...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.bz = fadd fast <4 x float> %i.bm, splat (float 1.000000e+00)
  %i.ca = fadd fast <4 x float> %i.bz, %i.by
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %reass.mul.a = fmul fast <4 x float> %i.bp, splat (float f0x3F317218)
  %reass.add68 = fadd fast <4 x float> %i.ci, splat (float -5.000000e-01)
  %reass.mul69 = fmul fast <4 x float> %i.br, %reass.add68
  %i.cj = fadd fast <4 x float> %reass.mul.a, %i.bq
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.ca = fadd fast <4 x float> %i.bn, splat (float 1.000000e+00)
  %i.cb = fadd fast <4 x float> %i.ca, %i.bz
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.ci = fmul fast <4 x float> %i.ch, %i.bq
  %reass.mul.a = fmul fast <4 x float> %i.bp, splat (float f0x3F317218)
  %reass.add67 = fadd fast <4 x float> %i.ci, splat (float -5.000000e-01)
  %reass.mul68 = fmul fast <4 x float> %i.br, %reass.add67
  %i.cj = fadd fast <4 x float> %reass.mul.a, %i.bq
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.bp = fadd fast <4 x float> %i.bc, splat (float 1.000000e+00)
  %i.bq = fadd fast <4 x float> %i.bp, %i.bo
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.ce = fadd fast <4 x float> %i.br, splat (float 1.000000e+00)
  %i.cf = fadd fast <4 x float> %i.ce, %i.cd
  ...
  %i.dp = fadd fast <4 x float> %i.dc, splat (float 1.000000e+00)
  %i.dq = fadd fast <4 x float> %i.dp, %i.do
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.bi = fmul fast <4 x float> %i.bh, %i.bh
  ...
  %i.bz = fmul fast <4 x float> %i.by, %i.bh
  %reass.mul.a = fmul fast <4 x float> %i.bg, splat (float f0x3F317218)
  %reass.add108 = fadd fast <4 x float> %i.bz, splat (float -5.000000e-01)
  %reass.mul109 = fmul fast <4 x float> %i.bi, %reass.add108
  %i.ca = fadd fast <4 x float> %reass.mul.a, %i.bh
  ...
  %i.cq = select fast <4 x i1> %i.cn, <4 x float> %i.cl, <4 x float> %i.cm
  ...
  %i.dj = fmul fast <4 x float> %i.di, %i.cr
  %reass.mul107 = fmul fast <4 x float> %i.cq, splat (float f0x3F317218)
  %reass.add110 = fadd fast <4 x float> %i.dj, splat (float -5.000000e-01)
  %reass.mul111 = fmul fast <4 x float> %i.cs, %reass.add110
  %i.dk = fadd fast <4 x float> %i.cr, splat (float f0x3F317218)
  %i.dl = fadd fast <4 x float> %i.dk, %reass.mul107
  %i.dm = fadd fast <4 x float> %i.dl, %reass.mul111
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.de = fadd fast <4 x float> %i.cr, splat (float 1.000000e+00)
  %i.df = fadd fast <4 x float> %i.de, %i.dd
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %reass.mul.a = fmul fast <4 x float> %i.bf, splat (float f0x3F317218)
  %reass.add107 = fadd fast <4 x float> %i.by, splat (float -5.000000e-01)
  %reass.mul108 = fmul fast <4 x float> %i.bh, %reass.add107
  %i.bz = fadd fast <4 x float> %reass.mul.a, %i.bg
  ...
  %reass.mul106 = fmul fast <4 x float> %i.cn, splat (float f0x3F317218)
  %reass.add109 = fadd fast <4 x float> %i.dg, splat (float -5.000000e-01)
  %reass.mul110 = fmul fast <4 x float> %i.cp, %reass.add109
  %i.dh = fadd fast <4 x float> %i.co, splat (float f0x3F317218)
  %i.di = fadd fast <4 x float> %i.dh, %reass.mul106
  %i.dj = fadd fast <4 x float> %i.di, %reass.mul110
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.by = fmul fast <4 x float> %i.bx, %i.bg
  %reass.mul.a = fmul fast <4 x float> %i.bf, splat (float f0x3F317218)
  %reass.add117 = fadd fast <4 x float> %i.by, splat (float -5.000000e-01)
  %reass.mul118 = fmul fast <4 x float> %i.bh, %reass.add117
  %i.bz = fadd fast <4 x float> %reass.mul.a, %i.bg
  ...
  %i.dn = fmul fast <4 x float> %i.dm, %i.cv
  %reass.mul116.a = fmul fast <4 x float> %i.cu, splat (float f0x3F317218)
  %reass.add119 = fadd fast <4 x float> %i.dn, splat (float -5.000000e-01)
  %reass.mul120 = fmul fast <4 x float> %i.cw, %reass.add119
  %i.do = fadd fast <4 x float> %reass.mul116.a, %i.cv
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.bz = fmul fast <4 x float> %i.by, %i.bh
  %reass.mul.a = fmul fast <4 x float> %i.bg, splat (float f0x3F317218)
  %reass.add72 = fadd fast <4 x float> %i.bz, splat (float -5.000000e-01)
  %reass.mul73 = fmul fast <4 x float> %i.bi, %reass.add72
  %i.ca = fadd fast <4 x float> %reass.mul.a, %i.bh
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.ct = fmul fast <4 x float> %i.cs, %i.cs
  ...
  %i.dk = fmul fast <4 x float> %i.dj, %i.cs
  %reass.mul.a = fmul fast <4 x float> %i.cr, splat (float f0x3F317218)
  %reass.add71 = fadd fast <4 x float> %i.dk, splat (float -5.000000e-01)
  %reass.mul72 = fmul fast <4 x float> %i.ct, %reass.add71
  %i.dl = fadd fast <4 x float> %reass.mul.a, %i.cs
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.dc = fadd fast <4 x float> %i.cp, splat (float 1.000000e+00)
  %i.dd = fadd fast <4 x float> %i.dc, %i.db
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.dk = fmul fast <4 x float> %i.dj, %i.cs
  %reass.mul.a = fmul fast <4 x float> %i.cr, splat (float f0x3F317218)
  %reass.add70 = fadd fast <4 x float> %i.dk, splat (float -5.000000e-01)
  %reass.mul71 = fmul fast <4 x float> %i.ct, %reass.add70
  %i.dl = fadd fast <4 x float> %reass.mul.a, %i.cs
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.dg = fadd fast <4 x float> %i.ct, splat (float 1.000000e+00)
  %i.dh = fadd fast <4 x float> %i.dg, %i.df
  ...
  %i.et = fadd fast <4 x float> %i.eg, splat (float 1.000000e+00)
  %i.eu = fadd fast <4 x float> %i.et, %i.es
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.cj = fmul fast <4 x float> %i.ci, %i.br
  %reass.mul.a = fmul fast <4 x float> %i.bq, splat (float f0x3F317218)
  %reass.add111 = fadd fast <4 x float> %i.cj, splat (float -5.000000e-01)
  %reass.mul112 = fmul fast <4 x float> %i.bs, %reass.add111
  %i.ck = fadd fast <4 x float> %reass.mul.a, %i.br
  ...
  %i.da = select fast <4 x i1> %i.cx, <4 x float> %i.cv, <4 x float> %i.cw
  ...
  %i.dt = fmul fast <4 x float> %i.ds, %i.db
  %reass.mul110 = fmul fast <4 x float> %i.da, splat (float f0x3F317218)
  %reass.add113 = fadd fast <4 x float> %i.dt, splat (float -5.000000e-01)
  %reass.mul114 = fmul fast <4 x float> %i.dc, %reass.add113
  %i.du = fadd fast <4 x float> %i.db, splat (float f0x3F317218)
  %i.dv = fadd fast <4 x float> %i.du, %reass.mul110
  %i.dw = fadd fast <4 x float> %i.dv, %reass.mul114
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.eg = fadd fast <4 x float> %i.dt, splat (float 1.000000e+00)
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.ci = fmul fast <4 x float> %i.ch, %i.bq
  %reass.mul.a = fmul fast <4 x float> %i.bp, splat (float f0x3F317218)
  %reass.add110 = fadd fast <4 x float> %i.ci, splat (float -5.000000e-01)
  %reass.mul111 = fmul fast <4 x float> %i.br, %reass.add110
  %i.cj = fadd fast <4 x float> %reass.mul.a, %i.bq
  ...
  %reass.mul109 = fmul fast <4 x float> %i.cx, splat (float f0x3F317218)
  %reass.add112 = fadd fast <4 x float> %i.dq, splat (float -5.000000e-01)
  %reass.mul113 = fmul fast <4 x float> %i.cz, %reass.add112
  %i.dr = fadd fast <4 x float> %i.cy, splat (float f0x3F317218)
  %i.ds = fadd fast <4 x float> %i.dr, %reass.mul109
  %i.dt = fadd fast <4 x float> %i.ds, %reass.mul113
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.ci = fmul fast <4 x float> %i.ch, %i.bq
  %reass.mul.a = fmul fast <4 x float> %i.bp, splat (float f0x3F317218)
  %reass.add120 = fadd fast <4 x float> %i.ci, splat (float -5.000000e-01)
  %reass.mul121 = fmul fast <4 x float> %i.br, %reass.add120
  %i.cj = fadd fast <4 x float> %reass.mul.a, %i.bq
  ...
  %i.di = fmul fast <4 x float> %i.dh, %i.dh
  ...
  %i.dz = fmul fast <4 x float> %i.dy, %i.dh
  %reass.mul119.a = fmul fast <4 x float> %i.dg, splat (float f0x3F317218)
  %reass.add122 = fadd fast <4 x float> %i.dz, splat (float -5.000000e-01)
  %reass.mul123 = fmul fast <4 x float> %i.di, %reass.add122
  %i.ea = fadd fast <4 x float> %reass.mul119.a, %i.dh
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.cj = fmul fast <4 x float> %i.ci, %i.br
  %reass.mul.a = fmul fast <4 x float> %i.bq, splat (float f0x3F317218)
  %reass.add75 = fadd fast <4 x float> %i.cj, splat (float -5.000000e-01)
  %reass.mul76 = fmul fast <4 x float> %i.bs, %reass.add75
  %i.ck = fadd fast <4 x float> %reass.mul.a, %i.br
