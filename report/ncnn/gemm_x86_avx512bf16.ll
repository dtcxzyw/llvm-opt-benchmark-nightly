...
.lr.ph1003.i.epil:                                ; preds = %.lr.ph1003.i.epil, %.lr.ph1003.i.epil.preheader
  ...
  %i.bfm = load i32, ptr %.131752999.i.epil, align 4, !tbaa !471
  ...
  br i1 %epil.iter2584.cmp.not, label %.preheader394.loopexit.i, label %.lr.ph1003.i.epil, !llvm.loop !404
...
.lr.ph1012.i.prol:                                ; preds = %.lr.ph1012.i.preheader
  ...
  %i.bgb = load i16, ptr %.131752.lcssa.i, align 2, !tbaa !24
...
.lr.ph1003.i:                                     ; preds = %.lr.ph1003.i.preheader, %.lr.ph1003.i
  ...
  %i.bgn = load i32, ptr %.131752999.i, align 4, !tbaa !471
  ...
  %i.bgv = load i32, ptr %i.bgt, align 4, !tbaa !471
  ...
  %i.bhd = load i32, ptr %i.bhb, align 4, !tbaa !471
  ...
  %i.bhl = load i32, ptr %i.bhj, align 4, !tbaa !471
  ...
  br i1 %niter2589.ncmp.3.not, label %.preheader394.loopexit.i.unr-lcssa, label %.lr.ph1003.i, !llvm.loop !405
...
.lr.ph1012.i:                                     ; preds = %.lr.ph1012.i.prol.loopexit, %.lr.ph1012.i
  ...
  %i.bhx = load i16, ptr %.1417531009.i, align 2, !tbaa !24
  ...
  %i.bil = load i16, ptr %i.bif, align 2, !tbaa !24
  ...
  br i1 %exitcond1807.not.i.1, label %._crit_edge1013.i, label %.lr.ph1012.i, !llvm.loop !406
...
._crit_edge1013.i:                                ; preds = %.lr.ph1012.i.prol.loopexit, %.lr.ph1012.i, %.preheader394.i
  ...
  br i1 %exitcond1808.not.i, label %._crit_edge1020.i, label %.lr.ph1019.i, !llvm.loop !407
...
._crit_edge1020.i:                                ; preds = %._crit_edge1013.i, %.preheader399.i
  ...
  br i1 %i.bja, label %.preheader403.i, label %.preheader393.i, !llvm.loop !408
...
.lr.ph1034.i.epil.preheader:                      ; preds = %.preheader387.i.loopexit.unr-lcssa, %.lr.ph1034.i.preheader
  ...
  %i.bkw = load double, ptr %.016911031.i.epil.init, align 8, !tbaa !470
...
.lr.ph1045.i.prol:                                ; preds = %.lr.ph1045.i.preheader
  %i.blm = load i32, ptr %.01691.lcssa.i, align 4, !tbaa !471
...
.lr.ph1034.i:                                     ; preds = %.lr.ph1034.i.preheader, %.lr.ph1034.i
  ...
  %i.bma = load double, ptr %.016911031.i, align 8, !tbaa !470
  ...
  %i.bmo = load double, ptr %i.bmm, align 8, !tbaa !470
  ...
  br i1 %niter2600.ncmp.1.not, label %.preheader387.i.loopexit.unr-lcssa, label %.lr.ph1034.i, !llvm.loop !409
...
.lr.ph1045.i:                                     ; preds = %.lr.ph1045.i.prol.loopexit, %.lr.ph1045.i
  ...
  %i.bnc = load i32, ptr %.116921043.i, align 4, !tbaa !471
...
begin_hunk_5_@_ZN4ncnn40gemm_transB_packed_tile_bf16s_avx512bf16ERKNS_3MatES2_RS0_iiiiii:bb.a
  ...
  %wide.vec1986 = load <64 x i16>, ptr %next.gep1970.a, align 2, !tbaa !24 ; 4 uses
  ...
  %wide.vec1991 = load <64 x i16>, ptr %next.gep1971.a, align 2, !tbaa !24 ; 4 uses
  ...
  %wide.vec1996 = load <64 x i16>, ptr %next.gep1972.a, align 2, !tbaa !24 ; 4 uses
  ...
  %wide.vec2001 = load <64 x i16>, ptr %next.gep1973, align 2, !tbaa !24 ; 4 uses
  ...
  br i1 %i.dpk, label %middle.block2007, label %vector.body1956, !llvm.loop !448
...
vec.epilog.iter.check2022:                        ; preds = %middle.block2007
  br i1 %min.epilog.iters.check2023, label %.lr.ph1318.i.preheader, label %vec.epilog.ph2024, !prof !26
...
vec.epilog.vector.body2026:                       ; preds = %vec.epilog.vector.body2026, %vec.epilog.ph2024
  ...
  %wide.vec2032 = load <16 x i16>, ptr %next.gep2030.a, align 2, !tbaa !24
  ...
  %wide.vec2035 = load <32 x i16>, ptr %next.gep2031, align 2, !tbaa !24 ; 4 uses
  ...
  br i1 %i.dqv, label %vec.epilog.middle.block2041, label %vec.epilog.vector.body2026, !llvm.loop !449
...
.preheader373.i:                                  ; preds = %.preheader373.loopexit.i, %bb.aw
  ...
  %.01454.lcssa.i = phi i32 [ 0, %bb.aw ], [ %i.bjh, %.preheader373.loopexit.i ] ; 6 uses
...
vector.body1865:                                  ; preds = %vector.body1865, %vector.ph1863
  ...
  %wide.vec1877 = load <64 x i16>, ptr %next.gep1875.a, align 2, !tbaa !24 ; 4 uses
  ...
  %wide.vec1882 = load <128 x i16>, ptr %next.gep1876, align 2, !tbaa !24 ; 8 uses
  ...
  br i1 %i.dts, label %middle.block1892, label %vector.body1865, !llvm.loop !450
...
vec.epilog.iter.check1907:                        ; preds = %middle.block1892
  ...
  br i1 %min.epilog.iters.check1908, label %.lr.ph1335.i.preheader, label %vec.epilog.ph1909, !prof !474
...
vec.epilog.vector.body1911:                       ; preds = %vec.epilog.vector.body1911, %vec.epilog.ph1909
  ...
  %wide.vec1923 = load <16 x i16>, ptr %next.gep1921.a, align 2, !tbaa !24 ; 4 uses
  ...
  %wide.vec1928 = load <32 x i16>, ptr %next.gep1922, align 2, !tbaa !24 ; 8 uses
...
begin_hunk_6_@_ZN4ncnn40gemm_transB_packed_tile_bf16s_avx512bf16ERKNS_3MatES2_RS0_iiiiii:bb.a
  ...
  br i1 %i.ega, label %.lr.ph1362.i, label %.preheader377.i, !llvm.loop !457
...
bb.ax:                                            ; preds = %.lr.ph1404.i
  %i.egb = load float, ptr %.291403.i, align 4, !tbaa !473
  br label %bb.ay
...
vector.body1713:                                  ; preds = %vector.body1713, %vector.ph1711
  ...
  %wide.vec1727 = load <32 x i16>, ptr %next.gep1719, align 2, !tbaa !24
  ...
  %wide.vec1730 = load <32 x i16>, ptr %next.gep1720, align 2, !tbaa !24
  ...
  %wide.vec1733 = load <32 x i16>, ptr %next.gep1721, align 2, !tbaa !24
  ...
  %wide.vec1736 = load <32 x i16>, ptr %next.gep1722, align 2, !tbaa !24
  ...
  %wide.vec1739 = load <32 x i16>, ptr %next.gep1723, align 2, !tbaa !24
  ...
  %wide.vec1742 = load <32 x i16>, ptr %next.gep1724, align 2, !tbaa !24
  ...
  %wide.vec1745 = load <32 x i16>, ptr %next.gep1725, align 2, !tbaa !24
  ...
  %wide.vec1748 = load <32 x i16>, ptr %next.gep1726, align 2, !tbaa !24
  ...
  br i1 %i.ejc, label %middle.block1752, label %vector.body1713, !llvm.loop !458
...
vec.epilog.iter.check1763:                        ; preds = %middle.block1752
  br i1 %min.epilog.iters.check1764, label %.lr.ph1371.i.preheader, label %vec.epilog.ph1765, !prof !26
...
vec.epilog.vector.body1767:                       ; preds = %vec.epilog.vector.body1767, %vec.epilog.ph1765
  ...
  %wide.vec1772 = load <16 x i16>, ptr %next.gep1770, align 2, !tbaa !24
  ...
  %wide.vec1775 = load <16 x i16>, ptr %next.gep1771, align 2, !tbaa !24
  ...
  br i1 %i.ejz, label %vec.epilog.middle.block1779, label %vec.epilog.vector.body1767, !llvm.loop !459
...
.preheader.i:                                     ; preds = %.preheader.loopexit.i, %bb.ay
  ...
  %.01391.lcssa.i = phi i32 [ 0, %bb.ay ], [ %i.bjh, %.preheader.loopexit.i ] ; 6 uses
...
iter.check1674:                                   ; preds = %.preheader.i
  %i.eke = sub i32 %9, %.01391.lcssa.i            ; 3 uses
...
vector.body1626:                                  ; preds = %vector.body1626, %vector.ph1624
  ...
  %wide.vec1640 = load <64 x i16>, ptr %next.gep1636, align 2, !tbaa !24 ; 4 uses
  ...
  %wide.vec1645 = load <64 x i16>, ptr %next.gep1637, align 2, !tbaa !24 ; 4 uses
  ...
  %wide.vec1650 = load <64 x i16>, ptr %next.gep1638, align 2, !tbaa !24 ; 4 uses
  ...
  %wide.vec1655 = load <64 x i16>, ptr %next.gep1639, align 2, !tbaa !24 ; 4 uses
  ...
  br i1 %i.enc, label %middle.block1661, label %vector.body1626, !llvm.loop !460
...
vec.epilog.iter.check1676:                        ; preds = %middle.block1661
  ...
  br i1 %min.epilog.iters.check1677, label %.lr.ph1383.i.preheader, label %vec.epilog.ph1678, !prof !22
...
vec.epilog.vector.body1680:                       ; preds = %vec.epilog.vector.body1680, %vec.epilog.ph1678
  ...
  %wide.vec1688 = load <32 x i16>, ptr %next.gep1686, align 2, !tbaa !24 ; 4 uses
  ...
  %wide.vec1693 = load <32 x i16>, ptr %next.gep1687, align 2, !tbaa !24 ; 4 uses
...
vector.body1575:                                  ; preds = %vector.body1575, %vector.ph1573
  ...
  %wide.load1583 = load <16 x i16>, ptr %next.gep1581, align 2, !tbaa !24
  %wide.load1584 = load <16 x i16>, ptr %i.erh, align 2, !tbaa !24
  %wide.load1585 = load <16 x i16>, ptr %i.eri, align 2, !tbaa !24
  %wide.load1586 = load <16 x i16>, ptr %i.erj, align 2, !tbaa !24
  ...
  %wide.load1587 = load <16 x i16>, ptr %next.gep1582, align 2, !tbaa !24
  %wide.load1588 = load <16 x i16>, ptr %i.erw, align 2, !tbaa !24
  %wide.load1589 = load <16 x i16>, ptr %i.erx, align 2, !tbaa !24
  %wide.load1590 = load <16 x i16>, ptr %i.ery, align 2, !tbaa !24
  ...
  br i1 %i.est, label %middle.block1592, label %vector.body1575, !llvm.loop !464
...
vec.epilog.iter.check1603:                        ; preds = %middle.block1592
  ...
  br i1 %min.epilog.iters.check1604, label %.lr.ph1397.i.preheader, label %vec.epilog.ph1605, !prof !26
...
vec.epilog.vector.body1607:                       ; preds = %vec.epilog.vector.body1607, %vec.epilog.ph1605
  ...
  %wide.load1612 = load <8 x i16>, ptr %next.gep1610, align 2, !tbaa !24
  ...
  %wide.load1613 = load <8 x i16>, ptr %next.gep1611, align 2, !tbaa !24
  ...
  br i1 %i.etk, label %vec.epilog.middle.block1615, label %vec.epilog.vector.body1607, !llvm.loop !465
...
.lr.ph1397.i:                                     ; preds = %.lr.ph1397.i.preheader, %.lr.ph1397.i
  ...
  %i.etm = load i16, ptr %.213991393.i, align 2, !tbaa !24
  %i.etn = zext i16 %i.etm to i32
  %i.eto = shl nuw i32 %i.etn, 16
  %i.etp = bitcast i32 %i.eto to float
  %i.etq = load i16, ptr %.1915611392.i, align 2, !tbaa !24
  ...
  br i1 %exitcond1830.not.i, label %._crit_edge1398.i, label %.lr.ph1397.i, !llvm.loop !466
...
._crit_edge1398.i:                                ; preds = %.lr.ph1397.i, %middle.block1592, %vec.epilog.middle.block1615, %._crit_edge1384.i
  ...
  store float %.21396.lcssa.i, ptr %.291403.i, align 4, !tbaa !473
  ...
  br i1 %exitcond1831.not.i, label %._crit_edge1405.i, label %.lr.ph1404.i, !llvm.loop !467
...
._crit_edge1405.i:                                ; preds = %._crit_edge1398.i, %.preheader377.i
  ...
  br i1 %exitcond1832.not.i, label %_ZN4ncnnL29gemm_transB_packed_tile_bf16sERKNS_3MatES2_RS0_iiiiii.exit, label %.preheader381.i, !llvm.loop !468
