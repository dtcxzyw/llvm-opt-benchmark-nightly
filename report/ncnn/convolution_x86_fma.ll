...
_ZN4ncnn3MatD2Ev.exit36:                          ; preds = %_ZN4ncnn3MatD2Ev.exit36.lr.ph, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.be = load i32, ptr %12, align 4, !tbaa !81   ; 26 uses
...
.lr.ph151.i.i:                                    ; preds = %_ZN17FastDivider_epu32C2Ej.exit1130.i.i
  ...
  %17 = shufflevector <2 x i32> %i.wr, <2 x i32> poison, <2 x i32> zeroinitializer
  %18 = insertelement <2 x i32> poison, i32 %i.be, i64 0
  %i.ws = shufflevector <2 x i32> %18, <2 x i32> poison, <2 x i32> zeroinitializer
  ...
  %21 = insertelement <2 x i32> poison, i32 %i.be, i64 0
...
.lr.ph182.i.i:                                    ; preds = %.preheader114.i.i
  ...
  %23 = shufflevector <2 x i32> %i.yd, <2 x i32> poison, <2 x i32> zeroinitializer
  %24 = insertelement <2 x i32> poison, i32 %i.be, i64 0
  %i.ye = shufflevector <2 x i32> %24, <2 x i32> poison, <2 x i32> zeroinitializer
  ...
  %25 = insertelement <2 x i64> poison, i64 %i.bs, i64 0
  ...
  %27 = insertelement <2 x i32> poison, i32 %i.be, i64 0
...
bb.q:                                             ; preds = %bb.q, %.lr.ph138.i.i
  ...
  %29 = sext <2 x i32> %i.aat to <2 x i64>
  %30 = mul <2 x i64> %20, %29                    ; 2 uses
  ...
  %i.aaz = srem <2 x i32> %.decomposed, %i.xd
  %i.aba = mul i32 %i.aaw, %i.wf
  %31 = mul nsw <2 x i32> %i.aaz, %22             ; 2 uses
  %32 = extractelement <2 x i32> %31, i64 0
  %i.abb = add nsw i32 %32, %i.aba
  %i.abc = sext i32 %i.abb to i64
  %i.abd = mul i32 %i.aay, %i.wf
  %i.abe = extractelement <2 x i32> %31, i64 1
  %i.abf = add nsw i32 %i.abe, %i.abd
  %i.abg = sext i32 %i.abf to i64
  %i.abh = load ptr, ptr %9, align 8, !tbaa !37   ; 2 uses
  %i.abi = extractelement <2 x i64> %30, i64 0
  ...
  %i.abo = extractelement <2 x i64> %30, i64 1
...
.lr.ph.i80.i:                                     ; preds = %.preheader124.i.i, %.lr.ph.i80.i
  ...
  %i.aeo = srem <2 x i32> %i.aen, %17
  %33 = mul nsw <2 x i32> %i.aeo, %i.ws           ; 2 uses
  %i.aep = insertelement <2 x i32> %i.aen, i32 %i.aej, i64 1
  %i.aeq = sdiv <2 x i32> %i.aep, %i.wt
  %i.aer = mul <2 x i32> %i.aeq, %i.wv            ; 2 uses
  %shift = shufflevector <2 x i32> %i.aer, <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop316 = add <2 x i32> %i.aer, %shift
  %foldExtExtBinop318 = add <2 x i32> %foldExtExtBinop316, %33
  %i.aes = shufflevector <2 x i32> %foldExtExtBinop318, <2 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  ...
  %i.aey = mul <2 x i32> %i.aex, %i.wv            ; 2 uses
  %34 = shufflevector <2 x i32> %i.aey, <2 x i32> poison, <4 x i32> zeroinitializer
  %35 = shufflevector <2 x i32> %i.aey, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %36 = add <4 x i32> %34, %35
  %37 = shufflevector <2 x i32> %33, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %38 = add <4 x i32> %36, %37                    ; 2 uses
  %i.aez = add <4 x i32> %38, %i.aah              ; 4 uses
  %i.afa = add <4 x i32> %38, %i.aai              ; 4 uses
...
.lr.ph214.i.i:                                    ; preds = %.preheader103.i.i
  ...
  %39 = insertelement <2 x i64> poison, i64 %i.bs, i64 0
  ...
  %41 = insertelement <2 x i32> poison, i32 %i.be, i64 0
...
bb.w:                                             ; preds = %bb.w, %.lr.ph169.i76.i
  ...
  %43 = sext <2 x i32> %i.aqf to <2 x i64>
  %44 = mul <2 x i64> %26, %43                    ; 2 uses
  ...
  %i.ara = extractelement <2 x i64> %44, i64 1
...
.lr.ph156.i.i:                                    ; preds = %.preheader113.i.i, %.lr.ph156.i.i
  ...
  %i.aub = srem <2 x i32> %i.aua, %23
  %47 = mul nsw <2 x i32> %i.aub, %i.ye           ; 2 uses
  %i.auc = insertelement <2 x i32> %i.aua, i32 %i.atw, i64 1
  %i.aud = sdiv <2 x i32> %i.auc, %i.yf
  %i.aue = mul <2 x i32> %i.aud, %i.yh            ; 2 uses
  %shift335 = shufflevector <2 x i32> %i.aue, <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop336 = add <2 x i32> %i.aue, %shift335
  %foldExtExtBinop338 = add <2 x i32> %foldExtExtBinop336, %47
  %i.auf = shufflevector <2 x i32> %foldExtExtBinop338, <2 x i32> poison, <4 x i32> zeroinitializer
  ...
  %i.auk = mul <2 x i32> %i.auj, %i.yh            ; 2 uses
  %48 = shufflevector <2 x i32> %i.auk, <2 x i32> poison, <4 x i32> zeroinitializer
  %49 = shufflevector <2 x i32> %i.auk, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %50 = add <4 x i32> %48, %49
  %51 = shufflevector <2 x i32> %47, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %52 = add <4 x i32> %50, %51
  %i.aul = add <4 x i32> %52, %i.apu              ; 4 uses
...
.lr.ph232.i.i:                                    ; preds = %.preheader92.i.i
  ...
  %53 = insertelement <2 x i64> poison, i64 %i.bs, i64 0
  ...
  %55 = insertelement <2 x i32> poison, i32 %i.be, i64 0
...
bb.ac:                                            ; preds = %bb.ac, %.lr.ph201.i.i
  ...
  %57 = sext <2 x i32> %i.ban to <2 x i64>
  %58 = mul <2 x i64> %40, %57                    ; 2 uses
  ...
  %i.bat = srem <2 x i32> %.decomposed523, %i.aow
  %i.bau = mul i32 %i.baq, %i.anv
  %59 = mul nsw <2 x i32> %i.bat, %42             ; 2 uses
  %60 = extractelement <2 x i32> %59, i64 0
  %i.bav = add nsw i32 %60, %i.bau
  %i.baw = sext i32 %i.bav to i64
  %i.bax = mul i32 %i.bas, %i.anv
  %i.bay = extractelement <2 x i32> %59, i64 1
  %i.baz = add nsw i32 %i.bay, %i.bax
  %i.bba = sext i32 %i.baz to i64
  %i.bbb = load ptr, ptr %9, align 8, !tbaa !37   ; 2 uses
  %i.bbc = extractelement <2 x i64> %58, i64 0
  ...
  %i.bbg = extractelement <2 x i64> %58, i64 1
...
.lr.ph187.i71.i:                                  ; preds = %.lr.ph187.i71.i.preheader, %.lr.ph187.i71.i
  ...
  %61 = load ptr, ptr %9, align 8, !tbaa !37      ; 4 uses
...
bb.aj:                                            ; preds = %bb.aj, %.lr.ph219.i.i
  ...
  %62 = sext <2 x i32> %i.bhy to <2 x i64>
  %63 = mul <2 x i64> %54, %62                    ; 2 uses
  ...
  %i.bie = srem <2 x i32> %.decomposed531, %i.azs
  %i.bif = mul i32 %i.bib, %i.azk
  %64 = mul nsw <2 x i32> %i.bie, %56             ; 2 uses
  %65 = extractelement <2 x i32> %64, i64 0
  %i.big = add nsw i32 %65, %i.bif
  %i.bih = sext i32 %i.big to i64
  %i.bii = mul i32 %i.bid, %i.azk
  %i.bij = extractelement <2 x i32> %64, i64 1
  %i.bik = add nsw i32 %i.bij, %i.bii
  %i.bil = sext i32 %i.bik to i64
  %i.bim = load ptr, ptr %9, align 8, !tbaa !37   ; 2 uses
  %i.bin = extractelement <2 x i64> %63, i64 0
  ...
  %i.bir = extractelement <2 x i64> %63, i64 1
