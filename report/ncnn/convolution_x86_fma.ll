...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.m = load i32, ptr %3, align 4, !tbaa !81
...
bb.f:                                             ; preds = %bb.e
  %i.ap = load i32, ptr %3, align 4, !tbaa !81    ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = load i32, ptr %i.a, align 4, !tbaa !81   ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph127, %_ZN4ncnn3MatD2Ev.exit
  %indvar162 = phi i32 [ 0, %.lr.ph127 ], [ %indvar.next163, %_ZN4ncnn3MatD2Ev.exit ] ; 2 uses
  %.033126 = phi i32 [ %i.k, %.lr.ph127 ], [ %i.bk, %_ZN4ncnn3MatD2Ev.exit ] ; 3 uses
  %11 = add i32 %i.k, %indvar162
  %i.r = mul i32 %11, 9
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %_ZN4ncnn3MatD2Ev.exit34, %_ZN4ncnn3Mat7channelEi.exit49
  ...
  %i.bl = load i32, ptr %i.b, align 4, !tbaa !81
...
bb.d:                                             ; preds = %.lr.ph, %_ZN4ncnn3MatD2Ev.exit34
  ...
  %smin197 = call i32 @llvm.smin.i32(i32 %i.ah, i32 %i.bo)
  %i.bp = add i32 %smin197, -1                    ; 2 uses
...
.preheader12.lr.ph.i:                             ; preds = %bb.d
  %i.ch = load i32, ptr %9, align 4, !tbaa !81    ; 3 uses
...
vector.body174:                                   ; preds = %vector.body174, %vector.ph172
  ...
  %i.ds = load float, ptr %i.do, align 4, !tbaa !56, !alias.scope !678 ; 2 uses
  ...
  %i.ee = load float, ptr %i.ea, align 4, !tbaa !56, !alias.scope !678
  ...
  %i.eq = load float, ptr %i.em, align 4, !tbaa !56, !alias.scope !678 ; 2 uses
  ...
  %i.fx = load float, ptr %i.ft, align 4, !tbaa !56, !alias.scope !678
  ...
  %i.gj = load float, ptr %i.gf, align 4, !tbaa !56, !alias.scope !678
  ...
  %i.gv = load float, ptr %i.gr, align 4, !tbaa !56, !alias.scope !678
...
begin_hunk_1_@_ZN4ncnnL37conv3x3s1_winograd63_transform_kernelERKNS_3MatERS0_iiRKNS_6OptionE.omp_outlined:bb.a
  ...
  %i.asv = load float, ptr %next.gep, align 4, !tbaa !56, !alias.scope !680
  %i.asw = load float, ptr %next.gep146, align 4, !tbaa !56, !alias.scope !680
  %i.asx = load float, ptr %next.gep147, align 4, !tbaa !56, !alias.scope !680
  %i.asy = load float, ptr %next.gep148, align 4, !tbaa !56, !alias.scope !680
  %i.asz = load float, ptr %next.gep149, align 4, !tbaa !56, !alias.scope !680
  %i.ata = load float, ptr %next.gep150, align 4, !tbaa !56, !alias.scope !680
  %i.atb = load float, ptr %next.gep151, align 4, !tbaa !56, !alias.scope !680
  %i.atc = load float, ptr %next.gep152, align 4, !tbaa !56, !alias.scope !680
  ...
  store <8 x float> %i.atk, ptr %next.gep153, align 4, !tbaa !56, !alias.scope !681, !noalias !680
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.atl = icmp eq i64 %index.next, %n.vec
  br i1 %i.atl, label %middle.block, label %vector.body, !llvm.loop !672
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph.i, %middle.block
  ...
  %xtraiter207 = and i32 %i.atm, 7                ; 2 uses
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %i.atn = load float, ptr %.09944.i.prol, align 4, !tbaa !56
  store float %i.atn, ptr %.743.i.prol, align 4, !tbaa !56
...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  %.lcssa196.unr = phi ptr [ poison, %scalar.ph.preheader ], [ %i.atp, %scalar.ph.prol ]
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.auo = load float, ptr %i.aum, align 4, !tbaa !56
  store float %i.auo, ptr %i.aun, align 4, !tbaa !56
  ...
  br i1 %exitcond74.not.i.7, label %._crit_edge.i53, label %scalar.ph, !llvm.loop !674

._crit_edge.i53:                                  ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %.lcssa142 = phi ptr [ %i.asl, %middle.block ], [ %.lcssa196.unr, %scalar.ph.prol.loopexit ], [ %i.auq, %scalar.ph ]
  %indvars.iv.next76.i = add nuw nsw i64 %indvars.iv75.i, 1 ; 2 uses
  %exitcond78.not.i = icmp eq i64 %indvars.iv.next76.i, %i.az
  br i1 %exitcond78.not.i, label %._crit_edge49.split.i, label %.lr.ph.i, !llvm.loop !8
...
._crit_edge49.split.i:                            ; preds = %._crit_edge.i53, %.lr.ph48.i, %.preheader.i, %.lr.ph33.i
  ...
  br i1 %exitcond83.not.i, label %_ZN4ncnn3MatD2Ev.exit34, label %bb.e, !llvm.loop !9
...
_ZN4ncnn3MatD2Ev.exit34:                          ; preds = %._crit_edge49.split.i
  ...
  br i1 %i.aus, label %bb.d, label %_ZN4ncnn3MatD2Ev.exit, !llvm.loop !675
...
; Function Attrs: nounwind
declare !callback !119 void @__kmpc_fork_call(ptr, i32, ptr, ...) local_unnamed_addr #12
...
bb.c:                                             ; preds = %.lr.ph135, %_ZN4ncnn3MatD2Ev.exit
  ...
  %.033134 = phi i32 [ %i.k, %.lr.ph135 ], [ %i.bk, %_ZN4ncnn3MatD2Ev.exit ] ; 3 uses
  %11 = add i32 %i.k, %indvar170
  %i.r = mul i32 %11, 9
  %i.s = load i32, ptr %3, align 4, !tbaa !81     ; 2 uses
...
vector.body182:                                   ; preds = %vector.body182, %vector.ph180
  ...
  %i.dq = getelementptr inbounds i8, ptr %i.cs, i64 %i.dm ; 9 uses
  %i.dr = getelementptr inbounds i8, ptr %i.cs, i64 %i.dn ; 9 uses
  %i.ds = load float, ptr %i.do, align 4, !tbaa !56, !alias.scope !702 ; 2 uses
  %i.dt = load float, ptr %i.dq, align 4, !tbaa !56, !alias.scope !702 ; 2 uses
  ...
  %i.dz = load float, ptr %i.dv, align 4, !tbaa !56, !alias.scope !702
  ...
  %i.el = load float, ptr %i.eh, align 4, !tbaa !56, !alias.scope !702 ; 2 uses
  ...
  %i.fb = load float, ptr %i.ex, align 4, !tbaa !56, !alias.scope !702
  ...
  %i.fn = load float, ptr %i.fj, align 4, !tbaa !56, !alias.scope !702
  ...
  %i.fz = load float, ptr %i.fv, align 4, !tbaa !56, !alias.scope !702
  ...
  %i.gy = load float, ptr %i.gu, align 4, !tbaa !56, !alias.scope !702 ; 2 uses
...
bb.l:                                             ; preds = %bb.c
  %i.ao = landingpad { ptr, i32 }
          cleanup
  %i.ap = load ptr, ptr %i.t, align 8, !tbaa !35  ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  %i.as = load ptr, ptr %i.u, align 8, !tbaa !36  ; 3 uses
  %.not3.i14 = icmp eq ptr %i.as, null
  %i.at = load ptr, ptr %5, align 8, !tbaa !37    ; 3 uses
  br i1 %.not3.i14, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.au = load ptr, ptr %i.as, align 8, !tbaa !29
...
bb.c:                                             ; preds = %.lr.ph140, %_ZN4ncnn3MatD2Ev.exit
  %indvar210 = phi i32 [ 0, %.lr.ph140 ], [ %indvar.next211, %_ZN4ncnn3MatD2Ev.exit ] ; 2 uses
  %.033139 = phi i32 [ %i.k, %.lr.ph140 ], [ %i.bh, %_ZN4ncnn3MatD2Ev.exit ] ; 3 uses
  %11 = add i32 %i.k, %indvar210
  %i.r = mul i32 %11, 9
  %i.s = load i32, ptr %3, align 4, !tbaa !81     ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %_ZN4ncnn3MatD2Ev.exit34, %_ZN4ncnn3Mat7channelEi.exit49
  ...
  %indvar.next211 = add i32 %indvar210, 1
  br i1 %.not.not, label %bb.c, label %._crit_edge
