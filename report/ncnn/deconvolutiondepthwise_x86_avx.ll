...
.preheader265:                                    ; preds = %.preheader265.preheader, %._crit_edge277
  ...
  %.054280 = phi ptr [ %.1.lcssa, %._crit_edge277 ], [ %i.bf, %.preheader265.preheader ] ; 2 uses
  %.055279 = phi i32 [ %.neg262.a, %._crit_edge277 ], [ 0, %.preheader265.preheader ]
  %i.bi = icmp sgt i32 %i.bh, 0
  %.neg262.a = add nuw nsw i32 %.055279, 1        ; 3 uses
...
._crit_edge277:                                   ; preds = %.preheader265, %._crit_edge277.loopexit
  ...
  %.1.lcssa = phi ptr [ %i.jn, %._crit_edge277.loopexit ], [ %.054280, %.preheader265 ]
...
.lr.ph276:                                        ; preds = %.preheader265, %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit
  %.1275 = phi ptr [ %i.jn, %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit ], [ %.054280, %.preheader265 ] ; 2 uses
  %.057274 = phi i32 [ %i.jo, %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit ], [ 0, %.preheader265 ] ; 2 uses
...
.lr.ph270:                                        ; preds = %bb.d
  ...
  %.neg264 = add nuw nsw i32 %.057274, 1
  br label %bb.f
...
.noexc79:                                         ; preds = %._crit_edge
  ...
  %i.dn = fadd fast <8 x float> %i.da, splat (float 1.000000e+00)
  %i.do = fadd fast <8 x float> %i.dn, %i.dm
...
.noexc80:                                         ; preds = %._crit_edge
  ...
  %i.es = fadd fast <8 x float> %i.ef, splat (float 1.000000e+00)
  %i.et = fadd fast <8 x float> %i.es, %i.er
  ...
  %i.fq = fmul fast <8 x float> %i.fp, %i.fp
  ...
  %i.gh = fmul fast <8 x float> %i.gg, %i.fp
  %reass.mul.a = fmul fast <8 x float> %i.fo, splat (float f0x3F317218)
  %reass.add259 = fadd fast <8 x float> %i.gh, splat (float -5.000000e-01)
  %reass.mul260 = fmul fast <8 x float> %i.fq, %reass.add259
  %i.gi = fadd fast <8 x float> %reass.mul.a, %i.fp
  ...
  %i.hh = fadd fast <8 x float> %i.gu, splat (float 1.000000e+00)
  %i.hi = fadd fast <8 x float> %i.hh, %i.hg
...
bb.f:                                             ; preds = %.lr.ph270, %.loopexit
  %.058269 = phi i32 [ 0, %.lr.ph270 ], [ %i.jm, %.loopexit ] ; 3 uses
  %.1257268 = phi <8 x float> [ %.0256, %.lr.ph270 ], [ %.4, %.loopexit ] ; 5 uses
  %i.if = mul nsw i32 %i.bu, %.058269
...
.lr.ph:                                           ; preds = %.preheader
  ...
  %i.is = mul nuw nsw i32 %i.il, %.058269
...
.loopexit:                                        ; preds = %bb.m, %.preheader, %bb.h, %bb.f, %bb.g
  ...
  %i.jm = add nuw nsw i32 %.058269, 1             ; 2 uses
...
_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit:      ; preds = %.noexc83, %.noexc80, %.noexc79, %.noexc78, %.noexc76, %bb.e, %._crit_edge
  ...
  store <8 x float> %.0.i, ptr %.1275, align 1, !tbaa !116
  %i.jn = getelementptr inbounds nuw i8, ptr %.1275, i64 32 ; 2 uses
  %i.jo = add nuw nsw i32 %.057274, 1             ; 2 uses
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit:      ; preds = %bb.g, %.noexc78, %.noexc77, %bb.f, %.noexc76, %bb.e, %._crit_edge
  ...
  store <4 x float> %.0.i, ptr %.1229, align 1, !tbaa !116
