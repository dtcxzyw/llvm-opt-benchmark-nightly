...
middle.block:                                     ; preds = %vector.body
  ...
  %i.ad = tail call fast float @llvm.vector.reduce.fadd.v4f32(float 0.000000e+00, <4 x float> %i.v)
  %i.ae = tail call fast float @llvm.vector.reduce.fadd.v4f32(float 0.000000e+00, <4 x float> %i.w)
  %cmp.n = icmp eq i64 %n.vec, %i.b
  %i.af = insertelement <2 x float> poison, float %i.ad, i64 0
  %i.ag = insertelement <2 x float> %i.af, float %i.ae, i64 1 ; 2 uses
  %i.ah = insertelement <2 x float> poison, float %i.z, i64 0
  %i.ai = insertelement <2 x float> %i.ah, float %i.aa, i64 1 ; 2 uses
...
._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %bb.a
  %.sroa.15.0.lcssa = phi float [ 0.000000e+00, %bb.a ], [ %i.ac, %middle.block ], [ %i.bp, %.lr.ph ] ; 2 uses
  %.sroa.974.0.lcssa = phi float [ 0.000000e+00, %bb.a ], [ %i.ab, %middle.block ], [ %i.bl, %.lr.ph ] ; 2 uses
  %.sroa.069.0.lcssa = phi float [ 0.000000e+00, %bb.a ], [ %i.y, %middle.block ], [ %i.bf, %.lr.ph ] ; 5 uses
  %4 = phi <2 x float> [ zeroinitializer, %bb.a ], [ %i.ag, %middle.block ], [ %i.bq, %.lr.ph ] ; 2 uses
  %i.aj = phi <2 x float> [ zeroinitializer, %bb.a ], [ %i.ai, %middle.block ], [ %i.bg, %.lr.ph ] ; 9 uses
  %5 = shufflevector <2 x float> %4, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1> ; 2 uses
  %6 = sitofp fast i32 %2 to float                ; 4 uses
  %i.ak = fneg fast float %6
  %7 = extractelement <2 x float> %i.aj, i64 0
  %8 = fneg fast <2 x float> %i.aj                ; 4 uses
  %9 = getelementptr inbounds nuw i8, ptr %3, i64 4
  %10 = getelementptr inbounds nuw i8, ptr %3, i64 8
  %11 = insertelement <4 x float> poison, float %.sroa.069.0.lcssa, i64 0 ; 2 uses
  %12 = shufflevector <2 x float> %i.aj, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 5 uses
  %13 = shufflevector <4 x float> %11, <4 x float> %12, <4 x i32> <i32 0, i32 4, i32 poison, i32 poison> ; 3 uses
  %14 = insertelement <4 x float> %13, float %6, i64 2 ; 2 uses
  %15 = shufflevector <4 x float> %14, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  %16 = shufflevector <4 x float> %14, <4 x float> poison, <4 x i32> <i32 poison, i32 2, i32 2, i32 poison>
  %17 = shufflevector <2 x float> %8, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison> ; 2 uses
  %18 = shufflevector <4 x float> %16, <4 x float> %17, <4 x i32> <i32 5, i32 1, i32 2, i32 poison>
  %19 = shufflevector <4 x float> %18, <4 x float> %12, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %20 = fmul fast <4 x float> %15, %19            ; 5 uses
  %21 = shufflevector <4 x float> %20, <4 x float> poison, <4 x i32> <i32 1, i32 3, i32 2, i32 0> ; 2 uses
  %22 = shufflevector <4 x float> %12, <4 x float> %13, <4 x i32> <i32 1, i32 4, i32 4, i32 5> ; 3 uses
  %23 = fmul fast <4 x float> %22, %21            ; 2 uses
  %24 = shufflevector <4 x float> %23, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 3> ; 2 uses
  %25 = shufflevector <4 x float> %13, <4 x float> %17, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %26 = shufflevector <4 x float> %20, <4 x float> poison, <4 x i32> <i32 3, i32 poison, i32 poison, i32 3>
  %27 = extractelement <2 x float> %i.aj, i64 1   ; 2 uses
  %28 = shufflevector <2 x float> %i.aj, <2 x float> %8, <4 x i32> <i32 1, i32 3, i32 1, i32 3>
  %29 = insertelement <4 x float> <float 1.000000e+00, float poison, float poison, float poison>, float %6, i64 1
  %30 = insertelement <4 x float> %29, float %i.ak, i64 2
  %31 = shufflevector <4 x float> %30, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 1>
  %32 = fmul reassoc nnan nsz arcp contract afn <4 x float> %28, %31 ; 2 uses
  %33 = shufflevector <2 x float> %i.aj, <2 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 0>
  %34 = fmul fast <4 x float> %32, %33            ; 4 uses
  %foldExtExtBinop = fadd fast <4 x float> %34, %24
  %35 = shufflevector <4 x float> %32, <4 x float> %20, <4 x i32> <i32 1, i32 2, i32 5, i32 poison>
  %36 = shufflevector <4 x float> %foldExtExtBinop, <4 x float> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 poison>
  %37 = shufflevector <2 x float> %i.aj, <2 x float> %8, <2 x i32> <i32 0, i32 3>
  %38 = fmul fast <2 x float> %i.aj, %37          ; 4 uses
  %i.al = fmul fast float %.sroa.069.0.lcssa, %6  ; 2 uses
  %39 = extractelement <2 x float> %38, i64 0
  %40 = fsub fast float %i.al, %39                ; 2 uses
  %41 = shufflevector <2 x float> %38, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %42 = shufflevector <2 x float> %38, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison>
  %43 = fsub fast <4 x float> %41, %42            ; 2 uses
  %44 = shufflevector <4 x float> %35, <4 x float> %43, <4 x i32> <i32 0, i32 1, i32 2, i32 4> ; 2 uses
  %45 = fmul fast <4 x float> %44, %25            ; 4 uses
  %46 = shufflevector <4 x float> %44, <4 x float> %36, <4 x i32> <i32 3, i32 2, i32 4, i32 1>
  %47 = shufflevector <4 x float> %22, <4 x float> <float 1.000000e+00, float poison, float poison, float poison>, <4 x i32> <i32 0, i32 0, i32 4, i32 1>
  %48 = fmul fast <4 x float> %46, %47            ; 2 uses
  %49 = fadd fast <4 x float> %45, %48            ; 2 uses
  %50 = fsub fast <4 x float> %45, %48            ; 2 uses
  %51 = shufflevector <4 x float> %49, <4 x float> %50, <4 x i32> <i32 0, i32 1, i32 2, i32 7>
  %i.am = extractelement <4 x float> %49, i64 2
  %52 = fmul fast float %i.am, %.sroa.069.0.lcssa
  %53 = insertelement <4 x float> %26, float %40, i64 1
  %54 = insertelement <4 x float> %12, float 1.000000e+00, i64 2
  %55 = fneg fast <4 x float> %21
  %56 = shufflevector <4 x float> %54, <4 x float> %55, <4 x i32> <i32 0, i32 1, i32 2, i32 4>
  %57 = extractelement <4 x float> %50, i64 3
  %58 = fmul fast float %27, %57
  %59 = shufflevector <2 x float> %38, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %60 = shufflevector <4 x float> %20, <4 x float> %59, <4 x i32> <i32 0, i32 poison, i32 poison, i32 4>
  %i.an = insertelement <4 x float> %60, float %40, i64 1
  %i.ao = insertelement <4 x float> %i.an, float %.sroa.069.0.lcssa, i64 2
  %61 = shufflevector <4 x float> %12, <4 x float> %20, <4 x i32> <i32 1, i32 0, i32 5, i32 0>
  %62 = fmul fast <4 x float> %i.ao, %61          ; 3 uses
  %63 = shufflevector <4 x float> %62, <4 x float> %45, <4 x i32> <i32 2, i32 4, i32 1, i32 poison>
  %foldExtExtBinop312 = fadd fast <4 x float> %34, %45
  %64 = extractelement <2 x float> %8, i64 0
  %65 = fmul fast float %.sroa.069.0.lcssa, %64   ; 2 uses
  %66 = extractelement <4 x float> %34, i64 0
  %67 = fsub fast float %i.al, %66                ; 2 uses
  %68 = fmul fast float %65, %27
  %69 = insertelement <4 x float> poison, float %68, i64 0
  %70 = insertelement <4 x float> %53, float %67, i64 2
  %71 = fmul fast <4 x float> %70, %22            ; 2 uses
  %72 = shufflevector <4 x float> %71, <4 x float> poison, <4 x i32> <i32 1, i32 0, i32 3, i32 2> ; 2 uses
  %73 = shufflevector <4 x float> %71, <4 x float> %11, <4 x i32> <i32 poison, i32 poison, i32 0, i32 4>
  %74 = shufflevector <4 x float> %43, <4 x float> %73, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %75 = fmul reassoc nsz arcp contract afn <4 x float> %74, %56 ; 4 uses
  %76 = shufflevector <4 x float> %63, <4 x float> %75, <4 x i32> <i32 0, i32 1, i32 2, i32 4> ; 2 uses
  %77 = fsub fast <4 x float> %75, %76            ; 2 uses
  %78 = fadd fast <4 x float> %75, %76
  %79 = shufflevector <4 x float> %77, <4 x float> %78, <4 x i32> <i32 0, i32 1, i32 2, i32 7>
  %i.ap = extractelement <4 x float> %77, i64 0
  %80 = fmul fast float %i.ap, %7
  %i.aq = fadd fast float %52, %80
  %81 = fsub fast float %i.aq, %58
  %82 = fdiv fast float 1.000000e+00, %81
  %83 = shufflevector <4 x float> %69, <4 x float> %foldExtExtBinop312, <4 x i32> <i32 0, i32 6, i32 poison, i32 poison>
  %84 = shufflevector <4 x float> %83, <4 x float> %34, <4 x i32> <i32 0, i32 1, i32 7, i32 poison>
  %85 = shufflevector <4 x float> %84, <4 x float> %23, <4 x i32> <i32 0, i32 1, i32 2, i32 5>
  %86 = fadd fast <4 x float> %85, %24
  %87 = insertelement <4 x float> poison, float %67, i64 0
  %88 = insertelement <4 x float> %87, float %65, i64 1
  %foldExtExtBinop314 = fadd fast <4 x float> %62, %75
  %89 = shufflevector <4 x float> %62, <4 x float> %foldExtExtBinop314, <4 x i32> <i32 0, i32 7, i32 poison, i32 poison>
  %90 = shufflevector <2 x float> %i.aj, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 poison, i32 poison>
  %91 = fmul fast <4 x float> %88, %90
  %92 = shufflevector <4 x float> %89, <4 x float> %91, <4 x i32> <i32 0, i32 1, i32 4, i32 5> ; 2 uses
  %93 = fadd fast <4 x float> %72, %92
  %94 = fsub fast <4 x float> %72, %92
  %95 = shufflevector <4 x float> %93, <4 x float> %94, <4 x i32> <i32 0, i32 1, i32 6, i32 3>
  %96 = shufflevector <2 x float> %4, <2 x float> poison, <4 x i32> <i32 1, i32 0, i32 0, i32 poison> ; 2 uses
  %97 = insertelement <4 x float> %96, float %.sroa.974.0.lcssa, i64 0
  %98 = insertelement <4 x float> %97, float %.sroa.15.0.lcssa, i64 3
  %99 = fmul fast <4 x float> %79, %98            ; 2 uses
  %100 = insertelement <4 x float> %96, float %.sroa.15.0.lcssa, i64 1 ; 2 uses
  %101 = fneg fast <4 x float> %5
  %102 = shufflevector <4 x float> %100, <4 x float> %101, <4 x i32> <i32 0, i32 1, i32 1, i32 4>
  %103 = fmul fast <4 x float> %102, %86          ; 2 uses
  %104 = shufflevector <4 x float> %100, <4 x float> poison, <2 x i32> <i32 1, i32 poison>
  %105 = insertelement <2 x float> %104, float %.sroa.974.0.lcssa, i64 1
  %106 = shufflevector <2 x float> %105, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 1, i32 1>
  %107 = fmul fast <4 x float> %51, %106          ; 2 uses
  %i.ar = fadd fast <4 x float> %103, %107
  %108 = fsub fast <4 x float> %103, %107
  %109 = shufflevector <4 x float> %i.ar, <4 x float> %108, <4 x i32> <i32 0, i32 5, i32 2, i32 7> ; 2 uses
  %110 = fsub fast <4 x float> %99, %109
  %111 = fadd fast <4 x float> %99, %109
  %112 = shufflevector <4 x float> %110, <4 x float> %111, <4 x i32> <i32 0, i32 5, i32 6, i32 7>
  %113 = fmul fast <4 x float> %95, %5
  %114 = fadd fast <4 x float> %112, %113
  %i.as = insertelement <4 x float> poison, float %82, i64 0
  %i.at = shufflevector <4 x float> %i.as, <4 x float> poison, <4 x i32> zeroinitializer
  %i.au = fmul fast <4 x float> %i.at, %114       ; 3 uses
  ...
  store float %i.ax, ptr %9, align 4, !tbaa !9
  store <4 x float> %i.au, ptr %10, align 4, !tbaa !9
  ret void
...
.lr.ph:                                           ; preds = %.lr.ph.preheader321, %.lr.ph
  ...
  %i.ay = phi <2 x float> [ %i.bq, %.lr.ph ], [ %.ph, %.lr.ph.preheader321 ]
  %i.az = phi <2 x float> [ %i.bg, %.lr.ph ], [ %.ph322, %.lr.ph.preheader321 ]
  %115 = load <2 x float>, ptr %.0243270, align 4, !tbaa !9 ; 4 uses
  ...
  %i.bg = fadd fast <2 x float> %i.ba, %i.az      ; 2 uses
  %i.bh = fmul fast <2 x float> %115, %i.ba       ; 2 uses
  ...
  %shift = shufflevector <2 x float> %115, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  ...
  %foldExtExtBinop319 = fmul fast <2 x float> %shift318, %115
  ...
  %i.bq = fadd fast <2 x float> %115, %i.ay       ; 2 uses
