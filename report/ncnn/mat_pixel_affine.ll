...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %middle.block, %bb.a
  ...
  %i.be = fadd fast float %i.bc, %i.bd
  ...
  %i.bp = fadd fast float %i.bc, %i.bo
  %i.bq = fadd fast float %i.bp, %.neg
  ...
  %i.dp = extractelement <4 x float> %i.cr, i64 2
  %i.dq = fadd fast float %i.dp, %i.do
  %i.dr = extractelement <4 x float> %i.cz, i64 3
