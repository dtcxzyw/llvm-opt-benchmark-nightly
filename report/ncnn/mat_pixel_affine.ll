...
bb.n:                                             ; preds = %._crit_edge675, %bb.m
  ...
  %.not370 = icmp samesign ult i32 %.pre-phi680, %1 ; 2 uses
  ...
  %.not372 = icmp samesign ult i32 %i.gi, %1      ; 2 uses
...
bb.s:                                             ; preds = %._crit_edge676, %bb.r
  ...
  %.not348 = icmp samesign ult i32 %.pre-phi, %1  ; 2 uses
  ...
  %.not350 = icmp samesign ult i32 %i.im, %1      ; 2 uses
...
bb.n:                                             ; preds = %._crit_edge727, %bb.m
  ...
  %.not408 = icmp samesign ult i32 %.pre-phi732, %1 ; 2 uses
  ...
  %.not410 = icmp samesign ult i32 %i.ie, %1      ; 2 uses
...
bb.s:                                             ; preds = %._crit_edge728, %bb.r
  ...
  %.not386 = icmp samesign ult i32 %.pre-phi, %1  ; 2 uses
  ...
  %.not388 = icmp samesign ult i32 %i.lh, %1      ; 2 uses
...
bb.n:                                             ; preds = %._crit_edge791, %bb.m
  ...
  %.not448 = icmp samesign ult i32 %.pre-phi796, %1 ; 2 uses
  ...
  %.not450 = icmp samesign ult i32 %i.jp, %1      ; 2 uses
...
bb.s:                                             ; preds = %._crit_edge792, %bb.r
  ...
  %.not426 = icmp samesign ult i32 %.pre-phi, %1  ; 2 uses
  ...
  %.not428 = icmp samesign ult i32 %i.nq, %1      ; 2 uses
...
bb.n:                                             ; preds = %._crit_edge855, %bb.m
  ...
  %.not488 = icmp samesign ult i32 %.pre-phi860, %1 ; 2 uses
  ...
  %.not490 = icmp samesign ult i32 %i.lc, %1      ; 2 uses
...
bb.s:                                             ; preds = %._crit_edge856, %bb.r
  ...
  %.not466 = icmp samesign ult i32 %.pre-phi, %1  ; 2 uses
  ...
  %.not468 = icmp samesign ult i32 %i.qb, %1      ; 2 uses
