...
._crit_edge3881.i:                                ; preds = %bb.jj, %.preheader.i
  ...
  %indvars.iv.next3937.i = add nuw nsw i64 %indvars.iv3936.i, 1 ; 2 uses
...
._crit_edge541.i:                                 ; preds = %.lr.ph540.i.prol.loopexit, %.lr.ph540.i, %middle.block160, %.preheader.i
  ...
  %indvars.iv.next596.i = add nuw nsw i64 %indvars.iv595.i, 1 ; 2 uses
...
.loopexit.i:                                      ; preds = %.lr.ph797.i.prol.loopexit, %.lr.ph797.i, %.lr.ph784.i, %.lr.ph778.i, %.preheader.i, %bb.u, %bb.t, %bb.s
  ...
  %indvars.iv.next855.i = add nuw nsw i64 %indvars.iv854.i, 1 ; 2 uses
...
.lr.ph29:                                         ; preds = %bb.a
  ...
  %unroll_iter = and i32 %4, 2147483640
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  %lcmp.mod448 = icmp ne i32 %xtraiter, 0
  %xtraiter449 = and i32 %4, 3                    ; 3 uses
  %i.x = icmp ult i32 %i.v, 3
  %unroll_iter454 = and i32 %4, 2147483644
  %lcmp.mod451.not = icmp eq i32 %xtraiter449, 0
  %lcmp.mod453 = icmp ne i32 %xtraiter449, 0
  br label %bb.b
...
.lr.ph61.split.us.preheader:                      ; preds = %.lr.ph61
  ...
  %invariant.op188 = add nsw i64 %i.ak, -3
  ...
  %min.iters.check301 = icmp ult i32 %4, 4
  %min.iters.check303 = icmp ult i32 %4, 16
  %i.as = and i64 %i.ar, 12
  %n.vec305 = and i64 %i.ar, 2147483632           ; 5 uses
  %i.at = shl nuw nsw i64 %n.vec305, 3            ; 2 uses
  %i.au = trunc nuw nsw i64 %n.vec305 to i32
  %cmp.n316 = icmp eq i64 %n.vec305, %i.ar
  %min.epilog.iters.check323 = icmp eq i64 %i.as, 0
  %n.vec325 = and i64 %i.ar, 2147483644           ; 4 uses
  %i.av = shl nuw nsw i64 %n.vec325, 3            ; 2 uses
  %i.aw = trunc nuw nsw i64 %n.vec325 to i32
  %cmp.n333 = icmp eq i64 %n.vec325, %i.ar
  br label %.lr.ph61.split.us

.lr.ph61.split.us:                                ; preds = %.lr.ph61.split.us.preheader, %.loopexit.us
  %indvar298 = phi i64 [ 0, %.lr.ph61.split.us.preheader ], [ %indvar.next299, %.loopexit.us ] ; 2 uses
  ...
  %.760.us297 = ptrtoaddr ptr %.760.us to i64
  %i.ax = mul i64 %i.aq, %indvar298
  ...
  br i1 %brmerge, label %.loopexit4.us, label %iter.check320

iter.check320:                                    ; preds = %.lr.ph61.split.us
  br i1 %min.iters.check301, label %.lr.ph35.us.preheader, label %vector.memcheck296

vector.memcheck296:                               ; preds = %iter.check320
  %i.bf = add i64 %i.ay, %.760.us297
  %i.bg = sub i64 %i.ba, %i.bf
  %diff.check300 = icmp ugt i64 %i.bg, -128
  br i1 %diff.check300, label %.lr.ph35.us.preheader, label %vector.main.loop.iter.check302

vector.main.loop.iter.check302:                   ; preds = %vector.memcheck296
  br i1 %min.iters.check303, label %vec.epilog.ph324, label %vector.ph304

vector.ph304:                                     ; preds = %vector.main.loop.iter.check302
...
vector.body306:                                   ; preds = %vector.body306, %vector.ph304
  %index307 = phi i64 [ 0, %vector.ph304 ], [ %index.next314, %vector.body306 ] ; 2 uses
  %i.bj = shl i64 %index307, 3                    ; 2 uses
  %next.gep308 = getelementptr i8, ptr %.760.us, i64 %i.bj ; 4 uses
  %next.gep309 = getelementptr i8, ptr %i.be, i64 %i.bj ; 4 uses
  %i.bk = getelementptr i8, ptr %next.gep309, i64 32
  %i.bl = getelementptr i8, ptr %next.gep309, i64 64
  %i.bm = getelementptr i8, ptr %next.gep309, i64 96
  %wide.load310 = load <4 x i64>, ptr %next.gep309, align 1, !tbaa !116
  %wide.load311 = load <4 x i64>, ptr %i.bk, align 1, !tbaa !116
  %wide.load312 = load <4 x i64>, ptr %i.bl, align 1, !tbaa !116
  %wide.load313 = load <4 x i64>, ptr %i.bm, align 1, !tbaa !116
  %i.bn = getelementptr i8, ptr %next.gep308, i64 32
  %i.bo = getelementptr i8, ptr %next.gep308, i64 64
  %i.bp = getelementptr i8, ptr %next.gep308, i64 96
  store <4 x i64> %wide.load310, ptr %next.gep308, align 1, !tbaa !116
  store <4 x i64> %wide.load311, ptr %i.bn, align 1, !tbaa !116
  store <4 x i64> %wide.load312, ptr %i.bo, align 1, !tbaa !116
  store <4 x i64> %wide.load313, ptr %i.bp, align 1, !tbaa !116
  %index.next314 = add nuw i64 %index307, 16      ; 2 uses
  %i.bq = icmp eq i64 %index.next314, %n.vec305
  br i1 %i.bq, label %middle.block315, label %vector.body306, !llvm.loop !1054

middle.block315:                                  ; preds = %vector.body306
  br i1 %cmp.n316, label %.loopexit4.us, label %vec.epilog.iter.check322

vec.epilog.iter.check322:                         ; preds = %middle.block315
  br i1 %min.epilog.iters.check323, label %.lr.ph35.us.preheader, label %vec.epilog.ph324, !prof !564

vec.epilog.ph324:                                 ; preds = %vector.main.loop.iter.check302, %vec.epilog.iter.check322
  %vec.epilog.resume.val317 = phi i64 [ %n.vec305, %vec.epilog.iter.check322 ], [ 0, %vector.main.loop.iter.check302 ]
...
vec.epilog.vector.body326:                        ; preds = %vec.epilog.vector.body326, %vec.epilog.ph324
  %index327 = phi i64 [ %vec.epilog.resume.val317, %vec.epilog.ph324 ], [ %index.next331, %vec.epilog.vector.body326 ] ; 2 uses
  %i.bt = shl i64 %index327, 3                    ; 2 uses
  %next.gep328 = getelementptr i8, ptr %.760.us, i64 %i.bt
  %next.gep329 = getelementptr i8, ptr %i.be, i64 %i.bt
  %wide.load330 = load <4 x i64>, ptr %next.gep329, align 1, !tbaa !116
  store <4 x i64> %wide.load330, ptr %next.gep328, align 1, !tbaa !116
  %index.next331 = add nuw i64 %index327, 4       ; 2 uses
  %i.bu = icmp eq i64 %index.next331, %n.vec325
  br i1 %i.bu, label %vec.epilog.middle.block332, label %vec.epilog.vector.body326, !llvm.loop !1055

vec.epilog.middle.block332:                       ; preds = %vec.epilog.vector.body326
  br i1 %cmp.n333, label %.loopexit4.us, label %.lr.ph35.us.preheader

.lr.ph35.us.preheader:                            ; preds = %vector.memcheck296, %iter.check320, %vec.epilog.iter.check322, %vec.epilog.middle.block332
  %.834.us.ph = phi ptr [ %.760.us, %iter.check320 ], [ %.760.us, %vector.memcheck296 ], [ %i.bh, %vec.epilog.iter.check322 ], [ %i.br, %vec.epilog.middle.block332 ] ; 2 uses
  %.018533.us.ph = phi i32 [ 0, %iter.check320 ], [ 0, %vector.memcheck296 ], [ %i.au, %vec.epilog.iter.check322 ], [ %i.aw, %vec.epilog.middle.block332 ] ; 4 uses
  %.018632.us.ph = phi ptr [ %i.be, %iter.check320 ], [ %i.be, %vector.memcheck296 ], [ %i.bi, %vec.epilog.iter.check322 ], [ %i.bs, %vec.epilog.middle.block332 ] ; 2 uses
  %i.bv = sub i32 %4, %.018533.us.ph
  %xtraiter458 = and i32 %i.bv, 7                 ; 2 uses
  %lcmp.mod459.not = icmp eq i32 %xtraiter458, 0
  br i1 %lcmp.mod459.not, label %.lr.ph35.us.prol.loopexit, label %.lr.ph35.us.prol
...
.lr.ph35.us.prol:                                 ; preds = %.lr.ph35.us.preheader, %.lr.ph35.us.prol
  ...
  %prol.iter460 = phi i32 [ %prol.iter460.next, %.lr.ph35.us.prol ], [ 0, %.lr.ph35.us.preheader ]
end_hunk_15
...
._crit_edge.us:                                   ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block368
  %.lcssa192 = phi ptr [ %i.qb, %middle.block368 ], [ %.lcssa432.unr, %scalar.ph.prol.loopexit ], [ %i.rn, %scalar.ph ] ; 2 uses
  %indvars.iv.next154 = add nuw nsw i64 %indvars.iv153, 2 ; 3 uses
  %i.rr = icmp slt i64 %indvars.iv.next154, %invariant.op189
...
.preheader:                                       ; preds = %.lr.ph91.split.preheader, %.preheader.loopexit, %.preheader1
  ...
  %.13.lcssa = phi ptr [ %.7.lcssa, %.preheader1 ], [ %.lcssa192, %.preheader.loopexit ], [ %.7.lcssa, %.lr.ph91.split.preheader ]
...
.lr.ph99.preheader:                               ; preds = %.lr.ph103
  ...
  %.neg = mul i64 %i.sc, -2
  %.neg422 = sub i64 %.neg, %i.rx
  %i.sd = mul i64 %i.k, -2
  %i.se = zext nneg i32 %4 to i64                 ; 5 uses
  %min.iters.check379 = icmp ult i32 %4, 8
  %min.iters.check381 = icmp ult i32 %4, 64
  %i.sf = and i64 %i.se, 56
  %n.vec383 = and i64 %i.se, 2147483584           ; 5 uses
  %i.sg = trunc nuw nsw i64 %n.vec383 to i32
  %i.sh = shl nuw nsw i64 %n.vec383, 1            ; 2 uses
  %cmp.n394 = icmp eq i64 %n.vec383, %i.se
  %min.epilog.iters.check402 = icmp eq i64 %i.sf, 0
  %n.vec404 = and i64 %i.se, 2147483640           ; 4 uses
  %i.si = trunc nuw nsw i64 %n.vec404 to i32
  %i.sj = shl nuw nsw i64 %n.vec404, 1            ; 2 uses
  %cmp.n412 = icmp eq i64 %n.vec404, %i.se
  br label %iter.check399

iter.check399:                                    ; preds = %.lr.ph99.preheader, %._crit_edge
  %indvar375 = phi i64 [ 0, %.lr.ph99.preheader ], [ %indvar.next376, %._crit_edge ] ; 2 uses
  %indvars.iv157 = phi i64 [ %i.ry, %.lr.ph99.preheader ], [ %indvars.iv.next158, %._crit_edge ] ; 2 uses
  %.15102 = phi ptr [ %.13.lcssa, %.lr.ph99.preheader ], [ %.lcssa, %._crit_edge ] ; 7 uses
  %i.sk = add nsw i64 %indvars.iv157, %i.rz
  %i.sl = mul i64 %i.k, %i.sk
  %gep = getelementptr [2 x i8], ptr %invariant.gep105, i64 %i.sl ; 6 uses
  br i1 %min.iters.check379, label %vec.epilog.scalar.ph400.preheader, label %vector.memcheck373

vector.memcheck373:                               ; preds = %iter.check399
  %i.sm = mul i64 %i.sd, %indvar375
  %i.sn = add i64 %.neg422, %i.sm
  %.15102374 = ptrtoaddr ptr %.15102 to i64
  %i.so = add i64 %i.sn, %.15102374
  %i.sp = add i64 %i.so, -1
  %diff.check377 = icmp ult i64 %i.sp, 127
  br i1 %diff.check377, label %vec.epilog.scalar.ph400.preheader, label %vector.main.loop.iter.check380

vector.main.loop.iter.check380:                   ; preds = %vector.memcheck373
  br i1 %min.iters.check381, label %vec.epilog.ph403, label %vector.ph382

vector.ph382:                                     ; preds = %vector.main.loop.iter.check380
...
vector.body384:                                   ; preds = %vector.body384, %vector.ph382
  %index385 = phi i64 [ 0, %vector.ph382 ], [ %index.next392, %vector.body384 ] ; 2 uses
  %i.ss = shl i64 %index385, 1                    ; 2 uses
  %next.gep386 = getelementptr i8, ptr %gep, i64 %i.ss ; 4 uses
  %next.gep387 = getelementptr i8, ptr %.15102, i64 %i.ss ; 4 uses
  %i.st = getelementptr i8, ptr %next.gep386, i64 32
  %i.su = getelementptr i8, ptr %next.gep386, i64 64
  %i.sv = getelementptr i8, ptr %next.gep386, i64 96
  %wide.load388 = load <16 x i16>, ptr %next.gep386, align 2, !tbaa !685
  %wide.load389 = load <16 x i16>, ptr %i.st, align 2, !tbaa !685
  %wide.load390 = load <16 x i16>, ptr %i.su, align 2, !tbaa !685
  %wide.load391 = load <16 x i16>, ptr %i.sv, align 2, !tbaa !685
  %i.sw = getelementptr i8, ptr %next.gep387, i64 32
  %i.sx = getelementptr i8, ptr %next.gep387, i64 64
  %i.sy = getelementptr i8, ptr %next.gep387, i64 96
  store <16 x i16> %wide.load388, ptr %next.gep387, align 2, !tbaa !685
  store <16 x i16> %wide.load389, ptr %i.sw, align 2, !tbaa !685
  store <16 x i16> %wide.load390, ptr %i.sx, align 2, !tbaa !685
  store <16 x i16> %wide.load391, ptr %i.sy, align 2, !tbaa !685
  %index.next392 = add nuw i64 %index385, 64      ; 2 uses
  %i.sz = icmp eq i64 %index.next392, %n.vec383
  br i1 %i.sz, label %middle.block393, label %vector.body384, !llvm.loop !1098

middle.block393:                                  ; preds = %vector.body384
  br i1 %cmp.n394, label %._crit_edge, label %vec.epilog.iter.check401

vec.epilog.iter.check401:                         ; preds = %middle.block393
  br i1 %min.epilog.iters.check402, label %vec.epilog.scalar.ph400.preheader, label %vec.epilog.ph403, !prof !1099

vec.epilog.ph403:                                 ; preds = %vector.main.loop.iter.check380, %vec.epilog.iter.check401
  %vec.epilog.resume.val395 = phi i64 [ %n.vec383, %vec.epilog.iter.check401 ], [ 0, %vector.main.loop.iter.check380 ]
...
vec.epilog.vector.body405:                        ; preds = %vec.epilog.vector.body405, %vec.epilog.ph403
  %index406 = phi i64 [ %vec.epilog.resume.val395, %vec.epilog.ph403 ], [ %index.next410, %vec.epilog.vector.body405 ] ; 2 uses
  %i.tc = shl i64 %index406, 1                    ; 2 uses
  %next.gep407 = getelementptr i8, ptr %gep, i64 %i.tc
  %next.gep408 = getelementptr i8, ptr %.15102, i64 %i.tc
  %wide.load409 = load <8 x i16>, ptr %next.gep407, align 2, !tbaa !685
  store <8 x i16> %wide.load409, ptr %next.gep408, align 2, !tbaa !685
  %index.next410 = add nuw i64 %index406, 8       ; 2 uses
  %i.td = icmp eq i64 %index.next410, %n.vec404
  br i1 %i.td, label %vec.epilog.middle.block411, label %vec.epilog.vector.body405, !llvm.loop !1100

vec.epilog.middle.block411:                       ; preds = %vec.epilog.vector.body405
  br i1 %cmp.n412, label %._crit_edge, label %vec.epilog.scalar.ph400.preheader

vec.epilog.scalar.ph400.preheader:                ; preds = %vector.memcheck373, %iter.check399, %vec.epilog.iter.check401, %vec.epilog.middle.block411
  %.098.ph = phi i32 [ 0, %iter.check399 ], [ 0, %vector.memcheck373 ], [ %i.sg, %vec.epilog.iter.check401 ], [ %i.si, %vec.epilog.middle.block411 ] ; 4 uses
  %.016297.ph = phi ptr [ %gep, %iter.check399 ], [ %gep, %vector.memcheck373 ], [ %i.sq, %vec.epilog.iter.check401 ], [ %i.ta, %vec.epilog.middle.block411 ] ; 2 uses
  %.1696.ph = phi ptr [ %.15102, %iter.check399 ], [ %.15102, %vector.memcheck373 ], [ %i.sr, %vec.epilog.iter.check401 ], [ %i.tb, %vec.epilog.middle.block411 ] ; 2 uses
  %i.te = sub i32 %4, %.098.ph
  %xtraiter467 = and i32 %i.te, 7                 ; 2 uses
  %lcmp.mod468.not = icmp eq i32 %xtraiter467, 0
  br i1 %lcmp.mod468.not, label %vec.epilog.scalar.ph400.prol.loopexit, label %vec.epilog.scalar.ph400.prol

vec.epilog.scalar.ph400.prol:                     ; preds = %vec.epilog.scalar.ph400.preheader, %vec.epilog.scalar.ph400.prol
  %.098.prol = phi i32 [ %i.ti, %vec.epilog.scalar.ph400.prol ], [ %.098.ph, %vec.epilog.scalar.ph400.preheader ]
  %.016297.prol = phi ptr [ %i.th, %vec.epilog.scalar.ph400.prol ], [ %.016297.ph, %vec.epilog.scalar.ph400.preheader ] ; 2 uses
  %.1696.prol = phi ptr [ %i.tg, %vec.epilog.scalar.ph400.prol ], [ %.1696.ph, %vec.epilog.scalar.ph400.preheader ] ; 2 uses
  %prol.iter469 = phi i32 [ %prol.iter469.next, %vec.epilog.scalar.ph400.prol ], [ 0, %vec.epilog.scalar.ph400.preheader ]
  ...
  %prol.iter469.next = add i32 %prol.iter469, 1   ; 2 uses
  %prol.iter469.cmp.not = icmp eq i32 %prol.iter469.next, %xtraiter467
  br i1 %prol.iter469.cmp.not, label %vec.epilog.scalar.ph400.prol.loopexit, label %vec.epilog.scalar.ph400.prol, !llvm.loop !1101

vec.epilog.scalar.ph400.prol.loopexit:            ; preds = %vec.epilog.scalar.ph400.prol, %vec.epilog.scalar.ph400.preheader
  %.lcssa431.unr = phi ptr [ poison, %vec.epilog.scalar.ph400.preheader ], [ %i.tg, %vec.epilog.scalar.ph400.prol ]
  %.098.unr = phi i32 [ %.098.ph, %vec.epilog.scalar.ph400.preheader ], [ %i.ti, %vec.epilog.scalar.ph400.prol ]
  %.016297.unr = phi ptr [ %.016297.ph, %vec.epilog.scalar.ph400.preheader ], [ %i.th, %vec.epilog.scalar.ph400.prol ]
  %.1696.unr = phi ptr [ %.1696.ph, %vec.epilog.scalar.ph400.preheader ], [ %i.tg, %vec.epilog.scalar.ph400.prol ]
  %i.tj = sub i32 %.098.ph, %4
  %i.tk = icmp ugt i32 %i.tj, -8
  br i1 %i.tk, label %._crit_edge, label %vec.epilog.scalar.ph400

vec.epilog.scalar.ph400:                          ; preds = %vec.epilog.scalar.ph400.prol.loopexit, %vec.epilog.scalar.ph400
  %.098 = phi i32 [ %i.uj, %vec.epilog.scalar.ph400 ], [ %.098.unr, %vec.epilog.scalar.ph400.prol.loopexit ]
  %.016297 = phi ptr [ %i.ui, %vec.epilog.scalar.ph400 ], [ %.016297.unr, %vec.epilog.scalar.ph400.prol.loopexit ] ; 9 uses
  %.1696 = phi ptr [ %i.uh, %vec.epilog.scalar.ph400 ], [ %.1696.unr, %vec.epilog.scalar.ph400.prol.loopexit ] ; 9 uses
  ...
  %exitcond156.not.7 = icmp eq i32 %i.uj, %4
  br i1 %exitcond156.not.7, label %._crit_edge, label %vec.epilog.scalar.ph400, !llvm.loop !1102

._crit_edge:                                      ; preds = %vec.epilog.scalar.ph400.prol.loopexit, %vec.epilog.scalar.ph400, %vec.epilog.middle.block411, %middle.block393
  %.lcssa = phi ptr [ %i.tb, %vec.epilog.middle.block411 ], [ %i.sr, %middle.block393 ], [ %.lcssa431.unr, %vec.epilog.scalar.ph400.prol.loopexit ], [ %i.uh, %vec.epilog.scalar.ph400 ]
  ...
  br i1 %exitcond160.not, label %._crit_edge104.split, label %iter.check399, !llvm.loop !1103
...
.lr.ph28:                                         ; preds = %bb.a
  ...
  %unroll_iter = and i32 %4, 2147483640
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  %lcmp.mod411 = icmp ne i32 %xtraiter, 0
  %xtraiter412 = and i32 %4, 3                    ; 3 uses
  %i.x = icmp ult i32 %i.v, 3
  %unroll_iter417 = and i32 %4, 2147483644
...
.lr.ph47.split.us.preheader:                      ; preds = %.lr.ph47
  ...
  %brmerge = or i1 %i.ad, %i.ae
  %invariant.op166 = add nsw i64 %i.aj, -3
  %i.ak = add i32 %4, -1
  ...
  %min.iters.check269 = icmp ult i32 %4, 4
  %min.iters.check271 = icmp ult i32 %4, 16
  %i.ba = and i64 %i.az, 12
  %n.vec273 = and i64 %i.az, 2147483632           ; 5 uses
end_hunk_16
...
._crit_edge.us:                                   ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block336
  %.lcssa170 = phi ptr [ %i.pd, %middle.block336 ], [ %.lcssa400.unr, %scalar.ph.prol.loopexit ], [ %i.qp, %scalar.ph ] ; 2 uses
  %indvars.iv.next134 = add nuw nsw i64 %indvars.iv133, 2 ; 3 uses
  %i.qt = icmp slt i64 %indvars.iv.next134, %invariant.op167
...
.preheader:                                       ; preds = %.lr.ph77.split.preheader, %.preheader.loopexit, %.preheader1
  %.12.lcssa = phi ptr [ %.7.lcssa, %.preheader1 ], [ %.lcssa170, %.preheader.loopexit ], [ %.7.lcssa, %.lr.ph77.split.preheader ]
...
.lr.ph85.preheader:                               ; preds = %.lr.ph89
  ...
  %.neg = mul i64 %i.re, -2
  %.neg390 = sub i64 %.neg, %i.qz
  %i.rf = mul i64 %i.k, -2
  %i.rg = zext nneg i32 %4 to i64                 ; 5 uses
  %min.iters.check347 = icmp ult i32 %4, 8
  %min.iters.check349 = icmp ult i32 %4, 64
  %i.rh = and i64 %i.rg, 56
  %n.vec351 = and i64 %i.rg, 2147483584           ; 5 uses
  %i.ri = trunc nuw nsw i64 %n.vec351 to i32
  %i.rj = shl nuw nsw i64 %n.vec351, 1            ; 2 uses
  %cmp.n362 = icmp eq i64 %n.vec351, %i.rg
  %min.epilog.iters.check370 = icmp eq i64 %i.rh, 0
  %n.vec372 = and i64 %i.rg, 2147483640           ; 4 uses
  %i.rk = trunc nuw nsw i64 %n.vec372 to i32
  %i.rl = shl nuw nsw i64 %n.vec372, 1            ; 2 uses
  %cmp.n380 = icmp eq i64 %n.vec372, %i.rg
  br label %iter.check367

iter.check367:                                    ; preds = %.lr.ph85.preheader, %._crit_edge
  %indvar343 = phi i64 [ 0, %.lr.ph85.preheader ], [ %indvar.next344, %._crit_edge ] ; 2 uses
  %indvars.iv137 = phi i64 [ %i.ra, %.lr.ph85.preheader ], [ %indvars.iv.next138, %._crit_edge ] ; 2 uses
  %.1487 = phi ptr [ %.12.lcssa, %.lr.ph85.preheader ], [ %.lcssa, %._crit_edge ] ; 7 uses
  %i.rm = add nsw i64 %indvars.iv137, %i.rb
  %i.rn = mul i64 %i.k, %i.rm
  %gep = getelementptr [2 x i8], ptr %invariant.gep91, i64 %i.rn ; 6 uses
  br i1 %min.iters.check347, label %vec.epilog.scalar.ph368.preheader, label %vector.memcheck341

vector.memcheck341:                               ; preds = %iter.check367
  %i.ro = mul i64 %i.rf, %indvar343
  %i.rp = add i64 %.neg390, %i.ro
  %.1487342 = ptrtoaddr ptr %.1487 to i64
  %i.rq = add i64 %i.rp, %.1487342
  %i.rr = add i64 %i.rq, -1
  %diff.check345 = icmp ult i64 %i.rr, 127
  br i1 %diff.check345, label %vec.epilog.scalar.ph368.preheader, label %vector.main.loop.iter.check348

vector.main.loop.iter.check348:                   ; preds = %vector.memcheck341
  br i1 %min.iters.check349, label %vec.epilog.ph371, label %vector.ph350
...
vector.body352:                                   ; preds = %vector.body352, %vector.ph350
  %index353 = phi i64 [ 0, %vector.ph350 ], [ %index.next360, %vector.body352 ] ; 2 uses
  %i.ru = shl i64 %index353, 1                    ; 2 uses
  %next.gep354 = getelementptr i8, ptr %gep, i64 %i.ru ; 4 uses
  %next.gep355 = getelementptr i8, ptr %.1487, i64 %i.ru ; 4 uses
  %i.rv = getelementptr i8, ptr %next.gep354, i64 32
  %i.rw = getelementptr i8, ptr %next.gep354, i64 64
  %i.rx = getelementptr i8, ptr %next.gep354, i64 96
  %wide.load356 = load <16 x i16>, ptr %next.gep354, align 2, !tbaa !685
  %wide.load357 = load <16 x i16>, ptr %i.rv, align 2, !tbaa !685
  %wide.load358 = load <16 x i16>, ptr %i.rw, align 2, !tbaa !685
  %wide.load359 = load <16 x i16>, ptr %i.rx, align 2, !tbaa !685
  %i.ry = getelementptr i8, ptr %next.gep355, i64 32
  %i.rz = getelementptr i8, ptr %next.gep355, i64 64
  %i.sa = getelementptr i8, ptr %next.gep355, i64 96
  store <16 x i16> %wide.load356, ptr %next.gep355, align 2, !tbaa !685
  store <16 x i16> %wide.load357, ptr %i.ry, align 2, !tbaa !685
  store <16 x i16> %wide.load358, ptr %i.rz, align 2, !tbaa !685
  store <16 x i16> %wide.load359, ptr %i.sa, align 2, !tbaa !685
  %index.next360 = add nuw i64 %index353, 64      ; 2 uses
  %i.sb = icmp eq i64 %index.next360, %n.vec351
  br i1 %i.sb, label %middle.block361, label %vector.body352, !llvm.loop !1149

middle.block361:                                  ; preds = %vector.body352
  br i1 %cmp.n362, label %._crit_edge, label %vec.epilog.iter.check369

vec.epilog.iter.check369:                         ; preds = %middle.block361
  br i1 %min.epilog.iters.check370, label %vec.epilog.scalar.ph368.preheader, label %vec.epilog.ph371, !prof !1099

vec.epilog.ph371:                                 ; preds = %vector.main.loop.iter.check348, %vec.epilog.iter.check369
  %vec.epilog.resume.val363 = phi i64 [ %n.vec351, %vec.epilog.iter.check369 ], [ 0, %vector.main.loop.iter.check348 ]
  %i.sc = getelementptr i8, ptr %gep, i64 %i.rl
  %i.sd = getelementptr i8, ptr %.1487, i64 %i.rl ; 2 uses
  br label %vec.epilog.vector.body373

vec.epilog.vector.body373:                        ; preds = %vec.epilog.vector.body373, %vec.epilog.ph371
  %index374 = phi i64 [ %vec.epilog.resume.val363, %vec.epilog.ph371 ], [ %index.next378, %vec.epilog.vector.body373 ] ; 2 uses
  %i.se = shl i64 %index374, 1                    ; 2 uses
  %next.gep375 = getelementptr i8, ptr %gep, i64 %i.se
  %next.gep376 = getelementptr i8, ptr %.1487, i64 %i.se
  %wide.load377 = load <8 x i16>, ptr %next.gep375, align 2, !tbaa !685
  store <8 x i16> %wide.load377, ptr %next.gep376, align 2, !tbaa !685
  %index.next378 = add nuw i64 %index374, 8       ; 2 uses
  %i.sf = icmp eq i64 %index.next378, %n.vec372
  br i1 %i.sf, label %vec.epilog.middle.block379, label %vec.epilog.vector.body373, !llvm.loop !1150

vec.epilog.middle.block379:                       ; preds = %vec.epilog.vector.body373
  br i1 %cmp.n380, label %._crit_edge, label %vec.epilog.scalar.ph368.preheader

vec.epilog.scalar.ph368.preheader:                ; preds = %vector.memcheck341, %iter.check367, %vec.epilog.iter.check369, %vec.epilog.middle.block379
  %.084.ph = phi i32 [ 0, %iter.check367 ], [ 0, %vector.memcheck341 ], [ %i.ri, %vec.epilog.iter.check369 ], [ %i.rk, %vec.epilog.middle.block379 ] ; 4 uses
  %.013883.ph = phi ptr [ %gep, %iter.check367 ], [ %gep, %vector.memcheck341 ], [ %i.rs, %vec.epilog.iter.check369 ], [ %i.sc, %vec.epilog.middle.block379 ] ; 2 uses
  %.1582.ph = phi ptr [ %.1487, %iter.check367 ], [ %.1487, %vector.memcheck341 ], [ %i.rt, %vec.epilog.iter.check369 ], [ %i.sd, %vec.epilog.middle.block379 ] ; 2 uses
  %i.sg = sub i32 %4, %.084.ph
  %xtraiter430 = and i32 %i.sg, 7                 ; 2 uses
  %lcmp.mod431.not = icmp eq i32 %xtraiter430, 0
  br i1 %lcmp.mod431.not, label %vec.epilog.scalar.ph368.prol.loopexit, label %vec.epilog.scalar.ph368.prol

vec.epilog.scalar.ph368.prol:                     ; preds = %vec.epilog.scalar.ph368.preheader, %vec.epilog.scalar.ph368.prol
  %.084.prol = phi i32 [ %i.sk, %vec.epilog.scalar.ph368.prol ], [ %.084.ph, %vec.epilog.scalar.ph368.preheader ]
  %.013883.prol = phi ptr [ %i.sj, %vec.epilog.scalar.ph368.prol ], [ %.013883.ph, %vec.epilog.scalar.ph368.preheader ] ; 2 uses
  %.1582.prol = phi ptr [ %i.si, %vec.epilog.scalar.ph368.prol ], [ %.1582.ph, %vec.epilog.scalar.ph368.preheader ] ; 2 uses
  %prol.iter432 = phi i32 [ %prol.iter432.next, %vec.epilog.scalar.ph368.prol ], [ 0, %vec.epilog.scalar.ph368.preheader ]
  ...
  br i1 %prol.iter432.cmp.not, label %vec.epilog.scalar.ph368.prol.loopexit, label %vec.epilog.scalar.ph368.prol, !llvm.loop !1151

vec.epilog.scalar.ph368.prol.loopexit:            ; preds = %vec.epilog.scalar.ph368.prol, %vec.epilog.scalar.ph368.preheader
  %.lcssa399.unr = phi ptr [ poison, %vec.epilog.scalar.ph368.preheader ], [ %i.si, %vec.epilog.scalar.ph368.prol ]
  %.084.unr = phi i32 [ %.084.ph, %vec.epilog.scalar.ph368.preheader ], [ %i.sk, %vec.epilog.scalar.ph368.prol ]
  %.013883.unr = phi ptr [ %.013883.ph, %vec.epilog.scalar.ph368.preheader ], [ %i.sj, %vec.epilog.scalar.ph368.prol ]
  %.1582.unr = phi ptr [ %.1582.ph, %vec.epilog.scalar.ph368.preheader ], [ %i.si, %vec.epilog.scalar.ph368.prol ]
  %i.sl = sub i32 %.084.ph, %4
  %i.sm = icmp ugt i32 %i.sl, -8
  br i1 %i.sm, label %._crit_edge, label %vec.epilog.scalar.ph368

vec.epilog.scalar.ph368:                          ; preds = %vec.epilog.scalar.ph368.prol.loopexit, %vec.epilog.scalar.ph368
  %.084 = phi i32 [ %i.tl, %vec.epilog.scalar.ph368 ], [ %.084.unr, %vec.epilog.scalar.ph368.prol.loopexit ]
  %.013883 = phi ptr [ %i.tk, %vec.epilog.scalar.ph368 ], [ %.013883.unr, %vec.epilog.scalar.ph368.prol.loopexit ] ; 9 uses
  %.1582 = phi ptr [ %i.tj, %vec.epilog.scalar.ph368 ], [ %.1582.unr, %vec.epilog.scalar.ph368.prol.loopexit ] ; 9 uses
  ...
  %exitcond136.not.7 = icmp eq i32 %i.tl, %4
  br i1 %exitcond136.not.7, label %._crit_edge, label %vec.epilog.scalar.ph368, !llvm.loop !1152

._crit_edge:                                      ; preds = %vec.epilog.scalar.ph368.prol.loopexit, %vec.epilog.scalar.ph368, %vec.epilog.middle.block379, %middle.block361
  %.lcssa = phi ptr [ %i.sd, %vec.epilog.middle.block379 ], [ %i.rt, %middle.block361 ], [ %.lcssa399.unr, %vec.epilog.scalar.ph368.prol.loopexit ], [ %i.tj, %vec.epilog.scalar.ph368 ]
  ...
  br i1 %exitcond140.not, label %._crit_edge90.split, label %iter.check367, !llvm.loop !1153
...
._crit_edge1990:                                  ; preds = %bb.om, %.preheader
  ...
  %indvars.iv.next2057 = add nuw nsw i64 %indvars.iv2056, 1 ; 2 uses
