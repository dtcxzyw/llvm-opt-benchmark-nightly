...
.preheader306:                                    ; preds = %._crit_edge344, %.preheader307
  %.1519.lcssa = phi i32 [ %.0518.lcssa, %.preheader307 ], [ %i.fk, %._crit_edge344 ] ; 6 uses
...
.lr.ph371.split.split.us.preheader:               ; preds = %.lr.ph371.split
  %i.ds = sub i32 %4, %.1519.lcssa                ; 2 uses
...
.preheader301:                                    ; preds = %._crit_edge446, %.preheader302
  ...
  %.1560.lcssa = phi i32 [ %.0559.lcssa, %.preheader302 ], [ %i.mk, %._crit_edge446 ] ; 6 uses
...
.lr.ph473.split.split.us.preheader:               ; preds = %.lr.ph473.split
  %i.kt = sub i32 %5, %.1560.lcssa                ; 2 uses
