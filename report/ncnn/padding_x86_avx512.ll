...
bb.x:                                             ; preds = %_ZNK4ncnn3Mat5emptyEv.exit335
  ...
  %6 = load <1 x float>, ptr %i.dj, align 4
  %i.dk = shufflevector <1 x float> %6, <1 x float> poison, <16 x i32> zeroinitializer
...
bb.ac:                                            ; preds = %_ZNK4ncnn3Mat5emptyEv.exit334
  ...
  %7 = load <1 x float>, ptr %i.ev, align 4
  %i.ew = shufflevector <1 x float> %7, <1 x float> poison, <16 x i32> zeroinitializer
...
bb.au:                                            ; preds = %_ZNK4ncnn3Mat5emptyEv.exit331
  ...
  %8 = load <1 x float>, ptr %i.jm, align 4
  %i.jn = shufflevector <1 x float> %8, <1 x float> poison, <8 x i32> zeroinitializer
...
bb.ay:                                            ; preds = %_ZNK4ncnn3Mat5emptyEv.exit330
  ...
  %9 = load <1 x float>, ptr %i.ld, align 4
  %i.le = shufflevector <1 x float> %9, <1 x float> poison, <8 x i32> zeroinitializer
...
bb.bn:                                            ; preds = %_ZNK4ncnn3Mat5emptyEv.exit327
  ...
  %10 = load <1 x float>, ptr %i.ps, align 4
  %i.pt = shufflevector <1 x float> %10, <1 x float> poison, <4 x i32> zeroinitializer
...
bb.br:                                            ; preds = %_ZNK4ncnn3Mat5emptyEv.exit326
  ...
  %11 = load <1 x float>, ptr %i.rj, align 4
  %i.rk = shufflevector <1 x float> %11, <1 x float> poison, <4 x i32> zeroinitializer
