...
.lr.ph3269.us.i.new:                              ; preds = %.lr.ph3269.us.i, %.lr.ph3269.us.i.new
  ...
  %i.djp = fadd fast <2 x float> %i.djo, %i.djg
  ...
  %i.dju = fadd fast <2 x float> %i.djp, %i.djt
  ...
  %i.dkf = fadd fast <2 x float> %i.dke, %i.dju
  ...
  %i.dkk = fadd fast <2 x float> %i.dkf, %i.dkj   ; 3 uses
...
.epil.preheader846:                               ; preds = %._crit_edge3270.us.i.unr-lcssa, %.lr.ph3269.us.i
  ...
  %i.dkv = fadd fast <2 x float> %i.dku, %.epil.init
  ...
  %i.dla = fadd fast <2 x float> %i.dkv, %i.dkz
...
.lr.ph3456.us.i.new:                              ; preds = %.lr.ph3456.us.i, %.lr.ph3456.us.i.new
  ...
  %i.ehb = fadd fast float %i.eha, %.213183451.us.i
  ...
  %i.ehh = fadd fast float %i.ehb, %i.ehg
  ...
  %i.ehn = fadd fast float %i.ehm, %i.ehh
  ...
  %i.eht = fadd fast float %i.ehn, %i.ehs         ; 3 uses
...
.epil.preheader913:                               ; preds = %._crit_edge3457.us.i.unr-lcssa, %.lr.ph3456.us.i
  ...
  %i.ehz = fadd fast float %i.ehy, %.213183451.us.i.epil.init
  ...
  %i.eif = fadd fast float %i.ehz, %i.eie
...
bb.at:                                            ; preds = %.lr.ph3661.us, %bb.at
  ...
  %i.enh = fadd fast <2 x float> %i.eng, %i.emq
  ...
  %i.enq = fadd fast <2 x float> %i.enh, %i.enp   ; 3 uses
...
bb.bi:                                            ; preds = %.lr.ph3848.us, %bb.bi
  ...
  %i.fla = fadd fast float %i.fkz, %.213243843.us
  ...
  %i.flm = fadd fast float %i.fla, %i.fll         ; 3 uses
