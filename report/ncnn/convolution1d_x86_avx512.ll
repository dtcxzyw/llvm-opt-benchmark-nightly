...
begin_hunk_0_@_ZN4ncnn24Convolution1D_x86_avx51215create_pipelineERKNS_6OptionE:bb.a
  %i.alc = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.alb, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.alc, ptr %i.akz, align 32, !tbaa !45
  %i.ald = getelementptr inbounds nuw [4 x i8], ptr %i.alb, i64 %i.ko
  %i.ale = getelementptr inbounds nuw i8, ptr %.812481747.us.i, i64 224
  %i.alf = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.ald, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.alf, ptr %i.ale, align 32, !tbaa !45
  %i.alg = getelementptr inbounds nuw i8, ptr %.812481747.us.i, i64 256 ; 3 uses
  ...
  br i1 %niter614.ncmp.3, label %._crit_edge1748.us.i.unr-lcssa, label %.preheader1575.us.i.new, !llvm.loop !97
...
.epil.preheader607:                               ; preds = %._crit_edge1748.us.i.unr-lcssa, %.preheader1575.us.i
  ...
  %.812481747.us.i.epil.init = phi ptr [ %.712471751.us.i, %.preheader1575.us.i ], [ %i.alg, %._crit_edge1748.us.i.unr-lcssa ]
...
bb.bg:                                            ; preds = %bb.bg, %.epil.preheader607
  ...
  %.812481747.us.i.epil = phi ptr [ %.812481747.us.i.epil.init, %.epil.preheader607 ], [ %i.alm, %bb.bg ] ; 3 uses
  %epil.iter609 = phi i64 [ 0, %.epil.preheader607 ], [ %epil.iter609.next, %bb.bg ]
  %i.alh = getelementptr inbounds nuw [4 x i8], ptr %.312231752.us.i, i64 %indvars.iv2251.i.epil ; 2 uses
  %i.ali = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr %i.alh, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.ali, ptr %.812481747.us.i.epil, align 32, !tbaa !45
  %i.alj = getelementptr inbounds nuw [4 x i8], ptr %i.alh, i64 %i.ko
  %i.alk = getelementptr inbounds nuw i8, ptr %.812481747.us.i.epil, i64 32
  %i.all = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr %i.alj, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.all, ptr %i.alk, align 32, !tbaa !45
  %i.alm = getelementptr inbounds nuw i8, ptr %.812481747.us.i.epil, i64 64 ; 2 uses
  ...
  br i1 %epil.iter609.cmp.not, label %._crit_edge1748.us.i, label %bb.bg, !llvm.loop !98

._crit_edge1748.us.i:                             ; preds = %bb.bg, %._crit_edge1748.us.i.unr-lcssa
  %.lcssa566 = phi ptr [ %i.alg, %._crit_edge1748.us.i.unr-lcssa ], [ %i.alm, %bb.bg ] ; 2 uses
  %i.aln = getelementptr inbounds nuw [4 x i8], ptr %.312231752.us.i, i64 %i.ks ; 2 uses
  %i.alo = add nuw nsw i32 %.312551750.us.i, 2    ; 3 uses
  %i.alp = or disjoint i32 %i.alo, 1
  %i.alq = icmp slt i32 %i.alp, %i.n
  br i1 %i.alq, label %.preheader1575.us.i, label %.preheader1579.i, !llvm.loop !99

.preheader1579.i:                                 ; preds = %._crit_edge1748.us.i, %.preheader1580.i
  %.31255.lcssa.i = phi i32 [ %.21254.lcssa.i, %.preheader1580.i ], [ %i.alo, %._crit_edge1748.us.i ] ; 2 uses
  %.71247.lcssa.i = phi ptr [ %.41244.lcssa.i, %.preheader1580.i ], [ %.lcssa566, %._crit_edge1748.us.i ]
  %.31223.lcssa.i = phi ptr [ %.21222.lcssa.i, %.preheader1580.i ], [ %i.aln, %._crit_edge1748.us.i ] ; 9 uses
  %i.alr = icmp sge i32 %.31255.lcssa.i, %i.n
  %brmerge1998.i = or i1 %i.kt, %i.alr
...
.preheader1574.i:                                 ; preds = %.preheader1579.i, %._crit_edge1761.i
  ...
  %.412561763.i = phi i32 [ %i.alv, %._crit_edge1761.i ], [ %.31255.lcssa.i, %.preheader1579.i ]
...
.epil.preheader615:                               ; preds = %._crit_edge1761.i.unr-lcssa, %.preheader1574.i
  ...
  %.1112511760.i.epil.init = phi ptr [ %.1012501764.i, %.preheader1574.i ], [ %i.ana, %._crit_edge1761.i.unr-lcssa ]
...
bb.bh:                                            ; preds = %bb.bh, %.epil.preheader615
  ...
  %.1112511760.i.epil = phi ptr [ %.1112511760.i.epil.init, %.epil.preheader615 ], [ %i.alu, %bb.bh ] ; 2 uses
  %epil.iter617 = phi i64 [ 0, %.epil.preheader615 ], [ %epil.iter617.next, %bb.bh ]
  %i.als = getelementptr inbounds nuw [4 x i8], ptr %.31223.lcssa.i, i64 %indvars.iv2256.i.epil
  %i.alt = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr %i.als, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.alt, ptr %.1112511760.i.epil, align 32, !tbaa !45
  %i.alu = getelementptr inbounds nuw i8, ptr %.1112511760.i.epil, i64 32 ; 2 uses
  ...
  br i1 %epil.iter617.cmp.not, label %._crit_edge1761.i, label %bb.bh, !llvm.loop !100

._crit_edge1761.i:                                ; preds = %bb.bh, %._crit_edge1761.i.unr-lcssa
  %.lcssa569 = phi ptr [ %i.ana, %._crit_edge1761.i.unr-lcssa ], [ %i.alu, %bb.bh ]
  %i.alv = add nuw nsw i32 %.412561763.i, 1       ; 2 uses
  %exitcond2261.not.i = icmp eq i32 %i.alv, %i.n
  br i1 %exitcond2261.not.i, label %._crit_edge1765.split.i, label %.preheader1574.i, !llvm.loop !101
...
.preheader1574.i.new:                             ; preds = %.preheader1574.i, %.preheader1574.i.new
  ...
  %.1112511760.i = phi ptr [ %i.ana, %.preheader1574.i.new ], [ %.1012501764.i, %.preheader1574.i ] ; 9 uses
  %niter622 = phi i64 [ %niter622.next.7, %.preheader1574.i.new ], [ 0, %.preheader1574.i ]
  %i.alw = getelementptr inbounds nuw [4 x i8], ptr %.31223.lcssa.i, i64 %indvars.iv2256.i
  %i.alx = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr %i.alw, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.alx, ptr %.1112511760.i, align 32, !tbaa !45
  %i.aly = getelementptr inbounds nuw i8, ptr %.1112511760.i, i64 32
  %i.alz = getelementptr inbounds nuw [4 x i8], ptr %.31223.lcssa.i, i64 %indvars.iv2256.i
  %i.ama = getelementptr inbounds nuw i8, ptr %i.alz, i64 4
  %i.amb = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.ama, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.amb, ptr %i.aly, align 32, !tbaa !45
  %i.amc = getelementptr inbounds nuw i8, ptr %.1112511760.i, i64 64
  %i.amd = getelementptr inbounds nuw [4 x i8], ptr %.31223.lcssa.i, i64 %indvars.iv2256.i
  %i.ame = getelementptr inbounds nuw i8, ptr %i.amd, i64 8
  %i.amf = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.ame, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.amf, ptr %i.amc, align 32, !tbaa !45
  %i.amg = getelementptr inbounds nuw i8, ptr %.1112511760.i, i64 96
  %i.amh = getelementptr inbounds nuw [4 x i8], ptr %.31223.lcssa.i, i64 %indvars.iv2256.i
  %i.ami = getelementptr inbounds nuw i8, ptr %i.amh, i64 12
  %i.amj = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.ami, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.amj, ptr %i.amg, align 32, !tbaa !45
  %i.amk = getelementptr inbounds nuw i8, ptr %.1112511760.i, i64 128
  %i.aml = getelementptr inbounds nuw [4 x i8], ptr %.31223.lcssa.i, i64 %indvars.iv2256.i
  %i.amm = getelementptr inbounds nuw i8, ptr %i.aml, i64 16
  %i.amn = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.amm, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.amn, ptr %i.amk, align 32, !tbaa !45
  %i.amo = getelementptr inbounds nuw i8, ptr %.1112511760.i, i64 160
  %i.amp = getelementptr inbounds nuw [4 x i8], ptr %.31223.lcssa.i, i64 %indvars.iv2256.i
  %i.amq = getelementptr inbounds nuw i8, ptr %i.amp, i64 20
  %i.amr = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.amq, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.amr, ptr %i.amo, align 32, !tbaa !45
  %i.ams = getelementptr inbounds nuw i8, ptr %.1112511760.i, i64 192
  %i.amt = getelementptr inbounds nuw [4 x i8], ptr %.31223.lcssa.i, i64 %indvars.iv2256.i
  %i.amu = getelementptr inbounds nuw i8, ptr %i.amt, i64 24
  %i.amv = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.amu, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.amv, ptr %i.ams, align 32, !tbaa !45
  %i.amw = getelementptr inbounds nuw i8, ptr %.1112511760.i, i64 224
  %i.amx = getelementptr inbounds nuw [4 x i8], ptr %.31223.lcssa.i, i64 %indvars.iv2256.i
  %i.amy = getelementptr inbounds nuw i8, ptr %i.amx, i64 28
  %i.amz = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.amy, <8 x i32> %i.kn, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.amz, ptr %i.amw, align 32, !tbaa !45
  %i.ana = getelementptr inbounds nuw i8, ptr %.1112511760.i, i64 256 ; 3 uses
  ...
  br i1 %niter622.ncmp.7, label %._crit_edge1761.i.unr-lcssa, label %.preheader1574.i.new, !llvm.loop !102
...
._crit_edge1765.split.i:                          ; preds = %._crit_edge1761.i, %.preheader1579.i, %.preheader1575.lr.ph.i, %.preheader1576.lr.ph.i
  ...
  %i.anb = icmp slt i64 %indvars.iv.next2265.i, %invariant.op.i
  %indvars.iv.next2206.i = add i32 %indvars.iv2205.i, %i.la
  %indvars.iv.next2263.i = add i32 %indvars.iv2262.i, 8
  br i1 %i.anb, label %_ZN4ncnn3MatD2Ev.exit1327.i, label %.preheader1573.loopexit.i, !llvm.loop !103

.preheader1564.loopexit.i:                        ; preds = %._crit_edge1851.split.i
  %i.anc = trunc nsw i64 %indvars.iv.next2317.i to i32
  br label %.preheader1564.i

.preheader1564.i:                                 ; preds = %.preheader1564.loopexit.i, %.preheader1573.i
  %.2.lcssa.i = phi i32 [ %.1.lcssa.i, %.preheader1573.i ], [ %i.anc, %.preheader1564.loopexit.i ] ; 4 uses
  %i.and = or disjoint i32 %.2.lcssa.i, 1         ; 3 uses
  %i.ane = icmp slt i32 %i.and, %i.m
  br i1 %i.ane, label %_ZN4ncnn3MatD2Ev.exit1325.lr.ph.i, label %.preheader1554.i

_ZN4ncnn3MatD2Ev.exit1325.lr.ph.i:                ; preds = %.preheader1564.i
  %i.anf = mul i32 %i.n, %i.j                     ; 5 uses
  %i.ang = getelementptr inbounds nuw i8, ptr %0, i64 536
  %i.anh = getelementptr inbounds nuw i8, ptr %0, i64 488
  %i.ani = insertelement <4 x i32> poison, i32 %i.j, i64 0
  %i.anj = shufflevector <4 x i32> %i.ani, <4 x i32> poison, <4 x i32> zeroinitializer
  %i.ank = mul <4 x i32> %i.anj, <i32 0, i32 1, i32 2, i32 3> ; 10 uses
  %i.anl = insertelement <8 x i32> poison, i32 %i.j, i64 0
  %i.anm = shufflevector <8 x i32> %i.anl, <8 x i32> poison, <8 x i32> zeroinitializer
  %i.ann = mul <8 x i32> %i.anm, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7> ; 10 uses
  %i.ano = insertelement <16 x i32> poison, i32 %i.j, i64 0
  %i.anp = shufflevector <16 x i32> %i.ano, <16 x i32> poison, <16 x i32> zeroinitializer
  %i.anq = mul <16 x i32> %i.anp, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15> ; 10 uses
  %i.anr = icmp sgt i32 %i.n, 15
  %i.ans = icmp sgt i32 %i.j, 0                   ; 4 uses
  %i.ant = shl i32 %i.j, 4
  %i.anu = sext i32 %i.ant to i64                 ; 3 uses
  %i.anv = shl i32 %i.j, 3
  %i.anw = sext i32 %i.anv to i64                 ; 3 uses
  %i.anx = shl i32 %i.j, 2
  %i.any = sext i32 %i.anx to i64                 ; 2 uses
  %i.anz = sext i32 %i.j to i64                   ; 11 uses
  %i.aoa = shl i32 %i.j, 1                        ; 2 uses
  %i.aob = sext i32 %i.aoa to i64                 ; 3 uses
  %i.aoc = icmp slt i32 %i.j, 1
  %i.aod = add i32 %i.n, -16                      ; 2 uses
  %i.aoe = lshr i32 %i.aod, 2
  %i.aof = and i32 %i.aoe, 1073741820
  %narrow2442.i = add nuw nsw i32 %i.aof, 4
  %i.aog = zext nneg i32 %narrow2442.i to i64
  %i.aoh = mul nsw i64 %i.aog, %i.anu
  %i.aoi = mul i32 %i.anf, %.2.lcssa.i
  %i.aoj = shl i32 %i.anf, 1                      ; 2 uses
  %i.aok = mul i32 %i.and, %i.anf
  %i.aol = and i32 %i.aod, -16
  %i.aom = add nuw i32 %i.aol, 16                 ; 4 uses
  %i.aon = add i32 %i.n, -8
  %i.aoo = sext i32 %.2.lcssa.i to i64
  %i.aop = sext i32 %i.m to i64
  %i.aoq = or disjoint i32 %i.aom, 7
  %i.aor = icmp slt i32 %i.aoq, %i.n
  %wide.trip.count2329.i = zext i32 %i.j to i64   ; 26 uses
  %i.aos = shl nuw nsw i64 %wide.trip.count2329.i, 3
  %i.aot = shl nuw nsw i64 %wide.trip.count2329.i, 2 ; 5 uses
  %i.aou = shl nuw nsw i64 %wide.trip.count2329.i, 4
  %i.aov = shl nuw nsw i64 %i.anz, 2              ; 3 uses
  %i.aow = add nuw nsw i64 %i.aov, %i.aot         ; 2 uses
  %i.aox = shl nsw i64 %i.aob, 2
  %i.aoy = add nsw i64 %wide.trip.count2329.i, -1 ; 3 uses
  %xtraiter640 = and i64 %wide.trip.count2329.i, 3 ; 3 uses
  %i.aoz = icmp ult i64 %i.aoy, 3
...
_ZN4ncnn3MatD2Ev.exit1326.i:                      ; preds = %._crit_edge1851.split.i, %_ZN4ncnn3MatD2Ev.exit1326.lr.ph.i
  %indvars.iv2316.i = phi i64 [ %i.abf, %_ZN4ncnn3MatD2Ev.exit1326.lr.ph.i ], [ %indvars.iv.next2317.i, %._crit_edge1851.split.i ] ; 2 uses
  %i.apj = phi i32 [ %i.zn, %_ZN4ncnn3MatD2Ev.exit1326.lr.ph.i ], [ %i.axo, %._crit_edge1851.split.i ]
  %i.apk = phi <4 x i32> [ %i.abb, %_ZN4ncnn3MatD2Ev.exit1326.lr.ph.i ], [ %i.axn, %._crit_edge1851.split.i ] ; 2 uses
  %i.apl = sext <4 x i32> %i.apk to <4 x i64>
  %i.apm = shl nsw <4 x i64> %i.apl, splat (i64 2) ; 4 uses
  %i.apn = load ptr, ptr %i.o, align 8, !tbaa !19 ; 5 uses
  %i.apo = trunc i64 %indvars.iv2316.i to i32     ; 6 uses
  %i.app = mul i32 %i.aax, %i.apo
  %i.apq = sext i32 %i.app to i64
  %i.apr = getelementptr inbounds [4 x i8], ptr %i.apn, i64 %i.apq ; 2 uses
  %i.aps = add i32 %i.apo, 1
  %i.apt = mul i32 %i.aps, %i.aax
  %i.apu = sext i32 %i.apt to i64
  %i.apv = getelementptr inbounds [4 x i8], ptr %i.apn, i64 %i.apu ; 2 uses
  %i.apw = add i32 %i.apo, 2
  %i.apx = mul i32 %i.apw, %i.aax
  %i.apy = sext i32 %i.apx to i64
  %i.apz = getelementptr inbounds [4 x i8], ptr %i.apn, i64 %i.apy ; 2 uses
  %i.aqa = mul i32 %i.apj, %i.aax
  %i.aqb = sext i32 %i.aqa to i64
  %i.aqc = getelementptr inbounds [4 x i8], ptr %i.apn, i64 %i.aqb ; 2 uses
  %i.aqd = lshr i32 %i.apo, 4
  %i.aqe = lshr i32 %i.apo, 3
  %i.aqf = and i32 %i.aqe, 1
  %i.aqg = add nuw nsw i32 %i.aqf, %i.aqd
  %i.aqh = lshr i32 %i.apo, 2
  %i.aqi = and i32 %i.aqh, 1
  %i.aqj = add nuw nsw i32 %i.aqg, %i.aqi
  %i.aqk = load ptr, ptr %i.p, align 8, !tbaa !19, !noalias !179
  %i.aql = load i64, ptr %i.zs, align 8, !tbaa !20, !noalias !179
  %i.aqm = zext nneg i32 %i.aqj to i64
  %i.aqn = mul i64 %i.aql, %i.aqm
  %i.aqo = load i64, ptr %i.zt, align 8, !tbaa !44, !noalias !179
  %i.aqp = mul i64 %i.aqn, %i.aqo
  %i.aqq = getelementptr inbounds nuw i8, ptr %i.aqk, i64 %i.aqp ; 4 uses
  br i1 %i.aad, label %.preheader1569.lr.ph.i, label %.preheader1572.i

.preheader1569.lr.ph.i:                           ; preds = %_ZN4ncnn3MatD2Ev.exit1326.i
  br i1 %i.aae, label %.preheader1569.us.i, label %.preheader1572.thread.i

.preheader1569.us.i:                              ; preds = %.preheader1569.lr.ph.i, %._crit_edge1770.us.i
  %.012581777.us.i = phi i32 [ %i.art, %._crit_edge1770.us.i ], [ 0, %.preheader1569.lr.ph.i ]
  %.012631776.us.i = phi ptr [ %i.aro, %._crit_edge1770.us.i ], [ %i.aqq, %.preheader1569.lr.ph.i ]
  %.012741775.us.i = phi ptr [ %i.ars, %._crit_edge1770.us.i ], [ %i.aqc, %.preheader1569.lr.ph.i ] ; 2 uses
  %.012771774.us.i = phi ptr [ %i.arr, %._crit_edge1770.us.i ], [ %i.apz, %.preheader1569.lr.ph.i ] ; 2 uses
  %.012801773.us.i = phi ptr [ %i.arq, %._crit_edge1770.us.i ], [ %i.apv, %.preheader1569.lr.ph.i ] ; 2 uses
  %.012831772.us.i = phi ptr [ %i.arp, %._crit_edge1770.us.i ], [ %i.apr, %.preheader1569.lr.ph.i ] ; 2 uses
  br label %bb.bi

bb.bi:                                            ; preds = %bb.bi, %.preheader1569.us.i
  %indvars.iv2282.i = phi i64 [ 0, %.preheader1569.us.i ], [ %indvars.iv.next2283.i, %bb.bi ] ; 5 uses
  %.112641768.us.i = phi ptr [ %.012631776.us.i, %.preheader1569.us.i ], [ %i.aro, %bb.bi ] ; 5 uses
  %i.aqr = getelementptr inbounds nuw [4 x i8], ptr %.012831772.us.i, i64 %indvars.iv2282.i
  %i.aqs = getelementptr inbounds nuw [4 x i8], ptr %.012801773.us.i, i64 %indvars.iv2282.i
  %i.aqt = getelementptr inbounds nuw [4 x i8], ptr %.012771774.us.i, i64 %indvars.iv2282.i
  %i.aqu = getelementptr inbounds nuw [4 x i8], ptr %.012741775.us.i, i64 %indvars.iv2282.i
  %i.aqv = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr %i.aqr, <16 x i32> %i.aac, <16 x i1> splat (i1 true), i32 4) ; 2 uses
  %i.aqw = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr %i.aqs, <16 x i32> %i.aac, <16 x i1> splat (i1 true), i32 4) ; 2 uses
  %i.aqx = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr %i.aqt, <16 x i32> %i.aac, <16 x i1> splat (i1 true), i32 4) ; 2 uses
  %i.aqy = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr %i.aqu, <16 x i32> %i.aac, <16 x i1> splat (i1 true), i32 4) ; 2 uses
  %i.aqz = shufflevector <16 x float> %i.aqv, <16 x float> %i.aqw, <16 x i32> <i32 0, i32 16, i32 1, i32 17, i32 4, i32 20, i32 5, i32 21, i32 8, i32 24, i32 9, i32 25, i32 12, i32 28, i32 13, i32 29> ; 2 uses
  %i.ara = shufflevector <16 x float> %i.aqv, <16 x float> %i.aqw, <16 x i32> <i32 2, i32 18, i32 3, i32 19, i32 6, i32 22, i32 7, i32 23, i32 10, i32 26, i32 11, i32 27, i32 14, i32 30, i32 15, i32 31> ; 2 uses
  ...
  %i.ard = shufflevector <16 x float> %i.aqz, <16 x float> %i.arb, <16 x i32> <i32 0, i32 1, i32 16, i32 17, i32 8, i32 9, i32 24, i32 25, i32 2, i32 3, i32 18, i32 19, i32 10, i32 11, i32 26, i32 27> ; 2 uses
  ...
  %i.arf = shufflevector <16 x float> %i.aqz, <16 x float> %i.arb, <16 x i32> <i32 4, i32 5, i32 20, i32 21, i32 12, i32 13, i32 28, i32 29, i32 6, i32 7, i32 22, i32 23, i32 14, i32 15, i32 30, i32 31> ; 2 uses
  ...
  %i.arh = shufflevector <16 x float> %i.ard, <16 x float> %i.are, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 18, i32 19, i32 24, i32 25, i32 26, i32 27>
  %i.ari = shufflevector <16 x float> %i.arf, <16 x float> %i.arg, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 18, i32 19, i32 24, i32 25, i32 26, i32 27>
  %i.arj = shufflevector <16 x float> %i.ard, <16 x float> %i.are, <16 x i32> <i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15, i32 20, i32 21, i32 22, i32 23, i32 28, i32 29, i32 30, i32 31>
  %i.ark = shufflevector <16 x float> %i.arf, <16 x float> %i.arg, <16 x i32> <i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15, i32 20, i32 21, i32 22, i32 23, i32 28, i32 29, i32 30, i32 31>
  store <16 x float> %i.arh, ptr %.112641768.us.i, align 1, !tbaa !45
  %i.arl = getelementptr inbounds nuw i8, ptr %.112641768.us.i, i64 64
  store <16 x float> %i.ari, ptr %i.arl, align 1, !tbaa !45
  %i.arm = getelementptr inbounds nuw i8, ptr %.112641768.us.i, i64 128
  store <16 x float> %i.arj, ptr %i.arm, align 1, !tbaa !45
  %i.arn = getelementptr inbounds nuw i8, ptr %.112641768.us.i, i64 192
  store <16 x float> %i.ark, ptr %i.arn, align 1, !tbaa !45
  %i.aro = getelementptr inbounds nuw i8, ptr %.112641768.us.i, i64 256 ; 3 uses
  ...
  br i1 %exitcond2286.not.i, label %._crit_edge1770.us.i, label %bb.bi, !llvm.loop !106

._crit_edge1770.us.i:                             ; preds = %bb.bi
  %i.arp = getelementptr inbounds nuw [4 x i8], ptr %.012831772.us.i, i64 %i.aag ; 2 uses
  %i.arq = getelementptr inbounds nuw [4 x i8], ptr %.012801773.us.i, i64 %i.aag ; 2 uses
  %i.arr = getelementptr inbounds nuw [4 x i8], ptr %.012771774.us.i, i64 %i.aag ; 2 uses
  %i.ars = getelementptr inbounds nuw [4 x i8], ptr %.012741775.us.i, i64 %i.aag ; 2 uses
  %i.art = add nuw nsw i32 %.012581777.us.i, 16   ; 2 uses
  %i.aru = or disjoint i32 %i.art, 15
  %i.arv = icmp slt i32 %i.aru, %i.n
  br i1 %i.arv, label %.preheader1569.us.i, label %.preheader1572.i, !llvm.loop !107

.preheader1572.i:                                 ; preds = %._crit_edge1770.us.i, %_ZN4ncnn3MatD2Ev.exit1326.i
  %.01283.lcssa.i = phi ptr [ %i.apr, %_ZN4ncnn3MatD2Ev.exit1326.i ], [ %i.arp, %._crit_edge1770.us.i ] ; 3 uses
  %.01280.lcssa.i = phi ptr [ %i.apv, %_ZN4ncnn3MatD2Ev.exit1326.i ], [ %i.arq, %._crit_edge1770.us.i ] ; 3 uses
  %.01277.lcssa.i = phi ptr [ %i.apz, %_ZN4ncnn3MatD2Ev.exit1326.i ], [ %i.arr, %._crit_edge1770.us.i ] ; 3 uses
  %.01274.lcssa.i = phi ptr [ %i.aqc, %_ZN4ncnn3MatD2Ev.exit1326.i ], [ %i.ars, %._crit_edge1770.us.i ] ; 3 uses
  %.01263.lcssa.i = phi ptr [ %i.aqq, %_ZN4ncnn3MatD2Ev.exit1326.i ], [ %i.aro, %._crit_edge1770.us.i ] ; 3 uses
  %.01258.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1326.i ], [ %i.abd, %._crit_edge1770.us.i ] ; 4 uses
  %i.arw = or disjoint i32 %.01258.lcssa.i, 7
  %i.arx = icmp slt i32 %i.arw, %i.n
  br i1 %i.arx, label %.preheader1568.lr.ph.i, label %.preheader1571.i

.preheader1572.thread.i:                          ; preds = %.preheader1569.lr.ph.i
  %scevgep2269.i.a = getelementptr i8, ptr %i.apn, i64 %i.aaw ; 4 uses
  %i.ary = extractelement <4 x i64> %i.apm, i64 0
  %scevgep2272.i.a = getelementptr i8, ptr %scevgep2269.i.a, i64 %i.ary ; 2 uses
  %i.arz = extractelement <4 x i64> %i.apm, i64 1
  %scevgep2275.i.a = getelementptr i8, ptr %scevgep2269.i.a, i64 %i.arz ; 2 uses
  %i.asa = extractelement <4 x i64> %i.apm, i64 2
  %scevgep2278.i.a = getelementptr i8, ptr %scevgep2269.i.a, i64 %i.asa ; 2 uses
  %i.asb = extractelement <4 x i64> %i.apm, i64 3
  %scevgep2281.i = getelementptr i8, ptr %scevgep2269.i.a, i64 %i.asb ; 2 uses
  br i1 %i.abi, label %.preheader1568.preheader.i, label %.preheader1571.i

.preheader1568.lr.ph.i:                           ; preds = %.preheader1572.i
  br i1 %i.aae, label %.preheader1568.us.i, label %.preheader1568.preheader.i
...
.preheader1568.preheader.i:                       ; preds = %.preheader1568.lr.ph.i, %.preheader1572.thread.i
  ...
  %.01263.lcssa25332542.i = phi ptr [ %.01263.lcssa.i, %.preheader1568.lr.ph.i ], [ %i.aqq, %.preheader1572.thread.i ]
  %.01258.lcssa25342541.i = phi i32 [ %.01258.lcssa.i, %.preheader1568.lr.ph.i ], [ %i.abd, %.preheader1572.thread.i ] ; 2 uses
  %i.asc = sub i32 %i.abe, %.01258.lcssa25342541.i ; 2 uses
  %i.asd = lshr i32 %i.asc, 1
  %i.ase = and i32 %i.asd, 2147483644
  %narrow2441.i = add nuw i32 %i.ase, 4
  %i.asf = zext i32 %narrow2441.i to i64
  %i.asg = mul nsw i64 %i.asf, %i.aai             ; 4 uses
  %scevgep2287.i.a = getelementptr i8, ptr %.01283.lcssa25292546.i, i64 %i.asg
  %scevgep2288.i = getelementptr i8, ptr %.01280.lcssa25302545.i, i64 %i.asg
  %scevgep2289.i = getelementptr i8, ptr %.01277.lcssa25312544.i, i64 %i.asg
  %scevgep2290.i = getelementptr i8, ptr %.01274.lcssa25322543.i, i64 %i.asg
  %i.ash = add i32 %.01258.lcssa25342541.i, 8
  %i.asi = and i32 %i.asc, -8
  %i.asj = add i32 %i.ash, %i.asi
  br label %.preheader1571.i

.preheader1568.us.i:                              ; preds = %.preheader1568.lr.ph.i, %._crit_edge1792.us.i
  %.112591799.us.i = phi i32 [ %i.ati, %._crit_edge1792.us.i ], [ %.01258.lcssa.i, %.preheader1568.lr.ph.i ]
  %.212651798.us.i = phi ptr [ %i.atd, %._crit_edge1792.us.i ], [ %.01263.lcssa.i, %.preheader1568.lr.ph.i ]
  %.112751797.us.i = phi ptr [ %i.ath, %._crit_edge1792.us.i ], [ %.01274.lcssa.i, %.preheader1568.lr.ph.i ] ; 2 uses
  %.112781796.us.i = phi ptr [ %i.atg, %._crit_edge1792.us.i ], [ %.01277.lcssa.i, %.preheader1568.lr.ph.i ] ; 2 uses
  %.112811795.us.i = phi ptr [ %i.atf, %._crit_edge1792.us.i ], [ %.01280.lcssa.i, %.preheader1568.lr.ph.i ] ; 2 uses
  %.112841794.us.i = phi ptr [ %i.ate, %._crit_edge1792.us.i ], [ %.01283.lcssa.i, %.preheader1568.lr.ph.i ] ; 2 uses
  br label %bb.bj

bb.bj:                                            ; preds = %bb.bj, %.preheader1568.us.i
  %indvars.iv2291.i = phi i64 [ 0, %.preheader1568.us.i ], [ %indvars.iv.next2292.i, %bb.bj ] ; 5 uses
  %.312661790.us.i = phi ptr [ %.212651798.us.i, %.preheader1568.us.i ], [ %i.atd, %bb.bj ] ; 5 uses
  %i.ask = getelementptr inbounds nuw [4 x i8], ptr %.112841794.us.i, i64 %indvars.iv2291.i
end_hunk_0
begin_hunk_1_@_ZN4ncnn24Convolution1D_x86_avx51215create_pipelineERKNS_6OptionE:bb.a
  ...
  %i.avj = getelementptr inbounds nuw i8, ptr %.712701832.us.i, i64 96
  %i.avk = getelementptr inbounds nuw [4 x i8], ptr %.312861836.us.i, i64 %indvars.iv2305.i.a
  %i.avl = getelementptr inbounds nuw i8, ptr %i.avk, i64 12 ; 2 uses
  %i.avm = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.avl, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.avm, ptr %i.avj, align 16, !tbaa !45
  %i.avn = getelementptr inbounds nuw [4 x i8], ptr %i.avl, i64 %i.aao
  %i.avo = getelementptr inbounds nuw i8, ptr %.712701832.us.i, i64 112
  %i.avp = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.avn, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.avp, ptr %i.avo, align 16, !tbaa !45
  %i.avq = getelementptr inbounds nuw i8, ptr %.712701832.us.i, i64 128 ; 3 uses
  ...
  br i1 %niter630.ncmp.3, label %._crit_edge1834.us.i.unr-lcssa, label %.preheader1566.us.i.new, !llvm.loop !112
...
.epil.preheader623:                               ; preds = %._crit_edge1834.us.i.unr-lcssa, %.preheader1566.us.i
  ...
  %.712701832.us.i.epil.init = phi ptr [ %.612691837.us.i, %.preheader1566.us.i ], [ %i.avq, %._crit_edge1834.us.i.unr-lcssa ]
...
bb.bl:                                            ; preds = %bb.bl, %.epil.preheader623
  ...
  %.712701832.us.i.epil = phi ptr [ %.712701832.us.i.epil.init, %.epil.preheader623 ], [ %i.avw, %bb.bl ] ; 3 uses
  %epil.iter625 = phi i64 [ 0, %.epil.preheader623 ], [ %epil.iter625.next, %bb.bl ]
  %i.avr = getelementptr inbounds nuw [4 x i8], ptr %.312861836.us.i, i64 %indvars.iv2305.i.epil.a ; 2 uses
  %i.avs = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr %i.avr, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.avs, ptr %.712701832.us.i.epil, align 16, !tbaa !45
  %i.avt = getelementptr inbounds nuw [4 x i8], ptr %i.avr, i64 %i.aao
  %i.avu = getelementptr inbounds nuw i8, ptr %.712701832.us.i.epil, i64 16
  %i.avv = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr %i.avt, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.avv, ptr %i.avu, align 16, !tbaa !45
  %i.avw = getelementptr inbounds nuw i8, ptr %.712701832.us.i.epil, i64 32 ; 2 uses
  ...
  br i1 %epil.iter625.cmp.not, label %._crit_edge1834.us.i, label %bb.bl, !llvm.loop !113

._crit_edge1834.us.i:                             ; preds = %bb.bl, %._crit_edge1834.us.i.unr-lcssa
  %.lcssa547 = phi ptr [ %i.avq, %._crit_edge1834.us.i.unr-lcssa ], [ %i.avw, %bb.bl ] ; 2 uses
  %i.avx = getelementptr inbounds nuw [4 x i8], ptr %.312861836.us.i, i64 %i.aaq ; 2 uses
  %i.avy = add nuw nsw i32 %.312611838.us.i, 2    ; 3 uses
  %i.avz = or disjoint i32 %i.avy, 1
  %i.awa = icmp slt i32 %i.avz, %i.n
  br i1 %i.awa, label %.preheader1566.us.i, label %.preheader1570.i, !llvm.loop !114

.preheader1570.i:                                 ; preds = %._crit_edge1834.us.i, %._crit_edge1822.i
  %.31286.lcssa.i = phi ptr [ %.21285.lcssa.i, %._crit_edge1822.i ], [ %i.avx, %._crit_edge1834.us.i ] ; 9 uses
  %.61269.lcssa.i = phi ptr [ %.41267.lcssa.i, %._crit_edge1822.i ], [ %.lcssa547, %._crit_edge1834.us.i ]
  %.31261.lcssa.i = phi i32 [ %.21260.lcssa.i, %._crit_edge1822.i ], [ %i.avy, %._crit_edge1834.us.i ] ; 2 uses
  %i.awb = icmp sge i32 %.31261.lcssa.i, %i.n
  %brmerge2001.i = or i1 %i.aar, %i.awb
...
.preheader1565.i:                                 ; preds = %.preheader1570.i, %._crit_edge1847.i
  %.412621850.i = phi i32 [ %i.awf, %._crit_edge1847.i ], [ %.31261.lcssa.i, %.preheader1570.i ]
  %.912721849.i = phi ptr [ %.lcssa550, %._crit_edge1847.i ], [ %.61269.lcssa.i, %.preheader1570.i ] ; 2 uses
  br i1 %i.abn, label %.epil.preheader631, label %.preheader1565.i.new
...
.epil.preheader631:                               ; preds = %._crit_edge1847.i.unr-lcssa, %.preheader1565.i
  ...
  %.1012731845.i.epil.init = phi ptr [ %.912721849.i, %.preheader1565.i ], [ %i.axk, %._crit_edge1847.i.unr-lcssa ]
...
bb.bm:                                            ; preds = %bb.bm, %.epil.preheader631
  ...
  %.1012731845.i.epil = phi ptr [ %.1012731845.i.epil.init, %.epil.preheader631 ], [ %i.awe, %bb.bm ] ; 2 uses
  %epil.iter633 = phi i64 [ 0, %.epil.preheader631 ], [ %epil.iter633.next, %bb.bm ]
  %i.awc = getelementptr inbounds nuw [4 x i8], ptr %.31286.lcssa.i, i64 %indvars.iv2310.i.epil
  %i.awd = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr %i.awc, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.awd, ptr %.1012731845.i.epil, align 16, !tbaa !45
  %i.awe = getelementptr inbounds nuw i8, ptr %.1012731845.i.epil, i64 16 ; 2 uses
  ...
  br i1 %epil.iter633.cmp.not, label %._crit_edge1847.i, label %bb.bm, !llvm.loop !115

._crit_edge1847.i:                                ; preds = %bb.bm, %._crit_edge1847.i.unr-lcssa
  %.lcssa550 = phi ptr [ %i.axk, %._crit_edge1847.i.unr-lcssa ], [ %i.awe, %bb.bm ]
  %i.awf = add nuw nsw i32 %.412621850.i, 1       ; 2 uses
  %exitcond2315.not.i = icmp eq i32 %i.awf, %i.n
  br i1 %exitcond2315.not.i, label %._crit_edge1851.split.i, label %.preheader1565.i, !llvm.loop !116
...
.preheader1565.i.new:                             ; preds = %.preheader1565.i, %.preheader1565.i.new
  ...
  %.1012731845.i = phi ptr [ %i.axk, %.preheader1565.i.new ], [ %.912721849.i, %.preheader1565.i ] ; 9 uses
  %niter638 = phi i64 [ %niter638.next.7, %.preheader1565.i.new ], [ 0, %.preheader1565.i ]
  %i.awg = getelementptr inbounds nuw [4 x i8], ptr %.31286.lcssa.i, i64 %indvars.iv2310.i
  %i.awh = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr %i.awg, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.awh, ptr %.1012731845.i, align 16, !tbaa !45
  %i.awi = getelementptr inbounds nuw i8, ptr %.1012731845.i, i64 16
  %i.awj = getelementptr inbounds nuw [4 x i8], ptr %.31286.lcssa.i, i64 %indvars.iv2310.i
  %i.awk = getelementptr inbounds nuw i8, ptr %i.awj, i64 4
  %i.awl = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.awk, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.awl, ptr %i.awi, align 16, !tbaa !45
  %i.awm = getelementptr inbounds nuw i8, ptr %.1012731845.i, i64 32
  %i.awn = getelementptr inbounds nuw [4 x i8], ptr %.31286.lcssa.i, i64 %indvars.iv2310.i
  %i.awo = getelementptr inbounds nuw i8, ptr %i.awn, i64 8
  %i.awp = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.awo, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.awp, ptr %i.awm, align 16, !tbaa !45
  %i.awq = getelementptr inbounds nuw i8, ptr %.1012731845.i, i64 48
  %i.awr = getelementptr inbounds nuw [4 x i8], ptr %.31286.lcssa.i, i64 %indvars.iv2310.i
  %i.aws = getelementptr inbounds nuw i8, ptr %i.awr, i64 12
  %i.awt = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.aws, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.awt, ptr %i.awq, align 16, !tbaa !45
  %i.awu = getelementptr inbounds nuw i8, ptr %.1012731845.i, i64 64
  %i.awv = getelementptr inbounds nuw [4 x i8], ptr %.31286.lcssa.i, i64 %indvars.iv2310.i
  %i.aww = getelementptr inbounds nuw i8, ptr %i.awv, i64 16
  %i.awx = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.aww, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.awx, ptr %i.awu, align 16, !tbaa !45
  %i.awy = getelementptr inbounds nuw i8, ptr %.1012731845.i, i64 80
  %i.awz = getelementptr inbounds nuw [4 x i8], ptr %.31286.lcssa.i, i64 %indvars.iv2310.i
  %i.axa = getelementptr inbounds nuw i8, ptr %i.awz, i64 20
  %i.axb = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.axa, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.axb, ptr %i.awy, align 16, !tbaa !45
  %i.axc = getelementptr inbounds nuw i8, ptr %.1012731845.i, i64 96
  %i.axd = getelementptr inbounds nuw [4 x i8], ptr %.31286.lcssa.i, i64 %indvars.iv2310.i
  %i.axe = getelementptr inbounds nuw i8, ptr %i.axd, i64 24
  %i.axf = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.axe, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.axf, ptr %i.axc, align 16, !tbaa !45
  %i.axg = getelementptr inbounds nuw i8, ptr %.1012731845.i, i64 112
  %i.axh = getelementptr inbounds nuw [4 x i8], ptr %.31286.lcssa.i, i64 %indvars.iv2310.i
  %i.axi = getelementptr inbounds nuw i8, ptr %i.axh, i64 28
  %i.axj = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.axi, <4 x i32> %i.aan, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.axj, ptr %i.axg, align 16, !tbaa !45
  %i.axk = getelementptr inbounds nuw i8, ptr %.1012731845.i, i64 128 ; 3 uses
  ...
  br i1 %niter638.ncmp.7, label %._crit_edge1847.i.unr-lcssa, label %.preheader1565.i.new, !llvm.loop !117
...
._crit_edge1851.split.i:                          ; preds = %._crit_edge1847.i, %.preheader1570.i, %.preheader1566.lr.ph.i, %.preheader1567.lr.ph.i
  ...
  %i.axl = or disjoint i64 %indvars.iv.next2317.i, 3 ; 2 uses
  %i.axm = icmp slt i64 %i.axl, %i.abg
  %i.axn = add <4 x i32> %i.apk, %i.abk
  %i.axo = trunc nsw i64 %i.axl to i32
  br i1 %i.axm, label %_ZN4ncnn3MatD2Ev.exit1326.i, label %.preheader1564.loopexit.i, !llvm.loop !118

.preheader1554.loopexit.i:                        ; preds = %._crit_edge1928.split.i
  %i.axp = trunc nsw i64 %indvars.iv.next2361.i to i32
  br label %.preheader1554.i

.preheader1554.i:                                 ; preds = %.preheader1554.loopexit.i, %.preheader1564.i
  %.3.lcssa.i = phi i32 [ %.2.lcssa.i, %.preheader1564.i ], [ %i.axp, %.preheader1554.loopexit.i ] ; 3 uses
  %i.axq = icmp slt i32 %.3.lcssa.i, %i.m
  br i1 %i.axq, label %_ZN4ncnn3MatD2Ev.exit.lr.ph.i, label %_ZN4ncnnL37convolution1d_transform_kernel_packedERKNS_3MatERS0_iii.exit

_ZN4ncnn3MatD2Ev.exit.lr.ph.i:                    ; preds = %.preheader1554.i
  %i.axr = mul i32 %i.n, %i.j                     ; 3 uses
  %i.axs = getelementptr inbounds nuw i8, ptr %0, i64 536
  %i.axt = getelementptr inbounds nuw i8, ptr %0, i64 488
  %i.axu = insertelement <4 x i32> poison, i32 %i.j, i64 0
  %i.axv = shufflevector <4 x i32> %i.axu, <4 x i32> poison, <4 x i32> zeroinitializer
  %i.axw = mul <4 x i32> %i.axv, <i32 0, i32 1, i32 2, i32 3> ; 9 uses
  %i.axx = insertelement <8 x i32> poison, i32 %i.j, i64 0
  %i.axy = shufflevector <8 x i32> %i.axx, <8 x i32> poison, <8 x i32> zeroinitializer
  %i.axz = mul <8 x i32> %i.axy, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7> ; 9 uses
  %i.aya = insertelement <16 x i32> poison, i32 %i.j, i64 0
  %i.ayb = shufflevector <16 x i32> %i.aya, <16 x i32> poison, <16 x i32> zeroinitializer
  %i.ayc = mul <16 x i32> %i.ayb, <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15> ; 9 uses
  %i.ayd = icmp sgt i32 %i.n, 15
  %i.aye = icmp sgt i32 %i.j, 0                   ; 4 uses
  %i.ayf = shl i32 %i.j, 4
  %i.ayg = sext i32 %i.ayf to i64                 ; 2 uses
  %i.ayh = shl i32 %i.j, 3
  %i.ayi = sext i32 %i.ayh to i64                 ; 2 uses
  %i.ayj = shl i32 %i.j, 2
  %i.ayk = sext i32 %i.ayj to i64
  %i.ayl = sext i32 %i.j to i64                   ; 8 uses
  %i.aym = shl i32 %i.j, 1                        ; 2 uses
  %i.ayn = sext i32 %i.aym to i64                 ; 2 uses
  %i.ayo = icmp slt i32 %i.j, 1
  %i.ayp = add i32 %i.n, -16                      ; 2 uses
  %i.ayq = lshr i32 %i.ayp, 2
  %i.ayr = and i32 %i.ayq, 1073741820
  %narrow2444.i = add nuw nsw i32 %i.ayr, 4
  %i.ays = zext nneg i32 %narrow2444.i to i64
  %i.ayt = mul nsw i64 %i.ays, %i.ayg
  %i.ayu = mul i32 %i.axr, %.3.lcssa.i
  %i.ayv = and i32 %i.ayp, -16
  %i.ayw = add nuw i32 %i.ayv, 16                 ; 4 uses
  %i.ayx = add i32 %i.n, -8
  %i.ayy = sext i32 %.3.lcssa.i to i64
  %wide.trip.count2401.i = sext i32 %i.m to i64
  %i.ayz = or disjoint i32 %i.ayw, 7
  %i.aza = icmp slt i32 %i.ayz, %i.n
  %wide.trip.count2370.i = zext i32 %i.j to i64   ; 25 uses
  %i.azb = shl nuw nsw i64 %wide.trip.count2370.i, 3
  %i.azc = shl nuw nsw i64 %i.ayl, 2              ; 2 uses
  %i.azd = shl nuw nsw i64 %wide.trip.count2370.i, 2 ; 2 uses
  %i.aze = shl nsw i64 %i.ayn, 2
  %i.azf = add nsw i64 %wide.trip.count2370.i, -1 ; 3 uses
  %xtraiter668 = and i64 %wide.trip.count2370.i, 7 ; 3 uses
  %i.azg = icmp ult i64 %i.azf, 7
...
_ZN4ncnn3MatD2Ev.exit1325.i:                      ; preds = %._crit_edge1928.split.i, %_ZN4ncnn3MatD2Ev.exit1325.lr.ph.i
  %indvars.iv2360.i.a = phi i64 [ %i.aoo, %_ZN4ncnn3MatD2Ev.exit1325.lr.ph.i ], [ %indvars.iv.next2361.i, %._crit_edge1928.split.i ] ; 2 uses
  %indvars.iv2323.i = phi i32 [ %i.aok, %_ZN4ncnn3MatD2Ev.exit1325.lr.ph.i ], [ %indvars.iv.next2324.i, %._crit_edge1928.split.i ] ; 2 uses
  %indvars.iv2320.i = phi i32 [ %i.aoi, %_ZN4ncnn3MatD2Ev.exit1325.lr.ph.i ], [ %indvars.iv.next2321.i, %._crit_edge1928.split.i ] ; 2 uses
  %i.azp = phi i32 [ %i.and, %_ZN4ncnn3MatD2Ev.exit1325.lr.ph.i ], [ %i.bjk, %._crit_edge1928.split.i ]
  %i.azq = sext i32 %indvars.iv2320.i to i64
  %i.azr = shl nsw i64 %i.azq, 2
  %i.azs = sext i32 %indvars.iv2323.i to i64
  %i.azt = shl nsw i64 %i.azs, 2
  %i.azu = load ptr, ptr %i.o, align 8, !tbaa !19 ; 3 uses
  %i.azv = trunc nsw i64 %indvars.iv2360.i.a to i32 ; 2 uses
  %i.azw = mul i32 %i.anf, %i.azv
  %i.azx = sext i32 %i.azw to i64
  %i.azy = getelementptr inbounds [4 x i8], ptr %i.azu, i64 %i.azx ; 2 uses
  %i.azz = mul i32 %i.azp, %i.anf
  %i.baa = sext i32 %i.azz to i64
  %i.bab = getelementptr inbounds [4 x i8], ptr %i.azu, i64 %i.baa ; 2 uses
  %i.bac = insertelement <4 x i32> poison, i32 %i.azv, i64 0
  %i.bad = shufflevector <4 x i32> %i.bac, <4 x i32> poison, <4 x i32> zeroinitializer
  %i.bae = lshr <4 x i32> %i.bad, <i32 3, i32 2, i32 1, i32 4>
  %i.baf = and <4 x i32> %i.bae, <i32 1, i32 1, i32 1, i32 -1>
  %i.bag = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.baf)
  %i.bah = load ptr, ptr %i.p, align 8, !tbaa !19, !noalias !180
  %i.bai = load i64, ptr %i.ang, align 8, !tbaa !20, !noalias !180
  %i.baj = zext nneg i32 %i.bag to i64
  %i.bak = mul i64 %i.bai, %i.baj
  %i.bal = load i64, ptr %i.anh, align 8, !tbaa !44, !noalias !180
  %i.bam = mul i64 %i.bak, %i.bal
  %i.ban = getelementptr inbounds nuw i8, ptr %i.bah, i64 %i.bam ; 4 uses
  br i1 %i.anr, label %.preheader1559.lr.ph.i, label %.preheader1563.i

.preheader1559.lr.ph.i:                           ; preds = %_ZN4ncnn3MatD2Ev.exit1325.i
  br i1 %i.ans, label %.preheader1559.us.i, label %.preheader1563.thread.i

.preheader1559.us.i:                              ; preds = %.preheader1559.lr.ph.i, %._crit_edge1856.us.i
  %.011821861.us.i = phi i32 [ %i.bbu, %._crit_edge1856.us.i ], [ 0, %.preheader1559.lr.ph.i ]
  %.011871860.us.i = phi ptr [ %.lcssa517, %._crit_edge1856.us.i ], [ %i.ban, %.preheader1559.lr.ph.i ] ; 2 uses
  %.011981859.us.i = phi ptr [ %i.bbt, %._crit_edge1856.us.i ], [ %i.bab, %.preheader1559.lr.ph.i ] ; 6 uses
  %.012021858.us.i = phi ptr [ %i.bbs, %._crit_edge1856.us.i ], [ %i.azy, %.preheader1559.lr.ph.i ] ; 6 uses
  br i1 %i.aoz, label %.epil.preheader639, label %.preheader1559.us.i.new
...
.preheader1559.us.i.new:                          ; preds = %.preheader1559.us.i, %.preheader1559.us.i.new
  ...
  %.111881854.us.i = phi ptr [ %i.bbl, %.preheader1559.us.i.new ], [ %.011871860.us.i, %.preheader1559.us.i ] ; 9 uses
  %niter646 = phi i64 [ %niter646.next.3, %.preheader1559.us.i.new ], [ 0, %.preheader1559.us.i ]
  %i.bao = getelementptr inbounds nuw [4 x i8], ptr %.012021858.us.i, i64 %indvars.iv2326.i
  %i.bap = getelementptr inbounds nuw [4 x i8], ptr %.011981859.us.i, i64 %indvars.iv2326.i
  %i.baq = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr %i.bao, <16 x i32> %i.anq, <16 x i1> splat (i1 true), i32 4)
  %i.bar = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr %i.bap, <16 x i32> %i.anq, <16 x i1> splat (i1 true), i32 4)
  store <16 x float> %i.baq, ptr %.111881854.us.i, align 1, !tbaa !45
  %i.bas = getelementptr inbounds nuw i8, ptr %.111881854.us.i, i64 64
  store <16 x float> %i.bar, ptr %i.bas, align 1, !tbaa !45
  %i.bat = getelementptr inbounds nuw i8, ptr %.111881854.us.i, i64 128
  %indvars.iv.next2327.i = or disjoint i64 %indvars.iv2326.i, 1 ; 2 uses
  %i.bau = getelementptr inbounds nuw [4 x i8], ptr %.012021858.us.i, i64 %indvars.iv.next2327.i
  %i.bav = getelementptr inbounds nuw [4 x i8], ptr %.011981859.us.i, i64 %indvars.iv.next2327.i
  %i.baw = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr nonnull %i.bau, <16 x i32> %i.anq, <16 x i1> splat (i1 true), i32 4)
  %i.bax = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr nonnull %i.bav, <16 x i32> %i.anq, <16 x i1> splat (i1 true), i32 4)
  store <16 x float> %i.baw, ptr %i.bat, align 1, !tbaa !45
  %i.bay = getelementptr inbounds nuw i8, ptr %.111881854.us.i, i64 192
  store <16 x float> %i.bax, ptr %i.bay, align 1, !tbaa !45
  %i.baz = getelementptr inbounds nuw i8, ptr %.111881854.us.i, i64 256
  %indvars.iv.next2327.i.1 = or disjoint i64 %indvars.iv2326.i, 2 ; 2 uses
  %i.bba = getelementptr inbounds nuw [4 x i8], ptr %.012021858.us.i, i64 %indvars.iv.next2327.i.1
  %i.bbb = getelementptr inbounds nuw [4 x i8], ptr %.011981859.us.i, i64 %indvars.iv.next2327.i.1
  %i.bbc = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr nonnull %i.bba, <16 x i32> %i.anq, <16 x i1> splat (i1 true), i32 4)
  %i.bbd = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr nonnull %i.bbb, <16 x i32> %i.anq, <16 x i1> splat (i1 true), i32 4)
  store <16 x float> %i.bbc, ptr %i.baz, align 1, !tbaa !45
  %i.bbe = getelementptr inbounds nuw i8, ptr %.111881854.us.i, i64 320
  store <16 x float> %i.bbd, ptr %i.bbe, align 1, !tbaa !45
  %i.bbf = getelementptr inbounds nuw i8, ptr %.111881854.us.i, i64 384
  %indvars.iv.next2327.i.2 = or disjoint i64 %indvars.iv2326.i, 3 ; 2 uses
  %i.bbg = getelementptr inbounds nuw [4 x i8], ptr %.012021858.us.i, i64 %indvars.iv.next2327.i.2
  %i.bbh = getelementptr inbounds nuw [4 x i8], ptr %.011981859.us.i, i64 %indvars.iv.next2327.i.2
  %i.bbi = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr nonnull %i.bbg, <16 x i32> %i.anq, <16 x i1> splat (i1 true), i32 4)
  %i.bbj = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr nonnull %i.bbh, <16 x i32> %i.anq, <16 x i1> splat (i1 true), i32 4)
  store <16 x float> %i.bbi, ptr %i.bbf, align 1, !tbaa !45
  %i.bbk = getelementptr inbounds nuw i8, ptr %.111881854.us.i, i64 448
  store <16 x float> %i.bbj, ptr %i.bbk, align 1, !tbaa !45
  %i.bbl = getelementptr inbounds nuw i8, ptr %.111881854.us.i, i64 512 ; 3 uses
  ...
  br i1 %niter646.ncmp.3, label %._crit_edge1856.us.i.unr-lcssa, label %.preheader1559.us.i.new, !llvm.loop !121
...
.epil.preheader639:                               ; preds = %._crit_edge1856.us.i.unr-lcssa, %.preheader1559.us.i
  ...
  %.111881854.us.i.epil.init = phi ptr [ %.011871860.us.i, %.preheader1559.us.i ], [ %i.bbl, %._crit_edge1856.us.i.unr-lcssa ]
...
bb.bn:                                            ; preds = %bb.bn, %.epil.preheader639
  ...
  %.111881854.us.i.epil = phi ptr [ %.111881854.us.i.epil.init, %.epil.preheader639 ], [ %i.bbr, %bb.bn ] ; 3 uses
  %epil.iter641 = phi i64 [ 0, %.epil.preheader639 ], [ %epil.iter641.next, %bb.bn ]
  %i.bbm = getelementptr inbounds nuw [4 x i8], ptr %.012021858.us.i, i64 %indvars.iv2326.i.epil
  %i.bbn = getelementptr inbounds nuw [4 x i8], ptr %.011981859.us.i, i64 %indvars.iv2326.i.epil
  %i.bbo = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr %i.bbm, <16 x i32> %i.anq, <16 x i1> splat (i1 true), i32 4)
  %i.bbp = tail call fast <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> zeroinitializer, ptr %i.bbn, <16 x i32> %i.anq, <16 x i1> splat (i1 true), i32 4)
  store <16 x float> %i.bbo, ptr %.111881854.us.i.epil, align 1, !tbaa !45
  %i.bbq = getelementptr inbounds nuw i8, ptr %.111881854.us.i.epil, i64 64
  store <16 x float> %i.bbp, ptr %i.bbq, align 1, !tbaa !45
  %i.bbr = getelementptr inbounds nuw i8, ptr %.111881854.us.i.epil, i64 128 ; 2 uses
  ...
  br i1 %epil.iter641.cmp.not, label %._crit_edge1856.us.i, label %bb.bn, !llvm.loop !122

._crit_edge1856.us.i:                             ; preds = %bb.bn, %._crit_edge1856.us.i.unr-lcssa
  %.lcssa517 = phi ptr [ %i.bbl, %._crit_edge1856.us.i.unr-lcssa ], [ %i.bbr, %bb.bn ] ; 2 uses
  %i.bbs = getelementptr inbounds nuw [4 x i8], ptr %.012021858.us.i, i64 %i.anu ; 2 uses
  %i.bbt = getelementptr inbounds nuw [4 x i8], ptr %.011981859.us.i, i64 %i.anu ; 2 uses
  %i.bbu = add nuw nsw i32 %.011821861.us.i, 16   ; 2 uses
  %i.bbv = or disjoint i32 %i.bbu, 15
  %i.bbw = icmp slt i32 %i.bbv, %i.n
  br i1 %i.bbw, label %.preheader1559.us.i, label %.preheader1563.i, !llvm.loop !123

.preheader1563.i:                                 ; preds = %._crit_edge1856.us.i, %_ZN4ncnn3MatD2Ev.exit1325.i
  %.01202.lcssa.i = phi ptr [ %i.azy, %_ZN4ncnn3MatD2Ev.exit1325.i ], [ %i.bbs, %._crit_edge1856.us.i ] ; 3 uses
  %.01198.lcssa.i = phi ptr [ %i.bab, %_ZN4ncnn3MatD2Ev.exit1325.i ], [ %i.bbt, %._crit_edge1856.us.i ] ; 3 uses
  %.01187.lcssa.i = phi ptr [ %i.ban, %_ZN4ncnn3MatD2Ev.exit1325.i ], [ %.lcssa517, %._crit_edge1856.us.i ] ; 3 uses
  %.01182.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1325.i ], [ %i.aom, %._crit_edge1856.us.i ] ; 4 uses
  %i.bbx = or disjoint i32 %.01182.lcssa.i, 7
  %i.bby = icmp slt i32 %i.bbx, %i.n
  br i1 %i.bby, label %.preheader1558.lr.ph.i, label %.preheader1562.i

.preheader1563.thread.i:                          ; preds = %.preheader1559.lr.ph.i
  %scevgep2319.i = getelementptr i8, ptr %i.azu, i64 %i.aoh ; 2 uses
  %scevgep2322.i = getelementptr i8, ptr %scevgep2319.i, i64 %i.azr ; 2 uses
  %scevgep2325.i = getelementptr i8, ptr %scevgep2319.i, i64 %i.azt ; 2 uses
  br i1 %i.aor, label %.preheader1558.preheader.i, label %.preheader1562.i

.preheader1558.lr.ph.i:                           ; preds = %.preheader1563.i
  br i1 %i.ans, label %.preheader1558.us.i, label %.preheader1558.preheader.i
...
.preheader1558.preheader.i:                       ; preds = %.preheader1558.lr.ph.i, %.preheader1563.thread.i
  ...
  %.01187.lcssa25692576.i = phi ptr [ %.01187.lcssa.i, %.preheader1558.lr.ph.i ], [ %i.ban, %.preheader1563.thread.i ]
  %.01182.lcssa25702575.i = phi i32 [ %.01182.lcssa.i, %.preheader1558.lr.ph.i ], [ %i.aom, %.preheader1563.thread.i ] ; 2 uses
  %i.bbz = sub i32 %i.aon, %.01182.lcssa25702575.i ; 2 uses
  %i.bca = lshr i32 %i.bbz, 1
  %i.bcb = and i32 %i.bca, 2147483644
  %narrow2443.i = add nuw i32 %i.bcb, 4
  %i.bcc = zext i32 %narrow2443.i to i64
  %i.bcd = mul nsw i64 %i.bcc, %i.anw             ; 2 uses
  %scevgep2331.i = getelementptr i8, ptr %.01202.lcssa25672578.i, i64 %i.bcd
  %scevgep2332.i = getelementptr i8, ptr %.01198.lcssa25682577.i, i64 %i.bcd
  %i.bce = add i32 %.01182.lcssa25702575.i, 8
  %i.bcf = and i32 %i.bbz, -8
  %i.bcg = add i32 %i.bce, %i.bcf
  br label %.preheader1562.i

.preheader1558.us.i:                              ; preds = %.preheader1558.lr.ph.i, %._crit_edge1872.us.i
  %.111831877.us.i = phi i32 [ %i.bdn, %._crit_edge1872.us.i ], [ %.01182.lcssa.i, %.preheader1558.lr.ph.i ]
  %.211891876.us.i = phi ptr [ %.lcssa520, %._crit_edge1872.us.i ], [ %.01187.lcssa.i, %.preheader1558.lr.ph.i ] ; 2 uses
  %.111991875.us.i = phi ptr [ %i.bdm, %._crit_edge1872.us.i ], [ %.01198.lcssa.i, %.preheader1558.lr.ph.i ] ; 6 uses
  %.112031874.us.i = phi ptr [ %i.bdl, %._crit_edge1872.us.i ], [ %.01202.lcssa.i, %.preheader1558.lr.ph.i ] ; 6 uses
  br i1 %i.apa, label %.epil.preheader647, label %.preheader1558.us.i.new
...
.preheader1558.us.i.new:                          ; preds = %.preheader1558.us.i, %.preheader1558.us.i.new
  ...
  %.311901870.us.i = phi ptr [ %i.bde, %.preheader1558.us.i.new ], [ %.211891876.us.i, %.preheader1558.us.i ] ; 9 uses
  %niter654 = phi i64 [ %niter654.next.3, %.preheader1558.us.i.new ], [ 0, %.preheader1558.us.i ]
  %i.bch = getelementptr inbounds nuw [4 x i8], ptr %.112031874.us.i, i64 %indvars.iv2333.i
  %i.bci = getelementptr inbounds nuw [4 x i8], ptr %.111991875.us.i, i64 %indvars.iv2333.i
  %i.bcj = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr %i.bch, <8 x i32> %i.ann, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  %i.bck = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr %i.bci, <8 x i32> %i.ann, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bcj, ptr %.311901870.us.i, align 1, !tbaa !45
  %i.bcl = getelementptr inbounds nuw i8, ptr %.311901870.us.i, i64 32
  store <8 x float> %i.bck, ptr %i.bcl, align 1, !tbaa !45
  %i.bcm = getelementptr inbounds nuw i8, ptr %.311901870.us.i, i64 64
  %indvars.iv.next2334.i = or disjoint i64 %indvars.iv2333.i, 1 ; 2 uses
  %i.bcn = getelementptr inbounds nuw [4 x i8], ptr %.112031874.us.i, i64 %indvars.iv.next2334.i
  %i.bco = getelementptr inbounds nuw [4 x i8], ptr %.111991875.us.i, i64 %indvars.iv.next2334.i
  %i.bcp = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bcn, <8 x i32> %i.ann, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  %i.bcq = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bco, <8 x i32> %i.ann, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bcp, ptr %i.bcm, align 1, !tbaa !45
  %i.bcr = getelementptr inbounds nuw i8, ptr %.311901870.us.i, i64 96
  store <8 x float> %i.bcq, ptr %i.bcr, align 1, !tbaa !45
  %i.bcs = getelementptr inbounds nuw i8, ptr %.311901870.us.i, i64 128
  %indvars.iv.next2334.i.1 = or disjoint i64 %indvars.iv2333.i, 2 ; 2 uses
  %i.bct = getelementptr inbounds nuw [4 x i8], ptr %.112031874.us.i, i64 %indvars.iv.next2334.i.1
  %i.bcu = getelementptr inbounds nuw [4 x i8], ptr %.111991875.us.i, i64 %indvars.iv.next2334.i.1
  %i.bcv = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bct, <8 x i32> %i.ann, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  %i.bcw = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bcu, <8 x i32> %i.ann, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bcv, ptr %i.bcs, align 1, !tbaa !45
  %i.bcx = getelementptr inbounds nuw i8, ptr %.311901870.us.i, i64 160
  store <8 x float> %i.bcw, ptr %i.bcx, align 1, !tbaa !45
  %i.bcy = getelementptr inbounds nuw i8, ptr %.311901870.us.i, i64 192
  %indvars.iv.next2334.i.2 = or disjoint i64 %indvars.iv2333.i, 3 ; 2 uses
  %i.bcz = getelementptr inbounds nuw [4 x i8], ptr %.112031874.us.i, i64 %indvars.iv.next2334.i.2
  %i.bda = getelementptr inbounds nuw [4 x i8], ptr %.111991875.us.i, i64 %indvars.iv.next2334.i.2
  %i.bdb = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bcz, <8 x i32> %i.ann, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  %i.bdc = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bda, <8 x i32> %i.ann, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bdb, ptr %i.bcy, align 1, !tbaa !45
  %i.bdd = getelementptr inbounds nuw i8, ptr %.311901870.us.i, i64 224
  store <8 x float> %i.bdc, ptr %i.bdd, align 1, !tbaa !45
  %i.bde = getelementptr inbounds nuw i8, ptr %.311901870.us.i, i64 256 ; 3 uses
  ...
  br i1 %niter654.ncmp.3, label %._crit_edge1872.us.i.unr-lcssa, label %.preheader1558.us.i.new, !llvm.loop !124
...
.epil.preheader647:                               ; preds = %._crit_edge1872.us.i.unr-lcssa, %.preheader1558.us.i
  ...
  %.311901870.us.i.epil.init = phi ptr [ %.211891876.us.i, %.preheader1558.us.i ], [ %i.bde, %._crit_edge1872.us.i.unr-lcssa ]
...
bb.bo:                                            ; preds = %bb.bo, %.epil.preheader647
  ...
  %.311901870.us.i.epil = phi ptr [ %.311901870.us.i.epil.init, %.epil.preheader647 ], [ %i.bdk, %bb.bo ] ; 3 uses
  %epil.iter649 = phi i64 [ 0, %.epil.preheader647 ], [ %epil.iter649.next, %bb.bo ]
  %i.bdf = getelementptr inbounds nuw [4 x i8], ptr %.112031874.us.i, i64 %indvars.iv2333.i.epil
  %i.bdg = getelementptr inbounds nuw [4 x i8], ptr %.111991875.us.i, i64 %indvars.iv2333.i.epil
  %i.bdh = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr %i.bdf, <8 x i32> %i.ann, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  %i.bdi = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr %i.bdg, <8 x i32> %i.ann, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bdh, ptr %.311901870.us.i.epil, align 1, !tbaa !45
  %i.bdj = getelementptr inbounds nuw i8, ptr %.311901870.us.i.epil, i64 32
  store <8 x float> %i.bdi, ptr %i.bdj, align 1, !tbaa !45
  %i.bdk = getelementptr inbounds nuw i8, ptr %.311901870.us.i.epil, i64 64 ; 2 uses
  ...
  br i1 %epil.iter649.cmp.not, label %._crit_edge1872.us.i, label %bb.bo, !llvm.loop !125

._crit_edge1872.us.i:                             ; preds = %bb.bo, %._crit_edge1872.us.i.unr-lcssa
  %.lcssa520 = phi ptr [ %i.bde, %._crit_edge1872.us.i.unr-lcssa ], [ %i.bdk, %bb.bo ] ; 2 uses
  %i.bdl = getelementptr inbounds nuw [4 x i8], ptr %.112031874.us.i, i64 %i.anw ; 2 uses
  %i.bdm = getelementptr inbounds nuw [4 x i8], ptr %.111991875.us.i, i64 %i.anw ; 2 uses
  %i.bdn = add nuw nsw i32 %.111831877.us.i, 8    ; 3 uses
  %i.bdo = or disjoint i32 %i.bdn, 7
  %i.bdp = icmp slt i32 %i.bdo, %i.n
  br i1 %i.bdp, label %.preheader1558.us.i, label %.preheader1562.i, !llvm.loop !126

.preheader1562.i:                                 ; preds = %._crit_edge1872.us.i, %.preheader1558.preheader.i, %.preheader1563.thread.i, %.preheader1563.i
  %.11203.lcssa.i = phi ptr [ %.01202.lcssa.i, %.preheader1563.i ], [ %scevgep2322.i, %.preheader1563.thread.i ], [ %scevgep2331.i, %.preheader1558.preheader.i ], [ %i.bdl, %._crit_edge1872.us.i ] ; 2 uses
  %.11199.lcssa.i = phi ptr [ %.01198.lcssa.i, %.preheader1563.i ], [ %scevgep2325.i, %.preheader1563.thread.i ], [ %scevgep2332.i, %.preheader1558.preheader.i ], [ %i.bdm, %._crit_edge1872.us.i ] ; 2 uses
  %.21189.lcssa.i = phi ptr [ %.01187.lcssa.i, %.preheader1563.i ], [ %i.ban, %.preheader1563.thread.i ], [ %.01187.lcssa25692576.i, %.preheader1558.preheader.i ], [ %.lcssa520, %._crit_edge1872.us.i ] ; 2 uses
  %.11183.lcssa.i = phi i32 [ %.01182.lcssa.i, %.preheader1563.i ], [ %i.aom, %.preheader1563.thread.i ], [ %i.bcg, %.preheader1558.preheader.i ], [ %i.bdn, %._crit_edge1872.us.i ] ; 3 uses
  %i.bdq = or disjoint i32 %.11183.lcssa.i, 3
  %i.bdr = icmp slt i32 %i.bdq, %i.n
  br i1 %i.bdr, label %.preheader1557.lr.ph.i, label %.preheader1561.i

.preheader1557.lr.ph.i:                           ; preds = %.preheader1562.i
  br i1 %i.ans, label %.preheader1557.us.i, label %._crit_edge1928.split.i

.preheader1557.us.i:                              ; preds = %.preheader1557.lr.ph.i, %._crit_edge1888.us.i
  %.211841893.us.i = phi i32 [ %i.bey, %._crit_edge1888.us.i ], [ %.11183.lcssa.i, %.preheader1557.lr.ph.i ]
  %.411911892.us.i = phi ptr [ %.lcssa524, %._crit_edge1888.us.i ], [ %.21189.lcssa.i, %.preheader1557.lr.ph.i ] ; 2 uses
  %.212001891.us.i = phi ptr [ %i.bex, %._crit_edge1888.us.i ], [ %.11199.lcssa.i, %.preheader1557.lr.ph.i ] ; 6 uses
  %.212041890.us.i = phi ptr [ %i.bew, %._crit_edge1888.us.i ], [ %.11203.lcssa.i, %.preheader1557.lr.ph.i ] ; 6 uses
  br i1 %i.apb, label %.epil.preheader655, label %.preheader1557.us.i.new
...
.preheader1557.us.i.new:                          ; preds = %.preheader1557.us.i, %.preheader1557.us.i.new
  ...
  %.511921886.us.i = phi ptr [ %i.bep, %.preheader1557.us.i.new ], [ %.411911892.us.i, %.preheader1557.us.i ] ; 9 uses
  %niter662 = phi i64 [ %niter662.next.3, %.preheader1557.us.i.new ], [ 0, %.preheader1557.us.i ]
  %i.bds = getelementptr inbounds nuw [4 x i8], ptr %.212041890.us.i, i64 %indvars.iv2341.i
  %i.bdt = getelementptr inbounds nuw [4 x i8], ptr %.212001891.us.i, i64 %indvars.iv2341.i
  %i.bdu = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr %i.bds, <4 x i32> %i.ank, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  %i.bdv = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr %i.bdt, <4 x i32> %i.ank, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.bdu, ptr %.511921886.us.i, align 1, !tbaa !45
  %i.bdw = getelementptr inbounds nuw i8, ptr %.511921886.us.i, i64 16
  store <4 x float> %i.bdv, ptr %i.bdw, align 1, !tbaa !45
  %i.bdx = getelementptr inbounds nuw i8, ptr %.511921886.us.i, i64 32
  %indvars.iv.next2342.i = or disjoint i64 %indvars.iv2341.i, 1 ; 2 uses
  %i.bdy = getelementptr inbounds nuw [4 x i8], ptr %.212041890.us.i, i64 %indvars.iv.next2342.i
  %i.bdz = getelementptr inbounds nuw [4 x i8], ptr %.212001891.us.i, i64 %indvars.iv.next2342.i
  %i.bea = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.bdy, <4 x i32> %i.ank, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  %i.beb = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.bdz, <4 x i32> %i.ank, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.bea, ptr %i.bdx, align 1, !tbaa !45
  %i.bec = getelementptr inbounds nuw i8, ptr %.511921886.us.i, i64 48
  store <4 x float> %i.beb, ptr %i.bec, align 1, !tbaa !45
  %i.bed = getelementptr inbounds nuw i8, ptr %.511921886.us.i, i64 64
  %indvars.iv.next2342.i.1 = or disjoint i64 %indvars.iv2341.i, 2 ; 2 uses
  %i.bee = getelementptr inbounds nuw [4 x i8], ptr %.212041890.us.i, i64 %indvars.iv.next2342.i.1
  %i.bef = getelementptr inbounds nuw [4 x i8], ptr %.212001891.us.i, i64 %indvars.iv.next2342.i.1
  %i.beg = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.bee, <4 x i32> %i.ank, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  %i.beh = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.bef, <4 x i32> %i.ank, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.beg, ptr %i.bed, align 1, !tbaa !45
  %i.bei = getelementptr inbounds nuw i8, ptr %.511921886.us.i, i64 80
  store <4 x float> %i.beh, ptr %i.bei, align 1, !tbaa !45
  %i.bej = getelementptr inbounds nuw i8, ptr %.511921886.us.i, i64 96
  %indvars.iv.next2342.i.2 = or disjoint i64 %indvars.iv2341.i, 3 ; 2 uses
  %i.bek = getelementptr inbounds nuw [4 x i8], ptr %.212041890.us.i, i64 %indvars.iv.next2342.i.2
  %i.bel = getelementptr inbounds nuw [4 x i8], ptr %.212001891.us.i, i64 %indvars.iv.next2342.i.2
  %i.bem = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.bek, <4 x i32> %i.ank, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  %i.ben = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.bel, <4 x i32> %i.ank, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.bem, ptr %i.bej, align 1, !tbaa !45
  %i.beo = getelementptr inbounds nuw i8, ptr %.511921886.us.i, i64 112
  store <4 x float> %i.ben, ptr %i.beo, align 1, !tbaa !45
  %i.bep = getelementptr inbounds nuw i8, ptr %.511921886.us.i, i64 128 ; 3 uses
  ...
  br i1 %niter662.ncmp.3, label %._crit_edge1888.us.i.unr-lcssa, label %.preheader1557.us.i.new, !llvm.loop !127
...
.epil.preheader655:                               ; preds = %._crit_edge1888.us.i.unr-lcssa, %.preheader1557.us.i
  ...
  %.511921886.us.i.epil.init = phi ptr [ %.411911892.us.i, %.preheader1557.us.i ], [ %i.bep, %._crit_edge1888.us.i.unr-lcssa ]
...
bb.bp:                                            ; preds = %bb.bp, %.epil.preheader655
  ...
  %.511921886.us.i.epil = phi ptr [ %.511921886.us.i.epil.init, %.epil.preheader655 ], [ %i.bev, %bb.bp ] ; 3 uses
  %epil.iter657 = phi i64 [ 0, %.epil.preheader655 ], [ %epil.iter657.next, %bb.bp ]
  %i.beq = getelementptr inbounds nuw [4 x i8], ptr %.212041890.us.i, i64 %indvars.iv2341.i.epil
  %i.ber = getelementptr inbounds nuw [4 x i8], ptr %.212001891.us.i, i64 %indvars.iv2341.i.epil
  %i.bes = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr %i.beq, <4 x i32> %i.ank, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  %i.bet = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr %i.ber, <4 x i32> %i.ank, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.bes, ptr %.511921886.us.i.epil, align 1, !tbaa !45
  %i.beu = getelementptr inbounds nuw i8, ptr %.511921886.us.i.epil, i64 16
  store <4 x float> %i.bet, ptr %i.beu, align 1, !tbaa !45
  %i.bev = getelementptr inbounds nuw i8, ptr %.511921886.us.i.epil, i64 32 ; 2 uses
  ...
  br i1 %epil.iter657.cmp.not, label %._crit_edge1888.us.i, label %bb.bp, !llvm.loop !128

._crit_edge1888.us.i:                             ; preds = %bb.bp, %._crit_edge1888.us.i.unr-lcssa
  %.lcssa524 = phi ptr [ %i.bep, %._crit_edge1888.us.i.unr-lcssa ], [ %i.bev, %bb.bp ] ; 2 uses
  %i.bew = getelementptr inbounds nuw [4 x i8], ptr %.212041890.us.i, i64 %i.any ; 2 uses
  %i.bex = getelementptr inbounds nuw [4 x i8], ptr %.212001891.us.i, i64 %i.any ; 2 uses
  %i.bey = add nuw nsw i32 %.211841893.us.i, 4    ; 3 uses
  %i.bez = or disjoint i32 %i.bey, 3
  %i.bfa = icmp slt i32 %i.bez, %i.n
  br i1 %i.bfa, label %.preheader1557.us.i, label %.preheader1561.i, !llvm.loop !129

.preheader1561.i:                                 ; preds = %._crit_edge1888.us.i, %.preheader1562.i
  %.21204.lcssa.i = phi ptr [ %.11203.lcssa.i, %.preheader1562.i ], [ %i.bew, %._crit_edge1888.us.i ] ; 6 uses
  %.21200.lcssa.i = phi ptr [ %.11199.lcssa.i, %.preheader1562.i ], [ %i.bex, %._crit_edge1888.us.i ] ; 6 uses
  %.41191.lcssa.i = phi ptr [ %.21189.lcssa.i, %.preheader1562.i ], [ %.lcssa524, %._crit_edge1888.us.i ] ; 2 uses
  %.21184.lcssa.i = phi i32 [ %.11183.lcssa.i, %.preheader1562.i ], [ %i.bey, %._crit_edge1888.us.i ] ; 5 uses
  %i.bfb = or disjoint i32 %.21184.lcssa.i, 1
  %i.bfc = icmp slt i32 %i.bfb, %i.n
  br i1 %i.bfc, label %.preheader1556.lr.ph.i, label %.preheader1560.i

.preheader1556.lr.ph.i:                           ; preds = %.preheader1561.i
  br i1 %i.ans, label %.preheader1556.us.i.preheader, label %._crit_edge1928.split.i

.preheader1556.us.i.preheader:                    ; preds = %.preheader1556.lr.ph.i
  %scevgep345 = getelementptr i8, ptr %.21200.lcssa.i, i64 %i.aov
  %scevgep346 = getelementptr i8, ptr %.21200.lcssa.i, i64 %i.aow
  %2 = add i32 %.21184.lcssa.i, 3
  %smax = tail call i32 @llvm.smax.i32(i32 %i.n, i32 %2)
  %3 = add i32 %smax, -2
  %i.bfd = sub i32 %3, %.21184.lcssa.i
  %i.bfe = lshr i32 %i.bfd, 1
  %i.bff = zext nneg i32 %i.bfe to i64
  %i.bfg = mul i64 %i.aox, %i.bff                 ; 4 uses
  %scevgep347 = getelementptr i8, ptr %scevgep346, i64 %i.bfg
  %scevgep348 = getelementptr i8, ptr %.21204.lcssa.i, i64 %i.aov
  %scevgep349 = getelementptr i8, ptr %.21204.lcssa.i, i64 %i.aow
  %scevgep350 = getelementptr i8, ptr %scevgep349, i64 %i.bfg
  %scevgep351 = getelementptr i8, ptr %.21200.lcssa.i, i64 %i.aot
  %scevgep352 = getelementptr i8, ptr %scevgep351, i64 %i.bfg
  %scevgep353 = getelementptr i8, ptr %.21204.lcssa.i, i64 %i.aot
  %scevgep354 = getelementptr i8, ptr %scevgep353, i64 %i.bfg
  br label %iter.check390

iter.check390:                                    ; preds = %.preheader1556.us.i.preheader, %._crit_edge1908.us.i
  %.311851913.us.i = phi i32 [ %i.bhn, %._crit_edge1908.us.i ], [ %.21184.lcssa.i, %.preheader1556.us.i.preheader ]
  %.611931912.us.i = phi ptr [ %.lcssa272, %._crit_edge1908.us.i ], [ %.41191.lcssa.i, %.preheader1556.us.i.preheader ] ; 11 uses
  %.312011911.us.i = phi ptr [ %i.bhm, %._crit_edge1908.us.i ], [ %.21200.lcssa.i, %.preheader1556.us.i.preheader ] ; 6 uses
  %.312051910.us.i = phi ptr [ %i.bhl, %._crit_edge1908.us.i ], [ %.21204.lcssa.i, %.preheader1556.us.i.preheader ] ; 6 uses
...
vector.memcheck343:                               ; preds = %iter.check390
  %scevgep344 = getelementptr i8, ptr %.611931912.us.i, i64 %i.aou ; 4 uses
  ...
  %i.bfh = or i1 %found.conflict360, %stride.check361
  %conflict.rdx362 = or i1 %found.conflict357, %i.bfh
...
vector.ph376:                                     ; preds = %vector.main.loop.iter.check374
  %i.bfi = getelementptr i8, ptr %.611931912.us.i, i64 %i.apd ; 2 uses
...
vector.body378:                                   ; preds = %vector.body378, %vector.ph376
  ...
  %i.bfj = shl i64 %index379, 4
  %next.gep380 = getelementptr i8, ptr %.611931912.us.i, i64 %i.bfj
  %i.bfk = getelementptr inbounds nuw [4 x i8], ptr %.312051910.us.i, i64 %index379 ; 2 uses
  %i.bfl = getelementptr inbounds nuw [4 x i8], ptr %.312011911.us.i, i64 %index379 ; 2 uses
  %wide.load381 = load <16 x float>, ptr %i.bfk, align 4, !tbaa !48, !alias.scope !181
  %wide.load382 = load <16 x float>, ptr %i.bfl, align 4, !tbaa !48, !alias.scope !182
  %i.bfm = getelementptr inbounds nuw [4 x i8], ptr %i.bfk, i64 %i.anz
  %i.bfn = getelementptr inbounds nuw [4 x i8], ptr %i.bfl, i64 %i.anz
  %wide.load383 = load <16 x float>, ptr %i.bfm, align 4, !tbaa !48, !alias.scope !183
  %wide.load384 = load <16 x float>, ptr %i.bfn, align 4, !tbaa !48, !alias.scope !184
  %i.bfo = shufflevector <16 x float> %wide.load381, <16 x float> %wide.load382, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %i.bfp = shufflevector <16 x float> %wide.load383, <16 x float> %wide.load384, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %interleaved.vec385 = shufflevector <32 x float> %i.bfo, <32 x float> %i.bfp, <64 x i32> <i32 0, i32 16, i32 32, i32 48, i32 1, i32 17, i32 33, i32 49, i32 2, i32 18, i32 34, i32 50, i32 3, i32 19, i32 35, i32 51, i32 4, i32 20, i32 36, i32 52, i32 5, i32 21, i32 37, i32 53, i32 6, i32 22, i32 38, i32 54, i32 7, i32 23, i32 39, i32 55, i32 8, i32 24, i32 40, i32 56, i32 9, i32 25, i32 41, i32 57, i32 10, i32 26, i32 42, i32 58, i32 11, i32 27, i32 43, i32 59, i32 12, i32 28, i32 44, i32 60, i32 13, i32 29, i32 45, i32 61, i32 14, i32 30, i32 46, i32 62, i32 15, i32 31, i32 47, i32 63>
  store <64 x float> %interleaved.vec385, ptr %next.gep380, align 4, !tbaa !48, !alias.scope !185, !noalias !186
  %index.next386 = add nuw i64 %index379, 16      ; 2 uses
  %i.bfq = icmp eq i64 %index.next386, %n.vec377
  br i1 %i.bfq, label %middle.block387, label %vector.body378, !llvm.loop !136
...
vec.epilog.iter.check392:                         ; preds = %middle.block387
  br i1 %min.epilog.iters.check393, label %vec.epilog.scalar.ph391.preheader, label %vec.epilog.ph394, !prof !51
...
vec.epilog.ph394:                                 ; preds = %vector.main.loop.iter.check374, %vec.epilog.iter.check392
  ...
  %i.bfr = getelementptr i8, ptr %.611931912.us.i, i64 %i.ape ; 2 uses
...
vec.epilog.vector.body396:                        ; preds = %vec.epilog.vector.body396, %vec.epilog.ph394
  ...
  %i.bfs = shl i64 %index397, 4
  %next.gep398 = getelementptr i8, ptr %.611931912.us.i, i64 %i.bfs
  %i.bft = getelementptr inbounds nuw [4 x i8], ptr %.312051910.us.i, i64 %index397 ; 2 uses
  %i.bfu = getelementptr inbounds nuw [4 x i8], ptr %.312011911.us.i, i64 %index397 ; 2 uses
  %wide.load399 = load <4 x float>, ptr %i.bft, align 4, !tbaa !48, !alias.scope !181
  %wide.load400 = load <4 x float>, ptr %i.bfu, align 4, !tbaa !48, !alias.scope !182
  %i.bfv = getelementptr inbounds nuw [4 x i8], ptr %i.bft, i64 %i.anz
  %i.bfw = getelementptr inbounds nuw [4 x i8], ptr %i.bfu, i64 %i.anz
  %wide.load401 = load <4 x float>, ptr %i.bfv, align 4, !tbaa !48, !alias.scope !183
  %wide.load402 = load <4 x float>, ptr %i.bfw, align 4, !tbaa !48, !alias.scope !184
  %i.bfx = shufflevector <4 x float> %wide.load399, <4 x float> %wide.load400, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.bfy = shufflevector <4 x float> %wide.load401, <4 x float> %wide.load402, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %interleaved.vec403 = shufflevector <8 x float> %i.bfx, <8 x float> %i.bfy, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
  store <16 x float> %interleaved.vec403, ptr %next.gep398, align 4, !tbaa !48, !alias.scope !185, !noalias !186
  %index.next404 = add nuw i64 %index397, 4       ; 2 uses
  %i.bfz = icmp eq i64 %index.next404, %n.vec395
  br i1 %i.bfz, label %vec.epilog.middle.block405, label %vec.epilog.vector.body396, !llvm.loop !137
...
vec.epilog.scalar.ph391.preheader:                ; preds = %vector.memcheck343, %iter.check390, %vec.epilog.iter.check392, %vec.epilog.middle.block405
  ...
  %.711941906.us.i.ph = phi ptr [ %.611931912.us.i, %iter.check390 ], [ %.611931912.us.i, %vector.memcheck343 ], [ %i.bfi, %vec.epilog.iter.check392 ], [ %i.bfr, %vec.epilog.middle.block405 ] ; 6 uses
...
vec.epilog.scalar.ph391.prol:                     ; preds = %vec.epilog.scalar.ph391.preheader
  %i.bga = getelementptr inbounds nuw [4 x i8], ptr %.312051910.us.i, i64 %indvars.iv2349.i.ph ; 2 uses
  %i.bgb = getelementptr inbounds nuw [4 x i8], ptr %.312011911.us.i, i64 %indvars.iv2349.i.ph ; 2 uses
  %i.bgc = load float, ptr %i.bga, align 4, !tbaa !48
  store float %i.bgc, ptr %.711941906.us.i.ph, align 4, !tbaa !48
  %i.bgd = load float, ptr %i.bgb, align 4, !tbaa !48
  %i.bge = getelementptr inbounds nuw i8, ptr %.711941906.us.i.ph, i64 4
  store float %i.bgd, ptr %i.bge, align 4, !tbaa !48
  %i.bgf = getelementptr inbounds nuw [4 x i8], ptr %i.bga, i64 %i.anz
  %i.bgg = getelementptr inbounds nuw [4 x i8], ptr %i.bgb, i64 %i.anz
  %i.bgh = getelementptr inbounds nuw i8, ptr %.711941906.us.i.ph, i64 8
  %i.bgi = load float, ptr %i.bgf, align 4, !tbaa !48
  store float %i.bgi, ptr %i.bgh, align 4, !tbaa !48
  %i.bgj = load float, ptr %i.bgg, align 4, !tbaa !48
  %i.bgk = getelementptr inbounds nuw i8, ptr %.711941906.us.i.ph, i64 12
  store float %i.bgj, ptr %i.bgk, align 4, !tbaa !48
  %i.bgl = getelementptr inbounds nuw i8, ptr %.711941906.us.i.ph, i64 16 ; 2 uses
...
vec.epilog.scalar.ph391.prol.loopexit:            ; preds = %vec.epilog.scalar.ph391.prol, %vec.epilog.scalar.ph391.preheader
  %.lcssa528.unr = phi ptr [ poison, %vec.epilog.scalar.ph391.preheader ], [ %i.bgl, %vec.epilog.scalar.ph391.prol ]
  ...
  %.711941906.us.i.unr = phi ptr [ %.711941906.us.i.ph, %vec.epilog.scalar.ph391.preheader ], [ %i.bgl, %vec.epilog.scalar.ph391.prol ]
  %i.bgm = icmp eq i64 %indvars.iv2349.i.ph, %i.apf
  br i1 %i.bgm, label %._crit_edge1908.us.i, label %vec.epilog.scalar.ph391
...
vec.epilog.scalar.ph391:                          ; preds = %vec.epilog.scalar.ph391.prol.loopexit, %vec.epilog.scalar.ph391
  ...
  %.711941906.us.i = phi ptr [ %i.bhk, %vec.epilog.scalar.ph391 ], [ %.711941906.us.i.unr, %vec.epilog.scalar.ph391.prol.loopexit ] ; 9 uses
  %i.bgn = getelementptr inbounds nuw [4 x i8], ptr %.312051910.us.i, i64 %indvars.iv2349.i ; 2 uses
  %i.bgo = getelementptr inbounds nuw [4 x i8], ptr %.312011911.us.i, i64 %indvars.iv2349.i ; 2 uses
  %i.bgp = load float, ptr %i.bgn, align 4, !tbaa !48
  store float %i.bgp, ptr %.711941906.us.i, align 4, !tbaa !48
  %i.bgq = load float, ptr %i.bgo, align 4, !tbaa !48
  %i.bgr = getelementptr inbounds nuw i8, ptr %.711941906.us.i, i64 4
  store float %i.bgq, ptr %i.bgr, align 4, !tbaa !48
  %i.bgs = getelementptr inbounds nuw [4 x i8], ptr %i.bgn, i64 %i.anz
  %i.bgt = getelementptr inbounds nuw [4 x i8], ptr %i.bgo, i64 %i.anz
  %i.bgu = getelementptr inbounds nuw i8, ptr %.711941906.us.i, i64 8
  %i.bgv = load float, ptr %i.bgs, align 4, !tbaa !48
  store float %i.bgv, ptr %i.bgu, align 4, !tbaa !48
  %i.bgw = load float, ptr %i.bgt, align 4, !tbaa !48
  %i.bgx = getelementptr inbounds nuw i8, ptr %.711941906.us.i, i64 12
  store float %i.bgw, ptr %i.bgx, align 4, !tbaa !48
  %i.bgy = getelementptr inbounds nuw i8, ptr %.711941906.us.i, i64 16
  %indvars.iv.next2350.i = add nuw nsw i64 %indvars.iv2349.i, 1 ; 2 uses
  %i.bgz = getelementptr inbounds nuw [4 x i8], ptr %.312051910.us.i, i64 %indvars.iv.next2350.i ; 2 uses
  %i.bha = getelementptr inbounds nuw [4 x i8], ptr %.312011911.us.i, i64 %indvars.iv.next2350.i ; 2 uses
  %i.bhb = load float, ptr %i.bgz, align 4, !tbaa !48
  store float %i.bhb, ptr %i.bgy, align 4, !tbaa !48
  %i.bhc = load float, ptr %i.bha, align 4, !tbaa !48
  %i.bhd = getelementptr inbounds nuw i8, ptr %.711941906.us.i, i64 20
  store float %i.bhc, ptr %i.bhd, align 4, !tbaa !48
  %i.bhe = getelementptr inbounds nuw [4 x i8], ptr %i.bgz, i64 %i.anz
  %i.bhf = getelementptr inbounds nuw [4 x i8], ptr %i.bha, i64 %i.anz
  %i.bhg = getelementptr inbounds nuw i8, ptr %.711941906.us.i, i64 24
  %i.bhh = load float, ptr %i.bhe, align 4, !tbaa !48
  store float %i.bhh, ptr %i.bhg, align 4, !tbaa !48
  %i.bhi = load float, ptr %i.bhf, align 4, !tbaa !48
  %i.bhj = getelementptr inbounds nuw i8, ptr %.711941906.us.i, i64 28
  store float %i.bhi, ptr %i.bhj, align 4, !tbaa !48
  %i.bhk = getelementptr inbounds nuw i8, ptr %.711941906.us.i, i64 32 ; 2 uses
  ...
  br i1 %exitcond2353.not.i.1, label %._crit_edge1908.us.i, label %vec.epilog.scalar.ph391, !llvm.loop !138
...
._crit_edge1908.us.i:                             ; preds = %vec.epilog.scalar.ph391.prol.loopexit, %vec.epilog.scalar.ph391, %vec.epilog.middle.block405, %middle.block387
  %.lcssa272 = phi ptr [ %i.bfr, %vec.epilog.middle.block405 ], [ %i.bfi, %middle.block387 ], [ %.lcssa528.unr, %vec.epilog.scalar.ph391.prol.loopexit ], [ %i.bhk, %vec.epilog.scalar.ph391 ] ; 2 uses
  %i.bhl = getelementptr inbounds nuw [4 x i8], ptr %.312051910.us.i, i64 %i.aob ; 2 uses
  %i.bhm = getelementptr inbounds nuw [4 x i8], ptr %.312011911.us.i, i64 %i.aob ; 2 uses
  %i.bhn = add nuw nsw i32 %.311851913.us.i, 2    ; 3 uses
  %i.bho = or disjoint i32 %i.bhn, 1
  %i.bhp = icmp slt i32 %i.bho, %i.n
  br i1 %i.bhp, label %iter.check390, label %.preheader1560.i, !llvm.loop !139

.preheader1560.i:                                 ; preds = %._crit_edge1908.us.i, %.preheader1561.i
  %.31205.lcssa.i = phi ptr [ %.21204.lcssa.i, %.preheader1561.i ], [ %i.bhl, %._crit_edge1908.us.i ] ; 9 uses
  %.31201.lcssa.i = phi ptr [ %.21200.lcssa.i, %.preheader1561.i ], [ %i.bhm, %._crit_edge1908.us.i ] ; 9 uses
  %.61193.lcssa.i = phi ptr [ %.41191.lcssa.i, %.preheader1561.i ], [ %.lcssa272, %._crit_edge1908.us.i ]
  %.31185.lcssa.i = phi i32 [ %.21184.lcssa.i, %.preheader1561.i ], [ %i.bhn, %._crit_edge1908.us.i ] ; 2 uses
  %i.bhq = icmp sge i32 %.31185.lcssa.i, %i.n
  %brmerge2004.i = or i1 %i.aoc, %i.bhq
...
.preheader1555.i.preheader:                       ; preds = %.preheader1560.i
  %scevgep326 = getelementptr i8, ptr %.31201.lcssa.i, i64 %i.aot
  %scevgep327 = getelementptr i8, ptr %.31205.lcssa.i, i64 %i.aot
  br label %iter.check

iter.check:                                       ; preds = %.preheader1555.i.preheader, %._crit_edge1924.i
  %.411861927.i = phi i32 [ %i.bij, %._crit_edge1924.i ], [ %.31185.lcssa.i, %.preheader1555.i.preheader ]
...
begin_hunk_2_@_ZN4ncnn24Convolution1D_x86_avx51215create_pipelineERKNS_6OptionE:bb.a
  br i1 %i.aye, label %.preheader1548.us.i, label %.preheader1548.preheader.i
...
.preheader1548.preheader.i:                       ; preds = %.preheader1548.lr.ph.i, %.preheader1553.thread.i
  ...
  %.01138.lcssa26042610.i = phi ptr [ %.01138.lcssa.i, %.preheader1548.lr.ph.i ], [ %i.bke, %.preheader1553.thread.i ]
  %.01133.lcssa26052609.i = phi i32 [ %.01133.lcssa.i, %.preheader1548.lr.ph.i ], [ %i.ayw, %.preheader1553.thread.i ] ; 2 uses
  %i.blt = sub i32 %i.ayx, %.01133.lcssa26052609.i ; 2 uses
  %i.blu = lshr i32 %i.blt, 1
  %i.blv = and i32 %i.blu, 2147483644
  %narrow2445.i = add nuw i32 %i.blv, 4
  %i.blw = zext i32 %narrow2445.i to i64
  %i.blx = mul nsw i64 %i.blw, %i.ayi
  %scevgep2372.i = getelementptr i8, ptr %.01143.lcssa26032611.i, i64 %i.blx
  %i.bly = add i32 %.01133.lcssa26052609.i, 8
  %i.blz = and i32 %i.blt, -8
  %i.bma = add i32 %i.bly, %i.blz
  br label %.preheader1552.i

.preheader1548.us.i:                              ; preds = %.preheader1548.lr.ph.i, %._crit_edge1946.us.i
  %.111341950.us.i = phi i32 [ %i.bnk, %._crit_edge1946.us.i ], [ %.01133.lcssa.i, %.preheader1548.lr.ph.i ]
  %.211401949.us.i = phi ptr [ %.lcssa507, %._crit_edge1946.us.i ], [ %.01138.lcssa.i, %.preheader1548.lr.ph.i ] ; 2 uses
  %.111441948.us.i = phi ptr [ %i.bnj, %._crit_edge1946.us.i ], [ %.01143.lcssa.i, %.preheader1548.lr.ph.i ] ; 10 uses
  br i1 %i.azh, label %.epil.preheader675, label %.preheader1548.us.i.new
...
.preheader1548.us.i.new:                          ; preds = %.preheader1548.us.i, %.preheader1548.us.i.new
  ...
  %.311411944.us.i = phi ptr [ %i.bnf, %.preheader1548.us.i.new ], [ %.211401949.us.i, %.preheader1548.us.i ] ; 9 uses
  %niter682 = phi i64 [ %niter682.next.7, %.preheader1548.us.i.new ], [ 0, %.preheader1548.us.i ]
  %i.bmb = getelementptr inbounds nuw [4 x i8], ptr %.111441948.us.i, i64 %indvars.iv2373.i
  %i.bmc = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr %i.bmb, <8 x i32> %i.axz, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bmc, ptr %.311411944.us.i, align 1, !tbaa !45
  %i.bmd = getelementptr inbounds nuw i8, ptr %.311411944.us.i, i64 32
  %i.bme = getelementptr inbounds nuw [4 x i8], ptr %.111441948.us.i, i64 %indvars.iv2373.i
  %i.bmf = getelementptr inbounds nuw i8, ptr %i.bme, i64 4
  %i.bmg = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bmf, <8 x i32> %i.axz, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bmg, ptr %i.bmd, align 1, !tbaa !45
  %i.bmh = getelementptr inbounds nuw i8, ptr %.311411944.us.i, i64 64
  %i.bmi = getelementptr inbounds nuw [4 x i8], ptr %.111441948.us.i, i64 %indvars.iv2373.i
  %i.bmj = getelementptr inbounds nuw i8, ptr %i.bmi, i64 8
  %i.bmk = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bmj, <8 x i32> %i.axz, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bmk, ptr %i.bmh, align 1, !tbaa !45
  %i.bml = getelementptr inbounds nuw i8, ptr %.311411944.us.i, i64 96
  %i.bmm = getelementptr inbounds nuw [4 x i8], ptr %.111441948.us.i, i64 %indvars.iv2373.i
  %i.bmn = getelementptr inbounds nuw i8, ptr %i.bmm, i64 12
  %i.bmo = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bmn, <8 x i32> %i.axz, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bmo, ptr %i.bml, align 1, !tbaa !45
  %i.bmp = getelementptr inbounds nuw i8, ptr %.311411944.us.i, i64 128
  %i.bmq = getelementptr inbounds nuw [4 x i8], ptr %.111441948.us.i, i64 %indvars.iv2373.i
  %i.bmr = getelementptr inbounds nuw i8, ptr %i.bmq, i64 16
  %i.bms = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bmr, <8 x i32> %i.axz, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bms, ptr %i.bmp, align 1, !tbaa !45
  %i.bmt = getelementptr inbounds nuw i8, ptr %.311411944.us.i, i64 160
  %i.bmu = getelementptr inbounds nuw [4 x i8], ptr %.111441948.us.i, i64 %indvars.iv2373.i
  %i.bmv = getelementptr inbounds nuw i8, ptr %i.bmu, i64 20
  %i.bmw = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bmv, <8 x i32> %i.axz, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bmw, ptr %i.bmt, align 1, !tbaa !45
  %i.bmx = getelementptr inbounds nuw i8, ptr %.311411944.us.i, i64 192
  %i.bmy = getelementptr inbounds nuw [4 x i8], ptr %.111441948.us.i, i64 %indvars.iv2373.i
  %i.bmz = getelementptr inbounds nuw i8, ptr %i.bmy, i64 24
  %i.bna = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bmz, <8 x i32> %i.axz, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bna, ptr %i.bmx, align 1, !tbaa !45
  %i.bnb = getelementptr inbounds nuw i8, ptr %.311411944.us.i, i64 224
  %i.bnc = getelementptr inbounds nuw [4 x i8], ptr %.111441948.us.i, i64 %indvars.iv2373.i
  %i.bnd = getelementptr inbounds nuw i8, ptr %i.bnc, i64 28
  %i.bne = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr nonnull %i.bnd, <8 x i32> %i.axz, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bne, ptr %i.bnb, align 1, !tbaa !45
  %i.bnf = getelementptr inbounds nuw i8, ptr %.311411944.us.i, i64 256 ; 3 uses
  ...
  br i1 %niter682.ncmp.7, label %._crit_edge1946.us.i.unr-lcssa, label %.preheader1548.us.i.new, !llvm.loop !155
...
.epil.preheader675:                               ; preds = %._crit_edge1946.us.i.unr-lcssa, %.preheader1548.us.i
  ...
  %.311411944.us.i.epil.init = phi ptr [ %.211401949.us.i, %.preheader1548.us.i ], [ %i.bnf, %._crit_edge1946.us.i.unr-lcssa ]
...
bb.br:                                            ; preds = %bb.br, %.epil.preheader675
  ...
  %.311411944.us.i.epil = phi ptr [ %.311411944.us.i.epil.init, %.epil.preheader675 ], [ %i.bni, %bb.br ] ; 2 uses
  %epil.iter677 = phi i64 [ 0, %.epil.preheader675 ], [ %epil.iter677.next, %bb.br ]
  %i.bng = getelementptr inbounds nuw [4 x i8], ptr %.111441948.us.i, i64 %indvars.iv2373.i.epil
  %i.bnh = tail call fast <8 x float> @llvm.x86.avx2.gather.d.ps.256(<8 x float> zeroinitializer, ptr %i.bng, <8 x i32> %i.axz, <8 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <8 x float> %i.bnh, ptr %.311411944.us.i.epil, align 1, !tbaa !45
  %i.bni = getelementptr inbounds nuw i8, ptr %.311411944.us.i.epil, i64 32 ; 2 uses
  ...
  br i1 %epil.iter677.cmp.not, label %._crit_edge1946.us.i, label %bb.br, !llvm.loop !156

._crit_edge1946.us.i:                             ; preds = %bb.br, %._crit_edge1946.us.i.unr-lcssa
  %.lcssa507 = phi ptr [ %i.bnf, %._crit_edge1946.us.i.unr-lcssa ], [ %i.bni, %bb.br ] ; 2 uses
  %i.bnj = getelementptr inbounds nuw [4 x i8], ptr %.111441948.us.i, i64 %i.ayi ; 2 uses
  %i.bnk = add nuw nsw i32 %.111341950.us.i, 8    ; 3 uses
  %i.bnl = or disjoint i32 %i.bnk, 7
  %i.bnm = icmp slt i32 %i.bnl, %i.n
  br i1 %i.bnm, label %.preheader1548.us.i, label %.preheader1552.i, !llvm.loop !157

.preheader1552.i:                                 ; preds = %._crit_edge1946.us.i, %.preheader1548.preheader.i, %.preheader1553.thread.i, %.preheader1553.i
  %.11144.lcssa.i = phi ptr [ %.01143.lcssa.i, %.preheader1553.i ], [ %scevgep2366.i, %.preheader1553.thread.i ], [ %scevgep2372.i, %.preheader1548.preheader.i ], [ %i.bnj, %._crit_edge1946.us.i ] ; 2 uses
  %.21140.lcssa.i = phi ptr [ %.01138.lcssa.i, %.preheader1553.i ], [ %i.bke, %.preheader1553.thread.i ], [ %.01138.lcssa26042610.i, %.preheader1548.preheader.i ], [ %.lcssa507, %._crit_edge1946.us.i ] ; 2 uses
  %.11134.lcssa.i = phi i32 [ %.01133.lcssa.i, %.preheader1553.i ], [ %i.ayw, %.preheader1553.thread.i ], [ %i.bma, %.preheader1548.preheader.i ], [ %i.bnk, %._crit_edge1946.us.i ] ; 3 uses
  %i.bnn = or disjoint i32 %.11134.lcssa.i, 3
  %i.bno = icmp slt i32 %i.bnn, %i.n
  br i1 %i.bno, label %.preheader1547.lr.ph.i, label %.preheader1551.i

.preheader1547.lr.ph.i:                           ; preds = %.preheader1552.i
  br i1 %i.aye, label %.preheader1547.us.i, label %._crit_edge1992.split.i

.preheader1547.us.i:                              ; preds = %.preheader1547.lr.ph.i, %._crit_edge1959.us.i
  %.211351963.us.i = phi i32 [ %i.boy, %._crit_edge1959.us.i ], [ %.11134.lcssa.i, %.preheader1547.lr.ph.i ]
  %.411421962.us.i = phi ptr [ %.lcssa510, %._crit_edge1959.us.i ], [ %.21140.lcssa.i, %.preheader1547.lr.ph.i ] ; 2 uses
  %.211451961.us.i = phi ptr [ %i.box, %._crit_edge1959.us.i ], [ %.11144.lcssa.i, %.preheader1547.lr.ph.i ] ; 10 uses
  br i1 %i.azi, label %.epil.preheader683, label %.preheader1547.us.i.new
...
.preheader1547.us.i.new:                          ; preds = %.preheader1547.us.i, %.preheader1547.us.i.new
  ...
  %.51957.us.i = phi ptr [ %i.bot, %.preheader1547.us.i.new ], [ %.411421962.us.i, %.preheader1547.us.i ] ; 9 uses
  %niter690 = phi i64 [ %niter690.next.7, %.preheader1547.us.i.new ], [ 0, %.preheader1547.us.i ]
  %i.bnp = getelementptr inbounds nuw [4 x i8], ptr %.211451961.us.i, i64 %indvars.iv2380.i
  %i.bnq = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr %i.bnp, <4 x i32> %i.axw, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.bnq, ptr %.51957.us.i, align 1, !tbaa !45
  %i.bnr = getelementptr inbounds nuw i8, ptr %.51957.us.i, i64 16
  %i.bns = getelementptr inbounds nuw [4 x i8], ptr %.211451961.us.i, i64 %indvars.iv2380.i
  %i.bnt = getelementptr inbounds nuw i8, ptr %i.bns, i64 4
  %i.bnu = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.bnt, <4 x i32> %i.axw, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.bnu, ptr %i.bnr, align 1, !tbaa !45
  %i.bnv = getelementptr inbounds nuw i8, ptr %.51957.us.i, i64 32
  %i.bnw = getelementptr inbounds nuw [4 x i8], ptr %.211451961.us.i, i64 %indvars.iv2380.i
  %i.bnx = getelementptr inbounds nuw i8, ptr %i.bnw, i64 8
  %i.bny = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.bnx, <4 x i32> %i.axw, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.bny, ptr %i.bnv, align 1, !tbaa !45
  %i.bnz = getelementptr inbounds nuw i8, ptr %.51957.us.i, i64 48
  %i.boa = getelementptr inbounds nuw [4 x i8], ptr %.211451961.us.i, i64 %indvars.iv2380.i
  %i.bob = getelementptr inbounds nuw i8, ptr %i.boa, i64 12
  %i.boc = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.bob, <4 x i32> %i.axw, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.boc, ptr %i.bnz, align 1, !tbaa !45
  %i.bod = getelementptr inbounds nuw i8, ptr %.51957.us.i, i64 64
  %i.boe = getelementptr inbounds nuw [4 x i8], ptr %.211451961.us.i, i64 %indvars.iv2380.i
  %i.bof = getelementptr inbounds nuw i8, ptr %i.boe, i64 16
  %i.bog = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.bof, <4 x i32> %i.axw, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.bog, ptr %i.bod, align 1, !tbaa !45
  %i.boh = getelementptr inbounds nuw i8, ptr %.51957.us.i, i64 80
  %i.boi = getelementptr inbounds nuw [4 x i8], ptr %.211451961.us.i, i64 %indvars.iv2380.i
  %i.boj = getelementptr inbounds nuw i8, ptr %i.boi, i64 20
  %i.bok = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.boj, <4 x i32> %i.axw, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.bok, ptr %i.boh, align 1, !tbaa !45
  %i.bol = getelementptr inbounds nuw i8, ptr %.51957.us.i, i64 96
  %i.bom = getelementptr inbounds nuw [4 x i8], ptr %.211451961.us.i, i64 %indvars.iv2380.i
  %i.bon = getelementptr inbounds nuw i8, ptr %i.bom, i64 24
  %i.boo = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.bon, <4 x i32> %i.axw, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.boo, ptr %i.bol, align 1, !tbaa !45
  %i.bop = getelementptr inbounds nuw i8, ptr %.51957.us.i, i64 112
  %i.boq = getelementptr inbounds nuw [4 x i8], ptr %.211451961.us.i, i64 %indvars.iv2380.i
  %i.bor = getelementptr inbounds nuw i8, ptr %i.boq, i64 28
  %i.bos = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr nonnull %i.bor, <4 x i32> %i.axw, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.bos, ptr %i.bop, align 1, !tbaa !45
  %i.bot = getelementptr inbounds nuw i8, ptr %.51957.us.i, i64 128 ; 3 uses
  ...
  br i1 %niter690.ncmp.7, label %._crit_edge1959.us.i.unr-lcssa, label %.preheader1547.us.i.new, !llvm.loop !158
...
.epil.preheader683:                               ; preds = %._crit_edge1959.us.i.unr-lcssa, %.preheader1547.us.i
  ...
  %.51957.us.i.epil.init = phi ptr [ %.411421962.us.i, %.preheader1547.us.i ], [ %i.bot, %._crit_edge1959.us.i.unr-lcssa ]
...
bb.bs:                                            ; preds = %bb.bs, %.epil.preheader683
  ...
  %.51957.us.i.epil = phi ptr [ %.51957.us.i.epil.init, %.epil.preheader683 ], [ %i.bow, %bb.bs ] ; 2 uses
  %epil.iter685 = phi i64 [ 0, %.epil.preheader683 ], [ %epil.iter685.next, %bb.bs ]
  %i.bou = getelementptr inbounds nuw [4 x i8], ptr %.211451961.us.i, i64 %indvars.iv2380.i.epil
  %i.bov = tail call fast <4 x float> @llvm.x86.avx2.gather.d.ps(<4 x float> zeroinitializer, ptr %i.bou, <4 x i32> %i.axw, <4 x float> splat (float -nan(0x3FFFFF)), i8 4)
  store <4 x float> %i.bov, ptr %.51957.us.i.epil, align 1, !tbaa !45
  %i.bow = getelementptr inbounds nuw i8, ptr %.51957.us.i.epil, i64 16 ; 2 uses
  ...
  br i1 %epil.iter685.cmp.not, label %._crit_edge1959.us.i, label %bb.bs, !llvm.loop !159

._crit_edge1959.us.i:                             ; preds = %bb.bs, %._crit_edge1959.us.i.unr-lcssa
  %.lcssa510 = phi ptr [ %i.bot, %._crit_edge1959.us.i.unr-lcssa ], [ %i.bow, %bb.bs ] ; 2 uses
  %i.box = getelementptr inbounds nuw [4 x i8], ptr %.211451961.us.i, i64 %i.ayk ; 2 uses
  %i.boy = add nuw nsw i32 %.211351963.us.i, 4    ; 3 uses
  %i.boz = or disjoint i32 %i.boy, 3
  %i.bpa = icmp slt i32 %i.boz, %i.n
  br i1 %i.bpa, label %.preheader1547.us.i, label %.preheader1551.i, !llvm.loop !160

.preheader1551.i:                                 ; preds = %._crit_edge1959.us.i, %.preheader1552.i
  %.21145.lcssa.i = phi ptr [ %.11144.lcssa.i, %.preheader1552.i ], [ %i.box, %._crit_edge1959.us.i ] ; 6 uses
  %.41142.lcssa.i = phi ptr [ %.21140.lcssa.i, %.preheader1552.i ], [ %.lcssa510, %._crit_edge1959.us.i ] ; 2 uses
  %.21135.lcssa.i = phi i32 [ %.11134.lcssa.i, %.preheader1552.i ], [ %i.boy, %._crit_edge1959.us.i ] ; 5 uses
  %i.bpb = or disjoint i32 %.21135.lcssa.i, 1
  %i.bpc = icmp slt i32 %i.bpb, %i.n
  br i1 %i.bpc, label %.preheader1546.lr.ph.i, label %.preheader1550.i

.preheader1546.lr.ph.i:                           ; preds = %.preheader1551.i
  br i1 %i.aye, label %.preheader1546.us.i.preheader, label %._crit_edge1992.split.i

.preheader1546.us.i.preheader:                    ; preds = %.preheader1546.lr.ph.i
  %scevgep445 = getelementptr i8, ptr %.21145.lcssa.i, i64 %i.azc
  %i.bpd = getelementptr i8, ptr %.21145.lcssa.i, i64 %i.azc
  %scevgep446 = getelementptr i8, ptr %i.bpd, i64 %i.azd
  %4 = add i32 %.21135.lcssa.i, 3
  %smax447 = tail call i32 @llvm.smax.i32(i32 %i.n, i32 %4)
  %5 = add i32 %smax447, -2
  %i.bpe = sub i32 %5, %.21135.lcssa.i
  %i.bpf = lshr i32 %i.bpe, 1
  %i.bpg = zext nneg i32 %i.bpf to i64
  %i.bph = mul i64 %i.aze, %i.bpg                 ; 2 uses
  %scevgep448.a = getelementptr i8, ptr %scevgep446, i64 %i.bph
  %scevgep449.a = getelementptr i8, ptr %.21145.lcssa.i, i64 %i.azd
  %scevgep450 = getelementptr i8, ptr %scevgep449.a, i64 %i.bph
  br label %iter.check479

iter.check479:                                    ; preds = %.preheader1546.us.i.preheader, %._crit_edge1975.us.i
  %.311361979.us.i = phi i32 [ %i.brg, %._crit_edge1975.us.i ], [ %.21135.lcssa.i, %.preheader1546.us.i.preheader ]
  %.61978.us.i = phi ptr [ %.lcssa257, %._crit_edge1975.us.i ], [ %.41142.lcssa.i, %.preheader1546.us.i.preheader ] ; 10 uses
  %.311461977.us.i = phi ptr [ %i.brf, %._crit_edge1975.us.i ], [ %.21145.lcssa.i, %.preheader1546.us.i.preheader ] ; 8 uses
...
vector.memcheck443:                               ; preds = %iter.check479
  %scevgep444 = getelementptr i8, ptr %.61978.us.i, i64 %i.azb ; 2 uses
  ...
  %i.bpi = or i1 %found.conflict457, %stride.check458
  %conflict.rdx459 = or i1 %found.conflict453, %i.bpi
...
vector.ph463:                                     ; preds = %vector.main.loop.iter.check461
  %i.bpj = getelementptr i8, ptr %.61978.us.i, i64 %i.azk ; 2 uses
...
vector.body465:                                   ; preds = %vector.body465, %vector.ph463
  ...
  %i.bpk = shl i64 %index466, 3                   ; 2 uses
  %next.gep467.a = getelementptr i8, ptr %.61978.us.i, i64 %i.bpk
  %i.bpl = getelementptr i8, ptr %.61978.us.i, i64 %i.bpk
  %next.gep468 = getelementptr i8, ptr %i.bpl, i64 128
  %i.bpm = getelementptr inbounds nuw [4 x i8], ptr %.311461977.us.i, i64 %index466 ; 3 uses
  %i.bpn = getelementptr inbounds nuw i8, ptr %i.bpm, i64 64
  %wide.load469.a = load <16 x float>, ptr %i.bpm, align 4, !tbaa !48, !alias.scope !192
  %wide.load470.a = load <16 x float>, ptr %i.bpn, align 4, !tbaa !48, !alias.scope !192
  %i.bpo = getelementptr inbounds nuw [4 x i8], ptr %i.bpm, i64 %i.ayl ; 2 uses
  %i.bpp = getelementptr inbounds nuw i8, ptr %i.bpo, i64 64
  %wide.load471.a = load <16 x float>, ptr %i.bpo, align 4, !tbaa !48, !alias.scope !193
  %wide.load472 = load <16 x float>, ptr %i.bpp, align 4, !tbaa !48, !alias.scope !193
  ...
  store <32 x float> %interleaved.vec473.a, ptr %next.gep467.a, align 4, !tbaa !48, !alias.scope !194, !noalias !195
  %interleaved.vec474 = shufflevector <16 x float> %wide.load470.a, <16 x float> %wide.load472, <32 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23, i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
  store <32 x float> %interleaved.vec474, ptr %next.gep468, align 4, !tbaa !48, !alias.scope !194, !noalias !195
  %index.next475 = add nuw i64 %index466, 32      ; 2 uses
  %i.bpq = icmp eq i64 %index.next475, %n.vec464
  br i1 %i.bpq, label %middle.block476, label %vector.body465, !llvm.loop !165
...
vec.epilog.iter.check481:                         ; preds = %middle.block476
  br i1 %min.epilog.iters.check482, label %vec.epilog.scalar.ph480.preheader, label %vec.epilog.ph483, !prof !52
...
vec.epilog.ph483:                                 ; preds = %vector.main.loop.iter.check461, %vec.epilog.iter.check481
  ...
  %i.bpr = getelementptr i8, ptr %.61978.us.i, i64 %i.azl ; 2 uses
...
vec.epilog.vector.body485:                        ; preds = %vec.epilog.vector.body485, %vec.epilog.ph483
  ...
  %i.bps = shl i64 %index486, 3
  %next.gep487 = getelementptr i8, ptr %.61978.us.i, i64 %i.bps
  %i.bpt = getelementptr inbounds nuw [4 x i8], ptr %.311461977.us.i, i64 %index486 ; 2 uses
  %wide.load488.a = load <8 x float>, ptr %i.bpt, align 4, !tbaa !48, !alias.scope !192
  %i.bpu = getelementptr inbounds nuw [4 x i8], ptr %i.bpt, i64 %i.ayl
  %wide.load489 = load <8 x float>, ptr %i.bpu, align 4, !tbaa !48, !alias.scope !193
  ...
  store <16 x float> %interleaved.vec490, ptr %next.gep487, align 4, !tbaa !48, !alias.scope !194, !noalias !195
  %index.next491 = add nuw i64 %index486, 8       ; 2 uses
  %i.bpv = icmp eq i64 %index.next491, %n.vec484
  br i1 %i.bpv, label %vec.epilog.middle.block492, label %vec.epilog.vector.body485, !llvm.loop !166
...
vec.epilog.scalar.ph480.preheader:                ; preds = %vector.memcheck443, %iter.check479, %vec.epilog.iter.check481, %vec.epilog.middle.block492
  ...
  %.71973.us.i.ph = phi ptr [ %.61978.us.i, %iter.check479 ], [ %.61978.us.i, %vector.memcheck443 ], [ %i.bpj, %vec.epilog.iter.check481 ], [ %i.bpr, %vec.epilog.middle.block492 ] ; 2 uses
...
vec.epilog.scalar.ph480.prol:                     ; preds = %vec.epilog.scalar.ph480.preheader, %vec.epilog.scalar.ph480.prol
  ...
  %.71973.us.i.prol = phi ptr [ %i.bqb, %vec.epilog.scalar.ph480.prol ], [ %.71973.us.i.ph, %vec.epilog.scalar.ph480.preheader ] ; 3 uses
  %prol.iter693 = phi i64 [ %prol.iter693.next, %vec.epilog.scalar.ph480.prol ], [ 0, %vec.epilog.scalar.ph480.preheader ]
  %i.bpw = getelementptr inbounds nuw [4 x i8], ptr %.311461977.us.i, i64 %indvars.iv2387.i.prol ; 2 uses
  %i.bpx = load float, ptr %i.bpw, align 4, !tbaa !48
  store float %i.bpx, ptr %.71973.us.i.prol, align 4, !tbaa !48
  %i.bpy = getelementptr inbounds nuw [4 x i8], ptr %i.bpw, i64 %i.ayl
  %i.bpz = getelementptr inbounds nuw i8, ptr %.71973.us.i.prol, i64 4
  %i.bqa = load float, ptr %i.bpy, align 4, !tbaa !48
  store float %i.bqa, ptr %i.bpz, align 4, !tbaa !48
  %i.bqb = getelementptr inbounds nuw i8, ptr %.71973.us.i.prol, i64 8 ; 3 uses
...
vec.epilog.scalar.ph480.prol.loopexit:            ; preds = %vec.epilog.scalar.ph480.prol, %vec.epilog.scalar.ph480.preheader
  %.lcssa513.unr = phi ptr [ poison, %vec.epilog.scalar.ph480.preheader ], [ %i.bqb, %vec.epilog.scalar.ph480.prol ]
  ...
  %.71973.us.i.unr = phi ptr [ %.71973.us.i.ph, %vec.epilog.scalar.ph480.preheader ], [ %i.bqb, %vec.epilog.scalar.ph480.prol ]
  %i.bqc = sub nsw i64 %indvars.iv2387.i.ph, %wide.trip.count2370.i
  %i.bqd = icmp ugt i64 %i.bqc, -4
  br i1 %i.bqd, label %._crit_edge1975.us.i, label %vec.epilog.scalar.ph480
...
vec.epilog.scalar.ph480:                          ; preds = %vec.epilog.scalar.ph480.prol.loopexit, %vec.epilog.scalar.ph480
  ...
  %.71973.us.i = phi ptr [ %i.bre, %vec.epilog.scalar.ph480 ], [ %.71973.us.i.unr, %vec.epilog.scalar.ph480.prol.loopexit ] ; 9 uses
  %i.bqe = getelementptr inbounds nuw [4 x i8], ptr %.311461977.us.i, i64 %indvars.iv2387.i ; 2 uses
  %i.bqf = load float, ptr %i.bqe, align 4, !tbaa !48
  store float %i.bqf, ptr %.71973.us.i, align 4, !tbaa !48
  %i.bqg = getelementptr inbounds nuw [4 x i8], ptr %i.bqe, i64 %i.ayl
  %i.bqh = getelementptr inbounds nuw i8, ptr %.71973.us.i, i64 4
  %i.bqi = load float, ptr %i.bqg, align 4, !tbaa !48
  store float %i.bqi, ptr %i.bqh, align 4, !tbaa !48
  %i.bqj = getelementptr inbounds nuw i8, ptr %.71973.us.i, i64 8
  %i.bqk = getelementptr inbounds nuw [4 x i8], ptr %.311461977.us.i, i64 %indvars.iv2387.i
  %i.bql = getelementptr inbounds nuw i8, ptr %i.bqk, i64 4 ; 2 uses
  %i.bqm = load float, ptr %i.bql, align 4, !tbaa !48
  store float %i.bqm, ptr %i.bqj, align 4, !tbaa !48
  %i.bqn = getelementptr inbounds nuw [4 x i8], ptr %i.bql, i64 %i.ayl
  %i.bqo = getelementptr inbounds nuw i8, ptr %.71973.us.i, i64 12
  %i.bqp = load float, ptr %i.bqn, align 4, !tbaa !48
  store float %i.bqp, ptr %i.bqo, align 4, !tbaa !48
  %i.bqq = getelementptr inbounds nuw i8, ptr %.71973.us.i, i64 16
  %i.bqr = getelementptr inbounds nuw [4 x i8], ptr %.311461977.us.i, i64 %indvars.iv2387.i
  %i.bqs = getelementptr inbounds nuw i8, ptr %i.bqr, i64 8 ; 2 uses
  %i.bqt = load float, ptr %i.bqs, align 4, !tbaa !48
  store float %i.bqt, ptr %i.bqq, align 4, !tbaa !48
  %i.bqu = getelementptr inbounds nuw [4 x i8], ptr %i.bqs, i64 %i.ayl
  %i.bqv = getelementptr inbounds nuw i8, ptr %.71973.us.i, i64 20
  %i.bqw = load float, ptr %i.bqu, align 4, !tbaa !48
  store float %i.bqw, ptr %i.bqv, align 4, !tbaa !48
  %i.bqx = getelementptr inbounds nuw i8, ptr %.71973.us.i, i64 24
  %i.bqy = getelementptr inbounds nuw [4 x i8], ptr %.311461977.us.i, i64 %indvars.iv2387.i
  %i.bqz = getelementptr inbounds nuw i8, ptr %i.bqy, i64 12 ; 2 uses
  %i.bra = load float, ptr %i.bqz, align 4, !tbaa !48
  store float %i.bra, ptr %i.bqx, align 4, !tbaa !48
  %i.brb = getelementptr inbounds nuw [4 x i8], ptr %i.bqz, i64 %i.ayl
  %i.brc = getelementptr inbounds nuw i8, ptr %.71973.us.i, i64 28
  %i.brd = load float, ptr %i.brb, align 4, !tbaa !48
  store float %i.brd, ptr %i.brc, align 4, !tbaa !48
  %i.bre = getelementptr inbounds nuw i8, ptr %.71973.us.i, i64 32 ; 2 uses
...
._crit_edge1975.us.i:                             ; preds = %vec.epilog.scalar.ph480.prol.loopexit, %vec.epilog.scalar.ph480, %vec.epilog.middle.block492, %middle.block476
  %.lcssa257 = phi ptr [ %i.bpr, %vec.epilog.middle.block492 ], [ %i.bpj, %middle.block476 ], [ %.lcssa513.unr, %vec.epilog.scalar.ph480.prol.loopexit ], [ %i.bre, %vec.epilog.scalar.ph480 ] ; 2 uses
  %i.brf = getelementptr inbounds nuw [4 x i8], ptr %.311461977.us.i, i64 %i.ayn ; 2 uses
  %i.brg = add nuw nsw i32 %.311361979.us.i, 2    ; 3 uses
  %i.brh = or disjoint i32 %i.brg, 1
  %i.bri = icmp slt i32 %i.brh, %i.n
  br i1 %i.bri, label %iter.check479, label %.preheader1550.i, !llvm.loop !169

.preheader1550.i:                                 ; preds = %._crit_edge1975.us.i, %.preheader1551.i
  %.31146.lcssa.i = phi ptr [ %.21145.lcssa.i, %.preheader1551.i ], [ %i.brf, %._crit_edge1975.us.i ] ; 12 uses
  %.6.lcssa.i = phi ptr [ %.41142.lcssa.i, %.preheader1551.i ], [ %.lcssa257, %._crit_edge1975.us.i ]
  %.31136.lcssa.i = phi i32 [ %.21135.lcssa.i, %.preheader1551.i ], [ %i.brg, %._crit_edge1975.us.i ] ; 2 uses
  %i.brj = icmp sge i32 %.31136.lcssa.i, %i.n
  %brmerge2007.i = or i1 %i.ayo, %i.brj
...
iter.check428:                                    ; preds = %.preheader.i.preheader, %._crit_edge1988.i
  %.411371991.i = phi i32 [ %i.bse, %._crit_edge1988.i ], [ %.31136.lcssa.i, %.preheader.i.preheader ]
  %.91990.i = phi ptr [ %.lcssa260, %._crit_edge1988.i ], [ %.6.lcssa.i, %.preheader.i.preheader ] ; 6 uses
  %.91990.i411 = ptrtoaddr ptr %.91990.i to i64
  %i.brk = sub i64 %.31146.lcssa.i410, %.91990.i411
  %diff.check = icmp ugt i64 %i.brk, -256
...
vector.ph415:                                     ; preds = %vector.main.loop.iter.check413
  %i.brl = getelementptr i8, ptr %.91990.i, i64 %i.azn ; 2 uses
...
vector.body417:                                   ; preds = %vector.body417, %vector.ph415
  ...
  %i.brm = shl i64 %index418, 2
  %next.gep419 = getelementptr i8, ptr %.91990.i, i64 %i.brm ; 4 uses
  %i.brn = getelementptr inbounds nuw [4 x i8], ptr %.31146.lcssa.i, i64 %index418 ; 4 uses
  %i.bro = getelementptr inbounds nuw i8, ptr %i.brn, i64 64
  %i.brp = getelementptr inbounds nuw i8, ptr %i.brn, i64 128
  %i.brq = getelementptr inbounds nuw i8, ptr %i.brn, i64 192
  %wide.load420 = load <16 x float>, ptr %i.brn, align 4, !tbaa !48
end_hunk_2
...
bb.l:                                             ; preds = %_ZNK4ncnn3Mat5emptyEv.exit
  ...
  %i.cd = load i32, ptr %i.y, align 4, !tbaa !42
  %i.ce = load i32, ptr %i.w, align 8, !tbaa !59
  %i.cf = load i32, ptr %i.bk, align 4, !tbaa !60
  %i.cg = getelementptr inbounds nuw i8, ptr %0, i64 244
  %i.ch = load i32, ptr %i.cg, align 4, !tbaa !61
  ...
  store i32 %i.ce, ptr %i.b, align 4, !tbaa !58
  store i32 %i.cf, ptr %i.c, align 4, !tbaa !58
  store i32 %i.ch, ptr %i.d, align 4, !tbaa !58
  %i.ck = load i32, ptr %i.ae, align 8, !tbaa !57 ; 12 uses
  %i.cl = load i32, ptr %i.ah, align 8, !tbaa !64
  %i.cm = mul i32 %i.cl, %i.ck                    ; 11 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #12
  %i.cn = load i32, ptr %i.ag, align 4, !tbaa !55
  %i.co = mul nsw i32 %i.cn, %i.ck
  store i32 %i.co, ptr %i.e, align 4, !tbaa !58
  %i.cp = getelementptr inbounds nuw i8, ptr %2, i64 44 ; 7 uses
  %i.cq = load i32, ptr %i.cp, align 4, !tbaa !55 ; 3 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %2, i64 24 ; 3 uses
  %i.cs = load i32, ptr %i.cr, align 8, !tbaa !57 ; 2 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %2, i64 48
  %i.cu = load i32, ptr %i.ct, align 8, !tbaa !64
  %i.cv = mul i32 %i.cu, %i.cs                    ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f) #12
  %i.cw = mul nsw i32 %i.cs, %i.cq
  store i32 %i.cw, ptr %i.f, align 4, !tbaa !58
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g) #12
  %i.cx = load ptr, ptr %i.cc, align 8, !tbaa !19
  store ptr %i.cx, ptr %i.g, align 8, !tbaa !66
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h) #12
  %i.cy = sdiv i32 %i.cv, 16
  store i32 %i.cy, ptr %i.h, align 4, !tbaa !58
  ...
  %i.db = load i32, ptr %i.h, align 4, !tbaa !58
  %i.dc = shl nsw i32 %i.db, 4                    ; 3 uses
  %i.dd = sub nsw i32 %i.cv, %i.dc                ; 2 uses
  %i.de = sdiv i32 %i.dd, 8                       ; 3 uses
  store i32 %i.de, ptr %i.h, align 4, !tbaa !58
  %i.df = icmp sgt i32 %i.dd, 7
  br i1 %i.df, label %.lr.ph2876.i, label %._crit_edge2877.i

.lr.ph2876.i:                                     ; preds = %bb.l
  ...
  %i.dl = load i32, ptr %i.cp, align 4, !tbaa !55 ; 2 uses
  %i.dm = icmp sgt i32 %i.dl, 0
  br i1 %i.dm, label %.lr.ph2876.split.preheader.i, label %._crit_edge2877.i

.lr.ph2876.split.preheader.i:                     ; preds = %.lr.ph2876.i
  %i.dn = sext i32 %i.dc to i64
  %wide.trip.count3793.i = zext nneg i32 %i.de to i64
  br label %.lr.ph2876.split.i

._crit_edge2877.i:                                ; preds = %._crit_edge.i, %.lr.ph2876.i, %bb.l
  %i.do = shl nsw i32 %i.de, 3
  %i.dp = add nsw i32 %i.do, %i.dc                ; 3 uses
  %i.dq = sub nsw i32 %i.cv, %i.dp                ; 2 uses
  %i.dr = sdiv i32 %i.dq, 4                       ; 3 uses
  store i32 %i.dr, ptr %i.h, align 4, !tbaa !58
  %i.ds = icmp sgt i32 %i.dq, 3
  br i1 %i.ds, label %.lr.ph3123.i, label %._crit_edge3124.i

.lr.ph3123.i:                                     ; preds = %._crit_edge2877.i
  ...
  %i.dy = load i32, ptr %i.cp, align 4, !tbaa !55 ; 2 uses
  %i.dz = icmp sgt i32 %i.dy, 0
  br i1 %i.dz, label %.lr.ph3123.split.preheader.i, label %._crit_edge3124.i

.lr.ph3123.split.preheader.i:                     ; preds = %.lr.ph3123.i
  %i.ea = sext i32 %i.dp to i64
  %wide.trip.count3843.i = zext nneg i32 %i.dr to i64
  br label %.lr.ph3123.split.i

.lr.ph2876.splitthread-pre-split.i:               ; preds = %._crit_edge.i
  %.pr.i = load i32, ptr %i.cp, align 4, !tbaa !55
  br label %.lr.ph2876.split.i

.lr.ph2876.split.i:                               ; preds = %.lr.ph2876.splitthread-pre-split.i, %.lr.ph2876.split.preheader.i
  %i.eb = phi i32 [ %.pr.i, %.lr.ph2876.splitthread-pre-split.i ], [ %i.dl, %.lr.ph2876.split.preheader.i ] ; 2 uses
  %indvars.iv3790.i = phi i64 [ %indvars.iv.next3791.i, %.lr.ph2876.splitthread-pre-split.i ], [ 0, %.lr.ph2876.split.preheader.i ] ; 2 uses
  %i.ec = load i32, ptr %i.ae, align 8, !tbaa !57 ; 9 uses
  %i.ed = load i32, ptr %i.ah, align 8, !tbaa !64
  %i.ee = mul i32 %i.ed, %i.ec                    ; 12 uses
  %i.ef = load i32, ptr %i.cr, align 8, !tbaa !57 ; 2 uses
  %i.eg = icmp sgt i32 %i.eb, 0
  br i1 %i.eg, label %.lr.ph2867.i, label %._crit_edge.i

.lr.ph2867.i:                                     ; preds = %.lr.ph2876.split.i
  %i.eh = load ptr, ptr %2, align 8, !tbaa !19
  %i.ei = shl nuw nsw i64 %indvars.iv3790.i, 3
  ...
  %i.ep = load i64, ptr %i.dg, align 8, !tbaa !44
  ...
  %factor.op.mul2868.i = mul i32 %i.ez, %i.ec     ; 3 uses
  ...
  %lcmp.mod764 = trunc i32 %i.fe to i1
  %xtraiter766 = and i32 %i.fe, 3                 ; 3 uses
  %i.gb = icmp ult i32 %i.fe, 4
  %unroll_iter770 = and i32 %i.fe, 2147483644
  %lcmp.mod767.not = icmp eq i32 %xtraiter766, 0
  %lcmp.mod769 = icmp ne i32 %xtraiter766, 0
  br label %bb.m

._crit_edge.i:                                    ; preds = %.thread2540.i, %.lr.ph2876.split.i
  %indvars.iv.next3791.i = add nuw nsw i64 %indvars.iv3790.i, 1 ; 2 uses
  %exitcond3794.not.i = icmp eq i64 %indvars.iv.next3791.i, %wide.trip.count3793.i
  br i1 %exitcond3794.not.i, label %._crit_edge2877.i, label %.lr.ph2876.splitthread-pre-split.i, !llvm.loop !203

bb.m:                                             ; preds = %.thread2540.i, %.lr.ph2867.i
  %indvars.iv3786.i = phi i64 [ 0, %.lr.ph2867.i ], [ %indvars.iv.next3787.i, %.thread2540.i ] ; 6 uses
  %.013002866.i = phi ptr [ %i.er, %.lr.ph2867.i ], [ %.31303.i, %.thread2540.i ] ; 15 uses
  br i1 %.not1505.i, label %_ZN4ncnn3MatD2Ev.exit1508.i, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.gc = load <8 x float>, ptr %i.es, align 1, !tbaa !45
...
_ZN4ncnn3MatD2Ev.exit1508.i:                      ; preds = %bb.n, %bb.m
  ...
  %i.gd = load ptr, ptr %i.cb, align 8, !tbaa !19, !noalias !295
  %i.ge = load i64, ptr %i.di, align 8, !tbaa !20, !noalias !295
  %i.gf = mul i64 %i.ge, %i.ex
  %i.gg = load i64, ptr %i.dj, align 8, !tbaa !44, !noalias !295
  %i.gh = mul i64 %i.gf, %i.gg
  %i.gi = getelementptr inbounds nuw i8, ptr %i.gd, i64 %i.gh ; 2 uses
  br i1 %i.ey, label %.lr.ph2711.i, label %.preheader2645.i

.lr.ph2711.i:                                     ; preds = %_ZN4ncnn3MatD2Ev.exit1508.i
  %i.gj = load ptr, ptr %4, align 8, !tbaa !19
  %i.gk = load i32, ptr %i.ag, align 4, !tbaa !55
  %i.gl = sext i32 %i.gk to i64
  %i.gm = load i64, ptr %i.ad, align 8, !tbaa !44
  %factor.op.mul.i = mul i64 %i.gm, %i.gl
  %i.gn = trunc nuw nsw i64 %indvars.iv3786.i to i32
  %.reass2869.i = mul i32 %factor.op.mul2868.i, %i.gn
  %i.go = sext i32 %.reass2869.i to i64
...
.preheader2645.i:                                 ; preds = %.loopexit2637.i, %_ZN4ncnn3MatD2Ev.exit1508.i
  %.02369.lcssa.i = phi <8 x float> [ zeroinitializer, %_ZN4ncnn3MatD2Ev.exit1508.i ], [ %.82377.i, %.loopexit2637.i ] ; 2 uses
  %.02348.lcssa.i = phi <8 x float> [ zeroinitializer, %_ZN4ncnn3MatD2Ev.exit1508.i ], [ %.82356.i, %.loopexit2637.i ] ; 2 uses
  %.02325.lcssa.i = phi <8 x float> [ zeroinitializer, %_ZN4ncnn3MatD2Ev.exit1508.i ], [ %.82333.i, %.loopexit2637.i ] ; 2 uses
  %.12296.lcssa.i = phi <8 x float> [ %.02295.i, %_ZN4ncnn3MatD2Ev.exit1508.i ], [ %.92304.i, %.loopexit2637.i ] ; 2 uses
  %.01334.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1508.i ], [ %i.fu, %.loopexit2637.i ] ; 3 uses
  %.01305.lcssa.i = phi ptr [ %i.gi, %_ZN4ncnn3MatD2Ev.exit1508.i ], [ %.81313.i, %.loopexit2637.i ] ; 2 uses
  %i.ig = or disjoint i32 %.01334.lcssa.i, 7
  %i.ih = icmp slt i32 %i.ig, %i.ee
  br i1 %i.ih, label %.lr.ph2766.i, label %.preheader2644.i

.lr.ph2766.i:                                     ; preds = %.preheader2645.i
  %i.ii = load ptr, ptr %4, align 8, !tbaa !19
  %i.ij = load i32, ptr %i.ag, align 4, !tbaa !55
  %i.ik = sext i32 %i.ij to i64
  %i.il = load i64, ptr %i.ad, align 8, !tbaa !44
  %factor.op.mul2773.i = mul i64 %i.il, %i.ik
  %i.im = trunc nuw nsw i64 %indvars.iv3786.i to i32
  %.reass2871.i = mul i32 %factor.op.mul2868.i, %i.im
  %i.in = sext i32 %.reass2871.i to i64
  %invariant.gep2775.i = getelementptr [4 x i8], ptr %i.ii, i64 %i.in
...
bb.o:                                             ; preds = %.loopexit2637.i, %.lr.ph2711.i
  %.013052710.i = phi ptr [ %i.gi, %.lr.ph2711.i ], [ %.81313.i, %.loopexit2637.i ] ; 13 uses
  %.013342709.i = phi i32 [ 0, %.lr.ph2711.i ], [ %i.abd, %.loopexit2637.i ] ; 2 uses
  %.122962708.i = phi <8 x float> [ %.02295.i, %.lr.ph2711.i ], [ %.92304.i, %.loopexit2637.i ] ; 9 uses
  %.023252707.i = phi <8 x float> [ zeroinitializer, %.lr.ph2711.i ], [ %.82333.i, %.loopexit2637.i ] ; 9 uses
  %.023482706.i = phi <8 x float> [ zeroinitializer, %.lr.ph2711.i ], [ %.82356.i, %.loopexit2637.i ] ; 9 uses
  %.023692705.i = phi <8 x float> [ zeroinitializer, %.lr.ph2711.i ], [ %.82377.i, %.loopexit2637.i ] ; 9 uses
  %i.jn = sdiv i32 %.013342709.i, %i.ec
  ...
  br i1 %i.fa, label %.preheader2640.i, label %.loopexit2641.i

.preheader2640.i:                                 ; preds = %bb.o
  br i1 %i.gq, label %.lr.ph.i, label %.loopexit2637.i

.lr.ph.i:                                         ; preds = %.preheader2640.i, %.lr.ph.i
  %.113062654.i = phi ptr [ %i.nw, %.lr.ph.i ], [ %.013052710.i, %.preheader2640.i ] ; 17 uses
  %.013392653.i = phi ptr [ %i.nv, %.lr.ph.i ], [ %gep.i, %.preheader2640.i ] ; 17 uses
  %.013462652.i = phi i32 [ %i.nx, %.lr.ph.i ], [ 0, %.preheader2640.i ]
  %.222972651.i = phi <8 x float> [ %i.nf, %.lr.ph.i ], [ %.122962708.i, %.preheader2640.i ]
  %.123262650.i = phi <8 x float> [ %i.nk, %.lr.ph.i ], [ %.023252707.i, %.preheader2640.i ]
  %.123492649.i = phi <8 x float> [ %i.np, %.lr.ph.i ], [ %.023482706.i, %.preheader2640.i ]
  %.123702648.i = phi <8 x float> [ %i.nu, %.lr.ph.i ], [ %.023692705.i, %.preheader2640.i ]
  %i.jp = load <8 x float>, ptr %.113062654.i, align 32, !tbaa !45
  %i.jq = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 32
  %i.jr = load <8 x float>, ptr %i.jq, align 32, !tbaa !45
  %i.js = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 64
  %i.jt = load <8 x float>, ptr %i.js, align 32, !tbaa !45
  %i.ju = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 96
  %i.jv = load <8 x float>, ptr %i.ju, align 32, !tbaa !45
  %i.jw = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 128
  %i.jx = load <8 x float>, ptr %i.jw, align 32, !tbaa !45
  %i.jy = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 160
  %i.jz = load <8 x float>, ptr %i.jy, align 32, !tbaa !45
  %i.ka = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 192
  %i.kb = load <8 x float>, ptr %i.ka, align 32, !tbaa !45
  %i.kc = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 224
  %i.kd = load <8 x float>, ptr %i.kc, align 32, !tbaa !45
  %i.ke = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 256
  %i.kf = load <8 x float>, ptr %i.ke, align 32, !tbaa !45
  %i.kg = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 288
  %i.kh = load <8 x float>, ptr %i.kg, align 32, !tbaa !45
  %i.ki = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 320
  %i.kj = load <8 x float>, ptr %i.ki, align 32, !tbaa !45
  %i.kk = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 352
  %i.kl = load <8 x float>, ptr %i.kk, align 32, !tbaa !45
  %i.km = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 384
  %i.kn = load <8 x float>, ptr %i.km, align 32, !tbaa !45
  %i.ko = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 416
  %i.kp = load <8 x float>, ptr %i.ko, align 32, !tbaa !45
  %i.kq = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 448
  %i.kr = load <8 x float>, ptr %i.kq, align 32, !tbaa !45
  %i.ks = getelementptr inbounds nuw i8, ptr %.113062654.i, i64 480
  %i.kt = load <8 x float>, ptr %i.ks, align 32, !tbaa !45
  %i.ku = load float, ptr %.013392653.i, align 4, !tbaa !48
end_hunk_3
begin_hunk_4_@_ZNK4ncnn24Convolution1D_x86_avx5127forwardERKNS_3MatERS1_RKNS_6OptionE:bb.a
  %i.adx = getelementptr inbounds nuw i8, ptr %.014262723.i, i64 24
  ...
  %i.aec = getelementptr inbounds nuw i8, ptr %.014262723.i, i64 28
  %i.aed = load float, ptr %i.aec, align 4, !tbaa !48
  ...
  %i.aeh = getelementptr inbounds [4 x i8], ptr %.014262723.i, i64 %i.is
  %i.aei = getelementptr inbounds nuw i8, ptr %.1013152724.i, i64 256
  %i.aej = add nuw nsw i32 %.014312722.i, 1       ; 2 uses
  %exitcond3763.not.i = icmp eq i32 %i.aej, %i.io
  br i1 %exitcond3763.not.i, label %.loopexit2635.loopexit.i, label %.lr.ph2725.i, !llvm.loop !211

.loopexit2635.loopexit.i:                         ; preds = %.lr.ph2725.i
  %scevgep3761.i = getelementptr i8, ptr %.913142765.i, i64 256
...
bb.s:                                             ; preds = %.loopexit2635.i
  br i1 %i.ip, label %.lr.ph2740.preheader.i, label %.loopexit2632.i

.lr.ph2740.preheader.i:                           ; preds = %bb.s
  %i.aek = getelementptr inbounds [4 x i8], ptr %gep2776.i, i64 %i.iu
  br label %.lr.ph2740.i

.lr.ph2740.i:                                     ; preds = %.lr.ph2740.i, %.lr.ph2740.preheader.i
  %.1213172739.i = phi ptr [ %i.ago, %.lr.ph2740.i ], [ %.913142765.i, %.lr.ph2740.preheader.i ] ; 9 uses
  %.214282738.i = phi ptr [ %i.agm, %.lr.ph2740.i ], [ %gep2776.i, %.lr.ph2740.preheader.i ] ; 5 uses
  %.014322737.i = phi ptr [ %i.agn, %.lr.ph2740.i ], [ %i.aek, %.lr.ph2740.preheader.i ] ; 5 uses
  %.014332736.i = phi i32 [ %i.agp, %.lr.ph2740.i ], [ 0, %.lr.ph2740.preheader.i ]
  %.1323082735.i = phi <8 x float> [ %i.afw, %.lr.ph2740.i ], [ %.1023052763.i, %.lr.ph2740.preheader.i ]
  %.1223372734.i = phi <8 x float> [ %i.agb, %.lr.ph2740.i ], [ %.923342762.i, %.lr.ph2740.preheader.i ]
  %.1223602733.i = phi <8 x float> [ %i.agg, %.lr.ph2740.i ], [ %.923572761.i, %.lr.ph2740.preheader.i ]
  %.1223812732.i = phi <8 x float> [ %i.agl, %.lr.ph2740.i ], [ %.923782760.i, %.lr.ph2740.preheader.i ]
  %i.ael = load <8 x float>, ptr %.1213172739.i, align 32, !tbaa !45
  %i.aem = getelementptr inbounds nuw i8, ptr %.1213172739.i, i64 32
  %i.aen = load <8 x float>, ptr %i.aem, align 32, !tbaa !45
  %i.aeo = getelementptr inbounds nuw i8, ptr %.1213172739.i, i64 64
  %i.aep = load <8 x float>, ptr %i.aeo, align 32, !tbaa !45
  %i.aeq = getelementptr inbounds nuw i8, ptr %.1213172739.i, i64 96
  %i.aer = load <8 x float>, ptr %i.aeq, align 32, !tbaa !45
  %i.aes = getelementptr inbounds nuw i8, ptr %.1213172739.i, i64 128
  %i.aet = load <8 x float>, ptr %i.aes, align 32, !tbaa !45
  %i.aeu = getelementptr inbounds nuw i8, ptr %.1213172739.i, i64 160
  %i.aev = load <8 x float>, ptr %i.aeu, align 32, !tbaa !45
  %i.aew = getelementptr inbounds nuw i8, ptr %.1213172739.i, i64 192
  %i.aex = load <8 x float>, ptr %i.aew, align 32, !tbaa !45
  %i.aey = getelementptr inbounds nuw i8, ptr %.1213172739.i, i64 224
  %i.aez = load <8 x float>, ptr %i.aey, align 32, !tbaa !45
  %i.afa = load float, ptr %.214282738.i, align 4, !tbaa !48
  ...
  %i.afd = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.ael, <8 x float> nofpclass(nan inf) %i.afc, <8 x float> nofpclass(nan inf) %.1323082735.i)
  %i.afe = getelementptr inbounds nuw i8, ptr %.214282738.i, i64 4
  %i.aff = load float, ptr %i.afe, align 4, !tbaa !48
  ...
  %i.afi = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.aen, <8 x float> nofpclass(nan inf) %i.afh, <8 x float> nofpclass(nan inf) %.1223372734.i)
  %i.afj = getelementptr inbounds nuw i8, ptr %.214282738.i, i64 8
  %i.afk = load float, ptr %i.afj, align 4, !tbaa !48
  ...
  %i.afn = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.aep, <8 x float> nofpclass(nan inf) %i.afm, <8 x float> nofpclass(nan inf) %.1223602733.i)
  %i.afo = getelementptr inbounds nuw i8, ptr %.214282738.i, i64 12
  %i.afp = load float, ptr %i.afo, align 4, !tbaa !48
  ...
  %i.afs = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.aer, <8 x float> nofpclass(nan inf) %i.afr, <8 x float> nofpclass(nan inf) %.1223812732.i)
  %i.aft = load float, ptr %.014322737.i, align 4, !tbaa !48
  ...
  %i.afx = getelementptr inbounds nuw i8, ptr %.014322737.i, i64 4
  %i.afy = load float, ptr %i.afx, align 4, !tbaa !48
  ...
  %i.agc = getelementptr inbounds nuw i8, ptr %.014322737.i, i64 8
  %i.agd = load float, ptr %i.agc, align 4, !tbaa !48
  ...
  %i.agh = getelementptr inbounds nuw i8, ptr %.014322737.i, i64 12
  ...
  %i.agm = getelementptr inbounds [4 x i8], ptr %.214282738.i, i64 %i.iw
  %i.agn = getelementptr inbounds [4 x i8], ptr %.014322737.i, i64 %i.iw
  %i.ago = getelementptr inbounds nuw i8, ptr %.1213172739.i, i64 256
  %i.agp = add nuw nsw i32 %.014332736.i, 1       ; 2 uses
  %exitcond3766.not.i = icmp eq i32 %i.agp, %i.io
...
.preheader2631.i:                                 ; preds = %.loopexit2633.i
  br i1 %i.ip, label %.lr.ph2754.i, label %.loopexit2632.i

.lr.ph2754.i:                                     ; preds = %.preheader2631.i, %.lr.ph2754.i
  %.1413192753.i = phi ptr [ %i.ait, %.lr.ph2754.i ], [ %.913142765.i, %.preheader2631.i ] ; 9 uses
  %.414302752.i = phi ptr [ %i.ais, %.lr.ph2754.i ], [ %gep2776.i, %.preheader2631.i ] ; 9 uses
  %.014342751.i = phi i32 [ %i.aiu, %.lr.ph2754.i ], [ 0, %.preheader2631.i ]
  %.1523102750.i = phi <8 x float> [ %i.aic, %.lr.ph2754.i ], [ %.1023052763.i, %.preheader2631.i ]
  %.1423392749.i = phi <8 x float> [ %i.aih, %.lr.ph2754.i ], [ %.923342762.i, %.preheader2631.i ]
  %.1423622748.i = phi <8 x float> [ %i.aim, %.lr.ph2754.i ], [ %.923572761.i, %.preheader2631.i ]
  %.1423832747.i = phi <8 x float> [ %i.air, %.lr.ph2754.i ], [ %.923782760.i, %.preheader2631.i ]
  %i.agq = load <8 x float>, ptr %.1413192753.i, align 32, !tbaa !45
  %i.agr = getelementptr inbounds nuw i8, ptr %.1413192753.i, i64 32
  %i.ags = load <8 x float>, ptr %i.agr, align 32, !tbaa !45
  %i.agt = getelementptr inbounds nuw i8, ptr %.1413192753.i, i64 64
  %i.agu = load <8 x float>, ptr %i.agt, align 32, !tbaa !45
  %i.agv = getelementptr inbounds nuw i8, ptr %.1413192753.i, i64 96
  %i.agw = load <8 x float>, ptr %i.agv, align 32, !tbaa !45
  %i.agx = getelementptr inbounds nuw i8, ptr %.1413192753.i, i64 128
  %i.agy = load <8 x float>, ptr %i.agx, align 32, !tbaa !45
  %i.agz = getelementptr inbounds nuw i8, ptr %.1413192753.i, i64 160
  %i.aha = load <8 x float>, ptr %i.agz, align 32, !tbaa !45
  %i.ahb = getelementptr inbounds nuw i8, ptr %.1413192753.i, i64 192
  %i.ahc = load <8 x float>, ptr %i.ahb, align 32, !tbaa !45
  %i.ahd = getelementptr inbounds nuw i8, ptr %.1413192753.i, i64 224
  %i.ahe = load <8 x float>, ptr %i.ahd, align 32, !tbaa !45
  %i.ahf = load float, ptr %.414302752.i, align 4, !tbaa !48
  ...
  %i.ahi = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.agq, <8 x float> nofpclass(nan inf) %i.ahh, <8 x float> nofpclass(nan inf) %.1523102750.i)
  %i.ahj = getelementptr inbounds [4 x i8], ptr %.414302752.i, i64 %i.iu
  ...
  %i.ahn = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.ags, <8 x float> nofpclass(nan inf) %i.ahm, <8 x float> nofpclass(nan inf) %.1423392749.i)
  %i.aho = getelementptr inbounds [4 x i8], ptr %.414302752.i, i64 %i.iy
  %i.ahp = load float, ptr %i.aho, align 4, !tbaa !48
  ...
  %i.ahs = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.agu, <8 x float> nofpclass(nan inf) %i.ahr, <8 x float> nofpclass(nan inf) %.1423622748.i)
  %i.aht = getelementptr inbounds [4 x i8], ptr %.414302752.i, i64 %i.ja
  %i.ahu = load float, ptr %i.aht, align 4, !tbaa !48
  ...
  %i.ahx = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.agw, <8 x float> nofpclass(nan inf) %i.ahw, <8 x float> nofpclass(nan inf) %.1423832747.i)
  %i.ahy = getelementptr inbounds [4 x i8], ptr %.414302752.i, i64 %i.jc
  %i.ahz = load float, ptr %i.ahy, align 4, !tbaa !48
  ...
  %i.aid = getelementptr inbounds [4 x i8], ptr %.414302752.i, i64 %i.je
  %i.aie = load float, ptr %i.aid, align 4, !tbaa !48
  ...
  %i.aii = getelementptr inbounds [4 x i8], ptr %.414302752.i, i64 %i.jg
  ...
  %i.ain = getelementptr inbounds [4 x i8], ptr %.414302752.i, i64 %i.ji
  ...
  %i.ais = getelementptr inbounds [4 x i8], ptr %.414302752.i, i64 %i.jj
  %i.ait = getelementptr inbounds nuw i8, ptr %.1413192753.i, i64 256
  %i.aiu = add nuw nsw i32 %.014342751.i, 1       ; 2 uses
  %exitcond3769.not.i = icmp eq i32 %i.aiu, %i.io
...
.loopexit2632.loopexit.i:                         ; preds = %.lr.ph2754.i
  ...
  %scevgep3768.i = getelementptr i8, ptr %scevgep3767.i, i64 %i.jm
  br label %.loopexit2632.i
...
.loopexit2632.i:                                  ; preds = %.loopexit2632.loopexit.i, %.preheader2631.i, %.loopexit2633.i, %.loopexit2633.loopexit.i, %bb.s, %.loopexit2635.loopexit.i, %.preheader2634.i
  %.152384.i = phi nsz <8 x float> [ %.923782760.i, %.loopexit2633.i ], [ %.923782760.i, %.preheader2631.i ], [ %i.air, %.loopexit2632.loopexit.i ], [ %.923782760.i, %bb.s ], [ %i.agl, %.loopexit2633.loopexit.i ], [ %i.aeg, %.loopexit2635.loopexit.i ], [ %.923782760.i, %.preheader2634.i ] ; 2 uses
  %.152363.i = phi nsz <8 x float> [ %.923572761.i, %.loopexit2633.i ], [ %.923572761.i, %.preheader2631.i ], [ %i.aim, %.loopexit2632.loopexit.i ], [ %.923572761.i, %bb.s ], [ %i.agg, %.loopexit2633.loopexit.i ], [ %i.aeb, %.loopexit2635.loopexit.i ], [ %.923572761.i, %.preheader2634.i ] ; 2 uses
  %.152340.i = phi nsz <8 x float> [ %.923342762.i, %.loopexit2633.i ], [ %.923342762.i, %.preheader2631.i ], [ %i.aih, %.loopexit2632.loopexit.i ], [ %.923342762.i, %bb.s ], [ %i.agb, %.loopexit2633.loopexit.i ], [ %i.adw, %.loopexit2635.loopexit.i ], [ %.923342762.i, %.preheader2634.i ] ; 2 uses
  %.162311.i = phi nsz <8 x float> [ %.1023052763.i, %.loopexit2633.i ], [ %.1023052763.i, %.preheader2631.i ], [ %i.aic, %.loopexit2632.loopexit.i ], [ %.1023052763.i, %bb.s ], [ %i.afw, %.loopexit2633.loopexit.i ], [ %i.adr, %.loopexit2635.loopexit.i ], [ %.1023052763.i, %.preheader2634.i ] ; 2 uses
  ...
  %i.aiv = add nuw nsw i32 %.113352764.i, 8       ; 3 uses
  %i.aiw = or disjoint i32 %i.aiv, 7
  %i.aix = icmp slt i32 %i.aiw, %i.ee
  br i1 %i.aix, label %bb.r, label %.preheader2644.i, !llvm.loop !214
...
.preheader2643.i:                                 ; preds = %.loopexit2628.i, %.preheader2644.i
  ...
  %.21336.lcssa.i = phi i32 [ %.11335.lcssa.i, %.preheader2644.i ], [ %i.anm, %.loopexit2628.i ] ; 6 uses
  ...
  br i1 %i.aiz, label %.lr.ph2834.i, label %.preheader2642.i

.lr.ph2834.i:                                     ; preds = %.preheader2643.i
  %i.aja = load ptr, ptr %4, align 8, !tbaa !19
  %i.ajb = load i32, ptr %i.ag, align 4, !tbaa !55
  %i.ajc = sext i32 %i.ajb to i64
  %i.ajd = load i64, ptr %i.ad, align 8, !tbaa !44
  %factor.op.mul2839.i = mul i64 %i.ajd, %i.ajc
  %i.aje = mul nsw i64 %indvars.iv3786.i, %i.fz
  %invariant.gep2841.i = getelementptr [4 x i8], ptr %i.aja, i64 %i.aje
...
.lr.ph2834.split.preheader.i:                     ; preds = %.lr.ph2834.i
  %i.ajj = add i32 %.21336.lcssa.i, 3
  %smax.i = call i32 @llvm.smax.i32(i32 %i.ee, i32 %i.ajj)
  %reass.sub = sub i32 %smax.i, %.21336.lcssa.i
  %i.ajk = and i32 %reass.sub, -2
  %i.ajl = add i32 %.21336.lcssa.i, %i.ajk
...
.lr.ph2826.us.i:                                  ; preds = %._crit_edge.us.i, %.lr.ph2826.us.preheader.i
  %indvars.iv.i = phi i64 [ %i.ajm, %.lr.ph2826.us.preheader.i ], [ %indvars.iv.next.i, %._crit_edge.us.i ] ; 2 uses
  %.2113262833.us.i = phi ptr [ %.161321.lcssa.i, %.lr.ph2826.us.preheader.i ], [ %scevgep3777.i, %._crit_edge.us.i ] ; 3 uses
  %.2223172831.us.i = phi <8 x float> [ %.172312.lcssa.i, %.lr.ph2826.us.preheader.i ], [ %.lcssa759, %._crit_edge.us.i ] ; 2 uses
  %.2123462830.us.i = phi <8 x float> [ %.162341.lcssa.i, %.lr.ph2826.us.preheader.i ], [ %.lcssa758.a, %._crit_edge.us.i ] ; 2 uses
  ...
  br i1 %i.ga, label %.epil.preheader, label %.lr.ph2826.us.i.new

.lr.ph2826.us.i.new:                              ; preds = %.lr.ph2826.us.i, %.lr.ph2826.us.i.new
  %.2213272825.us.i = phi ptr [ %i.ako, %.lr.ph2826.us.i.new ], [ %.2113262833.us.i, %.lr.ph2826.us.i ] ; 5 uses
  %.014402824.us.i = phi ptr [ %i.akn, %.lr.ph2826.us.i.new ], [ %gep2842.us.i, %.lr.ph2826.us.i ] ; 3 uses
  %.2323182822.us.i = phi <8 x float> [ %i.akh, %.lr.ph2826.us.i.new ], [ %.2223172831.us.i, %.lr.ph2826.us.i ]
  %.2223472821.us.i = phi <8 x float> [ %i.akm, %.lr.ph2826.us.i.new ], [ %.2123462830.us.i, %.lr.ph2826.us.i ]
  %niter = phi i32 [ %niter.next.1, %.lr.ph2826.us.i.new ], [ 0, %.lr.ph2826.us.i ]
  %i.ajn = load <8 x float>, ptr %.2213272825.us.i, align 32, !tbaa !45
  %i.ajo = getelementptr inbounds nuw i8, ptr %.2213272825.us.i, i64 32
  %i.ajp = load <8 x float>, ptr %i.ajo, align 32, !tbaa !45
  %i.ajq = load float, ptr %.014402824.us.i, align 4, !tbaa !48
  ...
  %i.ajt = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.ajn, <8 x float> nofpclass(nan inf) %i.ajs, <8 x float> nofpclass(nan inf) %.2323182822.us.i)
  %i.aju = getelementptr inbounds [4 x i8], ptr %.014402824.us.i, i64 %i.ajg
  %i.ajv = load float, ptr %i.aju, align 4, !tbaa !48
  ...
  %i.ajy = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.ajp, <8 x float> nofpclass(nan inf) %i.ajx, <8 x float> nofpclass(nan inf) %.2223472821.us.i)
  %i.ajz = getelementptr inbounds [4 x i8], ptr %.014402824.us.i, i64 %i.aji ; 3 uses
  %i.aka = getelementptr inbounds nuw i8, ptr %.2213272825.us.i, i64 64
  %i.akb = load <8 x float>, ptr %i.aka, align 32, !tbaa !45
  %i.akc = getelementptr inbounds nuw i8, ptr %.2213272825.us.i, i64 96
  %i.akd = load <8 x float>, ptr %i.akc, align 32, !tbaa !45
  %i.ake = load float, ptr %i.ajz, align 4, !tbaa !48
  ...
  %i.akj = load float, ptr %i.aki, align 4, !tbaa !48
  ...
  %i.ako = getelementptr inbounds nuw i8, ptr %.2213272825.us.i, i64 128 ; 2 uses
...
.epil.preheader:                                  ; preds = %._crit_edge.us.i.unr-lcssa, %.lr.ph2826.us.i
  %.2213272825.us.i.epil.init = phi ptr [ %.2113262833.us.i, %.lr.ph2826.us.i ], [ %i.ako, %._crit_edge.us.i.unr-lcssa ] ; 2 uses
  %.014402824.us.i.epil.init = phi ptr [ %gep2842.us.i, %.lr.ph2826.us.i ], [ %i.akn, %._crit_edge.us.i.unr-lcssa ] ; 2 uses
  %.2323182822.us.i.epil.init = phi <8 x float> [ %.2223172831.us.i, %.lr.ph2826.us.i ], [ %i.akh, %._crit_edge.us.i.unr-lcssa ]
  %.2223472821.us.i.epil.init = phi <8 x float> [ %.2123462830.us.i, %.lr.ph2826.us.i ], [ %i.akm, %._crit_edge.us.i.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod764)
  %i.akp = load <8 x float>, ptr %.2213272825.us.i.epil.init, align 32, !tbaa !45
  %i.akq = getelementptr inbounds nuw i8, ptr %.2213272825.us.i.epil.init, i64 32
  %i.akr = load <8 x float>, ptr %i.akq, align 32, !tbaa !45
  %i.aks = load float, ptr %.014402824.us.i.epil.init, align 4, !tbaa !48
  ...
  %i.akv = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.akp, <8 x float> nofpclass(nan inf) %i.aku, <8 x float> nofpclass(nan inf) %.2323182822.us.i.epil.init)
  %i.akw = getelementptr inbounds [4 x i8], ptr %.014402824.us.i.epil.init, i64 %i.ajg
  %i.akx = load float, ptr %i.akw, align 4, !tbaa !48
  ...
  %i.ala = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.akr, <8 x float> nofpclass(nan inf) %i.akz, <8 x float> nofpclass(nan inf) %.2223472821.us.i.epil.init)
  br label %._crit_edge.us.i

._crit_edge.us.i:                                 ; preds = %._crit_edge.us.i.unr-lcssa, %.epil.preheader
  %.lcssa759 = phi <8 x float> [ %i.akh, %._crit_edge.us.i.unr-lcssa ], [ %i.akv, %.epil.preheader ] ; 2 uses
  %.lcssa758.a = phi <8 x float> [ %i.akm, %._crit_edge.us.i.unr-lcssa ], [ %i.ala, %.epil.preheader ] ; 2 uses
  %scevgep3776.i = getelementptr i8, ptr %.2113262833.us.i, i64 64
  %scevgep3777.i = getelementptr i8, ptr %scevgep3776.i, i64 %i.fx ; 2 uses
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 2 ; 2 uses
  %i.alb = trunc i64 %indvars.iv.next.i to i32    ; 2 uses
  %i.alc = or i32 %i.alb, 1
  %i.ald = icmp slt i32 %i.alc, %i.ee
  br i1 %i.ald, label %.lr.ph2826.us.i, label %.preheader2642.i, !llvm.loop !216

bb.t:                                             ; preds = %.loopexit2628.i, %.lr.ph2810.i
  %.1613212809.i = phi ptr [ %.91314.lcssa.i, %.lr.ph2810.i ], [ %.201325.i, %.loopexit2628.i ] ; 7 uses
  %.213362808.i = phi i32 [ %.11335.lcssa.i, %.lr.ph2810.i ], [ %i.anm, %.loopexit2628.i ] ; 2 uses
  ...
  %i.ale = sdiv i32 %.213362808.i, %i.ec
  %i.alf = sext i32 %i.ale to i64
  %.reass2818.i = mul i64 %factor.op.mul2817.i, %i.alf
...
.preheader2629.i:                                 ; preds = %bb.t
  br i1 %i.abp, label %.lr.ph2784.i, label %.loopexit2628.i

.lr.ph2784.i:                                     ; preds = %.preheader2629.i, %.lr.ph2784.i
  %.1713222783.i = phi ptr [ %i.amh, %.lr.ph2784.i ], [ %.1613212809.i, %.preheader2629.i ] ; 5 uses
  %.014352782.i = phi ptr [ %i.amg, %.lr.ph2784.i ], [ %gep2820.i, %.preheader2629.i ] ; 5 uses
  %.014382781.i = phi i32 [ %i.ami, %.lr.ph2784.i ], [ 0, %.preheader2629.i ]
  %.1823132780.i = phi <8 x float> [ %i.alq, %.lr.ph2784.i ], [ %.1723122807.i, %.preheader2629.i ]
  %.1723422779.i = phi <8 x float> [ %i.alv, %.lr.ph2784.i ], [ %.1623412806.i, %.preheader2629.i ]
  %.1723652778.i = phi <8 x float> [ %i.ama, %.lr.ph2784.i ], [ %.1623642805.i, %.preheader2629.i ]
  %.1723862777.i = phi <8 x float> [ %i.amf, %.lr.ph2784.i ], [ %.1623852804.i, %.preheader2629.i ]
  %i.alg = load <8 x float>, ptr %.1713222783.i, align 32, !tbaa !45
  %i.alh = getelementptr inbounds nuw i8, ptr %.1713222783.i, i64 32
  %i.ali = load <8 x float>, ptr %i.alh, align 32, !tbaa !45
  %i.alj = getelementptr inbounds nuw i8, ptr %.1713222783.i, i64 64
  %i.alk = load <8 x float>, ptr %i.alj, align 32, !tbaa !45
  %i.all = getelementptr inbounds nuw i8, ptr %.1713222783.i, i64 96
  %i.alm = load <8 x float>, ptr %i.all, align 32, !tbaa !45
  %i.aln = load float, ptr %.014352782.i, align 4, !tbaa !48
  ...
  %i.alq = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.alg, <8 x float> nofpclass(nan inf) %i.alp, <8 x float> nofpclass(nan inf) %.1823132780.i) ; 2 uses
  %i.alr = getelementptr inbounds nuw i8, ptr %.014352782.i, i64 4
  %i.als = load float, ptr %i.alr, align 4, !tbaa !48
  ...
  %i.alv = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.ali, <8 x float> nofpclass(nan inf) %i.alu, <8 x float> nofpclass(nan inf) %.1723422779.i) ; 2 uses
  %i.alw = getelementptr inbounds nuw i8, ptr %.014352782.i, i64 8
  ...
  %i.ama = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.alk, <8 x float> nofpclass(nan inf) %i.alz, <8 x float> nofpclass(nan inf) %.1723652778.i) ; 2 uses
  %i.amb = getelementptr inbounds nuw i8, ptr %.014352782.i, i64 12
  %i.amc = load float, ptr %i.amb, align 4, !tbaa !48
  ...
  %i.amf = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.alm, <8 x float> nofpclass(nan inf) %i.ame, <8 x float> nofpclass(nan inf) %.1723862777.i) ; 2 uses
  %i.amg = getelementptr inbounds [4 x i8], ptr %.014352782.i, i64 %i.abs
  %i.amh = getelementptr inbounds nuw i8, ptr %.1713222783.i, i64 128
  %i.ami = add nuw nsw i32 %.014382781.i, 1       ; 2 uses
  %exitcond3772.not.i = icmp eq i32 %i.ami, %i.abo
...
.preheader2627.i:                                 ; preds = %.loopexit2630.i
  br i1 %i.abp, label %.lr.ph2798.i, label %.loopexit2628.i

.lr.ph2798.i:                                     ; preds = %.preheader2627.i, %.lr.ph2798.i
  %.1913242797.i = phi ptr [ %i.ank, %.lr.ph2798.i ], [ %.1613212809.i, %.preheader2627.i ] ; 5 uses
  %.214372796.i = phi ptr [ %i.anj, %.lr.ph2798.i ], [ %gep2820.i, %.preheader2627.i ] ; 5 uses
  %.014392795.i = phi i32 [ %i.anl, %.lr.ph2798.i ], [ 0, %.preheader2627.i ]
  %.2023152794.i = phi <8 x float> [ %i.amt, %.lr.ph2798.i ], [ %.1723122807.i, %.preheader2627.i ]
  %.1923442793.i = phi <8 x float> [ %i.amy, %.lr.ph2798.i ], [ %.1623412806.i, %.preheader2627.i ]
  %.1923672792.i = phi <8 x float> [ %i.and, %.lr.ph2798.i ], [ %.1623642805.i, %.preheader2627.i ]
  %.1923882791.i = phi <8 x float> [ %i.ani, %.lr.ph2798.i ], [ %.1623852804.i, %.preheader2627.i ]
  %i.amj = load <8 x float>, ptr %.1913242797.i, align 32, !tbaa !45
  %i.amk = getelementptr inbounds nuw i8, ptr %.1913242797.i, i64 32
  %i.aml = load <8 x float>, ptr %i.amk, align 32, !tbaa !45
  %i.amm = getelementptr inbounds nuw i8, ptr %.1913242797.i, i64 64
  %i.amn = load <8 x float>, ptr %i.amm, align 32, !tbaa !45
  %i.amo = getelementptr inbounds nuw i8, ptr %.1913242797.i, i64 96
  %i.amp = load <8 x float>, ptr %i.amo, align 32, !tbaa !45
  %i.amq = load float, ptr %.214372796.i, align 4, !tbaa !48
  ...
  %i.amt = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.amj, <8 x float> nofpclass(nan inf) %i.ams, <8 x float> nofpclass(nan inf) %.2023152794.i) ; 2 uses
  %i.amu = getelementptr inbounds [4 x i8], ptr %.214372796.i, i64 %i.abu
  %i.amv = load float, ptr %i.amu, align 4, !tbaa !48
  ...
  %i.amy = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.aml, <8 x float> nofpclass(nan inf) %i.amx, <8 x float> nofpclass(nan inf) %.1923442793.i) ; 2 uses
  %i.amz = getelementptr inbounds [4 x i8], ptr %.214372796.i, i64 %i.abw
  %i.ana = load float, ptr %i.amz, align 4, !tbaa !48
  ...
  %i.and = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.amn, <8 x float> nofpclass(nan inf) %i.anc, <8 x float> nofpclass(nan inf) %.1923672792.i) ; 2 uses
  %i.ane = getelementptr inbounds [4 x i8], ptr %.214372796.i, i64 %i.aby
  ...
  %i.ani = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.amp, <8 x float> nofpclass(nan inf) %i.anh, <8 x float> nofpclass(nan inf) %.1923882791.i) ; 2 uses
  %i.anj = getelementptr inbounds [4 x i8], ptr %.214372796.i, i64 %i.abz
  %i.ank = getelementptr inbounds nuw i8, ptr %.1913242797.i, i64 128
  %i.anl = add nuw nsw i32 %.014392795.i, 1       ; 2 uses
  %exitcond3775.not.i = icmp eq i32 %i.anl, %i.abo
...
.loopexit2628.loopexit.i:                         ; preds = %.lr.ph2798.i
  ...
  %scevgep3774.i = getelementptr i8, ptr %scevgep3773.i, i64 %i.acc
  br label %.loopexit2628.i

.loopexit2628.i:                                  ; preds = %.loopexit2628.loopexit.i, %.preheader2627.i, %.loopexit2630.i, %.loopexit2630.loopexit.i, %.preheader2629.i
end_hunk_4
begin_hunk_5_@_ZNK4ncnn24Convolution1D_x86_avx5127forwardERKNS_3MatERS1_RKNS_6OptionE:bb.a
  %.neg2577.i = fmul fast <8 x float> %i.ath, splat (float -2.000000e+00)
  %i.ati = select fast <8 x i1> %i.asd, <8 x float> splat (float +nan(0x3FFFFF)), <8 x float> %.neg2577.i
...
bb.aa:                                            ; preds = %._crit_edge2857.i
  %i.auk = load ptr, ptr %i.ci, align 8, !tbaa !19 ; 2 uses
  %i.aul = load float, ptr %i.auk, align 4, !tbaa !48
  ...
  %i.aup = load float, ptr %i.auo, align 4, !tbaa !48
...
_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit.i:    ; preds = %bb.aa, %bb.z, %bb.y, %bb.x, %bb.w, %bb.v, %._crit_edge2857.i
  %.0.i.i = phi nsz <8 x float> [ %i.auv, %bb.aa ], [ %i.apm, %bb.v ], [ %i.apu, %bb.w ], [ %i.aqe, %bb.x ], [ %i.are, %bb.y ], [ %i.auj, %bb.z ], [ %i.apl, %._crit_edge2857.i ] ; 11 uses
...
.thread.i:                                        ; preds = %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit.i
  store <8 x float> %.0.i.i, ptr %.013002866.i, align 32, !tbaa !45
  %i.auw = getelementptr inbounds nuw i8, ptr %.013002866.i, i64 32
...
bb.ab:                                            ; preds = %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit.i
  ...
  store <4 x float> %i.aux, ptr %.013002866.i, align 16, !tbaa !45
  %i.auy = getelementptr inbounds [4 x i8], ptr %.013002866.i, i64 %i.fh
  %i.auz = shufflevector <8 x float> %.0.i.i, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  store <4 x float> %i.auz, ptr %i.auy, align 16, !tbaa !45
  %i.ava = getelementptr inbounds nuw i8, ptr %.013002866.i, i64 16
  br label %.thread2540.i

bb.ac:                                            ; preds = %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit.i
  %.sroa.01836.0.vec.extract.i = extractelement <8 x float> %.0.i.i, i64 0
  store float %.sroa.01836.0.vec.extract.i, ptr %.013002866.i, align 4, !tbaa !48
  %.sroa.01836.4.vec.extract.i = extractelement <8 x float> %.0.i.i, i64 1
  %i.avb = getelementptr inbounds [4 x i8], ptr %.013002866.i, i64 %i.fh
  store float %.sroa.01836.4.vec.extract.i, ptr %i.avb, align 4, !tbaa !48
  %.sroa.01836.8.vec.extract.i = extractelement <8 x float> %.0.i.i, i64 2
  %i.avc = getelementptr inbounds [4 x i8], ptr %.013002866.i, i64 %i.fj
  store float %.sroa.01836.8.vec.extract.i, ptr %i.avc, align 4, !tbaa !48
  %.sroa.01836.12.vec.extract.i = extractelement <8 x float> %.0.i.i, i64 3
  %i.avd = getelementptr inbounds [4 x i8], ptr %.013002866.i, i64 %i.fl
  store float %.sroa.01836.12.vec.extract.i, ptr %i.avd, align 4, !tbaa !48
  %.sroa.01836.16.vec.extract.i = extractelement <8 x float> %.0.i.i, i64 4
  %i.ave = getelementptr inbounds [4 x i8], ptr %.013002866.i, i64 %i.fn
  store float %.sroa.01836.16.vec.extract.i, ptr %i.ave, align 4, !tbaa !48
  %.sroa.01836.20.vec.extract.i = extractelement <8 x float> %.0.i.i, i64 5
  %i.avf = getelementptr inbounds [4 x i8], ptr %.013002866.i, i64 %i.fp
  store float %.sroa.01836.20.vec.extract.i, ptr %i.avf, align 4, !tbaa !48
  %.sroa.01836.24.vec.extract.i = extractelement <8 x float> %.0.i.i, i64 6
  %i.avg = getelementptr inbounds [4 x i8], ptr %.013002866.i, i64 %i.fr
  store float %.sroa.01836.24.vec.extract.i, ptr %i.avg, align 4, !tbaa !48
  %.sroa.01836.28.vec.extract.i = extractelement <8 x float> %.0.i.i, i64 7
  %i.avh = getelementptr inbounds [4 x i8], ptr %.013002866.i, i64 %i.ft
  store float %.sroa.01836.28.vec.extract.i, ptr %i.avh, align 4, !tbaa !48
  %i.avi = getelementptr inbounds nuw i8, ptr %.013002866.i, i64 4
  br label %.thread2540.i

.thread2540.i:                                    ; preds = %bb.ac, %bb.ab, %.thread.i, %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit.i
  %.31303.i = phi ptr [ %i.avi, %bb.ac ], [ %.013002866.i, %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit.i ], [ %i.auw, %.thread.i ], [ %i.ava, %bb.ab ]
  %indvars.iv.next3787.i = add nuw nsw i64 %indvars.iv3786.i, 1 ; 2 uses
  %exitcond3789.not.i = icmp eq i64 %indvars.iv.next3787.i, %i.en
  br i1 %exitcond3789.not.i, label %._crit_edge.i, label %bb.m, !llvm.loop !223

._crit_edge3124.i:                                ; preds = %._crit_edge3114.i, %.lr.ph3123.i, %._crit_edge2877.i
  ...
  store i32 %i.avm, ptr %i.h, align 4, !tbaa !58
  %i.avn = icmp sgt i32 %i.avl, 1
  br i1 %i.avn, label %.lr.ph3334.i, label %._crit_edge3335.split.i

.lr.ph3334.i:                                     ; preds = %._crit_edge3124.i
  %i.avo = load i32, ptr %i.ae, align 8, !tbaa !57 ; 9 uses
  %i.avp = load i32, ptr %i.ah, align 8, !tbaa !64
  %i.avq = mul i32 %i.avp, %i.avo                 ; 11 uses
  %i.avr = load i32, ptr %i.cp, align 4, !tbaa !55 ; 3 uses
  %i.avs = load ptr, ptr %2, align 8, !tbaa !19   ; 2 uses
  %i.avt = sext i32 %i.avr to i64
  %i.avu = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.avv = load i64, ptr %i.avu, align 8, !tbaa !44
  ...
  br i1 %i.avx, label %.lr.ph3334.split.i, label %._crit_edge3335.split.i

.lr.ph3334.split.i:                               ; preds = %.lr.ph3334.i
  %i.awf = getelementptr inbounds nuw i8, ptr %0, i64 488
  %i.awg = getelementptr inbounds nuw i8, ptr %0, i64 536
  %i.awh = load ptr, ptr %i.cb, align 8, !tbaa !19, !noalias !296
  %i.awi = load i64, ptr %i.awg, align 8, !tbaa !20, !noalias !296
  %i.awj = load i64, ptr %i.awf, align 8, !tbaa !44, !noalias !296
  %factor.op.mul3337.i = mul i64 %i.awj, %i.awi
  %i.awk = and i32 %i.avq, -16
  %i.awl = sext i32 %i.avk to i64
  %wide.trip.count3893.i = zext nneg i32 %i.avm to i64
  %wide.trip.count3888.i = zext nneg i32 %i.avr to i64
  br label %.lr.ph3324.i

.lr.ph3123.splitthread-pre-split.i:               ; preds = %._crit_edge3114.i
  %.pr4051.i = load i32, ptr %i.cp, align 4, !tbaa !55
  br label %.lr.ph3123.split.i

.lr.ph3123.split.i:                               ; preds = %.lr.ph3123.splitthread-pre-split.i, %.lr.ph3123.split.preheader.i
  %i.awm = phi i32 [ %.pr4051.i, %.lr.ph3123.splitthread-pre-split.i ], [ %i.dy, %.lr.ph3123.split.preheader.i ] ; 2 uses
  %indvars.iv3840.i = phi i64 [ %indvars.iv.next3841.i, %.lr.ph3123.splitthread-pre-split.i ], [ 0, %.lr.ph3123.split.preheader.i ] ; 2 uses
  %i.awn = load i32, ptr %i.ae, align 8, !tbaa !57 ; 9 uses
  %i.awo = load i32, ptr %i.ah, align 8, !tbaa !64
  %i.awp = mul i32 %i.awo, %i.awn                 ; 12 uses
  %i.awq = load i32, ptr %i.cr, align 8, !tbaa !57 ; 2 uses
  %i.awr = icmp sgt i32 %i.awm, 0
  br i1 %i.awr, label %.lr.ph3113.i, label %._crit_edge3114.i

.lr.ph3113.i:                                     ; preds = %.lr.ph3123.split.i
  %i.aws = load ptr, ptr %2, align 8, !tbaa !19
  %i.awt = shl nuw nsw i64 %indvars.iv3840.i, 2
  ...
  %i.axa = load i64, ptr %i.dt, align 8, !tbaa !44
  ...
  %factor.op.mul3115.i = mul i32 %i.axq, %i.awn   ; 3 uses
  ...
  %xtraiter773 = and i32 %i.axv, 1
  %i.ayj = icmp eq i32 %i.aye, 0
  %unroll_iter779 = and i32 %i.axv, 2147483646
  %lcmp.mod775.not = icmp eq i32 %xtraiter773, 0
  %lcmp.mod778 = trunc i32 %i.axv to i1
  %xtraiter782 = and i32 %i.axv, 3                ; 3 uses
  %i.ayk = icmp ult i32 %i.axv, 4
  %unroll_iter787 = and i32 %i.axv, 2147483644
  %lcmp.mod784.not = icmp eq i32 %xtraiter782, 0
  %lcmp.mod786 = icmp ne i32 %xtraiter782, 0
  br label %bb.ad

._crit_edge3114.i:                                ; preds = %bb.at, %.lr.ph3123.split.i
  %indvars.iv.next3841.i = add nuw nsw i64 %indvars.iv3840.i, 1 ; 2 uses
  %exitcond3844.not.i = icmp eq i64 %indvars.iv.next3841.i, %wide.trip.count3843.i
  br i1 %exitcond3844.not.i, label %._crit_edge3124.i, label %.lr.ph3123.splitthread-pre-split.i, !llvm.loop !226

bb.ad:                                            ; preds = %bb.at, %.lr.ph3113.i
  %indvars.iv3835.i = phi i64 [ 0, %.lr.ph3113.i ], [ %indvars.iv.next3836.i, %bb.at ] ; 6 uses
  %.014463111.i = phi ptr [ %i.axc, %.lr.ph3113.i ], [ %.21448.i, %bb.at ] ; 8 uses
  br i1 %.not1504.i, label %_ZN4ncnn3MatD2Ev.exit1507.i, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.ayl = load <4 x float>, ptr %i.axd, align 1, !tbaa !45
...
_ZN4ncnn3MatD2Ev.exit1507.i:                      ; preds = %bb.ae, %bb.ad
  ...
  %i.aym = load ptr, ptr %i.cb, align 8, !tbaa !19, !noalias !297
  %i.ayn = load i64, ptr %i.dv, align 8, !tbaa !20, !noalias !297
  %i.ayo = mul i64 %i.ayn, %i.axo
  %i.ayp = load i64, ptr %i.dw, align 8, !tbaa !44, !noalias !297
  %i.ayq = mul i64 %i.ayo, %i.ayp
  %i.ayr = getelementptr inbounds nuw i8, ptr %i.aym, i64 %i.ayq ; 2 uses
  br i1 %i.axp, label %.lr.ph2947.i, label %.preheader2626.i

.lr.ph2947.i:                                     ; preds = %_ZN4ncnn3MatD2Ev.exit1507.i
  %i.ays = load ptr, ptr %4, align 8, !tbaa !19
  %i.ayt = load i32, ptr %i.ag, align 4, !tbaa !55
  %i.ayu = sext i32 %i.ayt to i64
  %i.ayv = load i64, ptr %i.ad, align 8, !tbaa !44
  %factor.op.mul2954.i = mul i64 %i.ayv, %i.ayu
  %i.ayw = trunc nuw nsw i64 %indvars.iv3835.i to i32
  %.reass3116.i = mul i32 %factor.op.mul3115.i, %i.ayw
  %i.ayx = sext i32 %.reass3116.i to i64
  %invariant.gep2956.i = getelementptr [4 x i8], ptr %i.ays, i64 %i.ayx
...
.preheader2626.i:                                 ; preds = %.loopexit2618.i, %_ZN4ncnn3MatD2Ev.exit1507.i
  %.02476.lcssa.i = phi <4 x float> [ zeroinitializer, %_ZN4ncnn3MatD2Ev.exit1507.i ], [ %.82484.i, %.loopexit2618.i ] ; 2 uses
  %.02455.lcssa.i = phi <4 x float> [ zeroinitializer, %_ZN4ncnn3MatD2Ev.exit1507.i ], [ %.82463.i, %.loopexit2618.i ] ; 2 uses
  %.02432.lcssa.i = phi <4 x float> [ zeroinitializer, %_ZN4ncnn3MatD2Ev.exit1507.i ], [ %.82440.i, %.loopexit2618.i ] ; 2 uses
  %.12407.lcssa.i = phi <4 x float> [ %.02406.i, %_ZN4ncnn3MatD2Ev.exit1507.i ], [ %.92415.i, %.loopexit2618.i ] ; 2 uses
  %.01475.lcssa.i = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1507.i ], [ %i.ayd, %.loopexit2618.i ] ; 3 uses
  %.01450.lcssa.i = phi ptr [ %i.ayr, %_ZN4ncnn3MatD2Ev.exit1507.i ], [ %.81458.i, %.loopexit2618.i ] ; 2 uses
  %i.bap = or disjoint i32 %.01475.lcssa.i, 7
  %i.baq = icmp slt i32 %i.bap, %i.awp
  br i1 %i.baq, label %.lr.ph3007.i, label %.preheader2625.i

.lr.ph3007.i:                                     ; preds = %.preheader2626.i
  %i.bar = load ptr, ptr %4, align 8, !tbaa !19
  %i.bas = load i32, ptr %i.ag, align 4, !tbaa !55
  %i.bat = sext i32 %i.bas to i64
  %i.bau = load i64, ptr %i.ad, align 8, !tbaa !44
  %factor.op.mul3014.i = mul i64 %i.bau, %i.bat
  %i.bav = trunc nuw nsw i64 %indvars.iv3835.i to i32
  %.reass3118.i = mul i32 %factor.op.mul3115.i, %i.bav
  %i.baw = sext i32 %.reass3118.i to i64
  %invariant.gep3016.i = getelementptr [4 x i8], ptr %i.bar, i64 %i.baw
...
bb.af:                                            ; preds = %.loopexit2618.i, %.lr.ph2947.i
  %.014502946.i = phi ptr [ %i.ayr, %.lr.ph2947.i ], [ %.81458.i, %.loopexit2618.i ] ; 13 uses
  %.014752945.i = phi i32 [ 0, %.lr.ph2947.i ], [ %i.btm, %.loopexit2618.i ] ; 2 uses
  %.124072944.i = phi <4 x float> [ %.02406.i, %.lr.ph2947.i ], [ %.92415.i, %.loopexit2618.i ] ; 9 uses
  %.024322943.i = phi <4 x float> [ zeroinitializer, %.lr.ph2947.i ], [ %.82440.i, %.loopexit2618.i ] ; 9 uses
  %.024552942.i = phi <4 x float> [ zeroinitializer, %.lr.ph2947.i ], [ %.82463.i, %.loopexit2618.i ] ; 9 uses
  %.024762941.i = phi <4 x float> [ zeroinitializer, %.lr.ph2947.i ], [ %.82484.i, %.loopexit2618.i ] ; 9 uses
  %i.bbw = sdiv i32 %.014752945.i, %i.awn
  %i.bbx = sext i32 %i.bbw to i64
  %.reass2955.i = mul i64 %factor.op.mul2954.i, %i.bbx
  %gep2957.i = getelementptr i8, ptr %invariant.gep2956.i, i64 %.reass2955.i ; 8 uses
  br i1 %i.axr, label %.preheader2621.i, label %.loopexit2622.i

.preheader2621.i:                                 ; preds = %bb.af
  br i1 %i.ayz, label %.lr.ph2887.i, label %.loopexit2618.i

.lr.ph2887.i:                                     ; preds = %.preheader2621.i, %.lr.ph2887.i
  %.114512886.i = phi ptr [ %i.bgf, %.lr.ph2887.i ], [ %.014502946.i, %.preheader2621.i ] ; 17 uses
  %.014802885.i = phi ptr [ %i.bge, %.lr.ph2887.i ], [ %gep2957.i, %.preheader2621.i ] ; 17 uses
  %.014872884.i = phi i32 [ %i.bgg, %.lr.ph2887.i ], [ 0, %.preheader2621.i ]
  %.224082883.i = phi <4 x float> [ %i.bfo, %.lr.ph2887.i ], [ %.124072944.i, %.preheader2621.i ]
  %.124332882.i = phi <4 x float> [ %i.bft, %.lr.ph2887.i ], [ %.024322943.i, %.preheader2621.i ]
  %.124562881.i = phi <4 x float> [ %i.bfy, %.lr.ph2887.i ], [ %.024552942.i, %.preheader2621.i ]
  %.124772880.i = phi <4 x float> [ %i.bgd, %.lr.ph2887.i ], [ %.024762941.i, %.preheader2621.i ]
  %i.bby = load <4 x float>, ptr %.114512886.i, align 16, !tbaa !45
  %i.bbz = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 16
  %i.bca = load <4 x float>, ptr %i.bbz, align 16, !tbaa !45
  %i.bcb = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 32
  %i.bcc = load <4 x float>, ptr %i.bcb, align 16, !tbaa !45
  %i.bcd = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 48
  %i.bce = load <4 x float>, ptr %i.bcd, align 16, !tbaa !45
  %i.bcf = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 64
  %i.bcg = load <4 x float>, ptr %i.bcf, align 16, !tbaa !45
  %i.bch = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 80
  %i.bci = load <4 x float>, ptr %i.bch, align 16, !tbaa !45
  %i.bcj = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 96
  %i.bck = load <4 x float>, ptr %i.bcj, align 16, !tbaa !45
  %i.bcl = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 112
  %i.bcm = load <4 x float>, ptr %i.bcl, align 16, !tbaa !45
  %i.bcn = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 128
  %i.bco = load <4 x float>, ptr %i.bcn, align 16, !tbaa !45
  %i.bcp = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 144
  %i.bcq = load <4 x float>, ptr %i.bcp, align 16, !tbaa !45
  %i.bcr = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 160
  %i.bcs = load <4 x float>, ptr %i.bcr, align 16, !tbaa !45
  %i.bct = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 176
  %i.bcu = load <4 x float>, ptr %i.bct, align 16, !tbaa !45
  %i.bcv = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 192
  %i.bcw = load <4 x float>, ptr %i.bcv, align 16, !tbaa !45
  %i.bcx = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 208
  %i.bcy = load <4 x float>, ptr %i.bcx, align 16, !tbaa !45
  %i.bcz = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 224
  %i.bda = load <4 x float>, ptr %i.bcz, align 16, !tbaa !45
  %i.bdb = getelementptr inbounds nuw i8, ptr %.114512886.i, i64 240
  %i.bdc = load <4 x float>, ptr %i.bdb, align 16, !tbaa !45
  %i.bdd = load float, ptr %.014802885.i, align 4, !tbaa !48
end_hunk_5
begin_hunk_6_@_ZNK4ncnn24Convolution1D_x86_avx5127forwardERKNS_3MatERS1_RKNS_6OptionE:bb.a
  %i.bwg = getelementptr inbounds nuw i8, ptr %.014172963.i, i64 24
  %i.bwh = load float, ptr %i.bwg, align 4, !tbaa !48
  ...
  %i.bwl = getelementptr inbounds nuw i8, ptr %.014172963.i, i64 28
  %i.bwm = load float, ptr %i.bwl, align 4, !tbaa !48
  ...
  %i.bwq = getelementptr inbounds [4 x i8], ptr %.014172963.i, i64 %i.bbb
  %i.bwr = getelementptr inbounds nuw i8, ptr %.1014602962.i, i64 128
  %i.bws = add nuw nsw i32 %.014162964.i, 1       ; 2 uses
  %exitcond3809.not.i = icmp eq i32 %i.bws, %i.bax
  br i1 %exitcond3809.not.i, label %.loopexit2616.loopexit.i, label %.lr.ph2965.i, !llvm.loop !234

.loopexit2616.loopexit.i:                         ; preds = %.lr.ph2965.i
  %scevgep3807.i = getelementptr i8, ptr %.914593006.i, i64 128
  %scevgep3808.i = getelementptr i8, ptr %scevgep3807.i, i64 %i.bbv
  br label %.loopexit2613.i

.loopexit2616.i:                                  ; preds = %bb.ai
  br i1 %i.axt, label %bb.aj, label %.loopexit2614.i

bb.aj:                                            ; preds = %.loopexit2616.i
  br i1 %i.bay, label %.lr.ph2981.preheader.i, label %.loopexit2613.i

.lr.ph2981.preheader.i:                           ; preds = %bb.aj
  %i.bwt = getelementptr inbounds [4 x i8], ptr %gep3017.i, i64 %i.bbd
  br label %.lr.ph2981.i

.lr.ph2981.i:                                     ; preds = %.lr.ph2981.i, %.lr.ph2981.preheader.i
  %.014142979.i = phi i32 [ %i.byy, %.lr.ph2981.i ], [ 0, %.lr.ph2981.preheader.i ]
  %.014152978.i = phi ptr [ %i.byw, %.lr.ph2981.i ], [ %i.bwt, %.lr.ph2981.preheader.i ] ; 5 uses
  %.214192977.i = phi ptr [ %i.byv, %.lr.ph2981.i ], [ %gep3017.i, %.lr.ph2981.preheader.i ] ; 5 uses
  %.1214622976.i = phi ptr [ %i.byx, %.lr.ph2981.i ], [ %.914593006.i, %.lr.ph2981.preheader.i ] ; 9 uses
  %.1324192975.i = phi <4 x float> [ %i.byf, %.lr.ph2981.i ], [ %.1024163004.i, %.lr.ph2981.preheader.i ]
  %.1224442974.i = phi <4 x float> [ %i.byk, %.lr.ph2981.i ], [ %.924413003.i, %.lr.ph2981.preheader.i ]
  %.1224672973.i = phi <4 x float> [ %i.byp, %.lr.ph2981.i ], [ %.924643002.i, %.lr.ph2981.preheader.i ]
  %.1224882972.i = phi <4 x float> [ %i.byu, %.lr.ph2981.i ], [ %.924853001.i, %.lr.ph2981.preheader.i ]
  %i.bwu = load <4 x float>, ptr %.1214622976.i, align 16, !tbaa !45
  %i.bwv = getelementptr inbounds nuw i8, ptr %.1214622976.i, i64 16
  %i.bww = load <4 x float>, ptr %i.bwv, align 16, !tbaa !45
  %i.bwx = getelementptr inbounds nuw i8, ptr %.1214622976.i, i64 32
  %i.bwy = load <4 x float>, ptr %i.bwx, align 16, !tbaa !45
  %i.bwz = getelementptr inbounds nuw i8, ptr %.1214622976.i, i64 48
  %i.bxa = load <4 x float>, ptr %i.bwz, align 16, !tbaa !45
  %i.bxb = getelementptr inbounds nuw i8, ptr %.1214622976.i, i64 64
  %i.bxc = load <4 x float>, ptr %i.bxb, align 16, !tbaa !45
  %i.bxd = getelementptr inbounds nuw i8, ptr %.1214622976.i, i64 80
  %i.bxe = load <4 x float>, ptr %i.bxd, align 16, !tbaa !45
  %i.bxf = getelementptr inbounds nuw i8, ptr %.1214622976.i, i64 96
  %i.bxg = load <4 x float>, ptr %i.bxf, align 16, !tbaa !45
  %i.bxh = getelementptr inbounds nuw i8, ptr %.1214622976.i, i64 112
  %i.bxi = load <4 x float>, ptr %i.bxh, align 16, !tbaa !45
  %i.bxj = load float, ptr %.214192977.i, align 4, !tbaa !48
  ...
  %i.bxm = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.bwu, <4 x float> nofpclass(nan inf) %i.bxl, <4 x float> nofpclass(nan inf) %.1324192975.i)
  %i.bxn = getelementptr inbounds nuw i8, ptr %.214192977.i, i64 4
  %i.bxo = load float, ptr %i.bxn, align 4, !tbaa !48
  ...
  %i.bxr = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.bww, <4 x float> nofpclass(nan inf) %i.bxq, <4 x float> nofpclass(nan inf) %.1224442974.i)
  %i.bxs = getelementptr inbounds nuw i8, ptr %.214192977.i, i64 8
  %i.bxt = load float, ptr %i.bxs, align 4, !tbaa !48
  ...
  %i.bxw = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.bwy, <4 x float> nofpclass(nan inf) %i.bxv, <4 x float> nofpclass(nan inf) %.1224672973.i)
  %i.bxx = getelementptr inbounds nuw i8, ptr %.214192977.i, i64 12
  %i.bxy = load float, ptr %i.bxx, align 4, !tbaa !48
  ...
  %i.byb = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.bxa, <4 x float> nofpclass(nan inf) %i.bya, <4 x float> nofpclass(nan inf) %.1224882972.i)
  %i.byc = load float, ptr %.014152978.i, align 4, !tbaa !48
  ...
  %i.byg = getelementptr inbounds nuw i8, ptr %.014152978.i, i64 4
  %i.byh = load float, ptr %i.byg, align 4, !tbaa !48
  ...
  %i.byl = getelementptr inbounds nuw i8, ptr %.014152978.i, i64 8
  %i.bym = load float, ptr %i.byl, align 4, !tbaa !48
  ...
  %i.byq = getelementptr inbounds nuw i8, ptr %.014152978.i, i64 12
  %i.byr = load float, ptr %i.byq, align 4, !tbaa !48
  ...
  %i.byv = getelementptr inbounds [4 x i8], ptr %.214192977.i, i64 %i.bbf
  %i.byw = getelementptr inbounds [4 x i8], ptr %.014152978.i, i64 %i.bbf
  %i.byx = getelementptr inbounds nuw i8, ptr %.1214622976.i, i64 128
  %i.byy = add nuw nsw i32 %.014142979.i, 1       ; 2 uses
  %exitcond3812.not.i = icmp eq i32 %i.byy, %i.bax
...
.loopexit2614.i:                                  ; preds = %.loopexit2616.i
  br i1 %i.axu, label %.preheader2612.i, label %.loopexit2613.i

.preheader2612.i:                                 ; preds = %.loopexit2614.i
  br i1 %i.bay, label %.lr.ph2995.i, label %.loopexit2613.i

.lr.ph2995.i:                                     ; preds = %.preheader2612.i, %.lr.ph2995.i
  %.014132994.i = phi i32 [ %i.cbd, %.lr.ph2995.i ], [ 0, %.preheader2612.i ]
  %.414212993.i = phi ptr [ %i.cbb, %.lr.ph2995.i ], [ %gep3017.i, %.preheader2612.i ] ; 9 uses
  %.1414642992.i = phi ptr [ %i.cbc, %.lr.ph2995.i ], [ %.914593006.i, %.preheader2612.i ] ; 9 uses
  %.1524212991.i = phi <4 x float> [ %i.cal, %.lr.ph2995.i ], [ %.1024163004.i, %.preheader2612.i ]
  %.1424462990.i = phi <4 x float> [ %i.caq, %.lr.ph2995.i ], [ %.924413003.i, %.preheader2612.i ]
  %.1424692989.i = phi <4 x float> [ %i.cav, %.lr.ph2995.i ], [ %.924643002.i, %.preheader2612.i ]
  %.1424902988.i = phi <4 x float> [ %i.cba, %.lr.ph2995.i ], [ %.924853001.i, %.preheader2612.i ]
  %i.byz = load <4 x float>, ptr %.1414642992.i, align 16, !tbaa !45
  %i.bza = getelementptr inbounds nuw i8, ptr %.1414642992.i, i64 16
  %i.bzb = load <4 x float>, ptr %i.bza, align 16, !tbaa !45
  %i.bzc = getelementptr inbounds nuw i8, ptr %.1414642992.i, i64 32
  %i.bzd = load <4 x float>, ptr %i.bzc, align 16, !tbaa !45
  %i.bze = getelementptr inbounds nuw i8, ptr %.1414642992.i, i64 48
  %i.bzf = load <4 x float>, ptr %i.bze, align 16, !tbaa !45
  %i.bzg = getelementptr inbounds nuw i8, ptr %.1414642992.i, i64 64
  %i.bzh = load <4 x float>, ptr %i.bzg, align 16, !tbaa !45
  %i.bzi = getelementptr inbounds nuw i8, ptr %.1414642992.i, i64 80
  %i.bzj = load <4 x float>, ptr %i.bzi, align 16, !tbaa !45
  %i.bzk = getelementptr inbounds nuw i8, ptr %.1414642992.i, i64 96
  %i.bzl = load <4 x float>, ptr %i.bzk, align 16, !tbaa !45
  %i.bzm = getelementptr inbounds nuw i8, ptr %.1414642992.i, i64 112
  %i.bzn = load <4 x float>, ptr %i.bzm, align 16, !tbaa !45
  %i.bzo = load float, ptr %.414212993.i, align 4, !tbaa !48
  ...
  %i.bzr = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.byz, <4 x float> nofpclass(nan inf) %i.bzq, <4 x float> nofpclass(nan inf) %.1524212991.i)
  %i.bzs = getelementptr inbounds [4 x i8], ptr %.414212993.i, i64 %i.bbd
  %i.bzt = load float, ptr %i.bzs, align 4, !tbaa !48
  ...
  %i.bzw = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.bzb, <4 x float> nofpclass(nan inf) %i.bzv, <4 x float> nofpclass(nan inf) %.1424462990.i)
  %i.bzx = getelementptr inbounds [4 x i8], ptr %.414212993.i, i64 %i.bbh
  %i.bzy = load float, ptr %i.bzx, align 4, !tbaa !48
  ...
  %i.cab = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.bzd, <4 x float> nofpclass(nan inf) %i.caa, <4 x float> nofpclass(nan inf) %.1424692989.i)
  %i.cac = getelementptr inbounds [4 x i8], ptr %.414212993.i, i64 %i.bbj
  %i.cad = load float, ptr %i.cac, align 4, !tbaa !48
  ...
  %i.cag = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.bzf, <4 x float> nofpclass(nan inf) %i.caf, <4 x float> nofpclass(nan inf) %.1424902988.i)
  %i.cah = getelementptr inbounds [4 x i8], ptr %.414212993.i, i64 %i.bbl
  %i.cai = load float, ptr %i.cah, align 4, !tbaa !48
  ...
  %i.cam = getelementptr inbounds [4 x i8], ptr %.414212993.i, i64 %i.bbn
  %i.can = load float, ptr %i.cam, align 4, !tbaa !48
  ...
  %i.car = getelementptr inbounds [4 x i8], ptr %.414212993.i, i64 %i.bbp
  %i.cas = load float, ptr %i.car, align 4, !tbaa !48
  ...
  %i.caw = getelementptr inbounds [4 x i8], ptr %.414212993.i, i64 %i.bbr
  %i.cax = load float, ptr %i.caw, align 4, !tbaa !48
  ...
  %i.cbb = getelementptr inbounds [4 x i8], ptr %.414212993.i, i64 %i.bbs
  %i.cbc = getelementptr inbounds nuw i8, ptr %.1414642992.i, i64 128
  %i.cbd = add nuw nsw i32 %.014132994.i, 1       ; 2 uses
  %exitcond3815.not.i = icmp eq i32 %i.cbd, %i.bax
...
.loopexit2613.loopexit.i:                         ; preds = %.lr.ph2995.i
  ...
  %scevgep3814.i = getelementptr i8, ptr %scevgep3813.i, i64 %i.bbv
  br label %.loopexit2613.i
...
.loopexit2613.i:                                  ; preds = %.loopexit2613.loopexit.i, %.preheader2612.i, %.loopexit2614.i, %.loopexit2614.loopexit.i, %bb.aj, %.loopexit2616.loopexit.i, %.preheader2615.i
  %.152491.i = phi nsz <4 x float> [ %.924853001.i, %.loopexit2614.i ], [ %.924853001.i, %.preheader2612.i ], [ %i.cba, %.loopexit2613.loopexit.i ], [ %.924853001.i, %bb.aj ], [ %i.byu, %.loopexit2614.loopexit.i ], [ %i.bwp, %.loopexit2616.loopexit.i ], [ %.924853001.i, %.preheader2615.i ] ; 2 uses
  %.152470.i = phi nsz <4 x float> [ %.924643002.i, %.loopexit2614.i ], [ %.924643002.i, %.preheader2612.i ], [ %i.cav, %.loopexit2613.loopexit.i ], [ %.924643002.i, %bb.aj ], [ %i.byp, %.loopexit2614.loopexit.i ], [ %i.bwk, %.loopexit2616.loopexit.i ], [ %.924643002.i, %.preheader2615.i ] ; 2 uses
  %.152447.i = phi nsz <4 x float> [ %.924413003.i, %.loopexit2614.i ], [ %.924413003.i, %.preheader2612.i ], [ %i.caq, %.loopexit2613.loopexit.i ], [ %.924413003.i, %bb.aj ], [ %i.byk, %.loopexit2614.loopexit.i ], [ %i.bwf, %.loopexit2616.loopexit.i ], [ %.924413003.i, %.preheader2615.i ] ; 2 uses
  %.162422.i = phi nsz <4 x float> [ %.1024163004.i, %.loopexit2614.i ], [ %.1024163004.i, %.preheader2612.i ], [ %i.cal, %.loopexit2613.loopexit.i ], [ %.1024163004.i, %bb.aj ], [ %i.byf, %.loopexit2614.loopexit.i ], [ %i.bwa, %.loopexit2616.loopexit.i ], [ %.1024163004.i, %.preheader2615.i ] ; 2 uses
  ...
  %i.cbe = add nuw nsw i32 %.114763005.i, 8       ; 3 uses
  %i.cbf = or disjoint i32 %i.cbe, 7
  %i.cbg = icmp slt i32 %i.cbf, %i.awp
  br i1 %i.cbg, label %bb.ai, label %.preheader2625.i, !llvm.loop !237
...
.preheader2624.i:                                 ; preds = %.loopexit2609.i, %.preheader2625.i
  ...
  %.21477.lcssa.i = phi i32 [ %.11476.lcssa.i, %.preheader2625.i ], [ %i.cfv, %.loopexit2609.i ] ; 6 uses
  ...
  br i1 %i.cbi, label %.lr.ph3077.i, label %.preheader2623.i

.lr.ph3077.i:                                     ; preds = %.preheader2624.i
  %i.cbj = load ptr, ptr %4, align 8, !tbaa !19
  %i.cbk = load i32, ptr %i.ag, align 4, !tbaa !55
  %i.cbl = sext i32 %i.cbk to i64
  %i.cbm = load i64, ptr %i.ad, align 8, !tbaa !44
  %factor.op.mul3082.i = mul i64 %i.cbm, %i.cbl
  %i.cbn = mul nsw i64 %indvars.iv3835.i, %i.ayi
  %invariant.gep3084.i = getelementptr [4 x i8], ptr %i.cbj, i64 %i.cbn
  ...
  br i1 %i.axw, label %.lr.ph3068.us.preheader.i, label %.lr.ph3077.split.preheader.i

.lr.ph3077.split.preheader.i:                     ; preds = %.lr.ph3077.i
  %i.cbs = add i32 %.21477.lcssa.i, 3
  %smax3822.i = call i32 @llvm.smax.i32(i32 %i.awp, i32 %i.cbs)
  %reass.sub166 = sub i32 %smax3822.i, %.21477.lcssa.i
  %i.cbt = and i32 %reass.sub166, -2
  %i.cbu = add i32 %.21477.lcssa.i, %i.cbt
...
.lr.ph3068.us.i:                                  ; preds = %._crit_edge3069.us.i, %.lr.ph3068.us.preheader.i
  %indvars.iv3826.i = phi i64 [ %i.cbv, %.lr.ph3068.us.preheader.i ], [ %indvars.iv.next3827.i, %._crit_edge3069.us.i ] ; 2 uses
  %.2114713076.us.i = phi ptr [ %.161466.lcssa.i, %.lr.ph3068.us.preheader.i ], [ %scevgep3824.i, %._crit_edge3069.us.i ] ; 3 uses
  %.2224283074.us.i = phi <4 x float> [ %.172423.lcssa.i, %.lr.ph3068.us.preheader.i ], [ %.lcssa717, %._crit_edge3069.us.i ] ; 2 uses
  %.2124533073.us.i = phi <4 x float> [ %.162448.lcssa.i, %.lr.ph3068.us.preheader.i ], [ %.lcssa716.a, %._crit_edge3069.us.i ] ; 2 uses
  %.reass3083.us.i = mul i64 %factor.op.mul3082.i, %indvars.iv3826.i
  %gep3085.us.i = getelementptr i8, ptr %invariant.gep3084.i, i64 %.reass3083.us.i ; 2 uses
  br i1 %i.ayj, label %.epil.preheader772, label %.lr.ph3068.us.i.new

.lr.ph3068.us.i.new:                              ; preds = %.lr.ph3068.us.i, %.lr.ph3068.us.i.new
  %.014073065.us.i = phi ptr [ %i.ccw, %.lr.ph3068.us.i.new ], [ %gep3085.us.i, %.lr.ph3068.us.i ] ; 3 uses
  %.2214723064.us.i = phi ptr [ %i.ccx, %.lr.ph3068.us.i.new ], [ %.2114713076.us.i, %.lr.ph3068.us.i ] ; 5 uses
  %.2324293063.us.i = phi <4 x float> [ %i.ccq, %.lr.ph3068.us.i.new ], [ %.2224283074.us.i, %.lr.ph3068.us.i ]
  %.2224543062.us.i = phi <4 x float> [ %i.ccv, %.lr.ph3068.us.i.new ], [ %.2124533073.us.i, %.lr.ph3068.us.i ]
  %niter780 = phi i32 [ %niter780.next.1, %.lr.ph3068.us.i.new ], [ 0, %.lr.ph3068.us.i ]
  %i.cbw = load <4 x float>, ptr %.2214723064.us.i, align 16, !tbaa !45
  %i.cbx = getelementptr inbounds nuw i8, ptr %.2214723064.us.i, i64 16
  %i.cby = load <4 x float>, ptr %i.cbx, align 16, !tbaa !45
  %i.cbz = load float, ptr %.014073065.us.i, align 4, !tbaa !48
  ...
  %i.ccc = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cbw, <4 x float> nofpclass(nan inf) %i.ccb, <4 x float> nofpclass(nan inf) %.2324293063.us.i)
  %i.ccd = getelementptr inbounds [4 x i8], ptr %.014073065.us.i, i64 %i.cbp
  %i.cce = load float, ptr %i.ccd, align 4, !tbaa !48
  ...
  %i.cch = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cby, <4 x float> nofpclass(nan inf) %i.ccg, <4 x float> nofpclass(nan inf) %.2224543062.us.i)
  %i.cci = getelementptr inbounds [4 x i8], ptr %.014073065.us.i, i64 %i.cbr ; 3 uses
  %i.ccj = getelementptr inbounds nuw i8, ptr %.2214723064.us.i, i64 32
  %i.cck = load <4 x float>, ptr %i.ccj, align 16, !tbaa !45
  %i.ccl = getelementptr inbounds nuw i8, ptr %.2214723064.us.i, i64 48
  %i.ccm = load <4 x float>, ptr %i.ccl, align 16, !tbaa !45
  %i.ccn = load float, ptr %i.cci, align 4, !tbaa !48
  ...
  %i.ccs = load float, ptr %i.ccr, align 4, !tbaa !48
  ...
  %i.ccx = getelementptr inbounds nuw i8, ptr %.2214723064.us.i, i64 64 ; 2 uses
  %niter780.next.1 = add nuw nsw i32 %niter780, 2 ; 2 uses
  %niter780.ncmp.1 = icmp eq i32 %niter780.next.1, %unroll_iter779
  br i1 %niter780.ncmp.1, label %._crit_edge3069.us.i.unr-lcssa, label %.lr.ph3068.us.i.new, !llvm.loop !238

._crit_edge3069.us.i.unr-lcssa:                   ; preds = %.lr.ph3068.us.i.new
  br i1 %lcmp.mod775.not, label %._crit_edge3069.us.i, label %.epil.preheader772

.epil.preheader772:                               ; preds = %._crit_edge3069.us.i.unr-lcssa, %.lr.ph3068.us.i
  %.014073065.us.i.epil.init = phi ptr [ %gep3085.us.i, %.lr.ph3068.us.i ], [ %i.ccw, %._crit_edge3069.us.i.unr-lcssa ] ; 2 uses
  %.2214723064.us.i.epil.init = phi ptr [ %.2114713076.us.i, %.lr.ph3068.us.i ], [ %i.ccx, %._crit_edge3069.us.i.unr-lcssa ] ; 2 uses
  %.2324293063.us.i.epil.init = phi <4 x float> [ %.2224283074.us.i, %.lr.ph3068.us.i ], [ %i.ccq, %._crit_edge3069.us.i.unr-lcssa ]
  %.2224543062.us.i.epil.init = phi <4 x float> [ %.2124533073.us.i, %.lr.ph3068.us.i ], [ %i.ccv, %._crit_edge3069.us.i.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod778)
  %i.ccy = load <4 x float>, ptr %.2214723064.us.i.epil.init, align 16, !tbaa !45
  %i.ccz = getelementptr inbounds nuw i8, ptr %.2214723064.us.i.epil.init, i64 16
  %i.cda = load <4 x float>, ptr %i.ccz, align 16, !tbaa !45
  %i.cdb = load float, ptr %.014073065.us.i.epil.init, align 4, !tbaa !48
  ...
  %i.cde = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ccy, <4 x float> nofpclass(nan inf) %i.cdd, <4 x float> nofpclass(nan inf) %.2324293063.us.i.epil.init)
  %i.cdf = getelementptr inbounds [4 x i8], ptr %.014073065.us.i.epil.init, i64 %i.cbp
  %i.cdg = load float, ptr %i.cdf, align 4, !tbaa !48
  ...
  %i.cdj = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cda, <4 x float> nofpclass(nan inf) %i.cdi, <4 x float> nofpclass(nan inf) %.2224543062.us.i.epil.init)
  br label %._crit_edge3069.us.i

._crit_edge3069.us.i:                             ; preds = %._crit_edge3069.us.i.unr-lcssa, %.epil.preheader772
  %.lcssa717 = phi <4 x float> [ %i.ccq, %._crit_edge3069.us.i.unr-lcssa ], [ %i.cde, %.epil.preheader772 ] ; 2 uses
  %.lcssa716.a = phi <4 x float> [ %i.ccv, %._crit_edge3069.us.i.unr-lcssa ], [ %i.cdj, %.epil.preheader772 ] ; 2 uses
  %scevgep3823.i.a = getelementptr i8, ptr %.2114713076.us.i, i64 32
  %scevgep3824.i = getelementptr i8, ptr %scevgep3823.i.a, i64 %i.ayg ; 2 uses
  %indvars.iv.next3827.i = add nuw nsw i64 %indvars.iv3826.i, 2 ; 2 uses
  %i.cdk = trunc i64 %indvars.iv.next3827.i to i32 ; 2 uses
  %i.cdl = or i32 %i.cdk, 1
  %i.cdm = icmp slt i32 %i.cdl, %i.awp
  br i1 %i.cdm, label %.lr.ph3068.us.i, label %.preheader2623.i, !llvm.loop !239

bb.ak:                                            ; preds = %.loopexit2609.i, %.lr.ph3051.i
  %.1614663050.i = phi ptr [ %.91459.lcssa.i, %.lr.ph3051.i ], [ %.201470.i, %.loopexit2609.i ] ; 7 uses
  %.214773049.i = phi i32 [ %.11476.lcssa.i, %.lr.ph3051.i ], [ %i.cfv, %.loopexit2609.i ] ; 2 uses
  ...
  %i.cdn = sdiv i32 %.214773049.i, %i.awn
  %i.cdo = sext i32 %i.cdn to i64
  %.reass3059.i = mul i64 %factor.op.mul3058.i, %i.cdo
  %gep3061.i = getelementptr i8, ptr %invariant.gep3060.i, i64 %.reass3059.i ; 2 uses
  br i1 %i.axt, label %.preheader2610.i, label %.loopexit2611.i

.preheader2610.i:                                 ; preds = %bb.ak
  br i1 %i.bty, label %.lr.ph3025.i, label %.loopexit2609.i

.lr.ph3025.i:                                     ; preds = %.preheader2610.i, %.lr.ph3025.i
  %.014093024.i = phi i32 [ %i.cer, %.lr.ph3025.i ], [ 0, %.preheader2610.i ]
  %.014103023.i = phi ptr [ %i.cep, %.lr.ph3025.i ], [ %gep3061.i, %.preheader2610.i ] ; 5 uses
  %.1714673022.i = phi ptr [ %i.ceq, %.lr.ph3025.i ], [ %.1614663050.i, %.preheader2610.i ] ; 5 uses
  %.1824243021.i = phi <4 x float> [ %i.cdz, %.lr.ph3025.i ], [ %.1724233048.i, %.preheader2610.i ]
  %.1724493020.i = phi <4 x float> [ %i.cee, %.lr.ph3025.i ], [ %.1624483047.i, %.preheader2610.i ]
  %.1724723019.i = phi <4 x float> [ %i.cej, %.lr.ph3025.i ], [ %.1624713046.i, %.preheader2610.i ]
  %.1724933018.i = phi <4 x float> [ %i.ceo, %.lr.ph3025.i ], [ %.1624923045.i, %.preheader2610.i ]
  %i.cdp = load <4 x float>, ptr %.1714673022.i, align 16, !tbaa !45
  %i.cdq = getelementptr inbounds nuw i8, ptr %.1714673022.i, i64 16
  %i.cdr = load <4 x float>, ptr %i.cdq, align 16, !tbaa !45
  %i.cds = getelementptr inbounds nuw i8, ptr %.1714673022.i, i64 32
  %i.cdt = load <4 x float>, ptr %i.cds, align 16, !tbaa !45
  %i.cdu = getelementptr inbounds nuw i8, ptr %.1714673022.i, i64 48
  %i.cdv = load <4 x float>, ptr %i.cdu, align 16, !tbaa !45
  %i.cdw = load float, ptr %.014103023.i, align 4, !tbaa !48
  ...
  %i.cdz = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cdp, <4 x float> nofpclass(nan inf) %i.cdy, <4 x float> nofpclass(nan inf) %.1824243021.i) ; 2 uses
  %i.cea = getelementptr inbounds nuw i8, ptr %.014103023.i, i64 4
  %i.ceb = load float, ptr %i.cea, align 4, !tbaa !48
  ...
  %i.cee = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cdr, <4 x float> nofpclass(nan inf) %i.ced, <4 x float> nofpclass(nan inf) %.1724493020.i) ; 2 uses
  %i.cef = getelementptr inbounds nuw i8, ptr %.014103023.i, i64 8
  %i.ceg = load float, ptr %i.cef, align 4, !tbaa !48
  ...
  %i.cej = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cdt, <4 x float> nofpclass(nan inf) %i.cei, <4 x float> nofpclass(nan inf) %.1724723019.i) ; 2 uses
  %i.cek = getelementptr inbounds nuw i8, ptr %.014103023.i, i64 12
  %i.cel = load float, ptr %i.cek, align 4, !tbaa !48
  ...
  %i.ceo = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cdv, <4 x float> nofpclass(nan inf) %i.cen, <4 x float> nofpclass(nan inf) %.1724933018.i) ; 2 uses
  %i.cep = getelementptr inbounds [4 x i8], ptr %.014103023.i, i64 %i.bub
  %i.ceq = getelementptr inbounds nuw i8, ptr %.1714673022.i, i64 64
  %i.cer = add nuw nsw i32 %.014093024.i, 1       ; 2 uses
  %exitcond3818.not.i = icmp eq i32 %i.cer, %i.btx
...
.loopexit2611.i:                                  ; preds = %bb.ak
  br i1 %i.axu, label %.preheader2608.i, label %.loopexit2609.i

.preheader2608.i:                                 ; preds = %.loopexit2611.i
  br i1 %i.bty, label %.lr.ph3039.i, label %.loopexit2609.i

.lr.ph3039.i:                                     ; preds = %.preheader2608.i, %.lr.ph3039.i
  %.014083038.i = phi i32 [ %i.cfu, %.lr.ph3039.i ], [ 0, %.preheader2608.i ]
  %.214123037.i = phi ptr [ %i.cfs, %.lr.ph3039.i ], [ %gep3061.i, %.preheader2608.i ] ; 5 uses
  %.1914693036.i = phi ptr [ %i.cft, %.lr.ph3039.i ], [ %.1614663050.i, %.preheader2608.i ] ; 5 uses
  %.2024263035.i = phi <4 x float> [ %i.cfc, %.lr.ph3039.i ], [ %.1724233048.i, %.preheader2608.i ]
  %.1924513034.i = phi <4 x float> [ %i.cfh, %.lr.ph3039.i ], [ %.1624483047.i, %.preheader2608.i ]
  %.1924743033.i = phi <4 x float> [ %i.cfm, %.lr.ph3039.i ], [ %.1624713046.i, %.preheader2608.i ]
  %.1924953032.i = phi <4 x float> [ %i.cfr, %.lr.ph3039.i ], [ %.1624923045.i, %.preheader2608.i ]
  %i.ces = load <4 x float>, ptr %.1914693036.i, align 16, !tbaa !45
  %i.cet = getelementptr inbounds nuw i8, ptr %.1914693036.i, i64 16
  %i.ceu = load <4 x float>, ptr %i.cet, align 16, !tbaa !45
  %i.cev = getelementptr inbounds nuw i8, ptr %.1914693036.i, i64 32
  %i.cew = load <4 x float>, ptr %i.cev, align 16, !tbaa !45
  %i.cex = getelementptr inbounds nuw i8, ptr %.1914693036.i, i64 48
  %i.cey = load <4 x float>, ptr %i.cex, align 16, !tbaa !45
  %i.cez = load float, ptr %.214123037.i, align 4, !tbaa !48
  ...
  %i.cfc = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ces, <4 x float> nofpclass(nan inf) %i.cfb, <4 x float> nofpclass(nan inf) %.2024263035.i) ; 2 uses
  %i.cfd = getelementptr inbounds [4 x i8], ptr %.214123037.i, i64 %i.bud
  %i.cfe = load float, ptr %i.cfd, align 4, !tbaa !48
  ...
  %i.cfh = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ceu, <4 x float> nofpclass(nan inf) %i.cfg, <4 x float> nofpclass(nan inf) %.1924513034.i) ; 2 uses
  %i.cfi = getelementptr inbounds [4 x i8], ptr %.214123037.i, i64 %i.buf
  %i.cfj = load float, ptr %i.cfi, align 4, !tbaa !48
  ...
  %i.cfm = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cew, <4 x float> nofpclass(nan inf) %i.cfl, <4 x float> nofpclass(nan inf) %.1924743033.i) ; 2 uses
  %i.cfn = getelementptr inbounds [4 x i8], ptr %.214123037.i, i64 %i.buh
  %i.cfo = load float, ptr %i.cfn, align 4, !tbaa !48
  ...
  %i.cfr = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cey, <4 x float> nofpclass(nan inf) %i.cfq, <4 x float> nofpclass(nan inf) %.1924953032.i) ; 2 uses
  %i.cfs = getelementptr inbounds [4 x i8], ptr %.214123037.i, i64 %i.bui
  %i.cft = getelementptr inbounds nuw i8, ptr %.1914693036.i, i64 64
  %i.cfu = add nuw nsw i32 %.014083038.i, 1       ; 2 uses
  %exitcond3821.not.i = icmp eq i32 %i.cfu, %i.btx
...
.loopexit2609.loopexit.i:                         ; preds = %.lr.ph3039.i
  ...
  %scevgep3820.i = getelementptr i8, ptr %scevgep3819.i, i64 %i.bul
  br label %.loopexit2609.i

.loopexit2609.i:                                  ; preds = %.loopexit2609.loopexit.i, %.preheader2608.i, %.loopexit2611.i, %.loopexit2611.loopexit.i, %.preheader2610.i
end_hunk_6
begin_hunk_7_@_ZNK4ncnn24Convolution1D_x86_avx51213forward_bf16sERKNS_3MatERS1_RKNS_6OptionE:bb.a
  ...
  %i.av = load i32, ptr %i.au, align 8, !tbaa !56
...
bb.j:                                             ; preds = %_ZNK4ncnn3Mat5emptyEv.exit
  ...
  %i.bc = load i32, ptr %i.c, align 4, !tbaa !42
  %i.bd = load i32, ptr %i.a, align 8, !tbaa !59
  %i.be = load i32, ptr %i.aj, align 4, !tbaa !60
...
_ZNK4ncnn3Mat5emptyEv.exit32.thread:              ; preds = %bb.h, %bb.b, %_ZNK4ncnn3Mat5emptyEv.exit, %bb.j, %_ZNK4ncnn3Mat5emptyEv.exit32
  ...
  %i.bi = load ptr, ptr %i.g, align 8, !tbaa !17  ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  %i.bl = load ptr, ptr %i.h, align 8, !tbaa !18  ; 3 uses
  %.not3.i = icmp eq ptr %i.bl, null
  %i.bm = load ptr, ptr %4, align 8, !tbaa !19    ; 3 uses
  br i1 %.not3.i, label %bb.n, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.bn = load ptr, ptr %i.bl, align 8, !tbaa !11
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bn, i64 24
  %i.bp = load ptr, ptr %i.bo, align 8
  invoke void %i.bp(ptr noundef nonnull align 8 dereferenceable(8) %i.bl, ptr noundef %i.bm)
          to label %_ZN4ncnn3MatD2Ev.exit24 unwind label %bb.p, !inline_history !0
...
bb.q:                                             ; preds = %bb.i, %bb.c
  ...
  %i.bs = load ptr, ptr %i.g, align 8, !tbaa !17  ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  %i.bv = load ptr, ptr %i.h, align 8, !tbaa !18  ; 3 uses
  %.not3.i26 = icmp eq ptr %i.bv, null
  %i.bw = load ptr, ptr %4, align 8, !tbaa !19    ; 3 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  invoke void %i.bz(ptr noundef nonnull align 8 dereferenceable(8) %i.bv, ptr noundef %i.bw)
          to label %_ZN4ncnn3MatD2Ev.exit unwind label %bb.w, !inline_history !0
...
.lr.ph985:                                        ; preds = %bb.b
  ...
  %i.u = load i32, ptr %i.n, align 4, !tbaa !55   ; 2 uses
...
.lr.ph985.splitthread-pre-split:                  ; preds = %._crit_edge
  %.pr = load i32, ptr %i.n, align 4, !tbaa !55
  br label %.lr.ph985.split
...
.lr.ph985.split:                                  ; preds = %.lr.ph985.splitthread-pre-split, %.lr.ph985.split.preheader
  ...
  %i.z = load i32, ptr %i.l, align 8, !tbaa !57   ; 11 uses
  %i.aa = load i32, ptr %i.m, align 8, !tbaa !64
...
.lr.ph981:                                        ; preds = %.lr.ph985.split
  ...
  %i.af = load i32, ptr %i.o, align 8, !tbaa !57  ; 3 uses
...
._crit_edge:                                      ; preds = %.thread743, %.lr.ph985.split
  ...
  br i1 %exitcond1089.not, label %._crit_edge986, label %.lr.ph985.splitthread-pre-split, !llvm.loop !383
...
bb.c:                                             ; preds = %.lr.ph981, %.thread743
  ...
  %i.ax = load ptr, ptr %5, align 8, !tbaa !66    ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.az = load <16 x float>, ptr %i.ay, align 1, !tbaa !45
  br label %_ZN4ncnn3MatD2Ev.exit

_ZN4ncnn3MatD2Ev.exit:                            ; preds = %bb.d, %bb.c
  %.0590 = phi nsz <16 x float> [ %i.az, %bb.d ], [ zeroinitializer, %bb.c ] ; 2 uses
  %i.ba = load ptr, ptr %6, align 8, !tbaa !19, !noalias !404
  %i.bb = load i64, ptr %i.q, align 8, !tbaa !20, !noalias !404
  %i.bc = mul i64 %i.bb, %indvars.iv1086
  %i.bd = load i64, ptr %i.r, align 8, !tbaa !44, !noalias !404
...
.lr.ph825:                                        ; preds = %_ZN4ncnn3MatD2Ev.exit
  %i.bg = load ptr, ptr %3, align 8, !tbaa !19
  %i.bh = load i32, ptr %i.s, align 4, !tbaa !55
  %i.bi = sext i32 %i.bh to i64
  %i.bj = load i64, ptr %i.t, align 8, !tbaa !44
  %factor.op.mul = mul i64 %i.bj, %i.bi
  %i.bk = load i32, ptr %7, align 4, !tbaa !58
...
.lr.ph880:                                        ; preds = %.preheader761
  %i.bq = load ptr, ptr %3, align 8, !tbaa !19
  %i.br = load i32, ptr %i.s, align 4, !tbaa !55
  %i.bs = sext i32 %i.br to i64
  %i.bt = load i64, ptr %i.t, align 8, !tbaa !44
  %factor.op.mul887 = mul i64 %i.bt, %i.bs
  %i.bu = load i32, ptr %7, align 4, !tbaa !58
...
bb.f:                                             ; preds = %.lr.ph, %bb.f
  ...
  %i.dp = load float, ptr %i.do, align 4, !tbaa !48
  ...
  %i.du = load float, ptr %i.dt, align 4, !tbaa !48
  ...
  %i.ej = load float, ptr %i.ei, align 4, !tbaa !48
  ...
  %i.eo = load float, ptr %i.en, align 4, !tbaa !48
  ...
  %i.et = load float, ptr %i.es, align 4, !tbaa !48
  ...
  %i.ey = load float, ptr %i.ex, align 4, !tbaa !48
  ...
  %i.fd = load float, ptr %i.fc, align 4, !tbaa !48
  ...
  %i.fn = load float, ptr %i.fm, align 4, !tbaa !48
  ...
  %i.fs = load float, ptr %i.fr, align 4, !tbaa !48
  ...
  %i.fx = load float, ptr %i.fw, align 4, !tbaa !48
...
bb.o:                                             ; preds = %.lr.ph854, %bb.o
  ...
  %i.zp = load <16 x float>, ptr %.12672849, align 64, !tbaa !45
  %i.zq = getelementptr inbounds nuw i8, ptr %.12672849, i64 64
  %i.zr = load <16 x float>, ptr %i.zq, align 64, !tbaa !45
  %i.zs = getelementptr inbounds nuw i8, ptr %.12672849, i64 128
  %i.zt = load <16 x float>, ptr %i.zs, align 64, !tbaa !45
  %i.zu = getelementptr inbounds nuw i8, ptr %.12672849, i64 192
  %i.zv = load <16 x float>, ptr %i.zu, align 64, !tbaa !45
  %i.zw = getelementptr inbounds nuw i8, ptr %.12672849, i64 256
  %i.zx = load <16 x float>, ptr %i.zw, align 64, !tbaa !45
  %i.zy = getelementptr inbounds nuw i8, ptr %.12672849, i64 320
  %i.zz = load <16 x float>, ptr %i.zy, align 64, !tbaa !45
  %i.aaa = getelementptr inbounds nuw i8, ptr %.12672849, i64 384
  %i.aab = load <16 x float>, ptr %i.aaa, align 64, !tbaa !45
  %i.aac = getelementptr inbounds nuw i8, ptr %.12672849, i64 448
  %i.aad = load <16 x float>, ptr %i.aac, align 64, !tbaa !45
  %i.aae = load float, ptr %.2708848, align 4, !tbaa !48
  ...
  %i.aaj = load float, ptr %i.aai, align 4, !tbaa !48
  ...
  %i.aao = load float, ptr %i.aan, align 4, !tbaa !48
  ...
  %i.aat = load float, ptr %i.aas, align 4, !tbaa !48
  ...
  %i.aax = load float, ptr %.0712846, align 4, !tbaa !48
  ...
  %i.abc = load float, ptr %i.abb, align 4, !tbaa !48
...
.lr.ph868:                                        ; preds = %.preheader747
  ...
  %i.acn = load i32, ptr %9, align 4, !tbaa !58
...
bb.p:                                             ; preds = %.lr.ph868, %bb.p
  ...
  %i.acp = load <16 x float>, ptr %.14674863, align 64, !tbaa !45
  %i.acq = getelementptr inbounds nuw i8, ptr %.14674863, i64 64
  %i.acr = load <16 x float>, ptr %i.acq, align 64, !tbaa !45
  %i.acs = getelementptr inbounds nuw i8, ptr %.14674863, i64 128
  %i.act = load <16 x float>, ptr %i.acs, align 64, !tbaa !45
  %i.acu = getelementptr inbounds nuw i8, ptr %.14674863, i64 192
  %i.acv = load <16 x float>, ptr %i.acu, align 64, !tbaa !45
  %i.acw = getelementptr inbounds nuw i8, ptr %.14674863, i64 256
  %i.acx = load <16 x float>, ptr %i.acw, align 64, !tbaa !45
  %i.acy = getelementptr inbounds nuw i8, ptr %.14674863, i64 320
  %i.acz = load <16 x float>, ptr %i.acy, align 64, !tbaa !45
  %i.ada = getelementptr inbounds nuw i8, ptr %.14674863, i64 384
  %i.adb = load <16 x float>, ptr %i.ada, align 64, !tbaa !45
  %i.adc = getelementptr inbounds nuw i8, ptr %.14674863, i64 448
  %i.add = load <16 x float>, ptr %i.adc, align 64, !tbaa !45
  %i.ade = load float, ptr %.4710861, align 4, !tbaa !48
  ...
  %i.adj = load float, ptr %i.adi, align 4, !tbaa !48
  ...
  %i.adt = load float, ptr %i.ads, align 4, !tbaa !48
  ...
  %i.aei = load float, ptr %i.aeh, align 4, !tbaa !48
  ...
  %i.aen = load float, ptr %i.aem, align 4, !tbaa !48
...
.loopexit748:                                     ; preds = %.preheader750, %.loopexit751.loopexit, %bb.n, %.loopexit749.loopexit, %.loopexit748.loopexit, %.preheader747, %.loopexit749
  ...
  br i1 %i.aez, label %bb.l, label %.preheader760, !llvm.loop !394

.preheader759:                                    ; preds = %.loopexit, %.preheader760
  %.2687.lcssa = phi i32 [ %.1686.lcssa, %.preheader760 ], [ %i.aks, %.loopexit ] ; 6 uses
...
.lr.ph948:                                        ; preds = %.preheader759
  %i.afc = load ptr, ptr %3, align 8, !tbaa !19
  %i.afd = load i32, ptr %i.s, align 4, !tbaa !55
  %i.afe = sext i32 %i.afd to i64
  %i.aff = load i64, ptr %i.t, align 8, !tbaa !44
  %factor.op.mul953 = mul i64 %i.aff, %i.afe
  %i.afg = load i32, ptr %7, align 4, !tbaa !58
  %i.afh = mul nsw i32 %i.afg, %.0585979
  %i.afi = sext i32 %i.afh to i64
  %invariant.gep955 = getelementptr [4 x i8], ptr %i.afc, i64 %i.afi
  %i.afj = load i32, ptr %8, align 4, !tbaa !58   ; 6 uses
...
.lr.ph940.us.new:                                 ; preds = %.lr.ph940.us, %.lr.ph940.us.new
  ...
  %i.afy = load <16 x float>, ptr %.22682935.us, align 64, !tbaa !45
  %i.afz = getelementptr inbounds nuw i8, ptr %.22682935.us, i64 64
  %i.aga = load <16 x float>, ptr %i.afz, align 64, !tbaa !45
  %i.agb = load float, ptr %.0582938.us, align 4, !tbaa !48
  ...
  %i.agg = load float, ptr %i.agf, align 4, !tbaa !48
  ...
  %i.agm = load <16 x float>, ptr %i.agl, align 64, !tbaa !45
  %i.agn = getelementptr inbounds nuw i8, ptr %.22682935.us, i64 192
  %i.ago = load <16 x float>, ptr %i.agn, align 64, !tbaa !45
  %i.agp = load float, ptr %i.agk, align 4, !tbaa !48
  ...
  %i.agu = load float, ptr %i.agt, align 4, !tbaa !48
...
.epil.preheader:                                  ; preds = %._crit_edge.us.unr-lcssa, %.lr.ph940.us
  ...
  %i.aha = load <16 x float>, ptr %.22682935.us.epil.init, align 64, !tbaa !45
  %i.ahb = getelementptr inbounds nuw i8, ptr %.22682935.us.epil.init, i64 64
  %i.ahc = load <16 x float>, ptr %i.ahb, align 64, !tbaa !45
  %i.ahd = load float, ptr %.0582938.us.epil.init, align 4, !tbaa !48
  ...
  %i.ahi = load float, ptr %i.ahh, align 4, !tbaa !48
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.unr-lcssa, %.epil.preheader
  ...
  br i1 %i.aho, label %.lr.ph940.us, label %.preheader758.loopexit, !llvm.loop !396
...
bb.r:                                             ; preds = %.lr.ph898, %bb.r
  ...
  %i.ahw = load <16 x float>, ptr %.17677891, align 64, !tbaa !45
  %i.ahx = getelementptr inbounds nuw i8, ptr %.17677891, i64 64
  %i.ahy = load <16 x float>, ptr %i.ahx, align 64, !tbaa !45
  %i.ahz = getelementptr inbounds nuw i8, ptr %.17677891, i64 128
  %i.aia = load <16 x float>, ptr %i.ahz, align 64, !tbaa !45
  %i.aib = getelementptr inbounds nuw i8, ptr %.17677891, i64 192
  %i.aic = load <16 x float>, ptr %i.aib, align 64, !tbaa !45
  %i.aid = load float, ptr %.0587896, align 4, !tbaa !48
  ...
  %i.aii = load float, ptr %i.aih, align 4, !tbaa !48
  ...
  %i.ain = load float, ptr %i.aim, align 4, !tbaa !48
  ...
  %i.ais = load float, ptr %i.air, align 4, !tbaa !48
...
.lr.ph912:                                        ; preds = %.preheader
  ...
  %i.ajk = load i32, ptr %9, align 4, !tbaa !58
...
bb.a:
  ...
  store i32 %4, ptr %i.a, align 4, !tbaa !58
  store i32 %5, ptr %i.b, align 4, !tbaa !58
  store i32 %6, ptr %i.c, align 4, !tbaa !58
  store i32 %7, ptr %i.d, align 4, !tbaa !58
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.l = load i32, ptr %i.k, align 8, !tbaa !57   ; 12 uses
  ...
  store i32 %i.r, ptr %i.e, align 4, !tbaa !58
  %i.s = getelementptr inbounds nuw i8, ptr %1, i64 44 ; 7 uses
  %i.t = load i32, ptr %i.s, align 4, !tbaa !55   ; 3 uses
  ...
  store i32 %i.z, ptr %i.f, align 4, !tbaa !58
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g) #12
  %i.aa = load ptr, ptr %3, align 8, !tbaa !19
  store ptr %i.aa, ptr %i.g, align 8, !tbaa !66
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h) #12
  %i.ab = sdiv i32 %i.y, 16
  store i32 %i.ab, ptr %i.h, align 4, !tbaa !58
  %i.ac = getelementptr inbounds nuw i8, ptr %9, i64 4
  %i.ad = load i32, ptr %i.ac, align 4, !tbaa !67
  ...
  %i.ae = load i32, ptr %i.h, align 4, !tbaa !58
  %i.af = shl nsw i32 %i.ae, 4                    ; 3 uses
  %i.ag = sub nsw i32 %i.y, %i.af                 ; 2 uses
  %i.ah = sdiv i32 %i.ag, 8                       ; 3 uses
  store i32 %i.ah, ptr %i.h, align 4, !tbaa !58
  %i.ai = icmp sgt i32 %i.ag, 7
  br i1 %i.ai, label %.lr.ph3268, label %._crit_edge3269

.lr.ph3268:                                       ; preds = %bb.c
  ...
  %i.ao = load i32, ptr %i.s, align 4, !tbaa !55  ; 2 uses
  %i.ap = icmp sgt i32 %i.ao, 0
  br i1 %i.ap, label %.lr.ph3268.split.preheader, label %._crit_edge3269

.lr.ph3268.split.preheader:                       ; preds = %.lr.ph3268
  %i.aq = sext i32 %i.af to i64
  %wide.trip.count4185 = zext nneg i32 %i.ah to i64
  br label %.lr.ph3268.split

._crit_edge3269:                                  ; preds = %._crit_edge, %.lr.ph3268, %bb.c
  %i.ar = shl nsw i32 %i.ah, 3
  %i.as = add nsw i32 %i.ar, %i.af                ; 3 uses
  %i.at = sub nsw i32 %i.y, %i.as                 ; 2 uses
  %i.au = sdiv i32 %i.at, 4                       ; 3 uses
  store i32 %i.au, ptr %i.h, align 4, !tbaa !58
  %i.av = icmp sgt i32 %i.at, 3
  br i1 %i.av, label %.lr.ph3515, label %._crit_edge3516

.lr.ph3515:                                       ; preds = %._crit_edge3269
  ...
  %i.bb = load i32, ptr %i.s, align 4, !tbaa !55  ; 2 uses
  %i.bc = icmp sgt i32 %i.bb, 0
  br i1 %i.bc, label %.lr.ph3515.split.preheader, label %._crit_edge3516

.lr.ph3515.split.preheader:                       ; preds = %.lr.ph3515
  %i.bd = sext i32 %i.as to i64
  %wide.trip.count4235 = zext nneg i32 %i.au to i64
  br label %.lr.ph3515.split

.lr.ph3268.splitthread-pre-split:                 ; preds = %._crit_edge
  %.pr = load i32, ptr %i.s, align 4, !tbaa !55
  br label %.lr.ph3268.split

.lr.ph3268.split:                                 ; preds = %.lr.ph3268.splitthread-pre-split, %.lr.ph3268.split.preheader
  %i.be = phi i32 [ %.pr, %.lr.ph3268.splitthread-pre-split ], [ %i.ao, %.lr.ph3268.split.preheader ] ; 3 uses
  %indvars.iv4182 = phi i64 [ %indvars.iv.next4183, %.lr.ph3268.splitthread-pre-split ], [ 0, %.lr.ph3268.split.preheader ] ; 2 uses
  %i.bf = load i32, ptr %i.k, align 8, !tbaa !57  ; 9 uses
  %i.bg = load i32, ptr %i.m, align 8, !tbaa !64
  %i.bh = mul i32 %i.bg, %i.bf                    ; 12 uses
  %i.bi = load i32, ptr %i.u, align 8, !tbaa !57  ; 2 uses
  %i.bj = icmp sgt i32 %i.be, 0
  br i1 %i.bj, label %.lr.ph3259, label %._crit_edge

.lr.ph3259:                                       ; preds = %.lr.ph3268.split
  %i.bk = load ptr, ptr %1, align 8, !tbaa !19
  %i.bl = shl nuw nsw i64 %indvars.iv4182, 3
  ...
  %i.bs = load i64, ptr %i.aj, align 8, !tbaa !44
  ...
  %factor.op.mul3260 = mul i32 %i.bf, %i.cb       ; 3 uses
  ...
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  %lcmp.mod4885 = trunc i32 %i.cg to i1
  br label %bb.d

._crit_edge:                                      ; preds = %.thread2931, %.lr.ph3268.split
  %indvars.iv.next4183 = add nuw nsw i64 %indvars.iv4182, 1 ; 2 uses
  %exitcond4186.not = icmp eq i64 %indvars.iv.next4183, %wide.trip.count4185
  br i1 %exitcond4186.not, label %._crit_edge3269, label %.lr.ph3268.splitthread-pre-split, !llvm.loop !405

bb.d:                                             ; preds = %.lr.ph3259, %.thread2931
  %indvars.iv4178 = phi i64 [ 0, %.lr.ph3259 ], [ %indvars.iv.next4179, %.thread2931 ] ; 6 uses
  %.013063258 = phi ptr [ %i.bu, %.lr.ph3259 ], [ %.31309, %.thread2931 ] ; 15 uses
  %i.dd = load ptr, ptr %i.g, align 8, !tbaa !66  ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.df = load <8 x float>, ptr %i.de, align 1, !tbaa !45
...
_ZN4ncnn3MatD2Ev.exit1515:                        ; preds = %bb.e, %bb.d
  ...
  %i.dg = load ptr, ptr %2, align 8, !tbaa !19, !noalias !485
  %i.dh = load i64, ptr %i.ak, align 8, !tbaa !20, !noalias !485
  %i.di = mul i64 %i.dh, %i.bz
  %i.dj = load i64, ptr %i.al, align 8, !tbaa !44, !noalias !485
  %i.dk = mul i64 %i.di, %i.dj
  %i.dl = getelementptr inbounds nuw i8, ptr %i.dg, i64 %i.dk ; 2 uses
  br i1 %i.ca, label %.lr.ph3103, label %.preheader3037

.lr.ph3103:                                       ; preds = %_ZN4ncnn3MatD2Ev.exit1515
  %i.dm = load ptr, ptr %0, align 8, !tbaa !19
  %i.dn = load i32, ptr %i.p, align 4, !tbaa !55
  %i.do = sext i32 %i.dn to i64
  %i.dp = load i64, ptr %i.am, align 8, !tbaa !44
  %factor.op.mul = mul i64 %i.dp, %i.do
  %i.dq = trunc nuw nsw i64 %indvars.iv4178 to i32
  %.reass3261 = mul i32 %factor.op.mul3260, %i.dq
  %i.dr = sext i32 %.reass3261 to i64
...
.preheader3037:                                   ; preds = %.loopexit3029, %_ZN4ncnn3MatD2Ev.exit1515
  %.02755.lcssa = phi <8 x float> [ zeroinitializer, %_ZN4ncnn3MatD2Ev.exit1515 ], [ %.82763, %.loopexit3029 ] ; 2 uses
  %.02734.lcssa = phi <8 x float> [ zeroinitializer, %_ZN4ncnn3MatD2Ev.exit1515 ], [ %.82742, %.loopexit3029 ] ; 2 uses
  %.02711.lcssa = phi <8 x float> [ zeroinitializer, %_ZN4ncnn3MatD2Ev.exit1515 ], [ %.82719, %.loopexit3029 ] ; 2 uses
  %.12687.lcssa = phi <8 x float> [ %.02686, %_ZN4ncnn3MatD2Ev.exit1515 ], [ %.92695, %.loopexit3029 ] ; 2 uses
  %.01340.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1515 ], [ %i.cw, %.loopexit3029 ] ; 3 uses
  %.01311.lcssa = phi ptr [ %i.dl, %_ZN4ncnn3MatD2Ev.exit1515 ], [ %.81319, %.loopexit3029 ] ; 2 uses
  %i.fj = or disjoint i32 %.01340.lcssa, 7
  %i.fk = icmp slt i32 %i.fj, %i.bh
  br i1 %i.fk, label %.lr.ph3158, label %.preheader3036

.lr.ph3158:                                       ; preds = %.preheader3037
  %i.fl = load ptr, ptr %0, align 8, !tbaa !19
  %i.fm = load i32, ptr %i.p, align 4, !tbaa !55
  %i.fn = sext i32 %i.fm to i64
  %i.fo = load i64, ptr %i.am, align 8, !tbaa !44
  %factor.op.mul3165 = mul i64 %i.fo, %i.fn
  %i.fp = trunc nuw nsw i64 %indvars.iv4178 to i32
  %.reass3263 = mul i32 %factor.op.mul3260, %i.fp
  %i.fq = sext i32 %.reass3263 to i64
  %invariant.gep3167 = getelementptr [2 x i8], ptr %i.fl, i64 %i.fq
...
bb.f:                                             ; preds = %.lr.ph3103, %.loopexit3029
  %.013113102 = phi ptr [ %i.dl, %.lr.ph3103 ], [ %.81319, %.loopexit3029 ] ; 13 uses
  %.013403101 = phi i32 [ 0, %.lr.ph3103 ], [ %i.ahg, %.loopexit3029 ] ; 2 uses
  %.126873100 = phi <8 x float> [ %.02686, %.lr.ph3103 ], [ %.92695, %.loopexit3029 ] ; 9 uses
  %.027113099 = phi <8 x float> [ zeroinitializer, %.lr.ph3103 ], [ %.82719, %.loopexit3029 ] ; 9 uses
  %.027343098 = phi <8 x float> [ zeroinitializer, %.lr.ph3103 ], [ %.82742, %.loopexit3029 ] ; 9 uses
  %.027553097 = phi <8 x float> [ zeroinitializer, %.lr.ph3103 ], [ %.82763, %.loopexit3029 ] ; 9 uses
  %i.gq = sdiv i32 %.013403101, %i.bf
  %i.gr = sext i32 %i.gq to i64
  %.reass = mul i64 %factor.op.mul, %i.gr
  %gep = getelementptr i8, ptr %invariant.gep, i64 %.reass ; 8 uses
  br i1 %i.cc, label %.preheader3032, label %.loopexit3033

.preheader3032:                                   ; preds = %bb.f
  br i1 %i.dt, label %.lr.ph, label %.loopexit3029

.lr.ph:                                           ; preds = %.preheader3032, %.lr.ph
  %.113123046 = phi ptr [ %i.mj, %.lr.ph ], [ %.013113102, %.preheader3032 ] ; 17 uses
  %.013453045 = phi ptr [ %i.mi, %.lr.ph ], [ %gep, %.preheader3032 ] ; 2 uses
  %.013523044 = phi i32 [ %i.mk, %.lr.ph ], [ 0, %.preheader3032 ]
  %.226883043 = phi <8 x float> [ %i.ly, %.lr.ph ], [ %.126873100, %.preheader3032 ]
  %.127123042 = phi <8 x float> [ %i.mb, %.lr.ph ], [ %.027113099, %.preheader3032 ]
  %.127353041 = phi <8 x float> [ %i.me, %.lr.ph ], [ %.027343098, %.preheader3032 ]
  %.127563040 = phi <8 x float> [ %i.mh, %.lr.ph ], [ %.027553097, %.preheader3032 ]
  %i.gs = load <8 x i16>, ptr %.113123046, align 16, !tbaa !45 ; 2 uses
  ...
  %i.gx = getelementptr inbounds nuw i8, ptr %.113123046, i64 16
  %i.gy = load <8 x i16>, ptr %i.gx, align 16, !tbaa !45 ; 2 uses
  ...
  %i.hd = getelementptr inbounds nuw i8, ptr %.113123046, i64 32
  %i.he = load <8 x i16>, ptr %i.hd, align 16, !tbaa !45 ; 2 uses
  ...
  %i.hj = getelementptr inbounds nuw i8, ptr %.113123046, i64 48
  %i.hk = load <8 x i16>, ptr %i.hj, align 16, !tbaa !45 ; 2 uses
  ...
  %i.hp = getelementptr inbounds nuw i8, ptr %.113123046, i64 64
  %i.hq = load <8 x i16>, ptr %i.hp, align 16, !tbaa !45 ; 2 uses
  ...
  %i.hv = getelementptr inbounds nuw i8, ptr %.113123046, i64 80
  %i.hw = load <8 x i16>, ptr %i.hv, align 16, !tbaa !45 ; 2 uses
...
begin_hunk_10_@_ZN4ncnnL26convolution1d_packed_bf16sERKNS_3MatERS0_S2_S2_iiiiS2_RKNS_6OptionE:bb.a
  ...
  %i.amx = getelementptr inbounds nuw i8, ptr %.1213233131, i64 112
  %i.amy = load <8 x i16>, ptr %i.amx, align 16, !tbaa !45 ; 2 uses
  ...
  %i.and = load <4 x i16>, ptr %.214343130, align 2, !tbaa !70
  %i.ane = load <4 x i16>, ptr %.014383129, align 2, !tbaa !70
  ...
  %i.ank = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.alm, <8 x float> nofpclass(nan inf) %i.anj, <8 x float> nofpclass(nan inf) %.1326993127)
  ...
  %i.ann = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.als, <8 x float> nofpclass(nan inf) %i.anm, <8 x float> nofpclass(nan inf) %.1227233126)
  ...
  %i.anq = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.aly, <8 x float> nofpclass(nan inf) %i.anp, <8 x float> nofpclass(nan inf) %.1227463125)
  ...
  %i.ant = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.ame, <8 x float> nofpclass(nan inf) %i.ans, <8 x float> nofpclass(nan inf) %.1227673124)
  ...
  %i.aog = getelementptr inbounds [2 x i8], ptr %.214343130, i64 %i.fz
  %i.aoh = getelementptr inbounds [2 x i8], ptr %.014383129, i64 %i.fz
  %i.aoi = getelementptr inbounds nuw i8, ptr %.1213233131, i64 128
  %i.aoj = add nuw nsw i32 %.014393128, 1         ; 2 uses
  %exitcond4158.not = icmp eq i32 %i.aoj, %i.fr
...
.preheader3023:                                   ; preds = %.loopexit3025
  br i1 %i.fs, label %.lr.ph3146, label %.loopexit3024

.lr.ph3146:                                       ; preds = %.preheader3023, %.lr.ph3146
  %.1413253145 = phi ptr [ %i.asr, %.lr.ph3146 ], [ %.913203157, %.preheader3023 ] ; 9 uses
  %.414363144 = phi ptr [ %i.asq, %.lr.ph3146 ], [ %gep3168, %.preheader3023 ] ; 9 uses
  %.014403143 = phi i32 [ %i.ass, %.lr.ph3146 ], [ 0, %.preheader3023 ]
  %.1527013142 = phi <8 x float> [ %i.arr, %.lr.ph3146 ], [ %.1026963155, %.preheader3023 ]
  %.1427253141 = phi <8 x float> [ %i.arz, %.lr.ph3146 ], [ %.927203154, %.preheader3023 ]
  %.1427483140 = phi <8 x float> [ %i.ash, %.lr.ph3146 ], [ %.927433153, %.preheader3023 ]
  %.1427693139 = phi <8 x float> [ %i.asp, %.lr.ph3146 ], [ %.927643152, %.preheader3023 ]
  %i.aok = load <8 x i16>, ptr %.1413253145, align 16, !tbaa !45 ; 2 uses
  ...
  %i.aop = getelementptr inbounds nuw i8, ptr %.1413253145, i64 16
  %i.aoq = load <8 x i16>, ptr %i.aop, align 16, !tbaa !45 ; 2 uses
  ...
  %i.aov = getelementptr inbounds nuw i8, ptr %.1413253145, i64 32
  %i.aow = load <8 x i16>, ptr %i.aov, align 16, !tbaa !45 ; 2 uses
  ...
  %i.apb = getelementptr inbounds nuw i8, ptr %.1413253145, i64 48
  %i.apc = load <8 x i16>, ptr %i.apb, align 16, !tbaa !45 ; 2 uses
  ...
  %i.aph = getelementptr inbounds nuw i8, ptr %.1413253145, i64 64
  %i.api = load <8 x i16>, ptr %i.aph, align 16, !tbaa !45 ; 2 uses
  ...
  %i.apn = getelementptr inbounds nuw i8, ptr %.1413253145, i64 80
  %i.apo = load <8 x i16>, ptr %i.apn, align 16, !tbaa !45 ; 2 uses
  ...
  %i.apt = getelementptr inbounds nuw i8, ptr %.1413253145, i64 96
  %i.apu = load <8 x i16>, ptr %i.apt, align 16, !tbaa !45 ; 2 uses
  ...
  %i.apz = getelementptr inbounds nuw i8, ptr %.1413253145, i64 112
  %i.aqa = load <8 x i16>, ptr %i.apz, align 16, !tbaa !45 ; 2 uses
  ...
  %i.aqf = load i16, ptr %.414363144, align 2, !tbaa !70
  ...
  %i.aql = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.aoo, <8 x float> nofpclass(nan inf) %i.aqk, <8 x float> nofpclass(nan inf) %.1527013142)
  %i.aqm = getelementptr inbounds [2 x i8], ptr %.414363144, i64 %i.fx
  %i.aqn = load i16, ptr %i.aqm, align 2, !tbaa !70
  ...
  %i.aqt = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.aou, <8 x float> nofpclass(nan inf) %i.aqs, <8 x float> nofpclass(nan inf) %.1427253141)
  %i.aqu = getelementptr inbounds [2 x i8], ptr %.414363144, i64 %i.gb
  %i.aqv = load i16, ptr %i.aqu, align 2, !tbaa !70
  ...
  %i.arb = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.apa, <8 x float> nofpclass(nan inf) %i.ara, <8 x float> nofpclass(nan inf) %.1427483140)
  %i.arc = getelementptr inbounds [2 x i8], ptr %.414363144, i64 %i.gd
  %i.ard = load i16, ptr %i.arc, align 2, !tbaa !70
  ...
  %i.arj = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.apg, <8 x float> nofpclass(nan inf) %i.ari, <8 x float> nofpclass(nan inf) %.1427693139)
  %i.ark = getelementptr inbounds [2 x i8], ptr %.414363144, i64 %i.gf
  %i.arl = load i16, ptr %i.ark, align 2, !tbaa !70
  ...
  %i.ars = getelementptr inbounds [2 x i8], ptr %.414363144, i64 %i.gh
  %i.art = load i16, ptr %i.ars, align 2, !tbaa !70
  ...
  %i.asa = getelementptr inbounds [2 x i8], ptr %.414363144, i64 %i.gj
  %i.asb = load i16, ptr %i.asa, align 2, !tbaa !70
  ...
  %i.asi = getelementptr inbounds [2 x i8], ptr %.414363144, i64 %i.gl
  %i.asj = load i16, ptr %i.asi, align 2, !tbaa !70
  ...
  %i.asq = getelementptr inbounds [2 x i8], ptr %.414363144, i64 %i.gm
  %i.asr = getelementptr inbounds nuw i8, ptr %.1413253145, i64 128
  %i.ass = add nuw nsw i32 %.014403143, 1         ; 2 uses
  %exitcond4161.not = icmp eq i32 %i.ass, %i.fr
...
.loopexit3024.loopexit:                           ; preds = %.lr.ph3146
  ...
  %scevgep4160 = getelementptr i8, ptr %scevgep4159, i64 %i.gp
  br label %.loopexit3024
...
.loopexit3024:                                    ; preds = %.preheader3026, %.loopexit3027.loopexit, %bb.j, %.loopexit3025.loopexit, %.loopexit3024.loopexit, %.preheader3023, %.loopexit3025
  %.152770 = phi nsz <8 x float> [ %.927643152, %.loopexit3025 ], [ %.927643152, %.preheader3023 ], [ %i.asp, %.loopexit3024.loopexit ], [ %.927643152, %bb.j ], [ %i.aof, %.loopexit3025.loopexit ], [ %i.ald, %.loopexit3027.loopexit ], [ %.927643152, %.preheader3026 ] ; 2 uses
  %.152749 = phi nsz <8 x float> [ %.927433153, %.loopexit3025 ], [ %.927433153, %.preheader3023 ], [ %i.ash, %.loopexit3024.loopexit ], [ %.927433153, %bb.j ], [ %i.aoc, %.loopexit3025.loopexit ], [ %i.ala, %.loopexit3027.loopexit ], [ %.927433153, %.preheader3026 ] ; 2 uses
  %.152726 = phi nsz <8 x float> [ %.927203154, %.loopexit3025 ], [ %.927203154, %.preheader3023 ], [ %i.arz, %.loopexit3024.loopexit ], [ %.927203154, %bb.j ], [ %i.anz, %.loopexit3025.loopexit ], [ %i.akx, %.loopexit3027.loopexit ], [ %.927203154, %.preheader3026 ] ; 2 uses
  %.162702 = phi nsz <8 x float> [ %.1026963155, %.loopexit3025 ], [ %.1026963155, %.preheader3023 ], [ %i.arr, %.loopexit3024.loopexit ], [ %.1026963155, %bb.j ], [ %i.anw, %.loopexit3025.loopexit ], [ %i.aku, %.loopexit3027.loopexit ], [ %.1026963155, %.preheader3026 ] ; 2 uses
  ...
  %i.ast = add nuw nsw i32 %.113413156, 8         ; 3 uses
  %i.asu = or disjoint i32 %i.ast, 7
  %i.asv = icmp slt i32 %i.asu, %i.bh
  br i1 %i.asv, label %bb.i, label %.preheader3036, !llvm.loop !416
...
.preheader3035:                                   ; preds = %.loopexit3020, %.preheader3036
  ...
  %.21342.lcssa = phi i32 [ %.11341.lcssa, %.preheader3036 ], [ %i.ayo, %.loopexit3020 ] ; 6 uses
  ...
  br i1 %i.asx, label %.lr.ph3226, label %.preheader3034

.lr.ph3226:                                       ; preds = %.preheader3035
  %i.asy = load ptr, ptr %0, align 8, !tbaa !19
  %i.asz = load i32, ptr %i.p, align 4, !tbaa !55
  %i.ata = sext i32 %i.asz to i64
  %i.atb = load i64, ptr %i.am, align 8, !tbaa !44
  %factor.op.mul3231 = mul i64 %i.atb, %i.ata
  %i.atc = mul nsw i64 %indvars.iv4178, %i.db
  %invariant.gep3233 = getelementptr [2 x i8], ptr %i.asy, i64 %i.atc
...
.lr.ph3226.split.preheader:                       ; preds = %.lr.ph3226
  ...
  %10 = add i32 %.21342.lcssa, 3
  %smax = call i32 @llvm.smax.i32(i32 %i.bh, i32 %10)
  %11 = add i32 %smax, -2
  %i.ati = sub i32 %11, %.21342.lcssa
...
.lr.ph3218.us:                                    ; preds = %.lr.ph3218.us.preheader, %._crit_edge.us
  %indvars.iv = phi i64 [ %i.atl, %.lr.ph3218.us.preheader ], [ %indvars.iv.next, %._crit_edge.us ] ; 2 uses
  %.2113323225.us = phi ptr [ %.161327.lcssa, %.lr.ph3218.us.preheader ], [ %scevgep4169, %._crit_edge.us ] ; 2 uses
  %.2227083223.us = phi <8 x float> [ %.172703.lcssa, %.lr.ph3218.us.preheader ], [ %i.aud, %._crit_edge.us ]
  %.2127323222.us = phi <8 x float> [ %.162727.lcssa, %.lr.ph3218.us.preheader ], [ %i.aul, %._crit_edge.us ]
...
bb.k:                                             ; preds = %.lr.ph3218.us, %bb.k
  %.2213333217.us = phi ptr [ %.2113323225.us, %.lr.ph3218.us ], [ %i.aun, %bb.k ] ; 3 uses
  %.014463216.us = phi ptr [ %gep3234.us, %.lr.ph3218.us ], [ %i.aum, %bb.k ] ; 3 uses
  %.014473215.us = phi i32 [ 0, %.lr.ph3218.us ], [ %i.auo, %bb.k ]
  %.2327093214.us = phi <8 x float> [ %.2227083223.us, %.lr.ph3218.us ], [ %i.aud, %bb.k ]
  %.2227333213.us = phi <8 x float> [ %.2127323222.us, %.lr.ph3218.us ], [ %i.aul, %bb.k ]
  %i.atm = load <8 x i16>, ptr %.2213333217.us, align 16, !tbaa !45 ; 2 uses
  ...
  %i.atr = getelementptr inbounds nuw i8, ptr %.2213333217.us, i64 16
  %i.ats = load <8 x i16>, ptr %i.atr, align 16, !tbaa !45 ; 2 uses
  ...
  %i.atx = load i16, ptr %.014463216.us, align 2, !tbaa !70
  ...
  %i.aud = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.atq, <8 x float> nofpclass(nan inf) %i.auc, <8 x float> nofpclass(nan inf) %.2327093214.us) ; 3 uses
  %i.aue = getelementptr inbounds [2 x i8], ptr %.014463216.us, i64 %i.ate
  %i.auf = load i16, ptr %i.aue, align 2, !tbaa !70
  ...
  %i.aul = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.atw, <8 x float> nofpclass(nan inf) %i.auk, <8 x float> nofpclass(nan inf) %.2227333213.us) ; 3 uses
  %i.aum = getelementptr inbounds [2 x i8], ptr %.014463216.us, i64 %i.atg
  %i.aun = getelementptr inbounds nuw i8, ptr %.2213333217.us, i64 32
  %i.auo = add nuw nsw i32 %.014473215.us, 1      ; 2 uses
  %exitcond4170.not = icmp eq i32 %i.auo, %i.cg
...
._crit_edge.us:                                   ; preds = %bb.k
  ...
  %scevgep4169 = getelementptr i8, ptr %scevgep4168, i64 %i.cz ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 2 ; 3 uses
  %i.aup = trunc i64 %indvars.iv.next to i32
  %i.auq = or i32 %i.aup, 1
  %i.aur = icmp slt i32 %i.auq, %i.bh
  br i1 %i.aur, label %.lr.ph3218.us, label %.preheader3034.loopexit, !llvm.loop !418

bb.l:                                             ; preds = %.lr.ph3202, %.loopexit3020
  %.1613273201 = phi ptr [ %.91320.lcssa, %.lr.ph3202 ], [ %.201331, %.loopexit3020 ] ; 7 uses
  %.213423200 = phi i32 [ %.11341.lcssa, %.lr.ph3202 ], [ %i.ayo, %.loopexit3020 ] ; 2 uses
  ...
  %i.aus = sdiv i32 %.213423200, %i.bf
  %i.aut = sext i32 %i.aus to i64
  %.reass3210 = mul i64 %factor.op.mul3209, %i.aut
...
.preheader3021:                                   ; preds = %bb.l
  br i1 %i.ahs, label %.lr.ph3176, label %.loopexit3020

.lr.ph3176:                                       ; preds = %.preheader3021, %.lr.ph3176
  %.1713283175 = phi ptr [ %i.awh, %.lr.ph3176 ], [ %.1613273201, %.preheader3021 ] ; 5 uses
  %.014413174 = phi ptr [ %i.awg, %.lr.ph3176 ], [ %gep3212, %.preheader3021 ] ; 2 uses
  %.014443173 = phi i32 [ %i.awi, %.lr.ph3176 ], [ 0, %.preheader3021 ]
  %.1827043172 = phi <8 x float> [ %i.avw, %.lr.ph3176 ], [ %.1727033199, %.preheader3021 ]
  %.1727283171 = phi <8 x float> [ %i.avz, %.lr.ph3176 ], [ %.1627273198, %.preheader3021 ]
  %.1727513170 = phi <8 x float> [ %i.awc, %.lr.ph3176 ], [ %.1627503197, %.preheader3021 ]
  %.1727723169 = phi <8 x float> [ %i.awf, %.lr.ph3176 ], [ %.1627713196, %.preheader3021 ]
  %i.auu = load <8 x i16>, ptr %.1713283175, align 16, !tbaa !45 ; 2 uses
  ...
  %i.auz = getelementptr inbounds nuw i8, ptr %.1713283175, i64 16
  %i.ava = load <8 x i16>, ptr %i.auz, align 16, !tbaa !45 ; 2 uses
  ...
  %i.avf = getelementptr inbounds nuw i8, ptr %.1713283175, i64 32
  %i.avg = load <8 x i16>, ptr %i.avf, align 16, !tbaa !45 ; 2 uses
  ...
  %i.avl = getelementptr inbounds nuw i8, ptr %.1713283175, i64 48
  %i.avm = load <8 x i16>, ptr %i.avl, align 16, !tbaa !45 ; 2 uses
  ...
  %i.avr = load <4 x i16>, ptr %.014413174, align 2, !tbaa !70
  ...
  %i.avw = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.auy, <8 x float> nofpclass(nan inf) %i.avv, <8 x float> nofpclass(nan inf) %.1827043172) ; 2 uses
  ...
  %i.avz = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.ave, <8 x float> nofpclass(nan inf) %i.avy, <8 x float> nofpclass(nan inf) %.1727283171) ; 2 uses
  ...
  %i.awc = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.avk, <8 x float> nofpclass(nan inf) %i.awb, <8 x float> nofpclass(nan inf) %.1727513170) ; 2 uses
  ...
  %i.awf = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.avq, <8 x float> nofpclass(nan inf) %i.awe, <8 x float> nofpclass(nan inf) %.1727723169) ; 2 uses
  %i.awg = getelementptr inbounds [2 x i8], ptr %.014413174, i64 %i.ahv
  %i.awh = getelementptr inbounds nuw i8, ptr %.1713283175, i64 64
  %i.awi = add nuw nsw i32 %.014443173, 1         ; 2 uses
  %exitcond4164.not = icmp eq i32 %i.awi, %i.ahr
...
.loopexit3022.loopexit:                           ; preds = %.lr.ph3176
  ...
  %scevgep4163 = getelementptr i8, ptr %scevgep4162, i64 %i.aif
...
.preheader3019:                                   ; preds = %.loopexit3022
  br i1 %i.ahs, label %.lr.ph3190, label %.loopexit3020

.lr.ph3190:                                       ; preds = %.preheader3019, %.lr.ph3190
  %.1913303189 = phi ptr [ %i.aym, %.lr.ph3190 ], [ %.1613273201, %.preheader3019 ] ; 5 uses
  %.214433188 = phi ptr [ %i.ayl, %.lr.ph3190 ], [ %gep3212, %.preheader3019 ] ; 5 uses
  %.014453187 = phi i32 [ %i.ayn, %.lr.ph3190 ], [ 0, %.preheader3019 ]
  %.2027063186 = phi <8 x float> [ %i.axm, %.lr.ph3190 ], [ %.1727033199, %.preheader3019 ]
  %.1927303185 = phi <8 x float> [ %i.axu, %.lr.ph3190 ], [ %.1627273198, %.preheader3019 ]
  %.1927533184 = phi <8 x float> [ %i.ayc, %.lr.ph3190 ], [ %.1627503197, %.preheader3019 ]
  %.1927743183 = phi <8 x float> [ %i.ayk, %.lr.ph3190 ], [ %.1627713196, %.preheader3019 ]
  %i.awj = load <8 x i16>, ptr %.1913303189, align 16, !tbaa !45 ; 2 uses
  ...
  %i.awo = getelementptr inbounds nuw i8, ptr %.1913303189, i64 16
  %i.awp = load <8 x i16>, ptr %i.awo, align 16, !tbaa !45 ; 2 uses
  ...
  %i.awu = getelementptr inbounds nuw i8, ptr %.1913303189, i64 32
  %i.awv = load <8 x i16>, ptr %i.awu, align 16, !tbaa !45 ; 2 uses
  ...
  %i.axa = getelementptr inbounds nuw i8, ptr %.1913303189, i64 48
  %i.axb = load <8 x i16>, ptr %i.axa, align 16, !tbaa !45 ; 2 uses
  ...
  %i.axg = load i16, ptr %.214433188, align 2, !tbaa !70
  ...
  %i.axm = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.awn, <8 x float> nofpclass(nan inf) %i.axl, <8 x float> nofpclass(nan inf) %.2027063186) ; 2 uses
  %i.axn = getelementptr inbounds [2 x i8], ptr %.214433188, i64 %i.ahx
  %i.axo = load i16, ptr %i.axn, align 2, !tbaa !70
  ...
  %i.axu = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.awt, <8 x float> nofpclass(nan inf) %i.axt, <8 x float> nofpclass(nan inf) %.1927303185) ; 2 uses
  %i.axv = getelementptr inbounds [2 x i8], ptr %.214433188, i64 %i.ahz
  %i.axw = load i16, ptr %i.axv, align 2, !tbaa !70
  ...
  %i.ayc = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.awz, <8 x float> nofpclass(nan inf) %i.ayb, <8 x float> nofpclass(nan inf) %.1927533184) ; 2 uses
  %i.ayd = getelementptr inbounds [2 x i8], ptr %.214433188, i64 %i.aib
  %i.aye = load i16, ptr %i.ayd, align 2, !tbaa !70
...
begin_hunk_11_@_ZN4ncnnL26convolution1d_packed_bf16sERKNS_3MatERS0_S2_S2_iiiiS2_RKNS_6OptionE:bb.a
  ...
  %.neg2969 = fmul fast <8 x float> %i.bep, splat (float -2.000000e+00)
  %i.beq = select fast <8 x i1> %i.bdl, <8 x float> splat (float +nan(0x3FFFFF)), <8 x float> %.neg2969
...
bb.r:                                             ; preds = %._crit_edge3249
  %i.bfs = load ptr, ptr %8, align 8, !tbaa !19   ; 2 uses
  %i.bft = load float, ptr %i.bfs, align 4, !tbaa !48
  ...
  %i.bfx = load float, ptr %i.bfw, align 4, !tbaa !48
...
_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit:      ; preds = %._crit_edge3249, %bb.m, %bb.n, %bb.o, %bb.p, %bb.q, %bb.r
  %.0.i = phi nsz <8 x float> [ %i.bgd, %bb.r ], [ %i.bau, %bb.m ], [ %i.bbc, %bb.n ], [ %i.bbm, %bb.o ], [ %i.bcm, %bb.p ], [ %i.bfr, %bb.q ], [ %i.bat, %._crit_edge3249 ] ; 4 uses
...
.thread:                                          ; preds = %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit
  ...
  store <8 x i16> %i.bgi, ptr %.013063258, align 16, !tbaa !45
  %i.bgj = getelementptr inbounds nuw i8, ptr %.013063258, i64 16
  br label %.thread2931
...
bb.s:                                             ; preds = %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit
  ...
  store i64 %i.bgs, ptr %.013063258, align 1, !tbaa !45
  %i.bgt = getelementptr inbounds [2 x i8], ptr %.013063258, i64 %i.cj
  %i.bgu = extractelement <2 x i64> %i.bgr, i64 1
  store i64 %i.bgu, ptr %i.bgt, align 1, !tbaa !45
  %i.bgv = getelementptr inbounds nuw i8, ptr %.013063258, i64 8
  br label %.thread2931
...
bb.t:                                             ; preds = %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit
  ...
  store i16 %i.bgx, ptr %.013063258, align 2, !tbaa !70
  %i.bgy = extractelement <16 x i16> %i.bgw, i64 3
  %i.bgz = getelementptr inbounds [2 x i8], ptr %.013063258, i64 %i.cj
  store i16 %i.bgy, ptr %i.bgz, align 2, !tbaa !70
  %i.bha = extractelement <16 x i16> %i.bgw, i64 5
  %i.bhb = getelementptr inbounds [2 x i8], ptr %.013063258, i64 %i.cl
  store i16 %i.bha, ptr %i.bhb, align 2, !tbaa !70
  %i.bhc = extractelement <16 x i16> %i.bgw, i64 7
  %i.bhd = getelementptr inbounds [2 x i8], ptr %.013063258, i64 %i.cn
  store i16 %i.bhc, ptr %i.bhd, align 2, !tbaa !70
  %i.bhe = extractelement <16 x i16> %i.bgw, i64 9
  %i.bhf = getelementptr inbounds [2 x i8], ptr %.013063258, i64 %i.cp
  store i16 %i.bhe, ptr %i.bhf, align 2, !tbaa !70
  %i.bhg = extractelement <16 x i16> %i.bgw, i64 11
  %i.bhh = getelementptr inbounds [2 x i8], ptr %.013063258, i64 %i.cr
  store i16 %i.bhg, ptr %i.bhh, align 2, !tbaa !70
  %i.bhi = extractelement <16 x i16> %i.bgw, i64 13
  %i.bhj = getelementptr inbounds [2 x i8], ptr %.013063258, i64 %i.ct
  store i16 %i.bhi, ptr %i.bhj, align 2, !tbaa !70
  %i.bhk = extractelement <16 x i16> %i.bgw, i64 15
  %i.bhl = getelementptr inbounds [2 x i8], ptr %.013063258, i64 %i.cv
  store i16 %i.bhk, ptr %i.bhl, align 2, !tbaa !70
  %i.bhm = getelementptr inbounds nuw i8, ptr %.013063258, i64 2
  br label %.thread2931

.thread2931:                                      ; preds = %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit, %bb.s, %.thread, %bb.t
  %.31309 = phi ptr [ %i.bhm, %bb.t ], [ %.013063258, %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit ], [ %i.bgj, %.thread ], [ %i.bgv, %bb.s ]
  %indvars.iv.next4179 = add nuw nsw i64 %indvars.iv4178, 1 ; 2 uses
  %exitcond4181.not = icmp eq i64 %indvars.iv.next4179, %wide.trip.count
  br i1 %exitcond4181.not, label %._crit_edge, label %bb.d, !llvm.loop !424

._crit_edge3516:                                  ; preds = %._crit_edge3506, %.lr.ph3515, %._crit_edge3269
  ...
  store i32 %i.bhq, ptr %i.h, align 4, !tbaa !58
  %i.bhr = icmp sgt i32 %i.bhp, 1
  br i1 %i.bhr, label %.lr.ph3726, label %._crit_edge3727.split

.lr.ph3726:                                       ; preds = %._crit_edge3516
  %i.bhs = load i32, ptr %i.k, align 8, !tbaa !57 ; 9 uses
  %i.bht = load i32, ptr %i.m, align 8, !tbaa !64
  %i.bhu = mul i32 %i.bht, %i.bhs                 ; 12 uses
  %i.bhv = load i32, ptr %i.s, align 4, !tbaa !55 ; 3 uses
  %i.bhw = load ptr, ptr %1, align 8, !tbaa !19   ; 2 uses
  %i.bhx = sext i32 %i.bhv to i64
  %i.bhy = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.bhz = load i64, ptr %i.bhy, align 8, !tbaa !44
  ...
  br i1 %i.bib, label %.lr.ph3726.split, label %._crit_edge3727.split

.lr.ph3726.split:                                 ; preds = %.lr.ph3726
  %i.bik = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.bil = getelementptr inbounds nuw i8, ptr %2, i64 64
  %i.bim = load ptr, ptr %2, align 8, !tbaa !19, !noalias !486
  %i.bin = load i64, ptr %i.bil, align 8, !tbaa !20, !noalias !486
  %i.bio = load i64, ptr %i.bik, align 8, !tbaa !44, !noalias !486
  %factor.op.mul3729 = mul i64 %i.bin, %i.bio
  %i.bip = and i32 %i.bhu, -16
  %i.biq = sext i32 %i.bho to i64
  %wide.trip.count4285 = zext nneg i32 %i.bhq to i64
  %wide.trip.count4280 = zext nneg i32 %i.bhv to i64
  br label %.lr.ph3716

.lr.ph3515.splitthread-pre-split:                 ; preds = %._crit_edge3506
  %.pr4445 = load i32, ptr %i.s, align 4, !tbaa !55
  br label %.lr.ph3515.split

.lr.ph3515.split:                                 ; preds = %.lr.ph3515.splitthread-pre-split, %.lr.ph3515.split.preheader
  %i.bir = phi i32 [ %.pr4445, %.lr.ph3515.splitthread-pre-split ], [ %i.bb, %.lr.ph3515.split.preheader ] ; 3 uses
  %indvars.iv4232 = phi i64 [ %indvars.iv.next4233, %.lr.ph3515.splitthread-pre-split ], [ 0, %.lr.ph3515.split.preheader ] ; 2 uses
  %i.bis = load i32, ptr %i.k, align 8, !tbaa !57 ; 9 uses
  %i.bit = load i32, ptr %i.m, align 8, !tbaa !64
  %i.biu = mul i32 %i.bit, %i.bis                 ; 12 uses
  %i.biv = load i32, ptr %i.u, align 8, !tbaa !57 ; 2 uses
  %i.biw = icmp sgt i32 %i.bir, 0
  br i1 %i.biw, label %.lr.ph3505, label %._crit_edge3506

.lr.ph3505:                                       ; preds = %.lr.ph3515.split
  %i.bix = load ptr, ptr %1, align 8, !tbaa !19
  %i.biy = shl nuw nsw i64 %indvars.iv4232, 2
  ...
  %i.bjf = load i64, ptr %i.aw, align 8, !tbaa !44
  ...
  %factor.op.mul3507 = mul i32 %i.bis, %i.bju     ; 3 uses
  ...
  %wide.trip.count4230 = zext nneg i32 %i.bir to i64
  %xtraiter4887 = and i32 %i.bjz, 1
  %i.bkn = icmp eq i32 %i.bki, 0
  %unroll_iter4891 = and i32 %i.bjz, 2147483646
  %lcmp.mod4888.not = icmp eq i32 %xtraiter4887, 0
  %lcmp.mod4890 = trunc i32 %i.bjz to i1
  br label %bb.u

._crit_edge3506:                                  ; preds = %bb.ak, %.lr.ph3515.split
  %indvars.iv.next4233 = add nuw nsw i64 %indvars.iv4232, 1 ; 2 uses
  %exitcond4236.not = icmp eq i64 %indvars.iv.next4233, %wide.trip.count4235
  br i1 %exitcond4236.not, label %._crit_edge3516, label %.lr.ph3515.splitthread-pre-split, !llvm.loop !427

bb.u:                                             ; preds = %.lr.ph3505, %bb.ak
  %indvars.iv4227 = phi i64 [ 0, %.lr.ph3505 ], [ %indvars.iv.next4228, %bb.ak ] ; 6 uses
  %.014523503 = phi ptr [ %i.bjh, %.lr.ph3505 ], [ %.21454, %bb.ak ] ; 8 uses
  %i.bko = load ptr, ptr %i.g, align 8, !tbaa !66 ; 2 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.bkq = load <4 x float>, ptr %i.bkp, align 1, !tbaa !45
...
_ZN4ncnn3MatD2Ev.exit1514:                        ; preds = %bb.v, %bb.u
  ...
  %i.bkr = load ptr, ptr %2, align 8, !tbaa !19, !noalias !487
  %i.bks = load i64, ptr %i.ax, align 8, !tbaa !20, !noalias !487
  %i.bkt = mul i64 %i.bks, %i.bjs
  %i.bku = load i64, ptr %i.ay, align 8, !tbaa !44, !noalias !487
  %i.bkv = mul i64 %i.bkt, %i.bku
  %i.bkw = getelementptr inbounds nuw i8, ptr %i.bkr, i64 %i.bkv ; 2 uses
  br i1 %i.bjt, label %.lr.ph3339, label %.preheader3018

.lr.ph3339:                                       ; preds = %_ZN4ncnn3MatD2Ev.exit1514
  %i.bkx = load ptr, ptr %0, align 8, !tbaa !19
  %i.bky = load i32, ptr %i.p, align 4, !tbaa !55
  %i.bkz = sext i32 %i.bky to i64
  %i.bla = load i64, ptr %i.az, align 8, !tbaa !44
  %factor.op.mul3346 = mul i64 %i.bla, %i.bkz
  %i.blb = trunc nuw nsw i64 %indvars.iv4227 to i32
  %.reass3508 = mul i32 %factor.op.mul3507, %i.blb
  %i.blc = sext i32 %.reass3508 to i64
  %invariant.gep3348 = getelementptr [2 x i8], ptr %i.bkx, i64 %i.blc
...
.preheader3018:                                   ; preds = %.loopexit3010, %_ZN4ncnn3MatD2Ev.exit1514
  %.02858.lcssa = phi <4 x float> [ zeroinitializer, %_ZN4ncnn3MatD2Ev.exit1514 ], [ %.82866, %.loopexit3010 ] ; 2 uses
  %.02830.lcssa = phi <4 x float> [ zeroinitializer, %_ZN4ncnn3MatD2Ev.exit1514 ], [ %.82838, %.loopexit3010 ] ; 2 uses
  %.02807.lcssa = phi <4 x float> [ zeroinitializer, %_ZN4ncnn3MatD2Ev.exit1514 ], [ %.82815, %.loopexit3010 ] ; 2 uses
  %.12782.lcssa = phi <4 x float> [ %.02781, %_ZN4ncnn3MatD2Ev.exit1514 ], [ %.92790, %.loopexit3010 ] ; 2 uses
  %.01481.lcssa = phi i32 [ 0, %_ZN4ncnn3MatD2Ev.exit1514 ], [ %i.bkh, %.loopexit3010 ] ; 3 uses
  %.01456.lcssa = phi ptr [ %i.bkw, %_ZN4ncnn3MatD2Ev.exit1514 ], [ %.81464, %.loopexit3010 ] ; 2 uses
  %i.bmu = or disjoint i32 %.01481.lcssa, 7
  %i.bmv = icmp slt i32 %i.bmu, %i.biu
  br i1 %i.bmv, label %.lr.ph3399, label %.preheader3017

.lr.ph3399:                                       ; preds = %.preheader3018
  %i.bmw = load ptr, ptr %0, align 8, !tbaa !19
  %i.bmx = load i32, ptr %i.p, align 4, !tbaa !55
  %i.bmy = sext i32 %i.bmx to i64
  %i.bmz = load i64, ptr %i.az, align 8, !tbaa !44
  %factor.op.mul3406 = mul i64 %i.bmz, %i.bmy
  %i.bna = trunc nuw nsw i64 %indvars.iv4227 to i32
  %.reass3510 = mul i32 %factor.op.mul3507, %i.bna
  %i.bnb = sext i32 %.reass3510 to i64
  %invariant.gep3408 = getelementptr [2 x i8], ptr %i.bmw, i64 %i.bnb
...
bb.w:                                             ; preds = %.lr.ph3339, %.loopexit3010
  %.014563338 = phi ptr [ %i.bkw, %.lr.ph3339 ], [ %.81464, %.loopexit3010 ] ; 13 uses
  %.014813337 = phi i32 [ 0, %.lr.ph3339 ], [ %i.cor, %.loopexit3010 ] ; 2 uses
  %.127823336 = phi <4 x float> [ %.02781, %.lr.ph3339 ], [ %.92790, %.loopexit3010 ] ; 9 uses
  %.028073335 = phi <4 x float> [ zeroinitializer, %.lr.ph3339 ], [ %.82815, %.loopexit3010 ] ; 9 uses
  %.028303334 = phi <4 x float> [ zeroinitializer, %.lr.ph3339 ], [ %.82838, %.loopexit3010 ] ; 9 uses
  %.028583333 = phi <4 x float> [ zeroinitializer, %.lr.ph3339 ], [ %.82866, %.loopexit3010 ] ; 9 uses
  %i.bob = sdiv i32 %.014813337, %i.bis
  %i.boc = sext i32 %i.bob to i64
  %.reass3347 = mul i64 %factor.op.mul3346, %i.boc
  %gep3349 = getelementptr i8, ptr %invariant.gep3348, i64 %.reass3347 ; 8 uses
  br i1 %i.bjv, label %.preheader3013, label %.loopexit3014

.preheader3013:                                   ; preds = %bb.w
  br i1 %i.ble, label %.lr.ph3279, label %.loopexit3010

.lr.ph3279:                                       ; preds = %.preheader3013, %.lr.ph3279
  %.114573278 = phi ptr [ %i.btu, %.lr.ph3279 ], [ %.014563338, %.preheader3013 ] ; 17 uses
  %.014863277 = phi ptr [ %i.btt, %.lr.ph3279 ], [ %gep3349, %.preheader3013 ] ; 2 uses
  %.014933276 = phi i32 [ %i.btv, %.lr.ph3279 ], [ 0, %.preheader3013 ]
  %.227833275 = phi <4 x float> [ %i.btj, %.lr.ph3279 ], [ %.127823336, %.preheader3013 ]
  %.128083274 = phi <4 x float> [ %i.btm, %.lr.ph3279 ], [ %.028073335, %.preheader3013 ]
  %.128313273 = phi <4 x float> [ %i.btp, %.lr.ph3279 ], [ %.028303334, %.preheader3013 ]
  %.128593272 = phi <4 x float> [ %i.bts, %.lr.ph3279 ], [ %.028583333, %.preheader3013 ]
  %i.bod = load i64, ptr %.114573278, align 1, !tbaa !45
  ...
  %i.boi = getelementptr inbounds nuw i8, ptr %.114573278, i64 8
  %i.boj = load i64, ptr %i.boi, align 1, !tbaa !45
  ...
  %i.boo = getelementptr inbounds nuw i8, ptr %.114573278, i64 16
  %i.bop = load i64, ptr %i.boo, align 1, !tbaa !45
  ...
  %i.bou = getelementptr inbounds nuw i8, ptr %.114573278, i64 24
  %i.bov = load i64, ptr %i.bou, align 1, !tbaa !45
  ...
  %i.bpa = getelementptr inbounds nuw i8, ptr %.114573278, i64 32
  %i.bpb = load i64, ptr %i.bpa, align 1, !tbaa !45
  ...
  %i.bpg = getelementptr inbounds nuw i8, ptr %.114573278, i64 40
  %i.bph = load i64, ptr %i.bpg, align 1, !tbaa !45
...
begin_hunk_12_@_ZN4ncnnL26convolution1d_packed_bf16sERKNS_3MatERS0_S2_S2_iiiiS2_RKNS_6OptionE:bb.a
  ...
  %i.cui = getelementptr inbounds nuw i8, ptr %.1214683368, i64 56
  %i.cuj = load i64, ptr %i.cui, align 1, !tbaa !45
  ...
  %i.cuo = load <4 x i16>, ptr %.214253369, align 2, !tbaa !70
  %i.cup = load <4 x i16>, ptr %.014213370, align 2, !tbaa !70
  ...
  %i.cuv = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.csx, <4 x float> nofpclass(nan inf) %i.cuu, <4 x float> nofpclass(nan inf) %.1327943367)
  ...
  %i.cuy = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ctd, <4 x float> nofpclass(nan inf) %i.cux, <4 x float> nofpclass(nan inf) %.1228193366)
  ...
  %i.cvb = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ctj, <4 x float> nofpclass(nan inf) %i.cva, <4 x float> nofpclass(nan inf) %.1228423365)
  ...
  %i.cve = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ctp, <4 x float> nofpclass(nan inf) %i.cvd, <4 x float> nofpclass(nan inf) %.1228703364)
  ...
  %i.cvr = getelementptr inbounds [2 x i8], ptr %.214253369, i64 %i.bnk
  %i.cvs = getelementptr inbounds [2 x i8], ptr %.014213370, i64 %i.bnk
  %i.cvt = getelementptr inbounds nuw i8, ptr %.1214683368, i64 64
  %i.cvu = add nuw nsw i32 %.014203371, 1         ; 2 uses
  %exitcond4204.not = icmp eq i32 %i.cvu, %i.bnc
...
.loopexit3006:                                    ; preds = %.loopexit3008
  br i1 %i.bjy, label %.preheader3004, label %.loopexit3005

.preheader3004:                                   ; preds = %.loopexit3006
  br i1 %i.bnd, label %.lr.ph3387, label %.loopexit3005

.lr.ph3387:                                       ; preds = %.preheader3004, %.lr.ph3387
  %.014193386 = phi i32 [ %i.dad, %.lr.ph3387 ], [ 0, %.preheader3004 ]
  %.414273385 = phi ptr [ %i.dab, %.lr.ph3387 ], [ %gep3409, %.preheader3004 ] ; 9 uses
  %.1414703384 = phi ptr [ %i.dac, %.lr.ph3387 ], [ %.914653398, %.preheader3004 ] ; 9 uses
  %.1527963383 = phi <4 x float> [ %i.czc, %.lr.ph3387 ], [ %.1027913396, %.preheader3004 ]
  %.1428213382 = phi <4 x float> [ %i.czk, %.lr.ph3387 ], [ %.928163395, %.preheader3004 ]
  %.1428443381 = phi <4 x float> [ %i.czs, %.lr.ph3387 ], [ %.928393394, %.preheader3004 ]
  %.1428723380 = phi <4 x float> [ %i.daa, %.lr.ph3387 ], [ %.928673393, %.preheader3004 ]
  %i.cvv = load i64, ptr %.1414703384, align 1, !tbaa !45
  ...
  %i.cwa = getelementptr inbounds nuw i8, ptr %.1414703384, i64 8
  %i.cwb = load i64, ptr %i.cwa, align 1, !tbaa !45
  ...
  %i.cwg = getelementptr inbounds nuw i8, ptr %.1414703384, i64 16
  %i.cwh = load i64, ptr %i.cwg, align 1, !tbaa !45
  ...
  %i.cwm = getelementptr inbounds nuw i8, ptr %.1414703384, i64 24
  %i.cwn = load i64, ptr %i.cwm, align 1, !tbaa !45
  ...
  %i.cws = getelementptr inbounds nuw i8, ptr %.1414703384, i64 32
  %i.cwt = load i64, ptr %i.cws, align 1, !tbaa !45
  ...
  %i.cwy = getelementptr inbounds nuw i8, ptr %.1414703384, i64 40
  %i.cwz = load i64, ptr %i.cwy, align 1, !tbaa !45
  ...
  %i.cxe = getelementptr inbounds nuw i8, ptr %.1414703384, i64 48
  %i.cxf = load i64, ptr %i.cxe, align 1, !tbaa !45
  ...
  %i.cxk = getelementptr inbounds nuw i8, ptr %.1414703384, i64 56
  %i.cxl = load i64, ptr %i.cxk, align 1, !tbaa !45
  ...
  %i.cxq = load i16, ptr %.414273385, align 2, !tbaa !70
  ...
  %i.cxw = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cvz, <4 x float> nofpclass(nan inf) %i.cxv, <4 x float> nofpclass(nan inf) %.1527963383)
  %i.cxx = getelementptr inbounds [2 x i8], ptr %.414273385, i64 %i.bni
  %i.cxy = load i16, ptr %i.cxx, align 2, !tbaa !70
  ...
  %i.cye = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cwf, <4 x float> nofpclass(nan inf) %i.cyd, <4 x float> nofpclass(nan inf) %.1428213382)
  %i.cyf = getelementptr inbounds [2 x i8], ptr %.414273385, i64 %i.bnm
  %i.cyg = load i16, ptr %i.cyf, align 2, !tbaa !70
  ...
  %i.cym = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cwl, <4 x float> nofpclass(nan inf) %i.cyl, <4 x float> nofpclass(nan inf) %.1428443381)
  %i.cyn = getelementptr inbounds [2 x i8], ptr %.414273385, i64 %i.bno
  %i.cyo = load i16, ptr %i.cyn, align 2, !tbaa !70
  ...
  %i.cyu = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.cwr, <4 x float> nofpclass(nan inf) %i.cyt, <4 x float> nofpclass(nan inf) %.1428723380)
  %i.cyv = getelementptr inbounds [2 x i8], ptr %.414273385, i64 %i.bnq
  %i.cyw = load i16, ptr %i.cyv, align 2, !tbaa !70
  ...
  %i.czd = getelementptr inbounds [2 x i8], ptr %.414273385, i64 %i.bns
  %i.cze = load i16, ptr %i.czd, align 2, !tbaa !70
  ...
  %i.czl = getelementptr inbounds [2 x i8], ptr %.414273385, i64 %i.bnu
  %i.czm = load i16, ptr %i.czl, align 2, !tbaa !70
  ...
  %i.czt = getelementptr inbounds [2 x i8], ptr %.414273385, i64 %i.bnw
  %i.czu = load i16, ptr %i.czt, align 2, !tbaa !70
  ...
  %i.dab = getelementptr inbounds [2 x i8], ptr %.414273385, i64 %i.bnx
  %i.dac = getelementptr inbounds nuw i8, ptr %.1414703384, i64 64
  %i.dad = add nuw nsw i32 %.014193386, 1         ; 2 uses
  %exitcond4207.not = icmp eq i32 %i.dad, %i.bnc
...
.loopexit3005.loopexit:                           ; preds = %.lr.ph3387
  ...
  %scevgep4206 = getelementptr i8, ptr %scevgep4205, i64 %i.boa
  br label %.loopexit3005
...
.loopexit3005:                                    ; preds = %.preheader3007, %.loopexit3008.loopexit, %bb.aa, %.loopexit3006.loopexit, %.loopexit3005.loopexit, %.preheader3004, %.loopexit3006
  %.152873 = phi nsz <4 x float> [ %.928673393, %.loopexit3006 ], [ %.928673393, %.preheader3004 ], [ %i.daa, %.loopexit3005.loopexit ], [ %.928673393, %bb.aa ], [ %i.cvq, %.loopexit3006.loopexit ], [ %i.cso, %.loopexit3008.loopexit ], [ %.928673393, %.preheader3007 ] ; 2 uses
  %.152845 = phi nsz <4 x float> [ %.928393394, %.loopexit3006 ], [ %.928393394, %.preheader3004 ], [ %i.czs, %.loopexit3005.loopexit ], [ %.928393394, %bb.aa ], [ %i.cvn, %.loopexit3006.loopexit ], [ %i.csl, %.loopexit3008.loopexit ], [ %.928393394, %.preheader3007 ] ; 2 uses
  %.152822 = phi nsz <4 x float> [ %.928163395, %.loopexit3006 ], [ %.928163395, %.preheader3004 ], [ %i.czk, %.loopexit3005.loopexit ], [ %.928163395, %bb.aa ], [ %i.cvk, %.loopexit3006.loopexit ], [ %i.csi, %.loopexit3008.loopexit ], [ %.928163395, %.preheader3007 ] ; 2 uses
  %.162797 = phi nsz <4 x float> [ %.1027913396, %.loopexit3006 ], [ %.1027913396, %.preheader3004 ], [ %i.czc, %.loopexit3005.loopexit ], [ %.1027913396, %bb.aa ], [ %i.cvh, %.loopexit3006.loopexit ], [ %i.csf, %.loopexit3008.loopexit ], [ %.1027913396, %.preheader3007 ] ; 2 uses
  ...
  %i.dae = add nuw nsw i32 %.114823397, 8         ; 3 uses
  %i.daf = or disjoint i32 %i.dae, 7
  %i.dag = icmp slt i32 %i.daf, %i.biu
  br i1 %i.dag, label %bb.z, label %.preheader3017, !llvm.loop !438
...
.preheader3016:                                   ; preds = %.loopexit3001, %.preheader3017
  ...
  %.21483.lcssa = phi i32 [ %.11482.lcssa, %.preheader3017 ], [ %i.dfz, %.loopexit3001 ] ; 6 uses
  ...
  br i1 %i.dai, label %.lr.ph3469, label %.preheader3015

.lr.ph3469:                                       ; preds = %.preheader3016
  %i.daj = load ptr, ptr %0, align 8, !tbaa !19
  %i.dak = load i32, ptr %i.p, align 4, !tbaa !55
  %i.dal = sext i32 %i.dak to i64
  %i.dam = load i64, ptr %i.az, align 8, !tbaa !44
  %factor.op.mul3474 = mul i64 %i.dam, %i.dal
  %i.dan = mul nsw i64 %indvars.iv4227, %i.bkm
  %invariant.gep3476 = getelementptr [2 x i8], ptr %i.daj, i64 %i.dan
  %i.dao = load i32, ptr %i.e, align 4
  %i.dap = sext i32 %i.dao to i64
  %i.daq = load i32, ptr %i.b, align 4
  %i.dar = sext i32 %i.daq to i64
  br i1 %i.bka, label %.lr.ph3460.us.preheader, label %.lr.ph3469.split.preheader

.lr.ph3469.split.preheader:                       ; preds = %.lr.ph3469
  %i.das = add i32 %.21483.lcssa, 2
  %12 = add i32 %.21483.lcssa, 3
  %smax4214 = call i32 @llvm.smax.i32(i32 %i.biu, i32 %12)
  %13 = add i32 %smax4214, -2
  %i.dat = sub i32 %13, %.21483.lcssa
...
.lr.ph3460.us:                                    ; preds = %.lr.ph3460.us.preheader, %._crit_edge3461.us
  %indvars.iv4218 = phi i64 [ %i.daw, %.lr.ph3460.us.preheader ], [ %indvars.iv.next4219, %._crit_edge3461.us ] ; 2 uses
  %.2114773468.us = phi ptr [ %.161472.lcssa, %.lr.ph3460.us.preheader ], [ %scevgep4216, %._crit_edge3461.us ] ; 2 uses
  %.2228033466.us = phi <4 x float> [ %.172798.lcssa, %.lr.ph3460.us.preheader ], [ %i.dbo, %._crit_edge3461.us ]
  %.2128283465.us = phi <4 x float> [ %.162823.lcssa, %.lr.ph3460.us.preheader ], [ %i.dbw, %._crit_edge3461.us ]
  %.reass3475.us = mul i64 %factor.op.mul3474, %indvars.iv4218
  %gep3477.us = getelementptr i8, ptr %invariant.gep3476, i64 %.reass3475.us
  br label %bb.ab

bb.ab:                                            ; preds = %.lr.ph3460.us, %bb.ab
  %.014123458.us = phi i32 [ 0, %.lr.ph3460.us ], [ %i.dbz, %bb.ab ]
  %.014133457.us = phi ptr [ %gep3477.us, %.lr.ph3460.us ], [ %i.dbx, %bb.ab ] ; 3 uses
  %.2214783456.us = phi ptr [ %.2114773468.us, %.lr.ph3460.us ], [ %i.dby, %bb.ab ] ; 3 uses
  %.2328043455.us = phi <4 x float> [ %.2228033466.us, %.lr.ph3460.us ], [ %i.dbo, %bb.ab ]
  %.2228293454.us = phi <4 x float> [ %.2128283465.us, %.lr.ph3460.us ], [ %i.dbw, %bb.ab ]
  %i.dax = load i64, ptr %.2214783456.us, align 1, !tbaa !45
  ...
  %i.dbc = getelementptr inbounds nuw i8, ptr %.2214783456.us, i64 8
  %i.dbd = load i64, ptr %i.dbc, align 1, !tbaa !45
  ...
  %i.dbi = load i16, ptr %.014133457.us, align 2, !tbaa !70
  ...
  %i.dbo = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.dbb, <4 x float> nofpclass(nan inf) %i.dbn, <4 x float> nofpclass(nan inf) %.2328043455.us) ; 3 uses
  %i.dbp = getelementptr inbounds [2 x i8], ptr %.014133457.us, i64 %i.dap
  %i.dbq = load i16, ptr %i.dbp, align 2, !tbaa !70
  ...
  %i.dbw = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.dbh, <4 x float> nofpclass(nan inf) %i.dbv, <4 x float> nofpclass(nan inf) %.2228293454.us) ; 3 uses
  %i.dbx = getelementptr inbounds [2 x i8], ptr %.014133457.us, i64 %i.dar
  %i.dby = getelementptr inbounds nuw i8, ptr %.2214783456.us, i64 16
  %i.dbz = add nuw nsw i32 %.014123458.us, 1      ; 2 uses
  %exitcond4217.not = icmp eq i32 %i.dbz, %i.bjz
  br i1 %exitcond4217.not, label %._crit_edge3461.us, label %bb.ab, !llvm.loop !439

._crit_edge3461.us:                               ; preds = %bb.ab
  %scevgep4215.a = getelementptr i8, ptr %.2114773468.us, i64 16
  %scevgep4216 = getelementptr i8, ptr %scevgep4215.a, i64 %i.bkk ; 2 uses
  %indvars.iv.next4219 = add nuw nsw i64 %indvars.iv4218, 2 ; 3 uses
  %i.dca = trunc i64 %indvars.iv.next4219 to i32
  %i.dcb = or i32 %i.dca, 1
  %i.dcc = icmp slt i32 %i.dcb, %i.biu
  br i1 %i.dcc, label %.lr.ph3460.us, label %.preheader3015.loopexit, !llvm.loop !440

bb.ac:                                            ; preds = %.lr.ph3443, %.loopexit3001
  %.1614723442 = phi ptr [ %.91465.lcssa, %.lr.ph3443 ], [ %.201476, %.loopexit3001 ] ; 7 uses
  %.214833441 = phi i32 [ %.11482.lcssa, %.lr.ph3443 ], [ %i.dfz, %.loopexit3001 ] ; 2 uses
  ...
  %i.dcd = sdiv i32 %.214833441, %i.bis
  %i.dce = sext i32 %i.dcd to i64
  %.reass3451 = mul i64 %factor.op.mul3450, %i.dce
  %gep3453 = getelementptr i8, ptr %invariant.gep3452, i64 %.reass3451 ; 2 uses
  br i1 %i.bjx, label %.preheader3002, label %.loopexit3003

.preheader3002:                                   ; preds = %bb.ac
  br i1 %i.cpd, label %.lr.ph3417, label %.loopexit3001

.lr.ph3417:                                       ; preds = %.preheader3002, %.lr.ph3417
  %.014153416 = phi i32 [ %i.ddt, %.lr.ph3417 ], [ 0, %.preheader3002 ]
  %.014163415 = phi ptr [ %i.ddr, %.lr.ph3417 ], [ %gep3453, %.preheader3002 ] ; 2 uses
  %.1714733414 = phi ptr [ %i.dds, %.lr.ph3417 ], [ %.1614723442, %.preheader3002 ] ; 5 uses
  %.1827993413 = phi <4 x float> [ %i.ddh, %.lr.ph3417 ], [ %.1727983440, %.preheader3002 ]
  %.1728243412 = phi <4 x float> [ %i.ddk, %.lr.ph3417 ], [ %.1628233439, %.preheader3002 ]
  %.1728473411 = phi <4 x float> [ %i.ddn, %.lr.ph3417 ], [ %.1628463438, %.preheader3002 ]
  %.1728753410 = phi <4 x float> [ %i.ddq, %.lr.ph3417 ], [ %.1628743437, %.preheader3002 ]
  %i.dcf = load i64, ptr %.1714733414, align 1, !tbaa !45
  ...
  %i.dck = getelementptr inbounds nuw i8, ptr %.1714733414, i64 8
  %i.dcl = load i64, ptr %i.dck, align 1, !tbaa !45
  ...
  %i.dcq = getelementptr inbounds nuw i8, ptr %.1714733414, i64 16
  %i.dcr = load i64, ptr %i.dcq, align 1, !tbaa !45
  ...
  %i.dcw = getelementptr inbounds nuw i8, ptr %.1714733414, i64 24
  %i.dcx = load i64, ptr %i.dcw, align 1, !tbaa !45
  ...
  %i.ddc = load <4 x i16>, ptr %.014163415, align 2, !tbaa !70
  ...
  %i.ddh = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.dcj, <4 x float> nofpclass(nan inf) %i.ddg, <4 x float> nofpclass(nan inf) %.1827993413) ; 2 uses
  ...
  %i.ddk = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.dcp, <4 x float> nofpclass(nan inf) %i.ddj, <4 x float> nofpclass(nan inf) %.1728243412) ; 2 uses
  ...
  %i.ddn = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.dcv, <4 x float> nofpclass(nan inf) %i.ddm, <4 x float> nofpclass(nan inf) %.1728473411) ; 2 uses
  ...
  %i.ddq = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ddb, <4 x float> nofpclass(nan inf) %i.ddp, <4 x float> nofpclass(nan inf) %.1728753410) ; 2 uses
  %i.ddr = getelementptr inbounds [2 x i8], ptr %.014163415, i64 %i.cpg
  %i.dds = getelementptr inbounds nuw i8, ptr %.1714733414, i64 32
  %i.ddt = add nuw nsw i32 %.014153416, 1         ; 2 uses
  %exitcond4210.not = icmp eq i32 %i.ddt, %i.cpc
...
.loopexit3003.loopexit:                           ; preds = %.lr.ph3417
  ...
  %scevgep4209 = getelementptr i8, ptr %scevgep4208, i64 %i.cpq
  br label %.loopexit3001

.loopexit3003:                                    ; preds = %bb.ac
  br i1 %i.bjy, label %.preheader3000, label %.loopexit3001

.preheader3000:                                   ; preds = %.loopexit3003
  br i1 %i.cpd, label %.lr.ph3431, label %.loopexit3001

.lr.ph3431:                                       ; preds = %.preheader3000, %.lr.ph3431
  %.014143430 = phi i32 [ %i.dfy, %.lr.ph3431 ], [ 0, %.preheader3000 ]
  %.214183429 = phi ptr [ %i.dfw, %.lr.ph3431 ], [ %gep3453, %.preheader3000 ] ; 5 uses
  %.1914753428 = phi ptr [ %i.dfx, %.lr.ph3431 ], [ %.1614723442, %.preheader3000 ] ; 5 uses
  %.2028013427 = phi <4 x float> [ %i.dex, %.lr.ph3431 ], [ %.1727983440, %.preheader3000 ]
  %.1928263426 = phi <4 x float> [ %i.dff, %.lr.ph3431 ], [ %.1628233439, %.preheader3000 ]
  %.1928493425 = phi <4 x float> [ %i.dfn, %.lr.ph3431 ], [ %.1628463438, %.preheader3000 ]
  %.1928773424 = phi <4 x float> [ %i.dfv, %.lr.ph3431 ], [ %.1628743437, %.preheader3000 ]
  %i.ddu = load i64, ptr %.1914753428, align 1, !tbaa !45
  ...
  %i.ddz = getelementptr inbounds nuw i8, ptr %.1914753428, i64 8
  %i.dea = load i64, ptr %i.ddz, align 1, !tbaa !45
  ...
  %i.def = getelementptr inbounds nuw i8, ptr %.1914753428, i64 16
  %i.deg = load i64, ptr %i.def, align 1, !tbaa !45
  ...
  %i.del = getelementptr inbounds nuw i8, ptr %.1914753428, i64 24
  %i.dem = load i64, ptr %i.del, align 1, !tbaa !45
  ...
  %i.der = load i16, ptr %.214183429, align 2, !tbaa !70
  ...
  %i.dex = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ddy, <4 x float> nofpclass(nan inf) %i.dew, <4 x float> nofpclass(nan inf) %.2028013427) ; 2 uses
  %i.dey = getelementptr inbounds [2 x i8], ptr %.214183429, i64 %i.cpi
  %i.dez = load i16, ptr %i.dey, align 2, !tbaa !70
  ...
  %i.dff = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.dee, <4 x float> nofpclass(nan inf) %i.dfe, <4 x float> nofpclass(nan inf) %.1928263426) ; 2 uses
  %i.dfg = getelementptr inbounds [2 x i8], ptr %.214183429, i64 %i.cpk
  %i.dfh = load i16, ptr %i.dfg, align 2, !tbaa !70
  ...
  %i.dfn = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.dek, <4 x float> nofpclass(nan inf) %i.dfm, <4 x float> nofpclass(nan inf) %.1928493425) ; 2 uses
  %i.dfo = getelementptr inbounds [2 x i8], ptr %.214183429, i64 %i.cpm
  %i.dfp = load i16, ptr %i.dfo, align 2, !tbaa !70
...
bb.ai:                                            ; preds = %._crit_edge3495
  %i.dnj = load ptr, ptr %8, align 8, !tbaa !19   ; 2 uses
  %i.dnk = load float, ptr %i.dnj, align 4, !tbaa !48
  ...
  %i.dno = load float, ptr %i.dnn, align 4, !tbaa !48
...
_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit:      ; preds = %._crit_edge3495, %bb.ad, %bb.ae, %bb.af, %bb.ag, %bb.ah, %bb.ai
  %.0.i1538 = phi nsz <4 x float> [ %i.dnv, %bb.ai ], [ %i.dif, %bb.ad ], [ %i.din, %bb.ae ], [ %i.dix, %bb.af ], [ %i.djz, %bb.ag ], [ %i.dni, %bb.ah ], [ %i.die, %._crit_edge3495 ] ; 2 uses
...
.thread2933:                                      ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit
  ...
  store i64 %i.doa, ptr %.014523503, align 1, !tbaa !45
  %i.dob = getelementptr inbounds nuw i8, ptr %.014523503, i64 8
  br label %bb.ak
...
bb.aj:                                            ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit
  ...
  store i16 %i.dod, ptr %.014523503, align 2, !tbaa !70
  %i.doe = extractelement <8 x i16> %i.doc, i64 3
  %i.dof = getelementptr inbounds [2 x i8], ptr %.014523503, i64 %i.bkc
  store i16 %i.doe, ptr %i.dof, align 2, !tbaa !70
  %i.dog = extractelement <8 x i16> %i.doc, i64 5
  %i.doh = getelementptr inbounds [2 x i8], ptr %.014523503, i64 %i.bke
  store i16 %i.dog, ptr %i.doh, align 2, !tbaa !70
  %i.doi = extractelement <8 x i16> %i.doc, i64 7
  %i.doj = getelementptr inbounds [2 x i8], ptr %.014523503, i64 %i.bkg
  store i16 %i.doi, ptr %i.doj, align 2, !tbaa !70
  %i.dok = getelementptr inbounds nuw i8, ptr %.014523503, i64 2
  br label %bb.ak

bb.ak:                                            ; preds = %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit, %.thread2933, %bb.aj
  %.21454 = phi ptr [ %i.dok, %bb.aj ], [ %.014523503, %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit ], [ %i.dob, %.thread2933 ]
  %indvars.iv.next4228 = add nuw nsw i64 %indvars.iv4227, 1 ; 2 uses
  %exitcond4231.not = icmp eq i64 %indvars.iv.next4228, %wide.trip.count4230
  br i1 %exitcond4231.not, label %._crit_edge3506, label %bb.u, !llvm.loop !446

._crit_edge3727.split:                            ; preds = %._crit_edge3717, %.lr.ph3726, %._crit_edge3516
  %i.dol = shl nsw i32 %i.bhq, 1
  %i.dom = add nsw i32 %i.dol, %i.bho             ; 2 uses
  %i.don = icmp slt i32 %i.dom, %i.y
  br i1 %i.don, label %.lr.ph3903, label %._crit_edge3904.split

.lr.ph3903:                                       ; preds = %._crit_edge3727.split
  %i.doo = load ptr, ptr %1, align 8, !tbaa !19
  %i.dop = load i32, ptr %i.s, align 4, !tbaa !55
  %i.doq = sext i32 %i.dop to i64
  %i.dor = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.dos = load i64, ptr %i.dor, align 8, !tbaa !44
  %factor.op.mul3905 = mul i64 %i.dos, %i.doq
  ...
  br i1 %i.dot, label %.lr.ph3903.split, label %._crit_edge3904.split

.lr.ph3903.split:                                 ; preds = %.lr.ph3903
  %i.dpe = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.dpf = getelementptr inbounds nuw i8, ptr %2, i64 64
  %i.dpg = load ptr, ptr %2, align 8, !tbaa !19, !noalias !488
  %i.dph = load i64, ptr %i.dpf, align 8, !tbaa !20, !noalias !488
  %i.dpi = load i64, ptr %i.dpe, align 8, !tbaa !44, !noalias !488
  %factor.op.mul3907 = mul i64 %i.dph, %i.dpi
  %i.dpj = and i32 %i.o, -16
  %i.dpk = sext i32 %i.dom to i64
  %wide.trip.count4335 = sext i32 %i.y to i64
  %wide.trip.count4330 = zext nneg i32 %i.t to i64
  br label %.lr.ph3893

.lr.ph3716:                                       ; preds = %.lr.ph3726.split, %._crit_edge3717
  %indvars.iv4282 = phi i64 [ 0, %.lr.ph3726.split ], [ %indvars.iv.next4283, %._crit_edge3717 ] ; 2 uses
  %i.dpl = shl nuw nsw i64 %indvars.iv4282, 1
  ...
  %.reass3730 = mul i64 %factor.op.mul3729, %i.dqh
  %i.dqi = getelementptr inbounds nuw i8, ptr %i.bim, i64 %.reass3730 ; 2 uses
  %i.dqj = load i32, ptr %i.c, align 4            ; 2 uses
  %factor.op.mul3718 = mul i32 %i.bhs, %i.dqj     ; 3 uses
  ...
  %xtraiter4901 = and i32 %i.dqk, 1
  %i.dqr = icmp eq i32 %i.dqm, 0
  %unroll_iter4905 = and i32 %i.dqk, 2147483646
  %lcmp.mod4902.not = icmp eq i32 %xtraiter4901, 0
  %lcmp.mod4904 = trunc i32 %i.dqk to i1
  br label %bb.al

._crit_edge3717:                                  ; preds = %_ZL13activation_ssfiRKN4ncnn3MatE.exit1539
  %indvars.iv.next4283 = add nuw nsw i64 %indvars.iv4282, 1 ; 2 uses
  %exitcond4286.not = icmp eq i64 %indvars.iv.next4283, %wide.trip.count4285
  br i1 %exitcond4286.not, label %._crit_edge3727.split, label %.lr.ph3716, !llvm.loop !449

bb.al:                                            ; preds = %.lr.ph3716, %_ZL13activation_ssfiRKN4ncnn3MatE.exit1539
  %indvars.iv4277 = phi i64 [ 0, %.lr.ph3716 ], [ %indvars.iv.next4278, %_ZL13activation_ssfiRKN4ncnn3MatE.exit1539 ] ; 6 uses
  %.014073713 = phi ptr [ %i.dpr, %.lr.ph3716 ], [ %i.esa, %_ZL13activation_ssfiRKN4ncnn3MatE.exit1539 ] ; 2 uses
  %.014083712 = phi ptr [ %i.dpo, %.lr.ph3716 ], [ %i.erz, %_ZL13activation_ssfiRKN4ncnn3MatE.exit1539 ] ; 2 uses
  br i1 %.not1510, label %_ZN4ncnn3MatD2Ev.exit1513, label %bb.am

bb.am:                                            ; preds = %bb.al
  %i.dqs = load <2 x float>, ptr %i.dps, align 4, !tbaa !48
...
_ZN4ncnn3MatD2Ev.exit1513:                        ; preds = %bb.am, %bb.al
  ...
  br i1 %i.bid, label %.lr.ph3568, label %._crit_edge3569

.lr.ph3568:                                       ; preds = %_ZN4ncnn3MatD2Ev.exit1513
  %i.dqu = load ptr, ptr %0, align 8, !tbaa !19
  %i.dqv = load i32, ptr %i.p, align 4, !tbaa !55
  %i.dqw = sext i32 %i.dqv to i64
  %i.dqx = load i64, ptr %i.bie, align 8, !tbaa !44
  %factor.op.mul3574 = mul i64 %i.dqx, %i.dqw
  %i.dqy = trunc nuw nsw i64 %indvars.iv4277 to i32
  %.reass3719 = mul i32 %factor.op.mul3718, %i.dqy
  %i.dqz = sext i32 %.reass3719 to i64
  %invariant.gep3576 = getelementptr [2 x i8], ptr %i.dqu, i64 %i.dqz
...
bb.an:                                            ; preds = %.lr.ph3568, %.loopexit2994
  %.013663567 = phi i32 [ 0, %.lr.ph3568 ], [ %i.eai, %.loopexit2994 ] ; 2 uses
  %.013713566 = phi ptr [ %i.dqi, %.lr.ph3568 ], [ %.81379, %.loopexit2994 ] ; 12 uses
  %.028883565 = phi <16 x float> [ zeroinitializer, %.lr.ph3568 ], [ %.82896, %.loopexit2994 ] ; 8 uses
  %.028973564 = phi <16 x float> [ zeroinitializer, %.lr.ph3568 ], [ %.82905, %.loopexit2994 ] ; 8 uses
  %i.dss = sdiv i32 %.013663567, %i.bhs
  %i.dst = sext i32 %i.dss to i64
  %.reass3575 = mul i64 %factor.op.mul3574, %i.dst
  %gep3577 = getelementptr i8, ptr %invariant.gep3576, i64 %.reass3575 ; 8 uses
  br i1 %i.bif, label %.preheader2997, label %.loopexit2998

.preheader2997:                                   ; preds = %bb.an
  br i1 %i.drb, label %.lr.ph3524, label %.loopexit2994

.lr.ph3524:                                       ; preds = %.preheader2997, %.lr.ph3524
  %.013583523 = phi i32 [ %i.dua, %.lr.ph3524 ], [ 0, %.preheader2997 ]
  %.013593522 = phi ptr [ %i.dty, %.lr.ph3524 ], [ %gep3577, %.preheader2997 ] ; 2 uses
  %.113723521 = phi ptr [ %i.dtz, %.lr.ph3524 ], [ %.013713566, %.preheader2997 ] ; 3 uses
  %.128893520 = phi <16 x float> [ %i.dtw, %.lr.ph3524 ], [ %.028883565, %.preheader2997 ]
  %.128983519 = phi <16 x float> [ %i.dtx, %.lr.ph3524 ], [ %.028973564, %.preheader2997 ]
  %i.dsu = load <16 x i16>, ptr %.013593522, align 32, !tbaa !45 ; 2 uses
  ...
  %i.dtd = load <16 x i16>, ptr %.113723521, align 32, !tbaa !45 ; 2 uses
  ...
  %i.dtm = getelementptr inbounds nuw i8, ptr %.113723521, i64 32
  %i.dtn = load <16 x i16>, ptr %i.dtm, align 32, !tbaa !45 ; 2 uses
  ...
  %i.dtw = call fast noundef nofpclass(nan inf) <16 x float> @llvm.fma.v16f32(<16 x float> nofpclass(nan inf) %i.dtc, <16 x float> nofpclass(nan inf) %i.dtl, <16 x float> nofpclass(nan inf) %.128893520) ; 2 uses
  %i.dtx = call fast noundef nofpclass(nan inf) <16 x float> @llvm.fma.v16f32(<16 x float> nofpclass(nan inf) %i.dtc, <16 x float> nofpclass(nan inf) %i.dtv, <16 x float> nofpclass(nan inf) %.128983519) ; 2 uses
  %i.dty = getelementptr inbounds [2 x i8], ptr %.013593522, i64 %i.dre
  %i.dtz = getelementptr inbounds nuw i8, ptr %.113723521, i64 64
  %i.dua = add nuw nsw i32 %.013583523, 1         ; 2 uses
  %exitcond4239.not = icmp eq i32 %i.dua, %i.dra
  br i1 %exitcond4239.not, label %.loopexit2998.loopexit, label %.lr.ph3524, !llvm.loop !450

.loopexit2998.loopexit:                           ; preds = %.lr.ph3524
  %scevgep4237.a = getelementptr i8, ptr %.013713566, i64 64
  %scevgep4238 = getelementptr i8, ptr %scevgep4237.a, i64 %i.dsr
  br label %.loopexit2994

.loopexit2998:                                    ; preds = %bb.an
  br i1 %i.big, label %bb.ao, label %.loopexit2996

bb.ao:                                            ; preds = %.loopexit2998
  br i1 %i.drb, label %.lr.ph3536.preheader, label %.loopexit2994

.lr.ph3536.preheader:                             ; preds = %bb.ao
  %i.dub = getelementptr inbounds [2 x i8], ptr %gep3577, i64 %i.drg
  br label %.lr.ph3536

.lr.ph3536:                                       ; preds = %.lr.ph3536.preheader, %.lr.ph3536
end_hunk_13
begin_hunk_14_@_ZN4ncnnL26convolution1d_packed_bf16sERKNS_3MatERS0_S2_S2_iiiiS2_RKNS_6OptionE:bb.a
.lr.ph3648:                                       ; preds = %._crit_edge3615
  %i.egf = load ptr, ptr %0, align 8, !tbaa !19
  %i.egg = load i32, ptr %i.p, align 4, !tbaa !55
  %i.egh = sext i32 %i.egg to i64
  %i.egi = load i64, ptr %i.bie, align 8, !tbaa !44
  %factor.op.mul3654 = mul i64 %i.egi, %i.egh
  %i.egj = trunc nuw nsw i64 %indvars.iv4277 to i32
  %.reass3723 = mul i32 %factor.op.mul3718, %i.egj
  %i.egk = sext i32 %.reass3723 to i64
  %invariant.gep3656 = getelementptr [2 x i8], ptr %i.egf, i64 %i.egk
  ...
  %brmerge3916 = select i1 %i.bii, i1 true, i1 %i.egq
  %xtraiter4893 = and i32 %i.egl, 1
  %i.ehb = icmp eq i32 %i.egy, 0
  %unroll_iter4898 = and i32 %i.egl, 2147483646
  %lcmp.mod4894.not = icmp eq i32 %xtraiter4893, 0
  %lcmp.mod4897 = trunc i32 %i.egl to i1
  br label %bb.as

bb.as:                                            ; preds = %.lr.ph3648, %.loopexit2985
  %.213683646 = phi i32 [ %.11367.lcssa, %.lr.ph3648 ], [ %i.ekr, %.loopexit2985 ] ; 2 uses
  %.1613873645 = phi ptr [ %.91380.lcssa, %.lr.ph3648 ], [ %.201391, %.loopexit2985 ] ; 7 uses
  %.029203644 = phi <4 x float> [ zeroinitializer, %.lr.ph3648 ], [ %.42924, %.loopexit2985 ] ; 5 uses
  %.029253643 = phi <4 x float> [ zeroinitializer, %.lr.ph3648 ], [ %.42929, %.loopexit2985 ] ; 5 uses
  %i.ehc = sdiv i32 %.213683646, %i.bhs
  %i.ehd = sext i32 %i.ehc to i64
  %.reass3655 = mul i64 %factor.op.mul3654, %i.ehd
  %gep3657 = getelementptr i8, ptr %invariant.gep3656, i64 %.reass3655 ; 3 uses
  br i1 %i.bih, label %.preheader2986, label %.loopexit2987

.preheader2986:                                   ; preds = %bb.as
  br i1 %i.egm, label %.lr.ph3629.preheader, label %.loopexit2985

.lr.ph3629.preheader:                             ; preds = %.preheader2986
  br i1 %i.ehb, label %.lr.ph3629.epil.preheader, label %.lr.ph3629

.lr.ph3629:                                       ; preds = %.lr.ph3629.preheader, %.lr.ph3629
  %.012933627 = phi ptr [ %i.eiq, %.lr.ph3629 ], [ %gep3657, %.lr.ph3629.preheader ] ; 2 uses
  %.1713883626 = phi ptr [ %i.eir, %.lr.ph3629 ], [ %.1613873645, %.lr.ph3629.preheader ] ; 5 uses
  %.129213625 = phi <4 x float> [ %i.eio, %.lr.ph3629 ], [ %.029203644, %.lr.ph3629.preheader ]
  %.129263624 = phi <4 x float> [ %i.eip, %.lr.ph3629 ], [ %.029253643, %.lr.ph3629.preheader ]
  %niter4899 = phi i32 [ %niter4899.next.1, %.lr.ph3629 ], [ 0, %.lr.ph3629.preheader ]
  %i.ehe = load i64, ptr %.012933627, align 1, !tbaa !45
  ...
  %i.ehj = load i64, ptr %.1713883626, align 1, !tbaa !45
  ...
  %i.eho = getelementptr inbounds nuw i8, ptr %.1713883626, i64 8
  %i.ehp = load i64, ptr %i.eho, align 1, !tbaa !45
  ...
  %i.ehu = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ehi, <4 x float> nofpclass(nan inf) %i.ehn, <4 x float> nofpclass(nan inf) %.129213625)
  %i.ehv = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ehi, <4 x float> nofpclass(nan inf) %i.eht, <4 x float> nofpclass(nan inf) %.129263624)
  %i.ehw = getelementptr inbounds [2 x i8], ptr %.012933627, i64 %i.egp ; 2 uses
  %i.ehx = getelementptr inbounds nuw i8, ptr %.1713883626, i64 16
  %i.ehy = load i64, ptr %i.ehw, align 1, !tbaa !45
  ...
  %i.eid = load i64, ptr %i.ehx, align 1, !tbaa !45
  ...
  %i.eii = getelementptr inbounds nuw i8, ptr %.1713883626, i64 24
  %i.eij = load i64, ptr %i.eii, align 1, !tbaa !45
  ...
  %i.eir = getelementptr inbounds nuw i8, ptr %.1713883626, i64 32 ; 2 uses
  %niter4899.next.1 = add nuw nsw i32 %niter4899, 2 ; 2 uses
  %niter4899.ncmp.1 = icmp eq i32 %niter4899.next.1, %unroll_iter4898
  br i1 %niter4899.ncmp.1, label %.loopexit2987.loopexit.unr-lcssa, label %.lr.ph3629, !llvm.loop !459

.loopexit2987.loopexit.unr-lcssa:                 ; preds = %.lr.ph3629
  br i1 %lcmp.mod4894.not, label %.loopexit2987.loopexit, label %.lr.ph3629.epil.preheader

.lr.ph3629.epil.preheader:                        ; preds = %.loopexit2987.loopexit.unr-lcssa, %.lr.ph3629.preheader
  %.012933627.epil.init = phi ptr [ %gep3657, %.lr.ph3629.preheader ], [ %i.eiq, %.loopexit2987.loopexit.unr-lcssa ]
  %.1713883626.epil.init = phi ptr [ %.1613873645, %.lr.ph3629.preheader ], [ %i.eir, %.loopexit2987.loopexit.unr-lcssa ] ; 2 uses
  %.129213625.epil.init = phi <4 x float> [ %.029203644, %.lr.ph3629.preheader ], [ %i.eio, %.loopexit2987.loopexit.unr-lcssa ]
  %.129263624.epil.init = phi <4 x float> [ %.029253643, %.lr.ph3629.preheader ], [ %i.eip, %.loopexit2987.loopexit.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod4897)
  %i.eis = load i64, ptr %.012933627.epil.init, align 1, !tbaa !45
  ...
  %i.eix = load i64, ptr %.1713883626.epil.init, align 1, !tbaa !45
  ...
  %i.ejc = getelementptr inbounds nuw i8, ptr %.1713883626.epil.init, i64 8
  %i.ejd = load i64, ptr %i.ejc, align 1, !tbaa !45
  ...
  %i.eji = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.eiw, <4 x float> nofpclass(nan inf) %i.ejb, <4 x float> nofpclass(nan inf) %.129213625.epil.init)
  %i.ejj = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.eiw, <4 x float> nofpclass(nan inf) %i.ejh, <4 x float> nofpclass(nan inf) %.129263624.epil.init)
  br label %.loopexit2987.loopexit

.loopexit2987.loopexit:                           ; preds = %.loopexit2987.loopexit.unr-lcssa, %.lr.ph3629.epil.preheader
  %.lcssa4798.a = phi <4 x float> [ %i.eio, %.loopexit2987.loopexit.unr-lcssa ], [ %i.eji, %.lr.ph3629.epil.preheader ]
  %.lcssa4797 = phi <4 x float> [ %i.eip, %.loopexit2987.loopexit.unr-lcssa ], [ %i.ejj, %.lr.ph3629.epil.preheader ]
  %scevgep4258.a = getelementptr i8, ptr %.1613873645, i64 16
...
.lr.ph3639:                                       ; preds = %.loopexit2987, %.lr.ph3639
  %.012913638 = phi i32 [ %i.ekq, %.lr.ph3639 ], [ 0, %.loopexit2987 ]
  %.212953637 = phi ptr [ %i.eko, %.lr.ph3639 ], [ %gep3657, %.loopexit2987 ] ; 5 uses
  %.1913903636 = phi ptr [ %i.ekp, %.lr.ph3639 ], [ %.1613873645, %.loopexit2987 ] ; 3 uses
  %.329233635 = phi <4 x float> [ %i.ekm, %.lr.ph3639 ], [ %.029203644, %.loopexit2987 ]
  %.329283634 = phi <4 x float> [ %i.ekn, %.lr.ph3639 ], [ %.029253643, %.loopexit2987 ]
  %i.ejk = getelementptr inbounds [2 x i8], ptr %.212953637, i64 %i.egt
  %i.ejl = load i16, ptr %i.ejk, align 2, !tbaa !70
  %i.ejm = getelementptr inbounds [2 x i8], ptr %.212953637, i64 %i.egv
  %i.ejn = load i16, ptr %i.ejm, align 2, !tbaa !70
  %i.ejo = getelementptr inbounds [2 x i8], ptr %.212953637, i64 %i.egw
  %i.ejp = load i16, ptr %i.ejo, align 2, !tbaa !70
  %i.ejq = load i16, ptr %.212953637, align 2, !tbaa !70
  ...
  %i.ekb = load i64, ptr %.1913903636, align 1, !tbaa !45
  ...
  %i.ekg = getelementptr inbounds nuw i8, ptr %.1913903636, i64 8
  %i.ekh = load i64, ptr %i.ekg, align 1, !tbaa !45
  ...
  %i.ekm = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.eka, <4 x float> nofpclass(nan inf) %i.ekf, <4 x float> nofpclass(nan inf) %.329233635) ; 2 uses
  %i.ekn = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.eka, <4 x float> nofpclass(nan inf) %i.ekl, <4 x float> nofpclass(nan inf) %.329283634) ; 2 uses
  %i.eko = getelementptr inbounds [2 x i8], ptr %.212953637, i64 %i.egx
  %i.ekp = getelementptr inbounds nuw i8, ptr %.1913903636, i64 16
  %i.ekq = add nuw nsw i32 %.012913638, 1         ; 2 uses
  %exitcond4263.not = icmp eq i32 %i.ekq, %i.egl
  br i1 %exitcond4263.not, label %.loopexit2985.loopexit, label %.lr.ph3639, !llvm.loop !460

.loopexit2985.loopexit:                           ; preds = %.lr.ph3639
  %scevgep4261.a = getelementptr i8, ptr %.1613873645, i64 16
  %scevgep4262 = getelementptr i8, ptr %scevgep4261.a, i64 %i.eha
  br label %.loopexit2985

.loopexit2985:                                    ; preds = %.preheader2986, %.loopexit2987.loopexit, %.loopexit2985.loopexit, %.loopexit2987
  %.42929 = phi nsz <4 x float> [ %.029253643, %.loopexit2987 ], [ %i.ekn, %.loopexit2985.loopexit ], [ %.lcssa4797, %.loopexit2987.loopexit ], [ %.029253643, %.preheader2986 ] ; 2 uses
  %.42924 = phi nsz <4 x float> [ %.029203644, %.loopexit2987 ], [ %i.ekm, %.loopexit2985.loopexit ], [ %.lcssa4798.a, %.loopexit2987.loopexit ], [ %.029203644, %.preheader2986 ] ; 2 uses
  %.201391 = phi ptr [ %.1613873645, %.loopexit2987 ], [ %scevgep4262, %.loopexit2985.loopexit ], [ %scevgep4259, %.loopexit2987.loopexit ], [ %.1613873645, %.preheader2986 ] ; 2 uses
  %i.ekr = add nuw nsw i32 %.213683646, 4         ; 3 uses
  %i.eks = or disjoint i32 %i.ekr, 3
  %i.ekt = icmp slt i32 %i.eks, %i.bhu
  br i1 %i.ekt, label %bb.as, label %._crit_edge3649, !llvm.loop !461
...
._crit_edge3649:                                  ; preds = %.loopexit2985, %._crit_edge3615
  ...
  %.21368.lcssa = phi i32 [ %.11367.lcssa, %._crit_edge3615 ], [ %i.ekr, %.loopexit2985 ] ; 6 uses
  ...
  br i1 %i.elt, label %.lr.ph3674, label %.preheader2999

.lr.ph3674:                                       ; preds = %._crit_edge3649
  %i.elu = load ptr, ptr %0, align 8, !tbaa !19
  %i.elv = load i32, ptr %i.p, align 4, !tbaa !55
  %i.elw = sext i32 %i.elv to i64
  %i.elx = load i64, ptr %i.bie, align 8, !tbaa !44
  %factor.op.mul3679 = mul i64 %i.elx, %i.elw
  %i.ely = mul nsw i64 %indvars.iv4277, %i.dqq
  %invariant.gep3681 = getelementptr [2 x i8], ptr %i.elu, i64 %i.ely
  %i.elz = load i32, ptr %i.e, align 4
  %i.ema = sext i32 %i.elz to i64
  %i.emb = load i32, ptr %i.b, align 4
  %i.emc = sext i32 %i.emb to i64
  br i1 %i.dql, label %.lr.ph3664.us.preheader, label %.lr.ph3674.split.preheader

.lr.ph3674.split.preheader:                       ; preds = %.lr.ph3674
  %i.emd = add i32 %.21368.lcssa, 2
  %14 = add i32 %.21368.lcssa, 3
  %smax4264 = call i32 @llvm.smax.i32(i32 %i.bhu, i32 %14)
  %15 = add i32 %smax4264, -2
  %i.eme = sub i32 %15, %.21368.lcssa
...
.lr.ph3664.us:                                    ; preds = %.lr.ph3664.us.preheader, %._crit_edge3665.us
  %indvars.iv4268 = phi i64 [ %i.emh, %.lr.ph3664.us.preheader ], [ %indvars.iv.next4269, %._crit_edge3665.us ] ; 2 uses
  %.2113923671.us = phi ptr [ %.161387.lcssa, %.lr.ph3664.us.preheader ], [ %scevgep4266, %._crit_edge3665.us ] ; 2 uses
  %i.emi = phi <2 x float> [ %i.elr, %.lr.ph3664.us.preheader ], [ %i.enh, %._crit_edge3665.us ]
  %.reass3680.us = mul i64 %factor.op.mul3679, %indvars.iv4268
  %gep3682.us = getelementptr i8, ptr %invariant.gep3681, i64 %.reass3680.us
  br label %bb.at

bb.at:                                            ; preds = %.lr.ph3664.us, %bb.at
  %.012893662.us = phi i32 [ 0, %.lr.ph3664.us ], [ %i.enk, %bb.at ]
  %.012903661.us = phi ptr [ %gep3682.us, %.lr.ph3664.us ], [ %i.eni, %bb.at ] ; 3 uses
  %.2213933660.us = phi ptr [ %.2113923671.us, %.lr.ph3664.us ], [ %i.enj, %bb.at ] ; 3 uses
  %i.emj = phi <2 x float> [ %i.emi, %.lr.ph3664.us ], [ %i.enh, %bb.at ]
  %i.emk = load i16, ptr %.012903661.us, align 2, !tbaa !70
  %i.eml = getelementptr inbounds [2 x i8], ptr %.012903661.us, i64 %i.ema
  %i.emm = load i16, ptr %i.eml, align 2, !tbaa !70
  %i.emn = getelementptr inbounds nuw i8, ptr %.2213933660.us, i64 4
  %i.emo = load <2 x i16>, ptr %.2213933660.us, align 2, !tbaa !70
  %i.emp = zext <2 x i16> %i.emo to <2 x i32>
  %i.emq = shl nuw <2 x i32> %i.emp, splat (i32 16)
  %i.emr = bitcast <2 x i32> %i.emq to <2 x float>
  %i.ems = zext i16 %i.emk to i32
  %i.emt = zext i16 %i.emm to i32
  %i.emu = insertelement <2 x i32> poison, i32 %i.emt, i64 0
  %i.emv = insertelement <2 x i32> %i.emu, i32 %i.ems, i64 1
  %i.emw = shl nuw <2 x i32> %i.emv, splat (i32 16)
  %i.emx = bitcast <2 x i32> %i.emw to <2 x float> ; 2 uses
  %i.emy = shufflevector <2 x float> %i.emx, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.emz = fmul fast <2 x float> %i.emy, %i.emr
  %i.ena = fadd fast <2 x float> %i.emj, %i.emz
  %i.enb = load <2 x i16>, ptr %i.emn, align 2, !tbaa !70
  %i.enc = zext <2 x i16> %i.enb to <2 x i32>
  %i.end = shl nuw <2 x i32> %i.enc, splat (i32 16)
  %i.ene = bitcast <2 x i32> %i.end to <2 x float>
  %i.enf = shufflevector <2 x float> %i.emx, <2 x float> poison, <2 x i32> zeroinitializer
  %i.eng = fmul fast <2 x float> %i.enf, %i.ene
  %i.enh = fadd fast <2 x float> %i.eng, %i.ena   ; 3 uses
  %i.eni = getelementptr inbounds [2 x i8], ptr %.012903661.us, i64 %i.emc
  %i.enj = getelementptr inbounds nuw i8, ptr %.2213933660.us, i64 8
  %i.enk = add nuw nsw i32 %.012893662.us, 1      ; 2 uses
  %exitcond4267.not = icmp eq i32 %i.enk, %i.dqk
  br i1 %exitcond4267.not, label %._crit_edge3665.us, label %bb.at, !llvm.loop !462

._crit_edge3665.us:                               ; preds = %bb.at
  %scevgep4265 = getelementptr i8, ptr %.2113923671.us, i64 8
  %scevgep4266 = getelementptr i8, ptr %scevgep4265, i64 %i.dqo ; 2 uses
  %indvars.iv.next4269 = add nuw nsw i64 %indvars.iv4268, 2 ; 3 uses
  %i.enl = trunc i64 %indvars.iv.next4269 to i32
  %i.enm = or i32 %i.enl, 1
  %i.enn = icmp slt i32 %i.enm, %i.bhu
  br i1 %i.enn, label %.lr.ph3664.us, label %.preheader2999.loopexit, !llvm.loop !463

.preheader2999.loopexit:                          ; preds = %._crit_edge3665.us
  %i.eno = trunc nuw i64 %indvars.iv.next4269 to i32
  br label %.preheader2999

.preheader2999:                                   ; preds = %.lr.ph3674.split.preheader, %.preheader2999.loopexit, %._crit_edge3649
  %.211392.lcssa = phi ptr [ %.161387.lcssa, %._crit_edge3649 ], [ %scevgep4266, %.preheader2999.loopexit ], [ %.161387.lcssa, %.lr.ph3674.split.preheader ]
  %.31369.lcssa = phi i32 [ %.21368.lcssa, %._crit_edge3649 ], [ %i.eno, %.preheader2999.loopexit ], [ %i.emg, %.lr.ph3674.split.preheader ] ; 2 uses
  %i.enp = phi <2 x float> [ %i.elr, %._crit_edge3649 ], [ %i.enh, %.preheader2999.loopexit ], [ %i.elr, %.lr.ph3674.split.preheader ] ; 3 uses
  %i.enq = icmp slt i32 %.31369.lcssa, %i.bhu
  br i1 %i.enq, label %.lr.ph3702, label %._crit_edge3703

.lr.ph3702:                                       ; preds = %.preheader2999
  %i.enr = load ptr, ptr %0, align 8, !tbaa !19
  %i.ens = load i32, ptr %i.p, align 4, !tbaa !55
  %i.ent = sext i32 %i.ens to i64
  %i.enu = load i64, ptr %i.bie, align 8, !tbaa !44
  %factor.op.mul3706 = mul i64 %i.enu, %i.ent
  %i.env = mul nsw i64 %indvars.iv4277, %i.dqq
  %invariant.gep3708 = getelementptr [2 x i8], ptr %i.enr, i64 %i.env
  %i.enw = load i32, ptr %i.b, align 4
  %i.enx = sext i32 %i.enw to i64                 ; 2 uses
  br i1 %i.dql, label %.lr.ph3693.us.preheader, label %._crit_edge3703

.lr.ph3693.us.preheader:                          ; preds = %.lr.ph3702
  %i.eny = zext i32 %.31369.lcssa to i64
  br label %.lr.ph3693.us

.lr.ph3693.us:                                    ; preds = %.lr.ph3693.us.preheader, %._crit_edge3694.us
  %indvars.iv4274 = phi i64 [ %i.eny, %.lr.ph3693.us.preheader ], [ %indvars.iv.next4275, %._crit_edge3694.us ] ; 2 uses
  %.2313943700.us = phi ptr [ %.211392.lcssa, %.lr.ph3693.us.preheader ], [ %scevgep4272, %._crit_edge3694.us ] ; 3 uses
  %i.enz = phi <2 x float> [ %i.enp, %.lr.ph3693.us.preheader ], [ %.lcssa4801, %._crit_edge3694.us ] ; 2 uses
  %.reass3707.us = mul i64 %factor.op.mul3706, %indvars.iv4274
  %gep3709.us = getelementptr i8, ptr %invariant.gep3708, i64 %.reass3707.us ; 2 uses
  br i1 %i.dqr, label %.epil.preheader4900, label %.lr.ph3693.us.new

.lr.ph3693.us.new:                                ; preds = %.lr.ph3693.us, %.lr.ph3693.us.new
  %.012883690.us = phi ptr [ %i.epb, %.lr.ph3693.us.new ], [ %gep3709.us, %.lr.ph3693.us ] ; 2 uses
  %.2413953689.us = phi ptr [ %i.epc, %.lr.ph3693.us.new ], [ %.2313943700.us, %.lr.ph3693.us ] ; 3 uses
  %i.eoa = phi <2 x float> [ %i.epa, %.lr.ph3693.us.new ], [ %i.enz, %.lr.ph3693.us ]
  %niter4906 = phi i32 [ %niter4906.next.1, %.lr.ph3693.us.new ], [ 0, %.lr.ph3693.us ]
  %i.eob = load i16, ptr %.012883690.us, align 2, !tbaa !70
  %i.eoc = zext i16 %i.eob to i32
  %i.eod = shl nuw i32 %i.eoc, 16
  %i.eoe = load <2 x i16>, ptr %.2413953689.us, align 2, !tbaa !70
  %i.eof = zext <2 x i16> %i.eoe to <2 x i32>
  %i.eog = shl nuw <2 x i32> %i.eof, splat (i32 16)
  %i.eoh = bitcast <2 x i32> %i.eog to <2 x float>
  %i.eoi = insertelement <2 x i32> poison, i32 %i.eod, i64 0
  %i.eoj = bitcast <2 x i32> %i.eoi to <2 x float>
  %i.eok = shufflevector <2 x float> %i.eoj, <2 x float> poison, <2 x i32> zeroinitializer
  %i.eol = fmul fast <2 x float> %i.eok, %i.eoh
  %i.eom = fadd fast <2 x float> %i.eol, %i.eoa
  %i.eon = getelementptr inbounds [2 x i8], ptr %.012883690.us, i64 %i.enx ; 2 uses
  %i.eoo = getelementptr inbounds nuw i8, ptr %.2413953689.us, i64 4
  %i.eop = load i16, ptr %i.eon, align 2, !tbaa !70
  %i.eoq = zext i16 %i.eop to i32
  %i.eor = shl nuw i32 %i.eoq, 16
  %i.eos = load <2 x i16>, ptr %i.eoo, align 2, !tbaa !70
  %i.eot = zext <2 x i16> %i.eos to <2 x i32>
  %i.eou = shl nuw <2 x i32> %i.eot, splat (i32 16)
  %i.eov = bitcast <2 x i32> %i.eou to <2 x float>
  %i.eow = insertelement <2 x i32> poison, i32 %i.eor, i64 0
  %i.eox = bitcast <2 x i32> %i.eow to <2 x float>
  %i.eoy = shufflevector <2 x float> %i.eox, <2 x float> poison, <2 x i32> zeroinitializer
  %i.eoz = fmul fast <2 x float> %i.eoy, %i.eov
  %i.epa = fadd fast <2 x float> %i.eoz, %i.eom   ; 3 uses
  %i.epb = getelementptr inbounds [2 x i8], ptr %i.eon, i64 %i.enx ; 2 uses
  %i.epc = getelementptr inbounds nuw i8, ptr %.2413953689.us, i64 8 ; 2 uses
  %niter4906.next.1 = add nuw nsw i32 %niter4906, 2 ; 2 uses
  %niter4906.ncmp.1 = icmp eq i32 %niter4906.next.1, %unroll_iter4905
  br i1 %niter4906.ncmp.1, label %._crit_edge3694.us.unr-lcssa, label %.lr.ph3693.us.new, !llvm.loop !464

._crit_edge3694.us.unr-lcssa:                     ; preds = %.lr.ph3693.us.new
  br i1 %lcmp.mod4902.not, label %._crit_edge3694.us, label %.epil.preheader4900

.epil.preheader4900:                              ; preds = %._crit_edge3694.us.unr-lcssa, %.lr.ph3693.us
  %.012883690.us.epil.init = phi ptr [ %gep3709.us, %.lr.ph3693.us ], [ %i.epb, %._crit_edge3694.us.unr-lcssa ]
  %.2413953689.us.epil.init = phi ptr [ %.2313943700.us, %.lr.ph3693.us ], [ %i.epc, %._crit_edge3694.us.unr-lcssa ]
  %.epil.init = phi <2 x float> [ %i.enz, %.lr.ph3693.us ], [ %i.epa, %._crit_edge3694.us.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod4904)
  %i.epd = load i16, ptr %.012883690.us.epil.init, align 2, !tbaa !70
  %i.epe = zext i16 %i.epd to i32
  %i.epf = shl nuw i32 %i.epe, 16
  %i.epg = load <2 x i16>, ptr %.2413953689.us.epil.init, align 2, !tbaa !70
  %i.eph = zext <2 x i16> %i.epg to <2 x i32>
  %i.epi = shl nuw <2 x i32> %i.eph, splat (i32 16)
  %i.epj = bitcast <2 x i32> %i.epi to <2 x float>
  %i.epk = insertelement <2 x i32> poison, i32 %i.epf, i64 0
  %i.epl = bitcast <2 x i32> %i.epk to <2 x float>
  %i.epm = shufflevector <2 x float> %i.epl, <2 x float> poison, <2 x i32> zeroinitializer
  %i.epn = fmul fast <2 x float> %i.epm, %i.epj
  %i.epo = fadd fast <2 x float> %i.epn, %.epil.init
  br label %._crit_edge3694.us

._crit_edge3694.us:                               ; preds = %._crit_edge3694.us.unr-lcssa, %.epil.preheader4900
  %.lcssa4801 = phi <2 x float> [ %i.epa, %._crit_edge3694.us.unr-lcssa ], [ %i.epo, %.epil.preheader4900 ] ; 2 uses
  %scevgep4271 = getelementptr i8, ptr %.2313943700.us, i64 4
  %scevgep4272 = getelementptr i8, ptr %scevgep4271, i64 %i.dqp
  %indvars.iv.next4275 = add nuw nsw i64 %indvars.iv4274, 1 ; 2 uses
  %i.epp = trunc nuw i64 %indvars.iv.next4275 to i32
  %i.epq = icmp sgt i32 %i.bhu, %i.epp
  br i1 %i.epq, label %.lr.ph3693.us, label %._crit_edge3703, !llvm.loop !465

._crit_edge3703:                                  ; preds = %._crit_edge3694.us, %.lr.ph3702, %.preheader2999
  %i.epr = phi <2 x float> [ %i.enp, %.preheader2999 ], [ %i.enp, %.lr.ph3702 ], [ %.lcssa4801, %._crit_edge3694.us ] ; 12 uses
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit1540.thread2943: ; preds = %._crit_edge3703
  %i.eps = call fast <2 x float> @llvm.maxnum.v2f32(<2 x float> %i.epr, <2 x float> zeroinitializer)
...
_ZL13activation_ssfiRKN4ncnn3MatE.exit1540.thread2946: ; preds = %._crit_edge3703
  %i.ept = load ptr, ptr %8, align 8, !tbaa !19
  %i.epu = load float, ptr %i.ept, align 4, !tbaa !48
  %i.epv = fcmp fast ogt <2 x float> %i.epr, zeroinitializer
  %i.epw = insertelement <2 x float> poison, float %i.epu, i64 0
  %i.epx = shufflevector <2 x float> %i.epw, <2 x float> poison, <2 x i32> zeroinitializer
  %i.epy = select <2 x i1> %i.epv, <2 x float> splat (float 1.000000e+00), <2 x float> %i.epx
  %i.epz = fmul fast <2 x float> %i.epy, %i.epr
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit1539

_ZL13activation_ssfiRKN4ncnn3MatE.exit1540.thread2940: ; preds = %._crit_edge3703
  %i.eqa = load ptr, ptr %8, align 8, !tbaa !19   ; 2 uses
  %i.eqb = load float, ptr %i.eqa, align 4, !tbaa !48 ; 2 uses
  %i.eqc = getelementptr inbounds nuw i8, ptr %i.eqa, i64 4
  %i.eqd = load float, ptr %i.eqc, align 4, !tbaa !48 ; 3 uses
  %i.eqe = extractelement <2 x float> %i.epr, i64 0
  %spec.select = call nnan ninf nsz float @llvm.maxnum.f32(float %i.eqe, float %i.eqb) ; 2 uses
  %i.eqf = fcmp fast ogt float %spec.select, %i.eqd
  %.126812942 = select i1 %i.eqf, float %i.eqd, float %spec.select
  %i.eqg = extractelement <2 x float> %i.epr, i64 1
  %.02682 = call nnan ninf nsz float @llvm.maxnum.f32(float %i.eqg, float %i.eqb)
  %spec.select2967 = call nnan ninf nsz float @llvm.minnum.f32(float %.02682, float %i.eqd)
end_hunk_14
begin_hunk_15_@_ZN4ncnnL26convolution1d_packed_bf16sERKNS_3MatERS0_S2_S2_iiiiS2_RKNS_6OptionE:bb.a
  %i.fff = shl nuw <8 x i32> %i.ffe, splat (i32 16)
  %i.ffg = bitcast <8 x i32> %i.fff to <8 x float>
  %i.ffh = load <8 x i16>, ptr %.143799, align 16, !tbaa !45 ; 2 uses
  ...
  %i.ffj = shufflevector <8 x i16> <i16 poison, i16 poison, i16 poison, i16 poison, i16 0, i16 0, i16 0, i16 0>, <8 x i16> %i.ffh, <8 x i32> <i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
  %i.ffk = shufflevector <8 x i16> %i.ffi, <8 x i16> %i.ffj, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.ffl = bitcast <16 x i16> %i.ffk to <8 x float>
  %i.ffm = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.ffg, <8 x float> nofpclass(nan inf) %i.ffl, <8 x float> nofpclass(nan inf) %.528563798) ; 2 uses
  %i.ffn = getelementptr inbounds [2 x i8], ptr %.43800, i64 %i.fcs
  %i.ffo = getelementptr inbounds nuw i8, ptr %.143799, i64 16
  %i.ffp = add nuw nsw i32 %.012463801, 1         ; 2 uses
  %exitcond4307.not = icmp eq i32 %i.ffp, %i.fbw
  br i1 %exitcond4307.not, label %.loopexit2973.loopexit, label %.lr.ph3802, !llvm.loop !475

.loopexit2973.loopexit:                           ; preds = %.lr.ph3802
  %scevgep4305 = getelementptr i8, ptr %.93806, i64 16
  %scevgep4306.a = getelementptr i8, ptr %scevgep4305, i64 %i.fcv
  br label %.loopexit2973

.loopexit2973:                                    ; preds = %bb.bf, %.loopexit2974.loopexit, %.loopexit2976.thread, %.loopexit2973.loopexit, %.loopexit2974
  %.62857 = phi nsz <8 x float> [ %.028513805, %.loopexit2974 ], [ %i.ffm, %.loopexit2973.loopexit ], [ %i.fdi, %.loopexit2976.thread ], [ %i.fec, %.loopexit2974.loopexit ], [ %.028513805, %bb.bf ] ; 2 uses
  %.15 = phi ptr [ %.93806, %.loopexit2974 ], [ %scevgep4306.a, %.loopexit2973.loopexit ], [ %scevgep4300.a, %.loopexit2976.thread ], [ %scevgep4303.a, %.loopexit2974.loopexit ], [ %.93806, %bb.bf ] ; 2 uses
  %i.ffq = add nuw nsw i32 %.112683807, 8         ; 3 uses
  %i.ffr = or disjoint i32 %i.ffq, 7
  %i.ffs = icmp slt i32 %i.ffr, %i.o
  br i1 %i.ffs, label %bb.be, label %._crit_edge3810, !llvm.loop !476
...
._crit_edge3810:                                  ; preds = %.loopexit2973, %._crit_edge3772
  ...
  %.11268.lcssa = phi i32 [ %.01267.lcssa, %._crit_edge3772 ], [ %i.ffq, %.loopexit2973 ] ; 3 uses
  %i.fft = shufflevector <8 x float> %.02851.lcssa, <8 x float> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %i.ffu = shufflevector <8 x float> %.02851.lcssa, <8 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.ffv = fadd fast <4 x float> %i.fft, %i.ffu   ; 2 uses
  %i.ffw = or disjoint i32 %.11268.lcssa, 3
  %i.ffx = icmp slt i32 %i.ffw, %i.o
  br i1 %i.ffx, label %.lr.ph3837, label %._crit_edge3838

.lr.ph3837:                                       ; preds = %._crit_edge3810
  %i.ffy = load ptr, ptr %0, align 8, !tbaa !19
  %i.ffz = load i32, ptr %i.p, align 4, !tbaa !55
  %i.fga = sext i32 %i.ffz to i64
  %i.fgb = load i64, ptr %i.dow, align 8, !tbaa !44
  %factor.op.mul3842 = mul i64 %i.fgb, %i.fga
  %i.fgc = trunc nuw nsw i64 %indvars.iv4327 to i32
  %.reass3900 = mul i32 %factor.op.mul3895, %i.fgc
  %i.fgd = sext i32 %.reass3900 to i64
  %invariant.gep3844 = getelementptr [2 x i8], ptr %i.ffy, i64 %i.fgd
  %i.fge = load i32, ptr %i.a, align 4            ; 6 uses
  %i.fgf = icmp slt i32 %i.fge, 1                 ; 2 uses
  %i.fgg = load i32, ptr %i.b, align 4            ; 2 uses
  %i.fgh = shl nsw i32 %i.fgg, 2
  %i.fgi = sext i32 %i.fgh to i64                 ; 2 uses
  %i.fgj = load i32, ptr %i.e, align 4            ; 3 uses
  %i.fgk = mul nsw i32 %i.fgj, 3
  %i.fgl = sext i32 %i.fgk to i64
  %i.fgm = shl nsw i32 %i.fgj, 1
  %i.fgn = sext i32 %i.fgm to i64
  %i.fgo = sext i32 %i.fgj to i64
  %i.fgp = sext i32 %i.fgg to i64
  %i.fgq = add i32 %i.fge, -1                     ; 2 uses
  %i.fgr = zext i32 %i.fgq to i64
  %i.fgs = shl nuw nsw i64 %i.fgr, 3              ; 2 uses
  %brmerge3931 = select i1 %i.dpc, i1 true, i1 %i.fgf
  %brmerge3934 = select i1 %i.dpa, i1 true, i1 %i.fgf
  %xtraiter4907 = and i32 %i.fge, 1
  %i.fgt = icmp eq i32 %i.fgq, 0
  %unroll_iter4911 = and i32 %i.fge, 2147483646
  %lcmp.mod4908.not = icmp eq i32 %xtraiter4907, 0
  %lcmp.mod4910 = trunc i32 %i.fge to i1
  br label %bb.bg

bb.bg:                                            ; preds = %.lr.ph3837, %.loopexit
  %.212693835 = phi i32 [ %.11268.lcssa, %.lr.ph3837 ], [ %i.fjh, %.loopexit ] ; 2 uses
  ...
  %i.fgu = sdiv i32 %.212693835, %i.l
  %i.fgv = sext i32 %i.fgu to i64
  %.reass3843 = mul i64 %factor.op.mul3842, %i.fgv
...
.lr.ph3822.preheader:                             ; preds = %bb.bg
  br i1 %i.fgt, label %.lr.ph3822.epil.preheader, label %.lr.ph3822

.lr.ph3822:                                       ; preds = %.lr.ph3822.preheader, %.lr.ph3822
  %.012453820 = phi ptr [ %i.fhu, %.lr.ph3822 ], [ %gep3845, %.lr.ph3822.preheader ] ; 2 uses
  %.173819 = phi ptr [ %i.fhv, %.lr.ph3822 ], [ %.163834, %.lr.ph3822.preheader ] ; 3 uses
  %.127773818 = phi <4 x float> [ %i.fht, %.lr.ph3822 ], [ %.027763833, %.lr.ph3822.preheader ]
  %niter4912 = phi i32 [ %niter4912.next.1, %.lr.ph3822 ], [ 0, %.lr.ph3822.preheader ]
  %i.fgw = load i64, ptr %.012453820, align 1, !tbaa !45
  %i.fgx = insertelement <2 x i64> poison, i64 %i.fgw, i64 0
  %i.fgy = bitcast <2 x i64> %i.fgx to <8 x i16>
  %i.fgz = shufflevector <8 x i16> <i16 0, i16 0, i16 0, i16 0, i16 poison, i16 poison, i16 poison, i16 poison>, <8 x i16> %i.fgy, <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
  %i.fha = bitcast <8 x i16> %i.fgz to <4 x float>
  %i.fhb = load i64, ptr %.173819, align 1, !tbaa !45
  %i.fhc = insertelement <2 x i64> poison, i64 %i.fhb, i64 0
  %i.fhd = bitcast <2 x i64> %i.fhc to <8 x i16>
  %i.fhe = shufflevector <8 x i16> <i16 0, i16 0, i16 0, i16 0, i16 poison, i16 poison, i16 poison, i16 poison>, <8 x i16> %i.fhd, <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
  %i.fhf = bitcast <8 x i16> %i.fhe to <4 x float>
  %i.fhg = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.fha, <4 x float> nofpclass(nan inf) %i.fhf, <4 x float> nofpclass(nan inf) %.127773818)
  %i.fhh = getelementptr inbounds [2 x i8], ptr %.012453820, i64 %i.fgi ; 2 uses
  %i.fhi = getelementptr inbounds nuw i8, ptr %.173819, i64 8
  %i.fhj = load i64, ptr %i.fhh, align 1, !tbaa !45
  %i.fhk = insertelement <2 x i64> poison, i64 %i.fhj, i64 0
  %i.fhl = bitcast <2 x i64> %i.fhk to <8 x i16>
  %i.fhm = shufflevector <8 x i16> <i16 0, i16 0, i16 0, i16 0, i16 poison, i16 poison, i16 poison, i16 poison>, <8 x i16> %i.fhl, <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
  %i.fhn = bitcast <8 x i16> %i.fhm to <4 x float>
  %i.fho = load i64, ptr %i.fhi, align 1, !tbaa !45
  %i.fhp = insertelement <2 x i64> poison, i64 %i.fho, i64 0
  %i.fhq = bitcast <2 x i64> %i.fhp to <8 x i16>
  %i.fhr = shufflevector <8 x i16> <i16 0, i16 0, i16 0, i16 0, i16 poison, i16 poison, i16 poison, i16 poison>, <8 x i16> %i.fhq, <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
  %i.fhs = bitcast <8 x i16> %i.fhr to <4 x float>
  %i.fht = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.fhn, <4 x float> nofpclass(nan inf) %i.fhs, <4 x float> nofpclass(nan inf) %i.fhg) ; 3 uses
  %i.fhu = getelementptr inbounds [2 x i8], ptr %i.fhh, i64 %i.fgi ; 2 uses
  %i.fhv = getelementptr inbounds nuw i8, ptr %.173819, i64 16 ; 2 uses
  %niter4912.next.1 = add nuw nsw i32 %niter4912, 2 ; 2 uses
  %niter4912.ncmp.1 = icmp eq i32 %niter4912.next.1, %unroll_iter4911
  br i1 %niter4912.ncmp.1, label %.loopexit2971.thread.unr-lcssa, label %.lr.ph3822, !llvm.loop !477

.loopexit2971.thread.unr-lcssa:                   ; preds = %.lr.ph3822
  br i1 %lcmp.mod4908.not, label %.loopexit2971.thread, label %.lr.ph3822.epil.preheader

.lr.ph3822.epil.preheader:                        ; preds = %.loopexit2971.thread.unr-lcssa, %.lr.ph3822.preheader
  %.012453820.epil.init = phi ptr [ %gep3845, %.lr.ph3822.preheader ], [ %i.fhu, %.loopexit2971.thread.unr-lcssa ]
  %.173819.epil.init = phi ptr [ %.163834, %.lr.ph3822.preheader ], [ %i.fhv, %.loopexit2971.thread.unr-lcssa ]
  %.127773818.epil.init = phi <4 x float> [ %.027763833, %.lr.ph3822.preheader ], [ %i.fht, %.loopexit2971.thread.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod4910)
  %i.fhw = load i64, ptr %.012453820.epil.init, align 1, !tbaa !45
  %i.fhx = insertelement <2 x i64> poison, i64 %i.fhw, i64 0
  %i.fhy = bitcast <2 x i64> %i.fhx to <8 x i16>
  %i.fhz = shufflevector <8 x i16> <i16 0, i16 0, i16 0, i16 0, i16 poison, i16 poison, i16 poison, i16 poison>, <8 x i16> %i.fhy, <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
  %i.fia = bitcast <8 x i16> %i.fhz to <4 x float>
  %i.fib = load i64, ptr %.173819.epil.init, align 1, !tbaa !45
  %i.fic = insertelement <2 x i64> poison, i64 %i.fib, i64 0
  %i.fid = bitcast <2 x i64> %i.fic to <8 x i16>
  %i.fie = shufflevector <8 x i16> <i16 0, i16 0, i16 0, i16 0, i16 poison, i16 poison, i16 poison, i16 poison>, <8 x i16> %i.fid, <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
  %i.fif = bitcast <8 x i16> %i.fie to <4 x float>
  %i.fig = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.fia, <4 x float> nofpclass(nan inf) %i.fif, <4 x float> nofpclass(nan inf) %.127773818.epil.init)
  br label %.loopexit2971.thread

.loopexit2971.thread:                             ; preds = %.loopexit2971.thread.unr-lcssa, %.lr.ph3822.epil.preheader
  %.lcssa4775 = phi <4 x float> [ %i.fht, %.loopexit2971.thread.unr-lcssa ], [ %i.fig, %.lr.ph3822.epil.preheader ]
  %scevgep4308 = getelementptr i8, ptr %.163834, i64 8
  %scevgep4309.a = getelementptr i8, ptr %scevgep4308, i64 %i.fgs
  br label %.loopexit
...
.lr.ph3830:                                       ; preds = %.loopexit2971, %.lr.ph3830
  %.012433829 = phi i32 [ %i.fjg, %.lr.ph3830 ], [ 0, %.loopexit2971 ]
  %.23828 = phi ptr [ %i.fje, %.lr.ph3830 ], [ %gep3845, %.loopexit2971 ] ; 5 uses
  %.193827 = phi ptr [ %i.fjf, %.lr.ph3830 ], [ %.163834, %.loopexit2971 ] ; 2 uses
  %.327793826 = phi <4 x float> [ %i.fjd, %.lr.ph3830 ], [ %.027763833, %.loopexit2971 ]
  %i.fih = getelementptr inbounds [2 x i8], ptr %.23828, i64 %i.fgl
  %i.fii = load i16, ptr %i.fih, align 2, !tbaa !70
  %i.fij = getelementptr inbounds [2 x i8], ptr %.23828, i64 %i.fgn
  %i.fik = load i16, ptr %i.fij, align 2, !tbaa !70
  %i.fil = getelementptr inbounds [2 x i8], ptr %.23828, i64 %i.fgo
  %i.fim = load i16, ptr %i.fil, align 2, !tbaa !70
  %i.fin = load i16, ptr %.23828, align 2, !tbaa !70
  %i.fio = zext i16 %i.fii to i32
  %i.fip = zext i16 %i.fik to i32
  %i.fiq = zext i16 %i.fim to i32
  %i.fir = zext i16 %i.fin to i32
  %i.fis = insertelement <4 x i32> poison, i32 %i.fir, i64 0
  %i.fit = insertelement <4 x i32> %i.fis, i32 %i.fiq, i64 1
  %i.fiu = insertelement <4 x i32> %i.fit, i32 %i.fip, i64 2
  %i.fiv = insertelement <4 x i32> %i.fiu, i32 %i.fio, i64 3
  %i.fiw = shl nuw <4 x i32> %i.fiv, splat (i32 16)
  %i.fix = bitcast <4 x i32> %i.fiw to <4 x float>
  %i.fiy = load i64, ptr %.193827, align 1, !tbaa !45
  %i.fiz = insertelement <2 x i64> poison, i64 %i.fiy, i64 0
  %i.fja = bitcast <2 x i64> %i.fiz to <8 x i16>
  %i.fjb = shufflevector <8 x i16> <i16 0, i16 0, i16 0, i16 0, i16 poison, i16 poison, i16 poison, i16 poison>, <8 x i16> %i.fja, <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
  %i.fjc = bitcast <8 x i16> %i.fjb to <4 x float>
  %i.fjd = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.fix, <4 x float> nofpclass(nan inf) %i.fjc, <4 x float> nofpclass(nan inf) %.327793826) ; 2 uses
  %i.fje = getelementptr inbounds [2 x i8], ptr %.23828, i64 %i.fgp
  %i.fjf = getelementptr inbounds nuw i8, ptr %.193827, i64 8
  %i.fjg = add nuw nsw i32 %.012433829, 1         ; 2 uses
  %exitcond4313.not = icmp eq i32 %i.fjg, %i.fge
  br i1 %exitcond4313.not, label %.loopexit.loopexit, label %.lr.ph3830, !llvm.loop !478

.loopexit.loopexit:                               ; preds = %.lr.ph3830
  %scevgep4311 = getelementptr i8, ptr %.163834, i64 8
  %scevgep4312.a = getelementptr i8, ptr %scevgep4311, i64 %i.fgs
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit2971.thread, %.loopexit.loopexit, %.loopexit2971
  %.42780 = phi nsz <4 x float> [ %.027763833, %.loopexit2971 ], [ %i.fjd, %.loopexit.loopexit ], [ %.lcssa4775, %.loopexit2971.thread ] ; 2 uses
  %.20 = phi ptr [ %.163834, %.loopexit2971 ], [ %scevgep4312.a, %.loopexit.loopexit ], [ %scevgep4309.a, %.loopexit2971.thread ] ; 2 uses
  %i.fjh = add nuw nsw i32 %.212693835, 4         ; 3 uses
  %i.fji = or disjoint i32 %i.fjh, 3
  %i.fjj = icmp slt i32 %i.fji, %i.o
  br i1 %i.fjj, label %bb.bg, label %._crit_edge3838, !llvm.loop !479
...
._crit_edge3838:                                  ; preds = %.loopexit, %._crit_edge3810
  ...
  %.21269.lcssa = phi i32 [ %.11268.lcssa, %._crit_edge3810 ], [ %i.fjh, %.loopexit ] ; 6 uses
  %i.fjk = shufflevector <4 x float> %.02776.lcssa, <4 x float> %i.ffv, <4 x i32> <i32 3, i32 2, i32 7, i32 6>
  %i.fjl = shufflevector <4 x float> %.02776.lcssa, <4 x float> %i.ffv, <4 x i32> <i32 1, i32 0, i32 5, i32 4>
  %i.fjm = fadd fast <4 x float> %i.fjk, %i.fjl
  %op.rdx = call fast float @llvm.vector.reduce.fadd.v4f32(float %i.fbm, <4 x float> %i.fjm)
  %op.rdx4766 = call fast float @llvm.vector.reduce.fadd.v8f32(float %.01279, <8 x float> %i.fbn)
  %op.rdx4767 = fadd fast float %op.rdx, %op.rdx4766 ; 3 uses
  %i.fjn = or disjoint i32 %.21269.lcssa, 1
  %i.fjo = icmp slt i32 %i.fjn, %i.o
  br i1 %i.fjo, label %.lr.ph3859, label %.preheader2983

.lr.ph3859:                                       ; preds = %._crit_edge3838
  %i.fjp = load ptr, ptr %0, align 8, !tbaa !19
  %i.fjq = load i32, ptr %i.p, align 4, !tbaa !55
  %i.fjr = sext i32 %i.fjq to i64
  %i.fjs = load i64, ptr %i.dow, align 8, !tbaa !44
  %factor.op.mul3863 = mul i64 %i.fjs, %i.fjr
  %i.fjt = mul nsw i64 %indvars.iv4327, %i.etc
  %invariant.gep3865 = getelementptr [2 x i8], ptr %i.fjp, i64 %i.fjt
  %i.fju = load i32, ptr %i.e, align 4
  %i.fjv = sext i32 %i.fju to i64
  %i.fjw = load i32, ptr %i.b, align 4
  %i.fjx = sext i32 %i.fjw to i64
  br i1 %i.esx, label %.lr.ph3851.us.preheader, label %.lr.ph3859.split.preheader

.lr.ph3859.split.preheader:                       ; preds = %.lr.ph3859
  %i.fjy = add i32 %.21269.lcssa, 2
  %16 = add i32 %.21269.lcssa, 3
  %smax4314 = call i32 @llvm.smax.i32(i32 %i.o, i32 %16)
  %17 = add i32 %smax4314, -2
  %i.fjz = sub i32 %17, %.21269.lcssa
  %i.fka = and i32 %i.fjz, -2
  %i.fkb = add i32 %i.fjy, %i.fka
  br label %.preheader2983

.lr.ph3851.us.preheader:                          ; preds = %.lr.ph3859
  %i.fkc = zext i32 %.21269.lcssa to i64
  br label %.lr.ph3851.us

.lr.ph3851.us:                                    ; preds = %.lr.ph3851.us.preheader, %._crit_edge3852.us
  %indvars.iv4318 = phi i64 [ %i.fkc, %.lr.ph3851.us.preheader ], [ %indvars.iv.next4319, %._crit_edge3852.us ] ; 2 uses
  %.213856.us = phi ptr [ %.16.lcssa, %.lr.ph3851.us.preheader ], [ %scevgep4316, %._crit_edge3852.us ] ; 2 uses
  %.112803855.us = phi float [ %op.rdx4767, %.lr.ph3851.us.preheader ], [ %i.fky, %._crit_edge3852.us ]
  %.reass3864.us = mul i64 %factor.op.mul3863, %indvars.iv4318
  %gep3866.us = getelementptr i8, ptr %invariant.gep3865, i64 %.reass3864.us
  br label %bb.bh

bb.bh:                                            ; preds = %.lr.ph3851.us, %bb.bh
  %.012413849.us = phi i32 [ 0, %.lr.ph3851.us ], [ %i.flb, %bb.bh ]
  %.012423848.us = phi ptr [ %gep3866.us, %.lr.ph3851.us ], [ %i.fkz, %bb.bh ] ; 3 uses
  %.223847.us = phi ptr [ %.213856.us, %.lr.ph3851.us ], [ %i.fla, %bb.bh ] ; 3 uses
  %.212813846.us = phi float [ %.112803855.us, %.lr.ph3851.us ], [ %i.fky, %bb.bh ]
  %i.fkd = load i16, ptr %.012423848.us, align 2, !tbaa !70
  %i.fke = zext i16 %i.fkd to i32
  %i.fkf = shl nuw i32 %i.fke, 16
  %i.fkg = bitcast i32 %i.fkf to float
  %i.fkh = load i16, ptr %.223847.us, align 2, !tbaa !70
  %i.fki = zext i16 %i.fkh to i32
  %i.fkj = shl nuw i32 %i.fki, 16
  %i.fkk = bitcast i32 %i.fkj to float
  %i.fkl = fmul fast float %i.fkk, %i.fkg
  %i.fkm = fadd fast float %.212813846.us, %i.fkl
  %i.fkn = getelementptr inbounds [2 x i8], ptr %.012423848.us, i64 %i.fjv
  %i.fko = load i16, ptr %i.fkn, align 2, !tbaa !70
  %i.fkp = zext i16 %i.fko to i32
  %i.fkq = shl nuw i32 %i.fkp, 16
  %i.fkr = bitcast i32 %i.fkq to float
  %i.fks = getelementptr inbounds nuw i8, ptr %.223847.us, i64 2
  %i.fkt = load i16, ptr %i.fks, align 2, !tbaa !70
  %i.fku = zext i16 %i.fkt to i32
  %i.fkv = shl nuw i32 %i.fku, 16
  %i.fkw = bitcast i32 %i.fkv to float
  %i.fkx = fmul fast float %i.fkw, %i.fkr
  %i.fky = fadd fast float %i.fkx, %i.fkm         ; 3 uses
  %i.fkz = getelementptr inbounds [2 x i8], ptr %.012423848.us, i64 %i.fjx
  %i.fla = getelementptr inbounds nuw i8, ptr %.223847.us, i64 4
  %i.flb = add nuw nsw i32 %.012413849.us, 1      ; 2 uses
  %exitcond4317.not = icmp eq i32 %i.flb, %i.esw
  br i1 %exitcond4317.not, label %._crit_edge3852.us, label %bb.bh, !llvm.loop !480

._crit_edge3852.us:                               ; preds = %bb.bh
  %scevgep4315 = getelementptr i8, ptr %.213856.us, i64 4
  %scevgep4316 = getelementptr i8, ptr %scevgep4315, i64 %i.eta ; 2 uses
  %indvars.iv.next4319 = add nuw nsw i64 %indvars.iv4318, 2 ; 3 uses
  %i.flc = trunc i64 %indvars.iv.next4319 to i32
  %i.fld = or i32 %i.flc, 1
  %i.fle = icmp slt i32 %i.fld, %i.o
  br i1 %i.fle, label %.lr.ph3851.us, label %.preheader2983.loopexit, !llvm.loop !481

.preheader2983.loopexit:                          ; preds = %._crit_edge3852.us
  %i.flf = trunc nuw i64 %indvars.iv.next4319 to i32
  br label %.preheader2983

.preheader2983:                                   ; preds = %.lr.ph3859.split.preheader, %.preheader2983.loopexit, %._crit_edge3838
  %.11280.lcssa = phi float [ %op.rdx4767, %._crit_edge3838 ], [ %i.fky, %.preheader2983.loopexit ], [ %op.rdx4767, %.lr.ph3859.split.preheader ] ; 3 uses
  %.21.lcssa = phi ptr [ %.16.lcssa, %._crit_edge3838 ], [ %scevgep4316, %.preheader2983.loopexit ], [ %.16.lcssa, %.lr.ph3859.split.preheader ]
  %.31270.lcssa = phi i32 [ %.21269.lcssa, %._crit_edge3838 ], [ %i.flf, %.preheader2983.loopexit ], [ %i.fkb, %.lr.ph3859.split.preheader ] ; 2 uses
  %i.flg = icmp slt i32 %.31270.lcssa, %i.o
  br i1 %i.flg, label %.lr.ph3882, label %._crit_edge3883

.lr.ph3882:                                       ; preds = %.preheader2983
  %i.flh = load ptr, ptr %0, align 8, !tbaa !19
  %i.fli = load i32, ptr %i.p, align 4, !tbaa !55
  %i.flj = sext i32 %i.fli to i64
  %i.flk = load i64, ptr %i.dow, align 8, !tbaa !44
  %factor.op.mul3885 = mul i64 %i.flk, %i.flj
  %i.fll = mul nsw i64 %indvars.iv4327, %i.etc
  %invariant.gep3887 = getelementptr [2 x i8], ptr %i.flh, i64 %i.fll
  %i.flm = load i32, ptr %i.b, align 4
  %i.fln = sext i32 %i.flm to i64                 ; 2 uses
  br i1 %i.esx, label %.lr.ph3875.us.preheader, label %._crit_edge3883

.lr.ph3875.us.preheader:                          ; preds = %.lr.ph3882
  %i.flo = zext i32 %.31270.lcssa to i64
  br label %.lr.ph3875.us

.lr.ph3875.us:                                    ; preds = %.lr.ph3875.us.preheader, %._crit_edge3876.us
  %indvars.iv4324 = phi i64 [ %i.flo, %.lr.ph3875.us.preheader ], [ %indvars.iv.next4325.a, %._crit_edge3876.us ] ; 2 uses
  %.233880.us = phi ptr [ %.21.lcssa, %.lr.ph3875.us.preheader ], [ %scevgep4322, %._crit_edge3876.us ] ; 3 uses
  %.312823879.us = phi float [ %.11280.lcssa, %.lr.ph3875.us.preheader ], [ %.lcssa4779, %._crit_edge3876.us ] ; 2 uses
  %.reass3886.us = mul i64 %factor.op.mul3885, %indvars.iv4324
  %gep3888.us = getelementptr i8, ptr %invariant.gep3887, i64 %.reass3886.us ; 2 uses
  br i1 %i.etd, label %.epil.preheader4913, label %.lr.ph3875.us.new

.lr.ph3875.us.new:                                ; preds = %.lr.ph3875.us, %.lr.ph3875.us.new
  %.012403872.us = phi ptr [ %i.fml, %.lr.ph3875.us.new ], [ %gep3888.us, %.lr.ph3875.us ] ; 2 uses
  %.243871.us = phi ptr [ %i.fmm, %.lr.ph3875.us.new ], [ %.233880.us, %.lr.ph3875.us ] ; 3 uses
  %.412833870.us = phi float [ %i.fmk, %.lr.ph3875.us.new ], [ %.312823879.us, %.lr.ph3875.us ]
  %niter4919 = phi i32 [ %niter4919.next.1, %.lr.ph3875.us.new ], [ 0, %.lr.ph3875.us ]
  %i.flp = load i16, ptr %.012403872.us, align 2, !tbaa !70
  %i.flq = zext i16 %i.flp to i32
  %i.flr = shl nuw i32 %i.flq, 16
  %i.fls = bitcast i32 %i.flr to float
  %i.flt = load i16, ptr %.243871.us, align 2, !tbaa !70
  %i.flu = zext i16 %i.flt to i32
  %i.flv = shl nuw i32 %i.flu, 16
  %i.flw = bitcast i32 %i.flv to float
  %i.flx = fmul fast float %i.flw, %i.fls
  %i.fly = fadd fast float %i.flx, %.412833870.us
  %i.flz = getelementptr inbounds [2 x i8], ptr %.012403872.us, i64 %i.fln ; 2 uses
  %i.fma = getelementptr inbounds nuw i8, ptr %.243871.us, i64 2
  %i.fmb = load i16, ptr %i.flz, align 2, !tbaa !70
  %i.fmc = zext i16 %i.fmb to i32
  %i.fmd = shl nuw i32 %i.fmc, 16
  %i.fme = bitcast i32 %i.fmd to float
  %i.fmf = load i16, ptr %i.fma, align 2, !tbaa !70
  %i.fmg = zext i16 %i.fmf to i32
  %i.fmh = shl nuw i32 %i.fmg, 16
  %i.fmi = bitcast i32 %i.fmh to float
  %i.fmj = fmul fast float %i.fmi, %i.fme
  %i.fmk = fadd fast float %i.fmj, %i.fly         ; 3 uses
  %i.fml = getelementptr inbounds [2 x i8], ptr %i.flz, i64 %i.fln ; 2 uses
  %i.fmm = getelementptr inbounds nuw i8, ptr %.243871.us, i64 4 ; 2 uses
  %niter4919.next.1 = add nuw nsw i32 %niter4919, 2 ; 2 uses
  %niter4919.ncmp.1 = icmp eq i32 %niter4919.next.1, %unroll_iter4918
  br i1 %niter4919.ncmp.1, label %._crit_edge3876.us.unr-lcssa, label %.lr.ph3875.us.new, !llvm.loop !482

._crit_edge3876.us.unr-lcssa:                     ; preds = %.lr.ph3875.us.new
  br i1 %lcmp.mod4915.not, label %._crit_edge3876.us, label %.epil.preheader4913

.epil.preheader4913:                              ; preds = %._crit_edge3876.us.unr-lcssa, %.lr.ph3875.us
  %.012403872.us.epil.init = phi ptr [ %gep3888.us, %.lr.ph3875.us ], [ %i.fml, %._crit_edge3876.us.unr-lcssa ]
  %.243871.us.epil.init = phi ptr [ %.233880.us, %.lr.ph3875.us ], [ %i.fmm, %._crit_edge3876.us.unr-lcssa ]
  %.412833870.us.epil.init = phi float [ %.312823879.us, %.lr.ph3875.us ], [ %i.fmk, %._crit_edge3876.us.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod4917)
  %i.fmn = load i16, ptr %.012403872.us.epil.init, align 2, !tbaa !70
  %i.fmo = zext i16 %i.fmn to i32
  %i.fmp = shl nuw i32 %i.fmo, 16
  %i.fmq = bitcast i32 %i.fmp to float
  %i.fmr = load i16, ptr %.243871.us.epil.init, align 2, !tbaa !70
  %i.fms = zext i16 %i.fmr to i32
  %i.fmt = shl nuw i32 %i.fms, 16
  %i.fmu = bitcast i32 %i.fmt to float
  %i.fmv = fmul fast float %i.fmu, %i.fmq
  %i.fmw = fadd fast float %i.fmv, %.412833870.us.epil.init
  br label %._crit_edge3876.us

._crit_edge3876.us:                               ; preds = %._crit_edge3876.us.unr-lcssa, %.epil.preheader4913
  %.lcssa4779 = phi float [ %i.fmk, %._crit_edge3876.us.unr-lcssa ], [ %i.fmw, %.epil.preheader4913 ] ; 2 uses
  %scevgep4321 = getelementptr i8, ptr %.233880.us, i64 2
  %scevgep4322 = getelementptr i8, ptr %scevgep4321, i64 %i.etb
  %indvars.iv.next4325.a = add nuw nsw i64 %indvars.iv4324, 1 ; 2 uses
  %i.fmx = trunc nuw i64 %indvars.iv.next4325.a to i32
  %i.fmy = icmp sgt i32 %i.o, %i.fmx
  br i1 %i.fmy, label %.lr.ph3875.us, label %._crit_edge3883, !llvm.loop !483

._crit_edge3883:                                  ; preds = %._crit_edge3876.us, %.lr.ph3882, %.preheader2983
  %.31282.lcssa = phi float [ %.11280.lcssa, %.preheader2983 ], [ %.11280.lcssa, %.lr.ph3882 ], [ %.lcssa4779, %._crit_edge3876.us ] ; 13 uses
...
bb.bi:                                            ; preds = %._crit_edge3883
  %i.fmz = call fast float @llvm.maxnum.f32(float nofpclass(nan inf) %.31282.lcssa, float 0.000000e+00)
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

bb.bj:                                            ; preds = %._crit_edge3883
  %i.fna = load ptr, ptr %8, align 8, !tbaa !19
  %i.fnb = load float, ptr %i.fna, align 4, !tbaa !48
  %i.fnc = fcmp fast ogt float %.31282.lcssa, 0.000000e+00
  %i.fnd = select fast i1 %i.fnc, float 1.000000e+00, float %i.fnb
  %i.fne = fmul fast float %i.fnd, %.31282.lcssa
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

bb.bk:                                            ; preds = %._crit_edge3883
  %i.fnf = load ptr, ptr %8, align 8, !tbaa !19   ; 2 uses
  %i.fng = load float, ptr %i.fnf, align 4, !tbaa !48
  %i.fnh = getelementptr inbounds nuw i8, ptr %i.fnf, i64 4
  %i.fni = load float, ptr %i.fnh, align 4, !tbaa !48
  %spec.select2965 = call nnan ninf nsz float @llvm.maxnum.f32(float %.31282.lcssa, float %i.fng)
  %spec.select2966 = call nnan ninf nsz float @llvm.minnum.f32(float %spec.select2965, float %i.fni)
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit
...
bb.bl:                                            ; preds = %._crit_edge3883
  ...
  %i.fnj = fneg fast float %.sroa.speculated
  %i.fnk = call fast float @llvm.exp.f32(float %i.fnj)
  %i.fnl = fadd fast float %i.fnk, 1.000000e+00
  %i.fnm = fdiv fast float 1.000000e+00, %i.fnl
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

bb.bm:                                            ; preds = %._crit_edge3883
  %i.fnn = call fast float @llvm.exp.f32(float nofpclass(nan inf) %.31282.lcssa)
  %i.fno = fadd fast float %i.fnn, 1.000000e+00
  %i.fnp = call fast float @llvm.log.f32(float %i.fno)
  %i.fnq = call fast float @llvm.tanh.f32(float %i.fnp)
  %i.fnr = fmul fast float %i.fnq, %.31282.lcssa
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

bb.bn:                                            ; preds = %._crit_edge3883
  %i.fns = load ptr, ptr %8, align 8, !tbaa !19   ; 2 uses
  %i.fnt = load float, ptr %i.fns, align 4, !tbaa !48 ; 3 uses
  %i.fnu = getelementptr inbounds nuw i8, ptr %i.fns, i64 4
  %i.fnv = load float, ptr %i.fnu, align 4, !tbaa !48 ; 2 uses
  %i.fnw = fneg fast float %i.fnv
  %i.fnx = fdiv fast float %i.fnw, %i.fnt         ; 2 uses
  %i.fny = fcmp fast olt float %.31282.lcssa, %i.fnx
  br i1 %i.fny, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit, label %bb.bo

bb.bo:                                            ; preds = %bb.bn
  %i.fnz = fdiv fast float 1.000000e+00, %i.fnt
  %i.foa = fadd fast float %i.fnx, %i.fnz
  %i.fob = fcmp fast ogt float %.31282.lcssa, %i.foa
  br i1 %i.fob, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit, label %bb.bp

bb.bp:                                            ; preds = %bb.bo
  %i.foc = fmul fast float %i.fnt, %.31282.lcssa
  %i.fod = fadd fast float %i.foc, %i.fnv
  %i.foe = fmul fast float %i.fod, %.31282.lcssa
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

_ZL13activation_ssfiRKN4ncnn3MatE.exit:           ; preds = %bb.bk, %bb.bn, %._crit_edge3883, %bb.bi, %bb.bj, %bb.bl, %bb.bm, %bb.bo, %bb.bp
  %.12685 = phi nsz float [ %.31282.lcssa, %._crit_edge3883 ], [ %i.fmz, %bb.bi ], [ %i.fne, %bb.bj ], [ 0.000000e+00, %bb.bn ], [ %spec.select2966, %bb.bk ], [ %i.fnm, %bb.bl ], [ %i.fnr, %bb.bm ], [ %i.foe, %bb.bp ], [ %.31282.lcssa, %bb.bo ]
  %i.fof = bitcast float %.12685 to i32
  %i.fog = lshr i32 %i.fof, 16
  %i.foh = trunc nuw i32 %i.fog to i16
  store i16 %i.foh, ptr %.012853890, align 2, !tbaa !70
  %i.foi = getelementptr inbounds nuw i8, ptr %.012853890, i64 2
  %indvars.iv.next4328 = add nuw nsw i64 %indvars.iv4327, 1 ; 2 uses
  %exitcond4331.not = icmp eq i64 %indvars.iv.next4328, %wide.trip.count4330
  br i1 %exitcond4331.not, label %._crit_edge3894, label %bb.az, !llvm.loop !484

bb.bq:                                            ; preds = %._crit_edge3904.split, %bb.b
  ret void
}
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %bb.d, %bb.c
  ...
  %i.ba = load ptr, ptr %6, align 8, !tbaa !19, !noalias !509
  %i.bb = load i64, ptr %i.q, align 8, !tbaa !20, !noalias !509
  %i.bc = mul i64 %i.bb, %indvars.iv1305
  %i.bd = load i64, ptr %i.r, align 8, !tbaa !44, !noalias !509
  %i.be = mul i64 %i.bc, %i.bd
  %i.bf = getelementptr inbounds nuw i8, ptr %i.ba, i64 %i.be ; 2 uses
...
bb.f:                                             ; preds = %.lr.ph, %bb.f
  ...
  %i.cf = load <16 x i16>, ptr %.1574985, align 32, !tbaa !45 ; 2 uses
  ...
  %i.cp = load <16 x i16>, ptr %i.co, align 32, !tbaa !45 ; 2 uses
  ...
  %i.cz = load <16 x i16>, ptr %i.cy, align 32, !tbaa !45 ; 2 uses
  ...
  %i.dj = load <16 x i16>, ptr %i.di, align 32, !tbaa !45 ; 2 uses
  ...
  %i.dt = load <16 x i16>, ptr %i.ds, align 32, !tbaa !45 ; 2 uses
  ...
  %i.ed = load <16 x i16>, ptr %i.ec, align 32, !tbaa !45 ; 2 uses
  ...
  %i.en = load <16 x i16>, ptr %i.em, align 32, !tbaa !45 ; 2 uses
  ...
  %i.ex = load <16 x i16>, ptr %i.ew, align 32, !tbaa !45 ; 2 uses
  ...
  %i.fh = load <16 x i16>, ptr %i.fg, align 32, !tbaa !45 ; 2 uses
  ...
  %i.fr = load <16 x i16>, ptr %i.fq, align 32, !tbaa !45 ; 2 uses
  ...
  %i.gb = load <16 x i16>, ptr %i.ga, align 32, !tbaa !45 ; 2 uses
end_hunk_15
...
.lr.ph1087:                                       ; preds = %.preheader966
  %i.ayy = load i32, ptr %10, align 4, !tbaa !58  ; 7 uses
  ...
  %i.azm = load i32, ptr %9, align 4, !tbaa !58
...
bb.p:                                             ; preds = %.lr.ph1087, %bb.p
  ...
  %i.azo = load <16 x i16>, ptr %.141084, align 32, !tbaa !45 ; 2 uses
  ...
  %i.azy = load <16 x i16>, ptr %i.azx, align 32, !tbaa !45 ; 2 uses
  ...
  %i.bai = load <16 x i16>, ptr %i.bah, align 32, !tbaa !45 ; 2 uses
  ...
  %i.bas = load <16 x i16>, ptr %i.bar, align 32, !tbaa !45 ; 2 uses
  ...
  %i.bbc = load <16 x i16>, ptr %i.bbb, align 32, !tbaa !45 ; 2 uses
  ...
  %i.bbm = load <16 x i16>, ptr %i.bbl, align 32, !tbaa !45 ; 2 uses
  ...
  %i.bbw = load <16 x i16>, ptr %i.bbv, align 32, !tbaa !45 ; 2 uses
  ...
  %i.bcg = load <16 x i16>, ptr %i.bcf, align 32, !tbaa !45 ; 2 uses
  ...
  %i.bcp = load i16, ptr %.41085, align 2, !tbaa !70
  ...
  %i.bcx = load i16, ptr %i.bcw, align 2, !tbaa !70
  ...
  %i.bdf = load i16, ptr %i.bde, align 2, !tbaa !70
  ...
  %i.bdn = load i16, ptr %i.bdm, align 2, !tbaa !70
  ...
  %i.bdv = load i16, ptr %i.bdu, align 2, !tbaa !70
  ...
  %i.bed = load i16, ptr %i.bec, align 2, !tbaa !70
  ...
  %i.bel = load i16, ptr %i.bek, align 2, !tbaa !70
  ...
  %i.bet = load i16, ptr %i.bes, align 2, !tbaa !70
...
.loopexit967:                                     ; preds = %.preheader969, %.loopexit970.loopexit, %bb.n, %.loopexit968.loopexit, %.loopexit967.loopexit, %.preheader966, %.loopexit968
  ...
  br i1 %i.bfi, label %bb.l, label %.preheader979, !llvm.loop !500
...
.preheader978:                                    ; preds = %.loopexit, %.preheader979
  ...
  %.2570.lcssa = phi i32 [ %.1569.lcssa, %.preheader979 ], [ %i.bnr, %.loopexit ] ; 6 uses
...
.lr.ph1167:                                       ; preds = %.preheader978
  %i.bfl = load ptr, ptr %3, align 8, !tbaa !19
  %i.bfm = load i32, ptr %i.s, align 4, !tbaa !55
  %i.bfn = sext i32 %i.bfm to i64
  %i.bfo = load i64, ptr %i.t, align 8, !tbaa !44
  %factor.op.mul1172 = mul i64 %i.bfo, %i.bfn
  %i.bfp = load i32, ptr %7, align 4, !tbaa !58
  %i.bfq = mul nsw i32 %i.bfp, %.06451199
  %i.bfr = sext i32 %i.bfq to i64
  %invariant.gep1174 = getelementptr [2 x i8], ptr %i.bfl, i64 %i.bfr
  %i.bfs = load i32, ptr %8, align 4, !tbaa !58   ; 3 uses
...
bb.q:                                             ; preds = %.lr.ph1159.us, %bb.q
  ...
  %i.bgg = load <16 x i16>, ptr %.221156.us, align 32, !tbaa !45 ; 2 uses
  ...
  %i.bgq = load <16 x i16>, ptr %i.bgp, align 32, !tbaa !45 ; 2 uses
  ...
  %i.bgz = load i16, ptr %.05441157.us, align 2, !tbaa !70
  ...
  %i.bhh = load i16, ptr %i.bhg, align 2, !tbaa !70
...
._crit_edge.us:                                   ; preds = %bb.q
  ...
  br i1 %i.bht, label %.lr.ph1159.us, label %.preheader977.loopexit, !llvm.loop !502
...
bb.s:                                             ; preds = %.lr.ph1117, %bb.s
  ...
  %i.bib = load <16 x i16>, ptr %.171114, align 32, !tbaa !45 ; 2 uses
  ...
  %i.bil = load <16 x i16>, ptr %i.bik, align 32, !tbaa !45 ; 2 uses
  ...
  %i.biv = load <16 x i16>, ptr %i.biu, align 32, !tbaa !45 ; 2 uses
  ...
  %i.bjf = load <16 x i16>, ptr %i.bje, align 32, !tbaa !45 ; 2 uses
  ...
  %i.bjo = load <4 x i16>, ptr %.05471115, align 2, !tbaa !70
...
.lr.ph1131:                                       ; preds = %.preheader
  ...
  %i.bkr = load i32, ptr %9, align 4, !tbaa !58
...
.thread:                                          ; preds = %_ZL17activation_avx512Dv16_fiRKN4ncnn3MatE.exit.split
  ...
  store <4 x i64> %i.buz, ptr %.06461198, align 32, !tbaa !45
...
bb.y:                                             ; preds = %_ZL17activation_avx512Dv16_fiRKN4ncnn3MatE.exit.split
  ...
  store <8 x i16> %i.bvg, ptr %.06461198, align 16, !tbaa !45
  %i.bvh = load i32, ptr %13, align 4, !tbaa !58
  ...
  store <8 x i16> %i.bvn, ptr %i.bvp, align 16, !tbaa !45
...
bb.z:                                             ; preds = %_ZL17activation_avx512Dv16_fiRKN4ncnn3MatE.exit.split
  ...
  store i64 %i.bvz, ptr %.06461198, align 1, !tbaa !45
  %i.bwa = load i32, ptr %13, align 4, !tbaa !58
  ...
  store i64 %i.bwd, ptr %i.bwc, align 1, !tbaa !45
  %i.bwe = load i32, ptr %13, align 4, !tbaa !58
  ...
  store i64 %i.bwq, ptr %i.bwh, align 1, !tbaa !45
  %i.bwr = load i32, ptr %13, align 4, !tbaa !58
  ...
  store i64 %i.bwv, ptr %i.bwu, align 1, !tbaa !45
...
bb.aa:                                            ; preds = %_ZL17activation_avx512Dv16_fiRKN4ncnn3MatE.exit.split
  ...
  store i16 %i.bwy, ptr %.06461198, align 2, !tbaa !70
  %i.bwz = extractelement <32 x i16> %i.bwx, i64 3
  %i.bxa = load i32, ptr %13, align 4, !tbaa !58  ; 15 uses
  %i.bxb = sext i32 %i.bxa to i64
  %i.bxc = getelementptr inbounds [2 x i8], ptr %.06461198, i64 %i.bxb
  store i16 %i.bwz, ptr %i.bxc, align 2, !tbaa !70
  ...
  store i16 %i.bxd, ptr %i.bxg, align 2, !tbaa !70
  ...
  store i16 %i.bxh, ptr %i.bxk, align 2, !tbaa !70
  ...
  store i16 %i.bxl, ptr %i.bxo, align 2, !tbaa !70
  ...
  store i16 %i.bxp, ptr %i.bxs, align 2, !tbaa !70
  ...
  store i16 %i.bxt, ptr %i.bxw, align 2, !tbaa !70
  ...
  store i16 %i.bxx, ptr %i.bya, align 2, !tbaa !70
  ...
  store i16 %i.byb, ptr %i.bye, align 2, !tbaa !70
  ...
  store i16 %i.byf, ptr %i.byi, align 2, !tbaa !70
  ...
  store i16 %i.byj, ptr %i.bym, align 2, !tbaa !70
  ...
  store i16 %i.byn, ptr %i.byq, align 2, !tbaa !70
  ...
  store i16 %i.byr, ptr %i.byu, align 2, !tbaa !70
  ...
  store i16 %i.byv, ptr %i.byy, align 2, !tbaa !70
  ...
  store i16 %i.byz, ptr %i.bzc, align 2, !tbaa !70
  ...
  store i16 %i.bzd, ptr %i.bzg, align 2, !tbaa !70
...
.thread962:                                       ; preds = %_ZL17activation_avx512Dv16_fiRKN4ncnn3MatE.exit, %_ZL17activation_avx512Dv16_fiRKN4ncnn3MatE.exit.split, %bb.y, %.thread, %bb.z, %bb.aa
  ...
  br i1 %exitcond1304.not, label %._crit_edge, label %bb.c, !llvm.loop !508
...
!53 = !{!"branch_weights", i32 8, i32 56}
!54 = !{!37, !21, i64 0}
!55 = !{!16, !7, i64 44}
!56 = !{!16, !7, i64 56}
!57 = !{!16, !7, i64 24}
...
!72 = !{!71}
!73 = !{ptr @_ZN4ncnn24Convolution1D_x86_avx512D2Ev}
!74 = distinct !{!74, !"_ZN4ncnn3Mat7channelEi"}
!75 = distinct !{!75, !74, !"_ZN4ncnn3Mat7channelEi: argument 0"}
!76 = distinct !{!76, !46}
!77 = distinct !{!77, !46}
!78 = distinct !{!78, !46}
!79 = distinct !{!79, !46}
...
!105 = distinct !{!105, !104, !"_ZN4ncnn3Mat7channelEi: argument 0"}
!106 = distinct !{!106, !46}
!107 = distinct !{!107, !46}
!108 = distinct !{!108, !46}
!109 = distinct !{!109, !46}
...
!120 = distinct !{!120, !119, !"_ZN4ncnn3Mat7channelEi: argument 0"}
!121 = distinct !{!121, !46}
!122 = distinct !{!122, !47}
!123 = distinct !{!123, !46}
!124 = distinct !{!124, !46}
...
!136 = distinct !{!136, !46, !49, !50}
!137 = distinct !{!137, !46, !49, !50}
!138 = distinct !{!138, !46, !49}
end_hunk_17
