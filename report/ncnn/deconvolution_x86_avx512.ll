...
_ZN4ncnn3MatD2Ev.exit2223.us.us:                  ; preds = %bb.cj
  ...
  %13 = zext i16 %i.fuw to i32
  %14 = zext i16 %i.fux to i32
  %15 = shl nuw i32 %13, 16
  %16 = shl nuw i32 %14, 16
  %17 = insertelement <2 x i32> poison, i32 %15, i64 0
  %i.fve = bitcast <2 x i32> %17 to <2 x float>
  %18 = shufflevector <2 x float> %i.fve, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fvf = fmul fast <2 x float> %18, %i.fvd
  %i.fvg = fadd fast <2 x float> %i.fvf, %i.fue
  %19 = bitcast <2 x i32> %i.fvb to <2 x float>
  %20 = insertelement <2 x i32> poison, i32 %16, i64 0
  %i.fvh = bitcast <2 x i32> %20 to <2 x float>
  %i.fvi = shufflevector <2 x float> %i.fvh, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fvj = fmul fast <2 x float> %i.fvi, %19
