...
._crit_edge.us:                                   ; preds = %.loopexit
  ...
  %17 = add nuw nsw i64 %indvars.iv.next302, %15
  %18 = icmp samesign ult i64 %17, %16
  %indvar.next5919 = add i64 %indvar5918, 1
  br i1 %18, label %.preheader197.us, label %._crit_edge248, !llvm.loop !102
...
.preheader1818.preheader.i:                       ; preds = %.preheader1818.lr.ph.i
  ...
  %i.lz = add nuw i64 %i.ly, %wide.trip.count.i
  %i.ma = shl i64 %i.lz, 2
...
.preheader1824.preheader:                         ; preds = %.preheader1824.lr.ph
  ...
  %i.v = add nuw i64 %i.u, %wide.trip.count
  %i.w = shl i64 %i.v, 2
