...
_ZN4ncnn3MatD2Ev.exit2223.us.us:                  ; preds = %bb.cj
  ...
  %20 = fmul fast <2 x float> %19, %i.fvs
  %21 = fadd fast <2 x float> %20, %i.fut
  %22 = bitcast <2 x i32> %i.fvq to <2 x float>
  %23 = insertelement <2 x i32> poison, i32 %16, i64 0
  %i.fvt = bitcast <2 x i32> %23 to <2 x float>
  %i.fvu = shufflevector <2 x float> %i.fvt, <2 x float> poison, <2 x i32> zeroinitializer
  %i.fvv = fmul fast <2 x float> %i.fvu, %22
  %i.fvw = fadd fast <2 x float> %i.fvv, %21
