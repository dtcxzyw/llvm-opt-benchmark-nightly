Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/ncnn/original/groupnorm_x86?download=true
...
begin_hunk_0_@_ZNK4ncnn13GroupNorm_x8621forward_inplace_bf16sERNS_3MatERKNS_6OptionE:bb.a
  ...
  invoke void %i.cc(ptr noundef nonnull align 8 dereferenceable(8) %i.by, ptr noundef %i.bz)
          to label %_ZN4ncnn3MatD2Ev.exit29 unwind label %bb.u, !inline_history !19

bb.s:                                             ; preds = %bb.q
  %.not.i36 = icmp eq ptr %i.bz, null
  br i1 %.not.i36, label %_ZN4ncnn3MatD2Ev.exit29, label %bb.t
...
end_hunk_0
begin_hunk_1_@_ZNK4ncnn13GroupNorm_x8615forward_inplaceERNS_3MatERKNS_6OptionE.omp_outlined.1:bb.a
...
; Function Attrs: alwaysinline norecurse nounwind uwtable
define internal void @_ZNK4ncnn13GroupNorm_x8615forward_inplaceERNS_3MatERKNS_6OptionE.omp_outlined.2(ptr noalias nofree noundef readonly captures(none) %0, ptr noalias nofree readnone captures(none) %1, ptr nofree noundef readonly captures(none) %2, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(72) %3, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %4, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %5, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %6, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(8) %7) #4 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = alloca i32, align 4                      ; 5 uses
  %i.b = alloca i32, align 4                      ; 7 uses
  %i.c = alloca i32, align 4                      ; 4 uses
