Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/ncnn/original/bnll_x86?download=true
inline.NumInlined: 2
inline.NumDeleted: 1
...
.preheader:                                       ; preds = %.lr.ph, %.noexc
  ...
  %.040.lcssa = phi ptr [ %i.v, %.noexc ], [ %i.ct, %.lr.ph ]
  %.039.lcssa = phi i32 [ 0, %.noexc ], [ %i.cu, %.lr.ph ] ; 2 uses
  %i.y = icmp slt i32 %.039.lcssa, %i.x
  br i1 %i.y, label %.lr.ph133, label %._crit_edge

.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  %.039128 = phi i32 [ %i.cu, %.lr.ph ], [ 0, %.noexc ]
  %.040127 = phi ptr [ %i.ct, %.lr.ph ], [ %i.v, %.noexc ] ; 3 uses
  %i.z = load <4 x float>, ptr %.040127, align 16, !tbaa !49 ; 2 uses
  ...
  %i.az = fadd fast <4 x float> %i.am, %i.ay
  ...
  %i.bw = fmul fast <4 x float> %i.bv, %i.bv      ; 2 uses
  ...
  %i.cn = fmul fast <4 x float> %i.bw, %i.bv
  %reass.mul.a = fmul fast <4 x float> %i.cn, %i.cm
  %.neg = fmul fast <4 x float> %i.bw, splat (float -5.000000e-01)
  %reass.mul126 = fmul fast <4 x float> %i.bu, splat (float f0x3F317218)
  %5 = fadd fast <4 x float> %i.bv, %.neg
  %i.co = fadd fast <4 x float> %reass.mul.a, %5
  ...
  store <4 x float> %i.cs, ptr %.040127, align 16, !tbaa !49
  %i.ct = getelementptr inbounds nuw i8, ptr %.040127, i64 16 ; 2 uses
  %i.cu = add nuw nsw i32 %.039128, 4             ; 3 uses
...
.lr.ph133:                                        ; preds = %.preheader, %bb.e
  %.1132 = phi i32 [ %i.dj, %bb.e ], [ %.039.lcssa, %.preheader ]
  %.141131 = phi ptr [ %i.di, %bb.e ], [ %.040.lcssa, %.preheader ] ; 3 uses
  %i.cy = load float, ptr %.141131, align 4, !tbaa !52 ; 4 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  store float %storemerge, ptr %.141131, align 4, !tbaa !52
  %i.di = getelementptr inbounds nuw i8, ptr %.141131, i64 4
  %i.dj = add nuw nsw i32 %.1132, 1               ; 2 uses
...
.preheader:                                       ; preds = %.lr.ph, %.noexc
  ...
  %.038.lcssa = phi ptr [ %i.v, %.noexc ], [ %i.df, %.lr.ph ]
  %.037.lcssa = phi i32 [ 0, %.noexc ], [ %i.dg, %.lr.ph ] ; 2 uses
  %i.y = icmp slt i32 %.037.lcssa, %i.x
  br i1 %i.y, label %.lr.ph136, label %._crit_edge

.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  %.037131 = phi i32 [ %i.dg, %.lr.ph ], [ 0, %.noexc ]
  %.038130 = phi ptr [ %i.df, %.lr.ph ], [ %i.v, %.noexc ] ; 3 uses
  %i.z = load i64, ptr %.038130, align 1, !tbaa !49
  ...
  %i.cc = fmul fast <4 x float> %i.cb, %i.cb      ; 2 uses
  ...
  %i.ct = fmul fast <4 x float> %i.cc, %i.cb
  %reass.mul.a = fmul fast <4 x float> %i.ct, %i.cs
  %.neg = fmul fast <4 x float> %i.cc, splat (float -5.000000e-01)
  %reass.mul129 = fmul fast <4 x float> %i.ca, splat (float f0x3F317218)
  %5 = fadd fast <4 x float> %i.cb, %.neg
  %i.cu = fadd fast <4 x float> %reass.mul.a, %5
  ...
  store i64 %i.de, ptr %.038130, align 1, !tbaa !49
  %i.df = getelementptr inbounds nuw i8, ptr %.038130, i64 8 ; 2 uses
  %i.dg = add nuw nsw i32 %.037131, 4             ; 3 uses
...
.lr.ph136:                                        ; preds = %.preheader, %bb.e
  %.1135 = phi i32 [ %i.eb, %bb.e ], [ %.037.lcssa, %.preheader ]
  %.139134 = phi ptr [ %i.ea, %bb.e ], [ %.038.lcssa, %.preheader ] ; 3 uses
  %i.dk = load i16, ptr %.139134, align 2, !tbaa !61
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  store i16 %i.dz, ptr %.139134, align 2, !tbaa !61
  %i.ea = getelementptr inbounds nuw i8, ptr %.139134, i64 2
  %i.eb = add nuw nsw i32 %.1135, 1               ; 2 uses
