...
.preheader4396:                                   ; preds = %.loopexit4381, %.preheader4397
  ...
  %.21594.lcssa = phi i32 [ %.11593.lcssa, %.preheader4397 ], [ %i.aoo, %.loopexit4381 ] ; 5 uses
...
.preheader4376:                                   ; preds = %.loopexit4361, %.preheader4377
  ...
  %.21546.lcssa = phi i32 [ %.11545.lcssa, %.preheader4377 ], [ %i.cvv, %.loopexit4361 ] ; 5 uses
...
._crit_edge4959:                                  ; preds = %.loopexit4344, %._crit_edge4929
  ...
  %.21488.lcssa = phi i32 [ %.11487.lcssa, %._crit_edge4929 ], [ %i.ebu, %.loopexit4344 ] ; 5 uses
...
._crit_edge5130:                                  ; preds = %.loopexit, %._crit_edge5106
  ...
  %.2.lcssa = phi i32 [ %.1.lcssa, %._crit_edge5106 ], [ %i.ghb, %.loopexit ] ; 5 uses
...
.preheader847:                                    ; preds = %.lr.ph859.split, %.preheader847.loopexit, %bb.a
  %.0700.lcssa = phi i32 [ 0, %bb.a ], [ %i.sn, %.lr.ph859.split ], [ %i.so, %.preheader847.loopexit ] ; 5 uses
...
.preheader846:                                    ; preds = %.lr.ph873.split, %.preheader846.loopexit, %.preheader847
  %.1701.lcssa = phi i32 [ %.0700.lcssa, %.preheader847 ], [ %i.ajj, %.lr.ph873.split ], [ %i.ajk, %.preheader846.loopexit ] ; 5 uses
...
.preheader2125:                                   ; preds = %.lr.ph2139.split, %.preheader2125.loopexit, %bb.a
  %.01116.lcssa = phi i32 [ 0, %bb.a ], [ %i.alg, %.lr.ph2139.split ], [ %i.alh, %.preheader2125.loopexit ] ; 5 uses
...
.preheader2124:                                   ; preds = %.lr.ph2155.split, %.preheader2124.loopexit, %.preheader2125
  %.11117.lcssa = phi i32 [ %.01116.lcssa, %.preheader2125 ], [ %i.bsm, %.lr.ph2155.split ], [ %i.bsn, %.preheader2124.loopexit ] ; 5 uses
...
.preheader3817:                                   ; preds = %.lr.ph3833.split, %.preheader3817.loopexit, %bb.a
  %.01586.lcssa = phi i32 [ 0, %bb.a ], [ %i.bgd, %.lr.ph3833.split ], [ %i.bge, %.preheader3817.loopexit ] ; 5 uses
...
.preheader3816:                                   ; preds = %.lr.ph3851.split, %.preheader3816.loopexit, %.preheader3817
  %.11587.lcssa = phi i32 [ %.01586.lcssa, %.preheader3817 ], [ %i.dfx, %.lr.ph3851.split ], [ %i.dfy, %.preheader3816.loopexit ] ; 5 uses
