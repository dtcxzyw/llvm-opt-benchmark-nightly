Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/ncnn/original/bnll_x86_avx?download=true
inline.NumInlined: 2
inline.NumDeleted: 1
...
.preheader242:                                    ; preds = %.lr.ph, %.noexc
  ...
  %.055.lcssa = phi ptr [ %i.v, %.noexc ], [ %i.cu, %.lr.ph ] ; 2 uses
  %.054.lcssa = phi i32 [ 0, %.noexc ], [ %i.cv, %.lr.ph ] ; 3 uses
  %i.y = or disjoint i32 %.054.lcssa, 3
  %i.z = icmp slt i32 %i.y, %i.x
  br i1 %i.z, label %.lr.ph248, label %.preheader

.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  %.054244 = phi i32 [ %i.cv, %.lr.ph ], [ 0, %.noexc ]
  %.055243 = phi ptr [ %i.cu, %.lr.ph ], [ %i.v, %.noexc ] ; 3 uses
  %i.aa = load <8 x float>, ptr %.055243, align 1, !tbaa !49 ; 2 uses
  ...
  %i.az = fadd fast <8 x float> %i.am, splat (float 1.000000e+00)
  %i.ba = fadd fast <8 x float> %i.az, %i.ay
  ...
  %i.bx = fmul fast <8 x float> %i.bw, %i.bw
  ...
  %i.co = fmul fast <8 x float> %i.cn, %i.bw
  %reass.mul239 = fmul fast <8 x float> %i.bv, splat (float f0x3F317218)
  %reass.add240 = fadd fast <8 x float> %i.co, splat (float -5.000000e-01)
  %reass.mul241 = fmul fast <8 x float> %i.bx, %reass.add240
  %i.cp = fadd fast <8 x float> %reass.mul239, %i.bw
  ...
  store <8 x float> %i.ct, ptr %.055243, align 1, !tbaa !49
  %i.cu = getelementptr inbounds nuw i8, ptr %.055243, i64 32 ; 2 uses
  %i.cv = add nuw nsw i32 %.054244, 8             ; 3 uses
...
.preheader:                                       ; preds = %.lr.ph248, %.preheader242
  ...
  %.156.lcssa = phi ptr [ %.055.lcssa, %.preheader242 ], [ %i.fv, %.lr.ph248 ]
  %.1.lcssa = phi i32 [ %.054.lcssa, %.preheader242 ], [ %i.fw, %.lr.ph248 ] ; 2 uses
  %i.da = icmp slt i32 %.1.lcssa, %i.cz
  br i1 %i.da, label %.lr.ph254, label %._crit_edge

.lr.ph248:                                        ; preds = %.preheader242, %.lr.ph248
  %.1247 = phi i32 [ %i.fw, %.lr.ph248 ], [ %.054.lcssa, %.preheader242 ]
  %.156246 = phi ptr [ %i.fv, %.lr.ph248 ], [ %.055.lcssa, %.preheader242 ] ; 3 uses
  %i.db = load <4 x float>, ptr %.156246, align 16, !tbaa !49 ; 2 uses
  ...
  %i.eb = fadd fast <4 x float> %i.do, splat (float 1.000000e+00)
  ...
  %i.ey = fmul fast <4 x float> %i.ex, %i.ex
  ...
  %i.fp = fmul fast <4 x float> %i.fo, %i.ex
  %reass.mul.a = fmul fast <4 x float> %i.ew, splat (float f0x3F317218)
  %reass.add237 = fadd fast <4 x float> %i.fp, splat (float -5.000000e-01)
  %reass.mul238 = fmul fast <4 x float> %i.ey, %reass.add237
  %i.fq = fadd fast <4 x float> %reass.mul.a, %i.ex
  ...
  store <4 x float> %i.fu, ptr %.156246, align 16, !tbaa !49
  %i.fv = getelementptr inbounds nuw i8, ptr %.156246, i64 16 ; 2 uses
  %i.fw = add nuw nsw i32 %.1247, 4               ; 3 uses
...
.lr.ph254:                                        ; preds = %.preheader, %bb.e
  %.2253 = phi i32 [ %i.gl, %bb.e ], [ %.1.lcssa, %.preheader ]
  %.257252 = phi ptr [ %i.gk, %bb.e ], [ %.156.lcssa, %.preheader ] ; 3 uses
  %i.ga = load float, ptr %.257252, align 4, !tbaa !53 ; 4 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  store float %storemerge, ptr %.257252, align 4, !tbaa !53
  %i.gk = getelementptr inbounds nuw i8, ptr %.257252, i64 4
  %i.gl = add nuw nsw i32 %.2253, 1               ; 2 uses
...
.preheader246:                                    ; preds = %.lr.ph, %.noexc
  ...
  %.049.lcssa = phi ptr [ %i.v, %.noexc ], [ %i.dg, %.lr.ph ] ; 2 uses
  %.048.lcssa = phi i32 [ 0, %.noexc ], [ %i.dh, %.lr.ph ] ; 3 uses
  %i.y = or disjoint i32 %.048.lcssa, 3
  %i.z = icmp slt i32 %i.y, %i.x
  br i1 %i.z, label %.lr.ph252, label %.preheader

.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  %.048248 = phi i32 [ %i.dh, %.lr.ph ], [ 0, %.noexc ]
  %.049247 = phi ptr [ %i.dg, %.lr.ph ], [ %i.v, %.noexc ] ; 3 uses
  %i.aa = load <8 x i16>, ptr %.049247, align 1, !tbaa !49 ; 2 uses
  ...
  %i.bf = fadd fast <8 x float> %i.as, splat (float 1.000000e+00)
  %i.bg = fadd fast <8 x float> %i.bf, %i.be
  ...
  %i.cd = fmul fast <8 x float> %i.cc, %i.cc
  ...
  %i.cu = fmul fast <8 x float> %i.ct, %i.cc
  %reass.mul243 = fmul fast <8 x float> %i.cb, splat (float f0x3F317218)
  %reass.add244 = fadd fast <8 x float> %i.cu, splat (float -5.000000e-01)
  %reass.mul245 = fmul fast <8 x float> %i.cd, %reass.add244
  %i.cv = fadd fast <8 x float> %reass.mul243, %i.cc
  ...
  store <8 x i16> %i.df, ptr %.049247, align 1, !tbaa !49
  %i.dg = getelementptr inbounds nuw i8, ptr %.049247, i64 16 ; 2 uses
  %i.dh = add nuw nsw i32 %.048248, 8             ; 3 uses
...
.preheader:                                       ; preds = %.lr.ph252, %.preheader246
  ...
  %.150.lcssa = phi ptr [ %.049.lcssa, %.preheader246 ], [ %i.gs, %.lr.ph252 ]
  %.1.lcssa = phi i32 [ %.048.lcssa, %.preheader246 ], [ %i.gt, %.lr.ph252 ] ; 2 uses
  %i.dm = icmp slt i32 %.1.lcssa, %i.dl
  br i1 %i.dm, label %.lr.ph258, label %._crit_edge

.lr.ph252:                                        ; preds = %.preheader246, %.lr.ph252
  %.1251 = phi i32 [ %i.gt, %.lr.ph252 ], [ %.048.lcssa, %.preheader246 ]
  %.150250 = phi ptr [ %i.gs, %.lr.ph252 ], [ %.049.lcssa, %.preheader246 ] ; 3 uses
  %i.dn = load i64, ptr %.150250, align 1, !tbaa !49
  ...
  %i.fq = fmul fast <4 x float> %i.fp, %i.fp
  ...
  %i.gh = fmul fast <4 x float> %i.gg, %i.fp
  %reass.mul.a = fmul fast <4 x float> %i.fo, splat (float f0x3F317218)
  %reass.add241 = fadd fast <4 x float> %i.gh, splat (float -5.000000e-01)
  %reass.mul242 = fmul fast <4 x float> %i.fq, %reass.add241
  %i.gi = fadd fast <4 x float> %reass.mul.a, %i.fp
  ...
  store i64 %i.gr, ptr %.150250, align 1, !tbaa !49
  %i.gs = getelementptr inbounds nuw i8, ptr %.150250, i64 8 ; 2 uses
  %i.gt = add nuw nsw i32 %.1251, 4               ; 3 uses
...
.lr.ph258:                                        ; preds = %.preheader, %bb.e
  %.2257 = phi i32 [ %i.ho, %bb.e ], [ %.1.lcssa, %.preheader ]
  %.251256 = phi ptr [ %i.hn, %bb.e ], [ %.150.lcssa, %.preheader ] ; 3 uses
  %i.gx = load i16, ptr %.251256, align 2, !tbaa !63
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  store i16 %i.hm, ptr %.251256, align 2, !tbaa !63
  %i.hn = getelementptr inbounds nuw i8, ptr %.251256, i64 2
  %i.ho = add nuw nsw i32 %.2257, 1               ; 2 uses
