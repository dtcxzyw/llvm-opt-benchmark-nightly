Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/ncnn/original/deformableconv2d_x86_fma?download=true
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  ...
  %i.ew = phi i32 [ %i.eb, %.preheader ], [ %i.jj, %._crit_edge.loopexit ]
  %.3.lcssa = phi ptr [ %.2205, %.preheader ], [ %i.ji, %._crit_edge.loopexit ] ; 2 uses
...
bb.k:                                             ; preds = %.lr.ph, %.critedge
  ...
  %.3203 = phi ptr [ %.2205, %.lr.ph ], [ %i.ji, %.critedge ] ; 2 uses
...
bb.v:                                             ; preds = %bb.t, %bb.u
  ...
  %i.in = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.hr, <8 x float> nofpclass(nan inf) %i.im, <8 x float> nofpclass(nan inf) %i.ik)
  %i.io = insertelement <8 x float> poison, float %i.ha, i64 0
  %i.ip = shufflevector <8 x float> %i.io, <8 x float> poison, <8 x i32> zeroinitializer
  %i.iq = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.hz, <8 x float> nofpclass(nan inf) %i.ip, <8 x float> nofpclass(nan inf) %i.in)
  %i.ir = insertelement <8 x float> poison, float %i.hb, i64 0
  %i.is = shufflevector <8 x float> %i.ir, <8 x float> poison, <8 x i32> zeroinitializer
  %i.it = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.ih, <8 x float> nofpclass(nan inf) %i.is, <8 x float> nofpclass(nan inf) %i.iq) ; 2 uses
  %i.iu = load i8, ptr %8, align 1, !tbaa !84, !range !50, !noundef !51
  %i.iv = trunc nuw i8 %i.iu to i1
  br i1 %i.iv, label %bb.w, label %.critedge

bb.w:                                             ; preds = %bb.v
  %i.iw = load ptr, ptr %14, align 8, !tbaa !18
  %i.ix = load i32, ptr %i.aa, align 4, !tbaa !55
  %i.iy = sext i32 %i.ix to i64
  %i.iz = mul nsw i64 %indvars.iv224, %i.iy
  %i.ja = load i64, ptr %i.w, align 8, !tbaa !56
  %i.jb = mul i64 %i.iz, %i.ja
  %i.jc = getelementptr inbounds nuw i8, ptr %i.iw, i64 %i.jb
  %i.jd = getelementptr inbounds nuw [4 x i8], ptr %i.jc, i64 %indvars.iv
  ...
  %i.jh = fmul fast <8 x float> %i.jg, %i.it
  br label %.critedge

.critedge:                                        ; preds = %bb.v, %bb.w, %bb.l, %bb.k, %bb.m
  %.1198 = phi nsz <8 x float> [ zeroinitializer, %bb.k ], [ zeroinitializer, %bb.m ], [ zeroinitializer, %bb.l ], [ %i.jh, %bb.w ], [ %i.it, %bb.v ]
  store <8 x float> %.1198, ptr %.3203, align 32, !tbaa !97
  %i.ji = getelementptr inbounds nuw i8, ptr %.3203, i64 32 ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.jj = load i32, ptr %11, align 4, !tbaa !68   ; 2 uses
  %i.jk = sext i32 %i.jj to i64
  %i.jl = icmp slt i64 %indvars.iv.next, %i.jk
  br i1 %i.jl, label %bb.k, label %._crit_edge.loopexit, !llvm.loop !119
...
bb.y:                                             ; preds = %bb.d
  ...
  call void @__clang_call_terminate(ptr %i.jn) #20
  unreachable
}
...
; Function Attrs: alwaysinline norecurse nounwind uwtable
define internal void @_ZNK4ncnn24DeformableConv2D_x86_fma7forwardERKSt6vectorINS_3MatESaIS2_EERS4_RKNS_6OptionE.omp_outlined.1(ptr noalias nofree noundef readonly captures(none) %0, ptr noalias nofree readnone captures(none) %1, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %2, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(72) %3, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(72) %4, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %5, ptr nofree noundef readonly captures(none) %6, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(72) %7, ptr nofree noundef nonnull readonly align 1 captures(none) dereferenceable(1) %8, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(72) %9, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %10, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %11, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %12, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %13) #10 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = alloca i32, align 4                      ; 5 uses
  %i.b = alloca i32, align 4                      ; 7 uses
  %i.c = alloca i32, align 4                      ; 4 uses
...
bb.v:                                             ; preds = %bb.t, %bb.u
  ...
  %i.in = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.hr, <4 x float> nofpclass(nan inf) %i.im, <4 x float> nofpclass(nan inf) %i.ik)
  %i.io = insertelement <4 x float> poison, float %i.ha, i64 0
  %i.ip = shufflevector <4 x float> %i.io, <4 x float> poison, <4 x i32> zeroinitializer
  %i.iq = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.hz, <4 x float> nofpclass(nan inf) %i.ip, <4 x float> nofpclass(nan inf) %i.in)
  %i.ir = insertelement <4 x float> poison, float %i.hb, i64 0
  %i.is = shufflevector <4 x float> %i.ir, <4 x float> poison, <4 x i32> zeroinitializer
  %i.it = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ih, <4 x float> nofpclass(nan inf) %i.is, <4 x float> nofpclass(nan inf) %i.iq) ; 2 uses
  %i.iu = load i8, ptr %8, align 1, !tbaa !84, !range !50, !noundef !51
  %i.iv = trunc nuw i8 %i.iu to i1
  br i1 %i.iv, label %bb.w, label %.critedge
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.jh = fmul fast <4 x float> %i.jg, %i.it
  br label %.critedge

.critedge:                                        ; preds = %bb.v, %bb.w, %bb.l, %bb.k, %bb.m
  %.1198 = phi nsz <4 x float> [ zeroinitializer, %bb.k ], [ zeroinitializer, %bb.m ], [ zeroinitializer, %bb.l ], [ %i.jh, %bb.w ], [ %i.it, %bb.v ]
  store <4 x float> %.1198, ptr %.3203, align 16, !tbaa !97
  %i.ji = getelementptr inbounds nuw i8, ptr %.3203, i64 16 ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.jj = load i32, ptr %11, align 4, !tbaa !68   ; 2 uses
  %i.jk = sext i32 %i.jj to i64
  %i.jl = icmp slt i64 %indvars.iv.next, %i.jk
  br i1 %i.jl, label %bb.k, label %._crit_edge.loopexit, !llvm.loop !135
...
; Function Attrs: alwaysinline norecurse nounwind uwtable
define internal void @_ZNK4ncnn24DeformableConv2D_x86_fma7forwardERKSt6vectorINS_3MatESaIS2_EERS4_RKNS_6OptionE.omp_outlined.2(ptr noalias nofree noundef readonly captures(none) %0, ptr noalias nofree readnone captures(none) %1, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %2, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(72) %3, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(72) %4, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %5, ptr nofree noundef readonly captures(none) %6, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(72) %7, ptr nofree noundef nonnull readonly align 1 captures(none) dereferenceable(1) %8, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(72) %9, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %10, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %11, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %12, ptr nofree noundef nonnull readonly align 4 captures(none) dereferenceable(4) %13) #12 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = alloca i32, align 4                      ; 5 uses
  %i.b = alloca i32, align 4                      ; 7 uses
  %i.c = alloca i32, align 4                      ; 4 uses
