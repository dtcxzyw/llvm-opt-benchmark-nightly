...
.lr.ph265.i.i:                                    ; preds = %_ZN17FastDivider_epu32C2Ej.exit.i.i
  ...
  %i.ach = insertelement <2 x i32> poison, i32 %8, i64 0
  %12 = shufflevector <2 x i32> %i.ach, <2 x i32> poison, <2 x i32> zeroinitializer
  %i.aci = insertelement <2 x i32> %i.acf, i32 %i.ym, i64 1 ; 2 uses
  %i.acj = insertelement <2 x i32> poison, i32 %.scalar451.i.i, i64 0
  %i.ack = insertelement <2 x i32> %i.acj, i32 %i.abo, i64 1 ; 2 uses
  %i.acl = insertelement <2 x i32> poison, i32 %6, i64 0
  %i.acm = insertelement <2 x i32> %i.acl, i32 %i.ym, i64 1
  %i.acn = insertelement <2 x i32> poison, i32 %.scalar451.i.i, i64 0
  %13 = insertelement <2 x i32> %i.acn, i32 %i.abo, i64 1
  %14 = insertelement <2 x i64> poison, i64 %i.l, i64 0
  %15 = shufflevector <2 x i64> %14, <2 x i64> poison, <2 x i32> zeroinitializer
  %16 = insertelement <2 x i32> poison, i32 %i.ym, i64 0
...
.lr.ph306.i.i:                                    ; preds = %.preheader216.i.i
  ...
  %i.aee = insertelement <2 x i32> poison, i32 %8, i64 0
  %18 = shufflevector <2 x i32> %i.aee, <2 x i32> poison, <2 x i32> zeroinitializer
  %i.aef = insertelement <2 x i32> %i.aec, i32 %i.ym, i64 1 ; 2 uses
  %i.aeg = insertelement <2 x i32> poison, i32 %.scalar454.i.i, i64 0
  %i.aeh = insertelement <2 x i32> %i.aeg, i32 %i.adl, i64 1 ; 2 uses
  %i.aei = insertelement <2 x i32> poison, i32 %6, i64 0
  %i.aej = insertelement <2 x i32> %i.aei, i32 %i.ym, i64 1
  %i.aek = insertelement <2 x i32> poison, i32 %.scalar454.i.i, i64 0
  %19 = insertelement <2 x i32> %i.aek, i32 %i.adl, i64 1
  %20 = insertelement <2 x i64> poison, i64 %i.l, i64 0
  %21 = shufflevector <2 x i64> %20, <2 x i64> poison, <2 x i32> zeroinitializer
  %22 = insertelement <2 x i32> poison, i32 %i.ym, i64 0
...
bb.k:                                             ; preds = %bb.k, %.lr.ph252.i.i
  ...
  %i.ahw = add nsw i32 %.11227250.i.i, %4         ; 3 uses
  %i.ahx = add nsw i32 %i.ahw, 1                  ; 2 uses
  %24 = srem i32 %i.ahw, %i.ym                    ; 2 uses
  %25 = srem i32 %i.ahx, %i.ym                    ; 2 uses
  %26 = sdiv i32 %24, %6
  %27 = sdiv i32 %25, %6
  %28 = srem i32 %24, %6
  %29 = srem i32 %25, %6
  ...
  %34 = insertelement <2 x i32> poison, i32 %i.ahw, i64 0
  %35 = insertelement <2 x i32> %34, i32 %i.ahx, i64 1
  %36 = sdiv <2 x i32> %35, %17
  %i.ahy = sext <2 x i32> %36 to <2 x i64>
  %i.ahz = mul <2 x i64> %15, %i.ahy              ; 2 uses
  %i.aia = mul i32 %27, %.scalar451.i.i
  %i.aib = mul nsw i32 %29, %8
  ...
  %i.aii = getelementptr i8, ptr %i.aih, i64 %33
...
.lr.ph234.i.i:                                    ; preds = %.preheader227.i.i, %.lr.ph234.i.i
  ...
  %i.aoi = srem <2 x i32> %i.aoh, %i.acg
  %37 = mul nsw <2 x i32> %i.aoi, %12             ; 2 uses
  %i.aoj = insertelement <2 x i32> %i.aoh, i32 %i.aod, i64 1
  %i.aok = sdiv <2 x i32> %i.aoj, %i.aci
  %i.aol = mul <2 x i32> %i.aok, %i.ack           ; 2 uses
  %shift = shufflevector <2 x i32> %i.aol, <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop384 = add <2 x i32> %i.aol, %shift
  %foldExtExtBinop386 = add <2 x i32> %foldExtExtBinop384, %37
  %i.aom = shufflevector <2 x i32> %foldExtExtBinop386, <2 x i32> poison, <8 x i32> zeroinitializer
  ...
  %i.aoq = sdiv <2 x i32> %i.aop, %i.aci
  %i.aor = mul <2 x i32> %i.aoq, %i.ack           ; 2 uses
  %38 = shufflevector <2 x i32> %i.aor, <2 x i32> poison, <8 x i32> zeroinitializer
  %39 = shufflevector <2 x i32> %i.aor, <2 x i32> poison, <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
...
.lr.ph239.i.i:                                    ; preds = %.preheader225.i.i, %.lr.ph239.i.i
  ...
  %i.apr = sdiv <2 x i32> %i.apq, %i.acm
  %i.aps = mul <2 x i32> %i.apr, %13
...
.lr.ph348.i.i:                                    ; preds = %.preheader203.i.i
  ...
  %43 = insertelement <2 x i64> poison, i64 %i.l, i64 0
  %44 = shufflevector <2 x i64> %43, <2 x i64> poison, <2 x i32> zeroinitializer
  %i.ath = insertelement <2 x i32> poison, i32 %i.ym, i64 0
...
bb.r:                                             ; preds = %bb.r, %.lr.ph293.i.i
  ...
  %i.awq = add nsw i32 %.11235291.i.i, %4         ; 3 uses
  %i.awr = add nsw i32 %i.awq, 1                  ; 2 uses
  %45 = srem i32 %i.awq, %i.ym                    ; 2 uses
  %46 = srem i32 %i.awr, %i.ym                    ; 2 uses
  %47 = sdiv i32 %45, %6
  %48 = sdiv i32 %46, %6
  %49 = srem i32 %45, %6
  %50 = srem i32 %46, %6
  ...
  %55 = insertelement <2 x i32> poison, i32 %i.awq, i64 0
  %56 = insertelement <2 x i32> %55, i32 %i.awr, i64 1
  %57 = sdiv <2 x i32> %56, %23
  %i.aws = sext <2 x i32> %57 to <2 x i64>
  %i.awt = mul <2 x i64> %21, %i.aws              ; 2 uses
  %i.awu = mul i32 %48, %.scalar454.i.i
  %i.awv = mul nsw i32 %50, %8
  ...
  %i.axc = getelementptr i8, ptr %i.axb, i64 %54
...
.lr.ph275.i.i:                                    ; preds = %.preheader214.i.i, %.lr.ph275.i.i
  ...
  %i.bcx = srem <2 x i32> %i.bcw, %i.aed
  %58 = mul nsw <2 x i32> %i.bcx, %18             ; 2 uses
  %i.bcy = insertelement <2 x i32> %i.bcw, i32 %i.bcs, i64 1
  %i.bcz = sdiv <2 x i32> %i.bcy, %i.aef
  %i.bda = mul <2 x i32> %i.bcz, %i.aeh           ; 2 uses
  %shift407 = shufflevector <2 x i32> %i.bda, <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop408 = add <2 x i32> %i.bda, %shift407
  %foldExtExtBinop410 = add <2 x i32> %foldExtExtBinop408, %58
  %i.bdb = shufflevector <2 x i32> %foldExtExtBinop410, <2 x i32> poison, <4 x i32> zeroinitializer
  ...
  %i.bdf = sdiv <2 x i32> %i.bde, %i.aef
  %i.bdg = mul <2 x i32> %i.bdf, %i.aeh           ; 2 uses
  %59 = shufflevector <2 x i32> %i.bdg, <2 x i32> poison, <4 x i32> zeroinitializer
  %60 = shufflevector <2 x i32> %i.bdg, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %61 = add <4 x i32> %59, %60
  %62 = shufflevector <2 x i32> %58, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %63 = add <4 x i32> %61, %62
  %i.bdh = add <4 x i32> %63, %i.aug
...
.lr.ph280.i.i:                                    ; preds = %.preheader212.i.i, %.lr.ph280.i.i
  ...
  %i.bea = sdiv <2 x i32> %i.bdz, %i.aej
  %i.beb = mul <2 x i32> %i.bea, %19
...
.lr.ph371.i.i:                                    ; preds = %.preheader190.i.i
  ...
  %64 = insertelement <2 x i64> poison, i64 %i.l, i64 0
  %65 = shufflevector <2 x i64> %64, <2 x i64> poison, <2 x i32> zeroinitializer
  %i.bgn = insertelement <2 x i32> poison, i32 %i.ym, i64 0
...
bb.y:                                             ; preds = %bb.y, %.lr.ph335.i.i
  ...
  %i.bjk = add nsw i32 %.11243333.i.i, %4         ; 3 uses
  %i.bjl = add nsw i32 %i.bjk, 1                  ; 2 uses
  %66 = srem i32 %i.bjk, %i.ym                    ; 2 uses
  %67 = srem i32 %i.bjl, %i.ym                    ; 2 uses
  %68 = sdiv i32 %66, %6
  %69 = sdiv i32 %67, %6
  %70 = srem i32 %66, %6
  %71 = srem i32 %67, %6
  ...
  %76 = insertelement <2 x i32> poison, i32 %i.bjk, i64 0
  %77 = insertelement <2 x i32> %76, i32 %i.bjl, i64 1
  %78 = sdiv <2 x i32> %77, %i.ati
  %i.bjm = sext <2 x i32> %78 to <2 x i64>
  %i.bjn = mul <2 x i64> %44, %i.bjm              ; 2 uses
  %i.bjo = mul i32 %69, %.scalar456.i.i
  %i.bjp = mul nsw i32 %71, %8
  ...
  %i.bjw = getelementptr i8, ptr %i.bjv, i64 %75  ; 2 uses
...
.lr.ph316.i.i:                                    ; preds = %.lr.ph316.i.i.preheader, %.lr.ph316.i.i
  ...
  %79 = load ptr, ptr %0, align 8, !tbaa !86      ; 4 uses
...
bb.af:                                            ; preds = %bb.af, %.lr.ph358.i.i
  ...
  %i.bwp = add nsw i32 %.11252356.i.i, %4         ; 3 uses
  %i.bwq = add nsw i32 %i.bwp, 1                  ; 2 uses
  %80 = srem i32 %i.bwp, %i.ym                    ; 2 uses
  %81 = srem i32 %i.bwq, %i.ym                    ; 2 uses
  %82 = sdiv i32 %80, %6
  %83 = sdiv i32 %81, %6
  %84 = srem i32 %80, %6
  %85 = srem i32 %81, %6
  ...
  %90 = insertelement <2 x i32> poison, i32 %i.bwp, i64 0
  %91 = insertelement <2 x i32> %90, i32 %i.bwq, i64 1
  %92 = sdiv <2 x i32> %91, %i.bgo
  %i.bwr = sext <2 x i32> %92 to <2 x i64>
  %i.bws = mul <2 x i64> %65, %i.bwr              ; 2 uses
  %i.bwt = mul i32 %83, %.scalar458.i.i
  %i.bwu = mul nsw i32 %85, %8
  ...
  %i.bxb = getelementptr i8, ptr %i.bxa, i64 %89
