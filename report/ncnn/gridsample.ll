...
_ZN4ncnnL17get_value_boundedERKNS_3MatEiiii.exit384: ; preds = %bb.bo, %_ZN4ncnnL13compute_coordEfiii.exit16.i369
  ...
  %9 = fsub fast float 3.750000e+00, %i.aay
  %10 = fmul fast float %i.aax, %9
  %reass.mul.i = fmul fast float %i.aav, 6.000000e+00
  %i.aaz = fsub fast float %10, %reass.mul.i
  %i.aba = fadd fast float %i.aaz, 3.000000e+00   ; 5 uses
  ...
  %11 = fsub fast float 3.750000e+00, %i.abs
  %12 = fmul fast float %i.abr, %11
  %reass.mul.i385 = fmul fast float %i.abp, 6.000000e+00
  %i.abt = fsub fast float %12, %reass.mul.i385
  %i.abu = fadd fast float %i.abt, 3.000000e+00   ; 2 uses
  ...
  %i.acj = fadd fast float %i.ach, %i.aci
  ...
  %i.acq = fadd fast float %i.aco, %i.acp
  ...
  %i.acx = fadd fast float %i.acv, %i.acw
  ...
  %i.ade = fadd fast float %i.adc, %i.add
