...
begin_hunk_0_@_ZN4ncnnL11pack_A_tileERKNS_3MatERS0_iiii:bb.a
  store <16 x float> %i.ml, ptr %i.na, align 64, !tbaa !90
  %i.nb = getelementptr inbounds nuw i8, ptr %.7143, i64 832
  store <16 x float> %i.mm, ptr %i.nb, align 64, !tbaa !90
  %i.nc = getelementptr inbounds nuw i8, ptr %.7143, i64 896
  store <16 x float> %i.mn, ptr %i.nc, align 64, !tbaa !90
  %i.nd = getelementptr inbounds nuw i8, ptr %.7143, i64 960
  store <16 x float> %i.mo, ptr %i.nd, align 64, !tbaa !90
  ...
  br i1 %i.nx, label %.lr.ph144, label %.preheader104, !llvm.loop !199
...
.lr.ph181:                                        ; preds = %.lr.ph181.preheader, %.lr.ph181
  ...
  %i.ny = load float, ptr %.1681163, align 4, !tbaa !69
  store float %i.ny, ptr %.8180, align 4, !tbaa !69
  %i.nz = load float, ptr %.1679164, align 4, !tbaa !69
  %i.oa = getelementptr inbounds nuw i8, ptr %.8180, i64 4
  store float %i.nz, ptr %i.oa, align 4, !tbaa !69
  %i.ob = load float, ptr %.1677165, align 4, !tbaa !69
  %i.oc = getelementptr inbounds nuw i8, ptr %.8180, i64 8
  store float %i.ob, ptr %i.oc, align 4, !tbaa !69
  %i.od = load float, ptr %.1675166, align 4, !tbaa !69
  %i.oe = getelementptr inbounds nuw i8, ptr %.8180, i64 12
  store float %i.od, ptr %i.oe, align 4, !tbaa !69
  %i.of = load float, ptr %.1673167, align 4, !tbaa !69
  %i.og = getelementptr inbounds nuw i8, ptr %.8180, i64 16
  store float %i.of, ptr %i.og, align 4, !tbaa !69
  %i.oh = load float, ptr %.1671168, align 4, !tbaa !69
  %i.oi = getelementptr inbounds nuw i8, ptr %.8180, i64 20
  store float %i.oh, ptr %i.oi, align 4, !tbaa !69
  %i.oj = load float, ptr %.1669169, align 4, !tbaa !69
  %i.ok = getelementptr inbounds nuw i8, ptr %.8180, i64 24
  store float %i.oj, ptr %i.ok, align 4, !tbaa !69
  %i.ol = load float, ptr %.1667170, align 4, !tbaa !69
  %i.om = getelementptr inbounds nuw i8, ptr %.8180, i64 28
  store float %i.ol, ptr %i.om, align 4, !tbaa !69
  %i.on = load float, ptr %.1665171, align 4, !tbaa !69
  %i.oo = getelementptr inbounds nuw i8, ptr %.8180, i64 32
  store float %i.on, ptr %i.oo, align 4, !tbaa !69
  %i.op = load float, ptr %.1663172, align 4, !tbaa !69
  %i.oq = getelementptr inbounds nuw i8, ptr %.8180, i64 36
  store float %i.op, ptr %i.oq, align 4, !tbaa !69
  %i.or = load float, ptr %.1661173, align 4, !tbaa !69
  %i.os = getelementptr inbounds nuw i8, ptr %.8180, i64 40
  store float %i.or, ptr %i.os, align 4, !tbaa !69
  %i.ot = load float, ptr %.1659174, align 4, !tbaa !69
  %i.ou = getelementptr inbounds nuw i8, ptr %.8180, i64 44
  store float %i.ot, ptr %i.ou, align 4, !tbaa !69
  %i.ov = load float, ptr %.1657175, align 4, !tbaa !69
  %i.ow = getelementptr inbounds nuw i8, ptr %.8180, i64 48
  store float %i.ov, ptr %i.ow, align 4, !tbaa !69
  %i.ox = load float, ptr %.1655176, align 4, !tbaa !69
  %i.oy = getelementptr inbounds nuw i8, ptr %.8180, i64 52
  store float %i.ox, ptr %i.oy, align 4, !tbaa !69
  %i.oz = load float, ptr %.1653177, align 4, !tbaa !69
  %i.pa = getelementptr inbounds nuw i8, ptr %.8180, i64 56
  store float %i.oz, ptr %i.pa, align 4, !tbaa !69
  %i.pb = load float, ptr %.1651178, align 4, !tbaa !69
  %i.pc = getelementptr inbounds nuw i8, ptr %.8180, i64 60
  store float %i.pb, ptr %i.pc, align 4, !tbaa !69
  ...
  br i1 %exitcond430.not, label %.loopexit105, label %.lr.ph181, !llvm.loop !200
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %i.pv = load <16 x float>, ptr %.0600110.epil, align 64, !tbaa !90
  store <16 x float> %i.pv, ptr %.1584111.epil, align 64, !tbaa !90
  ...
  br i1 %epil.iter1216.cmp.not, label %.loopexit105, label %.lr.ph.epil, !llvm.loop !201
...
.lr.ph116.epil:                                   ; preds = %.lr.ph116.epil, %.lr.ph116.epil.preheader
  ...
  %i.py = load <8 x float>, ptr %.0602114.epil, align 32, !tbaa !90
  store <8 x float> %i.py, ptr %.3115.epil, align 32, !tbaa !90
  %i.pz = getelementptr inbounds nuw i8, ptr %.3115.epil, i64 32
  %i.qa = load <8 x float>, ptr %.0603113.epil, align 32, !tbaa !90
  store <8 x float> %i.qa, ptr %i.pz, align 32, !tbaa !90
  ...
  br i1 %epil.iter.cmp.not, label %.loopexit105, label %.lr.ph116.epil, !llvm.loop !202
...
.lr.ph124.epil.preheader:                         ; preds = %.loopexit105.loopexit1184.unr-lcssa, %.lr.ph124.preheader
  ...
  %i.qe = load <4 x float>, ptr %.0605122.epil.init, align 16, !tbaa !90
  store <4 x float> %i.qe, ptr %.5123.epil.init, align 16, !tbaa !90
  %i.qf = getelementptr inbounds nuw i8, ptr %.5123.epil.init, i64 16
  %i.qg = load <4 x float>, ptr %.0606121.epil.init, align 16, !tbaa !90
  store <4 x float> %i.qg, ptr %i.qf, align 16, !tbaa !90
  %i.qh = getelementptr inbounds nuw i8, ptr %.5123.epil.init, i64 32
  %i.qi = load <4 x float>, ptr %.0607120.epil.init, align 16, !tbaa !90
  store <4 x float> %i.qi, ptr %i.qh, align 16, !tbaa !90
  %i.qj = getelementptr inbounds nuw i8, ptr %.5123.epil.init, i64 48
  %i.qk = load <4 x float>, ptr %.0683118.epil.init, align 16, !tbaa !90
  store <4 x float> %i.qk, ptr %i.qj, align 16, !tbaa !90
...
.loopexit105:                                     ; preds = %.lr.ph181, %.lr.ph124.epil.preheader, %.loopexit105.loopexit1184.unr-lcssa, %.loopexit105.loopexit1183.unr-lcssa.a, %.lr.ph116.epil, %.loopexit105.loopexit.unr-lcssa, %.lr.ph.epil, %middle.block, %vec.epilog.middle.block, %bb.b, %.split, %bb.c, %bb.d, %bb.e, %.preheader104
  ...
  br i1 %i.qn, label %bb.b, label %.preheader103.loopexit, !llvm.loop !203
...
.lr.ph278.split.us:                               ; preds = %.lr.ph278.split.us.preheader, %.loopexit.us
  ...
  %.pre457 = load ptr, ptr %0, align 8, !tbaa !25 ; 5 uses
...
.lr.ph240.us:                                     ; preds = %.lr.ph240.us.preheader, %.lr.ph240.us
  ...
  br i1 %niter1249.ncmp.7, label %.loopexit97.us.loopexit.unr-lcssa, label %.lr.ph240.us, !llvm.loop !204
...
.lr.ph240.us.epil:                                ; preds = %.lr.ph240.us.epil, %.lr.ph240.us.epil.preheader
  ...
  %i.st = load <4 x float>, ptr %.0624237.us.epil, align 16, !tbaa !90
  store <4 x float> %i.st, ptr %.19239.us.epil, align 16, !tbaa !90
  ...
  br i1 %epil.iter1244.cmp.not, label %.loopexit97.us.loopexit, label %.lr.ph240.us.epil, !llvm.loop !205
...
.lr.ph248.us:                                     ; preds = %.loopexit97.us, %.lr.ph248.us
  ...
  %i.tl = load <8 x float>, ptr %.0620242.us, align 1, !tbaa !90 ; 2 uses
  %i.tm = load <8 x float>, ptr %.0617243.us, align 1, !tbaa !90 ; 2 uses
  %i.tn = load <8 x float>, ptr %.0614244.us, align 1, !tbaa !90 ; 2 uses
  %i.to = load <8 x float>, ptr %.0611245.us, align 1, !tbaa !90 ; 2 uses
  ...
  store <8 x float> %i.tt, ptr %.21247.us, align 32, !tbaa !90
  %i.tx = getelementptr inbounds nuw i8, ptr %.21247.us, i64 32
  store <8 x float> %i.tu, ptr %i.tx, align 32, !tbaa !90
  %i.ty = getelementptr inbounds nuw i8, ptr %.21247.us, i64 64
  store <8 x float> %i.tv, ptr %i.ty, align 32, !tbaa !90
  %i.tz = getelementptr inbounds nuw i8, ptr %.21247.us, i64 96
  store <8 x float> %i.tw, ptr %i.tz, align 32, !tbaa !90
  ...
  br i1 %i.uh, label %.lr.ph248.us, label %.preheader96.us, !llvm.loop !206
...
.lr.ph261.us:                                     ; preds = %.preheader96.us, %.lr.ph261.us
  ...
  %i.ui = load <4 x float>, ptr %.1621255.us, align 1, !tbaa !90 ; 2 uses
  %i.uj = load <4 x float>, ptr %.1618256.us, align 1, !tbaa !90 ; 2 uses
  %i.uk = load <4 x float>, ptr %.1615257.us, align 1, !tbaa !90 ; 2 uses
  %i.ul = load <4 x float>, ptr %.1612258.us, align 1, !tbaa !90 ; 2 uses
...
vector.body997:                                   ; preds = %vector.body997, %vector.ph995
  ...
  %wide.load1004.a = load <16 x float>, ptr %next.gep1003, align 4, !tbaa !69, !alias.scope !275
  %wide.load1005.a = load <16 x float>, ptr %next.gep1002.a, align 4, !tbaa !69, !alias.scope !276
  %wide.load1006.a = load <16 x float>, ptr %next.gep1001.a, align 4, !tbaa !69, !alias.scope !277
  %wide.load1007 = load <16 x float>, ptr %next.gep1000.a, align 4, !tbaa !69, !alias.scope !278
  ...
  store <64 x float> %interleaved.vec1008, ptr %next.gep999.a, align 4, !tbaa !69, !alias.scope !279, !noalias !280
  %index.next1009 = add nuw i64 %index998, 16     ; 2 uses
  %i.xc = icmp eq i64 %index.next1009, %n.vec996
  br i1 %i.xc, label %middle.block1010, label %vector.body997, !llvm.loop !215
...
vec.epilog.iter.check1021:                        ; preds = %middle.block1010
  ...
  br i1 %min.epilog.iters.check1022, label %.lr.ph274.us.preheader, label %vec.epilog.ph1023, !prof !92
...
vec.epilog.vector.body1025:                       ; preds = %vec.epilog.vector.body1025, %vec.epilog.ph1023
  ...
  %wide.load1032.a = load <4 x float>, ptr %next.gep1031, align 4, !tbaa !69, !alias.scope !275
  %wide.load1033.a = load <4 x float>, ptr %next.gep1030.a, align 4, !tbaa !69, !alias.scope !276
  %wide.load1034.a = load <4 x float>, ptr %next.gep1029.a, align 4, !tbaa !69, !alias.scope !277
  %wide.load1035 = load <4 x float>, ptr %next.gep1028.a, align 4, !tbaa !69, !alias.scope !278
  ...
  store <16 x float> %interleaved.vec1036, ptr %next.gep1027.a, align 4, !tbaa !69, !alias.scope !279, !noalias !280
...
.lr.ph274.us.prol:                                ; preds = %.lr.ph274.us.preheader
  %i.xs = load float, ptr %.2622268.us.ph, align 4, !tbaa !69
  store float %i.xs, ptr %.23273.us.ph, align 4, !tbaa !69
  %i.xt = load float, ptr %.2619269.us.ph, align 4, !tbaa !69
  %i.xu = getelementptr inbounds nuw i8, ptr %.23273.us.ph, i64 4
  store float %i.xt, ptr %i.xu, align 4, !tbaa !69
  %i.xv = load float, ptr %.2616270.us.ph, align 4, !tbaa !69
  %i.xw = getelementptr inbounds nuw i8, ptr %.23273.us.ph, i64 8
  store float %i.xv, ptr %i.xw, align 4, !tbaa !69
  %i.xx = load float, ptr %.2613271.us.ph, align 4, !tbaa !69
  %i.xy = getelementptr inbounds nuw i8, ptr %.23273.us.ph, i64 12
  store float %i.xx, ptr %i.xy, align 4, !tbaa !69
...
.lr.ph240.us290.us:                               ; preds = %.lr.ph240.us290.us.preheader, %..loopexit97_crit_edge.us291.us
  ...
  %i.yy = load ptr, ptr %0, align 8, !tbaa !25
...
.lr.ph240.us290.us.new:                           ; preds = %.lr.ph240.us290.us, %.lr.ph240.us290.us.new
  ...
  %i.zd = load <4 x float>, ptr %.0624237.us286.us, align 16, !tbaa !90
  store <4 x float> %i.zd, ptr %.19239.us284.us, align 16, !tbaa !90
  ...
  %i.zg = load <4 x float>, ptr %i.zf, align 16, !tbaa !90
  store <4 x float> %i.zg, ptr %i.ze, align 16, !tbaa !90
  ...
  %i.zj = load <4 x float>, ptr %i.zi, align 16, !tbaa !90
  store <4 x float> %i.zj, ptr %i.zh, align 16, !tbaa !90
  ...
  %i.zm = load <4 x float>, ptr %i.zl, align 16, !tbaa !90
  store <4 x float> %i.zm, ptr %i.zk, align 16, !tbaa !90
  ...
  %i.zp = load <4 x float>, ptr %i.zo, align 16, !tbaa !90
  store <4 x float> %i.zp, ptr %i.zn, align 16, !tbaa !90
  ...
  %i.zs = load <4 x float>, ptr %i.zr, align 16, !tbaa !90
  store <4 x float> %i.zs, ptr %i.zq, align 16, !tbaa !90
  ...
  %i.zv = load <4 x float>, ptr %i.zu, align 16, !tbaa !90
  store <4 x float> %i.zv, ptr %i.zt, align 16, !tbaa !90
  ...
  %i.zy = load <4 x float>, ptr %i.zx, align 16, !tbaa !90
  store <4 x float> %i.zy, ptr %i.zw, align 16, !tbaa !90
  ...
  br i1 %niter1242.ncmp.7, label %..loopexit97_crit_edge.us291.us.unr-lcssa, label %.lr.ph240.us290.us.new, !llvm.loop !204
...
bb.h:                                             ; preds = %bb.h, %.epil.preheader
  ...
  %i.aab = load <4 x float>, ptr %.0624237.us286.us.epil, align 16, !tbaa !90
  store <4 x float> %i.aab, ptr %.19239.us284.us.epil, align 16, !tbaa !90
...
.lr.ph191.preheader:                              ; preds = %bb.j
  %i.aaf = load ptr, ptr %0, align 8, !tbaa !25
...
.lr.ph191:                                        ; preds = %.lr.ph191.preheader, %.lr.ph191
  ...
  %i.aak = load <8 x float>, ptr %.0647188, align 32, !tbaa !90
  store <8 x float> %i.aak, ptr %.11190, align 32, !tbaa !90
  %i.aal = getelementptr inbounds nuw i8, ptr %.11190, i64 32
  %i.aam = getelementptr inbounds nuw i8, ptr %.0647188, i64 32
  %i.aan = load <8 x float>, ptr %i.aam, align 32, !tbaa !90
  store <8 x float> %i.aan, ptr %i.aal, align 32, !tbaa !90
  %i.aao = getelementptr inbounds nuw i8, ptr %.11190, i64 64
  %i.aap = getelementptr inbounds nuw i8, ptr %.0647188, i64 64
  %i.aaq = load <8 x float>, ptr %i.aap, align 32, !tbaa !90
  store <8 x float> %i.aaq, ptr %i.aao, align 32, !tbaa !90
  %i.aar = getelementptr inbounds nuw i8, ptr %.11190, i64 96
  %i.aas = getelementptr inbounds nuw i8, ptr %.0647188, i64 96
  %i.aat = load <8 x float>, ptr %i.aas, align 32, !tbaa !90
  store <8 x float> %i.aat, ptr %i.aar, align 32, !tbaa !90
  %i.aau = getelementptr inbounds nuw i8, ptr %.11190, i64 128
  %i.aav = getelementptr inbounds nuw i8, ptr %.0647188, i64 128
  %i.aaw = load <8 x float>, ptr %i.aav, align 32, !tbaa !90
  store <8 x float> %i.aaw, ptr %i.aau, align 32, !tbaa !90
  %i.aax = getelementptr inbounds nuw i8, ptr %.11190, i64 160
  %i.aay = getelementptr inbounds nuw i8, ptr %.0647188, i64 160
  %i.aaz = load <8 x float>, ptr %i.aay, align 32, !tbaa !90
  store <8 x float> %i.aaz, ptr %i.aax, align 32, !tbaa !90
  %i.aba = getelementptr inbounds nuw i8, ptr %.11190, i64 192
  %i.abb = getelementptr inbounds nuw i8, ptr %.0647188, i64 192
  %i.abc = load <8 x float>, ptr %i.abb, align 32, !tbaa !90
  store <8 x float> %i.abc, ptr %i.aba, align 32, !tbaa !90
  %i.abd = getelementptr inbounds nuw i8, ptr %.11190, i64 224
  %i.abe = getelementptr inbounds nuw i8, ptr %.0647188, i64 224
  %i.abf = load <8 x float>, ptr %i.abe, align 32, !tbaa !90
  store <8 x float> %i.abf, ptr %i.abd, align 32, !tbaa !90
...
.lr.ph197.preheader:                              ; preds = %bb.k
  %i.abi = load ptr, ptr %0, align 8, !tbaa !25   ; 2 uses
...
.lr.ph197:                                        ; preds = %.lr.ph197.preheader, %.lr.ph197
  ...
  %i.abr = load <4 x float>, ptr %.0645193, align 16, !tbaa !90
  store <4 x float> %i.abr, ptr %.13196, align 16, !tbaa !90
  %i.abs = getelementptr inbounds nuw i8, ptr %.13196, i64 16
  %i.abt = load <4 x float>, ptr %.0644194, align 16, !tbaa !90
  store <4 x float> %i.abt, ptr %i.abs, align 16, !tbaa !90
  ...
  %i.abx = load <4 x float>, ptr %i.abv, align 16, !tbaa !90
  store <4 x float> %i.abx, ptr %i.abu, align 16, !tbaa !90
  %i.aby = getelementptr inbounds nuw i8, ptr %.13196, i64 48
  %i.abz = load <4 x float>, ptr %i.abw, align 16, !tbaa !90
  store <4 x float> %i.abz, ptr %i.aby, align 16, !tbaa !90
  ...
  %i.acd = load <4 x float>, ptr %i.acb, align 16, !tbaa !90
  store <4 x float> %i.acd, ptr %i.aca, align 16, !tbaa !90
  %i.ace = getelementptr inbounds nuw i8, ptr %.13196, i64 80
  %i.acf = load <4 x float>, ptr %i.acc, align 16, !tbaa !90
  store <4 x float> %i.acf, ptr %i.ace, align 16, !tbaa !90
...
begin_hunk_2_@_ZN4ncnnL11pack_B_tileERKNS_3MatERS0_iiii:bb.a
  store <16 x float> %i.ml, ptr %i.na, align 1, !tbaa !90
  %i.nb = getelementptr inbounds nuw i8, ptr %.7144, i64 832
  store <16 x float> %i.mm, ptr %i.nb, align 1, !tbaa !90
  %i.nc = getelementptr inbounds nuw i8, ptr %.7144, i64 896
  store <16 x float> %i.mn, ptr %i.nc, align 1, !tbaa !90
  %i.nd = getelementptr inbounds nuw i8, ptr %.7144, i64 960
  store <16 x float> %i.mo, ptr %i.nd, align 1, !tbaa !90
  ...
  %i.nw = or disjoint i32 %i.nv, 15
  %i.nx = icmp slt i32 %i.nw, %4
  br i1 %i.nx, label %.lr.ph145, label %.preheader105, !llvm.loop !321
...
.lr.ph182:                                        ; preds = %.lr.ph182.preheader, %.lr.ph182
  ...
  %i.ny = load float, ptr %.1696180, align 4, !tbaa !69
  store float %i.ny, ptr %.8181, align 4, !tbaa !69
  %i.nz = load float, ptr %.1698179, align 4, !tbaa !69
  %i.oa = getelementptr inbounds nuw i8, ptr %.8181, i64 4
  store float %i.nz, ptr %i.oa, align 4, !tbaa !69
  %i.ob = load float, ptr %.1700178, align 4, !tbaa !69
  %i.oc = getelementptr inbounds nuw i8, ptr %.8181, i64 8
  store float %i.ob, ptr %i.oc, align 4, !tbaa !69
  %i.od = load float, ptr %.1702177, align 4, !tbaa !69
  %i.oe = getelementptr inbounds nuw i8, ptr %.8181, i64 12
  store float %i.od, ptr %i.oe, align 4, !tbaa !69
  %i.of = load float, ptr %.1704176, align 4, !tbaa !69
  %i.og = getelementptr inbounds nuw i8, ptr %.8181, i64 16
  store float %i.of, ptr %i.og, align 4, !tbaa !69
  %i.oh = load float, ptr %.1706175, align 4, !tbaa !69
  %i.oi = getelementptr inbounds nuw i8, ptr %.8181, i64 20
  store float %i.oh, ptr %i.oi, align 4, !tbaa !69
  %i.oj = load float, ptr %.1708174, align 4, !tbaa !69
  %i.ok = getelementptr inbounds nuw i8, ptr %.8181, i64 24
  store float %i.oj, ptr %i.ok, align 4, !tbaa !69
  %i.ol = load float, ptr %.1710173, align 4, !tbaa !69
  %i.om = getelementptr inbounds nuw i8, ptr %.8181, i64 28
  store float %i.ol, ptr %i.om, align 4, !tbaa !69
  %i.on = load float, ptr %.1712172, align 4, !tbaa !69
  %i.oo = getelementptr inbounds nuw i8, ptr %.8181, i64 32
  store float %i.on, ptr %i.oo, align 4, !tbaa !69
  %i.op = load float, ptr %.1714171, align 4, !tbaa !69
  %i.oq = getelementptr inbounds nuw i8, ptr %.8181, i64 36
  store float %i.op, ptr %i.oq, align 4, !tbaa !69
  %i.or = load float, ptr %.1716170, align 4, !tbaa !69
  %i.os = getelementptr inbounds nuw i8, ptr %.8181, i64 40
  store float %i.or, ptr %i.os, align 4, !tbaa !69
  %i.ot = load float, ptr %.1718169, align 4, !tbaa !69
  %i.ou = getelementptr inbounds nuw i8, ptr %.8181, i64 44
  store float %i.ot, ptr %i.ou, align 4, !tbaa !69
  %i.ov = load float, ptr %.1720168, align 4, !tbaa !69
  %i.ow = getelementptr inbounds nuw i8, ptr %.8181, i64 48
  store float %i.ov, ptr %i.ow, align 4, !tbaa !69
  %i.ox = load float, ptr %.1722167, align 4, !tbaa !69
  %i.oy = getelementptr inbounds nuw i8, ptr %.8181, i64 52
  store float %i.ox, ptr %i.oy, align 4, !tbaa !69
  %i.oz = load float, ptr %.1760164, align 4, !tbaa !69
  %i.pa = getelementptr inbounds nuw i8, ptr %.8181, i64 56
  store float %i.oz, ptr %i.pa, align 4, !tbaa !69
  %i.pb = load float, ptr %.1758165, align 4, !tbaa !69
  ...
  br i1 %exitcond462.not, label %.loopexit106, label %.lr.ph182, !llvm.loop !322
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %i.pv = load <16 x float>, ptr %.0668111.epil, align 64, !tbaa !90
  store <16 x float> %i.pv, ptr %.1652112.epil, align 1, !tbaa !90
  ...
  br i1 %epil.iter1278.cmp.not, label %.loopexit106, label %.lr.ph.epil, !llvm.loop !323
...
.lr.ph117.epil:                                   ; preds = %.lr.ph117.epil, %.lr.ph117.epil.preheader
  ...
  %i.py = load <8 x float>, ptr %.0670115.epil, align 32, !tbaa !90
  store <8 x float> %i.py, ptr %.3116.epil, align 1, !tbaa !90
  %i.pz = getelementptr inbounds nuw i8, ptr %.3116.epil, i64 32
  %i.qa = load <8 x float>, ptr %.0671114.epil, align 32, !tbaa !90
  store <8 x float> %i.qa, ptr %i.pz, align 1, !tbaa !90
  ...
  br i1 %epil.iter.cmp.not, label %.loopexit106, label %.lr.ph117.epil, !llvm.loop !324
...
.lr.ph125.epil.preheader:                         ; preds = %.loopexit106.loopexit1246.unr-lcssa, %.lr.ph125.preheader
  ...
  %i.qe = load <4 x float>, ptr %.0673123.epil.init, align 16, !tbaa !90
  store <4 x float> %i.qe, ptr %.5124.epil.init, align 16, !tbaa !90
  %i.qf = getelementptr inbounds nuw i8, ptr %.5124.epil.init, i64 16
  %i.qg = load <4 x float>, ptr %.0674122.epil.init, align 16, !tbaa !90
  store <4 x float> %i.qg, ptr %i.qf, align 16, !tbaa !90
  %i.qh = getelementptr inbounds nuw i8, ptr %.5124.epil.init, i64 32
  %i.qi = load <4 x float>, ptr %.0675121.epil.init, align 16, !tbaa !90
  store <4 x float> %i.qi, ptr %i.qh, align 16, !tbaa !90
  %i.qj = getelementptr inbounds nuw i8, ptr %.5124.epil.init, i64 48
  %i.qk = load <4 x float>, ptr %.0693120.epil.init, align 16, !tbaa !90
  store <4 x float> %i.qk, ptr %i.qj, align 16, !tbaa !90
...
.loopexit106:                                     ; preds = %.lr.ph182, %.lr.ph125.epil.preheader, %.loopexit106.loopexit1246.unr-lcssa, %.loopexit106.loopexit1245.unr-lcssa.a, %.lr.ph117.epil, %.loopexit106.loopexit.unr-lcssa, %.lr.ph.epil, %middle.block, %vec.epilog.middle.block, %bb.b, %.split, %bb.c, %bb.d, %bb.e, %.preheader105
  ...
  %i.qm = or disjoint i64 %indvars.iv.next, 15
  %i.qn = icmp samesign ult i64 %i.qm, %i.w
  br i1 %i.qn, label %bb.b, label %.preheader104.loopexit, !llvm.loop !325
...
.lr.ph300.split.us:                               ; preds = %.lr.ph300.split.us.preheader, %.loopexit.us
  ...
  %.pre489 = load ptr, ptr %0, align 8, !tbaa !25 ; 5 uses
...
.lr.ph262.us:                                     ; preds = %.lr.ph262.us.preheader, %.lr.ph262.us
  ...
  %i.rv = load <4 x float>, ptr %.0692259.us, align 16, !tbaa !90
  store <4 x float> %i.rv, ptr %.20261.us, align 16, !tbaa !90
  ...
  br i1 %niter1311.ncmp.7, label %.loopexit97.us.loopexit.unr-lcssa, label %.lr.ph262.us, !llvm.loop !326
...
.lr.ph262.us.epil:                                ; preds = %.lr.ph262.us.epil, %.lr.ph262.us.epil.preheader
  ...
  %i.st = load <4 x float>, ptr %.0692259.us.epil, align 16, !tbaa !90
  store <4 x float> %i.st, ptr %.20261.us.epil, align 16, !tbaa !90
  ...
  br i1 %epil.iter1306.cmp.not, label %.loopexit97.us.loopexit, label %.lr.ph262.us.epil, !llvm.loop !327
...
.lr.ph270.us:                                     ; preds = %.loopexit97.us, %.lr.ph270.us
  ...
  %i.tl = load <8 x float>, ptr %.0688264.us, align 1, !tbaa !90 ; 2 uses
  %i.tm = load <8 x float>, ptr %.0685265.us, align 1, !tbaa !90 ; 2 uses
  %i.tn = load <8 x float>, ptr %.0682266.us, align 1, !tbaa !90 ; 2 uses
  %i.to = load <8 x float>, ptr %.0679267.us, align 1, !tbaa !90 ; 2 uses
  %i.tp = shufflevector <8 x float> %i.tl, <8 x float> %i.tm, <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 4, i32 12, i32 5, i32 13> ; 2 uses
  %i.tq = shufflevector <8 x float> %i.tl, <8 x float> %i.tm, <8 x i32> <i32 2, i32 10, i32 3, i32 11, i32 6, i32 14, i32 7, i32 15> ; 2 uses
  %i.tr = shufflevector <8 x float> %i.tn, <8 x float> %i.to, <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 4, i32 12, i32 5, i32 13> ; 2 uses
  %i.ts = shufflevector <8 x float> %i.tn, <8 x float> %i.to, <8 x i32> <i32 2, i32 10, i32 3, i32 11, i32 6, i32 14, i32 7, i32 15> ; 2 uses
  ...
  %i.tv = shufflevector <8 x float> %i.tp, <8 x float> %i.tr, <8 x i32> <i32 4, i32 5, i32 12, i32 13, i32 6, i32 7, i32 14, i32 15>
  %i.tw = shufflevector <8 x float> %i.tq, <8 x float> %i.ts, <8 x i32> <i32 4, i32 5, i32 12, i32 13, i32 6, i32 7, i32 14, i32 15>
  store <8 x float> %i.tt, ptr %.22269.us, align 1, !tbaa !90
  %i.tx = getelementptr inbounds nuw i8, ptr %.22269.us, i64 32
  store <8 x float> %i.tu, ptr %i.tx, align 1, !tbaa !90
  %i.ty = getelementptr inbounds nuw i8, ptr %.22269.us, i64 64
  store <8 x float> %i.tv, ptr %i.ty, align 1, !tbaa !90
  %i.tz = getelementptr inbounds nuw i8, ptr %.22269.us, i64 96
  store <8 x float> %i.tw, ptr %i.tz, align 1, !tbaa !90
  ...
  %i.ug = or disjoint i32 %i.uf, 7
  %i.uh = icmp slt i32 %i.ug, %4
  br i1 %i.uh, label %.lr.ph270.us, label %.preheader96.us, !llvm.loop !328
...
.lr.ph283.us:                                     ; preds = %.preheader96.us, %.lr.ph283.us
  ...
  %i.ui = load <4 x float>, ptr %.1689277.us, align 1, !tbaa !90 ; 2 uses
  %i.uj = load <4 x float>, ptr %.1686278.us, align 1, !tbaa !90 ; 2 uses
  %i.uk = load <4 x float>, ptr %.1683279.us, align 1, !tbaa !90 ; 2 uses
  %i.ul = load <4 x float>, ptr %.1680280.us, align 1, !tbaa !90 ; 2 uses
  %i.um = shufflevector <4 x float> %i.ui, <4 x float> %i.uj, <4 x i32> <i32 0, i32 4, i32 1, i32 5> ; 2 uses
  %i.un = shufflevector <4 x float> %i.uk, <4 x float> %i.ul, <4 x i32> <i32 0, i32 4, i32 1, i32 5> ; 2 uses
  %i.uo = shufflevector <4 x float> %i.ui, <4 x float> %i.uj, <4 x i32> <i32 2, i32 6, i32 3, i32 7> ; 2 uses
  %i.up = shufflevector <4 x float> %i.uk, <4 x float> %i.ul, <4 x i32> <i32 2, i32 6, i32 3, i32 7> ; 2 uses
...
vector.body1049:                                  ; preds = %vector.body1049, %vector.ph1047
  ...
  %wide.load1056.a = load <16 x float>, ptr %next.gep1055, align 4, !tbaa !69, !alias.scope !398
  %wide.load1057.a = load <16 x float>, ptr %next.gep1054.a, align 4, !tbaa !69, !alias.scope !399
  %wide.load1058.a = load <16 x float>, ptr %next.gep1053.a, align 4, !tbaa !69, !alias.scope !400
  %wide.load1059 = load <16 x float>, ptr %next.gep1052.a, align 4, !tbaa !69, !alias.scope !401
  ...
  store <64 x float> %interleaved.vec1060, ptr %next.gep1051.a, align 4, !tbaa !69, !alias.scope !402, !noalias !403
  %index.next1061 = add nuw i64 %index1050, 16    ; 2 uses
  %i.xc = icmp eq i64 %index.next1061, %n.vec1048
  br i1 %i.xc, label %middle.block1062, label %vector.body1049, !llvm.loop !337
...
vec.epilog.iter.check1073:                        ; preds = %middle.block1062
  ...
  br i1 %min.epilog.iters.check1074, label %.lr.ph296.us.preheader, label %vec.epilog.ph1075, !prof !92
...
vec.epilog.vector.body1077:                       ; preds = %vec.epilog.vector.body1077, %vec.epilog.ph1075
  ...
  %wide.load1084.a = load <4 x float>, ptr %next.gep1083, align 4, !tbaa !69, !alias.scope !398
  %wide.load1085.a = load <4 x float>, ptr %next.gep1082.a, align 4, !tbaa !69, !alias.scope !399
  %wide.load1086.a = load <4 x float>, ptr %next.gep1081.a, align 4, !tbaa !69, !alias.scope !400
  %wide.load1087 = load <4 x float>, ptr %next.gep1080.a, align 4, !tbaa !69, !alias.scope !401
  ...
  store <16 x float> %interleaved.vec1088, ptr %next.gep1079.a, align 4, !tbaa !69, !alias.scope !402, !noalias !403
  %index.next1089 = add nuw i64 %index1078, 4     ; 2 uses
  %i.xq = icmp eq i64 %index.next1089, %n.vec1076
  br i1 %i.xq, label %vec.epilog.middle.block1090, label %vec.epilog.vector.body1077, !llvm.loop !338
...
.lr.ph296.us.prol:                                ; preds = %.lr.ph296.us.preheader
  %i.xs = load float, ptr %.2690290.us.ph, align 4, !tbaa !69
  store float %i.xs, ptr %.24295.us.ph, align 4, !tbaa !69
  %i.xt = load float, ptr %.2687291.us.ph, align 4, !tbaa !69
  %i.xu = getelementptr inbounds nuw i8, ptr %.24295.us.ph, i64 4
  store float %i.xt, ptr %i.xu, align 4, !tbaa !69
  %i.xv = load float, ptr %.2684292.us.ph, align 4, !tbaa !69
  %i.xw = getelementptr inbounds nuw i8, ptr %.24295.us.ph, i64 8
  store float %i.xv, ptr %i.xw, align 4, !tbaa !69
  %i.xx = load float, ptr %.2681293.us.ph, align 4, !tbaa !69
...
.loopexit.us:                                     ; preds = %.lr.ph296.us.prol.loopexit, %.lr.ph296.us, %middle.block1062, %vec.epilog.middle.block1090, %.preheader95.us
  ...
  br i1 %i.yg, label %.lr.ph300.split.us, label %.preheader94.loopexit, !llvm.loop !339
...
.lr.ph262.us312.us.new:                           ; preds = %.lr.ph262.us312.us, %.lr.ph262.us312.us.new
  ...
  %i.zd = load <4 x float>, ptr %.0692259.us308.us, align 16, !tbaa !90
  store <4 x float> %i.zd, ptr %.20261.us306.us, align 16, !tbaa !90
  ...
  br i1 %niter1304.ncmp.7, label %..loopexit97_crit_edge.us313.us.unr-lcssa, label %.lr.ph262.us312.us.new, !llvm.loop !326
...
bb.h:                                             ; preds = %bb.h, %.epil.preheader
  ...
  %i.aab = load <4 x float>, ptr %.0692259.us308.us.epil, align 16, !tbaa !90
  store <4 x float> %i.aab, ptr %.20261.us306.us.epil, align 16, !tbaa !90
  ...
  br i1 %epil.iter1299.cmp.not, label %..loopexit97_crit_edge.us313.us, label %bb.h, !llvm.loop !340
...
..loopexit97_crit_edge.us313.us:                  ; preds = %bb.h, %..loopexit97_crit_edge.us313.us.unr-lcssa
  ...
  br i1 %i.aae, label %.lr.ph262.us312.us, label %.preheader94.loopexit375, !llvm.loop !339
...
.lr.ph192:                                        ; preds = %.lr.ph192.preheader, %.lr.ph192
  ...
  br i1 %niter1297.ncmp.7, label %.loopexit100.loopexit.unr-lcssa, label %.lr.ph192, !llvm.loop !341
...
.lr.ph198:                                        ; preds = %.lr.ph198.preheader, %.lr.ph198
  ...
  %i.abr = load <4 x float>, ptr %.0752194, align 16, !tbaa !90
  store <4 x float> %i.abr, ptr %.13197, align 16, !tbaa !90
  %i.abs = getelementptr inbounds nuw i8, ptr %.13197, i64 16
  %i.abt = load <4 x float>, ptr %.0751195, align 16, !tbaa !90
  store <4 x float> %i.abt, ptr %i.abs, align 16, !tbaa !90
...
bb.aj:                                            ; preds = %.lr.ph2801
  %i.bhp = load <4 x i32>, ptr %.172800, align 16, !tbaa !90
  br label %bb.ak
...
.preheader2159.loopexit.unr-lcssa:                ; preds = %.lr.ph2786
  br i1 %lcmp.mod5245.not.not, label %.lr.ph2786.epil.preheader, label %.preheader2159.loopexit
...
.lr.ph2786.epil.preheader:                        ; preds = %.preheader2159.loopexit.unr-lcssa, %.lr.ph2786.preheader
  ...
  %.epil.init5244 = phi <4 x i32> [ %i.bhq, %.lr.ph2786.preheader ], [ %i.bjm, %.preheader2159.loopexit.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod5247)
  %i.bhr = load <8 x i8>, ptr %.014062783.epil.init, align 1, !tbaa !90
  %i.bhs = load i16, ptr %.1313792784.epil.init, align 2, !tbaa !110
  ...
  %i.bhz = add <4 x i32> %i.bhy, %.epil.init5244
  br label %.preheader2159.loopexit

.preheader2159.loopexit:                          ; preds = %.preheader2159.loopexit.unr-lcssa, %.lr.ph2786.epil.preheader
  %.lcssa5040 = phi <4 x i32> [ %i.bjm, %.preheader2159.loopexit.unr-lcssa ], [ %i.bhz, %.lr.ph2786.epil.preheader ]
...
.preheader2159:                                   ; preds = %.preheader2159.loopexit, %bb.ak
  %.lcssa2236 = phi <4 x i32> [ %i.bhq, %bb.ak ], [ %.lcssa5040, %.preheader2159.loopexit ] ; 3 uses
...
.lr.ph2794.preheader:                             ; preds = %.preheader2159
  ...
  %.neg5331 = add i32 %.01432.lcssa, 1
  %xtraiter5250 = and i32 %i.bic, 1
  %lcmp.mod5251.not = icmp eq i32 %xtraiter5250, 0
  br i1 %lcmp.mod5251.not, label %.lr.ph2794.prol.loopexit, label %.lr.ph2794.prol

.lr.ph2794.prol:                                  ; preds = %.lr.ph2794.preheader
  %i.bid = load <8 x i8>, ptr %.01406.lcssa, align 1, !tbaa !90
  %i.bie = load i8, ptr %.131379.lcssa, align 1, !tbaa !90
...
.lr.ph2794.prol.loopexit:                         ; preds = %.lr.ph2794.prol, %.lr.ph2794.preheader
  %.lcssa5042.unr = phi <4 x i32> [ poison, %.lr.ph2794.preheader ], [ %i.bin, %.lr.ph2794.prol ]
  %.lcssa5041.unr = phi ptr [ poison, %.lr.ph2794.preheader ], [ %i.bip, %.lr.ph2794.prol ]
  ...
  %.unr5252 = phi <4 x i32> [ %.lcssa2236, %.lr.ph2794.preheader ], [ %i.bin, %.lr.ph2794.prol ]
  %i.bir = icmp eq i32 %8, %.neg5331
...
.lr.ph2786:                                       ; preds = %.lr.ph2786.preheader, %.lr.ph2786
  ...
  %niter5249 = phi i32 [ %niter5249.next.1, %.lr.ph2786 ], [ 0, %.lr.ph2786.preheader ]
  %i.bit = load <8 x i8>, ptr %.014062783, align 1, !tbaa !90
  %i.biu = load i16, ptr %.1313792784, align 2, !tbaa !110
  ...
  %i.bje = load <8 x i8>, ptr %i.bjc, align 1, !tbaa !90
  %i.bjf = load i16, ptr %i.bjd, align 2, !tbaa !110
  ...
  %niter5249.next.1 = add nuw nsw i32 %niter5249, 2 ; 2 uses
  %niter5249.ncmp.1.not = icmp eq i32 %niter5249.next.1, %unroll_iter5248
  br i1 %niter5249.ncmp.1.not, label %.preheader2159.loopexit.unr-lcssa, label %.lr.ph2786, !llvm.loop !863
...
.lr.ph2794:                                       ; preds = %.lr.ph2794.prol.loopexit, %.lr.ph2794
  ...
  %i.bjp = phi <4 x i32> [ %i.bkn, %.lr.ph2794 ], [ %.unr5252, %.lr.ph2794.prol.loopexit ]
  %i.bjq = load <8 x i8>, ptr %.114072792, align 1, !tbaa !90
  %i.bjr = load i8, ptr %.1413802793, align 1, !tbaa !90
  ...
  %i.bkd = load <8 x i8>, ptr %i.bkb, align 1, !tbaa !90
  %i.bke = load i8, ptr %i.bkc, align 1, !tbaa !90
  ...
  br i1 %exitcond3489.not.1, label %._crit_edge2795, label %.lr.ph2794, !llvm.loop !864

._crit_edge2795:                                  ; preds = %.lr.ph2794.prol.loopexit, %.lr.ph2794, %.preheader2159
  %.lcssa2237 = phi <4 x i32> [ %.lcssa2236, %.preheader2159 ], [ %.lcssa5042.unr, %.lr.ph2794.prol.loopexit ], [ %i.bkn, %.lr.ph2794 ]
  %.141380.lcssa = phi ptr [ %.131379.lcssa, %.preheader2159 ], [ %.lcssa5041.unr, %.lr.ph2794.prol.loopexit ], [ %i.bkp, %.lr.ph2794 ]
  store <4 x i32> %.lcssa2237, ptr %.172800, align 16, !tbaa !90
  ...
  br i1 %exitcond3490.not, label %._crit_edge2802, label %.lr.ph2801, !llvm.loop !865
...
._crit_edge2802:                                  ; preds = %._crit_edge2795, %.preheader2164
  ...
  br i1 %i.bkw, label %.preheader2168, label %.preheader2158, !llvm.loop !866
...
.preheader2157:                                   ; preds = %.preheader2157.lr.ph, %._crit_edge2948
  ...
  %.32952 = phi ptr [ %.21212.lcssa, %.preheader2157.lr.ph ], [ %i.cor, %._crit_edge2948 ] ; 26 uses
  %.182951 = phi ptr [ %.12.lcssa, %.preheader2157.lr.ph ], [ %.23.lcssa, %._crit_edge2948 ] ; 2 uses
  %.312212950 = phi i32 [ %.21220.lcssa, %.preheader2157.lr.ph ], [ %i.cos, %._crit_edge2948 ]
  br i1 %i.atv, label %.lr.ph2831, label %.preheader2156

.preheader2147:                                   ; preds = %._crit_edge2948, %.preheader2158
  %.31221.lcssa = phi i32 [ %.21220.lcssa, %.preheader2158 ], [ %i.cos, %._crit_edge2948 ] ; 2 uses
  %.18.lcssa = phi ptr [ %.12.lcssa, %.preheader2158 ], [ %.23.lcssa, %._crit_edge2948 ]
  %.3.lcssa = phi ptr [ %.21212.lcssa, %.preheader2158 ], [ %i.cor, %._crit_edge2948 ] ; 2 uses
...
.preheader2146.lr.ph:                             ; preds = %.preheader2147
  ...
  %unroll_iter5301 = and i32 %i.blv, -2
  %i.blx = and i32 %i.blt, 2
  %lcmp.mod5296.not.not = icmp eq i32 %i.blx, 0
  %lcmp.mod5300 = trunc i32 %i.blv to i1
  %i.bly = icmp eq i32 %i.blu, 0
  %unroll_iter5313 = and i32 %i.blv, -2
  %i.blz = and i32 %i.blt, 2
  %lcmp.mod5309.not.not = icmp eq i32 %i.blz, 0
  %lcmp.mod5312 = trunc i32 %i.blv to i1
  %i.bma = icmp eq i32 %i.blu, 0
  %unroll_iter5324 = and i32 %i.blv, -2
  %i.bmb = and i32 %i.blt, 2
  %lcmp.mod5321.not.not = icmp eq i32 %i.bmb, 0
  %lcmp.mod5323 = trunc i32 %i.blv to i1
...
bb.al:                                            ; preds = %.lr.ph2831
  %i.bmu = load <16 x i32>, ptr %.192830, align 1, !tbaa !90
  %i.bmv = getelementptr inbounds nuw i8, ptr %.192830, i64 64
  %i.bmw = load <16 x i32>, ptr %i.bmv, align 1, !tbaa !90
  br label %bb.am
...
.preheader2152.loopexit.unr-lcssa:                ; preds = %.lr.ph2814
  br i1 %lcmp.mod5258.not.not, label %.lr.ph2814.epil.preheader, label %.preheader2152
...
.lr.ph2814.epil.preheader:                        ; preds = %.preheader2152.loopexit.unr-lcssa, %.lr.ph2814.preheader
  ...
  %.epil.init5255 = phi <16 x i32> [ %i.bmy, %.lr.ph2814.preheader ], [ %i.bos, %.preheader2152.loopexit.unr-lcssa ]
  %.epil.init5257 = phi <16 x i32> [ %i.bmx, %.lr.ph2814.preheader ], [ %i.boo, %.preheader2152.loopexit.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod5263)
  %i.bmz = load float, ptr %.014102811.epil.init, align 1, !tbaa !90
  ...
  %i.bnc = load <32 x i8>, ptr %.114182810.epil.init, align 1, !tbaa !90 ; 2 uses
  ...
  %i.bnh = add <16 x i32> %i.bng, %.epil.init5257
  ...
  %i.bnl = add <16 x i32> %i.bnk, %.epil.init5255
...
.lr.ph2814:                                       ; preds = %.lr.ph2814.preheader, %.lr.ph2814
  ...
  %niter5265 = phi i32 [ %niter5265.next.1, %.lr.ph2814 ], [ 0, %.lr.ph2814.preheader ]
  %i.bnr = load float, ptr %.014102811, align 1, !tbaa !90
  ...
  %i.bnu = load <32 x i8>, ptr %.114182810, align 1, !tbaa !90 ; 2 uses
  ...
  %i.bog = load float, ptr %i.boe, align 1, !tbaa !90
  ...
  %i.boj = load <32 x i8>, ptr %i.bof, align 1, !tbaa !90 ; 2 uses
  ...
  %niter5265.next.1 = add nuw nsw i32 %niter5265, 2 ; 2 uses
  %niter5265.ncmp.1.not = icmp eq i32 %niter5265.next.1, %unroll_iter5264
  br i1 %niter5265.ncmp.1.not, label %.preheader2152.loopexit.unr-lcssa, label %.lr.ph2814, !llvm.loop !867
...
.lr.ph2823:                                       ; preds = %.preheader2152, %.lr.ph2823
  ...
  %i.box = load i16, ptr %.114112821, align 2, !tbaa !110
  %i.boy = insertelement <8 x i16> poison, i16 %i.box, i64 0
  %i.boz = load <16 x i8>, ptr %.214192820, align 16, !tbaa !90 ; 2 uses
  ...
  br i1 %exitcond3491.not, label %._crit_edge2824, label %.lr.ph2823, !llvm.loop !868
...
._crit_edge2824:                                  ; preds = %.lr.ph2823, %.preheader2152
  ...
  store <16 x i32> %.lcssa2199, ptr %.192830, align 1, !tbaa !90
  %i.bpp = getelementptr inbounds nuw i8, ptr %.192830, i64 64
  store <16 x i32> %.lcssa2198, ptr %i.bpp, align 1, !tbaa !90
  ...
  br i1 %i.bpt, label %.lr.ph2831, label %.preheader2156, !llvm.loop !869
...
vector.body4724:                                  ; preds = %vector.body4724, %vector.ph4722
  ...
  %vec.phi4726 = phi <16 x i32> [ %i.cys, %vector.ph4722 ], [ %i.dbc, %vector.body4724 ]
  %vec.phi4727 = phi <16 x i32> [ zeroinitializer, %vector.ph4722 ], [ %i.dbd, %vector.body4724 ]
  %vec.phi4728 = phi <16 x i32> [ zeroinitializer, %vector.ph4722 ], [ %i.dbe, %vector.body4724 ]
  %vec.phi4729 = phi <16 x i32> [ zeroinitializer, %vector.ph4722 ], [ %i.dbf, %vector.body4724 ]
  %vec.phi4730 = phi <16 x i32> [ %i.cyt, %vector.ph4722 ], [ %i.dae, %vector.body4724 ]
  %vec.phi4731 = phi <16 x i32> [ zeroinitializer, %vector.ph4722 ], [ %i.daf, %vector.body4724 ]
  %vec.phi4732 = phi <16 x i32> [ zeroinitializer, %vector.ph4722 ], [ %i.dag, %vector.body4724 ]
  %vec.phi4733 = phi <16 x i32> [ zeroinitializer, %vector.ph4722 ], [ %i.dah, %vector.body4724 ]
  %i.cyu = shl i64 %index4725, 1                  ; 4 uses
  %next.gep4734 = getelementptr i8, ptr %.43113, i64 %i.cyu
  %i.cyv = getelementptr i8, ptr %.43113, i64 %i.cyu
  %next.gep4735 = getelementptr i8, ptr %i.cyv, i64 32
  %i.cyw = getelementptr i8, ptr %.43113, i64 %i.cyu
  %next.gep4736 = getelementptr i8, ptr %i.cyw, i64 64
  %i.cyx = getelementptr i8, ptr %.43113, i64 %i.cyu
  %next.gep4737 = getelementptr i8, ptr %i.cyx, i64 96
  %i.cyy = shl i64 %index4725, 2                  ; 4 uses
  %next.gep4738 = getelementptr i8, ptr %.912893072, i64 %i.cyy
  %i.cyz = getelementptr i8, ptr %.912893072, i64 %i.cyy
  %next.gep4739 = getelementptr i8, ptr %i.cyz, i64 64
  %i.cza = getelementptr i8, ptr %.912893072, i64 %i.cyy
  %next.gep4740 = getelementptr i8, ptr %i.cza, i64 128
  %i.czb = getelementptr i8, ptr %.912893072, i64 %i.cyy
  %next.gep4741 = getelementptr i8, ptr %i.czb, i64 192
  %wide.vec4742 = load <32 x i8>, ptr %next.gep4734, align 1, !tbaa !90 ; 2 uses
  ...
  %wide.vec4745 = load <32 x i8>, ptr %next.gep4735, align 1, !tbaa !90 ; 2 uses
  ...
  %wide.vec4748 = load <32 x i8>, ptr %next.gep4736, align 1, !tbaa !90 ; 2 uses
  ...
  %wide.vec4751 = load <32 x i8>, ptr %next.gep4737, align 1, !tbaa !90 ; 2 uses
  ...
  %i.czc = sext <16 x i8> %strided.vec4743 to <16 x i32> ; 2 uses
  %i.czd = sext <16 x i8> %strided.vec4746 to <16 x i32> ; 2 uses
  %i.cze = sext <16 x i8> %strided.vec4749 to <16 x i32> ; 2 uses
  %i.czf = sext <16 x i8> %strided.vec4752 to <16 x i32> ; 2 uses
  %wide.vec4754 = load <64 x i8>, ptr %next.gep4738, align 1, !tbaa !90 ; 4 uses
  ...
  %wide.vec4759 = load <64 x i8>, ptr %next.gep4739, align 1, !tbaa !90 ; 4 uses
  ...
  %wide.vec4764 = load <64 x i8>, ptr %next.gep4740, align 1, !tbaa !90 ; 4 uses
  ...
  %wide.vec4769 = load <64 x i8>, ptr %next.gep4741, align 1, !tbaa !90 ; 4 uses
  ...
  %i.czg = sext <16 x i8> %strided.vec4755 to <16 x i32>
  %i.czh = sext <16 x i8> %strided.vec4760 to <16 x i32>
  %i.czi = sext <16 x i8> %strided.vec4765 to <16 x i32>
  %i.czj = sext <16 x i8> %strided.vec4770 to <16 x i32>
  %i.czk = mul nsw <16 x i32> %i.czg, %i.czc
  %i.czl = mul nsw <16 x i32> %i.czh, %i.czd
  %i.czm = mul nsw <16 x i32> %i.czi, %i.cze
  %i.czn = mul nsw <16 x i32> %i.czj, %i.czf
  %i.czo = add <16 x i32> %i.czk, %vec.phi4730
  %i.czp = add <16 x i32> %i.czl, %vec.phi4731
  %i.czq = add <16 x i32> %i.czm, %vec.phi4732
  %i.czr = add <16 x i32> %i.czn, %vec.phi4733
  %i.czs = sext <16 x i8> %strided.vec4744 to <16 x i32> ; 2 uses
  %i.czt = sext <16 x i8> %strided.vec4747 to <16 x i32> ; 2 uses
  %i.czu = sext <16 x i8> %strided.vec4750 to <16 x i32> ; 2 uses
  %i.czv = sext <16 x i8> %strided.vec4753 to <16 x i32> ; 2 uses
  %i.czw = sext <16 x i8> %strided.vec4756 to <16 x i32>
  %i.czx = sext <16 x i8> %strided.vec4761 to <16 x i32>
  %i.czy = sext <16 x i8> %strided.vec4766 to <16 x i32>
  %i.czz = sext <16 x i8> %strided.vec4771 to <16 x i32>
  %i.daa = mul nsw <16 x i32> %i.czw, %i.czs
  %i.dab = mul nsw <16 x i32> %i.czx, %i.czt
  %i.dac = mul nsw <16 x i32> %i.czy, %i.czu
  %i.dad = mul nsw <16 x i32> %i.czz, %i.czv
  %i.dae = add <16 x i32> %i.czo, %i.daa          ; 2 uses
  %i.daf = add <16 x i32> %i.czp, %i.dab          ; 2 uses
  %i.dag = add <16 x i32> %i.czq, %i.dac          ; 2 uses
  %i.dah = add <16 x i32> %i.czr, %i.dad          ; 2 uses
  %i.dai = sext <16 x i8> %strided.vec4757 to <16 x i32>
  %i.daj = sext <16 x i8> %strided.vec4762 to <16 x i32>
  %i.dak = sext <16 x i8> %strided.vec4767 to <16 x i32>
  %i.dal = sext <16 x i8> %strided.vec4772 to <16 x i32>
  %i.dam = mul nsw <16 x i32> %i.dai, %i.czc
  %i.dan = mul nsw <16 x i32> %i.daj, %i.czd
  %i.dao = mul nsw <16 x i32> %i.dak, %i.cze
  %i.dap = mul nsw <16 x i32> %i.dal, %i.czf
  %i.daq = add <16 x i32> %i.dam, %vec.phi4726
  %i.dar = add <16 x i32> %i.dan, %vec.phi4727
  %i.das = add <16 x i32> %i.dao, %vec.phi4728
  %i.dat = add <16 x i32> %i.dap, %vec.phi4729
  %i.dau = sext <16 x i8> %strided.vec4758 to <16 x i32>
  %i.dav = sext <16 x i8> %strided.vec4763 to <16 x i32>
  %i.daw = sext <16 x i8> %strided.vec4768 to <16 x i32>
  %i.dax = sext <16 x i8> %strided.vec4773 to <16 x i32>
  %i.day = mul nsw <16 x i32> %i.dau, %i.czs
  %i.daz = mul nsw <16 x i32> %i.dav, %i.czt
  %i.dba = mul nsw <16 x i32> %i.daw, %i.czu
  %i.dbb = mul nsw <16 x i32> %i.dax, %i.czv
  %i.dbc = add <16 x i32> %i.daq, %i.day          ; 2 uses
  %i.dbd = add <16 x i32> %i.dar, %i.daz          ; 2 uses
  %i.dbe = add <16 x i32> %i.das, %i.dba          ; 2 uses
  %i.dbf = add <16 x i32> %i.dat, %i.dbb          ; 2 uses
  %index.next4774 = add nuw i64 %index4725, 64    ; 2 uses
  %i.dbg = icmp eq i64 %index.next4774, %n.vec4723
  br i1 %i.dbg, label %middle.block4775, label %vector.body4724, !llvm.loop !900

middle.block4775:                                 ; preds = %vector.body4724
  %bin.rdx4776 = add <16 x i32> %i.dbd, %i.dbc
  %bin.rdx4777 = add <16 x i32> %i.dbe, %bin.rdx4776
  %bin.rdx4778 = add <16 x i32> %i.dbf, %bin.rdx4777
  %i.dbh = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %bin.rdx4778) ; 3 uses
  %bin.rdx4779 = add <16 x i32> %i.daf, %i.dae
  %bin.rdx4780 = add <16 x i32> %i.dag, %bin.rdx4779
  %bin.rdx4781 = add <16 x i32> %i.dah, %bin.rdx4780
  %i.dbi = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %bin.rdx4781) ; 3 uses
  br i1 %cmp.n4782, label %.preheader.loopexit, label %vec.epilog.iter.check4790

vec.epilog.iter.check4790:                        ; preds = %middle.block4775
  br i1 %min.epilog.iters.check4791, label %.lr.ph3031.preheader, label %vec.epilog.ph4792, !prof !73
...
vec.epilog.ph4792:                                ; preds = %vector.main.loop.iter.check4720, %vec.epilog.iter.check4790
  ...
  %bc.merge.rdx4785 = phi i32 [ %i.dbh, %vec.epilog.iter.check4790 ], [ %.01204, %vector.main.loop.iter.check4720 ]
  %bc.merge.rdx4786 = phi i32 [ %i.dbi, %vec.epilog.iter.check4790 ], [ %.01207, %vector.main.loop.iter.check4720 ]
  %i.dbj = getelementptr i8, ptr %.912893072, i64 %i.bmk
  %i.dbk = insertelement <8 x i32> <i32 poison, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0>, i32 %bc.merge.rdx4785, i64 0
  %i.dbl = insertelement <8 x i32> <i32 poison, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0>, i32 %bc.merge.rdx4786, i64 0
...
vec.epilog.vector.body4794:                       ; preds = %vec.epilog.vector.body4794, %vec.epilog.ph4792
  ...
  %vec.phi4796 = phi <8 x i32> [ %i.dbk, %vec.epilog.ph4792 ], [ %i.dcb, %vec.epilog.vector.body4794 ]
  %vec.phi4797 = phi <8 x i32> [ %i.dbl, %vec.epilog.ph4792 ], [ %i.dbv, %vec.epilog.vector.body4794 ]
  %i.dbm = shl i64 %index4795, 1
  %next.gep4798 = getelementptr i8, ptr %.43113, i64 %i.dbm
  %i.dbn = shl i64 %index4795, 2
  %next.gep4799 = getelementptr i8, ptr %.912893072, i64 %i.dbn
  %wide.vec4800 = load <16 x i8>, ptr %next.gep4798, align 1, !tbaa !90 ; 2 uses
  ...
  %i.dbo = sext <8 x i8> %strided.vec4801 to <8 x i32> ; 2 uses
  %wide.vec4803 = load <32 x i8>, ptr %next.gep4799, align 1, !tbaa !90 ; 4 uses
  ...
  %i.dbp = sext <8 x i8> %strided.vec4804 to <8 x i32>
  %i.dbq = mul nsw <8 x i32> %i.dbp, %i.dbo
  %i.dbr = add <8 x i32> %i.dbq, %vec.phi4797
  %i.dbs = sext <8 x i8> %strided.vec4802 to <8 x i32> ; 2 uses
  %i.dbt = sext <8 x i8> %strided.vec4805 to <8 x i32>
  %i.dbu = mul nsw <8 x i32> %i.dbt, %i.dbs
  %i.dbv = add <8 x i32> %i.dbr, %i.dbu           ; 2 uses
  %i.dbw = sext <8 x i8> %strided.vec4806 to <8 x i32>
  %i.dbx = mul nsw <8 x i32> %i.dbw, %i.dbo
  %i.dby = add <8 x i32> %i.dbx, %vec.phi4796
  %i.dbz = sext <8 x i8> %strided.vec4807 to <8 x i32>
  %i.dca = mul nsw <8 x i32> %i.dbz, %i.dbs
  %i.dcb = add <8 x i32> %i.dby, %i.dca           ; 2 uses
  %index.next4808 = add nuw i64 %index4795, 8     ; 2 uses
  %i.dcc = icmp eq i64 %index.next4808, %n.vec4793
  br i1 %i.dcc, label %vec.epilog.middle.block4809, label %vec.epilog.vector.body4794, !llvm.loop !901

vec.epilog.middle.block4809:                      ; preds = %vec.epilog.vector.body4794
  %i.dcd = tail call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> %i.dcb) ; 2 uses
  %i.dce = tail call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> %i.dbv) ; 2 uses
...
.lr.ph3031.preheader:                             ; preds = %iter.check4788, %vec.epilog.iter.check4790, %vec.epilog.middle.block4809
  ...
  %.012013028.ph = phi ptr [ %.43113, %iter.check4788 ], [ %i.cvd, %vec.epilog.iter.check4790 ], [ %i.cve, %vec.epilog.middle.block4809 ]
  %.112053027.ph = phi i32 [ %.01204, %iter.check4788 ], [ %i.dbh, %vec.epilog.iter.check4790 ], [ %i.dcd, %vec.epilog.middle.block4809 ]
  %.112083026.ph = phi i32 [ %.01207, %iter.check4788 ], [ %i.dbi, %vec.epilog.iter.check4790 ], [ %i.dce, %vec.epilog.middle.block4809 ]
  %.1012903025.ph = phi ptr [ %.912893072, %iter.check4788 ], [ %i.cyr, %vec.epilog.iter.check4790 ], [ %i.dbj, %vec.epilog.middle.block4809 ]
  br label %.lr.ph3031

.preheader.loopexit:                              ; preds = %.lr.ph3031, %vec.epilog.middle.block4809, %middle.block4775
  %.lcssa3848 = phi i32 [ %i.dce, %vec.epilog.middle.block4809 ], [ %i.dbi, %middle.block4775 ], [ %i.dgv, %.lr.ph3031 ]
  %.lcssa3847 = phi i32 [ %i.dcd, %vec.epilog.middle.block4809 ], [ %i.dbh, %middle.block4775 ], [ %i.dhf, %.lr.ph3031 ]
  %i.dcf = getelementptr i8, ptr %.912893072, i64 %i.bln
  %scevgep3512 = getelementptr i8, ptr %i.dcf, i64 4
  br label %.preheader
...
.preheader:                                       ; preds = %.preheader.loopexit, %bb.bc
  ...
  %i.dcg = add nuw nsw i32 %.01199.lcssa, 3
  %i.dch = icmp slt i32 %i.dcg, %8
  br i1 %i.dch, label %iter.check4673, label %._crit_edge3049

iter.check4673:                                   ; preds = %.preheader
  %9 = add i32 %.01199.lcssa, 7
  %smax = tail call i32 @llvm.smax.i32(i32 %8, i32 %9)
  %10 = add i32 %smax, -4
  %i.dci = sub i32 %10, %.01199.lcssa             ; 3 uses
  %i.dcj = lshr i32 %i.dci, 2
  %narrow4816 = add nuw nsw i32 %i.dcj, 1
  %i.dck = zext nneg i32 %narrow4816 to i64       ; 5 uses
  %min.iters.check4628 = icmp ult i32 %i.dci, 12
...
vector.main.loop.iter.check4629:                  ; preds = %iter.check4673
  %min.iters.check4630 = icmp ult i32 %i.dci, 60
  br i1 %min.iters.check4630, label %vec.epilog.ph4677, label %vector.ph4631

vector.ph4631:                                    ; preds = %vector.main.loop.iter.check4629
  %i.dcl = and i64 %i.dck, 12
  %n.vec4632 = and i64 %i.dck, 2147483632         ; 6 uses
  %i.dcm = trunc nuw nsw i64 %n.vec4632 to i32
  %i.dcn = shl i32 %i.dcm, 2
  %i.dco = add i32 %.01199.lcssa, %i.dcn          ; 2 uses
  %i.dcp = shl nuw nsw i64 %n.vec4632, 2
  %i.dcq = getelementptr i8, ptr %.01201.lcssa, i64 %i.dcp ; 2 uses
  %i.dcr = shl nuw nsw i64 %n.vec4632, 3
  %i.dcs = getelementptr i8, ptr %.101290.lcssa, i64 %i.dcr ; 2 uses
...
vector.body4633:                                  ; preds = %vector.body4633, %vector.ph4631
  ...
  %vec.phi4635 = phi <16 x i32> [ zeroinitializer, %vector.ph4631 ], [ %i.ddw, %vector.body4633 ]
  %vec.phi4636 = phi <16 x i32> [ zeroinitializer, %vector.ph4631 ], [ %i.ddp, %vector.body4633 ]
  %vec.phi4637 = phi <16 x i32> [ zeroinitializer, %vector.ph4631 ], [ %i.ddi, %vector.body4633 ]
  %vec.phi4638 = phi <16 x i32> [ zeroinitializer, %vector.ph4631 ], [ %i.ddb, %vector.body4633 ]
  %vec.phi4639 = phi <16 x i32> [ zeroinitializer, %vector.ph4631 ], [ %i.ddt, %vector.body4633 ]
  %vec.phi4640 = phi <16 x i32> [ zeroinitializer, %vector.ph4631 ], [ %i.ddm, %vector.body4633 ]
  %vec.phi4641 = phi <16 x i32> [ zeroinitializer, %vector.ph4631 ], [ %i.ddf, %vector.body4633 ]
  %vec.phi4642 = phi <16 x i32> [ zeroinitializer, %vector.ph4631 ], [ %i.dcy, %vector.body4633 ]
  %i.dct = shl i64 %index4634, 2
  %next.gep4643 = getelementptr i8, ptr %.01201.lcssa, i64 %i.dct
  %i.dcu = shl i64 %index4634, 3
  %next.gep4644 = getelementptr i8, ptr %.101290.lcssa, i64 %i.dcu
  %wide.vec4645 = load <64 x i8>, ptr %next.gep4643, align 1, !tbaa !90 ; 4 uses
  ...
  %i.dcv = sext <16 x i8> %strided.vec4646 to <16 x i32> ; 2 uses
  %wide.vec4650 = load <128 x i8>, ptr %next.gep4644, align 1, !tbaa !90 ; 8 uses
  ...
  %i.dcw = sext <16 x i8> %strided.vec4651 to <16 x i32>
  %i.dcx = mul nsw <16 x i32> %i.dcw, %i.dcv
  %i.dcy = add <16 x i32> %i.dcx, %vec.phi4642    ; 2 uses
  %i.dcz = sext <16 x i8> %strided.vec4652 to <16 x i32>
  %i.dda = mul nsw <16 x i32> %i.dcz, %i.dcv
  %i.ddb = add <16 x i32> %i.dda, %vec.phi4638    ; 2 uses
  %i.ddc = sext <16 x i8> %strided.vec4647 to <16 x i32> ; 2 uses
  %i.ddd = sext <16 x i8> %strided.vec4653 to <16 x i32>
  %i.dde = mul nsw <16 x i32> %i.ddd, %i.ddc
  %i.ddf = add <16 x i32> %i.dde, %vec.phi4641    ; 2 uses
  %i.ddg = sext <16 x i8> %strided.vec4654 to <16 x i32>
  %i.ddh = mul nsw <16 x i32> %i.ddg, %i.ddc
  %i.ddi = add <16 x i32> %i.ddh, %vec.phi4637    ; 2 uses
  %i.ddj = sext <16 x i8> %strided.vec4648 to <16 x i32> ; 2 uses
  %i.ddk = sext <16 x i8> %strided.vec4655 to <16 x i32>
  %i.ddl = mul nsw <16 x i32> %i.ddk, %i.ddj
  %i.ddm = add <16 x i32> %i.ddl, %vec.phi4640    ; 2 uses
  %i.ddn = sext <16 x i8> %strided.vec4656 to <16 x i32>
  %i.ddo = mul nsw <16 x i32> %i.ddn, %i.ddj
  %i.ddp = add <16 x i32> %i.ddo, %vec.phi4636    ; 2 uses
  %i.ddq = sext <16 x i8> %strided.vec4649 to <16 x i32> ; 2 uses
  %i.ddr = sext <16 x i8> %strided.vec4657 to <16 x i32>
  %i.dds = mul nsw <16 x i32> %i.ddr, %i.ddq
  %i.ddt = add <16 x i32> %i.dds, %vec.phi4639    ; 2 uses
  %i.ddu = sext <16 x i8> %strided.vec4658 to <16 x i32>
  %i.ddv = mul nsw <16 x i32> %i.ddu, %i.ddq
  %i.ddw = add <16 x i32> %i.ddv, %vec.phi4635    ; 2 uses
  %index.next4659 = add nuw i64 %index4634, 16    ; 2 uses
  %i.ddx = icmp eq i64 %index.next4659, %n.vec4632
  br i1 %i.ddx, label %middle.block4660, label %vector.body4633, !llvm.loop !902

middle.block4660:                                 ; preds = %vector.body4633
  %i.ddy = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %i.ddw) ; 3 uses
  %i.ddz = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %i.ddp) ; 3 uses
  %i.dea = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %i.ddi) ; 3 uses
  %i.deb = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %i.ddb) ; 3 uses
  %i.dec = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %i.ddt) ; 3 uses
  %i.ded = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %i.ddm) ; 3 uses
  %i.dee = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %i.ddf) ; 3 uses
  %i.def = tail call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> %i.dcy) ; 3 uses
  %cmp.n4661 = icmp eq i64 %n.vec4632, %i.dck
  br i1 %cmp.n4661, label %._crit_edge3049, label %vec.epilog.iter.check4675

vec.epilog.iter.check4675:                        ; preds = %middle.block4660
  %min.epilog.iters.check4676 = icmp eq i64 %i.dcl, 0
  br i1 %min.epilog.iters.check4676, label %.lr.ph3048.preheader, label %vec.epilog.ph4677, !prof !92
...
vec.epilog.ph4677:                                ; preds = %vector.main.loop.iter.check4629, %vec.epilog.iter.check4675
  ...
  %bc.merge.rdx4663 = phi i32 [ %i.ddy, %vec.epilog.iter.check4675 ], [ 0, %vector.main.loop.iter.check4629 ]
  %bc.merge.rdx4664 = phi i32 [ %i.ddz, %vec.epilog.iter.check4675 ], [ 0, %vector.main.loop.iter.check4629 ]
  %bc.merge.rdx4665 = phi i32 [ %i.dea, %vec.epilog.iter.check4675 ], [ 0, %vector.main.loop.iter.check4629 ]
  %bc.merge.rdx4666 = phi i32 [ %i.deb, %vec.epilog.iter.check4675 ], [ 0, %vector.main.loop.iter.check4629 ]
  %bc.merge.rdx4667 = phi i32 [ %i.dec, %vec.epilog.iter.check4675 ], [ 0, %vector.main.loop.iter.check4629 ]
  %bc.merge.rdx4668 = phi i32 [ %i.ded, %vec.epilog.iter.check4675 ], [ 0, %vector.main.loop.iter.check4629 ]
  %bc.merge.rdx4669 = phi i32 [ %i.dee, %vec.epilog.iter.check4675 ], [ 0, %vector.main.loop.iter.check4629 ]
  %bc.merge.rdx4670 = phi i32 [ %i.def, %vec.epilog.iter.check4675 ], [ 0, %vector.main.loop.iter.check4629 ]
  %n.vec4678 = and i64 %i.dck, 2147483644         ; 5 uses
  %i.deg = trunc nuw nsw i64 %n.vec4678 to i32
  %i.deh = shl i32 %i.deg, 2
  %i.dei = add i32 %.01199.lcssa, %i.deh          ; 2 uses
  %i.dej = shl nuw nsw i64 %n.vec4678, 2
  %i.dek = getelementptr i8, ptr %.01201.lcssa, i64 %i.dej ; 2 uses
  %i.del = shl nuw nsw i64 %n.vec4678, 3
  %i.dem = getelementptr i8, ptr %.101290.lcssa, i64 %i.del ; 2 uses
  %i.den = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %bc.merge.rdx4663, i64 0
  %i.deo = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %bc.merge.rdx4664, i64 0
  %i.dep = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %bc.merge.rdx4665, i64 0
  %i.deq = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %bc.merge.rdx4666, i64 0
  %i.der = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %bc.merge.rdx4667, i64 0
  %i.des = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %bc.merge.rdx4668, i64 0
  %i.det = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %bc.merge.rdx4669, i64 0
  %i.deu = insertelement <4 x i32> <i32 poison, i32 0, i32 0, i32 0>, i32 %bc.merge.rdx4670, i64 0
...
vec.epilog.vector.body4679:                       ; preds = %vec.epilog.vector.body4679, %vec.epilog.ph4677
  ...
  %vec.phi4681 = phi <4 x i32> [ %i.den, %vec.epilog.ph4677 ], [ %i.dfy, %vec.epilog.vector.body4679 ]
  %vec.phi4682 = phi <4 x i32> [ %i.deo, %vec.epilog.ph4677 ], [ %i.dfr, %vec.epilog.vector.body4679 ]
  %vec.phi4683 = phi <4 x i32> [ %i.dep, %vec.epilog.ph4677 ], [ %i.dfk, %vec.epilog.vector.body4679 ]
  %vec.phi4684 = phi <4 x i32> [ %i.deq, %vec.epilog.ph4677 ], [ %i.dfd, %vec.epilog.vector.body4679 ]
  %vec.phi4685 = phi <4 x i32> [ %i.der, %vec.epilog.ph4677 ], [ %i.dfv, %vec.epilog.vector.body4679 ]
  %vec.phi4686 = phi <4 x i32> [ %i.des, %vec.epilog.ph4677 ], [ %i.dfo, %vec.epilog.vector.body4679 ]
  %vec.phi4687 = phi <4 x i32> [ %i.det, %vec.epilog.ph4677 ], [ %i.dfh, %vec.epilog.vector.body4679 ]
  %vec.phi4688 = phi <4 x i32> [ %i.deu, %vec.epilog.ph4677 ], [ %i.dfa, %vec.epilog.vector.body4679 ]
  %i.dev = shl i64 %index4680, 2
  %next.gep4689 = getelementptr i8, ptr %.01201.lcssa, i64 %i.dev
  %i.dew = shl i64 %index4680, 3
  %next.gep4690 = getelementptr i8, ptr %.101290.lcssa, i64 %i.dew
  %wide.vec4691 = load <16 x i8>, ptr %next.gep4689, align 1, !tbaa !90 ; 4 uses
  ...
  %i.dex = sext <4 x i8> %strided.vec4692 to <4 x i32> ; 2 uses
  %wide.vec4696 = load <32 x i8>, ptr %next.gep4690, align 1, !tbaa !90 ; 8 uses
  ...
  %i.dey = sext <4 x i8> %strided.vec4697 to <4 x i32>
  %i.dez = mul nsw <4 x i32> %i.dey, %i.dex
  %i.dfa = add <4 x i32> %i.dez, %vec.phi4688     ; 2 uses
  %i.dfb = sext <4 x i8> %strided.vec4698 to <4 x i32>
  %i.dfc = mul nsw <4 x i32> %i.dfb, %i.dex
  %i.dfd = add <4 x i32> %i.dfc, %vec.phi4684     ; 2 uses
  %i.dfe = sext <4 x i8> %strided.vec4693 to <4 x i32> ; 2 uses
  %i.dff = sext <4 x i8> %strided.vec4699 to <4 x i32>
  %i.dfg = mul nsw <4 x i32> %i.dff, %i.dfe
  %i.dfh = add <4 x i32> %i.dfg, %vec.phi4687     ; 2 uses
  %i.dfi = sext <4 x i8> %strided.vec4700 to <4 x i32>
  %i.dfj = mul nsw <4 x i32> %i.dfi, %i.dfe
  %i.dfk = add <4 x i32> %i.dfj, %vec.phi4683     ; 2 uses
  %i.dfl = sext <4 x i8> %strided.vec4694 to <4 x i32> ; 2 uses
  %i.dfm = sext <4 x i8> %strided.vec4701 to <4 x i32>
  %i.dfn = mul nsw <4 x i32> %i.dfm, %i.dfl
  %i.dfo = add <4 x i32> %i.dfn, %vec.phi4686     ; 2 uses
  %i.dfp = sext <4 x i8> %strided.vec4702 to <4 x i32>
  %i.dfq = mul nsw <4 x i32> %i.dfp, %i.dfl
  %i.dfr = add <4 x i32> %i.dfq, %vec.phi4682     ; 2 uses
  %i.dfs = sext <4 x i8> %strided.vec4695 to <4 x i32> ; 2 uses
  %i.dft = sext <4 x i8> %strided.vec4703 to <4 x i32>
  %i.dfu = mul nsw <4 x i32> %i.dft, %i.dfs
  %i.dfv = add <4 x i32> %i.dfu, %vec.phi4685     ; 2 uses
  %i.dfw = sext <4 x i8> %strided.vec4704 to <4 x i32>
  %i.dfx = mul nsw <4 x i32> %i.dfw, %i.dfs
  %i.dfy = add <4 x i32> %i.dfx, %vec.phi4681     ; 2 uses
  %index.next4705 = add nuw i64 %index4680, 4     ; 2 uses
  %i.dfz = icmp eq i64 %index.next4705, %n.vec4678
  br i1 %i.dfz, label %vec.epilog.middle.block4706, label %vec.epilog.vector.body4679, !llvm.loop !903

vec.epilog.middle.block4706:                      ; preds = %vec.epilog.vector.body4679
  %i.dga = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.dfy) ; 2 uses
  %i.dgb = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.dfr) ; 2 uses
  %i.dgc = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.dfk) ; 2 uses
  %i.dgd = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.dfd) ; 2 uses
  %i.dge = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.dfv) ; 2 uses
  %i.dgf = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.dfo) ; 2 uses
  %i.dgg = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.dfh) ; 2 uses
  %i.dgh = tail call i32 @llvm.vector.reduce.add.v4i32(<4 x i32> %i.dfa) ; 2 uses
  %cmp.n4707 = icmp eq i64 %n.vec4678, %i.dck
...
.lr.ph3048.preheader:                             ; preds = %iter.check4673, %vec.epilog.iter.check4675, %vec.epilog.middle.block4706
  %.011913047.ph = phi i32 [ 0, %iter.check4673 ], [ %i.ddy, %vec.epilog.iter.check4675 ], [ %i.dga, %vec.epilog.middle.block4706 ]
end_hunk_5
...
.lr.ph302.prol:                                   ; preds = %.lr.ph302.preheader910
  %i.fp = load i64, ptr %.4229300.ph, align 1, !tbaa !90
  store i64 %i.fp, ptr %.5301.ph, align 1, !tbaa !90
  %i.fq = getelementptr inbounds nuw i8, ptr %.5301.ph, i64 8
  %i.fr = load i64, ptr %.0257299.ph, align 1, !tbaa !90
  store i64 %i.fr, ptr %i.fq, align 1, !tbaa !90
  %i.fs = getelementptr inbounds nuw i8, ptr %.5301.ph, i64 16
  %i.ft = load i64, ptr %.0261296.ph, align 1, !tbaa !90
  store i64 %i.ft, ptr %i.fs, align 1, !tbaa !90
  %i.fu = getelementptr inbounds nuw i8, ptr %.5301.ph, i64 24
  %i.fv = load i64, ptr %.0260297.ph, align 1, !tbaa !90
  store i64 %i.fv, ptr %i.fu, align 1, !tbaa !90
...
.lr.ph302:                                        ; preds = %.lr.ph302.prol.loopexit, %.lr.ph302
  ...
  %i.gd = load i64, ptr %.4229300, align 1, !tbaa !90
  store i64 %i.gd, ptr %.5301, align 1, !tbaa !90
  %i.ge = getelementptr inbounds nuw i8, ptr %.5301, i64 8
  %i.gf = load i64, ptr %.0257299, align 1, !tbaa !90
  store i64 %i.gf, ptr %i.ge, align 1, !tbaa !90
  %i.gg = getelementptr inbounds nuw i8, ptr %.5301, i64 16
  %i.gh = load i64, ptr %.0261296, align 1, !tbaa !90
  store i64 %i.gh, ptr %i.gg, align 1, !tbaa !90
  %i.gi = getelementptr inbounds nuw i8, ptr %.5301, i64 24
  %i.gj = load i64, ptr %.0260297, align 1, !tbaa !90
  store i64 %i.gj, ptr %i.gi, align 1, !tbaa !90
  ...
  %i.gp = load i64, ptr %i.gl, align 1, !tbaa !90
  store i64 %i.gp, ptr %i.gk, align 1, !tbaa !90
  %i.gq = getelementptr inbounds nuw i8, ptr %.5301, i64 40
  %i.gr = load i64, ptr %i.gm, align 1, !tbaa !90
  store i64 %i.gr, ptr %i.gq, align 1, !tbaa !90
  %i.gs = getelementptr inbounds nuw i8, ptr %.5301, i64 48
  %i.gt = load i64, ptr %i.gn, align 1, !tbaa !90
  store i64 %i.gt, ptr %i.gs, align 1, !tbaa !90
  %i.gu = getelementptr inbounds nuw i8, ptr %.5301, i64 56
  %i.gv = load i64, ptr %i.go, align 1, !tbaa !90
  store i64 %i.gv, ptr %i.gu, align 1, !tbaa !90
  ...
  br i1 %exitcond461.not.1, label %.loopexit280, label %.lr.ph302, !llvm.loop !1310
...
.lr.ph308:                                        ; preds = %.lr.ph308.preheader, %.lr.ph308
  ...
  store <16 x i16> %i.hd, ptr %.7307, align 1, !tbaa !90
  ...
  store <16 x i16> %i.hh, ptr %i.he, align 1, !tbaa !90
  ...
  store <16 x i16> %i.hl, ptr %i.hi, align 1, !tbaa !90
  ...
  store <16 x i16> %i.hp, ptr %i.hm, align 1, !tbaa !90
  ...
  br i1 %niter934.ncmp.3, label %.loopexit280.loopexit.unr-lcssa, label %.lr.ph308, !llvm.loop !1311
...
.lr.ph308.epil:                                   ; preds = %.lr.ph308.epil, %.lr.ph308.epil.preheader
  ...
  store <16 x i16> %i.ht, ptr %.7307.epil, align 1, !tbaa !90
  ...
  br i1 %epil.iter929.cmp.not, label %.loopexit280, label %.lr.ph308.epil, !llvm.loop !1312
...
.lr.ph293.epil:                                   ; preds = %.lr.ph293.epil, %.lr.ph293.epil.preheader
  ...
  %i.hw = load <2 x i64>, ptr %.2227291.epil, align 1, !tbaa !90
  store <2 x i64> %i.hw, ptr %.3292.epil, align 1, !tbaa !90
  %i.hx = getelementptr inbounds nuw i8, ptr %.3292.epil, i64 16
  %i.hy = load <2 x i64>, ptr %.0246290.epil, align 1, !tbaa !90
  store <2 x i64> %i.hy, ptr %i.hx, align 1, !tbaa !90
  ...
  br i1 %epil.iter922.cmp.not, label %.loopexit280, label %.lr.ph293.epil, !llvm.loop !1313
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %i.ic = load <4 x i64>, ptr %.0225286.epil, align 1, !tbaa !90
  store <4 x i64> %i.ic, ptr %.1287.epil, align 1, !tbaa !90
  ...
  br i1 %epil.iter.cmp.not, label %.loopexit280, label %.lr.ph.epil, !llvm.loop !1314
...
.loopexit280:                                     ; preds = %.loopexit280.loopexit912.unr-lcssa, %.lr.ph.epil, %.lr.ph302.prol.loopexit, %.lr.ph302, %.loopexit280.loopexit909.unr-lcssa.a, %.lr.ph293.epil, %.loopexit280.loopexit.unr-lcssa, %.lr.ph308.epil, %middle.block, %bb.h, %bb.i, %.loopexit281
  ...
  br i1 %i.ig, label %bb.g, label %.preheader279.loopexit, !llvm.loop !1315
...
.lr.ph367.split.us:                               ; preds = %.lr.ph367.split.us.preheader, %.loopexit271.us
  ...
  %i.ji = load ptr, ptr %0, align 8, !tbaa !25    ; 2 uses
...
vector.body744:                                   ; preds = %vector.body744, %vector.ph742
  ...
  %wide.load748.a = load <8 x i64>, ptr %next.gep747, align 1, !tbaa !90
  %wide.load749.a = load <8 x i64>, ptr %i.jt, align 1, !tbaa !90
  %wide.load750 = load <8 x i64>, ptr %i.ju, align 1, !tbaa !90
  %wide.load751 = load <8 x i64>, ptr %i.jv, align 1, !tbaa !90
  ...
  store <8 x i64> %wide.load748.a, ptr %next.gep746, align 1, !tbaa !90
  store <8 x i64> %wide.load749.a, ptr %i.jw, align 1, !tbaa !90
  store <8 x i64> %wide.load750, ptr %i.jx, align 1, !tbaa !90
  store <8 x i64> %wide.load751, ptr %i.jy, align 1, !tbaa !90
  %index.next752 = add nuw i64 %index745, 32      ; 2 uses
  %i.jz = icmp eq i64 %index.next752, %n.vec743
  br i1 %i.jz, label %middle.block753, label %vector.body744, !llvm.loop !1316
...
vec.epilog.iter.check761:                         ; preds = %middle.block753
  br i1 %min.epilog.iters.check762, label %.lr.ph341.us.preheader, label %vec.epilog.ph763, !prof !104
...
vec.epilog.vector.body765:                        ; preds = %vec.epilog.vector.body765, %vec.epilog.ph763
  ...
  %wide.load769 = load <8 x i64>, ptr %next.gep768, align 1, !tbaa !90
  store <8 x i64> %wide.load769, ptr %next.gep767, align 1, !tbaa !90
  %index.next770 = add nuw i64 %index766, 8       ; 2 uses
  %i.kd = icmp eq i64 %index.next770, %n.vec764
  br i1 %i.kd, label %vec.epilog.middle.block771, label %vec.epilog.vector.body765, !llvm.loop !1317
...
.lr.ph341.us.prol:                                ; preds = %.lr.ph341.us.preheader, %.lr.ph341.us.prol
  ...
  %i.kf = load i64, ptr %.0242338.us.prol, align 1, !tbaa !90
  store i64 %i.kf, ptr %.17340.us.prol, align 1, !tbaa !90
  ...
  br i1 %prol.iter956.cmp.not, label %.lr.ph341.us.prol.loopexit, label %.lr.ph341.us.prol, !llvm.loop !1318
...
.lr.ph341.us:                                     ; preds = %.lr.ph341.us.prol.loopexit, %.lr.ph341.us
  ...
  br i1 %exitcond475.not.7, label %.loopexit273.us, label %.lr.ph341.us, !llvm.loop !1319
...
begin_hunk_7_@_ZN4ncnnL16pack_A_tile_bf16ERKNS_3MatERS0_iiii:bb.a
  ...
  br i1 %exitcond476.not.1, label %.loopexit271.us, label %.lr.ph363.us, !llvm.loop !1321
...
vector.body684:                                   ; preds = %vector.body684, %vector.ph682
  ...
  %wide.load691.a = load <32 x i16>, ptr %next.gep690, align 2, !tbaa !110, !alias.scope !1367
  %wide.load692.a = load <32 x i16>, ptr %next.gep689, align 2, !tbaa !110, !alias.scope !1368
  %wide.load693 = load <32 x i16>, ptr %next.gep688.a, align 2, !tbaa !110, !alias.scope !1369
  %wide.load694 = load <32 x i16>, ptr %next.gep687.a, align 2, !tbaa !110, !alias.scope !1370
  ...
  store <128 x i16> %interleaved.vec695, ptr %next.gep686.a, align 2, !tbaa !110, !alias.scope !1371, !noalias !1372
  %index.next696 = add nuw i64 %index685, 32      ; 2 uses
  %i.ol = icmp eq i64 %index.next696, %n.vec683
  br i1 %i.ol, label %middle.block697, label %vector.body684, !llvm.loop !1328
...
vec.epilog.iter.check708:                         ; preds = %middle.block697
  ...
  br i1 %min.epilog.iters.check709, label %.lr.ph363.us.preheader, label %vec.epilog.ph710, !prof !104
...
vec.epilog.vector.body712:                        ; preds = %vec.epilog.vector.body712, %vec.epilog.ph710
  ...
  %wide.load719.a = load <8 x i16>, ptr %next.gep718, align 2, !tbaa !110, !alias.scope !1367
  %wide.load720.a = load <8 x i16>, ptr %next.gep717, align 2, !tbaa !110, !alias.scope !1368
  %wide.load721 = load <8 x i16>, ptr %next.gep716.a, align 2, !tbaa !110, !alias.scope !1369
  %wide.load722 = load <8 x i16>, ptr %next.gep715.a, align 2, !tbaa !110, !alias.scope !1370
  ...
  store <32 x i16> %interleaved.vec723, ptr %next.gep714.a, align 2, !tbaa !110, !alias.scope !1371, !noalias !1372
  %index.next724 = add nuw i64 %index713, 8       ; 2 uses
  %i.oz = icmp eq i64 %index.next724, %n.vec711
  br i1 %i.oz, label %vec.epilog.middle.block725, label %vec.epilog.vector.body712, !llvm.loop !1329
...
.lr.ph363.us.prol:                                ; preds = %.lr.ph363.us.preheader
  %i.pb = load i16, ptr %.3245357.us.ph, align 2, !tbaa !110
  store i16 %i.pb, ptr %.20362.us.ph, align 2, !tbaa !110
  %i.pc = load i16, ptr %.1240358.us.ph, align 2, !tbaa !110
  %i.pd = getelementptr inbounds nuw i8, ptr %.20362.us.ph, i64 2
  store i16 %i.pc, ptr %i.pd, align 2, !tbaa !110
  %i.pe = load i16, ptr %.1238359.us.ph, align 2, !tbaa !110
  %i.pf = getelementptr inbounds nuw i8, ptr %.20362.us.ph, i64 4
  store i16 %i.pe, ptr %i.pf, align 2, !tbaa !110
  %i.pg = load i16, ptr %.1236360.us.ph, align 2, !tbaa !110
  %i.ph = getelementptr inbounds nuw i8, ptr %.20362.us.ph, i64 6
  store i16 %i.pg, ptr %i.ph, align 2, !tbaa !110
...
.loopexit271.us:                                  ; preds = %.lr.ph363.us.prol.loopexit, %.lr.ph363.us, %middle.block697, %vec.epilog.middle.block725, %.preheader270.us
  ...
  br i1 %i.pp, label %.lr.ph367.split.us, label %.preheader269.loopexit, !llvm.loop !1330
...
vector.body628:                                   ; preds = %vector.body628, %vector.ph626
  ...
  %wide.load632.a = load <8 x i64>, ptr %next.gep631, align 1, !tbaa !90
  %wide.load633.a = load <8 x i64>, ptr %i.rc, align 1, !tbaa !90
  %wide.load634 = load <8 x i64>, ptr %i.rd, align 1, !tbaa !90
  %wide.load635 = load <8 x i64>, ptr %i.re, align 1, !tbaa !90
  ...
  store <8 x i64> %wide.load632.a, ptr %next.gep630, align 1, !tbaa !90
  store <8 x i64> %wide.load633.a, ptr %i.rf, align 1, !tbaa !90
  store <8 x i64> %wide.load634, ptr %i.rg, align 1, !tbaa !90
  store <8 x i64> %wide.load635, ptr %i.rh, align 1, !tbaa !90
  %index.next636 = add nuw i64 %index629, 32      ; 2 uses
  %i.ri = icmp eq i64 %index.next636, %n.vec627
  br i1 %i.ri, label %middle.block637, label %vector.body628, !llvm.loop !1331
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load646 = load <8 x i64>, ptr %next.gep645, align 1, !tbaa !90
  store <8 x i64> %wide.load646, ptr %next.gep644, align 1, !tbaa !90
  %index.next647 = add nuw i64 %index643, 8       ; 2 uses
  %i.rm = icmp eq i64 %index.next647, %n.vec642
  br i1 %i.rm, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !1332
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  %i.ro = load i64, ptr %.0242338.us375.us.prol, align 1, !tbaa !90
  store i64 %i.ro, ptr %.17340.us373.us.prol, align 1, !tbaa !90
  ...
  br i1 %prol.iter953.cmp.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol, !llvm.loop !1333
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  %i.ru = load i64, ptr %.0242338.us375.us, align 1, !tbaa !90
  store i64 %i.ru, ptr %.17340.us373.us, align 1, !tbaa !90
  ...
  br i1 %exitcond470.not.7, label %..loopexit273_crit_edge.us381.us, label %vec.epilog.scalar.ph, !llvm.loop !1334
...
..loopexit273_crit_edge.us381.us:                 ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block637
  ...
  br i1 %i.st, label %iter.check, label %.preheader269.loopexit428, !llvm.loop !1330
...
bb.j:                                             ; preds = %.lr.ph335, %.loopexit275
  ...
  %i.sv = load ptr, ptr %0, align 8, !tbaa !25    ; 4 uses
...
vector.body604:                                   ; preds = %vector.body604, %vector.ph602
  ...
  %wide.load609 = load <8 x i64>, ptr %next.gep608, align 1, !tbaa !90, !alias.scope !1373
  %wide.load610 = load <8 x i64>, ptr %next.gep607, align 1, !tbaa !90, !alias.scope !1374
  ...
  store <16 x i64> %interleaved.vec611, ptr %next.gep606.a, align 1, !tbaa !90, !alias.scope !1375, !noalias !1376
  %index.next612 = add nuw i64 %index605, 8       ; 2 uses
  %i.up = icmp eq i64 %index.next612, %n.vec603
  br i1 %i.up, label %middle.block613, label %vector.body604, !llvm.loop !1340
...
.lr.ph325.prol:                                   ; preds = %.lr.ph325.preheader903, %.lr.ph325.prol
  ...
  %i.ur = load i64, ptr %.2253321.prol, align 1, !tbaa !90
  store i64 %i.ur, ptr %.12324.prol, align 1, !tbaa !90
  %i.us = getelementptr inbounds nuw i8, ptr %.12324.prol, i64 8
  %i.ut = load i64, ptr %.0249322.prol, align 1, !tbaa !90
  store i64 %i.ut, ptr %i.us, align 1, !tbaa !90
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph325.prol.loopexit, label %.lr.ph325.prol, !llvm.loop !1341
...
.lr.ph325:                                        ; preds = %.lr.ph325.prol.loopexit, %.lr.ph325
  ...
  %i.va = load i64, ptr %.2253321, align 1, !tbaa !90
  store i64 %i.va, ptr %.12324, align 1, !tbaa !90
  %i.vb = getelementptr inbounds nuw i8, ptr %.12324, i64 8
  %i.vc = load i64, ptr %.0249322, align 1, !tbaa !90
  store i64 %i.vc, ptr %i.vb, align 1, !tbaa !90
  ...
  %i.vg = load i64, ptr %i.ve, align 1, !tbaa !90
  store i64 %i.vg, ptr %i.vd, align 1, !tbaa !90
  %i.vh = getelementptr inbounds nuw i8, ptr %.12324, i64 24
  %i.vi = load i64, ptr %i.vf, align 1, !tbaa !90
  store i64 %i.vi, ptr %i.vh, align 1, !tbaa !90
  ...
  %i.vm = load i64, ptr %i.vk, align 1, !tbaa !90
  store i64 %i.vm, ptr %i.vj, align 1, !tbaa !90
  %i.vn = getelementptr inbounds nuw i8, ptr %.12324, i64 40
  %i.vo = load i64, ptr %i.vl, align 1, !tbaa !90
  store i64 %i.vo, ptr %i.vn, align 1, !tbaa !90
  ...
  %i.vs = load i64, ptr %i.vq, align 1, !tbaa !90
  store i64 %i.vs, ptr %i.vp, align 1, !tbaa !90
  %i.vt = getelementptr inbounds nuw i8, ptr %.12324, i64 56
  %i.vu = load i64, ptr %i.vr, align 1, !tbaa !90
  store i64 %i.vu, ptr %i.vt, align 1, !tbaa !90
  ...
  br i1 %exitcond465.not.3, label %.loopexit275, label %.lr.ph325, !llvm.loop !1342
...
.lr.ph331:                                        ; preds = %.lr.ph331.preheader, %.lr.ph331
  ...
  store <8 x i16> %i.wa, ptr %.14330, align 1, !tbaa !90
  ...
  store <8 x i16> %i.we, ptr %i.wb, align 1, !tbaa !90
  ...
  store <8 x i16> %i.wi, ptr %i.wf, align 1, !tbaa !90
  ...
  store <8 x i16> %i.wm, ptr %i.wj, align 1, !tbaa !90
  ...
  br i1 %niter948.ncmp.3, label %.loopexit275.loopexit904.unr-lcssa, label %.lr.ph331, !llvm.loop !1343
...
.lr.ph331.epil:                                   ; preds = %.lr.ph331.epil, %.lr.ph331.epil.preheader
  ...
  store <8 x i16> %i.wq, ptr %.14330.epil, align 1, !tbaa !90
  ...
  br i1 %epil.iter943.cmp.not, label %.loopexit275, label %.lr.ph331.epil, !llvm.loop !1344
...
.lr.ph318.epil:                                   ; preds = %.lr.ph318.epil, %.lr.ph318.epil.preheader
  ...
  %i.wt = load <2 x i64>, ptr %.0251315.epil, align 1, !tbaa !90
  store <2 x i64> %i.wt, ptr %.10317.epil, align 1, !tbaa !90
  ...
  br i1 %epil.iter936.cmp.not, label %.loopexit275, label %.lr.ph318.epil, !llvm.loop !1345
...
.loopexit275:                                     ; preds = %.loopexit275.loopexit905.unr-lcssa, %.lr.ph318.epil, %.loopexit275.loopexit904.unr-lcssa, %.lr.ph331.epil, %.lr.ph325.prol.loopexit, %.lr.ph325, %middle.block613, %bb.k, %.loopexit276
  ...
  br i1 %i.ww, label %bb.j, label %.preheader274.loopexit, !llvm.loop !1346
...
.lr.ph397:                                        ; preds = %.preheader269
  %i.xb = load ptr, ptr %0, align 8, !tbaa !25    ; 5 uses
...
vector.body797:                                   ; preds = %vector.body797, %vector.ph795
  ...
  %wide.load802 = load <32 x i16>, ptr %next.gep800, align 2, !tbaa !110, !alias.scope !1377
  %wide.load803 = load <32 x i16>, ptr %next.gep799, align 2, !tbaa !110, !alias.scope !1378
  ...
  store <64 x i16> %interleaved.vec804, ptr %next.gep801, align 2, !tbaa !110, !alias.scope !1379, !noalias !1380
  %index.next805 = add nuw i64 %index798, 32      ; 2 uses
  %i.zh = icmp eq i64 %index.next805, %n.vec796
  br i1 %i.zh, label %middle.block806, label %vector.body797, !llvm.loop !1351
...
vec.epilog.iter.check815:                         ; preds = %middle.block806
  br i1 %min.epilog.iters.check816, label %vec.epilog.scalar.ph814.preheader, label %vec.epilog.ph817, !prof !104
...
vec.epilog.vector.body819:                        ; preds = %vec.epilog.vector.body819, %vec.epilog.ph817
  ...
  %wide.load824 = load <8 x i16>, ptr %next.gep822, align 2, !tbaa !110, !alias.scope !1377
  %wide.load825 = load <8 x i16>, ptr %next.gep821, align 2, !tbaa !110, !alias.scope !1378
  ...
  store <16 x i16> %interleaved.vec826, ptr %next.gep823, align 2, !tbaa !110, !alias.scope !1379, !noalias !1380
  %index.next827 = add nuw i64 %index820, 8       ; 2 uses
  %i.zn = icmp eq i64 %index.next827, %n.vec818
  br i1 %i.zn, label %vec.epilog.middle.block828, label %vec.epilog.vector.body819, !llvm.loop !1352
...
vec.epilog.scalar.ph814.prol:                     ; preds = %vec.epilog.scalar.ph814.preheader, %vec.epilog.scalar.ph814.prol
  ...
  %i.zp = load i16, ptr %.0218390.us.prol, align 2, !tbaa !110
  store i16 %i.zp, ptr %.23389.us.prol, align 2, !tbaa !110
  %i.zq = load i16, ptr %.0217391.us.prol, align 2, !tbaa !110
  %i.zr = getelementptr inbounds nuw i8, ptr %.23389.us.prol, i64 2
  store i16 %i.zq, ptr %i.zr, align 2, !tbaa !110
  ...
  br i1 %prol.iter962.cmp.not.a, label %vec.epilog.scalar.ph814.prol.loopexit, label %vec.epilog.scalar.ph814.prol, !llvm.loop !1353
...
vec.epilog.scalar.ph814:                          ; preds = %vec.epilog.scalar.ph814.prol.loopexit, %vec.epilog.scalar.ph814
  ...
  %i.zy = load i16, ptr %.0218390.us, align 2, !tbaa !110
  store i16 %i.zy, ptr %.23389.us, align 2, !tbaa !110
  %i.zz = load i16, ptr %.0217391.us, align 2, !tbaa !110
  %i.aaa = getelementptr inbounds nuw i8, ptr %.23389.us, i64 2
  store i16 %i.zz, ptr %i.aaa, align 2, !tbaa !110
  ...
  %i.aae = load i16, ptr %i.aac, align 2, !tbaa !110
  store i16 %i.aae, ptr %i.aab, align 2, !tbaa !110
  %i.aaf = load i16, ptr %i.aad, align 2, !tbaa !110
  %i.aag = getelementptr inbounds nuw i8, ptr %.23389.us, i64 6
  store i16 %i.aaf, ptr %i.aag, align 2, !tbaa !110
...
.lr.ph272.prol:                                   ; preds = %.lr.ph272.preheader844
  %i.fp = load i64, ptr %.4225266.ph, align 1, !tbaa !90
  store i64 %i.fp, ptr %.5271.ph, align 1, !tbaa !90
  %i.fq = getelementptr inbounds nuw i8, ptr %.5271.ph, i64 8
  %i.fr = load i64, ptr %.0217267.ph, align 1, !tbaa !90
  store i64 %i.fr, ptr %i.fq, align 1, !tbaa !90
  %i.fs = getelementptr inbounds nuw i8, ptr %.5271.ph, i64 16
  %i.ft = load i64, ptr %.0216268.ph, align 1, !tbaa !90
  store i64 %i.ft, ptr %i.fs, align 1, !tbaa !90
  %i.fu = getelementptr inbounds nuw i8, ptr %.5271.ph, i64 24
  %i.fv = load i64, ptr %.0215269.ph, align 1, !tbaa !90
  store i64 %i.fv, ptr %i.fu, align 1, !tbaa !90
...
.lr.ph272:                                        ; preds = %.lr.ph272.prol.loopexit, %.lr.ph272
  ...
  %i.gd = load i64, ptr %.4225266, align 1, !tbaa !90
  store i64 %i.gd, ptr %.5271, align 1, !tbaa !90
  %i.ge = getelementptr inbounds nuw i8, ptr %.5271, i64 8
  %i.gf = load i64, ptr %.0217267, align 1, !tbaa !90
  store i64 %i.gf, ptr %i.ge, align 1, !tbaa !90
  %i.gg = getelementptr inbounds nuw i8, ptr %.5271, i64 16
  %i.gh = load i64, ptr %.0216268, align 1, !tbaa !90
  store i64 %i.gh, ptr %i.gg, align 1, !tbaa !90
  %i.gi = getelementptr inbounds nuw i8, ptr %.5271, i64 24
  %i.gj = load i64, ptr %.0215269, align 1, !tbaa !90
  store i64 %i.gj, ptr %i.gi, align 1, !tbaa !90
  ...
  br i1 %exitcond412.not.1, label %.loopexit250, label %.lr.ph272, !llvm.loop !1396
...
.lr.ph278:                                        ; preds = %.lr.ph278.preheader, %.lr.ph278
  ...
  %i.hd = trunc <16 x i32> %i.hc to <16 x i16>
  store <16 x i16> %i.hd, ptr %.7277, align 1, !tbaa !90
  ...
  br i1 %niter868.ncmp.3, label %.loopexit250.loopexit.unr-lcssa, label %.lr.ph278, !llvm.loop !1397
...
.lr.ph278.epil:                                   ; preds = %.lr.ph278.epil, %.lr.ph278.epil.preheader
  ...
  %i.ht = trunc <16 x i32> %i.hs to <16 x i16>
  store <16 x i16> %i.ht, ptr %.7277.epil, align 1, !tbaa !90
  ...
  br i1 %epil.iter863.cmp.not, label %.loopexit250, label %.lr.ph278.epil, !llvm.loop !1398
...
.lr.ph263.epil:                                   ; preds = %.lr.ph263.epil, %.lr.ph263.epil.preheader
  ...
  %i.hw = load <2 x i64>, ptr %.2223259.epil, align 1, !tbaa !90
  store <2 x i64> %i.hw, ptr %.3211262.epil, align 1, !tbaa !90
  %i.hx = getelementptr inbounds nuw i8, ptr %.3211262.epil, i64 16
  %i.hy = load <2 x i64>, ptr %.0219260.epil, align 1, !tbaa !90
  store <2 x i64> %i.hy, ptr %i.hx, align 1, !tbaa !90
  ...
  br i1 %epil.iter856.cmp.not, label %.loopexit250, label %.lr.ph263.epil, !llvm.loop !1399
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %epil.iter = phi i32 [ %epil.iter.next, %.lr.ph.epil ], [ 0, %.lr.ph.epil.preheader ]
  %i.ic = load <4 x i64>, ptr %.0221255.epil, align 1, !tbaa !90
  store <4 x i64> %i.ic, ptr %.1209257.epil, align 1, !tbaa !90
  ...
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %.loopexit250, label %.lr.ph.epil, !llvm.loop !1400
...
.loopexit250:                                     ; preds = %.loopexit250.loopexit846.unr-lcssa, %.lr.ph.epil, %.lr.ph272.prol.loopexit, %.lr.ph272, %.loopexit250.loopexit843.unr-lcssa.a, %.lr.ph263.epil, %.loopexit250.loopexit.unr-lcssa, %.lr.ph278.epil, %middle.block, %bb.h, %bb.i, %.loopexit251
  ...
  %i.ig = icmp samesign ult i64 %i.if, %i.y
  %indvar.next = add i64 %indvar, 1
  br i1 %i.ig, label %bb.g, label %.preheader249.loopexit, !llvm.loop !1401
...
.lr.ph324.split.us:                               ; preds = %.lr.ph324.split.us.preheader, %.loopexit241.us
  ...
  %i.jx = load ptr, ptr %0, align 8, !tbaa !25    ; 2 uses
...
vector.body683:                                   ; preds = %vector.body683, %vector.ph681
  ...
  %wide.load687.a = load <8 x i64>, ptr %next.gep685, align 1, !tbaa !90
  %wide.load688.a = load <8 x i64>, ptr %i.ki, align 1, !tbaa !90
  %wide.load689 = load <8 x i64>, ptr %i.kj, align 1, !tbaa !90
  %wide.load690 = load <8 x i64>, ptr %i.kk, align 1, !tbaa !90
  ...
  store <8 x i64> %wide.load687.a, ptr %next.gep686, align 1, !tbaa !90
  store <8 x i64> %wide.load688.a, ptr %i.kl, align 1, !tbaa !90
  store <8 x i64> %wide.load689, ptr %i.km, align 1, !tbaa !90
  store <8 x i64> %wide.load690, ptr %i.kn, align 1, !tbaa !90
  %index.next691 = add nuw i64 %index684, 32      ; 2 uses
  %i.ko = icmp eq i64 %index.next691, %n.vec682
  br i1 %i.ko, label %middle.block692, label %vector.body683, !llvm.loop !1402
...
vec.epilog.iter.check700:                         ; preds = %middle.block692
  br i1 %min.epilog.iters.check701, label %.lr.ph311.us.preheader, label %vec.epilog.ph702, !prof !104
...
vec.epilog.vector.body704:                        ; preds = %vec.epilog.vector.body704, %vec.epilog.ph702
  ...
  %wide.load708 = load <8 x i64>, ptr %next.gep706, align 1, !tbaa !90
  store <8 x i64> %wide.load708, ptr %next.gep707, align 1, !tbaa !90
  %index.next709 = add nuw i64 %index705, 8       ; 2 uses
  %i.ks = icmp eq i64 %index.next709, %n.vec703
  br i1 %i.ks, label %vec.epilog.middle.block710, label %vec.epilog.vector.body704, !llvm.loop !1403
...
.lr.ph311.us.prol:                                ; preds = %.lr.ph311.us.preheader, %.lr.ph311.us.prol
  ...
  %i.ku = load i64, ptr %.0200309.us.prol, align 1, !tbaa !90
  store i64 %i.ku, ptr %.17308.us.prol, align 1, !tbaa !90
  ...
  br i1 %prol.iter890.cmp.not, label %.lr.ph311.us.prol.loopexit, label %.lr.ph311.us.prol, !llvm.loop !1404
...
.lr.ph311.us:                                     ; preds = %.lr.ph311.us.prol.loopexit, %.lr.ph311.us
  ...
  %i.la = load i64, ptr %.0200309.us, align 1, !tbaa !90
  store i64 %i.la, ptr %.17308.us, align 1, !tbaa !90
  ...
  %i.lj = load i64, ptr %i.li, align 1, !tbaa !90
  store i64 %i.lj, ptr %i.lh, align 1, !tbaa !90
...
vector.body623:                                   ; preds = %vector.body623, %vector.ph621
  ...
  %wide.load630.a = load <32 x i16>, ptr %next.gep628, align 2, !tbaa !110, !alias.scope !1452
  %wide.load631.a = load <32 x i16>, ptr %next.gep627.a, align 2, !tbaa !110, !alias.scope !1453
  %wide.load632 = load <32 x i16>, ptr %next.gep626.a, align 2, !tbaa !110, !alias.scope !1454
  %wide.load633 = load <32 x i16>, ptr %next.gep625.a, align 2, !tbaa !110, !alias.scope !1455
  ...
  store <128 x i16> %interleaved.vec634, ptr %next.gep629, align 2, !tbaa !110, !alias.scope !1456, !noalias !1457
  %index.next635 = add nuw i64 %index624, 32      ; 2 uses
  %i.ms = icmp eq i64 %index.next635, %n.vec622
  br i1 %i.ms, label %middle.block636, label %vector.body623, !llvm.loop !1412
...
vec.epilog.iter.check647:                         ; preds = %middle.block636
  br i1 %min.epilog.iters.check648, label %.lr.ph320.us.preheader, label %vec.epilog.ph649, !prof !104
...
vec.epilog.vector.body651:                        ; preds = %vec.epilog.vector.body651, %vec.epilog.ph649
  ...
  %wide.load658.a = load <8 x i16>, ptr %next.gep656, align 2, !tbaa !110, !alias.scope !1452
  %wide.load659.a = load <8 x i16>, ptr %next.gep655.a, align 2, !tbaa !110, !alias.scope !1453
  %wide.load660 = load <8 x i16>, ptr %next.gep654.a, align 2, !tbaa !110, !alias.scope !1454
  %wide.load661 = load <8 x i16>, ptr %next.gep653.a, align 2, !tbaa !110, !alias.scope !1455
  ...
  store <32 x i16> %interleaved.vec662, ptr %next.gep657, align 2, !tbaa !110, !alias.scope !1456, !noalias !1457
  %index.next663 = add nuw i64 %index652, 8       ; 2 uses
  %i.nc = icmp eq i64 %index.next663, %n.vec650
  br i1 %i.nc, label %vec.epilog.middle.block664, label %vec.epilog.vector.body651, !llvm.loop !1413
...
.lr.ph320.us.prol:                                ; preds = %.lr.ph320.us.preheader
  %i.ne = load i16, ptr %.2315.us.ph, align 2, !tbaa !110
  store i16 %i.ne, ptr %.19314.us.ph, align 2, !tbaa !110
  %i.nf = load i16, ptr %.0198316.us.ph, align 2, !tbaa !110
  %i.ng = getelementptr inbounds nuw i8, ptr %.19314.us.ph, i64 2
  store i16 %i.nf, ptr %i.ng, align 2, !tbaa !110
  %i.nh = load i16, ptr %.0197317.us.ph, align 2, !tbaa !110
  %i.ni = getelementptr inbounds nuw i8, ptr %.19314.us.ph, i64 4
  store i16 %i.nh, ptr %i.ni, align 2, !tbaa !110
  %i.nj = load i16, ptr %.0196318.us.ph, align 2, !tbaa !110
  %i.nk = getelementptr inbounds nuw i8, ptr %.19314.us.ph, i64 6
  store i16 %i.nj, ptr %i.nk, align 2, !tbaa !110
...
.lr.ph320.us:                                     ; preds = %.lr.ph320.us.prol.loopexit, %.lr.ph320.us
  ...
  %i.ns = load i16, ptr %.2315.us, align 2, !tbaa !110
  store i16 %i.ns, ptr %.19314.us, align 2, !tbaa !110
  %i.nt = load i16, ptr %.0198316.us, align 2, !tbaa !110
  %i.nu = getelementptr inbounds nuw i8, ptr %.19314.us, i64 2
  store i16 %i.nt, ptr %i.nu, align 2, !tbaa !110
  %i.nv = load i16, ptr %.0197317.us, align 2, !tbaa !110
  %i.nw = getelementptr inbounds nuw i8, ptr %.19314.us, i64 4
  store i16 %i.nv, ptr %i.nw, align 2, !tbaa !110
  %i.nx = load i16, ptr %.0196318.us, align 2, !tbaa !110
  %i.ny = getelementptr inbounds nuw i8, ptr %.19314.us, i64 6
  store i16 %i.nx, ptr %i.ny, align 2, !tbaa !110
  ...
  %i.oe = load i16, ptr %i.oa, align 2, !tbaa !110
  store i16 %i.oe, ptr %i.nz, align 2, !tbaa !110
  %i.of = load i16, ptr %i.ob, align 2, !tbaa !110
  %i.og = getelementptr inbounds nuw i8, ptr %.19314.us, i64 10
  store i16 %i.of, ptr %i.og, align 2, !tbaa !110
  %i.oh = load i16, ptr %i.oc, align 2, !tbaa !110
  %i.oi = getelementptr inbounds nuw i8, ptr %.19314.us, i64 12
  store i16 %i.oh, ptr %i.oi, align 2, !tbaa !110
  %i.oj = load i16, ptr %i.od, align 2, !tbaa !110
  %i.ok = getelementptr inbounds nuw i8, ptr %.19314.us, i64 14
  store i16 %i.oj, ptr %i.ok, align 2, !tbaa !110
  ...
  br i1 %exitcond427.not.1, label %.loopexit241.us, label %.lr.ph320.us, !llvm.loop !1414
...
.loopexit241.us:                                  ; preds = %.lr.ph320.us.prol.loopexit, %.lr.ph320.us, %middle.block636, %vec.epilog.middle.block664, %.loopexit243.us
  ...
  br i1 %i.or, label %.lr.ph324.split.us, label %.preheader240.loopexit, !llvm.loop !1415
...
vector.body572:                                   ; preds = %vector.body572, %vector.ph570
  ...
  %wide.load576.a = load <8 x i64>, ptr %next.gep574, align 1, !tbaa !90
  %wide.load577.a = load <8 x i64>, ptr %i.qe, align 1, !tbaa !90
  %wide.load578 = load <8 x i64>, ptr %i.qf, align 1, !tbaa !90
  %wide.load579 = load <8 x i64>, ptr %i.qg, align 1, !tbaa !90
  ...
  store <8 x i64> %wide.load576.a, ptr %next.gep575, align 1, !tbaa !90
  store <8 x i64> %wide.load577.a, ptr %i.qh, align 1, !tbaa !90
  store <8 x i64> %wide.load578, ptr %i.qi, align 1, !tbaa !90
  store <8 x i64> %wide.load579, ptr %i.qj, align 1, !tbaa !90
  %index.next580 = add nuw i64 %index573, 32      ; 2 uses
  %i.qk = icmp eq i64 %index.next580, %n.vec571
  br i1 %i.qk, label %middle.block581, label %vector.body572, !llvm.loop !1416
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load590 = load <8 x i64>, ptr %next.gep588, align 1, !tbaa !90
  store <8 x i64> %wide.load590, ptr %next.gep589, align 1, !tbaa !90
  %index.next591 = add nuw i64 %index587, 8       ; 2 uses
  %i.qo = icmp eq i64 %index.next591, %n.vec586
  br i1 %i.qo, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !1417
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  %i.qq = load i64, ptr %.0200309.us331.us.prol, align 1, !tbaa !90
  store i64 %i.qq, ptr %.17308.us332.us.prol, align 1, !tbaa !90
  ...
  br i1 %prol.iter887.cmp.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol, !llvm.loop !1418
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  %i.qw = load i64, ptr %.0200309.us331.us, align 1, !tbaa !90
  store i64 %i.qw, ptr %.17308.us332.us, align 1, !tbaa !90
  ...
  br i1 %exitcond421.not.7, label %..loopexit243_crit_edge.us338.us, label %vec.epilog.scalar.ph, !llvm.loop !1419
...
..loopexit243_crit_edge.us338.us:                 ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block581
  ...
  br i1 %i.rv, label %iter.check, label %.preheader240.loopexit385, !llvm.loop !1415
...
bb.j:                                             ; preds = %.lr.ph305, %.loopexit245
  ...
  %i.rx = load ptr, ptr %0, align 8, !tbaa !25    ; 4 uses
...
vector.body548:                                   ; preds = %vector.body548, %vector.ph546
  ...
  %wide.load553 = load <8 x i64>, ptr %next.gep551, align 1, !tbaa !90, !alias.scope !1458
  %wide.load554 = load <8 x i64>, ptr %next.gep550.a, align 1, !tbaa !90, !alias.scope !1459
  ...
  store <16 x i64> %interleaved.vec555, ptr %next.gep552, align 1, !tbaa !90, !alias.scope !1460, !noalias !1461
  %index.next556 = add nuw i64 %index549, 8       ; 2 uses
  %i.tr = icmp eq i64 %index.next556, %n.vec547
  br i1 %i.tr, label %middle.block557, label %vector.body548, !llvm.loop !1425
...
.lr.ph295.prol:                                   ; preds = %.lr.ph295.preheader837, %.lr.ph295.prol
  ...
  %i.tt = load i64, ptr %.2207292.prol, align 1, !tbaa !90
  store i64 %i.tt, ptr %.12291.prol, align 1, !tbaa !90
  %i.tu = getelementptr inbounds nuw i8, ptr %.12291.prol, i64 8
  %i.tv = load i64, ptr %.0203293.prol, align 1, !tbaa !90
  store i64 %i.tv, ptr %i.tu, align 1, !tbaa !90
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph295.prol.loopexit, label %.lr.ph295.prol, !llvm.loop !1426
...
.lr.ph295:                                        ; preds = %.lr.ph295.prol.loopexit, %.lr.ph295
  ...
  %i.uc = load i64, ptr %.2207292, align 1, !tbaa !90
  store i64 %i.uc, ptr %.12291, align 1, !tbaa !90
  %i.ud = getelementptr inbounds nuw i8, ptr %.12291, i64 8
  %i.ue = load i64, ptr %.0203293, align 1, !tbaa !90
  store i64 %i.ue, ptr %i.ud, align 1, !tbaa !90
  ...
  %i.ui = load i64, ptr %i.ug, align 1, !tbaa !90
  store i64 %i.ui, ptr %i.uf, align 1, !tbaa !90
  %i.uj = getelementptr inbounds nuw i8, ptr %.12291, i64 24
  %i.uk = load i64, ptr %i.uh, align 1, !tbaa !90
  store i64 %i.uk, ptr %i.uj, align 1, !tbaa !90
  ...
  %i.uo = load i64, ptr %i.um, align 1, !tbaa !90
  store i64 %i.uo, ptr %i.ul, align 1, !tbaa !90
  %i.up = getelementptr inbounds nuw i8, ptr %.12291, i64 40
  %i.uq = load i64, ptr %i.un, align 1, !tbaa !90
  store i64 %i.uq, ptr %i.up, align 1, !tbaa !90
  ...
  %i.uu = load i64, ptr %i.us, align 1, !tbaa !90
  store i64 %i.uu, ptr %i.ur, align 1, !tbaa !90
  %i.uv = getelementptr inbounds nuw i8, ptr %.12291, i64 56
  %i.uw = load i64, ptr %i.ut, align 1, !tbaa !90
  store i64 %i.uw, ptr %i.uv, align 1, !tbaa !90
  ...
  br i1 %exitcond416.not.3, label %.loopexit245, label %.lr.ph295, !llvm.loop !1427
...
.lr.ph301:                                        ; preds = %.lr.ph301.preheader, %.lr.ph301
  ...
  store <8 x i16> %i.vc, ptr %.14298, align 1, !tbaa !90
  ...
  store <8 x i16> %i.vg, ptr %i.vd, align 1, !tbaa !90
  ...
  store <8 x i16> %i.vk, ptr %i.vh, align 1, !tbaa !90
  ...
  store <8 x i16> %i.vo, ptr %i.vl, align 1, !tbaa !90
  ...
  br i1 %niter882.ncmp.3, label %.loopexit245.loopexit838.unr-lcssa, label %.lr.ph301, !llvm.loop !1428
...
.lr.ph301.epil:                                   ; preds = %.lr.ph301.epil, %.lr.ph301.epil.preheader
  ...
  store <8 x i16> %i.vs, ptr %.14298.epil, align 1, !tbaa !90
  ...
  br i1 %epil.iter877.cmp.not, label %.loopexit245, label %.lr.ph301.epil, !llvm.loop !1429
...
.lr.ph288.epil:                                   ; preds = %.lr.ph288.epil, %.lr.ph288.epil.preheader
  ...
  %i.vv = load <2 x i64>, ptr %.0205286.epil, align 1, !tbaa !90
  store <2 x i64> %i.vv, ptr %.10285.epil, align 1, !tbaa !90
  ...
  br i1 %epil.iter870.cmp.not, label %.loopexit245, label %.lr.ph288.epil, !llvm.loop !1430
...
.loopexit245:                                     ; preds = %.loopexit245.loopexit839.unr-lcssa, %.lr.ph288.epil, %.loopexit245.loopexit838.unr-lcssa, %.lr.ph301.epil, %.lr.ph295.prol.loopexit, %.lr.ph295, %middle.block557, %bb.k, %.loopexit246
  ...
  br i1 %i.vy, label %bb.j, label %.preheader244.loopexit, !llvm.loop !1431
...
.lr.ph354:                                        ; preds = %.preheader240
  %i.wd = load ptr, ptr %0, align 8, !tbaa !25    ; 5 uses
...
vector.body736:                                   ; preds = %vector.body736, %vector.ph734
  ...
  %wide.load741 = load <32 x i16>, ptr %next.gep739, align 2, !tbaa !110, !alias.scope !1462
  %wide.load742 = load <32 x i16>, ptr %next.gep738, align 2, !tbaa !110, !alias.scope !1463
  %interleaved.vec743 = shufflevector <32 x i16> %wide.load741, <32 x i16> %wide.load742, <64 x i32> <i32 0, i32 32, i32 1, i32 33, i32 2, i32 34, i32 3, i32 35, i32 4, i32 36, i32 5, i32 37, i32 6, i32 38, i32 7, i32 39, i32 8, i32 40, i32 9, i32 41, i32 10, i32 42, i32 11, i32 43, i32 12, i32 44, i32 13, i32 45, i32 14, i32 46, i32 15, i32 47, i32 16, i32 48, i32 17, i32 49, i32 18, i32 50, i32 19, i32 51, i32 20, i32 52, i32 21, i32 53, i32 22, i32 54, i32 23, i32 55, i32 24, i32 56, i32 25, i32 57, i32 26, i32 58, i32 27, i32 59, i32 28, i32 60, i32 29, i32 61, i32 30, i32 62, i32 31, i32 63>
  store <64 x i16> %interleaved.vec743, ptr %next.gep740, align 2, !tbaa !110, !alias.scope !1464, !noalias !1465
  %index.next744 = add nuw i64 %index737, 32      ; 2 uses
  %i.yj = icmp eq i64 %index.next744, %n.vec735
  br i1 %i.yj, label %middle.block745, label %vector.body736, !llvm.loop !1436
...
vec.epilog.iter.check754:                         ; preds = %middle.block745
  br i1 %min.epilog.iters.check755, label %vec.epilog.scalar.ph753.preheader, label %vec.epilog.ph756, !prof !104
...
vec.epilog.vector.body758:                        ; preds = %vec.epilog.vector.body758, %vec.epilog.ph756
  ...
  %wide.load763 = load <8 x i16>, ptr %next.gep761, align 2, !tbaa !110, !alias.scope !1462
  %wide.load764 = load <8 x i16>, ptr %next.gep760, align 2, !tbaa !110, !alias.scope !1463
  ...
  store <16 x i16> %interleaved.vec765, ptr %next.gep762, align 2, !tbaa !110, !alias.scope !1464, !noalias !1465
  %index.next766 = add nuw i64 %index759, 8       ; 2 uses
  %i.yp = icmp eq i64 %index.next766, %n.vec757
  br i1 %i.yp, label %vec.epilog.middle.block767, label %vec.epilog.vector.body758, !llvm.loop !1437
...
vec.epilog.scalar.ph753.prol:                     ; preds = %vec.epilog.scalar.ph753.preheader, %vec.epilog.scalar.ph753.prol
  ...
  %i.yr = load i16, ptr %.0194347.us.prol, align 2, !tbaa !110
  store i16 %i.yr, ptr %.22346.us.prol, align 2, !tbaa !110
  %i.ys = load i16, ptr %.0193348.us.prol, align 2, !tbaa !110
  %i.yt = getelementptr inbounds nuw i8, ptr %.22346.us.prol, i64 2
  store i16 %i.ys, ptr %i.yt, align 2, !tbaa !110
  ...
  br i1 %prol.iter896.cmp.not.a, label %vec.epilog.scalar.ph753.prol.loopexit, label %vec.epilog.scalar.ph753.prol, !llvm.loop !1438
...
vec.epilog.scalar.ph753:                          ; preds = %vec.epilog.scalar.ph753.prol.loopexit, %vec.epilog.scalar.ph753
  ...
  %i.za = load i16, ptr %.0194347.us, align 2, !tbaa !110
  store i16 %i.za, ptr %.22346.us, align 2, !tbaa !110
  %i.zb = load i16, ptr %.0193348.us, align 2, !tbaa !110
  %i.zc = getelementptr inbounds nuw i8, ptr %.22346.us, i64 2
  store i16 %i.zb, ptr %i.zc, align 2, !tbaa !110
  ...
  %i.zg = load i16, ptr %i.ze, align 2, !tbaa !110
  store i16 %i.zg, ptr %i.zd, align 2, !tbaa !110
  %i.zh = load i16, ptr %i.zf, align 2, !tbaa !110
  %i.zi = getelementptr inbounds nuw i8, ptr %.22346.us, i64 6
  store i16 %i.zh, ptr %i.zi, align 2, !tbaa !110
