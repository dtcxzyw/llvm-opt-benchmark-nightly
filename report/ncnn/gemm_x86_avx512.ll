...
.lr.ph2786:                                       ; preds = %.lr.ph2786.preheader, %.lr.ph2786
  ...
  br i1 %niter5249.ncmp.1.not, label %.preheader2159.loopexit.unr-lcssa, label %.lr.ph2786, !llvm.loop !857
...
.lr.ph2814:                                       ; preds = %.lr.ph2814.preheader, %.lr.ph2814
  ...
  br i1 %niter5265.ncmp.1.not, label %.preheader2152.loopexit.unr-lcssa, label %.lr.ph2814, !llvm.loop !861
...
vector.body4724:                                  ; preds = %vector.body4724, %vector.ph4722
  ...
  br i1 %i.dbg, label %middle.block4775, label %vector.body4724, !llvm.loop !895
...
vec.epilog.vector.body4794:                       ; preds = %vec.epilog.vector.body4794, %vec.epilog.ph4792
  ...
  br i1 %i.dcc, label %vec.epilog.middle.block4809, label %vec.epilog.vector.body4794, !llvm.loop !896
...
vector.body4633:                                  ; preds = %vector.body4633, %vector.ph4631
  ...
  br i1 %i.ddx, label %middle.block4660, label %vector.body4633, !llvm.loop !897
...
vec.epilog.vector.body4679:                       ; preds = %vec.epilog.vector.body4679, %vec.epilog.ph4677
  ...
  br i1 %i.dfz, label %vec.epilog.middle.block4706, label %vec.epilog.vector.body4679, !llvm.loop !898
