...
.loopexit:                                        ; preds = %.loopexit.loopexit483.unr-lcssa, %.lr.ph318.epil, %.loopexit.loopexit482.unr-lcssa, %.lr.ph313.epil, %.loopexit.loopexit481.unr-lcssa, %.lr.ph308.epil, %.loopexit.loopexit.unr-lcssa, %.lr.ph303.epil, %bb.v, %.split446, %bb.w, %bb.x, %bb.y, %bb.z
  ...
  %indvars.iv.next361 = add nsw i64 %indvars.iv360, 1 ; 2 uses
...
._crit_edge2303:                                  ; preds = %bb.ky, %.preheader
  ...
  %indvars.iv.next2589 = add nsw i64 %indvars.iv2588, 1 ; 2 uses
...
._crit_edge297.i:                                 ; preds = %bb.m, %._crit_edge297.i.unr-lcssa
  ...
  %indvars.iv.next345.i = add nsw i64 %indvars.iv344.i, 1 ; 2 uses
...
._crit_edge270.i:                                 ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block
  ...
  %indvars.iv.next311.i = add nsw i64 %indvars.iv310.i, 1 ; 2 uses
...
._crit_edge765.i:                                 ; preds = %.lr.ph764.i.prol.loopexit, %.lr.ph764.i, %middle.block243, %vec.epilog.middle.block262, %.preheader.i
  ...
  %indvars.iv.next847.i = add nsw i64 %indvars.iv846.i, 1 ; 2 uses
...
.loopexit.i:                                      ; preds = %.lr.ph1249.i.epil.preheader, %.loopexit.i.loopexit220.unr-lcssa, %.lr.ph1255.i.epil.preheader, %.loopexit.i.loopexit219.unr-lcssa, %.lr.ph1261.i, %.lr.ph1274.i.prol.loopexit, %.lr.ph1274.i, %.preheader.i, %.loopexit1068.i
  ...
  %indvars.iv.next1394.i = add nsw i64 %indvars.iv1393.i, 1 ; 2 uses
...
.loopexit.i:                                      ; preds = %.lr.ph1458.i.prol.loopexit, %.lr.ph1458.i, %.lr.ph1445.i, %.lr.ph1439.i.epil.preheader, %.loopexit.i.loopexit211.unr-lcssa, %.lr.ph1433.i.epil.preheader, %.loopexit.i.loopexit.unr-lcssa, %.preheader.i, %bb.x, %bb.w, %bb.v, %.split1641.i
  ...
  %indvars.iv.next1542.i = add nsw i64 %indvars.iv1541.i, 1 ; 2 uses
...
.loopexit:                                        ; preds = %.lr.ph844, %.lr.ph850, %.lr.ph856, %.loopexit.loopexit.unr-lcssa, %.lr.ph862.epil, %.loopexit689
  ...
  %indvars.iv.next979 = add nsw i64 %indvars.iv978, 1 ; 2 uses
...
.lr.ph312:                                        ; preds = %bb.f
  ...
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  %lcmp.mod919 = icmp ne i32 %xtraiter, 0
  ...
  %xtraiter922 = and i32 %5, 3                    ; 3 uses
  %i.av = icmp ult i32 %i.ap, 3
  %unroll_iter927 = and i32 %5, 2147483644
  %lcmp.mod924.not = icmp eq i32 %xtraiter922, 0
  %lcmp.mod926 = icmp ne i32 %xtraiter922, 0
  %xtraiter929 = and i32 %5, 3                    ; 3 uses
  %i.aw = icmp ult i32 %i.ap, 3
  %unroll_iter934 = and i32 %5, 2147483644
  %lcmp.mod931.not = icmp eq i32 %xtraiter929, 0
  %lcmp.mod933 = icmp ne i32 %xtraiter929, 0
  br label %bb.g
...
.lr.ph335:                                        ; preds = %.preheader279
  ...
  %xtraiter936 = and i32 %5, 7                    ; 3 uses
  %i.cb = icmp ult i32 %i.ca, 7
  %unroll_iter941 = and i32 %5, 2147483640
  %lcmp.mod938.not = icmp eq i32 %xtraiter936, 0
  %lcmp.mod940 = icmp ne i32 %xtraiter936, 0
  %xtraiter943 = and i32 %5, 3                    ; 3 uses
  %i.cc = icmp ult i32 %i.ca, 3
  %unroll_iter948 = and i32 %5, 2147483644
  %lcmp.mod945.not = icmp eq i32 %xtraiter943, 0
  %lcmp.mod947 = icmp ne i32 %xtraiter943, 0
  %i.cd = zext nneg i32 %5 to i64                 ; 2 uses
  %min.iters.check602 = icmp ult i32 %5, 8
  %n.vec604 = and i64 %i.cd, 2147483640           ; 5 uses
  %i.ce = shl nuw nsw i64 %n.vec604, 4
  %i.cf = trunc nuw nsw i64 %n.vec604 to i32
  %i.cg = shl nuw nsw i64 %n.vec604, 3            ; 2 uses
  %cmp.n615 = icmp eq i64 %n.vec604, %i.cd
  br label %bb.j
...
begin_hunk_15_@_ZN4ncnnL16pack_A_tile_bf16ERKNS_3MatERS0_iiii:bb.a
  br i1 %exitcond481.not.3, label %._crit_edge.us, label %vec.epilog.scalar.ph815, !llvm.loop !1373

._crit_edge.us:                                   ; preds = %vec.epilog.scalar.ph815.prol.loopexit, %vec.epilog.scalar.ph815, %vec.epilog.middle.block829, %middle.block807
  %.lcssa543 = phi ptr [ %i.zn, %vec.epilog.middle.block829 ], [ %i.zh, %middle.block807 ], [ %.lcssa894.unr, %vec.epilog.scalar.ph815.prol.loopexit ], [ %i.aaw, %vec.epilog.scalar.ph815 ] ; 2 uses
  %indvars.iv.next483 = add nuw nsw i64 %indvars.iv482, 2 ; 3 uses
  %i.aba = icmp slt i64 %indvars.iv.next483, %invariant.op537
  br i1 %i.aba, label %iter.check814, label %.preheader.loopexit, !llvm.loop !1374
...
.preheader:                                       ; preds = %.lr.ph397.split.preheader, %.preheader.loopexit, %.preheader269
  ...
  %.22.lcssa = phi ptr [ %.16.lcssa, %.preheader269 ], [ %.lcssa543, %.preheader.loopexit ], [ %.16.lcssa, %.lr.ph397.split.preheader ]
...
.lr.ph405.preheader:                              ; preds = %.lr.ph409
  ...
  %.neg = mul i64 %i.abl, -2
  %.neg884 = sub i64 %.neg, %i.abg
  %i.abm = mul i64 %i.l, -2
  %i.abn = zext nneg i32 %5 to i64                ; 5 uses
  %min.iters.check841 = icmp ult i32 %5, 16
  %min.iters.check843 = icmp ult i32 %5, 128
  %i.abo = and i64 %i.abn, 112
  %n.vec845 = and i64 %i.abn, 2147483520          ; 5 uses
  %i.abp = trunc nuw nsw i64 %n.vec845 to i32
  %i.abq = shl nuw nsw i64 %n.vec845, 1           ; 2 uses
  %cmp.n856 = icmp eq i64 %n.vec845, %i.abn
  %min.epilog.iters.check864 = icmp eq i64 %i.abo, 0
  %n.vec866 = and i64 %i.abn, 2147483632          ; 4 uses
  %i.abr = trunc nuw nsw i64 %n.vec866 to i32
  %i.abs = shl nuw nsw i64 %n.vec866, 1           ; 2 uses
  %cmp.n874 = icmp eq i64 %n.vec866, %i.abn
  br label %iter.check861

iter.check861:                                    ; preds = %.lr.ph405.preheader, %._crit_edge
  %indvar837 = phi i64 [ 0, %.lr.ph405.preheader ], [ %indvar.next838, %._crit_edge ] ; 2 uses
  %indvars.iv487 = phi i64 [ %i.abh, %.lr.ph405.preheader ], [ %indvars.iv.next488, %._crit_edge ] ; 2 uses
  %.24408 = phi ptr [ %.22.lcssa, %.lr.ph405.preheader ], [ %.lcssa, %._crit_edge ] ; 7 uses
  %i.abt = add nsw i64 %indvars.iv487, %i.abi
  %i.abu = mul i64 %i.l, %i.abt
  %gep = getelementptr [2 x i8], ptr %invariant.gep410, i64 %i.abu ; 6 uses
  br i1 %min.iters.check841, label %vec.epilog.scalar.ph862.preheader, label %vector.memcheck835

vector.memcheck835:                               ; preds = %iter.check861
  %i.abv = mul i64 %i.abm, %indvar837
  %i.abw = add i64 %.neg884, %i.abv
  %.24408836 = ptrtoaddr ptr %.24408 to i64
  %i.abx = add i64 %i.abw, %.24408836
  %i.aby = add i64 %i.abx, -1
  %diff.check839 = icmp ult i64 %i.aby, 255
  br i1 %diff.check839, label %vec.epilog.scalar.ph862.preheader, label %vector.main.loop.iter.check842

vector.main.loop.iter.check842:                   ; preds = %vector.memcheck835
  br i1 %min.iters.check843, label %vec.epilog.ph865, label %vector.ph844
...
vector.body846:                                   ; preds = %vector.body846, %vector.ph844
  %index847 = phi i64 [ 0, %vector.ph844 ], [ %index.next854, %vector.body846 ] ; 2 uses
  %i.acb = shl i64 %index847, 1                   ; 2 uses
  %next.gep848 = getelementptr i8, ptr %gep, i64 %i.acb ; 4 uses
  %next.gep849 = getelementptr i8, ptr %.24408, i64 %i.acb ; 4 uses
  %i.acc = getelementptr i8, ptr %next.gep848, i64 64
  %i.acd = getelementptr i8, ptr %next.gep848, i64 128
  %i.ace = getelementptr i8, ptr %next.gep848, i64 192
  %wide.load850 = load <32 x i16>, ptr %next.gep848, align 2, !tbaa !821
  %wide.load851 = load <32 x i16>, ptr %i.acc, align 2, !tbaa !821
  %wide.load852 = load <32 x i16>, ptr %i.acd, align 2, !tbaa !821
  %wide.load853 = load <32 x i16>, ptr %i.ace, align 2, !tbaa !821
  %i.acf = getelementptr i8, ptr %next.gep849, i64 64
  %i.acg = getelementptr i8, ptr %next.gep849, i64 128
  %i.ach = getelementptr i8, ptr %next.gep849, i64 192
  store <32 x i16> %wide.load850, ptr %next.gep849, align 2, !tbaa !821
  store <32 x i16> %wide.load851, ptr %i.acf, align 2, !tbaa !821
  store <32 x i16> %wide.load852, ptr %i.acg, align 2, !tbaa !821
  store <32 x i16> %wide.load853, ptr %i.ach, align 2, !tbaa !821
  %index.next854 = add nuw i64 %index847, 128     ; 2 uses
  %i.aci = icmp eq i64 %index.next854, %n.vec845
  br i1 %i.aci, label %middle.block855, label %vector.body846, !llvm.loop !1375

middle.block855:                                  ; preds = %vector.body846
  br i1 %cmp.n856, label %._crit_edge, label %vec.epilog.iter.check863

vec.epilog.iter.check863:                         ; preds = %middle.block855
  br i1 %min.epilog.iters.check864, label %vec.epilog.scalar.ph862.preheader, label %vec.epilog.ph865, !prof !1376

vec.epilog.ph865:                                 ; preds = %vector.main.loop.iter.check842, %vec.epilog.iter.check863
  %vec.epilog.resume.val857 = phi i64 [ %n.vec845, %vec.epilog.iter.check863 ], [ 0, %vector.main.loop.iter.check842 ]
...
vec.epilog.vector.body867:                        ; preds = %vec.epilog.vector.body867, %vec.epilog.ph865
  %index868 = phi i64 [ %vec.epilog.resume.val857, %vec.epilog.ph865 ], [ %index.next872, %vec.epilog.vector.body867 ] ; 2 uses
  %i.acl = shl i64 %index868, 1                   ; 2 uses
  %next.gep869 = getelementptr i8, ptr %gep, i64 %i.acl
  %next.gep870 = getelementptr i8, ptr %.24408, i64 %i.acl
  %wide.load871 = load <16 x i16>, ptr %next.gep869, align 2, !tbaa !821
  store <16 x i16> %wide.load871, ptr %next.gep870, align 2, !tbaa !821
  %index.next872 = add nuw i64 %index868, 16      ; 2 uses
  %i.acm = icmp eq i64 %index.next872, %n.vec866
  br i1 %i.acm, label %vec.epilog.middle.block873, label %vec.epilog.vector.body867, !llvm.loop !1377

vec.epilog.middle.block873:                       ; preds = %vec.epilog.vector.body867
  br i1 %cmp.n874, label %._crit_edge, label %vec.epilog.scalar.ph862.preheader

vec.epilog.scalar.ph862.preheader:                ; preds = %vector.memcheck835, %iter.check861, %vec.epilog.iter.check863, %vec.epilog.middle.block873
  %.0404.ph = phi i32 [ 0, %iter.check861 ], [ 0, %vector.memcheck835 ], [ %i.abp, %vec.epilog.iter.check863 ], [ %i.abr, %vec.epilog.middle.block873 ] ; 4 uses
  %.0215403.ph = phi ptr [ %gep, %iter.check861 ], [ %gep, %vector.memcheck835 ], [ %i.abz, %vec.epilog.iter.check863 ], [ %i.acj, %vec.epilog.middle.block873 ] ; 2 uses
  %.25402.ph = phi ptr [ %.24408, %iter.check861 ], [ %.24408, %vector.memcheck835 ], [ %i.aca, %vec.epilog.iter.check863 ], [ %i.ack, %vec.epilog.middle.block873 ] ; 2 uses
  %i.acn = sub i32 %5, %.0404.ph
  %xtraiter964 = and i32 %i.acn, 7                ; 2 uses
  %lcmp.mod965.not = icmp eq i32 %xtraiter964, 0
  br i1 %lcmp.mod965.not, label %vec.epilog.scalar.ph862.prol.loopexit, label %vec.epilog.scalar.ph862.prol

vec.epilog.scalar.ph862.prol:                     ; preds = %vec.epilog.scalar.ph862.preheader, %vec.epilog.scalar.ph862.prol
  %.0404.prol = phi i32 [ %i.acr, %vec.epilog.scalar.ph862.prol ], [ %.0404.ph, %vec.epilog.scalar.ph862.preheader ]
  %.0215403.prol = phi ptr [ %i.acq, %vec.epilog.scalar.ph862.prol ], [ %.0215403.ph, %vec.epilog.scalar.ph862.preheader ] ; 2 uses
  %.25402.prol = phi ptr [ %i.acp, %vec.epilog.scalar.ph862.prol ], [ %.25402.ph, %vec.epilog.scalar.ph862.preheader ] ; 2 uses
  %prol.iter966 = phi i32 [ %prol.iter966.next, %vec.epilog.scalar.ph862.prol ], [ 0, %vec.epilog.scalar.ph862.preheader ]
  ...
  %prol.iter966.next = add i32 %prol.iter966, 1   ; 2 uses
  %prol.iter966.cmp.not = icmp eq i32 %prol.iter966.next, %xtraiter964
  br i1 %prol.iter966.cmp.not, label %vec.epilog.scalar.ph862.prol.loopexit, label %vec.epilog.scalar.ph862.prol, !llvm.loop !1378

vec.epilog.scalar.ph862.prol.loopexit:            ; preds = %vec.epilog.scalar.ph862.prol, %vec.epilog.scalar.ph862.preheader
  %.lcssa893.unr = phi ptr [ poison, %vec.epilog.scalar.ph862.preheader ], [ %i.acp, %vec.epilog.scalar.ph862.prol ]
  %.0404.unr = phi i32 [ %.0404.ph, %vec.epilog.scalar.ph862.preheader ], [ %i.acr, %vec.epilog.scalar.ph862.prol ]
  %.0215403.unr = phi ptr [ %.0215403.ph, %vec.epilog.scalar.ph862.preheader ], [ %i.acq, %vec.epilog.scalar.ph862.prol ]
  %.25402.unr = phi ptr [ %.25402.ph, %vec.epilog.scalar.ph862.preheader ], [ %i.acp, %vec.epilog.scalar.ph862.prol ]
  %i.acs = sub i32 %.0404.ph, %5
  %i.act = icmp ugt i32 %i.acs, -8
  br i1 %i.act, label %._crit_edge, label %vec.epilog.scalar.ph862

vec.epilog.scalar.ph862:                          ; preds = %vec.epilog.scalar.ph862.prol.loopexit, %vec.epilog.scalar.ph862
  %.0404 = phi i32 [ %i.ads, %vec.epilog.scalar.ph862 ], [ %.0404.unr, %vec.epilog.scalar.ph862.prol.loopexit ]
  %.0215403 = phi ptr [ %i.adr, %vec.epilog.scalar.ph862 ], [ %.0215403.unr, %vec.epilog.scalar.ph862.prol.loopexit ] ; 9 uses
  %.25402 = phi ptr [ %i.adq, %vec.epilog.scalar.ph862 ], [ %.25402.unr, %vec.epilog.scalar.ph862.prol.loopexit ] ; 9 uses
  ...
  %exitcond486.not.7 = icmp eq i32 %i.ads, %5
  br i1 %exitcond486.not.7, label %._crit_edge, label %vec.epilog.scalar.ph862, !llvm.loop !1379

._crit_edge:                                      ; preds = %vec.epilog.scalar.ph862.prol.loopexit, %vec.epilog.scalar.ph862, %vec.epilog.middle.block873, %middle.block855
  %.lcssa = phi ptr [ %i.ack, %vec.epilog.middle.block873 ], [ %i.aca, %middle.block855 ], [ %.lcssa893.unr, %vec.epilog.scalar.ph862.prol.loopexit ], [ %i.adq, %vec.epilog.scalar.ph862 ]
  %indvars.iv.next488 = add nsw i64 %indvars.iv487, 1 ; 2 uses
  %exitcond490.not = icmp eq i64 %indvars.iv.next488, %wide.trip.count
  %indvar.next838 = add i64 %indvar837, 1
  br i1 %exitcond490.not, label %.loopexit, label %iter.check861, !llvm.loop !1380
...
begin_hunk_16_@_ZN4ncnnL16pack_B_tile_bf16ERKNS_3MatERS0_iiii:bb.a
  br i1 %exitcond432.not.3, label %._crit_edge.us, label %vec.epilog.scalar.ph754, !llvm.loop !1459

._crit_edge.us:                                   ; preds = %vec.epilog.scalar.ph754.prol.loopexit, %vec.epilog.scalar.ph754, %vec.epilog.middle.block768, %middle.block746
  %.lcssa492 = phi ptr [ %i.yp, %vec.epilog.middle.block768 ], [ %i.yj, %middle.block746 ], [ %.lcssa833.unr, %vec.epilog.scalar.ph754.prol.loopexit ], [ %i.zy, %vec.epilog.scalar.ph754 ] ; 2 uses
  %indvars.iv.next434 = add nuw nsw i64 %indvars.iv433, 2 ; 3 uses
  %i.aac = icmp slt i64 %indvars.iv.next434, %invariant.op486
  br i1 %i.aac, label %iter.check753, label %.preheader.loopexit, !llvm.loop !1460
...
.preheader:                                       ; preds = %.lr.ph354.split.preheader, %.preheader.loopexit, %.preheader240
  ...
  %.21.lcssa = phi ptr [ %.16.lcssa, %.preheader240 ], [ %.lcssa492, %.preheader.loopexit ], [ %.16.lcssa, %.lr.ph354.split.preheader ]
...
.lr.ph362.preheader:                              ; preds = %.lr.ph366
  ...
  %.neg = mul i64 %i.aan, -2
  %.neg823 = sub i64 %.neg, %i.aai
  %i.aao = mul i64 %i.l, -2
  %i.aap = zext nneg i32 %5 to i64                ; 5 uses
  %min.iters.check780 = icmp ult i32 %5, 16
  %min.iters.check782 = icmp ult i32 %5, 128
  %i.aaq = and i64 %i.aap, 112
  %n.vec784 = and i64 %i.aap, 2147483520          ; 5 uses
  %i.aar = trunc nuw nsw i64 %n.vec784 to i32
  %i.aas = shl nuw nsw i64 %n.vec784, 1           ; 2 uses
  %cmp.n795 = icmp eq i64 %n.vec784, %i.aap
  %min.epilog.iters.check803 = icmp eq i64 %i.aaq, 0
  %n.vec805 = and i64 %i.aap, 2147483632          ; 4 uses
  %i.aat = trunc nuw nsw i64 %n.vec805 to i32
  %i.aau = shl nuw nsw i64 %n.vec805, 1           ; 2 uses
  %cmp.n813 = icmp eq i64 %n.vec805, %i.aap
  br label %iter.check800

iter.check800:                                    ; preds = %.lr.ph362.preheader, %._crit_edge
  %indvar776 = phi i64 [ 0, %.lr.ph362.preheader ], [ %indvar.next777, %._crit_edge ] ; 2 uses
  %indvars.iv438 = phi i64 [ %i.aaj, %.lr.ph362.preheader ], [ %indvars.iv.next439, %._crit_edge ] ; 2 uses
  %.23365 = phi ptr [ %.21.lcssa, %.lr.ph362.preheader ], [ %.lcssa, %._crit_edge ] ; 7 uses
  %i.aav = add nsw i64 %indvars.iv438, %i.aak
  %i.aaw = mul i64 %i.l, %i.aav
  %gep = getelementptr [2 x i8], ptr %invariant.gep367, i64 %i.aaw ; 6 uses
  br i1 %min.iters.check780, label %vec.epilog.scalar.ph801.preheader, label %vector.memcheck774

vector.memcheck774:                               ; preds = %iter.check800
  %i.aax = mul i64 %i.aao, %indvar776
  %i.aay = add i64 %.neg823, %i.aax
  %.23365775 = ptrtoaddr ptr %.23365 to i64
  %i.aaz = add i64 %i.aay, %.23365775
  %i.aba = add i64 %i.aaz, -1
  %diff.check778 = icmp ult i64 %i.aba, 255
  br i1 %diff.check778, label %vec.epilog.scalar.ph801.preheader, label %vector.main.loop.iter.check781

vector.main.loop.iter.check781:                   ; preds = %vector.memcheck774
  br i1 %min.iters.check782, label %vec.epilog.ph804, label %vector.ph783
...
vector.body785:                                   ; preds = %vector.body785, %vector.ph783
  %index786 = phi i64 [ 0, %vector.ph783 ], [ %index.next793, %vector.body785 ] ; 2 uses
  %i.abd = shl i64 %index786, 1                   ; 2 uses
  %next.gep787 = getelementptr i8, ptr %gep, i64 %i.abd ; 4 uses
  %next.gep788 = getelementptr i8, ptr %.23365, i64 %i.abd ; 4 uses
  %i.abe = getelementptr i8, ptr %next.gep787, i64 64
  %i.abf = getelementptr i8, ptr %next.gep787, i64 128
  %i.abg = getelementptr i8, ptr %next.gep787, i64 192
  %wide.load789 = load <32 x i16>, ptr %next.gep787, align 2, !tbaa !821
  %wide.load790 = load <32 x i16>, ptr %i.abe, align 2, !tbaa !821
  %wide.load791 = load <32 x i16>, ptr %i.abf, align 2, !tbaa !821
  %wide.load792 = load <32 x i16>, ptr %i.abg, align 2, !tbaa !821
  %i.abh = getelementptr i8, ptr %next.gep788, i64 64
  %i.abi = getelementptr i8, ptr %next.gep788, i64 128
  %i.abj = getelementptr i8, ptr %next.gep788, i64 192
  store <32 x i16> %wide.load789, ptr %next.gep788, align 2, !tbaa !821
  store <32 x i16> %wide.load790, ptr %i.abh, align 2, !tbaa !821
  store <32 x i16> %wide.load791, ptr %i.abi, align 2, !tbaa !821
  store <32 x i16> %wide.load792, ptr %i.abj, align 2, !tbaa !821
  %index.next793 = add nuw i64 %index786, 128     ; 2 uses
  %i.abk = icmp eq i64 %index.next793, %n.vec784
  br i1 %i.abk, label %middle.block794, label %vector.body785, !llvm.loop !1461

middle.block794:                                  ; preds = %vector.body785
  br i1 %cmp.n795, label %._crit_edge, label %vec.epilog.iter.check802

vec.epilog.iter.check802:                         ; preds = %middle.block794
  br i1 %min.epilog.iters.check803, label %vec.epilog.scalar.ph801.preheader, label %vec.epilog.ph804, !prof !1376

vec.epilog.ph804:                                 ; preds = %vector.main.loop.iter.check781, %vec.epilog.iter.check802
  %vec.epilog.resume.val796 = phi i64 [ %n.vec784, %vec.epilog.iter.check802 ], [ 0, %vector.main.loop.iter.check781 ]
...
vec.epilog.vector.body806:                        ; preds = %vec.epilog.vector.body806, %vec.epilog.ph804
  %index807 = phi i64 [ %vec.epilog.resume.val796, %vec.epilog.ph804 ], [ %index.next811, %vec.epilog.vector.body806 ] ; 2 uses
  %i.abn = shl i64 %index807, 1                   ; 2 uses
  %next.gep808 = getelementptr i8, ptr %gep, i64 %i.abn
  %next.gep809 = getelementptr i8, ptr %.23365, i64 %i.abn
  %wide.load810 = load <16 x i16>, ptr %next.gep808, align 2, !tbaa !821
  store <16 x i16> %wide.load810, ptr %next.gep809, align 2, !tbaa !821
  %index.next811 = add nuw i64 %index807, 16      ; 2 uses
  %i.abo = icmp eq i64 %index.next811, %n.vec805
  br i1 %i.abo, label %vec.epilog.middle.block812, label %vec.epilog.vector.body806, !llvm.loop !1462

vec.epilog.middle.block812:                       ; preds = %vec.epilog.vector.body806
  br i1 %cmp.n813, label %._crit_edge, label %vec.epilog.scalar.ph801.preheader

vec.epilog.scalar.ph801.preheader:                ; preds = %vector.memcheck774, %iter.check800, %vec.epilog.iter.check802, %vec.epilog.middle.block812
  %.0361.ph = phi i32 [ 0, %iter.check800 ], [ 0, %vector.memcheck774 ], [ %i.aar, %vec.epilog.iter.check802 ], [ %i.aat, %vec.epilog.middle.block812 ] ; 4 uses
  %.0191360.ph = phi ptr [ %gep, %iter.check800 ], [ %gep, %vector.memcheck774 ], [ %i.abb, %vec.epilog.iter.check802 ], [ %i.abl, %vec.epilog.middle.block812 ] ; 2 uses
  %.24359.ph = phi ptr [ %.23365, %iter.check800 ], [ %.23365, %vector.memcheck774 ], [ %i.abc, %vec.epilog.iter.check802 ], [ %i.abm, %vec.epilog.middle.block812 ] ; 2 uses
  %i.abp = sub i32 %5, %.0361.ph
  %xtraiter898 = and i32 %i.abp, 7                ; 2 uses
  %lcmp.mod899.not = icmp eq i32 %xtraiter898, 0
  br i1 %lcmp.mod899.not, label %vec.epilog.scalar.ph801.prol.loopexit, label %vec.epilog.scalar.ph801.prol

vec.epilog.scalar.ph801.prol:                     ; preds = %vec.epilog.scalar.ph801.preheader, %vec.epilog.scalar.ph801.prol
  %.0361.prol = phi i32 [ %i.abt, %vec.epilog.scalar.ph801.prol ], [ %.0361.ph, %vec.epilog.scalar.ph801.preheader ]
  %.0191360.prol = phi ptr [ %i.abs, %vec.epilog.scalar.ph801.prol ], [ %.0191360.ph, %vec.epilog.scalar.ph801.preheader ] ; 2 uses
  %.24359.prol = phi ptr [ %i.abr, %vec.epilog.scalar.ph801.prol ], [ %.24359.ph, %vec.epilog.scalar.ph801.preheader ] ; 2 uses
  %prol.iter900 = phi i32 [ %prol.iter900.next, %vec.epilog.scalar.ph801.prol ], [ 0, %vec.epilog.scalar.ph801.preheader ]
  ...
  %prol.iter900.next = add i32 %prol.iter900, 1   ; 2 uses
  %prol.iter900.cmp.not = icmp eq i32 %prol.iter900.next, %xtraiter898
  br i1 %prol.iter900.cmp.not, label %vec.epilog.scalar.ph801.prol.loopexit, label %vec.epilog.scalar.ph801.prol, !llvm.loop !1463

vec.epilog.scalar.ph801.prol.loopexit:            ; preds = %vec.epilog.scalar.ph801.prol, %vec.epilog.scalar.ph801.preheader
  %.lcssa832.unr = phi ptr [ poison, %vec.epilog.scalar.ph801.preheader ], [ %i.abr, %vec.epilog.scalar.ph801.prol ]
  %.0361.unr = phi i32 [ %.0361.ph, %vec.epilog.scalar.ph801.preheader ], [ %i.abt, %vec.epilog.scalar.ph801.prol ]
  %.0191360.unr = phi ptr [ %.0191360.ph, %vec.epilog.scalar.ph801.preheader ], [ %i.abs, %vec.epilog.scalar.ph801.prol ]
  %.24359.unr = phi ptr [ %.24359.ph, %vec.epilog.scalar.ph801.preheader ], [ %i.abr, %vec.epilog.scalar.ph801.prol ]
  %i.abu = sub i32 %.0361.ph, %5
  %i.abv = icmp ugt i32 %i.abu, -8
  br i1 %i.abv, label %._crit_edge, label %vec.epilog.scalar.ph801

vec.epilog.scalar.ph801:                          ; preds = %vec.epilog.scalar.ph801.prol.loopexit, %vec.epilog.scalar.ph801
  %.0361 = phi i32 [ %i.acu, %vec.epilog.scalar.ph801 ], [ %.0361.unr, %vec.epilog.scalar.ph801.prol.loopexit ]
  %.0191360 = phi ptr [ %i.act, %vec.epilog.scalar.ph801 ], [ %.0191360.unr, %vec.epilog.scalar.ph801.prol.loopexit ] ; 9 uses
  %.24359 = phi ptr [ %i.acs, %vec.epilog.scalar.ph801 ], [ %.24359.unr, %vec.epilog.scalar.ph801.prol.loopexit ] ; 9 uses
  ...
  %exitcond437.not.7 = icmp eq i32 %i.acu, %5
  br i1 %exitcond437.not.7, label %._crit_edge, label %vec.epilog.scalar.ph801, !llvm.loop !1464

._crit_edge:                                      ; preds = %vec.epilog.scalar.ph801.prol.loopexit, %vec.epilog.scalar.ph801, %vec.epilog.middle.block812, %middle.block794
  %.lcssa = phi ptr [ %i.abm, %vec.epilog.middle.block812 ], [ %i.abc, %middle.block794 ], [ %.lcssa832.unr, %vec.epilog.scalar.ph801.prol.loopexit ], [ %i.acs, %vec.epilog.scalar.ph801 ]
  %indvars.iv.next439 = add nsw i64 %indvars.iv438, 1 ; 2 uses
  %exitcond441.not = icmp eq i64 %indvars.iv.next439, %wide.trip.count
  %indvar.next777 = add i64 %indvar776, 1
  br i1 %exitcond441.not, label %.loopexit, label %iter.check800, !llvm.loop !1465
...
._crit_edge5542:                                  ; preds = %bb.zf, %.preheader
  ...
  %indvars.iv.next5629 = add nsw i64 %indvars.iv5628, 1 ; 2 uses
