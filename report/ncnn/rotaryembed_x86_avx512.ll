...
.preheader:                                       ; preds = %.lr.ph454, %.preheader360
  ...
  %.2285.lcssa644 = ptrtoaddr ptr %.2285.lcssa to i64 ; 5 uses
...
vector.memcheck:                                  ; preds = %iter.check
  %10 = sub i64 %.2285.lcssa644, %.2281.lcssa643
  %diff.check = icmp ugt i64 %10, -64
  %11 = sub i64 %.2297.lcssa645, %.2285.lcssa644
  %diff.check646 = icmp ugt i64 %11, -64
  %conflict.rdx = or i1 %diff.check, %diff.check646
  %12 = sub i64 %.2301.lcssa647, %.2285.lcssa644
  %diff.check648 = icmp ugt i64 %12, -64
  %conflict.rdx649 = or i1 %conflict.rdx, %diff.check648
  %13 = sub i64 %.2293.lcssa650, %.2285.lcssa644
  %diff.check651 = icmp ugt i64 %13, -64
  %conflict.rdx652 = or i1 %conflict.rdx649, %diff.check651
  %14 = sub i64 %.2289.lcssa653, %.2285.lcssa644
  %diff.check654 = icmp ugt i64 %14, -64
  %conflict.rdx655 = or i1 %conflict.rdx652, %diff.check654
  %15 = sub i64 %.2297.lcssa645, %.2281.lcssa643
  %diff.check656 = icmp ugt i64 %15, -64
  %conflict.rdx657 = or i1 %conflict.rdx655, %diff.check656
  %16 = sub i64 %.2301.lcssa647, %.2281.lcssa643
  %diff.check658 = icmp ugt i64 %16, -64
  %conflict.rdx659 = or i1 %conflict.rdx657, %diff.check658
  %i.ma = sub i64 %.2293.lcssa650, %.2281.lcssa643
  %diff.check662.a = icmp ugt i64 %i.ma, -64
  %conflict.rdx661 = or i1 %conflict.rdx659, %diff.check662.a
  %17 = sub i64 %.2289.lcssa653, %.2281.lcssa643
  %diff.check662 = icmp ugt i64 %17, -64
  %op.rdx = or i1 %conflict.rdx661, %diff.check662
...
.preheader:                                       ; preds = %.lr.ph505, %.preheader411
  ...
  %.2250.lcssa694 = ptrtoaddr ptr %.2250.lcssa to i64 ; 5 uses
  %.2254.lcssa695 = ptrtoaddr ptr %.2254.lcssa to i64 ; 5 uses
  %.2266.lcssa696 = ptrtoaddr ptr %.2266.lcssa to i64 ; 2 uses
  %.2270.lcssa698 = ptrtoaddr ptr %.2270.lcssa to i64 ; 2 uses
  %.2262.lcssa701 = ptrtoaddr ptr %.2262.lcssa to i64 ; 2 uses
...
vector.memcheck:                                  ; preds = %iter.check
  %10 = sub i64 %.2254.lcssa695, %.2250.lcssa694
  %diff.check = icmp ugt i64 %10, -64
  %11 = sub i64 %.2266.lcssa696, %.2254.lcssa695
  %diff.check697 = icmp ugt i64 %11, -64
  %conflict.rdx = or i1 %diff.check, %diff.check697
  %12 = sub i64 %.2270.lcssa698, %.2254.lcssa695
  %diff.check699 = icmp ugt i64 %12, -64
  %conflict.rdx700 = or i1 %conflict.rdx, %diff.check699
  %13 = sub i64 %.2262.lcssa701, %.2254.lcssa695
  %diff.check702 = icmp ugt i64 %13, -64
  %conflict.rdx703 = or i1 %conflict.rdx700, %diff.check702
  %14 = sub i64 %.2258.lcssa704, %.2254.lcssa695
  %diff.check705 = icmp ugt i64 %14, -64
  %conflict.rdx706 = or i1 %conflict.rdx703, %diff.check705
  %15 = sub i64 %.2266.lcssa696, %.2250.lcssa694
  %diff.check707 = icmp ugt i64 %15, -64
  %conflict.rdx708 = or i1 %conflict.rdx706, %diff.check707
  %16 = sub i64 %.2270.lcssa698, %.2250.lcssa694
  %diff.check709 = icmp ugt i64 %16, -64
  %conflict.rdx710 = or i1 %conflict.rdx708, %diff.check709
  %i.tg = sub i64 %.2262.lcssa701, %.2250.lcssa694
  %diff.check713.a = icmp ugt i64 %i.tg, -64
  %conflict.rdx712 = or i1 %conflict.rdx710, %diff.check713.a
  %17 = sub i64 %.2258.lcssa704, %.2250.lcssa694
  %diff.check713 = icmp ugt i64 %17, -64
  %op.rdx = or i1 %conflict.rdx712, %diff.check713
