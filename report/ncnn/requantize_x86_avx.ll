...
_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit164.thread975: ; preds = %.lr.ph1060
  ...
  %i.gf = fmul fast <8 x float> %i.fl, splat (float f0x3F317218)
  %reass.add1039 = fadd fast <8 x float> %i.ge, splat (float -5.000000e-01)
  %reass.mul1023.a = fmul fast <8 x float> %i.fn, %reass.add1039
  %i.gg = fadd fast <8 x float> %i.gf, %i.fm
  ...
  %i.jk = fmul fast <8 x float> %i.jj, %i.jj
  ...
  %i.kb = fmul fast <8 x float> %i.ka, %i.jj
  %i.kc = fmul fast <8 x float> %i.ji, splat (float f0x3F317218)
  %reass.add1041 = fadd fast <8 x float> %i.kb, splat (float -5.000000e-01)
  %reass.mul1026 = fmul fast <8 x float> %i.jk, %reass.add1041
  %i.kd = fadd fast <8 x float> %i.kc, %i.jj
...
bb.j:                                             ; preds = %.lr.ph1067
  ...
  %i.qy = fmul fast <8 x float> %i.qx, %i.qx
  ...
  %i.rp = fmul fast <8 x float> %i.ro, %i.qx
  %i.rq = fmul fast <8 x float> %i.qw, splat (float f0x3F317218)
  %reass.add1032 = fadd fast <8 x float> %i.rp, splat (float -5.000000e-01)
  %reass.mul1021.a = fmul fast <8 x float> %i.qy, %reass.add1032
  %i.rr = fadd fast <8 x float> %i.rq, %i.qx
...
bb.p:                                             ; preds = %.lr.ph1074
  ...
  %i.yb = fmul fast <4 x float> %i.ya, %i.ya
  ...
  %i.ys = fmul fast <4 x float> %i.yr, %i.ya
  %i.yt = fmul fast <4 x float> %i.xz, splat (float f0x3F317218)
  %reass.add1028 = fadd fast <4 x float> %i.ys, splat (float -5.000000e-01)
  %reass.mul1019 = fmul fast <4 x float> %i.yb, %reass.add1028
  %i.yu = fadd fast <4 x float> %i.yt, %i.ya
...
_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit158.thread993: ; preds = %.lr.ph
  ...
  %i.ajb = fmul fast <8 x float> %i.aja, %i.aja
  ...
  %i.ajs = fmul fast <8 x float> %i.ajr, %i.aja
  %i.ajt = fmul fast <8 x float> %i.aiz, splat (float f0x3F317218)
  %reass.add1022 = fadd fast <8 x float> %i.ajs, splat (float -5.000000e-01)
  %reass.mul1014.a = fmul fast <8 x float> %i.ajb, %reass.add1022
  %i.aju = fadd fast <8 x float> %i.ajt, %i.aja
  ...
  %i.amy = fmul fast <8 x float> %i.amx, %i.amx
  ...
  %i.anp = fmul fast <8 x float> %i.ano, %i.amx
  %i.anq = fmul fast <8 x float> %i.amw, splat (float f0x3F317218)
  %reass.add1024 = fadd fast <8 x float> %i.anp, splat (float -5.000000e-01)
  %reass.mul1017 = fmul fast <8 x float> %i.amy, %reass.add1024
  %i.anr = fadd fast <8 x float> %i.anq, %i.amx
...
bb.ah:                                            ; preds = %.lr.ph1042
  ...
  %i.aun = fmul fast <8 x float> %i.aum, %i.aum
  ...
  %i.ave = fmul fast <8 x float> %i.avd, %i.aum
  %i.avf = fmul fast <8 x float> %i.aul, splat (float f0x3F317218)
  %reass.add1015 = fadd fast <8 x float> %i.ave, splat (float -5.000000e-01)
  %reass.mul1012.a = fmul fast <8 x float> %i.aun, %reass.add1015
  %i.avg = fadd fast <8 x float> %i.avf, %i.aum
...
bb.an:                                            ; preds = %.lr.ph1049
  ...
  %i.bbr = fmul fast <4 x float> %i.bbq, %i.bbq
  ...
  %i.bci = fmul fast <4 x float> %i.bch, %i.bbq
  %i.bcj = fmul fast <4 x float> %i.bbp, splat (float f0x3F317218)
  %reass.add1011 = fadd fast <4 x float> %i.bci, splat (float -5.000000e-01)
  %reass.mul = fmul fast <4 x float> %i.bbr, %reass.add1011
  %i.bck = fadd fast <4 x float> %i.bcj, %i.bbq
