...
_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit164.thread972: ; preds = %.lr.ph1076
  ...
  %i.ce = fadd fast <8 x float> %i.br, splat (float 1.000000e+00)
...
_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit164.thread975: ; preds = %.lr.ph1076
  ...
  %i.ep = fadd fast <8 x float> %i.ec, splat (float 1.000000e+00)
  %i.eq = fadd fast <8 x float> %i.ep, %i.eo
  ...
  %i.fn = fmul fast <8 x float> %i.fm, %i.fm
  ...
  %i.ge = fmul fast <8 x float> %i.gd, %i.fm
  %reass.mul1035 = fmul fast <8 x float> %i.fl, splat (float f0x3F317218)
  %reass.add1039 = fadd fast <8 x float> %i.ge, splat (float -5.000000e-01)
  %reass.mul1040 = fmul fast <8 x float> %i.fn, %reass.add1039
  %i.gf = fadd fast <8 x float> %reass.mul1035, %i.fm
  ...
  %i.he = fadd fast <8 x float> %i.gr, splat (float 1.000000e+00)
  %i.hf = fadd fast <8 x float> %i.he, %i.hd
  ...
  %i.jj = fmul fast <8 x float> %i.ji, %i.ji
  ...
  %i.ka = fmul fast <8 x float> %i.jz, %i.ji
  %reass.mul1038 = fmul fast <8 x float> %i.jh, splat (float f0x3F317218)
  %reass.add1041 = fadd fast <8 x float> %i.ka, splat (float -5.000000e-01)
  %reass.mul1042 = fmul fast <8 x float> %i.jj, %reass.add1041
  %i.kb = fadd fast <8 x float> %reass.mul1038, %i.ji
  ...
  %i.la = fadd fast <8 x float> %i.kn, splat (float 1.000000e+00)
  %i.lb = fadd fast <8 x float> %i.la, %i.kz
...
bb.i:                                             ; preds = %.lr.ph1083
  ...
  %i.ot = fadd fast <8 x float> %i.og, splat (float 1.000000e+00)
  %i.ou = fadd fast <8 x float> %i.ot, %i.os
...
bb.j:                                             ; preds = %.lr.ph1083
  ...
  %i.py = fadd fast <8 x float> %i.pl, splat (float 1.000000e+00)
  %i.pz = fadd fast <8 x float> %i.py, %i.px
  ...
  %i.qw = fmul fast <8 x float> %i.qv, %i.qv
  ...
  %i.rn = fmul fast <8 x float> %i.rm, %i.qv
  %reass.mul1031 = fmul fast <8 x float> %i.qu, splat (float f0x3F317218)
  %reass.add1032 = fadd fast <8 x float> %i.rn, splat (float -5.000000e-01)
  %reass.mul1033 = fmul fast <8 x float> %i.qw, %reass.add1032
  %i.ro = fadd fast <8 x float> %reass.mul1031, %i.qv
...
bb.o:                                             ; preds = %.lr.ph1090
  ...
  %i.vv = fadd fast <4 x float> %i.vi, splat (float 1.000000e+00)
  %i.vw = fadd fast <4 x float> %i.vv, %i.vu
...
bb.p:                                             ; preds = %.lr.ph1090
  ...
  %i.xb = fadd fast <4 x float> %i.wo, splat (float 1.000000e+00)
  %i.xc = fadd fast <4 x float> %i.xb, %i.xa
  ...
  %i.yp = fmul fast <4 x float> %i.yo, %i.xx
  %reass.mul1027 = fmul fast <4 x float> %i.xw, splat (float f0x3F317218)
  %reass.add1028 = fadd fast <4 x float> %i.yp, splat (float -5.000000e-01)
  %reass.mul1029 = fmul fast <4 x float> %i.xy, %reass.add1028
  %i.yq = fadd fast <4 x float> %reass.mul1027, %i.xx
  ...
  %i.zq = fadd fast <4 x float> %i.zd, splat (float 1.000000e+00)
  %i.zr = fadd fast <4 x float> %i.zq, %i.zp
...
_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit158.thread990: ; preds = %.lr.ph
  ...
  %i.afo = fadd fast <8 x float> %i.afb, splat (float 1.000000e+00)
  %i.afp = fadd fast <8 x float> %i.afo, %i.afn
...
_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit158.thread993: ; preds = %.lr.ph
  ...
  %i.ahz = fadd fast <8 x float> %i.ahm, splat (float 1.000000e+00)
  %i.aia = fadd fast <8 x float> %i.ahz, %i.ahy
  ...
  %i.aix = fmul fast <8 x float> %i.aiw, %i.aiw
  ...
  %i.ajo = fmul fast <8 x float> %i.ajn, %i.aiw
  %reass.mul1018 = fmul fast <8 x float> %i.aiv, splat (float f0x3F317218)
  %reass.add1022 = fadd fast <8 x float> %i.ajo, splat (float -5.000000e-01)
  %reass.mul1023 = fmul fast <8 x float> %i.aix, %reass.add1022
  %i.ajp = fadd fast <8 x float> %reass.mul1018, %i.aiw
  ...
  %i.ako = fadd fast <8 x float> %i.akb, splat (float 1.000000e+00)
  %i.akp = fadd fast <8 x float> %i.ako, %i.akn
  ...
  %i.alv = fadd fast <8 x float> %i.ali, splat (float 1.000000e+00)
  %i.alw = fadd fast <8 x float> %i.alv, %i.alu
  ...
  %i.amt = fmul fast <8 x float> %i.ams, %i.ams
  ...
  %i.ank = fmul fast <8 x float> %i.anj, %i.ams
  %reass.mul1021 = fmul fast <8 x float> %i.amr, splat (float f0x3F317218)
  %reass.add1024 = fadd fast <8 x float> %i.ank, splat (float -5.000000e-01)
  %reass.mul1025 = fmul fast <8 x float> %i.amt, %reass.add1024
  %i.anl = fadd fast <8 x float> %reass.mul1021, %i.ams
  ...
  %i.aok = fadd fast <8 x float> %i.anx, splat (float 1.000000e+00)
  %i.aol = fadd fast <8 x float> %i.aok, %i.aoj
...
bb.ag:                                            ; preds = %.lr.ph1058
  ...
  %i.ase = fadd fast <8 x float> %i.arr, splat (float 1.000000e+00)
  %i.asf = fadd fast <8 x float> %i.ase, %i.asd
...
bb.ah:                                            ; preds = %.lr.ph1058
  ...
  %i.atj = fadd fast <8 x float> %i.asw, splat (float 1.000000e+00)
  %i.atk = fadd fast <8 x float> %i.atj, %i.ati
  ...
  %i.auh = fmul fast <8 x float> %i.aug, %i.aug
  ...
  %i.auy = fmul fast <8 x float> %i.aux, %i.aug
  %reass.mul1014 = fmul fast <8 x float> %i.auf, splat (float f0x3F317218)
  %reass.add1015 = fadd fast <8 x float> %i.auy, splat (float -5.000000e-01)
  %reass.mul1016 = fmul fast <8 x float> %i.auh, %reass.add1015
  %i.auz = fadd fast <8 x float> %reass.mul1014, %i.aug
  ...
  %i.avy = fadd fast <8 x float> %i.avl, splat (float 1.000000e+00)
  %i.avz = fadd fast <8 x float> %i.avy, %i.avx
...
bb.am:                                            ; preds = %.lr.ph1065
  ...
  %i.azh = fadd fast <4 x float> %i.ayu, splat (float 1.000000e+00)
  %i.azi = fadd fast <4 x float> %i.azh, %i.azg
...
bb.an:                                            ; preds = %.lr.ph1065
  ...
  %i.ban = fadd fast <4 x float> %i.baa, splat (float 1.000000e+00)
  %i.bao = fadd fast <4 x float> %i.ban, %i.bam
  ...
  %i.bbk = fmul fast <4 x float> %i.bbj, %i.bbj
  ...
  %i.bcb = fmul fast <4 x float> %i.bca, %i.bbj
  %reass.mul.a = fmul fast <4 x float> %i.bbi, splat (float f0x3F317218)
  %reass.add1011 = fadd fast <4 x float> %i.bcb, splat (float -5.000000e-01)
  %reass.mul1012 = fmul fast <4 x float> %i.bbk, %reass.add1011
  %i.bcc = fadd fast <4 x float> %reass.mul.a, %i.bbj
  ...
  %i.bdc = fadd fast <4 x float> %i.bcp, splat (float 1.000000e+00)
  %i.bdd = fadd fast <4 x float> %i.bdc, %i.bdb
