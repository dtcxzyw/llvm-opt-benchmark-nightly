...
begin_hunk_0_@_ZN4ncnn15LSTM_x86_avx51220create_pipeline_int8ERKNS_6OptionE:bb.a
  ...
  call void %i.bq(ptr noundef nonnull align 8 dereferenceable(8) %i.bm, ptr noundef %i.bn), !inline_history !0
  br label %_ZN4ncnn3Mat7releaseEv.exit10

bb.r:                                             ; preds = %bb.p
  %.not.i20 = icmp eq ptr %i.bn, null
  br i1 %.not.i20, label %_ZN4ncnn3Mat7releaseEv.exit10, label %bb.s
...
_ZN4ncnn3Mat7releaseEv.exit10:                    ; preds = %bb.s, %bb.r, %_ZN4ncnn3Mat7releaseEv.exit13, %bb.o, %bb.q
  ...
  store i64 0, ptr %i.bs, align 8, !tbaa !27
  ...
  %i.bu = load ptr, ptr %i.bt, align 8, !tbaa !24 ; 2 uses
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.by = load ptr, ptr %i.bx, align 8, !tbaa !25 ; 3 uses
  %.not3.i6 = icmp eq ptr %i.by, null
  %i.bz = load ptr, ptr %i.q, align 8, !tbaa !26  ; 3 uses
  br i1 %.not3.i6, label %bb.w, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.ca = load ptr, ptr %i.by, align 8, !tbaa !18
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 24
  %i.cc = load ptr, ptr %i.cb, align 8
  call void %i.cc(ptr noundef nonnull align 8 dereferenceable(8) %i.by, ptr noundef %i.bz), !inline_history !0
...
_ZN4ncnn3Mat7releaseEv.exit7:                     ; preds = %bb.x, %bb.w, %_ZN4ncnn3Mat7releaseEv.exit10, %bb.t, %bb.v
  ...
  store i64 0, ptr %i.ce, align 8, !tbaa !27
  ...
  %i.cg = load ptr, ptr %i.cf, align 8, !tbaa !24 ; 2 uses
...
.noexc231.lr.ph:                                  ; preds = %bb.b
  ...
  %5 = sext i32 %i.bm to i64                      ; 5 uses
  %6 = sext i32 %i.bn to i64                      ; 5 uses
  %i.bt = sext i32 %i.k to i64                    ; 7 uses
  %i.bu = add nsw i32 %i.j, 1
  %invariant.op = add nsw i64 %i.bp, -1
  %i.bv = mul i64 %i.ah, %i.bt                    ; 4 uses
  %i.bw = add nsw i64 %6, %i.bs
  %i.bx = add nsw i64 %i.bw, -1
  %i.by = mul i64 %i.ah, %i.aj
  %i.bz = add nsw i64 %5, %i.bs
  %i.ca = add nsw i64 %i.bz, -1
  %i.cb = add nsw i64 %i.bp, %i.bs
  %i.cc = add nsw i64 %i.cb, -1
  %i.cd = add nsw i64 %i.bs, -1
  %i.ce = mul i64 %i.q, %i.bt                     ; 4 uses
  %i.cf = add nsw i64 %6, %i.bs
  %i.cg = add nsw i64 %i.cf, -1
  %i.ch = mul i64 %i.q, %i.s
  %i.ci = add nsw i64 %5, %i.bs
  %i.cj = add nsw i64 %i.ci, -1
  %i.ck = add nsw i64 %i.bp, %i.bs
  %i.cl = add nsw i64 %i.ck, -1
  %i.cm = add nsw i64 %i.bs, -1
  %i.cn = mul i64 %i.bd, %i.bt
  %i.co = add nsw i64 %i.bp, -2                   ; 4 uses
  %i.cp = lshr i64 %i.co, 1                       ; 2 uses
  %i.cq = mul i64 %i.bd, %i.bf
  %i.cr = mul i64 %i.ah, %i.bt                    ; 15 uses
  %i.cs = add nuw nsw i64 %i.bq, 1
  %i.ct = mul i64 %i.ah, %i.aj
  %i.cu = and i64 %i.co, -2                       ; 5 uses
  %i.cv = add nsw i64 %i.cu, %i.bq
  %i.cw = add nsw i64 %i.cv, 1
  %i.cx = sext i32 %i.ba to i64                   ; 4 uses
  %i.cy = sext i32 %i.ae to i64                   ; 26 uses
  %i.cz = mul i64 %i.aj, %i.cy                    ; 12 uses
  %i.da = mul i64 %i.bf, %i.cx                    ; 2 uses
  %i.db = mul i64 %i.bf, %i.cx
  %i.dc = mul i64 %i.aj, %i.cy
  %i.dd = mul i64 %i.bx, %i.cy
  %i.de = add i64 %i.bv, %i.dd
  %i.df = mul i64 %i.aj, %i.de
  %i.dg = mul i64 %i.aj, %i.cy
  %i.dh = mul i64 %i.aj, %i.cy
  %i.di = mul i64 %i.ca, %i.cy
  %i.dj = add i64 %i.bv, %i.di
  %i.dk = mul i64 %i.aj, %i.dj
  %i.dl = mul i64 %i.aj, %i.cy
  %i.dm = mul i64 %i.cc, %i.cy
  %i.dn = add i64 %i.bv, %i.dm
  %i.do = mul i64 %i.aj, %i.dn
  %i.dp = mul i64 %i.aj, %i.cy
  %i.dq = mul i64 %i.cd, %i.cy
  %i.dr = add i64 %i.bv, %i.dq
  %i.ds = mul i64 %i.aj, %i.dr
  %i.dt = mul i64 %i.cp, %i.cx
  %i.du = add i64 %i.cn, %i.dt
  %i.dv = mul i64 %i.bf, %i.du
  %i.dw = mul i64 %i.cs, %i.cy
  %i.dx = add i64 %i.cr, %i.dw
  %i.dy = mul i64 %i.aj, %i.dx
  %i.dz = mul i64 %i.cw, %i.cy
  %i.ea = add i64 %i.cr, %i.dz
  %i.eb = mul i64 %i.aj, %i.ea
  %i.ec = mul i64 %i.bf, %i.cx
  %i.ed = mul i64 %i.aj, %i.cy
  %i.ee = shl i64 %i.ed, 1
  %i.ef = or disjoint i64 %i.br, 1
  %i.eg = mul nsw i64 %i.ef, %i.cy
  %i.eh = add i64 %i.cr, %i.eg
  %i.ei = mul i64 %i.aj, %i.eh
  %i.ej = add nsw i64 %i.co, %i.br
  %i.ek = or i64 %i.ej, 1
  %i.el = mul i64 %i.ek, %i.cy
  %i.em = add i64 %i.cr, %i.el
  %i.en = mul i64 %i.aj, %i.em
  %i.eo = add nuw nsw i64 %i.bs, 1
  %i.ep = mul i64 %i.eo, %i.cy
  %i.eq = add i64 %i.cr, %i.ep
  %i.er = mul i64 %i.aj, %i.eq
  %i.es = add nsw i64 %i.cu, %i.bs
  %i.et = add nsw i64 %i.es, 1
  %i.eu = mul i64 %i.et, %i.cy
  %i.ev = add i64 %i.cr, %i.eu
  %i.ew = mul i64 %i.aj, %i.ev
  %i.ex = add i64 %i.cr, %i.cy
  %i.ey = mul i64 %i.aj, %i.ex
  %i.ez = or i64 %i.co, 1
  %i.fa = mul i64 %i.ez, %i.cy
  %i.fb = add i64 %i.cr, %i.fa
  %i.fc = mul i64 %i.aj, %i.fb
  %i.fd = mul nsw i64 %i.cy, %i.bq
  %i.fe = add i64 %i.cr, %i.fd
  %i.ff = mul i64 %i.aj, %i.fe
  %i.fg = add nsw i64 %i.cu, %i.bq
  %i.fh = mul i64 %i.fg, %i.cy
  %i.fi = add i64 %i.cr, %i.fh
  %i.fj = mul i64 %i.aj, %i.fi
  %i.fk = mul nsw i64 %i.cy, %i.br
  %i.fl = add i64 %i.cr, %i.fk
  %i.fm = mul i64 %i.aj, %i.fl
  %i.fn = add nsw i64 %i.cu, %i.br
  %i.fo = mul i64 %i.fn, %i.cy
  %i.fp = add i64 %i.cr, %i.fo
  %i.fq = mul i64 %i.aj, %i.fp
  %i.fr = mul nsw i64 %i.cy, %i.bs
  %i.fs = add i64 %i.cr, %i.fr
  %i.ft = mul i64 %i.aj, %i.fs
  %i.fu = add nsw i64 %i.cu, %i.bs
  %i.fv = mul i64 %i.fu, %i.cy
  %i.fw = add i64 %i.cr, %i.fv
  %i.fx = mul i64 %i.aj, %i.fw
  %i.fy = mul i64 %i.cp, %i.cy
  %i.fz = shl i64 %i.fy, 1
  %i.ga = add i64 %i.fz, %i.cr
  %i.gb = mul i64 %i.aj, %i.ga
  %i.gc = mul i64 %i.ap, %i.bt
  %i.gd = add nsw i64 %i.bp, -2                   ; 4 uses
  %i.ge = lshr i64 %i.gd, 1                       ; 2 uses
  %i.gf = mul i64 %i.ap, %i.ar
  %i.gg = mul i64 %i.q, %i.bt                     ; 15 uses
  %i.gh = add nuw nsw i64 %i.bq, 1
  %i.gi = mul i64 %i.q, %i.s
  %i.gj = and i64 %i.gd, -2                       ; 5 uses
  %i.gk = add nsw i64 %i.gj, %i.bq
  %i.gl = add nsw i64 %i.gk, 1
  %i.gm = sext i32 %i.am to i64                   ; 4 uses
  %i.gn = sext i32 %i.n to i64                    ; 26 uses
  %i.go = mul i64 %i.s, %i.gn                     ; 12 uses
  %i.gp = mul i64 %i.ar, %i.gm                    ; 2 uses
  %i.gq = mul i64 %i.ar, %i.gm
  %i.gr = mul i64 %i.s, %i.gn
  %i.gs = mul i64 %i.cg, %i.gn
  %i.gt = add i64 %i.ce, %i.gs
  %i.gu = mul i64 %i.s, %i.gt
  %i.gv = mul i64 %i.s, %i.gn
  %i.gw = mul i64 %i.s, %i.gn
  %i.gx = mul i64 %i.cj, %i.gn
  %i.gy = add i64 %i.ce, %i.gx
  %i.gz = mul i64 %i.s, %i.gy
  %i.ha = mul i64 %i.s, %i.gn
  %i.hb = mul i64 %i.cl, %i.gn
  %i.hc = add i64 %i.ce, %i.hb
  %i.hd = mul i64 %i.s, %i.hc
  %i.he = mul i64 %i.s, %i.gn
  %i.hf = mul i64 %i.cm, %i.gn
  %i.hg = add i64 %i.ce, %i.hf
  %i.hh = mul i64 %i.s, %i.hg
  %i.hi = mul i64 %i.ge, %i.gm
  %i.hj = add i64 %i.gc, %i.hi
  %i.hk = mul i64 %i.ar, %i.hj
  %i.hl = mul i64 %i.gh, %i.gn
  %i.hm = add i64 %i.gg, %i.hl
  %i.hn = mul i64 %i.s, %i.hm
  %i.ho = mul i64 %i.gl, %i.gn
  %i.hp = add i64 %i.gg, %i.ho
  %i.hq = mul i64 %i.s, %i.hp
  %i.hr = mul i64 %i.ar, %i.gm
  %i.hs = mul i64 %i.s, %i.gn
  %i.ht = shl i64 %i.hs, 1
  %i.hu = or disjoint i64 %i.br, 1
  %i.hv = mul nsw i64 %i.hu, %i.gn
  %i.hw = add i64 %i.gg, %i.hv
  %i.hx = mul i64 %i.s, %i.hw
  %i.hy = add nsw i64 %i.gd, %i.br
  %i.hz = or i64 %i.hy, 1
  %i.ia = mul i64 %i.hz, %i.gn
  %i.ib = add i64 %i.gg, %i.ia
  %i.ic = mul i64 %i.s, %i.ib
  %i.id = add nuw nsw i64 %i.bs, 1
  %i.ie = mul i64 %i.id, %i.gn
  %i.if = add i64 %i.gg, %i.ie
  %i.ig = mul i64 %i.s, %i.if
  %i.ih = add nsw i64 %i.gj, %i.bs
  %i.ii = add nsw i64 %i.ih, 1
  %i.ij = mul i64 %i.ii, %i.gn
  %i.ik = add i64 %i.gg, %i.ij
  %i.il = mul i64 %i.s, %i.ik
  %i.im = add i64 %i.gg, %i.gn
  %i.in = mul i64 %i.s, %i.im
  %i.io = or i64 %i.gd, 1
  %i.ip = mul i64 %i.io, %i.gn
  %i.iq = add i64 %i.gg, %i.ip
  %i.ir = mul i64 %i.s, %i.iq
  %i.is = mul nsw i64 %i.gn, %i.bq
  %i.it = add i64 %i.gg, %i.is
  %i.iu = mul i64 %i.s, %i.it
  %i.iv = add nsw i64 %i.gj, %i.bq
  %i.iw = mul i64 %i.iv, %i.gn
  %i.ix = add i64 %i.gg, %i.iw
  %i.iy = mul i64 %i.s, %i.ix
  %i.iz = mul nsw i64 %i.gn, %i.br
  %i.ja = add i64 %i.gg, %i.iz
  %i.jb = mul i64 %i.s, %i.ja
  %i.jc = add nsw i64 %i.gj, %i.br
  %i.jd = mul i64 %i.jc, %i.gn
  %i.je = add i64 %i.gg, %i.jd
  %i.jf = mul i64 %i.s, %i.je
  %i.jg = mul nsw i64 %i.gn, %i.bs
  %i.jh = add i64 %i.gg, %i.jg
  %i.ji = mul i64 %i.s, %i.jh
  %i.jj = add nsw i64 %i.gj, %i.bs
  %i.jk = mul i64 %i.jj, %i.gn
  %i.jl = add i64 %i.gg, %i.jk
  %i.jm = mul i64 %i.s, %i.jl
  %i.jn = mul i64 %i.ge, %i.gn
  %i.jo = shl i64 %i.jn, 1
  %i.jp = add i64 %i.jo, %i.gg
  %i.jq = mul i64 %i.s, %i.jp
  %i.jr = getelementptr i8, ptr %i.o, i64 %i.gu
  %i.js = getelementptr i8, ptr %i.o, i64 %i.gz
  %i.jt = getelementptr i8, ptr %i.o, i64 %i.hd
  %i.ju = getelementptr i8, ptr %i.o, i64 %i.hh
  %i.jv = getelementptr i8, ptr %i.af, i64 %i.df
  %i.jw = getelementptr i8, ptr %i.af, i64 %i.dk
  %i.jx = getelementptr i8, ptr %i.af, i64 %i.do
  %i.jy = getelementptr i8, ptr %i.af, i64 %i.ds
  %i.jz = getelementptr i8, ptr %i.af, i64 %i.ft
  %i.ka = getelementptr i8, ptr %i.af, i64 %i.fm
  %i.kb = getelementptr i8, ptr %i.af, i64 %i.ff
  %i.kc = getelementptr i8, ptr %i.af, i64 %i.ey
  %i.kd = getelementptr i8, ptr %i.af, i64 %i.er
  %i.ke = getelementptr i8, ptr %i.af, i64 %i.ei
  %i.kf = getelementptr i8, ptr %i.af, i64 %i.dy
  ...
  %i.km = getelementptr i8, ptr %i.o, i64 %i.hn
  %i.kn = getelementptr i8, ptr %i.af, i64 %i.gb
  %i.ko = getelementptr i8, ptr %i.af, i64 %i.fx
  %i.kp = getelementptr i8, ptr %i.af, i64 %i.fq
  %i.kq = getelementptr i8, ptr %i.af, i64 %i.fj
  %i.kr = getelementptr i8, ptr %i.af, i64 %i.fc
  %i.ks = getelementptr i8, ptr %i.af, i64 %i.ew
  %i.kt = getelementptr i8, ptr %i.af, i64 %i.en
  %i.ku = getelementptr i8, ptr %i.af, i64 %i.eb
  %i.kv = getelementptr i8, ptr %i.bb, i64 %i.dv
  ...
  %i.ld = getelementptr i8, ptr %i.o, i64 %i.hq
  %i.le = getelementptr i8, ptr %i.an, i64 %i.hk
  %i.lf = insertelement <8 x i64> poison, i64 %i.ee, i64 0
  %i.lg = insertelement <8 x i64> poison, i64 %i.ec, i64 0
  %i.lh = insertelement <8 x i64> poison, i64 %i.ht, i64 0
  %i.li = insertelement <8 x i64> poison, i64 %i.hr, i64 0
  ...
  %stride.check527 = icmp slt i64 %i.gv, 0
  %stride.check477 = icmp slt i64 %i.dg, 0
  br label %.noexc231
...
.noexc231:                                        ; preds = %.noexc231.lr.ph, %_ZN4ncnn3MatD2Ev.exit
  ...
  %indvars.iv448 = phi i64 [ %i.bt, %.noexc231.lr.ph ], [ %indvars.iv.next449, %_ZN4ncnn3MatD2Ev.exit ] ; 7 uses
  %i.lp = mul i64 %i.ch, %indvar461               ; 4 uses
  ...
  %i.lq = mul i64 %i.by, %indvar461               ; 4 uses
  ...
  %i.ls = getelementptr inbounds nuw i8, ptr %i.w, i64 %.reass414 ; 6 uses
  %.reass416 = mul i64 %factor.op.mul415, %indvars.iv448
  %i.lt = getelementptr i8, ptr %i.af, i64 %.reass416 ; 17 uses
  %.reass418 = mul i64 %factor.op.mul417, %indvars.iv448
  %i.lu = getelementptr i8, ptr %i.an, i64 %.reass418 ; 5 uses
  %.reass420 = mul i64 %factor.op.mul419, %indvars.iv448
  %i.lv = getelementptr inbounds nuw i8, ptr %i.at, i64 %.reass420 ; 2 uses
  %.reass422 = mul i64 %factor.op.mul421, %indvars.iv448
  %i.lw = getelementptr i8, ptr %i.bb, i64 %.reass422 ; 5 uses
  %i.lx = getelementptr inbounds nuw i8, ptr %i.ls, i64 %i.bg ; 3 uses
  %i.ly = getelementptr inbounds nuw i8, ptr %i.ls, i64 %i.bh ; 3 uses
  %i.lz = getelementptr inbounds nuw i8, ptr %i.ls, i64 %i.bi ; 3 uses
  br i1 %i.bl, label %.lr.ph396, label %.preheader388

.lr.ph396:                                        ; preds = %.noexc231
  %i.ma = mul i64 %i.ct, %indvar461               ; 15 uses
  ...
  %i.mb = mul i64 %i.gi, %indvar461               ; 15 uses
  ...
  %i.md = mul i64 %i.gf, %indvar461
  %scevgep693 = getelementptr i8, ptr %i.le, i64 %i.md
  %i.me = load i32, ptr %4, align 4, !tbaa !45    ; 4 uses
  %i.mf = icmp sgt i32 %i.me, 0
  %i.mg = load i32, ptr %i.bo, align 8, !tbaa !48 ; 4 uses
...
.preheader388:                                    ; preds = %.preheader388.loopexit, %.noexc231
  ...
  %i.ot = icmp slt i32 %.0181.lcssa, %i.bk
  br i1 %i.ot, label %.lr.ph409, label %_ZN4ncnn3MatD2Ev.exit

.lr.ph409:                                        ; preds = %.preheader388
  %i.ou = load i32, ptr %4, align 4, !tbaa !45    ; 4 uses
  %i.ov = icmp sgt i32 %i.ou, 0
  %i.ow = load i32, ptr %i.bo, align 8, !tbaa !48 ; 4 uses
  ...
  %i.pa = add nsw i64 %6, %i.oy
  %i.pb = mul i64 %i.dc, %i.pa
  ...
  %i.pj = add nsw i64 %6, %i.oy
  %i.pk = mul i64 %i.gr, %i.pj
...
bb.c:                                             ; preds = %.lr.ph396, %._crit_edge
  ...
  %i.qb = load float, ptr %i.qa, align 4, !tbaa !63
  store float %i.qb, ptr %.0182394, align 4, !tbaa !63
...
vector.body770:                                   ; preds = %vector.body770, %vector.ph768
  ...
  %wide.load773 = load <16 x float>, ptr %i.sr, align 4, !tbaa !63, !alias.scope !232
  %i.ss = getelementptr inbounds nuw [4 x i8], ptr %i.rc, i64 %index771
  %wide.load774 = load <16 x float>, ptr %i.ss, align 4, !tbaa !63, !alias.scope !233
  %i.st = getelementptr inbounds nuw [4 x i8], ptr %i.rf, i64 %index771
  %wide.load775 = load <16 x float>, ptr %i.st, align 4, !tbaa !63, !alias.scope !234
  %i.su = getelementptr inbounds nuw [4 x i8], ptr %i.ri, i64 %index771
  %wide.load776 = load <16 x float>, ptr %i.su, align 4, !tbaa !63, !alias.scope !235
  %i.sv = getelementptr inbounds nuw [4 x i8], ptr %i.rk, i64 %index771
  %wide.load777 = load <16 x float>, ptr %i.sv, align 4, !tbaa !63, !alias.scope !236
  %i.sw = getelementptr inbounds nuw [4 x i8], ptr %i.rn, i64 %index771
  %wide.load778 = load <16 x float>, ptr %i.sw, align 4, !tbaa !63, !alias.scope !237
  %i.sx = getelementptr inbounds nuw [4 x i8], ptr %i.rq, i64 %index771
  %wide.load779 = load <16 x float>, ptr %i.sx, align 4, !tbaa !63, !alias.scope !238
  %i.sy = getelementptr inbounds nuw [4 x i8], ptr %i.rt, i64 %index771
  %wide.load780 = load <16 x float>, ptr %i.sy, align 4, !tbaa !63, !alias.scope !239
  ...
  store <128 x float> %interleaved.vec781, ptr %next.gep772, align 4, !tbaa !63, !alias.scope !240, !noalias !241
...
vec.epilog.iter.check788:                         ; preds = %middle.block783
  br i1 %min.epilog.iters.check789, label %.lr.ph.preheader, label %vec.epilog.ph790, !prof !242
...
vec.epilog.vector.body792:                        ; preds = %vec.epilog.vector.body792, %vec.epilog.ph790
  ...
  %wide.load795 = load <4 x float>, ptr %i.ti, align 4, !tbaa !63, !alias.scope !232
  %i.tj = getelementptr inbounds nuw [4 x i8], ptr %i.rc, i64 %index793
  %wide.load796 = load <4 x float>, ptr %i.tj, align 4, !tbaa !63, !alias.scope !233
  %i.tk = getelementptr inbounds nuw [4 x i8], ptr %i.rf, i64 %index793
  %wide.load797 = load <4 x float>, ptr %i.tk, align 4, !tbaa !63, !alias.scope !234
  %i.tl = getelementptr inbounds nuw [4 x i8], ptr %i.ri, i64 %index793
  %wide.load798 = load <4 x float>, ptr %i.tl, align 4, !tbaa !63, !alias.scope !235
  %i.tm = getelementptr inbounds nuw [4 x i8], ptr %i.rk, i64 %index793
  %wide.load799 = load <4 x float>, ptr %i.tm, align 4, !tbaa !63, !alias.scope !236
  %i.tn = getelementptr inbounds nuw [4 x i8], ptr %i.rn, i64 %index793
  %wide.load800 = load <4 x float>, ptr %i.tn, align 4, !tbaa !63, !alias.scope !237
  %i.to = getelementptr inbounds nuw [4 x i8], ptr %i.rq, i64 %index793
  %wide.load801 = load <4 x float>, ptr %i.to, align 4, !tbaa !63, !alias.scope !238
  %i.tp = getelementptr inbounds nuw [4 x i8], ptr %i.rt, i64 %index793
  %wide.load802 = load <4 x float>, ptr %i.tp, align 4, !tbaa !63, !alias.scope !239
...
begin_hunk_1_@_ZN4ncnn15LSTM_x86_avx51215create_pipelineERKNS_6OptionE.omp_outlined:bb.a
  %wide.load658 = load <16 x float>, ptr %i.ub, align 4, !tbaa !63, !alias.scope !245
  %i.uc = getelementptr inbounds nuw [4 x i8], ptr %i.sb, i64 %index654
  %wide.load659 = load <16 x float>, ptr %i.uc, align 4, !tbaa !63, !alias.scope !246
  %i.ud = getelementptr inbounds nuw [4 x i8], ptr %i.sd, i64 %index654
  %wide.load660 = load <16 x float>, ptr %i.ud, align 4, !tbaa !63, !alias.scope !247
  %i.ue = getelementptr inbounds nuw [4 x i8], ptr %i.sf, i64 %index654
  %wide.load661 = load <16 x float>, ptr %i.ue, align 4, !tbaa !63, !alias.scope !248
  %i.uf = getelementptr inbounds nuw [4 x i8], ptr %i.sh, i64 %index654
  %wide.load662 = load <16 x float>, ptr %i.uf, align 4, !tbaa !63, !alias.scope !249
  %i.ug = getelementptr inbounds nuw [4 x i8], ptr %i.sj, i64 %index654
  %wide.load663 = load <16 x float>, ptr %i.ug, align 4, !tbaa !63, !alias.scope !250
  ...
  br i1 %i.un, label %middle.block666, label %vector.body653, !llvm.loop !202
...
vec.epilog.vector.body675:                        ; preds = %vec.epilog.vector.body675, %vec.epilog.ph673
  ...
  %wide.load678 = load <4 x float>, ptr %i.uq, align 4, !tbaa !63, !alias.scope !243
  %i.ur = getelementptr inbounds nuw [4 x i8], ptr %i.rx, i64 %index676
  %wide.load679 = load <4 x float>, ptr %i.ur, align 4, !tbaa !63, !alias.scope !244
  %i.us = getelementptr inbounds nuw [4 x i8], ptr %i.rz, i64 %index676
  %wide.load680 = load <4 x float>, ptr %i.us, align 4, !tbaa !63, !alias.scope !245
  %i.ut = getelementptr inbounds nuw [4 x i8], ptr %i.sb, i64 %index676
  %wide.load681 = load <4 x float>, ptr %i.ut, align 4, !tbaa !63, !alias.scope !246
  %i.uu = getelementptr inbounds nuw [4 x i8], ptr %i.sd, i64 %index676
  %wide.load682 = load <4 x float>, ptr %i.uu, align 4, !tbaa !63, !alias.scope !247
  %i.uv = getelementptr inbounds nuw [4 x i8], ptr %i.sf, i64 %index676
  %wide.load683 = load <4 x float>, ptr %i.uv, align 4, !tbaa !63, !alias.scope !248
  %i.uw = getelementptr inbounds nuw [4 x i8], ptr %i.sh, i64 %index676
  %wide.load684 = load <4 x float>, ptr %i.uw, align 4, !tbaa !63, !alias.scope !249
  %i.ux = getelementptr inbounds nuw [4 x i8], ptr %i.sj, i64 %index676
  %wide.load685 = load <4 x float>, ptr %i.ux, align 4, !tbaa !63, !alias.scope !250
  ...
  br i1 %i.ve, label %vec.epilog.middle.block688, label %vec.epilog.vector.body675, !llvm.loop !203
...
._crit_edge:                                      ; preds = %.lr.ph393, %middle.block666, %vec.epilog.middle.block688, %.preheader387
  ...
  br i1 %i.wd, label %bb.c, label %.preheader388.loopexit, !llvm.loop !205
...
vector.body544:                                   ; preds = %vector.body544, %vector.ph542
  ...
  %wide.load547 = load <16 x float>, ptr %i.zh, align 4, !tbaa !63, !alias.scope !253
  %i.zi = getelementptr inbounds nuw [4 x i8], ptr %i.yg, i64 %index545
  %wide.load548 = load <16 x float>, ptr %i.zi, align 4, !tbaa !63, !alias.scope !254
  %i.zj = getelementptr inbounds nuw [4 x i8], ptr %i.yj, i64 %index545
  %wide.load549 = load <16 x float>, ptr %i.zj, align 4, !tbaa !63, !alias.scope !255
  %i.zk = getelementptr inbounds nuw [4 x i8], ptr %i.ym, i64 %index545
  %wide.load550 = load <16 x float>, ptr %i.zk, align 4, !tbaa !63, !alias.scope !256
  ...
  br i1 %i.zn, label %middle.block553, label %vector.body544, !llvm.loop !213
...
vec.epilog.vector.body562:                        ; preds = %vec.epilog.vector.body562, %vec.epilog.ph560
  ...
  %wide.load565 = load <4 x float>, ptr %i.zq, align 4, !tbaa !63, !alias.scope !253
  %i.zr = getelementptr inbounds nuw [4 x i8], ptr %i.yg, i64 %index563
  %wide.load566 = load <4 x float>, ptr %i.zr, align 4, !tbaa !63, !alias.scope !254
  %i.zs = getelementptr inbounds nuw [4 x i8], ptr %i.yj, i64 %index563
  %wide.load567 = load <4 x float>, ptr %i.zs, align 4, !tbaa !63, !alias.scope !255
  %i.zt = getelementptr inbounds nuw [4 x i8], ptr %i.ym, i64 %index563
  %wide.load568 = load <4 x float>, ptr %i.zt, align 4, !tbaa !63, !alias.scope !256
  ...
  br i1 %i.zw, label %vec.epilog.middle.block571, label %vec.epilog.vector.body562, !llvm.loop !214
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x float>, ptr %i.aan, align 4, !tbaa !63, !alias.scope !259
  %i.aao = getelementptr inbounds nuw [4 x i8], ptr %i.yq, i64 %index
  %wide.load489 = load <16 x float>, ptr %i.aao, align 4, !tbaa !63, !alias.scope !260
  %i.aap = getelementptr inbounds nuw [4 x i8], ptr %i.ys, i64 %index
  %wide.load490 = load <16 x float>, ptr %i.aap, align 4, !tbaa !63, !alias.scope !261
  %i.aaq = getelementptr inbounds nuw [4 x i8], ptr %i.yu, i64 %index
  %wide.load491 = load <16 x float>, ptr %i.aaq, align 4, !tbaa !63, !alias.scope !262
  ...
  br i1 %i.aat, label %middle.block, label %vector.body, !llvm.loop !221
...
begin_hunk_2_@_ZN4ncnnL26lstm_transform_weight_int8ERKNS_3MatES2_S2_S2_S2_RS0_S3_S3_iiiiRKNS_6OptionE.omp_outlined:bb.a
  store i8 %i.alu, ptr %i.alv, align 1, !tbaa !76
  %i.alw = getelementptr inbounds nuw i8, ptr %i.hn, i64 %i.aih
  %i.alx = load i8, ptr %i.alw, align 1, !tbaa !76
  %i.aly = getelementptr inbounds nuw i8, ptr %.617252096, i64 31
  store i8 %i.alx, ptr %i.aly, align 1, !tbaa !76
  ...
  %i.amb = load i32, ptr %13, align 4, !tbaa !45  ; 2 uses
  %i.amc = trunc nuw i64 %i.ama to i32
  %i.amd = icmp sgt i32 %i.amb, %i.amc
  br i1 %i.amd, label %.lr.ph2098, label %.preheader2060.loopexit, !llvm.loop !388
...
._crit_edge:                                      ; preds = %.lr.ph2103, %.preheader2060
  ...
  %i.aoj = load <4 x float>, ptr %i.aoi, align 1, !tbaa !76
  ...
  %i.aoo = load <4 x float>, ptr %i.aon, align 1, !tbaa !76
  ...
  %i.aot = load <4 x float>, ptr %i.aos, align 1, !tbaa !76
  %i.aou = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %indvars.iv2262
  %i.aov = load <4 x float>, ptr %i.aou, align 1, !tbaa !76
  ...
  %i.aoy = load <4 x float>, ptr %i.aox, align 1, !tbaa !76
  ...
  %i.apb = load <4 x float>, ptr %i.apa, align 1, !tbaa !76
  ...
  %i.ape = load <4 x float>, ptr %i.apd, align 1, !tbaa !76
...
bb.d:                                             ; preds = %.lr.ph2150, %._crit_edge2147
  ...
  %i.ath = load i32, ptr %12, align 4, !tbaa !45  ; 2 uses
...
.lr.ph2112:                                       ; preds = %bb.d, %.lr.ph2112
  ...
  %i.auo = load i32, ptr %12, align 4, !tbaa !45  ; 2 uses
  %i.aup = sext i32 %i.auo to i64
  %i.auq = icmp slt i64 %i.aun, %i.aup
  br i1 %i.auq, label %.lr.ph2112, label %.preheader2059.loopexit, !llvm.loop !391
