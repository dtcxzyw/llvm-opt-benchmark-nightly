...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.ba = fadd fast <8 x float> %i.an, %i.az
...
.lr.ph124:                                        ; preds = %._crit_edge, %.lr.ph124
  ...
  %i.dh = fadd fast <4 x float> %i.cu, %i.dg
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.bd = fadd fast <8 x float> %i.aq, %i.bc
  %i.be = fadd fast <8 x float> %i.bd, splat (float 1.000000e+00)
...
.lr.ph133:                                        ; preds = %._crit_edge, %.lr.ph133
  ...
  %i.dk = fadd fast <4 x float> %i.cx, %i.dj
