...
.sink.split:                                      ; preds = %bb.e, %.thread
  ...
  store float %.sink100, ptr %i.du, align 4, !tbaa !17
  store float %.sink99, ptr %i.ei, align 4, !tbaa !17
  store float %.sink, ptr %i.eo, align 4, !tbaa !17
  store float 0.000000e+00, ptr %i.es, align 4, !tbaa !17
  br label %bb.f
...
.sink.split101:                                   ; preds = %bb.h, %.thread91
  ...
  store float %.sink104, ptr %i.es, align 4, !tbaa !17
  store float %.sink103, ptr %i.eo, align 4, !tbaa !17
  store float %.sink102, ptr %i.ei, align 4, !tbaa !17
  store float 0.000000e+00, ptr %i.du, align 4, !tbaa !17
  br label %bb.i
...
bb.i:                                             ; preds = %.sink.split101, %bb.g
  ...
  store i32 %.3, ptr %i.fe, align 4, !tbaa !15
...
.lr.ph167:                                        ; preds = %bb.b
  ...
  %i.p = load i32, ptr %6, align 4, !tbaa !15     ; 2 uses
...
.lr.ph167.split:                                  ; preds = %.lr.ph167.split.preheader, %._crit_edge163
  ...
  %i.u = load ptr, ptr %3, align 8, !tbaa !21     ; 2 uses
  %i.v = load i32, ptr %i.l, align 4, !tbaa !27
  %i.w = sext i32 %i.v to i64
  %i.x = mul i64 %indvars.iv187, %i.w
  %i.y = load i64, ptr %i.m, align 8, !tbaa !23
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %i.ck = getelementptr inbounds nuw [2 x i8], ptr %i.by, i64 %9
  %i.cl = load <16 x bfloat>, ptr %i.ck, align 1, !tbaa !32
  ...
  store <16 x bfloat> %i.cr, ptr %i.cs, align 1, !tbaa !32
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 16 ; 3 uses
  %i.ct = or disjoint i64 %indvars.iv.next, 15
  %i.cu = load i32, ptr %8, align 4, !tbaa !15    ; 3 uses
  %i.cv = sext i32 %i.cu to i64
  %i.cw = icmp slt i64 %i.ct, %i.cv
  br i1 %i.cw, label %bb.c, label %.preheader147.loopexit, !llvm.loop !75
...
bb.d:                                             ; preds = %.lr.ph150, %bb.d
  ...
  %i.dp = load <8 x bfloat>, ptr %i.do, align 1, !tbaa !32
  %i.dq = fpext fast <8 x bfloat> %i.dp to <8 x float>
  %i.dr = load <8 x bfloat>, ptr %i.dl, align 1, !tbaa !32
  %i.ds = fpext fast <8 x bfloat> %i.dr to <8 x float>
  %i.dt = getelementptr inbounds [2 x i8], ptr %i.dl, i64 %i.dm
  %i.du = load <8 x bfloat>, ptr %i.dt, align 1, !tbaa !32
  %i.dv = fpext fast <8 x bfloat> %i.du to <8 x float>
  %i.dw = shl nuw nsw i32 %i.dk, 1
  %10 = zext nneg i32 %i.dw to i64
  %i.dx = getelementptr inbounds nuw [2 x i8], ptr %i.dl, i64 %10
  %i.dy = load <8 x bfloat>, ptr %i.dx, align 1, !tbaa !32
  ...
  store <8 x bfloat> %i.ef, ptr %i.ee, align 1, !tbaa !32
  %indvars.iv.next176 = add nuw nsw i64 %indvars.iv175, 8 ; 3 uses
  %i.eg = or disjoint i64 %indvars.iv.next176, 7
  %i.eh = load i32, ptr %8, align 4, !tbaa !15    ; 3 uses
  %i.ei = sext i32 %i.eh to i64
  %i.ej = icmp slt i64 %i.eg, %i.ei
  br i1 %i.ej, label %bb.d, label %.preheader146.loopexit, !llvm.loop !76
...
bb.e:                                             ; preds = %.lr.ph153, %bb.e
  ...
  %11 = zext nneg i32 %i.il to i64
  %i.im = getelementptr inbounds nuw [2 x i8], ptr %i.hr, i64 %11
  %i.in = load i64, ptr %i.im, align 1, !tbaa !32
  ...
  store i64 %i.ja, ptr %i.iz, align 1, !tbaa !32
  %indvars.iv.next179 = add nuw nsw i64 %indvars.iv178, 4 ; 3 uses
  %i.jb = load i32, ptr %8, align 4, !tbaa !15    ; 3 uses
  %i.jc = trunc i64 %indvars.iv.next179 to i32
  %i.jd = or i32 %i.jc, 3
  %i.je = icmp slt i32 %i.jd, %i.jb
  br i1 %i.je, label %bb.e, label %.preheader.loopexit, !llvm.loop !79
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.jh = load i16, ptr %i.jg, align 2, !tbaa !34
  ...
  %i.jn = load i16, ptr %i.jm, align 2, !tbaa !34
  ...
  %i.jt = load i16, ptr %gep, align 2, !tbaa !34
  ...
  %i.jz = load i16, ptr %gep209, align 2, !tbaa !34
  ...
  store i16 %i.kh, ptr %i.ki, align 2, !tbaa !34
  %indvars.iv.next182 = add nuw nsw i64 %indvars.iv181, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next182, %i.ep
  br i1 %exitcond.not, label %._crit_edge, label %vec.epilog.scalar.ph, !llvm.loop !80
...
._crit_edge:                                      ; preds = %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %.preheader.._crit_edge_crit_edge
  ...
  %i.kl = load i32, ptr %6, align 4, !tbaa !15    ; 2 uses
  %i.km = sext i32 %i.kl to i64
  %i.kn = icmp slt i64 %indvars.iv.next185, %i.km
  br i1 %i.kn, label %.lr.ph162, label %._crit_edge163, !llvm.loop !81
...
.noexc40.lr.ph:                                   ; preds = %bb.b
  ...
  %i.r = load i32, ptr %5, align 4, !tbaa !15     ; 3 uses
...
.noexc40:                                         ; preds = %.noexc40.preheader, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.x = load ptr, ptr %3, align 8, !tbaa !21, !noalias !89
  %i.y = load i64, ptr %i.m, align 8, !tbaa !22, !noalias !89
  %i.z = mul i64 %i.y, %indvars.iv93
  %i.aa = load i64, ptr %i.n, align 8, !tbaa !23, !noalias !89 ; 2 uses
  %i.ab = mul i64 %i.z, %i.aa
  %i.ac = getelementptr inbounds nuw i8, ptr %i.x, i64 %i.ab
  %i.ad = load ptr, ptr %4, align 8, !tbaa !21, !noalias !90
  %i.ae = load i64, ptr %i.p, align 8, !tbaa !22, !noalias !90
  %i.af = mul i64 %i.ae, %indvars.iv93
  %i.ag = load i64, ptr %i.q, align 8, !tbaa !23, !noalias !90 ; 2 uses
...
.lr.ph86:                                         ; preds = %.noexc40
  %i.ak = load i32, ptr %i.o, align 4, !tbaa !27, !noalias !90
  %i.al = sext i32 %i.ak to i64
  %i.am = load i32, ptr %i.l, align 4, !tbaa !27, !noalias !89
  %i.an = sext i32 %i.am to i64
  %i.ao = mul i64 %i.aa, %i.an
  %i.ap = mul i64 %i.ag, %i.al
  %i.aq = load i32, ptr %8, align 4, !tbaa !15    ; 2 uses
  %i.ar = icmp sgt i32 %i.aq, 0
  br i1 %i.ar, label %.lr.ph86.split, label %_ZN4ncnn3MatD2Ev.exit

_ZN4ncnn3MatD2Ev.exit.loopexit:                   ; preds = %._crit_edge
  %.pre97 = load i32, ptr %i.b, align 4, !tbaa !15
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %.lr.ph86, %_ZN4ncnn3MatD2Ev.exit.loopexit, %.noexc40
  ...
  br i1 %.not.not, label %.noexc40, label %._crit_edge89, !llvm.loop !86
...
.lr.ph86.split:                                   ; preds = %.lr.ph86, %._crit_edge
  ...
  %i.ba = load float, ptr %6, align 4, !tbaa !17
  %i.bb = fmul fast float %i.ba, %i.az
  %i.bc = fptosi float %i.bb to i32
  %i.bd = load i32, ptr %7, align 4, !tbaa !15
...
.lr.ph.preheader:                                 ; preds = %.lr.ph86.split
  ...
  %.pre = load i32, ptr %11, align 4, !tbaa !15
  br label %.lr.ph

._crit_edge.loopexit:                             ; preds = %.lr.ph
  %.pre96 = load i32, ptr %5, align 4, !tbaa !15
  br label %._crit_edge
