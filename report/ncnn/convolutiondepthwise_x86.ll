...
_ZN4ncnn3Mat7channelEi.exit.lr.ph:                ; preds = %bb.b
  ...
  %i.s = load i32, ptr %6, align 4, !tbaa !72     ; 15 uses
  ...
  %i.y = zext i32 %i.s to i64                     ; 3 uses
  ...
  %n.vec416 = and i64 %i.y, 2147483644            ; 4 uses
  %i.bv = trunc nuw nsw i64 %n.vec416 to i32
  %i.bw = sub nsw i32 %i.s, %i.bv
  %i.bx = shl nuw nsw i64 %n.vec416, 2            ; 6 uses
  %cmp.n459 = icmp eq i64 %n.vec416, %i.y
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge.us
  %.0150218.us = phi i32 [ %i.hc, %._crit_edge.us ], [ 0, %.lr.ph.us.preheader ]
  %.0151217.us = phi ptr [ %i.gz, %._crit_edge.us ], [ %i.cv, %.lr.ph.us.preheader ] ; 7 uses
  %.0153216.us = phi ptr [ %i.gy, %._crit_edge.us ], [ %i.cl, %.lr.ph.us.preheader ] ; 7 uses
  %.0155215.us = phi ptr [ %i.gx, %._crit_edge.us ], [ %i.ck, %.lr.ph.us.preheader ] ; 7 uses
  %.0159214.us = phi ptr [ %i.gw, %._crit_edge.us ], [ %i.cj, %.lr.ph.us.preheader ] ; 7 uses
  %.0163213.us = phi ptr [ %i.hb, %._crit_edge.us ], [ %i.cu, %.lr.ph.us.preheader ] ; 11 uses
  %.0165212.us = phi ptr [ %i.ha, %._crit_edge.us ], [ %i.ce, %.lr.ph.us.preheader ] ; 11 uses
  br i1 %min.iters.check414, label %scalar.ph413.preheader, label %vector.memcheck361

vector.memcheck361:                               ; preds = %.lr.ph.us
  %scevgep362 = getelementptr i8, ptr %.0165212.us, i64 %i.bm ; 6 uses
  %scevgep363 = getelementptr i8, ptr %.0163213.us, i64 %i.bm ; 6 uses
  %scevgep364 = getelementptr i8, ptr %.0151217.us, i64 %i.bn ; 2 uses
  %scevgep365 = getelementptr i8, ptr %.0153216.us, i64 %i.bn ; 2 uses
  %scevgep366 = getelementptr i8, ptr %.0155215.us, i64 %i.bn ; 2 uses
  %scevgep367 = getelementptr i8, ptr %.0159214.us, i64 %i.bn ; 2 uses
  %bound0370 = icmp ult ptr %.0165212.us, %scevgep363
  %bound1371 = icmp ult ptr %.0163213.us, %scevgep362
  %found.conflict372 = and i1 %bound0370, %bound1371
  %bound0373 = icmp ult ptr %.0165212.us, %scevgep364
  %bound1374 = icmp ult ptr %.0151217.us, %scevgep362
  %found.conflict375 = and i1 %bound0373, %bound1374
  %conflict.rdx376 = or i1 %found.conflict372, %found.conflict375
  %bound0377 = icmp ult ptr %.0165212.us, %scevgep365
  %bound1378 = icmp ult ptr %.0153216.us, %scevgep362
  %found.conflict379 = and i1 %bound0377, %bound1378
  %conflict.rdx380 = or i1 %conflict.rdx376, %found.conflict379
  %bound0381 = icmp ult ptr %.0165212.us, %scevgep366
  %bound1382 = icmp ult ptr %.0155215.us, %scevgep362
  %found.conflict383 = and i1 %bound0381, %bound1382
  %conflict.rdx384 = or i1 %conflict.rdx380, %found.conflict383
  %bound0385 = icmp ult ptr %.0165212.us, %scevgep367
  %bound1386 = icmp ult ptr %.0159214.us, %scevgep362
  %found.conflict387 = and i1 %bound0385, %bound1386
  %conflict.rdx388 = or i1 %conflict.rdx384, %found.conflict387
  %bound0389 = icmp ult ptr %.0165212.us, %scevgep369
  ...
  %bound0393 = icmp ult ptr %.0163213.us, %scevgep364
  %bound1394 = icmp ult ptr %.0151217.us, %scevgep363
  %found.conflict395 = and i1 %bound0393, %bound1394
  %conflict.rdx396 = or i1 %conflict.rdx392, %found.conflict395
  %bound0397 = icmp ult ptr %.0163213.us, %scevgep365
  %bound1398 = icmp ult ptr %.0153216.us, %scevgep363
  %found.conflict399 = and i1 %bound0397, %bound1398
  %conflict.rdx400 = or i1 %conflict.rdx396, %found.conflict399
  %bound0401 = icmp ult ptr %.0163213.us, %scevgep366
  %bound1402 = icmp ult ptr %.0155215.us, %scevgep363
  %found.conflict403 = and i1 %bound0401, %bound1402
  %conflict.rdx404 = or i1 %conflict.rdx400, %found.conflict403
  %bound0405 = icmp ult ptr %.0163213.us, %scevgep367
  %bound1406 = icmp ult ptr %.0159214.us, %scevgep363
  %found.conflict407 = and i1 %bound0405, %bound1406
  %conflict.rdx408 = or i1 %conflict.rdx404, %found.conflict407
  %bound0409 = icmp ult ptr %.0163213.us, %scevgep369
...
vector.ph415:                                     ; preds = %vector.memcheck361
  %i.cw = getelementptr i8, ptr %.0151217.us, i64 %i.bx ; 2 uses
  %i.cx = getelementptr i8, ptr %.0153216.us, i64 %i.bx ; 2 uses
  %i.cy = getelementptr i8, ptr %.0155215.us, i64 %i.bx ; 2 uses
  %i.cz = getelementptr i8, ptr %.0159214.us, i64 %i.bx ; 2 uses
  %i.da = getelementptr i8, ptr %.0163213.us, i64 %i.bx ; 2 uses
  %i.db = getelementptr i8, ptr %.0165212.us, i64 %i.bx ; 2 uses
...
vector.body419:                                   ; preds = %vector.body419, %vector.ph415
  ...
  %next.gep421 = getelementptr i8, ptr %.0151217.us, i64 %i.dl ; 3 uses
  %next.gep422 = getelementptr i8, ptr %.0153216.us, i64 %i.dl ; 3 uses
  %next.gep423 = getelementptr i8, ptr %.0155215.us, i64 %i.dl ; 3 uses
  %next.gep424 = getelementptr i8, ptr %.0159214.us, i64 %i.dl ; 3 uses
  %next.gep425 = getelementptr i8, ptr %.0163213.us, i64 %i.dl
  %next.gep426 = getelementptr i8, ptr %.0165212.us, i64 %i.dl
  %wide.load427 = load <4 x float>, ptr %next.gep424, align 4, !tbaa !45, !alias.scope !224
  %i.dm = fmul fast <4 x float> %broadcast.splat429, %wide.load427
  %i.dn = fadd fast <4 x float> %i.dm, %broadcast.splat418
  %i.do = getelementptr inbounds nuw i8, ptr %next.gep424, i64 4
  ...
  %i.dr = getelementptr inbounds nuw i8, ptr %next.gep424, i64 8
  ...
  %wide.load436 = load <4 x float>, ptr %next.gep423, align 4, !tbaa !45, !alias.scope !226 ; 2 uses
  %i.du = fmul fast <4 x float> %broadcast.splat438, %wide.load436
  %i.dv = fadd fast <4 x float> %i.dt, %i.du
  %i.dw = getelementptr inbounds nuw i8, ptr %next.gep423, i64 4
  ...
  %i.dz = getelementptr inbounds nuw i8, ptr %next.gep423, i64 8
  ...
  %wide.load445 = load <4 x float>, ptr %next.gep422, align 4, !tbaa !45, !alias.scope !228 ; 2 uses
  %i.ec = fmul fast <4 x float> %broadcast.splat447, %wide.load445
  %i.ed = fadd fast <4 x float> %i.eb, %i.ec
  %i.ee = getelementptr inbounds nuw i8, ptr %next.gep422, i64 4
  ...
  %i.eh = getelementptr inbounds nuw i8, ptr %next.gep422, i64 8
end_hunk_0
