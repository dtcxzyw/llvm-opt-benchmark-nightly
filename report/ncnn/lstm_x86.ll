...
begin_hunk_0_@_ZNK4ncnn8LSTM_x8612forward_int8ERKSt6vectorINS_3MatESaIS2_EERS4_RKNS_6OptionE:bb.a
bb.nl:                                            ; preds = %bb.nj
  %.not.i357 = icmp eq ptr %i.bbe, null
  br i1 %.not.i357, label %_ZN4ncnn3MatD2Ev.exit115, label %bb.nm

bb.nm:                                            ; preds = %bb.nl
  call void @free(ptr noundef nonnull %i.bbe) #9
...
bb.nn:                                            ; preds = %bb.nk
  ...
  call void @__clang_call_terminate(ptr %i.bbj) #19
  unreachable

_ZN4ncnn3MatD2Ev.exit115:                         ; preds = %bb.ni, %bb.nh, %bb.nk, %bb.nl, %bb.nm
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #9
  %i.bbk = load ptr, ptr %i.h, align 8, !tbaa !11 ; 2 uses
  %.not.i346 = icmp eq ptr %i.bbk, null
  br i1 %.not.i346, label %_ZN4ncnn3MatD2Ev.exit114, label %bb.no

bb.no:                                            ; preds = %_ZN4ncnn3MatD2Ev.exit115
  %i.bbl = atomicrmw add ptr %i.bbk, i32 -1 acq_rel, align 4
  %i.bbm = icmp eq i32 %i.bbl, 1
  br i1 %i.bbm, label %bb.np, label %_ZN4ncnn3MatD2Ev.exit114

bb.np:                                            ; preds = %bb.no
  %i.bbn = load ptr, ptr %i.k, align 16, !tbaa !17 ; 3 uses
  %.not3.i347 = icmp eq ptr %i.bbn, null
  %i.bbo = load ptr, ptr %4, align 16, !tbaa !18  ; 3 uses
  br i1 %.not3.i347, label %bb.nr, label %bb.nq

bb.nq:                                            ; preds = %bb.np
  %i.bbp = load ptr, ptr %i.bbn, align 8, !tbaa !9
  %i.bbq = getelementptr inbounds nuw i8, ptr %i.bbp, i64 24
  %i.bbr = load ptr, ptr %i.bbq, align 8
  invoke void %i.bbr(ptr noundef nonnull align 8 dereferenceable(8) %i.bbn, ptr noundef %i.bbo)
          to label %_ZN4ncnn3MatD2Ev.exit114 unwind label %bb.nt, !inline_history !19

bb.nr:                                            ; preds = %bb.np
  %.not.i355 = icmp eq ptr %i.bbo, null
  br i1 %.not.i355, label %_ZN4ncnn3MatD2Ev.exit114, label %bb.ns

bb.ns:                                            ; preds = %bb.nr
  call void @free(ptr noundef nonnull %i.bbo) #9
  br label %_ZN4ncnn3MatD2Ev.exit114

bb.nt:                                            ; preds = %bb.nq
  %i.bbs = landingpad { ptr, i32 }
          catch ptr null
  %i.bbt = extractvalue { ptr, i32 } %i.bbs, 0
  call void @__clang_call_terminate(ptr %i.bbt) #19
  unreachable
...
_ZNK4ncnn3Mat7channelEi.exit359:                  ; preds = %_ZNK4ncnn3Mat7channelEi.exit359.lr.ph, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.aj = load ptr, ptr %3, align 8, !tbaa !18, !noalias !327
  %i.ak = load i64, ptr %i.m, align 8, !tbaa !20, !noalias !327
  %i.al = mul i64 %i.ak, %indvars.iv559
  %i.am = load i64, ptr %i.n, align 8, !tbaa !53, !noalias !327 ; 2 uses
  %i.an = mul i64 %i.al, %i.am
  %i.ao = getelementptr inbounds nuw i8, ptr %i.aj, i64 %i.an ; 4 uses
  %i.ap = load ptr, ptr %4, align 8, !tbaa !18, !noalias !330
  %i.aq = load i64, ptr %i.p, align 8, !tbaa !20, !noalias !330
  %i.ar = mul i64 %i.aq, %indvars.iv559
  %i.as = load i64, ptr %i.q, align 8, !tbaa !53, !noalias !330 ; 2 uses
  %i.at = mul i64 %i.ar, %i.as
  %i.au = getelementptr inbounds nuw i8, ptr %i.ap, i64 %i.at ; 4 uses
  %i.av = load i32, ptr %i.r, align 4, !tbaa !62, !noalias !333
  %i.aw = load ptr, ptr %5, align 8, !tbaa !18, !noalias !333
  %i.ax = load i64, ptr %i.s, align 8, !tbaa !20, !noalias !333
  %i.ay = mul i64 %i.ax, %indvars.iv559
  %i.az = load i64, ptr %i.t, align 8, !tbaa !53, !noalias !333 ; 2 uses
  ...
  %i.br = load ptr, ptr %8, align 8, !tbaa !18, !noalias !336
  %i.bs = load i64, ptr %i.z, align 8, !tbaa !20, !noalias !336
  %i.bt = mul i64 %i.bs, %indvars.iv559
  %i.bu = load i64, ptr %i.aa, align 8, !tbaa !53, !noalias !336 ; 2 uses
  %i.bv = mul i64 %i.bt, %i.bu
  %i.bw = getelementptr inbounds nuw i8, ptr %i.br, i64 %i.bv
  %i.bx = load ptr, ptr %10, align 8, !tbaa !18, !noalias !339
  %i.by = load i64, ptr %i.ae, align 8, !tbaa !20, !noalias !339
  %i.bz = mul i64 %i.by, %indvars.iv559
  %i.ca = load i64, ptr %i.af, align 8, !tbaa !53, !noalias !339 ; 2 uses
...
.lr.ph518:                                        ; preds = %_ZNK4ncnn3Mat7channelEi.exit359
  %i.ck = load i32, ptr %i.ad, align 4, !tbaa !62, !noalias !339
  %i.cl = sext i32 %i.ck to i64
  %i.cm = load ptr, ptr %9, align 8, !tbaa !18, !noalias !342
  %i.cn = load i64, ptr %i.ab, align 8, !tbaa !20, !noalias !342
  %i.co = mul i64 %i.cn, %indvars.iv559
  %i.cp = load i64, ptr %i.ac, align 8, !tbaa !53, !noalias !342
  %i.cq = mul i64 %i.co, %i.cp
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cm, i64 %i.cq
  %i.cs = load i32, ptr %i.y, align 4, !tbaa !62, !noalias !336
  %i.ct = sext i32 %i.cs to i64
  %i.cu = load i32, ptr %i.o, align 4, !tbaa !62, !noalias !330
  %i.cv = sext i32 %i.cu to i64
  %i.cw = load i32, ptr %i.l, align 4, !tbaa !62, !noalias !327
...
bb.c:                                             ; preds = %.lr.ph518, %._crit_edge
  %indvars.iv556 = phi i64 [ 0, %.lr.ph518 ], [ %indvars.iv.next557, %._crit_edge ] ; 12 uses
  ...
  %i.dr = trunc nuw nsw i64 %indvars.iv556 to i32 ; 6 uses
...
.lr.ph:                                           ; preds = %bb.c, %.lr.ph
  ...
  br i1 %i.fl, label %.lr.ph, label %.preheader480.loopexit, !llvm.loop !345
...
.lr.ph486:                                        ; preds = %.lr.ph486.preheader, %.lr.ph486
  ...
  br i1 %i.hu, label %.lr.ph486, label %.preheader479.loopexit, !llvm.loop !346
