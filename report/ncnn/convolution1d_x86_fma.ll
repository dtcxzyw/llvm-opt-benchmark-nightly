...
bb.z:                                             ; preds = %bb.z, %.lr.ph1408.us.i
  ...
  %5 = shl nuw i32 %i.avt, 16
  %6 = shl nuw i32 %i.avu, 16
  %7 = insertelement <2 x i32> poison, i32 %5, i64 0
  %i.avv = bitcast <2 x i32> %7 to <2 x float>
  %8 = shufflevector <2 x float> %i.avv, <2 x float> poison, <2 x i32> zeroinitializer
