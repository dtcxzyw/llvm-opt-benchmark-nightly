...
vector.body466:                                   ; preds = %vector.body466, %vector.ph462
  ...
  %i.dv = fadd fast <16 x float> %broadcast.splat465, %i.du
  ...
  %i.et = fadd fast <16 x float> %broadcast.splat465, %i.es
...
vec.epilog.vector.body522:                        ; preds = %vec.epilog.vector.body522, %vec.epilog.ph518
  ...
  %i.ge = fadd fast <4 x float> %broadcast.splat521, %i.gd
  ...
  %i.ha = fadd fast <4 x float> %i.gz, %i.gx
  %i.hb = fmul fast <4 x float> %wide.load539, %broadcast.splat532
  %i.hc = fadd fast <4 x float> %broadcast.splat521, %i.hb
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.kt = fadd fast <16 x float> %broadcast.splat, %i.ks
  ...
  %i.lp = fadd fast <16 x float> %i.lo, %i.lm
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.mg = fadd fast <4 x float> %broadcast.splat364, %i.mf
  ...
  %i.nc = fadd fast <4 x float> %i.nb, %i.mz
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.cp = fadd fast <16 x float> %broadcast.splat, %i.co
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.ea = fadd fast <4 x float> %broadcast.splat206, %i.dz
