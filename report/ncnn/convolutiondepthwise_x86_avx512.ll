...
iter.check514:                                    ; preds = %.lr.ph.us.preheader, %._crit_edge.us
  %.0150218.us = phi i32 [ %i.jt, %._crit_edge.us ], [ 0, %.lr.ph.us.preheader ]
  %.0151217.us = phi ptr [ %i.jq, %._crit_edge.us ], [ %i.dd, %.lr.ph.us.preheader ] ; 9 uses
  %.0153216.us = phi ptr [ %i.jp, %._crit_edge.us ], [ %i.ct, %.lr.ph.us.preheader ] ; 9 uses
  %.0155215.us = phi ptr [ %i.jo, %._crit_edge.us ], [ %i.cs, %.lr.ph.us.preheader ] ; 9 uses
  %.0159214.us = phi ptr [ %i.jn, %._crit_edge.us ], [ %i.cr, %.lr.ph.us.preheader ] ; 9 uses
  %.0163213.us = phi ptr [ %i.js, %._crit_edge.us ], [ %i.dc, %.lr.ph.us.preheader ] ; 13 uses
  %.0165212.us = phi ptr [ %i.jr, %._crit_edge.us ], [ %i.cm, %.lr.ph.us.preheader ] ; 13 uses
...
vector.memcheck407:                               ; preds = %iter.check514
  %scevgep408 = getelementptr i8, ptr %.0165212.us, i64 %i.bn ; 6 uses
  %scevgep409 = getelementptr i8, ptr %.0163213.us, i64 %i.bn ; 6 uses
  %scevgep410 = getelementptr i8, ptr %.0151217.us, i64 %i.bo ; 2 uses
  %scevgep411 = getelementptr i8, ptr %.0153216.us, i64 %i.bo ; 2 uses
  %scevgep412 = getelementptr i8, ptr %.0155215.us, i64 %i.bo ; 2 uses
  %scevgep413 = getelementptr i8, ptr %.0159214.us, i64 %i.bo ; 2 uses
  %bound0416 = icmp ult ptr %.0165212.us, %scevgep409
  %bound1417 = icmp ult ptr %.0163213.us, %scevgep408
  %found.conflict418 = and i1 %bound0416, %bound1417
  %bound0419 = icmp ult ptr %.0165212.us, %scevgep410
  %bound1420 = icmp ult ptr %.0151217.us, %scevgep408
  %found.conflict421 = and i1 %bound0419, %bound1420
  %conflict.rdx422 = or i1 %found.conflict418, %found.conflict421
  %bound0423 = icmp ult ptr %.0165212.us, %scevgep411
  %bound1424 = icmp ult ptr %.0153216.us, %scevgep408
  %found.conflict425 = and i1 %bound0423, %bound1424
  %conflict.rdx426 = or i1 %conflict.rdx422, %found.conflict425
  %bound0427 = icmp ult ptr %.0165212.us, %scevgep412
  %bound1428 = icmp ult ptr %.0155215.us, %scevgep408
  %found.conflict429 = and i1 %bound0427, %bound1428
  %conflict.rdx430 = or i1 %conflict.rdx426, %found.conflict429
  %bound0431 = icmp ult ptr %.0165212.us, %scevgep413
  %bound1432 = icmp ult ptr %.0159214.us, %scevgep408
  %found.conflict433 = and i1 %bound0431, %bound1432
  %conflict.rdx434 = or i1 %conflict.rdx430, %found.conflict433
  %bound0435 = icmp ult ptr %.0165212.us, %scevgep415
  ...
  %bound0439 = icmp ult ptr %.0163213.us, %scevgep410
  %bound1440 = icmp ult ptr %.0151217.us, %scevgep409
  %found.conflict441 = and i1 %bound0439, %bound1440
  %conflict.rdx442 = or i1 %conflict.rdx438, %found.conflict441
  %bound0443 = icmp ult ptr %.0163213.us, %scevgep411
  %bound1444 = icmp ult ptr %.0153216.us, %scevgep409
  %found.conflict445 = and i1 %bound0443, %bound1444
  %conflict.rdx446 = or i1 %conflict.rdx442, %found.conflict445
  %bound0447 = icmp ult ptr %.0163213.us, %scevgep412
  %bound1448 = icmp ult ptr %.0155215.us, %scevgep409
  %found.conflict449 = and i1 %bound0447, %bound1448
  %conflict.rdx450 = or i1 %conflict.rdx446, %found.conflict449
  %bound0451 = icmp ult ptr %.0163213.us, %scevgep413
  %bound1452 = icmp ult ptr %.0159214.us, %scevgep409
  %found.conflict453 = and i1 %bound0451, %bound1452
  %conflict.rdx454 = or i1 %conflict.rdx450, %found.conflict453
  %bound0455 = icmp ult ptr %.0163213.us, %scevgep415
...
vector.ph462:                                     ; preds = %vector.main.loop.iter.check460
  %i.de = getelementptr i8, ptr %.0151217.us, i64 %i.bz ; 2 uses
  %i.df = getelementptr i8, ptr %.0153216.us, i64 %i.bz ; 2 uses
  %i.dg = getelementptr i8, ptr %.0155215.us, i64 %i.bz ; 2 uses
  %i.dh = getelementptr i8, ptr %.0159214.us, i64 %i.bz ; 2 uses
  %i.di = getelementptr i8, ptr %.0163213.us, i64 %i.bz ; 2 uses
  %i.dj = getelementptr i8, ptr %.0165212.us, i64 %i.bz ; 2 uses
