...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.bm = fadd fast <4 x float> %i.az, splat (float 1.000000e+00)
  %i.bn = fadd fast <4 x float> %i.bm, %i.bl
  ...
  %i.da = fmul fast <4 x float> %i.cz, %i.ci
  %reass.mul.a = fmul fast <4 x float> %i.ch, splat (float f0x3F317218)
  %reass.add142 = fadd fast <4 x float> %i.da, splat (float -5.000000e-01)
  %reass.mul143 = fmul fast <4 x float> %i.cj, %reass.add142
  %i.db = fadd fast <4 x float> %reass.mul.a, %i.ci
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.bw = fadd fast <4 x float> %i.bj, splat (float 1.000000e+00)
  ...
  %reass.add145 = fadd fast <4 x float> %i.dk, splat (float -5.000000e-01)
  %reass.mul146 = fmul fast <4 x float> %i.ct, %reass.add145
  ...
  %i.el = fadd fast <4 x float> %i.dy, splat (float 1.000000e+00)
  %i.em = fadd fast <4 x float> %i.el, %i.ek
