...
_ZN4ncnn3MatD2Ev.exit122.preheader:               ; preds = %_ZN4ncnn3MatD2Ev.exit122.lr.ph.split
  ...
  %i.gd = load ptr, ptr %1, align 8, !tbaa !24, !noalias !299 ; 2 uses
  ...
  %4 = shl nuw nsw i64 %i.gg, 3
  %5 = mul i64 %.pre, %.pre270
  ...
  %i.gl = getelementptr i8, ptr %i.gd, i64 %4
...
iter.check377:                                    ; preds = %_ZN4ncnn3MatD2Ev.exit122.preheader, %._crit_edge
  ...
  %i.gs = getelementptr i8, ptr %i.gd, i64 %.reass ; 6 uses
...
vector.memcheck342:                               ; preds = %iter.check377
  %i.gt = mul i64 %5, %indvars.iv
  %scevgep345 = getelementptr i8, ptr %i.gm, i64 %i.gt
  ...
  %bound0350 = icmp ult ptr %.0255, %scevgep345
  %bound1351 = icmp ult ptr %i.gs, %scevgep343
