...
._crit_edge1444.us.i:                             ; preds = %scalar.ph1063.prol.loopexit, %scalar.ph1063, %middle.block1078
  %.lcssa632 = phi ptr [ %i.cnn, %middle.block1078 ], [ %.lcssa1247.unr, %scalar.ph1063.prol.loopexit ], [ %i.cpd, %scalar.ph1063 ] ; 2 uses
...
iter.check:                                       ; preds = %.preheader.i.preheader, %._crit_edge1457.i
  ...
  %or.cond1234 = select i1 %min.iters.check1025, i1 true, i1 %diff.check
  br i1 %or.cond1234, label %vec.epilog.scalar.ph.preheader, label %vector.main.loop.iter.check
...
vec.epilog.scalar.ph.preheader:                   ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  br i1 %lcmp.mod1322.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  %prol.iter1323 = phi i64 [ %prol.iter1323.next, %vec.epilog.scalar.ph.prol ], [ 0, %vec.epilog.scalar.ph.preheader ]
  ...
  br i1 %prol.iter1323.cmp.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol, !llvm.loop !282

vec.epilog.scalar.ph.prol.loopexit:               ; preds = %vec.epilog.scalar.ph.prol, %vec.epilog.scalar.ph.preheader
  %.lcssa1250.unr = phi ptr [ poison, %vec.epilog.scalar.ph.preheader ], [ %i.cqa, %vec.epilog.scalar.ph.prol ]
...
._crit_edge1457.i:                                ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block1037
  %.lcssa635 = phi ptr [ %i.cpu, %vec.epilog.middle.block ], [ %i.cpk, %middle.block1037 ], [ %.lcssa1250.unr, %vec.epilog.scalar.ph.prol.loopexit ], [ %i.cri, %vec.epilog.scalar.ph ]
...
begin_hunk_2_@_ZN4ncnnL37conv3x3s1_winograd63_transform_kernelERKNS_3MatERS0_iiRKNS_6OptionE.omp_outlined:bb.a
  %i.asb = getelementptr inbounds nuw [4 x i8], ptr %i.ary, i64 %i.anl
  %i.asc = load float, ptr %i.asb, align 4, !tbaa !39
  %i.asd = getelementptr inbounds nuw i8, ptr %.528.us.i, i64 28
  store float %i.asc, ptr %i.asd, align 4, !tbaa !39
  %i.ase = getelementptr inbounds nuw i8, ptr %.010129.us.i, i64 1024 ; 2 uses
  %i.asf = getelementptr inbounds nuw i8, ptr %.528.us.i, i64 32 ; 3 uses
  %niter216.next.3 = add i32 %niter216, 4         ; 2 uses
  %niter216.ncmp.3 = icmp eq i32 %niter216.next.3, %unroll_iter215
  br i1 %niter216.ncmp.3, label %._crit_edge.us39.i.unr-lcssa, label %.lr.ph.us38.i.new, !llvm.loop !652

._crit_edge.us39.i.unr-lcssa:                     ; preds = %.lr.ph.us38.i.new
  br i1 %lcmp.mod212.not, label %._crit_edge.us39.i, label %.epil.preheader209

.epil.preheader209:                               ; preds = %._crit_edge.us39.i.unr-lcssa, %.lr.ph.us38.i
  %.010129.us.i.epil.init = phi ptr [ %gep.us37.i, %.lr.ph.us38.i ], [ %i.ase, %._crit_edge.us39.i.unr-lcssa ]
  %.528.us.i.epil.init = phi ptr [ %.431.us.i, %.lr.ph.us38.i ], [ %i.asf, %._crit_edge.us39.i.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod214)
  br label %bb.g

bb.g:                                             ; preds = %bb.g, %.epil.preheader209
  %.010129.us.i.epil = phi ptr [ %.010129.us.i.epil.init, %.epil.preheader209 ], [ %i.ask, %bb.g ] ; 3 uses
  %.528.us.i.epil = phi ptr [ %.528.us.i.epil.init, %.epil.preheader209 ], [ %i.asl, %bb.g ] ; 3 uses
  %epil.iter = phi i32 [ 0, %.epil.preheader209 ], [ %epil.iter.next, %bb.g ]
  %i.asg = load float, ptr %.010129.us.i.epil, align 4, !tbaa !39
  store float %i.asg, ptr %.528.us.i.epil, align 4, !tbaa !39
  %i.ash = getelementptr inbounds nuw [4 x i8], ptr %.010129.us.i.epil, i64 %i.anl
  %i.asi = load float, ptr %i.ash, align 4, !tbaa !39
  %i.asj = getelementptr inbounds nuw i8, ptr %.528.us.i.epil, i64 4
  store float %i.asi, ptr %i.asj, align 4, !tbaa !39
  %i.ask = getelementptr inbounds nuw i8, ptr %.010129.us.i.epil, i64 256
  %i.asl = getelementptr inbounds nuw i8, ptr %.528.us.i.epil, i64 8 ; 2 uses
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter211
...
._crit_edge.us39.i:                               ; preds = %bb.g, %._crit_edge.us39.i.unr-lcssa
  %.lcssa204 = phi ptr [ %i.asf, %._crit_edge.us39.i.unr-lcssa ], [ %i.asl, %bb.g ] ; 2 uses
  %indvars.iv.next72.i = add nuw nsw i64 %indvars.iv71.i, 2 ; 3 uses
  %i.asm = icmp slt i64 %indvars.iv.next72.i, %invariant.op106.i
  br i1 %i.asm, label %.lr.ph.us38.i, label %.preheader.loopexit.i, !llvm.loop !654

.preheader.loopexit.i:                            ; preds = %._crit_edge.us39.i
  %i.asn = trunc nsw i64 %indvars.iv.next72.i to i32
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.loopexit.i, %.preheader1.i
  %.4.lcssa.i = phi ptr [ %.2109.lcssa.i, %.preheader1.i ], [ %.lcssa204, %.preheader.loopexit.i ]
  %.2.lcssa.i = phi i32 [ %.1.lcssa.i, %.preheader1.i ], [ %i.asn, %.preheader.loopexit.i ] ; 2 uses
  %i.aso = icmp slt i32 %.2.lcssa.i, %.sroa.speculated82
  br i1 %i.aso, label %.lr.ph48.i, label %._crit_edge49.split.i

.lr.ph48.i:                                       ; preds = %.preheader.i
  %invariant.gep50.i = getelementptr [4 x i8], ptr %i.ac, i64 %indvars.iv79.i
  br i1 %i.ank, label %.lr.ph.preheader.i, label %._crit_edge49.split.i

.lr.ph.preheader.i:                               ; preds = %.lr.ph48.i
  %i.asp = sext i32 %.2.lcssa.i to i64            ; 2 uses
  %i.asq = mul i64 %i.anz, %i.asp
  %scevgep145 = getelementptr i8, ptr %scevgep144, i64 %i.asq
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %._crit_edge.i53, %.lr.ph.preheader.i
  %indvars.iv75.i = phi i64 [ %i.asp, %.lr.ph.preheader.i ], [ %indvars.iv.next76.i, %._crit_edge.i53 ] ; 2 uses
  %.646.i = phi ptr [ %.4.lcssa.i, %.lr.ph.preheader.i ], [ %.lcssa142, %._crit_edge.i53 ] ; 6 uses
  %i.asr = mul nsw i64 %indvars.iv75.i, %i.anl
  %gep.i = getelementptr [4 x i8], ptr %invariant.gep50.i, i64 %i.asr ; 11 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.i
  %scevgep = getelementptr i8, ptr %.646.i, i64 4
  %scevgep143 = getelementptr i8, ptr %scevgep, i64 %i.cj
  %bound0 = icmp ult ptr %.646.i, %scevgep146
  %bound1 = icmp ult ptr %scevgep145, %scevgep143
  %found.conflict = and i1 %bound0, %bound1
  %i.ass = or i1 %found.conflict, %stride.check
  br i1 %i.ass, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %i.ast = getelementptr i8, ptr %gep.i, i64 %i.aog
  %i.asu = getelementptr i8, ptr %.646.i, i64 %i.aoh ; 2 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %i.asv = shl i64 %index, 8                      ; 8 uses
  %next.gep = getelementptr i8, ptr %gep.i, i64 %i.asv
  %i.asw = getelementptr i8, ptr %gep.i, i64 %i.asv
  %next.gep147 = getelementptr i8, ptr %i.asw, i64 256
  %i.asx = getelementptr i8, ptr %gep.i, i64 %i.asv
  %next.gep148 = getelementptr i8, ptr %i.asx, i64 512
  %i.asy = getelementptr i8, ptr %gep.i, i64 %i.asv
  %next.gep149 = getelementptr i8, ptr %i.asy, i64 768
  %i.asz = getelementptr i8, ptr %gep.i, i64 %i.asv
  %next.gep150 = getelementptr i8, ptr %i.asz, i64 1024
  %i.ata = getelementptr i8, ptr %gep.i, i64 %i.asv
  %next.gep151 = getelementptr i8, ptr %i.ata, i64 1280
  %i.atb = getelementptr i8, ptr %gep.i, i64 %i.asv
  %next.gep152 = getelementptr i8, ptr %i.atb, i64 1536
  %i.atc = getelementptr i8, ptr %gep.i, i64 %i.asv
  %next.gep153 = getelementptr i8, ptr %i.atc, i64 1792
  %i.atd = shl i64 %index, 2
  %next.gep154 = getelementptr i8, ptr %.646.i, i64 %i.atd
  %i.ate = load float, ptr %next.gep, align 4, !tbaa !39, !alias.scope !655
  %i.atf = load float, ptr %next.gep147, align 4, !tbaa !39, !alias.scope !655
  %i.atg = load float, ptr %next.gep148, align 4, !tbaa !39, !alias.scope !655
  %i.ath = load float, ptr %next.gep149, align 4, !tbaa !39, !alias.scope !655
  %i.ati = load float, ptr %next.gep150, align 4, !tbaa !39, !alias.scope !655
  %i.atj = load float, ptr %next.gep151, align 4, !tbaa !39, !alias.scope !655
  %i.atk = load float, ptr %next.gep152, align 4, !tbaa !39, !alias.scope !655
  %i.atl = load float, ptr %next.gep153, align 4, !tbaa !39, !alias.scope !655
  %i.atm = insertelement <8 x float> poison, float %i.ate, i64 0
  %i.atn = insertelement <8 x float> %i.atm, float %i.atf, i64 1
  %i.ato = insertelement <8 x float> %i.atn, float %i.atg, i64 2
  %i.atp = insertelement <8 x float> %i.ato, float %i.ath, i64 3
  %i.atq = insertelement <8 x float> %i.atp, float %i.ati, i64 4
  %i.atr = insertelement <8 x float> %i.atq, float %i.atj, i64 5
  %i.ats = insertelement <8 x float> %i.atr, float %i.atk, i64 6
  %i.att = insertelement <8 x float> %i.ats, float %i.atl, i64 7
  store <8 x float> %i.att, ptr %next.gep154, align 4, !tbaa !39, !alias.scope !658, !noalias !655
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.atu = icmp eq i64 %index.next, %n.vec
  br i1 %i.atu, label %middle.block, label %vector.body, !llvm.loop !660

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge.i53, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph.i, %middle.block
  %.045.i.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %.lr.ph.i ], [ %i.aof, %middle.block ] ; 4 uses
  %.09944.i.ph = phi ptr [ %gep.i, %vector.memcheck ], [ %gep.i, %.lr.ph.i ], [ %i.ast, %middle.block ] ; 2 uses
  %.743.i.ph = phi ptr [ %.646.i, %vector.memcheck ], [ %.646.i, %.lr.ph.i ], [ %i.asu, %middle.block ] ; 2 uses
  %i.atv = sub i32 %smin217, %.045.i.ph
  %xtraiter218 = and i32 %i.atv, 7                ; 2 uses
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  %.045.i.prol = phi i32 [ %i.atz, %scalar.ph.prol ], [ %.045.i.ph, %scalar.ph.preheader ]
  %.09944.i.prol = phi ptr [ %i.atx, %scalar.ph.prol ], [ %.09944.i.ph, %scalar.ph.preheader ] ; 2 uses
  %.743.i.prol = phi ptr [ %i.aty, %scalar.ph.prol ], [ %.743.i.ph, %scalar.ph.preheader ] ; 2 uses
  %prol.iter = phi i32 [ %prol.iter.next, %scalar.ph.prol ], [ 0, %scalar.ph.preheader ]
  %i.atw = load float, ptr %.09944.i.prol, align 4, !tbaa !39
  store float %i.atw, ptr %.743.i.prol, align 4, !tbaa !39
  %i.atx = getelementptr inbounds nuw i8, ptr %.09944.i.prol, i64 256 ; 2 uses
  %i.aty = getelementptr inbounds nuw i8, ptr %.743.i.prol, i64 4 ; 3 uses
  %i.atz = add nuw nsw i32 %.045.i.prol, 1        ; 2 uses
...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  %.lcssa205.unr = phi ptr [ poison, %scalar.ph.preheader ], [ %i.aty, %scalar.ph.prol ]
  %.045.i.unr = phi i32 [ %.045.i.ph, %scalar.ph.preheader ], [ %i.atz, %scalar.ph.prol ]
  %.09944.i.unr = phi ptr [ %.09944.i.ph, %scalar.ph.preheader ], [ %i.atx, %scalar.ph.prol ]
  %.743.i.unr = phi ptr [ %.743.i.ph, %scalar.ph.preheader ], [ %i.aty, %scalar.ph.prol ]
  %i.aua = sub i32 %.045.i.ph, %smin217
  %i.aub = icmp ugt i32 %i.aua, -8
  br i1 %i.aub, label %._crit_edge.i53, label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  %.045.i = phi i32 [ %i.ava, %scalar.ph ], [ %.045.i.unr, %scalar.ph.prol.loopexit ]
  %.09944.i = phi ptr [ %i.auy, %scalar.ph ], [ %.09944.i.unr, %scalar.ph.prol.loopexit ] ; 9 uses
  %.743.i = phi ptr [ %i.auz, %scalar.ph ], [ %.743.i.unr, %scalar.ph.prol.loopexit ] ; 9 uses
  %i.auc = load float, ptr %.09944.i, align 4, !tbaa !39
  store float %i.auc, ptr %.743.i, align 4, !tbaa !39
  %i.aud = getelementptr inbounds nuw i8, ptr %.09944.i, i64 256
  %i.aue = getelementptr inbounds nuw i8, ptr %.743.i, i64 4
  %i.auf = load float, ptr %i.aud, align 4, !tbaa !39
  store float %i.auf, ptr %i.aue, align 4, !tbaa !39
  %i.aug = getelementptr inbounds nuw i8, ptr %.09944.i, i64 512
  %i.auh = getelementptr inbounds nuw i8, ptr %.743.i, i64 8
  %i.aui = load float, ptr %i.aug, align 4, !tbaa !39
  store float %i.aui, ptr %i.auh, align 4, !tbaa !39
  %i.auj = getelementptr inbounds nuw i8, ptr %.09944.i, i64 768
  %i.auk = getelementptr inbounds nuw i8, ptr %.743.i, i64 12
  %i.aul = load float, ptr %i.auj, align 4, !tbaa !39
  store float %i.aul, ptr %i.auk, align 4, !tbaa !39
  %i.aum = getelementptr inbounds nuw i8, ptr %.09944.i, i64 1024
  %i.aun = getelementptr inbounds nuw i8, ptr %.743.i, i64 16
  %i.auo = load float, ptr %i.aum, align 4, !tbaa !39
  store float %i.auo, ptr %i.aun, align 4, !tbaa !39
  %i.aup = getelementptr inbounds nuw i8, ptr %.09944.i, i64 1280
  %i.auq = getelementptr inbounds nuw i8, ptr %.743.i, i64 20
  %i.aur = load float, ptr %i.aup, align 4, !tbaa !39
  store float %i.aur, ptr %i.auq, align 4, !tbaa !39
  %i.aus = getelementptr inbounds nuw i8, ptr %.09944.i, i64 1536
  %i.aut = getelementptr inbounds nuw i8, ptr %.743.i, i64 24
  %i.auu = load float, ptr %i.aus, align 4, !tbaa !39
  store float %i.auu, ptr %i.aut, align 4, !tbaa !39
  %i.auv = getelementptr inbounds nuw i8, ptr %.09944.i, i64 1792
  %i.auw = getelementptr inbounds nuw i8, ptr %.743.i, i64 28
  %i.aux = load float, ptr %i.auv, align 4, !tbaa !39
  store float %i.aux, ptr %i.auw, align 4, !tbaa !39
  %i.auy = getelementptr inbounds nuw i8, ptr %.09944.i, i64 2048
  %i.auz = getelementptr inbounds nuw i8, ptr %.743.i, i64 32 ; 2 uses
  %i.ava = add nuw nsw i32 %.045.i, 8             ; 2 uses
  %exitcond74.not.i.7 = icmp eq i32 %i.ava, %.sroa.speculated
...
._crit_edge.i53:                                  ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %.lcssa142 = phi ptr [ %i.asu, %middle.block ], [ %.lcssa205.unr, %scalar.ph.prol.loopexit ], [ %i.auz, %scalar.ph ]
...
_ZN4ncnn3MatD2Ev.exit34:                          ; preds = %._crit_edge49.split.i
  ...
  %i.avb = icmp slt i64 %indvars.iv.next, %i.be
  %indvar.next = add i32 %indvar, 1
  %indvar.next161 = add i64 %indvar160, 1
  br i1 %i.avb, label %bb.d, label %_ZN4ncnn3MatD2Ev.exit, !llvm.loop !665
...
bb.i:                                             ; preds = %bb.c
  ...
  %i.avd = extractvalue { ptr, i32 } %i.avc, 0
  call void @__clang_call_terminate(ptr %i.avd) #32
  unreachable
}
...
bb.c:                                             ; preds = %.lr.ph135, %_ZN4ncnn3MatD2Ev.exit
  %indvar171 = phi i32 [ 0, %.lr.ph135 ], [ %indvar.next172, %_ZN4ncnn3MatD2Ev.exit ] ; 2 uses
  %.033134 = phi i32 [ %i.k, %.lr.ph135 ], [ %i.bn, %_ZN4ncnn3MatD2Ev.exit ] ; 3 uses
  %i.r = add i32 %i.k, %indvar171
  %i.s = mul i32 %i.r, 9
...
_ZN4ncnn3Mat7channelEi.exit49:                    ; preds = %bb.c
  %i.w = load ptr, ptr %4, align 8, !tbaa !18, !noalias !668 ; 3 uses
  ...
  %i.ac = getelementptr inbounds nuw i8, ptr %i.w, i64 %i.ab ; 5 uses
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %_ZN4ncnn3MatD2Ev.exit34, %_ZN4ncnn3Mat7channelEi.exit49
  %i.bn = add i32 %.033134, 1
  %i.bo = load i32, ptr %i.b, align 4, !tbaa !67
  %.not.not = icmp slt i32 %.033134, %i.bo
  %indvar.next172 = add i32 %indvar171, 1
  br i1 %.not.not, label %bb.c, label %._crit_edge

bb.d:                                             ; preds = %.lr.ph, %_ZN4ncnn3MatD2Ev.exit34
  %indvar168 = phi i64 [ 0, %.lr.ph ], [ %indvar.next169, %_ZN4ncnn3MatD2Ev.exit34 ] ; 5 uses
  ...
  %i.bw = trunc i64 %indvar168 to i32
  ...
  %smin166 = call i32 @llvm.smin.i32(i32 %i.ai, i32 %i.ca)
  %i.cb = zext i32 %smin166 to i64                ; 2 uses
  %i.cc = mul nuw nsw i64 %i.cb, 144
  %i.cd = mul i64 %i.bh, %indvar168               ; 2 uses
...
begin_hunk_3_@_ZN4ncnnL37conv3x3s1_winograd43_transform_kernelERKNS_3MatERS0_iiRKNS_6OptionE.omp_outlined:bb.a
  %i.aek = getelementptr inbounds nuw [4 x i8], ptr %i.aeh, i64 %i.zu
  %i.ael = load float, ptr %i.aek, align 4, !tbaa !39
  %i.aem = getelementptr inbounds nuw i8, ptr %.528.us.i, i64 28
  store float %i.ael, ptr %i.aem, align 4, !tbaa !39
  %i.aen = getelementptr inbounds nuw i8, ptr %.010129.us.i, i64 576 ; 2 uses
  %i.aeo = getelementptr inbounds nuw i8, ptr %.528.us.i, i64 32 ; 3 uses
  %niter209.next.3 = add i32 %niter209, 4         ; 2 uses
  %niter209.ncmp.3 = icmp eq i32 %niter209.next.3, %unroll_iter208
  br i1 %niter209.ncmp.3, label %._crit_edge.us39.i.unr-lcssa, label %.lr.ph.us38.i.new, !llvm.loop !652

._crit_edge.us39.i.unr-lcssa:                     ; preds = %.lr.ph.us38.i.new
  br i1 %lcmp.mod205.not, label %._crit_edge.us39.i, label %.epil.preheader202

.epil.preheader202:                               ; preds = %._crit_edge.us39.i.unr-lcssa, %.lr.ph.us38.i
  %.010129.us.i.epil.init = phi ptr [ %gep.us37.i, %.lr.ph.us38.i ], [ %i.aen, %._crit_edge.us39.i.unr-lcssa ]
  %.528.us.i.epil.init = phi ptr [ %.431.us.i, %.lr.ph.us38.i ], [ %i.aeo, %._crit_edge.us39.i.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod207)
  br label %bb.g

bb.g:                                             ; preds = %bb.g, %.epil.preheader202
  %.010129.us.i.epil = phi ptr [ %.010129.us.i.epil.init, %.epil.preheader202 ], [ %i.aet, %bb.g ] ; 3 uses
  %.528.us.i.epil = phi ptr [ %.528.us.i.epil.init, %.epil.preheader202 ], [ %i.aeu, %bb.g ] ; 3 uses
  %epil.iter = phi i32 [ 0, %.epil.preheader202 ], [ %epil.iter.next, %bb.g ]
  %i.aep = load float, ptr %.010129.us.i.epil, align 4, !tbaa !39
  store float %i.aep, ptr %.528.us.i.epil, align 4, !tbaa !39
  %i.aeq = getelementptr inbounds nuw [4 x i8], ptr %.010129.us.i.epil, i64 %i.zu
  %i.aer = load float, ptr %i.aeq, align 4, !tbaa !39
  %i.aes = getelementptr inbounds nuw i8, ptr %.528.us.i.epil, i64 4
  store float %i.aer, ptr %i.aes, align 4, !tbaa !39
  %i.aet = getelementptr inbounds nuw i8, ptr %.010129.us.i.epil, i64 144
  %i.aeu = getelementptr inbounds nuw i8, ptr %.528.us.i.epil, i64 8 ; 2 uses
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
...
._crit_edge.us39.i:                               ; preds = %bb.g, %._crit_edge.us39.i.unr-lcssa
  %.lcssa197 = phi ptr [ %i.aeo, %._crit_edge.us39.i.unr-lcssa ], [ %i.aeu, %bb.g ] ; 2 uses
  %indvars.iv.next72.i = add nuw nsw i64 %indvars.iv71.i, 2 ; 3 uses
  %i.aev = icmp slt i64 %indvars.iv.next72.i, %invariant.op106.i
  br i1 %i.aev, label %.lr.ph.us38.i, label %.preheader.loopexit.i, !llvm.loop !654

.preheader.loopexit.i:                            ; preds = %._crit_edge.us39.i
  %i.aew = trunc nsw i64 %indvars.iv.next72.i to i32
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.loopexit.i, %.preheader1.i
  %.4.lcssa.i = phi ptr [ %.2109.lcssa.i, %.preheader1.i ], [ %.lcssa197, %.preheader.loopexit.i ]
  %.2.lcssa.i = phi i32 [ %.1.lcssa.i, %.preheader1.i ], [ %i.aew, %.preheader.loopexit.i ] ; 2 uses
  %i.aex = icmp slt i32 %.2.lcssa.i, %.sroa.speculated82
  br i1 %i.aex, label %.lr.ph48.i, label %._crit_edge49.split.i

.lr.ph48.i:                                       ; preds = %.preheader.i
  %invariant.gep50.i = getelementptr [4 x i8], ptr %i.ac, i64 %indvars.iv79.i
  br i1 %i.zt, label %.lr.ph.preheader.i, label %._crit_edge49.split.i

.lr.ph.preheader.i:                               ; preds = %.lr.ph48.i
  %i.aey = sext i32 %.2.lcssa.i to i64            ; 2 uses
  %i.aez = mul i64 %i.aai, %i.aey
  %scevgep153 = getelementptr i8, ptr %scevgep152, i64 %i.aez
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %._crit_edge.i53, %.lr.ph.preheader.i
  %indvars.iv75.i = phi i64 [ %i.aey, %.lr.ph.preheader.i ], [ %indvars.iv.next76.i, %._crit_edge.i53 ] ; 2 uses
  %.646.i = phi ptr [ %.4.lcssa.i, %.lr.ph.preheader.i ], [ %.lcssa150, %._crit_edge.i53 ] ; 6 uses
  %i.afa = mul nsw i64 %indvars.iv75.i, %i.zu
  %gep.i = getelementptr [4 x i8], ptr %invariant.gep50.i, i64 %i.afa ; 11 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.i
  %scevgep = getelementptr i8, ptr %.646.i, i64 4
  %scevgep151 = getelementptr i8, ptr %scevgep, i64 %i.cj
  %bound0 = icmp ult ptr %.646.i, %scevgep154
  %bound1 = icmp ult ptr %scevgep153, %scevgep151
  %found.conflict = and i1 %bound0, %bound1
  %i.afb = or i1 %found.conflict, %stride.check
  br i1 %i.afb, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %i.afc = getelementptr i8, ptr %gep.i, i64 %i.aap
  %i.afd = getelementptr i8, ptr %.646.i, i64 %i.aaq ; 2 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %i.afe = mul i64 %index, 144                    ; 8 uses
  %next.gep = getelementptr i8, ptr %gep.i, i64 %i.afe
  %i.aff = getelementptr i8, ptr %gep.i, i64 %i.afe
  %next.gep155 = getelementptr i8, ptr %i.aff, i64 144
  %i.afg = getelementptr i8, ptr %gep.i, i64 %i.afe
  %next.gep156 = getelementptr i8, ptr %i.afg, i64 288
  %i.afh = getelementptr i8, ptr %gep.i, i64 %i.afe
  %next.gep157 = getelementptr i8, ptr %i.afh, i64 432
  %i.afi = getelementptr i8, ptr %gep.i, i64 %i.afe
  %next.gep158 = getelementptr i8, ptr %i.afi, i64 576
  %i.afj = getelementptr i8, ptr %gep.i, i64 %i.afe
  %next.gep159 = getelementptr i8, ptr %i.afj, i64 720
  %i.afk = getelementptr i8, ptr %gep.i, i64 %i.afe
  %next.gep160 = getelementptr i8, ptr %i.afk, i64 864
  %i.afl = getelementptr i8, ptr %gep.i, i64 %i.afe
  %next.gep161 = getelementptr i8, ptr %i.afl, i64 1008
  %i.afm = shl i64 %index, 2
  %next.gep162 = getelementptr i8, ptr %.646.i, i64 %i.afm
  %i.afn = load float, ptr %next.gep, align 4, !tbaa !39, !alias.scope !683
  %i.afo = load float, ptr %next.gep155, align 4, !tbaa !39, !alias.scope !683
  %i.afp = load float, ptr %next.gep156, align 4, !tbaa !39, !alias.scope !683
  %i.afq = load float, ptr %next.gep157, align 4, !tbaa !39, !alias.scope !683
  %i.afr = load float, ptr %next.gep158, align 4, !tbaa !39, !alias.scope !683
  %i.afs = load float, ptr %next.gep159, align 4, !tbaa !39, !alias.scope !683
  %i.aft = load float, ptr %next.gep160, align 4, !tbaa !39, !alias.scope !683
  %i.afu = load float, ptr %next.gep161, align 4, !tbaa !39, !alias.scope !683
  %i.afv = insertelement <8 x float> poison, float %i.afn, i64 0
  %i.afw = insertelement <8 x float> %i.afv, float %i.afo, i64 1
  %i.afx = insertelement <8 x float> %i.afw, float %i.afp, i64 2
  %i.afy = insertelement <8 x float> %i.afx, float %i.afq, i64 3
  %i.afz = insertelement <8 x float> %i.afy, float %i.afr, i64 4
  %i.aga = insertelement <8 x float> %i.afz, float %i.afs, i64 5
  %i.agb = insertelement <8 x float> %i.aga, float %i.aft, i64 6
  %i.agc = insertelement <8 x float> %i.agb, float %i.afu, i64 7
  store <8 x float> %i.agc, ptr %next.gep162, align 4, !tbaa !39, !alias.scope !686, !noalias !683
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.agd = icmp eq i64 %index.next, %n.vec
  br i1 %i.agd, label %middle.block, label %vector.body, !llvm.loop !688

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge.i53, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph.i, %middle.block
  %.045.i.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %.lr.ph.i ], [ %i.aao, %middle.block ] ; 4 uses
  %.09944.i.ph = phi ptr [ %gep.i, %vector.memcheck ], [ %gep.i, %.lr.ph.i ], [ %i.afc, %middle.block ] ; 2 uses
  %.743.i.ph = phi ptr [ %.646.i, %vector.memcheck ], [ %.646.i, %.lr.ph.i ], [ %i.afd, %middle.block ] ; 2 uses
  %i.age = sub i32 %smin210, %.045.i.ph
  %xtraiter211 = and i32 %i.age, 7                ; 2 uses
  %lcmp.mod212.not = icmp eq i32 %xtraiter211, 0
  br i1 %lcmp.mod212.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol

scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  %.045.i.prol = phi i32 [ %i.agi, %scalar.ph.prol ], [ %.045.i.ph, %scalar.ph.preheader ]
  %.09944.i.prol = phi ptr [ %i.agg, %scalar.ph.prol ], [ %.09944.i.ph, %scalar.ph.preheader ] ; 2 uses
  %.743.i.prol = phi ptr [ %i.agh, %scalar.ph.prol ], [ %.743.i.ph, %scalar.ph.preheader ] ; 2 uses
  %prol.iter = phi i32 [ %prol.iter.next, %scalar.ph.prol ], [ 0, %scalar.ph.preheader ]
  %i.agf = load float, ptr %.09944.i.prol, align 4, !tbaa !39
  store float %i.agf, ptr %.743.i.prol, align 4, !tbaa !39
  %i.agg = getelementptr inbounds nuw i8, ptr %.09944.i.prol, i64 144 ; 2 uses
  %i.agh = getelementptr inbounds nuw i8, ptr %.743.i.prol, i64 4 ; 3 uses
  %i.agi = add nuw nsw i32 %.045.i.prol, 1        ; 2 uses
  %prol.iter.next = add i32 %prol.iter, 1         ; 2 uses
...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  %.lcssa198.unr = phi ptr [ poison, %scalar.ph.preheader ], [ %i.agh, %scalar.ph.prol ]
  %.045.i.unr = phi i32 [ %.045.i.ph, %scalar.ph.preheader ], [ %i.agi, %scalar.ph.prol ]
  %.09944.i.unr = phi ptr [ %.09944.i.ph, %scalar.ph.preheader ], [ %i.agg, %scalar.ph.prol ]
  %.743.i.unr = phi ptr [ %.743.i.ph, %scalar.ph.preheader ], [ %i.agh, %scalar.ph.prol ]
  %i.agj = sub i32 %.045.i.ph, %smin210
  %i.agk = icmp ugt i32 %i.agj, -8
  br i1 %i.agk, label %._crit_edge.i53, label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  %.045.i = phi i32 [ %i.ahj, %scalar.ph ], [ %.045.i.unr, %scalar.ph.prol.loopexit ]
  %.09944.i = phi ptr [ %i.ahh, %scalar.ph ], [ %.09944.i.unr, %scalar.ph.prol.loopexit ] ; 9 uses
  %.743.i = phi ptr [ %i.ahi, %scalar.ph ], [ %.743.i.unr, %scalar.ph.prol.loopexit ] ; 9 uses
  %i.agl = load float, ptr %.09944.i, align 4, !tbaa !39
  store float %i.agl, ptr %.743.i, align 4, !tbaa !39
  %i.agm = getelementptr inbounds nuw i8, ptr %.09944.i, i64 144
  %i.agn = getelementptr inbounds nuw i8, ptr %.743.i, i64 4
  %i.ago = load float, ptr %i.agm, align 4, !tbaa !39
  store float %i.ago, ptr %i.agn, align 4, !tbaa !39
  %i.agp = getelementptr inbounds nuw i8, ptr %.09944.i, i64 288
  %i.agq = getelementptr inbounds nuw i8, ptr %.743.i, i64 8
  %i.agr = load float, ptr %i.agp, align 4, !tbaa !39
  store float %i.agr, ptr %i.agq, align 4, !tbaa !39
  %i.ags = getelementptr inbounds nuw i8, ptr %.09944.i, i64 432
  %i.agt = getelementptr inbounds nuw i8, ptr %.743.i, i64 12
  %i.agu = load float, ptr %i.ags, align 4, !tbaa !39
  store float %i.agu, ptr %i.agt, align 4, !tbaa !39
  %i.agv = getelementptr inbounds nuw i8, ptr %.09944.i, i64 576
  %i.agw = getelementptr inbounds nuw i8, ptr %.743.i, i64 16
  %i.agx = load float, ptr %i.agv, align 4, !tbaa !39
  store float %i.agx, ptr %i.agw, align 4, !tbaa !39
  %i.agy = getelementptr inbounds nuw i8, ptr %.09944.i, i64 720
  %i.agz = getelementptr inbounds nuw i8, ptr %.743.i, i64 20
  %i.aha = load float, ptr %i.agy, align 4, !tbaa !39
  store float %i.aha, ptr %i.agz, align 4, !tbaa !39
  %i.ahb = getelementptr inbounds nuw i8, ptr %.09944.i, i64 864
  %i.ahc = getelementptr inbounds nuw i8, ptr %.743.i, i64 24
  %i.ahd = load float, ptr %i.ahb, align 4, !tbaa !39
  store float %i.ahd, ptr %i.ahc, align 4, !tbaa !39
  %i.ahe = getelementptr inbounds nuw i8, ptr %.09944.i, i64 1008
  %i.ahf = getelementptr inbounds nuw i8, ptr %.743.i, i64 28
  %i.ahg = load float, ptr %i.ahe, align 4, !tbaa !39
  store float %i.ahg, ptr %i.ahf, align 4, !tbaa !39
  %i.ahh = getelementptr inbounds nuw i8, ptr %.09944.i, i64 1152
  %i.ahi = getelementptr inbounds nuw i8, ptr %.743.i, i64 32 ; 2 uses
  %i.ahj = add nuw nsw i32 %.045.i, 8             ; 2 uses
  %exitcond74.not.i.7 = icmp eq i32 %i.ahj, %.sroa.speculated
  br i1 %exitcond74.not.i.7, label %._crit_edge.i53, label %scalar.ph, !llvm.loop !690

._crit_edge.i53:                                  ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %.lcssa150 = phi ptr [ %i.afd, %middle.block ], [ %.lcssa198.unr, %scalar.ph.prol.loopexit ], [ %i.ahi, %scalar.ph ]
  %indvars.iv.next76.i = add nuw nsw i64 %indvars.iv75.i, 1 ; 2 uses
  %exitcond78.not.i = icmp eq i64 %indvars.iv.next76.i, %i.ba
  br i1 %exitcond78.not.i, label %._crit_edge49.split.i, label %.lr.ph.i, !llvm.loop !663
...
_ZN4ncnn3MatD2Ev.exit34:                          ; preds = %._crit_edge49.split.i
  %indvars.iv.next = add nsw i64 %indvars.iv, %i.bd ; 2 uses
  %i.ahk = icmp slt i64 %indvars.iv.next, %i.be
  %indvar.next = add i32 %indvar, 1
  %indvar.next169 = add i64 %indvar168, 1
  br i1 %i.ahk, label %bb.d, label %_ZN4ncnn3MatD2Ev.exit, !llvm.loop !691
...
bb.i:                                             ; preds = %bb.c
  ...
  %i.ahm = extractvalue { ptr, i32 } %i.ahl, 0
  call void @__clang_call_terminate(ptr %i.ahm) #32
  unreachable
}
...
bb.c:                                             ; preds = %.lr.ph108, %_ZN4ncnn3MatD2Ev.exit
  %.033107 = phi i32 [ %i.k, %.lr.ph108 ], [ %i.bi, %_ZN4ncnn3MatD2Ev.exit ] ; 3 uses
...
_ZN4ncnn3Mat7channelEi.exit49:                    ; preds = %bb.c
  %i.u = load ptr, ptr %4, align 8, !tbaa !18, !noalias !692 ; 3 uses
  ...
  %i.aa = getelementptr inbounds nuw i8, ptr %i.u, i64 %i.z ; 5 uses
  %i.ab = load i32, ptr %5, align 4, !tbaa !67    ; 7 uses
...
.lr.ph:                                           ; preds = %_ZN4ncnn3Mat7channelEi.exit49
  ...
  %i.ag = load i32, ptr %6, align 4, !tbaa !67    ; 11 uses
  ...
  %i.bg = getelementptr i8, ptr %i.u, i64 %i.z
  %i.bh = getelementptr i8, ptr %i.bg, i64 4
  br label %bb.d

_ZN4ncnn3MatD2Ev.exit:                            ; preds = %_ZN4ncnn3MatD2Ev.exit34, %_ZN4ncnn3Mat7channelEi.exit49
  %i.bi = add i32 %.033107, 1
  %i.bj = load i32, ptr %i.b, align 4, !tbaa !67
  %.not.not = icmp slt i32 %.033107, %i.bj
  br i1 %.not.not, label %bb.c, label %._crit_edge

bb.d:                                             ; preds = %.lr.ph, %_ZN4ncnn3MatD2Ev.exit34
  %indvar = phi i32 [ 0, %.lr.ph ], [ %indvar.next, %_ZN4ncnn3MatD2Ev.exit34 ] ; 5 uses
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %_ZN4ncnn3MatD2Ev.exit34 ] ; 4 uses
  %i.bk = mul i32 %i.ag, %indvar
  %i.bl = sub i32 %i.ab, %i.bk
  %smin153 = call i32 @llvm.smin.i32(i32 %i.ag, i32 %i.bl) ; 2 uses
  %i.bm = mul i32 %i.ag, %indvar
  %i.bn = sub i32 %i.ab, %i.bm
  %smin146 = call i32 @llvm.smin.i32(i32 %i.ag, i32 %i.bn) ; 3 uses
  %i.bo = add i32 %smin146, -1
  %i.bp = mul i32 %i.ag, %indvar
  %i.bq = sub i32 %i.ab, %i.bp
  %smin142 = call i32 @llvm.smin.i32(i32 %i.ag, i32 %i.bq) ; 4 uses
  %i.br = mul i32 %i.ag, %indvar
  %i.bs = sub i32 %i.ab, %i.br
  %smin = call i32 @llvm.smin.i32(i32 %i.ag, i32 %i.bs) ; 2 uses
  %i.bt = add i32 %smin, -1
  %i.bu = zext i32 %i.bt to i64                   ; 2 uses
  %i.bv = shl nuw nsw i64 %i.bu, 2
  %i.bw = shl i32 %smin, 4                        ; 2 uses
  %i.bx = sext i32 %i.bw to i64                   ; 2 uses
  %i.by = mul i64 %i.be, %i.bx
  %i.bz = shl nuw nsw i64 %i.bu, 6
  %i.ca = trunc i64 %indvars.iv to i32
  %i.cb = sub i32 %i.ab, %i.ca
  %.sroa.speculated = call i32 @llvm.smin.i32(i32 %i.ag, i32 %i.cb) ; 14 uses
...
.preheader4.lr.ph.i:                              ; preds = %bb.d
  %i.cc = load i32, ptr %9, align 4, !tbaa !67
  %i.cd = icmp sgt i32 %.sroa.speculated, 0
  %i.ce = mul i32 %i.cc, 9
  br i1 %i.cd, label %.preheader4.preheader.i, label %_ZN4ncnnL42conv3x3s1_winograd23_transform_kernel_tileERKNS_3MatERS0_iiiii.exit
...
.preheader4.i:                                    ; preds = %._crit_edge.i, %.preheader4.preheader.i
  ...
  %.012.i = phi ptr [ %i.aa, %.preheader4.preheader.i ], [ %i.fj, %._crit_edge.i ]
  %i.cf = trunc i64 %indvars.iv17.i to i32
  %i.cg = add i32 %i.s, %i.cf
  %i.ch = mul i32 %i.ce, %i.cg
  %i.ci = sext i32 %i.ch to i64
  %i.cj = getelementptr inbounds [4 x i8], ptr %.val50, i64 %i.ci
...
.preheader.preheader.i:                           ; preds = %.preheader.preheader.i, %.preheader4.i
  ...
  %.110.i = phi ptr [ %.012.i, %.preheader4.i ], [ %i.fj, %.preheader.preheader.i ] ; 17 uses
  %i.ck = add nsw i64 %indvars.iv.i, %indvars.iv
  %.idx.i = mul nsw i64 %i.ck, 36
  %i.cl = getelementptr inbounds i8, ptr %i.cj, i64 %.idx.i ; 9 uses
  %i.cm = load float, ptr %i.cl, align 4, !tbaa !39 ; 2 uses
  ...
  %i.cq = load float, ptr %i.cp, align 4, !tbaa !39 ; 2 uses
  %i.cr = fmul fast float %i.cm, 5.000000e-01     ; 4 uses
  %i.cs = fmul fast float %i.co, 5.000000e-01     ; 2 uses
  %i.ct = fadd fast float %i.cs, %i.cr
end_hunk_3
begin_hunk_4_@_ZN4ncnnL37conv3x3s1_winograd23_transform_kernelERKNS_3MatERS0_iiRKNS_6OptionE.omp_outlined:bb.a
  %i.kh = getelementptr inbounds nuw [4 x i8], ptr %i.ke, i64 %i.fr
  %i.ki = load float, ptr %i.kh, align 4, !tbaa !39
  %i.kj = getelementptr inbounds nuw i8, ptr %.528.us.i, i64 28
  store float %i.ki, ptr %i.kj, align 4, !tbaa !39
  %i.kk = getelementptr inbounds nuw i8, ptr %.010129.us.i, i64 256 ; 2 uses
  %i.kl = getelementptr inbounds nuw i8, ptr %.528.us.i, i64 32 ; 3 uses
  %niter152.next.3 = add i32 %niter152, 4         ; 2 uses
  %niter152.ncmp.3 = icmp eq i32 %niter152.next.3, %unroll_iter151
  br i1 %niter152.ncmp.3, label %._crit_edge.us39.i.unr-lcssa, label %.lr.ph.us38.i.new, !llvm.loop !652

._crit_edge.us39.i.unr-lcssa:                     ; preds = %.lr.ph.us38.i.new
  br i1 %lcmp.mod148.not, label %._crit_edge.us39.i, label %.epil.preheader145

.epil.preheader145:                               ; preds = %._crit_edge.us39.i.unr-lcssa, %.lr.ph.us38.i
  %.010129.us.i.epil.init = phi ptr [ %gep.us37.i, %.lr.ph.us38.i ], [ %i.kk, %._crit_edge.us39.i.unr-lcssa ]
  %.528.us.i.epil.init = phi ptr [ %.431.us.i, %.lr.ph.us38.i ], [ %i.kl, %._crit_edge.us39.i.unr-lcssa ]
  call void @llvm.assume(i1 %lcmp.mod150)
  br label %bb.g

bb.g:                                             ; preds = %bb.g, %.epil.preheader145
  %.010129.us.i.epil = phi ptr [ %.010129.us.i.epil.init, %.epil.preheader145 ], [ %i.kq, %bb.g ] ; 3 uses
  %.528.us.i.epil = phi ptr [ %.528.us.i.epil.init, %.epil.preheader145 ], [ %i.kr, %bb.g ] ; 3 uses
  %epil.iter = phi i32 [ 0, %.epil.preheader145 ], [ %epil.iter.next, %bb.g ]
  %i.km = load float, ptr %.010129.us.i.epil, align 4, !tbaa !39
  store float %i.km, ptr %.528.us.i.epil, align 4, !tbaa !39
  %i.kn = getelementptr inbounds nuw [4 x i8], ptr %.010129.us.i.epil, i64 %i.fr
  %i.ko = load float, ptr %i.kn, align 4, !tbaa !39
  %i.kp = getelementptr inbounds nuw i8, ptr %.528.us.i.epil, i64 4
  store float %i.ko, ptr %i.kp, align 4, !tbaa !39
  %i.kq = getelementptr inbounds nuw i8, ptr %.010129.us.i.epil, i64 64
  %i.kr = getelementptr inbounds nuw i8, ptr %.528.us.i.epil, i64 8 ; 2 uses
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
...
._crit_edge.us39.i:                               ; preds = %bb.g, %._crit_edge.us39.i.unr-lcssa
  %.lcssa140 = phi ptr [ %i.kl, %._crit_edge.us39.i.unr-lcssa ], [ %i.kr, %bb.g ] ; 2 uses
  %indvars.iv.next72.i = add nuw nsw i64 %indvars.iv71.i, 2 ; 3 uses
  %i.ks = icmp slt i64 %indvars.iv.next72.i, %invariant.op106.i
  br i1 %i.ks, label %.lr.ph.us38.i, label %.preheader.loopexit.i, !llvm.loop !654

.preheader.loopexit.i:                            ; preds = %._crit_edge.us39.i
  %i.kt = trunc nsw i64 %indvars.iv.next72.i to i32
  br label %.preheader.i

.preheader.i:                                     ; preds = %.preheader.loopexit.i, %.preheader1.i
  %.4.lcssa.i = phi ptr [ %.2109.lcssa.i, %.preheader1.i ], [ %.lcssa140, %.preheader.loopexit.i ]
  %.2.lcssa.i = phi i32 [ %.1.lcssa.i, %.preheader1.i ], [ %i.kt, %.preheader.loopexit.i ] ; 2 uses
  %i.ku = icmp slt i32 %.2.lcssa.i, %.sroa.speculated82
  br i1 %i.ku, label %.lr.ph48.i, label %._crit_edge49.split.i

.lr.ph48.i:                                       ; preds = %.preheader.i
  %invariant.gep50.i = getelementptr [4 x i8], ptr %i.aa, i64 %indvars.iv79.i
  br i1 %i.fq, label %.lr.ph.preheader.i, label %._crit_edge49.split.i

.lr.ph.preheader.i:                               ; preds = %.lr.ph48.i
  %i.kv = sext i32 %.2.lcssa.i to i64             ; 2 uses
  %i.kw = mul i64 %i.gf, %i.kv
  %scevgep126 = getelementptr i8, ptr %scevgep125, i64 %i.kw
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %._crit_edge.i53, %.lr.ph.preheader.i
  %indvars.iv75.i = phi i64 [ %i.kv, %.lr.ph.preheader.i ], [ %indvars.iv.next76.i, %._crit_edge.i53 ] ; 2 uses
  %.646.i = phi ptr [ %.4.lcssa.i, %.lr.ph.preheader.i ], [ %.lcssa123, %._crit_edge.i53 ] ; 6 uses
  %i.kx = mul nsw i64 %indvars.iv75.i, %i.fr
  %gep.i = getelementptr [4 x i8], ptr %invariant.gep50.i, i64 %i.kx ; 11 uses
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.i
  %scevgep = getelementptr i8, ptr %.646.i, i64 4
  %scevgep124 = getelementptr i8, ptr %scevgep, i64 %i.bv
  %bound0 = icmp ult ptr %.646.i, %scevgep127
  %bound1 = icmp ult ptr %scevgep126, %scevgep124
  %found.conflict = and i1 %bound0, %bound1
  %i.ky = or i1 %found.conflict, %stride.check
  br i1 %i.ky, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %i.kz = getelementptr i8, ptr %gep.i, i64 %i.gm
  %i.la = getelementptr i8, ptr %.646.i, i64 %i.gn ; 2 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %i.lb = shl i64 %index, 6                       ; 8 uses
  %next.gep = getelementptr i8, ptr %gep.i, i64 %i.lb
  %i.lc = getelementptr i8, ptr %gep.i, i64 %i.lb
  %next.gep128 = getelementptr i8, ptr %i.lc, i64 64
  %i.ld = getelementptr i8, ptr %gep.i, i64 %i.lb
  %next.gep129 = getelementptr i8, ptr %i.ld, i64 128
  %i.le = getelementptr i8, ptr %gep.i, i64 %i.lb
  %next.gep130 = getelementptr i8, ptr %i.le, i64 192
  %i.lf = getelementptr i8, ptr %gep.i, i64 %i.lb
  %next.gep131 = getelementptr i8, ptr %i.lf, i64 256
  %i.lg = getelementptr i8, ptr %gep.i, i64 %i.lb
  %next.gep132 = getelementptr i8, ptr %i.lg, i64 320
  %i.lh = getelementptr i8, ptr %gep.i, i64 %i.lb
  %next.gep133 = getelementptr i8, ptr %i.lh, i64 384
  %i.li = getelementptr i8, ptr %gep.i, i64 %i.lb
  %next.gep134 = getelementptr i8, ptr %i.li, i64 448
  %i.lj = shl i64 %index, 2
  %next.gep135 = getelementptr i8, ptr %.646.i, i64 %i.lj
  %i.lk = load float, ptr %next.gep, align 4, !tbaa !39, !alias.scope !701
  %i.ll = load float, ptr %next.gep128, align 4, !tbaa !39, !alias.scope !701
  %i.lm = load float, ptr %next.gep129, align 4, !tbaa !39, !alias.scope !701
  %i.ln = load float, ptr %next.gep130, align 4, !tbaa !39, !alias.scope !701
  %i.lo = load float, ptr %next.gep131, align 4, !tbaa !39, !alias.scope !701
  %i.lp = load float, ptr %next.gep132, align 4, !tbaa !39, !alias.scope !701
  %i.lq = load float, ptr %next.gep133, align 4, !tbaa !39, !alias.scope !701
  %i.lr = load float, ptr %next.gep134, align 4, !tbaa !39, !alias.scope !701
  %i.ls = insertelement <8 x float> poison, float %i.lk, i64 0
  %i.lt = insertelement <8 x float> %i.ls, float %i.ll, i64 1
  %i.lu = insertelement <8 x float> %i.lt, float %i.lm, i64 2
  %i.lv = insertelement <8 x float> %i.lu, float %i.ln, i64 3
  %i.lw = insertelement <8 x float> %i.lv, float %i.lo, i64 4
  %i.lx = insertelement <8 x float> %i.lw, float %i.lp, i64 5
  %i.ly = insertelement <8 x float> %i.lx, float %i.lq, i64 6
  %i.lz = insertelement <8 x float> %i.ly, float %i.lr, i64 7
  store <8 x float> %i.lz, ptr %next.gep135, align 4, !tbaa !39, !alias.scope !704, !noalias !701
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ma = icmp eq i64 %index.next, %n.vec
  br i1 %i.ma, label %middle.block, label %vector.body, !llvm.loop !706

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge.i53, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph.i, %middle.block
  %.045.i.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %.lr.ph.i ], [ %i.gl, %middle.block ] ; 4 uses
  %.09944.i.ph = phi ptr [ %gep.i, %vector.memcheck ], [ %gep.i, %.lr.ph.i ], [ %i.kz, %middle.block ] ; 2 uses
  %.743.i.ph = phi ptr [ %.646.i, %vector.memcheck ], [ %.646.i, %.lr.ph.i ], [ %i.la, %middle.block ] ; 2 uses
  %i.mb = sub i32 %smin153, %.045.i.ph
  %xtraiter154 = and i32 %i.mb, 7                 ; 2 uses
  %lcmp.mod155.not = icmp eq i32 %xtraiter154, 0
  br i1 %lcmp.mod155.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol

scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  %.045.i.prol = phi i32 [ %i.mf, %scalar.ph.prol ], [ %.045.i.ph, %scalar.ph.preheader ]
  %.09944.i.prol = phi ptr [ %i.md, %scalar.ph.prol ], [ %.09944.i.ph, %scalar.ph.preheader ] ; 2 uses
  %.743.i.prol = phi ptr [ %i.me, %scalar.ph.prol ], [ %.743.i.ph, %scalar.ph.preheader ] ; 2 uses
  %prol.iter = phi i32 [ %prol.iter.next, %scalar.ph.prol ], [ 0, %scalar.ph.preheader ]
  %i.mc = load float, ptr %.09944.i.prol, align 4, !tbaa !39
  store float %i.mc, ptr %.743.i.prol, align 4, !tbaa !39
  %i.md = getelementptr inbounds nuw i8, ptr %.09944.i.prol, i64 64 ; 2 uses
  %i.me = getelementptr inbounds nuw i8, ptr %.743.i.prol, i64 4 ; 3 uses
  %i.mf = add nuw nsw i32 %.045.i.prol, 1         ; 2 uses
  %prol.iter.next = add i32 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i32 %prol.iter.next, %xtraiter154
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !707

scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  %.lcssa141.unr = phi ptr [ poison, %scalar.ph.preheader ], [ %i.me, %scalar.ph.prol ]
  %.045.i.unr = phi i32 [ %.045.i.ph, %scalar.ph.preheader ], [ %i.mf, %scalar.ph.prol ]
  %.09944.i.unr = phi ptr [ %.09944.i.ph, %scalar.ph.preheader ], [ %i.md, %scalar.ph.prol ]
  %.743.i.unr = phi ptr [ %.743.i.ph, %scalar.ph.preheader ], [ %i.me, %scalar.ph.prol ]
  %i.mg = sub i32 %.045.i.ph, %smin153
  %i.mh = icmp ugt i32 %i.mg, -8
  br i1 %i.mh, label %._crit_edge.i53, label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  %.045.i = phi i32 [ %i.ng, %scalar.ph ], [ %.045.i.unr, %scalar.ph.prol.loopexit ]
  %.09944.i = phi ptr [ %i.ne, %scalar.ph ], [ %.09944.i.unr, %scalar.ph.prol.loopexit ] ; 9 uses
  %.743.i = phi ptr [ %i.nf, %scalar.ph ], [ %.743.i.unr, %scalar.ph.prol.loopexit ] ; 9 uses
  %i.mi = load float, ptr %.09944.i, align 4, !tbaa !39
  store float %i.mi, ptr %.743.i, align 4, !tbaa !39
  %i.mj = getelementptr inbounds nuw i8, ptr %.09944.i, i64 64
  %i.mk = getelementptr inbounds nuw i8, ptr %.743.i, i64 4
  %i.ml = load float, ptr %i.mj, align 4, !tbaa !39
  store float %i.ml, ptr %i.mk, align 4, !tbaa !39
  %i.mm = getelementptr inbounds nuw i8, ptr %.09944.i, i64 128
  %i.mn = getelementptr inbounds nuw i8, ptr %.743.i, i64 8
  %i.mo = load float, ptr %i.mm, align 4, !tbaa !39
  store float %i.mo, ptr %i.mn, align 4, !tbaa !39
  %i.mp = getelementptr inbounds nuw i8, ptr %.09944.i, i64 192
  %i.mq = getelementptr inbounds nuw i8, ptr %.743.i, i64 12
  %i.mr = load float, ptr %i.mp, align 4, !tbaa !39
  store float %i.mr, ptr %i.mq, align 4, !tbaa !39
  %i.ms = getelementptr inbounds nuw i8, ptr %.09944.i, i64 256
  %i.mt = getelementptr inbounds nuw i8, ptr %.743.i, i64 16
  %i.mu = load float, ptr %i.ms, align 4, !tbaa !39
  store float %i.mu, ptr %i.mt, align 4, !tbaa !39
  %i.mv = getelementptr inbounds nuw i8, ptr %.09944.i, i64 320
  %i.mw = getelementptr inbounds nuw i8, ptr %.743.i, i64 20
  %i.mx = load float, ptr %i.mv, align 4, !tbaa !39
  store float %i.mx, ptr %i.mw, align 4, !tbaa !39
  %i.my = getelementptr inbounds nuw i8, ptr %.09944.i, i64 384
  %i.mz = getelementptr inbounds nuw i8, ptr %.743.i, i64 24
  %i.na = load float, ptr %i.my, align 4, !tbaa !39
  store float %i.na, ptr %i.mz, align 4, !tbaa !39
  %i.nb = getelementptr inbounds nuw i8, ptr %.09944.i, i64 448
  %i.nc = getelementptr inbounds nuw i8, ptr %.743.i, i64 28
  %i.nd = load float, ptr %i.nb, align 4, !tbaa !39
  store float %i.nd, ptr %i.nc, align 4, !tbaa !39
  %i.ne = getelementptr inbounds nuw i8, ptr %.09944.i, i64 512
  %i.nf = getelementptr inbounds nuw i8, ptr %.743.i, i64 32 ; 2 uses
  %i.ng = add nuw nsw i32 %.045.i, 8              ; 2 uses
  %exitcond74.not.i.7 = icmp eq i32 %i.ng, %.sroa.speculated
  br i1 %exitcond74.not.i.7, label %._crit_edge.i53, label %scalar.ph, !llvm.loop !708

._crit_edge.i53:                                  ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %.lcssa123 = phi ptr [ %i.la, %middle.block ], [ %.lcssa141.unr, %scalar.ph.prol.loopexit ], [ %i.nf, %scalar.ph ]
  %indvars.iv.next76.i = add nuw nsw i64 %indvars.iv75.i, 1 ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit34:                          ; preds = %._crit_edge49.split.i
  ...
  %i.nh = icmp slt i64 %indvars.iv.next, %i.bc
  %indvar.next = add i32 %indvar, 1
  br i1 %i.nh, label %bb.d, label %_ZN4ncnn3MatD2Ev.exit, !llvm.loop !709
...
bb.i:                                             ; preds = %bb.c
  ...
  call void @__clang_call_terminate(ptr %i.nj) #32
  unreachable
}
...
.loopexit.i.i:                                    ; preds = %.loopexit.i.i.loopexit179.unr-lcssa, %bb.i, %.loopexit.i.i.loopexit178.unr-lcssa, %.lr.ph410.i.i.epil, %.loopexit.i.i.loopexit.unr-lcssa, %.lr.ph405.i.i.epil, %_ZN4ncnn3MatD2Ev.exit.i.i, %_ZN4ncnn3MatD2Ev.exit496.i.i, %_ZN4ncnn3MatD2Ev.exit497.i.i, %bb.h
  ...
  %indvars.iv.next463.i.i = add nuw nsw i64 %indvars.iv462.i.i, 1 ; 2 uses
...
._crit_edge1247.i:                                ; preds = %bb.gb, %.preheader.i
  ...
  %indvars.iv.next1443.i = add nuw nsw i64 %indvars.iv1442.i, 1 ; 2 uses
...
._crit_edge1123.i:                                ; preds = %.lr.ph1122.i.prol.loopexit, %.lr.ph1122.i, %middle.block, %vec.epilog.middle.block, %.preheader.i
  ...
  %indvars.iv.next1184.i = add nuw nsw i64 %indvars.iv1183.i, 1 ; 2 uses
...
._crit_edge854.us.i:                              ; preds = %bb.bx
  %indvars.iv.next927.i = add nuw nsw i64 %indvars.iv926.i, 1 ; 2 uses
...
._crit_edge2055.us.i:                             ; preds = %bb.es
  ...
  %indvars.iv.next2132.i = add nuw nsw i64 %indvars.iv2131.i, 1 ; 2 uses
...
._crit_edge3614.us:                               ; preds = %bb.cu
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #12
  %indvars.iv.next3694 = add nuw nsw i64 %indvars.iv3693, 1 ; 2 uses
...
._crit_edge5163:                                  ; preds = %bb.em, %.preheader
  ...
  %indvars.iv.next5273 = add nuw nsw i64 %indvars.iv5272, 1 ; 2 uses
