...
.lr.ph339.i.i:                                    ; preds = %bb.c
  ...
  %16 = lshr i32 %.sroa.speculated, 3
  %i.bf = sdiv i32 %i.x, 4
  %i.bg = sext i32 %i.bf to i64
  %17 = lshr i32 %.sroa.speculated, 2
...
.lr.ph399.i.i:                                    ; preds = %.preheader312.i.i
  ...
  %22 = lshr i32 %.sroa.speculated, 3
  %i.rk = icmp sgt i32 %.sroa.speculated, 7
  %i.rl = sdiv i32 %i.x, 4
  %i.rm = sext i32 %i.rl to i64
  %23 = lshr i32 %.sroa.speculated, 2             ; 3 uses
  ...
  %24 = icmp eq i32 %23, 1
  %i.rv = and i32 %23, 536870910
  %unroll_iter233 = and i32 %.sroa.speculated, 4
  %lcmp.mod230.not = icmp eq i32 %unroll_iter233, 0
...
.lr.ph419.i.i:                                    ; preds = %.preheader.i.i
  ...
  %25 = lshr i32 %.sroa.speculated, 3             ; 3 uses
  %i.vl = icmp sgt i32 %.sroa.speculated, 7
  %i.vm = sdiv i32 %i.x, 4
  %i.vn = sext i32 %i.vm to i64
  %26 = lshr i32 %.sroa.speculated, 2             ; 3 uses
...
.lr.ph390.i.i:                                    ; preds = %.lr.ph390.preheader.i.i, %.lr.ph390.i.i
  ...
  %niter234.ncmp.1 = icmp eq i32 %niter234.next.1, %i.rv
...
.lr.ph169.i.i:                                    ; preds = %.preheader126.i.i
  ...
  %18 = lshr i32 %.sroa.speculated, 3             ; 3 uses
...
_ZN4ncnn3MatD2Ev.exit269.i.us.us.i.preheader:     ; preds = %.lr.ph169.i.split.us.i
  %19 = icmp eq i32 %18, 1
  %i.hk = and i32 %18, 268435454
  %unroll_iter391 = and i32 %.sroa.speculated, 8
  %lcmp.mod388.not = icmp eq i32 %unroll_iter391, 0
...
.lr.ph153.i.us.us.i:                              ; preds = %_ZN4ncnn3MatD2Ev.exit269.i.us.us.i, %.lr.ph153.i.us.us.i
  ...
  %niter392.ncmp.1 = icmp eq i32 %niter392.next.1, %i.hk
...
.lr.ph191.i.i:                                    ; preds = %.preheader122.i.i
  ...
  %20 = lshr i32 %.sroa.speculated, 3             ; 3 uses
  ...
  %21 = icmp eq i32 %20, 1
  %i.mo = and i32 %20, 268435454
  %unroll_iter407 = and i32 %.sroa.speculated, 8
  %lcmp.mod404.not = icmp eq i32 %unroll_iter407, 0
...
.lr.ph175.i.i:                                    ; preds = %.lr.ph175.preheader.i.i, %.lr.ph175.i.i
  ...
  %niter408.ncmp.1 = icmp eq i32 %niter408.next.1, %i.mo
