...
begin_hunk_0_@_ZN4ncnnL37conv3x3s1_winograd63_transform_kernelERKNS_3MatERS0_iiRKNS_6OptionE.omp_outlined:bb.a
  store <4 x float> %i.wt, ptr %i.vm, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.ww, ptr %i.vn, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.wz, ptr %i.vo, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.xn, ptr %i.xb, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.xq, ptr %i.xc, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.xt, ptr %i.xd, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.zc, ptr %i.xv, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.zf, ptr %i.xw, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.zi, ptr %i.xx, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.zw, ptr %i.zk, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.zz, ptr %i.zl, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.aac, ptr %i.zm, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store float %i.er, ptr %i.aad, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  store float %i.es, ptr %i.aae, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  store float %i.et, ptr %i.aaf, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  store float %i.eu, ptr %i.aag, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.abl, ptr %i.aaz, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.abo, ptr %i.aba, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store <4 x float> %i.abr, ptr %i.abb, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store float %i.abw, ptr %i.abs, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  %i.abx = getelementptr inbounds nuw i8, ptr %next.gep176, i64 248
  %i.aby = extractelement <4 x float> %i.aax, i64 0
  store float %i.aby, ptr %i.abx, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  %i.abz = shufflevector <4 x float> %i.aav, <4 x float> %i.aax, <2 x i32> <i32 1, i32 5>
  store <2 x float> %i.abz, ptr %i.abt, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  %i.aca = shufflevector <4 x float> %i.aav, <4 x float> %i.aax, <2 x i32> <i32 2, i32 6>
  store <2 x float> %i.aca, ptr %i.abu, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  %i.acb = shufflevector <4 x float> %i.aav, <4 x float> %i.aax, <2 x i32> <i32 3, i32 7>
  store <2 x float> %i.acb, ptr %i.abv, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  ...
  store float %i.jb, ptr %i.acc, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  store float %i.jc, ptr %i.acd, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  store float %i.jd, ptr %i.ace, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  store float %i.je, ptr %i.acf, align 4, !tbaa !39, !alias.scope !643, !noalias !640
  %index.next180 = add nuw i64 %index175, 4       ; 2 uses
  %i.acg = icmp eq i64 %index.next180, %n.vec173
  br i1 %i.acg, label %middle.block181, label %vector.body174, !llvm.loop !645
...
.preheader.preheader.i:                           ; preds = %.preheader.preheader.i.preheader, %.preheader.preheader.i
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %.preheader.preheader.i, !llvm.loop !646
...
._crit_edge.i:                                    ; preds = %.preheader.preheader.i, %middle.block181
  ...
  br i1 %exitcond29.not.i, label %_ZN4ncnnL42conv3x3s1_winograd63_transform_kernel_tileERKNS_3MatERS0_iiiii.exit, label %.preheader12.i, !llvm.loop !647
...
bb.f:                                             ; preds = %bb.f, %.lr.ph.us.i
  ...
  br i1 %exitcond.not.i55, label %._crit_edge.us.i, label %bb.f, !llvm.loop !648
...
._crit_edge.us.i:                                 ; preds = %bb.f
  ...
  br i1 %i.aig, label %.lr.ph.us.i, label %.preheader2.loopexit.i, !llvm.loop !649
...
.lr.ph.us23.i.new:                                ; preds = %.lr.ph.us23.i, %.lr.ph.us23.i.new
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.us24.i.unr-lcssa, label %.lr.ph.us23.i.new, !llvm.loop !650
end_hunk_0
