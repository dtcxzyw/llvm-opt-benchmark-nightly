...
_ZN4ncnn3MatD2Ev.exit1007.lr.ph.i:                ; preds = %bb.ja, %bb.iz, %bb.ix, %bb.iv
  ...
  %i.ajn = add nuw nsw i32 %i.ajm, 8              ; 4 uses
...
_ZN4ncnn3MatD2Ev.exit1006.lr.ph.i:                ; preds = %.preheader1105.i
  ...
  %i.alc = add nuw nsw i32 %i.alb, 8              ; 4 uses
...
_ZN4ncnn3MatD2Ev.exit1005.lr.ph.i:                ; preds = %.preheader1097.i
  ...
  %i.bgi = add nuw nsw i32 %i.bgh, 8              ; 4 uses
...
_ZN4ncnn3MatD2Ev.exit.lr.ph.i:                    ; preds = %.preheader1089.i
  ...
  %i.buw = add nuw nsw i32 %i.buv, 8              ; 4 uses
...
_ZN4ncnn3MatD2Ev.exit1007.lr.ph.i:                ; preds = %bb.dm, %bb.dl, %bb.dj, %bb.dh
  ...
  %i.vb = mul i32 %i.ub, 7
  %i.vc = and i32 %i.uq, -8
  %i.vd = add nuw nsw i32 %i.vc, 8                ; 4 uses
  %i.ve = add i32 %i.p, -4
...
_ZN4ncnn3MatD2Ev.exit1006.lr.ph.i:                ; preds = %.preheader1105.i
  ...
  %i.wp = and i32 %i.wd, -8
  %i.wq = add nuw nsw i32 %i.wp, 8                ; 4 uses
  %i.wr = add i32 %i.p, -4
...
_ZN4ncnn3MatD2Ev.exit1005.lr.ph.i:                ; preds = %.preheader1097.i
  ...
  %i.asm = add nuw nsw i32 %i.asl, 8              ; 4 uses
  %i.asn = add i32 %i.p, -4
...
_ZN4ncnn3MatD2Ev.exit.lr.ph.i:                    ; preds = %.preheader1089.i
  ...
  %i.bjk = add nuw nsw i32 %i.bjj, 8              ; 4 uses
  %i.bjl = add i32 %i.p, -4
...
.preheader431.lr.ph:                              ; preds = %.preheader432
  ...
  %i.adk = add nuw nsw i32 %i.adj, 12
  %i.adl = add i32 %6, -1
...
.lr.ph880.split.split.preheader:                  ; preds = %.lr.ph880.split
  ...
  %i.atb = add nuw i32 %.1602.lcssa, 7
  %smax = tail call i32 @llvm.smax.i32(i32 %4, i32 %i.atb)
  %i.atc = add nsw i32 %smax, -4
  %i.atd = sub nsw i32 %i.atc, %.1602.lcssa       ; 2 uses
  ...
  %i.ath = add nuw i32 %.1602.lcssa, 4
...
.lr.ph880.split.split.us.preheader:               ; preds = %.lr.ph880.split
  %i.atk = add nuw i32 %.1602.lcssa, 7
  %smax1149 = tail call i32 @llvm.smax.i32(i32 %4, i32 %i.atk)
  %i.atl = add nsw i32 %smax1149, -4
  %i.atm = sub nsw i32 %i.atl, %.1602.lcssa       ; 2 uses
  ...
  %i.atr = add nuw i32 %.1602.lcssa, 4
...
_ZN4ncnn3MatD2Ev.exit507.i.us.preheader.i:        ; preds = %.lr.ph339.i.split.us36.i
  ...
  %i.ip = mul nuw nsw i64 %i.io, 12
  %i.iq = add nuw nsw i64 %i.ip, 12
  br label %.preheader320.loopexit.i.i
...
.preheader217.lr.ph:                              ; preds = %.preheader218
  ...
  %i.tv = and i32 %i.tu, -2
  %i.tw = add nuw nsw i32 %i.tv, 2                ; 4 uses
  %i.tx = and i32 %4, -8
