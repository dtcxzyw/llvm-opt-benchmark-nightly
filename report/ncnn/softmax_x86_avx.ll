...
.lr.ph237:                                        ; preds = %bb.d, %.lr.ph237
  ...
  %i.dk = fadd fast <8 x float> %i.cx, splat (float 1.000000e+00)
  %i.dl = fadd fast <8 x float> %i.dk, %i.dj
...
.lr.ph244:                                        ; preds = %.preheader213, %.lr.ph244
  ...
  %i.gi = fadd fast <4 x float> %i.fv, splat (float 1.000000e+00)
  %i.gj = fadd fast <4 x float> %i.gi, %i.gh
...
.lr.ph628.i:                                      ; preds = %.preheader609.i, %.lr.ph628.i
  ...
  %i.gy = fadd fast <8 x float> %i.gl, splat (float 1.000000e+00)
  %i.gz = fadd fast <8 x float> %i.gy, %i.gx
  ...
  %i.ig = fadd fast <8 x float> %i.ht, splat (float 1.000000e+00)
  %i.ih = fadd fast <8 x float> %i.ig, %i.if
  ...
  %i.jo = fadd fast <8 x float> %i.jb, splat (float 1.000000e+00)
  %i.jp = fadd fast <8 x float> %i.jo, %i.jn
  ...
  %i.kw = fadd fast <8 x float> %i.kj, splat (float 1.000000e+00)
  %i.kx = fadd fast <8 x float> %i.kw, %i.kv
  ...
  %i.me = fadd fast <8 x float> %i.lr, splat (float 1.000000e+00)
  %i.mf = fadd fast <8 x float> %i.me, %i.md
  ...
  %i.nm = fadd fast <8 x float> %i.mz, splat (float 1.000000e+00)
  %i.nn = fadd fast <8 x float> %i.nm, %i.nl
  ...
  %i.ou = fadd fast <8 x float> %i.oh, splat (float 1.000000e+00)
  %i.ov = fadd fast <8 x float> %i.ou, %i.ot
  ...
  %i.qc = fadd fast <8 x float> %i.pp, splat (float 1.000000e+00)
...
.lr.ph637.i:                                      ; preds = %.preheader608.i, %.lr.ph637.i
  ...
  %i.sn = fadd fast <8 x float> %i.sa, splat (float 1.000000e+00)
  %i.so = fadd fast <8 x float> %i.sn, %i.sm
...
.lr.ph654.i:                                      ; preds = %.preheader627.i, %.lr.ph654.i
  ...
  %i.acq = fadd fast <8 x float> %i.acd, splat (float 1.000000e+00)
  %i.acr = fadd fast <8 x float> %i.acq, %i.acp
  ...
  %i.aeb = fadd fast <8 x float> %i.ado, splat (float 1.000000e+00)
  %i.aec = fadd fast <8 x float> %i.aeb, %i.aea
  ...
  %i.afm = fadd fast <8 x float> %i.aez, splat (float 1.000000e+00)
  %i.afn = fadd fast <8 x float> %i.afm, %i.afl
  ...
  %i.agx = fadd fast <8 x float> %i.agk, splat (float 1.000000e+00)
  %i.agy = fadd fast <8 x float> %i.agx, %i.agw
...
.lr.ph663.i:                                      ; preds = %.preheader626.i, %.lr.ph663.i
  ...
  %i.ajg = fadd fast <4 x float> %i.ait, splat (float 1.000000e+00)
  %i.ajh = fadd fast <4 x float> %i.ajg, %i.ajf
  ...
  %i.akp = fadd fast <4 x float> %i.akc, splat (float 1.000000e+00)
  %i.akq = fadd fast <4 x float> %i.akp, %i.ako
  ...
  %i.aly = fadd fast <4 x float> %i.all, splat (float 1.000000e+00)
  %i.alz = fadd fast <4 x float> %i.aly, %i.alx
  ...
  %i.anh = fadd fast <4 x float> %i.amu, splat (float 1.000000e+00)
  %i.ani = fadd fast <4 x float> %i.anh, %i.ang
...
.lr.ph672.i:                                      ; preds = %.preheader625.i, %.lr.ph672.i
  ...
  %i.apj = fadd fast <4 x float> %i.aow, splat (float 1.000000e+00)
  %i.apk = fadd fast <4 x float> %i.apj, %i.api
...
.lr.ph275.i:                                      ; preds = %.preheader248.i, %.lr.ph275.i
  ...
  %i.bci = fadd fast <8 x float> %i.bbv, splat (float 1.000000e+00)
  %i.bcj = fadd fast <8 x float> %i.bci, %i.bch
...
.lr.ph284.i:                                      ; preds = %.preheader247.i, %.lr.ph284.i
  ...
  %i.bfd = fadd fast <4 x float> %i.beq, splat (float 1.000000e+00)
  %i.bfe = fadd fast <4 x float> %i.bfd, %i.bfc
...
.lr.ph237.i:                                      ; preds = %bb.e, %.lr.ph237.i
  ...
  %i.em = fadd fast <8 x float> %i.dz, splat (float 1.000000e+00)
  %i.en = fadd fast <8 x float> %i.em, %i.el
...
.lr.ph244.i:                                      ; preds = %.preheader213.i, %.lr.ph244.i
  ...
  %i.hk = fadd fast <4 x float> %i.gx, splat (float 1.000000e+00)
  %i.hl = fadd fast <4 x float> %i.hk, %i.hj
...
.lr.ph237.i:                                      ; preds = %bb.e, %.lr.ph237.i
  ...
  %i.ex = fadd fast <8 x float> %i.ek, splat (float 1.000000e+00)
  %i.ey = fadd fast <8 x float> %i.ex, %i.ew
...
.lr.ph244.i:                                      ; preds = %.preheader213.i, %.lr.ph244.i
  ...
  %i.hv = fadd fast <4 x float> %i.hi, splat (float 1.000000e+00)
...
.lr.ph251:                                        ; preds = %bb.d, %.lr.ph251
  ...
  %i.er = fadd fast <8 x float> %i.ee, splat (float 1.000000e+00)
  %i.es = fadd fast <8 x float> %i.er, %i.eq
...
.lr.ph258:                                        ; preds = %.preheader227, %.lr.ph258
  ...
  %i.jd = fadd fast <4 x float> %i.iq, splat (float 1.000000e+00)
...
bb.d:                                             ; preds = %bb.d, %.lr.ph150.i
  ...
  %i.dx = fadd fast <8 x float> %i.dk, splat (float 1.000000e+00)
...
bb.g:                                             ; preds = %bb.g, %.lr.ph144.i
  ...
  %i.ks = fadd fast <4 x float> %i.kf, splat (float 1.000000e+00)
  %i.kt = fadd fast <4 x float> %i.ks, %i.kr
...
.lr.ph289.i:                                      ; preds = %.preheader262.i, %.lr.ph289.i
  ...
  %i.vd = fadd fast <8 x float> %i.uq, splat (float 1.000000e+00)
  %i.ve = fadd fast <8 x float> %i.vd, %i.vc
...
.lr.ph298.i:                                      ; preds = %.preheader261.i, %.lr.ph298.i
  ...
  %i.yw = fadd fast <4 x float> %i.yj, splat (float 1.000000e+00)
  %i.yx = fadd fast <4 x float> %i.yw, %i.yv
...
.lr.ph251.i:                                      ; preds = %bb.e, %.lr.ph251.i
  ...
  %i.ft = fadd fast <8 x float> %i.fg, splat (float 1.000000e+00)
  %i.fu = fadd fast <8 x float> %i.ft, %i.fs
...
.lr.ph258.i:                                      ; preds = %.preheader227.i, %.lr.ph258.i
  ...
  %i.kf = fadd fast <4 x float> %i.js, splat (float 1.000000e+00)
  %i.kg = fadd fast <4 x float> %i.kf, %i.ke
...
.lr.ph251.i:                                      ; preds = %bb.e, %.lr.ph251.i
  ...
  %i.ge = fadd fast <8 x float> %i.fr, splat (float 1.000000e+00)
  %i.gf = fadd fast <8 x float> %i.ge, %i.gd
...
.lr.ph258.i:                                      ; preds = %.preheader227.i, %.lr.ph258.i
  ...
  %i.kq = fadd fast <4 x float> %i.kd, splat (float 1.000000e+00)
  %i.kr = fadd fast <4 x float> %i.kq, %i.kp
