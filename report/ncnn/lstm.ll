...
.preheader.loopexit:                              ; preds = %scalar.ph211, %middle.block236
  %.lcssa184 = phi i32 [ %i.eb, %middle.block236 ], [ %21, %scalar.ph211 ]
  %.lcssa183 = phi i32 [ %i.ec, %middle.block236 ], [ %23, %scalar.ph211 ]
  %.lcssa182 = phi i32 [ %i.ed, %middle.block236 ], [ %27, %scalar.ph211 ]
  %.lcssa = phi i32 [ %i.ee, %middle.block236 ], [ %i.ge, %scalar.ph211 ]
  %15 = sitofp fast i32 %.lcssa184 to float
  %16 = sitofp fast i32 %.lcssa183 to float
  %17 = sitofp fast i32 %.lcssa182 to float
  %18 = sitofp fast i32 %.lcssa to float
  br label %.preheader

.preheader:                                       ; preds = %.preheader.loopexit, %bb.c
  %.0124.lcssa = phi float [ 0.000000e+00, %bb.c ], [ %18, %.preheader.loopexit ]
  %.0123.lcssa = phi float [ 0.000000e+00, %bb.c ], [ %17, %.preheader.loopexit ]
  %.0122.lcssa = phi float [ 0.000000e+00, %bb.c ], [ %16, %.preheader.loopexit ]
  %.0121.lcssa = phi float [ 0.000000e+00, %bb.c ], [ %15, %.preheader.loopexit ]
...
scalar.ph211:                                     ; preds = %scalar.ph211.preheader, %scalar.ph211
  ...
  %.0121135 = phi i32 [ %21, %scalar.ph211 ], [ %.0121135.ph, %scalar.ph211.preheader ]
  %.0122134 = phi i32 [ %23, %scalar.ph211 ], [ %.0122134.ph, %scalar.ph211.preheader ]
  %.0123133 = phi i32 [ %27, %scalar.ph211 ], [ %.0123133.ph, %scalar.ph211.preheader ]
  ...
  %19 = sext i8 %i.fw to i32                      ; 4 uses
  %20 = mul nsw i32 %i.fz, %19
  %21 = add nsw i32 %20, %.0121135                ; 2 uses
  %i.ga = getelementptr inbounds nuw i8, ptr %i.bk, i64 %indvars.iv
  %i.gb = load i8, ptr %i.ga, align 1, !tbaa !230
  %i.gc = sext i8 %i.gb to i32
  %22 = mul nsw i32 %i.gc, %19
  %23 = add nsw i32 %22, %.0122134                ; 2 uses
  %24 = getelementptr inbounds nuw i8, ptr %i.bn, i64 %indvars.iv
  %25 = load i8, ptr %24, align 1, !tbaa !230
  %26 = sext i8 %25 to i32
  %i.gd = mul nsw i32 %26, %19
  %27 = add nsw i32 %i.gd, %.0123133              ; 2 uses
  %28 = getelementptr inbounds nuw i8, ptr %i.bq, i64 %indvars.iv
  %29 = load i8, ptr %28, align 1, !tbaa !230
  %30 = sext i8 %29 to i32
  %31 = mul nsw i32 %30, %19
  %i.ge = add nsw i32 %31, %.0124132              ; 2 uses
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  ...
  %i.gs = fmul fast float %i.gl, %.0124.lcssa
  ...
  %32 = insertelement <4 x float> poison, float %.0121.lcssa, i64 0
  %33 = insertelement <4 x float> %32, float %.0122.lcssa, i64 1
  %34 = insertelement <4 x float> %33, float %.0123.lcssa, i64 2
  %i.hj = insertelement <4 x float> %34, float %.0126.lcssa, i64 3
