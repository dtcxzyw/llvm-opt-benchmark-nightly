...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  store <16 x float> splat (float f0xFF7FFFFF), ptr %.081217.epil, align 1, !tbaa !49
  %i.f = getelementptr inbounds nuw i8, ptr %.081217.epil, i64 64 ; 2 uses
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %.preheader119.loopexit, label %.lr.ph.epil, !llvm.loop !91
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  store <16 x float> splat (float f0xFF7FFFFF), ptr %.081217, align 1, !tbaa !49
  %i.j = getelementptr inbounds nuw i8, ptr %.081217, i64 64
  store <16 x float> splat (float f0xFF7FFFFF), ptr %i.j, align 1, !tbaa !49
  %i.k = getelementptr inbounds nuw i8, ptr %.081217, i64 128
  store <16 x float> splat (float f0xFF7FFFFF), ptr %i.k, align 1, !tbaa !49
  %i.l = getelementptr inbounds nuw i8, ptr %.081217, i64 192
  store <16 x float> splat (float f0xFF7FFFFF), ptr %i.l, align 1, !tbaa !49
  %i.m = getelementptr inbounds nuw i8, ptr %.081217, i64 256
  store <16 x float> splat (float f0xFF7FFFFF), ptr %i.m, align 1, !tbaa !49
  %i.n = getelementptr inbounds nuw i8, ptr %.081217, i64 320
  store <16 x float> splat (float f0xFF7FFFFF), ptr %i.n, align 1, !tbaa !49
  %i.o = getelementptr inbounds nuw i8, ptr %.081217, i64 384
  store <16 x float> splat (float f0xFF7FFFFF), ptr %i.o, align 1, !tbaa !49
  %i.p = getelementptr inbounds nuw i8, ptr %.081217, i64 448
  store <16 x float> splat (float f0xFF7FFFFF), ptr %i.p, align 1, !tbaa !49
  %i.q = getelementptr inbounds nuw i8, ptr %.081217, i64 512 ; 3 uses
  %niter.next.7 = add i32 %niter, 8               ; 2 uses
  %niter.ncmp.7.not = icmp eq i32 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7.not, label %.preheader119.loopexit.unr-lcssa, label %.lr.ph, !llvm.loop !92
...
.lr.ph222:                                        ; preds = %.preheader119, %.lr.ph222
  ...
  store <8 x float> splat (float f0xFF7FFFFF), ptr %.182220, align 1, !tbaa !49
  ...
  br i1 %i.w, label %.lr.ph222, label %.preheader118, !llvm.loop !93
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x float> splat (float f0xFF7FFFFF), ptr %next.gep, align 4, !tbaa !53
  store <16 x float> splat (float f0xFF7FFFFF), ptr %i.ai, align 4, !tbaa !53
  store <16 x float> splat (float f0xFF7FFFFF), ptr %i.aj, align 4, !tbaa !53
  store <16 x float> splat (float f0xFF7FFFFF), ptr %i.ak, align 4, !tbaa !53
  %index.next = add nuw i64 %index, 64            ; 2 uses
  %i.al = icmp eq i64 %index.next, %n.vec
  br i1 %i.al, label %middle.block, label %vector.body, !llvm.loop !94
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph232.preheader, label %vec.epilog.ph, !prof !56
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  store <8 x float> splat (float f0xFF7FFFFF), ptr %next.gep578, align 4, !tbaa !53
  %index.next579 = add nuw i64 %index577, 8       ; 2 uses
  %i.ar = icmp eq i64 %index.next579, %n.vec576
  br i1 %i.ar, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !95
...
.lr.ph227:                                        ; preds = %.preheader118, %.lr.ph227
  ...
  store <4 x float> splat (float f0xFF7FFFFF), ptr %.283225, align 1, !tbaa !49
  ...
  br i1 %i.av, label %.lr.ph227, label %.preheader117, !llvm.loop !96
...
.lr.ph235.preheader:                              ; preds = %.preheader116
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %6, i8 0, i64 %i.ba, i1 false), !tbaa !49
...
.lr.ph232:                                        ; preds = %.lr.ph232.preheader, %.lr.ph232
  ...
  store float f0xFF7FFFFF, ptr %.384230, align 4, !tbaa !53
  %i.be = add nuw nsw i32 %.380231, 1             ; 2 uses
  %exitcond.not = icmp eq i32 %i.be, %4
  br i1 %exitcond.not, label %.preheader116, label %.lr.ph232, !llvm.loop !97
...
.lr.ph240.preheader:                              ; preds = %.preheader115
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %.073.lcssa, i8 0, i64 %i.bm, i1 false), !tbaa !49
...
.lr.ph245.preheader:                              ; preds = %.preheader114
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %.174.lcssa, i8 0, i64 %i.bx, i1 false), !tbaa !49
...
.lr.ph250.preheader:                              ; preds = %.preheader
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %.275.lcssa, i8 0, i64 %i.cg, i1 false), !tbaa !53
  br label %._crit_edge
...
.lr.ph.i:                                         ; preds = %bb.c, %.lr.ph.i
  ...
  %i.fn = load <16 x float>, ptr %.0399469.i, align 1, !tbaa !49
  ...
  store <16 x float> %i.fo, ptr %.0399469.i, align 1, !tbaa !49
  ...
  br i1 %i.ft, label %.lr.ph.i, label %.preheader467.i, !llvm.loop !98
...
.lr.ph476.i:                                      ; preds = %.preheader467.i, %.lr.ph476.i
  ...
  %i.fu = load <16 x float>, ptr %.1475.i, align 1, !tbaa !49 ; 2 uses
  ...
  %i.gg = load float, ptr %.1400474.i, align 4, !tbaa !53 ; 2 uses
  %i.gh = fcmp fast olt float %i.gg, %i.gf
  %.sroa.speculated.i = select i1 %i.gh, float %i.gf, float %i.gg
  store float %.sroa.speculated.i, ptr %.1400474.i, align 4, !tbaa !53
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %.lr.ph476.i, !llvm.loop !99

._crit_edge.i:                                    ; preds = %.lr.ph476.i, %.preheader467.i
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond548.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond548.not.i, label %.preheader466.i, label %bb.c, !llvm.loop !100
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %epil.iter = phi i32 [ %epil.iter.next, %.lr.ph.epil ], [ 0, %.lr.ph.epil.preheader ]
  store <16 x float> splat (float f0xFF7FFFFF), ptr %.081187.epil, align 1, !tbaa !49
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  %niter = phi i32 [ 0, %.lr.ph.preheader.new ], [ %niter.next.7, %.lr.ph ]
  store <16 x float> splat (float f0xFF7FFFFF), ptr %.081187, align 1, !tbaa !49
...
.lr.ph192:                                        ; preds = %.preheader140, %.lr.ph192
  ...
  store <8 x float> splat (float f0xFF7FFFFF), ptr %.182190, align 1, !tbaa !49
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %min.epilog.iters.check = icmp eq i64 %i.ac, 0
  br i1 %min.epilog.iters.check, label %.lr.ph202.preheader, label %vec.epilog.ph, !prof !56
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  store <8 x float> splat (float f0xFF7FFFFF), ptr %next.gep395, align 4, !tbaa !53
...
.lr.ph197:                                        ; preds = %.preheader139, %.lr.ph197
  ...
  store <4 x float> splat (float f0xFF7FFFFF), ptr %.283195, align 1, !tbaa !49
...
.lr.ph202:                                        ; preds = %.lr.ph202.preheader, %.lr.ph202
  ...
  store float f0xFF7FFFFF, ptr %.384200, align 4, !tbaa !53
...
bb.d:                                             ; preds = %bb.d, %.lr.ph.i
  ...
  %i.cp = load <16 x i16>, ptr %.089133.i, align 1, !tbaa !49 ; 2 uses
  ...
  %i.dj = load float, ptr %.096131.i, align 4, !tbaa !53 ; 2 uses
  %i.dk = fcmp fast olt float %i.dj, %i.di
  %.sroa.speculated.i = select i1 %i.dk, float %i.di, float %i.dj
  store float %.sroa.speculated.i, ptr %.096131.i, align 4, !tbaa !53
...
bb.e:                                             ; preds = %bb.e, %.lr.ph141.i
  ...
  %i.du = load <16 x i16>, ptr %.093136.i, align 1, !tbaa !49 ; 2 uses
  ...
  %i.ed = load float, ptr %.092137.i, align 4, !tbaa !53
  ...
  store <4 x i64> %i.fk, ptr %.093136.i, align 1, !tbaa !49
...
begin_hunk_2_@_ZNK4ncnn18Softmax_x86_avx51221forward_inplace_bf16sERNS_3MatERKNS_6OptionE.omp_outlined.11:bb.a
  %i.ai = load i32, ptr %i.b, align 4, !tbaa !21
...
.noexc.lr.ph:                                     ; preds = %bb.b
  ...
  %i.n = load i32, ptr %4, align 4, !tbaa !21     ; 3 uses
...
.preheader.lr.ph:                                 ; preds = %.noexc
  %i.u = load i32, ptr %5, align 4, !tbaa !21     ; 2 uses
  %i.v = icmp sgt i32 %i.u, 0
  br i1 %i.v, label %.preheader.preheader, label %._crit_edge38

.preheader.preheader:                             ; preds = %.preheader.lr.ph
  %i.w = load ptr, ptr %3, align 8, !tbaa !40, !noalias !356
  %i.x = load i64, ptr %i.l, align 8, !tbaa !44, !noalias !356
  %i.y = mul i64 %i.x, %indvars.iv
  %i.z = load i64, ptr %i.m, align 8, !tbaa !18, !noalias !356
...
.lr.ph.preheader:                                 ; preds = %.preheader
  ...
  %.pre45 = load i32, ptr %7, align 4, !tbaa !21
  br label %.lr.ph

._crit_edge38.loopexit:                           ; preds = %._crit_edge
  %.pre47 = load i32, ptr %i.b, align 4, !tbaa !21
...
._crit_edge38:                                    ; preds = %.preheader.lr.ph, %._crit_edge38.loopexit, %.noexc
  ...
  br i1 %.not.not, label %.noexc, label %._crit_edge41, !llvm.loop !353

._crit_edge.loopexit:                             ; preds = %bb.c
  %.pre46 = load i32, ptr %4, align 4, !tbaa !21
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  ...
  br i1 %i.am, label %.preheader, label %._crit_edge38.loopexit, !llvm.loop !354
...
bb.c:                                             ; preds = %.lr.ph
  %i.ap = load i32, ptr %6, align 4, !tbaa !21    ; 2 uses
  %i.aq = load i32, ptr %7, align 4, !tbaa !21    ; 2 uses
  ...
  %i.av = load i32, ptr %5, align 4, !tbaa !21    ; 2 uses
  %i.aw = icmp slt i32 %i.au, %i.av
  br i1 %i.aw, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !355
...
!12 = !{!"p1 _ZTSN4ncnn9AllocatorE", !11, i64 0}
!13 = !{!"_ZTSN4ncnn6OptionE", !10, i64 0, !10, i64 1, !10, i64 2, !10, i64 3, !7, i64 4, !12, i64 8, !12, i64 16, !7, i64 24, !10, i64 28, !10, i64 29, !10, i64 30, !10, i64 31, !10, i64 32, !10, i64 33, !10, i64 34, !10, i64 35, !10, i64 36, !10, i64 37, !10, i64 38, !10, i64 39, !7, i64 40, !10, i64 44, !10, i64 45, !10, i64 46, !10, i64 47, !6, i64 48, !10, i64 49, !10, i64 50, !10, i64 51, !10, i64 52, !10, i64 53, !10, i64 54, !10, i64 55, !10, i64 56, !10, i64 57, !10, i64 58, !10, i64 59, !10, i64 60, !10, i64 61, !10, i64 62, !10, i64 63}
!14 = !{!"p1 int", !11, i64 0}
!15 = !{!"long", !6, i64 0}
!16 = !{!"_ZTSN4ncnn3MatE", !11, i64 0, !14, i64 8, !15, i64 16, !7, i64 24, !12, i64 32, !7, i64 40, !7, i64 44, !7, i64 48, !7, i64 52, !7, i64 56, !15, i64 64}
!17 = !{!16, !7, i64 24}
!18 = !{!16, !15, i64 16}
!19 = !{!16, !7, i64 40}
!20 = !{!16, !7, i64 44}
...
!27 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !26, i64 0, !15, i64 8, !6, i64 16}
!28 = !{!"_ZTSNSt12_Vector_baseIiSaIiEE17_Vector_impl_dataE", !14, i64 0, !14, i64 8, !14, i64 16}
!29 = !{!"_ZTSNSt12_Vector_baseIiSaIiEE12_Vector_implE", !28, i64 0}
!30 = !{!"_ZTSSt12_Vector_baseIiSaIiEE", !29, i64 0}
!31 = !{!"_ZTSSt6vectorIiSaIiEE", !30, i64 0}
!32 = !{!"p1 _ZTSN4ncnn3MatE", !11, i64 0}
!33 = !{!"_ZTSNSt12_Vector_baseIN4ncnn3MatESaIS1_EE17_Vector_impl_dataE", !32, i64 0, !32, i64 8, !32, i64 16}
!34 = !{!"_ZTSNSt12_Vector_baseIN4ncnn3MatESaIS1_EE12_Vector_implE", !33, i64 0}
!35 = !{!"_ZTSSt12_Vector_baseIN4ncnn3MatESaIS1_EE", !34, i64 0}
!36 = !{!"_ZTSSt6vectorIN4ncnn3MatESaIS1_EE", !35, i64 0}
!37 = !{!"_ZTSN4ncnn5LayerE", !10, i64 8, !10, i64 9, !10, i64 10, !10, i64 11, !10, i64 12, !10, i64 13, !10, i64 14, !10, i64 15, !10, i64 16, !10, i64 17, !10, i64 18, !10, i64 19, !10, i64 20, !10, i64 21, !10, i64 22, !10, i64 23, !10, i64 24, !10, i64 25, !10, i64 26, !10, i64 27, !7, i64 28, !11, i64 32, !7, i64 40, !27, i64 48, !27, i64 80, !31, i64 112, !31, i64 136, !36, i64 160, !36, i64 184}
!38 = !{!"_ZTSN4ncnn7SoftmaxE", !37, i64 0, !7, i64 208}
!39 = !{!38, !7, i64 208}
!40 = !{!16, !11, i64 0}
!41 = !{!13, !7, i64 4}
!42 = !{!15, !15, i64 0}
...
!56 = !{!"branch_weights", i32 8, i32 56}
...
!69 = distinct !{!69, !51}
!70 = distinct !{!70, !51}
!71 = distinct !{!71, !51, !54, !55}
!72 = distinct !{!72, !51, !54, !55}
!73 = distinct !{!73, !51}
!74 = distinct !{!74, !51, !55, !54}
!75 = distinct !{!75, !51}
!76 = distinct !{!76, !51}
!77 = distinct !{!77, !51, !54, !55}
!78 = distinct !{!78, !51, !54, !55}
!79 = distinct !{!79, !51}
!80 = distinct !{!80, !51, !55, !54}
!81 = distinct !{!81, !50}
!82 = distinct !{!82, !51}
!83 = distinct !{!83, !51}
!84 = distinct !{!84, !51, !54, !55}
!85 = distinct !{!85, !51, !54, !55}
!86 = distinct !{!86, !51}
!87 = distinct !{!87, !51, !55, !54}
!88 = distinct !{!88, !"_ZN4ncnn3Mat7channelEi"}
!89 = distinct !{!89, !88, !"_ZN4ncnn3Mat7channelEi: argument 0"}
!90 = !{!89}
!91 = distinct !{!91, !50}
!92 = distinct !{!92, !51}
!93 = distinct !{!93, !51}
!94 = distinct !{!94, !51, !54, !55}
!95 = distinct !{!95, !51, !54, !55}
!96 = distinct !{!96, !51}
!97 = distinct !{!97, !51, !55, !54}
!98 = distinct !{!98, !51}
!99 = distinct !{!99, !51}
!100 = distinct !{!100, !51}
!101 = distinct !{!101, !51}
...
!104 = distinct !{!104, !51}
!105 = distinct !{!105, !51}
!106 = distinct !{!106, !51, !54, !55}
!107 = distinct !{!107, !51, !54, !55}
!108 = distinct !{!108, !51}
!109 = distinct !{!109, !51, !55, !54}
!110 = distinct !{!110, !50}
!111 = distinct !{!111, !51}
!112 = distinct !{!112, !51}
!113 = distinct !{!113, !51}
...
!122 = distinct !{!122, !51}
!123 = distinct !{!123, !51}
!124 = distinct !{!124, !51, !54, !55}
!125 = distinct !{!125, !51, !54, !55}
!126 = distinct !{!126, !51}
!127 = distinct !{!127, !51, !55, !54}
!128 = distinct !{!128, !51}
!129 = distinct !{!129, !50}
!130 = distinct !{!130, !51}
!131 = distinct !{!131, !51}
