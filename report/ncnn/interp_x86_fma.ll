...
iter.check:                                       ; preds = %.preheader
  ...
  %wide.trip.count = zext i32 %i.bk to i64        ; 4 uses
...
iter.check:                                       ; preds = %.preheader
  ...
  %9 = sext i32 %i.bz to i64                      ; 6 uses
  %wide.trip.count = zext i32 %i.bz to i64        ; 4 uses
