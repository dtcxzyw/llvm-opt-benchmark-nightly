...
bb.i:                                             ; preds = %bb.h
  %i.bg = fsub fast float 1.000000e+00, %i.bd
  br label %.sink.split101

.sink.split101:                                   ; preds = %bb.i, %.thread91
  %.sink104 = phi float [ %i.bf, %.thread91 ], [ %i.bg, %bb.i ]
  %.sink103 = phi float [ %i.ba, %.thread91 ], [ %i.bd, %bb.i ]
  %.sink102 = phi float [ %i.bd, %.thread91 ], [ 0.000000e+00, %bb.i ]
  store float %.sink104, ptr %i.av, align 4, !tbaa !70
  store float %.sink103, ptr %i.ar, align 4, !tbaa !70
  store float %.sink102, ptr %i.al, align 4, !tbaa !70
...
bb.j:                                             ; preds = %.sink.split101, %bb.h
  ...
  store i32 %.3, ptr %i.bh, align 4, !tbaa !25
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.dy = getelementptr [4 x i8], ptr %invariant.gep158, i64 %i.do
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.fg = fadd fast float %i.fc, %i.ff
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.eq = getelementptr [2 x i8], ptr %invariant.gep171, i64 %i.dx
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.fv = getelementptr [2 x i8], ptr %invariant.gep171, i64 %i.fc
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.ig = zext i16 %i.ib to i32
  %i.ih = zext i16 %i.hz to i32
