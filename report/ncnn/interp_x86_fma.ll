...
begin_hunk_0_@_ZN4ncnnL12cubic_coeffsEiiPiPfi:bb.a
  ...
  store float %i.aj, ptr %i.ak, align 4, !tbaa !70
  ...
  store float %i.ap, ptr %i.aq, align 4, !tbaa !70
  ...
  store float %i.at, ptr %i.au, align 4, !tbaa !70
...
.sink.split:                                      ; preds = %bb.f, %.thread
  ...
  store float %.sink99, ptr %i.ak, align 4, !tbaa !70
  store float %.sink, ptr %i.aq, align 4, !tbaa !70
  store float 0.000000e+00, ptr %i.au, align 4, !tbaa !70
  br label %bb.g
...
.lr.ph:                                           ; preds = %.lr.ph121, %.lr.ph
  ...
  %i.bv = load <8 x float>, ptr %i.bu, align 32, !tbaa !17
  ...
  store <8 x float> %i.bz, ptr %i.ca, align 32, !tbaa !17
  ...
  br i1 %i.ce, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !128
...
.lr.ph111:                                        ; preds = %.lr.ph111.preheader, %.lr.ph111
  ...
  %i.eo = load <4 x float>, ptr %i.en, align 16, !tbaa !17
  ...
  store <4 x float> %i.es, ptr %i.et, align 16, !tbaa !17
  %indvars.iv.next134 = add nuw nsw i64 %indvars.iv133, 4 ; 3 uses
  %i.eu = or disjoint i64 %indvars.iv.next134, 3
  %i.ev = load i32, ptr %8, align 4, !tbaa !25    ; 3 uses
  %i.ew = sext i32 %i.ev to i64
  %i.ex = icmp slt i64 %i.eu, %i.ew
  br i1 %i.ex, label %.lr.ph111, label %.preheader.loopexit, !llvm.loop !130
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.fg = load float, ptr %gep, align 4, !tbaa !70
  ...
  %i.fj = load float, ptr %gep159, align 4, !tbaa !70
  ...
  store float %i.fl, ptr %i.fm, align 4, !tbaa !70
...
._crit_edge116:                                   ; preds = %scalar.ph, %middle.block, %.preheader.._crit_edge116_crit_edge
  ...
  %i.fp = load i32, ptr %6, align 4, !tbaa !25    ; 2 uses
  %i.fq = sext i32 %i.fp to i64
  %i.fr = icmp slt i64 %indvars.iv.next140, %i.fq
  br i1 %i.fr, label %.lr.ph121, label %._crit_edge122, !llvm.loop !132
...
.lr.ph89:                                         ; preds = %.lr.ph89.preheader, %.lr.ph89
  ...
  %i.fk = load i16, ptr %i.fj, align 2, !tbaa !220
  ...
  %i.fp = load i16, ptr %gep, align 2, !tbaa !220
  ...
  store i16 %i.fx, ptr %i.fy, align 2, !tbaa !220
...
._crit_edge:                                      ; preds = %.lr.ph89, %middle.block, %vec.epilog.middle.block, %.preheader.._crit_edge_crit_edge
  ...
  %i.gb = load i32, ptr %6, align 4, !tbaa !25    ; 2 uses
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %i.cg = load <8 x i16>, ptr %i.cf, align 1, !tbaa !17 ; 2 uses
  ...
  store <8 x i16> %i.cu, ptr %i.cv, align 1, !tbaa !17
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 8 ; 3 uses
  %i.cw = or disjoint i64 %indvars.iv.next, 7
  %i.cx = load i32, ptr %8, align 4, !tbaa !25    ; 3 uses
...
bb.d:                                             ; preds = %.lr.ph124, %bb.d
  ...
  %i.hd = load i64, ptr %i.hc, align 1, !tbaa !17
  ...
  store i64 %i.hr, ptr %i.hq, align 1, !tbaa !17
  %indvars.iv.next146 = add nuw nsw i64 %indvars.iv145, 4 ; 3 uses
  %i.hs = load i32, ptr %8, align 4, !tbaa !25    ; 3 uses
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.hy = load i16, ptr %i.hx, align 2, !tbaa !220
  ...
  %i.ib = load i16, ptr %gep, align 2, !tbaa !220
  %gep172 = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep171, i64 %indvars.iv148
  %i.ic = load i16, ptr %gep172, align 2, !tbaa !220
  ...
  store i16 %i.ir, ptr %i.is, align 2, !tbaa !220
...
._crit_edge:                                      ; preds = %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %.preheader.._crit_edge_crit_edge
  ...
  %i.iv = load i32, ptr %6, align 4, !tbaa !25    ; 2 uses
