...
._crit_edge122:                                   ; preds = %._crit_edge116, %.lr.ph126.split
  %i.am = phi i32 [ %i.t, %.lr.ph126.split ], [ %i.fp, %._crit_edge116 ]
...
.lr.ph121:                                        ; preds = %.lr.ph121.preheader, %._crit_edge116
  %i.an = phi i32 [ %.pre, %.lr.ph121.preheader ], [ %i.ct, %._crit_edge116 ] ; 4 uses
  %indvars.iv139 = phi i64 [ 0, %.lr.ph121.preheader ], [ %indvars.iv.next140, %._crit_edge116 ] ; 2 uses
  %.084118 = phi ptr [ %i.ad, %.lr.ph121.preheader ], [ %i.fn, %._crit_edge116 ] ; 5 uses
  %.085117 = phi ptr [ %i.ak, %.lr.ph121.preheader ], [ %i.fo, %._crit_edge116 ] ; 6 uses
...
.lr.ph:                                           ; preds = %.lr.ph121, %.lr.ph
  ...
  %i.bk = phi i32 [ %i.cc, %.lr.ph ], [ %i.an, %.lr.ph121 ] ; 2 uses
  ...
  %i.bv = load <8 x float>, ptr %i.bu, align 32, !tbaa !20
  %i.bw = fmul fast <8 x float> %i.bp, %i.bc
  %i.bx = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.bq, <8 x float> nofpclass(nan inf) %i.be, <8 x float> nofpclass(nan inf) %i.bw)
  %i.by = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.bs, <8 x float> nofpclass(nan inf) %i.bg, <8 x float> nofpclass(nan inf) %i.bx)
  %i.bz = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.bv, <8 x float> nofpclass(nan inf) %i.bi, <8 x float> nofpclass(nan inf) %i.by)
  %i.ca = getelementptr inbounds nuw [4 x i8], ptr %.085117, i64 %indvars.iv
  store <8 x float> %i.bz, ptr %i.ca, align 32, !tbaa !20
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 8 ; 3 uses
  %i.cb = or disjoint i64 %indvars.iv.next, 7
  %i.cc = load i32, ptr %8, align 4, !tbaa !28    ; 3 uses
  %i.cd = sext i32 %i.cc to i64
  %i.ce = icmp slt i64 %i.cb, %i.cd
  br i1 %i.ce, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !131
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.lr.ph121
  %i.cg = phi i32 [ %i.an, %.lr.ph121 ], [ %i.cc, %._crit_edge.loopexit ] ; 3 uses
  %.0.lcssa = phi i32 [ 0, %.lr.ph121 ], [ %i.cf, %._crit_edge.loopexit ] ; 3 uses
  %i.ch = insertelement <4 x float> poison, float %i.au, i64 0
  %i.ci = shufflevector <4 x float> %i.ch, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cj = insertelement <4 x float> poison, float %i.aw, i64 0
  %i.ck = shufflevector <4 x float> %i.cj, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cl = insertelement <4 x float> poison, float %i.ay, i64 0
  %i.cm = shufflevector <4 x float> %i.cl, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cn = insertelement <4 x float> poison, float %i.ba, i64 0
  %i.co = shufflevector <4 x float> %i.cn, <4 x float> poison, <4 x i32> zeroinitializer
  %i.cp = or disjoint i32 %.0.lcssa, 3
  %i.cq = icmp slt i32 %i.cp, %i.cg
  br i1 %i.cq, label %.lr.ph111.preheader, label %.preheader

.lr.ph111.preheader:                              ; preds = %._crit_edge
  %i.cr = zext nneg i32 %.0.lcssa to i64
  br label %.lr.ph111

.preheader.loopexit:                              ; preds = %.lr.ph111
  %i.cs = trunc nuw nsw i64 %indvars.iv.next134 to i32
  br label %.preheader

.preheader:                                       ; preds = %.preheader.loopexit, %._crit_edge
  %i.ct = phi i32 [ %i.cg, %._crit_edge ], [ %i.ev, %.preheader.loopexit ] ; 6 uses
  %.1.lcssa = phi i32 [ %.0.lcssa, %._crit_edge ], [ %i.cs, %.preheader.loopexit ] ; 2 uses
  %i.cu = icmp slt i32 %.1.lcssa, %i.ct
  br i1 %i.cu, label %.lr.ph115, label %.preheader.._crit_edge116_crit_edge

.preheader.._crit_edge116_crit_edge:              ; preds = %.preheader
  %.pre146 = sext i32 %i.ct to i64
  br label %._crit_edge116

.lr.ph115:                                        ; preds = %.preheader
  %i.cv = shl nuw nsw i32 %i.ct, 1
  %i.cw = zext i32 %.1.lcssa to i64               ; 5 uses
  %i.cx = sext i32 %i.ct to i64                   ; 7 uses
  %i.cy = zext nneg i32 %i.cv to i64              ; 2 uses
  %wide.trip.count = zext i32 %i.ct to i64        ; 2 uses
  %invariant.gep = getelementptr [4 x i8], ptr %i.at, i64 %i.cx ; 2 uses
  %invariant.gep158 = getelementptr inbounds nuw [4 x i8], ptr %i.at, i64 %i.cy ; 2 uses
  %i.cz = sub nsw i64 %wide.trip.count, %i.cw     ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.do = add nuw i64 %index, %i.cw               ; 5 uses
  %i.dp = sub nsw i64 %i.do, %i.cx
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph115, %middle.block
  %indvars.iv136.ph = phi i64 [ %i.cw, %vector.memcheck ], [ %i.cw, %.lr.ph115 ], [ %i.dn, %middle.block ]
  br label %scalar.ph

.lr.ph111:                                        ; preds = %.lr.ph111.preheader, %.lr.ph111
  %indvars.iv133 = phi i64 [ %i.cr, %.lr.ph111.preheader ], [ %indvars.iv.next134, %.lr.ph111 ] ; 3 uses
  %i.ed = phi i32 [ %i.cg, %.lr.ph111.preheader ], [ %i.ev, %.lr.ph111 ] ; 2 uses
  ...
  %10 = zext nneg i32 %i.em to i64
  %i.en = getelementptr inbounds nuw [4 x i8], ptr %i.ee, i64 %10
  %i.eo = load <4 x float>, ptr %i.en, align 16, !tbaa !20
  %i.ep = fmul fast <4 x float> %i.ei, %i.ci
  %i.eq = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ej, <4 x float> nofpclass(nan inf) %i.ck, <4 x float> nofpclass(nan inf) %i.ep)
  %i.er = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.el, <4 x float> nofpclass(nan inf) %i.cm, <4 x float> nofpclass(nan inf) %i.eq)
  %i.es = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.eo, <4 x float> nofpclass(nan inf) %i.co, <4 x float> nofpclass(nan inf) %i.er)
  %i.et = getelementptr inbounds nuw [4 x i8], ptr %.085117, i64 %indvars.iv133
  store <4 x float> %i.es, ptr %i.et, align 16, !tbaa !20
  %indvars.iv.next134 = add nuw nsw i64 %indvars.iv133, 4 ; 3 uses
  %i.eu = or disjoint i64 %indvars.iv.next134, 3
  %i.ev = load i32, ptr %8, align 4, !tbaa !28    ; 3 uses
  %i.ew = sext i32 %i.ev to i64
  %i.ex = icmp slt i64 %i.eu, %i.ew
  br i1 %i.ex, label %.lr.ph111, label %.preheader.loopexit, !llvm.loop !133

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv136 = phi i64 [ %indvars.iv.next137, %scalar.ph ], [ %indvars.iv136.ph, %scalar.ph.preheader ] ; 6 uses
  %i.ey = sub nsw i64 %indvars.iv136, %i.cx
  %i.ez = getelementptr inbounds [4 x i8], ptr %i.at, i64 %i.ey
  %i.fa = load float, ptr %i.ez, align 4, !tbaa !61
  %i.fb = fmul fast float %i.fa, %i.au
  %i.fc = getelementptr inbounds nuw [4 x i8], ptr %i.at, i64 %indvars.iv136
  %i.fd = load float, ptr %i.fc, align 4, !tbaa !61
  %i.fe = fmul fast float %i.fd, %i.aw
  %i.ff = fadd fast float %i.fe, %i.fb
  %gep = getelementptr [4 x i8], ptr %invariant.gep, i64 %indvars.iv136
  %i.fg = load float, ptr %gep, align 4, !tbaa !61
  %i.fh = fmul fast float %i.fg, %i.ay
  %i.fi = fadd fast float %i.ff, %i.fh
  %gep159 = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep158, i64 %indvars.iv136
  %i.fj = load float, ptr %gep159, align 4, !tbaa !61
  %i.fk = fmul fast float %i.fj, %i.ba
  %i.fl = fadd fast float %i.fi, %i.fk
  %i.fm = getelementptr inbounds nuw [4 x i8], ptr %.085117, i64 %indvars.iv136
  store float %i.fl, ptr %i.fm, align 4, !tbaa !61
...
._crit_edge116:                                   ; preds = %scalar.ph, %middle.block, %.preheader.._crit_edge116_crit_edge
  %.pre-phi = phi i64 [ %.pre146, %.preheader.._crit_edge116_crit_edge ], [ %i.cx, %middle.block ], [ %i.cx, %scalar.ph ]
  %i.fn = getelementptr inbounds nuw i8, ptr %.084118, i64 16
  %i.fo = getelementptr inbounds [4 x i8], ptr %.085117, i64 %.pre-phi
  %indvars.iv.next140 = add nuw nsw i64 %indvars.iv139, 1 ; 2 uses
  %i.fp = load i32, ptr %6, align 4, !tbaa !28    ; 2 uses
  %i.fq = sext i32 %i.fp to i64
  %i.fr = icmp slt i64 %indvars.iv.next140, %i.fq
  br i1 %i.fr, label %.lr.ph121, label %._crit_edge122, !llvm.loop !135
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %.lr.ph84, %_ZN4ncnn3MatD2Ev.exit.loopexit, %_ZNK4ncnn3Mat7channelEi.exit
  ...
  br i1 %.not.not, label %_ZNK4ncnn3Mat7channelEi.exit, label %._crit_edge87, !llvm.loop !140
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.lr.ph84.split
  ...
  br i1 %i.bo, label %.lr.ph84.split, label %_ZN4ncnn3MatD2Ev.exit.loopexit, !llvm.loop !141
...
._crit_edge134:                                   ; preds = %._crit_edge, %.lr.ph138.split
  %i.am = phi i32 [ %i.t, %.lr.ph138.split ], [ %i.iv, %._crit_edge ]
...
.lr.ph133:                                        ; preds = %.lr.ph133.preheader, %._crit_edge
  %i.an = phi i32 [ %.pre, %.lr.ph133.preheader ], [ %i.db, %._crit_edge ] ; 4 uses
  %indvars.iv151 = phi i64 [ 0, %.lr.ph133.preheader ], [ %indvars.iv.next152, %._crit_edge ] ; 2 uses
  %.084130 = phi ptr [ %i.ad, %.lr.ph133.preheader ], [ %i.it, %._crit_edge ] ; 2 uses
  %.085129 = phi ptr [ %i.ak, %.lr.ph133.preheader ], [ %i.iu, %._crit_edge ] ; 7 uses
  ...
  %i.au = load <4 x float>, ptr %.084130, align 4, !tbaa !61 ; 17 uses
...
.preheader121:                                    ; preds = %.preheader121.loopexit, %.lr.ph133
  %i.bb = phi i32 [ %i.an, %.lr.ph133 ], [ %i.cx, %.preheader121.loopexit ] ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %i.bj = phi i32 [ %i.an, %.lr.ph ], [ %i.cx, %bb.c ] ; 2 uses
  ...
  %i.bo = load <8 x i16>, ptr %i.bn, align 1, !tbaa !20 ; 2 uses
  ...
  %i.bt = load <8 x i16>, ptr %i.bk, align 1, !tbaa !20 ; 2 uses
  ...
  %i.bz = load <8 x i16>, ptr %i.by, align 1, !tbaa !20 ; 2 uses
  ...
  %i.ce = shl nuw nsw i32 %i.bj, 1
  %9 = zext nneg i32 %i.ce to i64
  %i.cf = getelementptr inbounds nuw [2 x i8], ptr %i.bk, i64 %9
  %i.cg = load <8 x i16>, ptr %i.cf, align 1, !tbaa !20 ; 2 uses
  ...
  %i.ci = shufflevector <8 x i16> <i16 poison, i16 poison, i16 poison, i16 poison, i16 0, i16 0, i16 0, i16 0>, <8 x i16> %i.cg, <8 x i32> <i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
  %i.cj = shufflevector <8 x i16> %i.ch, <8 x i16> %i.ci, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.ck = bitcast <16 x i16> %i.cj to <8 x float>
  %i.cl = fmul fast <8 x float> %i.aw, %i.bs
  %i.cm = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.bx, <8 x float> nofpclass(nan inf) %i.ax, <8 x float> nofpclass(nan inf) %i.cl)
  %i.cn = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.cd, <8 x float> nofpclass(nan inf) %i.ay, <8 x float> nofpclass(nan inf) %i.cm)
  %i.co = call fast noundef nofpclass(nan inf) <8 x float> @llvm.fma.v8f32(<8 x float> nofpclass(nan inf) %i.ck, <8 x float> nofpclass(nan inf) %i.az, <8 x float> nofpclass(nan inf) %i.cn)
  %i.cp = bitcast <8 x float> %i.co to <8 x i32>  ; 2 uses
  %i.cq = shufflevector <8 x i32> %i.cp, <8 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.cr = shufflevector <8 x i32> %i.cp, <8 x i32> poison, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %i.cs = lshr <4 x i32> %i.cq, splat (i32 16)
  %i.ct = lshr <4 x i32> %i.cr, splat (i32 16)
  %i.cu = call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %i.cs, <4 x i32> %i.ct)
  %i.cv = getelementptr inbounds nuw [2 x i8], ptr %.085129, i64 %indvars.iv
  store <8 x i16> %i.cu, ptr %i.cv, align 1, !tbaa !20
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 8 ; 3 uses
  %i.cw = or disjoint i64 %indvars.iv.next, 7
  %i.cx = load i32, ptr %8, align 4, !tbaa !28    ; 3 uses
  %i.cy = sext i32 %i.cx to i64
  %i.cz = icmp slt i64 %i.cw, %i.cy
  br i1 %i.cz, label %bb.c, label %.preheader121.loopexit, !llvm.loop !229

.preheader.loopexit:                              ; preds = %bb.d
  %i.da = trunc nuw nsw i64 %indvars.iv.next146 to i32
  br label %.preheader

.preheader:                                       ; preds = %.preheader.loopexit, %.preheader121
  %i.db = phi i32 [ %i.bb, %.preheader121 ], [ %i.hs, %.preheader.loopexit ] ; 6 uses
  %.1.lcssa = phi i32 [ %.0.lcssa, %.preheader121 ], [ %i.da, %.preheader.loopexit ] ; 2 uses
  %i.dc = icmp slt i32 %.1.lcssa, %i.db
  br i1 %i.dc, label %iter.check, label %.preheader.._crit_edge_crit_edge

.preheader.._crit_edge_crit_edge:                 ; preds = %.preheader
  %.pre158 = sext i32 %i.db to i64
  br label %._crit_edge

iter.check:                                       ; preds = %.preheader
  %i.dd = shl nuw nsw i32 %i.db, 1
  %i.de = zext i32 %.1.lcssa to i64               ; 7 uses
  %i.df = sext i32 %i.db to i64                   ; 9 uses
  %i.dg = zext nneg i32 %i.dd to i64              ; 2 uses
  %wide.trip.count = zext i32 %i.db to i64        ; 2 uses
  %invariant.gep = getelementptr [2 x i8], ptr %i.at, i64 %i.df ; 3 uses
  %invariant.gep171 = getelementptr inbounds nuw [2 x i8], ptr %i.at, i64 %i.dg ; 3 uses
  %i.dh = sub nsw i64 %wide.trip.count, %i.de     ; 7 uses
  %min.iters.check = icmp ult i64 %i.dh, 4
  br i1 %min.iters.check, label %vec.epilog.scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %iter.check
  %i.di = sub i64 %.085129175, %i.al              ; 2 uses
  %i.dj = add nsw i64 %i.as, %i.dg
  %i.dk = shl nsw i64 %i.dj, 1
  %i.dl = sub i64 %i.dk, %i.di
  %diff.check = icmp ugt i64 %i.dl, -32
  %i.dm = add nsw i64 %i.df, %i.as
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.dx = add nuw i64 %index, %i.de               ; 5 uses
  %i.dy = sub nsw i64 %i.dx, %i.df
  %i.dz = getelementptr inbounds [2 x i8], ptr %i.at, i64 %i.dy
  %wide.load = load <16 x i16>, ptr %i.dz, align 2, !tbaa !74
  ...
  %wide.load188 = load <16 x i16>, ptr %i.ee, align 2, !tbaa !74
  ...
  %wide.load189 = load <16 x i16>, ptr %i.ek, align 2, !tbaa !74
  ...
  %wide.load190 = load <16 x i16>, ptr %i.eq, align 2, !tbaa !74
  ...
  store <16 x i16> %i.ey, ptr %i.ez, align 2, !tbaa !74
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %i.fb = add nsw i64 %n.vec191, %i.de
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.fc = add nuw i64 %index200, %i.de            ; 5 uses
  %i.fd = sub nsw i64 %i.fc, %i.df
  %i.fe = getelementptr inbounds [2 x i8], ptr %i.at, i64 %i.fd
  %wide.load201 = load <4 x i16>, ptr %i.fe, align 2, !tbaa !74
  ...
  %wide.load202 = load <4 x i16>, ptr %i.fj, align 2, !tbaa !74
  ...
  %wide.load203 = load <4 x i16>, ptr %i.fp, align 2, !tbaa !74
  ...
  %wide.load204 = load <4 x i16>, ptr %i.fv, align 2, !tbaa !74
  ...
  store <4 x i16> %i.gd, ptr %i.ge, align 2, !tbaa !74
...
vec.epilog.scalar.ph.preheader:                   ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv148.ph = phi i64 [ %i.de, %iter.check ], [ %i.de, %vector.memcheck ], [ %i.dw, %vec.epilog.iter.check ], [ %i.fb, %vec.epilog.middle.block ]
  br label %vec.epilog.scalar.ph

bb.d:                                             ; preds = %.lr.ph124, %bb.d
  %indvars.iv145 = phi i64 [ %i.bi, %.lr.ph124 ], [ %indvars.iv.next146, %bb.d ] ; 3 uses
  %i.gg = phi i32 [ %i.bb, %.lr.ph124 ], [ %i.hs, %bb.d ] ; 2 uses
  ...
  %i.gl = load i64, ptr %i.gk, align 1, !tbaa !20
  ...
  %i.gq = load i64, ptr %i.gh, align 1, !tbaa !20
  ...
  %i.gw = load i64, ptr %i.gv, align 1, !tbaa !20
  ...
  %i.hb = shl nuw nsw i32 %i.gg, 1
  %10 = zext nneg i32 %i.hb to i64
  %i.hc = getelementptr inbounds nuw [2 x i8], ptr %i.gh, i64 %10
  %i.hd = load i64, ptr %i.hc, align 1, !tbaa !20
  %i.he = insertelement <2 x i64> poison, i64 %i.hd, i64 0
  %i.hf = bitcast <2 x i64> %i.he to <8 x i16>
  %i.hg = shufflevector <8 x i16> <i16 0, i16 0, i16 0, i16 0, i16 poison, i16 poison, i16 poison, i16 poison>, <8 x i16> %i.hf, <8 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11>
  %i.hh = bitcast <8 x i16> %i.hg to <4 x float>
  %i.hi = fmul fast <4 x float> %i.be, %i.gp
  %i.hj = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.gu, <4 x float> nofpclass(nan inf) %i.bf, <4 x float> nofpclass(nan inf) %i.hi)
  %i.hk = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.ha, <4 x float> nofpclass(nan inf) %i.bg, <4 x float> nofpclass(nan inf) %i.hj)
  %i.hl = call fast noundef nofpclass(nan inf) <4 x float> @llvm.fma.v4f32(<4 x float> nofpclass(nan inf) %i.hh, <4 x float> nofpclass(nan inf) %i.bh, <4 x float> nofpclass(nan inf) %i.hk)
  %i.hm = bitcast <4 x float> %i.hl to <4 x i32>
  %i.hn = lshr <4 x i32> %i.hm, splat (i32 16)
  %i.ho = call <8 x i16> @llvm.x86.sse41.packusdw(<4 x i32> %i.hn, <4 x i32> poison)
  %i.hp = bitcast <8 x i16> %i.ho to <2 x i64>
  %i.hq = getelementptr inbounds nuw [2 x i8], ptr %.085129, i64 %indvars.iv145
  %i.hr = extractelement <2 x i64> %i.hp, i64 0
  store i64 %i.hr, ptr %i.hq, align 1, !tbaa !20
  %indvars.iv.next146 = add nuw nsw i64 %indvars.iv145, 4 ; 3 uses
  %i.hs = load i32, ptr %8, align 4, !tbaa !28    ; 3 uses
  %i.ht = trunc i64 %indvars.iv.next146 to i32
  %i.hu = or i32 %i.ht, 3
  %i.hv = icmp slt i32 %i.hu, %i.hs
  br i1 %i.hv, label %bb.d, label %.preheader.loopexit, !llvm.loop !232
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.hw = sub nsw i64 %indvars.iv148, %i.df
  %i.hx = getelementptr inbounds [2 x i8], ptr %i.at, i64 %i.hw
  %i.hy = load i16, ptr %i.hx, align 2, !tbaa !74
  %i.hz = getelementptr inbounds nuw [2 x i8], ptr %i.at, i64 %indvars.iv148
  %i.ia = load i16, ptr %i.hz, align 2, !tbaa !74
  %gep = getelementptr [2 x i8], ptr %invariant.gep, i64 %indvars.iv148
  %i.ib = load i16, ptr %gep, align 2, !tbaa !74
  %gep172 = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep171, i64 %indvars.iv148
  %i.ic = load i16, ptr %gep172, align 2, !tbaa !74
  %i.id = zext i16 %i.ic to i32
  %i.ie = zext i16 %i.ib to i32
  %i.if = zext i16 %i.hy to i32
  %i.ig = zext i16 %i.ia to i32
  %i.ih = insertelement <4 x i32> poison, i32 %i.if, i64 0
  %i.ii = insertelement <4 x i32> %i.ih, i32 %i.ig, i64 1
  %i.ij = insertelement <4 x i32> %i.ii, i32 %i.ie, i64 2
  %i.ik = insertelement <4 x i32> %i.ij, i32 %i.id, i64 3
  %i.il = shl nuw <4 x i32> %i.ik, splat (i32 16)
  %i.im = bitcast <4 x i32> %i.il to <4 x float>
  %i.in = fmul fast <4 x float> %i.au, %i.im
  %i.io = call fast float @llvm.vector.reduce.fadd.v4f32(float 0.000000e+00, <4 x float> %i.in)
  %i.ip = bitcast float %i.io to i32
  %i.iq = lshr i32 %i.ip, 16
  %i.ir = trunc nuw i32 %i.iq to i16
  %i.is = getelementptr inbounds nuw [2 x i8], ptr %.085129, i64 %indvars.iv148
...
._crit_edge:                                      ; preds = %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %.preheader.._crit_edge_crit_edge
  %.pre-phi = phi i64 [ %.pre158, %.preheader.._crit_edge_crit_edge ], [ %i.df, %middle.block ], [ %i.df, %vec.epilog.middle.block ], [ %i.df, %vec.epilog.scalar.ph ]
  %i.it = getelementptr inbounds nuw i8, ptr %.084130, i64 16
  %i.iu = getelementptr inbounds [2 x i8], ptr %.085129, i64 %.pre-phi
  %indvars.iv.next152 = add nuw nsw i64 %indvars.iv151, 1 ; 2 uses
  %i.iv = load i32, ptr %6, align 4, !tbaa !28    ; 2 uses
  %i.iw = sext i32 %i.iv to i64
  %i.ix = icmp slt i64 %indvars.iv.next152, %i.iw
  br i1 %i.ix, label %.lr.ph133, label %._crit_edge134, !llvm.loop !234
