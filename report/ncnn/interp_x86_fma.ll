...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.dv = fadd fast <8 x float> %i.ds, %i.du
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.fh = fadd fast float %i.fd, %i.fg
...
vector.body444:                                   ; preds = %vector.body444, %vector.ph434
  ...
  %i.tk = fadd fast <8 x float> %i.th, %i.tj
...
.lr.ph78.i.i:                                     ; preds = %.lr.ph78.i.i.preheader, %.lr.ph78.i.i
  ...
  %i.un = fadd fast float %i.uj, %i.um
...
vector.body410:                                   ; preds = %vector.body410, %vector.ph400
  ...
  %i.bbp = fadd fast <8 x float> %i.bbm, %i.bbo
...
.lr.ph78.i.i42:                                   ; preds = %.lr.ph78.i.i42.preheader, %.lr.ph78.i.i42
  ...
  %i.bcs = fadd fast float %i.bco, %i.bcr
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.dmc = fadd fast <8 x float> %i.dlz, %i.dmb
...
.lr.ph78.i.i75:                                   ; preds = %.lr.ph78.i.i75.preheader, %.lr.ph78.i.i75
  ...
  %i.dnf = fadd fast float %i.dnb, %i.dne
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ek = fadd fast <16 x float> %i.ee, %i.ej
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.fp = fadd fast <4 x float> %i.fj, %i.fo
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.ih = zext i16 %i.ic to i32
  %i.ii = zext i16 %i.ia to i32
  %i.ij = insertelement <4 x i32> poison, i32 %i.ii, i64 0
  %i.ik = insertelement <4 x i32> %i.ij, i32 %i.ih, i64 1
...
vector.body436:                                   ; preds = %vector.body436, %vector.ph426
  ...
  %i.vq = fadd fast <8 x float> %i.vn, %i.vp
...
vector.body414:                                   ; preds = %vector.body414, %vector.ph404
  ...
  %i.asp = fadd fast <8 x float> %i.asm, %i.aso
...
.lr.ph81.i.i42:                                   ; preds = %.lr.ph81.i.i42.preheader, %.lr.ph81.i.i42
  ...
  %i.aua = fadd fast float %i.atw, %i.atz
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bhk = fadd fast <8 x float> %i.bhh, %i.bhj
...
.lr.ph81.i.i83:                                   ; preds = %.lr.ph81.i.i83.preheader, %.lr.ph81.i.i83
  ...
  %i.biv = fadd fast float %i.bir, %i.biu
