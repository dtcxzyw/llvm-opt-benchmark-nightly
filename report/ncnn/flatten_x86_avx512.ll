...
.lr.ph.preheader:                                 ; preds = %.noexc
  ...
  %i.ar = sext i32 %i.aq to i64
  %i.as = getelementptr inbounds i8, ptr %i.q, i64 %i.ar
  %i.at = load ptr, ptr %3, align 8, !tbaa !20, !noalias !301
  %i.au = load i64, ptr %i.l, align 8, !tbaa !23, !noalias !301
  %i.av = mul i64 %i.au, %indvars.iv
  %i.aw = load i64, ptr %i.m, align 8, !tbaa !16, !noalias !301
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.bz, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !300
...
.lr.ph.preheader:                                 ; preds = %.noexc
  ...
  %i.x = load ptr, ptr %3, align 8, !tbaa !20, !noalias !306
  %i.y = load i64, ptr %i.l, align 8, !tbaa !23, !noalias !306
  %i.z = mul i64 %i.y, %indvars.iv
  %i.aa = load i64, ptr %i.m, align 8, !tbaa !16, !noalias !306
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.ai, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !304
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.noexc
  ...
  br i1 %.not.not, label %.noexc, label %._crit_edge36, !llvm.loop !305
...
!299 = distinct !{!299, !298, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!300 = distinct !{!300, !38}
!301 = !{!299}
!302 = distinct !{!302, !"_ZNK4ncnn3Mat7channelEi"}
!303 = distinct !{!303, !302, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!304 = distinct !{!304, !38}
!305 = distinct !{!305, !46}
!306 = !{!303}
end_hunk_0
