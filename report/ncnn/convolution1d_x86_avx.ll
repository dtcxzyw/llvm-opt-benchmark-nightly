...
bb.t:                                             ; preds = %._crit_edge1230.i
  ...
  %i.abs = fmul fast <4 x float> %i.abr, %i.abr
  ...
  %i.acj = fmul fast <4 x float> %i.aci, %i.abr
  %i.ack = fmul fast <4 x float> %i.abq, splat (float f0x3F317218)
  %reass.add1066.i = fadd fast <4 x float> %i.acj, splat (float -5.000000e-01)
  %reass.mul.i = fmul fast <4 x float> %i.abs, %reass.add1066.i
  %i.acl = fadd fast <4 x float> %i.ack, %i.abr
  %i.acm = fadd fast <4 x float> %reass.mul.i, %i.acl
...
bb.r:                                             ; preds = %._crit_edge1300.i
  ...
  %i.aip = fmul fast <4 x float> %i.aio, %i.aio
  ...
  %i.ajg = fmul fast <4 x float> %i.ajf, %i.aio
  %i.ajh = fmul fast <4 x float> %i.ain, splat (float f0x3F317218)
  %reass.add1136.i = fadd fast <4 x float> %i.ajg, splat (float -5.000000e-01)
  %reass.mul.i = fmul fast <4 x float> %i.aip, %reass.add1136.i
  %i.aji = fadd fast <4 x float> %i.ajh, %i.aio
  %i.ajj = fadd fast <4 x float> %reass.mul.i, %i.aji
...
.noexc221:                                        ; preds = %._crit_edge693
  ...
  %i.xb = fmul fast <8 x float> %i.xa, %i.xa
  ...
  %i.xs = fmul fast <8 x float> %i.xr, %i.xa
  %i.xt = fmul fast <8 x float> %i.wz, splat (float f0x3F317218)
  %reass.add550 = fadd fast <8 x float> %i.xs, splat (float -5.000000e-01)
  %reass.mul = fmul fast <8 x float> %i.xb, %reass.add550
  %i.xu = fadd fast <8 x float> %i.xt, %i.xa
...
.noexc221:                                        ; preds = %._crit_edge771
  ...
  %i.aee = fmul fast <8 x float> %i.aed, %i.aed
  ...
  %i.aev = fmul fast <8 x float> %i.aeu, %i.aed
  %i.aew = fmul fast <8 x float> %i.aec, splat (float f0x3F317218)
  %reass.add628 = fadd fast <8 x float> %i.aev, splat (float -5.000000e-01)
  %reass.mul = fmul fast <8 x float> %i.aee, %reass.add628
  %i.aex = fadd fast <8 x float> %i.aew, %i.aed
