...
_ZN4ncnn3MatD2Ev.exit1005.lr.ph.i:                ; preds = %bb.k, %bb.j, %bb.h, %bb.f
  ...
  %i.gs = mul i32 %i.fs, 7
  %i.gt = and i32 %i.gh, -8
  %i.gu = add nuw i32 %i.gt, 8                    ; 4 uses
  %i.gv = add i32 %i.n, -4
...
_ZN4ncnn3MatD2Ev.exit1004.lr.ph.i:                ; preds = %.preheader1103.i
  ...
  %i.ii = and i32 %i.hw, -8
  %i.ij = add nuw i32 %i.ii, 8                    ; 4 uses
  %i.ik = add i32 %i.n, -4
...
_ZN4ncnn3MatD2Ev.exit1003.lr.ph.i:                ; preds = %.preheader1095.i
  ...
  %i.adp = add nuw i32 %i.ado, 8                  ; 4 uses
  %i.adq = add i32 %i.n, -4
...
_ZN4ncnn3MatD2Ev.exit.lr.ph.i:                    ; preds = %.preheader1087.i
  ...
  %i.asd = add nuw i32 %i.asc, 8                  ; 4 uses
  %i.ase = add i32 %i.n, -4
...
_ZN4ncnn3MatD2Ev.exit1005.lr.ph.i:                ; preds = %bb.h, %bb.g, %bb.e, %bb.c
  ...
  %i.gm = mul i32 %i.fm, 7
  %i.gn = and i32 %i.gb, -8
  %i.go = add nuw i32 %i.gn, 8                    ; 4 uses
  %i.gp = add i32 %i.h, -4
...
_ZN4ncnn3MatD2Ev.exit1004.lr.ph.i:                ; preds = %.preheader1103.i
  ...
  %i.ia = and i32 %i.ho, -8
  %i.ib = add nuw i32 %i.ia, 8                    ; 4 uses
  %i.ic = add i32 %i.h, -4
...
_ZN4ncnn3MatD2Ev.exit1003.lr.ph.i:                ; preds = %.preheader1095.i
  ...
  %i.adx = add nuw i32 %i.adw, 8                  ; 4 uses
  %i.ady = add i32 %i.h, -4
...
_ZN4ncnn3MatD2Ev.exit.lr.ph.i:                    ; preds = %.preheader1087.i
  ...
  %i.auv = add nuw i32 %i.auu, 8                  ; 4 uses
  %i.auw = add i32 %i.h, -4
