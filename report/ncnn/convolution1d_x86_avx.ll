...
_ZN4ncnn3MatD2Ev.exit1003.lr.ph.i:                ; preds = %.preheader1095.i
  ...
  %2 = zext i32 %i.acr to i64                     ; 7 uses
  %i.acs = mul i32 %i.j, 3
  %3 = zext i32 %i.acs to i64                     ; 7 uses
  %i.act = shl i32 %i.j, 2                        ; 3 uses
  %4 = zext nneg i32 %i.act to i64                ; 2 uses
  %i.acu = mul nuw nsw i32 %i.j, 5
  %5 = zext nneg i32 %i.acu to i64                ; 2 uses
  %i.acv = mul nuw nsw i32 %i.j, 6
  %6 = zext nneg i32 %i.acv to i64                ; 2 uses
  %i.acw = mul nuw nsw i32 %i.j, 7
  %7 = zext nneg i32 %i.acw to i64                ; 2 uses
  %i.acx = shl i32 %i.j, 3
  %8 = sext i32 %i.acx to i64                     ; 3 uses
  %9 = sext i32 %i.act to i64                     ; 4 uses
  %i.acy = sext i32 %i.acr to i64                 ; 3 uses
  ...
  %i.ady = add nuw nsw i64 %i.adx, %i.adw         ; 2 uses
  %i.adz = shl nsw i64 %9, 2
  %i.aea = add i32 %i.n, -4
  %i.aeb = shl nuw nsw i64 %2, 2                  ; 3 uses
  %i.aec = add nuw nsw i64 %i.adx, %i.aeb         ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit.lr.ph.i:                    ; preds = %.preheader1087.i
  ...
  %i.arl = shl i32 %i.j, 2                        ; 2 uses
  %i.arm = sext i32 %i.arl to i64                 ; 3 uses
  %i.arn = shl i32 %i.j, 1                        ; 2 uses
  ...
  %min.iters.check707 = icmp ult i32 %i.j, 16
  %stride.check700 = icmp slt i32 %i.arl, 0
  ...
  %min.iters.check660 = icmp ult i32 %i.j, 10
  %stride.check659 = icmp slt i32 %i.arn, 0
...
._crit_edge1344.us.i:                             ; preds = %bb.an
  %i.awp = getelementptr inbounds nuw [4 x i8], ptr %.08781346.us.i, i64 %8 ; 2 uses
  %i.awq = getelementptr inbounds nuw [4 x i8], ptr %.08751347.us.i, i64 %8 ; 2 uses
...
.preheader1090.preheader.i:                       ; preds = %.preheader1090.lr.ph.i, %.preheader1094.thread.i
  ...
  %i.axu = mul nsw i64 %i.axt, %9                 ; 2 uses
...
._crit_edge1360.us.i:                             ; preds = %scalar.ph596, %middle.block613
  ...
  %i.azv = getelementptr inbounds nuw [4 x i8], ptr %.18791362.us.i, i64 %9 ; 2 uses
  %i.azw = getelementptr inbounds nuw [4 x i8], ptr %.18761363.us.i, i64 %9 ; 2 uses
...
._crit_edge1380.us.i:                             ; preds = %scalar.ph516.prol.loopexit, %scalar.ph516, %middle.block529
  ...
  %i.bcd = getelementptr inbounds nuw [4 x i8], ptr %.28801382.us.i, i64 %i.acy ; 2 uses
  %i.bce = getelementptr inbounds nuw [4 x i8], ptr %.28771383.us.i, i64 %i.acy ; 2 uses
...
vector.memcheck678:                               ; preds = %.preheader1082.us.i
  ...
  %10 = or i1 %found.conflict696, %stride.check700
  %conflict.rdx697 = or i1 %found.conflict693, %10
  ...
  %conflict.rdx701 = or i1 %found.conflict700, %conflict.rdx697
  ...
  %conflict.rdx705 = or i1 %found.conflict704, %conflict.rdx701
...
vector.memcheck644:                               ; preds = %.preheader1081.us.i
  ...
  %11 = or i1 %found.conflict657, %stride.check659
  %conflict.rdx658 = or i1 %found.conflict654, %11
...
_ZN4ncnn3MatD2Ev.exit1003.lr.ph.i:                ; preds = %.preheader1095.i
  ...
  %i.acz = shl i32 %i.d, 1                        ; 2 uses
  %2 = zext nneg i32 %i.acz to i64                ; 6 uses
  %i.ada = mul nuw nsw i32 %i.d, 3
  %3 = zext nneg i32 %i.ada to i64                ; 6 uses
  %i.adb = shl i32 %i.d, 2                        ; 2 uses
  %4 = zext nneg i32 %i.adb to i64                ; 2 uses
  %i.adc = mul nuw nsw i32 %i.d, 5
  %5 = zext nneg i32 %i.adc to i64                ; 2 uses
  %i.add = mul nuw nsw i32 %i.d, 6
  %6 = zext nneg i32 %i.add to i64                ; 2 uses
  %i.ade = mul nuw nsw i32 %i.d, 7
  %7 = zext nneg i32 %i.ade to i64                ; 2 uses
  %i.adf = shl i32 %i.d, 3
  %8 = sext i32 %i.adf to i64                     ; 3 uses
  %9 = sext i32 %i.adb to i64                     ; 3 uses
  %i.adg = sext i32 %i.acz to i64                 ; 2 uses
...
._crit_edge1344.us.i:                             ; preds = %bb.ak
  %i.axu = getelementptr inbounds nuw [4 x i8], ptr %.08781346.us.i, i64 %8 ; 2 uses
  %i.axv = getelementptr inbounds nuw [4 x i8], ptr %.08751347.us.i, i64 %8 ; 2 uses
...
.preheader1090.preheader.i:                       ; preds = %.preheader1090.lr.ph.i, %.preheader1094.thread.i
  ...
  %i.ayf = mul nsw i64 %i.aye, %9                 ; 2 uses
...
._crit_edge1360.us.i:                             ; preds = %scalar.ph367, %middle.block384
  ...
  %i.bax = getelementptr inbounds nuw [4 x i8], ptr %.18791362.us.i, i64 %9 ; 2 uses
  %i.bay = getelementptr inbounds nuw [4 x i8], ptr %.18761363.us.i, i64 %9 ; 2 uses
...
._crit_edge1380.us.i:                             ; preds = %scalar.ph350, %middle.block363
  ...
  %i.bcm = getelementptr inbounds nuw [4 x i8], ptr %.28801382.us.i, i64 %i.adg ; 2 uses
  %i.bcn = getelementptr inbounds nuw [4 x i8], ptr %.28771383.us.i, i64 %i.adg ; 2 uses
