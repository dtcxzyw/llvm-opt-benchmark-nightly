...
bb.hm:                                            ; preds = %bb.hl
  call void @free(ptr noundef nonnull %i.ww) #12
  br label %bb.hn
...
bb.hs:                                            ; preds = %bb.hr
  call void @free(ptr noundef nonnull %i.xx) #12
...
bb.ht:                                            ; preds = %bb.hq
  ...
  call void @__clang_call_terminate(ptr %i.yc) #17
  unreachable
...
bb.hz:                                            ; preds = %bb.hy
  call void @free(ptr noundef nonnull %i.yj) #12
...
bb.ia:                                            ; preds = %bb.hx
  ...
  call void @__clang_call_terminate(ptr %i.yo) #17
  unreachable
...
bb.ih:                                            ; preds = %bb.ig
  call void @free(ptr noundef nonnull %i.zd) #12
...
bb.ii:                                            ; preds = %bb.if
  ...
  call void @__clang_call_terminate(ptr %i.zi) #17
  unreachable
...
vector.body360:                                   ; preds = %.lr.ph234, %vector.body360
  ...
  %wide.load362 = load <4 x float>, ptr %i.ft, align 4, !tbaa !59, !alias.scope !101
  %wide.load363 = load <4 x float>, ptr %i.fu, align 4, !tbaa !59, !alias.scope !101
  %i.fv = getelementptr inbounds nuw [4 x i8], ptr %i.fs, i64 %index361 ; 2 uses
  %i.fw = getelementptr inbounds nuw i8, ptr %i.fv, i64 16
  store <4 x float> %wide.load362, ptr %i.fv, align 4, !tbaa !59, !alias.scope !102, !noalias !101
  store <4 x float> %wide.load363, ptr %i.fw, align 4, !tbaa !59, !alias.scope !102, !noalias !101
  %index.next364 = add nuw i64 %index361, 8       ; 2 uses
  %i.fx = icmp eq i64 %index.next364, %n.vec359
  br i1 %i.fx, label %middle.block365, label %vector.body360, !llvm.loop !95
...
scalar.ph356.prol:                                ; preds = %scalar.ph356.preheader, %scalar.ph356.prol
  ...
  br i1 %prol.iter371.cmp.not, label %scalar.ph356.prol.loopexit, label %scalar.ph356.prol, !llvm.loop !96
...
._crit_edge235:                                   ; preds = %scalar.ph356.prol.loopexit, %scalar.ph356, %middle.block365
  ...
  br i1 %exitcond258.not, label %_ZN4ncnn3MataSERKS0_.exit207.loopexit, label %.lr.ph234, !llvm.loop !97
...
scalar.ph356:                                     ; preds = %scalar.ph356.prol.loopexit, %scalar.ph356
  ...
  br i1 %exitcond253.not.3, label %._crit_edge235, label %scalar.ph356, !llvm.loop !98
...
bb.ak:                                            ; preds = %bb.aj
  call void @free(ptr noundef nonnull %i.gw) #12
...
bb.ar:                                            ; preds = %bb.aq
  call void @free(ptr noundef nonnull %i.ip) #12
  br label %.thread335
...
bb.bd:                                            ; preds = %bb.bc
  call void @free(ptr noundef nonnull %i.jy) #12
...
bb.bv:                                            ; preds = %bb.bu
  call void @free(ptr noundef nonnull %i.mm) #12
