...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = fmul fast <16 x float> %i.aa, splat (float 6.000000e+00)
  %6 = fsub fast <16 x float> splat (float 3.750000e+00), %i.ad
  %i.ae = fmul fast <16 x float> %i.ac, %6
  %i.af = fsub fast <16 x float> splat (float 3.000000e+00), %5
  %i.ag = fadd fast <16 x float> %i.ae, %i.af     ; 4 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %7 = fmul fast <4 x float> %i.bx, splat (float 6.000000e+00)
  %8 = fsub fast <4 x float> splat (float 3.750000e+00), %i.ca
  %i.cb = fmul fast <4 x float> %i.bz, %8
  %i.cc = fsub fast <4 x float> splat (float 3.000000e+00), %7
  %i.cd = fadd fast <4 x float> %i.cb, %i.cc      ; 4 uses
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %bb.i
  ...
  %9 = fmul fast float %i.dr, 6.000000e+00
  %10 = fsub fast float 3.750000e+00, %i.du
  %reass.mul.i = fmul fast float %i.dt, %10
  %i.dv = fsub fast float 3.000000e+00, %9
  %i.dw = fadd fast float %reass.mul.i, %i.dv     ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ft = fadd fast <16 x float> %i.fp, %i.fh
  %i.fu = fadd fast <16 x float> %i.fq, %i.fi
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.hf = fadd fast <8 x float> %i.he, %i.hc
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.ir = fadd fast float %i.iq, %i.in
...
vector.body845:                                   ; preds = %vector.body845, %vector.ph835
  ...
  %i.sr = fadd fast <16 x float> %i.sn, %i.sf
...
vec.epilog.vector.body881:                        ; preds = %vec.epilog.vector.body881, %vec.epilog.ph871
  ...
  %i.ub = fadd fast <8 x float> %i.ua, %i.ty
...
vector.body774:                                   ; preds = %vector.body774, %vector.ph764
  ...
  %i.bda = fadd fast <16 x float> %i.bcw, %i.bco
  %i.bdb = fadd fast <16 x float> %i.bcx, %i.bcp
  %i.bdc = fadd fast <16 x float> %i.bcy, %i.bcq
  %i.bdd = fadd fast <16 x float> %i.bcz, %i.bcr
...
vec.epilog.vector.body810:                        ; preds = %vec.epilog.vector.body810, %vec.epilog.ph800
  ...
  %i.ben = fadd fast <8 x float> %i.bem, %i.bek
...
.lr.ph112.i.i44:                                  ; preds = %.lr.ph112.i.i44.preheader, %.lr.ph112.i.i44
  ...
  %i.bfs = fadd fast float %i.bfr, %i.bfo
...
vector.body703:                                   ; preds = %vector.body703, %vector.ph693
  ...
  %i.dpj = fadd fast <16 x float> %i.dpf, %i.dox
  %i.dpk = fadd fast <16 x float> %i.dpg, %i.doy
  %i.dpl = fadd fast <16 x float> %i.dph, %i.doz
  %i.dpm = fadd fast <16 x float> %i.dpi, %i.dpa
...
vec.epilog.vector.body739:                        ; preds = %vec.epilog.vector.body739, %vec.epilog.ph729
  ...
  %i.dqw = fadd fast <8 x float> %i.dqv, %i.dqt
...
.lr.ph112.i.i83:                                  ; preds = %.lr.ph112.i.i83.preheader, %.lr.ph112.i.i83
  ...
  %i.dsb = fadd fast float %i.dsa, %i.drx
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.erd = fadd fast <16 x float> %i.eqz, %i.eqr
  %i.ere = fadd fast <16 x float> %i.era, %i.eqs
  %i.erf = fadd fast <16 x float> %i.erb, %i.eqt
  %i.erg = fadd fast <16 x float> %i.erc, %i.equ
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.esq = fadd fast <8 x float> %i.esp, %i.esn
...
.lr.ph112.i.i122:                                 ; preds = %.lr.ph112.i.i122.preheader, %.lr.ph112.i.i122
  ...
  %i.etv = fadd fast float %i.etu, %i.etr
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ht = fadd fast <32 x float> %i.hs, %i.hn
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.iy = fadd fast <8 x float> %i.ix, %i.is
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.lu = fadd fast float %i.lt, %i.ln
...
vector.body972:                                   ; preds = %vector.body972, %vector.ph962
  ...
  %i.aeb = fadd fast <16 x float> %i.adx, %i.adp
  %i.aec = fadd fast <16 x float> %i.ady, %i.adq
  %i.aed = fadd fast <16 x float> %i.adz, %i.adr
  %i.aee = fadd fast <16 x float> %i.aea, %i.ads
...
vec.epilog.vector.body1008:                       ; preds = %vec.epilog.vector.body1008, %vec.epilog.ph998
  ...
  %i.aga = fadd fast <8 x float> %i.afz, %i.afx
...
.lr.ph112.i.i:                                    ; preds = %.lr.ph112.i.i.preheader, %.lr.ph112.i.i
  ...
  %i.ahn = fadd fast float %i.ahm, %i.ahj
...
vector.body913:                                   ; preds = %vector.body913, %vector.ph903
  ...
  %i.bey = fadd fast <16 x float> %i.beu, %i.bem
  %i.bez = fadd fast <16 x float> %i.bev, %i.ben
  %i.bfa = fadd fast <16 x float> %i.bew, %i.beo
  %i.bfb = fadd fast <16 x float> %i.bex, %i.bep
...
vec.epilog.vector.body949:                        ; preds = %vec.epilog.vector.body949, %vec.epilog.ph939
  ...
  %i.bgx = fadd fast <8 x float> %i.bgw, %i.bgu
...
.lr.ph112.i.i45:                                  ; preds = %.lr.ph112.i.i45.preheader, %.lr.ph112.i.i45
  ...
  %i.bik = fadd fast float %i.bij, %i.big
...
vector.body854:                                   ; preds = %vector.body854, %vector.ph844
  ...
  %i.cfv = fadd fast <16 x float> %i.cfr, %i.cfj
  %i.cfw = fadd fast <16 x float> %i.cfs, %i.cfk
  %i.cfx = fadd fast <16 x float> %i.cft, %i.cfl
  %i.cfy = fadd fast <16 x float> %i.cfu, %i.cfm
...
vec.epilog.vector.body890:                        ; preds = %vec.epilog.vector.body890, %vec.epilog.ph880
  ...
  %i.chu = fadd fast <8 x float> %i.cht, %i.chr
...
.lr.ph112.i.i96:                                  ; preds = %.lr.ph112.i.i96.preheader, %.lr.ph112.i.i96
  ...
  %i.cjh = fadd fast float %i.cjg, %i.cjd
...
vector.body613:                                   ; preds = %vector.main.loop.iter.check609, %vector.body613
  ...
  %i.cth = fadd fast <16 x float> %i.ctg, %i.crw
...
vec.epilog.vector.body629:                        ; preds = %vec.epilog.vector.body629, %vec.epilog.ph627
  ...
  %i.cyz = fadd fast <4 x float> %i.cyy, %i.cym
...
vector.body661:                                   ; preds = %vector.main.loop.iter.check657, %vector.body661
  ...
  %i.dhu = fadd fast <16 x float> %i.dht, %i.dgj
  ...
  %i.dpi = fadd fast <16 x float> %i.dph, %i.dnx
...
vec.epilog.vector.body680:                        ; preds = %vec.epilog.vector.body680, %vec.epilog.ph678
  ...
  %i.dve = fadd fast <4 x float> %i.dvd, %i.dur
  ...
  %i.dxq = fadd fast <4 x float> %i.dxp, %i.dxd
...
vector.body726:                                   ; preds = %vector.main.loop.iter.check722, %vector.body726
  ...
  %i.egk = fadd fast <16 x float> %i.egj, %i.eez
  ...
  %i.eny = fadd fast <16 x float> %i.enx, %i.emn
  ...
  %i.evm = fadd fast <16 x float> %i.evl, %i.eub
...
vec.epilog.vector.body745:                        ; preds = %vec.epilog.vector.body745, %vec.epilog.ph743
  ...
  %i.fbm = fadd fast <4 x float> %i.fbl, %i.faz
  ...
  %i.fdy = fadd fast <4 x float> %i.fdx, %i.fdl
  ...
  %i.fgk = fadd fast <4 x float> %i.fgj, %i.ffx
...
vector.body808:                                   ; preds = %vector.main.loop.iter.check804, %vector.body808
  ...
  %i.fqf = fadd fast <16 x float> %i.fqe, %i.fou
  ...
  %i.fxt = fadd fast <16 x float> %i.fxs, %i.fwi
  ...
  %i.gfh = fadd fast <16 x float> %i.gfg, %i.gdw
  ...
  %i.gmv = fadd fast <16 x float> %i.gmu, %i.glk
...
vec.epilog.vector.body827:                        ; preds = %vec.epilog.vector.body827, %vec.epilog.ph825
  ...
  %i.gsz = fadd fast <4 x float> %i.gsy, %i.gsm
  ...
  %i.gvl = fadd fast <4 x float> %i.gvk, %i.guy
  ...
  %i.gxx = fadd fast <4 x float> %i.gxw, %i.gxk
  ...
  %i.haj = fadd fast <4 x float> %i.hai, %i.gzw
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.hhm = fadd fast <16 x float> %i.hhi, %i.hha
  %i.hhn = fadd fast <16 x float> %i.hhj, %i.hhb
  %i.hho = fadd fast <16 x float> %i.hhk, %i.hhc
  %i.hhp = fadd fast <16 x float> %i.hhl, %i.hhd
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.hjl = fadd fast <8 x float> %i.hjk, %i.hji
...
.lr.ph112.i.i142:                                 ; preds = %.lr.ph112.i.i142.preheader, %.lr.ph112.i.i142
  ...
  %i.hky = fadd fast float %i.hkx, %i.hku
