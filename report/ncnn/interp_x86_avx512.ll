...
begin_hunk_0_@_ZN4ncnnL12cubic_coeffsEiiPiPfi:bb.a
  ...
  store float %i.eh, ptr %i.ei, align 4, !tbaa !60
  ...
  store float %i.en, ptr %i.eo, align 4, !tbaa !60
  ...
  store float %i.er, ptr %i.es, align 4, !tbaa !60
...
.sink.split:                                      ; preds = %bb.e, %.thread
  ...
  store float %.sink100, ptr %i.du, align 4, !tbaa !60
  store float %.sink99, ptr %i.ei, align 4, !tbaa !60
  store float %.sink, ptr %i.eo, align 4, !tbaa !60
  store float 0.000000e+00, ptr %i.es, align 4, !tbaa !60
  br label %bb.f
...
.sink.split101:                                   ; preds = %bb.h, %.thread91
  ...
  store float %.sink104, ptr %i.es, align 4, !tbaa !60
  store float %.sink103, ptr %i.eo, align 4, !tbaa !60
  store float %.sink102, ptr %i.ei, align 4, !tbaa !60
  store float 0.000000e+00, ptr %i.du, align 4, !tbaa !60
  br label %bb.i
...
bb.i:                                             ; preds = %.sink.split101, %bb.g
  ...
  store i32 %.3, ptr %i.fe, align 4, !tbaa !28
...
.lr.ph:                                           ; preds = %.lr.ph155, %.lr.ph
  ...
  %i.bv = load <16 x float>, ptr %i.bu, align 64, !tbaa !20
  ...
  store <16 x float> %i.bz, ptr %i.ca, align 64, !tbaa !20
  ...
  br i1 %i.ce, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !141
...
.lr.ph140:                                        ; preds = %.lr.ph140.preheader, %.lr.ph140
  ...
  %i.cx = load <8 x float>, ptr %i.cw, align 32, !tbaa !20
  %i.cy = load <8 x float>, ptr %i.ct, align 32, !tbaa !20
  %i.cz = getelementptr inbounds [4 x i8], ptr %i.ct, i64 %i.cu
  %i.da = load <8 x float>, ptr %i.cz, align 32, !tbaa !20
  %i.db = shl nsw i32 %i.cs, 1
  %10 = sext i32 %i.db to i64
  %i.dc = getelementptr inbounds [4 x i8], ptr %i.ct, i64 %10
  %i.dd = load <8 x float>, ptr %i.dc, align 32, !tbaa !20
  ...
  store <8 x float> %i.dh, ptr %i.di, align 32, !tbaa !20
  %indvars.iv.next169 = add nuw nsw i64 %indvars.iv168, 8 ; 3 uses
  %i.dj = or disjoint i64 %indvars.iv.next169, 7
  %i.dk = load i32, ptr %8, align 4, !tbaa !28    ; 3 uses
  %i.dl = sext i32 %i.dk to i64
  %i.dm = icmp slt i64 %i.dj, %i.dl
  br i1 %i.dm, label %.lr.ph140, label %._crit_edge141.loopexit, !llvm.loop !142
...
.lr.ph145:                                        ; preds = %.lr.ph145.preheader, %.lr.ph145
  ...
  %11 = sext i32 %i.hv to i64
  %i.hw = getelementptr inbounds [4 x i8], ptr %i.hn, i64 %11
  %i.hx = load <4 x float>, ptr %i.hw, align 16, !tbaa !20
  ...
  store <4 x float> %i.ib, ptr %i.ic, align 16, !tbaa !20
  %indvars.iv.next172 = add nuw nsw i64 %indvars.iv171, 4 ; 3 uses
  %i.id = load i32, ptr %8, align 4, !tbaa !28    ; 3 uses
  %i.ie = trunc i64 %indvars.iv.next172 to i32
  %i.if = or i32 %i.ie, 3
  %i.ig = icmp slt i32 %i.if, %i.id
  br i1 %i.ig, label %.lr.ph145, label %.preheader.loopexit, !llvm.loop !145
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.is = load float, ptr %gep202, align 4, !tbaa !60
  ...
  store float %i.iu, ptr %i.iv, align 4, !tbaa !60
  %indvars.iv.next175 = add nuw nsw i64 %indvars.iv174, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next175, %i.ef
  br i1 %exitcond.not, label %._crit_edge150, label %vec.epilog.scalar.ph, !llvm.loop !146
...
._crit_edge150:                                   ; preds = %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %.preheader.._crit_edge150_crit_edge
  ...
  %i.iy = load i32, ptr %6, align 4, !tbaa !28    ; 2 uses
  %i.iz = sext i32 %i.iy to i64
  %i.ja = icmp slt i64 %indvars.iv.next178, %i.iz
  br i1 %i.ja, label %.lr.ph155, label %._crit_edge156, !llvm.loop !147
...
_ZNK4ncnn3Mat7channelEi.exit:                     ; preds = %_ZNK4ncnn3Mat7channelEi.exit.preheader, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.x = load ptr, ptr %3, align 8, !tbaa !43, !noalias !155
  %i.y = load i64, ptr %i.m, align 8, !tbaa !37, !noalias !155
  %i.z = mul i64 %i.y, %indvars.iv91
  %i.aa = load i64, ptr %i.n, align 8, !tbaa !32, !noalias !155 ; 2 uses
  %i.ab = mul i64 %i.z, %i.aa
  %i.ac = getelementptr inbounds nuw i8, ptr %i.x, i64 %i.ab
  %i.ad = load ptr, ptr %4, align 8, !tbaa !43, !noalias !156
  %i.ae = load i64, ptr %i.p, align 8, !tbaa !37, !noalias !156
  %i.af = mul i64 %i.ae, %indvars.iv91
  %i.ag = load i64, ptr %i.q, align 8, !tbaa !32, !noalias !156 ; 2 uses
...
.lr.ph84:                                         ; preds = %_ZNK4ncnn3Mat7channelEi.exit
  %i.ak = load i32, ptr %i.o, align 4, !tbaa !29, !noalias !156
  %i.al = sext i32 %i.ak to i64
  %i.am = load i32, ptr %i.l, align 4, !tbaa !29, !noalias !155
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %.lr.ph84, %_ZN4ncnn3MatD2Ev.exit.loopexit, %_ZNK4ncnn3Mat7channelEi.exit
  ...
  br i1 %.not.not, label %_ZNK4ncnn3Mat7channelEi.exit, label %._crit_edge87, !llvm.loop !152
...
.lr.ph84.split:                                   ; preds = %.lr.ph84, %._crit_edge
  ...
  %i.ba = load float, ptr %6, align 4, !tbaa !60
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.lr.ph84.split
  ...
  br i1 %i.bo, label %.lr.ph84.split, label %_ZN4ncnn3MatD2Ev.exit.loopexit, !llvm.loop !153
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.br = load float, ptr %9, align 4, !tbaa !60
...
begin_hunk_1_@_ZN4ncnnL24interp_forward_bf16s_sseERKSt6vectorINS_3MatESaIS1_EERS3_RKNS_6OptionEiiffiii.omp_outlined.11:bb.a
  ...
  store i16 %i.hp, ptr %i.hq, align 2, !tbaa !73
...
._crit_edge:                                      ; preds = %.lr.ph112, %middle.block, %vec.epilog.middle.block, %.preheader.._crit_edge_crit_edge
  ...
  %i.ht = load i32, ptr %6, align 4, !tbaa !28    ; 2 uses
...
.lr.ph170:                                        ; preds = %.lr.ph170.preheader, %._crit_edge
  ...
  %i.au = load float, ptr %.0108167, align 4, !tbaa !60 ; 6 uses
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %9 = sext i32 %i.de to i64
  %i.df = getelementptr inbounds [2 x i8], ptr %i.by, i64 %9
  %i.dg = load <16 x i16>, ptr %i.df, align 1, !tbaa !20 ; 2 uses
  ...
  store <4 x i64> %i.dz, ptr %i.ea, align 1, !tbaa !20
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 16 ; 3 uses
  %i.eb = or disjoint i64 %indvars.iv.next, 15
  %i.ec = load i32, ptr %8, align 4, !tbaa !28    ; 3 uses
...
bb.d:                                             ; preds = %.lr.ph158, %bb.d
  ...
  %i.ex = load <8 x i16>, ptr %i.ew, align 1, !tbaa !20 ; 2 uses
  ...
  %i.fc = load <8 x i16>, ptr %i.et, align 1, !tbaa !20 ; 2 uses
  ...
  %i.fi = load <8 x i16>, ptr %i.fh, align 1, !tbaa !20 ; 2 uses
  ...
  %i.fn = shl nsw i32 %i.es, 1
  %10 = sext i32 %i.fn to i64
  %i.fo = getelementptr inbounds [2 x i8], ptr %i.et, i64 %10
  %i.fp = load <8 x i16>, ptr %i.fo, align 1, !tbaa !20 ; 2 uses
  ...
  store <8 x i16> %i.gc, ptr %i.gd, align 1, !tbaa !20
  %indvars.iv.next184 = add nuw nsw i64 %indvars.iv183, 8 ; 3 uses
  %i.ge = load i32, ptr %8, align 4, !tbaa !28    ; 3 uses
...
bb.e:                                             ; preds = %.lr.ph161, %bb.e
  ...
  %11 = sext i32 %i.kj to i64
  %i.kk = getelementptr inbounds [2 x i8], ptr %i.jp, i64 %11
  %i.kl = load i64, ptr %i.kk, align 1, !tbaa !20
  ...
  store i64 %i.kz, ptr %i.ky, align 1, !tbaa !20
  %indvars.iv.next187 = add nuw nsw i64 %indvars.iv186, 4 ; 3 uses
  %i.la = load i32, ptr %8, align 4, !tbaa !28    ; 3 uses
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.lg = load i16, ptr %i.lf, align 2, !tbaa !73
  ...
  %i.lm = load i16, ptr %i.ll, align 2, !tbaa !73
  ...
  %i.ls = load i16, ptr %gep, align 2, !tbaa !73
  ...
  %i.ly = load i16, ptr %gep218, align 2, !tbaa !73
...
._crit_edge:                                      ; preds = %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %.preheader.._crit_edge_crit_edge
  ...
  %i.mk = load i32, ptr %6, align 4, !tbaa !28    ; 2 uses
...
_ZNK4ncnn3Mat7channelEi.exit:                     ; preds = %_ZNK4ncnn3Mat7channelEi.exit.preheader, %_ZN4ncnn3MatD2Ev.exit
  ...
  %i.w = phi i32 [ %i.r, %_ZNK4ncnn3Mat7channelEi.exit.preheader ], [ %i.au, %_ZN4ncnn3MatD2Ev.exit ] ; 3 uses
  %indvars.iv91 = phi i64 [ %i.t, %_ZNK4ncnn3Mat7channelEi.exit.preheader ], [ %indvars.iv.next92, %_ZN4ncnn3MatD2Ev.exit ] ; 4 uses
  %i.x = load ptr, ptr %3, align 8, !tbaa !43, !noalias !292
  %i.y = load i64, ptr %i.m, align 8, !tbaa !37, !noalias !292
  %i.z = mul i64 %i.y, %indvars.iv91
  %i.aa = load i64, ptr %i.n, align 8, !tbaa !32, !noalias !292 ; 2 uses
  %i.ab = mul i64 %i.z, %i.aa
  %i.ac = getelementptr inbounds nuw i8, ptr %i.x, i64 %i.ab
  %i.ad = load ptr, ptr %4, align 8, !tbaa !43, !noalias !293
  %i.ae = load i64, ptr %i.p, align 8, !tbaa !37, !noalias !293
  %i.af = mul i64 %i.ae, %indvars.iv91
  %i.ag = load i64, ptr %i.q, align 8, !tbaa !32, !noalias !293 ; 2 uses
  %i.ah = mul i64 %i.af, %i.ag
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ad, i64 %i.ah
  %i.aj = icmp sgt i32 %i.w, 0
  br i1 %i.aj, label %.lr.ph84, label %_ZN4ncnn3MatD2Ev.exit
...
.lr.ph84:                                         ; preds = %_ZNK4ncnn3Mat7channelEi.exit
  %i.ak = load i32, ptr %i.o, align 4, !tbaa !29, !noalias !293
  %i.al = sext i32 %i.ak to i64
  %i.am = load i32, ptr %i.l, align 4, !tbaa !29, !noalias !292
  %i.an = sext i32 %i.am to i64
  %i.ao = mul i64 %i.aa, %i.an
  %i.ap = mul i64 %i.ag, %i.al
  %i.aq = load i32, ptr %8, align 4, !tbaa !28    ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %.lr.ph84, %_ZN4ncnn3MatD2Ev.exit.loopexit, %_ZNK4ncnn3Mat7channelEi.exit
  ...
  %i.av = sext i32 %i.as to i64
  %.not.not = icmp slt i64 %indvars.iv91, %i.av
  br i1 %.not.not, label %_ZNK4ncnn3Mat7channelEi.exit, label %._crit_edge87, !llvm.loop !289
