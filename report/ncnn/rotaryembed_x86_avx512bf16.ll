...
.preheader:                                       ; preds = %.lr.ph496, %.preheader402
  ...
  %.2254.lcssa686 = ptrtoaddr ptr %.2254.lcssa to i64 ; 2 uses
...
vector.memcheck:                                  ; preds = %iter.check
  ...
  %10 = insertelement <8 x i64> poison, i64 %.2266.lcssa687, i64 0
  %11 = insertelement <8 x i64> %10, i64 %.2270.lcssa689, i64 1
  %12 = insertelement <8 x i64> %11, i64 %.2262.lcssa692, i64 2
  %13 = insertelement <8 x i64> %12, i64 %.2258.lcssa695, i64 3
  %14 = insertelement <4 x i64> poison, i64 %.2254.lcssa686, i64 0
  %i.on = sub i64 %.2266.lcssa687, %.2250.lcssa685
  %15 = sub i64 %.2270.lcssa689, %.2250.lcssa685
  %i.oo = sub i64 %.2262.lcssa692, %.2250.lcssa685
  %16 = insertelement <8 x i64> poison, i64 %i.om, i64 0
  %17 = shufflevector <4 x i64> %14, <4 x i64> poison, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 poison, i32 poison, i32 poison, i32 poison>
  %18 = sub <8 x i64> %13, %17
  %19 = shufflevector <8 x i64> %16, <8 x i64> %18, <8 x i32> <i32 0, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 poison, i32 poison>
  %20 = insertelement <8 x i64> %19, i64 %i.on, i64 5
  %21 = insertelement <8 x i64> %20, i64 %15, i64 6
  %22 = insertelement <8 x i64> %21, i64 %i.oo, i64 7
  %23 = icmp ugt <8 x i64> %22, splat (i64 -64)
  %i.op = sub i64 %.2258.lcssa695, %.2250.lcssa685
  %diff.check702 = icmp ugt i64 %i.op, -64
  %24 = bitcast <8 x i1> %23 to i8
  %25 = icmp ne i8 %24, 0
  %conflict.rdx705 = or i1 %25, %diff.check702
