...
.preheader:                                       ; preds = %.lr.ph496, %.preheader402
  ...
  %.2250.lcssa685 = ptrtoaddr ptr %.2250.lcssa to i64 ; 2 uses
  %.2254.lcssa686 = ptrtoaddr ptr %.2254.lcssa to i64
  %.2266.lcssa687 = ptrtoaddr ptr %.2266.lcssa to i64
  %.2270.lcssa689 = ptrtoaddr ptr %.2270.lcssa to i64
  %.2262.lcssa692 = ptrtoaddr ptr %.2262.lcssa to i64
...
vector.memcheck:                                  ; preds = %iter.check
  %10 = insertelement <8 x i64> poison, i64 %.2254.lcssa686, i64 0 ; 2 uses
  %11 = insertelement <8 x i64> %10, i64 %.2266.lcssa687, i64 1
  %12 = insertelement <8 x i64> %11, i64 %.2270.lcssa689, i64 2
  %13 = insertelement <8 x i64> %12, i64 %.2262.lcssa692, i64 3
  %14 = insertelement <8 x i64> %13, i64 %.2258.lcssa695, i64 4
  ...
  %17 = insertelement <2 x i64> %16, i64 %.2250.lcssa685, i64 0
  ...
  %i.om = sub i64 %.2258.lcssa695, %.2250.lcssa685
  %diff.check704.a = icmp ugt i64 %i.om, -64
  %21 = bitcast <8 x i1> %20 to i8
  %22 = icmp ne i8 %21, 0
  %op.rdx = or i1 %22, %diff.check704.a
