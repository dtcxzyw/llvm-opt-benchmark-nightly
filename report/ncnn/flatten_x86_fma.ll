...
.lr.ph.preheader:                                 ; preds = %.noexc
  ...
  %i.ar = sext i32 %i.aq to i64
  %i.as = getelementptr inbounds i8, ptr %i.q, i64 %i.ar
  %i.at = load ptr, ptr %3, align 8, !tbaa !20, !noalias !286
  %i.au = load i64, ptr %i.l, align 8, !tbaa !23, !noalias !286
  %i.av = mul i64 %i.au, %indvars.iv
  %i.aw = load i64, ptr %i.m, align 8, !tbaa !16, !noalias !286
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.bz, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !285
...
!284 = distinct !{!284, !283, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!285 = distinct !{!285, !39}
!286 = !{!284}
