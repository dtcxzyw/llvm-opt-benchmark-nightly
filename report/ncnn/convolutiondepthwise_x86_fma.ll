...
.lr.ph219:                                        ; preds = %_ZN4ncnn3MatD2Ev.exit171
  %i.cp = getelementptr inbounds nuw i8, ptr %i.cj, i64 4 ; 2 uses
  %i.cq = getelementptr inbounds nuw i8, ptr %i.cj, i64 8
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cj, i64 16
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cj, i64 20 ; 2 uses
...
vector.body419:                                   ; preds = %vector.body419, %vector.ph415
  ...
  %i.do = fadd fast <8 x float> %i.dn, %broadcast.splat418
  ...
  %i.ek = fadd fast <8 x float> %i.eh, %i.ej
  %i.el = fmul fast <8 x float> %wide.load436, %broadcast.splat429
  %i.em = fadd fast <8 x float> %i.el, %broadcast.splat418
...
scalar.ph413:                                     ; preds = %scalar.ph413.preheader, %scalar.ph413
  ...
  %.1156203.us = phi ptr [ %i.fi, %scalar.ph413 ], [ %.1156203.us.ph, %scalar.ph413.preheader ] ; 2 uses
  %.1160202.us = phi ptr [ %i.fj, %scalar.ph413 ], [ %.1160202.us.ph, %scalar.ph413.preheader ] ; 2 uses
  %.1164201.us = phi ptr [ %i.fn, %scalar.ph413 ], [ %.1164201.us.ph, %scalar.ph413.preheader ] ; 2 uses
  %.1168200.us = phi ptr [ %i.fo, %scalar.ph413 ], [ %.1168200.us.ph, %scalar.ph413.preheader ] ; 3 uses
  %i.fg = load float, ptr %.1156203.us, align 4, !tbaa !45
  %i.fh = load float, ptr %i.cj, align 4, !tbaa !45 ; 2 uses
  %10 = fmul fast float %i.fh, %i.fg
  %i.fi = getelementptr inbounds nuw i8, ptr %.1156203.us, i64 4 ; 3 uses
  %i.fj = getelementptr inbounds nuw i8, ptr %.1160202.us, i64 4 ; 3 uses
  %i.fk = load <2 x float>, ptr %i.fi, align 4, !tbaa !45
  %11 = load <2 x float>, ptr %.1160202.us, align 4, !tbaa !45 ; 2 uses
  ...
  %i.fl = load <4 x float>, ptr %i.cp, align 4, !tbaa !45 ; 2 uses
  %13 = shufflevector <2 x float> %11, <2 x float> %i.fk, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %i.fm = fmul fast <4 x float> %i.fl, %13
  %i.fn = getelementptr inbounds nuw i8, ptr %.1164201.us, i64 4 ; 3 uses
  %14 = load <2 x float>, ptr %.1164201.us, align 4, !tbaa !45 ; 2 uses
  %15 = load <4 x float>, ptr %i.cs, align 4, !tbaa !45 ; 3 uses
  %i.fo = getelementptr inbounds nuw i8, ptr %.1168200.us, i64 4 ; 2 uses
  %i.fp = load <2 x float>, ptr %i.fj, align 4, !tbaa !45 ; 2 uses
  %16 = load <2 x float>, ptr %i.fn, align 4, !tbaa !45 ; 2 uses
  %17 = shufflevector <2 x float> %14, <2 x float> %16, <4 x i32> <i32 poison, i32 0, i32 1, i32 3>
  %18 = shufflevector <2 x float> %i.fp, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %19 = shufflevector <4 x float> %17, <4 x float> %18, <4 x i32> <i32 5, i32 1, i32 2, i32 3>
  %20 = fmul fast <4 x float> %15, %19
  %rdx.op = fadd fast <4 x float> %i.fm, %20
  %op.rdx468 = call fast float @llvm.vector.reduce.fadd.v4f32(float %10, <4 x float> %rdx.op)
  %op.rdx469 = fadd fast float %op.rdx468, %i.ci
  %21 = load <2 x float>, ptr %.1168200.us, align 4, !tbaa !45
  %22 = shufflevector <4 x float> %i.fl, <4 x float> %15, <8 x i32> <i32 poison, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6>
  %23 = shufflevector <8 x float> %12, <8 x float> %22, <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %24 = shufflevector <2 x float> %14, <2 x float> %i.fp, <8 x i32> <i32 poison, i32 2, i32 3, i32 0, i32 poison, i32 poison, i32 poison, i32 poison>
  %25 = insertelement <8 x float> %24, float %i.fh, i64 0
  %26 = shufflevector <2 x float> %16, <2 x float> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %27 = shufflevector <8 x float> %25, <8 x float> %26, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 poison, i32 poison>
  %28 = shufflevector <2 x float> %21, <2 x float> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %29 = shufflevector <8 x float> %27, <8 x float> %28, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 8, i32 9>
  %i.fq = fmul fast <8 x float> %23, %29
...
._crit_edge.us:                                   ; preds = %scalar.ph413, %middle.block458
  %.lcssa303 = phi ptr [ %i.cz, %middle.block458 ], [ %i.fi, %scalar.ph413 ]
  %.lcssa302 = phi ptr [ %i.da, %middle.block458 ], [ %i.fj, %scalar.ph413 ]
  %.lcssa301 = phi ptr [ %i.db, %middle.block458 ], [ %i.fn, %scalar.ph413 ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.he = fadd fast <8 x float> %i.hd, %broadcast.splat
  ...
  %i.ia = fadd fast <8 x float> %i.hx, %i.hz
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ci = fadd fast <4 x float> %i.ch, %broadcast.splat
