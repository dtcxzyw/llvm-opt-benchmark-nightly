...
vector.body417:                                   ; preds = %vector.body417, %vector.ph413
  ...
  %i.dm = fadd fast <8 x float> %i.dl, %broadcast.splat416
  ...
  %i.ek = fadd fast <8 x float> %i.ej, %broadcast.splat416
...
scalar.ph411:                                     ; preds = %scalar.ph411.preheader, %scalar.ph411
  ...
  %.1154204.us = phi ptr [ %i.fl, %scalar.ph411 ], [ %.1154204.us.ph, %scalar.ph411.preheader ] ; 2 uses
  %.1156203.us = phi ptr [ %i.fh, %scalar.ph411 ], [ %.1156203.us.ph, %scalar.ph411.preheader ] ; 2 uses
  %.1160202.us = phi ptr [ %i.fg, %scalar.ph411 ], [ %.1160202.us.ph, %scalar.ph411.preheader ] ; 2 uses
  ...
  %10 = fmul fast float %i.ff, %i.fe
  %i.fg = getelementptr inbounds nuw i8, ptr %.1160202.us, i64 4 ; 3 uses
  %i.fh = getelementptr inbounds nuw i8, ptr %.1156203.us, i64 4 ; 3 uses
  %i.fi = load <2 x float>, ptr %i.fg, align 4, !tbaa !45
  ...
  %i.fj = load <4 x float>, ptr %i.cn, align 4, !tbaa !45 ; 2 uses
  %13 = shufflevector <2 x float> %11, <2 x float> %i.fi, <4 x i32> <i32 2, i32 3, i32 0, i32 1>
  %i.fk = fmul fast <4 x float> %i.fj, %13
  %i.fl = getelementptr inbounds nuw i8, ptr %.1154204.us, i64 4 ; 3 uses
  %14 = load <2 x float>, ptr %.1154204.us, align 4, !tbaa !45 ; 2 uses
  %15 = load <4 x float>, ptr %i.cq, align 4, !tbaa !45 ; 3 uses
  %i.fm = getelementptr inbounds nuw i8, ptr %.1152205.us, i64 4 ; 2 uses
  %i.fn = load <2 x float>, ptr %i.fh, align 4, !tbaa !45 ; 2 uses
  %16 = load <2 x float>, ptr %i.fl, align 4, !tbaa !45 ; 2 uses
  %17 = shufflevector <2 x float> %14, <2 x float> %16, <4 x i32> <i32 poison, i32 0, i32 1, i32 3>
  %18 = shufflevector <2 x float> %i.fn, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %19 = shufflevector <4 x float> %17, <4 x float> %18, <4 x i32> <i32 5, i32 1, i32 2, i32 3>
  %20 = fmul fast <4 x float> %15, %19
  %rdx.op = fadd fast <4 x float> %i.fk, %20
  %op.rdx466 = call fast float @llvm.vector.reduce.fadd.v4f32(float %10, <4 x float> %rdx.op)
  %op.rdx467 = fadd fast float %op.rdx466, %i.cg
  %21 = load <2 x float>, ptr %.1152205.us, align 4, !tbaa !45
  %22 = shufflevector <4 x float> %i.fj, <4 x float> %15, <8 x i32> <i32 poison, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6>
  %23 = shufflevector <8 x float> %12, <8 x float> %22, <8 x i32> <i32 0, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %24 = shufflevector <2 x float> %14, <2 x float> %i.fn, <8 x i32> <i32 poison, i32 2, i32 3, i32 0, i32 poison, i32 poison, i32 poison, i32 poison>
  %25 = insertelement <8 x float> %24, float %i.ff, i64 0
  ...
  %i.fo = fmul fast <8 x float> %23, %29
...
._crit_edge.us:                                   ; preds = %scalar.ph411, %middle.block456
  %.lcssa303 = phi ptr [ %i.cy, %middle.block456 ], [ %i.fg, %scalar.ph411 ]
  %.lcssa302 = phi ptr [ %i.cx, %middle.block456 ], [ %i.fh, %scalar.ph411 ]
  %.lcssa301 = phi ptr [ %i.cw, %middle.block456 ], [ %i.fl, %scalar.ph411 ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.hc = fadd fast <8 x float> %i.hb, %broadcast.splat
  ...
  %i.hy = fadd fast <8 x float> %i.hv, %i.hx
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ch = fadd fast <4 x float> %i.cg, %broadcast.splat
  ...
  %i.da = fadd fast <4 x float> %i.cy, %i.cz
