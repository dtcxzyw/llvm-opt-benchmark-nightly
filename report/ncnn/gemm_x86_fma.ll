...
.lr.ph177.i:                                      ; preds = %bb.h, %.lr.ph177.i
  ...
  br i1 %i.kv, label %.lr.ph177.i, label %._crit_edge178.i, !llvm.loop !854
...
.lr.ph190.i:                                      ; preds = %._crit_edge178.i, %.lr.ph190.i
  ...
  br i1 %i.lm, label %.lr.ph190.i, label %._crit_edge191.i, !llvm.loop !855
...
.lr.ph200.i.prol:                                 ; preds = %.lr.ph200.i.preheader, %.lr.ph200.i.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph200.i.prol.loopexit, label %.lr.ph200.i.prol, !llvm.loop !856
...
.lr.ph200.i:                                      ; preds = %.lr.ph200.i.prol.loopexit, %.lr.ph200.i
  ...
  br i1 %exitcond330.not.i.3, label %._crit_edge201.i, label %.lr.ph200.i, !llvm.loop !857
...
.thread112.i:                                     ; preds = %bb.j, %bb.i, %.thread108.i, %._crit_edge201.i
  ...
  br i1 %i.oc, label %bb.h, label %.preheader119.i, !llvm.loop !858
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x float> splat (float +inf), ptr %next.gep, align 4, !tbaa !68, !alias.scope !879, !noalias !880
  store <4 x float> splat (float +inf), ptr %next.gep186, align 4, !tbaa !68, !alias.scope !879, !noalias !880
  store <4 x float> splat (float +inf), ptr %next.gep187, align 4, !tbaa !68, !alias.scope !879, !noalias !880
  store <4 x float> splat (float +inf), ptr %next.gep188, align 4, !tbaa !68, !alias.scope !879, !noalias !880
  store <4 x float> zeroinitializer, ptr %next.gep189, align 4, !tbaa !68, !alias.scope !880
  store <4 x float> zeroinitializer, ptr %next.gep190, align 4, !tbaa !68, !alias.scope !880
  store <4 x float> zeroinitializer, ptr %next.gep191, align 4, !tbaa !68, !alias.scope !880
  store <4 x float> zeroinitializer, ptr %next.gep192, align 4, !tbaa !68, !alias.scope !880
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %niter.ncmp.7, label %.loopexit7.loopexit443.unr-lcssa, label %.lr.ph, !llvm.loop !1076
...
.lr.ph19:                                         ; preds = %.lr.ph19.preheader, %.lr.ph19
  ...
  br i1 %niter455.ncmp.3, label %.loopexit7.loopexit.unr-lcssa, label %.lr.ph19, !llvm.loop !1077
...
.lr.ph25:                                         ; preds = %.loopexit8, %.lr.ph25
  ...
  br i1 %exitcond141.not, label %.loopexit7, label %.lr.ph25, !llvm.loop !1078
...
.lr.ph19.epil:                                    ; preds = %.lr.ph19.epil, %.lr.ph19.epil.preheader
  ...
  br i1 %epil.iter450.cmp.not, label %.loopexit7, label %.lr.ph19.epil, !llvm.loop !1079
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %.loopexit7, label %.lr.ph.epil, !llvm.loop !1080
...
.loopexit7:                                       ; preds = %.loopexit7.loopexit443.unr-lcssa, %.lr.ph.epil, %.lr.ph25, %.loopexit7.loopexit.unr-lcssa, %.lr.ph19.epil, %bb.c, %.loopexit8
  ...
  br i1 %i.nw, label %bb.b, label %.preheader5.loopexit, !llvm.loop !1081
...
.preheader1:                                      ; preds = %.preheader1.loopexit116, %.preheader3.us71.preheader, %.lr.ph61.split.split.preheader, %.preheader1.loopexit, %.preheader5
  %.1168.lcssa = phi i32 [ %.0167.lcssa, %.preheader5 ], [ %i.nx, %.preheader1.loopexit ], [ %i.hl, %.lr.ph61.split.split.preheader ], [ %i.if, %.preheader3.us71.preheader ], [ %i.ny, %.preheader1.loopexit116 ] ; 5 uses
...
vector.body355:                                   ; preds = %vector.body355, %vector.ph353
  ...
  %wide.load361.a = load <4 x i16>, ptr %next.gep358.a, align 2, !tbaa !108, !alias.scope !1101
  %wide.load362.a = load <4 x i16>, ptr %i.qe, align 2, !tbaa !108, !alias.scope !1101
  %i.qf = getelementptr i8, ptr %next.gep357.a, i64 8
  %wide.load363.a = load <4 x i16>, ptr %next.gep357.a, align 2, !tbaa !108, !alias.scope !1102
  %wide.load364 = load <4 x i16>, ptr %i.qf, align 2, !tbaa !108, !alias.scope !1102
  ...
  store <8 x i16> %interleaved.vec365.a, ptr %next.gep359.a, align 2, !tbaa !108, !alias.scope !1103, !noalias !1104
  ...
  store <8 x i16> %interleaved.vec366, ptr %next.gep360, align 2, !tbaa !108, !alias.scope !1103, !noalias !1104
  %index.next367 = add nuw i64 %index356, 8       ; 2 uses
  %i.qg = icmp eq i64 %index.next367, %n.vec354
  br i1 %i.qg, label %middle.block368, label %vector.body355, !llvm.loop !1086
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  br i1 %prol.iter466.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !1087
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %exitcond152.not.3, label %._crit_edge.us, label %scalar.ph, !llvm.loop !1088
...
._crit_edge.us:                                   ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block368
  ...
  br i1 %i.rq, label %.lr.ph87.us, label %.preheader.loopexit, !llvm.loop !1089
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %niter.next.7 = add nuw nsw i32 %niter, 8       ; 2 uses
  %niter.ncmp.7 = icmp eq i32 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %.loopexit6.loopexit406.unr-lcssa, label %.lr.ph, !llvm.loop !1126
...
.lr.ph18:                                         ; preds = %.lr.ph18.preheader, %.lr.ph18
  ...
  br i1 %niter418.ncmp.3, label %.loopexit6.loopexit.unr-lcssa, label %.lr.ph18, !llvm.loop !1127
...
.lr.ph24:                                         ; preds = %.loopexit7, %.lr.ph24
  ...
  br i1 %exitcond121.not, label %.loopexit6, label %.lr.ph24, !llvm.loop !1128
...
.lr.ph18.epil:                                    ; preds = %.lr.ph18.epil, %.lr.ph18.epil.preheader
  ...
  br i1 %epil.iter413.cmp.not, label %.loopexit6, label %.lr.ph18.epil, !llvm.loop !1129
...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %.loopexit6, label %.lr.ph.epil, !llvm.loop !1130
...
.loopexit6:                                       ; preds = %.loopexit6.loopexit406.unr-lcssa, %.lr.ph.epil, %.lr.ph24, %.loopexit6.loopexit.unr-lcssa, %.lr.ph18.epil, %bb.c, %.loopexit7
  ...
  br i1 %i.my, label %bb.b, label %.preheader4.loopexit, !llvm.loop !1131
...
.preheader1:                                      ; preds = %.preheader1.loopexit102, %.preheader2.us57.preheader, %.lr.ph47.split.split.preheader, %.preheader1.loopexit, %.preheader4
  ...
  %.1156.lcssa = phi i32 [ %.0155.lcssa, %.preheader4 ], [ %i.mz, %.preheader1.loopexit ], [ %i.gn, %.lr.ph47.split.split.preheader ], [ %i.hh, %.preheader2.us57.preheader ], [ %i.na, %.preheader1.loopexit102 ] ; 5 uses
...
vector.body323:                                   ; preds = %vector.body323, %vector.ph321
  ...
  %wide.load329.a = load <4 x i16>, ptr %next.gep326.a, align 2, !tbaa !108, !alias.scope !1151
  %wide.load330.a = load <4 x i16>, ptr %i.pg, align 2, !tbaa !108, !alias.scope !1151
  %i.ph = getelementptr i8, ptr %next.gep325.a, i64 8
  %wide.load331.a = load <4 x i16>, ptr %next.gep325.a, align 2, !tbaa !108, !alias.scope !1152
  %wide.load332 = load <4 x i16>, ptr %i.ph, align 2, !tbaa !108, !alias.scope !1152
  ...
  store <8 x i16> %interleaved.vec333.a, ptr %next.gep327.a, align 2, !tbaa !108, !alias.scope !1153, !noalias !1154
  ...
  store <8 x i16> %interleaved.vec334, ptr %next.gep328, align 2, !tbaa !108, !alias.scope !1153, !noalias !1154
  %index.next335 = add nuw i64 %index324, 8       ; 2 uses
  %i.pi = icmp eq i64 %index.next335, %n.vec322
  br i1 %i.pi, label %middle.block336, label %vector.body323, !llvm.loop !1136
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  br i1 %prol.iter429.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !1137
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %exitcond132.not.3, label %._crit_edge.us, label %scalar.ph, !llvm.loop !1138
...
._crit_edge.us:                                   ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block336
  ...
  br i1 %i.qs, label %.lr.ph73.us, label %.preheader.loopexit, !llvm.loop !1139
...
.noexc84:                                         ; preds = %bb.c
  %i.af = load ptr, ptr %8, align 8, !tbaa !24, !noalias !1184
  %i.ag = load i64, ptr %i.l, align 8, !tbaa !25, !noalias !1184
  %i.ah = sext i32 %i.ae to i64
  %i.ai = mul i64 %i.ag, %i.ah
  %i.aj = load i64, ptr %i.m, align 8, !tbaa !63, !noalias !1184
...
_ZN4ncnn3MatD2Ev.exit58:                          ; preds = %_ZN4ncnn3MatD2Ev.exit58.preheader, %_ZN4ncnn3MatD2Ev.exit58
  ...
  %i.ba = load i32, ptr %i.n, align 4, !tbaa !77, !noalias !1185
  %i.bb = load ptr, ptr %11, align 8, !tbaa !24, !noalias !1185
  %i.bc = load i64, ptr %i.o, align 8, !tbaa !25, !noalias !1185
  %i.bd = sext i32 %i.az to i64
  %i.be = mul i64 %i.bc, %i.bd
  %i.bf = load i64, ptr %i.p, align 8, !tbaa !63, !noalias !1185 ; 2 uses
  ...
  %i.bq = load i32, ptr %i.q, align 4, !tbaa !77, !noalias !1186
  %i.br = load ptr, ptr %12, align 8, !tbaa !24, !noalias !1186
  %i.bs = load i64, ptr %i.r, align 8, !tbaa !25, !noalias !1186
  %i.bt = sext i32 %i.bp to i64
  %i.bu = mul i64 %i.bs, %i.bt
  %i.bv = load i64, ptr %i.s, align 8, !tbaa !63, !noalias !1186 ; 2 uses
  ...
  br i1 %i.cf, label %_ZN4ncnn3MatD2Ev.exit58, label %_ZN4ncnn3MatD2Ev.exit, !llvm.loop !1183
