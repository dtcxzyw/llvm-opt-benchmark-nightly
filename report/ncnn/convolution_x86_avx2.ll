...
begin_hunk_0_@_ZN4ncnn47conv3x3s1_winograd43_transform_kernel_int8_avx2ERKNS_3MatERS0_iiRKNS_6OptionE:bb.a

bb.c:                                             ; preds = %bb.b, %bb.a
  %.0.i.i = phi i32 [ %i.n, %bb.b ], [ %i.i, %bb.a ] ; 3 uses
  %i.o = uitofp fast i64 %i.l to float            ; 2 uses
  %i.p = fmul fast float %i.o, f0x3EAAAAAB
  %i.q = tail call fast noundef nofpclass(nan inf) float @llvm.sqrt.f32(float nofpclass(nan inf) %i.p)
  %i.r = fptosi float %i.q to i32
  %i.s = and i32 %i.r, 2147483640
  %.sroa.speculated86.i.i = tail call i32 @llvm.umax.i32(i32 %i.s, i32 8)
  %i.t = tail call noundef i32 @_ZN4ncnn22get_physical_cpu_countEv()
  %.sroa.speculated82.i.i = tail call i32 @llvm.smin.i32(i32 %i.t, i32 %.0.i.i)
  %i.u = mul nsw i32 %.sroa.speculated82.i.i, %.sroa.speculated86.i.i ; 3 uses
  %i.v = add i32 %3, -1                           ; 3 uses
  %i.w = add i32 %i.u, %i.v
  %i.x = sdiv i32 %i.w, %i.u                      ; 2 uses
  %i.y = add i32 %i.x, %i.v
  %i.z = sdiv i32 %i.y, %i.x
  %i.aa = add nsw i32 %i.z, 7
  %i.ab = sdiv i32 %i.aa, 8
  %i.ac = shl nsw i32 %i.ab, 3
  %.sroa.speculated78.i.i = tail call i32 @llvm.smin.i32(i32 %i.ac, i32 %i.u) ; 3 uses
  %i.ad = icmp sgt i32 %.0.i.i, 1
  br i1 %i.ad, label %bb.d, label %_ZN4ncnnL25get_optimal_tile_mnk_int8EiiiRiS0_S0_i.exit.i

bb.d:                                             ; preds = %bb.c
  %i.ae = sdiv i32 %.sroa.speculated78.i.i, %.0.i.i
  %.sroa.speculated68.i.i = tail call i32 @llvm.smax.i32(i32 %i.ae, i32 1)
  %i.af = add nuw nsw i32 %.sroa.speculated68.i.i, 7
  %i.ag = and i32 %i.af, 2147483640
  %.sroa.speculated74.i.i = tail call i32 @llvm.smin.i32(i32 %i.ag, i32 %.sroa.speculated78.i.i)
  br label %_ZN4ncnnL25get_optimal_tile_mnk_int8EiiiRiS0_S0_i.exit.i

_ZN4ncnnL25get_optimal_tile_mnk_int8EiiiRiS0_S0_i.exit.i: ; preds = %bb.d, %bb.c
  %storemerge.i.i = phi i32 [ %.sroa.speculated74.i.i, %bb.d ], [ %.sroa.speculated78.i.i, %bb.c ] ; 5 uses
  store i32 %storemerge.i.i, ptr %i.d, align 4, !tbaa !24
  %i.ah = tail call fast noundef nofpclass(nan inf) float @llvm.sqrt.f32(float nofpclass(nan inf) %i.o)
  %i.ai = sitofp fast i32 %storemerge.i.i to float
  %i.aj = fsub fast float %i.ah, %i.ai
  %i.ak = fptosi float %i.aj to i32
  %i.al = sdiv i32 %i.ak, 8
  %i.am = shl nsw i32 %i.al, 3
  %.sroa.speculated62.i.i = tail call i32 @llvm.smax.i32(i32 %i.am, i32 8) ; 3 uses
  %i.an = add i32 %2, -1                          ; 3 uses
  %i.ao = add i32 %.sroa.speculated62.i.i, %i.an
  %i.ap = sdiv i32 %i.ao, %.sroa.speculated62.i.i ; 2 uses
  %i.aq = add i32 %i.ap, %i.an
  %i.ar = sdiv i32 %i.aq, %i.ap
  %i.as = add nsw i32 %i.ar, 7
  %i.at = sdiv i32 %i.as, 8
  %i.au = shl nsw i32 %i.at, 3
  %.sroa.speculated58.i.i = tail call i32 @llvm.smin.i32(i32 %i.au, i32 %.sroa.speculated62.i.i) ; 4 uses
  store i32 %.sroa.speculated58.i.i, ptr %i.e, align 4, !tbaa !24
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f) #8
  %i.av = add i32 %i.v, %storemerge.i.i
  %i.aw = sdiv i32 %i.av, %storemerge.i.i         ; 2 uses
  store i32 %i.aw, ptr %i.f, align 4, !tbaa !24
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #8
  %i.ax = mul i32 %.sroa.speculated58.i.i, %storemerge.i.i ; 2 uses
  %i.ay = mul i32 %i.ax, 36
  %i.az = load i32, ptr %i.h, align 4, !tbaa !32
  ...
  call void @_ZN4ncnn3Mat6createEiiimPNS_9AllocatorE(ptr noundef nonnull align 8 dereferenceable(72) %5, i32 noundef %i.ay, i32 noundef 1, i32 noundef %i.az, i64 noundef 4, ptr noundef null)
  %i.bd = add i32 %i.an, %.sroa.speculated58.i.i
  %i.be = sdiv i32 %i.bd, %.sroa.speculated58.i.i
  invoke void @_ZN4ncnn3Mat6createEiiiimPNS_9AllocatorE(ptr noundef nonnull align 8 dereferenceable(72) %1, i32 noundef %i.ax, i32 noundef 36, i32 noundef %i.be, i32 noundef %i.aw, i64 noundef 4, ptr noundef null)
          to label %bb.e unwind label %bb.l

bb.e:                                             ; preds = %_ZN4ncnnL25get_optimal_tile_mnk_int8EiiiRiS0_S0_i.exit.i
  %i.bf = load i32, ptr %i.h, align 4, !tbaa !32
  call void @__kmpc_push_num_threads(ptr nonnull @2, i32 %i.g, i32 %i.bf)
  call void (ptr, i32, ptr, ...) @__kmpc_fork_call(ptr nonnull @2, i32 9, ptr nonnull @_ZN4ncnnL42conv3x3s1_winograd43_transform_kernel_int8ERKNS_3MatERS0_iiRKNS_6OptionE.omp_outlined, ptr nonnull %i.f, ptr nonnull %i.d, ptr nonnull %5, ptr nonnull %i.c, ptr nonnull %i.e, ptr nonnull %i.b, ptr nonnull align 8 dereferenceable(72) %0, ptr nonnull %i.a, ptr nonnull align 8 dereferenceable(72) %1)
  %i.bg = load ptr, ptr %i.ba, align 8, !tbaa !36 ; 2 uses
  %.not.i.i = icmp eq ptr %i.bg, null
  br i1 %.not.i.i, label %_ZN4ncnnL42conv3x3s1_winograd43_transform_kernel_int8ERKNS_3MatERS0_iiRKNS_6OptionE.exit, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.bh = atomicrmw add ptr %i.bg, i32 -1 acq_rel, align 4
  %i.bi = icmp eq i32 %i.bh, 1
  br i1 %i.bi, label %bb.g, label %_ZN4ncnnL42conv3x3s1_winograd43_transform_kernel_int8ERKNS_3MatERS0_iiRKNS_6OptionE.exit

bb.g:                                             ; preds = %bb.f
  %i.bj = load ptr, ptr %i.bb, align 8, !tbaa !37 ; 3 uses
  %.not3.i.i = icmp eq ptr %i.bj, null
  %i.bk = load ptr, ptr %5, align 8, !tbaa !15    ; 3 uses
  br i1 %.not3.i.i, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.bl = load ptr, ptr %i.bj, align 8, !tbaa !39
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 24
  %i.bn = load ptr, ptr %i.bm, align 8
  invoke void %i.bn(ptr noundef nonnull align 8 dereferenceable(8) %i.bj, ptr noundef %i.bk)
          to label %_ZN4ncnnL42conv3x3s1_winograd43_transform_kernel_int8ERKNS_3MatERS0_iiRKNS_6OptionE.exit unwind label %bb.k, !inline_history !0

bb.i:                                             ; preds = %bb.g
  %.not.i14.i = icmp eq ptr %i.bk, null
  br i1 %.not.i14.i, label %_ZN4ncnnL42conv3x3s1_winograd43_transform_kernel_int8ERKNS_3MatERS0_iiRKNS_6OptionE.exit, label %bb.j

bb.j:                                             ; preds = %bb.i
  call void @free(ptr noundef nonnull %i.bk) #8
...
bb.l:                                             ; preds = %_ZN4ncnnL25get_optimal_tile_mnk_int8EiiiRiS0_S0_i.exit.i
  %i.bq = landingpad { ptr, i32 }
          cleanup
  %i.br = load ptr, ptr %i.ba, align 8, !tbaa !36 ; 2 uses
  %.not.i9.i = icmp eq ptr %i.br, null
  br i1 %.not.i9.i, label %_ZN4ncnn3MatD2Ev.exit.i, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.bs = atomicrmw add ptr %i.br, i32 -1 acq_rel, align 4
  %i.bt = icmp eq i32 %i.bs, 1
  br i1 %i.bt, label %bb.n, label %_ZN4ncnn3MatD2Ev.exit.i

bb.n:                                             ; preds = %bb.m
  %i.bu = load ptr, ptr %i.bb, align 8, !tbaa !37 ; 3 uses
  %.not3.i10.i = icmp eq ptr %i.bu, null
  %i.bv = load ptr, ptr %5, align 8, !tbaa !15    ; 3 uses
  br i1 %.not3.i10.i, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.bw = load ptr, ptr %i.bu, align 8, !tbaa !39
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 24
  %i.by = load ptr, ptr %i.bx, align 8
  invoke void %i.by(ptr noundef nonnull align 8 dereferenceable(8) %i.bu, ptr noundef %i.bv)
          to label %_ZN4ncnn3MatD2Ev.exit.i unwind label %bb.r, !inline_history !0

bb.p:                                             ; preds = %bb.n
  %.not.i13.i = icmp eq ptr %i.bv, null
  br i1 %.not.i13.i, label %_ZN4ncnn3MatD2Ev.exit.i, label %bb.q
...
_ZN4ncnn3MatD2Ev.exit.i:                          ; preds = %bb.q, %bb.p, %bb.o, %bb.m, %bb.l
...
_ZN4ncnnL42conv3x3s1_winograd43_transform_kernel_int8ERKNS_3MatERS0_iiRKNS_6OptionE.exit: ; preds = %bb.e, %bb.f, %bb.h, %bb.i, %bb.j
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f) #8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #8
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = load i32, ptr %i.a, align 4, !tbaa !24   ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph112, %_ZN4ncnn3MatD2Ev.exit
  %indvar = phi i32 [ 0, %.lr.ph112 ], [ %indvar.next, %_ZN4ncnn3MatD2Ev.exit ] ; 2 uses
  %.033111 = phi i32 [ %i.k, %.lr.ph112 ], [ %i.ao, %_ZN4ncnn3MatD2Ev.exit ] ; 3 uses
  %12 = add i32 %i.k, %indvar
  %i.aa = mul i32 %12, 9
  %i.ab = load i32, ptr %3, align 4, !tbaa !24    ; 2 uses
...
.noexc34:                                         ; preds = %bb.c
  %i.ae = load ptr, ptr %4, align 8, !tbaa !15, !noalias !686
  %i.af = load i64, ptr %i.l, align 8, !tbaa !16, !noalias !686
  %i.ag = sext i32 %i.ad to i64
  %i.ah = mul i64 %i.af, %i.ag
  %i.ai = load i64, ptr %i.m, align 8, !tbaa !17, !noalias !686
  %i.aj = mul i64 %i.ah, %i.ai
  %i.ak = getelementptr inbounds nuw i8, ptr %i.ae, i64 %i.aj ; 2 uses
  %i.al = load i32, ptr %5, align 4, !tbaa !24    ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit:                            ; preds = %.noexc, %.noexc34
  %i.ao = add nsw i32 %.033111, 1
  %i.ap = load i32, ptr %i.b, align 4, !tbaa !24
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.noexc
  ...
  %i.as = load i32, ptr %7, align 4, !tbaa !24
  %i.at = sub nsw i32 %i.as, %i.ac
  %i.au = load i32, ptr %3, align 4, !tbaa !24    ; 2 uses
...
.preheader11.lr.ph.i:                             ; preds = %.lr.ph
  %i.ax = load i32, ptr %9, align 4, !tbaa !24    ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.df = load i8, ptr %i.cx, align 1, !tbaa !18, !alias.scope !687
  %i.dg = load i8, ptr %i.cy, align 1, !tbaa !18, !alias.scope !687
  %i.dh = load i8, ptr %i.cz, align 1, !tbaa !18, !alias.scope !687
  %i.di = load i8, ptr %i.da, align 1, !tbaa !18, !alias.scope !687
  %i.dj = load i8, ptr %i.db, align 1, !tbaa !18, !alias.scope !687
  %i.dk = load i8, ptr %i.dc, align 1, !tbaa !18, !alias.scope !687
  %i.dl = load i8, ptr %i.dd, align 1, !tbaa !18, !alias.scope !687
  %i.dm = load i8, ptr %i.de, align 1, !tbaa !18, !alias.scope !687
  ...
  %i.ed = load i8, ptr %i.dv, align 1, !tbaa !18, !alias.scope !687
  %i.ee = load i8, ptr %i.dw, align 1, !tbaa !18, !alias.scope !687
  %i.ef = load i8, ptr %i.dx, align 1, !tbaa !18, !alias.scope !687
  %i.eg = load i8, ptr %i.dy, align 1, !tbaa !18, !alias.scope !687
  %i.eh = load i8, ptr %i.dz, align 1, !tbaa !18, !alias.scope !687
  %i.ei = load i8, ptr %i.ea, align 1, !tbaa !18, !alias.scope !687
  %i.ej = load i8, ptr %i.eb, align 1, !tbaa !18, !alias.scope !687
  %i.ek = load i8, ptr %i.ec, align 1, !tbaa !18, !alias.scope !687
  ...
  %i.fb = load i8, ptr %i.et, align 1, !tbaa !18, !alias.scope !687
  %i.fc = load i8, ptr %i.eu, align 1, !tbaa !18, !alias.scope !687
  %i.fd = load i8, ptr %i.ev, align 1, !tbaa !18, !alias.scope !687
  %i.fe = load i8, ptr %i.ew, align 1, !tbaa !18, !alias.scope !687
  %i.ff = load i8, ptr %i.ex, align 1, !tbaa !18, !alias.scope !687
  %i.fg = load i8, ptr %i.ey, align 1, !tbaa !18, !alias.scope !687
  %i.fh = load i8, ptr %i.ez, align 1, !tbaa !18, !alias.scope !687
  %i.fi = load i8, ptr %i.fa, align 1, !tbaa !18, !alias.scope !687
