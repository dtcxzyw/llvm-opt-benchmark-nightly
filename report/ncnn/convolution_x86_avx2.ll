...
.lr.ph112.i.i:                                    ; preds = %_ZN17FastDivider_epu32C2Ej.exit972.i.i
  ...
  %i.vg = insertelement <2 x i32> poison, i32 %8, i64 0
  %12 = shufflevector <2 x i32> %i.vg, <2 x i32> poison, <2 x i32> zeroinitializer
  %i.vh = insertelement <2 x i32> %i.ve, i32 %i.tm, i64 1 ; 2 uses
  %i.vi = insertelement <2 x i32> poison, i32 %i.us, i64 0
  %i.vj = insertelement <2 x i32> %i.vi, i32 %i.ut, i64 1 ; 2 uses
  %i.vk = insertelement <2 x i32> poison, i32 %6, i64 0
  %i.vl = insertelement <2 x i32> %i.vk, i32 %i.tm, i64 1
  %i.vm = insertelement <2 x i32> poison, i32 %i.us, i64 0
  %13 = insertelement <2 x i32> %i.vm, i32 %i.ut, i64 1
  %14 = insertelement <2 x i64> poison, i64 %i.k, i64 0
  %15 = shufflevector <2 x i64> %14, <2 x i64> poison, <2 x i32> zeroinitializer
  %16 = insertelement <2 x i32> poison, i32 %i.tm, i64 0
...
.lr.ph143.i62.i:                                  ; preds = %.preheader75.i.i
  ...
  %i.wo = insertelement <2 x i32> poison, i32 %8, i64 0
  %18 = shufflevector <2 x i32> %i.wo, <2 x i32> poison, <2 x i32> zeroinitializer
  %i.wp = insertelement <2 x i32> %i.wm, i32 %i.tm, i64 1 ; 2 uses
  %i.wq = insertelement <2 x i32> poison, i32 %i.wa, i64 0
  %i.wr = insertelement <2 x i32> %i.wq, i32 %i.wb, i64 1 ; 2 uses
  %i.ws = insertelement <2 x i32> poison, i32 %6, i64 0
  %i.wt = insertelement <2 x i32> %i.ws, i32 %i.tm, i64 1
  %i.wu = insertelement <2 x i32> poison, i32 %i.wa, i64 0
  %19 = insertelement <2 x i32> %i.wu, i32 %i.wb, i64 1
  %20 = insertelement <2 x i64> poison, i64 %i.k, i64 0
  %21 = shufflevector <2 x i64> %20, <2 x i64> poison, <2 x i32> zeroinitializer
  %22 = insertelement <2 x i32> poison, i32 %i.tm, i64 0
...
bb.m:                                             ; preds = %bb.m, %.lr.ph99.i.i
  ...
  %i.xz = add nsw i32 %.094297.i.i, %4            ; 3 uses
  %i.ya = add nsw i32 %i.xz, 1                    ; 2 uses
  %24 = srem i32 %i.xz, %i.tm                     ; 2 uses
  %25 = srem i32 %i.ya, %i.tm                     ; 2 uses
  %26 = sdiv i32 %24, %6
  %27 = sdiv i32 %25, %6
  %28 = srem i32 %24, %6
  %29 = srem i32 %25, %6
  ...
  %34 = insertelement <2 x i32> poison, i32 %i.xz, i64 0
  %35 = insertelement <2 x i32> %34, i32 %i.ya, i64 1
  %36 = sdiv <2 x i32> %35, %17
  %i.yb = sext <2 x i32> %36 to <2 x i64>
  %i.yc = mul <2 x i64> %15, %i.yb                ; 2 uses
  %i.yd = mul i32 %27, %i.us
  %i.ye = mul nsw i32 %29, %8
  ...
  %i.yl = getelementptr i8, ptr %i.yk, i64 %33
...
.lr.ph.i68.i:                                     ; preds = %.preheader85.i.i, %.lr.ph.i68.i
  ...
  %i.abc = srem <2 x i32> %i.abb, %i.vf
  %37 = mul nsw <2 x i32> %i.abc, %12             ; 2 uses
  %i.abd = insertelement <2 x i32> %i.abb, i32 %i.aax, i64 1
  %i.abe = sdiv <2 x i32> %i.abd, %i.vh
  %i.abf = mul <2 x i32> %i.abe, %i.vj            ; 2 uses
  %shift = shufflevector <2 x i32> %i.abf, <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop277 = add <2 x i32> %i.abf, %shift
  %foldExtExtBinop279 = add <2 x i32> %foldExtExtBinop277, %37
  %i.abg = shufflevector <2 x i32> %foldExtExtBinop279, <2 x i32> poison, <8 x i32> zeroinitializer
  ...
  %i.abk = sdiv <2 x i32> %i.abj, %i.vh
  %i.abl = mul <2 x i32> %i.abk, %i.vj            ; 2 uses
  %38 = shufflevector <2 x i32> %i.abl, <2 x i32> poison, <8 x i32> zeroinitializer
  %39 = shufflevector <2 x i32> %i.abl, <2 x i32> poison, <8 x i32> <i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1, i32 1>
...
.lr.ph91.i.i:                                     ; preds = %.preheader83.i.i, %.lr.ph91.i.i
  ...
  %i.acl = sdiv <2 x i32> %i.ack, %i.vl
  %i.acm = mul <2 x i32> %i.acl, %13
...
.lr.ph175.i59.i:                                  ; preds = %.preheader64.i.i
  ...
  %43 = insertelement <2 x i64> poison, i64 %i.k, i64 0
  %44 = shufflevector <2 x i64> %43, <2 x i64> poison, <2 x i32> zeroinitializer
  %i.afm = insertelement <2 x i32> poison, i32 %i.tm, i64 0
...
bb.s:                                             ; preds = %bb.s, %.lr.ph130.i.i
  ...
  %i.ags = add nsw i32 %.0948128.i.i, %4          ; 3 uses
  %i.agt = add nsw i32 %i.ags, 1                  ; 2 uses
  %45 = srem i32 %i.ags, %i.tm                    ; 2 uses
  %46 = srem i32 %i.agt, %i.tm                    ; 2 uses
  %47 = sdiv i32 %45, %6
  %48 = sdiv i32 %46, %6
  %49 = srem i32 %45, %6
  %50 = srem i32 %46, %6
  ...
  %55 = insertelement <2 x i32> poison, i32 %i.ags, i64 0
  %56 = insertelement <2 x i32> %55, i32 %i.agt, i64 1
  %57 = sdiv <2 x i32> %56, %23
  %i.agu = sext <2 x i32> %57 to <2 x i64>
  %i.agv = mul <2 x i64> %21, %i.agu              ; 2 uses
  %i.agw = mul i32 %48, %i.wa
  %i.agx = mul nsw i32 %50, %8
  ...
  %i.ahe = getelementptr i8, ptr %i.ahd, i64 %54
...
.lr.ph117.i.i:                                    ; preds = %.preheader74.i.i, %.lr.ph117.i.i
  ...
  %i.aki = srem <2 x i32> %i.akh, %i.wn
  %58 = mul nsw <2 x i32> %i.aki, %18             ; 2 uses
  %i.akj = insertelement <2 x i32> %i.akh, i32 %i.akd, i64 1
  %i.akk = sdiv <2 x i32> %i.akj, %i.wp
  %i.akl = mul <2 x i32> %i.akk, %i.wr            ; 2 uses
  %shift296 = shufflevector <2 x i32> %i.akl, <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop297 = add <2 x i32> %i.akl, %shift296
  %foldExtExtBinop299 = add <2 x i32> %foldExtExtBinop297, %58
  %i.akm = shufflevector <2 x i32> %foldExtExtBinop299, <2 x i32> poison, <4 x i32> zeroinitializer
  ...
  %i.akq = sdiv <2 x i32> %i.akp, %i.wp
  %i.akr = mul <2 x i32> %i.akq, %i.wr            ; 2 uses
  %59 = shufflevector <2 x i32> %i.akr, <2 x i32> poison, <4 x i32> zeroinitializer
  %60 = shufflevector <2 x i32> %i.akr, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %61 = add <4 x i32> %59, %60
  %62 = shufflevector <2 x i32> %58, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1>
  %63 = add <4 x i32> %61, %62
  %i.aks = add <4 x i32> %63, %i.agl
...
.lr.ph122.i.i:                                    ; preds = %.preheader72.i.i, %.lr.ph122.i.i
  ...
  %i.all = sdiv <2 x i32> %i.alk, %i.wt
  %i.alm = mul <2 x i32> %i.all, %19
...
.lr.ph193.i.i:                                    ; preds = %.preheader53.i.i
  ...
  %64 = insertelement <2 x i64> poison, i64 %i.k, i64 0
  %65 = shufflevector <2 x i64> %64, <2 x i64> poison, <2 x i32> zeroinitializer
  %i.ani = insertelement <2 x i32> poison, i32 %i.tm, i64 0
...
bb.y:                                             ; preds = %bb.y, %.lr.ph162.i.i
  ...
  %i.aoa = add nsw i32 %.0956160.i.i, %4          ; 3 uses
  %i.aob = add nsw i32 %i.aoa, 1                  ; 2 uses
  %66 = srem i32 %i.aoa, %i.tm                    ; 2 uses
  %67 = srem i32 %i.aob, %i.tm                    ; 2 uses
  %68 = sdiv i32 %66, %6
  %69 = sdiv i32 %67, %6
  %70 = srem i32 %66, %6
  %71 = srem i32 %67, %6
  ...
  %76 = insertelement <2 x i32> poison, i32 %i.aoa, i64 0
  %77 = insertelement <2 x i32> %76, i32 %i.aob, i64 1
  %78 = sdiv <2 x i32> %77, %i.afn
  %i.aoc = sext <2 x i32> %78 to <2 x i64>
  %i.aod = mul <2 x i64> %44, %i.aoc              ; 2 uses
  %i.aoe = mul i32 %69, %i.aeo
  %i.aof = mul nsw i32 %71, %8
  ...
  %i.aom = getelementptr i8, ptr %i.aol, i64 %75  ; 2 uses
...
.lr.ph148.i.i:                                    ; preds = %.lr.ph148.i.i.preheader, %.lr.ph148.i.i
  ...
  %79 = load ptr, ptr %0, align 8, !tbaa !15      ; 4 uses
...
bb.af:                                            ; preds = %bb.af, %.lr.ph180.i58.i
  ...
  %i.avb = add nsw i32 %.0950178.i.i, %4          ; 3 uses
  %i.avc = add nsw i32 %i.avb, 1                  ; 2 uses
  %80 = srem i32 %i.avb, %i.tm                    ; 2 uses
  %81 = srem i32 %i.avc, %i.tm                    ; 2 uses
  %82 = sdiv i32 %80, %6
  %83 = sdiv i32 %81, %6
  %84 = srem i32 %80, %6
  %85 = srem i32 %81, %6
  ...
  %90 = insertelement <2 x i32> poison, i32 %i.avb, i64 0
  %91 = insertelement <2 x i32> %90, i32 %i.avc, i64 1
  %92 = sdiv <2 x i32> %91, %i.anj
  %i.avd = sext <2 x i32> %92 to <2 x i64>
  %i.ave = mul <2 x i64> %65, %i.avd              ; 2 uses
  %i.avf = mul i32 %83, %i.and
  %i.avg = mul nsw i32 %85, %8
  ...
  %i.avn = getelementptr i8, ptr %i.avm, i64 %89
