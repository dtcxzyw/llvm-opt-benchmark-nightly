...
_ZN4ncnn3MatD2Ev.exit650.lr.ph.i:                 ; preds = %bb.f, %bb.e, %bb.c
  ...
  %i.cg = shl i32 %i.a, 1
  %6 = sext i32 %i.cg to i64                      ; 26 uses
  %i.ch = shl i32 %i.a, 3
...
_ZN4ncnn3MatD2Ev.exit649.lr.ph.i:                 ; preds = %.preheader747.i
  ...
  %i.di = shl i32 %i.a, 1
  %7 = sext i32 %i.di to i64                      ; 13 uses
  %i.dj = shl i32 %i.a, 3
...
._crit_edge.us790.i:                              ; preds = %bb.y
  %i.oi = getelementptr inbounds nuw i8, ptr %.1542785.us.i, i64 %6 ; 2 uses
  %i.oj = getelementptr inbounds nuw i8, ptr %.1558784.us.i, i64 %6
...
bb.z:                                             ; preds = %bb.z, %.preheader744.us.i
  ...
  %i.sy = getelementptr inbounds nuw i8, ptr %i.sa, i64 %7 ; 3 uses
  %i.sz = getelementptr inbounds nuw i8, ptr %i.sb, i64 %7 ; 3 uses
  %i.ta = getelementptr inbounds nuw i8, ptr %i.sc, i64 %7 ; 3 uses
  %i.tb = getelementptr inbounds nuw i8, ptr %i.sd, i64 %7 ; 3 uses
  ...
  %i.tw = getelementptr inbounds nuw i8, ptr %i.sy, i64 %7 ; 3 uses
  %i.tx = getelementptr inbounds nuw i8, ptr %i.sz, i64 %7 ; 3 uses
  %i.ty = getelementptr inbounds nuw i8, ptr %i.ta, i64 %7 ; 3 uses
  %i.tz = getelementptr inbounds nuw i8, ptr %i.tb, i64 %7 ; 3 uses
  ...
  %i.uu = getelementptr inbounds nuw i8, ptr %i.tw, i64 %7 ; 2 uses
  %i.uv = getelementptr inbounds nuw i8, ptr %i.tx, i64 %7 ; 2 uses
  %i.uw = getelementptr inbounds nuw i8, ptr %i.ty, i64 %7 ; 2 uses
  %i.ux = getelementptr inbounds nuw i8, ptr %i.tz, i64 %7 ; 2 uses
...
._crit_edge830.us.i:                              ; preds = %._crit_edge830.us.i.unr-lcssa, %.epil.preheader249
  ...
  %i.xg = getelementptr inbounds nuw i8, ptr %.1613832.us.i, i64 %7 ; 2 uses
...
.noexc1917.i:                                     ; preds = %._crit_edge4676.i, %.noexc1917.lr.ph.i
  ...
  %i.cz = shl nsw i32 %.016214677.i, 2
...
.lr.ph579.i:                                      ; preds = %._crit_edge
  ...
  %i.cd = mul nsw i32 %.sroa.speculated115, 24
  %17 = sext i32 %i.cd to i64
  %i.ce = shl nsw i32 %.sroa.speculated115, 5
...
.lr.ph590.i:                                      ; preds = %.preheader567.i
  ...
  %i.hy = shl nsw i32 %.sroa.speculated115, 2
  %19 = sext i32 %i.hy to i64
  %i.hz = shl nsw i32 %.sroa.speculated115, 3
  %20 = sext i32 %i.hz to i64
  %i.ia = mul nsw i32 %.sroa.speculated115, 12
...
.lr.ph606.i:                                      ; preds = %.preheader566.i
  ...
  %i.mp = shl nsw i32 %.sroa.speculated115, 1
  %23 = sext i32 %i.mp to i64
  %i.mq = shl nsw i32 %.sroa.speculated115, 2
  %24 = sext i32 %i.mq to i64
  %i.mr = mul nsw i32 %.sroa.speculated115, 6
  %25 = sext i32 %i.mr to i64
  %i.ms = shl nsw i32 %.sroa.speculated115, 3
...
.lr.ph624.i:                                      ; preds = %.preheader.i
  ...
  %i.sz = shl nsw i32 %.sroa.speculated115, 1
  %27 = sext i32 %i.sz to i64
  %i.ta = mul nsw i32 %.sroa.speculated115, 3
  %28 = sext i32 %i.ta to i64
  %i.tb = shl nsw i32 %.sroa.speculated115, 2
  %29 = sext i32 %i.tb to i64                     ; 12 uses
...
.lr.ph103.i:                                      ; preds = %._crit_edge
  ...
  %i.fu = shl nsw i32 %.sroa.speculated116, 4
  %16 = sext i32 %i.fu to i64
  %i.fv = mul nsw i32 %.sroa.speculated116, 24
  %17 = sext i32 %i.fv to i64
  %i.fw = shl nsw i32 %.sroa.speculated116, 5
  %18 = sext i32 %i.fw to i64
  %i.fx = mul nsw i32 %.sroa.speculated116, 40
  %19 = sext i32 %i.fx to i64
  %i.fy = mul nsw i32 %.sroa.speculated116, 48
...
.lr.ph150.i:                                      ; preds = %.preheader79.i
  ...
  %i.rg = shl nsw i32 %.sroa.speculated116, 2
  %21 = sext i32 %i.rg to i64
  %i.rh = shl nsw i32 %.sroa.speculated116, 3
  %22 = sext i32 %i.rh to i64
  %i.ri = mul nsw i32 %.sroa.speculated116, 12
  %23 = sext i32 %i.ri to i64
  %i.rj = shl nsw i32 %.sroa.speculated116, 4
  %24 = sext i32 %i.rj to i64
  %i.rk = mul nsw i32 %.sroa.speculated116, 20
  %25 = sext i32 %i.rk to i64
  %i.rl = mul nsw i32 %.sroa.speculated116, 24
...
.lr.ph206.i:                                      ; preds = %.preheader77.i
  ...
  %i.abn = shl nsw i32 %.sroa.speculated116, 1
  %27 = sext i32 %i.abn to i64
  %i.abo = shl nsw i32 %.sroa.speculated116, 2
  %28 = sext i32 %i.abo to i64
  %i.abp = mul nsw i32 %.sroa.speculated116, 6
  %29 = sext i32 %i.abp to i64
  %i.abq = shl nsw i32 %.sroa.speculated116, 3
  %30 = sext i32 %i.abq to i64
  %i.abr = mul nsw i32 %.sroa.speculated116, 10
  %31 = sext i32 %i.abr to i64
  %i.abs = mul nsw i32 %.sroa.speculated116, 12
...
.lr.ph295.i:                                      ; preds = %.preheader75.i
  ...
  %i.aro = shl nsw i32 %.sroa.speculated116, 1
  %33 = sext i32 %i.aro to i64
  %i.arp = mul nsw i32 %.sroa.speculated116, 3
  %34 = sext i32 %i.arp to i64
  %i.arq = shl nsw i32 %.sroa.speculated116, 2
  %35 = sext i32 %i.arq to i64
  %i.arr = mul nsw i32 %.sroa.speculated116, 5
  %36 = sext i32 %i.arr to i64
  %i.ars = mul nsw i32 %.sroa.speculated116, 6
  %37 = sext i32 %i.ars to i64                    ; 30 uses
