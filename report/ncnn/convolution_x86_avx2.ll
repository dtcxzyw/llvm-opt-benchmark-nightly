...
bb.a:
  ...
  store i32 %2, ptr %i.a, align 4, !tbaa !24
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #8
  store i32 %3, ptr %i.b, align 4, !tbaa !24
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #8
  store i32 %2, ptr %i.c, align 4, !tbaa !24
  ...
  %i.k = load i32, ptr %i.d, align 4, !tbaa !24   ; 3 uses
  %i.l = add i32 %3, -1
  %i.m = add i32 %i.l, %i.k
  %i.n = sdiv i32 %i.m, %i.k                      ; 2 uses
  store i32 %i.n, ptr %i.g, align 4, !tbaa !24
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #8
  %i.o = load i32, ptr %i.f, align 4, !tbaa !24   ; 3 uses
  %i.p = mul i32 %i.o, %i.k                       ; 2 uses
  %i.q = mul i32 %i.p, 36
  %i.r = load i32, ptr %i.i, align 4, !tbaa !32
...
bb.b:                                             ; preds = %bb.a
  %i.y = load i32, ptr %i.i, align 4, !tbaa !32
  ...
  %i.z = load ptr, ptr %i.s, align 8, !tbaa !36   ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %i.ac = load ptr, ptr %i.t, align 8, !tbaa !37  ; 3 uses
  %.not3.i.i = icmp eq ptr %i.ac, null
  %i.ad = load ptr, ptr %5, align 8, !tbaa !15    ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  invoke void %i.ag(ptr noundef nonnull align 8 dereferenceable(8) %i.ac, ptr noundef %i.ad)
          to label %_ZN4ncnnL42conv3x3s1_winograd43_transform_kernel_int8ERKNS_3MatERS0_iiRKNS_6OptionE.exit unwind label %bb.h, !inline_history !0
...
bb.i:                                             ; preds = %bb.a
  %i.aj = landingpad { ptr, i32 }
          cleanup
  %i.ak = load ptr, ptr %i.s, align 8, !tbaa !36  ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  %i.an = load ptr, ptr %i.t, align 8, !tbaa !37  ; 3 uses
  %.not3.i10.i = icmp eq ptr %i.an, null
  %i.ao = load ptr, ptr %5, align 8, !tbaa !15    ; 3 uses
  br i1 %.not3.i10.i, label %bb.m, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.ap = load ptr, ptr %i.an, align 8, !tbaa !39
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 24
  %i.ar = load ptr, ptr %i.aq, align 8
  invoke void %i.ar(ptr noundef nonnull align 8 dereferenceable(8) %i.an, ptr noundef %i.ao)
          to label %_ZN4ncnn3MatD2Ev.exit.i unwind label %bb.o, !inline_history !0
