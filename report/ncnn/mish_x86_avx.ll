...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.cn = fmul fast <8 x float> %i.bt, splat (float f0x3F317218)
  %reass.add299 = fadd fast <8 x float> %i.cm, splat (float -5.000000e-01)
  %reass.mul296.a = fmul fast <8 x float> %i.bv, %reass.add299
  %i.co = fadd fast <8 x float> %i.cn, %i.bu
...
.lr.ph303:                                        ; preds = %.preheader297, %.lr.ph303
  ...
  %i.hc = fmul fast <4 x float> %i.gi, splat (float f0x3F317218)
  %reass.add295 = fadd fast <4 x float> %i.hb, splat (float -5.000000e-01)
  %reass.mul = fmul fast <4 x float> %i.gk, %reass.add295
  %i.hd = fadd fast <4 x float> %i.hc, %i.gj
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %i.cr = fmul fast <8 x float> %i.bx, splat (float f0x3F317218)
  %reass.add303 = fadd fast <8 x float> %i.cq, splat (float -5.000000e-01)
  %reass.mul300.a = fmul fast <8 x float> %i.bz, %reass.add303
  %i.cs = fadd fast <8 x float> %i.cr, %i.by
...
.lr.ph307:                                        ; preds = %.preheader301, %.lr.ph307
  ...
  %i.ia = fmul fast <4 x float> %i.hz, %i.hi
  %i.ib = fmul fast <4 x float> %i.hh, splat (float f0x3F317218)
  %reass.add299 = fadd fast <4 x float> %i.ia, splat (float -5.000000e-01)
  %reass.mul = fmul fast <4 x float> %i.hj, %reass.add299
  %i.ic = fadd fast <4 x float> %i.ib, %i.hi
