...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %reass.mul298 = fmul fast <8 x float> %i.cm, %i.cl
  %.neg295 = fmul fast <8 x float> %i.bv, splat (float -5.000000e-01)
  %reass.mul300 = fmul fast <8 x float> %i.bt, splat (float f0x3F317218)
  %5 = fadd fast <8 x float> %i.bu, %.neg295
  %i.cn = fadd fast <8 x float> %reass.mul298, %5
  ...
  %i.dm = fadd fast <8 x float> %i.cz, %i.dl
...
.lr.ph307:                                        ; preds = %.preheader301, %.lr.ph307
  ...
  %i.fm = fadd fast <4 x float> %i.ez, %i.fl
  ...
  %i.gj = fmul fast <4 x float> %i.gi, %i.gi      ; 2 uses
  ...
  %i.ha = fmul fast <4 x float> %i.gj, %i.gi
  %reass.mul.a = fmul fast <4 x float> %i.ha, %i.gz
  %.neg294 = fmul fast <4 x float> %i.gj, splat (float -5.000000e-01)
  %reass.mul296 = fmul fast <4 x float> %i.gh, splat (float f0x3F317218)
  %6 = fadd fast <4 x float> %i.gi, %.neg294
  %i.hb = fadd fast <4 x float> %reass.mul.a, %6
  ...
  %i.ib = fadd fast <4 x float> %i.ho, %i.ia
  %i.ic = fadd fast <4 x float> %i.ib, splat (float 1.000000e+00)
...
.lr.ph:                                           ; preds = %.noexc, %.lr.ph
  ...
  %reass.mul302 = fmul fast <8 x float> %i.cq, %i.cp
  %.neg299 = fmul fast <8 x float> %i.bz, splat (float -5.000000e-01)
  %reass.mul304 = fmul fast <8 x float> %i.bx, splat (float f0x3F317218)
  %5 = fadd fast <8 x float> %i.by, %.neg299
  %i.cr = fadd fast <8 x float> %reass.mul302, %5
  ...
  %i.dq = fadd fast <8 x float> %i.dd, %i.dp
...
.lr.ph311:                                        ; preds = %.preheader305, %.lr.ph311
  ...
  %i.hi = fmul fast <4 x float> %i.hh, %i.hh      ; 2 uses
  ...
  %i.hz = fmul fast <4 x float> %i.hi, %i.hh
  %reass.mul.a = fmul fast <4 x float> %i.hz, %i.hy
  %.neg298 = fmul fast <4 x float> %i.hi, splat (float -5.000000e-01)
  %reass.mul300 = fmul fast <4 x float> %i.hg, splat (float f0x3F317218)
  %6 = fadd fast <4 x float> %i.hh, %.neg298
  %i.ia = fadd fast <4 x float> %reass.mul.a, %6
  ...
  %i.ja = fadd fast <4 x float> %i.in, %i.iz
  %i.jb = fadd fast <4 x float> %i.ja, splat (float 1.000000e+00)
