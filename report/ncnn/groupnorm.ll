...
.lr.ph:                                           ; preds = %bb.b
  %i.m = load i32, ptr %4, align 4, !tbaa !42     ; 8 uses
  ...
  %i.w = sitofp fast i32 %i.m to float            ; 2 uses
  ...
  %i.ak = fdiv fast float 1.000000e+00, %i.w
  ...
  %5 = fdiv fast float 1.000000e+00, %i.w
...
._crit_edge104.i:                                 ; preds = %.lr.ph.us106.i, %middle.block84, %.thread
  ...
  %6 = fmul fast float %.081.lcssa.i, %5
  %i.bw = fadd fast float %6, %i.av
...
._crit_edge96:                                    ; preds = %._crit_edge.us
  ...
  %7 = sitofp fast i32 %i.s to float              ; 2 uses
