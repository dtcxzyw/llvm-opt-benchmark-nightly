...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ra = fadd fast <8 x float> %i.qw, %i.qo
  %i.rb = fadd fast <8 x float> %i.qx, %i.qp
  %i.rc = fadd fast <8 x float> %i.qy, %i.qq
  %i.rd = fadd fast <8 x float> %i.qz, %i.qr
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.sn = fadd fast <8 x float> %i.sm, %i.sk
