...
.noexc43:                                         ; preds = %bb.c
  ...
  %i.cv = load ptr, ptr %8, align 8, !tbaa !18, !noalias !641 ; 5 uses
  ...
  %i.df = sext i32 %i.cs to i64                   ; 13 uses
...
bb.h:                                             ; preds = %bb.f
  ...
  %i.us = load i32, ptr %i.ap, align 8, !tbaa !50 ; 19 uses
...
.preheader9.us.preheader.i:                       ; preds = %.preheader9.lr.ph.i65
  %10 = sext i32 %i.us to i64                     ; 8 uses
  %wide.trip.count144.i = zext i32 %i.us to i64   ; 9 uses
  ...
  %scevgep1101.a = getelementptr i8, ptr %i.cv, i64 8
  %11 = add nsw i64 %10, %i.uv
  %i.vi = shl nsw i64 %11, 3
  %i.vj = add i64 %i.vi, %i.db                    ; 2 uses
  %12 = sub i64 %i.vj, %i.vh
  %scevgep1102.a = getelementptr i8, ptr %scevgep1101.a, i64 %12
  %scevgep1103 = getelementptr i8, ptr %i.cv, i64 8
  %i.vk = shl nsw i64 %i.df, 3
  %i.vl = add nsw i32 %i.uq, -1
  %i.vm = zext i32 %i.vl to i64
  %i.vn = mul i64 %i.vk, %i.vm
  %i.vo = sub i64 %i.vj, %i.vn
  %scevgep1104 = getelementptr i8, ptr %scevgep1103, i64 %i.vo
...
.lr.ph.us.i.prol:                                 ; preds = %.lr.ph.us.i.preheader, %.lr.ph.us.i.prol
  ...
  %i.wv = sub nsw i64 %10, %indvars.iv141.i.prol
...
.lr.ph.us.i.preheader.new:                        ; preds = %.lr.ph.us.i.prol.loopexit
  %invariant.gep1508.a = getelementptr [8 x i8], ptr %.08922.us.i, i64 %10
  br label %.lr.ph.us.i
...
.lr.ph.us.i:                                      ; preds = %.lr.ph.us.i, %.lr.ph.us.i.preheader.new
  ...
  %i.xb = sub nsw i64 %10, %indvars.iv141.i
  ...
  %i.xh = sub nsw i64 %10, %indvars.iv.next142.i.1
  ...
  %i.xl = sub nsw i64 %10, %indvars.iv.next142.i.2
...
.preheader5.lr.ph.i56:                            ; preds = %.preheader6.i47
  ...
  %13 = sext i32 %i.us to i64                     ; 8 uses
  %wide.trip.count156.i = zext i32 %i.us to i64   ; 9 uses
  ...
  %14 = shl nuw nsw i64 %wide.trip.count156.i, 3  ; 2 uses
  %i.aiz = shl nsw i64 %13, 3                     ; 2 uses
  %15 = sub nsw i64 %i.aiz, %14
...
vec.epilog.vector.body1003:                       ; preds = %vec.epilog.vector.body1003, %vec.epilog.ph1001
  ...
  %i.ajz = sub nsw i64 %13, %index1004
...
.lr.ph.i64.prol:                                  ; preds = %.lr.ph.i64.preheader, %.lr.ph.i64.prol
  ...
  %i.akd = sub nsw i64 %13, %indvars.iv153.i.prol
...
.lr.ph.i64.preheader.new:                         ; preds = %.lr.ph.i64.prol.loopexit
  %invariant.gep1510.a = getelementptr [8 x i8], ptr %.19081.i, i64 %13
  br label %.lr.ph.i64
...
.preheader2.lr.ph.i49:                            ; preds = %._crit_edge84.i
  ...
  %i.akl = sext i32 %i.akk to i64                 ; 3 uses
  ...
  %16 = sext i32 %i.us to i64                     ; 8 uses
  %wide.trip.count168.i = zext i32 %i.us to i64   ; 9 uses
  ...
  %18 = shl nsw i64 %i.akl, 3                     ; 2 uses
  %19 = add nsw i64 %18, %i.aky
  %20 = sub nsw i64 %17, %19
  %scevgep841 = getelementptr i8, ptr %scevgep840, i64 %20
  %21 = shl nsw i64 %i.df, 3
  %i.akz = add nsw i32 %i.ur, -1
  %i.ala = zext i32 %i.akz to i64
  %i.alb = mul i64 %21, %i.ala
  %i.alc = add i64 %i.alb, %18
  %i.ald = sub i64 %17, %i.alc
...
.lr.ph.i64:                                       ; preds = %.lr.ph.i64, %.lr.ph.i64.preheader.new
  ...
  %i.aml = sub nsw i64 %13, %indvars.iv153.i
  ...
  %i.amr = sub nsw i64 %13, %indvars.iv.next154.i.1
  ...
  %i.amv = sub nsw i64 %13, %indvars.iv.next154.i.2
...
.lr.ph89.i.prol:                                  ; preds = %.lr.ph89.i.preheader, %.lr.ph89.i.prol
  ...
  %i.aqi = sub nsw i64 %16, %indvars.iv165.i.prol
...
.lr.ph89.i.preheader.new:                         ; preds = %.lr.ph89.i.prol.loopexit
  %invariant.gep1512 = getelementptr [8 x i8], ptr %.392102.i, i64 %16
  br label %.lr.ph89.i
...
.lr.ph89.i:                                       ; preds = %.lr.ph89.i, %.lr.ph89.i.preheader.new
  ...
  %i.arl = sub nsw i64 %16, %indvars.iv165.i
  ...
  %i.arr = sub nsw i64 %16, %indvars.iv.next166.i.1
  ...
  %i.arv = sub nsw i64 %16, %indvars.iv.next166.i.2
