...
.lr.ph:                                           ; preds = %bb.b
  ...
  %i.o = load i32, ptr %i.n, align 8, !tbaa !38   ; 4 uses
...
vector.body84:                                    ; preds = %vector.body84, %vector.ph82
  ...
  br i1 %i.bp, label %middle.block93, label %vector.body84, !llvm.loop !72
...
scalar.ph80:                                      ; preds = %scalar.ph80.preheader, %scalar.ph80
  ...
  br i1 %exitcond55.not, label %._crit_edge.us.us, label %scalar.ph80, !llvm.loop !73
...
._crit_edge.us.us:                                ; preds = %scalar.ph80, %middle.block93
  ...
  %i.bz = load float, ptr %i.q, align 8, !tbaa !44
  ...
  br i1 %exitcond60.not, label %._crit_edge41.split.us.us, label %.lr.ph.us.us, !llvm.loop !74
...
.lr.ph40:                                         ; preds = %.lr.ph40.preheader, %._crit_edge41.split
  ...
  %indvars.iv51 = phi i64 [ %i.ah, %.lr.ph40.preheader ], [ %indvars.iv.next52, %._crit_edge41.split ] ; 3 uses
  %7 = add i64 %indvar, %i.ah
  %i.cb = shl i64 %7, 2
  %scevgep73 = getelementptr i8, ptr %i.ap, i64 %i.cb ; 4 uses
  %8 = shl nsw i64 %indvars.iv51, 2
  %scevgep74 = getelementptr i8, ptr %i.ad, i64 %8 ; 4 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  %i.ck = load float, ptr %i.q, align 8, !tbaa !44, !alias.scope !81, !noalias !82
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.co, align 4, !tbaa !52, !alias.scope !83, !noalias !82
  ...
  store float %i.cy, ptr %i.cu, align 4, !tbaa !52, !alias.scope !82
  %i.cz = extractelement <4 x float> %i.cp, i64 1
  store float %i.cz, ptr %i.cv, align 4, !tbaa !52, !alias.scope !82
  %i.da = extractelement <4 x float> %i.cp, i64 2
  store float %i.da, ptr %i.cw, align 4, !tbaa !52, !alias.scope !82
  %i.db = extractelement <4 x float> %i.cp, i64 3
  store float %i.db, ptr %i.cx, align 4, !tbaa !52, !alias.scope !82
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.dc = icmp eq i64 %index.next, %n.vec
  br i1 %i.dc, label %middle.block, label %vector.body, !llvm.loop !79
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  %i.df = load float, ptr %i.q, align 8, !tbaa !44
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.dk = load float, ptr %i.q, align 8, !tbaa !44
  ...
  %i.do = load float, ptr %i.q, align 8, !tbaa !44
  ...
  br i1 %exitcond.not.1, label %._crit_edge41.split, label %scalar.ph, !llvm.loop !80
...
; Function Attrs: nounwind
declare !callback !66 void @__kmpc_fork_call(ptr, i32, ptr, ...) local_unnamed_addr #11
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.w, label %middle.block, label %vector.body, !llvm.loop !151
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond.not, label %._crit_edge.us, label %scalar.ph, !llvm.loop !152
...
._crit_edge.us:                                   ; preds = %scalar.ph, %middle.block
  ...
  br i1 %exitcond23.not, label %._crit_edge9, label %.lr.ph.us, !llvm.loop !153
...
.lr.ph14.split:                                   ; preds = %.lr.ph14, %._crit_edge
  ...
  %i.al = load ptr, ptr %0, align 8, !tbaa !20
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.lr.ph14.split
  ...
  br i1 %i.bc, label %.lr.ph14.split, label %._crit_edge15, !llvm.loop !154
...
.lr.ph:                                           ; preds = %.lr.ph14.split, %.lr.ph
  ...
  store i8 %.0.i, ptr %i.bj, align 1, !tbaa !70
  ...
  br i1 %i.bm, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !155
}
...
.lr.ph.split:                                     ; preds = %.lr.ph
  ...
  %i.ac = icmp sgt i32 %i.ab, 0
  %i.ad = load ptr, ptr %i.u, align 8, !tbaa !20
  %i.ae = load ptr, ptr %i.t, align 8, !tbaa !20  ; 7 uses
  %i.af = load ptr, ptr %7, align 8, !tbaa !20    ; 4 uses
...
vector.body87:                                    ; preds = %vector.body87, %vector.ph85
  ...
  %wide.load91 = load <4 x i8>, ptr %next.gep, align 1, !tbaa !70
  %wide.load92 = load <4 x i8>, ptr %i.bd, align 1, !tbaa !70
  %i.be = sext <4 x i8> %wide.load91 to <4 x i32>
  %i.bf = sext <4 x i8> %wide.load92 to <4 x i32>
  %i.bg = getelementptr i8, ptr %next.gep90, i64 4
  %wide.load93 = load <4 x i8>, ptr %next.gep90, align 1, !tbaa !70
  %wide.load94 = load <4 x i8>, ptr %i.bg, align 1, !tbaa !70
  ...
  br i1 %i.bn, label %middle.block96, label %vector.body87, !llvm.loop !156
...
scalar.ph83:                                      ; preds = %scalar.ph83.preheader, %scalar.ph83
  ...
  %i.bq = load i8, ptr %.03236.us.us, align 1, !tbaa !70
  %i.br = sext i8 %i.bq to i32
  %i.bs = getelementptr inbounds nuw i8, ptr %.135.us.us, i64 1
  %i.bt = load i8, ptr %.135.us.us, align 1, !tbaa !70
  ...
  br i1 %exitcond58.not, label %._crit_edge.us.us, label %scalar.ph83, !llvm.loop !157
...
._crit_edge.us.us:                                ; preds = %scalar.ph83, %middle.block96
  ...
  %i.ch = load float, ptr %i.q, align 8, !tbaa !44
  ...
  br i1 %exitcond63.not, label %._crit_edge44.split.us.us, label %.lr.ph.us.us, !llvm.loop !158
...
.lr.ph43:                                         ; preds = %.lr.ph43.preheader, %._crit_edge44.split
  ...
  %indvars.iv54 = phi i64 [ %i.aj, %.lr.ph43.preheader ], [ %indvars.iv.next55, %._crit_edge44.split ] ; 3 uses
  %8 = add i64 %indvar, %i.aj
  %i.cj = shl i64 %8, 2
  %scevgep76 = getelementptr i8, ptr %i.ar, i64 %i.cj ; 4 uses
  %9 = shl nsw i64 %indvars.iv54, 2
  %scevgep77 = getelementptr i8, ptr %i.af, i64 %9 ; 4 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  %i.cs = load float, ptr %i.q, align 8, !tbaa !44, !alias.scope !165, !noalias !166
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.cw, align 4, !tbaa !52, !alias.scope !167, !noalias !166
  ...
  store float %i.dg, ptr %i.dc, align 4, !tbaa !52, !alias.scope !166
  %i.dh = extractelement <4 x float> %i.cx, i64 1
  store float %i.dh, ptr %i.dd, align 4, !tbaa !52, !alias.scope !166
  %i.di = extractelement <4 x float> %i.cx, i64 2
  store float %i.di, ptr %i.de, align 4, !tbaa !52, !alias.scope !166
  %i.dj = extractelement <4 x float> %i.cx, i64 3
  store float %i.dj, ptr %i.df, align 4, !tbaa !52, !alias.scope !166
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.dk = icmp eq i64 %index.next, %n.vec
  br i1 %i.dk, label %middle.block, label %vector.body, !llvm.loop !163
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader
  ...
  %i.dn = load float, ptr %i.q, align 8, !tbaa !44
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.ds = load float, ptr %i.q, align 8, !tbaa !44
  ...
  %i.dw = load float, ptr %i.q, align 8, !tbaa !44
  ...
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %exitcond.not.1 = icmp eq i64 %indvars.iv.next.1, %wide.trip.count
  br i1 %exitcond.not.1, label %._crit_edge44.split, label %scalar.ph, !llvm.loop !164
