...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %bc.merge.rdx = phi float [ %i.pe, %vec.epilog.iter.check ], [ %.3885.us, %vector.main.loop.iter.check ]
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %predphi1097.a = select i1 %.0269.us, <8 x float> %i.pk, <8 x float> zeroinitializer
  ...
  %i.pn = select ninf i1 %.0268.us, <8 x float> %i.pm, <8 x float> splat (float -0.000000e+00)
  ...
  %i.pq = select ninf i1 %.0267.us, <8 x float> %i.pp, <8 x float> splat (float -0.000000e+00)
...
vec.epilog.scalar.ph.preheader:                   ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  %.4877.us.ph = phi float [ %.3885.us, %iter.check ], [ %i.pe, %vec.epilog.iter.check ], [ %i.py, %vec.epilog.middle.block ]
  %.7876.us.ph = phi ptr [ %.6.us, %iter.check ], [ %i.nx, %vec.epilog.iter.check ], [ %i.pg, %vec.epilog.middle.block ]
...
_ZN4ncnn3MatD2Ev.exit.lr.ph.us:                   ; preds = %.thread846.us
  ...
  %broadcast.splatinsert1036.a = insertelement <8 x i1> poison, i1 %.0267.us, i64 0
  %broadcast.splat1037.a = shufflevector <8 x i1> %broadcast.splatinsert1036.a, <8 x i1> poison, <8 x i32> zeroinitializer
  %broadcast.splatinsert1038.a = insertelement <8 x i1> poison, i1 %.0268.us, i64 0
  %broadcast.splat1039.a = shufflevector <8 x i1> %broadcast.splatinsert1038.a, <8 x i1> poison, <8 x i32> zeroinitializer
  %broadcast.splatinsert1040.a = insertelement <8 x i1> poison, i1 %.0269.us, i64 0
  ...
  %broadcast.splatinsert1044.a = insertelement <8 x float> poison, float %.0273.us, i64 0
  ...
  %broadcast.splatinsert1046.a = insertelement <8 x float> poison, float %.0272.us, i64 0
  ...
  %broadcast.splatinsert1048.a = insertelement <8 x float> poison, float %.0271.us, i64 0
  ...
  %broadcast.splatinsert1050 = insertelement <8 x float> poison, float %.0270.us, i64 0
  %broadcast.splat1051 = shufflevector <8 x float> %broadcast.splatinsert1050, <8 x float> poison, <8 x i32> zeroinitializer ; 2 uses
  %broadcast.splatinsert1052 = insertelement <8 x float> poison, float %.1275.us, i64 0
...
._crit_edge906:                                   ; preds = %._crit_edge896.us, %.preheader861.lr.ph, %.thread842
  %.2833.lcssa = phi <8 x float> [ %.1832, %.thread842 ], [ %.1832, %.preheader861.lr.ph ], [ %.4835.lcssa.us, %._crit_edge896.us ] ; 10 uses
  %.2826.lcssa = phi <4 x float> [ %.1825, %.thread842 ], [ %.1825, %.preheader861.lr.ph ], [ %.4828.lcssa.us, %._crit_edge896.us ] ; 10 uses
  %.1281.lcssa = phi float [ %.0280, %.thread842 ], [ %.0280, %.preheader861.lr.ph ], [ %.3.lcssa.us, %._crit_edge896.us ] ; 13 uses
...
.noexc369:                                        ; preds = %bb.an
  ...
  %i.so = fadd fast <8 x float> %i.sb, splat (float 1.000000e+00)
  %i.sp = fadd fast <8 x float> %i.so, %i.sn
...
.noexc370:                                        ; preds = %bb.an
  ...
  %i.tt = fadd fast <8 x float> %i.tg, splat (float 1.000000e+00)
  %i.tu = fadd fast <8 x float> %i.tt, %i.ts
  ...
  %reass.mul.a = fmul fast <8 x float> %i.up, splat (float f0x3F317218)
  %reass.add853 = fadd fast <8 x float> %i.vi, splat (float -5.000000e-01)
  %reass.mul854.a = fmul fast <8 x float> %i.ur, %reass.add853
  %i.vj = fadd fast <8 x float> %reass.mul.a, %i.uq
  ...
  %i.wi = fadd fast <8 x float> %i.vv, splat (float 1.000000e+00)
  %i.wj = fadd fast <8 x float> %i.wi, %i.wh
  ...
  %i.ws = fmul fast <8 x float> %i.wr, %.2833.lcssa
  br label %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit
...
.noexc371:                                        ; preds = %bb.an
  ...
  %i.xb = fmul fast <8 x float> %i.ww, %.2833.lcssa
  ...
  %i.xf = fmul fast <8 x float> %i.xe, %.2833.lcssa
  br label %_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit

_ZL14activation_avxDv8_fiRKN4ncnn3MatE.exit:      ; preds = %.noexc371, %.noexc370, %.noexc369, %bb.ap, %.noexc368, %bb.ao, %bb.an
  %.0.i = phi nsz <8 x float> [ %i.xf, %.noexc371 ], [ %i.qy, %bb.ao ], [ %i.rg, %.noexc368 ], [ %i.rq, %bb.ap ], [ %i.sw, %.noexc369 ], [ %i.ws, %.noexc370 ], [ %.2833.lcssa, %bb.an ]
...
bb.as:                                            ; preds = %bb.ar
  %i.xp = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.max.ps(<4 x float> nofpclass(nan inf) %.2826.lcssa, <4 x float> zeroinitializer)
...
.noexc373:                                        ; preds = %bb.ar
  ...
  %i.xs = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.max.ps(<4 x float> zeroinitializer, <4 x float> nofpclass(nan inf) %.2826.lcssa)
  %i.xt = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.min.ps(<4 x float> zeroinitializer, <4 x float> nofpclass(nan inf) %.2826.lcssa)
...
bb.at:                                            ; preds = %bb.ar
  ...
  %i.yg = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.max.ps(<4 x float> nofpclass(nan inf) %.2826.lcssa, <4 x float> nofpclass(nan inf) %i.yb)
...
.noexc374:                                        ; preds = %bb.ar
  %i.yi = fneg fast <4 x float> %.2826.lcssa
  ...
  %i.zg = fadd fast <4 x float> %i.yt, splat (float 1.000000e+00)
  %i.zh = fadd fast <4 x float> %i.zg, %i.zf
...
.noexc375:                                        ; preds = %bb.ar
  %i.zp = call fast noundef nofpclass(nan inf) <4 x float> @llvm.x86.sse.min.ps(<4 x float> nofpclass(nan inf) %.2826.lcssa, <4 x float> splat (float f0x42B0C0A5))
  ...
  %i.aam = fadd fast <4 x float> %i.zz, splat (float 1.000000e+00)
  %i.aan = fadd fast <4 x float> %i.aam, %i.aal
  ...
  %i.abj = fmul fast <4 x float> %i.abi, %i.abi
  ...
  %i.aca = fmul fast <4 x float> %i.abz, %i.abi
  %reass.mul856 = fmul fast <4 x float> %i.abh, splat (float f0x3F317218)
  %reass.add857 = fadd fast <4 x float> %i.aca, splat (float -5.000000e-01)
  %reass.mul858 = fmul fast <4 x float> %i.abj, %reass.add857
  %i.acb = fadd fast <4 x float> %reass.mul856, %i.abi
  ...
  %i.adb = fadd fast <4 x float> %i.aco, splat (float 1.000000e+00)
  %i.adc = fadd fast <4 x float> %i.adb, %i.ada
  ...
  %i.adl = fmul fast <4 x float> %i.adk, %.2826.lcssa
  br label %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit
...
bb.au:                                            ; preds = %bb.ar
  ...
  %i.adu = fmul fast <4 x float> %i.adp, %.2826.lcssa
  ...
  %i.ady = fmul fast <4 x float> %i.adx, %.2826.lcssa
  br label %_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit

_ZL14activation_sseDv4_fiRKN4ncnn3MatE.exit:      ; preds = %bb.au, %.noexc375, %.noexc374, %bb.at, %.noexc373, %bb.as, %bb.ar
  %.0.i372 = phi nsz <4 x float> [ %i.ady, %bb.au ], [ %i.xp, %bb.as ], [ %i.xx, %.noexc373 ], [ %i.yh, %bb.at ], [ %i.zo, %.noexc374 ], [ %i.adl, %.noexc375 ], [ %.2826.lcssa, %bb.ar ]
...
bb.ax:                                            ; preds = %bb.aw
  %i.aei = call fast float @llvm.maxnum.f32(float nofpclass(nan inf) %.1281.lcssa, float 0.000000e+00)
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

bb.ay:                                            ; preds = %bb.aw
  %i.aej = load ptr, ptr %28, align 8, !tbaa !18
  %i.aek = load float, ptr %i.aej, align 4, !tbaa !38
  %i.ael = fcmp fast ogt float %.1281.lcssa, 0.000000e+00
  %i.aem = select fast i1 %i.ael, float 1.000000e+00, float %i.aek
  %i.aen = fmul fast float %i.aem, %.1281.lcssa
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit
...
bb.az:                                            ; preds = %bb.aw
  ...
  %.0838 = call nnan ninf nsz float @llvm.maxnum.f32(float %.1281.lcssa, float %i.aep) ; 2 uses
  %i.aes = fcmp fast ogt float %.0838, %i.aer
...
bb.bc:                                            ; preds = %bb.aw
  %i.aex = call fast float @llvm.exp.f32(float nofpclass(nan inf) %.1281.lcssa)
  ...
  %i.afb = fmul fast float %i.afa, %.1281.lcssa
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit
...
bb.bd:                                            ; preds = %bb.aw
  ...
  %i.afi = fcmp fast olt float %.1281.lcssa, %i.afh
...
bb.be:                                            ; preds = %bb.bd
  ...
  %i.afl = fcmp fast ogt float %.1281.lcssa, %i.afk
  br i1 %i.afl, label %_ZL13activation_ssfiRKN4ncnn3MatE.exit, label %bb.bf

bb.bf:                                            ; preds = %bb.be
  %i.afm = fmul fast float %i.afd, %.1281.lcssa
  %i.afn = fadd fast float %i.afm, %i.aff
  %i.afo = fmul fast float %i.afn, %.1281.lcssa
  br label %_ZL13activation_ssfiRKN4ncnn3MatE.exit

_ZL13activation_ssfiRKN4ncnn3MatE.exit:           ; preds = %bb.bf, %bb.be, %bb.bc, %bb.bb, %bb.ba, %bb.az, %bb.ay, %bb.ax, %bb.aw, %bb.bd
  %.1839 = phi nsz float [ %.1281.lcssa, %bb.aw ], [ %i.aei, %bb.ax ], [ %i.aen, %bb.ay ], [ %i.aer, %bb.ba ], [ %.0838, %bb.az ], [ %i.aew, %bb.bb ], [ %i.afb, %bb.bc ], [ %i.afo, %bb.bf ], [ %.1281.lcssa, %bb.be ], [ 0.000000e+00, %bb.bd ]
  ...
  store float %.1839, ptr %i.aft, align 4, !tbaa !38
  br label %bb.bg
