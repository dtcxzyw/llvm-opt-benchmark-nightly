...
.noexc370:                                        ; preds = %bb.an
  ...
  %i.vj = fmul fast <8 x float> %i.vi, %i.vh
  %.neg852 = fmul fast <8 x float> %i.ur, splat (float -5.000000e-01)
  %reass.mul = fmul fast <8 x float> %i.up, splat (float f0x3F317218)
  %29 = fadd fast <8 x float> %i.uq, %.neg852
  %i.vk = fadd fast <8 x float> %i.vj, %29
...
.noexc375:                                        ; preds = %bb.ar
  ...
  %i.abk = fmul fast <4 x float> %i.abj, %i.abj   ; 2 uses
  ...
  %i.acb = fmul fast <4 x float> %i.abk, %i.abj
  %i.acc = fmul fast <4 x float> %i.acb, %i.aca
  %.neg853 = fmul fast <4 x float> %i.abk, splat (float -5.000000e-01)
  %reass.mul854 = fmul fast <4 x float> %i.abi, splat (float f0x3F317218)
  %30 = fadd fast <4 x float> %i.abj, %.neg853
  %i.acd = fadd fast <4 x float> %i.acc, %30
