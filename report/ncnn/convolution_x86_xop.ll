...
.lr.ph384.i:                                      ; preds = %._crit_edge
  ...
  %i.cd = shl nuw nsw i32 %.sroa.speculated116, 3
  %16 = zext nneg i32 %i.cd to i64
  %i.ce = mul nuw nsw i32 %.sroa.speculated116, 12
...
.lr.ph395.i:                                      ; preds = %.preheader372.i
  ...
  %i.gq = shl nuw nsw i32 %.sroa.speculated116, 1
  %19 = zext nneg i32 %i.gq to i64
  %i.gr = shl nuw nsw i32 %.sroa.speculated116, 2
  %20 = zext nneg i32 %i.gr to i64
  %i.gs = mul nuw nsw i32 %.sroa.speculated116, 6
  %21 = zext nneg i32 %i.gs to i64
  %i.gt = shl nuw nsw i32 %.sroa.speculated116, 3
...
.lr.ph413.i:                                      ; preds = %.preheader.i
  ...
  %i.na = shl nuw nsw i32 %.sroa.speculated116, 1
  %23 = zext nneg i32 %i.na to i64
  %i.nb = mul nuw nsw i32 %.sroa.speculated116, 3
  %24 = zext nneg i32 %i.nb to i64
  %i.nc = shl nuw nsw i32 %.sroa.speculated116, 2
  %25 = zext nneg i32 %i.nc to i64                ; 12 uses
...
.lr.ph77.i:                                       ; preds = %._crit_edge
  ...
  %i.ew = shl nuw nsw i32 %.sroa.speculated117, 3
  %16 = zext nneg i32 %i.ew to i64
  %i.ex = mul nuw nsw i32 %.sroa.speculated117, 12
  %17 = zext nneg i32 %i.ex to i64
  %i.ey = shl nuw nsw i32 %.sroa.speculated117, 4
  %18 = zext nneg i32 %i.ey to i64
  %i.ez = mul nuw nsw i32 %.sroa.speculated117, 20
  %19 = zext nneg i32 %i.ez to i64
  %i.fa = mul nuw nsw i32 %.sroa.speculated117, 24
...
.lr.ph128.i:                                      ; preds = %.preheader53.i
  ...
  %i.oz = shl nuw nsw i32 %.sroa.speculated117, 1
  %21 = zext nneg i32 %i.oz to i64
  %i.pa = shl nuw nsw i32 %.sroa.speculated117, 2
  %22 = zext nneg i32 %i.pa to i64
  %i.pb = mul nuw nsw i32 %.sroa.speculated117, 6
  %23 = zext nneg i32 %i.pb to i64
  %i.pc = shl nuw nsw i32 %.sroa.speculated117, 3
  %24 = zext nneg i32 %i.pc to i64
  %i.pd = mul nuw nsw i32 %.sroa.speculated117, 10
  %25 = zext nneg i32 %i.pd to i64
  %i.pe = mul nuw nsw i32 %.sroa.speculated117, 12
...
.lr.ph217.i:                                      ; preds = %.preheader51.i
  ...
  %i.afe = shl nuw nsw i32 %.sroa.speculated117, 1
  %27 = zext nneg i32 %i.afe to i64
  %i.aff = mul nuw nsw i32 %.sroa.speculated117, 3
  %28 = zext nneg i32 %i.aff to i64
  %i.afg = shl nuw nsw i32 %.sroa.speculated117, 2
  %29 = zext nneg i32 %i.afg to i64
  %i.afh = mul nuw nsw i32 %.sroa.speculated117, 5
  %30 = zext nneg i32 %i.afh to i64
  %i.afi = mul nuw nsw i32 %.sroa.speculated117, 6
  %31 = zext nneg i32 %i.afi to i64               ; 30 uses
