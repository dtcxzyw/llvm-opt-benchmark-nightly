...
begin_hunk_0_@_ZN4ncnn27convolution_packed_int8_xopERKNS_3MatERS0_S2_iiiiiiRKNS_6OptionE:bb.a
  ...
  %i.air = load i32, ptr %i.a, align 4, !tbaa !10
  ...
  %i.aiv = load i32, ptr %i.f, align 4, !tbaa !10 ; 5 uses
...
.noexc1365.us.us.i.new:                           ; preds = %.noexc1365.us.us.i, %.noexc1365.us.us.i.new
  ...
  %i.ajj = load i32, ptr %i.aji, align 4, !tbaa !10
  %i.ajk = sext i32 %i.ajj to i64
  %i.ajl = getelementptr inbounds i8, ptr %gep3162.us.us.i, i64 %i.ajk
  %i.ajm = load <8 x i8>, ptr %i.ajl, align 1, !tbaa !29
  %i.ajn = sext <8 x i8> %i.ajm to <8 x i16>      ; 2 uses
  %i.ajo = load <16 x i8>, ptr %.111053139.us.us.us.i, align 16, !tbaa !29 ; 3 uses
  ...
  %i.ajy = load i32, ptr %i.ajx, align 4, !tbaa !10
  %i.ajz = sext i32 %i.ajy to i64
  %i.aka = getelementptr inbounds i8, ptr %gep3162.us.us.i, i64 %i.ajz
  %i.akb = load <8 x i8>, ptr %i.aka, align 1, !tbaa !29
  %i.akc = sext <8 x i8> %i.akb to <8 x i16>      ; 2 uses
  %i.akd = load <16 x i8>, ptr %i.ajv, align 16, !tbaa !29 ; 3 uses
  ...
  br i1 %niter.ncmp.1, label %._crit_edge3142.split.us.us.us.i.unr-lcssa, label %.noexc1365.us.us.i.new, !llvm.loop !84
...
.epil.preheader:                                  ; preds = %._crit_edge3142.split.us.us.us.i.unr-lcssa, %.noexc1365.us.us.i
  ...
  %i.akm = load i32, ptr %i.akl, align 4, !tbaa !10
  %i.akn = sext i32 %i.akm to i64
  %i.ako = getelementptr inbounds i8, ptr %gep3162.us.us.i, i64 %i.akn
  %i.akp = load <8 x i8>, ptr %i.ako, align 1, !tbaa !29
  %i.akq = sext <8 x i8> %i.akp to <8 x i16>      ; 2 uses
  %i.akr = load <16 x i8>, ptr %.111053139.us.us.us.i.epil.init, align 16, !tbaa !29 ; 3 uses
...
._crit_edge3142.split.us.us.us.i:                 ; preds = %._crit_edge3142.split.us.us.us.i.unr-lcssa, %.epil.preheader
  ...
  br i1 %i.akz, label %.noexc1365.us.us.i, label %._crit_edge3153.loopexit.i, !llvm.loop !85

.noexc1365.us.i:                                  ; preds = %.noexc1365.lr.ph.split.us.i, %._crit_edge3142.split.us3169.i
  %.011013152.us.i = phi i32 [ %i.amp, %._crit_edge3142.split.us3169.i ], [ 0, %.noexc1365.lr.ph.split.us.i ] ; 2 uses
  %.011043151.us.i = phi ptr [ %scevgep3752.i, %._crit_edge3142.split.us3169.i ], [ %i.ww, %.noexc1365.lr.ph.split.us.i ] ; 2 uses
  %i.ala = phi <4 x i32> [ %i.amn, %._crit_edge3142.split.us3169.i ], [ zeroinitializer, %.noexc1365.lr.ph.split.us.i ]
  %i.alb = phi <4 x i32> [ %i.aml, %._crit_edge3142.split.us3169.i ], [ zeroinitializer, %.noexc1365.lr.ph.split.us.i ]
...
bb.h:                                             ; preds = %bb.h, %.noexc1365.us.i
  %indvars.iv3749.i = phi i64 [ %indvars.iv.next3750.i, %bb.h ], [ 0, %.noexc1365.us.i ] ; 2 uses
  %.111053139.us3165.i = phi ptr [ %i.amo, %bb.h ], [ %.011043151.us.i, %.noexc1365.us.i ] ; 2 uses
  %.127943138.us3166.i = phi <4 x i32> [ %i.amn, %bb.h ], [ %i.ala, %.noexc1365.us.i ]
  %.127963137.us3167.i = phi <4 x i32> [ %i.aml, %bb.h ], [ %i.alb, %.noexc1365.us.i ]
  ...
  %i.alu = load i8, ptr %i.alt, align 1, !tbaa !29
  %i.alv = getelementptr inbounds nuw i8, ptr %i.alh, i64 %i.xc
  %i.alw = load i8, ptr %i.alv, align 1, !tbaa !29
  ...
  %i.amh = load <16 x i8>, ptr %.111053139.us3165.i, align 16, !tbaa !29 ; 3 uses
  %.lobit.i1410.us3168.i = ashr <16 x i8> %i.amh, splat (i8 7) ; 2 uses
  %i.ami = shufflevector <16 x i8> %i.amh, <16 x i8> %.lobit.i1410.us3168.i, <16 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23>
  %i.amj = shufflevector <16 x i8> %i.amh, <16 x i8> %.lobit.i1410.us3168.i, <16 x i32> <i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
  %i.amk = bitcast <16 x i8> %i.ami to <8 x i16>
  %i.aml = call <4 x i32> @llvm.x86.xop.vpmadcswd(<8 x i16> %i.amg, <8 x i16> %i.amk, <4 x i32> %.127963137.us3167.i) ; 3 uses
  %i.amm = bitcast <16 x i8> %i.amj to <8 x i16>
  %i.amn = call <4 x i32> @llvm.x86.xop.vpmadcswd(<8 x i16> %i.amg, <8 x i16> %i.amm, <4 x i32> %.127943138.us3166.i) ; 3 uses
  %i.amo = getelementptr inbounds nuw i8, ptr %.111053139.us3165.i, i64 16
  ...
  br i1 %exitcond3755.not.i, label %._crit_edge3142.split.us3169.i, label %bb.h, !llvm.loop !84

._crit_edge3142.split.us3169.i:                   ; preds = %bb.h
  ...
  br i1 %i.amr, label %.noexc1365.us.i, label %._crit_edge3153.loopexit3544.i, !llvm.loop !85

._crit_edge3153.loopexit.i:                       ; preds = %._crit_edge3142.split.us.us.us.i
  %i.ams = and i32 %i.aie, 2147483640
  br label %._crit_edge3153.i

._crit_edge3153.loopexit3544.i:                   ; preds = %._crit_edge3142.split.us3169.i
...
._crit_edge3153.i:                                ; preds = %._crit_edge3153.loopexit3544.i, %._crit_edge3153.loopexit.i, %.noexc1365.preheader.i, %.noexc1367.i
  ...
  %.01101.lcssa.i = phi i32 [ 0, %.noexc1367.i ], [ %i.ams, %._crit_edge3153.loopexit.i ], [ %i.amt, %._crit_edge3153.loopexit3544.i ], [ %i.aiy, %.noexc1365.preheader.i ] ; 6 uses
...
.noexc1363.lr.ph.i:                               ; preds = %._crit_edge3153.i
  %i.ana = load i32, ptr %i.l, align 4, !tbaa !16, !noalias !158
  %i.anb = load ptr, ptr %0, align 8, !tbaa !27, !noalias !158
  %i.anc = load i64, ptr %i.s, align 8, !tbaa !19, !noalias !158
  %i.and = load i64, ptr %i.ch, align 8, !tbaa !28, !noalias !158 ; 2 uses
  %factor.op.mul3198.i = mul i64 %i.and, %i.anc
  %i.ane = sext i32 %i.ana to i64
  %i.anf = load i32, ptr %i.b, align 4, !tbaa !10
  ...
  %i.ank = load i32, ptr %i.a, align 4, !tbaa !10
  ...
  %i.ann = load i32, ptr %i.f, align 4, !tbaa !10 ; 3 uses
...
.noexc1363.preheader.i:                           ; preds = %.noexc1363.lr.ph.i
  ...
  %10 = or disjoint i32 %.01101.lcssa.i, 3
  %11 = call i32 @llvm.umax.i32(i32 %i.aie, i32 %10)
  %reass.sub = sub nsw i32 %11, %.01101.lcssa.i
  %i.anr = and i32 %reass.sub, -2
  %12 = add i32 %i.anr, -2
  %i.ans = add i32 %i.anq, %12
...
bb.i:                                             ; preds = %bb.i, %.noexc1363.us.i
  ...
  %i.any = load i32, ptr %i.anx, align 4, !tbaa !10
  %i.anz = sext i32 %i.any to i64
  %i.aoa = getelementptr inbounds i8, ptr %gep3202.us.i, i64 %i.anz ; 2 uses
  %i.aob = load i8, ptr %i.aoa, align 1, !tbaa !29
  %i.aoc = sext i8 %i.aob to i32                  ; 2 uses
  %i.aod = load i8, ptr %.311073183.us.i, align 1, !tbaa !29
  ...
  %i.aoi = load i8, ptr %i.aoh, align 1, !tbaa !29
  ...
  %i.aov = load i8, ptr %i.aou, align 1, !tbaa !29
  ...
  br i1 %exitcond3769.not.i, label %._crit_edge3186.us.i, label %bb.i, !llvm.loop !88
...
._crit_edge3186.us.i:                             ; preds = %bb.i
  ...
  br i1 %i.apc, label %.noexc1363.us.i, label %.preheader2823.i, !llvm.loop !89
...
.noexc1361.lr.ph.i:                               ; preds = %.preheader2823.i
  %i.ape = load i32, ptr %i.l, align 4, !tbaa !16, !noalias !159
  %i.apf = load ptr, ptr %0, align 8, !tbaa !27, !noalias !159
  %i.apg = load i64, ptr %i.s, align 8, !tbaa !19, !noalias !159
  %i.aph = load i64, ptr %i.ch, align 8, !tbaa !28, !noalias !159 ; 2 uses
  %factor.op.mul3223.i = mul i64 %i.aph, %i.apg
  %i.api = sext i32 %i.ape to i64
  %i.apj = load i32, ptr %i.b, align 4, !tbaa !10
  ...
  %i.apo = load i32, ptr %i.a, align 4, !tbaa !10
  ...
  %i.apr = load i32, ptr %i.f, align 4, !tbaa !10 ; 5 uses
...
.noexc1361.us.i.new:                              ; preds = %.noexc1361.us.i, %.noexc1361.us.i.new
  ...
  %i.aqa = load i32, ptr %i.apz, align 4, !tbaa !10
  %i.aqb = sext i32 %i.aqa to i64
  %i.aqc = getelementptr inbounds i8, ptr %gep3227.us.i, i64 %i.aqb
  %i.aqd = load i8, ptr %i.aqc, align 1, !tbaa !29
  %i.aqe = sext i8 %i.aqd to i32                  ; 2 uses
  %i.aqf = load i8, ptr %.511093209.us.i, align 1, !tbaa !29
  ...
  %i.aqk = load i8, ptr %i.aqj, align 1, !tbaa !29
  ...
  %i.aqr = load i32, ptr %i.aqq, align 4, !tbaa !10
  ...
  %i.aqw = load i8, ptr %i.aqo, align 1, !tbaa !29
...
.epil.preheader577:                               ; preds = %._crit_edge3212.us.i.unr-lcssa, %.noexc1361.us.i
  ...
  %i.arh = load i32, ptr %i.arg, align 4, !tbaa !10
  %i.ari = sext i32 %i.arh to i64
  %i.arj = getelementptr inbounds i8, ptr %gep3227.us.i, i64 %i.ari
  %i.ark = load i8, ptr %i.arj, align 1, !tbaa !29
  %i.arl = sext i8 %i.ark to i32                  ; 2 uses
  %i.arm = load i8, ptr %.511093209.us.i.epil.init, align 1, !tbaa !29
  ...
  %i.arr = load i8, ptr %i.arq, align 1, !tbaa !29
...
begin_hunk_1_@_ZN4ncnn27convolution_packed_int8_xopERKNS_3MatERS0_S2_iiiiiiRKNS_6OptionE:bb.a
  ...
  store i32 %.21002.lcssa.i, ptr %i.bto, align 4, !tbaa !10
  ...
  br i1 %i.bts, label %.noexc1333.i, label %.preheader2821.i, !llvm.loop !129
...
.noexc1319.i:                                     ; preds = %._crit_edge3517.i, %.noexc1319.lr.ph.i
  ...
  %i.btv = load i32, ptr %i.d, align 4, !tbaa !10 ; 11 uses
  %i.btw = icmp sgt i32 %i.btv, 7
  br i1 %i.btw, label %.noexc1317.lr.ph.i, label %._crit_edge3464.i

.noexc1317.lr.ph.i:                               ; preds = %.noexc1319.i
  %i.btx = load i32, ptr %i.c, align 4, !tbaa !10 ; 3 uses
  %i.bty = load i32, ptr %i.l, align 4, !tbaa !16, !noalias !170
  %i.btz = load ptr, ptr %0, align 8, !tbaa !27, !noalias !170
  %i.bua = load i64, ptr %i.s, align 8, !tbaa !19, !noalias !170
  %i.bub = load i64, ptr %i.cx, align 8, !tbaa !28, !noalias !170 ; 2 uses
  %factor.op.mul3468.i = mul i64 %i.bub, %i.bua   ; 2 uses
  %i.buc = sext i32 %i.bty to i64
  %i.bud = load i32, ptr %i.b, align 4, !tbaa !10
  ...
  %i.bui = load i32, ptr %i.a, align 4, !tbaa !10
  ...
  %i.bum = load i32, ptr %i.f, align 4, !tbaa !10 ; 5 uses
...
.noexc1317.us.us.i.new:                           ; preds = %.noexc1317.us.us.i, %.noexc1317.us.us.i.new
  ...
  %i.buz = load i32, ptr %i.buy, align 4, !tbaa !10
  %i.bva = sext i32 %i.buz to i64
  %i.bvb = getelementptr inbounds i8, ptr %gep3472.us.us.i, i64 %i.bva
  %i.bvc = load <8 x i8>, ptr %i.bvb, align 1, !tbaa !29
  %i.bvd = sext <8 x i8> %i.bvc to <8 x i16>
  %i.bve = load <8 x i8>, ptr %.19763453.us.us.us.i, align 1, !tbaa !29
  ...
  %i.bvk = load i32, ptr %i.bvj, align 4, !tbaa !10
  %i.bvl = sext i32 %i.bvk to i64
  %i.bvm = getelementptr inbounds i8, ptr %gep3472.us.us.i, i64 %i.bvl
  %i.bvn = load <8 x i8>, ptr %i.bvm, align 1, !tbaa !29
  %i.bvo = sext <8 x i8> %i.bvn to <8 x i16>
  %i.bvp = load <8 x i8>, ptr %i.bvh, align 1, !tbaa !29
  ...
  br i1 %niter606.ncmp.1, label %._crit_edge3456.split.us.us.us.i.unr-lcssa, label %.noexc1317.us.us.i.new, !llvm.loop !132
...
.epil.preheader600:                               ; preds = %._crit_edge3456.split.us.us.us.i.unr-lcssa, %.noexc1317.us.us.i
  ...
  %i.bvu = load i32, ptr %i.bvt, align 4, !tbaa !10
  %i.bvv = sext i32 %i.bvu to i64
  %i.bvw = getelementptr inbounds i8, ptr %gep3472.us.us.i, i64 %i.bvv
  %i.bvx = load <8 x i8>, ptr %i.bvw, align 1, !tbaa !29
  %i.bvy = sext <8 x i8> %i.bvx to <8 x i16>
  %i.bvz = load <8 x i8>, ptr %.19763453.us.us.us.i.epil.init, align 1, !tbaa !29
...
._crit_edge3456.split.us.us.us.i:                 ; preds = %._crit_edge3456.split.us.us.us.i.unr-lcssa, %.epil.preheader600
  ...
  br i1 %i.bwd, label %.noexc1317.us.us.i, label %._crit_edge3464.loopexit.i, !llvm.loop !133

.noexc1317.us.i:                                  ; preds = %.noexc1317.lr.ph.split.us.i, %._crit_edge3456.split.us3477.i
  %.09743463.us.i = phi i32 [ %i.bxo, %._crit_edge3456.split.us3477.i ], [ 0, %.noexc1317.lr.ph.split.us.i ] ; 2 uses
  %.09753462.us.i = phi ptr [ %scevgep3855.i, %._crit_edge3456.split.us3477.i ], [ %i.bib, %.noexc1317.lr.ph.split.us.i ] ; 2 uses
  %i.bwe = phi <4 x i32> [ %i.bxm, %._crit_edge3456.split.us3477.i ], [ zeroinitializer, %.noexc1317.lr.ph.split.us.i ]
...
bb.n:                                             ; preds = %bb.n, %.noexc1317.us.i
  %indvars.iv3852.i = phi i64 [ %indvars.iv.next3853.i, %bb.n ], [ 0, %.noexc1317.us.i ] ; 2 uses
  %.19763453.us3475.i = phi ptr [ %i.bxn, %bb.n ], [ %.09753462.us.i, %.noexc1317.us.i ] ; 2 uses
  %.127483452.us3476.i = phi <4 x i32> [ %i.bxm, %bb.n ], [ %i.bwe, %.noexc1317.us.i ]
  %i.bwh = getelementptr inbounds nuw [4 x i8], ptr %i.buo, i64 %indvars.iv3852.i
  %i.bwi = load i32, ptr %i.bwh, align 4, !tbaa !10
  %i.bwj = sext i32 %i.bwi to i64
  %i.bwk = getelementptr inbounds i8, ptr %gep3472.us.i, i64 %i.bwj ; 8 uses
  %i.bwl = load i8, ptr %i.bwk, align 1, !tbaa !29
  %i.bwm = getelementptr inbounds nuw i8, ptr %i.bwk, i64 %i.v
  %i.bwn = load i8, ptr %i.bwm, align 1, !tbaa !29
  %i.bwo = getelementptr inbounds nuw i8, ptr %i.bwk, i64 %i.cy
  %i.bwp = load i8, ptr %i.bwo, align 1, !tbaa !29
  %i.bwq = getelementptr inbounds nuw i8, ptr %i.bwk, i64 %i.cz
  %i.bwr = load i8, ptr %i.bwq, align 1, !tbaa !29
  %i.bws = getelementptr inbounds nuw i8, ptr %i.bwk, i64 %i.da
  %i.bwt = load i8, ptr %i.bws, align 1, !tbaa !29
  %i.bwu = getelementptr inbounds nuw i8, ptr %i.bwk, i64 %i.db
  %i.bwv = load i8, ptr %i.bwu, align 1, !tbaa !29
  %i.bww = getelementptr inbounds nuw i8, ptr %i.bwk, i64 %i.dc
  %i.bwx = load i8, ptr %i.bww, align 1, !tbaa !29
  %i.bwy = getelementptr inbounds nuw i8, ptr %i.bwk, i64 %i.dd
  %i.bwz = load i8, ptr %i.bwy, align 1, !tbaa !29
  ...
  %i.bxk = load <8 x i8>, ptr %.19763453.us3475.i, align 1, !tbaa !29
  %i.bxl = sext <8 x i8> %i.bxk to <8 x i16>
  %i.bxm = call <4 x i32> @llvm.x86.xop.vpmadcswd(<8 x i16> %i.bxj, <8 x i16> %i.bxl, <4 x i32> %.127483452.us3476.i) ; 3 uses
  %i.bxn = getelementptr inbounds nuw i8, ptr %.19763453.us3475.i, i64 8
  ...
  br i1 %exitcond3858.not.i, label %._crit_edge3456.split.us3477.i, label %bb.n, !llvm.loop !132

._crit_edge3456.split.us3477.i:                   ; preds = %bb.n
  ...
  br i1 %i.bxq, label %.noexc1317.us.i, label %._crit_edge3464.loopexit3534.i, !llvm.loop !133

._crit_edge3464.loopexit.i:                       ; preds = %._crit_edge3456.split.us.us.us.i
  %i.bxr = and i32 %i.btv, 2147483640
  br label %._crit_edge3464.i

._crit_edge3464.loopexit3534.i:                   ; preds = %._crit_edge3456.split.us3477.i
...
._crit_edge3464.i:                                ; preds = %._crit_edge3464.loopexit3534.i, %._crit_edge3464.loopexit.i, %.noexc1317.preheader.i, %.noexc1319.i
  ...
  %.0974.lcssa.i = phi i32 [ 0, %.noexc1319.i ], [ %i.bxr, %._crit_edge3464.loopexit.i ], [ %i.bxs, %._crit_edge3464.loopexit3534.i ], [ %i.bup, %.noexc1317.preheader.i ] ; 6 uses
...
.noexc1315.lr.ph.i:                               ; preds = %._crit_edge3464.i
  %i.bxx = load i32, ptr %i.l, align 4, !tbaa !16, !noalias !171
  %i.bxy = load ptr, ptr %0, align 8, !tbaa !27, !noalias !171
  %i.bxz = load i64, ptr %i.s, align 8, !tbaa !19, !noalias !171
  %i.bya = load i64, ptr %i.cx, align 8, !tbaa !28, !noalias !171 ; 2 uses
  %factor.op.mul3499.i = mul i64 %i.bya, %i.bxz
  %i.byb = sext i32 %i.bxx to i64
  %i.byc = load i32, ptr %i.b, align 4, !tbaa !10
  ...
  %i.byh = load i32, ptr %i.a, align 4, !tbaa !10
  ...
  %i.byk = load i32, ptr %i.f, align 4, !tbaa !10 ; 5 uses
...
.noexc1315.preheader.i:                           ; preds = %.noexc1315.lr.ph.i
  ...
  %13 = or disjoint i32 %.0974.lcssa.i, 3
  %14 = call i32 @llvm.umax.i32(i32 %i.btv, i32 %13)
  %reass.sub135 = sub nsw i32 %14, %.0974.lcssa.i
  %i.byo = and i32 %reass.sub135, -2
  %15 = add i32 %i.byo, -2
  %i.byp = add i32 %i.byn, %15
...
.noexc1315.us.i.new:                              ; preds = %.noexc1315.us.i, %.noexc1315.us.i.new
  ...
  %i.byw = load i32, ptr %i.byv, align 4, !tbaa !10
  %i.byx = sext i32 %i.byw to i64
  %i.byy = getelementptr inbounds i8, ptr %gep3503.us.i, i64 %i.byx ; 2 uses
  %i.byz = load i8, ptr %i.byy, align 1, !tbaa !29
  %i.bza = sext i8 %i.byz to i32
  %i.bzb = load i8, ptr %.33487.us.i, align 1, !tbaa !29
  ...
  %i.bzq = load i32, ptr %i.bzp, align 4, !tbaa !10
  %i.bzr = sext i32 %i.bzq to i64
  %i.bzs = getelementptr inbounds i8, ptr %gep3503.us.i, i64 %i.bzr ; 2 uses
  %i.bzt = load i8, ptr %i.bzs, align 1, !tbaa !29
  %i.bzu = sext i8 %i.bzt to i32
  %i.bzv = load i8, ptr %i.bzn, align 1, !tbaa !29
  ...
  br i1 %niter613.ncmp.1, label %._crit_edge3490.us.i.unr-lcssa, label %.noexc1315.us.i.new, !llvm.loop !136
...
.epil.preheader607:                               ; preds = %._crit_edge3490.us.i.unr-lcssa, %.noexc1315.us.i
  ...
  %i.caj = load i32, ptr %i.cai, align 4, !tbaa !10
  %i.cak = sext i32 %i.caj to i64
  %i.cal = getelementptr inbounds i8, ptr %gep3503.us.i, i64 %i.cak ; 2 uses
  %i.cam = load i8, ptr %i.cal, align 1, !tbaa !29
  %i.can = sext i8 %i.cam to i32
  %i.cao = load i8, ptr %.33487.us.i.epil.init, align 1, !tbaa !29
...
._crit_edge3490.us.i:                             ; preds = %._crit_edge3490.us.i.unr-lcssa, %.epil.preheader607
  ...
  br i1 %i.cbc, label %.noexc1315.us.i, label %.preheader.i, !llvm.loop !137
...
.noexc1314.lr.ph.i:                               ; preds = %.preheader.i
  %i.cbe = load i32, ptr %i.l, align 4, !tbaa !16, !noalias !172
  %i.cbf = load ptr, ptr %0, align 8, !tbaa !27, !noalias !172
  %i.cbg = load i64, ptr %i.s, align 8, !tbaa !19, !noalias !172
  %i.cbh = load i64, ptr %i.cx, align 8, !tbaa !28, !noalias !172 ; 2 uses
  %factor.op.mul3519.i = mul i64 %i.cbh, %i.cbg
  %i.cbi = sext i32 %i.cbe to i64
  %i.cbj = load i32, ptr %i.b, align 4, !tbaa !10
  ...
  %i.cbo = load i32, ptr %i.a, align 4, !tbaa !10
  ...
  %i.cbr = load i32, ptr %i.f, align 4, !tbaa !10 ; 3 uses
...
.noexc1314.us.i.new:                              ; preds = %.noexc1314.us.i, %.noexc1314.us.i.new
  ...
  %i.cby = load i32, ptr %i.cbx, align 4, !tbaa !10
  %i.cbz = sext i32 %i.cby to i64
  %i.cca = getelementptr inbounds i8, ptr %gep3523.us.i, i64 %i.cbz
  %i.ccb = load i8, ptr %i.cca, align 1, !tbaa !29
  %i.ccc = sext i8 %i.ccb to i32
  %i.ccd = load i8, ptr %.53508.us.i, align 1, !tbaa !29
  ...
  %i.cck = load i32, ptr %i.ccj, align 4, !tbaa !10
  %i.ccl = sext i32 %i.cck to i64
  %i.ccm = getelementptr inbounds i8, ptr %gep3523.us.i, i64 %i.ccl
  %i.ccn = load i8, ptr %i.ccm, align 1, !tbaa !29
  %i.cco = sext i8 %i.ccn to i32
  %i.ccp = load i8, ptr %i.cch, align 1, !tbaa !29
  ...
  %i.ccw = load i32, ptr %i.ccv, align 4, !tbaa !10
  %i.ccx = sext i32 %i.ccw to i64
  %i.ccy = getelementptr inbounds i8, ptr %gep3523.us.i, i64 %i.ccx
  %i.ccz = load i8, ptr %i.ccy, align 1, !tbaa !29
  %i.cda = sext i8 %i.ccz to i32
  %i.cdb = load i8, ptr %i.cct, align 1, !tbaa !29
  ...
  %i.cdi = load i32, ptr %i.cdh, align 4, !tbaa !10
end_hunk_1
begin_hunk_2_@_ZN4ncnnL23convolution_packed_int8ERKNS_3MatERS0_S2_iiiiiiRKNS_6OptionE.omp_outlined:bb.a
  %i.agu = load i64, ptr %i.r, align 8, !tbaa !28, !noalias !229
  %i.agv = mul i64 %i.agt, %i.agu
  %i.agw = getelementptr inbounds nuw i8, ptr %i.agr, i64 %i.agv ; 4 uses
  %i.agx = load i32, ptr %9, align 4, !tbaa !10   ; 11 uses
  %i.agy = icmp sgt i32 %i.agx, 7
  br i1 %i.agy, label %.noexc714.lr.ph, label %._crit_edge1851

.noexc714.lr.ph:                                  ; preds = %.noexc716
  %i.agz = load i32, ptr %6, align 4, !tbaa !10   ; 3 uses
  %i.aha = load i32, ptr %i.s, align 4, !tbaa !16, !noalias !230
  %i.ahb = load ptr, ptr %5, align 8, !tbaa !27, !noalias !230
  %i.ahc = load i64, ptr %i.n, align 8, !tbaa !19, !noalias !230
  %i.ahd = load i64, ptr %i.t, align 8, !tbaa !28, !noalias !230 ; 2 uses
  %factor.op.mul1858 = mul i64 %i.ahc, %i.ahd     ; 2 uses
  %i.ahe = sext i32 %i.aha to i64
  %i.ahf = load i32, ptr %10, align 4, !tbaa !10
  ...
  %i.ahk = load i32, ptr %11, align 4, !tbaa !10
  ...
  %i.aho = load i32, ptr %12, align 4, !tbaa !10  ; 3 uses
...
.noexc714.lr.ph.split.us:                         ; preds = %.noexc714.lr.ph
  %i.ahr = load ptr, ptr %13, align 8, !tbaa !21  ; 2 uses
...
bb.o:                                             ; preds = %bb.o, %.noexc714.us.us
  ...
  %i.aih = load i32, ptr %i.aig, align 4, !tbaa !10
  %i.aii = sext i32 %i.aih to i64
  %i.aij = getelementptr inbounds i8, ptr %gep1862.us.us, i64 %i.aii
  %i.aik = load <8 x i8>, ptr %i.aij, align 1, !tbaa !29
  %i.ail = sext <8 x i8> %i.aik to <8 x i16>      ; 4 uses
  %i.aim = load <16 x i8>, ptr %.16431835.us.us.us, align 16, !tbaa !29 ; 3 uses
  %i.ain = getelementptr inbounds nuw i8, ptr %.16431835.us.us.us, i64 16
  %i.aio = load <16 x i8>, ptr %i.ain, align 16, !tbaa !29 ; 3 uses
  ...
  br i1 %exitcond2076.not, label %._crit_edge1838.split.us.us.us, label %bb.o, !llvm.loop !209
...
._crit_edge1838.split.us.us.us:                   ; preds = %bb.o
  ...
  br i1 %i.aji, label %.noexc714.us.us, label %._crit_edge1851.loopexit, !llvm.loop !210

.noexc714.us:                                     ; preds = %.noexc714.lr.ph.split.us, %._crit_edge1838.split.us1868
  %.06411850.us = phi i32 [ %i.alq, %._crit_edge1838.split.us1868 ], [ 0, %.noexc714.lr.ph.split.us ] ; 2 uses
  %.06421849.us = phi ptr [ %scevgep2066, %._crit_edge1838.split.us1868 ], [ %i.agw, %.noexc714.lr.ph.split.us ] ; 2 uses
  %i.ajj = phi <4 x i32> [ %i.alo, %._crit_edge1838.split.us1868 ], [ zeroinitializer, %.noexc714.lr.ph.split.us ]
  %i.ajk = phi <4 x i32> [ %i.all, %._crit_edge1838.split.us1868 ], [ zeroinitializer, %.noexc714.lr.ph.split.us ]
  %i.ajl = phi <4 x i32> [ %i.ali, %._crit_edge1838.split.us1868 ], [ zeroinitializer, %.noexc714.lr.ph.split.us ]
  %i.ajm = phi <4 x i32> [ %i.alf, %._crit_edge1838.split.us1868 ], [ zeroinitializer, %.noexc714.lr.ph.split.us ]
...
bb.p:                                             ; preds = %bb.p, %.noexc714.us
  %indvars.iv2063 = phi i64 [ %indvars.iv.next2064, %bb.p ], [ 0, %.noexc714.us ] ; 2 uses
  %.16431835.us1865 = phi ptr [ %i.alp, %bb.p ], [ %.06421849.us, %.noexc714.us ] ; 3 uses
  %i.ajp = phi <4 x i32> [ %i.alo, %bb.p ], [ %i.ajj, %.noexc714.us ]
  %i.ajq = phi <4 x i32> [ %i.all, %bb.p ], [ %i.ajk, %.noexc714.us ]
  %i.ajr = phi <4 x i32> [ %i.ali, %bb.p ], [ %i.ajl, %.noexc714.us ]
  %i.ajs = phi <4 x i32> [ %i.alf, %bb.p ], [ %i.ajm, %.noexc714.us ]
  %i.ajt = getelementptr inbounds nuw [4 x i8], ptr %i.ahr, i64 %indvars.iv2063
  %i.aju = load i32, ptr %i.ajt, align 4, !tbaa !10
  %i.ajv = sext i32 %i.aju to i64
  %i.ajw = getelementptr inbounds i8, ptr %gep1862.us, i64 %i.ajv ; 8 uses
  %i.ajx = load i8, ptr %i.ajw, align 1, !tbaa !29
  %i.ajy = getelementptr inbounds nuw i8, ptr %i.ajw, i64 %i.ac
  %i.ajz = load i8, ptr %i.ajy, align 1, !tbaa !29
  ...
  %i.akw = load <16 x i8>, ptr %.16431835.us1865, align 16, !tbaa !29 ; 3 uses
  %i.akx = getelementptr inbounds nuw i8, ptr %.16431835.us1865, i64 16
  %i.aky = load <16 x i8>, ptr %i.akx, align 16, !tbaa !29 ; 3 uses
  %.lobit.i762.us1866 = ashr <16 x i8> %i.akw, splat (i8 7) ; 2 uses
  %.lobit.i761.us1867 = ashr <16 x i8> %i.aky, splat (i8 7) ; 2 uses
  %i.akz = shufflevector <16 x i8> %i.akw, <16 x i8> %.lobit.i762.us1866, <16 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23>
  %i.ala = shufflevector <16 x i8> %i.akw, <16 x i8> %.lobit.i762.us1866, <16 x i32> <i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
  %i.alb = shufflevector <16 x i8> %i.aky, <16 x i8> %.lobit.i761.us1867, <16 x i32> <i32 0, i32 16, i32 1, i32 17, i32 2, i32 18, i32 3, i32 19, i32 4, i32 20, i32 5, i32 21, i32 6, i32 22, i32 7, i32 23>
  %i.alc = shufflevector <16 x i8> %i.aky, <16 x i8> %.lobit.i761.us1867, <16 x i32> <i32 8, i32 24, i32 9, i32 25, i32 10, i32 26, i32 11, i32 27, i32 12, i32 28, i32 13, i32 29, i32 14, i32 30, i32 15, i32 31>
  ...
  %i.alp = getelementptr inbounds nuw i8, ptr %.16431835.us1865, i64 32
  ...
  br i1 %exitcond2069.not, label %._crit_edge1838.split.us1868, label %bb.p, !llvm.loop !209

._crit_edge1838.split.us1868:                     ; preds = %bb.p
  ...
  br i1 %i.als, label %.noexc714.us, label %._crit_edge1851.loopexit1931, !llvm.loop !210

._crit_edge1851.loopexit:                         ; preds = %._crit_edge1838.split.us.us.us
  %i.alt = and i32 %i.agx, 2147483640
  br label %._crit_edge1851

._crit_edge1851.loopexit1931:                     ; preds = %._crit_edge1838.split.us1868
...
._crit_edge1851:                                  ; preds = %.noexc714.preheader, %._crit_edge1851.loopexit1931, %._crit_edge1851.loopexit, %.noexc716
  ...
  %.0641.lcssa = phi i32 [ 0, %.noexc716 ], [ %i.alt, %._crit_edge1851.loopexit ], [ %i.alu, %._crit_edge1851.loopexit1931 ], [ %i.ahq, %.noexc714.preheader ] ; 6 uses
...
.noexc712.lr.ph:                                  ; preds = %._crit_edge1851
  %i.ama = load i32, ptr %i.s, align 4, !tbaa !16, !noalias !231
  %i.amb = load ptr, ptr %5, align 8, !tbaa !27, !noalias !231
  %i.amc = load i64, ptr %i.n, align 8, !tbaa !19, !noalias !231
  %i.amd = load i64, ptr %i.t, align 8, !tbaa !28, !noalias !231 ; 2 uses
  %factor.op.mul1897 = mul i64 %i.amc, %i.amd
  %i.ame = sext i32 %i.ama to i64
  %i.amf = load i32, ptr %10, align 4, !tbaa !10
  ...
  %i.amk = load i32, ptr %11, align 4, !tbaa !10
  ...
  %i.amn = load i32, ptr %12, align 4, !tbaa !10  ; 5 uses
...
.noexc712.preheader:                              ; preds = %.noexc712.lr.ph
  ...
  %14 = or disjoint i32 %.0641.lcssa, 3
  %15 = call i32 @llvm.umax.i32(i32 %i.agx, i32 %14)
  %i.amq = add nsw i32 %15, -2
...
.noexc712.lr.ph.split.us:                         ; preds = %.noexc712.lr.ph
  %i.amu = load ptr, ptr %13, align 8, !tbaa !21  ; 3 uses
...
.noexc712.us.new:                                 ; preds = %.noexc712.us, %.noexc712.us.new
  ...
  %i.ann = load <8 x i8>, ptr %.31886.us, align 1, !tbaa !29
  ...
  %i.aod = load <8 x i8>, ptr %i.anq, align 1, !tbaa !29
  ...
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge1889.us.unr-lcssa, label %.noexc712.us.new, !llvm.loop !213
...
.epil.preheader:                                  ; preds = %._crit_edge1889.us.unr-lcssa, %.noexc712.us
  ...
  %i.aos = load <8 x i8>, ptr %.31886.us.epil.init, align 1, !tbaa !29
...
._crit_edge1889.us:                               ; preds = %._crit_edge1889.us.unr-lcssa, %.epil.preheader
  ...
  br i1 %i.aox, label %.noexc712.us, label %.preheader.loopexit, !llvm.loop !214
...
.noexc711.lr.ph:                                  ; preds = %.preheader
  %i.apa = load i32, ptr %i.s, align 4, !tbaa !16, !noalias !232
  %i.apb = load ptr, ptr %5, align 8, !tbaa !27, !noalias !232
  %i.apc = load i64, ptr %i.n, align 8, !tbaa !19, !noalias !232
  %i.apd = load i64, ptr %i.t, align 8, !tbaa !28, !noalias !232 ; 2 uses
  %factor.op.mul1915 = mul i64 %i.apc, %i.apd
  %i.ape = sext i32 %i.apa to i64
  %i.apf = load i32, ptr %10, align 4, !tbaa !10
  ...
  %i.apk = load i32, ptr %11, align 4, !tbaa !10
  ...
  %i.apn = load i32, ptr %12, align 4, !tbaa !10  ; 5 uses
...
.noexc711.lr.ph.split.us:                         ; preds = %.noexc711.lr.ph
  %i.app = load ptr, ptr %13, align 8, !tbaa !21  ; 3 uses
...
.noexc711.us.new:                                 ; preds = %.noexc711.us, %.noexc711.us.new
  ...
  %i.aqb = load i8, ptr %i.aqa, align 1, !tbaa !29
  ...
  %i.aqf = load <8 x i8>, ptr %.51905.us, align 1, !tbaa !29
  ...
  %i.aqt = load <8 x i8>, ptr %i.aqj, align 1, !tbaa !29
  ...
  br i1 %niter2256.ncmp.1, label %._crit_edge1908.us.unr-lcssa, label %.noexc711.us.new, !llvm.loop !217
...
begin_hunk_3_@_ZN4ncnnL25conv3x3s1_winograd23_int8ERKNS_3MatERS0_S2_iRKNS_6OptionE.omp_outlined:bb.a
  ...
  %i.db = load ptr, ptr %i.am, align 8, !tbaa !35 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  %i.de = load ptr, ptr %i.ap, align 8, !tbaa !34 ; 3 uses
  %.not3.i39 = icmp eq ptr %i.de, null
  %i.df = load ptr, ptr %12, align 8, !tbaa !27   ; 3 uses
  br i1 %.not3.i39, label %bb.h, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.dg = load ptr, ptr %i.de, align 8, !tbaa !38
...
_ZN4ncnn3MatD2Ev.exit35:                          ; preds = %bb.e, %_ZN4ncnn3Mat7channelEi.exit34, %bb.g, %bb.h, %bb.i
  ...
  %i.dl = load ptr, ptr %i.v, align 8, !tbaa !35  ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  %i.do = load ptr, ptr %i.y, align 8, !tbaa !34  ; 3 uses
  %.not3.i43 = icmp eq ptr %i.do, null
  %i.dp = load ptr, ptr %11, align 8, !tbaa !27   ; 3 uses
  br i1 %.not3.i43, label %bb.n, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.dq = load ptr, ptr %i.do, align 8, !tbaa !38
...
.noexc46:                                         ; preds = %bb.c
  %i.av = load ptr, ptr %4, align 8, !tbaa !27, !noalias !283
  %i.aw = load i64, ptr %i.l, align 8, !tbaa !19, !noalias !283
  %i.ax = sext i32 %i.au to i64
  %i.ay = mul i64 %i.aw, %i.ax
  %i.az = load i64, ptr %i.m, align 8, !tbaa !28, !noalias !283
...
.noexc52.preheader:                               ; preds = %bb.d
  %.pre156 = load i32, ptr %9, align 4, !tbaa !10
  br label %.noexc52

._crit_edge:                                      ; preds = %.noexc52, %bb.d
  %i.bt = load i32, ptr %i.an, align 4, !tbaa !16 ; 7 uses
  %i.bu = load i32, ptr %i.ao, align 8, !tbaa !20 ; 7 uses
  %i.bv = load i32, ptr %i.ap, align 8, !tbaa !17 ; 6 uses
...
.lr.ph384.i:                                      ; preds = %._crit_edge
  ...
  %i.cc = shl nuw nsw i32 %.sroa.speculated116, 2
  %i.cd = zext nneg i32 %i.cc to i64
  %i.ce = shl nuw nsw i32 %.sroa.speculated116, 3
  %i.cf = zext nneg i32 %i.ce to i64
  %i.cg = mul nuw nsw i32 %.sroa.speculated116, 12
  %i.ch = zext nneg i32 %i.cg to i64
  %i.ci = zext nneg i32 %factor.op.mul381.i to i64 ; 12 uses
...
_ZN4ncnn3MatD2Ev.exit304.us.i:                    ; preds = %bb.q, %.lr.ph.us.i
  ...
  %i.cv = load <4 x i32>, ptr %i.cs, align 16, !tbaa !29 ; 2 uses
  %i.cw = load <4 x i32>, ptr %i.ct, align 16, !tbaa !29 ; 2 uses
  %i.cx = load <4 x i32>, ptr %i.cu, align 16, !tbaa !29
  ...
  %i.dd = load <4 x i32>, ptr %i.da, align 16, !tbaa !29 ; 2 uses
  %i.de = load <4 x i32>, ptr %i.db, align 16, !tbaa !29 ; 2 uses
  %i.df = load <4 x i32>, ptr %i.dc, align 16, !tbaa !29
  ...
  %i.dl = load <4 x i32>, ptr %i.di, align 16, !tbaa !29 ; 2 uses
  %i.dm = load <4 x i32>, ptr %i.dj, align 16, !tbaa !29 ; 2 uses
  %i.dn = load <4 x i32>, ptr %i.dk, align 16, !tbaa !29
  ...
  %i.dt = load <4 x i32>, ptr %i.dq, align 16, !tbaa !29 ; 2 uses
  %i.du = load <4 x i32>, ptr %i.dr, align 16, !tbaa !29 ; 2 uses
  %i.dv = load <4 x i32>, ptr %i.ds, align 16, !tbaa !29
  %i.dw = trunc i64 %indvars.iv.i to i32
  %i.dx = add i32 %.044150, %i.dw                 ; 2 uses
  %i.dy = sdiv i32 %i.dx, %i.ca
  %i.dz = srem i32 %i.dx, %i.ca
  %i.ea = load i32, ptr %i.an, align 4, !tbaa !16, !noalias !284
  %i.eb = load ptr, ptr %12, align 8, !tbaa !27, !noalias !284
  %i.ec = load i64, ptr %i.aq, align 8, !tbaa !19, !noalias !284
  %i.ed = mul i64 %i.ec, %i.cp
  %i.ee = load i64, ptr %i.ar, align 8, !tbaa !28, !noalias !284 ; 2 uses
...
bb.e:                                             ; preds = %_ZN4ncnn3MatD2Ev.exit304.us.i
  ...
  %i.ew = load <4 x i32>, ptr %i.ev, align 16, !tbaa !29
  %i.ex = load <4 x i32>, ptr %i.eu, align 16, !tbaa !29
  %i.ey = add <4 x i32> %i.dm, %i.dl
  %i.ez = add <4 x i32> %i.ey, %i.ex              ; 2 uses
  %i.fa = load <4 x i32>, ptr %i.et, align 16, !tbaa !29
  %i.fb = add <4 x i32> %i.de, %i.dd
  %i.fc = add <4 x i32> %i.fb, %i.fa              ; 2 uses
  %i.fd = load <4 x i32>, ptr %i.cr, align 16, !tbaa !29
...
bb.f:                                             ; preds = %bb.e
  ...
  store i32 %.sroa.0343.0.vec.extract.us.i, ptr %i.eq, align 4, !tbaa !10
  %.sroa.0343.4.vec.extract.us.i = extractelement <4 x i32> %i.fm, i64 1
  store i32 %.sroa.0343.4.vec.extract.us.i, ptr %i.fo, align 4, !tbaa !10
  %.sroa.0343.8.vec.extract.us.i = extractelement <4 x i32> %i.fm, i64 2
  store i32 %.sroa.0343.8.vec.extract.us.i, ptr %i.fp, align 4, !tbaa !10
  %.sroa.0343.12.vec.extract.us.i = extractelement <4 x i32> %i.fm, i64 3
  store i32 %.sroa.0343.12.vec.extract.us.i, ptr %i.fq, align 4, !tbaa !10
...
bb.m:                                             ; preds = %bb.l
  ...
  store i32 %.sroa.0343.0.vec.extract.us.1.i, ptr %.1286.us.i, align 4, !tbaa !10
  %.sroa.0343.4.vec.extract.us.1.i = extractelement <4 x i32> %i.ge, i64 1
  store i32 %.sroa.0343.4.vec.extract.us.1.i, ptr %i.gg, align 4, !tbaa !10
  %.sroa.0343.8.vec.extract.us.1.i = extractelement <4 x i32> %i.ge, i64 2
  store i32 %.sroa.0343.8.vec.extract.us.1.i, ptr %i.gh, align 4, !tbaa !10
  %.sroa.0343.12.vec.extract.us.1.i = extractelement <4 x i32> %i.ge, i64 3
  store i32 %.sroa.0343.12.vec.extract.us.1.i, ptr %i.gi, align 4, !tbaa !10
...
._crit_edge.us.i:                                 ; preds = %bb.q
  ...
  br i1 %i.gp, label %.lr.ph.us.i, label %.preheader372.loopexit.i, !llvm.loop !264
...
.preheader372.i:                                  ; preds = %.lr.ph384.i, %.preheader372.loopexit.i, %._crit_edge
  %.0287.lcssa.i = phi i32 [ 0, %._crit_edge ], [ %i.gq, %.preheader372.loopexit.i ], [ %i.bi, %.lr.ph384.i ] ; 6 uses
...
.lr.ph395.i:                                      ; preds = %.preheader372.i
  ...
  %i.gu = shl nuw nsw i32 %.sroa.speculated116, 1
  %i.gv = zext nneg i32 %i.gu to i64
  %i.gw = shl nuw nsw i32 %.sroa.speculated116, 2
  %i.gx = zext nneg i32 %i.gw to i64
  %i.gy = mul nuw nsw i32 %.sroa.speculated116, 6
  %i.gz = zext nneg i32 %i.gy to i64
  %i.ha = shl nuw nsw i32 %.sroa.speculated116, 3
  %i.hb = zext nneg i32 %i.ha to i64              ; 12 uses
...
.lr.ph395.split.preheader.i:                      ; preds = %.lr.ph395.i
  %15 = add i32 %.0287.lcssa.i, 3
  %smax.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated120, i32 %15)
  %reass.sub = sub i32 %smax.i, %.0287.lcssa.i
  %16 = and i32 %reass.sub, -2
  %i.hd = add i32 %.0287.lcssa.i, %16
  br label %.preheader.i

.lr.ph395.split.us.i:                             ; preds = %.lr.ph395.i
  %i.he = load ptr, ptr %12, align 8, !tbaa !27, !noalias !285
  %i.hf = load i64, ptr %i.aq, align 8, !tbaa !19, !noalias !285
  %i.hg = load i64, ptr %i.ar, align 8, !tbaa !28, !noalias !285 ; 2 uses
...
_ZN4ncnn3MatD2Ev.exit303.us.i:                    ; preds = %bb.x, %.lr.ph.us398.i
  ...
  %i.hr = load i32, ptr %i.ho, align 4, !tbaa !10 ; 2 uses
  %i.hs = load i32, ptr %i.hp, align 4, !tbaa !10 ; 2 uses
  ...
  %i.hw = load i32, ptr %i.hv, align 4, !tbaa !10 ; 2 uses
  %i.hx = sub i32 %i.hr, %i.hs
  %i.hy = load i32, ptr %i.hq, align 4, !tbaa !10
  ...
  %i.ii = load i32, ptr %i.ie, align 4, !tbaa !10
  %i.ij = load i32, ptr %i.if, align 4, !tbaa !10 ; 2 uses
  %i.ik = add nsw i32 %i.ij, %i.ii
  %i.il = load i32, ptr %i.ig, align 4, !tbaa !10 ; 2 uses
  ...
  %i.ke = load i32, ptr %i.ka, align 4, !tbaa !10
  %i.kf = load i32, ptr %i.kb, align 4, !tbaa !10 ; 2 uses
  %i.kg = load i32, ptr %i.kc, align 4, !tbaa !10 ; 2 uses
  %i.kh = getelementptr inbounds nuw i8, ptr %i.ka, i64 4
  %i.ki = load i32, ptr %i.kh, align 4, !tbaa !10
  %i.kj = getelementptr inbounds nuw i8, ptr %i.kb, i64 4
  %i.kk = load i32, ptr %i.kj, align 4, !tbaa !10 ; 2 uses
  %i.kl = getelementptr inbounds nuw i8, ptr %i.kc, i64 4
  %i.km = load i32, ptr %i.kl, align 4, !tbaa !10 ; 2 uses
  %i.kn = load i32, ptr %i.kd, align 4, !tbaa !10
  %i.ko = getelementptr inbounds nuw i8, ptr %i.kd, i64 4
  %i.kp = load i32, ptr %i.ko, align 4, !tbaa !10
  %i.kq = trunc i64 %indvars.iv445.i to i32
  %i.kr = add i32 %.044150, %i.kq                 ; 2 uses
  %i.ks = sdiv i32 %i.kr, %i.ca
  %i.kt = srem i32 %i.kr, %i.ca
  %i.ku = load i32, ptr %i.an, align 4, !tbaa !16, !noalias !285
...
bb.r:                                             ; preds = %_ZN4ncnn3MatD2Ev.exit303.us.i
  ...
  %i.lh = load i32, ptr %i.lg, align 4, !tbaa !10
  %i.li = load i32, ptr %i.hn, align 4, !tbaa !10
  ...
  store i32 %i.lr, ptr %i.ld, align 4, !tbaa !10
  store i32 %i.ls, ptr %i.lt, align 4, !tbaa !10
...
bb.s:                                             ; preds = %bb.r
  ...
  store i32 %i.md, ptr %i.me, align 4, !tbaa !10
  %i.mf = getelementptr inbounds nuw i8, ptr %i.lt, i64 4
  store i32 %i.ly, ptr %i.mf, align 4, !tbaa !10
  br label %bb.t
...
bb.v:                                             ; preds = %bb.u
  ...
  store i32 %i.mm, ptr %.1277.us.i, align 4, !tbaa !10
...
bb.w:                                             ; preds = %bb.v
  ...
  store i32 %i.my, ptr %i.mz, align 4, !tbaa !10
  %i.na = getelementptr inbounds nuw i8, ptr %i.mo, i64 4
  store i32 %i.mt, ptr %i.na, align 4, !tbaa !10
  br label %bb.x

end_hunk_3
begin_hunk_4_@_ZN4ncnnL25conv3x3s1_winograd43_int8ERKNS_3MatERS0_S2_iRKNS_6OptionE.omp_outlined:bb.a
...
.noexc46:                                         ; preds = %bb.c
  %i.do = load ptr, ptr %4, align 8, !tbaa !27, !noalias !419
  %i.dp = load i64, ptr %i.n, align 8, !tbaa !19, !noalias !419
  %i.dq = sext i32 %i.dn to i64
  %i.dr = mul i64 %i.dp, %i.dq
  %i.ds = load i64, ptr %i.o, align 8, !tbaa !28, !noalias !419
...
.noexc52.preheader:                               ; preds = %bb.d
  %.pre137 = load i32, ptr %9, align 4, !tbaa !10
  br label %.noexc52

._crit_edge:                                      ; preds = %.noexc52, %bb.d
  %i.em = load i32, ptr %i.ap, align 4, !tbaa !16 ; 13 uses
  %i.en = load i32, ptr %i.aq, align 8, !tbaa !20 ; 6 uses
  %i.eo = load i32, ptr %i.ar, align 8, !tbaa !17 ; 5 uses
...
.lr.ph77.i:                                       ; preds = %._crit_edge
  ...
  %i.ev = shl nuw nsw i32 %.sroa.speculated117, 2
  %i.ew = zext nneg i32 %i.ev to i64
  %i.ex = shl nuw nsw i32 %.sroa.speculated117, 3
  %i.ey = zext nneg i32 %i.ex to i64
  %i.ez = mul nuw nsw i32 %.sroa.speculated117, 12
  %i.fa = zext nneg i32 %i.ez to i64
  %i.fb = shl nuw nsw i32 %.sroa.speculated117, 4
  %i.fc = zext nneg i32 %i.fb to i64
  %i.fd = mul nuw nsw i32 %.sroa.speculated117, 20
  %i.fe = zext nneg i32 %i.fd to i64
  %i.ff = mul nuw nsw i32 %.sroa.speculated117, 24
...
.preheader54.us.i:                                ; preds = %bb.u, %.lr.ph.us.i
  ...
  %i.fv = load <4 x i32>, ptr %i.fp, align 16, !tbaa !29
  %i.fw = load <4 x i32>, ptr %i.fq, align 16, !tbaa !29 ; 2 uses
  %i.fx = load <4 x i32>, ptr %i.fr, align 16, !tbaa !29 ; 2 uses
  %i.fy = load <4 x i32>, ptr %i.fs, align 16, !tbaa !29 ; 2 uses
  %i.fz = load <4 x i32>, ptr %i.ft, align 16, !tbaa !29 ; 2 uses
  %i.ga = load <4 x i32>, ptr %i.fu, align 16, !tbaa !29
  ...
  store <4 x i32> %i.gg, ptr %i.a, align 16, !tbaa !29
  store <4 x i32> %i.gi, ptr %i.at, align 16, !tbaa !29
  store <4 x i32> %i.gk, ptr %i.au, align 16, !tbaa !29
  store <4 x i32> %i.go, ptr %i.av, align 16, !tbaa !29
  ...
  %i.gv = load <4 x i32>, ptr %i.gp, align 16, !tbaa !29
  %i.gw = load <4 x i32>, ptr %i.gq, align 16, !tbaa !29 ; 2 uses
  %i.gx = load <4 x i32>, ptr %i.gr, align 16, !tbaa !29 ; 2 uses
  %i.gy = load <4 x i32>, ptr %i.gs, align 16, !tbaa !29 ; 2 uses
  %i.gz = load <4 x i32>, ptr %i.gt, align 16, !tbaa !29 ; 2 uses
  %i.ha = load <4 x i32>, ptr %i.gu, align 16, !tbaa !29
  ...
  store <4 x i32> %i.hg, ptr %i.bb, align 16, !tbaa !29
  store <4 x i32> %i.hi, ptr %i.bc, align 16, !tbaa !29
  store <4 x i32> %i.hk, ptr %i.bd, align 16, !tbaa !29
  store <4 x i32> %i.ho, ptr %i.be, align 16, !tbaa !29
  ...
  %i.hv = load <4 x i32>, ptr %i.hp, align 16, !tbaa !29
  %i.hw = load <4 x i32>, ptr %i.hq, align 16, !tbaa !29 ; 2 uses
  %i.hx = load <4 x i32>, ptr %i.hr, align 16, !tbaa !29 ; 2 uses
  %i.hy = load <4 x i32>, ptr %i.hs, align 16, !tbaa !29 ; 2 uses
  %i.hz = load <4 x i32>, ptr %i.ht, align 16, !tbaa !29 ; 2 uses
  %i.ia = load <4 x i32>, ptr %i.hu, align 16, !tbaa !29
  ...
  store <4 x i32> %i.ig, ptr %i.bf, align 16, !tbaa !29
  store <4 x i32> %i.ii, ptr %i.bg, align 16, !tbaa !29
  store <4 x i32> %i.ik, ptr %i.bh, align 16, !tbaa !29
  store <4 x i32> %i.io, ptr %i.bi, align 16, !tbaa !29
  ...
  %i.iv = load <4 x i32>, ptr %i.ip, align 16, !tbaa !29
  %i.iw = load <4 x i32>, ptr %i.iq, align 16, !tbaa !29 ; 2 uses
  %i.ix = load <4 x i32>, ptr %i.ir, align 16, !tbaa !29 ; 2 uses
  %i.iy = load <4 x i32>, ptr %i.is, align 16, !tbaa !29 ; 2 uses
  %i.iz = load <4 x i32>, ptr %i.it, align 16, !tbaa !29 ; 2 uses
  %i.ja = load <4 x i32>, ptr %i.iu, align 16, !tbaa !29
  ...
  store <4 x i32> %i.jg, ptr %i.bj, align 16, !tbaa !29
  store <4 x i32> %i.ji, ptr %i.bk, align 16, !tbaa !29
  store <4 x i32> %i.jk, ptr %i.bl, align 16, !tbaa !29
  store <4 x i32> %i.jo, ptr %i.bm, align 16, !tbaa !29
...
begin_hunk_5_@_ZN4ncnnL25conv3x3s1_winograd43_int8ERKNS_3MatERS0_S2_iRKNS_6OptionE.omp_outlined.2:bb.a
  ...
  store <4 x i32> %i.ll, ptr %i.aw, align 16, !tbaa !29
  store <4 x i32> %i.lo, ptr %i.ax, align 16, !tbaa !29
  store <4 x i32> %i.lr, ptr %i.ay, align 16, !tbaa !29
  store <4 x i32> %i.lv, ptr %i.az, align 16, !tbaa !29
  %i.lw = load i32, ptr %i.ap, align 4, !tbaa !16, !noalias !420
  %i.lx = load ptr, ptr %12, align 8, !tbaa !27, !noalias !420
  %i.ly = load i64, ptr %i.as, align 8, !tbaa !19, !noalias !420
  %i.lz = mul i64 %i.ly, %i.fo
  %i.ma = load i64, ptr %i.ba, align 8, !tbaa !28, !noalias !420 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.mw = load <4 x i32>, ptr %i.mv, align 16, !tbaa !29
  %i.mx = getelementptr inbounds nuw i8, ptr %i.mv, i64 16
  %i.my = load <4 x i32>, ptr %i.mx, align 16, !tbaa !29 ; 2 uses
  %i.mz = getelementptr inbounds nuw i8, ptr %i.mv, i64 32
  %i.na = load <4 x i32>, ptr %i.mz, align 16, !tbaa !29 ; 2 uses
  %i.nb = getelementptr inbounds nuw i8, ptr %i.mv, i64 48
  %i.nc = load <4 x i32>, ptr %i.nb, align 16, !tbaa !29 ; 2 uses
  %i.nd = getelementptr inbounds nuw i8, ptr %i.mv, i64 64
  %i.ne = load <4 x i32>, ptr %i.nd, align 16, !tbaa !29 ; 2 uses
  %i.nf = getelementptr inbounds nuw i8, ptr %i.mv, i64 80
  %i.ng = load <4 x i32>, ptr %i.nf, align 16, !tbaa !29
...
bb.g:                                             ; preds = %bb.f
  ...
  store i32 %.sroa.026.0.vec.extract.us.i, ptr %.068272.us.i, align 4, !tbaa !10
  %.sroa.026.4.vec.extract.us.i = extractelement <4 x i32> %i.nw, i64 1
  store i32 %.sroa.026.4.vec.extract.us.i, ptr %i.og, align 4, !tbaa !10
  %.sroa.026.8.vec.extract.us.i = extractelement <4 x i32> %i.nw, i64 2
  store i32 %.sroa.026.8.vec.extract.us.i, ptr %i.oh, align 4, !tbaa !10
  %.sroa.026.12.vec.extract.us.i = extractelement <4 x i32> %i.nw, i64 3
  store i32 %.sroa.026.12.vec.extract.us.i, ptr %i.oi, align 4, !tbaa !10
...
bb.p:                                             ; preds = %bb.o
  ...
  store <4 x i32> %i.oc, ptr %i.ow, align 16, !tbaa !29
  br label %bb.q
...
bb.r:                                             ; preds = %bb.q
  ...
  store <4 x i32> %i.of, ptr %i.ox, align 16, !tbaa !29
  br label %bb.s
...
bb.t:                                             ; preds = %bb.s, %bb.e
  ...
  br i1 %exitcond.not.i, label %bb.u, label %bb.e, !llvm.loop !397
...
bb.u:                                             ; preds = %bb.t
  ...
  br i1 %exitcond276.not.i, label %._crit_edge.us.i, label %.preheader54.us.i, !llvm.loop !398
...
._crit_edge.us.i:                                 ; preds = %bb.u
  ...
  br i1 %i.pa, label %.lr.ph.us.i, label %.preheader53.loopexit.i, !llvm.loop !399
...
.preheader53.i:                                   ; preds = %.lr.ph77.i, %.preheader53.loopexit.i, %._crit_edge
  %.0647.lcssa.i = phi i32 [ 0, %._crit_edge ], [ %i.pb, %.preheader53.loopexit.i ], [ %i.eb, %.lr.ph77.i ] ; 6 uses
...
.lr.ph128.i:                                      ; preds = %.preheader53.i
  ...
  %i.pf = shl nuw nsw i32 %.sroa.speculated117, 1
  %i.pg = zext nneg i32 %i.pf to i64
  %i.ph = shl nuw nsw i32 %.sroa.speculated117, 2
  %i.pi = zext nneg i32 %i.ph to i64
  %i.pj = mul nuw nsw i32 %.sroa.speculated117, 6
  %i.pk = zext nneg i32 %i.pj to i64
  %i.pl = shl nuw nsw i32 %.sroa.speculated117, 3
  %i.pm = zext nneg i32 %i.pl to i64
  %i.pn = mul nuw nsw i32 %.sroa.speculated117, 10
  %i.po = zext nneg i32 %i.pn to i64
  %i.pp = mul nuw nsw i32 %.sroa.speculated117, 12
  %i.pq = zext nneg i32 %i.pp to i64              ; 30 uses
...
.lr.ph128.split.preheader.i:                      ; preds = %.lr.ph128.i
  %15 = add i32 %.0647.lcssa.i, 3
  %smax.i = call i32 @llvm.smax.i32(i32 %.sroa.speculated121, i32 %15)
  %reass.sub = sub i32 %smax.i, %.0647.lcssa.i
  %16 = and i32 %reass.sub, -2
  %i.ps = add i32 %.0647.lcssa.i, %16
  br label %.preheader51.i

.lr.ph128.split.us.i:                             ; preds = %.lr.ph128.i
  %i.pt = load ptr, ptr %12, align 8, !tbaa !27, !noalias !421
  %i.pu = load i64, ptr %i.as, align 8, !tbaa !19, !noalias !421
  %i.pv = load i64, ptr %i.ba, align 8, !tbaa !28, !noalias !421 ; 2 uses
...
.preheader52.us.i:                                ; preds = %bb.ae, %.lr.ph.us131.i
  ...
  %i.qi = load i32, ptr %i.qd, align 4, !tbaa !10 ; 2 uses
  %i.qj = load i32, ptr %i.qe, align 4, !tbaa !10 ; 2 uses
  %i.qk = add nsw i32 %i.qj, %i.qi                ; 2 uses
  %i.ql = getelementptr inbounds nuw i8, ptr %i.qd, i64 4
  %i.qm = load i32, ptr %i.ql, align 4, !tbaa !10 ; 2 uses
  %i.qn = getelementptr inbounds nuw i8, ptr %i.qe, i64 4
  %i.qo = load i32, ptr %i.qn, align 4, !tbaa !10 ; 2 uses
  %i.qp = add nsw i32 %i.qo, %i.qm                ; 2 uses
  %i.qq = load i32, ptr %i.qf, align 4, !tbaa !10 ; 2 uses
  %i.qr = load i32, ptr %i.qg, align 4, !tbaa !10 ; 2 uses
  ...
  %i.qw = load i32, ptr %i.qv, align 4, !tbaa !10 ; 2 uses
  ...
  %i.rd = load i32, ptr %i.qc, align 4, !tbaa !10
  ...
  %i.rt = load i32, ptr %i.qh, align 4, !tbaa !10
  ...
  store i32 %i.re, ptr %i.b, align 16, !tbaa !10
  store i32 %i.ri, ptr %i.cb, align 4, !tbaa !10
  store i32 %i.rk, ptr %i.br, align 16, !tbaa !10
  store i32 %i.rm, ptr %i.cc, align 4, !tbaa !10
  store i32 %i.ro, ptr %i.bs, align 16, !tbaa !10
  store i32 %i.rq, ptr %i.cd, align 4, !tbaa !10
  store i32 %i.rv, ptr %i.bt, align 16, !tbaa !10
  store i32 %i.sb, ptr %i.ce, align 4, !tbaa !10
  ...
  %i.si = load i32, ptr %i.sd, align 4, !tbaa !10 ; 2 uses
  %i.sj = load i32, ptr %i.se, align 4, !tbaa !10 ; 2 uses
  %i.sk = add nsw i32 %i.sj, %i.si                ; 2 uses
  %i.sl = getelementptr inbounds nuw i8, ptr %i.sd, i64 4
  %i.sm = load i32, ptr %i.sl, align 4, !tbaa !10 ; 2 uses
  %i.sn = getelementptr inbounds nuw i8, ptr %i.se, i64 4
  %i.so = load i32, ptr %i.sn, align 4, !tbaa !10 ; 2 uses
  %i.sp = add nsw i32 %i.so, %i.sm                ; 2 uses
  %i.sq = load i32, ptr %i.sf, align 4, !tbaa !10 ; 2 uses
  %i.sr = load i32, ptr %i.sg, align 4, !tbaa !10 ; 2 uses
  %i.ss = add nsw i32 %i.sr, %i.sq                ; 2 uses
  %i.st = getelementptr inbounds nuw i8, ptr %i.sf, i64 4
  %i.su = load i32, ptr %i.st, align 4, !tbaa !10 ; 2 uses
  ...
  %i.td = load i32, ptr %i.sc, align 4, !tbaa !10
  ...
  %i.tt = load i32, ptr %i.sh, align 4, !tbaa !10
  ...
  store i32 %i.te, ptr %i.cf, align 8, !tbaa !10
  store i32 %i.ti, ptr %i.cg, align 4, !tbaa !10
  store i32 %i.tk, ptr %i.ch, align 8, !tbaa !10
  store i32 %i.tm, ptr %i.ci, align 4, !tbaa !10
  store i32 %i.to, ptr %i.cj, align 8, !tbaa !10
  store i32 %i.tq, ptr %i.ck, align 4, !tbaa !10
  store i32 %i.tv, ptr %i.cl, align 8, !tbaa !10
  store i32 %i.ub, ptr %i.cm, align 4, !tbaa !10
  ...
  %i.ui = load i32, ptr %i.ud, align 4, !tbaa !10 ; 2 uses
  %i.uj = load i32, ptr %i.ue, align 4, !tbaa !10 ; 2 uses
  %i.uk = add nsw i32 %i.uj, %i.ui                ; 2 uses
  %i.ul = getelementptr inbounds nuw i8, ptr %i.ud, i64 4
  %i.um = load i32, ptr %i.ul, align 4, !tbaa !10 ; 2 uses
  ...
  %i.uq = load i32, ptr %i.uf, align 4, !tbaa !10 ; 2 uses
  %i.ur = load i32, ptr %i.ug, align 4, !tbaa !10 ; 2 uses
  %i.us = add nsw i32 %i.ur, %i.uq                ; 2 uses
  %i.ut = getelementptr inbounds nuw i8, ptr %i.uf, i64 4
  %i.uu = load i32, ptr %i.ut, align 4, !tbaa !10 ; 2 uses
  %i.uv = getelementptr inbounds nuw i8, ptr %i.ug, i64 4
  %i.uw = load i32, ptr %i.uv, align 4, !tbaa !10 ; 2 uses
  ...
  %i.vd = load i32, ptr %i.uc, align 4, !tbaa !10
  ...
  %i.vt = load i32, ptr %i.uh, align 4, !tbaa !10
  ...
  %i.vz = load i32, ptr %i.vy, align 4, !tbaa !10
  %i.wa = shl nsw i32 %i.vz, 2
  %i.wb = add nsw i32 %i.vx, %i.wa
  store i32 %i.ve, ptr %i.cn, align 16, !tbaa !10
  store i32 %i.vi, ptr %i.co, align 4, !tbaa !10
end_hunk_5
begin_hunk_6_@_ZN4ncnnL46conv3x3s1_winograd43_transform_input_tile_int8ERKNS_3MatERS0_iiiii.omp_outlined:bb.a
  ...
  store <8 x i16> %i.asc, ptr %i.arn, align 16, !tbaa !29
  store <8 x i16> %i.asd, ptr %i.aro, align 16, !tbaa !29
  store <8 x i16> %i.ase, ptr %i.arp, align 16, !tbaa !29
  store <8 x i16> %i.asf, ptr %i.arq, align 16, !tbaa !29
  store <8 x i16> %i.asg, ptr %i.arr, align 16, !tbaa !29
  store <8 x i16> %i.asi, ptr %i.ars, align 16, !tbaa !29
  %i.asj = load i32, ptr %4, align 4, !tbaa !10
  ...
  store <8 x i16> %i.atb, ptr %i.asm, align 16, !tbaa !29
  store <8 x i16> %i.atc, ptr %i.asn, align 16, !tbaa !29
  store <8 x i16> %i.atd, ptr %i.aso, align 16, !tbaa !29
  store <8 x i16> %i.ate, ptr %i.asp, align 16, !tbaa !29
  store <8 x i16> %i.atf, ptr %i.asq, align 16, !tbaa !29
  store <8 x i16> %i.ath, ptr %i.asr, align 16, !tbaa !29
  %i.ati = load i32, ptr %4, align 4, !tbaa !10
  ...
  store <8 x i16> %i.aua, ptr %i.atl, align 16, !tbaa !29
  store <8 x i16> %i.aub, ptr %i.atm, align 16, !tbaa !29
  store <8 x i16> %i.auc, ptr %i.atn, align 16, !tbaa !29
  store <8 x i16> %i.aud, ptr %i.ato, align 16, !tbaa !29
  store <8 x i16> %i.aue, ptr %i.atp, align 16, !tbaa !29
  store <8 x i16> %i.aug, ptr %i.atq, align 16, !tbaa !29
  %i.auh = load i32, ptr %4, align 4, !tbaa !10
  ...
  store <8 x i16> %i.auz, ptr %i.auk, align 16, !tbaa !29
  store <8 x i16> %i.ava, ptr %i.aul, align 16, !tbaa !29
  store <8 x i16> %i.avb, ptr %i.aum, align 16, !tbaa !29
  store <8 x i16> %i.avc, ptr %i.aun, align 16, !tbaa !29
  store <8 x i16> %i.avd, ptr %i.auo, align 16, !tbaa !29
  store <8 x i16> %i.avf, ptr %i.aup, align 16, !tbaa !29
  %i.avg = load i32, ptr %4, align 4, !tbaa !10
  ...
  store <8 x i16> %i.avy, ptr %i.avj, align 16, !tbaa !29
  store <8 x i16> %i.avz, ptr %i.avk, align 16, !tbaa !29
  store <8 x i16> %i.awa, ptr %i.avl, align 16, !tbaa !29
  store <8 x i16> %i.awb, ptr %i.avm, align 16, !tbaa !29
  store <8 x i16> %i.awc, ptr %i.avn, align 16, !tbaa !29
  store <8 x i16> %i.awe, ptr %i.avo, align 16, !tbaa !29
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.awf = load i32, ptr %4, align 4, !tbaa !10   ; 2 uses
  %i.awg = sext i32 %i.awf to i64
  %i.awh = icmp slt i64 %indvars.iv.next, %i.awg
  br i1 %i.awh, label %.noexc, label %._crit_edge, !llvm.loop !429
...
._crit_edge:                                      ; preds = %.thread.5, %.lr.ph.split
  ...
  br i1 %exitcond.not, label %._crit_edge290, label %.lr.ph.split, !llvm.loop !430
...
!25 = !{!"bool", !6, i64 0}
!26 = !{!"_ZTSN4ncnn6OptionE", !25, i64 0, !25, i64 1, !25, i64 2, !25, i64 3, !7, i64 4, !14, i64 8, !14, i64 16, !7, i64 24, !25, i64 28, !25, i64 29, !25, i64 30, !25, i64 31, !25, i64 32, !25, i64 33, !25, i64 34, !25, i64 35, !25, i64 36, !25, i64 37, !25, i64 38, !25, i64 39, !7, i64 40, !25, i64 44, !25, i64 45, !25, i64 46, !25, i64 47, !6, i64 48, !25, i64 49, !25, i64 50, !25, i64 51, !25, i64 52, !25, i64 53, !25, i64 54, !25, i64 55, !25, i64 56, !25, i64 57, !25, i64 58, !25, i64 59, !25, i64 60, !25, i64 61, !25, i64 62, !25, i64 63}
!27 = !{!15, !11, i64 0}
!28 = !{!15, !13, i64 16}
!29 = !{!6, !6, i64 0}
...
!46 = distinct !{!46, !22}
!47 = distinct !{!47, !22, !24, !23}
!48 = distinct !{!48, !"_ZN4ncnn3Mat7channelEi"}
!49 = distinct !{!49, !48, !"_ZN4ncnn3Mat7channelEi: argument 0"}
!50 = distinct !{!50, !"_ZNK4ncnn3Mat7channelEi"}
!51 = distinct !{!51, !50, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!52 = distinct !{!52, !"_ZNK4ncnn3Mat7channelEi"}
!53 = distinct !{!53, !52, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!54 = distinct !{!54, !"_ZNK4ncnn3Mat7channelEi"}
!55 = distinct !{!55, !54, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!56 = distinct !{!56, !22}
!57 = distinct !{!57, !22}
!58 = distinct !{!58, !"_ZNK4ncnn3Mat7channelEi"}
!59 = distinct !{!59, !58, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!60 = distinct !{!60, !22}
!61 = distinct !{!61, !22}
...
!68 = distinct !{!68, !67, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
...
!74 = distinct !{!74, !73, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!75 = distinct !{!75, !22}
!76 = distinct !{!76, !22}
!77 = distinct !{!77, !"_ZNK4ncnn3Mat7channelEi"}
!78 = distinct !{!78, !77, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!79 = distinct !{!79, !22}
!80 = distinct !{!80, !22}
!81 = distinct !{!81, !22}
!82 = distinct !{!82, !"_ZNK4ncnn3Mat7channelEi"}
!83 = distinct !{!83, !82, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!84 = distinct !{!84, !22}
!85 = distinct !{!85, !22}
...
!91 = distinct !{!91, !90, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!92 = distinct !{!92, !22}
!93 = distinct !{!93, !22}
!94 = distinct !{!94, !22}
!95 = distinct !{!95, !22}
!96 = distinct !{!96, !"_ZN4ncnn3Mat7channelEi"}
!97 = distinct !{!97, !96, !"_ZN4ncnn3Mat7channelEi: argument 0"}
...
!101 = distinct !{!101, !100, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!102 = distinct !{!102, !"_ZNK4ncnn3Mat7channelEi"}
!103 = distinct !{!103, !102, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!104 = distinct !{!104, !22}
!105 = distinct !{!105, !22}
!106 = distinct !{!106, !"_ZNK4ncnn3Mat7channelEi"}
!107 = distinct !{!107, !106, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!108 = distinct !{!108, !22}
!109 = distinct !{!109, !22}
!110 = distinct !{!110, !"_ZNK4ncnn3Mat7channelEi"}
!111 = distinct !{!111, !110, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!112 = distinct !{!112, !22}
!113 = distinct !{!113, !22}
!114 = distinct !{!114, !22}
...
!122 = distinct !{!122, !121, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!123 = distinct !{!123, !22}
!124 = distinct !{!124, !22}
...
!131 = distinct !{!131, !130, !"_ZNK4ncnn3Mat7channelEi: argument 0"}
!132 = distinct !{!132, !22}
!133 = distinct !{!133, !22}
...
!143 = distinct !{!143, !22}
!144 = distinct !{!144, !22}
!145 = !{!"branch_weights", i32 4, i32 28}
!146 = !{!26, !7, i64 4}
!147 = !{!49}
!148 = !{!51}
!149 = !{!53}
