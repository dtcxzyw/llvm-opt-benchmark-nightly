...
bb.c:                                             ; preds = %.preheader114, %._crit_edge119
  ...
  %12 = fmul fast float %i.be, %i.bk
  %13 = call fast float @llvm.ceil.f32(float %i.bp)
  %i.bq = call fast float @llvm.ceil.f32(float %12)
  %i.br = insertelement <2 x float> poison, float %i.bq, i64 0
  %i.bs = insertelement <2 x float> %i.br, float %13, i64 1
