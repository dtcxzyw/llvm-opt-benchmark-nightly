...
bb.g:                                             ; preds = %bb.o, %.lr.ph35.new
  %.02233 = phi i64 [ 0, %.lr.ph35.new ], [ %i.cf, %bb.o ] ; 5 uses
  %.02332 = phi ptr [ %i.ax, %.lr.ph35.new ], [ %.1.3, %bb.o ] ; 3 uses
  %niter = phi i64 [ 0, %.lr.ph35.new ], [ %niter.next.3, %bb.o ]
  %i.bi = getelementptr inbounds nuw [8 x i8], ptr %i.ay, i64 %.02233
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.bm = getelementptr inbounds nuw i8, ptr %.02332, i64 8
  store ptr %i.bl, ptr %.02332, align 8, !tbaa !30
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %.1 = phi ptr [ %i.bm, %bb.h ], [ %.02332, %bb.g ] ; 3 uses
  %i.bn = getelementptr inbounds nuw [8 x i8], ptr %i.ay, i64 %.02233
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %i.bt = getelementptr inbounds nuw [8 x i8], ptr %i.ay, i64 %.02233
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.bz = getelementptr inbounds nuw [8 x i8], ptr %i.ay, i64 %.02233
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  %i.cf = add nuw nsw i64 %.02233, 4              ; 2 uses
