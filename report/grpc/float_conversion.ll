...
begin_hunk_0_@_ZN4absl12lts_2025051219str_format_internal12_GLOBAL__N_110StackArray19RunWithCapacityImplILm2EEEvNS0_11FunctionRefIFvNS0_4SpanIjEEEEE:bb.a
  ...
  call void %1(ptr %0, ptr nonnull %i.a, i64 256), !inline_history !103
...
bb.a:
  ...
  call void %1(ptr %0, ptr nonnull %i.a, i64 384), !inline_history !103
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #18
  ret void
}
...
bb.a:
  ...
  call void %1(ptr %0, ptr nonnull %i.a, i64 512), !inline_history !103
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #18
  ret void
}
...
bb.a:
  ...
  call void %1(ptr %0, ptr nonnull %i.a, i64 640), !inline_history !103
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #18
  ret void
}
...
bb.a:
  ...
  %i.c = load i32, ptr %i.b, align 16, !tbaa !92  ; 3 uses
  %i.d = getelementptr inbounds nuw i8, ptr %4, i64 32 ; 3 uses
  store i64 0, ptr %i.d, align 8, !tbaa !104
  ...
  store i64 %2, ptr %i.f, align 8, !tbaa !110
  %i.g = sdiv i32 %i.c, 32
  ...
  store i64 %i.n, ptr %i.o, align 8, !tbaa !111
  ...
  store i32 %i.w, ptr %i.y, align 4, !tbaa !17
...
.preheader39._crit_edge.i.i.i.i.i:                ; preds = %.preheader39.i.i.i.i.i
  ...
  %.pre.i.i.i.i.i = load i32, ptr %.phi.trans.insert.i.i.i.i.i, align 4, !tbaa !17
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i, %.lr.ph.preheader.i.i.i.i.i
  ...
  store i32 %i.ai, ptr %i.ak, align 4, !tbaa !17
  ...
  br i1 %.not53.i.i.i.i.i, label %.preheader39.i.i.i.i.i, label %.lr.ph.i.i.i.i.i, !llvm.loop !112
...
bb.b:                                             ; preds = %bb.c
  ...
  store i32 %i.au, ptr %i.ba, align 4, !tbaa !17
  %.not.i.i.i.i.i = icmp eq i64 %spec.select.i.i.i.i.i, 0
  br i1 %.not.i.i.i.i.i, label %._crit_edge.i.i.i.i.i, label %.preheader.i.i.i.i.i, !llvm.loop !113
...
bb.c:                                             ; preds = %bb.c, %.preheader.i.i.i.i.i
  ...
  store i32 %i.bi, ptr %i.bc, align 4, !tbaa !17
  %i.bj = urem i64 %i.bg, 1000000000              ; 2 uses
  %.not26.i.i.i.i.i = icmp eq i64 %i.bb, 0
  br i1 %.not26.i.i.i.i.i, label %bb.b, label %bb.c, !llvm.loop !114
...
._crit_edge.i.i.i.i.i:                            ; preds = %bb.b, %.preheader39._crit_edge.i.i.i.i.i
  ...
  store i64 %i.bl, ptr %4, align 8, !tbaa !115
...
bb.d:                                             ; preds = %bb.d, %.lr.ph51.i.i.i.i.i
  ...
  %i.bq = load i64, ptr %i.d, align 8, !tbaa !104 ; 2 uses
  %i.br = add i64 %i.bq, 1
  store i64 %i.br, ptr %i.d, align 8, !tbaa !104
  %i.bs = sub i64 8, %i.bq
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bm, i64 %i.bs
  store i8 %i.bp, ptr %i.bt, align 1, !tbaa !13
  %i.bu = udiv i32 %.049.i.i.i.i.i, 10
  %.not25.i.i.i.i.i = icmp ult i32 %.049.i.i.i.i.i, 10
  br i1 %.not25.i.i.i.i.i, label %_ZSt6invokeIRKZN4absl12lts_2025051219str_format_internal12_GLOBAL__N_115BinaryToDecimal13RunConversionENS1_7uint128EiNS1_11FunctionRefIFvS4_EEEEUlNS1_4SpanIjEEE_JSA_EENSt13invoke_resultIT_JDpT0_EE4typeEOSF_DpOSG_.exit, label %bb.d, !llvm.loop !116
...
_ZSt6invokeIRKZN4absl12lts_2025051219str_format_internal12_GLOBAL__N_115BinaryToDecimal13RunConversionENS1_7uint128EiNS1_11FunctionRefIFvS4_EEEEUlNS1_4SpanIjEEE_JSA_EENSt13invoke_resultIT_JDpT0_EE4typeEOSF_DpOSG_.exit: ; preds = %bb.d, %._crit_edge.i.i.i.i.i
  %.val.i.i.i.i = load ptr, ptr %0, align 16, !tbaa !13
  %i.bv = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.val5.i.i.i.i = load ptr, ptr %i.bv, align 8, !tbaa !117
  ...
  call void %.val5.i.i.i.i(ptr %.val.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(56) %3), !inline_history !118
...
bb.b:                                             ; preds = %_ZNK4absl12lts_2025051219str_format_internal12_GLOBAL__N_111FormatState14ShouldPrintDotEv.exit.thread.i.i.i.i, %_ZNK4absl12lts_2025051219str_format_internal12_GLOBAL__N_111FormatState14ShouldPrintDotEv.exit.i.i.i.i
  ...
  %i.v = load i32, ptr %i.u, align 4, !tbaa !15, !noalias !123 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.aa = load i8, ptr %i.z, align 1, !tbaa !8, !noalias !123 ; 2 uses
...
_ZN4absl12lts_2025051219str_format_internal12_GLOBAL__N_119ExtraWidthToPaddingEmRKNS2_11FormatStateE.exit.i.i.i.i: ; preds = %bb.e
  ...
  store i64 %i.ah, ptr %i.af, align 8, !tbaa !77
  ...
  %i.al = load ptr, ptr %i.aj, align 8, !tbaa !80 ; 4 uses
...
bb.f:                                             ; preds = %.lr.ph.i.i.i.i.i
  ...
  %i.at = load ptr, ptr %i.aj, align 8, !tbaa !80
  %i.au = getelementptr inbounds nuw i8, ptr %i.at, i64 %i.an ; 2 uses
  store ptr %i.au, ptr %i.aj, align 8, !tbaa !80
...
bb.g:                                             ; preds = %bb.f, %.lr.ph.i.i.i.i.i
  ...
  %i.aw = load ptr, ptr %i.ar, align 8, !tbaa !81
  %i.ax = load ptr, ptr %i.ae, align 8, !tbaa !82
  tail call void %i.aw(ptr noundef %i.ax, i64 %i.av, ptr nonnull %i.ap), !inline_history !126
  store ptr %i.ap, ptr %i.aj, align 8, !tbaa !80
...
.peel.next.i.i.i.i.i:                             ; preds = %bb.g, %.peel.next.i.i.i.i.i
  ...
  store ptr %i.ai, ptr %i.aj, align 8, !tbaa !80
  %i.ba = load ptr, ptr %i.ar, align 8, !tbaa !81
  %i.bb = load ptr, ptr %i.ae, align 8, !tbaa !82
  tail call void %i.ba(ptr noundef %i.bb, i64 1024, ptr nonnull %i.ap), !inline_history !126
  store ptr %i.ap, ptr %i.aj, align 8, !tbaa !80
  %i.bc = icmp ugt i64 %i.az, 1024
  br i1 %i.bc, label %.peel.next.i.i.i.i.i, label %._crit_edge.i.i.i.i.i, !llvm.loop !85
...
._crit_edge.i.i.i.i.i:                            ; preds = %.peel.next.i.i.i.i.i, %bb.g, %_ZN4absl12lts_2025051219str_format_internal12_GLOBAL__N_119ExtraWidthToPaddingEmRKNS2_11FormatStateE.exit.i.i.i.i
  ...
  %i.bd = load ptr, ptr %i.aj, align 8, !tbaa !80
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 %.0.lcssa.i.i.i.i.i
  store ptr %i.be, ptr %i.aj, align 8, !tbaa !80
  %.pre.i.i.i.i = load ptr, ptr %0, align 8, !tbaa !119 ; 2 uses
  %.pre75.i.i.i.i.a = load i8, ptr %.pre.i.i.i.i, align 8, !tbaa !26
...
bb.h:                                             ; preds = %_ZN4absl12lts_2025051219str_format_internal14FormatSinkImpl6AppendEmc.exit.i.i.i.i
  ...
  %i.bo = load ptr, ptr %i.bn, align 8, !tbaa !80 ; 2 uses
...
.lr.ph.i10.i.i.i.i:                               ; preds = %bb.h
  ...
  %i.bt = load ptr, ptr %i.bi, align 8, !tbaa !82
  tail call void %i.bs(ptr noundef %i.bt, i64 1024, ptr nonnull %i.bq), !inline_history !126
  store ptr %i.bq, ptr %i.bn, align 8, !tbaa !80
...
bb.j:                                             ; preds = %bb.i
  ...
  store i64 %i.cc, ptr %i.ca, align 8, !tbaa !77
  ...
  %i.cg = load ptr, ptr %i.ce, align 8, !tbaa !80 ; 4 uses
...
bb.k:                                             ; preds = %.lr.ph.i20.i.i.i.i
  ...
  %i.co = load ptr, ptr %i.ce, align 8, !tbaa !80
  %i.cp = getelementptr inbounds nuw i8, ptr %i.co, i64 %i.ci ; 2 uses
  store ptr %i.cp, ptr %i.ce, align 8, !tbaa !80
...
bb.l:                                             ; preds = %bb.k, %.lr.ph.i20.i.i.i.i
  ...
  %i.cr = load ptr, ptr %i.cm, align 8, !tbaa !81
  %i.cs = load ptr, ptr %i.by, align 8, !tbaa !82
  tail call void %i.cr(ptr noundef %i.cs, i64 %i.cq, ptr nonnull %i.ck), !inline_history !126
  store ptr %i.ck, ptr %i.ce, align 8, !tbaa !80
...
.peel.next.i24.i.i.i.i:                           ; preds = %bb.l, %.peel.next.i24.i.i.i.i
  ...
  store ptr %i.cd, ptr %i.ce, align 8, !tbaa !80
  %i.cv = load ptr, ptr %i.cm, align 8, !tbaa !81
  %i.cw = load ptr, ptr %i.by, align 8, !tbaa !82
  tail call void %i.cv(ptr noundef %i.cw, i64 1024, ptr nonnull %i.ck), !inline_history !126
  store ptr %i.ck, ptr %i.ce, align 8, !tbaa !80
  %i.cx = icmp ugt i64 %i.cu, 1024
  br i1 %i.cx, label %.peel.next.i24.i.i.i.i, label %._crit_edge.i17.i.i.i.i, !llvm.loop !85
...
bb.o:                                             ; preds = %bb.m
  ...
  %i.dy = load ptr, ptr %i.dl, align 8, !tbaa !80
  %i.dz = getelementptr inbounds nuw i8, ptr %i.dy, i64 %i.g
  store ptr %i.dz, ptr %i.dl, align 8, !tbaa !80
  br label %_ZN4absl12lts_2025051219str_format_internal14FormatSinkImpl6AppendESt17basic_string_viewIcSt11char_traitsIcEE.exit.peel.i.i.i.i
...
.loopexit.i.i.i.i:                                ; preds = %_ZN4absl12lts_2025051219str_format_internal14FormatSinkImpl6AppendESt17basic_string_viewIcSt11char_traitsIcEE.exit.i.i.i.i, %_ZN4absl12lts_2025051219str_format_internal14FormatSinkImpl6AppendESt17basic_string_viewIcSt11char_traitsIcEE.exit.peel.i.i.i.i
  ...
  %.val.i.i.i.i = load i64, ptr %i.et, align 8, !tbaa !31
...
.lr.ph.i34.i.i.i.i:                               ; preds = %_ZNK4absl12lts_2025051219str_format_internal12_GLOBAL__N_111FormatState14ShouldPrintDotEv.exit30.thread.i.i.i.i
  ...
  %i.fk = load ptr, ptr %i.ez, align 8, !tbaa !82
  call void %i.fj(ptr noundef %i.fk, i64 1024, ptr nonnull %i.fh), !inline_history !126
  store ptr %i.fh, ptr %i.fe, align 8, !tbaa !80
  br label %bb.r
...
bb.r:                                             ; preds = %.lr.ph.i34.i.i.i.i, %_ZNK4absl12lts_2025051219str_format_internal12_GLOBAL__N_111FormatState14ShouldPrintDotEv.exit30.thread.i.i.i.i
  ...
  %i.fl = load ptr, ptr %i.fe, align 8, !tbaa !80
  %i.fm = getelementptr inbounds nuw i8, ptr %i.fl, i64 1
  store ptr %i.fm, ptr %i.fe, align 8, !tbaa !80
  %.pre79.i.i.i.i = load ptr, ptr %0, align 8, !tbaa !119 ; 2 uses
  %.phi.trans.insert80.i.i.i.i = getelementptr inbounds nuw i8, ptr %.pre79.i.i.i.i, i64 8
  %.pre81.i.i.i.i = load i64, ptr %.phi.trans.insert80.i.i.i.i, align 8, !tbaa !31 ; 5 uses
  %i.fn = getelementptr inbounds nuw i8, ptr %.pre79.i.i.i.i, i64 24
  %i.fo = load ptr, ptr %i.fn, align 8, !tbaa !33 ; 8 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.fr = load i64, ptr %i.fq, align 8, !tbaa !77
  %i.fs = add i64 %i.fr, %.pre81.i.i.i.i
  store i64 %i.fs, ptr %i.fq, align 8, !tbaa !77
  ...
  %i.fw = load ptr, ptr %i.fu, align 8, !tbaa !80 ; 4 uses
...
bb.t:                                             ; preds = %.lr.ph.i44.i.i.i.i
  ...
  %i.ge = load ptr, ptr %i.fu, align 8, !tbaa !80
  %i.gf = getelementptr inbounds nuw i8, ptr %i.ge, i64 %i.fy ; 2 uses
  store ptr %i.gf, ptr %i.fu, align 8, !tbaa !80
...
bb.u:                                             ; preds = %bb.t, %.lr.ph.i44.i.i.i.i
  ...
  %i.gh = load ptr, ptr %i.gc, align 8, !tbaa !81
  %i.gi = load ptr, ptr %i.fo, align 8, !tbaa !82
  call void %i.gh(ptr noundef %i.gi, i64 %i.gg, ptr nonnull %i.ga), !inline_history !126
  store ptr %i.ga, ptr %i.fu, align 8, !tbaa !80
...
.peel.next.i48.i.i.i.i:                           ; preds = %bb.u, %.peel.next.i48.i.i.i.i
  ...
  store ptr %i.ft, ptr %i.fu, align 8, !tbaa !80
  %i.gl = load ptr, ptr %i.gc, align 8, !tbaa !81
  %i.gm = load ptr, ptr %i.fo, align 8, !tbaa !82
  call void %i.gl(ptr noundef %i.gm, i64 1024, ptr nonnull %i.ga), !inline_history !126
  store ptr %i.ga, ptr %i.fu, align 8, !tbaa !80
  %i.gn = icmp ugt i64 %i.gk, 1024
  br i1 %i.gn, label %.peel.next.i48.i.i.i.i, label %._crit_edge.i41.i.i.i.i, !llvm.loop !85
...
._crit_edge.i41.i.i.i.i:                          ; preds = %.peel.next.i48.i.i.i.i, %bb.u, %bb.s
  ...
  %i.go = load ptr, ptr %i.fu, align 8, !tbaa !80
  %i.gp = getelementptr inbounds nuw i8, ptr %i.go, i64 %.0.lcssa.i42.i.i.i.i
  store ptr %i.gp, ptr %i.fu, align 8, !tbaa !80
  %.pre82.i.i.i.i = load ptr, ptr %0, align 8, !tbaa !119
...
bb.v:                                             ; preds = %_ZN4absl12lts_2025051219str_format_internal14FormatSinkImpl6AppendEmc.exit50.i.i.i.i
  ...
  %i.gv = load i64, ptr %i.gu, align 8, !tbaa !77
  %i.gw = add i64 %i.gv, %.sroa.10.065.i.i.i.i
  store i64 %i.gw, ptr %i.gu, align 8, !tbaa !77
  ...
  %i.ha = load ptr, ptr %i.gy, align 8, !tbaa !80 ; 4 uses
...
bb.w:                                             ; preds = %.lr.ph.i54.i.i.i.i
  ...
  %i.hi = load ptr, ptr %i.gy, align 8, !tbaa !80
  %i.hj = getelementptr inbounds nuw i8, ptr %i.hi, i64 %i.hc ; 2 uses
  store ptr %i.hj, ptr %i.gy, align 8, !tbaa !80
...
bb.x:                                             ; preds = %bb.w, %.lr.ph.i54.i.i.i.i
  ...
  %i.hl = load ptr, ptr %i.hg, align 8, !tbaa !81
  %i.hm = load ptr, ptr %i.gs, align 8, !tbaa !82
  call void %i.hl(ptr noundef %i.hm, i64 %i.hk, ptr nonnull %i.he), !inline_history !126
  store ptr %i.he, ptr %i.gy, align 8, !tbaa !80
...
.peel.next.i58.i.i.i.i:                           ; preds = %bb.x, %.peel.next.i58.i.i.i.i
  ...
  store ptr %i.gx, ptr %i.gy, align 8, !tbaa !80
  %i.hp = load ptr, ptr %i.hg, align 8, !tbaa !81
  %i.hq = load ptr, ptr %i.gs, align 8, !tbaa !82
  call void %i.hp(ptr noundef %i.hq, i64 1024, ptr nonnull %i.he), !inline_history !126
  store ptr %i.he, ptr %i.gy, align 8, !tbaa !80
  %i.hr = icmp ugt i64 %i.ho, 1024
  br i1 %i.hr, label %.peel.next.i58.i.i.i.i, label %._crit_edge.i51.i.i.i.i, !llvm.loop !85
...
._crit_edge.i51.i.i.i.i:                          ; preds = %.peel.next.i58.i.i.i.i, %bb.x, %bb.v
  ...
  %i.hs = load ptr, ptr %i.gy, align 8, !tbaa !80
  %i.ht = getelementptr inbounds nuw i8, ptr %i.hs, i64 %.0.lcssa.i52.i.i.i.i
  store ptr %i.ht, ptr %i.gy, align 8, !tbaa !80
