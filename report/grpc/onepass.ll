...
bb.n:                                             ; preds = %.lr.ph476, %bb.bo
  %.0169473 = phi ptr [ %i.av, %.lr.ph476 ], [ %i.kr, %bb.bo ] ; 2 uses
  %.0170472 = phi i32 [ 1, %.lr.ph476 ], [ %.6.ph, %bb.bo ]
  %i.cb = load i32, ptr %.0169473, align 4, !tbaa !73 ; 2 uses
...
.loopexit:                                        ; preds = %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258, %.thread371, %bb.bk, %_ZN10LogMessageD2Ev.exit
  %.6.ph = phi i32 [ %.2172, %_ZN10LogMessageD2Ev.exit ], [ %.2172, %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258 ], [ %.3173, %.thread371 ], [ %.2172, %bb.bk ] ; 3 uses
  %.5.ph = phi ptr [ %.1166, %_ZN10LogMessageD2Ev.exit ], [ %.1166, %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258 ], [ %.2167, %.thread371 ], [ %.1166, %bb.bk ]
  %.3163.ph = phi i8 [ %.1161, %_ZN10LogMessageD2Ev.exit ], [ %.1161, %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258 ], [ %.1161, %.thread371 ], [ 1, %bb.bk ]
  %i.cq = icmp sgt i32 %.1157, 0
  br i1 %i.cq, label %bb.p, label %bb.bo

bb.p:                                             ; preds = %._crit_edge, %.loopexit
  %.0156470 = phi i32 [ 1, %._crit_edge ], [ %.1157, %.loopexit ]
  %.0160469 = phi i8 [ 0, %._crit_edge ], [ %.3163.ph, %.loopexit ]
  %.0165468 = phi ptr [ %i.ci, %._crit_edge ], [ %.5.ph, %.loopexit ]
  %.1171467 = phi i32 [ %.0170472, %._crit_edge ], [ %.6.ph, %.loopexit ]
  %i.cr = add nsw i32 %.0156470, -1               ; 2 uses
...
_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258:      ; preds = %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258.backedge, %bb.p
  %.2172 = phi i32 [ %.1171467, %bb.p ], [ %.2172.be, %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258.backedge ] ; 17 uses
  %.1166 = phi ptr [ %.0165468, %bb.p ], [ %.1166.be, %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258.backedge ] ; 14 uses
  %.1161 = phi i8 [ %.0160469, %bb.p ], [ %.1161.be, %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258.backedge ] ; 15 uses
  %.1157 = phi i32 [ %i.cr, %bb.p ], [ %.1157.be, %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258.backedge ] ; 14 uses
  %.0152 = phi i32 [ %i.cu, %bb.p ], [ %.0152.be, %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258.backedge ] ; 5 uses
  %.0149 = phi i32 [ %i.cw, %bb.p ], [ %.0149.be, %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258.backedge ] ; 17 uses
  %i.cx = sext i32 %.0152 to i64
...
_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258.backedge: ; preds = %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i290, %bb.bh, %.thread392, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i274, %bb.ax, %bb.aw, %bb.bl, %bb.bm, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i298, %bb.z, %bb.aa, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i255
  %.2172.be = phi i32 [ %.2172, %bb.aa ], [ %.2172, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i298 ], [ %.3173, %bb.ax ], [ %.2172, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i255 ], [ %.3173, %bb.aw ], [ %.2172, %.thread392 ], [ %.2172, %bb.bl ], [ %.2172, %bb.bh ], [ %.2172, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i290 ], [ %.2172, %bb.bm ], [ %.2172, %bb.z ], [ %.3173, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i274 ]
  %.1166.be = phi ptr [ %.1166, %bb.aa ], [ %.1166, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i298 ], [ %.2167, %bb.ax ], [ %.1166, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i255 ], [ %.2167, %bb.aw ], [ %.1166, %.thread392 ], [ %.1166, %bb.bl ], [ %.1166, %bb.bh ], [ %.1166, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i290 ], [ %.1166, %bb.bm ], [ %.1166, %bb.z ], [ %.2167, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i274 ]
  %.1161.be = phi i8 [ %.1161, %bb.aa ], [ 1, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i298 ], [ %.1161, %bb.ax ], [ %.1161, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i255 ], [ %.1161, %bb.aw ], [ %.1161, %.thread392 ], [ 1, %bb.bl ], [ %.1161, %bb.bh ], [ %.1161, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i290 ], [ 1, %bb.bm ], [ %.1161, %bb.z ], [ %.1161, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i274 ]
  %.1157.be = phi i32 [ %.1157, %bb.aa ], [ %.1157, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i298 ], [ %.1157, %bb.ax ], [ %.1157, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i255 ], [ %.1157, %bb.aw ], [ %.2158, %.thread392 ], [ %.1157, %bb.bl ], [ %.2158, %bb.bh ], [ %.2158, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i290 ], [ %.1157, %bb.bm ], [ %.1157, %bb.z ], [ %.1157, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i274 ]
  %.0152.be = phi i32 [ %i.ds, %bb.aa ], [ %i.kb, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i298 ], [ %i.hn, %bb.ax ], [ %i.ds, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i255 ], [ 0, %bb.aw ], [ 0, %.thread392 ], [ 0, %bb.bl ], [ %i.ji, %bb.bh ], [ %.pre501, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i290 ], [ %i.kb, %bb.bm ], [ 0, %bb.z ], [ %i.hn, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i274 ]
  %.0149.be = phi i32 [ %.0149, %bb.aa ], [ %.0149, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i298 ], [ %.0149, %bb.ax ], [ %.0149, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i255 ], [ %.0149, %bb.aw ], [ %.2151, %.thread392 ], [ %.0149, %bb.bl ], [ %.2151, %bb.bh ], [ %.2151, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i290 ], [ %.0149, %bb.bm ], [ %.0149, %bb.z ], [ %.0149, %_ZNK3re210SparseSetTIvE8containsEi.exit.thread.i.i.i274 ]
  br label %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258

bb.bj:                                            ; preds = %_ZN3re2L4AddQEPNS_10SparseSetTIvEEi.exit258
  %i.jy = trunc nuw i8 %.1161 to i1
...
bb.bl:                                            ; preds = %bb.bk
  %i.kb = add nsw i32 %.0152, 1                   ; 7 uses
...
bb.bo:                                            ; preds = %.loopexit
  %i.kr = getelementptr inbounds nuw i8, ptr %.0169473, i64 4 ; 2 uses
...
_ZNSt15__new_allocatorIhE8allocateEmPKv.exit.i:   ; preds = %._crit_edge477
  %i.la = zext nneg i32 %.0170.lcssa to i64
...
_ZN3re28PODArrayIhED2Ev.exit:                     ; preds = %bb.bp, %_ZN3re28PODArrayIhEC2Ei.exit
  ...
  store i32 %.0170.lcssa, ptr %i.lc, align 8, !tbaa !73
