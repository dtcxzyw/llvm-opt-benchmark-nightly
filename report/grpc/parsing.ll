Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/grpc/original/parsing?download=true
...
begin_hunk_0_@_Z24grpc_chttp2_perform_readP21grpc_chttp2_transportRK10grpc_sliceRm:bb.a
  ...
  store ptr %1, ptr %i.c, align 8, !tbaa !298
  %i.d = load ptr, ptr %2, align 8, !tbaa !299
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load i64, ptr %i.g, align 8, !tbaa !300
  br label %bb.d

bb.c:                                             ; preds = %bb.a
  %i.i = getelementptr inbounds nuw i8, ptr %2, i64 9
  %i.j = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.k = load i8, ptr %i.j, align 8, !tbaa !300
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  store i64 1, ptr %78, align 8, !tbaa !301
...
_ZN4absl12lts_202505126StatusD2Ev.exit:           ; preds = %bb.d
  store i64 1, ptr %0, align 8, !tbaa !301
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i8 1, ptr %i.q, align 8, !tbaa !1194
  br label %bb.lu

bb.e:                                             ; preds = %bb.d
  %i.r = getelementptr inbounds nuw i8, ptr %1, i64 2472 ; 2 uses
  %i.s = load i32, ptr %i.r, align 8, !tbaa !295  ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  %i.v = load i8, ptr %.097289, align 1, !tbaa !300 ; 4 uses
  %i.w = zext i8 %i.v to i32
  %i.x = getelementptr inbounds nuw i8, ptr @.str.2, i64 %indvars.iv
  %i.y = load i8, ptr %i.x, align 1, !tbaa !300   ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %77) #34, !noalias !1195
  %.sroa.0.0.insert.ext.i.i.i.i = zext i8 %i.y to i64
  %i.ab = inttoptr i64 %.sroa.0.0.insert.ext.i.i.i.i to ptr ; 2 uses
  store ptr %i.ab, ptr %77, align 8, !tbaa !300, !noalias !1195
  %i.ac = getelementptr inbounds nuw i8, ptr %77, i64 8
  store ptr @_ZN4absl12lts_2025051219str_format_internal13FormatArgImpl8DispatchIcEEbNS2_4DataENS1_24FormatConversionSpecImplEPv, ptr %i.ac, align 8, !tbaa !1197, !noalias !1195
  %i.ad = getelementptr inbounds nuw i8, ptr %77, i64 16
  store ptr %i.ab, ptr %i.ad, align 8, !tbaa !300, !noalias !1195
  %i.ae = getelementptr inbounds nuw i8, ptr %77, i64 24
  store ptr @_ZN4absl12lts_2025051219str_format_internal13FormatArgImpl8DispatchIiEEbNS2_4DataENS1_24FormatConversionSpecImplEPv, ptr %i.ae, align 8, !tbaa !1197, !noalias !1195
  ...
  store ptr %i.ag, ptr %i.af, align 8, !tbaa !300, !noalias !1195
  %i.ah = getelementptr inbounds nuw i8, ptr %77, i64 40
  store ptr @_ZN4absl12lts_2025051219str_format_internal13FormatArgImpl8DispatchIcEEbNS2_4DataENS1_24FormatConversionSpecImplEPv, ptr %i.ah, align 8, !tbaa !1197, !noalias !1195
  ...
  store ptr %i.aj, ptr %i.ai, align 8, !tbaa !300, !noalias !1195
  %i.ak = getelementptr inbounds nuw i8, ptr %77, i64 56
  store ptr @_ZN4absl12lts_2025051219str_format_internal13FormatArgImpl8DispatchIiEEbNS2_4DataENS1_24FormatConversionSpecImplEPv, ptr %i.ak, align 8, !tbaa !1197, !noalias !1195
  %i.al = getelementptr inbounds nuw i8, ptr %77, i64 64
  %i.am = inttoptr i64 %indvars.iv to ptr
  store ptr %i.am, ptr %i.al, align 8, !tbaa !300, !noalias !1195
  %i.an = getelementptr inbounds nuw i8, ptr %77, i64 72
  store ptr @_ZN4absl12lts_2025051219str_format_internal13FormatArgImpl8DispatchIjEEbNS2_4DataENS1_24FormatConversionSpecImplEPv, ptr %i.an, align 8, !tbaa !1197, !noalias !1195
...
bb.i:                                             ; preds = %bb.h
  call void @llvm.lifetime.end.p0(ptr nonnull %77) #34, !noalias !1195
  %i.ao = load ptr, ptr %80, align 8, !tbaa !305
  %i.ap = getelementptr inbounds nuw i8, ptr %80, i64 8
  %i.aq = load i64, ptr %i.ap, align 8, !tbaa !306
...
_ZN4absl12lts_202505126StatusD2Ev.exit163:        ; preds = %bb.i
  %i.ar = load i64, ptr %79, align 8, !tbaa !301
  store i64 %i.ar, ptr %0, align 8, !tbaa !301
  store i64 55, ptr %79, align 8, !tbaa !301
  %i.as = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i8 1, ptr %i.as, align 8, !tbaa !1194
  %i.at = load ptr, ptr %82, align 8, !tbaa !309  ; 3 uses
  %i.au = getelementptr inbounds nuw i8, ptr %82, i64 8
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !310 ; 2 uses
...
.lr.ph.i.i.i:                                     ; preds = %_ZN4absl12lts_202505126StatusD2Ev.exit163, %_ZSt8_DestroyIN4absl12lts_202505126StatusEEvPT_.exit.i.i.i
  ...
  %i.aw = load i64, ptr %.05.i.i.i, align 8, !tbaa !301 ; 2 uses
...
_ZSt8_DestroyIPN4absl12lts_202505126StatusES2_EvT_S4_RSaIT0_E.exitthread-pre-split.i: ; preds = %_ZSt8_DestroyIN4absl12lts_202505126StatusEEvPT_.exit.i.i.i
  %.pr.i = load ptr, ptr %82, align 8, !tbaa !309
...
bb.l:                                             ; preds = %_ZSt8_DestroyIPN4absl12lts_202505126StatusES2_EvT_S4_RSaIT0_E.exit.i
  ...
  %i.be = load ptr, ptr %i.bd, align 8, !tbaa !312
...
_ZNSt6vectorIN4absl12lts_202505126StatusESaIS2_EED2Ev.exit: ; preds = %_ZSt8_DestroyIPN4absl12lts_202505126StatusES2_EvT_S4_RSaIT0_E.exit.i, %bb.l
  ...
  %i.bi = load ptr, ptr %80, align 8, !tbaa !305  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %_ZNSt6vectorIN4absl12lts_202505126StatusESaIS2_EED2Ev.exit
  %i.bl = load i64, ptr %i.bj, align 8, !tbaa !300
  %i.bm = add i64 %i.bl, 1
...
bb.n:                                             ; preds = %bb.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %81) #34
  %i.bp = load ptr, ptr %80, align 8, !tbaa !305  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i164: ; preds = %bb.n
  %i.bs = load i64, ptr %i.bq, align 8, !tbaa !300
  %i.bt = add i64 %i.bs, 1
...
bb.o:                                             ; preds = %bb.g
  ...
  store i32 %103, ptr %i.r, align 8, !tbaa !295
  %.not137 = icmp eq ptr %i.bu, %i.o
  br i1 %.not137, label %_ZN4absl12lts_202505126StatusD2Ev.exit167, label %bb.f, !llvm.loop !1114

_ZN4absl12lts_202505126StatusD2Ev.exit167:        ; preds = %bb.o
  store i64 1, ptr %0, align 8, !tbaa !301
  %i.bv = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i8 1, ptr %i.bv, align 8, !tbaa !1194
  br label %bb.lu
...
_ZN4absl12lts_202505126StatusD2Ev.exit168:        ; preds = %bb.q
  ...
  store i32 25, ptr %i.cm, align 8, !tbaa !295
  store i64 1, ptr %0, align 8, !tbaa !301
  %i.cn = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i8 1, ptr %i.cn, align 8, !tbaa !1194
  br label %bb.lu
...
_ZN4absl12lts_202505126StatusD2Ev.exit169:        ; preds = %bb.r
  ...
  store i32 26, ptr %i.cx, align 8, !tbaa !295
  store i64 1, ptr %0, align 8, !tbaa !301
  %i.cy = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i8 1, ptr %i.cy, align 8, !tbaa !1194
  br label %bb.lu
...
bb.v:                                             ; preds = %bb.u, %bb.e
  ...
  store i32 %i.eb, ptr %i.ec, align 8, !tbaa !302
...
_ZN4absl12lts_202505126StatusD2Ev.exit173:        ; preds = %bb.v
  ...
  store i32 30, ptr %i.ef, align 8, !tbaa !295
  store i64 1, ptr %0, align 8, !tbaa !301
  %i.eg = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i8 1, ptr %i.eg, align 8, !tbaa !1194
  br label %bb.lu
...
bb.w:                                             ; preds = %._crit_edge310, %bb.v
  ...
  %i.ej = load i8, ptr %.8, align 1, !tbaa !300
  ...
  store i32 %i.en, ptr %i.em, align 8, !tbaa !302
...
_ZN4absl12lts_202505126StatusD2Ev.exit174:        ; preds = %bb.w
  ...
  store i32 31, ptr %i.eq, align 8, !tbaa !295
  store i64 1, ptr %0, align 8, !tbaa !301
  %i.er = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i8 1, ptr %i.er, align 8, !tbaa !1194
  br label %bb.lu
...
bb.x:                                             ; preds = %._crit_edge313, %bb.w
  ...
  %i.eu = load i8, ptr %.9, align 1, !tbaa !300
  ...
  store i32 %i.ey, ptr %i.ex, align 8, !tbaa !302
...
_ZN4absl12lts_202505126StatusD2Ev.exit175:        ; preds = %bb.x
  ...
  store i32 32, ptr %i.fb, align 8, !tbaa !295
  store i64 1, ptr %0, align 8, !tbaa !301
  %i.fc = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i8 1, ptr %i.fc, align 8, !tbaa !1194
  br label %bb.lu
...
bb.y:                                             ; preds = %._crit_edge316, %bb.x
  ...
  %i.ff = load i8, ptr %.10, align 1, !tbaa !300
