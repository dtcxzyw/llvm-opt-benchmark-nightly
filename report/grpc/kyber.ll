...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %3 = icmp slt <4 x i32> %i.q, zeroinitializer
  %i.r = select <4 x i1> %3, <4 x i32> splat (i32 3329), <4 x i32> zeroinitializer
...
vector.body8:                                     ; preds = %vector.body8, %_ZL52scalar_centered_binomial_distribution_eta_2_with_prfP6scalarPKh.exit
  ...
  %4 = icmp slt <4 x i32> %i.ay, zeroinitializer
  %i.az = select <4 x i1> %4, <4 x i32> splat (i32 3329), <4 x i32> zeroinitializer
...
vector.body15:                                    ; preds = %vector.body15, %_ZL52scalar_centered_binomial_distribution_eta_2_with_prfP6scalarPKh.exit.1
  ...
  %5 = icmp slt <4 x i32> %i.cg, zeroinitializer
  %i.ch = select <4 x i1> %5, <4 x i32> splat (i32 3329), <4 x i32> zeroinitializer
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.p = add nsw <4 x i32> %i.o, %i.n
  %i.q = add nsw <4 x i32> %i.p, %i.l             ; 2 uses
  %11 = icmp slt <4 x i32> %i.q, zeroinitializer
  %i.r = select <4 x i1> %11, <4 x i32> splat (i32 3329), <4 x i32> zeroinitializer
  %i.s = add nsw <4 x i32> %i.r, %i.q
  %i.t = trunc nsw <4 x i32> %i.s to <4 x i16>
  %.idx = shl nuw i64 %index, 2
