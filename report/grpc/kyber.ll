...
.lr.ph.preheader.i.1.i:                           ; preds = %._crit_edge.i.1.i, %.lr.ph47.i.1.i
  ...
  %i.my = load i16, ptr %gep69.i.1.i, align 2, !tbaa !12
  %i.mz = zext i16 %i.my to i32                   ; 2 uses
  %wide.trip.count.i.1.i = zext i32 %indvars.iv55.i.1.i to i64 ; 2 uses
  %i.na = sub i64 %wide.trip.count.i.1.i, %11     ; 3 uses
  %min.iters.check183 = icmp ult i64 %i.na, 8
...
vector.ph184:                                     ; preds = %vector.memcheck
  %n.vec185 = and i64 %i.na, -8                   ; 3 uses
  %i.nj = add i64 %indvars.iv.i.1.i18, %n.vec185
  %broadcast.splatinsert186 = insertelement <8 x i32> poison, i32 %i.mz, i64 0
...
middle.block193:                                  ; preds = %vector.body188
  %cmp.n194 = icmp eq i64 %i.na, %n.vec185
...
.lr.ph.preheader.i.2.i:                           ; preds = %._crit_edge.i.2.i, %.lr.ph47.i.2.i
  ...
  %12 = mul i64 %indvars.iv57.i.2.i, %i.qa
  %gep69.i.2.i = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep68.i.2.i, i64 %indvars.iv57.i.2.i
  %i.qj = load i16, ptr %gep69.i.2.i, align 2, !tbaa !12
  %i.qk = zext i16 %i.qj to i32                   ; 2 uses
  %wide.trip.count.i.2.i = zext i32 %indvars.iv55.i.2.i to i64 ; 2 uses
  %i.ql = sub i64 %wide.trip.count.i.2.i, %12     ; 3 uses
  %min.iters.check214 = icmp ult i64 %i.ql, 8
...
vector.ph215:                                     ; preds = %vector.memcheck203
  %n.vec216 = and i64 %i.ql, -8                   ; 3 uses
  %i.qu = add i64 %indvars.iv.i.2.i24, %n.vec216
  %broadcast.splatinsert217 = insertelement <8 x i32> poison, i32 %i.qk, i64 0
...
middle.block224:                                  ; preds = %vector.body219
  %cmp.n225 = icmp eq i64 %i.ql, %n.vec216
...
.lr.ph.preheader.i:                               ; preds = %._crit_edge.i, %.lr.ph47.i
  ...
  %13 = mul i64 %indvars.iv57.i, %i.vl
  %gep69.i = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep68.i, i64 %indvars.iv57.i
  %i.wk = load i16, ptr %gep69.i, align 2, !tbaa !12
  %i.wl = zext i16 %i.wk to i32                   ; 2 uses
  %wide.trip.count.i = zext i32 %indvars.iv55.i to i64 ; 2 uses
  %i.wm = sub i64 %wide.trip.count.i, %13         ; 3 uses
  %min.iters.check275 = icmp ult i64 %i.wm, 8
...
vector.ph276:                                     ; preds = %vector.memcheck264
  %n.vec277 = and i64 %i.wm, -8                   ; 3 uses
  %i.wu = add i64 %indvars.iv.i45, %n.vec277
  %broadcast.splatinsert278 = insertelement <8 x i32> poison, i32 %i.wl, i64 0
...
middle.block285:                                  ; preds = %vector.body280
  %cmp.n286 = icmp eq i64 %i.wm, %n.vec277
