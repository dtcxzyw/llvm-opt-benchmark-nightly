...
.lr.ph.epil.preheader:                            ; preds = %.preheader145.loopexit.unr-lcssa, %.lr.ph.preheader
  %.095147.epil.init = phi i64 [ 0, %.lr.ph.preheader ], [ %i.ax, %.preheader145.loopexit.unr-lcssa ] ; 2 uses
  %lcmp.mod194 = trunc i64 %i.aa to i1
  call void @llvm.assume(i1 %lcmp.mod194)
  %i.aj = urem i64 %.095147.epil.init, %3
  %i.ak = getelementptr inbounds nuw i8, ptr %2, i64 %i.aj
  %i.al = load i8, ptr %i.ak, align 1, !tbaa !20
  %i.am = getelementptr inbounds nuw i8, ptr %i.af, i64 %.095147.epil.init
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  %.095147 = phi i64 [ 0, %.lr.ph.preheader.new ], [ %i.ax, %.lr.ph ] ; 4 uses
  %niter = phi i64 [ 0, %.lr.ph.preheader.new ], [ %niter.next.1, %.lr.ph ]
  %i.ao = urem i64 %.095147, %3
  %i.ap = getelementptr inbounds nuw i8, ptr %2, i64 %i.ao
  %i.aq = load i8, ptr %i.ap, align 1, !tbaa !20
  %i.ar = getelementptr inbounds nuw i8, ptr %i.af, i64 %.095147
  store i8 %i.aq, ptr %i.ar, align 1, !tbaa !20
  %i.as = or disjoint i64 %.095147, 1             ; 2 uses
  ...
  %i.ax = add nuw i64 %.095147, 2                 ; 2 uses
...
.lr.ph149.epil.preheader:                         ; preds = %.preheader143.loopexit.unr-lcssa, %.lr.ph149.preheader
  %.094148.epil.init = phi i64 [ 0, %.lr.ph149.preheader ], [ %i.bq, %.preheader143.loopexit.unr-lcssa ] ; 2 uses
  ...
  %i.ba = urem i64 %.094148.epil.init, %i.az
...
.lr.ph149:                                        ; preds = %.lr.ph149, %.lr.ph149.preheader.new
  %.094148 = phi i64 [ 0, %.lr.ph149.preheader.new ], [ %i.bq, %.lr.ph149 ] ; 4 uses
  ...
  %i.bk = or disjoint i64 %.094148, 1             ; 2 uses
  ...
  %i.bq = add nuw i64 %.094148, 2                 ; 2 uses
...
.lr.ph188:                                        ; preds = %.lr.ph188.preheader, %._crit_edge160
  %.098162187 = phi ptr [ %i.ce, %._crit_edge160 ], [ %7, %.lr.ph188.preheader ] ; 2 uses
  %.096163186 = phi i64 [ %i.cf, %._crit_edge160 ], [ %6, %.lr.ph188.preheader ] ; 2 uses
...
bb.r:                                             ; preds = %bb.t
  %i.bu = add nuw i32 %.093151, 1                 ; 2 uses
...
.lr.ph152:                                        ; preds = %.preheader142, %bb.r
  %.093151 = phi i32 [ %i.bu, %bb.r ], [ 1, %.preheader142 ]
...
._crit_edge:                                      ; preds = %bb.r, %.preheader142
  ...
  %i.cc = call i64 @llvm.umin.i64(i64 %.096163186, i64 %i.cb) ; 3 uses
  %i.cd = icmp eq i32 %i.ca, 0
  br i1 %i.cd, label %_ZL14OPENSSL_memcpyPvPKvm.exit, label %bb.u

bb.u:                                             ; preds = %._crit_edge
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.098162187, ptr nonnull readonly align 16 %i.e, i64 %i.cc, i1 false)
  br label %_ZL14OPENSSL_memcpyPvPKvm.exit

_ZL14OPENSSL_memcpyPvPKvm.exit:                   ; preds = %._crit_edge, %bb.u
  %i.ce = getelementptr inbounds nuw i8, ptr %.098162187, i64 %i.cc
  %i.cf = sub i64 %.096163186, %i.cc              ; 2 uses
...
._crit_edge158.us:                                ; preds = %bb.w
  %i.cx = add i64 %.088159.us, %i.q               ; 2 uses
  %i.cy = icmp ult i64 %i.cx, %i.ad
  br i1 %i.cy, label %.preheader.us, label %._crit_edge160, !llvm.loop !26

.new:                                             ; preds = %bb.v, %.new
  %.089153 = phi i64 [ %i.di, %.new ], [ 0, %bb.v ] ; 4 uses
  %niter205 = phi i64 [ %niter205.next.1, %.new ], [ 0, %bb.v ]
  %i.cz = urem i64 %.089153, %i.cb
  %i.da = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.cz
  %i.db = load i8, ptr %i.da, align 1, !tbaa !20
  %i.dc = getelementptr inbounds nuw i8, ptr %i.g, i64 %.089153
  store i8 %i.db, ptr %i.dc, align 2, !tbaa !20
  %i.dd = or disjoint i64 %.089153, 1             ; 2 uses
  %i.de = urem i64 %i.dd, %i.cb
  %i.df = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.de
  %i.dg = load i8, ptr %i.df, align 1, !tbaa !20
  %i.dh = getelementptr inbounds nuw i8, ptr %i.g, i64 %i.dd
  store i8 %i.dg, ptr %i.dh, align 1, !tbaa !20
  %i.di = add nuw i64 %.089153, 2                 ; 2 uses
...
._crit_edge160:                                   ; preds = %._crit_edge158.us, %.preheader141
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #6
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f) #6
  %i.dj = call i32 @EVP_DigestInit_ex(ptr noundef nonnull %11, ptr noundef %8, ptr noundef null) #6
  %.not118 = icmp eq i32 %i.dj, 0
  br i1 %.not118, label %.thread133, label %.lr.ph188

.loopexit:                                        ; preds = %.preheader143, %.thread137, %.thread133, %bb.n, %bb.o, %bb.l
  %.1104 = phi ptr [ null, %bb.l ], [ null, %bb.n ], [ null, %bb.o ], [ %i.af, %.thread133 ], [ %i.af, %.thread137 ], [ %i.af, %.preheader143 ]
  %.1101 = phi i32 [ 0, %bb.l ], [ 0, %bb.n ], [ 0, %bb.o ], [ 0, %.thread133 ], [ 1, %.thread137 ], [ 1, %.preheader143 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #6
  br label %bb.x

bb.x:                                             ; preds = %_ZL22pkcs12_encode_passwordPKcmPPhPm.exit.thread, %_ZL22pkcs12_encode_passwordPKcmPPhPm.exit.thread128, %.loopexit
  %.2105 = phi ptr [ null, %_ZL22pkcs12_encode_passwordPKcmPPhPm.exit.thread ], [ %.1104, %.loopexit ], [ null, %_ZL22pkcs12_encode_passwordPKcmPPhPm.exit.thread128 ]
  %.2102 = phi i32 [ 0, %_ZL22pkcs12_encode_passwordPKcmPPhPm.exit.thread ], [ %.1101, %.loopexit ], [ 0, %_ZL22pkcs12_encode_passwordPKcmPPhPm.exit.thread128 ]
  call void @OPENSSL_free(ptr noundef %.2105) #6
  %i.dk = load ptr, ptr %i.b, align 8, !tbaa !11
  call void @OPENSSL_free(ptr noundef %i.dk) #6
  %i.dl = call i32 @EVP_MD_CTX_cleanup(ptr noundef nonnull %11) #6 ; 0 uses
