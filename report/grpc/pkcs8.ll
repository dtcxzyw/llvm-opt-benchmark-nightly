...
.lr.ph.epil.preheader:                            ; preds = %.preheader145.loopexit.unr-lcssa, %.lr.ph.preheader
  ...
  store i8 %i.al, ptr %i.am, align 1, !tbaa !27
...
.lr.ph149.epil.preheader:                         ; preds = %.preheader143.loopexit.unr-lcssa, %.lr.ph149.preheader
  ...
  %i.az = load i64, ptr %i.c, align 8, !tbaa !15
  ...
  store i8 %i.bc, ptr %gep.epil, align 1, !tbaa !27
...
.lr.ph149:                                        ; preds = %.lr.ph149, %.lr.ph149.preheader.new
  ...
  %i.bg = load i64, ptr %i.c, align 8, !tbaa !15
  ...
  store i8 %i.bj, ptr %gep, align 1, !tbaa !27
  %i.bk = or disjoint i64 %.092148, 1             ; 2 uses
  %i.bl = load ptr, ptr %i.b, align 8, !tbaa !13
  %i.bm = load i64, ptr %i.c, align 8, !tbaa !15
  ...
  store i8 %i.bp, ptr %gep.1, align 1, !tbaa !27
  ...
  br i1 %niter200.ncmp.1.not, label %.preheader143.loopexit.unr-lcssa, label %.lr.ph149, !llvm.loop !22
...
bb.r:                                             ; preds = %bb.t
  ...
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph152, !llvm.loop !23
...
.epil.preheader:                                  ; preds = %.preheader141.unr-lcssa, %bb.v
  ...
  store i8 %i.cj, ptr %i.ck, align 1, !tbaa !27
...
bb.w:                                             ; preds = %.preheader.us, %bb.w
  ...
  store i8 %i.cu, ptr %i.cm, align 1, !tbaa !27
  %i.cv = lshr i32 %i.ct, 8
  %.0.us = add i64 %.0156.us, -1                  ; 2 uses
  %i.cw = icmp ult i64 %.0.us, %i.q
  br i1 %i.cw, label %bb.w, label %._crit_edge158.us, !llvm.loop !24
