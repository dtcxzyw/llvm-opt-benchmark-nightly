...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  call void @_ZN4absl12lts_2025051218container_internal12raw_hash_setINS1_17FlatHashMapPolicyISt4pairIiiEbEENS0_13hash_internal4HashIS5_EESt8equal_toIS5_ESaIS4_IKS5_bEEED2Ev(ptr noundef nonnull align 8 dead_on_return(32) dereferenceable(32) %i.bl) #40
  %i.br = load ptr, ptr %i.bk, align 8, !tbaa !165 ; 2 uses
...
bb.r:                                             ; preds = %_ZNSt6vectorIiSaIiEE6assignEmRKi.exit.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #40
  %i.bv = load ptr, ptr %i.ba, align 8, !tbaa !165 ; 2 uses
...
_ZNSt14_Function_baseD2Ev.exit:                   ; preds = %bb.r, %bb.s
  ...
  %i.ca = load i32, ptr %11, align 8, !tbaa !701  ; 3 uses
...
_ZNSt6vectorIbSaIbEEC2EmRKS0_.exit.us.i:          ; preds = %_ZNSt6vectorIbSaIbEEC2EmRKS0_.exit.lr.ph.i, %_ZNSt13_Bvector_baseISaIbEED2Ev.exit.us.i
  %i.cf = phi i32 [ %i.cv, %_ZNSt13_Bvector_baseISaIbEED2Ev.exit.us.i ], [ %i.ca, %_ZNSt6vectorIbSaIbEEC2EmRKS0_.exit.lr.ph.i ] ; 3 uses
  %.02040.us.i = phi i32 [ %i.cu, %_ZNSt13_Bvector_baseISaIbEED2Ev.exit.us.i ], [ 0, %_ZNSt6vectorIbSaIbEEC2EmRKS0_.exit.lr.ph.i ] ; 2 uses
...
.noexc:                                           ; preds = %_ZNSt6vectorIbSaIbEEC2EmRKS0_.exit.us.i
  %i.cl = lshr i64 %i.ch, 6                       ; 3 uses
  %i.cm = getelementptr inbounds nuw [8 x i8], ptr %i.ck, i64 %i.cl
  store ptr %i.cm, ptr %i.ce, align 8, !tbaa !705
  store ptr %i.ck, ptr %9, align 8
  store i32 0, ptr %i.cb, align 8
  %i.cn = sdiv i32 %i.cf, 64
  %.sext.us.i = sext i32 %i.cn to i64
  %i.co = getelementptr inbounds [8 x i8], ptr %i.ck, i64 %.sext.us.i
  %i.cp = and i64 %i.cg, -9223372036854775745
  %i.cq = icmp ugt i64 %i.cp, -9223372036854775808
  %storemerge.idx.i.i.i.i.i.i.us.i = select i1 %i.cq, i64 -8, i64 0
  %storemerge.i.i.i.i.i.i.us.i = getelementptr inbounds i8, ptr %i.co, i64 %storemerge.idx.i.i.i.i.i.i.us.i
  %i.cr = and i32 %i.cf, 63
  store ptr %storemerge.i.i.i.i.i.i.us.i, ptr %i.cc, align 8
  store i32 %i.cr, ptr %i.cd, align 8
  %.idx.i.i.us.i = shl nuw nsw i64 %i.cl, 3       ; 2 uses
  call void @llvm.memset.p0.i64(ptr nonnull align 8 %i.ck, i8 0, i64 %.idx.i.i.us.i, i1 false)
  %i.cs = invoke fastcc noundef zeroext i1 @_ZN6google8protobuf4util12_GLOBAL__N_114MaximumMatcher19FindArgumentPathDFSEiPSt6vectorIbSaIbEE(ptr noundef nonnull align 8 dereferenceable(88) %11, i32 noundef %.02040.us.i, ptr noundef %9)
...
_ZNSt13_Bvector_baseISaIbEED2Ev.exit.us.i:        ; preds = %.noexc
  ...
  %.2.us.i = add nuw nsw i32 %.02139.us.i, %i.ct  ; 2 uses
  call void @_ZdlPvm(ptr noundef nonnull %i.ck, i64 noundef %.idx.i.i.us.i) #42
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #40
  %i.cu = add nuw nsw i32 %.02040.us.i, 1         ; 2 uses
  %i.cv = load i32, ptr %11, align 8, !tbaa !701  ; 2 uses
  %.not.us.i = icmp slt i32 %i.cu, %i.cv
  br i1 %.not.us.i, label %_ZNSt6vectorIbSaIbEEC2EmRKS0_.exit.us.i, label %.preheader.i, !llvm.loop !695

.split.us.i:                                      ; preds = %.noexc
  %i.cw = landingpad { ptr, i32 }
          cleanup
  %i.cx = getelementptr inbounds nuw [8 x i8], ptr %i.ck, i64 %i.cl
  br label %.body.i

bb.u:                                             ; preds = %_ZNSt13_Bvector_baseISaIbEED2Ev.exit.i
  %i.cy = add nuw nsw i32 %.02040.i, 1            ; 3 uses
  %i.cz = load i32, ptr %11, align 8, !tbaa !701  ; 2 uses
  %.not.i170 = icmp slt i32 %i.cy, %i.cz
  br i1 %.not.i170, label %_ZNSt6vectorIbSaIbEEC2EmRKS0_.exit.i, label %.preheader.i, !llvm.loop !695

.preheader.i:                                     ; preds = %_ZNSt13_Bvector_baseISaIbEED2Ev.exit.us.i, %bb.u, %_ZNSt14_Function_baseD2Ev.exit
  %.021.lcssa.i = phi i32 [ 0, %_ZNSt14_Function_baseD2Ev.exit ], [ %i.cy, %bb.u ], [ %.2.us.i, %_ZNSt13_Bvector_baseISaIbEED2Ev.exit.us.i ] ; 2 uses
  %i.da = load i32, ptr %i.bh, align 4, !tbaa !262 ; 2 uses
  %i.db = icmp sgt i32 %i.da, 0
  br i1 %i.db, label %.lr.ph.i, label %_ZN6google8protobuf4util12_GLOBAL__N_114MaximumMatcher16FindMaximumMatchEb.exit

.lr.ph.i:                                         ; preds = %.preheader.i
  %i.dc = load ptr, ptr %i.bn, align 8, !tbaa !264
  %i.dd = load ptr, ptr %i.dc, align 8, !tbaa !26
  %i.de = load ptr, ptr %i.bm, align 8
  br label %bb.v

_ZNSt6vectorIbSaIbEEC2EmRKS0_.exit.i:             ; preds = %_ZNSt6vectorIbSaIbEEC2EmRKS0_.exit.lr.ph.i, %bb.u
  %i.df = phi i32 [ %i.cz, %bb.u ], [ %i.ca, %_ZNSt6vectorIbSaIbEEC2EmRKS0_.exit.lr.ph.i ] ; 3 uses
...
.noexc171:                                        ; preds = %_ZNSt6vectorIbSaIbEEC2EmRKS0_.exit.i
  %i.dl = lshr i64 %i.dh, 6                       ; 3 uses
  %i.dm = getelementptr inbounds nuw [8 x i8], ptr %i.dk, i64 %i.dl
  store ptr %i.dm, ptr %i.ce, align 8, !tbaa !705
  store ptr %i.dk, ptr %9, align 8
  store i32 0, ptr %i.cb, align 8
  %i.dn = sdiv i32 %i.df, 64
  %.sext.i = sext i32 %i.dn to i64
  %i.do = getelementptr inbounds [8 x i8], ptr %i.dk, i64 %.sext.i
  %i.dp = and i64 %i.dg, -9223372036854775745
  %i.dq = icmp ugt i64 %i.dp, -9223372036854775808
  %storemerge.idx.i.i.i.i.i.i.i = select i1 %i.dq, i64 -8, i64 0
  %storemerge.i.i.i.i.i.i.i = getelementptr inbounds i8, ptr %i.do, i64 %storemerge.idx.i.i.i.i.i.i.i
  %i.dr = and i32 %i.df, 63
  store ptr %storemerge.i.i.i.i.i.i.i, ptr %i.cc, align 8
  store i32 %i.dr, ptr %i.cd, align 8
  %.idx.i.i.i = shl nuw nsw i64 %i.dl, 3          ; 2 uses
  call void @llvm.memset.p0.i64(ptr nonnull align 8 %i.dk, i8 0, i64 %.idx.i.i.i, i1 false)
  %i.ds = invoke fastcc noundef zeroext i1 @_ZN6google8protobuf4util12_GLOBAL__N_114MaximumMatcher19FindArgumentPathDFSEiPSt6vectorIbSaIbEE(ptr noundef nonnull align 8 dereferenceable(88) %11, i32 noundef %.02040.i, ptr noundef %9)
...
_ZNSt13_Bvector_baseISaIbEED2Ev.exit.i:           ; preds = %.noexc171
  call void @_ZdlPvm(ptr noundef nonnull %i.dk, i64 noundef %.idx.i.i.i) #42
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #40
  br i1 %i.ds, label %bb.u, label %_ZN6google8protobuf4util12_GLOBAL__N_114MaximumMatcher16FindMaximumMatchEb.exit

.split.i:                                         ; preds = %.noexc171
  %i.dt = landingpad { ptr, i32 }
          cleanup
  %i.du = getelementptr inbounds nuw [8 x i8], ptr %i.dk, i64 %i.dl
  br label %.body.i

.body.i:                                          ; preds = %.split.i, %.split.us.i
  %.us-phi.i = phi ptr [ %i.du, %.split.i ], [ %i.cx, %.split.us.i ] ; 2 uses
  %.us-phi41.i = phi ptr [ %i.dk, %.split.i ], [ %i.ck, %.split.us.i ]
  %.us-phi42.i = phi { ptr, i32 } [ %i.dt, %.split.i ], [ %i.cw, %.split.us.i ]
  %i.dv = ptrtoint ptr %.us-phi.i to i64
  %i.dw = ptrtoint ptr %.us-phi41.i to i64
  %i.dx = sub i64 %i.dv, %i.dw                    ; 2 uses
  %i.dy = ashr exact i64 %i.dx, 3
  %i.dz = sub nsw i64 0, %i.dy
  %i.ea = getelementptr inbounds [8 x i8], ptr %.us-phi.i, i64 %i.dz
  call void @_ZdlPvm(ptr noundef %i.ea, i64 noundef %i.dx) #42
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #40
  br label %.body172

bb.v:                                             ; preds = %bb.x, %.lr.ph.i
  %i.eb = phi i32 [ %i.da, %.lr.ph.i ], [ %i.ei, %bb.x ]
  %indvars.iv.i = phi i64 [ 0, %.lr.ph.i ], [ %indvars.iv.next.i, %bb.x ] ; 3 uses
  %i.ec = getelementptr inbounds nuw [4 x i8], ptr %i.dd, i64 %indvars.iv.i
  %i.ed = load i32, ptr %i.ec, align 4, !tbaa !27 ; 2 uses
  %.not28.i = icmp eq i32 %i.ed, -1
  br i1 %.not28.i, label %bb.x, label %bb.w

bb.w:                                             ; preds = %bb.v
  %i.ee = sext i32 %i.ed to i64
  %i.ef = load ptr, ptr %i.de, align 8, !tbaa !26
  %i.eg = getelementptr inbounds nuw [4 x i8], ptr %i.ef, i64 %i.ee
  %i.eh = trunc nuw nsw i64 %indvars.iv.i to i32
  store i32 %i.eh, ptr %i.eg, align 4, !tbaa !27
  %.pre.i = load i32, ptr %i.bh, align 4, !tbaa !262
  br label %bb.x

bb.x:                                             ; preds = %bb.w, %bb.v
  %i.ei = phi i32 [ %i.eb, %bb.v ], [ %.pre.i, %bb.w ] ; 2 uses
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %i.ej = sext i32 %i.ei to i64
  %i.ek = icmp slt i64 %indvars.iv.next.i, %i.ej
  br i1 %i.ek, label %bb.v, label %_ZN6google8protobuf4util12_GLOBAL__N_114MaximumMatcher16FindMaximumMatchEb.exit, !llvm.loop !696
...
_ZN6google8protobuf4util12_GLOBAL__N_114MaximumMatcher16FindMaximumMatchEb.exit: ; preds = %_ZNSt13_Bvector_baseISaIbEED2Ev.exit.i, %bb.x, %.preheader.i
  ...
  %i.el = icmp ne i32 %.326.i, %i.l
  %or.cond8 = and i1 %i.bz, %i.el
  %i.em = icmp eq i32 %.326.i, %i.l
  %i.en = load i64, ptr %i.bl, align 8, !tbaa !119 ; 3 uses
  %i.eo = icmp ne i64 %i.en, 0
  call void @llvm.assume(i1 %i.eo)
  %i.ep = icmp ult i64 %i.en, 2
  br i1 %i.ep, label %_ZN4absl12lts_2025051218container_internal12raw_hash_setINS1_17FlatHashMapPolicyISt4pairIiiEbEENS0_13hash_internal4HashIS5_EESt8equal_toIS5_ESaIS4_IKS5_bEEED2Ev.exit.i, label %bb.y

bb.y:                                             ; preds = %_ZN6google8protobuf4util12_GLOBAL__N_114MaximumMatcher16FindMaximumMatchEb.exit
  %i.eq = getelementptr inbounds nuw i8, ptr %11, i64 56
  %i.er = load ptr, ptr %i.eq, align 8, !tbaa !121
  %i.es = load i64, ptr %.sroa.4.0..sroa_idx.i.i.i.i, align 8, !tbaa !120
  %i.et = and i64 %i.es, 65536
  %i.eu = icmp ne i64 %i.et, 0
  invoke void @_ZN4absl12lts_2025051218container_internal22DeallocateBackingArrayILm8ESaIcEEEvPvmPNS1_6ctrl_tEmmb(ptr noundef nonnull align 8 dereferenceable(32) %i.bl, i64 noundef %i.en, ptr noundef %i.er, i64 noundef 12, i64 noundef 4, i1 noundef zeroext %i.eu)
...
bb.z:                                             ; preds = %bb.y
  ...
  call void @__clang_call_terminate(ptr %i.ew) #43
  unreachable
...
_ZN4absl12lts_2025051218container_internal12raw_hash_setINS1_17FlatHashMapPolicyISt4pairIiiEbEENS0_13hash_internal4HashIS5_EESt8equal_toIS5_ESaIS4_IKS5_bEEED2Ev.exit.i: ; preds = %bb.y, %_ZN6google8protobuf4util12_GLOBAL__N_114MaximumMatcher16FindMaximumMatchEb.exit
  %i.ex = load ptr, ptr %i.bk, align 8, !tbaa !165 ; 2 uses
  %.not.i.i174 = icmp eq ptr %i.ex, null
...
bb.aa:                                            ; preds = %_ZN4absl12lts_2025051218container_internal12raw_hash_setINS1_17FlatHashMapPolicyISt4pairIiiEbEENS0_13hash_internal4HashIS5_EESt8equal_toIS5_ESaIS4_IKS5_bEEED2Ev.exit.i
  %i.ey = invoke noundef zeroext i1 %i.ex(ptr noundef nonnull align 8 dereferenceable(32) %i.bi, ptr noundef nonnull align 8 dereferenceable(32) %i.bi, i32 noundef 3)
...
bb.ab:                                            ; preds = %bb.aa
  ...
  call void @__clang_call_terminate(ptr %i.fa) #43
  unreachable
...
.body168:                                         ; preds = %bb.o, %bb.p
  %i.fb = load ptr, ptr %i.ba, align 8, !tbaa !165 ; 2 uses
  %.not.i176 = icmp eq ptr %i.fb, null
  br i1 %.not.i176, label %.body, label %bb.ac

bb.ac:                                            ; preds = %.body168
  %i.fc = invoke noundef zeroext i1 %i.fb(ptr noundef nonnull align 8 dereferenceable(32) %12, ptr noundef nonnull align 8 dereferenceable(32) %12, i32 noundef 3)
...
bb.ad:                                            ; preds = %bb.ac
  ...
  call void @__clang_call_terminate(ptr %i.fe) #43
  unreachable
...
bb.ae:                                            ; preds = %_ZNSt6vectorIiSaIiEE6assignEmRKi.exit
  %i.ff = load ptr, ptr %i.f, align 8, !tbaa !114
  %i.fg = invoke noundef zeroext i1 @_ZN6google8protobuf4util18MessageDifferencer14IsTreatedAsSetEPKNS0_15FieldDescriptorE(ptr noundef nonnull align 8 dereferenceable(408) %0, ptr noundef %i.ff)
          to label %bb.af unwind label %bb.aj

bb.af:                                            ; preds = %bb.ae
  %or.cond10 = or i1 %i.p, %i.fg
  br i1 %or.cond10, label %bb.ai, label %bb.ag

bb.ag:                                            ; preds = %bb.af
  %i.fh = load ptr, ptr %i.f, align 8, !tbaa !114
  %i.fi = invoke noundef zeroext i1 @_ZN6google8protobuf4util18MessageDifferencer20IsTreatedAsSmartListEPKNS0_15FieldDescriptorE(ptr noundef nonnull align 8 dereferenceable(408) %0, ptr noundef %i.fh)
          to label %bb.ah unwind label %bb.aj

bb.ah:                                            ; preds = %bb.ag
  br i1 %i.fi, label %bb.ai, label %.loopexit311

bb.ai:                                            ; preds = %bb.ah, %bb.af
  %.sroa.speculated = call i32 @llvm.smin.i32(i32 %i.o, i32 %i.l) ; 4 uses
  %i.fj = icmp sgt i32 %.sroa.speculated, 0
  br i1 %i.fj, label %.lr.ph, label %.loopexit311
...
bb.ak:                                            ; preds = %.lr.ph, %bb.ao
  ...
  %i.fn = load ptr, ptr %i.f, align 8, !tbaa !114
  %i.fo = load ptr, ptr %i.g, align 8, !tbaa !174
  %i.fp = load i32, ptr %i.e, align 4, !tbaa !27
  %i.fq = trunc nuw nsw i64 %indvars.iv to i32    ; 5 uses
  %i.fr = invoke noundef zeroext i1 @_ZN6google8protobuf4util18MessageDifferencer7IsMatchEPKNS0_15FieldDescriptorEPKNS2_16MapKeyComparatorEPKNS0_7MessageESB_iRKSt6vectorINS2_13SpecificFieldESaISD_EEPNS2_8ReporterEii(ptr noundef nonnull align 8 dereferenceable(408) %0, ptr noundef %i.fn, ptr noundef %i.fo, ptr noundef nonnull %1, ptr noundef nonnull %2, i32 noundef %i.fp, ptr noundef nonnull align 8 dereferenceable(24) %6, ptr noundef null, i32 noundef %i.fq, i32 noundef %i.fq)
