...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.z, label %middle.block.a, label %vector.body, !llvm.loop !71
...
scalar.ph:                                        ; preds = %scalar.ph.preheader.a, %scalar.ph
  ...
  br i1 %3, label %scalar.ph, label %._crit_edge, !llvm.loop !74
...
bb.e:                                             ; preds = %bb.b, %bb.c, %._crit_edge
  ...
  store i32 %i.ah, ptr %i.af, align 8, !tbaa !75
  ret void
}
...
._crit_edge:                                      ; preds = %"_ZZN6google8protobuf8internal20RepeatedPtrFieldBase17MergeFromInternalINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEZNS2_9MergeFromIS9_EEvRKS2_PNS0_5ArenaEE3$_0EEvSC_SE_OT0_ENKUlSE_RKS9_E_clB5cxx11ESE_SJ_.exit", %.preheader37
  store i32 %i.r, ptr %i.n, align 8, !tbaa !75
...
.lr.ph:                                           ; preds = %bb.h, %.lr.ph
  ...
  br i1 %i.bp, label %.lr.ph, label %.loopexit, !llvm.loop !93
...
.lr.ph48:                                         ; preds = %.loopexit, %.lr.ph48
  ...
  br i1 %i.bv, label %.lr.ph48, label %._crit_edge, !llvm.loop !94

._crit_edge:                                      ; preds = %.lr.ph48, %.loopexit
  store i32 %i.r, ptr %i.l, align 8, !tbaa !75
...
._crit_edge:                                      ; preds = %bb.f, %.preheader
  store i32 %i.ab, ptr %i.x, align 8, !tbaa !75
...
bb.b:                                             ; preds = %.split
  ...
  %i.k = tail call noundef ptr %i.j(ptr noundef %1, ptr noundef %i.e, ptr noundef nonnull %3), !inline_history !103
...
.lr.ph64.i:                                       ; preds = %.preheader.i, %.lr.ph64.i
  ...
  tail call void asm sideeffect "prefetchw $0", "*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i8) %i.aa) #16, !srcloc !104
  ...
  br i1 %i.ac, label %.lr.ph64.i, label %._crit_edge65.i, !llvm.loop !105
...
.lr.ph.i:                                         ; preds = %.preheader61.i, %.lr.ph.i
  ...
  tail call void asm sideeffect "prefetchw $0", "*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i8) %i.ax) #16, !srcloc !104
  ...
  br i1 %i.az, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !106
...
bb.m:                                             ; preds = %.split8
  ...
  %i.bi = tail call noundef ptr %i.bh(ptr noundef %1, ptr noundef nonnull %i.bc, ptr noundef null), !inline_history !103
  br label %_ZNK6google8protobuf8internal14MessageCreator12PlacementNewINS0_11MessageLiteEEEPT_PKS5_S8_PvPNS0_5ArenaE.exit
...
.lr.ph64.i16:                                     ; preds = %.preheader.i14, %.lr.ph64.i16
  ...
  tail call void asm sideeffect "prefetchw $0", "*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i8) %i.by) #16, !srcloc !104
  ...
  br i1 %i.ca, label %.lr.ph64.i16, label %._crit_edge65.i15, !llvm.loop !105
...
.lr.ph.i12:                                       ; preds = %.preheader61.i9, %.lr.ph.i12
  ...
  tail call void asm sideeffect "prefetchw $0", "*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i8) %i.cv) #16, !srcloc !104
  ...
  br i1 %i.cx, label %.lr.ph.i12, label %._crit_edge.i10, !llvm.loop !106
...
!81 = distinct !{!81, !70}
!82 = !{!83, !83, i64 0}
!83 = !{!"p1 _ZTSN6google8protobuf11MessageLiteE", !13, i64 0}
!84 = distinct !{null}
!85 = !{!86, !13, i64 24}
!86 = !{!"_ZTSN6google8protobuf8internal9ClassDataE", !83, i64 0, !87, i64 8, !13, i64 16, !13, i64 24, !88, i64 32, !5, i64 48, !90, i64 52, !90, i64 53}
!87 = !{!"p1 _ZTSN6google8protobuf8internal16TcParseTableBaseE", !13, i64 0}
!88 = !{!"_ZTSN6google8protobuf8internal14MessageCreatorE", !5, i64 0, !89, i64 4, !6, i64 5, !13, i64 8}
!89 = !{!"_ZTSN6google8protobuf8internal14MessageCreator3TagE", !6, i64 0}
!90 = !{!"bool", !6, i64 0}
!91 = distinct !{null}
!92 = distinct !{!92, !70}
!93 = distinct !{!93, !70}
