Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/grpc/original/str_cat?download=true
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.b
  %i.u = load i64, ptr %i.a, align 8, !tbaa !15
  %i.v = add i64 %i.u, 1
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  %.03044 = phi ptr [ %1, %.lr.ph.preheader.new ], [ %i.w, %.lr.ph ] ; 9 uses
  %.03143 = phi i64 [ 0, %.lr.ph.preheader.new ], [ %i.v, %.lr.ph ]
  %niter = phi i64 [ 0, %.lr.ph.preheader.new ], [ %niter.next.7, %.lr.ph ]
  %.sroa.035.0.copyload = load i64, ptr %.03044, align 8, !tbaa !19
  %i.h = add i64 %.sroa.035.0.copyload, %.03143
  %i.i = getelementptr inbounds nuw i8, ptr %.03044, i64 16
  %.sroa.035.0.copyload.1 = load i64, ptr %i.i, align 8, !tbaa !19
  %i.j = add i64 %.sroa.035.0.copyload.1, %i.h
  %i.k = getelementptr inbounds nuw i8, ptr %.03044, i64 32
  %.sroa.035.0.copyload.2 = load i64, ptr %i.k, align 8, !tbaa !19
  %i.l = add i64 %.sroa.035.0.copyload.2, %i.j
  %i.m = getelementptr inbounds nuw i8, ptr %.03044, i64 48
  %.sroa.035.0.copyload.3 = load i64, ptr %i.m, align 8, !tbaa !19
  %i.n = add i64 %.sroa.035.0.copyload.3, %i.l
  %i.o = getelementptr inbounds nuw i8, ptr %.03044, i64 64
  %.sroa.035.0.copyload.4 = load i64, ptr %i.o, align 8, !tbaa !19
  %i.p = add i64 %.sroa.035.0.copyload.4, %i.n
  %i.q = getelementptr inbounds nuw i8, ptr %.03044, i64 80
  %.sroa.035.0.copyload.5 = load i64, ptr %i.q, align 8, !tbaa !19
  %i.r = add i64 %.sroa.035.0.copyload.5, %i.p
  %i.s = getelementptr inbounds nuw i8, ptr %.03044, i64 96
  %.sroa.035.0.copyload.6 = load i64, ptr %i.s, align 8, !tbaa !19
  %i.t = add i64 %.sroa.035.0.copyload.6, %i.r
  %i.u = getelementptr inbounds nuw i8, ptr %.03044, i64 112
  %.sroa.035.0.copyload.7 = load i64, ptr %i.u, align 8, !tbaa !19
  %i.v = add i64 %.sroa.035.0.copyload.7, %i.t    ; 3 uses
  %i.w = getelementptr inbounds nuw i8, ptr %.03044, i64 128 ; 2 uses
...
.lr.ph.epil.preheader:                            ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.preheader
  %.03044.epil.init = phi ptr [ %1, %.lr.ph.preheader ], [ %i.w, %._crit_edge.loopexit.unr-lcssa ]
  %.03143.epil.init = phi i64 [ 0, %.lr.ph.preheader ], [ %i.v, %._crit_edge.loopexit.unr-lcssa ]
  %lcmp.mod53 = icmp ne i64 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod53)
  br label %.lr.ph.epil

.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  %.03044.epil = phi ptr [ %i.y, %.lr.ph.epil ], [ %.03044.epil.init, %.lr.ph.epil.preheader ] ; 2 uses
  %.03143.epil = phi i64 [ %i.x, %.lr.ph.epil ], [ %.03143.epil.init, %.lr.ph.epil.preheader ]
  %epil.iter = phi i64 [ %epil.iter.next, %.lr.ph.epil ], [ 0, %.lr.ph.epil.preheader ]
  %.sroa.035.0.copyload.epil = load i64, ptr %.03044.epil, align 8, !tbaa !19
  %i.x = add i64 %.sroa.035.0.copyload.epil, %.03143.epil ; 2 uses
  %i.y = getelementptr inbounds nuw i8, ptr %.03044.epil, i64 16
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %._crit_edge, label %.lr.ph.epil, !llvm.loop !22

._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.epil, %bb.a
  %.031.lcssa = phi i64 [ 0, %bb.a ], [ %i.v, %._crit_edge.loopexit.unr-lcssa ], [ %i.x, %.lr.ph.epil ]
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6resizeEmc(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %.031.lcssa, i8 noundef signext 0)
...
.lr.ph48.preheader:                               ; preds = %_ZN4absl12lts_2025051216strings_internal28STLStringResizeUninitializedINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEvEEvPT_m.exit
  %i.z = load ptr, ptr %0, align 8, !tbaa !18     ; 4 uses
...
.lr.ph48.prol:                                    ; preds = %.lr.ph48.preheader
  %.sroa.0.0.copyload.prol = load i64, ptr %1, align 8, !tbaa !19 ; 3 uses
...
bb.b:                                             ; preds = %.lr.ph48.prol
  %.sroa.4.0..0.sroa_idx.prol = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.sroa.4.0.copyload.prol = load ptr, ptr %.sroa.4.0..0.sroa_idx.prol, align 8, !tbaa !21
...
.lr.ph48.prol.loopexit:                           ; preds = %.lr.ph48.prol.loopexit.unr-lcssa, %.lr.ph48.preheader
  %.047.unr = phi ptr [ %1, %.lr.ph48.preheader ], [ %i.ad, %.lr.ph48.prol.loopexit.unr-lcssa ]
  %.02346.unr = phi ptr [ %i.z, %.lr.ph48.preheader ], [ %.1.prol, %.lr.ph48.prol.loopexit.unr-lcssa ]
...
bb.c:                                             ; preds = %._crit_edge
  %i.af = landingpad { ptr, i32 }
          cleanup
  %i.ag = load ptr, ptr %0, align 8, !tbaa !18    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.c
  %i.ai = load i64, ptr %i.a, align 8, !tbaa !15
  %i.aj = add i64 %i.ai, 1
...
.lr.ph48:                                         ; preds = %.lr.ph48.prol.loopexit, %bb.f
  %.047 = phi ptr [ %i.an, %bb.f ], [ %.047.unr, %.lr.ph48.prol.loopexit ] ; 5 uses
  %.02346 = phi ptr [ %.1.1, %bb.f ], [ %.02346.unr, %.lr.ph48.prol.loopexit ] ; 3 uses
  %.sroa.0.0.copyload = load i64, ptr %.047, align 8, !tbaa !19 ; 3 uses
  %.not34 = icmp eq i64 %.sroa.0.0.copyload, 0
  br i1 %.not34, label %.lr.ph48.1, label %bb.d

bb.d:                                             ; preds = %.lr.ph48
  %.sroa.4.0..0.sroa_idx = getelementptr inbounds nuw i8, ptr %.047, i64 8
  %.sroa.4.0.copyload = load ptr, ptr %.sroa.4.0..0.sroa_idx, align 8, !tbaa !21
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.02346, ptr align 1 %.sroa.4.0.copyload, i64 %.sroa.0.0.copyload, i1 false)
  %i.ak = getelementptr inbounds nuw i8, ptr %.02346, i64 %.sroa.0.0.copyload
  br label %.lr.ph48.1

.lr.ph48.1:                                       ; preds = %bb.d, %.lr.ph48
  %.1 = phi ptr [ %i.ak, %bb.d ], [ %.02346, %.lr.ph48 ] ; 3 uses
  %i.al = getelementptr inbounds nuw i8, ptr %.047, i64 16
  %.sroa.0.0.copyload.1 = load i64, ptr %i.al, align 8, !tbaa !19 ; 3 uses
  %.not34.1 = icmp eq i64 %.sroa.0.0.copyload.1, 0
  br i1 %.not34.1, label %bb.f, label %bb.e

bb.e:                                             ; preds = %.lr.ph48.1
  %.sroa.4.0..0.sroa_idx.1 = getelementptr inbounds nuw i8, ptr %.047, i64 24
  %.sroa.4.0.copyload.1 = load ptr, ptr %.sroa.4.0..0.sroa_idx.1, align 8, !tbaa !21
...
bb.f:                                             ; preds = %bb.e, %.lr.ph48.1
  ...
  %i.an = getelementptr inbounds nuw i8, ptr %.047, i64 32 ; 2 uses
...
.lr.ph.preheader:                                 ; preds = %bb.a
  %i.b = add i64 %.idx, -16                       ; 4 uses
  %i.c = lshr exact i64 %i.b, 4
  %i.d = add nuw nsw i64 %i.c, 1                  ; 2 uses
  %xtraiter = and i64 %i.d, 7                     ; 3 uses
  %i.e = icmp ult i64 %i.b, 112
  br i1 %i.e, label %.lr.ph.epil.preheader, label %.lr.ph.preheader.new

.lr.ph.preheader.new:                             ; preds = %.lr.ph.preheader
  %unroll_iter = and i64 %i.d, 2305843009213693944
  br label %.lr.ph
...
.lr.ph.epil.preheader:                            ; preds = %.lr.ph43.preheader.unr-lcssa, %.lr.ph.preheader
  %.02438.epil.init = phi ptr [ %1, %.lr.ph.preheader ], [ %i.ae, %.lr.ph43.preheader.unr-lcssa ]
  %.02537.epil.init = phi i64 [ 0, %.lr.ph.preheader ], [ %i.ad, %.lr.ph43.preheader.unr-lcssa ]
  %lcmp.mod47 = icmp ne i64 %xtraiter, 0
  tail call void @llvm.assume(i1 %lcmp.mod47)
  br label %.lr.ph.epil

.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  %.02438.epil = phi ptr [ %i.h, %.lr.ph.epil ], [ %.02438.epil.init, %.lr.ph.epil.preheader ] ; 2 uses
  %.02537.epil = phi i64 [ %i.g, %.lr.ph.epil ], [ %.02537.epil.init, %.lr.ph.epil.preheader ]
  %epil.iter = phi i64 [ %epil.iter.next, %.lr.ph.epil ], [ 0, %.lr.ph.epil.preheader ]
  %.sroa.029.0.copyload.epil = load i64, ptr %.02438.epil, align 8, !tbaa !19
  %i.g = add i64 %.sroa.029.0.copyload.epil, %.02537.epil ; 2 uses
  %i.h = getelementptr inbounds nuw i8, ptr %.02438.epil, i64 16
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %.lr.ph43.preheader, label %.lr.ph.epil, !llvm.loop !23
...
bb.b:                                             ; preds = %.lr.ph43.prol
  %.sroa.4.0..0.sroa_idx.prol = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.sroa.4.0.copyload.prol = load ptr, ptr %.sroa.4.0..0.sroa_idx.prol, align 8, !tbaa !21
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.k, ptr align 1 %.sroa.4.0.copyload.prol, i64 %.sroa.0.0.copyload.prol, i1 false)
  %i.m = getelementptr inbounds nuw i8, ptr %i.k, i64 %.sroa.0.0.copyload.prol
  br label %.lr.ph43.prol.loopexit.unr-lcssa

.lr.ph43.prol.loopexit.unr-lcssa:                 ; preds = %bb.b, %.lr.ph43.prol
  %.1.prol = phi ptr [ %i.m, %bb.b ], [ %i.k, %.lr.ph43.prol ]
  %i.n = getelementptr inbounds nuw i8, ptr %1, i64 16
  br label %.lr.ph43.prol.loopexit

.lr.ph43.prol.loopexit:                           ; preds = %.lr.ph43.prol.loopexit.unr-lcssa, %.lr.ph43.preheader
  %.041.unr = phi ptr [ %1, %.lr.ph43.preheader ], [ %i.n, %.lr.ph43.prol.loopexit.unr-lcssa ]
  %.02340.unr = phi ptr [ %i.k, %.lr.ph43.preheader ], [ %.1.prol, %.lr.ph43.prol.loopexit.unr-lcssa ]
  %i.o = icmp eq i64 %i.b, 0
  br i1 %i.o, label %._crit_edge44, label %.lr.ph43

.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  %.02438 = phi ptr [ %1, %.lr.ph.preheader.new ], [ %i.ae, %.lr.ph ] ; 9 uses
  %.02537 = phi i64 [ 0, %.lr.ph.preheader.new ], [ %i.ad, %.lr.ph ]
  %niter = phi i64 [ 0, %.lr.ph.preheader.new ], [ %niter.next.7, %.lr.ph ]
  %.sroa.029.0.copyload = load i64, ptr %.02438, align 8, !tbaa !19
  %i.p = add i64 %.sroa.029.0.copyload, %.02537
  %i.q = getelementptr inbounds nuw i8, ptr %.02438, i64 16
  %.sroa.029.0.copyload.1 = load i64, ptr %i.q, align 8, !tbaa !19
  %i.r = add i64 %.sroa.029.0.copyload.1, %i.p
  %i.s = getelementptr inbounds nuw i8, ptr %.02438, i64 32
  %.sroa.029.0.copyload.2 = load i64, ptr %i.s, align 8, !tbaa !19
  %i.t = add i64 %.sroa.029.0.copyload.2, %i.r
  %i.u = getelementptr inbounds nuw i8, ptr %.02438, i64 48
  %.sroa.029.0.copyload.3 = load i64, ptr %i.u, align 8, !tbaa !19
  %i.v = add i64 %.sroa.029.0.copyload.3, %i.t
  %i.w = getelementptr inbounds nuw i8, ptr %.02438, i64 64
  %.sroa.029.0.copyload.4 = load i64, ptr %i.w, align 8, !tbaa !19
  %i.x = add i64 %.sroa.029.0.copyload.4, %i.v
  %i.y = getelementptr inbounds nuw i8, ptr %.02438, i64 80
  %.sroa.029.0.copyload.5 = load i64, ptr %i.y, align 8, !tbaa !19
  %i.z = add i64 %.sroa.029.0.copyload.5, %i.x
  %i.aa = getelementptr inbounds nuw i8, ptr %.02438, i64 96
  %.sroa.029.0.copyload.6 = load i64, ptr %i.aa, align 8, !tbaa !19
  %i.ab = add i64 %.sroa.029.0.copyload.6, %i.z
  %i.ac = getelementptr inbounds nuw i8, ptr %.02438, i64 112
  %.sroa.029.0.copyload.7 = load i64, ptr %i.ac, align 8, !tbaa !19
  %i.ad = add i64 %.sroa.029.0.copyload.7, %i.ab  ; 3 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %.02438, i64 128 ; 2 uses
  %niter.next.7 = add i64 %niter, 8               ; 2 uses
  %niter.ncmp.7 = icmp eq i64 %niter.next.7, %unroll_iter
...
.lr.ph43:                                         ; preds = %.lr.ph43.prol.loopexit, %bb.e
  %.041 = phi ptr [ %i.ai, %bb.e ], [ %.041.unr, %.lr.ph43.prol.loopexit ] ; 5 uses
  %.02340 = phi ptr [ %.1.1, %bb.e ], [ %.02340.unr, %.lr.ph43.prol.loopexit ] ; 3 uses
  %.sroa.0.0.copyload = load i64, ptr %.041, align 8, !tbaa !19 ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph43
  ...
  %.sroa.4.0.copyload = load ptr, ptr %.sroa.4.0..0.sroa_idx, align 8, !tbaa !21
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.02340, ptr align 1 %.sroa.4.0.copyload, i64 %.sroa.0.0.copyload, i1 false)
  %i.af = getelementptr inbounds nuw i8, ptr %.02340, i64 %.sroa.0.0.copyload
  br label %.lr.ph43.1

.lr.ph43.1:                                       ; preds = %bb.c, %.lr.ph43
  %.1 = phi ptr [ %i.af, %bb.c ], [ %.02340, %.lr.ph43 ] ; 3 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.041, i64 16
  %.sroa.0.0.copyload.1 = load i64, ptr %i.ag, align 8, !tbaa !19 ; 3 uses
  %.not28.1 = icmp eq i64 %.sroa.0.0.copyload.1, 0
  br i1 %.not28.1, label %bb.e, label %bb.d

bb.d:                                             ; preds = %.lr.ph43.1
  %.sroa.4.0..0.sroa_idx.1 = getelementptr inbounds nuw i8, ptr %.041, i64 24
  %.sroa.4.0.copyload.1 = load ptr, ptr %.sroa.4.0..0.sroa_idx.1, align 8, !tbaa !21
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %.1, ptr align 1 %.sroa.4.0.copyload.1, i64 %.sroa.0.0.copyload.1, i1 false)
...
bb.e:                                             ; preds = %bb.d, %.lr.ph43.1
  ...
  %i.ai = getelementptr inbounds nuw i8, ptr %.041, i64 32 ; 2 uses
  %.not27.1 = icmp eq ptr %i.ai, %i.a
...
bb.a:
  ...
  %i.c = load i64, ptr %1, align 8, !tbaa !17
  ...
  %.val = load i64, ptr %1, align 8, !tbaa !17    ; 2 uses
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !14   ; 2 uses
  %i.c = load i64, ptr %1, align 8, !tbaa !17
  %i.d = load i64, ptr %2, align 8, !tbaa !17
  %i.e = add i64 %i.d, %i.c
  ...
  %.val11 = load i64, ptr %1, align 8, !tbaa !17  ; 3 uses
...
_ZN4absl12lts_2025051212_GLOBAL__N_16AppendEPcRKNS0_8AlphaNumE.exit: ; preds = %bb.a, %bb.b
  %.val = load i64, ptr %2, align 8, !tbaa !17    ; 2 uses
...
bb.a:
  ...
  %i.d = load i64, ptr %2, align 8, !tbaa !17
  %i.e = add i64 %i.d, %i.c
  %i.f = load i64, ptr %3, align 8, !tbaa !17
  %i.g = add i64 %i.e, %i.f
  ...
  %.val16 = load i64, ptr %1, align 8, !tbaa !17  ; 3 uses
...
_ZN4absl12lts_2025051212_GLOBAL__N_16AppendEPcRKNS0_8AlphaNumE.exit: ; preds = %bb.a, %bb.b
  ...
  %.val14 = load i64, ptr %2, align 8, !tbaa !17  ; 3 uses
...
_ZN4absl12lts_2025051212_GLOBAL__N_16AppendEPcRKNS0_8AlphaNumE.exit19: ; preds = %_ZN4absl12lts_2025051212_GLOBAL__N_16AppendEPcRKNS0_8AlphaNumE.exit, %bb.c
  %.val = load i64, ptr %3, align 8, !tbaa !17    ; 2 uses
