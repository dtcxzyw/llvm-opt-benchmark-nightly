...
bb.k:                                             ; preds = %bb.g, %bb.j, %bb.h, %bb.i, %bb.f, %X509_NAME_ENTRY_get_data.exit
  %.0 = phi i32 [ -1, %X509_NAME_ENTRY_get_data.exit ], [ -1, %bb.f ], [ -1, %bb.h ], [ -1, %bb.i ], [ %i.q, %bb.j ], [ %i.q, %bb.g ]
...
X509_NAME_get_index_by_OBJ.exit.thread:           ; preds = %bb.c, %bb.b, %bb.a, %X509_NAME_get_index_by_OBJ.exit, %bb.k
  %.019 = phi i32 [ %.0, %bb.k ], [ -1, %X509_NAME_get_index_by_OBJ.exit ], [ -1, %bb.a ], [ -1, %bb.b ], [ -1, %bb.c ]
  ret i32 %.019
}
