...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i: ; preds = %bb.s
  %i.bk = load i64, ptr %i.al, align 8, !tbaa !39
  %i.bl = add i64 %i.bk, 1
...
_ZN10LogMessageD2Ev.exit:                         ; preds = %bb.s, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i
  store ptr getelementptr inbounds nuw inrange(-16, 112) (i8, ptr @_ZTVSt15basic_streambufIcSt11char_traitsIcEE, i64 16), ptr %i.aj, align 8, !tbaa !78
  ...
  store ptr null, ptr %i.au, align 8, !tbaa !39
  store i8 2, ptr %i.aq, align 8, !tbaa !38
  br label %bb.x
...
bb.v:                                             ; preds = %bb.o
  ...
  store ptr null, ptr %i.bp, align 8, !tbaa !62
...
bb.w:                                             ; preds = %bb.o
  ...
  store i16 %i.br, ptr %i.ar, align 2, !tbaa !61
...
bb.x:                                             ; preds = %_ZN10LogMessageD2Ev.exit, %bb.v, %bb.w, %bb.n
  ...
  br i1 %.not57, label %._crit_edge, label %bb.n, !llvm.loop !194
...
bb.a:
  ...
  store ptr %0, ptr %i.a, align 8, !tbaa !107
...
.noexc:                                           ; preds = %.noexc.backedge, %.noexc.preheader
  %i.ak = load ptr, ptr %i.d, align 8, !tbaa !205 ; 12 uses
  ...
  %i.aq = load ptr, ptr %i.ao, align 8, !tbaa !110 ; 5 uses
...
bb.c:                                             ; preds = %.noexc
  %i.av = load i32, ptr %i.ap, align 8, !tbaa !18 ; 2 uses
...
.preheader118:                                    ; preds = %bb.c
  %i.bc = load i32, ptr %i.am, align 8, !tbaa !18
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.bi = load ptr, ptr %i.e, align 8, !tbaa !112
  %.not.i87 = icmp eq ptr %i.ak, %i.bi
  br i1 %.not.i87, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.bj = load ptr, ptr %i.bg, align 8, !tbaa !107
  %i.bk = load i32, ptr %i.bh, align 8, !tbaa !18
  store ptr %i.bj, ptr %i.ak, align 8, !tbaa !118
  %i.bl = getelementptr inbounds nuw i8, ptr %i.ak, i64 8
  store i32 %i.bk, ptr %i.bl, align 8, !tbaa !119
  ...
  store ptr %i.bn, ptr %i.d, align 8, !tbaa !120
...
.preheader117:                                    ; preds = %.preheader118, %.loopexit
  ...
  %i.bp = load ptr, ptr %i.al, align 8, !tbaa !107 ; 6 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %.sroa.0104.0167, i64 8 ; 2 uses
  %i.br = load ptr, ptr %i.bq, align 8, !tbaa !122 ; 3 uses
...
.lr.ph.preheader:                                 ; preds = %.preheader117
  ...
  %i.bx = ptrtoaddr ptr %i.bp to i64              ; 2 uses
  %i.by = shl nsw i64 %i.bs, 3                    ; 2 uses
  %7 = add i64 %i.by, %i.bx
  %8 = add i64 %7, 8
  %9 = call i64 @llvm.umax.i64(i64 %i.bw, i64 %8)
  %i.bz = xor i64 %i.bx, -1
  %i.ca = add i64 %9, %i.bz
...
vector.body268:                                   ; preds = %vector.body268, %vector.ph266
  ...
  %wide.load270 = load <2 x ptr>, ptr %next.gep, align 8, !tbaa !62
  %wide.load271 = load <2 x ptr>, ptr %i.cm, align 8, !tbaa !62
  %gep = getelementptr [8 x i8], ptr %invariant.gep, i64 %index269 ; 2 uses
  %i.cn = getelementptr inbounds nuw i8, ptr %gep, i64 16
  store <2 x ptr> %wide.load270, ptr %gep, align 8, !tbaa !62
  store <2 x ptr> %wide.load271, ptr %i.cn, align 8, !tbaa !62
  %index.next272 = add nuw i64 %index269, 4       ; 2 uses
  %i.co = icmp eq i64 %index.next272, %n.vec267
  br i1 %i.co, label %middle.block273, label %vector.body268, !llvm.loop !195
...
._crit_edge170:                                   ; preds = %.loopexit, %.loopexit.thread
  ...
  %.pre200 = load ptr, ptr %i.ao, align 8, !tbaa !123 ; 2 uses
  %.pre201 = load ptr, ptr %i.ar, align 8, !tbaa !124
...
_ZSt8_DestroyIPN3re26SpliceES1_EvT_S3_RSaIT0_E.exit.i.i: ; preds = %.preheader118, %._crit_edge170
  ...
  store ptr %i.cq, ptr %i.ar, align 8, !tbaa !124
...
_ZNSt6vectorIN3re26SpliceESaIS1_EE5clearEv.exit:  ; preds = %._crit_edge170, %_ZSt8_DestroyIPN3re26SpliceES1_EvT_S3_RSaIT0_E.exit.i.i
  ...
  store i32 %.065.lcssa224, ptr %i.am, align 8, !tbaa !18
  br label %bb.ac
...
.lr.ph:                                           ; preds = %.lr.ph.preheader278, %.lr.ph
  ...
  br i1 %i.cv, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !196
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader117
  ...
  %i.cy = load i32, ptr %i.an, align 4, !tbaa !18
...
bb.h:                                             ; preds = %._crit_edge, %._crit_edge
  ...
  %i.cz = load ptr, ptr %.sroa.0104.0167, align 8, !tbaa !125
  store ptr %i.cz, ptr %i.c, align 16, !tbaa !62
  %i.da = load ptr, ptr %i.bq, align 8, !tbaa !122
  %i.db = getelementptr inbounds nuw i8, ptr %.sroa.0104.0167, i64 20
  %i.dc = load i32, ptr %i.db, align 4, !tbaa !126
...
bb.i:                                             ; preds = %bb.h
  store ptr %i.dd, ptr %i.f, align 8, !tbaa !62
...
bb.l:                                             ; preds = %._crit_edge
  %i.dn = load ptr, ptr %.sroa.0104.0167, align 8, !tbaa !125
...
bb.m:                                             ; preds = %._crit_edge
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVSt9basic_iosIcSt11char_traitsIcEE, i64 16), ptr %i.h, align 8, !tbaa !78
  store ptr null, ptr %i.i, align 8, !tbaa !134
  store i8 0, ptr %i.j, align 8, !tbaa !135
  store i8 0, ptr %i.k, align 1, !tbaa !136
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.l, i8 0, i64 32, i1 false)
  store ptr %i.m, ptr %i.g, align 8, !tbaa !78
  %i.du = load i64, ptr %i.o, align 8
  %i.dv = getelementptr inbounds i8, ptr %i.g, i64 %i.du
  store ptr %i.n, ptr %i.dv, align 8, !tbaa !78
  %i.dw = load ptr, ptr %i.g, align 8, !tbaa !78
...
bb.n:                                             ; preds = %bb.m
  store ptr getelementptr inbounds nuw inrange(-24, 16) (i8, ptr @_ZTVNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE, i64 64), ptr %i.h, align 8, !tbaa !78
  store <2 x ptr> <ptr getelementptr inbounds nuw inrange(-24, 16) (i8, ptr @_ZTVNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE, i64 24), ptr getelementptr inbounds nuw inrange(-16, 112) (i8, ptr @_ZTVSt15basic_streambufIcSt11char_traitsIcEE, i64 16)>, ptr %i.g, align 8, !tbaa !78
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 112) (i8, ptr @_ZTVNSt7__cxx1115basic_stringbufIcSt11char_traitsIcESaIcEEE, i64 16), ptr %i.p, align 8, !tbaa !78
  store i32 16, ptr %i.s, align 8, !tbaa !137
  store ptr %i.u, ptr %i.t, align 8, !tbaa !104
  store i64 0, ptr %i.v, align 8, !tbaa !105
  store i8 0, ptr %i.u, align 8, !tbaa !39
  %i.ea = load ptr, ptr %i.g, align 8, !tbaa !78
