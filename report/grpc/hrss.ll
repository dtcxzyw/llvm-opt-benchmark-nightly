...
bb.a:
  ...
  %3 = tail call noundef i64 @llvm.bitreverse.i64(i64 %2) ; 2 uses
  ...
  %4 = load <2 x i64>, ptr %i.av, align 8, !tbaa !16
  %5 = tail call <2 x i64> @llvm.bitreverse.v2i64(<2 x i64> %4) ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %1, i64 72
  %6 = load <2 x i64>, ptr %i.aw, align 8, !tbaa !16
  %7 = tail call <2 x i64> @llvm.bitreverse.v2i64(<2 x i64> %6) ; 2 uses
  %8 = extractelement <2 x i64> %7, i64 0         ; 2 uses
  %9 = extractelement <2 x i64> %7, i64 1
  %10 = tail call i64 @llvm.fshl.i64(i64 %8, i64 %9, i64 60)
  %11 = extractelement <2 x i64> %5, i64 1        ; 2 uses
  %i.ax = tail call i64 @llvm.fshl.i64(i64 %11, i64 %8, i64 60)
  %i.ay = extractelement <2 x i64> %5, i64 0      ; 2 uses
  %i.az = tail call i64 @llvm.fshl.i64(i64 %i.ay, i64 %11, i64 60)
  %i.ba = extractelement <2 x i64> %i.au, i64 1   ; 2 uses
  %i.bb = tail call i64 @llvm.fshl.i64(i64 %i.ba, i64 %i.ay, i64 60)
  %i.bc = extractelement <2 x i64> %i.au, i64 0   ; 2 uses
  %i.bd = tail call i64 @llvm.fshl.i64(i64 %i.bc, i64 %i.ba, i64 60)
  %i.be = extractelement <2 x i64> %i.ar, i64 1   ; 2 uses
  %i.bf = tail call i64 @llvm.fshl.i64(i64 %i.be, i64 %i.bc, i64 60)
  %i.bg = extractelement <2 x i64> %i.ar, i64 0   ; 2 uses
  %i.bh = tail call i64 @llvm.fshl.i64(i64 %i.bg, i64 %i.be, i64 60)
  %i.bi = extractelement <2 x i64> %i.ao, i64 1   ; 2 uses
  %i.bj = tail call i64 @llvm.fshl.i64(i64 %i.bi, i64 %i.bg, i64 60)
  %i.bk = extractelement <2 x i64> %i.ao, i64 0   ; 2 uses
  %i.bl = tail call i64 @llvm.fshl.i64(i64 %i.bk, i64 %i.bi, i64 60)
  %12 = tail call i64 @llvm.fshl.i64(i64 %3, i64 %i.bk, i64 60)
  %13 = insertelement <2 x i64> %i.c, i64 %3, i64 1
  %14 = lshr <2 x i64> %13, splat (i64 4)         ; 2 uses
  %.sroa.055.0.vec.insert.i = insertelement <2 x i64> poison, i64 %10, i64 0
  ...
  %.sroa.39.72.vec.insert.i = insertelement <2 x i64> %.sroa.39.64.vec.insert.i, i64 %12, i64 1
  %15 = shufflevector <2 x i64> <i64 poison, i64 0>, <2 x i64> %14, <2 x i32> <i32 3, i32 1>
  ...
  %.sroa.49.80.vec.insert.i = insertelement <2 x i64> %14, i64 0, i64 1
  br label %bb.c
...
.split.preheader.i.i:                             ; preds = %bb.b
  %.sroa.29160.0.vec.extract.i = extractelement <2 x i64> %i.qo, i64 0
  %.sroa.29178.0.vec.extract.i = extractelement <2 x i64> %i.ow, i64 0
  ...
  %16 = extractelement <2 x i64> %i.pa, i64 0
  %i.bw = and i64 %16, %i.bv
  ...
  %17 = tail call i64 @llvm.bitreverse.i64(i64 %i.bw) ; 2 uses
  %18 = shufflevector <2 x i64> %i.ow, <2 x i64> %i.pe, <2 x i32> <i32 1, i32 2>
  ...
  %i.da = xor <2 x i64> %18, %i.cz
  %19 = shufflevector <2 x i64> %i.pa, <2 x i64> %i.pi, <2 x i32> <i32 1, i32 2>
  %i.db = and <2 x i64> %19, %i.da
  %i.dc = tail call <2 x i64> @llvm.bitreverse.v2i64(<2 x i64> %i.db) ; 2 uses
  %20 = shufflevector <2 x i64> %i.pe, <2 x i64> %i.pm, <2 x i32> <i32 1, i32 2>
  %i.dd = xor <2 x i64> %20, %i.cz
  %21 = shufflevector <2 x i64> %i.pi, <2 x i64> %i.pq, <2 x i32> <i32 1, i32 2>
  %i.de = and <2 x i64> %21, %i.dd
  %i.df = tail call <2 x i64> @llvm.bitreverse.v2i64(<2 x i64> %i.de) ; 2 uses
  %22 = shufflevector <2 x i64> %i.pm, <2 x i64> %i.pu, <2 x i32> <i32 1, i32 2>
  %i.dg = xor <2 x i64> %22, %i.cz
  %23 = shufflevector <2 x i64> %i.pq, <2 x i64> %i.py, <2 x i32> <i32 1, i32 2>
  %i.dh = and <2 x i64> %i.dg, %23
  %i.di = tail call <2 x i64> @llvm.bitreverse.v2i64(<2 x i64> %i.dh) ; 2 uses
  %24 = shufflevector <2 x i64> %i.pu, <2 x i64> %i.qc, <2 x i32> <i32 1, i32 2>
  %i.dj = xor <2 x i64> %24, %i.cz
  %25 = shufflevector <2 x i64> %i.py, <2 x i64> %i.qg, <2 x i32> <i32 1, i32 2>
  %i.dk = and <2 x i64> %i.dj, %25
  %i.dl = tail call <2 x i64> @llvm.bitreverse.v2i64(<2 x i64> %i.dk) ; 2 uses
  %26 = shufflevector <2 x i64> %i.qc, <2 x i64> %i.qk, <2 x i32> <i32 1, i32 2>
  %i.dm = xor <2 x i64> %26, %i.cz
  %27 = shufflevector <2 x i64> %i.qg, <2 x i64> %i.qo, <2 x i32> <i32 1, i32 2>
  %i.dn = and <2 x i64> %i.dm, %27
  %i.do = tail call <2 x i64> @llvm.bitreverse.v2i64(<2 x i64> %i.dn) ; 2 uses
  %28 = extractelement <2 x i64> %i.do, i64 0     ; 2 uses
  %i.dp = extractelement <2 x i64> %i.do, i64 1
  %i.dq = tail call i64 @llvm.fshl.i64(i64 %28, i64 %i.dp, i64 60)
  %i.dr = extractelement <2 x i64> %i.dl, i64 1   ; 2 uses
  %i.ds = tail call i64 @llvm.fshl.i64(i64 %i.dr, i64 %28, i64 60)
  %i.dt = extractelement <2 x i64> %i.dl, i64 0   ; 2 uses
  %i.du = tail call i64 @llvm.fshl.i64(i64 %i.dt, i64 %i.dr, i64 60)
  %i.dv = extractelement <2 x i64> %i.di, i64 1   ; 2 uses
  %i.dw = tail call i64 @llvm.fshl.i64(i64 %i.dv, i64 %i.dt, i64 60)
  %i.dx = extractelement <2 x i64> %i.di, i64 0   ; 2 uses
  %i.dy = tail call i64 @llvm.fshl.i64(i64 %i.dx, i64 %i.dv, i64 60)
  %i.dz = extractelement <2 x i64> %i.df, i64 1   ; 2 uses
  %i.ea = tail call i64 @llvm.fshl.i64(i64 %i.dz, i64 %i.dx, i64 60)
  %i.eb = extractelement <2 x i64> %i.df, i64 0   ; 2 uses
  %i.ec = tail call i64 @llvm.fshl.i64(i64 %i.eb, i64 %i.dz, i64 60)
  %i.ed = extractelement <2 x i64> %i.dc, i64 1   ; 2 uses
  %i.ee = tail call i64 @llvm.fshl.i64(i64 %i.ed, i64 %i.eb, i64 60)
  %i.ef = extractelement <2 x i64> %i.dc, i64 0   ; 2 uses
...
bb.c:                                             ; preds = %bb.c, %bb.a
  ...
  %.sroa.48.0195.i = phi <2 x i64> [ %15, %bb.a ], [ %i.mh, %bb.c ] ; 2 uses
  ...
  %i.qo = xor <2 x i64> %i.qn, %i.gy              ; 4 uses
