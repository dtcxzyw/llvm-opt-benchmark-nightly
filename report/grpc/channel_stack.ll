...
.lr.ph:                                           ; preds = %bb.a, %bb.b
  %.01117 = phi i64 [ %i.i, %bb.b ], [ 0, %bb.a ] ; 2 uses
  %.01216 = phi i64 [ %spec.select, %bb.b ], [ 0, %bb.a ] ; 2 uses
  %i.d = getelementptr inbounds nuw [16 x i8], ptr %i.a, i64 %.01117 ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph
  ...
  %spec.select = add i64 %.01216, %i.h            ; 2 uses
  %i.i = add nuw i64 %.01117, 1                   ; 2 uses
  %exitcond.not = icmp eq i64 %i.i, %i.c
  br i1 %exitcond.not, label %.thread, label %.lr.ph, !llvm.loop !38

.thread:                                          ; preds = %bb.b, %.lr.ph, %bb.a
  %.012.lcssa = phi i64 [ 0, %bb.a ], [ %.01216, %.lr.ph ], [ %spec.select, %bb.b ]
  ret i64 %.012.lcssa
}
...
bb.l:                                             ; preds = %.lr.ph108, %_ZN4absl12lts_202505126StatusD2Ev.exit
  ...
  %.058105 = phi i64 [ %i.aw, %.lr.ph108 ], [ %i.dh, %_ZN4absl12lts_202505126StatusD2Ev.exit ]
...
_ZN4absl12lts_202505126StatusaSERKS1_.exit:       ; preds = %_ZN4absl12lts_202505126Status3RefEm.exit.i, %bb.p
  ...
  %i.dh = add i64 %i.dg, %.058105                 ; 2 uses
