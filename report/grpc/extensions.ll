...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %..critedge41_crit_edge
  %.03362 = phi ptr [ %i.ag, %..critedge41_crit_edge ], [ %.sroa.048.08389, %.lr.ph.preheader ] ; 2 uses
  %i.w = load i16, ptr %.03362, align 2, !tbaa !41
...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %bb.e
  %.03454.us = phi ptr [ %i.ab, %bb.e ], [ %.sroa.046.08290, %.lr.ph.split.us.preheader ] ; 2 uses
  %i.x = load i16, ptr %.03454.us, align 2, !tbaa !41
...
.lr.ph:                                           ; preds = %bb.a, %bb.g
  %.01834 = phi i8 [ %.119, %bb.g ], [ 1, %bb.a ] ; 2 uses
  %.02133 = phi ptr [ %i.s, %bb.g ], [ %i.e, %bb.a ] ; 3 uses
  %i.i = getelementptr inbounds nuw i8, ptr %.02133, i64 8
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !617
  %i.k = icmp eq ptr %i.j, null
  br i1 %i.k, label %bb.g, label %bb.b

bb.b:                                             ; preds = %.lr.ph
  %i.l = trunc nuw i8 %.01834 to i1
...
bb.f:                                             ; preds = %bb.e, %bb.b
  %i.p = getelementptr inbounds nuw i8, ptr %.02133, i64 16
...
bb.g:                                             ; preds = %.lr.ph, %bb.f
  %.119 = phi i8 [ %.01834, %.lr.ph ], [ 0, %bb.f ] ; 2 uses
  %i.s = getelementptr inbounds nuw i8, ptr %.02133, i64 24 ; 2 uses
  %.not = icmp eq ptr %i.s, %i.h
  br i1 %.not, label %._crit_edge, label %.lr.ph

._crit_edge:                                      ; preds = %bb.g
  %i.t = trunc nuw i8 %.119 to i1
...
.lr.ph98.split.us:                                ; preds = %.lr.ph98, %_ZN4bssl5ArrayItE16InitForOverwriteEm.exit.us
  %.03997.us = phi i64 [ %i.u, %_ZN4bssl5ArrayItE16InitForOverwriteEm.exit.us ], [ 0, %.lr.ph98 ] ; 3 uses
  %.04196.us = phi i64 [ %.546.us, %_ZN4bssl5ArrayItE16InitForOverwriteEm.exit.us ], [ %.fr106, %.lr.ph98 ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #21
...
bb.g:                                             ; preds = %bb.f
  %i.u = add nuw i64 %.03997.us, 1
  %exitcond114.not = icmp eq i64 %.03997.us, %i.p
...
_ZN4bssl5ArrayItEixEm.exit.us:                    ; preds = %bb.g
  ...
  %i.w = getelementptr inbounds nuw [2 x i8], ptr %i.q, i64 %.03997.us
  store i16 %i.v, ptr %i.w, align 2, !tbaa !41
  %i.x = load i64, ptr %i.g, align 8, !tbaa !616
  br label %bb.h

bb.h:                                             ; preds = %_ZN4bssl5ArrayItEixEm.exit.us, %bb.i
  %.03894.us = phi i64 [ 0, %_ZN4bssl5ArrayItEixEm.exit.us ], [ %i.ae, %bb.i ] ; 4 uses
  %exitcond.not = icmp eq i64 %.03894.us, %i.x
...
_ZNK4bssl6VectorINS_18CertCompressionAlgEEixEm.exit.us: ; preds = %bb.h
  ...
  %i.z = getelementptr inbounds nuw [24 x i8], ptr %i.y, i64 %.03894.us ; 2 uses
...
bb.i:                                             ; preds = %_ZNK4bssl6VectorINS_18CertCompressionAlgEEixEm.exit.us
  %i.ae = add nuw i64 %.03894.us, 1               ; 2 uses
...
bb.j:                                             ; preds = %_ZNK4bssl6VectorINS_18CertCompressionAlgEEixEm.exit.us
  %spec.select.us = call i64 @llvm.umin.i64(i64 %.03894.us, i64 %.04196.us)
  br label %_ZN4bssl5ArrayItE16InitForOverwriteEm.exit.us

_ZN4bssl5ArrayItE16InitForOverwriteEm.exit.us:    ; preds = %bb.i, %bb.j
  %.546.us = phi i64 [ %spec.select.us, %bb.j ], [ %.04196.us, %bb.i ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #21
...
.lr.ph98.split:                                   ; preds = %.lr.ph98, %_ZN4bssl5ArrayItEixEm.exit
  %.03997 = phi i64 [ %i.ak, %_ZN4bssl5ArrayItEixEm.exit ], [ 0, %.lr.ph98 ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #21
...
bb.n:                                             ; preds = %bb.l
  %exitcond115.not = icmp eq i64 %.03997, %i.p
...
_ZN4bssl5ArrayItEixEm.exit:                       ; preds = %bb.n
  %i.ak = add nuw i64 %.03997, 1
  %i.al = load i16, ptr %i.a, align 2, !tbaa !41
  %i.am = getelementptr inbounds nuw [2 x i8], ptr %i.q, i64 %.03997
...
_ZN4bssl5ArrayItE16InitForOverwriteEm.exit._crit_edge: ; preds = %_ZN4bssl5ArrayItE16InitForOverwriteEm.exit.us, %_ZN4bssl5ArrayItEixEm.exit, %_ZN4bssl5ArrayItE16InitForOverwriteEm.exit.preheader
  %.041.lcssa = phi i64 [ %.fr106, %_ZN4bssl5ArrayItE16InitForOverwriteEm.exit.preheader ], [ 0, %_ZN4bssl5ArrayItEixEm.exit ], [ %.546.us, %_ZN4bssl5ArrayItE16InitForOverwriteEm.exit.us ] ; 3 uses
...
.critedge64:                                      ; preds = %bb.o, %.preheader.split
  %i.aw = icmp ult i64 %.041.lcssa, %.fr106
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.be = icmp ult i64 %.041.lcssa, %i.bd
...
_ZNK4bssl6VectorINS_18CertCompressionAlgEEixEm.exit68: ; preds = %bb.s
  ...
  %i.bg = getelementptr inbounds nuw [24 x i8], ptr %i.bf, i64 %.041.lcssa
...
_ZN4bssl5ArrayItE16InitForOverwriteEm.exit.thread: ; preds = %_ZN4bssl5ArrayItEixEm.exit66, %.noexc65, %.critedge, %_ZNK4bssl6VectorINS_18CertCompressionAlgEEixEm.exit68, %bb.r, %.critedge64
  %.4 = phi i1 [ false, %.noexc65 ], [ true, %.critedge64 ], [ false, %.critedge ], [ true, %bb.r ], [ true, %_ZNK4bssl6VectorINS_18CertCompressionAlgEEixEm.exit68 ], [ false, %_ZN4bssl5ArrayItEixEm.exit66 ]
...
_ZN4bssl5ArrayItED2Ev.exit:                       ; preds = %_ZN4bssl5ArrayItE16InitForOverwriteEm.exit.thread, %bb.b, %bb.c, %bb.d
  %.5 = phi i1 [ false, %bb.b ], [ %.4, %_ZN4bssl5ArrayItE16InitForOverwriteEm.exit.thread ], [ false, %bb.d ], [ false, %bb.c ]
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #21
  br label %bb.x

bb.x:                                             ; preds = %bb.a, %_ZN4bssl5ArrayItED2Ev.exit
  %.6 = phi i1 [ %.5, %_ZN4bssl5ArrayItED2Ev.exit ], [ true, %bb.a ]
  ret i1 %.6
}
