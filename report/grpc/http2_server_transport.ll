...
begin_hunk_0_@_ZNK9grpc_core14promise_detail8SeqStateINS0_12TrySeqTraitsENS_5SleepEJZNS_22SettingsPromiseManager22WaitForSettingsTimeoutEvEUlvE0_EE7ToProtoE40grpc_channelz_v2_Promise_CompositionKindP24grpc_channelz_v2_PromiseP9upb_Arena:bb.a
  ...
  br i1 %i.ag, label %upb_Arena_Malloc.exit.i.i23, label %upb_Arena_Malloc.exit.thread.i.i21, !prof !54
...
upb_Arena_Malloc.exit.thread.i.i21:               ; preds = %grpc_channelz_v2_Promise_mutable_seq_promise.exit
  ...
  store ptr %i.ah, ptr %3, align 8, !tbaa !1880
...
upb_Arena_Malloc.exit.i.i23:                      ; preds = %grpc_channelz_v2_Promise_mutable_seq_promise.exit
  ...
  br i1 %.not.i.i24, label %grpc_channelz_v2_Promise_SeqStep_new.exit, label %bb.c, !prof !1881
...
grpc_channelz_v2_Promise_SeqStep_new.exit:        ; preds = %upb_Arena_Malloc.exit.i.i23, %bb.c
  ...
  store ptr %.0.i.i, ptr %i.v, align 8, !tbaa !3229
  %i.aj = load i16, ptr getelementptr inbounds nuw (i8, ptr @grpc__channelz__v2__Promise__SeqStep_msg_init, i64 8), align 8, !tbaa !1875
  %i.ak = zext i16 %i.aj to i64                   ; 5 uses
  %i.al = and i64 %i.ak, 7
  %i.am = icmp eq i64 %i.al, 0
  call void @llvm.assume(i1 %i.am)
  %i.an = load ptr, ptr %i.w, align 8, !tbaa !1878
  %i.ao = load ptr, ptr %3, align 8, !tbaa !1880  ; 4 uses
  %i.ap = ptrtoint ptr %i.an to i64
  %i.aq = ptrtoint ptr %i.ao to i64
  %i.ar = sub i64 %i.ap, %i.aq
  %i.as = icmp ult i64 %i.ar, %i.ak
  br i1 %i.as, label %upb_Arena_Malloc.exit.i.i23.1, label %upb_Arena_Malloc.exit.thread.i.i21.1, !prof !54
...
upb_Arena_Malloc.exit.thread.i.i21.1:             ; preds = %grpc_channelz_v2_Promise_SeqStep_new.exit
  ...
  store ptr %i.at, ptr %3, align 8, !tbaa !1880
...
upb_Arena_Malloc.exit.i.i23.1:                    ; preds = %grpc_channelz_v2_Promise_SeqStep_new.exit
  ...
  br i1 %.not.i.i24.1, label %grpc_channelz_v2_Promise_SeqStep_new.exit.1, label %bb.d, !prof !1881
...
grpc_channelz_v2_Promise_SeqStep_new.exit.1:      ; preds = %bb.d, %upb_Arena_Malloc.exit.i.i23.1
  ...
  store ptr %.0.i.i.1, ptr %i.av, align 8, !tbaa !3229
  %i.aw = load ptr, ptr %i.v, align 8, !tbaa !3229 ; 2 uses
  ...
  %i.az = load i8, ptr %i.ay, align 8, !tbaa !1033
  %i.ba = icmp eq i8 %i.az, 0
  br i1 %i.ba, label %bb.e, label %bb.h

bb.e:                                             ; preds = %grpc_channelz_v2_Promise_SeqStep_new.exit.1
  %i.bb = load ptr, ptr %i.v, align 8, !tbaa !3229 ; 2 uses
  call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(ptr nonnull @grpc__channelz__v2__Promise_msg_init) #44, !srcloc !1910
...
bb.f:                                             ; preds = %bb.e
  %i.bg = load i16, ptr getelementptr inbounds nuw (i8, ptr @grpc__channelz__v2__Promise_msg_init, i64 8), align 8, !tbaa !1875
  %i.bh = zext i16 %i.bg to i64                   ; 5 uses
  %i.bi = and i64 %i.bh, 7
  %i.bj = icmp eq i64 %i.bi, 0
  call void @llvm.assume(i1 %i.bj)
  %i.bk = load ptr, ptr %i.w, align 8, !tbaa !1878
  %i.bl = load ptr, ptr %3, align 8, !tbaa !1880  ; 4 uses
  %i.bm = ptrtoint ptr %i.bk to i64
  %i.bn = ptrtoint ptr %i.bl to i64               ; 2 uses
  %i.bo = sub i64 %i.bm, %i.bn
  %i.bp = icmp ult i64 %i.bo, %i.bh
  br i1 %i.bp, label %upb_Arena_Malloc.exit.i.i29, label %upb_Arena_Malloc.exit.thread.i.i26, !prof !54

upb_Arena_Malloc.exit.thread.i.i26:               ; preds = %bb.f
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bl, i64 %i.bh
  store ptr %i.bq, ptr %3, align 8, !tbaa !1880
...
bb.g:                                             ; preds = %upb_Arena_Malloc.exit.i.i29, %upb_Arena_Malloc.exit.thread.i.i26
  ...
  %i.bt = load i8, ptr %i.bs, align 1, !tbaa !42
  %i.bu = or i8 %i.bt, 1
...
grpc_channelz_v2_Promise_SeqStep_mutable_polling_promise.exit: ; preds = %bb.e, %bb.g
  ...
  store i32 2, ptr %i.bv, align 4, !tbaa !53
...
bb.h:                                             ; preds = %grpc_channelz_v2_Promise_SeqStep_mutable_polling_promise.exit, %grpc_channelz_v2_Promise_SeqStep_new.exit.1
  %i.bx = load ptr, ptr %i.av, align 8, !tbaa !3229 ; 2 uses
  ...
  %i.bz = load i8, ptr %i.ay, align 8, !tbaa !1033
  %i.ca = icmp eq i8 %i.bz, 1
  br i1 %i.ca, label %bb.i, label %bb.l

bb.i:                                             ; preds = %bb.h
  %i.cb = load ptr, ptr %i.av, align 8, !tbaa !3229 ; 2 uses
  call void asm sideeffect "", "r,~{dirflag},~{fpsr},~{flags}"(ptr nonnull @grpc__channelz__v2__Promise_msg_init) #44, !srcloc !1910
...
bb.j:                                             ; preds = %bb.i
  %i.cg = load i16, ptr getelementptr inbounds nuw (i8, ptr @grpc__channelz__v2__Promise_msg_init, i64 8), align 8, !tbaa !1875
  %i.ch = zext i16 %i.cg to i64                   ; 5 uses
  %i.ci = and i64 %i.ch, 7
  %i.cj = icmp eq i64 %i.ci, 0
  call void @llvm.assume(i1 %i.cj)
  %i.ck = load ptr, ptr %i.w, align 8, !tbaa !1878
  %i.cl = load ptr, ptr %3, align 8, !tbaa !1880  ; 4 uses
  %i.cm = ptrtoint ptr %i.ck to i64
  %i.cn = ptrtoint ptr %i.cl to i64               ; 2 uses
  %i.co = sub i64 %i.cm, %i.cn
  %i.cp = icmp ult i64 %i.co, %i.ch
  br i1 %i.cp, label %upb_Arena_Malloc.exit.i.i40, label %upb_Arena_Malloc.exit.thread.i.i37, !prof !54

upb_Arena_Malloc.exit.thread.i.i37:               ; preds = %bb.j
  %i.cq = getelementptr inbounds nuw i8, ptr %i.cl, i64 %i.ch
  store ptr %i.cq, ptr %3, align 8, !tbaa !1880
...
bb.k:                                             ; preds = %upb_Arena_Malloc.exit.i.i40, %upb_Arena_Malloc.exit.thread.i.i37
  ...
  %i.cu = or i8 %i.ct, 1
  store i8 %i.cu, ptr %i.cs, align 1, !tbaa !42
...
grpc_channelz_v2_Promise_SeqStep_mutable_polling_promise.exit44: ; preds = %bb.i, %bb.k
  ...
  store i32 2, ptr %i.cv, align 4, !tbaa !53
...
.lr.ph.preheader:                                 ; preds = %bb.a
  %lcmp.mod.not = trunc i64 %3 to i1
  br i1 %lcmp.mod.not, label %.lr.ph.prol, label %.lr.ph.prol.loopexit

.lr.ph.prol:                                      ; preds = %.lr.ph.preheader
  %i.a = load i32, ptr %2, align 8, !tbaa !1105
  store i32 %i.a, ptr %1, align 8, !tbaa !1105
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 2 uses
  store ptr null, ptr %i.b, align 8, !tbaa !314
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !314
  store ptr %i.d, ptr %i.b, align 8, !tbaa !314
  store ptr null, ptr %i.c, align 8, !tbaa !314
  %i.e = add nsw i64 %3, -1
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %i.i = load i32, ptr %.0913, align 8, !tbaa !1105
  store i32 %i.i, ptr %.014, align 8, !tbaa !1105
  %i.j = getelementptr inbounds nuw i8, ptr %.014, i64 8 ; 2 uses
  %i.k = getelementptr inbounds nuw i8, ptr %.0913, i64 8 ; 2 uses
  store ptr null, ptr %i.j, align 8, !tbaa !314
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !314
  store ptr %i.l, ptr %i.j, align 8, !tbaa !314
  store ptr null, ptr %i.k, align 8, !tbaa !314
  %i.m = getelementptr inbounds nuw i8, ptr %.0913, i64 16
  %i.n = getelementptr inbounds nuw i8, ptr %.014, i64 16
  %i.o = load i32, ptr %i.m, align 8, !tbaa !1105
  store i32 %i.o, ptr %i.n, align 8, !tbaa !1105
  ...
  store ptr %i.r, ptr %i.p, align 8, !tbaa !314
  store ptr null, ptr %i.q, align 8, !tbaa !314
  ...
  br i1 %.not.1, label %._crit_edge, label %.lr.ph, !llvm.loop !3231
...
bb.a:
  %i.a = load i64, ptr %0, align 8, !tbaa !325    ; 4 uses
  ...
  %.sroa.0.0.copyload.i.i.i = load ptr, ptr %i.g, align 8, !tbaa !42
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.i = load i64, ptr %i.h, align 8, !tbaa !326
...
bb.c:                                             ; preds = %bb.a, %._crit_edge
  ...
  %i.m = load <16 x i8>, ptr %i.l, align 1, !tbaa !42
...
._crit_edge:                                      ; preds = %bb.i, %bb.c
  ...
  br i1 %i.t, label %bb.c, label %bb.b, !llvm.loop !3232
...
.lr.ph:                                           ; preds = %bb.c, %bb.i
  ...
  br i1 %i.aj, label %bb.d, label %bb.e, !prof !76
...
_ZN4absl12lts_2025051218container_internal29TryFindNewIndexWithoutProbingIvEEmmmmPNS1_6ctrl_tEm.exit: ; preds = %bb.g, %bb.d
  ...
  store i8 %i.ag, ptr %i.aw, align 1, !tbaa !913
  %i.ax = getelementptr inbounds nuw [16 x i8], ptr %.sroa.0.0.copyload.i.i.i, i64 %.2.i ; 2 uses
  store i32 %i.y, ptr %i.ax, align 8, !tbaa !1105
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 8 ; 2 uses
  %i.az = getelementptr inbounds nuw i8, ptr %i.x, i64 8 ; 2 uses
  store ptr null, ptr %i.ay, align 8, !tbaa !314
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !314
  store ptr %i.ba, ptr %i.ay, align 8, !tbaa !314
  store ptr null, ptr %i.az, align 8, !tbaa !314
  br label %bb.i
...
bb.a:
  ...
  %i.m = load ptr, ptr %0, align 8, !tbaa !3233   ; 3 uses
