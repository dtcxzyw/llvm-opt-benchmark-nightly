...
bb.bj:                                            ; preds = %bb.bi
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.16..sroa_idx196, i8 0, i64 24, i1 false)
...
bb.j:                                             ; preds = %_ZNSt8functionIFbP10TestConfigPKcEEC2EOS5_.exit.i.i
  %i.as = invoke noundef zeroext i1 %i.ar(ptr noundef nonnull align 8 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %2, i32 noundef 3)
          to label %_ZN12_GLOBAL__N_14FlagI10TestConfigEaSEOS2_.exit unwind label %bb.k ; 0 uses
