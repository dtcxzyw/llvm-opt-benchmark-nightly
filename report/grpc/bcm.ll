...
.lr.ph.preheader:                                 ; preds = %bb.f
  ...
  %isnotneg.i.i.inv.a = icmp slt i64 %i.aa, 0
  %7 = icmp eq i8 %6, 0
  %8 = select i1 %isnotneg.i.i.inv.a, i1 true, i1 %7
  ...
  %25 = icmp ne <4 x i8> %.fr45, zeroinitializer
  %26 = and <4 x i1> %24, %25
  %27 = bitcast <4 x i1> %26 to i4
  %i.an = icmp eq i4 %27, 0
  %op.rdx = select i1 %i.an, i1 %i.am, i1 false
  %28 = freeze i1 %op.rdx
  %29 = and i1 %28, %12
  %op.rdx44 = select i1 %29, i1 %8, i1 false
