...
.lr.ph.preheader.i.i:                             ; preds = %._crit_edge.i.i, %.lr.ph47.i.i
  ...
  %8 = zext nneg i32 %indvars.iv55.i.i to i64
  %9 = sub i64 %8, %i.cq                          ; 3 uses
  %gep69.i.i = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep68.i.i, i64 %indvars.iv57.i.i
  %i.cr = load i16, ptr %gep69.i.i, align 2, !tbaa !639
...
vector.body81:                                    ; preds = %vector.body74, %vector.body81
  ...
  %i.hz = load i16, ptr %i.hr, align 2, !tbaa !639
  %i.ia = load i16, ptr %i.hs, align 2, !tbaa !639
  ...
  %i.jb = load i16, ptr %i.it, align 2, !tbaa !639
  %i.jc = load i16, ptr %i.iu, align 2, !tbaa !639
...
.lr.ph.preheader.i.i:                             ; preds = %._crit_edge.i.i, %.lr.ph47.i.i
  ...
  %indvars.iv55.i.i = phi i32 [ %.03649.i.i, %.lr.ph47.i.i ], [ %indvars.iv.next56.i.i, %._crit_edge.i.i ] ; 4 uses
  %indvars.iv.i7.i = phi i64 [ 0, %.lr.ph47.i.i ], [ %indvars.iv.next.i9.i, %._crit_edge.i.i ] ; 5 uses
  %i.da = mul i64 %indvars.iv57.i.i, %i.cb
  %8 = zext nneg i32 %indvars.iv55.i.i to i64
  %9 = sub i64 %8, %i.da                          ; 3 uses
  %gep69.i.i = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep68.i.i, i64 %indvars.iv57.i.i
  %i.db = load i16, ptr %gep69.i.i, align 2, !tbaa !639
...
vector.ph54:                                      ; preds = %vector.memcheck
  ...
  %broadcast.splatinsert = insertelement <8 x i32> poison, i32 %i.dc, i64 0
  %broadcast.splat = shufflevector <8 x i32> %broadcast.splatinsert, <8 x i32> poison, <8 x i32> zeroinitializer
...
vector.body87:                                    ; preds = %vector.body80, %vector.body87
  ...
  %i.hu = trunc <8 x i16> %i.ht to <8 x i8>
  %i.hv = and <8 x i8> %i.hu, splat (i8 1)
  %i.hw = getelementptr inbounds nuw i8, ptr %i.gp, i64 2
  %i.hx = getelementptr inbounds nuw i8, ptr %i.gq, i64 18
  %i.hy = getelementptr inbounds nuw i8, ptr %i.gs, i64 34
  %i.hz = getelementptr inbounds nuw i8, ptr %i.gu, i64 50
  %i.ia = getelementptr inbounds nuw i8, ptr %i.gw, i64 66
  %i.ib = getelementptr inbounds nuw i8, ptr %i.gy, i64 82
  %i.ic = getelementptr inbounds nuw i8, ptr %i.ha, i64 98
  %i.id = getelementptr inbounds nuw i8, ptr %i.hc, i64 114
  ...
  %i.ij = load i16, ptr %i.ib, align 2, !tbaa !639
  %i.ik = load i16, ptr %i.ic, align 2, !tbaa !639
  %i.il = load i16, ptr %i.id, align 2, !tbaa !639
  ...
  %i.it = insertelement <8 x i16> %i.is, i16 %i.il, i64 7
  %i.iu = trunc <8 x i16> %i.it to <8 x i8>
  %i.iv = shl <8 x i8> %i.iu, splat (i8 1)
  %i.iw = and <8 x i8> %i.iv, splat (i8 2)
  %i.ix = or disjoint <8 x i8> %i.iw, %i.hv
  %i.iy = getelementptr inbounds nuw i8, ptr %i.gp, i64 4
  %i.iz = getelementptr inbounds nuw i8, ptr %i.gq, i64 20
  %i.ja = getelementptr inbounds nuw i8, ptr %i.gs, i64 36
  %i.jb = getelementptr inbounds nuw i8, ptr %i.gu, i64 52
  %i.jc = getelementptr inbounds nuw i8, ptr %i.gw, i64 68
  %i.jd = getelementptr inbounds nuw i8, ptr %i.gy, i64 84
  %i.je = getelementptr inbounds nuw i8, ptr %i.ha, i64 100
  %i.jf = getelementptr inbounds nuw i8, ptr %i.hc, i64 116
  ...
  %i.jl = load i16, ptr %i.jd, align 2, !tbaa !639
  %i.jm = load i16, ptr %i.je, align 2, !tbaa !639
  %i.jn = load i16, ptr %i.jf, align 2, !tbaa !639
  %i.jo = insertelement <8 x i16> poison, i16 %i.jg, i64 0
  %i.jp = insertelement <8 x i16> %i.jo, i16 %i.jh, i64 1
  %i.jq = insertelement <8 x i16> %i.jp, i16 %i.ji, i64 2
  %i.jr = insertelement <8 x i16> %i.jq, i16 %i.jj, i64 3
  %i.js = insertelement <8 x i16> %i.jr, i16 %i.jk, i64 4
  %i.jt = insertelement <8 x i16> %i.js, i16 %i.jl, i64 5
  %i.ju = insertelement <8 x i16> %i.jt, i16 %i.jm, i64 6
  %i.jv = insertelement <8 x i16> %i.ju, i16 %i.jn, i64 7
  %i.jw = trunc <8 x i16> %i.jv to <8 x i8>
  %i.jx = shl <8 x i8> %i.jw, splat (i8 2)
  %i.jy = and <8 x i8> %i.jx, splat (i8 4)
  %i.jz = or disjoint <8 x i8> %i.ix, %i.jy
  %i.ka = getelementptr inbounds nuw i8, ptr %i.gp, i64 6
  %i.kb = getelementptr inbounds nuw i8, ptr %i.gq, i64 22
  %i.kc = getelementptr inbounds nuw i8, ptr %i.gs, i64 38
  %i.kd = getelementptr inbounds nuw i8, ptr %i.gu, i64 54
  %i.ke = getelementptr inbounds nuw i8, ptr %i.gw, i64 70
  %i.kf = getelementptr inbounds nuw i8, ptr %i.gy, i64 86
  %i.kg = getelementptr inbounds nuw i8, ptr %i.ha, i64 102
  %i.kh = getelementptr inbounds nuw i8, ptr %i.hc, i64 118
...
vector.ph180:                                     ; preds = %vector.memcheck
  %n.vec181 = and i64 %12, -8                     ; 3 uses
  %i.mg = add i64 %indvars.iv.i.1.i16, %n.vec181
  %broadcast.splatinsert182 = insertelement <8 x i32> poison, i32 %i.lx, i64 0
...
middle.block189:                                  ; preds = %vector.body184
  %cmp.n190 = icmp eq i64 %12, %n.vec181
...
vector.ph211:                                     ; preds = %vector.memcheck199
  %n.vec212 = and i64 %14, -8                     ; 3 uses
  %i.pr = add i64 %indvars.iv.i.2.i22, %n.vec212
  %broadcast.splatinsert213 = insertelement <8 x i32> poison, i32 %i.pi, i64 0
...
middle.block220:                                  ; preds = %vector.body215
  %cmp.n221 = icmp eq i64 %14, %n.vec212
...
vector.ph272:                                     ; preds = %vector.memcheck260
  %n.vec273 = and i64 %16, -8                     ; 3 uses
  %i.vp = add i64 %indvars.iv.i43, %n.vec273
  %broadcast.splatinsert274 = insertelement <8 x i32> poison, i32 %i.vh, i64 0
...
middle.block281:                                  ; preds = %vector.body276
  %cmp.n282 = icmp eq i64 %16, %n.vec273
...
vector.body311:                                   ; preds = %vector.body303, %vector.body311
  ...
  %i.zp = icmp eq i64 %index.next314, 256
  br i1 %i.zp, label %vector.body318, label %vector.body311, !llvm.loop !1831

vector.body318:                                   ; preds = %vector.body311, %vector.body318
  %index319 = phi i64 [ %index.next324, %vector.body318 ], [ 0, %vector.body311 ] ; 3 uses
  %i.zq = getelementptr inbounds nuw [2 x i8], ptr %9, i64 %index319 ; 3 uses
  %i.zr = getelementptr inbounds nuw i8, ptr %i.zq, i64 16 ; 2 uses
  %wide.load320 = load <8 x i16>, ptr %i.zq, align 2, !tbaa !639
  %wide.load321 = load <8 x i16>, ptr %i.zr, align 2, !tbaa !639
  %i.zs = getelementptr inbounds nuw [2 x i8], ptr %10, i64 %index319 ; 2 uses
  %i.zt = getelementptr inbounds nuw i8, ptr %i.zs, i64 16
  %wide.load322 = load <8 x i16>, ptr %i.zs, align 2, !tbaa !639
  %wide.load323 = load <8 x i16>, ptr %i.zt, align 2, !tbaa !639
  %i.zu = add <8 x i16> %wide.load322, %wide.load320 ; 2 uses
  %i.zv = add <8 x i16> %wide.load323, %wide.load321 ; 2 uses
  %i.zw = add <8 x i16> %i.zu, splat (i16 -3329)  ; 2 uses
  %i.zx = add <8 x i16> %i.zv, splat (i16 -3329)  ; 2 uses
  %i.zy = icmp slt <8 x i16> %i.zw, zeroinitializer
  %i.zz = icmp slt <8 x i16> %i.zx, zeroinitializer
  %i.aaa = select <8 x i1> %i.zy, <8 x i16> %i.zu, <8 x i16> zeroinitializer
  %i.aab = select <8 x i1> %i.zz, <8 x i16> %i.zv, <8 x i16> zeroinitializer
  %i.aac = call <8 x i16> @llvm.smax.v8i16(<8 x i16> %i.zw, <8 x i16> zeroinitializer)
  %i.aad = call <8 x i16> @llvm.smax.v8i16(<8 x i16> %i.zx, <8 x i16> zeroinitializer)
  %i.aae = or <8 x i16> %i.aaa, %i.aac
  %i.aaf = or <8 x i16> %i.aab, %i.aad
  store <8 x i16> %i.aae, ptr %i.zq, align 2, !tbaa !639
  store <8 x i16> %i.aaf, ptr %i.zr, align 2, !tbaa !639
  %index.next324 = add nuw i64 %index319, 16      ; 2 uses
  %i.aag = icmp eq i64 %index.next324, 256
  br i1 %i.aag, label %vector.body328, label %vector.body318, !llvm.loop !1832

vector.body328:                                   ; preds = %vector.body318, %vector.body328
  %index329 = phi i64 [ %index.next331, %vector.body328 ], [ 0, %vector.body318 ] ; 2 uses
  %i.aah = getelementptr inbounds nuw [2 x i8], ptr %8, i64 %index329 ; 2 uses
  %wide.load330 = load <4 x i16>, ptr %i.aah, align 2, !tbaa !639
  %i.aai = zext <4 x i16> %wide.load330 to <4 x i32>
  %i.aaj = shl nuw nsw <4 x i32> %i.aai, splat (i32 10) ; 2 uses
  %i.aak = zext nneg <4 x i32> %i.aaj to <4 x i64>
  %i.aal = mul nuw nsw <4 x i64> %i.aak, splat (i64 5039)
  %i.aam = lshr <4 x i64> %i.aal, splat (i64 24)  ; 2 uses
  %i.aan = trunc nuw nsw <4 x i64> %i.aam to <4 x i32>
  %i.aao = mul nsw <4 x i32> %i.aan, splat (i32 -3329)
  %i.aap = add nsw <4 x i32> %i.aao, %i.aaj       ; 2 uses
  %i.aaq = icmp ugt <4 x i32> %i.aap, splat (i32 1664)
  %i.aar = zext <4 x i1> %i.aaq to <4 x i64>
  %i.aas = add nuw nsw <4 x i64> %i.aam, %i.aar
  %i.aat = icmp ugt <4 x i32> %i.aap, splat (i32 4993)
  %i.aau = zext <4 x i1> %i.aat to <4 x i64>
  %i.aav = add nuw nsw <4 x i64> %i.aas, %i.aau
  %i.aaw = trunc nuw nsw <4 x i64> %i.aav to <4 x i16>
  %i.aax = and <4 x i16> %i.aaw, splat (i16 1023)
  store <4 x i16> %i.aax, ptr %i.aah, align 2, !tbaa !639
  %index.next331 = add nuw i64 %index329, 4       ; 2 uses
  %i.aay = icmp eq i64 %index.next331, 256
  br i1 %i.aay, label %vector.body335, label %vector.body328, !llvm.loop !1833

vector.body335:                                   ; preds = %vector.body328, %vector.body335
  %index336 = phi i64 [ %index.next338, %vector.body335 ], [ 0, %vector.body328 ] ; 2 uses
  %i.aaz = getelementptr inbounds nuw [2 x i8], ptr %i.lk, i64 %index336 ; 2 uses
  %wide.load337 = load <4 x i16>, ptr %i.aaz, align 2, !tbaa !639
  %i.aba = zext <4 x i16> %wide.load337 to <4 x i32>
  %i.abb = shl nuw nsw <4 x i32> %i.aba, splat (i32 10) ; 2 uses
  %i.abc = zext nneg <4 x i32> %i.abb to <4 x i64>
  %i.abd = mul nuw nsw <4 x i64> %i.abc, splat (i64 5039)
  %i.abe = lshr <4 x i64> %i.abd, splat (i64 24)  ; 2 uses
  %i.abf = trunc nuw nsw <4 x i64> %i.abe to <4 x i32>
  %i.abg = mul nsw <4 x i32> %i.abf, splat (i32 -3329)
  %i.abh = add nsw <4 x i32> %i.abg, %i.abb       ; 2 uses
end_hunk_2
...
.lr.ph.preheader.i.1.i:                           ; preds = %._crit_edge.i.1.i, %.lr.ph47.i.1.i
  ...
  %indvars.iv55.i.1.i = phi i32 [ %.03649.i.1.i, %.lr.ph47.i.1.i ], [ %indvars.iv.next56.i.1.i, %._crit_edge.i.1.i ] ; 4 uses
  %indvars.iv.i.1.i16 = phi i64 [ 0, %.lr.ph47.i.1.i ], [ %indvars.iv.next.i.1.i21, %._crit_edge.i.1.i ] ; 5 uses
  %i.oy = mul i64 %indvars.iv57.i.1.i, %i.op
  %11 = zext nneg i32 %indvars.iv55.i.1.i to i64
  %12 = sub i64 %11, %i.oy                        ; 3 uses
  %gep69.i.1.i = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep68.i.1.i, i64 %indvars.iv57.i.1.i
  %i.oz = load i16, ptr %gep69.i.1.i, align 2, !tbaa !639
  %i.pa = zext i16 %i.oz to i32                   ; 2 uses
  %wide.trip.count.i.1.i = zext i32 %indvars.iv55.i.1.i to i64
  %min.iters.check221 = icmp ult i64 %12, 8
...
vector.ph222:                                     ; preds = %vector.memcheck
  %n.vec223 = and i64 %12, -8                     ; 3 uses
  %i.pj = add i64 %indvars.iv.i.1.i16, %n.vec223
  %broadcast.splatinsert224 = insertelement <8 x i32> poison, i32 %i.pa, i64 0
...
middle.block231:                                  ; preds = %vector.body226
  %cmp.n232 = icmp eq i64 %12, %n.vec223
...
.lr.ph.preheader.i.2.i:                           ; preds = %._crit_edge.i.2.i, %.lr.ph47.i.2.i
  ...
  %indvars.iv55.i.2.i = phi i32 [ %.03649.i.2.i, %.lr.ph47.i.2.i ], [ %indvars.iv.next56.i.2.i, %._crit_edge.i.2.i ] ; 4 uses
  %indvars.iv.i.2.i22 = phi i64 [ 0, %.lr.ph47.i.2.i ], [ %indvars.iv.next.i.2.i27, %._crit_edge.i.2.i ] ; 5 uses
  %i.sj = mul i64 %indvars.iv57.i.2.i, %i.sa
  %13 = zext nneg i32 %indvars.iv55.i.2.i to i64
  %14 = sub i64 %13, %i.sj                        ; 3 uses
  %gep69.i.2.i = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep68.i.2.i, i64 %indvars.iv57.i.2.i
  %i.sk = load i16, ptr %gep69.i.2.i, align 2, !tbaa !639
  %i.sl = zext i16 %i.sk to i32                   ; 2 uses
  %wide.trip.count.i.2.i = zext i32 %indvars.iv55.i.2.i to i64
  %min.iters.check252 = icmp ult i64 %14, 8
...
vector.ph253:                                     ; preds = %vector.memcheck241
  %n.vec254 = and i64 %14, -8                     ; 3 uses
  %i.su = add i64 %indvars.iv.i.2.i22, %n.vec254
  %broadcast.splatinsert255 = insertelement <8 x i32> poison, i32 %i.sl, i64 0
...
middle.block262:                                  ; preds = %vector.body257
  %cmp.n263 = icmp eq i64 %14, %n.vec254
...
.lr.ph.preheader.i.3.i:                           ; preds = %._crit_edge.i.3.i, %.lr.ph47.i.3.i
  ...
  %indvars.iv55.i.3.i = phi i32 [ %.03649.i.3.i, %.lr.ph47.i.3.i ], [ %indvars.iv.next56.i.3.i, %._crit_edge.i.3.i ] ; 4 uses
  %indvars.iv.i.3.i28 = phi i64 [ 0, %.lr.ph47.i.3.i ], [ %indvars.iv.next.i.3.i33, %._crit_edge.i.3.i ] ; 5 uses
  %i.vu = mul i64 %indvars.iv57.i.3.i, %i.vl
  %15 = zext nneg i32 %indvars.iv55.i.3.i to i64
  %16 = sub i64 %15, %i.vu                        ; 3 uses
  %gep69.i.3.i = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep68.i.3.i, i64 %indvars.iv57.i.3.i
  %i.vv = load i16, ptr %gep69.i.3.i, align 2, !tbaa !639
  %i.vw = zext i16 %i.vv to i32                   ; 2 uses
  %wide.trip.count.i.3.i = zext i32 %indvars.iv55.i.3.i to i64
  %min.iters.check283 = icmp ult i64 %16, 8
...
vector.ph284:                                     ; preds = %vector.memcheck272
  %n.vec285 = and i64 %16, -8                     ; 3 uses
  %i.wf = add i64 %indvars.iv.i.3.i28, %n.vec285
  %broadcast.splatinsert286 = insertelement <8 x i32> poison, i32 %i.vw, i64 0
...
middle.block293:                                  ; preds = %vector.body288
  %cmp.n294 = icmp eq i64 %16, %n.vec285
...
.lr.ph.preheader.i:                               ; preds = %._crit_edge.i, %.lr.ph47.i
  ...
  %i.ack = mul i64 %indvars.iv57.i, %i.abl
  %17 = zext nneg i32 %indvars.iv55.i to i64
  %18 = sub i64 %17, %i.ack                       ; 3 uses
  %gep69.i = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep68.i, i64 %indvars.iv57.i
  %i.acl = load i16, ptr %gep69.i, align 2, !tbaa !639
  %i.acm = zext i16 %i.acl to i32                 ; 2 uses
  %wide.trip.count.i = zext i32 %indvars.iv55.i to i64
  %min.iters.check354 = icmp ult i64 %18, 8
...
vector.ph355:                                     ; preds = %vector.memcheck343
  %n.vec356 = and i64 %18, -8                     ; 3 uses
  %i.acu = add i64 %indvars.iv.i54, %n.vec356
  %broadcast.splatinsert357 = insertelement <8 x i32> poison, i32 %i.acm, i64 0
...
middle.block364:                                  ; preds = %vector.body359
  %cmp.n365 = icmp eq i64 %18, %n.vec356
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  %i.aeh = mul i32 %i.aeg, %i.acm                 ; 2 uses
...
vector.body394:                                   ; preds = %vector.body386, %vector.body394
  ...
  %i.agu = icmp eq i64 %index.next397, 256
  br i1 %i.agu, label %vector.body401, label %vector.body394, !llvm.loop !1893

vector.body401:                                   ; preds = %vector.body394, %vector.body401
  %index402 = phi i64 [ %index.next407, %vector.body401 ], [ 0, %vector.body394 ] ; 3 uses
  %i.agv = getelementptr inbounds nuw [2 x i8], ptr %9, i64 %index402 ; 3 uses
  %i.agw = getelementptr inbounds nuw i8, ptr %i.agv, i64 16 ; 2 uses
  %wide.load403 = load <8 x i16>, ptr %i.agv, align 2, !tbaa !639
  %wide.load404 = load <8 x i16>, ptr %i.agw, align 2, !tbaa !639
  %i.agx = getelementptr inbounds nuw [2 x i8], ptr %10, i64 %index402 ; 2 uses
  %i.agy = getelementptr inbounds nuw i8, ptr %i.agx, i64 16
  %wide.load405 = load <8 x i16>, ptr %i.agx, align 2, !tbaa !639
  %wide.load406 = load <8 x i16>, ptr %i.agy, align 2, !tbaa !639
  %i.agz = add <8 x i16> %wide.load405, %wide.load403 ; 2 uses
  %i.aha = add <8 x i16> %wide.load406, %wide.load404 ; 2 uses
  %i.ahb = add <8 x i16> %i.agz, splat (i16 -3329) ; 2 uses
  %i.ahc = add <8 x i16> %i.aha, splat (i16 -3329) ; 2 uses
  %i.ahd = icmp slt <8 x i16> %i.ahb, zeroinitializer
  %i.ahe = icmp slt <8 x i16> %i.ahc, zeroinitializer
  %i.ahf = select <8 x i1> %i.ahd, <8 x i16> %i.agz, <8 x i16> zeroinitializer
  %i.ahg = select <8 x i1> %i.ahe, <8 x i16> %i.aha, <8 x i16> zeroinitializer
  %i.ahh = call <8 x i16> @llvm.smax.v8i16(<8 x i16> %i.ahb, <8 x i16> zeroinitializer)
  %i.ahi = call <8 x i16> @llvm.smax.v8i16(<8 x i16> %i.ahc, <8 x i16> zeroinitializer)
  %i.ahj = or <8 x i16> %i.ahf, %i.ahh
  %i.ahk = or <8 x i16> %i.ahg, %i.ahi
  store <8 x i16> %i.ahj, ptr %i.agv, align 2, !tbaa !639
  store <8 x i16> %i.ahk, ptr %i.agw, align 2, !tbaa !639
  %index.next407 = add nuw i64 %index402, 16      ; 2 uses
  %i.ahl = icmp eq i64 %index.next407, 256
  br i1 %i.ahl, label %vector.body411, label %vector.body401, !llvm.loop !1894

vector.body411:                                   ; preds = %vector.body401, %vector.body411
  %index412 = phi i64 [ %index.next414, %vector.body411 ], [ 0, %vector.body401 ] ; 2 uses
  %i.ahm = getelementptr inbounds nuw [2 x i8], ptr %8, i64 %index412 ; 2 uses
  %wide.load413 = load <4 x i16>, ptr %i.ahm, align 2, !tbaa !639
  %i.ahn = zext <4 x i16> %wide.load413 to <4 x i32>
  %i.aho = shl nuw nsw <4 x i32> %i.ahn, splat (i32 11) ; 2 uses
  %i.ahp = zext nneg <4 x i32> %i.aho to <4 x i64>
  %i.ahq = mul nuw nsw <4 x i64> %i.ahp, splat (i64 5039)
  %i.ahr = lshr <4 x i64> %i.ahq, splat (i64 24)  ; 2 uses
  %i.ahs = trunc nuw nsw <4 x i64> %i.ahr to <4 x i32>
  %i.aht = mul nsw <4 x i32> %i.ahs, splat (i32 -3329)
  %i.ahu = add nsw <4 x i32> %i.aht, %i.aho       ; 2 uses
  %i.ahv = icmp ugt <4 x i32> %i.ahu, splat (i32 1664)
  %i.ahw = zext <4 x i1> %i.ahv to <4 x i64>
  %i.ahx = add nuw nsw <4 x i64> %i.ahr, %i.ahw
  %i.ahy = icmp ugt <4 x i32> %i.ahu, splat (i32 4993)
  %i.ahz = zext <4 x i1> %i.ahy to <4 x i64>
  %i.aia = add nuw nsw <4 x i64> %i.ahx, %i.ahz
  %i.aib = trunc nuw <4 x i64> %i.aia to <4 x i16>
  %i.aic = and <4 x i16> %i.aib, splat (i16 2047)
  store <4 x i16> %i.aic, ptr %i.ahm, align 2, !tbaa !639
  %index.next414 = add nuw i64 %index412, 4       ; 2 uses
  %i.aid = icmp eq i64 %index.next414, 256
  br i1 %i.aid, label %vector.body418, label %vector.body411, !llvm.loop !1895

vector.body418:                                   ; preds = %vector.body411, %vector.body418
  %index419 = phi i64 [ %index.next421, %vector.body418 ], [ 0, %vector.body411 ] ; 2 uses
  %i.aie = getelementptr inbounds nuw [2 x i8], ptr %i.on, i64 %index419 ; 2 uses
  %wide.load420 = load <4 x i16>, ptr %i.aie, align 2, !tbaa !639
  %i.aif = zext <4 x i16> %wide.load420 to <4 x i32>
  %i.aig = shl nuw nsw <4 x i32> %i.aif, splat (i32 11) ; 2 uses
  %i.aih = zext nneg <4 x i32> %i.aig to <4 x i64>
  %i.aii = mul nuw nsw <4 x i64> %i.aih, splat (i64 5039)
  %i.aij = lshr <4 x i64> %i.aii, splat (i64 24)  ; 2 uses
  %i.aik = trunc nuw nsw <4 x i64> %i.aij to <4 x i32>
  %i.ail = mul nsw <4 x i32> %i.aik, splat (i32 -3329)
  %i.aim = add nsw <4 x i32> %i.ail, %i.aig       ; 2 uses
end_hunk_3
