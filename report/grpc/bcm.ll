...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load241 = load <4 x i8>, ptr %i.be, align 1, !tbaa !80, !alias.scope !435
  %i.bf = getelementptr inbounds nuw i8, ptr %4, i64 %i.bd ; 2 uses
  %wide.load242 = load <4 x i8>, ptr %i.bf, align 1, !tbaa !80, !alias.scope !436, !noalias !437
  %i.bg = xor <4 x i8> %wide.load242, %wide.load241 ; 2 uses
  store <4 x i8> %i.bg, ptr %i.bf, align 1, !tbaa !80, !alias.scope !436, !noalias !437
  %i.bh = getelementptr inbounds nuw i8, ptr %.194.lcssa, i64 %i.bd
  store <4 x i8> %i.bg, ptr %i.bh, align 1, !tbaa !80, !alias.scope !438, !noalias !435
...
vec.epilog.vector.body288:                        ; preds = %vec.epilog.vector.body288, %vec.epilog.ph286
  ...
  %wide.load290 = load <4 x i8>, ptr %i.ek, align 1, !tbaa !80, !alias.scope !439, !noalias !440
  %i.el = getelementptr inbounds nuw i8, ptr %.3.lcssa, i64 %i.ej
  %wide.load291 = load <4 x i8>, ptr %i.el, align 1, !tbaa !80, !alias.scope !440 ; 2 uses
  %i.em = xor <4 x i8> %wide.load291, %wide.load290
  %i.en = getelementptr inbounds nuw i8, ptr %.396.lcssa, i64 %i.ej
  store <4 x i8> %i.em, ptr %i.en, align 1, !tbaa !80, !alias.scope !441, !noalias !442
  store <4 x i8> %wide.load291, ptr %i.ek, align 1, !tbaa !80, !alias.scope !439, !noalias !440
...
vec.epilog.ph:                                    ; preds = %vector.memcheck
  %n.vec95 = and i64 %.198.lcssa.i, 12            ; 3 uses
  %i.ay = and i64 %.198.lcssa.i, 3
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load97 = load <4 x i8>, ptr %i.be, align 1, !tbaa !80, !alias.scope !513
  %i.bf = getelementptr inbounds nuw i8, ptr %4, i64 %i.bd ; 2 uses
  %wide.load98 = load <4 x i8>, ptr %i.bf, align 1, !tbaa !80, !alias.scope !514, !noalias !515
  %i.bg = xor <4 x i8> %wide.load98, %wide.load97 ; 2 uses
  store <4 x i8> %i.bg, ptr %i.bf, align 1, !tbaa !80, !alias.scope !514, !noalias !515
  %i.bh = getelementptr inbounds nuw i8, ptr %.194.lcssa.i, i64 %i.bd
  store <4 x i8> %i.bg, ptr %i.bh, align 1, !tbaa !80, !alias.scope !516, !noalias !513
...
iter.check138:                                    ; preds = %._crit_edge157.i
  tail call void @aes_nohw_encrypt(ptr noundef readonly %4, ptr noundef %4, ptr noundef readonly %3)
  %min.iters.check122 = icmp samesign ult i64 %.4.lcssa.i, 4
...
vec.epilog.ph142:                                 ; preds = %vector.memcheck104
  %n.vec143 = and i64 %.4.lcssa.i, 12             ; 3 uses
  %i.ee = and i64 %.4.lcssa.i, 3
...
vec.epilog.vector.body144:                        ; preds = %vec.epilog.vector.body144, %vec.epilog.ph142
  ...
  %i.ej = zext i32 %i.ei to i64                   ; 3 uses
  %i.ek = getelementptr inbounds nuw i8, ptr %4, i64 %i.ej ; 2 uses
  %wide.load146 = load <4 x i8>, ptr %i.ek, align 1, !tbaa !80, !alias.scope !517, !noalias !518
  %i.el = getelementptr inbounds nuw i8, ptr %.3.lcssa.i, i64 %i.ej
  %wide.load147 = load <4 x i8>, ptr %i.el, align 1, !tbaa !80, !alias.scope !518 ; 2 uses
  %i.em = xor <4 x i8> %wide.load147, %wide.load146
  %i.en = getelementptr inbounds nuw i8, ptr %.396.lcssa.i, i64 %i.ej
  store <4 x i8> %i.em, ptr %i.en, align 1, !tbaa !80, !alias.scope !519, !noalias !520
  store <4 x i8> %wide.load147, ptr %i.ek, align 1, !tbaa !80, !alias.scope !517, !noalias !518
