...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.o = zext i32 %i.n to i64                     ; 9 uses
...
.lr.ph.preheader:                                 ; preds = %bb.f
  ...
  %isnotneg.i.i.inv = icmp slt i64 %i.aa, 0
  %6 = add i64 %5, -14
  %7 = sub i64 %6, %i.o
  %8 = sub i64 13, %5
  %9 = and i64 %7, %8
  %isnotneg.i.i.inv.a = icmp slt i64 %9, 0
  %10 = add i64 %5, -13
  %11 = sub i64 %10, %i.o
  %12 = sub i64 12, %5
  %13 = and i64 %11, %12
  %isnotneg.i.i.inv.2 = icmp slt i64 %13, 0
  %i.ac = add i64 %5, -12
  %i.ad = sub i64 %i.ac, %i.o
  %i.ae = sub i64 11, %5
  %i.af = and i64 %i.ad, %i.ae
  %isnotneg.i.i.inv.3 = icmp slt i64 %i.af, 0
  %14 = load <4 x i8>, ptr %i.ab, align 1, !tbaa !13
  %15 = icmp eq <4 x i8> %14, zeroinitializer     ; 4 uses
  %16 = extractelement <4 x i1> %15, i64 0
  %17 = select i1 %isnotneg.i.i.inv, i1 true, i1 %16
  %18 = extractelement <4 x i1> %15, i64 1
  %19 = select i1 %isnotneg.i.i.inv.a, i1 true, i1 %18
  %20 = extractelement <4 x i1> %15, i64 2
  %21 = select i1 %isnotneg.i.i.inv.2, i1 true, i1 %20
  %22 = extractelement <4 x i1> %15, i64 3
  %23 = select i1 %isnotneg.i.i.inv.3, i1 true, i1 %22
  %24 = add i64 %5, -11                           ; 2 uses
  %25 = sub i64 %24, %i.o
  %26 = sub i64 10, %5
  %27 = and i64 %25, %26
  %28 = getelementptr inbounds nuw i8, ptr %1, i64 %24
  %29 = load i8, ptr %28, align 1, !tbaa !13
  %isnotneg.i.i.inv.4 = icmp slt i64 %27, 0
  %30 = icmp eq i8 %29, 0
  %31 = select i1 %isnotneg.i.i.inv.4, i1 true, i1 %30
  %32 = add i64 %5, -10                           ; 2 uses
  %i.ag = sub i64 %32, %i.o
  %i.ah = sub i64 9, %5
  %i.ai = and i64 %i.ag, %i.ah
  %i.aj = getelementptr inbounds nuw i8, ptr %1, i64 %32
  %i.ak = load i8, ptr %i.aj, align 1, !tbaa !13
  %isnotneg.i.i.inv.6.a = icmp slt i64 %i.ai, 0
  %i.al = icmp eq i8 %i.ak, 0
  %i.am = select i1 %isnotneg.i.i.inv.6.a, i1 true, i1 %i.al
  %33 = sub i64 %i.s, %i.o
  %34 = sub i64 8, %5
  %35 = and i64 %33, %34
  %36 = getelementptr inbounds nuw i8, ptr %1, i64 %i.s
  %37 = load i8, ptr %36, align 1, !tbaa !13
  %isnotneg.i.i.inv.6 = icmp slt i64 %35, 0
  %i.an = icmp eq i8 %37, 0
  %38 = select i1 %isnotneg.i.i.inv.6, i1 true, i1 %i.an
  %39 = select i1 %38, i1 %i.am, i1 false
  %40 = select i1 %39, i1 %31, i1 false
  %op.rdx = select i1 %40, i1 %23, i1 false
  %41 = select i1 %op.rdx, i1 %21, i1 false
  %42 = select i1 %41, i1 %19, i1 false
  %op.rdx44 = select i1 %42, i1 %17, i1 false
  %i.ao = select i1 %op.rdx44, i64 %i.v, i64 0
  br label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph.preheader, %bb.f
  %.033.lcssa = phi i64 [ %i.v, %bb.f ], [ %i.ao, %.lr.ph.preheader ] ; 2 uses
  %i.ap = call noundef i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %.033.lcssa) #38, !srcloc !156
  %i.aq = and i64 %i.ap, %i.o
  store i64 %i.aq, ptr %2, align 8, !tbaa !94
  %i.ar = trunc nsw i64 %.033.lcssa to i32
  %i.as = and i32 %i.ar, 1
  br label %bb.g

bb.g:                                             ; preds = %._crit_edge, %bb.e
  %.0 = phi i32 [ 0, %bb.e ], [ %i.as, %._crit_edge ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #36
  br label %bb.h

bb.h:                                             ; preds = %bb.a, %bb.b, %bb.g
  %.1 = phi i32 [ %.0, %bb.g ], [ 0, %bb.b ], [ 0, %bb.a ]
  ret i32 %.1
}
