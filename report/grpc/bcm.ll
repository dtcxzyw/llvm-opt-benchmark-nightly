...
bb.c:                                             ; preds = %bb.a, %bb.c
  ...
  %.026.tr = trunc nuw i64 %.026 to i32
  %i.fi = shl nuw i32 %.026.tr, 11
  ...
  %.026.tr27 = trunc nuw i64 %.026 to i32
  %i.fp = shl nuw i32 %.026.tr27, 10
  ...
  %.026.tr28 = trunc nuw i64 %.026 to i32
  %i.fw = shl nuw i32 %.026.tr28, 9
  ...
  %.026.tr29 = trunc nuw i64 %.026 to i32
  %i.gd = shl nuw i32 %.026.tr29, 8
  ...
  %.026.tr30 = trunc nuw i64 %.026 to i32
  %i.gk = shl nuw i32 %.026.tr30, 7
  ...
  %.026.tr31 = trunc nuw i64 %.026 to i32
  %i.gr = shl nuw i32 %.026.tr31, 6
  ...
  %.026.tr32 = trunc nuw i64 %.026 to i32
  %i.gy = shl nuw i32 %.026.tr32, 5
  ...
  %.026.tr33 = trunc nuw i64 %.026 to i32
  %i.hf = shl nuw i32 %.026.tr33, 4
  ...
  %.026.tr34 = trunc nuw i64 %.026 to i32
  %i.hm = shl nuw i32 %.026.tr34, 3
  ...
  %.026.tr35 = trunc nuw i64 %.026 to i32
  %i.ht = shl nuw i32 %.026.tr35, 2
  ...
  %.026.tr36 = trunc nuw i64 %.026 to i32
  %i.ia = shl nuw i32 %.026.tr36, 1
