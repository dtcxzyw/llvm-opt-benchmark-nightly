...
bb.f:                                             ; preds = %bb.e
  ...
  %i.o = load i8, ptr %i.k, align 1, !tbaa !36
...
bb.n:                                             ; preds = %bb.m, %bb.l, %bb.i, %bb.h
  ...
  store ptr %i.ah, ptr %2, align 8, !tbaa !35
...
bb.p:                                             ; preds = %bb.o
  ...
  br i1 %i.ak, label %bb.q, label %_ZL19split_host_and_portPPcS0_PKc.exit
...
.critedge.sink.split.i:                           ; preds = %bb.q, %bb.o
  ...
  store ptr null, ptr %.sink.i, align 8, !tbaa !35
  %.0..0..0.79.pre = load ptr, ptr %3, align 8
  br label %_ZL19split_host_and_portPPcS0_PKc.exit

_ZL19split_host_and_portPPcS0_PKc.exit:           ; preds = %bb.p, %.critedge.sink.split.i
...
.thread:                                          ; preds = %_ZL19split_host_and_portPPcS0_PKc.exit
  %i.al = load ptr, ptr %i.f, align 8, !tbaa !29
  call void @OPENSSL_free(ptr noundef %i.al) #8
  store ptr %.0..0.79, ptr %i.f, align 8, !tbaa !29
  %i.am = load ptr, ptr %i.e, align 8, !tbaa !28
  call void @OPENSSL_free(ptr noundef %i.am) #8
  %.0..0..0.81 = load ptr, ptr %2, align 8, !tbaa !35 ; 2 uses
  store ptr %.0..0..0.81, ptr %i.e, align 8, !tbaa !28
  call void @llvm.lifetime.end.p0(ptr nonnull %3)
  call void @llvm.lifetime.end.p0(ptr nonnull %2)
  %.pre = load ptr, ptr %i.f, align 8, !tbaa !29
  br label %bb.r

.loopexit88.loopexit:                             ; preds = %_ZL19split_host_and_portPPcS0_PKc.exit
  %.0..0..0.80.pre = load ptr, ptr %2, align 8, !tbaa !35
  br label %.loopexit88
...
bb.y:                                             ; preds = %bb.w
  ...
  %i.be = load i32, ptr %i.h, align 8, !tbaa !37
...
bb.aa:                                            ; preds = %bb.z
  ...
  store i32 2, ptr %i.bi, align 4, !tbaa !38
  br label %.loopexit
...
bb.ae:                                            ; preds = %bb.ad
  ...
  store i32 2, ptr %i.bo, align 4, !tbaa !38
  br label %.loopexit
