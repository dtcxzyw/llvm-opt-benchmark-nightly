...
begin_hunk_0_@_ZNK3re213PrefilterTree8KeepNodeEPNS_9PrefilterE:bb.a
  %i.ax = getelementptr inbounds nuw [8 x i8], ptr %i.aw, i64 %.02942
  %i.ay = load ptr, ptr %i.ax, align 8, !tbaa !42
  %i.az = tail call noundef zeroext i1 @_ZNK3re213PrefilterTree8KeepNodeEPNS_9PrefilterE(ptr noundef nonnull align 8 dereferenceable(104) %0, ptr noundef %i.ay)
  %i.ba = load ptr, ptr %i.am, align 8, !tbaa !33 ; 4 uses
  %i.bb = getelementptr inbounds nuw [8 x i8], ptr %i.ba, i64 %.02942
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !42 ; 4 uses
  br i1 %i.az, label %bb.n, label %bb.o

bb.n:                                             ; preds = %.lr.ph43
  %i.bd = add nsw i32 %.03041, 1
  %i.be = sext i32 %.03041 to i64
  %i.bf = getelementptr inbounds nuw [8 x i8], ptr %i.ba, i64 %i.be
  store ptr %i.bc, ptr %i.bf, align 8, !tbaa !42
  br label %bb.q
...
bb.p:                                             ; preds = %bb.o
  ...
  %.pre = load ptr, ptr %i.am, align 8, !tbaa !33
  br label %bb.q
...
bb.q:                                             ; preds = %bb.n, %bb.p, %bb.o
  ...
  %i.bj = load ptr, ptr %i.an, align 8, !tbaa !32 ; 2 uses
  %i.bk = ptrtoint ptr %i.bj to i64
  %i.bl = ptrtoint ptr %i.bh to i64
  %i.bm = sub i64 %i.bk, %i.bl
  %i.bn = ashr exact i64 %i.bm, 3                 ; 2 uses
  %i.bo = icmp ult i64 %i.bi, %i.bn
  br i1 %i.bo, label %.lr.ph43, label %._crit_edge, !llvm.loop !143
...
bb.r:                                             ; preds = %.lr.ph
  ...
  %i.bt = load ptr, ptr %i.bq, align 8, !tbaa !33 ; 2 uses
  %i.bu = ptrtoint ptr %i.bs to i64
  %i.bv = ptrtoint ptr %i.bt to i64
  %i.bw = sub i64 %i.bu, %i.bv
  %i.bx = ashr exact i64 %i.bw, 3
  %.not = icmp ult i64 %i.bp, %i.bx
  br i1 %.not, label %.lr.ph, label %.loopexit, !llvm.loop !144
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit: ; preds = %bb.b
  %i.f = load i8, ptr %2, align 8, !tbaa !58, !range !44, !noundef !45
...
bb.d:                                             ; preds = %bb.c, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
  ...
  store ptr %i.h, ptr %i.d, align 8, !tbaa !60
  ...
  store ptr %i.i, ptr %i.l, align 8, !tbaa !60
  %i.m = getelementptr inbounds nuw i8, ptr %2, i64 16 ; 2 uses
  store ptr getelementptr inbounds nuw inrange(-16, 112) (i8, ptr @_ZTVNSt7__cxx1115basic_stringbufIcSt11char_traitsIcESaIcEEE, i64 16), ptr %i.m, align 8, !tbaa !60
  %i.n = getelementptr inbounds nuw i8, ptr %2, i64 88
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !61   ; 2 uses
...
_ZN10LogMessageD2Ev.exit:                         ; preds = %bb.d, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i
  store ptr getelementptr inbounds nuw inrange(-16, 112) (i8, ptr @_ZTVSt15basic_streambufIcSt11char_traitsIcEE, i64 16), ptr %i.m, align 8, !tbaa !60
...
.preheader31:                                     ; preds = %bb.h
  ...
  %i.ak = load ptr, ptr %0, align 8, !tbaa !37    ; 5 uses
...
._crit_edge41:                                    ; preds = %_ZNSt6vectorIiSaIiEE5clearEv.exit, %.preheader31
  %i.ap = load ptr, ptr %i.ae, align 8, !tbaa !80
...
.lr.ph40:                                         ; preds = %.lr.ph40.preheader, %_ZNSt6vectorIiSaIiEE5clearEv.exit
  %.01939 = phi i64 [ %i.bo, %_ZNSt6vectorIiSaIiEE5clearEv.exit ], [ 0, %.lr.ph40.preheader ] ; 2 uses
...
.lr.ph.a:                                         ; preds = %.lr.ph40, %.lr.ph.backedge
...
bb.k:                                             ; preds = %.lr.ph.a
  %i.bb = load i32, ptr %.sroa.026.033, align 4, !tbaa !84
  %i.bc = sext i32 %i.bb to i64
  %i.bd = getelementptr inbounds nuw [56 x i8], ptr %i.ak, i64 %i.bc
  %i.be = load i32, ptr %i.bd, align 8, !tbaa !86
  %i.bf = icmp sgt i32 %i.be, 1                   ; 2 uses
  %i.bg = getelementptr inbounds nuw i8, ptr %.sroa.026.033, i64 4 ; 2 uses
  %.not = icmp eq ptr %i.bg, %i.aw
  br i1 %.not, label %._crit_edge, label %.lr.ph.backedge

.lr.ph.backedge:                                  ; preds = %bb.k, %.thread
  %.01834.be = phi i1 [ false, %.thread ], [ %i.bf, %bb.k ]
  %.sroa.026.033.be = phi ptr [ %i.bh, %.thread ], [ %i.bg, %bb.k ]
  br label %.lr.ph.a

.thread:                                          ; preds = %.lr.ph.a
  %i.bh = getelementptr inbounds nuw i8, ptr %.sroa.026.033, i64 4 ; 2 uses
  %.not50 = icmp eq ptr %i.bh, %i.aw
...
_ZSt8_DestroyIPiiEvT_S1_RSaIT0_E.exit.i.i:        ; preds = %.lr.ph37
  store ptr %i.ax, ptr %i.av, align 8, !tbaa !83
  br label %_ZNSt6vectorIiSaIiEE5clearEv.exit

.lr.ph37:                                         ; preds = %._crit_edge, %.lr.ph37
  %.sroa.022.036 = phi ptr [ %i.bn, %.lr.ph37 ], [ %i.ax, %._crit_edge ] ; 2 uses
  %i.bi = load i32, ptr %.sroa.022.036, align 4, !tbaa !84
  %i.bj = sext i32 %i.bi to i64
  %i.bk = getelementptr inbounds nuw [56 x i8], ptr %i.ak, i64 %i.bj ; 2 uses
  %i.bl = load i32, ptr %i.bk, align 8, !tbaa !86
  %i.bm = add nsw i32 %i.bl, -1
  store i32 %i.bm, ptr %i.bk, align 8, !tbaa !86
  %i.bn = getelementptr inbounds nuw i8, ptr %.sroa.022.036, i64 4 ; 2 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.a, %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i.i
  ...
  %i.f = load ptr, ptr %.05.i.i.i.i, align 8, !tbaa !61 ; 2 uses
...
_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i.i: ; preds = %.lr.ph.i.i.i.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i, label %_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E.exit.i.i, label %.lr.ph.i.i.i.i, !llvm.loop !148
...
_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE5clearEv.exit: ; preds = %bb.a, %_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E.exit.i.i
  ...
  %i.o = load ptr, ptr %i.l, align 8, !tbaa !33   ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.y = load ptr, ptr %i.q, align 8, !tbaa !83   ; 4 uses
  %i.z = load ptr, ptr %i.r, align 8, !tbaa !35
  %.not.i.i98 = icmp eq ptr %i.y, %i.z
  br i1 %.not.i.i98, label %bb.e, label %bb.d

bb.d:                                             ; preds = %bb.c
  store i32 %i.x, ptr %i.y, align 4, !tbaa !84
  %i.aa = getelementptr inbounds nuw i8, ptr %i.y, i64 4
  store ptr %i.aa, ptr %i.q, align 8, !tbaa !83
  br label %_ZNSt6vectorIiSaIiEE9push_backEOi.exit

bb.e:                                             ; preds = %bb.c
  %i.ab = load ptr, ptr %i.p, align 8, !tbaa !34  ; 4 uses
...
.noexc100:                                        ; preds = %_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit.i.i.i
  ...
  store i32 %i.x, ptr %i.an, align 4, !tbaa !84
...
bb.h:                                             ; preds = %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit16.i.i.i
  %i.aq = load ptr, ptr %i.r, align 8, !tbaa !35
...
_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i.i: ; preds = %bb.h, %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit16.i.i.i
  store ptr %i.am, ptr %i.p, align 8, !tbaa !34
  store ptr %i.ap, ptr %i.q, align 8, !tbaa !83
  %i.at = getelementptr inbounds nuw [4 x i8], ptr %i.am, i64 %i.ak
  store ptr %i.at, ptr %i.r, align 8, !tbaa !35
  br label %_ZNSt6vectorIiSaIiEE9push_backEOi.exit
...
bb.i:                                             ; preds = %_ZNSt6vectorIiSaIiEE9push_backEOi.exit
  store ptr %i.v, ptr %.sroa.16.0281, align 8, !tbaa !42
...
bb.j:                                             ; preds = %_ZNSt6vectorIiSaIiEE9push_backEOi.exit
  ...
  br i1 %i.ax, label %bb.k, label %_ZNKSt6vectorIPN3re29PrefilterESaIS2_EE12_M_check_lenEmPKc.exit.i.i

bb.k:                                             ; preds = %bb.j
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.25) #23
          to label %.noexc101 unwind label %.loopexit.split-lp224

.noexc101:                                        ; preds = %bb.k
  unreachable

_ZNKSt6vectorIPN3re29PrefilterESaIS2_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.j
  ...
  %i.be = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.bd) #24
          to label %.noexc102 unwind label %.loopexit223 ; 4 uses

.noexc102:                                        ; preds = %_ZNKSt6vectorIPN3re29PrefilterESaIS2_EE12_M_check_lenEmPKc.exit.i.i
  %i.bf = getelementptr inbounds i8, ptr %i.be, i64 %i.aw ; 2 uses
  store ptr %i.v, ptr %i.bf, align 8, !tbaa !42
  %i.bg = icmp sgt i64 %i.aw, 0
  br i1 %i.bg, label %bb.l, label %_ZNSt6vectorIPN3re29PrefilterESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit16.i.i

bb.l:                                             ; preds = %.noexc102
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %i.be, ptr align 8 %.sroa.0.0280, i64 %i.aw, i1 false)
end_hunk_0
