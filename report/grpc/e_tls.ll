...
bb.ab:                                            ; preds = %bb.aa
  ...
  br i1 %.not73, label %.critedge, label %bb.ac
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %.not75 = icmp eq i32 %i.bj, 0
  br i1 %.not75, label %.critedge, label %bb.ae
...
bb.af:                                            ; preds = %bb.ae, %bb.z
  %i.bn = phi i64 [ %.pre79, %bb.z ], [ %i.bl, %bb.ae ]
  %.161 = phi ptr [ %i.g, %bb.z ], [ %i.bm, %bb.ae ]
  %i.bo = call i32 @CRYPTO_memcmp(ptr noundef %.161, ptr noundef nonnull %i.e, i64 noundef %i.bn) #5
  %i.bp = icmp ne i32 %i.bo, 0
  %i.bq = load i64, ptr %i.c, align 8, !tbaa !26
  %.not7778 = icmp eq i64 %i.bq, 0
  %.not77 = select i1 %i.bp, i1 true, i1 %.not7778
  br i1 %.not77, label %bb.ag, label %bb.ah
...
bb.p:                                             ; preds = %bb.o
  ...
  br i1 %.not82, label %bb.aa, label %bb.q
...
bb.s:                                             ; preds = %bb.r
  ...
  br i1 %.not84, label %bb.aa, label %bb.t
...
bb.t:                                             ; preds = %bb.s, %bb.r, %bb.q
  ...
  %.not85 = icmp eq i32 %i.am, 0
  br i1 %.not85, label %bb.z, label %bb.u
...
bb.u:                                             ; preds = %bb.t
  ...
  %.zext94 = zext i32 %13 to i64                  ; 6 uses
  %.not86 = icmp eq i32 %13, 0
  br i1 %.not86, label %._crit_edge, label %bb.v
...
bb.v:                                             ; preds = %bb.u
  ...
  %.not87.not = icmp eq i32 %i.aq, 0
  br i1 %.not87.not, label %.critedge, label %_ZL14OPENSSL_memcpyPvPKvm.exit91

_ZL14OPENSSL_memcpyPvPKvm.exit91:                 ; preds = %bb.v
  %i.ar = sub nuw nsw i64 %i.ao, %.zext94
  ...
  %i.aw = sub nsw i64 0, %.zext94
  %i.ax = getelementptr inbounds i8, ptr %i.av, i64 %i.aw
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %2, ptr nonnull readonly align 1 %i.ax, i64 %.zext94, i1 false)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f) #5
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #5
  br label %._crit_edge

._crit_edge:                                      ; preds = %bb.u, %_ZL14OPENSSL_memcpyPvPKvm.exit91
  %.pre-phi = phi i32 [ %13, %_ZL14OPENSSL_memcpyPvPKvm.exit91 ], [ 0, %bb.u ]
  %i.ay = getelementptr inbounds nuw i8, ptr %2, i64 %.zext94
  %i.az = getelementptr inbounds nuw i8, ptr %i.b, i64 %.zext94
  ...
  %.not88 = icmp eq i32 %i.bc, 0
  br i1 %.not88, label %bb.z, label %bb.w

bb.w:                                             ; preds = %._crit_edge
  %i.bd = load i32, ptr %i.d, align 4, !tbaa !25
  %i.be = sext i32 %i.bd to i64
  %i.bf = add nsw i64 %.zext94, %i.be             ; 3 uses
...
_ZL14OPENSSL_memsetPvim.exit:                     ; preds = %bb.w
  ...
  %.not89.not = icmp eq i32 %i.br, 0
  %i.bs = load i32, ptr %i.d, align 4
  %i.bt = sext i32 %i.bs to i64
  %i.bu = add nsw i64 %i.bf, %i.bt
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g) #5
  br i1 %.not89.not, label %bb.z, label %bb.x

bb.x:                                             ; preds = %_ZL14OPENSSL_memsetPvim.exit, %bb.w
  %.171 = phi i64 [ %i.bu, %_ZL14OPENSSL_memsetPvim.exit ], [ %i.bf, %bb.w ] ; 2 uses
  %i.bv = getelementptr inbounds nuw i8, ptr %2, i64 %.171
...
bb.y:                                             ; preds = %bb.x
  store i64 %.171, ptr %3, align 8, !tbaa !26
  br label %bb.z
...
bb.g:                                             ; preds = %bb.f
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.j, ptr readonly align 1 %1, i64 %i.d, i1 false)
