Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/grpc/original/mimics_pcre?download=true
...
_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit: ; preds = %.thread78, %bb.j
  %i.ay = phi ptr [ %i.ax, %bb.j ], [ %i.ar, %.thread78 ] ; 12 uses
...
bb.m:                                             ; preds = %bb.k
  ...
  %i.bt = call noundef zeroext i1 %i.bs(ptr noundef nonnull align 8 dereferenceable(96) %0, ptr noundef %i.ba, i1 noundef zeroext %i.bp, ptr noundef nonnull %i.a)
  %i.bu = getelementptr inbounds i8, ptr %i.ay, i64 -11
  %i.bv = zext i1 %i.bt to i8                     ; 2 uses
...
bb.r:                                             ; preds = %.thread, %_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit
  ...
  br i1 %.not70, label %bb.z, label %bb.s
...
bb.s:                                             ; preds = %bb.r
  ...
  %.not71 = icmp slt i32 %.pre, %i.cj
  br i1 %.not71, label %bb.t, label %bb.z
...
bb.w:                                             ; preds = %bb.u, %bb.t
  ...
  %.not.i.i.i73 = icmp eq ptr %i.do, %i.dq
  br i1 %.not.i.i.i73, label %bb.y, label %bb.x
...
_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit74: ; preds = %bb.x, %bb.y
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #18
  br label %.thread78.backedge

.thread78.backedge:                               ; preds = %_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE4pushEOS2_.exit74, %bb.v, %bb.ah
  br label %.thread78, !llvm.loop !106
...
bb.z:                                             ; preds = %bb.s, %bb.r
  ...
  %i.ee = call noundef zeroext i1 %i.ed(ptr noundef nonnull align 8 dereferenceable(96) %0, ptr noundef nonnull %i.ba, i1 noundef zeroext %i.dv, i1 noundef zeroext %i.dy, ptr noundef %i.ea, i32 noundef %.pre)
  %8 = zext i1 %i.ee to i8                        ; 3 uses
...
bb.ac:                                            ; preds = %bb.q, %bb.z, %bb.ab, %bb.aa, %bb.l
  %.3 = phi i8 [ %7, %bb.l ], [ %8, %bb.aa ], [ %8, %bb.ab ], [ %8, %bb.z ], [ %i.bv, %bb.q ] ; 3 uses
...
_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3popEv.exit: ; preds = %bb.ac
  ...
  br i1 %i.en, label %.thread82, label %bb.ad
...
_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3popEv.exit.thread: ; preds = %bb.ac
  ...
  br i1 %i.eu, label %.thread82, label %_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit75
...
bb.ad:                                            ; preds = %_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3popEv.exit
  ...
  br i1 %i.ev, label %bb.ae, label %_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit75
...
_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit75: ; preds = %_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3popEv.exit.thread, %bb.ad, %bb.ae
  ...
  %.not72 = icmp eq ptr %i.fc, null
  br i1 %.not72, label %bb.ag, label %bb.af

bb.af:                                            ; preds = %_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit75
  ...
  store i8 %.3, ptr %i.fg, align 1, !tbaa !10
  br label %bb.ah

bb.ag:                                            ; preds = %_ZNSt5stackIN3re29WalkStateIbEESt5dequeIS2_SaIS2_EEE3topEv.exit75
  %i.fh = getelementptr inbounds i8, ptr %i.fa, i64 -10
  store i8 %.3, ptr %i.fh, align 2, !tbaa !110
  %.phi.trans.insert = getelementptr inbounds i8, ptr %i.fa, i64 -16
  %.pre83 = load i32, ptr %.phi.trans.insert, align 8, !tbaa !96
  br label %bb.ah

bb.ah:                                            ; preds = %bb.ag, %bb.af
  %i.fi = phi i32 [ %.pre83, %bb.ag ], [ %i.fe, %bb.af ]
  %i.fj = getelementptr inbounds i8, ptr %i.fa, i64 -16
  %i.fk = add nsw i32 %i.fi, 1
  store i32 %i.fk, ptr %i.fj, align 8, !tbaa !96
  br label %.thread78.backedge

.thread80:                                        ; preds = %.thread82, %_ZN10LogMessageD2Ev.exit
...
_ZNSt11_Deque_baseIN3re29WalkStateIbEESaIS2_EE15_M_allocate_mapEm.exit: ; preds = %bb.k
  ...
  br i1 %i.bc, label %bb.m, label %bb.n, !prof !111
