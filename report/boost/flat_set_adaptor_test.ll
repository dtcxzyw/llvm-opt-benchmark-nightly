...
vector.body169:                                   ; preds = %vector.body169, %vector.ph167
  ...
  %wide.load173 = load <4 x i32>, ptr %next.gep171, align 4, !tbaa !69
  %wide.load174 = load <4 x i32>, ptr %i.bm, align 4, !tbaa !69
  %i.bn = getelementptr i8, ptr %next.gep172, i64 16
  store <4 x i32> %wide.load173, ptr %next.gep172, align 4, !tbaa !69
  store <4 x i32> %wide.load174, ptr %i.bn, align 4, !tbaa !69
  %index.next175 = add nuw i64 %index170, 8       ; 2 uses
  %i.bo = icmp eq i64 %index.next175, %n.vec168
  br i1 %i.bo, label %middle.block176, label %vector.body169, !llvm.loop !2873
...
.lr.ph.i24.i:                                     ; preds = %.lr.ph.i24.i.preheader293, %.lr.ph.i24.i
  ...
  %i.bp = load i32, ptr %.012.i.i, align 4, !tbaa !69
  store i32 %i.bp, ptr %.0911.i.i, align 4, !tbaa !69
  ...
  br i1 %.not.i25.i, label %_ZN5boost7movelib13adaptive_xbufIiPimE11move_assignIS2_EEvT_m.exit, label %.lr.ph.i24.i, !llvm.loop !2874
...
_ZN5boost7movelib13adaptive_xbufIiPimE11move_assignIS2_EEvT_m.exit: ; preds = %.lr.ph.i.i, %.lr.ph.i24.i, %middle.block, %middle.block176, %bb.e, %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit23.i
  ...
  store i64 %i.s, ptr %i.t, align 8, !tbaa !2566
...
vector.body187:                                   ; preds = %vector.body187, %vector.ph185
  ...
  %wide.load191 = load <4 x i32>, ptr %next.gep190, align 4, !tbaa !69
  %wide.load192 = load <4 x i32>, ptr %i.cj, align 4, !tbaa !69
  %i.ck = getelementptr i8, ptr %next.gep189, i64 16
  store <4 x i32> %wide.load191, ptr %next.gep189, align 4, !tbaa !69
  store <4 x i32> %wide.load192, ptr %i.ck, align 4, !tbaa !69
  %index.next193 = add nuw i64 %index188, 8       ; 2 uses
  %i.cl = icmp eq i64 %index.next193, %n.vec186
  br i1 %i.cl, label %middle.block194, label %vector.body187, !llvm.loop !2875
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader286, %.lr.ph.i.i.i
  ...
  %i.cm = load i32, ptr %.079.i.i.i, align 4, !tbaa !69
  store i32 %i.cm, ptr %.010.i.i.i, align 4, !tbaa !69
  ...
  br i1 %.not.i.i.i, label %_ZN5boost7movelib26op_merge_with_right_placedINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEPiSB_NS0_7move_opEEEvT0_SD_T1_SE_SE_T_T2_.exit, label %.lr.ph.i.i.i, !llvm.loop !2876

bb.g:                                             ; preds = %.lr.ph.i40
  %i.cp = load i32, ptr %.01625.i, align 4, !tbaa !69 ; 2 uses
  %i.cq = load i32, ptr %.026.i, align 4, !tbaa !69 ; 2 uses
  ...
  store i32 %.sink.i, ptr %.01824.i, align 4, !tbaa !69
  %i.cs = getelementptr inbounds nuw i8, ptr %.01824.i, i64 4
  %.not.i42 = icmp eq ptr %.1.i41, %i.bt
  %indvar.next = add i64 %indvar, 1
  br i1 %.not.i42, label %_ZN5boost7movelib26op_merge_with_right_placedINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEPiSB_NS0_7move_opEEEvT0_SD_T1_SE_SE_T_T2_.exit, label %.lr.ph.i40, !llvm.loop !2877
...
bb.h:                                             ; preds = %bb.h, %.lr.ph.i44
  ...
  %i.cw = load i32, ptr %i.cv, align 4, !tbaa !69
  ...
  br i1 %.not.i50, label %_ZN5boost7movelib11lower_boundIPiiNS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEEET_SC_SC_RKT0_T1_.exit, label %bb.h, !llvm.loop !2849
...
bb.i:                                             ; preds = %_ZN5boost7movelib11lower_boundIPiiNS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEEET_SC_SC_RKT0_T1_.exit
  ...
  %.pre111 = load ptr, ptr %3, align 8, !tbaa !2564 ; 7 uses
...
vector.body205:                                   ; preds = %vector.body205, %vector.ph203
  ...
  %wide.load209 = load <4 x i32>, ptr %next.gep208, align 4, !tbaa !69
  %wide.load210 = load <4 x i32>, ptr %i.dp, align 4, !tbaa !69
  %i.dq = getelementptr i8, ptr %next.gep207, i64 16
  store <4 x i32> %wide.load209, ptr %next.gep207, align 4, !tbaa !69
  store <4 x i32> %wide.load210, ptr %i.dq, align 4, !tbaa !69
  %index.next211 = add nuw i64 %index206, 8       ; 2 uses
  %i.dr = icmp eq i64 %index.next211, %n.vec204
  br i1 %i.dr, label %middle.block212, label %vector.body205, !llvm.loop !2878
...
.lr.ph.i.i55:                                     ; preds = %.lr.ph.i.i55.preheader284, %.lr.ph.i.i55
  ...
  %i.ds = load i32, ptr %.079.i.i57, align 4, !tbaa !69
  store i32 %i.ds, ptr %.010.i.i56, align 4, !tbaa !69
...
vector.body222:                                   ; preds = %vector.body222, %vector.ph220
  ...
  %wide.load226 = load <4 x i32>, ptr %next.gep225, align 4, !tbaa !69
  %wide.load227 = load <4 x i32>, ptr %i.eg, align 4, !tbaa !69
  %i.eh = getelementptr i8, ptr %next.gep224, i64 16
  store <4 x i32> %wide.load226, ptr %next.gep224, align 4, !tbaa !69
  store <4 x i32> %wide.load227, ptr %i.eh, align 4, !tbaa !69
  %index.next228 = add nuw i64 %index223, 8       ; 2 uses
  %i.ei = icmp eq i64 %index.next228, %n.vec221
  br i1 %i.ei, label %middle.block229, label %vector.body222, !llvm.loop !2880
...
.lr.ph.i18.i61:                                   ; preds = %.lr.ph.i18.i61.preheader283, %.lr.ph.i18.i61
  ...
  %i.ej = load i32, ptr %.079.i20.i63, align 4, !tbaa !69
  store i32 %i.ej, ptr %.010.i19.i62, align 4, !tbaa !69
  ...
  br i1 %.not.i21.i64, label %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit23.i65, label %.lr.ph.i18.i61, !llvm.loop !2881
...
vector.body240:                                   ; preds = %vector.body240, %vector.ph238
  ...
  %wide.load244 = load <4 x i32>, ptr %next.gep242, align 4, !tbaa !69
  %wide.load245 = load <4 x i32>, ptr %i.ey, align 4, !tbaa !69
  %i.ez = getelementptr i8, ptr %next.gep243, i64 16
  store <4 x i32> %wide.load244, ptr %next.gep243, align 4, !tbaa !69
  store <4 x i32> %wide.load245, ptr %i.ez, align 4, !tbaa !69
  %index.next246 = add nuw i64 %index241, 8       ; 2 uses
  %i.fa = icmp eq i64 %index.next246, %n.vec239
  br i1 %i.fa, label %middle.block247, label %vector.body240, !llvm.loop !2882
...
.lr.ph.i24.i68:                                   ; preds = %.lr.ph.i24.i68.preheader282, %.lr.ph.i24.i68
  ...
  %i.fb = load i32, ptr %.012.i.i69, align 4, !tbaa !69
  store i32 %i.fb, ptr %.0911.i.i70, align 4, !tbaa !69
  ...
  br i1 %.not.i25.i71, label %_ZN5boost7movelib13adaptive_xbufIiPimE11move_assignIS2_EEvT_m.exit72, label %.lr.ph.i24.i68, !llvm.loop !2883
...
_ZN5boost7movelib13adaptive_xbufIiPimE11move_assignIS2_EEvT_m.exit72: ; preds = %.lr.ph.i.i55, %.lr.ph.i24.i68, %middle.block212, %middle.block247, %bb.i, %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit23.i65
  ...
  store i64 %i.dc, ptr %i.dd, align 8, !tbaa !2566
...
vector.body261:                                   ; preds = %vector.body261, %vector.ph259
  ...
  %wide.load265 = load <4 x i32>, ptr %i.fu, align 4, !tbaa !69
  %wide.load266 = load <4 x i32>, ptr %i.fv, align 4, !tbaa !69
  %i.fw = getelementptr inbounds i8, ptr %next.gep263, i64 -16
  %i.fx = getelementptr inbounds i8, ptr %next.gep263, i64 -32
  store <4 x i32> %wide.load265, ptr %i.fw, align 4, !tbaa !69
  store <4 x i32> %wide.load266, ptr %i.fx, align 4, !tbaa !69
  %index.next267 = add nuw i64 %index262, 8       ; 2 uses
  %i.fy = icmp eq i64 %index.next267, %n.vec260
  br i1 %i.fy, label %middle.block268, label %vector.body261, !llvm.loop !2884
...
.lr.ph.i.i.i75:                                   ; preds = %.lr.ph.i.i.i75.preheader276, %.lr.ph.i.i.i75
  ...
  %i.gb = load i32, ptr %i.fz, align 4, !tbaa !69
  store i32 %i.gb, ptr %i.ga, align 4, !tbaa !69
  %.not.i.i.i78 = icmp eq ptr %i.fe, %i.fz
  br i1 %.not.i.i.i78, label %_ZN5boost7movelib26op_merge_with_right_placedINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEPiSB_NS0_7move_opEEEvT0_SD_T1_SE_SE_T_T2_.exit, label %.lr.ph.i.i.i75, !llvm.loop !2885
...
bb.k:                                             ; preds = %.lr.ph.i73
  ...
  %i.ge = load i32, ptr %i.gc, align 4, !tbaa !69 ; 2 uses
  %i.gf = load i32, ptr %i.gd, align 4, !tbaa !69 ; 2 uses
  ...
  store i32 %..i, ptr %i.gh, align 4, !tbaa !69
  %.not.i74 = icmp eq ptr %i.fe, %.030..i
  %indvar.next255 = add i64 %indvar254, 1
  br i1 %.not.i74, label %_ZN5boost7movelib26op_merge_with_right_placedINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEPiSB_NS0_7move_opEEEvT0_SD_T1_SE_SE_T_T2_.exit, label %.lr.ph.i73, !llvm.loop !2886
...
bb.b:                                             ; preds = %.lr.ph
  %i.e = load i32, ptr %.07294, align 4, !tbaa !69 ; 2 uses
  %i.f = load i32, ptr %.07493, align 4, !tbaa !69 ; 2 uses
  %i.g = icmp slt i32 %i.e, %i.f
  br i1 %i.g, label %bb.c, label %.loopexit

bb.c:                                             ; preds = %bb.b
  store i32 %i.e, ptr %.07493, align 4, !tbaa !69
  store i32 %i.f, ptr %.07294, align 4, !tbaa !69
  br label %.loopexit
...
.lr.ph37.i:                                       ; preds = %.lr.ph37.i.preheader, %bb.e
  ...
  %i.g = load i32, ptr %.02236.i, align 4, !tbaa !69 ; 3 uses
  %i.h = load i32, ptr %.pn35.i, align 4, !tbaa !69 ; 2 uses
  %i.i = icmp slt i32 %i.g, %i.h
  br i1 %i.i, label %bb.c, label %bb.e

bb.c:                                             ; preds = %.lr.ph37.i
  store i32 %i.h, ptr %.02236.i, align 4, !tbaa !69
...
.critedge.i:                                      ; preds = %bb.d, %.lr.ph.i, %bb.c
  ...
  store i32 %i.g, ptr %.021.lcssa.i, align 4, !tbaa !69
  br label %bb.e

bb.d:                                             ; preds = %.lr.ph.i
  store i32 %i.k, ptr %.030.i, align 4, !tbaa !69
  %.not26.i = icmp eq ptr %i.j, %0
  br i1 %.not26.i, label %.critedge.i, label %.lr.ph.i, !llvm.loop !3329

bb.e:                                             ; preds = %.critedge.i, %.lr.ph37.i
  %.022.i = getelementptr inbounds nuw i8, ptr %.02236.i, i64 4 ; 2 uses
  %.not25.i = icmp eq ptr %.022.i, %i.f
  br i1 %.not25.i, label %_ZN5boost7movelib14insertion_sortINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEPiEEvT0_SC_T_.exit, label %.lr.ph37.i, !llvm.loop !3330

bb.f:                                             ; preds = %bb.a
  %i.m = lshr i64 %1, 1
  %i.n = sub i64 %1, %i.m                         ; 2 uses
  %i.o = getelementptr inbounds nuw i8, ptr %2, i64 16 ; 2 uses
  %i.p = load i64, ptr %i.o, align 8, !tbaa !2567
  %.not = icmp ugt i64 %i.n, %i.p
  br i1 %.not, label %bb.h, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.q = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %1
  %i.r = load ptr, ptr %2, align 8, !tbaa !2564
...
bb.h:                                             ; preds = %bb.f
  ...
  store i64 0, ptr %i.a, align 8, !tbaa !272
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #23
  store i64 0, ptr %i.b, align 8, !tbaa !272
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #23
  store i64 0, ptr %i.c, align 8, !tbaa !272
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #23
  store i64 0, ptr %i.d, align 8, !tbaa !272
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.u = load i64, ptr %i.o, align 8, !tbaa !2567
  %i.v = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.w = load i64, ptr %i.v, align 8, !tbaa !2566 ; 2 uses
  %i.x = sub i64 %i.u, %i.w
  %.not.i31 = icmp ult i64 %i.x, %i.n
  br i1 %.not.i31, label %bb.k, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.y = load ptr, ptr %2, align 8, !tbaa !2564
...
bb.l:                                             ; preds = %bb.h
  %i.aa = load i64, ptr %i.b, align 8, !tbaa !272
  %i.ab = load i64, ptr %i.c, align 8, !tbaa !272
  %i.ac = add i64 %i.ab, %i.aa                    ; 2 uses
  %i.ad = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %i.ac
  %i.ae = load i64, ptr %i.d, align 8, !tbaa !272 ; 3 uses
  %i.af = sub i64 0, %i.ae
  %i.ag = getelementptr inbounds [4 x i8], ptr %i.ad, i64 %i.af
  %i.ah = sub i64 %1, %i.ac
  %i.ai = add i64 %i.ah, %i.ae
  %i.aj = load i64, ptr %i.a, align 8, !tbaa !272
  ...
  %i.al = load i64, ptr %i.c, align 8, !tbaa !272 ; 2 uses
  ...
  %i.ap = load i64, ptr %i.b, align 8, !tbaa !272
  %i.aq = load i64, ptr %i.c, align 8, !tbaa !272
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden void @_ZN5boost7movelib10merge_sortIPiS2_NS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEEEvT_SC_T1_T0_(ptr noundef %0, ptr noundef %1, ptr noundef %2) local_unnamed_addr #1 comdat personality ptr @__gxx_personality_v0 {
bb.a:
...
.lr.ph37.i:                                       ; preds = %bb.b, %bb.e
  ...
  %i.f = load i32, ptr %.02236.i, align 4, !tbaa !69 ; 3 uses
  %i.g = load i32, ptr %.pn35.i, align 4, !tbaa !69 ; 2 uses
  %i.h = icmp slt i32 %i.f, %i.g
  br i1 %i.h, label %bb.c, label %bb.e

bb.c:                                             ; preds = %.lr.ph37.i
  store i32 %i.g, ptr %.02236.i, align 4, !tbaa !69
  %.not2628.i = icmp eq ptr %.pn35.i, %0
  br i1 %.not2628.i, label %.critedge.i, label %.lr.ph.i
...
.critedge.i:                                      ; preds = %bb.d, %.lr.ph.i, %bb.c
  %.021.lcssa.i = phi ptr [ %0, %bb.c ], [ %.030.i, %.lr.ph.i ], [ %0, %bb.d ]
  store i32 %i.f, ptr %.021.lcssa.i, align 4, !tbaa !69
  br label %bb.e

bb.d:                                             ; preds = %.lr.ph.i
  store i32 %i.j, ptr %.030.i, align 4, !tbaa !69
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep53, align 4, !tbaa !69
  %wide.load54 = load <4 x i32>, ptr %i.ae, align 4, !tbaa !69
  %i.af = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %wide.load, ptr %next.gep, align 4, !tbaa !69
  store <4 x i32> %wide.load54, ptr %i.af, align 4, !tbaa !69
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ag = icmp eq i64 %index.next, %n.vec
  br i1 %i.ag, label %middle.block, label %vector.body, !llvm.loop !3331
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.preheader56, %.lr.ph.i.i.i.i
  ...
  %i.ah = load i32, ptr %.079.i.i.i.i, align 4, !tbaa !69
  store i32 %i.ah, ptr %.010.i.i.i.i, align 4, !tbaa !69
  ...
  br i1 %.not.i.i.i.i, label %_ZN5boost7movelib14insertion_sortINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEPiEEvT0_SC_T_.exit, label %.lr.ph.i.i.i.i, !llvm.loop !3332

bb.g:                                             ; preds = %.lr.ph.i.i
  %i.ak = load i32, ptr %.027.i.i, align 4, !tbaa !69 ; 2 uses
  %i.al = load i32, ptr %.01725.i.i, align 4, !tbaa !69 ; 2 uses
  ...
  %indvar.next = add i64 %indvar, 1
  br i1 %.not.i.i, label %_ZN5boost7movelib14insertion_sortINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEPiEEvT0_SC_T_.exit, label %.lr.ph.i.i, !llvm.loop !3333
...
bb.b:                                             ; preds = %bb.b, %bb.a
  ...
  br i1 %.not.i.i.i.1, label %_ZN5boost7movelib15detail_adaptive9ceil_sqrtImEET_S3_.exit.i, label %bb.b, !llvm.loop !2844
...
.lr.ph.i.i.i:                                     ; preds = %_ZN5boost7movelib15detail_adaptive9ceil_sqrtImEET_S3_.exit.i, %.lr.ph.i.i.i
  ...
  br i1 %i.w, label %.lr.ph.i.i.i, label %_ZN5boost7movelib15detail_adaptive20floor_merge_multipleImEET_S3_RS3_S4_.exit.i.i, !llvm.loop !3334
...
bb.f:                                             ; preds = %bb.f, %_ZN5boost7movelib15detail_adaptive18ceil_sqrt_multipleImEET_S3_PS3_.exit
  ...
  br i1 %.not, label %.preheader88, label %bb.f, !llvm.loop !3335
...
bb.g:                                             ; preds = %.preheader88, %bb.g
  ...
  br i1 %.not80, label %bb.h, label %bb.g, !llvm.loop !3336
...
.preheader87:                                     ; preds = %bb.o, %.preheader87
  ...
  br i1 %.not84, label %.preheader, label %.preheader87, !llvm.loop !3337
...
.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  ...
  br i1 %i.bp, label %.lr.ph, label %._crit_edge, !llvm.loop !3338
...
bb.p:                                             ; preds = %._crit_edge, %.preheader
  ...
  %i.bs = load i64, ptr %i.br, align 8, !tbaa !272
  store i64 %i.bs, ptr %4, align 8, !tbaa !272
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.aa, label %middle.block, label %vector.body, !llvm.loop !3339
...
vector.body128:                                   ; preds = %vector.body128, %vector.ph126
  ...
  br i1 %i.at, label %middle.block135, label %vector.body128, !llvm.loop !3341
...
.lr.ph.i18.i:                                     ; preds = %.lr.ph.i18.i.preheader199, %.lr.ph.i18.i
  ...
  br i1 %.not.i21.i, label %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit23.i, label %.lr.ph.i18.i, !llvm.loop !3342
...
vector.body146:                                   ; preds = %vector.body146, %vector.ph144
  ...
  store <4 x i32> %wide.load151, ptr %i.bm, align 4, !tbaa !69
  %index.next152 = add nuw i64 %index147, 8       ; 2 uses
  %i.bn = icmp eq i64 %index.next152, %n.vec145
  br i1 %i.bn, label %middle.block153, label %vector.body146, !llvm.loop !3343
...
.lr.ph.i24.i:                                     ; preds = %.lr.ph.i24.i.preheader198, %.lr.ph.i24.i
  ...
  %i.bo = load i32, ptr %.012.i.i, align 4, !tbaa !69
  store i32 %i.bo, ptr %.0911.i.i, align 4, !tbaa !69
  ...
  br i1 %.not.i25.i, label %_ZN5boost7movelib13adaptive_xbufIiPimE11move_assignIS2_EEvT_m.exit, label %.lr.ph.i24.i, !llvm.loop !3344
...
_ZN5boost7movelib13adaptive_xbufIiPimE11move_assignIS2_EEvT_m.exit: ; preds = %.lr.ph.i.i, %.lr.ph.i24.i, %middle.block, %middle.block153, %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit23.i
  store i64 %.sroa.speculated63, ptr %i.i, align 8, !tbaa !2566
...
bb.d:                                             ; preds = %_ZN5boost7movelib13adaptive_xbufIiPimE11move_assignIS2_EEvT_m.exit
  %i.bw = load ptr, ptr %4, align 8, !tbaa !2564  ; 2 uses
...
vector.body180:                                   ; preds = %vector.body180, %vector.ph178
  ...
  %wide.load184 = load <4 x i32>, ptr %next.gep183, align 4, !tbaa !69
  %wide.load185 = load <4 x i32>, ptr %i.cp, align 4, !tbaa !69
  %i.cq = getelementptr i8, ptr %next.gep182, i64 16
  store <4 x i32> %wide.load184, ptr %next.gep182, align 4, !tbaa !69
  store <4 x i32> %wide.load185, ptr %i.cq, align 4, !tbaa !69
  %index.next186 = add nuw i64 %index181, 8       ; 2 uses
  %i.cr = icmp eq i64 %index.next186, %n.vec179
  br i1 %i.cr, label %middle.block187, label %vector.body180, !llvm.loop !3345
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader196, %.lr.ph.i
  ...
  %i.cs = load i32, ptr %.079.i, align 4, !tbaa !69
  store i32 %i.cs, ptr %.010.i, align 4, !tbaa !69
  ...
  br i1 %.not.i47, label %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit.thread.thread, label %.lr.ph.i, !llvm.loop !3346
...
_ZN5boost7movelib14insertion_sortINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEPiEEvT0_SC_T_.exit.us.i: ; preds = %.lr.ph.i50, %_ZN5boost7movelib14insertion_sortINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEPiEEvT0_SC_T_.exit.us.i
  ...
  br i1 %i.cy, label %_ZN5boost7movelib14insertion_sortINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEPiEEvT0_SC_T_.exit.us.i, label %._crit_edge.i, !llvm.loop !3347
...
.lr.ph37.i.i:                                     ; preds = %bb.h, %.lr.ph37.i.preheader.i
  ...
  %i.db = load i32, ptr %.02236.i.i, align 4, !tbaa !69 ; 3 uses
  %i.dc = load i32, ptr %.pn35.i.i, align 4, !tbaa !69 ; 2 uses
  %i.dd = icmp slt i32 %i.db, %i.dc
  br i1 %i.dd, label %bb.f, label %bb.h

bb.f:                                             ; preds = %.lr.ph37.i.i
  store i32 %i.dc, ptr %.02236.i.i, align 4, !tbaa !69
...
.lr.ph.i.i51:                                     ; preds = %bb.f, %bb.g
  ...
  %i.df = load i32, ptr %i.de, align 4, !tbaa !69 ; 2 uses
...
.critedge.i.i:                                    ; preds = %bb.g, %.lr.ph.i.i51, %bb.f
  ...
  store i32 %i.db, ptr %.021.lcssa.i.i, align 4, !tbaa !69
  br label %bb.h

bb.g:                                             ; preds = %.lr.ph.i.i51
  store i32 %i.df, ptr %.030.i.i, align 4, !tbaa !69
  %.not26.i.i = icmp eq ptr %i.de, %i.cz
  br i1 %.not26.i.i, label %.critedge.i.i, label %.lr.ph.i.i51, !llvm.loop !3329
...
bb.h:                                             ; preds = %.critedge.i.i, %.lr.ph37.i.i
  ...
  br i1 %.not25.i.i, label %_ZN5boost7movelib14insertion_sortINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEPiEEvT0_SC_T_.exit.loopexit.i, label %.lr.ph37.i.i, !llvm.loop !3330
...
_ZN5boost7movelib14insertion_sortINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEPiEEvT0_SC_T_.exit.loopexit.i: ; preds = %bb.h
  ...
  br i1 %i.dj, label %.lr.ph37.i.preheader.i, label %._crit_edge.i, !llvm.loop !3347
...
.lr.ph37.i19.i:                                   ; preds = %bb.k, %.lr.ph37.i19.preheader.i
  ...
  %i.dn = load i32, ptr %.02236.i20.i, align 4, !tbaa !69 ; 3 uses
  %i.do = load i32, ptr %.pn35.i21.i, align 4, !tbaa !69 ; 2 uses
  %i.dp = icmp slt i32 %i.dn, %i.do
  br i1 %i.dp, label %bb.i, label %bb.k

bb.i:                                             ; preds = %.lr.ph37.i19.i
  store i32 %i.do, ptr %.02236.i20.i, align 4, !tbaa !69
...
.lr.ph.i25.i:                                     ; preds = %bb.i, %bb.j
  ...
  %i.dr = load i32, ptr %i.dq, align 4, !tbaa !69 ; 2 uses
...
.critedge.i27.i:                                  ; preds = %bb.j, %.lr.ph.i25.i, %bb.i
  ...
  store i32 %i.dn, ptr %.021.lcssa.i28.i, align 4, !tbaa !69
  br label %bb.k

bb.j:                                             ; preds = %.lr.ph.i25.i
  store i32 %i.dr, ptr %.030.i26.i, align 4, !tbaa !69
  %.not26.i29.i = icmp eq ptr %i.dq, %i.dk
  br i1 %.not26.i29.i, label %.critedge.i27.i, label %.lr.ph.i25.i, !llvm.loop !3329
...
bb.k:                                             ; preds = %.critedge.i27.i, %.lr.ph37.i19.i
  ...
  br i1 %.not25.i23.i, label %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit, label %.lr.ph37.i19.i, !llvm.loop !3330
...
.lr.ph.i53.preheader:                             ; preds = %_ZN5boost7movelib13adaptive_xbufIiPimE11move_assignIS2_EEvT_m.exit
  ...
  %i.ef = load ptr, ptr %4, align 8, !tbaa !2564  ; 5 uses
...
vector.body163:                                   ; preds = %vector.body163, %vector.ph161
  ...
  %wide.load167 = load <4 x i32>, ptr %next.gep166, align 4, !tbaa !69
  %wide.load168 = load <4 x i32>, ptr %i.eq, align 4, !tbaa !69
  %i.er = getelementptr i8, ptr %next.gep165, i64 16
  store <4 x i32> %wide.load167, ptr %next.gep165, align 4, !tbaa !69
  store <4 x i32> %wide.load168, ptr %i.er, align 4, !tbaa !69
  %index.next169 = add nuw i64 %index164, 8       ; 2 uses
  %i.es = icmp eq i64 %index.next169, %n.vec162
  br i1 %i.es, label %middle.block170, label %vector.body163, !llvm.loop !3348
...
.lr.ph.i53:                                       ; preds = %.lr.ph.i53.preheader197, %.lr.ph.i53
  ...
  %i.et = load i32, ptr %.079.i55, align 4, !tbaa !69
  store i32 %i.et, ptr %.010.i54, align 4, !tbaa !69
  ...
  br i1 %.not.i56, label %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit59, label %.lr.ph.i53, !llvm.loop !3349
...
_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit59:         ; preds = %.lr.ph.i53, %middle.block170, %bb.l
  ...
  %i.ex = load i64, ptr %i.ew, align 8, !tbaa !2566
...
.preheader.preheader.i.i:                         ; preds = %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit59
  store i64 0, ptr %i.ew, align 8, !tbaa !2566
  br label %_ZN5boost7movelib13adaptive_xbufIiPimE5clearEv.exit
...
bb.a:
  ...
  %i.c = load i64, ptr %5, align 8, !tbaa !272    ; 13 uses
  %i.d = getelementptr [4 x i8], ptr %2, i64 %i.c ; 8 uses
  %i.e = sub i64 %3, %i.c                         ; 8 uses
  %i.f = load i64, ptr %1, align 8, !tbaa !272
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep247, align 4, !tbaa !69
  %wide.load248 = load <4 x i32>, ptr %i.y, align 4, !tbaa !69
  %i.z = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %wide.load, ptr %next.gep, align 4, !tbaa !69
  store <4 x i32> %wide.load248, ptr %i.z, align 4, !tbaa !69
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.aa = icmp eq i64 %index.next, %n.vec
  br i1 %i.aa, label %middle.block, label %vector.body, !llvm.loop !3350
...
vector.body256:                                   ; preds = %vector.body256, %vector.ph254
  ...
  %wide.load260 = load <4 x i32>, ptr %next.gep259, align 4, !tbaa !69
  %wide.load261 = load <4 x i32>, ptr %i.an, align 4, !tbaa !69
  %i.ao = getelementptr i8, ptr %next.gep258, i64 16
  store <4 x i32> %wide.load260, ptr %next.gep258, align 4, !tbaa !69
  store <4 x i32> %wide.load261, ptr %i.ao, align 4, !tbaa !69
  %index.next262 = add nuw i64 %index257, 8       ; 2 uses
  %i.ap = icmp eq i64 %index.next262, %n.vec255
  br i1 %i.ap, label %middle.block263, label %vector.body256, !llvm.loop !3352
...
.lr.ph.i18.i:                                     ; preds = %.lr.ph.i18.i.preheader453, %.lr.ph.i18.i
  ...
  %i.aq = load i32, ptr %.079.i20.i, align 4, !tbaa !69
  store i32 %i.aq, ptr %.010.i19.i, align 4, !tbaa !69
  ...
  br i1 %.not.i21.i, label %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit23.i, label %.lr.ph.i18.i, !llvm.loop !3353
...
vector.body274:                                   ; preds = %vector.body274, %vector.ph272
  ...
  %wide.load278 = load <4 x i32>, ptr %next.gep276, align 4, !tbaa !69
  %wide.load279 = load <4 x i32>, ptr %i.be, align 4, !tbaa !69
  %i.bf = getelementptr i8, ptr %next.gep277, i64 16
  store <4 x i32> %wide.load278, ptr %next.gep277, align 4, !tbaa !69
  store <4 x i32> %wide.load279, ptr %i.bf, align 4, !tbaa !69
  %index.next280 = add nuw i64 %index275, 8       ; 2 uses
  %i.bg = icmp eq i64 %index.next280, %n.vec273
  br i1 %i.bg, label %middle.block281, label %vector.body274, !llvm.loop !3354
...
.lr.ph.i24.i:                                     ; preds = %.lr.ph.i24.i.preheader452, %.lr.ph.i24.i
  ...
  %i.bh = load i32, ptr %.012.i.i, align 4, !tbaa !69
  store i32 %i.bh, ptr %.0911.i.i, align 4, !tbaa !69
...
._crit_edge:                                      ; preds = %bb.s
  ...
  store i64 %i.bq, ptr %1, align 8, !tbaa !272
...
bb.d:                                             ; preds = %.lr.ph, %bb.s
  ...
  %i.br = load i64, ptr %5, align 8, !tbaa !272   ; 2 uses
  %i.bs = load i64, ptr %1, align 8, !tbaa !272   ; 4 uses
...
vector.body368:                                   ; preds = %vector.body368, %vector.ph366
  ...
  %wide.load372 = load <4 x i32>, ptr %i.cq, align 4, !tbaa !69
  %wide.load373 = load <4 x i32>, ptr %i.cr, align 4, !tbaa !69
  %i.cs = getelementptr inbounds i8, ptr %next.gep370, i64 -16
  %i.ct = getelementptr inbounds i8, ptr %next.gep370, i64 -32
  store <4 x i32> %wide.load372, ptr %i.cs, align 4, !tbaa !69
  store <4 x i32> %wide.load373, ptr %i.ct, align 4, !tbaa !69
  %index.next374 = add nuw i64 %index369, 8       ; 2 uses
  %i.cu = icmp eq i64 %index.next374, %n.vec367
  br i1 %i.cu, label %middle.block375, label %vector.body368, !llvm.loop !3356
...
.lr.ph.i.i149:                                    ; preds = %.lr.ph.i.i149.preheader, %.lr.ph.i.i149
  ...
  %i.cx = load i32, ptr %i.cv, align 4, !tbaa !69
  store i32 %i.cx, ptr %i.cw, align 4, !tbaa !69
  %.not.i.i152 = icmp eq ptr %i.cf, %i.cv
  br i1 %.not.i.i152, label %_ZN5boost7movelib15detail_adaptive18move_data_backwardIPiEEvT_NS0_9iter_sizeIS4_E4typeES4_b.exit, label %.lr.ph.i.i149, !llvm.loop !3357
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %indvar.next = add i64 %indvar, 1
  br i1 %.not.i52, label %_ZN5boost7movelib7swap_opclIPiS3_EET0_NS0_9forward_tET_S6_S4_.exit.i53, label %.lr.ph.i46, !llvm.loop !3428
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep152, align 4, !tbaa !69, !alias.scope !3445, !noalias !3448
  %wide.load153 = load <4 x i32>, ptr %i.ff, align 4, !tbaa !69, !alias.scope !3445, !noalias !3448
  %i.fg = getelementptr i8, ptr %next.gep, i64 16 ; 2 uses
  %wide.load154 = load <4 x i32>, ptr %next.gep, align 4, !tbaa !69, !alias.scope !3448
  %wide.load155 = load <4 x i32>, ptr %i.fg, align 4, !tbaa !69, !alias.scope !3448
  store <4 x i32> %wide.load154, ptr %next.gep152, align 4, !tbaa !69, !alias.scope !3445, !noalias !3448
  store <4 x i32> %wide.load155, ptr %i.ff, align 4, !tbaa !69, !alias.scope !3445, !noalias !3448
  store <4 x i32> %wide.load, ptr %next.gep, align 4, !tbaa !69, !alias.scope !3448
  store <4 x i32> %wide.load153, ptr %i.fg, align 4, !tbaa !69, !alias.scope !3448
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.fh = icmp eq i64 %index.next, %n.vec
  br i1 %i.fh, label %middle.block, label %vector.body, !llvm.loop !3450
...
.lr.ph.i.i29.i59:                                 ; preds = %.lr.ph.i.i29.i59.preheader276, %.lr.ph.i.i29.i59
  ...
  %i.fi = load i32, ptr %.079.i.i31.i61, align 4, !tbaa !69
  %i.fj = load i32, ptr %.010.i.i30.i60, align 4, !tbaa !69
  store i32 %i.fj, ptr %.079.i.i31.i61, align 4, !tbaa !69
  store i32 %i.fi, ptr %.010.i.i30.i60, align 4, !tbaa !69
  ...
  br i1 %.not.i.i32.i62, label %_ZN5boost7movelib13op_merge_leftIPiNS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEENS0_7swap_opEEEvT_SD_SD_SD_T0_T1_.exit67, label %.lr.ph.i.i29.i59, !llvm.loop !3451
...
vector.body199:                                   ; preds = %vector.body199, %vector.ph197
  ...
  %wide.load203 = load <4 x i32>, ptr %next.gep202, align 4, !tbaa !69, !alias.scope !3452, !noalias !3455
  %wide.load204 = load <4 x i32>, ptr %i.gb, align 4, !tbaa !69, !alias.scope !3452, !noalias !3455
  %i.gc = getelementptr i8, ptr %next.gep201, i64 16 ; 2 uses
  %wide.load205 = load <4 x i32>, ptr %next.gep201, align 4, !tbaa !69, !alias.scope !3455
  %wide.load206 = load <4 x i32>, ptr %i.gc, align 4, !tbaa !69, !alias.scope !3455
  store <4 x i32> %wide.load205, ptr %next.gep202, align 4, !tbaa !69, !alias.scope !3452, !noalias !3455
  store <4 x i32> %wide.load206, ptr %i.gb, align 4, !tbaa !69, !alias.scope !3452, !noalias !3455
  store <4 x i32> %wide.load203, ptr %next.gep201, align 4, !tbaa !69, !alias.scope !3455
  store <4 x i32> %wide.load204, ptr %i.gc, align 4, !tbaa !69, !alias.scope !3455
  %index.next207 = add nuw i64 %index200, 8       ; 2 uses
  %i.gd = icmp eq i64 %index.next207, %n.vec198
  br i1 %i.gd, label %middle.block208, label %vector.body199, !llvm.loop !3457
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader279, %.lr.ph.i.i
  ...
  %i.ge = load i32, ptr %.079.i.i, align 4, !tbaa !69
  %i.gf = load i32, ptr %.010.i.i, align 4, !tbaa !69
  store i32 %i.gf, ptr %.079.i.i, align 4, !tbaa !69
  store i32 %i.ge, ptr %.010.i.i, align 4, !tbaa !69
  ...
  br i1 %.not.i.i, label %_ZN5boost7movelib13op_merge_leftIPiNS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEENS0_7swap_opEEEvT_SD_SD_SD_T0_T1_.exit67, label %.lr.ph.i.i, !llvm.loop !3458
...
_ZN5boost7movelib13op_merge_leftIPiNS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEENS0_7swap_opEEEvT_SD_SD_SD_T0_T1_.exit67: ; preds = %.lr.ph.i.i, %.lr.ph.i.i.i63, %.lr.ph.i.i29.i59, %middle.block208, %middle.block180, %middle.block, %bb.l, %_ZN5boost7movelib7swap_opclIPiS3_EET0_NS0_9forward_tET_S6_S4_.exit.i53
  ...
  br i1 %i.gm, label %.preheader, label %._crit_edge88, !llvm.loop !3459
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.t, align 4, !tbaa !69
  %wide.load143 = load <4 x i32>, ptr %i.u, align 4, !tbaa !69
  %i.v = getelementptr inbounds i8, ptr %next.gep, i64 -16
  %i.w = getelementptr inbounds i8, ptr %next.gep, i64 -32
  store <4 x i32> %wide.load, ptr %i.v, align 4, !tbaa !69
  store <4 x i32> %wide.load143, ptr %i.w, align 4, !tbaa !69
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.x = icmp eq i64 %index.next, %n.vec
  br i1 %i.x, label %middle.block, label %vector.body, !llvm.loop !3460
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader266, %.lr.ph.i.i
  ...
  %i.aa = load i32, ptr %i.y, align 4, !tbaa !69
  store i32 %i.aa, ptr %i.z, align 4, !tbaa !69
  %.not.i.i = icmp eq ptr %i.f, %i.y
  br i1 %.not.i.i, label %_ZN5boost7movelib7move_opclIPiS3_EET0_NS0_10backward_tET_S6_S4_.exit, label %.lr.ph.i.i, !llvm.loop !3461
...
vector.body152:                                   ; preds = %vector.body152, %vector.ph150
  ...
  %wide.load156 = load <4 x i32>, ptr %i.au, align 4, !tbaa !69
  %wide.load157 = load <4 x i32>, ptr %i.av, align 4, !tbaa !69
  %i.aw = getelementptr inbounds i8, ptr %next.gep154, i64 -16
  %i.ax = getelementptr inbounds i8, ptr %next.gep154, i64 -32
  store <4 x i32> %wide.load156, ptr %i.aw, align 4, !tbaa !69
  store <4 x i32> %wide.load157, ptr %i.ax, align 4, !tbaa !69
  %index.next158 = add nuw i64 %index153, 8       ; 2 uses
  %i.ay = icmp eq i64 %index.next158, %n.vec151
  br i1 %i.ay, label %middle.block159, label %vector.body152, !llvm.loop !3462
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader259, %.lr.ph.i.i.i
  ...
  %i.bb = load i32, ptr %i.az, align 4, !tbaa !69
  store i32 %i.bb, ptr %i.ba, align 4, !tbaa !69
  %.not.i.i.i = icmp eq ptr %i.f, %i.az
  br i1 %.not.i.i.i, label %_ZN5boost7movelib7move_opclIPiS3_EET0_NS0_10backward_tET_S6_S4_.exit, label %.lr.ph.i.i.i, !llvm.loop !3463
...
bb.d:                                             ; preds = %.lr.ph.i
  ...
  %i.bf = load i32, ptr %i.bc, align 4, !tbaa !69 ; 2 uses
  %i.bg = load i32, ptr %i.bd, align 4, !tbaa !69 ; 2 uses
  ...
  store i32 %..i, ptr %i.be, align 4, !tbaa !69
  %.not.i = icmp eq ptr %i.f, %..025.i
  %indvar.next = add i64 %indvar, 1
  br i1 %.not.i, label %._crit_edge.i, label %.lr.ph.i, !llvm.loop !3464
...
vector.body171:                                   ; preds = %vector.body171, %vector.ph169
  ...
  %wide.load175 = load <4 x i32>, ptr %i.bw, align 4, !tbaa !69
  %wide.load176 = load <4 x i32>, ptr %i.bx, align 4, !tbaa !69
  %i.by = getelementptr inbounds i8, ptr %next.gep173, i64 -16
  %i.bz = getelementptr inbounds i8, ptr %next.gep173, i64 -32
  store <4 x i32> %wide.load175, ptr %i.by, align 4, !tbaa !69
  store <4 x i32> %wide.load176, ptr %i.bz, align 4, !tbaa !69
  %index.next177 = add nuw i64 %index172, 8       ; 2 uses
  %i.ca = icmp eq i64 %index.next177, %n.vec170
  br i1 %i.ca, label %middle.block178, label %vector.body171, !llvm.loop !3465
...
.lr.ph.i.i30.i:                                   ; preds = %.lr.ph.i.i30.i.preheader258, %.lr.ph.i.i30.i
  ...
  %i.cd = load i32, ptr %i.cb, align 4, !tbaa !69
  store i32 %i.cd, ptr %i.cc, align 4, !tbaa !69
  %.not.i.i33.i = icmp eq ptr %i.ab, %i.cb
  br i1 %.not.i.i33.i, label %_ZN5boost7movelib7move_opclIPiS3_EET0_NS0_10backward_tET_S6_S4_.exit, label %.lr.ph.i.i30.i, !llvm.loop !3466
...
vector.body230:                                   ; preds = %vector.body230, %.lr.ph.i.i30.i59.us.preheader
  ...
  %wide.load234 = load <4 x i32>, ptr %i.cl, align 4, !tbaa !69
  %wide.load235 = load <4 x i32>, ptr %i.cm, align 4, !tbaa !69
  %i.cn = getelementptr inbounds i8, ptr %next.gep232, i64 -16
  %i.co = getelementptr inbounds i8, ptr %next.gep232, i64 -32
  store <4 x i32> %wide.load234, ptr %i.cn, align 4, !tbaa !69
  store <4 x i32> %wide.load235, ptr %i.co, align 4, !tbaa !69
  %index.next236 = add nuw i64 %index231, 8       ; 2 uses
  %i.cp = icmp eq i64 %index.next236, 4611686018427387904
  br i1 %i.cp, label %_ZN5boost7movelib14op_merge_rightIPiNS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEENS0_7move_opEEEvT_SD_SD_SD_T0_T1_.exit67.us, label %vector.body230, !llvm.loop !3467
...
_ZN5boost7movelib14op_merge_rightIPiNS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEENS0_7move_opEEEvT_SD_SD_SD_T0_T1_.exit67.us: ; preds = %vector.body230, %._crit_edge.i53.us
  ...
  br i1 %.not43.us, label %._crit_edge, label %._crit_edge.i53.us, !llvm.loop !3468
...
vector.body193:                                   ; preds = %vector.body193, %vector.ph191
  ...
  %wide.load197 = load <4 x i32>, ptr %i.dw, align 4, !tbaa !69
  %wide.load198 = load <4 x i32>, ptr %i.dx, align 4, !tbaa !69
  %i.dy = getelementptr inbounds i8, ptr %next.gep195, i64 -16
  %i.dz = getelementptr inbounds i8, ptr %next.gep195, i64 -32
  store <4 x i32> %wide.load197, ptr %i.dy, align 4, !tbaa !69
  store <4 x i32> %wide.load198, ptr %i.dz, align 4, !tbaa !69
  %index.next199 = add nuw i64 %index194, 8       ; 2 uses
  %i.ea = icmp eq i64 %index.next199, %n.vec192
  br i1 %i.ea, label %middle.block200, label %vector.body193, !llvm.loop !3469
...
.lr.ph.i.i.i63:                                   ; preds = %.lr.ph.i.i.i63.preheader250, %.lr.ph.i.i.i63
  ...
  %i.ed = load i32, ptr %i.eb, align 4, !tbaa !69
  store i32 %i.ed, ptr %i.ec, align 4, !tbaa !69
  %.not.i.i.i66 = icmp eq ptr %i.cv, %i.eb
  br i1 %.not.i.i.i66, label %_ZN5boost7movelib14op_merge_rightIPiNS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEENS0_7move_opEEEvT_SD_SD_SD_T0_T1_.exit67, label %.lr.ph.i.i.i63, !llvm.loop !3470
...
bb.e:                                             ; preds = %.lr.ph.i45
  ...
  %i.eh = load i32, ptr %i.ee, align 4, !tbaa !69 ; 2 uses
  %i.ei = load i32, ptr %i.ef, align 4, !tbaa !69 ; 2 uses
  ...
  store i32 %..i49, ptr %i.eg, align 4, !tbaa !69
  %.not.i52 = icmp eq ptr %i.cv, %..025.i50
  %indvar.next187 = add i64 %indvar186, 1
  br i1 %.not.i52, label %._crit_edge.i53.loopexit, label %.lr.ph.i45, !llvm.loop !3464
...
vector.body211:                                   ; preds = %vector.body211, %vector.ph209
  ...
  %wide.load215 = load <4 x i32>, ptr %i.fc, align 4, !tbaa !69
  %wide.load216 = load <4 x i32>, ptr %i.fd, align 4, !tbaa !69
  %i.fe = getelementptr inbounds i8, ptr %next.gep213, i64 -16
  %i.ff = getelementptr inbounds i8, ptr %next.gep213, i64 -32
  store <4 x i32> %wide.load215, ptr %i.fe, align 4, !tbaa !69
  store <4 x i32> %wide.load216, ptr %i.ff, align 4, !tbaa !69
  %index.next217 = add nuw i64 %index212, 8       ; 2 uses
  %i.fg = icmp eq i64 %index.next217, %n.vec210
  br i1 %i.fg, label %middle.block218, label %vector.body211, !llvm.loop !3471
...
.lr.ph.i.i30.i59:                                 ; preds = %.lr.ph.i.i30.i59.preheader251, %.lr.ph.i.i30.i59
  ...
  %i.fj = load i32, ptr %i.fh, align 4, !tbaa !69
  store i32 %i.fj, ptr %i.fi, align 4, !tbaa !69
  %.not.i.i33.i62 = icmp eq ptr %i.cw, %i.fh
  br i1 %.not.i.i33.i62, label %_ZN5boost7movelib14op_merge_rightIPiNS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEENS0_7move_opEEEvT_SD_SD_SD_T0_T1_.exit67, label %.lr.ph.i.i30.i59, !llvm.loop !3472
...
_ZN5boost7movelib14op_merge_rightIPiNS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEENS0_7move_opEEEvT_SD_SD_SD_T0_T1_.exit67: ; preds = %.lr.ph.i.i30.i59, %.lr.ph.i.i.i63, %middle.block218, %middle.block200, %._crit_edge.i53.loopexit
  ...
  br i1 %.not43, label %._crit_edge, label %.lr.ph.i45.preheader, !llvm.loop !3468
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.w, align 4, !tbaa !69, !alias.scope !3473, !noalias !3476
  %wide.load151 = load <4 x i32>, ptr %i.x, align 4, !tbaa !69, !alias.scope !3473, !noalias !3476
  %i.y = getelementptr inbounds i8, ptr %next.gep, i64 -16 ; 2 uses
  %i.z = getelementptr inbounds i8, ptr %next.gep, i64 -32 ; 2 uses
  %wide.load152 = load <4 x i32>, ptr %i.y, align 4, !tbaa !69, !alias.scope !3476
  %wide.load153 = load <4 x i32>, ptr %i.z, align 4, !tbaa !69, !alias.scope !3476
  store <4 x i32> %wide.load152, ptr %i.w, align 4, !tbaa !69, !alias.scope !3473, !noalias !3476
  store <4 x i32> %wide.load153, ptr %i.x, align 4, !tbaa !69, !alias.scope !3473, !noalias !3476
  store <4 x i32> %wide.load, ptr %i.y, align 4, !tbaa !69, !alias.scope !3476
  store <4 x i32> %wide.load151, ptr %i.z, align 4, !tbaa !69, !alias.scope !3476
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.aa = icmp eq i64 %index.next, %n.vec
  br i1 %i.aa, label %middle.block, label %vector.body, !llvm.loop !3478
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader316, %.lr.ph.i.i
  ...
  %i.ad = load i32, ptr %i.ab, align 4, !tbaa !69
  %i.ae = load i32, ptr %i.ac, align 4, !tbaa !69
  store i32 %i.ae, ptr %i.ab, align 4, !tbaa !69
  store i32 %i.ad, ptr %i.ac, align 4, !tbaa !69
  %.not.i.i = icmp eq ptr %i.f, %i.ab
  br i1 %.not.i.i, label %_ZN5boost7movelib7swap_opclIPiS3_EET0_NS0_10backward_tET_S6_S4_.exit, label %.lr.ph.i.i, !llvm.loop !3479
...
vector.body168:                                   ; preds = %vector.body168, %vector.ph166
  ...
  %wide.load172 = load <4 x i32>, ptr %i.be, align 4, !tbaa !69, !alias.scope !3480, !noalias !3483
  %wide.load173 = load <4 x i32>, ptr %i.bf, align 4, !tbaa !69, !alias.scope !3480, !noalias !3483
  %i.bg = getelementptr inbounds i8, ptr %next.gep170, i64 -16 ; 2 uses
  %i.bh = getelementptr inbounds i8, ptr %next.gep170, i64 -32 ; 2 uses
  %wide.load174 = load <4 x i32>, ptr %i.bg, align 4, !tbaa !69, !alias.scope !3483
  %wide.load175 = load <4 x i32>, ptr %i.bh, align 4, !tbaa !69, !alias.scope !3483
  store <4 x i32> %wide.load174, ptr %i.be, align 4, !tbaa !69, !alias.scope !3480, !noalias !3483
  store <4 x i32> %wide.load175, ptr %i.bf, align 4, !tbaa !69, !alias.scope !3480, !noalias !3483
  store <4 x i32> %wide.load172, ptr %i.bg, align 4, !tbaa !69, !alias.scope !3483
  store <4 x i32> %wide.load173, ptr %i.bh, align 4, !tbaa !69, !alias.scope !3483
  %index.next176 = add nuw i64 %index169, 8       ; 2 uses
  %i.bi = icmp eq i64 %index.next176, %n.vec167
  br i1 %i.bi, label %middle.block177, label %vector.body168, !llvm.loop !3485
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader309, %.lr.ph.i.i.i
  ...
  %i.bl = load i32, ptr %i.bj, align 4, !tbaa !69
  %i.bm = load i32, ptr %i.bk, align 4, !tbaa !69
  store i32 %i.bm, ptr %i.bj, align 4, !tbaa !69
  store i32 %i.bl, ptr %i.bk, align 4, !tbaa !69
  %.not.i.i.i = icmp eq ptr %i.f, %i.bj
  br i1 %.not.i.i.i, label %_ZN5boost7movelib7swap_opclIPiS3_EET0_NS0_10backward_tET_S6_S4_.exit, label %.lr.ph.i.i.i, !llvm.loop !3486
...
bb.d:                                             ; preds = %.lr.ph.i
  ...
  %i.bq = load i32, ptr %i.bn, align 4, !tbaa !69 ; 2 uses
  %i.br = load i32, ptr %i.bo, align 4, !tbaa !69 ; 2 uses
  %i.bs = icmp slt i32 %i.bq, %i.br
  %i.bt = load i32, ptr %i.bp, align 4, !tbaa !69 ; 2 uses
  br i1 %i.bs, label %bb.e, label %bb.f

bb.e:                                             ; preds = %bb.d
  store i32 %i.br, ptr %i.bp, align 4, !tbaa !69
  store i32 %i.bt, ptr %i.bo, align 4, !tbaa !69
  br label %bb.g

bb.f:                                             ; preds = %bb.d
  store i32 %i.bq, ptr %i.bp, align 4, !tbaa !69
  store i32 %i.bt, ptr %i.bn, align 4, !tbaa !69
  br label %bb.g
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %indvar.next = add i64 %indvar, 1
  br i1 %.not.i, label %._crit_edge.i, label %.lr.ph.i, !llvm.loop !3487
...
vector.body192:                                   ; preds = %vector.body192, %vector.ph190
  ...
  %wide.load196 = load <4 x i32>, ptr %i.cn, align 4, !tbaa !69, !alias.scope !3488, !noalias !3491
  %wide.load197 = load <4 x i32>, ptr %i.co, align 4, !tbaa !69, !alias.scope !3488, !noalias !3491
  %i.cp = getelementptr inbounds i8, ptr %next.gep194, i64 -16 ; 2 uses
  %i.cq = getelementptr inbounds i8, ptr %next.gep194, i64 -32 ; 2 uses
  %wide.load198 = load <4 x i32>, ptr %i.cp, align 4, !tbaa !69, !alias.scope !3491
  %wide.load199 = load <4 x i32>, ptr %i.cq, align 4, !tbaa !69, !alias.scope !3491
  store <4 x i32> %wide.load198, ptr %i.cn, align 4, !tbaa !69, !alias.scope !3488, !noalias !3491
  store <4 x i32> %wide.load199, ptr %i.co, align 4, !tbaa !69, !alias.scope !3488, !noalias !3491
  store <4 x i32> %wide.load196, ptr %i.cp, align 4, !tbaa !69, !alias.scope !3491
  store <4 x i32> %wide.load197, ptr %i.cq, align 4, !tbaa !69, !alias.scope !3491
  %index.next200 = add nuw i64 %index193, 8       ; 2 uses
  %i.cr = icmp eq i64 %index.next200, %n.vec191
  br i1 %i.cr, label %middle.block201, label %vector.body192, !llvm.loop !3493
...
.lr.ph.i.i30.i:                                   ; preds = %.lr.ph.i.i30.i.preheader308, %.lr.ph.i.i30.i
  ...
  %i.cu = load i32, ptr %i.cs, align 4, !tbaa !69
  %i.cv = load i32, ptr %i.ct, align 4, !tbaa !69
  store i32 %i.cv, ptr %i.cs, align 4, !tbaa !69
  store i32 %i.cu, ptr %i.ct, align 4, !tbaa !69
  %.not.i.i33.i = icmp eq ptr %i.af, %i.cs
  br i1 %.not.i.i33.i, label %_ZN5boost7movelib7swap_opclIPiS3_EET0_NS0_10backward_tET_S6_S4_.exit, label %.lr.ph.i.i30.i, !llvm.loop !3494
...
vector.body175:                                   ; preds = %vector.body175, %vector.ph173
  ...
  %wide.load179 = load <4 x i32>, ptr %next.gep177, align 4, !tbaa !69
  %wide.load180 = load <4 x i32>, ptr %i.bk, align 4, !tbaa !69
  %i.bl = getelementptr i8, ptr %next.gep178, i64 16
  store <4 x i32> %wide.load179, ptr %next.gep178, align 4, !tbaa !69
  store <4 x i32> %wide.load180, ptr %i.bl, align 4, !tbaa !69
  %index.next181 = add nuw i64 %index176, 8       ; 2 uses
  %i.bm = icmp eq i64 %index.next181, %n.vec174
  br i1 %i.bm, label %middle.block182, label %vector.body175, !llvm.loop !4782
...
.lr.ph.i24.i:                                     ; preds = %.lr.ph.i24.i.preheader299, %.lr.ph.i24.i
  ...
  %i.bn = load i32, ptr %.012.i.i, align 4, !tbaa !69
  store i32 %i.bn, ptr %.0911.i.i, align 4, !tbaa !69
  ...
  br i1 %.not.i25.i, label %_ZN5boost7movelib13adaptive_xbufIiPimE11move_assignIS2_EEvT_m.exit, label %.lr.ph.i24.i, !llvm.loop !4783
...
_ZN5boost7movelib13adaptive_xbufIiPimE11move_assignIS2_EEvT_m.exit: ; preds = %.lr.ph.i.i, %.lr.ph.i24.i, %middle.block, %middle.block182, %bb.e, %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit23.i
  ...
  store i64 %i.q, ptr %i.r, align 8, !tbaa !2566
...
vector.body193:                                   ; preds = %vector.body193, %vector.ph191
  ...
  %wide.load197 = load <4 x i32>, ptr %next.gep196, align 4, !tbaa !69
  %wide.load198 = load <4 x i32>, ptr %i.ch, align 4, !tbaa !69
  %i.ci = getelementptr i8, ptr %next.gep195, i64 16
  store <4 x i32> %wide.load197, ptr %next.gep195, align 4, !tbaa !69
  store <4 x i32> %wide.load198, ptr %i.ci, align 4, !tbaa !69
  %index.next199 = add nuw i64 %index194, 8       ; 2 uses
  %i.cj = icmp eq i64 %index.next199, %n.vec192
  br i1 %i.cj, label %middle.block200, label %vector.body193, !llvm.loop !4784
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader292, %.lr.ph.i.i.i
  ...
  %i.ck = load i32, ptr %.079.i.i.i, align 4, !tbaa !69
  store i32 %i.ck, ptr %.010.i.i.i, align 4, !tbaa !69
  ...
  br i1 %.not.i.i.i, label %_ZN5boost7movelib26op_merge_with_right_placedINS0_10antistableINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEEEPiSD_NS0_7move_opEEEvT0_SF_T1_SG_SG_T_T2_.exit, label %.lr.ph.i.i.i, !llvm.loop !4785

bb.g:                                             ; preds = %.lr.ph.i40
  %i.cn = load i32, ptr %.027.i, align 4, !tbaa !69 ; 2 uses
  %i.co = load i32, ptr %.01725.i, align 4, !tbaa !69 ; 2 uses
  ...
  store i32 %.sink.i, ptr %.01626.i, align 4, !tbaa !69
  %i.cp = getelementptr inbounds nuw i8, ptr %.01626.i, i64 4
  %.not.i42 = icmp eq ptr %.1.i41, %i.br
  %indvar.next = add i64 %indvar, 1
  br i1 %.not.i42, label %_ZN5boost7movelib26op_merge_with_right_placedINS0_10antistableINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEEEPiSD_NS0_7move_opEEEvT0_SF_T1_SG_SG_T_T2_.exit, label %.lr.ph.i40, !llvm.loop !3333
...
bb.h:                                             ; preds = %bb.h, %.lr.ph.i44
  ...
  %i.ct = load i32, ptr %i.cs, align 4, !tbaa !69
  ...
  br i1 %.not.i51, label %_ZN5boost7movelib11lower_boundIPiiNS0_10antistableINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEEEEET_SE_SE_RKT0_T1_.exit, label %bb.h, !llvm.loop !3251
...
bb.i:                                             ; preds = %_ZN5boost7movelib11lower_boundIPiiNS0_10antistableINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEEEEET_SE_SE_RKT0_T1_.exit
  ...
  %.pre117 = load ptr, ptr %4, align 8, !tbaa !2564 ; 7 uses
...
vector.body211:                                   ; preds = %vector.body211, %vector.ph209
  ...
  %wide.load215 = load <4 x i32>, ptr %next.gep214, align 4, !tbaa !69
  %wide.load216 = load <4 x i32>, ptr %i.dl, align 4, !tbaa !69
  %i.dm = getelementptr i8, ptr %next.gep213, i64 16
  store <4 x i32> %wide.load215, ptr %next.gep213, align 4, !tbaa !69
  store <4 x i32> %wide.load216, ptr %i.dm, align 4, !tbaa !69
  %index.next217 = add nuw i64 %index212, 8       ; 2 uses
  %i.dn = icmp eq i64 %index.next217, %n.vec210
  br i1 %i.dn, label %middle.block218, label %vector.body211, !llvm.loop !4786
...
.lr.ph.i.i56:                                     ; preds = %.lr.ph.i.i56.preheader290, %.lr.ph.i.i56
  ...
  %i.do = load i32, ptr %.079.i.i58, align 4, !tbaa !69
  store i32 %i.do, ptr %.010.i.i57, align 4, !tbaa !69
...
vector.body228:                                   ; preds = %vector.body228, %vector.ph226
  ...
  %wide.load232 = load <4 x i32>, ptr %next.gep231, align 4, !tbaa !69
  %wide.load233 = load <4 x i32>, ptr %i.ec, align 4, !tbaa !69
  %i.ed = getelementptr i8, ptr %next.gep230, i64 16
  store <4 x i32> %wide.load232, ptr %next.gep230, align 4, !tbaa !69
  store <4 x i32> %wide.load233, ptr %i.ed, align 4, !tbaa !69
  %index.next234 = add nuw i64 %index229, 8       ; 2 uses
  %i.ee = icmp eq i64 %index.next234, %n.vec227
  br i1 %i.ee, label %middle.block235, label %vector.body228, !llvm.loop !4788
...
.lr.ph.i18.i62:                                   ; preds = %.lr.ph.i18.i62.preheader289, %.lr.ph.i18.i62
  ...
  %i.ef = load i32, ptr %.079.i20.i64, align 4, !tbaa !69
  store i32 %i.ef, ptr %.010.i19.i63, align 4, !tbaa !69
  ...
  br i1 %.not.i21.i65, label %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit23.i66, label %.lr.ph.i18.i62, !llvm.loop !4789
...
vector.body246:                                   ; preds = %vector.body246, %vector.ph244
  ...
  %wide.load250 = load <4 x i32>, ptr %next.gep248, align 4, !tbaa !69
  %wide.load251 = load <4 x i32>, ptr %i.eu, align 4, !tbaa !69
  %i.ev = getelementptr i8, ptr %next.gep249, i64 16
  store <4 x i32> %wide.load250, ptr %next.gep249, align 4, !tbaa !69
  store <4 x i32> %wide.load251, ptr %i.ev, align 4, !tbaa !69
  %index.next252 = add nuw i64 %index247, 8       ; 2 uses
  %i.ew = icmp eq i64 %index.next252, %n.vec245
  br i1 %i.ew, label %middle.block253, label %vector.body246, !llvm.loop !4790
...
.lr.ph.i24.i69:                                   ; preds = %.lr.ph.i24.i69.preheader288, %.lr.ph.i24.i69
  ...
  %i.ex = load i32, ptr %.012.i.i70, align 4, !tbaa !69
  store i32 %i.ex, ptr %.0911.i.i71, align 4, !tbaa !69
  ...
  br i1 %.not.i25.i72, label %_ZN5boost7movelib13adaptive_xbufIiPimE11move_assignIS2_EEvT_m.exit73, label %.lr.ph.i24.i69, !llvm.loop !4791
...
_ZN5boost7movelib13adaptive_xbufIiPimE11move_assignIS2_EEvT_m.exit73: ; preds = %.lr.ph.i.i56, %.lr.ph.i24.i69, %middle.block218, %middle.block253, %bb.i, %_ZN5boost4moveIPiS1_EET0_T_S3_S2_.exit23.i66
  ...
  store i64 %i.cy, ptr %i.cz, align 8, !tbaa !2566
...
vector.body267:                                   ; preds = %vector.body267, %vector.ph265
  ...
  %wide.load271 = load <4 x i32>, ptr %i.fq, align 4, !tbaa !69
  %wide.load272 = load <4 x i32>, ptr %i.fr, align 4, !tbaa !69
  %i.fs = getelementptr inbounds i8, ptr %next.gep269, i64 -16
  %i.ft = getelementptr inbounds i8, ptr %next.gep269, i64 -32
  store <4 x i32> %wide.load271, ptr %i.fs, align 4, !tbaa !69
  store <4 x i32> %wide.load272, ptr %i.ft, align 4, !tbaa !69
  %index.next273 = add nuw i64 %index268, 8       ; 2 uses
  %i.fu = icmp eq i64 %index.next273, %n.vec266
  br i1 %i.fu, label %middle.block274, label %vector.body267, !llvm.loop !4792
...
.lr.ph.i.i.i77:                                   ; preds = %.lr.ph.i.i.i77.preheader282, %.lr.ph.i.i.i77
  ...
  %i.fx = load i32, ptr %i.fv, align 4, !tbaa !69
  store i32 %i.fx, ptr %i.fw, align 4, !tbaa !69
  %.not.i.i.i80 = icmp eq ptr %i.fa, %i.fv
  br i1 %.not.i.i.i80, label %_ZN5boost7movelib26op_merge_with_right_placedINS0_10antistableINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEEEPiSD_NS0_7move_opEEEvT0_SF_T1_SG_SG_T_T2_.exit, label %.lr.ph.i.i.i77, !llvm.loop !4793
...
bb.k:                                             ; preds = %.lr.ph.i74
  ...
  %i.ga = load i32, ptr %i.fz, align 4, !tbaa !69 ; 2 uses
  %i.gb = load i32, ptr %i.fy, align 4, !tbaa !69 ; 2 uses
  ...
  store i32 %..i, ptr %i.gc, align 4, !tbaa !69
  %.not.i76 = icmp eq ptr %i.fa, %..01930.i
  %indvar.next261 = add i64 %indvar260, 1
  br i1 %.not.i76, label %_ZN5boost7movelib26op_merge_with_right_placedINS0_10antistableINS_9container3dtl23flat_tree_value_compareISt4lessIiEiNS_11move_detail8identityIiEEEEEEPiSD_NS0_7move_opEEEvT0_SF_T1_SG_SG_T_T2_.exit, label %.lr.ph.i74, !llvm.loop !4794
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %5, ptr %9, align 8, !tbaa !3304
  ...
  %i.h = load ptr, ptr %7, align 8, !tbaa !4773, !nonnull !1789
  call void @llvm.lifetime.start.p0(ptr nonnull %8)
  store ptr %i.h, ptr %8, align 8, !tbaa !2915
...
bb.e:                                             ; preds = %bb.d
  %i.k = load i32, ptr %0, align 4, !tbaa !69     ; 2 uses
  %i.l = load i32, ptr %1, align 4, !tbaa !69     ; 2 uses
