...
bb.b:                                             ; preds = %.lr.ph, %.backedge
  ...
  %i.a = load i32, ptr %.065176, align 8, !tbaa !263
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.c = load i32, ptr %i.b, align 8, !tbaa !265
...
.backedge:                                        ; preds = %bb.d, %bb.e, %bb.v
  ...
  %.065.be = load ptr, ptr %.065.be.in, align 8, !tbaa !84 ; 2 uses
  %.not = icmp eq ptr %.065.be, null
  br i1 %.not, label %.thread, label %bb.b, !llvm.loop !1164
...
.outer.outer:                                     ; preds = %bb.i
  ...
  %i.q = load i32, ptr %i.p, align 4, !tbaa !86
  %i.r = load ptr, ptr %i.o, align 8, !tbaa !381  ; 2 uses
  %.not175180189 = icmp eq ptr %i.r, null
  br i1 %.not175180189, label %.thread, label %.lr.ph.lr.ph.lr.ph, !llvm.loop !1164

bb.j:                                             ; preds = %bb.b
  %i.s = getelementptr inbounds nuw i8, ptr %.065176, i64 16
  %i.t = load i32, ptr %i.s, align 8, !tbaa !323
...
bb.l:                                             ; preds = %bb.b
  ...
  %i.ad = load ptr, ptr %i.ac, align 8, !tbaa !84
...
bb.m:                                             ; preds = %bb.l
  %i.af = load i32, ptr %i.x, align 8, !tbaa !263
...
bb.p:                                             ; preds = %bb.m
  ...
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !360, !range !267, !noundef !107
...
.thread300:                                       ; preds = %bb.p
  store i32 25, ptr %.065176, align 8, !tbaa !263
  br label %bb.r
...
_ZN5boost13re_detail_60019basic_regex_creatorIcNS_12regex_traitsIcNS_16cpp_regex_traitsIcEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread: ; preds = %bb.m, %bb.n, %bb.o
  ...
  store i32 %.0.i.ph, ptr %.065176, align 8, !tbaa !263
...
_ZN5boost13re_detail_60019basic_regex_creatorIcNS_12regex_traitsIcNS_16cpp_regex_traitsIcEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread71: ; preds = %bb.l, %bb.m, %bb.p
  store i32 18, ptr %.065176, align 8, !tbaa !263
  br label %.thread
...
.loopexit470:                                     ; preds = %bb.b, %bb.b, %bb.b, %_ZN5boost13re_detail_60019basic_regex_creatorIcNS_12regex_traitsIcNS_16cpp_regex_traitsIcEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread
  ...
  %i.ak = load i64, ptr %i.aj, align 8, !tbaa !325 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %.065176, i64 288
  %i.am = load i64, ptr %i.al, align 8, !tbaa !324 ; 2 uses
  ...
  br i1 %or.cond, label %.thread, label %bb.s, !llvm.loop !1164
...
bb.q:                                             ; preds = %bb.b
  ...
  %.pre293 = load i8, ptr %.phi.trans.insert292, align 1, !tbaa !360, !range !267
...
bb.r:                                             ; preds = %.thread300, %bb.q
  ...
  %i.as = load i64, ptr %i.ar, align 8, !tbaa !325 ; 2 uses
  %i.at = getelementptr inbounds nuw i8, ptr %.065176, i64 288
  %i.au = load i64, ptr %i.at, align 8, !tbaa !324
  %.not25 = icmp eq i64 %i.as, %i.au
  br i1 %.not25, label %bb.s, label %.thread, !llvm.loop !1164
...
bb.t:                                             ; preds = %bb.b
  ...
  %i.aw = load i8, ptr %i.av, align 1, !tbaa !360, !range !267, !noundef !107
...
bb.y:                                             ; preds = %bb.x
  ...
  store i64 %i.bh, ptr %.sroa.10.0.ph82183, align 8, !tbaa !381
...
.noexc33:                                         ; preds = %_ZNKSt6vectorISt5tupleIJiPN5boost13re_detail_60014re_syntax_baseEEESaIS5_EE12_M_check_lenEmPKc.exit.i
  ...
  store i64 %i.bn, ptr %i.bm, align 8, !tbaa !381
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bm, i64 8
  store i32 %.0.ph191, ptr %i.bo, align 8, !tbaa !86
...
.lr.ph.i.i.i.i:                                   ; preds = %.noexc33, %.lr.ph.i.i.i.i
  ...
  %i.bp = load i64, ptr %.0911.i.i.i.i, align 8, !tbaa !381, !alias.scope !1172, !noalias !1171
  store i64 %i.bp, ptr %.012.i.i.i.i, align 8, !tbaa !381, !alias.scope !1171, !noalias !1172
  %i.bq = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i, i64 8
  %i.br = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i, i64 8
  %i.bs = load i32, ptr %i.br, align 8, !tbaa !86, !alias.scope !1172, !noalias !1171
  store i32 %i.bs, ptr %i.bq, align 8, !tbaa !86, !alias.scope !1171, !noalias !1172
  ...
  br i1 %.not.i.i.i.i, label %_ZNSt6vectorISt5tupleIJiPN5boost13re_detail_60014re_syntax_baseEEESaIS5_EE11_S_relocateEPS5_S8_S8_RS6_.exit22.i, label %.lr.ph.i.i.i.i, !llvm.loop !27
...
bb.z:                                             ; preds = %_ZNSt6vectorISt5tupleIJiPN5boost13re_detail_60014re_syntax_baseEEESaIS5_EE11_S_relocateEPS5_S8_S8_RS6_.exit22.i
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.037.0.ph83184, i64 noundef %i.bc) #31
  br label %.noexc
...
.outer.backedge:                                  ; preds = %bb.b, %bb.c, %bb.j, %bb.k, %bb.u, %bb.f, %bb.s
  ...
  %.065.ph.be = load ptr, ptr %i.by, align 8, !tbaa !84 ; 2 uses
  %.not175180 = icmp eq ptr %.065.ph.be, null
  br i1 %.not175180, label %.thread, label %.lr.ph.lr.ph, !llvm.loop !1164
...
bb.ac:                                            ; preds = %.thread
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.037.0.ph83127, i64 noundef %i.cb) #31
...
define linkonce_odr void @_ZNSt6vectorIhSaIhEE14_M_fill_assignEmRKh(ptr noundef nonnull align 8 dereferenceable(24) %0, i64 noundef %1, ptr noundef nonnull align 1 dereferenceable(1) %2) local_unnamed_addr #3 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 3 uses
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !138
  %i.c = load ptr, ptr %0, align 8, !tbaa !137    ; 6 uses
...
bb.c:                                             ; preds = %bb.b
  tail call void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.261) #29
  unreachable

_ZNSt6vectorIhSaIhEEC2EmRKhRKS0_.exit:            ; preds = %bb.b
  %i.i = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %1) #30 ; 3 uses
  %i.j = getelementptr inbounds nuw i8, ptr %i.i, i64 %1 ; 2 uses
  %i.k = load i8, ptr %2, align 1, !tbaa !84
  tail call void @llvm.memset.p0.i64(ptr nonnull align 1 %i.i, i8 %i.k, i64 %1, i1 false)
  %i.l = load ptr, ptr %0, align 8, !tbaa !137    ; 3 uses
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.n = load ptr, ptr %i.a, align 8, !tbaa !138
  store ptr %i.i, ptr %0, align 8, !tbaa !137
  store ptr %i.j, ptr %i.m, align 8, !tbaa !376
  store ptr %i.j, ptr %i.a, align 8, !tbaa !138
...
bb.e:                                             ; preds = %bb.a
  ...
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !376  ; 4 uses
...
bb.g:                                             ; preds = %bb.f
  %i.w = load i8, ptr %2, align 1, !tbaa !84
  tail call void @llvm.memset.p0.i64(ptr align 1 %i.c, i8 %i.w, i64 %i.u, i1 false)
  %.pre14 = load ptr, ptr %i.r, align 8, !tbaa !376 ; 2 uses
  %.pre15 = load ptr, ptr %0, align 8, !tbaa !137
...
bb.h:                                             ; preds = %_ZSt4fillIN9__gnu_cxx17__normal_iteratorIPhSt6vectorIhSaIhEEEEhEvT_S7_RKT0_.exit
  ...
  %i.ab = load i8, ptr %2, align 1, !tbaa !84
...
_ZSt24__uninitialized_fill_n_aIPhmhhET_S1_T0_RKT1_RSaIT2_E.exit: ; preds = %_ZSt4fillIN9__gnu_cxx17__normal_iteratorIPhSt6vectorIhSaIhEEEEhEvT_S7_RKT0_.exit, %bb.h
  ...
  store ptr %.0.i.i.i.i.i, ptr %i.r, align 8, !tbaa !376
  br label %_ZNSt6vectorIhSaIhEED2Ev.exit
...
_ZSt8_DestroyIPhhEvT_S1_RSaIT0_E.exit.i:          ; preds = %_ZSt6fill_nIPhmhET_S1_T0_RKT1_.exit
  store ptr %.0.i.i, ptr %i.r, align 8, !tbaa !376
  br label %_ZNSt6vectorIhSaIhEED2Ev.exit
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !114  ; 11 uses
  %i.g = getelementptr inbounds nuw i8, ptr %2, i64 16 ; 2 uses
  %i.h = load i32, ptr %i.g, align 8, !tbaa !353
...
.lr.ph232.split:                                  ; preds = %bb.b, %bb.h
  ...
  %i.i = load i8, ptr %.0103229, align 1, !tbaa !84 ; 2 uses
...
_ZNK5boost16cpp_regex_traitsIcE9translateEcb.exit135.us: ; preds = %.lr.ph, %bb.c
  ...
  %i.k = load i8, ptr %.0102218.us, align 1, !tbaa !84
  %i.l = load ptr, ptr %i.f, align 8, !tbaa !181
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 8
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !157  ; 2 uses
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !102
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 32
  %i.q = load ptr, ptr %i.p, align 8
  %i.r = tail call noundef signext i8 %i.q(ptr noundef nonnull align 8 dereferenceable(570) %i.n, i8 noundef signext %i.k), !inline_history !24
  %i.s = load i8, ptr %.1104217.us, align 1, !tbaa !84 ; 2 uses
...
bb.c:                                             ; preds = %_ZNK5boost16cpp_regex_traitsIcE9translateEcb.exit135.us
  ...
  %i.v = load i8, ptr %i.t, align 1, !tbaa !84    ; 2 uses
  %i.w = icmp ne i8 %i.v, 0
  %i.x = icmp ne ptr %i.u, %1
  %i.y = select i1 %i.w, i1 %i.x, i1 false
  br i1 %i.y, label %_ZNK5boost16cpp_regex_traitsIcE9translateEcb.exit135.us, label %_ZNK5boost16cpp_regex_traitsIcE9translateEcb.exit135._crit_edge, !llvm.loop !1173

bb.d:                                             ; preds = %.lr.ph232.split
  %i.z = load i8, ptr %0, align 1, !tbaa !84      ; 2 uses
  br i1 %4, label %bb.e, label %_ZNK5boost16cpp_regex_traitsIcE9translateEcb.exit

bb.e:                                             ; preds = %bb.d
  %i.aa = load ptr, ptr %i.f, align 8, !tbaa !181
...
end_hunk_0
begin_hunk_1_@_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE18calculate_backstepEPNS0_14re_syntax_baseE:bb.a
.lr.ph.lr.ph:                                     ; preds = %.lr.ph.lr.ph.lr.ph, %.outer.backedge
  %.sroa.037.0.ph195 = phi ptr [ %.sroa.037.0.ph.ph205, %.lr.ph.lr.ph.lr.ph ], [ %.sroa.037.0.ph83184, %.outer.backedge ]
  %.sroa.10.0.ph194 = phi ptr [ %.sroa.10.0.ph.ph204, %.lr.ph.lr.ph.lr.ph ], [ %.sroa.10.0.ph82183, %.outer.backedge ]
  %.sroa.19.0.ph193 = phi ptr [ %.sroa.19.0.ph.ph203, %.lr.ph.lr.ph.lr.ph ], [ %.sroa.19.0.ph81182, %.outer.backedge ]
...
.backedge:                                        ; preds = %bb.d, %bb.e, %bb.v
  ...
  %.065.be = load ptr, ptr %.065.be.in, align 8, !tbaa !84 ; 2 uses
  %.not = icmp eq ptr %.065.be, null
  br i1 %.not, label %.thread, label %bb.b, !llvm.loop !1631
...
.outer.outer:                                     ; preds = %bb.i
  ...
  %i.r = load ptr, ptr %i.o, align 8, !tbaa !381  ; 2 uses
  %.not175180189 = icmp eq ptr %i.r, null
  br i1 %.not175180189, label %.thread, label %.lr.ph.lr.ph.lr.ph, !llvm.loop !1631
...
bb.l:                                             ; preds = %bb.b
  ...
  %i.ad = load ptr, ptr %i.ac, align 8, !tbaa !84
  %i.ae = icmp eq ptr %i.ab, %i.ad
  br i1 %i.ae, label %bb.m, label %_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread71

bb.m:                                             ; preds = %bb.l
  %i.af = load i32, ptr %i.x, align 8, !tbaa !263
  switch i32 %i.af, label %_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread71 [
    i32 5, label %_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread
    i32 2, label %bb.n
    i32 15, label %bb.o
    i32 14, label %bb.p
  ]
...
bb.n:                                             ; preds = %bb.m
  br label %_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread
...
bb.p:                                             ; preds = %bb.m
  ...
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !360, !range !267, !noundef !107
  %i.ai = trunc nuw i8 %i.ah to i1
  br i1 %i.ai, label %.thread300, label %_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread71

.thread300:                                       ; preds = %bb.p
  store i32 25, ptr %.065176, align 8, !tbaa !263
  br label %bb.r

_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread: ; preds = %bb.m, %bb.n, %bb.o
  %.0.i.ph = phi i32 [ 24, %bb.o ], [ 23, %bb.n ], [ 22, %bb.m ]
  store i32 %.0.i.ph, ptr %.065176, align 8, !tbaa !263
  br label %.loopexit470

_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread71: ; preds = %bb.l, %bb.m, %bb.p
  store i32 18, ptr %.065176, align 8, !tbaa !263
  br label %.thread

.loopexit470:                                     ; preds = %bb.b, %bb.b, %bb.b, %_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread
  %i.aj = getelementptr inbounds nuw i8, ptr %.065176, i64 296
  %i.ak = load i64, ptr %i.aj, align 8, !tbaa !325 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %.065176, i64 288
  %i.am = load i64, ptr %i.al, align 8, !tbaa !324 ; 2 uses
  ...
  %i.ap = icmp ugt i64 %i.am, %i.ao
  %or.cond = select i1 %.not26, i1 true, i1 %i.ap
  br i1 %or.cond, label %.thread, label %bb.s, !llvm.loop !1631
...
bb.r:                                             ; preds = %.thread300, %bb.q
  ...
  %i.au = load i64, ptr %i.at, align 8, !tbaa !324
  %.not25 = icmp eq i64 %i.as, %i.au
  br i1 %.not25, label %bb.s, label %.thread, !llvm.loop !1631
...
.lr.ph.i.i.i.i:                                   ; preds = %.noexc33, %.lr.ph.i.i.i.i
  ...
  %i.bp = load i64, ptr %.0911.i.i.i.i, align 8, !tbaa !381, !alias.scope !1639, !noalias !1638
  store i64 %i.bp, ptr %.012.i.i.i.i, align 8, !tbaa !381, !alias.scope !1638, !noalias !1639
  %i.bq = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i, i64 8
  %i.br = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i, i64 8
  %i.bs = load i32, ptr %i.br, align 8, !tbaa !86, !alias.scope !1639, !noalias !1638
  store i32 %i.bs, ptr %i.bq, align 8, !tbaa !86, !alias.scope !1638, !noalias !1639
  %i.bt = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i, i64 16 ; 2 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i, i64 16 ; 2 uses
  %.not.i.i.i.i = icmp eq ptr %i.bt, %.sroa.10.0.ph82183
  br i1 %.not.i.i.i.i, label %_ZNSt6vectorISt5tupleIJiPN5boost13re_detail_60014re_syntax_baseEEESaIS5_EE11_S_relocateEPS5_S8_S8_RS6_.exit22.i, label %.lr.ph.i.i.i.i, !llvm.loop !27
...
.outer.backedge:                                  ; preds = %bb.b, %bb.c, %bb.j, %bb.k, %bb.u, %bb.f, %bb.s
  ...
  %.065.ph.be = load ptr, ptr %i.by, align 8, !tbaa !84 ; 2 uses
  %.not175180 = icmp eq ptr %.065.ph.be, null
  br i1 %.not175180, label %.thread, label %.lr.ph.lr.ph, !llvm.loop !1631

.thread:                                          ; preds = %.outer.outer, %bb.i, %bb.h, %.outer.backedge, %bb.q, %.loopexit470, %bb.r, %bb.t, %bb.w, %_ZNSt6vectorISt5tupleIJiPN5boost13re_detail_60014re_syntax_baseEEESaIS5_EE9push_backEOS5_.exit, %bb.b, %bb.b, %bb.b, %.backedge, %_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread71
  %.sroa.19.0.ph81163 = phi ptr [ %.sroa.19.0.ph81182, %_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread71 ], [ %.sroa.19.0.ph81182, %.outer.backedge ], [ %.sroa.19.0.ph81182, %bb.w ], [ %.sroa.19.0.ph81182, %bb.b ], [ %.sroa.19.0.ph81182, %.backedge ], [ %.sroa.19.0.ph81182, %bb.b ], [ %.sroa.19.0.ph81182, %bb.b ], [ %.sroa.19.1, %_ZNSt6vectorISt5tupleIJiPN5boost13re_detail_60014re_syntax_baseEEESaIS5_EE9push_backEOS5_.exit ], [ %.sroa.19.0.ph81182, %bb.t ], [ %.sroa.19.0.ph81182, %bb.r ], [ %.sroa.19.0.ph81182, %.loopexit470 ], [ %.sroa.19.0.ph81182, %bb.q ], [ %.sroa.19.0.ph81182, %bb.h ], [ %.sroa.19.0.ph81182, %bb.i ], [ %.sroa.19.0.ph81182, %.outer.outer ]
  %.sroa.037.0.ph83127 = phi ptr [ %.sroa.037.0.ph83184, %_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread71 ], [ %.sroa.037.0.ph83184, %.outer.backedge ], [ %.sroa.037.0.ph83184, %bb.w ], [ %.sroa.037.0.ph83184, %bb.b ], [ %.sroa.037.0.ph83184, %.backedge ], [ %.sroa.037.0.ph83184, %bb.b ], [ %.sroa.037.0.ph83184, %bb.b ], [ %.sroa.037.1, %_ZNSt6vectorISt5tupleIJiPN5boost13re_detail_60014re_syntax_baseEEESaIS5_EE9push_backEOS5_.exit ], [ %.sroa.037.0.ph83184, %bb.t ], [ %.sroa.037.0.ph83184, %bb.r ], [ %.sroa.037.0.ph83184, %.loopexit470 ], [ %.sroa.037.0.ph83184, %bb.q ], [ %.sroa.037.0.ph83184, %bb.h ], [ %.sroa.037.0.ph83184, %bb.i ], [ %.sroa.037.0.ph83184, %.outer.outer ] ; 3 uses
  %.2 = phi i32 [ -1, %_ZN5boost13re_detail_60019basic_regex_creatorIwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEE15get_repeat_typeEPNS0_14re_syntax_baseE.exit.thread71 ], [ -1, %.outer.backedge ], [ -1, %bb.w ], [ -1, %bb.b ], [ -1, %.backedge ], [ -1, %bb.b ], [ -1, %bb.b ], [ -1, %_ZNSt6vectorISt5tupleIJiPN5boost13re_detail_60014re_syntax_baseEEESaIS5_EE9push_backEOS5_.exit ], [ -1, %bb.t ], [ -1, %bb.r ], [ -1, %.loopexit470 ], [ -1, %bb.q ], [ -1, %bb.h ], [ -1, %.outer.outer ], [ %.0.ph191, %bb.i ] ; 2 uses
  %.not.i.i.i29 = icmp eq ptr %.sroa.037.0.ph83127, null
  br i1 %.not.i.i.i29, label %_ZNSt6vectorISt5tupleIJiPN5boost13re_detail_60014re_syntax_baseEEESaIS5_EED2Ev.exit30, label %bb.ac
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden noundef ptr @_ZN5boost13re_detail_60016re_is_set_memberIPwwNS_12regex_traitsIwNS_16cpp_regex_traitsIwEEEEjEET_S7_S7_PKNS0_11re_set_longIT2_EERKNS0_10regex_dataIT0_T1_EEb(ptr noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef nonnull align 8 dereferenceable(402) %3, i1 noundef zeroext %4) local_unnamed_addr #3 comdat personality ptr @__gxx_personality_v0 {
bb.a:
  %5 = alloca %"class.std::__cxx11::basic_string.7", align 8 ; 23 uses
  %i.a = alloca [2 x i32], align 4                ; 6 uses
  %6 = alloca %"class.std::__cxx11::basic_string.7", align 8 ; 14 uses
  %i.b = alloca [2 x i32], align 4                ; 6 uses
  %7 = alloca %"class.std::__cxx11::basic_string.7", align 8 ; 14 uses
  %i.c = icmp eq ptr %0, %1
...
bb.b:                                             ; preds = %bb.a
  %i.d = getelementptr inbounds nuw i8, ptr %2, i64 40 ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %3, i64 24
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !395  ; 7 uses
  %i.g = getelementptr inbounds nuw i8, ptr %2, i64 16 ; 2 uses
  %i.h = load i32, ptr %i.g, align 8, !tbaa !353
  %.not226 = icmp eq i32 %i.h, 0
  br i1 %.not226, label %._crit_edge208, label %.lr.ph207.split

.lr.ph207.split:                                  ; preds = %bb.b, %bb.h
  %.0100205 = phi i32 [ %i.bc, %bb.h ], [ 0, %bb.b ]
  %.0103204 = phi ptr [ %.2105, %bb.h ], [ %i.d, %bb.b ] ; 4 uses
  %i.i = load i32, ptr %.0103204, align 4, !tbaa !388 ; 2 uses
  %i.j = icmp eq i32 %i.i, 0
  br i1 %i.j, label %bb.d, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph207.split
  br i1 %4, label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135.us, label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135

_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135.us: ; preds = %.lr.ph, %bb.c
  %.0102193.us = phi ptr [ %i.u, %bb.c ], [ %0, %.lr.ph ] ; 3 uses
  %.1104192.us = phi ptr [ %i.t, %bb.c ], [ %.0103204, %.lr.ph ] ; 3 uses
  %i.k = load i32, ptr %.0102193.us, align 4, !tbaa !388
  %i.l = load ptr, ptr %i.f, align 8, !tbaa !414
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 8
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !409  ; 2 uses
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !102
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 64
  %i.q = load ptr, ptr %i.p, align 8
  %i.r = tail call noundef signext i32 %i.q(ptr noundef nonnull align 8 dereferenceable(12) %i.n, i32 noundef signext %i.k), !inline_history !42
  %i.s = load i32, ptr %.1104192.us, align 4, !tbaa !388 ; 2 uses
  %.not132.us = icmp eq i32 %i.r, %i.s
  br i1 %.not132.us, label %bb.c, label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135._crit_edge

bb.c:                                             ; preds = %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135.us
  %i.t = getelementptr inbounds nuw i8, ptr %.1104192.us, i64 4 ; 3 uses
  %i.u = getelementptr inbounds nuw i8, ptr %.0102193.us, i64 4 ; 3 uses
  %i.v = load i32, ptr %i.t, align 4, !tbaa !388  ; 2 uses
  %i.w = icmp ne i32 %i.v, 0
  %i.x = icmp ne ptr %i.u, %1
  %i.y = select i1 %i.w, i1 %i.x, i1 false
  br i1 %i.y, label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135.us, label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135._crit_edge, !llvm.loop !1640

bb.d:                                             ; preds = %.lr.ph207.split
  %i.z = load i32, ptr %0, align 4, !tbaa !388    ; 2 uses
  br i1 %4, label %bb.e, label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit

bb.e:                                             ; preds = %bb.d
  %i.aa = load ptr, ptr %i.f, align 8, !tbaa !414
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 8
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !409 ; 2 uses
  %i.ad = load ptr, ptr %i.ac, align 8, !tbaa !102
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 64
  %i.af = load ptr, ptr %i.ae, align 8
  %i.ag = tail call noundef signext i32 %i.af(ptr noundef nonnull align 8 dereferenceable(12) %i.ac, i32 noundef signext %i.z), !inline_history !42
  br label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit

_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit: ; preds = %bb.d, %bb.e
  %i.ah = phi i32 [ %i.ag, %bb.e ], [ %i.z, %bb.d ]
  %.not133 = icmp eq i32 %i.ah, 0
  br i1 %.not133, label %.split212.us, label %bb.h

.split212.us:                                     ; preds = %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit
  %i.ai = getelementptr inbounds nuw i8, ptr %2, i64 36
  %i.aj = load i8, ptr %i.ai, align 4, !tbaa !359, !range !267, !noundef !107
  %i.ak = trunc nuw i8 %i.aj to i1
  %.idx183 = select i1 %i.ak, i64 0, i64 4
  %i.al = getelementptr inbounds nuw i8, ptr %0, i64 %.idx183
  br label %bb.as

_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135: ; preds = %.lr.ph, %bb.f
  %i.am = phi i32 [ %i.aq, %bb.f ], [ %i.i, %.lr.ph ]
  %.0102193 = phi ptr [ %i.ap, %bb.f ], [ %0, %.lr.ph ] ; 2 uses
  %.1104192 = phi ptr [ %i.ao, %bb.f ], [ %.0103204, %.lr.ph ] ; 2 uses
  %i.an = load i32, ptr %.0102193, align 4, !tbaa !388
  %.not132 = icmp eq i32 %i.an, %i.am
  br i1 %.not132, label %bb.f, label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135._crit_edge.thread

bb.f:                                             ; preds = %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135
  %i.ao = getelementptr inbounds nuw i8, ptr %.1104192, i64 4 ; 3 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %.0102193, i64 4 ; 3 uses
  %i.aq = load i32, ptr %i.ao, align 4, !tbaa !388 ; 3 uses
  %i.ar = icmp ne i32 %i.aq, 0
  %i.as = icmp ne ptr %i.ap, %1
  %i.at = select i1 %i.ar, i1 %i.as, i1 false
  br i1 %i.at, label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135, label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135._crit_edge, !llvm.loop !1640

_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135._crit_edge: ; preds = %bb.f, %bb.c, %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135.us
  %.1104.lcssa = phi ptr [ %.1104192.us, %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135.us ], [ %i.t, %bb.c ], [ %i.ao, %bb.f ]
  %.0102.lcssa = phi ptr [ %.0102193.us, %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135.us ], [ %i.u, %bb.c ], [ %i.ap, %bb.f ] ; 2 uses
  %i.au = phi i32 [ %i.s, %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135.us ], [ %i.v, %bb.c ], [ %i.aq, %bb.f ]
  %i.av = icmp eq i32 %i.au, 0
  br i1 %i.av, label %.split.us, label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135._crit_edge.thread

.split.us:                                        ; preds = %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135._crit_edge
  %i.aw = getelementptr inbounds nuw i8, ptr %2, i64 36
  %i.ax = load i8, ptr %i.aw, align 4, !tbaa !359, !range !267, !noundef !107
  %i.ay = trunc nuw i8 %i.ax to i1
  br i1 %i.ay, label %bb.as, label %bb.g

bb.g:                                             ; preds = %.split.us
  %i.az = icmp eq ptr %.0102.lcssa, %0
  %i.ba = getelementptr inbounds nuw i8, ptr %0, i64 4
  %spec.select = select i1 %i.az, ptr %i.ba, ptr %.0102.lcssa
  br label %bb.as

_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135._crit_edge.thread: ; preds = %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135, %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135._crit_edge
  %.1104.lcssa293 = phi ptr [ %.1104.lcssa, %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135._crit_edge ], [ %.1104192, %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135 ] ; 2 uses
  %wcslen.i = tail call i64 @wcslen(ptr nonnull %.1104.lcssa293)
  %i.bb = shl i64 %wcslen.i, 2
  %scevgep.i = getelementptr i8, ptr %.1104.lcssa293, i64 %i.bb
  br label %bb.h

bb.h:                                             ; preds = %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit, %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135._crit_edge.thread
  %.0103.pn = phi ptr [ %scevgep.i, %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit135._crit_edge.thread ], [ %.0103204, %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit ]
  %.2105 = getelementptr inbounds nuw i8, ptr %.0103.pn, i64 4 ; 2 uses
  %i.bc = add nuw i32 %.0100205, 1                ; 2 uses
  %i.bd = load i32, ptr %i.g, align 8, !tbaa !353
  %i.be = icmp ult i32 %i.bc, %i.bd
  br i1 %i.be, label %.lr.ph207.split, label %._crit_edge208, !llvm.loop !1641

._crit_edge208:                                   ; preds = %bb.h, %bb.b
  %.0103.lcssa = phi ptr [ %i.d, %bb.b ], [ %.2105, %bb.h ] ; 3 uses
  %i.bf = load i32, ptr %0, align 4, !tbaa !388   ; 2 uses
  br i1 %4, label %bb.i, label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit136

bb.i:                                             ; preds = %._crit_edge208
  %i.bg = load ptr, ptr %i.f, align 8, !tbaa !414
  %i.bh = getelementptr inbounds nuw i8, ptr %i.bg, i64 8
  %i.bi = load ptr, ptr %i.bh, align 8, !tbaa !409 ; 2 uses
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !102
  %i.bk = getelementptr inbounds nuw i8, ptr %i.bj, i64 64
  %i.bl = load ptr, ptr %i.bk, align 8
  %i.bm = tail call noundef signext i32 %i.bl(ptr noundef nonnull align 8 dereferenceable(12) %i.bi, i32 noundef signext %i.bf), !inline_history !42
  br label %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit136

_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit136: ; preds = %._crit_edge208, %bb.i
  %i.bn = phi i32 [ %i.bm, %bb.i ], [ %i.bf, %._crit_edge208 ] ; 5 uses
  %i.bo = getelementptr inbounds nuw i8, ptr %2, i64 20 ; 2 uses
  %i.bp = load i32, ptr %i.bo, align 4, !tbaa !355
  %.not = icmp eq i32 %i.bp, 0
  br i1 %.not, label %bb.j, label %bb.k

bb.j:                                             ; preds = %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit136
  %i.bq = getelementptr inbounds nuw i8, ptr %2, i64 24
  %i.br = load i32, ptr %i.bq, align 8, !tbaa !356
  %.not122 = icmp eq i32 %i.br, 0
  br i1 %.not122, label %bb.am, label %.thread

.thread:                                          ; preds = %bb.j
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #27
  %i.bs = getelementptr inbounds nuw i8, ptr %5, i64 16 ; 3 uses
  store ptr %i.bs, ptr %5, align 8, !tbaa !384
  %i.bt = getelementptr inbounds nuw i8, ptr %5, i64 8 ; 2 uses
  store i64 0, ptr %i.bt, align 8, !tbaa !386
  store i32 0, ptr %i.bs, align 8, !tbaa !388
  br label %.loopexit185

bb.k:                                             ; preds = %_ZNK5boost16cpp_regex_traitsIwE9translateEwb.exit136
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #27
  %i.bu = getelementptr inbounds nuw i8, ptr %5, i64 16 ; 9 uses
end_hunk_1
