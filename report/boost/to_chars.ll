...
.thread248:                                       ; preds = %_ZN5boost8charconv6detailrsENS1_7uint128Ei.exit.thread
  br i1 %.not, label %.preheader.preheader, label %.thread.thread

.thread.thread:                                   ; preds = %.thread248
...
_ZN5boost8charconv6detailrsENS1_7uint128Ei.exit.thread: ; preds = %_ZN5boost8charconv6detailrsENS1_7uint128Ei.exit.13
  ...
  br i1 %i.ej, label %.thread, label %.thread248
...
.preheader.preheader:                             ; preds = %.thread248, %.thread
  %.4.pn.ph = phi ptr [ %i.eh, %.thread248 ], [ %.4, %.thread ]
  br label %.preheader
...
bb.o:                                             ; preds = %bb.n
  ...
  %spec.select257 = select i1 %i.ep, i64 10, i64 5
...
_ZN5boost8charconv6detail10num_digitsIjEEiT_.exit.i.i: ; preds = %bb.o, %bb.r, %bb.q
  %.0.i.i.i = phi i64 [ %spec.select257, %bb.o ], [ %.12.i.i.i, %bb.q ], [ %.13.i.i.i, %bb.r ] ; 4 uses
