...
begin_hunk_0_@_ZNK5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE5beginEv:bb.a
  %i.m = sub i64 %i.k, %i.l
  %i.n = ashr exact i64 %i.m, 3
  %i.o = getelementptr inbounds nuw i8, ptr %i.i, i64 8
  %i.p = load i64, ptr %i.o, align 8, !tbaa !28
  %i.q = sub nsw i64 63, %i.n
  %i.r = lshr i64 -1, %i.q
  %i.s = xor i64 %i.r, -1
  %i.t = and i64 %i.p, %i.s
  %i.u = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %i.t, i1 false) ; 2 uses
  %i.v = icmp samesign ult i64 %i.u, 64
  br i1 %i.v, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %i.w = getelementptr inbounds nuw [8 x i8], ptr %i.j, i64 %i.u
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.ab = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %i.aa, i1 false)
  %i.ac = load ptr, ptr %i.y, align 8, !tbaa !27
  %i.ad = getelementptr inbounds nuw [8 x i8], ptr %i.ac, i64 %i.ab
  br label %_ZN5boost9unordered6detail23grouped_bucket_iteratorINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EEEppEv.exit

_ZN5boost9unordered6detail23grouped_bucket_iteratorINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EEEppEv.exit: ; preds = %bb.a, %bb.d, %bb.c
  %.pn4 = phi ptr [ %i.ad, %bb.d ], [ %i.w, %bb.c ], [ %i.e, %bb.a ]
  %.pn = phi ptr [ %i.y, %bb.d ], [ %i.i, %bb.c ], [ null, %bb.a ]
  %.fca.0.insert.i.pn = insertvalue { ptr, ptr } poison, ptr %.pn4, 0
...
define linkonce_odr hidden void @_ZN5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE14emplace_uniqueIJS5_EEESt4pairINS1_15iterator_detail8iteratorINS1_4nodeIS5_PvEENS1_6bucketISJ_SI_EEEEbERKS5_DpOT_(ptr dead_on_unwind noalias writable sret(%"struct.std::pair.13") align 8 %0, ptr noundef nonnull align 8 dereferenceable(64) %1, ptr noundef nonnull align 8 dereferenceable(8) %2, ptr noundef nonnull align 8 dereferenceable(8) %3) local_unnamed_addr #11 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = load ptr, ptr %2, align 8, !tbaa !35     ; 5 uses
  %i.b = tail call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.a) #23 ; 6 uses
  %i.c = xor i64 %i.b, -1606050821391897906       ; 3 uses
  %i.d = icmp ugt i64 %i.b, 7
  br i1 %i.d, label %.lr.ph.i.i.i.i.i.i.i.preheader, label %._crit_edge.i.i.i.i.i.i.i

.lr.ph.i.i.i.i.i.i.i.preheader:                   ; preds = %bb.a
  %i.e = add i64 %i.b, -8
  %i.f = lshr i64 %i.e, 3                         ; 2 uses
  %i.g = add nuw nsw i64 %i.f, 1                  ; 2 uses
  %min.iters.check = icmp eq i64 %i.f, 0
  br i1 %min.iters.check, label %.lr.ph.i.i.i.i.i.i.i.preheader82, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.i.i.i.preheader
  %n.vec = and i64 %i.g, 4611686018427387902      ; 5 uses
  %i.h = shl i64 %n.vec, 3
  %i.i = getelementptr i8, ptr %i.a, i64 %i.h     ; 2 uses
  %i.j = shl i64 %n.vec, 3
  %i.k = sub i64 %i.b, %i.j                       ; 2 uses
  %i.l = mul i64 %n.vec, -7046029254386353131     ; 2 uses
  %i.m = add i64 %i.l, -1606050821391897906
  %i.n = insertelement <2 x i64> <i64 poison, i64 0>, i64 %i.c, i64 0
...
bb.f:                                             ; preds = %_ZNK5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE4hashIS5_EEmRKT_.exit
  %i.cl = getelementptr [8 x i8], ptr @_ZN5boost9unordered6detail15prime_fmod_sizeIvE9positionsE, i64 %i.cb
  %i.cm = getelementptr i8, ptr %i.cl, i64 -232
  %i.cn = load ptr, ptr %i.cm, align 8, !tbaa !76
  %i.co = tail call noundef i64 %i.cn(i64 noundef %i.bz), !inline_history !1
  br label %_ZNK5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE8positionEm.exit
...
_ZNK5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE8positionEm.exit: ; preds = %bb.e, %bb.f
  ...
  %i.ct = getelementptr inbounds nuw i8, ptr %1, i64 56 ; 3 uses
  %i.cu = load ptr, ptr %i.ct, align 8
  %i.cv = lshr i64 %.0.i.i, 6
  %i.cw = getelementptr inbounds nuw [32 x i8], ptr %i.cu, i64 %i.cv
  %.sroa.3.0.i = select i1 %.not.i, ptr null, ptr %i.cw ; 2 uses
  %i.cx = shl nsw i64 %.0.i.i, 3
  %.sroa.0.0.i.idx = select i1 %.not.i, i64 0, i64 %i.cx ; 2 uses
  %.sroa.0.0.i = getelementptr inbounds i8, ptr %i.cs, i64 %.sroa.0.0.i.idx ; 3 uses
  %.idx = shl i64 %i.cq, 3
...
_ZN5boost9typeindex6detail18is_constant_stringEPKc.exit9.i.i.i.i.i: ; preds = %bb.g
  ...
  %i.db = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.cy, ptr noundef nonnull dereferenceable(1) %i.da) #19
...
_ZNK5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE14find_node_implIS5_EEPNS1_4nodeIS5_PvEERKT_NS1_23grouped_bucket_iteratorINS1_6bucketISG_SF_EEEE.exit.thread: ; preds = %bb.g, %_ZNK5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE8positionEm.exit
  %i.dc = tail call noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #24 ; 6 uses
  store ptr null, ptr %i.dc, align 8, !tbaa !67
  %i.dd = getelementptr inbounds nuw i8, ptr %i.dc, i64 8
  %i.de = load i64, ptr %3, align 8
  store i64 %i.de, ptr %i.dd, align 8
  %i.df = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 3 uses
  %i.dg = load i64, ptr %i.df, align 8, !tbaa !19 ; 2 uses
  %i.dh = add i64 %i.dg, 1                        ; 2 uses
  %i.di = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.dj = load i64, ptr %i.di, align 8, !tbaa !77
  %i.dk = icmp ugt i64 %i.dh, %i.dj
  br i1 %i.dk, label %_ZN5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE16bucket_count_forEm.exit.i.i, label %bb.n
...
_ZN5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE16bucket_count_forEm.exit.i.i: ; preds = %_ZNK5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE14find_node_implIS5_EEPNS1_4nodeIS5_PvEERKT_NS1_23grouped_bucket_iteratorINS1_6bucketISG_SF_EEEE.exit.thread
  ...
  %i.dm = load float, ptr %i.dl, align 8, !tbaa !20
  %i.dn = uitofp i64 %i.dh to float
  %i.do = uitofp i64 %i.dg to float
  ...
  %i.dt = fdiv <2 x float> %i.dq, %i.ds           ; 2 uses
  %i.du = extractelement <2 x float> %i.dt, i64 0
  %i.dv = tail call noundef float @llvm.ceil.f32(float %i.du) ; 2 uses
  %i.dw = fcmp ult float %i.dv, f0x5F800000
  %i.dx = fptoui float %i.dv to i64
  %i.dy = extractelement <2 x float> %i.dt, i64 1
  %i.dz = tail call noundef float @llvm.ceil.f32(float %i.dy) ; 2 uses
  %i.ea = fcmp ult float %i.dz, f0x5F800000
  %i.eb = fptoui float %i.dz to i64
  %i.ec = tail call i64 @llvm.umax.i64(i64 %i.dx, i64 %i.eb)
  %i.ed = tail call i64 @llvm.umax.i64(i64 %i.ec, i64 1)
  %i.ee = and i1 %i.ea, %i.dw
  %i.ef = select i1 %i.ee, i64 %i.ed, i64 -1
  %i.eg = tail call noundef i64 @_ZN5boost9unordered6detail15prime_fmod_sizeIvE10size_indexEm(i64 noundef %i.ef)
  %i.eh = getelementptr inbounds nuw [8 x i8], ptr @_ZN5boost9unordered6detail15prime_fmod_sizeIvE5sizesE, i64 %i.eg
  %i.ei = load i64, ptr %i.eh, align 8, !tbaa !75 ; 2 uses
  %i.ej = load i64, ptr %i.cp, align 8, !tbaa !24
  %.not.i.i = icmp eq i64 %i.ei, %i.ej
...
bb.h:                                             ; preds = %_ZN5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE16bucket_count_forEm.exit.i.i
  invoke void @_ZN5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE11rehash_implEm(ptr noundef nonnull align 8 dereferenceable(64) %1, i64 noundef %i.ei)
...
_ZN5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE7reserveEm.exit: ; preds = %_ZN5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE16bucket_count_forEm.exit.i.i, %bb.h
  %i.ek = load i64, ptr %i.ca, align 8, !tbaa !73 ; 4 uses
  %i.el = icmp ult i64 %i.ek, 29
  br i1 %i.el, label %bb.i, label %bb.j, !prof !74
...
bb.i:                                             ; preds = %_ZN5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE7reserveEm.exit
  %i.em = lshr i64 %i.bz, 32
  %i.en = add i64 %i.em, %i.bz
  %i.eo = getelementptr inbounds nuw [8 x i8], ptr @_ZN5boost9unordered6detail15prime_fmod_sizeIvE11inv_sizes32E, i64 %i.ek
  %i.ep = load i64, ptr %i.eo, align 8, !tbaa !75
  %i.eq = getelementptr inbounds nuw [8 x i8], ptr @_ZN5boost9unordered6detail15prime_fmod_sizeIvE5sizesE, i64 %i.ek
...
bb.j:                                             ; preds = %_ZN5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE7reserveEm.exit
  %i.eu = getelementptr [8 x i8], ptr @_ZN5boost9unordered6detail15prime_fmod_sizeIvE9positionsE, i64 %i.ek
  %i.ev = getelementptr i8, ptr %i.eu, i64 -232
  %i.ew = load ptr, ptr %i.ev, align 8, !tbaa !76
  %i.ex = invoke noundef i64 %i.ew(i64 noundef %i.bz)
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %i.fa = load ptr, ptr %i.ct, align 8
  %i.fb = lshr i64 %.0.i.i24, 6
  %i.fc = getelementptr inbounds nuw [32 x i8], ptr %i.fa, i64 %i.fb
  %.sroa.3.0.i29 = select i1 %.not.i28, ptr null, ptr %i.fc
  %.sroa.0.0.idx.i30 = select i1 %.not.i28, i64 0, i64 %.0.i.i24
  %.sroa.0.0.i31 = getelementptr inbounds [8 x i8], ptr %i.ez, i64 %.sroa.0.0.idx.i30
  br label %bb.n
...
bb.n:                                             ; preds = %bb.k, %_ZNK5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE14find_node_implIS5_EEPNS1_4nodeIS5_PvEERKT_NS1_23grouped_bucket_iteratorINS1_6bucketISG_SF_EEEE.exit.thread
  ...
  %i.ff = load ptr, ptr %.sroa.012.0, align 8, !tbaa !32 ; 2 uses
  %.not.i.i34 = icmp eq ptr %i.ff, null
...
bb.o:                                             ; preds = %bb.n
  %i.fg = load ptr, ptr %i.cr, align 8, !tbaa !25 ; 2 uses
  %i.fh = ptrtoint ptr %.sroa.012.0 to i64
  %i.fi = ptrtoint ptr %i.fg to i64
  %i.fj = sub i64 %i.fh, %i.fi
  %i.fk = ashr exact i64 %i.fj, 3                 ; 2 uses
  %i.fl = getelementptr inbounds nuw i8, ptr %.sroa.9.0, i64 8 ; 2 uses
  %i.fm = load i64, ptr %i.fl, align 8, !tbaa !28 ; 2 uses
  %.not17.i.i = icmp eq i64 %i.fm, 0
  br i1 %.not17.i.i, label %bb.p, label %bb.q

bb.p:                                             ; preds = %bb.o
  %i.fn = load i64, ptr %i.cp, align 8, !tbaa !24
  %i.fo = lshr i64 %i.fn, 6
  %i.fp = load ptr, ptr %i.ct, align 8, !tbaa !36
  %i.fq = getelementptr [32 x i8], ptr %i.fp, i64 %i.fo ; 2 uses
  %i.fr = and i64 %i.fk, -64
  %i.fs = getelementptr inbounds [8 x i8], ptr %i.fg, i64 %i.fr
  store ptr %i.fs, ptr %.sroa.9.0, align 8, !tbaa !27
  %i.ft = getelementptr i8, ptr %i.fq, i64 16     ; 2 uses
  %i.fu = load ptr, ptr %i.ft, align 8, !tbaa !29 ; 2 uses
  %i.fv = getelementptr inbounds nuw i8, ptr %.sroa.9.0, i64 16
  store ptr %i.fu, ptr %i.fv, align 8, !tbaa !29
  %i.fw = getelementptr inbounds nuw i8, ptr %i.fu, i64 24
  store ptr %.sroa.9.0, ptr %i.fw, align 8, !tbaa !70
  %i.fx = getelementptr inbounds nuw i8, ptr %.sroa.9.0, i64 24
  store ptr %i.fq, ptr %i.fx, align 8, !tbaa !70
  store ptr %.sroa.9.0, ptr %i.ft, align 8, !tbaa !29
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  %i.fy = and i64 %i.fk, 63
  %i.fz = shl nuw i64 1, %i.fy
  %i.ga = or i64 %i.fz, %i.fm
  store i64 %i.ga, ptr %i.fl, align 8, !tbaa !28
...
_ZN5boost9unordered6detail8node_tmpISaINS1_4nodeINS_9typeindex15ctti_type_indexEPvEEEED2Ev.exit: ; preds = %bb.q, %bb.n
  store ptr %i.ff, ptr %i.dc, align 8, !tbaa !67
  store ptr %i.dc, ptr %.sroa.012.0, align 8, !tbaa !32
  %i.gb = load i64, ptr %i.df, align 8, !tbaa !19
  %i.gc = add i64 %i.gb, 1
  store i64 %i.gc, ptr %i.df, align 8, !tbaa !19
...
_ZN5boost9unordered6detail8node_tmpISaINS1_4nodeINS_9typeindex15ctti_type_indexEPvEEEED2Ev.exit38: ; preds = %bb.m, %bb.l
  %.pn = phi { ptr, i32 } [ %i.fe, %bb.m ], [ %i.fd, %bb.l ]
  tail call void @_ZdlPvm(ptr noundef nonnull %i.dc, i64 noundef 16) #20
  resume { ptr, i32 } %.pn
...
_ZNK5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE14find_node_implIS5_EEPNS1_4nodeIS5_PvEERKT_NS1_23grouped_bucket_iteratorINS1_6bucketISG_SF_EEEE.exit: ; preds = %_ZN5boost9typeindex6detail18is_constant_stringEPKc.exit9.i.i.i.i.i, %_ZN5boost9unordered6detail8node_tmpISaINS1_4nodeINS_9typeindex15ctti_type_indexEPvEEEED2Ev.exit
  %.sink75 = phi ptr [ %i.dc, %_ZN5boost9unordered6detail8node_tmpISaINS1_4nodeINS_9typeindex15ctti_type_indexEPvEEEED2Ev.exit ], [ %.0.i, %_ZN5boost9typeindex6detail18is_constant_stringEPKc.exit9.i.i.i.i.i ]
  ...
  store i8 %.sink, ptr %i.gd, align 8, !tbaa !118
  ret void
}
...
bb.g:                                             ; preds = %_ZNK5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE4hashIS5_EEmRKT_.exit.i
  %i.cx = getelementptr [8 x i8], ptr @_ZN5boost9unordered6detail15prime_fmod_sizeIvE9positionsE, i64 %i.cn
  %i.cy = getelementptr i8, ptr %i.cx, i64 -232
  %i.cz = load ptr, ptr %i.cy, align 8, !tbaa !76
  %i.da = invoke noundef i64 %i.cz(i64 noundef %i.cm)
...
_ZNK5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE8positionEm.exit.i: ; preds = %bb.g, %bb.f
  ...
  %i.dd = load ptr, ptr %i.i, align 8             ; 2 uses
  %i.de = lshr i64 %.0.i.i.i, 6
  %i.df = getelementptr inbounds nuw [32 x i8], ptr %i.dd, i64 %i.de ; 4 uses
  %.sroa.3.0.i.i = select i1 %.not.i.i, ptr null, ptr %i.df ; 3 uses
  %.sroa.0.0.idx.i.i = select i1 %.not.i.i, i64 0, i64 %.0.i.i.i ; 3 uses
  %.sroa.0.0.i.i = getelementptr inbounds [8 x i8], ptr %i.dc, i64 %.sroa.0.0.idx.i.i ; 2 uses
  %i.dg = load ptr, ptr %.sroa.0.0.i.i, align 8, !tbaa !32 ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.dg, null
  br i1 %.not.i.i.i, label %bb.h, label %bb.k

bb.h:                                             ; preds = %_ZNK5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE8positionEm.exit.i
  %i.dh = getelementptr inbounds nuw i8, ptr %.sroa.3.0.i.i, i64 8 ; 2 uses
  %i.di = load i64, ptr %i.dh, align 8, !tbaa !28 ; 2 uses
  %.not17.i.i.i = icmp eq i64 %i.di, 0
  br i1 %.not17.i.i.i, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  %i.dj = lshr i64 %i.db, 6
  %i.dk = getelementptr [32 x i8], ptr %i.dd, i64 %i.dj ; 2 uses
  %i.dl = and i64 %.sroa.0.0.idx.i.i, -64
  %i.dm = getelementptr inbounds [8 x i8], ptr %i.dc, i64 %i.dl
  store ptr %i.dm, ptr %i.df, align 8, !tbaa !27
  %i.dn = getelementptr i8, ptr %i.dk, i64 16     ; 2 uses
  %i.do = load ptr, ptr %i.dn, align 8, !tbaa !29 ; 2 uses
  %i.dp = getelementptr inbounds nuw i8, ptr %i.df, i64 16
  store ptr %i.do, ptr %i.dp, align 8, !tbaa !29
  %i.dq = getelementptr inbounds nuw i8, ptr %i.do, i64 24
  store ptr %.sroa.3.0.i.i, ptr %i.dq, align 8, !tbaa !70
  %i.dr = getelementptr inbounds nuw i8, ptr %i.df, i64 24
  store ptr %i.dk, ptr %i.dr, align 8, !tbaa !70
  store ptr %.sroa.3.0.i.i, ptr %i.dn, align 8, !tbaa !29
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h
  %i.ds = and i64 %.sroa.0.0.idx.i.i, 63
  %i.dt = shl nuw i64 1, %i.ds
  %i.du = or i64 %i.di, %i.dt
  store i64 %i.du, ptr %i.dh, align 8, !tbaa !28
  br label %bb.k
...
bb.k:                                             ; preds = %bb.j, %_ZNK5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE8positionEm.exit.i
  store ptr %i.dg, ptr %.02347, align 8, !tbaa !67
...
bb.l:                                             ; preds = %bb.g
  ...
  %.026 = extractvalue { ptr, i32 } %i.dv, 0
  %i.dw = call ptr @__cxa_begin_catch(ptr %.026) #19 ; 0 uses
  %i.dx = invoke { ptr, ptr } @_ZNK5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE5beginEv(ptr noundef nonnull align 8 dereferenceable(32) %2)
...
._crit_edge52:                                    ; preds = %._crit_edge52.loopexit, %bb.a
  %i.dy = phi ptr [ %.pre, %._crit_edge52.loopexit ], [ %i.c, %bb.a ] ; 2 uses
  %.not.i.i35 = icmp eq ptr %i.dy, null
  br i1 %.not.i.i35, label %bb.n, label %bb.m

bb.m:                                             ; preds = %._crit_edge52
  %i.dz = load i64, ptr %i.d, align 8, !tbaa !24
  %i.ea = shl i64 %i.dz, 3
  %i.eb = add i64 %i.ea, 8
  call void @_ZdlPvm(ptr noundef nonnull %i.dy, i64 noundef %i.eb) #20
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.eg = and i64 %i.ef, 9223372036854775776
  %i.eh = add nuw i64 %i.eg, 32
  call void @_ZdlPvm(ptr noundef nonnull %i.ed, i64 noundef %i.eh) #20
  store ptr null, ptr %i.ec, align 8, !tbaa !36
...
_ZN5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEEaSEOSD_.exit: ; preds = %bb.n, %bb.o
  ...
  %i.ej = load i64, ptr %i.ei, align 8, !tbaa !24 ; 2 uses
  %i.ek = load <2 x i64>, ptr %2, align 16, !tbaa !75
  store <2 x i64> %i.ek, ptr %i.a, align 8, !tbaa !75
  %i.el = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.em = load <2 x ptr>, ptr %i.el, align 16, !tbaa !76
  store <2 x ptr> %i.em, ptr %i.b, align 8, !tbaa !76
  %i.en = icmp eq i64 %i.ej, 0
  br i1 %i.en, label %_ZN5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEED2Ev.exit, label %bb.p
...
bb.p:                                             ; preds = %_ZN5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEEaSEOSD_.exit
  ...
  %i.ep = load float, ptr %i.eo, align 8, !tbaa !20
  %i.eq = fpext float %i.ep to double
  %i.er = uitofp i64 %i.ej to double
  %i.es = fmul double %i.er, %i.eq                ; 2 uses
  %i.et = fcmp ult double %i.es, f0x43F0000000000000
  %i.eu = fptoui double %i.es to i64
  %spec.select.i.i = select i1 %i.et, i64 %i.eu, i64 -1
...
_ZN5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEED2Ev.exit: ; preds = %_ZN5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEEaSEOSD_.exit, %bb.p
  %i.ev = phi i64 [ 0, %_ZN5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEEaSEOSD_.exit ], [ %spec.select.i.i, %bb.p ]
  %i.ew = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i64 %i.ev, ptr %i.ew, align 8, !tbaa !77
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #19
  ret void

bb.q:                                             ; preds = %bb.l
  %i.ex = extractvalue { ptr, ptr } %i.dx, 0      ; 2 uses
  %i.ey = load ptr, ptr %i.h, align 16, !tbaa !25
  %i.ez = load i64, ptr %i.g, align 8, !tbaa !24
  %i.fa = getelementptr [8 x i8], ptr %i.ey, i64 %i.ez
  %.not4358 = icmp eq ptr %i.ex, %i.fa
  br i1 %.not4358, label %._crit_edge63, label %.lr.ph62

.lr.ph62:                                         ; preds = %bb.q
  %i.fb = extractvalue { ptr, ptr } %i.dx, 1
...
bb.s:                                             ; preds = %.lr.ph62, %_ZN5boost9unordered6detail23grouped_bucket_iteratorINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EEEppEv.exit
  %.sroa.040.060 = phi ptr [ %i.ex, %.lr.ph62 ], [ %storemerge.i.i, %_ZN5boost9unordered6detail23grouped_bucket_iteratorINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EEEppEv.exit ] ; 2 uses
  %.sroa.8.059 = phi ptr [ %i.fb, %.lr.ph62 ], [ %.sroa.8.1, %_ZN5boost9unordered6detail23grouped_bucket_iteratorINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EEEppEv.exit ] ; 4 uses
  %i.fe = load ptr, ptr %.sroa.040.060, align 8, !tbaa !32 ; 2 uses
  %.not3053 = icmp eq ptr %i.fe, null
  br i1 %.not3053, label %._crit_edge57, label %.lr.ph56

._crit_edge57:                                    ; preds = %.lr.ph56, %bb.s
  %i.ff = load ptr, ptr %.sroa.8.059, align 8, !tbaa !27 ; 2 uses
  %i.fg = ptrtoint ptr %.sroa.040.060 to i64
  %i.fh = ptrtoint ptr %i.ff to i64
  %i.fi = sub i64 %i.fg, %i.fh
  %i.fj = ashr exact i64 %i.fi, 3
  %i.fk = getelementptr inbounds nuw i8, ptr %.sroa.8.059, i64 8
  %i.fl = load i64, ptr %i.fk, align 8, !tbaa !28
  %i.fm = sub nsw i64 63, %i.fj
  %i.fn = lshr i64 -1, %i.fm
  %i.fo = xor i64 %i.fn, -1
  %i.fp = and i64 %i.fl, %i.fo
  %i.fq = call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %i.fp, i1 false) ; 2 uses
  %i.fr = icmp samesign ult i64 %i.fq, 64
  br i1 %i.fr, label %bb.t, label %bb.u

bb.t:                                             ; preds = %._crit_edge57
  %i.fs = getelementptr inbounds nuw [8 x i8], ptr %i.ff, i64 %i.fq
  br label %_ZN5boost9unordered6detail23grouped_bucket_iteratorINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EEEppEv.exit

bb.u:                                             ; preds = %._crit_edge57
  %i.ft = getelementptr inbounds nuw i8, ptr %.sroa.8.059, i64 16
  %i.fu = load ptr, ptr %i.ft, align 8, !tbaa !29 ; 3 uses
  %i.fv = getelementptr inbounds nuw i8, ptr %i.fu, i64 8
  %i.fw = load i64, ptr %i.fv, align 8, !tbaa !28
  %i.fx = call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %i.fw, i1 false)
  %i.fy = load ptr, ptr %i.fu, align 8, !tbaa !27
...
_ZN5boost9unordered6detail23grouped_bucket_iteratorINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EEEppEv.exit: ; preds = %bb.t, %bb.u
  %.sroa.8.1 = phi ptr [ %.sroa.8.059, %bb.t ], [ %i.fu, %bb.u ]
  %storemerge.i.i = phi ptr [ %i.fs, %bb.t ], [ %i.fz, %bb.u ] ; 2 uses
  %i.ga = load ptr, ptr %i.h, align 16, !tbaa !25
  %i.gb = load i64, ptr %i.g, align 8, !tbaa !24
  %i.gc = getelementptr [8 x i8], ptr %i.ga, i64 %i.gb
  %.not43 = icmp eq ptr %storemerge.i.i, %i.gc
  br i1 %.not43, label %._crit_edge63, label %bb.s, !llvm.loop !124

.lr.ph56:                                         ; preds = %bb.s, %.lr.ph56
  %.054 = phi ptr [ %i.gd, %.lr.ph56 ], [ %i.fe, %bb.s ] ; 2 uses
  %i.gd = load ptr, ptr %.054, align 8, !tbaa !67 ; 2 uses
  call void @_ZdlPvm(ptr noundef nonnull %.054, i64 noundef 16) #20
  %i.ge = load i64, ptr %i.fc, align 8, !tbaa !19
  %i.gf = add i64 %i.ge, -1
  store i64 %i.gf, ptr %i.fc, align 8, !tbaa !19
  %.not30 = icmp eq ptr %i.gd, null
  br i1 %.not30, label %._crit_edge57, label %.lr.ph56, !llvm.loop !125

bb.v:                                             ; preds = %._crit_edge63
  %i.gg = landingpad { ptr, i32 }
end_hunk_0
begin_hunk_1_@_ZN5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE20unlink_empty_bucketsEv:bb.a
  %niter = phi i64 [ 0, %.lr.ph33.new ], [ %niter.next.1, %bb.p ]
  %i.ap = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %.032
  %i.aq = load ptr, ptr %i.ap, align 8, !tbaa !32
  %.not23 = icmp eq ptr %i.aq, null
  br i1 %.not23, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  %i.ar = shl nuw nsw i64 1, %.032
  %i.as = xor i64 %i.ar, -1
  %i.at = load i64, ptr %i.j, align 8, !tbaa !28
  %i.au = and i64 %i.at, %i.as
  store i64 %i.au, ptr %i.j, align 8, !tbaa !28
  br label %bb.n

bb.n:                                             ; preds = %bb.l, %bb.m
  %i.av = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %.032
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 8
  %i.ax = load ptr, ptr %i.aw, align 8, !tbaa !32
  %.not23.1 = icmp eq ptr %i.ax, null
  br i1 %.not23.1, label %bb.o, label %bb.p

bb.o:                                             ; preds = %bb.n
  %i.ay = shl nuw nsw i64 2, %.032
  %i.az = xor i64 %i.ay, -1
  %i.ba = load i64, ptr %i.j, align 8, !tbaa !28
  %i.bb = and i64 %i.ba, %i.az
  store i64 %i.bb, ptr %i.j, align 8, !tbaa !28
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n
  %i.bc = add nuw nsw i64 %.032, 2                ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %bb.l, !llvm.loop !129
}
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden noundef i64 @_ZN5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE21erase_key_unique_implIS5_EEmRKT_(ptr noundef nonnull align 8 dereferenceable(64) %0, ptr noundef nonnull align 8 dereferenceable(8) %1) local_unnamed_addr #11 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.b = load ptr, ptr %1, align 8, !tbaa !35     ; 5 uses
  %i.c = tail call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.b) #23 ; 6 uses
  %i.d = xor i64 %i.c, -1606050821391897906       ; 3 uses
  %i.e = icmp ugt i64 %i.c, 7
  br i1 %i.e, label %.lr.ph.i.i.i.i.i.i.i.preheader, label %._crit_edge.i.i.i.i.i.i.i
...
.lr.ph.i.i.i.i.i.i.i.preheader:                   ; preds = %bb.a
  ...
  br i1 %min.iters.check, label %.lr.ph.i.i.i.i.i.i.i.preheader59, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.i.i.i.preheader
  %n.vec = and i64 %i.h, 4611686018427387902      ; 5 uses
  %i.i = shl i64 %n.vec, 3
  %i.j = getelementptr i8, ptr %i.b, i64 %i.i     ; 2 uses
  %i.k = shl i64 %n.vec, 3
  %i.l = sub i64 %i.c, %i.k                       ; 2 uses
  %i.m = mul i64 %n.vec, -7046029254386353131     ; 2 uses
  %i.n = add i64 %i.m, -1606050821391897906
  %i.o = insertelement <2 x i64> <i64 poison, i64 0>, i64 %i.d, i64 0
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %vec.phi = phi <2 x i64> [ %i.o, %vector.ph ], [ %i.x, %vector.body ]
  %vec.ind = phi <2 x i64> [ <i64 -1606050821391897906, i64 -8652080075778251037>, %vector.ph ], [ %vec.ind.next, %vector.body ] ; 2 uses
  %i.p = shl i64 %index, 3
  %next.gep = getelementptr i8, ptr %i.b, i64 %i.p
  %wide.load = load <2 x i64>, ptr %next.gep, align 1
  %i.q = add <2 x i64> %vec.ind, splat (i64 -7046029254386353131)
  %i.r = add <2 x i64> %wide.load, %i.q
  %i.s = zext <2 x i64> %i.r to <2 x i128>
  %i.t = mul nuw <2 x i128> %i.s, splat (i128 16088033396387240377) ; 2 uses
  %i.u = lshr <2 x i128> %i.t, splat (i128 64)
  %i.v = xor <2 x i128> %i.u, %i.t
  %i.w = trunc <2 x i128> %i.v to <2 x i64>
  %i.x = xor <2 x i64> %vec.phi, %i.w             ; 2 uses
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %vec.ind.next = add <2 x i64> %vec.ind, splat (i64 4354685564936845354)
...
middle.block:                                     ; preds = %vector.body
  %i.z = tail call i64 @llvm.vector.reduce.xor.v2i64(<2 x i64> %i.x) ; 2 uses
  %ind.escape = add i64 %i.m, 5439978432994455225
  %cmp.n = icmp eq i64 %i.h, %n.vec
  br i1 %cmp.n, label %._crit_edge.i.i.loopexit.i.i.i.i.i, label %.lr.ph.i.i.i.i.i.i.i.preheader59

.lr.ph.i.i.i.i.i.i.i.preheader59:                 ; preds = %.lr.ph.i.i.i.i.i.i.i.preheader, %middle.block
  %.041.i.i.i.i.i.i.i.ph = phi ptr [ %i.b, %.lr.ph.i.i.i.i.i.i.i.preheader ], [ %i.j, %middle.block ]
  %.03440.i.i.i.i.i.i.i.ph = phi i64 [ %i.c, %.lr.ph.i.i.i.i.i.i.i.preheader ], [ %i.l, %middle.block ]
  %.03639.i.i.i.i.i.i.i.ph = phi i64 [ %i.d, %.lr.ph.i.i.i.i.i.i.i.preheader ], [ %i.z, %middle.block ]
  %.03738.i.i.i.i.i.i.i.ph = phi i64 [ -1606050821391897906, %.lr.ph.i.i.i.i.i.i.i.preheader ], [ %i.n, %middle.block ]
  br label %.lr.ph.i.i.i.i.i.i.i

.lr.ph.i.i.i.i.i.i.i:                             ; preds = %.lr.ph.i.i.i.i.i.i.i.preheader59, %.lr.ph.i.i.i.i.i.i.i
  %.041.i.i.i.i.i.i.i = phi ptr [ %i.aj, %.lr.ph.i.i.i.i.i.i.i ], [ %.041.i.i.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.i.i.preheader59 ] ; 2 uses
...
bb.f:                                             ; preds = %_ZNK5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE4hashIS5_EEmRKT_.exit
  ...
  %i.cm = getelementptr i8, ptr %i.cl, i64 -232
  %i.cn = load ptr, ptr %i.cm, align 8, !tbaa !76
  %i.co = tail call noundef i64 %i.cn(i64 noundef %i.ca), !inline_history !1
  br label %_ZNK5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE8positionEm.exit
...
_ZNK5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE8positionEm.exit: ; preds = %bb.e, %bb.f
  ...
  %i.cu = load ptr, ptr %i.ct, align 8
  %i.cv = lshr i64 %.0.i.i, 6
  %i.cw = getelementptr inbounds nuw [32 x i8], ptr %i.cu, i64 %i.cv ; 3 uses
  %.sroa.3.0.i = select i1 %.not.i, ptr null, ptr %i.cw ; 2 uses
  %.sroa.0.0.idx.i = select i1 %.not.i, i64 0, i64 %.0.i.i
  %.sroa.0.0.i = getelementptr inbounds [8 x i8], ptr %i.cs, i64 %.sroa.0.0.idx.i ; 4 uses
  %i.cx = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  %i.cy = load i64, ptr %i.cx, align 8, !tbaa !19
  %.not.i11 = icmp eq i64 %i.cy, 0
...
.preheader.i:                                     ; preds = %_ZNK5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE8positionEm.exit
  %i.cz = load ptr, ptr %.sroa.0.0.i, align 8, !tbaa !68 ; 2 uses
  %.not11.not22.i = icmp eq ptr %i.cz, null
...
.lr.ph.i:                                         ; preds = %.preheader.i
  %i.da = load ptr, ptr %1, align 8, !tbaa !35
...
_ZN5boost9typeindex6detail18is_constant_stringEPKc.exit9.i.i.i.i.i: ; preds = %_ZNKSt8equal_toIN5boost9typeindex15ctti_type_indexEEclERKS2_S5_.exit.thread33.i, %.lr.ph.i
  %i.db = phi ptr [ %i.cz, %.lr.ph.i ], [ %i.df, %_ZNKSt8equal_toIN5boost9typeindex15ctti_type_indexEEclERKS2_S5_.exit.thread33.i ] ; 4 uses
  %.0823.i = phi ptr [ %.sroa.0.0.i, %.lr.ph.i ], [ %i.db, %_ZNKSt8equal_toIN5boost9typeindex15ctti_type_indexEEclERKS2_S5_.exit.thread33.i ]
  %i.dc = getelementptr inbounds nuw i8, ptr %i.db, i64 8
  %i.dd = load ptr, ptr %i.dc, align 8, !tbaa !35
  %i.de = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.da, ptr noundef nonnull dereferenceable(1) %i.dd) #19
  %.not.i.i.i14.i = icmp eq i32 %i.de, 0
  %i.df = load ptr, ptr %i.db, align 8, !tbaa !68 ; 3 uses
...
_ZNKSt8equal_toIN5boost9typeindex15ctti_type_indexEEclERKS2_S5_.exit.thread33.i: ; preds = %_ZN5boost9typeindex6detail18is_constant_stringEPKc.exit9.i.i.i.i.i
  %.not11.not.i = icmp eq ptr %i.df, null
...
_ZN5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE9find_prevIS5_EEPPNS1_4nodeIS5_PvEERKT_NS1_23grouped_bucket_iteratorINS1_6bucketISG_SF_EEEE.exit.thread16: ; preds = %_ZN5boost9typeindex6detail18is_constant_stringEPKc.exit9.i.i.i.i.i
  store ptr %i.df, ptr %.0823.i, align 8, !tbaa !68
  %i.dg = load ptr, ptr %.sroa.0.0.i, align 8, !tbaa !32
  %.not.i12 = icmp eq ptr %i.dg, null
...
bb.g:                                             ; preds = %_ZN5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE9find_prevIS5_EEPPNS1_4nodeIS5_PvEERKT_NS1_23grouped_bucket_iteratorINS1_6bucketISG_SF_EEEE.exit.thread16
  %i.dh = load ptr, ptr %i.cw, align 8, !tbaa !27
  ...
  %i.dn = xor i64 %i.dm, -1
  %i.do = getelementptr inbounds nuw i8, ptr %.sroa.3.0.i, i64 8 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  %i.dr = getelementptr inbounds nuw i8, ptr %i.cw, i64 24
  %i.ds = load ptr, ptr %i.dr, align 8, !tbaa !70 ; 2 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %.sroa.3.0.i, i64 16 ; 2 uses
  %i.du = load ptr, ptr %i.dt, align 8, !tbaa !29 ; 2 uses
  ...
  store ptr %i.du, ptr %i.dw, align 8, !tbaa !29
...
_ZN5boost9unordered6detail20grouped_bucket_arrayINS1_6bucketINS1_4nodeINS_9typeindex15ctti_type_indexEPvEES7_EESaIS6_ENS1_15prime_fmod_sizeIvEEE18extract_node_afterENS1_23grouped_bucket_iteratorIS9_EEPPS8_.exit: ; preds = %_ZN5boost9unordered6detail5tableINS1_3setISaINS_9typeindex15ctti_type_indexEES5_NS_4hashIS5_EESt8equal_toIS5_EEEE9find_prevIS5_EEPPNS1_4nodeIS5_PvEERKT_NS1_23grouped_bucket_iteratorINS1_6bucketISG_SF_EEEE.exit.thread16, %bb.g, %bb.h
  tail call void @_ZdlPvm(ptr noundef nonnull %i.db, i64 noundef 16) #20
  %i.dx = load i64, ptr %i.cx, align 8, !tbaa !19
  %i.dy = add i64 %i.dx, -1
  store i64 %i.dy, ptr %i.cx, align 8, !tbaa !19
