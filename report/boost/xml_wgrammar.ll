...
bb.e:                                             ; preds = %.lr.ph, %bb.g
  %.sroa.0.0.copyload48 = phi ptr [ %i.aj, %.lr.ph ], [ %i.bq, %bb.g ] ; 4 uses
  %.sroa.035.047 = phi i64 [ 1, %.lr.ph ], [ %i.br, %bb.g ] ; 3 uses
