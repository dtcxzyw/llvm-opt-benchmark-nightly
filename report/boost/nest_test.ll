...
_ZN5boost9container4nestIivvE5beginEv.exit:       ; preds = %bb.k, %bb.l
  ...
  %.0.i.i12 = phi i64 [ %i.ba, %bb.l ], [ %i.ap, %bb.k ]
  %4 = call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %.0.i.i12, i1 true)
  %5 = shl i64 -2, %4
...
_ZN5boost9container13nest_iteratorIPiLb0ELb1EEppEv.exit10: ; preds = %_ZN5boost9container4nestIivvE5beginEv.exit, %bb.m
  ...
  %.0.i9 = phi i64 [ %i.bo, %bb.m ], [ %i.bc, %_ZN5boost9container4nestIivvE5beginEv.exit ]
  %6 = call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %.0.i9, i1 true)
  %7 = shl i64 -2, %6
...
_ZN5boost9container13nest_iteratorIPiLb0ELb1EEppEv.exit6: ; preds = %_ZN5boost9container13nest_iteratorIPiLb0ELb1EEppEv.exit8, %bb.o
  ...
  %.0.i5 = phi i64 [ %i.ct, %bb.o ], [ %i.ch, %_ZN5boost9container13nest_iteratorIPiLb0ELb1EEppEv.exit8 ]
  %8 = call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %.0.i5, i1 true)
  %9 = shl i64 -2, %8
...
_ZN5boost9container13nest_iteratorIPiLb0ELb1EEppEv.exit4: ; preds = %_ZN5boost9container13nest_iteratorIPiLb0ELb1EEppEv.exit6, %bb.p
  ...
  %.0.i3 = phi i64 [ %i.dh, %bb.p ], [ %i.cv, %_ZN5boost9container13nest_iteratorIPiLb0ELb1EEppEv.exit6 ]
  %10 = call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %.0.i3, i1 true)
  %11 = shl i64 -2, %10
