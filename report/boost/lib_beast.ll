...
_ZNK5boost5beast4http6detail17iequals_predicateclENS_4core17basic_string_viewIcEE.exit: ; preds = %.preheader.i17.i, %_ZN5boost5beast7iequalsENS_4core17basic_string_viewIcEES3_.exit.i
  ...
  %i.db = getelementptr inbounds nuw i8, ptr %0, i64 4112 ; 5 uses
...
bb.r:                                             ; preds = %_ZNK5boost5beast4http6detail17iequals_predicateclENS_4core17basic_string_viewIcEE.exit
  ...
  %i.dj = load i64, ptr %i.db, align 8, !tbaa !185 ; 2 uses
  ...
  %or.cond.i.i.i = or i1 %.not.i.i.i74, %i.dk
...
_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i: ; preds = %bb.s, %bb.r
  %.pre.i = phi i64 [ %.pre.pre.i, %bb.s ], [ %i.dj, %bb.r ]
...
_ZN5boost5beast6detail16temporary_buffer6appendENS_4core17basic_string_viewIcEE.exit: ; preds = %_ZNK5boost5beast4http6detail17iequals_predicateclENS_4core17basic_string_viewIcEE.exit, %_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i
  %i.dl = phi i64 [ %i.dc, %_ZNK5boost5beast4http6detail17iequals_predicateclENS_4core17basic_string_viewIcEE.exit ], [ %.pre.i, %_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i ]
  %i.dm = getelementptr inbounds nuw i8, ptr %0, i64 4096
  %i.dn = load ptr, ptr %i.dm, align 8, !tbaa !186
  %i.do = getelementptr inbounds nuw i8, ptr %i.dn, i64 %i.dl
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.do, ptr readonly align 1 %.sroa.0192.0, i64 %.sroa.13.0, i1 false)
  %i.dp = load i64, ptr %i.db, align 8, !tbaa !185
  %i.dq = add i64 %i.dp, %.sroa.13.0
  store i64 %i.dq, ptr %i.db, align 8, !tbaa !185
...
bb.t:                                             ; preds = %_ZN5boost5beast4http10token_list14const_iteratorppEv.exit.i
  %i.dr = getelementptr inbounds nuw i8, ptr %0, i64 4104 ; 6 uses
  %i.ds = load i64, ptr %i.dr, align 8, !tbaa !183
  %i.dt = getelementptr inbounds nuw i8, ptr %0, i64 4112 ; 15 uses
  %i.du = load i64, ptr %i.dt, align 8, !tbaa !185 ; 3 uses
  %i.dv = sub i64 %i.ds, %i.du
  %.not.i.i75 = icmp ult i64 %i.dv, %.sroa.13.0
  br i1 %.not.i.i75, label %bb.u, label %_ZN5boost5beast6detail16temporary_buffer6appendENS_4core17basic_string_viewIcEE.exit81

bb.u:                                             ; preds = %bb.t
  %i.dw = add i64 %i.du, %.sroa.13.0
  %i.dx = shl i64 %i.dw, 1                        ; 2 uses
  %i.dy = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %i.dx) #52 ; 2 uses
  %i.dz = getelementptr inbounds nuw i8, ptr %0, i64 4096 ; 2 uses
  %i.ea = load ptr, ptr %i.dz, align 8, !tbaa !186 ; 4 uses
  %i.eb = load i64, ptr %i.dt, align 8, !tbaa !185 ; 2 uses
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.dy, ptr align 1 %i.ea, i64 %i.eb, i1 false)
  store ptr %i.dy, ptr %i.dz, align 8, !tbaa !187
  %.not.i.i.i76 = icmp eq ptr %i.ea, %0
  %i.ec = icmp eq ptr %i.ea, null
  %or.cond.i.i.i77 = or i1 %.not.i.i.i76, %i.ec
  br i1 %or.cond.i.i.i77, label %_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i79, label %bb.v

bb.v:                                             ; preds = %bb.u
  tail call void @_ZdaPv(ptr noundef nonnull %i.ea) #51
  %.pre.pre.i78 = load i64, ptr %i.dt, align 8, !tbaa !185
...
_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i79: ; preds = %bb.v, %bb.u
  %.pre.i80 = phi i64 [ %.pre.pre.i78, %bb.v ], [ %i.eb, %bb.u ]
  store i64 %i.dx, ptr %i.dr, align 8, !tbaa !183
...
_ZN5boost5beast6detail16temporary_buffer6appendENS_4core17basic_string_viewIcEE.exit81: ; preds = %bb.t, %_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i79
  %i.ed = phi i64 [ %i.du, %bb.t ], [ %.pre.i80, %_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i79 ]
  %i.ee = getelementptr inbounds nuw i8, ptr %0, i64 4096 ; 9 uses
  %i.ef = load ptr, ptr %i.ee, align 8, !tbaa !186
  %i.eg = getelementptr inbounds nuw i8, ptr %i.ef, i64 %i.ed
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.eg, ptr readonly align 1 %.sroa.0192.0, i64 %.sroa.13.0, i1 false)
  br label %bb.w
...
bb.w:                                             ; preds = %_ZN5boost5beast6detail16temporary_buffer6appendENS_4core17basic_string_viewIcEES5_.exit163, %_ZN5boost5beast6detail16temporary_buffer6appendENS_4core17basic_string_viewIcEE.exit81
  ...
  %i.eh = load i64, ptr %i.dt, align 8, !tbaa !185
  %i.ei = add i64 %i.eh, %.sroa.0172.sroa.5.0.sink ; 7 uses
  store i64 %i.ei, ptr %i.dt, align 8, !tbaa !185
  %i.ej = icmp ne ptr %.sroa.5173.0, %.sroa.7.0
  br label %bb.x

bb.x:                                             ; preds = %bb.ac, %bb.w
  %i.ek = phi ptr [ %.sroa.5173.0, %bb.w ], [ %i.fi, %bb.ac ] ; 5 uses
  %.06.i.i.i86 = phi i1 [ %i.ej, %bb.w ], [ false, %bb.ac ]
  %.not8.i.i.i.i87 = icmp eq ptr %i.ek, %i.b
...
.lr.ph.i.i.i.i88.preheader:                       ; preds = %bb.x
  ...
  %scevgep364 = getelementptr i8, ptr %i.ek, i64 %i.ai
  %i.em = sub i64 0, %i.el
  %scevgep365 = getelementptr i8, ptr %scevgep364, i64 %i.em
  br label %.lr.ph.i.i.i.i88

.lr.ph.i.i.i.i88:                                 ; preds = %.lr.ph.i.i.i.i88.preheader, %bb.y
  %i.en = phi ptr [ %i.ep, %bb.y ], [ %i.ek, %.lr.ph.i.i.i.i88.preheader ] ; 3 uses
  %i.eo = load i8, ptr %i.en, align 1, !tbaa !20, !noalias !779
  switch i8 %i.eo, label %_ZN5boost5beast4http6detail8skip_owsIPKcEEvRT_S6_.exit.i.i.i90 [
    i8 32, label %bb.y
    i8 9, label %bb.y
  ]
...
bb.y:                                             ; preds = %.lr.ph.i.i.i.i88, %.lr.ph.i.i.i.i88
  ...
  %.not.i.i.i.i89 = icmp eq ptr %i.ep, %i.b
...
_ZN5boost5beast4http6detail8skip_owsIPKcEEvRT_S6_.exit.i.i.i90: ; preds = %bb.y, %.lr.ph.i.i.i.i88, %bb.x
  %.promoted22.i.i.i91 = phi ptr [ %i.ek, %bb.x ], [ %i.en, %.lr.ph.i.i.i.i88 ], [ %scevgep365, %bb.y ] ; 8 uses
  %i.eq = icmp eq ptr %.promoted22.i.i.i91, %i.b
  br i1 %i.eq, label %_ZN5boost5beast4http10token_list14const_iteratorppEv.exit.i96, label %bb.z

bb.z:                                             ; preds = %_ZN5boost5beast4http6detail8skip_owsIPKcEEvRT_S6_.exit.i.i.i90
  %i.er = load i8, ptr %.promoted22.i.i.i91, align 1, !tbaa !20, !noalias !779 ; 2 uses
  %i.es = zext i8 %i.er to i64
  %i.et = getelementptr inbounds nuw i8, ptr @_ZZN5boost5beast4http6detail13is_token_charEcE3tab, i64 %i.es
  %i.eu = load i8, ptr %i.et, align 1, !tbaa !20, !noalias !779
  %.not.i.i.i92 = icmp eq i8 %i.eu, 0
...
.preheader.i.i.i93.preheader:                     ; preds = %bb.aa
  ...
  %i.ev = sub i64 0, %.promoted22.i.i.i91.lcssa366368
  %scevgep369 = getelementptr i8, ptr %scevgep367, i64 %i.ev ; 2 uses
  %i.ew = getelementptr inbounds nuw i8, ptr %.promoted22.i.i.i91, i64 1 ; 2 uses
  %i.ex = icmp eq ptr %i.ew, %i.b
  br i1 %i.ex, label %.preheader.i.i.i93._crit_edge, label %.lr.ph477

.preheader.i.i.i93:                               ; preds = %.lr.ph477
  %i.ey = getelementptr inbounds nuw i8, ptr %i.fa, i64 1 ; 2 uses
  %i.ez = icmp eq ptr %i.ey, %i.b
  br i1 %i.ez, label %.preheader.i.i.i93._crit_edge, label %.lr.ph477, !llvm.loop !570

.lr.ph477:                                        ; preds = %.preheader.i.i.i93.preheader, %.preheader.i.i.i93
  %i.fa = phi ptr [ %i.ey, %.preheader.i.i.i93 ], [ %i.ew, %.preheader.i.i.i93.preheader ] ; 4 uses
  %i.fb = load i8, ptr %i.fa, align 1, !tbaa !20, !noalias !779
  %i.fc = zext i8 %i.fb to i64
  %i.fd = getelementptr inbounds nuw i8, ptr @_ZZN5boost5beast4http6detail13is_token_charEcE3tab, i64 %i.fc
  %i.fe = load i8, ptr %i.fd, align 1, !tbaa !20, !noalias !779
  %.not10.i.i.i94 = icmp eq i8 %i.fe, 0
...
.preheader.i.i.i93._crit_edge:                    ; preds = %.preheader.i.i.i93, %._crit_edge478, %.preheader.i.i.i93.preheader
  %.lcssa338 = phi ptr [ %i.fa, %._crit_edge478 ], [ %scevgep369, %.preheader.i.i.i93.preheader ], [ %scevgep369, %.preheader.i.i.i93 ]
  %.lcssa.i.i.i95 = phi ptr [ %i.fa, %._crit_edge478 ], [ %i.b, %.preheader.i.i.i93.preheader ], [ %i.b, %.preheader.i.i.i93 ]
  %i.ff = ptrtoint ptr %.lcssa.i.i.i95 to i64
  %i.fg = ptrtoint ptr %.promoted22.i.i.i91 to i64
  %i.fh = sub i64 %i.ff, %i.fg
  br label %_ZN5boost5beast4http10token_list14const_iteratorppEv.exit.i96

bb.ab:                                            ; preds = %bb.z
  %.not9.i.i.i98 = icmp eq i8 %i.er, 44
  br i1 %.not9.i.i.i98, label %bb.ac, label %_ZN5boost5beast4http10token_list14const_iteratorppEv.exit.i96

bb.ac:                                            ; preds = %bb.ab
  %i.fi = getelementptr inbounds nuw i8, ptr %.promoted22.i.i.i91, i64 1
...
_ZN5boost5beast4http10token_list14const_iteratorppEv.exit.i96: ; preds = %_ZN5boost5beast4http6detail8skip_owsIPKcEEvRT_S6_.exit.i.i.i90, %bb.ab, %.preheader.i.i.i93._crit_edge, %bb.aa
  %.sroa.6243.0 = phi i64 [ %i.fh, %.preheader.i.i.i93._crit_edge ], [ 0, %bb.aa ], [ 0, %bb.ab ], [ 0, %_ZN5boost5beast4http6detail8skip_owsIPKcEEvRT_S6_.exit.i.i.i90 ]
  ...
  %i.fj = icmp eq ptr %i.b, %.sroa.9244.0
  %i.fk = icmp eq ptr %i.b, %.sroa.18.0
  %or.cond251 = and i1 %i.fk, %i.fj
...
.preheader21.i.i138:                              ; preds = %bb.ad
  %i.fl = getelementptr inbounds nuw i8, ptr %.0.i.i141486, i64 1
  %i.fm = getelementptr inbounds nuw i8, ptr %.08.i.i140485, i64 1
  %.not14.i.i142 = icmp eq i64 %i.fn, 0
...
bb.ad:                                            ; preds = %.lr.ph487, %.preheader21.i.i138
  %.0.i.i141486 = phi ptr [ %.sroa.03.0.copyload.i137, %.lr.ph487 ], [ %i.fl, %.preheader21.i.i138 ] ; 3 uses
  %.08.i.i140485 = phi ptr [ %.sroa.0172.sroa.0.0, %.lr.ph487 ], [ %i.fm, %.preheader21.i.i138 ] ; 3 uses
  %.010.i.i139484 = phi i64 [ %.sroa.0172.sroa.5.0, %.lr.ph487 ], [ %i.fn, %.preheader21.i.i138 ]
  %i.fn = add i64 %.010.i.i139484, -1             ; 3 uses
  %i.fo = load i8, ptr %.08.i.i140485, align 1, !tbaa !20
  %i.fp = load i8, ptr %.0.i.i141486, align 1, !tbaa !20
  %.not15.i.i143 = icmp eq i8 %i.fo, %i.fp
  br i1 %.not15.i.i143, label %.preheader21.i.i138, label %.preheader.i.i144, !llvm.loop !255

.preheader.i.i144:                                ; preds = %bb.ad, %bb.ae
  %.111.i.i145 = phi i64 [ %i.ge, %bb.ae ], [ %i.fn, %bb.ad ] ; 2 uses
  %.19.i.i146 = phi ptr [ %i.gd, %bb.ae ], [ %.08.i.i140485, %bb.ad ] ; 2 uses
  %.1.i.i147 = phi ptr [ %i.gc, %bb.ae ], [ %.0.i.i141486, %bb.ad ] ; 2 uses
  %i.fq = load i8, ptr %.19.i.i146, align 1, !tbaa !20 ; 3 uses
  %i.fr = sext i8 %i.fq to i32
  %i.fs = add nsw i32 %i.fr, -65
  %i.ft = icmp ult i32 %i.fs, 26
  %i.fu = add i8 %i.fq, 32
  %i.fv = select i1 %i.ft, i8 %i.fu, i8 %i.fq
  %i.fw = load i8, ptr %.1.i.i147, align 1, !tbaa !20 ; 3 uses
  %i.fx = sext i8 %i.fw to i32
  %i.fy = add nsw i32 %i.fx, -65
  %i.fz = icmp ult i32 %i.fy, 26
  %i.ga = add i8 %i.fw, 32
  %i.gb = select i1 %i.fz, i8 %i.ga, i8 %i.fw
  %.not16.i.i148 = icmp eq i8 %i.fv, %i.gb
...
bb.ae:                                            ; preds = %.preheader.i.i144
  %i.gc = getelementptr inbounds nuw i8, ptr %.1.i.i147, i64 1
  %i.gd = getelementptr inbounds nuw i8, ptr %.19.i.i146, i64 1
  %i.ge = add i64 %.111.i.i145, -1
...
.lr.ph492:                                        ; preds = %.preheader21.i11.preheader.i122
  ...
  %.sroa.0.0.copyload.i123 = load ptr, ptr %i.gf, align 8, !tbaa !187
  br label %bb.af

.preheader21.i11.i124:                            ; preds = %bb.af
  %i.gg = getelementptr inbounds nuw i8, ptr %.0.i14.i127491, i64 1
  %i.gh = getelementptr inbounds nuw i8, ptr %.08.i13.i126490, i64 1
  %.not14.i15.i128 = icmp eq i64 %i.gi, 0
...
bb.af:                                            ; preds = %.lr.ph492, %.preheader21.i11.i124
  %.0.i14.i127491 = phi ptr [ %.sroa.0.0.copyload.i123, %.lr.ph492 ], [ %i.gg, %.preheader21.i11.i124 ] ; 3 uses
  %.08.i13.i126490 = phi ptr [ %.sroa.0172.sroa.0.0, %.lr.ph492 ], [ %i.gh, %.preheader21.i11.i124 ] ; 3 uses
  %.010.i12.i125489 = phi i64 [ %.sroa.0172.sroa.5.0, %.lr.ph492 ], [ %i.gi, %.preheader21.i11.i124 ]
  %i.gi = add i64 %.010.i12.i125489, -1           ; 3 uses
  %i.gj = load i8, ptr %.08.i13.i126490, align 1, !tbaa !20
  %i.gk = load i8, ptr %.0.i14.i127491, align 1, !tbaa !20
  %.not15.i16.i129 = icmp eq i8 %i.gj, %i.gk
...
.preheader.i17.i130:                              ; preds = %bb.af, %bb.ag
  %.111.i18.i131 = phi i64 [ %i.gz, %bb.ag ], [ %i.gi, %bb.af ] ; 2 uses
  %.19.i19.i132 = phi ptr [ %i.gy, %bb.ag ], [ %.08.i13.i126490, %bb.af ] ; 2 uses
  %.1.i20.i133 = phi ptr [ %i.gx, %bb.ag ], [ %.0.i14.i127491, %bb.af ] ; 2 uses
  %i.gl = load i8, ptr %.19.i19.i132, align 1, !tbaa !20 ; 3 uses
  %i.gm = sext i8 %i.gl to i32
  %i.gn = add nsw i32 %i.gm, -65
  %i.go = icmp ult i32 %i.gn, 26
  %i.gp = add i8 %i.gl, 32
  %i.gq = select i1 %i.go, i8 %i.gp, i8 %i.gl
  %i.gr = load i8, ptr %.1.i20.i133, align 1, !tbaa !20 ; 3 uses
  %i.gs = sext i8 %i.gr to i32
  %i.gt = add nsw i32 %i.gs, -65
  %i.gu = icmp ult i32 %i.gt, 26
  %i.gv = add i8 %i.gr, 32
  %i.gw = select i1 %i.gu, i8 %i.gv, i8 %i.gr
  %.not16.i21.i134 = icmp eq i8 %i.gq, %i.gw
...
bb.ag:                                            ; preds = %.preheader.i17.i130
  %i.gx = getelementptr inbounds nuw i8, ptr %.1.i20.i133, i64 1
  %i.gy = getelementptr inbounds nuw i8, ptr %.19.i19.i132, i64 1
  %i.gz = add i64 %.111.i18.i131, -1
...
_ZNK5boost5beast4http6detail17iequals_predicateclENS_4core17basic_string_viewIcEE.exit150: ; preds = %.preheader.i17.i130, %_ZN5boost5beast7iequalsENS_4core17basic_string_viewIcEES3_.exit.i118
  %i.ha = add i64 %.sroa.0172.sroa.5.0, 2         ; 2 uses
  %i.hb = load i64, ptr %i.dr, align 8, !tbaa !183
  %i.hc = sub i64 %i.hb, %i.ei
  %.not.i.i151 = icmp ult i64 %i.hc, %i.ha
...
bb.ah:                                            ; preds = %_ZNK5boost5beast4http6detail17iequals_predicateclENS_4core17basic_string_viewIcEE.exit150
  %i.hd = add i64 %i.ei, %i.ha
  %i.he = shl i64 %i.hd, 1                        ; 2 uses
  %i.hf = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %i.he) #52 ; 2 uses
  %i.hg = load ptr, ptr %i.ee, align 8, !tbaa !186 ; 4 uses
  %i.hh = load i64, ptr %i.dt, align 8, !tbaa !185 ; 2 uses
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.hf, ptr align 1 %i.hg, i64 %i.hh, i1 false)
  store ptr %i.hf, ptr %i.ee, align 8, !tbaa !187
  %.not.i.i.i152 = icmp eq ptr %i.hg, %0
  %i.hi = icmp eq ptr %i.hg, null
  %or.cond.i.i.i153 = or i1 %.not.i.i.i152, %i.hi
  br i1 %or.cond.i.i.i153, label %_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i155, label %bb.ai

bb.ai:                                            ; preds = %bb.ah
  tail call void @_ZdaPv(ptr noundef nonnull %i.hg) #51
  %.pre.pre.i154 = load i64, ptr %i.dt, align 8, !tbaa !185
...
_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i155: ; preds = %bb.ai, %bb.ah
  %.pre.i156 = phi i64 [ %.pre.pre.i154, %bb.ai ], [ %i.hh, %bb.ah ]
  store i64 %i.he, ptr %i.dr, align 8, !tbaa !183
...
_ZN5boost5beast6detail16temporary_buffer6appendENS_4core17basic_string_viewIcEES5_.exit: ; preds = %_ZNK5boost5beast4http6detail17iequals_predicateclENS_4core17basic_string_viewIcEE.exit150, %_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i155
  %i.hj = phi i64 [ %i.ei, %_ZNK5boost5beast4http6detail17iequals_predicateclENS_4core17basic_string_viewIcEE.exit150 ], [ %.pre.i156, %_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i155 ]
  %i.hk = load ptr, ptr %i.ee, align 8, !tbaa !186
  %i.hl = getelementptr inbounds nuw i8, ptr %i.hk, i64 %i.hj
  store i16 8236, ptr %i.hl, align 1
  %i.hm = load i64, ptr %i.dt, align 8, !tbaa !185
  %i.hn = add i64 %i.hm, 2                        ; 2 uses
  store i64 %i.hn, ptr %i.dt, align 8, !tbaa !185
  %i.ho = load ptr, ptr %i.ee, align 8, !tbaa !186
  %i.hp = getelementptr inbounds nuw i8, ptr %i.ho, i64 %i.hn
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.hp, ptr readonly align 1 %.sroa.0172.sroa.0.0, i64 %.sroa.0172.sroa.5.0, i1 false)
  %i.hq = load i64, ptr %i.dt, align 8, !tbaa !185
  %i.hr = add i64 %i.hq, %.sroa.0172.sroa.5.0
  store i64 %i.hr, ptr %i.dt, align 8, !tbaa !185
  br label %_ZNK5boost5beast4http10token_list14const_iteratorneERKS3_.exit

bb.aj:                                            ; preds = %_ZN5boost5beast4http10token_list14const_iteratorppEv.exit.i96
  %i.hs = add i64 %.sroa.0172.sroa.5.0, 2         ; 2 uses
  %i.ht = load i64, ptr %i.dr, align 8, !tbaa !183
  %i.hu = sub i64 %i.ht, %i.ei
  %.not.i.i157 = icmp ult i64 %i.hu, %i.hs
...
bb.ak:                                            ; preds = %bb.aj
  %i.hv = add i64 %i.ei, %i.hs
  %i.hw = shl i64 %i.hv, 1                        ; 2 uses
  %i.hx = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %i.hw) #52 ; 2 uses
  %i.hy = load ptr, ptr %i.ee, align 8, !tbaa !186 ; 4 uses
  %i.hz = load i64, ptr %i.dt, align 8, !tbaa !185 ; 2 uses
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.hx, ptr align 1 %i.hy, i64 %i.hz, i1 false)
  store ptr %i.hx, ptr %i.ee, align 8, !tbaa !187
  %.not.i.i.i158 = icmp eq ptr %i.hy, %0
  %i.ia = icmp eq ptr %i.hy, null
  %or.cond.i.i.i159 = or i1 %.not.i.i.i158, %i.ia
  br i1 %or.cond.i.i.i159, label %_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i161, label %bb.al

bb.al:                                            ; preds = %bb.ak
  tail call void @_ZdaPv(ptr noundef nonnull %i.hy) #51
  %.pre.pre.i160 = load i64, ptr %i.dt, align 8, !tbaa !185
...
_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i161: ; preds = %bb.al, %bb.ak
  %.pre.i162 = phi i64 [ %.pre.pre.i160, %bb.al ], [ %i.hz, %bb.ak ]
  store i64 %i.hw, ptr %i.dr, align 8, !tbaa !183
...
_ZN5boost5beast6detail16temporary_buffer6appendENS_4core17basic_string_viewIcEES5_.exit163: ; preds = %bb.aj, %_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i161
  %i.ib = phi i64 [ %i.ei, %bb.aj ], [ %.pre.i162, %_ZN5boost5beast6detail16temporary_buffer10deallocateEPc.exit.i.i161 ]
  %i.ic = load ptr, ptr %i.ee, align 8, !tbaa !186
  %i.id = getelementptr inbounds nuw i8, ptr %i.ic, i64 %i.ib
  store i16 8236, ptr %i.id, align 1
  %i.ie = load i64, ptr %i.dt, align 8, !tbaa !185
end_hunk_2
