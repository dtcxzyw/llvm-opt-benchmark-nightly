...
begin_hunk_0_@boost_cont_multialloc_nodes:bb.a
  %i.aj = add i64 %.19010.i, -1                   ; 2 uses
  %i.ak = load ptr, ptr %.sroa.0.111.i, align 8, !tbaa !98
  %i.al = getelementptr inbounds i8, ptr %.sroa.0.111.i, i64 -8
...
bb.j:                                             ; preds = %.critedge
  ...
  %i.ag = sub i64 %i.af, %.140.lcssa.ph
  %.0 = add i64 %i.ag, %i.ae
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %spin_acquire_lock.exit
  %.1 = phi i64 [ %.0, %bb.j ], [ 0, %spin_acquire_lock.exit ]
