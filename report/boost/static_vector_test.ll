...
bb.by:                                            ; preds = %bb.bs
  ...
  %.15 = extractvalue { ptr, i32 } %i.mo, 0
  %.1579 = extractvalue { ptr, i32 } %i.mo, 1
  %i.mp = icmp eq i32 %.1579, %i.ly
  %i.mq = tail call ptr @__cxa_begin_catch(ptr %.15) #25 ; 0 uses
...
bb.d:                                             ; preds = %bb.b
  ...
  %.044 = extractvalue { ptr, i32 } %i.d, 0
  %.047 = extractvalue { ptr, i32 } %i.d, 1
  %i.e = tail call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTIN5boost9container9bad_allocE) #25
  %i.f = icmp eq i32 %.047, %i.e
  %i.g = tail call ptr @__cxa_begin_catch(ptr %.044) #25 ; 0 uses
...
bb.c:                                             ; preds = %bb.f, %bb.b
  %.060.i = phi ptr [ %i.u, %bb.f ], [ %0, %bb.b ] ; 3 uses
  %.056.i = phi i64 [ %i.v, %bb.f ], [ %i.i, %bb.b ]
  %.0.i = phi ptr [ %i.t, %bb.f ], [ %1, %bb.b ]  ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, ptr noundef nonnull align 1 dereferenceable(2048) %.0.i, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.0.i, ptr noundef nonnull align 1 dereferenceable(2048) %.060.i, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.060.i, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, i64 2048, i1 false)
  %i.n = getelementptr inbounds nuw i8, ptr %.0.i, i64 2048
  %i.o = getelementptr inbounds nuw i8, ptr %.060.i, i64 2048
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %.161.i = phi ptr [ %i.o, %bb.c ], [ %0, %bb.b ] ; 3 uses
  %.157.i = phi i64 [ %.056.i, %bb.c ], [ %i.i, %bb.b ]
  %.1.i = phi ptr [ %i.n, %bb.c ], [ %1, %bb.b ]  ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, ptr noundef nonnull align 1 dereferenceable(2048) %.1.i, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.1.i, ptr noundef nonnull align 1 dereferenceable(2048) %.161.i, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.161.i, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, i64 2048, i1 false)
  %i.p = getelementptr inbounds nuw i8, ptr %.1.i, i64 2048
  %i.q = getelementptr inbounds nuw i8, ptr %.161.i, i64 2048
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.b
  %.262.i = phi ptr [ %i.q, %bb.d ], [ %0, %bb.b ] ; 3 uses
  %.258.i = phi i64 [ %.157.i, %bb.d ], [ %i.i, %bb.b ]
  %.2.i = phi ptr [ %i.p, %bb.d ], [ %1, %bb.b ]  ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, ptr noundef nonnull align 1 dereferenceable(2048) %.2.i, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.2.i, ptr noundef nonnull align 1 dereferenceable(2048) %.262.i, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.262.i, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, i64 2048, i1 false)
  %i.r = getelementptr inbounds nuw i8, ptr %.2.i, i64 2048
  %i.s = getelementptr inbounds nuw i8, ptr %.262.i, i64 2048
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.b
  %.363.i = phi ptr [ %0, %bb.b ], [ %i.s, %bb.e ] ; 3 uses
  %.359.i = phi i64 [ %i.i, %bb.b ], [ %.258.i, %bb.e ]
  %.3.i = phi ptr [ %1, %bb.b ], [ %i.r, %bb.e ]  ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, ptr noundef nonnull align 1 dereferenceable(2048) %.3.i, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.3.i, ptr noundef nonnull align 1 dereferenceable(2048) %.363.i, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.363.i, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, i64 2048, i1 false)
  %i.t = getelementptr inbounds nuw i8, ptr %.3.i, i64 2048 ; 2 uses
  %i.u = getelementptr inbounds nuw i8, ptr %.363.i, i64 2048 ; 2 uses
  %i.v = add i64 %.359.i, -1                      ; 2 uses
...
_ZN5boost9container17deep_swap_alloc_nILm40ENS0_3dtl24static_storage_allocatorIiLm10ELm0ELb1EEEPiS5_EENS_11move_detail11enable_if_cIXaasr3dtl30is_memtransfer_copy_assignableIT1_T2_EE5valueLb1EEvE4typeERT0_S8_mS9_m.exit: ; preds = %bb.f, %bb.b
  %.464.i = phi ptr [ %0, %bb.b ], [ %i.u, %bb.f ] ; 2 uses
  %.4.i = phi ptr [ %1, %bb.b ], [ %i.t, %bb.f ]  ; 2 uses
  %i.w = and i64 %i.f, 2044                       ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %.sroa.0.i, ptr nonnull align 1 %.4.i, i64 %i.w, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %.4.i, ptr nonnull align 1 %.464.i, i64 %i.w, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %.464.i, ptr nonnull align 4 %.sroa.0.i, i64 %i.w, i1 false)
...
bb.h:                                             ; preds = %bb.k, %bb.g
  %.060.i18 = phi ptr [ %i.aq, %bb.k ], [ %1, %bb.g ] ; 3 uses
  %.056.i19 = phi i64 [ %i.ar, %bb.k ], [ %i.ae, %bb.g ]
  %.0.i20 = phi ptr [ %i.ap, %bb.k ], [ %0, %bb.g ] ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, ptr noundef nonnull align 1 dereferenceable(2048) %.0.i20, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.0.i20, ptr noundef nonnull align 1 dereferenceable(2048) %.060.i18, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.060.i18, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, i64 2048, i1 false)
  %i.aj = getelementptr inbounds nuw i8, ptr %.0.i20, i64 2048
  %i.ak = getelementptr inbounds nuw i8, ptr %.060.i18, i64 2048
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %.161.i21 = phi ptr [ %i.ak, %bb.h ], [ %1, %bb.g ] ; 3 uses
  %.157.i22 = phi i64 [ %.056.i19, %bb.h ], [ %i.ae, %bb.g ]
  %.1.i23 = phi ptr [ %i.aj, %bb.h ], [ %0, %bb.g ] ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, ptr noundef nonnull align 1 dereferenceable(2048) %.1.i23, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.1.i23, ptr noundef nonnull align 1 dereferenceable(2048) %.161.i21, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.161.i21, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, i64 2048, i1 false)
  %i.al = getelementptr inbounds nuw i8, ptr %.1.i23, i64 2048
  %i.am = getelementptr inbounds nuw i8, ptr %.161.i21, i64 2048
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.g
  %.262.i11 = phi ptr [ %i.am, %bb.i ], [ %1, %bb.g ] ; 3 uses
  %.258.i12 = phi i64 [ %.157.i22, %bb.i ], [ %i.ae, %bb.g ]
  %.2.i13 = phi ptr [ %i.al, %bb.i ], [ %0, %bb.g ] ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, ptr noundef nonnull align 1 dereferenceable(2048) %.2.i13, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.2.i13, ptr noundef nonnull align 1 dereferenceable(2048) %.262.i11, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.262.i11, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, i64 2048, i1 false)
  %i.an = getelementptr inbounds nuw i8, ptr %.2.i13, i64 2048
  %i.ao = getelementptr inbounds nuw i8, ptr %.262.i11, i64 2048
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %bb.g
  %.363.i14 = phi ptr [ %1, %bb.g ], [ %i.ao, %bb.j ] ; 3 uses
  %.359.i15 = phi i64 [ %i.ae, %bb.g ], [ %.258.i12, %bb.j ]
  %.3.i16 = phi ptr [ %0, %bb.g ], [ %i.an, %bb.j ] ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, ptr noundef nonnull align 1 dereferenceable(2048) %.3.i16, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.3.i16, ptr noundef nonnull align 1 dereferenceable(2048) %.363.i14, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.363.i14, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, i64 2048, i1 false)
  %i.ap = getelementptr inbounds nuw i8, ptr %.3.i16, i64 2048 ; 2 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %.363.i14, i64 2048 ; 2 uses
  %i.ar = add i64 %.359.i15, -1                   ; 2 uses
  %.not.i17 = icmp eq i64 %i.ar, 0
  br i1 %.not.i17, label %bb.l, label %bb.h, !llvm.loop !2362

bb.l:                                             ; preds = %bb.k, %bb.g
  %.464.i24 = phi ptr [ %1, %bb.g ], [ %i.aq, %bb.k ] ; 2 uses
  %.4.i25 = phi ptr [ %0, %bb.g ], [ %i.ap, %bb.k ] ; 2 uses
  %i.as = and i64 %i.ab, 2044                     ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %.sroa.0.i10, ptr nonnull align 1 %.4.i25, i64 %i.as, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %.4.i25, ptr nonnull align 1 %.464.i24, i64 %i.as, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %.464.i24, ptr nonnull align 4 %.sroa.0.i10, i64 %i.as, i1 false)
...
bb.c:                                             ; preds = %bb.f, %bb.b
  %.060.i = phi ptr [ %i.w, %bb.f ], [ %0, %bb.b ] ; 3 uses
  %.056.i = phi i64 [ %i.x, %bb.f ], [ %i.k, %bb.b ]
  %.0.i = phi ptr [ %i.v, %bb.f ], [ %1, %bb.b ]  ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, ptr noundef nonnull align 1 dereferenceable(2048) %.0.i, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.0.i, ptr noundef nonnull align 1 dereferenceable(2048) %.060.i, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.060.i, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, i64 2048, i1 false)
  %i.p = getelementptr inbounds nuw i8, ptr %.0.i, i64 2048
  %i.q = getelementptr inbounds nuw i8, ptr %.060.i, i64 2048
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %.161.i = phi ptr [ %i.q, %bb.c ], [ %0, %bb.b ] ; 3 uses
  %.157.i = phi i64 [ %.056.i, %bb.c ], [ %i.k, %bb.b ]
  %.1.i = phi ptr [ %i.p, %bb.c ], [ %1, %bb.b ]  ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, ptr noundef nonnull align 1 dereferenceable(2048) %.1.i, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.1.i, ptr noundef nonnull align 1 dereferenceable(2048) %.161.i, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.161.i, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, i64 2048, i1 false)
  %i.r = getelementptr inbounds nuw i8, ptr %.1.i, i64 2048
  %i.s = getelementptr inbounds nuw i8, ptr %.161.i, i64 2048
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.b
  %.262.i = phi ptr [ %i.s, %bb.d ], [ %0, %bb.b ] ; 3 uses
  %.258.i = phi i64 [ %.157.i, %bb.d ], [ %i.k, %bb.b ]
  %.2.i = phi ptr [ %i.r, %bb.d ], [ %1, %bb.b ]  ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, ptr noundef nonnull align 1 dereferenceable(2048) %.2.i, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.2.i, ptr noundef nonnull align 1 dereferenceable(2048) %.262.i, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.262.i, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, i64 2048, i1 false)
  %i.t = getelementptr inbounds nuw i8, ptr %.2.i, i64 2048
  %i.u = getelementptr inbounds nuw i8, ptr %.262.i, i64 2048
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.b
  %.363.i = phi ptr [ %0, %bb.b ], [ %i.u, %bb.e ] ; 3 uses
  %.359.i = phi i64 [ %i.k, %bb.b ], [ %.258.i, %bb.e ]
  %.3.i = phi ptr [ %1, %bb.b ], [ %i.t, %bb.e ]  ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, ptr noundef nonnull align 1 dereferenceable(2048) %.3.i, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.3.i, ptr noundef nonnull align 1 dereferenceable(2048) %.363.i, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.363.i, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i, i64 2048, i1 false)
  %i.v = getelementptr inbounds nuw i8, ptr %.3.i, i64 2048 ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %.363.i, i64 2048 ; 2 uses
  %i.x = add i64 %.359.i, -1                      ; 2 uses
...
.lr.ph.i.preheader.i:                             ; preds = %bb.f, %bb.b
  %.464.i = phi ptr [ %0, %bb.b ], [ %i.w, %bb.f ] ; 2 uses
  %.4.i = phi ptr [ %1, %bb.b ], [ %i.v, %bb.f ]  ; 2 uses
  %i.y = and i64 %i.h, 2044                       ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %.sroa.0.i, ptr nonnull align 1 %.4.i, i64 %i.y, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %.4.i, ptr nonnull align 1 %.464.i, i64 %i.y, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %.464.i, ptr nonnull align 4 %.sroa.0.i, i64 %i.y, i1 false)
...
bb.h:                                             ; preds = %bb.k, %bb.g
  %.060.i18 = phi ptr [ %i.cf, %bb.k ], [ %1, %bb.g ] ; 3 uses
  %.056.i19 = phi i64 [ %i.cg, %bb.k ], [ %i.bt, %bb.g ]
  %.0.i20 = phi ptr [ %i.ce, %bb.k ], [ %0, %bb.g ] ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, ptr noundef nonnull align 1 dereferenceable(2048) %.0.i20, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.0.i20, ptr noundef nonnull align 1 dereferenceable(2048) %.060.i18, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.060.i18, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, i64 2048, i1 false)
  %i.by = getelementptr inbounds nuw i8, ptr %.0.i20, i64 2048
  %i.bz = getelementptr inbounds nuw i8, ptr %.060.i18, i64 2048
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  %.161.i21 = phi ptr [ %i.bz, %bb.h ], [ %1, %bb.g ] ; 3 uses
  %.157.i22 = phi i64 [ %.056.i19, %bb.h ], [ %i.bt, %bb.g ]
  %.1.i23 = phi ptr [ %i.by, %bb.h ], [ %0, %bb.g ] ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, ptr noundef nonnull align 1 dereferenceable(2048) %.1.i23, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.1.i23, ptr noundef nonnull align 1 dereferenceable(2048) %.161.i21, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.161.i21, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, i64 2048, i1 false)
  %i.ca = getelementptr inbounds nuw i8, ptr %.1.i23, i64 2048
  %i.cb = getelementptr inbounds nuw i8, ptr %.161.i21, i64 2048
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.g
  %.262.i11 = phi ptr [ %i.cb, %bb.i ], [ %1, %bb.g ] ; 3 uses
  %.258.i12 = phi i64 [ %.157.i22, %bb.i ], [ %i.bt, %bb.g ]
  %.2.i13 = phi ptr [ %i.ca, %bb.i ], [ %0, %bb.g ] ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, ptr noundef nonnull align 1 dereferenceable(2048) %.2.i13, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.2.i13, ptr noundef nonnull align 1 dereferenceable(2048) %.262.i11, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.262.i11, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, i64 2048, i1 false)
  %i.cc = getelementptr inbounds nuw i8, ptr %.2.i13, i64 2048
  %i.cd = getelementptr inbounds nuw i8, ptr %.262.i11, i64 2048
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %bb.g
  %.363.i14 = phi ptr [ %1, %bb.g ], [ %i.cd, %bb.j ] ; 3 uses
  %.359.i15 = phi i64 [ %i.bt, %bb.g ], [ %.258.i12, %bb.j ]
  %.3.i16 = phi ptr [ %0, %bb.g ], [ %i.cc, %bb.j ] ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, ptr noundef nonnull align 1 dereferenceable(2048) %.3.i16, i64 2048, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.3.i16, ptr noundef nonnull align 1 dereferenceable(2048) %.363.i14, i64 2048, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(2048) %.363.i14, ptr noundef nonnull align 4 dereferenceable(2048) %.sroa.0.i10, i64 2048, i1 false)
  %i.ce = getelementptr inbounds nuw i8, ptr %.3.i16, i64 2048 ; 2 uses
  %i.cf = getelementptr inbounds nuw i8, ptr %.363.i14, i64 2048 ; 2 uses
  %i.cg = add i64 %.359.i15, -1                   ; 2 uses
  %.not.i17 = icmp eq i64 %i.cg, 0
  br i1 %.not.i17, label %bb.l, label %bb.h, !llvm.loop !2364

bb.l:                                             ; preds = %bb.k, %bb.g
  %.464.i24 = phi ptr [ %1, %bb.g ], [ %i.cf, %bb.k ] ; 2 uses
  %.4.i25 = phi ptr [ %0, %bb.g ], [ %i.ce, %bb.k ] ; 2 uses
  %i.ch = and i64 %i.bq, 2044                     ; 3 uses
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 4 %.sroa.0.i10, ptr nonnull align 1 %.4.i25, i64 %i.ch, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %.4.i25, ptr nonnull align 1 %.464.i24, i64 %i.ch, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %.464.i24, ptr nonnull align 4 %.sroa.0.i10, i64 %i.ch, i1 false)
