...
_ZN5boost9container6vectorI14counting_valueNS0_3dtl24static_storage_allocatorIS2_Lm10ELm0ELb1EEEvED2Ev.exit90: ; preds = %_ZN5boost9container6vectorI14counting_valueNS0_3dtl24static_storage_allocatorIS2_Lm10ELm0ELb1EEEvED2Ev.exit97, %_ZN5boost9container6vectorI14counting_valueNS0_3dtl24static_storage_allocatorIS2_Lm10ELm0ELb1EEEvED2Ev.exit97.thread
  %_ZZN14counting_value1cEvE2co.promoted.i.i96257 = phi i64 [ %i.dw, %_ZN5boost9container6vectorI14counting_valueNS0_3dtl24static_storage_allocatorIS2_Lm10ELm0ELb1EEEvED2Ev.exit97.thread ], [ %i.eq, %_ZN5boost9container6vectorI14counting_valueNS0_3dtl24static_storage_allocatorIS2_Lm10ELm0ELb1EEEvED2Ev.exit97 ]
...
.lr.ph.i.i.i.i.preheader:                         ; preds = %bb.p
  %i.bm = sub nsw i64 4, %indvars.iv202           ; 3 uses
...
bb.v:                                             ; preds = %._crit_edge
  %i.dv = load i64, ptr @_ZZN14counting_value1cEvE2co, align 8, !tbaa !69 ; 3 uses
...
bb.w:                                             ; preds = %._crit_edge
  %i.dy = landingpad { ptr, i32 }
          cleanup
  %i.dz = load i64, ptr @_ZZN14counting_value1cEvE2co, align 8, !tbaa !69
  %i.ea = add i64 %i.dz, -1
  store i64 %i.ea, ptr @_ZZN14counting_value1cEvE2co, align 8, !tbaa !69
  br label %_ZN5boost9container6vectorI14counting_valueNS0_3dtl24static_storage_allocatorIS2_Lm10ELm0ELb1EEEvED2Ev.exit105

.lr.ph178:                                        ; preds = %.lr.ph178.preheader, %bb.x
  %i.eb = phi i64 [ %i.dv, %.lr.ph178.preheader ], [ %i.ep, %bb.x ]
  %indvars.iv195 = phi i64 [ 0, %.lr.ph178.preheader ], [ %indvars.iv.next196, %bb.x ] ; 2 uses
  %i.ec = add nuw nsw i64 %indvars.iv195, %indvars.iv202 ; 3 uses
  %i.ed = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.ec ; 2 uses
  %i.ee = getelementptr inbounds nuw i8, ptr %i.ed, i64 8
  %i.ef = add nuw nsw i64 %i.ec, 100
  store i64 %i.eb, ptr @_ZZN14counting_value1cEvE2co, align 8, !tbaa !69
  %i.eg = load i32, ptr %i.ee, align 8, !tbaa !72
  %i.eh = zext i32 %i.eg to i64
  %i.ei = icmp eq i64 %i.ec, %i.eh
  %i.ej = getelementptr inbounds nuw i8, ptr %i.ed, i64 12
  %i.ek = load i32, ptr %i.ej, align 4
  %i.el = zext i32 %i.ek to i64
  %i.em = icmp eq i64 %i.ef, %i.el
  %i.en = select i1 %i.ei, i1 %i.em, i1 false
  %i.eo = invoke noundef zeroext i1 @_ZN5boost6detail9test_implEPKcS2_iS2_b(ptr noundef nonnull @.str.135, ptr noundef nonnull @.str.1, i32 noundef 618, ptr noundef nonnull @__PRETTY_FUNCTION__._Z15test_emplace_2pI14counting_valueLm10EEvv, i1 noundef zeroext %i.en)
          to label %bb.x unwind label %bb.y       ; 0 uses

bb.x:                                             ; preds = %.lr.ph178
  %i.ep = load i64, ptr @_ZZN14counting_value1cEvE2co, align 8, !tbaa !69 ; 3 uses
  %i.eq = add i64 %i.ep, -1                       ; 2 uses
  store i64 %i.eq, ptr @_ZZN14counting_value1cEvE2co, align 8, !tbaa !69
...
bb.y:                                             ; preds = %.lr.ph178
  %i.er = landingpad { ptr, i32 }
          cleanup
  %i.es = load i64, ptr @_ZZN14counting_value1cEvE2co, align 8, !tbaa !69
  %i.et = add i64 %i.es, -1
...
_ZN5boost9container6vectorI14counting_valueNS0_3dtl24static_storage_allocatorIS2_Lm10ELm0ELb1EEEvED2Ev.exit105: ; preds = %bb.r, %bb.s, %bb.u, %bb.w, %bb.y
  %.pn60 = phi { ptr, i32 } [ %i.ds, %bb.u ], [ %i.er, %bb.y ], [ %i.dy, %bb.w ], [ %i.dd, %bb.s ], [ %i.dc, %bb.r ]
  %_ZZN14counting_value1cEvE2co.promoted.i.i100 = load i64, ptr @_ZZN14counting_value1cEvE2co, align 8
  %i.eu = add i64 %_ZZN14counting_value1cEvE2co.promoted.i.i100, -6
...
_ZN5boost9container6vectorI14counting_valueNS0_3dtl24static_storage_allocatorIS2_Lm10ELm0ELb1EEEvED2Ev.exit75: ; preds = %bb.m, %bb.n, %bb.k, %bb.j, %bb.i, %bb.l, %bb.c, %_ZN5boost9container6vectorI14counting_valueNS0_3dtl24static_storage_allocatorIS2_Lm10ELm0ELb1EEEvED2Ev.exit105
  ...
  %i.ev = add i64 %_ZZN14counting_value1cEvE2co.promoted.i.i104.pre, %.sink253
...
bb.z:                                             ; preds = %bb.j, %bb.i
  ...
  tail call void @__clang_call_terminate(ptr %i.ex) #26
  unreachable
}
