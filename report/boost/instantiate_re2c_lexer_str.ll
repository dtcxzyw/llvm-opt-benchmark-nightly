...
_ZN5boost4wave4util22AllocatorStringStorageIcSaIcEEC2ERKS4_.exit.i.i.i: ; preds = %.noexc8, %_ZN5boost4wave4util22AllocatorStringStorageIcSaIcEE4InitEmm.exit.thread.i.i.i.i
  ...
  store i8 1, ptr %i.ax, align 1, !tbaa !25
  br label %bb.h
...
bb.g:                                             ; preds = %_ZN5boost4wave4util11flex_stringIcSt11char_traitsIcESaIcENS1_9CowStringINS1_22AllocatorStringStorageIcS5_EEPcEEEC2ERKSB_.exit
  store ptr %i.ab, ptr %i.aa, align 8, !tbaa !45
  %i.ay = load i8, ptr %i.ac, align 1, !tbaa !25
  %i.az = add i8 %i.ay, 1
  store i8 %i.az, ptr %i.ac, align 1, !tbaa !25
  br label %bb.h
...
bb.h:                                             ; preds = %bb.g, %_ZN5boost4wave4util22AllocatorStringStorageIcSaIcEEC2ERKS4_.exit.i.i.i
  ...
  %i.bd = load i8, ptr %4, align 8, !tbaa !252, !range !28, !noalias !251, !noundef !29
  %i.be = trunc nuw i8 %i.bd to i1
  br i1 %i.be, label %bb.i, label %bb.m

bb.i:                                             ; preds = %bb.h
  %i.bf = getelementptr inbounds nuw i8, ptr %4, i64 8 ; 2 uses
  store i8 1, ptr %i.bc, align 8, !tbaa !121, !alias.scope !251
  %i.bg = getelementptr inbounds nuw i8, ptr %0, i64 48 ; 3 uses
  %i.bh = load ptr, ptr %i.bf, align 8, !tbaa !45, !noalias !251 ; 3 uses
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bh, i64 16 ; 4 uses
  %i.bj = load i8, ptr %i.bi, align 1, !tbaa !25, !noalias !251 ; 2 uses
  %i.bk = icmp eq i8 %i.bj, -1
  br i1 %i.bk, label %bb.j, label %bb.l

bb.j:                                             ; preds = %bb.i
  %i.bl = load ptr, ptr %i.bh, align 8, !tbaa !23, !noalias !251 ; 2 uses
...
_ZN5boost4wave4util22AllocatorStringStorageIcSaIcEE4InitEmm.exit.thread.i.i.i.i.i.i.i.i: ; preds = %bb.j
  store ptr @_ZN5boost4wave4util19SimpleStringStorageIcSaIcEE12emptyString_E, ptr %i.bg, align 8, !tbaa !45, !alias.scope !251
...
bb.k:                                             ; preds = %bb.j
  ...
  br i1 %i.br, label %.noexc.i.i.i.i.i.i.i.i, label %_ZN5boost4wave4util22AllocatorStringStorageIcSaIcEE5AllocEmPKv.exit.i.i.i.i.i.i.i.i.i, !prof !46
...
.noexc10:                                         ; preds = %_ZN5boost4wave4util22AllocatorStringStorageIcSaIcEE5AllocEmPKv.exit.i.i.i.i.i.i.i.i.i
  store ptr %i.bs, ptr %i.bg, align 8, !tbaa !45, !alias.scope !251
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bs, i64 16 ; 2 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %i.bt, i64 %i.bo ; 2 uses
  store ptr %i.bu, ptr %i.bs, align 8, !tbaa !23, !noalias !251
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bs, i64 8
  store ptr %i.bu, ptr %i.bv, align 8, !tbaa !24, !noalias !251
  %i.bw = load ptr, ptr %i.bf, align 8, !tbaa !45, !noalias !251 ; 2 uses
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 16 ; 2 uses
  %i.by = load ptr, ptr %i.bw, align 8, !tbaa !23, !noalias !251
  %i.bz = ptrtoint ptr %i.by to i64
  %i.ca = ptrtoint ptr %i.bx to i64
  %i.cb = sub i64 %i.bz, %i.ca
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.bt, ptr nonnull align 8 %i.bx, i64 %i.cb, i1 false), !noalias !251
  br label %_ZN5boost4wave4util22AllocatorStringStorageIcSaIcEEC2ERKS4_.exit.i.i.i.i.i.i.i
...
_ZN5boost4wave4util22AllocatorStringStorageIcSaIcEEC2ERKS4_.exit.i.i.i.i.i.i.i: ; preds = %.noexc10, %_ZN5boost4wave4util22AllocatorStringStorageIcSaIcEE4InitEmm.exit.thread.i.i.i.i.i.i.i.i
  ...
  store i8 1, ptr %i.cd, align 1, !tbaa !25, !noalias !251
...
bb.l:                                             ; preds = %bb.i
  store ptr %i.bh, ptr %i.bg, align 8, !tbaa !45, !alias.scope !251
  %i.ce = add nuw i8 %i.bj, 1
  store i8 %i.ce, ptr %i.bi, align 1, !tbaa !25, !noalias !251
  br label %_ZN5boost15optional_detail24fallback_guarded_storageINS_4wave4util13file_positionINS3_11flex_stringIcSt11char_traitsIcESaIcENS3_9CowStringINS3_22AllocatorStringStorageIcS8_EEPcEEEEEEEC2IJRKSF_EEENS_11optional_ns15in_place_init_tEDpOT_.exit.i.i
...
bb.m:                                             ; preds = %bb.h
  store i8 0, ptr %i.bc, align 8, !tbaa !121, !alias.scope !251
  %i.ch = getelementptr inbounds nuw i8, ptr %0, i64 48
  store i8 0, ptr %i.ch, align 8, !tbaa !25, !alias.scope !251
  br label %_ZN5boost8optionalINS_4wave4util13file_positionINS2_11flex_stringIcSt11char_traitsIcESaIcENS2_9CowStringINS2_22AllocatorStringStorageIcS7_EEPcEEEEEEEC2ERKSF_.exit
...
_ZN5boost8optionalINS_4wave4util13file_positionINS2_11flex_stringIcSt11char_traitsIcESaIcENS2_9CowStringINS2_22AllocatorStringStorageIcS7_EEPcEEEEEEEC2ERKSF_.exit: ; preds = %bb.m, %_ZN5boost15optional_detail24fallback_guarded_storageINS_4wave4util13file_positionINS3_11flex_stringIcSt11char_traitsIcESaIcENS3_9CowStringINS3_22AllocatorStringStorageIcS8_EEPcEEEEEEEC2IJRKSF_EEENS_11optional_ns15in_place_init_tEDpOT_.exit.i.i
  ...
  store i32 1, ptr %i.ci, align 8, !tbaa !253
  ret void
...
bb.a:
  ...
  store i32 -1, ptr %i.e, align 8, !tbaa !115
  %i.f = getelementptr inbounds nuw i8, ptr %i.a, i64 52
  store i32 -1, ptr %i.f, align 4, !tbaa !116
  store ptr getelementptr inbounds nuw inrange(-16, 32) (i8, ptr @_ZTVN5boost10wrapexceptISt9bad_allocEE, i64 16), ptr %i.a, align 8, !tbaa !19
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN5boost10wrapexceptISt9bad_allocEE, i64 64), ptr %i.b, align 8, !tbaa !19
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVN5boost10wrapexceptISt9bad_allocEE, i64 104), ptr %i.c, align 8, !tbaa !19
...
bb.b:                                             ; preds = %bb.a
  %i.j = load i64, ptr %i.d, align 8, !tbaa !36   ; 2 uses
  %i.k = icmp ugt i64 %i.j, 4
  br i1 %i.k, label %bb.c, label %.thread

bb.c:                                             ; preds = %bb.b
  %i.l = lshr i64 %i.j, 1                         ; 2 uses
  store i64 %i.l, ptr %i.d, align 8, !tbaa !36
  %i.m = load i64, ptr %i.a, align 8, !tbaa !66
...
bb.d:                                             ; preds = %bb.c, %bb.a
  ...
  %i.u = load i64, ptr %i.t, align 8, !tbaa !37   ; 3 uses
  %.not = icmp eq i64 %i.u, 0
  %i.v = load i64, ptr %i.d, align 8, !tbaa !36   ; 3 uses
  %i.w = load i64, ptr %i.a, align 8, !tbaa !66   ; 3 uses
...
.sink.split:                                      ; preds = %bb.e, %bb.g
  ...
  store i64 %.sroa.speculated.i25, ptr %i.ag, align 8, !tbaa !35
  store i64 %.sroa.speculated.i25, ptr %i.d, align 8, !tbaa !36
  br label %bb.h

bb.h:                                             ; preds = %.sink.split, %bb.f
  %i.ah = load ptr, ptr %0, align 8, !tbaa !119
  ...
  store ptr %i.ah, ptr %i.al, align 8, !tbaa !120
...
._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i, %bb.i
  ...
  store ptr %.022.lcssa.i.i, ptr %.1, align 8, !tbaa !120
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.preheader.i.i
  ...
  store ptr %.02228.i.i, ptr %.029.i.i, align 8, !tbaa !120
...
bb.a:
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVN5boost9exceptionE, i64 16), ptr %i.a, align 8, !tbaa !19
...
bb.a:
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 32) (i8, ptr @_ZTVN5boost16exception_detail10clone_baseE, i64 16), ptr %i.a, align 8, !tbaa !19
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 3 uses
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.b, align 8, !tbaa !19
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 16 ; 3 uses
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVN5boost9exceptionE, i64 16), ptr %i.c, align 8, !tbaa !19
  %i.d = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !117  ; 4 uses
  store ptr %i.f, ptr %i.d, align 8, !tbaa !117
...
bb.b:                                             ; preds = %bb.a
  ...
  invoke void %i.i(ptr noundef nonnull align 8 dereferenceable(8) %i.f)
          to label %bb.c unwind label %.body, !inline_history !257

.body:                                            ; preds = %bb.b
  %i.j = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZNSt9bad_allocD2Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %i.b) #31, !inline_history !259
...
_ZN5boost10wrapexceptISt9bad_allocE7deleterD2Ev.exit7: ; preds = %bb.c
  ...
  tail call void %i.q(ptr noundef nonnull align 8 dereferenceable(56) %i.a) #31, !inline_history !258
  br label %bb.d
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = load ptr, ptr %i.e, align 8
  %i.g = invoke noundef zeroext i1 %i.f(ptr noundef nonnull align 8 dereferenceable(8) %i.c)
          to label %_ZN5boost10wrapexceptISt9bad_allocED2Ev.exit unwind label %bb.c, !inline_history !1 ; 0 uses
