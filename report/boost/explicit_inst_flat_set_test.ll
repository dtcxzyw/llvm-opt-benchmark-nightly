...
.lr.ph:                                           ; preds = %bb.c, %_ZN5boost7movelib13adaptive_xbufINS_9container4test24movable_and_copyable_intEPS4_mE6insertIS5_EEvS5_T_.exit
  %indvar = phi i64 [ %indvar.next, %_ZN5boost7movelib13adaptive_xbufINS_9container4test24movable_and_copyable_intEPS4_mE6insertIS5_EEvS5_T_.exit ], [ 0, %bb.c ] ; 4 uses
...
.lr.ph.i81.preheader197:                          ; preds = %vector.memcheck, %.lr.ph.i81.preheader, %middle.block
  ...
  %i.aw = sub i64 %5, %.079.i.ph199               ; 2 uses
...
.preheader:                                       ; preds = %.preheader.lr.ph, %_ZN5boost7movelib13op_merge_leftIPNS_9container4test24movable_and_copyable_intENS2_3dtl23flat_tree_value_compareISt4lessIS4_ES4_NS_11move_detail8identityIS4_EEEENS0_7move_opEEEvT_SF_SF_SF_T0_T1_.exit67
  ...
  %.04285 = phi i64 [ %2, %.preheader.lr.ph ], [ %i.f, %_ZN5boost7movelib13op_merge_leftIPNS_9container4test24movable_and_copyable_intENS2_3dtl23flat_tree_value_compareISt4lessIS4_ES4_NS_11move_detail8identityIS4_EEEENS0_7move_opEEEvT_SF_SF_SF_T0_T1_.exit67 ] ; 18 uses
...
.lr.ph:                                           ; preds = %.preheader
  ...
  %i.j = shl i64 %.04285, 2                       ; 3 uses
  %i.k = add i64 %i.i, %i.j                       ; 2 uses
  %i.l = shl i64 %.04285, 3
  %i.m = shl i64 %.04285, 3
  %i.n = shl i64 %.04285, 3                       ; 2 uses
  %i.o = add i64 %.04186157, -4                   ; 2 uses
  %5 = add i64 %i.o, %i.n                         ; 3 uses
  %6 = shl i64 %.04285, 3
  %7 = shl i64 %.04285, 3
  %i.p = add i64 %i.o, %i.j
  %i.q = shl i64 %.04285, 3
...
bb.b:                                             ; preds = %.lr.ph, %_ZN5boost7movelib13op_merge_leftIPNS_9container4test24movable_and_copyable_intENS2_3dtl23flat_tree_value_compareISt4lessIS4_ES4_NS_11move_detail8identityIS4_EEEENS0_7move_opEEEvT_SF_SF_SF_T0_T1_.exit
  %indvar209 = phi i64 [ 0, %.lr.ph ], [ %indvar.next210, %_ZN5boost7movelib13op_merge_leftIPNS_9container4test24movable_and_copyable_intENS2_3dtl23flat_tree_value_compareISt4lessIS4_ES4_NS_11move_detail8identityIS4_EEEENS0_7move_opEEEvT_SF_SF_SF_T0_T1_.exit ] ; 7 uses
  ...
  %8 = mul i64 %i.q, %indvar209
  %9 = add i64 %i.p, %8
  %10 = mul i64 %7, %indvar209
  %11 = add i64 %5, %10
  %i.r = mul i64 %6, %indvar209
  %i.s = add i64 %5, %i.r
...
.lr.ph.i.i.i.preheader265:                        ; preds = %vector.memcheck233, %.lr.ph.i.i.i.preheader, %middle.block255
  ...
  %i.as = sub i64 %11, %.079.i.i.i.ph286          ; 2 uses
...
.lr.ph.i.i29.i.preheader264:                      ; preds = %vector.memcheck207, %.lr.ph.i.i29.i.preheader, %middle.block229
  ...
  %i.cp = sub i64 %9, %.079.i.i31.i.ph287         ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %_ZN5boost7movelib15detail_adaptive19swap_and_update_keyIPNS_9container4test24movable_and_copyable_intES6_EEvT_S7_RS7_T0_S9_S9_.exit
  %indvar = phi i64 [ 0, %.lr.ph ], [ %indvar.next, %_ZN5boost7movelib15detail_adaptive19swap_and_update_keyIPNS_9container4test24movable_and_copyable_intES6_EEvT_S7_RS7_T0_S9_S9_.exit ] ; 7 uses
  ...
  %15 = mul i64 %i.g, %indvar
  %16 = add i64 %14, %15
  %17 = mul i64 %i.f, %indvar
  %18 = add i64 %14, %17
  %i.h = mul i64 %i.e, %indvar
  %i.i = add i64 %i.c, %i.h
  %i.j = mul i64 %i.d, %indvar
  %i.k = add i64 %i.c, %i.j
  %i.l = mul i64 %12, %indvar
  %i.m = add i64 %i.c, %i.l
  %i.n = mul i64 %11, %indvar
  %i.o = add i64 %i.c, %i.n
...
.lr.ph.i49.preheader299:                          ; preds = %vector.memcheck262, %.lr.ph.i49.preheader, %middle.block291
  ...
  %i.ci = sub i64 %18, %.0810.i.ph344             ; 2 uses
...
.lr.ph.i.i.preheader297:                          ; preds = %vector.memcheck, %.lr.ph.i.i.preheader, %middle.block
  ...
  %i.dx = sub i64 %16, %.079.i.i.ph345            ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %_ZN5boost7movelib15detail_adaptive19swap_and_update_keyIPhPNS_9container4test24movable_and_copyable_intEEEvT_S8_RS8_T0_SA_SA_.exit
  %indvar = phi i64 [ 0, %.lr.ph ], [ %indvar.next, %_ZN5boost7movelib15detail_adaptive19swap_and_update_keyIPhPNS_9container4test24movable_and_copyable_intEEEvT_S8_RS8_T0_SA_SA_.exit ] ; 7 uses
...
.lr.ph.i49.preheader299:                          ; preds = %vector.memcheck262, %.lr.ph.i49.preheader, %middle.block291
  ...
  %.0810.i.ph344 = ptrtoaddr ptr %.0810.i.ph to i64
  %i.cj = sub i64 %18, %.0810.i.ph344             ; 2 uses
...
.lr.ph.i.i.preheader297:                          ; preds = %vector.memcheck, %.lr.ph.i.i.preheader, %middle.block
  ...
  %.079.i.i.ph345 = ptrtoaddr ptr %.079.i.i.ph to i64
  %i.dy = sub i64 %16, %.079.i.i.ph345            ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %_ZN5boost7movelib15detail_adaptive19swap_and_update_keyIPmPNS_9container4test24movable_and_copyable_intEEEvT_S8_RS8_T0_SA_SA_.exit
  %indvar = phi i64 [ 0, %.lr.ph ], [ %indvar.next, %_ZN5boost7movelib15detail_adaptive19swap_and_update_keyIPmPNS_9container4test24movable_and_copyable_intEEEvT_S8_RS8_T0_SA_SA_.exit ] ; 7 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.x
  %indvar = phi i64 [ 0, %.lr.ph ], [ %indvar.next, %bb.x ] ; 5 uses
  ...
  %22 = mul i64 %i.s, %indvar
  %23 = add i64 %i.q, %22
  %24 = mul i64 %i.r, %indvar
  %25 = add i64 %i.q, %24
  %i.ae = mul i64 %21, %indvar
  %i.af = add i64 %19, %i.ae
  %i.ag = mul i64 %20, %indvar                    ; 2 uses
  %i.ah = add i64 %19, %i.ag
...
.lr.ph.i125.preheader448:                         ; preds = %vector.memcheck, %.lr.ph.i125.preheader, %middle.block
  ...
  %i.co = sub i64 %23, %.02131.i.ph454            ; 2 uses
...
.lr.ph.i129.preheader450:                         ; preds = %vector.memcheck338, %.lr.ph.i129.preheader, %middle.block368
  ...
  %i.ff = sub i64 %25, %.02131.i132.ph453         ; 2 uses
...
.lr.ph.i129.preheader450:                         ; preds = %vector.memcheck338, %.lr.ph.i129.preheader, %middle.block368
  ...
  %.02131.i132.ph453 = ptrtoaddr ptr %.02131.i132.ph to i64
  %i.fb = sub i64 %25, %.02131.i132.ph453         ; 2 uses
