...
_ZN5boost4urls7grammar12hexdig_valueEc.exit.thread.thread.peel: ; preds = %.lr.ph.peel, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d, %bb.d
  ...
  br i1 %i.l, label %.outer.backedge.peel.a, label %.loopexit605

.outer.backedge.peel.a:                           ; preds = %_ZN5boost4urls7grammar12hexdig_valueEc.exit.thread.thread.peel
...
.lr.ph:                                           ; preds = %.outer.backedge.peel.a, %.outer.backedge
  %.0.ph539 = phi i32 [ %.0.ph.be, %.outer.backedge ], [ %i.t, %.outer.backedge.peel.a ] ; 5 uses
  %.073.ph538 = phi i32 [ %.073298, %.outer.backedge ], [ %.073297410.peel, %.outer.backedge.peel.a ] ; 6 uses
  %.077.ph536 = phi ptr [ %.077.ph.be, %.outer.backedge ], [ %i.k, %.outer.backedge.peel.a ]
  %.promoted535 = phi ptr [ %.promoted.pre, %.outer.backedge ], [ %.promoted.pre.peel, %.outer.backedge.peel.a ] ; 4 uses
...
bb.e:                                             ; preds = %.lr.ph
  ...
  br i1 %i.x, label %.loopexit331, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.y = load i8, ptr %i.w, align 1, !tbaa !17
  %i.z = icmp eq i8 %i.y, 58
  br i1 %i.z, label %bb.g, label %.loopexit332

bb.g:                                             ; preds = %bb.f
  %i.aa = icmp eq i32 %.073.ph538, -1
  br i1 %i.aa, label %bb.h, label %.loopexit333
...
.peel.next:                                       ; preds = %bb.h
  ...
  br i1 %i.ae, label %.thread215.thread, label %bb.j

.loopexit:                                        ; preds = %.outer.backedge.peel.a, %.outer.backedge, %bb.a
  %.073.ph.lcssa = phi i32 [ -1, %bb.a ], [ %.073297410.peel, %.outer.backedge.peel.a ], [ %.073298, %.outer.backedge ] ; 2 uses
  %.0.ph.lcssa = phi i32 [ 8, %bb.a ], [ %i.t, %.outer.backedge.peel.a ], [ %.0.ph.be, %.outer.backedge ]
  %.not = icmp eq i32 %.073.ph.lcssa, -1
  br i1 %.not, label %bb.i, label %.thread215
...
_ZN5boost6system10error_codeC2INS_4urls7grammar5errorEEET_PNSt9enable_ifIXoosr18is_error_code_enumIS6_EE5valuesr3std18is_error_code_enumIS6_EE5valueEvE4typeE.exit: ; preds = %bb.i
...
_ZN5boost6system10error_codeC2INS_4urls7grammar5errorEEET_PNSt9enable_ifIXoosr18is_error_code_enumIS6_EE5valuesr3std18is_error_code_enumIS6_EE5valueEvE4typeE.exit.thread: ; preds = %bb.i, %_ZN5boost6system10error_codeC2INS_4urls7grammar5errorEEET_PNSt9enable_ifIXoosr18is_error_code_enumIS6_EE5valuesr3std18is_error_code_enumIS6_EE5valueEvE4typeE.exit
...
.loopexit603:                                     ; preds = %bb.j, %bb.d
  %.promoted535.lcssa547 = phi ptr [ %i.a, %bb.d ], [ %.promoted535, %bb.j ]
  ...
  br i1 %i.aq, label %.loopexit331, label %bb.k

.loopexit331:                                     ; preds = %bb.b, %bb.e, %.loopexit603
...
.loopexit332:                                     ; preds = %bb.f
  ...
  br i1 %i.bl, label %bb.n, label %.loopexit602
...
_ZNKR5boost6system6resultINS_4urls6detail10h16_rule_t10value_typeENS0_10error_codeEE5errorEv.exit: ; preds = %bb.l, %bb.m
  %.sroa.0371.0 = phi i16 [ %.sroa.0345.0.copyload, %bb.l ], [ 0, %bb.m ]
...
.outer.backedge:                                  ; preds = %bb.n, %bb.aa
  %.073298 = phi i32 [ %i.ac, %bb.aa ], [ %.073.ph538, %bb.n ] ; 2 uses
  %.077.ph.be = phi ptr [ %i.ab, %bb.aa ], [ %i.w, %bb.n ]
  %.0.ph.be = phi i32 [ %i.fb, %bb.aa ], [ %i.bv, %bb.n ] ; 2 uses
...
.loopexit332.thread:                              ; preds = %bb.c, %bb.k
...
_ZN5boost6system10error_codeC2INS_4urls7grammar5errorEEET_PNSt9enable_ifIXoosr18is_error_code_enumIS6_EE5valuesr3std18is_error_code_enumIS6_EE5valueEvE4typeE.exit127: ; preds = %bb.r
...
_ZN5boost6system10error_codeC2INS_4urls7grammar5errorEEET_PNSt9enable_ifIXoosr18is_error_code_enumIS6_EE5valuesr3std18is_error_code_enumIS6_EE5valueEvE4typeE.exit127.thread: ; preds = %bb.r, %_ZN5boost6system10error_codeC2INS_4urls7grammar5errorEEET_PNSt9enable_ifIXoosr18is_error_code_enumIS6_EE5valuesr3std18is_error_code_enumIS6_EE5valueEvE4typeE.exit127
...
bb.s:                                             ; preds = %bb.q
  ...
  br i1 %i.eb, label %bb.w, label %bb.t
...
_ZN5boost4urls7grammar12hexdig_valueEc.exit.thread.thread: ; preds = %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j, %bb.j
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #22
  call void @_ZNK5boost4urls6detail10h16_rule_t5parseERPKcS4_(ptr dead_on_unwind nonnull writable sret(%"class.boost::system::result.181") align 8 %9, ptr noundef nonnull align 1 dereferenceable(1) @_ZN5boost4urls6detailL8h16_ruleE, ptr noundef nonnull align 8 dereferenceable(8) %2, ptr noundef %3) #22
  ...
  br i1 %i.er, label %bb.aa, label %.loopexit605
...
_ZNKR5boost6system6resultINS_4urls6detail10h16_rule_t10value_typeENS0_10error_codeEE5errorEv.exit131: ; preds = %bb.y, %bb.z
  %.sroa.0370.0 = phi i16 [ %.sroa.0345.0.copyload347.lcssa, %bb.y ], [ 0, %bb.z ]
...
bb.aa:                                            ; preds = %_ZN5boost4urls7grammar12hexdig_valueEc.exit.thread.thread
...
.thread209:                                       ; preds = %bb.aa, %bb.n, %.thread
  %.073295 = phi i32 [ %.073.ph538.lcssa, %.thread ], [ %.073.ph538, %bb.n ], [ %i.ac, %bb.aa ] ; 2 uses
  %.3 = phi i32 [ %i.ep, %.thread ], [ 0, %bb.n ], [ 0, %bb.aa ]
  %i.fm = icmp eq i32 %.073295, -1
  br i1 %i.fm, label %bb.ab, label %.thread215

bb.ab:                                            ; preds = %.thread209
...
.thread215:                                       ; preds = %_ZN5boost4urls7grammar12hexdig_valueEc.exit, %.loopexit, %.thread209
  ...
  br i1 %i.fo, label %.thread215.thread, label %bb.ac

.thread215.thread:                                ; preds = %.peel.next.peel, %bb.d, %bb.j, %.peel.next, %bb.h, %.thread215
  %.3219224 = phi i32 [ %.073294, %.thread215 ], [ 7, %bb.d ], [ 7, %.peel.next.peel ], [ 0, %bb.h ], [ %i.ac, %.peel.next ], [ %i.ac, %bb.j ]
