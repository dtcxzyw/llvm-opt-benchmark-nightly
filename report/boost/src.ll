...
_ZN5boost4json6detail3ryu6detail15decimalLength17Em.exit.thread123: ; preds = %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c, %_ZN5boost4json6detail3ryu6detail15decimalLength17Em.exit
  ...
  %4 = udiv i32 %i.t, 10000
  %5 = insertelement <2 x i32> poison, i32 %i.t, i64 0
  %6 = insertelement <2 x i32> %5, i32 %4, i64 1
  %7 = urem <2 x i32> %6, splat (i32 10000)
  %8 = trunc nuw nsw <2 x i32> %7 to <2 x i16>
  %.frozen = freeze <2 x i16> %8                  ; 2 uses
  %9 = udiv <2 x i16> %.frozen, splat (i16 100)   ; 3 uses
  %10 = extractelement <2 x i16> %9, i64 0
  %i.u = shl nuw nsw i16 %10, 1
  %11 = mul <2 x i16> %9, splat (i16 100)
  %.decomposed = sub <2 x i16> %.frozen, %11      ; 2 uses
  %12 = extractelement <2 x i16> %.decomposed, i64 0
  %13 = shl nuw nsw i16 %12, 1
  %14 = extractelement <2 x i16> %.decomposed, i64 1
  %i.v = shl nuw nsw i16 %14, 1
  %15 = extractelement <2 x i16> %9, i64 1
  %i.w = shl nuw nsw i16 %15, 1
