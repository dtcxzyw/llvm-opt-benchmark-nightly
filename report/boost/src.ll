...
bb.b:                                             ; preds = %bb.a
  ...
  %2 = zext i64 %i.u to i128                      ; 3 uses
  %3 = mul nuw i128 %2, %i.t
  ...
  %i.ai = zext i64 %i.ah to i128                  ; 2 uses
  %i.aj = mul nuw i128 %2, %i.ai
  %5 = mul nuw i128 %i.x, %i.ai
  %6 = lshr i128 %i.aj, 64
  %i.ak = add nuw i128 %6, %5
  %i.al = lshr i128 %i.ak, %i.ac
  %i.am = trunc i128 %i.al to i64                 ; 4 uses
  %i.an = zext i64 %i.f to i128                   ; 2 uses
  %i.ao = mul nuw i128 %2, %i.an
  %7 = mul nuw i128 %i.x, %i.an
  %8 = lshr i128 %i.ao, 64
  %i.ap = add nuw i128 %8, %7
...
bb.g:                                             ; preds = %bb.a
  ...
  %i.cd = or disjoint i64 %i.f, 2
  %i.ce = zext i64 %i.cd to i128                  ; 2 uses
  %i.cf = load i64, ptr %i.cc, align 16, !tbaa !90
  %9 = zext i64 %i.cf to i128                     ; 3 uses
  %10 = mul nuw i128 %9, %i.ce
  ...
  %i.cr = xor i64 %i.cq, -1
  %i.cs = add i64 %i.f, %i.cr
  %i.ct = zext i64 %i.cs to i128                  ; 2 uses
  %i.cu = mul nuw i128 %9, %i.ct
  %12 = mul nuw i128 %i.ci, %i.ct
  %13 = lshr i128 %i.cu, 64
  %i.cv = add nuw i128 %13, %12
  %i.cw = lshr i128 %i.cv, %i.cn
  %i.cx = trunc i128 %i.cw to i64                 ; 3 uses
  %i.cy = zext i64 %i.f to i128                   ; 2 uses
  %i.cz = mul nuw i128 %9, %i.cy
  %14 = mul nuw i128 %i.ci, %i.cy
  %15 = lshr i128 %i.cz, 64
  %i.da = add nuw i128 %15, %14
...
.noexc102:                                        ; preds = %bb.ap
  ...
  %i.fu = zext i64 %i.fn to i128                  ; 2 uses
...
.noexc103:                                        ; preds = %.noexc102
  ...
  %6 = zext i64 %i.gd to i128
  %7 = mul nuw i128 %6, %i.fu
  %8 = lshr i128 %7, 64
  %9 = trunc nuw i128 %8 to i64                   ; 2 uses
  %i.ge = add i64 %9, %i.fx                       ; 2 uses
  %10 = icmp ult i64 %i.ge, %9
  %i.gf = zext i1 %10 to i64
...
.noexc107:                                        ; preds = %bb.au
  ...
  %i.hy = zext i64 %i.hr to i128                  ; 2 uses
...
.noexc108:                                        ; preds = %.noexc107
  ...
  %11 = zext i64 %i.ih to i128
  %12 = mul nuw i128 %11, %i.hy
  %13 = lshr i128 %12, 64
  %14 = trunc nuw i128 %13 to i64                 ; 2 uses
  %i.ii = add i64 %14, %i.ib                      ; 2 uses
  %15 = icmp ult i64 %i.ii, %14
  %i.ij = zext i1 %15 to i64
...
.noexc99:                                         ; preds = %.noexc
  ...
  %16 = zext i64 %i.km to i128
  %17 = mul nuw i128 %16, %i.kb
  %18 = lshr i128 %17, 64
  %19 = trunc nuw i128 %18 to i64
  %i.kn = xor i64 %19, -1
  %20 = icmp ult i64 %i.kn, %i.ki
  %i.ko = zext i1 %20 to i64
