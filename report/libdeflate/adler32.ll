...
.preheader:                                       ; preds = %.lr.ph, %.preheader
  ...
  %i.ai = load <32 x i8>, ptr %.3, align 1, !tbaa !11 ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %.3, i64 32
  %i.ak = load <32 x i8>, ptr %i.aj, align 1, !tbaa !11 ; 2 uses
  ...
  br i1 %i.bd, label %.preheader, label %bb.d, !llvm.loop !22
...
bb.f:                                             ; preds = %bb.e
  %i.bx = load <32 x i8>, ptr %.4, align 1, !tbaa !11 ; 3 uses
  %i.by = getelementptr inbounds nuw i8, ptr %.4, i64 32
  %i.bz = load <32 x i8>, ptr %i.by, align 1, !tbaa !11 ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  %i.cw = load <32 x i8>, ptr %.5, align 1, !tbaa !11 ; 2 uses
...
.preheader222:                                    ; preds = %.lr.ph167, %.preheader222
  ...
  %i.y = load <32 x i8>, ptr %.3, align 1, !tbaa !11 ; 3 uses
  %i.z = getelementptr inbounds nuw i8, ptr %.3, i64 32
  %i.aa = load <32 x i8>, ptr %i.z, align 1, !tbaa !11 ; 3 uses
  ...
  br i1 %i.aw, label %.preheader222, label %bb.d, !llvm.loop !25
...
.preheader:                                       ; preds = %bb.e, %.preheader
  ...
  %i.br = load i8, ptr %.5, align 1, !tbaa !11
  ...
  br i1 %i.cm, label %.preheader, label %bb.f, !llvm.loop !26
...
.lr.ph.prol:                                      ; preds = %bb.g, %.lr.ph.prol
  ...
  %i.cv = load i8, ptr %.7158.prol, align 1, !tbaa !11
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %i.dc = load i8, ptr %.7158, align 1, !tbaa !11
