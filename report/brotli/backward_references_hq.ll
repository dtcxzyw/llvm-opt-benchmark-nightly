...
begin_hunk_0_@BrotliZopfliComputeShortestPath:bb.a
  ...
  %i.acx = load i32, ptr %i.acw, align 4, !tbaa !46
...
.lr.ph.i250:                                      ; preds = %._crit_edge541, %bb.dg
  ...
  %i.adb = load i32, ptr %i.ada, align 4, !tbaa !45
...
bb.dg:                                            ; preds = %.lr.ph.i250
  ...
  %i.adg = load i32, ptr %i.adf, align 4, !tbaa !46
  %i.adh = and i32 %i.adg, 134217727
  %i.adi = icmp eq i32 %i.adh, 0
  br i1 %i.adi, label %.lr.ph.i250, label %.critedge.i246, !llvm.loop !10
...
.critedge.i246:                                   ; preds = %bb.dg, %.lr.ph.i250, %._crit_edge541
  ...
  store i32 -1, ptr %i.adj, align 4, !tbaa !22
...
.lr.ph26.i:                                       ; preds = %.critedge.i246, %.lr.ph26.i
  ...
  %i.ado = load i32, ptr %i.adn, align 4, !tbaa !46
  ...
  store i32 %i.adq, ptr %i.adu, align 4, !tbaa !22
  %i.adv = add i64 %.01724.i, 1                   ; 2 uses
  %.not.i249 = icmp eq i64 %i.ads, 0
  br i1 %.not.i249, label %ComputeShortestPathFromNodes.exit, label %.lr.ph26.i, !llvm.loop !11
...
bb.a:
  ...
  %i.f = load i64, ptr %i.e, align 8, !tbaa !60   ; 6 uses
...
.lr.ph.epil.preheader:                            ; preds = %.preheader41.preheader.loopexit.unr-lcssa, %.lr.ph.preheader
  ...
  store float %i.n, ptr %i.k, align 4, !tbaa !92
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  store float %i.t, ptr %i.q, align 4, !tbaa !92
  ...
  %i.y = load float, ptr %i.x, align 4, !tbaa !92
  %i.z = fadd float %i.v, %i.y                    ; 2 uses
  %i.aa = fadd float %i.t, %i.z                   ; 4 uses
  store float %i.aa, ptr %i.x, align 4, !tbaa !92
  %i.ab = fsub float %i.aa, %i.t
  %i.ac = fsub float %i.z, %i.ab                  ; 2 uses
  %niter.next.1 = add nuw i64 %niter, 2           ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.preheader41.preheader.loopexit.unr-lcssa, label %.lr.ph, !llvm.loop !174

.preheader:                                       ; preds = %FastLog2.exit40
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 2824
  %i.ae = load i32, ptr %i.ad, align 8, !tbaa !64 ; 2 uses
...
bb.b:                                             ; preds = %.preheader41
  ...
  %i.aj = load double, ptr %i.ai, align 8, !tbaa !99
...
FastLog2.exit40:                                  ; preds = %bb.b, %bb.c
  ...
  store float %i.am, ptr %i.an, align 4, !tbaa !92
  %i.ao = add nuw nsw i64 %.144, 1                ; 2 uses
  %exitcond48.not = icmp eq i64 %i.ao, 704
  br i1 %exitcond48.not, label %.preheader, label %.preheader41, !llvm.loop !175
