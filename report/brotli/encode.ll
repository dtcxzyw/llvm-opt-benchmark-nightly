...
GetInsertLengthCode.exit:                         ; preds = %bb.et, %bb.ev, %bb.ex, %bb.ey, %bb.ez
  ...
  %i.bbt = lshr i16 %.0.i308, 3
  %narrow.i = mul nuw nsw i16 %i.bbt, 3
  %i.bbu = zext nneg i16 %narrow.i to i32         ; 2 uses
  %11 = shl nuw nsw i32 %i.bbu, 1
  %12 = shl nuw nsw i32 %i.bbu, 6
  %13 = add nuw nsw i32 %12, 64
  %i.bbv = lshr i32 5377344, %11
  %14 = and i32 %i.bbv, 192
  %15 = add nuw nsw i32 %13, %14
  %16 = trunc nuw nsw i32 %15 to i16
  %17 = shl nuw nsw i16 %.0.i308, 3
  %18 = and i16 %17, 56
  %i.bbw = or disjoint i16 %18, %16
  %.0.i312 = or disjoint i16 %i.bbw, 2
...
bb.p:                                             ; preds = %bb.o
  ...
  %3 = shl nuw nsw i32 %i.ek, 1
  %4 = zext nneg i32 %3 to i64
  %i.el = zext nneg i32 %i.ek to i64
  %i.em = lshr i64 %i.eh, %i.el
  %5 = add nuw nsw i64 %i.em, %4
  %6 = trunc nuw nsw i64 %5 to i16
  %i.en = add nuw nsw i16 %6, 2
  br label %GetInsertLengthCode.exit
...
bb.w:                                             ; preds = %bb.v
  ...
  %7 = shl nuw nsw i32 %i.fc, 1
  %8 = zext nneg i32 %7 to i64
  %i.fd = zext nneg i32 %i.fc to i64
  %i.fe = lshr i64 %i.ez, %i.fd
  %9 = add nuw nsw i64 %i.fe, %8
  %10 = trunc nuw nsw i64 %9 to i16
  %i.ff = add nuw nsw i16 %10, 4
  br label %GetCopyLengthCode.exit
...
GetCopyLengthCode.exit.thread:                    ; preds = %bb.x, %bb.y, %GetCopyLengthCode.exit
  ...
  %narrow21.i = add nuw nsw i16 %i.fp, %narrow.i
  %11 = zext nneg i16 %narrow21.i to i32          ; 2 uses
  %12 = shl nuw nsw i32 %11, 1
  %13 = shl nuw nsw i32 %11, 6
  %14 = add nuw nsw i32 %13, 64
  %i.fr = lshr i32 5377344, %12
  %15 = and i32 %i.fr, 192
...
CombineLengthCodes.exit:                          ; preds = %bb.z, %GetCopyLengthCode.exit.thread
  ...
  %.pn.i = phi i16 [ %i.fo, %bb.z ], [ %17, %GetCopyLengthCode.exit.thread ]
