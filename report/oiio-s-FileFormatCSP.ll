...
391:                                              ; preds = %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_510ColorSpaceELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_512CPUProcessorELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit142
  ...
  %.sroa.22.0 = phi ptr [ %207, %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_510ColorSpaceELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit ], [ %81, %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_512CPUProcessorELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit142 ] ; [#uses=1 type=ptr]
  ...
  %.sroa.22.0.fr = freeze ptr %.sroa.22.0         ; [#uses=16 type=ptr]
...
begin_hunk_1
  ...
  %448 = ptrtoint ptr %.sroa.22.0.fr to i64       ; [#uses=1 type=i64]
  %449 = ptrtoint ptr %.sroa.0358.6 to i64        ; [#uses=1 type=i64]
  %450 = sub i64 %448, %449                       ; [#uses=2 type=i64]
  %451 = ashr i64 %450, 2                         ; [#uses=2 type=i64]
...
459:                                              ; preds = %433
  %460 = icmp eq ptr %.sroa.0358.6, %.sroa.22.0.fr ; [#uses=1 type=i1]
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit221.preheader: ; preds = %567, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit235
  %indvars.iv522 = phi i64 [ %indvars.iv.next523, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit235 ], [ 0, %567 ] ; [#uses=2 type=i64]
  %.idx = mul nuw nsw i64 %indvars.iv522, 12      ; [#uses=1 type=i64]
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit235: ; preds = %_ZNSolsEf.exit233
  %indvars.iv.next523 = add nuw nsw i64 %indvars.iv522, 1 ; [#uses=2 type=i64]
  %exitcond526.not = icmp eq i64 %indvars.iv.next523, %33 ; [#uses=1 type=i1]
  br i1 %exitcond526.not, label %569, label %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit221.preheader, !llvm.loop !176
...
.split:                                           ; preds = %.split465.us.loopexit, %.split465.us.loopexit.split-lp.loopexit.split-lp, %.split465.us.loopexit.split-lp.loopexit, %.split462.us.loopexit, %.split462.us.loopexit.split-lp.loopexit.split-lp, %.split462.us.loopexit.split-lp.loopexit, %.split.us, %.split.split, %406, %586, %457, %455, %430, %76, %151, %404, %390
  ...
  %.sroa.37.7 = phi ptr [ %.sroa.22.0.fr, %430 ], [ %.sroa.22.0.fr, %586 ], [ %.sroa.22.0.fr, %455 ], [ %.sroa.22.0.fr, %.split.us ], [ %.sroa.22.0.fr, %.split462.us.loopexit ], [ %.sroa.37.0, %76 ], [ %.sroa.22.0.fr, %457 ], [ %.sroa.22.0.fr, %406 ], [ %.sroa.22.0.fr, %404 ], [ %.sroa.37.5, %390 ], [ %81, %151 ], [ %.sroa.22.0.fr, %.split.split ], [ %.sroa.22.0.fr, %.split462.us.loopexit.split-lp.loopexit ], [ %.sroa.22.0.fr, %.split462.us.loopexit.split-lp.loopexit.split-lp ], [ %.sroa.22.0.fr, %.split465.us.loopexit.split-lp.loopexit ], [ %.sroa.22.0.fr, %.split465.us.loopexit.split-lp.loopexit.split-lp ], [ %.sroa.22.0.fr, %.split465.us.loopexit ] ; [#uses=1 type=ptr]
  ...
  %.pn119.pn.pn = phi { ptr, i32 } [ %431, %430 ], [ %587, %586 ], [ %456, %455 ], [ %545, %.split.us ], [ %lpad.loopexit513, %.split462.us.loopexit ], [ %77, %76 ], [ %458, %457 ], [ %407, %406 ], [ %405, %404 ], [ %.pn105.pn.pn.pn.pn.pn.pn.pn.pn, %390 ], [ %.pn.pn.pn.pn, %151 ], [ %550, %.split.split ], [ %lpad.loopexit519, %.split462.us.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp520, %.split462.us.loopexit.split-lp.loopexit.split-lp ], [ %lpad.loopexit516, %.split465.us.loopexit.split-lp.loopexit ], [ %lpad.loopexit.split-lp517, %.split465.us.loopexit.split-lp.loopexit.split-lp ], [ %lpad.loopexit, %.split465.us.loopexit ] ; [#uses=2 type={ ptr, i32 }]
