...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.bx = tail call i64 %i.bv(ptr noundef nonnull %i.bq, i64 noundef %i.bw) #5, !inline_history !44 ; 3 uses
...
.preheader.us.i40:                                ; preds = %.lr.ph153
  ...
  br i1 %i.ck, label %.lr.ph153, label %.critedge.us.i42, !llvm.loop !45
...
.lr.ph153:                                        ; preds = %.preheader.us.i40.preheader, %.preheader.us.i40
  ...
  %i.cp = tail call i64 %i.cm(ptr noundef %i.cn, i64 noundef %i.co) #5, !inline_history !44
  %i.cq = icmp eq i64 %i.cp, 0
  br i1 %i.cq, label %.preheader.us.i40, label %..critedge.us.i42_crit_edge, !llvm.loop !45

..critedge.us.i42_crit_edge:                      ; preds = %.lr.ph153
  br label %.critedge.us.i42, !llvm.loop !45
...
bb.ag:                                            ; preds = %bb.af, %.critedge.us.i42, %bb.ae
  ...
  br i1 %i.cw, label %.split.us.i35, label %pm_strpbrk_utf8.exit, !llvm.loop !46
...
.thread.i:                                        ; preds = %bb.ah
  ...
  %i.df = tail call i64 %i.dd(ptr noundef nonnull %i.cx, i64 noundef %i.de) #5, !inline_history !44 ; 2 uses
...
bb.ak:                                            ; preds = %.thread45.i, %bb.aj, %bb.ai
  ...
  br i1 %i.di, label %.split.i31, label %pm_strpbrk_utf8.exit, !llvm.loop !46
...
bb.am:                                            ; preds = %.split.us.i43
  ...
  br i1 %exitcond.not.i46, label %pm_strpbrk_utf8.exit, label %.split.us.i43, !llvm.loop !47
...
bb.ap:                                            ; preds = %bb.an
  ...
  %i.dw = tail call i64 %i.du(ptr noundef nonnull %i.do, i64 noundef %i.dv) #5, !inline_history !48 ; 3 uses
...
.preheader.i:                                     ; preds = %.lr.ph150
  ...
  br i1 %i.ej, label %.lr.ph150, label %.critedge.i, !llvm.loop !49
...
.lr.ph150:                                        ; preds = %.preheader.i.preheader, %.preheader.i
  ...
  %i.eo = tail call i64 %i.el(ptr noundef %i.em, i64 noundef %i.en) #5, !inline_history !48
  %i.ep = icmp eq i64 %i.eo, 0
  br i1 %i.ep, label %.preheader.i, label %..critedge.i_crit_edge, !llvm.loop !49
...
bb.au:                                            ; preds = %.critedge.i, %bb.at, %bb.ao
  ...
  br i1 %i.eu, label %.split.i47, label %pm_strpbrk_utf8.exit, !llvm.loop !47
