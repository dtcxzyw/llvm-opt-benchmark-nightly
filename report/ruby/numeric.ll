...
begin_hunk_2_@rb_int_round:bb.a
  ...
  %spec.select = tail call i64 @llvm.abs.i64(i64 %i.aa, i1 true) ; 4 uses
  %i.ad = sdiv i64 %i.ab, 2                       ; 3 uses
...
bb.h:                                             ; preds = %bb.g
  %3 = add nsw i64 %i.ad, %spec.select
...
bb.i:                                             ; preds = %bb.g
  %4 = add nsw i64 %i.ad, %spec.select            ; 2 uses
  %i.al = srem i64 %4, %i.ab
  %i.am = sub nsw i64 %4, %i.al
  br label %bb.k

bb.j:                                             ; preds = %bb.g
  %5 = add nsw i64 %spec.select, -1
  %i.an = add nsw i64 %5, %i.ad                   ; 2 uses
