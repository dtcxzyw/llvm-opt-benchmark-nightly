...
bb.b:                                             ; preds = %bb.a
  ...
  %i.m = getelementptr i8, ptr %.0..0..0..0..0..0..i, i64 24
...
bb.f:                                             ; preds = %rb_ec_vm_lock_rec.exit
  %.0..0..0..0.3 = load ptr, ptr %i.d, align 8, !tbaa !20
  %3 = getelementptr i8, ptr %.0..0..0..0.3, i64 24
...
bb.g:                                             ; preds = %bb.e, %bb.f
  ...
  %.0..0..0..0.4 = load ptr, ptr %i.d, align 8, !tbaa !20
  %i.al = getelementptr i8, ptr %.0..0..0..0.4, i64 24
  store ptr %i.ak, ptr %i.al, align 8, !tbaa !77
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #16
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d)
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  %i.am = load ptr, ptr %i.f, align 8, !tbaa !20
  store volatile ptr %i.am, ptr %i.a, align 8, !tbaa !20
  ...
  %i.an = getelementptr i8, ptr %.0..0..0..0..0..0..i18, i64 36
  store i32 %.0..0..0..0.6, ptr %i.an, align 4, !tbaa !73
  br i1 %.not, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.ao = getelementptr i8, ptr %.0..0..0..0..0..0..i18, i64 24
  %.val = load ptr, ptr %i.ao, align 8, !tbaa !77 ; 2 uses
  %i.ap = getelementptr i8, ptr %.val, i64 64
  store i32 %i.aj, ptr %i.ap, align 8, !tbaa !74
  %i.aq = getelementptr i8, ptr %.val, i64 16
  call void @llvm.eh.sjlj.longjmp(ptr %i.aq)
  unreachable
