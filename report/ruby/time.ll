...
.lr.ph196:                                        ; preds = %.lr.ph196.preheader, %bb.at
  ...
  %i.ez = phi ptr [ %i.fe, %bb.at ], [ %.promoted198.pre, %.lr.ph196.preheader ] ; 3 uses
...
.lr.ph196..critedge2.loopexit_crit_edge:          ; preds = %.lr.ph196
  %.lcssa272 = phi ptr [ %i.ez, %.lr.ph196 ]
  br label %.critedge2.loopexit

.critedge2.loopexit:                              ; preds = %.critedge2.loopexitsplit, %.lr.ph196..critedge2.loopexit_crit_edge
  %.promoted198.ph = phi ptr [ %.lcssa272, %.lr.ph196..critedge2.loopexit_crit_edge ], [ %scevgep, %.critedge2.loopexitsplit ]
  br label %.critedge2
...
.lr.ph199:                                        ; preds = %.lr.ph199.preheader, %bb.au
  ...
  %i.fi = phi ptr [ %i.fo, %bb.au ], [ %.promoted198, %.lr.ph199.preheader ] ; 3 uses
...
.lr.ph199..critedge4.loopexit_crit_edge:          ; preds = %.lr.ph199
  %.lcssa278 = phi ptr [ %i.fi, %.lr.ph199 ]      ; 2 uses
  br label %.critedge4.loopexit

.critedge4.loopexit:                              ; preds = %.critedge4.loopexitsplit, %.lr.ph199..critedge4.loopexit_crit_edge
  %.promoted203223 = phi ptr [ %.lcssa278, %.lr.ph199..critedge4.loopexit_crit_edge ], [ %.lcssa277, %.critedge4.loopexitsplit ] ; 2 uses
  %.lcssa191.ph = phi ptr [ %.lcssa278, %.lr.ph199..critedge4.loopexit_crit_edge ], [ %scevgep212, %.critedge4.loopexitsplit ]
...
.lr.ph204:                                        ; preds = %.lr.ph204.preheader, %bb.av
  ...
  %i.fs = phi ptr [ %i.fy, %bb.av ], [ %.promoted203, %.lr.ph204.preheader ] ; 3 uses
...
.lr.ph204..critedge6.loopexit_crit_edge:          ; preds = %.lr.ph204
  %.lcssa284 = phi ptr [ %i.fs, %.lr.ph204 ]      ; 2 uses
  br label %.critedge6.loopexit

.critedge6.loopexit:                              ; preds = %.critedge6.loopexitsplit, %.lr.ph204..critedge6.loopexit_crit_edge
  %.promoted208225 = phi ptr [ %.lcssa284, %.lr.ph204..critedge6.loopexit_crit_edge ], [ %.lcssa283.a, %.critedge6.loopexitsplit ] ; 2 uses
  %.lcssa.ph = phi ptr [ %.lcssa284, %.lr.ph204..critedge6.loopexit_crit_edge ], [ %scevgep215, %.critedge6.loopexitsplit ]
