...
begin_hunk_12_@time_xmlschema:bb.a
  ...
  tail call void @rb_str_set_len(i64 noundef %.0126, i64 noundef %i.iq) #19
  ret i64 %.0126
}
...
.critedge2:                                       ; preds = %bb.at, %.lr.ph196.a, %bb.y, %.preheader, %bb.z, %bb.x, %bb.aa, %.critedge.thread257, %bb.aq, %bb.ap, %bb.t, %bb.u, %bb.p, %bb.q
  ...
  %.1104 = phi i32 [ -1, %bb.p ], [ -1, %bb.y ], [ %i.cu, %bb.ap ], [ -1, %bb.u ], [ -1, %bb.t ], [ -1, %bb.q ], [ -1, %bb.aa ], [ %i.cu, %.critedge.thread257 ], [ -1, %bb.x ], [ -1, %bb.z ], [ %i.cu, %bb.aq ], [ %i.cu, %.preheader ], [ %i.cu, %.lr.ph196.a ], [ %i.cu, %bb.at ] ; 3 uses
  %.1101 = phi i32 [ -1, %bb.p ], [ -1, %bb.y ], [ %i.dp, %bb.ap ], [ -1, %bb.u ], [ -1, %bb.t ], [ -1, %bb.q ], [ -1, %bb.aa ], [ %i.dp, %.critedge.thread257 ], [ -1, %bb.x ], [ -1, %bb.z ], [ %i.dp, %bb.aq ], [ %i.dp, %.preheader ], [ %i.dp, %.lr.ph196.a ], [ %i.dp, %bb.at ] ; 3 uses
  %.198 = phi i32 [ -1, %bb.p ], [ -1, %bb.y ], [ %i.bz, %bb.ap ], [ -1, %bb.u ], [ -1, %bb.t ], [ -1, %bb.q ], [ -1, %bb.aa ], [ %i.bz, %.critedge.thread257 ], [ -1, %bb.x ], [ -1, %bb.z ], [ %i.bz, %bb.aq ], [ %i.bz, %.preheader ], [ %i.bz, %.lr.ph196.a ], [ %i.bz, %bb.at ] ; 4 uses
  %.095 = phi i32 [ -1, %bb.p ], [ %i.bn, %bb.y ], [ %i.bn, %bb.ap ], [ -1, %bb.u ], [ -1, %bb.t ], [ -1, %bb.q ], [ %i.bn, %bb.aa ], [ %i.bn, %.critedge.thread257 ], [ %i.bn, %bb.x ], [ %i.bn, %bb.z ], [ %i.bn, %bb.aq ], [ %i.bn, %.preheader ], [ %i.bn, %.lr.ph196.a ], [ %i.bn, %bb.at ] ; 3 uses
  %.093 = phi i32 [ -1, %bb.p ], [ %i.bd, %bb.y ], [ %i.bd, %bb.ap ], [ %i.bd, %bb.u ], [ %i.bd, %bb.t ], [ -1, %bb.q ], [ %i.bd, %bb.aa ], [ %i.bd, %.critedge.thread257 ], [ %i.bd, %bb.x ], [ %i.bd, %bb.z ], [ %i.bd, %bb.aq ], [ %i.bd, %.preheader ], [ %i.bd, %.lr.ph196.a ], [ %i.bd, %bb.at ] ; 3 uses
  %.2 = phi i64 [ 4, %bb.p ], [ 4, %bb.y ], [ 4, %bb.ap ], [ 4, %bb.u ], [ 4, %bb.t ], [ 4, %bb.q ], [ 4, %bb.aa ], [ 4, %.critedge.thread257 ], [ 4, %bb.x ], [ 4, %bb.z ], [ 4, %bb.aq ], [ %i.et, %.preheader ], [ %i.et, %.lr.ph196.a ], [ %i.et, %bb.at ] ; 4 uses
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %i.hc = call i64 @rb_int_mul(i64 noundef %.2, i64 noundef %i.hb) #19
  br label %bb.bg
...
bb.bf:                                            ; preds = %bb.be
  ...
  %i.hg = call i64 @rb_rational_new(i64 noundef %.2, i64 noundef %i.hf) #19
  br label %bb.bg
...
bb.bh:                                            ; preds = %bb.bg, %.thread149, %.thread170
  ...
  %i.hl = phi i64 [ %.2, %.thread170 ], [ %spec.select, %bb.bg ], [ 1, %.thread149 ]
...
bb.aj:                                            ; preds = %bb.ai, %bb.ag, %bb.ac, %bb.y
  %.056 = phi i32 [ 2000, %bb.y ], [ %i.et, %bb.ac ], [ %i.fc, %bb.ag ], [ %i.fh, %bb.ai ] ; 2 uses
  %.3 = phi i32 [ %i.el, %bb.y ], [ %i.eu, %bb.ac ], [ %i.fd, %bb.ag ], [ %.sext86, %bb.ai ] ; 2 uses
  %i.fi = add nsw i32 %.3, 1
...
begin_hunk_21_@gmtimew_noleapsecond:bb.a
  ...
  %i.fp = sext i32 %.056 to i64                   ; 4 uses
