...
.preheader:                                       ; preds = %bb.d
  ...
  br i1 %i.k, label %.preheader.split.us, label %.loopexit

.preheader.split.us:                              ; preds = %.preheader
  %i.m = load i64, ptr %i.g, align 8, !tbaa !30
  %i.n = and i64 %i.m, 8192
  %.not.i19.us = icmp eq i64 %i.n, 0
  br i1 %.not.i19.us, label %RSTRING_PTR.exit.us.us.preheader, label %.preheader.split.us.split

RSTRING_PTR.exit.us.us.preheader:                 ; preds = %.preheader.split.us
  %i.o = tail call i32 @rb_st_locale_insensitive_strncasecmp(ptr noundef nonnull @months, ptr noundef %i.l, i64 noundef 3) #21
  %i.p = icmp eq i32 %i.o, 0
  br i1 %i.p, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.us.1

RSTRING_PTR.exit.us.us.1:                         ; preds = %RSTRING_PTR.exit.us.us.preheader
  ...
  br i1 %i.r, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.us.2

RSTRING_PTR.exit.us.us.2:                         ; preds = %RSTRING_PTR.exit.us.us.1
  ...
  br i1 %i.t, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.us.3

RSTRING_PTR.exit.us.us.3:                         ; preds = %RSTRING_PTR.exit.us.us.2
  ...
  br i1 %i.v, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.us.4

RSTRING_PTR.exit.us.us.4:                         ; preds = %RSTRING_PTR.exit.us.us.3
  ...
  br i1 %i.x, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.us.5

RSTRING_PTR.exit.us.us.5:                         ; preds = %RSTRING_PTR.exit.us.us.4
  ...
  br i1 %i.z, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.us.6

RSTRING_PTR.exit.us.us.6:                         ; preds = %RSTRING_PTR.exit.us.us.5
  ...
  br i1 %i.ab, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.us.7

RSTRING_PTR.exit.us.us.7:                         ; preds = %RSTRING_PTR.exit.us.us.6
  ...
  br i1 %i.ad, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.us.8

RSTRING_PTR.exit.us.us.8:                         ; preds = %RSTRING_PTR.exit.us.us.7
  ...
  br i1 %i.af, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.us.9

RSTRING_PTR.exit.us.us.9:                         ; preds = %RSTRING_PTR.exit.us.us.8
  ...
  br i1 %i.ah, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.us.10

RSTRING_PTR.exit.us.us.10:                        ; preds = %RSTRING_PTR.exit.us.us.9
  ...
  br i1 %i.aj, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.us.11

RSTRING_PTR.exit.us.us.11:                        ; preds = %RSTRING_PTR.exit.us.us.10
  ...
  br i1 %i.al, label %obj2ubits.exit, label %.loopexit
...
.preheader.split.us.split:                        ; preds = %.preheader.split.us
  ...
  br i1 %i.ao, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.1

RSTRING_PTR.exit.us.1:                            ; preds = %.preheader.split.us.split
  ...
  br i1 %i.aq, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.2
...
RSTRING_PTR.exit.us.2:                            ; preds = %RSTRING_PTR.exit.us.1
  ...
  br i1 %i.as, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.3
...
RSTRING_PTR.exit.us.3:                            ; preds = %RSTRING_PTR.exit.us.2
  ...
  br i1 %i.au, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.4
...
RSTRING_PTR.exit.us.4:                            ; preds = %RSTRING_PTR.exit.us.3
  ...
  br i1 %i.aw, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.5
...
RSTRING_PTR.exit.us.5:                            ; preds = %RSTRING_PTR.exit.us.4
  ...
  br i1 %i.ay, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.6
...
RSTRING_PTR.exit.us.6:                            ; preds = %RSTRING_PTR.exit.us.5
  ...
  br i1 %i.ba, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.7
...
RSTRING_PTR.exit.us.7:                            ; preds = %RSTRING_PTR.exit.us.6
  ...
  br i1 %i.bc, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.8
...
RSTRING_PTR.exit.us.8:                            ; preds = %RSTRING_PTR.exit.us.7
  ...
  br i1 %i.be, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.9
...
RSTRING_PTR.exit.us.9:                            ; preds = %RSTRING_PTR.exit.us.8
  ...
  br i1 %i.bg, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.10
...
RSTRING_PTR.exit.us.10:                           ; preds = %RSTRING_PTR.exit.us.9
  ...
  br i1 %i.bi, label %obj2ubits.exit, label %RSTRING_PTR.exit.us.11

RSTRING_PTR.exit.us.11:                           ; preds = %RSTRING_PTR.exit.us.10
...
rbimpl_RB_TYPE_P_fastpath.exit.i.i20:             ; preds = %.loopexit
...
rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i21:      ; preds = %bb.e, %rbimpl_RB_TYPE_P_fastpath.exit.i.i20, %.loopexit
  %.0.i.i22 = phi i64 [ %i.bt, %bb.e ], [ %.018.ph, %rbimpl_RB_TYPE_P_fastpath.exit.i.i20 ], [ %.018.ph, %.loopexit ] ; 3 uses
...
obj2ubits.exit:                                   ; preds = %RSTRING_PTR.exit.us.us.11, %RSTRING_PTR.exit.us.us.10, %RSTRING_PTR.exit.us.us.9, %RSTRING_PTR.exit.us.us.8, %RSTRING_PTR.exit.us.us.7, %RSTRING_PTR.exit.us.us.6, %RSTRING_PTR.exit.us.us.5, %RSTRING_PTR.exit.us.us.4, %RSTRING_PTR.exit.us.us.3, %RSTRING_PTR.exit.us.us.2, %RSTRING_PTR.exit.us.us.1, %RSTRING_PTR.exit.us.us.preheader, %RSTRING_PTR.exit.us.11, %RSTRING_PTR.exit.us.10, %RSTRING_PTR.exit.us.9, %RSTRING_PTR.exit.us.8, %RSTRING_PTR.exit.us.7, %RSTRING_PTR.exit.us.6, %RSTRING_PTR.exit.us.5, %RSTRING_PTR.exit.us.4, %RSTRING_PTR.exit.us.3, %RSTRING_PTR.exit.us.2, %RSTRING_PTR.exit.us.1, %.preheader.split.us.split, %obj2int.exit.i23, %rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i
  %.0 = phi i32 [ %i.bx, %obj2int.exit.i23 ], [ %i.c, %rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i ], [ 12, %RSTRING_PTR.exit.us.us.11 ], [ 1, %RSTRING_PTR.exit.us.us.preheader ], [ 2, %RSTRING_PTR.exit.us.us.1 ], [ 3, %RSTRING_PTR.exit.us.us.2 ], [ 4, %RSTRING_PTR.exit.us.us.3 ], [ 5, %RSTRING_PTR.exit.us.us.4 ], [ 6, %RSTRING_PTR.exit.us.us.5 ], [ 7, %RSTRING_PTR.exit.us.us.6 ], [ 8, %RSTRING_PTR.exit.us.us.7 ], [ 9, %RSTRING_PTR.exit.us.us.8 ], [ 10, %RSTRING_PTR.exit.us.us.9 ], [ 11, %RSTRING_PTR.exit.us.us.10 ], [ 1, %.preheader.split.us.split ], [ 2, %RSTRING_PTR.exit.us.1 ], [ 3, %RSTRING_PTR.exit.us.2 ], [ 4, %RSTRING_PTR.exit.us.3 ], [ 5, %RSTRING_PTR.exit.us.4 ], [ 6, %RSTRING_PTR.exit.us.5 ], [ 7, %RSTRING_PTR.exit.us.6 ], [ 8, %RSTRING_PTR.exit.us.7 ], [ 9, %RSTRING_PTR.exit.us.8 ], [ 10, %RSTRING_PTR.exit.us.9 ], [ 11, %RSTRING_PTR.exit.us.10 ], [ 12, %RSTRING_PTR.exit.us.11 ]
  ret i32 %.0
}
