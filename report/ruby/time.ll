...
bb.s:                                             ; preds = %extract_time.exit
  call void @rb_gc_writebarrier(i64 noundef %1, i64 noundef %i.cz) #18
...
bb.t:                                             ; preds = %rb_obj_write.exit.i
  call void @rb_gc_writebarrier(i64 noundef %1, i64 noundef %0) #18
...
bb.z:                                             ; preds = %bb.y
  call void @rb_gc_writebarrier(i64 noundef %1, i64 noundef %.023) #18
...
bb.bq:                                            ; preds = %rb_obj_write.exit
  call void @rb_gc_writebarrier(i64 noundef %1, i64 noundef %i.pi) #18
  br label %rb_obj_write.exit.i
