...
.preheader.i.i:                                   ; preds = %RTYPEDDATA_GET_DATA.exit.i.i, %bb.i
  %.015.i.i = phi ptr [ %i.w, %bb.i ], [ %i.p, %RTYPEDDATA_GET_DATA.exit.i.i ] ; 2 uses
  %.not.i.i = icmp eq ptr %.015.i.i, null
  br i1 %.not.i.i, label %.critedge.i.i, label %bb.i

bb.i:                                             ; preds = %.preheader.i.i
  %i.v = getelementptr i8, ptr %.015.i.i, i64 48
...
ruby_nonempty_memcpy.exit.loopexit:               ; preds = %bb.ag, %rb_num2long_inline.exit147
  %.0130 = phi i64 [ %i.gl, %bb.ag ], [ %.0.i146, %rb_num2long_inline.exit147 ]
  %i.gm = add nuw nsw i64 %.0, 1
  %i.gn = trunc nuw nsw i64 %.0 to i32
  %i.go = tail call i32 (ptr, i64, ptr, ...) @ruby_snprintf(ptr noundef %i.ep, i64 noundef %i.gm, ptr noundef nonnull @.str.135, i32 noundef %i.gn, i64 noundef %.0130) #18
  %i.gp = sext i32 %i.go to i64
  %i.gq = getelementptr i8, ptr %i.ep, i64 %i.gp
  br label %ruby_nonempty_memcpy.exit

bb.ah:                                            ; preds = %bb.ac
  %i.gr = tail call i64 @rb_int2str(i64 noundef %.1132, i32 noundef 10) #18
...
bb.aj:                                            ; preds = %bb.ah, %bb.ai
  %.0127 = phi i64 [ %i.gu, %bb.ai ], [ %.0, %bb.ah ] ; 3 uses
...
RSTRING_PTR.exit149:                              ; preds = %bb.aj, %bb.ak
  ...
  %.not.i150 = icmp eq i64 %.0127, 0
  br i1 %.not.i150, label %ruby_nonempty_memcpy.exit, label %bb.al

bb.al:                                            ; preds = %RSTRING_PTR.exit149
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 %i.gz, ptr noundef nonnull readonly align 1 %i.he, i64 noundef %.0127, i1 noundef false) #18
  br label %ruby_nonempty_memcpy.exit
...
.preheader.i.i.i:                                 ; preds = %RTYPEDDATA_GET_DATA.exit.i.i.i, %bb.e
  %.015.i.i.i = phi ptr [ %i.t, %bb.e ], [ %i.m, %RTYPEDDATA_GET_DATA.exit.i.i.i ] ; 2 uses
  %.not.i.i.i = icmp eq ptr %.015.i.i.i, null
  br i1 %.not.i.i.i, label %.critedge.i.i.i, label %bb.e

bb.e:                                             ; preds = %.preheader.i.i.i
  %i.s = getelementptr i8, ptr %.015.i.i.i, i64 48
...
rb_long2num_inline.exit.i:                        ; preds = %bb.o, %bb.n, %bb.l, %bb.k, %bb.i, %bb.h
  %.075.i = phi i64 [ 67435, %bb.h ], [ 1900, %bb.o ], [ %i.af, %bb.i ], [ 67435, %bb.n ], [ 1900, %bb.k ], [ 1900, %bb.l ] ; 2 uses
  %.073.i = phi i64 [ %i.ah, %bb.h ], [ %i.ap, %bb.o ], [ 4, %bb.i ], [ %i.ao, %bb.n ], [ %i.al, %bb.k ], [ %i.am, %bb.l ] ; 3 uses
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %or.cond189 = and i1 %i.ec, %i.ed
  br i1 %or.cond189, label %.lr.ph, label %.critedge.thread

.lr.ph:                                           ; preds = %bb.ar, %bb.as
  %storemerge190 = phi i64 [ %i.ei, %bb.as ], [ 0, %bb.ar ] ; 4 uses
  %i.ee = getelementptr i8, ptr %i.dz, i64 %storemerge190
...
bb.as:                                            ; preds = %.lr.ph
  %i.ei = add nuw nsw i64 %storemerge190, 1       ; 5 uses
  store i64 %i.ei, ptr %i.b, align 8, !tbaa !13
  %i.ej = icmp ult i64 %i.ei, %i.w
  %i.ek = icmp slt i64 %i.ei, %i.eb
  %or.cond = and i1 %i.ej, %i.ek
  br i1 %or.cond, label %.lr.ph, label %.critedge.thread254, !llvm.loop !72

.critedge:                                        ; preds = %.lr.ph
  %.not129 = icmp eq i64 %storemerge190, 0
  br i1 %.not129, label %.critedge.thread, label %.critedge.thread254
...
.critedge.thread254:                              ; preds = %bb.as, %.critedge
  %storemerge.lcssa257 = phi i64 [ %storemerge190, %.critedge ], [ %i.ei, %bb.as ]
  %i.eu = call i64 @rb_int_parse_cstr(ptr noundef %i.dz, i64 noundef %storemerge.lcssa257, ptr noundef nonnull %i.a, ptr noundef nonnull %i.b, i32 noundef 10, i32 noundef 0) #18 ; 4 uses
  %i.ev = icmp eq i64 %i.eu, 4
  %.promoted195.pre = load ptr, ptr %i.a, align 8, !tbaa !69 ; 6 uses
  br i1 %i.ev, label %.critedge2, label %.preheader

.preheader:                                       ; preds = %.critedge.thread254
  %i.ew = icmp ult ptr %.promoted195.pre, %i.r
  br i1 %i.ew, label %.lr.ph193.preheader, label %.critedge2

.lr.ph193.preheader:                              ; preds = %.preheader
  %.promoted207 = ptrtoaddr ptr %.promoted195.pre to i64
  %i.ex = add i64 %i.q, %i.o
  %i.ey = sub i64 %i.ex, %.promoted207
  %scevgep = getelementptr i8, ptr %.promoted195.pre, i64 %i.ey ; 2 uses
  br label %.lr.ph193

.lr.ph193:                                        ; preds = %.lr.ph193.preheader, %bb.at
  %i.ez = phi ptr [ %i.fe, %bb.at ], [ %.promoted195.pre, %.lr.ph193.preheader ] ; 3 uses
...
bb.at:                                            ; preds = %.lr.ph193
  %i.fe = getelementptr i8, ptr %i.ez, i64 1      ; 3 uses
  store ptr %i.fe, ptr %i.a, align 8, !tbaa !69
  %exitcond.not = icmp eq ptr %i.fe, %scevgep
  br i1 %exitcond.not, label %.critedge2, label %.lr.ph193, !llvm.loop !73

.critedge2:                                       ; preds = %bb.at, %.lr.ph193, %bb.y, %.preheader, %bb.z, %bb.x, %bb.aa, %.critedge.thread254, %bb.aq, %bb.ap, %bb.t, %bb.u, %bb.p, %bb.q
  %.promoted195 = phi ptr [ %i.aw, %bb.p ], [ %i.br, %bb.y ], [ %i.dt, %bb.ap ], [ %i.bh, %bb.u ], [ %i.bh, %bb.t ], [ %i.aw, %bb.q ], [ %i.br, %bb.aa ], [ %.promoted195.pre, %.critedge.thread254 ], [ %i.br, %bb.x ], [ %i.br, %bb.z ], [ %i.dt, %bb.aq ], [ %.promoted195.pre, %.preheader ], [ %scevgep, %bb.at ], [ %i.ez, %.lr.ph193 ] ; 6 uses
  %.1104 = phi i32 [ -1, %bb.p ], [ -1, %bb.y ], [ %i.cv, %bb.ap ], [ -1, %bb.u ], [ -1, %bb.t ], [ -1, %bb.q ], [ -1, %bb.aa ], [ %i.cv, %.critedge.thread254 ], [ -1, %bb.x ], [ -1, %bb.z ], [ %i.cv, %bb.aq ], [ %i.cv, %.preheader ], [ %i.cv, %.lr.ph193 ], [ %i.cv, %bb.at ] ; 3 uses
  %.0101 = phi i32 [ -1, %bb.p ], [ -1, %bb.y ], [ %i.dq, %bb.ap ], [ -1, %bb.u ], [ -1, %bb.t ], [ -1, %bb.q ], [ -1, %bb.aa ], [ %i.dq, %.critedge.thread254 ], [ -1, %bb.x ], [ -1, %bb.z ], [ %i.dq, %bb.aq ], [ %i.dq, %.preheader ], [ %i.dq, %.lr.ph193 ], [ %i.dq, %bb.at ] ; 3 uses
  %.099 = phi i32 [ -1, %bb.p ], [ -1, %bb.y ], [ %i.ca, %bb.ap ], [ -1, %bb.u ], [ -1, %bb.t ], [ -1, %bb.q ], [ -1, %bb.aa ], [ %i.ca, %.critedge.thread254 ], [ -1, %bb.x ], [ -1, %bb.z ], [ %i.ca, %bb.aq ], [ %i.ca, %.preheader ], [ %i.ca, %.lr.ph193 ], [ %i.ca, %bb.at ] ; 4 uses
  %.197 = phi i32 [ -1, %bb.p ], [ %i.bo, %bb.y ], [ %i.bo, %bb.ap ], [ -1, %bb.u ], [ -1, %bb.t ], [ -1, %bb.q ], [ %i.bo, %bb.aa ], [ %i.bo, %.critedge.thread254 ], [ %i.bo, %bb.x ], [ %i.bo, %bb.z ], [ %i.bo, %bb.aq ], [ %i.bo, %.preheader ], [ %i.bo, %.lr.ph193 ], [ %i.bo, %bb.at ] ; 3 uses
  %.194 = phi i32 [ -1, %bb.p ], [ %i.be, %bb.y ], [ %i.be, %bb.ap ], [ %i.be, %bb.u ], [ %i.be, %bb.t ], [ -1, %bb.q ], [ %i.be, %bb.aa ], [ %i.be, %.critedge.thread254 ], [ %i.be, %bb.x ], [ %i.be, %bb.z ], [ %i.be, %bb.aq ], [ %i.be, %.preheader ], [ %i.be, %.lr.ph193 ], [ %i.be, %bb.at ] ; 3 uses
  %.2 = phi i64 [ 4, %bb.p ], [ 4, %bb.y ], [ 4, %bb.ap ], [ 4, %bb.u ], [ 4, %bb.t ], [ 4, %bb.q ], [ 4, %bb.aa ], [ 4, %.critedge.thread254 ], [ 4, %bb.x ], [ 4, %bb.z ], [ 4, %bb.aq ], [ %i.eu, %.preheader ], [ %i.eu, %.lr.ph193 ], [ %i.eu, %bb.at ] ; 4 uses
  %.promoted195208 = ptrtoaddr ptr %.promoted195 to i64 ; 2 uses
  %i.ff = icmp ult ptr %.promoted195, %i.r
  br i1 %i.ff, label %.lr.ph196.preheader, label %.critedge4

.lr.ph196.preheader:                              ; preds = %.critedge2
  %i.fg = add i64 %i.q, %i.o
  %i.fh = sub i64 %i.fg, %.promoted195208
  %scevgep209 = getelementptr i8, ptr %.promoted195, i64 %i.fh ; 2 uses
  br label %.lr.ph196

.lr.ph196:                                        ; preds = %.lr.ph196.preheader, %bb.au
  %i.fi = phi ptr [ %i.fo, %bb.au ], [ %.promoted195, %.lr.ph196.preheader ] ; 4 uses
...
bb.au:                                            ; preds = %.lr.ph196
  %i.fo = getelementptr i8, ptr %i.fi, i64 1      ; 4 uses
  store ptr %i.fo, ptr %i.a, align 8, !tbaa !69
  %exitcond210.not = icmp eq ptr %i.fo, %scevgep209
  br i1 %exitcond210.not, label %.critedge4.loopexit, label %.lr.ph196, !llvm.loop !74

.critedge4.loopexit:                              ; preds = %bb.au, %.lr.ph196
  %.promoted200220 = phi ptr [ %i.fi, %.lr.ph196 ], [ %i.fo, %bb.au ] ; 2 uses
  %.lcssa188.ph = phi ptr [ %i.fi, %.lr.ph196 ], [ %scevgep209, %bb.au ]
  %.pre = ptrtoaddr ptr %.promoted200220 to i64
  br label %.critedge4

.critedge4:                                       ; preds = %.critedge4.loopexit, %.critedge2
  %.promoted200211.pre-phi = phi i64 [ %.pre, %.critedge4.loopexit ], [ %.promoted195208, %.critedge2 ] ; 2 uses
  %.promoted200 = phi ptr [ %.promoted200220, %.critedge4.loopexit ], [ %.promoted195, %.critedge2 ] ; 5 uses
  %.lcssa188 = phi ptr [ %.lcssa188.ph, %.critedge4.loopexit ], [ %.promoted195, %.critedge2 ] ; 2 uses
  %i.fp = icmp ult ptr %.promoted200, %i.r
  br i1 %i.fp, label %.lr.ph201.preheader, label %.critedge6

.lr.ph201.preheader:                              ; preds = %.critedge4
  %i.fq = add i64 %i.q, %i.o
  %i.fr = sub i64 %i.fq, %.promoted200211.pre-phi
  %scevgep212 = getelementptr i8, ptr %.promoted200, i64 %i.fr ; 2 uses
  br label %.lr.ph201

.lr.ph201:                                        ; preds = %.lr.ph201.preheader, %bb.av
  %i.fs = phi ptr [ %i.fy, %bb.av ], [ %.promoted200, %.lr.ph201.preheader ] ; 4 uses
...
bb.av:                                            ; preds = %.lr.ph201
  %i.fy = getelementptr i8, ptr %i.fs, i64 1      ; 4 uses
  store ptr %i.fy, ptr %i.a, align 8, !tbaa !69
  %exitcond213.not = icmp eq ptr %i.fy, %scevgep212
  br i1 %exitcond213.not, label %.critedge6.loopexit, label %.lr.ph201, !llvm.loop !75

.critedge6.loopexit:                              ; preds = %bb.av, %.lr.ph201
  %.promoted205222 = phi ptr [ %i.fs, %.lr.ph201 ], [ %i.fy, %bb.av ] ; 2 uses
  %.lcssa.ph = phi ptr [ %i.fs, %.lr.ph201 ], [ %scevgep212, %bb.av ]
  %.pre223 = ptrtoaddr ptr %.promoted205222 to i64
  br label %.critedge6

.critedge6:                                       ; preds = %.critedge6.loopexit, %.critedge4
  %.promoted205214.pre-phi = phi i64 [ %.pre223, %.critedge6.loopexit ], [ %.promoted200211.pre-phi, %.critedge4 ]
  %.promoted205 = phi ptr [ %.promoted205222, %.critedge6.loopexit ], [ %.promoted200, %.critedge4 ] ; 3 uses
  %.lcssa = phi ptr [ %.lcssa.ph, %.critedge6.loopexit ], [ %.promoted200, %.critedge4 ] ; 2 uses
  %i.fz = icmp ult ptr %.promoted205, %i.r
  br i1 %i.fz, label %.lr.ph206.preheader, label %.critedge8

.lr.ph206.preheader:                              ; preds = %.critedge6
  %i.ga = add i64 %i.q, %i.o
  %i.gb = sub i64 %i.ga, %.promoted205214.pre-phi
  %scevgep215 = getelementptr i8, ptr %.promoted205, i64 %i.gb
  br label %.lr.ph206

.lr.ph206:                                        ; preds = %.lr.ph206.preheader, %bb.aw
  %i.gc = phi ptr [ %i.gi, %bb.aw ], [ %.promoted205, %.lr.ph206.preheader ] ; 2 uses
...
bb.aw:                                            ; preds = %.lr.ph206
  %i.gi = getelementptr i8, ptr %i.gc, i64 1      ; 3 uses
  store ptr %i.gi, ptr %i.a, align 8, !tbaa !69
  %exitcond216.not = icmp eq ptr %i.gi, %scevgep215
  br i1 %exitcond216.not, label %.critedge8, label %.lr.ph206, !llvm.loop !76

bb.ax:                                            ; preds = %.lr.ph206
...
.critedge8:                                       ; preds = %bb.aw, %.critedge6
  %i.gq = icmp ugt ptr %.lcssa, %.lcssa188
  br i1 %i.gq, label %bb.ay, label %bb.az

bb.ay:                                            ; preds = %.critedge8
  %i.gr = ptrtoint ptr %.lcssa188 to i64          ; 2 uses
...
bb.bb:                                            ; preds = %bb.az, %bb.ay
  ...
  %i.gy = icmp eq i64 %.2, 4
  br i1 %i.gy, label %.thread147, label %bb.bc
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %i.hd = call i64 @rb_int_mul(i64 noundef %.2, i64 noundef %i.hc) #18
  br label %bb.bg

bb.be:                                            ; preds = %bb.bc
  %.not134 = icmp eq i64 %i.gz, 9
  br i1 %.not134, label %.thread168, label %bb.bf

.thread168:                                       ; preds = %bb.be
...
bb.bf:                                            ; preds = %bb.be
  ...
  %i.hh = call i64 @rb_rational_new(i64 noundef %.2, i64 noundef %i.hg) #18
  br label %bb.bg

.thread147:                                       ; preds = %bb.o, %bb.bb
  %.2105.ph = phi i32 [ %.1104, %bb.bb ], [ -1, %bb.o ]
  %.1102.ph = phi i32 [ %.0101, %bb.bb ], [ -1, %bb.o ]
  %.1100.ph = phi i32 [ %.099, %bb.bb ], [ -1, %bb.o ]
  %.298.ph = phi i32 [ %.197, %bb.bb ], [ -1, %bb.o ]
  %.295.ph = phi i32 [ %.194, %bb.bb ], [ -1, %bb.o ]
...
bb.bh:                                            ; preds = %bb.bg, %.thread147, %.thread168
  %i.hl = phi ptr [ %i.he, %.thread168 ], [ %i.hj, %bb.bg ], [ %i.hi, %.thread147 ]
  %.1166 = phi i64 [ %.090, %.thread168 ], [ %.090, %bb.bg ], [ %.1.ph, %.thread147 ]
  %.295162 = phi i32 [ %.194, %.thread168 ], [ %.194, %bb.bg ], [ %.295.ph, %.thread147 ]
  %.298160 = phi i32 [ %.197, %.thread168 ], [ %.197, %bb.bg ], [ %.298.ph, %.thread147 ]
  %.1100158 = phi i32 [ %.099, %.thread168 ], [ %.099, %bb.bg ], [ %.1100.ph, %.thread147 ]
  %.1102156 = phi i32 [ %.0101, %.thread168 ], [ %.0101, %bb.bg ], [ %.1102.ph, %.thread147 ]
  %.2105158 = phi i32 [ %.1104, %.thread168 ], [ %.1104, %bb.bg ], [ %.2105.ph, %.thread147 ]
  %i.hm = phi i64 [ %.2, %.thread168 ], [ %spec.select, %bb.bg ], [ 1, %.thread147 ]
  %.196164.fr = freeze i32 %.298160               ; 2 uses
  %.194166.fr = freeze i32 %.295162               ; 2 uses
  ...
  %i.hr = icmp slt i32 %.194166.fr, 0
  %i.hs = shl i32 %.194166.fr, 9
  %i.ht = and i32 %i.hs, 7680
  %i.hu = select i1 %i.hr, i32 512, i32 %i.ht
  %i.hv = icmp slt i32 %.196164.fr, 0
  %i.hw = shl i32 %.196164.fr, 13
  %i.hx = and i32 %i.hw, 253952
  %i.hy = select i1 %i.hv, i32 8192, i32 %i.hx
  %6 = or disjoint i32 %i.hy, %i.hu
  %i.hz = call i32 @llvm.smax.i32(i32 %.1100158, i32 0)
  %i.ia = shl i32 %i.hz, 18
  %i.ib = and i32 %i.ia, 8126464
  %7 = or disjoint i32 %6, %i.ib
  %i.ic = call i32 @llvm.smax.i32(i32 %.2105158, i32 0)
  %i.id = shl i32 %i.ic, 23
  %i.ie = and i32 %i.id, 528482304
  %i.if = or disjoint i32 %7, %i.ie
  %i.ig = zext nneg i32 %i.if to i64
  %i.ih = call i32 @llvm.smax.i32(i32 %.1102156, i32 0)
  %i.ii = and i32 %i.ih, 63
  %i.ij = zext nneg i32 %i.ii to i64
  %i.ik = shl nuw nsw i64 %i.ij, 32
  %i.il = or disjoint i64 %i.ik, %i.ig
  %i.im = or disjoint i64 %i.il, 1924145348608
  store i64 %i.im, ptr %i.hq, align 8
  %i.in = call fastcc i64 @time_init_vtm(i64 noundef %1, ptr noundef nonnull byval(%struct.vtm) align 8 %5, i64 noundef %.1166) ; 0 uses
...
bb.aa:                                            ; preds = %bb.z, %rb_num2int_inline.exit70
  %.056.a = phi i32 [ %i.em, %bb.z ], [ %i.ei, %rb_num2int_inline.exit70 ] ; 2 uses
  %i.en = sdiv i32 %.056.a, 36524
  %i.eo = srem i32 %.056.a, 36524                 ; 5 uses
...
bb.aj:                                            ; preds = %bb.ai, %bb.ag, %bb.ac, %bb.y
  %.3.a = phi i32 [ 2000, %bb.y ], [ %i.et, %bb.ac ], [ %i.fc, %bb.ag ], [ %i.fh, %bb.ai ] ; 2 uses
  %.0 = phi i32 [ %i.el, %bb.y ], [ %i.eu, %bb.ac ], [ %i.fd, %bb.ag ], [ %.sext86, %bb.ai ] ; 2 uses
  %i.fi = add nsw i32 %.0, 1
  ...
  %i.fp = sext i32 %.3.a to i64                   ; 4 uses
...
bb.c:                                             ; preds = %rb_localtime_r.exit
  ...
  %.083 = tail call i64 @llvm.abs.i64(i64 %i.f, i1 false) ; 3 uses
  %.082 = select i1 %i.g, i32 1, i32 -1           ; 3 uses
  %i.h = srem i64 %.083, 60                       ; 2 uses
  %i.i = sdiv i64 %.083, 60
  %i.j = srem i64 %i.i, 60
  %i.k = trunc nsw i64 %i.j to i32
  %i.l = sdiv i64 %.083, 3600
  %i.m = trunc i64 %i.l to i32
  %i.n = mul nsw i32 %.082, %i.k                  ; 3 uses
  %i.o = mul i32 %.082, %i.m                      ; 3 uses
  %.not = icmp eq i64 %i.h, 0
  br i1 %.not, label %bb.f, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.p = trunc nsw i64 %i.h to i32
  %i.q = mul nsw i32 %.082, %i.p
