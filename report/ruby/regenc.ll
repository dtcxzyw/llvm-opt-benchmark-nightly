...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check34 = icmp ult i32 %i.aj, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load36 = load <16 x i8>, ptr %i.ap, align 1, !tbaa !26
  %i.aq = getelementptr i8, ptr %next.gep35, i64 16
  store <16 x i8> %wide.load, ptr %next.gep35, align 1, !tbaa !26
  store <16 x i8> %wide.load36, ptr %i.aq, align 1, !tbaa !26
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec40 = and i64 %i.ak, 2147483644            ; 5 uses
  %i.as = trunc nuw nsw i64 %n.vec40 to i32
  %i.at = getelementptr i8, ptr %i.b, i64 %n.vec40
  %i.au = getelementptr i8, ptr %4, i64 %n.vec40
