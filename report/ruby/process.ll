...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.br = call i64 @rb_check_array_type(i64 noundef %2) #26 ; 5 uses
...
bb.t:                                             ; preds = %bb.m
  %i.ch = call i64 @rb_to_int(i64 noundef %2) #26 ; 2 uses
...
bb.y:                                             ; preds = %bb.x
  %i.cy = icmp eq i64 %2, 20
  br i1 %i.cy, label %bb.ad, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.cz = trunc i64 %2 to i1
  br i1 %i.cz, label %bb.aa, label %bb.ab

bb.aa:                                            ; preds = %bb.z
  %i.da = call i64 @rb_fix2int(i64 noundef %2) #26
  br label %rb_num2int_inline.exit

bb.ab:                                            ; preds = %bb.z
  %i.db = call i64 @rb_num2int(i64 noundef %2) #26
  br label %rb_num2int_inline.exit
...
bb.an:                                            ; preds = %bb.al
  %i.eg = call i64 @rb_get_path(i64 noundef %2) #26
...
bb.ap:                                            ; preds = %bb.ao
  %i.et = call i64 @rb_num2uint(i64 noundef %2) #26
...
check_uid_switch.exit:                            ; preds = %bb.be
  %i.gf = call fastcc i32 @obj2uid0(i64 noundef %2)
...
check_gid_switch.exit:                            ; preds = %bb.bj
  %i.gq = call fastcc i32 @obj2gid0(i64 noundef %2)
...
rb_type.exit.thread74:                            ; preds = %rb_type.exit.thread74.sink.split, %bb.f, %rb_type.exit, %rb_type.exit, %rb_type.exit
  ...
  store i64 %2, ptr %i.a, align 8, !tbaa !47
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #26
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #26
  %i.hl = icmp eq i64 %2, 0
  %i.hm = and i64 %2, 7
...
bb.br:                                            ; preds = %rb_type.exit.thread74
  %i.hp = call i64 @llvm.fshl.i64(i64 %2, i64 %2, i64 62)
...
rb_type.exit.i:                                   ; preds = %rb_type.exit.thread74
  %i.ht = inttoptr i64 %2 to ptr                  ; 3 uses
...
bb.cc:                                            ; preds = %rb_type.exit.thread.i, %rb_type.exit.i
  %i.iu = phi i64 [ %i.nl, %rb_type.exit.thread.i ], [ %2, %rb_type.exit.i ]
...
rb_type.exit.thread79.i:                          ; preds = %bb.cc, %rb_type.exit.i, %bb.bs
  %i.iw = phi i64 [ %2, %bb.bs ], [ %i.iv, %bb.cc ], [ %2, %rb_type.exit.i ]
...
bb.cd:                                            ; preds = %rb_type.exit.i
  %i.ja = call i64 @rb_ary_entry(i64 noundef %2, i64 noundef 0) #27 ; 7 uses
...
bb.ci:                                            ; preds = %RB_SYMBOL_P.exit.thread.i
  %i.jv = call i64 @rb_ary_entry(i64 noundef %2, i64 noundef 1) #27
...
begin_hunk_15_@rb_execarg_addopt:bb.a
  ...
  %i.kc = call i64 @rb_ary_entry(i64 noundef %2, i64 noundef 1) #27 ; 6 uses
...
bb.cl:                                            ; preds = %rbimpl_RB_TYPE_P_fastpath.exit67.thread.i, %bb.ck, %RB_SYMBOL_P.exit.thread81.i
  ...
  %i.ks = call i64 @rb_ary_entry(i64 noundef %2, i64 noundef 2) #27 ; 2 uses
...
bb.co:                                            ; preds = %rb_type.exit.i
  ...
  %i.lh = call i64 @rb_get_path(i64 noundef %2) #26
...
rb_type.exit.thread.i:                            ; preds = %rb_type.exit.i, %bb.bt, %bb.br, %bb.br, %bb.br, %bb.br
  %i.nl = call i64 @rb_io_check_io(i64 noundef %2) #26 ; 2 uses
