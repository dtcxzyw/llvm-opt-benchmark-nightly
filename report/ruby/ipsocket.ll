...
bb.dy:                                            ; preds = %bb.dw
  ...
  %.4481.in.a = getelementptr inbounds nuw i8, ptr %i.f, i64 %.4475.in.v
  %.4475 = load i64, ptr %.4481.in.a, align 8, !tbaa !17
  %.4481.in = getelementptr inbounds nuw i8, ptr %i.f, i64 %.4481.in.v
  %.4481 = load i64, ptr %.4481.in, align 8, !tbaa !17
...
bb.fj:                                            ; preds = %bb.fh
  ...
  %.5482.in.a = getelementptr inbounds nuw i8, ptr %i.f, i64 %.5476.in.v
  %.5476 = load i64, ptr %.5482.in.a, align 8, !tbaa !17
  %.5482.in = getelementptr inbounds nuw i8, ptr %i.f, i64 %.5482.in.v
  %.5482 = load i64, ptr %.5482.in, align 8, !tbaa !17
