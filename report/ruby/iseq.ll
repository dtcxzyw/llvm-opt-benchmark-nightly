...
.lr.ph:                                           ; preds = %bb.g, %encoded_iseq_trace_instrument.exit
  ...
  %i.ag = zext i32 %.029 to i64                   ; 2 uses
...
bb.j:                                             ; preds = %bb.h
  %i.ay = add nsw i32 %.029, -54                  ; 2 uses
...
begin_hunk_2_@rb_iseq_trace_set:bb.a
  ...
  %.not.i.i.i.i = sub nsw i64 53, %i.ag
  %2 = and i64 %.not.i.i.i.i, 63
  %i.bt = shl i64 %i.bs, %2
...
begin_hunk_4_@rb_iseq_line_no:bb.a
  ...
  %.not.i.i.i = sub i64 53, %1
  %2 = and i64 %.not.i.i.i, 63
  %i.ao = shl i64 %i.an, %2
...
bb.e:                                             ; preds = %bb.c
  %i.av = add nsw i32 %i.aj, -54                  ; 2 uses
...
begin_hunk_13_@rb_iseq_disasm_insn:bb.a
  ...
  %.not.i.i.i.i = sub i64 53, %2
  %5 = and i64 %.not.i.i.i.i, 63
  %i.bq = shl i64 %i.bp, %5
...
begin_hunk_15_@rb_iseq_disasm_insn:bb.a
  ...
  %.not.i.i.i.i92 = sub i64 54, %2
  %6 = and i64 %.not.i.i.i.i92, 63
  %i.dl = shl i64 %i.dk, %6
...
bb.t:                                             ; preds = %bb.r
  %i.eu = add nsw i32 %i.ei, -54                  ; 2 uses
...
begin_hunk_17_@rb_iseq_disasm_insn:bb.a
  ...
  %.not.i.i.i.i101 = sub i64 53, %2
  %7 = and i64 %.not.i.i.i.i101, 63
  %i.fp = shl i64 %i.fo, %7
...
bb.b:                                             ; preds = %encoded_iseq_trace_instrument.exit.i, %.lr.ph.i
  ...
  %i.s = zext i32 %.038.i to i64                  ; 2 uses
  %.val.i = load ptr, ptr %i.j, align 8, !tbaa !18 ; 3 uses
...
bb.e:                                             ; preds = %bb.c
  %i.ak = add nsw i32 %.038.i, -54                ; 2 uses
...
begin_hunk_20_@iseq_add_local_tracepoint_i:bb.a
  ...
  %.not.i.i.i.i = sub nsw i64 53, %i.s
  %2 = and i64 %.not.i.i.i.i, 63
  %i.bf = shl i64 %i.be, %2
...
bb.g:                                             ; preds = %encoded_iseq_trace_instrument.exit.i, %.lr.ph.i
  ...
  %i.ak = zext i32 %.02533.i to i64               ; 2 uses
...
bb.j:                                             ; preds = %bb.h
  %i.bd = add nsw i32 %.02533.i, -54              ; 2 uses
...
begin_hunk_23_@iseq_remove_local_tracepoint_i:bb.a
  ...
  %.not.i.i.i.i.i = sub nsw i64 53, %i.ak
  %2 = and i64 %.not.i.i.i.i.i, 63
  %i.by = shl i64 %i.bx, %2
...
begin_hunk_24_@iseq_data_to_ary:bb.a
  ...
  %i.rg = zext i32 %.0342 to i64                  ; 2 uses
...
bb.ce:                                            ; preds = %bb.cc
  %i.sb = add nsw i32 %.0342, -54                 ; 2 uses
...
begin_hunk_26_@iseq_data_to_ary:bb.a
  ...
  %.not.i.i.i = sub nsw i64 53, %i.rg
  %1 = and i64 %.not.i.i.i, 63
  %i.sw = shl i64 %i.sv, %1
