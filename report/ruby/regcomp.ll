...
common.ret25:                                     ; preds = %bb.f, %bb.e, %bb.c, %bb.d, %tailrecurse, %.split, %bb.g, %bb.m
  %common.ret25.op = phi i32 [ %spec.select, %bb.m ], [ %i.d, %bb.c ], [ 1, %bb.f ], [ %i.k, %bb.e ], [ %.135, %bb.d ], [ 0, %tailrecurse ], [ 0, %.split ], [ 0, %bb.g ]
...
tailrecurse.backedge:                             ; preds = %tailrecurse, %bb.e, %bb.g, %.split
  %.sink = phi i64 [ 24, %bb.e ], [ 8, %.split ], [ 24, %bb.g ], [ 8, %tailrecurse ]
...
tailrecurse.backedge.sink.split:                  ; preds = %tailrecurse, %bb.d, %bb.f
  %.sink63 = phi i64 [ 24, %bb.d ], [ 24, %bb.f ], [ 8, %tailrecurse ]
...
.critedge:                                        ; preds = %bb.e, %bb.l, %tailrecurse, %.lr.ph.i, %bb.c, %bb.b, %._crit_edge.i, %bb.g
  %.1 = phi i32 [ -208, %.lr.ph.i ], [ 0, %._crit_edge.i ], [ 0, %bb.c ], [ -209, %bb.g ], [ %i.d, %bb.b ], [ -208, %bb.e ], [ 0, %tailrecurse ], [ 0, %bb.l ]
  ret i32 %.1
}
...
common.ret117:                                    ; preds = %bb.j, %bb.k, %bb.h, %.thread, %bb.m, %bb.o, %bb.i, %.preheader, %tailrecurse, %.split, %bb.l, %bb.p
  %common.ret117.op = phi i32 [ %i.ar, %bb.p ], [ %i.p, %.preheader ], [ %i.an, %bb.o ], [ %.0.ph, %.thread ], [ %i.x, %bb.j ], [ 0, %bb.m ], [ %spec.select77, %bb.k ], [ %i.h, %bb.h ], [ %i.s, %bb.i ], [ 0, %tailrecurse ], [ 0, %.split ], [ 0, %bb.l ]
...
.critedge:                                        ; preds = %tailrecurse, %bb.d, %bb.e, %bb.c, %bb.b, %.split, %.critedge.loopexit38
  %.1 = phi i32 [ 0, %.split ], [ %spec.select, %bb.b ], [ 0, %bb.d ], [ 0, %tailrecurse ], [ 0, %bb.e ], [ 3, %bb.c ], [ 2, %.critedge.loopexit38 ]
  ret i32 %.1
}
...
bb.a:
  %i.a = load i32, ptr %0, align 8, !tbaa !34     ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a, %tailrecurse.backedge
  ...
  %.tr48 = phi ptr [ %.tr.be, %tailrecurse.backedge ], [ %0, %bb.a ] ; 5 uses
...
tailrecurse.backedge.sink.split:                  ; preds = %.lr.ph, %bb.d
  %.sink63 = phi i64 [ 24, %bb.d ], [ 8, %.lr.ph ]
  %i.l = getelementptr i8, ptr %.tr48, i64 %.sink63
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !34
  br label %tailrecurse.backedge

tailrecurse.backedge:                             ; preds = %tailrecurse.backedge.sink.split, %bb.f
  %.tr.be = phi ptr [ %i.z, %bb.f ], [ %i.m, %tailrecurse.backedge.sink.split ] ; 2 uses
...
.critedge41:                                      ; preds = %tailrecurse.backedge, %bb.e, %.lr.ph, %bb.f, %bb.d, %bb.c, %bb.b, %bb.a
  %.1 = phi i32 [ 0, %bb.c ], [ 1, %bb.a ], [ 1, %bb.b ], [ 1, %bb.e ], [ 0, %bb.f ], [ 1, %tailrecurse.backedge ], [ 0, %.lr.ph ], [ 1, %bb.d ]
  ret i32 %.1
}
