...
vector.ph1002:                                    ; preds = %vector.main.loop.iter.check1000
  ...
  %n.vec1004 = and i64 %i.dx, 8589934560          ; 5 uses
  %.cast1005 = trunc i64 %n.vec1004 to i32        ; 2 uses
...
vec.epilog.ph1024:                                ; preds = %vector.main.loop.iter.check1000, %vec.epilog.iter.check1022
  ...
  %n.vec1026 = and i64 %i.dx, 8589934588          ; 4 uses
  %.cast1027 = trunc i64 %n.vec1026 to i32        ; 2 uses
...
.lr.ph.i.i.preheader:                             ; preds = %vector.memcheck996, %vector.scevcheck993, %iter.check1020, %vec.epilog.iter.check1022, %vec.epilog.middle.block1035
  ...
  %.04045.i.i.ph = phi i32 [ 0, %iter.check1020 ], [ 0, %vector.scevcheck993 ], [ 0, %vector.memcheck996 ], [ %.cast1005, %vec.epilog.iter.check1022 ], [ %.cast1027, %vec.epilog.middle.block1035 ]
  br label %.lr.ph.i.i
...
vector.ph955:                                     ; preds = %vector.main.loop.iter.check953
  ...
  %n.vec957 = and i64 %i.gk, 8589934560           ; 5 uses
  %.cast958 = trunc i64 %n.vec957 to i32          ; 2 uses
...
vec.epilog.ph977:                                 ; preds = %vector.main.loop.iter.check953, %vec.epilog.iter.check975
  ...
  %n.vec979 = and i64 %i.gk, 8589934588           ; 4 uses
  %.cast980 = trunc i64 %n.vec979 to i32          ; 2 uses
...
.lr.ph.i88.i.preheader:                           ; preds = %vector.memcheck949, %vector.scevcheck946, %iter.check973, %vec.epilog.iter.check975, %vec.epilog.middle.block988
  ...
  %.04045.i91.i.ph = phi i32 [ 0, %iter.check973 ], [ 0, %vector.scevcheck946 ], [ 0, %vector.memcheck949 ], [ %.cast958, %vec.epilog.iter.check975 ], [ %.cast980, %vec.epilog.middle.block988 ]
...
vector.ph908:                                     ; preds = %vector.main.loop.iter.check906
  ...
  %n.vec910 = and i64 %i.no, 8589934560           ; 5 uses
  %i.nz = getelementptr i8, ptr %.034.i, i64 %n.vec910 ; 2 uses
  %.cast911 = trunc i64 %n.vec910 to i32          ; 2 uses
...
vec.epilog.ph930:                                 ; preds = %vector.main.loop.iter.check906, %vec.epilog.iter.check928
  ...
  %n.vec932 = and i64 %i.no, 8589934588           ; 4 uses
  %i.og = getelementptr i8, ptr %.034.i, i64 %n.vec932 ; 2 uses
  %.cast933 = trunc i64 %n.vec932 to i32          ; 2 uses
...
.lr.ph.i.preheader:                               ; preds = %vector.memcheck902, %vector.scevcheck899, %iter.check926, %vec.epilog.iter.check928, %vec.epilog.middle.block941
  ...
  %.02629.i.ph = phi i32 [ 0, %iter.check926 ], [ 0, %vector.scevcheck899 ], [ 0, %vector.memcheck902 ], [ %.cast911, %vec.epilog.iter.check928 ], [ %.cast933, %vec.epilog.middle.block941 ]
  br label %.lr.ph.i
...
vector.ph861:                                     ; preds = %vector.main.loop.iter.check859
  ...
  %n.vec863 = and i64 %i.qu, 8589934560           ; 5 uses
  %i.rf = getelementptr i8, ptr %.034.i332, i64 %n.vec863 ; 2 uses
  %.cast864 = trunc i64 %n.vec863 to i32          ; 2 uses
...
vec.epilog.ph883:                                 ; preds = %vector.main.loop.iter.check859, %vec.epilog.iter.check881
  ...
  %n.vec885 = and i64 %i.qu, 8589934588           ; 4 uses
  %i.rm = getelementptr i8, ptr %.034.i332, i64 %n.vec885 ; 2 uses
  %.cast886 = trunc i64 %n.vec885 to i32          ; 2 uses
...
.lr.ph.i338.preheader:                            ; preds = %vector.memcheck855, %vector.scevcheck852, %iter.check879, %vec.epilog.iter.check881, %vec.epilog.middle.block894
  ...
  %.02629.i341.ph = phi i32 [ 0, %iter.check879 ], [ 0, %vector.scevcheck852 ], [ 0, %vector.memcheck855 ], [ %.cast864, %vec.epilog.iter.check881 ], [ %.cast886, %vec.epilog.middle.block894 ]
  br label %.lr.ph.i338
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %n.vec = and i64 %i.ade, 8589934560             ; 5 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec840 = and i64 %i.ade, 8589934588          ; 4 uses
  %.cast841 = trunc i64 %n.vec840 to i32          ; 2 uses
...
.lr.ph.i364.preheader:                            ; preds = %vector.memcheck, %vector.scevcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  %.04045.i.ph = phi i32 [ 0, %iter.check ], [ 0, %vector.scevcheck ], [ 0, %vector.memcheck ], [ %.cast, %vec.epilog.iter.check ], [ %.cast841, %vec.epilog.middle.block ]
  br label %.lr.ph.i364
