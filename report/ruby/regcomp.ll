...
bb.a:
  ...
  %5 = ptrtoaddr ptr %4 to i64                    ; 4 uses
  ...
  %9 = ptrtoaddr ptr %8 to i64                    ; 2 uses
...
bb.n:                                             ; preds = %.loopexit.i.i, %.lr.ph51.i.i
  ...
  %.03849.i.i968 = ptrtoaddr ptr %.03849.i.i to i64 ; 3 uses
...
bb.v:                                             ; preds = %.loopexit.i85.i, %.lr.ph51.i81.i
  ...
  %.03849.i83.i928 = ptrtoaddr ptr %.03849.i83.i to i64 ; 3 uses
...
bb.bp:                                            ; preds = %.loopexit.i, %.lr.ph35.i
  ...
  %.034.i888 = ptrtoaddr ptr %.034.i to i64       ; 3 uses
...
bb.ca:                                            ; preds = %.loopexit.i335, %.lr.ph35.i331
  ...
  %.034.i332848 = ptrtoaddr ptr %.034.i332 to i64 ; 3 uses
...
bb.ei:                                            ; preds = %.loopexit.i362, %.lr.ph51.i
  ...
  %.03849.i831 = ptrtoaddr ptr %.03849.i to i64   ; 3 uses
