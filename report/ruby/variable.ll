...
.lr.ph.preheader.i:                               ; preds = %bb.t
  %5 = getelementptr i8, ptr %.128.i, i64 %i.am
  %scevgep.i = getelementptr i8, ptr %5, i64 %4
  %6 = sub i64 0, %.12843.i
  %scevgep44.i = getelementptr i8, ptr %scevgep.i, i64 %6 ; 2 uses
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %bb.u, %.lr.ph.preheader.i
  %.22940.i = phi ptr [ %i.bf, %bb.u ], [ %.128.i, %.lr.ph.preheader.i ] ; 3 uses
  %i.be = load i8, ptr %.22940.i, align 1, !tbaa !42
  %.not35.i = icmp eq i8 %i.be, 58
  br i1 %.not35.i, label %.critedge.i, label %bb.u

bb.u:                                             ; preds = %.lr.ph.i
  %i.bf = getelementptr i8, ptr %.22940.i, i64 1  ; 2 uses
  %exitcond.not.i = icmp eq ptr %i.bf, %scevgep44.i
...
.preheader.preheader:                             ; preds = %bb.f
  ...
  %2 = getelementptr i8, ptr %.033, i64 %i.o
  %scevgep = getelementptr i8, ptr %2, i64 %1
  %3 = sub i64 0, %.03355
  %scevgep56 = getelementptr i8, ptr %scevgep, i64 %3 ; 3 uses
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %bb.g
  %.13451 = phi ptr [ %i.y, %bb.g ], [ %.033, %.preheader.preheader ] ; 9 uses
  %i.x = load i8, ptr %.13451, align 1, !tbaa !42
  %.not = icmp eq i8 %i.x, 58
  br i1 %.not, label %bb.h, label %bb.g

bb.g:                                             ; preds = %.preheader
  %i.y = getelementptr i8, ptr %.13451, i64 1     ; 2 uses
  %exitcond.not = icmp eq ptr %i.y, %scevgep56
  br i1 %exitcond.not, label %.critedge, label %.preheader, !llvm.loop !54

.critedge:                                        ; preds = %bb.g
  %i.z = ptrtoint ptr %scevgep56 to i64
...
bb.l:                                             ; preds = %.critedge, %bb.k, %bb.h
  ...
  %.2 = phi ptr [ %i.an, %bb.k ], [ %.13451, %bb.h ], [ %scevgep56, %.critedge ] ; 4 uses
