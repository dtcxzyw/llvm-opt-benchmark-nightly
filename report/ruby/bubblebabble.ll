...
begin_hunk_0_@rb_digest_s_bubblebabble:bb.a
  ...
  %i.q = call i64 @rb_str_new(ptr noundef null, i64 noundef %i.p) #4, !callees !17, !inline_history !18 ; 2 uses
...
begin_hunk_1_@rb_digest_class_s_bubblebabble:bb.a
  ...
  %i.s = call i64 @rb_str_new(ptr noundef null, i64 noundef %i.r) #4, !callees !17, !inline_history !18 ; 2 uses
