...
begin_hunk_1_@debug_info_reader_read_value:bb.a
  ...
  %4 = load ptr, ptr %i.m, align 8, !tbaa !81
  %i.s = getelementptr i8, ptr %4, i64 %i.p
  store ptr %i.s, ptr %i.m, align 8, !tbaa !81
  br label %bb.bx

bb.f:                                             ; preds = %bb.a
  %i.t = getelementptr i8, ptr %0, i64 96         ; 4 uses
...
begin_hunk_2_@debug_info_reader_read_value:bb.a
  ...
  %5 = load ptr, ptr %i.t, align 8, !tbaa !81
...
bb.l:                                             ; preds = %bb.a
  %i.bs = getelementptr i8, ptr %0, i64 96        ; 4 uses
...
begin_hunk_4_@debug_info_reader_read_value:bb.a
  ...
  %6 = load ptr, ptr %i.bs, align 8, !tbaa !81
  %i.bz = getelementptr i8, ptr %6, i64 %i.bw
