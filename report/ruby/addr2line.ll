...
bb.dj:                                            ; preds = %.cont.i
  ...
  %.val.i3.i.i65.i.i = load i64, ptr %i.ys, align 1 ; 2 uses
  %.val.i3.i.i19166.i.i = load i64, ptr %i.yt, align 1 ; 2 uses
  %i.yu = icmp ne i64 %.val.i3.i.i65.i.i, 0
  %i.yv = icmp ne i64 %.val.i3.i.i19166.i.i, 0
  %or.cond67.i.i = select i1 %i.yu, i1 true, i1 %i.yv
...
.lr.ph.i.i:                                       ; preds = %bb.dj, %bb.dl
  ...
  %.pn71.i.i = phi ptr [ %i.yw, %bb.dl ], [ %i.ys, %bb.dj ] ; 2 uses
  ...
  %i.yw = getelementptr i8, ptr %.pn71.i.i, i64 16 ; 2 uses
  %i.yx = icmp eq i64 %.val.i3.i.i69.i.i, -1
  br i1 %i.yx, label %bb.dl, label %bb.dk

bb.dk:                                            ; preds = %.lr.ph.i.i
  %i.yy = add i64 %.37068.i.i, %.val.i3.i.i69.i.i ; 2 uses
...
bb.dl:                                            ; preds = %bb.dk, %.lr.ph.i.i
  ...
  %i.zb = getelementptr i8, ptr %.pn71.i.i, i64 24
...
end_hunk_1
begin_hunk_2_@di_read_die:bb.a

.lr.ph.i19.i61.i:                                 ; preds = %bb.j, %.lr.ph.i19.i61.i
  %i.en = phi ptr [ %i.eo, %.lr.ph.i19.i61.i ], [ %i.ek, %bb.j ] ; 2 uses
  %i.eo = getelementptr i8, ptr %i.en, i64 1      ; 2 uses
  %i.ep = load i8, ptr %i.en, align 1, !tbaa !14
  %i.eq = icmp sgt i8 %i.ep, -1
  br i1 %i.eq, label %sleb128.exit.i60.i.backedge, label %.lr.ph.i19.i61.i

di_skip_die_attributes.exit62.i:                  ; preds = %uleb128.exit17.i52.i
  %i.er = getelementptr i8, ptr %.5.i, i64 1      ; 2 uses
  %i.es = load i8, ptr %.5.i, align 1, !tbaa !14  ; 3 uses
  %i.et = icmp sgt i8 %i.es, -1
  br i1 %i.et, label %uleb128.exit73.i, label %.lr.ph.i64.i

.lr.ph.i64.i:                                     ; preds = %di_skip_die_attributes.exit62.i, %.lr.ph.i64.i
  %i.eu = phi i8 [ %i.fc, %.lr.ph.i64.i ], [ %i.es, %di_skip_die_attributes.exit62.i ]
  %i.ev = phi ptr [ %i.fb, %.lr.ph.i64.i ], [ %i.er, %di_skip_die_attributes.exit62.i ] ; 2 uses
  %.01020.i65.i = phi i64 [ %.1.i67.i, %.lr.ph.i64.i ], [ 0, %di_skip_die_attributes.exit62.i ]
  %.01119.i66.i = phi i32 [ %i.fa, %.lr.ph.i64.i ], [ 0, %di_skip_die_attributes.exit62.i ] ; 2 uses
  %i.ew = and i8 %i.eu, 127
  %i.ex = zext nneg i8 %i.ew to i32
  %i.ey = shl i32 %i.ex, %.01119.i66.i
  %i.ez = sext i32 %i.ey to i64
  %i.fa = add i32 %.01119.i66.i, 7                ; 2 uses
  %.1.i67.i = add i64 %.01020.i65.i, %i.ez        ; 2 uses
  %i.fb = getelementptr i8, ptr %i.ev, i64 1      ; 2 uses
  %i.fc = load i8, ptr %i.ev, align 1, !tbaa !14  ; 3 uses
  %i.fd = icmp sgt i8 %i.fc, -1
  br i1 %i.fd, label %._crit_edge.loopexit.i68.i, label %.lr.ph.i64.i

._crit_edge.loopexit.i68.i:                       ; preds = %.lr.ph.i64.i
  %i.fe = zext nneg i32 %i.fa to i64
  br label %uleb128.exit73.i

uleb128.exit73.i:                                 ; preds = %._crit_edge.loopexit.i68.i, %di_skip_die_attributes.exit62.i
  %.6.i = phi ptr [ %i.er, %di_skip_die_attributes.exit62.i ], [ %i.fb, %._crit_edge.loopexit.i68.i ] ; 2 uses
  %.011.lcssa.i69.i = phi i64 [ 0, %di_skip_die_attributes.exit62.i ], [ %i.fe, %._crit_edge.loopexit.i68.i ]
  %.010.lcssa.i70.i = phi i64 [ 0, %di_skip_die_attributes.exit62.i ], [ %.1.i67.i, %._crit_edge.loopexit.i68.i ]
  %.lcssa.i71.i = phi i8 [ %i.es, %di_skip_die_attributes.exit62.i ], [ %i.fc, %._crit_edge.loopexit.i68.i ]
  %i.ff = zext nneg i8 %.lcssa.i71.i to i64
  %i.fg = shl i64 %i.ff, %.011.lcssa.i69.i
  %.117.i72.i = add i64 %i.fg, %.010.lcssa.i70.i  ; 2 uses
  %.not.i = icmp eq i64 %.117.i, %.117.i72.i
  br i1 %.not.i, label %di_find_abbrev.exit, label %.lr.ph.i19, !llvm.loop !134

di_find_abbrev.exit:                              ; preds = %uleb128.exit73.i, %bb.d, %uleb128.exit25.i
  %.1.i20 = phi ptr [ %i.z, %bb.d ], [ %.3.i, %uleb128.exit25.i ], [ %.6.i, %uleb128.exit73.i ] ; 4 uses
  %i.fh = getelementptr i8, ptr %0, i64 128       ; 4 uses
  store ptr %.1.i20, ptr %i.fh, align 8, !tbaa !117
  %.not = icmp eq ptr %.1.i20, null
  br i1 %.not, label %bb.m, label %bb.k

bb.k:                                             ; preds = %di_find_abbrev.exit
  %i.fi = load ptr, ptr %0, align 8, !tbaa !80
  %i.fj = getelementptr i8, ptr %i.fi, i64 72
  %i.fk = load ptr, ptr %i.fj, align 8, !tbaa !76
  %i.fl = ptrtoint ptr %i.p to i64
  %i.fm = ptrtoint ptr %i.fk to i64
  %i.fn = xor i64 %i.fm, -1
  %i.fo = add i64 %i.fn, %i.fl
  store i64 %i.fo, ptr %1, align 8, !tbaa !135
  %i.fp = getelementptr i8, ptr %.1.i20, i64 1    ; 3 uses
  store ptr %i.fp, ptr %i.fh, align 8, !tbaa !64
  %i.fq = load i8, ptr %.1.i20, align 1, !tbaa !14 ; 3 uses
  %i.fr = icmp sgt i8 %i.fq, -1
  br i1 %i.fr, label %uleb128.exit31, label %.lr.ph.i22

.lr.ph.i22:                                       ; preds = %bb.k, %.lr.ph.i22
  %i.fs = phi i8 [ %i.ga, %.lr.ph.i22 ], [ %i.fq, %bb.k ]
  %i.ft = phi ptr [ %i.fz, %.lr.ph.i22 ], [ %i.fp, %bb.k ] ; 2 uses
  %.01020.i23 = phi i64 [ %.1.i25, %.lr.ph.i22 ], [ 0, %bb.k ]
  %.01119.i24 = phi i32 [ %i.fy, %.lr.ph.i22 ], [ 0, %bb.k ] ; 2 uses
  %i.fu = and i8 %i.fs, 127
  %i.fv = zext nneg i8 %i.fu to i32
  %i.fw = shl i32 %i.fv, %.01119.i24
  %i.fx = zext i32 %i.fw to i64
  %i.fy = add i32 %.01119.i24, 7                  ; 2 uses
  %.1.i25 = add i64 %.01020.i23, %i.fx            ; 2 uses
  %i.fz = getelementptr i8, ptr %i.ft, i64 1      ; 3 uses
  store ptr %i.fz, ptr %i.fh, align 8, !tbaa !64
  %i.ga = load i8, ptr %i.ft, align 1, !tbaa !14  ; 3 uses
  %i.gb = icmp sgt i8 %i.ga, -1
  br i1 %i.gb, label %._crit_edge.loopexit.i26, label %.lr.ph.i22

._crit_edge.loopexit.i26:                         ; preds = %.lr.ph.i22
  %i.gc = zext nneg i32 %i.fy to i64
  br label %uleb128.exit31

uleb128.exit31:                                   ; preds = %bb.k, %._crit_edge.loopexit.i26
  %i.gd = phi ptr [ %i.fp, %bb.k ], [ %i.fz, %._crit_edge.loopexit.i26 ] ; 2 uses
  %.011.lcssa.i27 = phi i64 [ 0, %bb.k ], [ %i.gc, %._crit_edge.loopexit.i26 ]
  %.010.lcssa.i28 = phi i64 [ 0, %bb.k ], [ %.1.i25, %._crit_edge.loopexit.i26 ]
  %.lcssa.i29 = phi i8 [ %i.fq, %bb.k ], [ %i.ga, %._crit_edge.loopexit.i26 ]
  %i.ge = zext nneg i8 %.lcssa.i29 to i64
  %i.gf = shl i64 %i.ge, %.011.lcssa.i27
  %.117.i30 = add i64 %i.gf, %.010.lcssa.i28
  %i.gg = trunc i64 %.117.i30 to i32
  %i.gh = getelementptr i8, ptr %1, i64 8
  store i32 %i.gg, ptr %i.gh, align 8, !tbaa !99
  %i.gi = getelementptr i8, ptr %i.gd, i64 1
  store ptr %i.gi, ptr %i.fh, align 8, !tbaa !117
  %i.gj = load i8, ptr %i.gd, align 1, !tbaa !14  ; 2 uses
  %i.gk = sext i8 %i.gj to i32
  %i.gl = getelementptr i8, ptr %1, i64 12
  store i32 %i.gk, ptr %i.gl, align 4, !tbaa !136
  %.not18 = icmp eq i8 %i.gj, 0
  br i1 %.not18, label %bb.m, label %bb.l

bb.l:                                             ; preds = %uleb128.exit31
  %i.gm = getelementptr i8, ptr %0, i64 144       ; 2 uses
  %i.gn = load i32, ptr %i.gm, align 8, !tbaa !92
  %i.go = add i32 %i.gn, 1
  store i32 %i.go, ptr %i.gm, align 8, !tbaa !92
  br label %bb.m

bb.m:                                             ; preds = %di_find_abbrev.exit.thread, %uleb128.exit31, %bb.l, %di_find_abbrev.exit, %bb.b
  %.0 = phi ptr [ null, %bb.b ], [ null, %di_find_abbrev.exit ], [ %1, %bb.l ], [ %1, %uleb128.exit31 ], [ null, %di_find_abbrev.exit.thread ]
  ret ptr %.0
}
...
bb.a:
  store ptr %.168.val, ptr %0, align 8, !tbaa !111
  %.not = icmp eq ptr %.168.val, null
  br i1 %.not, label %bb.f, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.a = load i32, ptr %.168.val, align 4, !tbaa !7 ; 2 uses
  %i.b = zext i32 %i.a to i64
  %i.c = getelementptr i8, ptr %0, i64 8          ; 2 uses
  store i64 %i.b, ptr %i.c, align 8, !tbaa !137
  %i.d = getelementptr i8, ptr %0, i64 16         ; 2 uses
  store i8 4, ptr %i.d, align 8, !tbaa !138
  %i.e = icmp eq i32 %i.a, -1
  br i1 %i.e, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %i.f = getelementptr i8, ptr %.168.val, i64 4
  %i.g = load i64, ptr %i.f, align 8, !tbaa !67
  store i64 %i.g, ptr %i.c, align 8, !tbaa !137
  store i8 8, ptr %i.d, align 8, !tbaa !138
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %i.h = phi i64 [ 12, %bb.c ], [ 4, %bb.b ]
  %i.i = getelementptr i8, ptr %.168.val, i64 %i.h
  %i.j = getelementptr i8, ptr %i.i, i64 2
  %i.k = load i8, ptr %i.j, align 1, !tbaa !14    ; 3 uses
  %i.l = getelementptr i8, ptr %0, i64 17
  store i8 %i.k, ptr %i.l, align 1, !tbaa !109
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.n = tail call i32 (ptr, i32, ptr, ...) @__fprintf_chk(ptr noundef %1, i32 noundef 1, ptr noundef nonnull @.str.18, i32 noundef %i.m) #15 ; 0 uses
  br label %bb.f

bb.f:                                             ; preds = %bb.d, %bb.d, %bb.a, %bb.e
  %.022 = phi i1 [ false, %bb.e ], [ true, %bb.a ], [ true, %bb.d ], [ true, %bb.d ]
  ret i1 %.022
}
...
bb.a:
  %i.a = load ptr, ptr %1, align 8, !tbaa !64     ; 3 uses
  %i.b = load i32, ptr %i.a, align 4, !tbaa !7    ; 2 uses
  %i.c = zext i32 %i.b to i64                     ; 2 uses
  store i64 %i.c, ptr %2, align 8, !tbaa !139
  %i.d = getelementptr i8, ptr %i.a, i64 4        ; 4 uses
  %i.e = getelementptr i8, ptr %2, i64 10         ; 2 uses
  store i8 4, ptr %i.e, align 2, !tbaa !95
  %.not81 = icmp eq i32 %i.b, -1
  br i1 %.not81, label %bb.b, label %.thread

bb.b:                                             ; preds = %bb.a
  %i.f = load i64, ptr %i.d, align 8, !tbaa !67   ; 2 uses
  store i64 %i.f, ptr %2, align 8, !tbaa !139
  %i.g = getelementptr i8, ptr %i.a, i64 12       ; 3 uses
  store i8 8, ptr %i.e, align 2, !tbaa !95
  %i.h = getelementptr i8, ptr %i.g, i64 %i.f     ; 2 uses
  %i.i = getelementptr i8, ptr %2, i64 56
  store ptr %i.h, ptr %i.i, align 8, !tbaa !93
  %i.j = load i16, ptr %i.g, align 4, !tbaa !131  ; 4 uses
  %i.k = getelementptr i8, ptr %2, i64 8
  store i16 %i.j, ptr %i.k, align 8, !tbaa !97
  %i.l = icmp ugt i16 %i.j, 5
...
.lr.ph:                                           ; preds = %bb.a, %uleb128.exit.1
  %.03691 = phi i32 [ %i.s, %uleb128.exit.1 ], [ 0, %bb.a ]
...
uleb128.exit.1:                                   ; preds = %.lr.ph.i.1, %uleb128.exit
  ...
  %i.s = add nuw nsw i32 %.03691, 2               ; 2 uses
...
.lr.ph.i44:                                       ; preds = %._crit_edge, %.lr.ph.i44
  ...
  %.01119.i46 = phi i32 [ %i.ac, %.lr.ph.i44 ], [ 0, %._crit_edge ] ; 2 uses
  %i.y = and i8 %i.w, 127
  %i.z = zext nneg i8 %i.y to i32
  %i.aa = shl i32 %i.z, %.01119.i46
  %i.ab = zext i32 %i.aa to i64
  %i.ac = add i32 %.01119.i46, 7                  ; 2 uses
  %.1.i47 = add i64 %.01020.i45, %i.ab            ; 2 uses
