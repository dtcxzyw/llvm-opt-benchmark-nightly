...
begin_hunk_0_@date_strftime_with_tmx:bb.a
  ...
  %or.cond47 = and i1 %i.beo, %i.bep              ; 7 uses
  %spec.store.select = select i1 %or.cond47, i32 1, i32 2 ; 6 uses
...
bb.fg:                                            ; preds = %bb.ff
  %4 = select i1 %or.cond47, i32 4, i32 5
...
bb.fi:                                            ; preds = %bb.fh
  %5 = select i1 %or.cond47, i32 5, i32 6
...
bb.fk:                                            ; preds = %bb.fj
  %6 = select i1 %or.cond47, i32 8, i32 9
...
bb.fn:                                            ; preds = %bb.fm
  %7 = select i1 %or.cond47, i32 2, i32 3
...
bb.fq:                                            ; preds = %bb.fp
  %8 = select i1 %or.cond47, i32 5, i32 6
...
bb.fs:                                            ; preds = %bb.fr
  %9 = select i1 %or.cond47, i32 8, i32 9
