...
ruby_nonempty_memcpy.exit:                        ; preds = %bb.a, %bb.b
  ...
  %.lhs.trunc3 = trunc i64 %1 to i16              ; 2 uses
  %4 = udiv i16 %.lhs.trunc3, 40
  %5 = udiv i16 %.lhs.trunc3, 2560
  %.zext6 = zext nneg i16 %5 to i64
  %6 = getelementptr [8 x i8], ptr %i.au, i64 %.zext6 ; 2 uses
  %7 = load i64, ptr %6, align 8, !tbaa !59       ; 2 uses
  %8 = and i16 %4, 63
  %9 = zext nneg i16 %8 to i64
  %10 = shl nuw i64 1, %9                         ; 2 uses
  %11 = xor i64 %10, -1
  %i.av = and i64 %7, %11
  %12 = or i64 %7, %10
  %.sink = select i1 %.not, i64 %i.av, i64 %12
  store i64 %.sink, ptr %6, align 8, !tbaa !59
  %i.aw = and i64 %i.h, %i.t
  %.not90.a = icmp eq i64 %i.aw, 0
  %i.ax = and i64 %1, -65536
  %i.ay = inttoptr i64 %i.ax to ptr
  %i.az = load ptr, ptr %i.ay, align 65536, !tbaa !113
  %i.ba = getelementptr i8, ptr %i.az, i64 280
  %.lhs.trunc7 = trunc i64 %1 to i16              ; 2 uses
  %13 = udiv i16 %.lhs.trunc7, 40
  %i.bb = udiv i16 %.lhs.trunc7, 2560
  %.zext10 = zext nneg i16 %i.bb to i64
  %14 = getelementptr [8 x i8], ptr %i.ba, i64 %.zext10 ; 2 uses
  %15 = load i64, ptr %14, align 8, !tbaa !59     ; 2 uses
  %i.bc = and i16 %13, 63
  ...
  %16 = and i64 %15, %i.bf
  %17 = or i64 %15, %i.be
  %.sink38 = select i1 %.not90.a, i64 %16, i64 %17
  store i64 %.sink38, ptr %14, align 8, !tbaa !59
  %18 = and i64 %i.m, %i.t
  %.not91 = icmp eq i64 %18, 0
  %19 = and i64 %1, -65536
  %20 = inttoptr i64 %19 to ptr
  %21 = load ptr, ptr %20, align 65536, !tbaa !113
  %22 = getelementptr i8, ptr %21, i64 72
  %.lhs.trunc11 = trunc i64 %1 to i16             ; 2 uses
  %23 = udiv i16 %.lhs.trunc11, 40
  %24 = udiv i16 %.lhs.trunc11, 2560
  %.zext14.a = zext nneg i16 %24 to i64
  %i.bg = getelementptr [8 x i8], ptr %22, i64 %.zext14.a ; 2 uses
  ...
  %.sink37.a = select i1 %.not91, i64 %i.bm, i64 %i.bn
  store i64 %.sink37.a, ptr %i.bg, align 8, !tbaa !59
  %25 = and i64 %i.p, %i.t
  %.not92 = icmp eq i64 %25, 0
  %26 = and i64 %1, -65536
  %27 = inttoptr i64 %26 to ptr                   ; 2 uses
  %28 = load ptr, ptr %27, align 65536, !tbaa !113
  %29 = getelementptr i8, ptr %28, i64 488
  %.lhs.trunc15 = trunc i64 %1 to i16             ; 3 uses
  %30 = udiv i16 %.lhs.trunc15, 40                ; 2 uses
  %31 = udiv i16 %.lhs.trunc15, 2560
  %.zext18.a = zext nneg i16 %31 to i64
  %i.bo = getelementptr [8 x i8], ptr %29, i64 %.zext18.a ; 2 uses
  ...
  %.sink39.a = select i1 %.not92, i64 %i.bu, i64 %i.bv
  store i64 %.sink39.a, ptr %i.bo, align 8, !tbaa !59
  %32 = lshr i64 %i.x, %i.ai
  %33 = load ptr, ptr %27, align 65536, !tbaa !113 ; 2 uses
  %34 = getelementptr i8, ptr %33, i64 1320
  %35 = shl nuw nsw i16 %30, 1
  %36 = and i16 %35, 62
  %37 = zext nneg i16 %36 to i64                  ; 2 uses
  %38 = shl nuw i64 3, %37
  %39 = xor i64 %38, -1
  %40 = udiv i16 %.lhs.trunc15, 1280
  %.zext8.i.i = zext nneg i16 %40 to i64
  %i.bw = getelementptr [8 x i8], ptr %34, i64 %.zext8.i.i ; 2 uses
  %i.bx = load i64, ptr %i.bw, align 8, !tbaa !59
  %i.by = and i64 %i.bx, %39
  %i.bz = and i64 %32, 3                          ; 2 uses
  %i.ca = shl nuw i64 %i.bz, %37
  ...
  %i.cm = getelementptr i8, ptr %33, i64 16
