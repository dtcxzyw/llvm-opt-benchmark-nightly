...
begin_hunk_1_@bary_pack:bb.a
  ...
  %i.mh = sub nuw nsw i32 8, %i.lz                ; 2 uses
  %8 = shl nsw i32 -1, %i.mh
  %9 = xor i32 %8, -1
  %i.mi = select i1 %i.ma, i32 %9, i32 0          ; 2 uses
...
bb.ao:                                            ; preds = %._crit_edge
  ...
  %i.gu = add i32 %.1284.lcssa, %8                ; 3 uses
