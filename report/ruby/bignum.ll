...
BIGNUM_DIGITS.exit:                               ; preds = %bb.b, %bb.c
  %.0.i = phi ptr [ %i.f, %bb.b ], [ %i.h, %bb.c ] ; 3 uses
  %1 = lshr i128 %0, 32                           ; 2 uses
  %i.i = trunc i128 %1 to i32
  %2 = insertelement <2 x i128> poison, i128 %0, i64 0
  %3 = insertelement <2 x i128> %2, i128 %1, i64 1
  %4 = trunc <2 x i128> %3 to <2 x i32>
  %5 = trunc i128 %0 to i32
  store <2 x i32> %4, ptr %.0.i, align 4, !tbaa !7
  %i.j = lshr i128 %0, 64
...
bb.a:
  ...
  %.07 = tail call i128 @llvm.abs.i128(i128 %0, i1 false) ; 5 uses
...
BIGNUM_DIGITS.exit.i:                             ; preds = %bb.c, %bb.b
  %.0.i.i = phi ptr [ %i.g, %bb.b ], [ %i.i, %bb.c ] ; 3 uses
  %1 = lshr i128 %.07, 32                         ; 2 uses
  %i.j = trunc i128 %1 to i32
  %2 = insertelement <2 x i128> poison, i128 %.07, i64 0
  %3 = insertelement <2 x i128> %2, i128 %1, i64 1
  %4 = trunc <2 x i128> %3 to <2 x i32>
  %5 = trunc i128 %.07 to i32
  store <2 x i32> %4, ptr %.0.i.i, align 4, !tbaa !7
  %i.k = lshr i128 %.07, 64
