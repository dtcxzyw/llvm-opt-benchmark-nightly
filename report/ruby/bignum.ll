...
.lr.ph.i.i:                                       ; preds = %BIGNUM_DIGITS.exit.i.i, %bb.ae
  ...
  %.02232.i.i = phi i64 [ %i.dq, %bb.ae ], [ %.0.i28.i.i, %BIGNUM_DIGITS.exit.i.i ] ; 5 uses
...
.critedge.i.i:                                    ; preds = %.lr.ph.i.i
  ...
  br i1 %i.dr, label %bb.ai, label %.lr.ph36.preheader.i.i

.lr.ph36.preheader.i.i:                           ; preds = %.critedge.i.i
  %i.ds = trunc nuw i64 %.02232.i.i to i32        ; 3 uses
...
.lr.ph36.i.i.epil:                                ; preds = %.lr.ph36.i.i.epil, %.lr.ph36.i.i.epil.preheader
  ...
  %i.eo = or disjoint i64 %i.ej, %i.en            ; 3 uses
...
bb.af:                                            ; preds = %._crit_edge.i.i.epilog-lcssa
  br i1 %i.ep, label %bb.ag, label %bb.ai

bb.ag:                                            ; preds = %bb.af
  %3 = icmp eq i64 %i.eo, 1
  br i1 %3, label %int_pow_tmp3.exit, label %bignorm.exit.thread

bb.ah:                                            ; preds = %._crit_edge.i.i.epilog-lcssa
  %i.er = icmp ult i64 %i.eo, 4611686018427387905
  br i1 %i.er, label %bignorm.exit.thread, label %bb.ai
...
bignorm.exit.thread:                              ; preds = %bb.ae, %rb_bigzero_p.exit, %bb.ai, %bb.ah, %BIGNUM_DIGITS.exit.i.i, %bb.ag
  %i.es = tail call i64 @rb_int_modulo(i64 noundef %2, i64 noundef %.036) #23 ; 2 uses
  br i1 %i.g, label %.preheader.i60, label %.lr.ph.i58

.preheader.i60:                                   ; preds = %bb.ak, %bignorm.exit.thread
  %.032.lcssa.i = phi i64 [ %i.c, %bignorm.exit.thread ], [ %i.ez, %bb.ak ] ; 2 uses
  %.030.lcssa.i = phi i64 [ %i.es, %bignorm.exit.thread ], [ %i.ey, %bb.ak ]
...
.lr.ph.i58:                                       ; preds = %bignorm.exit.thread, %bb.ak
  ...
  %.03039.i = phi i64 [ %i.ey, %bb.ak ], [ %i.es, %bignorm.exit.thread ] ; 3 uses
  %.03238.i = phi i64 [ %i.ez, %bb.ak ], [ %i.c, %bignorm.exit.thread ] ; 2 uses
  %i.et = tail call i64 @rb_int_odd_p(i64 noundef %.03238.i) #23
  %i.eu = and i64 %i.et, -5
  %.not37.i = icmp eq i64 %i.eu, 0
  br i1 %.not37.i, label %bb.ak, label %bb.aj

bb.aj:                                            ; preds = %.lr.ph.i58
  %i.ev = tail call i64 @rb_int_mul(i64 noundef %.02940.i, i64 noundef %.03039.i) #23
  %i.ew = tail call i64 @rb_int_modulo(i64 noundef %i.ev, i64 noundef %.036) #23
  br label %bb.ak

bb.ak:                                            ; preds = %bb.aj, %.lr.ph.i58
  %.1.i59 = phi i64 [ %i.ew, %bb.aj ], [ %.02940.i, %.lr.ph.i58 ] ; 2 uses
  %i.ex = tail call i64 @rb_int_mul(i64 noundef %.03039.i, i64 noundef %.03039.i) #23
  %i.ey = tail call i64 @rb_int_modulo(i64 noundef %i.ex, i64 noundef %.036) #23 ; 2 uses
  %i.ez = tail call i64 @rb_big_rshift(i64 noundef %.03238.i, i64 noundef 3) ; 3 uses
  %i.fa = trunc i64 %i.ez to i1
  br i1 %i.fa, label %.preheader.i60, label %.lr.ph.i58, !llvm.loop !412
...
.lr.ph49.i:                                       ; preds = %.preheader.i60, %bb.am
  ...
  %.13145.i = phi i64 [ %i.ff, %bb.am ], [ %.030.lcssa.i, %.preheader.i60 ] ; 3 uses
  %i.fb = and i64 %.0.in47.i, 2
  %.not36.i = icmp eq i64 %i.fb, 0
  br i1 %.not36.i, label %bb.am, label %bb.al

bb.al:                                            ; preds = %.lr.ph49.i
  %i.fc = tail call i64 @rb_int_mul(i64 noundef %.246.i, i64 noundef %.13145.i) #23
  %i.fd = tail call i64 @rb_int_modulo(i64 noundef %i.fc, i64 noundef %.036) #23
  br label %bb.am

bb.am:                                            ; preds = %bb.al, %.lr.ph49.i
  %.3.i62 = phi i64 [ %i.fd, %bb.al ], [ %.246.i, %.lr.ph49.i ] ; 2 uses
  %i.fe = tail call i64 @rb_int_mul(i64 noundef %.13145.i, i64 noundef %.13145.i) #23
  %i.ff = tail call i64 @rb_int_modulo(i64 noundef %i.fe, i64 noundef %.036) #23
...
bb.an:                                            ; preds = %._crit_edge.i
  %i.fg = tail call i32 @rb_int_positive_p(i64 noundef %.2.lcssa.i65) #23
  %.not34.i66 = icmp eq i32 %i.fg, 0
  br i1 %.not34.i66, label %int_pow_tmp3.exit, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  %i.fh = tail call i64 @rb_int_zero_p(i64 noundef %.2.lcssa.i65) #23
  %.not35.i67 = icmp eq i64 %i.fh, 0
  br i1 %.not35.i67, label %bb.ap, label %int_pow_tmp3.exit

bb.ap:                                            ; preds = %bb.ao
  %i.fi = tail call i64 @rb_int_minus(i64 noundef %.2.lcssa.i65, i64 noundef %.036) #23
  br label %int_pow_tmp3.exit

int_pow_tmp3.exit:                                ; preds = %bb.ap, %bb.ao, %bb.an, %._crit_edge.i, %bb.i, %bb.m, %int_pow_tmp2.exit, %int_pow_tmp1.exit, %bb.ag, %bb.c
  %.2 = phi i64 [ %i.d, %bb.c ], [ 1, %bb.i ], [ %i.ah, %bb.m ], [ 1, %bb.ag ], [ %i.cc, %int_pow_tmp2.exit ], [ %i.bb, %int_pow_tmp1.exit ], [ %.2.lcssa.i65, %bb.ao ], [ %i.fi, %bb.ap ], [ %.2.lcssa.i65, %bb.an ], [ %.2.lcssa.i65, %._crit_edge.i ]
  ret i64 %.2
}
