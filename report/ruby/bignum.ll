...
._crit_edge.i.i:                                  ; preds = %bb.o, %.critedge2.i.i, %.critedge.preheader.i.i
  ...
  %i.cn = call nonnull ptr @__memcpy_chk(ptr noundef nonnull %i.c, ptr noundef nonnull readonly %i.a, i64 noundef range(i64 1, 0) %i.cm, i64 noundef 16) #23, !alias.scope !168 ; 0 uses
