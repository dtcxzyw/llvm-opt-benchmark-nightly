...
._crit_edge396:                                   ; preds = %bb.au, %bb.av
  ...
  store i32 %i.ic, ptr %i.ib, align 4, !tbaa !44
...
.preheader.i:                                     ; preds = %bb.ax, %bb.ay
  ...
  %i.if = load i32, ptr %i.ie, align 4, !tbaa !44
...
bb.ba:                                            ; preds = %bb.az
  ...
  %i.ih = load i32, ptr %i.ig, align 4, !tbaa !44
...
.lr.ph.i242:                                      ; preds = %.lr.ph.i242.preheader, %bb.bb
  ...
  %i.ij = load i32, ptr %i.ii, align 4, !tbaa !44 ; 2 uses
...
bb.bc:                                            ; preds = %.lr.ph.i242
  ...
  %i.im = sub i32 0, %i.ij
  store i32 %i.im, ptr %i.il, align 4, !tbaa !44
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.is, align 4, !tbaa !44
  %wide.load469 = load <4 x i32>, ptr %i.it, align 4, !tbaa !44
  %i.iu = xor <4 x i32> %wide.load, splat (i32 -1)
  %i.iv = xor <4 x i32> %wide.load469, splat (i32 -1)
  store <4 x i32> %i.iu, ptr %i.is, align 4, !tbaa !44
  store <4 x i32> %i.iv, ptr %i.it, align 4, !tbaa !44
...
.lr.ph26.i247:                                    ; preds = %.lr.ph26.i247.preheader517, %.lr.ph26.i247
  ...
  %i.iz = xor i32 %i.iy, -1
  store i32 %i.iz, ptr %i.ix, align 4, !tbaa !44
