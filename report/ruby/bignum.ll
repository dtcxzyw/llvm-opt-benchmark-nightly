...
begin_hunk_2_@rb_absint_numwords:bb.a
  ...
  %i.cn = call ptr @__memcpy_chk(ptr noundef nonnull %i.c, ptr noundef nonnull readonly %i.a, i64 noundef range(i64 1, 0) %i.cm, i64 noundef 16) #24, !alias.scope !168 ; 0 uses
