...
iso2022jp_put_state.exit:                         ; preds = %bb.d, %bb.c
...
begin_hunk_2
  ...
  %i.p = getelementptr inbounds nuw i8, ptr %.1.i, i64 2 ; 2 uses
  store i8 %i.o, ptr %i.n, align 1, !tbaa !10
  %.pre = load i8, ptr %0, align 1, !tbaa !10
  %.not.i23 = icmp eq i8 %.pre, 0
  br i1 %.not.i23, label %iso2022jp_put_state.exit26, label %.thread

.thread:                                          ; preds = %bb.a, %bb.b, %iso2022jp_put_state.exit
  %.02030 = phi ptr [ %i.p, %iso2022jp_put_state.exit ], [ %1, %bb.b ], [ %1, %bb.a ] ; 4 uses
...
iso2022jp_put_state.exit26:                       ; preds = %iso2022jp_put_state.exit, %.thread
  %.1.i25 = phi ptr [ %.0.i24, %.thread ], [ %i.p, %iso2022jp_put_state.exit ]
