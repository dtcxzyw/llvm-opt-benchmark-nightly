...
bb.b:                                             ; preds = %.lr.ph, %proc_W_option.exit.thread
  %.0156497 = phi i64 [ %.0156492, %.lr.ph ], [ %.0156, %proc_W_option.exit.thread ] ; 56 uses
  %.0156.in495 = phi i64 [ %0, %.lr.ph ], [ %.4, %proc_W_option.exit.thread ] ; 16 uses
