...
bb.s:                                             ; preds = %bb.r
  %i.au = call i64 @rsock_intern_ip_optname(i32 noundef %i.y) #11, !callees !71 ; 2 uses
...
bb.v:                                             ; preds = %bb.r
  %i.ay = call i64 @rsock_intern_ipv6_optname(i32 noundef %i.y) #11, !callees !71 ; 2 uses
...
bb.y:                                             ; preds = %bb.r
  %i.bc = call i64 @rsock_intern_tcp_optname(i32 noundef %i.y) #11, !callees !71 ; 2 uses
...
bb.ab:                                            ; preds = %bb.r
  %i.bg = call i64 @rsock_intern_udp_optname(i32 noundef %i.y) #11, !callees !71 ; 2 uses
...
begin_hunk_5_@ancillary_inspect:bb.a
  ...
  br i1 %i.dq, label %bb.aq, label %inspect_timeval_as_abstime.exit, !llvm.loop !73
...
bb.bc:                                            ; preds = %bb.bb, %bb.ba
  %i.eq = load i32, ptr %2, align 4, !tbaa !74
...
bb.bd:                                            ; preds = %bb.bc
  %i.et = load i32, ptr %2, align 4, !tbaa !74
...
begin_hunk_8_@ancillary_s_unix_rights:bb.a
  ...
  br i1 %exitcond33.not, label %._crit_edge27, label %bb.c, !llvm.loop !78
...
begin_hunk_9_@ancillary_s_ip_pktinfo:bb.a
  ...
  store i32 %i.o, ptr %3, align 4, !tbaa !74
...
begin_hunk_10_@ancillary_ip_pktinfo:bb.a
  ...
  store i16 2, ptr %1, align 4, !tbaa !79
...
begin_hunk_11_@ancillary_s_ipv6_pktinfo:bb.a
  ...
  store i32 %i.p, ptr %i.r, align 4, !tbaa !82
...
bb.j:                                             ; preds = %RSTRING_PTR.exit
  ...
  store i32 %i.ai, ptr %i.aj, align 4, !tbaa !87
  br label %bb.k
...
!73 = distinct !{!73, !20}
!74 = !{!75, !7, i64 0}
!75 = !{!"in_pktinfo", !7, i64 0, !76, i64 4, !76, i64 8}
!76 = !{!"in_addr", !7, i64 0}
!77 = distinct !{!77, !20}
!78 = distinct !{!78, !20}
!79 = !{!80, !81, i64 0}
!80 = !{!"sockaddr_in", !81, i64 0, !81, i64 2, !76, i64 4, !8, i64 8}
!81 = !{!"short", !8, i64 0}
!82 = !{!83, !7, i64 16}
!83 = !{!"in6_pktinfo", !84, i64 0, !7, i64 16}
!84 = !{!"in6_addr", !8, i64 0}
!85 = !{!86, !81, i64 0}
!86 = !{!"sockaddr", !81, i64 0, !8, i64 2}
!87 = !{!88, !7, i64 24}
!88 = !{!"sockaddr_in6", !81, i64 0, !81, i64 2, !7, i64 4, !84, i64 8, !7, i64 24}
end_hunk_16
