...
bb.r:                                             ; preds = %bb.p
  br label %rb_any_to_s.exit
end_hunk_1
begin_hunk_2_@rb_check_to_i:bb.a

declare double @ruby_strtod(ptr noundef, ptr noundef) local_unnamed_addr #4
...
bb.a:
  %i.a = tail call i64 @rb_convert_type_with_id(i64 noundef %0, i32 noundef 4, ptr noundef nonnull @.str.19, i64 noundef 3409)
  ret i64 %i.a
}
...
bb.a:
  %i.a = tail call i64 @rb_exc_new_str(i64 noundef %0, i64 noundef %1) #21
  tail call void @rb_exc_raise(i64 noundef %i.a) #22
  unreachable
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal i64 @inspect_obj(i64 noundef %0, i64 noundef %1, i32 noundef %2) #2 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  %i.c = tail call i64 @rb_str_cat(i64 noundef %i.b, ptr noundef nonnull @.str.169, i64 noundef 4) #21 ; 0 uses
  br label %bb.d

bb.c:                                             ; preds = %bb.a
  tail call void @rb_ivar_foreach(i64 noundef %0, ptr noundef nonnull @inspect_i, i64 noundef %1) #21
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %i.d = tail call i64 @rb_str_cat(i64 noundef %i.b, ptr noundef nonnull @.str.8, i64 noundef 1) #21 ; 0 uses
...
RSTRING_PTR.exit:                                 ; preds = %bb.d, %bb.e
  ...
  store i8 35, ptr %i.j, align 1, !tbaa !34
  ret i64 %i.b
}

declare void @rb_ivar_foreach(i64 noundef, ptr noundef, i64 noundef) local_unnamed_addr #4
...
rb_class_of.exit:                                 ; preds = %bb.b, %bb.c, %bb.d, %bb.e, %bb.f, %bb.g
  ...
  %i.n = icmp eq i64 %.0.i, 0
  br i1 %i.n, label %.loopexit, label %bb.h

bb.h:                                             ; preds = %rb_class_of.exit
  %i.o = tail call i32 @rb_is_instance_id(i64 noundef %0) #26
...
bb.j:                                             ; preds = %bb.i
  %i.q = tail call i64 @rb_id2sym(i64 noundef %0) #21 ; 2 uses
  %i.r = inttoptr i64 %i.d to ptr                 ; 3 uses
  %i.s = load i64, ptr %i.r, align 8, !tbaa !28   ; 2 uses
  %i.t = and i64 %i.s, 8192
  %.not.i.i = icmp eq i64 %i.t, 0
  %i.u = getelementptr i8, ptr %i.r, i64 16       ; 2 uses
  br i1 %.not.i.i, label %.split.us, label %RARRAY_AREF.exit.thread.preheader

RARRAY_AREF.exit.thread.preheader:                ; preds = %bb.j
  %i.v = lshr i64 %i.s, 15
  %i.w = and i64 %i.v, 127
...
.split.us:                                        ; preds = %bb.j
  %i.x = getelementptr i8, ptr %i.r, i64 32
  %i.y = load ptr, ptr %i.x, align 8, !tbaa !34
  br label %RARRAY_AREF.exit.us

RARRAY_AREF.exit.us:                              ; preds = %rb_array_len.exit.us, %.split.us
  %.0.us = phi i64 [ 0, %.split.us ], [ %i.ac, %rb_array_len.exit.us ] ; 2 uses
  %i.z = getelementptr [8 x i8], ptr %i.y, i64 %.0.us
  %i.aa = load i64, ptr %i.z, align 8, !tbaa !11
  %.not26.us = icmp eq i64 %i.aa, %i.q
  br i1 %.not26.us, label %.critedge, label %rb_array_len.exit.us

rb_array_len.exit.us:                             ; preds = %RARRAY_AREF.exit.us
  %i.ab = load i64, ptr %i.u, align 8, !tbaa !34
  %i.ac = add nuw nsw i64 %.0.us, 1               ; 2 uses
  %.not27.us = icmp slt i64 %i.ac, %i.ab
  br i1 %.not27.us, label %RARRAY_AREF.exit.us, label %.loopexit, !llvm.loop !113

RARRAY_AREF.exit.thread:                          ; preds = %RARRAY_AREF.exit.thread.preheader, %rb_array_len.exit
  %.0 = phi i64 [ %i.af, %rb_array_len.exit ], [ 0, %RARRAY_AREF.exit.thread.preheader ] ; 2 uses
  %i.ad = getelementptr [8 x i8], ptr %i.u, i64 %.0
  %i.ae = load i64, ptr %i.ad, align 8, !tbaa !11
  %.not2633 = icmp eq i64 %i.ae, %i.q
  br i1 %.not2633, label %.critedge, label %rb_array_len.exit

rb_array_len.exit:                                ; preds = %RARRAY_AREF.exit.thread
  %i.af = add nuw nsw i64 %.0, 1                  ; 2 uses
  %exitcond.not = icmp eq i64 %i.af, %umax
  br i1 %exitcond.not, label %.loopexit, label %RARRAY_AREF.exit.thread, !llvm.loop !113

.critedge:                                        ; preds = %RARRAY_AREF.exit.thread, %RARRAY_AREF.exit.us, %bb.i
  %i.ag = inttoptr i64 %i.b to ptr                ; 2 uses
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !28
  %i.ai = and i64 %i.ah, 8192
  %.not.i29 = icmp eq i64 %i.ai, 0
  %i.aj = getelementptr i8, ptr %i.ag, i64 24     ; 3 uses
...
RSTRING_PTR.exit.thread:                          ; preds = %.critedge
  %i.am = load ptr, ptr %i.aj, align 8, !tbaa !34 ; 2 uses
  %i.an = load i8, ptr %i.am, align 1, !tbaa !34
  %i.ao = icmp eq i8 %i.an, 45
  br i1 %i.ao, label %RSTRING_PTR.exit31, label %bb.k

RSTRING_PTR.exit31:                               ; preds = %RSTRING_PTR.exit.thread, %RSTRING_PTR.exit
  %i.ap = phi ptr [ %i.aj, %RSTRING_PTR.exit ], [ %i.am, %RSTRING_PTR.exit.thread ]
  store i8 35, ptr %i.ap, align 1, !tbaa !34
  %i.aq = tail call i64 @rb_str_cat(i64 noundef %i.b, ptr noundef nonnull @.str.170, i64 noundef 1) #21 ; 0 uses
  br label %bb.l

bb.k:                                             ; preds = %RSTRING_PTR.exit.thread, %RSTRING_PTR.exit
  %i.ar = tail call i64 @rb_str_cat(i64 noundef %i.b, ptr noundef nonnull @.str.171, i64 noundef 2) #21 ; 0 uses
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %RSTRING_PTR.exit31
  %i.as = tail call i64 @rb_id2str(i64 noundef %0) #21
  %i.at = tail call i64 (i64, ptr, ...) @rb_str_catf(i64 noundef %i.b, ptr noundef nonnull @.str.172, i64 noundef %i.as) #21 ; 0 uses
  %i.au = tail call i64 @rb_inspect(i64 noundef %1)
  %i.av = tail call i64 @rb_str_buf_append(i64 noundef %i.b, i64 noundef %i.au) #21 ; 0 uses
  br label %.loopexit

.loopexit:                                        ; preds = %rb_array_len.exit, %rb_array_len.exit.us, %bb.h, %rb_class_of.exit, %bb.l
  ret i32 0
}
...
declare i32 @rb_is_instance_name(i64 noundef) local_unnamed_addr #4
...
declare i64 @rb_ivar_defined(i64 noundef, i64 noundef) local_unnamed_addr #4

declare i64 @rb_f_sprintf(i32 noundef, ptr noundef) local_unnamed_addr #4

declare i64 @rb_mod_module_exec(i32 noundef, ptr noundef, i64 noundef) local_unnamed_addr #4

; Function Attrs: mustprogress nofree nounwind willreturn memory(read)
declare i32 @rb_is_const_sym(i64 noundef) local_unnamed_addr #14

declare i64 @rb_const_missing(i64 noundef, i64 noundef) local_unnamed_addr #4
...
declare i64 @rb_check_id_cstr(ptr noundef, i64 noundef, ptr noundef) local_unnamed_addr #4

; Function Attrs: inlinehint nounwind sspstrong uwtable
define internal fastcc i64 @QUOTE(i64 noundef %0) unnamed_addr #9 {
bb.a:
  %i.a = tail call i64 @rb_str_quote_unprintable(i64 noundef %0) #21
  ret i64 %i.a
}
...
declare i64 @rb_const_get_from(i64 noundef, i64 noundef) local_unnamed_addr #4

; Function Attrs: inlinehint noreturn nounwind sspstrong uwtable
define internal fastcc void @rb_name_err_raise(ptr noundef %0, i64 noundef %1, i64 noundef %2) unnamed_addr #15 {
bb.a:
  %i.a = tail call i64 @rb_fstring_cstr(ptr noundef %0) #21
  tail call fastcc void @rb_name_err_raise_str(i64 noundef %i.a, i64 noundef %1, i64 noundef %2) #25
  unreachable
}

declare i64 @rb_str_quote_unprintable(i64 noundef) local_unnamed_addr #4
...
declare i32 @rb_const_defined(i64 noundef, i64 noundef) local_unnamed_addr #4

declare i32 @rb_const_defined_at(i64 noundef, i64 noundef) local_unnamed_addr #4

declare i32 @rb_const_defined_from(i64 noundef, i64 noundef) local_unnamed_addr #4

declare i64 @rb_const_source_location(i64 noundef, i64 noundef) local_unnamed_addr #4
...
declare i32 @rb_is_class_name(i64 noundef) local_unnamed_addr #4

declare i64 @rb_cvar_get(i64 noundef, i64 noundef) local_unnamed_addr #4
...
declare void @rb_check_inheritable(i64 noundef) local_unnamed_addr #4

declare i64 @rb_class_set_super(i64 noundef, i64 noundef) local_unnamed_addr #4

declare i64 @rb_make_metaclass(i64 noundef, i64 noundef) local_unnamed_addr #4
...
bb.a:
  %i.a = tail call i64 @rb_float_new_in_heap(double noundef +inf) #21
  ret i64 %i.a
}
...
attributes #1 = { mustprogress nofree norecurse nosync nounwind sspstrong willreturn memory(write, inaccessiblemem: none, target_mem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #5 = { mustprogress nofree nounwind sspstrong willreturn memory(read) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!12 = !{!"long", !9, i64 0}
!13 = !{!14, !24, i64 144}
!14 = !{!"RClass_and_rb_classext_t", !15, i64 0, !17, i64 24}
!15 = !{!"RClass", !16, i64 0, !12, i64 16}
