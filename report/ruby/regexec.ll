...
bb.uf:                                            ; preds = %.backedge
  ...
  %i.bwi = load ptr, ptr %i.o, align 8, !tbaa !59 ; 6 uses
...
bb.ug:                                            ; preds = %.lr.ph4019, %.thread
  %lsr.iv7287 = phi ptr [ %scevgep7285, %.lr.ph4019 ], [ %scevgep7287, %.thread ] ; 5 uses
  %lsr.iv7286 = phi ptr [ %i.bwi, %.lr.ph4019 ], [ %6, %.thread ]
  %.022484016 = phi i32 [ 0, %.lr.ph4019 ], [ %.12249, %.thread ] ; 5 uses
  %6 = getelementptr i8, ptr %lsr.iv7286, i64 -48 ; 3 uses
  %i.bwm = load i32, ptr %lsr.iv7287, align 8, !tbaa !63 ; 2 uses
  %i.bwn = and i32 %i.bwm, 32768
  %.not2648 = icmp eq i32 %i.bwn, 0
  br i1 %.not2648, label %bb.ui, label %bb.uh

bb.uh:                                            ; preds = %bb.ug
  %scevgep7289 = getelementptr i8, ptr %lsr.iv7287, i64 16
...
bb.uj:                                            ; preds = %bb.ui
  %scevgep7290.a = getelementptr i8, ptr %lsr.iv7287, i64 16
...
.thread:                                          ; preds = %bb.uh, %bb.ui, %bb.uj, %bb.ul
  ...
  %scevgep7287 = getelementptr i8, ptr %lsr.iv7287, i64 -48 ; 2 uses
...
._crit_edge4020.loopexitsplit:                    ; preds = %bb.uk
  %lsr.iv7286.lcssa = phi ptr [ %6, %bb.uk ]
  br label %._crit_edge4020.loopexit

.thread.._crit_edge4020.loopexit_crit_edge:       ; preds = %.thread
  %lsr.iv7287.lcssa7289 = phi ptr [ %lsr.iv7287, %.thread ]
  %lsr.iv7286.lcssa7291 = phi ptr [ %6, %.thread ] ; 0 uses
...
._crit_edge4020.loopexit:                         ; preds = %._crit_edge4020.loopexitsplit, %.thread.._crit_edge4020.loopexit_crit_edge
  %.lcssa6889 = phi ptr [ %lsr.iv7287.lcssa7289, %.thread.._crit_edge4020.loopexit_crit_edge ], [ %lsr.iv7286.lcssa, %._crit_edge4020.loopexitsplit ]
...
begin_hunk_4_@match_at:bb.a
  ...
  %i.bzs = load ptr, ptr %i.o, align 8, !tbaa !59 ; 6 uses
...
.lr.ph4009:                                       ; preds = %.lr.ph4009.preheader, %.thread3378
  %lsr.iv7279 = phi ptr [ %scevgep7278, %.lr.ph4009.preheader ], [ %scevgep7280, %.thread3378 ] ; 5 uses
  %lsr.iv7279.a = phi ptr [ %7, %.thread3378 ], [ %i.bzs, %.lr.ph4009.preheader ]
  %.022504006 = phi i32 [ %.12251, %.thread3378 ], [ 0, %.lr.ph4009.preheader ] ; 5 uses
  %7 = getelementptr i8, ptr %lsr.iv7279.a, i64 -48 ; 3 uses
  %i.bzw = load i32, ptr %lsr.iv7279, align 8, !tbaa !63 ; 2 uses
  %i.bzx = and i32 %i.bzw, 32768
  %.not2643 = icmp eq i32 %i.bzx, 0
  br i1 %.not2643, label %bb.vd, label %bb.vc

bb.vc:                                            ; preds = %.lr.ph4009
  %scevgep7282.a = getelementptr i8, ptr %lsr.iv7279, i64 16
...
bb.ve:                                            ; preds = %bb.vd
  %scevgep7283 = getelementptr i8, ptr %lsr.iv7279, i64 16
...
.thread3378:                                      ; preds = %bb.vc, %bb.vd, %bb.ve, %bb.vg
  ...
  %scevgep7280 = getelementptr i8, ptr %lsr.iv7279, i64 -48 ; 2 uses
...
._crit_edge4010.loopexitsplit:                    ; preds = %bb.vf
  %lsr.iv7279.lcssa = phi ptr [ %7, %bb.vf ]
  br label %._crit_edge4010.loopexit

.thread3378.._crit_edge4010.loopexit_crit_edge:   ; preds = %.thread3378
  %lsr.iv7279.lcssa7281 = phi ptr [ %lsr.iv7279, %.thread3378 ]
  %lsr.iv7279.lcssa7284 = phi ptr [ %7, %.thread3378 ] ; 0 uses
...
._crit_edge4010.loopexit:                         ; preds = %._crit_edge4010.loopexitsplit, %.thread3378.._crit_edge4010.loopexit_crit_edge
  %.lcssa6888 = phi ptr [ %lsr.iv7279.lcssa7281, %.thread3378.._crit_edge4010.loopexit_crit_edge ], [ %lsr.iv7279.lcssa, %._crit_edge4010.loopexitsplit ]
...
bb.b:                                             ; preds = %bb.k, %bb.a
  %.039 = phi i64 [ 0, %bb.a ], [ %7, %bb.k ]     ; 4 uses
...
.loopexit.loopexitsplit:                          ; preds = %bb.f
  %.lcssa108.ph = phi i64 [ %7, %bb.f ]
  br label %.loopexit.loopexit

..loopexit.loopexit_crit_edge:                    ; preds = %bb.k
  %.039.lcssa114 = phi i64 [ %.039, %bb.k ]
  %split = phi i64 [ %7, %bb.k ]                  ; 0 uses
  %i.z = add i64 %.039.lcssa114, 1
  br label %.loopexit.loopexit

.loopexit.loopexit:                               ; preds = %.loopexit.loopexitsplit, %..loopexit.loopexit_crit_edge
  %.lcssa108 = phi i64 [ %i.z, %..loopexit.loopexit_crit_edge ], [ %.lcssa108.ph, %.loopexit.loopexitsplit ]
  br label %.loopexit
