...
bb.h:                                             ; preds = %bb.ar, %bb.g
  ...
  %.01091.pn = phi ptr [ %.01091, %bb.g ], [ %.51134, %bb.ar ] ; 4 uses
...
begin_hunk_3_@transcode_restartable0:bb.a
  ...
  %6 = sub nsw i64 %i.s, %i.ae
  %7 = getelementptr i8, ptr %i.ac, i64 %6
  %i.ao = getelementptr i8, ptr %7, i64 2
...
.lr.ph:                                           ; preds = %bb.m
  ...
  %i.bj = sub i64 %.01091.pn1288, %i.aw
  %xtraiter = and i64 %i.bj, 1
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.prol.preheader, label %.prol.loopexit
...
.lr.ph.new:                                       ; preds = %.prol.loopexit, %bb.r
  ...
  %i.bw = getelementptr i8, ptr %.010921287, i64 1 ; 2 uses
...
begin_hunk_6_@transcode_restartable0:bb.a
  ...
  %i.ch = getelementptr i8, ptr %.010921287, i64 2
...
begin_hunk_7_@transcode_restartable0:bb.a
  ...
  %exitcond.not.1 = icmp eq ptr %i.bw, %.01091.pn
