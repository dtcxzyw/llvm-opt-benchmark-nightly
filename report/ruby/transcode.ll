...
ruby_nonempty_memcpy.exit200.i:                   ; preds = %bb.j, %bb.i
  %i.be = phi ptr [ %i.au, %bb.i ], [ %.pre225.i, %bb.j ]
...
ruby_nonempty_memcpy.exit:                        ; preds = %bb.u, %bb.v
  %i.co = phi ptr [ %i.cn, %bb.u ], [ %.pre, %bb.v ]
...
ruby_nonempty_memcpy.exit135:                     ; preds = %bb.z, %bb.aa
  %i.df = phi ptr [ %i.cp, %bb.z ], [ %.pre138, %bb.aa ]
  %i.dg = phi i64 [ 0, %bb.z ], [ %.pre137, %bb.aa ]
...
bb.g:                                             ; preds = %bb.f
  ...
  %6 = load i64, ptr %i.b, align 8, !tbaa !87
...
bb.h:                                             ; preds = %bb.g, %bb.f
  %8 = load i64, ptr %i.b, align 8, !tbaa !87
  %i.ae = add i64 %8, %i.ab
...
ruby_nonempty_memcpy.exit.i:                      ; preds = %bb.fm, %bb.fl
  %i.we = phi ptr [ %i.vx, %bb.fl ], [ %.pre.i, %bb.fm ] ; 2 uses
  %i.wf = phi i32 [ %i.vz, %bb.fl ], [ %.pre21.i, %bb.fm ]
...
ruby_nonempty_memcpy.exit.i1241:                  ; preds = %bb.hc, %bb.hb
  %i.abs = phi ptr [ %i.abj, %bb.hb ], [ %.pre.i1238, %bb.hc ] ; 2 uses
  %i.abt = phi i32 [ %i.abl, %bb.hb ], [ %.pre21.i1240, %bb.hc ]
...
ruby_nonempty_memcpy.exit.i1248:                  ; preds = %bb.hl, %bb.hk
  %i.acw = phi ptr [ %i.acn, %bb.hk ], [ %.pre.i1245, %bb.hl ] ; 2 uses
  %i.acx = phi i32 [ %i.acp, %bb.hk ], [ %.pre21.i1247, %bb.hl ]
...
ruby_nonempty_memcpy.exit.i1255:                  ; preds = %bb.io, %bb.in
  %i.agy = phi ptr [ %i.agp, %bb.in ], [ %.pre.i1252, %bb.io ] ; 2 uses
  %i.agz = phi i32 [ %i.agr, %bb.in ], [ %.pre21.i1254, %bb.io ]
...
ruby_nonempty_memcpy.exit.i1262:                  ; preds = %bb.ix, %bb.iw
  %i.aie = phi ptr [ %i.ahv, %bb.iw ], [ %.pre.i1259, %bb.ix ] ; 2 uses
  %i.aif = phi i32 [ %i.ahx, %bb.iw ], [ %.pre21.i1261, %bb.ix ]
