...
.thread:                                          ; preds = %bb.as, %._crit_edge.i
  %i.ep = phi ptr [ %.pre.i.a, %._crit_edge.i ], [ @.str.3, %bb.as ]
  %i.eq = phi ptr [ %.pre.a, %._crit_edge.i ], [ @.str.3, %bb.as ] ; 2 uses
  %i.er = getelementptr inbounds nuw i8, ptr %i.ak, i64 8
  store ptr %i.eq, ptr %i.er, align 8, !tbaa !55
  %i.es = getelementptr inbounds nuw i8, ptr %i.ak, i64 16
  store ptr %i.ep, ptr %i.es, align 8, !tbaa !56
...
bb.au:                                            ; preds = %.thread, %.split
  %i.fd = phi ptr [ %i.eq, %.thread ], [ %i.et, %.split ] ; 2 uses
