...
begin_hunk_0_@rb_econv_prepare_options:bb.a
  ...
  %i.cq = and i64 %i.bu, -5
  %.not69.i = icmp eq i64 %i.cq, 0                ; 2 uses
  %spec.select.i = select i1 %.not69.i, i32 0, i32 256
  %3 = select i1 %.not69.i, i32 4096, i32 4352
...
begin_hunk_1_@econv_primitive_convert:bb.a
  ...
  %i.bs = and i64 %i.br, -5
  %.not61 = icmp eq i64 %i.bs, 0                  ; 2 uses
  %spec.select = select i1 %.not61, i32 0, i32 131072
  ...
  %3 = select i1 %.not61, i32 262144, i32 393216
