...
.preheader2986:                                   ; preds = %.preheader2986.preheader, %bb.iv
  %lsr.iv8154.a = phi i64 [ 3, %.preheader2986.preheader ], [ %lsr.iv.next8155.a, %bb.iv ] ; 9 uses
  %scevgep8161 = getelementptr i8, ptr %i.bkn, i64 %lsr.iv8154.a
...
.preheader2986.1:                                 ; preds = %bb.ip
  %scevgep8159 = getelementptr i8, ptr %i.bkn, i64 %lsr.iv8154.a
...
.preheader2986.2:                                 ; preds = %bb.is
  %scevgep8157 = getelementptr i8, ptr %i.bkn, i64 %lsr.iv8154.a
...
.preheader2986.3:                                 ; preds = %bb.it
  %scevgep8156 = getelementptr i8, ptr %i.bkn, i64 %lsr.iv8154.a
...
bb.iv:                                            ; preds = %bb.iu
  %lsr.iv.next8155.a = add nuw nsw i64 %lsr.iv8154.a, 4 ; 2 uses
  %exitcond3680.not.3 = icmp eq i64 %lsr.iv.next8155.a, 103
...
.critedge.loopexitsplitsplitsplit:                ; preds = %.preheader2986.1
  %lsr.iv8154.lcssa8164 = phi i64 [ %lsr.iv8154.a, %.preheader2986.1 ]
  %12 = add i64 %lsr.iv8154.lcssa8164, -2
  br label %.critedge.loopexitsplitsplit

.preheader2986.2..critedge.loopexitsplitsplit_crit_edge: ; preds = %.preheader2986.2
  %lsr.iv8154.lcssa8165 = phi i64 [ %lsr.iv8154.a, %.preheader2986.2 ]
  %i.ekc = add i64 %lsr.iv8154.lcssa8165, -1
  br label %.critedge.loopexitsplitsplit

.critedge.loopexitsplitsplit:                     ; preds = %.critedge.loopexitsplitsplitsplit, %.preheader2986.2..critedge.loopexitsplitsplit_crit_edge
  %.31917.ph.ph.ph = phi i64 [ %i.ekc, %.preheader2986.2..critedge.loopexitsplitsplit_crit_edge ], [ %12, %.critedge.loopexitsplitsplitsplit ]
  br label %.critedge.loopexitsplit

.preheader2986.3..critedge.loopexitsplit_crit_edge: ; preds = %.preheader2986.3
  %lsr.iv8154.lcssa8166 = phi i64 [ %lsr.iv8154.a, %.preheader2986.3 ]
  br label %.critedge.loopexitsplit

.critedge.loopexitsplit:                          ; preds = %.critedge.loopexitsplitsplit, %.preheader2986.3..critedge.loopexitsplit_crit_edge
  %.31917.ph.ph = phi i64 [ %lsr.iv8154.lcssa8166, %.preheader2986.3..critedge.loopexitsplit_crit_edge ], [ %.31917.ph.ph.ph, %.critedge.loopexitsplitsplit ]
  br label %.critedge.loopexit

.preheader2986..critedge.loopexit_crit_edge:      ; preds = %.preheader2986
  %lsr.iv8154.lcssa.a = phi i64 [ %lsr.iv8154.a, %.preheader2986 ]
  %i.ekd = add i64 %lsr.iv8154.lcssa.a, -3
  br label %.critedge.loopexit
