...
bb.ay:                                            ; preds = %.lr.ph
  ...
  %i.od = call range(i32 0, 512) i32 @llvm.umax.i32(i32 %i.oc, i32 range(i32 0, 512) 1)
...
buffer_size_check.exit2610:                       ; preds = %resize_buffer.exit2608, %bb.kj
  ...
  %i.ccn = call range(i32 0, 512) i32 @llvm.umax.i32(i32 %i.ccm, i32 range(i32 0, 512) 1)
