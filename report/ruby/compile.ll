...
.sink.split:                                      ; preds = %.thread, %.thread117
  ...
  %.ph = phi i64 [ 1, %.thread117 ], [ 9, %.thread ]
...
bb.f:                                             ; preds = %.sink.split, %bb.e
  %6 = phi i64 [ 1, %bb.e ], [ %.ph, %.sink.split ]
  %i.an = phi i32 [ 0, %bb.e ], [ %.ph.a, %.sink.split ]
...
begin_hunk_2_@compile_attrasgn:bb.a
  ...
  %i.ck = call fastcc ptr @new_insn_send(ptr noundef %0, i32 noundef %i.ci, i32 noundef %i.cj, i64 noundef 145, i64 noundef 3, ptr noundef null, i64 noundef %6, ptr noundef null) ; 3 uses
...
.critedge.i88.i.i:                                ; preds = %bb.ab, %bb.aa, %bb.z, %bb.y, %bb.x, %bb.w
  ...
  %.0.lcssa.i90.i.i = phi i64 [ 8, %bb.ab ], [ 0, %bb.w ], [ 1, %bb.x ], [ 3, %bb.z ], [ 2, %bb.y ], [ 4, %bb.aa ]
  %3 = phi i32 [ 8, %bb.ab ], [ 0, %bb.w ], [ 1, %bb.x ], [ 3, %bb.z ], [ 2, %bb.y ], [ 4, %bb.aa ] ; 2 uses
  %i.hh = shl nuw nsw i64 %.016.lcssa.i89.i.i, 1
  %i.hi = or disjoint i64 %i.hh, 1
  %i.hj = shl i64 %i.hi, %.0.lcssa.i90.i.i
  %i.hk = trunc i64 %i.hj to i8
  %i.hl = sub nuw nsw i32 8, %3
  %i.hm = zext nneg i32 %i.hl to i64
  %i.hn = getelementptr i8, ptr %i.i, i64 %i.hm
  store i8 %i.hk, ptr %i.hn, align 1, !tbaa !20
  %i.ho = add nuw nsw i32 %3, 1
...
.critedge.i73.i.i:                                ; preds = %bb.al, %bb.ak, %bb.aj, %bb.ai, %bb.ah, %bb.ag, %bb.af, %bb.ae, %ibf_dump_write_small_value.exit94.i.i
  ...
  %.0.lcssa.i75.i.i = phi i64 [ 8, %bb.al ], [ 0, %ibf_dump_write_small_value.exit94.i.i ], [ 1, %bb.ae ], [ 7, %bb.ak ], [ 2, %bb.af ], [ 5, %bb.ai ], [ 3, %bb.ag ], [ 6, %bb.aj ], [ 4, %bb.ah ]
  %4 = phi i32 [ 8, %bb.al ], [ 0, %ibf_dump_write_small_value.exit94.i.i ], [ 1, %bb.ae ], [ 7, %bb.ak ], [ 2, %bb.af ], [ 5, %bb.ai ], [ 3, %bb.ag ], [ 6, %bb.aj ], [ 4, %bb.ah ] ; 2 uses
  %i.iu = shl nuw nsw i64 %.016.lcssa.i74.i.i, 1
  %i.iv = or disjoint i64 %i.iu, 1
  %i.iw = shl i64 %i.iv, %.0.lcssa.i75.i.i
  %i.ix = trunc i64 %i.iw to i8
  %i.iy = sub nuw nsw i32 8, %4
  %i.iz = zext nneg i32 %i.iy to i64
  %i.ja = getelementptr i8, ptr %i.j, i64 %i.iz
  store i8 %i.ix, ptr %i.ja, align 1, !tbaa !20
  %i.jb = add nuw nsw i32 %4, 1
...
.critedge.i.i.i:                                  ; preds = %bb.ax, %bb.aw, %bb.av, %bb.au, %bb.at, %bb.as, %bb.ar, %bb.aq, %ibf_dump_object.exit.i.i, %ibf_dump_object.exit.thread.i.i
  ...
  %.0.lcssa.i.i.i = phi i64 [ 8, %bb.ax ], [ 0, %ibf_dump_object.exit.i.i ], [ 1, %bb.aq ], [ 7, %bb.aw ], [ 2, %bb.ar ], [ 5, %bb.au ], [ 3, %bb.as ], [ 6, %bb.av ], [ 4, %bb.at ], [ 0, %ibf_dump_object.exit.thread.i.i ]
  %5 = phi i32 [ 8, %bb.ax ], [ 0, %ibf_dump_object.exit.i.i ], [ 1, %bb.aq ], [ 7, %bb.aw ], [ 2, %bb.ar ], [ 5, %bb.au ], [ 3, %bb.as ], [ 6, %bb.av ], [ 4, %bb.at ], [ 0, %ibf_dump_object.exit.thread.i.i ] ; 2 uses
  %i.kq = shl nuw nsw i64 %.016.lcssa.i.i.i, 1
  %i.kr = or disjoint i64 %i.kq, 1
  %i.ks = shl i64 %i.kr, %.0.lcssa.i.i.i
  %i.kt = trunc i64 %i.ks to i8
  %i.ku = sub nuw nsw i32 8, %5
  %i.kv = zext nneg i32 %i.ku to i64
  %i.kw = getelementptr i8, ptr %i.k, i64 %i.kv
  store i8 %i.kt, ptr %i.kw, align 1, !tbaa !20
  %i.kx = add nuw nsw i32 %5, 1
...
.critedge.i.i232.i:                               ; preds = %bb.cg, %bb.cf, %bb.ce, %bb.cd, %bb.cc, %ibf_dump_object.exit.i226.i
  ...
  %.0.lcssa.i.i234.i = phi i64 [ 8, %bb.cg ], [ 0, %ibf_dump_object.exit.i226.i ], [ 1, %bb.cc ], [ 3, %bb.ce ], [ 2, %bb.cd ], [ 4, %bb.cf ]
  %6 = phi i32 [ 8, %bb.cg ], [ 0, %ibf_dump_object.exit.i226.i ], [ 1, %bb.cc ], [ 3, %bb.ce ], [ 2, %bb.cd ], [ 4, %bb.cf ] ; 2 uses
  %i.tr = shl nuw nsw i64 %.016.lcssa.i.i233.i, 1
  %i.ts = or disjoint i64 %i.tr, 1
  %i.tt = shl i64 %i.ts, %.0.lcssa.i.i234.i
  %i.tu = trunc i64 %i.tt to i8
  %i.tv = sub nuw nsw i32 8, %6
  %i.tw = zext nneg i32 %i.tv to i64
  %i.tx = getelementptr i8, ptr %i.c, i64 %i.tw
  store i8 %i.tu, ptr %i.tx, align 1, !tbaa !20
  %i.ty = add nuw nsw i32 %6, 1
...
.critedge:                                        ; preds = %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c, %bb.b, %bb.a
  ...
  %.0.lcssa = phi i64 [ 8, %bb.i ], [ 0, %bb.a ], [ 1, %bb.b ], [ 7, %bb.h ], [ 2, %bb.c ], [ 5, %bb.f ], [ 3, %bb.d ], [ 6, %bb.g ], [ 4, %bb.e ]
  %2 = phi i32 [ 8, %bb.i ], [ 0, %bb.a ], [ 1, %bb.b ], [ 7, %bb.h ], [ 2, %bb.c ], [ 5, %bb.f ], [ 3, %bb.d ], [ 6, %bb.g ], [ 4, %bb.e ] ; 2 uses
  %i.y = shl nuw nsw i64 %.016.lcssa, 1
  %i.z = or disjoint i64 %i.y, 1
  %i.aa = shl i64 %i.z, %.0.lcssa
  %i.ab = trunc i64 %i.aa to i8
  %i.ac = sub nuw nsw i32 8, %2
