...
.preheader:                                       ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %bb.d
  %.0.lcssa = phi i32 [ 0, %bb.d ], [ %i.v, %middle.block ], [ %i.v, %scalar.ph ], [ %i.v, %scalar.ph.prol.loopexit ] ; 5 uses
...
vector.ph6:                                       ; preds = %vector.memcheck2
  ...
  %invariant.op = add i32 %.0.lcssa, %i.l
  %invariant.gep = getelementptr [8 x i8], ptr %i.au, i64 %i.av
  br label %vector.body9

vector.body9:                                     ; preds = %vector.body9, %vector.ph6
  %index10 = phi i64 [ 0, %vector.ph6 ], [ %index.next14, %vector.body9 ] ; 3 uses
  %i.bq = trunc i64 %index10 to i32
  %.reass = add i32 %i.bq, %invariant.op
  ...
  %gep = getelementptr [8 x i8], ptr %invariant.gep, i64 %index10 ; 2 uses
