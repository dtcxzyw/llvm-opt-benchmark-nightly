...
begin_hunk_0_@compile_if:bb.a
  ...
  %8 = getelementptr i8, ptr %2, i64 40           ; 2 uses
  %i.b = getelementptr i8, ptr %2, i64 48         ; 2 uses
  %.in = select i1 %i.a, ptr %8, ptr %i.b
  %9 = load ptr, ptr %.in, align 8, !tbaa !219    ; 3 uses
  %.in84 = select i1 %i.a, ptr %i.b, ptr %8
...
begin_hunk_1_@compile_if:bb.a
  ...
  %i.do = icmp eq ptr %9, null                    ; 2 uses
...
iseq_compile_each.exit:                           ; preds = %.thread154
  %i.ea = call fastcc i32 @iseq_compile_each0(ptr noundef nonnull %0, ptr noundef nonnull %6, ptr noundef %9, i32 noundef %3), !inline_history !174
...
bb.t:                                             ; preds = %iseq_compile_each.exit.thread
  %i.ec = select i1 %i.do, ptr %2, ptr %9         ; 2 uses
...
get_node_call_nd_mid.exit:                        ; preds = %bb.d, %bb.d, %bb.d, %bb.d, %bb.e
  %.sink.i.a = phi i64 [ 40, %bb.d ], [ 40, %bb.d ], [ 40, %bb.d ], [ 32, %bb.e ], [ 40, %bb.d ]
...
get_node_call_nd_mid.exit34:                      ; preds = %bb.g, %bb.g, %bb.g, %bb.g, %bb.h
  %.sink.i32 = phi i64 [ 40, %bb.g ], [ 40, %bb.g ], [ 40, %bb.g ], [ 32, %bb.h ], [ 40, %bb.g ]
...
get_node_call_nd_mid.exit:                        ; preds = %nd_line.exit357, %nd_line.exit357, %nd_line.exit357, %nd_line.exit357, %bb.bh
  %.sink.i = phi i64 [ 40, %nd_line.exit357 ], [ 40, %nd_line.exit357 ], [ 40, %nd_line.exit357 ], [ 32, %bb.bh ], [ 40, %nd_line.exit357 ]
...
get_node_call_nd_mid.exit372:                     ; preds = %nd_line.exit369, %nd_line.exit369, %nd_line.exit369, %nd_line.exit369, %bb.bl
  %.sink.i370 = phi i64 [ 40, %nd_line.exit369 ], [ 40, %nd_line.exit369 ], [ 40, %nd_line.exit369 ], [ 32, %bb.bl ], [ 40, %nd_line.exit369 ]
