...
.loopexit.i.i:                                    ; preds = %.preheader.i.i, %bb.p, %bb.m, %bb.l, %.lr.ph169.i.i
  %.293.i.i = phi i32 [ %.091165.i.i, %bb.m ], [ %.091165.i.i, %bb.p ], [ %.091165.i.i, %.lr.ph169.i.i ], [ %.091165.i.i, %bb.l ], [ %i.x, %.preheader.i.i ]
  %.290.i.i = phi i32 [ %.088166.i.i, %bb.m ], [ %i.bn, %bb.p ], [ %.088166.i.i, %.lr.ph169.i.i ], [ %i.bh, %bb.l ], [ %i.s, %.preheader.i.i ]
  %.387.i.i = phi i32 [ %.084167.i.i, %bb.m ], [ %.084167.i.i, %bb.p ], [ %.084167.i.i, %.lr.ph169.i.i ], [ %.084167.i.i, %bb.l ], [ %spec.select.i.i, %.preheader.i.i ] ; 3 uses
...
iseq_set_sequence.exit.thread:                    ; preds = %bb.k, %.critedge.i.i, %bb.e, %bb.q, %bb.ct, %bb.ce, %bb.g, %bb.dt, %bb.du, %ISEQ_COMPILE_DATA.exit
  %.0 = phi i32 [ 0, %ISEQ_COMPILE_DATA.exit ], [ 1, %bb.dt ], [ 1, %bb.du ], [ 0, %bb.g ], [ 0, %bb.ce ], [ 0, %bb.ct ], [ 0, %bb.q ], [ 0, %bb.e ], [ 0, %.critedge.i.i ], [ 0, %bb.k ]
  ret i32 %.0
}
...
.thread:                                          ; preds = %APPEND_LIST.exit, %.thread.sink.split, %bb.p
  %.083152 = phi i64 [ %.083157, %.thread.sink.split ], [ %i.dj, %bb.p ], [ 0, %APPEND_LIST.exit ]
  %.279 = phi ptr [ %.077, %.thread.sink.split ], [ null, %bb.p ], [ null, %APPEND_LIST.exit ] ; 4 uses
...
bb.aj:                                            ; preds = %bb.ah, %bb.ai, %.critedge.a, %.critedge, %bb.i
  %.3 = phi i32 [ 0, %.critedge.a ], [ 1, %bb.ai ], [ 1, %bb.ah ], [ 0, %bb.i ], [ 0, %.critedge ]
...
.thread191:                                       ; preds = %iseq_compile_each.exit, %iseq_compile_each.exit165, %new_label_body.exit155, %nd_line.exit174, %nd_line.exit136, %APPEND_LIST.exit, %iseq_compile_each.exit181
  %.6 = phi i32 [ 0, %iseq_compile_each.exit181 ], [ 1, %APPEND_LIST.exit ], [ 0, %nd_line.exit174 ], [ 0, %nd_line.exit136 ], [ 0, %new_label_body.exit155 ], [ 0, %iseq_compile_each.exit165 ], [ 0, %iseq_compile_each.exit ]
...
compile_massign_opt.exit.thread:                  ; preds = %.lr.ph94, %bb.e, %get_nd_vid.exit66, %bb.c, %bb.d
...
iseq_compile_each.exit:                           ; preds = %private_recv_p.exit.thread
  ...
  br i1 %.not148, label %bb.bh, label %bb.r

bb.r:                                             ; preds = %iseq_compile_each.exit.thread, %nd_line.exit172, %iseq_compile_each.exit, %nd_line.exit
...
.thread:                                          ; preds = %bb.r, %bb.s, %nd_line.exit178, %bb.f
...
bb.bh:                                            ; preds = %iseq_compile_each.exit, %bb.bg, %nd_line.exit273, %get_nd_args.exit, %bb.e
  %.1 = phi i32 [ %i.w, %bb.e ], [ 1, %bb.bg ], [ 0, %get_nd_args.exit ], [ 1, %nd_line.exit273 ], [ 0, %iseq_compile_each.exit ]
...
.thread.a:                                        ; preds = %bb.l, %bb.j, %bb.m, %bb.h, %bb.g
...
new_label_body.exit:                              ; preds = %ISEQ_COMPILE_DATA.exit.i.i.i, %._crit_edge.i.i.i.i
  ...
  %6 = load i32, ptr %2, align 4, !tbaa !553      ; 2 uses
  %7 = getelementptr i8, ptr %2, i64 4            ; 3 uses
  %8 = load i32, ptr %7, align 4, !tbaa !556      ; 2 uses
...
bb.e:                                             ; preds = %new_label_body.exit
  ...
  %14 = load i32, ptr %7, align 4, !tbaa !556
  ...
  %19 = load i32, ptr %i.ak, align 8, !tbaa !273
  %20 = add i32 %19, 1
  store i32 %20, ptr %i.ak, align 8, !tbaa !273
  %i.at = load i32, ptr %2, align 4, !tbaa !553
  %21 = load i32, ptr %7, align 4, !tbaa !556
