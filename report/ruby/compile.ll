...
RARRAY_AREF.exit130:                              ; preds = %bb.ap, %bb.aq
  ...
  %i.gl = load i64, ptr %i.gk, align 8, !tbaa !63
  ...
  store i64 %i.gn, ptr %i.go, align 8, !tbaa !63
  ...
  br i1 %exitcond300.not, label %._crit_edge249, label %bb.ap, !llvm.loop !721

._crit_edge249:                                   ; preds = %RARRAY_AREF.exit130, %bb.ao
  %i.gp = load ptr, ptr %i.ad, align 8, !tbaa !70 ; 2 uses
  %i.gq = getelementptr i8, ptr %i.gp, i64 28
  store i32 %i.fr, ptr %i.gq, align 4, !tbaa !165
  %i.gr = getelementptr i8, ptr %i.gp, i64 48
  store ptr %i.gd, ptr %i.gr, align 8, !tbaa !164
  br label %bb.as
...
bb.ar:                                            ; preds = %rbimpl_RB_TYPE_P_fastpath.exit103.thread
  %i.gt = load i64, ptr @rb_eTypeError, align 8, !tbaa !63
...
rbimpl_RB_TYPE_P_fastpath.exit:                   ; preds = %bb.as
  ...
  %i.gz = load i64, ptr %i.gy, align 8, !tbaa !100 ; 3 uses
...
bb.av:                                            ; preds = %bb.at
  ...
  %i.hg = load i64, ptr %i.hf, align 8, !tbaa !47
  br label %rb_array_len.exit.i.i
...
bb.ax:                                            ; preds = %RARRAY_LENINT.exit.i
  ...
  store i32 %i.hu, ptr %i.ho, align 8, !tbaa !37
...
.int_param.exit_crit_edge.i:                      ; preds = %bb.ay
  %.pre.i = load i32, ptr %i.ho, align 8, !tbaa !194
  br label %int_param.exit.i

bb.az:                                            ; preds = %bb.ay
  %i.hw = load i64, ptr @rb_eTypeError, align 8, !tbaa !63
...
int_param.exit.i:                                 ; preds = %.int_param.exit_crit_edge.i, %bb.ax
  ...
  %i.hz = load ptr, ptr %i.ad, align 8, !tbaa !70
  %i.ia = getelementptr i8, ptr %i.hz, i64 144
  %i.ib = load ptr, ptr %i.ia, align 8, !tbaa !179
...
RARRAY_AREF.exit.i:                               ; preds = %bb.bb, %bb.ba
  ...
  %i.im = load i64, ptr %i.il, align 8, !tbaa !63 ; 5 uses
...
RB_SYMBOL_P.exit.i:                               ; preds = %bb.bc
  ...
  %i.iu = load i64, ptr %i.it, align 8, !tbaa !100
...
RB_SYMBOL_P.exit.thread.i:                        ; preds = %RB_SYMBOL_P.exit.i, %RARRAY_AREF.exit.i
  ...
  store i64 %i.ix, ptr %i.iy, align 8, !tbaa !63
  %i.iz = load i32, ptr %i.ih, align 4, !tbaa !201
  %i.ja = add i32 %i.iz, 1
  store i32 %i.ja, ptr %i.ih, align 4, !tbaa !201
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %.0.i.i.i
  br i1 %exitcond.not.i, label %iseq_build_kw.exit, label %bb.ba, !llvm.loop !722
...
RARRAY_AREF.exit73.i:                             ; preds = %bb.bn, %bb.bm
  ...
  %i.kh = load i64, ptr %i.kg, align 8, !tbaa !63
  br label %RARRAY_AREF.exit67.i

bb.bo:                                            ; preds = %rb_array_len.exit.i132
  %i.ki = load i64, ptr @rb_eTypeError, align 8, !tbaa !63
...
RARRAY_AREF.exit67.i:                             ; preds = %RARRAY_AREF.exit73.i, %bb.bk, %bb.bj
  ...
  %.054.i = load i64, ptr %.054.in.i, align 8, !tbaa !63
  %i.kj = call i64 @rb_sym2id(i64 noundef %.054.i) #37
  %i.kk = getelementptr [8 x i8], ptr %i.id, i64 %indvars.iv86.i
  store i64 %i.kj, ptr %i.kk, align 8, !tbaa !63
  %i.kl = getelementptr [8 x i8], ptr %i.jh, i64 %indvars.iv301
  store i64 %.053.i, ptr %i.kl, align 8, !tbaa !63
...
rb_obj_write.exit.i:                              ; preds = %bb.bp, %RARRAY_AREF.exit67.i
  ...
  br i1 %exitcond89.not.i, label %._crit_edge.i, label %bb.be, !llvm.loop !723

._crit_edge.i:                                    ; preds = %rb_obj_write.exit.i, %bb.bd
  %i.kq = getelementptr inbounds nuw i8, ptr %i.hj, i64 16
  store ptr %i.id, ptr %i.kq, align 8, !tbaa !202
...
iseq_build_kw.exit:                               ; preds = %RB_SYMBOL_P.exit.thread.i, %.thread.i, %._crit_edge.i
  ...
  store ptr %.sink.i, ptr %i.kr, align 8, !tbaa !107
  %i.ks = load ptr, ptr %i.ad, align 8, !tbaa !70
  %i.kt = getelementptr i8, ptr %i.ks, i64 56
  store ptr %i.hj, ptr %i.kt, align 8, !tbaa !191
  br label %bb.br
...
bb.bq:                                            ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.thread
  %i.kv = load i64, ptr @rb_eTypeError, align 8, !tbaa !63
...
bb.bs:                                            ; preds = %bb.br
  %i.la = load ptr, ptr %i.ad, align 8, !tbaa !70
...
bb.bu:                                            ; preds = %bb.bt
  %i.li = load ptr, ptr %i.ad, align 8, !tbaa !70
...
bb.bx:                                            ; preds = %bb.bw
  %i.lr = load i64, ptr @rb_eTypeError, align 8, !tbaa !63
...
bb.by:                                            ; preds = %bb.bv
  ...
  %i.lu = load ptr, ptr %i.ad, align 8, !tbaa !70 ; 2 uses
  %i.lv = getelementptr i8, ptr %i.lu, i64 56
  %i.lw = load ptr, ptr %i.lv, align 8, !tbaa !191 ; 2 uses
...
bb.bz:                                            ; preds = %bb.by
  ...
  %i.lz = load ptr, ptr %i.ad, align 8, !tbaa !70 ; 2 uses
  %i.ma = getelementptr i8, ptr %i.lz, i64 56
  store ptr %i.ly, ptr %i.ma, align 8, !tbaa !191
  br label %bb.ca
