...
tailcallable_p.exit.thread.i:                     ; preds = %ISEQ_COMPILE_DATA.exit
  %2 = getelementptr i8, ptr %i.d, i64 152
  %3 = load ptr, ptr %2, align 8, !tbaa !45
  %4 = load i16, ptr %3, align 4                  ; 4 uses
  %5 = getelementptr i8, ptr %0, i64 16
  %.val.i = load ptr, ptr %5, align 8, !tbaa !46
  %.val.val.i = load i32, ptr %.val.i, align 8, !tbaa !47 ; 3 uses
  %6 = icmp ult i32 %.val.val.i, 8
  ...
  %i.h = zext nneg i16 %.lobit.i to i32
  %7 = select i1 %or.cond, i32 0, i32 %i.h        ; 2 uses
  %i.i = getelementptr i8, ptr %1, i64 8          ; 2 uses
  %.val72.i = load ptr, ptr %i.i, align 8, !tbaa !63 ; 3 uses
...
bb.d:                                             ; preds = %tailcallable_p.exit.thread.i
  %.not59108.i = icmp eq ptr %.val72.i, null
  br i1 %.not59108.i, label %iseq_optimize.exit, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %bb.d, %bb.c, %bb.b, %bb.a
  %.051162.i = phi i32 [ 0, %bb.d ], [ 1, %bb.c ], [ 1, %bb.a ], [ 1, %bb.b ]
  %.154161.i = phi ptr [ null, %bb.d ], [ %spec.select.i, %bb.c ], [ null, %bb.a ], [ null, %bb.b ]
  %i.v = and i16 %4, 2
...
bb.e:                                             ; preds = %bb.dj, %.lr.ph.i
  %.0112.i = phi ptr [ %.val72.i, %.lr.ph.i ], [ %i.sy, %bb.dj ] ; 75 uses
  %.047111.i = phi i32 [ 0, %.lr.ph.i ], [ %.1.i, %bb.dj ] ; 4 uses
  %.049110.i = phi i32 [ %7, %.lr.ph.i ], [ %.150.i, %bb.dj ] ; 4 uses
...
begin_hunk_3
  ...
  %i.sn = icmp eq ptr %.154161.i, %i.sm
...
bb.di:                                            ; preds = %bb.dg
  ...
  %spec.select68.i = select i1 %.not66.i, i32 %7, i32 %.049110.i
  br label %bb.dj
...
bb.dk:                                            ; preds = %._crit_edge.i
  %.val70.i = load ptr, ptr %i.i, align 8, !tbaa !63
...
begin_hunk_6
  ...
  %i.ga = getelementptr i8, ptr %i.h, i64 248     ; 3 uses
...
3:                                                ; preds = %bb.bp
  %4 = load i32, ptr %i.ga, align 8, !tbaa !121
  br label %bb.bq

bb.bq:                                            ; preds = %3, %bb.bp
  %.0.i470.i = phi i32 [ %4, %3 ], [ 0, %bb.bp ]
  %i.na = load i32, ptr %i.gb, align 8, !tbaa !122
  %5 = add i32 %i.na, %.0.i470.i
  br label %bb.br

bb.br:                                            ; preds = %bb.bq, %bb.bp
  %.1.i469.i = phi i32 [ %5, %bb.bq ], [ 0, %bb.bp ]
...
ELEM_REMOVE.exit820:                              ; preds = %bb.ft, %bb.fs, %bb.fm, %bb.fo, %bb.fn, %bb.fl, %ELEM_REMOVE.exit818, %bb.fh, %bb.fi, %ELEM_REMOVE.exit828, %ELEM_INSERT_PREV.exit824, %.loopexit1082
  ...
  switch i32 %.pr1295, label %.loopexit [
    i32 27, label %bb.fw
    i32 29, label %bb.fw
    i32 32, label %bb.fw
end_hunk_8
...
.loopexitthread-pre-split:                        ; preds = %ELEM_INSERT_PREV.exit838, %ELEM_INSERT_PREV.exit835, %ELEM_REMOVE.exit830, %bb.gc, %bb.gb, %bb.ga
  %.pr999.pr = load i32, ptr %i.a, align 8, !tbaa !65
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexitthread-pre-split, %ELEM_REMOVE.exit820
  %.pr999 = phi i32 [ %.pr999.pr, %.loopexitthread-pre-split ], [ %.pr1295, %ELEM_REMOVE.exit820 ]
  switch i32 %.pr999, label %ELEM_REMOVE.exit847 [
    i32 29, label %bb.gl
    i32 24, label %bb.gn
    i32 21, label %bb.gs
    i32 22, label %bb.gs
...
bb.gp:                                            ; preds = %bb.go
  ...
  br i1 %i.acf, label %bb.gq, label %ELEM_REMOVE.exit847
...
begin_hunk_10
  ...
  br i1 %.not.i839, label %ELEM_REMOVE.exit847, label %ELEM_REMOVE.exit847.sink.split

.sink.split:                                      ; preds = %bb.ci, %bb.gm
  store i32 19, ptr %i.a, align 8, !tbaa !65
  br label %bb.gr

bb.gr:                                            ; preds = %.sink.split, %.loopexit
  ...
  br i1 %i.acq, label %ELEM_REMOVE.exit847, label %rbimpl_RB_TYPE_P_fastpath.exit
...
rbimpl_RB_TYPE_P_fastpath.exit:                   ; preds = %bb.gr
  ...
  br i1 %i.acu, label %bb.gs, label %ELEM_REMOVE.exit847

bb.gs:                                            ; preds = %.loopexit, %.loopexit, %rbimpl_RB_TYPE_P_fastpath.exit
  %i.acv = load ptr, ptr %i.d, align 8, !tbaa !68 ; 8 uses
  %.not620 = icmp eq ptr %i.acv, null
  br i1 %.not620, label %ELEM_REMOVE.exit847, label %bb.gt

bb.gt:                                            ; preds = %bb.gs
  %i.acw = load i32, ptr %i.acv, align 8, !tbaa !64
  %i.acx = icmp eq i32 %i.acw, 2
  br i1 %i.acx, label %bb.gu, label %ELEM_REMOVE.exit847
...
begin_hunk_11
  ...
  br i1 %.not.i843, label %ELEM_REMOVE.exit847, label %bb.gz
...
begin_hunk_13
  ...
  br i1 %i.aee, label %bb.hd, label %ELEM_REMOVE.exit847
...
begin_hunk_14
  ...
  br i1 %.not.i846, label %ELEM_REMOVE.exit847, label %ELEM_REMOVE.exit847.sink.split
...
ELEM_REMOVE.exit847:                              ; preds = %ELEM_REMOVE.exit847.sink.split, %.loopexit, %bb.gl, %bb.gm, %ELEM_REMOVE.exit842, %bb.gt, %bb.gs, %bb.gr, %bb.gq, %bb.gp, %bb.go, %bb.gn, %rb_obj_write.exit, %bb.hc, %bb.ha, %bb.hb, %rbimpl_RB_TYPE_P_fastpath.exit
  %.pr1299 = load i32, ptr %i.a, align 8, !tbaa !65
  %i.afl = icmp eq i32 %.pr1299, 23
...
ELEM_REMOVE.exit873:                              ; preds = %.lr.ph.i851, %bb.gh, %bb.gg, %.preheader1073, %.preheader1072, %bb.hh, %bb.hz, %bb.hy, %get_next_insn.exit871, %bb.hn, %get_destination_insn.exit859, %ELEM_REMOVE.exit847
