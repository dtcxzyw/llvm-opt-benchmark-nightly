...
bb.s:                                             ; preds = %tailrecurse.i
  tail call void @__assert_fail(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 487, ptr noundef nonnull @__PRETTY_FUNCTION__.pm_static_literal_positive_p) #11
  unreachable

pm_static_literal_positive_p.exit:                ; preds = %tailrecurse.i
  %i.af = getelementptr i8, ptr %.tr.i, i64 44
  %i.ag = load i8, ptr %i.af, align 4, !tbaa !58, !range !46, !noundef !47
...
begin_hunk_1_@pm_static_literal_inspect_node:bb.a
  ...
  %i.ar = load i16, ptr %i.aq, align 2, !tbaa !60 ; 2 uses
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %.pre = load i16, ptr %i.aq, align 2, !tbaa !60
  br label %bb.ac
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %.pre88 = load i16, ptr %i.aq, align 2, !tbaa !60
  br label %bb.ae
...
bb.af:                                            ; preds = %bb.ae
  ...
  %.pre89 = load i16, ptr %i.aq, align 2, !tbaa !60
  br label %bb.ag
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.e = load i64, ptr %i.d, align 8, !tbaa !61   ; 5 uses
...
begin_hunk_5_@node_hash:bb.a
  ...
  br i1 %niter232.ncmp.1, label %murmur_hash.exit.i.loopexit.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !62
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.dv = load i64, ptr %i.du, align 8, !tbaa !61 ; 5 uses
...
begin_hunk_7_@node_hash:bb.a
  ...
  br i1 %niter220.ncmp.1, label %murmur_hash.exit.i49.loopexit.unr-lcssa, label %.lr.ph.i.i44, !llvm.loop !62
...
bb.f:                                             ; preds = %integer_hash.exit55
  ...
  %i.gh = load i64, ptr %i.gg, align 8, !tbaa !61 ; 5 uses
...
begin_hunk_9_@node_hash:bb.a
  ...
  br i1 %niter226.ncmp.1, label %murmur_hash.exit.i63.loopexit.unr-lcssa, label %.lr.ph.i.i58, !llvm.loop !62
...
bb.h:                                             ; preds = %bb.a
  ...
  %i.jj = load i16, ptr %i.ji, align 2, !tbaa !60
...
begin_hunk_11_@node_hash:bb.a
  ...
  br i1 %niter214.ncmp.1, label %._crit_edge.loopexit.i.unr-lcssa, label %.lr.ph.i70, !llvm.loop !62
...
begin_hunk_12_@node_hash:bb.a
  ...
  br i1 %niter208.ncmp.1, label %._crit_edge.loopexit.i83.unr-lcssa, label %.lr.ph.i78, !llvm.loop !62
...
begin_hunk_13_@node_hash:bb.a
  ...
  br i1 %niter202.ncmp.1, label %._crit_edge.loopexit.i100.unr-lcssa, label %.lr.ph.i95, !llvm.loop !62
...
begin_hunk_14_@node_hash:bb.a
  ...
  %i.sc = load i16, ptr %i.sb, align 2, !tbaa !60
...
begin_hunk_15_@node_hash:bb.a
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.i117.unr-lcssa, label %.lr.ph.i112, !llvm.loop !62
...
begin_hunk_16_@node_hash:bb.a
  ...
  %i.vg = load i16, ptr %i.vf, align 2, !tbaa !60
...
!58 = !{!59, !44, i64 44}
!59 = !{!"pm_integer_node", !12, i64 0, !41, i64 24}
!60 = !{!12, !13, i64 2}
!61 = !{!41, !42, i64 0}
!62 = distinct !{!62, !30}
end_hunk_17
