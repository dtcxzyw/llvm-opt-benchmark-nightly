...
RSHAPE_EMBEDDED_CAPACITY.exit.i:                  ; preds = %rb_imemo_fields_owner.exit30
  ...
  %i.av = and i64 %i.at, 7
  %1 = add nuw nsw i64 %i.av, 4294967295
  %2 = and i64 %1, 4294967295
  %3 = getelementptr [2 x i8], ptr %i.au, i64 %2
  %i.aw = load i16, ptr %3, align 2, !tbaa !32
...
RSHAPE_EMBEDDED_CAPACITY.exit.i:                  ; preds = %rb_shape_obj_too_complex_p.exit.thread
  ...
  %i.af = and i64 %i.ad, 7
  %1 = add nuw nsw i64 %i.af, 4294967295
  %2 = and i64 %1, 4294967295
  %3 = getelementptr [2 x i8], ptr %i.ae, i64 %2
  %i.ag = load i16, ptr %3, align 2, !tbaa !32
