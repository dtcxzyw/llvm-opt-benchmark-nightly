...
bb.a:
  %i.a = tail call i64 @rb_define_module(ptr noundef nonnull @.str) #7
  %i.b = tail call i64 @rb_define_module_under(i64 noundef %i.a, ptr noundef nonnull @.str.1) #7 ; 5 uses
  tail call void @rb_define_singleton_method(i64 noundef %i.b, ptr noundef nonnull @.str.2, ptr noundef nonnull @printf_test_s, i32 noundef 1) #7
  tail call void @rb_define_singleton_method(i64 noundef %i.b, ptr noundef nonnull @.str.3, ptr noundef nonnull @printf_test_v, i32 noundef 1) #7
  tail call void @rb_define_singleton_method(i64 noundef %i.b, ptr noundef nonnull @.str.4, ptr noundef nonnull @printf_test_q, i32 noundef 1) #7
  tail call void @rb_define_singleton_method(i64 noundef %i.b, ptr noundef nonnull @.str.5, ptr noundef nonnull @printf_test_call, i32 noundef -1) #7
  tail call void @rb_define_singleton_method(i64 noundef %i.b, ptr noundef nonnull @.str.6, ptr noundef nonnull @snprintf_count, i32 noundef 1) #7
  ret void
}
...
bb.a:
  %i.a = tail call nonnull ptr @rb_usascii_encoding() #7
  %i.b = tail call i64 (ptr, ptr, ...) @rb_enc_sprintf(ptr noundef nonnull %i.a, ptr noundef nonnull @.str.7, i64 noundef %1) #7
  ret i64 %i.b
}
...
bb.a:
  %i.a = tail call nonnull ptr @rb_usascii_encoding() #7
  %i.b = tail call i64 (ptr, ptr, ...) @rb_enc_sprintf(ptr noundef nonnull %i.a, ptr noundef nonnull @.str.8, i64 noundef %1) #7
  ret i64 %i.b
}
...
bb.a:
  %i.a = tail call nonnull ptr @rb_usascii_encoding() #7
  %i.b = tail call i64 (ptr, ptr, ...) @rb_enc_sprintf(ptr noundef nonnull %i.a, ptr noundef nonnull @.str.9, i64 noundef %1) #7
  ret i64 %i.b
}
...
begin_hunk_3_@printf_test_call:bb.a
  ...
  %i.h = tail call i32 @rb_keyword_given_p() #7
  %.not83 = icmp eq i32 %i.h, 0
  br i1 %.not83, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.i = tail call i64 @rb_hash_dup(i64 noundef %i.g) #7
  %i.j = add nsw i32 %0, -1
  br label %bb.d
...
.thread:                                          ; preds = %bb.a, %bb.e, %bb.d
  ...
  tail call void @rb_error_arity(i32 noundef %.1.i82, i32 noundef 2, i32 noundef 2) #8
  unreachable
...
rbimpl_RB_TYPE_P_fastpath.exit.thread.i:          ; preds = %bb.f, %rb_scan_args_set.exit
  tail call void @rb_unexpected_type(i64 noundef %i.l, i32 noundef 5) #9
  unreachable
...
bb.g:                                             ; preds = %Check_Type.exit
  ...
  tail call void (i64, ptr, ...) @rb_raise(i64 noundef %i.z, ptr noundef nonnull @.str.11, i64 noundef %i.y) #8
  unreachable
...
bb.k:                                             ; preds = %bb.j
  %i.ah = tail call i64 @rb_fix2int(i64 noundef %i.af) #7
  br label %rb_num2int_inline.exit

bb.l:                                             ; preds = %bb.j
  %i.ai = tail call i64 @rb_num2int(i64 noundef %i.af) #7
  br label %rb_num2int_inline.exit
...
bb.m:                                             ; preds = %RSTRING_PTR.exit
  %i.ak = call ptr @rb_string_value_cstr(ptr noundef nonnull %i.a) #7
  br label %bb.o

bb.n:                                             ; preds = %RSTRING_PTR.exit
  %i.al = sext i8 %i.ae to i32
  %i.am = load i64, ptr @rb_eArgError, align 8, !tbaa !10
  tail call void (i64, ptr, ...) @rb_raise(i64 noundef %i.am, ptr noundef nonnull @.str.12, i32 noundef %i.al) #8
  unreachable
...
rbimpl_RB_TYPE_P_fastpath.exit.thread.i33:        ; preds = %bb.q, %bb.p
  call void @rb_unexpected_type(i64 noundef %.188.i, i32 noundef 8) #9
  unreachable
...
.lr.ph.i:                                         ; preds = %Check_Type.exit34, %.lr.ph.i
  %i.aw = call i64 @rb_intern2(ptr noundef nonnull @.str.13, i64 noundef 5) #7 ; 3 uses
...
rbimpl_intern_const.exit:                         ; preds = %.lr.ph.i, %Check_Type.exit34
  ...
  %i.ax = call i64 @rb_id2sym(i64 noundef %.lcssa.i) #7
  %i.ay = call i64 @rb_hash_aref(i64 noundef %.188.i, i64 noundef %i.ax) #7
  %i.az = and i64 %i.ay, -5
...
.lr.ph.i39:                                       ; preds = %bb.s, %.lr.ph.i39
  %i.ba = call i64 @rb_intern2(ptr noundef nonnull @.str.15, i64 noundef 4) #7 ; 3 uses
...
rbimpl_intern_const.exit41:                       ; preds = %.lr.ph.i39, %bb.s
  ...
  %i.bb = call i64 @rb_id2sym(i64 noundef %.lcssa.i38) #7
  %i.bc = call i64 @rb_hash_aref(i64 noundef %.188.i, i64 noundef %i.bb) #7
  %i.bd = and i64 %i.bc, -5
...
.lr.ph.i45:                                       ; preds = %bb.u, %.lr.ph.i45
  %i.be = call i64 @rb_intern2(ptr noundef nonnull @.str.17, i64 noundef 4) #7 ; 3 uses
...
rbimpl_intern_const.exit47:                       ; preds = %.lr.ph.i45, %bb.u
  ...
  %i.bf = call i64 @rb_id2sym(i64 noundef %.lcssa.i44) #7
  %i.bg = call i64 @rb_hash_aref(i64 noundef %.188.i, i64 noundef %i.bf) #7
  %i.bh = and i64 %i.bg, -5
...
.lr.ph.i51:                                       ; preds = %bb.w, %.lr.ph.i51
  %i.bi = call i64 @rb_intern2(ptr noundef nonnull @.str.19, i64 noundef 5) #7 ; 3 uses
...
rbimpl_intern_const.exit53:                       ; preds = %.lr.ph.i51, %bb.w
  ...
  %i.bj = call i64 @rb_id2sym(i64 noundef %.lcssa.i50) #7
  %i.bk = call i64 @rb_hash_aref(i64 noundef %.188.i, i64 noundef %i.bj) #7
  %i.bl = and i64 %i.bk, -5
...
.lr.ph.i57:                                       ; preds = %bb.y, %.lr.ph.i57
  %i.bm = call i64 @rb_intern2(ptr noundef nonnull @.str.21, i64 noundef 4) #7 ; 3 uses
...
rbimpl_intern_const.exit59:                       ; preds = %.lr.ph.i57, %bb.y
  ...
  %i.bn = call i64 @rb_id2sym(i64 noundef %.lcssa.i56) #7
  %i.bo = call i64 @rb_hash_aref(i64 noundef %.188.i, i64 noundef %i.bn) #7
  %i.bp = and i64 %i.bo, -5
...
.lr.ph.i63:                                       ; preds = %bb.aa, %.lr.ph.i63
  %i.bq = call i64 @rb_intern2(ptr noundef nonnull @.str.23, i64 noundef 5) #7 ; 3 uses
...
rbimpl_intern_const.exit65:                       ; preds = %.lr.ph.i63, %bb.aa
  ...
  %i.br = call i64 @rb_id2sym(i64 noundef %.lcssa.i62) #7
  %i.bs = call i64 @rb_hash_aref(i64 noundef %.188.i, i64 noundef %i.br) #7 ; 2 uses
...
.preheader.i.preheader:                           ; preds = %rbimpl_intern_const.exit65
  ...
  %i.bv = call i64 @rb_num2uint(i64 noundef %i.bs) #7
...
.lr.ph.i71:                                       ; preds = %uint_to_str.exit, %.lr.ph.i71
  %i.ci = call i64 @rb_intern2(ptr noundef nonnull @.str.25, i64 noundef 4) #7 ; 3 uses
...
rbimpl_intern_const.exit73:                       ; preds = %.lr.ph.i71, %uint_to_str.exit
  ...
  %i.cj = call i64 @rb_id2sym(i64 noundef %.lcssa.i70) #7
  %i.ck = call i64 @rb_hash_aref(i64 noundef %.188.i, i64 noundef %i.cj) #7 ; 3 uses
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %i.co = call i64 @rb_num2uint(i64 noundef %i.ck) #7
...
uint_to_str.exit79.a:                             ; preds = %rbimpl_intern_const.exit73, %uint_to_str.exit79, %bb.ac, %bb.o
  ...
  %i.de = call nonnull ptr @rb_usascii_encoding() #7 ; 2 uses
  br i1 %i.dd, label %bb.af, label %bb.ag

bb.af:                                            ; preds = %uint_to_str.exit79.a
  %i.df = call i64 (ptr, ptr, ...) @rb_enc_sprintf(ptr noundef nonnull %i.de, ptr noundef nonnull %i.b, ptr noundef %.030) #7
  br label %bb.ah

bb.ag:                                            ; preds = %uint_to_str.exit79.a
  %i.dg = call i64 (ptr, ptr, ...) @rb_enc_sprintf(ptr noundef nonnull %i.de, ptr noundef nonnull %i.b, i32 noundef %.029) #7
  br label %bb.ah

bb.ah:                                            ; preds = %bb.ag, %bb.af
  %.0 = phi i64 [ %i.df, %bb.af ], [ %i.dg, %bb.ag ]
  %i.dh = call i64 @rb_usascii_str_new_cstr(ptr noundef nonnull %i.b) #7
  %i.di = call i64 @rb_assoc_new(i64 noundef %.0, i64 noundef %i.dh) #7
...
bb.a:
  ...
  %i.b = call ptr @rb_string_value_cstr(ptr noundef nonnull %i.a) #7
  %i.c = call i32 (ptr, i64, ptr, ...) @ruby_snprintf(ptr noundef null, i64 noundef 0, ptr noundef nonnull @.str.26, ptr noundef %i.b) #7
