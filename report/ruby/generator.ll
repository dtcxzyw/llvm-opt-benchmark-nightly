...
bb.h:                                             ; preds = %bb.f
  ...
  %i.al = call zeroext i8 %i.ak(ptr noundef nonnull %3) #25, !callees !100
...
begin_hunk_1_@raw_generate_json_string:bb.a
  ...
  %i.fn = call zeroext i8 %i.fm(ptr noundef nonnull %3) #25, !callees !100
...
begin_hunk_2_@convert_UTF8_to_ASCII_only_JSON:bb.a
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !101
...
begin_hunk_3_@convert_UTF8_to_ASCII_only_JSON:bb.a
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge.i5, label %.lr.ph.i4.epil, !llvm.loop !102
