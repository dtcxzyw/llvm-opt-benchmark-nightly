...
bb.c:                                             ; preds = %bb.a
  ...
  %or.cond.a = select i1 %i.s, i1 %switch.lobit, i1 false
  br i1 %or.cond.a, label %switch.lookup, label %bb.d
...
bb.q:                                             ; preds = %bb.p
  ...
  %or.cond103 = icmp eq i64 %i.be, 12
  br i1 %or.cond103, label %.loopexit88, label %rb_type.exit69.peel.thread
