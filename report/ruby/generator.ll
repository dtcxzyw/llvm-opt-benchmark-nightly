...
begin_hunk_0_@generate_json_float:bb.a
  ...
  %.179.i.i.sroa.gep.i = getelementptr inbounds nuw i8, ptr %i.a, i64 1 ; 2 uses
...
bb.n:                                             ; preds = %bb.m, %fbuffer_inc_capa.exit
  %.016.i = phi i64 [ 1, %bb.m ], [ 0, %fbuffer_inc_capa.exit ]
  %3 = phi i32 [ 1, %bb.m ], [ 0, %fbuffer_inc_capa.exit ]
  %i.bh = getelementptr inbounds nuw i8, ptr %i.bf, i64 %.016.i ; 25 uses
...
begin_hunk_2_@generate_json_float:bb.a
  ...
  store i8 %i.ga, ptr %.179.i.i.sroa.phi.i, align 1, !tbaa !79
...
round_digit.exit.thread.i.i.i:                    ; preds = %bb.ao, %find_cachedpow10.exit.i.i
  %.179.i.i.sroa.phi.i = phi ptr [ %.179.i.i.sroa.gep.i, %bb.ao ], [ %i.a, %find_cachedpow10.exit.i.i ]
  %.179.i.i.i = phi i32 [ 1, %bb.ao ], [ 0, %find_cachedpow10.exit.i.i ] ; 2 uses
...
begin_hunk_4_@generate_json_float:bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.nh, ptr nonnull readonly align 1 %.179.i.i.sroa.gep.i, i64 %i.nj, i1 false)
