...
.lr.ph.i4:                                        ; preds = %rb_ec_ractor_hooks.exit.i.i
  ...
  br i1 %i.e, label %.lr.ph.split.us.split.us.split.us.i13, label %.lr.ph.split.us.split.us.split.i5.preheader
...
.lr.ph.split.us.split.us.split.us.i13:            ; preds = %.lr.ph.i4
  store i8 1, ptr %i.f, align 4, !tbaa !22
  br label %.lr.ph.split.us.split.us.split.us.i13.a

.lr.ph.split.us.split.us.split.us.i13.a:          ; preds = %.lr.ph.split.us.split.us.split.us.i13.a, %.lr.ph.split.us.split.us.split.us.i13
  %.022.us.us.us.i14 = phi ptr [ %.019.i2, %.lr.ph.split.us.split.us.split.us.i13 ], [ %.0.us.us.us.i16, %.lr.ph.split.us.split.us.split.us.i13.a ] ; 3 uses
  ...
  br i1 %.not.us.us.us.i17, label %._crit_edge.i11, label %.lr.ph.split.us.split.us.split.us.i13.a, !llvm.loop !71
...
._crit_edge.i11:                                  ; preds = %.lr.ph.split.us.split.us.split.us.i13.a, %bb.c, %rb_ec_ractor_hooks.exit.i.i.thread, %rb_ec_ractor_hooks.exit.i.i
  %i.r = phi ptr [ inttoptr (i64 16 to ptr), %rb_ec_ractor_hooks.exit.i.i.thread ], [ %i.h, %bb.c ], [ %i.d, %rb_ec_ractor_hooks.exit.i.i ], [ %i.d, %.lr.ph.split.us.split.us.split.us.i13.a ]
  %.0.i.i.i.i25 = phi ptr [ null, %rb_ec_ractor_hooks.exit.i.i.thread ], [ %.0.i.i.i.i2430, %bb.c ], [ %i.c, %rb_ec_ractor_hooks.exit.i.i ], [ %i.c, %.lr.ph.split.us.split.us.split.us.i13.a ] ; 2 uses
...
.lr.ph.split.us.split.us.split.us.i:              ; preds = %.lr.ph.i
  ...
  br label %.lr.ph.split.us.split.us.split.us.i.a

.lr.ph.split.us.split.us.split.us.i.a:            ; preds = %.lr.ph.split.us.split.us.split.us.i.a, %.lr.ph.split.us.split.us.split.us.i
  %.022.us.us.us.i = phi ptr [ %.019.i, %.lr.ph.split.us.split.us.split.us.i ], [ %.0.us.us.us.i, %.lr.ph.split.us.split.us.split.us.i.a ] ; 3 uses
  ...
  br i1 %.not.us.us.us.i, label %._crit_edge.i, label %.lr.ph.split.us.split.us.split.us.i.a, !llvm.loop !71
...
._crit_edge.i:                                    ; preds = %bb.h, %.lr.ph.split.us.split.us.split.us.i.a, %rb_threadptr_remove_event_hook.exit
...
rb_ec_ractor_hooks.exit.i.i:                      ; preds = %bb.b, %bb.a
  ...
  br i1 %.not20.i2, label %._crit_edge.i10, label %.lr.ph.i3

.lr.ph.i3:                                        ; preds = %rb_ec_ractor_hooks.exit.i.i
  store i8 1, ptr %.phi.trans.insert, align 4, !tbaa !22
  br label %.lr.ph.split.us.split.us.split.us.i4

.lr.ph.split.us.split.us.split.us.i4:             ; preds = %.lr.ph.split.us.split.us.split.us.i4, %.lr.ph.i3
  %.022.us.us.us.i5 = phi ptr [ %.019.i1, %.lr.ph.i3 ], [ %.0.us.us.us.i7, %.lr.ph.split.us.split.us.split.us.i4 ] ; 3 uses
  ...
  br i1 %.not.us.us.us.i8, label %bb.c, label %.lr.ph.split.us.split.us.split.us.i4, !prof !75, !llvm.loop !71
...
bb.c:                                             ; preds = %.lr.ph.split.us.split.us.split.us.i4, %._crit_edge.i10
...
rb_threadptr_remove_event_hook.exit:              ; preds = %remove_event_hook_from_list.exit12, %bb.e
  %.0.i.i12.i.i = phi ptr [ %i.m, %bb.e ], [ null, %remove_event_hook_from_list.exit12 ] ; 3 uses
...
.lr.ph.split.us.split.us.split.us.i:              ; preds = %.lr.ph.split.us.split.us.split.us.i, %.lr.ph.i
  %.022.us.us.us.i = phi ptr [ %.019.i, %.lr.ph.i ], [ %.0.us.us.us.i, %.lr.ph.split.us.split.us.split.us.i ] ; 3 uses
  ...
  %.not.us.us.us.i = icmp eq ptr %.0.us.us.us.i, null
  br i1 %.not.us.us.us.i, label %bb.f, label %.lr.ph.split.us.split.us.split.us.i, !prof !75, !llvm.loop !71

._crit_edge.i:                                    ; preds = %rb_threadptr_remove_event_hook.exit
  %.pre15 = load i8, ptr %.phi.trans.insert12, align 4, !tbaa !22, !range !72
  %i.r = trunc nuw i8 %.pre15 to i1
  br i1 %i.r, label %bb.f, label %remove_event_hook_from_list.exit, !prof !76

bb.f:                                             ; preds = %.lr.ph.split.us.split.us.split.us.i, %._crit_edge.i
...
.lr.ph.split.us.split.us.split.us:                ; preds = %.lr.ph.split.us.split.us
  ...
  br label %.lr.ph.split.us.split.us.split.us.a

.lr.ph.split.us.split.us.split.us.a:              ; preds = %.lr.ph.split.us.split.us.split.us.a, %.lr.ph.split.us.split.us.split.us
  %.022.us.us.us = phi ptr [ %.019, %.lr.ph.split.us.split.us.split.us ], [ %.0.us.us.us, %.lr.ph.split.us.split.us.split.us.a ] ; 3 uses
  %.01721.us.us.us = phi i32 [ 0, %.lr.ph.split.us.split.us.split.us ], [ %i.g, %.lr.ph.split.us.split.us.split.us.a ]
...
begin_hunk_8_@remove_event_hook_from_list:bb.a
  ...
  br i1 %.not.us.us.us, label %._crit_edge, label %.lr.ph.split.us.split.us.split.us.a, !llvm.loop !71
...
._crit_edge:                                      ; preds = %bb.t, %bb.p, %bb.m, %bb.j, %bb.h, %bb.e, %bb.c, %.lr.ph.split.us.split.us.split.us.a, %bb.a
  %.017.lcssa = phi i32 [ 0, %bb.a ], [ %.1.us.us44, %bb.e ], [ %i.g, %.lr.ph.split.us.split.us.split.us.a ], [ %.1.us34, %bb.p ], [ %.1.us.us, %bb.c ], [ %.1.us26.us, %bb.j ], [ %.1.us, %bb.h ], [ %.1.us26, %bb.m ], [ %.1, %bb.t ]
