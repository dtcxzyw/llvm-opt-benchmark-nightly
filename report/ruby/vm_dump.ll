...
begin_hunk_0_@rb_vm_bugreport:bb.a
  ...
  br i1 %i.ij, label %.thread179, label %bb.bu
...
bb.bu:                                            ; preds = %rb_dump_machine_register.exit
  ...
  br i1 %i.im, label %.thread179, label %bb.bv
...
bb.bv:                                            ; preds = %bb.bu
  ...
  br i1 %i.io, label %.thread179, label %bb.bw
...
RSTRING_PTR.exit:                                 ; preds = %bb.bz, %bb.ca
  ...
  br i1 %i.jd, label %.thread179, label %bb.cb
...
bb.cb:                                            ; preds = %RSTRING_PTR.exit
  ...
  br i1 %i.jf, label %.thread179, label %bb.cc
...
bb.cd:                                            ; preds = %bb.cc
  ...
  br i1 %i.jj, label %.thread179, label %bb.ce
...
bb.ch:                                            ; preds = %bb.cf, %bb.cg
  ...
  br i1 %i.jv, label %.thread179, label %bb.ck
...
bb.ci:                                            ; preds = %bb.ce
  ...
  br i1 %i.jx, label %.thread179, label %bb.ck
...
bb.cj:                                            ; preds = %bb.cc
  ...
  br i1 %i.jz, label %.thread179, label %bb.ck
...
bb.cl:                                            ; preds = %bb.ck
  ...
  br i1 %i.kb, label %.thread179, label %.preheader188

.preheader188:                                    ; preds = %bb.cl
  %i.kc = inttoptr i64 %.0106 to ptr              ; 3 uses
  %i.kd = getelementptr i8, ptr %i.kc, i64 16     ; 2 uses
  %i.ke = getelementptr i8, ptr %i.kc, i64 32
  br label %bb.cm

bb.cm:                                            ; preds = %.preheader188, %bb.cu
  %.0107 = phi i32 [ %i.ne, %bb.cu ], [ 0, %.preheader188 ] ; 7 uses
...
RSTRING_PTR.exit152:                              ; preds = %bb.co, %bb.cp
  ...
  br i1 %i.lg, label %.thread179, label %bb.cu
...
bb.cw:                                            ; preds = %bb.cv
  ...
  br i1 %i.nj, label %.thread179, label %.preheader
...
bb.cx:                                            ; preds = %fread.inline.exit, %.preheader
  ...
  br i1 %i.np, label %.thread179, label %bb.cy

.thread179:                                       ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.thread, %RSTRING_PTR.exit156, %rbimpl_RB_TYPE_P_fastpath.exit133.thread, %RSTRING_PTR.exit154, %RSTRING_PTR.exit152, %bb.cx, %bb.cw, %.loopexit, %bb.ch, %bb.cl, %bb.cj, %bb.cd, %bb.cb, %RSTRING_PTR.exit, %bb.ci, %bb.bv, %bb.bu, %rb_dump_machine_register.exit, %bb.q, %bb.p, %rb_ec_ractor_ptr.exit, %bb.n, %bb.m, %bb.l, %bb.f
  br label %bb.cy

bb.cy:                                            ; preds = %bb.cx, %bb.cv, %bb.f, %.thread179
  %.0 = phi i1 [ false, %.thread179 ], [ true, %bb.f ], [ true, %bb.cv ], [ true, %bb.cx ]
  ret i1 %.0
}
