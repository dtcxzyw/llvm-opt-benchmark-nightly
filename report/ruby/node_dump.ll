...
rb_dump_literal.exit5208:                         ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.i.i5205, %bb.gj, %bb.gk
  ...
  %i.cfa = load i32, ptr %i.cew, align 8, !tbaa !343
  %i.cfb = load i32, ptr %i.cex, align 4, !tbaa !344
  %i.cfc = load i32, ptr %i.cey, align 8, !tbaa !345
  ...
  %i.cfm = load i32, ptr %i.cfi, align 8, !tbaa !347
  %i.cfn = load i32, ptr %i.cfj, align 4, !tbaa !348
  %i.cfo = load i32, ptr %i.cfk, align 8, !tbaa !349
  ...
  %i.cfy = load i32, ptr %i.cfu, align 8, !tbaa !351
  %i.cfz = load i32, ptr %i.cfv, align 4, !tbaa !352
  %i.cga = load i32, ptr %i.cfw, align 8, !tbaa !353
