...
mbc_enc_len.exit.thread25:                        ; preds = %bb.d, %bb.g, %bb.i
...
.lr.ph.preheader:                                 ; preds = %mbc_enc_len.exit, %mbc_enc_len.exit.thread25
  %i.ap = phi i32 [ %i.aj, %mbc_enc_len.exit.thread25 ], [ %i.an, %mbc_enc_len.exit ]
  %.0.i27 = phi i32 [ %.0.i.ph, %mbc_enc_len.exit.thread25 ], [ %i.am, %mbc_enc_len.exit ] ; 3 uses
  %.01628 = add i32 %.0.i27, -1                   ; 3 uses
  %i.aq = sub nsw i32 7, %.0.i27
  %notmask = shl nsw i32 -1, %i.aq
  %i.ar = xor i32 %notmask, -1
  %i.as = and i32 %i.ap, %i.ar                    ; 2 uses
  %i.at = add i32 %.0.i27, -2
  %xtraiter = and i32 %.01628, 3                  ; 2 uses
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol

.lr.ph.prol:                                      ; preds = %.lr.ph.preheader, %.lr.ph.prol
  %.01632.prol = phi i32 [ %.016.prol, %.lr.ph.prol ], [ %.01628, %.lr.ph.preheader ]
  %.031.prol = phi i32 [ %i.ay, %.lr.ph.prol ], [ %i.as, %.lr.ph.preheader ]
  %.pn30.prol = phi ptr [ %.018.prol, %.lr.ph.prol ], [ %0, %.lr.ph.preheader ]
  %prol.iter = phi i32 [ %prol.iter.next, %.lr.ph.prol ], [ 0, %.lr.ph.preheader ]
  %.018.prol = getelementptr i8, ptr %.pn30.prol, i64 1 ; 3 uses
  %i.au = load i8, ptr %.018.prol, align 1, !tbaa !11
  %i.av = shl i32 %.031.prol, 6
  %i.aw = and i8 %i.au, 63
  %i.ax = zext nneg i8 %i.aw to i32
  %i.ay = or disjoint i32 %i.av, %i.ax            ; 3 uses
  %.016.prol = add i32 %.01632.prol, -1           ; 2 uses
...
.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader
  ...
  %.01632.unr = phi i32 [ %.01628, %.lr.ph.preheader ], [ %.016.prol, %.lr.ph.prol ]
  %.031.unr = phi i32 [ %i.as, %.lr.ph.preheader ], [ %i.ay, %.lr.ph.prol ]
  %.pn30.unr = phi ptr [ %0, %.lr.ph.preheader ], [ %.018.prol, %.lr.ph.prol ]
  %i.az = icmp ult i32 %i.at, 3
  br i1 %i.az, label %.loopexit, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  %.01632 = phi i32 [ %.016.3, %.lr.ph ], [ %.01632.unr, %.lr.ph.prol.loopexit ]
  %.031 = phi i32 [ %i.bt, %.lr.ph ], [ %.031.unr, %.lr.ph.prol.loopexit ]
  %.pn30 = phi ptr [ %.018.3, %.lr.ph ], [ %.pn30.unr, %.lr.ph.prol.loopexit ] ; 4 uses
  %.018 = getelementptr i8, ptr %.pn30, i64 1
  %i.ba = load i8, ptr %.018, align 1, !tbaa !11
  %i.bb = and i8 %i.ba, 63
  %i.bc = zext nneg i8 %i.bb to i32
  %.018.1 = getelementptr i8, ptr %.pn30, i64 2
  ...
  %.018.2 = getelementptr i8, ptr %.pn30, i64 3
  %i.bk = load i8, ptr %.018.2, align 1, !tbaa !11
  %i.bl = and i8 %i.bk, 63
  %i.bm = zext nneg i8 %i.bl to i32
  %.018.3 = getelementptr i8, ptr %.pn30, i64 4   ; 2 uses
