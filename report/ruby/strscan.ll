...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.h
  %.130 = phi i64 [ %i.au, %bb.h ], [ %i.ah, %.lr.ph.preheader ] ; 3 uses
...
.lr.ph..critedge.loopexit_crit_edge:              ; preds = %.lr.ph
  %.130.lcssa.a = phi i64 [ %.130, %.lr.ph ]
  br label %.critedge.loopexit

.critedge.loopexit:                               ; preds = %.critedge.loopexitsplit, %.lr.ph..critedge.loopexit_crit_edge
  %.1.lcssa.ph = phi i64 [ %.130.lcssa.a, %.lr.ph..critedge.loopexit_crit_edge ], [ %i.ad, %.critedge.loopexitsplit ]
  br label %.critedge
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.m
  %.261 = phi i64 [ %i.bk, %bb.m ], [ %.1, %.lr.ph.preheader ] ; 3 uses
...
switch.early.test60..critedge.loopexit_crit_edge: ; preds = %switch.early.test60
  %.261.lcssa.a = phi i64 [ %.261, %switch.early.test60 ]
  br label %.critedge.loopexit

.critedge.loopexit:                               ; preds = %.critedge.loopexitsplit, %switch.early.test60..critedge.loopexit_crit_edge
  %.2.lcssa.ph = phi i64 [ %.261.lcssa.a, %switch.early.test60..critedge.loopexit_crit_edge ], [ %i.ad, %.critedge.loopexitsplit ]
  br label %.critedge
