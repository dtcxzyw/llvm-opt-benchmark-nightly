...
rbimpl_RB_TYPE_P_fastpath.exit.i.i:               ; preds = %bb.k
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #22
  %i.bw = load i64, ptr %i.bi, align 8, !tbaa !11
  %i.bx = and i64 %i.bw, 31
  %i.by = icmp eq i64 %i.bx, 5
  br i1 %i.by, label %rb_get_path.exit, label %rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i
...
.lr.ph.i.i.i:                                     ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i, %.lr.ph.i.i.i
  %i.bz = call i64 @rb_intern2(ptr noundef nonnull @.str, i64 noundef 7) #22 ; 3 uses
  store i64 %i.bz, ptr @rb_get_path_check_to_string.rbimpl_id, align 8, !tbaa !14
  %.not.i.i.i = icmp eq i64 %i.bz, 0
  br i1 %.not.i.i.i, label %.lr.ph.i.i.i, label %rbimpl_intern_const.exit.i.i, !llvm.loop !15

rbimpl_intern_const.exit.i.i:                     ; preds = %.lr.ph.i.i.i, %rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i
  %.lcssa.i.i.i = phi i64 [ %.pr.i.i.i, %rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i ], [ %i.bz, %.lr.ph.i.i.i ]
  %i.ca = call i64 @rb_check_funcall_default(i64 noundef %i.bd, i64 noundef %.lcssa.i.i.i, i32 noundef 0, ptr noundef null, i64 noundef %i.bd) #22
  store i64 %i.ca, ptr %i.a, align 8, !tbaa !14
  %i.cb = call i64 @rb_string_value(ptr noundef nonnull %i.a) #22 ; 0 uses
  %i.cc = load i64, ptr %i.a, align 8, !tbaa !14
  br label %rb_get_path.exit

rb_get_path.exit:                                 ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.i.i, %rbimpl_intern_const.exit.i.i
  %.0.i.i70 = phi i64 [ %i.cc, %rbimpl_intern_const.exit.i.i ], [ %i.bd, %rbimpl_RB_TYPE_P_fastpath.exit.i.i ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #22
  %i.cd = call i64 @rb_get_path_check_convert(i64 noundef %.0.i.i70)
  store i64 %i.cd, ptr %i.b, align 8, !tbaa !14
  br label %bb.q
...
bb.q:                                             ; preds = %rb_get_path.exit, %bb.p, %check_path_encoding.exit69
  ...
  %i.ce = load i64, ptr %i.aq, align 8, !tbaa !11
  %i.cf = and i64 %i.ce, 8192
  %.not.i71 = icmp eq i64 %i.cf, 0
  br i1 %.not.i71, label %RSTRING_PTR.exit, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.cg = load ptr, ptr %i.as, align 8, !tbaa !36
  br label %RSTRING_PTR.exit

RSTRING_PTR.exit:                                 ; preds = %bb.q, %bb.r
  %i.ch = phi ptr [ %i.cg, %bb.r ], [ %i.as, %bb.q ] ; 5 uses
  %i.ci = icmp eq i64 %.144, 0
  br i1 %i.ci, label %bb.s, label %bb.t

bb.s:                                             ; preds = %RSTRING_PTR.exit
  %i.cj = load i64, ptr %i.b, align 8, !tbaa !14
  call void @rb_enc_copy(i64 noundef %i.ap, i64 noundef %i.cj) #22
  br label %bb.y

bb.t:                                             ; preds = %RSTRING_PTR.exit
  %i.ck = load i64, ptr %i.at, align 8, !tbaa !90
  %i.cl = getelementptr i8, ptr %i.ch, i64 %i.ck  ; 5 uses
  %i.cm = call ptr @rb_enc_get(i64 noundef %i.ap) #22
  %i.cn = icmp ult ptr %i.ch, %i.cl
  br i1 %i.cn, label %.lr.ph.i, label %chompdirsep.exit

.lr.ph.i:                                         ; preds = %bb.t, %.critedge.thread.i
  %.01822.i = phi ptr [ %.220.i, %.critedge.thread.i ], [ %i.ch, %bb.t ] ; 6 uses
  %i.co = load i8, ptr %.01822.i, align 1, !tbaa !36
  %i.cp = icmp eq i8 %i.co, 47
  br i1 %i.cp, label %.preheader.i.preheader, label %bb.u

.preheader.i.preheader:                           ; preds = %.lr.ph.i
  %.119.i136 = getelementptr i8, ptr %.01822.i, i64 1 ; 2 uses
  %i.cq = icmp ult ptr %.119.i136, %i.cl
  br i1 %i.cq, label %.lr.ph, label %chompdirsep.exit

.preheader.i:                                     ; preds = %.lr.ph
  %.119.i = getelementptr i8, ptr %.119.i137, i64 1 ; 2 uses
  %i.cr = icmp ult ptr %.119.i, %i.cl
  br i1 %i.cr, label %.lr.ph, label %chompdirsep.exit, !llvm.loop !88

.lr.ph:                                           ; preds = %.preheader.i.preheader, %.preheader.i
  %.119.i137 = phi ptr [ %.119.i, %.preheader.i ], [ %.119.i136, %.preheader.i.preheader ] ; 3 uses
  %i.cs = load i8, ptr %.119.i137, align 1, !tbaa !36
  %i.ct = icmp eq i8 %i.cs, 47
  br i1 %i.ct, label %.preheader.i, label %.critedge.thread.i, !llvm.loop !88

bb.u:                                             ; preds = %.lr.ph.i
  %i.cu = call i32 @rb_enc_mbclen(ptr noundef nonnull %.01822.i, ptr noundef nonnull %i.cl, ptr noundef %i.cm) #22
  %i.cv = sext i32 %i.cu to i64
  %i.cw = getelementptr i8, ptr %.01822.i, i64 %i.cv
  br label %.critedge.thread.i

.critedge.thread.i:                               ; preds = %.lr.ph, %bb.u
  %.220.i = phi ptr [ %i.cw, %bb.u ], [ %.119.i137, %.lr.ph ] ; 3 uses
  %i.cx = icmp ult ptr %.220.i, %i.cl
  br i1 %i.cx, label %.lr.ph.i, label %chompdirsep.exit, !llvm.loop !89

chompdirsep.exit:                                 ; preds = %.critedge.thread.i, %.preheader.i.preheader, %.preheader.i, %bb.t
  %.018.lcssa.i = phi ptr [ %i.ch, %bb.t ], [ %.01822.i, %.preheader.i ], [ %.220.i, %.critedge.thread.i ], [ %.01822.i, %.preheader.i.preheader ] ; 2 uses
  %i.cy = load i64, ptr %i.b, align 8, !tbaa !14
  %i.cz = inttoptr i64 %i.cy to ptr               ; 2 uses
  %i.da = load i64, ptr %i.cz, align 8, !tbaa !11
  %i.db = and i64 %i.da, 8192
  %.not.i72 = icmp eq i64 %i.db, 0
  %i.dc = getelementptr i8, ptr %i.cz, i64 24     ; 3 uses
...
bb.v:                                             ; preds = %RSTRING_PTR.exit75
  %i.dh = ptrtoint ptr %.018.lcssa.i to i64
  %i.di = ptrtoint ptr %i.ch to i64
  %i.dj = sub i64 %i.dh, %i.di
  call void @rb_str_set_len(i64 noundef %i.ap, i64 noundef %i.dj) #22
  br label %bb.y

bb.w:                                             ; preds = %RSTRING_PTR.exit73.thread, %RSTRING_PTR.exit75, %RSTRING_PTR.exit73
  %i.dk = load i8, ptr %.018.lcssa.i, align 1, !tbaa !36
  %.not51 = icmp eq i8 %i.dk, 0
  br i1 %.not51, label %bb.x, label %bb.y

bb.x:                                             ; preds = %bb.w
  %i.dl = call i64 @rb_str_cat(i64 noundef %i.ap, ptr noundef nonnull @.str.67, i64 noundef 1) #22 ; 0 uses
  br label %bb.y

bb.y:                                             ; preds = %bb.v, %bb.x, %bb.w, %bb.s
  %i.dm = load i64, ptr %i.b, align 8, !tbaa !14  ; 2 uses
  %i.dn = call ptr @rb_enc_check(i64 noundef %i.ap, i64 noundef %i.dm) #22 ; 2 uses
  %i.do = call i32 @rb_enc_to_index(ptr noundef %i.dn) #23
  %i.dp = icmp eq i32 %i.do, 2
  br i1 %i.dp, label %bb.z, label %fs_enc_check.exit

bb.z:                                             ; preds = %bb.y
  %i.dq = call i32 @rb_enc_get_index(i64 noundef %i.ap) #22 ; 2 uses
  %i.dr = icmp eq i32 %i.dq, 2
  br i1 %i.dr, label %bb.aa, label %bb.ab

bb.aa:                                            ; preds = %bb.z
  %i.ds = call i32 @rb_enc_get_index(i64 noundef %i.dm) #22
  br label %bb.ab

bb.ab:                                            ; preds = %bb.aa, %bb.z
  %.0.i76 = phi i32 [ %i.ds, %bb.aa ], [ %i.dq, %bb.z ]
  %i.dt = call ptr @rb_enc_from_index(i32 noundef %.0.i76) #22
  br label %fs_enc_check.exit

fs_enc_check.exit:                                ; preds = %bb.y, %bb.ab
  %.08.i = phi ptr [ %i.dt, %bb.ab ], [ %i.dn, %bb.y ]
  %i.du = load i64, ptr %i.b, align 8, !tbaa !14
  %i.dv = call i64 @rb_str_buf_append(i64 noundef %i.ap, i64 noundef %i.du) #22 ; 0 uses
  %i.dw = call i64 @rb_enc_associate(i64 noundef %i.ap, ptr noundef %.08.i) #22 ; 0 uses
  %i.dx = add i64 %.144, 1
  br label %bb.i, !llvm.loop !217

bb.ac:                                            ; preds = %rb_array_len.exit59.thread, %rb_array_len.exit59
  %i.dy = load i64, ptr @rb_cString, align 8, !tbaa !14
  store i64 %i.dy, ptr %i.ar, align 8, !tbaa !14
  br label %bb.ad
