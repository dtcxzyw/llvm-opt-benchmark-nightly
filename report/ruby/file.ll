...
bb.a:
  ...
  %i.c = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %2) #24
  %i.d = getelementptr i8, ptr %2, i64 %i.c       ; 5 uses
...
rb_enc_path_next.exit:                            ; preds = %.lr.ph.i145, %bb.c
  %.0.lcssa.i = phi ptr [ %.09.i, %.lr.ph.i145 ], [ %i.u, %bb.c ] ; 6 uses
...
.lr.ph:                                           ; preds = %rb_enc_path_next.exit, %bb.d
  %.0124164 = phi ptr [ %i.ac, %bb.d ], [ %.0.lcssa.i, %rb_enc_path_next.exit ] ; 3 uses
  %i.aa = load i8, ptr %.0124164, align 1, !tbaa !36
  %i.ab = icmp eq i8 %i.aa, 47
  br i1 %i.ab, label %bb.d, label %.critedge

bb.d:                                             ; preds = %.lr.ph
  %i.ac = getelementptr i8, ptr %.0124164, i64 1  ; 3 uses
  %10 = icmp ult ptr %i.ac, %i.d
  br i1 %10, label %.lr.ph, label %.critedge, !llvm.loop !218

.critedge:                                        ; preds = %.lr.ph, %bb.d, %rb_enc_path_next.exit
  %.0124.lcssa = phi ptr [ %.0.lcssa.i, %rb_enc_path_next.exit ], [ %i.ac, %bb.d ], [ %.0124164, %.lr.ph ]
...
RSTRING_PTR.exit150:                              ; preds = %bb.s, %bb.t
  ...
  %i.ck = call ptr @rb_nogvl(ptr noundef nonnull @no_gvl_lstat, ptr noundef nonnull %8, ptr noundef nonnull inttoptr (i64 -1 to ptr), ptr noundef null, i32 noundef 4) #23
...
RSTRING_PTR.exit152:                              ; preds = %bb.w, %bb.x
  ...
  %i.cv = call ptr @rb_nogvl(ptr noundef nonnull @no_gvl_stat, ptr noundef nonnull %7, ptr noundef nonnull inttoptr (i64 -1 to ptr), ptr noundef null, i32 noundef 4) #23
