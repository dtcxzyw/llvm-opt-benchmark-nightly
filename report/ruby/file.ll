...
begin_hunk_1_@rb_file_s_link:bb.a
  ...
  %3 = load i64, ptr %i.d, align 8, !tbaa !14     ; 6 uses
...
rbimpl_intern_const.exit.i.i6:                    ; preds = %.lr.ph.i.i.i9, %rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i3
  ...
  %i.ad = call i64 @rb_check_funcall_default(i64 noundef %3, i64 noundef %.lcssa.i.i.i7, i32 noundef 0, ptr noundef null, i64 noundef %3) #22
...
rb_get_path.exit11:                               ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.i.i2, %rbimpl_intern_const.exit.i.i6
  %.0.i.i8 = phi i64 [ %i.af, %rbimpl_intern_const.exit.i.i6 ], [ %3, %rbimpl_RB_TYPE_P_fastpath.exit.i.i2 ]
...
begin_hunk_7_@rb_file_s_rename:bb.a
  ...
  %4 = load i64, ptr %i.d, align 8, !tbaa !14     ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #22
  %i.w = icmp eq i64 %4, 0
  %i.x = and i64 %4, 7
...
rbimpl_intern_const.exit.i.i6:                    ; preds = %.lr.ph.i.i.i9, %rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i3
  ...
  %i.af = call i64 @rb_check_funcall_default(i64 noundef %4, i64 noundef %.lcssa.i.i.i7, i32 noundef 0, ptr noundef null, i64 noundef %4) #22
...
rb_get_path.exit11:                               ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.i.i2, %rbimpl_intern_const.exit.i.i6
  %.0.i.i8 = phi i64 [ %i.ah, %rbimpl_intern_const.exit.i.i6 ], [ %4, %rbimpl_RB_TYPE_P_fastpath.exit.i.i2 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #22
...
begin_hunk_10_@rb_check_realpath_emulate:bb.a
  ...
  %i.j = tail call i64 @rb_str_new_frozen(i64 noundef %1) #22 ; 2 uses
...
begin_hunk_11_@rb_check_realpath_emulate:bb.a
  ...
  %.pre = load i64, ptr %i.e, align 8, !tbaa !14
  br label %bb.c

bb.c:                                             ; preds = %rb_get_path.exit, %bb.a
  %4 = phi i64 [ %.pre, %rb_get_path.exit ], [ %i.j, %bb.a ] ; 4 uses
  %i.ab = call ptr @rb_enc_get(i64 noundef %4) #22 ; 2 uses
  %i.ac = inttoptr i64 %4 to ptr                  ; 3 uses
...
begin_hunk_12_@rb_check_realpath_emulate:bb.a
  ...
  %i.al = call ptr @rb_enc_get(i64 noundef %4) #22 ; 0 uses
...
skipprefixroot.exit80:                            ; preds = %bb.m, %.lr.ph.i.i77, %RSTRING_PTR.exit74, %skipprefixroot.exit, %bb.j
  ...
  %.sink112 = phi i64 [ %4, %skipprefixroot.exit ], [ %i.bg, %bb.j ], [ %i.bh, %RSTRING_PTR.exit74 ], [ %i.bh, %.lr.ph.i.i77 ], [ %i.bh, %bb.m ]
