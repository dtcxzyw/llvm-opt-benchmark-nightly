...
bb.c:                                             ; preds = %.preheader, %bb.b
  ...
  %.185.i.lcssa = phi i64 [ 1, %bb.b ], [ 0, %.preheader ]
  %.185.i.lcssa.a = phi i32 [ 1, %bb.b ], [ 0, %.preheader ] ; 2 uses
...
.thread:                                          ; preds = %bb.c
  ...
  %i.i = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.185.i.lcssa
...
bb.c:                                             ; preds = %.preheader, %bb.b
  ...
  %.185.i.lcssa = phi i64 [ 2, %bb.b ], [ 1, %.preheader ]
  %.185.i.lcssa.a = phi i32 [ 2, %bb.b ], [ 1, %.preheader ] ; 2 uses
...
.thread:                                          ; preds = %bb.c
  ...
  %i.l = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.185.i.lcssa
...
.preheader2:                                      ; preds = %bb.a
  %.not = icmp eq i32 %0, 1
  br i1 %.not, label %rb_scan_args_set.exit.critedge, label %bb.b

bb.b:                                             ; preds = %.preheader2
  %3 = icmp eq i32 %0, 2
  %4 = load <2 x i64>, ptr %1, align 8, !tbaa !10
  store <2 x i64> %4, ptr %i.b, align 8, !tbaa !10
  br i1 %3, label %rb_scan_args_set.exit, label %bb.c

bb.c:                                             ; preds = %bb.b, %bb.a
  tail call void @rb_error_arity(i32 noundef %0, i32 noundef 1, i32 noundef 2) #5
  unreachable

rb_scan_args_set.exit.critedge:                   ; preds = %.preheader2
  store i64 4, ptr %i.b, align 8, !tbaa !10
  %5 = load i64, ptr %1, align 8, !tbaa !10
  store i64 %5, ptr %i.c, align 16, !tbaa !10
  br label %rb_scan_args_set.exit
...
bb.a:
  ...
  br i1 %i.d, label %5, label %.preheader2
...
bb.b:                                             ; preds = %.preheader2
  ...
  %3 = icmp eq i32 %0, 3
  %4 = load <2 x i64>, ptr %i.g, align 8, !tbaa !10
  store <2 x i64> %4, ptr %i.b, align 16, !tbaa !10
  br i1 %3, label %rb_scan_args_set.exit, label %5

5:                                                ; preds = %bb.b, %bb.a
  tail call void @rb_error_arity(i32 noundef %0, i32 noundef 2, i32 noundef 3) #5
  unreachable

bb.c:                                             ; preds = %.preheader2
  store i64 4, ptr %i.b, align 16, !tbaa !10
  %6 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.h = load i64, ptr %6, align 8, !tbaa !10
  store i64 %i.h, ptr %i.c, align 8, !tbaa !10
  br label %rb_scan_args_set.exit

rb_scan_args_set.exit:                            ; preds = %bb.c, %bb.b
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.j = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.185.i.lcssa
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.m = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.185.i.lcssa
...
begin_hunk_11_@scan_args_opt_var_hash:rb_scan_args_n_opt.exit
  ...
  %.185.i.lcssa = phi i64 [ 1, %.preheader.thread22 ], [ 0, %bb.b ], [ 0, %.preheader ]
  %.185.i.lcssa.a = phi i32 [ 1, %.preheader.thread22 ], [ 0, %bb.b ], [ 0, %.preheader ] ; 2 uses
  store i64 %.sink, ptr %i.b, align 8, !tbaa !10
...
.thread28:                                        ; preds = %.preheader.thread
  ...
  %i.r = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.185.i.lcssa
...
bb.d:                                             ; preds = %.preheader, %bb.c
  ...
  %.185.i.lcssa = phi i64 [ 2, %bb.c ], [ 1, %.preheader ]
  %.185.i.lcssa.a = phi i32 [ 2, %bb.c ], [ 1, %.preheader ] ; 2 uses
...
.thread20:                                        ; preds = %bb.d
  ...
  %i.v = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.185.i.lcssa
...
bb.d:                                             ; preds = %.preheader5, %bb.c
  ...
  %.286.i = phi i64 [ 1, %bb.c ], [ 0, %.preheader5 ]
  %3 = phi i32 [ 2, %bb.c ], [ 1, %.preheader5 ]
  store i64 %.sink, ptr %i.b, align 8, !tbaa !10
  %i.p = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.286.i
  %i.q = load i64, ptr %i.p, align 8, !tbaa !10
  store i64 %i.q, ptr %i.c, align 16, !tbaa !10
  store i64 %.188.i14, ptr %i.d, align 8, !tbaa !10
  %i.r = icmp eq i32 %3, %.1.i15
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %.188.i = phi i64 [ 4, %bb.a ], [ %i.l, %bb.b ] ; 2 uses
...
begin_hunk_18_@scan_args_lead_opt_trail_hash:rb_scan_args_n_opt.exit
  ...
  br i1 %.not10, label %rb_scan_args_set.exit.critedge, label %bb.d

bb.d:                                             ; preds = %.preheader2
  %3 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %4 = icmp eq i32 %.1.i, 3
  %5 = load <2 x i64>, ptr %3, align 8, !tbaa !10
  store <2 x i64> %5, ptr %i.c, align 16, !tbaa !10
...
rb_scan_args_set.exit.critedge:                   ; preds = %.preheader2
  store i64 4, ptr %i.c, align 16, !tbaa !10
  %6 = getelementptr inbounds nuw i8, ptr %1, i64 8
  %7 = load i64, ptr %6, align 8, !tbaa !10
  store i64 %7, ptr %i.d, align 8, !tbaa !10
  store i64 %.188.i, ptr %i.e, align 16, !tbaa !10
  br label %rb_scan_args_set.exit

rb_scan_args_set.exit:                            ; preds = %rb_scan_args_set.exit.critedge, %bb.d
...
bb.d:                                             ; preds = %.preheader, %bb.c
  ...
  %.185.i.lcssa = phi i64 [ 1, %bb.c ], [ 0, %.preheader ]
  %.185.i.lcssa.a = phi i32 [ 1, %bb.c ], [ 0, %.preheader ] ; 2 uses
  store i64 %.sink, ptr %i.b, align 8, !tbaa !10
  %.neg = xor i32 %.185.i.lcssa.a, -1
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.t = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.185.i.lcssa
...
bb.e:                                             ; preds = %.preheader, %bb.d
  ...
  %.185.i.lcssa = phi i64 [ 2, %bb.d ], [ 1, %.preheader ]
  %.185.i.lcssa.a = phi i32 [ 2, %bb.d ], [ 1, %.preheader ] ; 2 uses
  store i64 %.sink, ptr %i.c, align 16, !tbaa !10
  %.neg = xor i32 %.185.i.lcssa.a, -1
