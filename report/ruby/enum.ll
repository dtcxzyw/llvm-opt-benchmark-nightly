...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %i.y, label %rb_type.exit27.thread36, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.z = and i64 %.0, 254
  %i.aa = icmp eq i64 %i.z, 12
  br i1 %i.aa, label %rb_type.exit27.thread, label %rb_type.exit27.thread38
...
sum_iter_normalize_memo.exit:                     ; preds = %rb_type.exit27.thread38, %rb_type.exit.i, %bb.n
  %i.bi = phi i64 [ %i.aw, %rb_type.exit27.thread38 ], [ %i.aw, %rb_type.exit.i ], [ %i.bh, %bb.n ]
