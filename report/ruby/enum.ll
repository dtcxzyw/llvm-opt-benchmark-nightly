...
bb.aj:                                            ; preds = %bb.an, %.preheader.i
  ...
  %.145.i = phi i64 [ %i.cz, %bb.an ], [ %.044.i, %.preheader.i ] ; 7 uses
...
rbimpl_RB_TYPE_P_fastpath.exit.thread.isplit:     ; preds = %bb.am
  %.148.i.lcssa134.ph = phi i64 [ %.148.i, %bb.am ]
  %.145.i.lcssa135 = phi i64 [ %.145.i, %bb.am ]
  %.0.i74.lcssa132.ph = phi i64 [ %.0.i74, %bb.am ]
...
rbimpl_RB_TYPE_P_fastpath.exit.i.rbimpl_RB_TYPE_P_fastpath.exit.thread.i_crit_edge: ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.i
  %.145.i.lcssa138 = phi i64 [ %.145.i, %rbimpl_RB_TYPE_P_fastpath.exit.i ]
  %split = phi i64 [ %.148.i, %rbimpl_RB_TYPE_P_fastpath.exit.i ]
  %.145.i.lcssa136 = phi i64 [ %.145.i, %rbimpl_RB_TYPE_P_fastpath.exit.i ] ; 0 uses
  %split136 = phi i64 [ %.0.i74, %rbimpl_RB_TYPE_P_fastpath.exit.i ]
  br label %rbimpl_RB_TYPE_P_fastpath.exit.thread.i
...
rbimpl_RB_TYPE_P_fastpath.exit.thread.i:          ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.thread.isplit, %rbimpl_RB_TYPE_P_fastpath.exit.i.rbimpl_RB_TYPE_P_fastpath.exit.thread.i_crit_edge
  %.148.i.lcssa134 = phi i64 [ %split, %rbimpl_RB_TYPE_P_fastpath.exit.i.rbimpl_RB_TYPE_P_fastpath.exit.thread.i_crit_edge ], [ %.148.i.lcssa134.ph, %rbimpl_RB_TYPE_P_fastpath.exit.thread.isplit ] ; 2 uses
  %.145.i.lcssa133 = phi i64 [ %.145.i.lcssa138, %rbimpl_RB_TYPE_P_fastpath.exit.i.rbimpl_RB_TYPE_P_fastpath.exit.thread.i_crit_edge ], [ %.145.i.lcssa135, %rbimpl_RB_TYPE_P_fastpath.exit.thread.isplit ] ; 2 uses
  %.0.i74.lcssa132 = phi i64 [ %split136, %rbimpl_RB_TYPE_P_fastpath.exit.i.rbimpl_RB_TYPE_P_fastpath.exit.thread.i_crit_edge ], [ %.0.i74.lcssa132.ph, %rbimpl_RB_TYPE_P_fastpath.exit.thread.isplit ] ; 2 uses
...
.preheader28.split.us.i:                          ; preds = %.preheader28.split.us.i.preheader, %bb.e
  %.1.us.i = phi ptr [ %i.q, %bb.e ], [ %.038.i, %.preheader28.split.us.i.preheader ] ; 5 uses
...
rb_uniform_is_less.exit27.us.i..loopexit.i.loopexit184_crit_edge: ; preds = %rb_uniform_is_less.exit27.us.i
  %.1.us.i.lcssa217 = phi ptr [ %.1.us.i, %rb_uniform_is_less.exit27.us.i ]
  %.1.us.i.lcssa214 = phi ptr [ %.1.us.i, %rb_uniform_is_less.exit27.us.i ] ; 0 uses
  br label %.loopexit.i.loopexit184

.loopexit.i.loopexit184:                          ; preds = %.loopexit.i.loopexit184split, %rb_uniform_is_less.exit27.us.i..loopexit.i.loopexit184_crit_edge
  %.1.us.i.lcssa = phi ptr [ %.1.us.i.lcssa217, %rb_uniform_is_less.exit27.us.i..loopexit.i.loopexit184_crit_edge ], [ %.1.us.i.lcssa215, %.loopexit.i.loopexit184split ]
  br label %.loopexit.i
...
bb.y:                                             ; preds = %bb.aa, %.split.us.us
  %.162.us.us = phi ptr [ %.061.us, %.split.us.us ], [ %i.da, %bb.aa ] ; 5 uses
...
.critedge.i82.us.us..preheader.split103.us.us.preheader_crit_edge: ; preds = %.critedge.i82.us.us
  %.162.us.us.lcssa201 = phi ptr [ %.162.us.us, %.critedge.i82.us.us ]
  %.162.us.us.lcssa200 = phi ptr [ %.162.us.us, %.critedge.i82.us.us ] ; 0 uses
  br label %.preheader.split103.us.us.preheader
...
.preheader.split103.us.us.preheader:              ; preds = %.preheader.split103.us.us.preheadersplit, %.critedge.i82.us.us..preheader.split103.us.us.preheader_crit_edge
  %.162.us.us.lcssa = phi ptr [ %.162.us.us.lcssa201, %.critedge.i82.us.us..preheader.split103.us.us.preheader_crit_edge ], [ %.162.us.us.lcssa201.a, %.preheader.split103.us.us.preheadersplit ] ; 5 uses
...
rb_uniform_is_less.exit87.us.us..split105.us109_crit_edge: ; preds = %rb_uniform_is_less.exit87.us.us
  %.1.us.us.lcssa204 = phi ptr [ %.1.us.us, %rb_uniform_is_less.exit87.us.us ]
  %.1.us.us.lcssa202 = phi ptr [ %.1.us.us, %rb_uniform_is_less.exit87.us.us ] ; 0 uses
  br label %.split105.us109

.split105.us109:                                  ; preds = %.split105.us109split, %rb_uniform_is_less.exit87.us.us..split105.us109_crit_edge
  %.1.us.us.lcssa = phi ptr [ %.1.us.us.lcssa204, %rb_uniform_is_less.exit87.us.us..split105.us109_crit_edge ], [ %.1.us.us.lcssa203, %.split105.us109split ] ; 5 uses
...
.preheader.split103.us.us:                        ; preds = %.preheader.split103.us.us.preheader, %bb.ac
  %.1.us.us = phi ptr [ %i.dg, %bb.ac ], [ %.0.us, %.preheader.split103.us.us.preheader ] ; 5 uses
...
bb.ad:                                            ; preds = %bb.ae, %.split
  %.162 = phi ptr [ %.061, %.split ], [ %i.dn, %bb.ae ] ; 5 uses
...
.critedge.i82..critedge.i85.preheader_crit_edge:  ; preds = %.critedge.i82
  %.162.lcssa196 = phi ptr [ %.162, %.critedge.i82 ]
  %.162.lcssa196.a = phi ptr [ %.162, %.critedge.i82 ] ; 0 uses
  br label %.critedge.i85.preheader

.critedge.i85.preheader:                          ; preds = %.critedge.i85.preheadersplit, %.critedge.i82..critedge.i85.preheader_crit_edge
  %.162.lcssa = phi ptr [ %.162.lcssa196, %.critedge.i82..critedge.i85.preheader_crit_edge ], [ %.162.lcssa197, %.critedge.i85.preheadersplit ] ; 5 uses
