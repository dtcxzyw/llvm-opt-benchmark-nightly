...
bb.l:                                             ; preds = %bb.k
  ...
  %or.cond127.i = select i1 %.not128.i, i1 true, i1 %.not129.i
  br i1 %or.cond127.i, label %and_code_range_buf.exit.thread.thread, label %.lr.ph123.preheader.i
...
.preheader:                                       ; preds = %bb.j
  ...
  %or.cond127 = select i1 %.not128, i1 true, i1 %.not129
  br i1 %or.cond127, label %bbuf_clone.exit, label %.lr.ph123.preheader
...
bbuf_clone.exit:                                  ; preds = %and_code_range1.exit, %bb.y, %and_code_range1.exit.us, %bb.t, %bb.n, %._crit_edge, %bb.w, %bbuf_clone.exit.sink.split, %.preheader111, %.preheader, %.thread, %bb.h, %bb.g, %bb.d, %bb.c, %bb.f, %bb.b
  %.0 = phi i32 [ 0, %._crit_edge ], [ %i.av, %bb.n ], [ %i.i, %bb.d ], [ 0, %bb.b ], [ 0, %bb.f ], [ %i.p, %bb.h ], [ 0, %.thread ], [ 0, %.preheader ], [ 0, %.preheader111 ], [ -5, %bb.c ], [ %i.bx, %bb.w ], [ -5, %bb.g ], [ 0, %and_code_range1.exit.us ], [ 0, %bbuf_clone.exit.sink.split ], [ %i.ba, %bb.t ], [ 0, %and_code_range1.exit ], [ %i.ch, %bb.y ]
  ret i32 %.0
}
