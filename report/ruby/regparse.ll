...
define internal void @onig_syntax_warn(ptr noundef readonly captures(none) %0, ptr noundef %1, ...) unnamed_addr #5 {
bb.a:
...
; Function Attrs: nounwind sspstrong uwtable
define internal fastcc range(i32 -216, 1) i32 @fetch_name(i32 noundef %0, ptr noundef nonnull captures(none) %1, ptr noundef %2, ptr noundef nonnull writeonly captures(none) %3, ptr noundef captures(none) %4, ptr noundef nonnull writeonly captures(none) initializes((0, 4)) %5, i32 noundef range(i32 0, 2) %6) unnamed_addr #5 {
bb.a:
...
.lr.ph.preheader.i.us:                            ; preds = %.lr.ph.preheader.i.us.preheader, %and_code_range1.exit.us
  ...
  %i.ac = trunc nuw i64 %indvars.iv138 to i32
...
.lr.ph123.us.preheader:                           ; preds = %.preheader
  %wide.trip.count151 = zext i32 %i.w to i64
  %wide.trip.count146 = zext i32 %i.q to i64
...
.lr.ph123.us:                                     ; preds = %.lr.ph123.us.preheader, %._crit_edge.us
  ...
  %i.ba = trunc nuw i64 %indvars.iv148 to i32
  %i.bb = shl i32 %i.ba, 1                        ; 2 uses
  %i.bc = zext i32 %i.bb to i64
  %i.bd = getelementptr [4 x i8], ptr %i.x, i64 %i.bc
  %i.be = load i32, ptr %i.bd, align 4, !tbaa !7  ; 2 uses
  %i.bf = or disjoint i32 %i.bb, 1
  %i.bg = zext i32 %i.bf to i64
...
bb.u:                                             ; preds = %.lr.ph123.us, %bb.x
  ...
  %i.bj = trunc nuw i64 %indvars.iv143 to i32
  %i.bk = shl i32 %i.bj, 1                        ; 2 uses
  %i.bl = zext i32 %i.bk to i64
  %i.bm = getelementptr [4 x i8], ptr %i.r, i64 %i.bl
  %i.bn = load i32, ptr %i.bm, align 4, !tbaa !7  ; 2 uses
  %i.bo = or disjoint i32 %i.bk, 1
  %i.bp = zext i32 %i.bo to i64
  %i.bq = getelementptr [4 x i8], ptr %i.r, i64 %i.bp
  %i.br = load i32, ptr %i.bq, align 4, !tbaa !7  ; 2 uses
  %i.bs = icmp ugt i32 %i.bn, %i.bi
  br i1 %i.bs, label %._crit_edge.us, label %bb.v
