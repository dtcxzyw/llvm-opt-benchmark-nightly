...
begin_hunk_0_@nurat_to_s:bb.a
  ...
  %i.d = tail call i64 @rb_obj_as_string(i64 noundef %i.c) #16, !callees !42 ; 3 uses
  ...
  %i.h = tail call i64 @rb_obj_as_string(i64 noundef %i.g) #16, !callees !42
...
begin_hunk_1_@nurat_inspect:bb.a
  ...
  %i.e = tail call i64 @rb_inspect(i64 noundef %i.d) #16, !callees !42 ; 3 uses
  ...
  %i.i = tail call i64 @rb_inspect(i64 noundef %i.h) #16, !callees !42
...
begin_hunk_2_@nurat_marshal_load:bb.a
  ...
  br i1 %.not3.i.i, label %RB_OBJ_FROZEN.exit.i, label %RB_OBJ_FROZEN.exit.thread.i, !prof !43
...
RB_OBJ_FROZEN.exit.i:                             ; preds = %bb.a
  ...
  br i1 %.not.i, label %rbimpl_RB_TYPE_P_fastpath.exit.i, label %RB_OBJ_FROZEN.exit.thread.i, !prof !44
...
begin_hunk_3_@nurat_marshal_load:bb.a
  ...
  br i1 %or.cond.i, label %rb_check_frozen_inline.exit, label %bb.b, !prof !45
...
begin_hunk_4_@nurat_marshal_load:bb.a
  ...
  %i.m = or i1 %i.j, %i.l
  br i1 %i.m, label %rbimpl_RB_TYPE_P_fastpath.exit.thread.i, label %rbimpl_RB_TYPE_P_fastpath.exit.i9, !prof !46
...
rbimpl_RB_TYPE_P_fastpath.exit.i9:                ; preds = %rb_check_frozen_inline.exit
  ...
  br i1 %i.q, label %Check_Type.exit, label %rbimpl_RB_TYPE_P_fastpath.exit.thread.i, !prof !44
...
!47 = !{!48, !18, i64 16}
!48 = !{!"RString", !17, i64 0, !18, i64 16, !9, i64 24}
end_hunk_7
