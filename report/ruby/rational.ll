...
bb.b:                                             ; preds = %bb.c, %.lr.ph.i
  %.05.i = phi ptr [ %0, %.lr.ph.i ], [ %i.r, %bb.c ] ; 3 uses
...
.skip_ws.exit.loopexit_crit_edge:                 ; preds = %bb.b
  %.05.i.lcssa.a = phi ptr [ %.05.i, %bb.b ]
  br label %skip_ws.exit.loopexit

skip_ws.exit.loopexit:                            ; preds = %skip_ws.exit.loopexitsplit, %.skip_ws.exit.loopexit_crit_edge
  %.0.lcssa.i.ph = phi ptr [ %.05.i.lcssa.a, %.skip_ws.exit.loopexit_crit_edge ], [ %scevgep.i, %skip_ws.exit.loopexitsplit ]
...
bb.r:                                             ; preds = %bb.s, %.lr.ph.i39
  %.05.i41 = phi ptr [ %i.am, %.lr.ph.i39 ], [ %i.ay, %bb.s ] ; 3 uses
...
.skip_ws.exit44.loopexit_crit_edge:               ; preds = %bb.r
  %.05.i41.lcssa.a = phi ptr [ %.05.i41, %bb.r ]
  br label %skip_ws.exit44.loopexit

skip_ws.exit44.loopexit:                          ; preds = %skip_ws.exit44.loopexitsplit, %.skip_ws.exit44.loopexit_crit_edge
  %.0.lcssa.i38.ph = phi ptr [ %.05.i41.lcssa.a, %.skip_ws.exit44.loopexit_crit_edge ], [ %scevgep.i40, %skip_ws.exit44.loopexitsplit ]
...
bb.v:                                             ; preds = %bb.w, %.lr.ph.i46
  %.05.i48 = phi ptr [ %i.ae, %.lr.ph.i46 ], [ %i.bm, %bb.w ] ; 3 uses
...
.skip_ws.exit51.loopexit_crit_edge:               ; preds = %bb.v
  %.05.i48.lcssa.a = phi ptr [ %.05.i48, %bb.v ]
  br label %skip_ws.exit51.loopexit

skip_ws.exit51.loopexit:                          ; preds = %skip_ws.exit51.loopexitsplit, %.skip_ws.exit51.loopexit_crit_edge
  %.0.lcssa.i45.ph = phi ptr [ %.05.i48.lcssa.a, %.skip_ws.exit51.loopexit_crit_edge ], [ %scevgep.i47, %skip_ws.exit51.loopexitsplit ]
