...
pm_parameters_node_block_set.exit:                ; preds = %bb.m
  %15 = load <2 x ptr>, ptr %i.t, align 8, !tbaa !14 ; 4 uses
  %16 = icmp eq <2 x ptr> %15, zeroinitializer
  %17 = insertelement <2 x ptr> %15, ptr %i.bx, i64 1 ; 2 uses
  %18 = insertelement <2 x ptr> %15, ptr %.sroa.4531.0.copyload, i64 0
  %19 = icmp uge <2 x ptr> %17, %18
  %20 = select <2 x i1> %16, <2 x i1> splat (i1 true), <2 x i1> %19
  %21 = insertelement <2 x ptr> %17, ptr %.sroa.4531.0.copyload, i64 0
  %22 = select <2 x i1> %20, <2 x ptr> %21, <2 x ptr> %15
  store <2 x ptr> %22, ptr %i.t, align 8, !tbaa !14
...
begin_hunk_3_@parse_parameters:bb.a
  ...
  %i.dd = load ptr, ptr %i.s, align 8, !tbaa !523 ; 3 uses
...
begin_hunk_4_@parse_parameters:bb.a
  ...
  store ptr %i.cw, ptr %i.s, align 8, !tbaa !523
  br label %.critedge
...
bb.av:                                            ; preds = %pm_node_flag_set_repeated_parameter.exit305, %pm_optional_parameter_node_create.exit
  %i.gy = load ptr, ptr %i.t, align 8, !tbaa !524 ; 3 uses
  ...
  %i.hc = load ptr, ptr %i.u, align 8, !tbaa !525 ; 3 uses
...
.thread542:                                       ; preds = %.thread542.sink.split, %pm_required_parameter_node_create.exit337, %pm_required_parameter_node_create.exit
  ...
  %i.jl = load ptr, ptr %i.t, align 8, !tbaa !524 ; 3 uses
  ...
  %i.jp = load ptr, ptr %i.u, align 8, !tbaa !525 ; 2 uses
...
context_push.exit343:                             ; preds = %bb.bm, %bb.bn
  ...
  %23 = load <2 x ptr>, ptr %i.p, align 8, !tbaa !14 ; 5 uses
  %24 = extractelement <2 x ptr> %23, i64 0       ; 27 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %11) #28
  store i64 %.sroa.0505.0.copyload, ptr %11, align 8
  store ptr %24, ptr %.sroa.4507.0..sroa_idx508, align 8, !tbaa !14
  %25 = extractelement <2 x ptr> %23, i64 1       ; 9 uses
  %i.jy = getelementptr i8, ptr %25, i64 -1       ; 9 uses
...
begin_hunk_8_@parse_parameters:bb.a
  ...
  %i.kf = ptrtoint ptr %24 to i64
  %i.kg = sub i64 %i.ke, %i.kf
  %i.kh = tail call zeroext i1 %i.kd(ptr noundef %24, i64 noundef %i.kg) #28
  br i1 %i.kh, label %bb.bq, label %bb.br

bb.bp:                                            ; preds = %context_push.exit343
  %i.ki = ptrtoint ptr %i.jy to i64
  %i.kj = ptrtoint ptr %24 to i64
  %i.kk = sub i64 %i.ki, %i.kj
  %i.kl = tail call zeroext i1 @pm_encoding_utf_8_isupper_char(ptr noundef %24, i64 noundef %i.kk) #28
  br i1 %i.kl, label %bb.bq, label %bb.br

bb.bq:                                            ; preds = %bb.bp, %bb.bo
  %i.km = tail call zeroext i1 @pm_diagnostic_list_append(ptr noundef %i.r, ptr noundef %24, ptr noundef %i.jy, i32 noundef 12) #28 ; 0 uses
  br label %bb.bt

bb.br:                                            ; preds = %bb.bp, %bb.bo
  %i.kn = getelementptr i8, ptr %25, i64 -2
...
bb.bs:                                            ; preds = %bb.br, %bb.br
  ...
  %i.kq = ptrtoint ptr %24 to i64
  %i.kr = sub i64 %i.kp, %i.kq
  %i.ks = trunc i64 %i.kr to i32
  %i.kt = tail call zeroext i1 (ptr, ptr, ptr, i32, ...) @pm_diagnostic_list_append_format(ptr noundef %i.r, ptr noundef %24, ptr noundef %i.jy, i32 noundef 152, i32 noundef %i.ks, ptr noundef %24) #28 ; 0 uses
  br label %bb.bt
...
bb.bt:                                            ; preds = %bb.br, %bb.bs, %bb.bq
  ...
  %i.kw = ptrtoint ptr %24 to i64
  %i.kx = sub i64 %i.kv, %i.kw                    ; 7 uses
  %i.ky = tail call i32 @pm_constant_pool_insert_shared(ptr noundef %i.o, ptr noundef %24, i64 noundef %i.kx) #28 ; 2 uses
...
bb.bu:                                            ; preds = %bb.bt
  ...
  tail call fastcc void @pm_parser_local_add(ptr %.val.i.i345, i32 noundef %i.ky, ptr noundef %24, ptr noundef %i.jy, i32 noundef 1)
...
begin_hunk_10_@parse_parameters:bb.a
  ...
  %i.lj = tail call i32 @pm_constant_pool_insert_shared(ptr noundef %i.o, ptr noundef %24, i64 noundef %i.kx) #28
  ...
  store ptr %24, ptr %.sroa.4.0..sroa_idx.i349, align 8, !tbaa !14
  %.sroa.5.0..sroa_idx.i350 = getelementptr inbounds nuw i8, ptr %i.ld, i64 16
  store ptr %25, ptr %.sroa.5.0..sroa_idx.i350, align 8, !tbaa !14
  ...
  store ptr %24, ptr %.sroa.8.0..sroa_idx.i352, align 8, !tbaa !14
  %.sroa.9.0..sroa_idx.i353 = getelementptr inbounds nuw i8, ptr %i.ld, i64 40
  store ptr %25, ptr %.sroa.9.0..sroa_idx.i353, align 8, !tbaa !14
...
begin_hunk_11_@parse_parameters:bb.a
  ...
  %i.lt = tail call i32 @pm_constant_pool_insert_shared(ptr noundef %i.o, ptr noundef %24, i64 noundef %i.kx) #28
  ...
  store ptr %24, ptr %.sroa.4.0..sroa_idx.i359, align 8, !tbaa !14
  %.sroa.5.0..sroa_idx.i360 = getelementptr inbounds nuw i8, ptr %i.ln, i64 16
  store ptr %25, ptr %.sroa.5.0..sroa_idx.i360, align 8, !tbaa !14
  ...
  store ptr %24, ptr %.sroa.8.0..sroa_idx.i362, align 8, !tbaa !14
  %.sroa.9.0..sroa_idx.i363 = getelementptr inbounds nuw i8, ptr %i.ln, i64 40
  store ptr %25, ptr %.sroa.9.0..sroa_idx.i363, align 8, !tbaa !14
  br i1 %i.ku, label %.thread.sink.split, label %.thread
...
bb.cb:                                            ; preds = %bb.ca
  %i.lv = tail call i32 @pm_constant_pool_insert_shared(ptr noundef %i.o, ptr noundef %24, i64 noundef %i.kx) #28 ; 8 uses
...
bb.cw:                                            ; preds = %pm_locals_reads.exit399
  ...
  %i.pf = tail call zeroext i1 (ptr, ptr, ptr, i32, ...) @pm_diagnostic_list_append_format(ptr noundef %i.r, ptr noundef %24, ptr noundef %i.jy, i32 noundef 207, i32 noundef %i.pe, ptr noundef %24) #28 ; 0 uses
  br label %bb.cx
...
begin_hunk_14_@parse_parameters:bb.a
  ...
  %i.po = tail call i32 @pm_constant_pool_insert_shared(ptr noundef %i.o, ptr noundef %24, i64 noundef %i.kx) #28
  ...
  store ptr %24, ptr %.sroa.4.0..sroa_idx.i402, align 8, !tbaa !14
  ...
  store ptr %24, ptr %.sroa.8.0..sroa_idx.i405, align 8, !tbaa !14
  %.sroa.9.0..sroa_idx.i406 = getelementptr inbounds nuw i8, ptr %i.pg, i64 40
  store ptr %25, ptr %.sroa.9.0..sroa_idx.i406, align 8, !tbaa !14
...
begin_hunk_15_@parse_parameters:bb.a
  ...
  %i.pv = tail call i32 @pm_constant_pool_insert_shared(ptr noundef %i.o, ptr noundef %24, i64 noundef %i.kx) #28
  ...
  store ptr %24, ptr %.sroa.4.0..sroa_idx.i410, align 8, !tbaa !14
  %.sroa.5.0..sroa_idx.i411 = getelementptr inbounds nuw i8, ptr %i.pp, i64 16
  store ptr %25, ptr %.sroa.5.0..sroa_idx.i411, align 8, !tbaa !14
  ...
  store ptr %24, ptr %.sroa.8.0..sroa_idx.i413, align 8, !tbaa !14
  %.sroa.9.0..sroa_idx.i414 = getelementptr inbounds nuw i8, ptr %i.pp, i64 40
  store ptr %25, ptr %.sroa.9.0..sroa_idx.i414, align 8, !tbaa !14
  br label %bb.db
...
pm_rest_parameter_node_create.exit:               ; preds = %pm_node_alloc.exit.i424, %bb.dg
  ...
  %i.qx = phi ptr [ %.sroa.9.0.i427, %bb.dg ], [ %.sroa.5504.0.copyload, %pm_node_alloc.exit.i424 ] ; 3 uses
...
bb.di:                                            ; preds = %bb.dh
  %26 = load <2 x ptr>, ptr %i.t, align 8, !tbaa !14 ; 4 uses
  %27 = icmp eq <2 x ptr> %26, zeroinitializer
  %28 = insertelement <2 x ptr> %26, ptr %i.qx, i64 1 ; 2 uses
  %29 = insertelement <2 x ptr> %26, ptr %.sroa.3.0.copyload, i64 0
  %30 = icmp uge <2 x ptr> %28, %29
  %31 = select <2 x i1> %27, <2 x i1> splat (i1 true), <2 x i1> %30
  %32 = insertelement <2 x ptr> %28, ptr %.sroa.3.0.copyload, i64 0
  %33 = select <2 x i1> %31, <2 x ptr> %32, <2 x ptr> %26
  store <2 x ptr> %33, ptr %i.t, align 8, !tbaa !14
...
bb.du:                                            ; preds = %bb.dt, %bb.do
  ...
  %i.sv = load ptr, ptr %i.s, align 8, !tbaa !523
...
begin_hunk_19_@parse_parameters:bb.a
  ...
  store ptr %.0232, ptr %i.s, align 8, !tbaa !523
  br label %bb.dw
...
bb.dz:                                            ; preds = %bb.dy
  %i.tv = tail call noalias dereferenceable_or_null(24) ptr @calloc(i64 noundef 1, i64 noundef 24) #31 ; 6 uses
...
begin_hunk_21_@parse_parameters:bb.a
  ...
  %34 = load <2 x ptr>, ptr %i.p, align 8, !tbaa !14 ; 6 uses
  ...
  store <2 x ptr> %34, ptr %.sroa.4.0..sroa_idx.i483, align 8, !tbaa !14
...
bb.eb:                                            ; preds = %pm_implicit_rest_node_create.exit
  %35 = load <2 x ptr>, ptr %i.t, align 8, !tbaa !14 ; 4 uses
  %36 = icmp eq <2 x ptr> %35, zeroinitializer
  %37 = shufflevector <2 x ptr> %35, <2 x ptr> %34, <2 x i32> <i32 0, i32 3>
  %38 = shufflevector <2 x ptr> %34, <2 x ptr> %35, <2 x i32> <i32 0, i32 3>
  %39 = icmp uge <2 x ptr> %37, %38
  %40 = select <2 x i1> %36, <2 x i1> splat (i1 true), <2 x i1> %39
  %41 = select <2 x i1> %40, <2 x ptr> %34, <2 x ptr> %35
  store <2 x ptr> %41, ptr %i.t, align 8, !tbaa !14
  store ptr %i.tv, ptr %i.w, align 8, !tbaa !526
  br label %.critedge245.thread

bb.ec:                                            ; preds = %pm_implicit_rest_node_create.exit
  %42 = extractelement <2 x ptr> %34, i64 0
  %43 = extractelement <2 x ptr> %34, i64 1
  %i.ud = tail call zeroext i1 @pm_diagnostic_list_append(ptr noundef %i.r, ptr noundef %42, ptr noundef %43, i32 noundef 215) #28 ; 0 uses
...
.thread:                                          ; preds = %.thread.sink.split, %pm_required_keyword_parameter_node_create.exit364, %pm_required_keyword_parameter_node_create.exit
  ...
  %44 = load <2 x ptr>, ptr %i.t, align 8, !tbaa !14 ; 4 uses
  %45 = icmp eq <2 x ptr> %44, zeroinitializer
  %46 = shufflevector <2 x ptr> %44, <2 x ptr> %23, <2 x i32> <i32 0, i32 3>
  %47 = shufflevector <2 x ptr> %23, <2 x ptr> %44, <2 x i32> <i32 0, i32 3>
  %48 = icmp uge <2 x ptr> %46, %47
  %49 = select <2 x i1> %45, <2 x i1> splat (i1 true), <2 x i1> %48
  %50 = select <2 x i1> %49, <2 x ptr> %23, <2 x ptr> %44
  store <2 x ptr> %50, ptr %i.t, align 8, !tbaa !14
...
begin_hunk_23_@parse_parameters:bb.a
  ...
  %i.vm = load ptr, ptr %i.t, align 8, !tbaa !524
  %i.vn = load ptr, ptr %i.u, align 8, !tbaa !525
