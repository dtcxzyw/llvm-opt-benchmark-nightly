...
bb.n:                                             ; preds = %bb.l
  ...
  %.pre4550 = load ptr, ptr %i.d, align 8, !tbaa !76
  br label %match_eol_offset.exit.thread
...
match_eol_offset.exit.thread.thread:              ; preds = %match_eol_offset.exit2268, %.lr.ph4116, %peek_at.exit.i.i, %peek_at.exit11.i.i
  %.ph = phi ptr [ %i.at, %peek_at.exit11.i.i ], [ %i.at, %peek_at.exit.i.i ], [ %i.at, %.lr.ph4116 ], [ %.pre4551, %match_eol_offset.exit2268 ] ; 61 uses
...
match_eol_offset.exit.thread:                     ; preds = %bb.n, %bb.m, %bb.o, %match_eol_offset.exit, %bb.g
  %i.bx = phi ptr [ %.pre4550, %bb.n ], [ %i.aw, %bb.g ], [ %i.bt, %bb.o ], [ %i.bg, %match_eol_offset.exit ], [ %i.bo, %bb.m ] ; 3 uses
...
.critedge14.i:                                    ; preds = %.critedge16.i, %bb.ay, %.critedge18.i, %.preheader315.i
  ...
  %i.hh = call ptr @pm_memchr(ptr noundef %.us-phi4126, i32 noundef 45, i64 noundef %i.hd, i1 noundef zeroext %i.hf, ptr noundef %i.hg) #27 ; 3 uses
  %i.hi = icmp eq ptr %i.hh, null
  br i1 %i.hi, label %bb.ba, label %bb.bb

bb.ba:                                            ; preds = %.critedge14.i
  call void @pm_string_shared_init(ptr noundef nonnull %3, ptr noundef %.us-phi4126, ptr noundef %.us-phi4125) #27
  br label %bb.bd
...
bb.cx:                                            ; preds = %pm_parser_scope_shareable_constant_set.exit.i
  ...
  store ptr %.us-phi4126, ptr %i.ll, align 8, !tbaa !190
...
peek_at.exit.i:                                   ; preds = %bb.db
  ...
  switch i8 %i.md, label %match_eol_at.exit [
end_hunk_0
...
begin_hunk_5_@parse_alias_argument:bb.a
  %i.af = add i16 %2, 1
  %i.ag = tail call fastcc ptr @parse_symbol(ptr noundef nonnull %0, i32 %.sroa.0.0.copyload, i8 %.sroa.441.0.copyload, i32 noundef %i.ae, i16 noundef zeroext %i.af)
  br label %bb.p

bb.l:                                             ; preds = %bb.a
  tail call fastcc void @parser_lex(ptr noundef nonnull %0)
  %i.ah = getelementptr i8, ptr %0, i64 320
  %i.ai = tail call fastcc ptr @pm_back_reference_read_node_create(ptr noundef nonnull %0, ptr noundef %i.ah)
  br label %bb.p

bb.m:                                             ; preds = %bb.a
  tail call fastcc void @parser_lex(ptr noundef nonnull %0)
  %i.aj = getelementptr i8, ptr %0, i64 320
  %i.ak = tail call fastcc ptr @pm_numbered_reference_read_node_create(ptr noundef nonnull %0, ptr noundef %i.aj)
  br label %bb.p

bb.n:                                             ; preds = %bb.a
  tail call fastcc void @parser_lex(ptr noundef nonnull %0)
  %i.al = getelementptr i8, ptr %0, i64 320
  %i.am = tail call fastcc ptr @pm_global_variable_read_node_create(ptr noundef nonnull %0, ptr noundef %i.al)
  br label %bb.p

bb.o:                                             ; preds = %bb.a
  %i.an = getelementptr i8, ptr %0, i64 352       ; 2 uses
  %i.ao = load ptr, ptr %i.an, align 8, !tbaa !166
  %i.ap = getelementptr i8, ptr %0, i64 360       ; 2 uses
  %i.aq = load ptr, ptr %i.ap, align 8, !tbaa !76
  %i.ar = getelementptr i8, ptr %0, i64 472
