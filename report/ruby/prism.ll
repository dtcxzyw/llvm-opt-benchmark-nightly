...
match_eol.exit:                                   ; preds = %peek_at.exit11.i.i2946, %bb.aea, %peek_at.exit.i.i2945, %bb.adz, %current_token_starts_line.exit2942.thread, %current_token_starts_line.exit2942, %lex_identifier.exit
  ...
  switch i32 %.1.i2926, label %pm_token_is_numbered_parameter.exit.thread [
...
bb.aee:                                           ; preds = %bb.aec
  ...
  br i1 %i.cfi, label %pm_token_is_numbered_parameter.exit.thread.sink.split, label %bb.aef

bb.aef:                                           ; preds = %bb.aee, %bb.aed
...
pm_token_is_numbered_parameter.exit.thread:       ; preds = %pm_token_is_numbered_parameter.exit.thread.sink.split, %pm_parser_local_depth.exit.thread, %bb.aep, %bb.aeq, %match_eol.exit, %pm_token_is_numbered_parameter.exit, %bb.aef
...
bb.c:                                             ; preds = %..thread_crit_edge, %bb.b
  %.01873 = phi i8 [ 0, %bb.b ], [ %.11874, %..thread_crit_edge ] ; 4 uses
  %.val2157 = load i32, ptr %i.b, align 8, !tbaa !169 ; 5 uses
  switch i32 %.val2157, label %bb.d [
    i32 33, label %accept1.exit2349
    i32 1, label %accept1.exit2349
  ]
...
bb.an:                                            ; preds = %bb.am, %bb.al
  switch i16 %i.cj, label %..thread_crit_edge [
    i16 139, label %pm_array_node_elements_append.exit.thread
    i16 103, label %.loopexit
  ]

..thread_crit_edge:                               ; preds = %bb.an, %pm_array_node_elements_append.exit.thread
  br label %bb.c
...
.loopexit:                                        ; preds = %bb.an
  %.val.i2348.pr.pre = load i32, ptr %i.b, align 8, !tbaa !169 ; 2 uses
  %i.cr = icmp eq i32 %.val.i2348.pr.pre, 14
...
accept1.exit2349:                                 ; preds = %bb.c, %bb.c, %.loopexit, %bb.ao
  %117 = phi i32 [ %.val.i2348.pr.pre, %.loopexit ], [ %.val.i2350.pre, %bb.ao ], [ %.val2157, %bb.c ], [ %.val2157, %bb.c ] ; 2 uses
