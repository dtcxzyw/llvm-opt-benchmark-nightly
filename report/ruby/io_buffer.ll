...
io_buffer_extract_width.exit:                     ; preds = %rb_num2ull_inline.exit.i, %rb_check_arity.exit
  ...
  %i.o = load i64, ptr %i.b, align 8, !tbaa !19   ; 5 uses
...
begin_hunk_1_@rb_io_buffer_hexdump:bb.a
  ...
  %i.ah = mul i64 %i.ae, %i.ag                    ; 2 uses
  %.not14.i = icmp eq i64 %i.o, 0
  %3 = add i64 %i.o, %i.ah
  %spec.select.i.a = add i64 %3, -1
  %spec.select.i = select i1 %.not14.i, i64 %i.ah, i64 %spec.select.i.a
  %i.ai = tail call i64 @rb_str_buf_new(i64 noundef %spec.select.i) #23 ; 2 uses
