...
.thread232:                                       ; preds = %.lr.ph242
  %lsr.iv260.lcssa268 = phi i64 [ %lsr.iv260, %.lr.ph242 ]
  %lsr.iv260.lcssa = phi i64 [ %lsr.iv260, %.lr.ph242 ]
  %indvar.lcssa = phi i64 [ %indvar, %.lr.ph242 ] ; 2 uses
  %.0.idx.i240.lcssa = phi i64 [ %.0.idx.i240, %.lr.ph242 ]
  %lsr.iv260.lcssa268270 = inttoptr i64 %lsr.iv260.lcssa268 to ptr
...
.lr.ph211.preheader.new:                          ; preds = %.lr.ph211.preheader
  %i.bj = lshr i64 %lsr.iv260.lcssa, 1
...
begin_hunk_3_@rsock_inspect_sockaddr:bb.a
  ...
  %exitcond220.not = icmp eq ptr %lsr.iv260.lcssa268270, %tmp
