...
bb.aa:                                            ; preds = %bb.z, %rb_num2int_inline.exit35
  ...
  %.pre.i = load ptr, ptr %i.ch, align 8, !tbaa !17 ; 6 uses
...
init_addrinfo.exit.i:                             ; preds = %bb.ai, %rb_obj_write.exit.i.i
  ...
  %.not11.i.i = icmp eq i32 %i.dp, 0
  br i1 %.not11.i.i, label %bb.aj, label %.lr.ph.i.i
...
bb.j:                                             ; preds = %bb.i, %rb_scan_args_set.exit
  ...
  %i.ao = load ptr, ptr %i.an, align 8, !tbaa !17 ; 5 uses
...
._crit_edge.i:                                    ; preds = %bb.l
  ...
  br i1 %.not11.i.i, label %bb.m, label %.lr.ph.i.i
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !17   ; 9 uses
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  br i1 %.not11.i, label %bb.d, label %.lr.ph.i
