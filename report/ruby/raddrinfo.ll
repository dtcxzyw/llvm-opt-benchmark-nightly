...
bb.c:                                             ; preds = %bb.a
  ...
  store i64 4, ptr %i.j, align 8, !tbaa !80
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 8 ; 4 uses
  store i64 4, ptr %i.k, align 8, !tbaa !81
  %i.l = inttoptr i64 %2 to ptr
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 32
  store ptr %i.j, ptr %i.m, align 8, !tbaa !83
...
bb.v:                                             ; preds = %RSTRING_PTR.exit
  %i.bi = load i32, ptr %i.d, align 4, !tbaa !12
...
bb.ab:                                            ; preds = %bb.aa
  %4 = load ptr, ptr %i.ch, align 8, !tbaa !17
...
bb.ac:                                            ; preds = %bb.ab, %bb.aa
  ...
  %5 = load ptr, ptr %i.ch, align 8, !tbaa !17    ; 2 uses
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %.pre.i = load ptr, ptr %i.ch, align 8, !tbaa !17
...
rb_num2int_inline.exit.i:                         ; preds = %bb.ad, %bb.ac
  ...
  %i.cr = load i32, ptr %i.cq, align 8, !tbaa !69 ; 4 uses
...
bb.ag:                                            ; preds = %bb.af
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.db, ptr readonly align 1 %i.cp, i64 %i.da, i1 false)
...
ruby_nonempty_memcpy.exit.i.i:                    ; preds = %bb.ag, %bb.af
  ...
  store i32 %i.cr, ptr %i.dc, align 4, !tbaa !84
  %i.dd = getelementptr inbounds nuw i8, ptr %i.j, i64 16
  store i32 %i.ct, ptr %i.dd, align 8, !tbaa !85
  %i.de = getelementptr inbounds nuw i8, ptr %i.j, i64 20
  store i32 %i.cv, ptr %i.de, align 4, !tbaa !86
  %i.df = getelementptr inbounds nuw i8, ptr %i.j, i64 24
  store i32 %i.cx, ptr %i.df, align 8, !tbaa !87
...
init_addrinfo.exit.i:                             ; preds = %bb.ai, %rb_obj_write.exit.i.i
  ...
  %i.dp = load i32, ptr %i.do, align 8, !tbaa !16
  %.not.i.i = icmp eq i32 %i.dp, 0
  %7 = load ptr, ptr %i.ch, align 8, !tbaa !17    ; 3 uses
  %.not11.i.i = icmp eq ptr %7, null              ; 2 uses
  br i1 %.not.i.i, label %8, label %9

8:                                                ; preds = %init_addrinfo.exit.i
  br i1 %.not11.i.i, label %init_addrinfo_getaddrinfo.exit, label %bb.aj
...
.lr.ph.i.i:                                       ; preds = %9, %.lr.ph.i.i
  ...
  br i1 %.not12.i.i, label %init_addrinfo_getaddrinfo.exit, label %.lr.ph.i.i, !llvm.loop !0
...
bb.ak:                                            ; preds = %bb.v
  ...
  %i.eb = load i64, ptr %i.ea, align 8, !tbaa !48 ; 5 uses
...
bb.am:                                            ; preds = %bb.ak
  ...
  %i.ee = load i64, ptr %i.dz, align 8, !tbaa !45
...
init_unix_addrinfo.exit:                          ; preds = %RSTRING_PTR.exit.i, %RSTRING_PTR.exit.thread.i, %RSTRING_PTR.exit.i.i, %RSTRING_LENINT.exit.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.en, ptr noundef nonnull readonly align 2 dereferenceable(1) %3, i64 %i.em, i1 false)
  %i.eo = getelementptr inbounds nuw i8, ptr %i.j, i64 28
  store i32 %.0.i.i40, ptr %i.eo, align 4, !tbaa !84
  %i.ep = getelementptr inbounds nuw i8, ptr %i.j, i64 16
  store i32 1, ptr %i.ep, align 8, !tbaa !85
  %i.eq = getelementptr inbounds nuw i8, ptr %i.j, i64 20
  store i32 1, ptr %i.eq, align 4, !tbaa !86
  %i.er = getelementptr inbounds nuw i8, ptr %i.j, i64 24
  store i32 0, ptr %i.er, align 8, !tbaa !87
...
RSTRING_PTR.exit42:                               ; preds = %bb.aq, %bb.ar
  ...
  %i.fc = load i64, ptr %i.fb, align 8, !tbaa !48 ; 6 uses
...
inspect_sockaddr.exit:                            ; preds = %get_addrinfo.exit
  ...
  %i.k = load i32, ptr %i.j, align 4, !tbaa !84
...
ai_get_afamily.exit:                              ; preds = %bb.d
  ...
  %i.s = load i16, ptr %i.r, align 8, !tbaa !73
...
.thread:                                          ; preds = %inspect_sockaddr.exit, %bb.g, %bb.m, %bb.k, %bb.l
  ...
  %i.am = load i32, ptr %i.al, align 4, !tbaa !86 ; 2 uses
...
bb.q:                                             ; preds = %bb.o
  %i.aq = load i32, ptr %i.al, align 4, !tbaa !86
...
bb.r:                                             ; preds = %bb.p, %bb.q, %.thread
  ...
  %i.at = load i32, ptr %i.as, align 8, !tbaa !87 ; 3 uses
...
._crit_edge:                                      ; preds = %bb.t
  %.pre = load i32, ptr %i.as, align 8, !tbaa !87
  br label %bb.u
...
bb.x:                                             ; preds = %bb.w, %bb.v
  %i.be = load i64, ptr %i.c, align 8, !tbaa !80  ; 2 uses
...
; Function Attrs: nounwind uwtable
define internal i64 @addrinfo_s_getaddrinfo(i32 noundef %0, ptr nofree noundef readonly captures(none) %1, i64 %2) #0 {
...
bb.c:                                             ; preds = %bb.b, %bb.a
  %.193.i = phi i32 [ %0, %bb.a ], [ %i.i, %bb.b ] ; 8 uses
  %.1.i = phi i64 [ 4, %bb.a ], [ %i.h, %bb.b ]
...
.preheader.preheader:                             ; preds = %bb.c
  ...
  %.not30 = icmp eq i32 %.193.i, 2
  br i1 %.not30, label %.preheader.1, label %bb.d
...
.preheader.1:                                     ; preds = %.preheader.preheader, %bb.d
  ...
  %i.q = icmp samesign ult i32 %.286.i, %.193.i
...
.preheader.2:                                     ; preds = %.preheader.1, %bb.e
  ...
  %i.w = icmp samesign ult i32 %.286.i.1, %.193.i
...
.preheader.3:                                     ; preds = %.preheader.2, %bb.f
  ...
  %i.ac = icmp samesign ult i32 %.286.i.2, %.193.i
...
bb.h:                                             ; preds = %.preheader.3, %bb.g
  ...
  %i.ai = icmp eq i32 %.286.i.3, %.193.i
  br i1 %i.ai, label %rb_scan_args_set.exit, label %.thread

.thread:                                          ; preds = %rb_scan_args_n_opt.exit, %bb.h, %bb.c
  %.193.i4 = phi i32 [ %.193.i, %bb.c ], [ %.193.i, %bb.h ], [ %0, %rb_scan_args_n_opt.exit ]
  tail call void @rb_error_arity(i32 noundef %.193.i4, i32 noundef 2, i32 noundef 6) #19
  unreachable

rb_scan_args_set.exit:                            ; preds = %bb.h
  %i.aj = call i32 @rb_get_kwargs(i64 noundef %.1.i, ptr noundef nonnull @id_timeout, i32 noundef 0, i32 noundef 1, ptr noundef nonnull %i.a) #17 ; 0 uses
...
.lr.ph.i:                                         ; preds = %bb.j, %bb.l
  ...
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !70 ; 2 uses
...
bb.l:                                             ; preds = %bb.k, %.lr.ph.i
  ...
  %i.ax = load i32, ptr %i.aw, align 8, !tbaa !69
  %i.ay = getelementptr inbounds nuw i8, ptr %.02631.i, i64 4
  %i.az = load i32, ptr %i.ay, align 4, !tbaa !64
...
._crit_edge.loopexit.i:                           ; preds = %bb.l
  %.pre.i = load ptr, ptr %i.an, align 8, !tbaa !17
...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.j
  ...
  %i.bi = load i32, ptr %i.bh, align 8, !tbaa !16
  %.not.i.i = icmp eq i32 %i.bi, 0
  %.not11.i.i = icmp eq ptr %3, null              ; 2 uses
  br i1 %.not.i.i, label %4, label %5

4:                                                ; preds = %._crit_edge.i
  br i1 %.not11.i.i, label %addrinfo_list_new.exit, label %bb.m
...
5:                                                ; preds = %._crit_edge.i
  br i1 %.not11.i.i, label %addrinfo_list_new.exit, label %.lr.ph.i.i
...
.lr.ph.i.i:                                       ; preds = %5, %.lr.ph.i.i
  ...
  br i1 %.not12.i.i, label %addrinfo_list_new.exit, label %.lr.ph.i.i, !llvm.loop !0
...
get_addrinfo.exit:                                ; preds = %bb.a
  ...
  store i32 0, ptr %i.d, align 4, !tbaa !86
...
; Function Attrs: nounwind uwtable
define internal i64 @addrinfo_s_unix(i32 noundef %0, ptr nofree noundef readonly captures(none) %1, i64 %2) #0 {
bb.a:
  %i.a = alloca i64, align 8                      ; 5 uses
...
rb_scan_args_set.exit.thread:                     ; preds = %.preheader, %rb_scan_args_set.exit, %bb.d
  ...
  store i64 4, ptr %i.k, align 8, !tbaa !80
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 8 ; 2 uses
  store i64 4, ptr %i.l, align 8, !tbaa !81
  %i.m = inttoptr i64 %i.j to ptr
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 32
  store ptr %i.k, ptr %i.n, align 8, !tbaa !83
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
...
bb.f:                                             ; preds = %rb_scan_args_set.exit.thread
  ...
  store i16 1, ptr %3, align 2, !tbaa !90
  %i.v = load i64, ptr %i.q, align 8, !tbaa !45
...
init_unix_addrinfo.exit:                          ; preds = %RSTRING_PTR.exit.i, %RSTRING_PTR.exit.thread.i, %RSTRING_PTR.exit.i.i, %RSTRING_LENINT.exit.i.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.ae, ptr noundef nonnull readonly align 2 dereferenceable(1) %3, i64 %i.ad, i1 false)
  %i.af = getelementptr inbounds nuw i8, ptr %i.k, i64 28
  store i32 %.0.i.i, ptr %i.af, align 4, !tbaa !84
  %i.ag = getelementptr inbounds nuw i8, ptr %i.k, i64 16
  store i32 1, ptr %i.ag, align 8, !tbaa !85
  %i.ah = getelementptr inbounds nuw i8, ptr %i.k, i64 20
  store i32 %.0, ptr %i.ah, align 4, !tbaa !86
  %i.ai = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  store i32 0, ptr %i.ai, align 8, !tbaa !87
...
bb.c:                                             ; preds = %get_addrinfo.exit
  ...
  %i.g = load i16, ptr %i.f, align 4, !tbaa !73
...
; Function Attrs: nounwind uwtable
define internal range(i64 -4294967295, 4294967296) i64 @addrinfo_pfamily(i64 noundef %0) #0 {
bb.a:
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.m = load i32, ptr %i.c, align 4, !tbaa !58
...
.backedge:                                        ; preds = %.split, %bb.d
  %i.o = load i32, ptr %i.b, align 8, !tbaa !61
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  store i32 %.019, ptr %i.n, align 8, !tbaa !59
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 76
  store i32 %i.h, ptr %i.o, align 4, !tbaa !60
...
bb.d:                                             ; preds = %bb.c
  %i.r = load ptr, ptr %i.e, align 8, !tbaa !56   ; 2 uses
...
bb.f:                                             ; preds = %bb.c
  ...
  store i32 1, ptr %i.s, align 4, !tbaa !58
...
bb.g:                                             ; preds = %bb.d, %bb.e, %bb.f
  ...
  store i32 %i.w, ptr %i.u, align 8, !tbaa !63
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  store i32 %i.c, ptr %i.d, align 4, !tbaa !64
  %i.e = icmp eq i64 %3, 4
...
rb_num2int_inline.exit:                           ; preds = %bb.g, %bb.h
  ...
  store i32 %i.l, ptr %i.m, align 4, !tbaa !65
  br label %bb.i
...
rbimpl_RB_TYPE_P_fastpath.exit24.thread:          ; preds = %bb.c, %RSTRING_PTR.exit, %rbimpl_RB_TYPE_P_fastpath.exit24
  %.014 = phi i64 [ %0, %rbimpl_RB_TYPE_P_fastpath.exit24 ], [ %spec.select, %RSTRING_PTR.exit ], [ %0, %bb.c ] ; 3 uses
  %i.x = icmp eq i64 %1, 0
  %i.y = and i64 %1, 7
...
rbimpl_RB_TYPE_P_fastpath.exit22:                 ; preds = %rbimpl_RB_TYPE_P_fastpath.exit24.thread
  ...
  %i.ac = load i64, ptr %i.ab, align 8, !tbaa !45 ; 2 uses
...
bb.h:                                             ; preds = %rbimpl_RB_TYPE_P_fastpath.exit22.thread
  %i.am = call i64 @__isoc23_strtol(ptr noundef nonnull %i.c, ptr noundef null, i32 noundef 10) #17, !inline_history !1
...
bb.i:                                             ; preds = %.sink.split, %bb.h, %rbimpl_RB_TYPE_P_fastpath.exit22.thread, %bb.b
  ...
  %.115 = phi i64 [ %.014, %rbimpl_RB_TYPE_P_fastpath.exit22.thread ], [ %0, %bb.b ], [ %.014, %bb.h ], [ %.014, %.sink.split ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #17
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #17
  br label %bb.j
...
bb.j:                                             ; preds = %bb.a, %bb.i
  ...
  %.2 = phi i64 [ %.115, %bb.i ], [ %0, %bb.a ]   ; 4 uses
...
rbimpl_RB_TYPE_P_fastpath.exit19.thread:          ; preds = %bb.j, %rbimpl_RB_TYPE_P_fastpath.exit19, %bb.k
  %.0 = phi i64 [ %i.bb, %bb.k ], [ 4, %rbimpl_RB_TYPE_P_fastpath.exit19 ], [ 4, %bb.j ] ; 8 uses
...
bb.n:                                             ; preds = %bb.l
  %i.bn = call i64 (i64, ptr, ...) @rb_str_catf(i64 noundef %.0, ptr noundef nonnull @.str.111, ptr noundef %i.bl) #17 ; 0 uses
  br label %.thread
...
bb.r:                                             ; preds = %bb.p
  %i.bv = call i64 (i64, ptr, ...) @rb_str_catf(i64 noundef %.0, ptr noundef nonnull @.str.19, i32 noundef %i.bt) #17 ; 0 uses
  br label %.thread

bb.s:                                             ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.thread, %bb.o, %bb.q, %bb.m
  %.1 = phi i64 [ %i.bm, %bb.m ], [ %.0, %bb.o ], [ %i.bu, %bb.q ], [ %.0, %rbimpl_RB_TYPE_P_fastpath.exit.thread ] ; 2 uses
  %i.bw = icmp eq i64 %.1, 4
  br i1 %i.bw, label %bb.t, label %.thread

.thread:                                          ; preds = %bb.r, %bb.n, %bb.s
  %.132 = phi i64 [ %.1, %bb.s ], [ %.0, %bb.n ], [ %.0, %bb.r ] ; 2 uses
  call void @rb_obj_freeze_inline(i64 noundef %.132) #17
  br label %bb.t

bb.t:                                             ; preds = %.thread, %bb.s
  %.133 = phi i64 [ %.132, %.thread ], [ 4, %bb.s ]
  ret i64 %.133
}
...
bb.a:
  ...
  %5 = load ptr, ptr %i.a, align 8, !tbaa !17     ; 2 uses
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %7 = load ptr, ptr %i.a, align 8, !tbaa !17     ; 3 uses
  %.not11.i = icmp eq ptr %7, null                ; 2 uses
  br i1 %.not.i, label %8, label %9

8:                                                ; preds = %bb.c
  br i1 %.not11.i, label %rb_freeaddrinfo.exit, label %bb.d
...
.lr.ph.i:                                         ; preds = %9, %.lr.ph.i
  ...
  br i1 %.not12.i, label %rb_freeaddrinfo.exit, label %.lr.ph.i, !llvm.loop !0
...
!14 = !{!"p1 _ZTS8addrinfo", !13, i64 0}
!15 = !{!"rb_addrinfo", !14, i64 0, !11, i64 8}
!16 = !{!15, !11, i64 8}
!17 = !{!15, !14, i64 0}
!18 = !{!"p1 _ZTS8sockaddr", !13, i64 0}
!19 = !{!"p1 omnipotent char", !13, i64 0}
!20 = !{!"addrinfo", !11, i64 0, !11, i64 4, !11, i64 8, !11, i64 12, !11, i64 16, !18, i64 24, !19, i64 32, !14, i64 40}
!21 = !{!20, !14, i64 40}
!22 = !{!20, !18, i64 24}
!23 = !{!"llvm.loop.mustprogress"}
!24 = !{!"long", !10, i64 0}
!25 = !{!"getnameinfo_arg", !18, i64 0, !11, i64 8, !11, i64 12, !19, i64 16, !24, i64 24, !19, i64 32, !24, i64 40, !11, i64 48, !11, i64 52, !11, i64 56, !11, i64 60, !11, i64 64, !10, i64 72, !10, i64 112}
!26 = !{!25, !18, i64 0}
!27 = !{!25, !11, i64 8}
!28 = !{!25, !19, i64 16}
!29 = !{!25, !24, i64 24}
...
!39 = !{!"short", !10, i64 0}
!40 = !{!"in_addr", !11, i64 0}
!41 = !{!"sockaddr_in", !39, i64 0, !39, i64 2, !40, i64 4, !10, i64 8}
!42 = !{!41, !39, i64 0}
!43 = !{!41, !11, i64 4}
!44 = !{!"RBasic", !24, i64 0, !24, i64 8}
!45 = !{!44, !24, i64 0}
!46 = !{!10, !10, i64 0}
!47 = !{!"RString", !44, i64 0, !24, i64 16, !10, i64 24}
!48 = !{!47, !24, i64 16}
!49 = !{!20, !11, i64 8}
!50 = !{!19, !19, i64 0}
!51 = !{!20, !11, i64 0}
!52 = !{!14, !14, i64 0}
!53 = !{!"getaddrinfo_arg", !19, i64 0, !19, i64 8, !20, i64 16, !14, i64 64, !11, i64 72, !11, i64 76, !11, i64 80, !11, i64 84, !11, i64 88, !11, i64 92, !10, i64 96, !10, i64 136, !11, i64 184}
!54 = !{!53, !19, i64 0}
!55 = !{!53, !19, i64 8}
!56 = !{!53, !14, i64 64}
!57 = !{!53, !11, i64 184}
...
!64 = !{!20, !11, i64 4}
!65 = !{!20, !11, i64 12}
!66 = !{!"in6_addr", !10, i64 0}
!67 = !{!"sockaddr_in6", !39, i64 0, !39, i64 2, !11, i64 4, !66, i64 8, !11, i64 24}
!68 = !{!67, !39, i64 2}
!69 = !{!20, !11, i64 16}
!70 = !{!20, !19, i64 32}
!71 = !{!41, !39, i64 2}
!72 = !{!"sockaddr", !39, i64 0, !10, i64 2}
!73 = !{!72, !39, i64 0}
!74 = !{!"p1 _ZTS11rb_addrinfo", !13, i64 0}
!75 = !{!"hostent_arg", !24, i64 0, !74, i64 8, !13, i64 16}
!76 = !{!75, !24, i64 0}
!77 = !{!75, !74, i64 8}
!78 = !{!75, !13, i64 16}
!79 = !{!"", !24, i64 0, !24, i64 8, !11, i64 16, !11, i64 20, !11, i64 24, !11, i64 28, !10, i64 32}
!80 = !{!79, !24, i64 0}
!81 = !{!79, !24, i64 8}
!82 = !{!"RData", !44, i64 0, !13, i64 16, !13, i64 24, !13, i64 32}
!83 = !{!82, !13, i64 32}
!84 = !{!79, !11, i64 28}
!85 = !{!79, !11, i64 16}
!86 = !{!79, !11, i64 20}
!87 = !{!79, !11, i64 24}
!88 = !{!"p1 _ZTS32fast_fallback_getaddrinfo_shared", !13, i64 0}
!89 = !{!"sockaddr_un", !39, i64 0, !10, i64 2}
!90 = !{!89, !39, i64 0}
!91 = distinct !{!91, !23}
!92 = distinct !{!92, !23}
!93 = distinct !{!93, !23}
!94 = distinct !{!94, !23}
!95 = !{!18, !18, i64 0}
!96 = !{i64 0, i64 4, !12, i64 4, i64 4, !12, i64 8, i64 4, !12, i64 12, i64 4, !12, i64 16, i64 4, !12, i64 24, i64 8, !95, i64 32, i64 8, !50, i64 40, i64 8, !52}
!97 = !{!67, !39, i64 0}
!98 = distinct !{!98, !23}
!99 = distinct !{!99, !23}
!100 = !{!"any p2 pointer", !13, i64 0}
!101 = !{!"p2 omnipotent char", !100, i64 0}
!102 = !{!"hostent", !19, i64 0, !101, i64 8, !11, i64 16, !11, i64 20, !101, i64 24}
!103 = !{!102, !101, i64 8}
!104 = distinct !{!104, !23}
!105 = distinct !{!105, !23}
!106 = distinct !{!106, !23, !113}
!107 = !{!"sockaddr_ll", !39, i64 0, !39, i64 2, !11, i64 4, !39, i64 8, !10, i64 10, !10, i64 11, !10, i64 12}
!108 = !{!107, !39, i64 2}
!109 = !{!107, !11, i64 4}
!110 = !{!107, !39, i64 8}
!111 = !{!107, !10, i64 10}
...
!114 = !{!"p1 _ZTS5rb_io", !13, i64 0}
!115 = !{!"RFile", !44, i64 0, !114, i64 16}
!116 = !{!115, !114, i64 16}
!117 = !{!"p1 _ZTS8_IO_FILE", !13, i64 0}
!118 = !{!"rb_io_internal_buffer", !19, i64 0, !11, i64 8, !11, i64 12, !11, i64 16}
!119 = !{!"p1 _ZTS18OnigEncodingTypeST", !13, i64 0}
!120 = !{!"rb_io_encoding", !119, i64 0, !119, i64 8, !11, i64 16, !24, i64 24}
!121 = !{!"p1 _ZTS10rb_econv_t", !13, i64 0}
!122 = !{!"p1 _ZTS14ccan_list_node", !13, i64 0}
!123 = !{!"ccan_list_node", !122, i64 0, !122, i64 8}
!124 = !{!"ccan_list_head", !123, i64 0}
!125 = !{!"p1 _ZTS27rb_execution_context_struct", !13, i64 0}
!126 = !{!"long long", !10, i64 0}
!127 = !{!"rb_io", !24, i64 0, !117, i64 8, !11, i64 16, !11, i64 20, !11, i64 24, !11, i64 28, !24, i64 32, !13, i64 40, !118, i64 48, !118, i64 68, !24, i64 88, !120, i64 96, !121, i64 128, !118, i64 136, !121, i64 160, !24, i64 168, !11, i64 176, !11, i64 180, !24, i64 184, !24, i64 192, !24, i64 200, !124, i64 208, !125, i64 224, !24, i64 232, !126, i64 240}
!128 = !{!127, !11, i64 16}
!129 = !{!88, !88, i64 0}
!130 = !{!"fast_fallback_getaddrinfo_entry", !11, i64 0, !11, i64 4, !11, i64 8, !20, i64 16, !14, i64 64, !88, i64 72, !11, i64 80, !24, i64 88, !11, i64 96}
!131 = !{!130, !88, i64 72}
!132 = !{!130, !24, i64 88}
!133 = !{!"timespec", !24, i64 0, !24, i64 8}
!134 = !{!133, !24, i64 0}
!135 = !{!133, !24, i64 8}
!136 = !{!130, !11, i64 96}
!137 = !{!130, !14, i64 64}
