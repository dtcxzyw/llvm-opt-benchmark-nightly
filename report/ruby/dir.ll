...
..loopexit27.split.us.us.loopexit_crit_edge:      ; preds = %bb.d
  %.018.us.us.lcssa122 = phi ptr [ %.018.us.us, %bb.d ]
...
.loopexit27.split.us.us.loopexit:                 ; preds = %.loopexit27.split.us.us.loopexitsplit, %..loopexit27.split.us.us.loopexit_crit_edge
  %.018.us.us.lcssa113 = phi ptr [ %.018.us.us.lcssa122, %..loopexit27.split.us.us.loopexit_crit_edge ], [ %.018.us.us.lcssa121, %.loopexit27.split.us.us.loopexitsplit ]
  %.ph = phi i64 [ 2, %..loopexit27.split.us.us.loopexit_crit_edge ], [ 1, %.loopexit27.split.us.us.loopexitsplit ]
  %.1.us.ph = phi i32 [ %.015.ph.us, %..loopexit27.split.us.us.loopexit_crit_edge ], [ 1, %.loopexit27.split.us.us.loopexitsplit ]
...
bb.b:                                             ; preds = %bb.d, %.outer.us
  %.018.us.us = phi ptr [ %i.j, %bb.d ], [ %.018.ph.us, %.outer.us ] ; 8 uses
...
.preheader47:                                     ; preds = %.preheader47.preheader, %.backedge
  ...
  %.promoted = phi ptr [ %i.ag, %.backedge ], [ %0, %.preheader47.preheader ] ; 4 uses
