...
bb.av:                                            ; preds = %ruby_nonempty_memcpy.exit.i374, %bb.au
  %.018.i = phi i64 [ %25, %bb.au ], [ %i.da, %ruby_nonempty_memcpy.exit.i374 ]
...
bb.ck:                                            ; preds = %bb.cj, %ruby_nonempty_memcpy.exit.i390
  %.018.i391 = phi i64 [ %26, %bb.cj ], [ %i.b, %ruby_nonempty_memcpy.exit.i390 ]
...
.lr.ph550:                                        ; preds = %.preheader504
  ...
  %i.lm = add i64 %i.b, %i.ll
  %.not.i.i416 = icmp eq i64 %i.b, 0
  %i.ln = add i64 %i.b, 1
  %invariant.op = add i64 %i.lm, 1
  br label %bb.dl
...
._crit_edge547:                                   ; preds = %bb.dz, %bb.dw
  ...
  %i.nd = add i64 %.0, %invariant.op              ; 2 uses
