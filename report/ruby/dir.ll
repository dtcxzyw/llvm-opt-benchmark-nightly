...
.preheader:                                       ; preds = %glob_alloc_n.exit
  br i1 %i.c, label %.lr.ph557, label %._crit_edge558
...
.lr.ph557.split.us:                               ; preds = %.lr.ph557, %bb.cz
  %.1280556.us = phi ptr [ %i.jz, %bb.cz ], [ %6, %.lr.ph557 ] ; 2 uses
  %.0288555.us = phi ptr [ %.3291.us, %bb.cz ], [ %i.jg, %.lr.ph557 ] ; 4 uses
  %i.jj = load ptr, ptr %.1280556.us, align 8, !tbaa !28 ; 4 uses
...
bb.ct:                                            ; preds = %.lr.ph557.split.us
  br i1 %i.ji, label %bb.cu, label %bb.cv

bb.cu:                                            ; preds = %bb.ct
  %i.jn = getelementptr i8, ptr %.0288555.us, i64 8
  store ptr %i.jj, ptr %.0288555.us, align 8, !tbaa !28
  br label %bb.cv

bb.cv:                                            ; preds = %bb.cu, %bb.ct
  %.1289.us = phi ptr [ %i.jn, %bb.cu ], [ %.0288555.us, %bb.ct ]
  %i.jo = getelementptr i8, ptr %i.jj, i64 16
  %i.jp = load ptr, ptr %i.jo, align 8, !tbaa !30 ; 2 uses
  %.phi.trans.insert574 = getelementptr i8, ptr %i.jp, i64 8
  %.pre575 = load i32, ptr %.phi.trans.insert574, align 8, !tbaa !102
  br label %bb.cw

bb.cw:                                            ; preds = %bb.cv, %.lr.ph557.split.us
  %i.jq = phi i32 [ %.pre575, %bb.cv ], [ %i.jl, %.lr.ph557.split.us ]
  %.2290.us = phi ptr [ %.1289.us, %bb.cv ], [ %.0288555.us, %.lr.ph557.split.us ] ; 5 uses
  %.0283.us = phi ptr [ %i.jp, %bb.cv ], [ %i.jj, %.lr.ph557.split.us ] ; 3 uses
...
bb.cz:                                            ; preds = %.sink.split, %bb.cy, %bb.cx, %bb.cw
  ...
  %i.jz = getelementptr i8, ptr %.1280556.us, i64 8 ; 2 uses
  %i.ka = icmp ult ptr %i.jz, %7
  br i1 %i.ka, label %.lr.ph557.split.us, label %._crit_edge558, !llvm.loop !148

bb.da:                                            ; preds = %glob_alloc_n.exit
  call void @free(ptr noundef nonnull %i.ik) #20
  br label %glob_getent.exit.thread

.lr.ph557.split:                                  ; preds = %.lr.ph557, %bb.df
  %.1280556 = phi ptr [ %i.kq, %bb.df ], [ %6, %.lr.ph557 ] ; 2 uses
  %.0288555 = phi ptr [ %.3291, %bb.df ], [ %i.jg, %.lr.ph557 ] ; 5 uses
  %i.kb = load ptr, ptr %.1280556, align 8, !tbaa !28 ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %24) #20
...
bb.db:                                            ; preds = %.lr.ph557.split
  %i.kf = getelementptr i8, ptr %i.kb, i64 16
  %i.kg = load ptr, ptr %i.kf, align 8, !tbaa !30 ; 2 uses
  %.phi.trans.insert572 = getelementptr i8, ptr %i.kg, i64 8
  %.pre573 = load i32, ptr %.phi.trans.insert572, align 8, !tbaa !102
  br label %bb.dc

bb.dc:                                            ; preds = %bb.db, %.lr.ph557.split
  %i.kh = phi i32 [ %.pre573, %bb.db ], [ %i.kd, %.lr.ph557.split ]
  %.0283 = phi ptr [ %i.kg, %bb.db ], [ %i.kb, %.lr.ph557.split ] ; 3 uses
...
bb.dd:                                            ; preds = %bb.dc
  ...
  br i1 %i.kk, label %.sink.split672, label %bb.df
...
bb.de:                                            ; preds = %bb.dc, %bb.dc, %bb.dc
  ...
  br i1 %.not359.not, label %.sink.split672, label %bb.df

.sink.split672:                                   ; preds = %bb.de, %bb.dd
  %i.kn = getelementptr i8, ptr %.0283, i64 16
  %i.ko = load ptr, ptr %i.kn, align 8, !tbaa !30
  %i.kp = getelementptr i8, ptr %.0288555, i64 8
  store ptr %i.ko, ptr %.0288555, align 8, !tbaa !28
  br label %bb.df

bb.df:                                            ; preds = %.sink.split672, %bb.dc, %bb.de, %bb.dd
  %.3291 = phi ptr [ %.0288555, %bb.dc ], [ %.0288555, %bb.de ], [ %.0288555, %bb.dd ], [ %i.kp, %.sink.split672 ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %24) #20
  %i.kq = getelementptr i8, ptr %.1280556, i64 8  ; 2 uses
  %i.kr = icmp ult ptr %i.kq, %7
  br i1 %i.kr, label %.lr.ph557.split, label %._crit_edge558, !llvm.loop !148
...
select.unfold.backedge:                           ; preds = %._crit_edge558, %bb.cf, %bb.ce
  br label %select.unfold, !llvm.loop !149

glob_getent.exit.thread:                          ; preds = %glob_alloc_n.exit.i387, %._crit_edge558, %bb.da
  %.6434 = phi i32 [ -1, %bb.da ], [ -1, %glob_alloc_n.exit.i387 ], [ %i.kt, %._crit_edge558 ] ; 2 uses
...
glob_getent.exit.thread.thread:                   ; preds = %bb.ca, %glob_getent.exit.thread
  %.6434500 = phi i32 [ %.6434, %glob_getent.exit.thread ], [ 0, %bb.ca ]
...
.thread487:                                       ; preds = %glob_getent.exit.thread.thread, %.thread477, %._crit_edge.i401
  %.7435.ph = phi i32 [ %.6434480, %._crit_edge.i401 ], [ %.6434480, %.thread477 ], [ %.6434500, %glob_getent.exit.thread.thread ]
...
bb.dj:                                            ; preds = %.thread455
  br i1 %.0294.lcssa650, label %.thread451, label %bb.dk
...
.preheader505:                                    ; preds = %glob_alloc_n.exit403
  br i1 %i.c, label %.lr.ph540, label %.thread493

.preheader504:                                    ; preds = %.lr.ph540
  %i.ll = icmp ult ptr %i.lk, %i.lt
  br i1 %i.ll, label %.lr.ph550, label %.thread493
...
.lr.ph540:                                        ; preds = %.preheader505, %.lr.ph540
  %.0278539 = phi ptr [ %i.lt, %.lr.ph540 ], [ %i.lk, %.preheader505 ] ; 2 uses
  %.2281538 = phi ptr [ %i.lu, %.lr.ph540 ], [ %6, %.preheader505 ] ; 2 uses
  %i.lp = load ptr, ptr %.2281538, align 8, !tbaa !28 ; 2 uses
  ...
  %i.lt = getelementptr i8, ptr %.0278539, i64 8  ; 5 uses
  store ptr %spec.select365, ptr %.0278539, align 8, !tbaa !28
  %i.lu = getelementptr i8, ptr %.2281538, i64 8  ; 2 uses
  %i.lv = icmp ult ptr %i.lu, %7
  br i1 %i.lv, label %.lr.ph540, label %.preheader504, !llvm.loop !150

bb.dl:                                            ; preds = %.lr.ph550, %bb.eh
  %.3282549 = phi ptr [ %i.lk, %.lr.ph550 ], [ %i.no, %bb.eh ] ; 4 uses
  %i.lw = load ptr, ptr %.3282549, align 8, !tbaa !28 ; 2 uses
...
glob_alloc_n.exit405:                             ; preds = %bb.dm
  ...
  br i1 %.not342, label %.thread493, label %bb.dn
...
glob_alloc_n.exit412:                             ; preds = %ruby_nonempty_memcpy.exit, %remove_backslashes.exit
  ...
  br i1 %.not343, label %.thread493.sink.split, label %bb.dw

bb.dw:                                            ; preds = %glob_alloc_n.exit412
  %i.mq = load ptr, ptr %.3282549, align 8, !tbaa !28
  ...
  %.0277542 = getelementptr i8, ptr %.3282549, i64 8 ; 2 uses
  %i.mu = icmp ult ptr %.0277542, %i.lt
  br i1 %i.mu, label %.lr.ph546, label %._crit_edge547

.lr.ph546:                                        ; preds = %bb.dw, %bb.dz
  %.0277544 = phi ptr [ %.0277, %bb.dz ], [ %.0277542, %bb.dw ] ; 4 uses
  %.4292543 = phi ptr [ %.5293, %bb.dz ], [ %i.mt, %bb.dw ] ; 4 uses
  %i.mv = load ptr, ptr %.0277544, align 8, !tbaa !28 ; 2 uses
  %.not346 = icmp eq ptr %i.mv, null
  br i1 %.not346, label %bb.dz, label %bb.dx

bb.dx:                                            ; preds = %.lr.ph546
...
bb.dy:                                            ; preds = %bb.dx
  %i.mz = load ptr, ptr %.0277544, align 8, !tbaa !28
  %i.na = getelementptr i8, ptr %i.mz, i64 16
  %i.nb = load ptr, ptr %i.na, align 8, !tbaa !30
  %i.nc = getelementptr i8, ptr %.4292543, i64 8
  store ptr %i.nb, ptr %.4292543, align 8, !tbaa !28
  store ptr null, ptr %.0277544, align 8, !tbaa !28
  br label %bb.dz

bb.dz:                                            ; preds = %.lr.ph546, %bb.dx, %bb.dy
  %.5293 = phi ptr [ %i.nc, %bb.dy ], [ %.4292543, %bb.dx ], [ %.4292543, %.lr.ph546 ] ; 2 uses
  %.0277 = getelementptr i8, ptr %.0277544, i64 8 ; 2 uses
  %i.nd = icmp ult ptr %.0277, %i.lt
  br i1 %i.nd, label %.lr.ph546, label %._crit_edge547, !llvm.loop !152
...
bb.eg:                                            ; preds = %bb.ee, %bb.ed
  ...
  br i1 %.not345, label %bb.eh, label %.thread493

bb.eh:                                            ; preds = %bb.eg, %bb.dl
  %i.no = getelementptr i8, ptr %.3282549, i64 8  ; 2 uses
  %i.np = icmp ult ptr %i.no, %i.lt
  br i1 %i.np, label %bb.dl, label %.thread493, !llvm.loop !153

.thread493.sink.split:                            ; preds = %glob_alloc_n.exit412, %bb.ef
  %.lcssa668.sink = phi ptr [ %i.mp, %bb.ef ], [ %i.mb, %glob_alloc_n.exit412 ]
  call void @free(ptr noundef %.lcssa668.sink) #20
  br label %.thread493

.thread493:                                       ; preds = %bb.eh, %bb.eg, %glob_alloc_n.exit405, %.thread493.sink.split, %.preheader505, %.preheader504
  %.12 = phi i32 [ 0, %.preheader505 ], [ -1, %.thread493.sink.split ], [ 0, %.preheader504 ], [ -1, %glob_alloc_n.exit405 ], [ 0, %bb.eh ], [ %i.nn, %bb.eg ]
  call void @free(ptr noundef %i.lk) #20
  br label %.thread451

.thread451:                                       ; preds = %.thread493, %glob_alloc_n.exit403, %bb.bf, %bb.be, %bb.bd, %bb.bb, %bb.bb, %glob_alloc_n.exit.i372, %do_stat.exit.thread, %do_stat.exit, %bb.dj, %.thread487, %bb.di, %bb.aw, %bb.an, %bb.av, %join_path_from_pattern.exit.thread
  %.8 = phi i32 [ %.0273, %join_path_from_pattern.exit.thread ], [ %i.cr, %bb.an ], [ 0, %bb.bb ], [ %.7435, %bb.di ], [ %.12, %.thread493 ], [ %i.dj, %bb.av ], [ 0, %bb.aw ], [ 0, %do_stat.exit.thread ], [ -1, %glob_alloc_n.exit403 ], [ -1, %glob_alloc_n.exit.i372 ], [ %.7435.ph, %.thread487 ], [ 0, %bb.dj ], [ 0, %do_stat.exit ], [ 0, %bb.be ], [ 0, %bb.bf ], [ %i.ea, %bb.bd ], [ 0, %bb.bb ]
...
bb.am:                                            ; preds = %.split.us
  ...
  %spec.select600 = select i1 %brmerge, i1 %not..not175, i1 %i.cu
  br label %bb.aw
