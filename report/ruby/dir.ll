...
glob_getent.exit.thread:                          ; preds = %glob_alloc_n.exit.i387, %._crit_edge558, %bb.da
  %.6434 = phi i32 [ -1, %bb.da ], [ -1, %glob_alloc_n.exit.i387 ], [ %.fr505, %._crit_edge558 ] ; 2 uses
...
.thread493:                                       ; preds = %bb.eh, %bb.eg, %glob_alloc_n.exit405, %.thread493.sink.split, %.preheader505, %.preheader504
  %.12 = phi i32 [ 0, %.preheader505 ], [ -1, %.thread493.sink.split ], [ 0, %.preheader504 ], [ -1, %glob_alloc_n.exit405 ], [ 0, %bb.eh ], [ %.fr, %bb.eg ]
