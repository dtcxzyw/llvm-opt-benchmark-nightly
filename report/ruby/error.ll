...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %bb.e
  ...
  %i.l = phi ptr [ %i.q, %bb.e ], [ %.promoted.i, %.lr.ph.i.preheader ] ; 3 uses
...
.lr.ph.i..critedge.i.loopexit_crit_edge:          ; preds = %.lr.ph.i
  %.lcssa = phi ptr [ %i.l, %.lr.ph.i ]
  %.lcssa39 = phi ptr [ %i.l, %.lr.ph.i ]         ; 0 uses
  br label %.critedge.i.loopexit

.critedge.i.loopexit:                             ; preds = %.critedge.i.loopexitsplit, %.lr.ph.i..critedge.i.loopexit_crit_edge
  %.lcssa.i.ph = phi ptr [ %.lcssa, %.lr.ph.i..critedge.i.loopexit_crit_edge ], [ %.lcssa.a, %.critedge.i.loopexitsplit ]
  br label %.critedge.i
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.h
  %.252 = phi ptr [ %i.ad, %bb.h ], [ %.062, %.lr.ph.preheader ] ; 5 uses
...
.critedge4split:                                  ; preds = %bb.h
  %.lcssa86 = phi ptr [ %i.ae, %bb.h ]
  %.lcssa84 = phi ptr [ %i.ad, %bb.h ]
  br label %.critedge4
...
.lr.ph..critedge4_crit_edge:                      ; preds = %.lr.ph, %.lr.ph
  ...
  %split84 = phi ptr [ %.252, %.lr.ph ], [ %.252, %.lr.ph ] ; 0 uses
  br label %.critedge4

.critedge4:                                       ; preds = %.critedge4split, %.lr.ph..critedge4_crit_edge
  %.242.lcssa = phi ptr [ %.24251.lcssa, %.lr.ph..critedge4_crit_edge ], [ %.lcssa86, %.critedge4split ] ; 4 uses
  %.2.lcssa = phi ptr [ %.252.lcssa, %.lr.ph..critedge4_crit_edge ], [ %.lcssa84, %.critedge4split ] ; 3 uses
