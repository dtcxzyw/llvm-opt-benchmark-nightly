...
begin_hunk_0_@onigenc_unicode_get_case_fold_codes_by_str:bb.a
  ...
  %5 = insertelement <2 x i32> <i32 3, i32 poison>, i32 %i.nv, i64 1 ; 3 uses
...
begin_hunk_1_@onigenc_unicode_get_case_fold_codes_by_str:bb.a
  ...
  %i.nz = getelementptr [20 x i8], ptr %4, i64 %i.ny ; 4 uses
  store i32 %i.l, ptr %i.nz, align 4, !tbaa !56
  %i.oa = getelementptr i8, ptr %i.nz, i64 4
  store <2 x i32> %5, ptr %i.oa, align 4, !tbaa !7
...
begin_hunk_2_@onigenc_unicode_get_case_fold_codes_by_str:bb.a
  ...
  %i.oh = getelementptr [20 x i8], ptr %4, i64 %i.og ; 4 uses
  store i32 %i.l, ptr %i.oh, align 4, !tbaa !56
  %i.oi = getelementptr i8, ptr %i.oh, i64 4
  store <2 x i32> %5, ptr %i.oi, align 4, !tbaa !7
...
begin_hunk_3_@onigenc_unicode_get_case_fold_codes_by_str:bb.a
  ...
  %i.oq = getelementptr [20 x i8], ptr %4, i64 %i.op ; 4 uses
  store i32 %i.l, ptr %i.oq, align 4, !tbaa !56
  %i.or = getelementptr i8, ptr %i.oq, i64 4
  store <2 x i32> %5, ptr %i.or, align 4, !tbaa !7
