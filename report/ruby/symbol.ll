...
bb.b:                                             ; preds = %bb.a
  %i.d = lshr i32 %i.b, 2
  %i.e = lshr i32 %i.b, 3                         ; 2 uses
  %1 = or i32 %i.d, %i.b
  %i.f = or i32 %1, %i.e
  %i.g = lshr i32 %i.f, 2
  %i.h = or i32 %i.g, %i.e                        ; 2 uses
  %i.i = lshr i32 %i.h, 4
...
bb.c:                                             ; preds = %RTYPEDDATA_GET_DATA.exit
  %i.l = lshr i32 %i.j, 2
  %i.m = lshr i32 %i.j, 3                         ; 2 uses
  %2 = or i32 %i.l, %i.j
  %i.n = or i32 %2, %i.m
  %i.o = lshr i32 %i.n, 2
  %i.p = or i32 %i.o, %i.m                        ; 2 uses
  %i.q = lshr i32 %i.p, 4
...
bb.d:                                             ; preds = %managed_id_table_ptr.exit
  %i.v = add nuw nsw i32 %i.t, 1                  ; 3 uses
  %i.w = lshr i32 %i.v, 2
  %i.x = lshr i32 %i.v, 3                         ; 2 uses
  %1 = or i32 %i.w, %i.v
  %i.y = or i32 %1, %i.x
  %i.z = lshr i32 %i.y, 2
  %i.aa = or i32 %i.z, %i.x                       ; 2 uses
