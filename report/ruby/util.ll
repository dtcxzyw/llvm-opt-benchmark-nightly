...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  store i32 %storemerge41, ptr %2, align 4, !tbaa !11
...
bb.d:                                             ; preds = %bb.c
  %i.h = load ptr, ptr @p5s, align 8, !tbaa !53   ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  store i32 625, ptr %i.k, align 8, !tbaa !11
  store <4 x i32> <i32 1, i32 2, i32 0, i32 1>, ptr %i.j, align 8, !tbaa !11
  store ptr null, ptr %i.i, align 8, !tbaa !54
  %i.l = ptrtoint ptr %i.i to i64
  %i.m = cmpxchg volatile ptr @p5s, i64 0, i64 %i.l seq_cst seq_cst, align 8 ; 2 uses
  %.not28 = extractvalue { i64, i1 } %i.m, 1
  br i1 %.not28, label %.preheader, label %.sink.split, !prof !55
...
bb.k:                                             ; preds = %bb.j
  %i.s = load ptr, ptr %.2, align 8, !tbaa !54    ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  br i1 %.not36, label %.backedge, label %.sink.split, !prof !56
...
bb.e:                                             ; preds = %bb.d
  ...
  store <4 x i32> <i32 0, i32 1, i32 0, i32 1>, ptr %i.l, align 8, !tbaa !11
...
._crit_edge98:                                    ; preds = %bb.c
  ...
  %i.t = load i32, ptr %i.s, align 4, !tbaa !26   ; 2 uses
...
.lr.ph.preheader:                                 ; preds = %bb.f
  ...
  tail call void @llvm.memset.p0.i64(ptr align 8 %i.al, i8 0, i64 %i.ap, i1 false), !tbaa !11
  br label %._crit_edge
...
.lr.ph91:                                         ; preds = %._crit_edge, %bb.i
  ...
  %i.az = load i32, ptr %.06588, align 4, !tbaa !11 ; 2 uses
...
bb.g:                                             ; preds = %.preheader85, %bb.g
  ...
  %i.bc = load i32, ptr %.167, align 4, !tbaa !11
  %i.bd = zext i32 %i.bc to i64
  %i.be = mul nuw i64 %i.bd, %i.ba
  %i.bf = load i32, ptr %.064, align 4, !tbaa !11
  ...
  store i32 %i.bk, ptr %.064, align 4, !tbaa !11
  %i.bm = icmp ult ptr %i.bb, %i.as
  br i1 %i.bm, label %bb.g, label %bb.h, !llvm.loop !57

bb.h:                                             ; preds = %bb.g
  %i.bn = trunc nuw i64 %i.bj to i32
  store i32 %i.bn, ptr %i.bl, align 4, !tbaa !11
  br label %bb.i

bb.i:                                             ; preds = %.lr.ph91, %bb.h
  %i.bo = getelementptr i8, ptr %.06389, i64 4
  %i.bp = icmp ult ptr %i.ay, %i.av
  br i1 %i.bp, label %.lr.ph91, label %.preheader, !llvm.loop !58
...
bb.j:                                             ; preds = %.lr.ph94
  ...
  br i1 %i.bt, label %.lr.ph94, label %.critedge, !llvm.loop !59

.critedge:                                        ; preds = %.lr.ph94, %bb.j, %.preheader
  %.068.lcssa = phi i32 [ %i.w, %.preheader ], [ 0, %bb.j ], [ %.06892, %.lr.ph94 ]
  store i32 %.068.lcssa, ptr %i.aj, align 4, !tbaa !26
  br label %Balloc.exit.thread
...
._crit_edge70:                                    ; preds = %bb.a
  ...
  %i.n = load i32, ptr %i.m, align 4, !tbaa !24   ; 2 uses
...
.lr.ph:                                           ; preds = %._crit_edge70, %.lr.ph
  ...
  br i1 %i.r, label %.lr.ph, label %._crit_edge, !llvm.loop !60
...
bb.b:                                             ; preds = %._crit_edge
  ...
  store i32 %.039.lcssa, ptr %i.y, align 8, !tbaa !23
  %i.z = getelementptr i8, ptr %i.x, i64 12
  store i32 %i.s, ptr %i.z, align 4, !tbaa !24
  %i.aa = getelementptr i8, ptr %i.x, i64 20
  %i.ab = getelementptr i8, ptr %i.x, i64 16
  store i32 0, ptr %i.ab, align 8, !tbaa !25
...
.lr.ph63.preheader:                               ; preds = %bb.b
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.ac, i8 0, i64 %i.ag, i1 false), !tbaa !11
...
._crit_edge64:                                    ; preds = %.lr.ph63.preheader, %bb.b
  ...
  %i.ai = load i32, ptr %i.j, align 4, !tbaa !26
...
.preheader.preheader:                             ; preds = %._crit_edge64
  ...
  %i.as = and i64 %i.ar, -4
  %i.at = add i64 %i.as, 4
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %.035.lcssa, ptr nonnull align 8 %i.b, i64 %i.at, i1 false), !tbaa !11
...
bb.d:                                             ; preds = %bb.d, %bb.c
  ...
  %i.av = load i32, ptr %.036, align 4, !tbaa !11 ; 2 uses
  ...
  br i1 %i.bb, label %bb.d, label %bb.e, !llvm.loop !61

bb.e:                                             ; preds = %bb.d
  store i32 %i.ba, ptr %i.ay, align 4, !tbaa !11
...
Bclear.exit52:                                    ; preds = %.preheader.preheader, %bb.e
  ...
  store i32 %.038, ptr %i.aa, align 4, !tbaa !26
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader, %.lr.ph.prol
  ...
  store i8 %i.ap, ptr %.082104.prol, align 1, !tbaa !12
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  store i8 %i.ay, ptr %.082104, align 1, !tbaa !12
  ...
  store i8 %i.bf, ptr %.082, align 1, !tbaa !12
  ...
  store i8 %i.bm, ptr %.082.1, align 1, !tbaa !12
  ...
  store i8 %i.bt, ptr %.082.2, align 1, !tbaa !12
...
bb.m:                                             ; preds = %.loopexit
  store ptr %i.cd, ptr %5, align 8, !tbaa !18
  br label %nrv_alloc.exit
...
!19 = !{!"double", !9, i64 0}
!20 = !{!19, !19, i64 0}
!21 = !{!"p1 _ZTS6Bigint", !16, i64 0}
!22 = !{!"Bigint", !21, i64 0, !10, i64 8, !10, i64 12, !10, i64 16, !10, i64 20, !9, i64 24}
!23 = !{!22, !10, i64 8}
!24 = !{!22, !10, i64 12}
!25 = !{!22, !10, i64 16}
!26 = !{!22, !10, i64 20}
...
!28 = distinct !{!28, !13}
!29 = !{!"RBasic", !14, i64 0, !14, i64 8}
!30 = !{!"RTypedData", !29, i64 0, !14, i64 16, !14, i64 24, !16, i64 32}
!31 = !{!30, !16, i64 32}
!32 = !{!"p1 long", !16, i64 0}
!33 = !{!32, !32, i64 0}
!34 = !{i64 2150843125}
...
!53 = !{!21, !21, i64 0}
!54 = !{!22, !21, i64 0}
!55 = !{!"branch_weights", !"expected", i32 2145766520, i32 1717128}
!56 = !{!"branch_weights", !"expected", i32 2146162781, i32 1320867}
!57 = distinct !{!57, !13}
!58 = distinct !{!58, !13}
!59 = distinct !{!59, !13}
!60 = distinct !{!60, !13}
