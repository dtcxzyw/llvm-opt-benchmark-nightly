...
.lr.ph63.preheader:                               ; preds = %bb.b
  ...
  tail call void @llvm.memset.p0.i64(ptr align 8 %i.ac, i8 0, i64 %i.af, i1 false), !tbaa !7
...
.preheader.preheader:                             ; preds = %._crit_edge64
  ...
  %i.au = and i64 %i.at, -4
  %i.av = add i64 %i.au, 4
  tail call void @llvm.memcpy.p0.p0.i64(ptr align 4 %.035.lcssa, ptr nonnull align 8 %i.b, i64 %i.av, i1 false), !tbaa !7
...
bb.d:                                             ; preds = %bb.d, %bb.c
  %.036 = phi ptr [ %i.b, %bb.c ], [ %i.bb, %bb.d ] ; 2 uses
  %.1 = phi ptr [ %.035.lcssa, %bb.c ], [ %i.ba, %bb.d ] ; 2 uses
  %.0 = phi i32 [ 0, %bb.c ], [ %i.bc, %bb.d ]
  %i.ax = load i32, ptr %.036, align 4, !tbaa !7  ; 2 uses
  %i.ay = shl i32 %i.ax, %i.an
  %i.az = or i32 %i.ay, %.0
  %i.ba = getelementptr i8, ptr %.1, i64 4        ; 2 uses
  store i32 %i.az, ptr %.1, align 4, !tbaa !7
  %i.bb = getelementptr i8, ptr %.036, i64 4      ; 2 uses
