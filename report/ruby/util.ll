...
begin_hunk_0_@ruby_dtoa:bb.a
  ...
  %i.bq = ptrtoint ptr %i.bp to i64               ; 4 uses
...
.loopexit828:                                     ; preds = %.lr.ph946, %bb.az, %.lr.ph958._crit_edge, %bb.aw, %._crit_edge953
  ...
  %.5 = phi ptr [ %.lcssa1282, %.lr.ph958._crit_edge ], [ %.lcssa1282, %bb.az ], [ %.lcssa922, %bb.aw ], [ %.lcssa922, %._crit_edge953 ], [ %i.ea, %.lr.ph946 ] ; 4 uses
  %6 = add i64 %i.bq, 1
  %.51069 = ptrtoint ptr %.5 to i64               ; 2 uses
  %7 = sub i64 %6, %.51069
  %scevgep1071 = getelementptr i8, ptr %.5, i64 %7
...
begin_hunk_3_@ruby_dtoa:bb.a
  ...
  %.12 = phi ptr [ %.11, %cmp.exit639 ], [ %.11, %cmp.exit639.thread ], [ %i.ow, %bb.dv ], [ %.11, %bb.ek ] ; 4 uses
  %8 = add i64 %i.bq, 1
  %.121068 = ptrtoint ptr %.12 to i64             ; 2 uses
  %9 = sub i64 %8, %.121068
  %scevgep = getelementptr i8, ptr %.12, i64 %9
  %i.qm = sub i64 %i.bq, %.121068
  %scevgep.a = getelementptr i8, ptr %.12, i64 %i.qm
  br label %bb.em

bb.em:                                            ; preds = %bb.en, %cmp.exit639.thread771
  %.13 = phi ptr [ %.12, %cmp.exit639.thread771 ], [ %i.qn, %bb.en ] ; 3 uses
...
begin_hunk_4_@ruby_dtoa:bb.a
  ...
  %.16 = phi ptr [ %i.lh, %cmp.exit607.thread754 ], [ %i.bp, %cmp.exit607.thread ], [ %.14, %.preheader817 ], [ %scevgep, %bb.eo ], [ %.13, %bb.ep ], [ %.13, %bb.eq ], [ %i.oz, %bb.dw ], [ %i.np, %bb.dg ], [ %i.ot, %.thread764 ], [ %i.pm, %bb.ee ] ; 2 uses
...
Bclear.exit647:                                   ; preds = %bb.at, %.preheader825, %.lr.ph1373, %bb.ar, %.preheader, %Bclear.exit641, %Bclear.exit645, %.loopexit, %bb.az
  ...
  %.17 = phi ptr [ %.16, %Bclear.exit641 ], [ %.16, %Bclear.exit645 ], [ %.6969, %.loopexit ], [ %.lcssa1282, %bb.az ], [ %i.gj, %.preheader ], [ %.2, %.preheader825 ], [ %i.dq, %bb.ar ], [ %i.ho, %.lr.ph1373 ], [ %i.em, %bb.at ] ; 2 uses
