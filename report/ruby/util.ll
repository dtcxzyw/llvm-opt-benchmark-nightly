...
.critedge.outer.i:                                ; preds = %bb.b, %.critedge.outer.preheader.i
  ...
  %.029.ph.i = phi ptr [ %i.q, %bb.b ], [ %0, %.critedge.outer.preheader.i ] ; 4 uses
...
.critedge.outer.split.i..loopexit.i.loopexit43_crit_edge: ; preds = %.critedge.outer.split.i
  %.029.ph.i.lcssa51 = phi ptr [ %.029.ph.i, %.critedge.outer.split.i ]
  br label %.loopexit.i.loopexit43

.loopexit.i.loopexit43:                           ; preds = %.loopexit.i.loopexit43split, %.critedge.outer.split.i..loopexit.i.loopexit43_crit_edge
  %.144.i.ph = phi ptr [ %.029.ph.i.lcssa51, %.critedge.outer.split.i..loopexit.i.loopexit43_crit_edge ], [ %scevgep.i, %.loopexit.i.loopexit43split ]
  %.13242.i.ph = phi i64 [ %.031.ph.i, %.critedge.outer.split.i..loopexit.i.loopexit43_crit_edge ], [ %i.t, %.loopexit.i.loopexit43split ]
  br label %.loopexit.i
...
.critedge.outer:                                  ; preds = %.critedge.outer.preheader, %bb.e
  ...
  %.029.ph = phi ptr [ %i.v, %bb.e ], [ %0, %.critedge.outer.preheader ] ; 4 uses
...
.critedge.outer.split..loopexit.loopexit79_crit_edge: ; preds = %.critedge.outer.split
  %.029.ph.lcssa84 = phi ptr [ %.029.ph, %.critedge.outer.split ]
  br label %.loopexit.loopexit79

.loopexit.loopexit79:                             ; preds = %.loopexit.loopexit79split, %.critedge.outer.split..loopexit.loopexit79_crit_edge
  %.144.ph = phi ptr [ %.029.ph.lcssa84, %.critedge.outer.split..loopexit.loopexit79_crit_edge ], [ %scevgep, %.loopexit.loopexit79split ]
  %.13242.ph = phi i64 [ %.031.ph, %.critedge.outer.split..loopexit.loopexit79_crit_edge ], [ %i.ae, %.loopexit.loopexit79split ]
  br label %.loopexit
...
.preheader950:                                    ; preds = %.preheader950.preheader, %bb.o
  %lsr.iv2094 = phi ptr [ %lsr.iv2092, %.preheader950.preheader ], [ %scevgep2095, %bb.o ] ; 3 uses
...
bb.ct:                                            ; preds = %bb.cs, %bb.cr
  %.4786 = phi ptr [ %i.ng, %bb.cs ], [ %.3785, %bb.cr ] ; 13 uses
...
begin_hunk_9_@ruby_strtod:bb.a
  ...
  %scevgep2128 = getelementptr i8, ptr %.4786, i64 %i.or
  br label %bb.de
...
.lr.ph94:                                         ; preds = %.lr.ph94.preheader, %bb.j
  ...
  %.07192 = phi i32 [ %i.cb, %bb.j ], [ %i.w, %.lr.ph94.preheader ] ; 3 uses
...
.lr.ph94..critedge.loopexit_crit_edge:            ; preds = %.lr.ph94
  %.07192.lcssa.a = phi i32 [ %.07192, %.lr.ph94 ]
  br label %.critedge.loopexit

.critedge.loopexit:                               ; preds = %.critedge.loopexitsplit, %.lr.ph94..critedge.loopexit_crit_edge
  %.071.lcssa.ph = phi i32 [ %.07192.lcssa.a, %.lr.ph94..critedge.loopexit_crit_edge ], [ 0, %.critedge.loopexitsplit ]
  br label %.critedge
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.e
  ...
  %.07194 = phi i32 [ %i.ak, %bb.e ], [ %i.g, %.lr.ph.preheader ] ; 2 uses
...
.lr.ph..critedge.loopexit_crit_edge:              ; preds = %.lr.ph
  %.07194.lcssa.a = phi i32 [ %.07194, %.lr.ph ]
  br label %.critedge.loopexit

.critedge.loopexit:                               ; preds = %.critedge.loopexitsplit, %.lr.ph..critedge.loopexit_crit_edge
  %.071.lcssa.ph = phi i32 [ %.07194.lcssa.a, %.lr.ph..critedge.loopexit_crit_edge ], [ %.lcssa133, %.critedge.loopexitsplit ]
  br label %.critedge
...
.lr.ph98:                                         ; preds = %.lr.ph98.preheader, %bb.l
  ...
  %.297 = phi i32 [ %i.bs, %bb.l ], [ %.172, %.lr.ph98.preheader ] ; 2 uses
...
.lr.ph98..critedge2.loopexit_crit_edge:           ; preds = %.lr.ph98
  %.297.lcssa.a = phi i32 [ %.297, %.lr.ph98 ]
  br label %.critedge2.loopexit

.critedge2.loopexit:                              ; preds = %.critedge2.loopexitsplit, %.lr.ph98..critedge2.loopexit_crit_edge
  %.2.lcssa.ph = phi i32 [ %.297.lcssa.a, %.lr.ph98..critedge2.loopexit_crit_edge ], [ %.lcssa136, %.critedge2.loopexitsplit ]
  br label %.critedge2
