...
bb.d:                                             ; preds = %RSTRING_PTR.exit
  ...
  %i.t = tail call i32 %i.s(ptr noundef %i.j, ptr noundef %i.m, ptr noundef nonnull %i.a) #9, !inline_history !22 ; 2 uses
...
begin_hunk_1_@bug_str_s_cstr_term:bb.a
  ...
  %i.e = or i1 %i.b, %i.d
  br i1 %i.e, label %rbimpl_RB_TYPE_P_fastpath.exit.thread.i, label %rbimpl_RB_TYPE_P_fastpath.exit.i, !prof !23
...
rbimpl_RB_TYPE_P_fastpath.exit.i:                 ; preds = %bb.a
  ...
  br i1 %i.i, label %Check_Type.exit, label %rbimpl_RB_TYPE_P_fastpath.exit.thread.i, !prof !24
...
begin_hunk_2_@bug_str_s_cstr_unterm:bb.a
  ...
  %i.d = or i1 %i.a, %i.c
  br i1 %i.d, label %rbimpl_RB_TYPE_P_fastpath.exit.thread.i, label %rbimpl_RB_TYPE_P_fastpath.exit.i, !prof !23
...
rbimpl_RB_TYPE_P_fastpath.exit.i:                 ; preds = %bb.a
  ...
  br i1 %i.h, label %Check_Type.exit, label %rbimpl_RB_TYPE_P_fastpath.exit.thread.i, !prof !24
...
bb.d:                                             ; preds = %RSTRING_PTR.exit.i
  ...
  %i.aa = tail call i32 %i.z(ptr noundef %i.q, ptr noundef %i.t, ptr noundef nonnull %i.i) #9, !inline_history !25 ; 2 uses
...
begin_hunk_5_@bug_str_s_cstr_noembed:bb.a
  ...
  %i.m = or i1 %i.j, %i.l
  br i1 %i.m, label %rbimpl_RB_TYPE_P_fastpath.exit.thread.i, label %rbimpl_RB_TYPE_P_fastpath.exit.i, !prof !23

rbimpl_RB_TYPE_P_fastpath.exit.i:                 ; preds = %bb.a
  %i.n = load i64, ptr %i.b, align 8, !tbaa !19   ; 2 uses
  %i.o = and i64 %i.n, 31
  %i.p = icmp eq i64 %i.o, 5
  br i1 %i.p, label %Check_Type.exit, label %rbimpl_RB_TYPE_P_fastpath.exit.thread.i, !prof !24
...
begin_hunk_6_@bug_str_s_cstr_noembed:bb.a
  ...
  br i1 %i.am, label %bb.e, label %bb.f, !prof !26
...
!25 = distinct !{ptr @bug_str_cstr_term_char, null}
