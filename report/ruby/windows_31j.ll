...
.preheader:                                       ; preds = %bb.d, %bb.b, %mbc_enc_len.exit
  %.0.i31 = phi i32 [ %i.t, %mbc_enc_len.exit ], [ %i.p, %bb.d ], [ -1, %bb.b ] ; 2 uses
  %i.u = zext i8 %i.b to i32                      ; 2 uses
  %i.v = icmp sgt i32 %.0.i31, 1
...
.preheader.i:                                     ; preds = %bb.f, %mbc_enc_len.exit.i
  %.0.i31.i = phi i32 [ %i.z, %mbc_enc_len.exit.i ], [ %i.w, %bb.f ] ; 2 uses
  %i.aa = zext i8 %i.b to i32                     ; 2 uses
  %i.ab = icmp sgt i32 %.0.i31.i, 1
...
.lr.ph.i:                                         ; preds = %.preheader.i, %.lr.ph.i
  ...
  %i.ah = icmp slt i32 %i.ag, %.0.i31.i
...
bb.a:
  ...
  %i.d = getelementptr inbounds nuw i8, ptr @trans, i64 %i.c
  %i.e = load i8, ptr %i.d, align 1, !tbaa !10
  %.fr.i = freeze i8 %i.e                         ; 3 uses
  %i.f = sext i8 %.fr.i to i64                    ; 2 uses
  %i.g = icmp slt i8 %.fr.i, 0
...
.preheader.i:                                     ; preds = %bb.c, %mbc_enc_len.exit.i
  %.0.i31.i = phi i32 [ %i.r, %mbc_enc_len.exit.i ], [ %i.o, %bb.c ] ; 2 uses
  %i.s = zext i8 %i.b to i32                      ; 2 uses
  %i.t = icmp sgt i32 %.0.i31.i, 1
...
get_lower_case.exit.thread.thread:                ; preds = %bb.h, %bb.j, %bb.l, %get_lower_case.exit.thread
  %.0.i324042 = phi i32 [ %.017.i4649, %get_lower_case.exit.thread ], [ %i.at, %bb.h ], [ %i.aw, %bb.j ], [ %i.bb, %bb.l ] ; 2 uses
  %.not = icmp eq i32 %.017.i4649, %.0.i324042
...
get_upper_case.exit.thread:                       ; preds = %get_lower_case.exit.thread.thread
  %i.bi = add i32 %.017.i4649, -33919
  %i.bj = icmp ult i32 %i.bi, -15
  %i.bk = add i32 %.017.i4649, -33938
  %i.bl = icmp ult i32 %i.bk, -18
  %or.cond.i33.not = and i1 %i.bj, %i.bl          ; 2 uses
  %i.bm = icmp samesign ugt i32 %.017.i4649, 33919
...
get_upper_case.exit.thread.thread:                ; preds = %get_lower_case.exit.thread, %get_lower_case.exit, %get_upper_case.exit.thread
  ...
  %.0.i345660 = add nsw i32 %.017.i4649, %.pn
  store i32 %.0.i, ptr %3, align 4, !tbaa !16
  ...
  store i32 %.0.i345660, ptr %i.bp, align 4, !tbaa !6
  br label %bb.n
