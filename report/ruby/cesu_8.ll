Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/ruby/original/cesu_8?download=true
inline.NumInlined: 6
inline.NumDeleted: 1
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.u, label %mbc_enc_len.exit.thread25, label %mbc_enc_len.exit.thread
...
bb.m:                                             ; preds = %bb.j, %bb.k, %bb.l, %bb.i, %bb.b
  %.1 = phi i32 [ 1, %bb.b ], [ %i.ar, %bb.l ], [ 1, %bb.j ], [ 1, %bb.k ], [ -401, %bb.i ]
  ret i32 %.1
}
...
; Function Attrs: nounwind sspstrong uwtable
define internal i32 @get_ctype_code_range(i32 noundef %0, ptr nofree noundef writeonly captures(none) initializes((0, 4)) %1, ptr noundef %2, ptr nofree readnone captures(none) %3) #0 {
bb.a:
...
define internal noundef ptr @left_adjust_char_head(ptr nofree noundef readnone captures(address) %0, ptr noundef %1, ptr nofree readnone captures(none) %2, ptr nofree readnone captures(none) %3) #5 {
bb.a:
