...
begin_hunk_0_@rb_ractor_require:bb.a
  ...
  %i.h = tail call i64 @rb_data_typed_object_zalloc(i64 noundef 0, i64 noundef 40, ptr noundef nonnull @cross_ractor_require_data_type) #21 ; 6 uses
...
rb_obj_write.exit:                                ; preds = %rb_obj_set_shareable.exit, %bb.e
  %4 = load i64, ptr %i.d, align 8, !tbaa !57     ; 2 uses
...
bb.j:                                             ; preds = %rb_ractor_make_shareable.exit
  call void @rb_gc_writebarrier(i64 noundef %4, i64 noundef %i.aw) #21
...
begin_hunk_3_@rb_ractor_require:bb.a
  ...
  call void @rb_ractor_interrupt_exec(ptr noundef %i.br, ptr noundef nonnull @ractor_require_func, ptr noundef %5, i32 noundef 1) #21
