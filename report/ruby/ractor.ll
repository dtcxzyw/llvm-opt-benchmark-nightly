...
begin_hunk_0_@rb_ractor_send_parameters:bb.a
...
end_hunk_0
begin_hunk_1_@rb_ractor_dump:bb.a
  ret void
}
...
bb.a:
  %i.a = alloca ptr, align 8                      ; 4 uses
end_hunk_1
begin_hunk_2_@rb_ractor_stdin:bb.a
  ret i64 %.0
}
...
bb.a:
  %i.a = alloca ptr, align 8                      ; 4 uses
end_hunk_2
begin_hunk_3_@rb_ractor_stdout:bb.a
  ret i64 %.0
}
...
attributes #6 = { nofree norecurse nosync nounwind sspstrong memory(read, inaccessiblemem: readwrite, target_mem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
