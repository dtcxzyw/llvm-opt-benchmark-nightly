...
begin_hunk_0_@nucomp_inspect:bb.a
...
RB_FLOAT_TYPE_P.exit.thread11.i:                  ; preds = %rb_integer_type_p.exit.i.i, %bb.b
  ...
  br i1 %.not, label %bb.d, label %f_finite_p.exit.thread
...
bb.a:
  %i.a = inttoptr i64 %0 to ptr                   ; 2 uses
  %i.b = getelementptr i8, ptr %i.a, i64 16
  %i.c = load i64, ptr @id_i_real, align 8, !tbaa !11
  %i.d = tail call i64 @rb_ivar_get(i64 noundef %1, i64 noundef %i.c) #17 ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  tail call void @rb_gc_writebarrier(i64 noundef %0, i64 noundef %i.d) #17
  br label %rb_obj_write.exit

rb_obj_write.exit:                                ; preds = %bb.a, %bb.b
  %i.i = getelementptr i8, ptr %i.a, i64 24
  %i.j = load i64, ptr @id_i_imag, align 8, !tbaa !11
  %i.k = tail call i64 @rb_ivar_get(i64 noundef %1, i64 noundef %i.j) #17 ; 4 uses
  store i64 %i.k, ptr %i.i, align 8, !tbaa !11
  %i.l = icmp eq i64 %i.k, 0
  %i.m = and i64 %i.k, 7
  %i.n = icmp ne i64 %i.m, 0
  %i.o = or i1 %i.l, %i.n
  br i1 %i.o, label %rb_obj_write.exit8, label %bb.c

bb.c:                                             ; preds = %rb_obj_write.exit
  tail call void @rb_gc_writebarrier(i64 noundef %0, i64 noundef %i.k) #17
  br label %rb_obj_write.exit8

rb_obj_write.exit8:                               ; preds = %rb_obj_write.exit, %bb.c
...
bb.a:
  ...
  %i.c = load i64, ptr %i.b, align 8, !tbaa !16   ; 10 uses
  %i.d = and i64 %i.c, 3
  %i.e = icmp eq i64 %i.d, 2
  br i1 %i.e, label %RB_FLOAT_TYPE_P.exit.thread, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.f = icmp eq i64 %i.c, 0                      ; 2 uses
  %i.g = and i64 %i.c, 7
  %i.h = icmp ne i64 %i.g, 0
  %i.i = or i1 %i.f, %i.h
  br i1 %i.i, label %RB_FLOAT_TYPE_P.exit.thread11.i, label %RB_FLOAT_TYPE_P.exit

RB_FLOAT_TYPE_P.exit:                             ; preds = %bb.b
  %i.j = inttoptr i64 %i.c to ptr
  %i.k = load i64, ptr %i.j, align 8, !tbaa !17
  %i.l = and i64 %i.k, 31
  %i.m = icmp eq i64 %i.l, 4
  br i1 %i.m, label %RB_FLOAT_TYPE_P.exit.thread, label %RB_FLOAT_TYPE_P.exit.i

RB_FLOAT_TYPE_P.exit.i:                           ; preds = %RB_FLOAT_TYPE_P.exit
  %i.n = inttoptr i64 %i.c to ptr                 ; 2 uses
  %i.o = load i64, ptr %i.n, align 8, !tbaa !17
  %i.p = and i64 %i.o, 31
  %i.q = icmp eq i64 %i.p, 4
  br i1 %i.q, label %FLOAT_ZERO_P.exit.i, label %RB_FLOAT_TYPE_P.exit.thread11.i

FLOAT_ZERO_P.exit.i:                              ; preds = %RB_FLOAT_TYPE_P.exit.i
  %i.r = getelementptr i8, ptr %i.n, i64 16
  %i.s = load double, ptr %i.r, align 8, !tbaa !19
  %i.t = fcmp oeq double %i.s, 0.000000e+00
  br i1 %i.t, label %bb.e, label %RB_FLOAT_TYPE_P.exit.thread

RB_FLOAT_TYPE_P.exit.thread11.i:                  ; preds = %bb.b, %RB_FLOAT_TYPE_P.exit.i
  %i.u = trunc i64 %i.c to i1
end_hunk_0
