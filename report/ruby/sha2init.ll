...
rb_digest_make_metadata.exit:                     ; preds = %bb.a, %bb.b
  ...
  %i.k = tail call i64 %i.j(ptr noundef nonnull @sha256) #3, !inline_history !14
...
rb_digest_make_metadata.exit15:                   ; preds = %rb_digest_make_metadata.exit, %bb.d
  ...
  %i.r = tail call i64 %i.q(ptr noundef nonnull @sha384) #3, !inline_history !14
...
rb_digest_make_metadata.exit18:                   ; preds = %rb_digest_make_metadata.exit15, %bb.f
  ...
  %i.y = tail call i64 %i.x(ptr noundef nonnull @sha512) #3, !inline_history !14
