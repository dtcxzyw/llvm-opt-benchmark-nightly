...
bb.l:                                             ; preds = %rb_num2int_inline.exit
  ...
  %i.aq = call i32 %i.ap(i32 noundef %i.ai, ptr noundef nonnull %i.d, ptr noundef %i.ak) #16 ; 0 uses
...
begin_hunk_1_@strio_ungetc:bb.a
  ...
  call void asm sideeffect "", "*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(ptr) %i.b) #16, !srcloc !40
  %i.bo = load ptr, ptr %i.b, align 8, !tbaa !38
...
begin_hunk_2_@strio_ungetbyte:bb.a
  ...
  store ptr %i.a, ptr %i.b, align 8, !tbaa !38
  call void asm sideeffect "", "*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(ptr) %i.b) #16, !srcloc !40
  %i.aw = load ptr, ptr %i.b, align 8, !tbaa !38
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #16
...
begin_hunk_3_@strio_readlines:bb.a
  ...
  br i1 %i.x, label %._crit_edge, label %.lr.ph, !llvm.loop !41
...
begin_hunk_4_@strio_write_m:bb.a
  ...
  br i1 %i.g, label %.lr.ph, label %._crit_edge, !llvm.loop !42
...
bb.z:                                             ; preds = %bb.y
  ...
  %.val.i = load i32, ptr %i.bh, align 4, !tbaa !47
...
bb.ab:                                            ; preds = %rb_enc_asciicompat.exit.thread
  ...
  %.val31 = load ptr, ptr %i.bo, align 8, !tbaa !48
  %i.bp = getelementptr i8, ptr %i.av, i64 8
  %.val = load ptr, ptr %i.bp, align 8, !tbaa !48
...
bb.ac:                                            ; preds = %bb.w, %bb.y, %rb_enc_asciicompat.exit, %bb.aa, %bb.s, %rb_num2long_inline.exit34
  ...
  store i64 %i.bq, ptr %1, align 8, !tbaa !49
...
begin_hunk_13_@strio_getline:bb.a
  ...
  %i.d = load i64, ptr %0, align 8, !tbaa !49     ; 2 uses
...
bb.t:                                             ; preds = %.preheader222
  ...
  br i1 %i.bm, label %.thread, label %.preheader222, !llvm.loop !50
...
begin_hunk_15_@strio_getline:bb.a
  ...
  br i1 %i.cd, label %.lr.ph, label %.critedge2, !llvm.loop !51
...
RSTRING_PTR.exit202.us:                           ; preds = %.lr.ph233
  ...
  br i1 %i.fl, label %.split.us, label %.lr.ph233, !llvm.loop !53
...
.lr.ph233:                                        ; preds = %.lr.ph229.split.us, %RSTRING_PTR.exit202.us
  ...
  br i1 %.not175.us, label %.loopexit, label %RSTRING_PTR.exit202.us, !llvm.loop !53
...
begin_hunk_18_@strio_getline:bb.a
  ...
  br i1 %.not175, label %.loopexit, label %RSTRING_PTR.exit202, !llvm.loop !53

RSTRING_PTR.exit202:                              ; preds = %.lr.ph231
  %bcmp = tail call i32 @bcmp(ptr nonnull %i.fq, ptr %i.fo, i64 %i.bc)
  %i.fs = icmp eq i32 %bcmp, 0
  br i1 %i.fs, label %.split.us, label %.lr.ph231, !llvm.loop !53
...
begin_hunk_19_@strio_getline:bb.a
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !54
...
begin_hunk_20_@strio_getline:bb.a
  ...
  br i1 %.not.i205.3, label %bm_init_skip.exit, label %.lr.ph.i, !llvm.loop !56
...
begin_hunk_21_@bm_search:bb.a
  ...
  br i1 %i.n, label %.preheader.us, label %.loopexit, !llvm.loop !57

bb.c:                                             ; preds = %bb.b
  %i.o = add nsw i64 %.023.us, -1
  %i.p = add nsw i64 %.01822.us, -1
  %i.q = icmp sgt i64 %.01822.us, 0
  br i1 %i.q, label %bb.b, label %.loopexit.loopexit, !llvm.loop !58
...
bb.ag:                                            ; preds = %RSTRING_PTR.exit, %bb.u, %RSTRING_PTR.exit70
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #16
  store ptr %i.a, ptr %i.b, align 8, !tbaa !38
  call void asm sideeffect "", "*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(ptr) %i.b) #16, !srcloc !59
  %i.cy = load ptr, ptr %i.b, align 8, !tbaa !38
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #16
...
!42 = distinct !{!42, !30}
!43 = !{!44, !14, i64 8}
!44 = !{!"rb_io_encoding", !14, i64 0, !14, i64 8, !7, i64 16, !11, i64 24}
!45 = distinct !{!45, !30}
!46 = !{!44, !14, i64 0}
!47 = !{!36, !7, i64 20}
!48 = !{!36, !37, i64 8}
