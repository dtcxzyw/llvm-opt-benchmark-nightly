...
begin_hunk_1
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.o) #20
  call void @llvm.lifetime.end.p0(ptr nonnull %i.n) #20
  br i1 %.not21, label %bb.h, label %bb.l

bb.h:                                             ; preds = %c_jd_to_ordinal.exit, %bb.a
  %.118 = phi i32 [ %6, %c_jd_to_ordinal.exit ], [ %1, %bb.a ] ; 2 uses
...
bb.l:                                             ; preds = %c_find_ldoy.exit.thread, %c_jd_to_ordinal.exit36, %c_jd_to_ordinal.exit
  %.1 = phi i32 [ 0, %c_jd_to_ordinal.exit ], [ %spec.select, %c_jd_to_ordinal.exit36 ], [ 0, %c_find_ldoy.exit.thread ]
  ret i32 %.1
}
