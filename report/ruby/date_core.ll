...
bb.a:
  %i.a = fcmp olt double %1, 0.000000e+00         ; 2 uses
  %i.b = select i1 %i.a, i32 584400, i32 584388   ; 2 uses
...
rbimpl_intern_const.exit:                         ; preds = %.lr.ph.i, %.critedge
  ...
  %4 = select i1 %i.a, i64 1168801, i64 1168777   ; 2 uses
  %i.x = tail call i64 (i64, i64, i32, ...) @rb_funcall(i64 noundef %i.v, i64 noundef %.lcssa.i, i32 noundef 1, i64 noundef %4) #19 ; 10 uses
...
f_zero_p.exit.thread:                             ; preds = %bb.h, %rb_type.exit.i, %rb_type.exit.thread8.i, %f_zero_p.exit
  %i.am = tail call i64 (i64, i64, i32, ...) @rb_funcall(i64 noundef %i.v, i64 noundef 37, i32 noundef 1, i64 noundef %4) #19
