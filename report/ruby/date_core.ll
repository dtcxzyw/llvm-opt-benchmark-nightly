...
c_find_fdoy.exit.i:                               ; preds = %bb.c
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f) #20
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #20
  %i.r = load i32, ptr %i.g, align 4, !tbaa !6    ; 4 uses
...
begin_hunk_10_@c_valid_commercial_p:bb.a
  ...
  %9 = add i32 %i.aa, 3
  call fastcc void @c_jd_to_commercial(i32 noundef %9, double noundef %3, ptr noundef %i.i, ptr noundef %i.j, ptr noundef %i.k)
...
c_commercial_to_jd.exit41:                        ; preds = %bb.h, %bb.i
  ...
  %i.an = mul i32 %.126, 7
  %i.ao = add i32 %spec.select, %i.an
  %i.ap = add i32 %i.ao, %i.ag
  %10 = sub i32 %i.ap, %i.am
  %11 = add i32 %10, -8                           ; 2 uses
  store i32 %11, ptr %6, align 4, !tbaa !6
  %i.aq = sitofp i32 %11 to double
...
c_find_fdoy.exit.i:                               ; preds = %bb.c
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f) #20
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #20
  %i.ai = load i32, ptr %i.g, align 4, !tbaa !6   ; 4 uses
...
c_find_fdoy.exit.i27:                             ; preds = %bb.g
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #20
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #20
  %i.as = load i32, ptr %i.c, align 4, !tbaa !6   ; 4 uses
...
bb.j:                                             ; preds = %c_commercial_to_jd.exit, %c_commercial_to_jd.exit28
  %.0 = phi i32 [ %8, %c_commercial_to_jd.exit28 ], [ %6, %c_commercial_to_jd.exit ]
...
c_weeknum_to_jd.exit46:                           ; preds = %bb.h, %bb.i
  ...
  %i.au = add i32 %spec.select, %i.at
  %i.av = add i32 %i.au, %i.ak
  %9 = sub i32 %i.av, %i.as
  %10 = add i32 %9, -7                            ; 2 uses
