...
define internal range(i32 0, 2) i32 @ary_hash_orset(ptr noundef writeonly captures(none) %0, ptr noundef writeonly captures(none) %1, i64 noundef %2, i32 noundef %3) #19 {
bb.a:
  %.not = icmp eq i32 %3, 0
