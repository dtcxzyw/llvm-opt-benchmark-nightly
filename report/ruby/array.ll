...
._crit_edge289:                                   ; preds = %.lr.ph288, %bb.bf, %bb.be, %rb_ary_ptr_use_start.exit251
  %.2272319 = phi i64 [ 0, %bb.bf ], [ %.2272, %rb_ary_ptr_use_start.exit251 ], [ 0, %bb.be ], [ %.2272, %.lr.ph288 ]
...
bb.bp:                                            ; preds = %._crit_edge301, %._crit_edge292, %._crit_edge289
  ...
  %.3 = phi i64 [ %spec.select209, %._crit_edge301 ], [ %spec.select209, %._crit_edge292 ], [ %.2272319, %._crit_edge289 ] ; 2 uses
