...
bb.f:                                             ; preds = %.preheader.split.split, %queue_ptr.exit
  tail call void @rb_error_arity(i32 noundef %0, i32 noundef 0, i32 noundef 1) #42
  unreachable

bb.g:                                             ; preds = %.preheader.split.split
  ...
  %8 = icmp ne i64 %7, 0
  %9 = or i1 %i.ad, %8
  br i1 %9, label %rb_obj_write.exit.a, label %bb.h

bb.h:                                             ; preds = %bb.g
  tail call void @rb_gc_writebarrier(i64 noundef %2, i64 noundef %6) #17
  %.pre = load i64, ptr %5, align 1, !tbaa !207
  br label %rb_obj_write.exit.a

rb_obj_write.exit.a:                              ; preds = %bb.g, %bb.h
  %10 = phi i64 [ %6, %bb.g ], [ %.pre, %bb.h ]
  %11 = getelementptr i8, ptr %.1.i.i, i64 8
  store ptr %.1.i.i, ptr %11, align 8, !tbaa !58
...
bb.j:                                             ; preds = %rb_obj_write.exit12, %rb_obj_write.exit.a
  ret i64 %2
}
