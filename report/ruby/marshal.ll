...
begin_hunk_2_@r_object_for:bb.a
  ...
  %i.tr = load i64, ptr %i.ti, align 8, !tbaa !52 ; 2 uses
  %i.ts = add i64 %i.tr, -2
...
._crit_edge817:                                   ; preds = %.lr.ph816, %r_entry0.exit546
  %storemerge431.lcssa = phi i64 [ %6, %r_entry0.exit546 ], [ %i.tr, %.lr.ph816 ]
  store i64 %storemerge431.lcssa, ptr %i.ti, align 8, !tbaa !52
