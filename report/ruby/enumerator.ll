...
.critedge.i:                                      ; preds = %.lr.ph219.i
  %.0126218.i.lcssa = phi i64 [ %.0126218.i, %.lr.ph219.i ]
...
.lr.ph225.i:                                      ; preds = %.lr.ph225.i.preheader, %.lr.ph225.i
  %lsr.iv129 = phi i64 [ %.0126218.i.lcssa, %.lr.ph225.i.preheader ], [ %lsr.iv.next130, %.lr.ph225.i ]
...
bb.h:                                             ; preds = %lazy_yielder_yield.exit, %bb.g
  %.0 = phi i64 [ 0, %bb.g ], [ %i.bn, %lazy_yielder_yield.exit ] ; 6 uses
...
split.a:                                          ; preds = %rb_array_len.exit
  ...
  %.lcssa.ph = phi i64 [ %i.aj, %rb_array_len.exit ]
  br label %bb.m

rb_array_len.exit.thread._crit_edge:              ; preds = %rb_array_len.exit.thread
  %.0.lcssa78 = phi i64 [ %.0, %rb_array_len.exit.thread ]
  %.0.lcssa76 = phi i64 [ %.0, %rb_array_len.exit.thread ] ; 0 uses
  %split76 = phi i64 [ %i.aj, %rb_array_len.exit.thread ]
  br label %bb.m

bb.m:                                             ; preds = %split.a, %rb_array_len.exit.thread._crit_edge
  %.0.lcssa = phi i64 [ %.0.lcssa78, %rb_array_len.exit.thread._crit_edge ], [ %.0.lcssa77, %split.a ] ; 3 uses
  %.lcssa = phi i64 [ %split76, %rb_array_len.exit.thread._crit_edge ], [ %.lcssa.ph, %split.a ]
