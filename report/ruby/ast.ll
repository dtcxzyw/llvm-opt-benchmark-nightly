...
bb.ek:                                            ; preds = %bb.ej, %bb.ei, %bb.ef
  %.0402 = phi i64 [ 4, %bb.ef ], [ %i.pj, %bb.ej ], [ 4, %bb.ei ]
  %.0401 = phi i64 [ 4, %bb.ef ], [ %i.pg, %bb.ej ], [ %i.pg, %bb.ei ]
  %i.pk = tail call i64 @rb_node_dstr_string_val(ptr noundef nonnull %1) #10
  %i.pl = tail call i64 (i64, ...) @rb_ary_new_from_args(i64 noundef 3, i64 noundef %i.pk, i64 noundef %.0401, i64 noundef %.0402) #10
  br label %bb.ic
