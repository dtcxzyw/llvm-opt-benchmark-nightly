...
RSTRING_PTR.exit1359:                             ; preds = %bb.oa, %bb.ob
  %i.amn = phi ptr [ %i.amm, %bb.ob ], [ %i.am, %bb.oa ] ; 10 uses
...
bb.oh:                                            ; preds = %bb.og, %bb.of
  %.16 = phi i64 [ %i.amz, %bb.og ], [ %.15, %bb.of ] ; 2 uses
...
RSTRING_PTR.exit1361:                             ; preds = %bb.oh, %bb.oi
  ...
  %3 = getelementptr i8, ptr %i.amn, i64 %.16     ; 2 uses
  br i1 %i.ank, label %bb.oj, label %bb.ol

bb.oj:                                            ; preds = %RSTRING_PTR.exit1361
  %i.anl = sub i64 %i.ane, %.pre-phi              ; 4 uses
...
bb.ol:                                            ; preds = %RSTRING_PTR.exit1361
  store i8 48, ptr %3, align 1, !tbaa !15
  br label %ruby_nonempty_memcpy.exit1364

ruby_nonempty_memcpy.exit1364:                    ; preds = %bb.ok, %bb.oj, %bb.ol
  %.pn = phi i64 [ 1, %bb.ol ], [ %i.anl, %bb.oj ], [ %i.anl, %bb.ok ]
...
; Function Attrs: nofree norecurse nosync nounwind sspstrong memory(readwrite, inaccessiblemem: write, target_mem: none) uwtable
...
bb.e:                                             ; preds = %bb.d
  ...
  %2 = load ptr, ptr %0, align 8, !tbaa !67       ; 2 uses
  %.not.i = icmp eq i64 %i.t, 0
  br i1 %.not.i, label %ruby_nonempty_memcpy.exit, label %bb.f

bb.f:                                             ; preds = %bb.e
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 %2, ptr noundef nonnull readonly align 1 %.133.lcssa, i64 noundef range(i64 1, 0) %spec.select, i1 noundef false) #20
...
ruby_nonempty_memcpy.exit:                        ; preds = %bb.e, %bb.f
  %.pre46 = phi i64 [ %.pre46.pre, %bb.f ], [ %i.m, %bb.e ]
  %i.w = phi ptr [ %.pre44, %bb.f ], [ %2, %bb.e ]
  %i.x = phi i64 [ %.pre, %bb.f ], [ 0, %bb.e ]
...
attributes #13 = { nofree norecurse nosync nounwind sspstrong memory(readwrite, inaccessiblemem: write, target_mem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
