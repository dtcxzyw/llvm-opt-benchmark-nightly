...
.backedge.sink.split:                             ; preds = %rb_type.exit.thread, %bb.ix, %rb_float_value_inline.exit1300
  %.sink5411 = phi i64 [ %i.xg, %rb_float_value_inline.exit1300 ], [ %i.xt, %bb.ix ], [ %i.xv, %rb_type.exit.thread ]
...
rb_float_value_inline.exit1304:                   ; preds = %bb.iu, %bb.iv, %bb.iw
  ...
  br i1 %i.xs, label %.backedge.backedge, label %.loopexit1594
...
.sink.split:                                      ; preds = %bb.kd, %bb.kc, %bb.kb
  %.sink5412 = phi i8 [ 45, %bb.kb ], [ 43, %bb.kc ], [ 32, %bb.kd ]
...
bb.ke:                                            ; preds = %.sink.split, %bb.kd
  %.17746 = phi i8 [ %.sink5412, %.sink.split ], [ 0, %bb.kd ]
  ...
  br i1 %i.acf, label %bb.kf, label %.preheader1593
...
.preheader1593:                                   ; preds = %bb.ke, %.preheader1593
  %.129.i.i = phi ptr [ %i.acl, %.preheader1593 ], [ %i.ax, %bb.ke ]
  %.1.i.i = phi i64 [ %i.acm, %.preheader1593 ], [ %.11023, %bb.ke ] ; 3 uses
  ...
  br i1 %.not38.i.i, label %ruby_ultoa.exit, label %.preheader1593, !llvm.loop !47

ruby_ultoa.exit:                                  ; preds = %.preheader1593, %bb.kf
  %.030.i.i = phi ptr [ %i.ay, %bb.kf ], [ %i.acl, %.preheader1593 ] ; 2 uses
...
bb.ki:                                            ; preds = %RSTRING_PTR.exit1326
  ...
  br label %.sink.split5413

bb.kj:                                            ; preds = %RSTRING_PTR.exit1326
  %i.acz = and i32 %.1952, 4
  %.not1126 = icmp eq i32 %i.acz, 0
  br i1 %.not1126, label %bb.kk, label %.sink.split5413

bb.kk:                                            ; preds = %bb.kj
  %i.ada = and i32 %.1952, 16
  %.not1127 = icmp eq i32 %i.ada, 0
  br i1 %.not1127, label %bb.kl, label %.sink.split5413

.sink.split5413:                                  ; preds = %bb.kk, %bb.kj, %bb.ki
  %.sink5415 = phi i8 [ 45, %bb.ki ], [ 43, %bb.kj ], [ 32, %bb.kk ]
  %.21034.ph = phi i32 [ -1, %bb.ki ], [ 1, %bb.kj ], [ 1, %bb.kk ]
  %.11030.ph = phi ptr [ %i.acy, %bb.ki ], [ %i.acv, %bb.kj ], [ %i.acv, %bb.kk ]
  %i.adb = add i32 %.0928, -1
  br label %bb.kl

bb.kl:                                            ; preds = %.sink.split5413, %bb.kk
  %.2 = phi i8 [ %.sink5415, %.sink.split5413 ], [ 0, %bb.kk ]
  %.21034 = phi i32 [ %.21034.ph, %.sink.split5413 ], [ 1, %bb.kk ]
  %.11030 = phi ptr [ %.11030.ph, %.sink.split5413 ], [ %i.acv, %bb.kk ] ; 2 uses
  %.8936 = phi i32 [ %i.adb, %.sink.split5413 ], [ %.0928, %bb.kk ]
...
.thread1477:                                      ; preds = %RSTRING_END.exit1328, %ruby_ultoa.exit, %bb.kp, %bb.ko
  %.3 = phi i8 [ %.17746, %ruby_ultoa.exit ], [ %.2, %RSTRING_END.exit1328 ], [ %.0, %bb.ko ], [ %.0, %bb.kp ] ; 2 uses
...
.preheader:                                       ; preds = %.thread1477
  ...
  %.not11363075 = icmp eq i8 %i.adp, 0
  br i1 %.not11363075, label %.loopexit, label %.lr.ph3077

.lr.ph3077:                                       ; preds = %.preheader, %.lr.ph3077
  %i.adq = phi i8 [ %i.adv, %.lr.ph3077 ], [ %i.adp, %.preheader ]
  %.010103076 = phi ptr [ %i.adu, %.lr.ph3077 ], [ %.210311486, %.preheader ] ; 2 uses
  %i.adr = zext i8 %i.adq to i32
  %i.ads = call i32 @rb_enc_toupper(i32 noundef %i.adr, ptr noundef %.08533085) #24
  %i.adt = trunc i32 %i.ads to i8
  store i8 %i.adt, ptr %.010103076, align 1, !tbaa !15
  %i.adu = getelementptr i8, ptr %.010103076, i64 1 ; 2 uses
  %i.adv = load i8, ptr %i.adu, align 1, !tbaa !15 ; 2 uses
  %.not1136 = icmp eq i8 %i.adv, 0
  br i1 %.not1136, label %.loopexit, label %.lr.ph3077, !llvm.loop !48

.loopexit:                                        ; preds = %.lr.ph3077, %.preheader, %.thread1477
...
bb.kr:                                            ; preds = %bb.kq
  br i1 %.110251489, label %bb.ks, label %.thread1494
...
bb.ku:                                            ; preds = %bb.kt
  ...
  %sext1589 = ashr i32 %i.aeb, 31
  %spec.select1579 = add i32 %.31429, %sext1589
  br label %.thread1505
...
bb.kv:                                            ; preds = %bb.kt, %bb.ks
  ...
  br i1 %cond.fr1494, label %.thread1494, label %.thread1505
...
bb.kx:                                            ; preds = %bb.kw
  ...
  br i1 %i.aeg, label %.thread1494, label %bb.ky

bb.ky:                                            ; preds = %bb.kx, %bb.kw
  br i1 %.not1137, label %.thread1494, label %.thread1505

.thread1505:                                      ; preds = %bb.ku, %bb.kv, %bb.ky
  %.110161512 = phi i32 [ %.010151490, %bb.ky ], [ 0, %bb.ku ], [ %.010151490, %bb.kv ]
  %.41510 = phi i32 [ %.31429, %bb.ky ], [ %spec.select1579, %bb.ku ], [ %.31429, %bb.kv ]
...
.thread1494:                                      ; preds = %bb.kv, %bb.kx, %bb.kr, %.thread1505, %bb.ky
  %.not11411502 = phi i1 [ false, %.thread1505 ], [ true, %bb.ky ], [ true, %bb.kr ], [ true, %bb.kx ], [ true, %bb.kv ] ; 2 uses
  %.110161501 = phi i32 [ %.110161512, %.thread1505 ], [ %.010151490, %bb.ky ], [ %.010151490, %bb.kr ], [ 1, %bb.kx ], [ %.010151490, %bb.kv ] ; 6 uses
  %.110281500 = phi ptr [ %.01027, %.thread1505 ], [ null, %bb.ky ], [ null, %bb.kr ], [ null, %bb.kx ], [ null, %bb.kv ] ; 2 uses
  %.41499 = phi i32 [ %.41510, %.thread1505 ], [ %.31429, %bb.ky ], [ %.31429, %bb.kr ], [ %.31429, %bb.kx ], [ %.31429, %bb.kv ] ; 3 uses
  %.11939 = phi i32 [ %i.aej, %.thread1505 ], [ %.10938, %bb.ky ], [ %.10938, %bb.kr ], [ %.10938, %bb.kx ], [ %.10938, %bb.kv ] ; 2 uses
  %i.aek = and i32 %.1952, 74
  %i.ael = icmp eq i32 %i.aek, 8
  br i1 %i.ael, label %.thread1527, label %bb.kz

bb.kz:                                            ; preds = %.thread1494
  %i.aem = icmp slt i32 %.41499, %.110161501
  br i1 %i.aem, label %bb.la, label %bb.lc

bb.la:                                            ; preds = %bb.kz
  %i.aen = icmp eq i32 %.41499, 0
  %or.cond = and i1 %.not11411502, %i.aen
  %i.aeo = icmp eq i32 %.110161501, 1
...
bb.lc:                                            ; preds = %bb.kz, %bb.lb, %bb.la
  %.51430 = phi i32 [ %.41499, %bb.kz ], [ %.110161501, %bb.la ], [ %spec.select1198, %bb.lb ] ; 4 uses
  %.31018 = phi i32 [ %.110161501, %bb.kz ], [ %.110161501, %bb.la ], [ %spec.select1198, %bb.lb ] ; 3 uses
  %i.aer = sub i32 %.11939, %.51430               ; 3 uses
  %i.aes = and i32 %.1952, 2
  %.not1142 = icmp eq i32 %i.aes, 0
  br i1 %.not1142, label %bb.ld, label %.thread1527

bb.ld:                                            ; preds = %bb.lc
  %i.aet = icmp slt i32 %i.aer, 1
  br i1 %i.aet, label %.thread1527, label %bb.le
...
.thread1527:                                      ; preds = %.thread1494, %RSTRING_PTR.exit1332, %bb.ld, %bb.lc
  %.410191524 = phi i32 [ %.31018, %bb.lc ], [ %.31018, %bb.ld ], [ %.31018, %RSTRING_PTR.exit1332 ], [ %.110161501, %.thread1494 ] ; 4 uses
  %.614311522 = phi i32 [ %.51430, %bb.lc ], [ %.51430, %bb.ld ], [ %.51430, %RSTRING_PTR.exit1332 ], [ %.11939, %.thread1494 ] ; 2 uses
  %.13941 = phi i32 [ %i.aer, %bb.lc ], [ 0, %bb.ld ], [ 0, %RSTRING_PTR.exit1332 ], [ 0, %.thread1494 ] ; 2 uses
  %.13899 = phi i64 [ %.1887, %bb.lc ], [ %.1887, %bb.ld ], [ %.11897, %RSTRING_PTR.exit1332 ], [ %.1887, %.thread1494 ] ; 2 uses
  %.8883 = phi i64 [ %i.by, %bb.lc ], [ %i.by, %bb.ld ], [ %i.afk, %RSTRING_PTR.exit1332 ], [ %i.by, %.thread1494 ] ; 4 uses
  %.not1143 = icmp eq i8 %.3, 0
  br i1 %.not1143, label %bb.lq, label %bb.lk

bb.lk:                                            ; preds = %.thread1527
...
bb.lq:                                            ; preds = %RSTRING_PTR.exit1334, %.thread1527
  %.15901 = phi i64 [ %.14900, %RSTRING_PTR.exit1334 ], [ %.13899, %.thread1527 ] ; 2 uses
  %.9884 = phi i64 [ %i.aga, %RSTRING_PTR.exit1334 ], [ %.8883, %.thread1527 ] ; 4 uses
  br i1 %.not11411502, label %bb.ly, label %bb.lr

bb.lr:                                            ; preds = %bb.lq
  %i.agb = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.110281500) #22
...
bb.lx:                                            ; preds = %RSTRING_PTR.exit1337
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 %i.agr, ptr noundef nonnull readonly align 1 %.110281500, i64 noundef range(i64 1, 0) %i.age, i1 noundef false) #20
