...
RSTRING_PTR.exit1359:                             ; preds = %bb.oa, %bb.ob
  %i.amo = phi ptr [ %i.amn, %bb.ob ], [ %i.am, %bb.oa ] ; 10 uses
...
bb.oh:                                            ; preds = %bb.og, %bb.of
  %.16 = phi i64 [ %i.ana, %bb.og ], [ %.15, %bb.of ] ; 2 uses
...
RSTRING_PTR.exit1361:                             ; preds = %bb.oh, %bb.oi
  ...
  %3 = getelementptr i8, ptr %i.amo, i64 %.16     ; 2 uses
  br i1 %i.anl, label %bb.oj, label %bb.ol

bb.oj:                                            ; preds = %RSTRING_PTR.exit1361
  %i.anm = sub i64 %i.anf, %.pre-phi              ; 4 uses
...
ruby_nonempty_memcpy.exit1364:                    ; preds = %bb.ok, %bb.oj, %bb.ol
  %.pn = phi i64 [ 1, %bb.ol ], [ %i.anm, %bb.oj ], [ %i.anm, %bb.ok ]
...
; Function Attrs: nofree norecurse nounwind sspstrong memory(readwrite, inaccessiblemem: write, target_mem: none) uwtable
...
bb.f:                                             ; preds = %bb.e
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 %2, ptr noundef nonnull readonly align 1 %.133.lcssa, i64 noundef range(i64 1, 0) %spec.select, i1 noundef false) #21
...
attributes #13 = { nofree norecurse nounwind sspstrong memory(readwrite, inaccessiblemem: write, target_mem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
