begin_hunk_0_@fun_so_from_gb18030:bb.a
  ...
  %i.o = add nuw nsw i32 %i.c, %i.g
  %i.p = add nuw nsw i32 %i.o, %i.k
  %i.q = add nuw nsw i32 %i.p, %i.n
  %i.r = add nsw i32 %i.q, -1810682               ; 4 uses
  %i.s = lshr i32 %i.r, 18
  %i.t = lshr i32 %i.r, 12
  %i.u = lshr i32 %i.r, 6
end_hunk_0
begin_hunk_1_@fun_sio_from_gb18030:bb.a
  ...
  %i.t = add i32 %reass.sub, %i.p
  %i.u = add i32 %i.t, -1507328
  br label %bb.d
...
begin_hunk_2_@fun_so_to_gb18030:bb.a
  ...
  %5 = or disjoint i32 %i.d, %i.i
  %i.s = add nsw i32 %5, -65536
...
begin_hunk_4_@fun_sio_to_gb18030:bb.a
  ...
  %6 = add i32 %i.q, %i.b                         ; 2 uses
  br i1 %.not, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.s = add i32 %6, -181650                      ; 2 uses
  %i.t = urem i32 %i.s, 10
