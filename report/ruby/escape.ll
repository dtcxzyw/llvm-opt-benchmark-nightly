...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.de = call i32 %i.dd(i32 noundef range(i32 0, 1114111) %i.dc, ptr noundef nonnull %i.c, ptr noundef %i.l) #8
...
begin_hunk_1_@cgiesc_unescape_html:bb.a
  ...
  br i1 %i.dr, label %bb.f, label %.loopexit.i, !llvm.loop !23
...
begin_hunk_2_@optimized_escape_html:bb.a
  ...
  %i.y = load i8, ptr %i.x, align 8, !tbaa !25    ; 2 uses
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %i.ad, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !27
...
begin_hunk_4_@optimized_escape:bb.a
  ...
  br i1 %exitcond51.not, label %._crit_edge, label %.lr.ph.split.us, !llvm.loop !28
