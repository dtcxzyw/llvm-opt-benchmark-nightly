...
@.str.15 = private unnamed_addr constant [5 x i8] c"pos;\00", align 1
@.str.16 = private unnamed_addr constant [4 x i8] c"mp;\00", align 1
@.str.17 = private unnamed_addr constant [5 x i8] c"uot;\00", align 1
...
bb.a:
  ...
  %i.a = tail call i64 @rb_intern2(ptr noundef nonnull @.str, i64 noundef 16) #9
...
bb.a:
  ...
  %i.b = tail call i64 @rb_define_class(ptr noundef nonnull @.str.1, i64 noundef %i.a) #9 ; 2 uses
  store i64 %i.b, ptr @rb_cCGI, align 8, !tbaa !10
  %i.c = tail call i64 @rb_define_module_under(i64 noundef %i.b, ptr noundef nonnull @.str.2) #9
  store i64 %i.c, ptr @rb_mEscapeExt, align 8, !tbaa !10
  %i.d = load i64, ptr @rb_cCGI, align 8, !tbaa !10
  %i.e = tail call i64 @rb_define_module_under(i64 noundef %i.d, ptr noundef nonnull @.str.3) #9
  store i64 %i.e, ptr @rb_mEscape, align 8, !tbaa !10
  %i.f = load i64, ptr @rb_mEscapeExt, align 8, !tbaa !10
  tail call void @rb_define_method(i64 noundef %i.f, ptr noundef nonnull @.str.4, ptr noundef nonnull @cgiesc_escape_html, i32 noundef 1) #9
  %i.g = load i64, ptr @rb_mEscapeExt, align 8, !tbaa !10
  tail call void @rb_define_method(i64 noundef %i.g, ptr noundef nonnull @.str.5, ptr noundef nonnull @cgiesc_unescape_html, i32 noundef 1) #9
  %i.h = load i64, ptr @rb_mEscapeExt, align 8, !tbaa !10
  tail call void @rb_define_method(i64 noundef %i.h, ptr noundef nonnull @.str.6, ptr noundef nonnull @cgiesc_escape_uri_component, i32 noundef 1) #9
  %i.i = load i64, ptr @rb_mEscapeExt, align 8, !tbaa !10
  tail call void @rb_define_alias(i64 noundef %i.i, ptr noundef nonnull @.str.7, ptr noundef nonnull @.str.6) #9
  %i.j = load i64, ptr @rb_mEscapeExt, align 8, !tbaa !10
  tail call void @rb_define_method(i64 noundef %i.j, ptr noundef nonnull @.str.8, ptr noundef nonnull @cgiesc_unescape_uri_component, i32 noundef -1) #9
  %i.k = load i64, ptr @rb_mEscapeExt, align 8, !tbaa !10
  tail call void @rb_define_alias(i64 noundef %i.k, ptr noundef nonnull @.str.9, ptr noundef nonnull @.str.8) #9
  %i.l = load i64, ptr @rb_mEscapeExt, align 8, !tbaa !10
  tail call void @rb_define_method(i64 noundef %i.l, ptr noundef nonnull @.str.10, ptr noundef nonnull @cgiesc_escape, i32 noundef 1) #9
  %i.m = load i64, ptr @rb_mEscapeExt, align 8, !tbaa !10
  tail call void @rb_define_method(i64 noundef %i.m, ptr noundef nonnull @.str.11, ptr noundef nonnull @cgiesc_unescape, i32 noundef -1) #9
  %i.n = load i64, ptr @rb_mEscape, align 8, !tbaa !10
  %i.o = load i64, ptr @rb_mEscapeExt, align 8, !tbaa !10
  tail call void @rb_prepend_module(i64 noundef %i.n, i64 noundef %i.o) #9
  %i.p = load i64, ptr @rb_cCGI, align 8, !tbaa !10
  %i.q = load i64, ptr @rb_mEscapeExt, align 8, !tbaa !10
  tail call void @rb_extend_object(i64 noundef %i.p, i64 noundef %i.q) #9
  ret void
}
...
bb.a:
  ...
  %i.b = call i64 @rb_string_value(ptr noundef nonnull %i.a) #9 ; 0 uses
  %i.c = load i64, ptr %i.a, align 8, !tbaa !10
  %i.d = call ptr @rb_enc_get(i64 noundef %i.c) #9 ; 2 uses
...
rb_enc_str_asciicompat_p.exit:                    ; preds = %bb.a
  %i.f = call i32 @rb_enc_dummy_p(ptr noundef nonnull readonly %i.d) #10
...
rb_enc_str_asciicompat_p.exit.thread:             ; preds = %bb.a, %rb_enc_str_asciicompat_p.exit
  %i.i = call i64 @rb_call_super(i32 noundef 1, ptr noundef nonnull %i.a) #9
  br label %bb.c
...
begin_hunk_5
  ...
  %i.f = call i64 @rb_string_value(ptr noundef nonnull %i.e) #9 ; 0 uses
  %i.g = load i64, ptr %i.e, align 8, !tbaa !10
  %i.h = call ptr @rb_enc_get(i64 noundef %i.g) #9 ; 2 uses
...
rb_enc_str_asciicompat_p.exit:                    ; preds = %bb.a
  %i.j = call i32 @rb_enc_dummy_p(ptr noundef nonnull readonly %i.h) #10
  %.not3.i.i = icmp eq i32 %i.j, 0
  br i1 %.not3.i.i, label %bb.b, label %rb_enc_str_asciicompat_p.exit.thread

bb.b:                                             ; preds = %rb_enc_str_asciicompat_p.exit
  %i.k = load i64, ptr %i.e, align 8, !tbaa !10   ; 4 uses
  %i.l = call ptr @rb_enc_get(i64 noundef %i.k) #9 ; 3 uses
  %i.m = getelementptr i8, ptr %i.l, i64 8
  %.val140.i = load ptr, ptr %i.m, align 8, !tbaa !16 ; 2 uses
  %i.n = call i32 @strcasecmp(ptr noundef %.val140.i, ptr noundef nonnull @.str.13) #10
  %i.o = icmp eq i32 %i.n, 0
  br i1 %i.o, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.p = call i32 @strcasecmp(ptr noundef %.val140.i, ptr noundef nonnull @.str.14) #10
...
bb.j:                                             ; preds = %bb.i
  ...
  %bcmp136.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(4) %i.an, ptr noundef nonnull dereferenceable(4) @.str.15, i64 4)
  %i.ao = icmp eq i32 %bcmp136.i, 0
...
.thread.i:                                        ; preds = %bb.k, %bb.j
  %i.aq = getelementptr inbounds i8, ptr %i.aa, i64 %i.ak
  %bcmp137.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) %i.aq, ptr noundef nonnull dereferenceable(3) @.str.16, i64 3)
  %i.ar = icmp eq i32 %bcmp137.i, 0
...
bb.m:                                             ; preds = %bb.l
  ...
  %bcmp135.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(4) %i.av, ptr noundef nonnull dereferenceable(4) @.str.17, i64 4)
  %i.aw = icmp eq i32 %bcmp135.i, 0
...
bb.o:                                             ; preds = %bb.n
  ...
  %bcmp134.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(2) %i.ba, ptr noundef nonnull dereferenceable(2) @.str.18, i64 2)
  %i.bb = icmp eq i32 %bcmp134.i, 0
...
bb.q:                                             ; preds = %bb.p
  ...
  %bcmp.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(2) %i.bf, ptr noundef nonnull dereferenceable(2) @.str.18, i64 2)
...
bb.s:                                             ; preds = %bb.r
  %i.bp = call i64 @ruby_scan_digits(ptr noundef nonnull %i.bk, i64 noundef %i.bi, i32 noundef 10, ptr noundef nonnull %i.a, ptr noundef nonnull %i.b) #9
  br label %bb.w
...
bb.v:                                             ; preds = %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %bb.u
  %i.by = call i64 @ruby_scan_digits(ptr noundef nonnull %i.bt, i64 noundef %i.br, i32 noundef 16, ptr noundef nonnull %i.a, ptr noundef nonnull %i.b) #9
  br label %bb.w
...
bb.z:                                             ; preds = %bb.y
  %i.ce = call i64 @rb_str_buf_new(i64 noundef %i.v) #9
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %bb.y
  %.1.i = phi i64 [ %.0111158.i, %bb.y ], [ %i.ce, %bb.z ] ; 4 uses
  %i.cf = getelementptr inbounds i8, ptr %i.aa, i64 %.0117156.i
  %i.cg = call i64 @rb_str_cat(i64 noundef %.1.i, ptr noundef %i.cf, i64 noundef %i.ag) #9 ; 0 uses
  br i1 %i.ac, label %bb.ab, label %bb.ac

bb.ab:                                            ; preds = %bb.aa
  %i.ch = trunc nuw nsw i64 %.0110.i to i32
  %i.ci = load ptr, ptr %i.ad, align 8, !tbaa !22
  %i.cj = call i32 %i.ci(i32 noundef range(i32 0, 1114111) %i.ch, ptr noundef nonnull %i.c, ptr noundef %i.l) #9
  %i.ck = sext i32 %i.cj to i64
  %i.cl = call i64 @rb_str_cat(i64 noundef %.1.i, ptr noundef nonnull %i.c, i64 noundef %i.ck) #9 ; 0 uses
  br label %bb.ad

bb.ac:                                            ; preds = %bb.aa
  %i.cm = trunc i64 %.0110.i to i8
  store i8 %i.cm, ptr %i.d, align 1, !tbaa !21
  %i.cn = call i64 @rb_str_cat(i64 noundef %.1.i, ptr noundef nonnull %i.d, i64 noundef 1) #9 ; 0 uses
  br label %bb.ad
...
bb.af:                                            ; preds = %bb.ae
  %i.cq = call i64 @rb_str_buf_new(i64 noundef %i.v) #9
  br label %bb.ag

bb.ag:                                            ; preds = %bb.af, %bb.ae
  %.2.i = phi i64 [ %.0111158.i, %bb.ae ], [ %i.cq, %bb.af ] ; 3 uses
  %i.cr = getelementptr inbounds i8, ptr %i.aa, i64 %.0117156.i
  %i.cs = call i64 @rb_str_cat(i64 noundef %.2.i, ptr noundef %i.cr, i64 noundef %i.ag) #9 ; 0 uses
  %i.ct = call i64 @rb_str_cat(i64 noundef %.2.i, ptr noundef nonnull %i.d, i64 noundef 1) #9 ; 0 uses
...
bb.aj:                                            ; preds = %.loopexit.i
  ...
  %i.cz = call i64 @rb_str_cat(i64 noundef %.0111153.i, ptr noundef %i.cx, i64 noundef %i.cy) #9 ; 0 uses
  %i.da = call ptr @rb_enc_get(i64 noundef %i.k) #9
  %i.db = call i64 @rb_enc_associate(i64 noundef %.0111153.i, ptr noundef %i.da) #9 ; 0 uses
  br label %optimized_unescape_html.exit

.loopexit.thread.i:                               ; preds = %.loopexit.i, %RSTRING_PTR.exit.i
  %i.dc = call i64 @rb_str_dup(i64 noundef %i.k) #9
  br label %optimized_unescape_html.exit
...
rb_enc_str_asciicompat_p.exit.thread:             ; preds = %bb.a, %rb_enc_str_asciicompat_p.exit
  %i.dd = call i64 @rb_call_super(i32 noundef 1, ptr noundef nonnull %i.e) #9
  br label %bb.ak
...
rb_check_arity.exit:                              ; preds = %bb.a
  ...
  %i.d = call i64 @rb_string_value(ptr noundef nonnull %i.a) #9 ; 0 uses
  %i.e = load i64, ptr %i.a, align 8, !tbaa !10
  %i.f = call ptr @rb_enc_get(i64 noundef %i.e) #9 ; 2 uses
...
rb_enc_str_asciicompat_p.exit:                    ; preds = %rb_check_arity.exit
  %i.h = call i32 @rb_enc_dummy_p(ptr noundef nonnull readonly %i.f) #10
...
begin_hunk_20
  ...
  %i.u = call i64 @rb_cvar_get(i64 noundef %.0.i.i8, i64 noundef %i.t) #9
...
rb_enc_str_asciicompat_p.exit.thread:             ; preds = %rb_check_arity.exit, %rb_enc_str_asciicompat_p.exit
  %i.x = call i64 @rb_call_super(i32 noundef %0, ptr noundef nonnull %1) #9
  br label %bb.l
...
bb.b:                                             ; preds = %bb.a
  tail call void @ruby_malloc_size_overflow(i64 noundef %i.d, i64 noundef 6) #11
  unreachable
...
escaped_length.exit33:                            ; preds = %escaped_length.exit
  ...
  %i.j = lshr i64 %i.i, 3
  %i.k = call noalias nonnull ptr @rb_alloc_tmp_buffer_with_count(ptr noundef nonnull %i.a, i64 noundef range(i64 -9223372036854775808, 9223372036854775801) %i.f, i64 noundef %i.j) #12
  br label %bb.c
...
bb.h:                                             ; preds = %._crit_edge
  %i.aj = call i64 @rb_str_new(ptr noundef nonnull %i.l, i64 noundef %i.ah) #9 ; 2 uses
  %i.ak = call ptr @rb_enc_get(i64 noundef %0) #9
  %i.al = call i64 @rb_enc_associate(i64 noundef %i.aj, ptr noundef %i.ak) #9 ; 0 uses
  br label %bb.j

bb.i:                                             ; preds = %._crit_edge
  %i.am = call i64 @rb_str_dup(i64 noundef %0) #9
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h
  %.0 = phi i64 [ %i.aj, %bb.h ], [ %i.am, %bb.i ]
  call void @rb_free_tmp_buffer(ptr noundef nonnull %i.a) #9
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #9
  ret i64 %.0
}
...
bb.d:                                             ; preds = %bb.c
  %i.o = call i64 @rb_str_buf_new(i64 noundef %i.d) #9
  br label %bb.e
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.r = call i64 @rb_str_cat(i64 noundef %.1.us, ptr noundef %i.p, i64 noundef %i.q) #9 ; 0 uses
...
begin_hunk_33
  ...
  %i.ac = call i64 @rb_str_cat(i64 noundef %.1.us, ptr noundef nonnull %i.a, i64 noundef 3) #9 ; 0 uses
...
bb.g:                                             ; preds = %bb.f
  %i.ag = call i64 @rb_str_buf_new(i64 noundef %i.d) #9
  br label %bb.h
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %i.aj = call i64 @rb_str_cat(i64 noundef %.1, ptr noundef %i.ah, i64 noundef %i.ai) #9 ; 0 uses
  %i.ak = add nuw nsw i64 %.03446, 1              ; 2 uses
  %i.al = icmp eq i8 %i.af, 32
  br i1 %i.al, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  %i.am = call i64 @rb_str_cat(i64 noundef %.1, ptr noundef nonnull @.str.19, i64 noundef 1) #9 ; 0 uses
...
begin_hunk_35
  ...
  %i.aw = call i64 @rb_str_cat(i64 noundef %.1, ptr noundef nonnull %i.a, i64 noundef 3) #9 ; 0 uses
  br label %url_unreserved_char.exit
...
bb.k:                                             ; preds = %._crit_edge
  ...
  %i.ba = call i64 @rb_str_cat(i64 noundef %.035.lcssa, ptr noundef %i.ay, i64 noundef %i.az) #9 ; 0 uses
  %i.bb = call ptr @rb_enc_get(i64 noundef %0) #9
  %i.bc = call i64 @rb_enc_associate(i64 noundef %.035.lcssa, ptr noundef %i.bb) #9 ; 0 uses
  br label %bb.l

._crit_edge.thread:                               ; preds = %RSTRING_PTR.exit, %._crit_edge
  %i.bd = call i64 @rb_str_dup(i64 noundef %0) #9
  br label %bb.l
...
bb.a:
  ...
  %i.b = tail call ptr @rb_to_encoding(i64 noundef %1) #9
  %i.c = tail call i32 @rb_enc_to_index(ptr noundef %i.b) #10 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  %i.aj = call i64 @rb_str_buf_new(i64 noundef %i.f) #9
  br label %bb.h
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %i.am = call i64 @rb_str_cat(i64 noundef %.162.us, ptr noundef %i.ak, i64 noundef %i.al) #9 ; 0 uses
  %i.an = add nsw i64 %.05897.us, 2
  %i.ao = call i64 @rb_str_cat(i64 noundef %.162.us, ptr noundef nonnull %i.a, i64 noundef 1) #9 ; 0 uses
  br label %bb.i
...
bb.o:                                             ; preds = %bb.n
  %i.bn = call i64 @rb_str_buf_new(i64 noundef %i.f) #9
  br label %bb.p
...
bb.p:                                             ; preds = %bb.o, %bb.n
  ...
  %i.bq = call i64 @rb_str_cat(i64 noundef %.162, ptr noundef %i.bo, i64 noundef %i.bp) #9 ; 0 uses
  %i.br = add nsw i64 %.057, %.05897              ; 2 uses
  %i.bs = add nsw i64 %i.br, 1
  %i.bt = call i64 @rb_str_cat(i64 noundef %.162, ptr noundef nonnull %i.a, i64 noundef 1) #9 ; 0 uses
  br label %bb.q
...
bb.r:                                             ; preds = %.loopexit
  ...
  %i.by = call i64 @rb_str_cat(i64 noundef %.06192, ptr noundef %i.bw, i64 noundef %i.bx) #9 ; 0 uses
  %i.bz = call ptr @rb_enc_get(i64 noundef %0) #9
  %i.ca = call i64 @rb_enc_associate(i64 noundef %.06192, ptr noundef %i.bz) #9 ; 0 uses
  br label %bb.s

.loopexit.thread:                                 ; preds = %RSTRING_PTR.exit, %.loopexit
  %i.cb = call i64 @rb_str_dup(i64 noundef %0) #9
...
bb.s:                                             ; preds = %.loopexit.thread, %bb.r
  ...
  %i.cf = call i32 @rb_enc_get_index(i64 noundef %0) #9 ; 2 uses
  %.not72 = icmp eq i32 %i.cf, %i.c
  br i1 %.not72, label %bb.w, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.cg = call i64 @rb_enc_associate_index(i64 noundef %.4, i32 noundef %i.c) #9 ; 0 uses
  %i.ch = call i32 @rb_enc_str_coderange(i64 noundef %.4) #9 ; 2 uses
...
bb.u:                                             ; preds = %bb.t
  %i.cl = call i64 @rb_enc_associate_index(i64 noundef %.4, i32 noundef %i.cf) #9 ; 0 uses
