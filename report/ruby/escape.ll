...
._crit_edge:                                      ; preds = %url_unreserved_char.exit.us, %url_unreserved_char.exit
  %.036.lcssa = phi i64 [ %.137, %url_unreserved_char.exit ], [ %.137.us, %url_unreserved_char.exit.us ] ; 2 uses
  %.035.lcssa = phi i64 [ %.2, %url_unreserved_char.exit ], [ %.2.us, %url_unreserved_char.exit.us ] ; 4 uses
...
.split.us:                                        ; preds = %bb.c, %bb.j
  %.us-phi = phi i64 [ %.06193, %bb.j ], [ %.06193.us, %bb.c ]
  %.us-phi100 = phi i64 [ %.05995, %bb.j ], [ %.05995.us, %bb.c ]
...
.loopexit:                                        ; preds = %bb.i, %bb.q, %.split.us
  %.06192 = phi i64 [ %.us-phi, %.split.us ], [ %.263.ph, %bb.q ], [ %.263.ph.us, %bb.i ] ; 4 uses
  %.05990 = phi i64 [ %.us-phi100, %.split.us ], [ %.160.ph, %bb.q ], [ %.160.ph.us, %bb.i ] ; 2 uses
