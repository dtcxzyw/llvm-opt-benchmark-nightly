...
begin_hunk_0_@heredoc_identifier:bb.a
  ...
  %.076.neg = phi i64 [ 0, %.critedge.i125 ], [ 0, %bb.bd ], [ 0, %.split ], [ 0, %bb.bb ], [ 0, %bb.bc ], [ -1, %nextc0.exit120 ]
  %3 = phi i8 [ 0, %.critedge.i125 ], [ 0, %bb.bd ], [ 0, %.split ], [ 0, %bb.bb ], [ 0, %bb.bc ], [ 1, %nextc0.exit120 ]
  ...
  %4 = sub i64 %i.gw, %i.gx
  %i.gy = add i64 %4, %.076.neg                   ; 2 uses
  %i.gz = icmp ugt i64 %i.gy, 4294967294
...
begin_hunk_1_@heredoc_identifier:bb.a
  ...
  store i8 %3, ptr %i.ic, align 8, !tbaa !489
