...
magic_comment_marker.exit.i:                      ; preds = %bb.ip, %bb.im
  %.sink2961 = phi i64 [ 1, %bb.im ], [ 2, %bb.ip ]
  %i.ana = getelementptr i8, ptr %i.aml, i64 %.sink2961 ; 5 uses
...
bb.ir:                                            ; preds = %magic_comment_marker.exit.i
  %3 = ptrtoint ptr %i.ana to i64
  %i.anb = sub i64 %i.amh, %3                     ; 3 uses
...
bb.iy:                                            ; preds = %magic_comment_marker.exit214.i
  %reass.sub = add i64 %.028.i209.i, %.sink2962
  %i.ant = add i64 %reass.sub, -3
