...
bb.x:                                             ; preds = %bb.v, %.preheader, %bb.w
  ...
  br label %.preheader, !llvm.loop !475
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.dj, label %middle.block, label %vector.body, !llvm.loop !478
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.do, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !480
...
.lr.ph188:                                        ; preds = %.lr.ph188.preheader, %.lr.ph188
  ...
  br i1 %i.du, label %.lr.ph188, label %._crit_edge, !llvm.loop !481
...
bb.b:                                             ; preds = %bb.a
  %.val = load i8, ptr %i.h, align 8, !tbaa !561, !range !563, !noundef !462
...
bb.x:                                             ; preds = %bb.co, %bb.w
  ...
  %i.do = phi i32 [ %i.mu, %bb.co ], [ %.pre.i, %bb.w ]
  ...
  %i.ep = load i32, ptr %i.eo, align 8, !tbaa !486
...
.backedge.i:                                      ; preds = %.backedge.i.backedge, %.preheader303.i
  ...
  %3 = ptrtoint ptr %i.fg to i64                  ; 3 uses
  %i.fh = icmp ugt ptr %i.fd, %i.fg
  br i1 %i.fh, label %bb.aa, label %bb.ae

bb.aa:                                            ; preds = %.backedge.i
  %i.fi = getelementptr i8, ptr %i.fd, i64 -1     ; 3 uses
...
bb.ab:                                            ; preds = %bb.aa
  %i.fk = icmp eq ptr %i.fi, %i.fg
  br i1 %i.fk, label %bb.ae, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %i.fl = getelementptr i8, ptr %i.fd, i64 -2
  %i.fm = load i8, ptr %i.fl, align 1, !tbaa !15
  %.not156.i = icmp eq i8 %i.fm, 13
  br i1 %.not156.i, label %bb.ad, label %bb.ae

bb.ad:                                            ; preds = %bb.ac, %bb.aa
  %.0145.i = phi ptr [ %i.fi, %bb.ac ], [ %i.fd, %bb.aa ]
  %i.fn = getelementptr i8, ptr %.0145.i, i64 -1
  br label %bb.ae

bb.ae:                                            ; preds = %bb.ad, %bb.ac, %bb.ab, %bb.aa, %.backedge.i
  %.1146.i = phi ptr [ %i.fd, %bb.aa ], [ %i.fd, %.backedge.i ], [ %i.fn, %bb.ad ], [ %i.fd, %bb.ac ], [ %i.fd, %bb.ab ] ; 5 uses
  %.1146330.i = ptrtoint ptr %.1146.i to i64      ; 2 uses
  %i.fo = load i32, ptr %i.fb, align 4, !tbaa !177 ; 2 uses
  %i.fp = icmp sgt i32 %i.fo, 0
  br i1 %i.fp, label %.preheader.i, label %bb.am

.preheader.i:                                     ; preds = %bb.ae
  %i.fq = icmp ult ptr %i.fg, %.1146.i
  br i1 %i.fq, label %.lr.ph.i, label %.critedge.i

.lr.ph.i:                                         ; preds = %.preheader.i
  %.promoted.i = load i32, ptr %i.fc, align 8, !tbaa !180
  %i.fr = sub i64 %.1146330.i, %3
  br label %bb.af

bb.af:                                            ; preds = %bb.al, %.lr.ph.i
  %.sink.i318.i = phi i32 [ %.promoted.i, %.lr.ph.i ], [ %.sink.i.i, %bb.al ] ; 5 uses
  %.0138317.i = phi i64 [ 0, %.lr.ph.i ], [ %i.ga, %bb.al ] ; 2 uses
  %i.fs = icmp eq i32 %.sink.i318.i, -1
  br i1 %i.fs, label %.critedge.i, label %bb.ag

bb.ag:                                            ; preds = %bb.af
  %i.ft = getelementptr i8, ptr %i.fg, i64 %.0138317.i
  %i.fu = load i8, ptr %i.ft, align 1, !tbaa !15
  switch i8 %i.fu, label %bb.aj [
    i8 32, label %bb.ah
    i8 9, label %bb.ai
...
bb.ah:                                            ; preds = %bb.ag
  %i.fv = add nuw i32 %.sink.i318.i, 1
  br label %bb.al

bb.ai:                                            ; preds = %bb.ag
  %i.fw = sdiv i32 %.sink.i318.i, 8
  %i.fx = shl nsw i32 %i.fw, 3
  %i.fy = add i32 %i.fx, 8
  br label %bb.al

bb.aj:                                            ; preds = %bb.ag
  %i.fz = icmp sgt i32 %i.fo, %.sink.i318.i
  br i1 %i.fz, label %bb.ak, label %.critedge.i
...
bb.al:                                            ; preds = %bb.ai, %bb.ah
  %.sink.i.i = phi i32 [ %i.fv, %bb.ah ], [ %i.fy, %bb.ai ] ; 2 uses
  store i32 %.sink.i.i, ptr %i.fc, align 8, !tbaa !180
  %i.ga = add i64 %.0138317.i, 1                  ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.ga, %i.fr
...
bb.am:                                            ; preds = %.critedge.i, %bb.ae
  ...
  %i.gb = sub i64 %.1146330.i, %3                 ; 9 uses
  br i1 %.not158.i, label %bb.aq, label %bb.an

bb.an:                                            ; preds = %bb.am
  store i32 0, ptr %.0142.i, align 8, !tbaa !24
  %i.gc = icmp eq ptr %.1146.i, %i.fg
  br i1 %i.gc, label %rb_parser_str_buf_cat.exit.i, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  %i.gd = getelementptr i8, ptr %.0142.i, i64 16  ; 3 uses
  %i.ge = load i64, ptr %i.gd, align 8, !tbaa !23 ; 4 uses
  %i.gf = sub i64 9223372036854775807, %i.gb
  %i.gg = icmp sgt i64 %i.ge, %i.gf
  br i1 %i.gg, label %bb.ap, label %ruby_nonempty_memcpy.exit.i.i
...
ruby_nonempty_memcpy.exit.i.i:                    ; preds = %bb.ao
  %i.gh = getelementptr i8, ptr %.0142.i, i64 24  ; 3 uses
  %i.gi = load ptr, ptr %i.gh, align 8, !tbaa !18 ; 4 uses
  %.not.i182.i = icmp ult ptr %i.fg, %i.gi
  %i.gj = getelementptr i8, ptr %i.gi, i64 %i.ge
  %.not40.i.i = icmp ugt ptr %i.fg, %i.gj
  %or.cond.i183.i = or i1 %.not.i182.i, %.not40.i.i
  %i.gk = ptrtoint ptr %i.gi to i64
  %i.gl = sub i64 %3, %i.gk
  %.034.i.i = select i1 %or.cond.i183.i, i64 -1, i64 %i.gl ; 2 uses
  %i.gm = add i64 %i.ge, %i.gb                    ; 4 uses
  %i.gn = add i64 %i.gm, 1
  %i.go = tail call nonnull ptr @ruby_xrealloc2(ptr noundef %i.gi, i64 noundef %i.gn, i64 noundef 1) #38 ; 3 uses
  store ptr %i.go, ptr %i.gh, align 8, !tbaa !18
  store i64 %i.gm, ptr %i.gd, align 8, !tbaa !23
  %.not41.i.i = icmp eq i64 %.034.i.i, -1
  %i.gp = getelementptr i8, ptr %i.go, i64 %.034.i.i
  %spec.select.i184.i = select i1 %.not41.i.i, ptr %i.fg, ptr %i.gp
  %i.gq = getelementptr i8, ptr %i.go, i64 %i.ge
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 %i.gq, ptr noundef nonnull readonly align 1 %spec.select.i184.i, i64 noundef range(i64 1, 0) %i.gb, i1 noundef false) #31
  store i64 %i.gm, ptr %i.gd, align 8, !tbaa !23
  %i.gr = load ptr, ptr %i.gh, align 8, !tbaa !18
  %i.gs = getelementptr i8, ptr %i.gr, i64 %i.gm
  store i8 0, ptr %i.gs, align 1, !tbaa !15
  br label %rb_parser_str_buf_cat.exit.i

bb.aq:                                            ; preds = %bb.am
  %i.gt = icmp slt i64 %i.gb, 0
  br i1 %i.gt, label %bb.ar, label %bb.as

bb.ar:                                            ; preds = %bb.aq
  tail call void (ptr, ...) @rb_bug(ptr noundef nonnull @.str.81, i64 noundef %i.gb) #32
  unreachable

bb.as:                                            ; preds = %bb.aq
  %i.gu = tail call noalias nonnull dereferenceable(32) ptr @ruby_xcalloc(i64 noundef 1, i64 noundef 32) #33 ; 5 uses
  %i.gv = add nuw i64 %i.gb, 1
  %i.gw = tail call noalias nonnull ptr @ruby_xcalloc(i64 noundef %i.gv, i64 noundef 1) #33 ; 3 uses
  %i.gx = getelementptr inbounds nuw i8, ptr %i.gu, i64 24
  store ptr %i.gw, ptr %i.gx, align 8, !tbaa !18
...
bb.at:                                            ; preds = %bb.as
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 %i.gw, ptr noundef nonnull readonly align 1 %i.fg, i64 noundef range(i64 1, 0) %i.gb, i1 noundef false) #31
...
rb_parser_encoding_string_new.exit.i:             ; preds = %bb.at, %bb.as
  ...
  store i64 %i.gb, ptr %i.gy, align 8, !tbaa !23
  %i.gz = getelementptr i8, ptr %i.gw, i64 %i.gb
  store i8 0, ptr %i.gz, align 1, !tbaa !15
  store i32 0, ptr %i.gu, align 8, !tbaa !24
  %i.ha = getelementptr inbounds nuw i8, ptr %i.gu, i64 8
  store ptr %i.n, ptr %i.ha, align 8, !tbaa !25
  br label %rb_parser_str_buf_cat.exit.i

rb_parser_str_buf_cat.exit.i:                     ; preds = %rb_parser_encoding_string_new.exit.i, %ruby_nonempty_memcpy.exit.i.i, %bb.ap, %bb.an
  %.1143.i = phi ptr [ %i.gu, %rb_parser_encoding_string_new.exit.i ], [ %.0142.i, %bb.an ], [ %.0142.i, %bb.ap ], [ %.0142.i, %ruby_nonempty_memcpy.exit.i.i ] ; 8 uses
  %i.hb = load ptr, ptr %i.ac, align 8, !tbaa !426
  %.not159.i = icmp ult ptr %.1146.i, %i.hb
...
bb.au:                                            ; preds = %rb_parser_str_buf_cat.exit.i
  ...
  %i.hc = getelementptr i8, ptr %.1143.i, i64 16  ; 3 uses
  %i.hd = load i64, ptr %i.hc, align 8, !tbaa !23 ; 5 uses
  %i.he = icmp eq i64 %i.hd, 9223372036854775807
  br i1 %i.he, label %bb.av, label %ruby_nonempty_memcpy.exit.i187.i
...
ruby_nonempty_memcpy.exit.i187.i:                 ; preds = %bb.au
  %i.hf = getelementptr i8, ptr %.1143.i, i64 24  ; 3 uses
  %i.hg = load ptr, ptr %i.hf, align 8, !tbaa !18 ; 4 uses
  %.not.i188.i = icmp ugt ptr %i.hg, @.str.7
  %i.hh = getelementptr i8, ptr %i.hg, i64 %i.hd
  %.not40.i189.i = icmp ult ptr %i.hh, @.str.7
  %or.cond.i190.i = or i1 %.not.i188.i, %.not40.i189.i
  %i.hi = ptrtoint ptr %i.hg to i64
  %i.hj = sub i64 ptrtoint (ptr @.str.7 to i64), %i.hi
  %.034.i191.i = select i1 %or.cond.i190.i, i64 -1, i64 %i.hj ; 2 uses
  %i.hk = add nsw i64 %i.hd, 1                    ; 3 uses
  %i.hl = add i64 %i.hd, 2
  %i.hm = tail call nonnull ptr @ruby_xrealloc2(ptr noundef %i.hg, i64 noundef %i.hl, i64 noundef 1) #38 ; 3 uses
  store ptr %i.hm, ptr %i.hf, align 8, !tbaa !18
  store i64 %i.hk, ptr %i.hc, align 8, !tbaa !23
  %.not41.i192.i = icmp eq i64 %.034.i191.i, -1
  %i.hn = getelementptr i8, ptr %i.hm, i64 %.034.i191.i
  %spec.select.i193.i = select i1 %.not41.i192.i, ptr @.str.7, ptr %i.hn
  %i.ho = getelementptr i8, ptr %i.hm, i64 %i.hd
  %i.hp = load i8, ptr %spec.select.i193.i, align 1
  store i8 %i.hp, ptr %i.ho, align 1
  store i64 %i.hk, ptr %i.hc, align 8, !tbaa !23
  %i.hq = load ptr, ptr %i.hf, align 8, !tbaa !18
  %i.hr = getelementptr i8, ptr %i.hq, i64 %i.hk
  store i8 0, ptr %i.hr, align 1, !tbaa !15
  br label %rb_parser_str_buf_cat.exit195.i

rb_parser_str_buf_cat.exit195.i:                  ; preds = %ruby_nonempty_memcpy.exit.i187.i, %bb.av, %rb_parser_str_buf_cat.exit.i
  %i.hs = load ptr, ptr %i.ac, align 8, !tbaa !426 ; 2 uses
  store ptr %i.hs, ptr %i.i, align 8, !tbaa !188
  %i.ht = load i32, ptr %i.fb, align 4, !tbaa !177
  %i.hu = icmp sgt i32 %i.ht, 0
  br i1 %i.hu, label %.loopexit.i, label %.critedge.i197.i

.critedge.i197.i:                                 ; preds = %rb_parser_str_buf_cat.exit195.i
  %i.hv = tail call fastcc i32 @nextline(ptr noundef nonnull %0, i32 noundef 1)
  %.not14.i198.i = icmp eq i32 %i.hv, 0
...
bb.aw:                                            ; preds = %.critedge.i197.i
  ...
  %i.hw = getelementptr i8, ptr %.pre.i201.i, i64 1 ; 3 uses
  store ptr %i.hw, ptr %i.i, align 8, !tbaa !188
  %i.hx = load i8, ptr %.pre.i201.i, align 1, !tbaa !15
  %i.hy = icmp eq i8 %i.hx, 13
  %.val170.pre.i = load ptr, ptr %i.ac, align 8, !tbaa !426 ; 8 uses
  br i1 %i.hy, label %bb.ax, label %bb.ba, !prof !205

bb.ax:                                            ; preds = %bb.aw
  %.not.i.i202.i = icmp ult ptr %i.hw, %.val170.pre.i
  br i1 %.not.i.i202.i, label %bb.ay, label %bb.ba

bb.ay:                                            ; preds = %bb.ax
  %i.hz = load i8, ptr %i.hw, align 1, !tbaa !15
  %i.ia = icmp eq i8 %i.hz, 10
  br i1 %i.ia, label %bb.az, label %bb.ba

bb.az:                                            ; preds = %bb.ay
  %i.ib = getelementptr i8, ptr %.pre.i201.i, i64 2
  store ptr %i.ib, ptr %i.i, align 8, !tbaa !188
  br label %bb.ba

rb_parser_string_free.exit.i:                     ; preds = %.critedge.i197.i
  %i.ic = getelementptr i8, ptr %.1143.i, i64 24
  %i.id = load ptr, ptr %i.ic, align 8, !tbaa !18
  tail call void @ruby_xfree(ptr noundef %i.id) #31
...
bb.ba:                                            ; preds = %bb.az, %bb.ay, %bb.ax, %bb.aw
  ...
  %i.ie = ptrtoint ptr %.val170.pre.i to i64      ; 3 uses
  %i.if = ptrtoint ptr %.val169.i to i64          ; 3 uses
  %i.ig = sub i64 %i.ie, %i.if
  %i.ih = icmp slt i64 %i.ig, %i.w
  br i1 %i.ih, label %.backedge.i.backedge, label %bb.bb

bb.bb:                                            ; preds = %bb.ba
  %i.ii = icmp ugt ptr %.val170.pre.i, %.val169.i
  br i1 %i.ii, label %bb.bc, label %bb.bg

bb.bc:                                            ; preds = %bb.bb
  %i.ij = getelementptr i8, ptr %.val170.pre.i, i64 -1 ; 4 uses
  %i.ik = load i8, ptr %i.ij, align 1, !tbaa !15
  %i.il = icmp eq i8 %i.ik, 10
  br i1 %i.il, label %bb.bd, label %bb.bg

bb.bd:                                            ; preds = %bb.bc
  %i.im = icmp ugt ptr %i.ij, %.val169.i
  br i1 %i.im, label %bb.be, label %bb.bf

bb.be:                                            ; preds = %bb.bd
  %i.in = getelementptr i8, ptr %.val170.pre.i, i64 -2 ; 2 uses
  %i.io = load i8, ptr %i.in, align 1, !tbaa !15
  %i.ip = icmp eq i8 %i.io, 13
  %spec.select.i221.i = select i1 %i.ip, ptr %i.in, ptr %i.ij
  br label %bb.bf

bb.bf:                                            ; preds = %bb.be, %bb.bd
  %.0.i220.i = phi ptr [ %i.ij, %bb.bd ], [ %spec.select.i221.i, %bb.be ] ; 2 uses
  %i.iq = ptrtoint ptr %.0.i220.i to i64          ; 2 uses
  %i.ir = sub i64 %i.iq, %i.if
  %i.is = icmp slt i64 %i.ir, %i.w
  br i1 %i.is, label %.backedge.i.backedge, label %bb.bg

bb.bg:                                            ; preds = %bb.bf, %bb.bc, %bb.bb
  %.16.pre-phi.i206.i = phi i64 [ %i.iq, %bb.bf ], [ %i.ie, %bb.bc ], [ %i.ie, %bb.bb ]
  %.1.i207.i = phi ptr [ %.0.i220.i, %bb.bf ], [ %.val170.pre.i, %bb.bc ], [ %.val170.pre.i, %bb.bb ]
  %i.it = getelementptr i8, ptr %.1.i207.i, i64 %i.x ; 3 uses
  %i.iu = tail call i32 @strncmp(ptr noundef readonly %i.t, ptr noundef %i.it, i64 noundef range(i64 0, 4294967296) %i.w) #35
  %.not.i208.i = icmp eq i32 %i.iu, 0
  br i1 %.not.i208.i, label %bb.bh, label %.backedge.i.backedge

bb.bh:                                            ; preds = %bb.bg
  %i.iv = icmp ult ptr %.val169.i, %i.it
  %or.cond.i211.i = and i1 %.not35.i210.i, %i.iv
  br i1 %or.cond.i211.i, label %.lr.ph.preheader.i214.i, label %.critedge.i212.i

.lr.ph.preheader.i214.i:                          ; preds = %bb.bh
  %i.iw = add i64 %i.if, %i.w
  %i.ix = sub i64 %.16.pre-phi.i206.i, %i.iw
  %scevgep.i215.i = getelementptr i8, ptr %.val169.i, i64 %i.ix ; 2 uses
  br label %.lr.ph.i216.i

.lr.ph.i216.i:                                    ; preds = %bb.bi, %.lr.ph.preheader.i214.i
  %.0263.i217.i = phi ptr [ %i.jd, %bb.bi ], [ %.val169.i, %.lr.ph.preheader.i214.i ] ; 3 uses
  %i.iy = load i8, ptr %.0263.i217.i, align 1, !tbaa !15 ; 2 uses
  %i.iz = sext i8 %i.iy to i32
  %i.ja = icmp ne i8 %i.iy, 32
  %i.jb = add nsw i32 %i.iz, -14
  %i.jc = icmp ult i32 %i.jb, -5
  %narrow.i.not.i218.i = select i1 %i.ja, i1 %i.jc, i1 false
  br i1 %narrow.i.not.i218.i, label %.critedge.i212.i, label %bb.bi

bb.bi:                                            ; preds = %.lr.ph.i216.i
  %i.jd = getelementptr i8, ptr %.0263.i217.i, i64 1 ; 2 uses
  %exitcond.not.i219.i = icmp eq ptr %i.jd, %scevgep.i215.i
...
.critedge.i212.i:                                 ; preds = %bb.bi, %.lr.ph.i216.i, %bb.bh
  ...
  %.not320.i = icmp eq ptr %.127.i213.i, %i.it
...
bb.bj:                                            ; preds = %whole_match_p.exit.thread.i
  %i.je = getelementptr i8, ptr %0, i64 136       ; 9 uses
  store i32 0, ptr %i.je, align 8, !tbaa !570
  %i.jf = getelementptr i8, ptr %0, i64 160       ; 11 uses
  %i.jg = load ptr, ptr %i.jf, align 8, !tbaa !500 ; 2 uses
  %.not.i223.i = icmp eq ptr %i.jg, null
  br i1 %.not.i223.i, label %bb.bk, label %bb.bl

bb.bk:                                            ; preds = %bb.bj
  %i.jh = getelementptr i8, ptr %0, i64 140
  store i32 60, ptr %i.jh, align 4, !tbaa !509
  %i.ji = tail call noalias nonnull dereferenceable(60) ptr @ruby_xmalloc2(i64 noundef 60, i64 noundef 1) #33 ; 2 uses
  store ptr %i.ji, ptr %i.jf, align 8, !tbaa !500
  br label %bb.bl

bb.bl:                                            ; preds = %bb.bk, %bb.bj
  %i.jj = phi ptr [ %i.ji, %bb.bk ], [ %i.jg, %bb.bj ]
  %i.jk = getelementptr i8, ptr %0, i64 140       ; 6 uses
  %i.jl = load i32, ptr %i.jk, align 4, !tbaa !509
  %i.jm = icmp sgt i32 %i.jl, 4096
  br i1 %i.jm, label %bb.bm, label %newtok.exit.i

bb.bm:                                            ; preds = %bb.bl
  store i32 60, ptr %i.jk, align 4, !tbaa !509
  %i.jn = tail call nonnull dereferenceable(60) ptr @ruby_xrealloc2(ptr noundef nonnull %i.jj, i64 noundef 60, i64 noundef 1) #38
  store ptr %i.jn, ptr %i.jf, align 8, !tbaa !500
  br label %newtok.exit.i

newtok.exit.i:                                    ; preds = %bb.bm, %bb.bl
  %i.jo = icmp eq i32 %.011.i.ph.i, 35
  br i1 %i.jo, label %bb.bn, label %nextc0.exit238.i

bb.bn:                                            ; preds = %newtok.exit.i
  %i.jp = load ptr, ptr %i.i, align 8, !tbaa !188 ; 4 uses
  %i.jq = getelementptr i8, ptr %i.jp, i64 1      ; 4 uses
  %i.jr = load ptr, ptr %i.ac, align 8, !tbaa !426 ; 3 uses
  %.not.i224.i = icmp ult ptr %i.jq, %i.jr
  br i1 %.not.i224.i, label %bb.bo, label %parser_peek_variable_name.exit.i

bb.bo:                                            ; preds = %bb.bn
  %i.js = load i8, ptr %i.jp, align 1, !tbaa !15
  switch i8 %i.js, label %parser_peek_variable_name.exit.i [
    i8 36, label %bb.bp
    i8 64, label %bb.bt
    i8 123, label %bb.bw
  ]
...
bb.bp:                                            ; preds = %bb.bo
  %i.jt = load i8, ptr %i.jq, align 1, !tbaa !15  ; 2 uses
  %i.ju = sext i8 %i.jt to i32                    ; 7 uses
  %i.jv = icmp eq i8 %i.jt, 45
  br i1 %i.jv, label %bb.bq, label %bb.bs

bb.bq:                                            ; preds = %bb.bp
  %i.jw = getelementptr i8, ptr %i.jp, i64 2      ; 2 uses
  %.not34.i.i = icmp ult ptr %i.jw, %i.jr
  br i1 %.not34.i.i, label %bb.br, label %parser_peek_variable_name.exit.i

bb.br:                                            ; preds = %bb.bq
  %i.jx = load i8, ptr %i.jw, align 1, !tbaa !15
  %i.jy = sext i8 %i.jx to i32
  br label %bb.bx

bb.bs:                                            ; preds = %bb.bp
  %i.jz = add nsw i32 %i.ju, -127
  %or.cond.i.i228.i = icmp ult i32 %i.jz, -94
...
is_global_name_punct.exit.i.i:                    ; preds = %bb.bs
  %i.ka = add nsw i32 %i.ju, -32
  %i.kb = lshr i32 %i.ka, 5
  %i.kc = zext nneg i32 %i.kb to i64
  %i.kd = getelementptr [4 x i8], ptr @ruby_global_name_punct_bits, i64 %i.kc
  %i.ke = load i32, ptr %i.kd, align 4, !tbaa !7
  %i.kf = and i32 %i.ju, 31
  %i.kg = shl nuw i32 1, %i.kf
  %i.kh = and i32 %i.ke, %i.kg
  %.not32.i.i = icmp eq i32 %i.kh, 0
  %i.ki = add nsw i32 %i.ju, -58
  %i.kj = icmp ult i32 %i.ki, -10
  %or.cond39.i.i = select i1 %.not32.i.i, i1 %i.kj, i1 false
  br i1 %or.cond39.i.i, label %bb.bx, label %parser_peek_variable_name.exit.i

is_global_name_punct.exit.thread.i.i:             ; preds = %bb.bs
  %.old.i.i = add nsw i32 %i.ju, -58
  %.old38.i.i = icmp ult i32 %.old.i.i, -10
  br i1 %.old38.i.i, label %bb.bx, label %parser_peek_variable_name.exit.i

bb.bt:                                            ; preds = %bb.bo
  %i.kk = load i8, ptr %i.jq, align 1, !tbaa !15  ; 2 uses
  %i.kl = sext i8 %i.kk to i32
  %i.km = icmp eq i8 %i.kk, 64
  br i1 %i.km, label %bb.bu, label %bb.bx

bb.bu:                                            ; preds = %bb.bt
  %i.kn = getelementptr i8, ptr %i.jp, i64 2      ; 2 uses
  %.not31.i.i = icmp ult ptr %i.kn, %i.jr
...
bb.bw:                                            ; preds = %bb.bo
  store ptr %i.jq, ptr %i.i, align 8, !tbaa !188
  %i.kq = load i32, ptr %i.e, align 8
  %i.kr = or i32 %i.kq, 4
  store i32 %i.kr, ptr %i.e, align 8
  %i.ks = getelementptr i8, ptr %0, i64 104
  %i.kt = load i32, ptr %i.ks, align 8, !tbaa !67
  %i.ku = load ptr, ptr %0, align 8, !tbaa !62
  store i32 %i.kt, ptr %i.ku, align 8, !tbaa !15
...
bb.bx:                                            ; preds = %bb.bv, %bb.bt, %is_global_name_punct.exit.thread.i.i, %is_global_name_punct.exit.i.i, %bb.br
  %.0.i225.i = phi i32 [ %i.jy, %bb.br ], [ %i.ju, %is_global_name_punct.exit.thread.i.i ], [ %i.kp, %bb.bv ], [ %i.kl, %bb.bt ], [ %i.ju, %is_global_name_punct.exit.i.i ] ; 3 uses
  %i.kv = icmp ugt i32 %.0.i225.i, 127
  %i.kw = icmp eq i32 %.0.i225.i, 95
  %or.cond.i226.i = or i1 %i.kv, %i.kw
  br i1 %or.cond.i226.i, label %parser_peek_variable_name.exit.i, label %bb.by

bb.by:                                            ; preds = %bb.bx
  %i.kx = and i32 %.0.i225.i, 95
  %i.ky = add nsw i32 %i.kx, -91
  %narrow.i.i.i = icmp ult i32 %i.ky, -26
...
parser_peek_variable_name.exit.i:                 ; preds = %bb.by, %bb.bx, %bb.bw, %bb.bu, %is_global_name_punct.exit.thread.i.i, %is_global_name_punct.exit.i.i, %bb.bq, %bb.bo, %bb.bn
  ...
  %i.kz = getelementptr i8, ptr %0, i64 152       ; 2 uses
  %i.la = load i32, ptr %i.kz, align 8, !tbaa !180 ; 3 uses
  %.not161.i = icmp eq i32 %i.la, -1
  br i1 %.not161.i, label %bb.cc, label %bb.bz

bb.bz:                                            ; preds = %parser_peek_variable_name.exit.i
  %i.lb = getelementptr i8, ptr %0, i64 148       ; 2 uses
  %i.lc = load i32, ptr %i.lb, align 4, !tbaa !177
  %i.ld = icmp sgt i32 %i.lc, %i.la
  br i1 %i.ld, label %bb.ca, label %bb.cb

bb.ca:                                            ; preds = %bb.bz
  store i32 %i.la, ptr %i.lb, align 4, !tbaa !177
  br label %bb.cb

bb.cb:                                            ; preds = %bb.ca, %bb.bz
  store i32 -1, ptr %i.kz, align 8, !tbaa !180
  br label %bb.cc
...
bb.cd:                                            ; preds = %bb.cc
  %i.le = load ptr, ptr %i.jf, align 8, !tbaa !500
  %i.lf = load i32, ptr %i.je, align 8, !tbaa !570 ; 2 uses
  %i.lg = add i32 %i.lf, 1
  store i32 %i.lg, ptr %i.je, align 8, !tbaa !570
  %i.lh = sext i32 %i.lf to i64
  %i.li = getelementptr i8, ptr %i.le, i64 %i.lh
  store i8 35, ptr %i.li, align 1, !tbaa !15
  %i.lj = load i32, ptr %i.je, align 8, !tbaa !570
  %i.lk = load i32, ptr %i.jk, align 4, !tbaa !509 ; 2 uses
  %.not.i229.i = icmp slt i32 %i.lj, %i.lk
  br i1 %.not.i229.i, label %tokadd.exit.i, label %bb.ce

bb.ce:                                            ; preds = %bb.cd
  %i.ll = shl i32 %i.lk, 1                        ; 2 uses
  store i32 %i.ll, ptr %i.jk, align 4, !tbaa !509
  %i.lm = load ptr, ptr %i.jf, align 8, !tbaa !500
  %i.ln = sext i32 %i.ll to i64
  %i.lo = tail call nonnull ptr @ruby_xrealloc2(ptr noundef %i.lm, i64 noundef %i.ln, i64 noundef 1) #38
  store ptr %i.lo, ptr %i.jf, align 8, !tbaa !500
end_hunk_2
begin_hunk_3_@parser_yylex:bb.a
  %i.mx = load ptr, ptr %i.jf, align 8, !tbaa !500
  %i.my = load i32, ptr %i.je, align 8, !tbaa !570
  %i.mz = sext i32 %i.my to i64
  %i.na = load ptr, ptr %i.c, align 8, !tbaa !564 ; 2 uses
  %i.nb = load ptr, ptr %i.m, align 8, !tbaa !176
  %i.nc = tail call fastcc ptr @parser_str_new(ptr noundef %i.mx, i64 noundef %i.mz, ptr noundef %i.na, i32 noundef %i.aa, ptr noundef %i.nb)
  %.pre332.i = load ptr, ptr %i.i, align 8, !tbaa !188
  br label %.loopexit.i

.loopexit.i:                                      ; preds = %rb_parser_str_buf_cat.exit195.i, %.loopexit305.i
  %i.nd = phi ptr [ %i.na, %.loopexit305.i ], [ %i.n, %rb_parser_str_buf_cat.exit195.i ]
  %i.ne = phi ptr [ %.pre332.i, %.loopexit305.i ], [ %i.hs, %rb_parser_str_buf_cat.exit195.i ]
  %.2144.i = phi ptr [ %i.nc, %.loopexit305.i ], [ %.1143.i, %rb_parser_str_buf_cat.exit195.i ]
  %i.nf = getelementptr i8, ptr %0, i64 196
  %i.ng = load i32, ptr %i.nf, align 4, !tbaa !29 ; 3 uses
  %i.nh = load ptr, ptr %i.k, align 8, !tbaa !49
  %i.ni = load ptr, ptr %i.cg, align 8, !tbaa !50
  %i.nj = ptrtoint ptr %i.nh to i64
  %i.nk = ptrtoint ptr %i.ni to i64               ; 2 uses
  %i.nl = sub i64 %i.nj, %i.nk
  %i.nm = trunc i64 %i.nl to i32
  %i.nn = ptrtoint ptr %i.ne to i64
  %i.no = sub i64 %i.nn, %i.nk
  %i.np = trunc i64 %i.no to i32
  %i.nq = getelementptr i8, ptr %0, i64 288
  %.val.i.i.i = load ptr, ptr %i.nq, align 8, !tbaa !129
  %i.nr = tail call ptr @rb_ast_newnode(ptr noundef %.val.i.i.i, i32 noundef range(i32 0, 115) 63, i64 noundef range(i64 32, 129) 40, i64 noundef 8) #31 ; 10 uses
  tail call void @rb_node_init(ptr noundef %i.nr, i32 noundef range(i32 0, 115) 63) #31
  %i.ns = getelementptr i8, ptr %i.nr, i64 8
  store i32 %i.ng, ptr %i.ns, align 8, !tbaa !7
  %.sroa.5280.0..sroa_idx.i = getelementptr i8, ptr %i.nr, i64 12
  store i32 %i.nm, ptr %.sroa.5280.0..sroa_idx.i, align 4, !tbaa !7
  %.sroa.6281.0..sroa_idx.i = getelementptr i8, ptr %i.nr, i64 16
  store i32 %i.ng, ptr %.sroa.6281.0..sroa_idx.i, align 8, !tbaa !7
  %.sroa.7282.0..sroa_idx.i = getelementptr i8, ptr %i.nr, i64 20
  store i32 %i.np, ptr %.sroa.7282.0..sroa_idx.i, align 4, !tbaa !7
  %i.nt = sext i32 %i.ng to i64
  %i.nu = load i64, ptr %i.nr, align 8, !tbaa !69
  %i.nv = and i64 %i.nu, 32767
  %i.nw = shl nsw i64 %i.nt, 15
  %i.nx = or disjoint i64 %i.nv, %i.nw
  store i64 %i.nx, ptr %i.nr, align 8, !tbaa !69
  %i.ny = getelementptr i8, ptr %0, i64 296       ; 2 uses
  %i.nz = load i32, ptr %i.ny, align 8, !tbaa !217 ; 2 uses
  %i.oa = add i32 %i.nz, 1
  store i32 %i.oa, ptr %i.ny, align 8, !tbaa !217
  %i.ob = getelementptr i8, ptr %i.nr, i64 24
  store i32 %i.nz, ptr %i.ob, align 8, !tbaa !218
  %i.oc = getelementptr i8, ptr %i.nr, i64 32
  store ptr %.2144.i, ptr %i.oc, align 8, !tbaa !444
  %i.od = load ptr, ptr %0, align 8, !tbaa !62
  store ptr %i.nr, ptr %i.od, align 8, !tbaa !15
  br i1 %i.cj, label %bb.cq, label %bb.cr

bb.cq:                                            ; preds = %.loopexit.i
  %i.oe = load ptr, ptr %0, align 8, !tbaa !62
  %i.of = load ptr, ptr %i.oe, align 8, !tbaa !15 ; 2 uses
  %i.og = load i64, ptr %i.of, align 8, !tbaa !69
  %i.oh = or i64 %i.og, 128
  store i64 %i.oh, ptr %i.of, align 8, !tbaa !69
  br label %bb.cr

bb.cr:                                            ; preds = %bb.cq, %.loopexit.i
  tail call fastcc void @flush_string_content(ptr noundef nonnull %0, ptr noundef %i.nd, i64 noundef 0)
  br label %here_document.exit

bb.cs:                                            ; preds = %pushback.exit.i
  %i.oi = load ptr, ptr %i.i, align 8, !tbaa !188 ; 2 uses
  %i.oj = load ptr, ptr %i.ac, align 8, !tbaa !426
  %.not.i239.i = icmp ult ptr %i.oi, %i.oj
  br i1 %.not.i239.i, label %bb.ct, label %.critedge.i240.i, !prof !527

bb.ct:                                            ; preds = %bb.cs
  %i.ok = load i32, ptr %i.e, align 8
  %i.ol = and i32 %i.ok, 8
  %.not13.i246.i = icmp eq i32 %i.ol, 0
  br i1 %.not13.i246.i, label %bb.cu, label %.critedge.i240.i, !prof !527

bb.cu:                                            ; preds = %bb.ct
  %i.om = load ptr, ptr %i.mf, align 8, !tbaa !528
  %i.on = icmp ugt ptr %i.om, inttoptr (i64 1 to ptr)
  br i1 %i.on, label %.critedge.i240.i, label %bb.cv, !prof !205

.critedge.i240.i:                                 ; preds = %bb.cu, %bb.ct, %bb.cs
  %i.oo = tail call fastcc i32 @nextline(ptr noundef nonnull %0, i32 noundef 1)
  %.not14.i241.i = icmp eq i32 %i.oo, 0
...
bb.cv:                                            ; preds = %.critedge._crit_edge.i243.i, %bb.cu
  %i.op = phi ptr [ %.pre.i244.i, %.critedge._crit_edge.i243.i ], [ %i.oi, %bb.cu ] ; 3 uses
  %i.oq = getelementptr i8, ptr %i.op, i64 1      ; 3 uses
  store ptr %i.oq, ptr %i.i, align 8, !tbaa !188
  %i.or = load i8, ptr %i.op, align 1, !tbaa !15  ; 2 uses
  %i.os = icmp eq i8 %i.or, 13
  br i1 %i.os, label %bb.cw, label %nextc0.exit247.i, !prof !205

bb.cw:                                            ; preds = %bb.cv
  %i.ot = load ptr, ptr %i.ac, align 8, !tbaa !426
  %.not.i.i245.i = icmp ult ptr %i.oq, %i.ot
  br i1 %.not.i.i245.i, label %bb.cx, label %nextc0.exit247.i

bb.cx:                                            ; preds = %bb.cw
  %i.ou = load i8, ptr %i.oq, align 1, !tbaa !15
  %i.ov = icmp eq i8 %i.ou, 10
  br i1 %i.ov, label %bb.cy, label %nextc0.exit247.i

bb.cy:                                            ; preds = %bb.cx
  %i.ow = getelementptr i8, ptr %i.op, i64 2
  store ptr %i.ow, ptr %i.i, align 8, !tbaa !188
  br label %nextc0.exit247.i

nextc0.exit247.i:                                 ; preds = %bb.cy, %bb.cx, %bb.cw, %bb.cv, %.critedge.i240.i
  %.011.i242.i = phi i8 [ -1, %.critedge.i240.i ], [ %i.or, %bb.cv ], [ 13, %bb.cw ], [ 10, %bb.cy ], [ 13, %bb.cx ]
  %i.ox = load ptr, ptr %i.jf, align 8, !tbaa !500
  %i.oy = load i32, ptr %i.je, align 8, !tbaa !570 ; 2 uses
  %i.oz = add i32 %i.oy, 1
  store i32 %i.oz, ptr %i.je, align 8, !tbaa !570
  %i.pa = sext i32 %i.oy to i64
  %i.pb = getelementptr i8, ptr %i.ox, i64 %i.pa
  store i8 %.011.i242.i, ptr %i.pb, align 1, !tbaa !15
  %i.pc = load i32, ptr %i.je, align 8, !tbaa !570
  %i.pd = load i32, ptr %i.jk, align 4, !tbaa !509 ; 2 uses
  %.not.i248.i = icmp slt i32 %i.pc, %i.pd
  br i1 %.not.i248.i, label %tokadd.exit249.i, label %bb.cz

bb.cz:                                            ; preds = %nextc0.exit247.i
  %i.pe = shl i32 %i.pd, 1                        ; 2 uses
  store i32 %i.pe, ptr %i.jk, align 4, !tbaa !509
  %i.pf = load ptr, ptr %i.jf, align 8, !tbaa !500
  %i.pg = sext i32 %i.pe to i64
  %i.ph = tail call nonnull ptr @ruby_xrealloc2(ptr noundef %i.pf, i64 noundef %i.pg, i64 noundef 1) #38
  store ptr %i.ph, ptr %i.jf, align 8, !tbaa !500
  br label %tokadd.exit249.i

tokadd.exit249.i:                                 ; preds = %bb.cz, %nextc0.exit247.i
  %i.pi = load i32, ptr %i.mg, align 4, !tbaa !177
  %i.pj = icmp sgt i32 %i.pi, 0
  br i1 %i.pj, label %bb.da, label %bb.db

bb.da:                                            ; preds = %tokadd.exit249.i
  %i.pk = load ptr, ptr %i.ac, align 8, !tbaa !426
  store ptr %i.pk, ptr %i.i, align 8, !tbaa !188
  br label %.loopexit305.i

bb.db:                                            ; preds = %tokadd.exit249.i
  %i.pl = load ptr, ptr %i.i, align 8, !tbaa !188 ; 2 uses
  %i.pm = load ptr, ptr %i.ac, align 8, !tbaa !426 ; 2 uses
  %.not.i250.i = icmp ult ptr %i.pl, %i.pm
  br i1 %.not.i250.i, label %bb.dc, label %.critedge.i251.i, !prof !527

bb.dc:                                            ; preds = %bb.db
  %i.pn = load i32, ptr %i.e, align 8
  %i.po = and i32 %i.pn, 8
  %.not13.i257.i = icmp eq i32 %i.po, 0
  br i1 %.not13.i257.i, label %bb.dd, label %.critedge.i251.i, !prof !527

bb.dd:                                            ; preds = %bb.dc
  %i.pp = load ptr, ptr %i.mf, align 8, !tbaa !528
  %i.pq = icmp ugt ptr %i.pp, inttoptr (i64 1 to ptr)
  br i1 %i.pq, label %.critedge.i251.i, label %bb.de, !prof !205

.critedge.i251.i:                                 ; preds = %bb.dd, %bb.dc, %bb.db
  %i.pr = tail call fastcc i32 @nextline(ptr noundef nonnull %0, i32 noundef 1)
  %.not14.i252.i = icmp eq i32 %i.pr, 0
...
bb.de:                                            ; preds = %.critedge._crit_edge.i254.i, %bb.dd
  %.val168.pre.i = phi ptr [ %.val168.pre.pre.i, %.critedge._crit_edge.i254.i ], [ %i.pm, %bb.dd ] ; 7 uses
  %i.ps = phi ptr [ %.pre.i255.i, %.critedge._crit_edge.i254.i ], [ %i.pl, %bb.dd ] ; 3 uses
  %i.pt = getelementptr i8, ptr %i.ps, i64 1      ; 3 uses
  store ptr %i.pt, ptr %i.i, align 8, !tbaa !188
  %i.pu = load i8, ptr %i.ps, align 1, !tbaa !15
  %i.pv = icmp eq i8 %i.pu, 13
  br i1 %i.pv, label %bb.df, label %bb.di, !prof !205

bb.df:                                            ; preds = %bb.de
  %.not.i.i256.i = icmp ult ptr %i.pt, %.val168.pre.i
  br i1 %.not.i.i256.i, label %bb.dg, label %bb.di

bb.dg:                                            ; preds = %bb.df
  %i.pw = load i8, ptr %i.pt, align 1, !tbaa !15
  %i.px = icmp eq i8 %i.pw, 10
  br i1 %i.px, label %bb.dh, label %bb.di

bb.dh:                                            ; preds = %bb.dg
  %i.py = getelementptr i8, ptr %i.ps, i64 2
  store ptr %i.py, ptr %i.i, align 8, !tbaa !188
  br label %bb.di

bb.di:                                            ; preds = %bb.dh, %bb.dg, %bb.df, %bb.de
  %.val.i = load ptr, ptr %i.cg, align 8, !tbaa !50 ; 7 uses
  %i.pz = ptrtoint ptr %.val168.pre.i to i64      ; 3 uses
  %i.qa = ptrtoint ptr %.val.i to i64             ; 3 uses
  %i.qb = sub i64 %i.pz, %i.qa
  %i.qc = icmp slt i64 %i.qb, %i.w
  br i1 %i.qc, label %.backedge306.i, label %bb.dj

bb.dj:                                            ; preds = %bb.di
  %i.qd = icmp ugt ptr %.val168.pre.i, %.val.i
  br i1 %i.qd, label %bb.dk, label %bb.do

bb.dk:                                            ; preds = %bb.dj
  %i.qe = getelementptr i8, ptr %.val168.pre.i, i64 -1 ; 4 uses
  %i.qf = load i8, ptr %i.qe, align 1, !tbaa !15
  %i.qg = icmp eq i8 %i.qf, 10
  br i1 %i.qg, label %bb.dl, label %bb.do

bb.dl:                                            ; preds = %bb.dk
  %i.qh = icmp ugt ptr %i.qe, %.val.i
  br i1 %i.qh, label %bb.dm, label %bb.dn

bb.dm:                                            ; preds = %bb.dl
  %i.qi = getelementptr i8, ptr %.val168.pre.i, i64 -2 ; 2 uses
  %i.qj = load i8, ptr %i.qi, align 1, !tbaa !15
  %i.qk = icmp eq i8 %i.qj, 13
  %spec.select.i274.i = select i1 %i.qk, ptr %i.qi, ptr %i.qe
  br label %bb.dn

bb.dn:                                            ; preds = %bb.dm, %bb.dl
  %.0.i273.i = phi ptr [ %i.qe, %bb.dl ], [ %spec.select.i274.i, %bb.dm ] ; 2 uses
  %i.ql = ptrtoint ptr %.0.i273.i to i64          ; 2 uses
  %i.qm = sub i64 %i.ql, %i.qa
  %i.qn = icmp slt i64 %i.qm, %i.w
  br i1 %i.qn, label %.backedge306.i, label %bb.do

bb.do:                                            ; preds = %bb.dn, %bb.dk, %bb.dj
  %.16.pre-phi.i259.i = phi i64 [ %i.ql, %bb.dn ], [ %i.pz, %bb.dk ], [ %i.pz, %bb.dj ]
  %.1.i260.i = phi ptr [ %.0.i273.i, %bb.dn ], [ %.val168.pre.i, %bb.dk ], [ %.val168.pre.i, %bb.dj ]
  %i.qo = getelementptr i8, ptr %.1.i260.i, i64 %i.x ; 3 uses
  %i.qp = tail call i32 @strncmp(ptr noundef readonly %i.t, ptr noundef %i.qo, i64 noundef range(i64 0, 4294967296) %i.w) #35
  %.not.i261.i = icmp eq i32 %i.qp, 0
  br i1 %.not.i261.i, label %bb.dp, label %.backedge306.i

bb.dp:                                            ; preds = %bb.do
  %i.qq = icmp ult ptr %.val.i, %i.qo
  %or.cond.i264.i = and i1 %.not35.i263.i, %i.qq
  br i1 %or.cond.i264.i, label %.lr.ph.preheader.i267.i, label %.critedge.i265.i

.lr.ph.preheader.i267.i:                          ; preds = %bb.dp
  %i.qr = add i64 %i.qa, %i.w
  %i.qs = sub i64 %.16.pre-phi.i259.i, %i.qr
  %scevgep.i268.i = getelementptr i8, ptr %.val.i, i64 %i.qs ; 2 uses
  br label %.lr.ph.i269.i

.lr.ph.i269.i:                                    ; preds = %bb.dq, %.lr.ph.preheader.i267.i
  %.0263.i270.i = phi ptr [ %i.qy, %bb.dq ], [ %.val.i, %.lr.ph.preheader.i267.i ] ; 3 uses
  %i.qt = load i8, ptr %.0263.i270.i, align 1, !tbaa !15 ; 2 uses
  %i.qu = sext i8 %i.qt to i32
  %i.qv = icmp ne i8 %i.qt, 32
  %i.qw = add nsw i32 %i.qu, -14
  %i.qx = icmp ult i32 %i.qw, -5
  %narrow.i.not.i271.i = select i1 %i.qv, i1 %i.qx, i1 false
  br i1 %narrow.i.not.i271.i, label %.critedge.i265.i, label %bb.dq

bb.dq:                                            ; preds = %.lr.ph.i269.i
  %i.qy = getelementptr i8, ptr %.0263.i270.i, i64 1 ; 2 uses
  %exitcond.not.i272.i = icmp eq ptr %i.qy, %scevgep.i268.i
...
.critedge.i265.i:                                 ; preds = %bb.dq, %.lr.ph.i269.i, %bb.dp
  ...
  %.not319.i = icmp eq ptr %.127.i266.i, %i.qo
  br i1 %.not319.i, label %bb.dr, label %.backedge306.i

bb.dr:                                            ; preds = %.critedge.i265.i
  %i.qz = load ptr, ptr %i.jf, align 8, !tbaa !500
  %i.ra = load i32, ptr %i.je, align 8, !tbaa !570
  %i.rb = sext i32 %i.ra to i64
  %i.rc = load ptr, ptr %i.c, align 8, !tbaa !564
  %i.rd = load ptr, ptr %i.m, align 8, !tbaa !176
  %i.re = tail call fastcc ptr @parser_str_new(ptr noundef %i.qz, i64 noundef %i.rb, ptr noundef %i.rc, i32 noundef %i.aa, ptr noundef %i.rd)
  br label %.loopexit304.i

.loopexit304.i:                                   ; preds = %.critedge.i212.i, %bb.dr
  %.3.i = phi ptr [ %i.re, %bb.dr ], [ %.1143.i, %.critedge.i212.i ]
  tail call fastcc void @parser_dispatch_heredoc_end(ptr noundef %0, i32 noundef 9189)
  %i.rf = load ptr, ptr %i.g, align 8, !tbaa !178 ; 6 uses
  %i.rg = getelementptr i8, ptr %i.rf, i64 8
  store ptr null, ptr %i.g, align 8, !tbaa !178
  %i.rh = load ptr, ptr %i.rg, align 8, !tbaa !565 ; 3 uses
  %i.ri = getelementptr i8, ptr %0, i64 56
  store ptr %i.rh, ptr %i.ri, align 8, !tbaa !189
  %i.rj = getelementptr i8, ptr %i.rh, i64 24
  %i.rk = load ptr, ptr %i.rj, align 8, !tbaa !18 ; 3 uses
  store ptr %i.rk, ptr %i.cg, align 8, !tbaa !50
  %i.rl = getelementptr i8, ptr %i.rh, i64 16
  %i.rm = load i64, ptr %i.rl, align 8, !tbaa !23
  %i.rn = getelementptr i8, ptr %i.rk, i64 %i.rm
  store ptr %i.rn, ptr %i.ac, align 8, !tbaa !426
  %i.ro = getelementptr i8, ptr %i.rf, i64 16
  %i.rp = load i64, ptr %i.ro, align 8, !tbaa !488
  %i.rq = getelementptr i8, ptr %i.rk, i64 %i.rp  ; 2 uses
  %i.rr = getelementptr i8, ptr %i.rf, i64 28
  %i.rs = load i32, ptr %i.rr, align 4, !tbaa !491
  %i.rt = zext i32 %i.rs to i64
  %i.ru = getelementptr i8, ptr %i.rq, i64 %i.rt
  %i.rv = getelementptr i8, ptr %i.rf, i64 32
  %i.rw = load i8, ptr %i.rv, align 8, !tbaa !489
  %i.rx = zext i8 %i.rw to i64                    ; 2 uses
  %i.ry = getelementptr i8, ptr %i.ru, i64 %i.rx
  store ptr %i.ry, ptr %i.i, align 8, !tbaa !188
  %i.rz = sub nsw i64 0, %i.rx
  %i.sa = getelementptr i8, ptr %i.rq, i64 %i.rz
  store ptr %i.sa, ptr %i.k, align 8, !tbaa !49
  %i.sb = getelementptr i8, ptr %0, i64 196       ; 3 uses
  %i.sc = load i32, ptr %i.sb, align 4, !tbaa !29
  %i.sd = getelementptr i8, ptr %0, i64 144
  store i32 %i.sc, ptr %i.sd, align 8, !tbaa !543
  %i.se = getelementptr i8, ptr %i.rf, i64 24
  %i.sf = load i32, ptr %i.se, align 8, !tbaa !486
  store i32 %i.sf, ptr %i.sb, align 4, !tbaa !29
  %i.sg = load i32, ptr %i.e, align 8             ; 2 uses
  %i.sh = and i32 %i.sg, 8
  %.not.i276.i = icmp eq i32 %i.sh, 0
  br i1 %.not.i276.i, label %heredoc_restore.exit277.i, label %bb.ds

bb.ds:                                            ; preds = %.loopexit304.i
  %i.si = getelementptr i8, ptr %0, i64 64
  store ptr inttoptr (i64 1 to ptr), ptr %i.si, align 8, !tbaa !528
  br label %heredoc_restore.exit277.i

heredoc_restore.exit277.i:                        ; preds = %bb.ds, %.loopexit304.i
  %i.sj = and i32 %i.sg, -9
  store i32 %i.sj, ptr %i.e, align 8
  tail call void @ruby_xfree(ptr noundef nonnull %i.rf) #31
  %i.sk = load ptr, ptr %i.i, align 8, !tbaa !188
  store ptr %i.sk, ptr %i.k, align 8, !tbaa !49
  %i.sl = or disjoint i32 %i.aa, 32768
  %i.sm = tail call noalias nonnull dereferenceable(40) ptr @ruby_xcalloc(i64 noundef 1, i64 noundef 40) #33 ; 4 uses
  %i.sn = getelementptr inbounds nuw i8, ptr %i.sm, i64 16
  store i32 %i.sl, ptr %i.sn, align 8, !tbaa !15
  %i.so = getelementptr inbounds nuw i8, ptr %i.sm, i64 24
  store i32 0, ptr %i.so, align 8, !tbaa !15
  %i.sp = getelementptr inbounds nuw i8, ptr %i.sm, i64 20
  store i32 0, ptr %i.sp, align 4, !tbaa !15
  store ptr %i.sm, ptr %i.g, align 8, !tbaa !178
  %i.sq = load i32, ptr %i.sb, align 4, !tbaa !29 ; 3 uses
  %i.sr = load ptr, ptr %i.k, align 8, !tbaa !49
  %i.ss = load ptr, ptr %i.cg, align 8, !tbaa !50
  %i.st = ptrtoint ptr %i.sr to i64
  %i.su = ptrtoint ptr %i.ss to i64               ; 2 uses
  %i.sv = sub i64 %i.st, %i.su
  %i.sw = trunc i64 %i.sv to i32
  %i.sx = load ptr, ptr %i.i, align 8, !tbaa !188
  %i.sy = ptrtoint ptr %i.sx to i64
  %i.sz = sub i64 %i.sy, %i.su
  %i.ta = trunc i64 %i.sz to i32
  %i.tb = getelementptr i8, ptr %0, i64 288
  %.val.i.i278.i = load ptr, ptr %i.tb, align 8, !tbaa !129
  %i.tc = tail call ptr @rb_ast_newnode(ptr noundef %.val.i.i278.i, i32 noundef range(i32 0, 115) 63, i64 noundef range(i64 32, 129) 40, i64 noundef 8) #31 ; 10 uses
  tail call void @rb_node_init(ptr noundef %i.tc, i32 noundef range(i32 0, 115) 63) #31
  %i.td = getelementptr i8, ptr %i.tc, i64 8
  store i32 %i.sq, ptr %i.td, align 8, !tbaa !7
  %.sroa.5.0..sroa_idx.i = getelementptr i8, ptr %i.tc, i64 12
  store i32 %i.sw, ptr %.sroa.5.0..sroa_idx.i, align 4, !tbaa !7
  %.sroa.6.0..sroa_idx.i = getelementptr i8, ptr %i.tc, i64 16
  store i32 %i.sq, ptr %.sroa.6.0..sroa_idx.i, align 8, !tbaa !7
  %.sroa.7.0..sroa_idx.i = getelementptr i8, ptr %i.tc, i64 20
  store i32 %i.ta, ptr %.sroa.7.0..sroa_idx.i, align 4, !tbaa !7
  %i.te = sext i32 %i.sq to i64
  %i.tf = load i64, ptr %i.tc, align 8, !tbaa !69
  %i.tg = and i64 %i.tf, 32767
  %i.th = shl nsw i64 %i.te, 15
  %i.ti = or disjoint i64 %i.tg, %i.th
  store i64 %i.ti, ptr %i.tc, align 8, !tbaa !69
  %i.tj = getelementptr i8, ptr %0, i64 296       ; 2 uses
  %i.tk = load i32, ptr %i.tj, align 8, !tbaa !217 ; 2 uses
  %i.tl = add i32 %i.tk, 1
  store i32 %i.tl, ptr %i.tj, align 8, !tbaa !217
  %i.tm = getelementptr i8, ptr %i.tc, i64 24
  store i32 %i.tk, ptr %i.tm, align 8, !tbaa !218
  %i.tn = getelementptr i8, ptr %i.tc, i64 32
  store ptr %.3.i, ptr %i.tn, align 8, !tbaa !444
  %i.to = load ptr, ptr %0, align 8, !tbaa !62
  store ptr %i.tc, ptr %i.to, align 8, !tbaa !15
  br i1 %i.cj, label %bb.dt, label %here_document.exit

bb.dt:                                            ; preds = %heredoc_restore.exit277.i
  %i.tp = load ptr, ptr %0, align 8, !tbaa !62
  %i.tq = load ptr, ptr %i.tp, align 8, !tbaa !15 ; 2 uses
  %i.tr = load i64, ptr %i.tq, align 8, !tbaa !69
  %i.ts = or i64 %i.tr, 128
  store i64 %i.ts, ptr %i.tq, align 8, !tbaa !69
  br label %here_document.exit
...
bb.du:                                            ; preds = %bb.b
  %i.tt = getelementptr i8, ptr %i.h, i64 16      ; 7 uses
  %i.tu = load i32, ptr %i.tt, align 8, !tbaa !571 ; 11 uses
  %i.tv = getelementptr i8, ptr %i.h, i64 24
  %i.tw = load i32, ptr %i.tv, align 8, !tbaa !573 ; 3 uses
  %i.tx = getelementptr i8, ptr %i.h, i64 20
  %i.ty = load i32, ptr %i.tx, align 4, !tbaa !574
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #31
  %i.tz = getelementptr i8, ptr %0, i64 216       ; 2 uses
  %i.ua = load ptr, ptr %i.tz, align 8, !tbaa !176
  store ptr %i.ua, ptr %i.a, align 8, !tbaa !564
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #31
  store ptr null, ptr %i.b, align 8, !tbaa !564
  %i.ub = and i32 %i.tu, 32768
  %.not.i881 = icmp eq i32 %i.ub, 0
  br i1 %.not.i881, label %bb.ed, label %bb.dv

bb.dv:                                            ; preds = %bb.du
  %i.uc = and i32 %i.tu, 8
  %.not94.i = icmp eq i32 %i.uc, 0
  br i1 %.not94.i, label %nextc0.exit.i885, label %bb.dw

bb.dw:                                            ; preds = %bb.dv
  %i.ud = getelementptr i8, ptr %0, i64 88        ; 2 uses
  %i.ue = load ptr, ptr %i.ud, align 8, !tbaa !426
  %.not.i.i882 = icmp ult ptr %i.j, %i.ue
  %i.uf = and i32 %i.f, 8
  %.not13.i.i891 = icmp eq i32 %i.uf, 0
...
bb.dx:                                            ; preds = %bb.dw
  %i.ug = getelementptr i8, ptr %0, i64 64
  %i.uh = load ptr, ptr %i.ug, align 8, !tbaa !528
  %i.ui = icmp ugt ptr %i.uh, inttoptr (i64 1 to ptr)
  br i1 %i.ui, label %.critedge.i.i883, label %bb.dy, !prof !205

.critedge.i.i883:                                 ; preds = %bb.dx, %bb.dw
  %i.uj = tail call fastcc i32 @nextline(ptr noundef nonnull %0, i32 noundef 1)
  %.not14.i.i884 = icmp eq i32 %i.uj, 0
...
bb.dy:                                            ; preds = %.critedge._crit_edge.i.i888, %bb.dx
  %i.uk = phi ptr [ %.pre.i.i889, %.critedge._crit_edge.i.i888 ], [ %i.j, %bb.dx ] ; 3 uses
  %i.ul = getelementptr i8, ptr %i.uk, i64 1      ; 3 uses
  store ptr %i.ul, ptr %i.i, align 8, !tbaa !188
end_hunk_3
begin_hunk_4_@parser_yylex:bb.a
  %i.axj = load i64, ptr %i.axi, align 8, !tbaa !13
  %i.axk = and i64 %i.axj, 8192
  %.not.i225.i = icmp eq i64 %i.axk, 0
  %i.axl = getelementptr i8, ptr %i.axi, i64 24   ; 2 uses
  br i1 %.not.i225.i, label %RSTRING_PTR.exit226.i, label %bb.jy

bb.jy:                                            ; preds = %bb.jx
  %i.axm = load ptr, ptr %i.axl, align 8, !tbaa !15
  br label %RSTRING_PTR.exit226.i

RSTRING_PTR.exit226.i:                            ; preds = %bb.jy, %bb.jx
  %i.axn = phi ptr [ %i.axm, %bb.jy ], [ %i.axl, %bb.jx ]
...
bb.jz:                                            ; preds = %RSTRING_PTR.exit226.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 %i.axn, ptr noundef nonnull readonly align 1 %.0157.i, i64 noundef range(i64 1, 0) %.0136.i, i1 noundef false) #31
  br label %ruby_nonempty_memcpy.exit229.i

bb.ka:                                            ; preds = %bb.jw
  %i.axo = load ptr, ptr %i.ait, align 8, !tbaa !176
  %i.axp = call i64 @rb_enc_str_new(ptr noundef %.0157.i, i64 noundef %.0136.i, ptr noundef %i.axo) #31 ; 2 uses
  %.pre406.i = inttoptr i64 %i.axp to ptr
  br label %ruby_nonempty_memcpy.exit229.i

ruby_nonempty_memcpy.exit229.i:                   ; preds = %bb.ka, %bb.jz, %RSTRING_PTR.exit226.i
  %.pre-phi407.i = phi ptr [ %i.axi, %bb.jz ], [ %i.axi, %RSTRING_PTR.exit226.i ], [ %.pre406.i, %bb.ka ] ; 2 uses
  %.1159.i = phi i64 [ %.0158363.i, %bb.jz ], [ %.0158363.i, %RSTRING_PTR.exit226.i ], [ %i.axp, %bb.ka ]
  store ptr %i.aqg, ptr %i.aii, align 8, !tbaa !49
  store ptr %.9.i, ptr %i.aig, align 8, !tbaa !188
  %i.axq = getelementptr i8, ptr %.0153.lcssa.i, i64 8
  %i.axr = load ptr, ptr %i.axq, align 8, !tbaa !596
  %i.axs = load i64, ptr %.pre-phi407.i, align 8, !tbaa !13
  %i.axt = and i64 %i.axs, 8192
  %.not.i230.i942 = icmp eq i64 %i.axt, 0
  %i.axu = getelementptr i8, ptr %.pre-phi407.i, i64 24 ; 2 uses
  br i1 %.not.i230.i942, label %RSTRING_PTR.exit231.i, label %bb.kb

bb.kb:                                            ; preds = %ruby_nonempty_memcpy.exit229.i
  %i.axv = load ptr, ptr %i.axu, align 8, !tbaa !15
  br label %RSTRING_PTR.exit231.i

RSTRING_PTR.exit231.i:                            ; preds = %bb.kb, %ruby_nonempty_memcpy.exit229.i
  %i.axw = phi ptr [ %i.axv, %bb.kb ], [ %i.axu, %ruby_nonempty_memcpy.exit229.i ]
  call void %i.axr(ptr noundef nonnull %0, ptr noundef nonnull %.lcssa391.i, ptr noundef %i.axw) #31, !inline_history !595
  br label %.loopexit.i937

bb.kc:                                            ; preds = %.preheader.i940
  %i.axx = call i32 @rb_parser_st_locale_insensitive_strncasecmp(ptr noundef nonnull @.str.815, ptr noundef %i.arp, i64 noundef %i.arb) #35
  %i.axy = icmp eq i32 %i.axx, 0
  %.not203.1.i = icmp eq i64 %i.arb, 8
  %or.cond472.i = and i1 %.not203.1.i, %i.axy
  br i1 %or.cond472.i, label %bb.ju, label %bb.kd

bb.kd:                                            ; preds = %bb.kc
  %i.axz = call i32 @rb_parser_st_locale_insensitive_strncasecmp(ptr noundef nonnull @.str.816, ptr noundef %i.arp, i64 noundef %i.arb) #35
  %i.aya = icmp eq i32 %i.axz, 0
  %.not203.2.i = icmp eq i64 %i.arb, 21
  %or.cond473.i = and i1 %.not203.2.i, %i.aya
  br i1 %or.cond473.i, label %bb.ju, label %bb.ke

bb.ke:                                            ; preds = %bb.kd
  %i.ayb = call i32 @rb_parser_st_locale_insensitive_strncasecmp(ptr noundef nonnull @.str.817, ptr noundef %i.arp, i64 noundef %i.arb) #35
  %i.ayc = icmp eq i32 %i.ayb, 0
  %.not203.3.i = icmp eq i64 %i.arb, 24
  %or.cond474.i = and i1 %.not203.3.i, %i.ayc
  br i1 %or.cond474.i, label %bb.ju, label %bb.kf

bb.kf:                                            ; preds = %bb.ke
  %i.ayd = call i32 @rb_parser_st_locale_insensitive_strncasecmp(ptr noundef nonnull @.str.818, ptr noundef %i.arp, i64 noundef %i.arb) #35
  %i.aye = icmp eq i32 %i.ayd, 0
  %.not203.4.i = icmp eq i64 %i.arb, 11
  %or.cond475.i = and i1 %.not203.4.i, %i.aye
...
.loopexit.i937:                                   ; preds = %bb.kf, %RSTRING_PTR.exit231.i, %bb.jf
  ...
  %i.ayf = icmp sgt i64 %.14152.i, 0
  br i1 %i.ayf, label %.preheader271.i, label %parser_magic_comment.exit

.loopexit:                                        ; preds = %bb.ix, %bb.iu, %bb.jf, %.critedge14.i, %.lr.ph357.i, %bb.ik, %bb.ir, %magic_comment_marker.exit214.i
  %i.ayg = load i32, ptr %i.e, align 8            ; 2 uses
  %i.ayh = and i32 %i.ayg, 128
  %.not.i945 = icmp eq i32 %i.ayh, 0
  br i1 %.not.i945, label %comment_at_top.exit, label %parser_magic_comment.exit

comment_at_top.exit:                              ; preds = %.loopexit
  %i.ayi = load i32, ptr %i.aiu, align 8, !tbaa !537
  %i.ayj = and i32 %i.ayg, 64
  %.not4.i = icmp eq i32 %i.ayj, 0
  %i.ayk = select i1 %.not4.i, i32 1, i32 2
  %i.ayl = icmp eq i32 %i.ayi, %i.ayk
  br i1 %i.ayl, label %bb.kg, label %parser_magic_comment.exit

bb.kg:                                            ; preds = %comment_at_top.exit
  %i.aym = load ptr, ptr %i.aig, align 8, !tbaa !188 ; 2 uses
  %i.ayn = load ptr, ptr %i.aik, align 8, !tbaa !426 ; 4 uses
  %i.ayo = ptrtoint ptr %i.ayn to i64             ; 3 uses
  %i.ayp = ptrtoint ptr %i.aym to i64
  %i.ayq = sub i64 %i.ayo, %i.ayp
  %i.ayr = icmp slt i64 %i.ayq, 7
  br i1 %i.ayr, label %parser_magic_comment.exit, label %.lr.ph.i946

.lr.ph.i946:                                      ; preds = %bb.kg, %.backedge.i947
  %.065.i = phi ptr [ %.0.be.i, %.backedge.i947 ], [ %i.aym, %bb.kg ] ; 8 uses
  %i.ays = getelementptr i8, ptr %.065.i, i64 6   ; 6 uses
  %i.ayt = load i8, ptr %i.ays, align 1, !tbaa !15 ; 3 uses
  switch i8 %i.ayt, label %bb.km [
...
.backedge.i947:                                   ; preds = %bb.kn, %bb.km, %bb.kl, %bb.kk, %bb.kj, %bb.ki, %bb.kh, %.lr.ph.i946, %.lr.ph.i946
  %.0.be.i = phi ptr [ %i.azb, %bb.kl ], [ %i.ays, %bb.km ], [ %i.ays, %bb.kn ], [ %i.ayx, %bb.kh ], [ %i.ayy, %bb.ki ], [ %i.ayz, %bb.kj ], [ %i.aza, %bb.kk ], [ %i.ays, %.lr.ph.i946 ], [ %i.ays, %.lr.ph.i946 ] ; 2 uses
  %i.ayu = ptrtoint ptr %.0.be.i to i64
  %i.ayv = sub i64 %i.ayo, %i.ayu
  %i.ayw = icmp slt i64 %i.ayv, 7
  br i1 %i.ayw, label %parser_magic_comment.exit, label %.lr.ph.i946

bb.kh:                                            ; preds = %.lr.ph.i946, %.lr.ph.i946
  %i.ayx = getelementptr i8, ptr %.065.i, i64 5
  br label %.backedge.i947

bb.ki:                                            ; preds = %.lr.ph.i946, %.lr.ph.i946
  %i.ayy = getelementptr i8, ptr %.065.i, i64 4
  br label %.backedge.i947

bb.kj:                                            ; preds = %.lr.ph.i946, %.lr.ph.i946
  %i.ayz = getelementptr i8, ptr %.065.i, i64 3
  br label %.backedge.i947

bb.kk:                                            ; preds = %.lr.ph.i946, %.lr.ph.i946
  %i.aza = getelementptr i8, ptr %.065.i, i64 2
  br label %.backedge.i947

bb.kl:                                            ; preds = %.lr.ph.i946, %.lr.ph.i946
  %i.azb = getelementptr i8, ptr %.065.i, i64 1
  br label %.backedge.i947

bb.km:                                            ; preds = %.lr.ph.i946
  %i.azc = sext i8 %i.ayt to i32
  %i.azd = icmp ne i8 %i.ayt, 32
  %i.aze = add nsw i32 %i.azc, -14
  %i.azf = icmp ult i32 %i.aze, -5
  %narrow.i.not.i958 = select i1 %i.azd, i1 %i.azf, i1 false
  br i1 %narrow.i.not.i958, label %.backedge.i947, label %bb.kn

bb.kn:                                            ; preds = %bb.km, %.lr.ph.i946, %.lr.ph.i946
  %i.azg = phi i1 [ true, %bb.km ], [ false, %.lr.ph.i946 ], [ false, %.lr.ph.i946 ]
  %i.azh = call i32 @rb_parser_st_locale_insensitive_strncasecmp(ptr noundef nonnull %.065.i, ptr noundef nonnull @.str.814, i64 noundef 6) #35
  %i.azi = icmp eq i32 %i.azh, 0
  br i1 %i.azi, label %.preheader58.i.preheader, label %.backedge.i947

.preheader58.i.preheader:                         ; preds = %bb.kn
  %i.azj = getelementptr i8, ptr %.065.i, i64 7   ; 2 uses
  %.not47.i28632866 = icmp ult ptr %i.azj, %i.ayn
...
.lr.ph2865:                                       ; preds = %.preheader58.i.preheader, %.preheader58.i
  %i.azk = phi ptr [ %i.azu, %.preheader58.i ], [ %i.azj, %.preheader58.i.preheader ]
  %.2.i9492868 = phi ptr [ %i.azt, %.preheader58.i ], [ %i.ays, %.preheader58.i.preheader ] ; 3 uses
  %.240.i2867 = phi i1 [ false, %.preheader58.i ], [ %i.azg, %.preheader58.i.preheader ]
  br label %bb.kp

bb.ko:                                            ; preds = %bb.kp
  %i.azl = getelementptr i8, ptr %i.azm, i64 1    ; 2 uses
  %.not47.i = icmp ult ptr %i.azl, %i.ayn
  br i1 %.not47.i, label %bb.kp, label %parser_magic_comment.exit, !llvm.loop !597

bb.kp:                                            ; preds = %.lr.ph2865, %bb.ko
  %i.azm = phi ptr [ %i.azk, %.lr.ph2865 ], [ %i.azl, %bb.ko ] ; 8 uses
  %.3.i9502864 = phi ptr [ %.2.i9492868, %.lr.ph2865 ], [ %i.azm, %bb.ko ] ; 2 uses
  %i.azn = load i8, ptr %i.azm, align 1, !tbaa !15 ; 3 uses
  %i.azo = sext i8 %i.azn to i32
  %i.azp = icmp ne i8 %i.azn, 32
  %i.azq = add nsw i32 %i.azo, -14
  %i.azr = icmp ult i32 %i.azq, -5
  %narrow.i53.not.i = select i1 %i.azp, i1 %i.azr, i1 false
...
.preheader.i951:                                  ; preds = %bb.kq
  %scevgep.i = getelementptr i8, ptr %.2.i9492868, i64 %i.ayo
  %.2.lcssa7375.i = ptrtoint ptr %.2.i9492868 to i64
  %i.azs = sub i64 0, %.2.lcssa7375.i
  %scevgep76.i = getelementptr i8, ptr %scevgep.i, i64 %i.azs ; 2 uses
  br label %bb.ks

bb.kr:                                            ; preds = %bb.kq
  switch i8 %i.azn, label %parser_magic_comment.exit [
    i8 61, label %.preheader58.i
    i8 58, label %.preheader58.i
  ]

.preheader58.i:                                   ; preds = %bb.kr, %bb.kr
  %i.azt = getelementptr i8, ptr %.3.i9502864, i64 2
  %i.azu = getelementptr i8, ptr %.3.i9502864, i64 3 ; 2 uses
  %.not47.i2863 = icmp ult ptr %i.azu, %i.ayn
  br i1 %.not47.i2863, label %.lr.ph2865, label %parser_magic_comment.exit

bb.ks:                                            ; preds = %bb.ku, %.preheader.i951
  %.4.i = phi ptr [ %i.bab, %bb.ku ], [ %i.azm, %.preheader.i951 ] ; 3 uses
  %i.azv = load i8, ptr %.4.i, align 1, !tbaa !15 ; 2 uses
  switch i8 %i.azv, label %bb.kt [
    i8 45, label %bb.ku
    i8 95, label %bb.ku
  ]
...
bb.kt:                                            ; preds = %bb.ks
  ...
  %i.azx = and i32 %i.azw, -33
  %i.azy = add nsw i32 %i.azx, -91
  %narrow.i.i.i957 = icmp ult i32 %i.azy, -26
  %i.azz = add nsw i32 %i.azw, -58
  %i.baa = icmp ult i32 %i.azz, -10
  %narrow.i54.not.i = select i1 %narrow.i.i.i957, i1 %i.baa, i1 false
  br i1 %narrow.i54.not.i, label %.critedge.i953, label %bb.ku

bb.ku:                                            ; preds = %bb.kt, %bb.ks, %bb.ks
  %i.bab = getelementptr i8, ptr %.4.i, i64 1     ; 2 uses
  %exitcond.not.i952 = icmp eq ptr %i.bab, %scevgep76.i
...
.critedge.i953:                                   ; preds = %bb.ku, %bb.kt
  ...
  %i.bac = ptrtoint ptr %.5.i954 to i64
  %i.bad = ptrtoint ptr %i.azm to i64
  %i.bae = sub i64 %i.bac, %i.bad
  %i.baf = call i64 @parser_encode_length(ptr poison, ptr noundef nonnull %i.azm, i64 noundef %i.bae)
  %i.bag = call i64 @rb_str_new(ptr noundef nonnull %i.azm, i64 noundef %i.baf) #31 ; 2 uses
  store ptr %i.azm, ptr %i.aii, align 8, !tbaa !49
  store ptr %.5.i954, ptr %i.aig, align 8, !tbaa !188
  %i.bah = inttoptr i64 %i.bag to ptr             ; 2 uses
  %i.bai = load i64, ptr %i.bah, align 8, !tbaa !13
  %i.baj = and i64 %i.bai, 8192
  %.not.i.i955 = icmp eq i64 %i.baj, 0
  %i.bak = getelementptr i8, ptr %i.bah, i64 24   ; 2 uses
  br i1 %.not.i.i955, label %RSTRING_PTR.exit.i956, label %bb.kv

bb.kv:                                            ; preds = %.critedge.i953
  %i.bal = load ptr, ptr %i.bak, align 8, !tbaa !15
  br label %RSTRING_PTR.exit.i956

RSTRING_PTR.exit.i956:                            ; preds = %bb.kv, %.critedge.i953
  %i.bam = phi ptr [ %i.bal, %bb.kv ], [ %i.bak, %.critedge.i953 ]
  call fastcc void @parser_set_encode(ptr noundef nonnull %0, ptr noundef %i.bam)
  %i.ban = call i64 @rb_str_resize(i64 noundef %i.bag, i64 noundef 0) #31 ; 0 uses
...
parser_magic_comment.exit:                        ; preds = %.loopexit.i937, %.critedge4.i, %.backedge.i947, %bb.kr, %.preheader58.i, %bb.jb, %bb.jd, %bb.je, %bb.ko, %.preheader58.i.preheader, %.loopexit, %RSTRING_PTR.exit.i956, %bb.kg, %magic_comment_marker.exit.thread.i, %comment_at_top.exit
  store ptr %i.ame, ptr %i.aii, align 8, !tbaa !49
  %i.bao = load ptr, ptr %i.aik, align 8, !tbaa !426
  store ptr %i.bao, ptr %i.aig, align 8, !tbaa !188
...
bb.kw:                                            ; preds = %bb.hw, %nextc0.exit.thread1154, %parser_magic_comment.exit
  ...
  %i.bap = load i32, ptr %i.e, align 8            ; 2 uses
  %i.baq = and i32 %i.bap, -129
  %i.bar = or disjoint i32 %i.baq, %i.aib
  store i32 %i.bar, ptr %i.e, align 8
  %i.bas = load ptr, ptr %i.air, align 8, !tbaa !189 ; 3 uses
  %i.bat = load i32, ptr %i.aij, align 8, !tbaa !67 ; 3 uses
  %i.bau = and i32 %i.bat, 897
  %.not842 = icmp ne i32 %i.bau, 0
  %i.bav = and i32 %i.bat, 2048
  %.not843 = icmp eq i32 %i.bav, 0
  %i.baw = and i1 %.not842, %.not843              ; 2 uses
  %i.bax = and i32 %i.bat, 2064
  %i.bay = icmp eq i32 %i.bax, 2064
  %or.cond1240 = or i1 %i.bay, %i.baw
  br i1 %or.cond1240, label %bb.lb, label %.preheader.preheader

.preheader.preheader:                             ; preds = %bb.kw
  %i.baz = load ptr, ptr %i.aig, align 8, !tbaa !188 ; 2 uses
  %i.bba = load ptr, ptr %i.aik, align 8, !tbaa !426
  %.not.i959.peel = icmp ult ptr %i.baz, %i.bba
  %i.bbb = and i32 %i.bap, 8
  %.not13.i966.peel = icmp eq i32 %i.bbb, 0
...
bb.kx:                                            ; preds = %.preheader.preheader
  %i.bbc = load ptr, ptr %i.ail, align 8, !tbaa !528
  %i.bbd = icmp ugt ptr %i.bbc, inttoptr (i64 1 to ptr)
  br i1 %i.bbd, label %.critedge.i960.peel, label %bb.ky, !prof !205

.critedge.i960.peel:                              ; preds = %bb.kx, %.preheader.preheader
  %i.bbe = call fastcc i32 @nextline(ptr noundef nonnull %0, i32 noundef 1)
  %.not14.i961.peel = icmp eq i32 %i.bbe, 0
...
.critedge._crit_edge.i963.peel:                   ; preds = %.critedge.i960.peel
  %.pre.i964.peel = load ptr, ptr %i.aig, align 8, !tbaa !188
  br label %bb.ky

bb.ky:                                            ; preds = %.critedge._crit_edge.i963.peel, %bb.kx
  %i.bbf = phi ptr [ %.pre.i964.peel, %.critedge._crit_edge.i963.peel ], [ %i.baz, %bb.kx ] ; 2 uses
  %i.bbg = getelementptr i8, ptr %i.bbf, i64 1    ; 7 uses
  store ptr %i.bbg, ptr %i.aig, align 8, !tbaa !188
  %i.bbh = load i8, ptr %i.bbf, align 1, !tbaa !15
  switch i8 %i.bbh, label %.loopexit1289 [
    i8 13, label %bb.kz
...
bb.kz:                                            ; preds = %bb.ky
  %i.bbi = load ptr, ptr %i.aik, align 8, !tbaa !426
  %.not.i.i965.peel = icmp ult ptr %i.bbg, %i.bbi
  br i1 %.not.i.i965.peel, label %bb.la, label %.preheader.preheader3012

bb.la:                                            ; preds = %bb.kz
  %i.bbj = load i8, ptr %i.bbg, align 1, !tbaa !15
  %i.bbk = icmp eq i8 %i.bbj, 10
  br i1 %i.bbk, label %.loopexit1289, label %.preheader.preheader3012
...
bb.ld:                                            ; preds = %bb.lc, %bb.lb
  br i1 %i.baw, label %.backedge, label %bb.le

bb.le:                                            ; preds = %bb.ld
  %i.bbl = load i16, ptr %i.aiw, align 8
  %i.bbm = and i16 %i.bbl, 2
  %.not850 = icmp eq i16 %i.bbm, 0
  br i1 %.not850, label %.backedge, label %.loopexit1297

.preheader:                                       ; preds = %.preheader.backedge, %.preheader.preheader3012
  %i.bbn = phi ptr [ %i.bbg, %.preheader.preheader3012 ], [ %i.bbv, %.preheader.backedge ] ; 2 uses
  %i.bbo = load ptr, ptr %i.aik, align 8, !tbaa !426
  %.not.i959 = icmp ult ptr %i.bbn, %i.bbo
  br i1 %.not.i959, label %bb.lf, label %.critedge.i960, !prof !527

bb.lf:                                            ; preds = %.preheader
  %i.bbp = load i32, ptr %i.e, align 8
  %i.bbq = and i32 %i.bbp, 8
  %.not13.i966 = icmp eq i32 %i.bbq, 0
  br i1 %.not13.i966, label %bb.lg, label %.critedge.i960, !prof !527

bb.lg:                                            ; preds = %bb.lf
  %i.bbr = load ptr, ptr %i.ail, align 8, !tbaa !528
  %i.bbs = icmp ugt ptr %i.bbr, inttoptr (i64 1 to ptr)
  br i1 %i.bbs, label %.critedge.i960, label %bb.lh, !prof !205

.critedge.i960:                                   ; preds = %bb.lg, %bb.lf, %.preheader
  %i.bbt = call fastcc i32 @nextline(ptr noundef nonnull %0, i32 noundef 1)
  %.not14.i961 = icmp eq i32 %i.bbt, 0
  br i1 %.not14.i961, label %.critedge._crit_edge.i963, label %.loopexit1939.thread

.critedge._crit_edge.i963:                        ; preds = %.critedge.i960
  %.pre.i964 = load ptr, ptr %i.aig, align 8, !tbaa !188
  br label %bb.lh

bb.lh:                                            ; preds = %.critedge._crit_edge.i963, %bb.lg
  %i.bbu = phi ptr [ %.pre.i964, %.critedge._crit_edge.i963 ], [ %i.bbn, %bb.lg ] ; 2 uses
  %i.bbv = getelementptr i8, ptr %i.bbu, i64 1    ; 7 uses
  store ptr %i.bbv, ptr %i.aig, align 8, !tbaa !188
  %i.bbw = load i8, ptr %i.bbu, align 1, !tbaa !15
  switch i8 %i.bbw, label %.loopexit1289 [
    i8 13, label %bb.li
