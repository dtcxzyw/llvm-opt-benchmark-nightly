...
bb.sg:                                            ; preds = %bb.sf
  %i.cet = load ptr, ptr %i.j, align 8, !tbaa !49
  %i.ceu = getelementptr i8, ptr %i.cet, i64 -2   ; 3 uses
  %i.cev = load ptr, ptr %i.l, align 8, !tbaa !50
  ...
  br i1 %i.cfb, label %.lr.ph, label %.critedge

.lr.ph:                                           ; preds = %bb.sg, %bb.sh
  %.029683751 = phi ptr [ %i.cfh, %bb.sh ], [ %i.cfa, %bb.sg ] ; 3 uses
...
begin_hunk_2_@parser_yylex:bb.a
  ...
  %i.w = zext i32 %i.v to i64                     ; 12 uses
...
begin_hunk_3_@parser_yylex:bb.a
  ...
  %i.cg = load ptr, ptr %i.cf, align 8, !tbaa !50 ; 7 uses
...
bb.n:                                             ; preds = %bb.l
  ...
  %i.cm = ptrtoint ptr %.val170.i to i64
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  %i.cy = ptrtoint ptr %.0.i.i to i64
...
bb.t:                                             ; preds = %bb.s, %bb.p, %bb.o
  ...
  %3 = sub nsw i64 0, %i.w
  %i.db = getelementptr i8, ptr %.1.i.i, i64 %3   ; 4 uses
...
.lr.ph.i.i:                                       ; preds = %bb.u, %bb.v
  %.0263.i.i = phi ptr [ %i.dj, %bb.v ], [ %i.cg, %bb.u ] ; 3 uses
...
bb.v:                                             ; preds = %.lr.ph.i.i
  %i.dj = getelementptr i8, ptr %.0263.i.i, i64 1 ; 3 uses
  %4 = icmp ult ptr %i.dj, %i.db
  br i1 %4, label %.lr.ph.i.i, label %whole_match_p.exit.i, !llvm.loop !565

whole_match_p.exit.i:                             ; preds = %bb.v, %.lr.ph.i.i, %bb.u
  %.127.i.i = phi ptr [ %i.cg, %bb.u ], [ %.0263.i.i, %.lr.ph.i.i ], [ %i.dj, %bb.v ]
...
bb.ba:                                            ; preds = %bb.az, %bb.ay, %bb.ax, %bb.aw
  %.val167.i = load ptr, ptr %i.cf, align 8, !tbaa !50 ; 6 uses
  %i.ic = ptrtoint ptr %.val168.pre.i to i64
  %i.id = ptrtoint ptr %.val167.i to i64          ; 2 uses
...
bb.bf:                                            ; preds = %bb.be, %bb.bd
  ...
  %i.io = ptrtoint ptr %.0.i214.i to i64
...
bb.bg:                                            ; preds = %bb.bf, %bb.bc, %bb.bb
  ...
  %i.ir = getelementptr i8, ptr %.1.i204.i, i64 %5 ; 4 uses
...
.lr.ph.i211.i:                                    ; preds = %bb.bh, %bb.bi
  %.0263.i212.i = phi ptr [ %i.iz, %bb.bi ], [ %.val167.i, %bb.bh ] ; 3 uses
...
bb.bi:                                            ; preds = %.lr.ph.i211.i
  %i.iz = getelementptr i8, ptr %.0263.i212.i, i64 1 ; 3 uses
  %6 = icmp ult ptr %i.iz, %i.ir
  br i1 %6, label %.lr.ph.i211.i, label %.critedge.i209.i, !llvm.loop !565

.critedge.i209.i:                                 ; preds = %bb.bi, %.lr.ph.i211.i, %bb.bh
  %.127.i210.i = phi ptr [ %.val167.i, %bb.bh ], [ %.0263.i212.i, %.lr.ph.i211.i ], [ %i.iz, %bb.bi ]
...
bb.di:                                            ; preds = %bb.dh, %bb.dg, %bb.df, %bb.de
  %.val.i = load ptr, ptr %i.cf, align 8, !tbaa !50 ; 6 uses
  %i.pv = ptrtoint ptr %.val166.pre.i to i64
  %i.pw = ptrtoint ptr %.val.i to i64             ; 2 uses
...
bb.dn:                                            ; preds = %bb.dm, %bb.dl
  ...
  %i.qh = ptrtoint ptr %.0.i263.i to i64
...
bb.do:                                            ; preds = %bb.dn, %bb.dk, %bb.dj
  ...
  %i.qk = getelementptr i8, ptr %.1.i253.i, i64 %7 ; 4 uses
...
bb.dp:                                            ; preds = %bb.do
  ...
  br i1 %or.cond.i257.i, label %.lr.ph.i260.i, label %.critedge.i258.i

.lr.ph.i260.i:                                    ; preds = %bb.dp, %bb.dq
  %.0263.i261.i = phi ptr [ %i.qs, %bb.dq ], [ %.val.i, %bb.dp ] ; 3 uses
...
bb.dq:                                            ; preds = %.lr.ph.i260.i
  %i.qs = getelementptr i8, ptr %.0263.i261.i, i64 1 ; 3 uses
  %8 = icmp ult ptr %i.qs, %i.qk
  br i1 %8, label %.lr.ph.i260.i, label %.critedge.i258.i, !llvm.loop !565

.critedge.i258.i:                                 ; preds = %bb.dq, %.lr.ph.i260.i, %bb.dp
  %.127.i259.i = phi ptr [ %.val.i, %bb.dp ], [ %.0263.i261.i, %.lr.ph.i260.i ], [ %i.qs, %bb.dq ]
...
bb.kg:                                            ; preds = %comment_at_top.exit
  ...
  %i.ayh = load ptr, ptr %i.aie, align 8, !tbaa !426 ; 5 uses
...
begin_hunk_19_@parser_yylex:bb.a
  ...
  %scevgep76.i = getelementptr i8, ptr %scevgep.i, i64 %i.azm
  br label %bb.ks
...
bb.ku:                                            ; preds = %bb.kt, %bb.ks, %bb.ks
  ...
  %9 = icmp ult ptr %i.azv, %i.ayh
  br i1 %9, label %bb.ks, label %.critedge.i952, !llvm.loop !597
...
bb.i:                                             ; preds = %.lr.ph
  %i.y = getelementptr i8, ptr %.0263, i64 1      ; 3 uses
  %3 = icmp ult ptr %i.y, %i.q
  br i1 %3, label %.lr.ph, label %.critedge, !llvm.loop !565
