...
begin_hunk_0_@ruby_yyparse:bb.a
  ...
  %5 = alloca %union.YYSTYPE, align 8             ; 586 uses
...
begin_hunk_1_@ruby_yyparse:bb.a
  ...
  %i.bvq = call fastcc ptr @rb_node_for_new(ptr noundef nonnull %0, ptr noundef %i.bvn, ptr noundef %i.bvh, ptr noundef %6, ptr noundef %i.bvo, ptr noundef %i.bvp, ptr noundef %14, ptr noundef nonnull %.32950) ; 5 uses
