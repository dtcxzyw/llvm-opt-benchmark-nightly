...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !10  ; 3 uses
...
iter.check:                                       ; preds = %bb.l, %bb.j, %bb.g, %bb.d, %mbc_enc_len.exit
  %.0.i38 = phi i32 [ %i.au, %mbc_enc_len.exit ], [ 3, %bb.j ], [ 2, %bb.g ], [ 1, %bb.d ], [ 4, %bb.l ] ; 7 uses
  %i.aw = zext nneg i32 %.0.i38 to i64            ; 5 uses
  %min.iters.check = icmp samesign ult i32 %.0.i38, 4
...
vector.main.loop.iter.check:                      ; preds = %iter.check
  %min.iters.check47 = icmp samesign ult i32 %.0.i38, 32
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep48 = getelementptr i8, ptr %3, i64 %index ; 2 uses
  %i.bb = getelementptr i8, ptr %next.gep, i64 16
  %wide.load = load <16 x i8>, ptr %next.gep, align 1, !tbaa !10
  %wide.load49 = load <16 x i8>, ptr %i.bb, align 1, !tbaa !10
  %i.bc = getelementptr i8, ptr %next.gep48, i64 16
  store <16 x i8> %wide.load, ptr %next.gep48, align 1, !tbaa !10
  store <16 x i8> %wide.load49, ptr %i.bc, align 1, !tbaa !10
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec53 = and i64 %i.aw, 2147483644            ; 5 uses
  %i.be = trunc nuw nsw i64 %n.vec53 to i32
  %i.bf = getelementptr i8, ptr %i.b, i64 %n.vec53
  %i.bg = getelementptr i8, ptr %3, i64 %n.vec53
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %next.gep56 = getelementptr i8, ptr %3, i64 %index54
  %wide.load57 = load <4 x i8>, ptr %next.gep55, align 1, !tbaa !10
  store <4 x i8> %wide.load57, ptr %next.gep56, align 1, !tbaa !10
  %index.next58 = add nuw i64 %index54, 4         ; 2 uses
  %i.bh = icmp eq i64 %index.next58, %n.vec53
  br i1 %i.bh, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !23

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n59 = icmp eq i64 %n.vec53, %i.aw
  br i1 %cmp.n59, label %._crit_edge.loopexit, label %.lr.ph.preheader
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %exitcond.not.7 = icmp eq i32 %i.cn, %.0.i38
