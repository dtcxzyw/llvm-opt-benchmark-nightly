...
bb.i:                                             ; preds = %.lr.ph400, %RCLASS_EXT_READABLE.exit351
  ...
  %spec.select = zext i1 %i.as to i32
  %i.at = icmp ne i64 %i.aj, %.085399
  %or.cond = or i1 %5, %i.at
...
bb.p:                                             ; preds = %bb.o
  ...
  %spec.select118 = select i1 %i.br, i32 1, i32 %.191389 ; 2 uses
...
bb.ab:                                            ; preds = %RCLASS_EXT_READABLE.exit182
  ...
  %6 = icmp ne i32 %spec.select118, 0
  %or.cond5 = select i1 %i.df, i1 %6, i1 false
...
add_instance_method_list.exit98:                  ; preds = %RCLASS_EXT_READABLE.exit.i80, %bb.ah
  ...
  %or.cond3 = or i1 %6, %or.cond.not29
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local noundef i64 @rb_class_protected_instance_methods(i32 noundef %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local noundef i64 @rb_class_private_instance_methods(i32 noundef %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind sspstrong uwtable
define dso_local noundef i64 @rb_class_public_instance_methods(i32 noundef %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind sspstrong uwtable
define hidden noundef i64 @rb_obj_protected_methods(i32 noundef %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) local_unnamed_addr #0 {
bb.a:
  %i.a = icmp eq i64 %2, 0
  %i.b = and i64 %2, 7
