...
begin_hunk_0_@random_ulong_limited:bb.a
  ...
  %4 = select i1 %i.b, i32 4, i32 8               ; 2 uses
  %5 = shl nsw i64 -1, %narrow                    ; 3 uses
  %6 = xor i64 %5, -1                             ; 2 uses
  %7 = zext nneg i32 %4 to i64                    ; 2 uses
  %8 = shl nuw nsw i32 %4, 3
  %9 = zext nneg i32 %8 to i64
  %i.c = shl nsw i64 -1, %9
  %i.d = xor i64 %i.c, -1
  %i.e = select i1 %i.b, i64 %i.d, i64 -1         ; 2 uses
...
bb.d:                                             ; preds = %.split.us
  ...
  %i.g = call fastcc i64 @obj_random_bytes(i64 noundef %0, ptr noundef nonnull %3, i64 noundef %7) ; 0 uses
...
bb.f:                                             ; preds = %.split
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #23
  %i.o = call fastcc i64 @obj_random_bytes(i64 noundef %0, ptr noundef nonnull %3, i64 noundef %7) ; 0 uses
