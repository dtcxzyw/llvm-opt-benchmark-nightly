...
bb.ax:                                            ; preds = %bb.aw
  %i.ee = trunc i64 %i.dp to i1
  %i.ef = and i64 %i.dp, 254
  %i.eg = icmp eq i64 %i.ef, 12
  %or.cond110 = or i1 %i.eg, %i.ee
  br i1 %or.cond110, label %rb_float_new_inline.exit77, label %rb_type.exit.thread104

rb_type.exit:                                     ; preds = %bb.av
  %i.eh = inttoptr i64 %i.dp to ptr
  %i.ei = load i64, ptr %i.eh, align 8, !tbaa !53
  %i.ej = trunc i64 %i.ei to i32
  %i.ek = and i32 %i.ej, 31
  switch i32 %i.ek, label %rb_float_new_inline.exit77 [
...
bb.ay:                                            ; preds = %rb_type.exit
  %i.el = call i64 @rb_big_plus(i64 noundef %i.dp, i64 noundef %i.dq) #23
  br label %rb_float_new_inline.exit

rb_type.exit.thread104:                           ; preds = %bb.ax, %rb_type.exit
  %i.em = call i64 @rb_check_to_float(i64 noundef %i.dq) #23 ; 6 uses
  %i.en = icmp eq i64 %i.em, 4
  br i1 %i.en, label %rb_type.exit.thread104.rb_float_new_inline.exit77_crit_edge, label %bb.az
...
bb.az:                                            ; preds = %rb_type.exit.thread104
  ...
  br i1 %i.ep, label %bb.ba, label %bb.bc
...
bb.bb:                                            ; preds = %bb.ba
  ...
  %i.eq = add nsw i64 %.neg.i.i69, 2
  %i.er = and i64 %i.dp, -4
  %i.es = or i64 %i.eq, %i.er                     ; 2 uses
  %i.et = call noundef i64 @llvm.fshl.i64(i64 range(i64 1, 0) %i.es, i64 range(i64 1, 0) %i.es, i64 61)
  %i.eu = bitcast i64 %i.et to double
  br label %rb_float_value_inline.exit70

bb.bc:                                            ; preds = %bb.az
  %i.ev = inttoptr i64 %i.dp to ptr
  %i.ew = getelementptr i8, ptr %i.ev, i64 16
  %i.ex = load double, ptr %i.ew, align 8, !tbaa !98
  br label %rb_float_value_inline.exit70

rb_float_value_inline.exit70:                     ; preds = %bb.ba, %bb.bb, %bb.bc
  %.0.i67 = phi double [ %i.ex, %bb.bc ], [ %i.eu, %bb.bb ], [ 0.000000e+00, %bb.ba ]
  %i.ey = and i64 %i.em, 3
  %i.ez = icmp eq i64 %i.ey, 2
  br i1 %i.ez, label %bb.bd, label %bb.bf

bb.bd:                                            ; preds = %rb_float_value_inline.exit70
  %.not.i.i72 = icmp eq i64 %i.em, -9223372036854775806
  br i1 %.not.i.i72, label %rb_float_value_inline.exit74, label %bb.be

bb.be:                                            ; preds = %bb.bd
  %.neg.i.i73 = ashr i64 %i.em, 63
  %i.fa = add nsw i64 %.neg.i.i73, 2
  %i.fb = and i64 %i.em, -4
  %i.fc = or i64 %i.fa, %i.fb                     ; 2 uses
  %i.fd = call noundef i64 @llvm.fshl.i64(i64 range(i64 1, 0) %i.fc, i64 range(i64 1, 0) %i.fc, i64 61)
  %i.fe = bitcast i64 %i.fd to double
  br label %rb_float_value_inline.exit74

bb.bf:                                            ; preds = %rb_float_value_inline.exit70
  %i.ff = inttoptr i64 %i.em to ptr
  %i.fg = getelementptr i8, ptr %i.ff, i64 16
  %i.fh = load double, ptr %i.fg, align 8, !tbaa !98
  br label %rb_float_value_inline.exit74

rb_float_value_inline.exit74:                     ; preds = %bb.bd, %bb.be, %bb.bf
  %.0.i71 = phi double [ %i.fh, %bb.bf ], [ %i.fe, %bb.be ], [ 0.000000e+00, %bb.bd ]
  %i.fi = fadd double %.0.i67, %.0.i71            ; 2 uses
  %i.fj = bitcast double %i.fi to i64             ; 5 uses
  %cond.i75 = icmp eq i64 %i.fj, 3458764513820540928
  br i1 %cond.i75, label %bb.bj, label %bb.bg

bb.bg:                                            ; preds = %rb_float_value_inline.exit74
  %i.fk = lshr i64 %i.fj, 60
  %i.fl = trunc nuw nsw i64 %i.fk to i32
  %i.fm = and i32 %i.fl, 7
  %i.fn = add nsw i32 %i.fm, -5
  %i.fo = icmp ult i32 %i.fn, -2
  br i1 %i.fo, label %bb.bi, label %bb.bh

bb.bh:                                            ; preds = %bb.bg
  %i.fp = call noundef i64 @llvm.fshl.i64(i64 range(i64 3458764513820540929, 3458764513820540928) %i.fj, i64 range(i64 3458764513820540929, 3458764513820540928) %i.fj, i64 3)
  %i.fq = and i64 %i.fp, -4
  %i.fr = or disjoint i64 %i.fq, 2
  br label %rb_float_new_inline.exit

bb.bi:                                            ; preds = %bb.bg
  %i.fs = icmp eq i64 %i.fj, 0
  br i1 %i.fs, label %rb_float_new_inline.exit, label %bb.bj

bb.bj:                                            ; preds = %bb.bi, %rb_float_value_inline.exit74
  %i.ft = call i64 @rb_float_new_in_heap(double noundef %i.fi) #23
  br label %rb_float_new_inline.exit
...
rb_float_new_inline.exit77:                       ; preds = %rb_type.exit.thread104.rb_float_new_inline.exit77_crit_edge, %bb.aw, %bb.aw, %bb.ax, %bb.aw, %rb_type.exit
  %i.fu = phi i64 [ %.pre116, %rb_type.exit.thread104.rb_float_new_inline.exit77_crit_edge ], [ %i.dq, %bb.aw ], [ %i.dq, %bb.aw ], [ %i.dq, %bb.ax ], [ %i.dq, %bb.aw ], [ %i.dq, %rb_type.exit ]
  %i.fv = call i64 @rb_funcallv(i64 noundef %i.fu, i64 noundef 43, i32 noundef 1, ptr noundef nonnull %i.d) #23
  br label %rb_float_new_inline.exit
...
rb_float_new_inline.exit:                         ; preds = %range_values.exit, %bb.bh, %bb.bi, %bb.bj, %bb.aw, %bb.au, %bb.at, %bb.aj, %bb.ak, %bb.al, %range_values.exit.thread83, %rb_type.exit, %rb_float_new_inline.exit77, %bb.ay
  %.3 = phi i64 [ 0, %range_values.exit.thread83 ], [ -9223372036854775806, %bb.ak ], [ %i.fv, %rb_float_new_inline.exit77 ], [ %i.k, %range_values.exit ], [ %i.el, %bb.ay ], [ %i.dp, %bb.aw ], [ %i.dp, %rb_type.exit ], [ %i.cx, %bb.aj ], [ %i.cz, %bb.al ], [ %i.dy, %bb.at ], [ %i.dz, %bb.au ], [ -9223372036854775806, %bb.bi ], [ %i.ft, %bb.bj ], [ %i.fr, %bb.bh ]
