...
begin_hunk_0_@rb_enc_strlen:bb.a
}
...
.lr.ph163.preheader:                              ; preds = %bb.f
  ...
  br i1 %min.iters.check, label %.lr.ph163.preheader310, label %vector.ph
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %.preheader, label %.lr.ph163.preheader310

.lr.ph163.preheader310:                           ; preds = %.lr.ph163.preheader, %middle.block
...
.lr.ph167.preheader:                              ; preds = %.preheader
  %i.al = add i64 %i.u, 8
  %umax = tail call i64 @llvm.umax.i64(i64 %i.w, i64 %i.al)
  %i.am = xor i64 %i.u, -1
  %i.an = add i64 %umax, %i.am                    ; 2 uses
  %i.ao = lshr i64 %i.an, 3
  %i.ap = add nuw nsw i64 %i.ao, 1                ; 2 uses
  %min.iters.check267 = icmp ult i64 %i.an, 24
  br i1 %min.iters.check267, label %.lr.ph167.preheader305, label %vector.ph268

vector.ph268:                                     ; preds = %.lr.ph167.preheader
  %n.vec270 = and i64 %i.ap, 4611686018427387900  ; 3 uses
  %i.aq = shl i64 %n.vec270, 3
  %i.ar = getelementptr i8, ptr %i.v, i64 %i.aq   ; 2 uses
  %i.as = insertelement <2 x i64> <i64 poison, i64 0>, i64 %.080.lcssa, i64 0
...
vector.body271:                                   ; preds = %vector.body271, %vector.ph268
  ...
  %vec.phi273 = phi <2 x i64> [ %i.as, %vector.ph268 ], [ %i.bt, %vector.body271 ]
  %vec.phi274 = phi <2 x i64> [ zeroinitializer, %vector.ph268 ], [ %i.bu, %vector.body271 ]
  %i.at = shl i64 %index272, 3
  %next.gep275 = getelementptr i8, ptr %i.v, i64 %i.at ; 2 uses
  %i.au = getelementptr i8, ptr %next.gep275, i64 16
  %wide.load276 = load <2 x i64>, ptr %next.gep275, align 8, !tbaa !27 ; 2 uses
  %wide.load277 = load <2 x i64>, ptr %i.au, align 8, !tbaa !27 ; 2 uses
  %i.av = lshr <2 x i64> %wide.load276, splat (i64 6)
  %i.aw = lshr <2 x i64> %wide.load277, splat (i64 6)
  %i.ax = xor <2 x i64> %wide.load276, splat (i64 -1)
  %i.ay = xor <2 x i64> %wide.load277, splat (i64 -1)
  %i.az = lshr <2 x i64> %i.ax, splat (i64 7)
  %i.ba = lshr <2 x i64> %i.ay, splat (i64 7)
  %i.bb = or <2 x i64> %i.av, %i.az
  %i.bc = or <2 x i64> %i.aw, %i.ba
  %i.bd = and <2 x i64> %i.bb, splat (i64 72340172838076673) ; 2 uses
  %i.be = and <2 x i64> %i.bc, splat (i64 72340172838076673) ; 2 uses
  %i.bf = lshr <2 x i64> %i.bd, splat (i64 8)
  %i.bg = lshr <2 x i64> %i.be, splat (i64 8)
  %i.bh = add nuw nsw <2 x i64> %i.bf, %i.bd      ; 2 uses
  %i.bi = add nuw nsw <2 x i64> %i.bg, %i.be      ; 2 uses
  %i.bj = lshr <2 x i64> %i.bh, splat (i64 16)
  %i.bk = lshr <2 x i64> %i.bi, splat (i64 16)
  %i.bl = add nuw nsw <2 x i64> %i.bj, %i.bh      ; 2 uses
  %i.bm = add nuw nsw <2 x i64> %i.bk, %i.bi      ; 2 uses
  %i.bn = lshr <2 x i64> %i.bl, splat (i64 32)
  %i.bo = lshr <2 x i64> %i.bm, splat (i64 32)
  %i.bp = add nuw nsw <2 x i64> %i.bn, %i.bl
  %i.bq = add nuw nsw <2 x i64> %i.bo, %i.bm
  %i.br = and <2 x i64> %i.bp, splat (i64 15)
  %i.bs = and <2 x i64> %i.bq, splat (i64 15)
  %i.bt = add <2 x i64> %i.br, %vec.phi273        ; 2 uses
  %i.bu = add <2 x i64> %i.bs, %vec.phi274        ; 2 uses
  %index.next278 = add nuw i64 %index272, 4       ; 2 uses
  %i.bv = icmp eq i64 %index.next278, %n.vec270
  br i1 %i.bv, label %middle.block279, label %vector.body271, !llvm.loop !60

middle.block279:                                  ; preds = %vector.body271
  %bin.rdx280 = add <2 x i64> %i.bu, %i.bt
  %i.bw = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx280) ; 2 uses
  %cmp.n281 = icmp eq i64 %i.ap, %n.vec270
  br i1 %cmp.n281, label %.loopexit130, label %.lr.ph167.preheader305

.lr.ph167.preheader305:                           ; preds = %.lr.ph167.preheader, %middle.block279
  %.079166.ph = phi ptr [ %i.v, %.lr.ph167.preheader ], [ %i.ar, %middle.block279 ]
  %.282165.ph = phi i64 [ %.080.lcssa, %.lr.ph167.preheader ], [ %i.bw, %middle.block279 ]
  br label %.lr.ph167

.lr.ph163:                                        ; preds = %.lr.ph163.preheader310, %.lr.ph163
  %.078162 = phi ptr [ %i.bz, %.lr.ph163 ], [ %.078162.ph, %.lr.ph163.preheader310 ] ; 2 uses
  %.080161 = phi i64 [ %spec.select, %.lr.ph163 ], [ %.080161.ph, %.lr.ph163.preheader310 ]
  %i.bx = load i8, ptr %.078162, align 1, !tbaa !20
  %.not102 = icmp sgt i8 %i.bx, -65
  %i.by = zext i1 %.not102 to i64
  %spec.select = add i64 %.080161, %i.by          ; 2 uses
  %i.bz = getelementptr i8, ptr %.078162, i64 1   ; 2 uses
  %exitcond.not = icmp eq ptr %i.bz, %scevgep
  br i1 %exitcond.not, label %.preheader, label %.lr.ph163, !llvm.loop !61

.lr.ph167:                                        ; preds = %.lr.ph167.preheader305, %.lr.ph167
  %.079166 = phi ptr [ %i.cn, %.lr.ph167 ], [ %.079166.ph, %.lr.ph167.preheader305 ] ; 2 uses
  %.282165 = phi i64 [ %i.cm, %.lr.ph167 ], [ %.282165.ph, %.lr.ph167.preheader305 ]
  %.079.val = load i64, ptr %.079166, align 8, !tbaa !27 ; 2 uses
  %i.ca = lshr i64 %.079.val, 6
  %i.cb = xor i64 %.079.val, -1
  %i.cc = lshr i64 %i.cb, 7
  %i.cd = or i64 %i.ca, %i.cc
  %i.ce = and i64 %i.cd, 72340172838076673        ; 2 uses
  %i.cf = lshr i64 %i.ce, 8
  %i.cg = add nuw nsw i64 %i.cf, %i.ce            ; 2 uses
  ...
  %i.cm = add i64 %i.cl, %.282165                 ; 2 uses
  %i.cn = getelementptr i8, ptr %.079166, i64 8   ; 3 uses
  %i.co = icmp ult ptr %i.cn, %i.x
  br i1 %i.co, label %.lr.ph167, label %.loopexit130, !llvm.loop !62

.loopexit130:                                     ; preds = %.lr.ph167, %middle.block279, %.preheader, %bb.e
  %.383 = phi i64 [ 0, %bb.e ], [ %.080.lcssa, %.preheader ], [ %i.bw, %middle.block279 ], [ %i.cm, %.lr.ph167 ] ; 3 uses
  %.1 = phi ptr [ %0, %bb.e ], [ %i.v, %.preheader ], [ %i.ar, %middle.block279 ], [ %i.cn, %.lr.ph167 ] ; 5 uses
  %i.cp = icmp ult ptr %.1, %1
  br i1 %i.cp, label %.lr.ph172.preheader, label %.loopexit

.lr.ph172.preheader:                              ; preds = %.loopexit130
  %.1284 = ptrtoint ptr %.1 to i64
  %i.cq = sub i64 %i.p, %.1284                    ; 3 uses
  %min.iters.check286 = icmp ult i64 %i.cq, 4
  br i1 %min.iters.check286, label %.lr.ph172.preheader303, label %vector.ph287

vector.ph287:                                     ; preds = %.lr.ph172.preheader
  %n.vec289 = and i64 %i.cq, -4                   ; 3 uses
  %i.cr = getelementptr i8, ptr %.1, i64 %n.vec289
  %i.cs = insertelement <2 x i64> <i64 poison, i64 0>, i64 %.383, i64 0
  br label %vector.body290

vector.body290:                                   ; preds = %vector.body290, %vector.ph287
  %index291 = phi i64 [ 0, %vector.ph287 ], [ %index.next297, %vector.body290 ] ; 2 uses
  %vec.phi292 = phi <2 x i64> [ %i.cs, %vector.ph287 ], [ %i.cy, %vector.body290 ]
  %vec.phi293 = phi <2 x i64> [ zeroinitializer, %vector.ph287 ], [ %i.cz, %vector.body290 ]
  %next.gep294 = getelementptr i8, ptr %.1, i64 %index291 ; 2 uses
  %i.ct = getelementptr i8, ptr %next.gep294, i64 2
  %wide.load295 = load <2 x i8>, ptr %next.gep294, align 1, !tbaa !20
  %wide.load296 = load <2 x i8>, ptr %i.ct, align 1, !tbaa !20
  %i.cu = icmp sgt <2 x i8> %wide.load295, splat (i8 -65)
  %i.cv = icmp sgt <2 x i8> %wide.load296, splat (i8 -65)
  %i.cw = zext <2 x i1> %i.cu to <2 x i64>
  %i.cx = zext <2 x i1> %i.cv to <2 x i64>
  %i.cy = add <2 x i64> %vec.phi292, %i.cw        ; 2 uses
  %i.cz = add <2 x i64> %vec.phi293, %i.cx        ; 2 uses
  %index.next297 = add nuw i64 %index291, 4       ; 2 uses
  %i.da = icmp eq i64 %index.next297, %n.vec289
  br i1 %i.da, label %middle.block298, label %vector.body290, !llvm.loop !63

middle.block298:                                  ; preds = %vector.body290
  %bin.rdx299 = add <2 x i64> %i.cz, %i.cy
  %i.db = tail call i64 @llvm.vector.reduce.add.v2i64(<2 x i64> %bin.rdx299) ; 2 uses
  %cmp.n300 = icmp eq i64 %i.cq, %n.vec289
  br i1 %cmp.n300, label %.loopexit, label %.lr.ph172.preheader303

.lr.ph172.preheader303:                           ; preds = %.lr.ph172.preheader, %middle.block298
  %.2171.ph = phi ptr [ %.1, %.lr.ph172.preheader ], [ %i.cr, %middle.block298 ]
  %.484170.ph = phi i64 [ %.383, %.lr.ph172.preheader ], [ %i.db, %middle.block298 ]
  br label %.lr.ph172

.lr.ph172:                                        ; preds = %.lr.ph172.preheader303, %.lr.ph172
  %.2171 = phi ptr [ %i.de, %.lr.ph172 ], [ %.2171.ph, %.lr.ph172.preheader303 ] ; 2 uses
  %.484170 = phi i64 [ %spec.select103, %.lr.ph172 ], [ %.484170.ph, %.lr.ph172.preheader303 ]
  %i.dc = load i8, ptr %.2171, align 1, !tbaa !20
  %.not101 = icmp sgt i8 %i.dc, -65
  %i.dd = zext i1 %.not101 to i64
  %spec.select103 = add i64 %.484170, %i.dd       ; 2 uses
  %i.de = getelementptr i8, ptr %.2171, i64 1     ; 2 uses
  %exitcond200.not = icmp eq ptr %i.de, %1
...
rb_enc_asciicompat.exit.preheader:                ; preds = %bb.h, %bb.g
  ...
  br i1 %i.df, label %rb_enc_asciicompat.exit, label %.loopexit

bb.h:                                             ; preds = %bb.g
  %i.dg = tail call i32 @rb_enc_dummy_p(ptr noundef nonnull readonly %2) #32
  %.not3.i = icmp eq i32 %i.dg, 0
  br i1 %.not3.i, label %bb.i, label %rb_enc_asciicompat.exit.preheader

bb.i:                                             ; preds = %bb.h
  %i.dh = lshr i32 %3, 1
  %i.di = xor i32 %i.dh, %3
  %i.dj = and i32 %i.di, 1048576
  %.not126 = icmp eq i32 %i.dj, 0
  %i.dk = icmp ult ptr %0, %1                     ; 2 uses
  br i1 %.not126, label %.preheader131, label %.preheader133

.preheader133:                                    ; preds = %bb.i
  br i1 %i.dk, label %.lr.ph155, label %.loopexit

.lr.ph155:                                        ; preds = %.preheader133
  %i.dl = getelementptr i8, ptr %1, i64 -7        ; 4 uses
  %i.dm = ptrtoint ptr %1 to i64                  ; 2 uses
  %i.dn = getelementptr i8, ptr %1, i64 -6        ; 2 uses
  %i.do = getelementptr i8, ptr %1, i64 -5        ; 2 uses
  %i.dp = getelementptr i8, ptr %1, i64 -4        ; 2 uses
  %i.dq = getelementptr i8, ptr %1, i64 -3        ; 2 uses
  %i.dr = getelementptr i8, ptr %1, i64 -2        ; 2 uses
  %i.ds = getelementptr i8, ptr %1, i64 -1        ; 2 uses
  br label %bb.j

.preheader131:                                    ; preds = %bb.i
  br i1 %i.dk, label %.lr.ph159, label %.loopexit

.lr.ph159:                                        ; preds = %.preheader131
  %i.dt = getelementptr i8, ptr %1, i64 -7        ; 4 uses
  %i.du = ptrtoint ptr %1 to i64                  ; 2 uses
  %i.dv = getelementptr i8, ptr %1, i64 -6        ; 2 uses
  %i.dw = getelementptr i8, ptr %1, i64 -5        ; 2 uses
  %i.dx = getelementptr i8, ptr %1, i64 -4        ; 2 uses
  %i.dy = getelementptr i8, ptr %1, i64 -3        ; 2 uses
  %i.dz = getelementptr i8, ptr %1, i64 -2        ; 2 uses
  %i.ea = getelementptr i8, ptr %1, i64 -1        ; 2 uses
  br label %bb.x

bb.j:                                             ; preds = %.lr.ph155, %bb.w
  %.3154 = phi ptr [ %0, %.lr.ph155 ], [ %i.fd, %bb.w ] ; 7 uses
  %.086153 = phi i64 [ 0, %.lr.ph155 ], [ %i.fe, %bb.w ] ; 3 uses
  %i.eb = load i8, ptr %.3154, align 1, !tbaa !20
  %i.ec = icmp slt i8 %i.eb, 0
  br i1 %i.ec, label %bb.w, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.ed = icmp ult ptr %.3154, %i.dl
  br i1 %i.ed, label %.lr.ph.i, label %._crit_edge.i

.lr.ph.i:                                         ; preds = %bb.k, %bb.m
  %.02639.i = phi ptr [ %i.ej, %bb.m ], [ %.3154, %bb.k ] ; 3 uses
  %i.ee = load i64, ptr %.02639.i, align 1
  %i.ef = and i64 %i.ee, -9187201950435737472     ; 2 uses
  %.not35.i = icmp eq i64 %i.ef, 0
  br i1 %.not35.i, label %bb.m, label %bb.l

bb.l:                                             ; preds = %.lr.ph.i
  %i.eg = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 range(i64 1, -9187201950435737471) %i.ef, i1 true)
  %i.eh = lshr i64 %i.eg, 3
  %i.ei = getelementptr i8, ptr %.02639.i, i64 %i.eh
  br label %search_nonascii.exit

bb.m:                                             ; preds = %.lr.ph.i
  %i.ej = getelementptr i8, ptr %.02639.i, i64 8  ; 3 uses
  %i.ek = icmp ult ptr %i.ej, %i.dl
  br i1 %i.ek, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !37

._crit_edge.i:                                    ; preds = %bb.m, %bb.k
  %.026.lcssa.i = phi ptr [ %.3154, %bb.k ], [ %i.ej, %bb.m ]
  %i.el = ptrtoint ptr %.026.lcssa.i to i64
  %i.em = sub i64 %i.dm, %i.el
  switch i64 %i.em, label %bb.n [
    i64 7, label %bb.o
    i64 6, label %bb.p
    i64 5, label %bb.q
    i64 4, label %bb.r
...
search_nonascii.exit:                             ; preds = %bb.l, %bb.o, %bb.p, %bb.q, %bb.r, %bb.s, %bb.t, %bb.u
  %.2.i = phi ptr [ %i.ei, %bb.l ], [ %i.ds, %bb.u ], [ %i.dl, %bb.o ], [ %i.dn, %bb.p ], [ %i.do, %bb.q ], [ %i.dp, %bb.r ], [ %i.dq, %bb.s ], [ %i.dr, %bb.t ] ; 3 uses
...
search_nonascii.exit.thread:                      ; preds = %bb.u, %._crit_edge.i, %search_nonascii.exit
  %i.eu = ptrtoint ptr %.3154 to i64
  %i.ev = add i64 %.086153, %i.dm
  %i.ew = sub i64 %i.ev, %i.eu
  br label %.loopexit

bb.v:                                             ; preds = %search_nonascii.exit
  %i.ex = ptrtoint ptr %.2.i to i64
  %i.ey = ptrtoint ptr %.3154 to i64
end_hunk_0
...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  ...
  %i.ao = getelementptr i8, ptr %.030, i64 8      ; 4 uses
  %i.ap = icmp ult ptr %i.ao, %i.k
  %i.aq = icmp sgt i64 %i.an, 7
  %i.ar = select i1 %i.ap, i1 %i.aq, i1 false
  br i1 %i.ar, label %.preheader, label %.loopexit.loopexit, !llvm.loop !85
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %bb.a
  %.146.pre-phi = phi i64 [ %.pre, %.loopexit.loopexit ], [ %i.c, %bb.a ]
  %.3 = phi i64 [ %i.an, %.loopexit.loopexit ], [ %i.a, %bb.a ] ; 2 uses
  %.1 = phi ptr [ %i.ao, %.loopexit.loopexit ], [ %0, %bb.a ] ; 4 uses
  %i.as = icmp ult ptr %.1, %1
  br i1 %i.as, label %.lr.ph39.preheader, label %._crit_edge

.lr.ph39.preheader:                               ; preds = %.loopexit
  %i.at = sub i64 %i.b, %.146.pre-phi
  %scevgep47 = getelementptr i8, ptr %.1, i64 %i.at ; 2 uses
  br label %.lr.ph39
...
bb.e:                                             ; preds = %bb.d, %.lr.ph39
  ...
  %exitcond48.not = icmp eq ptr %i.ax, %scevgep47
...
.preheader.i:                                     ; preds = %.preheader.i.preheader, %.preheader.i
  ...
  %i.an = getelementptr i8, ptr %.030.i, i64 8    ; 4 uses
  %i.ao = icmp ult ptr %i.an, %i.j
  %i.ap = icmp sgt i64 %i.am, 7
  %i.aq = select i1 %i.ao, i1 %i.ap, i1 false
  br i1 %i.aq, label %.preheader.i, label %.loopexit.loopexit.i, !llvm.loop !85
...
.loopexit.i:                                      ; preds = %.loopexit.loopexit.i, %bb.a
  %.146.pre-phi.i = phi i64 [ %.pre.i, %.loopexit.loopexit.i ], [ %i.b, %bb.a ]
  %.3.i = phi i64 [ %i.am, %.loopexit.loopexit.i ], [ %2, %bb.a ]
  %.1.i = phi ptr [ %i.an, %.loopexit.loopexit.i ], [ %0, %bb.a ] ; 4 uses
  %i.ar = icmp ult ptr %.1.i, %1
  br i1 %i.ar, label %.lr.ph39.preheader.i, label %str_utf8_nth.exit

.lr.ph39.preheader.i:                             ; preds = %.loopexit.i
  %i.as = sub i64 %i.a, %.146.pre-phi.i
  %scevgep47.i = getelementptr i8, ptr %.1.i, i64 %i.as ; 2 uses
  br label %.lr.ph39.i
...
bb.e:                                             ; preds = %bb.d, %.lr.ph39.i
  ...
  %exitcond48.not.i = icmp eq ptr %i.aw, %scevgep47.i
...
.lr.ph80.preheader:                               ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  %.04979.ph113 = ptrtoint ptr %.04979.ph to i64  ; 2 uses
...
bb.d:                                             ; preds = %bb.c
end_hunk_2
begin_hunk_3_@rb_str_scan:bb.a
...
bb.g:                                             ; preds = %bb.f
  %i.aq = tail call fastcc zeroext i1 @single_byte_optimizable(i64 noundef %2)
  br i1 %i.aq, label %.lr.ph41.i, label %.lr.ph.i

.lr.ph41.i:                                       ; preds = %bb.g, %.critedge2.i
  %.02440.i = phi ptr [ %i.aw, %.critedge2.i ], [ %i.r, %bb.g ] ; 3 uses
  %i.ar = load i8, ptr %.02440.i, align 1, !tbaa !20 ; 2 uses
  %i.as = icmp eq i8 %i.ar, 0
  br i1 %i.as, label %.critedge2.i, label %bb.h

bb.h:                                             ; preds = %.lr.ph41.i
  %i.at = zext i8 %i.ar to i64
  %i.au = getelementptr i8, ptr @isspacetable, i64 %i.at
  %i.av = load i8, ptr %i.au, align 1, !tbaa !20
  %.not31.i = icmp eq i8 %i.av, 0
  br i1 %.not31.i, label %.critedge.i, label %.critedge2.i

.critedge2.i:                                     ; preds = %bb.h, %.lr.ph41.i
  %i.aw = getelementptr i8, ptr %.02440.i, i64 1  ; 2 uses
  %exitcond.not.i42 = icmp eq ptr %i.aw, %i.ap
  br i1 %exitcond.not.i42, label %.critedge.i, label %.lr.ph41.i, !llvm.loop !213

.lr.ph.i:                                         ; preds = %bb.g, %bb.i
  %.139.i = phi ptr [ %i.ba, %bb.i ], [ %i.r, %bb.g ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #28
  %i.ax = call i32 @rb_enc_codepoint_len(ptr noundef %.139.i, ptr noundef nonnull %i.ap, ptr noundef nonnull %i.a, ptr noundef %i.m) #28
  switch i32 %i.ax, label %.thread.i [
    i32 0, label %bb.i
    i32 32, label %bb.i
    i32 13, label %bb.i
    i32 12, label %bb.i
...
bb.i:                                             ; preds = %.lr.ph.i, %.lr.ph.i, %.lr.ph.i, %.lr.ph.i, %.lr.ph.i, %.lr.ph.i, %.lr.ph.i
  %i.ay = load i32, ptr %i.a, align 4, !tbaa !7
  %i.az = sext i32 %i.ay to i64
  %i.ba = getelementptr i8, ptr %.139.i, i64 %i.az ; 3 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #28
  %i.bb = icmp ult ptr %i.ba, %i.ap
  br i1 %i.bb, label %.lr.ph.i, label %.critedge.i

.critedge.i:                                      ; preds = %bb.i, %.critedge2.i, %bb.h, %.thread.i
  %.3.i = phi ptr [ %.139.i, %.thread.i ], [ %.02440.i, %bb.h ], [ %i.ap, %.critedge2.i ], [ %i.ba, %bb.i ]
  %i.bc = ptrtoint ptr %.3.i to i64
  %i.bd = sub i64 %i.bc, %3
  br label %lstrip_offset.exit

lstrip_offset.exit:                               ; preds = %bb.f, %.critedge.i
  %.0.i = phi i64 [ %i.bd, %.critedge.i ], [ 0, %bb.f ] ; 2 uses
  %i.be = getelementptr i8, ptr %i.r, i64 %.0.i
  %i.bf = call fastcc i64 @rstrip_offset(i64 noundef %2, ptr noundef %i.be, ptr noundef %i.ap, ptr noundef %i.m)
  br label %bb.j
...
bb.j:                                             ; preds = %lstrip_offset.exit, %tr_setup_table_multi.exit
  ...
  %.038 = phi i64 [ %i.ao, %tr_setup_table_multi.exit ], [ %i.bf, %lstrip_offset.exit ] ; 2 uses
  %i.bg = icmp slt i64 %.039, 1
  %i.bh = icmp slt i64 %.038, 1
  %or.cond = select i1 %i.bg, i1 %i.bh, i1 false
  br i1 %or.cond, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.bi = load i64, ptr @rb_cString, align 8, !tbaa !27
  %i.bj = call fastcc i64 @str_duplicate(i64 noundef %i.bi, i64 noundef %2)
  br label %bb.m

bb.l:                                             ; preds = %bb.j
  %i.bk = add i64 %.039, %.038
  %i.bl = sub i64 %i.t, %i.bk
  %i.bm = call fastcc i64 @str_subseq(i64 noundef %2, i64 noundef %.039, i64 noundef %i.bl) ; 2 uses
  call fastcc void @rb_enc_cr_str_copy_for_substr(i64 noundef %i.bm, i64 noundef %2)
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k
  %.0 = phi i64 [ %i.bj, %bb.k ], [ %i.bm, %bb.l ]
  ret i64 %.0
}
...
bb.g:                                             ; preds = %bb.f
  %i.as = tail call i32 @rb_enc_get_index(i64 noundef %2) #28
  br label %get_encoding.exit25

get_encoding.exit25:                              ; preds = %bb.f, %bb.g
  %.0.i.i24 = phi i32 [ %i.as, %bb.g ], [ %i.aq, %bb.f ]
  %i.at = tail call ptr @rb_enc_from_index(i32 noundef %.0.i.i24) #28
  %3 = ptrtoint ptr %i.k to i64
  %.not.i26 = icmp ne ptr %i.k, null
  %.not28.i = icmp ult ptr %i.k, %i.an
  %or.cond.i = and i1 %.not.i26, %.not28.i
  br i1 %or.cond.i, label %bb.h, label %lstrip_offset.exit.thread

bb.h:                                             ; preds = %get_encoding.exit25
  %i.au = tail call fastcc zeroext i1 @single_byte_optimizable(i64 noundef %2)
  br i1 %i.au, label %.lr.ph41.i, label %.lr.ph.i

.lr.ph41.i:                                       ; preds = %bb.h, %.critedge2.i
  %.02440.i = phi ptr [ %i.ba, %.critedge2.i ], [ %i.k, %bb.h ] ; 3 uses
  %i.av = load i8, ptr %.02440.i, align 1, !tbaa !20 ; 2 uses
  %i.aw = icmp eq i8 %i.av, 0
  br i1 %i.aw, label %.critedge2.i, label %bb.i

bb.i:                                             ; preds = %.lr.ph41.i
  %i.ax = zext i8 %i.av to i64
  %i.ay = getelementptr i8, ptr @isspacetable, i64 %i.ax
  %i.az = load i8, ptr %i.ay, align 1, !tbaa !20
  %.not31.i = icmp eq i8 %i.az, 0
  br i1 %.not31.i, label %.critedge.i, label %.critedge2.i

.critedge2.i:                                     ; preds = %bb.i, %.lr.ph41.i
  %i.ba = getelementptr i8, ptr %.02440.i, i64 1  ; 2 uses
  %exitcond.not.i27 = icmp eq ptr %i.ba, %i.an
  br i1 %exitcond.not.i27, label %.critedge.i, label %.lr.ph41.i, !llvm.loop !213

.lr.ph.i:                                         ; preds = %bb.h, %bb.j
  %.139.i = phi ptr [ %i.be, %bb.j ], [ %i.k, %bb.h ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #28
  %i.bb = call i32 @rb_enc_codepoint_len(ptr noundef %.139.i, ptr noundef nonnull %i.an, ptr noundef nonnull %i.a, ptr noundef %i.at) #28
  switch i32 %i.bb, label %.thread.i [
    i32 0, label %bb.j
    i32 32, label %bb.j
    i32 13, label %bb.j
    i32 12, label %bb.j
...
bb.j:                                             ; preds = %.lr.ph.i, %.lr.ph.i, %.lr.ph.i, %.lr.ph.i, %.lr.ph.i, %.lr.ph.i, %.lr.ph.i
  %i.bc = load i32, ptr %i.a, align 4, !tbaa !7
  %i.bd = sext i32 %i.bc to i64
  %i.be = getelementptr i8, ptr %.139.i, i64 %i.bd ; 3 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #28
  %i.bf = icmp ult ptr %i.be, %i.an
  br i1 %i.bf, label %.lr.ph.i, label %.critedge.i

.critedge.i:                                      ; preds = %bb.j, %.critedge2.i, %bb.i, %.thread.i
  %.3.i = phi ptr [ %.139.i, %.thread.i ], [ %.02440.i, %bb.i ], [ %i.an, %.critedge2.i ], [ %i.be, %bb.j ]
  %i.bg = ptrtoint ptr %.3.i to i64
  %i.bh = sub i64 %i.bg, %3
  br label %lstrip_offset.exit

lstrip_offset.exit:                               ; preds = %.critedge.i, %get_encoding.exit
  %.0 = phi i64 [ %i.am, %get_encoding.exit ], [ %i.bh, %.critedge.i ] ; 3 uses
  %i.bi = icmp slt i64 %.0, 1
  br i1 %i.bi, label %lstrip_offset.exit.thread, label %bb.k

lstrip_offset.exit.thread:                        ; preds = %get_encoding.exit25, %lstrip_offset.exit
  %i.bj = load i64, ptr @rb_cString, align 8, !tbaa !27
  %i.bk = call fastcc i64 @str_duplicate(i64 noundef %i.bj, i64 noundef %2)
  br label %bb.l

bb.k:                                             ; preds = %lstrip_offset.exit
  %i.bl = sub i64 %i.m, %.0
  %i.bm = call fastcc i64 @str_subseq(i64 noundef %2, i64 noundef %.0, i64 noundef %i.bl) ; 2 uses
  call fastcc void @rb_enc_cr_str_copy_for_substr(i64 noundef %i.bm, i64 noundef %2)
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %lstrip_offset.exit.thread
  %.022 = phi i64 [ %i.bk, %lstrip_offset.exit.thread ], [ %i.bm, %bb.k ]
  ret i64 %.022
}

; Function Attrs: nounwind sspstrong uwtable
define internal i64 @rb_str_rstrip(i32 noundef %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) #1 {
bb.a:
  %i.a = alloca i64, align 8                      ; 5 uses
  %i.b = alloca [257 x i8], align 16              ; 4 uses
  ...
  br i1 %i.j, label %bb.b, label %get_encoding.exit

bb.b:                                             ; preds = %bb.a
  %i.k = tail call i32 @rb_enc_get_index(i64 noundef %2) #28
  br label %get_encoding.exit

get_encoding.exit:                                ; preds = %bb.a, %bb.b
  %.0.i.i = phi i32 [ %i.k, %bb.b ], [ %i.i, %bb.a ]
  %i.l = tail call ptr @rb_enc_from_index(i32 noundef %.0.i.i) #28 ; 2 uses
...
RSTRING_PTR.exit:                                 ; preds = %get_encoding.exit, %bb.c
  %i.q = phi ptr [ %i.p, %bb.c ], [ %i.o, %get_encoding.exit ] ; 4 uses
...
bb.e:                                             ; preds = %rb_string_value.exit.i, %bb.d
  %indvars.iv.i = phi i64 [ 0, %bb.d ], [ %indvars.iv.next.i, %rb_string_value.exit.i ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a)
  %i.u = getelementptr [8 x i8], ptr %1, i64 %indvars.iv.i
  %i.v = load i64, ptr %i.u, align 8, !tbaa !27
  store i64 %i.v, ptr %i.a, align 8, !tbaa !27
  %.0..0..0..0..0..i = load volatile i64, ptr %i.a, align 8, !tbaa !27 ; 5 uses
  %i.w = icmp eq i64 %.0..0..0..0..0..i, 0
  %i.x = and i64 %.0..0..0..0..0..i, 7
  %i.y = icmp ne i64 %i.x, 0
  %i.z = or i1 %i.w, %i.y
  br i1 %i.z, label %rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i, label %rbimpl_RB_TYPE_P_fastpath.exit.i.i

rbimpl_RB_TYPE_P_fastpath.exit.i.i:               ; preds = %bb.e
  %i.aa = inttoptr i64 %.0..0..0..0..0..i to ptr
  %i.ab = load i64, ptr %i.aa, align 8, !tbaa !11
  %i.ac = and i64 %i.ab, 31
  %i.ad = icmp eq i64 %i.ac, 5
  br i1 %i.ad, label %rb_string_value.exit.i, label %rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i

rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i:        ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.i.i, %bb.e
  %i.ae = tail call i64 @rb_convert_type_with_id(i64 noundef %.0..0..0..0..0..i, i32 noundef 5, ptr noundef nonnull @.str.4, i64 noundef 3281) #28 ; 2 uses
  store volatile i64 %i.ae, ptr %i.a, align 8, !tbaa !27
  br label %rb_string_value.exit.i

rb_string_value.exit.i:                           ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i, %rbimpl_RB_TYPE_P_fastpath.exit.i.i
  %.0..0.10.i = phi i64 [ %.0..0..0..0..0..i, %rbimpl_RB_TYPE_P_fastpath.exit.i.i ], [ %i.ae, %rbimpl_RB_TYPE_P_fastpath.exit.thread.i.i ] ; 2 uses
  %i.af = tail call ptr @rb_enc_check(i64 noundef %2, i64 noundef %.0..0.10.i) #28
  %i.ag = icmp eq i64 %indvars.iv.i, 0
  %i.ah = zext i1 %i.ag to i32
  call fastcc void @tr_setup_table(i64 noundef %.0..0.10.i, ptr noundef nonnull %i.b, i32 noundef %i.ah, ptr noundef nonnull %i.c, ptr noundef nonnull %i.d, ptr noundef %i.af)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a)
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %tr_setup_table_multi.exit, label %bb.e, !llvm.loop !212
...
tr_setup_table_multi.exit:                        ; preds = %rb_string_value.exit.i
  %i.ai = getelementptr i8, ptr %i.q, i64 %i.s
  %i.aj = load i64, ptr %i.c, align 8, !tbaa !27
  %i.ak = load i64, ptr %i.d, align 8, !tbaa !27
  %i.al = call fastcc i64 @rstrip_offset_table(i64 noundef %2, ptr noundef %i.q, ptr noundef %i.ai, ptr noundef %i.l, ptr noundef %i.b, i64 noundef %i.aj, i64 noundef %i.ak)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #28
...
bb.f:                                             ; preds = %RSTRING_PTR.exit
  %i.am = getelementptr i8, ptr %i.q, i64 %i.s
  %i.an = tail call fastcc i64 @rstrip_offset(i64 noundef %2, ptr noundef %i.q, ptr noundef %i.am, ptr noundef %i.l)
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %tr_setup_table_multi.exit
  %.0 = phi i64 [ %i.al, %tr_setup_table_multi.exit ], [ %i.an, %bb.f ] ; 2 uses
  %i.ao = icmp slt i64 %.0, 1
  br i1 %i.ao, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %i.ap = load i64, ptr @rb_cString, align 8, !tbaa !27
  %i.aq = tail call fastcc i64 @str_duplicate(i64 noundef %i.ap, i64 noundef %2)
  br label %bb.j

bb.i:                                             ; preds = %bb.g
  %i.ar = sub i64 %i.s, %.0
  %i.as = tail call fastcc i64 @str_subseq(i64 noundef %2, i64 noundef 0, i64 noundef %i.ar) ; 2 uses
  tail call fastcc void @rb_enc_cr_str_copy_for_substr(i64 noundef %i.as, i64 noundef %2)
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h
  %.022 = phi i64 [ %i.aq, %bb.h ], [ %i.as, %bb.i ]
  ret i64 %.022
}

; Function Attrs: nounwind sspstrong uwtable
define internal i64 @rb_str_delete_prefix(i64 noundef %0, i64 noundef %1) #1 {
bb.a:
  %i.a = tail call fastcc i64 @deleted_prefix_length(i64 noundef %0, i64 noundef %1) ; 3 uses
  %i.b = icmp eq i64 %i.a, 0
  br i1 %i.b, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.c = load i64, ptr @rb_cString, align 8, !tbaa !27
  %i.d = tail call fastcc i64 @str_duplicate(i64 noundef %i.c, i64 noundef %0)
  br label %bb.d
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.g = load i64, ptr %i.f, align 8, !tbaa !14
  %i.h = sub i64 %i.g, %i.a
  %i.i = tail call fastcc i64 @str_subseq(i64 noundef %0, i64 noundef %i.a, i64 noundef %i.h) ; 2 uses
  tail call fastcc void @rb_enc_cr_str_copy_for_substr(i64 noundef %i.i, i64 noundef %0)
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %.0 = phi i64 [ %i.d, %bb.b ], [ %i.i, %bb.c ]
  ret i64 %.0
}

; Function Attrs: nounwind sspstrong uwtable
define internal i64 @rb_str_delete_suffix(i64 noundef %0, i64 noundef %1) #1 {
bb.a:
  %i.a = tail call fastcc i64 @deleted_suffix_length(i64 noundef %0, i64 noundef %1) ; 2 uses
  %i.b = icmp eq i64 %i.a, 0
  br i1 %i.b, label %bb.b, label %bb.c
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.g = load i64, ptr %i.f, align 8, !tbaa !14
  %i.h = sub i64 %i.g, %i.a
  %i.i = tail call fastcc i64 @str_subseq(i64 noundef %0, i64 noundef 0, i64 noundef %i.h) ; 2 uses
  tail call fastcc void @rb_enc_cr_str_copy_for_substr(i64 noundef %i.i, i64 noundef %0)
  br label %bb.d
...
; Function Attrs: nounwind sspstrong uwtable
define internal noundef i64 @rb_str_sub_bang(i32 noundef %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) #1 {
bb.a:
  %i.a = alloca i64, align 8                      ; 5 uses
  %i.b = alloca i64, align 8                      ; 4 uses
end_hunk_3
begin_hunk_4_@rb_str_chop_bang:bb.a
...
.critedge2.i:                                     ; preds = %bb.h, %.lr.ph41.i
  %i.aw = getelementptr i8, ptr %.02440.i, i64 1  ; 2 uses
  %exitcond.not.i58 = icmp eq ptr %i.aw, %i.ap
...
bb.j:                                             ; preds = %lstrip_offset.exit, %tr_setup_table_multi.exit
  %.054 = phi i64 [ %i.ao, %tr_setup_table_multi.exit ], [ %i.bf, %lstrip_offset.exit ] ; 2 uses
  %.052 = phi i64 [ %i.am, %tr_setup_table_multi.exit ], [ %.0.i, %lstrip_offset.exit ] ; 3 uses
  %i.bg = icmp sgt i64 %.052, 0                   ; 2 uses
  %i.bh = icmp sgt i64 %.054, 0
  %or.cond = select i1 %i.bg, i1 true, i1 %i.bh
  br i1 %or.cond, label %bb.k, label %bb.o

bb.k:                                             ; preds = %bb.j
  %i.bi = sub i64 %i.t, %.054                     ; 2 uses
  br i1 %i.bg, label %bb.l, label %bb.m

bb.l:                                             ; preds = %bb.k
  %i.bj = sub i64 %i.bi, %.052                    ; 2 uses
  %i.bk = getelementptr i8, ptr %i.r, i64 %.052
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 %i.r, ptr noundef nonnull align 1 %i.bk, i64 noundef %i.bj, i1 noundef false) #28
  br label %bb.m

bb.m:                                             ; preds = %bb.k, %bb.l
  %.053 = phi i64 [ %i.bj, %bb.l ], [ %i.bi, %bb.k ] ; 2 uses
  store i64 %.053, ptr %i.s, align 8, !tbaa !14
  %i.bl = getelementptr i8, ptr %i.r, i64 %.053   ; 2 uses
  %i.bm = getelementptr i8, ptr %i.m, i64 20
  %.val = load i32, ptr %i.bm, align 4, !tbaa !16 ; 2 uses
  store i8 0, ptr %i.bl, align 1, !tbaa !20
  %i.bn = icmp sgt i32 %.val, 1
  br i1 %i.bn, label %bb.n, label %bb.o, !prof !34

bb.n:                                             ; preds = %bb.m
  %i.bo = zext nneg i32 %.val to i64
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 %i.bl, i8 noundef 0, i64 noundef %i.bo, i1 noundef false) #28
  br label %bb.o
...
tr_setup_table_multi.exit:                        ; preds = %rb_string_value.exit.i
  ...
  %i.ak = load i64, ptr %i.d, align 8, !tbaa !27
  %i.al = load i64, ptr %i.e, align 8, !tbaa !27
  %i.am = call fastcc i64 @lstrip_offset_table(ptr noundef %i.r, ptr noundef %i.aj, ptr noundef %i.m, ptr noundef %i.c, i64 noundef %i.ak, i64 noundef %i.al)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #28
  br label %lstrip_offset.exit
...
bb.f:                                             ; preds = %RSTRING_PTR.exit
  %i.an = getelementptr i8, ptr %i.r, i64 %i.t    ; 5 uses
  %3 = ptrtoint ptr %i.r to i64
  %.not.i39 = icmp ne ptr %i.r, null
  %.not28.i = icmp ult ptr %i.r, %i.an
  %or.cond.i = and i1 %.not.i39, %.not28.i
  br i1 %or.cond.i, label %bb.g, label %lstrip_offset.exit.thread

bb.g:                                             ; preds = %bb.f
  %i.ao = tail call fastcc zeroext i1 @single_byte_optimizable(i64 noundef %2)
  br i1 %i.ao, label %.lr.ph41.i, label %.lr.ph.i

.lr.ph41.i:                                       ; preds = %bb.g, %.critedge2.i
  %.02440.i = phi ptr [ %i.au, %.critedge2.i ], [ %i.r, %bb.g ] ; 3 uses
  %i.ap = load i8, ptr %.02440.i, align 1, !tbaa !20 ; 2 uses
  %i.aq = icmp eq i8 %i.ap, 0
  br i1 %i.aq, label %.critedge2.i, label %bb.h

bb.h:                                             ; preds = %.lr.ph41.i
  %i.ar = zext i8 %i.ap to i64
  %i.as = getelementptr i8, ptr @isspacetable, i64 %i.ar
  %i.at = load i8, ptr %i.as, align 1, !tbaa !20
  %.not31.i = icmp eq i8 %i.at, 0
  br i1 %.not31.i, label %.critedge.i, label %.critedge2.i

.critedge2.i:                                     ; preds = %bb.h, %.lr.ph41.i
  %i.au = getelementptr i8, ptr %.02440.i, i64 1  ; 2 uses
  %exitcond.not.i40 = icmp eq ptr %i.au, %i.an
  br i1 %exitcond.not.i40, label %.critedge.i, label %.lr.ph41.i, !llvm.loop !213

.lr.ph.i:                                         ; preds = %bb.g, %bb.i
  %.139.i = phi ptr [ %i.ay, %bb.i ], [ %i.r, %bb.g ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #28
  %i.av = call i32 @rb_enc_codepoint_len(ptr noundef %.139.i, ptr noundef nonnull %i.an, ptr noundef nonnull %i.a, ptr noundef %i.m) #28
  switch i32 %i.av, label %.thread.i [
    i32 0, label %bb.i
    i32 32, label %bb.i
    i32 13, label %bb.i
    i32 12, label %bb.i
...
bb.i:                                             ; preds = %.lr.ph.i, %.lr.ph.i, %.lr.ph.i, %.lr.ph.i, %.lr.ph.i, %.lr.ph.i, %.lr.ph.i
  %i.aw = load i32, ptr %i.a, align 4, !tbaa !7
  %i.ax = sext i32 %i.aw to i64
  %i.ay = getelementptr i8, ptr %.139.i, i64 %i.ax ; 3 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #28
  %i.az = icmp ult ptr %i.ay, %i.an
  br i1 %i.az, label %.lr.ph.i, label %.critedge.i

.critedge.i:                                      ; preds = %bb.i, %.critedge2.i, %bb.h, %.thread.i
  %.3.i = phi ptr [ %.139.i, %.thread.i ], [ %.02440.i, %bb.h ], [ %i.an, %.critedge2.i ], [ %i.ay, %bb.i ]
  %i.ba = ptrtoint ptr %.3.i to i64
  %i.bb = sub i64 %i.ba, %3
  br label %lstrip_offset.exit

lstrip_offset.exit:                               ; preds = %.critedge.i, %tr_setup_table_multi.exit
  %.036 = phi i64 [ %i.am, %tr_setup_table_multi.exit ], [ %i.bb, %.critedge.i ] ; 3 uses
  %i.bc = icmp sgt i64 %.036, 0
  br i1 %i.bc, label %bb.j, label %lstrip_offset.exit.thread

bb.j:                                             ; preds = %lstrip_offset.exit
  %i.bd = sub i64 %i.t, %.036                     ; 3 uses
  %i.be = getelementptr i8, ptr %i.r, i64 %.036
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 1 %i.r, ptr noundef nonnull align 1 %i.be, i64 noundef %i.bd, i1 noundef false) #28
  store i64 %i.bd, ptr %i.s, align 8, !tbaa !14
  %i.bf = getelementptr i8, ptr %i.r, i64 %i.bd   ; 2 uses
  %i.bg = getelementptr i8, ptr %i.m, i64 20
  %.val = load i32, ptr %i.bg, align 4, !tbaa !16 ; 2 uses
  store i8 0, ptr %i.bf, align 1, !tbaa !20
  %i.bh = icmp sgt i32 %.val, 1
  br i1 %i.bh, label %bb.k, label %lstrip_offset.exit.thread, !prof !34

bb.k:                                             ; preds = %bb.j
  %i.bi = zext nneg i32 %.val to i64
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 %i.bf, i8 noundef 0, i64 noundef %i.bi, i1 noundef false) #28
  br label %lstrip_offset.exit.thread

lstrip_offset.exit.thread:                        ; preds = %bb.f, %lstrip_offset.exit, %bb.j, %bb.k
  %.0 = phi i64 [ %2, %bb.j ], [ %2, %bb.k ], [ 4, %lstrip_offset.exit ], [ 4, %bb.f ]
  ret i64 %.0
}

; Function Attrs: nounwind sspstrong uwtable
define internal noundef i64 @rb_str_rstrip_bang(i32 noundef %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) #1 {
bb.a:
  %i.a = alloca i64, align 8                      ; 5 uses
  %i.b = alloca [257 x i8], align 16              ; 4 uses
  %i.c = alloca i64, align 8                      ; 5 uses
...
get_encoding.exit:                                ; preds = %bb.a, %bb.b
  %.0.i.i = phi i32 [ %i.k, %bb.b ], [ %i.i, %bb.a ]
  %i.l = tail call ptr @rb_enc_from_index(i32 noundef %.0.i.i) #28 ; 3 uses
  %i.m = load i64, ptr %i.e, align 8, !tbaa !11
  %i.n = and i64 %i.m, 8192
  %.not.i = icmp eq i64 %i.n, 0
  %i.o = getelementptr i8, ptr %i.e, i64 24       ; 2 uses
...
RSTRING_PTR.exit:                                 ; preds = %get_encoding.exit, %bb.c
  %i.q = phi ptr [ %i.p, %bb.c ], [ %i.o, %get_encoding.exit ] ; 5 uses
...
bb.g:                                             ; preds = %bb.f, %tr_setup_table_multi.exit
  %.031 = phi i64 [ %i.al, %tr_setup_table_multi.exit ], [ %i.an, %bb.f ] ; 2 uses
  %i.ao = icmp sgt i64 %.031, 0
  br i1 %i.ao, label %bb.h, label %bb.j

bb.h:                                             ; preds = %bb.g
  %i.ap = sub i64 %i.s, %.031                     ; 2 uses
  store i64 %i.ap, ptr %i.r, align 8, !tbaa !14
  %i.aq = getelementptr i8, ptr %i.q, i64 %i.ap   ; 2 uses
  %i.ar = getelementptr i8, ptr %i.l, i64 20
  %.val = load i32, ptr %i.ar, align 4, !tbaa !16 ; 2 uses
  store i8 0, ptr %i.aq, align 1, !tbaa !20
  %i.as = icmp sgt i32 %.val, 1
  br i1 %i.as, label %bb.i, label %bb.j, !prof !34

bb.i:                                             ; preds = %bb.h
  %i.at = zext nneg i32 %.val to i64
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 %i.aq, i8 noundef 0, i64 noundef %i.at, i1 noundef false) #28
  br label %bb.j

bb.j:                                             ; preds = %bb.g, %bb.h, %bb.i
  %.0 = phi i64 [ %2, %bb.h ], [ %2, %bb.i ], [ 4, %bb.g ]
  ret i64 %.0
}
...
bb.a:
  tail call fastcc void @str_modify_keep_cr(i64 noundef %0)
  %i.a = tail call fastcc i64 @deleted_prefix_length(i64 noundef %0, i64 noundef %1) ; 2 uses
  %i.b = icmp eq i64 %i.a, 0
  br i1 %i.b, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.c = tail call i64 @rb_str_drop_bytes(i64 noundef %0, i64 noundef %i.a) ; 0 uses
  br label %bb.c

bb.c:                                             ; preds = %bb.a, %bb.b
  %.0 = phi i64 [ %0, %bb.b ], [ 4, %bb.a ]
  ret i64 %.0
}
...
end_hunk_4
begin_hunk_5_@rb_str_delete_suffix_bang:bb.a
...
end_hunk_5
begin_hunk_6_@rb_str_delete_bang:bb.a
...
RSTRING_PTR.exit:                                 ; preds = %.loopexit131, %bb.f
  ...
  %3 = ptrtoint ptr %i.al to i64                  ; 3 uses
...
RSTRING_END.exit:                                 ; preds = %bb.h, %bb.i
  ...
  %4 = ptrtoint ptr %i.aq to i64                  ; 3 uses
...
end_hunk_6
begin_hunk_7_@rstrip_offset_table:bb.a
  %i.e = load i64, ptr %i.d, align 8, !tbaa !11
...
bb.a:
  ...
  %i.a = tail call i32 @rb_enc_dummy_p(ptr noundef readonly %3) #32
  %.not.i = icmp eq i32 %i.a, 0
  br i1 %.not.i, label %rb_str_check_dummy_enc.exit, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.b = load i64, ptr @rb_eEncCompatError, align 8, !tbaa !27
  %i.c = getelementptr i8, ptr %3, i64 8
  %.val.i = load ptr, ptr %i.c, align 8, !tbaa !42
  tail call void (i64, ptr, ...) @rb_raise(i64 noundef %i.b, ptr noundef nonnull @.str.246, ptr noundef %.val.i) #30
  unreachable
...
bb.h:                                             ; preds = %bb.g
  %i.ac = tail call fastcc zeroext i1 @single_byte_optimizable(i64 noundef %0)
  br i1 %i.ac, label %.lr.ph50.preheader, label %.preheader43

.preheader43:                                     ; preds = %bb.h
  %i.ad = tail call ptr @onigenc_get_prev_char_head(ptr noundef %3, ptr noundef nonnull %1, ptr noundef nonnull %2, ptr noundef nonnull %2) #28 ; 2 uses
  %.not3545 = icmp eq ptr %i.ad, null
  br i1 %.not3545, label %.critedge, label %.lr.ph

.lr.ph50.preheader:                               ; preds = %bb.h
  %i.ae = sub i64 %5, %4
  %scevgep = getelementptr i8, ptr %2, i64 %i.ae
  br label %.lr.ph50

.lr.ph50:                                         ; preds = %.lr.ph50.preheader, %.critedge2
  %.02849 = phi ptr [ %i.af, %.critedge2 ], [ %2, %.lr.ph50.preheader ] ; 2 uses
  %i.af = getelementptr i8, ptr %.02849, i64 -1   ; 3 uses
  %i.ag = load i8, ptr %i.af, align 1, !tbaa !20  ; 2 uses
  %i.ah = icmp eq i8 %i.ag, 0
  br i1 %i.ah, label %.critedge2, label %bb.i

bb.i:                                             ; preds = %.lr.ph50
  %i.ai = zext i8 %i.ag to i64
  %i.aj = getelementptr i8, ptr @isspacetable, i64 %i.ai
  %i.ak = load i8, ptr %i.aj, align 1, !tbaa !20
  %.not38 = icmp eq i8 %i.ak, 0
  br i1 %.not38, label %.critedge, label %.critedge2

.critedge2:                                       ; preds = %.lr.ph50, %bb.i
  %i.al = icmp ult ptr %1, %i.af
  br i1 %i.al, label %.lr.ph50, label %.critedge, !llvm.loop !264

.lr.ph:                                           ; preds = %.preheader43, %bb.j
  %i.am = phi ptr [ %i.ao, %bb.j ], [ %i.ad, %.preheader43 ] ; 4 uses
  %.146 = phi ptr [ %i.am, %bb.j ], [ %2, %.preheader43 ]
  %i.an = tail call i32 @rb_enc_codepoint_len(ptr noundef nonnull %i.am, ptr noundef nonnull %2, ptr noundef null, ptr noundef %3) #28
...
bb.j:                                             ; preds = %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph
  %i.ao = tail call ptr @onigenc_get_prev_char_head(ptr noundef %3, ptr noundef nonnull %1, ptr noundef nonnull %i.am, ptr noundef nonnull %2) #28 ; 2 uses
  %.not35 = icmp eq ptr %i.ao, null
  br i1 %.not35, label %.critedge, label %.lr.ph

.critedge:                                        ; preds = %bb.j, %.lr.ph, %.critedge2, %bb.i, %.preheader43
  %.4 = phi ptr [ %2, %.preheader43 ], [ %.02849, %bb.i ], [ %scevgep, %.critedge2 ], [ %i.am, %bb.j ], [ %.146, %.lr.ph ]
  %i.ap = ptrtoint ptr %.4 to i64
  %i.aq = sub i64 %4, %i.ap
  br label %bb.k

bb.k:                                             ; preds = %bb.g, %.critedge
  %.0 = phi i64 [ %i.aq, %.critedge ], [ 0, %bb.g ]
  ret i64 %.0
}
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %or.cond, label %.preheader84, label %bb.g
...
.preheader84:                                     ; preds = %bb.f, %bb.g, %.preheader85.preheader
  %i.ab = trunc nuw nsw i32 %.055 to i8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(256) %i.a, i8 %i.ab, i64 256, i1 false), !tbaa !20
  %i.ac = call fastcc i32 @trnext(ptr noundef %6, ptr noundef %5) ; 2 uses
  %.not6488 = icmp eq i32 %i.ac, -1
  br i1 %.not6488, label %vector.body, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader84
  %i.ad = getelementptr i8, ptr %1, i64 256
  %i.ae = zext i1 %.not69 to i8
  br label %bb.h
...
vector.body:                                      ; preds = %.preheader.loopexit, %.preheader84
  %.0.lcssa = phi i1 [ %i.v, %.preheader84 ], [ %i.ag, %.preheader.loopexit ]
  %i.ah = getelementptr i8, ptr %1, i64 16        ; 2 uses
  %wide.load = load <16 x i8>, ptr %1, align 1, !tbaa !20
  %wide.load99 = load <16 x i8>, ptr %i.ah, align 1, !tbaa !20
  %i.ai = icmp ne <16 x i8> %wide.load, zeroinitializer
  %i.aj = icmp ne <16 x i8> %wide.load99, zeroinitializer
  %i.ak = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %wide.load100 = load <16 x i8>, ptr %i.a, align 16, !tbaa !20
  %wide.load101 = load <16 x i8>, ptr %i.ak, align 16, !tbaa !20
  %i.al = icmp ne <16 x i8> %wide.load100, zeroinitializer
  %i.am = icmp ne <16 x i8> %wide.load101, zeroinitializer
  %narrow = select <16 x i1> %i.ai, <16 x i1> %i.al, <16 x i1> zeroinitializer
  %predphi = zext <16 x i1> %narrow to <16 x i8>
  %narrow103 = select <16 x i1> %i.aj, <16 x i1> %i.am, <16 x i1> zeroinitializer
  %predphi102 = zext <16 x i1> %narrow103 to <16 x i8>
  store <16 x i8> %predphi, ptr %1, align 1, !tbaa !20
  store <16 x i8> %predphi102, ptr %i.ah, align 1, !tbaa !20
  %i.an = getelementptr i8, ptr %1, i64 32        ; 2 uses
  %i.ao = getelementptr i8, ptr %1, i64 48        ; 2 uses
  %wide.load.1 = load <16 x i8>, ptr %i.an, align 1, !tbaa !20
  %wide.load99.1 = load <16 x i8>, ptr %i.ao, align 1, !tbaa !20
  %i.ap = icmp ne <16 x i8> %wide.load.1, zeroinitializer
  %i.aq = icmp ne <16 x i8> %wide.load99.1, zeroinitializer
  %i.ar = getelementptr inbounds nuw i8, ptr %i.a, i64 32
  %i.as = getelementptr inbounds nuw i8, ptr %i.a, i64 48
  %wide.load100.1 = load <16 x i8>, ptr %i.ar, align 16, !tbaa !20
  %wide.load101.1 = load <16 x i8>, ptr %i.as, align 16, !tbaa !20
  %i.at = icmp ne <16 x i8> %wide.load100.1, zeroinitializer
  %i.au = icmp ne <16 x i8> %wide.load101.1, zeroinitializer
  %narrow.1 = select <16 x i1> %i.ap, <16 x i1> %i.at, <16 x i1> zeroinitializer
  %predphi.1 = zext <16 x i1> %narrow.1 to <16 x i8>
  %narrow103.1 = select <16 x i1> %i.aq, <16 x i1> %i.au, <16 x i1> zeroinitializer
  %predphi102.1 = zext <16 x i1> %narrow103.1 to <16 x i8>
  store <16 x i8> %predphi.1, ptr %i.an, align 1, !tbaa !20
  store <16 x i8> %predphi102.1, ptr %i.ao, align 1, !tbaa !20
  %i.av = getelementptr i8, ptr %1, i64 64        ; 2 uses
  %i.aw = getelementptr i8, ptr %1, i64 80        ; 2 uses
  %wide.load.2 = load <16 x i8>, ptr %i.av, align 1, !tbaa !20
  %wide.load99.2 = load <16 x i8>, ptr %i.aw, align 1, !tbaa !20
  %i.ax = icmp ne <16 x i8> %wide.load.2, zeroinitializer
  %i.ay = icmp ne <16 x i8> %wide.load99.2, zeroinitializer
  %i.az = getelementptr inbounds nuw i8, ptr %i.a, i64 64
  %i.ba = getelementptr inbounds nuw i8, ptr %i.a, i64 80
  %wide.load100.2 = load <16 x i8>, ptr %i.az, align 16, !tbaa !20
  %wide.load101.2 = load <16 x i8>, ptr %i.ba, align 16, !tbaa !20
  %i.bb = icmp ne <16 x i8> %wide.load100.2, zeroinitializer
  %i.bc = icmp ne <16 x i8> %wide.load101.2, zeroinitializer
  %narrow.2 = select <16 x i1> %i.ax, <16 x i1> %i.bb, <16 x i1> zeroinitializer
  %predphi.2 = zext <16 x i1> %narrow.2 to <16 x i8>
  %narrow103.2 = select <16 x i1> %i.ay, <16 x i1> %i.bc, <16 x i1> zeroinitializer
  %predphi102.2 = zext <16 x i1> %narrow103.2 to <16 x i8>
  store <16 x i8> %predphi.2, ptr %i.av, align 1, !tbaa !20
  store <16 x i8> %predphi102.2, ptr %i.aw, align 1, !tbaa !20
  %i.bd = getelementptr i8, ptr %1, i64 96        ; 2 uses
  %i.be = getelementptr i8, ptr %1, i64 112       ; 2 uses
  %wide.load.3 = load <16 x i8>, ptr %i.bd, align 1, !tbaa !20
  %wide.load99.3 = load <16 x i8>, ptr %i.be, align 1, !tbaa !20
  %i.bf = icmp ne <16 x i8> %wide.load.3, zeroinitializer
  %i.bg = icmp ne <16 x i8> %wide.load99.3, zeroinitializer
  %i.bh = getelementptr inbounds nuw i8, ptr %i.a, i64 96
  %i.bi = getelementptr inbounds nuw i8, ptr %i.a, i64 112
  %wide.load100.3 = load <16 x i8>, ptr %i.bh, align 16, !tbaa !20
  %wide.load101.3 = load <16 x i8>, ptr %i.bi, align 16, !tbaa !20
  %i.bj = icmp ne <16 x i8> %wide.load100.3, zeroinitializer
  %i.bk = icmp ne <16 x i8> %wide.load101.3, zeroinitializer
  %narrow.3 = select <16 x i1> %i.bf, <16 x i1> %i.bj, <16 x i1> zeroinitializer
  %predphi.3 = zext <16 x i1> %narrow.3 to <16 x i8>
  %narrow103.3 = select <16 x i1> %i.bg, <16 x i1> %i.bk, <16 x i1> zeroinitializer
  %predphi102.3 = zext <16 x i1> %narrow103.3 to <16 x i8>
  store <16 x i8> %predphi.3, ptr %i.bd, align 1, !tbaa !20
  store <16 x i8> %predphi102.3, ptr %i.be, align 1, !tbaa !20
  %i.bl = getelementptr i8, ptr %1, i64 128       ; 2 uses
  %i.bm = getelementptr i8, ptr %1, i64 144       ; 2 uses
  %wide.load.4 = load <16 x i8>, ptr %i.bl, align 1, !tbaa !20
  %wide.load99.4 = load <16 x i8>, ptr %i.bm, align 1, !tbaa !20
  %i.bn = icmp ne <16 x i8> %wide.load.4, zeroinitializer
  %i.bo = icmp ne <16 x i8> %wide.load99.4, zeroinitializer
  %i.bp = getelementptr inbounds nuw i8, ptr %i.a, i64 128
  %i.bq = getelementptr inbounds nuw i8, ptr %i.a, i64 144
  %wide.load100.4 = load <16 x i8>, ptr %i.bp, align 16, !tbaa !20
  %wide.load101.4 = load <16 x i8>, ptr %i.bq, align 16, !tbaa !20
  %i.br = icmp ne <16 x i8> %wide.load100.4, zeroinitializer
  %i.bs = icmp ne <16 x i8> %wide.load101.4, zeroinitializer
  %narrow.4 = select <16 x i1> %i.bn, <16 x i1> %i.br, <16 x i1> zeroinitializer
  %predphi.4 = zext <16 x i1> %narrow.4 to <16 x i8>
  %narrow103.4 = select <16 x i1> %i.bo, <16 x i1> %i.bs, <16 x i1> zeroinitializer
  %predphi102.4 = zext <16 x i1> %narrow103.4 to <16 x i8>
  store <16 x i8> %predphi.4, ptr %i.bl, align 1, !tbaa !20
  store <16 x i8> %predphi102.4, ptr %i.bm, align 1, !tbaa !20
  %i.bt = getelementptr i8, ptr %1, i64 160       ; 2 uses
  %i.bu = getelementptr i8, ptr %1, i64 176       ; 2 uses
  %wide.load.5 = load <16 x i8>, ptr %i.bt, align 1, !tbaa !20
  %wide.load99.5 = load <16 x i8>, ptr %i.bu, align 1, !tbaa !20
  %i.bv = icmp ne <16 x i8> %wide.load.5, zeroinitializer
  %i.bw = icmp ne <16 x i8> %wide.load99.5, zeroinitializer
  %i.bx = getelementptr inbounds nuw i8, ptr %i.a, i64 160
  %i.by = getelementptr inbounds nuw i8, ptr %i.a, i64 176
  %wide.load100.5 = load <16 x i8>, ptr %i.bx, align 16, !tbaa !20
  %wide.load101.5 = load <16 x i8>, ptr %i.by, align 16, !tbaa !20
  %i.bz = icmp ne <16 x i8> %wide.load100.5, zeroinitializer
  %i.ca = icmp ne <16 x i8> %wide.load101.5, zeroinitializer
end_hunk_7
