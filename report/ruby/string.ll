...
RSTRING_PTR.exit73:                               ; preds = %bb.k, %bb.l
  %i.bk = phi ptr [ %i.bj, %bb.l ], [ %i.bi, %bb.k ] ; 6 uses
...
RSTRING_END.exit:                                 ; preds = %bb.n, %bb.o
  ...
  %i.br = getelementptr i8, ptr %i.bq, i64 %i.bn  ; 2 uses
...
begin_hunk_3_@rb_str_count:bb.a
  ...
  %3 = icmp ult ptr %i.ch, %i.br
  br i1 %3, label %scalar.ph, label %._crit_edge, !llvm.loop !218
...
bb.g:                                             ; preds = %RSTRING_PTR.exit
  ...
  %i.ao = load i64, ptr %i.an, align 8, !tbaa !14 ; 4 uses
...
.lr.ph138.split.preheader:                        ; preds = %.lr.ph138
  %i.ay = add i64 %i.ao, %i.as                    ; 2 uses
  %3 = sub i64 %i.ay, %i.am                       ; 2 uses
...
.lr.ph138.split.us.preheader:                     ; preds = %.lr.ph138
  %i.bb = add i64 %i.ao, %i.as                    ; 2 uses
  %4 = sub i64 %i.bb, %i.am                       ; 3 uses
  %.neg = add i64 %i.am, 1
