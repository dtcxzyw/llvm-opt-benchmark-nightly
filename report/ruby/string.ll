...
.lr.ph39:                                         ; preds = %.lr.ph39.preheader, %bb.e
  ...
  %.238 = phi ptr [ %i.aw, %bb.e ], [ %.1, %.lr.ph39.preheader ] ; 4 uses
...
._crit_edge.loopexitsplit:                        ; preds = %bb.e
  %.4.lcssa.ph.ph = phi i64 [ %.5, %bb.e ]
  %.2.lcssa.ph.ph = phi ptr [ %scevgep47, %bb.e ]
  br label %._crit_edge.loopexit

.._crit_edge.loopexit_crit_edge:                  ; preds = %bb.c
  %.238.lcssa = phi ptr [ %.238, %bb.c ]
  %split = phi i64 [ 0, %bb.c ]
  %.238.lcssa.a = phi ptr [ %.238, %bb.c ]        ; 0 uses
  br label %._crit_edge.loopexit

._crit_edge.loopexit:                             ; preds = %._crit_edge.loopexitsplit, %.._crit_edge.loopexit_crit_edge
  %.4.lcssa.ph = phi i64 [ %split, %.._crit_edge.loopexit_crit_edge ], [ %.4.lcssa.ph.ph, %._crit_edge.loopexitsplit ]
  %.2.lcssa.ph = phi ptr [ %.238.lcssa, %.._crit_edge.loopexit_crit_edge ], [ %.2.lcssa.ph.ph, %._crit_edge.loopexitsplit ]
  br label %._crit_edge
...
.lr.ph39.i:                                       ; preds = %bb.e, %.lr.ph39.preheader.i
  ...
  %.238.i = phi ptr [ %i.av, %bb.e ], [ %.1.i, %.lr.ph39.preheader.i ] ; 4 uses
...
str_utf8_nth.exit.loopexitsplit:                  ; preds = %bb.e
  %.2.lcssa.i.ph.ph = phi ptr [ %scevgep47.i, %bb.e ]
  br label %str_utf8_nth.exit.loopexit

.str_utf8_nth.exit.loopexit_crit_edge:            ; preds = %bb.c
  %.238.i.lcssa = phi ptr [ %.238.i, %bb.c ]
  %.238.i.lcssa.a = phi ptr [ %.238.i, %bb.c ]    ; 0 uses
  br label %str_utf8_nth.exit.loopexit

str_utf8_nth.exit.loopexit:                       ; preds = %str_utf8_nth.exit.loopexitsplit, %.str_utf8_nth.exit.loopexit_crit_edge
  %.2.lcssa.i.ph = phi ptr [ %.238.i.lcssa, %.str_utf8_nth.exit.loopexit_crit_edge ], [ %.2.lcssa.i.ph.ph, %str_utf8_nth.exit.loopexitsplit ]
...
.preheader.us.i.i:                                ; preds = %.preheader.us.i.i.preheader, %bb.s
  %.06278.us.i.i = phi i64 [ %i.ch, %bb.s ], [ %i.bq, %.preheader.us.i.i.preheader ] ; 5 uses
...
._crit_edge.us.i.isplit:                          ; preds = %bb.s
  %.062.lcssa.us.i.i.ph = phi i64 [ 0, %bb.s ]
  br label %._crit_edge.us.i.i

.preheader.us.i.i.._crit_edge.us.i.i_crit_edge:   ; preds = %.preheader.us.i.i
  %.06278.us.i.i.lcssa = phi i64 [ %.06278.us.i.i, %.preheader.us.i.i ]
  %.06278.us.i.i.lcssa.a = phi i64 [ %.06278.us.i.i, %.preheader.us.i.i ] ; 0 uses
  br label %._crit_edge.us.i.i

._crit_edge.us.i.i:                               ; preds = %._crit_edge.us.i.isplit, %.preheader.us.i.i.._crit_edge.us.i.i_crit_edge
  %.062.lcssa.us.i.i = phi i64 [ %.06278.us.i.i.lcssa, %.preheader.us.i.i.._crit_edge.us.i.i_crit_edge ], [ %.062.lcssa.us.i.i.ph, %._crit_edge.us.i.isplit ] ; 2 uses
...
rb_str_cat.exit:                                  ; preds = %rb_str_buf_new.exit, %bb.ag
  ...
  %spec.select297 = tail call i64 @llvm.smin.i64(i64 %i.dk, i64 %i.ck) ; 3 uses
...
.preheader:                                       ; preds = %.preheader.preheader, %bb.ah
  %lsr.iv = phi i64 [ %i.dm, %.preheader.preheader ], [ %lsr.iv.next, %bb.ah ] ; 3 uses
  %lsr.iv.a = phi i64 [ %.1229453, %bb.ah ], [ %spec.select297, %.preheader.preheader ]
  %.1229453 = add nsw i64 %lsr.iv.a, -1           ; 2 uses
  %scevgep = getelementptr i8, ptr %.1260563.lcssa583, i64 %lsr.iv
...
.loopexit.loopexitsplit:                          ; preds = %bb.ah
  %.2230.ph.ph = phi i64 [ 1, %bb.ah ]
  br label %.loopexit.loopexit

.preheader..loopexit.loopexit_crit_edge:          ; preds = %.preheader
  %lsr.iv.lcssa = phi i64 [ %lsr.iv, %.preheader ]
  %lsr.iv.lcssa.a = phi i64 [ %.1229453, %.preheader ] ; 0 uses
  br label %.loopexit.loopexit

.loopexit.loopexit:                               ; preds = %.loopexit.loopexitsplit, %.preheader..loopexit.loopexit_crit_edge
  %.2230.ph = phi i64 [ %lsr.iv.lcssa, %.preheader..loopexit.loopexit_crit_edge ], [ %.2230.ph.ph, %.loopexit.loopexitsplit ]
  br label %.loopexit
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.ci
  %.1438 = phi i64 [ %.1, %bb.ci ], [ %.1437, %.lr.ph.preheader ] ; 4 uses
...
.lr.ph..loopexit417.loopexit_crit_edge:           ; preds = %.lr.ph
  %.1438.lcssa = phi i64 [ %.1438, %.lr.ph ]
  %.1438.lcssa.a = phi i64 [ %.1438, %.lr.ph ]    ; 0 uses
  br label %.loopexit417.loopexit

.loopexit417.loopexit:                            ; preds = %.loopexit417.loopexitsplit, %.lr.ph..loopexit417.loopexit_crit_edge
  %.2.ph = phi i64 [ %.1438.lcssa, %.lr.ph..loopexit417.loopexit_crit_edge ], [ %.1.lcssa, %.loopexit417.loopexitsplit ]
...
.lr.ph41.i:                                       ; preds = %.lr.ph41.i.preheader, %.critedge2.i
  ...
  %.02440.i = phi ptr [ %i.az, %.critedge2.i ], [ %i.r, %.lr.ph41.i.preheader ] ; 4 uses
...
.critedge.i.loopexitsplit:                        ; preds = %.critedge2.i
  %.3.i.ph.ph = phi ptr [ %i.ar, %.critedge2.i ]
  br label %.critedge.i.loopexit

..critedge.i.loopexit_crit_edge:                  ; preds = %bb.h
  %.02440.i.lcssa = phi ptr [ %.02440.i, %bb.h ]
  %.02440.i.lcssa.a = phi ptr [ %.02440.i, %bb.h ] ; 0 uses
  br label %.critedge.i.loopexit

.critedge.i.loopexit:                             ; preds = %.critedge.i.loopexitsplit, %..critedge.i.loopexit_crit_edge
  %.3.i.ph = phi ptr [ %.02440.i.lcssa, %..critedge.i.loopexit_crit_edge ], [ %.3.i.ph.ph, %.critedge.i.loopexitsplit ]
  br label %.critedge.i
...
.lr.ph41.i:                                       ; preds = %.lr.ph41.i.preheader, %.critedge2.i
  ...
  %.02440.i = phi ptr [ %i.bb, %.critedge2.i ], [ %i.k, %.lr.ph41.i.preheader ] ; 4 uses
...
.critedge.i.loopexitsplit:                        ; preds = %.critedge2.i
  %.3.i.ph.ph = phi ptr [ %i.an, %.critedge2.i ]
  br label %.critedge.i.loopexit

..critedge.i.loopexit_crit_edge:                  ; preds = %bb.i
  %.02440.i.lcssa = phi ptr [ %.02440.i, %bb.i ]
  %.02440.i.lcssa.a = phi ptr [ %.02440.i, %bb.i ] ; 0 uses
  br label %.critedge.i.loopexit
...
.lr.ph41.i:                                       ; preds = %.lr.ph41.i.preheader, %.critedge2.i
  %lsr.iv = phi i64 [ %i.t, %.lr.ph41.i.preheader ], [ %lsr.iv.next, %.critedge2.i ]
  %.02440.i = phi ptr [ %i.av, %.critedge2.i ], [ %i.r, %.lr.ph41.i.preheader ] ; 4 uses
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %bb.c
  %.06074.us = phi i64 [ %i.t, %bb.c ], [ %i.c, %.preheader.us.preheader ] ; 5 uses
...
._crit_edge.ussplit:                              ; preds = %bb.c
  %.060.lcssa.us.ph = phi i64 [ 0, %bb.c ]
  br label %._crit_edge.us

.preheader.us.._crit_edge.us_crit_edge:           ; preds = %.preheader.us
  %.06074.us.lcssa = phi i64 [ %.06074.us, %.preheader.us ]
  %.06074.us.lcssa.a = phi i64 [ %.06074.us, %.preheader.us ] ; 0 uses
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.ussplit, %.preheader.us.._crit_edge.us_crit_edge
  %.060.lcssa.us = phi i64 [ %.06074.us.lcssa, %.preheader.us.._crit_edge.us_crit_edge ], [ %.060.lcssa.us.ph, %._crit_edge.ussplit ] ; 2 uses
...
.lr.ph50:                                         ; preds = %.lr.ph50.preheader, %.critedge2
  %.02849 = phi ptr [ %i.ah, %.critedge2 ], [ %2, %.lr.ph50.preheader ] ; 3 uses
...
.critedge.loopexitsplit:                          ; preds = %.critedge2
  %.4.ph.ph = phi ptr [ %scevgep, %.critedge2 ]
  br label %.critedge.loopexit

..critedge.loopexit_crit_edge:                    ; preds = %bb.i
  %.02849.lcssa = phi ptr [ %.02849, %bb.i ]
  %.02849.lcssa.a = phi ptr [ %.02849, %bb.i ]    ; 0 uses
  br label %.critedge.loopexit

.critedge.loopexit:                               ; preds = %.critedge.loopexitsplit, %..critedge.loopexit_crit_edge
  %.4.ph = phi ptr [ %.02849.lcssa, %..critedge.loopexit_crit_edge ], [ %.4.ph.ph, %.critedge.loopexitsplit ]
  br label %.critedge
...
._crit_edge:                                      ; preds = %bb.n
  %.025.lcssa55 = phi i64 [ %.025, %bb.n ]
  %.025.lcssa54 = phi i64 [ %.025, %bb.n ]        ; 0 uses
  br label %bb.o

bb.o:                                             ; preds = %split.a, %._crit_edge
  %.025.lcssa = phi i64 [ %.025.lcssa55, %._crit_edge ], [ %.025.lcssa53, %split.a ] ; 3 uses
