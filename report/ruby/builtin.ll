...
begin_hunk_0_@load_with_builtin_functions:bb.a
  ...
  %i.f = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.e, ptr noundef nonnull readonly dereferenceable(1) %0) #5
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %bin4feature.exit12.i
  ...
  %i.j = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.i, ptr noundef nonnull readonly dereferenceable(1) %0) #5
...
bb.c:                                             ; preds = %builtin_lookup.exit
  tail call void (ptr, ...) @rb_bug(ptr noundef nonnull @.str.1, ptr noundef nonnull %0) #6
  unreachable
...
bb.e:                                             ; preds = %bb.d
  tail call void (ptr, ...) @rb_bug(ptr noundef nonnull @.str.2) #6
  unreachable

bb.f:                                             ; preds = %bb.d
  store ptr %1, ptr %i.q, align 8, !tbaa !22
  %i.s = tail call nonnull ptr @rb_iseq_ibf_load_bytes(ptr noundef nonnull %.09.lcssa.i, i64 noundef %.0) #7
  store ptr null, ptr %i.q, align 8, !tbaa !22
  %i.t = tail call ptr @rb_root_box() #7
  %i.u = tail call i64 @rb_iseq_eval(ptr noundef nonnull %i.s, ptr noundef %i.t) #7 ; 0 uses
  ret void
}
