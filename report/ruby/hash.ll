...
bb.g:                                             ; preds = %bb.f, %.lr.ph.i
  ...
  %indvars.iv.i = phi i64 [ 0, %.lr.ph.i ], [ %indvars.iv.next.i, %bb.f ] ; 5 uses
...
ar_cleared_entry.exit.i.ar_cleared_entry.exit.thread.i_crit_edge: ; preds = %ar_cleared_entry.exit.i
  %indvars.iv.i.lcssa45 = phi i64 [ %indvars.iv.i, %ar_cleared_entry.exit.i ]
  %indvars.iv.i.lcssa45.a = phi i64 [ %indvars.iv.i, %ar_cleared_entry.exit.i ] ; 0 uses
  br label %ar_cleared_entry.exit.thread.i
...
ar_cleared_entry.exit.thread.i:                   ; preds = %ar_cleared_entry.exit.thread.isplit, %ar_cleared_entry.exit.i.ar_cleared_entry.exit.thread.i_crit_edge
  %indvars.iv.i.lcssa = phi i64 [ %indvars.iv.i.lcssa45, %ar_cleared_entry.exit.i.ar_cleared_entry.exit.thread.i_crit_edge ], [ %indvars.iv.i.lcssa44, %ar_cleared_entry.exit.thread.isplit ] ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.d
  ...
  %indvars.iv58 = phi i64 [ %umax, %.lr.ph.preheader ], [ %indvars.iv.next59, %bb.d ] ; 5 uses
...
.lr.ph.ar_cleared_entry.exit39.thread_crit_edge:  ; preds = %.lr.ph
  %indvars.iv58.lcssa78 = phi i64 [ %indvars.iv58, %.lr.ph ]
  %indvars.iv58.lcssa79 = phi i64 [ %indvars.iv58, %.lr.ph ] ; 0 uses
  br label %ar_cleared_entry.exit39.thread

ar_cleared_entry.exit39.thread:                   ; preds = %ar_cleared_entry.exit39.threadsplit, %.lr.ph.ar_cleared_entry.exit39.thread_crit_edge
  %indvars.iv58.lcssa = phi i64 [ %indvars.iv58.lcssa78, %.lr.ph.ar_cleared_entry.exit39.thread_crit_edge ], [ %indvars.iv58.lcssa80, %ar_cleared_entry.exit39.threadsplit ] ; 3 uses
...
.lr.ph.i:                                         ; preds = %bb.h, %.lr.ph.preheader.i
  ...
  %indvars.iv58.i = phi i64 [ %umax.i, %.lr.ph.preheader.i ], [ %indvars.iv.next59.i, %bb.h ] ; 5 uses
...
ar_cleared_entry.exit39.i.ar_cleared_entry.exit39.thread.i_crit_edge: ; preds = %ar_cleared_entry.exit39.i
  %indvars.iv58.i.lcssa13 = phi i64 [ %indvars.iv58.i, %ar_cleared_entry.exit39.i ]
  %indvars.iv58.i.lcssa17 = phi i64 [ %indvars.iv58.i, %ar_cleared_entry.exit39.i ] ; 0 uses
  br label %ar_cleared_entry.exit39.thread.i
...
ar_cleared_entry.exit39.thread.i:                 ; preds = %ar_cleared_entry.exit39.thread.isplit, %ar_cleared_entry.exit39.i.ar_cleared_entry.exit39.thread.i_crit_edge
  %indvars.iv58.i.lcssa = phi i64 [ %indvars.iv58.i.lcssa13, %ar_cleared_entry.exit39.i.ar_cleared_entry.exit39.thread.i_crit_edge ], [ %indvars.iv58.i.lcssa16, %ar_cleared_entry.exit39.thread.isplit ] ; 3 uses
