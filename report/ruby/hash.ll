...
rb_hash_new_with_size.exit:                       ; preds = %bb.f, %bb.g
  ...
  br i1 %.not.i.i.i20, label %copy_compare_by_id.exit23, label %bb.h
...
bb.h:                                             ; preds = %rb_hash_new_with_size.exit
  ...
  br i1 %i.au, label %rb_hash_compare_by_id_p.exit.i22, label %copy_compare_by_id.exit23

rb_hash_compare_by_id_p.exit.i22:                 ; preds = %bb.h
  %i.av = tail call i64 @rb_hash_compare_by_id(i64 noundef %i.af) ; 0 uses
  br label %copy_compare_by_id.exit23

copy_compare_by_id.exit23:                        ; preds = %rb_hash_new_with_size.exit, %bb.h, %rb_hash_compare_by_id_p.exit.i22
  %i.aw = icmp sgt i32 %0, 0
  br i1 %i.aw, label %.lr.ph.preheader, label %copy_compare_by_id.exit

.lr.ph.preheader:                                 ; preds = %copy_compare_by_id.exit23
...
copy_compare_by_id.exit:                          ; preds = %bb.j, %copy_compare_by_id.exit23, %rb_hash_compare_by_id_p.exit.i, %bb.e, %._crit_edge
  %.0 = phi i64 [ %i.p, %rb_hash_compare_by_id_p.exit.i ], [ %i.p, %._crit_edge ], [ %i.p, %bb.e ], [ %i.af, %copy_compare_by_id.exit23 ], [ %i.af, %bb.j ]
  ret i64 %.0
}
