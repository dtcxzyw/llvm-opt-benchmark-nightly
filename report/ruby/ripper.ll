...
bb.sg:                                            ; preds = %bb.sf
  %i.duw = load ptr, ptr %i.k, align 8, !tbaa !41
  %i.dux = getelementptr inbounds i8, ptr %i.duw, i64 -2 ; 3 uses
  %i.duy = load ptr, ptr %i.n, align 8, !tbaa !44
  ...
  br i1 %i.dve, label %.lr.ph, label %.critedge

.lr.ph:                                           ; preds = %bb.sg, %bb.sh
  %.063567663 = phi ptr [ %i.dvk, %bb.sh ], [ %i.dvd, %bb.sg ] ; 3 uses
...
bb.sh:                                            ; preds = %.lr.ph
  %i.dvk = getelementptr inbounds nuw i8, ptr %.063567663, i64 1 ; 3 uses
  %i.dvl = icmp ult ptr %i.dvk, %i.dux
  br i1 %i.dvl, label %.lr.ph, label %.critedge, !llvm.loop !138

.critedge:                                        ; preds = %.lr.ph, %bb.sh, %bb.sg
  %.06356.lcssa = phi ptr [ %i.dvd, %bb.sg ], [ %i.dvk, %bb.sh ], [ %.063567663, %.lr.ph ]
...
begin_hunk_2_@parser_yylex:bb.a
  ...
  %i.x = zext i32 %i.w to i64                     ; 12 uses
...
begin_hunk_3_@parser_yylex:bb.a
  ...
  %i.fo = load ptr, ptr %i.fn, align 8, !tbaa !44 ; 7 uses
...
bb.ab:                                            ; preds = %bb.z
  ...
  %i.fu = ptrtoint ptr %.val208.i to i64
  %i.fv = ptrtoint ptr %i.fo to i64               ; 2 uses
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  ...
  %i.gg = ptrtoint ptr %.0.i225.i to i64
...
bb.ah:                                            ; preds = %bb.ag, %bb.ad, %bb.ac
  ...
  %4 = sub nsw i64 0, %i.x
  %i.gj = getelementptr inbounds i8, ptr %.1.i.i, i64 %4 ; 4 uses
...
.lr.ph.i.i:                                       ; preds = %bb.ai, %bb.aj
  %.0263.i.i = phi ptr [ %i.gr, %bb.aj ], [ %i.fo, %bb.ai ] ; 3 uses
...
bb.aj:                                            ; preds = %.lr.ph.i.i
  %i.gr = getelementptr inbounds nuw i8, ptr %.0263.i.i, i64 1 ; 3 uses
  %5 = icmp ult ptr %i.gr, %i.gj
  br i1 %5, label %.lr.ph.i.i, label %whole_match_p.exit.i, !llvm.loop !511

whole_match_p.exit.i:                             ; preds = %bb.aj, %.lr.ph.i.i, %bb.ai
  %.127.i.i = phi ptr [ %i.fo, %bb.ai ], [ %.0263.i.i, %.lr.ph.i.i ], [ %i.gr, %bb.aj ]
...
bb.bo:                                            ; preds = %bb.bn, %bb.bm, %bb.bl, %bb.bk
  %.val205.i = load ptr, ptr %i.fn, align 8, !tbaa !44 ; 6 uses
  %i.li = ptrtoint ptr %.val206.pre.i to i64
  %i.lj = ptrtoint ptr %.val205.i to i64          ; 2 uses
...
bb.bt:                                            ; preds = %bb.bs, %bb.br
  ...
  %i.lu = ptrtoint ptr %.0.i265.i to i64
...
bb.bu:                                            ; preds = %bb.bt, %bb.bq, %bb.bp
  ...
  %i.lx = getelementptr inbounds i8, ptr %.1.i255.i, i64 %6 ; 4 uses
...
bb.bv:                                            ; preds = %bb.bu
  ...
  br i1 %or.cond.i259.i, label %.lr.ph.i262.i, label %.critedge.i260.i

.lr.ph.i262.i:                                    ; preds = %bb.bv, %bb.bw
  %.0263.i263.i = phi ptr [ %i.mf, %bb.bw ], [ %.val205.i, %bb.bv ] ; 3 uses
...
bb.bw:                                            ; preds = %.lr.ph.i262.i
  %i.mf = getelementptr inbounds nuw i8, ptr %.0263.i263.i, i64 1 ; 3 uses
  %7 = icmp ult ptr %i.mf, %i.lx
  br i1 %7, label %.lr.ph.i262.i, label %.critedge.i260.i, !llvm.loop !511

.critedge.i260.i:                                 ; preds = %bb.bw, %.lr.ph.i262.i, %bb.bv
  %.127.i261.i = phi ptr [ %.val205.i, %bb.bv ], [ %.0263.i263.i, %.lr.ph.i262.i ], [ %i.mf, %bb.bw ]
...
bb.dj:                                            ; preds = %bb.di, %bb.dh, %bb.dg, %bb.df
  %.val.i = load ptr, ptr %i.fn, align 8, !tbaa !44 ; 6 uses
  %i.rn = ptrtoint ptr %.val204.pre.i to i64
  %i.ro = ptrtoint ptr %.val.i to i64             ; 2 uses
...
bb.do:                                            ; preds = %bb.dn, %bb.dm
  ...
  %i.rz = ptrtoint ptr %.0.i310.i to i64
...
bb.dp:                                            ; preds = %bb.do, %bb.dl, %bb.dk
  ...
  %i.sc = getelementptr inbounds i8, ptr %.1.i300.i, i64 %8 ; 4 uses
...
bb.dq:                                            ; preds = %bb.dp
  ...
  br i1 %or.cond.i304.i, label %.lr.ph.i307.i, label %.critedge.i305.i

.lr.ph.i307.i:                                    ; preds = %bb.dq, %bb.dr
  %.0263.i308.i = phi ptr [ %i.sk, %bb.dr ], [ %.val.i, %bb.dq ] ; 3 uses
...
bb.dr:                                            ; preds = %.lr.ph.i307.i
  %i.sk = getelementptr inbounds nuw i8, ptr %.0263.i308.i, i64 1 ; 3 uses
  %9 = icmp ult ptr %i.sk, %i.sc
  br i1 %9, label %.lr.ph.i307.i, label %.critedge.i305.i, !llvm.loop !511

.critedge.i305.i:                                 ; preds = %bb.dr, %.lr.ph.i307.i, %bb.dq
  %.127.i306.i = phi ptr [ %.val.i, %bb.dq ], [ %.0263.i308.i, %.lr.ph.i307.i ], [ %i.sk, %bb.dr ]
...
bb.jh:                                            ; preds = %comment_at_top.exit
  ...
  %i.ava = load ptr, ptr %i.afn, align 8, !tbaa !413 ; 5 uses
...
begin_hunk_19_@parser_yylex:bb.a
  ...
  %scevgep76.i = getelementptr i8, ptr %scevgep.i, i64 %i.awf
  br label %bb.jt
...
bb.jv:                                            ; preds = %bb.ju, %bb.jt, %bb.jt
  ...
  %10 = icmp ult ptr %i.awo, %i.ava
  br i1 %10, label %bb.jt, label %.critedge.i913, !llvm.loop !543
...
bb.a:
  ...
  %i.b = ptrtoint ptr %.72.val to i64             ; 2 uses
  %i.c = sub i64 %i.a, %i.b
...
.lr.ph:                                           ; preds = %bb.h, %bb.i
  %.0263 = phi ptr [ %i.y, %bb.i ], [ %.72.val, %bb.h ] ; 3 uses
...
bb.i:                                             ; preds = %.lr.ph
  %i.y = getelementptr inbounds nuw i8, ptr %.0263, i64 1 ; 3 uses
  %3 = icmp ult ptr %i.y, %i.q
  br i1 %3, label %.lr.ph, label %.critedge, !llvm.loop !511

.critedge:                                        ; preds = %bb.i, %.lr.ph, %bb.h
  %.127 = phi ptr [ %.72.val, %bb.h ], [ %.0263, %.lr.ph ], [ %i.y, %bb.i ]
