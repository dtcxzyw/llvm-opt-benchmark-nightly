begin_hunk_0
  ...
  %i.qa = sub nsw i64 %.1343653, %i.pz            ; 2 uses
  %i.qb = getelementptr i8, ptr %.5341654, i64 %i.pz
  %8 = icmp sgt i64 %i.qa, 0
  br i1 %8, label %.lr.ph656, label %.loopexit, !llvm.loop !39
...
begin_hunk_1
  ...
  %4 = icmp sgt i64 %i.uu, 0
  br i1 %4, label %.lr.ph1575, label %._crit_edge1576, !llvm.loop !68
