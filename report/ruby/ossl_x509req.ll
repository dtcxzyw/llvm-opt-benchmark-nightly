...
rb_check_frozen_inline.exit:                      ; preds = %rbimpl_RB_TYPE_P_fastpath.exit.i, %bb.b
  ...
  br i1 %i.m, label %bb.c, label %.preheader.split.split.a

.preheader.split.split.a:                         ; preds = %rb_check_frozen_inline.exit
...
rb_scan_args_set.exit.thread:                     ; preds = %.preheader.split.split.a, %bb.f
