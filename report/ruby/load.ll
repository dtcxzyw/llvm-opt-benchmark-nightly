...
RARRAY_AREF.exit47.us75:                          ; preds = %rb_darray_size.exit.us80, %.lr.ph.split.us
  %.0427274.us = phi i64 [ 0, %.lr.ph.split.us ], [ %i.ca, %rb_darray_size.exit.us80 ] ; 5 uses
...
RARRAY_AREF.exit47:                               ; preds = %RARRAY_AREF.exit47.preheader, %rb_darray_size.exit
  %.0427274 = phi i64 [ %i.cy, %rb_darray_size.exit ], [ 0, %RARRAY_AREF.exit47.preheader ] ; 5 uses
...
is_rbext_path.exit51.us79.rb_darray_size.exit.i.loopexit_crit_edge: ; preds = %is_rbext_path.exit51.us79
  %.0427274.us.lcssa178 = phi i64 [ %.0427274.us, %is_rbext_path.exit51.us79 ]
  %.0427274.us.lcssa178.a = phi i64 [ %.0427274.us, %is_rbext_path.exit51.us79 ] ; 0 uses
  br label %rb_darray_size.exit.i.loopexit
...
rb_darray_size.exit.i.loopexit:                   ; preds = %rb_darray_size.exit.i.loopexitsplit, %is_rbext_path.exit51.us79.rb_darray_size.exit.i.loopexit_crit_edge
  %.0427274.us.lcssa166 = phi i64 [ %.0427274.us.lcssa178, %is_rbext_path.exit51.us79.rb_darray_size.exit.i.loopexit_crit_edge ], [ %.0427274.us.lcssa177, %rb_darray_size.exit.i.loopexitsplit ]
...
Check_Type.exit.rb_darray_size.exit.i.loopexit162_crit_edge: ; preds = %Check_Type.exit
  %.0427274.lcssa173 = phi i64 [ %.0427274, %Check_Type.exit ]
  %.0427274.lcssa173.a = phi i64 [ %.0427274, %Check_Type.exit ] ; 0 uses
  br label %rb_darray_size.exit.i.loopexit162
...
rb_darray_size.exit.i.loopexit162:                ; preds = %rb_darray_size.exit.i.loopexit162split, %Check_Type.exit.rb_darray_size.exit.i.loopexit162_crit_edge
  %.0427274.lcssa171 = phi i64 [ %.0427274.lcssa173, %Check_Type.exit.rb_darray_size.exit.i.loopexit162_crit_edge ], [ %.0427274.lcssa174, %rb_darray_size.exit.i.loopexit162split ]
  br label %rb_darray_size.exit.i
