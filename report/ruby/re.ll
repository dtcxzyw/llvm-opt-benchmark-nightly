...
bb.o:                                             ; preds = %bb.m
  ...
  %i.aa = getelementptr i8, ptr %i.k, i64 2       ; 3 uses
  store ptr %i.aa, ptr %i.a, align 8, !tbaa !63
  %i.ab = load i8, ptr %i.u, align 1, !tbaa !13   ; 5 uses
  store i8 %i.ab, ptr %i.b, align 1, !tbaa !13
  switch i8 %i.ab, label %bb.ae [
    i8 49, label %bb.p
    i8 50, label %bb.p
    i8 51, label %bb.p
    i8 52, label %bb.p
...
bb.p:                                             ; preds = %bb.o, %bb.o, %bb.o, %bb.o, %bb.o, %bb.o, %bb.o
  ...
  %i.ae = call i64 @llvm.umin.i64(i64 %i.ad, i64 3)
  %i.af = call i64 @ruby_scan_oct(ptr noundef nonnull %i.u, i64 noundef %i.ae, ptr noundef nonnull %i.d) #36
  %i.ag = icmp ult i64 %i.af, 128
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #28
  br i1 %i.ag, label %._crit_edge290, label %bb.q
...
bb.q:                                             ; preds = %bb.p, %bb.o, %bb.o, %bb.o, %bb.o, %bb.o
  ...
  %i.ah = call nonnull ptr @rb_usascii_encoding() #28
  %i.ai = icmp eq ptr %2, %i.ah
  br i1 %i.ai, label %bb.r, label %bb.t

bb.r:                                             ; preds = %bb.q
  %i.aj = call fastcc i32 @read_escaped_byte(ptr noundef %i.a, ptr noundef nonnull %1, ptr noundef %6) ; 2 uses
  %.not207 = icmp eq i32 %i.aj, -1
  br i1 %.not207, label %.thread220, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.ak = trunc nuw i32 %i.aj to i8
  store i8 %i.ak, ptr %i.b, align 1, !tbaa !13
  %i.al = load ptr, ptr %i.a, align 8, !tbaa !63
  %i.am = ptrtoint ptr %i.al to i64
  %i.an = sub i64 %i.am, %i.z
  %i.ao = call i64 @rb_str_cat(i64 noundef %3, ptr noundef nonnull %i.k, i64 noundef %i.an) #28 ; 0 uses
  br label %.loopexit229.loopexit

bb.t:                                             ; preds = %bb.q
  %i.ap = call fastcc i32 @unescape_escaped_nonascii(ptr noundef %i.a, ptr noundef nonnull %1, ptr noundef %2, i64 noundef %3, ptr noundef %4, ptr noundef %6)
  %.not206 = icmp eq i32 %i.ap, 0
  br i1 %.not206, label %.loopexit229.loopexit, label %.thread220

bb.u:                                             ; preds = %bb.o
  %i.aq = icmp eq ptr %i.aa, %1
...
bb.w:                                             ; preds = %bb.u
  %i.ar = load i8, ptr %i.aa, align 1, !tbaa !13
  %i.as = icmp eq i8 %i.ar, 123
  br i1 %i.as, label %bb.x, label %bb.ab

bb.x:                                             ; preds = %bb.w
  %i.at = getelementptr i8, ptr %i.k, i64 3
  store ptr %i.at, ptr %i.a, align 8, !tbaa !63
  %i.au = call fastcc i32 @unescape_unicode_list(ptr noundef %i.a, ptr noundef nonnull %1, i64 noundef %3, ptr noundef %4, ptr noundef %6)
  %.not204 = icmp eq i32 %i.au, 0
  br i1 %.not204, label %bb.y, label %.thread220

bb.y:                                             ; preds = %bb.x
  %i.av = load ptr, ptr %i.a, align 8, !tbaa !63  ; 3 uses
  %i.aw = icmp eq ptr %i.av, %1
  br i1 %i.aw, label %bb.aa, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.ax = getelementptr i8, ptr %i.av, i64 1
  store ptr %i.ax, ptr %i.a, align 8, !tbaa !63
  %i.ay = load i8, ptr %i.av, align 1, !tbaa !13
  %.not205 = icmp eq i8 %i.ay, 125
...
bb.ab:                                            ; preds = %bb.w
  %i.az = call fastcc i32 @unescape_unicode_bmp(ptr noundef %i.a, ptr noundef nonnull %1, i64 noundef %3, ptr noundef %4, ptr noundef %6)
  %.not203 = icmp eq i32 %i.az, 0
  br i1 %.not203, label %.loopexit229.loopexit, label %.thread220

bb.ac:                                            ; preds = %bb.o, %bb.o
  %i.ba = load ptr, ptr %4, align 8, !tbaa !64
  %.not202 = icmp eq ptr %i.ba, null
...
bb.ae:                                            ; preds = %._crit_edge290, %bb.o, %bb.ac, %bb.ad
  %i.bb = phi i8 [ %.pre, %._crit_edge290 ], [ %i.ab, %bb.o ], [ %i.ab, %bb.ac ], [ %i.ab, %bb.ad ]
  store i8 92, ptr %i.c, align 1, !tbaa !13
  store i8 %i.bb, ptr %i.h, align 1, !tbaa !13
  %i.bc = call i64 @rb_str_cat(i64 noundef %3, ptr noundef nonnull %i.c, i64 noundef 2) #28 ; 0 uses
  br label %.loopexit229.loopexit

bb.af:                                            ; preds = %bb.i
  store ptr %i.u, ptr %i.a, align 8
  %i.bd = icmp eq i32 %.5161392, 0
  %i.be = icmp ne i32 %.4149394, 0
  %or.cond = select i1 %i.bd, i1 true, i1 %i.be
  br i1 %or.cond, label %bb.al, label %.preheader

.preheader:                                       ; preds = %bb.af
  %i.bf = icmp ult ptr %i.u, %1
...
.lr.ph259:                                        ; preds = %.lr.ph259.preheader, %bb.ak
  %i.bh = phi ptr [ %i.bi, %bb.ak ], [ %i.u, %.lr.ph259.preheader ] ; 2 uses
  %i.bi = getelementptr i8, ptr %i.bh, i64 1      ; 3 uses
  %i.bj = load i8, ptr %i.bh, align 1, !tbaa !13  ; 3 uses
  store i8 %i.bj, ptr %i.b, align 1, !tbaa !13
  %.not198 = icmp eq i8 %i.bj, 10
  br i1 %.not198, label %.critedge.loopexit, label %bb.ag

bb.ag:                                            ; preds = %.lr.ph259
  %.not199 = icmp sgt i8 %i.bj, -1
  br i1 %.not199, label %bb.ak, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  %i.bk = load ptr, ptr %4, align 8, !tbaa !64
  %.not200 = icmp eq ptr %i.bk, null
  br i1 %.not200, label %bb.ai, label %bb.ak

bb.ai:                                            ; preds = %bb.ah
  %i.bl = call nonnull ptr @rb_utf8_encoding() #28
  %i.bm = icmp eq ptr %2, %i.bl
...
bb.ak:                                            ; preds = %bb.aj, %bb.ai, %bb.ah, %bb.ag
  %exitcond289.not = icmp eq ptr %i.bi, %scevgep288
  br i1 %exitcond289.not, label %.critedge.loopexit, label %.lr.ph259, !llvm.loop !130

bb.al:                                            ; preds = %bb.af
  %i.bn = call i64 @rb_str_cat(i64 noundef %3, ptr noundef nonnull %i.b, i64 noundef 1) #28 ; 0 uses
  br label %.loopexit229.loopexit

bb.am:                                            ; preds = %bb.i
  store ptr %i.u, ptr %i.a, align 8
  %i.bo = add i32 %.4149394, 1
...
bb.ao:                                            ; preds = %bb.i
  store ptr %i.u, ptr %i.a, align 8
  %i.br = call i64 @rb_str_cat(i64 noundef %3, ptr noundef nonnull %i.b, i64 noundef 1) #28 ; 0 uses
  %i.bs = icmp eq i32 %.4149394, 0
  %or.cond3 = and i1 %i.f, %i.bs
  br i1 %or.cond3, label %bb.ap, label %.loopexit229.loopexit

bb.ap:                                            ; preds = %bb.ao
  %i.bt = add i32 %.5155393, -1                   ; 2 uses
  %i.bu = icmp eq i32 %i.bt, 0
  br i1 %i.bu, label %bb.aq, label %.loopexit229.loopexit
...
bb.as:                                            ; preds = %bb.ar
  %i.bw = getelementptr i8, ptr %i.k, i64 2       ; 3 uses
  %i.bx = icmp ult ptr %i.bw, %1
  br i1 %i.bx, label %bb.at, label %bb.bl

bb.at:                                            ; preds = %bb.as
  %i.by = load i8, ptr %i.u, align 1, !tbaa !13
  %i.bz = icmp eq i8 %i.by, 63
  br i1 %i.bz, label %bb.au, label %bb.bl

bb.au:                                            ; preds = %bb.at
  %i.ca = load i8, ptr %i.bw, align 1, !tbaa !13
  %i.cb = icmp eq i8 %i.ca, 35
  br i1 %i.cb, label %.preheader227, label %.lr.ph.preheader

.preheader227:                                    ; preds = %bb.au
  %i.cc = icmp ult ptr %i.u, %1
  br i1 %i.cc, label %.lr.ph256, label %._crit_edge.thread

.lr.ph256:                                        ; preds = %.preheader227, %bb.bb
  %i.cd = phi ptr [ %i.co, %bb.bb ], [ %i.u, %.preheader227 ] ; 5 uses
  %i.ce = getelementptr i8, ptr %i.cd, i64 1      ; 3 uses
  %i.cf = load i8, ptr %i.cd, align 1, !tbaa !13  ; 3 uses
  store i8 %i.cf, ptr %i.b, align 1, !tbaa !13
  switch i8 %i.cf, label %bb.av [
    i8 92, label %bb.az
    i8 41, label %._crit_edge
  ]

bb.av:                                            ; preds = %.lr.ph256
  %.not195 = icmp sgt i8 %i.cf, -1
  br i1 %.not195, label %bb.bb, label %bb.aw

bb.aw:                                            ; preds = %bb.av
  %i.cg = load ptr, ptr %4, align 8, !tbaa !64
  %.not196 = icmp eq ptr %i.cg, null
  br i1 %.not196, label %bb.ax, label %bb.az

bb.ax:                                            ; preds = %bb.aw
  %i.ch = call nonnull ptr @rb_utf8_encoding() #28
  %i.ci = icmp eq ptr %2, %i.ch
  br i1 %i.ci, label %bb.ay, label %bb.az
...
bb.az:                                            ; preds = %bb.aw, %bb.ax, %bb.ay, %.lr.ph256
  %i.cj = phi ptr [ %i.ce, %.lr.ph256 ], [ %i.cd, %bb.ay ], [ %i.cd, %bb.ax ], [ %i.cd, %bb.aw ] ; 2 uses
  %i.ck = call i32 @rb_enc_precise_mbclen(ptr noundef %i.cj, ptr noundef nonnull %1, ptr noundef %2) #28 ; 2 uses
  %i.cl = icmp sgt i32 %i.ck, 0
  br i1 %i.cl, label %bb.ba, label %.loopexit228
...
bb.bb:                                            ; preds = %bb.av, %bb.ba
  %i.co = phi ptr [ %i.cn, %bb.ba ], [ %i.ce, %bb.av ] ; 2 uses
  %i.cp = icmp ult ptr %i.co, %1
  br i1 %i.cp, label %.lr.ph256, label %._crit_edge.thread, !llvm.loop !131
...
._crit_edge.thread:                               ; preds = %bb.bb, %.preheader227
  ...
  %i.cq = call i64 @rb_str_cat(i64 noundef %3, ptr noundef nonnull %i.b, i64 noundef 1) #28 ; 0 uses
  br label %.loopexit229.loopexit
...
.lr.ph.preheader:                                 ; preds = %bb.au
  ...
  %i.cr = sub i64 0, %i.bv
  %scevgep285 = getelementptr i8, ptr %scevgep, i64 %i.cr
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.bk
  %.0138252 = phi ptr [ %.0138, %bb.bk ], [ %i.bw, %.lr.ph.preheader ] ; 2 uses
  %.0139251 = phi i32 [ %.1140, %bb.bk ], [ 0, %.lr.ph.preheader ] ; 9 uses
  %.0141250 = phi i32 [ %.1142, %bb.bk ], [ 0, %.lr.ph.preheader ] ; 7 uses
  %i.cs = load i8, ptr %.0138252, align 1, !tbaa !13 ; 2 uses
  switch i8 %i.cs, label %.thread215 [
    i8 120, label %bb.bc
    i8 45, label %bb.bd
    i8 58, label %bb.be
    i8 41, label %bb.be
...
bb.bc:                                            ; preds = %.lr.ph
  ...
  %i.ct = select i1 %.not194, i32 1, i32 -1
  br label %bb.bk
...
bb.be:                                            ; preds = %.lr.ph, %.lr.ph
  %i.cu = icmp eq i32 %.0139251, 0
  br i1 %i.cu, label %.thread215, label %bb.bf

bb.bf:                                            ; preds = %bb.be
  %i.cv = icmp ne i32 %.0139251, -1
  %i.cw = icmp ne i32 %.5161392, 0                ; 2 uses
  %or.cond5 = select i1 %i.cv, i1 true, i1 %i.cw
  br i1 %or.cond5, label %bb.bg, label %.thread215

bb.bg:                                            ; preds = %bb.bf
  %i.cx = icmp eq i32 %.0139251, 1                ; 3 uses
  %or.cond7 = select i1 %i.cx, i1 %i.cw, i1 false
  br i1 %or.cond7, label %.thread215, label %bb.bh

bb.bh:                                            ; preds = %bb.bg
  %i.cy = icmp eq i8 %i.cs, 58
  br i1 %i.cy, label %bb.bi, label %bb.bj

bb.bi:                                            ; preds = %bb.bh
  %masksel = select i1 %i.cx, i32 2, i32 0
  %.0137 = or disjoint i32 %masksel, %i.g
  %i.cz = call i64 @rb_str_cat(i64 noundef %3, ptr noundef nonnull %i.b, i64 noundef 1) #28 ; 0 uses
  %i.da = call fastcc i32 @unescape_nonascii0(ptr noundef %i.a, ptr noundef nonnull %1, ptr noundef %2, i64 noundef %3, ptr noundef %4, ptr noundef %5, ptr noundef %6, i32 noundef %.0137, i32 noundef 1)
  %i.db = icmp slt i32 %i.da, 0
  br i1 %i.db, label %.thread220, label %.loopexit229.loopexit

bb.bj:                                            ; preds = %bb.bh
  %i.dc = zext i1 %i.cx to i32
  br label %.thread215
...
bb.bk:                                            ; preds = %bb.bc, %bb.bd, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph, %.lr.ph
  ...
  %.1140 = phi i32 [ %i.ct, %bb.bc ], [ %.0139251, %bb.bd ], [ %.0139251, %.lr.ph ], [ %.0139251, %.lr.ph ], [ %.0139251, %.lr.ph ], [ %.0139251, %.lr.ph ], [ %.0139251, %.lr.ph ]
...
bb.bl:                                            ; preds = %bb.at, %bb.as, %bb.ar
  ...
  %i.dd = zext i1 %or.cond9 to i32
  %spec.select210 = add i32 %.5155393, %i.dd
  br label %.thread215
...
.thread215:                                       ; preds = %.lr.ph, %bb.bk, %.thread215.loopexit316, %bb.bf, %bb.bg, %bb.bj, %bb.be, %bb.bl
  %.2158 = phi i32 [ %.5161392, %.thread215.loopexit316 ], [ %.5161392, %bb.bl ], [ %.5161392, %bb.be ], [ 0, %bb.bf ], [ %.5161392, %bb.bg ], [ %i.dc, %bb.bj ], [ %.5161392, %bb.bk ], [ %.5161392, %.lr.ph ]
  ...
  %i.de = call i64 @rb_str_cat(i64 noundef %3, ptr noundef nonnull %i.b, i64 noundef 1) #28 ; 0 uses
  br label %.loopexit229.loopexit

.critedge.loopexit:                               ; preds = %bb.ak, %.lr.ph259, %.preheader
  %i.df = phi ptr [ %i.u, %.preheader ], [ %scevgep288, %bb.ak ], [ %i.bi, %.lr.ph259 ]
  store ptr %i.df, ptr %i.a, align 8
  br label %.loopexit229.loopexit

.critedge:                                        ; preds = %bb.f, %bb.g
  %i.dg = icmp ult ptr %i.r, %1
  br i1 %i.dg, label %bb.b, label %.loopexit229._crit_edge
...
.loopexit229.loopexit:                            ; preds = %bb.bi, %._crit_edge, %._crit_edge.thread, %bb.s, %bb.ao, %bb.ap, %bb.am, %bb.al, %bb.ae, %bb.t, %bb.z, %bb.ab, %.thread215, %bb.an, %.critedge.loopexit
  ...
  %.4154.ph = phi i32 [ %.5155393, %.critedge.loopexit ], [ %.5155393, %bb.an ], [ %.2152, %.thread215 ], [ %.5155393, %bb.ab ], [ %.5155393, %bb.z ], [ %.5155393, %bb.t ], [ %.5155393, %bb.ae ], [ %.5155393, %bb.al ], [ %.5155393, %bb.am ], [ %i.bt, %bb.ap ], [ %.5155393, %bb.ao ], [ %.5155393, %bb.s ], [ %.5155393, %._crit_edge.thread ], [ %.5155393, %._crit_edge ], [ %spec.select209, %bb.bi ]
  %.3148.ph = phi i32 [ 0, %.critedge.loopexit ], [ %spec.select, %bb.an ], [ %.4149394, %.thread215 ], [ %.4149394, %bb.ab ], [ %.4149394, %bb.z ], [ %.4149394, %bb.t ], [ %.4149394, %bb.ae ], [ %.4149394, %bb.al ], [ %i.bo, %bb.am ], [ 0, %bb.ap ], [ %.4149394, %bb.ao ], [ %.4149394, %bb.s ], [ 0, %._crit_edge.thread ], [ 0, %._crit_edge ], [ 0, %bb.bi ]
  %.promoted = load ptr, ptr %i.a, align 8, !tbaa !63 ; 3 uses
  %i.dh = icmp ult ptr %.promoted, %1
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.b
  %.02537 = phi ptr [ %i.k, %bb.b ], [ %i.c, %.lr.ph.preheader ] ; 3 uses
  %i.f = load i8, ptr %.02537, align 1, !tbaa !13 ; 2 uses
  %i.g = sext i8 %i.f to i32
  %i.h = icmp ne i8 %i.f, 32
...
.critedge:                                        ; preds = %.critedge.loopexit, %bb.a
  ...
  br i1 %i.o, label %.critedge49, label %.lr.ph46
...
bb.d:                                             ; preds = %.lr.ph46
  %i.s = call fastcc i32 @append_utf8(i64 noundef %i.q, i64 noundef %2, ptr noundef %3, ptr noundef %4)
  %.not27 = icmp eq i32 %i.s, 0
  br i1 %.not27, label %bb.e, label %.loopexit

bb.e:                                             ; preds = %bb.d
  %i.t = getelementptr i8, ptr %.145, i64 %i.p    ; 3 uses
  %i.u = icmp ult ptr %i.t, %1
  br i1 %i.u, label %.lr.ph41.preheader, label %.critedge2

.lr.ph41.preheader:                               ; preds = %bb.e
  %scevgep50 = getelementptr i8, ptr %.145, i64 %i.a
  %i.v = sub i64 0, %.14551
  %scevgep52 = getelementptr i8, ptr %scevgep50, i64 %i.v ; 2 uses
  br label %.lr.ph41

.lr.ph41:                                         ; preds = %.lr.ph41.preheader, %bb.f
  %.240 = phi ptr [ %i.ab, %bb.f ], [ %i.t, %.lr.ph41.preheader ] ; 3 uses
  %i.w = load i8, ptr %.240, align 1, !tbaa !13   ; 2 uses
  %i.x = sext i8 %i.w to i32
  %i.y = icmp ne i8 %i.w, 32
  %i.z = add nsw i32 %i.x, -14
  %i.aa = icmp ult i32 %i.z, -5
  %narrow.i29.not = select i1 %i.y, i1 %i.aa, i1 false
  br i1 %narrow.i29.not, label %.critedge2, label %bb.f

bb.f:                                             ; preds = %.lr.ph41
  %i.ab = getelementptr i8, ptr %.240, i64 1      ; 2 uses
  %exitcond53.not = icmp eq ptr %i.ab, %scevgep52
  br i1 %exitcond53.not, label %.critedge2, label %.lr.ph41, !llvm.loop !135

.critedge2:                                       ; preds = %.lr.ph41, %bb.f, %bb.e
  %.2.lcssa = phi ptr [ %i.t, %bb.e ], [ %scevgep52, %bb.f ], [ %.240, %.lr.ph41 ] ; 4 uses
  %i.ac = ptrtoint ptr %.2.lcssa to i64
  %i.ad = sub i64 %i.a, %i.ac
  %i.ae = call i64 @ruby_scan_hex(ptr noundef %.2.lcssa, i64 noundef %i.ad, ptr noundef nonnull %i.b) #28
  %i.af = load i64, ptr %i.b, align 8, !tbaa !19  ; 2 uses
  %i.ag = icmp eq i64 %i.af, 0
  br i1 %i.ag, label %._crit_edge, label %.lr.ph46
