...
RSTRING_PTR.exit:                                 ; preds = %rb_enc_asciicompat.exit, %bb.c
  ...
  br i1 %i.o, label %.lr.ph212, label %._crit_edge.thread

.lr.ph212:                                        ; preds = %RSTRING_PTR.exit
...
bb.d:                                             ; preds = %.lr.ph212, %bb.an
  %.0150211 = phi i64 [ 0, %.lr.ph212 ], [ %.2, %bb.an ] ; 4 uses
  %.0151210 = phi ptr [ %i.k, %.lr.ph212 ], [ %.2153, %bb.an ] ; 4 uses
  %.0154209 = phi ptr [ %i.k, %.lr.ph212 ], [ %.2156, %bb.an ] ; 9 uses
  br i1 %.0.i, label %bb.e, label %bb.f

bb.e:                                             ; preds = %bb.d
  store i32 1, ptr %i.a, align 4, !tbaa !7
  %i.z = load i8, ptr %.0154209, align 1, !tbaa !13 ; 2 uses
  %i.aa = zext nneg i8 %i.z to i32
  %i.ab = icmp slt i8 %i.z, 0
  br i1 %i.ab, label %.thread, label %.thread237

bb.f:                                             ; preds = %bb.d
  %i.ac = call i32 @rb_enc_ascget(ptr noundef %.0154209, ptr noundef nonnull %i.n, ptr noundef nonnull %i.a, ptr noundef %i.b) #28 ; 2 uses
  %i.ad = icmp eq i32 %i.ac, -1
  br i1 %i.ad, label %.thread, label %.thread237

.thread:                                          ; preds = %bb.e, %bb.f
  %i.ae = call i32 @rb_enc_mbclen(ptr noundef %.0154209, ptr noundef nonnull %i.n, ptr noundef %i.b) #28
  %i.af = sext i32 %i.ae to i64
  %i.ag = getelementptr i8, ptr %.0154209, i64 %i.af
  br label %bb.an, !llvm.loop !94

.thread237:                                       ; preds = %bb.e, %bb.f
  %i.ah = phi i32 [ %i.ac, %bb.f ], [ %i.aa, %bb.e ]
  %i.ai = load i32, ptr %i.a, align 4, !tbaa !7
  %i.aj = sext i32 %i.ai to i64                   ; 4 uses
  %i.ak = getelementptr i8, ptr %.0154209, i64 %i.aj ; 8 uses
...
bb.g:                                             ; preds = %.thread237
  %.not168 = icmp eq i64 %.0150211, 0
  %i.am = ptrtoint ptr %.0154209 to i64
  %i.an = ptrtoint ptr %.0151210 to i64
  %i.ao = sub i64 %i.am, %i.an                    ; 2 uses
  br i1 %.not168, label %bb.h, label %._crit_edge219

bb.h:                                             ; preds = %bb.g
  %i.ap = call i64 @rb_str_buf_new(i64 noundef %i.ao) #28
  br label %._crit_edge219

._crit_edge219:                                   ; preds = %bb.g, %bb.h
  %.1 = phi i64 [ %i.ap, %bb.h ], [ %.0150211, %bb.g ] ; 20 uses
  %i.aq = call i64 @rb_enc_str_buf_cat(i64 noundef %.1, ptr noundef %.0151210, i64 noundef %i.ao, ptr noundef %i.b) #28 ; 0 uses
  br i1 %.0.i, label %bb.i, label %bb.j

bb.i:                                             ; preds = %._crit_edge219
  store i32 1, ptr %i.a, align 4, !tbaa !7
  %i.ar = load i8, ptr %i.ak, align 1, !tbaa !13  ; 2 uses
  %i.as = zext nneg i8 %i.ar to i32
  %i.at = icmp slt i8 %i.ar, 0
  br i1 %i.at, label %.thread189, label %.thread238

bb.j:                                             ; preds = %._crit_edge219
  ...
  br i1 %i.av, label %.thread189, label %.thread238

.thread189:                                       ; preds = %bb.i, %bb.j
  ...
  %i.ba = call i64 @rb_enc_str_buf_cat(i64 noundef %.1, ptr noundef %.0154209, i64 noundef %i.az, ptr noundef %i.b) #28 ; 0 uses
  br label %bb.an, !llvm.loop !94

.thread238:                                       ; preds = %bb.i, %bb.j
  ...
  switch i32 %i.bb, label %bb.aj [
    ...
    i32 57, label %bb.k
    i32 107, label %bb.n
    i32 48, label %.thread196
    i32 38, label %.thread196
    i32 96, label %bb.ab
    i32 39, label %bb.ad
    i32 43, label %bb.af
    i32 92, label %bb.ai
...
bb.k:                                             ; preds = %.thread238, %.thread238, %.thread238, %.thread238, %.thread238, %.thread238, %.thread238, %.thread238, %.thread238
...
bb.n:                                             ; preds = %.thread238
  %i.bi = icmp ult ptr %i.be, %i.n
  br i1 %i.bi, label %bb.o, label %.thread191
...
bb.p:                                             ; preds = %bb.o
  ...
  br i1 %i.bl, label %.thread191, label %bb.r
...
bb.r:                                             ; preds = %bb.p, %bb.q
  ...
  br i1 %i.bo, label %bb.s, label %.thread191
...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %bb.u
  %.0149207.us = phi ptr [ %i.by, %bb.u ], [ %i.br, %.lr.ph ] ; 4 uses
  store i32 1, ptr %i.a, align 4, !tbaa !7
  %i.bt = load i8, ptr %.0149207.us, align 1, !tbaa !13 ; 2 uses
  %i.bu = icmp slt i8 %i.bt, 0
  br i1 %i.bu, label %.thread193.us, label %bb.t

bb.t:                                             ; preds = %.lr.ph.split.us
  %cond = icmp eq i8 %i.bt, 62
  br i1 %cond, label %.split.us, label %bb.u

.thread193.us:                                    ; preds = %.lr.ph.split.us
  %i.bv = call i32 @rb_enc_mbclen(ptr noundef nonnull %.0149207.us, ptr noundef nonnull %i.n, ptr noundef %i.b) #28
  %i.bw = sext i32 %i.bv to i64
  br label %bb.u

bb.u:                                             ; preds = %bb.t, %.thread193.us
  %i.bx = phi i64 [ %i.bw, %.thread193.us ], [ 1, %bb.t ]
  %i.by = getelementptr i8, ptr %.0149207.us, i64 %i.bx ; 2 uses
  %i.bz = icmp ult ptr %i.by, %i.n
  br i1 %i.bz, label %.lr.ph.split.us, label %.critedge, !llvm.loop !95

.lr.ph.split:                                     ; preds = %.lr.ph, %bb.w
  %.0149207 = phi ptr [ %i.cf, %bb.w ], [ %i.br, %.lr.ph ] ; 4 uses
  %i.ca = call i32 @rb_enc_ascget(ptr noundef %.0149207, ptr noundef nonnull %i.n, ptr noundef nonnull %i.a, ptr noundef %i.b) #28
  switch i32 %i.ca, label %bb.v [
    i32 62, label %.split.us
    i32 -1, label %.thread193.a
  ]

.thread193.a:                                     ; preds = %.lr.ph.split
  %i.cb = call i32 @rb_enc_mbclen(ptr noundef %.0149207, ptr noundef nonnull %i.n, ptr noundef %i.b) #28
  br label %bb.w
...
bb.w:                                             ; preds = %bb.v, %.thread193.a
  %i.cd = phi i32 [ %i.cb, %.thread193.a ], [ %i.cc, %bb.v ]
  %i.ce = sext i32 %i.cd to i64
  %i.cf = getelementptr i8, ptr %.0149207, i64 %i.ce ; 2 uses
  %i.cg = icmp ult ptr %i.cf, %i.n
  br i1 %i.cg, label %.lr.ph.split, label %.critedge, !llvm.loop !95

.split.us:                                        ; preds = %.lr.ph.split, %bb.t
  %.us-phi = phi ptr [ %.0149207.us, %bb.t ], [ %.0149207, %.lr.ph.split ] ; 3 uses
...
.thread191:                                       ; preds = %bb.p, %bb.r, %bb.n
  ...
  %i.db = call i64 @rb_enc_str_buf_cat(i64 noundef %.1, ptr noundef %.0154209, i64 noundef %i.da, ptr noundef %i.b) #28 ; 0 uses
  br label %bb.an, !llvm.loop !94

bb.ab:                                            ; preds = %.thread238
...
bb.ai:                                            ; preds = %.thread238
  %i.ec = call i64 @rb_enc_str_buf_cat(i64 noundef %.1, ptr noundef %i.ak, i64 noundef %i.bd, ptr noundef %i.b) #28 ; 0 uses
  br label %bb.an, !llvm.loop !94

bb.aj:                                            ; preds = %.thread238
  %i.ed = add nsw i64 %i.bd, %i.aj
  %i.ee = call i64 @rb_enc_str_buf_cat(i64 noundef %.1, ptr noundef %.0154209, i64 noundef %i.ed, ptr noundef %i.b) #28 ; 0 uses
  br label %bb.an, !llvm.loop !94

.thread196:                                       ; preds = %bb.ah, %.thread238, %.thread238, %bb.aa, %bb.m
  %.1152200 = phi ptr [ %i.be, %bb.ah ], [ %i.be, %.thread238 ], [ %i.be, %.thread238 ], [ %i.cy, %bb.aa ], [ %i.be, %bb.m ] ; 6 uses
  %.1158199 = phi i32 [ %.0157, %bb.ah ], [ 0, %.thread238 ], [ 0, %.thread238 ], [ %i.cu, %bb.aa ], [ %i.bh, %bb.m ] ; 2 uses
  %i.ef = load i32, ptr %i.p, align 4, !tbaa !43
  %.not174 = icmp slt i32 %.1158199, %i.ef
  br i1 %.not174, label %bb.ak, label %bb.an, !llvm.loop !94

bb.ak:                                            ; preds = %.thread196
  %i.eg = load ptr, ptr %i.q, align 8, !tbaa !73
  %i.eh = zext nneg i32 %.1158199 to i64          ; 2 uses
...
bb.an:                                            ; preds = %RSTRING_PTR.exit187, %bb.ak, %.thread196, %bb.ah, %bb.k, %bb.l, %.thread237, %bb.aj, %bb.ai, %RSTRING_PTR.exit185, %RSTRING_PTR.exit183, %.thread191, %.thread189, %.thread
  %.2156 = phi ptr [ %i.ag, %.thread ], [ %i.be, %bb.ai ], [ %i.ay, %.thread189 ], [ %i.be, %bb.aj ], [ %i.ak, %.thread237 ], [ %i.be, %bb.ah ], [ %.1152200, %.thread196 ], [ %.1152200, %bb.ak ], [ %i.be, %.thread191 ], [ %i.be, %RSTRING_PTR.exit183 ], [ %i.be, %RSTRING_PTR.exit185 ], [ %i.be, %bb.k ], [ %i.be, %bb.l ], [ %.1152200, %RSTRING_PTR.exit187 ] ; 2 uses
  %.2153 = phi ptr [ %.0151210, %.thread ], [ %i.be, %bb.ai ], [ %i.ay, %.thread189 ], [ %i.be, %bb.aj ], [ %.0151210, %.thread237 ], [ %i.be, %bb.ah ], [ %.1152200, %.thread196 ], [ %.1152200, %bb.ak ], [ %i.be, %.thread191 ], [ %i.be, %RSTRING_PTR.exit183 ], [ %i.be, %RSTRING_PTR.exit185 ], [ %i.be, %bb.k ], [ %i.be, %bb.l ], [ %.1152200, %RSTRING_PTR.exit187 ] ; 4 uses
  %.2 = phi i64 [ %.0150211, %.thread ], [ %.1, %bb.ai ], [ %.1, %.thread189 ], [ %.1, %bb.aj ], [ %.0150211, %.thread237 ], [ %.1, %bb.ah ], [ %.1, %.thread196 ], [ %.1, %bb.ak ], [ %.1, %.thread191 ], [ %.1, %RSTRING_PTR.exit183 ], [ %.1, %RSTRING_PTR.exit185 ], [ %.1, %bb.k ], [ %.1, %bb.l ], [ %.1, %RSTRING_PTR.exit187 ] ; 5 uses
...
bb.bf:                                            ; preds = %bb.be
  ...
  %i.cx = icmp ne i32 %.5161392, 0                ; 2 uses
...
bb.bl:                                            ; preds = %bb.at, %bb.as, %bb.ar
  ...
  %spec.select210 = add i32 %.5155393, %i.de
  br label %.thread215
...
.thread215:                                       ; preds = %.lr.ph, %bb.bk, %.thread215.loopexit316, %bb.bf, %bb.bg, %bb.bj, %bb.be, %bb.bl
  %.2158 = phi i32 [ %.5161392, %.thread215.loopexit316 ], [ %.5161392, %bb.bl ], [ %.5161392, %bb.be ], [ 0, %bb.bf ], [ %.5161392, %bb.bg ], [ %i.dd, %bb.bj ], [ %.5161392, %bb.bk ], [ %.5161392, %.lr.ph ]
...
.loopexit229.loopexit:                            ; preds = %bb.bi, %._crit_edge, %._crit_edge.thread, %bb.s, %bb.ao, %bb.ap, %bb.am, %bb.al, %bb.ae, %bb.t, %bb.z, %bb.ab, %.thread215, %bb.an, %.critedge.loopexit
  ...
  %.4154.ph = phi i32 [ %.5155393, %.critedge.loopexit ], [ %.5155393, %bb.an ], [ %.2152, %.thread215 ], [ %.5155393, %bb.ab ], [ %.5155393, %bb.z ], [ %.5155393, %bb.t ], [ %.5155393, %bb.ae ], [ %.5155393, %bb.al ], [ %.5155393, %bb.am ], [ %i.bu, %bb.ap ], [ %.5155393, %bb.ao ], [ %.5155393, %bb.s ], [ %.5155393, %._crit_edge.thread ], [ %.5155393, %._crit_edge ], [ %spec.select209, %bb.bi ]
  %.3148.ph = phi i32 [ 0, %.critedge.loopexit ], [ %spec.select, %bb.an ], [ %.4149394, %.thread215 ], [ %.4149394, %bb.ab ], [ %.4149394, %bb.z ], [ %.4149394, %bb.t ], [ %.4149394, %bb.ae ], [ %.4149394, %bb.al ], [ %i.bp, %bb.am ], [ 0, %bb.ap ], [ %.4149394, %bb.ao ], [ %.4149394, %bb.s ], [ 0, %._crit_edge.thread ], [ 0, %._crit_edge ], [ 0, %bb.bi ]
  %.promoted = load ptr, ptr %i.b, align 8, !tbaa !63 ; 3 uses
  %i.di = icmp ult ptr %.promoted, %1
  br i1 %i.di, label %.lr.ph388, label %.loopexit229._crit_edge
...
.lr.ph388:                                        ; preds = %.lr.ph388.lr.ph, %.loopexit229.loopexit
  ...
  %.5161392 = phi i32 [ %i.k, %.lr.ph388.lr.ph ], [ %.4160.ph, %.loopexit229.loopexit ] ; 22 uses
  br label %bb.b

.loopexit229._crit_edge:                          ; preds = %.loopexit229.loopexit, %.critedge, %bb.a
  %.lcssa370 = phi ptr [ %i.s, %.critedge ], [ %i.f, %bb.a ], [ %.promoted, %.loopexit229.loopexit ] ; 2 uses
