...
rb_memsearch_qs_utf8_hash.exit:                   ; preds = %bb.b, %bb.i, %bb.j
  %.026.i = phi i32 [ %i.z, %bb.b ], [ %i.bc, %bb.j ], [ %i.bb, %bb.i ]
  %i.bd = zext nneg i32 %.026.i to i64
  %i.be = getelementptr [8 x i8], ptr %i.a, i64 %i.bd
  store i64 %i.v, ptr %i.be, align 8, !tbaa !19
  %i.bf = getelementptr i8, ptr %.03039, i64 1    ; 2 uses
  %exitcond45.not = icmp eq ptr %i.bf, %i.o
  br i1 %exitcond45.not, label %.preheader, label %bb.a, !llvm.loop !28

bb.k:                                             ; preds = %.lr.ph43, %rb_memsearch_qs_utf8_hash.exit35
  %i.bg = phi ptr [ %i.s, %.lr.ph43 ], [ %i.cy, %rb_memsearch_qs_utf8_hash.exit35 ] ; 7 uses
  %.02842 = phi ptr [ %2, %.lr.ph43 ], [ %i.cx, %rb_memsearch_qs_utf8_hash.exit35 ] ; 4 uses
  %i.bh = load i8, ptr %.02842, align 1, !tbaa !13
  %i.bi = icmp eq i8 %i.t, %i.bh
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.bj = icmp eq i32 %bcmp, 0
  br i1 %i.bj, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  %i.bk = ptrtoint ptr %.02842 to i64
