...
begin_hunk_3_@ossl_asn1_decode0:bb.a
  ...
  %i.cb = call i64 @rb_ary_new() #9               ; 4 uses
...
begin_hunk_4_@ossl_asn1_decode0:bb.a
  ...
  %i.cf = call fastcc i64 @ossl_asn1_decode0(ptr noundef nonnull %0, i64 noundef %.036.i88.us, ptr noundef %i.l, i32 noundef %i.ce, i32 noundef range(i32 0, 2) %4, ptr noundef %i.m) ; 3 uses
...
bb.v:                                             ; preds = %ossl_asn1_tag.exit.us
  ...
  %i.cs = call i64 @rb_attr_get(i64 noundef %i.cf, i64 noundef %i.cr) #9
...
bb.x:                                             ; preds = %bb.w
  %i.cw = call i64 @rb_ary_push(i64 noundef %i.cb, i64 noundef %i.cf) #9 ; 0 uses
...
begin_hunk_7_@ossl_asn1_decode0:bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.m) #9
  store i64 0, ptr %i.m, align 8, !tbaa !10
  %i.cy = call fastcc i64 @ossl_asn1_decode0(ptr noundef nonnull %0, i64 noundef %.036.i88, ptr noundef %i.l, i32 noundef %i.ce, i32 noundef range(i32 0, 2) %4, ptr noundef %i.m)
  %i.cz = load i64, ptr %i.m, align 8, !tbaa !10  ; 2 uses
  %i.da = add nsw i64 %i.cz, %.187                ; 2 uses
  %i.db = sub nsw i64 %.036.i88, %i.cz            ; 2 uses
  %i.dc = call i64 @rb_ary_push(i64 noundef %i.cb, i64 noundef %i.cy) #9 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.m) #9
...
.split90.us:                                      ; preds = %bb.w
  ...
  call void (i64, ptr, ...) @ossl_raise(i64 noundef %i.df, ptr noundef nonnull @.str.76) #10
  unreachable
...
begin_hunk_10_@ossl_asn1_decode0:bb.a
  ...
  %i.dv = call i64 @ossl_asn1_initialize(i32 noundef 4, ptr noundef nonnull %i.n, i64 noundef %i.do) ; 0 uses
...
bb.ab:                                            ; preds = %.loopexit
  ...
  %i.dx = call i64 @rb_obj_alloc(i64 noundef %i.dw) #9 ; 2 uses
  %i.dy = sext i32 %i.bz to i64
  %i.dz = shl nsw i64 %i.dy, 1
  %i.ea = or disjoint i64 %i.dz, 1
  %i.eb = call i64 @ossl_asn1data_initialize(i64 noundef %i.dx, i64 noundef %i.cb, i64 noundef %i.ea, i64 noundef %.0) ; 0 uses
  br label %int_ossl_asn1_decode0_cons.exit
...
decode_bstr.exit.i:                               ; preds = %bb.at
  %i.fp = load i32, ptr %i.fn, align 8, !tbaa !36
  ...
  %i.fv = load ptr, ptr %i.fu, align 8, !tbaa !37
...
bb.bn:                                            ; preds = %bb.bm
  ...
  %i.hk = load ptr, ptr %i.hj, align 8, !tbaa !35
...
begin_hunk_13_@to_der_internal:bb.a
  ...
  %i.bd = tail call i64 @rb_str_new(ptr noundef null, i64 noundef %i.bc) #9, !callees !38 ; 3 uses
...
bb.aa:                                            ; preds = %RSTRING_LENINT.exit
  ...
  %i.bv = tail call i64 @rb_str_new(ptr noundef null, i64 noundef %i.bu) #9, !callees !38 ; 3 uses
...
!36 = !{!33, !7, i64 0}
!37 = !{!33, !21, i64 8}
!38 = !{ptr @rb_str_new, ptr @rb_str_new_static}
end_hunk_15
