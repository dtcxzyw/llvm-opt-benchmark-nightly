...
bb.c:                                             ; preds = %.lr.ph122, %.loopexit89
  %.071121 = phi ptr [ %i.q, %.lr.ph122 ], [ %.6, %.loopexit89 ] ; 19 uses
  %.073120 = phi ptr [ %3, %.lr.ph122 ], [ %.477, %.loopexit89 ] ; 19 uses
...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  %i.ad = phi i32 [ %i.y, %bb.d ], [ %i.ab, %bb.e ] ; 6 uses
...
.lr.ph105.preheader.a:                            ; preds = %.preheader
  ...
  %min.iters.check185 = icmp ult i32 %i.ad, 32
  ...
  br i1 %or.cond, label %.lr.ph105.preheader228, label %vector.ph186

vector.ph186:                                     ; preds = %.lr.ph105.preheader.a
  %n.vec188 = and i64 %i.ag, 2147483616           ; 5 uses
...
begin_hunk_4_@onig_vsnprintf_with_pattern:bb.a
  ...
  br i1 %i.an, label %middle.block197, label %vector.body190, !llvm.loop !32

middle.block197:                                  ; preds = %vector.body190
  %cmp.n198 = icmp eq i64 %n.vec188, %i.ag
  br i1 %cmp.n198, label %.loopexit89, label %.lr.ph105.preheader228

.lr.ph105.preheader228:                           ; preds = %.lr.ph105.preheader.a, %middle.block197
  %.172104.ph = phi ptr [ %.071121, %.lr.ph105.preheader.a ], [ %i.ai, %middle.block197 ]
  %.174103.ph = phi ptr [ %.073120, %.lr.ph105.preheader.a ], [ %i.aj, %middle.block197 ]
  %.078102.ph = phi i32 [ %i.ad, %.lr.ph105.preheader.a ], [ %i.ak, %middle.block197 ]
  br label %.lr.ph105
...
begin_hunk_5_@onig_vsnprintf_with_pattern:bb.a
  ...
  br i1 %i.as, label %.lr.ph105, label %.loopexit89, !llvm.loop !35

.loopexit:                                        ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %middle.block217, %.lr.ph99
  %.3.lcssa = phi ptr [ %.298, %.lr.ph99 ], [ %i.bf, %middle.block217 ], [ %.lcssa.unr, %.lr.ph.prol.loopexit ], [ %i.co, %.lr.ph ] ; 2 uses
  %i.at = icmp samesign ugt i32 %.in, 1
  br i1 %i.at, label %.lr.ph99, label %.loopexit89, !llvm.loop !36

.lr.ph99:                                         ; preds = %.preheader92, %.loopexit
  %.in = phi i32 [ %i.au, %.loopexit ], [ %i.ad, %.preheader92 ] ; 2 uses
  %.298 = phi ptr [ %.3.lcssa, %.loopexit ], [ %.071121, %.preheader92 ] ; 5 uses
...
.lr.ph.preheader.a:                               ; preds = %.lr.ph99
  ...
  br i1 %or.cond221, label %.lr.ph.preheader224, label %vector.ph207

vector.ph207:                                     ; preds = %.lr.ph.preheader.a
  %n.vec209 = and i64 %i.bb, 2147483616           ; 4 uses
...
begin_hunk_6_@onig_vsnprintf_with_pattern:bb.a
  ...
  br i1 %i.bi, label %middle.block217, label %vector.body210, !llvm.loop !37

middle.block217:                                  ; preds = %vector.body210
  %cmp.n218 = icmp eq i64 %n.vec209, %i.bb
  br i1 %cmp.n218, label %.loopexit, label %.lr.ph.preheader224

.lr.ph.preheader224:                              ; preds = %.lr.ph.preheader.a, %middle.block217
  %.07095.ph = phi ptr [ %i.a, %.lr.ph.preheader.a ], [ %i.be, %middle.block217 ] ; 3 uses
  %.394.ph = phi ptr [ %.298, %.lr.ph.preheader.a ], [ %i.bf, %middle.block217 ] ; 2 uses
...
begin_hunk_7_@onig_vsnprintf_with_pattern:bb.a
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !38
...
begin_hunk_8_@onig_vsnprintf_with_pattern:bb.a
  ...
  br i1 %exitcond.not.7, label %.loopexit, label %.lr.ph, !llvm.loop !40
...
bb.h:                                             ; preds = %bb.g
  %i.cq = getelementptr i8, ptr %.073120, i64 1   ; 7 uses
...
select.unfold:                                    ; preds = %bb.i, %bb.j
  %i.cw = phi i32 [ %i.cv, %bb.j ], [ %i.cr, %bb.i ] ; 5 uses
  %.4108 = getelementptr i8, ptr %.071121, i64 1  ; 4 uses
...
.lr.ph112.preheader.a:                            ; preds = %select.unfold
  ...
  %min.iters.check166 = icmp ult i32 %i.cw, 32
  ...
  br i1 %or.cond222, label %.lr.ph112.preheader226, label %vector.ph167

vector.ph167:                                     ; preds = %.lr.ph112.preheader.a
  %n.vec169 = and i64 %i.cy, 2147483616           ; 5 uses
...
begin_hunk_11_@onig_vsnprintf_with_pattern:bb.a
  ...
  br i1 %i.df, label %middle.block177, label %vector.body170, !llvm.loop !41

middle.block177:                                  ; preds = %vector.body170
  %cmp.n178 = icmp eq i64 %n.vec169, %i.cy
  br i1 %cmp.n178, label %.loopexit89, label %.lr.ph112.preheader226

.lr.ph112.preheader226:                           ; preds = %.lr.ph112.preheader.a, %middle.block177
  %.4111.ph = phi ptr [ %.4108, %.lr.ph112.preheader.a ], [ %i.da, %middle.block177 ]
  %.376110.ph = phi ptr [ %i.cq, %.lr.ph112.preheader.a ], [ %i.db, %middle.block177 ]
  %.280109.ph = phi i32 [ %i.cw, %.lr.ph112.preheader.a ], [ %i.dc, %middle.block177 ]
  br label %.lr.ph112
...
begin_hunk_12_@onig_vsnprintf_with_pattern:bb.a
  ...
  br i1 %i.dj, label %.lr.ph112, label %.loopexit89, !llvm.loop !42
...
bb.l:                                             ; preds = %bb.g
  ...
  %i.dp = load ptr, ptr %i.u, align 8, !tbaa !43
...
bb.m:                                             ; preds = %bb.l
  %i.dr = load ptr, ptr %i.u, align 8, !tbaa !43
...
bb.n:                                             ; preds = %bb.m
  %i.dv = load ptr, ptr %i.u, align 8, !tbaa !43
...
bb.o:                                             ; preds = %bb.n, %bb.m
  %i.dz = getelementptr i8, ptr %.073120, i64 1   ; 4 uses
  ...
  %i.ed = call i32 @onigenc_str_bytelen_null(ptr noundef nonnull @OnigEncodingASCII, ptr noundef nonnull %i.a) #8 ; 3 uses
  %i.ee = icmp sgt i32 %i.ed, 0
  br i1 %i.ee, label %.lr.ph118.preheader.a, label %.loopexit89

.lr.ph118.preheader.a:                            ; preds = %bb.o
  %i.ef = zext nneg i32 %i.ed to i64              ; 5 uses
  %i.eg = getelementptr i8, ptr %i.a, i64 %i.ef
  %scevgep132 = getelementptr i8, ptr %i.eg, i64 -1
  %min.iters.check = icmp ult i32 %i.ed, 32
  %i.eh = sub i64 %.071121158, %i.c
  %diff.check = icmp ult i64 %i.eh, 32
  %or.cond223 = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond223, label %.lr.ph118.preheader225, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph118.preheader.a
  %n.vec = and i64 %i.ef, 2147483616              ; 4 uses
...
begin_hunk_16_@onig_vsnprintf_with_pattern:bb.a
  ...
  br i1 %i.em, label %middle.block.a, label %vector.body, !llvm.loop !44

middle.block.a:                                   ; preds = %vector.body
  %cmp.n.a = icmp eq i64 %n.vec, %i.ef
  br i1 %cmp.n.a, label %.loopexit89, label %.lr.ph118.preheader225

.lr.ph118.preheader225:                           ; preds = %.lr.ph118.preheader.a, %middle.block.a
  %.1117.ph = phi ptr [ %i.a, %.lr.ph118.preheader.a ], [ %i.ei, %middle.block.a ] ; 3 uses
  %.5116.ph = phi ptr [ %.071121, %.lr.ph118.preheader.a ], [ %i.ej, %middle.block.a ] ; 2 uses
...
begin_hunk_17_@onig_vsnprintf_with_pattern:bb.a
  ...
  br i1 %prol.iter240.cmp.not, label %.lr.ph118.prol.loopexit, label %.lr.ph118.prol, !llvm.loop !45
...
begin_hunk_18_@onig_vsnprintf_with_pattern:bb.a
  ...
  br i1 %exitcond133.not.7, label %.loopexit89, label %.lr.ph118, !llvm.loop !46
...
.loopexit89:                                      ; preds = %.loopexit, %.lr.ph105, %.lr.ph112, %.lr.ph118.prol.loopexit, %.lr.ph118, %middle.block197, %middle.block177, %middle.block.a, %.thread, %.preheader92, %.preheader, %select.unfold, %bb.o, %bb.p, %bb.k
  %.477 = phi ptr [ %i.dz, %bb.o ], [ %i.cq, %.thread ], [ %i.dz, %.lr.ph118.prol.loopexit ], [ %i.dl, %bb.k ], [ %i.ft, %bb.p ], [ %i.dz, %middle.block.a ], [ %i.cq, %select.unfold ], [ %.073120, %.preheader ], [ %.073120, %.preheader92 ], [ %i.ap, %.lr.ph105 ], [ %i.dh, %.lr.ph112 ], [ %i.db, %middle.block177 ], [ %i.aj, %middle.block197 ], [ %i.dz, %.lr.ph118 ], [ %i.av, %.loopexit ] ; 2 uses
  %.6 = phi ptr [ %.071121, %bb.o ], [ %.4108141, %.thread ], [ %i.fs, %.lr.ph118 ], [ %i.dn, %bb.k ], [ %i.fv, %bb.p ], [ %i.ej, %middle.block.a ], [ %.4108, %select.unfold ], [ %.071121, %.preheader ], [ %.071121, %.preheader92 ], [ %i.ar, %.lr.ph105 ], [ %.4, %.lr.ph112 ], [ %i.da, %middle.block177 ], [ %i.ai, %middle.block197 ], [ %.lcssa235.unr, %.lr.ph118.prol.loopexit ], [ %.3.lcssa, %.loopexit ] ; 2 uses
  %i.fw = icmp ult ptr %.477, %4
  br i1 %i.fw, label %bb.c, label %._crit_edge, !llvm.loop !47
...
!35 = distinct !{!35, !26, !33}
!36 = distinct !{!36, !26}
!37 = distinct !{!37, !26, !33, !34}
!38 = distinct !{!38, !39}
!39 = !{!"llvm.loop.unroll.disable"}
!40 = distinct !{!40, !26, !33}
!41 = distinct !{!41, !26, !33, !34}
!42 = distinct !{!42, !26, !33}
!43 = !{!20, !12, i64 88}
