...
bb.o:                                             ; preds = %RARRAY_AREF.exit.thread, %RCLASS_SINGLETON_P.exit39.thread, %rb_num2int_inline.exit, %RARRAY_AREF.exit, %bb.g, %rb_ruby_verbose_ptr.exit, %bb.d
  %.032 = phi i64 [ 1, %bb.d ], [ 1, %rb_ruby_verbose_ptr.exit ], [ 2, %bb.g ], [ 1, %RARRAY_AREF.exit ], [ 1, %rb_num2int_inline.exit ], [ 1, %RCLASS_SINGLETON_P.exit39.thread ], [ 1, %RARRAY_AREF.exit.thread ]
  %.032.a = phi i32 [ 1, %bb.d ], [ 1, %rb_ruby_verbose_ptr.exit ], [ 2, %bb.g ], [ 1, %RARRAY_AREF.exit ], [ 1, %rb_num2int_inline.exit ], [ 1, %RCLASS_SINGLETON_P.exit39.thread ], [ 1, %RARRAY_AREF.exit.thread ]
...
begin_hunk_1_@vm_respond_to:bb.a
  ...
  store i64 %.032, ptr %i.bw, align 8, !tbaa !174
...
bb.c:                                             ; preds = %.preheader, %bb.b
  ...
  %.286.i = phi i64 [ 2, %bb.b ], [ 1, %.preheader ]
  %.286.i.a = phi i32 [ 2, %bb.b ], [ 1, %.preheader ] ; 3 uses
...
select.unfold:                                    ; preds = %bb.t, %bb.s, %bb.j, %bb.k, %bb.l, %bb.m, %bb.n, %bb.o, %bb.p, %bb.q, %bb.r
  %.0.i20.ph = phi i16 [ 2048, %bb.s ], [ 1024, %bb.r ], [ 512, %bb.q ], [ 256, %bb.p ], [ 64, %bb.o ], [ 16, %bb.n ], [ 8, %bb.m ], [ 4, %bb.l ], [ 2, %bb.k ], [ 1, %bb.j ], [ 4096, %bb.t ]
  %.0.i20.ph.a = phi i32 [ 2048, %bb.s ], [ 1024, %bb.r ], [ 512, %bb.q ], [ 256, %bb.p ], [ 64, %bb.o ], [ 16, %bb.n ], [ 8, %bb.m ], [ 4, %bb.l ], [ 2, %bb.k ], [ 1, %bb.j ], [ 4096, %bb.t ] ; 2 uses
...
scope_to_ci.exit:                                 ; preds = %bb.a, %scope_to_ci.exit.fold.split, %.thread100, %bb.b, %bb.c
  ...
  %11 = phi i8 [ 1, %bb.a ], [ 1, %.thread100 ], [ 0, %bb.b ], [ 0, %bb.c ], [ 0, %scope_to_ci.exit.fold.split ]
  %12 = phi i32 [ 64, %bb.a ], [ 64, %.thread100 ], [ 0, %bb.b ], [ 0, %bb.c ], [ 0, %scope_to_ci.exit.fold.split ] ; 2 uses
...
begin_hunk_8_@rb_call0:bb.a
  ...
  store i8 %11, ptr %i.eb, align 4, !tbaa !231
