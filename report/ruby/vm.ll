...
define internal fastcc i64 @vm_caller_setup_fwd_args(ptr nofree noundef readonly captures(none) %0, ptr noundef %1, ptr nofree noundef readonly captures(none) %2, ptr noundef %3, i32 noundef range(i32 0, 2) %4, ptr nofree noundef nonnull writeonly captures(none) %5, ptr noundef nonnull %6) unnamed_addr #2 {
bb.a:
