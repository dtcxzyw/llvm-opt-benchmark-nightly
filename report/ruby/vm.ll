...
.backedge.backedge:                               ; preds = %.lr.ph3058.epil.preheader, %.backedge.loopexit.unr-lcssa, %bb.er, %bb.lq, %vm_method_cfunc_is.exit.thread, %bb.c, %vm_get_ep.exit, %vm_env_write.exit, %bb.p, %vm_env_write.exit2389, %bb.ab, %vm_getspecial.exit, %VM_EP_LEP.exit2414, %vm_getivar.exit, %bb.bn, %vm_getclassvariable.exit, %vm_setclassvariable.exit, %bb.bz, %bb.ca, %vm_ensure_not_refinement_module.exit2434, %bb.cd, %bb.ce, %bb.cf, %bb.cg, %bb.ch, %bb.ci, %bb.cj, %bb.ck, %bb.cl, %bb.cm, %bb.cn, %bb.co, %bb.cp, %bb.cu, %bb.cv, %bb.cw, %vm_expandarray.exit, %vm_concat_array.exit, %vm_concat_to_array.exit, %bb.dw, %vm_splat_array.exit, %bb.eh, %bb.ej, %bb.ek, %bb.el, %bb.em, %ruby_nonempty_memcpy.exit, %bb.eq, %bb.es, %bb.et, %bb.eu, %bb.ev, %bb.fr, %vm_check_match.exit, %vm_check_keyword.exit, %rb_type.exit, %vm_push_frame.exit, %bb.hn, %bb.ho, %.thread2842, %.thread2844, %bb.jz, %bb.ka, %.thread2856, %.thread2858, %bb.ls, %bb.lv, %bb.ly, %bb.mb, %bb.ml, %bb.mo, %vm_opt_duparray_include_p.exit, %vm_opt_newarray_hash.exit, %.thread2870, %.thread2872, %bb.ou, %bb.ov, %.thread2884, %.thread2886, %bb.py, %rb_vm_check_ints.exit, %bb.qf, %bb.qj, %bb.qn, %vm_once_dispatch.exit, %vm_case_dispatch.exit.thread, %vm_opt_plus.exit.thread2893, %vm_opt_minus.exit.thread2898, %vm_opt_mult.exit.thread2903, %bb.vl, %vm_opt_mod.exit.thread2912, %opt_equality.exit, %vm_opt_neq.exit, %vm_opt_lt.exit, %vm_opt_le.exit, %vm_opt_gt.exit, %vm_opt_ge.exit, %bb.aaq, %bb.aas, %bb.aav, %vm_opt_aref.exit.thread2927, %bb.abv, %bb.aby, %bb.acb, %bb.ace, %vm_opt_succ.exit.thread2932, %vm_opt_not.exit, %bb.adk, %bb.adl, %vm_invoke_builtin_delegate.exit, %bb.adt, %bb.adu, %.lr.ph.i2774, %vm_env_write.exit2783, %vm_env_write.exit2791, %bb.aea, %bb.aeb
  %.02257.be = phi ptr [ %.02257, %bb.c ], [ %.02257, %vm_get_ep.exit ], [ %.02257, %vm_env_write.exit ], [ %.02257, %bb.p ], [ %.02257, %vm_env_write.exit2389 ], [ %.02257, %bb.ab ], [ %.02257, %vm_getspecial.exit ], [ %.02257, %VM_EP_LEP.exit2414 ], [ %.02257, %vm_getivar.exit ], [ %.02257, %bb.bn ], [ %.02257, %vm_getclassvariable.exit ], [ %.02257, %vm_setclassvariable.exit ], [ %.02257, %bb.bz ], [ %.02257, %bb.ca ], [ %.02257, %vm_ensure_not_refinement_module.exit2434 ], [ %.02257, %bb.cd ], [ %.02257, %bb.ce ], [ %.02257, %bb.cf ], [ %.02257, %bb.cg ], [ %.02257, %bb.ch ], [ %.02257, %bb.ci ], [ %.02257, %bb.cj ], [ %.02257, %bb.ck ], [ %.02257, %bb.cl ], [ %.02257, %bb.cm ], [ %.02257, %bb.cn ], [ %.02257, %bb.co ], [ %.02257, %bb.cp ], [ %.02257, %bb.cu ], [ %.02257, %bb.cv ], [ %.02257, %bb.cw ], [ %.02257, %vm_expandarray.exit ], [ %.02257, %vm_concat_array.exit ], [ %.02257, %vm_concat_to_array.exit ], [ %.02257, %bb.dw ], [ %.02257, %vm_splat_array.exit ], [ %.02257, %bb.eh ], [ %.02257, %bb.ej ], [ %.02257, %bb.ek ], [ %.02257, %bb.el ], [ %.02257, %bb.em ], [ %.02257, %ruby_nonempty_memcpy.exit ], [ %.02257, %bb.eq ], [ %.02257, %bb.aeb ], [ %.02257, %bb.es ], [ %.02257, %bb.et ], [ %.02257, %bb.eu ], [ %.02257, %bb.ev ], [ %.02257, %bb.fr ], [ %.02257, %vm_check_match.exit ], [ %.02257, %vm_check_keyword.exit ], [ %.02257, %rb_type.exit ], [ %i.bbb, %vm_push_frame.exit ], [ %.02257, %bb.hn ], [ %.02257, %bb.ho ], [ %i.bgk, %.thread2842 ], [ %.02257, %.thread2844 ], [ %i.bkw, %bb.jz ], [ %.02257, %bb.ka ], [ %i.bpd, %.thread2856 ], [ %.02257, %.thread2858 ], [ %.02257, %bb.lq ], [ %.02257, %bb.ls ], [ %.02257, %bb.lv ], [ %.02257, %bb.ly ], [ %.02257, %bb.mb ], [ %.02257, %bb.ml ], [ %.02257, %bb.mo ], [ %.02257, %vm_opt_duparray_include_p.exit ], [ %.02257, %vm_opt_newarray_hash.exit ], [ %i.cbo, %.thread2870 ], [ %.02257, %.thread2872 ], [ %i.cel, %bb.ou ], [ %.02257, %bb.ov ], [ %i.cgv, %.thread2884 ], [ %.02257, %.thread2886 ], [ %i.ciu, %bb.py ], [ %.02257, %rb_vm_check_ints.exit ], [ %.02257, %bb.qf ], [ %.02257, %bb.qj ], [ %.02257, %bb.qn ], [ %.02257, %vm_once_dispatch.exit ], [ %.02257, %vm_case_dispatch.exit.thread ], [ %.02257, %vm_opt_plus.exit.thread2893 ], [ %.02257, %vm_opt_minus.exit.thread2898 ], [ %.02257, %vm_opt_mult.exit.thread2903 ], [ %.02257, %bb.vl ], [ %.02257, %vm_opt_mod.exit.thread2912 ], [ %.02257, %opt_equality.exit ], [ %.02257, %vm_opt_neq.exit ], [ %.02257, %vm_opt_lt.exit ], [ %.02257, %vm_opt_le.exit ], [ %.02257, %vm_opt_gt.exit ], [ %.02257, %vm_opt_ge.exit ], [ %.02257, %bb.aaq ], [ %.02257, %bb.aas ], [ %.02257, %bb.aav ], [ %.02257, %vm_opt_aref.exit.thread2927 ], [ %.02257, %bb.abv ], [ %.02257, %bb.aby ], [ %.02257, %bb.acb ], [ %.02257, %bb.ace ], [ %.02257, %vm_opt_succ.exit.thread2932 ], [ %.02257, %vm_opt_not.exit ], [ %.02257, %bb.adk ], [ %.02257, %bb.adl ], [ %.02257, %vm_invoke_builtin_delegate.exit ], [ %i.ekl, %bb.adt ], [ %.02257, %bb.adu ], [ %.02257, %.lr.ph.i2774 ], [ %.02257, %vm_env_write.exit2783 ], [ %.02257, %vm_env_write.exit2791 ], [ %.02257, %bb.aea ], [ %.02257, %vm_method_cfunc_is.exit.thread ], [ %.02257, %bb.er ], [ %.02257, %.backedge.loopexit.unr-lcssa ], [ %.02257, %.lr.ph3058.epil.preheader ]
  %.6.be = phi ptr [ %i.as, %bb.c ], [ %i.ax, %vm_get_ep.exit ], [ %i.cz, %vm_env_write.exit ], [ %i.fa, %bb.p ], [ %i.id, %vm_env_write.exit2389 ], [ %i.kg, %bb.ab ], [ %i.nb, %vm_getspecial.exit ], [ %i.ou, %VM_EP_LEP.exit2414 ], [ %i.pj, %vm_getivar.exit ], [ %i.rt, %bb.bn ], [ %i.sd, %vm_getclassvariable.exit ], [ %i.tk, %vm_setclassvariable.exit ], [ %i.ut, %bb.bz ], [ %i.vg, %bb.ca ], [ %i.vu, %vm_ensure_not_refinement_module.exit2434 ], [ %i.wq, %bb.cd ], [ %i.xb, %bb.ce ], [ %i.xf, %bb.cf ], [ %i.xj, %bb.cg ], [ %i.xr, %bb.ch ], [ %i.xx, %bb.ci ], [ %i.yh, %bb.cj ], [ %i.yo, %bb.ck ], [ %i.yv, %bb.cl ], [ %i.zl, %bb.cm ], [ %i.zu, %bb.cn ], [ %i.aal, %bb.co ], [ %i.aar, %bb.cp ], [ %i.abh, %bb.cu ], [ %i.aby, %bb.cv ], [ %i.acf, %bb.cw ], [ %i.acs, %vm_expandarray.exit ], [ %i.aiz, %vm_concat_array.exit ], [ %i.ajs, %vm_concat_to_array.exit ], [ %i.akd, %bb.dw ], [ %i.aku, %vm_splat_array.exit ], [ %i.alm, %bb.eh ], [ %i.alu, %bb.ej ], [ %i.amp, %bb.ek ], [ %i.amw, %bb.el ], [ %i.and, %bb.em ], [ %i.anh, %ruby_nonempty_memcpy.exit ], [ %i.ant, %bb.eq ], [ %i.enj, %bb.aeb ], [ %i.aou, %bb.es ], [ %i.api, %bb.et ], [ %i.apo, %bb.eu ], [ %i.aqd, %bb.ev ], [ %i.aqo, %bb.fr ], [ %i.asy, %vm_check_match.exit ], [ %i.auc, %vm_check_keyword.exit ], [ %i.avb, %rb_type.exit ], [ %i.bbt, %vm_push_frame.exit ], [ %i.bby, %bb.hn ], [ %i.bch, %bb.ho ], [ %i.bgl, %.thread2842 ], [ %i.bco, %.thread2844 ], [ %i.bkx, %bb.jz ], [ %i.bgu, %bb.ka ], [ %i.bpe, %.thread2856 ], [ %i.bld, %.thread2858 ], [ %i.bpm, %bb.lq ], [ %i.brp, %bb.ls ], [ %i.bry, %bb.lv ], [ %i.bsn, %bb.ly ], [ %i.btc, %bb.mb ], [ %i.btw, %bb.ml ], [ %i.bvf, %bb.mo ], [ %i.bvy, %vm_opt_duparray_include_p.exit ], [ %i.bwr, %vm_opt_newarray_hash.exit ], [ %i.cbp, %.thread2870 ], [ %i.bzj, %.thread2872 ], [ %i.cem, %bb.ou ], [ %i.cby, %bb.ov ], [ %i.cgw, %.thread2884 ], [ %i.ces, %.thread2886 ], [ %i.ciw, %bb.py ], [ %i.cjq, %rb_vm_check_ints.exit ], [ %.2, %bb.qf ], [ %.3, %bb.qj ], [ %.4, %bb.qn ], [ %i.clt, %vm_once_dispatch.exit ], [ %.5, %vm_case_dispatch.exit.thread ], [ %i.cpj, %vm_opt_plus.exit.thread2893 ], [ %i.ctx, %vm_opt_minus.exit.thread2898 ], [ %i.cxr, %vm_opt_mult.exit.thread2903 ], [ %i.dbo, %bb.vl ], [ %i.ddv, %vm_opt_mod.exit.thread2912 ], [ %i.dhw, %opt_equality.exit ], [ %i.djq, %vm_opt_neq.exit ], [ %i.dlz, %vm_opt_lt.exit ], [ %i.doo, %vm_opt_le.exit ], [ %i.dre, %vm_opt_gt.exit ], [ %i.dtt, %vm_opt_ge.exit ], [ %i.dwj, %bb.aaq ], [ %i.dxw, %bb.aas ], [ %i.dyh, %bb.aav ], [ %i.dyu, %vm_opt_aref.exit.thread2927 ], [ %i.eax, %bb.abv ], [ %i.eca, %bb.aby ], [ %i.ecj, %bb.acb ], [ %i.ecs, %bb.ace ], [ %i.eda, %vm_opt_succ.exit.thread2932 ], [ %i.eee, %vm_opt_not.exit ], [ %i.efp, %bb.adk ], [ %i.ehb, %bb.adl ], [ %i.ehx, %vm_invoke_builtin_delegate.exit ], [ %i.ekn, %bb.adt ], [ %i.ekt, %bb.adu ], [ %i.ele, %.lr.ph.i2774 ], [ %i.elx, %vm_env_write.exit2783 ], [ %i.emp, %vm_env_write.exit2791 ], [ %i.enf, %bb.aea ], [ %i.brh, %vm_method_cfunc_is.exit.thread ], [ %i.any, %bb.er ], [ %i.any, %.backedge.loopexit.unr-lcssa ], [ %i.any, %.lr.ph3058.epil.preheader ]
  br label %.backedge
...
bb.ew:                                            ; preds = %.backedge, %bb.ahc, %bb.aee
