...
ruby_nonempty_memcpy.exit:                        ; preds = %rbimpl_size_mul_or_raise.exit, %bb.ep
  %i.anj = phi ptr [ %i.ane, %rbimpl_size_mul_or_raise.exit ], [ %.pre3202, %bb.ep ]
...
rbimpl_size_mul_or_raise.exit.thread:             ; preds = %vm_block_iseq.exit
  %i.ai = call noalias nonnull ptr @rb_alloc_tmp_buffer(ptr noundef nonnull %i.b, i64 noundef %i.ag) #61 ; 2 uses
...
bb.i:                                             ; preds = %rbimpl_size_mul_or_raise.exit.thread, %rbimpl_size_mul_or_raise.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 %5, ptr noundef nonnull readonly align 1 %3, i64 noundef %i.af, i1 noundef false) #24
  br label %ruby_nonempty_memcpy.exit
...
bb.ha:                                            ; preds = %bb.gy
  ...
  %i.ahv = inttoptr i64 %i.ahu to ptr
