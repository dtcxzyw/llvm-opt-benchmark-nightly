...
begin_hunk_0_@vm_yield_with_cfunc:bb.a
  ...
  %8 = select i1 %.not, i32 1717960833, i32 1717960897 ; 2 uses
  %9 = or disjoint i32 %8, 1024
  %spec.select = select i1 %.not26, i32 %8, i32 %9
  %10 = zext nneg i32 %spec.select to i64
  %11 = load ptr, ptr %i.a, align 8, !tbaa !27
  ...
  store i64 %10, ptr %i.ae, align 8, !tbaa !11
  ...
  store ptr %11, ptr %.sroa.3.0..sroa_idx.i, align 8, !tbaa !76
...
begin_hunk_2_@vm_invoke_bmethod:bb.a
  ...
  store i64 %11, ptr %i.cf, align 8, !tbaa !11
...
begin_hunk_3_@vm_invoke_bmethod:bb.a
  ...
  store i64 %12, ptr %i.dk, align 8, !tbaa !11
