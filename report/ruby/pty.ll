...
begin_hunk_0_@pty_getpty:bb.a
  ...
  %4 = alloca %struct.pty_info, align 4           ; 6 uses
...
begin_hunk_4_@pty_getpty:bb.a
  ...
  %5 = load i32, ptr %4, align 4, !tbaa !26       ; 2 uses
  %i.at = call i64 @rb_io_open_descriptor(i64 noundef %i.as, i32 noundef %5, i32 noundef 1, i64 noundef %i.ar, i64 noundef 4, ptr noundef null) #9
  %i.au = call i32 @rb_cloexec_dup(i32 noundef %5) #9 ; 2 uses
...
begin_hunk_5_@pty_getpty:bb.a
  ...
  %6 = load i32, ptr %i.an, align 4, !tbaa !24
  %7 = sext i32 %6 to i64
  %8 = shl nsw i64 %7, 1
  %9 = or disjoint i64 %8, 1
  call void @rb_ary_store(i64 noundef %i.ay, i64 noundef 2, i64 noundef %9) #9
