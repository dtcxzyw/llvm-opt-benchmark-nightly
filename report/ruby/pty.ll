...
bb.g:                                             ; preds = %bb.f, %bb.a
  ...
  %i.q = call i64 @rb_execarg_new(i32 noundef %.0.i, ptr noundef %.018.i, i32 noundef 1, i32 noundef 0) #9 ; 3 uses
  ...
  call void @rb_execarg_parent_start(i64 noundef %i.q) #9
...
begin_hunk_2_@pty_getpty:bb.a
  ...
  %i.at = load i32, ptr %4, align 4, !tbaa !26    ; 2 uses
  ...
  %i.av = call i32 @rb_cloexec_dup(i32 noundef %i.at) #9 ; 2 uses
