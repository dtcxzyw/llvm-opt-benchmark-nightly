...
.preheader:                                       ; preds = %bb.a, %bb.b
  ...
  %i.l = icmp samesign ugt i32 %.1.i34, 1         ; 2 uses
  %spec.select = select i1 %i.l, i32 2, i32 1     ; 2 uses
  %i.m = icmp samesign ult i32 %spec.select, %.1.i34
  %5 = select i1 %i.l, i32 3, i32 2
  %.286.i.1 = select i1 %i.m, i32 %5, i32 %spec.select
...
.preheader:                                       ; preds = %bb.a, %bb.b
  ...
  %i.l = icmp samesign ugt i32 %.1.i29, 1         ; 2 uses
  %spec.select = select i1 %i.l, i32 2, i32 1     ; 2 uses
...
.preheader:                                       ; preds = %bb.a, %bb.b
  ...
  %i.k = icmp samesign ugt i32 %.1.i29, 1         ; 2 uses
  %spec.select = select i1 %i.k, i32 2, i32 1     ; 3 uses
...
.preheader:                                       ; preds = %bb.a
  %.not22 = icmp eq i32 %0, 1                     ; 2 uses
  %spec.select = select i1 %.not22, i32 1, i32 2  ; 3 uses
