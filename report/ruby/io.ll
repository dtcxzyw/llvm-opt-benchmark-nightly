...
rb_num2int_inline.exit95:                         ; preds = %bb.ac, %bb.ad
  ...
  %switch.gep156 = getelementptr inbounds nuw i8, ptr @switch.table.io_initialize, i64 %i.ch
...
bb.aq:                                            ; preds = %bb.z
  ...
  br i1 %i.do, label %switch.lookup163, label %bb.ar
...
rb_num2int_inline.exit.1:                         ; preds = %bb.at, %bb.as
  ...
  %switch.gep160 = getelementptr inbounds nuw i8, ptr @switch.table.io_initialize, i64 %i.dt
...
switch.lookup163:                                 ; preds = %bb.aq
  ...
  %switch.gep164 = getelementptr inbounds nuw i8, ptr @switch.table.rb_io_reopen, i64 %i.eg
