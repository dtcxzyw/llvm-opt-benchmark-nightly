...
bb.e:                                             ; preds = %rb_num2int_inline.exit
  %i.l = tail call i32 (i32, i32, ...) @fcntl(i32 noundef %i.i, i32 noundef 3) #28 ; 3 uses
  store i32 %i.l, ptr %i.b, align 4, !tbaa !7
...
begin_hunk_2_@io_initialize:bb.a
  ...
  br i1 %i.y, label %.lr.ph.i, label %rb_update_max_fd.exit.loopexit, !llvm.loop !11

rb_update_max_fd.exit.loopexit:                   ; preds = %.lr.ph.i
  %.pre = load i32, ptr %i.b, align 4, !tbaa !7
  br label %rb_update_max_fd.exit

rb_update_max_fd.exit:                            ; preds = %rb_update_max_fd.exit.loopexit, %bb.g
  %5 = phi i32 [ %.pre, %rb_update_max_fd.exit.loopexit ], [ %i.l, %bb.g ] ; 5 uses
  %i.z = and i32 %5, 3
