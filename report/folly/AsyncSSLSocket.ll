...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i14: ; preds = %bb.m
  %i.bc = load i64, ptr %i.n, align 8, !tbaa !11256
  %i.bd = add i64 %i.bc, 1
...
bb.a:
  ...
  store ptr %i.a, ptr %0, align 8, !tbaa !11257
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  store i64 0, ptr %i.b, align 8, !tbaa !11255
  store i8 0, ptr %i.a, align 8, !tbaa !11256
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !11451
  %i.e = getelementptr inbounds nuw i8, ptr %1, i64 32 ; 3 uses
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !11450 ; 4 uses
  %i.g = ptrtoint ptr %i.d to i64
  %i.h = ptrtoint ptr %i.f to i64
  %i.i = sub i64 %i.g, %i.h
  %.not = icmp ult i64 %i.i, %2
  br i1 %.not, label %bb.l, label %bb.c, !prof !11293

bb.c:                                             ; preds = %bb.b
  %i.j = load i64, ptr %i.b, align 8, !tbaa !11255 ; 5 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i: ; preds = %bb.c
  ...
  %i.n = load ptr, ptr %0, align 8, !tbaa !11254  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE15_M_check_lengthEmmPKc.exit.i
  %i.q = load i64, ptr %i.a, align 8, !tbaa !11256
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i.i
...
bb.g:                                             ; preds = %bb.f
  %i.t = load i8, ptr %i.f, align 1, !tbaa !11256
  store i8 %i.t, ptr %i.s, align 1, !tbaa !11256
  br label %bb.j
...
bb.j:                                             ; preds = %bb.h, %bb.g, %bb.e, %bb.i
  store i64 %i.m, ptr %i.b, align 8, !tbaa !11255
  %i.u = load ptr, ptr %0, align 8, !tbaa !11254
  %i.v = getelementptr inbounds nuw i8, ptr %i.u, i64 %i.m
  store i8 0, ptr %i.v, align 1, !tbaa !11256
  %i.w = load ptr, ptr %i.e, align 8, !tbaa !11450
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 %2
  store ptr %i.x, ptr %i.e, align 8, !tbaa !11450
  br label %bb.m

bb.k:                                             ; preds = %bb.i, %bb.d, %bb.l, %bb.a
  %i.y = landingpad { ptr, i32 }
          cleanup
  %i.z = load ptr, ptr %0, align 8, !tbaa !11254  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.k
  %i.ab = load i64, ptr %i.a, align 8, !tbaa !11256
  %i.ac = add i64 %i.ab, 1
...
bb.a:
  ...
  br i1 %.not, label %bb.c, label %bb.b, !prof !11467
...
bb.a:
  ...
  %.promoted = load ptr, ptr %i.a, align 8, !tbaa !11451 ; 3 uses
  %.promoted28 = load ptr, ptr %i.b, align 8, !tbaa !11450 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !11447 ; 2 uses
  ...
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !11263 ; 2 uses
  %i.m = icmp eq ptr %i.l, %i.g
  %i.n = icmp eq i64 %.promoted36, 0
  %or.cond67 = select i1 %i.m, i1 true, i1 %i.n, !prof !12853
  br i1 %or.cond67, label %.thread, label %.lr.ph69, !prof !12854
...
bb.b:                                             ; preds = %._crit_edge43
  ...
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !11263 ; 2 uses
  %i.r = icmp eq ptr %i.q, %i.g
  %i.s = icmp eq i64 %i.ai, 0
  %or.cond = select i1 %i.r, i1 true, i1 %i.s, !prof !12853
  br i1 %or.cond, label %.thread.loopexit, label %bb.c, !prof !12855, !llvm.loop !12852
...
bb.c:                                             ; preds = %.lr.ph69, %bb.b
  ...
  %i.ae = load ptr, ptr %i.ad, align 8, !tbaa !11264 ; 7 uses
  %i.af = load i64, ptr %i.t, align 8, !tbaa !11266
  %i.ag = getelementptr inbounds nuw i8, ptr %i.ae, i64 %i.af ; 4 uses
  store ptr %i.ag, ptr %i.a, align 8, !tbaa !11451
...
6:                                                ; preds = %2
  ...
  store ptr %7, ptr %i.a, align 8, !tbaa !11451
...
bb.d:                                             ; preds = %6, %2
  ...
  store i64 %i.ah, ptr %i.h, align 8, !tbaa !11448
  br label %._crit_edge43

.thread.loopexit:                                 ; preds = %bb.b
  store i64 %i.ac, ptr %i.j, align 8, !tbaa !11527
  store ptr %i.t, ptr %0, align 8, !tbaa !11446
  store ptr %i.ae, ptr %i.i, align 8, !tbaa !11449
  br label %.thread
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.a
  ...
  store ptr %i.ap, ptr %i.b, align 8, !tbaa !11450
...
bb.e:                                             ; preds = %._crit_edge
  %i.ar = load ptr, ptr %0, align 8, !tbaa !11446
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 32
  %i.at = load ptr, ptr %i.as, align 8, !tbaa !11263 ; 4 uses
  %i.au = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !11447
  %i.aw = icmp eq ptr %i.at, %i.av
  br i1 %i.aw, label %bb.g, label %bb.f, !prof !11293

bb.f:                                             ; preds = %bb.e
  %i.ax = getelementptr inbounds nuw i8, ptr %0, i64 48 ; 2 uses
  %i.ay = load i64, ptr %i.ax, align 8, !tbaa !11448 ; 4 uses
  %i.az = icmp eq i64 %i.ay, 0
  br i1 %i.az, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f, %bb.e
  store ptr %i.an, ptr %i.b, align 8, !tbaa !11450
...
bb.h:                                             ; preds = %bb.f
  ...
  %i.bb = load ptr, ptr %i.ba, align 8, !tbaa !11449
  %i.bc = ptrtoint ptr %i.an to i64
  %i.bd = ptrtoint ptr %i.bb to i64
  %i.be = sub i64 %i.bc, %i.bd
  %i.bf = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 2 uses
  %i.bg = load i64, ptr %i.bf, align 8, !tbaa !11527
  %i.bh = add i64 %i.be, %i.bg
  store i64 %i.bh, ptr %i.bf, align 8, !tbaa !11527
  store ptr %i.at, ptr %0, align 8, !tbaa !11446
  %i.bi = getelementptr inbounds nuw i8, ptr %i.at, i64 8
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !11264 ; 5 uses
  store ptr %i.bj, ptr %i.ba, align 8, !tbaa !11449
  store ptr %i.bj, ptr %i.b, align 8, !tbaa !11450
  %i.bk = load i64, ptr %i.at, align 8, !tbaa !11266
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bj, i64 %i.bk ; 2 uses
  store ptr %i.bl, ptr %i.a, align 8, !tbaa !11451
...
bb.j:                                             ; preds = %bb.i
  ...
  store ptr %i.bq, ptr %i.a, align 8, !tbaa !11451
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  store i64 %i.br, ptr %i.ax, align 8, !tbaa !11448
  br label %_ZN5folly2io10CursorBaseINS0_6CursorEKNS_5IOBufEE20advanceBufferIfEmptyEv.exit
...
bb.a:
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt12out_of_range, i64 16), ptr %0, align 8, !tbaa !455
  ret void
}
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit:
  %i.a = load ptr, ptr %0, align 8, !tbaa !11254
...
bb.c:                                             ; preds = %bb.a
  ...
  br i1 %i.j, label %bb.d, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit, !prof !11293
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit: ; preds = %bb.c
  ...
  %i.l = load ptr, ptr %0, align 8, !tbaa !11254  ; 4 uses
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.n = load i64, ptr %i.m, align 8, !tbaa !11255 ; 2 uses
...
bb.e:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit
  %i.p = load i8, ptr %i.l, align 1, !tbaa !11256
  store i8 %i.p, ptr %i.k, align 1, !tbaa !11256
