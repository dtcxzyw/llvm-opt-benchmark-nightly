...
bb.b:                                             ; preds = %_ZN6google12Check_GEImplImiEEPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKT_RKT0_PKc.exit._crit_edge, %_ZN6google12Check_GEImplImiEEPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKT_RKT0_PKc.exit.thread
  ...
  %6 = fmul <2 x double> %i.ad, splat (double 1.000000e+02) ; 3 uses
  %7 = insertelement <2 x double> %6, double 1.000000e+02, i64 1
  %8 = insertelement <2 x double> %6, double 0.000000e+00, i64 0
  %9 = fcmp ogt <2 x double> %7, %8
  %10 = select <2 x i1> %9, <2 x double> %6, <2 x double> <double 0.000000e+00, double 1.000000e+02> ; 2 uses
  %11 = extractelement <2 x double> %10, i64 0
  %i.ae = call noundef double @_ZNK5folly6detail13SortedSamples10percentileEd(ptr noundef nonnull align 8 dereferenceable(24) %1, double noundef %11)
  store double %i.ae, ptr %0, align 8, !tbaa !31
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 8
  %12 = extractelement <2 x double> %10, i64 1
  %i.ag = call noundef double @_ZNK5folly6detail13SortedSamples10percentileEd(ptr noundef nonnull align 8 dereferenceable(24) %1, double noundef %12)
