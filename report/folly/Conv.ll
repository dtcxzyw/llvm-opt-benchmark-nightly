...
begin_hunk_0_@_ZN3fmt2v96detail6bigint13divmod_assignERKS2_:bb.a
  ...
  br i1 %.not13.i, label %._crit_edge.i15, label %bb.i, !llvm.loop !635

._crit_edge.i15:                                  ; preds = %bb.i
  store i32 %i.en, ptr %i.dj, align 4, !tbaa !236
...
bb.j:                                             ; preds = %bb.k
  ...
  br i1 %i.eu, label %bb.k, label %.critedge.i.i, !llvm.loop !47
...
bb.k:                                             ; preds = %.lr.ph102, %bb.j
  ...
  %i.ey = load i32, ptr %i.ex, align 4, !tbaa !236
  %i.ez = icmp eq i32 %i.ey, 0
  br i1 %i.ez, label %bb.j, label %..critedge.i.i_crit_edge, !llvm.loop !47
...
.critedge.i.i:                                    ; preds = %bb.j, %..critedge.i.i_crit_edge, %.preheader.thread.i
  ...
  %i.fb = load i64, ptr %i.cm, align 8, !tbaa !282 ; 2 uses
...
bb.l:                                             ; preds = %.critedge.i.i
  %i.fd = load ptr, ptr %0, align 8, !tbaa !95
  %i.fe = load ptr, ptr %i.fd, align 8
  tail call void %i.fe(ptr noundef nonnull align 8 dereferenceable(172) %0, i64 noundef %i.fa), !call_target !291, !inline_history !636
  %.pre.i.i.i.i = load i64, ptr %i.cm, align 8, !tbaa !282
...
_ZN3fmt2v96detail6bigint16subtract_alignedERKS2_.exit: ; preds = %.critedge.i.i, %bb.l
  ...
  store i64 %..i.i.i.i, ptr %i.a, align 8, !tbaa !287
  %i.fg = add nuw nsw i32 %.0, 1                  ; 4 uses
  %i.fh = trunc nuw i64 %..i.i.i.i to i32         ; 3 uses
  %i.fi = load i32, ptr %i.d, align 8, !tbaa !286 ; 2 uses
  %i.fj = add nsw i32 %i.fi, %i.fh                ; 2 uses
  %i.fk = load i64, ptr %i.g, align 8, !tbaa !287 ; 2 uses
  %i.fl = trunc i64 %i.fk to i32                  ; 4 uses
  %i.fm = load i32, ptr %i.j, align 8, !tbaa !286
...
bb.o:                                             ; preds = %.lr.ph110
  ...
  br i1 %.not35.not.i21, label %.lr.ph110, label %._crit_edge111, !llvm.loop !45
...
.lr.ph110:                                        ; preds = %bb.n, %bb.o
  ...
  %i.fw = load i32, ptr %i.fv, align 4, !tbaa !236 ; 2 uses
  %i.fx = zext i32 %.0.i23 to i64
  %i.fy = getelementptr inbounds nuw [4 x i8], ptr %i.fr, i64 %i.fx
  %i.fz = load i32, ptr %i.fy, align 4, !tbaa !236 ; 2 uses
  %.not37.i24 = icmp eq i32 %i.fw, %i.fz
  br i1 %.not37.i24, label %bb.o, label %.loopexit.i25, !llvm.loop !45
...
_ZN3fmt2v96detail7compareERKNS1_6bigintES4_.exit26.backedge: ; preds = %.loopexit.i25, %bb.m, %._crit_edge111
  br label %_ZN3fmt2v96detail7compareERKNS1_6bigintES4_.exit26, !llvm.loop !637
...
define linkonce_odr void @_ZN3fmt2v919basic_memory_bufferIjLm32ESaIjEE4growEm(ptr noundef nonnull align 8 dereferenceable(168) %0, i64 noundef %1) unnamed_addr #15 comdat align 2 {
bb.a:
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !281  ; 4 uses
  %i.j = icmp ugt i64 %.0, 2305843009213693951
  br i1 %i.j, label %bb.d, label %_ZNSt15__new_allocatorIjE8allocateEmPKv.exit, !prof !237
...
_ZNSt15__new_allocatorIjE8allocateEmPKv.exit:     ; preds = %bb.c
  ...
  %i.o = load i64, ptr %i.n, align 8, !tbaa !287  ; 3 uses
  %i.p = icmp ugt i64 %i.o, 1
  br i1 %i.p, label %bb.g, label %bb.h, !prof !93
...
bb.i:                                             ; preds = %bb.h
  %i.r = load i32, ptr %i.i, align 4, !tbaa !236
  store i32 %i.r, ptr %i.m, align 4, !tbaa !236
  br label %_ZSt18uninitialized_copyIPjS0_ET0_T_S2_S1_.exit

_ZSt18uninitialized_copyIPjS0_ET0_T_S2_S1_.exit:  ; preds = %bb.g, %bb.h, %bb.i
  store ptr %i.m, ptr %i.h, align 8, !tbaa !281
  store i64 %.0, ptr %i.a, align 8, !tbaa !282
...
bb.j:                                             ; preds = %_ZSt18uninitialized_copyIPjS0_ET0_T_S2_S1_.exit
  %i.t = shl i64 %i.b, 2
  tail call void @_ZdlPvm(ptr noundef %i.i, i64 noundef %i.t) #29
  br label %bb.k
...
; Function Attrs: mustprogress uwtable
define linkonce_odr void @_ZN3fmt2v96detail6bigint6squareEv(ptr noundef nonnull align 8 dereferenceable(172) %0) local_unnamed_addr #15 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %1 = alloca %"class.fmt::v9::basic_memory_buffer.103", align 8 ; 12 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 4 uses
  %i.b = load i64, ptr %i.a, align 8, !tbaa !287  ; 11 uses
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 8) (i8, ptr @_ZTVN3fmt2v919basic_memory_bufferIjLm32ESaIjEEE, i64 16), ptr %1, align 8, !tbaa !95
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 5 uses
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !281  ; 3 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 4 uses
  %i.j = load i64, ptr %i.i, align 8, !tbaa !282  ; 9 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.m, ptr %i.e, align 8, !tbaa !281
  store i64 %i.j, ptr %i.f, align 8, !tbaa !282
...
.lr.ph.i.i.i.preheader:                           ; preds = %bb.b
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.m, ptr nonnull align 8 %i.k, i64 %.idx.i.i, i1 false), !tbaa !236
  br label %_ZN3fmt2v96detail8copy_strIjPjS3_EET1_T0_S5_S4_.exit.i.i

bb.c:                                             ; preds = %bb.a
  store ptr %i.h, ptr %i.e, align 8, !tbaa !281
  store i64 %i.j, ptr %i.f, align 8, !tbaa !282
  store ptr %i.k, ptr %i.g, align 8, !tbaa !281
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  br i1 %i.v, label %bb.g, label %_ZNSt15__new_allocatorIjE8allocateEmPKv.exit.i, !prof !237
...
.noexc112:                                        ; preds = %_ZNSt15__new_allocatorIjE8allocateEmPKv.exit.i
  ...
  %i.aa = load i64, ptr %i.z, align 8, !tbaa !287 ; 3 uses
  %i.ab = icmp ugt i64 %i.aa, 1
  br i1 %i.ab, label %bb.j, label %bb.k, !prof !93
...
bb.l:                                             ; preds = %bb.k
  %i.ad = load i32, ptr %i.n, align 4, !tbaa !236
  store i32 %i.ad, ptr %i.y, align 4, !tbaa !236
  br label %_ZSt18uninitialized_copyIPjS0_ET0_T_S2_S1_.exit.i

_ZSt18uninitialized_copyIPjS0_ET0_T_S2_S1_.exit.i: ; preds = %bb.l, %bb.k, %bb.j
  store ptr %i.y, ptr %i.e, align 8, !tbaa !281
  store i64 %.0.i, ptr %i.f, align 8, !tbaa !282
...
bb.m:                                             ; preds = %_ZSt18uninitialized_copyIPjS0_ET0_T_S2_S1_.exit.i
  %i.af = shl i64 %i.j, 2
  call void @_ZdlPvm(ptr noundef %i.n, i64 noundef %i.af) #29
  %.pre.i.i.i.i.pre = load i64, ptr %i.f, align 8, !tbaa !282
  br label %.noexc.i
...
.noexc.i:                                         ; preds = %bb.m, %_ZSt18uninitialized_copyIPjS0_ET0_T_S2_S1_.exit.i
  ...
  %.pre = load i64, ptr %i.i, align 8, !tbaa !282
...
bb.n:                                             ; preds = %_ZNSt15__new_allocatorIjE8allocateEmPKv.exit.i, %bb.i, %bb.h
  ...
  call void @__clang_call_terminate(ptr %i.ah) #26
  unreachable
...
_ZN3fmt2v919basic_memory_bufferIjLm32ESaIjEEC2EOS3_.exit: ; preds = %_ZN3fmt2v96detail8copy_strIjPjS3_EET1_T0_S5_S4_.exit.i.i, %.noexc.i
  ...
  store i64 %..i.i.i.i, ptr %i.ak, align 8, !tbaa !287
...
bb.o:                                             ; preds = %_ZN3fmt2v919basic_memory_bufferIjLm32ESaIjEEC2EOS3_.exit
  ...
  invoke void %i.ao(ptr noundef nonnull align 8 dereferenceable(168) %0, i64 noundef %i.al)
          to label %.noexc unwind label %bb.p, !inline_history !639

.noexc:                                           ; preds = %bb.o
  %.pre.i.i45 = load i64, ptr %i.i, align 8, !tbaa !282
...
_ZN3fmt2v919basic_memory_bufferIjLm32ESaIjEE6resizeEm.exit: ; preds = %_ZN3fmt2v919basic_memory_bufferIjLm32ESaIjEEC2EOS3_.exit, %.noexc
  ...
  store i64 %..i.i, ptr %i.a, align 8, !tbaa !287
...
.preheader49.lr.ph:                               ; preds = %_ZN3fmt2v919basic_memory_bufferIjLm32ESaIjEE6resizeEm.exit
  %i.ar = load ptr, ptr %i.e, align 8, !tbaa !281 ; 6 uses
...
bb.q:                                             ; preds = %bb.q, %.preheader49.new
  ...
  br i1 %niter.ncmp.1, label %.unr-lcssa, label %bb.q, !llvm.loop !640
...
.epil.preheader:                                  ; preds = %.unr-lcssa, %.preheader49
  ...
  %i.bu = load i32, ptr %i.bt, align 4, !tbaa !236
...
bb.r:                                             ; preds = %.unr-lcssa, %.epil.preheader
  ...
  store i32 %i.cd, ptr %i.cc, align 4, !tbaa !236
  %i.ce = lshr i128 %.lcssa147, 32                ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %indvars.iv.next75 = add nuw nsw i64 %indvars.iv74, 1
  %exitcond80.not = icmp eq i64 %indvars.iv.next, %wide.trip.count79
  br i1 %exitcond80.not, label %.preheader.loopexit, label %.preheader49, !llvm.loop !641
...
bb.s:                                             ; preds = %.lr.ph142
  ...
  br i1 %i.ck, label %.lr.ph142, label %.critedge.i, !llvm.loop !47
...
.lr.ph142:                                        ; preds = %._crit_edge62, %bb.s
  ...
  %i.co = load i32, ptr %i.cn, align 4, !tbaa !236
  %i.cp = icmp eq i32 %i.co, 0
  br i1 %i.cp, label %bb.s, label %..critedge.i_crit_edge, !llvm.loop !47
...
bb.t:                                             ; preds = %.critedge.i
  %i.cs = load ptr, ptr %0, align 8, !tbaa !95
  %i.ct = load ptr, ptr %i.cs, align 8
  invoke void %i.ct(ptr noundef nonnull align 8 dereferenceable(172) %0, i64 noundef %i.cq)
          to label %.noexc46 unwind label %bb.x, !inline_history !642

.noexc46:                                         ; preds = %bb.t
  %.pre.i.i.i = load i64, ptr %i.i, align 8, !tbaa !282
  br label %bb.v
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader
  ...
  %i.cz = load i32, ptr %i.cy, align 4, !tbaa !236
  %i.da = zext i32 %i.cz to i64
  %i.db = load i32, ptr %i.ax, align 4, !tbaa !236
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %i.dt = load i32, ptr %i.ds, align 4, !tbaa !236
  ...
  br i1 %exitcond.1, label %._crit_edge, label %.lr.ph, !llvm.loop !643
...
._crit_edge:                                      ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %bb.u
  ...
  store i32 %i.ec, ptr %i.eb, align 4, !tbaa !236
  %i.ed = lshr i128 %.3.lcssa, 32
  %indvars.iv.next92 = add nuw nsw i64 %indvars.iv91, 1
  %indvars.iv.next82 = add i32 %.03360, 1
  %exitcond91.not = icmp eq i32 %.03360, %i.c
  %indvar.next = add i32 %indvar, 1
  br i1 %exitcond91.not, label %._crit_edge62.loopexit, label %bb.u, !llvm.loop !644
...
bb.v:                                             ; preds = %.noexc46, %.critedge.i
  ...
  store i64 %..i.i.i, ptr %i.a, align 8, !tbaa !287
  %i.ef = getelementptr inbounds nuw i8, ptr %0, i64 168 ; 2 uses
  %i.eg = load i32, ptr %i.ef, align 8, !tbaa !286
  %i.eh = shl nsw i32 %i.eg, 1
  store i32 %i.eh, ptr %i.ef, align 8, !tbaa !286
  %i.ei = load ptr, ptr %i.e, align 8, !tbaa !281 ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  %i.ek = load i64, ptr %i.f, align 8, !tbaa !282
  %i.el = shl i64 %i.ek, 2
...
bb.y:                                             ; preds = %bb.x, %bb.p
  ...
  %i.en = load ptr, ptr %i.e, align 8, !tbaa !281 ; 2 uses
...
bb.z:                                             ; preds = %bb.y
  %i.ep = load i64, ptr %i.f, align 8, !tbaa !282
  %i.eq = shl i64 %i.ep, 2
...
; Function Attrs: mustprogress uwtable
define linkonce_odr void @_ZN3fmt2v912format_errorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef %1) unnamed_addr #15 comdat align 2 {
bb.a:
  tail call void @_ZNSt13runtime_errorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef %1)
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN3fmt2v912format_errorE, i64 16), ptr %0, align 8, !tbaa !95
  ret void
}

; Function Attrs: nounwind
declare void @_ZN3fmt2v912format_errorD1Ev(ptr noundef nonnull align 8 dead_on_return(16) dereferenceable(16)) unnamed_addr #10
...
bb.a:
  ...
  store i8 %i.q, ptr %i.d, align 1, !tbaa !243
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  store i8 %i.x, ptr %i.e, align 1, !tbaa !71
  %i.y = getelementptr inbounds nuw i8, ptr %1, i64 12
  %i.z = load i32, ptr %i.y, align 4, !tbaa !279  ; 3 uses
...
bb.g:                                             ; preds = %bb.e, %bb.f, %bb.d
  ...
  store i8 %i.q, ptr %6, align 8, !tbaa !345
  %i.ap = getelementptr inbounds nuw i8, ptr %6, i64 8
  store ptr %i.k, ptr %i.ap, align 8, !tbaa !346
  %i.aq = getelementptr inbounds nuw i8, ptr %6, i64 16
  store i32 %i.m, ptr %i.aq, align 8, !tbaa !347
  %i.ar = getelementptr inbounds nuw i8, ptr %6, i64 20
  store i8 %i.am, ptr %i.ar, align 4, !tbaa !348
  %i.as = getelementptr inbounds nuw i8, ptr %6, i64 24
  store i32 %.054, ptr %i.as, align 8, !tbaa !349
  %i.at = getelementptr inbounds nuw i8, ptr %6, i64 28
  store i8 48, ptr %i.at, align 4, !tbaa !645
  %i.au = getelementptr inbounds nuw i8, ptr %6, i64 29
  store i8 %i.ao, ptr %i.au, align 1, !tbaa !350
  %i.av = getelementptr inbounds nuw i8, ptr %6, i64 32
  store i32 %i.ab, ptr %i.av, align 8, !tbaa !351
  %i.aw = load i32, ptr %2, align 4, !tbaa !205   ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.bj = getelementptr inbounds nuw i8, ptr %2, i64 9
