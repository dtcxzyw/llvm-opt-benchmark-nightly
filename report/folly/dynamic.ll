...
begin_hunk_0_@_ZN5follyeqERKNS_7dynamicES2_:bb.a
  %.0.i.i32 = phi ptr [ %i.ac, %.lr.ph ], [ %i.v, %.preheader ] ; 2 uses
  %.08.i.i31 = phi ptr [ %i.ab, %.lr.ph ], [ %i.p, %.preheader ] ; 2 uses
  %i.aa = tail call noundef zeroext i1 @_ZN5follyeqERKNS_7dynamicES2_(ptr noundef nonnull align 8 dereferenceable(40) %.08.i.i31, ptr noundef nonnull align 8 dereferenceable(40) %.0.i.i32), !inline_history !265 ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %.08.i.i31, i64 40 ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %.0.i.i32, i64 40
  %.not.i.i = icmp ne ptr %i.ab, %i.o
  %or.cond85.not = select i1 %i.aa, i1 %.not.i.i, i1 false
  br i1 %or.cond85.not, label %.lr.ph, label %_ZSteqIN5folly7dynamicESaIS1_EEbRKSt6vectorIT_T0_ES8_.exit, !llvm.loop !266

bb.f:                                             ; preds = %bb.d
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ae = load i8, ptr %i.ad, align 8, !tbaa !88, !range !81, !noundef !51
  %i.af = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.ag = load i8, ptr %i.af, align 8, !tbaa !88, !range !81, !noundef !51
  %i.ah = icmp eq i8 %i.ae, %i.ag
  br label %_ZSteqIN5folly7dynamicESaIS1_EEbRKSt6vectorIT_T0_ES8_.exit

bb.g:                                             ; preds = %bb.d
  %i.ai = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.aj = load double, ptr %i.ai, align 8, !tbaa !90
  %i.ak = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.al = load double, ptr %i.ak, align 8, !tbaa !90
...
bb.f:                                             ; preds = %bb.e
  call void (ptr, ...) @_ZN5folly6detail21safe_assert_terminateILb0EEEvPKNS0_15safe_assert_argEz(ptr noundef nonnull @_ZZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE6setTagEmmE30__folly_detail_safe_assert_arg_0, ptr noundef nonnull @.str.50) #39
  unreachable

bb.g:                                             ; preds = %bb.e
  store i8 %i.bk, ptr %i.bl, align 1, !tbaa !44
  ...
  %i.bu = load ptr, ptr %i.bt, align 8, !tbaa !112
  store ptr %i.bu, ptr %i.bq, align 8, !tbaa !112
...
bb.h:                                             ; preds = %bb.g, %bb.d
  ...
  br i1 %i.bx, label %bb.d, label %bb.i, !llvm.loop !285
...
bb.i:                                             ; preds = %bb.h
  ...
  store i64 %i.ch, ptr %i.ci, align 8, !tbaa !71
  br label %bb.ad
...
bb.k:                                             ; preds = %bb.j
  ...
  br i1 %i.cj, label %bb.l, label %bb.m, !prof !69
...
bb.o:                                             ; preds = %bb.m
  ...
  %.pre161 = load i64, ptr %i.b, align 8, !tbaa !71
  %.pre162 = load i64, ptr %i.a, align 8, !tbaa !71 ; 2 uses
...
.loopexit:                                        ; preds = %bb.y, %.lr.ph150
  ...
  br i1 %.not59, label %._crit_edge, label %.lr.ph150, !llvm.loop !286
...
.lr.ph150:                                        ; preds = %.lr.ph150.preheader, %.loopexit
  ...
  %i.cp = load <16 x i8>, ptr %.043149, align 16, !tbaa !44
...
bb.p:                                             ; preds = %.lr.ph, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit
  ...
  br i1 %.not.i74, label %bb.q, label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit, !prof !69
...
_ZN5folly3f146detail13DenseMaskIter4nextEv.exit:  ; preds = %bb.p, %bb.q
  ...
  %i.dd = load ptr, ptr %i.dc, align 8, !tbaa !112
...
.lr.ph145:                                        ; preds = %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit, %bb.y
  ...
  br i1 %.not.i76, label %bb.r, label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit78, !prof !69
...
.lr.ph.i80:                                       ; preds = %bb.v, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i
  ...
  %i.ek = load i8, ptr %i.ej, align 1, !tbaa !119 ; 2 uses
...
bb.w:                                             ; preds = %.lr.ph.i80
  %i.el = add i8 %i.ek, 1
  store i8 %i.el, ptr %i.ej, align 1, !tbaa !119
...
_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i: ; preds = %bb.w, %.lr.ph.i80
  ...
  %i.eq = load i8, ptr %i.ep, align 1, !tbaa !44  ; 2 uses
  %i.er = icmp ult i8 %i.eq, 14
  br i1 %i.er, label %._crit_edge.i, label %.lr.ph.i80, !prof !132, !llvm.loop !9
...
bb.y:                                             ; preds = %._crit_edge.i
  ...
  store i8 %i.ey, ptr %i.ev, align 1, !tbaa !44
  %i.ez = getelementptr inbounds nuw i8, ptr %.lcssa21.i, i64 14 ; 2 uses
  %i.fa = load i8, ptr %i.ez, align 2, !tbaa !123
  %i.fb = add i8 %i.fa, %.0.lcssa.i
  store i8 %i.fb, ptr %i.ez, align 2, !tbaa !123
  ...
  %i.fg = load ptr, ptr %i.dm, align 8, !tbaa !112
  store ptr %i.fg, ptr %i.fe, align 8, !tbaa !112
  store ptr null, ptr %i.dm, align 8, !tbaa !112
  %.not127 = icmp eq i32 %.sroa.088.1, 0
  br i1 %.not127, label %.loopexit, label %.lr.ph145, !llvm.loop !287

._crit_edge:                                      ; preds = %.loopexit, %bb.o
  %.0125177 = phi ptr [ %i.ck, %bb.o ], [ %.0125176, %.loopexit ] ; 2 uses
  %i.fh = load i64, ptr %i.ba, align 8, !tbaa !108
...
bb.z:                                             ; preds = %._crit_edge, %bb.z
  ...
  %i.fl = load i8, ptr %i.fk, align 1, !tbaa !44  ; 3 uses
  %i.fm = icmp eq i8 %i.fl, 0
  br i1 %i.fm, label %bb.z, label %bb.aa, !llvm.loop !288

bb.aa:                                            ; preds = %bb.z
  %i.fn = load ptr, ptr %0, align 8, !tbaa !116
  ...
  store i64 %i.fz, ptr %i.ga, align 8, !tbaa !71
...
bb.ab:                                            ; preds = %bb.aa
  call void @_ZdlPvm(ptr noundef nonnull %.0125177, i64 noundef %4) #34
...
bb.ac:                                            ; preds = %bb.u
  call void @_ZdlPvm(ptr noundef nonnull %.0125176, i64 noundef %4) #34
  br label %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail8F14TableINS3_19NodeContainerPolicyINS_7dynamicES6_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvEEE10rehashImplEmmmmmEUlvE0_Lb1EED2Ev.exit81
...
_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail8F14TableINS3_19NodeContainerPolicyINS_7dynamicES6_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvEEE10rehashImplEmmmmmEUlvE0_Lb1EED2Ev.exit81: ; preds = %bb.ac, %bb.u, %bb.n
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #32
  call void @_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail8F14TableINS3_19NodeContainerPolicyINS_7dynamicES6_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvEEE10rehashImplEmmmmmEUlvE_Lb1EED2Ev(ptr noundef nonnull align 8 dead_on_return(96) dereferenceable(96) %6) #32
...
bb.ad:                                            ; preds = %bb.i, %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail8F14TableINS3_19NodeContainerPolicyINS_7dynamicES6_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvEEE10rehashImplEmmmmmEUlvE0_Lb1EED2Ev.exit, %_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE16initializeChunksEPhmm.exit
  store i8 1, ptr %i.j, align 1, !tbaa !88
  %i.gb = load i64, ptr %i.d, align 8, !tbaa !71
...
bb.ae:                                            ; preds = %bb.ad
  %i.gc = load ptr, ptr %i.c, align 8, !tbaa !121 ; 2 uses
...
bb.af:                                            ; preds = %bb.ae
  %i.gd = load i64, ptr %i.e, align 8, !tbaa !71
  call void @_ZdlPvm(ptr noundef nonnull %i.gc, i64 noundef %i.gd) #32
...
define linkonce_odr void @_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE26buildFromF14TableCatchColdEPS9_(ptr noundef %0) local_unnamed_addr #26 comdat align 2 {
bb.a:
  tail call void @_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE5resetEv(ptr noundef nonnull align 8 dereferenceable(24) %0) #32
...
bb.a:
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %0, align 8, !tbaa !48
...
bb.a:
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.a, align 8, !tbaa !48
...
bb.a:
  %i.a = load i8, ptr %0, align 8, !tbaa !125, !range !81, !noundef !51
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !295, !nonnull !51
  %i.e = load i8, ptr %i.d, align 1, !tbaa !88, !range !81, !noundef !51
  %i.f = trunc nuw i8 %i.e to i1
  br i1 %i.f, label %bb.c, label %bb.e, !prof !70

bb.c:                                             ; preds = %bb.b
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !296, !nonnull !51, !align !52
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !297, !nonnull !51, !align !52
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !121
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !298, !nonnull !51, !align !52
  %i.o = load i64, ptr %i.n, align 8, !tbaa !71
  br label %bb.f

bb.e:                                             ; preds = %bb.b
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !299  ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !300, !nonnull !51, !align !52
  %i.t = load ptr, ptr %i.s, align 8, !tbaa !34
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.v = load ptr, ptr %i.u, align 8, !tbaa !301, !nonnull !51, !align !52
  %i.w = load i64, ptr %i.v, align 8, !tbaa !71
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.y = load ptr, ptr %i.x, align 8, !tbaa !297, !nonnull !51, !align !52
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !121
  store ptr %i.z, ptr %i.q, align 8, !tbaa !116
  %i.aa = getelementptr inbounds nuw i8, ptr %i.q, i64 8 ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 64
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !302, !nonnull !51, !align !52
  %i.ad = load i64, ptr %i.ac, align 8, !tbaa !71 ; 2 uses
  %i.ae = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %i.ad, i1 true)
  %i.af = icmp eq i64 %i.ad, 0
  %i.ag = load i64, ptr %i.aa, align 8, !tbaa !108
  %i.ah = and i64 %i.ag, -256
  %i.ai = select i1 %i.af, i64 4294967295, i64 %i.ae
  %i.aj = or i64 %i.ah, %i.ai
  store i64 %i.aj, ptr %i.aa, align 8, !tbaa !108
  tail call void @_ZN5folly3f146detail12F14LinkCheckILNS1_17F14IntrinsicsModeE1EE5checkEv() #32
  br label %bb.f
...
; Function Attrs: mustprogress uwtable
define linkonce_odr void @_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE15directBuildFromIRKS9_EEvOT_(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull align 8 dereferenceable(24) %1) local_unnamed_addr #22 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  %i.c = load i64, ptr %i.b, align 8, !tbaa !108  ; 2 uses
  %i.d = and i64 %i.c, 255
  %i.e = load ptr, ptr %0, align 8, !tbaa !116
  %i.f = load ptr, ptr %1, align 8, !tbaa !116
  %notmask = shl nsw i64 -1, %i.d
  %i.g = xor i64 %notmask, -1
  %i.h = shl nsw i64 %i.g, 7                      ; 2 uses
  %i.i = getelementptr inbounds nuw i8, ptr %i.f, i64 %i.h
  %i.j = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.h
  br label %bb.b

bb.b:                                             ; preds = %._crit_edge, %bb.a
  %i.k = phi i64 [ %i.bl, %._crit_edge ], [ %i.c, %bb.a ]
  %.039 = phi ptr [ %i.bm, %._crit_edge ], [ %i.i, %bb.a ] ; 8 uses
  %.038 = phi ptr [ %i.bn, %._crit_edge ], [ %i.j, %bb.a ] ; 5 uses
  %i.l = getelementptr inbounds nuw i8, ptr %.039, i64 14
  %i.m = load i8, ptr %i.l, align 2, !tbaa !123
  %i.n = and i8 %i.m, -16
  %i.o = getelementptr inbounds nuw i8, ptr %.038, i64 14 ; 2 uses
  %i.p = load i8, ptr %i.o, align 2, !tbaa !123
  %i.q = add i8 %i.p, %i.n
  store i8 %i.q, ptr %i.o, align 2, !tbaa !123
  %i.r = getelementptr inbounds nuw i8, ptr %.039, i64 15
  %i.s = load i8, ptr %i.r, align 1, !tbaa !119
  %i.t = getelementptr inbounds nuw i8, ptr %.038, i64 15
  store i8 %i.s, ptr %i.t, align 1, !tbaa !119
  %i.u = load <16 x i8>, ptr %.039, align 16, !tbaa !44
  %i.v = icmp eq <16 x i8> %i.u, zeroinitializer
  %i.w = bitcast <16 x i1> %i.v to i16
  %i.x = and i16 %i.w, 16383                      ; 2 uses
  %i.y = xor i16 %i.x, 16383
  %.sroa.075.0.extract.trunc = zext nneg i16 %i.y to i32 ; 2 uses
  %cond = icmp eq i16 %i.x, 16383
  br i1 %cond, label %._crit_edge, label %.lr.ph

.lr.ph103:                                        ; preds = %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit
  %i.z = icmp ne ptr %.039, @_ZZN5folly3f146detail20getF14EmptyTagVectorEvE8instance
  tail call void @llvm.assume(i1 %i.z)
  br label %bb.d

.lr.ph:                                           ; preds = %bb.b, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit
  %.sroa.072.098 = phi i32 [ %.sroa.072.1, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit ], [ %.sroa.075.0.extract.trunc, %bb.b ] ; 3 uses
  %.sroa.8.097 = phi i32 [ %.sroa.8.1, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit ], [ 0, %bb.b ] ; 2 uses
  %i.aa = and i32 %.sroa.072.098, 1
  %.not.i = icmp eq i32 %i.aa, 0
  br i1 %.not.i, label %bb.c, label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit, !prof !69

bb.c:                                             ; preds = %.lr.ph
  %i.ab = tail call noundef range(i32 0, 32) i32 @llvm.cttz.i32(i32 %.sroa.072.098, i1 true) ; 2 uses
  %i.ac = add i32 %i.ab, %.sroa.8.097
  %i.ad = add nuw nsw i32 %i.ab, 1
  br label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit

_ZN5folly3f146detail13DenseMaskIter4nextEv.exit:  ; preds = %.lr.ph, %bb.c
  %.sroa.8.1.in = phi i32 [ %i.ac, %bb.c ], [ %.sroa.8.097, %.lr.ph ] ; 2 uses
  %.pn93 = phi i32 [ %i.ad, %bb.c ], [ 1, %.lr.ph ]
  %.sroa.072.1 = lshr i32 %.sroa.072.098, %.pn93  ; 2 uses
  %.sroa.8.1 = add i32 %.sroa.8.1.in, 1
  %i.ae = zext i32 %.sroa.8.1.in to i64
  %i.af = shl nuw nsw i64 %i.ae, 3
  %i.ag = getelementptr i8, ptr %.039, i64 %i.af
  ...
  %.not91 = icmp eq i32 %.sroa.072.1, 0
  br i1 %.not91, label %.lr.ph103, label %.lr.ph

bb.d:                                             ; preds = %.lr.ph103, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE6setTagEmm.exit
  %.0102 = phi i64 [ 0, %.lr.ph103 ], [ %i.bk, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE6setTagEmm.exit ] ; 3 uses
  %.sroa.075.0101 = phi i32 [ %.sroa.075.0.extract.trunc, %.lr.ph103 ], [ %.sroa.075.1, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE6setTagEmm.exit ] ; 3 uses
  %.sroa.877.0100 = phi i32 [ 0, %.lr.ph103 ], [ %.sroa.877.1, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE6setTagEmm.exit ] ; 2 uses
  %i.aj = and i32 %.sroa.075.0101, 1
  %.not.i68 = icmp eq i32 %i.aj, 0
  br i1 %.not.i68, label %bb.e, label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit70, !prof !69

bb.e:                                             ; preds = %bb.d
  %i.ak = tail call noundef range(i32 0, 32) i32 @llvm.cttz.i32(i32 %.sroa.075.0101, i1 true) ; 2 uses
  %i.al = add i32 %i.ak, %.sroa.877.0100
  %i.am = add nuw nsw i32 %i.ak, 1
  br label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit70

_ZN5folly3f146detail13DenseMaskIter4nextEv.exit70: ; preds = %bb.d, %bb.e
  %.sroa.877.1.in = phi i32 [ %i.al, %bb.e ], [ %.sroa.877.0100, %bb.d ] ; 2 uses
  %.pn = phi i32 [ %i.am, %bb.e ], [ 1, %bb.d ]
  %.sroa.075.1 = lshr i32 %.sroa.075.0101, %.pn   ; 2 uses
  %.sroa.877.1 = add i32 %.sroa.877.1.in, 1
  %i.an = zext i32 %.sroa.877.1.in to i64         ; 2 uses
  %i.ao = shl nuw nsw i64 %i.an, 3
  %i.ap = getelementptr i8, ptr %.039, i64 %i.ao
  %i.aq = getelementptr i8, ptr %i.ap, i64 16
  %i.ar = load ptr, ptr %i.aq, align 8, !tbaa !112 ; 2 uses
  %i.as = shl i64 %.0102, 3
  %i.at = getelementptr i8, ptr %.038, i64 %i.as
  %i.au = getelementptr i8, ptr %i.at, i64 16     ; 2 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.au) ]
  %i.av = tail call noalias noundef nonnull dereferenceable(80) ptr @_Znwm(i64 noundef 80) #37, !inline_history !303 ; 5 uses
  store ptr %i.av, ptr %i.au, align 8, !tbaa !112
  invoke void @_ZN5folly7dynamicC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(80) %i.av, ptr noundef nonnull align 8 dereferenceable(80) %i.ar)
          to label %.noexc.i unwind label %bb.g, !inline_history !304

.noexc.i:                                         ; preds = %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit70
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 40
  %i.ax = getelementptr inbounds nuw i8, ptr %i.ar, i64 40
  invoke void @_ZN5folly7dynamicC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(40) %i.aw, ptr noundef nonnull align 8 dereferenceable(40) %i.ax)
          to label %_ZN5folly3f146detail19NodeContainerPolicyINS_7dynamicES3_NS_6detail13DynamicHasherENS4_15DynamicKeyEqualEvE20constructValueAtItemIiJRKSt4pairIKS3_S3_EEEEvOT_PPSB_DpOT0_.exit unwind label %bb.f, !inline_history !305

bb.f:                                             ; preds = %.noexc.i
  %i.ay = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZN5folly7dynamic7destroyEv(ptr noundef nonnull align 8 dereferenceable(80) %i.av) #32, !inline_history !306
...
bb.g:                                             ; preds = %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit70
  %i.az = landingpad { ptr, i32 }
          cleanup
  br label %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail19NodeContainerPolicyINS_7dynamicES5_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvE20constructValueAtItemIiJRKSt4pairIKS5_S5_EEEEvOT_PPSC_DpOT0_EUlvE_Lb1EED2Ev.exit9.i

_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail19NodeContainerPolicyINS_7dynamicES5_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvE20constructValueAtItemIiJRKSt4pairIKS5_S5_EEEEvOT_PPSC_DpOT0_EUlvE_Lb1EED2Ev.exit9.i: ; preds = %bb.g, %bb.f
  %eh.lpad-body.i = phi { ptr, i32 } [ %i.az, %bb.g ], [ %i.ay, %bb.f ]
  tail call void @_ZdlPvm(ptr noundef nonnull %i.av, i64 noundef 80) #34, !inline_history !303
...
_ZN5folly3f146detail19NodeContainerPolicyINS_7dynamicES3_NS_6detail13DynamicHasherENS4_15DynamicKeyEqualEvE20constructValueAtItemIiJRKSt4pairIKS3_S3_EEEEvOT_PPSB_DpOT0_.exit: ; preds = %.noexc.i
  %i.ba = getelementptr inbounds nuw i8, ptr %.038, i64 %.0102 ; 2 uses
  %i.bb = load i8, ptr %i.ba, align 1, !tbaa !44
  %i.bc = icmp eq i8 %i.bb, 0
  br i1 %i.bc, label %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE6setTagEmm.exit, label %bb.h

bb.h:                                             ; preds = %_ZN5folly3f146detail19NodeContainerPolicyINS_7dynamicES3_NS_6detail13DynamicHasherENS4_15DynamicKeyEqualEvE20constructValueAtItemIiJRKSt4pairIKS3_S3_EEEEvOT_PPSB_DpOT0_.exit
...
_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE6setTagEmm.exit: ; preds = %_ZN5folly3f146detail19NodeContainerPolicyINS_7dynamicES3_NS_6detail13DynamicHasherENS4_15DynamicKeyEqualEvE20constructValueAtItemIiJRKSt4pairIKS3_S3_EEEEvOT_PPSB_DpOT0_.exit
  %i.bd = getelementptr inbounds nuw i8, ptr %.039, i64 %i.an
  %i.be = load i8, ptr %i.bd, align 1, !tbaa !44
  store i8 %i.be, ptr %i.ba, align 1, !tbaa !44
  %i.bf = load i64, ptr %i.b, align 8, !tbaa !108 ; 2 uses
  %i.bg = and i64 %i.bf, -256
  %i.bh = add i64 %i.bg, 256
  %i.bi = and i64 %i.bf, 255
  %i.bj = or disjoint i64 %i.bh, %i.bi            ; 2 uses
  store i64 %i.bj, ptr %i.b, align 8, !tbaa !108
  %i.bk = add i64 %.0102, 1
  %.not92 = icmp eq i32 %.sroa.075.1, 0
  br i1 %.not92, label %._crit_edge, label %bb.d, !llvm.loop !307

._crit_edge:                                      ; preds = %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE6setTagEmm.exit, %bb.b
  %i.bl = phi i64 [ %i.k, %bb.b ], [ %i.bj, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE6setTagEmm.exit ] ; 2 uses
  %i.bm = getelementptr inbounds i8, ptr %.039, i64 -128
  %i.bn = getelementptr inbounds i8, ptr %.038, i64 -128
  %i.bo = load i64, ptr %i.a, align 8, !tbaa !108
  %.not.unshifted = xor i64 %i.bo, %i.bl
  %.not = icmp ult i64 %.not.unshifted, 256
  br i1 %.not, label %bb.i, label %bb.b, !llvm.loop !308

bb.i:                                             ; preds = %._crit_edge
  %i.bp = load ptr, ptr %1, align 8, !tbaa !116
  %i.bq = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.br = load i64, ptr %i.bq, align 8, !tbaa !110 ; 3 uses
  %i.bs = and i64 %i.br, -8
  %i.bt = shl i64 %i.br, 1
  %i.bu = and i64 %i.bt, 14
  %i.bv = shl i64 %i.br, 60
  %i.bw = ashr i64 %i.bv, 63
  %.neg.i = sub nsw i64 %i.bw, %i.bu
  %.neg.i.i.i = shl nsw i64 %.neg.i, 3
  %i.bx = ptrtoint ptr %i.bp to i64
  %reass.sub = sub i64 %i.bs, %i.bx
  %i.by = add i64 %reass.sub, -16
  %i.bz = add i64 %i.by, %.neg.i.i.i
  %i.ca = and i64 %i.bz, -128
  %i.cb = load ptr, ptr %0, align 8, !tbaa !116
  %i.cc = getelementptr inbounds i8, ptr %i.cb, i64 %i.ca ; 3 uses
  %i.cd = load <16 x i8>, ptr %i.cc, align 16, !tbaa !44
  %i.ce = icmp eq <16 x i8> %i.cd, zeroinitializer
  %i.cf = bitcast <16 x i1> %i.ce to i16
  %i.cg = and i16 %i.cf, 16383                    ; 2 uses
  %i.ch = xor i16 %i.cg, 16383
  %i.ci = zext nneg i16 %i.ch to i32
  %i.cj = icmp ne i16 %i.cg, 16383
  tail call void @llvm.assume(i1 %i.cj)
  %i.ck = tail call range(i32 0, 33) i32 @llvm.ctlz.i32(i32 %i.ci, i1 true)
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.e, label %bb.c, label %_ZNSt15__new_allocatorIhE8allocateEmPKv.exit, !prof !69
...
_ZNSt15__new_allocatorIhE8allocateEmPKv.exit:     ; preds = %bb.b
  %i.f = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.d) #37
  br label %bb.d

bb.d:                                             ; preds = %_ZNSt15__new_allocatorIhE8allocateEmPKv.exit, %bb.a
  %.0133 = phi ptr [ %i.f, %_ZNSt15__new_allocatorIhE8allocateEmPKv.exit ], [ %2, %bb.a ] ; 9 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %.0133, i8 0, i64 %i.d, i1 false)
  %i.g = load ptr, ptr %1, align 8, !tbaa !116
  %i.h = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.i = load i64, ptr %i.h, align 8, !tbaa !110  ; 3 uses
  %i.j = and i64 %i.i, -8
  %i.k = shl i64 %i.i, 1
  %i.l = and i64 %i.k, 14
  %i.m = shl i64 %i.i, 60
  %i.n = ashr i64 %i.m, 63
  %.neg.i = sub nsw i64 %i.n, %i.l
  %.neg.i.i.i = shl nsw i64 %.neg.i, 3
  %i.o = ptrtoint ptr %i.g to i64
  %reass.sub = sub i64 %i.j, %i.o
  %i.p = add i64 %reass.sub, -16
  %i.q = add i64 %i.p, %.neg.i.i.i
  %i.r = lshr i64 %i.q, 7
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 4 uses
  br label %bb.e

bb.e:                                             ; preds = %.loopexit, %bb.d
  %.0125 = phi i64 [ %i.r, %bb.d ], [ %i.gc, %.loopexit ] ; 5 uses
  %i.t = load ptr, ptr %1, align 8, !tbaa !116
  %i.u = shl nsw i64 %.0125, 7
  %i.v = getelementptr inbounds i8, ptr %i.t, i64 %i.u ; 7 uses
  %i.w = load <16 x i8>, ptr %i.v, align 16       ; 2 uses
  %i.x = icmp eq <16 x i8> %i.w, zeroinitializer
  %i.y = bitcast <16 x i1> %i.x to i16
  %i.z = and i16 %i.y, 16383                      ; 2 uses
  %i.aa = xor i16 %i.z, 16383
  %.sroa.097.0.extract.trunc = zext nneg i16 %i.aa to i32 ; 3 uses
  %.not136148 = icmp eq i16 %i.z, 16383
  %i.ab = extractelement <16 x i8> %i.w, i64 14
  br i1 %.not136148, label %.loopexit, label %.lr.ph
...
._crit_edge:                                      ; preds = %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit
  %i.ad = icmp ult i8 %i.ab, 16
  br i1 %i.ad, label %.lr.ph158, label %.lr.ph154

bb.f:                                             ; preds = %.lr.ph, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit
  %.sroa.094.0150 = phi i32 [ %.sroa.097.0.extract.trunc, %.lr.ph ], [ %.sroa.094.1, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit ] ; 3 uses
  %.sroa.8.0149 = phi i32 [ 0, %.lr.ph ], [ %.sroa.8.1, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit ] ; 2 uses
  %i.ae = and i32 %.sroa.094.0150, 1
  %.not.i = icmp eq i32 %i.ae, 0
  br i1 %.not.i, label %bb.g, label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit, !prof !69

bb.g:                                             ; preds = %bb.f
  %i.af = tail call noundef range(i32 0, 32) i32 @llvm.cttz.i32(i32 %.sroa.094.0150, i1 true) ; 2 uses
  %i.ag = add i32 %i.af, %.sroa.8.0149
  %i.ah = add nuw nsw i32 %i.af, 1
  br label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit

_ZN5folly3f146detail13DenseMaskIter4nextEv.exit:  ; preds = %bb.f, %bb.g
  %.sroa.8.1.in = phi i32 [ %i.ag, %bb.g ], [ %.sroa.8.0149, %bb.f ] ; 2 uses
  %.pn140 = phi i32 [ %i.ah, %bb.g ], [ 1, %bb.f ]
  %.sroa.094.1 = lshr i32 %.sroa.094.0150, %.pn140 ; 2 uses
  %.sroa.8.1 = add i32 %.sroa.8.1.in, 1
  %i.ai = zext i32 %.sroa.8.1.in to i64
  ...
  %.not136 = icmp eq i32 %.sroa.094.1, 0
  br i1 %.not136, label %._crit_edge, label %bb.f

.lr.ph158:                                        ; preds = %._crit_edge, %bb.r
  %.sroa.097.0157 = phi i32 [ %.sroa.097.2, %bb.r ], [ %.sroa.097.0.extract.trunc, %._crit_edge ] ; 3 uses
  %.sroa.12.0156 = phi i32 [ %.sroa.12.2, %bb.r ], [ 0, %._crit_edge ] ; 2 uses
  %i.an = and i32 %.sroa.097.0157, 1
  %.not.i58 = icmp eq i32 %i.an, 0
  br i1 %.not.i58, label %bb.h, label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit60, !prof !69

bb.h:                                             ; preds = %.lr.ph158
  %i.ao = tail call noundef range(i32 0, 32) i32 @llvm.cttz.i32(i32 %.sroa.097.0157, i1 true) ; 2 uses
  %i.ap = add i32 %i.ao, %.sroa.12.0156
  %i.aq = add nuw nsw i32 %i.ao, 1
  br label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit60

_ZN5folly3f146detail13DenseMaskIter4nextEv.exit60: ; preds = %.lr.ph158, %bb.h
  %.sroa.12.2.in = phi i32 [ %i.ap, %bb.h ], [ %.sroa.12.0156, %.lr.ph158 ] ; 2 uses
  %.pn139 = phi i32 [ %i.aq, %bb.h ], [ 1, %.lr.ph158 ]
  %.sroa.097.2 = lshr i32 %.sroa.097.0157, %.pn139 ; 2 uses
  ...
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !112 ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %i.v, i64 %i.ar
  %i.ax = load i8, ptr %i.aw, align 1, !tbaa !44  ; 2 uses
  %i.ay = zext i8 %i.ax to i64                    ; 2 uses
  %i.az = shl nuw nsw i64 %i.ay, 1
  %i.ba = or disjoint i64 %i.az, 1
  %i.bb = load i64, ptr %i.a, align 8, !tbaa !108
  %i.bc = and i64 %i.bb, 255
  %notmask.i.i = shl nsw i64 -1, %i.bc
  %i.bd = xor i64 %notmask.i.i, -1                ; 2 uses
  %i.be = load ptr, ptr %0, align 8, !tbaa !116   ; 2 uses
  %i.bf = and i64 %.0125, %i.bd                   ; 4 uses
  %i.bg = shl nsw i64 %i.bf, 7                    ; 2 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %.0133, i64 %i.bf
  %i.bi = load i8, ptr %i.bh, align 1, !tbaa !44  ; 2 uses
  %i.bj = icmp ult i8 %i.bi, 14
  br i1 %i.bj, label %._crit_edge.i, label %.lr.ph.i, !prof !131

.lr.ph.i:                                         ; preds = %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit60, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i
  %i.bk = phi i64 [ %i.bs, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i ], [ %i.bg, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit60 ]
  %i.bl = phi i64 [ %i.br, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i ], [ %i.bf, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit60 ]
  %i.bm = getelementptr inbounds nuw i8, ptr %i.be, i64 %i.bk
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 15 ; 2 uses
  %i.bo = load i8, ptr %i.bn, align 1, !tbaa !119 ; 2 uses
  %.not.i.i = icmp eq i8 %i.bo, -2
  br i1 %.not.i.i, label %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i, label %bb.i

bb.i:                                             ; preds = %.lr.ph.i
  %i.bp = add i8 %i.bo, 1
  store i8 %i.bp, ptr %i.bn, align 1, !tbaa !119
  br label %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i

_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i: ; preds = %bb.i, %.lr.ph.i
  %i.bq = add i64 %i.ba, %i.bl
  %i.br = and i64 %i.bq, %i.bd                    ; 4 uses
  %i.bs = shl nsw i64 %i.br, 7                    ; 2 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %.0133, i64 %i.br
  %i.bu = load i8, ptr %i.bt, align 1, !tbaa !44  ; 2 uses
  %i.bv = icmp ult i8 %i.bu, 14
  br i1 %i.bv, label %._crit_edge.i, label %.lr.ph.i, !prof !132, !llvm.loop !9

._crit_edge.i:                                    ; preds = %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit60
  %.lcssa22.i = phi i64 [ %i.bf, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit60 ], [ %i.br, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i ]
  %.0.lcssa.i = phi i8 [ 0, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit60 ], [ 16, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i ]
  %.pn.i = phi i64 [ %i.bg, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit60 ], [ %i.bs, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i ]
  %.lcssa.i = phi i8 [ %i.bi, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit60 ], [ %i.bu, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i ] ; 2 uses
  %.lcssa21.i = getelementptr inbounds nuw i8, ptr %i.be, i64 %.pn.i ; 4 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %.0133, i64 %.lcssa22.i
  %i.bx = add nuw nsw i8 %.lcssa.i, 1
  store i8 %i.bx, ptr %i.bw, align 1, !tbaa !44
  %i.by = zext nneg i8 %.lcssa.i to i64           ; 4 uses
...
bb.k:                                             ; preds = %._crit_edge.i
  store i8 %i.ax, ptr %i.bz, align 1, !tbaa !44
  %i.cc = getelementptr inbounds nuw i8, ptr %.lcssa21.i, i64 14 ; 2 uses
  %i.cd = load i8, ptr %i.cc, align 2, !tbaa !123
  %i.ce = add i8 %i.cd, %.0.lcssa.i
  store i8 %i.ce, ptr %i.cc, align 2, !tbaa !123
  %i.cf = shl nuw nsw i64 %i.by, 3
  %i.cg = getelementptr i8, ptr %.lcssa21.i, i64 %i.cf
  %i.ch = getelementptr i8, ptr %i.cg, i64 16     ; 4 uses
  ...
  %i.cj = invoke noalias noundef nonnull dereferenceable(80) ptr @_Znwm(i64 noundef 80) #37
          to label %.noexc.i unwind label %bb.n, !inline_history !309 ; 5 uses

.noexc.i:                                         ; preds = %bb.k
  store ptr %i.cj, ptr %i.ch, align 8, !tbaa !112
  invoke void @_ZN5folly7dynamicC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(80) %i.cj, ptr noundef nonnull align 8 dereferenceable(80) %i.av)
          to label %.noexc.i.i.i unwind label %bb.m, !inline_history !310
...
.noexc.i.i.i:                                     ; preds = %.noexc.i
  ...
  invoke void @_ZN5folly7dynamicC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(40) %i.ck, ptr noundef nonnull align 8 dereferenceable(40) %i.cl)
          to label %_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS5_S5_EEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSE_EEEESC_ImmEDpOT_EUlvE_PFvPSA_SM_SN_EJSS_RSM_RSN_EvEET2_OT_OT0_DpOT1_.exit.i unwind label %bb.l, !inline_history !311

bb.l:                                             ; preds = %.noexc.i.i.i
  %i.cm = landingpad { ptr, i32 }
          catch ptr null
  tail call void @_ZN5folly7dynamic7destroyEv(ptr noundef nonnull align 8 dereferenceable(80) %i.cj) #32, !inline_history !312
  br label %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail19NodeContainerPolicyINS_7dynamicES5_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvE20constructValueAtItemIRNS3_8F14TableIS8_EEJRKSt4pairIKS5_S5_EEEEvOT_PPSF_DpOT0_EUlvE_Lb1EED2Ev.exit9.i.i.i
...
_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail19NodeContainerPolicyINS_7dynamicES5_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvE20constructValueAtItemIRNS3_8F14TableIS8_EEJRKSt4pairIKS5_S5_EEEEvOT_PPSF_DpOT0_EUlvE_Lb1EED2Ev.exit9.i.i.i: ; preds = %bb.m, %bb.l
  %eh.lpad-body.i.i.i = phi { ptr, i32 } [ %i.cn, %bb.m ], [ %i.cm, %bb.l ]
  tail call void @_ZdlPvm(ptr noundef nonnull %i.cj, i64 noundef 80) #34, !inline_history !313
  br label %.body.i
...
.body.i:                                          ; preds = %bb.n, %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail19NodeContainerPolicyINS_7dynamicES5_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvE20constructValueAtItemIRNS3_8F14TableIS8_EEJRKSt4pairIKS5_S5_EEEEvOT_PPSF_DpOT0_EUlvE_Lb1EED2Ev.exit9.i.i.i
  %eh.lpad-body.i = phi { ptr, i32 } [ %i.co, %bb.n ], [ %eh.lpad-body.i.i.i, %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail19NodeContainerPolicyINS_7dynamicES5_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvE20constructValueAtItemIRNS3_8F14TableIS8_EEJRKSt4pairIKS5_S5_EEEEvOT_PPSF_DpOT0_EUlvE_Lb1EED2Ev.exit9.i.i.i ]
  %i.cp = extractvalue { ptr, i32 } %eh.lpad-body.i, 0
  %i.cq = tail call ptr @__cxa_begin_catch(ptr %i.cp) #32, !inline_history !314 ; 0 uses
  invoke void @_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE14eraseBlankColdEPS9_NS1_11F14ItemIterIPNS1_8F14ChunkIPSt4pairIKS4_S4_EEEEESD_ImmE(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr nonnull %i.ch, i64 %i.by, i64 %.0125, i64 %i.ay)
          to label %_ZN5folly11invoke_coldIPFvPNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEEENS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairIKS5_S5_EEEEESE_ImmEEJSB_RSK_RSL_ESM_TnNSt9enable_ifIXsr3std11is_functionIT1_EE5valueEiE4typeELi0EvEET3_OT_DpOT0_.exit.i unwind label %bb.o, !inline_history !314
...
_ZN5folly11invoke_coldIPFvPNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEEENS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairIKS5_S5_EEEEESE_ImmEEJSB_RSK_RSL_ESM_TnNSt9enable_ifIXsr3std11is_functionIT1_EE5valueEiE4typeELi0EvEET3_OT_DpOT0_.exit.i: ; preds = %.body.i
  invoke void @__cxa_end_catch()
          to label %_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS5_S5_EEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSE_EEEESC_ImmEDpOT_EUlvE_PFvPSA_SM_SN_EJSS_RSM_RSN_EvEET2_OT_OT0_DpOT1_.exit.i unwind label %bb.s, !inline_history !314

bb.o:                                             ; preds = %.body.i
  %i.cr = landingpad { ptr, i32 }
          cleanup
  invoke void @__cxa_end_catch()
          to label %.body unwind label %bb.p, !inline_history !314

bb.p:                                             ; preds = %bb.o
  %i.cs = landingpad { ptr, i32 }
          catch ptr null
  %i.ct = extractvalue { ptr, i32 } %i.cs, 0
  tail call void @__clang_call_terminate(ptr %i.ct) #33, !inline_history !314
  unreachable

_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS5_S5_EEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSE_EEEESC_ImmEDpOT_EUlvE_PFvPSA_SM_SN_EJSS_RSM_RSN_EvEET2_OT_OT0_DpOT1_.exit.i: ; preds = %_ZN5folly11invoke_coldIPFvPNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEEENS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairIKS5_S5_EEEEESE_ImmEEJSB_RSK_RSL_ESM_TnNSt9enable_ifIXsr3std11is_functionIT1_EE5valueEiE4typeELi0EvEET3_OT_DpOT0_.exit.i, %.noexc.i.i.i
  %i.cu = lshr i64 %i.by, 1
  %i.cv = ptrtoint ptr %i.ch to i64
  %i.cw = or i64 %i.cu, %i.cv                     ; 2 uses
  %i.cx = load i64, ptr %i.s, align 8, !tbaa !110
  %i.cy = icmp ult i64 %i.cx, %i.cw
  br i1 %i.cy, label %bb.q, label %bb.r

bb.q:                                             ; preds = %_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS5_S5_EEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSE_EEEESC_ImmEDpOT_EUlvE_PFvPSA_SM_SN_EJSS_RSM_RSN_EvEET2_OT_OT0_DpOT1_.exit.i
  store i64 %i.cw, ptr %i.s, align 8, !tbaa !71
  br label %bb.r
...
bb.r:                                             ; preds = %bb.q, %_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS5_S5_EEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSE_EEEESC_ImmEDpOT_EUlvE_PFvPSA_SM_SN_EJSS_RSM_RSN_EvEET2_OT_OT0_DpOT1_.exit.i
  %i.cz = load i64, ptr %i.a, align 8, !tbaa !108 ; 2 uses
  %i.da = and i64 %i.cz, -256
  %i.db = add i64 %i.da, 256
  %i.dc = and i64 %i.cz, 255
  %i.dd = or disjoint i64 %i.db, %i.dc
  store i64 %i.dd, ptr %i.a, align 8, !tbaa !108
  %.not138 = icmp eq i32 %.sroa.097.2, 0
  br i1 %.not138, label %.loopexit, label %.lr.ph158, !llvm.loop !315

bb.s:                                             ; preds = %_ZN5folly11invoke_coldIPFvPNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEEENS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairIKS5_S5_EEEEESE_ImmEEJSB_RSK_RSL_ESM_TnNSt9enable_ifIXsr3std11is_functionIT1_EE5valueEiE4typeELi0EvEET3_OT_DpOT0_.exit.i
  %i.de = landingpad { ptr, i32 }
          cleanup
  br label %.body

.lr.ph154:                                        ; preds = %._crit_edge, %_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS4_S4_EEEEvNS1_11F14ItemIterIPNS1_8F14ChunkIPSD_EEEESB_ImmEDpOT_.exit89
  %.sroa.097.1153 = phi i32 [ %.sroa.097.3, %_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS4_S4_EEEEvNS1_11F14ItemIterIPNS1_8F14ChunkIPSD_EEEESB_ImmEDpOT_.exit89 ], [ %.sroa.097.0.extract.trunc, %._crit_edge ] ; 3 uses
  %.sroa.12.1152 = phi i32 [ %.sroa.12.3, %_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS4_S4_EEEEvNS1_11F14ItemIterIPNS1_8F14ChunkIPSD_EEEESB_ImmEDpOT_.exit89 ], [ 0, %._crit_edge ] ; 2 uses
  %i.df = and i32 %.sroa.097.1153, 1
  %.not.i61 = icmp eq i32 %i.df, 0
  br i1 %.not.i61, label %bb.t, label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit63, !prof !69

bb.t:                                             ; preds = %.lr.ph154
  %i.dg = tail call noundef range(i32 0, 32) i32 @llvm.cttz.i32(i32 %.sroa.097.1153, i1 true) ; 2 uses
  %i.dh = add i32 %i.dg, %.sroa.12.1152
  %i.di = add nuw nsw i32 %i.dg, 1
  br label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit63

_ZN5folly3f146detail13DenseMaskIter4nextEv.exit63: ; preds = %.lr.ph154, %bb.t
  %.sroa.12.3.in = phi i32 [ %i.dh, %bb.t ], [ %.sroa.12.1152, %.lr.ph154 ] ; 2 uses
  %.pn = phi i32 [ %i.di, %bb.t ], [ 1, %.lr.ph154 ]
  %.sroa.097.3 = lshr i32 %.sroa.097.1153, %.pn   ; 2 uses
  %.sroa.12.3 = add i32 %.sroa.12.3.in, 1
  %i.dj = zext i32 %.sroa.12.3.in to i64          ; 2 uses
  %i.dk = shl nuw nsw i64 %i.dj, 3
  %i.dl = getelementptr i8, ptr %i.v, i64 %i.dk
  %i.dm = getelementptr i8, ptr %i.dl, i64 16
  %i.dn = load ptr, ptr %i.dm, align 8, !tbaa !112 ; 3 uses
  %i.do = invoke noundef i64 @_ZNK5folly7dynamic4hashEv(ptr noundef nonnull align 8 dereferenceable(40) %i.dn)
          to label %bb.u unwind label %bb.w       ; 3 uses

bb.u:                                             ; preds = %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit63
  %i.dp = lshr i64 %i.do, 56
  %.sroa.speculated.i.i.i = tail call i64 @llvm.umax.i64(i64 %i.dp, i64 1) ; 4 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %i.v, i64 %i.dj
  %i.dr = load i8, ptr %i.dq, align 1, !tbaa !44
  %i.ds = zext i8 %i.dr to i64
  %i.dt = icmp eq i64 %.sroa.speculated.i.i.i, %i.ds
...
bb.w:                                             ; preds = %_ZN5folly11invoke_coldIPFvPNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEEENS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairIKS5_S5_EEEEESE_ImmEEJSB_RSK_RSL_ESM_TnNSt9enable_ifIXsr3std11is_functionIT1_EE5valueEiE4typeELi0EvEET3_OT_DpOT0_.exit.i80, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit63
  %i.du = landingpad { ptr, i32 }
          cleanup
  br label %.body

bb.x:                                             ; preds = %bb.u
  %i.dv = shl nuw nsw i64 %.sroa.speculated.i.i.i, 1
  %i.dw = or disjoint i64 %i.dv, 1
  %i.dx = load i64, ptr %i.a, align 8, !tbaa !108
  %i.dy = and i64 %i.dx, 255
  %notmask.i.i65 = shl nsw i64 -1, %i.dy
  %i.dz = xor i64 %notmask.i.i65, -1              ; 2 uses
  %i.ea = load ptr, ptr %0, align 8, !tbaa !116   ; 2 uses
  %i.eb = and i64 %i.do, %i.dz                    ; 4 uses
  %i.ec = shl nsw i64 %i.eb, 7                    ; 2 uses
  %i.ed = getelementptr inbounds nuw i8, ptr %.0133, i64 %i.eb
  %i.ee = load i8, ptr %i.ed, align 1, !tbaa !44  ; 2 uses
  %i.ef = icmp ult i8 %i.ee, 14
  br i1 %i.ef, label %._crit_edge.i69, label %.lr.ph.i66, !prof !131

.lr.ph.i66:                                       ; preds = %bb.x, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i68
  %i.eg = phi i64 [ %i.eo, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i68 ], [ %i.ec, %bb.x ]
  %i.eh = phi i64 [ %i.en, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i68 ], [ %i.eb, %bb.x ]
  %i.ei = getelementptr inbounds nuw i8, ptr %i.ea, i64 %i.eg
  %i.ej = getelementptr inbounds nuw i8, ptr %i.ei, i64 15 ; 2 uses
  %i.ek = load i8, ptr %i.ej, align 1, !tbaa !119 ; 2 uses
  %.not.i.i67 = icmp eq i8 %i.ek, -2
  br i1 %.not.i.i67, label %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i68, label %bb.y

bb.y:                                             ; preds = %.lr.ph.i66
  %i.el = add i8 %i.ek, 1
  store i8 %i.el, ptr %i.ej, align 1, !tbaa !119
  br label %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i68

_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i68: ; preds = %bb.y, %.lr.ph.i66
  %i.em = add nuw i64 %i.dw, %i.eh
  %i.en = and i64 %i.em, %i.dz                    ; 4 uses
  %i.eo = shl nsw i64 %i.en, 7                    ; 2 uses
  %i.ep = getelementptr inbounds nuw i8, ptr %.0133, i64 %i.en
  %i.eq = load i8, ptr %i.ep, align 1, !tbaa !44  ; 2 uses
  %i.er = icmp ult i8 %i.eq, 14
  br i1 %i.er, label %._crit_edge.i69, label %.lr.ph.i66, !prof !132, !llvm.loop !9

._crit_edge.i69:                                  ; preds = %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i68, %bb.x
  %.lcssa22.i70 = phi i64 [ %i.eb, %bb.x ], [ %i.en, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i68 ]
  %.0.lcssa.i71 = phi i8 [ 0, %bb.x ], [ 16, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i68 ]
  %.pn.i72 = phi i64 [ %i.ec, %bb.x ], [ %i.eo, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i68 ]
  %.lcssa.i73 = phi i8 [ %i.ee, %bb.x ], [ %i.eq, %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE25incrOutboundOverflowCountEv.exit.i68 ] ; 2 uses
  %.lcssa21.i74 = getelementptr inbounds nuw i8, ptr %i.ea, i64 %.pn.i72 ; 4 uses
  %i.es = getelementptr inbounds nuw i8, ptr %.0133, i64 %.lcssa22.i70
  %i.et = add nuw nsw i8 %.lcssa.i73, 1
  store i8 %i.et, ptr %i.es, align 1, !tbaa !44
  %i.eu = zext nneg i8 %.lcssa.i73 to i64         ; 4 uses
  %i.ev = getelementptr inbounds nuw i8, ptr %.lcssa21.i74, i64 %i.eu ; 2 uses
  %i.ew = load i8, ptr %i.ev, align 1, !tbaa !44
  %i.ex = icmp eq i8 %i.ew, 0
  br i1 %i.ex, label %bb.aa, label %bb.z

bb.z:                                             ; preds = %._crit_edge.i69
  tail call void (ptr, ...) @_ZN5folly6detail21safe_assert_terminateILb0EEEvPKNS0_15safe_assert_argEz(ptr noundef nonnull @_ZZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE6setTagEmmE30__folly_detail_safe_assert_arg_0, ptr noundef nonnull @.str.50) #39
  unreachable

bb.aa:                                            ; preds = %._crit_edge.i69
  %i.ey = trunc nuw i64 %.sroa.speculated.i.i.i to i8
  store i8 %i.ey, ptr %i.ev, align 1, !tbaa !44
  %i.ez = getelementptr inbounds nuw i8, ptr %.lcssa21.i74, i64 14 ; 2 uses
  %i.fa = load i8, ptr %i.ez, align 2, !tbaa !123
  %i.fb = add i8 %i.fa, %.0.lcssa.i71
  store i8 %i.fb, ptr %i.ez, align 2, !tbaa !123
  %i.fc = shl nuw nsw i64 %i.eu, 3
  %i.fd = getelementptr i8, ptr %.lcssa21.i74, i64 %i.fc
  %i.fe = getelementptr i8, ptr %i.fd, i64 16     ; 4 uses
  %i.ff = icmp ne ptr %.lcssa21.i74, @_ZZN5folly3f146detail20getF14EmptyTagVectorEvE8instance
  tail call void @llvm.assume(i1 %i.ff)
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.fe) ]
  %i.fg = invoke noalias noundef nonnull dereferenceable(80) ptr @_Znwm(i64 noundef 80) #37
          to label %.noexc.i82 unwind label %bb.ad, !inline_history !309 ; 5 uses

.noexc.i82:                                       ; preds = %bb.aa
  store ptr %i.fg, ptr %i.fe, align 8, !tbaa !112
  invoke void @_ZN5folly7dynamicC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(80) %i.fg, ptr noundef nonnull align 8 dereferenceable(80) %i.dn)
          to label %.noexc.i.i.i85 unwind label %bb.ac, !inline_history !310

.noexc.i.i.i85:                                   ; preds = %.noexc.i82
  %i.fh = getelementptr inbounds nuw i8, ptr %i.fg, i64 40
  %i.fi = getelementptr inbounds nuw i8, ptr %i.dn, i64 40
  invoke void @_ZN5folly7dynamicC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(40) %i.fh, ptr noundef nonnull align 8 dereferenceable(40) %i.fi)
          to label %_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS5_S5_EEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSE_EEEESC_ImmEDpOT_EUlvE_PFvPSA_SM_SN_EJSS_RSM_RSN_EvEET2_OT_OT0_DpOT1_.exit.i81 unwind label %bb.ab, !inline_history !311

bb.ab:                                            ; preds = %.noexc.i.i.i85
  %i.fj = landingpad { ptr, i32 }
          catch ptr null
  tail call void @_ZN5folly7dynamic7destroyEv(ptr noundef nonnull align 8 dereferenceable(80) %i.fg) #32, !inline_history !312
  br label %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail19NodeContainerPolicyINS_7dynamicES5_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvE20constructValueAtItemIRNS3_8F14TableIS8_EEJRKSt4pairIKS5_S5_EEEEvOT_PPSF_DpOT0_EUlvE_Lb1EED2Ev.exit9.i.i.i83

bb.ac:                                            ; preds = %.noexc.i82
  %i.fk = landingpad { ptr, i32 }
          catch ptr null
  br label %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail19NodeContainerPolicyINS_7dynamicES5_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvE20constructValueAtItemIRNS3_8F14TableIS8_EEJRKSt4pairIKS5_S5_EEEEvOT_PPSF_DpOT0_EUlvE_Lb1EED2Ev.exit9.i.i.i83

_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail19NodeContainerPolicyINS_7dynamicES5_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvE20constructValueAtItemIRNS3_8F14TableIS8_EEJRKSt4pairIKS5_S5_EEEEvOT_PPSF_DpOT0_EUlvE_Lb1EED2Ev.exit9.i.i.i83: ; preds = %bb.ac, %bb.ab
  %eh.lpad-body.i.i.i84 = phi { ptr, i32 } [ %i.fk, %bb.ac ], [ %i.fj, %bb.ab ]
  tail call void @_ZdlPvm(ptr noundef nonnull %i.fg, i64 noundef 80) #34, !inline_history !313
  br label %.body.i78
...
.body.i78:                                        ; preds = %bb.ad, %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail19NodeContainerPolicyINS_7dynamicES5_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvE20constructValueAtItemIRNS3_8F14TableIS8_EEJRKSt4pairIKS5_S5_EEEEvOT_PPSF_DpOT0_EUlvE_Lb1EED2Ev.exit9.i.i.i83
  %eh.lpad-body.i79 = phi { ptr, i32 } [ %i.fl, %bb.ad ], [ %eh.lpad-body.i.i.i84, %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail19NodeContainerPolicyINS_7dynamicES5_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvE20constructValueAtItemIRNS3_8F14TableIS8_EEJRKSt4pairIKS5_S5_EEEEvOT_PPSF_DpOT0_EUlvE_Lb1EED2Ev.exit9.i.i.i83 ]
  %i.fm = extractvalue { ptr, i32 } %eh.lpad-body.i79, 0
  %i.fn = tail call ptr @__cxa_begin_catch(ptr %i.fm) #32, !inline_history !314 ; 0 uses
  invoke void @_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE14eraseBlankColdEPS9_NS1_11F14ItemIterIPNS1_8F14ChunkIPSt4pairIKS4_S4_EEEEESD_ImmE(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr nonnull %i.fe, i64 %i.eu, i64 %i.do, i64 %.sroa.speculated.i.i.i)
          to label %_ZN5folly11invoke_coldIPFvPNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEEENS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairIKS5_S5_EEEEESE_ImmEEJSB_RSK_RSL_ESM_TnNSt9enable_ifIXsr3std11is_functionIT1_EE5valueEiE4typeELi0EvEET3_OT_DpOT0_.exit.i80 unwind label %bb.ae, !inline_history !314

_ZN5folly11invoke_coldIPFvPNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEEENS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairIKS5_S5_EEEEESE_ImmEEJSB_RSK_RSL_ESM_TnNSt9enable_ifIXsr3std11is_functionIT1_EE5valueEiE4typeELi0EvEET3_OT_DpOT0_.exit.i80: ; preds = %.body.i78
  invoke void @__cxa_end_catch()
          to label %_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS5_S5_EEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSE_EEEESC_ImmEDpOT_EUlvE_PFvPSA_SM_SN_EJSS_RSM_RSN_EvEET2_OT_OT0_DpOT1_.exit.i81 unwind label %bb.w, !inline_history !314

bb.ae:                                            ; preds = %.body.i78
  %i.fo = landingpad { ptr, i32 }
          cleanup
  invoke void @__cxa_end_catch()
          to label %.body unwind label %bb.af, !inline_history !314

bb.af:                                            ; preds = %bb.ae
  %i.fp = landingpad { ptr, i32 }
          catch ptr null
  %i.fq = extractvalue { ptr, i32 } %i.fp, 0
  tail call void @__clang_call_terminate(ptr %i.fq) #33, !inline_history !314
  unreachable

_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS5_S5_EEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSE_EEEESC_ImmEDpOT_EUlvE_PFvPSA_SM_SN_EJSS_RSM_RSN_EvEET2_OT_OT0_DpOT1_.exit.i81: ; preds = %_ZN5folly11invoke_coldIPFvPNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEEENS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairIKS5_S5_EEEEESE_ImmEEJSB_RSK_RSL_ESM_TnNSt9enable_ifIXsr3std11is_functionIT1_EE5valueEiE4typeELi0EvEET3_OT_DpOT0_.exit.i80, %.noexc.i.i.i85
  %i.fr = lshr i64 %i.eu, 1
  %i.fs = ptrtoint ptr %i.fe to i64
  %i.ft = or i64 %i.fr, %i.fs                     ; 2 uses
  %i.fu = load i64, ptr %i.s, align 8, !tbaa !110
  %i.fv = icmp ult i64 %i.fu, %i.ft
  br i1 %i.fv, label %bb.ag, label %_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS4_S4_EEEEvNS1_11F14ItemIterIPNS1_8F14ChunkIPSD_EEEESB_ImmEDpOT_.exit89

bb.ag:                                            ; preds = %_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS5_S5_EEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSE_EEEESC_ImmEDpOT_EUlvE_PFvPSA_SM_SN_EJSS_RSM_RSN_EvEET2_OT_OT0_DpOT1_.exit.i81
  store i64 %i.ft, ptr %i.s, align 8, !tbaa !71
  br label %_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS4_S4_EEEEvNS1_11F14ItemIterIPNS1_8F14ChunkIPSD_EEEESB_ImmEDpOT_.exit89

_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS4_S4_EEEEvNS1_11F14ItemIterIPNS1_8F14ChunkIPSD_EEEESB_ImmEDpOT_.exit89: ; preds = %_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS5_S5_EEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSE_EEEESC_ImmEDpOT_EUlvE_PFvPSA_SM_SN_EJSS_RSM_RSN_EvEET2_OT_OT0_DpOT1_.exit.i81, %bb.ag
  %i.fw = load i64, ptr %i.a, align 8, !tbaa !108 ; 2 uses
  %i.fx = and i64 %i.fw, -256
  %i.fy = add i64 %i.fx, 256
  %i.fz = and i64 %i.fw, 255
  %i.ga = or disjoint i64 %i.fy, %i.fz
  store i64 %i.ga, ptr %i.a, align 8, !tbaa !108
  %.not137 = icmp eq i32 %.sroa.097.3, 0
  br i1 %.not137, label %.loopexit, label %.lr.ph154

.loopexit:                                        ; preds = %_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE13insertAtBlankIJRKSt4pairIKS4_S4_EEEEvNS1_11F14ItemIterIPNS1_8F14ChunkIPSD_EEEESB_ImmEDpOT_.exit89, %bb.r, %bb.e
  %i.gb = icmp eq i64 %.0125, 0
  %i.gc = add nsw i64 %.0125, -1
  br i1 %i.gb, label %bb.ah, label %bb.e

bb.ah:                                            ; preds = %.loopexit
  br i1 %.not, label %bb.ai, label %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail8F14TableINS3_19NodeContainerPolicyINS_7dynamicES6_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvEEE15rehashBuildFromIRKSA_EEvOT_EUlvE_Lb1EED2Ev.exit

bb.ai:                                            ; preds = %bb.ah
  call void @_ZdlPvm(ptr noundef nonnull %.0133, i64 noundef %i.d) #34
...
_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail8F14TableINS3_19NodeContainerPolicyINS_7dynamicES6_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvEEE15rehashBuildFromIRKSA_EEvOT_EUlvE_Lb1EED2Ev.exit: ; preds = %bb.ah, %bb.ai
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #32
  ret void

.body:                                            ; preds = %bb.ae, %bb.w, %bb.s, %bb.o
  %.pn54.pn.pn = phi { ptr, i32 } [ %i.fo, %bb.ae ], [ %i.du, %bb.w ], [ %i.cr, %bb.o ], [ %i.de, %bb.s ]
  br i1 %.not, label %bb.aj, label %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail8F14TableINS3_19NodeContainerPolicyINS_7dynamicES6_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvEEE15rehashBuildFromIRKSA_EEvOT_EUlvE_Lb1EED2Ev.exit90

bb.aj:                                            ; preds = %.body
  call void @_ZdlPvm(ptr noundef nonnull %.0133, i64 noundef %i.d) #34
  br label %_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail8F14TableINS3_19NodeContainerPolicyINS_7dynamicES6_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvEEE15rehashBuildFromIRKSA_EEvOT_EUlvE_Lb1EED2Ev.exit90

_ZN5folly6detail14ScopeGuardImplIZNS_3f146detail8F14TableINS3_19NodeContainerPolicyINS_7dynamicES6_NS0_13DynamicHasherENS0_15DynamicKeyEqualEvEEE15rehashBuildFromIRKSA_EEvOT_EUlvE_Lb1EED2Ev.exit90: ; preds = %.body, %bb.aj
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #32
  resume { ptr, i32 } %.pn54.pn.pn
}

; Function Attrs: cold mustprogress noinline optsize uwtable
define linkonce_odr void @_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE14eraseBlankColdEPS9_NS1_11F14ItemIterIPNS1_8F14ChunkIPSt4pairIKS4_S4_EEEEESD_ImmE(ptr noundef %0, ptr %1, i64 %2, i64 %3, i64 %4) local_unnamed_addr #26 comdat align 2 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  tail call void (ptr, ...) @_ZN5folly6detail21safe_assert_terminateILb0EEEvPKNS0_15safe_assert_argEz(ptr noundef nonnull @_ZZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE8clearTagEmE30__folly_detail_safe_assert_arg, ptr noundef nonnull @.str.50) #39
  unreachable
...
_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE8clearTagEm.exit: ; preds = %bb.a
  ...
  %i.f = load i8, ptr %i.e, align 2, !tbaa !123
...
bb.c:                                             ; preds = %_ZN5folly3f146detail8F14ChunkIPSt4pairIKNS_7dynamicES4_EE8clearTagEm.exit
  ...
  %i.m = load ptr, ptr %0, align 8, !tbaa !116    ; 4 uses
  %i.n = and i64 %3, %i.l
...
.thread:                                          ; preds = %bb.e, %bb.c
  ...
  %i.u = load i8, ptr %i.t, align 2, !tbaa !123
  %i.v = add i8 %i.u, %.010.lcssa
  store i8 %i.v, ptr %i.t, align 2, !tbaa !123
  br label %bb.f
...
.lr.ph:                                           ; preds = %bb.c, %bb.e
  ...
  %i.z = load i8, ptr %i.y, align 1, !tbaa !119   ; 2 uses
  %.not.i17 = icmp eq i8 %i.z, -2
  br i1 %.not.i17, label %bb.e, label %bb.d

bb.d:                                             ; preds = %.lr.ph
  %i.aa = add i8 %i.z, -1
  store i8 %i.aa, ptr %i.y, align 1, !tbaa !119
  br label %bb.e
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr void @_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE5resetEv(ptr noundef nonnull align 8 dereferenceable(24) %0) local_unnamed_addr #7 comdat align 2 {
bb.a:
...
bb.a:
  ...
  %i.c = load i8, ptr %i.b, align 1, !tbaa !135
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.g, label %bb.h, label %.preheader38

.preheader38:                                     ; preds = %bb.b, %._crit_edge
  %i.h = phi i64 [ %i.al, %._crit_edge ], [ %i.f, %bb.b ]
  %.02346 = phi i64 [ %i.am, %._crit_edge ], [ 0, %bb.b ] ; 2 uses
  %i.i = load ptr, ptr %0, align 8, !tbaa !116
  %i.j = shl nsw i64 %.02346, 7
  %i.k = getelementptr inbounds i8, ptr %i.i, i64 %i.j ; 4 uses
  %i.l = load <16 x i8>, ptr %i.k, align 16, !tbaa !44
  %i.m = icmp eq <16 x i8> %i.l, zeroinitializer
  %i.n = bitcast <16 x i1> %i.m to i16
  %i.o = and i16 %i.n, 16383                      ; 2 uses
  %i.p = xor i16 %i.o, 16383
  %.sroa.032.0.extract.trunc = zext nneg i16 %i.p to i32 ; 2 uses
  %cond = icmp eq i16 %i.o, 16383
  br i1 %cond, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader38
  %i.q = icmp ne ptr %i.k, @_ZZN5folly3f146detail20getF14EmptyTagVectorEvE8instance
  tail call void @llvm.assume(i1 %i.q)
  br label %bb.c

bb.c:                                             ; preds = %.lr.ph, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit
  %.sroa.029.041 = phi i32 [ %.sroa.032.0.extract.trunc, %.lr.ph ], [ %.sroa.029.1, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit ] ; 3 uses
  %.sroa.7.040 = phi i32 [ 0, %.lr.ph ], [ %.sroa.7.1, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit ] ; 2 uses
  %i.r = and i32 %.sroa.029.041, 1
  %.not.i = icmp eq i32 %i.r, 0
  br i1 %.not.i, label %bb.d, label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit, !prof !69

bb.d:                                             ; preds = %bb.c
  %i.s = tail call noundef range(i32 0, 32) i32 @llvm.cttz.i32(i32 %.sroa.029.041, i1 true) ; 2 uses
  %i.t = add i32 %i.s, %.sroa.7.040
  %i.u = add nuw nsw i32 %i.s, 1
  br label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit

_ZN5folly3f146detail13DenseMaskIter4nextEv.exit:  ; preds = %bb.c, %bb.d
  %.sroa.7.1.in = phi i32 [ %i.t, %bb.d ], [ %.sroa.7.040, %bb.c ] ; 2 uses
  %.pn37 = phi i32 [ %i.u, %bb.d ], [ 1, %bb.c ]
  %.sroa.029.1 = lshr i32 %.sroa.029.041, %.pn37  ; 2 uses
  %.sroa.7.1 = add i32 %.sroa.7.1.in, 1
  %i.v = zext i32 %.sroa.7.1.in to i64
  %i.w = shl nuw nsw i64 %i.v, 3
  %i.x = getelementptr i8, ptr %i.k, i64 %i.w
  ...
  br i1 %.not, label %.lr.ph45, label %bb.c
...
.lr.ph45:                                         ; preds = %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit, %_ZN5folly3f146detail19NodeContainerPolicyINS_7dynamicES3_NS_6detail13DynamicHasherENS4_15DynamicKeyEqualEvE11destroyItemERPSt4pairIKS3_S3_E.exit
  %.sroa.734.044 = phi i32 [ %.sroa.734.1, %_ZN5folly3f146detail19NodeContainerPolicyINS_7dynamicES3_NS_6detail13DynamicHasherENS4_15DynamicKeyEqualEvE11destroyItemERPSt4pairIKS3_S3_E.exit ], [ 0, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit ] ; 2 uses
  %.sroa.032.043 = phi i32 [ %.sroa.032.1, %_ZN5folly3f146detail19NodeContainerPolicyINS_7dynamicES3_NS_6detail13DynamicHasherENS4_15DynamicKeyEqualEvE11destroyItemERPSt4pairIKS3_S3_E.exit ], [ %.sroa.032.0.extract.trunc, %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit ] ; 3 uses
  %i.aa = and i32 %.sroa.032.043, 1
  %.not.i24 = icmp eq i32 %i.aa, 0
  br i1 %.not.i24, label %bb.e, label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit26, !prof !69

bb.e:                                             ; preds = %.lr.ph45
  %i.ab = tail call noundef range(i32 0, 32) i32 @llvm.cttz.i32(i32 %.sroa.032.043, i1 true) ; 2 uses
  %i.ac = add i32 %.sroa.734.044, %i.ab
  %i.ad = add nuw nsw i32 %i.ab, 1
  br label %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit26

_ZN5folly3f146detail13DenseMaskIter4nextEv.exit26: ; preds = %.lr.ph45, %bb.e
  %.pn = phi i32 [ %i.ad, %bb.e ], [ 1, %.lr.ph45 ]
  %.sroa.734.1.in = phi i32 [ %i.ac, %bb.e ], [ %.sroa.734.044, %.lr.ph45 ] ; 2 uses
  %.sroa.734.1 = add i32 %.sroa.734.1.in, 1
  %.sroa.032.1 = lshr i32 %.sroa.032.043, %.pn    ; 2 uses
  %i.ae = zext i32 %.sroa.734.1.in to i64
  %i.af = shl nuw nsw i64 %i.ae, 3
  %i.ag = getelementptr i8, ptr %i.k, i64 %i.af
  %i.ah = getelementptr i8, ptr %i.ag, i64 16     ; 2 uses
  %i.ai = load ptr, ptr %i.ah, align 8, !tbaa !112 ; 3 uses
  %.not.i27 = icmp eq ptr %i.ai, null
  br i1 %.not.i27, label %_ZN5folly3f146detail19NodeContainerPolicyINS_7dynamicES3_NS_6detail13DynamicHasherENS4_15DynamicKeyEqualEvE11destroyItemERPSt4pairIKS3_S3_E.exit, label %bb.f

bb.f:                                             ; preds = %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit26
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 40
  tail call void @_ZN5folly7dynamic7destroyEv(ptr noundef nonnull align 8 dereferenceable(40) %i.aj) #32, !inline_history !316
  tail call void @_ZN5folly7dynamic7destroyEv(ptr noundef nonnull align 8 dereferenceable(80) %i.ai) #32, !inline_history !316
  %i.ak = load ptr, ptr %i.ah, align 8, !tbaa !112
  tail call void @_ZdlPvm(ptr noundef %i.ak, i64 noundef 80) #34
...
_ZN5folly3f146detail19NodeContainerPolicyINS_7dynamicES3_NS_6detail13DynamicHasherENS4_15DynamicKeyEqualEvE11destroyItemERPSt4pairIKS3_S3_E.exit: ; preds = %_ZN5folly3f146detail13DenseMaskIter4nextEv.exit26, %bb.f
  %.not36 = icmp eq i32 %.sroa.032.1, 0
  br i1 %.not36, label %._crit_edge.loopexit, label %.lr.ph45, !llvm.loop !317
...
._crit_edge.loopexit:                             ; preds = %_ZN5folly3f146detail19NodeContainerPolicyINS_7dynamicES3_NS_6detail13DynamicHasherENS4_15DynamicKeyEqualEvE11destroyItemERPSt4pairIKS3_S3_E.exit
  %.pre = load i64, ptr %i.e, align 8, !tbaa !108
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader38
  %i.al = phi i64 [ %i.h, %.preheader38 ], [ %.pre, %._crit_edge.loopexit ] ; 2 uses
  %i.am = add i64 %.02346, 1                      ; 2 uses
  %i.an = and i64 %i.al, 255                      ; 3 uses
  %.023.highbits = lshr i64 %i.am, %i.an
  %i.ao = icmp eq i64 %.023.highbits, 0
  br i1 %i.ao, label %.preheader38, label %bb.g, !llvm.loop !318

bb.g:                                             ; preds = %._crit_edge
  %i.ap = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 0, ptr %i.ap, align 8, !tbaa !71
  store i64 %i.an, ptr %i.e, align 8, !tbaa !108
  %.pre47 = load ptr, ptr %0, align 8, !tbaa !116
  br label %bb.h

bb.h:                                             ; preds = %bb.b, %bb.g
  %i.aq = phi i64 [ %i.f, %bb.b ], [ %i.an, %bb.g ] ; 2 uses
  %i.ar = phi ptr [ %i.a, %bb.b ], [ %.pre47, %bb.g ] ; 2 uses
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 14
  %i.at = load i8, ptr %i.as, align 1, !tbaa !44
  %i.au = icmp eq i64 %i.aq, 0
  %i.av = shl i8 %i.at, 3
  %i.aw = and i8 %i.av, 120
  %narrow = add nuw i8 %i.aw, 16
  %i.ax = zext i8 %narrow to i64
  %i.ay = shl i64 128, %i.aq
  %.0.i28 = select i1 %i.au, i64 %i.ax, i64 %i.ay
  store ptr @_ZZN5folly3f146detail20getF14EmptyTagVectorEvE8instance, ptr %0, align 8, !tbaa !116
  store i64 0, ptr %i.e, align 8, !tbaa !108
  tail call void @_ZdlPvm(ptr noundef %i.ar, i64 noundef %.0.i28) #32
  br label %bb.i
...
bb.a:
  ...
  %i.a = load i32, ptr %1, align 8, !tbaa !31
  store i32 %i.a, ptr %0, align 8, !tbaa !31
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 9 uses
  store ptr null, ptr %i.b, align 8, !tbaa !44
  %i.c = load i32, ptr %1, align 8, !tbaa !31
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load <2 x ptr>, ptr %i.d, align 8, !tbaa !87
  store <2 x ptr> %i.e, ptr %i.b, align 8, !tbaa !87
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !120
  store ptr %i.h, ptr %i.f, align 8, !tbaa !120
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.d, i8 0, i64 24, i1 false)
  br label %bb.m

bb.c:                                             ; preds = %bb.a
  %i.i = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.j = load i8, ptr %i.i, align 8, !tbaa !88, !range !81, !noundef !51
  store i8 %i.j, ptr %i.b, align 8, !tbaa !88
  br label %bb.m

bb.d:                                             ; preds = %bb.a
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.l = load double, ptr %i.k, align 8, !tbaa !90
  store double %i.l, ptr %i.b, align 8, !tbaa !90
  br label %bb.m

bb.e:                                             ; preds = %bb.a
  %i.m = getelementptr inbounds nuw i8, ptr %1, i64 8
end_hunk_1
begin_hunk_2_@_ZN5folly7dynamicaSEOS0_:bb.a
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i21: ; preds = %bb.ab
  store ptr %i.cj, ptr %i.cg, align 8, !tbaa !46
  %i.cq = load i64, ptr %i.ck, align 8, !tbaa !44
  store i64 %i.cq, ptr %i.ci, align 8, !tbaa !44
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit: ; preds = %bb.ac, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i21
  %i.cr = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  %i.cs = load i64, ptr %i.cr, align 8, !tbaa !43
  %i.ct = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 %i.cs, ptr %i.ct, align 8, !tbaa !43
  store ptr %i.ck, ptr %i.ch, align 8, !tbaa !46
  store i64 0, ptr %i.cr, align 8, !tbaa !43
  store i8 0, ptr %i.ck, align 8, !tbaa !44
  br label %bb.ah

bb.ad:                                            ; preds = %bb.u
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #32
  invoke void @_ZN6google15LogMessageFatalC1EPKci(ptr noundef nonnull align 8 dereferenceable(96) %5, ptr noundef nonnull @.str.38, i32 noundef 172)
          to label %bb.ae unwind label %bb.ai

bb.ae:                                            ; preds = %bb.ad
  %i.cu = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZN6google10LogMessage6streamEv(ptr noundef nonnull align 8 dereferenceable(96) %5)
          to label %bb.af unwind label %bb.ai

bb.af:                                            ; preds = %bb.ae
  %i.cv = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(ptr noundef nonnull align 8 dereferenceable(8) %i.cu, ptr noundef nonnull @.str.39)
...
end_hunk_2
begin_hunk_3_@_ZNK5folly7dynamic6asImplINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEET_v:bb.a
bb.f:                                             ; preds = %bb.e
  %i.z = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.aa = load ptr, ptr %0, align 8, !tbaa !46, !alias.scope !349 ; 2 uses
...
bb.g:                                             ; preds = %bb.a
  ...
  store ptr %i.ad, ptr %0, align 8, !tbaa !40, !alias.scope !350
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i64 0, ptr %i.ae, align 8, !tbaa !43, !alias.scope !350
  store i8 0, ptr %i.ad, align 8, !tbaa !44, !alias.scope !350
  %i.af = load i8, ptr %i.ac, align 8, !tbaa !88, !range !81, !noalias !350, !noundef !51
  %i.ag = trunc nuw i8 %i.af to i1
  %i.ah = load i64, ptr @_ZN5folly6detail15to_ascii_powersILm10EmE4dataE, align 8, !noalias !350
  %i.ai = icmp ult i64 %i.ah, 2
  %not..i.i.i.i = xor i1 %i.ag, true
  %narrow.i.i.i.i = select i1 %not..i.i.i.i, i1 true, i1 %i.ai, !prof !69
...
bb.h:                                             ; preds = %.critedge.i.us.us, %.preheader.us
  ...
  %i.bc = add nsw i32 %.sroa.023.0.us.us, -1
...
_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE16reserveForInsertEm.exit: ; preds = %.thread69, %bb.g
  ...
  %i.bg = and i64 %2, %i.bf
  %i.bh = shl nsw i64 %i.bg, 7                    ; 2 uses
...
bb.f:                                             ; preds = %_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRNS_5RangeIPKcEEDnEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairIKS5_S5_EEEEESJ_ImmEDpOT_EUlvE_PFvPSA_SP_SQ_EJSV_RSP_RSQ_EvEET2_OT_OT0_DpOT1_.exit
  store i64 %i.k, ptr %i.l, align 8, !tbaa !71
...
_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE29adjustSizeAndBeginAfterInsertENS1_11F14ItemIterIPNS1_8F14ChunkIPSt4pairIKS4_S4_EEEEE.exit: ; preds = %_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRNS_5RangeIPKcEEDnEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairIKS5_S5_EEEEESJ_ImmEDpOT_EUlvE_PFvPSA_SP_SQ_EJSV_RSP_RSQ_EvEET2_OT_OT0_DpOT1_.exit, %bb.f
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.p = load i64, ptr %i.o, align 8, !tbaa !108  ; 2 uses
  %i.q = and i64 %i.p, -256
  %i.r = add i64 %i.q, 256
  %i.s = and i64 %i.p, 255
  %i.t = or disjoint i64 %i.r, %i.s
  store i64 %i.t, ptr %i.o, align 8, !tbaa !108
  ret void
}
...
_ZNK5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE25computeChunkCountAndScaleEmbb.exit: ; preds = %bb.b, %bb.c, %bb.f
  ...
  %i.r = load i64, ptr %i.q, align 8, !tbaa !108
  %i.s = lshr i64 %i.r, 8
...
bb.a:
  ...
  %i.a = tail call noalias noundef nonnull dereferenceable(80) ptr @_Znwm(i64 noundef 80) #37 ; 8 uses
...
bb.g:                                             ; preds = %.critedge.i.us.us, %.preheader.us
  ...
  %i.bb = add nsw i32 %.sroa.026.0.us.us, -1
...
bb.g:                                             ; preds = %.critedge.i.i.us.us, %.preheader.us
  ...
  %i.bb = add nsw i32 %.sroa.019.0.us.us, -1
...
bb.h:                                             ; preds = %.critedge.i.us.us, %.preheader.us
  ...
  %i.bb = add nsw i32 %.sroa.028.0.us.us, -1
...
bb.aq:                                            ; preds = %bb.ap
  %i.df = load i32, ptr %0, align 8, !tbaa !31    ; 2 uses
  switch i32 %i.df, label %bb.ar [
    i32 5, label %_ZN5folly7dynamic3getINS0_10ObjectImplEEERT_v.exit.i107
    i32 1, label %bb.as
  ]

bb.ar:                                            ; preds = %bb.aq
  invoke void @_ZN5folly6detail16throw_exception_INS_9TypeErrorEJPKcNS_7dynamic4TypeEEEEvDpT0_(ptr noundef nonnull @.str.59, i32 noundef %i.df) #12
          to label %.noexc110 unwind label %.loopexit.split-lp

.noexc110:                                        ; preds = %bb.ar
  unreachable

bb.as:                                            ; preds = %bb.aq
  %i.dg = invoke noundef nonnull align 8 dereferenceable(40) ptr @_ZNKR5folly7dynamic6atImplERKS0_(ptr noundef nonnull align 8 dereferenceable(40) %0, ptr noundef nonnull align 8 dereferenceable(40) %i.da)
          to label %_ZNR5folly7dynamicixIRKS0_EENSt9enable_ifIXaantsr3std14is_convertibleIT_NS_5RangeIPKcEEEE5valuesr3std14is_convertibleIS5_S0_EE5valueERS0_E4typeEOS5_.exit114 unwind label %.loopexit152

_ZN5folly7dynamic3getINS0_10ObjectImplEEERT_v.exit.i107: ; preds = %bb.aq
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #32
  store ptr null, ptr %i.a, align 8, !tbaa !138
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #32, !noalias !388
  %i.dh = invoke noundef i64 @_ZNK5folly7dynamic4hashEv(ptr noundef nonnull align 8 dereferenceable(40) %i.da)
          to label %.noexc112 unwind label %.loopexit152 ; 2 uses

.noexc112:                                        ; preds = %_ZN5folly7dynamic3getINS0_10ObjectImplEEERT_v.exit.i107
  %i.di = lshr i64 %i.dh, 56
  %.sroa.speculated.i.i.i.i.i.i.i.i.i.i108 = call i64 @llvm.umax.i64(i64 %i.di, i64 1)
  invoke void @_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE19tryEmplaceValueImplIS4_JRKS4_DnEEESt4pairINS1_11F14ItemIterIPNS1_8F14ChunkIPSD_ISB_S4_EEEEEbESD_ImmERKT_DpOT0_(ptr dead_on_unwind nonnull writable sret(%"struct.std::pair.111") align 8 %3, ptr noundef nonnull align 8 dereferenceable(24) %i.g, i64 %i.dh, i64 %.sroa.speculated.i.i.i.i.i.i.i.i.i.i108, ptr noundef nonnull align 8 dereferenceable(40) %i.da, ptr noundef nonnull align 8 dereferenceable(40) %i.da, ptr noundef nonnull align 8 dereferenceable(8) %i.a)
          to label %.noexc113 unwind label %.loopexit152
...
_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKS5_DnEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairISC_S5_EEEEESG_ImmEDpOT_EUlvE_PFvPSA_SL_SM_EJSR_RSL_RSM_EvEET2_OT_OT0_DpOT1_.exit: ; preds = %_ZZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE13insertAtBlankIJRKS4_DnEEEvNS1_11F14ItemIterIPNS1_8F14ChunkIPSt4pairISB_S4_EEEEESF_ImmEDpOT_ENKUlvE_clEv.exit, %_ZN5folly11invoke_coldIPFvPNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEEENS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairIKS5_S5_EEEEESE_ImmEEJSB_RSK_RSL_ESM_TnNSt9enable_ifIXsr3std11is_functionIT1_EE5valueEiE4typeELi0EvEET3_OT_DpOT0_.exit.i
  ...
  %i.q = load i64, ptr %i.p, align 8, !tbaa !110
  %i.r = icmp ult i64 %i.q, %i.o
  br i1 %i.r, label %bb.f, label %_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE29adjustSizeAndBeginAfterInsertENS1_11F14ItemIterIPNS1_8F14ChunkIPSt4pairIKS4_S4_EEEEE.exit

bb.f:                                             ; preds = %_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKS5_DnEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairISC_S5_EEEEESG_ImmEDpOT_EUlvE_PFvPSA_SL_SM_EJSR_RSL_RSM_EvEET2_OT_OT0_DpOT1_.exit
  store i64 %i.o, ptr %i.p, align 8, !tbaa !71
  br label %_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE29adjustSizeAndBeginAfterInsertENS1_11F14ItemIterIPNS1_8F14ChunkIPSt4pairIKS4_S4_EEEEE.exit

_ZN5folly3f146detail8F14TableINS1_19NodeContainerPolicyINS_7dynamicES4_NS_6detail13DynamicHasherENS5_15DynamicKeyEqualEvEEE29adjustSizeAndBeginAfterInsertENS1_11F14ItemIterIPNS1_8F14ChunkIPSt4pairIKS4_S4_EEEEE.exit: ; preds = %_ZN5folly15catch_exceptionIZNS_3f146detail8F14TableINS2_19NodeContainerPolicyINS_7dynamicES5_NS_6detail13DynamicHasherENS6_15DynamicKeyEqualEvEEE13insertAtBlankIJRKS5_DnEEEvNS2_11F14ItemIterIPNS2_8F14ChunkIPSt4pairISC_S5_EEEEESG_ImmEDpOT_EUlvE_PFvPSA_SL_SM_EJSR_RSL_RSM_EvEET2_OT_OT0_DpOT1_.exit, %bb.f
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.t = load i64, ptr %i.s, align 8, !tbaa !108  ; 2 uses
  %i.u = and i64 %i.t, -256
  %i.v = add i64 %i.u, 256
  %i.w = and i64 %i.t, 255
  %i.x = or disjoint i64 %i.v, %i.w
  store i64 %i.x, ptr %i.s, align 8, !tbaa !108
  ret void
}

; Function Attrs: mustprogress uwtable
define void @_ZNKR5folly7dynamic11try_get_ptrERKNS_12json_pointerE(ptr dead_on_unwind noalias nofree writable writeonly sret(%"class.folly::Expected.141") align 8 captures(none) %0, ptr noundef nonnull align 8 dereferenceable(40) %1, ptr noundef nonnull align 8 dereferenceable(24) %2) local_unnamed_addr #22 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = alloca i64, align 8                      ; 4 uses
  %i.b = alloca i64, align 8                      ; 5 uses
  %3 = alloca %"class.folly::Range", align 8      ; 7 uses
  %i.c = tail call noundef nonnull align 8 dereferenceable(24) ptr @_ZNK5folly12json_pointer6tokensB5cxx11Ev(ptr noundef nonnull align 8 dereferenceable(24) %2) ; 3 uses
  ...
  br i1 %i.g, label %bb.b, label %.preheader304

.preheader304:                                    ; preds = %bb.a
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %1, ptr %.sroa.4182.0..sroa_idx, align 8, !tbaa !87
  %.sroa.5.0..sroa_idx183 = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 40
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.5.0..sroa_idx183, i8 0, i64 24, i1 false)
  store i8 1, ptr %i.i, align 8, !tbaa !148
  br label %.thread273

bb.c:                                             ; preds = %.thread213
  %i.j = add i64 %.sroa.7.0371496, 1              ; 2 uses
  %.not = icmp eq ptr %.5, null
  br i1 %.not, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  store i8 7, ptr %0, align 8, !tbaa !398
  %.sroa.5155.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i64 %i.j, ptr %.sroa.5155.0..sroa_idx, align 8, !tbaa !71
  %.sroa.6156.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %.036376493, ptr %.sroa.6156.0..sroa_idx, align 8, !tbaa !87
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 40
  store i8 2, ptr %i.k, align 8, !tbaa !148
  br label %.thread273

bb.e:                                             ; preds = %.preheader304, %bb.c
  %.sroa.0173.0368499 = phi ptr [ %i.d, %.preheader304 ], [ %i.ea, %bb.c ] ; 9 uses
  %.sroa.7.0371496 = phi i64 [ 0, %.preheader304 ], [ %i.j, %bb.c ] ; 8 uses
  %.sroa.5180.0374495 = phi ptr [ null, %.preheader304 ], [ %.sroa.5180.3, %bb.c ] ; 2 uses
  %.sroa.0179.0375494 = phi ptr [ null, %.preheader304 ], [ %.sroa.0179.3, %bb.c ] ; 2 uses
  %.036376493 = phi ptr [ %1, %.preheader304 ], [ %.5, %bb.c ] ; 13 uses
  %.0380492 = phi i64 [ 0, %.preheader304 ], [ %.3, %bb.c ] ; 2 uses
  %i.l = load i32, ptr %.036376493, align 8, !tbaa !31
  %i.m = getelementptr inbounds nuw i8, ptr %.036376493, i64 8 ; 2 uses
  switch i32 %i.l, label %bb.w [
    i32 1, label %bb.f
    i32 5, label %bb.n
  ]

bb.f:                                             ; preds = %bb.e
  %i.n = getelementptr inbounds nuw i8, ptr %.sroa.0173.0368499, i64 8
  %i.o = load i64, ptr %i.n, align 8, !tbaa !43   ; 3 uses
  %i.p = icmp ugt i64 %i.o, 1
  br i1 %i.p, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE2atEm.exit, label %bb.h

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE2atEm.exit: ; preds = %bb.f
  %i.q = load ptr, ptr %.sroa.0173.0368499, align 8, !tbaa !46 ; 2 uses
  %i.r = load i8, ptr %i.q, align 1, !tbaa !44
  %i.s = icmp eq i8 %i.r, 48
  br i1 %i.s, label %bb.g, label %.thread

bb.g:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE2atEm.exit
  store i8 5, ptr %0, align 8, !tbaa !398
  %.sroa.5147.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i64 %.sroa.7.0371496, ptr %.sroa.5147.0..sroa_idx, align 8, !tbaa !71
  %.sroa.6148.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %.036376493, ptr %.sroa.6148.0..sroa_idx, align 8, !tbaa !87
...
bb.t:                                             ; preds = %.preheader, %.critedge.i
  ...
  %i.cy = add nsw i32 %.sroa.0194.0, -1
