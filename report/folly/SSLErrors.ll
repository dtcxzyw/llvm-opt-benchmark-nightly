...
_ZN12_GLOBAL__N_118decodeOpenSSLErrorB5cxx11Eimi.exit.thread38: ; preds = %bb.a
  ...
  %8 = tail call noalias noundef nonnull dereferenceable(31) ptr @_Znwm(i64 noundef 31) #11, !noalias !12 ; 3 uses
  store ptr %8, ptr %7, align 8, !tbaa !23, !alias.scope !12
  store i64 30, ptr %i.g, align 8, !tbaa !22, !alias.scope !12
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(30) %8, ptr noundef nonnull align 1 dereferenceable(30) @.str.2, i64 30, i1 false), !noalias !12
  ...
  store i8 0, ptr %i.i, align 1, !tbaa !22, !noalias !12
  br label %_ZN12_GLOBAL__N_118decodeOpenSSLErrorB5cxx11Eimi.exit.thread
