...
begin_hunk_0_@_ZN2v88internal23RegExpMacroAssemblerX647GetCodeENS0_12DirectHandleINS0_6StringEEENS_4base5FlagsINS0_10RegExpFlagEiiEE:_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit276
  ...
  %i.t = tail call i64 @_ZN2v88internal17ExternalReference18address_of_jslimitEPNS0_7IsolateE(ptr noundef %i.s) #13
  tail call void @_ZN2v88internal9Assembler8emit_movENS0_8RegisterES2_i(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i8 9, i8 4, i32 noundef 8) #13
  tail call void @_ZN2v88internal14MacroAssembler4MoveENS0_8RegisterENS0_17ExternalReferenceE(ptr noundef nonnull align 8 dereferenceable(436) %i.b, i8 10, i64 %i.t) #13
  tail call void @_ZN2v88internal9Assembler13arithmetic_opEhNS0_8RegisterENS0_7OperandEi(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i8 noundef zeroext 43, i8 9, i64 131328, ptr nonnull inttoptr (i64 1 to ptr), i32 noundef 8) #13
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 596 ; 22 uses
  %i.v = load i32, ptr %i.u, align 4
  %i.w = shl nsw i32 %i.v, 3
  call void @_ZN2v88internal9Assembler1jENS0_9ConditionEPNS0_5LabelENS3_8DistanceE(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i32 noundef 6, ptr noundef nonnull %4, i32 noundef 1) #13
  %.sroa.0410.0.insert.ext411 = zext i32 %i.w to i64 ; 2 uses
  call void @_ZN2v88internal9Assembler23immediate_arithmetic_opEhNS0_8RegisterENS0_9ImmediateEi(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i8 noundef zeroext 7, i8 9, i64 %.sroa.0410.0.insert.ext411, i32 noundef 8) #13
  call void @_ZN2v88internal9Assembler1jENS0_9ConditionEPNS0_5LabelENS3_8DistanceE(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i32 noundef 3, ptr noundef nonnull %5, i32 noundef 1) #13
  call void @_ZN2v88internal9Assembler8emit_movENS0_8RegisterENS0_9ImmediateEi(ptr noundef nonnull align 8 dereferenceable(436) %i.b, i8 0, i64 4294967295, i32 noundef 8) #13
  call void @_ZN2v88internal9Assembler3jmpEPNS0_5LabelENS2_8DistanceE(ptr noundef nonnull align 8 dereferenceable(408) %i.b, ptr noundef nonnull %3, i32 noundef 1) #13
  call void @_ZN2v88internal9Assembler4bindEPNS0_5LabelE(ptr noundef nonnull align 8 dereferenceable(408) %i.b, ptr noundef nonnull %4) #13
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 520 ; 5 uses
  %.sroa.0.0.copyload.i334 = load ptr, ptr %i.x, align 8
  call void @_ZN2v88internal14MacroAssembler4MoveENS0_8RegisterENS0_6HandleINS0_10HeapObjectEEENS0_9RelocInfo4ModeE(ptr noundef nonnull align 8 dereferenceable(436) %i.b, i8 8, ptr %.sroa.0.0.copyload.i334, i8 noundef signext 4) #13
  call void @_ZN2v88internal9Assembler5pushqENS0_8RegisterE(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i8 1) #13
  ...
  call void @_ZN2v88internal9Assembler8emit_movENS0_8RegisterENS0_9ImmediateEi(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i8 1, i64 %.sroa.0410.0.insert.ext411, i32 noundef 8) #13
  ...
  %i.y = call i64 @_ZN2v88internal17ExternalReference26re_check_stack_guard_stateEv() #13
  %i.z = call noundef i32 @_ZN2v88internal14MacroAssembler13CallCFunctionENS0_17ExternalReferenceEi19SetIsolateDataSlotsPNS0_5LabelE(ptr noundef nonnull align 8 dereferenceable(436) %i.b, i64 %i.y, i32 noundef 4, i32 noundef 0, ptr noundef null) #13 ; 0 uses
  call void @_ZN2v88internal9Assembler4popqENS0_8RegisterE(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i8 1) #13
  ...
  call void @_ZN2v88internal9Assembler4bindEPNS0_5LabelE(ptr noundef nonnull align 8 dereferenceable(408) %i.b, ptr noundef nonnull %5) #13
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #13
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #13
  %i.aa = load i32, ptr %i.u, align 4             ; 2 uses
  %i.ab = icmp eq i32 %i.aa, 0
  br i1 %i.ab, label %_ZN2v88internal14MacroAssembler18AllocateStackSpaceEi.exit, label %bb.a

bb.a:                                             ; preds = %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit276
  %i.ac = shl nsw i32 %i.aa, 3
  %.sroa.0.0.insert.ext.i = zext i32 %i.ac to i64
  call void @_ZN2v88internal9Assembler23immediate_arithmetic_opEhNS0_8RegisterENS0_9ImmediateEi(ptr noundef nonnull align 8 dereferenceable(436) %i.b, i8 noundef zeroext 5, i8 4, i64 %.sroa.0.0.insert.ext.i, i32 noundef 8) #13
  br label %_ZN2v88internal14MacroAssembler18AllocateStackSpaceEi.exit

_ZN2v88internal14MacroAssembler18AllocateStackSpaceEi.exit: ; preds = %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit276, %bb.a
  ...
  call void @_ZN2v88internal9Assembler8emit_movENS0_8RegisterENS0_7OperandEi(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i8 7, i64 3762618368, ptr nonnull inttoptr (i64 2 to ptr), i32 noundef 8) #13
  call void @_ZN2v88internal9Assembler13arithmetic_opEhNS0_8RegisterES2_i(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i8 noundef zeroext 43, i8 7, i8 6, i32 noundef 8) #13
  call void @_ZN2v88internal9Assembler8emit_movENS0_8RegisterENS0_7OperandEi(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i8 3, i64 3896836096, ptr nonnull inttoptr (i64 2 to ptr), i32 noundef 8) #13
  call void @_ZN2v88internal9Assembler4negqENS0_8RegisterE(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i8 3) #13
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 592 ; 8 uses
  %i.ae = load i32, ptr %i.ad, align 8            ; 2 uses
  switch i32 %i.ae, label %bb.c [
    i32 1, label %_ZN2v88internal23RegExpMacroAssemblerX6419CharSizeScaleFactorEv.exit
    i32 2, label %bb.b
  ]

bb.b:                                             ; preds = %_ZN2v88internal14MacroAssembler18AllocateStackSpaceEi.exit
  br label %_ZN2v88internal23RegExpMacroAssemblerX6419CharSizeScaleFactorEv.exit

bb.c:                                             ; preds = %_ZN2v88internal14MacroAssembler18AllocateStackSpaceEi.exit
  call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.23) #14
  unreachable

_ZN2v88internal23RegExpMacroAssemblerX6419CharSizeScaleFactorEv.exit: ; preds = %_ZN2v88internal14MacroAssembler18AllocateStackSpaceEi.exit, %bb.b
  %.0.i = phi i64 [ 1593835520, %bb.b ], [ 520093696, %_ZN2v88internal14MacroAssembler18AllocateStackSpaceEi.exit ]
  %i.af = sub nsw i32 0, %i.ae
  %i.ag = and i32 %i.af, 255
  %.sroa.7.0.insert.ext1000 = zext nneg i32 %i.ag to i64
  %.sroa.7.0.insert.shift1001 = shl nuw nsw i64 %.sroa.7.0.insert.ext1000, 32
  %.sroa.5999.0.insert.insert = or disjoint i64 %.sroa.7.0.insert.shift1001, %.0.i
  %.sroa.3998.0.insert.insert = or disjoint i64 %.sroa.5999.0.insert.insert, 4456448
  call void @_ZN2v88internal9Assembler8emit_leaENS0_8RegisterENS0_7OperandEi(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i8 0, i64 %.sroa.3998.0.insert.insert, ptr nonnull inttoptr (i64 3 to ptr), i32 noundef 8) #13
  call void @_ZN2v88internal9Assembler8emit_movENS0_7OperandENS0_8RegisterEi(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i64 2957312000, ptr nonnull inttoptr (i64 2 to ptr), i8 0, i32 noundef 8) #13
  %.sroa.0.0.copyload.i335 = load ptr, ptr %i.x, align 8
  call void @_ZN2v88internal14MacroAssembler4MoveENS0_8RegisterENS0_6HandleINS0_10HeapObjectEEENS0_9RelocInfo4ModeE(ptr noundef nonnull align 8 dereferenceable(436) %i.b, i8 8, ptr %.sroa.0.0.copyload.i335, i8 noundef signext 4) #13
  ...
  call void @_ZN2v88internal9Assembler23immediate_arithmetic_opEhNS0_7OperandENS0_9ImmediateEi(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i8 noundef zeroext 7, i64 3896836096, ptr nonnull inttoptr (i64 2 to ptr), i64 0, i32 noundef 4) #13
  call void @_ZN2v88internal9Assembler1jENS0_9ConditionEPNS0_5LabelENS3_8DistanceE(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i32 noundef 5, ptr noundef nonnull %6, i32 noundef 0) #13
  call void @_ZN2v88internal9Assembler8emit_movENS0_8RegisterENS0_9ImmediateEi(ptr noundef nonnull align 8 dereferenceable(436) %i.b, i8 2, i64 10, i32 noundef 4) #13
  call void @_ZN2v88internal9Assembler3jmpEPNS0_5LabelENS2_8DistanceE(ptr noundef nonnull align 8 dereferenceable(408) %i.b, ptr noundef nonnull %7, i32 noundef 0) #13
  call void @_ZN2v88internal9Assembler4bindEPNS0_5LabelE(ptr noundef nonnull align 8 dereferenceable(408) %i.b, ptr noundef nonnull %6) #13
  %i.aj = load ptr, ptr %0, align 8
  %i.ak = getelementptr inbounds nuw i8, ptr %i.aj, i64 464
  %i.al = load ptr, ptr %i.ak, align 8
  call void %i.al(ptr noundef nonnull align 8 dereferenceable(668) %0, i32 noundef -1, i32 noundef 1) #13
  call void @_ZN2v88internal9Assembler4bindEPNS0_5LabelE(ptr noundef nonnull align 8 dereferenceable(408) %i.b, ptr noundef nonnull %7) #13
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #13
  %i.am = getelementptr inbounds nuw i8, ptr %0, i64 600 ; 17 uses
  %i.an = load i32, ptr %i.am, align 8            ; 2 uses
  %i.ao = icmp sgt i32 %i.an, 0
  br i1 %i.ao, label %bb.d, label %.loopexit773

bb.d:                                             ; preds = %_ZN2v88internal23RegExpMacroAssemblerX6419CharSizeScaleFactorEv.exit
  %i.ap = icmp samesign ugt i32 %i.an, 8
  br i1 %i.ap, label %_ZN2v88internal7OperandC2ENS0_8RegisterES2_NS0_11ScaleFactorEi.exit285, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %bb.d
  %i.aq = load i32, ptr %i.u, align 4
  %.not.i.peel = icmp sgt i32 %i.aq, 0
  br i1 %.not.i.peel, label %_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel, label %bb.e

bb.e:                                             ; preds = %.lr.ph.preheader
  store i32 1, ptr %i.u, align 4
  br label %_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel

_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel: ; preds = %bb.e, %.lr.ph.preheader
  call void @_ZN2v88internal9Assembler8emit_movENS0_7OperandENS0_8RegisterEi(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i64 2554658816, ptr nonnull inttoptr (i64 2 to ptr), i8 0, i32 noundef 8) #13
  %i.ar = load i32, ptr %i.am, align 8
  %i.as = icmp sgt i32 %i.ar, 1
  br i1 %i.as, label %.lr.ph.peel.next, label %.loopexit773

.lr.ph.peel.next:                                 ; preds = %_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel
  %i.at = load i32, ptr %i.u, align 4
  %.not.i.peel786 = icmp sgt i32 %i.at, 1
  br i1 %.not.i.peel786, label %_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel787, label %bb.f

bb.f:                                             ; preds = %.lr.ph.peel.next
  store i32 2, ptr %i.u, align 4
  br label %_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel787

_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel787: ; preds = %bb.f, %.lr.ph.peel.next
  call void @_ZN2v88internal9Assembler8emit_movENS0_7OperandENS0_8RegisterEi(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i64 2420441088, ptr nonnull inttoptr (i64 2 to ptr), i8 0, i32 noundef 8) #13
  %i.au = load i32, ptr %i.am, align 8
  %i.av = icmp sgt i32 %i.au, 2
  br i1 %i.av, label %.lr.ph.peel.next784, label %.loopexit773

.lr.ph.peel.next784:                              ; preds = %_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel787
  %i.aw = load i32, ptr %i.u, align 4
  %.not.i.peel797 = icmp sgt i32 %i.aw, 2
  br i1 %.not.i.peel797, label %_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel798, label %bb.g

bb.g:                                             ; preds = %.lr.ph.peel.next784
  store i32 3, ptr %i.u, align 4
  br label %_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel798

_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel798: ; preds = %bb.g, %.lr.ph.peel.next784
  call void @_ZN2v88internal9Assembler8emit_movENS0_7OperandENS0_8RegisterEi(ptr noundef nonnull align 8 dereferenceable(408) %i.b, i64 2286223360, ptr nonnull inttoptr (i64 2 to ptr), i8 0, i32 noundef 8) #13
  %i.ax = load i32, ptr %i.am, align 8
  %i.ay = icmp sgt i32 %i.ax, 3
  br i1 %i.ay, label %.lr.ph.peel.next795, label %.loopexit773

.lr.ph.peel.next795:                              ; preds = %_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel798
  %i.az = load i32, ptr %i.u, align 4
  %.not.i.peel808 = icmp sgt i32 %i.az, 3
  br i1 %.not.i.peel808, label %_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel809, label %bb.h

bb.h:                                             ; preds = %.lr.ph.peel.next795
  store i32 4, ptr %i.u, align 4
  br label %_ZN2v88internal23RegExpMacroAssemblerX6417register_locationEi.exit.peel809
