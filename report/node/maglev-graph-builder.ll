...
@switch.table._ZN2v88internal6maglev18MaglevGraphBuilder21VisitCompareOperationIL9Operation21EEENS1_12ReduceResultEv = private unnamed_addr constant [3 x i32] [i32 3, i32 19, i32 31], align 4
...
switch.lookup:                                    ; preds = %_ZZN2v88internal6maglev18MaglevGraphBuilder21VisitCompareOperationIL9Operation16EEENS1_12ReduceResultEvENKUlPNS1_9ValueNodeES7_E0_clES7_S7_.exit51
  ...
  %switch.gep = getelementptr inbounds nuw [4 x i8], ptr @switch.table._ZN2v88internal6maglev18MaglevGraphBuilder21VisitCompareOperationIL9Operation21EEENS1_12ReduceResultEv, i64 %i.ct
...
switch.lookup:                                    ; preds = %_ZZN2v88internal6maglev18MaglevGraphBuilder21VisitCompareOperationIL9Operation17EEENS1_12ReduceResultEvENKUlPNS1_9ValueNodeES7_E0_clES7_S7_.exit66
  ...
  %switch.gep = getelementptr inbounds nuw [4 x i8], ptr @switch.table._ZN2v88internal6maglev18MaglevGraphBuilder21VisitCompareOperationIL9Operation21EEENS1_12ReduceResultEv, i64 %i.bx
  %switch.load = load i32, ptr %switch.gep, align 4 ; 2 uses
...
switch.lookup:                                    ; preds = %.thread
  ...
  %switch.gep = getelementptr inbounds nuw [4 x i8], ptr @switch.table._ZN2v88internal6maglev18MaglevGraphBuilder21VisitCompareOperationIL9Operation21EEENS1_12ReduceResultEv, i64 %i.ej
  %switch.load = load i32, ptr %switch.gep, align 4 ; 2 uses
...
switch.lookup:                                    ; preds = %_ZZN2v88internal6maglev18MaglevGraphBuilder21VisitCompareOperationIL9Operation19EEENS1_12ReduceResultEvENKUlPNS1_9ValueNodeES7_E0_clES7_S7_.exit55
  ...
  %switch.gep = getelementptr inbounds nuw [4 x i8], ptr @switch.table._ZN2v88internal6maglev18MaglevGraphBuilder21VisitCompareOperationIL9Operation21EEENS1_12ReduceResultEv, i64 %i.cj
  %switch.load = load i32, ptr %switch.gep, align 4 ; 2 uses
