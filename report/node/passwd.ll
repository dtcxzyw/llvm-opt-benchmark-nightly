...
begin_hunk_0_@do_passwd:bb.a
  ...
  %i.ep = getelementptr inbounds nuw i8, ptr @shacrypt.out_buf, i64 %i.eo ; 131 uses
...
begin_hunk_1_@do_passwd:bb.a
  ...
  %9 = getelementptr inbounds nuw i8, ptr %i.ep, i64 44
...
begin_hunk_2_@do_passwd:bb.a
  ...
  %10 = getelementptr inbounds nuw i8, ptr %i.ep, i64 87
  store i8 %i.avl, ptr %i.avh, align 1, !tbaa !17
  br label %.loopexit.i

.loopexit.i:                                      ; preds = %.loopexit.loopexit537.i, %.loopexit.loopexit.i
  %.35.i = phi ptr [ %9, %.loopexit.loopexit.i ], [ %10, %.loopexit.loopexit537.i ]
