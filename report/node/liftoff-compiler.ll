begin_hunk_0
  ...
  %.sroa.12.0.copyload = load i32, ptr %.sroa.12.0..sroa_idx, align 4 ; 2 uses
...
begin_hunk_1
  ...
  %i.bo = sub nsw i32 0, %.sroa.12.0.copyload     ; 3 uses
  %1 = sext i32 %i.bo to i64
  %2 = add nsw i64 %1, 128
  %i.bp = icmp ult i64 %2, 256                    ; 2 uses
  ...
  %.sroa.0.0.i = select i1 %i.bp, i64 %.sroa.0.3.insert.insert11.i, i64 %.sroa.0.3.insert.insert.i
  %storemerge.i.i = select i1 %i.bp, i64 2, i64 5
  %.fca.1.load.cast.i.i = inttoptr i64 %storemerge.i.i to ptr
  tail call void @_ZN2v88internal4wasm7liftoff13LoadFromStackEPNS1_16LiftoffAssemblerENS1_15LiftoffRegisterENS0_7OperandENS1_9ValueKindE(ptr noundef nonnull align 8 dereferenceable(824) %0, i8 %.sroa.06.0.i.i, i64 %.sroa.0.0.i, ptr nonnull %.fca.1.load.cast.i.i, i8 noundef zeroext %.sroa.5.0.copyload)
  br label %bb.i
...
begin_hunk_3
  ...
  %i.pl = sub nsw i32 0, %.sroa.3.0.copyload.i    ; 3 uses
  %14 = sext i32 %i.pl to i64
  %15 = add nsw i64 %14, 128
  %i.pm = icmp ult i64 %15, 256                   ; 2 uses
  ...
  %.sroa.0.0.i.i = select i1 %i.pm, i64 %.sroa.0.3.insert.insert11.i.i, i64 %.sroa.0.3.insert.insert.i.i
  %storemerge.i.i.i = select i1 %i.pm, i64 2, i64 5
  ...
  call void @_ZN2v88internal9Assembler8emit_movENS0_8RegisterENS0_7OperandEi(ptr noundef nonnull align 8 dereferenceable(1284) %i.dx, i8 %.sroa.06.0.i.i105.i, i64 %.sroa.0.0.i.i, ptr nonnull %.fca.1.load.cast.i.i.i, i32 noundef 8) #25
...
_ZNK2v88internal4wasm16LiftoffAssembler14TopSpillOffsetEv.exit.i200.i: ; preds = %bb.de, %bb.dd
  ...
  %23 = add nsw i8 %.0.i.i, -9
  %24 = icmp ult i8 %23, 2
  br i1 %24, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit2.i205.i, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit.i201.i
...
bb.hc:                                            ; preds = %_ZN2v88internal4wasm16LiftoffAssembler17GetUnusedRegisterENS1_8RegClassENS1_14LiftoffRegListE.exit184.i
  ...
  br i1 %26, label %_ZN2v88internal4wasm7liftoff8GetMemOpEPNS1_16LiftoffAssemblerENS0_8RegisterES5_mNS0_11ScaleFactorE.exit210.i, label %switch.lookup194
...
_ZNK2v88internal4wasm16LiftoffAssembler14TopSpillOffsetEv.exit.i195.i: ; preds = %bb.he, %bb.hd
  ...
  %27 = add nsw i8 %.0.i168.i, -9
  %28 = icmp ult i8 %27, 2
  br i1 %28, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit2.i200.i, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit.i196.i
...
_ZNK2v88internal4wasm16LiftoffAssembler14TopSpillOffsetEv.exit.i.i: ; preds = %bb.ah, %_ZN2v88internal4wasm16LiftoffAssembler20emit_type_conversionENS1_10WasmOpcodeENS1_15LiftoffRegisterES4_PNS0_5LabelE.exit.i
  ...
  %3 = add nsw i8 %.0.i, -9
  %4 = icmp ult i8 %3, 2
  br i1 %4, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit2.i.i, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit.i.i
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %.sroa.0.3.insert.shift.i = shl nuw nsw i64 %.sroa.0.3.insert.ext.i, 24
  %.sroa.0.3.insert.insert.i = or disjoint i64 %.sroa.0.3.insert.shift.i, 8716288
  %.sroa.0.0.i = select i1 %i.n, i64 %.sroa.0.3.insert.insert10.i, i64 %.sroa.0.3.insert.insert.i
  %storemerge.i.i = select i1 %i.n, i64 2, i64 5
  %.fca.1.load.cast.i.i = inttoptr i64 %storemerge.i.i to ptr
  tail call void @_ZN2v88internal9Assembler8emit_leaENS0_8RegisterENS0_7OperandEi(ptr noundef nonnull align 8 dereferenceable(824) %0, i8 0, i64 %.sroa.0.0.i, ptr nonnull %.fca.1.load.cast.i.i, i32 noundef 8) #25
  br label %bb.f
...
.thread.i:                                        ; preds = %bb.m
  ...
  %i.bp = sub nsw i32 0, %i.bn                    ; 3 uses
  %3 = sext i32 %i.bp to i64
  %4 = add nsw i64 %3, 128
  %i.bq = icmp ult i64 %4, 256                    ; 2 uses
  ...
  %.sroa.0.3.insert.shift.i.i = shl nuw nsw i64 %.sroa.0.3.insert.ext.i.i, 24
  %.sroa.0.3.insert.insert.i.i = or disjoint i64 %.sroa.0.3.insert.shift.i.i, 8716288
  %.sroa.0.0.i.i = select i1 %i.bq, i64 %.sroa.0.3.insert.insert11.i.i, i64 %.sroa.0.3.insert.insert.i.i
  %storemerge.i.i.i = select i1 %i.bq, i64 2, i64 5
  %.fca.1.load.cast.i.i.i = inttoptr i64 %storemerge.i.i.i to ptr
  tail call void @_ZN2v88internal4wasm7liftoff13LoadFromStackEPNS1_16LiftoffAssemblerENS1_15LiftoffRegisterENS0_7OperandENS1_9ValueKindE(ptr noundef nonnull align 8 dereferenceable(1284) %0, i8 %.sroa.0.0.copyload.i.i, i64 %.sroa.0.0.i.i, ptr nonnull %.fca.1.load.cast.i.i.i, i8 noundef zeroext %i.be)
...
_ZN2v88internal4wasm16LiftoffAssembler17GetUnusedRegisterENS1_8RegClassENS1_14LiftoffRegListE.exit.i: ; preds = %bb.q, %bb.p
  ...
  %i.ck = sub nsw i32 0, %i.ci                    ; 3 uses
  %5 = sext i32 %i.ck to i64
  %6 = add nsw i64 %5, 128
  %i.cl = icmp ult i64 %6, 256                    ; 2 uses
  ...
  %.sroa.0.0.i33.i = select i1 %i.cl, i64 %.sroa.0.3.insert.insert11.i29.i, i64 %.sroa.0.3.insert.insert.i32.i
  %storemerge.i.i34.i = select i1 %i.cl, i64 2, i64 5
  %.fca.1.load.cast.i.i35.i = inttoptr i64 %storemerge.i.i34.i to ptr
  tail call void @_ZN2v88internal4wasm7liftoff13LoadFromStackEPNS1_16LiftoffAssemblerENS1_15LiftoffRegisterENS0_7OperandENS1_9ValueKindE(ptr noundef nonnull align 8 dereferenceable(1284) %0, i8 %.sroa.06.0.i.i.i, i64 %.sroa.0.0.i33.i, ptr nonnull %.fca.1.load.cast.i.i35.i, i8 noundef zeroext %i.be)
...
begin_hunk_12
  ...
  %i.r = sub nsw i32 0, %i.p                      ; 3 uses
  %4 = sext i32 %i.r to i64
  %5 = add nsw i64 %4, 128
  %i.s = icmp ult i64 %5, 256                     ; 2 uses
  %i.t = shl i32 %i.r, 24
  ...
  %.sroa.045.0 = select i1 %i.s, i64 %.sroa.045.3.insert.insert53, i64 %.sroa.045.3.insert.insert ; 2 uses
  %storemerge.i = select i1 %i.s, i64 2, i64 5
  %.fca.1.load.cast.i = inttoptr i64 %storemerge.i to ptr ; 2 uses
...
_ZN2v88internal4wasm7liftoff12GetStackSlotEi.exit: ; preds = %bb.f
  tail call void @_ZN2v88internal9Assembler8emit_movENS0_8RegisterENS0_7OperandEi(ptr noundef nonnull align 8 dereferenceable(408) %0, i8 10, i64 %.sroa.045.0, ptr nonnull %.fca.1.load.cast.i, i32 noundef 4) #25
...
_ZN2v88internal4wasm7liftoff12GetStackSlotEi.exit44: ; preds = %bb.f
  tail call void @_ZN2v88internal9Assembler8emit_movENS0_8RegisterENS0_7OperandEi(ptr noundef nonnull align 8 dereferenceable(408) %0, i8 10, i64 %.sroa.045.0, ptr nonnull %.fca.1.load.cast.i, i32 noundef 8) #25
...
begin_hunk_14
  ...
  %5 = add nsw i8 %.0.i38, -9
  %6 = icmp ult i8 %5, 2
  br i1 %6, label %_ZN2v88internal4wasm7liftoff8GetMemOpEPNS1_16LiftoffAssemblerENS0_8RegisterES5_mNS0_11ScaleFactorE.exit, label %bb.n
...
_ZNK2v88internal4wasm16LiftoffAssembler14TopSpillOffsetEv.exit.i: ; preds = %bb.v, %_ZN2v88internal4wasm12_GLOBAL__N_115LiftoffCompiler15LoadObjectFieldEPNS1_15WasmFullDecoderINS1_7Decoder15NoValidationTagES3_LNS1_12DecodingModeE0EEENS1_15LiftoffRegisterENS0_8RegisterESB_iNS1_9ValueKindEbbNS1_14LiftoffRegListE.exit
  ...
  %7 = add nsw i8 %i.cm, -9
  %8 = icmp ult i8 %7, 2
  br i1 %8, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit2.i, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit.i
...
begin_hunk_16
  ...
  %.sroa.0.0.copyload.i.i = load i32, ptr %i.ej, align 4 ; 12 uses
...
begin_hunk_17
  ...
  br i1 %i.gv, label %switch.lookup.i89, label %bb.ai
...
bb.ak:                                            ; preds = %bb.aj
  %12 = and i32 %.sroa.0.0.copyload.i.i, 5
  %13 = icmp eq i32 %12, 5
  %14 = select i1 %13, i8 10, i8 9
  br label %_ZNK2v88internal4wasm13ValueTypeBase4kindEv.exit92

switch.lookup.i89:                                ; preds = %bb.ah
  %switch.idx.cast.i90 = trunc nuw nsw i32 %i.gu to i8
  %switch.offset.i91 = add nuw nsw i8 %switch.idx.cast.i90, 1
  br label %_ZNK2v88internal4wasm13ValueTypeBase4kindEv.exit92

_ZNK2v88internal4wasm13ValueTypeBase4kindEv.exit92: ; preds = %bb.ak, %switch.lookup.i89
  %.0.i87 = phi i8 [ %14, %bb.ak ], [ %switch.offset.i91, %switch.lookup.i89 ] ; 2 uses
  %15 = add nsw i8 %.0.i87, -9
  %16 = icmp ult i8 %15, 2
  br i1 %16, label %bb.al, label %_ZNK2v88internal4wasm13ValueTypeBase4kindEv.exit92.thread

bb.al:                                            ; preds = %_ZNK2v88internal4wasm13ValueTypeBase4kindEv.exit92
...
_ZNK2v88internal4wasm13ValueTypeBase4kindEv.exit92.thread: ; preds = %_ZNK2v88internal4wasm13ValueTypeBase4kindEv.exit92
  %switch.tableidx = add nsw i8 %.0.i87, -1
...
_ZN2v88internal4wasm12_GLOBAL__N_115LiftoffCompiler16StoreObjectFieldEPNS1_15WasmFullDecoderINS1_7Decoder15NoValidationTagES3_LNS1_12DecodingModeE0EEENS0_8RegisterESA_iNS1_15LiftoffRegisterEbNS1_14LiftoffRegListENS1_9ValueKindENS1_16LiftoffAssembler16SkipWriteBarrierE.exit: ; preds = %bb.al, %_ZNK2v88internal4wasm13ValueTypeBase4kindEv.exit92.thread
  %i.gy = xor i32 %i.gl, -1
...
begin_hunk_21
  ...
  %5 = add nsw i8 %.0.i, -9
  %6 = icmp ult i8 %5, 2                          ; 2 uses
  br i1 %6, label %bb.ab, label %switch.lookup
...
_ZNK2v88internal4wasm16LiftoffAssembler14TopSpillOffsetEv.exit.i118: ; preds = %bb.af, %bb.ae
  ...
  br i1 %6, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit2.i123, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit.i119
...
begin_hunk_23
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #25
  store i32 0, ptr %i.a, align 4
  %4 = add nsw i8 %.0.i39, -9
  %5 = icmp ult i8 %4, 2
  br i1 %5, label %_ZN2v88internal4wasm7liftoff8GetMemOpEPNS1_16LiftoffAssemblerENS0_8RegisterES5_mNS0_11ScaleFactorE.exit, label %switch.lookup
...
_ZNK2v88internal4wasm16LiftoffAssembler14TopSpillOffsetEv.exit.i: ; preds = %bb.n, %_ZN2v88internal4wasm12_GLOBAL__N_115LiftoffCompiler21LoadAtomicObjectFieldEPNS1_15WasmFullDecoderINS1_7Decoder15NoValidationTagES3_LNS1_12DecodingModeE0EEENS1_15LiftoffRegisterENS0_8RegisterESB_iNS1_9ValueKindEbbNS0_17AtomicMemoryOrderENS1_14LiftoffRegListE.exit
  ...
  %6 = add nsw i8 %i.cl, -9
  %7 = icmp ult i8 %6, 2
  br i1 %7, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit2.i, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit.i
...
begin_hunk_25
  ...
  %5 = add nsw i8 %.0.i114, -9
  %6 = icmp ult i8 %5, 2                          ; 2 uses
  br i1 %6, label %bb.y, label %switch.lookup
...
_ZNK2v88internal4wasm16LiftoffAssembler14TopSpillOffsetEv.exit.i122: ; preds = %bb.aa, %bb.z
  ...
  br i1 %6, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit2.i127, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit.i123
