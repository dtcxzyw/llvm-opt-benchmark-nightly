...
bb.x:                                             ; preds = %bb.w, %_ZN2v88internal4wasm12_GLOBAL__N_115LiftoffCompiler15dynamic_tieringEv.exit.thread
  ...
  br i1 %i.ck, label %_ZN2v88internal24SharedMacroAssemblerBase6MovdquINS0_7OperandENS0_11XMMRegisterEJEEEvT_T0_DpT1_.exit.i.1, label %bb.y

_ZN2v88internal24SharedMacroAssemblerBase6MovdquINS0_7OperandENS0_11XMMRegisterEJEEEvT_T0_DpT1_.exit.i.1: ; preds = %bb.x
  ...
  call void @_ZN2v88internal4wasm16LiftoffAssembler13PushRegistersENS1_14LiftoffRegListE(ptr noundef nonnull align 8 dereferenceable(824) %0, i32 393221)
...
_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit31: ; preds = %bb.b, %bb.a, %bb.c
  %.sroa.7.sroa.4.sroa.0.0 = phi i32 [ %.sroa.6182.sroa.4.0.extract.shift, %bb.c ], [ 0, %bb.a ], [ 0, %bb.b ]
  ...
  %.sroa.6182.sroa.0.0.insert.insert = or disjoint i32 %.sroa.7.sroa.4.sroa.0.0, %.sroa.6182.sroa.0.0.insert.ext
  ...
  %.sroa.5.0.insert.insert = or disjoint i64 %.sroa.6182.0.insert.shift, %.sroa.3.0
