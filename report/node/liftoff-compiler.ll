...
bb.z:                                             ; preds = %bb.y, %_ZN2v88internal4wasm16LiftoffAssembler14PeekToRegisterEiNS1_14LiftoffRegListE.exit78
  ...
  %i.ew = phi i8 [ 1, %_ZN2v88internal4wasm16LiftoffAssembler14PeekToRegisterEiNS1_14LiftoffRegListE.exit78 ], [ 9, %bb.y ] ; 2 uses
...
begin_hunk_1_@_ZN2v88internal4wasm12_GLOBAL__N_115LiftoffCompiler10AtomicWaitEPNS1_15WasmFullDecoderINS1_7Decoder15NoValidationTagES3_LNS1_12DecodingModeE0EEENS1_9ValueKindERKNS1_21MemoryAccessImmediateE:bb.a
  ...
  %.sroa.5.0.insert.ext.i = zext nneg i8 %i.ew to i32
  ...
  %.sroa.5.0.insert.insert.i = or disjoint i32 %.sroa.5.0.insert.shift.i, %.sroa.4.0.insert.shift.i
  %.sroa.0.0.insert.insert.i = or disjoint i32 %.sroa.5.0.insert.insert.i, 150994945
