...
bb.af:                                            ; preds = %_ZNSt6vectorIjSaIjEE9push_backERKj.exit
  %i.gb = load i8, ptr getelementptr inbounds nuw (i8, ptr @_ZN2v88internal8v8_flagsE, i64 862), align 2, !range !23, !noundef !24
...
bb.ag:                                            ; preds = %bb.af
  ...
  br i1 %.not.i.i85, label %bb.ai, label %bb.ah, !prof !25
...
bb.b:                                             ; preds = %bb.a
  %i.j = icmp ult i64 %indvars.iv, 16
...
_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit31: ; preds = %bb.b, %bb.a, %bb.c
  %.sroa.7.sroa.4.sroa.0.0 = phi i64 [ %.sroa.7.sroa.4.0.extract.shift, %bb.c ], [ 0, %bb.a ], [ 0, %bb.b ]
  %.sroa.7.sroa.0.0 = phi i64 [ %i.h, %bb.c ], [ 0, %bb.a ], [ %i.h, %bb.b ]
  %.sroa.3.0 = phi i64 [ 8650752, %bb.c ], [ 262144, %bb.a ], [ 4456448, %bb.b ]
  ...
  %.sroa.6181.0.insert.insert = or disjoint i64 %.sroa.7.0.insert.shift, %.sroa.3.0
  %.sroa.3.0.insert.insert = or disjoint i64 %.sroa.6181.0.insert.insert, 603979776
  tail call void @_ZN2v88internal9Assembler8emit_movENS0_8RegisterENS0_7OperandEi(ptr noundef nonnull align 8 dereferenceable(408) %0, i8 10, i64 %.sroa.3.0.insert.insert, ptr nonnull %i.k, i32 noundef 8) #24
  %i.l = sub nsw i64 %indvars.iv, %i.d
  %i.m = shl nsw i64 %i.l, 3                      ; 3 uses
  %i.n = add nsw i64 %i.m, 128
  %i.o = icmp ult i64 %i.n, 256                   ; 3 uses
  %.sroa.4.sroa.4.0.extract.shift173 = and i64 %i.m, 4294967040
  %.sroa.4.sroa.4.sroa.0175.0 = select i1 %i.o, i64 0, i64 %.sroa.4.sroa.4.0.extract.shift173
  %.sroa.2162.0 = select i1 %i.o, i64 4521984, i64 8716288
  %storemerge140 = select i1 %i.o, i64 2, i64 5
  %.sroa.4.sroa.0168.0.insert.ext = and i64 %i.m, 248
  %.sroa.4.sroa.0168.0.insert.insert = or disjoint i64 %.sroa.4.sroa.4.sroa.0175.0, %.sroa.4.sroa.0168.0.insert.ext
  %.sroa.4.0.insert.shift164 = shl nuw nsw i64 %.sroa.4.sroa.0168.0.insert.insert, 24
  %.sroa.2162.0.insert.insert = or disjoint i64 %.sroa.4.0.insert.shift164, %.sroa.2162.0
  %.cast141 = inttoptr i64 %storemerge140 to ptr
  tail call void @_ZN2v88internal9Assembler8emit_movENS0_7OperandENS0_8RegisterEi(ptr noundef nonnull align 8 dereferenceable(408) %0, i64 %.sroa.2162.0.insert.insert, ptr nonnull %.cast141, i8 10, i32 noundef 8) #24
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %i.p = icmp sgt i64 %indvars.iv, 0
  br i1 %i.p, label %bb.a, label %._crit_edge, !llvm.loop !529
}
...
_ZN2v88internal4wasm12_GLOBAL__N_115LiftoffCompiler15DefineSafepointEi.exit: ; preds = %bb.a, %bb.b
  ...
  br i1 %.not.i, label %_ZN2v88internal4wasm12_GLOBAL__N_115LiftoffCompiler27RegisterDebugSideTableEntryEPNS1_15WasmFullDecoderINS1_7Decoder15NoValidationTagES3_LNS1_12DecodingModeE0EEENS2_21DebugSideTableBuilder14AssumeSpillingE.exit, label %bb.c, !prof !26
