...
by_store.exit:                                    ; preds = %bb.b, %.lr.ph.i, %bb.a
  ...
  br i1 %.1.i, label %.thread39, label %bb.c

bb.c:                                             ; preds = %by_store.exit
...
.thread39:                                        ; preds = %bb.c, %by_store.exit, %bb.d, %bb.h, %bb.i, %bb.f, %bb.g, %bb.e
  %.1 = phi i32 [ 0, %by_store.exit ], [ 0, %bb.e ], [ %i.p, %bb.g ], [ 0, %bb.f ], [ %i.t, %bb.i ], [ 0, %bb.h ], [ 0, %bb.d ], [ 0, %bb.c ]
  ret i32 %.1
}
