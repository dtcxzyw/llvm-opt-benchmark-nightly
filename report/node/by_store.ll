...
bb.a:
  %i.a = tail call ptr @OSSL_STORE_SEARCH_by_name(ptr noundef %2) #4 ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.a, %bb.b
  ...
  br i1 %.not.i, label %bb.b, label %by_store.exit

by_store.exit:                                    ; preds = %bb.b, %.lr.ph.i, %bb.a
  %.1.i = phi i1 [ true, %bb.a ], [ %.not.i, %.lr.ph.i ], [ %.not.i, %bb.b ]
  ...
  br i1 %.1.i, label %.critedge, label %by_store.exit.a

by_store.exit.a:                                  ; preds = %by_store.exit
...
.critedge:                                        ; preds = %by_store.exit.a, %by_store.exit, %bb.c, %bb.g, %bb.h, %bb.e, %bb.f, %bb.d
  %.1 = phi i32 [ 0, %by_store.exit ], [ 0, %bb.d ], [ %i.p, %bb.f ], [ 0, %bb.e ], [ %i.t, %bb.h ], [ 0, %bb.g ], [ 0, %bb.c ], [ 0, %by_store.exit.a ]
  ret i32 %.1
}
