...
bb.ab:                                            ; preds = %_ZNK2v84base6VectorIKhE6lengthEv.exit18.i.i
  ...
  %2 = or <2 x i8> %i.dz, <i8 32, i8 0>
  %i.ea = or <2 x i8> %i.dz, <i8 0, i8 32>
  %i.eb = add <2 x i8> %i.ea, <i8 -48, i8 -97>
  %i.ec = icmp ult <2 x i8> %i.eb, <i8 10, i8 26>
  %i.ed = add <2 x i8> %2, <i8 -97, i8 -48>
  %i.ee = icmp ult <2 x i8> %i.ed, <i8 26, i8 10>
...
bb.ab:                                            ; preds = %_ZNK2v84base6VectorIKtE6lengthEv.exit18.i.i
  ...
  %2 = or <2 x i16> %i.eb, <i16 32, i16 0>
  %i.ec = or <2 x i16> %i.eb, <i16 0, i16 32>
  %i.ed = add <2 x i16> %i.ec, <i16 -48, i16 -97>
  %i.ee = icmp ult <2 x i16> %i.ed, <i16 10, i16 26>
  %i.ef = add <2 x i16> %2, <i16 -97, i16 -48>
  %i.eg = icmp ult <2 x i16> %i.ef, <i16 26, i16 10>
