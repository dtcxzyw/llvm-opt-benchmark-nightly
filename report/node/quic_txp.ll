...
begin_hunk_0_@ossl_quic_tx_packetiser_generate:bb.a
  ...
  %or.cond.i.i.i.i = select i1 %.not64.i.i.i.i, i1 true, i1 %.not29.1.i.i.i.i ; 2 uses
  ...
  %or.cond71.i.i.i.i = select i1 %.not66.i.i.i.i, i1 true, i1 %.not29.3.i.i.i.i ; 2 uses
  %or.cond71.i.i.i.i.a = select i1 %or.cond71.i.i.i.i, i1 %or.cond70.i.i.i.i, i1 false
  %i.qt = select i1 %or.cond71.i.i.i.i.a, i1 %or.cond.i.i.i.i, i1 false
  %.125.3.i.i.i.i = select i1 %or.cond71.i.i.i.i, i64 %.125.2.i.i.i.i, i64 %.1.i.i.i.i.i ; 2 uses
  store i64 %.125.3.i.i.i.i, ptr %i.be, align 8, !tbaa !51
  %or.cond.i.i = select i1 %i.qt, i1 %.not.i.i.not.i.i, i1 false
...
begin_hunk_1_@determine_stream_len:bb.a
  ...
  %or.cond.i = select i1 %.0.i41.i, i1 true, i1 %.not29.1.i ; 3 uses
  ...
  %.125.2.i = select i1 %or.cond70.i, i64 %.125.1.i, i64 %.sink.i32.i ; 2 uses
  %.125.2.i.a = select i1 %or.cond70.i, i64 %.1.1.i, i64 %i.m
  %.not29.3.i = icmp ult i64 %.sink.i.i, %.125.2.i
  %or.cond71.i = select i1 %.0.i.i, i1 true, i1 %.not29.3.i ; 3 uses
  %or.cond71.i.a = select i1 %or.cond71.i, i1 %or.cond70.i, i1 false
  %i.v = select i1 %or.cond71.i.a, i1 %or.cond.i, i1 false
  %.127.3.i = select i1 %i.v, i32 %.127.i, i32 1
  %.125.3.i = select i1 %or.cond71.i, i64 %.125.2.i, i64 %.sink.i.i
  %.1.3.i = select i1 %or.cond71.i, i64 %.125.2.i.a, i64 %i.i
