...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  br i1 %exitcond26.not.i.1, label %_ZN2v88internal12StringSearchIthE31PopulateBoyerMooreHorspoolTableEv.exit, label %.lr.ph.i, !llvm.loop !65
...
bb.j:                                             ; preds = %.split.loop.exit76
  ...
  br i1 %.not.not, label %bb.d, label %_ZN2v88internal18FindFirstCharacterIthEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit.thread, !llvm.loop !66
...
bb.d:                                             ; preds = %.preheader.us
  ...
  br i1 %.not61.us, label %.thread, label %.preheader.us, !llvm.loop !67
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.am, label %bb.e, label %.thread, !llvm.loop !68
...
.critedge.us:                                     ; preds = %bb.e
  ...
  br i1 %i.as, label %.split.us, label %_ZNK2v84base6VectorIKtE6lengthEv.exit.split.us, !llvm.loop !69
...
bb.g:                                             ; preds = %.preheader
  ...
  br i1 %.not61, label %.thread, label %.preheader, !llvm.loop !67
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.v, label %middle.block, label %vector.body, !llvm.loop !70
...
.lr.ph:                                           ; preds = %.lr.ph.preheader130, %.lr.ph
  ...
  br i1 %exitcond.not, label %.loopexit128, label %.lr.ph, !llvm.loop !71
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  br i1 %.not91, label %.critedge, label %.lr.ph101, !llvm.loop !72
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  br i1 %i.bi, label %.lr.ph105, label %.critedge94.loopexit, !llvm.loop !73
...
.critedge94:                                      ; preds = %.critedge94.loopexit, %.critedge2, %.critedge
  ...
  br i1 %i.bp, label %bb.c, label %bb.j, !llvm.loop !74
...
bb.t:                                             ; preds = %bb.s, %bb.r
  ...
  br i1 %exitcond122.not.1, label %.loopexit, label %.lr.ph112, !llvm.loop !75
...
.preheader73.us.backedge:                         ; preds = %bb.d, %bb.i
  ...
  br label %.preheader73.us, !llvm.loop !76
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.aj, label %bb.e, label %.thread, !llvm.loop !77
...
bb.j:                                             ; preds = %.preheader73
  ...
  br i1 %.not65, label %.thread, label %.preheader73, !llvm.loop !78
...
bb.d:                                             ; preds = %.lr.ph.i
  ...
  br i1 %exitcond.not.i, label %_ZN2v88internal18FindFirstCharacterIhtEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit, label %.lr.ph.i, !llvm.loop !79
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %i.ag, label %bb.e, label %_ZN2v88internal18FindFirstCharacterIhtEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit, !llvm.loop !80
...
bb.e:                                             ; preds = %.lr.ph.i
  ...
  br i1 %exitcond.not.i, label %_ZN2v88internal18FindFirstCharacterIhtEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit.thread, label %.lr.ph.i, !llvm.loop !79
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %i.aj, label %bb.f, label %_ZN2v88internal18FindFirstCharacterIhtEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit.thread, !llvm.loop !80
...
bb.j:                                             ; preds = %bb.j, %bb.i
  ...
  br i1 %or.cond.i, label %bb.j, label %_ZN2v88internal11CharCompareIhtEEbPKT_PKT0_i.exit, !llvm.loop !81

_ZN2v88internal11CharCompareIhtEEbPKT_PKT0_i.exit: ; preds = %bb.j
  br i1 %.not.i, label %_ZN2v88internal18FindFirstCharacterIhtEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit.thread, label %bb.d, !llvm.loop !82
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %i.al, label %bb.f, label %_ZN2v88internal18FindFirstCharacterIhtEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit.thread, !llvm.loop !80
...
bb.i:                                             ; preds = %.preheader
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.split.loop.exit90, label %.preheader, !llvm.loop !83
...
.lr.ph.i52.prol:                                  ; preds = %.lr.ph.preheader.i51, %.lr.ph.i52.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i52.prol.loopexit, label %.lr.ph.i52.prol, !llvm.loop !84
...
.lr.ph.i52:                                       ; preds = %.lr.ph.i52.prol.loopexit, %.lr.ph.i52
  ...
  br i1 %exitcond26.not.i.3, label %_ZN2v88internal12StringSearchIhtE31PopulateBoyerMooreHorspoolTableEv.exit, label %.lr.ph.i52, !llvm.loop !85
...
bb.k:                                             ; preds = %.split.loop.exit90
  ...
  br i1 %.not.not, label %bb.d, label %_ZN2v88internal18FindFirstCharacterIhtEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit.thread, !llvm.loop !86
...
_ZN2v88internal12StringSearchIhtE14CharOccurrenceEPit.exit.us: ; preds = %bb.e, %bb.d
  ...
  %i.af = sub i32 %reass.sub.us, %i.ad
  %.not61.us = icmp sgt i32 %i.ae, %i.q
  br i1 %.not61.us, label %.thread, label %.preheader.us, !llvm.loop !87
...
bb.g:                                             ; preds = %bb.f
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %i.am = icmp sgt i64 %indvars.iv, 0
  br i1 %i.am, label %bb.f, label %.thread, !llvm.loop !88
...
.critedge.us:                                     ; preds = %bb.f
  ...
  %i.ar = sub i32 %i.ap, %i.aq                    ; 2 uses
  %i.as = icmp sgt i32 %i.ar, 0
  br i1 %i.as, label %.split.us, label %_ZNK2v84base6VectorIKhE6lengthEv.exit.split.us, !llvm.loop !89
...
_ZN2v88internal12StringSearchIhtE14CharOccurrenceEPit.exit: ; preds = %bb.h, %bb.i
  ...
  %i.bc = add nsw i32 %i.bb, %.154                ; 2 uses
  %.not61 = icmp sgt i32 %i.bc, %i.q
  br i1 %.not61, label %.thread, label %.preheader, !llvm.loop !87
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.v = icmp eq i64 %index.next, %n.vec
  br i1 %i.v, label %middle.block, label %vector.body, !llvm.loop !90
...
.lr.ph:                                           ; preds = %.lr.ph.preheader130, %.lr.ph
  ...
  %indvars.iv.next = add nsw i64 %indvars.iv, 1   ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %i.b
  br i1 %exitcond.not, label %.loopexit128, label %.lr.ph, !llvm.loop !91
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.at = load i32, ptr %i.as, align 4            ; 3 uses
  %.not91 = icmp sgt i32 %i.at, %i.e
  br i1 %.not91, label %.critedge, label %.lr.ph101, !llvm.loop !92
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  store i32 %i.e, ptr %i.bh, align 4
  %i.bi = icmp sgt i64 %indvars.iv.next117, %i.l
  br i1 %i.bi, label %.lr.ph105, label %.critedge94.loopexit, !llvm.loop !93
...
.critedge94:                                      ; preds = %.critedge94.loopexit, %.critedge2, %.critedge
  ...
  %.2 = phi i32 [ %i.bl, %.critedge2 ], [ %i.av, %.critedge ], [ %i.bo, %.critedge94.loopexit ] ; 2 uses
  %i.bp = icmp sgt i32 %.2, %i.h
  br i1 %i.bp, label %bb.c, label %bb.j, !llvm.loop !94
...
bb.t:                                             ; preds = %bb.s, %bb.r
  ...
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next120.1 to i32
  %exitcond122.not.1 = icmp eq i32 %i.ab, %lftr.wideiv.1
  br i1 %exitcond122.not.1, label %.loopexit, label %.lr.ph112, !llvm.loop !95
...
.preheader76.us.backedge:                         ; preds = %_ZN2v88internal12StringSearchIhtE14CharOccurrenceEPit.exit.us, %bb.k
  ...
  br label %.preheader76.us, !llvm.loop !96
...
bb.g:                                             ; preds = %bb.f
  %indvars.iv.next = add nsw i64 %indvars.iv, -1
  %i.aj = icmp sgt i64 %indvars.iv, 0
  br i1 %i.aj, label %bb.f, label %.thread, !llvm.loop !97
...
_ZN2v88internal12StringSearchIhtE14CharOccurrenceEPit.exit: ; preds = %bb.l, %bb.m
  ...
  br i1 %.not65, label %.thread, label %.preheader76, !llvm.loop !98
...
bb.d:                                             ; preds = %.lr.ph.i
  ...
  %lftr.wideiv.i = trunc i64 %indvars.iv.next.i to i32
  %exitcond.not.i = icmp eq i32 %i.h, %lftr.wideiv.i
  br i1 %exitcond.not.i, label %_ZN2v88internal18FindFirstCharacterIttEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit, label %.lr.ph.i, !llvm.loop !99
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %i.ai, label %bb.f, label %_ZN2v88internal18FindFirstCharacterIttEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit, !llvm.loop !100
...
bb.e:                                             ; preds = %.lr.ph.i
  ...
  %lftr.wideiv.i = trunc i64 %indvars.iv.next.i to i32
  %exitcond.not.i = icmp eq i32 %i.g, %lftr.wideiv.i
  br i1 %exitcond.not.i, label %_ZN2v88internal18FindFirstCharacterIttEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit.thread, label %.lr.ph.i, !llvm.loop !99
...
bb.i:                                             ; preds = %bb.h
  %i.ak = add nsw i32 %i.ag, 1
  %i.al = icmp sgt i32 %i.f, %i.ag
  br i1 %i.al, label %bb.g, label %_ZN2v88internal18FindFirstCharacterIttEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit.thread, !llvm.loop !100
...
bb.k:                                             ; preds = %bb.k, %bb.j
  ...
  br i1 %or.cond.i, label %bb.k, label %_ZN2v88internal11CharCompareIttEEbPKT_PKT0_i.exit, !llvm.loop !101

_ZN2v88internal11CharCompareIttEEbPKT_PKT0_i.exit: ; preds = %bb.k
  br i1 %.not.i, label %_ZN2v88internal18FindFirstCharacterIttEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit.thread, label %bb.d, !llvm.loop !102
...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %i.an, label %bb.g, label %_ZN2v88internal18FindFirstCharacterIttEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit.thread, !llvm.loop !100
...
bb.j:                                             ; preds = %.preheader
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.split.loop.exit91, label %.preheader, !llvm.loop !103
...
.lr.ph.i53.prol:                                  ; preds = %.lr.ph.preheader.i52, %.lr.ph.i53.prol
  ...
  %indvars.iv.next24.i.prol.a = add i64 %prol.iter, 1 ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %indvars.iv.next24.i.prol.a, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i53.prol.loopexit, label %.lr.ph.i53.prol, !llvm.loop !104
...
.lr.ph.i53:                                       ; preds = %.lr.ph.i53.prol.loopexit, %.lr.ph.i53
  ...
  %indvars.iv.next24.i.1.a = add nsw i64 %indvars.iv23.i, 4 ; 2 uses
  %exitcond26.not.i.1 = icmp eq i64 %indvars.iv.next24.i.1.a, %wide.trip.count.i
  br i1 %exitcond26.not.i.1, label %_ZN2v88internal12StringSearchIttE31PopulateBoyerMooreHorspoolTableEv.exit, label %.lr.ph.i53, !llvm.loop !105
...
bb.l:                                             ; preds = %.split.loop.exit91
  ...
  %.not.not = icmp slt i32 %.4.i, %i.f
  br i1 %.not.not, label %bb.d, label %_ZN2v88internal18FindFirstCharacterIttEEiNS_4base6VectorIKT_EENS3_IKT0_EEi.exit.thread, !llvm.loop !106
...
bb.d:                                             ; preds = %.preheader.us
  ...
  %i.af = sub i32 %reass.sub.us, %i.ad
  %.not61.us = icmp sgt i32 %i.ae, %i.q
  br i1 %.not61.us, label %.thread, label %.preheader.us, !llvm.loop !107
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.al, label %bb.e, label %.thread, !llvm.loop !108
...
.critedge.us:                                     ; preds = %bb.e
  ...
  br i1 %i.ar, label %.split.us, label %_ZNK2v84base6VectorIKtE6lengthEv.exit62.split.us, !llvm.loop !109
...
bb.g:                                             ; preds = %.preheader
  ...
  br i1 %.not61, label %.thread, label %.preheader, !llvm.loop !107
...
.lr.ph:                                           ; preds = %.lr.ph.preheader130, %.lr.ph
  ...
  %indvars.iv.next = add nsw i64 %indvars.iv, 1   ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %i.b
  br i1 %exitcond.not, label %.loopexit128, label %.lr.ph, !llvm.loop !111
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.at = load i32, ptr %i.as, align 4            ; 3 uses
  %.not91 = icmp sgt i32 %i.at, %i.e
  br i1 %.not91, label %.critedge, label %.lr.ph101, !llvm.loop !112
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  store i32 %i.e, ptr %i.bh, align 4
  %i.bi = icmp sgt i64 %indvars.iv.next117, %i.l
  br i1 %i.bi, label %.lr.ph105, label %.critedge94.loopexit, !llvm.loop !113
...
.critedge94:                                      ; preds = %.critedge94.loopexit, %.critedge2, %.critedge
  ...
  %.2 = phi i32 [ %i.bl, %.critedge2 ], [ %i.av, %.critedge ], [ %i.bo, %.critedge94.loopexit ] ; 2 uses
  %i.bp = icmp sgt i32 %.2, %i.h
  br i1 %i.bp, label %bb.c, label %bb.j, !llvm.loop !114
...
bb.t:                                             ; preds = %bb.s, %bb.r
  ...
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next120.1 to i32
  %exitcond122.not.1 = icmp eq i32 %i.ab, %lftr.wideiv.1
  br i1 %exitcond122.not.1, label %.loopexit, label %.lr.ph112, !llvm.loop !115
...
.preheader74.us.backedge:                         ; preds = %bb.d, %bb.i
  %.150.us.be = phi i32 [ %i.ad, %bb.d ], [ %.251.us, %bb.i ]
  br label %.preheader74.us, !llvm.loop !116
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.ai, label %bb.e, label %.thread, !llvm.loop !117
...
bb.j:                                             ; preds = %.preheader74
  ...
  %i.bg = add nsw i32 %i.bf, %.150                ; 2 uses
  %.not65 = icmp sgt i32 %i.bg, %i.q
  br i1 %.not65, label %.thread, label %.preheader74, !llvm.loop !118
...
!68 = distinct !{!68, !19}
!69 = distinct !{!69, !19}
!70 = distinct !{!70, !19, !46, !47}
!71 = distinct !{!71, !19, !47, !46}
!72 = distinct !{!72, !19}
!73 = distinct !{!73, !19}
!74 = distinct !{!74, !19}
!75 = distinct !{!75, !19}
...
!88 = distinct !{!88, !19}
!89 = distinct !{!89, !19}
!90 = distinct !{!90, !19, !46, !47}
!91 = distinct !{!91, !19, !47, !46}
!92 = distinct !{!92, !19}
!93 = distinct !{!93, !19}
!94 = distinct !{!94, !19}
!95 = distinct !{!95, !19}
...
!108 = distinct !{!108, !19}
!109 = distinct !{!109, !19}
!110 = distinct !{!110, !19, !46, !47}
!111 = distinct !{!111, !19, !47, !46}
!112 = distinct !{!112, !19}
!113 = distinct !{!113, !19}
!114 = distinct !{!114, !19}
!115 = distinct !{!115, !19}
