...
begin_hunk_0_@_ZN2v88internal13DebugEvaluate5LocalEPNS0_7IsolateENS0_12StackFrameIdEiNS0_12DirectHandleINS0_6StringEEEb:bb.a
  ...
  %i.bx = load i64, ptr %.sroa.0.0.copyload.i41, align 8
  store i64 %i.bx, ptr %7, align 8
  %i.by = call i64 @_ZNK2v88internal7Context12global_proxyEv(ptr noundef nonnull align 8 dereferenceable(8) %7) #12
  ...
  br i1 %i.cd, label %bb.k, label %_ZN2v88internal6HandleINS0_8JSObjectEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit, !prof !5

bb.k:                                             ; preds = %bb.j
  %i.ce = call noundef ptr @_ZN2v88internal11HandleScope6ExtendEPNS0_7IsolateE(ptr noundef nonnull %0) #12
  br label %_ZN2v88internal6HandleINS0_8JSObjectEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit

_ZN2v88internal6HandleINS0_8JSObjectEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit: ; preds = %bb.j, %bb.k
  %.0.i.i = phi ptr [ %i.ce, %bb.k ], [ %i.ca, %bb.j ] ; 4 uses
  %i.cf = ptrtoint ptr %.0.i.i to i64
  %i.cg = add i64 %i.cf, 8
  %i.ch = inttoptr i64 %i.cg to ptr
  store ptr %i.ch, ptr %i.bz, align 8
  store i64 %i.by, ptr %.0.i.i, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #12
  %i.ci = getelementptr inbounds nuw i8, ptr %6, i64 88
  %.sroa.0.0.copyload.i.i42 = load ptr, ptr %i.ci, align 8
  %i.cj = load i64, ptr %.sroa.0.0.copyload.i.i42, align 8
  %i.ck = add i64 %i.cj, 31
  ...
  %i.cp = getelementptr inbounds nuw i8, ptr %i.co, i64 560 ; 2 uses
  %i.cq = load ptr, ptr %i.cp, align 8            ; 2 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %i.co, i64 568
  %i.cs = load ptr, ptr %i.cr, align 8
  %i.ct = icmp eq ptr %i.cq, %i.cs
  br i1 %i.ct, label %bb.l, label %_ZNK2v88internal13DebugEvaluate14ContextBuilder10outer_infoEv.exit, !prof !5

bb.l:                                             ; preds = %_ZN2v88internal6HandleINS0_8JSObjectEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit
  %i.cu = call noundef ptr @_ZN2v88internal11HandleScope6ExtendEPNS0_7IsolateE(ptr noundef nonnull %i.co) #12
  br label %_ZNK2v88internal13DebugEvaluate14ContextBuilder10outer_infoEv.exit

_ZNK2v88internal13DebugEvaluate14ContextBuilder10outer_infoEv.exit: ; preds = %_ZN2v88internal6HandleINS0_8JSObjectEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit, %bb.l
  %.0.i.i.i = phi ptr [ %i.cu, %bb.l ], [ %i.cq, %_ZN2v88internal6HandleINS0_8JSObjectEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit ] ; 3 uses
...
_ZNK2v88internal11MaybeHandleINS0_6ObjectEE5CheckEv.exit43: ; preds = %bb.d, %_ZN2v88internal6HandleINS0_6ObjectEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit
  %i.aw = call ptr @_ZN2v88internal9ScopeInfo18CreateForWithScopeEPNS0_7IsolateENS0_17MaybeDirectHandleIS1_EE(ptr noundef nonnull %0, ptr null) #12 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #12
  %i.ax = load i64, ptr %i.aw, align 8
  store i64 %i.ax, ptr %3, align 8
  call void @_ZN2v88internal9ScopeInfo23SetIsDebugEvaluateScopeEv(ptr noundef nonnull align 8 dereferenceable(8) %3) #12
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #12
  %i.ay = call ptr @_ZN2v88internal7Factory23NewDebugEvaluateContextENS0_12DirectHandleINS0_7ContextEEENS2_INS0_9ScopeInfoEEENS2_INS0_10JSReceiverEEES4_(ptr noundef nonnull align 1 dereferenceable(1) %0, ptr nonnull %.0.i, ptr nonnull %i.aw, ptr %i.y, ptr null) #12
  %i.az = load i64, ptr %.0.i, align 8
  %i.ba = add i64 %i.az, 527
  %i.bb = inttoptr i64 %i.ba to ptr
  %i.bc = load atomic volatile i64, ptr %i.bb monotonic, align 8
  %i.bd = add i64 %i.bc, 31
  %i.be = inttoptr i64 %i.bd to ptr
  %i.bf = load atomic volatile i64, ptr %i.be monotonic, align 8
  %i.bg = load ptr, ptr %i.p, align 8             ; 2 uses
  %i.bh = load ptr, ptr %i.r, align 8
  %i.bi = icmp eq ptr %i.bg, %i.bh
  br i1 %i.bi, label %bb.f, label %_ZN2v88internal6HandleINS0_18SharedFunctionInfoEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit, !prof !5

bb.f:                                             ; preds = %_ZNK2v88internal11MaybeHandleINS0_6ObjectEE5CheckEv.exit43
  %i.bj = call noundef ptr @_ZN2v88internal11HandleScope6ExtendEPNS0_7IsolateE(ptr noundef nonnull %0) #12
  br label %_ZN2v88internal6HandleINS0_18SharedFunctionInfoEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit
end_hunk_0
