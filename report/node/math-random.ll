...
bb.e:                                             ; preds = %bb.d
  tail call void @_ZN2v88internal12WriteBarrier40CombinedGenerationalAndSharedBarrierSlowENS0_6TaggedINS0_10HeapObjectEEEmS4_(i64 %i.b, i64 noundef %i.d, i64 %i.c) #6
  br label %bb.f
...
bb.g:                                             ; preds = %bb.f
  tail call void @_ZN2v88internal12WriteBarrier11MarkingSlowENS0_6TaggedINS0_10HeapObjectEEENS0_18FullHeapObjectSlotES4_(i64 %i.b, i64 %i.d, i64 %i.c) #6
...
_ZN2v88internal7Context21set_math_random_cacheENS0_6TaggedINS0_16FixedDoubleArrayEEE.exit: ; preds = %bb.b, %bb.f, %bb.g
  %i.o = tail call ptr @_ZN2v88internal11FactoryBaseINS0_7FactoryEE12NewByteArrayEiNS0_14AllocationTypeENS0_19AllocationAlignmentE(ptr noundef nonnull align 1 dereferenceable(1) %0, i32 noundef 16, i8 noundef zeroext 1, i8 noundef zeroext 0) #6
...
bb.j:                                             ; preds = %bb.i
  tail call void @_ZN2v88internal12WriteBarrier40CombinedGenerationalAndSharedBarrierSlowENS0_6TaggedINS0_10HeapObjectEEEmS4_(i64 %i.p, i64 noundef %i.r, i64 %i.q) #6
  br label %bb.k
...
bb.l:                                             ; preds = %bb.k
  tail call void @_ZN2v88internal12WriteBarrier11MarkingSlowENS0_6TaggedINS0_10HeapObjectEEENS0_18FullHeapObjectSlotES4_(i64 %i.p, i64 %i.r, i64 %i.q) #6
...
bb.d:                                             ; preds = %bb.b
  %i.l = tail call noundef ptr @_ZN2v88internal7Isolate23random_number_generatorEv(ptr noundef nonnull align 8 dereferenceable(64320) %0) #6
  call void @_ZN2v84base21RandomNumberGenerator9NextBytesEPvm(ptr noundef nonnull align 8 dereferenceable(24) %i.l, ptr noundef nonnull %i.a, i64 noundef 8) #6
  %.pre = load i64, ptr %i.a, align 8
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c
  %i.m = phi i64 [ %.pre, %bb.d ], [ %i.k, %bb.c ]
  %i.n = call noundef i64 @_ZN2v84base21RandomNumberGenerator11MurmurHash3Em(i64 noundef %i.m) #6 ; 2 uses
  %i.o = load i64, ptr %i.a, align 8
  %i.p = xor i64 %i.o, -1
  %i.q = call noundef i64 @_ZN2v84base21RandomNumberGenerator11MurmurHash3Em(i64 noundef %i.p) #6 ; 2 uses
  %i.r = or i64 %i.q, %i.n
  %.not11 = icmp eq i64 %i.r, 0
  br i1 %.not11, label %bb.f, label %bb.g, !prof !8

bb.f:                                             ; preds = %bb.e
  call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1) #7
  unreachable
