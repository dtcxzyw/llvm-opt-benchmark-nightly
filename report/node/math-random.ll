...
bb.a:
  %i.a = tail call ptr @_ZN2v88internal11FactoryBaseINS0_7FactoryEE19NewFixedDoubleArrayEiNS0_14AllocationTypeE(ptr noundef nonnull align 1 dereferenceable(1) %0, i32 noundef 64, i8 noundef zeroext 0) #5 ; 5 uses
  br label %bb.m
...
bb.e:                                             ; preds = %bb.d
  tail call void @_ZN2v88internal12WriteBarrier40CombinedGenerationalAndSharedBarrierSlowENS0_6TaggedINS0_10HeapObjectEEEmS4_(i64 %i.b, i64 noundef %i.d, i64 %i.c) #5
  br label %bb.f
...
bb.g:                                             ; preds = %bb.f
  tail call void @_ZN2v88internal12WriteBarrier11MarkingSlowENS0_6TaggedINS0_10HeapObjectEEENS0_18FullHeapObjectSlotES4_(i64 %i.b, i64 %i.d, i64 %i.c) #5
...
_ZN2v88internal7Context21set_math_random_cacheENS0_6TaggedINS0_16FixedDoubleArrayEEE.exit: ; preds = %bb.b, %bb.f, %bb.g
  %i.o = tail call ptr @_ZN2v88internal11FactoryBaseINS0_7FactoryEE12NewByteArrayEiNS0_14AllocationTypeENS0_19AllocationAlignmentE(ptr noundef nonnull align 1 dereferenceable(1) %0, i32 noundef 16, i8 noundef zeroext 1, i8 noundef zeroext 0) #5
  %i.p = load i64, ptr %1, align 8                ; 4 uses
  %i.q = load i64, ptr %i.o, align 8              ; 5 uses
  %i.r = add i64 %i.p, 1343                       ; 3 uses
end_hunk_2
begin_hunk_3_@_ZN2v88internal10MathRandom17InitializeContextEPNS0_7IsolateENS0_12DirectHandleINS0_7ContextEEE:bb.a
  br i1 %.not39.i.i.i15, label %bb.k, label %bb.j

bb.j:                                             ; preds = %bb.i
  tail call void @_ZN2v88internal12WriteBarrier40CombinedGenerationalAndSharedBarrierSlowENS0_6TaggedINS0_10HeapObjectEEEmS4_(i64 %i.p, i64 noundef %i.r, i64 %i.q) #5
  br label %bb.k
...
bb.l:                                             ; preds = %bb.k
  tail call void @_ZN2v88internal12WriteBarrier11MarkingSlowENS0_6TaggedINS0_10HeapObjectEEENS0_18FullHeapObjectSlotES4_(i64 %i.p, i64 %i.r, i64 %i.q) #5
...
end_hunk_3
begin_hunk_4_@_ZN2v88internal10MathRandom17InitializeContextEPNS0_7IsolateENS0_12DirectHandleINS0_7ContextEEE:bb.a
  ...
  store <2 x i64> zeroinitializer, ptr %i.ak, align 4
  ret void
...
bb.a:
  ...
  store <2 x i64> zeroinitializer, ptr %i.h, align 4
  ret void
}
...
bb.a:
end_hunk_5
begin_hunk_6_@_ZN2v88internal10MathRandom11RefillCacheEPNS0_7IsolateEm:bb.a
...
end_hunk_6
begin_hunk_7_@_ZN2v88internal10MathRandom11RefillCacheEPNS0_7IsolateEm:bb.a
  br label %bb.e

bb.d:                                             ; preds = %bb.b
  %i.l = tail call noundef ptr @_ZN2v88internal7Isolate23random_number_generatorEv(ptr noundef nonnull align 8 dereferenceable(64320) %0) #5
  call void @_ZN2v84base21RandomNumberGenerator9NextBytesEPvm(ptr noundef nonnull align 8 dereferenceable(24) %i.l, ptr noundef nonnull %i.a, i64 noundef 8) #5
  %.pre = load i64, ptr %i.a, align 8
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c
  %i.m = phi i64 [ %.pre, %bb.d ], [ %i.k, %bb.c ]
  %i.n = call noundef i64 @_ZN2v84base21RandomNumberGenerator11MurmurHash3Em(i64 noundef %i.m) #5 ; 2 uses
  %i.o = load i64, ptr %i.a, align 8
  %i.p = xor i64 %i.o, -1
  %i.q = call noundef i64 @_ZN2v84base21RandomNumberGenerator11MurmurHash3Em(i64 noundef %i.p) #5 ; 2 uses
  %i.r = or i64 %i.q, %i.n
  %.not11 = icmp eq i64 %i.r, 0
  br i1 %.not11, label %bb.f, label %bb.g, !prof !8

bb.f:                                             ; preds = %bb.e
  call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1) #6
  unreachable
...
end_hunk_7
begin_hunk_8_@_ZN2v84base21RandomNumberGenerator11MurmurHash3Em
...
end_hunk_8
begin_hunk_9_@_ZN2v88internal11FactoryBaseINS0_7FactoryEE12NewByteArrayEiNS0_14AllocationTypeENS0_19AllocationAlignmentE
