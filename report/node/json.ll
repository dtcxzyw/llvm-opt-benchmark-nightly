...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ad = tail call double @llvm.trunc.f64(double %1)
...
declare void @_ZN8v8_crdtp4json8platform6DToStrB5cxx11Ed(ptr dead_on_unwind writable sret(%"class.std::__cxx11::basic_string") align 8, double noundef) local_unnamed_addr #9
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.bk = tail call double @llvm.trunc.f64(double %1)
...
define internal fastcc noundef range(i32 0, 13) i32 @_ZN8v8_crdtp4json12_GLOBAL__N_110JsonParserIhE10ParseTokenEPKhS5_PS5_S6_(ptr noundef %0, ptr noundef %1, ptr noundef nonnull writeonly captures(none) %2, ptr noundef nonnull writeonly captures(none) %3) unnamed_addr #11 align 2 {
bb.a:
...
declare noundef zeroext i1 @_ZN8v8_crdtp4json8platform6StrToDEPKcPd(ptr noundef, ptr noundef) local_unnamed_addr #9
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable
define internal fastcc noundef range(i32 0, 13) i32 @_ZN8v8_crdtp4json12_GLOBAL__N_110JsonParserItE10ParseTokenEPKtS5_PS5_S6_(ptr noundef %0, ptr noundef %1, ptr noundef nonnull writeonly captures(none) %2, ptr noundef nonnull writeonly captures(none) %3) unnamed_addr #11 align 2 {
bb.a:
  %i.a = icmp ult ptr %0, %1
...
declare void @_ZN8v8_crdtp4cbor9ParseCBORESt4spanIKhLm18446744073709551615EEPNS_13ParserHandlerE(ptr, i64, ptr noundef) local_unnamed_addr #9

declare void @_ZN8v8_crdtp4cbor14NewCBOREncoderEPSt6vectorIhSaIhEEPNS_6StatusE(ptr dead_on_unwind writable sret(%"class.std::unique_ptr") align 8, ptr noundef, ptr noundef) local_unnamed_addr #9
