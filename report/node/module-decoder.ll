...
bb.ag:                                            ; preds = %bb.ae
  ...
  %i.bx = load ptr, ptr %i.e, align 8             ; 3 uses
  %i.by = ptrtoint ptr %i.bx to i64
  %i.bz = sub i64 %i.bt, %i.by
  %i.ca = trunc i64 %i.bz to i32
  %.not.i13 = icmp ugt i32 %i.bw, %i.ca
  br i1 %.not.i13, label %bb.ai, label %bb.ah, !prof !22

bb.ah:                                            ; preds = %bb.ag
  %i.cb = and i64 %i.bv, 4294967295
  %i.cc = getelementptr inbounds nuw i8, ptr %i.bx, i64 %i.cb
  br label %_ZN2v88internal4wasm7Decoder13consume_bytesEjPKc.exit15

bb.ai:                                            ; preds = %bb.ag
  call preserve_mostcc void @_ZN2v88internal4wasm7Decoder6errorfIJjEEEvPKhPKcDpT_(ptr noundef nonnull align 8 dereferenceable(80) %0, ptr noundef %i.bx, ptr noundef nonnull @.str.1136, i32 noundef %i.bw)
  %i.cd = load ptr, ptr %i.f, align 8
  br label %_ZN2v88internal4wasm7Decoder13consume_bytesEjPKc.exit15

_ZN2v88internal4wasm7Decoder13consume_bytesEjPKc.exit15: ; preds = %bb.ah, %bb.ai
  %storemerge.i14 = phi ptr [ %i.cd, %bb.ai ], [ %i.cc, %bb.ah ]
...
bb.am:                                            ; preds = %bb.b
  ...
  %i.cg = and i32 %i.cf, 1024
  %.not27 = icmp eq i32 %i.cg, 0
...
bb.ao:                                            ; preds = %bb.am
  ...
  %i.ci = call noundef ptr @_ZN2v88internal4wasm11SectionNameENS1_11SectionCodeE(i8 noundef signext 14)
  call preserve_mostcc void @_ZN2v88internal4wasm7Decoder6errorfIJPKcEEEvPKhS5_DpT_(ptr noundef nonnull align 8 dereferenceable(80) %0, ptr noundef %i.ch, ptr noundef nonnull @.str.93, ptr noundef nonnull %i.ci)
  br label %bb.aq

bb.ap:                                            ; preds = %bb.b
  %i.cj = load ptr, ptr %i.e, align 8
  %i.ck = call noundef ptr @_ZN2v88internal4wasm11SectionNameENS1_11SectionCodeE(i8 noundef signext %1)
  call preserve_mostcc void @_ZN2v88internal4wasm7Decoder6errorfIJPKcEEEvPKhS5_DpT_(ptr noundef nonnull align 8 dereferenceable(80) %0, ptr noundef %i.cj, ptr noundef nonnull @.str.94, ptr noundef nonnull %i.ck)
  br label %bb.as
...
bb.aq:                                            ; preds = %bb.an, %bb.ao, %bb.af, %_ZN2v88internal4wasm7Decoder13consume_bytesEjPKc.exit15, %bb.aa, %_ZN2v88internal4wasm7Decoder13consume_bytesEjPKc.exit12, %bb.v, %_ZN2v88internal4wasm7Decoder13consume_bytesEjPKc.exit9, %bb.al, %bb.ak, %bb.aj, %bb.t, %bb.s, %_ZN2v88internal4wasm7Decoder13consume_bytesEjPKc.exit, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c, %bb.b
  %i.cl = load ptr, ptr %i.e, align 8             ; 4 uses
  %.not = icmp eq ptr %i.cl, %i.c
  br i1 %.not, label %bb.as, label %bb.ar

bb.ar:                                            ; preds = %bb.aq
  %i.cm = icmp ult ptr %i.cl, %i.c
  %i.cn = select i1 %i.cm, ptr @.str.78, ptr @.str.79
  %i.co = ptrtoint ptr %i.cl to i64
  %i.cp = ptrtoint ptr %2 to i64
  %i.cq = sub i64 %i.co, %i.cp
  call preserve_mostcc void @_ZN2v88internal4wasm7Decoder6errorfIJPKcmmEEEvPKhS5_DpT_(ptr noundef nonnull align 8 dereferenceable(80) %0, ptr noundef %i.cl, ptr noundef nonnull @.str.95, ptr noundef nonnull %i.cn, i64 noundef %3, i64 noundef %i.cq)
  br label %bb.as
...
.lr.ph.i.i:                                       ; preds = %bb.e, %bb.i
  ...
  %2 = getelementptr inbounds nuw i8, ptr %.sroa.030.033.i.i, i64 4
  %3 = load i8, ptr %2, align 4, !range !38, !noundef !39
  %4 = trunc nuw i8 %3 to i1
  %i.r = getelementptr inbounds nuw i8, ptr %.sroa.030.033.i.i, i64 21
  %i.s = load i8, ptr %i.r, align 1, !range !38
  %i.t = trunc nuw i8 %i.s to i1
  %or.cond.i.i = select i1 %4, i1 %i.t, i1 false
...
.lr.ph.i:                                         ; preds = %bb.j, %bb.n
  ...
  %2 = getelementptr inbounds nuw i8, ptr %.sroa.030.033.i, i64 4
  %3 = load i8, ptr %2, align 4, !range !38, !noundef !39
  %4 = trunc nuw i8 %3 to i1
  %i.ap = getelementptr inbounds nuw i8, ptr %.sroa.030.033.i, i64 21
  %i.aq = load i8, ptr %i.ap, align 1, !range !38
  %i.ar = trunc nuw i8 %i.aq to i1
  %or.cond.i = select i1 %4, i1 %i.ar, i1 false
...
bb.a:
  %5 = alloca %"class.v8::internal::wasm::WasmError", align 8 ; 7 uses
  %i.a = load ptr, ptr %0, align 8                ; 7 uses
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 40
  %i.c = load i32, ptr %i.b, align 8
  %.not.i.i = icmp eq i32 %i.c, -1
  br i1 %.not.i.i, label %_ZN2v88internal4wasm9WasmErroraSEOS2_.exit.i.i, label %bb.b

_ZN2v88internal4wasm9WasmErroraSEOS2_.exit.i.i:   ; preds = %bb.a
  ...
  store i8 0, ptr %.pre.i.i.i.i, align 1
  %i.o = load ptr, ptr %i.i, align 8              ; 2 uses
  %i.p = icmp eq ptr %i.o, %i.j
  br i1 %i.p, label %_ZN2v88internal4wasm7Decoder5ResetENS_4base6VectorIKhEEj.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i
...
_ZN2v88internal4wasm7Decoder5ResetENS_4base6VectorIKhEEj.exit: ; preds = %_ZN2v88internal4wasm9WasmErroraSEOS2_.exit.i.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i
  ...
  %i.t = call noundef signext i8 @_ZN2v88internal4wasm30IdentifyUnknownSectionInternalEPNS1_7DecoderEPNS1_7ITracerE(ptr noundef %i.s, ptr noundef null)
  store i8 %i.t, ptr %4, align 1
...
bb.b:                                             ; preds = %bb.a, %_ZN2v88internal4wasm7Decoder5ResetENS_4base6VectorIKhEEj.exit
  %.0 = phi i64 [ %i.z, %_ZN2v88internal4wasm7Decoder5ResetENS_4base6VectorIKhEEj.exit ], [ 0, %bb.a ]
  ret i64 %.0
}
...
_ZNK2v84base6VectorIKcEeqERKS3_.exit.2:           ; preds = %bb.b
  ...
  %.not9.i.i.i.i.i.i.i.2 = icmp eq i32 %i.ab, 0
  br i1 %.not9.i.i.i.i.i.i.i.2, label %_ZNK2v84base6VectorIKcEeqERKS3_.exit.thread, label %_ZNK2v84base6VectorIKcEeqERKS3_.exit.8

_ZNK2v84base6VectorIKcEeqERKS3_.exit.3:           ; preds = %bb.b
  %i.ac = load i128, ptr %i.j, align 1
  %i.ad = xor i128 %i.ac, 152041777635586164654133699032844100973
  %i.ae = getelementptr i8, ptr %i.j, i64 9
...
.lr.ph.i:                                         ; preds = %bb.c, %bb.g
  ...
  %3 = getelementptr inbounds nuw i8, ptr %.sroa.030.033.i, i64 4
  %4 = load i8, ptr %3, align 4, !range !38, !noundef !39
  %5 = trunc nuw i8 %4 to i1
  %i.l = getelementptr inbounds nuw i8, ptr %.sroa.030.033.i, i64 21
  %i.m = load i8, ptr %i.l, align 1, !range !38
  %i.n = trunc nuw i8 %i.m to i1
  %or.cond.i = select i1 %5, i1 %i.n, i1 false
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.ae, label %.lr.ph.i, label %bb.h
...
bb.g:                                             ; preds = %bb.g, %.lr.ph.i
  ...
  br i1 %i.at, label %bb.g, label %bb.h, !llvm.loop !295
...
bb.h:                                             ; preds = %bb.g, %bb.e, %bb.f
  ...
  %i.av = load i8, ptr %i.au, align 8, !range !38
  %i.aw = trunc nuw i8 %i.av to i1
  %or.cond = select i1 %3, i1 true, i1 %i.aw
...
bb.i:                                             ; preds = %bb.h
  ...
  %scevgep.i = getelementptr i8, ptr %4, i64 -184
...
bb.j:                                             ; preds = %bb.i
  %i.az = getelementptr i8, ptr %4, i64 -359      ; 2 uses
...
.critedge:                                        ; preds = %bb.h
  ...
  %scevgep.i10 = getelementptr i8, ptr %5, i64 -184
