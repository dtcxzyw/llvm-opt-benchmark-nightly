...
begin_hunk_0_@_ZN6icu_7819TransliteratorAlias6createER11UParseErrorR10UErrorCode:bb.a
  %i.w = sext i16 %i.v to i32
  %i.x = getelementptr inbounds nuw i8, ptr %3, i64 12 ; 2 uses
  %i.y = load i32, ptr %i.x, align 4
  %i.z = select i1 %i.u, i32 %i.y, i32 %i.w       ; 4 uses
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 80 ; 7 uses
  %7 = load i16, ptr %6, align 8                  ; 2 uses
  %i.aa = icmp slt i16 %7, 0
  %8 = ashr i16 %7, 5
  %9 = sext i16 %8 to i32
  %10 = getelementptr inbounds nuw i8, ptr %0, i64 84 ; 4 uses
  %11 = load i32, ptr %10, align 4
  %12 = select i1 %i.aa, i32 %11, i32 %9
  %13 = and i16 %i.t, 1
  %.not.i.i = icmp eq i16 %13, 0
  br i1 %.not.i.i, label %.sink.split.i.i.i, label %._crit_edge

.sink.split.i.i.i:                                ; preds = %bb.f
  %spec.select.i.i = call i32 @llvm.smin.i32(i32 %i.z, i32 0) ; 2 uses
  %14 = icmp slt i32 %i.z, 0
  br i1 %14, label %._crit_edge, label %_ZNK6icu_7813UnicodeString10pinIndicesERiS1_.exit.i.i

_ZNK6icu_7813UnicodeString10pinIndicesERiS1_.exit.i.i: ; preds = %.sink.split.i.i.i
  %15 = sub nuw nsw i32 %i.z, %spec.select.i.i
  %16 = call i32 @llvm.umin.i32(i32 %i.z, i32 %15) ; 2 uses
  %.not.i = icmp eq i32 %16, 0
  br i1 %.not.i, label %._crit_edge, label %_ZNK6icu_7813UnicodeString7indexOfERKS0_.exit
...
_ZNK6icu_7813UnicodeString7indexOfERKS0_.exit:    ; preds = %_ZNK6icu_7813UnicodeString10pinIndicesERiS1_.exit.i.i
  ...
  %i.ag = call noundef i32 @_ZNK6icu_7813UnicodeString7indexOfEPKDsiiii(ptr noundef nonnull align 8 dereferenceable(64) %i.r, ptr noundef %i.af, i32 noundef %spec.select.i.i, i32 noundef %16, i32 noundef 0, i32 noundef %12) #11 ; 2 uses
...
_ZNK6icu_7813UnicodeString8pinIndexERi.exit.i:    ; preds = %_ZNK6icu_7813UnicodeString8pinIndexERi.exit.i.lr.ph, %_ZNK6icu_7813UnicodeString7indexOfERKS0_i.exit
  ...
  %17 = add nuw nsw i32 %.03262, 1
  %.pre.i = load i16, ptr %6, align 8             ; 2 uses
  %18 = icmp slt i16 %.pre.i, 0
  %19 = ashr i16 %.pre.i, 5
  %20 = sext i16 %19 to i32
  %21 = load i32, ptr %10, align 4
  %22 = select i1 %18, i32 %21, i32 %20           ; 2 uses
  %spec.select.i = call i32 @llvm.smin.i32(i32 %17, i32 %22) ; 2 uses
  ...
  %i.ap = select i1 %i.al, i32 %i.ao, i32 %i.an   ; 4 uses
  %23 = sub nsw i32 %22, %spec.select.i
  %24 = and i16 %i.ak, 1
  %.not.i.i52 = icmp eq i16 %24, 0
  br i1 %.not.i.i52, label %.sink.split.i.i.i54, label %._crit_edge

.sink.split.i.i.i54:                              ; preds = %_ZNK6icu_7813UnicodeString8pinIndexERi.exit.i
  %spec.select.i.i55 = call i32 @llvm.smin.i32(i32 %i.ap, i32 0) ; 2 uses
  %25 = icmp slt i32 %i.ap, 0
  br i1 %25, label %._crit_edge, label %_ZNK6icu_7813UnicodeString10pinIndicesERiS1_.exit.i.i56

_ZNK6icu_7813UnicodeString10pinIndicesERiS1_.exit.i.i56: ; preds = %.sink.split.i.i.i54
  %26 = sub nuw nsw i32 %i.ap, %spec.select.i.i55
  %27 = call i32 @llvm.umin.i32(i32 %i.ap, i32 %26) ; 2 uses
  %.not.i57 = icmp eq i32 %27, 0
  br i1 %.not.i57, label %._crit_edge, label %_ZNK6icu_7813UnicodeString7indexOfERKS0_i.exit

_ZNK6icu_7813UnicodeString7indexOfERKS0_i.exit:   ; preds = %_ZNK6icu_7813UnicodeString10pinIndicesERiS1_.exit.i.i56
  %i.aq = and i16 %i.ak, 2
  %.not.i.i.i58 = icmp eq i16 %i.aq, 0
  %i.ar = load ptr, ptr %i.aj, align 8
  %i.as = select i1 %.not.i.i.i58, ptr %i.ar, ptr %i.ai
  %i.at = call noundef i32 @_ZNK6icu_7813UnicodeString7indexOfEPKDsiiii(ptr noundef nonnull align 8 dereferenceable(64) %i.r, ptr noundef %i.as, i32 noundef %spec.select.i.i55, i32 noundef %27, i32 noundef %spec.select.i, i32 noundef %23) #11 ; 2 uses
  %i.au = icmp sgt i32 %i.at, -1
  br i1 %i.au, label %_ZNK6icu_7813UnicodeString8pinIndexERi.exit.i, label %._crit_edge, !llvm.loop !5

._crit_edge:                                      ; preds = %.sink.split.i.i.i54, %_ZNK6icu_7813UnicodeString8pinIndexERi.exit.i, %_ZNK6icu_7813UnicodeString10pinIndicesERiS1_.exit.i.i56, %_ZNK6icu_7813UnicodeString7indexOfERKS0_i.exit, %.sink.split.i.i.i, %bb.f, %_ZNK6icu_7813UnicodeString10pinIndicesERiS1_.exit.i.i, %_ZNK6icu_7813UnicodeString7indexOfERKS0_.exit
...
end_hunk_0
begin_hunk_1_@_ZN6icu_7819TransliteratorAlias6createER11UParseErrorR10UErrorCode:bb.a
  br i1 %i.bn, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %i.bo = load i16, ptr %6, align 8               ; 2 uses
  %i.bp = and i16 %i.bo, 1
  %.not.i.i60 = icmp eq i16 %i.bp, 0
  %i.bq = and i16 %i.bo, 30
  %storemerge.i.i = select i1 %.not.i.i60, i16 %i.bq, i16 2
  store i16 %storemerge.i.i, ptr %6, align 8
  br label %_ZN6icu_7813UnicodeString6removeEii.exit

bb.i:                                             ; preds = %bb.g
end_hunk_1
begin_hunk_2_@_ZN6icu_7819TransliteratorAlias6createER11UParseErrorR10UErrorCode:bb.a
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k
  %i.bz = load i16, ptr %6, align 8               ; 2 uses
  %i.ca = icmp slt i16 %i.bz, 0
  %i.cb = ashr i16 %i.bz, 5
  %i.cc = sext i16 %i.cb to i32
  %i.cd = load i32, ptr %10, align 4
