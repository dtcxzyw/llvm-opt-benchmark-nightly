...
begin_hunk_2_@ucnv_MBCSFromUnicodeWithOffsets_78:bb.a
  ...
  %i.dm = icmp ult i32 %.3103.i, 65536
  %i.dn = select i1 %i.dm, i32 1, i32 2           ; 3 uses
...
begin_hunk_4_@ucnv_MBCSFromUnicodeWithOffsets_78:bb.a
  ...
  %2 = sub i32 %i.dn, %i.dt
  %3 = icmp ugt i32 %2, -4
  br i1 %3, label %.loopexit132.loopexit.i, label %.lr.ph.i
...
bb.ax:                                            ; preds = %bb.av
  ...
  %10 = zext nneg i32 %6 to i64                   ; 2 uses
  %i.mi = getelementptr inbounds nuw [2 x i8], ptr %i.mb, i64 %10 ; 2 uses
  %i.mj = sub i32 %i.lv, %9
  %i.mk = zext i32 %i.mj to i64
  %i.ml = getelementptr inbounds nuw [4 x i8], ptr %i.mi, i64 %i.mk
  %i.mm = getelementptr inbounds nuw [2 x i8], ptr %i.mg, i64 %10
  %i.mn = shl i32 %9, 2
