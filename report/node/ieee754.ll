...
bb.i:                                             ; preds = %bb.g
  ...
  %i.bc = fmul double %i.bb, 5.000000e-01         ; 7 uses
  ...
  %1 = tail call double @llvm.fmuladd.f64(double %i.bh, double %i.bg, double %i.bc)
  %2 = fadd double %i.bd, %i.bg
  %3 = fdiv double %1, %2
  %i.bi = insertelement <2 x double> <double poison, double -0.000000e+00>, double %i.bc, i64 0 ; 5 uses
  %4 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bi, <2 x double> <double f0x3F023DE10DFDF709, double 0.000000e+00>, <2 x double> <double f0x3F49EFE07501B288, double 0.000000e+00>)
  %i.bj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bi, <2 x double> %4, <2 x double> <double f0xBFA48228B5688F3B, double 0.000000e+00>)
  %5 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bi, <2 x double> %i.bj, <2 x double> <double f0x3FC9C1550E884455, double 0.000000e+00>)
  %6 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bi, <2 x double> %5, <2 x double> <double f0xBFD4D61203EB6F7D, double f0x3FB3B8C5B12E9282>)
  %7 = shufflevector <2 x double> %i.bi, <2 x double> poison, <2 x i32> zeroinitializer
  %8 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %7, <2 x double> %6, <2 x double> <double f0x3FC5555555555555, double f0xBFE6066C1B8D0159>) ; 2 uses
  %9 = extractelement <2 x double> %8, i64 0
  %i.bk = fmul double %i.bc, %9
  %10 = extractelement <2 x double> %8, i64 1
  %11 = tail call double @llvm.fmuladd.f64(double %i.bc, double %10, double f0x40002AE59C598AC8)
  %12 = tail call double @llvm.fmuladd.f64(double %i.bc, double %11, double f0xC0033A271C8A2D4B)
  %13 = tail call double @llvm.fmuladd.f64(double %i.bc, double %12, double 1.000000e+00)
  %14 = fdiv double %i.bk, %13
  %i.bl = tail call double @llvm.fmuladd.f64(double %14, double %i.bd, double %3)
