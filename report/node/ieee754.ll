...
bb.aa:                                            ; preds = %bb.aa, %._crit_edge.us.i.new
  ...
  %sext.1 = shl i64 %i.fa, 32
  %4 = ashr exact i64 %sext.1, 29
  %5 = getelementptr inbounds i8, ptr %i.b, i64 %4
...
.epil.preheader278:                               ; preds = %._crit_edge.us.1.i.unr-lcssa, %._crit_edge.us.i
  ...
  %sext.epil = shl i64 %i.ff, 32
  %6 = ashr exact i64 %sext.epil, 29
  %7 = getelementptr inbounds i8, ptr %i.b, i64 %6
