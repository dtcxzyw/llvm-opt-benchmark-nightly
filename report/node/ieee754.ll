...
._crit_edge.us.i:                                 ; preds = %._crit_edge.us.i.unr-lcssa, %.epil.preheader
  %.lcssa270 = phi double [ %i.eg, %._crit_edge.us.i.unr-lcssa ], [ %i.eo, %.epil.preheader ]
  store double %.lcssa270, ptr %i.d, align 16
  %xtraiter279 = and i64 %indvars.iv, 1
  %i.ep = icmp eq i64 %i.dp, 0
  br i1 %i.ep, label %.epil.preheader278, label %._crit_edge.us.i.new
...
bb.aa:                                            ; preds = %bb.aa, %._crit_edge.us.i.new
  ...
  %sext.1 = shl i64 %i.ez, 32
  %i.fa = ashr exact i64 %sext.1, 29
  %i.fb = getelementptr inbounds i8, ptr %i.b, i64 %i.fa
...
.epil.preheader278:                               ; preds = %._crit_edge.us.1.i.unr-lcssa, %._crit_edge.us.i
  ...
  %sext.epil = shl i64 %i.fg, 32
  %i.fh = ashr exact i64 %sext.epil, 29
  %i.fi = getelementptr inbounds i8, ptr %i.b, i64 %i.fh
...
._crit_edge.us.1.i:                               ; preds = %._crit_edge.us.1.i.unr-lcssa, %.epil.preheader278
  %.lcssa269 = phi double [ %i.fd, %._crit_edge.us.1.i.unr-lcssa ], [ %i.fk, %.epil.preheader278 ]
  %i.fl = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  store double %.lcssa269, ptr %i.fl, align 8
  %i.fm = add nuw i64 %indvars.iv, 1              ; 2 uses
  %xtraiter286 = and i64 %indvars.iv, 1
  %i.fn = icmp eq i64 %i.dp, 0
  br i1 %i.fn, label %.epil.preheader285, label %._crit_edge.us.1.i.new
...
bb.ab:                                            ; preds = %bb.ab, %._crit_edge.us.1.i.new
  ...
  %sext185 = shl i64 %i.fq, 32
  %i.fr = ashr exact i64 %sext185, 29
  ...
  %sext185.1 = shl i64 %i.fy, 32
  %i.fz = ashr exact i64 %sext185.1, 29
...
.epil.preheader285:                               ; preds = %._crit_edge.us.2.i.unr-lcssa, %._crit_edge.us.1.i
  ...
  %sext185.epil = shl i64 %i.gf, 32
  %i.gg = ashr exact i64 %sext185.epil, 29
...
._crit_edge.us.2.i:                               ; preds = %._crit_edge.us.2.i.unr-lcssa, %.epil.preheader285
  %.lcssa268 = phi double [ %i.gc, %._crit_edge.us.2.i.unr-lcssa ], [ %i.gj, %.epil.preheader285 ]
  %i.gk = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  store double %.lcssa268, ptr %i.gk, align 16
  %i.gl = add nuw i64 %indvars.iv, 2              ; 3 uses
  %xtraiter293 = and i64 %indvars.iv, 1
  %i.gm = icmp eq i64 %i.dp, 0
  br i1 %i.gm, label %.epil.preheader292, label %._crit_edge.us.2.i.new
...
bb.ac:                                            ; preds = %bb.ac, %._crit_edge.us.2.i.new
  ...
  %sext186 = shl i64 %i.gp, 32
  %i.gq = ashr exact i64 %sext186, 29
  ...
  %sext186.1 = shl i64 %i.gw, 32
  %i.gx = ashr exact i64 %sext186.1, 29
...
.epil.preheader292:                               ; preds = %._crit_edge.us.3.i.unr-lcssa, %._crit_edge.us.2.i
  ...
  %sext186.epil = shl i64 %i.hd, 32
  %i.he = ashr exact i64 %sext186.epil, 29
...
._crit_edge.us.3.i:                               ; preds = %._crit_edge.us.3.i.unr-lcssa, %.epil.preheader292
  %.lcssa267 = phi double [ %i.ha, %._crit_edge.us.3.i.unr-lcssa ], [ %i.hh, %.epil.preheader292 ]
  %i.hi = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  store double %.lcssa267, ptr %i.hi, align 8
  %xtraiter300 = and i64 %indvars.iv, 1
  %i.hj = icmp eq i64 %i.dp, 0
  br i1 %i.hj, label %.epil.preheader299, label %._crit_edge.us.3.i.new
...
._crit_edge.us.4.i:                               ; preds = %._crit_edge.us.4.i.unr-lcssa, %.epil.preheader299
  %.lcssa266 = phi double [ %i.ht, %._crit_edge.us.4.i.unr-lcssa ], [ %i.hy, %.epil.preheader299 ]
  %i.hz = getelementptr inbounds nuw i8, ptr %i.d, i64 32
  store double %.lcssa266, ptr %i.hz, align 16
  br label %.preheader15.i
...
.preheader15.i:                                   ; preds = %._crit_edge.us.4.i, %.preheader16.preheader.i
  ...
  %xtraiter319 = and i64 %wide.trip.count132.i.pre-phi, 3 ; 3 uses
  %i.ja = icmp ult i64 %i.iz, 3
  %unroll_iter323 = and i64 %wide.trip.count132.i.pre-phi, 4294967292
...
.lr.ph38.preheader.i.new:                         ; preds = %.lr.ph38.preheader.i
  %unroll_iter310 = and i64 %i.jb, 2147483646
  br label %.lr.ph38.i
...
.lr.ph38.i:                                       ; preds = %.lr.ph38.i, %.lr.ph38.preheader.i.new
  ...
  %niter311 = phi i64 [ 0, %.lr.ph38.preheader.i.new ], [ %niter311.next.1, %.lr.ph38.i ]
  ...
  br i1 %niter311.ncmp.1, label %._crit_edge.i.unr-lcssa, label %.lr.ph38.i, !llvm.loop !9

._crit_edge.i.unr-lcssa:                          ; preds = %.lr.ph38.i
  %lcmp.mod307.not = icmp eq i64 %xtraiter306, 0
  br i1 %lcmp.mod307.not, label %._crit_edge.i, label %.lr.ph38.i.epil.preheader
...
.lr.ph38.i.epil.preheader:                        ; preds = %._crit_edge.i.unr-lcssa, %.lr.ph38.preheader.i
  ...
  %lcmp.mod309 = trunc i32 %.0254.i to i1
...
._crit_edge.i:                                    ; preds = %._crit_edge.i.unr-lcssa, %.lr.ph38.i.epil.preheader
  %.lcssa251 = phi double [ %i.ka, %._crit_edge.i.unr-lcssa ], [ %i.kk, %.lr.ph38.i.epil.preheader ]
  %i.kl = tail call double @scalbn(double noundef %.lcssa251, i32 noundef %i.dg) #12 ; 2 uses
...
.thread.i:                                        ; preds = %bb.al, %bb.ak
  ...
  %xtraiter313 = and i64 %i.jb, 1
  %i.lg = icmp eq i64 %i.je, 0
  br i1 %i.lg, label %.epil.preheader312, label %.thread.i.new

.thread.i.new:                                    ; preds = %.thread.i
  %unroll_iter317 = and i64 %i.jb, 2147483646
  br label %bb.am
