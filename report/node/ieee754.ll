...
bb.h:                                             ; preds = %bb.g
  ...
  %1 = insertelement <2 x double> <double poison, double -0.000000e+00>, double %i.ai, i64 0 ; 5 uses
  %2 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> <double f0x3F023DE10DFDF709, double 0.000000e+00>, <2 x double> <double f0x3F49EFE07501B288, double 0.000000e+00>)
  %3 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> %2, <2 x double> <double f0xBFA48228B5688F3B, double 0.000000e+00>)
  %4 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> %3, <2 x double> <double f0x3FC9C1550E884455, double 0.000000e+00>)
  %5 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> %4, <2 x double> <double f0xBFD4D61203EB6F7D, double f0x3FB3B8C5B12E9282>)
  %i.aj = shufflevector <2 x double> %1, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ak = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.aj, <2 x double> %5, <2 x double> <double f0x3FC5555555555555, double f0xBFE6066C1B8D0159>) ; 2 uses
...
bb.i:                                             ; preds = %bb.g
  ...
  %i.ax = fmul double %i.aw, 5.000000e-01         ; 7 uses
  ...
  %6 = insertelement <2 x double> <double poison, double -0.000000e+00>, double %i.ax, i64 0 ; 5 uses
  %7 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> <double f0x3F023DE10DFDF709, double 0.000000e+00>, <2 x double> <double f0x3F49EFE07501B288, double 0.000000e+00>)
  %8 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %7, <2 x double> <double f0xBFA48228B5688F3B, double 0.000000e+00>)
  %9 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %8, <2 x double> <double f0x3FC9C1550E884455, double 0.000000e+00>)
  %10 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %9, <2 x double> <double f0xBFD4D61203EB6F7D, double f0x3FB3B8C5B12E9282>)
  %i.bg = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bh = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bg, <2 x double> %10, <2 x double> <double f0x3FC5555555555555, double f0xBFE6066C1B8D0159>) ; 2 uses
...
bb.n:                                             ; preds = %bb.g
  ...
  %i.bh = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %2, <2 x double> %1, <2 x double> <double f0x3FD999999997FA04, double f0x3FC7466496CB03DE>) ; 2 uses
  %i.bi = extractelement <2 x double> %i.bh, i64 0
...
bb.h:                                             ; preds = %bb.f, %bb.g
  %.049 = phi double [ 0.000000e+00, %bb.f ], [ %i.p, %bb.g ] ; 5 uses
  %1 = insertelement <2 x double> <double poison, double -0.000000e+00>, double %.049, i64 0 ; 5 uses
  %2 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> <double f0x3F023DE10DFDF709, double 0.000000e+00>, <2 x double> <double f0x3F49EFE07501B288, double 0.000000e+00>)
  %3 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> %2, <2 x double> <double f0xBFA48228B5688F3B, double 0.000000e+00>)
  %4 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> %3, <2 x double> <double f0x3FC9C1550E884455, double 0.000000e+00>)
  %5 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> %4, <2 x double> <double f0xBFD4D61203EB6F7D, double f0x3FB3B8C5B12E9282>)
  %i.q = shufflevector <2 x double> %1, <2 x double> poison, <2 x i32> zeroinitializer
  %i.r = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.q, <2 x double> %5, <2 x double> <double f0x3FC5555555555555, double f0xBFE6066C1B8D0159>) ; 2 uses
...
bb.i:                                             ; preds = %bb.d
  ...
  %i.ac = fmul double %i.ab, 5.000000e-01         ; 7 uses
  %6 = insertelement <2 x double> <double poison, double -0.000000e+00>, double %i.ac, i64 0 ; 5 uses
  %7 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> <double f0x3F023DE10DFDF709, double 0.000000e+00>, <2 x double> <double f0x3F49EFE07501B288, double 0.000000e+00>)
  %8 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %7, <2 x double> <double f0xBFA48228B5688F3B, double 0.000000e+00>)
  %9 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %8, <2 x double> <double f0x3FC9C1550E884455, double 0.000000e+00>)
  %10 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %9, <2 x double> <double f0xBFD4D61203EB6F7D, double f0x3FB3B8C5B12E9282>)
  %i.ad = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ae = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ad, <2 x double> %10, <2 x double> <double f0x3FC5555555555555, double f0xBFE6066C1B8D0159>) ; 2 uses
...
bb.k:                                             ; preds = %bb.i
  ...
  %i.au = fneg double %i.at
  %11 = fadd double %i.al, %i.at
  %i.av = tail call double @llvm.fmuladd.f64(double %i.au, double %i.at, double %i.ac)
  %12 = insertelement <2 x double> poison, double %i.av, i64 0
  %13 = insertelement <2 x double> %12, double %i.ag, i64 1
  %14 = insertelement <2 x double> poison, double %11, i64 0
  %15 = insertelement <2 x double> %14, double %i.ak, i64 1
  %16 = fdiv <2 x double> %13, %15                ; 2 uses
  %i.aw = fmul double %i.al, 2.000000e+00
  %17 = extractelement <2 x double> %16, i64 0
  %i.ax = tail call double @llvm.fmuladd.f64(double %17, double -2.000000e+00, double f0x3C91A62633145C07)
  %i.ay = fneg double %i.ax
  %18 = extractelement <2 x double> %16, i64 1
  %i.az = tail call double @llvm.fmuladd.f64(double %i.aw, double %18, double %i.ay)
...
bb.q:                                             ; preds = %bb.i, %bb.m, %bb.l, %bb.p, %bb.o
  ...
  %i.ah = fmul double %i.ag, %i.ag                ; 5 uses
  %1 = insertelement <2 x double> <double poison, double -0.000000e+00>, double %i.ah, i64 0 ; 5 uses
  %2 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> <double f0x3F90AD3AE322DA11, double 0.000000e+00>, <2 x double> <double f0x3FA97B4B24760DEB, double 0.000000e+00>)
  %3 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> %2, <2 x double> <double f0x3FB10D66A0D03D51, double 0.000000e+00>)
  %4 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> %3, <2 x double> <double f0x3FB745CDC54C206E, double 0.000000e+00>)
  %5 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> %4, <2 x double> <double f0x3FC24924920083FF, double f0xBFA2B4442C6A6C2F>)
  %i.ai = shufflevector <2 x double> %1, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ai, <2 x double> %5, <2 x double> <double f0x3FD555555555550D, double f0xBFADDE2D52DEFD9A>) ; 2 uses
...
bb.f:                                             ; preds = %bb.c, %bb.e
  ...
  %i.y = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %2, <2 x double> %1, <2 x double> <double f0x3FFE03E60F61E692, double f0xBFE844CBBEE751D9>) ; 2 uses
...
.thread.i:                                        ; preds = %bb.e, %bb.d, %bb.c
  ...
  %5 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> %4, <2 x double> <double f0x3F9664F48406D637, double f0x3EFB2A7074BF7AD4>)
  %i.q = shufflevector <2 x double> %1, <2 x double> poison, <2 x i32> zeroinitializer
  %i.r = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.q, <2 x double> %5, <2 x double> <double f0x3FC111111110FE7A, double f0x3F12B80F32F0A7E9>) ; 2 uses
...
.thread.i7:                                       ; preds = %bb.p, %bb.o, %bb.j
  ...
  %i.cj = fmul double %i.ci, %i.ci                ; 5 uses
  %6 = insertelement <2 x double> <double poison, double -0.000000e+00>, double %i.cj, i64 0 ; 5 uses
  %7 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> <double f0xBEF375CBDB605373, double 0.000000e+00>, <2 x double> <double f0x3F147E88A03792A6, double 0.000000e+00>)
  %8 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %7, <2 x double> <double f0x3F4344D8F2F26501, double 0.000000e+00>)
  %9 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %8, <2 x double> <double f0x3F6D6D22C9560328, double 0.000000e+00>)
  %10 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> %9, <2 x double> <double f0x3F9664F48406D637, double f0x3EFB2A7074BF7AD4>)
  %i.ck = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cl = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ck, <2 x double> %10, <2 x double> <double f0x3FC111111110FE7A, double f0x3F12B80F32F0A7E9>) ; 2 uses
