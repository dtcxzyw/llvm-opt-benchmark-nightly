...
10:                                               ; preds = %bb.b, %bb.b
  ...
  %12 = load i32, ptr %11, align 4, !tbaa !37     ; 6 uses
  %13 = icmp eq i32 %0, 7
  br i1 %13, label %.thread192, label %bb.be

.thread192:                                       ; preds = %bb.b, %10
  %.0158195 = phi i32 [ %12, %10 ], [ 1, %bb.b ]  ; 3 uses
...
bb.bn:                                            ; preds = %bb.bm
  ...
  %i.gy = tail call i32 @OSSL_PARAM_set_int(ptr noundef %i.gx, i32 noundef %12) #8
  br label %.thread200
...
bb.bq:                                            ; preds = %bb.bo
  %i.he = tail call i32 @OSSL_PARAM_set_uint(ptr noundef %i.hc, i32 noundef %12) #8
  br label %.thread200
...
.thread200:                                       ; preds = %.thread192, %bb.bf, %bb.be, %bb.at, %.thread, %bb.b, %bb.aa, %bb.ac, %bb.ag, %bb.af, %bb.ae, %bb.ad, %bb.u, %bb.t, %bb.aj, %bb.ah, %bb.bv, %bb.bw, %bb.ai, %bb.bk, %bb.bn, %bb.bp, %bb.bq, %bb.br, %bb.bs, %bb.bt, %bb.bu, %bb.ay, %bb.ax, %bb.x, %bb.a, %bb.bd, %bb.bc, %bb.bb, %bb.ba, %bb.az, %bb.av, %bb.ab, %bb.z, %bb.s, %bb.e, %bb.c
  %.2 = phi i32 [ 0, %bb.ay ], [ 0, %bb.c ], [ 0, %bb.e ], [ -2, %bb.s ], [ 0, %bb.bk ], [ %i.b, %bb.a ], [ 0, %bb.z ], [ 0, %bb.ab ], [ %12, %bb.bf ], [ 0, %bb.bd ], [ %i.fc, %bb.av ], [ 1, %bb.az ], [ 0, %bb.x ], [ 0, %bb.ax ], [ %i.fq, %bb.ba ], [ %i.fx, %bb.bb ], [ %i.gd, %bb.bc ], [ 0, %bb.bu ], [ %i.gy, %bb.bn ], [ %i.hd, %bb.bp ], [ %i.he, %bb.bq ], [ %i.hj, %bb.br ], [ %i.ho, %bb.bs ], [ %i.hu, %bb.bt ], [ 1, %bb.t ], [ 1, %bb.u ], [ 1, %bb.aa ], [ 1, %bb.ac ], [ 1, %bb.ad ], [ 1, %bb.ae ], [ 1, %bb.af ], [ 1, %bb.ag ], [ 1, %bb.ai ], [ 1, %bb.aj ], [ 1, %bb.ah ], [ 1, %bb.b ], [ %.0158195, %bb.bw ], [ %.0158195, %bb.bv ], [ %.0158195, %.thread192 ], [ 1, %bb.at ], [ %.0157.ph, %.thread ], [ %12, %bb.be ]
  ret i32 %.2
}
