...
bb.v:                                             ; preds = %_ZNK2v88internal4Name4hashEv.exit51.i, %.lr.ph.i
  ...
  %sext.i.i48.i = add nuw nsw i64 %i.de, 137438953472 ; 2 uses
  %i.df = lshr exact i64 %sext.i.i48.i, 32
...
_ZN2v88internal15DescriptorArray6SearchENS0_6TaggedINS0_4NameEEEib.exit.i: ; preds = %.lr.ph166.i, %bb.f, %bb.h, %bb.j, %bb.l, %bb.n, %bb.p, %bb.r, %._ZN2v88internal15DescriptorArray6SearchENS0_6TaggedINS0_4NameEEEib.exit_crit_edge.i
  %.pre-phi178.i = phi i64 [ %sext.i.i48.i, %._ZN2v88internal15DescriptorArray6SearchENS0_6TaggedINS0_4NameEEEib.exit_crit_edge.i ], [ 137438953472, %.lr.ph166.i ], [ 240518168576, %bb.f ], [ 343597383680, %bb.h ], [ 446676598784, %bb.j ], [ 549755813888, %bb.l ], [ 652835028992, %bb.n ], [ 755914244096, %bb.p ], [ 858993459200, %bb.r ]
  ...
  %13 = lshr exact i64 %.pre-phi178.i, 32
  %i.dz = add i64 %13, %i.dy                      ; 2 uses
  %i.ea = add i64 %i.dz, 7
