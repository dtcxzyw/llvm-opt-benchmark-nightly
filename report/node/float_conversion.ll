...
_ZN4absl19str_format_internal14FormatSinkImpl6AppendEmc.exit: ; preds = %bb.d, %bb.c, %bb.e, %._crit_edge.i
  ...
  %.0235 = phi i64 [ 0, %._crit_edge.i ], [ 0, %bb.e ], [ %.1, %bb.c ], [ 0, %bb.d ] ; 5 uses
  %.not = icmp eq i8 %0, 0
...
.lr.ph.i49:                                       ; preds = %bb.q
  ...
  %i.de = sub nuw nsw i64 %.0235, %i.cz           ; 3 uses
...
._crit_edge.i46:                                  ; preds = %.peel.next.i53, %bb.s, %bb.q
  %.0.lcssa.i47 = phi i64 [ %.0235, %bb.q ], [ %i.de, %bb.s ], [ %i.dl, %.peel.next.i53 ] ; 2 uses
