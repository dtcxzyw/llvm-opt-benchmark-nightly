...
bb.b:                                             ; preds = %bb.a, %bb.b
  ...
  %i.q = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %.neg.i.i.i.i) #1, !srcloc !11
  %i.r = and i32 %i.q, %i.m
  %i.s = xor i32 %.neg.i.i.i.i, -1
  %i.t = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %i.s) #1, !srcloc !11
  %i.u = and i32 %i.n, %i.t
  %i.v = or i32 %i.u, %i.r
...
bb.b:                                             ; preds = %bb.a, %._crit_edge39
  ...
  %.03240 = phi i32 [ 1, %bb.a ], [ %i.ay, %._crit_edge39 ] ; 3 uses
...
.lr.ph:                                           ; preds = %1
  ...
  %i.g = load i32, ptr %gep48, align 4, !tbaa !10
  %i.h = zext i32 %i.g to i64
  br label %bb.c

bb.c:                                             ; preds = %.lr.ph, %bb.c
  %indvars.iv42 = phi i64 [ %indvars.iv, %.lr.ph ], [ %indvars.iv.next43, %bb.c ] ; 3 uses
  ...
  %i.k = load i32, ptr %gep, align 4, !tbaa !10
  ...
  %i.w = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %.neg.i.i.i.i) #1, !srcloc !11
  %i.x = and i32 %i.w, %i.s
  %i.y = xor i32 %.neg.i.i.i.i, -1
  %i.z = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %i.y) #1, !srcloc !11
  ...
  %i.ag = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %.neg.i.i.i) #1, !srcloc !11
  %i.ah = and i32 %i.ac, %i.ag
  %i.ai = xor i32 %.neg.i.i.i, -1
  %i.aj = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %i.ai) #1, !srcloc !11
  ...
  %i.ar = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %.neg.i.i.i.i33) #1, !srcloc !11
  %i.as = and i32 %i.an, %i.ar
  %i.at = xor i32 %.neg.i.i.i.i33, -1
  %i.au = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %i.at) #1, !srcloc !11
  ...
  %i.ax = icmp samesign ult i64 %indvars.iv.next43, %2
  br i1 %i.ax, label %bb.c, label %._crit_edge, !llvm.loop !14

._crit_edge:                                      ; preds = %bb.c, %1
  ...
  br i1 %exitcond.not, label %._crit_edge39, label %1, !llvm.loop !15

._crit_edge39:                                    ; preds = %._crit_edge, %bb.b
  %i.ay = shl i32 %.03240, 1                      ; 2 uses
  %i.az = icmp slt i32 %i.ay, 256
  br i1 %i.az, label %bb.b, label %bb.d, !llvm.loop !16
...
bb.c:                                             ; preds = %.lr.ph, %bb.c
  ...
  %i.n = load i32, ptr %gep, align 4, !tbaa !10   ; 2 uses
  %i.o = add i32 %i.n, %i.m                       ; 3 uses
  %i.p = add i32 %i.o, -8380417                   ; 2 uses
  %i.q = xor i32 %i.o, -1
  %i.r = and i32 %i.p, %i.q
  %.neg.i.i.i = ashr i32 %i.r, 31                 ; 2 uses
  %i.s = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %.neg.i.i.i) #1, !srcloc !11
  %i.t = and i32 %i.s, %i.o
  %i.u = xor i32 %.neg.i.i.i, -1
  %i.v = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %i.u) #1, !srcloc !11
  %i.w = and i32 %i.v, %i.p
  %i.x = or i32 %i.w, %i.t
  store i32 %i.x, ptr %i.l, align 4, !tbaa !10
  ...
  %i.al = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %.neg.i.i.i.i) #1, !srcloc !11
  %i.am = and i32 %i.al, %i.ah
  %i.an = xor i32 %.neg.i.i.i.i, -1
  %i.ao = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %i.an) #1, !srcloc !11
  %i.ap = and i32 %i.ai, %i.ao
  %i.aq = or i32 %i.ap, %i.am
  store i32 %i.aq, ptr %gep, align 4, !tbaa !10
...
._crit_edge:                                      ; preds = %bb.c
  ...
  br i1 %exitcond63.not, label %._crit_edge48, label %.lr.ph, !llvm.loop !18
...
._crit_edge48:                                    ; preds = %._crit_edge, %.._crit_edge48_crit_edge
  ...
  br i1 %i.ar, label %bb.b, label %.preheader, !llvm.loop !19

.preheader:                                       ; preds = %._crit_edge48, %.preheader
  %indvars.iv64 = phi i64 [ %indvars.iv.next65, %.preheader ], [ 0, %._crit_edge48 ] ; 2 uses
  %i.as = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv64 ; 2 uses
  ...
  %i.bf = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %.neg.i.i.i.i42) #1, !srcloc !11
  %i.bg = and i32 %i.bf, %i.bb
  %i.bh = xor i32 %.neg.i.i.i.i42, -1
  %i.bi = tail call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 range(i32 -1, 1) %i.bh) #1, !srcloc !11
  %i.bj = and i32 %i.bc, %i.bi
  %i.bk = or i32 %i.bj, %i.bg
  store i32 %i.bk, ptr %i.as, align 4, !tbaa !10
  %indvars.iv.next65 = add nuw nsw i64 %indvars.iv64, 1 ; 2 uses
  %exitcond67.not = icmp eq i64 %indvars.iv.next65, 256
  br i1 %exitcond67.not, label %bb.d, label %.preheader, !llvm.loop !20
