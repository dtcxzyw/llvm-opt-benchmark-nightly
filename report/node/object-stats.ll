...
.lr.ph:                                           ; preds = %bb.a
  %i.k = add i64 %1, -1
  %i.l = add i64 %1, 15
  %.pre69 = load ptr, ptr @_ZN2v88internal12IsolateGroup22default_isolate_group_E, align 8
  br label %bb.b

bb.b:                                             ; preds = %.lr.ph, %bb.e
  %2 = phi ptr [ %.pre69, %.lr.ph ], [ %3, %bb.e ] ; 2 uses
...
bb.ac:                                            ; preds = %_ZN2v88internal24ObjectStatsCollectorImpl12SameLivenessENS0_6TaggedINS0_10HeapObjectEEES4_.exit.thread
  ...
  %i.hf = ptrtoint ptr %.pre.i.i to i64
...
bb.ae:                                            ; preds = %_ZN2v88internal24ObjectStatsCollectorImpl12SameLivenessENS0_6TaggedINS0_10HeapObjectEEES4_.exit.thread
  %i.hp = ptrtoint ptr %.pre.i.i to i64
...
attributes #10 = { mustprogress nofree norecurse nounwind willreturn memory(readwrite, target_mem: none) uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
