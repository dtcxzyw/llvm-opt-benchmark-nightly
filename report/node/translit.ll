...
begin_hunk_0_@_ZN6icu_7814Transliterator18initializeRegistryER10UErrorCode:bb.a
  ...
  %i.aq = icmp slt i16 %22, 0
  %23 = ashr i16 %22, 5
  %24 = sext i16 %23 to i32
  %25 = load i32, ptr %i.z, align 4
  %26 = select i1 %i.aq, i32 %25, i32 %24
  %27 = and i16 %i.ak, 1
...
.sink.split.i.i.i:                                ; preds = %bb.l
  %spec.select.i.i = call i32 @llvm.smin.i32(i32 %i.ap, i32 0) ; 2 uses
  %28 = icmp slt i32 %i.ap, 0
  br i1 %28, label %_ZNK6icu_7813UnicodeString7indexOfERKS0_.exit.thread, label %_ZNK6icu_7813UnicodeString10pinIndicesERiS1_.exit.i.i

_ZNK6icu_7813UnicodeString10pinIndicesERiS1_.exit.i.i: ; preds = %.sink.split.i.i.i
  %29 = sub nuw nsw i32 %i.ap, %spec.select.i.i
  %30 = call i32 @llvm.umin.i32(i32 %i.ap, i32 %29) ; 2 uses
...
_ZNK6icu_7813UnicodeString7indexOfERKS0_.exit:    ; preds = %_ZNK6icu_7813UnicodeString10pinIndicesERiS1_.exit.i.i
  ...
  %i.au = call noundef i32 @_ZNK6icu_7813UnicodeString7indexOfEPKDsiiii(ptr noundef nonnull align 8 dereferenceable(64) %4, ptr noundef %i.at, i32 noundef %spec.select.i.i, i32 noundef %30, i32 noundef 0, i32 noundef %26) #15
  %.not93 = icmp eq i32 %i.au, -1
  br i1 %.not93, label %_ZNK6icu_7813UnicodeString7indexOfERKS0_.exit.thread, label %bb.t

_ZNK6icu_7813UnicodeString7indexOfERKS0_.exit.thread: ; preds = %.sink.split.i.i.i, %bb.l, %_ZNK6icu_7813UnicodeString10pinIndicesERiS1_.exit.i.i, %_ZNK6icu_7813UnicodeString7indexOfERKS0_.exit
...
end_hunk_0
begin_hunk_1_@_ZN6icu_7813UnicodeString8doAppendESt17basic_string_viewIDsSt11char_traitsIDsEE
