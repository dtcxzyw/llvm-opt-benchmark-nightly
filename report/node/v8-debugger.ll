...
define hidden void @_ZN12v8_inspector10V8Debugger13stackTraceForEiRKNS_14V8StackTraceIdE(ptr dead_on_unwind noalias writable writeonly sret(%"class.std::shared_ptr") align 8 captures(none) %0, ptr noundef nonnull align 8 dereferenceable(817) %1, i32 noundef %2, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(25) %3) local_unnamed_addr #0 align 2 {
bb.a:
...
begin_hunk_3_@_ZN12v8_inspector10V8Debugger13stackTraceForEiRKNS_14V8StackTraceIdE:bb.a
  ...
  br i1 %i.by, label %_ZNKSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE16_M_get_use_countEv.exit.i.i.i, label %bb.s, !llvm.loop !68
...
_ZNKSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE16_M_get_use_countEv.exit.i.i.i: ; preds = %bb.t
  %i.ca = load atomic i32, ptr %i.bu monotonic, align 8, !noalias !229
