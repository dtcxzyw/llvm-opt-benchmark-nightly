...
begin_hunk_0_@HUF_decompress1X2_usingDTable_internal:bb.a
  ...
  %i.dt = load i8, ptr %i.ds, align 2, !tbaa !28
  ...
  %i.eh = load i8, ptr %i.eg, align 2, !tbaa !28
  ...
  %i.ev = load i8, ptr %i.eu, align 2, !tbaa !28
  ...
  br i1 %i.fc, label %BIT_reloadDStream.exit29.i, label %bb.p, !prof !30, !llvm.loop !0
...
BIT_reloadDStream.exit15.i:                       ; preds = %bb.x, %bb.v
  ...
  %.sroa.0.6.i = load i64, ptr %.sroa.9790.6.i, align 1, !tbaa !25 ; 7 uses
...
bb.y:                                             ; preds = %BIT_reloadDStream.exit15.i
  ...
  %i.fw = load i8, ptr %i.fv, align 2, !tbaa !28
  ...
  %i.gy = load i8, ptr %i.gx, align 2, !tbaa !28
  ...
  %i.hm = load i8, ptr %i.hl, align 2, !tbaa !28
  ...
  br i1 %i.ht, label %BIT_reloadDStream.exit29.i, label %bb.u, !prof !30, !llvm.loop !1
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.hy = and i32 %i.ay, 7
  %.val.i61.i = load i64, ptr %i.hx, align 1, !tbaa !25
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %.val30.i = load i64, ptr %i.ie, align 1, !tbaa !25
  br label %BIT_reloadDStream.exit29.i
...
BIT_reloadDStream.exit29.i:                       ; preds = %bb.y, %bb.w, %bb.t, %bb.r, %BIT_reloadDStream.exit29.i.loopexit73.split.loop.exit, %BIT_reloadDStream.exit29.i.loopexit.split.loop.exit, %bb.ac, %bb.ab, %bb.aa, %.thread.i
  ...
  %.sroa.0.0.i = phi i64 [ %.val.i.i, %bb.ab ], [ %.val.i61.i, %bb.aa ], [ %.sroa.0.5.i, %BIT_reloadDStream.exit29.i.loopexit.split.loop.exit ], [ %.val30.i, %bb.ac ], [ %.sroa.0.9.i, %.thread.i ], [ %.sroa.0.5.i, %bb.t ], [ %.sroa.0.6.i, %BIT_reloadDStream.exit29.i.loopexit73.split.loop.exit ], [ %.sroa.0.4236.i, %bb.r ], [ %.sroa.0.6.i, %bb.y ], [ %.sroa.0.3219.i, %bb.w ] ; 3 uses
...
.preheader202.i:                                  ; preds = %BIT_reloadDStream.exit29.i
  ...
  br i1 %i.is, label %.preheader.i, label %.lr.ph, !prof !31
...
BIT_reloadDStream.exit22.i:                       ; preds = %bb.ae, %bb.ad
  ...
  %.sroa.0.7.i = load i64, ptr %.sroa.9790.7.i, align 1, !tbaa !25 ; 4 uses
  %i.iy = icmp ule ptr %.5.i.i40, %i.in
  %i.iz = and i1 %i.iy, %.022.i17.i
  br i1 %i.iz, label %bb.af, label %.preheader.i

.preheader.i:                                     ; preds = %bb.af, %7, %BIT_reloadDStream.exit22.i, %.preheader202.i
  %.5.i.i.lcssa = phi ptr [ %.4.i.i, %.preheader202.i ], [ %.5.i.i40, %BIT_reloadDStream.exit22.i ], [ %.5.i.i40, %7 ], [ %i.jn, %bb.af ] ; 3 uses
  %.sroa.9790.7330.i = phi ptr [ @BIT_reloadDStream.zeroFilled, %.preheader202.i ], [ %.sroa.9790.7.i, %BIT_reloadDStream.exit22.i ], [ %2, %7 ], [ @BIT_reloadDStream.zeroFilled, %bb.af ] ; 2 uses
  %.sroa.31.9329.i = phi i32 [ %.sroa.31.0.i, %.preheader202.i ], [ %.sroa.31.9.i, %BIT_reloadDStream.exit22.i ], [ %.sroa.31.2.i38, %7 ], [ %i.jj, %bb.af ] ; 2 uses
  %.sroa.0.7328.i = phi i64 [ %.sroa.0.0.i, %.preheader202.i ], [ %.sroa.0.7.i, %BIT_reloadDStream.exit22.i ], [ %.sroa.0.2.i37, %7 ], [ %.sroa.0.7.i, %bb.af ] ; 3 uses
...
bb.af:                                            ; preds = %BIT_reloadDStream.exit22.i
  ...
  %i.jh = load i8, ptr %i.jg, align 2, !tbaa !28
  ...
  br i1 %i.jo, label %.preheader.i, label %.lr.ph, !prof !30, !llvm.loop !2
...
.lr.ph248.i:                                      ; preds = %.preheader.i, %.lr.ph248.i
  ...
  %i.jw = load i8, ptr %i.jv, align 2, !tbaa !28
...
.loopexit.i:                                      ; preds = %.lr.ph248.i, %.preheader.i, %BIT_reloadDStream.exit29.i
  %.sroa.0.1.i = phi i64 [ %.sroa.0.0.i, %BIT_reloadDStream.exit29.i ], [ %.sroa.0.7328.i, %.preheader.i ], [ %.sroa.0.7328.i, %.lr.ph248.i ]
  %.sroa.31.1.i = phi i32 [ %.sroa.31.0.i, %BIT_reloadDStream.exit29.i ], [ %.sroa.31.9329.i, %.preheader.i ], [ %i.jy, %.lr.ph248.i ] ; 6 uses
  %.sroa.9790.1.i = phi ptr [ %.sroa.9790.0.i, %BIT_reloadDStream.exit29.i ], [ %.sroa.9790.7330.i, %.preheader.i ], [ %.sroa.9790.7330.i, %.lr.ph248.i ]
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.kr = load i8, ptr %i.kq, align 2, !tbaa !28
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.kw = load i8, ptr %i.kv, align 2, !tbaa !28
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  %i.h = load i32, ptr %i.g, align 16, !tbaa !33
...
bb.f:                                             ; preds = %bb.e
  %i.e = load i8, ptr %3, align 1, !tbaa !19
...
HUF_selectDecoder.exit:                           ; preds = %bb.e
  ...
  %i.l = load i32, ptr %i.k, align 16, !tbaa !33
...
begin_hunk_1_@HUF_decompress1X2_usingDTable_internal_bmi2:bb.a
  ...
  %i.dz = load i8, ptr %i.dy, align 2, !tbaa !28
  ...
  %i.en = load i8, ptr %i.em, align 2, !tbaa !28
  ...
  %i.fb = load i8, ptr %i.fa, align 2, !tbaa !28
  ...
  br i1 %i.fi, label %BIT_reloadDStream.exit29, label %bb.n, !prof !30, !llvm.loop !0
...
BIT_reloadDStream.exit15:                         ; preds = %bb.t, %bb.v
  ...
  %.sroa.0.6 = load i64, ptr %.sroa.9790.6, align 1, !tbaa !25 ; 7 uses
...
bb.w:                                             ; preds = %BIT_reloadDStream.exit15
  ...
  %i.gc = load i8, ptr %i.gb, align 2, !tbaa !28
  ...
  %i.gq = load i8, ptr %i.gp, align 2, !tbaa !28
  ...
  %i.he = load i8, ptr %i.hd, align 2, !tbaa !28
  ...
  %i.hs = load i8, ptr %i.hr, align 2, !tbaa !28
  ...
  br i1 %i.hz, label %BIT_reloadDStream.exit29, label %bb.s, !prof !30, !llvm.loop !1
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.ie = and i32 %i.aw, 7
  %.val.i61 = load i64, ptr %i.id, align 1, !tbaa !25
...
bb.aa:                                            ; preds = %bb.z
  ...
  %.val30 = load i64, ptr %i.ik, align 1, !tbaa !25
  br label %BIT_reloadDStream.exit29
...
BIT_reloadDStream.exit29:                         ; preds = %bb.u, %bb.w, %bb.p, %bb.r, %BIT_reloadDStream.exit29.loopexit331.split.loop.exit, %BIT_reloadDStream.exit29.loopexit.split.loop.exit, %.thread, %bb.z, %bb.aa, %bb.y
  ...
  %.sroa.0.0 = phi i64 [ %.val.i, %bb.z ], [ %.val.i61, %bb.y ], [ %.sroa.0.5, %BIT_reloadDStream.exit29.loopexit.split.loop.exit ], [ %.val30, %bb.aa ], [ %.sroa.0.9, %.thread ], [ %.sroa.0.4236, %bb.p ], [ %.sroa.0.6, %BIT_reloadDStream.exit29.loopexit331.split.loop.exit ], [ %.sroa.0.5, %bb.r ], [ %.sroa.0.3219, %bb.u ], [ %.sroa.0.6, %bb.w ] ; 3 uses
...
.preheader202:                                    ; preds = %BIT_reloadDStream.exit29
  ...
  br i1 %i.iy, label %.preheader, label %.lr.ph371, !prof !31
...
BIT_reloadDStream.exit22:                         ; preds = %bb.ab, %bb.ac
  ...
  %.sroa.0.7 = load i64, ptr %.sroa.9790.7, align 1, !tbaa !25 ; 4 uses
  %i.je = icmp ule ptr %.5.i370, %i.it
  %i.jf = and i1 %i.je, %.022.i17
  br i1 %i.jf, label %bb.ad, label %.preheader

.preheader:                                       ; preds = %BIT_reloadDStream.exit22, %bb.ad, %6, %.preheader202
  %.5.i.lcssa = phi ptr [ %.4.i, %.preheader202 ], [ %.5.i370, %BIT_reloadDStream.exit22 ], [ %i.jt, %bb.ad ], [ %.5.i370, %6 ] ; 3 uses
  %.sroa.9790.7330 = phi ptr [ @BIT_reloadDStream.zeroFilled, %.preheader202 ], [ %.sroa.9790.7, %BIT_reloadDStream.exit22 ], [ @BIT_reloadDStream.zeroFilled, %bb.ad ], [ %.sroa.9790.2369, %6 ] ; 2 uses
  %.sroa.31.9329 = phi i32 [ %.sroa.31.0, %.preheader202 ], [ %.sroa.31.9, %BIT_reloadDStream.exit22 ], [ %i.jp, %bb.ad ], [ %.sroa.31.2368, %6 ] ; 2 uses
  %.sroa.0.7328 = phi i64 [ %.sroa.0.0, %.preheader202 ], [ %.sroa.0.7, %BIT_reloadDStream.exit22 ], [ %.sroa.0.7, %bb.ad ], [ %.sroa.0.2367, %6 ] ; 3 uses
...
bb.ad:                                            ; preds = %BIT_reloadDStream.exit22
  ...
  %i.jn = load i8, ptr %i.jm, align 2, !tbaa !28
  ...
  br i1 %i.ju, label %.preheader, label %.lr.ph371, !prof !30, !llvm.loop !2
...
.lr.ph248:                                        ; preds = %.preheader, %.lr.ph248
  ...
  %i.kc = load i8, ptr %i.kb, align 2, !tbaa !28
...
.loopexit:                                        ; preds = %.lr.ph248, %.preheader, %BIT_reloadDStream.exit29
  %.sroa.0.1 = phi i64 [ %.sroa.0.0, %BIT_reloadDStream.exit29 ], [ %.sroa.0.7328, %.preheader ], [ %.sroa.0.7328, %.lr.ph248 ]
  %.sroa.31.1 = phi i32 [ %.sroa.31.0, %BIT_reloadDStream.exit29 ], [ %.sroa.31.9329, %.preheader ], [ %i.ke, %.lr.ph248 ] ; 6 uses
  %.sroa.9790.1 = phi ptr [ %.sroa.9790.0, %BIT_reloadDStream.exit29 ], [ %.sroa.9790.7330, %.preheader ], [ %.sroa.9790.7330, %.lr.ph248 ]
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.kx = load i8, ptr %i.kw, align 2, !tbaa !28
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.lc = load i8, ptr %i.lb, align 2, !tbaa !28
...
bb.d:                                             ; preds = %bb.c
  ...
  %.val = load i64, ptr %i.g, align 1, !tbaa !25
...
bb.e:                                             ; preds = %bb.d
  ...
  store i32 0, ptr %i.p, align 8, !tbaa !43
  br label %bb.p

bb.f:                                             ; preds = %bb.c
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %1, ptr %i.q, align 8, !tbaa !44
  %i.r = load i8, ptr %1, align 1, !tbaa !19
  %i.s = zext i8 %i.r to i64                      ; 7 uses
  store i64 %i.s, ptr %0, align 8, !tbaa !46
...
bb.g:                                             ; preds = %bb.f
  ...
  store i64 %i.x, ptr %0, align 8, !tbaa !46
  br label %bb.h
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  store i64 %i.ad, ptr %0, align 8, !tbaa !46
  br label %bb.i
...
bb.i:                                             ; preds = %bb.h, %bb.f
  ...
  store i64 %i.aj, ptr %0, align 8, !tbaa !46
  br label %bb.j
...
bb.j:                                             ; preds = %bb.i, %bb.f
  ...
  store i64 %i.ap, ptr %0, align 8, !tbaa !46
  br label %bb.k
...
bb.k:                                             ; preds = %bb.j, %bb.f
  ...
  store i64 %i.av, ptr %0, align 8, !tbaa !46
  br label %bb.l
...
bb.l:                                             ; preds = %bb.k, %bb.f
  ...
  store i64 %i.bb, ptr %0, align 8, !tbaa !46
  br label %bb.m
...
bb.n:                                             ; preds = %bb.m
  ...
  store i32 0, ptr %i.bf, align 8, !tbaa !43
  br label %bb.p
...
bb.o:                                             ; preds = %bb.m
  ...
  store i32 %i.bm, ptr %i.bi, align 8, !tbaa !43
  br label %bb.p
...
begin_hunk_2_@HUF_decompress4X2_usingDTable_internal_bmi2:bb.a
  ...
  store ptr %i.bfw, ptr %i.beu, align 8, !tbaa !44
...
BIT_reloadDStream.exit326.i:                      ; preds = %bb.eg, %bb.ee
  ...
  store i32 %storemerge1131, ptr %i.bes, align 8, !tbaa !43
  %.val19.sink = load i64, ptr %.val19.sink.in, align 1, !tbaa !25
  store i64 %.val19.sink, ptr %5, align 8, !tbaa !46
...
bb.eh:                                            ; preds = %BIT_reloadDStream.exit326.i
  %.val142 = load i64, ptr %5, align 8, !tbaa !46
  ...
  %i.bgi = load i8, ptr %i.bgh, align 2, !tbaa !28
  %i.bgj = zext i8 %i.bgi to i32
  %i.bgk = load i32, ptr %i.bes, align 8, !tbaa !43
  %i.bgl = add i32 %i.bgk, %i.bgj                 ; 4 uses
  store i32 %i.bgl, ptr %i.bes, align 8, !tbaa !43
  ...
  br i1 %i.bgq, label %._crit_edge1128, label %.lr.ph1127, !prof !30, !llvm.loop !2
...
.lr.ph844:                                        ; preds = %.preheader, %.lr.ph844
  ...
  %.val144 = load i64, ptr %5, align 8, !tbaa !46
  ...
  %i.bgy = load i8, ptr %i.bgx, align 2, !tbaa !28
  %i.bgz = zext i8 %i.bgy to i32
  %i.bha = load i32, ptr %i.bes, align 8, !tbaa !43
  %i.bhb = add i32 %i.bha, %i.bgz                 ; 3 uses
  store i32 %i.bhb, ptr %i.bes, align 8, !tbaa !43
...
bb.ei:                                            ; preds = %.loopexit
  %.val146 = load i64, ptr %5, align 8, !tbaa !46
  ...
  %i.bhs = load i8, ptr %i.bhr, align 1, !tbaa !29
  %i.bht = icmp eq i8 %i.bhs, 1
  br i1 %i.bht, label %bb.ej, label %bb.ek

bb.ej:                                            ; preds = %bb.ei
  %i.bhu = getelementptr inbounds nuw i8, ptr %i.bhp, i64 2
  %i.bhv = load i8, ptr %i.bhu, align 2, !tbaa !28
  %i.bhw = zext i8 %i.bhv to i32
  %i.bhx = load i32, ptr %i.bhh, align 8, !tbaa !43
  %i.bhy = add i32 %i.bhx, %i.bhw
  br label %HUF_decodeStreamX2.exit.i

bb.ek:                                            ; preds = %bb.ei
  %i.bhz = load i32, ptr %i.bhh, align 8, !tbaa !43 ; 3 uses
...
bb.el:                                            ; preds = %bb.ek
  ...
  %i.bic = load i8, ptr %i.bib, align 2, !tbaa !28
...
HUF_decodeStreamX2.exit.i:                        ; preds = %bb.ej, %bb.ek, %bb.el, %.loopexit
  ...
  %i.bin = load ptr, ptr %i.bim, align 8, !tbaa !44
  %i.bio = getelementptr inbounds nuw i8, ptr %5, i64 24
  %i.bip = load ptr, ptr %i.bio, align 8, !tbaa !47
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define internal fastcc i64 @HUF_decompress4X2_usingDTable_internal_fast(ptr noundef %0, i64 noundef %1, ptr noundef %2, i64 noundef %3, ptr noundef %4) unnamed_addr #11 {
bb.a:
  %5 = alloca %struct.HUF_DecompressFastArgs, align 8 ; 9 uses
  ...
  %i.c = call fastcc i64 @HUF_DecompressFastArgs_init(ptr noundef %5, ptr noundef %0, i64 noundef %1, ptr noundef %2, i64 noundef %3, ptr noundef %4) ; 2 uses
  %i.d = icmp eq i64 %i.c, 1
  br i1 %i.d, label %bb.b, label %.thread

bb.b:                                             ; preds = %bb.a
  call fastcc void @HUF_decompress4X2_usingDTable_internal_fast_c_loop(ptr noundef nonnull %5)
  %i.e = add i64 %1, 3
...
bb.c:                                             ; preds = %bb.r
  ...
  br i1 %exitcond, label %.thread, label %bb.d, !llvm.loop !139
...
bb.f:                                             ; preds = %bb.e
  %.val.i = load i64, ptr %i.s, align 1, !tbaa !25 ; 2 uses
  ...
  %i.ab = load ptr, ptr %i.k, align 8, !tbaa !50  ; 10 uses
...
7:                                                ; preds = %bb.g
  ...
  br i1 %8, label %BIT_reloadDStream.exit74.loopexit, label %bb.i
...
BIT_reloadDStream.exit:                           ; preds = %bb.h, %bb.i
  ...
  %.sroa.0.2 = load i64, ptr %.sroa.6235.2, align 1, !tbaa !25 ; 8 uses
...
bb.j:                                             ; preds = %BIT_reloadDStream.exit
  ...
  %i.bc = load i8, ptr %i.bb, align 2, !tbaa !28
  ...
  %i.bq = load i8, ptr %i.bp, align 2, !tbaa !28
  ...
  %i.cs = load i8, ptr %i.cr, align 2, !tbaa !28
  ...
  %i.dg = load i8, ptr %i.df, align 2, !tbaa !28
  ...
  br i1 %i.dn, label %BIT_reloadDStream.exit74.loopexit, label %bb.g, !prof !53, !llvm.loop !0
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.dr = and i32 %i.aa, 7
  %.val.i95 = load i64, ptr %i.dq, align 1, !tbaa !25
...
bb.n:                                             ; preds = %bb.m
  ...
  %.val = load i64, ptr %i.ee, align 1, !tbaa !25
  br label %BIT_reloadDStream.exit74

BIT_reloadDStream.exit74.loopexit:                ; preds = %BIT_reloadDStream.exit, %bb.j, %7
  %.sroa.6235.4.ph = phi ptr [ %.sroa.6235.2, %BIT_reloadDStream.exit ], [ %.sroa.6235.165, %7 ], [ @BIT_reloadDStream.zeroFilled, %bb.j ]
  %.sroa.17.4.ph = phi i32 [ %.sroa.17.2, %BIT_reloadDStream.exit ], [ %.sroa.17.166, %7 ], [ %i.di, %bb.j ]
  %.sroa.0.4.ph = phi i64 [ %.sroa.0.2, %BIT_reloadDStream.exit ], [ %.sroa.0.167, %7 ], [ %.sroa.0.2, %bb.j ]
  %.4.i.ph = phi ptr [ %.0.i68, %BIT_reloadDStream.exit ], [ %.0.i68, %7 ], [ %i.dm, %bb.j ] ; 2 uses
...
BIT_reloadDStream.exit74:                         ; preds = %BIT_reloadDStream.exit74.loopexit, %bb.m, %bb.n, %bb.l
  %.pre-phi78 = phi i64 [ %.pre77, %BIT_reloadDStream.exit74.loopexit ], [ %i.af, %bb.m ], [ %i.af, %bb.n ], [ %i.af, %bb.l ]
  %.sroa.6235.4 = phi ptr [ %.sroa.6235.4.ph, %BIT_reloadDStream.exit74.loopexit ], [ %i.s, %bb.m ], [ %i.ee, %bb.n ], [ %i.dq, %bb.l ]
  %.sroa.17.4 = phi i32 [ %.sroa.17.4.ph, %BIT_reloadDStream.exit74.loopexit ], [ %i.aa, %bb.m ], [ %i.eg, %bb.n ], [ %i.dr, %bb.l ] ; 4 uses
  %.sroa.0.4 = phi i64 [ %.sroa.0.4.ph, %BIT_reloadDStream.exit74.loopexit ], [ %.val.i, %bb.m ], [ %.val, %bb.n ], [ %.val.i95, %bb.l ] ; 3 uses
  %.4.i = phi ptr [ %.4.i.ph, %BIT_reloadDStream.exit74.loopexit ], [ %i.p, %bb.m ], [ %i.p, %bb.n ], [ %i.p, %bb.l ] ; 3 uses
  %i.eh = icmp ugt i64 %.pre-phi78, 1
  br i1 %i.eh, label %.preheader63, label %.loopexit

.preheader63:                                     ; preds = %BIT_reloadDStream.exit74
  %i.ei = getelementptr inbounds i8, ptr %.1, i64 -2 ; 3 uses
  %i.ej = ptrtoint ptr %i.ab to i64
  %i.ek = icmp ugt i32 %.sroa.17.4, 64
  br i1 %i.ek, label %.preheader, label %.lr.ph101, !prof !31
...
BIT_reloadDStream.exit67:                         ; preds = %bb.o, %bb.p
  ...
  %.sroa.0.6 = load i64, ptr %.sroa.6235.6, align 1, !tbaa !25 ; 4 uses
  %i.eq = icmp ule ptr %.5.i100, %i.ei
  %i.er = and i1 %i.eq, %.022.i62
  br i1 %i.er, label %bb.q, label %.preheader

.preheader:                                       ; preds = %BIT_reloadDStream.exit67, %bb.q, %11, %.preheader63
  %.5.i.lcssa = phi ptr [ %.4.i, %.preheader63 ], [ %.5.i100, %BIT_reloadDStream.exit67 ], [ %i.ff, %bb.q ], [ %.5.i100, %11 ] ; 3 uses
  %.sroa.0.692 = phi i64 [ %.sroa.0.4, %.preheader63 ], [ %.sroa.0.6, %BIT_reloadDStream.exit67 ], [ %.sroa.0.6, %bb.q ], [ %.sroa.0.599, %11 ] ; 3 uses
  %.sroa.17.691 = phi i32 [ %.sroa.17.4, %.preheader63 ], [ %.sroa.17.6, %BIT_reloadDStream.exit67 ], [ %i.fb, %bb.q ], [ %.sroa.17.598, %11 ] ; 2 uses
...
bb.q:                                             ; preds = %BIT_reloadDStream.exit67
  ...
  %i.ez = load i8, ptr %i.ey, align 2, !tbaa !28
  ...
  br i1 %i.fg, label %.preheader, label %.lr.ph101, !prof !30, !llvm.loop !2
...
.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  ...
  %i.fo = load i8, ptr %i.fn, align 2, !tbaa !28
...
.loopexit:                                        ; preds = %.lr.ph, %.preheader, %BIT_reloadDStream.exit74
  %.sroa.17.8 = phi i32 [ %.sroa.17.4, %BIT_reloadDStream.exit74 ], [ %.sroa.17.691, %.preheader ], [ %i.fq, %.lr.ph ]
  %.sroa.0.7 = phi i64 [ %.sroa.0.4, %BIT_reloadDStream.exit74 ], [ %.sroa.0.692, %.preheader ], [ %.sroa.0.692, %.lr.ph ]
...
bb.r:                                             ; preds = %HUF_decodeLastSymbolX2.exit, %.loopexit
  ...
  %i.gf = load ptr, ptr %i.o, align 8, !tbaa !52
  %i.gg = getelementptr inbounds nuw i8, ptr %i.gf, i64 %i.ge ; 2 uses
  store ptr %i.gg, ptr %i.o, align 8, !tbaa !52
...
define internal fastcc range(i64 -20, 2) i64 @HUF_DecompressFastArgs_init(ptr nofree noundef nonnull writeonly captures(none) %0, ptr noundef %1, i64 noundef %2, ptr noundef %3, i64 noundef %4, ptr noundef %5) unnamed_addr #12 {
bb.a:
...
bb.e:                                             ; preds = %bb.d
  ...
  store ptr %1, ptr %i.aj, align 8, !tbaa !52
  %i.ak = add i64 %2, 3
...
bb.f:                                             ; preds = %bb.e
  ...
  %.val.i = load i64, ptr %i.ab, align 1, !tbaa !25
  %i.bb = or i64 %.val.i, 1
  ...
  %.val.i85 = load i64, ptr %i.ac, align 1, !tbaa !25
  ...
  %.val.i87 = load i64, ptr %i.ae, align 1, !tbaa !25
  ...
  %i.cb = load i8, ptr %i.ca, align 1, !tbaa !19  ; 2 uses
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define internal fastcc void @HUF_decompress4X1_usingDTable_internal_fast_c_loop(ptr nofree noundef captures(none) %0) unnamed_addr #11 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 96
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !49   ; 20 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 112
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !51
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 104
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !50
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 64 ; 2 uses
  %.sroa.0146.0.copyload = load i64, ptr %i.g, align 8
end_hunk_2
begin_hunk_3_@HUF_decompress4X1_usingDTable_internal_bmi2:bb.a
  store i64 %.val.i116, ptr %5, align 8, !tbaa !46
  br label %BIT_reloadDStream.exit.i.i

bb.ch:                                            ; preds = %bb.cf
  %i.agj = getelementptr inbounds nuw i8, ptr %5, i64 24
  %i.agk = load ptr, ptr %i.agj, align 8, !tbaa !47 ; 3 uses
...
bb.ci:                                            ; preds = %bb.ch
  ...
  store ptr %i.agx, ptr %i.aga, align 8, !tbaa !44
  %i.agy = shl i32 %.021.i.i.i, 3
  %i.agz = sub i32 %i.acy, %i.agy                 ; 2 uses
  store i32 %i.agz, ptr %i.acx, align 8, !tbaa !43
  %.val11 = load i64, ptr %i.agx, align 1, !tbaa !25
  store i64 %.val11, ptr %5, align 8, !tbaa !46
  br label %BIT_reloadDStream.exit.i.i
...
.prol.loopexit586.unr-lcssa:                      ; preds = %.lr.ph482
  %.val82.prol = load i64, ptr %5, align 8, !tbaa !46
  %.val83.prol = load i32, ptr %i.ahd, align 8, !tbaa !43 ; 2 uses
  ...
  %i.ahp = load i8, ptr %i.aho, align 1, !tbaa !36
  %i.ahq = load i8, ptr %i.ahn, align 1, !tbaa !37
  %i.ahr = zext i8 %i.ahq to i32
  %i.ahs = add i32 %.val83.prol, %i.ahr
  store i32 %i.ahs, ptr %i.ahd, align 8, !tbaa !43
  %i.aht = getelementptr inbounds nuw i8, ptr %.3.i.i, i64 1
  store i8 %i.ahp, ptr %.3.i.i, align 1, !tbaa !19
...
.lr.ph482.new:                                    ; preds = %.prol.loopexit586, %.lr.ph482.new
  ...
  %.val82 = load i64, ptr %5, align 8, !tbaa !46
  %.val83 = load i32, ptr %i.ahd, align 8, !tbaa !43 ; 2 uses
  ...
  %i.aib = load i8, ptr %i.aia, align 1, !tbaa !36
  %i.aic = load i8, ptr %i.ahz, align 1, !tbaa !37
  %i.aid = zext i8 %i.aic to i32
  %i.aie = add i32 %.val83, %i.aid
  store i32 %i.aie, ptr %i.ahd, align 8, !tbaa !43
  %i.aif = getelementptr inbounds nuw i8, ptr %.6.i.i481, i64 1
  store i8 %i.aib, ptr %.6.i.i481, align 1, !tbaa !19
  %.val82.1 = load i64, ptr %5, align 8, !tbaa !46
  %.val83.1 = load i32, ptr %i.ahd, align 8, !tbaa !43 ; 2 uses
  ...
  %i.aim = load i8, ptr %i.ail, align 1, !tbaa !36
  %i.ain = load i8, ptr %i.aik, align 1, !tbaa !37
  %i.aio = zext i8 %i.ain to i32
  %i.aip = add i32 %.val83.1, %i.aio
  store i32 %i.aip, ptr %i.ahd, align 8, !tbaa !43
  %i.aiq = getelementptr inbounds nuw i8, ptr %.6.i.i481, i64 2 ; 2 uses
  store i8 %i.aim, ptr %i.aif, align 1, !tbaa !19
...
HUF_decodeStreamX1.exit.i.loopexit:               ; preds = %.lr.ph482.new, %.prol.loopexit586
  ...
  %.pre499 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !44
...
HUF_decodeStreamX1.exit.i:                        ; preds = %HUF_decodeStreamX1.exit.i.loopexit, %BIT_reloadDStream.exit.i.i
  ...
  %i.aja = load ptr, ptr %i.aiz, align 8, !tbaa !47
...
; Function Attrs: nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define internal fastcc i64 @HUF_decompress4X1_usingDTable_internal_fast(ptr noundef %0, i64 noundef %1, ptr noundef %2, i64 noundef %3, ptr noundef %4) unnamed_addr #11 {
bb.a:
  %5 = alloca %struct.HUF_DecompressFastArgs, align 8 ; 9 uses
...
bb.b:                                             ; preds = %bb.a
  call fastcc void @HUF_decompress4X1_usingDTable_internal_fast_c_loop(ptr noundef nonnull %5)
  %i.e = add i64 %1, 3
  %i.f = lshr i64 %i.e, 2                         ; 2 uses
  %i.g = ptrtoint ptr %i.b to i64
  %i.h = getelementptr inbounds nuw i8, ptr %5, i64 32
...
bb.c:                                             ; preds = %._crit_edge
  ...
  br i1 %exitcond53, label %.thread, label %bb.d, !llvm.loop !141
...
bb.d:                                             ; preds = %bb.b, %bb.c
  ...
  %.1 = select i1 %.not54, ptr %i.b, ptr %i.n     ; 7 uses
  %i.o = getelementptr inbounds nuw [8 x i8], ptr %i.h, i64 %indvars.iv ; 3 uses
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !52   ; 7 uses
  %i.q = icmp ugt ptr %i.p, %.1
  br i1 %i.q, label %.thread, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.r = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %indvars.iv
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !52   ; 9 uses
  %i.t = getelementptr inbounds nuw [8 x i8], ptr %i.i, i64 %indvars.iv
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !52
  %i.v = getelementptr inbounds i8, ptr %i.u, i64 -8
  %i.w = icmp ult ptr %i.s, %i.v
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.z = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %i.y, i1 true) ; 2 uses
  %i.aa = trunc nuw nsw i64 %i.z to i32           ; 5 uses
  %i.ab = load ptr, ptr %i.k, align 8, !tbaa !50  ; 7 uses
...
7:                                                ; preds = %bb.g
  ...
  br i1 %8, label %BIT_reloadDStream.exit.i, label %bb.i
...
BIT_reloadDStream.exit43.i:                       ; preds = %bb.i, %bb.h
  ...
  %.sroa.0.2 = load i64, ptr %.sroa.3820.2, align 1, !tbaa !25 ; 7 uses
...
bb.j:                                             ; preds = %BIT_reloadDStream.exit43.i
  ...
  %i.bc = load i8, ptr %i.az, align 1, !tbaa !37
  %i.bd = zext i8 %i.bc to i32
  %i.be = add i32 %.sroa.12.2, %i.bd              ; 2 uses
  store i8 %i.bb, ptr %.0.i46, align 1, !tbaa !19
  ...
  %i.bn = load i8, ptr %i.bk, align 1, !tbaa !37
  %i.bo = zext i8 %i.bn to i32
  %i.bp = add i32 %i.be, %i.bo                    ; 2 uses
  store i8 %i.bm, ptr %i.bf, align 1, !tbaa !19
  ...
  %i.by = load i8, ptr %i.bv, align 1, !tbaa !37
  %i.bz = zext i8 %i.by to i32
  %i.ca = add i32 %i.bp, %i.bz                    ; 2 uses
  store i8 %i.bx, ptr %i.bq, align 1, !tbaa !19
  ...
  %i.cj = load i8, ptr %i.cg, align 1, !tbaa !37
  %i.ck = zext i8 %i.cj to i32
  %i.cl = add i32 %i.ca, %i.ck                    ; 3 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %.0.i46, i64 4 ; 2 uses
  store i8 %i.ci, ptr %i.cb, align 1, !tbaa !19
  %i.cn = icmp ugt i32 %i.cl, 64
  br i1 %i.cn, label %BIT_reloadDStream.exit.i, label %bb.g, !prof !53, !llvm.loop !4
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.cr = and i32 %i.aa, 7
  %.val.i72 = load i64, ptr %i.cq, align 1, !tbaa !25
...
bb.n:                                             ; preds = %bb.m
  ...
  %.val59 = load i64, ptr %i.de, align 1, !tbaa !25
  br label %BIT_reloadDStream.exit.i

BIT_reloadDStream.exit.i:                         ; preds = %7, %bb.j, %BIT_reloadDStream.exit43.i, %bb.m, %bb.l, %bb.n
  %.sroa.12.4 = phi i32 [ %i.aa, %bb.m ], [ %i.dg, %bb.n ], [ %i.cr, %bb.l ], [ %i.cl, %bb.j ], [ %.sroa.12.144, %7 ], [ %.sroa.12.2, %BIT_reloadDStream.exit43.i ] ; 3 uses
  %.sroa.0.4 = phi i64 [ %.val.i, %bb.m ], [ %.val59, %bb.n ], [ %.val.i72, %bb.l ], [ %.sroa.0.2, %bb.j ], [ %.sroa.0.145, %7 ], [ %.sroa.0.2, %BIT_reloadDStream.exit43.i ] ; 3 uses
  %.3.i = phi ptr [ %i.p, %bb.m ], [ %i.p, %bb.n ], [ %i.p, %bb.l ], [ %i.cm, %bb.j ], [ %.0.i46, %7 ], [ %.0.i46, %BIT_reloadDStream.exit43.i ] ; 5 uses
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %i.ec = load i8, ptr %i.eb, align 1, !tbaa !36
  %i.ed = load i8, ptr %i.ea, align 1, !tbaa !37
  %i.ee = zext i8 %i.ed to i32
  %i.ef = add i32 %.sroa.12.547, %i.ee            ; 2 uses
  %i.eg = getelementptr inbounds nuw i8, ptr %.6.i48, i64 1
  store i8 %i.ec, ptr %.6.i48, align 1, !tbaa !19
  ...
  %i.en = load i8, ptr %i.em, align 1, !tbaa !36
  %i.eo = load i8, ptr %i.el, align 1, !tbaa !37
  %i.ep = zext i8 %i.eo to i32
  %i.eq = add i32 %i.ef, %i.ep
  %i.er = getelementptr inbounds nuw i8, ptr %.6.i48, i64 2 ; 2 uses
  store i8 %i.en, ptr %i.eg, align 1, !tbaa !19
...
._crit_edge.loopexit:                             ; preds = %.lr.ph, %.lr.ph.prol.loopexit
  %.pre = load ptr, ptr %i.o, align 8, !tbaa !52
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %BIT_reloadDStream.exit.i
  %i.es = phi ptr [ %.pre, %._crit_edge.loopexit ], [ %i.p, %BIT_reloadDStream.exit.i ]
  %i.et = getelementptr inbounds nuw i8, ptr %i.es, i64 %i.af ; 2 uses
  store ptr %i.et, ptr %i.o, align 8, !tbaa !52
...
attributes #7 = { nofree norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+bmi,+bmi2,+cmov,+cx8,+fxsr,+lzcnt,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #8 = { inlinehint mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #11 = { nofree norecurse nosync nounwind memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+bmi,+bmi2,+cmov,+cx8,+fxsr,+lzcnt,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!33 = !{!32, !15, i64 0}
!34 = !{!32, !15, i64 4}
!35 = !{!"", !14, i64 0, !14, i64 1}
!36 = !{!35, !14, i64 1}
!37 = !{!35, !14, i64 0}
!38 = !{!26, !26, i64 0}
!39 = !{!"any pointer", !14, i64 0}
!40 = !{!"p1 omnipotent char", !39, i64 0}
!41 = !{!"", !24, i64 0, !15, i64 8, !40, i64 16, !40, i64 24, !40, i64 32}
!42 = !{!41, !40, i64 32}
!43 = !{!41, !15, i64 8}
!44 = !{!41, !40, i64 16}
...
!46 = !{!41, !24, i64 0}
!47 = !{!41, !40, i64 24}
!48 = !{!"", !14, i64 0, !14, i64 32, !14, i64 64, !39, i64 96, !40, i64 104, !40, i64 112, !14, i64 120}
!49 = !{!48, !39, i64 96}
!50 = !{!48, !40, i64 104}
!51 = !{!48, !40, i64 112}
!52 = !{!40, !40, i64 0}
!53 = !{!"branch_weights", i32 1, i32 1999}
!54 = distinct !{!54, !20, !21, !22}
