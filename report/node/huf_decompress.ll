...
BIT_reloadDStream.exit22.i:                       ; preds = %bb.ae, %bb.ad
  ...
  %.sroa.0.7.i = load i64, ptr %.sroa.9790.7.i, align 1, !tbaa !25 ; 3 uses
...
BIT_reloadDStream.exit22:                         ; preds = %bb.ab, %bb.ac
  ...
  %.sroa.0.7 = load i64, ptr %.sroa.9790.7, align 1, !tbaa !25 ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  %.val.i = load i64, ptr %i.s, align 1, !tbaa !25
  ...
  %i.ab = load ptr, ptr %i.k, align 8, !tbaa !50  ; 8 uses
...
bb.g:                                             ; preds = %.preheader64, %bb.j
  %.0.i68 = phi ptr [ %i.p, %.preheader64 ], [ %i.dm, %bb.j ] ; 4 uses
  %.sroa.17.166 = phi i32 [ %i.aa, %.preheader64 ], [ %i.di, %bb.j ] ; 3 uses
  %.sroa.6235.165 = phi ptr [ %i.s, %.preheader64 ], [ %.sroa.6235.2, %bb.j ] ; 4 uses
  %.not.i59 = icmp ult ptr %.sroa.6235.165, %i.ac
  %6 = lshr i32 %.sroa.17.166, 3                  ; 3 uses
...
bb.i:                                             ; preds = %bb.g
  ...
  %.021.i = select i1 %i.an, i32 %6, i32 %i.aq    ; 2 uses
...
BIT_reloadDStream.exit:                           ; preds = %bb.h, %bb.i
  ...
  %.sroa.0.2 = load i64, ptr %.sroa.6235.2, align 1, !tbaa !25 ; 6 uses
...
BIT_reloadDStream.exit74.loopexit:                ; preds = %BIT_reloadDStream.exit, %bb.j
  %.sroa.6235.4.ph.ph = phi ptr [ @BIT_reloadDStream.zeroFilled, %bb.j ], [ %.sroa.6235.2, %BIT_reloadDStream.exit ]
  %.sroa.17.4.ph.ph = phi i32 [ %i.di, %bb.j ], [ %.sroa.17.2, %BIT_reloadDStream.exit ]
  %.4.i.ph.ph = phi ptr [ %i.dm, %bb.j ], [ %.0.i68, %BIT_reloadDStream.exit ] ; 2 uses
...
BIT_reloadDStream.exit74:                         ; preds = %BIT_reloadDStream.exit74.loopexit, %bb.m, %bb.n, %bb.l
  ...
  %.sroa.6235.4 = phi ptr [ %.sroa.6235.4.ph.ph, %BIT_reloadDStream.exit74.loopexit ], [ %i.s, %bb.m ], [ %i.ee, %bb.n ], [ %i.dq, %bb.l ]
  %.sroa.17.4 = phi i32 [ %.sroa.17.4.ph.ph, %BIT_reloadDStream.exit74.loopexit ], [ %i.aa, %bb.m ], [ %i.eg, %bb.n ], [ %i.dr, %bb.l ] ; 4 uses
  %.sroa.0.4 = phi i64 [ %.sroa.0.2, %BIT_reloadDStream.exit74.loopexit ], [ %.val.i, %bb.m ], [ %.val, %bb.n ], [ %.val.i95, %bb.l ] ; 2 uses
...
.lr.ph101:                                        ; preds = %.preheader63, %bb.q
  %.5.i100 = phi ptr [ %i.ff, %bb.q ], [ %.4.i, %.preheader63 ] ; 4 uses
  %.sroa.17.598 = phi i32 [ %i.fb, %bb.q ], [ %.sroa.17.4, %.preheader63 ] ; 3 uses
  %.sroa.6235.597 = phi ptr [ %.sroa.6235.6, %bb.q ], [ %.sroa.6235.4, %.preheader63 ] ; 4 uses
  %.not.i61 = icmp ult ptr %.sroa.6235.597, %i.ac
  %7 = lshr i32 %.sroa.17.598, 3                  ; 2 uses
  %8 = zext nneg i32 %7 to i64
  %9 = sub nsw i64 0, %8
  %10 = getelementptr inbounds i8, ptr %.sroa.6235.597, i64 %9 ; 2 uses
...
bb.p:                                             ; preds = %.lr.ph101
  %11 = icmp uge ptr %10, %i.ab                   ; 2 uses
  %12 = ptrtoint ptr %.sroa.6235.597 to i64
  %i.em = sub i64 %12, %i.ej
  %13 = trunc i64 %i.em to i32
  %.021.i63 = select i1 %11, i32 %7, i32 %13      ; 2 uses
  %14 = zext i32 %.021.i63 to i64
  %i.en = sub nsw i64 0, %14
  %15 = getelementptr inbounds i8, ptr %.sroa.6235.597, i64 %i.en
  %i.eo = shl i32 %.021.i63, 3
  %i.ep = sub i32 %.sroa.17.598, %i.eo
  br label %BIT_reloadDStream.exit67

BIT_reloadDStream.exit67:                         ; preds = %bb.o, %bb.p
  %.sroa.6235.6 = phi ptr [ %10, %bb.o ], [ %15, %bb.p ] ; 2 uses
  %.sroa.17.6 = phi i32 [ %i.el, %bb.o ], [ %i.ep, %bb.p ] ; 3 uses
  %.022.i62 = phi i1 [ true, %bb.o ], [ %11, %bb.p ]
  %.sroa.0.6 = load i64, ptr %.sroa.6235.6, align 1, !tbaa !25 ; 3 uses
  %i.eq = icmp ule ptr %.5.i100, %i.ei
  %i.er = and i1 %i.eq, %.022.i62
  br i1 %i.er, label %bb.q, label %.preheader

.preheader:                                       ; preds = %BIT_reloadDStream.exit67, %bb.q, %.preheader63
  %.5.i.lcssa = phi ptr [ %.4.i, %.preheader63 ], [ %.5.i100, %BIT_reloadDStream.exit67 ], [ %i.ff, %bb.q ] ; 3 uses
  %.sroa.0.691 = phi i64 [ %.sroa.0.4, %.preheader63 ], [ %.sroa.0.6, %bb.q ], [ %.sroa.0.6, %BIT_reloadDStream.exit67 ] ; 3 uses
  %.sroa.17.690 = phi i32 [ %.sroa.17.4, %.preheader63 ], [ %.sroa.17.6, %BIT_reloadDStream.exit67 ], [ %i.fb, %bb.q ] ; 2 uses
...
.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  ...
  %.sroa.17.770 = phi i32 [ %i.fq, %.lr.ph ], [ %.sroa.17.690, %.preheader ] ; 2 uses
  %i.fh = and i32 %.sroa.17.770, 63
  %i.fi = zext nneg i32 %i.fh to i64
  %i.fj = shl i64 %.sroa.0.691, %i.fi
...
.loopexit:                                        ; preds = %.lr.ph, %.preheader, %BIT_reloadDStream.exit74
  %.sroa.17.8 = phi i32 [ %.sroa.17.4, %BIT_reloadDStream.exit74 ], [ %.sroa.17.690, %.preheader ], [ %i.fq, %.lr.ph ]
  %.sroa.0.7 = phi i64 [ %.sroa.0.4, %BIT_reloadDStream.exit74 ], [ %.sroa.0.691, %.preheader ], [ %.sroa.0.691, %.lr.ph ]
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.z = tail call range(i64 0, 65) i64 @llvm.cttz.i64(i64 %i.y, i1 true) ; 2 uses
  %i.aa = trunc nuw nsw i64 %i.z to i32           ; 5 uses
  %i.ab = load ptr, ptr %i.k, align 8, !tbaa !50  ; 6 uses
...
bb.g:                                             ; preds = %.preheader, %bb.j
  %.0.i46 = phi ptr [ %i.p, %.preheader ], [ %i.cm, %bb.j ] ; 7 uses
  %.sroa.12.144 = phi i32 [ %i.aa, %.preheader ], [ %i.cl, %bb.j ] ; 3 uses
  %.sroa.3820.143 = phi ptr [ %i.s, %.preheader ], [ %.sroa.3820.2, %bb.j ] ; 4 uses
  %.not.i37.i = icmp ult ptr %.sroa.3820.143, %i.ac
  %6 = lshr i32 %.sroa.12.144, 3                  ; 3 uses
...
bb.i:                                             ; preds = %bb.g
  ...
  %i.ap = sub i64 %i.ao, %i.ah
  %i.aq = trunc i64 %i.ap to i32
  %.021.i39.i = select i1 %i.an, i32 %6, i32 %i.aq ; 2 uses
...
BIT_reloadDStream.exit43.i:                       ; preds = %bb.i, %bb.h
  ...
  %.sroa.0.2 = load i64, ptr %.sroa.3820.2, align 1, !tbaa !25 ; 6 uses
...
BIT_reloadDStream.exit.i:                         ; preds = %bb.j, %BIT_reloadDStream.exit43.i, %bb.m, %bb.l, %bb.n
  %.sroa.12.4 = phi i32 [ %i.aa, %bb.m ], [ %i.dg, %bb.n ], [ %i.cr, %bb.l ], [ %.sroa.12.2, %BIT_reloadDStream.exit43.i ], [ %i.cl, %bb.j ] ; 3 uses
  %.sroa.0.4 = phi i64 [ %.val.i, %bb.m ], [ %.val59, %bb.n ], [ %.val.i72, %bb.l ], [ %.sroa.0.2, %BIT_reloadDStream.exit43.i ], [ %.sroa.0.2, %bb.j ] ; 3 uses
  %.3.i = phi ptr [ %i.p, %bb.m ], [ %i.p, %bb.n ], [ %i.p, %bb.l ], [ %.0.i46, %BIT_reloadDStream.exit43.i ], [ %i.cm, %bb.j ] ; 5 uses
