...
.preheader539.i.preheader:                        ; preds = %bb.da
  ...
  %umin = tail call i64 @llvm.umin.i64(i64 %.sroa.11.0.copyload, i64 %i.zm)
  %i.abm = add i64 %i.abl, %umin
  %umax34 = tail call i64 @llvm.umax.i64(i64 %.sroa.11.0.copyload, i64 %i.zm) ; 3 uses
  %i.abn = add i64 %i.abm, %umax34
...
.preheader543.i.preheader:                        ; preds = %bb.dv
  ...
  %umin114 = tail call i64 @llvm.umin.i64(i64 %.sroa.1048.0.copyload, i64 %i.aea)
  %i.aga = add i64 %i.afz, %umin114
  %umax115 = tail call i64 @llvm.umax.i64(i64 %.sroa.1048.0.copyload, i64 %i.aea) ; 3 uses
  %i.agb = add i64 %i.aga, %umax115
...
.preheader546.i.preheader:                        ; preds = %bb.ep
  ...
  %umin137 = tail call i64 @llvm.umin.i64(i64 %.sroa.10.0.copyload, i64 %i.aij)
  %i.akj = add i64 %i.aki, %umin137
  %umax138 = tail call i64 @llvm.umax.i64(i64 %.sroa.10.0.copyload, i64 %i.aij) ; 3 uses
  %i.akk = add i64 %i.akj, %umax138
...
.preheader529.i.preheader:                        ; preds = %bb.ft
  ...
  %umin161 = tail call i64 @llvm.umin.i64(i64 %.sroa.1132.0.copyload, i64 %i.aql)
  %i.asl = add i64 %i.ask, %umin161
  %umax162 = tail call i64 @llvm.umax.i64(i64 %.sroa.1132.0.copyload, i64 %i.aql) ; 3 uses
  %i.asm = add i64 %i.asl, %umax162
...
.preheader533.i.preheader:                        ; preds = %bb.gn
  ...
  %umin264 = tail call i64 @llvm.umin.i64(i64 %.sroa.1056.0.copyload, i64 %i.aus)
  %i.aws = add i64 %i.awr, %umin264
  %umax265 = tail call i64 @llvm.umax.i64(i64 %.sroa.1056.0.copyload, i64 %i.aus) ; 3 uses
  %i.awt = add i64 %i.aws, %umax265
...
.preheader536.i.preheader:                        ; preds = %bb.hh
  ...
  %umin287 = tail call i64 @llvm.umin.i64(i64 %.sroa.1040.0.copyload, i64 %i.ayy)
  %i.bay = add i64 %i.bax, %umin287
  %umax288 = tail call i64 @llvm.umax.i64(i64 %.sroa.1040.0.copyload, i64 %i.ayy) ; 3 uses
  %i.baz = add i64 %i.bay, %umax288
...
.preheader240.i.preheader:                        ; preds = %bb.bs
  ...
  %umin = tail call i64 @llvm.umin.i64(i64 %.sink.i, i64 %i.pd)
  %i.re = add i64 %i.rd, %umin
  %umax108 = tail call i64 @llvm.umax.i64(i64 %.sink.i, i64 %i.pd) ; 3 uses
  %i.rf = add i64 %i.re, %umax108
...
.preheader236.i.preheader:                        ; preds = %bb.cu
  ...
  %umin188 = tail call i64 @llvm.umin.i64(i64 %.sink.i, i64 %i.wf)
  %i.yg = add i64 %i.yf, %umin188
  %umax189 = tail call i64 @llvm.umax.i64(i64 %.sink.i, i64 %i.wf) ; 3 uses
  %i.yh = add i64 %i.yg, %umax189
...
.preheader233.i.preheader:                        ; preds = %bb.en
  ...
  %umin212 = tail call i64 @llvm.umin.i64(i64 %.sink442.i, i64 %i.ahl)
  %i.ajm = add i64 %i.ajl, %umin212
  %umax213 = tail call i64 @llvm.umax.i64(i64 %.sink442.i, i64 %i.ahl) ; 3 uses
  %i.ajn = add i64 %i.ajm, %umax213
...
.preheader240.preheader:                          ; preds = %bb.bq
  ...
  %umin = tail call i64 @llvm.umin.i64(i64 %.sink, i64 %i.pe)
  %i.rf = add i64 %i.re, %umin
  %umax78 = tail call i64 @llvm.umax.i64(i64 %.sink, i64 %i.pe) ; 3 uses
  %i.rg = add i64 %i.rf, %umax78
...
.preheader236.preheader:                          ; preds = %bb.cs
  ...
  %umin158 = tail call i64 @llvm.umin.i64(i64 %.sink, i64 %i.wg)
  %i.yh = add i64 %i.yg, %umin158
  %umax159 = tail call i64 @llvm.umax.i64(i64 %.sink, i64 %i.wg) ; 3 uses
  %i.yi = add i64 %i.yh, %umax159
...
.preheader233.preheader:                          ; preds = %bb.el
  ...
  %umin182 = tail call i64 @llvm.umin.i64(i64 %.sink442, i64 %i.aho)
  %i.ajp = add i64 %i.ajo, %umin182
  %umax183 = tail call i64 @llvm.umax.i64(i64 %.sink442, i64 %i.aho) ; 3 uses
  %i.ajq = add i64 %i.ajp, %umax183
