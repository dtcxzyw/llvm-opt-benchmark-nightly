...
_ZNK2v88internal10JSFunction15has_initial_mapEv.exit.thread: ; preds = %bb.a, %_ZNK2v88internal10JSFunction15has_initial_mapEv.exit
  %i.r = tail call noundef i32 @_ZN2v88internal10JSFunction30CalculateExpectedNofPropertiesEPNS0_7IsolateENS0_12DirectHandleIS1_EE(ptr noundef %0, ptr nonnull %1) ; 2 uses
...
bb.e:                                             ; preds = %bb.c
  %.sroa.speculated.i = tail call i32 @llvm.smin.i32(i32 %i.bh, i32 %i.r) ; 2 uses
  %i.bj = shl i32 %.sroa.speculated.i, 3
  %i.bk = add nsw i32 %i.bj, %i.bf                ; 2 uses
  %3 = icmp sgt i32 %i.r, -268435457
  br i1 %3, label %bb.g, label %bb.f, !prof !26
