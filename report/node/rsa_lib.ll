...
bb.e:                                             ; preds = %bb.e, %bb.d
  ...
  %.01419.i = phi i64 [ %i.g, %bb.d ], [ %i.h, %bb.e ] ; 2 uses
...
ilog_e.exit:                                      ; preds = %bb.e
  ...
  %i.m = mul nuw nsw i64 %i.h, %i.h               ; 2 uses
  %i.n = icmp samesign ugt i64 %i.m, 137438953471 ; 2 uses
  %.216.v.i = select i1 %i.n, i64 19, i64 18
  %.216.i = lshr i64 %i.m, %.216.v.i              ; 2 uses
  %i.o = select i1 %i.n, i32 131072, i32 0
  %i.p = mul nuw nsw i64 %.216.i, %.216.i         ; 2 uses
  %i.q = icmp samesign ugt i64 %i.p, 137438953471 ; 2 uses
  %.216.v.1.i = select i1 %i.q, i64 19, i64 18
  %.216.1.i = lshr i64 %i.p, %.216.v.1.i          ; 2 uses
  %i.r = select i1 %i.q, i32 65536, i32 0
  %i.s = mul nuw nsw i64 %.216.1.i, %.216.1.i     ; 2 uses
  %i.t = icmp samesign ugt i64 %i.s, 137438953471 ; 2 uses
