...
bb.a:
  %i.a = tail call ptr @EVP_CIPHER_CTX_get_cipher_data(ptr noundef %0) #8 ; 20 uses
...
bb.h:                                             ; preds = %bb.f, %bb.e
  %.pn = phi i64 [ 720, %bb.e ], [ 704, %bb.f ]
  %.0114 = phi ptr [ %i.g, %bb.e ], [ %i.h, %bb.f ] ; 5 uses
  %.0115 = getelementptr inbounds nuw i8, ptr %i.a, i64 %.pn ; 5 uses
