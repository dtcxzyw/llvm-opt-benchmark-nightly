...
pred.store.continue75:                            ; preds = %pred.store.continue, %pred.store.if74
...
pred.store.continue42:                            ; preds = %pred.store.continue, %pred.store.if41
...
pred.store.continue72:                            ; preds = %pred.store.continue, %pred.store.if71
  %i.at = extractelement <2 x i1> %i.aq, i64 0
