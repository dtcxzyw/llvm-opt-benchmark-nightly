...
bb.m:                                             ; preds = %bb.l
  ...
  call void %i.cp(ptr noundef nonnull align 8 dereferenceable(172) %9, i64 noundef 1) #25, !inline_history !440
...
bb.o:                                             ; preds = %bb.n
  ...
  call void %i.dg(ptr noundef nonnull align 8 dereferenceable(172) %9, i64 noundef %i.dd) #25, !inline_history !439
...
bb.q:                                             ; preds = %bb.q, %.lr.ph.i128.new
  ...
  br i1 %niter982.ncmp.1, label %._crit_edge.i132.unr-lcssa, label %bb.q, !llvm.loop !438
...
bb.s:                                             ; preds = %bb.r
  ...
  call void %i.em(ptr noundef nonnull align 8 dereferenceable(172) %7, i64 noundef %i.ej) #25, !inline_history !439
...
_ZN3fmt3v1119basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.thread.i: ; preds = %bb.u
  ...
  call void %i.ew(ptr noundef nonnull align 8 dereferenceable(172) %8, i64 noundef %i.et) #25, !inline_history !441
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.fq, label %middle.block, label %vector.body, !llvm.loop !442
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  br i1 %.not.i.i139, label %_ZN3fmt3v116detail6bigint6assignERKS2_.exit, label %.lr.ph.i.i, !llvm.loop !443
...
_ZN3fmt3v1119basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.thread.i148: ; preds = %bb.v
  ...
  call void %i.fy(ptr noundef nonnull align 8 dereferenceable(172) %9, i64 noundef %i.fv) #25, !inline_history !441
...
vector.body871:                                   ; preds = %vector.body871, %vector.ph868
  ...
  br i1 %i.gs, label %middle.block878, label %vector.body871, !llvm.loop !444
...
.lr.ph.i.i144:                                    ; preds = %.lr.ph.i.i144.preheader, %.lr.ph.i.i144
  ...
  br i1 %.not.i.i147, label %_ZN3fmt3v116detail6bigint6assignERKS2_.exit151, label %.lr.ph.i.i144, !llvm.loop !445
...
.lr.ph.i153:                                      ; preds = %.lr.ph.i153, %.lr.ph.i153.preheader.new
  ...
  br i1 %niter961.ncmp.1, label %._crit_edge.i157.unr-lcssa, label %.lr.ph.i153, !llvm.loop !438
...
bb.x:                                             ; preds = %bb.w
  ...
  call void %i.hu(ptr noundef nonnull align 8 dereferenceable(172) %9, i64 noundef %i.hr) #25, !inline_history !439
...
bb.y:                                             ; preds = %bb.y, %.lr.ph.i.i164
  ...
  br i1 %exitcond.not.i.i, label %.preheader.i.i, label %bb.y, !llvm.loop !446
...
bb.z:                                             ; preds = %.lr.ph22.i.i
  ...
  call void %i.iw(ptr noundef nonnull align 8 dereferenceable(172) %6, i64 noundef %i.it) #25, !inline_history !447
...
_ZN3fmt3v116detail6bufferIjE9push_backERKj.exit.i.i: ; preds = %bb.z, %.lr.ph22.i.i
  ...
  br i1 %.not.i.i165, label %_ZN3fmt3v116detail6bigintmLIoEERS2_T_.exit, label %.lr.ph22.i.i, !llvm.loop !448
...
end_hunk_0
begin_hunk_1_@_ZNSt6vectorIN4LIEF5MachO7details19binding_instructionESaIS3_EE17_M_realloc_insertIJiiEEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_:bb.a
  %i.e = load ptr, ptr %0, align 8                ; 7 uses
...
bb.b:                                             ; preds = %bb.a
  tail call void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.129) #27
  unreachable
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.a
  ...
  %i.r = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.q) #28 ; 5 uses
...
bb.c:                                             ; preds = %.lr.ph.i.i.i.i.i
  %i.aj = call noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %i.ac, ptr noundef nonnull align 8 dereferenceable(8) %i.b, i64 noundef 0) #25 ; 2 uses
...
_ZSt10_ConstructIN4LIEF5MachO7details19binding_instructionEJRKS3_EEvPT_DpOT0_.exit.i.i.i.i.i: ; preds = %bb.e, %bb.d, %._crit_edge.i.i.i.i.i.i.i.i.i
  ...
  br i1 %.not.i.i.i.i.i, label %_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit, label %.lr.ph.i.i.i.i.i, !llvm.loop !613
...
_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit: ; preds = %_ZSt10_ConstructIN4LIEF5MachO7details19binding_instructionEJRKS3_EEvPT_DpOT0_.exit.i.i.i.i.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  ...
  %.not9.i.i.i.i.i19 = icmp eq ptr %1, %i.d
  br i1 %.not9.i.i.i.i.i19, label %_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit27, label %.lr.ph.i.i.i.i.i20

.lr.ph.i.i.i.i.i20:                               ; preds = %_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit, %_ZSt10_ConstructIN4LIEF5MachO7details19binding_instructionEJRKS3_EEvPT_DpOT0_.exit.i.i.i.i.i24
  %.011.i.i.i.i.i21 = phi ptr [ %i.bk, %_ZSt10_ConstructIN4LIEF5MachO7details19binding_instructionEJRKS3_EEvPT_DpOT0_.exit.i.i.i.i.i24 ], [ %i.at, %_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit ] ; 5 uses
  %.0810.i.i.i.i.i22 = phi ptr [ %i.bj, %_ZSt10_ConstructIN4LIEF5MachO7details19binding_instructionEJRKS3_EEvPT_DpOT0_.exit.i.i.i.i.i24 ], [ %1, %_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit ] ; 4 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %.011.i.i.i.i.i21, ptr noundef nonnull align 8 dereferenceable(56) %.0810.i.i.i.i.i22, i64 24, i1 false)
  %i.au = getelementptr inbounds nuw i8, ptr %.011.i.i.i.i.i21, i64 24 ; 4 uses
  %i.av = getelementptr inbounds nuw i8, ptr %.0810.i.i.i.i.i22, i64 24
  %i.aw = getelementptr inbounds nuw i8, ptr %.011.i.i.i.i.i21, i64 40 ; 3 uses
  store ptr %i.aw, ptr %i.au, align 8
  %i.ax = load ptr, ptr %i.av, align 8            ; 2 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %.0810.i.i.i.i.i22, i64 32
  %i.az = load i64, ptr %i.ay, align 8            ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #25
  store i64 %i.az, ptr %i.a, align 8
  %i.ba = icmp ugt i64 %i.az, 15
  br i1 %i.ba, label %bb.f, label %._crit_edge.i.i.i.i.i.i.i.i.i23

bb.f:                                             ; preds = %.lr.ph.i.i.i.i.i20
  %i.bb = call noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %i.au, ptr noundef nonnull align 8 dereferenceable(8) %i.a, i64 noundef 0) #25 ; 2 uses
  store ptr %i.bb, ptr %i.au, align 8
  %i.bc = load i64, ptr %i.a, align 8
  store i64 %i.bc, ptr %i.aw, align 8
  br label %._crit_edge.i.i.i.i.i.i.i.i.i23

._crit_edge.i.i.i.i.i.i.i.i.i23:                  ; preds = %bb.f, %.lr.ph.i.i.i.i.i20
  %i.bd = phi ptr [ %i.bb, %bb.f ], [ %i.aw, %.lr.ph.i.i.i.i.i20 ] ; 2 uses
  switch i64 %i.az, label %bb.h [
    i64 1, label %bb.g
    i64 0, label %_ZSt10_ConstructIN4LIEF5MachO7details19binding_instructionEJRKS3_EEvPT_DpOT0_.exit.i.i.i.i.i24
  ]

bb.g:                                             ; preds = %._crit_edge.i.i.i.i.i.i.i.i.i23
  %i.be = load i8, ptr %i.ax, align 1
  store i8 %i.be, ptr %i.bd, align 1
  br label %_ZSt10_ConstructIN4LIEF5MachO7details19binding_instructionEJRKS3_EEvPT_DpOT0_.exit.i.i.i.i.i24

bb.h:                                             ; preds = %._crit_edge.i.i.i.i.i.i.i.i.i23
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.bd, ptr align 1 %i.ax, i64 %i.az, i1 false)
  br label %_ZSt10_ConstructIN4LIEF5MachO7details19binding_instructionEJRKS3_EEvPT_DpOT0_.exit.i.i.i.i.i24

_ZSt10_ConstructIN4LIEF5MachO7details19binding_instructionEJRKS3_EEvPT_DpOT0_.exit.i.i.i.i.i24: ; preds = %bb.h, %bb.g, %._crit_edge.i.i.i.i.i.i.i.i.i23
  %i.bf = load i64, ptr %i.a, align 8             ; 2 uses
  %i.bg = getelementptr inbounds nuw i8, ptr %.011.i.i.i.i.i21, i64 32
  store i64 %i.bf, ptr %i.bg, align 8
  %i.bh = load ptr, ptr %i.au, align 8
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bh, i64 %i.bf
  store i8 0, ptr %i.bi, align 1
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #25
  %i.bj = getelementptr inbounds nuw i8, ptr %.0810.i.i.i.i.i22, i64 56 ; 2 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %.011.i.i.i.i.i21, i64 56 ; 2 uses
  %.not.i.i.i.i.i25 = icmp eq ptr %i.bj, %i.d
  br i1 %.not.i.i.i.i.i25, label %_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit27, label %.lr.ph.i.i.i.i.i20, !llvm.loop !613

_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit27: ; preds = %_ZSt10_ConstructIN4LIEF5MachO7details19binding_instructionEJRKS3_EEvPT_DpOT0_.exit.i.i.i.i.i24, %_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit
  %.0.lcssa.i.i.i.i.i26 = phi ptr [ %i.at, %_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit ], [ %i.bk, %_ZSt10_ConstructIN4LIEF5MachO7details19binding_instructionEJRKS3_EEvPT_DpOT0_.exit.i.i.i.i.i24 ]
...
.lr.ph.i.i:                                       ; preds = %_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit27, %_ZSt8_DestroyIN4LIEF5MachO7details19binding_instructionEEvPT_.exit.i.i
  %.05.i.i = phi ptr [ %i.br, %_ZSt8_DestroyIN4LIEF5MachO7details19binding_instructionEEvPT_.exit.i.i ], [ %i.e, %_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit27 ] ; 3 uses
...
_ZSt8_DestroyIN4LIEF5MachO7details19binding_instructionEEvPT_.exit.i.i: ; preds = %.lr.ph.i.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i
  ...
  br i1 %.not.i.i, label %_ZSt8_DestroyIPN4LIEF5MachO7details19binding_instructionEEvT_S5_.exit, label %.lr.ph.i.i, !llvm.loop !182

_ZSt8_DestroyIPN4LIEF5MachO7details19binding_instructionEEvT_S5_.exit: ; preds = %_ZSt8_DestroyIN4LIEF5MachO7details19binding_instructionEEvPT_.exit.i.i, %_ZSt34__uninitialized_move_if_noexcept_aIPN4LIEF5MachO7details19binding_instructionES4_SaIS3_EET0_T_S7_S6_RT1_.exit27
  %i.bs = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %.not.i28 = icmp eq ptr %i.e, null
  br i1 %.not.i28, label %_ZNSt12_Vector_baseIN4LIEF5MachO7details19binding_instructionESaIS3_EE13_M_deallocateEPS3_m.exit, label %bb.i

bb.i:                                             ; preds = %_ZSt8_DestroyIPN4LIEF5MachO7details19binding_instructionEEvT_S5_.exit
  %i.bt = load ptr, ptr %i.bs, align 8
  %i.bu = ptrtoint ptr %i.bt to i64
  %i.bv = sub i64 %i.bu, %i.g
  call void @_ZdlPvm(ptr noundef nonnull %i.e, i64 noundef %i.bv) #26
...
_ZNSt12_Vector_baseIN4LIEF5MachO7details19binding_instructionESaIS3_EE13_M_deallocateEPS3_m.exit: ; preds = %_ZSt8_DestroyIPN4LIEF5MachO7details19binding_instructionEEvT_S5_.exit, %bb.i
  ...
  store ptr %.0.lcssa.i.i.i.i.i26, ptr %i.c, align 8
...
_ZNKSt6vectorISt10unique_ptrIN4LIEF5MachO10ExportInfoESt14default_deleteIS3_EESaIS6_EE12_M_check_lenEmPKc.exit: ; preds = %bb.a
  ...
  %i.q = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.p) #28 ; 10 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %next.gep36, align 8, !alias.scope !633, !noalias !628
  %wide.load37 = load <2 x i64>, ptr %i.ae, align 8, !alias.scope !633, !noalias !628
  %i.af = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !alias.scope !636, !noalias !633
  store <2 x i64> %wide.load37, ptr %i.af, align 8, !alias.scope !636, !noalias !633
  %i.ag = getelementptr i8, ptr %next.gep36, i64 16
  store <2 x ptr> splat (ptr null), ptr %next.gep36, align 8, !alias.scope !633, !noalias !628
  store <2 x ptr> splat (ptr null), ptr %i.ag, align 8, !alias.scope !633, !noalias !628
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ah = icmp eq i64 %index.next, %n.vec
  br i1 %i.ah, label %middle.block, label %vector.body, !llvm.loop !638
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader62, %.lr.ph.i.i.i
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !628)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !631)
  %i.ai = load i64, ptr %.0911.i.i.i, align 8, !alias.scope !631, !noalias !628
  store i64 %i.ai, ptr %.012.i.i.i, align 8, !alias.scope !628, !noalias !631
  ...
  br i1 %.not.i.i.i, label %_ZNSt6vectorISt10unique_ptrIN4LIEF5MachO10ExportInfoESt14default_deleteIS3_EESaIS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit, label %.lr.ph.i.i.i, !llvm.loop !639
...
vector.body50:                                    ; preds = %vector.body50, %vector.ph47
  ...
  %wide.load54 = load <2 x i64>, ptr %next.gep53, align 8, !alias.scope !645, !noalias !640
  %wide.load55 = load <2 x i64>, ptr %i.ay, align 8, !alias.scope !645, !noalias !640
  %i.az = getelementptr i8, ptr %next.gep52, i64 16
  store <2 x i64> %wide.load54, ptr %next.gep52, align 8, !alias.scope !648, !noalias !645
  store <2 x i64> %wide.load55, ptr %i.az, align 8, !alias.scope !648, !noalias !645
  %i.ba = getelementptr i8, ptr %next.gep53, i64 16
  store <2 x ptr> splat (ptr null), ptr %next.gep53, align 8, !alias.scope !645, !noalias !640
  store <2 x ptr> splat (ptr null), ptr %i.ba, align 8, !alias.scope !645, !noalias !640
  %index.next56 = add nuw i64 %index51, 4         ; 2 uses
  %i.bb = icmp eq i64 %index.next56, %n.vec49
  br i1 %i.bb, label %middle.block57, label %vector.body50, !llvm.loop !650
...
.lr.ph.i.i.i17:                                   ; preds = %.lr.ph.i.i.i17.preheader61, %.lr.ph.i.i.i17
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !640)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !643)
  %i.bc = load i64, ptr %.0911.i.i.i19, align 8, !alias.scope !643, !noalias !640
  store i64 %i.bc, ptr %.012.i.i.i18, align 8, !alias.scope !640, !noalias !643
  ...
  br i1 %.not.i.i.i20, label %_ZNSt6vectorISt10unique_ptrIN4LIEF5MachO10ExportInfoESt14default_deleteIS3_EESaIS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit22, label %.lr.ph.i.i.i17, !llvm.loop !651
...
bb.c:                                             ; preds = %_ZNSt6vectorISt10unique_ptrIN4LIEF5MachO10ExportInfoESt14default_deleteIS3_EESaIS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit22
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.d, i64 noundef %i.bi) #26
...
!7 = distinct !{null, null, null, null, null, null}
!8 = distinct !{!8, !6}
