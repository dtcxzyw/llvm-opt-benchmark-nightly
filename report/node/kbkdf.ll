...
bb.m:                                             ; preds = %bb.l
  %i.s = call i64 @llvm.umin.i64(i64 %13, i64 %9)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %12, ptr noundef nonnull align 1 dereferenceable(1) %8, i64 %i.s, i1 false)
  call void @EVP_MAC_CTX_free(ptr noundef nonnull %i.j) #6
  %i.t = icmp ult i64 %9, %13
  br i1 %i.t, label %.peel.next, label %.loopexit

.peel.next:                                       ; preds = %bb.m, %bb.x
  %.04564 = phi i32 [ %i.ai, %bb.x ], [ 2, %bb.m ] ; 2 uses
  %.04862 = phi i64 [ %i.ah, %bb.x ], [ %9, %bb.m ] ; 3 uses
  %i.u = call noundef i32 @llvm.bswap.i32(i32 %.04564)
  store i32 %i.u, ptr %i.c, align 4, !tbaa !5
  %i.v = call ptr @EVP_MAC_CTX_dup(ptr noundef %0) #6 ; 16 uses
  %i.w = icmp eq ptr %i.v, null
  br i1 %i.w, label %.loopexit, label %bb.n

bb.n:                                             ; preds = %.peel.next
  br i1 %i.d, label %bb.o, label %bb.p

bb.o:                                             ; preds = %bb.n
  %i.x = call i32 @EVP_MAC_update(ptr noundef nonnull %i.v, ptr noundef nonnull %8, i64 noundef %9) #6
  %.not54 = icmp eq i32 %i.x, 0
  br i1 %.not54, label %.loopexit, label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n
  %i.y = call i32 @EVP_MAC_update(ptr noundef nonnull %i.v, ptr noundef nonnull %i.h, i64 noundef %i.i) #6
  %.not55 = icmp eq i32 %i.y, 0
  br i1 %.not55, label %.loopexit, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.z = call i32 @EVP_MAC_update(ptr noundef nonnull %i.v, ptr noundef %4, i64 noundef %5) #6
  %.not56 = icmp eq i32 %i.z, 0
  br i1 %.not56, label %.loopexit, label %bb.r

bb.r:                                             ; preds = %bb.q
  br i1 %.not57, label %bb.t, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.aa = call i32 @EVP_MAC_update(ptr noundef nonnull %i.v, ptr noundef nonnull %i.b, i64 noundef 1) #6
  %.not58 = icmp eq i32 %i.aa, 0
  br i1 %.not58, label %.loopexit, label %bb.t

bb.t:                                             ; preds = %bb.s, %bb.r
  %i.ab = call i32 @EVP_MAC_update(ptr noundef nonnull %i.v, ptr noundef %6, i64 noundef %7) #6
  %.not59 = icmp eq i32 %i.ab, 0
  br i1 %.not59, label %.loopexit, label %bb.u

bb.u:                                             ; preds = %bb.t
  br i1 %.not, label %bb.w, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.ac = call i32 @EVP_MAC_update(ptr noundef nonnull %i.v, ptr noundef nonnull %i.a, i64 noundef 4) #6
  %.not60 = icmp eq i32 %i.ac, 0
  br i1 %.not60, label %.loopexit, label %bb.w

bb.w:                                             ; preds = %bb.v, %bb.u
  %i.ad = call i32 @EVP_MAC_final(ptr noundef nonnull %i.v, ptr noundef nonnull %8, ptr noundef null, i64 noundef %9) #6
  %.not61 = icmp eq i32 %i.ad, 0
  br i1 %.not61, label %.loopexit, label %bb.x

bb.x:                                             ; preds = %bb.w
  %i.ae = sub i64 %13, %.04862
  %i.af = getelementptr inbounds nuw i8, ptr %12, i64 %.04862
  %i.ag = call i64 @llvm.umin.i64(i64 %i.ae, i64 %9)
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.af, ptr nonnull align 1 %8, i64 %i.ag, i1 false)
  %i.ah = add i64 %.04862, %9                     ; 2 uses
  call void @EVP_MAC_CTX_free(ptr noundef nonnull %i.v) #6
  %i.ai = add i32 %.04564, 1
  %i.aj = icmp ult i64 %i.ah, %13
  br i1 %i.aj, label %.peel.next, label %.loopexit, !llvm.loop !38

.loopexit:                                        ; preds = %bb.x, %bb.p, %bb.q, %bb.s, %bb.t, %bb.v, %bb.w, %bb.o, %.peel.next, %bb.m, %bb.l, %bb.k, %bb.i, %bb.h, %bb.f, %bb.e, %bb.d, %.peel.begin
  %.1 = phi ptr [ null, %.peel.begin ], [ %i.j, %bb.d ], [ %i.j, %bb.e ], [ %i.j, %bb.f ], [ %i.j, %bb.h ], [ %i.j, %bb.i ], [ %i.j, %bb.k ], [ %i.j, %bb.l ], [ null, %bb.m ], [ null, %.peel.next ], [ %i.v, %bb.w ], [ %i.v, %bb.v ], [ %i.v, %bb.t ], [ %i.v, %bb.s ], [ %i.v, %bb.q ], [ %i.v, %bb.p ], [ %i.v, %bb.o ], [ null, %bb.x ]
  %.0 = phi i32 [ 0, %.peel.begin ], [ 0, %bb.d ], [ 0, %bb.e ], [ 0, %bb.f ], [ 0, %bb.h ], [ 0, %bb.i ], [ 0, %bb.k ], [ 0, %bb.l ], [ 1, %bb.m ], [ 0, %.peel.next ], [ 0, %bb.w ], [ 0, %bb.v ], [ 0, %bb.t ], [ 0, %bb.s ], [ 0, %bb.q ], [ 0, %bb.p ], [ 0, %bb.o ], [ 1, %bb.x ]
  call void @EVP_MAC_CTX_free(ptr noundef %.1) #6
...
bb.b:                                             ; preds = %bb.a
  call void @OSSL_PARAM_construct_octet_string(ptr dead_on_unwind nonnull writable sret(%struct.ossl_param_st) align 8 %3, ptr noundef nonnull @.str.20, ptr noundef nonnull %1, i64 noundef %2) #6
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.c, ptr noundef nonnull align 8 dereferenceable(40) %4, i64 40, i1 false), !tbaa.struct !30
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #6
  %i.d = call i32 @EVP_MAC_CTX_set_params(ptr noundef nonnull %0, ptr noundef nonnull %3) #6
...
!8 = !{!"Simple C/C++ TBAA"}
!9 = !{!10, !11, i64 0}
!10 = !{!"", !11, i64 0, !6, i64 8, !12, i64 16, !6, i64 24, !13, i64 32, !14, i64 40, !13, i64 48, !14, i64 56, !13, i64 64, !14, i64 72, !13, i64 80, !14, i64 88, !6, i64 96, !6, i64 100, !6, i64 104}
...
!32 = !{!11, !11, i64 0}
!33 = !{!34, !13, i64 0}
!34 = !{!"ossl_param_st", !13, i64 0, !6, i64 8, !11, i64 16, !14, i64 24, !14, i64 32}
!35 = !{!34, !11, i64 16}
!36 = !{!34, !14, i64 24}
!37 = !{!7, !7, i64 0}
