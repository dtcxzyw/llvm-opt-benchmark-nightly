...
begin_hunk_0_@_ZN2v88internal4wasm12NativeModule18AddCodeSpaceLockedENS_4base13AddressRegionE:bb.a
  ...
  %.sroa.096.0.vec.insert = insertelement <2 x i64> poison, i64 %1, i64 0
  %.sroa.096.8.vec.insert = insertelement <2 x i64> %.sroa.096.0.vec.insert, i64 %2, i64 1 ; 4 uses
...
begin_hunk_1_@_ZN2v88internal4wasm12NativeModule18AddCodeSpaceLockedENS_4base13AddressRegionE:bb.a
  ...
  %i.dt = load ptr, ptr %i.k, align 8             ; 7 uses
...
bb.aa:                                            ; preds = %bb.z
  store <2 x i64> %.sroa.096.8.vec.insert, ptr %i.dt, align 8
...
begin_hunk_2_@_ZN2v88internal4wasm12NativeModule18AddCodeSpaceLockedENS_4base13AddressRegionE:bb.a
  ...
  %.sroa.0.sroa.10.0..sroa_idx103 = getelementptr inbounds nuw i8, ptr %i.ej, i64 %i.eb ; 3 uses
  store <2 x i64> %.sroa.096.8.vec.insert, ptr %.sroa.0.sroa.10.0..sroa_idx103, align 8
  %.sroa.10.0..sroa_idx75 = getelementptr inbounds nuw i8, ptr %.sroa.0.sroa.10.0..sroa_idx103, i64 16
  store ptr %.0111, ptr %.sroa.10.0..sroa_idx75, align 8
  %.sroa.12.0..sroa_idx81 = getelementptr inbounds nuw i8, ptr %.sroa.0.sroa.10.0..sroa_idx103, i64 24
...
.critedge:                                        ; preds = %bb.y
  %i.eo = load ptr, ptr %i.k, align 8             ; 7 uses
...
bb.ae:                                            ; preds = %.critedge
  store <2 x i64> %.sroa.096.8.vec.insert, ptr %i.eo, align 8
...
begin_hunk_4_@_ZN2v88internal4wasm12NativeModule18AddCodeSpaceLockedENS_4base13AddressRegionE:bb.a
  ...
  %.sroa.0.sroa.10.0..sroa_idx107 = getelementptr inbounds nuw i8, ptr %i.fe, i64 %i.ew ; 3 uses
  store <2 x i64> %.sroa.096.8.vec.insert, ptr %.sroa.0.sroa.10.0..sroa_idx107, align 8
  %.sroa.10.0..sroa_idx79 = getelementptr inbounds nuw i8, ptr %.sroa.0.sroa.10.0..sroa_idx107, i64 16
  store ptr %.0111, ptr %.sroa.10.0..sroa_idx79, align 8
  %.sroa.12.0..sroa_idx85 = getelementptr inbounds nuw i8, ptr %.sroa.0.sroa.10.0..sroa_idx107, i64 24
