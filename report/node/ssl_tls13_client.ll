...
begin_hunk_0_@mbedtls_ssl_tls13_write_client_hello_exts:bb.a
  ...
  %i.g = icmp ult i32 %i.f, 772
  %4 = select i1 %i.g, i8 4, i8 2                 ; 3 uses
  ...
  %narrow.i = add nuw nsw i8 %4, 5
  %5 = zext nneg i8 %narrow.i to i64              ; 2 uses
  %i.h = icmp ule ptr %1, %2
  %i.i = ptrtoint ptr %2 to i64                   ; 5 uses
  %i.j = ptrtoint ptr %1 to i64                   ; 2 uses
  %i.k = sub i64 %i.i, %i.j
  %6 = icmp uge i64 %i.k, %5
  %narrow.i.not.i = and i1 %i.h, %6
...
begin_hunk_1_@mbedtls_ssl_tls13_write_client_hello_exts:bb.a
  ...
  %i.y = getelementptr inbounds nuw i8, ptr %1, i64 %5 ; 7 uses
