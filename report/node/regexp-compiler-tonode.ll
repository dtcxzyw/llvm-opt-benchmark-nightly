...
begin_hunk_0_@_ZN2v88internal17RegExpDisjunction27RationalizeConsecutiveAtomsEPNS0_14RegExpCompilerE:bb.a
  ...
  %i.rb = getelementptr inbounds nuw i8, ptr %i.qz, i64 8 ; 7 uses
  store <2 x ptr> <ptr getelementptr inbounds nuw inrange(-16, 312) (i8, ptr @_ZTVN2v88internal10RegExpTextE, i64 16), ptr null>, ptr %i.qz, align 8
