...
define hidden i64 @uvwasi__timespec_to_timestamp(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #1 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define hidden zeroext range(i8 0, 8) i8 @uvwasi__stat_to_filetype(ptr nofree noundef readonly captures(none) %0) local_unnamed_addr #1 {
bb.a:
...
define hidden void @uvwasi__stat_to_filestat(ptr nofree noundef readonly captures(none) %0, ptr nofree noundef writeonly captures(none) initializes((0, 17), (24, 64)) %1) local_unnamed_addr #3 {
bb.a:
...
define hidden noundef zeroext i16 @uvwasi__get_filetype_by_fd(i32 noundef %0, ptr nofree noundef captures(none) initializes((0, 1)) %1) local_unnamed_addr #4 {
bb.a:
