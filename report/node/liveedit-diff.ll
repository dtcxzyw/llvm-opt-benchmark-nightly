...
begin_hunk_0_@_ZN2v88internal10Comparator19CalculateDifferenceEPNS1_5InputEPNS1_6OutputE:bb.a
  ...
  %i.du = call noundef zeroext i1 %i.dt(ptr noundef nonnull align 8 dereferenceable(8) %i.dq, i32 noundef %.sroa.0.0.i.i, i32 noundef %.sroa.12.0.i.i) #8, !inline_history !14 ; 2 uses
  br i1 %i.dp, label %.lr.ph.i47.us.preheader.i.i, label %.lr.ph.i47.preheader68.i.i, !prof !12

.lr.ph.i47.preheader68.i.i:                       ; preds = %.lr.ph.i47.preheader.i.i
  br i1 %i.du, label %bb.n, label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12WalkDiagonalERNS2_12ResultWriterENS2_5PointES5_.exit53.i.i

bb.n:                                             ; preds = %.lr.ph.i47.preheader68.i.i
  %i.dv = trunc nuw i8 %.sroa.6.6.i.i to i1
  br i1 %i.dv, label %.loopexit83.i.i, label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.peel.i.i

_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.peel.i.i: ; preds = %bb.n
  %i.dw = add nsw i32 %.sroa.0.0.i.i, 1           ; 2 uses
  %i.dx = add nsw i32 %.sroa.12.0.i.i, 1          ; 2 uses
  %i.dy = icmp slt i32 %i.dw, %.sroa.07.0.copyload.i.i
  %i.dz = icmp slt i32 %i.dx, %.sroa.6.0.copyload.i.i
  %or.cond.i51.peel.i.i = select i1 %i.dy, i1 %i.dz, i1 false
  br i1 %or.cond.i51.peel.i.i, label %.lr.ph.i47.i.i, label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12WalkDiagonalERNS2_12ResultWriterENS2_5PointES5_.exit53.i.i

.lr.ph.i47.us.preheader.i.i:                      ; preds = %.lr.ph.i47.preheader.i.i
  br i1 %i.du, label %bb.o, label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12WalkDiagonalERNS2_12ResultWriterENS2_5PointES5_.exit53.i.i

bb.o:                                             ; preds = %.lr.ph.i47.us.preheader.i.i
  %i.ea = trunc nuw i8 %.sroa.6.6.i.i to i1
  br i1 %i.ea, label %bb.p, label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.peel.i.i

bb.p:                                             ; preds = %bb.o
  %i.eb = sub nsw i32 %.sroa.0.0.i.i, %.sroa.1737.12.extract.trunc41.i.i
  %i.ec = sub nsw i32 %.sroa.12.0.i.i, %.sroa.1737.16.extract.trunc47.i.i
  %i.ed = load ptr, ptr %i.bb, align 8
  %i.ee = load ptr, ptr %i.ed, align 8
  call void %i.ee(ptr noundef nonnull align 8 dereferenceable(8) %i.bb, i32 noundef %.sroa.1737.12.extract.trunc41.i.i, i32 noundef %.sroa.1737.16.extract.trunc47.i.i, i32 noundef %i.eb, i32 noundef %i.ec) #8, !inline_history !15
  br label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.peel.i.i

_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.peel.i.i: ; preds = %bb.p, %bb.o
  %i.ef = add nsw i32 %.sroa.0.0.i.i, 1           ; 2 uses
  %i.eg = add nsw i32 %.sroa.12.0.i.i, 1          ; 2 uses
  %i.eh = icmp slt i32 %i.ef, %.sroa.07.0.copyload.i.i
  %i.ei = icmp slt i32 %i.eg, %.sroa.6.0.copyload.i.i
  %or.cond.i51.us.peel.i.i = select i1 %i.eh, i1 %i.ei, i1 false
  br i1 %or.cond.i51.us.peel.i.i, label %.lr.ph.i47.us.i.i, label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12WalkDiagonalERNS2_12ResultWriterENS2_5PointES5_.exit53.i.i

.lr.ph.i47.us.i.i:                                ; preds = %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.peel.i.i, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.i.i
  %.sroa.0.012.i48.us.i.i = phi i32 [ %i.eo, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.i.i ], [ %i.ef, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.peel.i.i ] ; 2 uses
  %.sroa.6.011.i49.us.i.i = phi i32 [ %i.ep, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.i.i ], [ %i.eg, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.peel.i.i ] ; 2 uses
  %i.ej = load ptr, ptr %2, align 8               ; 2 uses
  %i.ek = load ptr, ptr %i.ej, align 8
  %i.el = getelementptr inbounds nuw i8, ptr %i.ek, i64 16
  %i.em = load ptr, ptr %i.el, align 8
  %i.en = call noundef zeroext i1 %i.em(ptr noundef nonnull align 8 dereferenceable(8) %i.ej, i32 noundef %.sroa.0.012.i48.us.i.i, i32 noundef %.sroa.6.011.i49.us.i.i) #8, !inline_history !16
  br i1 %i.en, label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.i.i, label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12WalkDiagonalERNS2_12ResultWriterENS2_5PointES5_.exit53.i.i

_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.i.i: ; preds = %.lr.ph.i47.us.i.i
  %i.eo = add nsw i32 %.sroa.0.012.i48.us.i.i, 1  ; 2 uses
  %i.ep = add nsw i32 %.sroa.6.011.i49.us.i.i, 1  ; 2 uses
  %i.eq = icmp slt i32 %i.eo, %.sroa.07.0.copyload.i.i
  %i.er = icmp slt i32 %i.ep, %.sroa.6.0.copyload.i.i
  %or.cond.i51.us.i.i = select i1 %i.eq, i1 %i.er, i1 false
  br i1 %or.cond.i51.us.i.i, label %.lr.ph.i47.us.i.i, label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12WalkDiagonalERNS2_12ResultWriterENS2_5PointES5_.exit53.i.i, !llvm.loop !21

.lr.ph.i47.i.i:                                   ; preds = %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.peel.i.i, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.i.i
  %.sroa.0.012.i48.i.i = phi i32 [ %i.ex, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.i.i ], [ %i.dw, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.peel.i.i ] ; 2 uses
  %.sroa.6.011.i49.i.i = phi i32 [ %i.ey, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.i.i ], [ %i.dx, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.peel.i.i ] ; 2 uses
  %i.es = load ptr, ptr %2, align 8               ; 2 uses
  %i.et = load ptr, ptr %i.es, align 8
  %i.eu = getelementptr inbounds nuw i8, ptr %i.et, i64 16
  %i.ev = load ptr, ptr %i.eu, align 8
  %i.ew = call noundef zeroext i1 %i.ev(ptr noundef nonnull align 8 dereferenceable(8) %i.es, i32 noundef %.sroa.0.012.i48.i.i, i32 noundef %.sroa.6.011.i49.i.i) #8, !inline_history !16
  br i1 %i.ew, label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.i.i, label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12WalkDiagonalERNS2_12ResultWriterENS2_5PointES5_.exit53.i.i

.loopexit83.i.i:                                  ; preds = %bb.n
  call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.3, ptr noundef nonnull @.str.4) #9
  unreachable

_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.i.i: ; preds = %.lr.ph.i47.i.i
  %i.ex = add nsw i32 %.sroa.0.012.i48.i.i, 1     ; 2 uses
  %i.ey = add nsw i32 %.sroa.6.011.i49.i.i, 1     ; 2 uses
  %i.ez = icmp slt i32 %i.ex, %.sroa.07.0.copyload.i.i
  %i.fa = icmp slt i32 %i.ey, %.sroa.6.0.copyload.i.i
  %or.cond.i51.i.i = select i1 %i.ez, i1 %i.fa, i1 false
  br i1 %or.cond.i51.i.i, label %.lr.ph.i47.i.i, label %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12WalkDiagonalERNS2_12ResultWriterENS2_5PointES5_.exit53.i.i, !llvm.loop !22

_ZN2v88internal12_GLOBAL__N_111MyersDiffer12WalkDiagonalERNS2_12ResultWriterENS2_5PointES5_.exit53.i.i: ; preds = %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.i.i, %.lr.ph.i47.i.i, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.i.i, %.lr.ph.i47.us.i.i, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.peel.i.i, %.lr.ph.i47.us.preheader.i.i, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.peel.i.i, %.lr.ph.i47.preheader68.i.i, %bb.m
  %.sroa.6.9.i.i = phi i8 [ %.sroa.6.6.i.i, %bb.m ], [ 0, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.peel.i.i ], [ %.sroa.6.6.i.i, %.lr.ph.i47.us.preheader.i.i ], [ 0, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.peel.i.i ], [ 0, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.us.i.i ], [ %.sroa.6.6.i.i, %.lr.ph.i47.preheader68.i.i ], [ 0, %.lr.ph.i47.us.i.i ], [ 0, %.lr.ph.i47.i.i ], [ 0, %_ZN2v88internal12_GLOBAL__N_111MyersDiffer12ResultWriter20RecordNoModificationERKNS2_5PointE.exit.i50.i.i ] ; 2 uses
  %i.fb = add nuw i64 %.065.i.i, 1                ; 2 uses
  %exitcond.not.i.i = icmp eq i64 %i.fb, %i.bf
...
bb.q:                                             ; preds = %_ZN2v88internal12_GLOBAL__N_111MyersDiffer11WriteResultERKNS2_4PathE.exit.thread.i
  ...
  %.val1.i.i.i.i.i = load ptr, ptr %i.fc, align 8
  %i.fd = ptrtoint ptr %.val1.i.i.i.i.i to i64
  %i.fe = sub i64 %i.fd, %i.bd
  call void @_ZdlPvm(ptr noundef nonnull %.val2.i, i64 noundef %i.fe) #11
...
bb.r:                                             ; preds = %_ZNSt14_Optional_baseIN2v88internal12_GLOBAL__N_111MyersDiffer4PathELb0ELb0EED2Ev.exit.i
  %i.ff = getelementptr inbounds nuw i8, ptr %2, i64 56
  %.val3.i.i = load ptr, ptr %i.ff, align 8
  %i.fg = ptrtoint ptr %.val3.i.i to i64
  %i.fh = ptrtoint ptr %.val2.i.i to i64
  %i.fi = sub i64 %i.fg, %i.fh
  call void @_ZdlPvm(ptr noundef nonnull %.val2.i.i, i64 noundef %i.fi) #11
...
bb.s:                                             ; preds = %_ZN2v88internal12_GLOBAL__N_111MyersDiffer16FurthestReachingD2Ev.exit.i.i
  ...
  %.val1.i.i = load ptr, ptr %i.fj, align 8
  %i.fk = ptrtoint ptr %.val1.i.i to i64
  %i.fl = ptrtoint ptr %.val.i.i to i64
  %i.fm = sub i64 %i.fk, %i.fl
  call void @_ZdlPvm(ptr noundef nonnull %.val.i.i, i64 noundef %i.fm) #11
