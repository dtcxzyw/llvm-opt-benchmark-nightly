...
bb.f:                                             ; preds = %bb.d, %bb.e, %bb.c, %bb.b
  %.310 = phi i1 [ %.0730, %bb.b ], [ %.0730, %bb.d ], [ %i.v, %bb.e ], [ %.0730, %bb.c ] ; 2 uses
  %.3 = phi i8 [ %.031, %bb.b ], [ %.031, %bb.d ], [ %6, %bb.e ], [ %.031, %bb.c ] ; 2 uses
  %i.w = load ptr, ptr %i.a, align 8              ; 2 uses
  %i.x = load i8, ptr %i.w, align 1
  %i.y = load i8, ptr %i.e, align 8
  %i.z = lshr i8 %i.y, 1
  %i.aa = zext nneg i8 %i.z to i64
  %i.ab = getelementptr inbounds nuw [212 x i8], ptr @_ZN2v88internal11interpreter9Bytecodes14kBytecodeSizesE, i64 %i.aa
  %i.ac = zext i8 %i.x to i64
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ab, i64 %i.ac
  %i.ae = load i8, ptr %i.ad, align 1
  %i.af = zext i8 %i.ae to i64
  %i.ag = getelementptr inbounds nuw i8, ptr %i.w, i64 %i.af ; 6 uses
  store ptr %i.ag, ptr %i.a, align 8
  %i.ah = load ptr, ptr %i.b, align 8             ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %switch.selectcmp.i.i.i = icmp ult i8 %i.ai, 4
  br i1 %switch.selectcmp.i.i.i, label %switch.lookup, label %bb.h

switch.lookup:                                    ; preds = %bb.g
  %i.aj = shl nuw nsw i8 %i.ai, 3
  %switch.shiftamt = zext nneg i8 %i.aj to i32
...
.sink.split.i.i:                                  ; preds = %bb.h, %switch.lookup
  %i.al = phi ptr [ %i.ak, %switch.lookup ], [ %i.ag, %bb.h ]
...
_ZN2v88internal11interpreter21BytecodeArrayIterator7AdvanceEv.exit: ; preds = %bb.f, %.sink.split.i.i
  %i.am = phi ptr [ %i.ag, %bb.f ], [ %i.al, %.sink.split.i.i ] ; 2 uses
  %.not23 = icmp ult ptr %i.am, %i.ah
...
._crit_edge.thread:                               ; preds = %bb.a, %._crit_edge
  ...
  %i.ap = add i64 %i.ao, 20
  %i.aq = inttoptr i64 %i.ap to ptr               ; 2 uses
  %i.ar = load i8, ptr %i.aq, align 1             ; 2 uses
  %i.as = and i8 %i.ar, 8
  %.not25 = icmp eq i8 %i.as, 0
  br i1 %.not25, label %bb.k, label %bb.i

bb.i:                                             ; preds = %._crit_edge.thread
  %i.at = load i8, ptr getelementptr inbounds nuw (i8, ptr @_ZN2v88internal8v8_flagsE, i64 612), align 4, !range !7, !noundef !8
  %i.au = trunc nuw i8 %i.at to i1
  br i1 %i.au, label %_ZN2v88internal14FeedbackVector32set_maybe_has_optimized_osr_codeEbNS0_8CodeKindE.exit, label %bb.j, !prof !6
...
_ZN2v88internal14FeedbackVector32set_maybe_has_optimized_osr_codeEbNS0_8CodeKindE.exit: ; preds = %bb.i
  %i.av = and i8 %i.ar, -9
  store i8 %i.av, ptr %i.aq, align 1
  br i1 %.0.lcssa40, label %bb.n, label %bb.l

bb.k:                                             ; preds = %._crit_edge.thread, %._crit_edge
  %.0.lcssa41 = phi i1 [ %i.an, %._crit_edge ], [ %.0.lcssa40, %._crit_edge.thread ]
