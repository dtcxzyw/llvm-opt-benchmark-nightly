...
.lr.ph.i.i:                                       ; preds = %bb.eg, %.outer68.i.i
  %.0.ph152.i.i = phi i1 [ %.0105.us.i.i, %.outer68.i.i ], [ true, %bb.eg ]
...
.split102.us109.i.i:                              ; preds = %bb.ei, %bb.ek
  %i.rv = phi i32 [ %i.ry, %bb.ek ], [ %i.rt, %bb.ei ]
...
bb.en:                                            ; preds = %bb.eo, %bb.em
  ...
  br i1 %i.sj, label %bb.eo, label %.critedge57.i.i

bb.eo:                                            ; preds = %bb.en
  %i.sk = load i32, ptr %i.g, align 4
  %i.sl = icmp eq i32 %i.sk, 4
  br i1 %i.sl, label %bb.en, label %.critedge6.i.i, !llvm.loop !20
...
bb.es:                                            ; preds = %bb.er, %bb.er, %bb.er, %bb.er, %bb.eq
...
uv__fs_stat.exit:                                 ; preds = %uv__fs_statx.exit.i115, %bb.eu, %bb.ev
  %.0.i114 = phi i32 [ %i.st, %uv__fs_statx.exit.i115 ], [ 0, %bb.ev ], [ %i.sv, %bb.eu ]
...
bb.ew:                                            ; preds = %bb.b
  ...
  br i1 %.not.i116, label %bb.ex, label %uv__fs_statfs.exit

bb.ex:                                            ; preds = %bb.ew
  %i.to = call ptr @uv__malloc(i64 noundef 88) #15 ; 9 uses
  %i.tp = icmp eq ptr %i.to, null
  br i1 %i.tp, label %bb.ey, label %bb.ez
