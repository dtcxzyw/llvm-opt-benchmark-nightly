...
_ZN12_GLOBAL__N_111LargestGaps8truncateEi.exit:   ; preds = %bb.p, %bb.q
  %i.ce = phi i32 [ %.val, %bb.p ], [ %i.cd, %bb.q ] ; 5 uses
...
.lr.ph89.split:                                   ; preds = %.lr.ph89
  ...
  %6 = insertelement <2 x i32> poison, i32 %i.ce, i64 0
  %7 = shufflevector <2 x i32> %6, <2 x i32> poison, <2 x i32> zeroinitializer
  %8 = insertelement <2 x i32> <i32 -1, i32 poison>, i32 %i.dm, i64 1
...
begin_hunk_2_@uprv_makeDenseRanges:bb.a
  ...
  store <2 x i32> %9, ptr %i.dt, align 4
