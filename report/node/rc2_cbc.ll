...
bb.b:                                             ; preds = %bb.e, %bb.a
  %.070 = phi ptr [ %i.l, %bb.a ], [ %12, %bb.e ] ; 5 uses
  ...
  %i.r = and i32 %.064, %.066
  %2 = or i32 %i.q, %i.r
  %3 = getelementptr inbounds i8, ptr %.070, i64 -4
  %4 = load i32, ptr %.070, align 4, !tbaa !5
  %i.s = add i32 %2, %4
  ...
  %5 = or i32 %i.z, %i.aa
  %6 = getelementptr inbounds i8, ptr %.070, i64 -8
  ...
  %8 = or i32 %i.ai, %i.aj
  %9 = getelementptr inbounds i8, ptr %.070, i64 -12
  ...
  %11 = or i32 %i.aq, %i.ar
  %12 = getelementptr inbounds i8, ptr %.070, i64 -16
