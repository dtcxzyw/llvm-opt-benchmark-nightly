...
bb.b:                                             ; preds = %bb.a
  ...
  %i.au = fmul double %i.al, 4.000000e+00
  %2 = getelementptr inbounds nuw i8, ptr %0, i64 48 ; 2 uses
  %i.av = load double, ptr %2, align 8
  %3 = sitofp i64 %i.w to double                  ; 4 uses
  %4 = insertelement <2 x double> poison, double %i.al, i64 0 ; 2 uses
  %5 = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> zeroinitializer
  %6 = insertelement <2 x double> %4, double 3.000000e+00, i64 1
  %7 = fmul <2 x double> %5, %6                   ; 4 uses
  %8 = extractelement <2 x double> %7, i64 0      ; 2 uses
  %9 = fmul double %i.al, %8
  %foldExtExtBinop = fmul <2 x double> %7, %7
  %10 = extractelement <2 x double> %foldExtExtBinop, i64 0
  %11 = load double, ptr %i.ar, align 8           ; 2 uses
  %12 = load double, ptr %i.ap, align 8           ; 2 uses
  %13 = fmul double %9, %3
  %14 = extractelement <2 x double> %i.ag, i64 1  ; 2 uses
  %i.aw = insertelement <2 x double> poison, double %3, i64 0
  %15 = shufflevector <2 x double> %i.ag, <2 x double> poison, <2 x i32> zeroinitializer
  %16 = fmul double %10, %3
  %17 = fmul double %8, 6.000000e+00
  %18 = uitofp nneg i64 %i.x to double            ; 2 uses
  %19 = sitofp i64 %i.a to double                 ; 3 uses
  %20 = tail call double @llvm.fmuladd.f64(double %19, double %i.ak, double %i.an)
  %i.ax = fmul double %i.ao, %20
  store double %i.ax, ptr %i.aj, align 8
  %21 = load i64, ptr %1, align 8                 ; 2 uses
  %22 = sub nsw i64 %i.a, %21
  %23 = sitofp i64 %22 to double
  %24 = sitofp i64 %21 to double
  %25 = fneg double %24                           ; 2 uses
  %26 = load double, ptr %i.at, align 8
  %27 = load double, ptr %i.as, align 8           ; 2 uses
  %28 = load double, ptr %i.aq, align 8           ; 2 uses
  %29 = fadd double %11, %27
  %30 = fadd double %12, %28
  %i.ay = fmul double %13, %23
  %31 = tail call double @llvm.fmuladd.f64(double %i.ay, double %14, double %29)
  %32 = insertelement <2 x double> poison, double %12, i64 0
  %33 = shufflevector <2 x double> %32, <2 x double> poison, <2 x i32> zeroinitializer
  %i.az = insertelement <2 x double> poison, double %25, i64 0
  %i.ba = insertelement <2 x double> %i.az, double %i.z, i64 1
  %34 = fmul <2 x double> %33, %i.ba
  %i.bb = insertelement <2 x double> poison, double %19, i64 0
  %35 = insertelement <2 x double> %i.bb, double %18, i64 1
  %36 = insertelement <2 x double> poison, double %28, i64 0
  %37 = shufflevector <2 x double> %36, <2 x double> poison, <2 x i32> zeroinitializer
  %38 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %35, <2 x double> %37, <2 x double> %34) ; 2 uses
  %i.bc = shufflevector <2 x double> %i.aw, <2 x double> %38, <2 x i32> <i32 0, i32 2>
  %i.bd = fmul <2 x double> %7, %i.bc
  %39 = insertelement <2 x double> poison, double %30, i64 0
  %i.be = insertelement <2 x double> %39, double %31, i64 1
  %i.bf = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bd, <2 x double> %15, <2 x double> %i.be)
  %40 = fsub nnan double %18, %3
  %41 = fadd nnan double %40, %i.z
  %i.bg = fmul double %41, %16
  %i.bh = fdiv double %i.bg, %i.ad
  %i.bi = fadd double %i.bh, %26
  %42 = extractelement <2 x double> %38, i64 1
  %i.bj = fmul double %17, %42
  %43 = tail call double @llvm.fmuladd.f64(double %i.bj, double %14, double %i.bi)
  %i.bk = fmul double %11, %25
  %i.bl = tail call double @llvm.fmuladd.f64(double %19, double %27, double %i.bk)
  %44 = fmul double %i.au, %i.bl
  %i.bm = tail call double @llvm.fmuladd.f64(double %44, double %i.ao, double %43)
  %i.bn = fadd double %i.av, %i.bm
