...
declare i32 @ubidi_getParagraph_78(ptr noundef, i32 noundef, ptr noundef, ptr noundef, ptr noundef, ptr noundef) local_unnamed_addr #2

declare zeroext i8 @ubidi_getParaLevelAtIndex_78(ptr noundef, i32 noundef) local_unnamed_addr #2

; Function Attrs: nocallback nofree nosync nounwind willreturn memory(argmem: readwrite)
declare void @llvm.lifetime.end.p0(ptr captures(none)) #1

; Function Attrs: mustprogress nofree norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable
define internal fastcc void @_ZL18setTrailingWSStartP5UBiDi(ptr nofree noundef nonnull captures(none) %0) unnamed_addr #3 {
bb.a:
...
declare signext i8 @ubidi_getMemory_78(ptr noundef, ptr noundef, i8 noundef signext, i32 noundef) local_unnamed_addr #2
...
bb.a:
  %2 = alloca %struct.Run, align 4                ; 6 uses
...
.lr.ph81.us.i:                                    ; preds = %.critedge2.us.i, %.lr.ph81.us.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %2, ptr noundef nonnull align 4 dereferenceable(12) %i.dn, i64 12, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %i.do, ptr noundef nonnull align 4 dereferenceable(12) %2, i64 12, i1 false)
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.preheader.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %2, ptr noundef nonnull align 4 dereferenceable(12) %i.ea, i64 12, i1 false)
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %i.eb, ptr noundef nonnull align 4 dereferenceable(12) %2, i64 12, i1 false)
...
bb.x:                                             ; preds = %switch.early.test
  %i.iu = add nsw i32 %.2125176, 1
  %i.iv = sext i32 %.2125176 to i64
  %i.iw = getelementptr inbounds [4 x i8], ptr %1, i64 %i.iv
  %i.ix = trunc nuw nsw i64 %i.io to i32
...
.lr.ph178.split.1:                                ; preds = %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %.lr.ph178.split, %bb.x
  %.3126 = phi i32 [ %.2125176, %switch.early.test ], [ %i.iu, %bb.x ], [ %.2125176, %.lr.ph178.split ], [ %.2125176, %switch.early.test ], [ %.2125176, %switch.early.test ], [ %.2125176, %switch.early.test ], [ %.2125176, %switch.early.test ], [ %.2125176, %switch.early.test ], [ %.2125176, %switch.early.test ], [ %.2125176, %switch.early.test ], [ %.2125176, %switch.early.test ] ; 12 uses
  %indvars.iv.next = or disjoint i64 %indvars.iv, 1
  %i.iy = add nuw nsw i64 %indvars.iv.next, %i.ia ; 2 uses
  %i.iz = load ptr, ptr %i.gd, align 8
  %i.ja = getelementptr inbounds nuw [2 x i8], ptr %i.iz, i64 %i.iy
  %i.jb = load i16, ptr %i.ja, align 2
  %.fr161.1 = freeze i16 %i.jb                    ; 2 uses
  %i.jc = and i16 %.fr161.1, -4
  %i.jd = icmp eq i16 %i.jc, 8204
  br i1 %i.jd, label %bb.z, label %switch.early.test.1
...
bb.y:                                             ; preds = %switch.early.test.1
  %i.je = add nsw i32 %.3126, 1
  %i.jf = sext i32 %.3126 to i64
  %i.jg = getelementptr inbounds [4 x i8], ptr %1, i64 %i.jf
  %i.jh = trunc nuw nsw i64 %i.iy to i32
  store i32 %i.jh, ptr %i.jg, align 4
  br label %bb.z
...
bb.z:                                             ; preds = %bb.y, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %switch.early.test.1, %.lr.ph178.split.1
  %.3126.1 = phi i32 [ %.3126, %switch.early.test.1 ], [ %i.je, %bb.y ], [ %.3126, %.lr.ph178.split.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ], [ %.3126, %switch.early.test.1 ] ; 3 uses
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %.loopexit162.loopexit352.unr-lcssa, label %.lr.ph178.split, !llvm.loop !78

.loopexit162.loopexit:                            ; preds = %.lr.ph181.prol.loopexit, %.lr.ph181, %middle.block312
  %indvars.iv.next230.lcssa = phi i64 [ %i.gt, %middle.block312 ], [ %indvars.iv.next230.lcssa354.unr, %.lr.ph181.prol.loopexit ], [ %indvars.iv.next230.3, %.lr.ph181 ]
  %i.ji = trunc nsw i64 %indvars.iv.next230.lcssa to i32
  br label %.loopexit162

.loopexit162.loopexit352.unr-lcssa:               ; preds = %bb.z
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.loopexit162, label %.lr.ph178.split.epil.preheader

.lr.ph178.split.epil.preheader:                   ; preds = %.loopexit162.loopexit352.unr-lcssa, %.lr.ph178.split.preheader
  %indvars.iv.epil.init = phi i64 [ 0, %.lr.ph178.split.preheader ], [ %indvars.iv.next.1, %.loopexit162.loopexit352.unr-lcssa ]
  %.2125176.epil.init = phi i32 [ %.0123184, %.lr.ph178.split.preheader ], [ %.3126.1, %.loopexit162.loopexit352.unr-lcssa ] ; 12 uses
  %lcmp.mod360 = trunc i32 %i.gh to i1
  tail call void @llvm.assume(i1 %lcmp.mod360)
  %i.jj = add nuw nsw i64 %indvars.iv.epil.init, %i.ia ; 2 uses
  %i.jk = load ptr, ptr %i.gd, align 8
  %i.jl = getelementptr inbounds nuw [2 x i8], ptr %i.jk, i64 %i.jj
  %i.jm = load i16, ptr %i.jl, align 2
  %.fr161.epil = freeze i16 %i.jm                 ; 2 uses
  %i.jn = and i16 %.fr161.epil, -4
  %i.jo = icmp eq i16 %i.jn, 8204
  br i1 %i.jo, label %.loopexit162, label %switch.early.test.epil
...
bb.aa:                                            ; preds = %switch.early.test.epil
  %i.jp = add nsw i32 %.2125176.epil.init, 1
  %i.jq = sext i32 %.2125176.epil.init to i64
  %i.jr = getelementptr inbounds [4 x i8], ptr %1, i64 %i.jq
  %i.js = trunc nuw nsw i64 %i.jj to i32
  store i32 %i.js, ptr %i.jr, align 4
  br label %.loopexit162

.loopexit162:                                     ; preds = %.loopexit162.loopexit352.unr-lcssa, %bb.aa, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %switch.early.test.epil, %.lr.ph178.split.epil.preheader, %bb.w, %bb.s, %.loopexit162.loopexit, %bb.u, %.preheader
  %.4127 = phi i32 [ %.3126.us, %bb.w ], [ %i.gg, %bb.s ], [ %.0123184, %.preheader ], [ %.0123184, %bb.u ], [ %i.ji, %.loopexit162.loopexit ], [ %.3126.1, %.loopexit162.loopexit352.unr-lcssa ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %i.jp, %bb.aa ], [ %.2125176.epil.init, %.lr.ph178.split.epil.preheader ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ], [ %.2125176.epil.init, %switch.early.test.epil ]
