...
vector.body141:                                   ; preds = %vector.body141, %vector.ph138
  ...
  %i.ev = add nuw i64 %.0.i.lcssa74, %index142    ; 2 uses
...
vec.epilog.vector.body158:                        ; preds = %vec.epilog.vector.body158, %vec.epilog.ph155
  ...
  %i.fe = add nuw i64 %.0.i.lcssa74, %index159    ; 2 uses
...
mbedtls_xor.exit41:                               ; preds = %bb.f
  ...
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 400 ; 16 uses
...
.preheader:                                       ; preds = %.lr.ph50, %middle.block, %mbedtls_xor.exit41
  %.0.i.lcssa = phi i64 [ 0, %mbedtls_xor.exit41 ], [ %i.z, %middle.block ], [ %i.bj, %.lr.ph50 ] ; 12 uses
...
vector.body73:                                    ; preds = %vector.main.loop.iter.check, %vector.body73
  ...
  %i.an = add nuw i64 %.0.i.lcssa, %index74       ; 2 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check
  %n.vec84 = and i64 %i.ak, 24                    ; 4 uses
  %i.au = add i64 %.0.i.lcssa, %n.vec84
  %6 = getelementptr inbounds nuw i8, ptr %4, i64 %.0.i.lcssa ; 2 uses
  %wide.load86 = load <8 x i8>, ptr %6, align 1, !tbaa !16, !alias.scope !83, !noalias !86
  %7 = getelementptr inbounds nuw i8, ptr %i.q, i64 %.0.i.lcssa
  %wide.load87 = load <8 x i8>, ptr %7, align 1, !tbaa !16, !alias.scope !86
  %8 = xor <8 x i8> %wide.load87, %wide.load86
  store <8 x i8> %8, ptr %6, align 1, !tbaa !16, !alias.scope !83, !noalias !86
  %9 = icmp eq i64 %n.vec84, 8
  br i1 %9, label %vec.epilog.middle.block, label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.ph
  %i.av = add nuw i64 %.0.i.lcssa, 8              ; 2 uses
  ...
  %i.az = icmp eq i64 %n.vec84, 16
  br i1 %i.az, label %vec.epilog.middle.block, label %vec.epilog.vector.body.2

vec.epilog.vector.body.2:                         ; preds = %vec.epilog.vector.body
  %10 = add nuw i64 %.0.i.lcssa, 16               ; 2 uses
  %11 = getelementptr inbounds nuw i8, ptr %4, i64 %10 ; 2 uses
  %wide.load86.2 = load <8 x i8>, ptr %11, align 1, !tbaa !16, !alias.scope !83, !noalias !86
  %12 = getelementptr inbounds nuw i8, ptr %i.q, i64 %10
  %wide.load87.2 = load <8 x i8>, ptr %12, align 1, !tbaa !16, !alias.scope !86
  %13 = xor <8 x i8> %wide.load87.2, %wide.load86.2
  store <8 x i8> %13, ptr %11, align 1, !tbaa !16, !alias.scope !83, !noalias !86
...
bb.g:                                             ; preds = %._crit_edge
  ...
  br i1 %.not162, label %bb.h, label %.thread248
...
mbedtls_gcm_crypt_and_tag.exit219:                ; preds = %bb.r
  ...
  br i1 %.not169, label %bb.s, label %.thread248

bb.s:                                             ; preds = %mbedtls_gcm_crypt_and_tag.exit219
  %bcmp170 = call i32 @bcmp(ptr nonnull %i.c, ptr nonnull %i.al, i64 %i.v)
  %.not171 = icmp eq i32 %bcmp170, 0
  br i1 %.not171, label %bb.t, label %.thread248
...
bb.t:                                             ; preds = %bb.s
  ...
  br i1 %.not173, label %bb.u, label %.thread248
...
bb.w:                                             ; preds = %.critedge209, %bb.v
  ...
  br i1 %.not175, label %bb.x, label %.thread248
...
bb.x:                                             ; preds = %bb.w
  ...
  br i1 %.not176, label %bb.y, label %.thread248
...
bb.y:                                             ; preds = %bb.x
  ...
  br i1 %.not177, label %bb.z, label %.thread248
...
bb.aa:                                            ; preds = %bb.z
  ...
  br i1 %.not180, label %bb.ab, label %.thread248

bb.ab:                                            ; preds = %bb.aa
  %i.bq = load i64, ptr %i.e, align 8, !tbaa !8
  %.not181 = icmp eq i64 %i.bq, 32
  br i1 %.not181, label %bb.ac, label %.thread243
...
bb.ac:                                            ; preds = %bb.ab
  ...
  br i1 %.not182, label %bb.ad, label %.thread248

bb.ad:                                            ; preds = %bb.ac
  %i.bt = load i64, ptr %i.e, align 8, !tbaa !8
  %.not183 = icmp eq i64 %i.bt, %i.bo
  br i1 %.not183, label %bb.ag, label %.thread243
...
bb.ae:                                            ; preds = %bb.z
  ...
  br i1 %.not178, label %bb.af, label %.thread248

bb.af:                                            ; preds = %bb.ae
  %i.bv = load i64, ptr %i.e, align 8, !tbaa !8
  %.not179 = icmp eq i64 %i.bv, %i.v
  br i1 %.not179, label %bb.ag, label %.thread243
...
bb.ai:                                            ; preds = %bb.ah
  ...
  br i1 %.not188, label %bb.aj, label %.thread248
...
bb.al:                                            ; preds = %.critedge212, %bb.ak
  ...
  br i1 %.not190, label %bb.am, label %.thread248
...
bb.am:                                            ; preds = %bb.al
  ...
  br i1 %.not191, label %bb.an, label %.thread248
...
bb.an:                                            ; preds = %bb.am
  ...
  br i1 %.not192, label %bb.ao, label %.thread248
...
bb.ap:                                            ; preds = %bb.ao
  ...
  br i1 %.not195, label %bb.aq, label %.thread248

bb.aq:                                            ; preds = %bb.ap
  %i.ci = load i64, ptr %i.e, align 8, !tbaa !8
  %.not196 = icmp eq i64 %i.ci, 32
  br i1 %.not196, label %bb.ar, label %.thread243
...
bb.ar:                                            ; preds = %bb.aq
  ...
  br i1 %.not197, label %bb.as, label %.thread248

bb.as:                                            ; preds = %bb.ar
  %i.cl = load i64, ptr %i.e, align 8, !tbaa !8
  %.not198 = icmp eq i64 %i.cl, %i.cg
  br i1 %.not198, label %bb.av, label %.thread243
...
bb.at:                                            ; preds = %bb.ao
  ...
  br i1 %.not193, label %bb.au, label %.thread248

bb.au:                                            ; preds = %bb.at
  %i.cn = load i64, ptr %i.e, align 8, !tbaa !8
  %.not194 = icmp eq i64 %i.cn, %i.v
  br i1 %.not194, label %bb.av, label %.thread243
...
bb.ax:                                            ; preds = %bb.aw
  ...
  br i1 %.not203, label %bb.ay, label %.thread248
...
bb.ba:                                            ; preds = %bb.ay, %bb.az
  ...
  br i1 %exitcond.not, label %.thread238, label %bb.d, !llvm.loop !92

.thread238:                                       ; preds = %bb.ba, %bb.f
  %indvars.iv.next262 = add nuw nsw i64 %indvars.iv261, 1 ; 2 uses
  %exitcond264.not = icmp eq i64 %indvars.iv.next262, 3
  br i1 %exitcond264.not, label %bb.bb, label %bb.c, !llvm.loop !93

bb.bb:                                            ; preds = %.thread238
  br i1 %.not, label %.thread243, label %bb.bc

bb.bc:                                            ; preds = %bb.bb
  %putchar = call i32 @putchar(i32 10)            ; 0 uses
  br label %.thread243

.thread248:                                       ; preds = %bb.ar, %bb.ap, %bb.aa, %bb.ac, %bb.aw, %bb.ae, %bb.g, %mbedtls_gcm_crypt_and_tag.exit, %bb.k, %bb.o, %mbedtls_gcm_crypt_and_tag.exit219, %bb.s, %bb.w, %bb.x, %bb.ag, %bb.ah, %bb.al, %bb.am, %bb.av, %bb.an, %bb.at, %bb.y, %bb.l, %bb.t, %bb.ai, %bb.ax, %mbedtls_gcm_crypt_and_tag.exit.thread, %mbedtls_gcm_crypt_and_tag.exit219.thread
  %.5.ph251 = phi i32 [ %.0.i216.ph, %mbedtls_gcm_crypt_and_tag.exit219.thread ], [ %.0.i.ph, %mbedtls_gcm_crypt_and_tag.exit.thread ], [ %i.bs, %bb.ac ], [ %i.bp, %bb.aa ], [ %i.ch, %bb.ap ], [ %i.ck, %bb.ar ], [ 1, %bb.ax ], [ 1, %bb.ai ], [ 1, %bb.t ], [ 1, %bb.l ], [ %i.bm, %bb.y ], [ %i.cm, %bb.at ], [ %i.cf, %bb.an ], [ %i.co, %bb.av ], [ %i.ce, %bb.am ], [ %i.cd, %bb.al ], [ 1, %bb.ah ], [ %i.bw, %bb.ag ], [ %i.bl, %bb.x ], [ %i.bk, %bb.w ], [ 1, %bb.s ], [ %i.bd, %mbedtls_gcm_crypt_and_tag.exit219 ], [ %i.az, %bb.o ], [ 1, %bb.k ], [ %i.ap, %mbedtls_gcm_crypt_and_tag.exit ], [ %i.s, %bb.g ], [ %i.bu, %bb.ae ], [ 1, %bb.aw ]
  br i1 %.not, label %bb.be, label %bb.bd

bb.bd:                                            ; preds = %.thread248
  %puts207 = call i32 @puts(ptr nonnull dereferenceable(1) @str.7) ; 0 uses
  br label %bb.be

bb.be:                                            ; preds = %bb.bd, %.thread248
  call void @mbedtls_cipher_free(ptr noundef nonnull %1) #9
  call void @mbedtls_platform_zeroize(ptr noundef nonnull %1, i64 noundef 424) #9
  br label %.thread243

.thread243:                                       ; preds = %bb.as, %bb.ad, %bb.ab, %bb.aq, %bb.af, %bb.au, %bb.bb, %bb.bc, %bb.be
  %.6246 = phi i32 [ 0, %bb.bb ], [ 0, %bb.bc ], [ %.5.ph251, %bb.be ], [ 0, %bb.au ], [ 0, %bb.af ], [ 0, %bb.aq ], [ 0, %bb.ab ], [ 0, %bb.ad ], [ 0, %bb.as ]
