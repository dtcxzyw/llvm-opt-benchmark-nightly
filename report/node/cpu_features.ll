...
bb.a:
  %i.a = tail call { i32, i32, i32, i32 } asm "  xchg$(q$|$)  $(%$|$)rbx,${1:q}\0A  cpuid\0A  xchg$(q$|$)  $(%$|$)rbx,${1:q}", "={ax},=r,={cx},={dx},0,~{dirflag},~{fpsr},~{flags}"(i32 1) #4, !srcloc !10 ; 2 uses
  ...
  store i32 %i.d, ptr @x86_cpu_enable_sse2, align 4, !tbaa !11
  store i32 %i.e, ptr @x86_cpu_enable_ssse3, align 4, !tbaa !11
  ...
  store i32 %i.j, ptr @x86_cpu_enable_simd, align 4, !tbaa !11
  ret void
}
...
!9 = !{!"Simple C/C++ TBAA"}
!10 = !{i64 2148248941, i64 2148249023, i64 2148249104}
!11 = !{!7, !7, i64 0}
end_hunk_0
