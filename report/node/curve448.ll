...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %15 = getelementptr inbounds nuw [8 x i8], ptr %13, i64 %index ; 2 uses
  %16 = trunc nuw i64 %index to i32
  %i.ar = add i32 %i.aj, %16
  ...
  store <2 x i64> %wide.load, ptr %15, align 16
...
vector.body114:                                   ; preds = %vector.body114, %vector.ph111
  ...
  %17 = getelementptr inbounds nuw [8 x i8], ptr %12, i64 %index115 ; 2 uses
  %18 = trunc nuw i64 %index115 to i32
  %i.du = add i32 %i.dm, %18
  ...
  %i.dy = getelementptr inbounds nuw i8, ptr %17, i64 16
  store <2 x i64> %wide.load116, ptr %17, align 16
