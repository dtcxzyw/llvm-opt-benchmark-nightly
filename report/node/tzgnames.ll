...
.sink.split:                                      ; preds = %bb.d, %.critedge97, %bb.ai, %.thread
...
begin_hunk_3
  ...
  br i1 %i.l, label %bb.y, label %bb.g
...
bb.t:                                             ; preds = %.thread115, %bb.o, %bb.r, %bb.q, %bb.s
  %.243 = phi ptr [ %i.r, %bb.s ], [ %i.ac, %bb.o ], [ null, %bb.r ], [ null, %bb.q ], [ null, %.thread115 ] ; 3 uses
...
begin_hunk_6
  ...
  br i1 %.not.i, label %.thread123, label %.lr.ph.i, !llvm.loop !14

bb.y:                                             ; preds = %bb.h, %bb.f
  tail call void @umtx_unlock_78(ptr noundef nonnull @_ZN6icu_78L9gTZGNLockE) #17
  br label %.thread122

.thread123:                                       ; preds = %bb.x, %bb.u
...
.thread69:                                        ; preds = %.thread121, %.thread123
...
.thread122:                                       ; preds = %.thread123, %_ZN6icu_7812LocalPointerINS_20TimeZoneGenericNamesEEC2EPS1_R10UErrorCode.exit, %bb.y, %.thread121
