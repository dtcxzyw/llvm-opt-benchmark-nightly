Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/node/original/tzgnames?download=true
...
.critedge:                                        ; preds = %_ZN6icu_7812LocalPointerINS_7UVectorEEC2EPS1_R10UErrorCode.exit
  ...
  tail call void %i.al(ptr noundef nonnull align 8 dereferenceable(40) %i.v) #16, !inline_history !9
  br label %.thread63

.critedge48:                                      ; preds = %bb.o, %bb.n, %bb.f
  %i.am = add nuw nsw i32 %.03464, 1              ; 2 uses
  %exitcond.not = icmp eq i32 %i.am, %i.i
  br i1 %exitcond.not, label %.thread63, label %bb.d, !llvm.loop !10

.thread63:                                        ; preds = %_ZNK6icu_7813CharacterNode8getValueEi.exit, %.critedge48, %bb.m, %bb.i, %bb.j, %_ZNK6icu_7813CharacterNode11countValuesEv.exit, %bb.l, %.critedge, %bb.b, %bb.a
  %.7 = phi i8 [ 0, %bb.i ], [ 0, %bb.a ], [ 0, %bb.l ], [ 1, %bb.b ], [ 0, %.critedge ], [ 1, %_ZNK6icu_7813CharacterNode11countValuesEv.exit ], [ 0, %bb.j ], [ 1, %_ZNK6icu_7813CharacterNode8getValueEi.exit ], [ 0, %bb.m ], [ 1, %.critedge48 ]
  ret i8 %.7
}
...
bb.l:                                             ; preds = %bb.k
  ...
  call void %i.bb(ptr noundef nonnull align 8 dereferenceable(8) %i.ax) #16, !inline_history !8
  br label %bb.m
...
bb.n:                                             ; preds = %bb.m
  ...
  call void %i.bg(ptr noundef nonnull align 8 dereferenceable(8) %i.bc) #16, !inline_history !8
