...
iter.check257:                                    ; preds = %.thread
  tail call void @padlock_reload_key() #6
  tail call void @padlock_aes_block(ptr noundef nonnull %i.f, ptr noundef nonnull %i.f, ptr noundef nonnull %i.f) #6
  tail call void @padlock_reload_key() #6
  %min.iters.check235 = icmp ult i64 %.594106, 4
  br i1 %min.iters.check235, label %vec.epilog.scalar.ph258.preheader, label %vector.memcheck220

vector.memcheck220:                               ; preds = %iter.check257
  %i.cz = add i64 %.594106, %i.am                 ; 2 uses
...
vector.ph119:                                     ; preds = %vector.main.loop.iter.check117
  ...
  %i.bj = getelementptr i8, ptr %i.i, i64 %n.vec121
  %i.bk = getelementptr i8, ptr %i.bb, i64 %n.vec121
  %i.bl = and i64 %.35366, 31
  %i.bm = getelementptr i8, ptr %i.bc, i64 %n.vec121
...
vector.body122:                                   ; preds = %vector.body122, %vector.ph119
  ...
  %i.bn = getelementptr i8, ptr %next.gep126, i64 16
  %wide.load127 = load <16 x i8>, ptr %next.gep126, align 1, !tbaa !14
  %wide.load128 = load <16 x i8>, ptr %i.bn, align 1, !tbaa !14
  %i.bo = getelementptr i8, ptr %next.gep124, i64 16
  %wide.load129 = load <16 x i8>, ptr %next.gep124, align 1, !tbaa !14
  %wide.load130 = load <16 x i8>, ptr %i.bo, align 1, !tbaa !14
  %i.bp = xor <16 x i8> %wide.load129, %wide.load127
  %i.bq = xor <16 x i8> %wide.load130, %wide.load128
  %i.br = getelementptr i8, ptr %next.gep125, i64 16
  store <16 x i8> %i.bp, ptr %next.gep125, align 1, !tbaa !14
  store <16 x i8> %i.bq, ptr %i.br, align 1, !tbaa !14
  %index.next131 = add nuw i64 %index123, 32      ; 2 uses
  %i.bs = icmp eq i64 %index.next131, %n.vec121
  br i1 %i.bs, label %middle.block132, label %vector.body122, !llvm.loop !47
...
vec.epilog.ph142:                                 ; preds = %vector.main.loop.iter.check117, %vec.epilog.iter.check140
  ...
  %i.bt = getelementptr i8, ptr %i.i, i64 %n.vec144
  %i.bu = getelementptr i8, ptr %i.bb, i64 %n.vec144
  %i.bv = and i64 %.35366, 3
  %i.bw = getelementptr i8, ptr %i.bc, i64 %n.vec144
...
vec.epilog.vector.body145:                        ; preds = %vec.epilog.vector.body145, %vec.epilog.ph142
  ...
  %i.bx = xor <4 x i8> %wide.load151, %wide.load150
  store <4 x i8> %i.bx, ptr %next.gep148, align 1, !tbaa !14
  %index.next152 = add nuw i64 %index146, 4       ; 2 uses
  %i.by = icmp eq i64 %index.next152, %n.vec144
  br i1 %i.by, label %vec.epilog.middle.block153, label %vec.epilog.vector.body145, !llvm.loop !48
...
vec.epilog.scalar.ph139.preheader:                ; preds = %vector.memcheck110, %iter.check138, %vec.epilog.iter.check140, %vec.epilog.middle.block153
  %.077.ph = phi ptr [ %i.i, %iter.check138 ], [ %i.i, %vector.memcheck110 ], [ %i.bj, %vec.epilog.iter.check140 ], [ %i.bt, %vec.epilog.middle.block153 ] ; 2 uses
  %.376.ph = phi ptr [ %i.bb, %iter.check138 ], [ %i.bb, %vector.memcheck110 ], [ %i.bk, %vec.epilog.iter.check140 ], [ %i.bu, %vec.epilog.middle.block153 ] ; 2 uses
  %.475.ph = phi i64 [ %.35366, %iter.check138 ], [ %.35366, %vector.memcheck110 ], [ %i.bl, %vec.epilog.iter.check140 ], [ %i.bv, %vec.epilog.middle.block153 ] ; 4 uses
  %.35774.ph = phi ptr [ %i.bc, %iter.check138 ], [ %i.bc, %vector.memcheck110 ], [ %i.bm, %vec.epilog.iter.check140 ], [ %i.bw, %vec.epilog.middle.block153 ] ; 2 uses
  %i.bz = add i64 %.475.ph, -1
...
vec.epilog.scalar.ph139.prol:                     ; preds = %vec.epilog.scalar.ph139.preheader, %vec.epilog.scalar.ph139.prol
  %.077.prol = phi ptr [ %i.cf, %vec.epilog.scalar.ph139.prol ], [ %.077.ph, %vec.epilog.scalar.ph139.preheader ] ; 2 uses
  %.376.prol = phi ptr [ %i.ce, %vec.epilog.scalar.ph139.prol ], [ %.376.ph, %vec.epilog.scalar.ph139.preheader ] ; 2 uses
  %.475.prol = phi i64 [ %i.cg, %vec.epilog.scalar.ph139.prol ], [ %.475.ph, %vec.epilog.scalar.ph139.preheader ]
  %.35774.prol = phi ptr [ %i.ca, %vec.epilog.scalar.ph139.prol ], [ %.35774.ph, %vec.epilog.scalar.ph139.preheader ] ; 2 uses
  %prol.iter = phi i64 [ %prol.iter.next, %vec.epilog.scalar.ph139.prol ], [ 0, %vec.epilog.scalar.ph139.preheader ]
  %i.ca = getelementptr inbounds nuw i8, ptr %.35774.prol, i64 1 ; 2 uses
  %i.cb = load i8, ptr %.35774.prol, align 1, !tbaa !14
  %i.cc = load i8, ptr %.077.prol, align 1, !tbaa !14
  %i.cd = xor i8 %i.cc, %i.cb
  %i.ce = getelementptr inbounds nuw i8, ptr %.376.prol, i64 1 ; 2 uses
  store i8 %i.cd, ptr %.376.prol, align 1, !tbaa !14
  %i.cf = getelementptr inbounds nuw i8, ptr %.077.prol, i64 1 ; 2 uses
  %i.cg = add i64 %.475.prol, -1                  ; 2 uses
...
vec.epilog.scalar.ph139.prol.loopexit:            ; preds = %vec.epilog.scalar.ph139.prol, %vec.epilog.scalar.ph139.preheader
  %.077.unr = phi ptr [ %.077.ph, %vec.epilog.scalar.ph139.preheader ], [ %i.cf, %vec.epilog.scalar.ph139.prol ]
  %.376.unr = phi ptr [ %.376.ph, %vec.epilog.scalar.ph139.preheader ], [ %i.ce, %vec.epilog.scalar.ph139.prol ]
  %.475.unr = phi i64 [ %.475.ph, %vec.epilog.scalar.ph139.preheader ], [ %i.cg, %vec.epilog.scalar.ph139.prol ]
  %.35774.unr = phi ptr [ %.35774.ph, %vec.epilog.scalar.ph139.preheader ], [ %i.ca, %vec.epilog.scalar.ph139.prol ]
  %i.ch = icmp ult i64 %i.bz, 3
  br i1 %i.ch, label %.loopexit, label %vec.epilog.scalar.ph139

vec.epilog.scalar.ph139:                          ; preds = %vec.epilog.scalar.ph139.prol.loopexit, %vec.epilog.scalar.ph139
  %.077 = phi ptr [ %i.df, %vec.epilog.scalar.ph139 ], [ %.077.unr, %vec.epilog.scalar.ph139.prol.loopexit ] ; 5 uses
  %.376 = phi ptr [ %i.de, %vec.epilog.scalar.ph139 ], [ %.376.unr, %vec.epilog.scalar.ph139.prol.loopexit ] ; 5 uses
  %.475 = phi i64 [ %i.dg, %vec.epilog.scalar.ph139 ], [ %.475.unr, %vec.epilog.scalar.ph139.prol.loopexit ]
  %.35774 = phi ptr [ %i.da, %vec.epilog.scalar.ph139 ], [ %.35774.unr, %vec.epilog.scalar.ph139.prol.loopexit ] ; 5 uses
  %i.ci = getelementptr inbounds nuw i8, ptr %.35774, i64 1
  %i.cj = load i8, ptr %.35774, align 1, !tbaa !14
  %i.ck = load i8, ptr %.077, align 1, !tbaa !14
  %i.cl = xor i8 %i.ck, %i.cj
  %i.cm = getelementptr inbounds nuw i8, ptr %.376, i64 1
  store i8 %i.cl, ptr %.376, align 1, !tbaa !14
  %i.cn = getelementptr inbounds nuw i8, ptr %.077, i64 1
  %i.co = getelementptr inbounds nuw i8, ptr %.35774, i64 2
  %i.cp = load i8, ptr %i.ci, align 1, !tbaa !14
  %i.cq = load i8, ptr %i.cn, align 1, !tbaa !14
  %i.cr = xor i8 %i.cq, %i.cp
  %i.cs = getelementptr inbounds nuw i8, ptr %.376, i64 2
  store i8 %i.cr, ptr %i.cm, align 1, !tbaa !14
  %i.ct = getelementptr inbounds nuw i8, ptr %.077, i64 2
  %i.cu = getelementptr inbounds nuw i8, ptr %.35774, i64 3
  %i.cv = load i8, ptr %i.co, align 1, !tbaa !14
  %i.cw = load i8, ptr %i.ct, align 1, !tbaa !14
  %i.cx = xor i8 %i.cw, %i.cv
  %i.cy = getelementptr inbounds nuw i8, ptr %.376, i64 3
  store i8 %i.cx, ptr %i.cs, align 1, !tbaa !14
  %i.cz = getelementptr inbounds nuw i8, ptr %.077, i64 3
  %i.da = getelementptr inbounds nuw i8, ptr %.35774, i64 4
  %i.db = load i8, ptr %i.cu, align 1, !tbaa !14
  %i.dc = load i8, ptr %i.cz, align 1, !tbaa !14
  %i.dd = xor i8 %i.dc, %i.db
  %i.de = getelementptr inbounds nuw i8, ptr %.376, i64 4
  store i8 %i.dd, ptr %i.cy, align 1, !tbaa !14
  %i.df = getelementptr inbounds nuw i8, ptr %.077, i64 4
  %i.dg = add i64 %.475, -4                       ; 2 uses
  %.not63.3 = icmp eq i64 %i.dg, 0
...
.loopexit:                                        ; preds = %vec.epilog.scalar.ph139.prol.loopexit, %vec.epilog.scalar.ph139, %middle.block132, %vec.epilog.middle.block153, %bb.f
  %i.dh = tail call ptr @EVP_CIPHER_CTX_iv_noconst(ptr noundef %0) #6
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.dh, ptr noundef nonnull align 4 dereferenceable(16) %i.i, i64 16, i1 false)
  br label %.critedge
