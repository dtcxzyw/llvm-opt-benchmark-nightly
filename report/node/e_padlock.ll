...
vec.epilog.ph:                                    ; preds = %vector.memcheck
  ...
  %4 = xor <4 x i8> %wide.load103, %wide.load102
  store <4 x i8> %4, ptr %1, align 1, !tbaa !14
  %5 = icmp eq i64 %n.vec98, 4
  br i1 %5, label %vec.epilog.middle.block, label %vec.epilog.vector.body.1
...
vec.epilog.vector.body.1:                         ; preds = %vec.epilog.ph
  ...
  %i.z = getelementptr i8, ptr %6, i64 %i.n
  %wide.load103.1 = load <4 x i8>, ptr %i.z, align 1, !tbaa !14
  %i.aa = xor <4 x i8> %wide.load103.1, %wide.load102.1
  store <4 x i8> %i.aa, ptr %next.gep100.1, align 1, !tbaa !14
  %i.ab = icmp eq i64 %n.vec98, 8
  br i1 %i.ab, label %vec.epilog.middle.block, label %vec.epilog.vector.body.2
...
vec.epilog.vector.body.2:                         ; preds = %vec.epilog.vector.body.1
  ...
  %7 = getelementptr i8, ptr %i.k, i64 8
  %8 = getelementptr i8, ptr %7, i64 %i.n
  %wide.load103.2 = load <4 x i8>, ptr %8, align 1, !tbaa !14
  %9 = xor <4 x i8> %wide.load103.2, %wide.load102.2
  store <4 x i8> %9, ptr %next.gep100.2, align 1, !tbaa !14
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.ad = load i8, ptr %.05467, align 1, !tbaa !14
  ...
  store i8 %i.ag, ptr %.04869, align 1, !tbaa !14
  ...
  br i1 %i.am, label %.lr.ph, label %._crit_edge.loopexit, !llvm.loop !46
...
vector.memcheck110:                               ; preds = %iter.check138
  ...
  %i.bb = add i64 %i.f, 15
  %i.bc = or i64 %i.bb, -16
  %i.bd = sub i64 %i.bc, %i.d
  %i.be = add i64 %i.bd, %i.ba
  %diff.check114 = icmp ult i64 %i.be, 31
...
vector.ph119:                                     ; preds = %vector.main.loop.iter.check117
  ...
  %i.bf = getelementptr i8, ptr %i.i, i64 %n.vec121
  %i.bg = getelementptr i8, ptr %i.av, i64 %n.vec121
  %i.bh = and i64 %.35366, 31
  %i.bi = getelementptr i8, ptr %i.aw, i64 %n.vec121
...
vector.body122:                                   ; preds = %vector.body122, %vector.ph119
  ...
  %i.bj = getelementptr i8, ptr %next.gep126, i64 16
  %wide.load127 = load <16 x i8>, ptr %next.gep126, align 1, !tbaa !14
  %wide.load128 = load <16 x i8>, ptr %i.bj, align 1, !tbaa !14
  %i.bk = getelementptr i8, ptr %next.gep124, i64 16
  %wide.load129 = load <16 x i8>, ptr %next.gep124, align 1, !tbaa !14
  %wide.load130 = load <16 x i8>, ptr %i.bk, align 1, !tbaa !14
  %i.bl = xor <16 x i8> %wide.load129, %wide.load127
  %i.bm = xor <16 x i8> %wide.load130, %wide.load128
  %i.bn = getelementptr i8, ptr %next.gep125, i64 16
  store <16 x i8> %i.bl, ptr %next.gep125, align 1, !tbaa !14
  store <16 x i8> %i.bm, ptr %i.bn, align 1, !tbaa !14
  %index.next131 = add nuw i64 %index123, 32      ; 2 uses
  %i.bo = icmp eq i64 %index.next131, %n.vec121
  br i1 %i.bo, label %middle.block132, label %vector.body122, !llvm.loop !47
...
vec.epilog.ph142:                                 ; preds = %vector.main.loop.iter.check117, %vec.epilog.iter.check140
  ...
  %i.bp = getelementptr i8, ptr %i.i, i64 %n.vec144
  %i.bq = getelementptr i8, ptr %i.av, i64 %n.vec144
  %i.br = and i64 %.35366, 3
  %i.bs = getelementptr i8, ptr %i.aw, i64 %n.vec144
...
vec.epilog.vector.body145:                        ; preds = %vec.epilog.vector.body145, %vec.epilog.ph142
  ...
  %i.bt = xor <4 x i8> %wide.load151, %wide.load150
  store <4 x i8> %i.bt, ptr %next.gep148, align 1, !tbaa !14
  %index.next152 = add nuw i64 %index146, 4       ; 2 uses
  %i.bu = icmp eq i64 %index.next152, %n.vec144
  br i1 %i.bu, label %vec.epilog.middle.block153, label %vec.epilog.vector.body145, !llvm.loop !48
...
vec.epilog.scalar.ph139.preheader:                ; preds = %vector.memcheck110, %iter.check138, %vec.epilog.iter.check140, %vec.epilog.middle.block153
  %.077.ph = phi ptr [ %i.i, %iter.check138 ], [ %i.i, %vector.memcheck110 ], [ %i.bf, %vec.epilog.iter.check140 ], [ %i.bp, %vec.epilog.middle.block153 ] ; 2 uses
  %.376.ph = phi ptr [ %i.av, %iter.check138 ], [ %i.av, %vector.memcheck110 ], [ %i.bg, %vec.epilog.iter.check140 ], [ %i.bq, %vec.epilog.middle.block153 ] ; 2 uses
  %.475.ph = phi i64 [ %.35366, %iter.check138 ], [ %.35366, %vector.memcheck110 ], [ %i.bh, %vec.epilog.iter.check140 ], [ %i.br, %vec.epilog.middle.block153 ] ; 4 uses
  %.35774.ph = phi ptr [ %i.aw, %iter.check138 ], [ %i.aw, %vector.memcheck110 ], [ %i.bi, %vec.epilog.iter.check140 ], [ %i.bs, %vec.epilog.middle.block153 ] ; 2 uses
  %i.bv = add i64 %.475.ph, -1
...
vec.epilog.scalar.ph139.prol:                     ; preds = %vec.epilog.scalar.ph139.preheader, %vec.epilog.scalar.ph139.prol
  %.077.prol = phi ptr [ %i.cb, %vec.epilog.scalar.ph139.prol ], [ %.077.ph, %vec.epilog.scalar.ph139.preheader ] ; 2 uses
  %.376.prol = phi ptr [ %i.ca, %vec.epilog.scalar.ph139.prol ], [ %.376.ph, %vec.epilog.scalar.ph139.preheader ] ; 2 uses
  %.475.prol = phi i64 [ %i.cc, %vec.epilog.scalar.ph139.prol ], [ %.475.ph, %vec.epilog.scalar.ph139.preheader ]
  %.35774.prol = phi ptr [ %i.bw, %vec.epilog.scalar.ph139.prol ], [ %.35774.ph, %vec.epilog.scalar.ph139.preheader ] ; 2 uses
  %prol.iter = phi i64 [ %prol.iter.next, %vec.epilog.scalar.ph139.prol ], [ 0, %vec.epilog.scalar.ph139.preheader ]
  %i.bw = getelementptr inbounds nuw i8, ptr %.35774.prol, i64 1 ; 2 uses
  %i.bx = load i8, ptr %.35774.prol, align 1, !tbaa !14
  %i.by = load i8, ptr %.077.prol, align 1, !tbaa !14
  %i.bz = xor i8 %i.by, %i.bx
  %i.ca = getelementptr inbounds nuw i8, ptr %.376.prol, i64 1 ; 2 uses
  store i8 %i.bz, ptr %.376.prol, align 1, !tbaa !14
  %i.cb = getelementptr inbounds nuw i8, ptr %.077.prol, i64 1 ; 2 uses
  %i.cc = add i64 %.475.prol, -1                  ; 2 uses
...
vec.epilog.scalar.ph139.prol.loopexit:            ; preds = %vec.epilog.scalar.ph139.prol, %vec.epilog.scalar.ph139.preheader
  %.077.unr = phi ptr [ %.077.ph, %vec.epilog.scalar.ph139.preheader ], [ %i.cb, %vec.epilog.scalar.ph139.prol ]
  %.376.unr = phi ptr [ %.376.ph, %vec.epilog.scalar.ph139.preheader ], [ %i.ca, %vec.epilog.scalar.ph139.prol ]
  %.475.unr = phi i64 [ %.475.ph, %vec.epilog.scalar.ph139.preheader ], [ %i.cc, %vec.epilog.scalar.ph139.prol ]
  %.35774.unr = phi ptr [ %.35774.ph, %vec.epilog.scalar.ph139.preheader ], [ %i.bw, %vec.epilog.scalar.ph139.prol ]
  %i.cd = icmp ult i64 %i.bv, 3
  br i1 %i.cd, label %.loopexit, label %vec.epilog.scalar.ph139

vec.epilog.scalar.ph139:                          ; preds = %vec.epilog.scalar.ph139.prol.loopexit, %vec.epilog.scalar.ph139
  %.077 = phi ptr [ %i.db, %vec.epilog.scalar.ph139 ], [ %.077.unr, %vec.epilog.scalar.ph139.prol.loopexit ] ; 5 uses
  %.376 = phi ptr [ %i.da, %vec.epilog.scalar.ph139 ], [ %.376.unr, %vec.epilog.scalar.ph139.prol.loopexit ] ; 5 uses
  %.475 = phi i64 [ %i.dc, %vec.epilog.scalar.ph139 ], [ %.475.unr, %vec.epilog.scalar.ph139.prol.loopexit ]
  %.35774 = phi ptr [ %i.cw, %vec.epilog.scalar.ph139 ], [ %.35774.unr, %vec.epilog.scalar.ph139.prol.loopexit ] ; 5 uses
  %i.ce = getelementptr inbounds nuw i8, ptr %.35774, i64 1
  %i.cf = load i8, ptr %.35774, align 1, !tbaa !14
  %i.cg = load i8, ptr %.077, align 1, !tbaa !14
  %i.ch = xor i8 %i.cg, %i.cf
  %i.ci = getelementptr inbounds nuw i8, ptr %.376, i64 1
  store i8 %i.ch, ptr %.376, align 1, !tbaa !14
  %i.cj = getelementptr inbounds nuw i8, ptr %.077, i64 1
  %i.ck = getelementptr inbounds nuw i8, ptr %.35774, i64 2
  %i.cl = load i8, ptr %i.ce, align 1, !tbaa !14
  %i.cm = load i8, ptr %i.cj, align 1, !tbaa !14
  %i.cn = xor i8 %i.cm, %i.cl
  %i.co = getelementptr inbounds nuw i8, ptr %.376, i64 2
  store i8 %i.cn, ptr %i.ci, align 1, !tbaa !14
  %i.cp = getelementptr inbounds nuw i8, ptr %.077, i64 2
  %i.cq = getelementptr inbounds nuw i8, ptr %.35774, i64 3
  %i.cr = load i8, ptr %i.ck, align 1, !tbaa !14
  %i.cs = load i8, ptr %i.cp, align 1, !tbaa !14
  %i.ct = xor i8 %i.cs, %i.cr
  %i.cu = getelementptr inbounds nuw i8, ptr %.376, i64 3
  store i8 %i.ct, ptr %i.co, align 1, !tbaa !14
  %i.cv = getelementptr inbounds nuw i8, ptr %.077, i64 3
  %i.cw = getelementptr inbounds nuw i8, ptr %.35774, i64 4
  %i.cx = load i8, ptr %i.cq, align 1, !tbaa !14
  %i.cy = load i8, ptr %i.cv, align 1, !tbaa !14
  %i.cz = xor i8 %i.cy, %i.cx
  %i.da = getelementptr inbounds nuw i8, ptr %.376, i64 4
  store i8 %i.cz, ptr %i.cu, align 1, !tbaa !14
  %i.db = getelementptr inbounds nuw i8, ptr %.077, i64 4
  %i.dc = add i64 %.475, -4                       ; 2 uses
  %.not63.3 = icmp eq i64 %i.dc, 0
  br i1 %.not63.3, label %.loopexit, label %vec.epilog.scalar.ph139, !llvm.loop !50
...
.loopexit:                                        ; preds = %vec.epilog.scalar.ph139.prol.loopexit, %vec.epilog.scalar.ph139, %middle.block132, %vec.epilog.middle.block153, %bb.f
  %i.dd = tail call ptr @EVP_CIPHER_CTX_iv_noconst(ptr noundef %0) #6
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(16) %i.dd, ptr noundef nonnull align 4 dereferenceable(16) %i.i, i64 16, i1 false)
  br label %.critedge
...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 %i.d, ptr %i.a, align 4, !tbaa !5
  ...
  %i.l = load i32, ptr %i.a, align 4, !tbaa !5
...
!12 = !{!13, !13, i64 0}
!13 = !{!"p1 _ZTS13evp_cipher_st", !11, i64 0}
!14 = !{!7, !7, i64 0}
!15 = distinct !{!15, !16}
...
!40 = distinct !{!40, !36}
!41 = !{!38, !35}
!42 = distinct !{!42, !16, !27, !28}
!43 = distinct !{!43, !16, !27, !28}
!44 = distinct !{!44, !32}
!45 = distinct !{!45, !16, !27}
!46 = distinct !{!46, !16, !27}
!47 = distinct !{!47, !16, !27, !28}
!48 = distinct !{!48, !16, !27, !28}
!49 = distinct !{!49, !32}
!50 = distinct !{!50, !16, !27}
end_hunk_0
