...
vec.epilog.vector.body.1:                         ; preds = %vec.epilog.vector.body.1, %vec.epilog.ph
  ...
  %wide.load102 = load <4 x i8>, ptr %next.gep101, align 1, !tbaa !14
  ...
  store <4 x i8> %i.aa, ptr %next.gep101.1, align 1, !tbaa !14
...
vector.body122:                                   ; preds = %vector.body122, %vector.ph119
  ...
  br i1 %i.bo, label %middle.block132, label %vector.body122, !llvm.loop !48
...
vec.epilog.vector.body145:                        ; preds = %vec.epilog.vector.body145, %vec.epilog.ph142
  ...
  br i1 %i.bu, label %vec.epilog.middle.block153, label %vec.epilog.vector.body145, !llvm.loop !49
...
vec.epilog.scalar.ph139.prol:                     ; preds = %vec.epilog.scalar.ph139.preheader, %vec.epilog.scalar.ph139.prol
  ...
  br i1 %prol.iter.cmp.not, label %vec.epilog.scalar.ph139.prol.loopexit, label %vec.epilog.scalar.ph139.prol, !llvm.loop !50
...
vec.epilog.scalar.ph139:                          ; preds = %vec.epilog.scalar.ph139.prol.loopexit, %vec.epilog.scalar.ph139
  ...
  br i1 %.not63.3, label %.loopexit, label %vec.epilog.scalar.ph139, !llvm.loop !51
