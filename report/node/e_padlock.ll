...
bb.b:                                             ; preds = %bb.a
  %i.k = tail call ptr @EVP_CIPHER_CTX_iv_noconst(ptr noundef %0) #7 ; 5 uses
...
vec.epilog.ph:                                    ; preds = %vector.memcheck
  %n.vec102 = and i64 %i.q, 28                    ; 7 uses
  ...
  %wide.load106 = load <4 x i8>, ptr %2, align 1, !tbaa !14
  %i.y = getelementptr i8, ptr %i.k, i64 %i.n
  %wide.load107 = load <4 x i8>, ptr %i.y, align 1, !tbaa !14
  %4 = xor <4 x i8> %wide.load107, %wide.load106
  store <4 x i8> %4, ptr %1, align 1, !tbaa !14
  %5 = icmp eq i64 %n.vec102, 4
  br i1 %5, label %vec.epilog.middle.block, label %vec.epilog.vector.body.1

vec.epilog.vector.body.1:                         ; preds = %vec.epilog.ph
  %next.gep104.1 = getelementptr i8, ptr %1, i64 4
  %next.gep105.1 = getelementptr i8, ptr %2, i64 4
  %wide.load106.1 = load <4 x i8>, ptr %next.gep105.1, align 1, !tbaa !14
  %6 = getelementptr i8, ptr %i.k, i64 4
  %i.z = getelementptr i8, ptr %6, i64 %i.n
  %wide.load107.1 = load <4 x i8>, ptr %i.z, align 1, !tbaa !14
  %i.aa = xor <4 x i8> %wide.load107.1, %wide.load106.1
  store <4 x i8> %i.aa, ptr %next.gep104.1, align 1, !tbaa !14
  %i.ab = icmp eq i64 %n.vec102, 8
...
vec.epilog.vector.body.2:                         ; preds = %vec.epilog.vector.body.1
  %next.gep104.2 = getelementptr i8, ptr %1, i64 8
  %next.gep105.2 = getelementptr i8, ptr %2, i64 8
  %wide.load106.2 = load <4 x i8>, ptr %next.gep105.2, align 1, !tbaa !14
  %7 = getelementptr i8, ptr %i.k, i64 8
  %8 = getelementptr i8, ptr %7, i64 %i.n
  %wide.load107.2 = load <4 x i8>, ptr %8, align 1, !tbaa !14
  %9 = xor <4 x i8> %wide.load107.2, %wide.load106.2
  store <4 x i8> %9, ptr %next.gep104.2, align 1, !tbaa !14
...
begin_hunk_4_@padlock_ofb_cipher:bb.a
  ...
  br i1 %i.bo, label %middle.block136, label %vector.body126, !llvm.loop !47
...
begin_hunk_5_@padlock_ofb_cipher:bb.a
  ...
  br i1 %i.bu, label %vec.epilog.middle.block157, label %vec.epilog.vector.body149, !llvm.loop !48
...
begin_hunk_6_@padlock_ofb_cipher:bb.a
  ...
  br i1 %prol.iter.cmp.not, label %vec.epilog.scalar.ph143.prol.loopexit, label %vec.epilog.scalar.ph143.prol, !llvm.loop !49
...
begin_hunk_7_@padlock_ofb_cipher:bb.a
  ...
  br i1 %.not63.3, label %.loopexit, label %vec.epilog.scalar.ph143, !llvm.loop !50
