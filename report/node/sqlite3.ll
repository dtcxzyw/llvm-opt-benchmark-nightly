...
._crit_edge186.i:                                 ; preds = %.lr.ph185.i.prol.loopexit, %.lr.ph185.i, %bb.dn
  ...
  %.pre205.i = load ptr, ptr %i.tn, align 8, !tbaa !6007 ; 2 uses
...
.lr.ph192.i:                                      ; preds = %bb.dp, %._crit_edge186.i
  ...
  %i.ua = load ptr, ptr %i.tn, align 8, !tbaa !6056
...
bb.dq:                                            ; preds = %nodeReaderRelease.exit139.i, %.lr.ph192.i
  ...
  %i.ue = load ptr, ptr %i.ud, align 8, !tbaa !6056 ; 4 uses
...
bb.dy:                                            ; preds = %bb.dx
  ...
  %.pre206.i = load ptr, ptr %i.vm, align 8, !tbaa !6007 ; 2 uses
...
blobGrowBuffer.exit129.i:                         ; preds = %bb.ea, %bb.dy
  ...
  %i.wb = load ptr, ptr %i.vm, align 8, !tbaa !6056
...
bb.fn:                                            ; preds = %bb.fm
  %i.abx = load ptr, ptr %i.cs, align 8, !tbaa !6056
...
bb.gj:                                            ; preds = %bb.fu
  ...
  %i.aga = load ptr, ptr %i.afy, align 8, !tbaa !6056
  ...
  %i.agd = load ptr, ptr %i.afy, align 8, !tbaa !6056
  store i8 %i.agc, ptr %i.agd, align 1, !tbaa !227
  %i.age = load ptr, ptr %i.afy, align 8, !tbaa !6056
...
bb.gs:                                            ; preds = %blobGrowBuffer.exit.i181
  ...
  %i.ahw = load ptr, ptr %i.cs, align 8, !tbaa !6056
...
bb.gz:                                            ; preds = %bb.gy
  ...
  %i.aiu = load ptr, ptr %i.ait, align 8, !tbaa !6056 ; 4 uses
...
bb.hq:                                            ; preds = %.lr.ph.i200
  ...
  %i.alf = load ptr, ptr %i.akz, align 8, !tbaa !6056
...
bb.hr:                                            ; preds = %bb.hq, %.lr.ph.i200
  ...
  %i.alh = load ptr, ptr %i.akz, align 8, !tbaa !6056 ; 4 uses
...
bb.ie:                                            ; preds = %bb.id, %bb.ic
  ...
  %i.anb = load ptr, ptr %i.ana, align 8, !tbaa !6056
...
bb.if:                                            ; preds = %bb.ie, %._crit_edge.i197
  ...
  %i.ang = load ptr, ptr %i.anf, align 8, !tbaa !6056 ; 4 uses
