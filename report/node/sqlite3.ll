...
bb.gb:                                            ; preds = %bb.ga
  ...
  %i.abw = load ptr, ptr %i.abu, align 8, !tbaa !1340 ; 2 uses
...
bb.ge:                                            ; preds = %bb.gd, %bb.gc
  ...
  %i.acl = load ptr, ptr %i.ack, align 8, !tbaa !350
  %i.acm = sext i16 %.0.i103 to i32
  store i32 %i.acm, ptr %i.acj, align 4, !tbaa !24
...
.preheader23.i.thread:                            ; preds = %bb.ge
  store i64 9223372036854775807, ptr %i.aci, align 8, !tbaa !19
...
sqlite3LogEstToInt.exit:                          ; preds = %bb.ge
  ...
  store i64 %.013.i, ptr %i.aci, align 8, !tbaa !19
...
.lr.ph34.i:                                       ; preds = %bb.gf, %.lr.ph34.i
  ...
  br i1 %i.adh, label %.lr.ph34.i, label %.loopexit.i108, !llvm.loop !1342
...
.lr.ph.i109:                                      ; preds = %.lr.ph.i109.preheader, %.lr.ph.i109
  ...
  br i1 %i.adl, label %.lr.ph.i109, label %.preheader21.i, !llvm.loop !1343
...
.lr.ph29.i:                                       ; preds = %.preheader21.i, %.lr.ph29.i
  ...
  br i1 %i.ado, label %.lr.ph29.i, label %.loopexit.i108, !llvm.loop !1344
...
.loopexit.i108:                                   ; preds = %.lr.ph34.i, %.lr.ph29.i, %.preheader21.i
  ...
  %i.adr = load i16, ptr %i.adq, align 2, !tbaa !332
...
sqlite3LogEst.exit:                               ; preds = %bb.gf, %.loopexit.i108
  ...
  store i32 %.018.i, ptr %i.acl, align 4, !tbaa !24
...
.lr.ph34:                                         ; preds = %bb.b, %.lr.ph34
  ...
  br i1 %i.f, label %.lr.ph34, label %.loopexit, !llvm.loop !1342
...
.lr.ph:                                           ; preds = %.preheader23, %.lr.ph
  ...
  br i1 %i.j, label %.lr.ph, label %.preheader21, !llvm.loop !1343
...
.lr.ph29:                                         ; preds = %.preheader21, %.lr.ph29
  ...
  br i1 %i.m, label %.lr.ph29, label %.loopexit, !llvm.loop !1344
...
.loopexit:                                        ; preds = %.lr.ph29, %.lr.ph34, %.preheader21
  ...
  %i.p = load i16, ptr %i.o, align 2, !tbaa !332
  %i.q = add i16 %.3, -10
  %i.r = add i16 %i.q, %i.p
  br label %bb.c
...
.lr.ph42:                                         ; preds = %.lr.ph42.preheader, %.lr.ph42
  ...
  br i1 %exitcond54.not, label %._crit_edge43, label %.lr.ph42, !llvm.loop !1346
...
._crit_edge43:                                    ; preds = %.lr.ph42, %bb.b
  ...
  store i8 0, ptr %.0.lcssa, align 1, !tbaa !229
  ...
  store i8 0, ptr %i.ah, align 1, !tbaa !229
  store i8 0, ptr %i.ai, align 1, !tbaa !229
...
databaseName.exit:                                ; preds = %bb.d
  ...
  %i.k = load i32, ptr @sqlite3Config, align 8, !tbaa !177
  %.not.i3 = icmp eq i32 %i.k, 0
  br i1 %.not.i3, label %bb.h, label %bb.e

bb.e:                                             ; preds = %databaseName.exit
  %i.l = load ptr, ptr @mem0, align 8, !tbaa !178 ; 2 uses
  %.not.i.i = icmp eq ptr %i.l, null
  br i1 %.not.i.i, label %sqlite3_mutex_enter.exit.i, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.m = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 128), align 8, !tbaa !10
  tail call void %i.m(ptr noundef nonnull %i.l) #59, !inline_history !270
  br label %sqlite3_mutex_enter.exit.i

sqlite3_mutex_enter.exit.i:                       ; preds = %bb.f, %bb.e
  %i.n = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 56), align 8, !tbaa !96
  %i.o = tail call i32 %i.n(ptr noundef nonnull %i.j) #59, !inline_history !271
  %i.p = sext i32 %i.o to i64
  %i.q = load i64, ptr @sqlite3Stat, align 8, !tbaa !19
  %i.r = sub nsw i64 %i.q, %i.p
  store i64 %i.r, ptr @sqlite3Stat, align 8, !tbaa !19
  %i.s = load i64, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Stat, i64 72), align 8, !tbaa !19
  %i.t = add nsw i64 %i.s, -1
  store i64 %i.t, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Stat, i64 72), align 8, !tbaa !19
  %i.u = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 40), align 8, !tbaa !182
  tail call void %i.u(ptr noundef nonnull %i.j) #59, !inline_history !272
  %i.v = load ptr, ptr @mem0, align 8, !tbaa !178 ; 2 uses
...
bb.g:                                             ; preds = %sqlite3_mutex_enter.exit.i
  ...
  tail call void %i.w(ptr noundef nonnull %i.v) #59, !inline_history !273
  br label %sqlite3_free.exit

bb.h:                                             ; preds = %databaseName.exit
  %i.x = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 40), align 8, !tbaa !182
  tail call void %i.x(ptr noundef nonnull %i.j) #59, !inline_history !272
  br label %sqlite3_free.exit
...
bb.b:                                             ; preds = %.preheader
  ...
  %i.f = load i8, ptr %i.e, align 1, !tbaa !229
  %.not6.i = icmp eq i8 %i.f, 0
  br i1 %.not6.i, label %bb.c, label %.preheader.backedge

bb.c:                                             ; preds = %bb.b
  %i.g = getelementptr inbounds i8, ptr %.0.i, i64 -3
  %i.h = load i8, ptr %i.g, align 1, !tbaa !229
...
sqlite3_realloc64.exit.i.i:                       ; preds = %bb.o
  %i.av = call fastcc ptr @sqlite3Realloc(ptr noundef %i.at, i64 noundef %.1.i.i), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i: ; preds = %sqlite3_realloc64.exit.i.i
  store ptr %i.av, ptr %6, align 8, !tbaa !1627
  %i.ax = trunc nsw i64 %.1.i.i to i32
  store i32 %i.ax, ptr %i.n, align 4, !tbaa !1626
  %.pre9.i = load i32, ptr %i.m, align 8, !tbaa !1618 ; 2 uses
...
bb.p:                                             ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i, %.sessionBufferGrow.exit.thread5_crit_edge.i
  ...
  store i32 %i.ba, ptr %i.m, align 8, !tbaa !1618
  %i.bb = getelementptr inbounds i8, ptr %i.az, i64 %.pre-phi.i
  store i8 84, ptr %i.bb, align 1, !tbaa !229
  %.pr388 = load i32, ptr %i.m, align 8, !tbaa !1618 ; 2 uses
  %i.bc = load i32, ptr %i.o, align 8, !tbaa !1675 ; 6 uses
  %i.bd = sext i32 %.pr388 to i64                 ; 2 uses
  %i.be = add nsw i64 %i.bd, 9                    ; 2 uses
  %i.bf = load i32, ptr %i.n, align 4, !tbaa !1626 ; 2 uses
...
.sessionBufferGrow.exit.thread6_crit_edge.i:      ; preds = %bb.p
  %.pre.i81 = load ptr, ptr %6, align 8, !tbaa !1627
...
bb.r:                                             ; preds = %bb.r, %bb.q
  ...
  br i1 %i.bj, label %bb.r, label %bb.s, !llvm.loop !1628
...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  %i.bm = load ptr, ptr %6, align 8, !tbaa !1627
  %i.bn = call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i89:                     ; preds = %bb.u
  %i.bo = call fastcc ptr @sqlite3Realloc(ptr noundef %i.bm, i64 noundef %.1.i.i86), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread6_crit_edge.i: ; preds = %sqlite3_realloc64.exit.i.i89
  store ptr %i.bo, ptr %6, align 8, !tbaa !1627
  %i.bq = trunc nsw i64 %.1.i.i86 to i32
  store i32 %i.bq, ptr %i.n, align 4, !tbaa !1626
  %.pre8.i = load i32, ptr %i.m, align 8, !tbaa !1618
...
bb.v:                                             ; preds = %sessionBufferGrow.exit.thread6.i
  ...
  store i8 %i.bu, ptr %i.bs, align 1, !tbaa !229
...
sessionAppendVarint.exit:                         ; preds = %bb.u, %sqlite3_realloc64.exit.i.i89, %bb.t, %bb.o, %sqlite3_realloc64.exit.i.i, %bb.n, %sqlite3_stricmp.exit.thread
  ...
  store i32 %.sink, ptr %i.f, align 4, !tbaa !24
  br label %sessionAppendBlob.exit

sessionAppendVarint.exit.thread:                  ; preds = %bb.v, %bb.x, %bb.y
  %i.cf = phi i32 [ 1, %bb.v ], [ %i.ce, %bb.y ], [ 2, %bb.x ]
  %i.cg = load i32, ptr %i.m, align 8, !tbaa !1618
  %i.ch = add nsw i32 %i.cg, %i.cf
  store i32 %i.ch, ptr %i.m, align 8, !tbaa !1618
  %.pr390594 = load i32, ptr %i.o, align 8, !tbaa !1675 ; 3 uses
  %i.ci = load ptr, ptr %i.p, align 8, !tbaa !1688
...
bb.z:                                             ; preds = %sessionAppendVarint.exit.thread
  ...
  %i.cl = load i32, ptr %i.m, align 8, !tbaa !1618
  %i.cm = sext i32 %i.cl to i64                   ; 2 uses
  %i.cn = add nsw i64 %i.cm, %i.ck                ; 3 uses
  %i.co = load i32, ptr %i.n, align 4, !tbaa !1626 ; 2 uses
...
.sessionBufferGrow.exit.thread10_crit_edge.i:     ; preds = %bb.z
  %.pre.i95 = load ptr, ptr %6, align 8, !tbaa !1627
...
bb.ab:                                            ; preds = %bb.ab, %bb.aa
  ...
  br i1 %i.cs, label %bb.ab, label %bb.ac, !llvm.loop !1628
...
.critedge.i.i107:                                 ; preds = %bb.ad
  store i32 7, ptr %i.f, align 4, !tbaa !24
  br label %sessionAppendBlob.exit

bb.ae:                                            ; preds = %bb.ad, %bb.ac
  %.1.i.i100 = phi i64 [ 2147483391, %bb.ad ], [ %i.cr, %bb.ac ] ; 2 uses
  %i.cv = load ptr, ptr %6, align 8, !tbaa !1627
  %i.cw = call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i103:                    ; preds = %bb.ae
  %i.cx = call fastcc ptr @sqlite3Realloc(ptr noundef %i.cv, i64 noundef %.1.i.i100), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread10_crit_edge.i: ; preds = %sqlite3_realloc64.exit.i.i103
  store ptr %i.cx, ptr %6, align 8, !tbaa !1627
  %i.cz = trunc nsw i64 %.1.i.i100 to i32
  store i32 %i.cz, ptr %i.n, align 4, !tbaa !1626
  %.pre12.i = load i32, ptr %i.m, align 8, !tbaa !1618
...
sessionBufferGrow.exit.thread10.i:                ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread10_crit_edge.i, %.sessionBufferGrow.exit.thread10_crit_edge.i
  ...
  %i.dc = load i32, ptr %i.m, align 8, !tbaa !1618
  %i.dd = add nsw i32 %i.dc, %.pr390594
  store i32 %i.dd, ptr %i.m, align 8, !tbaa !1618
  br label %sessionAppendBlob.exit
...
sessionAppendBlob.exit:                           ; preds = %sessionAppendVarint.exit, %sessionAppendVarint.exit.thread, %.critedge.i.i107, %sqlite3_realloc64.exit.thread.i.i102, %sessionBufferGrow.exit.thread10.i
  ...
  %i.df = load ptr, ptr %i.j, align 8, !tbaa !1689 ; 2 uses
...
bb.af:                                            ; preds = %sessionAppendBlob.exit
  ...
  %i.dl = load i32, ptr %i.m, align 8, !tbaa !1618
...
bb.ag:                                            ; preds = %bb.af
  %i.dp = load i32, ptr %i.n, align 4, !tbaa !1626 ; 2 uses
...
.sessionBufferGrow.exit.thread10_crit_edge.i108:  ; preds = %bb.ag
  %.pre.i109 = load ptr, ptr %6, align 8, !tbaa !1627
...
bb.ai:                                            ; preds = %bb.ai, %bb.ah
  ...
  br i1 %i.dt, label %bb.ai, label %bb.aj, !llvm.loop !1628
...
bb.al:                                            ; preds = %bb.ak, %bb.aj
  ...
  %i.dw = load ptr, ptr %6, align 8, !tbaa !1627
  %i.dx = call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i118:                    ; preds = %bb.al
  %i.dy = call fastcc ptr @sqlite3Realloc(ptr noundef %i.dw, i64 noundef %.1.i.i115), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread10_crit_edge.i122: ; preds = %sqlite3_realloc64.exit.i.i118
  store ptr %i.dy, ptr %6, align 8, !tbaa !1627
  %i.ea = trunc nsw i64 %.1.i.i115 to i32
  store i32 %i.ea, ptr %i.n, align 4, !tbaa !1626
  %.pre12.i123 = load i32, ptr %i.m, align 8, !tbaa !1618
...
sessionBufferGrow.exit.thread10.i110:             ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread10_crit_edge.i122, %.sessionBufferGrow.exit.thread10_crit_edge.i108
  ...
  %i.ed = load i32, ptr %i.m, align 8, !tbaa !1618
  %i.ee = add nsw i32 %i.ed, %i.di
  store i32 %i.ee, ptr %i.m, align 8, !tbaa !1618
...
bb.am:                                            ; preds = %sessionAppendBlob.exit126
  %i.eh = load ptr, ptr %i.g, align 8, !tbaa !253 ; 8 uses
  %i.ei = getelementptr inbounds nuw i8, ptr %.2.ph, i64 68
  %i.ej = load i32, ptr %i.ei, align 4, !tbaa !1605
...
.lr.ph450:                                        ; preds = %bb.am, %bb.an
  ...
  %i.er = load ptr, ptr %i.eq, align 8, !tbaa !1620 ; 3 uses
...
bb.an:                                            ; preds = %.lr.ph450
  ...
  %.061 = load ptr, ptr %i.et, align 8, !tbaa !1607 ; 2 uses
  %.not72 = icmp eq ptr %.061, null
  br i1 %.not72, label %.thread391, label %.lr.ph450, !llvm.loop !1787

bb.ao:                                            ; preds = %.lr.ph450
  %i.eu = getelementptr inbounds nuw i8, ptr %.061449, i64 16 ; 3 uses
  %i.ev = load i32, ptr %i.q, align 4, !tbaa !1691
  %i.ew = load i8, ptr %.061449, align 8, !tbaa !1625 ; 3 uses
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %i.ez = load i8, ptr %i.ey, align 1, !tbaa !1629
  %i.fa = icmp eq i8 %i.ez, 0
  br i1 %i.fa, label %bb.ar, label %.critedge

bb.ar:                                            ; preds = %bb.aq
  %i.fb = load i32, ptr %i.m, align 8, !tbaa !1618 ; 4 uses
  %i.fc = sext i32 %i.fb to i64                   ; 2 uses
  %i.fd = load i32, ptr %i.n, align 4, !tbaa !1626 ; 3 uses
...
.sessionBufferGrow.exit.thread5_crit_edge.i146:   ; preds = %bb.ar
  %.pre.i147 = load ptr, ptr %6, align 8, !tbaa !1627
  br label %bb.ax
...
bb.at:                                            ; preds = %bb.at, %bb.as
  ...
  br i1 %.not7.i132, label %bb.au, label %bb.at, !llvm.loop !1628
...
bb.aw:                                            ; preds = %bb.av, %bb.au
  ...
  %i.fh = load ptr, ptr %6, align 8, !tbaa !1627
  %i.fi = call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i136:                    ; preds = %bb.aw
  %i.fj = call fastcc ptr @sqlite3Realloc(ptr noundef %i.fh, i64 noundef %.1.i.i133), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i140: ; preds = %sqlite3_realloc64.exit.i.i136
  store ptr %i.fj, ptr %6, align 8, !tbaa !1627
  %i.fl = trunc nsw i64 %.1.i.i133 to i32
  store i32 %i.fl, ptr %i.n, align 4, !tbaa !1626
  %.pre9.i141 = load i32, ptr %i.m, align 8, !tbaa !1618 ; 2 uses
...
bb.ax:                                            ; preds = %.sessionBufferGrow.exit.thread5_crit_edge.i146, %sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i140
  ...
  store i32 %i.fo, ptr %i.m, align 8, !tbaa !1618
  %i.fp = getelementptr inbounds i8, ptr %i.fn, i64 %.pre-phi.i144
  store i8 23, ptr %i.fp, align 1, !tbaa !229
  %.pr396 = load i32, ptr %i.m, align 8, !tbaa !1618 ; 4 uses
  %i.fq = load i32, ptr %i.r, align 8, !tbaa !1692
  %i.fr = trunc i32 %i.fq to i8
  %i.fs = sext i32 %.pr396 to i64                 ; 2 uses
  %i.ft = load i32, ptr %i.n, align 4, !tbaa !1626 ; 3 uses
...
.sessionBufferGrow.exit.thread5_crit_edge.i168:   ; preds = %bb.ax
  %.pre.i169 = load ptr, ptr %6, align 8, !tbaa !1627
...
bb.az:                                            ; preds = %bb.az, %bb.ay
  ...
  br i1 %.not7.i154, label %bb.ba, label %bb.az, !llvm.loop !1628
...
bb.bc:                                            ; preds = %bb.bb, %bb.ba
  ...
  %i.fx = load ptr, ptr %6, align 8, !tbaa !1627
  %i.fy = call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i158:                    ; preds = %bb.bc
  %i.fz = call fastcc ptr @sqlite3Realloc(ptr noundef %i.fx, i64 noundef %.1.i.i155), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i162: ; preds = %sqlite3_realloc64.exit.i.i158
  store ptr %i.fz, ptr %6, align 8, !tbaa !1627
  %i.gb = trunc nsw i64 %.1.i.i155 to i32
  store i32 %i.gb, ptr %i.n, align 4, !tbaa !1626
  %.pre9.i163 = load i32, ptr %i.m, align 8, !tbaa !1618 ; 2 uses
...
sessionAppendByte.exit170.thread:                 ; preds = %.sessionBufferGrow.exit.thread5_crit_edge.i168, %sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i162
  ...
  store i32 %i.ge, ptr %i.m, align 8, !tbaa !1618
  %i.gf = getelementptr inbounds i8, ptr %i.gd, i64 %.pre-phi.i166
  store i8 %i.fr, ptr %i.gf, align 1, !tbaa !229
  %i.gg = load ptr, ptr %i.eu, align 8, !tbaa !1620
  %i.gh = getelementptr inbounds nuw i8, ptr %.061449, i64 8
  %i.gi = load i32, ptr %i.gh, align 8, !tbaa !1645 ; 3 uses
...
bb.bd:                                            ; preds = %sessionAppendByte.exit170.thread
  ...
  %i.gl = load i32, ptr %i.m, align 8, !tbaa !1618
  %i.gm = sext i32 %i.gl to i64                   ; 2 uses
  %i.gn = add nsw i64 %i.gm, %i.gk                ; 3 uses
  %i.go = load i32, ptr %i.n, align 4, !tbaa !1626 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !912
  %i.d = getelementptr inbounds nuw i8, ptr %i.c, i64 280
  %i.e = load i32, ptr %i.d, align 8, !tbaa !913
...
bb.a:
  ...
  %i.c = load i32, ptr %i.b, align 8, !tbaa !1618 ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load i32, ptr %i.g, align 4, !tbaa !1626 ; 3 uses
...
.sessionBufferGrow.exit.thread5_crit_edge.i:      ; preds = %bb.b
  %.pre.i = load ptr, ptr %0, align 8, !tbaa !1627
...
bb.d:                                             ; preds = %bb.d, %bb.c
  ...
  br i1 %.not7.i, label %bb.e, label %bb.d, !llvm.loop !1628
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.l = load ptr, ptr %0, align 8, !tbaa !1627
  %i.m = tail call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i:                       ; preds = %bb.g
  %i.n = tail call fastcc ptr @sqlite3Realloc(ptr noundef %i.l, i64 noundef %.1.i.i), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.i:                         ; preds = %sqlite3_realloc64.exit.i.i
  store ptr %i.n, ptr %0, align 8, !tbaa !1627
  %i.p = trunc nsw i64 %.1.i.i to i32
  store i32 %i.p, ptr %i.g, align 4, !tbaa !1626
  %.pre.i.i = load i32, ptr %3, align 4, !tbaa !24
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i: ; preds = %sessionBufferGrow.exit.i
  %.pre9.i = load i32, ptr %i.b, align 8, !tbaa !1618 ; 2 uses
  %.pre10.i = sext i32 %.pre9.i to i64
  br label %sessionBufferGrow.exit.thread5.i
...
sessionBufferGrow.exit.thread5.i:                 ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i, %.sessionBufferGrow.exit.thread5_crit_edge.i
  ...
  store i32 %i.s, ptr %i.b, align 8, !tbaa !1618
  %i.t = getelementptr inbounds i8, ptr %i.r, i64 %.pre-phi.i
  store i8 %i.a, ptr %i.t, align 1, !tbaa !229
  br label %sessionAppendByte.exit
...
sessionAppendByte.exit:                           ; preds = %bb.a, %.critedge.i.i, %sqlite3_realloc64.exit.thread.i.i, %sessionBufferGrow.exit.i, %sessionBufferGrow.exit.thread5.i
  ...
  %i.v = load i32, ptr %i.u, align 8, !tbaa !1555
  ...
  %i.x = load ptr, ptr %i.w, align 8, !tbaa !1558
  %i.y = load i32, ptr %i.u, align 8, !tbaa !1555 ; 3 uses
...
.sessionBufferGrow.exit.thread10_crit_edge.i:     ; preds = %bb.i
  %.pre.i13 = load ptr, ptr %0, align 8, !tbaa !1627
  br label %sessionBufferGrow.exit.thread10.i
...
bb.k:                                             ; preds = %bb.k, %bb.j
  ...
  br i1 %i.al, label %bb.k, label %bb.l, !llvm.loop !1628
...
bb.n:                                             ; preds = %bb.m, %bb.l
  ...
  %i.ao = load ptr, ptr %0, align 8, !tbaa !1627
  %i.ap = tail call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i21:                     ; preds = %bb.n
  %i.aq = tail call fastcc ptr @sqlite3Realloc(ptr noundef %i.ao, i64 noundef %.1.i.i18), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.i22:                       ; preds = %sqlite3_realloc64.exit.i.i21
  store ptr %i.aq, ptr %0, align 8, !tbaa !1627
  %i.as = trunc nsw i64 %.1.i.i18 to i32
  store i32 %i.as, ptr %i.ag, align 4, !tbaa !1626
  %.pre.i.i23 = load i32, ptr %3, align 4, !tbaa !24
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread10_crit_edge.i: ; preds = %sessionBufferGrow.exit.i22
  %.pre12.i = load i32, ptr %i.b, align 8, !tbaa !1618
  %.pre13.i = sext i32 %.pre12.i to i64
  br label %sessionBufferGrow.exit.thread10.i
...
sessionBufferGrow.exit.thread10.i:                ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread10_crit_edge.i, %.sessionBufferGrow.exit.thread10_crit_edge.i
  ...
  %i.av = load i32, ptr %i.b, align 8, !tbaa !1618
  %i.aw = add nsw i32 %i.av, %i.y
  store i32 %i.aw, ptr %i.b, align 8, !tbaa !1618
  br label %sessionAppendBlob.exit
...
sessionAppendBlob.exit:                           ; preds = %sessionAppendByte.exit, %bb.h, %.critedge.i.i25, %sqlite3_realloc64.exit.thread.i.i20, %sessionBufferGrow.exit.i22, %sessionBufferGrow.exit.thread10.i
  ...
  %i.ay = load ptr, ptr %i.ax, align 8, !tbaa !1561 ; 2 uses
...
.sessionBufferGrow.exit.thread10_crit_edge.i26:   ; preds = %bb.p
  %.pre.i27 = load ptr, ptr %0, align 8, !tbaa !1627
...
bb.r:                                             ; preds = %bb.r, %bb.q
  ...
  br i1 %i.bo, label %bb.r, label %bb.s, !llvm.loop !1628
...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  %i.br = load ptr, ptr %0, align 8, !tbaa !1627
  %i.bs = tail call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i36:                     ; preds = %bb.u
  %i.bt = tail call fastcc ptr @sqlite3Realloc(ptr noundef %i.br, i64 noundef %.1.i.i33), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.i37:                       ; preds = %sqlite3_realloc64.exit.i.i36
  store ptr %i.bt, ptr %0, align 8, !tbaa !1627
  %i.bv = trunc nsw i64 %.1.i.i33 to i32
  store i32 %i.bv, ptr %i.bj, align 4, !tbaa !1626
  %.pre.i.i38 = load i32, ptr %3, align 4, !tbaa !24
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread10_crit_edge.i40: ; preds = %sessionBufferGrow.exit.i37
  %.pre12.i41 = load i32, ptr %i.b, align 8, !tbaa !1618
...
sessionBufferGrow.exit.thread10.i28:              ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread10_crit_edge.i40, %.sessionBufferGrow.exit.thread10_crit_edge.i26
  ...
  %i.by = load i32, ptr %i.b, align 8, !tbaa !1618
  %i.bz = add nsw i32 %i.by, %i.bb
  store i32 %i.bz, ptr %i.b, align 8, !tbaa !1618
  br label %sessionAppendBlob.exit44
...
bb.a:
  ...
  %i.d = tail call i32 @sqlite3_initialize(), !inline_history !1059
  %.not.i.i.i = icmp eq i32 %i.d, 0
  br i1 %.not.i.i.i, label %sqlite3_realloc64.exit.i.i, label %sqlite3_realloc64.exit.thread.i.i

sqlite3_realloc64.exit.i.i:                       ; preds = %bb.a
  %i.e = tail call fastcc ptr @sqlite3Realloc(ptr noundef null, i64 noundef 256), !inline_history !1059 ; 5 uses
...
sqlite3_realloc64.exit.thread.i.i:                ; preds = %sqlite3_realloc64.exit.i.i, %bb.a
  store i32 7, ptr %i.a, align 4, !tbaa !24
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i: ; preds = %sqlite3_realloc64.exit.i.i
  store ptr %i.e, ptr %10, align 8, !tbaa !1627
  store i32 256, ptr %i.b, align 4, !tbaa !1626
  ...
  store i32 3, ptr %i.c, align 8, !tbaa !1618
  %i.g = getelementptr inbounds nuw i8, ptr %i.e, i64 3
  store i8 0, ptr %i.g, align 1, !tbaa !229
  br label %sessionAppendStr.exit
...
.preheader.i:                                     ; preds = %sessionAppendStr.exit, %bb.d
  ...
  %i.n = load i8, ptr %.0.i.i, align 1, !tbaa !229 ; 3 uses
  %i.o = load i8, ptr %.013.i.i, align 1, !tbaa !229 ; 2 uses
...
.preheader:                                       ; preds = %bb.e, %.preheader
  ...
  br i1 %i.ak, label %.preheader, label %bb.f, !llvm.loop !1628

bb.f:                                             ; preds = %.preheader
  %i.al = icmp sgt i64 %.024.i.i42, 1073741695
  %spec.select = select i1 %i.al, i64 2147483391, i64 %i.aj ; 2 uses
  %i.am = tail call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i46:                     ; preds = %bb.f
  %i.an = tail call fastcc ptr @sqlite3Realloc(ptr noundef %i.h, i64 noundef %spec.select), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i50: ; preds = %sqlite3_realloc64.exit.i.i46
  store ptr %i.an, ptr %10, align 8, !tbaa !1627
  %i.ap = trunc nsw i64 %spec.select to i32
  store i32 %i.ap, ptr %i.b, align 4, !tbaa !1626
...
sessionBufferGrow.exit.thread12.i38:              ; preds = %bb.e, %sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i50
  ...
  store i32 %i.as, ptr %i.c, align 8, !tbaa !1618
  %i.at = zext nneg i32 %i.as to i64
  %i.au = getelementptr inbounds nuw i8, ptr %i.aq, i64 %i.at
  store i8 0, ptr %i.au, align 1, !tbaa !229
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %11, i64 8
  %.pre = load i32, ptr %.phi.trans.insert, align 8, !tbaa !1618
  %.pre228 = load i32, ptr %i.a, align 4, !tbaa !24
...
bb.g:                                             ; preds = %sessionAppendStr.exit54
  ...
  %i.bb = load i32, ptr %i.ba, align 4, !tbaa !1626 ; 2 uses
...
bb.h:                                             ; preds = %bb.h, %bb.g
  ...
  br i1 %i.bf, label %bb.h, label %bb.i, !llvm.loop !1628
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %i.bi = tail call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i66:                     ; preds = %bb.k
  %i.bj = tail call fastcc ptr @sqlite3Realloc(ptr noundef null, i64 noundef %.1.i.i63), !inline_history !1059 ; 4 uses
  %i.bk = icmp eq ptr %i.bj, null
  br i1 %i.bk, label %sqlite3_free.exit, label %bb.l

bb.l:                                             ; preds = %sqlite3_realloc64.exit.i.i66
  store ptr %i.bj, ptr %11, align 8, !tbaa !1627
...
bb.p:                                             ; preds = %sqlite3_column_count.exit, %bb.f
  ...
  %i.bq = load ptr, ptr %i.bp, align 8, !tbaa !1721
...
.sessionBufferGrow.exit.thread5_crit_edge.i.i:    ; preds = %bb.t
  %.pre.i.i48 = load ptr, ptr %i.ch, align 8, !tbaa !1627
...
bb.v:                                             ; preds = %bb.v, %bb.u
  ...
  br i1 %.not7.i.i, label %bb.w, label %bb.v, !llvm.loop !1628
...
.critedge.i.i.i:                                  ; preds = %bb.x
  store i32 7, ptr %i.b, align 4, !tbaa !24
  br label %sessionAppendByte.exit.i

bb.y:                                             ; preds = %bb.x, %bb.w
  %.1.i.i.i = phi i64 [ 2147483391, %bb.x ], [ %i.ck, %bb.w ] ; 2 uses
  %i.cn = load ptr, ptr %i.ch, align 8, !tbaa !1627
  %i.co = tail call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i.i:                     ; preds = %bb.y
  %i.cp = tail call fastcc ptr @sqlite3Realloc(ptr noundef %i.cn, i64 noundef %.1.i.i.i), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i.i: ; preds = %sqlite3_realloc64.exit.i.i.i
  store ptr %i.cp, ptr %i.ch, align 8, !tbaa !1627
  %i.cr = trunc nsw i64 %.1.i.i.i to i32
  store i32 %i.cr, ptr %i.ci, align 4, !tbaa !1626
  %.pre9.i.i = load i32, ptr %i.ca, align 8, !tbaa !1618 ; 2 uses
...
sessionBufferGrow.exit.thread5.i.i:               ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i.i, %.sessionBufferGrow.exit.thread5_crit_edge.i.i
  ...
  store i32 %i.cu, ptr %i.ca, align 8, !tbaa !1618
  %i.cv = getelementptr inbounds i8, ptr %i.ct, i64 %.pre-phi.i.i
  store i8 84, ptr %i.cv, align 1, !tbaa !229
  br label %sessionAppendByte.exit.i
...
sessionAppendByte.exit.i:                         ; preds = %sessionBufferGrow.exit.thread5.i.i, %sqlite3_realloc64.exit.thread.i.i.i, %.critedge.i.i.i
  ...
  %i.cx = load i32, ptr %i.cw, align 8, !tbaa !1728
  ...
  %i.cz = load ptr, ptr %i.cy, align 8, !tbaa !1729
  %i.da = load i32, ptr %i.cw, align 8, !tbaa !1728 ; 3 uses
  %i.db = icmp sgt i32 %i.da, 0
  %.pre.pre.pre.i = load i32, ptr %i.b, align 4, !tbaa !24 ; 3 uses
...
bb.z:                                             ; preds = %sessionAppendByte.exit.i
  ...
  %i.dd = load i32, ptr %i.ca, align 8, !tbaa !1618
...
bb.aa:                                            ; preds = %bb.z
  %i.dh = load i32, ptr %i.ci, align 4, !tbaa !1626 ; 2 uses
...
.sessionBufferGrow.exit.thread10_crit_edge.i.i:   ; preds = %bb.aa
  %.pre.i31.i = load ptr, ptr %i.ch, align 8, !tbaa !1627
...
bb.ac:                                            ; preds = %bb.ac, %bb.ab
  ...
  br i1 %i.dl, label %bb.ac, label %bb.ad, !llvm.loop !1628
...
bb.af:                                            ; preds = %bb.ae, %bb.ad
  ...
  %i.do = load ptr, ptr %i.ch, align 8, !tbaa !1627
  %i.dp = tail call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i39.i:                   ; preds = %bb.af
  %i.dq = tail call fastcc ptr @sqlite3Realloc(ptr noundef %i.do, i64 noundef %.1.i.i36.i), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread10_crit_edge.i.i: ; preds = %sqlite3_realloc64.exit.i.i39.i
  store ptr %i.dq, ptr %i.ch, align 8, !tbaa !1627
  %i.ds = trunc nsw i64 %.1.i.i36.i to i32
  store i32 %i.ds, ptr %i.ci, align 4, !tbaa !1626
  %.pre12.i.i = load i32, ptr %i.ca, align 8, !tbaa !1618
...
sessionBufferGrow.exit.thread10.i.i:              ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread10_crit_edge.i.i, %.sessionBufferGrow.exit.thread10_crit_edge.i.i
  ...
  %i.dv = load i32, ptr %i.ca, align 8, !tbaa !1618
  %i.dw = add nsw i32 %i.dv, %i.da
  store i32 %i.dw, ptr %i.ca, align 8, !tbaa !1618
...
bb.ag:                                            ; preds = %sessionAppendBlob.exit.i
  ...
  %i.ec = load i32, ptr %i.ca, align 8, !tbaa !1618
...
bb.ah:                                            ; preds = %bb.ag
  %i.eg = load i32, ptr %i.ci, align 4, !tbaa !1626 ; 2 uses
...
.sessionBufferGrow.exit.thread10_crit_edge.i44.i: ; preds = %bb.ah
  %.pre.i45.i = load ptr, ptr %i.ch, align 8, !tbaa !1627
...
bb.aj:                                            ; preds = %bb.aj, %bb.ai
  ...
  br i1 %i.ek, label %bb.aj, label %bb.ak, !llvm.loop !1628
...
bb.am:                                            ; preds = %bb.al, %bb.ak
  ...
  %i.en = load ptr, ptr %i.ch, align 8, !tbaa !1627
  %i.eo = tail call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i54.i:                   ; preds = %bb.am
  %i.ep = tail call fastcc ptr @sqlite3Realloc(ptr noundef %i.en, i64 noundef %.1.i.i51.i), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread10_crit_edge.i58.i: ; preds = %sqlite3_realloc64.exit.i.i54.i
  store ptr %i.ep, ptr %i.ch, align 8, !tbaa !1627
  %i.er = trunc nsw i64 %.1.i.i51.i to i32
  store i32 %i.er, ptr %i.ci, align 4, !tbaa !1626
  %.pre12.i59.i = load i32, ptr %i.ca, align 8, !tbaa !1618
...
.thread171.i:                                     ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread10_crit_edge.i58.i, %.sessionBufferGrow.exit.thread10_crit_edge.i44.i
  ...
  %i.eu = load i32, ptr %i.ca, align 8, !tbaa !1618
  %i.ev = add nsw i32 %i.eu, %i.dz                ; 3 uses
  store i32 %i.ev, ptr %i.ca, align 8, !tbaa !1618
  store i8 1, ptr %i.bx, align 8, !tbaa !1725
...
bb.an:                                            ; preds = %sessionAppendBlob.exit.i
  ...
  %i.fc = load i32, ptr %i.ca, align 8, !tbaa !1618 ; 2 uses
...
bb.ao:                                            ; preds = %bb.an, %.thread171.i, %.thread.i
  ...
  %i.fl = load i32, ptr %i.fk, align 4, !tbaa !1626 ; 3 uses
...
.sessionBufferGrow.exit.thread5_crit_edge.i82.i:  ; preds = %bb.ao
  %.pre.i83.i = load ptr, ptr %i.fj, align 8, !tbaa !1627
  br label %bb.au
...
bb.aq:                                            ; preds = %bb.aq, %bb.ap
  ...
  br i1 %.not7.i68.i, label %bb.ar, label %bb.aq, !llvm.loop !1628
...
bb.at:                                            ; preds = %bb.as, %bb.ar
  ...
  %i.fp = load ptr, ptr %i.fj, align 8, !tbaa !1627
  %i.fq = tail call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i72.i:                   ; preds = %bb.at
  %i.fr = tail call fastcc ptr @sqlite3Realloc(ptr noundef %i.fp, i64 noundef %.1.i.i69.i), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i76.i: ; preds = %sqlite3_realloc64.exit.i.i72.i
  store ptr %i.fr, ptr %i.fj, align 8, !tbaa !1627
  %i.ft = trunc nsw i64 %.1.i.i69.i to i32
  store i32 %i.ft, ptr %i.fk, align 4, !tbaa !1626
  %.pre9.i77.i = load i32, ptr %i.ca, align 8, !tbaa !1618 ; 2 uses
...
bb.au:                                            ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i76.i, %.sessionBufferGrow.exit.thread5_crit_edge.i82.i
  ...
  store i32 %i.fw, ptr %i.ca, align 8, !tbaa !1618
  %i.fx = getelementptr inbounds i8, ptr %i.fv, i64 %.pre-phi.i80.i
  store i8 %i.fh, ptr %i.fx, align 1, !tbaa !229
  %i.fy = load i32, ptr %i.ca, align 8, !tbaa !1618 ; 4 uses
  %i.fz = sext i32 %i.fy to i64                   ; 2 uses
  %i.ga = load i32, ptr %i.fk, align 4, !tbaa !1626 ; 3 uses
...
.sessionBufferGrow.exit.thread5_crit_edge.i104.i: ; preds = %bb.au
  %.pre.i105.i = load ptr, ptr %i.fj, align 8, !tbaa !1627
...
bb.aw:                                            ; preds = %bb.aw, %bb.av
  ...
  br i1 %.not7.i90.i, label %bb.ax, label %bb.aw, !llvm.loop !1628
...
bb.az:                                            ; preds = %bb.ay, %bb.ax
  ...
  %i.ge = load ptr, ptr %i.fj, align 8, !tbaa !1627
  %i.gf = tail call i32 @sqlite3_initialize(), !inline_history !1059
...
sqlite3_realloc64.exit.i.i94.i:                   ; preds = %bb.az
  %i.gg = tail call fastcc ptr @sqlite3Realloc(ptr noundef %i.ge, i64 noundef %.1.i.i91.i), !inline_history !1059 ; 3 uses
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i98.i: ; preds = %sqlite3_realloc64.exit.i.i94.i
  store ptr %i.gg, ptr %i.fj, align 8, !tbaa !1627
  %i.gi = trunc nsw i64 %.1.i.i91.i to i32
  store i32 %i.gi, ptr %i.fk, align 4, !tbaa !1626
  %.pre9.i99.i = load i32, ptr %i.ca, align 8, !tbaa !1618 ; 2 uses
...
sessionBufferGrow.exit.thread5.i101.i:            ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread5_crit_edge.i98.i, %.sessionBufferGrow.exit.thread5_crit_edge.i104.i
  ...
  store i32 %i.gl, ptr %i.ca, align 8, !tbaa !1618
  %i.gm = getelementptr inbounds i8, ptr %i.gk, i64 %.pre-phi.i102.i
  store i8 %i.bt, ptr %i.gm, align 1, !tbaa !229
  br label %sessionAppendByte.exit106.i
...
sessionAppendByte.exit106.i:                      ; preds = %bb.az, %sqlite3_realloc64.exit.i.i94.i, %bb.ay, %bb.at, %sqlite3_realloc64.exit.i.i72.i, %bb.as, %sessionBufferGrow.exit.thread5.i101.i, %bb.an, %.thread169.i
  ...
  %i.gq = load i32, ptr %i.gp, align 8, !tbaa !1728 ; 2 uses
