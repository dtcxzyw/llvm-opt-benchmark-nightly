...
end_hunk_2
begin_hunk_3_@sqlite3CreateIndex:bb.a
  store ptr %i.xj, ptr %.1400751, align 8, !tbaa !935
  %i.xm = getelementptr inbounds nuw i8, ptr %i.xj, i64 40 ; 3 uses
  %i.xn = load ptr, ptr %i.xm, align 8, !tbaa !2795
  store ptr %i.xn, ptr %i.xh, align 8, !tbaa !2795
  store ptr %.lcssa, ptr %i.xm, align 8, !tbaa !2795
  %i.xo = load ptr, ptr %i.xh, align 8, !tbaa !2795 ; 2 uses
  %.not506 = icmp eq ptr %i.xo, null
  br i1 %.not506, label %.critedge.thread, label %.lr.ph752, !llvm.loop !3610

.critedge:                                        ; preds = %.lr.ph749.preheader, %.lr.ph749
  %i.xp = phi ptr [ %i.xr, %.lr.ph749 ], [ %i.xb, %.lr.ph749.preheader ] ; 2 uses
  %i.xq = getelementptr inbounds nuw i8, ptr %i.xp, i64 40
  %i.xr = load ptr, ptr %i.xq, align 8, !tbaa !935 ; 4 uses
  %.not504 = icmp eq ptr %i.xr, null
  br i1 %.not504, label %.critedge.thread, label %.lr.ph749, !llvm.loop !3609
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !3471 ; 7 uses
...
bb.h:                                             ; preds = %bb.f
  ...
  store i32 %i.z, ptr %i.s, align 8, !tbaa !5
...
bb.k:                                             ; preds = %bb.k, %bb.j
  ...
  %i.ah = load i8, ptr %.0, align 1, !tbaa !227
  ...
  br i1 %.not29, label %.preheader, label %bb.k, !llvm.loop !3611
...
.preheader:                                       ; preds = %bb.k, %.preheader
  ...
  br i1 %.not30, label %bb.l, label %.preheader, !llvm.loop !3612
...
bb.l:                                             ; preds = %.preheader
  ...
  store i32 %i.av, ptr %i.aw, align 8, !tbaa !376
...
bb.n:                                             ; preds = %bb.m
  tail call fastcc void @sqlite3ExprDeleteNN(ptr noundef %i.c, ptr noundef %1), !inline_history !144
  br label %sqlite3ExprDelete.exit
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !651    ; 12 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 344
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !1093 ; 9 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.j = load i16, ptr %i.i, align 2, !tbaa !881  ; 2 uses
  %i.k = zext i16 %i.j to i64
  %i.l = add nuw nsw i64 %i.k, 4294967295
  %i.m = icmp slt i16 %i.j, 1
  br i1 %i.m, label %sqlite3ExprListDelete.exit, label %bb.e
...
bb.f:                                             ; preds = %bb.e
  %i.n = load i32, ptr %3, align 8, !tbaa !5
  %.not147 = icmp eq i32 %i.n, 1
  br i1 %.not147, label %.preheader197, label %sqlite3ExprListDelete.exit.thread

sqlite3ExprListDelete.exit.thread:                ; preds = %bb.f
  %i.o = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !882
  %i.q = and i64 %i.l, 4294967295
  %i.r = getelementptr inbounds nuw [16 x i8], ptr %i.p, i64 %i.q
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !929
  tail call void (ptr, ptr, ...) @sqlite3ErrorMsg(ptr noundef nonnull %0, ptr noundef nonnull @.str.835, ptr noundef %i.s, ptr noundef %2)
  br label %bb.as

bb.g:                                             ; preds = %bb.c
  %.not = icmp eq ptr %3, null
  %.pre = load i32, ptr %1, align 8, !tbaa !5     ; 3 uses
  br i1 %.not, label %.thread, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.t = load i32, ptr %3, align 8, !tbaa !5
  %.not145 = icmp eq i32 %i.t, %.pre
  br i1 %.not145, label %.preheader197, label %sqlite3DbFree.exit.thread190

sqlite3DbFree.exit.thread190:                     ; preds = %bb.h
...
.thread:                                          ; preds = %bb.g, %bb.e
  ...
  %i.u = sext i32 %.1132 to i64                   ; 2 uses
  %i.v = shl nsw i64 %i.u, 4
  %i.w = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 2 uses
  %i.x = load i32, ptr %i.w, align 8, !tbaa !376
  %i.y = zext i32 %i.x to i64
  %i.z = add nsw i64 %i.v, 65
  %i.aa = add nsw i64 %i.z, %i.y
  br label %.loopexit198

.preheader197:                                    ; preds = %bb.h, %bb.f
  %.1132.ph = phi i32 [ %.pre, %bb.h ], [ 1, %bb.f ] ; 3 uses
  %i.ab = sext i32 %.1132.ph to i64               ; 3 uses
  %i.ac = shl nsw i64 %i.ab, 4
  %i.ad = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 3 uses
  %i.ae = load i32, ptr %i.ad, align 8, !tbaa !376
  %i.af = zext i32 %i.ae to i64
  %i.ag = add nsw i64 %i.ac, 65
  %i.ah = add nsw i64 %i.ag, %i.af                ; 2 uses
  %i.ai = load i32, ptr %3, align 8, !tbaa !5     ; 2 uses
  %i.aj = icmp sgt i32 %i.ai, 0
  br i1 %i.aj, label %.lr.ph.preheader, label %.loopexit198
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %sqlite3Strlen30.exit
  ...
  %.0128204 = phi i64 [ %i.ah, %.lr.ph.preheader ], [ %i.ar, %sqlite3Strlen30.exit ]
  %i.ak = getelementptr inbounds nuw [24 x i8], ptr %3, i64 %indvars.iv
  %i.al = getelementptr inbounds nuw i8, ptr %i.ak, i64 16
  %i.am = load ptr, ptr %i.al, align 8, !tbaa !3485 ; 2 uses
  %i.an = icmp eq ptr %i.am, null
  br i1 %i.an, label %sqlite3Strlen30.exit, label %bb.i

bb.i:                                             ; preds = %.lr.ph
  %i.ao = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %i.am) #60
  %i.ap = and i64 %i.ao, 1073741823
  %i.aq = add nuw nsw i64 %i.ap, 1
  br label %sqlite3Strlen30.exit

sqlite3Strlen30.exit:                             ; preds = %.lr.ph, %bb.i
  %.0.i = phi i64 [ %i.aq, %bb.i ], [ 1, %.lr.ph ]
  %i.ar = add nsw i64 %.0.i, %.0128204            ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.loopexit198, label %.lr.ph, !llvm.loop !3613

.loopexit198:                                     ; preds = %sqlite3Strlen30.exit, %.thread, %.preheader197
  %.not148252 = phi i1 [ false, %.thread ], [ true, %.preheader197 ], [ true, %sqlite3Strlen30.exit ]
  %i.as = phi ptr [ %i.w, %.thread ], [ %i.ad, %.preheader197 ], [ %i.ad, %sqlite3Strlen30.exit ] ; 3 uses
  %i.at = phi i64 [ %i.u, %.thread ], [ %i.ab, %.preheader197 ], [ %i.ab, %sqlite3Strlen30.exit ]
  %.1132250 = phi i32 [ %.1132, %.thread ], [ %.1132.ph, %.preheader197 ], [ %.1132.ph, %sqlite3Strlen30.exit ] ; 5 uses
  %.1129 = phi i64 [ %i.aa, %.thread ], [ %i.ah, %.preheader197 ], [ %i.ar, %sqlite3Strlen30.exit ] ; 3 uses
  %.not.i.i = icmp eq ptr %i.a, null
  br i1 %.not.i.i, label %bb.k, label %bb.j

bb.j:                                             ; preds = %.loopexit198
  %i.au = tail call fastcc ptr @sqlite3DbMallocRawNN(ptr noundef nonnull %i.a, i64 noundef %.1129), !inline_history !608
  br label %sqlite3DbMallocRaw.exit.i

bb.k:                                             ; preds = %.loopexit198
  %i.av = tail call fastcc ptr @sqlite3Malloc(i64 noundef %.1129), !inline_history !608
  br label %sqlite3DbMallocRaw.exit.i

sqlite3DbMallocRaw.exit.i:                        ; preds = %bb.k, %bb.j
  %.0.i.i = phi ptr [ %i.au, %bb.j ], [ %i.av, %bb.k ] ; 15 uses
...
bb.l:                                             ; preds = %sqlite3DbMallocRaw.exit.i
  ...
  store ptr %i.c, ptr %.0.i.i, align 8, !tbaa !3525
  %i.aw = getelementptr inbounds nuw i8, ptr %i.c, i64 72 ; 2 uses
  %i.ax = load ptr, ptr %i.aw, align 8, !tbaa !227
  %i.ay = getelementptr inbounds nuw i8, ptr %.0.i.i, i64 8
  store ptr %i.ax, ptr %i.ay, align 8, !tbaa !3462
  %i.az = getelementptr inbounds nuw i8, ptr %.0.i.i, i64 64 ; 4 uses
  %i.ba = getelementptr inbounds [16 x i8], ptr %i.az, i64 %i.at ; 10 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %.0.i.i, i64 16 ; 2 uses
  store ptr %i.ba, ptr %i.bb, align 8, !tbaa !251
  %i.bc = load i8, ptr %i.e, align 4, !tbaa !1091
...
bb.m:                                             ; preds = %bb.l
  %i.bd = load ptr, ptr %0, align 8, !tbaa !651   ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.bd, null
  br i1 %.not.i.i.i, label %bb.o, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.be = tail call fastcc ptr @sqlite3DbMallocRawNN(ptr noundef nonnull %i.bd, i64 noundef 32), !inline_history !608
  br label %sqlite3DbMallocRaw.exit.i.i

bb.o:                                             ; preds = %bb.m
  %i.bf = tail call fastcc ptr @sqlite3Malloc(i64 noundef 32), !inline_history !608
  br label %sqlite3DbMallocRaw.exit.i.i

sqlite3DbMallocRaw.exit.i.i:                      ; preds = %bb.o, %bb.n
  %.0.i.i.i = phi ptr [ %i.be, %bb.n ], [ %i.bf, %bb.o ] ; 5 uses
  %.not.i.i153 = icmp eq ptr %.0.i.i.i, null
  br i1 %.not.i.i153, label %sqlite3RenameTokenMap.exit, label %bb.p
...
bb.p:                                             ; preds = %sqlite3DbMallocRaw.exit.i.i
  ...
  store ptr %i.ba, ptr %.0.i.i.i, align 8, !tbaa !3500
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.bg, ptr noundef nonnull readonly align 8 dereferenceable(16) %2, i64 16, i1 false), !tbaa.struct !3492
  %i.bh = getelementptr inbounds nuw i8, ptr %0, i64 408 ; 2 uses
  %i.bi = load ptr, ptr %i.bh, align 8, !tbaa !3550
  %i.bj = getelementptr inbounds nuw i8, ptr %.0.i.i.i, i64 24
  store ptr %i.bi, ptr %i.bj, align 8, !tbaa !3551
  store ptr %.0.i.i.i, ptr %i.bh, align 8, !tbaa !3550
  br label %sqlite3RenameTokenMap.exit

sqlite3RenameTokenMap.exit:                       ; preds = %bb.l, %bb.l, %bb.l, %bb.p, %sqlite3DbMallocRaw.exit.i.i
  %i.bk = load ptr, ptr %2, align 8, !tbaa !377
  %i.bl = load i32, ptr %i.as, align 8, !tbaa !376
  %i.bm = zext i32 %i.bl to i64
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.ba, ptr align 1 %i.bk, i64 %i.bm, i1 false)
  %i.bn = load i32, ptr %i.as, align 8, !tbaa !376
  %i.bo = zext i32 %i.bn to i64
  %i.bp = getelementptr inbounds nuw i8, ptr %i.ba, i64 %i.bo
  store i8 0, ptr %i.bp, align 1, !tbaa !227
  %i.bq = load i8, ptr %i.ba, align 1, !tbaa !227 ; 3 uses
  %i.br = zext i8 %i.bq to i64
  %i.bs = getelementptr inbounds nuw i8, ptr @sqlite3CtypeMap, i64 %i.br
  %i.bt = load i8, ptr %i.bs, align 1, !tbaa !227
  %.not.i154 = icmp sgt i8 %i.bt, -1
  br i1 %.not.i154, label %sqlite3Dequote.exit, label %bb.q

bb.q:                                             ; preds = %sqlite3RenameTokenMap.exit
  %i.bu = icmp eq i8 %i.bq, 91
  %spec.store.select.i = select i1 %i.bu, i8 93, i8 %i.bq ; 3 uses
  br label %bb.r

bb.r:                                             ; preds = %bb.t, %bb.q
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %bb.t ], [ 0, %bb.q ] ; 3 uses
  %.020.i = phi i32 [ %i.cf, %bb.t ], [ 1, %bb.q ] ; 3 uses
  %i.bv = sext i32 %.020.i to i64
  %i.bw = getelementptr inbounds i8, ptr %i.ba, i64 %i.bv
  %i.bx = load i8, ptr %i.bw, align 1, !tbaa !227 ; 2 uses
  %i.by = icmp eq i8 %i.bx, %spec.store.select.i
  br i1 %i.by, label %bb.s, label %bb.t

bb.s:                                             ; preds = %bb.r
  %i.bz = add nsw i32 %.020.i, 1                  ; 2 uses
  %i.ca = sext i32 %i.bz to i64
  %i.cb = getelementptr inbounds i8, ptr %i.ba, i64 %i.ca
  %i.cc = load i8, ptr %i.cb, align 1, !tbaa !227
  %i.cd = icmp eq i8 %i.cc, %spec.store.select.i
  br i1 %i.cd, label %bb.t, label %bb.u

bb.t:                                             ; preds = %bb.s, %bb.r
  %spec.store.select.sink.i = phi i8 [ %spec.store.select.i, %bb.s ], [ %i.bx, %bb.r ]
  %.121.i = phi i32 [ %i.bz, %bb.s ], [ %.020.i, %bb.r ]
  %i.ce = getelementptr inbounds nuw i8, ptr %i.ba, i64 %indvars.iv.i
  store i8 %spec.store.select.sink.i, ptr %i.ce, align 1, !tbaa !227
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1
end_hunk_3
begin_hunk_4_@sqlite3ExprCodeTarget:bb.a
...
end_hunk_4
begin_hunk_5_@sqlite3ExprCompare:bb.a
...
end_hunk_5
begin_hunk_6_@sqlite3FindInIndex:bb.a
...
end_hunk_6
begin_hunk_7_@convertToWithoutRowidTable:bb.a
...
bb.e:                                             ; preds = %bb.d
end_hunk_7
begin_hunk_8_@sqlite3VdbeAddParseSchemaOp:bb.a
...
end_hunk_8
begin_hunk_9_@resolveExprStep:bb.a
...
end_hunk_9
begin_hunk_10_@viewGetColumnNames:bb.a
...
end_hunk_11
begin_hunk_12_@selectWindowRewriteExprCb:bb.a
...
end_hunk_12
begin_hunk_13_@whereOmitNoopJoin:bb.a
...
end_hunk_13
begin_hunk_14_@whereLoopAddVirtual:bb.a
...
end_hunk_14
begin_hunk_15_@whereLoopOutputAdjust:bb.a
...
end_hunk_15
begin_hunk_16_@whereLoopAddBtreeIndex:bb.a
...
end_hunk_16
begin_hunk_17_@fts3SnippetFunc:bb.a
