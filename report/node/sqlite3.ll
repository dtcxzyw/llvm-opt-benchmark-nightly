...
vector.body988:                                   ; preds = %vector.body988, %vector.ph986
  ...
  br i1 %i.bx, label %middle.block995, label %vector.body988, !llvm.loop !6419
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i.1, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !6420
...
vector.body1010:                                  ; preds = %vector.body1010, %vector.ph1008
  ...
  br i1 %i.dm, label %middle.block1015, label %vector.body1010, !llvm.loop !6421
...
vec.epilog.vector.body1026:                       ; preds = %vec.epilog.vector.body1026, %vec.epilog.ph1024
  ...
  br i1 %i.dp, label %vec.epilog.middle.block1030, label %vec.epilog.vector.body1026, !llvm.loop !6422
...
.lr.ph50.i.i:                                     ; preds = %.lr.ph50.i.i.preheader, %.lr.ph50.i.i
  ...
  br i1 %i.dt, label %.lr.ph50.i.i, label %.loopexit.loopexit.i.i, !llvm.loop !6423
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.eu, label %middle.block, label %vector.body, !llvm.loop !6424
...
.lr.ph.i111.i:                                    ; preds = %.lr.ph.i111.i.prol.loopexit, %.lr.ph.i111.i
  ...
  br i1 %exitcond.not.i118.i.1, label %._crit_edge.loopexit.i119.i, label %.lr.ph.i111.i, !llvm.loop !6425
...
vector.body966:                                   ; preds = %vector.body966, %vector.ph964
  ...
  br i1 %i.gj, label %middle.block971, label %vector.body966, !llvm.loop !6426
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.gm, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !6427
...
.lr.ph50.i103.i:                                  ; preds = %.lr.ph50.i103.i.preheader, %.lr.ph50.i103.i
  ...
  br i1 %i.gq, label %.lr.ph50.i103.i, label %.loopexit.loopexit.i108.i, !llvm.loop !6428
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %.lr.ph.i, !llvm.loop !6429
...
.lr.ph.i163.2.i:                                  ; preds = %.lr.ph.i163.1.i
  ...
  %i.ii = load i8, ptr %i.ih, align 1, !tbaa !741
...
._crit_edge.i168.i:                               ; preds = %.lr.ph.i163.2.i, %._crit_edge.i168.i
  ...
  br i1 %.not.i424.i, label %hasVowel.exit425.i, label %._crit_edge.i168.i, !llvm.loop !6430

hasVowel.exit425.i:                               ; preds = %._crit_edge.i168.i
  %i.im = load i8, ptr %.0.i423.i, align 1, !tbaa !741
...
hasVowel.exit425.i..lr.ph.i183.i_crit_edge:       ; preds = %hasVowel.exit425.i
  %.pre706 = load i8, ptr %scevgep799.i, align 1, !tbaa !741
...
._crit_edge.i178.i:                               ; preds = %.lr.ph.i150.2.i, %._crit_edge.i178.i
  ...
  br i1 %.not.i427.i, label %hasVowel.exit428.i, label %._crit_edge.i178.i, !llvm.loop !6430

hasVowel.exit428.i:                               ; preds = %._crit_edge.i178.i
  %i.ip = load i8, ptr %.0.i426.i, align 1, !tbaa !741
...
.lr.ph.i183.i:                                    ; preds = %hasVowel.exit425.i..lr.ph.i183.i_crit_edge, %hasVowel.exit428.i
  ...
  store ptr %storemerge, ptr %i.b, align 8, !tbaa !747
...
.lr.ph.i183.1.i:                                  ; preds = %.lr.ph.i183.i
  ...
  %i.is = load i8, ptr %i.ir, align 1, !tbaa !741
...
.lr.ph33.i190.preheader.i:                        ; preds = %.lr.ph.i183.1.i
  ...
  store i8 101, ptr %i.iu, align 1, !tbaa !741
  store ptr %i.iu, ptr %i.b, align 8, !tbaa !747
  br label %stem.exit162.thread.i.thread

.lr.ph.i196.1.i:                                  ; preds = %.lr.ph.i183.i
  %i.iv = getelementptr inbounds nuw i8, ptr %storemerge, i64 1
  %i.iw = load i8, ptr %i.iv, align 1, !tbaa !741
