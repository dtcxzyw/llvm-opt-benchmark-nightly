...
bb.t:                                             ; preds = %bb.s
  ...
  %i.hb = load ptr, ptr %i.ha, align 8, !tbaa !525
...
bb.x:                                             ; preds = %bb.w, %bb.v
  ...
  %i.ho = load ptr, ptr %i.hn, align 8, !tbaa !518
  ...
  %i.hs = load ptr, ptr %i.hr, align 8, !tbaa !683
...
._crit_edge371.i.i:                               ; preds = %bb.z
  ...
  %.pre.i.i = load ptr, ptr %.phi.trans.insert.i.i, align 8, !tbaa !525
...
.thread252.i.i:                                   ; preds = %._crit_edge371.i.i, %bb.z, %bb.t
  ...
  %.0169.val.i.i = load ptr, ptr %i.hx, align 8, !tbaa !518
  %i.hy = getelementptr i8, ptr %.0169337.i.i, i64 48
  %.0169.val231.i.i = load i32, ptr %i.hy, align 8, !tbaa !527
...
.thread264.i.i:                                   ; preds = %.thread252.i.i
  ...
  %i.id = load i16, ptr %i.ic, align 4, !tbaa !521
  %i.ie = or i16 %i.id, 64
  store i16 %i.ie, ptr %i.ic, align 4, !tbaa !521
  br label %bb.ab

bb.aa:                                            ; preds = %bb.x
  %i.if = getelementptr inbounds nuw i8, ptr %.0169337.i.i, i64 52 ; 2 uses
  %i.ig = load i16, ptr %i.if, align 4, !tbaa !521
  %i.ih = and i16 %i.ig, -65
  store i16 %i.ih, ptr %i.if, align 4, !tbaa !521
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f) #59
  br label %bb.ab
...
bb.ab:                                            ; preds = %bb.aa, %.thread264.i.i
  ...
  %i.ij = load ptr, ptr %i.ii, align 8, !tbaa !525 ; 2 uses
...
bb.ae:                                            ; preds = %sqlite3_malloc.exit.i.i.i
  ...
  %i.iz = load ptr, ptr %i.iy, align 8, !tbaa !475
  %i.ja = getelementptr inbounds nuw i8, ptr %i.iz, i64 16
  %i.jb = load ptr, ptr %i.ja, align 8, !tbaa !1435
  ...
  %i.jm = load i8, ptr %i.jl, align 1, !tbaa !229
  ...
  store i32 %i.km, ptr %i.kn, align 4, !tbaa !24
...
bb.af:                                            ; preds = %bb.ai, %.lr.ph.i.i.i
  ...
  %i.lk = load ptr, ptr %i.lj, align 8, !tbaa !475
  %i.ll = getelementptr inbounds nuw i8, ptr %i.lk, i64 16
  %i.lm = load ptr, ptr %i.ll, align 8, !tbaa !1435
...
bb.ag:                                            ; preds = %bb.af
  %i.lp = load <8 x i8>, ptr %i.iq, align 1, !tbaa !229
...
walChecksumBytes.exit.i.i.i.i:                    ; preds = %.preheader96.i.i.i.i.i, %.preheader.i.i.i.i.i
  ...
  store i8 %i.lx, ptr %i.kx, align 16, !tbaa !229
  %i.ly = lshr i32 %i.lv, 16
  %i.lz = trunc i32 %i.ly to i8
  store i8 %i.lz, ptr %i.ky, align 1, !tbaa !229
  %i.ma = lshr i32 %i.lv, 8
  %i.mb = trunc i32 %i.ma to i8
  store i8 %i.mb, ptr %i.kz, align 2, !tbaa !229
  %i.mc = trunc i32 %i.lv to i8
  store i8 %i.mc, ptr %i.la, align 1, !tbaa !229
  %i.md = load i32, ptr %i.kn, align 4, !tbaa !24 ; 4 uses
  %i.me = lshr i32 %i.md, 24
  %i.mf = trunc nuw i32 %i.me to i8
  store i8 %i.mf, ptr %i.lb, align 4, !tbaa !229
  %i.mg = lshr i32 %i.md, 16
  %i.mh = trunc i32 %i.mg to i8
  store i8 %i.mh, ptr %i.lc, align 1, !tbaa !229
  %i.mi = lshr i32 %i.md, 8
  %i.mj = trunc i32 %i.mi to i8
  store i8 %i.mj, ptr %i.ld, align 2, !tbaa !229
  %i.mk = trunc i32 %i.md to i8
  store i8 %i.mk, ptr %i.le, align 1, !tbaa !229
  br label %bb.ai
...
bb.ai:                                            ; preds = %bb.ah, %walChecksumBytes.exit.i.i.i.i
  %i.ml = load ptr, ptr %i.go, align 8, !tbaa !2194 ; 2 uses
  %i.mm = load ptr, ptr %i.ml, align 8, !tbaa !475
  %i.mn = getelementptr inbounds nuw i8, ptr %i.mm, i64 24
  %i.mo = load ptr, ptr %i.mn, align 8, !tbaa !683
  %i.mp = call i32 %i.mo(ptr noundef nonnull %i.ml, ptr noundef nonnull %i.a, i32 noundef 24, i64 noundef %i.li) #59, !inline_history !2323 ; 2 uses
  %i.mq = add i32 %.03744.i.i.i, 1                ; 2 uses
  %i.mr = icmp eq i32 %i.mp, 0
  %i.ms = icmp ule i32 %i.mq, %.1165273.i.i
  %i.mt = and i1 %i.ms, %i.mr
  br i1 %i.mt, label %bb.af, label %._crit_edge.i.i.i, !llvm.loop !2324

._crit_edge.i.i.i:                                ; preds = %bb.ai, %bb.af, %bb.ae
  %.036.lcssa.i.i.i = phi i32 [ %i.jc, %bb.ae ], [ %i.mp, %bb.ai ], [ %i.ln, %bb.af ] ; 2 uses
  %i.mu = load i32, ptr @sqlite3Config, align 8, !tbaa !177
  %.not.i42.i.i.i = icmp eq i32 %i.mu, 0
  br i1 %.not.i42.i.i.i, label %bb.am, label %bb.aj

bb.aj:                                            ; preds = %._crit_edge.i.i.i
  %i.mv = load ptr, ptr @mem0, align 8, !tbaa !178 ; 2 uses
  %.not.i.i.i.i.i = icmp eq ptr %i.mv, null
  br i1 %.not.i.i.i.i.i, label %sqlite3_mutex_enter.exit.i.i.i.i, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  %i.mw = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 128), align 8, !tbaa !10
  call void %i.mw(ptr noundef nonnull %i.mv) #59, !inline_history !2325
  br label %sqlite3_mutex_enter.exit.i.i.i.i

sqlite3_mutex_enter.exit.i.i.i.i:                 ; preds = %bb.ak, %bb.aj
  %i.mx = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 56), align 8, !tbaa !96
  %i.my = call i32 %i.mx(ptr noundef nonnull %i.iq) #59, !inline_history !2326
  %i.mz = sext i32 %i.my to i64
  %i.na = load i64, ptr @sqlite3Stat, align 8, !tbaa !19
  %i.nb = sub nsw i64 %i.na, %i.mz
  store i64 %i.nb, ptr @sqlite3Stat, align 8, !tbaa !19
  %i.nc = load i64, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Stat, i64 72), align 8, !tbaa !19
  %i.nd = add nsw i64 %i.nc, -1
  store i64 %i.nd, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Stat, i64 72), align 8, !tbaa !19
  %i.ne = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 40), align 8, !tbaa !182
  call void %i.ne(ptr noundef nonnull %i.iq) #59, !inline_history !2327
  %i.nf = load ptr, ptr @mem0, align 8, !tbaa !178 ; 2 uses
...
bb.al:                                            ; preds = %sqlite3_mutex_enter.exit.i.i.i.i
  %i.ng = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 144), align 8, !tbaa !20
  call void %i.ng(ptr noundef nonnull %i.nf) #59, !inline_history !2328
  br label %walRewriteChecksums.exit.i.i

bb.am:                                            ; preds = %._crit_edge.i.i.i
  %i.nh = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 40), align 8, !tbaa !182
  call void %i.nh(ptr noundef nonnull %i.iq) #59, !inline_history !2327
  br label %walRewriteChecksums.exit.i.i
...
bb.an:                                            ; preds = %.thread283.i.i
  ...
  %i.nk = load i8, ptr %i.nj, align 1, !tbaa !2267
  %.not217.i.i = icmp eq i8 %i.nk, 0
  br i1 %.not217.i.i, label %sqlite3OsSync.exit237.i.i, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  %i.nl = load ptr, ptr %i.go, align 8, !tbaa !2194 ; 2 uses
  %i.nm = load ptr, ptr %i.nl, align 8, !tbaa !475
  %i.nn = getelementptr inbounds nuw i8, ptr %i.nm, i64 88
  %i.no = load ptr, ptr %i.nn, align 8, !tbaa !2079 ; 2 uses
...
sqlite3OsSectorSize.exit.i.i.i:                   ; preds = %bb.ao
  %i.np = call i32 %i.no(ptr noundef nonnull %i.nl) #59, !inline_history !2329
...
sqlite3SectorSize.exit.i.i:                       ; preds = %sqlite3OsSectorSize.exit.i.i.i, %bb.ao
  ...
  %i.nu = add nsw i64 %i.nt, %.1181271.i.i
  %.fr218.i.i = freeze i64 %i.nu
  %i.nv = add i64 %.fr218.i.i, -1                 ; 2 uses
  %i.nw = srem i64 %i.nv, %i.nt
  %i.nx = sub nsw i64 %i.nv, %i.nw                ; 4 uses
  store i64 %i.nx, ptr %i.gr, align 8, !tbaa !2316
  %.not313.i.i = icmp eq i64 %i.nx, %.1181271.i.i
  %.not220341.i.i = icmp slt i64 %.1181271.i.i, %i.nx
  br i1 %.not220341.i.i, label %.lr.ph344.i.i, label %._crit_edge345.i.i

.lr.ph344.i.i:                                    ; preds = %sqlite3SectorSize.exit.i.i
  %i.ny = getelementptr i8, ptr %.1178272.i.i, i64 8
  %i.nz = getelementptr i8, ptr %.1178272.i.i, i64 48
  br label %bb.ap

bb.ap:                                            ; preds = %bb.aq, %.lr.ph344.i.i
  %.2182343.i.i = phi i64 [ %.1181271.i.i, %.lr.ph344.i.i ], [ %i.ob, %bb.aq ] ; 2 uses
  %.0183342.i.i = phi i32 [ 0, %.lr.ph344.i.i ], [ %i.oc, %bb.aq ]
  %.0177.val.i.i = load ptr, ptr %i.ny, align 8, !tbaa !518
  %.0177.val230.i.i = load i32, ptr %i.nz, align 8, !tbaa !527
  %i.oa = call fastcc i32 @walWriteOneFrame(ptr noundef %4, ptr %.0177.val.i.i, i32 %.0177.val230.i.i, i32 noundef %2, i64 noundef %.2182343.i.i), !inline_history !2304 ; 2 uses
  %.not219.i.i = icmp eq i32 %i.oa, 0
  br i1 %.not219.i.i, label %bb.aq, label %sqlite3WalFrames.exit.thread

bb.aq:                                            ; preds = %bb.ap
  %i.ob = add nsw i64 %.2182343.i.i, %i.gw        ; 2 uses
  %i.oc = add nuw nsw i32 %.0183342.i.i, 1        ; 2 uses
...
._crit_edge345.i.i:                               ; preds = %bb.aq, %sqlite3SectorSize.exit.i.i
  %.0183.lcssa.i.i = phi i32 [ 0, %sqlite3SectorSize.exit.i.i ], [ %i.oc, %bb.aq ] ; 2 uses
...
sqlite3OsSync.exit237.i.i:                        ; preds = %._crit_edge345.i.i, %bb.an
  ...
  %i.od = load ptr, ptr %i.gp, align 8, !tbaa !475
  %i.oe = getelementptr inbounds nuw i8, ptr %i.od, i64 40
  %i.of = load ptr, ptr %i.oe, align 8, !tbaa !735
  %i.og = call i32 %i.of(ptr noundef nonnull %i.gp, i32 noundef range(i32 0, 256) %i.ni) #59, !inline_history !2312
  br label %.thread308.i.i

.thread308.i.i:                                   ; preds = %sqlite3OsSync.exit237.i.i, %._crit_edge345.i.i, %.thread283.i.i
  %.12312.i.i = phi i32 [ 0, %.thread283.i.i ], [ 0, %._crit_edge345.i.i ], [ %i.og, %sqlite3OsSync.exit237.i.i ] ; 3 uses
  %.3186311.i.i = phi i32 [ 0, %.thread283.i.i ], [ %.0183.lcssa.i.i, %._crit_edge345.i.i ], [ %.1184294.i.i, %sqlite3OsSync.exit237.i.i ] ; 4 uses
  %i.oh = getelementptr inbounds nuw i8, ptr %i.bi, i64 67 ; 2 uses
  %i.oi = load i8, ptr %i.oh, align 1, !tbaa !2038
...
bb.ar:                                            ; preds = %.thread308.i.i
  ...
  %i.ok = load i64, ptr %i.oj, align 8, !tbaa !2265 ; 2 uses
  %i.ol = icmp sgt i64 %i.ok, -1
  br i1 %i.ol, label %bb.as, label %.thread303.i.i

bb.as:                                            ; preds = %bb.ar
  %i.om = add i32 %.3186311.i.i, %.1165273.i.i
  ...
  call fastcc void @walLimitSize(ptr noundef nonnull %i.bi, i64 noundef %spec.select229.i.i), !inline_history !2304
  store i8 0, ptr %i.oh, align 1, !tbaa !2038
  br label %.thread303.i.i

.thread303.i.i:                                   ; preds = %bb.as, %bb.ar, %.thread308.i.i, %._crit_edge.i.i
  %.12307.i.i = phi i32 [ 0, %._crit_edge.i.i ], [ %.12312.i.i, %bb.as ], [ %.12312.i.i, %bb.ar ], [ %.12312.i.i, %.thread308.i.i ] ; 2 uses
  %.3186306.i.i = phi i32 [ 0, %._crit_edge.i.i ], [ %.3186311.i.i, %bb.as ], [ %.3186311.i.i, %bb.ar ], [ %.3186311.i.i, %.thread308.i.i ] ; 2 uses
  %i.oq = load i32, ptr %i.cz, align 8, !tbaa !2182 ; 2 uses
  %i.or = icmp ne ptr %.0..12355, null
  %i.os = icmp eq i32 %.12307.i.i, 0
...
.preheader.i.i:                                   ; preds = %bb.au, %.thread303.i.i
  %.2166.lcssa.i.i = phi i32 [ %i.oq, %.thread303.i.i ], [ %.3167.i.i, %bb.au ] ; 2 uses
  %.13.lcssa.i.i = phi i32 [ %.12307.i.i, %.thread303.i.i ], [ %.14.i.i, %bb.au ] ; 2 uses
  %i.ou = icmp eq i32 %.13.lcssa.i.i, 0           ; 2 uses
  %i.ov = icmp sgt i32 %.3186306.i.i, 0
...
.lr.ph354.i.i:                                    ; preds = %.preheader.i.i
  %i.ox = getelementptr inbounds nuw i8, ptr %.1178272.i.i, i64 48
  br label %bb.av

.lr.ph349.i.i:                                    ; preds = %.thread303.i.i, %bb.au
  %.2166348.i.i = phi i32 [ %.3167.i.i, %bb.au ], [ %i.oq, %.thread303.i.i ] ; 2 uses
  %.1170347.i.i = phi ptr [ %i.ph, %bb.au ], [ %.0..12355, %.thread303.i.i ] ; 3 uses
  %i.oy = getelementptr inbounds nuw i8, ptr %.1170347.i.i, i64 52
  %i.oz = load i16, ptr %i.oy, align 4, !tbaa !521
  %i.pa = and i16 %i.oz, 64
  %i.pb = icmp eq i16 %i.pa, 0
  br i1 %i.pb, label %bb.au, label %bb.at

bb.at:                                            ; preds = %.lr.ph349.i.i
  %i.pc = add i32 %.2166348.i.i, 1                ; 2 uses
  %i.pd = getelementptr inbounds nuw i8, ptr %.1170347.i.i, i64 48
  %i.pe = load i32, ptr %i.pd, align 8, !tbaa !527
  %i.pf = call fastcc i32 @walIndexAppend(ptr noundef %i.bi, i32 noundef %i.pc, i32 noundef %i.pe), !inline_history !2304
  br label %bb.au

bb.au:                                            ; preds = %bb.at, %.lr.ph349.i.i
  %.3167.i.i = phi i32 [ %.2166348.i.i, %.lr.ph349.i.i ], [ %i.pc, %bb.at ] ; 2 uses
end_hunk_0
begin_hunk_1_@pager_write_pagelist:bb.a
bb.c:                                             ; preds = %.thread
  %i.r = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !525
  %.not45 = icmp eq ptr %i.s, null
  br i1 %.not45, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.t = getelementptr inbounds nuw i8, ptr %1, i64 48
  %i.u = load i32, ptr %i.t, align 8, !tbaa !527
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  store i64 %i.z, ptr %i.a, align 8, !tbaa !19
  %i.aa = load ptr, ptr %i.b, align 8, !tbaa !526 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ad = load ptr, ptr %i.ac, align 8, !tbaa !731
  %i.ae = call i32 %i.ad(ptr noundef nonnull %i.aa, i32 noundef 5, ptr noundef nonnull %i.a) #59, !inline_history !2097 ; 0 uses
  %.pre = load i32, ptr %i.o, align 8, !tbaa !678
  br label %sqlite3OsFileControlHint.exit

sqlite3OsFileControlHint.exit:                    ; preds = %bb.e, %bb.f
  %i.af = phi i32 [ %i.p, %bb.e ], [ %.pre, %bb.f ]
  store i32 %i.af, ptr %i.m, align 4, !tbaa !1985
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #59
  br label %bb.g
...
bb.h:                                             ; preds = %.lr.ph, %sqlite3BackupUpdate.exit
  %.051 = phi ptr [ %1, %.lr.ph ], [ %i.de, %sqlite3BackupUpdate.exit ] ; 6 uses
  %i.am = getelementptr inbounds nuw i8, ptr %.051, i64 48
  %i.an = load i32, ptr %i.am, align 8, !tbaa !527 ; 6 uses
  %i.ao = load i32, ptr %i.ag, align 8, !tbaa !678
  %.not46 = icmp ugt i32 %i.an, %i.ao
  br i1 %.not46, label %sqlite3BackupUpdate.exit, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.ap = getelementptr inbounds nuw i8, ptr %.051, i64 52
  %i.aq = load i16, ptr %i.ap, align 4, !tbaa !521
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.av = load i64, ptr %i.ah, align 8, !tbaa !81 ; 2 uses
...
pager_write_changecounter.exit:                   ; preds = %bb.j
  ...
  %i.bt = getelementptr inbounds nuw i8, ptr %.051, i64 8 ; 3 uses
  %i.bu = load ptr, ptr %i.bt, align 8, !tbaa !518 ; 4 uses
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bu, i64 24
  %i.bw = lshr i32 %i.bs, 24
  %i.bx = trunc nuw i32 %i.bw to i8               ; 2 uses
  store i8 %i.bx, ptr %i.bv, align 1, !tbaa !229
...
bb.k:                                             ; preds = %pager_write_changecounter.exit, %bb.j
  ...
  %i.co = getelementptr inbounds nuw i8, ptr %.051, i64 8 ; 2 uses
...
sqlite3BackupUpdate.exit:                         ; preds = %bb.p, %bb.o, %bb.h, %bb.i
  ...
  %i.dd = getelementptr inbounds nuw i8, ptr %.051, i64 32
...
walEncodeFrame.exit:                              ; preds = %walChecksumBytes.exit.i, %bb.b
  ...
  %i.be = load i64, ptr %i.bd, align 8, !tbaa !2316 ; 3 uses
...
bb.c:                                             ; preds = %walEncodeFrame.exit
  ...
  %i.bk = load ptr, ptr %i.bj, align 8, !tbaa !2315 ; 2 uses
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !475
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 24
  %i.bn = load ptr, ptr %i.bm, align 8, !tbaa !683
  %i.bo = call i32 %i.bn(ptr noundef nonnull %i.bk, ptr noundef nonnull %i.a, i32 noundef %i.bi, i64 noundef %2) #59, !inline_history !2343 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.bu = load i32, ptr %i.bt, align 8, !tbaa !2317
  %i.bv = and i32 %i.bu, 3                        ; 2 uses
  %.not.i.i = icmp eq i32 %i.bv, 0
  br i1 %.not.i.i, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.bw = load ptr, ptr %i.bj, align 8, !tbaa !2315 ; 2 uses
  %i.bx = load ptr, ptr %i.bw, align 8, !tbaa !475
  %i.by = getelementptr inbounds nuw i8, ptr %i.bx, i64 40
  %i.bz = load ptr, ptr %i.by, align 8, !tbaa !735
  %i.ca = call i32 %i.bz(ptr noundef nonnull %i.bw, i32 noundef range(i32 0, 256) %i.bv) #59, !inline_history !2344
  br label %bb.f
...
bb.g:                                             ; preds = %bb.f, %walEncodeFrame.exit
  %.137.i = phi ptr [ %i.bs, %bb.f ], [ %i.a, %walEncodeFrame.exit ]
  %.135.i = phi i32 [ %i.br, %bb.f ], [ 24, %walEncodeFrame.exit ]
  %.133.i = phi i64 [ %i.bq, %bb.f ], [ %2, %walEncodeFrame.exit ]
  %i.ce = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.cf = load ptr, ptr %i.ce, align 8, !tbaa !2315 ; 2 uses
  %i.cg = load ptr, ptr %i.cf, align 8, !tbaa !475
  %i.ch = getelementptr inbounds nuw i8, ptr %i.cg, i64 24
  %i.ci = load ptr, ptr %i.ch, align 8, !tbaa !683
  %i.cj = call i32 %i.ci(ptr noundef nonnull %i.cf, ptr noundef nonnull %.137.i, i32 noundef %.135.i, i64 noundef %.133.i) #59, !inline_history !2343
  br label %walWriteToLog.exit

walWriteToLog.exit:                               ; preds = %bb.f, %bb.g
  %.1.i = phi i32 [ %i.cj, %bb.g ], [ %i.cb, %bb.f ] ; 2 uses
...
bb.h:                                             ; preds = %walWriteToLog.exit
  ...
  %i.cl = load i32, ptr %i.ck, align 4, !tbaa !2318 ; 3 uses
  %i.cm = load i64, ptr %i.bd, align 8, !tbaa !2316 ; 3 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ct = load ptr, ptr %i.cs, align 8, !tbaa !2315 ; 2 uses
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !475
  %i.cv = getelementptr inbounds nuw i8, ptr %i.cu, i64 24
  %i.cw = load ptr, ptr %i.cv, align 8, !tbaa !683
  %i.cx = call i32 %i.cw(ptr noundef nonnull %i.ct, ptr noundef %.8.val, i32 noundef %i.cr, i64 noundef %i.bg) #59, !inline_history !2343 ; 2 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.dd = load i32, ptr %i.dc, align 8, !tbaa !2317
  %i.de = and i32 %i.dd, 3                        ; 2 uses
  %.not.i.i22 = icmp eq i32 %i.de, 0
  br i1 %.not.i.i22, label %bb.l, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.df = load ptr, ptr %i.cs, align 8, !tbaa !2315 ; 2 uses
  %i.dg = load ptr, ptr %i.df, align 8, !tbaa !475
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dg, i64 40
  %i.di = load ptr, ptr %i.dh, align 8, !tbaa !735
  %i.dj = call i32 %i.di(ptr noundef nonnull %i.df, i32 noundef range(i32 0, 256) %i.de) #59, !inline_history !2344
  br label %bb.l
...
bb.m:                                             ; preds = %bb.l, %bb.h
  %.137.i15 = phi ptr [ %i.db, %bb.l ], [ %.8.val, %bb.h ]
  %.135.i16 = phi i32 [ %i.da, %bb.l ], [ %i.cl, %bb.h ]
  %.133.i17 = phi i64 [ %i.cz, %bb.l ], [ %i.bg, %bb.h ]
  %i.dn = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.do = load ptr, ptr %i.dn, align 8, !tbaa !2315 ; 2 uses
  %i.dp = load ptr, ptr %i.do, align 8, !tbaa !475
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 24
  %i.dr = load ptr, ptr %i.dq, align 8, !tbaa !683
  %i.ds = call i32 %i.dr(ptr noundef nonnull %i.do, ptr noundef %.137.i15, i32 noundef %.135.i16, i64 noundef %.133.i17) #59, !inline_history !2343
  br label %walWriteToLog.exit24

walWriteToLog.exit24:                             ; preds = %bb.c, %bb.m, %bb.l, %bb.i, %walWriteToLog.exit
  %.0 = phi i32 [ %i.cx, %bb.i ], [ %.1.i, %walWriteToLog.exit ], [ %i.ds, %bb.m ], [ %i.dk, %bb.l ], [ %i.bo, %bb.c ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #59
  ret i32 %.0
}
