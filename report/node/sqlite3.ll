...
.critedge:                                        ; preds = %bb.d, %bb.d, %bb.f
  ...
  br i1 %.not26, label %._crit_edge, label %.lr.ph, !llvm.loop !4670
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !4659 ; 6 uses
...
bb.b:                                             ; preds = %bb.a, %bb.a
  ...
  %i.h = load i32, ptr %i.g, align 8, !tbaa !4661
...
bb.d:                                             ; preds = %bb.e
  ...
  br i1 %exitcond.not, label %._crit_edge, label %bb.e, !llvm.loop !4671
...
._crit_edge:                                      ; preds = %bb.d, %bb.c
  ...
  store i8 1, ptr %i.r, align 1, !tbaa !4663
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.w = load i32, ptr %i.v, align 8, !tbaa !4661
...
bb.j:                                             ; preds = %._crit_edge14.i, %bb.h
  ...
  br i1 %i.ao, label %bb.h, label %exprIsCoveredByIndex.exit.thread, !llvm.loop !4672

exprIsCoveredByIndex.exit:                        ; preds = %bb.i
  %i.ap = getelementptr inbounds nuw i8, ptr %i.b, i64 12
  store i8 1, ptr %i.ap, align 4, !tbaa !4662
  br label %exprIsCoveredByIndex.exit.thread
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load i32, ptr %i.g, align 8, !tbaa !4525
  %i.i = icmp eq i32 %i.d, %i.h
  br i1 %i.i, label %bb.c, label %sqlite3TableColumnToIndex.exit

bb.c:                                             ; preds = %bb.b
  %i.j = load ptr, ptr %i.f, align 8, !tbaa !4527 ; 2 uses
...
bb.h:                                             ; preds = %bb.f, %bb.g
  ...
  %i.av = load i32, ptr %i.au, align 8, !tbaa !4271 ; 2 uses
...
bb.k:                                             ; preds = %bb.h
  ...
  %i.be = load i8, ptr %i.bd, align 8, !tbaa !4308
...
bb.t:                                             ; preds = %bb.s
  ...
  store ptr %i.r, ptr %8, align 8, !tbaa !4286
  store ptr %i.r, ptr %i.s, align 8, !tbaa !4288
  store i8 0, ptr %i.t, align 8, !tbaa !4289
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.u, i8 0, i64 16, i1 false)
  store i32 %spec.select, ptr %i.v, align 4, !tbaa !4290
  store i32 0, ptr %i.w, align 8, !tbaa !4291
  store i32 %i.bi, ptr %i.x, align 4, !tbaa !5
  store i8 1, ptr %i.y, align 2, !tbaa !4292
  store i8 1, ptr %i.z, align 1, !tbaa !4293
...
.lr.ph.i339:                                      ; preds = %.thread.i.i, %bb.x
  ...
  %i.cj = load i64, ptr %i.ci, align 8, !tbaa !4294 ; 2 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.co = load i16, ptr %i.cn, align 4, !tbaa !4491 ; 2 uses
...
bb.x:                                             ; preds = %bb.w, %.lr.ph.i339
  ...
  br i1 %.not.i341, label %sqlite3WhereFindTerm.exit, label %.lr.ph.i339, !llvm.loop !4530
...
bb.y:                                             ; preds = %sqlite3WhereFindTerm.exit
  ...
  %.pre.a = load i16, ptr %.phi.trans.insert, align 4, !tbaa !4491 ; 3 uses
  %i.ct = icmp eq i16 %.pre.a, 1
  br i1 %i.ct, label %.preheader460, label %.critedge3.thread

.preheader460:                                    ; preds = %bb.y
  %i.cu = load i16, ptr %i.bk, align 4, !tbaa !4269 ; 2 uses
  %.not529 = icmp eq i16 %i.cu, 0
  br i1 %.not529, label %.critedge3, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader460
  %i.cv = load ptr, ptr %i.bl, align 8, !tbaa !4266
...
bb.z:                                             ; preds = %bb.aa
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.critedge3, label %bb.aa, !llvm.loop !4673
...
bb.aa:                                            ; preds = %.lr.ph, %bb.z
  ...
  %i.cx = load ptr, ptr %i.cw, align 8, !tbaa !4296
  %.not318 = icmp eq ptr %.1.i340, %i.cx
  br i1 %.not318, label %.critedge3.thread, label %bb.z

.critedge3.thread:                                ; preds = %bb.aa, %.thread, %bb.y
  %.017.i372625 = phi ptr [ %.021.i, %.thread ], [ %.1.i340, %bb.y ], [ %.1.i340, %bb.aa ]
  %i.cy = phi i16 [ %i.co, %.thread ], [ %.pre.a, %bb.y ], [ %.pre.a, %bb.aa ]
...
sqlite3ExprNNCollSeq.exit:                        ; preds = %bb.ac, %bb.ad
  ...
  %i.dj = load ptr, ptr %.017.i372625, align 8, !tbaa !1155 ; 5 uses
...
.critedge3:                                       ; preds = %bb.r, %bb.z, %bb.ao, %.preheader460, %sqlite3ExprCompareCollSeq.exit, %bb.m, %sqlite3WhereFindTerm.exit.thread, %sqlite3ExprSkipCollateAndLikely.exit, %sqlite3WhereFindTerm.exit, %bb.s, %bb.l, %sqlite3StrICmp.exit.thread
  ...
  br i1 %exitcond562.not, label %._crit_edge.loopexit, label %bb.l, !llvm.loop !4674

._crit_edge.loopexit:                             ; preds = %.critedge3
  %.pre584 = load i32, ptr %i.au, align 8, !tbaa !4271
  br label %._crit_edge
...
.lr.ph510:                                        ; preds = %bb.at, %bb.as, %bb.ar, %bb.aw
  ...
  %.not288 = icmp eq ptr %.0249638, null
  %i.gg = getelementptr inbounds nuw i8, ptr %.0249638, i64 8
  %i.gh = getelementptr inbounds nuw i8, ptr %.0249638, i64 56
  %i.gi = getelementptr inbounds nuw i8, ptr %.0249638, i64 24
...
bb.bc:                                            ; preds = %.lr.ph726
  ...
  br i1 %exitcond569.not, label %.thread379, label %.lr.ph726, !llvm.loop !4675
...
.lr.ph726:                                        ; preds = %bb.bb, %bb.bc
  ...
  %i.hg = load ptr, ptr %i.hf, align 8, !tbaa !4296
  %i.hh = load ptr, ptr %i.hg, align 8, !tbaa !1155
  %i.hi = icmp eq ptr %i.hh, %i.hd
  br i1 %i.hi, label %..thread379.loopexit_crit_edge, label %bb.bc, !llvm.loop !4675

..thread379.loopexit_crit_edge:                   ; preds = %.lr.ph726
  br label %.thread379, !llvm.loop !4675
...
sqlite3ExprSkipCollateAndLikely.exit355.thread:   ; preds = %bb.bo, %bb.ca, %bb.bj, %sqlite3ExprCompareSkip.exit, %bb.bp, %bb.br, %bb.bq, %bb.bi
  ...
  br i1 %.not303, label %.thread413, label %bb.bi, !llvm.loop !4676
...
.select.unfold_crit_edge:                         ; preds = %bb.cd
  %.phi.trans.insert585 = and i64 %indvars.iv570, 4294967295 ; 2 uses
  %.phi.trans.insert586 = getelementptr inbounds nuw [24 x i8], ptr %1, i64 %.phi.trans.insert585
  %.phi.trans.insert587 = getelementptr inbounds nuw i8, ptr %.phi.trans.insert586, i64 24
  %.pre588 = load i8, ptr %.phi.trans.insert587, align 8, !tbaa !3498
...
select.unfold:                                    ; preds = %.select.unfold_crit_edge, %bb.cf, %bb.cg, %bb.ch
  %.pre-phi = phi i64 [ %.phi.trans.insert585, %.select.unfold_crit_edge ], [ %i.kq, %bb.cf ], [ %i.kv, %bb.cg ], [ %i.kv, %bb.ch ]
  %i.ld = phi i8 [ %.pre588, %.select.unfold_crit_edge ], [ %i.kt, %bb.cf ], [ %i.ky, %bb.cg ], [ %i.ky, %bb.ch ]
...
bb.cj:                                            ; preds = %bb.ci
  %i.li = load i32, ptr %i.au, align 8, !tbaa !4271
  %i.lj = or i32 %i.li, 524288
  store i32 %i.lj, ptr %i.au, align 8, !tbaa !4271
...
.thread413:                                       ; preds = %bb.ci, %bb.cf, %.thread403, %sqlite3ExprSkipCollateAndLikely.exit355.thread
  ...
  %i.lo = icmp samesign ugt i32 %.0236640, %i.lm
...
bb.ck:                                            ; preds = %.critedge334, %.thread383
  ...
  %exitcond573.not = icmp eq i64 %indvars.iv.next564, %.1247639
...
.preheader.i.i:                                   ; preds = %bb.co
  %i.mi = load i32, ptr %i.al, align 4, !tbaa !4259 ; 2 uses
...
bb.cp:                                            ; preds = %.lr.ph.i.i366
  ...
  br i1 %exitcond.not.i.i, label %sqlite3ExprIsConstant.exit, label %.lr.ph.i.i366, !llvm.loop !4309
...
sqlite3WhereExprUsage.exit:                       ; preds = %._crit_edge.i
  %i.mp = call fastcc i64 @sqlite3WhereExprUsageFull(ptr noundef nonnull %i.ah, ptr noundef nonnull readonly %i.ly), !inline_history !4541 ; 2 uses
...
bb.ct:                                            ; preds = %.critedge
  br i1 %or.cond.not716, label %.preheader.preheader, label %.loopexit

.preheader.preheader:                             ; preds = %bb.ct
  %i.nb = icmp samesign ugt i32 %i.h, 1
  br i1 %i.nb, label %.lr.ph744, label %.loopexit

.preheader:                                       ; preds = %.lr.ph744
  %i.nc = icmp sgt i64 %indvars.iv581743, 2
  br i1 %i.nc, label %.lr.ph744, label %.loopexit, !llvm.loop !4680

.lr.ph744:                                        ; preds = %.preheader.preheader, %.preheader
  %indvars.iv581743 = phi i64 [ %indvars.iv.next582, %.preheader ], [ %i.j, %.preheader.preheader ] ; 2 uses
  %indvars.iv.next582 = add nsw i64 %indvars.iv581743, -1 ; 3 uses
  %notmask324 = shl nsw i64 -1, %indvars.iv.next582
  %i.nd = or i64 %notmask324, %i.my
  %.not325 = icmp eq i64 %i.nd, -1
  br i1 %.not325, label %.loopexit.split.loop.exit, label %.preheader, !llvm.loop !4680

.loopexit.split.loop.exit:                        ; preds = %.lr.ph744
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 8, !tbaa !4271
  %i.c = and i32 %i.b, 512
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = load i32, ptr %i.e, align 8, !tbaa !4271
  %i.g = and i32 %i.f, 512
...
bb.b:                                             ; preds = %bb.b, %bb.a
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  br i1 %.not, label %.preheader, label %bb.b, !llvm.loop !4681
...
bb.j:                                             ; preds = %bb.i
  %i.an = load i32, ptr %i.h, align 8, !tbaa !4271
