...
begin_hunk_0_@allocateBtreePage:bb.a
  ...
  %i.kc = sub i32 %i.kb, %3                       ; 4 uses
  %i.kd = icmp slt i32 %i.kc, 0
  %5 = icmp eq i32 %i.kc, -2147483648
  %6 = sub nsw i32 0, %i.kc
  %spec.select.i = select i1 %5, i32 2147483647, i32 %6
...
begin_hunk_1_@allocateBtreePage:bb.a
  ...
  %7 = sub i32 %i.kk, %3                          ; 4 uses
  %8 = icmp eq i32 %7, -2147483648
  %i.kl = sub nsw i32 0, %7
  %spec.select.i311 = select i1 %8, i32 2147483647, i32 %i.kl
  %i.km = icmp slt i32 %7, 0
  %.0.i312 = select i1 %i.km, i32 %spec.select.i311, i32 %7 ; 2 uses
...
sqlite3SetTextEncoding.exit:                      ; preds = %.thread206, %sqlite3SetTextEncoding.exit.loopexit, %sqlite3HashFind.exit.i.i.i, %bb.be, %bb.as
  %.sroa.7.0213 = phi i32 [ %i.go, %sqlite3SetTextEncoding.exit.loopexit ], [ %i.go, %sqlite3HashFind.exit.i.i.i ], [ %i.go, %bb.be ], [ %i.go, %bb.as ], [ 0, %.thread206 ] ; 4 uses
...
bb.bh:                                            ; preds = %sqlite3SetTextEncoding.exit
  %5 = icmp eq i32 %.sroa.7.0213, -2147483648
  %6 = sub nsw i32 0, %.sroa.7.0213
  %spec.select.i = select i1 %5, i32 2147483647, i32 %6
...
begin_hunk_4_@sqlite3Pragma:bb.a
  ...
  %i.hk = load i32, ptr %i.g, align 4, !tbaa !5   ; 4 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g) #71
  %5 = icmp eq i32 %i.hk, -2147483648
  %6 = sub nsw i32 0, %i.hk
  %spec.select.i = select i1 %5, i32 2147483647, i32 %6
...
sqlite3_value_int.exit.i:                         ; preds = %bb.db, %bb.da, %bb.cz, %bb.cy, %bb.cx, %bb.cw, %bb.cu
  ...
  %i.pm = trunc i64 %.0.i.i67.i to i32            ; 4 uses
  %i.pn = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.po = load ptr, ptr %i.pn, align 8, !tbaa !6354
  %i.pp = getelementptr i8, ptr %i.po, i64 8
end_hunk_5
begin_hunk_6_@fts5UpdateMethod:bb.a
  %i.px = tail call fastcc ptr @fts5IndexOptimizeStruct(ptr noundef nonnull %.val41.i, ptr noundef nonnull %i.pq), !inline_history !6525 ; 3 uses
  tail call fastcc void @fts5StructureRelease(ptr noundef nonnull %i.pq), !inline_history !6525
  store ptr %i.px, ptr %i.a, align 8, !tbaa !6519
  %5 = icmp eq i32 %i.pm, -2147483648
  %6 = sub nsw i32 0, %i.pm
  %7 = select i1 %5, i32 2147483647, i32 %6
...
thread-pre-split.thread.i.i.i:                    ; preds = %thread-pre-split.i.i.i, %fts5StructureInvalidate.exit.i.i70.i
  %.027.i.i.i = phi i32 [ %7, %thread-pre-split.i.i.i ], [ %i.pm, %fts5StructureInvalidate.exit.i.i70.i ]
