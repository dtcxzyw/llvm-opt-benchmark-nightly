...
bb.ba:                                            ; preds = %bb.ax, %bb.az
  ...
  %i.if = select i1 %.not52, ptr @.str.491, ptr @.str.490 ; 2 uses
...
begin_hunk_1
  ...
  %i.p = load i32, ptr %i.o, align 8, !tbaa !778  ; 10 uses
...
begin_hunk_2
  ...
  br i1 %i.bg, label %bb.q, label %.thread271.a
...
bb.q:                                             ; preds = %bb.p
  ...
  br i1 %or.cond.i, label %bb.r, label %.thread271.a
...
begin_hunk_3
  ...
  br i1 %.not24.i, label %bb.s, label %.thread271.a
...
bb.v:                                             ; preds = %bb.u
  ...
  br i1 %.not28.i, label %bb.w, label %.thread271.a
...
bb.w:                                             ; preds = %bb.v
  ...
  br i1 %.not29.i, label %bb.x, label %.thread271.a
...
begin_hunk_4
  ...
  br i1 %i.cf, label %.thread271.a, label %bb.y
...
begin_hunk_5
  ...
  br i1 %.not30.i, label %bb.z, label %.thread271.a

isCandidateForInOpt.exit:                         ; preds = %bb.z
  %.not191 = icmp eq ptr %i.bl, null
  br i1 %.not191, label %.thread271.a, label %isCandidateForInOpt.exit.thread260
...
._crit_edge:                                      ; preds = %sqlite3CompareAffinity.exit
  br i1 %narrow, label %.critedge, label %.thread271.a
...
.critedge:                                        ; preds = %bb.ai, %._crit_edge
  ...
  br i1 %.not329, label %.thread271.a, label %.lr.ph324
...
begin_hunk_7
  ...
  br i1 %.not419, label %.thread271.a, label %bb.au, !llvm.loop !2984
...
.thread271.a:                                     ; preds = %.lr.ph.i, %bb.cj, %.critedge, %bb.w, %bb.v, %bb.u, %bb.t, %bb.s, %bb.r, %bb.x, %bb.q, %._crit_edge, %isCandidateForInOpt.exit, %bb.p
  %7 = and i32 %2, 1
  %.not200 = icmp eq i32 %7, 0
  br i1 %.not200, label %bb.co, label %bb.ck

bb.ck:                                            ; preds = %.thread271.a
...
bb.co:                                            ; preds = %bb.cm, %bb.ck, %.thread271.a
  %i.mo = getelementptr inbounds nuw i8, ptr %0, i64 28 ; 3 uses
  %i.mp = load i16, ptr %i.mo, align 4, !tbaa !893
  %i.mq = and i32 %2, 2                           ; 2 uses
  %.not202 = icmp eq i32 %i.mq, 0
  %.lobit = lshr exact i32 %i.mq, 1               ; 2 uses
...
bb.cs:                                            ; preds = %bb.cq, %bb.cr, %bb.cp
  %.0165 = phi i32 [ 0, %bb.cp ], [ %i.mt, %bb.cr ], [ 0, %bb.cq ] ; 2 uses
...
bb.cv:                                            ; preds = %bb.cu, %bb.ct, %bb.cs
  %.0164 = phi i32 [ %.lobit, %bb.cs ], [ 0, %bb.ct ], [ %spec.select207, %bb.cu ]
...
bb.cx:                                            ; preds = %bb.cw, %bb.cv
  store i16 %i.mp, ptr %i.mo, align 4, !tbaa !893
  br label %bb.cy
...
begin_hunk_12
  ...
  br i1 %i.cg, label %jsonParseFree.exit, label %jsonCacheSearch.exit.thread
...
bb.ai:                                            ; preds = %bb.ah
  br i1 %.not100, label %jsonParseFree.exit, label %bb.aj
...
bb.bg:                                            ; preds = %bb.bf
  br i1 %.not100, label %jsonParseFree.exit, label %bb.x
...
begin_hunk_16
  ...
  %i.ti = load i32, ptr %i.th, align 8, !tbaa !4958 ; 3 uses
...
bb.ep:                                            ; preds = %bb.eo
  ...
  %i.tl = shl nuw nsw i64 %i.tk, 3                ; 2 uses
...
bb.eq:                                            ; preds = %bb.ep
  ...
  %8 = add nsw i64 %i.tl, -2147483384
  %or.cond.i.i = icmp ult i64 %8, -2147483391
  %or.cond293.i = select i1 %.not.i.i.i168.i, i1 true, i1 %or.cond.i.i
