...
.split10.i:                                       ; preds = %sqlite3GetVdbe.exit.i
  %i.lu = load ptr, ptr %i.kb, align 8, !tbaa !2248 ; 2 uses
...
.split.i:                                         ; preds = %.split10.i, %sqlite3GetVdbe.exit.i
  ...
  %i.lz = load i32, ptr %i.ly, align 8, !tbaa !711 ; 4 uses
...
bb.bi:                                            ; preds = %.split.i
  %i.mc = call fastcc i32 @growOp3(ptr noundef nonnull %.0.i.i708, i32 noundef 71, i32 noundef 275, i32 noundef %spec.store.select8, i32 noundef 0), !inline_history !1234
...
bb.bj:                                            ; preds = %.split.i
  ...
  store i8 71, ptr %i.mh, align 8, !tbaa !938
  ...
  store i32 275, ptr %i.mj, align 4, !tbaa !954
  %i.mk = getelementptr inbounds nuw i8, ptr %i.mh, i64 8
  store i32 %spec.store.select8, ptr %i.mk, align 8, !tbaa !955
...
sqlite3VdbeAddOp3.exit.i:                         ; preds = %bb.bj, %bb.bi
  ...
  %i.mo = load ptr, ptr %.0.i.i708, align 8, !tbaa !687
  %i.mp = getelementptr inbounds nuw i8, ptr %i.mo, i64 103
  %i.mq = load i8, ptr %i.mp, align 1, !tbaa !928
...
bb.bl:                                            ; preds = %bb.bk
  %i.ms = load i32, ptr %i.ly, align 8, !tbaa !711
...
bb.bm:                                            ; preds = %bb.bl, %bb.bk
  ...
  %i.mv = load ptr, ptr %i.mu, align 8, !tbaa !710
  %i.mw = sext i32 %.0.i10.i to i64
  %i.mx = getelementptr inbounds [24 x i8], ptr %i.mv, i64 %i.mw
  call fastcc void @vdbeChangeP4Full(ptr noundef nonnull readonly %.0.i.i708, ptr noundef %i.mx, ptr noundef %i.lg, i32 noundef 0), !inline_history !1211
  br label %sqlite3VdbeAddOp4.exit

sqlite3VdbeAddOp4.exit:                           ; preds = %sqlite3VdbeAddOp3.exit.i, %bb.bm
  %i.my = load i32, ptr %i.ly, align 8, !tbaa !711 ; 2 uses
...
sqlite3VdbeGoto.exit:                             ; preds = %bb.bn, %sqlite3VdbeAddOp4.exit, %bb.bc, %bb.bb
  ...
  %i.nf = load ptr, ptr %i.kg, align 8, !tbaa !1232 ; 4 uses
  %i.ng = sub i32 0, %i.km                        ; 2 uses
  %i.nh = getelementptr inbounds nuw i8, ptr %i.nf, i64 76
  %i.ni = load i32, ptr %i.nh, align 4, !tbaa !2385
  %i.nj = getelementptr inbounds nuw i8, ptr %i.nf, i64 72
  %i.nk = load i32, ptr %i.nj, align 8, !tbaa !2096
...
.preheader1004:                                   ; preds = %bb.bt, %.preheader1004
  ...
  %i.od = load ptr, ptr %i.oc, align 8, !tbaa !1980 ; 2 uses
  %i.oe = add nuw nsw i32 %.05281029, 1           ; 3 uses
  %.not628 = icmp eq ptr %i.od, null
  br i1 %.not628, label %bb.bu, label %.preheader1004, !llvm.loop !6088

bb.bu:                                            ; preds = %.preheader1004
  store i32 %i.oe, ptr %.sroa.9, align 8, !tbaa !741
...
bb.bv:                                            ; preds = %bb.bu
  %i.oh = call fastcc ptr @sqlite3DbMallocRawNN(ptr noundef nonnull %i.b, i64 noundef %i.og), !inline_history !37
  br label %sqlite3DbMallocRaw.exit.i

bb.bw:                                            ; preds = %bb.bu
  %i.oi = call fastcc ptr @sqlite3Malloc(i64 noundef %i.og), !inline_history !37
  br label %sqlite3DbMallocRaw.exit.i
...
.lr.ph1036:                                       ; preds = %.preheader1003, %.lr.ph1036
  ...
  %.1599 = load ptr, ptr %i.oq, align 8, !tbaa !1201 ; 4 uses
  %.not630 = icmp eq ptr %.1599, null
  %.not631 = icmp eq ptr %.1599, %i.oo
  %or.cond992 = or i1 %.not630, %.not631
  br i1 %or.cond992, label %.critedge, label %.lr.ph1036, !llvm.loop !6089
...
bb.cb:                                            ; preds = %.critedge, %bb.bz, %bb.ca
  ...
  %i.pa = load ptr, ptr %i.oz, align 8, !tbaa !2199 ; 2 uses
  %.not629 = icmp eq ptr %i.pa, null
  br i1 %.not629, label %bb.cc, label %bb.by, !llvm.loop !6090

bb.cc:                                            ; preds = %bb.by, %bb.cb
  %.2590.lcssa = phi i32 [ %.25901039, %bb.by ], [ %.3591, %bb.cb ]
  %.26001041 = load ptr, ptr %i.nv, align 8, !tbaa !1201 ; 2 uses
...
.lr.ph1047:                                       ; preds = %bb.cc, %bb.ce
  ...
  %i.pc = load i8, ptr %i.pb, align 1, !tbaa !741
...
bb.ce:                                            ; preds = %.lr.ph1047, %bb.cd
  ...
  %.2600 = load ptr, ptr %i.pi, align 8, !tbaa !1201 ; 2 uses
  %.not633 = icmp eq ptr %.2600, null
  br i1 %.not633, label %.loopexit1002, label %.lr.ph1047, !llvm.loop !6091
...
.loopexit1002:                                    ; preds = %bb.ce, %bb.cc, %bb.bs, %bb.bt, %bb.bq
  ...
  %i.pk = load i64, ptr %i.pj, align 8, !tbaa !924 ; 2 uses
...
bb.cg:                                            ; preds = %bb.cf
  ...
  %i.pp = load ptr, ptr %i.po, align 8, !tbaa !2372
  %i.pq = icmp eq ptr %i.pp, null
  br i1 %i.pq, label %bb.ch, label %bb.ci

bb.ch:                                            ; preds = %bb.cg
  %i.pr = load ptr, ptr %0, align 8, !tbaa !1001
  %i.ps = getelementptr i8, ptr %i.pr, i64 32
  %.val.i = load ptr, ptr %i.ps, align 8, !tbaa !612
  %i.pt = getelementptr i8, ptr %.val.i, i64 56
  %.val.val.i = load ptr, ptr %i.pt, align 8, !tbaa !649 ; 2 uses
...
tempTriggersExist.exit.i:                         ; preds = %bb.ch
  ...
  %i.pw = load ptr, ptr %i.pv, align 8, !tbaa !2373
...
sqlite3VdbeChangeP5.exit905:                      ; preds = %bb.jd, %bb.jc, %sqlite3VdbeGetOp.exit
  ...
  br i1 %i.bdb, label %.lr.ph1062, label %._crit_edge1063, !llvm.loop !6103
...
._crit_edge1063:                                  ; preds = %sqlite3VdbeChangeP5.exit905, %sqlite3VdbeAddOp2.exit902
  ...
  %i.bdc = load i32, ptr %i.abk, align 8, !tbaa !711
  %i.bdd = load ptr, ptr %i.d, align 8, !tbaa !687
  %i.bde = getelementptr inbounds nuw i8, ptr %i.bdd, i64 103
  %i.bdf = load i8, ptr %i.bde, align 1, !tbaa !928
...
bb.je:                                            ; preds = %._crit_edge1063
  %i.bdg = load ptr, ptr %i.abl, align 8, !tbaa !710
...
sqlite3VdbeJumpHere.exit908:                      ; preds = %._crit_edge1063, %bb.je
  ...
  store i32 %i.bdc, ptr %i.bdj, align 8, !tbaa !955
...
sqlite3VdbeGoto.exit884:                          ; preds = %bb.ii, %bb.ih, %sqlite3VdbeAddOp1.exit892, %sqlite3VdbeJumpHere.exit908, %bb.ie
  ...
  %i.bdk = load ptr, ptr %i.acj, align 8, !tbaa !1232 ; 4 uses
  %i.bdl = sub i32 0, %i.adc                      ; 2 uses
  %i.bdm = getelementptr inbounds nuw i8, ptr %i.bdk, i64 76
  %i.bdn = load i32, ptr %i.bdm, align 4, !tbaa !2385
  %i.bdo = getelementptr inbounds nuw i8, ptr %i.bdk, i64 72
  %i.bdp = load i32, ptr %i.bdo, align 8, !tbaa !2096
...
bb.jq:                                            ; preds = %bb.jo, %bb.jn, %.preheader
  %i.ben = load i32, ptr %i.abk, align 8, !tbaa !711 ; 3 uses
  %i.beo = load i32, ptr %i.abp, align 4, !tbaa !1206
  %.not.i.i914 = icmp sgt i32 %i.beo, %i.ben
  br i1 %.not.i.i914, label %bb.js, label %bb.jr

bb.jr:                                            ; preds = %bb.jq
  %i.bep = call fastcc i32 @growOp3(ptr noundef nonnull %i.d, i32 noundef 9, i32 noundef 0, i32 noundef %i.ack, i32 noundef 0), !inline_history !1234 ; 0 uses
  br label %sqlite3VdbeGoto.exit916

bb.js:                                            ; preds = %bb.jq
  %i.beq = add nsw i32 %i.ben, 1
  store i32 %i.beq, ptr %i.abk, align 8, !tbaa !711
  %i.ber = load ptr, ptr %i.abl, align 8, !tbaa !710
  %i.bes = sext i32 %i.ben to i64
  %i.bet = getelementptr inbounds [24 x i8], ptr %i.ber, i64 %i.bes ; 7 uses
  store i8 9, ptr %i.bet, align 8, !tbaa !938
  %i.beu = getelementptr inbounds nuw i8, ptr %i.bet, i64 2
  store i16 0, ptr %i.beu, align 2, !tbaa !957
  %i.bev = getelementptr inbounds nuw i8, ptr %i.bet, i64 4
  store i32 0, ptr %i.bev, align 4, !tbaa !954
  %i.bew = getelementptr inbounds nuw i8, ptr %i.bet, i64 8
  store i32 %i.ack, ptr %i.bew, align 8, !tbaa !955
  %i.bex = getelementptr inbounds nuw i8, ptr %i.bet, i64 12
  store i32 0, ptr %i.bex, align 4, !tbaa !956
  %i.bey = getelementptr inbounds nuw i8, ptr %i.bet, i64 16
  store ptr null, ptr %i.bey, align 8, !tbaa !741
  %i.bez = getelementptr inbounds nuw i8, ptr %i.bet, i64 1
  store i8 0, ptr %i.bez, align 1, !tbaa !939
  br label %sqlite3VdbeGoto.exit916

sqlite3VdbeGoto.exit916:                          ; preds = %bb.jr, %bb.js
  %i.bfa = load i32, ptr %i.abk, align 8, !tbaa !711
  %i.bfb = load ptr, ptr %i.d, align 8, !tbaa !687
  %i.bfc = getelementptr inbounds nuw i8, ptr %i.bfb, i64 103
  %i.bfd = load i8, ptr %i.bfc, align 1, !tbaa !928
...
bb.jt:                                            ; preds = %sqlite3VdbeGoto.exit916
  %i.bfe = load ptr, ptr %i.abl, align 8, !tbaa !710
...
sqlite3VdbeJumpHere.exit919:                      ; preds = %sqlite3VdbeGoto.exit916, %bb.jt
  ...
  store i32 %i.bfa, ptr %i.bfh, align 8, !tbaa !955
...
bb.ju:                                            ; preds = %sqlite3VdbeResolveLabel.exit840
  ...
  %.sroa.9.0..sroa.9.0..sroa.9.0..sroa.9.8.954 = load i32, ptr %.sroa.9, align 8, !tbaa !741
...
bb.jv:                                            ; preds = %bb.ju
  ...
  %i.bfm = load i32, ptr %i.bfl, align 8, !tbaa !6107
  %i.bfn = load ptr, ptr %i.bfk, align 8, !tbaa !6106
  br label %indexIteratorNext.exit

bb.jw:                                            ; preds = %sqlite3VdbeResolveLabel.exit840
  %i.bfo = add nsw i32 %.01065, 1
  %.sroa.9.0..sroa.9.0..sroa.9.0..sroa.9.8. = load ptr, ptr %.sroa.9, align 8, !tbaa !741
  %i.bfp = getelementptr inbounds nuw i8, ptr %.sroa.9.0..sroa.9.0..sroa.9.0..sroa.9.8., i64 40
  %i.bfq = load ptr, ptr %i.bfp, align 8, !tbaa !1980 ; 2 uses
  store ptr %i.bfq, ptr %.sroa.9, align 8, !tbaa !741
  br label %indexIteratorNext.exit
...
indexIteratorNext.exit:                           ; preds = %bb.jv, %bb.jw
  ...
  br i1 %.not649, label %._crit_edge1077, label %bb.fb, !llvm.loop !6104
...
bb.ka:                                            ; preds = %sqlite3VdbeGoto.exit924
  ...
  %i.bgm = load ptr, ptr %i.bgl, align 8, !tbaa !710
...
sqlite3VdbeJumpHere.exit927:                      ; preds = %sqlite3VdbeGoto.exit924, %bb.ka
  ...
  store i32 %i.bgh, ptr %i.bgo, align 8, !tbaa !955
  br label %bb.kb
...
bb.kg:                                            ; preds = %bb.kf
  %i.bhf = load i32, ptr %i.bgr, align 4, !tbaa !1206
  %.not.i931 = icmp sgt i32 %i.bhf, %.pre1121
  br i1 %.not.i931, label %bb.ki, label %bb.kh

bb.kh:                                            ; preds = %bb.kg
  %i.bhg = call fastcc i32 @growOp3(ptr noundef nonnull %i.d, i32 noundef 54, i32 noundef %5, i32 noundef %.0544, i32 noundef %6), !inline_history !1234 ; 0 uses
  br label %sqlite3VdbeAddOp3.exit933

bb.ki:                                            ; preds = %bb.kg
  %i.bhh = add nsw i32 %.pre1121, 1
  store i32 %i.bhh, ptr %i.bgp, align 8, !tbaa !711
  %i.bhi = getelementptr inbounds nuw i8, ptr %i.d, i64 136
  %i.bhj = load ptr, ptr %i.bhi, align 8, !tbaa !710
