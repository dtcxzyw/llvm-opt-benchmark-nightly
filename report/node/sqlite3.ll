...
bb.m:                                             ; preds = %sqlite3_mutex_enter.exit, %bb.l
  ...
  %.not23 = icmp ne ptr %i.ag, null
  %0 = load i8, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 4), align 4
  %.not23.a = icmp eq i8 %0, 0
  %or.cond101 = select i1 %.not23, i1 true, i1 %.not23.a
  br i1 %or.cond101, label %select.unfold, label %sqlite3MutexAlloc.exit30

sqlite3MutexAlloc.exit30:                         ; preds = %bb.m
...
select.unfold:                                    ; preds = %sqlite3MutexAlloc.exit30, %bb.m
...
.lr.ph.i121.2.i:                                  ; preds = %.lr.ph.i121.1.i
  %i.gx = getelementptr i8, ptr %i.gr, i64 3      ; 5 uses
...
.lr.ph.i150.2.i:                                  ; preds = %.lr.ph.i150.1.i
  %i.hh = getelementptr i8, ptr %i.hd, i64 2      ; 3 uses
...
.lr.ph.i183.i:                                    ; preds = %hasVowel.exit425.i..lr.ph.i183.i_crit_edge, %hasVowel.exit428.i
  ...
  %storemerge = phi ptr [ %i.hh, %hasVowel.exit428.i ], [ %scevgep799.i, %hasVowel.exit425.i..lr.ph.i183.i_crit_edge ] ; 18 uses
...
stem.exit162.thread.i.thread:                     ; preds = %.lr.ph33.i.preheader.i, %.lr.ph33.i131.preheader.i, %.lr.ph33.i144.preheader.i, %bb.u, %hasVowel.exit.i, %stem.exit162.thread.i, %stem.exit162.thread.thread.i
  ...
  %i.jx = getelementptr inbounds nuw i8, ptr %i.jw, i64 1 ; 7 uses
...
.lr.ph.i224.5.i:                                  ; preds = %.lr.ph.i224.4.i
  %i.ky = getelementptr inbounds nuw i8, ptr %i.jw, i64 5
...
.lr.ph.i224.6.i:                                  ; preds = %.lr.ph.i224.5.i
  %i.lb = getelementptr inbounds nuw i8, ptr %i.jw, i64 6
...
.lr.ph33.i246.preheader.i:                        ; preds = %m_gt_0.exit448.i
  store i8 99, ptr %i.jx, align 1, !tbaa !204
...
.lr.ph.i252.2.i:                                  ; preds = %.lr.ph.i252.preheader.i
  %i.ox = getelementptr inbounds nuw i8, ptr %i.jw, i64 2
...
.lr.ph.i252.3.i:                                  ; preds = %.lr.ph.i252.2.i
  %i.pa = getelementptr inbounds nuw i8, ptr %i.jw, i64 3
...
.lr.ph.i266.2.i:                                  ; preds = %.lr.ph.i266.preheader.i
  %i.pv = getelementptr inbounds nuw i8, ptr %i.jw, i64 2
...
.lr.ph.i266.3.i:                                  ; preds = %.lr.ph.i266.2.i
  %i.py = getelementptr inbounds nuw i8, ptr %i.jw, i64 3
...
.lr.ph.i280.2.i:                                  ; preds = %.lr.ph.i280.preheader.i
  %i.qt = getelementptr inbounds nuw i8, ptr %i.jw, i64 2
...
.lr.ph.i294.5.i:                                  ; preds = %.lr.ph.i294.4.i
  %i.uh = getelementptr inbounds nuw i8, ptr %i.jw, i64 5
...
.lr.ph.i294.6.i:                                  ; preds = %.lr.ph.i294.5.i
  %i.uk = getelementptr inbounds nuw i8, ptr %i.jw, i64 6
...
.lr.ph.i308.3.i:                                  ; preds = %.lr.ph.i308.2.i
  %i.xo = getelementptr inbounds nuw i8, ptr %i.jw, i64 3 ; 2 uses
...
.lr.ph.i308.4.i:                                  ; preds = %.lr.ph.i308.3.i
  %i.xr = getelementptr inbounds nuw i8, ptr %i.jw, i64 4
...
.lr.ph.i322.3.i:                                  ; preds = %.lr.ph.i322.2.i
  %i.acu = getelementptr inbounds nuw i8, ptr %i.jw, i64 3 ; 2 uses
...
.lr.ph.i322.4.i:                                  ; preds = %.lr.ph.i322.3.i
  %i.acx = getelementptr inbounds nuw i8, ptr %i.jw, i64 4
...
.lr.ph.i336.3.i:                                  ; preds = %.lr.ph.i336.2.i
  %i.agk = getelementptr inbounds nuw i8, ptr %i.agd, i64 3 ; 2 uses
...
m_gt_0.exit518.i:                                 ; preds = %.preheader.i515.i
  ...
  br i1 %.not632.i, label %stem.exit373.i, label %stem.exit373.i.sink.split
...
.lr.ph.i360.3.i:                                  ; preds = %.lr.ph.i360.2.i
  %i.ajs = getelementptr inbounds nuw i8, ptr %i.agd, i64 3 ; 2 uses
...
.lr.ph.i360.4.i:                                  ; preds = %.lr.ph.i360.3.i
  %i.ajv = getelementptr inbounds nuw i8, ptr %i.agd, i64 4
...
m_gt_0.exit528.i:                                 ; preds = %.preheader.i525.i
  ...
  br i1 %.not631.i, label %stem.exit373.i, label %stem.exit373.i.sink.split
...
.lr.ph.i374.2.i:                                  ; preds = %.lr.ph.i374.1.i
  %i.akt = getelementptr inbounds nuw i8, ptr %i.agd, i64 2 ; 2 uses
...
.lr.ph.i374.3.i:                                  ; preds = %.lr.ph.i374.2.i
  %i.akw = getelementptr inbounds nuw i8, ptr %i.agd, i64 3
...
m_gt_0.exit538.i:                                 ; preds = %.preheader.i535.i
  ...
  br i1 %.not630.i, label %stem.exit373.i, label %stem.exit373.i.sink.split
...
stem.exit373.i.sink.split:                        ; preds = %m_gt_0.exit548.i, %m_gt_0.exit, %m_gt_0.exit538.i, %m_gt_0.exit528.i, %m_gt_0.exit111, %m_gt_0.exit518.i, %.lr.ph33.i.preheader
  %.sink = phi ptr [ %i.ajl, %.lr.ph33.i.preheader ], [ %scevgep843.i, %m_gt_0.exit ], [ %i.akt, %m_gt_0.exit538.i ], [ %i.ajs, %m_gt_0.exit528.i ], [ %scevgep849.i, %m_gt_0.exit111 ], [ %i.agk, %m_gt_0.exit518.i ], [ %scevgep839.i, %m_gt_0.exit548.i ] ; 2 uses
...
begin_hunk_36
  ...
  %5 = alloca %struct.TermSelect, align 8         ; 12 uses
...
begin_hunk_37
  ...
  br i1 %.not.i.i, label %sqlite3_malloc64.exit.i, label %.preheader.preheader
...
.preheader.preheader:                             ; preds = %sqlite3_malloc64.exit.i, %fts3TermSelectMerge.exit, %bb.c, %bb.v, %sqlite3_free.exit.thread.i, %bb.a
  %.2 = phi i32 [ %i.de, %sqlite3_free.exit.thread.i ], [ %i.z, %bb.a ], [ %i.ay, %bb.v ], [ 7, %bb.c ], [ 7, %sqlite3_malloc64.exit.i ], [ %i.ag, %fts3TermSelectMerge.exit ]
  br label %.preheader
