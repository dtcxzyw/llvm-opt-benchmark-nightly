...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx = sub i64 %i.ahb, %index            ; 2 uses
  %i.aho = trunc i64 %offset.idx to i32
  %i.ahp = sub nsw i32 %i.aho, %i.aha
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index2024 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next2028, %vec.epilog.vector.body ] ; 2 uses
  %i.ahz = sub i64 %i.ahb, %index2024             ; 2 uses
  %i.aia = trunc i64 %i.ahz to i32
  %i.aib = sub nsw i32 %i.aia, %i.aha
