...
bb.a:
  ...
  %9 = alloca %struct.SessionBuffer, align 8      ; 16 uses
  %10 = alloca %struct.SessionBuffer, align 8     ; 10 uses
  %11 = alloca %struct.SessionBuffer, align 8     ; 16 uses
  %12 = alloca %struct.SessionBuffer, align 8     ; 16 uses
...
sessionBufferGrow.exit.thread12.i:                ; preds = %sqlite3_realloc64.exit.i.i
  ...
  store i32 256, ptr %i.c, align 4, !tbaa !1624
  ...
  store i32 3, ptr %i.b, align 8, !tbaa !1616
...
sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i50: ; preds = %sqlite3_realloc64.exit.i.i46
  ...
  store i32 %i.ap, ptr %i.c, align 4, !tbaa !1624
...
begin_hunk_4_@sessionSelectStmt:bb.a
  ...
  store i32 %i.as, ptr %i.b, align 8, !tbaa !1616
...
bb.g:                                             ; preds = %sessionAppendStr.exit54
  ...
  br i1 %i.bd, label %13, label %.sessionBufferGrow.exit.thread12_crit_edge.i56

.sessionBufferGrow.exit.thread12_crit_edge.i56:   ; preds = %bb.g
  %.pre.i57 = load ptr, ptr %11, align 8, !tbaa !1625
  br label %bb.l
...
bb.h:                                             ; preds = %bb.h, %13
  %.024.i.i62 = phi i64 [ %spec.select.i.i61, %13 ], [ %i.be, %bb.h ] ; 2 uses
...
bb.k:                                             ; preds = %bb.j, %bb.i
  %.1.i.i63 = phi i64 [ 2147483391, %bb.j ], [ %i.be, %bb.i ] ; 2 uses
  %14 = load ptr, ptr %11, align 8, !tbaa !1625
...
sqlite3_realloc64.exit.i.i66:                     ; preds = %bb.k
  %i.bj = tail call fastcc ptr @sqlite3Realloc(ptr noundef %14, i64 noundef %.1.i.i63), !inline_history !1057 ; 3 uses
  %i.bk = icmp eq ptr %i.bj, null
  br i1 %i.bk, label %sqlite3_free.exit, label %sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i70

sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i70: ; preds = %sqlite3_realloc64.exit.i.i66
  store ptr %i.bj, ptr %11, align 8, !tbaa !1625
  %15 = trunc nsw i64 %.1.i.i63 to i32
  store i32 %15, ptr %i.ba, align 4, !tbaa !1624
  br label %bb.l

bb.l:                                             ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i70, %.sessionBufferGrow.exit.thread12_crit_edge.i56
  %16 = phi ptr [ %i.bj, %sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i70 ], [ %.pre.i57, %.sessionBufferGrow.exit.thread12_crit_edge.i56 ] ; 2 uses
  %i.bl = getelementptr inbounds i8, ptr %16, i64 %i.ax
  store i64 8675174369127588468, ptr %i.bl, align 1
  %i.bm = sext i32 %i.aw to i64
  %i.bn = getelementptr i8, ptr %16, i64 %i.bm
...
begin_hunk_7_@sessionSelectStmt:bb.a
  ...
  br i1 %i.bw, label %17, label %.sessionBufferGrow.exit.thread12_crit_edge.i76

.sessionBufferGrow.exit.thread12_crit_edge.i76:   ; preds = %bb.l
  %.pre.i77 = load ptr, ptr %12, align 8, !tbaa !1625
  br label %bb.q
...
bb.m:                                             ; preds = %bb.m, %17
  %.024.i.i82 = phi i64 [ %spec.select.i.i81, %17 ], [ %i.bx, %bb.m ] ; 2 uses
...
bb.p:                                             ; preds = %bb.o, %bb.n
  ...
  %18 = load ptr, ptr %12, align 8, !tbaa !1625
...
sqlite3_realloc64.exit.i.i86:                     ; preds = %bb.p
  %i.cc = tail call fastcc ptr @sqlite3Realloc(ptr noundef %18, i64 noundef %.1.i.i83), !inline_history !1057 ; 3 uses
  %i.cd = icmp eq ptr %i.cc, null
  br i1 %i.cd, label %sqlite3_free.exit, label %sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i90

sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i90: ; preds = %sqlite3_realloc64.exit.i.i86
  store ptr %i.cc, ptr %12, align 8, !tbaa !1625
  br label %bb.q

bb.q:                                             ; preds = %sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i90, %.sessionBufferGrow.exit.thread12_crit_edge.i76
  %19 = phi ptr [ %i.cc, %sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i90 ], [ %.pre.i77, %.sessionBufferGrow.exit.thread12_crit_edge.i76 ] ; 2 uses
  %i.ce = getelementptr inbounds i8, ptr %19, i64 %i.br
  ...
  %i.cg = getelementptr i8, ptr %19, i64 %i.cf
...
begin_hunk_9_@sessionSelectStmt:bb.a
  ...
  br i1 %i.cp, label %20, label %.sessionBufferGrow.exit.thread12_crit_edge.i96

.sessionBufferGrow.exit.thread12_crit_edge.i96:   ; preds = %bb.q
  %.pre.i97 = load ptr, ptr %9, align 8, !tbaa !1625
  br label %sessionAppendStr.exit114.thread287
...
bb.r:                                             ; preds = %bb.r, %20
  %.024.i.i102 = phi i64 [ %spec.select.i.i101, %20 ], [ %i.cq, %bb.r ] ; 2 uses
...
bb.u:                                             ; preds = %bb.t, %bb.s
  ...
  %21 = load ptr, ptr %9, align 8, !tbaa !1625
...
sqlite3_realloc64.exit.i.i106:                    ; preds = %bb.u
  %i.cv = tail call fastcc ptr @sqlite3Realloc(ptr noundef %21, i64 noundef %.1.i.i103), !inline_history !1057 ; 3 uses
  %i.cw = icmp eq ptr %i.cv, null
  br i1 %i.cw, label %sqlite3_free.exit, label %sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i110

sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i110: ; preds = %sqlite3_realloc64.exit.i.i106
  store ptr %i.cv, ptr %9, align 8, !tbaa !1625
  br label %sessionAppendStr.exit114.thread287

sessionAppendStr.exit114.thread287:               ; preds = %.sessionBufferGrow.exit.thread12_crit_edge.i96, %sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i110
  %22 = phi ptr [ %i.cv, %sessionBufferGrow.exit.sessionBufferGrow.exit.thread12_crit_edge.i110 ], [ %.pre.i97, %.sessionBufferGrow.exit.thread12_crit_edge.i96 ] ; 2 uses
  %i.cx = getelementptr inbounds i8, ptr %22, i64 %i.ck
  ...
  %i.cz = getelementptr i8, ptr %22, i64 %i.cy
