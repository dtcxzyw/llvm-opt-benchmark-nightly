...
bb.a:
  ...
  %i.c = load ptr, ptr %0, align 8, !tbaa !4261   ; 4 uses
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !820  ; 6 uses
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !4264 ; 8 uses
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !4265 ; 11 uses
  %i.i = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !4154
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 8
  %i.l = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  %i.m = load i8, ptr %i.l, align 8, !tbaa !4308
...
bb.c:                                             ; preds = %constraintCompatibleWithOuterJoin.exit.thread.i, %.lr.ph.i
  ...
  %i.ac = load i16, ptr %i.ab, align 2, !tbaa !4282 ; 3 uses
  %i.ad = and i16 %i.ac, -65
  store i16 %i.ad, ptr %i.ab, align 2, !tbaa !4282
  %i.ae = getelementptr inbounds nuw i8, ptr %.0178268.i, i64 28
  %i.af = load i32, ptr %i.ae, align 4, !tbaa !4447
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !4294
  %i.ai = and i64 %i.ah, %2
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ak = load i16, ptr %i.aj, align 4, !tbaa !4491
...
bb.i:                                             ; preds = %constraintCompatibleWithOuterJoin.exit.i, %bb.f
  ...
  %i.ay = or i16 %i.ac, 64
  store i16 %i.ay, ptr %i.ab, align 2, !tbaa !4282
...
constraintCompatibleWithOuterJoin.exit.thread.i:  ; preds = %bb.i, %constraintCompatibleWithOuterJoin.exit.i, %bb.h, %bb.g, %bb.e, %bb.d, %bb.c
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %bb.c, !llvm.loop !4587
...
._crit_edge.i:                                    ; preds = %constraintCompatibleWithOuterJoin.exit.thread.i, %bb.b
  ...
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !4274 ; 2 uses
  %.not.i = icmp eq ptr %i.bc, null
  br i1 %.not.i, label %._crit_edge277.loopexit.i, label %bb.b, !llvm.loop !4588
...
.thread245.i:                                     ; preds = %bb.t, %bb.q, %bb.n, %sqlite3ExprIsConstant.exit.i, %sqlite3ExprIsConstant.exit.thread.i
  ...
  br i1 %exitcond328.not.i, label %.thread248.thread.i, label %bb.k, !llvm.loop !4589
...
bb.ae:                                            ; preds = %sqlite3DbMallocRaw.exit.i.i
  ...
  store i64 %i.en, ptr %i.eo, align 8, !tbaa !4590
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.fo, label %middle.block, label %vector.body, !llvm.loop !4591
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond333.not.i, label %..loopexit_crit_edge.i, label %scalar.ph, !llvm.loop !4592

..loopexit_crit_edge.i:                           ; preds = %scalar.ph, %middle.block
  %.lcssa210 = phi i64 [ %i.fp, %middle.block ], [ %i.fv, %scalar.ph ]
  store i64 %.lcssa210, ptr %i.eo, align 8, !tbaa !4590
  br label %.loopexit.i
...
.lr.ph302.i:                                      ; preds = %bb.ay, %.lr.ph302.preheader.i
  ...
  %i.gg = load i16, ptr %i.gf, align 2, !tbaa !4282 ; 2 uses
...
bb.ag:                                            ; preds = %.lr.ph302.i
  ...
  %i.gp = load i16, ptr %i.go, align 4, !tbaa !4491 ; 2 uses
