...
sqlite3PagerBegin.exit:                           ; preds = %bb.br, %bb.az, %bb.bg, %walLockExclusive.exit.i.i, %bb.bo
  %.028.i = phi i32 [ %i.ig, %walLockExclusive.exit.i.i ], [ %i.gp, %bb.az ], [ %i.hg, %bb.bg ], [ %i.ix, %bb.bo ], [ %i.jg, %bb.br ] ; 2 uses
  switch i32 %.028.i, label %bb.bu [
    i32 0, label %sqlite3PagerBegin.exit.thread147
    i32 517, label %bb.bt
  ]

sqlite3PagerBegin.exit.thread147:                 ; preds = %sqlite3WalBeginWriteTransaction.exit.thread56.i, %bb.ba, %sqlite3PagerBegin.exit
  %i.jl = call fastcc i32 @newDatabase(ptr noundef nonnull %i.d)
  br label %bb.bu

bb.bt:                                            ; preds = %sqlite3PagerBegin.exit.thread149, %sqlite3PagerBegin.exit
  %i.jm = load i8, ptr %i.cf, align 4, !tbaa !525 ; 2 uses
  %i.jn = icmp eq i8 %i.jm, 0
  %spec.select = select i1 %i.jn, i32 5, i32 517
  br label %.thread152

bb.bu:                                            ; preds = %sqlite3PagerBegin.exit, %sqlite3PagerBegin.exit.thread147, %.critedge
  %.4 = phi i32 [ %.2.lcssa, %.critedge ], [ %i.jl, %sqlite3PagerBegin.exit.thread147 ], [ %.028.i, %sqlite3PagerBegin.exit ] ; 2 uses
  %.not113 = icmp eq i32 %.4, 0
  br i1 %.not113, label %.critedge7.thread, label %.thread152thread-pre-split

.thread152thread-pre-split:                       ; preds = %lockBtree.exit, %.lr.ph206, %bb.bs, %bb.bu, %bb.ay, %releasePageOne.exit.i, %btreeGetPage.exit.i, %bb.bi
  %.4155.ph = phi i32 [ %.276125.i, %releasePageOne.exit.i ], [ 5, %bb.bs ], [ %.4, %bb.bu ], [ %i.ct, %btreeGetPage.exit.i ], [ 8, %bb.bi ], [ 8, %bb.ay ], [ %i.cp, %.lr.ph206 ], [ %i.gk, %lockBtree.exit ]
...
.thread152:                                       ; preds = %.thread152thread-pre-split, %bb.bt
  ...
  %.4155 = phi i32 [ %.4155.ph, %.thread152thread-pre-split ], [ %spec.select, %bb.bt ] ; 7 uses
...
unlockBtreeIfUnused.exit:                         ; preds = %bb.bx, %bb.bw, %bb.bv, %.thread152
  ...
  br i1 %i.jz, label %bb.by, label %sqlite3PagerOpenSavepoint.exit
...
querySharedCacheTableLock.exit.thread174:         ; preds = %bb.cj, %bb.cg, %bb.ch, %bb.d, %sqlite3BtreeEnter.exit
...
sqlite3PagerOpenSavepoint.exit:                   ; preds = %bb.s, %unlockBtreeIfUnused.exit, %bb.by, %bb.bz, %bb.ca, %.loopexit179, %btreeInvokeBusyHandler.exit.thread165, %bb.p, %bb.ci, %bb.h, %bb.co, %bb.cn, %bb.cm, %bb.cl
  %.7 = phi i32 [ 0, %bb.cm ], [ 0, %bb.cl ], [ 262, %.loopexit179 ], [ %i.mu, %bb.co ], [ 0, %bb.cn ], [ %.4155, %btreeInvokeBusyHandler.exit.thread165 ], [ 8, %bb.h ], [ 262, %bb.p ], [ %.4155, %unlockBtreeIfUnused.exit ], [ %i.lq, %bb.ci ], [ %.4155, %bb.ca ], [ %.4155, %bb.bz ], [ %.4155, %bb.by ], [ 262, %bb.s ]
...
begin_hunk_4
  ...
  switch i32 %i.ab, label %pagerPagecount.exit [
...
pagerLockDb.exit.i:                               ; preds = %bb.w, %sqlite3OsDelete.exit.i, %bb.s
  ...
  br i1 %.not.i40.i, label %.thread203.thread, label %bb.x
...
begin_hunk_7
  ...
  switch i32 %i.cu, label %bb.ac [
    i32 0, label %.thread49.i
    i32 14, label %.thread203
  ]
...
.thread203.thread:                                ; preds = %bb.x, %pagerLockDb.exit.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f) #72
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #72
  br label %.thread190

.thread203:                                       ; preds = %bb.z
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f) #72
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #72
  br label %.thread117

bb.ac:                                            ; preds = %.thread211, %bb.z, %sqlite3OsClose.exit.i
  %.1106 = phi i1 [ true, %.thread211 ], [ %.not145, %sqlite3OsClose.exit.i ], [ true, %bb.z ]
  %.3.i = phi i32 [ %i.aw, %.thread211 ], [ %spec.store.select.i, %sqlite3OsClose.exit.i ], [ %i.cu, %bb.z ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f) #72
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #72
...
.thread117:                                       ; preds = %.thread203, %.thread.i.i, %pager_wait_on_lock.exit.thread, %bb.ad
...
.thread190:                                       ; preds = %.thread203.thread, %.thread, %bb.ap, %bb.ad
...
pagerPagecount.exit:                              ; preds = %bb.f, %bb.ax, %.thread199, %bb.bg
  %.8 = phi i32 [ %.7, %.thread199 ], [ %.7, %bb.bg ], [ %i.fd, %bb.ax ], [ %i.ab, %bb.f ] ; 2 uses
  %.not90 = icmp eq i32 %.8, 0
  br i1 %.not90, label %bb.bn, label %pagerPagecount.exit.thread141

pagerPagecount.exit.thread141:                    ; preds = %bb.g, %.thread207, %.thread, %bb.ac, %.thread117, %bb.ae, %.thread120, %bb.aq, %pagerPagecount.exit.thread136, %pagerPagecount.exit
  %.8139 = phi i32 [ %i.ig, %pagerPagecount.exit.thread136 ], [ %.8, %pagerPagecount.exit ], [ %.4123, %bb.aq ], [ %.3.i, %bb.ac ], [ 776, %.thread117 ], [ %i.dj, %bb.ae ], [ %.4123, %.thread120 ], [ %i.ap, %.thread ], [ %i.bl, %.thread207 ], [ 5, %bb.g ]
...
bb.bo:                                            ; preds = %pagerPagecount.exit.thread141, %bb.bn
  %.8134 = phi i32 [ %.8139, %pagerPagecount.exit.thread141 ], [ 0, %bb.bn ]
  ret i32 %.8134
}
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.084 = phi i32 [ %i.ag, %bb.d ], [ 0, %bb.c ]  ; 2 uses
...
bb.x:                                             ; preds = %pager_reset.exit, %.lr.ph
  ...
  switch i32 %i.dm, label %.loopexit163 [
    i32 0, label %bb.y
    i32 101, label %bb.z
...
.loopexit163:                                     ; preds = %bb.x, %bb.e
  %.185 = phi i32 [ %.084, %bb.e ], [ %i.dm, %bb.x ] ; 2 uses
  %.2 = phi i32 [ 0, %bb.e ], [ %.1188, %bb.x ]   ; 2 uses
  %i.dq = icmp eq i32 %.185, 0
  br i1 %i.dq, label %.thread127, label %.thread132

.thread132:                                       ; preds = %.loopexit, %.loopexit163, %bb.a, %pager_truncate.exit, %bb.b
  %.2124.ph = phi i32 [ %.2, %.loopexit163 ], [ 0, %bb.a ], [ %.0.ph, %pager_truncate.exit ], [ 0, %bb.b ], [ %.0.ph, %.loopexit ]
  %.286.ph = phi i32 [ %.185, %.loopexit163 ], [ %i.s, %bb.a ], [ %.1.i, %pager_truncate.exit ], [ %i.ab, %bb.b ], [ %i.ax, %.loopexit ]
...
.thread127:                                       ; preds = %.loopexit, %bb.x, %.loopexit163
  %.2130 = phi i32 [ %.2, %.loopexit163 ], [ %.1188, %bb.x ], [ %.0.ph, %.loopexit ] ; 7 uses
...
sqlite3PagerExclusiveLock.exit.thread:            ; preds = %bb.d, %.thread.i.i.i, %bb.b
...
sqlite3PagerExclusiveLock.exit.thread83:          ; preds = %bb.f, %bb.g, %.thread91, %bb.r, %sqlite3OsSync.exit77, %sqlite3OsSync.exit.thread, %bb.a, %sqlite3PcacheClearSyncFlags.exit
  %.3 = phi i32 [ %i.d, %bb.a ], [ 0, %sqlite3PcacheClearSyncFlags.exit ], [ %i.cm, %sqlite3OsSync.exit.thread ], [ %i.cz, %sqlite3OsSync.exit77 ], [ %.0.ph, %.thread91 ], [ %i.de, %bb.r ], [ %i.s, %bb.f ], [ 5, %bb.g ]
  ret i32 %.3
}
...
bb.q:                                             ; preds = %walLockExclusive.exit.i.i
  %i.cf = tail call i32 %.091(ptr noundef %4) #72
...
walBusyLock.exit.thread202.i:                     ; preds = %bb.q, %bb.r, %walBusyLock.exit.thread.i, %walBusyLock.exit.i, %bb.o
  ...
  %.2.ph.i = phi ptr [ %.091, %bb.r ], [ %.091, %walBusyLock.exit.thread.i ], [ %.091, %bb.o ], [ null, %walBusyLock.exit.i ], [ null, %bb.q ] ; 5 uses
...
walUnlockExclusive.exit176.thread.i:              ; preds = %bb.ay, %walUnlockExclusive.exit176.i, %bb.n
  ...
  %.3.i = phi ptr [ %.091, %bb.n ], [ %.2.ph.3.i, %walUnlockExclusive.exit176.i ], [ %.2.ph.3.i, %bb.ay ] ; 2 uses
  %i.si = icmp eq i32 %.13.i, 0
  %i.sj = icmp ne i32 %.05088, 0
...
.thread98:                                        ; preds = %sqlite3_malloc64.exit.i.i, %bb.ab, %bb.l, %walLockExclusive.exit, %walCheckpoint.exit, %bb.cj, %bb.ci, %bb.h
  %.05090 = phi i32 [ %.05088, %bb.cj ], [ %.05088, %bb.ci ], [ %.05088, %walCheckpoint.exit ], [ %.05088, %bb.h ], [ %2, %walLockExclusive.exit ], [ %.05088, %bb.l ], [ %.05088, %bb.ab ], [ %.05088, %sqlite3_malloc64.exit.i.i ]
  %.3 = phi i32 [ %.2111, %bb.cj ], [ %.2111, %bb.ci ], [ %.2, %walCheckpoint.exit ], [ %.1, %bb.h ], [ %i.n, %walLockExclusive.exit ], [ 11, %bb.l ], [ 7, %bb.ab ], [ 7, %sqlite3_malloc64.exit.i.i ] ; 2 uses
...
bb.x:                                             ; preds = %bb.v
  %4 = icmp eq i8 %i.cw, 10
  %5 = zext i1 %4 to i32
  %i.dl = tail call fastcc i32 @jsonLabelCompareEscaped(ptr noundef readonly %i.bo, i32 noundef %i.bb, i32 noundef range(i32 0, 2) %i.bs, ptr noundef readonly %i.dk, i32 noundef %i.db, i32 noundef range(i32 0, 2) %5)
...
sqlite3Fts3Optimize.exit:                         ; preds = %bb.d, %bb.b, %bb.e
  %.1.i = phi i32 [ %spec.select, %bb.d ], [ %i.j, %bb.e ], [ %i.h, %bb.b ] ; 5 uses
...
bb.g:                                             ; preds = %sqlite3Fts3Optimize.exit
  %.not.i7 = icmp eq i32 %.1.i, 0
  %3 = select i1 %.not.i7, i32 -1, i32 %.1.i
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 36
  store i32 %3, ptr %i.p, align 4, !tbaa !5
...
.thread52:                                        ; preds = %bb.n, %bb.i, %fts5LocateTokenizer.exit.thread
...
.thread47:                                        ; preds = %sqlite3Fts5TokenizerPattern.exit, %bb.j, %.thread52
  %.03350 = phi i32 [ 0, %sqlite3Fts5TokenizerPattern.exit ], [ %.03355, %.thread52 ], [ 0, %bb.j ]
  ret i32 %.03350
}
...
begin_hunk_38
  ...
  switch i32 %1, label %fts5ExprAssignXNext.exit [
    i32 9, label %bb.q
...
bb.q:                                             ; preds = %bb.p
  ...
  br i1 %i.am, label %bb.r, label %fts5ExprAssignXNext.exit.thread144
...
bb.u:                                             ; preds = %bb.t
  ...
  br label %fts5ExprAssignXNext.exit.thread144

bb.v:                                             ; preds = %bb.p
  br label %fts5ExprAssignXNext.exit.thread

fts5ExprAssignXNext.exit.thread:                  ; preds = %bb.p, %bb.v
  %fts5ExprNodeNext_TERM.sink.i.ph = phi ptr [ @fts5ExprNodeNext_OR, %bb.p ], [ @fts5ExprNodeNext_AND, %bb.v ]
  %5 = getelementptr inbounds nuw i8, ptr %i.ag, i64 16
  store ptr %fts5ExprNodeNext_TERM.sink.i.ph, ptr %5, align 8, !tbaa !366
  br label %bb.ad

fts5ExprAssignXNext.exit.thread144:               ; preds = %bb.q, %bb.r, %bb.s, %bb.t, %bb.u
  %fts5ExprNodeNext_TERM.sink.i.ph143 = phi ptr [ @fts5ExprNodeNext_STRING, %bb.t ], [ @fts5ExprNodeNext_STRING, %bb.r ], [ @fts5ExprNodeNext_STRING, %bb.s ], [ @fts5ExprNodeNext_STRING, %bb.q ], [ @fts5ExprNodeNext_TERM, %bb.u ]
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ag, i64 16 ; 2 uses
  store ptr %fts5ExprNodeNext_TERM.sink.i.ph143, ptr %i.ay, align 8, !tbaa !366
  br label %.preheader

fts5ExprAssignXNext.exit:                         ; preds = %bb.p
  %6 = getelementptr inbounds nuw i8, ptr %i.ag, i64 16 ; 2 uses
  store ptr @fts5ExprNodeNext_NOT, ptr %6, align 8, !tbaa !366
  br i1 %i.d, label %.preheader, label %bb.ad

.preheader:                                       ; preds = %fts5ExprAssignXNext.exit.thread144, %fts5ExprAssignXNext.exit
  %i.az = phi ptr [ %i.ay, %fts5ExprAssignXNext.exit.thread144 ], [ %6, %fts5ExprAssignXNext.exit ]
  %i.ba = getelementptr inbounds nuw i8, ptr %4, i64 16 ; 2 uses
  %7 = load i32, ptr %i.ba, align 8, !tbaa !5     ; 2 uses
...
bb.x:                                             ; preds = %bb.w
  store ptr null, ptr %i.az, align 8, !tbaa !366
  store i32 0, ptr %i.ag, align 8, !tbaa !5
  %.pre.a = load i32, ptr %i.ba, align 8, !tbaa !5
  br label %bb.y
...
bb.ad:                                            ; preds = %fts5ExprAssignXNext.exit.thread, %fts5ExprAssignXNext.exit
