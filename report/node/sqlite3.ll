...
begin_hunk_1_@sqlite3VdbeExec:bb.a
  %i.emh = getelementptr inbounds nuw i8, ptr %.02963, i64 12
  %i.emi = load i32, ptr %i.emh, align 4, !tbaa !586
  %i.emj = sext i32 %i.emi to i64
  %.not3628 = icmp slt i64 %.03264, %i.emj
  br i1 %.not3628, label %.critedge, label %bb.agz

bb.agz:                                           ; preds = %sqlite3BtreeFirst.exit.thread.thread5445
  %i.emk = getelementptr inbounds nuw i8, ptr %.02963, i64 16
  %i.eml = load i32, ptr %i.emk, align 8, !tbaa !227
  %i.emm = sext i32 %i.eml to i64
  %i.emn = icmp sle i64 %.03264, %i.emm
  %cond.fr5111 = freeze i1 %i.emn
  br i1 %cond.fr5111, label %.thread4778, label %.critedge

bb.aha:                                           ; preds = %bb.h, %bb.h
  %i.emo = load i32, ptr %i.fp, align 4, !tbaa !5
  %i.emp = add i32 %i.emo, 1
  store i32 %i.emp, ptr %i.fp, align 4, !tbaa !5
  br label %bb.ahb

bb.ahb:                                           ; preds = %bb.aha, %bb.h
  %i.emq = load ptr, ptr %i.bz, align 8, !tbaa !989
  %i.emr = getelementptr inbounds nuw i8, ptr %.02963, i64 4
  %i.ems = load i32, ptr %i.emr, align 4, !tbaa !584
  %i.emt = sext i32 %i.ems to i64
  %i.emu = getelementptr inbounds [8 x i8], ptr %i.emq, i64 %i.emt
  %i.emv = load ptr, ptr %i.emu, align 8, !tbaa !994 ; 5 uses
  %i.emw = load i8, ptr %i.emv, align 8, !tbaa !227
  %i.emx = icmp eq i8 %i.emw, 1
  %i.emy = getelementptr i8, ptr %i.emv, i64 40
  %.val4123 = load ptr, ptr %i.emy, align 8, !tbaa !227 ; 18 uses
  br i1 %i.emx, label %bb.ahc, label %bb.ala

bb.ahc:                                           ; preds = %bb.ahb
  %i.emz = getelementptr inbounds nuw i8, ptr %.val4123, i64 88
  %i.ena = load i8, ptr %i.emz, align 8, !tbaa !227
  %i.enb = icmp eq i8 %i.ena, 0
  br i1 %i.enb, label %bb.ahd, label %bb.ahf

bb.ahd:                                           ; preds = %bb.ahc
  %i.enc = getelementptr inbounds nuw i8, ptr %.val4123, i64 56 ; 2 uses
  %i.end = load ptr, ptr %i.enc, align 8, !tbaa !2522
  %.not.i4385 = icmp eq ptr %i.end, null
  br i1 %.not.i4385, label %sqlite3VdbeSorterRewind.exit.thread5127, label %bb.ahe

bb.ahe:                                           ; preds = %bb.ahd
  %i.ene = getelementptr inbounds nuw i8, ptr %.val4123, i64 96
  %i.enf = call fastcc i32 @vdbeSorterSort(ptr noundef nonnull %i.ene, ptr noundef nonnull %i.enc)
  br label %sqlite3VdbeSorterRewind.exit

bb.ahf:                                           ; preds = %bb.ahc
  %i.eng = call fastcc i32 @vdbeSorterFlushPMA(ptr noundef nonnull %.val4123)
  %i.enh = call fastcc i32 @vdbeSorterJoinAll(ptr noundef nonnull %.val4123, i32 noundef %i.eng) ; 2 uses
  %i.eni = icmp eq i32 %i.enh, 0
  br i1 %i.eni, label %bb.ahg, label %sqlite3VdbeSorterRowkey.exit.loopexit12631

bb.ahg:                                           ; preds = %bb.ahf
  %i.enj = getelementptr inbounds nuw i8, ptr %.val4123, i64 96 ; 12 uses
  %i.enk = getelementptr inbounds nuw i8, ptr %.val4123, i64 112
  %i.enl = load ptr, ptr %i.enk, align 8, !tbaa !2520
  %i.enm = getelementptr inbounds nuw i8, ptr %i.enl, i64 32
  %i.enn = load ptr, ptr %i.enm, align 8, !tbaa !818 ; 2 uses
  %i.eno = getelementptr i8, ptr %.val4123, i64 92
  %.val.i.i4380 = load i8, ptr %i.eno, align 4, !tbaa !227 ; 2 uses
  ...
  %i.enp = getelementptr inbounds nuw i8, ptr %.val4123, i64 91 ; 5 uses
  %i.enq = load i8, ptr %i.enp, align 1, !tbaa !227 ; 5 uses
  %i.enr = zext i8 %i.enq to i32
  %.not148.i.i = icmp eq i8 %i.enq, 0
  br i1 %.not148.i.i, label %.lr.ph113.i.i.i.preheader, label %.lr.ph.preheader.i.i

.lr.ph.preheader.i.i:                             ; preds = %bb.ahg
  %wide.trip.count.i.i = zext i8 %i.enq to i64    ; 2 uses
  %xtraiter13404 = and i64 %wide.trip.count.i.i, 7 ; 3 uses
  %i.ens = icmp ult i8 %i.enq, 8
  br i1 %i.ens, label %.lr.ph.i.i.epil.preheader, label %.lr.ph.preheader.i.i.new
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.preheader.i.i.new
  ...
  %i.ent = getelementptr inbounds nuw [104 x i8], ptr %i.enj, i64 %indvars.iv.i.i
  %i.enu = getelementptr inbounds nuw i8, ptr %i.ent, i64 56
  store ptr %switch.select5.i.i.i, ptr %i.enu, align 8, !tbaa !2717
  %i.env = getelementptr inbounds nuw [104 x i8], ptr %i.enj, i64 %indvars.iv.i.i
  %i.enw = getelementptr inbounds nuw i8, ptr %i.env, i64 160
  store ptr %switch.select5.i.i.i, ptr %i.enw, align 8, !tbaa !2717
  %i.enx = getelementptr inbounds nuw [104 x i8], ptr %i.enj, i64 %indvars.iv.i.i
  %i.eny = getelementptr inbounds nuw i8, ptr %i.enx, i64 264
  store ptr %switch.select5.i.i.i, ptr %i.eny, align 8, !tbaa !2717
  %i.enz = getelementptr inbounds nuw [104 x i8], ptr %i.enj, i64 %indvars.iv.i.i
  %i.eoa = getelementptr inbounds nuw i8, ptr %i.enz, i64 368
  store ptr %switch.select5.i.i.i, ptr %i.eoa, align 8, !tbaa !2717
  %i.eob = getelementptr inbounds nuw [104 x i8], ptr %i.enj, i64 %indvars.iv.i.i
  %i.eoc = getelementptr inbounds nuw i8, ptr %i.eob, i64 472
  store ptr %switch.select5.i.i.i, ptr %i.eoc, align 8, !tbaa !2717
  %i.eod = getelementptr inbounds nuw [104 x i8], ptr %i.enj, i64 %indvars.iv.i.i
  %i.eoe = getelementptr inbounds nuw i8, ptr %i.eod, i64 576
  store ptr %switch.select5.i.i.i, ptr %i.eoe, align 8, !tbaa !2717
  %i.eof = getelementptr inbounds nuw [104 x i8], ptr %i.enj, i64 %indvars.iv.i.i
  %i.eog = getelementptr inbounds nuw i8, ptr %i.eof, i64 680
  store ptr %switch.select5.i.i.i, ptr %i.eog, align 8, !tbaa !2717
  %i.eoh = getelementptr inbounds nuw [104 x i8], ptr %i.enj, i64 %indvars.iv.i.i
  %i.eoi = getelementptr inbounds nuw i8, ptr %i.eoh, i64 784
...
._crit_edge.i.i.unr-lcssa:                        ; preds = %.lr.ph.i.i
  %lcmp.mod13405.not = icmp eq i64 %xtraiter13404, 0
  br i1 %lcmp.mod13405.not, label %._crit_edge.i.i, label %.lr.ph.i.i.epil.preheader
...
.lr.ph.i.i.epil.preheader:                        ; preds = %._crit_edge.i.i.unr-lcssa, %.lr.ph.preheader.i.i
  ...
  %lcmp.mod13406 = icmp ne i64 %xtraiter13404, 0
  call void @llvm.assume(i1 %lcmp.mod13406)
...
.lr.ph.i.i.epil:                                  ; preds = %.lr.ph.i.i.epil, %.lr.ph.i.i.epil.preheader
  ...
  %i.eoj = getelementptr inbounds nuw [104 x i8], ptr %i.enj, i64 %indvars.iv.i.i.epil
  %i.eok = getelementptr inbounds nuw i8, ptr %i.eoj, i64 56
  store ptr %switch.select5.i.i.i, ptr %i.eok, align 8, !tbaa !2717
  %indvars.iv.next.i.i.epil = add nuw nsw i64 %indvars.iv.i.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter13404
...
.preheader119.i.i:                                ; preds = %._crit_edge.i.i, %.preheader119.i.i
  %.0.i.i.i.i4381 = phi i32 [ %i.eom, %.preheader119.i.i ], [ 2, %._crit_edge.i.i ] ; 4 uses
  %i.eol = icmp slt i32 %.0.i.i.i.i4381, %i.enr
  %i.eom = shl nsw i32 %.0.i.i.i.i4381, 1
  br i1 %i.eol, label %.preheader119.i.i, label %bb.ahh, !llvm.loop !2720

bb.ahh:                                           ; preds = %.preheader119.i.i
  %i.eon = zext nneg i32 %.0.i.i.i.i4381 to i64   ; 2 uses
  %i.eoo = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 400), align 8, !tbaa !718 ; 2 uses
  %.not.i.i.i.i.i = icmp eq ptr %i.eoo, null
  br i1 %.not.i.i.i.i.i, label %sqlite3FaultSim.exit.thread.i.i.i.i, label %sqlite3FaultSim.exit.i.i.i.i

sqlite3FaultSim.exit.i.i.i.i:                     ; preds = %bb.ahh
  %i.eop = call i32 %i.eoo(i32 noundef 100) #59, !inline_history !2721
  %.not.i.i.i.i4382 = icmp eq i32 %i.eop, 0
  br i1 %.not.i.i.i.i4382, label %sqlite3FaultSim.exit.thread.i.i.i.i, label %sqlite3VdbeSorterRowkey.exit.loopexit12631

sqlite3FaultSim.exit.thread.i.i.i.i:              ; preds = %sqlite3FaultSim.exit.i.i.i.i, %bb.ahh
  %i.eoq = mul nuw nsw i64 %i.eon, 84
  %i.eor = add nuw nsw i64 %i.eoq, 32             ; 2 uses
  %i.eos = call fastcc ptr @sqlite3Malloc(i64 noundef range(i64 -180388626400, 180388626381) %i.eor) ; 8 uses
  %.not.i17.i.i.i.i = icmp eq ptr %i.eos, null
  br i1 %.not.i17.i.i.i.i, label %sqlite3VdbeSorterRowkey.exit.loopexit12631, label %vdbeMergeEngineNew.exit.i.i.i

vdbeMergeEngineNew.exit.i.i.i:                    ; preds = %sqlite3FaultSim.exit.thread.i.i.i.i
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %i.eos, i8 0, i64 range(i64 -180388626400, 180388626381) %i.eor, i1 false)
  store i32 %.0.i.i.i.i4381, ptr %i.eos, align 8, !tbaa !2491
  %i.eot = getelementptr inbounds nuw i8, ptr %i.eos, i64 8
  store ptr null, ptr %i.eot, align 8, !tbaa !2722
  %i.eou = getelementptr inbounds nuw i8, ptr %i.eos, i64 32 ; 2 uses
  %i.eov = getelementptr inbounds nuw i8, ptr %i.eos, i64 24
  store ptr %i.eou, ptr %i.eov, align 8, !tbaa !2498
  %i.eow = getelementptr inbounds nuw [80 x i8], ptr %i.eou, i64 %i.eon
  %i.eox = getelementptr inbounds nuw i8, ptr %i.eos, i64 16
  store ptr %i.eow, ptr %i.eox, align 8, !tbaa !2712
  br label %.lr.ph113.i.i.i.preheader

.lr.ph113.i.i.i.preheader:                        ; preds = %vdbeMergeEngineNew.exit.i.i.i, %._crit_edge.i.i, %bb.ahg
  %.1112.i.i.i.ph = phi ptr [ null, %bb.ahg ], [ null, %._crit_edge.i.i ], [ %i.eos, %vdbeMergeEngineNew.exit.i.i.i ]
  br label %.lr.ph113.i.i.i

.lr.ph113.i.i.i:                                  ; preds = %.lr.ph113.i.i.i.preheader, %bb.ajr
  %indvars.iv122.i.i.i = phi i64 [ %indvars.iv.next123.i.i.i, %bb.ajr ], [ 0, %.lr.ph113.i.i.i.preheader ] ; 4 uses
  %.1112.i.i.i = phi ptr [ %.3.i.i.i, %bb.ajr ], [ %.1112.i.i.i.ph, %.lr.ph113.i.i.i.preheader ] ; 27 uses
  %i.eoy = load i8, ptr %i.enp, align 1, !tbaa !227
  %i.eoz = zext i8 %i.eoy to i64                  ; 2 uses
  %i.epa = icmp samesign ult i64 %indvars.iv122.i.i.i, %i.eoz
  br i1 %i.epa, label %bb.ahi, label %vdbeSorterMergeTreeBuild.exit.i.i

bb.ahi:                                           ; preds = %.lr.ph113.i.i.i
  %i.epb = getelementptr inbounds nuw [104 x i8], ptr %i.enj, i64 %indvars.iv122.i.i.i ; 8 uses
  %i.epc = getelementptr inbounds nuw i8, ptr %i.epb, i64 12 ; 3 uses
  %i.epd = load i32, ptr %i.epc, align 4, !tbaa !2723 ; 4 uses
  %.not52.i.i.i = icmp eq i32 %i.epd, 0
  br i1 %.not52.i.i.i, label %bb.ajr, label %bb.ahj
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.ahj, %.lr.ph.i.i.i.i
  %indvars.iv.i.i.i = phi i32 [ %indvars.iv.next.i.i.i, %.lr.ph.i.i.i.i ], [ 1, %bb.ahj ] ; 3 uses
  %.07.i.i.i.i = phi i64 [ %i.epf, %.lr.ph.i.i.i.i ], [ 16, %bb.ahj ]
  %.056.i.i.i.i = phi i32 [ %i.epg, %.lr.ph.i.i.i.i ], [ 0, %bb.ahj ] ; 4 uses
  %i.epf = shl nsw i64 %.07.i.i.i.i, 4            ; 2 uses
  %i.epg = add nuw i32 %.056.i.i.i.i, 1
  %i.eph = icmp slt i64 %i.epf, %20
  %indvars.iv.next.i.i.i = add nuw i32 %indvars.iv.i.i.i, 1
  br i1 %i.eph, label %.lr.ph.i.i.i.i, label %bb.ahk, !llvm.loop !2724

bb.ahk:                                           ; preds = %.lr.ph.i.i.i.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.j) #59
  store i64 0, ptr %i.j, align 8, !tbaa !18
  %i.epi = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 400), align 8, !tbaa !718 ; 2 uses
...
sqlite3FaultSim.exit.i59.i.i.i:                   ; preds = %bb.ahk
  %i.epj = call i32 %i.epi(i32 noundef 100) #59, !inline_history !2721
...
sqlite3FaultSim.exit.thread.i61.i.i.i:            ; preds = %sqlite3FaultSim.exit.i59.i.i.i, %bb.ahk
  %i.epk = call fastcc ptr @sqlite3Malloc(i64 noundef range(i64 -180388626400, 180388626381) 1376) ; 13 uses
...
vdbeMergeEngineNew.exit63.i.i.i:                  ; preds = %sqlite3FaultSim.exit.thread.i61.i.i.i
  ...
  store i32 16, ptr %i.epk, align 8, !tbaa !2491
  %i.epm = getelementptr inbounds nuw i8, ptr %i.epk, i64 32
  %i.epn = getelementptr inbounds nuw i8, ptr %i.epk, i64 24
  store ptr %i.epm, ptr %i.epn, align 8, !tbaa !2498
  %i.epo = getelementptr inbounds nuw i8, ptr %i.epk, i64 1312
  %i.epp = getelementptr inbounds nuw i8, ptr %i.epk, i64 16
  store ptr %i.epo, ptr %i.epp, align 8, !tbaa !2712
  store ptr %i.epk, ptr %i.i, align 8, !tbaa !2489
  %i.epq = load i32, ptr %i.epc, align 4, !tbaa !2723 ; 2 uses
...
.lr.ph.i.i.i:                                     ; preds = %vdbeMergeEngineNew.exit63.i.i.i
  ...
  %i.eps = getelementptr inbounds nuw i8, ptr %i.epb, i64 16
  %i.ept = getelementptr inbounds nuw i8, ptr %i.epb, i64 88 ; 2 uses
  %i.epu = add i32 %indvars.iv.i.i.i, -2
  %xtraiter13407 = and i32 %.056.i.i.i.i, 7       ; 3 uses
  %i.epv = icmp ult i32 %i.epu, 7
  %unroll_iter13412 = and i32 %.056.i.i.i.i, -8
  %lcmp.mod13409.not = icmp eq i32 %xtraiter13407, 0
  %lcmp.mod13411 = icmp ne i32 %xtraiter13407, 0
  br label %bb.ahl

bb.ahl:                                           ; preds = %.loopexit193.i.i.i, %.lr.ph.i.i.i
  %i.epw = phi i32 [ %i.epq, %.lr.ph.i.i.i ], [ %i.eyb, %.loopexit193.i.i.i ]
  %.037108.i.i.i = phi i32 [ 0, %.lr.ph.i.i.i ], [ %i.eqa, %.loopexit193.i.i.i ] ; 3 uses
  %.039107.i.i.i = phi i32 [ 0, %.lr.ph.i.i.i ], [ %i.eya, %.loopexit193.i.i.i ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.k) #59
  store ptr null, ptr %i.k, align 8, !tbaa !2489
  %i.epx = sub nsw i32 %i.epw, %.039107.i.i.i
  %spec.select56.i.i.i = call i32 @llvm.smin.i32(i32 %i.epx, i32 16)
  %i.epy = call fastcc i32 @vdbeMergeEngineLevel0(ptr noundef nonnull %i.epb, i32 noundef %spec.select56.i.i.i, ptr noundef %i.j, ptr noundef %i.k) ; 2 uses
  %i.epz = icmp eq i32 %i.epy, 0
  br i1 %i.epz, label %bb.ahm, label %.loopexit.thread.sink.split.i.i.i

bb.ahm:                                           ; preds = %bb.ahl
  %i.eqa = add nuw nsw i32 %.037108.i.i.i, 1
  %i.eqb = load ptr, ptr %i.k, align 8, !tbaa !2489
  call void @llvm.lifetime.start.p0(ptr nonnull %i.h) #59
  %i.eqc = call fastcc i32 @vdbeIncrMergerNew(ptr noundef nonnull %i.epb, ptr noundef %i.eqb, ptr noundef nonnull %i.h) ; 4 uses
  br i1 %.not.i.i.i4384, label %.preheader42.thread.i.i.i.i, label %.lr.ph.i64.i.i.i.preheader

.lr.ph.i64.i.i.i.preheader:                       ; preds = %bb.ahm
  br i1 %i.epv, label %.lr.ph.i64.i.i.i.epil.preheader, label %.lr.ph.i64.i.i.i

.preheader42.thread.i.i.i.i:                      ; preds = %bb.ahm
...
.preheader42.i.i.i.i.unr-lcssa:                   ; preds = %.lr.ph.i64.i.i.i
  br i1 %lcmp.mod13409.not, label %.preheader42.i.i.i.i, label %.lr.ph.i64.i.i.i.epil.preheader
...
.lr.ph.i64.i.i.i.epil.preheader:                  ; preds = %.preheader42.i.i.i.i.unr-lcssa, %.lr.ph.i64.i.i.i.preheader
  ...
  call void @llvm.assume(i1 %lcmp.mod13411)
  br label %.lr.ph.i64.i.i.i.epil

.lr.ph.i64.i.i.i.epil:                            ; preds = %.lr.ph.i64.i.i.i.epil, %.lr.ph.i64.i.i.i.epil.preheader
  %.02644.i.i.i.i.epil = phi i32 [ %i.eqe, %.lr.ph.i64.i.i.i.epil ], [ %.02644.i.i.i.i.epil.init, %.lr.ph.i64.i.i.i.epil.preheader ]
  %epil.iter13408 = phi i32 [ %epil.iter13408.next, %.lr.ph.i64.i.i.i.epil ], [ 0, %.lr.ph.i64.i.i.i.epil.preheader ]
  %i.eqe = shl nsw i32 %.02644.i.i.i.i.epil, 4    ; 2 uses
  %epil.iter13408.next = add i32 %epil.iter13408, 1 ; 2 uses
  %epil.iter13408.cmp.not = icmp eq i32 %epil.iter13408.next, %xtraiter13407
  br i1 %epil.iter13408.cmp.not, label %.preheader42.i.i.i.i, label %.lr.ph.i64.i.i.i.epil, !llvm.loop !2725

.preheader42.i.i.i.i:                             ; preds = %.lr.ph.i64.i.i.i.epil, %.preheader42.i.i.i.i.unr-lcssa
  %.lcssa12649 = phi i32 [ 0, %.preheader42.i.i.i.i.unr-lcssa ], [ %i.eqe, %.lr.ph.i64.i.i.i.epil ]
...
.lr.ph.i64.i.i.i:                                 ; preds = %.lr.ph.i64.i.i.i.preheader, %.lr.ph.i64.i.i.i
  %niter13413 = phi i32 [ %niter13413.next.7, %.lr.ph.i64.i.i.i ], [ 0, %.lr.ph.i64.i.i.i.preheader ]
  %niter13413.next.7 = add i32 %niter13413, 8     ; 2 uses
  %niter13413.ncmp.7 = icmp eq i32 %niter13413.next.7, %unroll_iter13412
  br i1 %niter13413.ncmp.7, label %.preheader42.i.i.i.i.unr-lcssa, label %.lr.ph.i64.i.i.i, !llvm.loop !2726

.lr.ph48.i.i.i.i:                                 ; preds = %.preheader42.i.i.i.i, %.thread40.i.i.i.i
  %.12747.i.i.i.i = phi i32 [ %i.etr, %.thread40.i.i.i.i ], [ %.lcssa12649, %.preheader42.i.i.i.i ] ; 2 uses
  %.13046.i.i.i.i = phi i32 [ %i.ets, %.thread40.i.i.i.i ], [ 1, %.preheader42.i.i.i.i ]
  %.03145.i.i.i.i = phi ptr [ %i.etq, %.thread40.i.i.i.i ], [ %i.epk, %.preheader42.i.i.i.i ]
  %i.eqg = sdiv i32 %.037108.i.i.i, %.12747.i.i.i.i
  %i.eqh = srem i32 %i.eqg, 16
  %i.eqi = getelementptr inbounds nuw i8, ptr %.03145.i.i.i.i, i64 24
  %i.eqj = load ptr, ptr %i.eqi, align 8, !tbaa !2498
  ...
  %i.eqn = load ptr, ptr %i.eqm, align 8, !tbaa !2542 ; 2 uses
...
.preheader.preheader.i.i.i.i:                     ; preds = %.lr.ph48.i.i.i.i
  %i.eqp = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 400), align 8, !tbaa !718 ; 2 uses
...
sqlite3FaultSim.exit.i.i.i.i.i:                   ; preds = %.preheader.preheader.i.i.i.i
  %i.eqq = call i32 %i.eqp(i32 noundef 100) #59, !inline_history !2727
...
sqlite3FaultSim.exit.thread.i.i.i.i.i:            ; preds = %sqlite3FaultSim.exit.i.i.i.i.i, %.preheader.preheader.i.i.i.i
  %i.eqr = load i32, ptr @sqlite3Config, align 8, !tbaa !175
  %.not.i90.i.i.i = icmp eq i32 %i.eqr, 0
  br i1 %.not.i90.i.i.i, label %bb.aia, label %bb.ahn

bb.ahn:                                           ; preds = %sqlite3FaultSim.exit.thread.i.i.i.i.i
  %i.eqs = load ptr, ptr @mem0, align 8, !tbaa !176 ; 2 uses
  %.not.i.i91.i.i.i = icmp eq ptr %i.eqs, null
  br i1 %.not.i.i91.i.i.i, label %sqlite3_mutex_enter.exit.i.i.i.i, label %bb.aho

bb.aho:                                           ; preds = %bb.ahn
  %i.eqt = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 128), align 8, !tbaa !9
  call void %i.eqt(ptr noundef nonnull %i.eqs) #59, !inline_history !2728
  br label %sqlite3_mutex_enter.exit.i.i.i.i

sqlite3_mutex_enter.exit.i.i.i.i:                 ; preds = %bb.aho, %bb.ahn
  %i.equ = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 64), align 8, !tbaa !102
  %i.eqv = call i32 %i.equ(i32 noundef range(i32 1, 2147483392) 1376) #59, !inline_history !2729 ; 2 uses
  %i.eqw = load i64, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Stat, i64 120), align 8, !tbaa !18
  %i.eqx = icmp slt i64 %i.eqw, 1376
  br i1 %i.eqx, label %bb.ahp, label %sqlite3StatusHighwater.exit.i.i.i.i.i

bb.ahp:                                           ; preds = %sqlite3_mutex_enter.exit.i.i.i.i
...
sqlite3StatusHighwater.exit.i.i.i.i.i:            ; preds = %bb.ahp, %sqlite3_mutex_enter.exit.i.i.i.i
  %i.eqy = load i64, ptr getelementptr inbounds nuw (i8, ptr @mem0, i64 8), align 8, !tbaa !256 ; 2 uses
  %i.eqz = icmp sgt i64 %i.eqy, 0
  br i1 %i.eqz, label %bb.ahq, label %bb.ahv

bb.ahq:                                           ; preds = %sqlite3StatusHighwater.exit.i.i.i.i.i
  %i.era = load i64, ptr @sqlite3Stat, align 8, !tbaa !18
  %i.erb = sext i32 %i.eqv to i64                 ; 2 uses
  %i.erc = sub nsw i64 %i.eqy, %i.erb
  %.not.i5.i.i.i.i = icmp slt i64 %i.era, %i.erc
  br i1 %.not.i5.i.i.i.i, label %bb.ahu, label %bb.ahr

bb.ahr:                                           ; preds = %bb.ahq
  store atomic i32 1, ptr getelementptr inbounds nuw (i8, ptr @mem0, i64 24) monotonic, align 8
  %i.erd = load ptr, ptr @mem0, align 8, !tbaa !176 ; 2 uses
...
sqlite3_mutex_leave.exit.i.i.i.i.i.i:             ; preds = %bb.ahr
  %i.ere = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 144), align 8, !tbaa !19
  call void %i.ere(ptr noundef nonnull %i.erd) #59, !inline_history !2730
  %.pr.i.i.i.i.i.i = load ptr, ptr @mem0, align 8, !tbaa !176 ; 2 uses
  %.not.i1.i.i.i.i.i.i = icmp eq ptr %.pr.i.i.i.i.i.i, null
  br i1 %.not.i1.i.i.i.i.i.i, label %sqlite3MallocAlarm.exit.i.i.i.i.i, label %bb.ahs

bb.ahs:                                           ; preds = %sqlite3_mutex_leave.exit.i.i.i.i.i.i
  %i.erf = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 128), align 8, !tbaa !9
  call void %i.erf(ptr noundef nonnull %.pr.i.i.i.i.i.i) #59, !inline_history !2731
  br label %sqlite3MallocAlarm.exit.i.i.i.i.i

sqlite3MallocAlarm.exit.i.i.i.i.i:                ; preds = %bb.ahs, %sqlite3_mutex_leave.exit.i.i.i.i.i.i, %bb.ahr
  %i.erg = load i64, ptr getelementptr inbounds nuw (i8, ptr @mem0, i64 16), align 8, !tbaa !257 ; 2 uses
  %.not17.i.i.i.i.i = icmp eq i64 %i.erg, 0
  br i1 %.not17.i.i.i.i.i, label %bb.ahv, label %bb.aht
end_hunk_1
