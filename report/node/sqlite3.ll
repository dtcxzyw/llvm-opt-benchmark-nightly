...
begin_hunk_0_@sqlite3GetToken:bb.a
  ...
  br i1 %.not260319, label %.loopexit277, label %.lr.ph321

.lr.ph321:                                        ; preds = %.loopexit278
  store i32 186, ptr %1, align 4, !tbaa !5
  br label %.lr.ph321.a

.lr.ph321.a:                                      ; preds = %.lr.ph321, %.lr.ph321.a
  %.12320 = phi i64 [ %.11, %.lr.ph321 ], [ %i.dj, %.lr.ph321.a ]
