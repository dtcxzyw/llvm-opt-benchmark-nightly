...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi350 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %i.ih, %vector.body ]
...
bb.bp:                                            ; preds = %bb.d
  %i.ll = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %indvars.iv303
  %i.lm = load ptr, ptr %i.ll, align 8, !tbaa !290
  br label %bb.bs

bb.bq:                                            ; preds = %bb.d
  %i.ln = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %indvars.iv303
  %i.lo = load ptr, ptr %i.ln, align 8, !tbaa !290
  br label %bb.bs

bb.br:                                            ; preds = %bb.d
  %i.lp = getelementptr inbounds nuw [8 x i8], ptr %4, i64 %indvars.iv303
  %i.lq = load ptr, ptr %i.lp, align 8, !tbaa !290
  br label %bb.bs

bb.bs:                                            ; preds = %bb.ao, %sqlite3Fts5ExprPattern.exit.thread, %bb.e, %bb.bp, %bb.bq, %bb.br
  %.1160 = phi ptr [ %.0159284, %bb.br ], [ %i.ad, %bb.e ], [ %.0159284, %bb.bq ], [ %.0159284, %sqlite3Fts5ExprPattern.exit.thread ], [ %.0159284, %bb.bp ], [ %.0159284, %bb.ao ] ; 2 uses
  %.1158 = phi ptr [ %.0157285, %bb.br ], [ %.0157285, %bb.e ], [ %.0157285, %bb.bq ], [ %.0157285, %sqlite3Fts5ExprPattern.exit.thread ], [ %i.lm, %bb.bp ], [ %.0157285, %bb.ao ] ; 2 uses
  %.1155 = phi ptr [ %.0154286, %bb.br ], [ %.0154286, %bb.e ], [ %i.lo, %bb.bq ], [ %.0154286, %sqlite3Fts5ExprPattern.exit.thread ], [ %.0154286, %bb.bp ], [ %.0154286, %bb.ao ] ; 2 uses
  %.1152 = phi ptr [ %i.lq, %bb.br ], [ %.0151287, %bb.e ], [ %.0151287, %bb.bq ], [ %.0151287, %sqlite3Fts5ExprPattern.exit.thread ], [ %.0151287, %bb.bp ], [ %.0151287, %bb.ao ] ; 2 uses
  ...
  %exitcond.not.a = icmp eq i64 %indvars.iv.next304, %wide.trip.count
...
._crit_edge:                                      ; preds = %bb.bs, %bb.c
  ...
  %.not.i217 = icmp eq ptr %spec.select, null     ; 2 uses
  br i1 %.not177.not, label %bb.co, label %bb.bt

bb.bt:                                            ; preds = %._crit_edge
  br i1 %.not.i217, label %fts5GetRowidLimit.exit, label %bb.bu
...
bb.cb:                                            ; preds = %bb.bx
  ...
  %.not9.i.i.i209 = icmp eq i32 %i.mg, 0
  br i1 %.not9.i.i.i209, label %fts5GetRowidLimit.exit, label %bb.cc
...
bb.cc:                                            ; preds = %bb.cb
  ...
  br i1 %.not10.i.i.i, label %fts5GetRowidLimit.exit, label %bb.cd
