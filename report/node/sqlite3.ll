...
bb.e:                                             ; preds = %bb.d
  ...
  %spec.select.i.i.i = select i1 %i.r, i64 9223372036854775807, i64 %i.s
  %.0.i.i.i = select i1 %i.q, i64 -9223372036854775808, i64 %spec.select.i.i.i ; 3 uses
  %i.t = fcmp oeq double %i.m, 0.000000e+00
  br i1 %i.t, label %alsoAnInt.exit.thread.i, label %sqlite3RealSameAsInt.exit.i.i

sqlite3RealSameAsInt.exit.i.i:                    ; preds = %bb.e
...
alsoAnInt.exit.thread.i:                          ; preds = %sqlite3RealSameAsInt.exit.i.i, %bb.e
...
alsoAnInt.exit.i:                                 ; preds = %sqlite3RealSameAsInt.exit.i.i
  ...
  br i1 %.not.i8, label %sqlite3VdbeIntegerAffinity.exit.i, label %bb.f

bb.f:                                             ; preds = %alsoAnInt.exit.i, %bb.d
  store double %i.m, ptr %0, align 8, !tbaa !229
  br label %sqlite3VdbeIntegerAffinity.exit.i

sqlite3VdbeIntegerAffinity.exit.i:                ; preds = %alsoAnInt.exit.thread.i, %alsoAnInt.exit.i, %bb.f
  %.sink14 = phi i16 [ 8, %bb.f ], [ 4, %alsoAnInt.exit.i ], [ 4, %alsoAnInt.exit.thread.i ]
...
applyNumericAffinity.exit:                        ; preds = %sqlite3_mutex_enter.exit, %sqlite3VdbeIntegerAffinity.exit.i
  ...
  br i1 %.not.i9, label %sqlite3_mutex_leave.exit, label %bb.g

bb.g:                                             ; preds = %applyNumericAffinity.exit
  %i.al = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 144), align 8, !tbaa !20
  call void %i.al(ptr noundef nonnull %i.ak) #59, !inline_history !21
end_hunk_0
...
begin_hunk_2_@geopolyRegularFunc:bb.a
  %i.bb = fcmp ole double %.0.i.i79, 0.000000e+00
  %or.cond = select i1 %i.ba, i1 true, i1 %i.bb
  br i1 %or.cond, label %sqlite3_result_error_nomem.exit, label %bb.w

bb.w:                                             ; preds = %sqlite3_value_int.exit
  %i.bc = tail call i32 @llvm.umin.i32(i32 %i.az, i32 1000) ; 6 uses
  %i.bd = tail call i32 @sqlite3_initialize(), !inline_history !398
  %.not.i = icmp eq i32 %i.bd, 0
  br i1 %.not.i, label %sqlite3_malloc64.exit, label %sqlite3_malloc64.exit.thread

sqlite3_malloc64.exit:                            ; preds = %bb.w
  %i.be = shl nuw nsw i32 %i.bc, 1
  %i.bf = add nsw i32 %i.be, -2
  %i.bg = zext nneg i32 %i.bf to i64
  %i.bh = shl nuw nsw i64 %i.bg, 2
  %i.bi = add nuw nsw i64 %i.bh, 40
  %i.bj = tail call fastcc ptr @sqlite3Malloc(i64 noundef %i.bi), !inline_history !398 ; 9 uses
  %i.bk = icmp eq ptr %i.bj, null
  br i1 %i.bk, label %sqlite3_malloc64.exit.thread, label %.lr.ph

sqlite3_malloc64.exit.thread:                     ; preds = %bb.w, %sqlite3_malloc64.exit
  %i.bl = load ptr, ptr %0, align 8, !tbaa !290   ; 3 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 20 ; 2 uses
  %i.bn = load i16, ptr %i.bm, align 4, !tbaa !164
  %i.bo = and i16 %i.bn, -28672
  %.not.i.i86 = icmp eq i16 %i.bo, 0
  br i1 %.not.i.i86, label %bb.y, label %bb.x

bb.x:                                             ; preds = %sqlite3_malloc64.exit.thread
  tail call fastcc void @vdbeMemClearExternAndSetNull(ptr noundef nonnull %i.bl)
  %.pre.i = load ptr, ptr %0, align 8, !tbaa !290
  br label %sqlite3VdbeMemSetNull.exit.i

bb.y:                                             ; preds = %sqlite3_malloc64.exit.thread
  store i16 1, ptr %i.bm, align 4, !tbaa !164
  br label %sqlite3VdbeMemSetNull.exit.i

sqlite3VdbeMemSetNull.exit.i:                     ; preds = %bb.y, %bb.x
  %i.bp = phi ptr [ %.pre.i, %bb.x ], [ %i.bl, %bb.y ]
  %i.bq = getelementptr inbounds nuw i8, ptr %0, i64 36
  store i32 7, ptr %i.bq, align 4, !tbaa !24
  %i.br = getelementptr inbounds nuw i8, ptr %i.bp, i64 24
  %i.bs = load ptr, ptr %i.br, align 8, !tbaa !159 ; 7 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bs, i64 103 ; 2 uses
  %i.bu = load i8, ptr %i.bt, align 1, !tbaa !552
  %i.bv = icmp eq i8 %i.bu, 0
  br i1 %i.bv, label %bb.z, label %sqlite3_result_error_nomem.exit

bb.z:                                             ; preds = %sqlite3VdbeMemSetNull.exit.i
  %i.bw = getelementptr inbounds nuw i8, ptr %i.bs, i64 104
  %i.bx = load i8, ptr %i.bw, align 8, !tbaa !553
  %i.by = icmp eq i8 %i.bx, 0
  br i1 %i.by, label %bb.aa, label %sqlite3_result_error_nomem.exit

bb.aa:                                            ; preds = %bb.z
  store i8 1, ptr %i.bt, align 1, !tbaa !552
  %i.bz = getelementptr inbounds nuw i8, ptr %i.bs, i64 220
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !554
  %i.cb = icmp sgt i32 %i.ca, 0
  br i1 %i.cb, label %bb.ab, label %bb.ac

bb.ab:                                            ; preds = %bb.aa
  %i.cc = getelementptr inbounds nuw i8, ptr %i.bs, i64 424
  store atomic volatile i32 1, ptr %i.cc monotonic, align 8
  br label %bb.ac

bb.ac:                                            ; preds = %bb.ab, %bb.aa
  %i.cd = getelementptr inbounds nuw i8, ptr %i.bs, i64 432 ; 2 uses
  %i.ce = load i32, ptr %i.cd, align 8, !tbaa !555
  %i.cf = add i32 %i.ce, 1
  store i32 %i.cf, ptr %i.cd, align 8, !tbaa !555
  %i.cg = getelementptr inbounds nuw i8, ptr %i.bs, i64 436
  store i16 0, ptr %i.cg, align 4, !tbaa !556
  %i.ch = getelementptr inbounds nuw i8, ptr %i.bs, i64 344 ; 2 uses
  %i.ci = load ptr, ptr %i.ch, align 8, !tbaa !303 ; 2 uses
  %.not.i3.i = icmp eq ptr %i.ci, null
  br i1 %.not.i3.i, label %sqlite3_result_error_nomem.exit, label %bb.ad

bb.ad:                                            ; preds = %bb.ac
  tail call void (ptr, ptr, ...) @sqlite3ErrorMsg(ptr noundef nonnull %i.ci, ptr noundef nonnull @.str.133), !inline_history !557
  %i.cj = load ptr, ptr %i.ch, align 8, !tbaa !303 ; 2 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %i.cj, i64 24
  store i32 7, ptr %i.ck, align 8, !tbaa !304
  %.0.in17.i.i = getelementptr inbounds nuw i8, ptr %i.cj, i64 216
...
.lr.ph.i.i:                                       ; preds = %bb.ad, %.lr.ph.i.i
  %.020.i.i = phi ptr [ %.0.i.i87, %.lr.ph.i.i ], [ %.018.i.i, %bb.ad ] ; 3 uses
  %i.cl = getelementptr inbounds nuw i8, ptr %.020.i.i, i64 52 ; 2 uses
  %i.cm = load i32, ptr %i.cl, align 4, !tbaa !315
  %i.cn = add nsw i32 %i.cm, 1
  store i32 %i.cn, ptr %i.cl, align 4, !tbaa !315
  %i.co = getelementptr inbounds nuw i8, ptr %.020.i.i, i64 24
...
.lr.ph:                                           ; preds = %sqlite3_malloc64.exit
  %i.cp = getelementptr inbounds nuw i8, ptr %i.bj, i64 4 ; 2 uses
  store i8 1, ptr %i.cp, align 4, !tbaa !229
  %i.cq = getelementptr inbounds nuw i8, ptr %i.bj, i64 5
  store i8 0, ptr %i.cq, align 1, !tbaa !229
  %i.cr = lshr i32 %i.bc, 8
  %i.cs = trunc nuw nsw i32 %i.cr to i8
  %i.ct = getelementptr inbounds nuw i8, ptr %i.bj, i64 6
  store i8 %i.cs, ptr %i.ct, align 2, !tbaa !229
  %i.cu = trunc i32 %i.bc to i8
  %i.cv = getelementptr inbounds nuw i8, ptr %i.bj, i64 7
  store i8 %i.cu, ptr %i.cv, align 1, !tbaa !229
  %i.cw = uitofp nneg i32 %i.bc to double
  %i.cx = fneg double %.0.i.i79
  ...
  %i.da = insertelement <2 x double> %i.cz, double %.0.i.i79, i64 1
  %i.db = insertelement <2 x double> poison, double %.0.i.i, i64 0
  %i.dc = insertelement <2 x double> %i.db, double %.0.i.i74, i64 1
  br label %bb.ae
...
bb.ae:                                            ; preds = %.lr.ph, %bb.ae
  ...
  %i.df = fmul nnan double %i.de, f0x401921FB54442D18
  %i.dg = fdiv double %i.df, %i.cw                ; 2 uses
  %i.dh = fadd double %i.dg, f0xBFF921FB54442D18
  %i.di = tail call fastcc double @geopolySine(double noundef %i.dh)
  %.idx = shl nuw nsw i64 %indvars.iv, 3
  %i.dj = getelementptr inbounds nuw i8, ptr %i.cy, i64 %.idx
  %i.dk = tail call fastcc double @geopolySine(double noundef %i.dg)
  %i.dl = insertelement <2 x double> poison, double %i.di, i64 0
  %i.dm = insertelement <2 x double> %i.dl, double %i.dk, i64 1
  %i.dn = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.da, <2 x double> %i.dm, <2 x double> %i.dc)
  %i.do = fptrunc <2 x double> %i.dn to <2 x float>
  store <2 x float> %i.do, ptr %i.dj, align 4, !tbaa !8101
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge, label %bb.ae, !llvm.loop !8109

._crit_edge:                                      ; preds = %bb.ae
  %i.dp = shl nuw nsw i32 %i.bc, 3
  %i.dq = or disjoint i32 %i.dp, 4
  tail call fastcc void @setResultStrOrError(ptr noundef %0, ptr noundef nonnull %i.cp, i32 noundef %i.dq, i8 noundef zeroext 0, ptr noundef nonnull inttoptr (i64 -1 to ptr))
  %i.dr = load i32, ptr @sqlite3Config, align 8, !tbaa !177
  %.not.i88 = icmp eq i32 %i.dr, 0
  br i1 %.not.i88, label %bb.ai, label %bb.af

bb.af:                                            ; preds = %._crit_edge
  %i.ds = load ptr, ptr @mem0, align 8, !tbaa !178 ; 2 uses
  %.not.i.i89 = icmp eq ptr %i.ds, null
  br i1 %.not.i.i89, label %sqlite3_mutex_enter.exit.i, label %bb.ag

bb.ag:                                            ; preds = %bb.af
  %i.dt = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 128), align 8, !tbaa !10
  tail call void %i.dt(ptr noundef nonnull %i.ds) #59, !inline_history !270
  br label %sqlite3_mutex_enter.exit.i

sqlite3_mutex_enter.exit.i:                       ; preds = %bb.ag, %bb.af
  %i.du = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 56), align 8, !tbaa !96
  %i.dv = tail call i32 %i.du(ptr noundef nonnull %i.bj) #59, !inline_history !271
  %i.dw = sext i32 %i.dv to i64
  %i.dx = load i64, ptr @sqlite3Stat, align 8, !tbaa !19
  %i.dy = sub nsw i64 %i.dx, %i.dw
  store i64 %i.dy, ptr @sqlite3Stat, align 8, !tbaa !19
  %i.dz = load i64, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Stat, i64 72), align 8, !tbaa !19
  %i.ea = add nsw i64 %i.dz, -1
  store i64 %i.ea, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Stat, i64 72), align 8, !tbaa !19
  %i.eb = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 40), align 8, !tbaa !182
  tail call void %i.eb(ptr noundef nonnull %i.bj) #59, !inline_history !272
  %i.ec = load ptr, ptr @mem0, align 8, !tbaa !178 ; 2 uses
  %.not.i4.i = icmp eq ptr %i.ec, null
  br i1 %.not.i4.i, label %sqlite3_result_error_nomem.exit, label %bb.ah

bb.ah:                                            ; preds = %sqlite3_mutex_enter.exit.i
  %i.ed = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 144), align 8, !tbaa !20
  tail call void %i.ed(ptr noundef nonnull %i.ec) #59, !inline_history !273
  br label %sqlite3_result_error_nomem.exit

bb.ai:                                            ; preds = %._crit_edge
  %i.ee = load ptr, ptr getelementptr inbounds nuw (i8, ptr @sqlite3Config, i64 40), align 8, !tbaa !182
  tail call void %i.ee(ptr noundef nonnull %i.bj) #59, !inline_history !272
  br label %sqlite3_result_error_nomem.exit

sqlite3_result_error_nomem.exit:                  ; preds = %.lr.ph.i.i, %bb.t, %bb.u, %bb.ai, %bb.ah, %sqlite3_mutex_enter.exit.i, %bb.ad, %bb.ac, %bb.z, %sqlite3VdbeMemSetNull.exit.i, %sqlite3_value_int.exit
  ret void
}
