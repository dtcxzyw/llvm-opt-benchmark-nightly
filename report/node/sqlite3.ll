...
.lr.ph740:                                        ; preds = %bb.d, %bb.cs
  ...
  %.promoted731 = phi i64 [ %10, %bb.cs ], [ 0, %bb.d ] ; 5 uses
...
bb.e:                                             ; preds = %.lr.ph740
  ...
  %i.ap = or i64 %i.ao, %.0242522735
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %.lr.ph740
  %.1243 = phi i64 [ %i.ap, %bb.e ], [ %.0242522735, %.lr.ph740 ] ; 2 uses
  %i.aq = icmp samesign ult i64 %indvars.iv579732, %i.am
  br i1 %i.aq, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f
  %i.ar = load ptr, ptr %i.n, align 8, !tbaa !4464
  %i.as = getelementptr inbounds nuw [8 x i8], ptr %i.ar, i64 %indvars.iv579732
...
bb.l:                                             ; preds = %.lr.ph491, %.critedge3
  ...
  %i.bm = phi i64 [ %.promoted731, %.lr.ph491 ], [ %i.fa, %.critedge3 ] ; 13 uses
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.k
  ...
  %.lcssa489 = phi i64 [ %.promoted731, %bb.k ], [ %i.fa, %._crit_edge.loopexit ] ; 6 uses
...
bb.at:                                            ; preds = %bb.as
  %i.fk = trunc nuw nsw i64 %indvars.iv579732 to i32
...
.lr.ph510:                                        ; preds = %bb.at, %bb.ar, %bb.as, %bb.aw
  %.2220636 = phi i8 [ %i.ga, %bb.aw ], [ 1, %bb.as ], [ 1, %bb.ar ], [ 1, %bb.at ]
  %.0236635 = phi i32 [ %i.gb, %bb.aw ], [ 0, %bb.as ], [ 0, %bb.ar ], [ 0, %bb.at ]
  %.1247634 = phi i64 [ %i.gc, %bb.aw ], [ 1, %bb.as ], [ 1, %bb.ar ], [ 1, %bb.at ]
  %.0249633 = phi ptr [ %i.fn, %bb.aw ], [ null, %bb.as ], [ null, %bb.ar ], [ null, %bb.at ] ; 6 uses
  ...
  %i.gm = shl nuw i64 1, %indvars.iv579732
  br label %bb.ax
...
bb.cr:                                            ; preds = %sqlite3WhereExprUsage.exit.thread448, %sqlite3ExprIsConstant.exit, %bb.cl
  ...
  br i1 %exitcond578.not, label %.loopexit463, label %bb.cl, !llvm.loop !4677
...
bb.cs:                                            ; preds = %.loopexit463, %bb.g
  %10 = phi i64 [ %.promoted731, %bb.g ], [ %.lcssa514, %.loopexit463 ] ; 3 uses
  %.2259 = phi ptr [ %i.at, %bb.g ], [ %.1258, %.loopexit463 ]
  %.1245 = phi i64 [ %.0244521736, %bb.g ], [ %i.ls, %.loopexit463 ]
  %indvars.iv.next580 = add nuw nsw i64 %indvars.iv579732, 1
  %i.mx = icmp ult i64 %10, %i.k
  %.not275 = icmp samesign ult i64 %indvars.iv579732, %i.am
  %or.cond.not = select i1 %i.mx, i1 %.not275, i1 false
  br i1 %or.cond.not, label %.lr.ph740, label %.critedge, !llvm.loop !4678

.critedge:                                        ; preds = %bb.cs, %.loopexit464, %bb.d, %bb.i, %bb.j
  %or.cond.not720 = phi i1 [ true, %bb.i ], [ true, %bb.j ], [ false, %bb.d ], [ true, %.loopexit464 ], [ false, %bb.cs ]
  %i.my = phi i64 [ %.promoted731, %bb.i ], [ %.promoted731, %bb.j ], [ 0, %bb.d ], [ %9, %.loopexit464 ], [ %10, %bb.cs ] ; 2 uses
