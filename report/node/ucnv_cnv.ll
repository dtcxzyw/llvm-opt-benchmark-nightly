...
begin_hunk_1_@ucnv_fromUWriteBytes_78:bb.a
  ...
  %umin99 = tail call i64 @llvm.umin.i64(i64 %i.al, i64 %i.an) ; 3 uses
  %i.ao = add nuw nsw i64 %umin99, 1              ; 5 uses
  ...
  br i1 %or.cond, label %.lr.ph53.preheader153, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %.lr.ph53.preheader.a
  %min.iters.check102 = icmp samesign ult i64 %umin99, 31
  br i1 %min.iters.check102, label %vec.epilog.ph, label %vector.ph102

vector.ph102:                                     ; preds = %vector.main.loop.iter.check
  %n.mod.vf104 = and i64 %i.ao, 28
  %n.vec104 = and i64 %i.ao, 8589934560           ; 6 uses
...
begin_hunk_2_@ucnv_fromUWriteBytes_78:bb.a
  ...
  br i1 %i.av, label %middle.block114, label %vector.body106, !llvm.loop !17

middle.block114:                                  ; preds = %vector.body106
  %cmp.n115 = icmp eq i64 %i.ao, %n.vec104
  br i1 %cmp.n115, label %.loopexit41, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block114
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf104, 0
  br i1 %min.epilog.iters.check, label %.lr.ph53.preheader153, label %vec.epilog.ph, !prof !18

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec104, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec120 = and i64 %i.ao, 8589934588           ; 5 uses
  %8 = getelementptr i8, ptr %.fr, i64 %n.vec120  ; 2 uses
  %9 = getelementptr i8, ptr %1, i64 %n.vec120    ; 2 uses
  %.cast121 = trunc i64 %n.vec120 to i32
  %10 = sub i32 %2, %.cast121                     ; 2 uses
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index122 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next126, %vec.epilog.vector.body ] ; 3 uses
  %next.gep123 = getelementptr i8, ptr %.fr, i64 %index122
  %next.gep124 = getelementptr i8, ptr %1, i64 %index122
  %wide.load125 = load <4 x i8>, ptr %next.gep124, align 1
  store <4 x i8> %wide.load125, ptr %next.gep123, align 1
  %index.next126 = add nuw i64 %index122, 4       ; 2 uses
  %11 = icmp eq i64 %index.next126, %n.vec120
  br i1 %11, label %middle.block113, label %vec.epilog.vector.body, !llvm.loop !19

middle.block113:                                  ; preds = %vec.epilog.vector.body
  %cmp.n114 = icmp eq i64 %i.ao, %n.vec120
  br i1 %cmp.n114, label %.loopexit41, label %.lr.ph53.preheader153

.lr.ph53.preheader153:                            ; preds = %.lr.ph53.preheader.a, %vec.epilog.iter.check, %middle.block113
  %.02951.ph = phi ptr [ %.fr, %.lr.ph53.preheader.a ], [ %i.aq, %vec.epilog.iter.check ], [ %8, %middle.block113 ]
  %.03050.ph = phi ptr [ %1, %.lr.ph53.preheader.a ], [ %i.ar, %vec.epilog.iter.check ], [ %9, %middle.block113 ]
  %.03449.ph = phi i32 [ %2, %.lr.ph53.preheader.a ], [ %i.as, %vec.epilog.iter.check ], [ %10, %middle.block113 ]
  br label %.lr.ph53
...
begin_hunk_3_@ucnv_fromUWriteBytes_78:bb.a
  ...
  br i1 %i.bc, label %.lr.ph53, label %.loopexit41, !llvm.loop !20
...
begin_hunk_4_@ucnv_fromUWriteBytes_78:bb.a
  ...
  br i1 %i.bk, label %.lr.ph, label %._crit_edge, !llvm.loop !21
...
.loopexit41:                                      ; preds = %.lr.ph53, %middle.block114, %middle.block113, %bb.c, %._crit_edge
  %.236 = phi i32 [ %.135.lcssa, %._crit_edge ], [ %2, %bb.c ], [ %10, %middle.block113 ], [ %i.as, %middle.block114 ], [ %i.az, %.lr.ph53 ] ; 9 uses
  %.232 = phi ptr [ %.131.lcssa, %._crit_edge ], [ %1, %bb.c ], [ %9, %middle.block113 ], [ %i.ar, %middle.block114 ], [ %i.aw, %.lr.ph53 ] ; 7 uses
  %.2 = phi ptr [ %.1.lcssa, %._crit_edge ], [ %.fr, %bb.c ], [ %8, %middle.block113 ], [ %i.aq, %middle.block114 ], [ %i.ay, %.lr.ph53 ]
...
begin_hunk_6_@ucnv_fromUWriteBytes_78:bb.a
  ...
  br i1 %i.bx, label %middle.block135, label %vector.body128, !llvm.loop !22
...
vec.epilog.iter.check.a:                          ; preds = %middle.block135
  ...
  br i1 %min.epilog.iters.check.a, label %vec.epilog.scalar.ph.preheader, label %vec.epilog.ph.a, !prof !18
...
begin_hunk_8_@ucnv_fromUWriteBytes_78:bb.a
  ...
  br i1 %i.cb, label %vec.epilog.middle.block, label %vec.epilog.vector.body.a, !llvm.loop !23
...
begin_hunk_9_@ucnv_fromUWriteBytes_78:bb.a
  ...
  br i1 %i.cg, label %vec.epilog.scalar.ph, label %.loopexit, !llvm.loop !24
...
begin_hunk_10_@ucnv_toUWriteUChars_78:bb.a
  ...
  br i1 %i.r, label %.lr.ph53, label %.loopexit41, !llvm.loop !25
...
begin_hunk_11_@ucnv_toUWriteUChars_78:bb.a
  ...
  br i1 %i.z, label %.lr.ph, label %._crit_edge, !llvm.loop !26
...
begin_hunk_12_@ucnv_toUWriteUChars_78:bb.a
  ...
  br i1 %i.ao, label %middle.block, label %vector.body, !llvm.loop !27
...
begin_hunk_15_@ucnv_toUWriteUChars_78:bb.a
  ...
  br i1 %i.bb, label %vec.epilog.scalar.ph, label %.loopexit, !llvm.loop !30
