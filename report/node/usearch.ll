...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi44 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %i.bb, %vector.body ]
  ...
  %i.at = add <4 x i16> %wide.load45, splat (i16 -12645)
  ...
  %i.bb = add <4 x i32> %vec.phi44, %i.az         ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader46, %.lr.ph
  %.038 = phi ptr [ %i.be, %.lr.ph ], [ %.038.ph, %.lr.ph.preheader46 ] ; 2 uses
  %storemerge3637 = phi i32 [ %storemerge, %.lr.ph ], [ %storemerge3637.ph, %.lr.ph.preheader46 ]
