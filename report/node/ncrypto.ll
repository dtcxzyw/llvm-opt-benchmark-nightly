...
end_hunk_0
begin_hunk_1_@_ZN7ncrypto6Cipher7recoverERKNS_13EVPKeyPointerERKNS0_12CipherParamsENS_6BufferIKvEE:bb.a
...
bb.a:
  %1 = alloca %"class.std::function.101", align 8 ; 5 uses
  %2 = alloca %"struct.ncrypto::(anonymous namespace)::CipherCallbackContext", align 8 ; 7 uses
...
bb.c:                                             ; preds = %_ZNSt8functionIFvPKcEEaSEOS3_.exit
  %i.e = call noundef zeroext i1 %i.d(ptr noundef nonnull align 8 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %2, i32 noundef 3) #21, !inline_history !346 ; 0 uses
