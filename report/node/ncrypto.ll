...
.lr.ph:                                           ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEmcRKS3_.exit, %bb.i
  ...
  %i.u = mul nuw nsw i64 %indvars.iv, 3           ; 3 uses
  %i.v = getelementptr inbounds nuw i8, ptr %i.b, i64 %indvars.iv ; 2 uses
  %i.w = load i8, ptr %i.v, align 1
  %i.x = lshr i8 %i.w, 4
  %i.y = zext nneg i8 %i.x to i64
  %i.z = getelementptr inbounds nuw i8, ptr @_ZZNK7ncrypto8X509View14getFingerprintB5cxx11ERKNS_6DigestEE3hex, i64 %i.y
  %i.aa = load i8, ptr %i.z, align 1
  %i.ab = load ptr, ptr %3, align 8
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 %i.u
  store i8 %i.aa, ptr %i.ac, align 1
  %i.ad = load i8, ptr %i.v, align 1
  %i.ae = and i8 %i.ad, 15
...
bb.i:                                             ; preds = %.lr.ph
  ...
  br i1 %i.ap, label %.lr.ph, label %.critedge, !llvm.loop !53
...
.critedge:                                        ; preds = %bb.i, %.lr.ph, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2IS3_EEmcRKS3_.exit
  ...
  br i1 %i.as, label %bb.j, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i.i

bb.j:                                             ; preds = %.critedge
  %i.at = load i64, ptr %i.r, align 8             ; 3 uses
  %i.au = icmp ult i64 %i.at, 16
  call void @llvm.assume(i1 %i.au)
  %i.av = add nuw nsw i64 %i.at, 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.aq, ptr noundef nonnull align 8 dereferenceable(1) %i.l, i64 %i.av, i1 false)
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.j, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i.i
  %i.ax = phi i64 [ %i.at, %bb.j ], [ %.pre, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i.i ]
