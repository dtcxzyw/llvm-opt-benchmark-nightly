...
._crit_edge340.loopexit.peel.begin.i:             ; preds = %bb.i
  ...
  %i.gs = select i1 %i.gr, i32 %.0303.i, i32 %.0302.i ; 6 uses
...
begin_hunk_1_@aesni_cbc_hmac_sha1_tls1_multiblock_encrypt:bb.a
  ...
  %invariant.op = sub i32 21, %.1308.i
  br label %bb.k
...
begin_hunk_2_@aesni_cbc_hmac_sha1_tls1_multiblock_encrypt:bb.a
  ...
  %i.jc = select i1 %i.jb, i32 %.0303.i, i32 %.0302.i ; 4 uses
...
begin_hunk_3_@aesni_cbc_hmac_sha1_tls1_multiblock_encrypt:bb.a
  ...
  %.not.i = sub i32 11, %i.jc
  %i.kh = and i32 %.not.i, 15                     ; 3 uses
  %i.ki = trunc nuw nsw i32 %i.kh to i8
  %i.kj = zext nneg i32 %i.kh to i64              ; 2 uses
  %i.kk = add nuw nsw i64 %i.kj, 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %i.kg, i8 %i.ki, i64 %i.kk, i1 false), !tbaa !10
  ...
  %6 = add i32 %i.kh, %i.jc                       ; 3 uses
  %.reass.i.reass.reass = add i32 %6, %invariant.op
...
begin_hunk_5_@aesni_cbc_hmac_sha1_tls1_multiblock_encrypt:bb.a
  ...
  %.not.peel.i = sub i32 11, %i.gs
  %i.mg = and i32 %.not.peel.i, 15                ; 3 uses
  %i.mh = trunc nuw nsw i32 %i.mg to i8
  %narrow.i = add nuw nsw i32 %i.mg, 1
  %i.mi = zext nneg i32 %narrow.i to i64
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %i.mf, i8 %i.mh, i64 %i.mi, i1 false), !tbaa !10
  %7 = add i32 %i.mg, %i.gs                       ; 3 uses
  %reass.sub.peel.i = add i32 %7, 21
