...
@.str = private unnamed_addr constant [47 x i8] c"../../deps/openssl/openssl/crypto/ui/ui_util.c\00", align 1
...
define dso_local i32 @UI_UTIL_read_pw_string(ptr noundef %0, i32 noundef %1, ptr noundef %2, i32 noundef %3) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define dso_local i32 @UI_UTIL_read_pw(ptr noundef %0, ptr noundef %1, i32 noundef %2, ptr noundef %3, i32 noundef %4) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define dso_local ptr @UI_UTIL_wrap_read_pem_callback(ptr noundef %0, i32 noundef %1) local_unnamed_addr #0 {
bb.a:
...
bb.h:                                             ; preds = %bb.g
  %i.o = load i32, ptr @ui_method_data_index, align 4, !tbaa !5
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i32, ptr @ui_method_data_index, align 4, !tbaa !5
...
bb.a:
  ...
  store i32 %i.a, ptr @ui_method_data_index, align 4, !tbaa !5
...
!8 = !{!"Simple C/C++ TBAA"}
!9 = !{!10, !6, i64 8}
!10 = !{!"pem_password_cb_data", !11, i64 0, !6, i64 8}
