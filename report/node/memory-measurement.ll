...
bb.a:
  %2 = alloca %"class.v8::internal::(anonymous namespace)::MemoryMeasurementResultBuilder", align 8 ; 15 uses
...
begin_hunk_1_@_ZN2v88internal21MeasureMemoryDelegate19MeasurementCompleteENS_21MeasureMemoryDelegate6ResultE:bb.a
  ...
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bi, i64 344 ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(33) %i.bk, i8 0, i64 33, i1 false)
  %.sroa.0.0.copyload.i.i.i.i.i = load i64, ptr %i.bl, align 8
...
begin_hunk_2_@_ZN2v88internal21MeasureMemoryDelegate19MeasurementCompleteENS_21MeasureMemoryDelegate6ResultE:bb.a
  ...
  %i.ce = tail call ptr @_ZN2v88internal7Factory11NewJSObjectENS0_12DirectHandleINS0_10JSFunctionEEENS0_14AllocationTypeENS0_15NewJSObjectTypeE(ptr noundef nonnull align 1 dereferenceable(1) %i.bi, ptr nonnull %.0.i.i.i.i, i8 noundef zeroext 0, i8 noundef zeroext 0) #17 ; 4 uses
  store ptr %i.ce, ptr %i.bk, align 8
...
bb.e:                                             ; preds = %_ZN2v88internal12_GLOBAL__N_130MemoryMeasurementResultBuilderC2EPNS_7IsolateE.exit
  %.sroa.0.0.copyload.i.i.i.i.i39 = load i64, ptr %i.bl, align 8
...
begin_hunk_4_@_ZN2v88internal21MeasureMemoryDelegate19MeasurementCompleteENS_21MeasureMemoryDelegate6ResultE:bb.a
  ...
  br i1 %i.fh, label %bb.q, label %.loopexit._ZN2v88internal12_GLOBAL__N_130MemoryMeasurementResultBuilder5BuildEv.exit_crit_edge
...
begin_hunk_5_@_ZN2v88internal21MeasureMemoryDelegate19MeasurementCompleteENS_21MeasureMemoryDelegate6ResultE:bb.a
  ...
  br i1 %i.hy, label %.loopexit.thread, label %.loopexit._ZN2v88internal12_GLOBAL__N_130MemoryMeasurementResultBuilder5BuildEv.exit_crit_edge

.loopexit._ZN2v88internal12_GLOBAL__N_130MemoryMeasurementResultBuilder5BuildEv.exit_crit_edge: ; preds = %bb.p, %.loopexit
  %.sroa.0.0.copyload.i.pre = load ptr, ptr %i.bk, align 8
...
._crit_edge.i:                                    ; preds = %_ZN2v88internal15TaggedArrayBaseINS0_10FixedArrayENS0_16TaggedArrayShapeENS0_16HeapObjectLayoutEE3setEiNS0_6TaggedINS0_6ObjectEEENS0_16WriteBarrierModeE.exit.i, %.loopexit.thread
  %.sroa.04.0.copyload.i = load ptr, ptr %i.bk, align 8 ; 2 uses
...
begin_hunk_7_@_ZN2v88internal21MeasureMemoryDelegate19MeasurementCompleteENS_21MeasureMemoryDelegate6ResultE:bb.a
  ...
  tail call void @_ZN2v88internal8JSObject11AddPropertyEPNS0_7IsolateENS0_12DirectHandleIS1_EENS4_INS0_4NameEEENS4_INS0_6ObjectEEENS0_18PropertyAttributesE(ptr noundef nonnull %i.bi, ptr %.sroa.04.0.copyload.i, ptr nonnull %i.ij, ptr %i.ir, i32 noundef 0) #17
  br label %_ZN2v88internal12_GLOBAL__N_130MemoryMeasurementResultBuilder5BuildEv.exit
...
_ZN2v88internal12_GLOBAL__N_130MemoryMeasurementResultBuilder5BuildEv.exit: ; preds = %.loopexit._ZN2v88internal12_GLOBAL__N_130MemoryMeasurementResultBuilder5BuildEv.exit_crit_edge, %._crit_edge.i
  %.sroa.0.0.copyload.i = phi ptr [ %.sroa.0.0.copyload.i.pre, %.loopexit._ZN2v88internal12_GLOBAL__N_130MemoryMeasurementResultBuilder5BuildEv.exit_crit_edge ], [ %.sroa.04.0.copyload.i, %._crit_edge.i ]
...
begin_hunk_9_@_ZN2v88internal21MeasureMemoryDelegate19MeasurementCompleteENS_21MeasureMemoryDelegate6ResultE:bb.a
  ...
  %i.ka = tail call i16 @_ZN2v87Promise8Resolver7ResolveENS_5LocalINS_7ContextEEENS2_INS_5ValueEEE(ptr noundef nonnull align 1 dereferenceable(1) %.0.i.i, ptr nonnull %.sroa.054.0, ptr %.sroa.0.0.copyload.i) #17
