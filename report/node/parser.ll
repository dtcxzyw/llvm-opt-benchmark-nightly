...
bb.f:                                             ; preds = %bb.e
  ...
  %or.cond79 = select i1 %i.bc, i1 %switch.lobit, i1 false
  br i1 %or.cond79, label %switch.lookup, label %bb.g
...
switch.lookup:                                    ; preds = %bb.f
  ...
  %switch.shiftamt76 = zext nneg i8 %i.be to i64
  %switch.downshift77 = lshr i64 216172782113915140, %switch.shiftamt76
  %switch.masked78 = trunc i64 %switch.downshift77 to i8
...
bb.j:                                             ; preds = %bb.i
  ...
  call void @_ZN2v88internal6Parser25DeclarePrivateClassMemberEPNS0_10ClassScopeEPKNS0_12AstRawStringEPNS0_20ClassLiteralPropertyENS7_4KindEbPNS0_10ParserBaseIS1_E9ClassInfoE(ptr noundef nonnull align 8 dereferenceable(1852) %0, ptr noundef %i.bx, ptr noundef %i.by, ptr noundef %i.au, i8 noundef zeroext %switch.masked78, i1 noundef zeroext %i.ca, ptr noundef nonnull %1)
  %i.cb = load ptr, ptr %i.v, align 8
  %i.cc = load ptr, ptr %i.w, align 8
  %i.cd = icmp eq ptr %i.cb, %i.cc
  br i1 %i.cd, label %_ZN2v88internal16FuncNameInferrer5InferEv.exit.jt2, label %bb.k, !llvm.loop !38
...
bb.n:                                             ; preds = %bb.m
  %i.ce = load i32, ptr %i.x, align 4
  %i.cf = add nsw i32 %i.ce, 1
  store i32 %i.cf, ptr %i.x, align 4
  ...
  %.pre56 = load i8, ptr %i.r, align 1, !range !6
  %.pre57 = trunc nuw i8 %.pre to i1
  %i.ci = trunc nuw i8 %.pre56 to i1
  br label %bb.o

bb.o:                                             ; preds = %bb.n, %bb.m
  %.pre-phi = phi i1 [ %.pre57, %bb.n ], [ %i.bi, %bb.m ]
  ...
  br i1 %i.cm, label %_ZN2v88internal16FuncNameInferrer5InferEv.exit.jt2, label %_ZN2v88internal16FuncNameInferrer5InferEv.exit.jt2.sink.split
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  br i1 %i.cp, label %_ZN2v88internal16FuncNameInferrer5InferEv.exit.jt2, label %_ZN2v88internal16FuncNameInferrer5InferEv.exit.jt2.sink.split
...
_ZN2v88internal16FuncNameInferrer5InferEv.exit.jt2: ; preds = %_ZN2v88internal16FuncNameInferrer5InferEv.exit.jt2.sink.split, %bb.r, %bb.o, %bb.j
  ...
  br i1 %i.cv, label %bb.s, label %_ZN2v88internal16FuncNameInferrer5StateD2Ev.exit.jt2

_ZN2v88internal16FuncNameInferrer5InferEv.exit.jt1: ; preds = %bb.e
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #19
  %i.cw = load ptr, ptr %i.y, align 8
  %i.cx = load ptr, ptr %i.j, align 8             ; 2 uses
  %i.cy = ptrtoint ptr %i.cw to i64
  %i.cz = ptrtoint ptr %i.cx to i64
  %i.da = sub i64 %i.cy, %i.cz
  %i.db = icmp ugt i64 %i.ao, %i.da
  br i1 %i.db, label %bb.t, label %_ZN2v88internal16FuncNameInferrer5StateD2Ev.exit.jt1
...
_ZN2v88internal16FuncNameInferrer5StateD2Ev.exit.jt2: ; preds = %_ZN2v88internal16FuncNameInferrer5InferEv.exit.jt2, %bb.s
  %i.dc = phi ptr [ %i.cr, %_ZN2v88internal16FuncNameInferrer5InferEv.exit.jt2 ], [ %.pre.i.i.jt2, %bb.s ]
  %i.dd = getelementptr inbounds nuw i8, ptr %i.dc, i64 %i.ao
  store ptr %i.dd, ptr %i.k, align 8
  %i.de = load i64, ptr %i.l, align 8
  %i.df = add i64 %i.de, -1
  store i64 %i.df, ptr %i.l, align 8
  br label %.backedge

_ZN2v88internal16FuncNameInferrer5StateD2Ev.exit.jt1: ; preds = %_ZN2v88internal16FuncNameInferrer5InferEv.exit.jt1, %bb.t
  %i.dg = phi ptr [ %i.cx, %_ZN2v88internal16FuncNameInferrer5InferEv.exit.jt1 ], [ %.pre.i.i.jt1, %bb.t ]
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dg, i64 %i.ao
  store ptr %i.dh, ptr %i.k, align 8
  %i.di = load i64, ptr %i.l, align 8
  %i.dj = add i64 %i.di, -1
  store i64 %i.dj, ptr %i.l, align 8
  br label %.loopexit

._crit_edge:                                      ; preds = %.backedge, %bb.a
  %.lcssa = phi ptr [ %i.d, %bb.a ], [ %i.af, %.backedge ]
  %i.dk = call noundef zeroext i8 @_ZN2v88internal7Scanner4NextEv(ptr noundef nonnull align 8 dereferenceable(560) %.lcssa) #19 ; 2 uses
  %.not.i = icmp eq i8 %i.dk, %4
  br i1 %.not.i, label %_ZN2v88internal10ParserBaseINS0_6ParserEE6ExpectENS0_5Token5ValueE.exit, label %bb.u, !prof !8

bb.u:                                             ; preds = %._crit_edge
  call void @_ZN2v88internal10ParserBaseINS0_6ParserEE21ReportUnexpectedTokenENS0_5Token5ValueE(ptr noundef nonnull align 8 dereferenceable(390) %0, i8 noundef zeroext %i.dk)
...
_ZN2v88internal10ParserBaseINS0_6ParserEE6ExpectENS0_5Token5ValueE.exit: ; preds = %._crit_edge, %bb.u
  ...
  %i.dr = getelementptr inbounds nuw i8, ptr %i.dl, i64 108
