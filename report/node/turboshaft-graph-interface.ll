...
vector.memcheck:                                  ; preds = %.lr.ph.i.i.i.preheader
  ...
  %i.dh = ashr exact i64 %sext77, 29
  %i.di = add i64 %i.dh, %i.cm
  %sext78 = shl i64 %i.bd, 32
  %i.dj = ashr exact i64 %sext78, 29
  %.neg79 = sub i64 %i.dj, %i.di
  %i.dk = add i64 %.neg79, %.ph72
  %diff.check = icmp ult i64 %i.dk, 32
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.dm = getelementptr i8, ptr %.ph, i64 %i.dl
  %i.dn = getelementptr i8, ptr %i.co, i64 %i.dl
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.do = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %.ph, i64 %i.do ; 2 uses
  %next.gep73 = getelementptr i8, ptr %i.co, i64 %i.do ; 2 uses
  %i.dp = getelementptr i8, ptr %next.gep73, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep73, align 4
  %wide.load74 = load <2 x i64>, ptr %i.dp, align 4
  %i.dq = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 4
  store <2 x i64> %wide.load74, ptr %i.dq, align 4
...
.lr.ph.i.i.i.preheader80:                         ; preds = %vector.memcheck, %.lr.ph.i.i.i.preheader, %middle.block
  %.011.i.i.i.ph = phi ptr [ %.ph, %vector.memcheck ], [ %.ph, %.lr.ph.i.i.i.preheader ], [ %i.dm, %middle.block ]
  %.0810.i.i.i.ph = phi ptr [ %i.co, %vector.memcheck ], [ %i.co, %.lr.ph.i.i.i.preheader ], [ %i.dn, %middle.block ]
  br label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader80, %.lr.ph.i.i.i
  %.011.i.i.i = phi ptr [ %i.du, %.lr.ph.i.i.i ], [ %.011.i.i.i.ph, %.lr.ph.i.i.i.preheader80 ] ; 2 uses
  %.0810.i.i.i = phi ptr [ %i.dt, %.lr.ph.i.i.i ], [ %.0810.i.i.i.ph, %.lr.ph.i.i.i.preheader80 ] ; 2 uses
  %i.ds = load i64, ptr %.0810.i.i.i, align 4
  store i64 %i.ds, ptr %.011.i.i.i, align 4
  %i.dt = getelementptr inbounds nuw i8, ptr %.0810.i.i.i, i64 8 ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %.011.i.i.i, i64 8
  %.not.i.i.i21 = icmp eq ptr %i.dt, %i.cl
...
_ZSt18uninitialized_copyIPKN2v88internal4wasm32TurboshaftGraphBuildingInterface5ValueEPS4_ET0_T_S9_S8_.exit: ; preds = %_ZN2v84base11SmallVectorINS_8internal4wasm32TurboshaftGraphBuildingInterface5ValueELm8ESaIS5_EEC2ENS0_6VectorIKS5_EERKS6_.exit.i, %_ZSt18uninitialized_copyIPKN2v88internal4wasm32TurboshaftGraphBuildingInterface5ValueEPS4_ET0_T_S9_S8_.exit.loopexit
  %i.dv = phi ptr [ %i.cx, %_ZSt18uninitialized_copyIPKN2v88internal4wasm32TurboshaftGraphBuildingInterface5ValueEPS4_ET0_T_S9_S8_.exit.loopexit ], [ %i.dc, %_ZN2v84base11SmallVectorINS_8internal4wasm32TurboshaftGraphBuildingInterface5ValueELm8ESaIS5_EEC2ENS0_6VectorIKS5_EERKS6_.exit.i ]
  %i.dw = phi ptr [ %.pre61, %_ZSt18uninitialized_copyIPKN2v88internal4wasm32TurboshaftGraphBuildingInterface5ValueEPS4_ET0_T_S9_S8_.exit.loopexit ], [ %i.db, %_ZN2v84base11SmallVectorINS_8internal4wasm32TurboshaftGraphBuildingInterface5ValueELm8ESaIS5_EEC2ENS0_6VectorIKS5_EERKS6_.exit.i ]
  %i.dx = getelementptr inbounds nuw [8 x i8], ptr %i.dw, i64 %i.cn
  store ptr %i.dx, ptr %i.dv, align 8
  %i.dy = and i64 %.sroa.04.0.i.i.i3, 4293918720
  %i.dz = icmp eq i64 %i.dy, 0
  br i1 %i.dz, label %_ZNK2v88internal4wasm18ContIndexImmediate9heap_typeEv.exit23, label %bb.m, !prof !8
...
_ZNK2v88internal4wasm18ContIndexImmediate9heap_typeEv.exit23: ; preds = %_ZSt18uninitialized_copyIPKN2v88internal4wasm32TurboshaftGraphBuildingInterface5ValueEPS4_ET0_T_S9_S8_.exit
  %i.ea = shl nuw nsw i8 %i.at, 4
  %i.eb = or disjoint i8 %i.ea, -125
  %i.ec = zext i8 %i.eb to i64
  %i.ed = shl nuw nsw i64 %.sroa.04.0.i.i.i3, 8
  %.sroa.035.0.insert.ext = or disjoint i64 %i.ed, %i.ec
  %.sroa.035.0.insert.insert = or i64 %.sroa.035.0.insert.ext, -4294967296
  %i.ee = load ptr, ptr %i.bq, align 8
  store i64 %.sroa.035.0.insert.insert, ptr %i.ee, align 4
  %i.ef = load ptr, ptr %i.bq, align 8
  %i.eg = getelementptr inbounds nuw i8, ptr %i.ef, i64 8
  store ptr %i.eg, ptr %i.bq, align 8
  %i.eh = getelementptr inbounds nuw i8, ptr %0, i64 528
  %i.ei = load i8, ptr %i.eh, align 8, !range !10, !noundef !11
  %i.ej = trunc nuw i8 %i.ei to i1
  br i1 %i.ej, label %bb.n, label %_ZN2v88internal4wasm15WasmFullDecoderINS1_7Decoder15NoValidationTagENS1_32TurboshaftGraphBuildingInterfaceELNS1_12DecodingModeE0EE18DecodeContBindImplEPNS7_9TraceLineENS1_10WasmOpcodeE.exit, !prof !8
...
_ZN2v88internal4wasm15WasmFullDecoderINS1_7Decoder15NoValidationTagENS1_32TurboshaftGraphBuildingInterfaceELNS1_12DecodingModeE0EE18DecodeContBindImplEPNS7_9TraceLineENS1_10WasmOpcodeE.exit: ; preds = %_ZNK2v88internal4wasm18ContIndexImmediate9heap_typeEv.exit23
  %i.ek = add nuw nsw i32 %.sroa.5.0.i.i.i, 1
  %i.el = add nuw nsw i32 %i.ek, %.sroa.5.0.i.i.i4
