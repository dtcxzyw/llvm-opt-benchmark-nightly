...
begin_hunk_2_@a2d_ASN1_OBJECT:bb.a
  ...
  br i1 %found.conflict, label %.lr.ph257.preheader397, label %vector.main.loop.iter.check
...
begin_hunk_3_@a2d_ASN1_OBJECT:bb.a
  ...
  br i1 %i.ca, label %middle.block, label %vector.body, !llvm.loop !23
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph257.preheader397, label %vec.epilog.ph, !prof !26

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec399 = and i64 %i.bo, -8                   ; 4 uses
  %4 = sub nsw i64 %i.bn, %n.vec399
  %5 = add nsw i64 %n.vec399, %i.bm               ; 2 uses
  %invariant.gep447 = getelementptr i8, ptr %.3112, i64 %i.bn
  %invariant.gep449 = getelementptr i8, ptr %0, i64 %i.bm
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index400 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next403, %vec.epilog.vector.body ] ; 3 uses
  %6 = xor i64 %index400, -1
  %gep448 = getelementptr i8, ptr %invariant.gep447, i64 %6
  %7 = getelementptr inbounds i8, ptr %gep448, i64 -7
  %wide.load401 = load <8 x i8>, ptr %7, align 1, !tbaa !15, !alias.scope !18
  %8 = or <8 x i8> %wide.load401, splat (i8 -128)
  %9 = shufflevector <8 x i8> %8, <8 x i8> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  %gep450 = getelementptr i8, ptr %invariant.gep449, i64 %index400
  store <8 x i8> %9, ptr %gep450, align 1, !tbaa !15, !alias.scope !21, !noalias !18
  %index.next403 = add nuw i64 %index400, 8       ; 2 uses
  %10 = icmp eq i64 %index.next403, %n.vec399
  br i1 %10, label %middle.block.a, label %vec.epilog.vector.body, !llvm.loop !27

middle.block.a:                                   ; preds = %vec.epilog.vector.body
  %cmp.n.a = icmp eq i64 %i.bo, %n.vec399
  br i1 %cmp.n.a, label %._crit_edge258.loopexit, label %.lr.ph257.preheader397

.lr.ph257.preheader397:                           ; preds = %vector.memcheck, %.lr.ph257.preheader.a, %vec.epilog.iter.check, %middle.block.a
  %indvars.iv314.ph = phi i64 [ %i.bn, %.lr.ph257.preheader.a ], [ %i.bn, %vector.memcheck ], [ %i.bq, %vec.epilog.iter.check ], [ %4, %middle.block.a ]
  %indvars.iv312.ph = phi i64 [ %i.bm, %.lr.ph257.preheader.a ], [ %i.bm, %vector.memcheck ], [ %i.br, %vec.epilog.iter.check ], [ %5, %middle.block.a ]
  br label %.lr.ph257
...
begin_hunk_4_@a2d_ASN1_OBJECT:bb.a
  ...
  br i1 %i.cf, label %.lr.ph257, label %._crit_edge258.loopexit, !llvm.loop !28

._crit_edge258.loopexit:                          ; preds = %.lr.ph257, %middle.block.a, %middle.block
  %indvars.iv.next313.lcssa = phi i64 [ %5, %middle.block.a ], [ %i.br, %middle.block ], [ %indvars.iv.next313, %.lr.ph257 ]
...
bb.c:                                             ; preds = %bb.b
  %i.i = load i64, ptr %i.b, align 8, !tbaa !29
...
bb.e:                                             ; preds = %bb.c
  ...
  store i32 0, ptr %i.l, align 8, !tbaa !32
...
bb.h:                                             ; preds = %bb.g
  %i.q = load ptr, ptr %0, align 8, !tbaa !33     ; 8 uses
...
bb.j:                                             ; preds = %bb.i
  %i.v = load ptr, ptr %i.q, align 8, !tbaa !35
  ...
  %.pre.i = load i32, ptr %i.s, align 8, !tbaa !32
  br label %bb.k
...
begin_hunk_8_@ossl_c2i_ASN1_OBJECT:bb.a
  ...
  %.pre14.i = load i32, ptr %i.s, align 8, !tbaa !32
  br label %bb.m
...
ASN1_OBJECT_free.exit:                            ; preds = %bb.h, %bb.m, %bb.n
  store ptr %i.p, ptr %0, align 8, !tbaa !33
  br label %bb.o
...
bb.r:                                             ; preds = %._crit_edge
  %i.am = load ptr, ptr %0, align 8, !tbaa !33    ; 3 uses
...
ASN1_OBJECT_new.exit:                             ; preds = %bb.t
  ...
  store i32 1, ptr %i.at, align 8, !tbaa !32
  br label %bb.u
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.bf = load i32, ptr %i.be, align 8, !tbaa !32
  %i.bg = or i32 %i.bf, 8
  store i32 %i.bg, ptr %i.be, align 8, !tbaa !32
  br label %bb.y
...
bb.z:                                             ; preds = %bb.y
  %i.bk = load ptr, ptr %.072, align 8, !tbaa !35
  ...
  %i.bn = load i32, ptr %i.bh, align 8, !tbaa !32
  %i.bo = and i32 %i.bn, -5
  store i32 %i.bo, ptr %i.bh, align 8, !tbaa !32
  br label %bb.aa
...
bb.ab:                                            ; preds = %bb.aa
  store ptr %.072, ptr %0, align 8, !tbaa !33
  br label %bb.ac
...
bb.c:                                             ; preds = %bb.b
  ...
  %.pre = load i32, ptr %i.b, align 8, !tbaa !32
  br label %bb.d
...
begin_hunk_16_@ASN1_OBJECT_free:bb.a
  ...
  %.pre14 = load i32, ptr %i.b, align 8, !tbaa !32
  br label %bb.f
...
bb.a:
  ...
  store i32 13, ptr %i.e, align 8, !tbaa !32
...
!32 = !{!10, !6, i64 32}
!33 = !{!34, !34, i64 0}
!34 = !{!"p1 _ZTS14asn1_object_st", !12, i64 0}
!35 = !{!10, !11, i64 0}
!36 = !{!10, !11, i64 8}
