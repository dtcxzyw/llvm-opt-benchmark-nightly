...
bb.a:
  ...
  %2 = alloca %struct.mbedtls_sha512_context, align 8 ; 18 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #12
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #12
  %.not = icmp eq i32 %1, 0                       ; 2 uses
  %i.b = select i1 %.not, ptr @sha512_test_sum, ptr @sha384_test_sum
  %i.c = tail call noalias dereferenceable_or_null(1024) ptr @calloc(i64 noundef 1024, i64 noundef 1) #13 ; 6 uses
...
bb.d:                                             ; preds = %bb.a
  ...
  %.not41 = icmp eq i32 %0, 0                     ; 3 uses
  %i.e = shl nuw nsw i32 %1, 7
  %i.f = sub nuw nsw i32 512, %i.e
  ...
  %i.m = getelementptr inbounds nuw i8, ptr %2, i64 80 ; 4 uses
...
.backedge:                                        ; preds = %.backedge.backedge, %bb.d
  %indvars.iv = phi i64 [ 0, %bb.d ], [ %indvars.iv.be, %.backedge.backedge ] ; 7 uses
  br i1 %.not41, label %bb.f, label %bb.e

bb.e:                                             ; preds = %.backedge
  %3 = trunc i64 %indvars.iv to i32
  %4 = add i32 %3, 1
  %i.q = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.1, i32 noundef %i.f, i32 noundef %4) ; 0 uses
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %.backedge
...
begin_hunk_3_@mbedtls_sha512_common_self_test:bb.a
  ...
  %i.v = icmp eq i64 %indvars.iv, 2
  br i1 %i.v, label %bb.i, label %.thread62.i55

bb.i:                                             ; preds = %bb.h
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1000) %i.c, i8 97, i64 1000, i1 false)
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %mbedtls_sha512_update.exit
...
bb.k:                                             ; preds = %bb.j
  %i.ad = load i64, ptr %i.l, align 8, !tbaa !10
  %i.ae = add i64 %i.ad, 1
  store i64 %i.ae, ptr %i.l, align 8, !tbaa !10
  br label %bb.l
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ag = getelementptr inbounds nuw i8, ptr %i.m, i64 %i.af
  ...
  %i.ah = call i32 @mbedtls_internal_sha512_process(ptr noundef nonnull %2, ptr noundef nonnull %i.m) ; 0 uses
...
.thread62.i:                                      ; preds = %bb.o
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.m, ptr align 1 %i.aq, i64 %i.ao, i1 false)
...
.thread62.i55:                                    ; preds = %bb.h
  %5 = getelementptr inbounds nuw [113 x i8], ptr @sha_test_buf, i64 %indvars.iv
  %6 = getelementptr inbounds nuw [8 x i8], ptr @sha_test_buflen, i64 %indvars.iv
  %7 = load i64, ptr %6, align 8, !tbaa !10       ; 2 uses
  store i64 %7, ptr %2, align 8, !tbaa !10
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.m, ptr nonnull align 1 %5, i64 %7, i1 false)
  br label %mbedtls_sha512_update.exit60

mbedtls_sha512_update.exit60:                     ; preds = %mbedtls_sha512_update.exit, %.thread62.i55
  %i.as = call i32 @mbedtls_sha512_finish(ptr noundef nonnull %2, ptr noundef nonnull %i.a) ; 0 uses
  %8 = getelementptr inbounds nuw [64 x i8], ptr %i.b, i64 %indvars.iv
  %bcmp = call i32 @bcmp(ptr noundef nonnull dereferenceable(1) %i.a, ptr noundef nonnull dereferenceable(1) %8, i64 %i.p)
  %.not45.a = icmp eq i32 %bcmp, 0
  br i1 %.not45.a, label %9, label %bb.q

9:                                                ; preds = %mbedtls_sha512_update.exit60
  br i1 %.not41, label %bb.p, label %.thread

bb.p:                                             ; preds = %9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond64.not = icmp eq i64 %indvars.iv.next, 3
  br i1 %exitcond64.not, label %.loopexit, label %.backedge.backedge

.backedge.backedge:                               ; preds = %bb.p, %.thread
  %indvars.iv.be = phi i64 [ %indvars.iv.next, %bb.p ], [ %indvars.iv.next68, %.thread ]
...
.thread:                                          ; preds = %9
  ...
  %exitcond64.not69 = icmp eq i64 %indvars.iv.next68, 3
  br i1 %exitcond64.not69, label %10, label %.backedge.backedge

10:                                               ; preds = %.thread
  %putchar = call i32 @putchar(i32 10)            ; 0 uses
  br label %.loopexit

bb.q:                                             ; preds = %mbedtls_sha512_update.exit60
...
.loopexit:                                        ; preds = %bb.p, %bb.q, %bb.r, %10
  %.4 = phi i32 [ 1, %bb.r ], [ 1, %bb.q ], [ 0, %10 ], [ 0, %bb.p ]
  call void @mbedtls_platform_zeroize(ptr noundef nonnull %2, i64 noundef 216) #12
  call void @free(ptr noundef %i.c) #12
  br label %bb.s
end_hunk_7
begin_hunk_8_@puts
!19 = !{!18, !11, i64 8}
