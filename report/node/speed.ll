...
bb.xz:                                            ; preds = %bb.xx, %bb.xy
  %i.dox = getelementptr inbounds nuw [24 x i8], ptr @speed_main.ec_curves, i64 %indvars.iv3871
  %i.doy = getelementptr inbounds nuw i8, ptr %i.dox, i64 12
  %i.doz = load i32, ptr %i.doy, align 4, !tbaa !131
  %i.dpa = getelementptr inbounds nuw [16 x i8], ptr @ecdsa_results, i64 %indvars.iv3871 ; 2 uses
  ...
  %i.dpe = trunc nuw nsw i64 %indvars.iv3871 to i32
...
bb.ya:                                            ; preds = %bb.xx, %bb.xy
  %i.dpg = getelementptr inbounds nuw [24 x i8], ptr @speed_main.ec_curves, i64 %indvars.iv3871 ; 2 uses
  ...
  %i.dpk = getelementptr inbounds nuw [16 x i8], ptr @ecdsa_results, i64 %indvars.iv3871 ; 2 uses
...
bb.yb:                                            ; preds = %bb.xz, %bb.ya, %bb.xv
  %indvars.iv.next3872 = add nuw nsw i64 %indvars.iv3871, 1 ; 2 uses
  %exitcond3874.not = icmp eq i64 %indvars.iv.next3872, 22
  br i1 %exitcond3874.not, label %bb.yc, label %bb.xv, !llvm.loop !163
...
bb.yd:                                            ; preds = %bb.yc, %bb.yj
  %indvars.iv3875 = phi i64 [ 0, %bb.yc ], [ %indvars.iv.next3876, %bb.yj ] ; 7 uses
  %i.dpr = getelementptr inbounds nuw i8, ptr %i.n, i64 %indvars.iv3875
...
bb.yh:                                            ; preds = %bb.yf, %bb.yg
  %i.dpw = getelementptr inbounds nuw [24 x i8], ptr @speed_main.ec_curves, i64 %indvars.iv3875
  %i.dpx = getelementptr inbounds nuw i8, ptr %i.dpw, i64 12
  %i.dpy = load i32, ptr %i.dpx, align 4, !tbaa !131
  %i.dpz = getelementptr inbounds nuw [8 x i8], ptr @ecdh_results, i64 %indvars.iv3875
  %i.dqa = load double, ptr %i.dpz, align 8, !tbaa !91 ; 2 uses
  %i.dqb = fdiv double 1.000000e+00, %i.dqa
  %i.dqc = trunc nuw nsw i64 %indvars.iv3875 to i32
...
bb.yi:                                            ; preds = %bb.yf, %bb.yg
  %i.dqe = getelementptr inbounds nuw [24 x i8], ptr @speed_main.ec_curves, i64 %indvars.iv3875 ; 2 uses
  ...
  %i.dqi = getelementptr inbounds nuw [8 x i8], ptr @ecdh_results, i64 %indvars.iv3875
...
bb.yj:                                            ; preds = %bb.yh, %bb.yi, %bb.yd
  %indvars.iv.next3876 = add nuw nsw i64 %indvars.iv3875, 1 ; 2 uses
  %exitcond3878.not = icmp eq i64 %indvars.iv.next3876, 24
  br i1 %exitcond3878.not, label %bb.yk, label %bb.yd, !llvm.loop !164
...
bb.yv:                                            ; preds = %bb.yu, %bb.yt, %bb.yp
  ...
  br i1 %.not1827, label %bb.za, label %bb.yw

bb.yw:                                            ; preds = %bb.yv
  %.b1598 = load i1, ptr @mr, align 4
  br i1 %.b1598, label %bb.yy, label %bb.yx
...
bb.yx:                                            ; preds = %bb.yw
  ...
  br i1 %.b1609.pr, label %bb.yy, label %bb.yz

bb.yy:                                            ; preds = %bb.yw, %bb.yx
...
bb.za:                                            ; preds = %bb.yy, %bb.yz, %bb.yv
  store i32 1, ptr @testnum, align 4, !tbaa !5
  %i.drs = load i8, ptr %i.k, align 1, !tbaa !26
  %.not1826 = icmp eq i8 %i.drs, 0
  br i1 %.not1826, label %bb.zf, label %bb.zb

bb.zb:                                            ; preds = %bb.za
  %.b1597 = load i1, ptr @mr, align 4
  br i1 %.b1597, label %bb.zd, label %bb.zc
...
bb.zc:                                            ; preds = %bb.zb
  ...
  br i1 %.b1608.pr, label %bb.zd, label %bb.ze

bb.zd:                                            ; preds = %bb.zb, %bb.zc
...
bb.zg:                                            ; preds = %bb.zf
  ...
  br i1 %or.cond72.1, label %bb.zi, label %bb.zh
...
bb.zh:                                            ; preds = %bb.zg
  ...
  br i1 %.b1608.pr.1, label %bb.zk, label %bb.zj

bb.zi:                                            ; preds = %bb.zg
  br i1 %.b1597.1, label %bb.zk, label %bb.zj
...
bb.zm:                                            ; preds = %bb.zl
  ...
  br i1 %or.cond72.2, label %bb.zo, label %bb.zn
...
bb.zn:                                            ; preds = %bb.zm
  ...
  br i1 %.b1608.pr.2, label %bb.zq, label %bb.zp

bb.zo:                                            ; preds = %bb.zm
  br i1 %.b1597.2, label %bb.zq, label %bb.zp
...
bb.zs:                                            ; preds = %bb.zr
  ...
  br i1 %or.cond72.3, label %bb.zu, label %bb.zt
...
bb.zt:                                            ; preds = %bb.zs
  ...
  br i1 %.b1608.pr.3, label %bb.zw, label %bb.zv

bb.zu:                                            ; preds = %bb.zs
  br i1 %.b1597.3, label %bb.zw, label %bb.zv
...
bb.zy:                                            ; preds = %bb.zx
  ...
  br i1 %or.cond72.4, label %bb.aaa, label %bb.zz
...
bb.zz:                                            ; preds = %bb.zy
  ...
  br i1 %.b1608.pr.4, label %bb.aac, label %bb.aab

bb.aaa:                                           ; preds = %bb.zy
  br i1 %.b1597.4, label %bb.aac, label %bb.aab
...
bb.aad:                                           ; preds = %bb.aac, %bb.aab, %bb.zx
  store i32 1, ptr @testnum, align 4, !tbaa !5
  %i.dts = load i64, ptr @kems_algs_len, align 8, !tbaa !29
  %.not3260 = icmp eq i64 %i.dts, 0
  br i1 %.not3260, label %._crit_edge3186, label %.lr.ph3185

.lr.ph3185:                                       ; preds = %bb.aad
  %i.dtt = icmp ne i8 %.51385, 0
  br label %bb.aae

bb.aae:                                           ; preds = %.lr.ph3185, %bb.aak
  %i.dtu = phi i64 [ 0, %.lr.ph3185 ], [ %i.duv, %bb.aak ] ; 4 uses
  %.1214443183 = phi i32 [ 0, %.lr.ph3185 ], [ %i.duu, %bb.aak ] ; 2 uses
  ...
  br i1 %or.cond74, label %bb.aaf, label %bb.aak
...
bb.aaf:                                           ; preds = %bb.aae
  ...
  br i1 %or.cond76, label %bb.aah, label %bb.aag
...
bb.aag:                                           ; preds = %bb.aaf
  ...
  br i1 %.b1607.pr, label %bb.aai, label %bb.aaj

bb.aah:                                           ; preds = %bb.aaf
  br i1 %.b1596, label %bb.aai, label %bb.aaj
