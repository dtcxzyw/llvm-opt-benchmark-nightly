...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec.a = load <4 x i32>, ptr %i.df, align 4
  %strided.vec = shufflevector <4 x i32> %wide.vec.a, <4 x i32> poison, <2 x i32> <i32 0, i32 2>
  %wide.vec1207 = load <4 x i32>, ptr %i.dg, align 4
  %strided.vec1208 = shufflevector <4 x i32> %wide.vec1207, <4 x i32> poison, <2 x i32> <i32 0, i32 2>
  %6 = zext <2 x i32> %strided.vec to <2 x i64>
  %7 = zext <2 x i32> %strided.vec1208 to <2 x i64>
  %i.dh = sub <2 x i64> %vec.phi, %6              ; 2 uses
  %i.di = sub <2 x i64> %vec.phi1205, %7          ; 2 uses
