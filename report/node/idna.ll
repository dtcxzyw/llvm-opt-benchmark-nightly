...
bb.b:                                             ; preds = %bb.o, %bb.a
  ...
  %.0 = phi ptr [ %1, %bb.a ], [ %.1, %bb.o ]     ; 4 uses
...
bb.o:                                             ; preds = %bb.n, %uv__wtf8_decode1.exit.thread20
  ...
  %.pn = phi i64 [ 4, %bb.n ], [ 2, %uv__wtf8_decode1.exit.thread20 ]
  %i.ap = add i64 %.011, %.sink                   ; 2 uses
  %.1 = getelementptr inbounds nuw i8, ptr %.0, i64 %.pn
...
.lr.ph:                                           ; preds = %bb.p, %bb.ac
  ...
  %.190164 = phi ptr [ %.2, %bb.ac ], [ %.089, %bb.p ] ; 12 uses
...
bb.ac:                                            ; preds = %bb.ab, %bb.v, %bb.y, %bb.s
  ...
  %.pn = phi i64 [ 1, %bb.s ], [ 2, %bb.v ], [ 3, %bb.y ], [ 4, %bb.ab ]
  %.1 = phi ptr [ %.088165, %bb.s ], [ %.088165, %bb.v ], [ %.088165, %bb.y ], [ %i.aj, %bb.ab ]
  %.2 = getelementptr inbounds nuw i8, ptr %.190164, i64 %.pn ; 4 uses
