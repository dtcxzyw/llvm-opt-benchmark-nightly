...
define range(i32 -141, 1) i32 @psa_allocate_buffer_to_slot(ptr noundef captures(none) %0, i64 noundef %1) local_unnamed_addr #3 {
bb.a:
...
define range(i32 -141, 1) i32 @psa_copy_key_material_into_slot(ptr noundef captures(none) %0, ptr noundef readonly captures(none) %1, i64 noundef %2) local_unnamed_addr #5 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 2 uses
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !18
...
; Function Attrs: nounwind uwtable
define noundef i32 @psa_remove_key_data_from_memory(ptr noundef captures(none) %0) local_unnamed_addr #6 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 2 uses
...
; Function Attrs: nounwind uwtable
define i32 @psa_aead_verify(ptr noundef %0, ptr noundef writeonly captures(address) %1, i64 noundef %2, ptr noundef %3, ptr noundef readonly captures(none) %4, i64 noundef %5) local_unnamed_addr #6 {
bb.a:
...
define range(i32 -137, 1) i32 @psa_key_derivation_get_capacity(ptr noundef readonly captures(none) %0, ptr noundef writeonly captures(none) %1) local_unnamed_addr #9 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
define range(i32 -137, 1) i32 @psa_key_derivation_set_capacity(ptr noundef captures(none) %0, i64 noundef %1) local_unnamed_addr #9 {
bb.a:
  %i.a = load i32, ptr %0, align 8, !tbaa !75
  %i.b = icmp eq i32 %i.a, 0
...
bb.m:                                             ; preds = %bb.l
  ...
  %switch.gep = getelementptr inbounds nuw i8, ptr @switch.table.psa_key_derivation_input_internal.32, i64 %i.au
  br label %bb.n
...
; Function Attrs: nounwind uwtable
define i32 @psa_key_derivation_output_key_ext(ptr noundef readonly captures(none) %0, ptr noundef %1, ptr noundef readonly captures(none) %2, i64 noundef %3, ptr noundef writeonly captures(none) initializes((0, 4)) %4) local_unnamed_addr #6 {
bb.a:
...
; Function Attrs: nounwind uwtable
define i32 @psa_key_derivation_output_key(ptr noundef readonly captures(none) %0, ptr noundef %1, ptr noundef writeonly captures(none) initializes((0, 4)) %2) local_unnamed_addr #6 {
bb.a:
...
; Function Attrs: nounwind uwtable
define i32 @psa_key_derivation_setup(ptr noundef captures(none) %0, i32 noundef %1) local_unnamed_addr #6 {
bb.a:
  %i.a = load i32, ptr %0, align 8, !tbaa !75
...
switch.lookup:                                    ; preds = %bb.d
  ...
  %switch.gep = getelementptr inbounds nuw [8 x i8], ptr @switch.table.psa_key_derivation_setup_kdf, i64 %i.i
...
bb.h:                                             ; preds = %bb.g
  %i.n = mul nuw nsw i64 %switch.load, 255
...
bb.i:                                             ; preds = %bb.g
  ...
  store i64 %switch.load, ptr %i.p, align 8, !tbaa !77
  br label %psa_key_derivation_set_maximum_capacity.exit

bb.j:                                             ; preds = %bb.g
  %i.q = mul nuw nsw i64 %switch.load, 255
...
; Function Attrs: nounwind uwtable
define i32 @psa_key_derivation_input_bytes(ptr noundef %0, i16 noundef zeroext %1, ptr noundef readonly captures(none) %2, i64 noundef %3) local_unnamed_addr #6 {
bb.a:
  %i.a = icmp eq i64 %3, 0
...
switch.lookup:                                    ; preds = %bb.j
  ...
  %switch.gep = getelementptr inbounds nuw i8, ptr @switch.table.psa_key_derivation_input_internal.32, i64 %i.w
  %switch.load = load i8, ptr %switch.gep, align 1
  br label %bb.k
...
switch.lookup71:                                  ; preds = %bb.o
  ...
  %switch.gep72 = getelementptr inbounds nuw [8 x i8], ptr @switch.table.psa_key_derivation_input_internal.31, i64 %i.ak
  %switch.load73 = load i64, ptr %switch.gep72, align 8
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %switch.lookup71
  %i.al = phi i64 [ %switch.load73, %switch.lookup71 ], [ 0, %bb.o ]
...
switch.lookup75:                                  ; preds = %bb.s
  ...
  %switch.gep76 = getelementptr inbounds nuw i8, ptr @switch.table.psa_key_derivation_input_internal.32, i64 %i.aw
...
; Function Attrs: nounwind uwtable
define i32 @psa_generate_key_ext(ptr noundef %0, ptr noundef %1, i64 noundef %2, ptr noundef writeonly captures(none) initializes((0, 4)) %3) local_unnamed_addr #6 {
bb.a:
...
; Function Attrs: nounwind uwtable
define i32 @psa_generate_key(ptr noundef %0, ptr noundef writeonly captures(none) initializes((0, 4)) %1) local_unnamed_addr #6 {
bb.a:
