...
begin_hunk_0_@gid_cb:bb.a
  ...
  %i.an = load i64, ptr %i.am, align 8, !tbaa !162 ; 2 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 3 uses
  %i.ap = load i64, ptr %i.ao, align 8, !tbaa !153
...
bb.o:                                             ; preds = %.critedge.thread
  ...
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !157
  %i.at = shl i64 %i.an, 1
...
bb.p:                                             ; preds = %bb.o
  %i.aw = load i64, ptr %i.ao, align 8, !tbaa !153
  %i.ax = add i64 %i.aw, 32
  store i64 %i.ax, ptr %i.ao, align 8, !tbaa !153
  store ptr %i.av, ptr %i.ar, align 8, !tbaa !157
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %.critedge.thread
  %i.ay = getelementptr inbounds nuw i8, ptr %2, i64 64 ; 5 uses
  %i.az = load i64, ptr %i.ay, align 8, !tbaa !161 ; 2 uses
  %i.ba = getelementptr inbounds nuw i8, ptr %2, i64 56 ; 3 uses
  %i.bb = load i64, ptr %i.ba, align 8, !tbaa !155
...
bb.s:                                             ; preds = %bb.r
  %i.bi = load i64, ptr %i.ba, align 8, !tbaa !155
  %i.bj = add i64 %i.bi, 32
  store i64 %i.bj, ptr %i.ba, align 8, !tbaa !155
  store ptr %i.bh, ptr %i.bd, align 8, !tbaa !159
  br label %bb.t
...
bb.u:                                             ; preds = %bb.t
  ...
  store i8 0, ptr %i.bm, align 1, !tbaa !137
  %i.bn = load ptr, ptr %2, align 8, !tbaa !156   ; 2 uses
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bn, i64 1656 ; 2 uses
  %i.bp = load i64, ptr %i.bo, align 8, !tbaa !113
...
bb.v:                                             ; preds = %bb.x, %.lr.ph.i
  ...
  %i.br = load ptr, ptr %i.bq, align 8, !tbaa !114
...
bb.w:                                             ; preds = %bb.v
  %i.bw = load ptr, ptr %i.bq, align 8, !tbaa !114
  %i.bx = getelementptr inbounds nuw [56 x i8], ptr %i.bw, i64 %.013.i
  %i.by = getelementptr inbounds nuw i8, ptr %i.bx, i64 8
  %i.bz = load ptr, ptr %i.by, align 8, !tbaa !234
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.cd = load i64, ptr %i.bo, align 8, !tbaa !113
  %i.ce = icmp ult i64 %i.cc, %i.cd
  br i1 %i.ce, label %bb.v, label %.preheader239.preheader, !llvm.loop !332

tls1_group_name2id.exit:                          ; preds = %bb.v, %bb.w
  %i.cf = load ptr, ptr %i.bq, align 8, !tbaa !114
  %i.cg = getelementptr inbounds nuw [56 x i8], ptr %i.cf, i64 %.013.i
  %i.ch = getelementptr inbounds nuw i8, ptr %i.cg, i64 28
  %i.ci = load i16, ptr %i.ch, align 4, !tbaa !116 ; 2 uses
...
.loopexit:                                        ; preds = %.preheader239.preheader, %.preheader239.1, %.preheader239.2, %.preheader239.3, %.preheader239.4, %.preheader239.5, %.preheader239.6
  ...
  %i.cz = load i16, ptr %i.cy, align 8, !tbaa !342 ; 2 uses
...
bb.y:                                             ; preds = %.loopexit, %tls1_group_name2id.exit
  ...
  %i.db = load ptr, ptr %2, align 8, !tbaa !156   ; 2 uses
  %i.dc = getelementptr inbounds nuw i8, ptr %i.db, i64 1656
  %i.dd = load i64, ptr %i.dc, align 8, !tbaa !113 ; 2 uses
...
bb.z:                                             ; preds = %bb.aa
  ...
  br i1 %exitcond.not, label %.critedge228, label %bb.aa, !llvm.loop !333
...
.lr.ph292:                                        ; preds = %.preheader236
  ...
  %i.dn = load ptr, ptr %i.dm, align 8, !tbaa !157 ; 3 uses
  br label %bb.ac

.preheader:                                       ; preds = %bb.ab
  %.phi.trans.insert356 = getelementptr inbounds nuw i8, ptr %2, i64 24
  %.pre357 = load ptr, ptr %.phi.trans.insert356, align 8, !tbaa !157 ; 2 uses
...
bb.ac:                                            ; preds = %.lr.ph292, %bb.ad
  ...
  %i.dp = load i16, ptr %i.do, align 2, !tbaa !150
...
.lr.ph294.preheader:                              ; preds = %.preheader235
  ...
  call void @llvm.memmove.p0.p0.i64(ptr align 2 %scevgep, ptr align 2 %scevgep348, i64 %i.dy, i1 false), !tbaa !150
  br label %._crit_edge

bb.ad:                                            ; preds = %bb.ac
  %i.dz = add nuw i64 %.2184291, 1                ; 2 uses
  %exitcond345.not = icmp eq i64 %i.dz, %i.dl
  br i1 %exitcond345.not, label %.critedge228, label %bb.ac, !llvm.loop !334

._crit_edge:                                      ; preds = %.lr.ph294.preheader, %.preheader235
  store i64 %i.dr, ptr %i.am, align 8, !tbaa !162
  %i.ea = getelementptr inbounds nuw i8, ptr %2, i64 40
  %i.eb = load i64, ptr %i.ea, align 8, !tbaa !160 ; 3 uses
  %.not314 = icmp eq i64 %i.eb, 0
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %2, i64 48
  %.pre = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !158 ; 3 uses
...
.lr.ph300:                                        ; preds = %._crit_edge, %bb.af
  ...
  %i.ed = load i64, ptr %i.ec, align 8, !tbaa !129 ; 2 uses
...
bb.ae:                                            ; preds = %.lr.ph300
  ...
  %i.eh = add i64 %i.ed, -1
  store i64 %i.eh, ptr %i.eg, align 8, !tbaa !129
  br label %bb.ag

bb.af:                                            ; preds = %.lr.ph300
  %i.ei = add nuw i64 %.2181297, 1                ; 2 uses
  %exitcond349.not = icmp eq i64 %i.ei, %i.eb
  br i1 %exitcond349.not, label %.critedge230, label %.lr.ph300, !llvm.loop !335

.critedge230:                                     ; preds = %bb.af, %._crit_edge
  %i.ej = getelementptr inbounds nuw [8 x i8], ptr %.pre, i64 %i.eb ; 2 uses
  %i.ek = load i64, ptr %i.ej, align 8, !tbaa !129
  %i.el = add i64 %i.ek, -1
  store i64 %i.el, ptr %i.ej, align 8, !tbaa !129
  br label %bb.ag

bb.ag:                                            ; preds = %bb.ae, %.critedge230
  %i.em = load i64, ptr %i.ay, align 8, !tbaa !161 ; 4 uses
...
.lr.ph305:                                        ; preds = %bb.ag
  ...
  %i.eo = load ptr, ptr %i.en, align 8, !tbaa !159 ; 3 uses
  br label %bb.ah
...
bb.ah:                                            ; preds = %.lr.ph305, %bb.ai
  ...
  %i.eq = load i16, ptr %i.ep, align 2, !tbaa !150
...
.lr.ph307.preheader:                              ; preds = %.preheader233
  ...
  call void @llvm.memmove.p0.p0.i64(ptr align 2 %scevgep353, ptr align 2 %scevgep354, i64 %i.ez, i1 false), !tbaa !150
  br label %._crit_edge308

bb.ai:                                            ; preds = %bb.ah
  %i.fa = add nuw i64 %.3185303, 1                ; 2 uses
  %exitcond350.not = icmp eq i64 %i.fa, %i.em
  br i1 %exitcond350.not, label %.critedge228, label %bb.ah, !llvm.loop !336

._crit_edge308:                                   ; preds = %.lr.ph307.preheader, %.preheader233
  store i64 %i.es, ptr %i.ay, align 8, !tbaa !161
  br label %.critedge228

bb.aj:                                            ; preds = %.lr.ph311
  %i.fb = add nuw i64 %.4310, 1                   ; 2 uses
  %exitcond355.not = icmp eq i64 %i.fb, %i.dl
  br i1 %exitcond355.not, label %._crit_edge312, label %.lr.ph311, !llvm.loop !337
...
bb.ak:                                            ; preds = %._crit_edge312
  ...
  %i.fp = load ptr, ptr %i.fo, align 8, !tbaa !159
  %i.fq = load i64, ptr %i.ay, align 8, !tbaa !161 ; 2 uses
  %i.fr = add i64 %i.fq, 1
  store i64 %i.fr, ptr %i.ay, align 8, !tbaa !161
  %i.fs = getelementptr inbounds nuw [2 x i8], ptr %i.fp, i64 %i.fq
  store i16 %.1176, ptr %i.fs, align 2, !tbaa !150
  br label %.critedge228
...
bb.b:                                             ; preds = %bb.a
  store i32 6, ptr %0, align 4, !tbaa !131
  br label %bb.l
...
bb.e:                                             ; preds = %bb.d, %bb.c
  store i32 912, ptr %0, align 4, !tbaa !131
  br label %bb.l
...
bb.g:                                             ; preds = %bb.f
  store i32 116, ptr %0, align 4, !tbaa !131
  br label %bb.l
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.f = load ptr, ptr %i.d, align 8, !tbaa !98
...
.preheader:                                       ; preds = %bb.e
  ...
  %i.o = load i64, ptr %i.n, align 8, !tbaa !344  ; 2 uses
