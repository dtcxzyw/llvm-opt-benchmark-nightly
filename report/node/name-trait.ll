...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6substrEmm.exit: ; preds = %._crit_edge.i.i.i, %bb.p, %bb.q
  ...
  %3 = load i64, ptr %i.ah, align 8
  %4 = add i64 %3, 1
  %i.am = load ptr, ptr %2, align 8
  %i.an = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull %i.al, i64 noundef %4, ptr noundef nonnull @.str.1, ptr noundef %i.am) #9 ; 0 uses
