...
bb.i:                                             ; preds = %bb.h
  ...
  %i.am = fcmp oeq double %i.al, %i.ak
...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %_ZN6icu_786number4impl6DecNumD2Ev.exit.us
  ...
  %i.bs = call double @llvm.trunc.f64(double %.06983.us)
  %i.bt = fcmp oeq double %i.bs, %.06983.us
...
bb.h:                                             ; preds = %bb.g
  %2 = call double @llvm.floor.f64(double %i.b)
  %i.ac = fsub double %i.b, %2                    ; 4 uses
...
bb.h:                                             ; preds = %bb.g
  %2 = tail call double @llvm.floor.f64(double %i.a)
  %i.p = fsub double %i.a, %2                     ; 4 uses
