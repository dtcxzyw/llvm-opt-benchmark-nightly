...
bb.b:                                             ; preds = %.lr.ph, %.lr.ph.i.i
  %i.v = phi i32 [ %i.b, %.lr.ph.i.i ], [ %3, %.lr.ph ]
  %indvars.iv.i.i = phi i64 [ %i.n, %.lr.ph.i.i ], [ %indvars.iv.next.i.i, %.lr.ph ] ; 3 uses
...
_ZN2v88internal11interpreter22JumpTableTargetOffsets8iteratorC2EiiiPKNS1_21BytecodeArrayIteratorE.exit: ; preds = %.lr.ph, %bb.a, %._crit_edge
  ret void
}
