...
begin_hunk_2_@_ZNK2v88internal11interpreter22JumpTableTargetOffsets5beginEv:bb.a
  ...
  %4 = and i64 %3, 1
  %5 = icmp eq i64 %4, 0
  br i1 %5, label %bb.d, label %.lr.ph.preheader
...
bb.b:                                             ; preds = %.lr.ph24, %bb.c
  %indvars.iv.next.i.i23 = phi i64 [ %indvars.iv.next.i.i21, %.lr.ph24 ], [ %indvars.iv.next.i.i, %bb.c ] ; 4 uses
  %i.v = phi i32 [ %i.b, %.lr.ph24 ], [ %7, %bb.c ]
  ...
  br i1 %i.z, label %._crit_edge.loopexit, label %bb.c, !llvm.loop !11
...
bb.d:                                             ; preds = %._crit_edge.loopexit, %.lr.ph.i.i
...
.lr.ph._ZN2v88internal11interpreter22JumpTableTargetOffsets8iteratorC2EiiiPKNS1_21BytecodeArrayIteratorE.exit.loopexit_crit_edge: ; preds = %bb.c
...
_ZN2v88internal11interpreter22JumpTableTargetOffsets8iteratorC2EiiiPKNS1_21BytecodeArrayIteratorE.exit: ; preds = %_ZN2v88internal11interpreter22JumpTableTargetOffsets8iteratorC2EiiiPKNS1_21BytecodeArrayIteratorE.exit.loopexit, %bb.a, %bb.d
  ret void
}
