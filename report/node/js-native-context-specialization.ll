...
begin_hunk_0_@_ZN2v88internal8compiler29JSNativeContextSpecialization50BuildElementAccessForTypedArrayOrRabGsabTypedArrayEPNS1_4NodeES4_S4_S4_S4_S4_NS0_12ElementsKindERKNS1_15KeyedAccessModeE:bb.a
  ...
  %99 = alloca %"class.v8::internal::compiler::JSGraphAssembler::IfBuilder1", align 8 ; 15 uses
  %100 = alloca %"class.v8::internal::TNode.273", align 8 ; 4 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 24 ; 10 uses
  %i.d = load ptr, ptr %i.c, align 8
end_hunk_0
begin_hunk_1_@_ZN2v88internal8compiler29JSNativeContextSpecialization50BuildElementAccessForTypedArrayOrRabGsabTypedArrayEPNS1_4NodeES4_S4_S4_S4_S4_NS0_12ElementsKindERKNS1_15KeyedAccessModeE:bb.a
  store i8 0, ptr %i.tr, align 8, !alias.scope !182
  %i.ts = getelementptr inbounds nuw i8, ptr %99, i64 17
  %i.tt = getelementptr inbounds nuw i8, ptr %99, i64 24 ; 3 uses
  %i.tu = ptrtoint ptr %97 to i64                 ; 2 uses
  store i64 %i.tu, ptr %i.tt, align 8
  %.sroa.5.0..sroa_idx310 = getelementptr inbounds nuw i8, ptr %99, i64 32
  store i64 0, ptr %.sroa.5.0..sroa_idx310, align 8
  %101 = getelementptr inbounds nuw i8, ptr %99, i64 40 ; 2 uses
  store ptr @"_ZNSt17_Function_handlerIFN2v88internal5TNodeINS1_7BooleanEEEvEZNS1_8compiler29JSNativeContextSpecialization50BuildElementAccessForTypedArrayOrRabGsabTypedArrayEPNS6_4NodeES9_S9_S9_S9_S9_NS1_12ElementsKindERKNS6_15KeyedAccessModeEE3$_4E10_M_managerERSt9_Any_dataRKSG_St18_Manager_operation", ptr %101, align 8
  %i.tv = getelementptr inbounds nuw i8, ptr %99, i64 48
  store ptr @"_ZNSt17_Function_handlerIFN2v88internal5TNodeINS1_7BooleanEEEvEZNS1_8compiler29JSNativeContextSpecialization50BuildElementAccessForTypedArrayOrRabGsabTypedArrayEPNS6_4NodeES9_S9_S9_S9_S9_NS1_12ElementsKindERKNS6_15KeyedAccessModeEE3$_4E9_M_invokeERKSt9_Any_data", ptr %i.tv, align 8
  %i.tw = getelementptr inbounds nuw i8, ptr %99, i64 56 ; 3 uses
  store i64 %i.tu, ptr %i.tw, align 8
  %.sroa.5312.0..sroa_idx = getelementptr inbounds nuw i8, ptr %99, i64 64
  store i64 0, ptr %.sroa.5312.0..sroa_idx, align 8
...
end_hunk_1
begin_hunk_2_@_ZN2v88internal8compiler29JSNativeContextSpecialization50BuildElementAccessForTypedArrayOrRabGsabTypedArrayEPNS1_4NodeES4_S4_S4_S4_S4_NS0_12ElementsKindERKNS1_15KeyedAccessModeE:bb.a
  br i1 %.not.i.i, label %_ZNSt14_Function_baseD2Ev.exit.i, label %bb.bd

bb.bd:                                            ; preds = %_ZNSt14_Function_baseD2Ev.exit148
  %i.ub = call noundef zeroext i1 %i.ua(ptr noundef nonnull align 8 dereferenceable(32) %i.tw, ptr noundef nonnull align 8 dereferenceable(32) %i.tw, i32 noundef 3) #18, !inline_history !185 ; 0 uses
  br label %_ZNSt14_Function_baseD2Ev.exit.i

_ZNSt14_Function_baseD2Ev.exit.i:                 ; preds = %bb.bd, %_ZNSt14_Function_baseD2Ev.exit148
  %i.uc = load ptr, ptr %101, align 8             ; 2 uses
...
end_hunk_2
begin_hunk_3_@_ZN2v88internal8compiler16JSGraphAssembler10IfBuilder1INS0_7BooleanENS0_7Word32TEE5ValueEv:bb.a
...
end_hunk_3
begin_hunk_4_@_ZN2v88internal8compiler16JSGraphAssembler10IfBuilder1INS0_7BooleanENS0_7Word32TEE5ValueEv:bb.a
bb.b:                                             ; preds = %bb.a
