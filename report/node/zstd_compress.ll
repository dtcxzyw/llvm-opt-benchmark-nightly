...
begin_hunk_0_@ZSTD_compressBegin_internal:bb.a
  ...
  %.sroa.0.sroa.4.0.copyload.i.i = load i32, ptr %.sroa.0.sroa.4.0..sroa_idx.i.i, align 8, !tbaa !5 ; 2 uses
  %.sroa.4.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %5, i64 372
  %.sroa.4.0.copyload.i.i = load i32, ptr %.sroa.4.0..sroa_idx.i.i, align 4, !tbaa !5 ; 2 uses
  ...
  %11 = load i32, ptr %.sroa.6.sroa.4.0..sroa.6.0..sroa_idx.sroa_idx.i.i, align 4, !tbaa !89
...
end_hunk_0
begin_hunk_1_@ZSTD_compressBegin_internal:bb.a
  ...
  %.sroa.043.0.vec.extract46.i.i = extractelement <2 x i32> %.sroa.0.0.copyload.i.i, i64 0
  %spec.store.select40.i.i.i = tail call i32 @llvm.umin.i32(i32 %.sroa.043.0.vec.extract46.i.i, i32 %i.ap)
  br label %.thread.i.i.i

bb.p:                                             ; preds = %ZSTD_shouldAttachDict.exit.thread17.i
  %.not.i.i.i = icmp eq i64 %7, -1
  %.sroa.043.0.vec.extract.i.i = extractelement <2 x i32> %.sroa.0.0.copyload.i.i, i64 0 ; 2 uses
  br i1 %.not.i.i.i, label %bb.q, label %.thread.i.i.i

.thread.i.i.i:                                    ; preds = %bb.p, %bb.o
  %i.aq = phi i32 [ %spec.store.select40.i.i.i, %bb.o ], [ %.sroa.043.0.vec.extract.i.i, %bb.p ] ; 5 uses
  %.sroa.043.4.vec.extract.i.i = extractelement <2 x i32> %.sroa.0.0.copyload.i.i, i64 1
  %i.ar = icmp ugt i32 %i.u, 5
  %.neg.i.i.i.i = sext i1 %i.ar to i32            ; 2 uses
  %i.as = add i32 %.sroa.043.4.vec.extract.i.i, %.neg.i.i.i.i
  %i.at = add i32 %i.aq, 1
...
12:                                               ; preds = %.thread.i.i.i
  ...
  %.sroa.043.4.vec.insert.i.i = insertelement <2 x i32> %.sroa.0.0.copyload.i.i, i32 %13, i64 1
  br label %bb.q

bb.q:                                             ; preds = %12, %.thread.i.i.i, %bb.p
  %.sroa.043.0.i.i = phi <2 x i32> [ %.sroa.043.4.vec.insert.i.i, %12 ], [ %.sroa.0.0.copyload.i.i, %.thread.i.i.i ], [ %.sroa.0.0.copyload.i.i, %bb.p ]
  %.sroa.9.0.i.i = phi i32 [ %spec.store.select41.i.i.i, %12 ], [ %spec.store.select41.i.i.i, %.thread.i.i.i ], [ %.sroa.4.0.i.i, %bb.p ] ; 2 uses
  %14 = phi i32 [ %i.aq, %12 ], [ %i.aq, %.thread.i.i.i ], [ %.sroa.043.0.vec.extract.i.i, %bb.p ]
  %spec.store.select42.i.i.i = tail call i32 @llvm.umax.i32(i32 %14, i32 10)
  %.sroa.043.0.vec.insert.i.i = insertelement <2 x i32> %.sroa.043.0.i.i, i32 %spec.store.select42.i.i.i, i64 0
  %i.av = add i32 %i.u, -6
  %i.aw = icmp ult i32 %i.av, -3
  %i.ax = icmp ugt i32 %i.ai, 1
end_hunk_1
begin_hunk_2_@ZSTD_compressBegin_internal:bb.a
...
end_hunk_2
begin_hunk_3_@ZSTD_compressBegin_internal:bb.a
...
ZSTD_adjustCParams_internal.exit.i.i:             ; preds = %bb.r, %bb.q
  ...
  store <2 x i32> %.sroa.043.0.vec.insert.i.i, ptr %.sroa.6.sroa.4.0..sroa.6.0..sroa_idx.sroa_idx.i.i, align 4
  %.sroa.448.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %10, i64 12
  store i32 %.sroa.9.1.i.i, ptr %.sroa.448.0..sroa_idx.i.i, align 4, !tbaa !5
  %.sroa.5.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %10, i64 16
  store i32 %.sroa.4.0.copyload.i.i, ptr %.sroa.5.0..sroa_idx.i.i, align 8, !tbaa !5
  %.sroa.6.0..sroa_idx49.i.i = getelementptr inbounds nuw i8, ptr %10, i64 20
  store <2 x i32> %.sroa.6.sroa.4.0.copyload.i.i, ptr %.sroa.6.0..sroa_idx49.i.i, align 4
  %.sroa.750.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %10, i64 28
  store i32 %i.u, ptr %.sroa.750.0..sroa_idx.i.i, align 4, !tbaa !5
  store i32 %11, ptr %.sroa.6.sroa.4.0..sroa.6.0..sroa_idx.sroa_idx.i.i, align 4, !tbaa !89
  %i.bb = getelementptr inbounds nuw i8, ptr %5, i64 6072
  %i.bc = load i32, ptr %i.bb, align 8, !tbaa !279
  store i32 %i.bc, ptr %i.ah, align 8, !tbaa !81
end_hunk_3
