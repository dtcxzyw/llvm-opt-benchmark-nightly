...
.preheader130._crit_edge:                         ; preds = %.preheader130, %.preheader130._crit_edge.loopexit
  %.293.lcssa = phi ptr [ %i.bc, %.preheader130._crit_edge.loopexit ], [ %.091, %.preheader130 ] ; 2 uses
...
bb.s:                                             ; preds = %bb.q
  %i.bc = getelementptr inbounds nuw i8, ptr %.293166, i64 2 ; 2 uses
