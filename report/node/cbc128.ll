...
begin_hunk_2_@CRYPTO_cbc128_decrypt:bb.a
  ...
  br i1 %conflict.rdx174, label %scalar.ph.preheader, label %vector.main.loop.iter.check
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %iter.check, label %vec.epilog.iter.check

vec.epilog.iter.check:                            ; preds = %middle.block
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf, 0
  br i1 %min.epilog.iters.check, label %scalar.ph.preheader, label %vec.epilog.ph, !prof !37

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec182 = and i64 %.282144, -4                ; 4 uses
  %7 = add i64 %i.af, %n.vec182                   ; 2 uses
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index183 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next187, %vec.epilog.vector.body ] ; 5 uses
  %8 = getelementptr inbounds nuw i8, ptr %.2146, i64 %index183
  %wide.load184 = load <4 x i8>, ptr %8, align 1, !tbaa !13, !alias.scope !25
  %9 = getelementptr inbounds nuw i8, ptr %6, i64 %index183
  %wide.load185 = load <4 x i8>, ptr %9, align 4, !tbaa !13, !alias.scope !28
  %10 = getelementptr inbounds nuw i8, ptr %4, i64 %index183 ; 2 uses
  %wide.load186 = load <4 x i8>, ptr %10, align 1, !tbaa !13, !alias.scope !30, !noalias !32
  %11 = xor <4 x i8> %wide.load186, %wide.load185
  %12 = getelementptr inbounds nuw i8, ptr %.277145, i64 %index183
  store <4 x i8> %11, ptr %12, align 1, !tbaa !13, !alias.scope !33, !noalias !35
  store <4 x i8> %wide.load184, ptr %10, align 1, !tbaa !13, !alias.scope !30, !noalias !32
  %index.next187 = add nuw i64 %index183, 4       ; 2 uses
  %13 = icmp eq i64 %index.next187, %n.vec182
  br i1 %13, label %middle.block.a, label %vec.epilog.vector.body, !llvm.loop !38

middle.block.a:                                   ; preds = %vec.epilog.vector.body
  %cmp.n.a = icmp eq i64 %.282144, %n.vec182
  %ind.escape.a = add i64 %7, -1
  br i1 %cmp.n.a, label %iter.check, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %vector.memcheck, %.loopexit100.thread, %vec.epilog.iter.check, %middle.block.a
  %indvars.iv.ph = phi i64 [ %i.af, %.loopexit100.thread ], [ %i.af, %vector.memcheck ], [ %i.ag, %vec.epilog.iter.check ], [ %7, %middle.block.a ] ; 3 uses
  %.287118.ph = phi i64 [ 0, %.loopexit100.thread ], [ 0, %vector.memcheck ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec182, %middle.block.a ] ; 7 uses
...
begin_hunk_4_@CRYPTO_cbc128_decrypt:bb.a
  ...
  %i.av = load i8, ptr %i.au, align 4, !tbaa !13
...
iter.check:                                       ; preds = %iter.check.loopexit.unr-lcssa, %scalar.ph.prol.loopexit, %middle.block.a, %middle.block
  %indvars.iv.lcssa = phi i64 [ %ind.escape.a, %middle.block.a ], [ %ind.escape, %middle.block ], [ %indvars.iv.ph, %scalar.ph.prol.loopexit ], [ %indvars.iv.next, %iter.check.loopexit.unr-lcssa ] ; 3 uses
...
begin_hunk_6_@CRYPTO_cbc128_decrypt:bb.a
  ...
  br i1 %i.bj, label %middle.block194, label %vector.body189, !llvm.loop !39
...
vec.epilog.iter.check.a:                          ; preds = %middle.block194
  ...
  br i1 %min.epilog.iters.check.a, label %.lr.ph120.preheader, label %vec.epilog.ph.a, !prof !37
...
begin_hunk_8_@CRYPTO_cbc128_decrypt:bb.a
  ...
  br i1 %i.bo, label %vec.epilog.middle.block, label %vec.epilog.vector.body.a, !llvm.loop !40
...
begin_hunk_10_@CRYPTO_cbc128_decrypt:bb.a
  ...
  br i1 %exitcond.not.1, label %iter.check.loopexit.unr-lcssa, label %scalar.ph, !llvm.loop !42
