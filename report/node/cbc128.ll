...
vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n188 = icmp eq i64 %.282144, %n.vec182
  %ind.escape189 = add i64 %i.as, -1
  br i1 %cmp.n188, label %iter.check208, label %vec.epilog.scalar.ph.preheader
...
iter.check208:                                    ; preds = %iter.check208.loopexit.unr-lcssa, %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.middle.block, %middle.block
  %indvars.iv.lcssa = phi i64 [ %ind.escape189, %vec.epilog.middle.block ], [ %ind.escape, %middle.block ], [ %indvars.iv.ph, %vec.epilog.scalar.ph.prol.loopexit ], [ %indvars.iv.next, %iter.check208.loopexit.unr-lcssa ] ; 3 uses
