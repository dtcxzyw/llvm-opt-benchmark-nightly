...
select.unfold:                                    ; preds = %bb.c
  ...
  %.pr = load i8, ptr %i.c, align 8               ; 2 uses
...
.thread:                                          ; preds = %select.unfold
  %3 = tail call noundef i32 @_ZNK6icu_7811Formattable7getTypeEv(ptr noundef nonnull align 8 dereferenceable(112) %i.e) #11 ; 0 uses
  %.pr36.pre = load i8, ptr %i.c, align 8         ; 2 uses
  %.not = icmp eq i8 %.pr36.pre, 3
...
.thread.thread:                                   ; preds = %bb.c, %bb.c, %bb.c, %select.unfold, %.thread
  %4 = phi i8 [ %.pr36.pre, %.thread ], [ %i.d, %bb.c ], [ %i.d, %bb.c ], [ %i.d, %bb.c ], [ %.pr, %select.unfold ]
  switch i8 %4, label %_ZNK6icu_788message211Formattable7getTypeEv.exit23.thread [
    i8 0, label %_ZNK6icu_788message211Formattable7getTypeEv.exit23.thread41
