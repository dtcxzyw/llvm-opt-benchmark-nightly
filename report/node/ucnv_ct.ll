...
begin_hunk_1_@_ZL43UConverter_fromUnicode_CompoundText_OFFSETSP25UConverterFromUnicodeArgsP10UErrorCode:bb.a
  ...
  %.2271 = ptrtoint ptr %.2 to i64                ; 2 uses
...
.lr.ph182.preheader:                              ; preds = %.loopexit154
  %2 = call i64 @llvm.usub.sat.i64(i64 %i.j, i64 %.2271) ; 3 uses
...
.lr.ph182:                                        ; preds = %.lr.ph182.preheader313, %bb.ak
  ...
  %.3181 = phi ptr [ %i.gd, %bb.ak ], [ %.3181.ph, %.lr.ph182.preheader313 ] ; 3 uses
  %exitcond.not = icmp eq i64 %indvars.iv214, %2
  br i1 %exitcond.not, label %.critedge, label %bb.ak
...
.critedge:                                        ; preds = %.lr.ph182
  %i.ge = trunc nuw nsw i64 %2 to i32
