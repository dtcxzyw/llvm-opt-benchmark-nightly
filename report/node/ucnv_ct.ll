...
bb.a:
  ...
  br i1 %i.o, label %.lr.ph131, label %.loopexit100
...
bb.b:                                             ; preds = %.lr.ph131, %.loopexit
  %.075130 = phi ptr [ %i.b, %.lr.ph131 ], [ %.5, %.loopexit ] ; 12 uses
  %.076129 = phi i32 [ %i.n, %.lr.ph131 ], [ %.278, %.loopexit ] ; 4 uses
  %.081128 = phi ptr [ %i.d, %.lr.ph131 ], [ %.283, %.loopexit ] ; 8 uses
  %i.v = load ptr, ptr %i.p, align 8
  %i.w = icmp ult ptr %.081128, %i.v
...
bb.c:                                             ; preds = %bb.b
  ...
  %.080.in.in = select i1 %i.aa, ptr %i.ab, ptr %.075130
...
.lr.ph.preheader.i:                               ; preds = %.loopexit.i, %bb.d
  %indvars.iv44.i = phi i64 [ 0, %bb.d ], [ %indvars.iv.next45.i, %.loopexit.i ] ; 4 uses
  %i.ae = getelementptr inbounds nuw [5 x i8], ptr @_ZL18escSeqCompoundText, i64 %indvars.iv44.i
  br label %.lr.ph.i
...
bb.f:                                             ; preds = %.lr.ph.i
  ...
  %i.al = getelementptr inbounds nuw i8, ptr %.075130, i64 %i.ak ; 2 uses
...
.preheader:                                       ; preds = %_ZL19findStateFromEscSeqPKcS0_PKhiP10UErrorCode.exit, %_ZL19findStateFromEscSeqPKcS0_PKhiP10UErrorCode.exit.thread
  %i.au = icmp ult ptr %.075130, %i.f
  br i1 %i.au, label %.lr.ph136.preheader, label %._crit_edge

.lr.ph136.preheader:                              ; preds = %.preheader
  %.075130244246 = ptrtoint ptr %.075130 to i64   ; 2 uses
  %i.av = sub i64 %i.q, %.075130244246
...
.lr.ph136.prol:                                   ; preds = %.lr.ph136.preheader
  %i.aw = getelementptr inbounds nuw i8, ptr %.075130, i64 1 ; 2 uses
  %i.ax = load i8, ptr %.075130, align 1
...
.lr.ph136.prol.loopexit:                          ; preds = %.lr.ph136.prol, %.lr.ph136.preheader
  %.lcssa.unr = phi ptr [ poison, %.lr.ph136.preheader ], [ %i.aw, %.lr.ph136.prol ]
  %.1135.unr = phi ptr [ %.075130, %.lr.ph136.preheader ], [ %i.aw, %.lr.ph136.prol ]
  %i.bf = add i64 %i.q, -1
  %i.bg = icmp eq i64 %i.bf, %.075130244246
  br i1 %i.bg, label %._crit_edge, label %.lr.ph136

.lr.ph136:                                        ; preds = %.lr.ph136.prol.loopexit, %.lr.ph136
  %.1135 = phi ptr [ %i.bq, %.lr.ph136 ], [ %.1135.unr, %.lr.ph136.prol.loopexit ] ; 3 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %.1135, i64 1
  %i.bi = load i8, ptr %.1135, align 1
  ...
  %i.bq = getelementptr inbounds nuw i8, ptr %.1135, i64 2 ; 3 uses
  ...
  %exitcond165.not.1 = icmp eq ptr %i.bq, %i.f
  br i1 %exitcond165.not.1, label %._crit_edge, label %.lr.ph136, !llvm.loop !8

._crit_edge:                                      ; preds = %.lr.ph136.prol.loopexit, %.lr.ph136, %.preheader
  %.1.lcssa = phi ptr [ %.075130, %.preheader ], [ %.lcssa.unr, %.lr.ph136.prol.loopexit ], [ %i.bq, %.lr.ph136 ]
...
.thread:                                          ; preds = %_ZL19findStateFromEscSeqPKcS0_PKhiP10UErrorCode.exit.thread
  ...
  %spec.select = getelementptr inbounds nuw i8, ptr %.075130, i64 %spec.select.idx
...
bb.j:                                             ; preds = %_ZL19findStateFromEscSeqPKcS0_PKhiP10UErrorCode.exit
  ...
  %i.ce = ashr exact i64 %sext97, 32
  %i.cf = getelementptr inbounds [5 x i8], ptr @_ZL18escSeqCompoundText, i64 %i.ce
  %i.cg = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.cf) #10
  %i.ch = load ptr, ptr %i.g, align 8
  %i.ci = getelementptr inbounds nuw i8, ptr %i.ch, i64 64 ; 2 uses
  %i.cj = load i8, ptr %i.ci, align 8
  %i.ck = sext i8 %i.cj to i64
  %i.cl = sub i64 %i.cg, %i.ck
  %sext = shl i64 %i.cl, 32
  %i.cm = ashr exact i64 %sext, 32
  %i.cn = getelementptr inbounds i8, ptr %.075130, i64 %i.cm
  store i8 0, ptr %i.ci, align 8
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %bb.c
  %.278 = phi i32 [ %i.cd, %bb.j ], [ %.076129, %bb.c ] ; 6 uses
  %.3 = phi ptr [ %i.cn, %bb.j ], [ %.075130, %bb.c ] ; 9 uses
  %.3161 = ptrtoint ptr %.3 to i64                ; 2 uses
  %i.co = icmp eq i32 %.278, 0
  %i.cp = icmp ult ptr %.3, %i.f                  ; 2 uses
  br i1 %i.co, label %.preheader99, label %bb.o

.preheader99:                                     ; preds = %bb.k
  br i1 %i.cp, label %.lr.ph.preheader, label %.loopexit

.lr.ph.preheader:                                 ; preds = %.preheader99
  %scevgep = getelementptr i8, ptr %.3, i64 %i.q
  %i.cq = sub i64 0, %.3161
  %scevgep162 = getelementptr i8, ptr %scevgep, i64 %i.cq
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.m
  %.4123 = phi ptr [ %i.cv, %bb.m ], [ %.3, %.lr.ph.preheader ] ; 4 uses
  %.182122 = phi ptr [ %i.cx, %bb.m ], [ %.081128, %.lr.ph.preheader ] ; 5 uses
  %i.cr = load i8, ptr %.4123, align 1            ; 2 uses
  %i.cs = icmp eq i8 %i.cr, 27
  br i1 %i.cs, label %.loopexit, label %bb.l

bb.l:                                             ; preds = %.lr.ph
  %i.ct = load ptr, ptr %i.p, align 8
  %i.cu = icmp ult ptr %.182122, %i.ct
  br i1 %i.cu, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  %i.cv = getelementptr inbounds nuw i8, ptr %.4123, i64 1 ; 3 uses
  %i.cw = zext i8 %i.cr to i16
  %i.cx = getelementptr inbounds nuw i8, ptr %.182122, i64 2 ; 2 uses
  store i16 %i.cw, ptr %.182122, align 2
  %exitcond.not = icmp eq ptr %i.cv, %scevgep162
...
bb.p:                                             ; preds = %bb.o
  %i.cy = sub i64 %i.q, %.3161                    ; 4 uses
  %i.cz = trunc i64 %i.cy to i32
  %i.da = icmp sgt i32 %i.cz, 1
  br i1 %i.da, label %.lr.ph.preheader.i90, label %_ZL11findNextEscPKcS0_.exit

.lr.ph.preheader.i90:                             ; preds = %bb.p
  %wide.trip.count.i = and i64 %i.cy, 2147483647
  br label %.lr.ph.i91

.lr.ph.i91:                                       ; preds = %bb.q, %.lr.ph.preheader.i90
  %indvars.iv.i92 = phi i64 [ 1, %.lr.ph.preheader.i90 ], [ %indvars.iv.next.i93, %bb.q ] ; 3 uses
  %i.db = getelementptr inbounds nuw i8, ptr %.3, i64 %indvars.iv.i92
  %i.dc = load i8, ptr %i.db, align 1
  %i.dd = icmp eq i8 %i.dc, 27
  br i1 %i.dd, label %_ZL11findNextEscPKcS0_.exit, label %bb.q
...
_ZL11findNextEscPKcS0_.exit:                      ; preds = %.lr.ph.i91, %bb.q, %bb.p
  %.09.i = phi i64 [ %i.cy, %bb.p ], [ %indvars.iv.i92, %.lr.ph.i91 ], [ %i.cy, %bb.q ]
  %sext98 = shl i64 %.09.i, 32
  %i.de = ashr exact i64 %sext98, 32
  %i.df = getelementptr inbounds i8, ptr %.3, i64 %i.de
  store ptr %.3, ptr %i.r, align 8
  store ptr %i.df, ptr %i.s, align 8
  store ptr %.081128, ptr %i.t, align 8
  %i.dg = load ptr, ptr %i.u, align 8
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dg, i64 48 ; 2 uses
  %i.di = load ptr, ptr %i.dh, align 8
  %i.dj = sext i32 %.278 to i64
  ...
  %i.dm = load ptr, ptr %i.u, align 8             ; 3 uses
  %i.dn = getelementptr inbounds nuw i8, ptr %i.dm, i64 48
  store ptr %i.di, ptr %i.dn, align 8
  %i.do = load ptr, ptr %i.r, align 8             ; 3 uses
  %i.dp = load ptr, ptr %i.t, align 8             ; 3 uses
  %i.dq = load i32, ptr %1, align 4               ; 2 uses
  %i.dr = icmp slt i32 %i.dq, 1
  br i1 %i.dr, label %.loopexit, label %bb.r

bb.r:                                             ; preds = %_ZL11findNextEscPKcS0_.exit
  %i.ds = icmp eq i32 %i.dq, 15
  br i1 %i.ds, label %bb.s, label %.loopexit100

bb.s:                                             ; preds = %bb.r
  %i.dt = getelementptr inbounds nuw i8, ptr %i.dm, i64 93 ; 3 uses
  %i.du = load i8, ptr %i.dt, align 1             ; 3 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dm, i64 144
  %i.dz = zext nneg i8 %i.du to i64
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.dx, ptr nonnull align 8 %i.dy, i64 %i.dz, i1 false)
  %.pre = load i8, ptr %i.dt, align 1
  br label %bb.u

bb.u:                                             ; preds = %bb.t, %bb.s
  %i.ea = phi i8 [ %.pre, %bb.t ], [ %i.du, %bb.s ]
  %i.eb = load ptr, ptr %i.g, align 8
  %i.ec = getelementptr inbounds nuw i8, ptr %i.eb, i64 93
...
.loopexit:                                        ; preds = %bb.m, %.lr.ph, %.preheader99, %bb.n, %_ZL11findNextEscPKcS0_.exit, %bb.o
  %.283 = phi ptr [ %i.dp, %_ZL11findNextEscPKcS0_.exit ], [ %.182122, %bb.n ], [ %.081128, %bb.o ], [ %.081128, %.preheader99 ], [ %i.cx, %bb.m ], [ %.182122, %.lr.ph ] ; 2 uses
  %.5 = phi ptr [ %i.do, %_ZL11findNextEscPKcS0_.exit ], [ %.4123, %bb.n ], [ %.3, %bb.o ], [ %.3, %.preheader99 ], [ %i.cv, %bb.m ], [ %.4123, %.lr.ph ] ; 3 uses
  %i.ed = icmp ult ptr %.5, %i.f
  br i1 %i.ed, label %bb.b, label %.loopexit100, !llvm.loop !11

.loopexit100:                                     ; preds = %.loopexit, %bb.a, %bb.r, %bb.u, %bb.v, %.thread, %._crit_edge
  %.384 = phi ptr [ %.081128, %._crit_edge ], [ %.081128, %.thread ], [ %i.dp, %bb.u ], [ %i.dp, %bb.r ], [ %.081128, %bb.v ], [ %i.d, %bb.a ], [ %.283, %.loopexit ]
  %.379 = phi i32 [ %.076129, %._crit_edge ], [ %.076129, %.thread ], [ %.278, %bb.u ], [ %.278, %bb.r ], [ %.076129, %bb.v ], [ %i.n, %bb.a ], [ %.278, %.loopexit ]
  %.6 = phi ptr [ %.1.lcssa, %._crit_edge ], [ %spec.select, %.thread ], [ %i.do, %bb.u ], [ %i.do, %bb.r ], [ %.075130, %bb.v ], [ %i.b, %bb.a ], [ %.5, %.loopexit ]
