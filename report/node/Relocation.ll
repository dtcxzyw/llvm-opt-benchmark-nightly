...
begin_hunk_0_@_ZNK4LIEF5MachO10Relocation5printERSo:bb.a
  ...
  %. = select i1 %i.fg, i32 2, i32 3              ; 3 uses
...
begin_hunk_1_@_ZNK4LIEF5MachO10Relocation5printERSo:bb.a
  ...
  %17 = getelementptr i8, ptr %i.fj, i64 %16
  %i.fs = getelementptr i8, ptr %17, i64 -1
  store i8 %i.fr, ptr %i.fs, align 1
  %i.ft = load i8, ptr %i.fp, align 2, !noalias !13
  %18 = zext nneg i32 %. to i64
  %19 = getelementptr i8, ptr %i.fj, i64 %18
  %i.fu = getelementptr i8, ptr %19, i64 -2
...
bb.e:                                             ; preds = %bb.a
  ...
  %.not26 = icmp eq i32 %i.ad, 0                  ; 2 uses
...
bb.f:                                             ; preds = %_ZN3fmt3v116detail16do_format_base2eIcjEEPT_iS4_T0_ib.exit
  %i.ak = select i1 %.not26, i32 30768, i32 22576 ; 2 uses
  %.not.i7 = icmp eq i64 %.sroa.2.0.extract.shift.i, 0
  %5 = shl nuw nsw i32 %i.ak, 8
...
bb.i:                                             ; preds = %_ZN3fmt3v116detail16do_format_base2eIcjEEPT_iS4_T0_ib.exit14
  ...
  %i.bh = select i1 %.not29, i32 25136, i32 16944 ; 2 uses
  %.not.i15 = icmp eq i64 %.sroa.2.0.extract.shift.i, 0
  %6 = shl nuw nsw i32 %i.bh, 8
...
bb.d:                                             ; preds = %bb.c
  ...
  %.not82 = icmp eq i32 %i.v, 0
  %i.w = select i1 %.not82, i32 30768, i32 22576  ; 2 uses
  %.not.i = icmp eq i32 %2, 0
  %11 = shl nuw nsw i32 %i.w, 8
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.bl = select i1 %.not85, i32 25136, i32 16944 ; 2 uses
  %.not.i53 = icmp eq i32 %2, 0
  %12 = shl nuw nsw i32 %i.bl, 8
...
bb.j:                                             ; preds = %bb.i
  ...
  %.not82 = icmp eq i32 %i.u, 0
  %i.v = select i1 %.not82, i32 30768, i32 22576  ; 2 uses
  %.not.i = icmp eq i32 %2, 0
  %11 = shl nuw nsw i32 %i.v, 8
...
bb.e:                                             ; preds = %bb.a
  ...
  %.not27 = icmp eq i32 %i.ab, 0                  ; 2 uses
...
bb.f:                                             ; preds = %_ZN3fmt3v116detail16do_format_base2eIcmEEPT_iS4_T0_ib.exit
  %i.ah = select i1 %.not27, i32 30768, i32 22576 ; 2 uses
  %.not.i8 = icmp eq i32 %2, 0
  %6 = shl nuw nsw i32 %i.ah, 8
...
bb.i:                                             ; preds = %_ZN3fmt3v116detail16do_format_base2eIcmEEPT_iS4_T0_ib.exit15
  ...
  %i.be = select i1 %.not30, i32 25136, i32 16944 ; 2 uses
  %.not.i16 = icmp eq i32 %2, 0
  %7 = shl nuw nsw i32 %i.be, 8
...
.thread241:                                       ; preds = %bb.n
  %7 = add nsw i32 %i.ar, -3
  %i.kk = add nsw i32 %7, %.0112
