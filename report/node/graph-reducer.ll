...
.lr.ph:                                           ; preds = %.lr.ph.lr.ph, %_ZN2v88internal8compiler21UnparkedScopeIfNeededD2Ev.exit
  %.015.ph73 = phi ptr [ %i.b, %.lr.ph.lr.ph ], [ %i.ck, %_ZN2v88internal8compiler21UnparkedScopeIfNeededD2Ev.exit ]
  %.016.ph72 = phi ptr [ %i.d, %.lr.ph.lr.ph ], [ %i.cj, %_ZN2v88internal8compiler21UnparkedScopeIfNeededD2Ev.exit ]
  %.sroa.043.0.ph71 = phi ptr [ %i.b, %.lr.ph.lr.ph ], [ %.01568, %_ZN2v88internal8compiler21UnparkedScopeIfNeededD2Ev.exit ] ; 2 uses
  br label %bb.b

bb.b:                                             ; preds = %.lr.ph, %bb.af
  %i.p = phi ptr [ %.015.ph73, %.lr.ph ], [ %i.eq, %bb.af ]
  %.01568 = phi ptr [ %.016.ph72, %.lr.ph ], [ %i.er, %bb.af ] ; 7 uses
  %.not18 = icmp eq ptr %.01568, %.sroa.043.0.ph71
...
_ZN2v88internal8compiler21UnparkedScopeIfNeededC2EPNS1_12JSHeapBrokerEb.exit: ; preds = %_ZNSt19_Optional_base_implIN2v88internal13UnparkedScopeESt14_Optional_baseIS2_Lb0ELb0EEE8_M_resetEv.exit.i.i, %bb.j, %bb.g, %bb.h, %bb.i
  ...
  %.sroa.043.0 = phi ptr [ undef, %bb.h ], [ undef, %bb.g ], [ undef, %bb.i ], [ %i.ar, %bb.j ], [ %i.ar, %_ZNSt19_Optional_base_implIN2v88internal13UnparkedScopeESt14_Optional_baseIS2_Lb0ELb0EEE8_M_resetEv.exit.i.i ] ; 2 uses
...
bb.q:                                             ; preds = %_ZN2v88internal12StdoutStreamD1Ev.exit
  %i.cg = getelementptr inbounds nuw i8, ptr %.sroa.043.0, i64 9
...
bb.r:                                             ; preds = %bb.q
  call void @_ZN2v88internal9LocalHeap12ParkSlowPathEv(ptr noundef nonnull align 8 dereferenceable(1944) %.sroa.043.0) #18
...
.critedge:                                        ; preds = %_ZN2v88internal8compiler21UnparkedScopeIfNeededD2Ev.exit, %bb.af, %bb.a
  ...
  %.016.ph.lcssa66 = phi ptr [ %.sroa.043.0.ph71, %bb.af ], [ %i.b, %bb.a ], [ %.01568, %_ZN2v88internal8compiler21UnparkedScopeIfNeededD2Ev.exit ]
