...
bb.d:                                             ; preds = %_ZNK2v820FunctionCallbackInfoINS_5ValueEEixEi.exit
  ...
  %i.aq = load i64, ptr %i.f, align 8             ; 3 uses
  %i.ar = add i64 %i.aq, -1
...
bb.e:                                             ; preds = %bb.d
  ...
  tail call void @_ZN2v88internal6String11WriteToFlatIhEEvNS0_6TaggedIS1_EEPT_jj(i64 %i.aq, ptr noundef nonnull %i.aw, i32 noundef 0, i32 noundef %i.au) #9
...
bb.f:                                             ; preds = %bb.d
  ...
  tail call void @_ZN2v88internal6String11WriteToFlatItEEvNS0_6TaggedIS1_EEPT_jj(i64 %i.aq, ptr noundef nonnull %i.bg, i32 noundef 0, i32 noundef %i.au) #9
