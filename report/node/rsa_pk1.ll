...
bb.c:                                             ; preds = %bb.a
  ...
  %i.h = tail call noalias ptr @CRYPTO_malloc(i64 noundef %i.g, ptr noundef nonnull @.str, i32 noundef 424) #7 ; 6 uses
...
.lr.ph107:                                        ; preds = %._crit_edge
  ...
  %i.cc = call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 %i.cb) #8, !srcloc !15 ; 3 uses
  %i.cd = xor i32 %i.cb, -1
  %i.ce = call i32 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i32 %i.cd) #8, !srcloc !15 ; 3 uses
  ...
  %umin = call i64 @llvm.umin.i64(i64 %i.cj, i64 %i.ck) ; 3 uses
  %i.cl = add nuw nsw i64 %umin, 1                ; 5 uses
...
vector.memcheck:                                  ; preds = %.lr.ph107
  ...
  br i1 %diff.check, label %scalar.ph.preheader, label %vector.main.loop.iter.check
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %n.mod.vf = and i64 %i.cl, 12
  %n.vec = and i64 %i.cl, 4294967280              ; 6 uses
...
begin_hunk_2_@ossl_rsa_padding_check_PKCS1_type_2:bb.a
  ...
  br i1 %i.cy, label %middle.block, label %vector.body, !llvm.loop !32
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %scalar.ph.preheader, label %vec.epilog.ph, !prof !25

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec133 = and i64 %i.cl, 4294967292           ; 5 uses
  %7 = add nsw i64 %n.vec133, %i.cg
  %broadcast.splatinsert134 = insertelement <4 x i32> poison, i32 %i.cc, i64 0
  %broadcast.splat135 = shufflevector <4 x i32> %broadcast.splatinsert134, <4 x i32> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert136 = insertelement <4 x i32> poison, i32 %i.ce, i64 0
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %8 = add i64 %index138, %i.cg                   ; 2 uses
  %9 = getelementptr inbounds i8, ptr %3, i64 %8
  %wide.load139 = load <4 x i8>, ptr %9, align 1, !tbaa !9
  %10 = getelementptr inbounds i8, ptr %i.h, i64 %8
  %wide.load140 = load <4 x i8>, ptr %10, align 1, !tbaa !9
  %11 = zext <4 x i8> %wide.load139 to <4 x i32>
  %12 = zext <4 x i8> %wide.load140 to <4 x i32>
  %13 = and <4 x i32> %broadcast.splat135, %11
  %14 = and <4 x i32> %broadcast.splat137, %12
  %15 = or <4 x i32> %14, %13
  %16 = trunc nuw <4 x i32> %15 to <4 x i8>
  %17 = getelementptr inbounds nuw i8, ptr %1, i64 %index138
  store <4 x i8> %16, ptr %17, align 1, !tbaa !9
  %index.next141 = add nuw i64 %index138, 4       ; 2 uses
  %18 = icmp eq i64 %index.next141, %n.vec133
  br i1 %18, label %middle.block.a, label %vec.epilog.vector.body, !llvm.loop !33

middle.block.a:                                   ; preds = %vec.epilog.vector.body
  %cmp.n.a = icmp eq i64 %i.cl, %n.vec133
  br i1 %cmp.n.a, label %.loopexit.loopexit, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph107, %vec.epilog.iter.check, %middle.block.a
  %indvars.iv117.ph = phi i64 [ %i.cg, %.lr.ph107 ], [ %i.cg, %vector.memcheck ], [ %i.co, %vec.epilog.iter.check ], [ %7, %middle.block.a ]
  %indvars.iv115.ph = phi i64 [ 0, %.lr.ph107 ], [ 0, %vector.memcheck ], [ %n.vec, %vec.epilog.iter.check ], [ %n.vec133, %middle.block.a ]
  br label %scalar.ph
...
begin_hunk_3_@ossl_rsa_padding_check_PKCS1_type_2:bb.a
  ...
  br i1 %i.dm, label %scalar.ph, label %.loopexit.loopexit, !llvm.loop !34
...
.loopexit.loopexit:                               ; preds = %scalar.ph, %middle.block.a, %middle.block
  %indvars.iv.next116.lcssa = phi i64 [ %n.vec133, %middle.block.a ], [ %n.vec, %middle.block ], [ %indvars.iv.next116, %scalar.ph ]
...
begin_hunk_6_@ossl_rsa_padding_check_PKCS1_type_2_TLS:bb.a
  ...
  br i1 %i.ah, label %middle.block, label %vector.body, !llvm.loop !36
...
begin_hunk_7_@ossl_rsa_padding_check_PKCS1_type_2_TLS:bb.a
  ...
  br i1 %i.ar, label %.lr.ph, label %._crit_edge, !llvm.loop !37
...
!33 = distinct !{!33, !11, !23, !24}
!34 = distinct !{!34, !11, !23}
!35 = distinct !{!35, !11}
