...
.critedge31.i:                                    ; preds = %_ZN2v88internal6Object8ToObjectIS1_NS0_12DirectHandleEQsr3stdE16is_convertible_vIT0_IT_ENS3_IS5_EEEEENS4_INS0_10JSReceiverEE9MaybeTypeEPNS0_7IsolateES6_PKc.exit..critedge31.i_crit_edge, %_ZN2v88internal12IsJSReceiverENS0_6TaggedINS0_6ObjectEEE.exit.i
  ...
  %i.s = phi ptr [ %i.q, %_ZN2v88internal6Object8ToObjectIS1_NS0_12DirectHandleEQsr3stdE16is_convertible_vIT0_IT_ENS3_IS5_EEEEENS4_INS0_10JSReceiverEE9MaybeTypeEPNS0_7IsolateES6_PKc.exit..critedge31.i_crit_edge ], [ %1, %_ZN2v88internal12IsJSReceiverENS0_6TaggedINS0_6ObjectEEE.exit.i ] ; 2 uses
  %4 = load atomic volatile i64, ptr %.pre-phi81 monotonic, align 8 ; 2 uses
  %5 = load ptr, ptr %i.a, align 8                ; 2 uses
  %6 = load ptr, ptr %i.c, align 8
  %i.t = icmp eq ptr %5, %6
...
_ZN2v88internal11HandleScope12CreateHandleEPNS0_7IsolateEm.exit: ; preds = %.critedge31.i, %bb.b
  %.0.i6 = phi ptr [ %i.u, %bb.b ], [ %5, %.critedge31.i ] ; 3 uses
  %i.v = ptrtoint ptr %.0.i6 to i64
  %i.w = add i64 %i.v, 8
  %i.x = inttoptr i64 %i.w to ptr
  store ptr %i.x, ptr %i.a, align 8
  store i64 %4, ptr %.0.i6, align 8
  %i.y = add i64 %4, 15
...
_ZN2v88internal7Isolate15object_functionEv.exit:  ; preds = %._crit_edge, %bb.e
  %.0.i.i.i = phi ptr [ %i.au, %bb.e ], [ %3, %._crit_edge ] ; 3 uses
