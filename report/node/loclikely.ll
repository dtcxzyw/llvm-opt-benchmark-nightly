...
define dso_local void @_ZN6icu_7817RegionValidateMapC2Ev(ptr nofree noundef nonnull writeonly align 8 captures(none) dereferenceable(96) initializes((0, 96)) %0) unnamed_addr #5 align 2 {
bb.a:
...
; Function Attrs: mustprogress nounwind uwtable
define dso_local noundef zeroext i1 @_ZNK6icu_7817RegionValidateMap5isSetEPKc(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(96) %0, ptr nofree noundef readonly captures(none) %1) local_unnamed_addr #0 align 2 {
bb.a:
...
; Function Attrs: mustprogress nounwind uwtable
define dso_local noundef range(i32 -5211, 1675) i32 @_ZNK6icu_7817RegionValidateMap5valueEPKc(ptr nofree noundef nonnull readnone align 8 captures(none) dereferenceable(96) %0, ptr nofree noundef readonly captures(none) %1) local_unnamed_addr #0 align 2 {
bb.a:
  %i.a = load i8, ptr %1, align 1
  %i.b = tail call signext i8 @uprv_isASCIILetter_78(i8 noundef signext %i.a) #10
