...
bb.d:                                             ; preds = %bb.c
  ...
  %min.iters.check124 = icmp ult i64 %i.t, 56
  %diff.check122 = icmp ult i64 %i.e, 32
...
vector.body128:                                   ; preds = %vector.body128, %vector.ph125
  ...
  %i.z = shl i64 %index129, 3                     ; 2 uses
  %next.gep130 = getelementptr i8, ptr %i.j, i64 %i.z ; 2 uses
  %next.gep131 = getelementptr i8, ptr %i.r, i64 %i.z ; 2 uses
  %i.aa = getelementptr i8, ptr %next.gep131, i64 16
  %wide.load132 = load <2 x i64>, ptr %next.gep131, align 4
  %wide.load133 = load <2 x i64>, ptr %i.aa, align 4
  %i.ab = getelementptr i8, ptr %next.gep130, i64 16
  store <2 x i64> %wide.load132, ptr %next.gep130, align 4
  store <2 x i64> %wide.load133, ptr %i.ab, align 4
  %index.next134 = add nuw i64 %index129, 4       ; 2 uses
  %i.ac = icmp eq i64 %index.next134, %n.vec127
  br i1 %i.ac, label %middle.block135, label %vector.body128, !llvm.loop !422
...
.lr.ph.i.i.i.i.i.preheader:                       ; preds = %bb.d, %middle.block135
  %.08.i.i.i.i.i.ph = phi ptr [ %i.j, %bb.d ], [ %i.x, %middle.block135 ]
  %.sroa.04.07.i.i.i.i.i.ph = phi ptr [ %i.r, %bb.d ], [ %i.y, %middle.block135 ]
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.preheader204, %.lr.ph.i.i.i.i
  %.08.i.i.i.i = phi ptr [ %i.bl, %.lr.ph.i.i.i.i ], [ %.08.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader204 ] ; 2 uses
  %.sroa.04.07.i.i.i.i = phi ptr [ %i.bk, %.lr.ph.i.i.i.i ], [ %.sroa.04.07.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader204 ] ; 2 uses
