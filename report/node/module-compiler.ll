...
_ZN2v88internal7tracing12ScopedTracerD2Ev.exit193: ; preds = %_ZNSt14_Optional_baseIN2v88internal4wasm14CompilationEnvELb0ELb0EED2Ev.exit, %bb.dz, %bb.ea
...
bb.d:                                             ; preds = %bb.c
  ...
  %min.iters.check124 = icmp ult i64 %i.t, 72
  %i.w = sub i64 %i.d, %i.c
  %diff.check122 = icmp ugt i64 %i.w, -32
...
vector.ph125:                                     ; preds = %bb.d
  %n.vec127 = and i64 %i.v, 4611686018427387900   ; 3 uses
  %i.x = shl i64 %n.vec127, 3                     ; 2 uses
  %i.y = getelementptr i8, ptr %i.j, i64 %i.x
  %i.z = getelementptr i8, ptr %i.r, i64 %i.x
...
vector.body128:                                   ; preds = %vector.body128, %vector.ph125
  ...
  %i.aa = shl i64 %index129, 3                    ; 2 uses
  %next.gep130 = getelementptr i8, ptr %i.j, i64 %i.aa ; 2 uses
  %next.gep131 = getelementptr i8, ptr %i.r, i64 %i.aa ; 2 uses
  %i.ab = getelementptr i8, ptr %next.gep131, i64 16
  %wide.load132 = load <2 x i64>, ptr %next.gep131, align 4
  %wide.load133 = load <2 x i64>, ptr %i.ab, align 4
  %i.ac = getelementptr i8, ptr %next.gep130, i64 16
  store <2 x i64> %wide.load132, ptr %next.gep130, align 4
  store <2 x i64> %wide.load133, ptr %i.ac, align 4
  %index.next134 = add nuw i64 %index129, 4       ; 2 uses
  %i.ad = icmp eq i64 %index.next134, %n.vec127
  br i1 %i.ad, label %middle.block135, label %vector.body128, !llvm.loop !422

middle.block135:                                  ; preds = %vector.body128
  %cmp.n136 = icmp eq i64 %i.v, %n.vec127
...
.lr.ph.i.i.i.i.i.preheader:                       ; preds = %bb.d, %middle.block135
  %.08.i.i.i.i.i.ph = phi ptr [ %i.j, %bb.d ], [ %i.y, %middle.block135 ]
  %.sroa.04.07.i.i.i.i.i.ph = phi ptr [ %i.r, %bb.d ], [ %i.z, %middle.block135 ]
  br label %.lr.ph.i.i.i.i.i

.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader, %.lr.ph.i.i.i.i.i
  %.08.i.i.i.i.i = phi ptr [ %i.ag, %.lr.ph.i.i.i.i.i ], [ %.08.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader ] ; 2 uses
  %.sroa.04.07.i.i.i.i.i = phi ptr [ %i.af, %.lr.ph.i.i.i.i.i ], [ %.sroa.04.07.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader ] ; 2 uses
  %i.ae = load i64, ptr %.sroa.04.07.i.i.i.i.i, align 4
  store i64 %i.ae, ptr %.08.i.i.i.i.i, align 4
  %i.af = getelementptr inbounds nuw i8, ptr %.sroa.04.07.i.i.i.i.i, i64 8 ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.08.i.i.i.i.i, i64 8
  %i.ah = icmp eq ptr %i.af, %i.j
  br i1 %i.ah, label %_ZSt22__uninitialized_move_aIPN2v88internal4wasm19WasmCompilationUnitES4_SaIS3_EET0_T_S7_S6_RT1_.exit, label %.lr.ph.i.i.i.i.i, !llvm.loop !423
...
_ZSt22__uninitialized_move_aIPN2v88internal4wasm19WasmCompilationUnitES4_SaIS3_EET0_T_S7_S6_RT1_.exit: ; preds = %.lr.ph.i.i.i.i.i, %middle.block135
  ...
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 %i.e
  store ptr %i.aj, ptr %i.i, align 8
  %i.ak = ptrtoint ptr %i.r to i64
  %i.al = sub i64 %i.ak, %i.n                     ; 3 uses
  %i.am = ashr exact i64 %i.al, 3                 ; 2 uses
  %i.an = icmp sgt i64 %i.am, 1
  br i1 %i.an, label %bb.e, label %bb.f, !prof !104
...
bb.e:                                             ; preds = %_ZSt22__uninitialized_move_aIPN2v88internal4wasm19WasmCompilationUnitES4_SaIS3_EET0_T_S7_S6_RT1_.exit
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.ap, ptr align 4 %1, i64 %i.al, i1 false)
...
bb.f:                                             ; preds = %_ZSt22__uninitialized_move_aIPN2v88internal4wasm19WasmCompilationUnitES4_SaIS3_EET0_T_S7_S6_RT1_.exit
  %i.aq = icmp eq i64 %i.al, 8
  br i1 %i.aq, label %bb.g, label %_ZSt13move_backwardIPN2v88internal4wasm19WasmCompilationUnitES4_ET0_T_S6_S5_.exit

bb.g:                                             ; preds = %bb.f
  %i.ar = getelementptr inbounds i8, ptr %i.j, i64 -8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(6) %i.ar, ptr noundef nonnull align 4 dereferenceable(6) %1, i64 6, i1 false)
  br label %_ZSt13move_backwardIPN2v88internal4wasm19WasmCompilationUnitES4_ET0_T_S6_S5_.exit

_ZSt13move_backwardIPN2v88internal4wasm19WasmCompilationUnitES4_ET0_T_S6_S5_.exit: ; preds = %bb.e, %bb.f, %bb.g
  %i.as = icmp sgt i64 %i.e, 8
  br i1 %i.as, label %bb.h, label %bb.i, !prof !104
...
bb.i:                                             ; preds = %_ZSt13move_backwardIPN2v88internal4wasm19WasmCompilationUnitES4_ET0_T_S6_S5_.exit
  %i.at = icmp eq i64 %i.e, 8
  br i1 %i.at, label %bb.j, label %_ZSt4copyIN9__gnu_cxx17__normal_iteratorIPN2v88internal4wasm19WasmCompilationUnitESt6vectorIS5_SaIS5_EEEESA_ET0_T_SC_SB_.exit
...
_ZSt9__advanceIN9__gnu_cxx17__normal_iteratorIPN2v88internal4wasm19WasmCompilationUnitESt6vectorIS5_SaIS5_EEEElEvRT_T0_St26random_access_iterator_tag.exit: ; preds = %bb.c
  %i.au = getelementptr inbounds i8, ptr %2, i64 %i.o ; 4 uses
  %i.av = icmp eq ptr %i.au, %3
  br i1 %i.av, label %_ZSt22__uninitialized_copy_aIN9__gnu_cxx17__normal_iteratorIPN2v88internal4wasm19WasmCompilationUnitESt6vectorIS5_SaIS5_EEEES6_S5_ET0_T_SC_SB_RSaIT1_E.exit, label %.lr.ph.i.i.i.i.preheader
...
.lr.ph.i.i.i.i.preheader:                         ; preds = %_ZSt9__advanceIN9__gnu_cxx17__normal_iteratorIPN2v88internal4wasm19WasmCompilationUnitESt6vectorIS5_SaIS5_EEEElEvRT_T0_St26random_access_iterator_tag.exit
  %i.aw = add i64 %i.c, %i.n
  %i.ax = add i64 %i.l, %i.d
  %i.ay = sub i64 %i.aw, %i.ax
  %i.az = add i64 %i.ay, -8                       ; 2 uses
  %i.ba = lshr i64 %i.az, 3
  %i.bb = add nuw nsw i64 %i.ba, 1                ; 2 uses
  %min.iters.check = icmp ult i64 %i.az, 72
  %i.bc = sub i64 %i.d, %i.n
...
vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.preheader
  ...
  %i.be = getelementptr i8, ptr %i.j, i64 %i.bd
  %i.bf = getelementptr i8, ptr %i.au, i64 %i.bd
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.bg = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.j, i64 %i.bg ; 2 uses
  %next.gep100 = getelementptr i8, ptr %i.au, i64 %i.bg ; 2 uses
  %i.bh = getelementptr i8, ptr %next.gep100, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep100, align 4
  %wide.load101 = load <2 x i64>, ptr %i.bh, align 4
  %i.bi = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 4
  store <2 x i64> %wide.load101, ptr %i.bi, align 4
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.bj = icmp eq i64 %index.next, %n.vec
  br i1 %i.bj, label %middle.block, label %vector.body, !llvm.loop !424
...
.lr.ph.i.i.i.i.preheader204:                      ; preds = %.lr.ph.i.i.i.i.preheader, %middle.block
  %.08.i.i.i.i.ph = phi ptr [ %i.j, %.lr.ph.i.i.i.i.preheader ], [ %i.be, %middle.block ]
  %.sroa.04.07.i.i.i.i.ph = phi ptr [ %i.au, %.lr.ph.i.i.i.i.preheader ], [ %i.bf, %middle.block ]
  br label %.lr.ph.i.i.i.i

.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.preheader204, %.lr.ph.i.i.i.i
  %.08.i.i.i.i = phi ptr [ %i.bm, %.lr.ph.i.i.i.i ], [ %.08.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader204 ] ; 2 uses
  %.sroa.04.07.i.i.i.i = phi ptr [ %i.bl, %.lr.ph.i.i.i.i ], [ %.sroa.04.07.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader204 ] ; 2 uses
  %i.bk = load i64, ptr %.sroa.04.07.i.i.i.i, align 4
  store i64 %i.bk, ptr %.08.i.i.i.i, align 4
  %i.bl = getelementptr inbounds nuw i8, ptr %.sroa.04.07.i.i.i.i, i64 8 ; 2 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %.08.i.i.i.i, i64 8
  %i.bn = icmp eq ptr %i.bl, %3
  br i1 %i.bn, label %_ZSt22__uninitialized_copy_aIN9__gnu_cxx17__normal_iteratorIPN2v88internal4wasm19WasmCompilationUnitESt6vectorIS5_SaIS5_EEEES6_S5_ET0_T_SC_SB_RSaIT1_E.exit.loopexit, label %.lr.ph.i.i.i.i, !llvm.loop !425
...
_ZSt22__uninitialized_copy_aIN9__gnu_cxx17__normal_iteratorIPN2v88internal4wasm19WasmCompilationUnitESt6vectorIS5_SaIS5_EEEES6_S5_ET0_T_SC_SB_RSaIT1_E.exit: ; preds = %_ZSt22__uninitialized_copy_aIN9__gnu_cxx17__normal_iteratorIPN2v88internal4wasm19WasmCompilationUnitESt6vectorIS5_SaIS5_EEEES6_S5_ET0_T_SC_SB_RSaIT1_E.exit.loopexit, %_ZSt9__advanceIN9__gnu_cxx17__normal_iteratorIPN2v88internal4wasm19WasmCompilationUnitESt6vectorIS5_SaIS5_EEEElEvRT_T0_St26random_access_iterator_tag.exit
  %i.bo = phi ptr [ %.pre, %_ZSt22__uninitialized_copy_aIN9__gnu_cxx17__normal_iteratorIPN2v88internal4wasm19WasmCompilationUnitESt6vectorIS5_SaIS5_EEEES6_S5_ET0_T_SC_SB_RSaIT1_E.exit.loopexit ], [ %i.j, %_ZSt9__advanceIN9__gnu_cxx17__normal_iteratorIPN2v88internal4wasm19WasmCompilationUnitESt6vectorIS5_SaIS5_EEEElEvRT_T0_St26random_access_iterator_tag.exit ] ; 2 uses
end_hunk_1
