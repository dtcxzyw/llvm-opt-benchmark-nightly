...
.lr.ph69.preheader:                               ; preds = %bb.r
  ...
  br i1 %min.iters.check, label %.lr.ph69.preheader115, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %.lr.ph69.preheader
  ...
  br i1 %found.conflict, label %.lr.ph69.preheader115, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep89, align 4, !alias.scope !50
  %wide.load90 = load <4 x i32>, ptr %i.az, align 4, !alias.scope !50
  %i.ba = trunc <4 x i32> %wide.load to <4 x i16>
  %i.bb = trunc <4 x i32> %wide.load90 to <4 x i16>
  %i.bc = getelementptr i8, ptr %next.gep, i64 8
  store <4 x i16> %i.ba, ptr %next.gep, align 2, !alias.scope !51, !noalias !50
  store <4 x i16> %i.bb, ptr %i.bc, align 2, !alias.scope !51, !noalias !50
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.bd = icmp eq i64 %index.next, %n.vec
  br i1 %i.bd, label %middle.block, label %vector.body, !llvm.loop !42

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %i.al
  br i1 %cmp.n, label %.preheader, label %.lr.ph69.preheader115

.lr.ph69.preheader115:                            ; preds = %vector.memcheck, %.lr.ph69.preheader, %middle.block
...
.lr.ph69.prol:                                    ; preds = %.lr.ph69.preheader115, %.lr.ph69.prol
  %.15768.prol = phi ptr [ %.157.prol, %.lr.ph69.prol ], [ %.15768.ph, %.lr.ph69.preheader115 ] ; 2 uses
  %.067.prol = phi i32 [ %i.bi, %.lr.ph69.prol ], [ %.067.ph, %.lr.ph69.preheader115 ]
  %.05066.prol = phi ptr [ %i.bf, %.lr.ph69.prol ], [ %.05066.ph, %.lr.ph69.preheader115 ] ; 2 uses
  %prol.iter = phi i32 [ %prol.iter.next, %.lr.ph69.prol ], [ 0, %.lr.ph69.preheader115 ]
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph69.prol.loopexit, label %.lr.ph69.prol, !llvm.loop !43

.lr.ph69.prol.loopexit:                           ; preds = %.lr.ph69.prol, %.lr.ph69.preheader115
  %.lcssa.unr = phi ptr [ poison, %.lr.ph69.preheader115 ], [ %i.bf, %.lr.ph69.prol ]
  %.157.lcssa116.unr = phi ptr [ poison, %.lr.ph69.preheader115 ], [ %.157.prol, %.lr.ph69.prol ]
  %.15768.unr = phi ptr [ %.15768.ph, %.lr.ph69.preheader115 ], [ %.157.prol, %.lr.ph69.prol ]
  %.067.unr = phi i32 [ %.067.ph, %.lr.ph69.preheader115 ], [ %i.bi, %.lr.ph69.prol ]
  %.05066.unr = phi ptr [ %.05066.ph, %.lr.ph69.preheader115 ], [ %i.bf, %.lr.ph69.prol ]
...
.preheader:                                       ; preds = %.lr.ph69.prol.loopexit, %.lr.ph69, %middle.block, %bb.r
  ...
  %.157.lcssa = phi ptr [ %.15765, %bb.r ], [ %i.at, %middle.block ], [ %.157.lcssa116.unr, %.lr.ph69.prol.loopexit ], [ %.157.7, %.lr.ph69 ] ; 6 uses
...
.lr.ph76.preheader:                               ; preds = %.preheader
  ...
  br i1 %min.iters.check100, label %.lr.ph76.preheader114, label %vector.memcheck93
...
vector.memcheck93:                                ; preds = %.lr.ph76.preheader
  ...
  br i1 %found.conflict98, label %.lr.ph76.preheader114, label %vector.ph101
...
vector.body103:                                   ; preds = %vector.body103, %vector.ph101
  %index104 = phi i64 [ 0, %vector.ph101 ], [ %index.next108, %vector.body103 ] ; 2 uses
  ...
  %wide.load107 = load <4 x i32>, ptr %next.gep105, align 4, !alias.scope !52 ; 2 uses
  ...
  store <8 x i16> %interleaved.vec, ptr %next.gep106, align 2, !alias.scope !53, !noalias !52
  %index.next108 = add nuw i64 %index104, 4       ; 2 uses
  %i.cf = icmp eq i64 %index.next108, %n.vec102
  br i1 %i.cf, label %middle.block109, label %vector.body103, !llvm.loop !47

middle.block109:                                  ; preds = %vector.body103
  %cmp.n110 = icmp eq i64 %n.vec102, %i.bp
  br i1 %cmp.n110, label %.loopexit, label %.lr.ph76.preheader114

.lr.ph76.preheader114:                            ; preds = %vector.memcheck93, %.lr.ph76.preheader, %middle.block109
  %.175.ph = phi i32 [ %.0.lcssa, %vector.memcheck93 ], [ %.0.lcssa, %.lr.ph76.preheader ], [ %i.by, %middle.block109 ]
  %.15174.ph = phi ptr [ %.050.lcssa, %vector.memcheck93 ], [ %.050.lcssa, %.lr.ph76.preheader ], [ %i.ca, %middle.block109 ]
  %.273.ph = phi ptr [ %.157.lcssa, %vector.memcheck93 ], [ %.157.lcssa, %.lr.ph76.preheader ], [ %i.cb, %middle.block109 ]
  br label %.lr.ph76
...
.lr.ph69:                                         ; preds = %.lr.ph69.prol.loopexit, %.lr.ph69
  ...
  br i1 %exitcond80.not.7, label %.preheader, label %.lr.ph69, !llvm.loop !48

.lr.ph76:                                         ; preds = %.lr.ph76.preheader114, %.lr.ph76
  %.175 = phi i32 [ %i.dn, %.lr.ph76 ], [ %.175.ph, %.lr.ph76.preheader114 ]
  %.15174 = phi ptr [ %i.dj, %.lr.ph76 ], [ %.15174.ph, %.lr.ph76.preheader114 ] ; 3 uses
  %.273 = phi ptr [ %i.dm, %.lr.ph76 ], [ %.273.ph, %.lr.ph76.preheader114 ] ; 3 uses
  ...
  br i1 %i.do, label %.lr.ph76, label %.loopexit, !llvm.loop !49

bb.s:                                             ; preds = %bb.o
  store i32 15, ptr %3, align 4
  br label %.loopexit

.loopexit:                                        ; preds = %.lr.ph76, %middle.block109, %.preheader, %bb.s, %bb.g, %bb.h, %bb.a, %bb.n, %bb.d
  %.055 = phi i32 [ 1, %bb.g ], [ 0, %bb.d ], [ 0, %bb.a ], [ 0, %bb.n ], [ 1, %bb.h ], [ %i.ae, %bb.s ], [ %i.ae, %.preheader ], [ %i.ae, %middle.block109 ], [ %i.ae, %.lr.ph76 ]
  ret i32 %.055
}
