...
begin_hunk_0_@mbedtls_x509_crt_parse:bb.a
  ...
  %.053111 = phi ptr [ %1, %.lr.ph ], [ %.154, %bb.j ] ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %4 = getelementptr inbounds nuw i8, ptr %.053111, i64 %i.l ; 2 uses
...
bb.h:                                             ; preds = %bb.f
  ...
  %5 = getelementptr inbounds nuw i8, ptr %.053111, i64 %i.p
...
bb.j:                                             ; preds = %bb.g, %bb.i, %bb.h
  %.154 = phi ptr [ %5, %bb.h ], [ %4, %bb.i ], [ %4, %bb.g ]
  %.pn = phi i64 [ %i.p, %bb.h ], [ %i.l, %bb.i ], [ %i.l, %bb.g ]
