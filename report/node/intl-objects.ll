inline.NumInlined: 4174
inline.NumDeleted: 1528
begin_hunk_0_@_ZNK2v88internal6String9IsEqualToILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EEPNS0_7IsolateE:bb.a
  %i.d = ptrtoint ptr %0 to i64
  %i.e = or disjoint i64 %i.d, 1
  %.idx.i.i9 = shl nuw nsw i64 %2, 1              ; 2 uses
  %5 = icmp eq i64 %2, 0                          ; 2 uses
  br label %bb.c

bb.c:                                             ; preds = %_ZNK2v88internal11StringShape22DispatchToSpecificTypeIN4absl8OverloadIJZNKS0_6String13IsEqualToImplILNS5_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EERKNS0_31SharedStringAccessGuardIfNeededEEUlNS0_6TaggedINS0_16SeqOneByteStringEEEE_ZNKS6_ILS7_0EcEEbSC_SF_EUlNSG_INS0_16SeqTwoByteStringEEEE_ZNKS6_ILS7_0EcEEbSC_SF_EUlNSG_INS0_21ExternalOneByteStringEEEE_ZNKS6_ILS7_0EcEEbSC_SF_EUlNSG_INS0_21ExternalTwoByteStringEEEE_ZNKS6_ILS7_0EcEEbSC_SF_EUlNSG_INS0_12SlicedStringEEEE_ZNKS6_ILS7_0EcEEbSC_SF_EUlNSG_INS0_10ConsStringEEEE_ZNKS6_ILS7_0EcEEbSC_SF_EUlNSG_INS0_10ThinStringEEEE_EEEEEDaNSG_IS5_EEOT_.exit, %bb.b
end_hunk_0
begin_hunk_1_@_ZNK2v88internal6String9IsEqualToILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EEPNS0_7IsolateE:bb.a
  ...
  br i1 %5, label %_ZNK2v88internal6String13IsEqualToImplILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EERKNS0_31SharedStringAccessGuardIfNeededE.exit, label %.lr.ph.i.i
...
end_hunk_1
begin_hunk_2_@_ZNK2v88internal6String9IsEqualToILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EEPNS0_7IsolateE:bb.a
  ...
  br i1 %5, label %_ZNK2v88internal6String13IsEqualToImplILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EERKNS0_31SharedStringAccessGuardIfNeededE.exit, label %.lr.ph.i.i10
...
end_hunk_2
begin_hunk_3_@_ZNK2v88internal6String9IsEqualToILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EEPNS0_7IsolateE:bb.a
  %i.cb = load i64, ptr %i.ca, align 8
  br label %bb.c

_ZNK2v88internal6String13IsEqualToImplILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EERKNS0_31SharedStringAccessGuardIfNeededE.exit: ; preds = %.lr.ph.i.i10, %.lr.ph.i.i, %bb.e, %_ZNK2v88internal21ExternalTwoByteString8GetCharsEv.exit, %_ZNK2v88internal21ExternalOneByteString8GetCharsEv.exit, %bb.f, %bb.d
...
end_hunk_3
begin_hunk_4_@_ZNK2v88internal6String9IsEqualToILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EEPNS0_12LocalIsolateE:bb.a
  %i.l = ptrtoint ptr %0 to i64
  %i.m = or disjoint i64 %i.l, 1
  %.idx.i.i11 = shl nuw nsw i64 %2, 1             ; 2 uses
  %5 = icmp eq i64 %2, 0                          ; 2 uses
  br label %bb.c

bb.c:                                             ; preds = %_ZNK2v88internal11StringShape22DispatchToSpecificTypeIN4absl8OverloadIJZNKS0_6String13IsEqualToImplILNS5_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EERKNS0_31SharedStringAccessGuardIfNeededEEUlNS0_6TaggedINS0_16SeqOneByteStringEEEE_ZNKS6_ILS7_0EcEEbSC_SF_EUlNSG_INS0_16SeqTwoByteStringEEEE_ZNKS6_ILS7_0EcEEbSC_SF_EUlNSG_INS0_21ExternalOneByteStringEEEE_ZNKS6_ILS7_0EcEEbSC_SF_EUlNSG_INS0_21ExternalTwoByteStringEEEE_ZNKS6_ILS7_0EcEEbSC_SF_EUlNSG_INS0_12SlicedStringEEEE_ZNKS6_ILS7_0EcEEbSC_SF_EUlNSG_INS0_10ConsStringEEEE_ZNKS6_ILS7_0EcEEbSC_SF_EUlNSG_INS0_10ThinStringEEEE_EEEEEDaNSG_IS5_EEOT_.exit, %bb.b
end_hunk_4
begin_hunk_5_@_ZNK2v88internal6String9IsEqualToILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EEPNS0_12LocalIsolateE:bb.a
  %i.z = sext i32 %.0 to i64
  %i.aa = getelementptr inbounds [2 x i8], ptr %i.y, i64 %i.z ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 %.idx.i.i11
  br i1 %5, label %_ZNK2v88internal6String13IsEqualToImplILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EERKNS0_31SharedStringAccessGuardIfNeededE.exit.loopexit, label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %bb.e, %.lr.ph.i.i
  %.01013.i.i = phi ptr [ %i.af, %.lr.ph.i.i ], [ %i.aa, %bb.e ] ; 2 uses
  %.01112.i.i = phi ptr [ %i.ag, %.lr.ph.i.i ], [ %1, %bb.e ] ; 2 uses
  %i.ac = load i16, ptr %.01013.i.i, align 2
end_hunk_5
begin_hunk_6_@_ZNK2v88internal6String9IsEqualToILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EEPNS0_12LocalIsolateE:bb.a
  %i.bv = sext i32 %.0 to i64
  %i.bw = getelementptr inbounds [2 x i8], ptr %.0.i10, i64 %i.bv ; 2 uses
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 %.idx.i.i11
  br i1 %5, label %_ZNK2v88internal6String13IsEqualToImplILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EERKNS0_31SharedStringAccessGuardIfNeededE.exit.loopexit, label %.lr.ph.i.i12

.lr.ph.i.i12:                                     ; preds = %_ZNK2v88internal21ExternalTwoByteString8GetCharsEv.exit, %.lr.ph.i.i12
  %.01013.i.i13 = phi ptr [ %i.cb, %.lr.ph.i.i12 ], [ %i.bw, %_ZNK2v88internal21ExternalTwoByteString8GetCharsEv.exit ] ; 2 uses
  %.01112.i.i14 = phi ptr [ %i.cc, %.lr.ph.i.i12 ], [ %1, %_ZNK2v88internal21ExternalTwoByteString8GetCharsEv.exit ] ; 2 uses
  %i.by = load i16, ptr %.01013.i.i13, align 2
end_hunk_6
begin_hunk_7_@_ZNK2v88internal6String9IsEqualToILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EEPNS0_12LocalIsolateE:bb.a
  %i.cj = load i64, ptr %i.ci, align 8
  br label %bb.c

_ZNK2v88internal6String13IsEqualToImplILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EERKNS0_31SharedStringAccessGuardIfNeededE.exit.loopexit: ; preds = %.lr.ph.i.i12, %.lr.ph.i.i, %bb.d, %bb.f, %_ZNK2v88internal21ExternalOneByteString8GetCharsEv.exit, %_ZNK2v88internal21ExternalTwoByteString8GetCharsEv.exit, %bb.e
  %.sroa.050.1.ph = phi i1 [ %i.bc, %_ZNK2v88internal21ExternalOneByteString8GetCharsEv.exit ], [ %.not.i.i5, %.lr.ph.i.i ], [ %i.ah, %bb.f ], [ %i.x, %bb.d ], [ true, %bb.e ], [ true, %_ZNK2v88internal21ExternalTwoByteString8GetCharsEv.exit ], [ %.not.i.i15, %.lr.ph.i.i12 ]
  %.pre = load i8, ptr %i.a, align 8, !range !10
  br label %_ZNK2v88internal6String13IsEqualToImplILNS1_12EqualityTypeE0EcEEbNS_4base6VectorIKT0_EERKNS0_31SharedStringAccessGuardIfNeededE.exit
...
6:                                                ; preds = %.lr.ph.i.i
  ...
  br i1 %.not16.i.i, label %.lr.ph.i.i, label %_ZNK2v88internal6String13IsEqualToImplILNS1_12EqualityTypeE2EcEEbNS_4base6VectorIKT0_EERKNS0_31SharedStringAccessGuardIfNeededE.exit.thread, !llvm.loop !8

bb.e:                                             ; preds = %bb.b, %bb.b
  %i.ad = call noundef zeroext i1 @_ZN2v88internal6String23IsConsStringEqualToImplIcEEbNS0_6TaggedINS0_10ConsStringEEENS_4base6VectorIKT_EERKNS0_31SharedStringAccessGuardIfNeededE(i64 %.sroa.0119.0, ptr %.sroa.039.0141, i64 %.sroa.speculated, ptr noundef nonnull align 8 dereferenceable(16) %3)
end_hunk_9
begin_hunk_10_@_ZN2v88internal6String23IsConsStringEqualToImplIcEEbNS0_6TaggedINS0_10ConsStringEEENS_4base6VectorIKT_EERKNS0_31SharedStringAccessGuardIfNeededE:bb.a
  call void @_ZNK2v86String29ExternalOneByteStringResource25CheckCachedDataInvariantsEv(ptr noundef nonnull align 8 dereferenceable(16) %i.ag) #27
...
bb.i:                                             ; preds = %bb.g, %bb.f
  ...
  %i.av = call noundef ptr %i.au(ptr noundef nonnull align 8 dereferenceable(16) %i.ag) #27
  br label %_ZNK2v88internal6String13IsEqualToImplILNS1_12EqualityTypeE2EcEEbNS_4base6VectorIKT0_EERKNS0_31SharedStringAccessGuardIfNeededE.exit

bb.j:                                             ; preds = %bb.b
  %i.aw = getelementptr inbounds nuw i8, ptr %i.m, i64 16
end_hunk_10
begin_hunk_11_@_ZN2v88internal6String23IsConsStringEqualToImplIcEEbNS0_6TaggedINS0_10ConsStringEEENS_4base6VectorIKT_EERKNS0_31SharedStringAccessGuardIfNeededE:bb.a
...
9:                                                ; preds = %.lr.ph.i.i23
  ...
  br i1 %.not16.i.i28, label %.lr.ph.i.i23, label %_ZNK2v88internal6String13IsEqualToImplILNS1_12EqualityTypeE2EcEEbNS_4base6VectorIKT0_EERKNS0_31SharedStringAccessGuardIfNeededE.exit.thread, !llvm.loop !8

bb.n:                                             ; preds = %bb.b, %bb.b
  %i.bu = getelementptr inbounds nuw i8, ptr %i.m, i64 24
end_hunk_11
begin_hunk_12_@_ZN2v88internal6String23IsConsStringEqualToImplIcEEbNS0_6TaggedINS0_10ConsStringEEENS_4base6VectorIKT_EERKNS0_31SharedStringAccessGuardIfNeededE:bb.a
...
end_hunk_12
begin_hunk_13_@_ZN2v88internal6String23IsConsStringEqualToImplIcEEbNS0_6TaggedINS0_10ConsStringEEENS_4base6VectorIKT_EERKNS0_31SharedStringAccessGuardIfNeededE:bb.a
  %i.cg = icmp eq i64 %i.cf, 0
  br i1 %i.cg, label %.thread134, label %.lr.ph, !llvm.loop !478
