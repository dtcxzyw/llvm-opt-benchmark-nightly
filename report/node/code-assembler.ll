...
begin_hunk_0_@_ZN2v88internal8compiler7TFGraph12AddDecoratorEPNS1_14GraphDecoratorE
...
end_hunk_0
begin_hunk_1_@_ZN2v88internal8compiler13CodeAssembler31RegisterCallGenerationCallbacksERKSt8functionIFvvEES7_:bb.a
bb.b:                                             ; preds = %bb.a
  %i.e = call noundef zeroext i1 %i.d(ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %1, i32 noundef 2) #25, !inline_history !93 ; 0 uses
...
_ZNSt8functionIFvvEEC2ERKS1_.exit.i:              ; preds = %bb.b, %bb.a
  %5 = phi <2 x ptr> [ splat (ptr null), %bb.a ], [ %i.f, %bb.b ]
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %i.b, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.b, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i, i64 16, i1 false)
  ...
  store <2 x ptr> %i.i, ptr %i.g, align 8
  store <2 x ptr> %5, ptr %i.h, align 8
  %.not.i.i = icmp eq ptr %i.j, null
  br i1 %.not.i.i, label %_ZNSt8functionIFvvEEaSERKS1_.exit, label %bb.c
end_hunk_1
begin_hunk_2_@_ZN2v88internal8compiler13CodeAssembler31RegisterCallGenerationCallbacksERKSt8functionIFvvEES7_:bb.a
...
end_hunk_2
begin_hunk_3_@_ZN2v88internal8compiler13CodeAssembler31RegisterCallGenerationCallbacksERKSt8functionIFvvEES7_:bb.a
bb.d:                                             ; preds = %_ZNSt8functionIFvvEEaSERKS1_.exit
  %i.p = call noundef zeroext i1 %i.o(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %2, i32 noundef 2) #25, !inline_history !93 ; 0 uses
...
_ZNSt8functionIFvvEEC2ERKS1_.exit.i5:             ; preds = %bb.d, %_ZNSt8functionIFvvEEaSERKS1_.exit
  %6 = phi <2 x ptr> [ splat (ptr null), %_ZNSt8functionIFvvEEaSERKS1_.exit ], [ %i.q, %bb.d ]
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.0.i.i.i3)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i3, ptr noundef nonnull align 8 dereferenceable(32) %3, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %i.m, i64 16, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.m, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i3, i64 16, i1 false)
