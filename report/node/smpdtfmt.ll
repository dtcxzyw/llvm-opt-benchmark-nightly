...
bb.d:                                             ; preds = %bb.c
  %i.z = tail call ptr @__dynamic_cast(ptr nonnull %i.x, ptr nonnull @_ZTIN6icu_7812NumberFormatE, ptr nonnull @_ZTIN6icu_7813DecimalFormatE, i64 0) #17 ; 3 uses
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  %.011 = phi i32 [ %i.g, %.lr.ph ], [ %2, %bb.a ] ; 2 uses
  %.0910 = phi i32 [ %spec.select, %.lr.ph ], [ 0, %bb.a ]
  %i.b = tail call noundef i32 @_ZNK6icu_7813UnicodeString8char32AtEi(ptr noundef nonnull align 8 dereferenceable(64) %1, i32 noundef %.011) #17 ; 2 uses
  %i.c = tail call signext i8 @u_isdigit_78(i32 noundef %i.b) #17
  %.not = icmp ne i8 %i.c, 0
  %i.d = zext i1 %.not to i32
  %spec.select = add nuw nsw i32 %.0910, %i.d     ; 2 uses
  %i.e = icmp ult i32 %i.b, 65536
  %i.f = select i1 %i.e, i32 1, i32 2
  %i.g = add nsw i32 %i.f, %.011                  ; 2 uses
  %i.h = icmp slt i32 %i.g, %3
  br i1 %i.h, label %.lr.ph, label %._crit_edge, !llvm.loop !50

._crit_edge:                                      ; preds = %.lr.ph, %bb.a
  %.09.lcssa = phi i32 [ 0, %bb.a ], [ %spec.select, %.lr.ph ]
  ret i32 %.09.lcssa
}
...
bb.e:                                             ; preds = %.thread, %._crit_edge, %bb.c
  %i.ac = icmp eq ptr %.sroa.0.0, null
  br i1 %i.ac, label %_ZN6icu_7812LocalPointerINS_13DecimalFormatEED2Ev.exit, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.ad = load ptr, ptr %.sroa.0.0, align 8
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 8
  %i.af = load ptr, ptr %i.ae, align 8
  call void %i.af(ptr noundef nonnull align 8 dereferenceable(136) %.sroa.0.0) #17, !inline_history !52
...
_ZNK6icu_7813UnicodeStringixEi.exit:              ; preds = %_ZNK6icu_7813UnicodeStringixEi.exit.lr.ph, %_ZN6icu_7816SimpleDateFormat12isSyntaxCharEDs.exit.thread
  ...
  %.02867 = phi i8 [ 0, %_ZNK6icu_7813UnicodeStringixEi.exit.lr.ph ], [ %.129.shrunk, %_ZN6icu_7816SimpleDateFormat12isSyntaxCharEDs.exit.thread ]
  %i.y = and i16 %i.x, 2
...
_ZN6icu_7816SimpleDateFormat12isSyntaxCharEDs.exit.thread: ; preds = %bb.c, %bb.g, %bb.h, %bb.e, %_ZN6icu_7816SimpleDateFormat12isSyntaxCharEDs.exit, %bb.d
  %.129.shrunk = phi i8 [ 0, %_ZN6icu_7816SimpleDateFormat12isSyntaxCharEDs.exit ], [ 1, %bb.d ], [ 0, %bb.g ], [ 0, %bb.h ], [ 0, %bb.e ], [ %i.ae, %bb.c ] ; 2 uses
  %.1 = phi i16 [ %.fr, %_ZN6icu_7816SimpleDateFormat12isSyntaxCharEDs.exit ], [ 39, %bb.d ], [ -1, %bb.g ], [ %i.bd, %bb.h ], [ %.fr, %bb.e ], [ %.fr, %bb.c ]
