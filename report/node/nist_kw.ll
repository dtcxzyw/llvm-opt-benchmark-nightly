...
bb.b:                                             ; preds = %.lr.ph, %bb.c
  ...
  %.03245 = phi i64 [ %i.l, %.lr.ph ], [ %i.ad, %bb.c ] ; 6 uses
  %i.o = lshr i64 %.03245, 8
  %6 = insertelement <4 x i64> poison, i64 %.03245, i64 0
  %7 = shufflevector <4 x i64> %6, <4 x i64> poison, <4 x i32> zeroinitializer
  %8 = lshr <4 x i64> %7, <i64 40, i64 32, i64 24, i64 16>
  %i.p = lshr i64 %.03245, 48
  %i.q = lshr i64 %.03245, 56
  %i.r = load <8 x i8>, ptr %3, align 1, !tbaa !10
  %9 = insertelement <2 x i64> poison, i64 %i.o, i64 0
  %10 = insertelement <2 x i64> %9, i64 %.03245, i64 1
  %11 = trunc <2 x i64> %10 to <2 x i8>
  %12 = trunc <4 x i64> %8 to <4 x i8>
  %i.s = trunc i64 %i.p to i8
  %i.t = trunc nuw i64 %i.q to i8
  %i.u = insertelement <8 x i8> poison, i8 %i.t, i64 0
  %i.v = insertelement <8 x i8> %i.u, i8 %i.s, i64 1
  %13 = shufflevector <4 x i8> %12, <4 x i8> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %14 = shufflevector <8 x i8> %i.v, <8 x i8> %13, <8 x i32> <i32 0, i32 1, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 poison>
  %15 = shufflevector <2 x i8> %11, <2 x i8> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %16 = shufflevector <8 x i8> %14, <8 x i8> %15, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 8, i32 9>
  %i.w = xor <8 x i8> %i.r, %16                   ; 2 uses
