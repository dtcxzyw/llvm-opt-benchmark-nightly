...
bb.a:
  %2 = alloca %"struct.std::__detail::_State", align 8 ; 18 uses
...
bb.b:                                             ; preds = %bb.a
  %.sroa.017.0.copyload = load <2 x i64>, ptr %1, align 8
  ...
  store <2 x i64> %.sroa.017.0.copyload, ptr %i.e, align 8
  store ptr %i.d, ptr %i.g, align 8
  br label %_ZNSt8__detail6_StateIcEC2EOS1_.exit

_ZNSt8__detail6_StateIcEC2EOS1_.exit.critedge:    ; preds = %bb.a
  store i32 11, ptr %2, align 8
  %.sroa.514.0..sroa_idx15 = getelementptr inbounds nuw i8, ptr %2, i64 8
...
bb.c:                                             ; preds = %_ZNSt8__detail6_StateIcEC2EOS1_.exit
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.l, ptr noundef nonnull align 8 dereferenceable(48) %2, i64 48, i1 false)
...
bb.f:                                             ; preds = %_ZNSt8__detail6_StateIcEC2EOS1_.exit
  call void @_ZNSt6vectorINSt8__detail6_StateIcEESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_(ptr noundef nonnull align 8 dereferenceable(24) %i.j, ptr %i.l, ptr noundef nonnull align 8 dereferenceable(48) %2)
