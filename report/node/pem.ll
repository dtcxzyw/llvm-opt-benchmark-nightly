...
bb.b:                                             ; preds = %bb.a, %bb.e
  %.02432 = phi i64 [ 0, %bb.a ], [ %i.q, %bb.e ] ; 3 uses
  %.02531 = phi ptr [ %0, %bb.a ], [ %i.r, %bb.e ] ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c, %bb.b
  ...
  %i.i = and i64 %i.h, 4
  %i.j = xor i64 %i.i, 4
  %i.k = shl nuw nsw i64 %i.g, %i.j
  %i.l = lshr i64 %.02432, 1
  ...
  %i.q = add nuw nsw i64 %.02432, 1               ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %.02531, i64 1
  %exitcond.not = icmp eq i64 %i.q, %i.a
