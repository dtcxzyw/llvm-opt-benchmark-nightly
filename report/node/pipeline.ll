...
_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim.exit.i.i.i: ; preds = %bb.e
  ...
  %i.u = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.t) #31 ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  %i.f = tail call noalias noundef nonnull dereferenceable(32) ptr @_Znwm(i64 noundef 32) #31, !noalias !184 ; 5 uses
  %4 = icmp eq i64 %3, 0
...
begin_hunk_2_@_ZN2v88internal4wasm22WasmModuleCoverageData19InstallCoverageDataEiNS_4base6VectorIKNS1_13WasmCodeRangeEEE:bb.a
  %i.p = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %i.o) #31, !noalias !192 ; 5 uses
  tail call void @llvm.memset.p0.i64(ptr nonnull align 4 %i.p, i8 -1, i64 %i.n, i1 false), !noalias !192
  %.not.i.i.i.i.i = icmp eq i64 %3, 1
  br i1 %.not.i.i.i.i.i, label %bb.d, label %bb.c, !prof !203
