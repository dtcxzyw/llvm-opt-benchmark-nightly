...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !10   ; 13 uses
...
.loopexit:                                        ; preds = %.preheader, %.loopexit31
  ...
  store i32 0, ptr %i.aj, align 8, !tbaa !18
  ret i32 1
}
...
vector.ph.a:                                      ; preds = %vector.main.loop.iter.check
  ...
  %wide.load = load <16 x i8>, ptr %2, align 1, !tbaa !16
  %wide.load123 = load <16 x i8>, ptr %i.v, align 1, !tbaa !16
  %i.w = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.l ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 16
  %wide.load124 = load <16 x i8>, ptr %i.w, align 1, !tbaa !16
  %wide.load125 = load <16 x i8>, ptr %i.x, align 1, !tbaa !16
  %i.y = xor <16 x i8> %wide.load124, %wide.load
  %i.z = xor <16 x i8> %wide.load125, %wide.load123
  %i.aa = getelementptr i8, ptr %1, i64 16
  store <16 x i8> %i.y, ptr %1, align 1, !tbaa !16
  store <16 x i8> %i.z, ptr %i.aa, align 1, !tbaa !16
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load134 = load <4 x i8>, ptr %next.gep133, align 1, !tbaa !16
  %gep = getelementptr i8, ptr %invariant.gep.a, i64 %index131
  %wide.load135 = load <4 x i8>, ptr %gep, align 1, !tbaa !16
  %i.af = xor <4 x i8> %wide.load135, %wide.load134
  store <4 x i8> %i.af, ptr %next.gep132, align 1, !tbaa !16
  %index.next136 = add nuw i64 %index131, 4       ; 2 uses
  %i.ag = icmp eq i64 %index.next136, %n.vec130
  br i1 %i.ag, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !21
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.ai = load i8, ptr %.07281, align 1, !tbaa !16
  ...
  store i8 %i.al, ptr %.06783, align 1, !tbaa !16
  %i.an = add i64 %.06982, -1                     ; 3 uses
  %i.ao = icmp ne i64 %i.an, 0
  %i.ap = icmp samesign ult i64 %indvars.iv, 63
  %i.aq = and i1 %i.ao, %i.ap
  br i1 %i.aq, label %vec.epilog.scalar.ph, label %._crit_edge.loopexit, !llvm.loop !25
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  ...
  store i32 %.065.lcssa, ptr %i.f, align 8, !tbaa !18
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.av = load i32, ptr %i.au, align 8, !tbaa !17
  %i.aw = add i32 %i.av, 1                        ; 2 uses
  store i32 %i.aw, ptr %i.au, align 8, !tbaa !17
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ba = add i32 %i.az, 1
  store i32 %i.ba, ptr %i.ay, align 4, !tbaa !17
  br label %bb.e
...
bb.f:                                             ; preds = %.lr.ph94, %bb.h
  ...
  store i32 %spec.select, ptr %i.be, align 8, !tbaa !17
  %i.br = icmp eq i32 %spec.select, 0
  br i1 %i.br, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f
  %i.bs = load i32, ptr %i.bg, align 4, !tbaa !17
  %i.bt = add i32 %i.bs, 1
  store i32 %i.bt, ptr %i.bg, align 4, !tbaa !17
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f
  %.not78 = icmp eq i64 %i.bo, 0
  br i1 %.not78, label %._crit_edge95, label %bb.f, !llvm.loop !26
...
vector.body154:                                   ; preds = %vector.body154, %vector.ph151
  ...
  %wide.load156 = load <8 x i8>, ptr %i.by, align 1, !tbaa !16
  %wide.load157 = load <8 x i8>, ptr %i.bz, align 1, !tbaa !16
  %i.ca = getelementptr inbounds nuw i8, ptr %i.bu, i64 %index155 ; 2 uses
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 8
  %wide.load158 = load <8 x i8>, ptr %i.ca, align 1, !tbaa !16
  %wide.load159 = load <8 x i8>, ptr %i.cb, align 1, !tbaa !16
  ...
  store <8 x i8> %i.cc, ptr %i.ce, align 1, !tbaa !16
  store <8 x i8> %i.cd, ptr %i.cf, align 1, !tbaa !16
  %index.next160 = add nuw i64 %index155, 16      ; 2 uses
  %i.cg = icmp eq i64 %index.next160, %n.vec153
  br i1 %i.cg, label %middle.block161, label %vector.body154, !llvm.loop !27
...
vec.epilog.iter.check166:                         ; preds = %middle.block161
  ...
  br i1 %min.epilog.iters.check167, label %vec.epilog.scalar.ph165.preheader, label %vec.epilog.ph168, !prof !28
...
vec.epilog.scalar.ph165.prol:                     ; preds = %vec.epilog.scalar.ph165.preheader, %vec.epilog.scalar.ph165.prol
  ...
  br i1 %prol.iter.cmp.not, label %vec.epilog.scalar.ph165.prol.loopexit, label %vec.epilog.scalar.ph165.prol, !llvm.loop !30
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !10   ; 24 uses
...
chacha_init_key.exit:                             ; preds = %bb.e, %.preheader30.preheader.i
  ...
  store i32 0, ptr %i.ao, align 8, !tbaa !18
...
chacha_init_key.exit29:                           ; preds = %bb.f, %.preheader30.preheader.i28
  ...
  store i32 0, ptr %i.bo, align 8, !tbaa !18
  br label %bb.g
...
bb.a:
  ...
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 120
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !10   ; 46 uses
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 200 ; 3 uses
  %i.f = load i64, ptr %i.e, align 8, !tbaa !33   ; 23 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  store i64 13, ptr %i.u, align 8, !tbaa !39
  %i.v = getelementptr inbounds nuw i8, ptr %i.d, i64 176
  store i64 %i.f, ptr %i.v, align 8, !tbaa !40
...
bb.j:                                             ; preds = %bb.d
  ...
  store i64 13, ptr %i.ah, align 8, !tbaa !39
  %i.ai = getelementptr inbounds nuw i8, ptr %i.d, i64 176
  store i64 %i.f, ptr %i.ai, align 8, !tbaa !40
...
bb.s:                                             ; preds = %bb.b
  ...
  store i32 0, ptr %i.bc, align 8, !tbaa !38
  ...
  store i32 1, ptr %i.g, align 4, !tbaa !37
...
bb.t:                                             ; preds = %bb.s
  ...
  store i64 13, ptr %i.bd, align 8, !tbaa !39
  %i.bf = getelementptr inbounds nuw i8, ptr %i.d, i64 184
  store i32 1, ptr %i.bf, align 8, !tbaa !41
  br label %bb.u
...
bb.w:                                             ; preds = %bb.v
  ...
  store i32 1, ptr %i.bl, align 8, !tbaa !41
...
bb.aa:                                            ; preds = %bb.z, %bb.y
  store i32 0, ptr %i.bn, align 8, !tbaa !41
  br label %bb.ab
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  %i.cc = load i64, ptr %i.bx, align 8, !tbaa !40
  %i.cd = add i64 %i.cc, %.0105
  store i64 %i.cd, ptr %i.bx, align 8, !tbaa !40
...
bb.ah:                                            ; preds = %.thread, %bb.ag
  ...
  %i.cf = load i32, ptr %i.ce, align 8, !tbaa !41
...
bb.ak:                                            ; preds = %bb.aj, %bb.ai
  store i32 0, ptr %i.ce, align 8, !tbaa !41
  br label %bb.al
...
bb.al:                                            ; preds = %bb.ak, %bb.ah
  ...
  %i.cn = load i64, ptr %i.cm, align 8, !tbaa !40
...
bb.at:                                            ; preds = %bb.as
  ...
  %i.da = load i32, ptr %i.cz, align 8, !tbaa !42
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !10   ; 24 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %i.f, ptr %i.a, align 8, !tbaa !10
...
.thread:                                          ; preds = %bb.b, %bb.c
  ...
  store i32 12, ptr %i.i, align 4, !tbaa !36
...
bb.f:                                             ; preds = %bb.e
  ...
  store ptr %i.n, ptr %i.o, align 8, !tbaa !10
...
bb.j:                                             ; preds = %bb.i
  ...
  store i32 %2, ptr %i.s, align 4, !tbaa !36
  br label %.critedge
...
bb.o:                                             ; preds = %bb.n
  ...
  store i32 %2, ptr %i.ah, align 8, !tbaa !42
  br label %.critedge
...
bb.w:                                             ; preds = %bb.v, %bb.t
  ...
  store i64 %i.bd, ptr %i.be, align 8, !tbaa !33
  ...
  store i32 0, ptr %i.bn, align 4, !tbaa !37
  br label %.critedge
...
!17 = !{!7, !7, i64 0}
!18 = !{!19, !7, i64 112}
!19 = !{!"", !8, i64 0, !8, i64 32, !8, i64 48, !7, i64 112}
...
!33 = !{!34, !15, i64 200}
!34 = !{!"", !19, i64 0, !8, i64 120, !8, i64 132, !8, i64 148, !35, i64 168, !7, i64 184, !7, i64 188, !7, i64 192, !7, i64 196, !15, i64 200}
!35 = !{!"", !15, i64 0, !15, i64 8}
!36 = !{!34, !7, i64 196}
!37 = !{!34, !7, i64 188}
!38 = !{!34, !7, i64 112}
!39 = !{!34, !15, i64 168}
