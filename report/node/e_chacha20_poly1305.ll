...
vector.ph.a:                                      ; preds = %vector.ph.a, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.u, align 1, !tbaa !16
  ...
  store <16 x i8> %i.y, ptr %i.t, align 1, !tbaa !16
  store <16 x i8> %i.z, ptr %i.aa, align 1, !tbaa !16
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %cmp.n.a = icmp eq i64 %index.next, %n.vec
  br i1 %cmp.n.a, label %middle.block, label %vector.ph.a, !llvm.loop !20
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.ag, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !25
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  br i1 %i.aq, label %vec.epilog.scalar.ph, label %._crit_edge.loopexit, !llvm.loop !26
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  br i1 %.not78, label %._crit_edge95, label %bb.f, !llvm.loop !27
...
vector.body154:                                   ; preds = %vector.body154, %vector.ph151
  ...
  br i1 %i.cg, label %middle.block161, label %vector.body154, !llvm.loop !28
...
vec.epilog.iter.check166:                         ; preds = %middle.block161
  ...
  br i1 %min.epilog.iters.check167, label %vec.epilog.scalar.ph165.preheader, label %vec.epilog.ph168, !prof !29
...
vec.epilog.vector.body171:                        ; preds = %vec.epilog.vector.body171, %vec.epilog.ph168
  ...
  br i1 %i.cl, label %vec.epilog.middle.block176, label %vec.epilog.vector.body171, !llvm.loop !30
...
vec.epilog.scalar.ph165.prol:                     ; preds = %vec.epilog.scalar.ph165.preheader, %vec.epilog.scalar.ph165.prol
  ...
  br i1 %prol.iter.cmp.not, label %vec.epilog.scalar.ph165.prol.loopexit, label %vec.epilog.scalar.ph165.prol, !llvm.loop !31
...
vec.epilog.scalar.ph165:                          ; preds = %vec.epilog.scalar.ph165.prol.loopexit, %vec.epilog.scalar.ph165
  ...
  br i1 %exitcond.not.3, label %.loopexit, label %vec.epilog.scalar.ph165, !llvm.loop !33
...
bb.a:
  ...
  %i.f = load i64, ptr %i.e, align 8, !tbaa !34   ; 23 uses
...
bb.at:                                            ; preds = %bb.as
  ...
  %i.da = load i32, ptr %i.cz, align 8, !tbaa !43
...
.thread:                                          ; preds = %bb.b, %bb.c
  ...
  store i32 12, ptr %i.i, align 4, !tbaa !37
  %i.j = getelementptr inbounds nuw i8, ptr %.096110, i64 200
  store i64 -1, ptr %i.j, align 8, !tbaa !34
...
bb.j:                                             ; preds = %bb.i
  ...
  store i32 %2, ptr %i.s, align 4, !tbaa !37
  br label %.critedge
...
bb.o:                                             ; preds = %bb.n
  ...
  store i32 %2, ptr %i.ah, align 8, !tbaa !43
  br label %.critedge
...
bb.w:                                             ; preds = %bb.v, %bb.t
  ...
  store i64 %i.bd, ptr %i.be, align 8, !tbaa !34
...
!34 = !{!35, !15, i64 200}
!35 = !{!"", !19, i64 0, !8, i64 120, !8, i64 132, !8, i64 148, !36, i64 168, !7, i64 184, !7, i64 188, !7, i64 192, !7, i64 196, !15, i64 200}
!36 = !{!"", !15, i64 0, !15, i64 8}
!37 = !{!35, !7, i64 196}
!38 = !{!35, !7, i64 188}
!39 = !{!35, !7, i64 112}
!40 = !{!35, !15, i64 168}
