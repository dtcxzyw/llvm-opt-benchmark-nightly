...
begin_hunk_0_@_ZN4node19CompileCacheHandler7PersistEv:bb.a
  ...
  %i.be = call noalias noundef nonnull dereferenceable(20) ptr @_Znwm(i64 noundef 20) #26 ; 8 uses
...
bb.r:                                             ; preds = %_ZNK4node19CompileCacheHandler5DebugIJRPKcEEEvS3_DpOT_.exit
  ...
  call void @_ZN4node7FPrintFIJRPKcRNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES3_RjSB_SB_SB_SB_EEEvP8_IO_FILESt17basic_string_viewIcS7_EDpOT_(ptr noundef %i.cg, i64 80, ptr nonnull @.str.42, ptr noundef nonnull align 8 dereferenceable(8) %i.a, ptr noundef nonnull align 8 dereferenceable(32) %i.br, ptr noundef nonnull align 8 dereferenceable(8) %i.j, ptr noundef nonnull align 4 dereferenceable(4) %i.be, ptr noundef nonnull align 4 dereferenceable(4) %i.bf, ptr noundef nonnull align 4 dereferenceable(4) %i.bi, ptr noundef nonnull align 4 dereferenceable(4) %i.bl, ptr noundef nonnull align 4 dereferenceable(4) %i.bm) #29
