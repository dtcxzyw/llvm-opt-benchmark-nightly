...
.preheader.7:                                     ; preds = %.preheader.6
  ...
  %.not.7 = icmp eq i8 %i.r, 0                    ; 2 uses
  %spec.select = select i1 %.not.7, i64 8, i64 7
...
.critedge:                                        ; preds = %.preheader.7, %.preheader.6, %.preheader.5, %.preheader.4, %.preheader.3, %.preheader.2, %.preheader.1, %.preheader.preheader
  %.0.lcssa = phi i64 [ 4, %.preheader.4 ], [ 0, %.preheader.preheader ], [ 1, %.preheader.1 ], [ %spec.select, %.preheader.7 ], [ 2, %.preheader.2 ], [ 5, %.preheader.5 ], [ 3, %.preheader.3 ], [ 6, %.preheader.6 ]
  %.0.lcssa.a = phi i32 [ 4, %.preheader.4 ], [ 0, %.preheader.preheader ], [ 1, %.preheader.1 ], [ %spec.select.a, %.preheader.7 ], [ 2, %.preheader.2 ], [ 5, %.preheader.5 ], [ 3, %.preheader.3 ], [ 6, %.preheader.6 ] ; 2 uses
...
begin_hunk_1_@create_nonce:bb.a
  ...
  %i.aa = getelementptr inbounds nuw i8, ptr %i.a, i64 %.0.lcssa
