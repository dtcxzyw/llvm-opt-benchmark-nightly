...
._crit_edge335.loopexit.peel.begin.i:             ; preds = %bb.aw
  ...
  %i.oc = select i1 %i.ob, i32 %.0298.i, i32 %.0297.i ; 7 uses
...
begin_hunk_2_@aesni_cbc_hmac_sha1_ctrl:bb.a
  ...
  %i.qm = select i1 %i.ql, i32 %.0298.i, i32 %.0297.i ; 5 uses
...
begin_hunk_3_@aesni_cbc_hmac_sha1_ctrl:bb.a
  ...
  %8 = add i32 %i.qm, 4
  %i.rr = and i32 %8, 15                          ; 2 uses
  %i.rs = trunc nuw nsw i32 %i.rr to i8
  %9 = xor i8 %i.rs, 15
  %10 = sub i32 11, %i.qm
  %11 = and i32 %10, 15
  %i.rt = zext nneg i32 %11 to i64                ; 2 uses
  %i.ru = add nuw nsw i64 %i.rt, 1
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %i.rq, i8 %9, i64 %i.ru, i1 false), !tbaa !10
  ...
  %12 = sub i32 %i.qm, %i.rr                      ; 3 uses
  %.reass.i.reass.reass = add i32 %12, %invariant.op
...
begin_hunk_4_@aesni_cbc_hmac_sha1_ctrl:bb.a
  ...
  %i.sj = add i32 %.0304342.i, 57
  %i.sk = add i32 %i.sj, %12                      ; 2 uses
...
begin_hunk_5_@aesni_cbc_hmac_sha1_ctrl:bb.a
  ...
  %13 = add i32 %i.oc, 4
  %i.tp = and i32 %13, 15                         ; 2 uses
  %i.tq = trunc nuw nsw i32 %i.tp to i8
  %14 = xor i8 %i.tq, 15
  %15 = sub i32 11, %i.oc
  %16 = and i32 %15, 15
  %narrow.i = add nuw nsw i32 %16, 1
  %i.tr = zext nneg i32 %narrow.i to i64
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %i.to, i8 %14, i64 %i.tr, i1 false), !tbaa !10
  %17 = sub i32 %i.oc, %i.tp                      ; 3 uses
  %reass.sub.peel.i = add i32 %17, 36
