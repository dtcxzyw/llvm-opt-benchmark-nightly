...
bb.c:                                             ; preds = %bb.b, %bb.a
  %.049.i = phi i1 [ false, %bb.a ], [ %i.d, %bb.b ] ; 23 uses
...
_ZN4absl12_GLOBAL__N_111FloatTraitsIfE4MakeEjib.exit.i.i: ; preds = %bb.u, %bb.t
  %.07.i.i.i = phi i32 [ %i.bo, %bb.t ], [ %8, %bb.u ]
...
_ZN4absl12_GLOBAL__N_111FloatTraitsIfE4MakeEjib.exit.i89.i: ; preds = %bb.au, %bb.at
  %.07.i.i90.i = phi i32 [ %i.ed, %bb.at ], [ %10, %bb.au ]
...
bb.cn:                                            ; preds = %bb.cm
  ...
  %11 = select i1 %.049.i, i32 -889192448, i32 1258291200
  %i.ln = add i32 %i.lm, %11
  %i.lo = and i32 %i.lk, 8388607
  br label %_ZN4absl12_GLOBAL__N_111FloatTraitsIfE4MakeEjib.exit.i113.i

bb.co:                                            ; preds = %bb.cm
  %12 = select i1 %.049.i, i32 -2147483648, i32 0
...
_ZN4absl12_GLOBAL__N_111FloatTraitsIfE4MakeEjib.exit.i113.i: ; preds = %bb.co, %bb.cn
  %.07.i.i114.i = phi i32 [ %i.ln, %bb.cn ], [ %12, %bb.co ]
...
_ZN4absl16strings_internal11BigUnsignedILi84EE9SetToZeroEv.exit.i51: ; preds = %bb.o
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(4) %i.h, i8 0, i64 %.idx.i.i.i.i50, i1 false)
