...
bb.a:
  %i.a = tail call noalias noundef nonnull dereferenceable(32) ptr @_Znwm(i64 noundef 32) #30 ; 10 uses
...
bb.g:                                             ; preds = %.lr.ph.i.i
  ...
  br i1 %.not19.i.i, label %bb.f, label %..loopexit_crit_edge21.i.i, !llvm.loop !442

..loopexit_crit_edge21.i.i:                       ; preds = %bb.g
  br label %.critedge19, !llvm.loop !442
...
.critedge19:                                      ; preds = %.lr.ph.i.i, %.critedge, %..loopexit_crit_edge21.i.i, %.critedge.thread
  ...
  %i.an = tail call { i8, i64 } @_ZNKSt8__detail20_Prime_rehash_policy14_M_need_rehashEmmm(ptr noundef nonnull align 8 dereferenceable(16) %i.am, i64 noundef %i.aj, i64 noundef %i.e, i64 noundef 1) #28 ; 2 uses
...
_ZNKSt10_HashtableIPvSt4pairIKS0_N4node15TimerWrapHandleEESaIS5_ENSt8__detail10_Select1stESt8equal_toIS0_ESt4hashIS0_ENS7_18_Mod_range_hashingENS7_20_Default_ranged_hashENS7_20_Prime_rehash_policyENS7_17_Hashtable_traitsILb0ELb0ELb1EEEE12_M_find_nodeEmRS2_m.exit: ; preds = %bb.f, %bb.d, %bb.e
  ...
  tail call void @_ZN4node15TimerWrapHandle5CloseEv(ptr noundef nonnull align 8 dereferenceable(16) %i.bk) #28
...
bb.a:
  ...
  %.sroa.0.sroa.0.0.copyload = load <2 x ptr>, ptr %3, align 8
  ...
  %i.j = tail call noalias noundef nonnull dereferenceable(200) ptr @_Znwm(i64 noundef 200) #30 ; 8 uses
  ...
  store <2 x ptr> %.sroa.0.sroa.0.0.copyload, ptr %i.l, align 8
  ...
  %i.t = tail call i32 @uv_timer_init(ptr noundef %i.r, ptr noundef nonnull %i.s) #28 ; 0 uses
...
bb.b:                                             ; preds = %bb.a
  call void @_ZN4node6AssertERKNS_13AssertionInfoE(ptr noundef nonnull align 8 dereferenceable(24) @_ZZN4node12CleanupQueue3AddEPFvPvES1_E20error_and_abort_args) #28
  call void @abort() #29
  unreachable
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = tail call noundef zeroext i1 %i.b(ptr noundef nonnull align 8 dereferenceable(32) %i.c, ptr noundef nonnull align 8 dereferenceable(32) %i.c, i32 noundef 3) #28, !inline_history !443 ; 0 uses
...
bb.b:                                             ; preds = %bb.a
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.d = tail call noundef zeroext i1 %i.b(ptr noundef nonnull align 8 dereferenceable(32) %i.c, ptr noundef nonnull align 8 dereferenceable(32) %i.c, i32 noundef 3) #28, !inline_history !444 ; 0 uses
...
bb.a:
  ...
  tail call void %i.a(ptr noundef %i.c) #28, !inline_history !445
  ret void
}
