...
@switch.table.ossl_dh_get_named_group_uid_from_size = private unnamed_addr constant [7 x i16] [i16 1126, i16 1127, i16 1128, i16 0, i16 1129, i16 0, i16 1130], align 4
...
bb.b:                                             ; preds = %switch.lookup, %bb.a
  %.03 = phi i32 [ 0, %bb.a ], [ %switch.ext, %switch.lookup ]
  ret i32 %.03
}
