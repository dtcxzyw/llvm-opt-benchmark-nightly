...
begin_hunk_0_@mbedtls_ssl_parse_certificate:bb.a
  ...
  %i.ad = icmp eq i8 %.val8.val.i, 1
  %..i.i = select i1 %i.ad, i64 12, i64 4         ; 2 uses
  %1 = or disjoint i64 %..i.i, 3
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.bm = load i64, ptr %i.bl, align 8, !tbaa !271 ; 3 uses
  ...
  %i.bo = icmp eq i8 %.val78.val.i, 1
  %..i.i52.a = select i1 %i.bo, i64 12, i64 4     ; 3 uses
  %2 = add nuw nsw i64 %..i.i52.a, 6              ; 4 uses
  %i.bp = icmp ult i64 %i.bm, %2
...
bb.w:                                             ; preds = %bb.u
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bj, i64 %..i.i52.a ; 2 uses
...
begin_hunk_3_@mbedtls_ssl_parse_certificate:bb.a
  ...
  %3 = or disjoint i64 %..i.i52.a, 3              ; 2 uses
  %i.bv = add nuw nsw i64 %3, %i.bu
...
bb.z:                                             ; preds = %bb.x
  ...
  %i.by = getelementptr inbounds nuw i8, ptr %i.bj, i64 %3 ; 2 uses
...
bb.ab:                                            ; preds = %bb.aa
  %i.ce = add nuw nsw i64 %2, %i.cc               ; 3 uses
...
begin_hunk_8_@mbedtls_ssl_parse_finished:bb.a
  ...
  %i.w = icmp eq i8 %.val50.val, 1
  %..i.a = select i1 %i.w, i64 12, i64 4          ; 2 uses
  %1 = add nuw nsw i64 %..i.a, 12
  %.not47 = icmp eq i64 %i.u, %1
...
bb.k:                                             ; preds = %bb.i
  %i.y = getelementptr inbounds nuw i8, ptr %i.q, i64 %..i.a
