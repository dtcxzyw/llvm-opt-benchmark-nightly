...
bb.t:                                             ; preds = %bb.r
  ...
  br i1 %.not71.i, label %bb.u, label %ssl_parse_certificate_chain.exit.thread.sink.split
...
begin_hunk_3
  ...
  switch i32 %i.cr, label %ssl_parse_certificate_chain.exit [
    i32 0, label %bb.ai
...
bb.ai:                                            ; preds = %bb.ah, %bb.ah
  ...
  br i1 %i.ct, label %.peel.next.i, label %ssl_parse_certificate_chain.exit.thread59
...
bb.am:                                            ; preds = %bb.al
  ...
  switch i32 %i.dh, label %ssl_parse_certificate_chain.exit [
    i32 0, label %bb.an
...
bb.an:                                            ; preds = %bb.am, %bb.am
  ...
  br i1 %i.dj, label %.peel.next.i, label %ssl_parse_certificate_chain.exit.thread59, !llvm.loop !271

ssl_parse_certificate_chain.exit.thread59:        ; preds = %bb.an, %bb.ai
...
ssl_parse_certificate_chain.exit:                 ; preds = %bb.am, %bb.ah, %.loopexit.i, %.loopexit88.i
  %1 = phi i32 [ -9600, %.loopexit88.i ], [ -10368, %.loopexit.i ], [ %i.cr, %bb.ah ], [ %i.dh, %bb.am ] ; 3 uses
  %.0.i53 = phi i8 [ 43, %.loopexit88.i ], [ 80, %.loopexit.i ], [ 42, %bb.ah ], [ 42, %bb.am ]
  %2 = tail call i32 @mbedtls_ssl_send_alert_message(ptr noundef nonnull %0, i8 noundef zeroext 2, i8 noundef zeroext %.0.i53) #26 ; 0 uses
  tail call void @mbedtls_debug_print_ret(ptr noundef nonnull %0, i32 noundef 1, ptr noundef nonnull @.str, i32 noundef 7886, ptr noundef nonnull @.str.199, i32 noundef %1) #26
  %.not46 = icmp eq i32 %1, 0
  br i1 %.not46, label %bb.ao, label %ssl_parse_certificate_chain.exit.thread

bb.ao:                                            ; preds = %ssl_parse_certificate_chain.exit.thread59, %ssl_parse_certificate_chain.exit
  %i.dk = load ptr, ptr %i.a, align 8, !tbaa !70
  %i.dl = getelementptr inbounds nuw i8, ptr %i.dk, i64 16
  %3 = load ptr, ptr %i.dl, align 8, !tbaa !252
  %4 = tail call i32 @mbedtls_ssl_verify_certificate(ptr noundef nonnull %0, i32 noundef %i.h, ptr noundef nonnull %i.ax, ptr noundef %3, ptr noundef null) ; 2 uses
  %.not47 = icmp eq i32 %4, 0
  br i1 %.not47, label %bb.ap, label %ssl_parse_certificate_chain.exit.thread

bb.ap:                                            ; preds = %bb.ao
  %5 = load ptr, ptr %i.as, align 8, !tbaa !88
  %6 = getelementptr inbounds nuw i8, ptr %5, i64 112
  store ptr %i.ax, ptr %6, align 8, !tbaa !45
...
.thread66:                                        ; preds = %bb.ap, %bb.g, %bb.n
...
ssl_parse_certificate_chain.exit.thread.sink.split: ; preds = %bb.t, %bb.s, %bb.v, %bb.y, %.loopexit93.i, %.loopexit94.i, %.loopexit95.i, %ssl_check_peer_crt_unchanged.exit.thread.i
  %.sink = phi i8 [ 49, %ssl_check_peer_crt_unchanged.exit.thread.i ], [ 50, %.loopexit95.i ], [ 43, %.loopexit94.i ], [ 50, %.loopexit93.i ], [ 50, %bb.y ], [ 50, %bb.v ], [ 10, %bb.s ], [ 10, %bb.t ]
  %.036.ph.ph = phi i32 [ -31232, %ssl_check_peer_crt_unchanged.exit.thread.i ], [ -29440, %.loopexit95.i ], [ -31232, %.loopexit94.i ], [ -29440, %.loopexit93.i ], [ -29440, %bb.y ], [ -29440, %bb.v ], [ -30464, %bb.s ], [ -30464, %bb.t ]
  %7 = tail call i32 @mbedtls_ssl_send_alert_message(ptr noundef nonnull %0, i8 noundef zeroext 2, i8 noundef zeroext %.sink) #26 ; 0 uses
  br label %ssl_parse_certificate_chain.exit.thread

ssl_parse_certificate_chain.exit.thread:          ; preds = %ssl_parse_certificate_chain.exit.thread.sink.split, %bb.ao, %ssl_parse_certificate_chain.exit
  %.036.ph = phi i32 [ %1, %ssl_parse_certificate_chain.exit ], [ %4, %bb.ao ], [ %.036.ph.ph, %ssl_parse_certificate_chain.exit.thread.sink.split ]
...
.thread72:                                        ; preds = %bb.h, %bb.n, %bb.q, %.thread66, %ssl_parse_certificate_chain.exit.thread
  %.0366470 = phi i32 [ 0, %.thread66 ], [ %.036.ph, %ssl_parse_certificate_chain.exit.thread ], [ %i.v, %bb.h ], [ -29824, %bb.n ], [ -32512, %bb.q ]
  ret i32 %.0366470
}
