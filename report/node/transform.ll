...
vec.epilog.iter.check175:                         ; preds = %middle.block170
  ...
  br i1 %min.epilog.iters.check176, label %.lr.ph104.preheader, label %vec.epilog.ph177, !prof !19
...
vec.epilog.vector.body180:                        ; preds = %vec.epilog.vector.body180, %vec.epilog.ph177
  ...
  %wide.load182 = load <4 x i8>, ptr %i.df, align 1, !tbaa !17
  %gep236 = getelementptr i8, ptr %invariant.gep235, i64 %index181
  store <4 x i8> %wide.load182, ptr %gep236, align 1, !tbaa !17
  %index.next183 = add nuw i64 %index181, 4       ; 2 uses
  %i.dg = icmp eq i64 %index.next183, %n.vec179
  br i1 %i.dg, label %vec.epilog.middle.block184, label %vec.epilog.vector.body180, !llvm.loop !28
...
.lr.ph104.prol:                                   ; preds = %.lr.ph104.preheader, %.lr.ph104.prol
  ...
  br i1 %prol.iter230.cmp.not, label %.lr.ph104.prol.loopexit, label %.lr.ph104.prol, !llvm.loop !29
...
.lr.ph104:                                        ; preds = %.lr.ph104.prol.loopexit, %.lr.ph104
  ...
  br i1 %exitcond.not.3, label %._crit_edge105.loopexit, label %.lr.ph104, !llvm.loop !30
...
ToUpperCase.exit95:                               ; preds = %bb.m, %bb.n, %bb.p, %bb.q
  ...
  br i1 %i.fk, label %.lr.ph114, label %ToUpperCase.exit, !llvm.loop !31
...
.lr.ph110:                                        ; preds = %.lr.ph110.preheader, %.lr.ph110
  ...
  br i1 %i.gi, label %.lr.ph110, label %ToUpperCase.exit, !llvm.loop !33
...
vec.epilog.iter.check209:                         ; preds = %middle.block202
  ...
  br i1 %min.epilog.iters.check210, label %.lr.ph119.preheader, label %vec.epilog.ph211, !prof !19
...
vec.epilog.vector.body214:                        ; preds = %vec.epilog.vector.body214, %vec.epilog.ph211
  ...
  %wide.load217 = load <4 x i8>, ptr %i.im, align 1, !tbaa !17
  %gep238 = getelementptr i8, ptr %invariant.gep237, i64 %index215
  store <4 x i8> %wide.load217, ptr %gep238, align 1, !tbaa !17
  %index.next218 = add nuw i64 %index215, 4       ; 2 uses
  %i.in = icmp eq i64 %index.next218, %n.vec213
  br i1 %i.in, label %vec.epilog.middle.block219, label %vec.epilog.vector.body214, !llvm.loop !34
...
.lr.ph119.prol:                                   ; preds = %.lr.ph119.preheader, %.lr.ph119.prol
  ...
  br i1 %prol.iter233.cmp.not, label %.lr.ph119.prol.loopexit, label %.lr.ph119.prol, !llvm.loop !35
...
.lr.ph119:                                        ; preds = %.lr.ph119.prol.loopexit, %.lr.ph119
  ...
  br i1 %.not91.3, label %._crit_edge120.loopexit, label %.lr.ph119, !llvm.loop !36
