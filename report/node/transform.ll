...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %wide.load.1 = load <16 x i8>, ptr %i.am, align 1, !tbaa !17
  %wide.load144.1 = load <16 x i8>, ptr %i.an, align 1, !tbaa !17
  %i.ao = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.ap = getelementptr inbounds nuw i8, ptr %0, i64 48
  store <16 x i8> %wide.load.1, ptr %i.ao, align 1, !tbaa !17
  store <16 x i8> %wide.load144.1, ptr %i.ap, align 1, !tbaa !17
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %wide.load.2 = load <16 x i8>, ptr %i.ar, align 1, !tbaa !17
  %wide.load144.2 = load <16 x i8>, ptr %i.as, align 1, !tbaa !17
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 64
  %i.au = getelementptr inbounds nuw i8, ptr %0, i64 80
  store <16 x i8> %wide.load.2, ptr %i.at, align 1, !tbaa !17
  store <16 x i8> %wide.load144.2, ptr %i.au, align 1, !tbaa !17
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %wide.load.3 = load <16 x i8>, ptr %i.aw, align 1, !tbaa !17
  %wide.load144.3 = load <16 x i8>, ptr %i.ax, align 1, !tbaa !17
  %i.ay = getelementptr inbounds nuw i8, ptr %0, i64 96
  %i.az = getelementptr inbounds nuw i8, ptr %0, i64 112
  store <16 x i8> %wide.load.3, ptr %i.ay, align 1, !tbaa !17
  store <16 x i8> %wide.load144.3, ptr %i.az, align 1, !tbaa !17
...
vector.body.4:                                    ; preds = %vector.body.3
  ...
  %wide.load.4 = load <16 x i8>, ptr %i.bb, align 1, !tbaa !17
  %wide.load144.4 = load <16 x i8>, ptr %i.bc, align 1, !tbaa !17
  %i.bd = getelementptr inbounds nuw i8, ptr %0, i64 128
  %i.be = getelementptr inbounds nuw i8, ptr %0, i64 144
  store <16 x i8> %wide.load.4, ptr %i.bd, align 1, !tbaa !17
  store <16 x i8> %wide.load144.4, ptr %i.be, align 1, !tbaa !17
...
vector.body.5:                                    ; preds = %vector.body.4
  ...
  %wide.load.5 = load <16 x i8>, ptr %i.bg, align 1, !tbaa !17
  %wide.load144.5 = load <16 x i8>, ptr %i.bh, align 1, !tbaa !17
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 160
  %i.bj = getelementptr inbounds nuw i8, ptr %0, i64 176
  store <16 x i8> %wide.load.5, ptr %i.bi, align 1, !tbaa !17
  store <16 x i8> %wide.load144.5, ptr %i.bj, align 1, !tbaa !17
...
vector.body.6:                                    ; preds = %vector.body.5
  ...
  %wide.load.6 = load <16 x i8>, ptr %i.bl, align 1, !tbaa !17
  %wide.load144.6 = load <16 x i8>, ptr %i.bm, align 1, !tbaa !17
  %i.bn = getelementptr inbounds nuw i8, ptr %0, i64 192
  %i.bo = getelementptr inbounds nuw i8, ptr %0, i64 208
  store <16 x i8> %wide.load.6, ptr %i.bn, align 1, !tbaa !17
  store <16 x i8> %wide.load144.6, ptr %i.bo, align 1, !tbaa !17
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load150 = load <4 x i8>, ptr %i.bs, align 1, !tbaa !17
  %i.bt = getelementptr inbounds nuw i8, ptr %0, i64 %index148
  store <4 x i8> %wide.load150, ptr %i.bt, align 1, !tbaa !17
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader, %.lr.ph.prol
  ...
  %i.bx = load i8, ptr %.084.prol, align 1, !tbaa !17
  ...
  store i8 %i.bx, ptr %i.by, align 1, !tbaa !17
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  %i.ca = load i8, ptr %.084, align 1, !tbaa !17
  ...
  %i.cc = load i8, ptr %.084.1, align 1, !tbaa !17
  ...
  %i.cf = load i8, ptr %.084.2, align 1, !tbaa !17
  ...
  %i.cj = load i8, ptr %.084.3, align 1, !tbaa !17
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4 ; 2 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %0, i64 %indvars.iv
  %i.cl = getelementptr inbounds nuw i8, ptr %i.ck, i64 3
  store i8 %i.cj, ptr %i.cl, align 1, !tbaa !17
  %.not.3 = icmp eq i32 %i.ci, 0
  br i1 %.not.3, label %._crit_edge.loopexit, label %.lr.ph, !llvm.loop !26
...
vector.body165:                                   ; preds = %vector.body165, %vector.ph162
  ...
  %wide.load167 = load <16 x i8>, ptr %i.da, align 1, !tbaa !17
  %wide.load168 = load <16 x i8>, ptr %i.db, align 1, !tbaa !17
  %gep = getelementptr i8, ptr %invariant.gep, i64 %index166 ; 2 uses
  %i.dc = getelementptr inbounds nuw i8, ptr %gep, i64 16
  store <16 x i8> %wide.load167, ptr %gep, align 1, !tbaa !17
  store <16 x i8> %wide.load168, ptr %i.dc, align 1, !tbaa !17
  %index.next169 = add nuw i64 %index166, 32      ; 2 uses
  %i.dd = icmp eq i64 %index.next169, %n.vec164
  br i1 %i.dd, label %middle.block170, label %vector.body165, !llvm.loop !27
...
vec.epilog.iter.check175:                         ; preds = %middle.block170
  ...
  br i1 %min.epilog.iters.check176, label %.lr.ph104.preheader, label %vec.epilog.ph177, !prof !28
...
vec.epilog.vector.body180:                        ; preds = %vec.epilog.vector.body180, %vec.epilog.ph177
  ...
  %wide.load182 = load <8 x i8>, ptr %i.df, align 1, !tbaa !17
  %gep236 = getelementptr i8, ptr %invariant.gep235, i64 %index181
  store <8 x i8> %wide.load182, ptr %gep236, align 1, !tbaa !17
  %index.next183 = add nuw i64 %index181, 8       ; 2 uses
  %i.dg = icmp eq i64 %index.next183, %n.vec179
  br i1 %i.dg, label %vec.epilog.middle.block184, label %vec.epilog.vector.body180, !llvm.loop !29
...
.lr.ph104.prol:                                   ; preds = %.lr.ph104.preheader, %.lr.ph104.prol
  ...
  br i1 %prol.iter230.cmp.not, label %.lr.ph104.prol.loopexit, label %.lr.ph104.prol, !llvm.loop !30
...
.lr.ph104:                                        ; preds = %.lr.ph104.prol.loopexit, %.lr.ph104
  ...
  store i8 %i.dn, ptr %i.do, align 1, !tbaa !17
  ...
  store i8 %i.dr, ptr %i.dt, align 1, !tbaa !17
  ...
  store i8 %i.dw, ptr %i.dy, align 1, !tbaa !17
  ...
  store i8 %i.eb, ptr %i.ed, align 1, !tbaa !17
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next129.3, %wide.trip.count
  br i1 %exitcond.not.3, label %._crit_edge105.loopexit, label %.lr.ph104, !llvm.loop !31
...
bb.f:                                             ; preds = %._crit_edge105
  ...
  %i.ei = load i8, ptr %i.eh, align 1, !tbaa !17  ; 4 uses
...
bb.h:                                             ; preds = %bb.g
  %i.el = and i8 %i.ei, 95
  store i8 %i.el, ptr %i.eh, align 1, !tbaa !17
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.eo = load i8, ptr %i.en, align 1, !tbaa !17
  %i.ep = xor i8 %i.eo, 32
  store i8 %i.ep, ptr %i.en, align 1, !tbaa !17
  br label %ToUpperCase.exit
...
bb.k:                                             ; preds = %bb.i
  ...
  %i.es = xor i8 %i.er, 5
  store i8 %i.es, ptr %i.eq, align 1, !tbaa !17
  br label %ToUpperCase.exit

bb.l:                                             ; preds = %._crit_edge105
  br i1 %i.cv, label %.lr.ph114.preheader, label %ToUpperCase.exit
...
.lr.ph114:                                        ; preds = %.lr.ph114.preheader, %ToUpperCase.exit95
  %.1112 = phi i32 [ %i.fj, %ToUpperCase.exit95 ], [ %.080, %.lr.ph114.preheader ]
  %.085111 = phi ptr [ %i.fi, %ToUpperCase.exit95 ], [ %i.ev, %.lr.ph114.preheader ] ; 5 uses
  %i.ew = load i8, ptr %.085111, align 1, !tbaa !17 ; 4 uses
...
bb.n:                                             ; preds = %bb.m
  %i.ez = and i8 %i.ew, 95
  store i8 %i.ez, ptr %.085111, align 1, !tbaa !17
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.fd = xor i8 %i.fc, 32
  store i8 %i.fd, ptr %i.fb, align 1, !tbaa !17
  br label %ToUpperCase.exit95
...
bb.q:                                             ; preds = %bb.o
  ...
  %i.fg = xor i8 %i.ff, 5
  store i8 %i.fg, ptr %i.fe, align 1, !tbaa !17
  br label %ToUpperCase.exit95
...
ToUpperCase.exit95:                               ; preds = %bb.m, %bb.n, %bb.p, %bb.q
  ...
  br i1 %i.fk, label %.lr.ph114, label %ToUpperCase.exit, !llvm.loop !32
...
bb.r:                                             ; preds = %._crit_edge105
  ...
  %i.fu = tail call fastcc i32 @Shift(ptr noundef %i.ft, i32 noundef %.080, i16 noundef zeroext %i.fq) ; 0 uses
  br label %ToUpperCase.exit
...
bb.s:                                             ; preds = %._crit_edge105
  ...
  br i1 %i.cv, label %.lr.ph110.preheader, label %ToUpperCase.exit
...
vector.ph193:                                     ; preds = %vector.main.loop.iter.check191
  ...
  %wide.load199 = load <16 x i8>, ptr %i.gu, align 1, !tbaa !17
  %wide.load200 = load <16 x i8>, ptr %i.gv, align 1, !tbaa !17
  %i.gw = getelementptr i8, ptr %0, i64 %i.gl     ; 2 uses
  %i.gx = getelementptr inbounds nuw i8, ptr %i.gw, i64 16
  store <16 x i8> %wide.load199, ptr %i.gw, align 1, !tbaa !17
  store <16 x i8> %wide.load200, ptr %i.gx, align 1, !tbaa !17
...
vector.body196.1:                                 ; preds = %vector.ph193
  ...
  %wide.load199.1 = load <16 x i8>, ptr %i.gz, align 1, !tbaa !17
  %wide.load200.1 = load <16 x i8>, ptr %i.ha, align 1, !tbaa !17
  ...
  store <16 x i8> %wide.load199.1, ptr %i.hc, align 1, !tbaa !17
  store <16 x i8> %wide.load200.1, ptr %i.hd, align 1, !tbaa !17
...
vector.body196.2:                                 ; preds = %vector.body196.1
  ...
  %wide.load199.2 = load <16 x i8>, ptr %i.hf, align 1, !tbaa !17
  %wide.load200.2 = load <16 x i8>, ptr %i.hg, align 1, !tbaa !17
  ...
  store <16 x i8> %wide.load199.2, ptr %i.hi, align 1, !tbaa !17
  store <16 x i8> %wide.load200.2, ptr %i.hj, align 1, !tbaa !17
...
vector.body196.3:                                 ; preds = %vector.body196.2
  ...
  %wide.load199.3 = load <16 x i8>, ptr %i.hl, align 1, !tbaa !17
  %wide.load200.3 = load <16 x i8>, ptr %i.hm, align 1, !tbaa !17
  ...
  store <16 x i8> %wide.load199.3, ptr %i.ho, align 1, !tbaa !17
  store <16 x i8> %wide.load200.3, ptr %i.hp, align 1, !tbaa !17
...
vector.body196.4:                                 ; preds = %vector.body196.3
  ...
  %wide.load199.4 = load <16 x i8>, ptr %i.hr, align 1, !tbaa !17
  %wide.load200.4 = load <16 x i8>, ptr %i.hs, align 1, !tbaa !17
  ...
  store <16 x i8> %wide.load199.4, ptr %i.hu, align 1, !tbaa !17
  store <16 x i8> %wide.load200.4, ptr %i.hv, align 1, !tbaa !17
...
vector.body196.5:                                 ; preds = %vector.body196.4
  ...
  %wide.load199.5 = load <16 x i8>, ptr %i.hx, align 1, !tbaa !17
  %wide.load200.5 = load <16 x i8>, ptr %i.hy, align 1, !tbaa !17
  ...
  store <16 x i8> %wide.load199.5, ptr %i.ia, align 1, !tbaa !17
  store <16 x i8> %wide.load200.5, ptr %i.ib, align 1, !tbaa !17
...
vector.body196.6:                                 ; preds = %vector.body196.5
  ...
  %wide.load199.6 = load <16 x i8>, ptr %i.id, align 1, !tbaa !17
  %wide.load200.6 = load <16 x i8>, ptr %i.ie, align 1, !tbaa !17
  ...
  store <16 x i8> %wide.load199.6, ptr %i.ig, align 1, !tbaa !17
  store <16 x i8> %wide.load200.6, ptr %i.ih, align 1, !tbaa !17
...
vec.epilog.iter.check209:                         ; preds = %middle.block202
  ...
  br i1 %min.epilog.iters.check210, label %.lr.ph119.preheader, label %vec.epilog.ph211, !prof !28
...
vec.epilog.vector.body214:                        ; preds = %vec.epilog.vector.body214, %vec.epilog.ph211
  ...
  %wide.load217 = load <8 x i8>, ptr %i.im, align 1, !tbaa !17
  %gep238 = getelementptr i8, ptr %invariant.gep237, i64 %index215
  store <8 x i8> %wide.load217, ptr %gep238, align 1, !tbaa !17
  %index.next218 = add nuw i64 %index215, 8       ; 2 uses
  %i.in = icmp eq i64 %index.next218, %n.vec213
  br i1 %i.in, label %vec.epilog.middle.block219, label %vec.epilog.vector.body214, !llvm.loop !35
...
.lr.ph119.prol:                                   ; preds = %.lr.ph119.preheader, %.lr.ph119.prol
  ...
  %i.iq = load i8, ptr %.086.prol, align 1, !tbaa !17
  ...
  br i1 %prol.iter233.cmp.not, label %.lr.ph119.prol.loopexit, label %.lr.ph119.prol, !llvm.loop !36
...
.lr.ph119:                                        ; preds = %.lr.ph119.prol.loopexit, %.lr.ph119
  ...
  store i8 %i.jc, ptr %i.je, align 1, !tbaa !17
  %.not91.3 = icmp eq i32 %i.jb, 0
  br i1 %.not91.3, label %._crit_edge120.loopexit, label %.lr.ph119, !llvm.loop !37
...
._crit_edge120:                                   ; preds = %._crit_edge120.loopexit, %ToUpperCase.exit
  %.283.lcssa = phi i32 [ %.182.lcssa, %ToUpperCase.exit ], [ %i.jf, %._crit_edge120.loopexit ]
  ret i32 %.283.lcssa
}
...
bb.a:
  ...
  %i.e = load i8, ptr %0, align 1, !tbaa !17      ; 7 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.i = add i8 %i.e, %i.h
  %i.j = and i8 %i.i, 127
  store i8 %i.j, ptr %0, align 1, !tbaa !17
  br label %bb.m
...
bb.f:                                             ; preds = %bb.e
  ...
  store i8 %i.y, ptr %0, align 1, !tbaa !17
  %i.z = and i8 %i.o, -64
  %i.aa = trunc i32 %i.u to i8
  %i.ab = and i8 %i.aa, 63
  %i.ac = or disjoint i8 %i.ab, %i.z
  store i8 %i.ac, ptr %i.n, align 1, !tbaa !17
  br label %bb.m
...
attributes #1 = { nofree norecurse nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!8 = !{!"Simple C/C++ TBAA"}
!9 = !{!10, !12, i64 8}
!10 = !{!"BrotliTransforms", !11, i64 0, !12, i64 8, !14, i64 16, !6, i64 24, !12, i64 32, !12, i64 40, !7, i64 48}
!11 = !{!"short", !7, i64 0}
