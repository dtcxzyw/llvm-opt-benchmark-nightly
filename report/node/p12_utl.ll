...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i8>, ptr %i.t, align 1, !tbaa !9
  %wide.load42 = load <8 x i8>, ptr %i.u, align 1, !tbaa !9
  ...
  br i1 %i.v, label %middle.block, label %vector.body, !llvm.loop !10
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  store <8 x i8> %interleaved.vec48, ptr %i.y, align 1, !tbaa !9
  %index.next49 = add nuw i64 %index46, 4         ; 2 uses
  %i.ab = icmp eq i64 %index.next49, %n.vec45
  br i1 %i.ab, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !15
...
.lr.ph.preheader:                                 ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.ph = phi i64 [ 0, %iter.check ], [ %i.n, %vec.epilog.iter.check ], [ %i.w, %vec.epilog.middle.block ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph ], [ %indvars.iv.ph, %.lr.ph.preheader ] ; 3 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %i.h, i64 %indvars.iv ; 2 uses
  store i8 0, ptr %i.ac, align 1, !tbaa !9
  %i.ad = lshr exact i64 %indvars.iv, 1
  ...
  %i.ah = icmp samesign ult i64 %indvars.iv.next, %i.j
  br i1 %i.ah, label %.lr.ph, label %._crit_edge, !llvm.loop !16
...
._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %vec.epilog.middle.block, %.preheader
  ...
  %i.ai = getelementptr inbounds nuw i8, ptr %i.h, i64 %.pre-phi ; 2 uses
  store i8 0, ptr %i.ai, align 1, !tbaa !9
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 1
  store i8 0, ptr %i.aj, align 1, !tbaa !9
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x i8> %i.cd, ptr %i.cf, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.cg = icmp eq i64 %index.next, %n.vec
  br i1 %i.cg, label %vec.epilog.iter.check, label %vector.body, !llvm.loop !20
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %i.ch = icmp eq i64 %n.mod.vf30, 0
  %i.ci = select i1 %i.ch, i64 8, i64 %n.mod.vf30
  %n.vec31 = sub i64 %i.o, %i.ci                  ; 2 uses
  %i.cj = shl i64 %n.vec31, 1
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index32 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next33, %vec.epilog.vector.body ] ; 3 uses
  %i.ck = shl i64 %index32, 1                     ; 8 uses
  %2 = getelementptr inbounds nuw i8, ptr %i.h, i64 %i.ck
  %3 = getelementptr i8, ptr %i.h, i64 %i.ck
  %4 = getelementptr i8, ptr %3, i64 2
  %5 = getelementptr i8, ptr %i.h, i64 %i.ck
  %6 = getelementptr i8, ptr %5, i64 4
  %7 = getelementptr i8, ptr %i.h, i64 %i.ck
  %8 = getelementptr i8, ptr %7, i64 6
  %9 = getelementptr i8, ptr %i.h, i64 %i.ck
  %i.cl = getelementptr i8, ptr %9, i64 8
  %i.cm = getelementptr i8, ptr %i.h, i64 %i.ck
  %i.cn = getelementptr i8, ptr %i.cm, i64 10
  %i.co = getelementptr i8, ptr %i.h, i64 %i.ck
  %i.cp = getelementptr i8, ptr %i.co, i64 12
  %i.cq = getelementptr i8, ptr %i.h, i64 %i.ck
  %i.cr = getelementptr i8, ptr %i.cq, i64 14
  ...
  %i.cs = load i8, ptr %i.cl, align 1, !tbaa !9
  %i.ct = load i8, ptr %i.cn, align 1, !tbaa !9
  %i.cu = load i8, ptr %i.cp, align 1, !tbaa !9
  %i.cv = load i8, ptr %i.cr, align 1, !tbaa !9
  %14 = insertelement <8 x i8> poison, i8 %10, i64 0
  %15 = insertelement <8 x i8> %14, i8 %11, i64 1
  %16 = insertelement <8 x i8> %15, i8 %12, i64 2
  %17 = insertelement <8 x i8> %16, i8 %13, i64 3
  %18 = insertelement <8 x i8> %17, i8 %i.cs, i64 4
  %19 = insertelement <8 x i8> %18, i8 %i.ct, i64 5
  %20 = insertelement <8 x i8> %19, i8 %i.cu, i64 6
  %21 = insertelement <8 x i8> %20, i8 %i.cv, i64 7
  %i.cw = and i64 %index32, 9223372036854775807
  %i.cx = getelementptr inbounds nuw i8, ptr %i.j, i64 %i.cw
  store <8 x i8> %21, ptr %i.cx, align 1, !tbaa !9
  %index.next33 = add nuw i64 %index32, 8         ; 2 uses
  %i.cy = icmp eq i64 %index.next33, %n.vec31
  br i1 %i.cy, label %.lr.ph.preheader, label %vec.epilog.vector.body, !llvm.loop !22

.lr.ph.preheader:                                 ; preds = %vec.epilog.vector.body, %iter.check, %vec.epilog.iter.check
  %indvars.iv.ph = phi i64 [ 0, %iter.check ], [ %i.r, %vec.epilog.iter.check ], [ %i.cj, %vec.epilog.vector.body ]
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph ], [ %indvars.iv.ph, %.lr.ph.preheader ] ; 3 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %i.h, i64 %indvars.iv
  %i.da = load i8, ptr %i.cz, align 1, !tbaa !9
  %i.db = lshr exact i64 %indvars.iv, 1
  %i.dc = getelementptr inbounds nuw i8, ptr %i.j, i64 %i.db
  store i8 %i.da, ptr %i.dc, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %i.dd = icmp samesign ult i64 %indvars.iv.next, %i.l
  br i1 %i.dd, label %.lr.ph, label %._crit_edge, !llvm.loop !23

._crit_edge:                                      ; preds = %.lr.ph, %.preheader
  %i.de = zext nneg i32 %.020 to i64
  %i.df = getelementptr i8, ptr %i.j, i64 %i.de
  %i.dg = getelementptr i8, ptr %i.df, i64 -1
  store i8 0, ptr %i.dg, align 1, !tbaa !9
  br label %bb.f
...
.lr.ph:                                           ; preds = %bb.c, %bb.h
  ...
  %.05164 = phi i32 [ %i.at, %bb.h ], [ 0, %bb.c ] ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i8>, ptr %i.z, align 1, !tbaa !9
  %wide.load91 = load <8 x i8>, ptr %i.aa, align 1, !tbaa !9
  %interleaved.vec = shufflevector <8 x i8> zeroinitializer, <8 x i8> %wide.load, <16 x i32> <i32 0, i32 8, i32 1, i32 9, i32 2, i32 10, i32 3, i32 11, i32 4, i32 12, i32 5, i32 13, i32 6, i32 14, i32 7, i32 15>
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  store <8 x i8> %interleaved.vec97, ptr %i.ae, align 1, !tbaa !9
  %index.next98 = add nuw i64 %index95, 4         ; 2 uses
  %i.ah = icmp eq i64 %index.next98, %n.vec94
...
.lr.ph.i.preheader:                               ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.i.ph = phi i64 [ 0, %iter.check ], [ %i.t, %vec.epilog.iter.check ], [ %i.ac, %vec.epilog.middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %.lr.ph.i ], [ %indvars.iv.i.ph, %.lr.ph.i.preheader ] ; 3 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %i.n, i64 %indvars.iv.i ; 2 uses
  store i8 0, ptr %i.ai, align 1, !tbaa !9
  %i.aj = lshr exact i64 %indvars.iv.i, 1
  ...
  %i.an = icmp samesign ult i64 %indvars.iv.next.i, %i.p
  br i1 %i.an, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !28

._crit_edge.i:                                    ; preds = %.lr.ph.i, %vec.epilog.middle.block, %middle.block
  %i.ao = getelementptr inbounds nuw i8, ptr %i.n, i64 %i.p ; 2 uses
  store i8 0, ptr %i.ao, align 1, !tbaa !9
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ao, i64 1
  store i8 0, ptr %i.ap, align 1, !tbaa !9
...
bb.g:                                             ; preds = %.lr.ph
  %i.aq = load i64, ptr %i.a, align 8, !tbaa !24  ; 2 uses
  %i.ar = icmp ugt i64 %i.aq, 1114111
  br i1 %i.ar, label %OPENSSL_asc2uni.exit, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.as = icmp samesign ugt i64 %i.aq, 65535
  %.1.v = select i1 %i.as, i32 4, i32 2
  %.1 = add nuw nsw i32 %.1.v, %.04865            ; 2 uses
  %i.at = add nuw nsw i32 %i.i, %.05164           ; 2 uses
  %i.au = icmp slt i32 %i.at, %.047
  br i1 %i.au, label %.lr.ph, label %._crit_edge, !llvm.loop !29

._crit_edge:                                      ; preds = %bb.h
  %i.av = add nuw nsw i32 %.1, 2                  ; 2 uses
  %i.aw = zext nneg i32 %i.av to i64
  %i.ax = call noalias ptr @CRYPTO_malloc(i64 noundef %i.aw, ptr noundef nonnull @.str, i32 noundef 120) #6 ; 3 uses
  %i.ay = icmp eq ptr %i.ax, null
  br i1 %i.ay, label %OPENSSL_asc2uni.exit, label %.lr.ph68

._crit_edge.thread:                               ; preds = %bb.c
  %i.az = tail call noalias ptr @CRYPTO_malloc(i64 noundef 2, ptr noundef nonnull @.str, i32 noundef 120) #6 ; 3 uses
  %i.ba = icmp eq ptr %i.az, null
  br i1 %i.ba, label %OPENSSL_asc2uni.exit, label %._crit_edge69

.lr.ph68:                                         ; preds = %._crit_edge, %bb.k
  %.04967 = phi ptr [ %.150, %bb.k ], [ %i.ax, %._crit_edge ] ; 7 uses
  %.15266 = phi i32 [ %i.ca, %bb.k ], [ 0, %._crit_edge ] ; 3 uses
  %i.bb = sext i32 %.15266 to i64
  %i.bc = getelementptr inbounds i8, ptr %0, i64 %i.bb
  %i.bd = sub nsw i32 %.047, %.15266
  %i.be = call i32 @UTF8_getc(ptr noundef %i.bc, i32 noundef %i.bd, ptr noundef nonnull %i.a) #6
  %i.bf = load i64, ptr %i.a, align 8, !tbaa !24  ; 5 uses
  %i.bg = icmp ugt i64 %i.bf, 65535
  br i1 %i.bg, label %bb.i, label %bb.j

bb.i:                                             ; preds = %.lr.ph68
  %i.bh = add i64 %i.bf, -65536                   ; 2 uses
  store i64 %i.bh, ptr %i.a, align 8, !tbaa !24
  %i.bi = lshr i64 %i.bh, 10                      ; 2 uses
  %i.bj = trunc i64 %i.bi to i16
  %i.bk = add i16 %i.bj, -10240
  %i.bl = lshr i16 %i.bk, 8
  %i.bm = trunc nuw i16 %i.bl to i8
  store i8 %i.bm, ptr %.04967, align 1, !tbaa !9
  %i.bn = getelementptr inbounds nuw i8, ptr %.04967, i64 2
  %i.bo = lshr i64 %i.bf, 8
  %i.bp = trunc i64 %i.bo to i8
  %i.bq = and i8 %i.bp, 3
  %i.br = or disjoint i8 %i.bq, -36
  %i.bs = getelementptr inbounds nuw i8, ptr %.04967, i64 3
  store i8 %i.br, ptr %i.bn, align 1, !tbaa !9
  %i.bt = trunc i64 %i.bf to i8
  %i.bu = getelementptr inbounds nuw i8, ptr %.04967, i64 4
  store i8 %i.bt, ptr %i.bs, align 1, !tbaa !9
  br label %bb.k

bb.j:                                             ; preds = %.lr.ph68
  %i.bv = lshr i64 %i.bf, 8
  %i.bw = trunc nuw i64 %i.bv to i8
  store i8 %i.bw, ptr %.04967, align 1, !tbaa !9
  %i.bx = load i64, ptr %i.a, align 8, !tbaa !24
  %i.by = getelementptr inbounds nuw i8, ptr %.04967, i64 2
  br label %bb.k

bb.k:                                             ; preds = %bb.i, %bb.j
  %.sink.in = phi i64 [ %i.bi, %bb.i ], [ %i.bx, %bb.j ]
  %.150 = phi ptr [ %i.bu, %bb.i ], [ %i.by, %bb.j ] ; 2 uses
  %.sink = trunc i64 %.sink.in to i8
  %i.bz = getelementptr inbounds nuw i8, ptr %.04967, i64 1
  store i8 %.sink, ptr %i.bz, align 1, !tbaa !9
  %i.ca = add nsw i32 %i.be, %.15266              ; 2 uses
  %i.cb = icmp slt i32 %i.ca, %.047
  br i1 %i.cb, label %.lr.ph68, label %._crit_edge69, !llvm.loop !30

._crit_edge69:                                    ; preds = %bb.k, %._crit_edge.thread
  %.048.lcssa8688 = phi i32 [ 2, %._crit_edge.thread ], [ %i.av, %bb.k ]
  %i.cc = phi ptr [ %i.az, %._crit_edge.thread ], [ %i.ax, %bb.k ] ; 2 uses
  %.049.lcssa = phi ptr [ %i.az, %._crit_edge.thread ], [ %.150, %bb.k ] ; 2 uses
  %i.cd = getelementptr inbounds nuw i8, ptr %.049.lcssa, i64 1
  store i8 0, ptr %.049.lcssa, align 1, !tbaa !9
  store i8 0, ptr %i.cd, align 1, !tbaa !9
  %.not = icmp eq ptr %3, null
...
OPENSSL_asc2uni.exit.sink.split:                  ; preds = %bb.m, %bb.f
  %.sink89 = phi ptr [ %i.n, %bb.f ], [ %i.cc, %bb.m ] ; 2 uses
...
OPENSSL_asc2uni.exit:                             ; preds = %bb.g, %OPENSSL_asc2uni.exit.sink.split, %._crit_edge.thread, %bb.f, %bb.d, %bb.m, %._crit_edge
  %.0 = phi ptr [ %i.cc, %bb.m ], [ null, %._crit_edge ], [ %i.n, %bb.f ], [ %.sink89, %OPENSSL_asc2uni.exit.sink.split ], [ null, %bb.d ], [ null, %._crit_edge.thread ], [ null, %bb.g ]
...
.lr.ph:                                           ; preds = %.preheader87, %bb.g
  ...
  %.04690 = phi i32 [ %i.eo, %bb.g ], [ 0, %.preheader87 ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.dl = and i64 %index, 9223372036854775792
  %i.dm = getelementptr inbounds nuw i8, ptr %i.ar, i64 %i.dl
  store <16 x i8> %i.dk, ptr %i.dm, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.dn = icmp eq i64 %index.next, %n.vec
  br i1 %i.dn, label %vec.epilog.iter.check, label %vector.body, !llvm.loop !31
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %i.do = icmp eq i64 %n.mod.vf107, 0
  %i.dp = select i1 %i.do, i64 8, i64 %n.mod.vf107
  %n.vec108 = sub nsw i64 %i.av, %i.dp            ; 2 uses
  %i.dq = shl nsw i64 %n.vec108, 1
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index109 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next110, %vec.epilog.vector.body ] ; 3 uses
  %i.dr = shl i64 %index109, 1                    ; 8 uses
  %2 = getelementptr inbounds nuw i8, ptr %i.as, i64 %i.dr
  %3 = getelementptr i8, ptr %i.as, i64 %i.dr
  %4 = getelementptr i8, ptr %3, i64 2
  %5 = getelementptr i8, ptr %i.as, i64 %i.dr
  %6 = getelementptr i8, ptr %5, i64 4
  %7 = getelementptr i8, ptr %i.as, i64 %i.dr
  %8 = getelementptr i8, ptr %7, i64 6
  %9 = getelementptr i8, ptr %i.as, i64 %i.dr
  %i.ds = getelementptr i8, ptr %9, i64 8
  %i.dt = getelementptr i8, ptr %i.as, i64 %i.dr
  %i.du = getelementptr i8, ptr %i.dt, i64 10
  %i.dv = getelementptr i8, ptr %i.as, i64 %i.dr
  %i.dw = getelementptr i8, ptr %i.dv, i64 12
  %i.dx = getelementptr i8, ptr %i.as, i64 %i.dr
  %i.dy = getelementptr i8, ptr %i.dx, i64 14
  %10 = load i8, ptr %2, align 1, !tbaa !9
  %11 = load i8, ptr %4, align 1, !tbaa !9
  %12 = load i8, ptr %6, align 1, !tbaa !9
  %13 = load i8, ptr %8, align 1, !tbaa !9
  %i.dz = load i8, ptr %i.ds, align 1, !tbaa !9
  %i.ea = load i8, ptr %i.du, align 1, !tbaa !9
  %i.eb = load i8, ptr %i.dw, align 1, !tbaa !9
  %i.ec = load i8, ptr %i.dy, align 1, !tbaa !9
  %14 = insertelement <8 x i8> poison, i8 %10, i64 0
  %15 = insertelement <8 x i8> %14, i8 %11, i64 1
  %16 = insertelement <8 x i8> %15, i8 %12, i64 2
  %17 = insertelement <8 x i8> %16, i8 %13, i64 3
  %18 = insertelement <8 x i8> %17, i8 %i.dz, i64 4
  %19 = insertelement <8 x i8> %18, i8 %i.ea, i64 5
  %20 = insertelement <8 x i8> %19, i8 %i.eb, i64 6
  %21 = insertelement <8 x i8> %20, i8 %i.ec, i64 7
  %i.ed = and i64 %index109, 9223372036854775807
  %i.ee = getelementptr inbounds nuw i8, ptr %i.ar, i64 %i.ed
  store <8 x i8> %21, ptr %i.ee, align 1, !tbaa !9
  %index.next110 = add nuw i64 %index109, 8       ; 2 uses
  %i.ef = icmp eq i64 %index.next110, %n.vec108
  br i1 %i.ef, label %.lr.ph.i.preheader, label %vec.epilog.vector.body, !llvm.loop !32
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %.lr.ph.i ], [ %indvars.iv.i.ph, %.lr.ph.i.preheader ] ; 3 uses
  %i.eg = getelementptr inbounds nuw i8, ptr %i.as, i64 %indvars.iv.i
  %i.eh = load i8, ptr %i.eg, align 1, !tbaa !9
  %i.ei = lshr exact i64 %indvars.iv.i, 1
  %i.ej = getelementptr inbounds nuw i8, ptr %i.ar, i64 %i.ei
  store i8 %i.eh, ptr %i.ej, align 1, !tbaa !9
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 2 ; 2 uses
  %i.ek = icmp samesign ult i64 %indvars.iv.next.i, %i.af
  br i1 %i.ek, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !33

._crit_edge.i:                                    ; preds = %.lr.ph.i
  %i.el = getelementptr i8, ptr %i.ar, i64 %i.aq
  %i.em = getelementptr i8, ptr %i.el, i64 -1
  store i8 0, ptr %i.em, align 1, !tbaa !9
  br label %OPENSSL_uni2asc.exit

bb.g:                                             ; preds = %bmp_to_utf8.exit
  %i.en = icmp eq i32 %.fr86, 4
  %spec.select.v = select i1 %i.en, i32 4, i32 2
  %spec.select = add nuw nsw i32 %spec.select.v, %.04591 ; 2 uses
  %i.eo = add nuw nsw i32 %.fr86, %.04690         ; 2 uses
  %i.ep = icmp slt i32 %spec.select, %1
  br i1 %i.ep, label %.lr.ph, label %._crit_edge, !llvm.loop !34

._crit_edge:                                      ; preds = %bb.g, %.preheader87
  %.046.lcssa = phi i32 [ 0, %.preheader87 ], [ %i.eo, %bb.g ] ; 2 uses
  %.not54 = icmp eq i32 %1, 0                     ; 2 uses
  br i1 %.not54, label %bb.j, label %bb.h

bb.h:                                             ; preds = %._crit_edge
  %i.eq = sext i32 %1 to i64
  %i.er = getelementptr i8, ptr %0, i64 %i.eq     ; 2 uses
  %i.es = getelementptr i8, ptr %i.er, i64 -2
  %i.et = load i8, ptr %i.es, align 1, !tbaa !9
  %.not55 = icmp eq i8 %i.et, 0
  br i1 %.not55, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  %i.eu = getelementptr i8, ptr %i.er, i64 -1
  %i.ev = load i8, ptr %i.eu, align 1, !tbaa !9
  %.not56 = icmp eq i8 %i.ev, 0
  br i1 %.not56, label %bb.k, label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h, %._crit_edge
  %i.ew = add nuw nsw i32 %.046.lcssa, 1
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %bb.i
  %.147 = phi i32 [ %i.ew, %bb.j ], [ %.046.lcssa, %bb.i ]
  %i.ex = zext nneg i32 %.147 to i64
  %i.ey = tail call noalias ptr @CRYPTO_malloc(i64 noundef %i.ex, ptr noundef nonnull @.str, i32 noundef 210) #6 ; 6 uses
  %i.ez = icmp eq ptr %i.ey, null
  br i1 %i.ez, label %OPENSSL_uni2asc.exit, label %.preheader
...
.lr.ph94:                                         ; preds = %.preheader, %bb.p
  ...
  %.24892 = phi i32 [ %i.gf, %bb.p ], [ 0, %.preheader ] ; 2 uses
  %i.fa = zext nneg i32 %.24892 to i64
  %i.fb = getelementptr inbounds nuw i8, ptr %i.ey, i64 %i.fa
  %i.fc = zext nneg i32 %.293 to i64
  %i.fd = getelementptr inbounds nuw i8, ptr %0, i64 %i.fc ; 4 uses
  %i.fe = sub nsw i32 %1, %.293                   ; 3 uses
  %i.ff = icmp slt i32 %i.fe, 2
  br i1 %i.ff, label %bmp_to_utf8.exit64.thread, label %bb.l

bb.l:                                             ; preds = %.lr.ph94
  %i.fg = load i8, ptr %i.fd, align 1, !tbaa !9   ; 2 uses
  %i.fh = zext i8 %i.fg to i64
  %i.fi = shl nuw nsw i64 %i.fh, 8
  %i.fj = getelementptr inbounds nuw i8, ptr %i.fd, i64 1
  %i.fk = load i8, ptr %i.fj, align 1, !tbaa !9
  %i.fl = zext i8 %i.fk to i64
  %i.fm = or disjoint i64 %i.fi, %i.fl            ; 2 uses
  %i.fn = and i8 %i.fg, -8
  %or.cond.i59 = icmp eq i8 %i.fn, -40
  br i1 %or.cond.i59, label %bb.m, label %bmp_to_utf8.exit64

bb.m:                                             ; preds = %bb.l
  %i.fo = icmp samesign ult i32 %i.fe, 4
  br i1 %i.fo, label %bmp_to_utf8.exit64.thread, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.fp = getelementptr inbounds nuw i8, ptr %i.fd, i64 2
  %i.fq = load i8, ptr %i.fp, align 1, !tbaa !9   ; 2 uses
  %i.fr = add i8 %i.fq, 32
  %or.cond3.i62 = icmp ult i8 %i.fr, -4
  br i1 %or.cond3.i62, label %bmp_to_utf8.exit64.thread, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.fs = shl nuw nsw i64 %i.fm, 10
  %i.ft = zext i8 %i.fq to i64
  %i.fu = shl nuw nsw i64 %i.ft, 8
  %i.fv = getelementptr inbounds nuw i8, ptr %i.fd, i64 3
  %i.fw = load i8, ptr %i.fv, align 1, !tbaa !9
  %i.fx = zext i8 %i.fw to i64
  %.masked.i63 = and i64 %i.fu, 768
  %i.fy = or disjoint i64 %.masked.i63, %i.fx
  %i.fz = add nsw i64 %i.fs, -56557568
  %i.ga = or disjoint i64 %i.fy, %i.fz
  br label %bmp_to_utf8.exit64

bmp_to_utf8.exit64:                               ; preds = %bb.l, %bb.o
  %.126.i60 = phi i64 [ %i.ga, %bb.o ], [ %i.fm, %bb.l ]
  %i.gb = tail call i32 @llvm.umin.i32(i32 %i.fe, i32 4)
  %i.gc = tail call i32 @UTF8_putc(ptr noundef nonnull %i.fb, i32 noundef %i.gb, i64 noundef %.126.i60) #6
  %.fr = freeze i32 %i.gc                         ; 3 uses
  %i.gd = icmp slt i32 %.fr, 0
  br i1 %i.gd, label %bmp_to_utf8.exit64.thread, label %bb.p

bmp_to_utf8.exit64.thread:                        ; preds = %bb.m, %bb.n, %.lr.ph94, %bmp_to_utf8.exit64
  tail call void @CRYPTO_free(ptr noundef nonnull %i.ey, ptr noundef nonnull @.str, i32 noundef 218) #6
  br label %OPENSSL_uni2asc.exit

bb.p:                                             ; preds = %bmp_to_utf8.exit64
  %i.ge = icmp eq i32 %.fr, 4
  %spec.select85.v = select i1 %i.ge, i32 4, i32 2
  %spec.select85 = add nuw nsw i32 %spec.select85.v, %.293 ; 2 uses
  %i.gf = add nuw nsw i32 %.fr, %.24892           ; 2 uses
  %i.gg = icmp slt i32 %spec.select85, %1
  br i1 %i.gg, label %.lr.ph94, label %._crit_edge95.loopexit, !llvm.loop !35
...
OPENSSL_uni2asc.exit:                             ; preds = %.thread83, %._crit_edge.i, %.thread, %bb.r, %bb.s, %bb.k, %bb.a, %bmp_to_utf8.exit64.thread
  %.0 = phi ptr [ null, %bb.k ], [ %i.ey, %bb.r ], [ null, %bb.a ], [ null, %bmp_to_utf8.exit64.thread ], [ %i.ey, %bb.s ], [ %i.ar, %._crit_edge.i ], [ null, %.thread83 ], [ null, %.thread ]
  ret ptr %.0
}
...
; Function Attrs: nounwind uwtable
define dso_local ptr @d2i_PKCS12_fp(ptr noundef %0, ptr noundef %1) local_unnamed_addr #0 {
bb.a:
  %.not = icmp eq ptr %1, null
  br i1 %.not, label %bb.d, label %bb.b
