...
bb.j:                                             ; preds = %bb.h, %bb.g
  ...
  %i.ao = tail call i32 @udata_readInt32_78(ptr noundef %0, i32 noundef %i.an) #14 ; 3 uses
...
begin_hunk_1_@usprep_swap_78:bb.a
  ...
  %i.ci = add i32 %i.ao, %i.ar
  %i.cj = add i32 %i.ci, 64                       ; 3 uses
