...
begin_hunk_0_@"_ZN4node13CallbackQueueIvJPNS_11EnvironmentEEE12CallbackImplIZZNS_6worker6Worker17GetHeapStatisticsERKN2v820FunctionCallbackInfoINS7_5ValueEEEEN3$_0clES2_EUlS2_E_E4CallES2_":bb.a
  ...
  %7 = shufflevector <2 x ptr> %i.ec, <2 x ptr> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.ed = insertelement <8 x ptr> %7, ptr %i.eb, i64 2
  %i.ee = insertelement <8 x ptr> %i.ed, ptr %i.bf, i64 3
  %i.ef = insertelement <8 x ptr> %i.ee, ptr %i.bm, i64 4
  %i.eg = insertelement <8 x ptr> %i.ef, ptr %i.bt, i64 5
  %i.eh = insertelement <8 x ptr> %i.eg, ptr %i.ca, i64 6
  %8 = insertelement <8 x ptr> %i.eh, ptr %i.ch, i64 7
  %.fr = freeze <8 x ptr> %8
