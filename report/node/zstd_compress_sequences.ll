Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/node/original/zstd_compress_sequences?download=true
...
bb.a:
  %.val.i = load i16, ptr %0, align 1, !tbaa !14  ; 2 uses
  ...
  %.val = load i16, ptr %i.g, align 1, !tbaa !14
...
bb.b:                                             ; preds = %bb.b, %.new
  ...
  %i.e = load i16, ptr %i.d, align 2, !tbaa !14   ; 2 uses
  ...
  %i.p = load i16, ptr %i.o, align 2, !tbaa !14   ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  %i.g = load i32, ptr %0, align 4, !tbaa !17
...
bb.t:                                             ; preds = %bb.t, %ZSTD_NCountCost.exit.new
  ...
  %i.cx = load i32, ptr %i.cw, align 4, !tbaa !17 ; 3 uses
  %i.cy = shl i32 %i.cx, 8
  ...
  br i1 %niter99.ncmp.1, label %ZSTD_entropyCost.exit.unr-lcssa, label %bb.t, !llvm.loop !26
...
.epil.preheader93:                                ; preds = %ZSTD_entropyCost.exit.unr-lcssa, %ZSTD_NCountCost.exit
  ...
  %i.dw = load i32, ptr %i.dv, align 4, !tbaa !17 ; 3 uses
  %i.dx = shl i32 %i.dw, 8
...
bb.d:                                             ; preds = %bb.c
  %i.e = load i8, ptr %7, align 1, !tbaa !19
  store i8 %i.e, ptr %0, align 1, !tbaa !19
  br label %bb.l
...
bb.h:                                             ; preds = %bb.g
  %i.p = add i32 %i.n, -1
  store i32 %i.p, ptr %i.m, align 4, !tbaa !17
  %i.q = add i64 %8, -1
  br label %bb.i
...
bb.d:                                             ; preds = %bb.c
  ...
  %.val.i.i.i = load i16, ptr %2, align 1, !tbaa !14 ; 3 uses
  ...
  %.sroa.0.0.copyload.i.i = load i32, ptr %i.p, align 4, !tbaa !17
  %.sroa.4.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.p, i64 4
  %.sroa.4.0.copyload.i.i = load i32, ptr %.sroa.4.0..sroa_idx.i.i, align 4, !tbaa !17 ; 2 uses
  ...
  %i.ac = load i8, ptr %i.ab, align 1, !tbaa !19  ; 4 uses
  %i.ad = zext i8 %i.ac to i32                    ; 3 uses
  %.val.i.i16.i = load i16, ptr %4, align 1, !tbaa !14 ; 3 uses
  ...
  %.sroa.0.0.copyload.i18.i = load i32, ptr %i.am, align 4, !tbaa !17
  %.sroa.4.0..sroa_idx.i19.i = getelementptr inbounds nuw i8, ptr %i.am, i64 4
  %.sroa.4.0.copyload.i20.i = load i32, ptr %.sroa.4.0..sroa_idx.i19.i, align 4, !tbaa !17 ; 2 uses
  ...
  %.val.i.i21.i = load i16, ptr %6, align 1, !tbaa !14 ; 3 uses
  ...
  %.sroa.0.0.copyload.i23.i = load i32, ptr %i.bi, align 4, !tbaa !17
  %.sroa.4.0..sroa_idx.i24.i = getelementptr inbounds nuw i8, ptr %i.bi, i64 4
  %.sroa.4.0.copyload.i25.i = load i32, ptr %.sroa.4.0..sroa_idx.i24.i, align 4, !tbaa !17 ; 2 uses
  ...
  %i.bw = load i16, ptr %i.bv, align 4, !tbaa !21
  ...
  %i.ce = load i16, ptr %i.cd, align 2, !tbaa !22
...
..thread_crit_edge.i:                             ; preds = %bb.e
  %.pre.i = load i32, ptr %i.bu, align 4, !tbaa !23
  br label %.thread.i

bb.f:                                             ; preds = %bb.e
  %.not93.i.i = icmp eq i8 %i.ac, 56
  %.pre158.i = load i32, ptr %i.bu, align 4, !tbaa !23 ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  store i64 %i.cs, ptr %0, align 1, !tbaa !25
...
bb.h:                                             ; preds = %bb.d
  %i.dl = load i32, ptr %i.bu, align 4, !tbaa !23
...
.lr.ph.i:                                         ; preds = %bb.r, %.lr.ph.preheader.i
  ...
  %i.ed = load i8, ptr %i.ec, align 1, !tbaa !19  ; 4 uses
  ...
  %.sroa.0.0.copyload.i27.i = load i32, ptr %i.eq, align 4, !tbaa !17
  %.sroa.4.0..sroa_idx.i28.i = getelementptr inbounds nuw i8, ptr %i.eq, i64 4
  %.sroa.4.0.copyload.i29.i = load i32, ptr %.sroa.4.0..sroa_idx.i28.i, align 4, !tbaa !17
  ...
  %.sroa.0.0.copyload.i30.i = load i32, ptr %i.ff, align 4, !tbaa !17
  %.sroa.4.0..sroa_idx.i31.i = getelementptr inbounds nuw i8, ptr %i.ff, i64 4
  %.sroa.4.0.copyload.i32.i = load i32, ptr %.sroa.4.0..sroa_idx.i31.i, align 4, !tbaa !17
  ...
  %i.ft = load i16, ptr %i.fs, align 2, !tbaa !14
  %i.fu = getelementptr inbounds nuw [8 x i8], ptr %i.bg, i64 %i.eg ; 2 uses
  %.sroa.0.0.copyload.i33.i = load i32, ptr %i.fu, align 4, !tbaa !17
  %.sroa.4.0..sroa_idx.i34.i = getelementptr inbounds nuw i8, ptr %i.fu, i64 4
  %.sroa.4.0.copyload.i35.i = load i32, ptr %.sroa.4.0..sroa_idx.i34.i, align 4, !tbaa !17
  ...
  %i.gl = load i16, ptr %i.gk, align 2, !tbaa !14
...
bb.j:                                             ; preds = %.lr.ph.i
  ...
  store i64 %i.gf, ptr %.sroa.112.2143.i, align 1, !tbaa !25
...
bb.k:                                             ; preds = %bb.j, %.lr.ph.i
  ...
  %i.gy = load i16, ptr %i.gx, align 4, !tbaa !21
  ...
  %i.hh = load i16, ptr %i.hg, align 2, !tbaa !22
...
bb.l:                                             ; preds = %bb.k
  ...
  store i64 %i.hn, ptr %.sroa.112.3.i, align 1, !tbaa !25
...
..thread133_crit_edge.i:                          ; preds = %bb.n
  %.pre159.i = load i32, ptr %i.gw, align 4, !tbaa !23
  br label %.thread133.i

bb.o:                                             ; preds = %bb.n
  %.not94.i.i = icmp eq i8 %i.ed, 56
  %.pre160.i = load i32, ptr %i.gw, align 4, !tbaa !23 ; 3 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  store i64 %i.id, ptr %.sroa.112.4.i, align 1, !tbaa !25
...
bb.q:                                             ; preds = %bb.m
  %i.iw = load i32, ptr %i.gw, align 4, !tbaa !23
...
._crit_edge.i:                                    ; preds = %bb.r, %bb.i
  ...
  store i64 %i.jp, ptr %.sroa.112.2.lcssa.i, align 1, !tbaa !25
  ...
  store i64 %i.kc, ptr %spec.store.select.i.i.i, align 1, !tbaa !25
  ...
  store i64 %i.kp, ptr %spec.store.select.i.i40.i, align 1, !tbaa !25
  ...
  store i64 %i.la, ptr %spec.store.select.i.i41.i, align 1, !tbaa !25
...
bb.b:                                             ; preds = %bb.a
  ...
  %.val.i.i = load i16, ptr %2, align 1, !tbaa !14 ; 3 uses
  ...
  %.sroa.0.0.copyload.i = load i32, ptr %i.o, align 4, !tbaa !17
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.o, i64 4
  %.sroa.4.0.copyload.i = load i32, ptr %.sroa.4.0..sroa_idx.i, align 4, !tbaa !17 ; 2 uses
  ...
  %i.z = load i16, ptr %i.y, align 2, !tbaa !14
  %i.aa = getelementptr inbounds nuw i8, ptr %5, i64 %i.d
  %i.ab = load i8, ptr %i.aa, align 1, !tbaa !19  ; 4 uses
  %i.ac = zext i8 %i.ab to i32                    ; 3 uses
  %.val.i.i16 = load i16, ptr %4, align 1, !tbaa !14 ; 3 uses
  ...
  %.sroa.0.0.copyload.i18 = load i32, ptr %i.al, align 4, !tbaa !17
  %.sroa.4.0..sroa_idx.i19 = getelementptr inbounds nuw i8, ptr %i.al, i64 4
  %.sroa.4.0.copyload.i20 = load i32, ptr %.sroa.4.0..sroa_idx.i19, align 4, !tbaa !17 ; 2 uses
  ...
  %.val.i.i21 = load i16, ptr %6, align 1, !tbaa !14 ; 3 uses
  ...
  %.sroa.0.0.copyload.i23 = load i32, ptr %i.bh, align 4, !tbaa !17
  %.sroa.4.0..sroa_idx.i24 = getelementptr inbounds nuw i8, ptr %i.bh, i64 4
  %.sroa.4.0.copyload.i25 = load i32, ptr %.sroa.4.0..sroa_idx.i24, align 4, !tbaa !17 ; 2 uses
  ...
  %i.bs = load i16, ptr %i.br, align 2, !tbaa !14
...
..thread_crit_edge:                               ; preds = %bb.c
  %.pre = load i32, ptr %i.bt, align 4, !tbaa !23
  br label %.thread

bb.d:                                             ; preds = %bb.c
  %.not93.i = icmp eq i8 %i.ab, 56
  %.pre158 = load i32, ptr %i.bt, align 4, !tbaa !23 ; 3 uses
...
bb.g:                                             ; preds = %bb.f, %.thread
  ...
  store i64 %.sroa.058.1, ptr %.sroa.112.1, align 1, !tbaa !25
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.p
  ...
  %i.ea = load i8, ptr %i.dz, align 1, !tbaa !19
  %i.eb = getelementptr inbounds nuw i8, ptr %5, i64 %.0.i144
  %i.ec = load i8, ptr %i.eb, align 1, !tbaa !19  ; 4 uses
  %i.ed = getelementptr inbounds nuw i8, ptr %3, i64 %.0.i144
  %i.ee = load i8, ptr %i.ed, align 1, !tbaa !19
  ...
  %i.em = load i8, ptr %i.el, align 1, !tbaa !19  ; 2 uses
  ...
  %.sroa.0.0.copyload.i27 = load i32, ptr %i.ep, align 4, !tbaa !17
  %.sroa.4.0..sroa_idx.i28 = getelementptr inbounds nuw i8, ptr %i.ep, i64 4
  %.sroa.4.0.copyload.i29 = load i32, ptr %.sroa.4.0..sroa_idx.i28, align 4, !tbaa !17
  ...
  %i.fd = load i16, ptr %i.fc, align 2, !tbaa !14
  %i.fe = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %i.ek ; 2 uses
  %.sroa.0.0.copyload.i30 = load i32, ptr %i.fe, align 4, !tbaa !17
  %.sroa.4.0..sroa_idx.i31 = getelementptr inbounds nuw i8, ptr %i.fe, i64 4
  %.sroa.4.0.copyload.i32 = load i32, ptr %.sroa.4.0..sroa_idx.i31, align 4, !tbaa !17
  ...
  %i.fs = load i16, ptr %i.fr, align 2, !tbaa !14
  %i.ft = getelementptr inbounds nuw [8 x i8], ptr %i.bf, i64 %i.ef ; 2 uses
  %.sroa.0.0.copyload.i33 = load i32, ptr %i.ft, align 4, !tbaa !17
  %.sroa.4.0..sroa_idx.i34 = getelementptr inbounds nuw i8, ptr %i.ft, i64 4
  %.sroa.4.0.copyload.i35 = load i32, ptr %.sroa.4.0..sroa_idx.i34, align 4, !tbaa !17
  ...
  %i.gk = load i16, ptr %i.gj, align 2, !tbaa !14
...
bb.h:                                             ; preds = %.lr.ph
  ...
  store i64 %i.ge, ptr %.sroa.112.2143, align 1, !tbaa !25
...
bb.j:                                             ; preds = %bb.i
  ...
  store i64 %i.hm, ptr %.sroa.112.3, align 1, !tbaa !25
...
..thread133_crit_edge:                            ; preds = %bb.l
  %.pre159 = load i32, ptr %i.gv, align 4, !tbaa !23
  br label %.thread133

bb.m:                                             ; preds = %bb.l
  %.not94.i = icmp eq i8 %i.ec, 56
  %.pre160 = load i32, ptr %i.gv, align 4, !tbaa !23 ; 3 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  store i64 %i.ic, ptr %.sroa.112.4, align 1, !tbaa !25
...
bb.p:                                             ; preds = %bb.o, %.thread133
  ...
  store i64 %.sroa.058.6, ptr %.sroa.112.6, align 1, !tbaa !25
...
._crit_edge:                                      ; preds = %bb.p, %bb.g
  ...
  store i64 %i.jo, ptr %.sroa.112.2.lcssa, align 1, !tbaa !25
  ...
  store i64 %i.kb, ptr %spec.store.select.i.i, align 1, !tbaa !25
  ...
  store i64 %i.ko, ptr %spec.store.select.i.i40, align 1, !tbaa !25
  ...
  store i64 %i.kz, ptr %spec.store.select.i.i41, align 1, !tbaa !25
...
attributes #4 = { nofree norecurse nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!19 = !{!9, !9, i64 0}
!20 = !{!"SeqDef_s", !10, i64 0, !13, i64 4, !13, i64 6}
!21 = !{!20, !13, i64 4}
!22 = !{!20, !13, i64 6}
!23 = !{!20, !10, i64 0}
!24 = !{!"long", !9, i64 0}
