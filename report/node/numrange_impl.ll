...
bb.w:                                             ; preds = %bb.q, %bb.u, %bb.v, %bb.r
  %.1149 = phi i32 [ %.0148, %bb.u ], [ %i.da, %bb.v ], [ %i.at, %bb.r ], [ %i.at, %bb.q ] ; 6 uses
...
bb.ab:                                            ; preds = %bb.aa, %_ZNK6icu_786number4impl24NumberRangeFormatterImpl22resolveModifierPluralsERKNS1_8ModifierES5_.exit
  %.0150 = phi i32 [ %i.de, %_ZNK6icu_786number4impl24NumberRangeFormatterImpl22resolveModifierPluralsERKNS1_8ModifierES5_.exit ], [ %i.fp, %bb.aa ] ; 4 uses
  %.0146 = phi i32 [ %i.dl, %_ZNK6icu_786number4impl24NumberRangeFormatterImpl22resolveModifierPluralsERKNS1_8ModifierES5_.exit ], [ %i.gc, %bb.aa ] ; 4 uses
...
bb.af:                                            ; preds = %bb.ab
  ...
  %i.ih = add nsw i32 %i.ig, %.0150               ; 2 uses
  ...
  %i.iu = add nsw i32 %i.it, %.0146
  br label %bb.ag

bb.ag:                                            ; preds = %bb.af, %_ZNK6icu_786number4impl24NumberRangeFormatterImpl22resolveModifierPluralsERKNS1_8ModifierES5_.exit161
  %.1151 = phi i32 [ %.0150, %_ZNK6icu_786number4impl24NumberRangeFormatterImpl22resolveModifierPluralsERKNS1_8ModifierES5_.exit161 ], [ %i.ih, %bb.af ] ; 4 uses
  %.1147 = phi i32 [ %.0146, %_ZNK6icu_786number4impl24NumberRangeFormatterImpl22resolveModifierPluralsERKNS1_8ModifierES5_.exit161 ], [ %i.iu, %bb.af ] ; 4 uses
...
bb.ak:                                            ; preds = %bb.ag
  ...
  %i.kz = add nsw i32 %i.ky, %.1151               ; 2 uses
  ...
  %i.lm = add nsw i32 %i.ll, %.1147
  br label %bb.al

bb.al:                                            ; preds = %bb.ak, %_ZNK6icu_786number4impl24NumberRangeFormatterImpl22resolveModifierPluralsERKNS1_8ModifierES5_.exit163
  %.pre-phi = phi i32 [ %i.ld, %bb.ak ], [ %i.jx, %_ZNK6icu_786number4impl24NumberRangeFormatterImpl22resolveModifierPluralsERKNS1_8ModifierES5_.exit163 ]
  %.2152 = phi i32 [ %i.kz, %bb.ak ], [ %.1151, %_ZNK6icu_786number4impl24NumberRangeFormatterImpl22resolveModifierPluralsERKNS1_8ModifierES5_.exit163 ]
  %.2 = phi i32 [ %i.lm, %bb.ak ], [ %.1147, %_ZNK6icu_786number4impl24NumberRangeFormatterImpl22resolveModifierPluralsERKNS1_8ModifierES5_.exit163 ]
  %i.ln = load i32, ptr %i.a, align 4
  call void @_ZN6icu_7831FormattedValueStringBuilderImpl14appendSpanInfoE14UFieldCategoryiiiR10UErrorCode(ptr noundef nonnull align 8 dereferenceable(300) %1, i32 noundef 4098, i32 noundef 0, i32 noundef %i.ln, i32 noundef %.2152, ptr noundef nonnull align 4 dereferenceable(4) %4) #11
  %i.lo = load i32, ptr %i.a, align 4
  %i.lp = add i32 %.pre-phi, %i.lo
  call void @_ZN6icu_7831FormattedValueStringBuilderImpl14appendSpanInfoE14UFieldCategoryiiiR10UErrorCode(ptr noundef nonnull align 8 dereferenceable(300) %1, i32 noundef 4098, i32 noundef 1, i32 noundef %i.lp, i32 noundef %.2, ptr noundef nonnull align 4 dereferenceable(4) %4) #11
