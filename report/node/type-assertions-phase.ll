...
.lr.ph.i.i:                                       ; preds = %.preheader.i.i, %.lr.ph.i.i
  %6 = phi i64 [ %i.cq, %.lr.ph.i.i ], [ 1, %.preheader.i.i ] ; 2 uses
  %.026.i.i = phi i64 [ %.1.i.i, %.lr.ph.i.i ], [ 0, %.preheader.i.i ] ; 2 uses
  %.01025.i.i.a = phi i64 [ %.111.i.i, %.lr.ph.i.i ], [ %i.cb, %.preheader.i.i ] ; 3 uses
  %7 = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.i.i19, i64 %6
  %8 = load i32, ptr %7, align 4
  %i.ci = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.i.i19, i64 %.026.i.i
  %i.cj = load i32, ptr %i.ci, align 4
  %i.ck = sub i32 %8, %i.cj
  %9 = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.i.i19, i64 %.01025.i.i.a
  %10 = load i32, ptr %9, align 4
  %i.cl = add i64 %.01025.i.i.a, -1               ; 2 uses
  %i.cm = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.i.i19, i64 %i.cl
  %i.cn = load i32, ptr %i.cm, align 4
  %i.co = sub i32 %10, %i.cn
  %i.cp = icmp ult i32 %i.ck, %i.co               ; 2 uses
  %.111.i.i = select i1 %i.cp, i64 %.01025.i.i.a, i64 %i.cl ; 3 uses
  %.1.i.i = select i1 %i.cp, i64 %6, i64 %.026.i.i ; 3 uses
...
bb.p:                                             ; preds = %_ZN2v88internal8compiler10turboshaft18WordOperationTyperILm32EE9MakeRangeERKNS2_8WordTypeILm32EEE.exit
  ...
  %.sroa.0.0.i.i22 = select i1 %i.cv, ptr %i.q, ptr %i.cw ; 8 uses
  ...
  %i.da = load i32, ptr %.sroa.0.0.i.i22, align 4 ; 3 uses
...
.lr.ph.i.i32:                                     ; preds = %.preheader.i.i23, %.lr.ph.i.i32
  %11 = phi i64 [ %i.dm, %.lr.ph.i.i32 ], [ 1, %.preheader.i.i23 ] ; 2 uses
  %.026.i.i33 = phi i64 [ %.1.i.i36, %.lr.ph.i.i32 ], [ 0, %.preheader.i.i23 ] ; 2 uses
  %.01025.i.i34.a = phi i64 [ %.111.i.i35, %.lr.ph.i.i32 ], [ %i.cx, %.preheader.i.i23 ] ; 3 uses
  %12 = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.i.i22, i64 %11
  %13 = load i32, ptr %12, align 4
  %i.de = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.i.i22, i64 %.026.i.i33
  %i.df = load i32, ptr %i.de, align 4
  %i.dg = sub i32 %13, %i.df
  %14 = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.i.i22, i64 %.01025.i.i34.a
  %15 = load i32, ptr %14, align 4
  %i.dh = add i64 %.01025.i.i34.a, -1             ; 2 uses
  %i.di = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.i.i22, i64 %i.dh
  %i.dj = load i32, ptr %i.di, align 4
  %i.dk = sub i32 %15, %i.dj
  %i.dl = icmp ult i32 %i.dg, %i.dk               ; 2 uses
  %.111.i.i35 = select i1 %i.dl, i64 %.01025.i.i34.a, i64 %i.dh ; 3 uses
  %.1.i.i36 = select i1 %i.dl, i64 %11, i64 %.026.i.i33 ; 3 uses
...
.lr.ph.i.i:                                       ; preds = %.preheader.i.i, %.lr.ph.i.i
  %i.cg = phi i64 [ %i.cp, %.lr.ph.i.i ], [ 1, %.preheader.i.i ] ; 2 uses
  %.026.i.i.a = phi i64 [ %.1.i.i, %.lr.ph.i.i ], [ 0, %.preheader.i.i ] ; 2 uses
  %.01025.i.i.a = phi i64 [ %.111.i.i, %.lr.ph.i.i ], [ %i.bz, %.preheader.i.i ] ; 3 uses
  %6 = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i.i19, i64 %i.cg
  %7 = load i64, ptr %6, align 8
  %i.ch = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i.i19, i64 %.026.i.i.a
  %i.ci = load i64, ptr %i.ch, align 8
  %i.cj = sub i64 %7, %i.ci
  %8 = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i.i19, i64 %.01025.i.i.a
  %9 = load i64, ptr %8, align 8
  %i.ck = add i64 %.01025.i.i.a, -1               ; 2 uses
  %i.cl = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i.i19, i64 %i.ck
  %i.cm = load i64, ptr %i.cl, align 8
  %i.cn = sub i64 %9, %i.cm
  %i.co = icmp ult i64 %i.cj, %i.cn               ; 2 uses
  %.111.i.i = select i1 %i.co, i64 %.01025.i.i.a, i64 %i.ck ; 3 uses
  %.1.i.i = select i1 %i.co, i64 %i.cg, i64 %.026.i.i.a ; 3 uses
...
bb.n:                                             ; preds = %_ZN2v88internal8compiler10turboshaft18WordOperationTyperILm64EE9MakeRangeERKNS2_8WordTypeILm64EEE.exit
  ...
  %.sroa.0.0.i.i22 = select i1 %i.ct, ptr %i.r, ptr %i.v ; 8 uses
  ...
  %i.cx = load i64, ptr %.sroa.0.0.i.i22, align 8 ; 3 uses
...
.lr.ph.i.i28:                                     ; preds = %.preheader.i.i23, %.lr.ph.i.i28
  %i.db = phi i64 [ %i.dk, %.lr.ph.i.i28 ], [ 1, %.preheader.i.i23 ] ; 2 uses
  %.026.i.i29.a = phi i64 [ %.1.i.i32, %.lr.ph.i.i28 ], [ 0, %.preheader.i.i23 ] ; 2 uses
  %.01025.i.i30.a = phi i64 [ %.111.i.i31, %.lr.ph.i.i28 ], [ %i.cu, %.preheader.i.i23 ] ; 3 uses
  %10 = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i.i22, i64 %i.db
  %11 = load i64, ptr %10, align 8
  %i.dc = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i.i22, i64 %.026.i.i29.a
  %i.dd = load i64, ptr %i.dc, align 8
  %i.de = sub i64 %11, %i.dd
  %12 = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i.i22, i64 %.01025.i.i30.a
  %13 = load i64, ptr %12, align 8
  %i.df = add i64 %.01025.i.i30.a, -1             ; 2 uses
  %i.dg = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0.0.i.i22, i64 %i.df
  %i.dh = load i64, ptr %i.dg, align 8
  %i.di = sub i64 %13, %i.dh
  %i.dj = icmp ult i64 %i.de, %i.di               ; 2 uses
  %.111.i.i31 = select i1 %i.dj, i64 %.01025.i.i30.a, i64 %i.df ; 3 uses
  %.1.i.i32 = select i1 %i.dj, i64 %i.db, i64 %.026.i.i29.a ; 3 uses
...
bb.k:                                             ; preds = %_ZSt6uniqueIPmET_S1_S1_.exit
  ...
  %i.cm = load i64, ptr %i.z, align 8             ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.k, %.lr.ph.i
  %i.cp = phi i64 [ %i.cy, %.lr.ph.i ], [ 1, %bb.k ] ; 2 uses
  %.026.i.a = phi i64 [ %.1.i, %.lr.ph.i ], [ 0, %bb.k ] ; 2 uses
  %.01025.i.a = phi i64 [ %.111.i, %.lr.ph.i ], [ %i.cj, %bb.k ] ; 3 uses
  %3 = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %i.cp
  %4 = load i64, ptr %3, align 8
  %i.cq = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %.026.i.a
  %i.cr = load i64, ptr %i.cq, align 8
  %i.cs = sub i64 %4, %i.cr
  %5 = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %.01025.i.a
  %6 = load i64, ptr %5, align 8
  %i.ct = add i64 %.01025.i.a, -1                 ; 2 uses
  %i.cu = getelementptr inbounds nuw [8 x i8], ptr %i.z, i64 %i.ct
  %i.cv = load i64, ptr %i.cu, align 8
  %i.cw = sub i64 %6, %i.cv
  %i.cx = icmp ult i64 %i.cs, %i.cw               ; 2 uses
  %.111.i = select i1 %i.cx, i64 %.01025.i.a, i64 %i.ct ; 3 uses
  %.1.i = select i1 %i.cx, i64 %i.cp, i64 %.026.i.a ; 3 uses
