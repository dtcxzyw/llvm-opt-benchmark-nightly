...
bb.dt:                                            ; preds = %bb.ds
  ...
  %spec.select667 = select i1 %i.hd, i32 4096, i32 4097
  %spec.select667.a = select i1 %i.hd, i64 4096, i64 4097
  br label %bb.du

bb.du:                                            ; preds = %bb.dt, %bb.ds, %bb.dr
  %.2396 = phi i32 [ 4096, %bb.dr ], [ %spec.select667, %bb.dt ], [ 4097, %bb.ds ]
  %.2396.a = phi i64 [ 4096, %bb.dr ], [ %spec.select667.a, %bb.dt ], [ 4097, %bb.ds ]
...
bb.ff:                                            ; preds = %bb.fe
  %i.kw = call ptr @parse_name(ptr noundef nonnull %.0457, i32 noundef %.2396, i32 noundef 1, ptr noundef nonnull @.str.41) #12 ; 2 uses
