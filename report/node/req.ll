...
bb.a:
  ...
  %i.l = tail call ptr @EVP_aes_256_cbc() #12
  tail call void @opt_set_unknown_name(ptr noundef nonnull @.str.121) #12
  %i.m = tail call ptr @opt_init(i32 noundef %0, ptr noundef %1, ptr noundef nonnull @req_options) #12 ; 2 uses
  br label %bb.b
...
bb.b:                                             ; preds = %.backedge, %bb.a
  ...
  %i.n = call i32 @opt_next() #12                 ; 3 uses
...
.loopexit:                                        ; preds = %bb.b, %bb.ay, %bb.am, %bb.al, %bb.ab, %.thread694, %bb.z, %.thread690, %bb.x, %.thread, %bb.n, %bb.e, %bb.d, %bb.dc, %bb.bw, %bb.bu, %bb.ax, %bb.h
  ...
  %i.p = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.o, ptr noundef nonnull @.str.122, ptr noundef %i.m) #12 ; 0 uses
  br label %.thread706
...
bb.d:                                             ; preds = %bb.b
  %i.q = call ptr @opt_arg() #12
  %i.r = call i32 @opt_format(ptr noundef %i.q, i64 noundef 6, ptr noundef nonnull %i.e) #12
  %.not659 = icmp eq i32 %i.r, 0
  br i1 %.not659, label %.loopexit, label %.backedge

bb.e:                                             ; preds = %bb.b
  %i.s = call ptr @opt_arg() #12
  %i.t = call i32 @opt_format(ptr noundef %i.s, i64 noundef 6, ptr noundef nonnull %i.f) #12
  %.not658 = icmp eq i32 %i.t, 0
  br i1 %.not658, label %.loopexit, label %.backedge

bb.f:                                             ; preds = %bb.b
  %i.u = call ptr @opt_arg() #12
  %i.v = call ptr @setup_engine_methods(ptr noundef %i.u, i32 noundef -1, i32 noundef 0) #12
  br label %.backedge

bb.g:                                             ; preds = %bb.b
  %i.w = call ptr @opt_arg() #12
  %i.x = call ptr @setup_engine_methods(ptr noundef %i.w, i32 noundef -1, i32 noundef 0) #12 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ab = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.z, ptr noundef nonnull @.str.123, ptr noundef %i.aa) #12 ; 0 uses
  br label %.loopexit

bb.i:                                             ; preds = %bb.b
  %i.ac = call ptr @opt_arg() #12
  br label %.backedge
...
bb.l:                                             ; preds = %bb.b
  %i.ad = call ptr @opt_arg() #12
  br label %.backedge

bb.m:                                             ; preds = %bb.b
  %i.ae = call ptr @opt_arg() #12
  store ptr %i.ae, ptr @section, align 8, !tbaa !9
  br label %.backedge

bb.n:                                             ; preds = %bb.b
  %i.af = call ptr @opt_arg() #12
  %i.ag = call i32 @opt_format(ptr noundef %i.af, i64 noundef 4094, ptr noundef nonnull %i.g) #12
  %.not657 = icmp eq i32 %i.ag, 0
  br i1 %.not657, label %.loopexit, label %.backedge

bb.o:                                             ; preds = %bb.b
  %i.ah = call ptr @opt_arg() #12
  br label %.backedge

bb.p:                                             ; preds = %bb.b
  %i.ai = call ptr @opt_arg() #12
  br label %.backedge

bb.q:                                             ; preds = %bb.b
  %i.aj = call ptr @opt_arg() #12
  br label %.backedge

bb.r:                                             ; preds = %bb.b
  %i.ak = call ptr @opt_arg() #12
  br label %.backedge

bb.s:                                             ; preds = %bb.b
  %i.al = call ptr @opt_arg() #12
  br label %.backedge

bb.t:                                             ; preds = %bb.b, %bb.b
  %i.am = call i32 @opt_rand(i32 noundef %i.n) #12
  %.not656 = icmp eq i32 %i.am, 0
  br i1 %.not656, label %.thread706, label %.backedge

bb.u:                                             ; preds = %bb.b, %bb.b, %bb.b, %bb.b
  %i.an = call i32 @opt_provider(i32 noundef %i.n) #12
  %.not655 = icmp eq i32 %i.an, 0
  br i1 %.not655, label %.thread706, label %.backedge

bb.v:                                             ; preds = %bb.b
  %i.ao = call ptr @opt_arg() #12
  br label %.backedge
...
bb.x:                                             ; preds = %bb.w
  %i.aq = call ptr @OPENSSL_sk_new_null() #12     ; 2 uses
  %i.ar = icmp eq ptr %i.aq, null
  br i1 %i.ar, label %.loopexit, label %.thread

.thread:                                          ; preds = %bb.w, %bb.x
  %.2445689 = phi ptr [ %i.aq, %bb.x ], [ %.0443, %bb.w ] ; 3 uses
  %i.as = call ptr @opt_arg() #12
  %i.at = call i32 @OPENSSL_sk_push(ptr noundef nonnull %.2445689, ptr noundef %i.as) #12
...
bb.au:                                            ; preds = %bb.b
  %i.bi = call ptr @opt_arg() #12
  %i.bj = call i64 @strtol(ptr noundef nonnull captures(none) %i.bi, ptr noundef null, i32 noundef 10) #12, !inline_history !18
...
bb.av:                                            ; preds = %bb.au
  ...
  %i.bn = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.bm, ptr noundef nonnull @.str.124, ptr noundef %i.m) #12 ; 0 uses
  br label %.thread706
...
bb.ax:                                            ; preds = %bb.aw
  ...
  %i.bp = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.bo, ptr noundef nonnull @.str.125) #12 ; 0 uses
  br label %.loopexit

bb.ay:                                            ; preds = %bb.aw
  %i.bq = call ptr @opt_arg() #12
  %i.br = call ptr @s2i_ASN1_INTEGER(ptr noundef null, ptr noundef %i.bq) #12 ; 2 uses
...
bb.ba:                                            ; preds = %bb.b
  %i.bt = call ptr @opt_arg() #12
  br label %.backedge

bb.bb:                                            ; preds = %bb.b
  %i.bu = call ptr @opt_arg() #12
  %i.bv = call i32 @set_ext_copy(ptr noundef nonnull %i.a, ptr noundef %i.bu) #12
  %.not644 = icmp eq i32 %i.bv, 0
  br i1 %.not644, label %bb.bc, label %.backedge

bb.bc:                                            ; preds = %bb.bb
  %i.bw = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.bx = call ptr @opt_arg() #12
  %i.by = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.bw, ptr noundef nonnull @.str.126, ptr noundef %i.bx) #12 ; 0 uses
  br label %.thread706

bb.bd:                                            ; preds = %bb.b, %bb.b
  %i.bz = call ptr @opt_arg() #12
  br label %.backedge

bb.be:                                            ; preds = %bb.b
  %i.ca = call ptr @opt_arg() #12                 ; 3 uses
  %i.cb = icmp eq ptr %.0506, null
  br i1 %i.cb, label %bb.bf, label %bb.bg

bb.bf:                                            ; preds = %bb.be
  %i.cc = call ptr @OPENSSL_LH_new(ptr noundef nonnull @ext_name_hash, ptr noundef nonnull @ext_name_cmp) #12
  %i.cd = call ptr @OPENSSL_LH_set_thunks(ptr noundef %i.cc, ptr noundef nonnull @lh_OPENSSL_STRING_hash_thunk, ptr noundef nonnull @lh_OPENSSL_STRING_comp_thunk, ptr noundef nonnull @lh_OPENSSL_STRING_doall_thunk, ptr noundef nonnull @lh_OPENSSL_STRING_doall_arg_thunk) #12 ; 3 uses
  %i.ce = call ptr @BIO_s_mem() #12
  %i.cf = call ptr @BIO_new(ptr noundef %i.ce) #12 ; 3 uses
...
bb.bg:                                            ; preds = %bb.bf, %bb.be
  ...
  %i.ci = tail call ptr @__ctype_b_loc() #13      ; 2 uses
...
bb.bi:                                            ; preds = %bb.bh
  %i.cq = call ptr @strchr(ptr noundef nonnull dereferenceable(1) %.024.i, i32 noundef 61) #14 ; 3 uses
  %i.cr = icmp eq ptr %i.cq, null
  br i1 %i.cr, label %bb.bj, label %bb.bk

bb.bj:                                            ; preds = %bb.bi
  %i.cs = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.ct = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.cs, ptr noundef nonnull @.str.210) #12 ; 0 uses
  br label %.thread706

bb.bk:                                            ; preds = %bb.bi
  %i.cu = call ptr @CRYPTO_strdup(ptr noundef nonnull %.024.i, ptr noundef nonnull @.str.208, i32 noundef 255) #12 ; 8 uses
...
bb.bn:                                            ; preds = %._crit_edge3171
  ...
  %i.dk = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.dj, ptr noundef nonnull @.str.211) #12 ; 0 uses
  call void @CRYPTO_free(ptr noundef nonnull %i.cu, ptr noundef nonnull @.str.208, i32 noundef 264) #12
  br label %.thread706

bb.bo:                                            ; preds = %._crit_edge3171
  store i8 0, ptr %.023.i.lcssa, align 1, !tbaa !21
  %i.dl = call ptr @OPENSSL_LH_insert(ptr noundef nonnull %.1507, ptr noundef nonnull %i.cu) #12 ; 2 uses
  %.not29.i = icmp eq ptr %i.dl, null
  br i1 %.not29.i, label %bb.bp, label %duplicated.exit

bb.bp:                                            ; preds = %bb.bo
  %i.dm = call i32 @OPENSSL_LH_error(ptr noundef nonnull %.1507) #12
  %.not30.i = icmp eq i32 %i.dm, 0
  br i1 %.not30.i, label %bb.br, label %bb.bq

bb.bq:                                            ; preds = %bb.bp
  call void @CRYPTO_free(ptr noundef nonnull %i.cu, ptr noundef nonnull @.str.208, i32 noundef 276) #12
  br label %.thread704

duplicated.exit:                                  ; preds = %bb.bo
  %i.dn = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.do = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.dn, ptr noundef nonnull @.str.212, ptr noundef nonnull %i.cu) #12 ; 0 uses
  call void @CRYPTO_free(ptr noundef nonnull %i.dl, ptr noundef nonnull @.str.208, i32 noundef 273) #12
  br label %.thread706

.thread704:                                       ; preds = %bb.bk, %bb.bq
  %i.dp = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.dq = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.dp, ptr noundef nonnull @.str.127, ptr noundef %i.ca) #12 ; 0 uses
  br label %.thread706

bb.br:                                            ; preds = %bb.bp
  %i.dr = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %.1491, ptr noundef nonnull @.str.128, ptr noundef %i.ca) #12
...
bb.bt:                                            ; preds = %bb.b
  %i.dt = call ptr @opt_arg() #12
  %i.du = call ptr @EVP_get_cipherbyname(ptr noundef %i.dt) #12 ; 2 uses
  %i.dv = icmp eq ptr %i.du, null
  br i1 %i.dv, label %bb.bu, label %.backedge

bb.bu:                                            ; preds = %bb.bt
  %i.dw = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.dx = call ptr @opt_arg() #12
  %i.dy = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.dw, ptr noundef nonnull @.str.129, ptr noundef %i.dx) #12 ; 0 uses
  br label %.loopexit

bb.bv:                                            ; preds = %bb.b
  %i.dz = call ptr @opt_unknown() #12
  br label %.backedge

bb.bw:                                            ; preds = %bb.b
  %i.ea = call i32 @opt_check_rest_arg(ptr noundef null) #12
  %.not563 = icmp eq i32 %i.ea, 0
  br i1 %.not563, label %.loopexit, label %bb.bx

bb.bx:                                            ; preds = %bb.bw
  %i.eb = call i32 @app_RAND_load() #12
...
bb.ca:                                            ; preds = %bb.bz
  ...
  %i.ed = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.ec, ptr noundef nonnull @.str.130) #12 ; 0 uses
  br label %bb.cb
...
bb.cc:                                            ; preds = %bb.cb
  ...
  %i.ef = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.ee, ptr noundef nonnull @.str.131) #12 ; 0 uses
  br label %bb.cd
...
bb.ce:                                            ; preds = %bb.cd
  ...
  %i.eh = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.eg, ptr noundef nonnull @.str.132) #12 ; 0 uses
  br label %bb.cf
...
bb.cg:                                            ; preds = %bb.cf
  ...
  %i.el = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.ek, ptr noundef nonnull @.str.133) #12 ; 0 uses
  br label %bb.ch
...
bb.cj:                                            ; preds = %bb.ci
  %i.eo = call i32 @fileno_stdin() #12
  %i.ep = call i32 @isatty(i32 noundef %i.eo) #12
  %.not569 = icmp eq i32 %i.ep, 0
  br i1 %.not569, label %bb.cl, label %bb.ck

bb.ck:                                            ; preds = %bb.cj
  %i.eq = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.er = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.eq, ptr noundef nonnull @.str.134) #12 ; 0 uses
  br label %bb.cl

bb.cl:                                            ; preds = %bb.ci, %bb.ck, %bb.cj, %bb.ch
  %.2426 = phi i32 [ %.0424, %bb.ch ], [ 1, %bb.ci ], [ 0, %bb.ck ], [ 0, %bb.cj ] ; 3 uses
  %i.es = call i32 @app_passwd(ptr noundef %.0465, ptr noundef %.0463, ptr noundef nonnull %i.c, ptr noundef nonnull %i.d) #12
  %.not570 = icmp eq i32 %i.es, 0
  br i1 %.not570, label %bb.cm, label %bb.cn

bb.cm:                                            ; preds = %bb.cl
  %i.et = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.eu = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.et, ptr noundef nonnull @.str.135) #12 ; 0 uses
  br label %.thread706

bb.cn:                                            ; preds = %bb.cl
  %i.ev = call ptr @app_load_config_verbose(ptr noundef %.0453, i32 noundef %.0422) #12 ; 3 uses
...
bb.cq:                                            ; preds = %bb.cp
  ...
  %i.ey = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.ex, ptr noundef nonnull @.str.136) #12 ; 0 uses
  br label %bb.cr

bb.cr:                                            ; preds = %bb.cq, %bb.cp
  %i.ez = call ptr @app_load_config_bio(ptr noundef nonnull %.0490, ptr noundef null) #12 ; 2 uses
...
bb.ct:                                            ; preds = %bb.cs
  %i.fc = call i32 @app_load_modules(ptr noundef %.pre1995) #12
...
bb.cv:                                            ; preds = %bb.cu
  %i.fe = call ptr @app_conf_try_string(ptr noundef nonnull %i.fd, ptr noundef null, ptr noundef nonnull @.str.137) #12 ; 3 uses
  %.not576 = icmp eq ptr %i.fe, null
  br i1 %.not576, label %bb.da, label %bb.cw

bb.cw:                                            ; preds = %bb.cv
  %i.ff = call ptr @BIO_new_file(ptr noundef nonnull %i.fe, ptr noundef nonnull @.str.138) #12 ; 3 uses
...
bb.cy:                                            ; preds = %bb.cx
  ...
  %i.fi = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.fh, ptr noundef nonnull @.str.139, ptr noundef nonnull %i.fe) #12 ; 0 uses
  br label %bb.da

bb.cz:                                            ; preds = %bb.cw
  %i.fj = call i32 @OBJ_create_objects(ptr noundef nonnull %i.ff) #12 ; 0 uses
  %i.fk = call i32 @BIO_free(ptr noundef nonnull %i.ff) #12 ; 0 uses
  br label %bb.da

bb.da:                                            ; preds = %bb.cz, %bb.cy, %bb.cx, %bb.cv, %bb.cu
  %i.fl = load ptr, ptr @req_conf, align 8, !tbaa !26
  %i.fm = call i32 @add_oid_section(ptr noundef %i.fl) #12
...
bb.dc:                                            ; preds = %bb.db
  %i.fn = call i32 @opt_check_md(ptr noundef nonnull %.0473) #12
...
bb.dd:                                            ; preds = %bb.db
  ...
  %i.fq = call ptr @app_conf_try_string(ptr noundef %i.fo, ptr noundef %i.fp, ptr noundef nonnull @.str.140) #12
  br label %bb.de
...
bb.df:                                            ; preds = %bb.de
  ...
  %i.fv = call ptr @app_conf_try_string(ptr noundef %i.fs, ptr noundef %i.ft, ptr noundef nonnull %i.fu) #12 ; 2 uses
...
.thread708:                                       ; preds = %bb.de, %bb.df
  ...
  call void @X509V3_set_ctx(ptr noundef nonnull %2, ptr noundef null, ptr noundef null, ptr noundef null, ptr noundef null, i32 noundef 1) #12
  %i.fw = load ptr, ptr @req_conf, align 8, !tbaa !26
  call void @X509V3_set_nconf(ptr noundef nonnull %2, ptr noundef %i.fw) #12
  %i.fx = load ptr, ptr @req_conf, align 8, !tbaa !26
  %i.fy = call i32 @X509V3_EXT_add_nconf(ptr noundef %i.fx, ptr noundef nonnull %2, ptr noundef nonnull %.2489711, ptr noundef null) #12
...
bb.dg:                                            ; preds = %.thread708
  ...
  %i.gb = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.fz, ptr noundef nonnull @.str.143, ptr noundef nonnull %i.ga, ptr noundef nonnull %.2489711) #12 ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #12
  br label %.thread706
...
bb.ex:                                            ; preds = %bb.ew
  ...
  %i.jn = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.jm, ptr noundef nonnull @.str.163) #12 ; 0 uses
  %i.jo = icmp eq ptr %.2452, null
  %i.jp = load ptr, ptr @bio_err, align 8, !tbaa !14 ; 2 uses
  br i1 %i.jo, label %bb.ey, label %bb.ez

bb.ey:                                            ; preds = %bb.ex
  %i.jq = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.jp, ptr noundef nonnull @.str.164) #12 ; 0 uses
  br label %bb.fa

bb.ez:                                            ; preds = %bb.ex
  %i.jr = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.jp, ptr noundef nonnull @.str.165, ptr noundef nonnull %.2452) #12 ; 0 uses
  br label %bb.fa

bb.fa:                                            ; preds = %bb.ey, %bb.ez, %bb.ew
  %i.js = load i32, ptr %i.f, align 4, !tbaa !5
  %i.jt = call ptr @bio_open_owner(ptr noundef %.2452, i32 noundef %i.js, i32 noundef 1) #12 ; 5 uses
...
bb.fb:                                            ; preds = %bb.fa
  ...
  %i.jx = call ptr @app_conf_try_string(ptr noundef %i.jv, ptr noundef %i.jw, ptr noundef nonnull @.str.166) #12 ; 2 uses
...
bb.fc:                                            ; preds = %bb.fb
  ...
  %i.kb = call ptr @app_conf_try_string(ptr noundef %i.jz, ptr noundef %i.ka, ptr noundef nonnull @.str.167) #12 ; 2 uses
...
.thread733.tail:                                  ; preds = %sub_2, %sub_1, %sub_0, %bb.fc
  ...
  %i.kk = call i32 @PEM_write_bio_PrivateKey(ptr noundef nonnull %i.jt, ptr noundef nonnull %.1386732, ptr noundef %spec.select672, ptr noundef null, i32 noundef 0, ptr noundef null, ptr noundef %i.kj) #12
...
.lr.ph1430:                                       ; preds = %.thread733.tail, %bb.fd
  ...
  %i.kl = call i64 @ERR_peek_error() #12          ; 2 uses
...
bb.fd:                                            ; preds = %.lr.ph1430
  ...
  %i.ks = call i32 @PEM_write_bio_PrivateKey(ptr noundef nonnull %i.jt, ptr noundef nonnull %.1386732, ptr noundef %spec.select672, ptr noundef null, i32 noundef 0, ptr noundef null, ptr noundef %i.kr) #12
  %.not602 = icmp eq i32 %i.ks, 0
  br i1 %.not602, label %.lr.ph1430, label %._crit_edge

._crit_edge:                                      ; preds = %bb.fd, %.thread733.tail
  call void @BIO_free_all(ptr noundef nonnull %i.jt) #12
  %i.kt = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.ku = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.kt, ptr noundef nonnull @.str.169) #12 ; 0 uses
  br label %bb.fe
...
bb.ff:                                            ; preds = %bb.fe
  ...
  %i.kw = call ptr @parse_name(ptr noundef nonnull %.0457, i32 noundef %i.kv, i32 noundef 1, ptr noundef nonnull @.str.41) #12 ; 2 uses
...
bb.fi:                                            ; preds = %bb.fh
  ...
  %i.kz = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.ky, ptr noundef nonnull @.str.170) #12 ; 0 uses
  br label %bb.fj

bb.fj:                                            ; preds = %bb.fi, %bb.fh
  %i.la = load i32, ptr %i.e, align 4, !tbaa !5
  %i.lb = call ptr @load_csr_autofmt(ptr noundef %.0485, i32 noundef %i.la, ptr noundef %.0510, ptr noundef nonnull @.str.171) #12 ; 2 uses
...
bb.fl:                                            ; preds = %bb.fk
  ...
  %i.le = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.ld, ptr noundef nonnull @.str.172) #12 ; 0 uses
  br label %bb.fm
...
.thread737:                                       ; preds = %bb.fn
  ...
  %i.lh = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.lg, ptr noundef nonnull @.str.173) #12 ; 0 uses
  br label %bb.fs
...
bb.fo:                                            ; preds = %bb.fn
  ...
  %i.lk = call ptr @load_key(ptr noundef nonnull %spec.select673, i32 noundef 0, i32 noundef 0, ptr noundef %i.li, ptr noundef %.0379, ptr noundef nonnull %i.lj) #12 ; 2 uses
...
.thread741:                                       ; preds = %bb.fo, %bb.fp
  ...
  %i.ln = call ptr @load_cert_pass(ptr noundef nonnull %.0483, i32 noundef 0, i32 noundef 1, ptr noundef %i.lm, ptr noundef nonnull @.str.176) #12 ; 4 uses
  %i.lo = icmp eq ptr %i.ln, null
  br i1 %i.lo, label %.thread706, label %bb.fq

bb.fq:                                            ; preds = %.thread741
  %i.lp = call i32 @X509_check_private_key(ptr noundef nonnull %i.ln, ptr noundef %.0392744) #12
  %.not608 = icmp eq i32 %i.lp, 0
  br i1 %.not608, label %bb.fr, label %bb.fs

bb.fr:                                            ; preds = %bb.fq
  %i.lq = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.lr = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.lq, ptr noundef nonnull @.str.177) #12 ; 0 uses
  br label %.thread706
...
bb.fu:                                            ; preds = %bb.ft
  ...
  %i.lw = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.lv, ptr noundef nonnull @.str.178) #12 ; 0 uses
  br label %.thread706
...
bb.fw:                                            ; preds = %bb.fv
  %i.ly = call ptr @app_get0_libctx() #12
  %i.lz = call ptr @app_get0_propq() #12
  %i.ma = call ptr @X509_REQ_new_ex(ptr noundef %i.ly, ptr noundef %i.lz) #12 ; 4 uses
...
bb.fy:                                            ; preds = %bb.fx
  ...
  %i.me = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.md, ptr noundef nonnull @.str.179) #12 ; 0 uses
  br label %.thread706
...
bb.ga:                                            ; preds = %bb.fz
  %i.mf = call ptr @X509_REQ_get0_pubkey(ptr noundef nonnull %.1499) #12 ; 2 uses
...
bb.gb:                                            ; preds = %bb.ga
  %i.mi = call ptr @X509_get_subject_name(ptr noundef nonnull %.0502) #12
  br label %bb.gd

bb.gc:                                            ; preds = %bb.ga
  %i.mj = call ptr @X509_REQ_get_subject_name(ptr noundef nonnull %.1499) #12
  br label %bb.gd
...
bb.ge:                                            ; preds = %bb.gd
  %i.ml = call ptr @X509_REQ_get_subject_name(ptr noundef nonnull %.1499) #12
  br label %bb.gf
...
bb.gg:                                            ; preds = %bb.gf
  ...
  %i.mo = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.mn, ptr noundef nonnull @.str.180) #12 ; 0 uses
  br label %bb.gh

bb.gh:                                            ; preds = %bb.gg, %bb.gf
  %i.mp = call ptr @app_get0_libctx() #12
  %i.mq = call ptr @app_get0_propq() #12
  %i.mr = call ptr @X509_new_ex(ptr noundef %i.mp, ptr noundef %i.mq) #12 ; 17 uses
...
bb.gj:                                            ; preds = %bb.gi
  %i.mt = call i32 @X509_set_serialNumber(ptr noundef nonnull %i.mr, ptr noundef nonnull %.0376) #12
  %.not618 = icmp eq i32 %i.mt, 0
  br i1 %.not618, label %.thread746, label %bb.gl

bb.gk:                                            ; preds = %bb.gi
  %i.mu = call ptr @X509_get_serialNumber(ptr noundef nonnull %i.mr) #12
  %i.mv = call i32 @rand_serial(ptr noundef null, ptr noundef %i.mu) #12
  %.not617 = icmp eq i32 %i.mv, 0
  br i1 %.not617, label %.thread746, label %bb.gl

bb.gl:                                            ; preds = %bb.gk, %bb.gj
  %i.mw = call i32 @X509_set_issuer_name(ptr noundef nonnull %i.mr, ptr noundef %i.mk) #12
...
bb.go:                                            ; preds = %bb.gn
  ...
  %i.mz = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.my, ptr noundef nonnull @.str.181) #12 ; 0 uses
  br label %bb.gp

bb.gp:                                            ; preds = %bb.gm, %bb.gn, %bb.go
  %.2438 = phi i32 [ %.0436, %bb.gn ], [ %.0436, %bb.go ], [ 30, %bb.gm ]
  %i.na = call i32 @set_cert_times(ptr noundef nonnull %i.mr, ptr noundef %.0441, ptr noundef %.0439, i32 noundef %.2438, i32 noundef 1) #12
  %.not621 = icmp eq i32 %i.na, 0
  br i1 %.not621, label %.thread746, label %bb.gq

bb.gq:                                            ; preds = %bb.gp
  %i.nb = call i32 @X509_set_subject_name(ptr noundef nonnull %i.mr, ptr noundef %i.mm) #12
...
bb.gr:                                            ; preds = %bb.gq
  %i.nc = call i32 @X509_set_pubkey(ptr noundef nonnull %i.mr, ptr noundef nonnull %i.mf) #12
...
bb.gu:                                            ; preds = %bb.gt
  ...
  %i.ng = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.nf, ptr noundef nonnull @.str.182) #12 ; 0 uses
  br label %bb.gx

bb.gv:                                            ; preds = %bb.gs
  %i.nh = call i32 @copy_extensions(ptr noundef nonnull %i.mr, ptr noundef nonnull %.1499, i32 noundef %i.nd) #12
  %.not625 = icmp eq i32 %i.nh, 0
  br i1 %.not625, label %bb.gw, label %bb.gx

bb.gw:                                            ; preds = %bb.gv
  %i.ni = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.nj = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.ni, ptr noundef nonnull @.str.183) #12 ; 0 uses
  br label %.thread746

bb.gx:                                            ; preds = %bb.gv, %bb.gt, %bb.gu
  %i.nk = select i1 %i.mg, ptr %.0502, ptr %i.mr
  call void @X509V3_set_ctx(ptr noundef nonnull %4, ptr noundef nonnull %i.nk, ptr noundef nonnull %i.mr, ptr noundef null, ptr noundef null, i32 noundef 2) #12
  br i1 %i.lt, label %bb.gy, label %bb.hb

bb.gy:                                            ; preds = %bb.gx
  %i.nl = call i32 @X509V3_set_issuer_pkey(ptr noundef nonnull %4, ptr noundef %.1386732) #12
  %.not627 = icmp eq i32 %i.nl, 0
  br i1 %.not627, label %.thread746, label %bb.gz

bb.gz:                                            ; preds = %bb.gy
  %i.nm = call i32 @cert_matches_key(ptr noundef nonnull %i.mr, ptr noundef %.1386732) #12
  %.not628 = icmp eq i32 %i.nm, 0
  br i1 %.not628, label %bb.ha, label %bb.hb

bb.ha:                                            ; preds = %bb.gz
  %i.nn = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.no = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.nn, ptr noundef nonnull @.str.184) #12 ; 0 uses
  br label %bb.hb

bb.hb:                                            ; preds = %bb.gz, %bb.ha, %bb.gx
  %i.np = load ptr, ptr @req_conf, align 8, !tbaa !26
  call void @X509V3_set_nconf(ptr noundef nonnull %4, ptr noundef %i.np) #12
  br i1 %.not582714, label %bb.he, label %bb.hc

bb.hc:                                            ; preds = %bb.hb
  %i.nq = load ptr, ptr @req_conf, align 8, !tbaa !26
  %i.nr = call i32 @X509V3_EXT_add_nconf(ptr noundef %i.nq, ptr noundef nonnull %4, ptr noundef nonnull %.2489712, ptr noundef nonnull %i.mr) #12
  %.not629 = icmp eq i32 %i.nr, 0
  br i1 %.not629, label %bb.hd, label %bb.he

bb.hd:                                            ; preds = %bb.hc
  %i.ns = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.nt = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.ns, ptr noundef nonnull @.str.185, ptr noundef nonnull %.2489712) #12 ; 0 uses
  br label %.thread746
...
bb.hf:                                            ; preds = %bb.he
  %i.nv = call i32 @X509V3_EXT_add_nconf(ptr noundef nonnull %i.nu, ptr noundef nonnull %4, ptr noundef nonnull @.str.145, ptr noundef nonnull %i.mr) #12
  %.not631 = icmp eq i32 %i.nv, 0
  br i1 %.not631, label %bb.hg, label %bb.hh

bb.hg:                                            ; preds = %bb.hf
  %i.nw = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.nx = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.nw, ptr noundef nonnull @.str.186) #12 ; 0 uses
  br label %.thread746
...
bb.hi:                                            ; preds = %bb.hh
  %i.ny = call i32 @X509_add1_ext_i2d(ptr noundef nonnull %i.mr, i32 noundef 952, ptr noundef null, i32 noundef 1, i64 noundef 0) #12
  %.not633 = icmp eq i32 %i.ny, 1
  br i1 %.not633, label %bb.hk, label %bb.hj

bb.hj:                                            ; preds = %bb.hi
  %i.nz = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.oa = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.nz, ptr noundef nonnull @.str.187) #12 ; 0 uses
  br label %.thread746

bb.hk:                                            ; preds = %bb.hi, %bb.hh
  %i.ob = call i32 @do_X509_sign(ptr noundef nonnull %i.mr, i32 noundef %.0397, ptr noundef %i.mh, ptr noundef %.2475, ptr noundef %.0467, ptr noundef nonnull %4) #12
...
bb.hn:                                            ; preds = %bb.hm
  ...
  %i.od = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.oc, ptr noundef nonnull @.str.188) #12 ; 0 uses
  br label %bb.ho

bb.ho:                                            ; preds = %bb.hn, %bb.hm
  call void @X509V3_set_ctx(ptr noundef nonnull %5, ptr noundef null, ptr noundef null, ptr noundef nonnull %.1499, ptr noundef null, i32 noundef 2) #12
  %i.oe = load ptr, ptr @req_conf, align 8, !tbaa !26
  call void @X509V3_set_nconf(ptr noundef nonnull %5, ptr noundef %i.oe) #12
  br i1 %.not582714, label %bb.hr, label %bb.hp

bb.hp:                                            ; preds = %bb.ho
  %i.of = load ptr, ptr @req_conf, align 8, !tbaa !26
  %i.og = call i32 @X509V3_EXT_REQ_add_nconf(ptr noundef %i.of, ptr noundef nonnull %5, ptr noundef nonnull %.2489712, ptr noundef nonnull %.1499) #12
  %.not611 = icmp eq i32 %i.og, 0
  br i1 %.not611, label %bb.hq, label %bb.hr

bb.hq:                                            ; preds = %bb.hp
  %i.oh = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.oi = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.oh, ptr noundef nonnull @.str.189, ptr noundef nonnull %.2489712) #12 ; 0 uses
  br label %.thread750
...
bb.hs:                                            ; preds = %bb.hr
  %i.ok = call i32 @X509V3_EXT_REQ_add_nconf(ptr noundef nonnull %i.oj, ptr noundef nonnull %5, ptr noundef nonnull @.str.145, ptr noundef nonnull %.1499) #12
  %.not613 = icmp eq i32 %i.ok, 0
  br i1 %.not613, label %bb.ht, label %bb.hu

bb.ht:                                            ; preds = %bb.hs
  %i.ol = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.om = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.ol, ptr noundef nonnull @.str.190) #12 ; 0 uses
  br label %.thread750

bb.hu:                                            ; preds = %bb.hs, %bb.hr
  %i.on = call i32 @do_X509_REQ_sign(ptr noundef nonnull %.1499, ptr noundef %.1386732, ptr noundef %.2475, ptr noundef %.0467) #12
...
bb.hy:                                            ; preds = %bb.hx
  %i.oo = call i32 @X509_REQ_set_subject_name(ptr noundef %.0498, ptr noundef %.0455) #12
  %.not636 = icmp eq i32 %i.oo, 0
  br i1 %.not636, label %bb.hz, label %.thread753

.thread764:                                       ; preds = %bb.hx
  %i.op = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef null, ptr noundef nonnull @.str.191) #12 ; 0 uses
  %i.oq = call ptr @X509_REQ_get_subject_name(ptr noundef %.0498) #12
  call void @print_name(ptr noundef null, ptr noundef nonnull @.str.192, ptr noundef %i.oq) #12
  %i.or = call i32 @X509_REQ_set_subject_name(ptr noundef %.0498, ptr noundef %.0455) #12
...
bb.hz:                                            ; preds = %.thread764, %bb.hy
  ...
  %i.ot = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.os, ptr noundef nonnull @.str.193) #12 ; 0 uses
  br label %.thread706

bb.ia:                                            ; preds = %.thread764
  %i.ou = call ptr @X509_REQ_get_subject_name(ptr noundef %.0498) #12
  call void @print_name(ptr noundef null, ptr noundef nonnull @.str.194, ptr noundef %i.ou) #12
  br label %.thread753
...
bb.ic:                                            ; preds = %bb.ib
  %i.ow = call ptr @X509_REQ_get0_pubkey(ptr noundef %.2500761) #12 ; 2 uses
...
bb.id:                                            ; preds = %bb.ic, %bb.ib
  ...
  %i.oy = call i32 @do_X509_REQ_verify(ptr noundef %.2500761, ptr noundef nonnull %.0375, ptr noundef %.0510) #12 ; 2 uses
...
bb.if:                                            ; preds = %bb.ie
  ...
  %i.pc = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.pb, ptr noundef nonnull @.str.195) #12 ; 0 uses
  br label %.thread706

bb.ig:                                            ; preds = %bb.ie
  %i.pd = load ptr, ptr @bio_out, align 8, !tbaa !14
  %i.pe = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.pd, ptr noundef nonnull @.str.196) #12 ; 0 uses
  br label %bb.ih
...
bb.ij:                                            ; preds = %bb.ii
  %i.pk = call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %.2452, ptr noundef nonnull dereferenceable(1) %.0478) #14
...
bb.ik:                                            ; preds = %bb.ij, %bb.ii
  ...
  %i.pp = call ptr @bio_open_default(ptr noundef %.0478, i8 noundef signext %i.pn, i32 noundef %i.po) #12 ; 23 uses
...
.thread770:                                       ; preds = %bb.im
  %i.pt = call i32 @PEM_write_bio_PUBKEY(ptr noundef nonnull %i.pp, ptr noundef nonnull %i.pr) #12 ; 0 uses
  br label %bb.io

bb.in:                                            ; preds = %bb.im
  %i.pu = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.pv = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.pu, ptr noundef nonnull @.str.197) #12 ; 0 uses
  br label %.thread706
...
bb.iq:                                            ; preds = %bb.ip
  %i.py = call i32 @X509_print_ex(ptr noundef nonnull %i.pp, ptr noundef %.0504757, i64 noundef %i.pw, i64 noundef %i.px) #12 ; 4 uses
  %i.pz = icmp eq i32 %i.py, 0
  br i1 %i.pz, label %bb.ir, label %.thread855

.thread772:                                       ; preds = %bb.ip
  %i.qa = call i32 @X509_REQ_print_ex(ptr noundef nonnull %i.pp, ptr noundef %.2500761, i64 noundef %i.pw, i64 noundef %i.px) #12 ; 4 uses
  %i.qb = icmp eq i32 %i.qa, 0
  br i1 %i.qb, label %.thread774, label %.thread775

bb.ir:                                            ; preds = %bb.iq
  %i.qc = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.qd = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.qc, ptr noundef nonnull @.str.198) #12 ; 0 uses
  br label %bb.jt

.thread774:                                       ; preds = %.thread772
  %i.qe = load ptr, ptr @bio_err, align 8, !tbaa !14
  %i.qf = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.qe, ptr noundef nonnull @.str.199) #12 ; 0 uses
  br label %bb.jt
...
.thread857:                                       ; preds = %.thread855, %bb.it
  ...
  %i.qg = call ptr @X509_get_subject_name(ptr noundef %.0504757) #12
  br label %bb.iu

.thread781:                                       ; preds = %.thread775, %bb.it
  %.1434780784 = phi i32 [ 1, %bb.it ], [ %i.qa, %.thread775 ]
  %i.qh = call ptr @X509_REQ_get_subject_name(ptr noundef %.2500761) #12
  br label %bb.iu
...
bb.iu:                                            ; preds = %.thread781, %.thread857
  ...
  call void @print_name(ptr noundef nonnull %i.pp, ptr noundef nonnull @.str.200, ptr noundef %i.qi) #12
  br label %bb.iv
...
.thread862:                                       ; preds = %.thread860, %bb.iw
  ...
  %i.qj = call ptr @X509_get0_pubkey(ptr noundef %.0504757) #12
  br label %bb.ix

.thread789:                                       ; preds = %.thread785, %bb.iw
  %.1434779788792 = phi i32 [ %.1434779, %bb.iw ], [ %i.qa, %.thread785 ]
  %i.qk = call ptr @X509_REQ_get0_pubkey(ptr noundef %.2500761) #12
  br label %bb.ix
...
bb.iy:                                            ; preds = %bb.ix
  ...
  %i.qn = call i32 @BIO_puts(ptr noundef %i.qm, ptr noundef nonnull @.str.201) #12 ; 0 uses
  br label %.thread706

bb.iz:                                            ; preds = %bb.ix
  %i.qo = call i32 @BIO_puts(ptr noundef nonnull %i.pp, ptr noundef nonnull @.str.202) #12 ; 0 uses
  %i.qp = call i32 @EVP_PKEY_is_a(ptr noundef nonnull %.0, ptr noundef nonnull @.str.155) #12
  %.not638 = icmp eq i32 %i.qp, 0
  br i1 %.not638, label %bb.ja, label %bb.jb

bb.ja:                                            ; preds = %bb.iz
  %i.qq = call i32 @EVP_PKEY_is_a(ptr noundef nonnull %.0, ptr noundef nonnull @.str.156) #12
...
bb.jb:                                            ; preds = %bb.ja, %bb.iz
  ...
  %i.qr = call i32 @EVP_PKEY_get_bn_param(ptr noundef nonnull %.0, ptr noundef nonnull @.str.203, ptr noundef nonnull %i.j) #12
...
bb.jc:                                            ; preds = %bb.jb
  ...
  %i.qt = call i32 @BN_print(ptr noundef nonnull %i.pp, ptr noundef %i.qs) #12 ; 0 uses
  %i.qu = load ptr, ptr %i.j, align 8, !tbaa !29
  call void @BN_free(ptr noundef %i.qu) #12
  call void @llvm.lifetime.end.p0(ptr nonnull %i.j) #12
  br label %bb.je

bb.jd:                                            ; preds = %bb.ja
  %i.qv = call i32 @BIO_puts(ptr noundef nonnull %i.pp, ptr noundef nonnull @.str.204) #12 ; 0 uses
  br label %bb.je

bb.je:                                            ; preds = %bb.jd, %bb.jc
  %i.qw = call i32 @BIO_puts(ptr noundef nonnull %i.pp, ptr noundef nonnull @.str.205) #12 ; 0 uses
  br label %bb.jf
...
bb.jh:                                            ; preds = %bb.jg
  %i.ra = call i32 @i2d_X509_REQ_bio(ptr noundef nonnull %i.pp, ptr noundef %.2500761) #12
  br label %bb.jl
...
bb.jj:                                            ; preds = %bb.ji
  %i.rb = call i32 @PEM_write_bio_X509_REQ_NEW(ptr noundef nonnull %i.pp, ptr noundef %.2500761) #12
  br label %bb.jl

bb.jk:                                            ; preds = %bb.ji
  %i.rc = call i32 @PEM_write_bio_X509_REQ(ptr noundef nonnull %i.pp, ptr noundef %.2500761) #12
  br label %bb.jl
...
bb.jm:                                            ; preds = %bb.jl
  ...
  %i.re = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.rd, ptr noundef nonnull @.str.206) #12 ; 0 uses
  br label %.thread706
...
bb.jp:                                            ; preds = %bb.jo
  %i.rj = call i32 @i2d_X509_bio(ptr noundef nonnull %i.pp, ptr noundef nonnull %.0504757) #12
  br label %bb.jr

bb.jq:                                            ; preds = %bb.jo
  %i.rk = call i32 @PEM_write_bio_X509(ptr noundef nonnull %i.pp, ptr noundef nonnull %.0504757) #12
  br label %bb.jr
...
bb.js:                                            ; preds = %bb.jr
  ...
  %i.rm = call i32 (ptr, ptr, ...) @BIO_printf(ptr noundef %i.rl, ptr noundef nonnull @.str.207) #12 ; 0 uses
  br label %.thread706
...
.thread706:                                       ; preds = %bb.t, %bb.bf, %bb.br, %bb.u, %.lr.ph1430, %.thread793, %bb.iy, %bb.id, %bb.if, %bb.ic, %bb.bj, %bb.bn, %.loopexit, %duplicated.exit, %bb.av, %bb.bc, %bb.cn, %bb.cr, %bb.dv, %bb.eb, %bb.eg, %bb.er, %bb.fa, %bb.ff, %.thread741, %bb.fu, %bb.fw, %bb.ik, %bb.js, %bb.jm, %bb.in, %bb.bx, %bb.hz, %.thread746, %.thread750, %bb.fy, %bb.fr, %bb.fo, %bb.fj, %bb.ep, %bb.dq, %bb.dj, %bb.dg, %bb.da, %bb.ct, %bb.cm, %.thread704
  ...
  call void @ERR_print_errors(ptr noundef %i.rn) #12
  br label %bb.jt
...
bb.jt:                                            ; preds = %bb.c, %.thread774, %bb.ir, %bb.ih, %bb.jr, %bb.jn, %.thread706
  ...
  call void @NCONF_free(ptr noundef %i.ro) #12
  %i.rp = load ptr, ptr @addext_conf, align 8, !tbaa !26
  call void @NCONF_free(ptr noundef %i.rp) #12
  %i.rq = call i32 @BIO_free(ptr noundef %.3493830) #12 ; 0 uses
  call void @BIO_free_all(ptr noundef %.1378852) #12
  call void @EVP_PKEY_free(ptr noundef %.2387848) #12
  call void @EVP_PKEY_CTX_free(ptr noundef %.1417844) #12
  call void @OPENSSL_sk_free(ptr noundef %.4447840) #12
  call void @OPENSSL_sk_free(ptr noundef %.4471832) #12
  call void @OPENSSL_sk_free(ptr noundef %.4514820) #12
  call void @OPENSSL_LH_doall(ptr noundef %.3509822, ptr noundef nonnull @exts_cleanup) #12
  call void @OPENSSL_LH_free(ptr noundef %.3509822) #12
  call void @release_engine(ptr noundef %.3384850) #12
  %i.rr = load ptr, ptr %i.b, align 8, !tbaa !9
  call void @CRYPTO_free(ptr noundef %i.rr, ptr noundef nonnull @.str.208, i32 noundef 1096) #12
  call void @X509_REQ_free(ptr noundef %.3501828) #12
  call void @X509_NAME_free(ptr noundef %.1456838) #12
  call void @X509_free(ptr noundef %.1505824) #12
  call void @X509_free(ptr noundef %.1503826) #12
  call void @EVP_PKEY_free(ptr noundef %.1393846) #12
  call void @ASN1_INTEGER_free(ptr noundef %.3854) #12
  call void @release_engine(ptr noundef %.0379) #12
  %i.rs = load ptr, ptr %i.c, align 8, !tbaa !9   ; 2 uses
  %.not661 = icmp eq ptr %i.rs, %.1462834
  br i1 %.not661, label %bb.jv, label %bb.ju

bb.ju:                                            ; preds = %bb.jt
  call void @CRYPTO_free(ptr noundef %i.rs, ptr noundef nonnull @.str.208, i32 noundef 1105) #12
  br label %bb.jv
...
bb.jw:                                            ; preds = %bb.jv
  call void @CRYPTO_free(ptr noundef %i.rt, ptr noundef nonnull @.str.208, i32 noundef 1107) #12
  br label %bb.jx
...
bb.a:
  %i.a = tail call i64 @OPENSSL_LH_strhash(ptr noundef %0) #12
  ret i64 %i.a
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define internal i32 @ext_name_cmp(ptr nofree noundef readonly captures(none) %0, ptr nofree noundef readonly captures(none) %1) #3 {
bb.a:
  %i.a = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #14
  ret i32 %i.a
}

; Function Attrs: inlinehint nounwind uwtable
define internal i64 @lh_OPENSSL_STRING_hash_thunk(ptr noundef %0, ptr nofree noundef readonly captures(none) %1) #4 {
bb.a:
...
; Function Attrs: inlinehint nounwind uwtable
define internal i32 @lh_OPENSSL_STRING_comp_thunk(ptr noundef %0, ptr noundef %1, ptr nofree noundef readonly captures(none) %2) #4 {
bb.a:
...
; Function Attrs: inlinehint nounwind uwtable
define internal void @lh_OPENSSL_STRING_doall_thunk(ptr noundef %0, ptr nofree noundef readonly captures(none) %1) #4 {
bb.a:
...
; Function Attrs: inlinehint nounwind uwtable
define internal void @lh_OPENSSL_STRING_doall_arg_thunk(ptr noundef %0, ptr noundef %1, ptr nofree noundef readonly captures(none) %2) #4 {
bb.a:
end_hunk_2
