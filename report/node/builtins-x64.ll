...
begin_hunk_6_@_ZN2v88internal12_GLOBAL__N_128Generate_DeoptimizationEntryEPNS0_14MacroAssemblerENS0_14DeoptimizeKindE:bb.a
  br label %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit338

_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit338: ; preds = %bb.c, %bb.b, %bb.d
  %.sroa.21555.0 = phi i64 [ 8650752, %bb.d ], [ 262144, %bb.b ], [ 4456448, %bb.c ]
  %.sroa.61556.sroa.0.0 = phi i32 [ %i.p, %bb.d ], [ 0, %bb.b ], [ %i.p, %bb.c ]
  %.sroa.61556.sroa.4.sroa.0.0 = phi i32 [ %.sroa.61556.sroa.4.0.extract.shift, %bb.d ], [ 0, %bb.b ], [ 0, %bb.c ]
  %i.s = phi ptr [ inttoptr (i64 6 to ptr), %bb.d ], [ inttoptr (i64 2 to ptr), %bb.b ], [ inttoptr (i64 3 to ptr), %bb.c ]
  %.sroa.61556.sroa.0.0.insert.ext = and i32 %.sroa.61556.sroa.0.0, 240
  %.sroa.61556.sroa.0.0.insert.insert = or disjoint i32 %.sroa.61556.sroa.4.sroa.0.0, %.sroa.61556.sroa.0.0.insert.ext
  %.sroa.61556.0.insert.ext = zext i32 %.sroa.61556.sroa.0.0.insert.insert to i64
  %.sroa.61556.0.insert.shift = shl nuw i64 %.sroa.61556.0.insert.ext, 32
  %.sroa.5.0.insert.insert = or disjoint i64 %.sroa.61556.0.insert.shift, %.sroa.21555.0
  %.sroa.21555.0.insert.insert = or disjoint i64 %.sroa.5.0.insert.insert, 603979776
  tail call void @_ZN2v88internal9Assembler6movdquENS0_7OperandENS0_11XMMRegisterE(ptr noundef nonnull align 8 dereferenceable(408) %0, i64 %.sroa.21555.0.insert.insert, ptr nonnull %i.s, i8 %i.n) #8
