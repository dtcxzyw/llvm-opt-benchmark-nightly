...
bb.an:                                            ; preds = %bb.am, %bb.al
  ...
  %i.du = add nuw nsw i64 %.0249, 1               ; 3 uses
  %i.dv = load i64, ptr %i.s, align 8, !tbaa !42  ; 3 uses
  %i.dw = sub i64 %i.dv, %i.du
  %.not362 = icmp eq i64 %i.dv, 0
  br i1 %.not362, label %._crit_edge, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %bb.an
  %3 = call i64 @llvm.usub.sat.i64(i64 %i.dv, i64 256)
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %.0258359 = phi i64 [ %i.el, %.lr.ph ], [ %3, %.lr.ph.preheader ] ; 3 uses
  %.0268358 = phi i64 [ %i.ek, %.lr.ph ], [ 0, %.lr.ph.preheader ]
  %i.dx = call { i64, i64, i64 } asm sideeffect "mov $1, $0                                 \0A\09xor $2, $0                                 \0A\09sub $2, $1                                 \0A\09and $0, $2                                 \0A\09not $0                                       \0A\09and $0, $1                                 \0A\09or $2, $1                                  \0A\09sar $$63, $1                                  \0A\09", "=&{ax},=&{di},=&{si},1,2,~{dirflag},~{fpsr},~{flags}"(i64 %.0258359, i64 %i.dw) #19, !srcloc !60
  %i.dy = extractvalue { i64, i64, i64 } %i.dx, 1
  %i.dz = and i64 %i.dy, 1
  %i.ea = xor i64 %i.dz, 1
  %i.eb = getelementptr inbounds nuw i8, ptr %i.db, i64 %.0258359
  ...
  %i.ef = call i64 asm sideeffect "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %.0249) #19, !srcloc !46
  ...
  %i.ek = add i64 %i.ej, %.0268358                ; 2 uses
  %i.el = add nuw i64 %.0258359, 1                ; 2 uses
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.an
  %.0268.lcssa = phi i64 [ 0, %bb.an ], [ %i.ek, %.lr.ph ]
  %i.eo = call i64 asm sideeffect "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %.0268.lcssa) #19, !srcloc !46
...
bb.at:                                            ; preds = %bb.ar, %bb.as, %bb.aq
  %.4256 = phi i64 [ %i.eu, %bb.aq ], [ %i.fn, %bb.as ], [ %i.eu, %bb.ar ]
  %.5247 = phi i32 [ 0, %bb.aq ], [ 1, %bb.as ], [ 1, %bb.ar ]
...
bb.au:                                            ; preds = %.thread337, %bb.at, %._crit_edge
  ...
  %.5257 = phi i64 [ %.4256, %bb.at ], [ %i.eu, %._crit_edge ], [ %i.h, %.thread337 ]
  %.6248 = phi i32 [ %.5247, %bb.at ], [ 1, %._crit_edge ], [ 1, %.thread337 ]
  %i.fq = call i64 asm sideeffect "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 0) #19, !srcloc !46
  %i.fr = icmp eq i64 %.5257, %i.fq
  br i1 %i.fr, label %ssl_parse_inner_plaintext.exit, label %bb.av

bb.av:                                            ; preds = %bb.au
  %.not306 = icmp eq i32 %.6248, 1
