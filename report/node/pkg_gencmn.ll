...
_ZL11allocStringj.exit69.i:                       ; preds = %bb.ae
  ...
  %i.dg = getelementptr inbounds nuw i8, ptr @_ZL11stringStore, i64 %i.df ; 8 uses
...
_ZL11allocStringj.exit70.i:                       ; preds = %_ZL11allocStringj.exit69.i
  ...
  %i.dt = getelementptr inbounds nuw i8, ptr @_ZL11stringStore, i64 %i.ds ; 5 uses
...
.lr.ph.i.preheader.a:                             ; preds = %_ZL11allocStringj.exit70.i
  %i.du = and i64 %i.cx, 4294967295               ; 2 uses
  %min.iters.check = icmp samesign ult i64 %i.du, 32
  %i.dv = sub nsw i64 %i.ds, %i.df
  %diff.check = icmp ult i64 %i.dv, 32
  %or.cond = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond, label %.lr.ph.i.preheader378, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.i.preheader.a
  %n.vec = and i64 %i.cx, 4294967264              ; 5 uses
...
begin_hunk_3_@createCommonDataFile:bb.a
  ...
  br i1 %i.eh, label %middle.block.a, label %vector.body, !llvm.loop !7

middle.block.a:                                   ; preds = %vector.body
  %cmp.n.a = icmp eq i64 %i.du, %n.vec
  br i1 %cmp.n.a, label %._crit_edge.i, label %.lr.ph.i.preheader378

.lr.ph.i.preheader378:                            ; preds = %.lr.ph.i.preheader.a, %middle.block.a
  %.ph = phi i32 [ %i.cy, %.lr.ph.i.preheader.a ], [ %i.dw, %middle.block.a ] ; 4 uses
  %.073.i.ph = phi ptr [ %i.dt, %.lr.ph.i.preheader.a ], [ %i.dx, %middle.block.a ] ; 2 uses
  %.05472.i.ph = phi ptr [ %i.dg, %.lr.ph.i.preheader.a ], [ %i.dy, %middle.block.a ] ; 2 uses
  %i.ei = add i32 %.ph, -1
...
begin_hunk_4_@createCommonDataFile:bb.a
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !10
...
begin_hunk_5_@createCommonDataFile:bb.a
  ...
  br i1 %.not67.i.3, label %._crit_edge.i, label %.lr.ph.i, !llvm.loop !12

._crit_edge.i:                                    ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %middle.block.a, %_ZL11allocStringj.exit70.i
  %.0.lcssa.i = phi ptr [ %i.dt, %_ZL11allocStringj.exit70.i ], [ %i.dx, %middle.block.a ], [ %.lcssa381.unr, %.lr.ph.i.prol.loopexit ], [ %i.fb, %.lr.ph.i ]
...
begin_hunk_7_@createCommonDataFile:bb.a
  ...
  br i1 %niter.ncmp.1, label %._crit_edge233.loopexit.unr-lcssa, label %bb.ao, !llvm.loop !14
...
begin_hunk_8_@createCommonDataFile:bb.a
  ...
  br i1 %i.hr, label %.lr.ph236, label %.preheader203, !llvm.loop !15
...
begin_hunk_9_@createCommonDataFile:bb.a
  ...
  br i1 %i.ia, label %.lr.ph238, label %._crit_edge239, !llvm.loop !16
...
begin_hunk_10_@createCommonDataFile:bb.a
  ...
  br i1 %i.ij, label %.lr.ph247, label %._crit_edge248, !llvm.loop !17
...
begin_hunk_11_@createCommonDataFile:bb.a
  ...
  br i1 %i.jj, label %._crit_edge242, label %.lr.ph241, !llvm.loop !18
...
begin_hunk_12_@createCommonDataFile:bb.a
  ...
  br i1 %i.ln, label %.lr.ph, label %._crit_edge, !llvm.loop !19
...
begin_hunk_13_@createCommonDataFile:bb.a
  ...
  br i1 %i.mk, label %.lr.ph226, label %._crit_edge227, !llvm.loop !20
