...
begin_hunk_1_@_ZL27_Latin1ToUnicodeWithOffsetsP23UConverterToUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %found.conflict, label %.lr.ph.preheader169, label %vector.main.loop.iter.check
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph.preheader169, label %vec.epilog.ph, !prof !16

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec155 = and i64 %i.bo, 2147483644           ; 5 uses
  %.cast156 = trunc nuw nsw i64 %n.vec155 to i32
  %2 = sub nsw i32 %.174126, %.cast156
  %3 = shl nuw nsw i64 %n.vec155, 1
  %4 = getelementptr i8, ptr %.180124, i64 %3     ; 2 uses
  %5 = getelementptr i8, ptr %.183122, i64 %n.vec155 ; 2 uses
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index157 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next161, %vec.epilog.vector.body ] ; 3 uses
  %6 = shl i64 %index157, 1
  %next.gep158 = getelementptr i8, ptr %.180124, i64 %6
  %next.gep159 = getelementptr i8, ptr %.183122, i64 %index157
  %wide.load160 = load <4 x i8>, ptr %next.gep159, align 1, !alias.scope !8
  %7 = zext <4 x i8> %wide.load160 to <4 x i16>
  store <4 x i16> %7, ptr %next.gep158, align 2, !alias.scope !11, !noalias !8
  %index.next161 = add nuw i64 %index157, 4       ; 2 uses
  %8 = icmp eq i64 %index.next161, %n.vec155
  br i1 %8, label %middle.block.a, label %vec.epilog.vector.body, !llvm.loop !17

middle.block.a:                                   ; preds = %vec.epilog.vector.body
  %cmp.n.a = icmp eq i64 %n.vec155, %i.bo
  br i1 %cmp.n.a, label %._crit_edge, label %.lr.ph.preheader169

.lr.ph.preheader169:                              ; preds = %vector.memcheck, %.lr.ph.preheader.a, %vec.epilog.iter.check, %middle.block.a
  %.27897.ph = phi i32 [ %.174126, %.lr.ph.preheader.a ], [ %.174126, %vector.memcheck ], [ %i.bu, %vec.epilog.iter.check ], [ %2, %middle.block.a ]
  %.28196.ph = phi ptr [ %.180124, %.lr.ph.preheader.a ], [ %.180124, %vector.memcheck ], [ %i.bw, %vec.epilog.iter.check ], [ %4, %middle.block.a ]
  %.28495.ph = phi ptr [ %.183122, %.lr.ph.preheader.a ], [ %.183122, %vector.memcheck ], [ %i.bx, %vec.epilog.iter.check ], [ %5, %middle.block.a ]
  br label %.lr.ph
...
begin_hunk_3_@_ZL27_Latin1ToUnicodeWithOffsetsP23UConverterToUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %i.ci, label %.lr.ph, label %._crit_edge, !llvm.loop !18

._crit_edge:                                      ; preds = %.lr.ph, %middle.block.a, %middle.block
  %.lcssa142 = phi ptr [ %5, %middle.block.a ], [ %i.bx, %middle.block ], [ %i.cd, %.lr.ph ]
  %.lcssa141 = phi ptr [ %4, %middle.block.a ], [ %i.bw, %middle.block ], [ %i.cg, %.lr.ph ]
...
begin_hunk_4_@_ZL27_Latin1ToUnicodeWithOffsetsP23UConverterToUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %i.cp, label %middle.block164, label %vector.body159, !llvm.loop !19
...
begin_hunk_7_@_ZL29_Latin1FromUnicodeWithOffsetsP25UConverterFromUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %i.fc, label %.lr.ph, label %.loopexit227, !llvm.loop !22
...
begin_hunk_8_@_ZL29_Latin1FromUnicodeWithOffsetsP25UConverterFromUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %i.fk, label %.lr.ph235, label %.critedge, !llvm.loop !23
...
begin_hunk_9_@_ZL29_Latin1FromUnicodeWithOffsetsP25UConverterFromUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %i.gh, label %middle.block, label %vector.body, !llvm.loop !24
...
begin_hunk_10_@_ZL29_Latin1FromUnicodeWithOffsetsP25UConverterFromUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %.not221, label %.loopexit, label %.lr.ph247, !llvm.loop !25
...
.lr.ph:                                           ; preds = %bb.o
  ...
  br i1 %i.ak, label %.lr.ph126, label %.loopexit.thread, !llvm.loop !26
...
begin_hunk_12_@_ZL19ucnv_Latin1FromUTF8P25UConverterFromUnicodeArgsP23UConverterToUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %i.au, label %.lr.ph, label %.loopexit, !llvm.loop !26
...
begin_hunk_13_@_ZL26_ASCIIToUnicodeWithOffsetsP23UConverterToUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %i.bk, label %bb.c, label %bb.e, !llvm.loop !27
...
begin_hunk_14_@_ZL26_ASCIIToUnicodeWithOffsetsP23UConverterToUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %niter.ncmp.1.not, label %.loopexit132.loopexit.unr-lcssa, label %.lr.ph, !llvm.loop !28
...
begin_hunk_15_@_ZL26_ASCIIToUnicodeWithOffsetsP23UConverterToUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %i.cu, label %.lr.ph144, label %.critedge, !llvm.loop !29
...
begin_hunk_16_@_ZL26_ASCIIToUnicodeWithOffsetsP23UConverterToUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %i.dk, label %middle.block, label %vector.body, !llvm.loop !30
...
begin_hunk_17_@_ZL26_ASCIIToUnicodeWithOffsetsP23UConverterToUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %.not126, label %.loopexit, label %.lr.ph151, !llvm.loop !31
...
begin_hunk_18_@_ZL18ucnv_ASCIIFromUTF8P25UConverterFromUnicodeArgsP23UConverterToUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %i.ck, label %bb.e, label %bb.g, !llvm.loop !32
...
begin_hunk_19_@_ZL18ucnv_ASCIIFromUTF8P25UConverterFromUnicodeArgsP23UConverterToUnicodeArgsP10UErrorCode:bb.a
  ...
  br i1 %i.cs, label %.lr.ph, label %.critedge101, !llvm.loop !33
...
!20 = distinct !{!20, !6, !15, !14}
!21 = distinct !{!21, !6}
!22 = distinct !{!22, !6}
!23 = distinct !{!23, !6}
!24 = distinct !{!24, !6, !14, !15}
!25 = distinct !{!25, !6, !15, !14}
!26 = distinct !{!26, !6}
!27 = distinct !{!27, !6}
!28 = distinct !{!28, !6}
!29 = distinct !{!29, !6}
!30 = distinct !{!30, !6, !14, !15}
!31 = distinct !{!31, !6, !15, !14}
!32 = distinct !{!32, !6}
!33 = distinct !{!33, !6}
end_hunk_20
