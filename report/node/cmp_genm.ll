...
define dso_local range(i32 0, 2) i32 @OSSL_CMP_get1_caCerts(ptr noundef %0, ptr noundef captures(address_is_null) %1) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define dso_local range(i32 0, 2) i32 @OSSL_CMP_get1_rootCaKeyUpdate(ptr noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef captures(address_is_null) %3, ptr noundef writeonly captures(address_is_null) %4) local_unnamed_addr #0 {
bb.a:
