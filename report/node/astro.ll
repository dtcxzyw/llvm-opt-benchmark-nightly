...
_ZN6icu_7818CalendarAstronomer12getJulianDayEv.exit: ; preds = %._crit_edge.i, %bb.c
  ...
  %3 = tail call double @llvm.fmuladd.f64(double %i.l, double f0x3FCD6FB4CCD0BC8D, double f0x401639A2A09C75E2) ; 2 uses
  %4 = fdiv double %3, f0x401921FB54442D18
  %5 = tail call noundef double @uprv_floor_78(double noundef %4) #12
  %6 = tail call noundef double @llvm.fmuladd.f64(double %5, double f0xC01921FB54442D18, double %3) ; 3 uses
  ...
  %i.o = insertelement <2 x double> <double poison, double f0x40163C779EFC0D54>, double %6, i64 0
  ...
  %i.w = load double, ptr %1, align 8             ; 2 uses
  %i.x = fsub double %6, %i.w
  %i.y = fneg double %i.v
  ...
  %i.ac = load double, ptr %2, align 8
