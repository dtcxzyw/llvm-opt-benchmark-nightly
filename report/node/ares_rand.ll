...
ares_reinit_rand.exit:                            ; preds = %.backedge, %.loopexit49, %bb.e
  tail call fastcc void @ares_init_rand_engine(ptr noundef nonnull %0)
  br label %.backedge.backedge

.loopexit:                                        ; preds = %.preheader48
  br i1 %i.v, label %.thread46, label %.backedge.backedge

.backedge.backedge:                               ; preds = %.loopexit, %ares_reinit_rand.exit
  br label %.backedge

.thread46:                                        ; preds = %.loopexit, %bb.c, %ares_rc4_prng.exit
  ret void
}
