...
bb.a:
  ...
  %i.e = tail call noundef i32 %i.d(ptr noundef nonnull align 8 dereferenceable(8) %2, i32 noundef %i.a) #14 ; 7 uses
  ...
  %or.cond.not = select i1 %i.g, i1 true, i1 %i.i
...
bb.e:                                             ; preds = %bb.d, %bb.c, %bb.b, %bb.a
  %.1 = phi i32 [ %i.e, %bb.b ], [ %i.e, %bb.a ], [ %i.e, %bb.c ], [ %i.q, %bb.d ]
  ret i32 %.1
}
...
bb.a:
  ...
  br i1 %or.cond, label %bb.aj, label %bb.b
