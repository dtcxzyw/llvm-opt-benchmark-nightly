...
; Function Attrs: nounwind uwtable
define internal fastcc i32 @do_name_ex(ptr nofree noundef readonly captures(none) %0, ptr noundef %1, ptr noundef %2, i32 noundef %3, i64 noundef range(i64 1, 0) %4) unnamed_addr #0 {
bb.a:
...
bb.b:                                             ; preds = %.lr.ph.i
  ...
  br i1 %exitcond.not.i, label %.loopexit145, label %.lr.ph.i, !llvm.loop !9
...
.loopexit145:                                     ; preds = %bb.b, %bb.a
  %5 = lshr i64 %4, 16
  %6 = and i64 %5, 15
  switch i64 %6, label %.critedge [
    i64 4, label %bb.f
    i64 1, label %bb.c
    i64 2, label %bb.d
    i64 3, label %bb.e
...
bb.e:                                             ; preds = %.loopexit145
  br label %bb.f

bb.f:                                             ; preds = %.loopexit145, %bb.e, %bb.d, %bb.c
  %.093 = phi i32 [ 0, %bb.e ], [ 0, %bb.c ], [ 0, %bb.d ], [ %spec.store.select, %.loopexit145 ] ; 3 uses
  %.092 = phi ptr [ @.str.5, %bb.e ], [ @.str.2, %bb.c ], [ @.str.4, %bb.d ], [ @.str, %.loopexit145 ]
  %.091 = phi ptr [ @.str.1, %bb.e ], [ @.str.3, %bb.c ], [ @.str.1, %bb.d ], [ @.str.1, %.loopexit145 ]
  %.089 = phi i32 [ 2, %bb.e ], [ 1, %bb.c ], [ 2, %bb.d ], [ 1, %.loopexit145 ] ; 2 uses
  %.088 = phi i32 [ 3, %bb.e ], [ 1, %bb.c ], [ 3, %bb.d ], [ 3, %.loopexit145 ] ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph, %bb.z
  %.094148 = phi i32 [ %spec.store.select, %.lr.ph ], [ %i.av, %bb.z ] ; 3 uses
  %.0100147 = phi i32 [ 0, %.lr.ph ], [ %i.aw, %bb.z ] ; 3 uses
  %.0101146 = phi i32 [ -1, %.lr.ph ], [ %i.z, %bb.z ] ; 2 uses
  %i.o = xor i32 %.0100147, -1
  %i.p = add nsw i32 %i.g, %i.o
  %.0100147.sink = select i1 %.not109, i32 %.0100147, i32 %i.p
  %i.q = call ptr @X509_NAME_get_entry(ptr noundef %2, i32 noundef %.0100147.sink) #8 ; 4 uses
  %.not110 = icmp eq i32 %.0101146, -1
  br i1 %.not110, label %bb.n, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.r = call i32 @X509_NAME_ENTRY_set(ptr noundef %i.q) #8
  %i.s = icmp eq i32 %.0101146, %i.r
...
bb.m:                                             ; preds = %.lr.ph.i123
  ...
  br i1 %exitcond.not.i126, label %.loopexit142, label %.lr.ph.i123, !llvm.loop !9
...
.lr.ph.i123:                                      ; preds = %bb.l, %bb.m
  ...
  br i1 %.not.i125, label %.critedge, label %bb.m

.loopexit142:                                     ; preds = %bb.m, %bb.l
  %i.y = add i32 %i.j, %.094148
  br label %bb.n

bb.n:                                             ; preds = %bb.j, %.loopexit142, %bb.g
  %.195 = phi i32 [ %i.u, %bb.j ], [ %i.y, %.loopexit142 ], [ %.094148, %bb.g ] ; 3 uses
  ...
  br i1 %.not114, label %bb.y, label %bb.o
...
bb.t:                                             ; preds = %bb.q, %bb.r, %bb.s, %bb.p
  ...
  br i1 %.not115, label %.critedge, label %bb.u
...
.lr.ph.i129:                                      ; preds = %.lr.ph.i129.preheader, %bb.v
  ...
  br i1 %.not.i131, label %.critedge, label %bb.v
...
bb.w:                                             ; preds = %.loopexit, %bb.u
  ...
  br i1 %.not118, label %.critedge, label %bb.x
...
bb.y:                                             ; preds = %bb.x, %bb.n
  ...
  br i1 %i.au, label %.critedge, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.av = add nsw i32 %i.at, %.4                  ; 2 uses
  %i.aw = add nuw nsw i32 %.0100147, 1            ; 2 uses
  %exitcond.not = icmp eq i32 %i.aw, %i.g
  br i1 %exitcond.not, label %.critedge, label %bb.g, !llvm.loop !13

.critedge:                                        ; preds = %.lr.ph.i, %bb.i, %bb.k, %bb.y, %bb.z, %bb.w, %bb.t, %.lr.ph.i123, %.lr.ph.i129, %bb.f, %.loopexit145
  %.3 = phi i32 [ %spec.store.select, %bb.f ], [ -1, %bb.t ], [ -1, %.lr.ph.i123 ], [ -1, %.loopexit145 ], [ -1, %.lr.ph.i129 ], [ -1, %bb.w ], [ %i.av, %bb.z ], [ -1, %bb.k ], [ -1, %bb.i ], [ -1, %bb.y ], [ -1, %.lr.ph.i ]
