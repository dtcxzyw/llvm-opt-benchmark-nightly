...
bb.a:
  ...
  %i.b = call i32 @RAND_priv_bytes_ex(ptr noundef %0, ptr noundef nonnull %i.a, i64 noundef 16, i32 noundef 128) #7
  %.not = icmp eq i32 %i.b, 1
  br i1 %.not, label %bb.b, label %ossl_quic_srtm_free.exit

bb.b:                                             ; preds = %bb.a
  %i.c = call noalias ptr @CRYPTO_zalloc(i64 noundef 32, ptr noundef nonnull @.str, i32 noundef 119) #7 ; 9 uses
  %i.d = icmp eq ptr %i.c, null
  br i1 %i.d, label %bb.k, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.e = call ptr @EVP_CIPHER_fetch(ptr noundef %0, ptr noundef nonnull @.str.1, ptr noundef %1) #7 ; 5 uses
  %i.f = icmp eq ptr %i.e, null
  br i1 %i.f, label %bb.h, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.g = call ptr @EVP_CIPHER_CTX_new() #7        ; 3 uses
  store ptr %i.g, ptr %i.c, align 8, !tbaa !9
  %i.h = icmp eq ptr %i.g, null
  br i1 %i.h, label %bb.h, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.i = call i32 @EVP_EncryptInit_ex2(ptr noundef nonnull %i.g, ptr noundef nonnull %i.e, ptr noundef nonnull %i.a, ptr noundef null, ptr noundef null) #7
  %.not18 = icmp eq i32 %i.i, 0
  br i1 %.not18, label %bb.h, label %bb.f

bb.f:                                             ; preds = %bb.e
  call void @EVP_CIPHER_free(ptr noundef nonnull %i.e) #7
  %i.j = call ptr @OPENSSL_LH_new(ptr noundef nonnull @items_fwd_hash, ptr noundef nonnull @items_fwd_cmp) #7
  %i.k = call ptr @OPENSSL_LH_set_thunks(ptr noundef %i.j, ptr noundef nonnull @lh_SRTM_ITEM_hfn_thunk, ptr noundef nonnull @lh_SRTM_ITEM_cfn_thunk, ptr noundef nonnull @lh_SRTM_ITEM_doall_thunk, ptr noundef nonnull @lh_SRTM_ITEM_doall_arg_thunk) #7 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  %i.n = call ptr @OPENSSL_LH_new(ptr noundef nonnull @items_rev_hash, ptr noundef nonnull @items_rev_cmp) #7
  %i.o = call ptr @OPENSSL_LH_set_thunks(ptr noundef %i.n, ptr noundef nonnull @lh_SRTM_ITEM_hfn_thunk, ptr noundef nonnull @lh_SRTM_ITEM_cfn_thunk, ptr noundef nonnull @lh_SRTM_ITEM_doall_thunk, ptr noundef nonnull @lh_SRTM_ITEM_doall_arg_thunk) #7 ; 2 uses
...
bb.h:                                             ; preds = %bb.c, %bb.d, %bb.f, %bb.g, %bb.e
  ...
  call void @OPENSSL_LH_free(ptr noundef %i.s) #7
...
bb.i:                                             ; preds = %bb.h
  call void @OPENSSL_LH_doall(ptr noundef nonnull %i.u, ptr noundef nonnull @srtm_free_each) #7
  call void @OPENSSL_LH_free(ptr noundef nonnull %i.u) #7
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h
  %i.v = load ptr, ptr %i.c, align 8, !tbaa !9
  call void @EVP_CIPHER_CTX_free(ptr noundef %i.v) #7
  call void @CRYPTO_free(ptr noundef nonnull %i.c, ptr noundef nonnull @.str, i32 noundef 176) #7
  br label %ossl_quic_srtm_free.exit

ossl_quic_srtm_free.exit:                         ; preds = %bb.a, %bb.j
  %.023 = phi ptr [ %.0.ph, %bb.j ], [ null, %bb.a ]
  call void @EVP_CIPHER_free(ptr noundef %.023) #7
  br label %bb.k
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define internal i32 @items_rev_cmp(ptr noundef readonly captures(none) %0, ptr noundef readonly captures(none) %1) #3 {
loadbb:
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void @OPENSSL_LH_free(ptr noundef %i.c) #7
...
bb.c:                                             ; preds = %bb.b
  tail call void @OPENSSL_LH_doall(ptr noundef nonnull %i.e, ptr noundef nonnull @srtm_free_each) #7
  %i.f = load ptr, ptr %i.d, align 8, !tbaa !14
  tail call void @OPENSSL_LH_free(ptr noundef %i.f) #7
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %i.g = load ptr, ptr %0, align 8, !tbaa !9
  tail call void @EVP_CIPHER_CTX_free(ptr noundef %i.g) #7
  tail call void @CRYPTO_free(ptr noundef nonnull %0, ptr noundef nonnull @.str, i32 noundef 176) #7
  br label %bb.e
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  tail call void @CRYPTO_free(ptr noundef nonnull %.08, ptr noundef nonnull @.str, i32 noundef 158) #7
  %.not = icmp eq ptr %i.d, null
  br i1 %.not, label %._crit_edge, label %.lr.ph, !llvm.loop !22

._crit_edge:                                      ; preds = %.lr.ph, %bb.a
  tail call void @CRYPTO_free(ptr noundef nonnull %0, ptr noundef nonnull @.str, i32 noundef 161) #7
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = call ptr @OPENSSL_LH_retrieve(ptr noundef %.val, ptr noundef nonnull %4) #7 ; 7 uses
...
.loopexit:                                        ; preds = %bb.c, %bb.d, %bb.b
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #7
  %i.o = call noalias ptr @CRYPTO_zalloc(i64 noundef 64, ptr noundef nonnull @.str, i32 noundef 294) #7 ; 15 uses
...
bb.e:                                             ; preds = %.loopexit
  ...
  %i.u = call i32 @EVP_EncryptUpdate(ptr noundef %.val50, ptr noundef nonnull %i.t, ptr noundef nonnull %i.a, ptr noundef nonnull %i.s, i32 noundef 16) #7
...
bb.f:                                             ; preds = %bb.e
  call void @CRYPTO_free(ptr noundef nonnull %i.o, ptr noundef nonnull @.str, i32 noundef 301) #7
  br label %srtm_check_lh.exit60
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.y = call ptr @OPENSSL_LH_insert(ptr noundef %i.x, ptr noundef nonnull %i.o) #7 ; 0 uses
  %i.z = load ptr, ptr %i.f, align 8, !tbaa !14
  %i.aa = call i32 @OPENSSL_LH_error(ptr noundef %i.z) #7
...
bb.i:                                             ; preds = %bb.h
  ...
  call void @CRYPTO_free(ptr noundef nonnull %i.o, ptr noundef nonnull @.str, i32 noundef 310) #7
  br label %srtm_check_lh.exit60
...
bb.l:                                             ; preds = %sorted_insert_seq_num.exit
  ...
  %i.ar = call ptr @OPENSSL_LH_insert(ptr noundef %i.aq, ptr noundef %.0..0..0.) #7 ; 0 uses
  %i.as = load ptr, ptr %i.f, align 8, !tbaa !14
  %i.at = call i32 @OPENSSL_LH_error(ptr noundef %i.as) #7
...
bb.m:                                             ; preds = %bb.l
  ...
  call void @CRYPTO_free(ptr noundef nonnull %i.o, ptr noundef nonnull @.str, i32 noundef 318) #7
  br label %srtm_check_lh.exit60
...
srtm_check_lh.exit:                               ; preds = %bb.l, %bb.h, %sorted_insert_seq_num.exit
  ...
  %i.ay = call ptr @OPENSSL_LH_retrieve(ptr noundef %i.ax, ptr noundef nonnull %i.o) #7 ; 6 uses
  %i.az = icmp eq ptr %i.ay, null
  br i1 %i.az, label %bb.n, label %bb.o

bb.n:                                             ; preds = %srtm_check_lh.exit
  %i.ba = load ptr, ptr %i.aw, align 8, !tbaa !15
  %i.bb = call ptr @OPENSSL_LH_insert(ptr noundef %i.ba, ptr noundef nonnull %i.o) #7 ; 0 uses
  %i.bc = load ptr, ptr %i.aw, align 8, !tbaa !15
  %i.bd = call i32 @OPENSSL_LH_error(ptr noundef %i.bc) #7
...
bb.q:                                             ; preds = %sorted_insert_srt.exit
  ...
  %i.bq = call ptr @OPENSSL_LH_insert(ptr noundef %i.bp, ptr noundef %.0..0..0.68) #7 ; 0 uses
  %i.br = load ptr, ptr %i.aw, align 8, !tbaa !15
  %i.bs = call i32 @OPENSSL_LH_error(ptr noundef %i.br) #7
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = call ptr @OPENSSL_LH_retrieve(ptr noundef %.val, ptr noundef nonnull %3) #7 ; 7 uses
...
bb.e:                                             ; preds = %bb.d
  %i.t = call ptr @OPENSSL_LH_insert(ptr noundef %i.s, ptr noundef nonnull %i.r) #7 ; 0 uses
  %i.u = load ptr, ptr %i.d, align 8, !tbaa !14
  %i.v = call i32 @OPENSSL_LH_error(ptr noundef %i.u) #7
...
bb.f:                                             ; preds = %bb.d
  %i.y = call ptr @OPENSSL_LH_delete(ptr noundef %i.s, ptr noundef nonnull %i.f) #7 ; 0 uses
...
srtm_check_lh.exit:                               ; preds = %bb.e, %bb.f, %bb.g
  ...
  %i.ae = call ptr @OPENSSL_LH_retrieve(ptr noundef %i.ad, ptr noundef nonnull %.0152.i.lcssa44) #7 ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  %i.ai = call ptr @OPENSSL_LH_insert(ptr noundef %i.ah, ptr noundef nonnull %i.ag) #7 ; 0 uses
  %i.aj = load ptr, ptr %i.ac, align 8, !tbaa !15
  %i.ak = call i32 @OPENSSL_LH_error(ptr noundef %i.aj) #7
  %.not.i.i = icmp eq i32 %i.ak, 0
  br i1 %.not.i.i, label %bb.l, label %srtm_remove_from_rev.exit

bb.j:                                             ; preds = %bb.h
  %i.al = call ptr @OPENSSL_LH_delete(ptr noundef %i.ah, ptr noundef nonnull %.0152.i.lcssa44) #7 ; 0 uses
  br label %bb.l
...
bb.l:                                             ; preds = %bb.i, %bb.j, %bb.k
  call void @CRYPTO_free(ptr noundef nonnull %.0152.i.lcssa44, ptr noundef nonnull @.str, i32 noundef 412) #7
  br label %bb.m
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = call ptr @OPENSSL_LH_retrieve(ptr noundef %i.f, ptr noundef nonnull %2) #7 ; 11 uses
  %i.h = icmp eq ptr %i.g, null
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.m = call ptr @OPENSSL_LH_retrieve(ptr noundef %i.l, ptr noundef nonnull %.01729) #7 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  %i.q = call ptr @OPENSSL_LH_insert(ptr noundef %i.p, ptr noundef nonnull %i.o) #7 ; 0 uses
  %i.r = load ptr, ptr %i.i, align 8, !tbaa !15
  %i.s = call i32 @OPENSSL_LH_error(ptr noundef %i.r) #7
...
bb.g:                                             ; preds = %bb.e
  %i.v = call ptr @OPENSSL_LH_delete(ptr noundef %i.p, ptr noundef nonnull %.01729) #7 ; 0 uses
  br label %srtm_remove_from_rev.exit
...
srtm_remove_from_rev.exit:                        ; preds = %bb.f, %srtm_check_lh.exit.thread.i, %bb.g, %bb.h
  call void @CRYPTO_free(ptr noundef nonnull %.01729, ptr noundef nonnull @.str, i32 noundef 432) #7
  br label %bb.i
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.z = call ptr @OPENSSL_LH_delete(ptr noundef %i.y, ptr noundef nonnull %i.g) #7 ; 0 uses
  %i.aa = load ptr, ptr %i.i, align 8, !tbaa !15
  %i.ab = call ptr @OPENSSL_LH_retrieve(ptr noundef %i.aa, ptr noundef nonnull %i.g) #7 ; 2 uses
...
bb.l:                                             ; preds = %bb.k
  %i.af = call ptr @OPENSSL_LH_insert(ptr noundef %i.ae, ptr noundef nonnull %i.ad) #7 ; 0 uses
  %i.ag = load ptr, ptr %i.i, align 8, !tbaa !15
  %i.ah = call i32 @OPENSSL_LH_error(ptr noundef %i.ag) #7
...
bb.m:                                             ; preds = %bb.k
  %i.ak = call ptr @OPENSSL_LH_delete(ptr noundef %i.ae, ptr noundef nonnull %i.g) #7 ; 0 uses
  br label %srtm_remove_from_rev.exit28
...
srtm_remove_from_rev.exit28:                      ; preds = %bb.l, %srtm_check_lh.exit.thread.i27, %bb.m, %bb.n
  call void @CRYPTO_free(ptr noundef nonnull %i.g, ptr noundef nonnull @.str, i32 noundef 438) #7
  br label %bb.o
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = call i32 @EVP_EncryptUpdate(ptr noundef %.val, ptr noundef nonnull %i.e, ptr noundef nonnull %i.a, ptr noundef %1, i32 noundef 16) #7
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.k = call ptr @OPENSSL_LH_retrieve(ptr noundef %i.j, ptr noundef nonnull %5) #7 ; 3 uses
  %i.l = icmp ne i64 %2, 0
...
define dso_local void @ossl_quic_srtm_check(ptr noundef readnone captures(none) %0) local_unnamed_addr #4 {
bb.a:
  ret void
}
...
bb.a:
  %i.a = tail call i64 %1(ptr noundef %0) #7
  ret i64 %i.a
}
...
bb.a:
  %i.a = tail call i32 %2(ptr noundef %0, ptr noundef %1) #7
  ret i32 %i.a
}

; Function Attrs: inlinehint nounwind uwtable
define internal void @lh_SRTM_ITEM_doall_thunk(ptr noundef %0, ptr noundef readonly captures(none) %1) #5 {
bb.a:
...
; Function Attrs: inlinehint nounwind uwtable
define internal void @lh_SRTM_ITEM_doall_arg_thunk(ptr noundef %0, ptr noundef %1, ptr noundef readonly captures(none) %2) #5 {
bb.a:
