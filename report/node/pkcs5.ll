...
.lr.ph76.split.us:                                ; preds = %.lr.ph76.split.us.preheader, %bb.h
  %.075.us = phi ptr [ %i.bm, %bb.h ], [ %7, %.lr.ph76.split.us.preheader ] ; 2 uses
  %.03774.us = phi i32 [ %i.bl, %bb.h ], [ %6, %.lr.ph76.split.us.preheader ] ; 2 uses
...
bb.e:                                             ; preds = %._crit_edge.us
  %i.v = load i8, ptr %i.k, align 2, !tbaa !20
  %i.w = add i8 %i.v, 1                           ; 2 uses
  store i8 %i.w, ptr %i.k, align 2, !tbaa !20
  %.not58.us.1 = icmp eq i8 %i.w, 0
  br i1 %.not58.us.1, label %bb.f, label %bb.h

bb.f:                                             ; preds = %bb.e
  %i.x = load i8, ptr %i.l, align 1, !tbaa !20
  %i.y = add i8 %i.x, 1                           ; 2 uses
  store i8 %i.y, ptr %i.l, align 1, !tbaa !20
  %.not58.us.2 = icmp eq i8 %i.y, 0
  br i1 %.not58.us.2, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f
  %i.z = load i8, ptr %i.c, align 4, !tbaa !20
  %i.aa = add i8 %i.z, 1
  store i8 %i.aa, ptr %i.c, align 4, !tbaa !20
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f, %bb.e, %._crit_edge.us
  %.not52.us = icmp eq i32 %i.bl, 0
  br i1 %.not52.us, label %.loopexit, label %.lr.ph76.split.us, !llvm.loop !21

bb.i:                                             ; preds = %.lr.ph72.us, %mbedtls_xor.exit.us
  %.03871.us = phi i32 [ 1, %.lr.ph72.us ], [ %i.aj, %mbedtls_xor.exit.us ]
  %i.ab = call i32 @mbedtls_md_hmac_update(ptr noundef nonnull %0, ptr noundef nonnull %i.a, i64 noundef %i.h) #6 ; 2 uses
  %.not59.us = icmp eq i32 %i.ab, 0
  br i1 %.not59.us, label %bb.j, label %.loopexit

bb.j:                                             ; preds = %bb.i
  %i.ac = call i32 @mbedtls_md_hmac_finish(ptr noundef nonnull %0, ptr noundef nonnull %i.a) #6 ; 2 uses
  %.not60.us = icmp eq i32 %i.ac, 0
  br i1 %.not60.us, label %bb.k, label %.loopexit
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader149, %.lr.ph.us
  ...
  %.0.i68.us = phi i64 [ %i.ae, %.lr.ph.us ], [ %.0.i68.us.ph, %.lr.ph.us.preheader149 ] ; 2 uses
  %i.af = getelementptr inbounds nuw i8, ptr %i.b, i64 %.0.i68.us ; 2 uses
  %.0.copyload.i62.us = load i64, ptr %i.af, align 1
  %i.ag = getelementptr inbounds nuw i8, ptr %i.a, i64 %.0.i68.us
  %.0.copyload.i.us = load i64, ptr %i.ag, align 1
  %i.ah = xor i64 %.0.copyload.i.us, %.0.copyload.i62.us
  store i64 %i.ah, ptr %i.af, align 1
  %i.ai = add nuw nsw i64 %i.ae, 8                ; 2 uses
  %.not.i.us = icmp samesign ugt i64 %i.ai, %i.h
...
mbedtls_xor.exit.us:                              ; preds = %.lr.ph70.us, %middle.block, %vec.epilog.middle.block, %.preheader.us
  ...
  br i1 %exitcond96.not, label %._crit_edge.us, label %bb.i, !llvm.loop !26

.lr.ph70.us:                                      ; preds = %.lr.ph70.us.preheader, %.lr.ph70.us
  %.1.i69.us = phi i64 [ %i.ap, %.lr.ph70.us ], [ %.1.i69.us.ph, %.lr.ph70.us.preheader ] ; 3 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %i.b, i64 %.1.i69.us ; 2 uses
  %i.al = load i8, ptr %i.ak, align 1, !tbaa !20
  %i.am = getelementptr inbounds nuw i8, ptr %i.a, i64 %.1.i69.us
  %i.an = load i8, ptr %i.am, align 1, !tbaa !20
  %i.ao = xor i8 %i.an, %i.al
  store i8 %i.ao, ptr %i.ak, align 1, !tbaa !20
  %i.ap = add nuw nsw i64 %.1.i69.us, 1           ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.at = add i64 %.0.i.lcssa.us, %index          ; 2 uses
  %i.au = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.at ; 3 uses
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 16 ; 2 uses
  %wide.load = load <16 x i8>, ptr %i.au, align 1, !tbaa !20
  %wide.load124 = load <16 x i8>, ptr %i.av, align 1, !tbaa !20
  %i.aw = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.at ; 2 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 16
  %wide.load125 = load <16 x i8>, ptr %i.aw, align 1, !tbaa !20
  %wide.load126 = load <16 x i8>, ptr %i.ax, align 1, !tbaa !20
  %i.ay = xor <16 x i8> %wide.load125, %wide.load
  %i.az = xor <16 x i8> %wide.load126, %wide.load124
  store <16 x i8> %i.ay, ptr %i.au, align 1, !tbaa !20
  store <16 x i8> %i.az, ptr %i.av, align 1, !tbaa !20
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.bc = add i64 %.0.i.lcssa.us, %index129       ; 2 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %i.b, i64 %i.bc ; 2 uses
  %wide.load130 = load <8 x i8>, ptr %i.bd, align 1, !tbaa !20
  %i.be = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.bc
  %wide.load131 = load <8 x i8>, ptr %i.be, align 1, !tbaa !20
  %i.bf = xor <8 x i8> %wide.load131, %wide.load130
  store <8 x i8> %i.bf, ptr %i.bd, align 1, !tbaa !20
...
._crit_edge.us:                                   ; preds = %mbedtls_xor.exit.us
  ...
  %i.bn = load i8, ptr %i.f, align 1, !tbaa !20
  %i.bo = add i8 %i.bn, 1                         ; 2 uses
  store i8 %i.bo, ptr %i.f, align 1, !tbaa !20
  %.not58.us = icmp eq i8 %i.bo, 0
  br i1 %.not58.us, label %bb.e, label %bb.h
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bx = load i8, ptr %i.f, align 1, !tbaa !20
  %i.by = add i8 %i.bx, 1                         ; 2 uses
  store i8 %i.by, ptr %i.f, align 1, !tbaa !20
  %.not58 = icmp eq i8 %i.by, 0
  br i1 %.not58, label %bb.p, label %bb.s

bb.p:                                             ; preds = %bb.o
  %i.bz = load i8, ptr %i.k, align 2, !tbaa !20
  %i.ca = add i8 %i.bz, 1                         ; 2 uses
  store i8 %i.ca, ptr %i.k, align 2, !tbaa !20
  %.not58.1 = icmp eq i8 %i.ca, 0
  br i1 %.not58.1, label %bb.q, label %bb.s

bb.q:                                             ; preds = %bb.p
  %i.cb = load i8, ptr %i.l, align 1, !tbaa !20
  %i.cc = add i8 %i.cb, 1                         ; 2 uses
  store i8 %i.cc, ptr %i.l, align 1, !tbaa !20
  %.not58.2 = icmp eq i8 %i.cc, 0
  br i1 %.not58.2, label %bb.r, label %bb.s

bb.r:                                             ; preds = %bb.q
  %i.cd = load i8, ptr %i.c, align 4, !tbaa !20
  %i.ce = add i8 %i.cd, 1
  store i8 %i.ce, ptr %i.c, align 4, !tbaa !20
  br label %bb.s

bb.s:                                             ; preds = %bb.r, %bb.q, %bb.p, %bb.o
  %.not52 = icmp eq i32 %i.bv, 0
  br i1 %.not52, label %.loopexit, label %.lr.ph76.split, !llvm.loop !21

.loopexit:                                        ; preds = %.lr.ph76.split, %bb.l, %bb.m, %bb.n, %bb.s, %.lr.ph76.split.us, %bb.b, %bb.c, %bb.d, %bb.h, %bb.k, %bb.j, %bb.i, %.preheader64
  %.2 = phi i32 [ 0, %.preheader64 ], [ %i.u, %bb.d ], [ %i.ab, %bb.i ], [ %i.ad, %bb.k ], [ %i.ac, %bb.j ], [ 0, %bb.h ], [ %i.r, %.lr.ph76.split.us ], [ %i.s, %bb.b ], [ %i.t, %bb.c ], [ %i.bp, %.lr.ph76.split ], [ 0, %bb.s ], [ %i.bs, %bb.n ], [ %i.br, %bb.m ], [ %i.bq, %bb.l ]
