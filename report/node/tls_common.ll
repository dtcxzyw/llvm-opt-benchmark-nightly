...
bb.d:                                             ; preds = %bb.c
  store i64 %i.h, ptr %i.k, align 8, !tbaa !48
  br label %bb.e

bb.e:                                             ; preds = %._crit_edge181, %bb.d
  %i.l = phi i64 [ %.pre, %._crit_edge181 ], [ %i.h, %bb.d ]
...
bb.h:                                             ; preds = %bb.f
  ...
  %i.t = getelementptr inbounds nuw i8, ptr %i.e, i64 %i.h ; 4 uses
...
begin_hunk_5_@tls_initialise_write_packets_default:bb.a
  ...
  %i.r = tail call i32 @WPACKET_allocate_bytes(ptr noundef %i.b, i64 noundef %i.k, ptr noundef null) #13
