...
bb.b:                                             ; preds = %.lr.ph61, %._crit_edge
  ...
  %.sroa.01.0.copyload.i = load i32, ptr %i.k, align 4, !noalias !15 ; 2 uses
  %i.l = getelementptr inbounds nuw i8, ptr %i.j, i64 48
  %.sroa.0.0.copyload.i15 = load i32, ptr %i.l, align 8, !noalias !15 ; 2 uses
...
bb.k:                                             ; preds = %bb.j, %_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit
  ...
  br i1 %.not.i.i, label %_ZNK2v88internal8compiler10turboshaft23GrowingOpIndexSidetableINS0_14SourcePositionEEixENS2_7OpIndexE.exit, label %bb.l, !prof !7
...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %.not.i.i28, label %bb.m, label %_ZN2v88internal10ZoneVectorINS0_14SourcePositionEE14EnsureCapacityEm.exit.i29, !prof !8
...
.lr.ph.preheader.i30:                             ; preds = %_ZN2v88internal10ZoneVectorINS0_14SourcePositionEE14EnsureCapacityEm.exit.i29
  %i.cl = ptrtoaddr ptr %i.ch to i64
...
.lr.ph.preheader.i:                               ; preds = %_ZN2v88internal10ZoneVectorINS0_14SourcePositionEE14EnsureCapacityEm.exit.i
  %i.da = ptrtoaddr ptr %i.cj to i64
  %i.db = xor i64 %i.da, -1
  %i.dc = add i64 %i.cv, %i.db
  %i.dd = and i64 %i.dc, -8
  %i.de = add i64 %i.dd, 8
...
bb.b:                                             ; preds = %.lr.ph97, %._crit_edge93
  ...
  %.sroa.01.0.copyload.i = load i32, ptr %i.r, align 4, !noalias !21 ; 2 uses
  %i.s = getelementptr inbounds nuw i8, ptr %i.q, i64 48
  %.sroa.0.0.copyload.i31 = load i32, ptr %i.s, align 8, !noalias !21 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.bh, label %middle.block, label %vector.body, !llvm.loop !18
