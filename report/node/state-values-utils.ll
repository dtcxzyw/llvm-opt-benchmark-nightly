...
bb.c:                                             ; preds = %bb.c, %.lr.ph
  ...
  br i1 %or.cond.not, label %bb.c, label %.loopexit, !llvm.loop !0
...
_ZNK2v88internal8compiler4Node7InputAtEi.exit.us: ; preds = %_ZNK2v88internal8compiler4Node7InputAtEi.exit.us, %.lr.ph.split.us
  ...
  br i1 %or.cond.not, label %_ZNK2v88internal8compiler4Node7InputAtEi.exit.us, label %.loopexit, !llvm.loop !14
...
_ZNK2v88internal8compiler4Node7InputAtEi.exit:    ; preds = %.lr.ph, %_ZNK2v88internal8compiler4Node7InputAtEi.exit
  ...
  br i1 %or.cond29.not, label %_ZNK2v88internal8compiler4Node7InputAtEi.exit, label %.loopexit, !llvm.loop !14
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not.i.i, label %bb.c, label %_ZN2v88internal10ZoneVectorISt5arrayIPNS0_8compiler4NodeELm8EEE14EnsureCapacityEm.exit.i, !prof !11
...
.lr.ph.preheader.i:                               ; preds = %_ZN2v88internal10ZoneVectorISt5arrayIPNS0_8compiler4NodeELm8EEE14EnsureCapacityEm.exit.i
  %i.t = ptrtoaddr ptr %i.p to i64                ; 2 uses
  %i.u = ptrtoaddr ptr %i.q to i64
  %i.v = shl nuw nsw i64 %i.j, 6
  %2 = add nuw i64 %i.v, %i.u
  %i.w = add i64 %i.t, 64
  %umax.i = tail call i64 @llvm.umax.i64(i64 %2, i64 %i.w)
  %i.x = xor i64 %i.t, -1
  %i.y = add i64 %umax.i, %i.x
  %i.z = and i64 %i.y, -64
  %i.aa = add i64 %i.z, 64
...
bb.e:                                             ; preds = %bb.d, %.lr.ph.i.1
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.i.unr-lcssa, label %.lr.ph.i, !llvm.loop !15
...
bb.f:                                             ; preds = %_ZN2v88internal8compiler12_GLOBAL__N_118StateValuesHashKeyEPPNS1_4NodeEm.exit
  ...
  br i1 %i.bh, label %bb.g, label %_ZN2v88internal4Zone3NewINS0_8compiler16StateValuesCache7NodeKeyEJRPNS3_4NodeEEEEPT_DpOT0_.exit, !prof !11
...
bb.b:                                             ; preds = %.lr.ph.split.us
  ...
  br i1 %i.t, label %.lr.ph.split.us, label %.critedge, !llvm.loop !1
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  br i1 %i.at, label %.lr.ph.split, label %.critedge, !llvm.loop !1
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not.i.i.i, label %bb.c, label %_ZN2v88internal10ZoneVectorISt5arrayIPNS0_8compiler4NodeELm8EEE14EnsureCapacityEm.exit.i.i, !prof !11
...
.lr.ph.preheader.i.i:                             ; preds = %_ZN2v88internal10ZoneVectorISt5arrayIPNS0_8compiler4NodeELm8EEE14EnsureCapacityEm.exit.i.i
  ...
  %i.u = ptrtoaddr ptr %i.q to i64
  %i.v = shl nuw nsw i64 %i.j, 6
  %6 = add nuw i64 %i.v, %i.u
  %i.w = add i64 %i.t, 64
  %umax.i.i = tail call i64 @llvm.umax.i64(i64 %6, i64 %i.w)
  %7 = xor i64 %i.t, -1
  %i.x = add i64 %umax.i.i, %7
  %i.y = and i64 %i.x, -64
  %i.z = add i64 %i.y, 64
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %i.da, label %.lr.ph.split.i, label %_ZN2v88internal8compiler16StateValuesCache20FillBufferWithValuesEPSt5arrayIPNS1_4NodeELm8EEPmS8_PS5_mPKNS1_21BytecodeLivenessStateE.exit.loopexit, !llvm.loop !1
