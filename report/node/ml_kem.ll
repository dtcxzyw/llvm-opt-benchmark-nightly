...
vector.body117:                                   ; preds = %vector.memcheck100, %vector.body117
  ...
  %wide.vec122 = load <8 x i16>, ptr %next.gep121, align 2, !tbaa !38, !alias.scope !52
  %4 = freeze <8 x i16> %wide.vec122              ; 2 uses
  %5 = bitcast <8 x i16> %4 to <4 x i32>
  %6 = bitcast <8 x i16> %4 to <4 x i32>
  %7 = and <4 x i32> %6, splat (i32 65535)        ; 2 uses
  %8 = lshr <4 x i32> %5, splat (i32 16)          ; 2 uses
  %wide.vec125 = load <8 x i16>, ptr %next.gep120, align 2, !tbaa !38, !alias.scope !55
  %9 = freeze <8 x i16> %wide.vec125              ; 2 uses
  %10 = bitcast <8 x i16> %9 to <4 x i32>
  %11 = bitcast <8 x i16> %9 to <4 x i32>
  %12 = and <4 x i32> %11, splat (i32 65535)      ; 2 uses
  %13 = lshr <4 x i32> %10, splat (i32 16)        ; 2 uses
  %wide.load128 = load <4 x i16>, ptr %next.gep119, align 8, !tbaa !38, !alias.scope !57
  %i.bk = zext <4 x i16> %wide.load128 to <4 x i32>
  %wide.vec129 = load <8 x i16>, ptr %i.bj, align 2, !tbaa !38, !alias.scope !59, !noalias !61
  %14 = freeze <8 x i16> %wide.vec129             ; 2 uses
  ...
  %i.bl = mul nuw <4 x i32> %12, %7
  %i.bm = add nuw <4 x i32> %i.bl, %17
  %i.bn = mul nuw <4 x i32> %13, %8               ; 2 uses
  ...
  %i.cp = mul nuw <4 x i32> %13, %7
  %i.cq = mul nuw <4 x i32> %8, %12
  %i.cr = add <4 x i32> %i.cp, %i.cq
  %i.cs = add <4 x i32> %i.cr, %18                ; 2 uses
...
vector.body:                                      ; preds = %.lr.ph.i, %vector.body
  ...
  %wide.vec = load <8 x i16>, ptr %next.gep92, align 2, !tbaa !38, !alias.scope !66
  %19 = freeze <8 x i16> %wide.vec                ; 2 uses
  %20 = bitcast <8 x i16> %19 to <4 x i32>
  %21 = bitcast <8 x i16> %19 to <4 x i32>
  %22 = and <4 x i32> %21, splat (i32 65535)      ; 2 uses
  %23 = lshr <4 x i32> %20, splat (i32 16)        ; 2 uses
  %wide.vec94 = load <8 x i16>, ptr %next.gep91, align 2, !tbaa !38, !alias.scope !69
  %24 = freeze <8 x i16> %wide.vec94              ; 2 uses
  %25 = bitcast <8 x i16> %24 to <4 x i32>
  %26 = bitcast <8 x i16> %24 to <4 x i32>
  %27 = and <4 x i32> %26, splat (i32 65535)      ; 2 uses
  %28 = lshr <4 x i32> %25, splat (i32 16)        ; 2 uses
  %wide.load = load <4 x i16>, ptr %next.gep, align 8, !tbaa !38, !alias.scope !71
  %i.fv = zext <4 x i16> %wide.load to <4 x i32>
  %wide.vec97 = load <8 x i16>, ptr %i.fu, align 2, !tbaa !38, !alias.scope !73, !noalias !75
  %29 = freeze <8 x i16> %wide.vec97              ; 2 uses
  %30 = bitcast <8 x i16> %29 to <4 x i32>
  %31 = bitcast <8 x i16> %29 to <4 x i32>
  %32 = and <4 x i32> %31, splat (i32 65535)
  %33 = lshr <4 x i32> %30, splat (i32 16)
  %i.fw = mul nuw <4 x i32> %27, %22
  %i.fx = add nuw <4 x i32> %i.fw, %32
  %i.fy = mul nuw <4 x i32> %28, %23              ; 2 uses
  ...
  %i.ha = mul nuw <4 x i32> %28, %22
  %i.hb = mul nuw <4 x i32> %23, %27
  %i.hc = add <4 x i32> %i.ha, %i.hb
  %i.hd = add <4 x i32> %i.hc, %33                ; 2 uses
...
vector.body193:                                   ; preds = %.preheader.i, %vector.body193
  ...
  %i.cg = mul nuw <4 x i32> %16, %10
  %i.ch = mul nuw <4 x i32> %11, %15
...
vector.body:                                      ; preds = %.lr.ph.i, %vector.body
  ...
  %17 = freeze <8 x i16> %wide.vec                ; 2 uses
  %18 = bitcast <8 x i16> %17 to <4 x i32>
  %19 = bitcast <8 x i16> %17 to <4 x i32>
  %20 = and <4 x i32> %19, splat (i32 65535)      ; 2 uses
  %21 = lshr <4 x i32> %18, splat (i32 16)        ; 2 uses
  %wide.vec142 = load <8 x i16>, ptr %next.gep139, align 2, !tbaa !38
  %22 = freeze <8 x i16> %wide.vec142             ; 2 uses
  %23 = bitcast <8 x i16> %22 to <4 x i32>
  %24 = bitcast <8 x i16> %22 to <4 x i32>
  %25 = and <4 x i32> %24, splat (i32 65535)      ; 2 uses
  %26 = lshr <4 x i32> %23, splat (i32 16)        ; 2 uses
  %wide.load = load <4 x i16>, ptr %next.gep, align 8, !tbaa !38, !alias.scope !139
  %i.gd = zext <4 x i16> %wide.load to <4 x i32>
  %wide.vec145 = load <8 x i16>, ptr %i.gc, align 2, !tbaa !38
  %27 = freeze <8 x i16> %wide.vec145             ; 2 uses
  %28 = bitcast <8 x i16> %27 to <4 x i32>
  %29 = bitcast <8 x i16> %27 to <4 x i32>
  %30 = and <4 x i32> %29, splat (i32 65535)
  %31 = lshr <4 x i32> %28, splat (i32 16)
  %i.ge = mul nuw <4 x i32> %25, %20
  %i.gf = add nuw <4 x i32> %i.ge, %30
  %i.gg = mul nuw <4 x i32> %26, %21              ; 2 uses
  ...
  %i.hi = mul nuw <4 x i32> %26, %20
  %i.hj = mul nuw <4 x i32> %21, %25
  %i.hk = add <4 x i32> %i.hi, %i.hj
  %i.hl = add <4 x i32> %i.hk, %31                ; 2 uses
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %wide.vec = load <8 x i16>, ptr %next.gep27, align 2, !tbaa !38, !alias.scope !161
  %4 = freeze <8 x i16> %wide.vec                 ; 2 uses
  %5 = bitcast <8 x i16> %4 to <4 x i32>
  %6 = bitcast <8 x i16> %4 to <4 x i32>
  %7 = and <4 x i32> %6, splat (i32 65535)        ; 2 uses
  %8 = lshr <4 x i32> %5, splat (i32 16)          ; 2 uses
  %wide.vec29 = load <8 x i16>, ptr %next.gep26, align 2, !tbaa !38, !alias.scope !164
  %9 = freeze <8 x i16> %wide.vec29               ; 2 uses
  %10 = bitcast <8 x i16> %9 to <4 x i32>
  %11 = bitcast <8 x i16> %9 to <4 x i32>
  %12 = and <4 x i32> %11, splat (i32 65535)      ; 2 uses
  %13 = lshr <4 x i32> %10, splat (i32 16)        ; 2 uses
  ...
  %i.e = mul nuw <4 x i32> %12, %7
  %i.f = mul nuw <4 x i32> %13, %8                ; 2 uses
  ...
  %i.ah = mul nuw <4 x i32> %13, %7
  %i.ai = mul nuw <4 x i32> %8, %12
...
vector.body51:                                    ; preds = %.lr.ph, %vector.body51
  ...
  %14 = freeze <8 x i16> %wide.vec56              ; 2 uses
  %15 = bitcast <8 x i16> %14 to <4 x i32>
  %16 = bitcast <8 x i16> %14 to <4 x i32>
  %17 = and <4 x i32> %16, splat (i32 65535)      ; 2 uses
  %18 = lshr <4 x i32> %15, splat (i32 16)        ; 2 uses
  %wide.vec59 = load <8 x i16>, ptr %next.gep54, align 2, !tbaa !38, !alias.scope !176
  %19 = freeze <8 x i16> %wide.vec59              ; 2 uses
  %20 = bitcast <8 x i16> %19 to <4 x i32>
  %21 = bitcast <8 x i16> %19 to <4 x i32>
  %22 = and <4 x i32> %21, splat (i32 65535)      ; 2 uses
  %23 = lshr <4 x i32> %20, splat (i32 16)        ; 2 uses
  ...
  %wide.vec63 = load <8 x i16>, ptr %i.dh, align 2, !tbaa !38, !alias.scope !180, !noalias !182
  %24 = freeze <8 x i16> %wide.vec63              ; 2 uses
  %25 = bitcast <8 x i16> %24 to <4 x i32>
  %26 = bitcast <8 x i16> %24 to <4 x i32>
  %27 = and <4 x i32> %26, splat (i32 65535)
  %28 = lshr <4 x i32> %25, splat (i32 16)
  %i.dj = mul nuw <4 x i32> %22, %17
  %i.dk = add nuw <4 x i32> %i.dj, %27
  %i.dl = mul nuw <4 x i32> %23, %18              ; 2 uses
  ...
  %i.en = mul nuw <4 x i32> %23, %17
  %i.eo = mul nuw <4 x i32> %18, %22
  %i.ep = add <4 x i32> %i.en, %i.eo
  %i.eq = add <4 x i32> %i.ep, %28                ; 2 uses
