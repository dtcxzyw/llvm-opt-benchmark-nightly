...
.preheader.lr.ph.i:                               ; preds = %bb.d
  ...
  %scevgep104 = getelementptr i8, ptr %3, i64 512 ; 2 uses
  %i.ai = getelementptr i8, ptr %3, i64 %i.ag
  %scevgep105 = getelementptr i8, ptr %i.ai, i64 1022 ; 2 uses
  %scevgep106 = getelementptr i8, ptr %3, i64 514 ; 2 uses
...
.lr.ph.i.preheader:                               ; preds = %scalar_mult.exit.preheader.i
  ...
  %7 = insertelement <4 x ptr> %i.fg, ptr %.121.i, i64 1
  %8 = insertelement <4 x ptr> %7, ptr %scevgep104, i64 2
  %i.fh = insertelement <4 x ptr> %8, ptr %scevgep106, i64 3
  ...
  %i.fo = insertelement <4 x ptr> <ptr poison, ptr poison, ptr poison, ptr @kModRoots>, ptr %.121.i, i64 0
  %9 = insertelement <4 x ptr> %i.fo, ptr %scevgep104, i64 1
  %10 = insertelement <4 x ptr> %9, ptr %scevgep106, i64 2
  %11 = shufflevector <4 x ptr> %i.fc, <4 x ptr> poison, <4 x i32> zeroinitializer
  %i.fp = icmp ult <4 x ptr> %i.fb, %i.ff
  %i.fq = icmp ult <4 x ptr> %i.fh, %i.fj
