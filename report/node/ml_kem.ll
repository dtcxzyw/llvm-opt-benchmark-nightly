...
middle.block60:                                   ; preds = %vector.body54
  %ind.escape61 = add i64 %i.ci, -2
  %cmp.n62 = icmp eq i64 %i.cg, %n.vec51
...
middle.block79:                                   ; preds = %vector.body73
  %ind.escape80 = add i64 %i.fc, -2
  %cmp.n81 = icmp eq i64 %i.fa, %n.vec70
...
middle.block98:                                   ; preds = %vector.body92
  %ind.escape99 = add i64 %i.hw, -2
  %cmp.n100 = icmp eq i64 %i.hu, %n.vec89
...
middle.block104:                                  ; preds = %vector.body98
  %ind.escape105 = add i64 %i.azs, -2
  %cmp.n106 = icmp eq i64 %i.azq, %n.vec95
...
middle.block123:                                  ; preds = %vector.body117
  %ind.escape124 = add i64 %i.bch, -2
  %cmp.n125 = icmp eq i64 %i.bcf, %n.vec114
...
middle.block142:                                  ; preds = %vector.body136
  %ind.escape143 = add i64 %i.bew, -2
  %cmp.n144 = icmp eq i64 %i.beu, %n.vec133
