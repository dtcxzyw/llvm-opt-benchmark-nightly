...
scalar.ph:                                        ; preds = %vector.memcheck, %scalar.ph
  ...
  %1 = extractelement <2 x i16> %i.fa, i64 0
  %2 = zext i16 %1 to i32
  %3 = load <2 x i16>, ptr %.ptr26, align 2, !tbaa !39 ; 3 uses
  %4 = extractelement <2 x i16> %3, i64 0
  %5 = zext i16 %4 to i32
  %6 = add nuw nsw i32 %2, 3329
  %7 = sub nsw i32 %6, %5
  %i.fb = mul i32 %7, %i.ez                       ; 2 uses
  ...
  %8 = extractelement <2 x i16> %i.fa, i64 1
  %9 = zext i16 %8 to i32
  %10 = extractelement <2 x i16> %3, i64 1
  %11 = zext i16 %10 to i32
  %12 = add nuw nsw i32 %9, 3329
  %13 = sub nsw i32 %12, %11
  %i.fi = mul i32 %13, %i.ez                      ; 2 uses
