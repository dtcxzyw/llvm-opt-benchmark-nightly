...
scalar.ph129:                                     ; preds = %vector.memcheck123, %scalar.ph129
  ...
  %i.bjp = add i16 %i.bjo, -3329                  ; 2 uses
  %isneg.i.i.6.1 = icmp slt i16 %i.bjp, 0
  %i.bjq = select i1 %isneg.i.i.6.1, i16 %i.bjo, i16 0
  %i.bjr = tail call i16 @llvm.smax.i16(i16 %i.bjp, i16 0)
  %i.bjs = or i16 %i.bjq, %i.bjr                  ; 2 uses
  %.022.add.6.1 = add nuw nsw i64 %.020.idx.6, 8
  %i.bjt = load <2 x i16>, ptr %.020.ptr.6, align 2, !tbaa !38
  %i.bju = load i16, ptr %i.bje, align 2, !tbaa !38
  %i.bjv = load i16, ptr %.020.ptr.6, align 2, !tbaa !38
  %i.bjw = add i16 %i.bjd, %i.bjv
  %i.bjx = add i16 %i.bjs, %i.bju
  %i.bjy = shufflevector <2 x i16> %i.bjt, <2 x i16> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 1>
  %i.bjz = insertelement <4 x i16> %i.bjy, i16 %i.bjw, i64 0
  %i.bka = insertelement <4 x i16> %i.bjz, i16 %i.bjx, i64 1 ; 2 uses
  %i.bkb = insertelement <4 x i16> <i16 3329, i16 3329, i16 poison, i16 poison>, i16 %i.bjd, i64 2
  %i.bkc = insertelement <4 x i16> %i.bkb, i16 %i.bjs, i64 3
  %i.bkd = sub <4 x i16> %i.bka, %i.bkc           ; 3 uses
  %i.bke = icmp slt <4 x i16> %i.bkd, zeroinitializer
  %i.bkf = add <4 x i16> %i.bkd, <i16 poison, i16 poison, i16 3329, i16 3329>
  %i.bkg = shufflevector <4 x i16> %i.bkf, <4 x i16> poison, <4 x i32> <i32 2, i32 3, i32 poison, i32 poison>
  %i.bkh = shufflevector <4 x i16> %i.bka, <4 x i16> %i.bkg, <4 x i32> <i32 0, i32 1, i32 4, i32 5>
  %i.bki = select <4 x i1> %i.bke, <4 x i16> %i.bkh, <4 x i16> zeroinitializer
  %i.bkj = tail call <4 x i16> @llvm.smax.v4i16(<4 x i16> %i.bkd, <4 x i16> zeroinitializer)
  %i.bkk = or <4 x i16> %i.bki, %i.bkj
  store <4 x i16> %i.bkk, ptr %.020.ptr.6, align 2, !tbaa !38
  %i.bkl = icmp samesign ult i64 %.020.idx.6, 504
  br i1 %i.bkl, label %scalar.ph129, label %middle.block137, !llvm.loop !128

middle.block137:                                  ; preds = %vector.body131, %scalar.ph129
  ret void
}
