...
bb.n:                                             ; preds = %bb.l
  ...
  %i.dl = tail call noundef zeroext i1 @_ZN2v88internal8compiler18OperatorProperties15HasContextInputEPKNS1_8OperatorE(ptr noundef nonnull %i.de) #22
  %i.dm = load ptr, ptr %2, align 8
  %i.dn = tail call noundef zeroext i1 @_ZN2v88internal8compiler18OperatorProperties18HasFrameStateInputEPKNS1_8OperatorE(ptr noundef %i.dm) #22
  %i.do = load i32, ptr %i.z, align 4
  %i.dp = and i32 %i.do, 251658240
  %.not.i.i.i26 = icmp eq i32 %i.dp, 251658240
  br i1 %.not.i.i.i26, label %bb.o, label %_ZN2v88internal8compiler14NodeProperties14GetEffectInputEPNS1_4NodeEi.exit28
...
bb.o:                                             ; preds = %bb.n
  ...
  br label %_ZN2v88internal8compiler14NodeProperties14GetEffectInputEPNS1_4NodeEi.exit28

_ZN2v88internal8compiler14NodeProperties14GetEffectInputEPNS1_4NodeEi.exit28: ; preds = %bb.n, %bb.o
  %.sink.i.i.i27 = phi ptr [ %i.dt, %bb.o ], [ %i.ae, %bb.n ]
  %i.du = zext i1 %i.dl to i32
  %i.dv = zext i1 %i.dn to i32
  %i.dw = trunc nuw nsw i64 %indvars.iv to i32
  %i.dx = add i32 %i.dk, %i.dw
  %i.dy = add i32 %i.dx, %i.du
  %i.dz = add i32 %i.dy, %i.dv
  %i.ea = sext i32 %i.dz to i64
  %i.eb = getelementptr inbounds [8 x i8], ptr %.sink.i.i.i27, i64 %i.ea
  ...
  %i.eh = load ptr, ptr %i.au, align 8
  %i.ei = load ptr, ptr %i.aw, align 8            ; 2 uses
  %i.ej = ptrtoint ptr %i.eh to i64
  %i.ek = ptrtoint ptr %i.ei to i64
  %i.el = sub i64 %i.ej, %i.ek
  %i.em = ashr exact i64 %i.el, 3
  %i.en = icmp ugt i64 %i.em, %i.eg
  br i1 %i.en, label %bb.p, label %_ZNK2v88internal8compiler15LoadElimination27AbstractStateForEffectNodes3GetEPNS1_4NodeE.exit30

bb.p:                                             ; preds = %_ZN2v88internal8compiler14NodeProperties14GetEffectInputEPNS1_4NodeEi.exit28
  %i.eo = getelementptr inbounds nuw [8 x i8], ptr %i.ei, i64 %i.eg
  %i.ep = load ptr, ptr %i.eo, align 8
  br label %_ZNK2v88internal8compiler15LoadElimination27AbstractStateForEffectNodes3GetEPNS1_4NodeE.exit30

_ZNK2v88internal8compiler15LoadElimination27AbstractStateForEffectNodes3GetEPNS1_4NodeE.exit30: ; preds = %_ZN2v88internal8compiler14NodeProperties14GetEffectInputEPNS1_4NodeEi.exit28, %bb.p
  %.0.i29 = phi ptr [ %i.ep, %bb.p ], [ null, %_ZN2v88internal8compiler14NodeProperties14GetEffectInputEPNS1_4NodeEi.exit28 ]
  %i.eq = load i32, ptr %i.c, align 4
  %i.er = and i32 %i.eq, 251658240
  %.not.i.i31 = icmp eq i32 %i.er, 251658240
  br i1 %.not.i.i31, label %bb.q, label %_ZNK2v88internal8compiler4Node7InputAtEi.exit33

bb.q:                                             ; preds = %_ZNK2v88internal8compiler15LoadElimination27AbstractStateForEffectNodes3GetEPNS1_4NodeE.exit30
  %i.es = load ptr, ptr %i.bj, align 8
...
_ZNK2v88internal8compiler4Node7InputAtEi.exit33:  ; preds = %_ZNK2v88internal8compiler15LoadElimination27AbstractStateForEffectNodes3GetEPNS1_4NodeE.exit30, %bb.q
  %.sink.i.i32 = phi ptr [ %i.ev, %bb.q ], [ %i.bj, %_ZNK2v88internal8compiler15LoadElimination27AbstractStateForEffectNodes3GetEPNS1_4NodeE.exit30 ]
  %i.ew = getelementptr inbounds nuw i8, ptr %.0.i29, i64 520
  %i.ex = load ptr, ptr %i.ew, align 8            ; 3 uses
  %.not.i34 = icmp eq ptr %i.ex, null
  br i1 %.not.i34, label %_ZNK2v88internal8compiler15LoadElimination13AbstractState10LookupMapsEPNS1_4NodeEPNS0_14ZoneCompactSetINS1_6MapRefEEE.exit.thread, label %.preheader.i35.preheader

.preheader.i35.preheader:                         ; preds = %_ZNK2v88internal8compiler4Node7InputAtEi.exit33
  %i.ey = getelementptr inbounds nuw [8 x i8], ptr %.sink.i.i32, i64 %indvars.iv
  br label %.preheader.i35

.preheader.i35:                                   ; preds = %.preheader.i35.backedge, %.preheader.i35.preheader
  %.0.i.i.i36.in = phi ptr [ %i.ey, %.preheader.i35.preheader ], [ %.0.i.i.i36.in.be, %.preheader.i35.backedge ]
  %.0.i.i.i36 = load ptr, ptr %.0.i.i.i36.in, align 8 ; 5 uses
  %i.ez = load ptr, ptr %.0.i.i.i36, align 8
  %i.fa = getelementptr inbounds nuw i8, ptr %i.ez, i64 16
  %i.fb = load i16, ptr %i.fa, align 8
  switch i16 %i.fb, label %_ZN2v88internal8compiler12_GLOBAL__N_114ResolveRenamesEPNS1_4NodeE.exit.i.i48 [
    i16 278, label %bb.r
    i16 41, label %bb.r
    i16 59, label %bb.r
  ]

bb.r:                                             ; preds = %.preheader.i35, %.preheader.i35, %.preheader.i35
  %i.fc = getelementptr inbounds nuw i8, ptr %.0.i.i.i36, i64 20
  %i.fd = load i32, ptr %i.fc, align 4            ; 2 uses
  %i.fe = lshr i32 %i.fd, 24
  %i.ff = and i32 %i.fe, 15                       ; 2 uses
  %.not.i.i.i.i.i.i37 = icmp eq i32 %i.ff, 15
  %i.fg = ptrtoint ptr %.0.i.i.i36 to i64
  %i.fh = add i64 %i.fg, 32                       ; 3 uses
  br i1 %.not.i.i.i.i.i.i37, label %bb.s, label %_ZNK2v88internal8compiler4Node6inputsEv.exit.i.i.i.i.i38
...
bb.s:                                             ; preds = %bb.r
  ...
  br label %_ZNK2v88internal8compiler4Node6inputsEv.exit.i.i.i.i.i38

_ZNK2v88internal8compiler4Node6inputsEv.exit.i.i.i.i.i38: ; preds = %bb.s, %bb.r
  %.sroa.3.0.i.i.i.i.i.i39 = phi i32 [ %i.fn, %bb.s ], [ %i.ff, %bb.r ]
  %.sroa.0.0.in.i.i.i.i.i.i40 = phi i64 [ %i.fl, %bb.s ], [ %i.fh, %bb.r ]
  %i.fo = icmp sgt i32 %.sroa.3.0.i.i.i.i.i.i39, 0
  br i1 %i.fo, label %_ZN2v88internal8compiler12_GLOBAL__N_18IsRenameEPNS1_4NodeE.exit.i.i.i45, label %_ZN2v88internal8compiler12_GLOBAL__N_18IsRenameEPNS1_4NodeE.exit.thread.i.i.i41

_ZN2v88internal8compiler12_GLOBAL__N_18IsRenameEPNS1_4NodeE.exit.i.i.i45: ; preds = %_ZNK2v88internal8compiler4Node6inputsEv.exit.i.i.i.i.i38
  %.sroa.0.0.i.i.i.i.i.i46 = inttoptr i64 %.sroa.0.0.in.i.i.i.i.i.i40 to ptr
  %i.fp = load ptr, ptr %.sroa.0.0.i.i.i.i.i.i46, align 8
  %.not.i.i.i47 = icmp eq ptr %i.fp, null
  br i1 %.not.i.i.i47, label %_ZN2v88internal8compiler12_GLOBAL__N_114ResolveRenamesEPNS1_4NodeE.exit.i.i48, label %_ZN2v88internal8compiler12_GLOBAL__N_18IsRenameEPNS1_4NodeE.exit.thread.i.i.i41

_ZN2v88internal8compiler12_GLOBAL__N_18IsRenameEPNS1_4NodeE.exit.thread.i.i.i41: ; preds = %_ZN2v88internal8compiler12_GLOBAL__N_18IsRenameEPNS1_4NodeE.exit.i.i.i45, %_ZNK2v88internal8compiler4Node6inputsEv.exit.i.i.i.i.i38
  %i.fq = and i32 %i.fd, 251658240
  %.not.i.i.i.i.i42 = icmp eq i32 %i.fq, 251658240
  %i.fr = inttoptr i64 %i.fh to ptr               ; 2 uses
  br i1 %.not.i.i.i.i.i42, label %bb.t, label %.preheader.i35.backedge

bb.t:                                             ; preds = %_ZN2v88internal8compiler12_GLOBAL__N_18IsRenameEPNS1_4NodeE.exit.thread.i.i.i41
  %i.fs = load ptr, ptr %i.fr, align 8
  %i.ft = ptrtoint ptr %i.fs to i64
  %i.fu = add i64 %i.ft, 16
  %i.fv = inttoptr i64 %i.fu to ptr
  br label %.preheader.i35.backedge

.preheader.i35.backedge:                          ; preds = %bb.t, %_ZN2v88internal8compiler12_GLOBAL__N_18IsRenameEPNS1_4NodeE.exit.thread.i.i.i41
  %.0.i.i.i36.in.be = phi ptr [ %i.fv, %bb.t ], [ %i.fr, %_ZN2v88internal8compiler12_GLOBAL__N_18IsRenameEPNS1_4NodeE.exit.thread.i.i.i41 ]
  br label %.preheader.i35, !llvm.loop !14

_ZN2v88internal8compiler12_GLOBAL__N_114ResolveRenamesEPNS1_4NodeE.exit.i.i48: ; preds = %_ZN2v88internal8compiler12_GLOBAL__N_18IsRenameEPNS1_4NodeE.exit.i.i.i45, %.preheader.i35
  %i.fw = getelementptr inbounds nuw i8, ptr %i.ex, i64 24
  %i.fx = load ptr, ptr %i.fw, align 8            ; 2 uses
  %i.fy = getelementptr inbounds nuw i8, ptr %i.ex, i64 16 ; 2 uses
  %.not10.i.i.i.i.i49 = icmp eq ptr %i.fx, null
  br i1 %.not10.i.i.i.i.i49, label %_ZNK2v88internal8compiler15LoadElimination13AbstractState10LookupMapsEPNS1_4NodeEPNS0_14ZoneCompactSetINS1_6MapRefEEE.exit.thread, label %.lr.ph.i.i.i.i.i50

.lr.ph.i.i.i.i.i50:                               ; preds = %_ZN2v88internal8compiler12_GLOBAL__N_114ResolveRenamesEPNS1_4NodeE.exit.i.i48, %.lr.ph.i.i.i.i.i50
  %.012.i.i.i.i.i51 = phi ptr [ %.1.i.i.i.i.i56, %.lr.ph.i.i.i.i.i50 ], [ %i.fx, %_ZN2v88internal8compiler12_GLOBAL__N_114ResolveRenamesEPNS1_4NodeE.exit.i.i48 ] ; 3 uses
  %.0811.i.i.i.i.i52 = phi ptr [ %.19.i.i.i.i.i53, %.lr.ph.i.i.i.i.i50 ], [ %i.fy, %_ZN2v88internal8compiler12_GLOBAL__N_114ResolveRenamesEPNS1_4NodeE.exit.i.i48 ]
  %i.fz = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i51, i64 32
  %i.ga = load ptr, ptr %i.fz, align 8
  %i.gb = icmp ult ptr %i.ga, %.0.i.i.i36         ; 2 uses
  %.19.i.i.i.i.i53 = select i1 %i.gb, ptr %.0811.i.i.i.i.i52, ptr %.012.i.i.i.i.i51 ; 4 uses
  %.1.in.v.i.i.i.i.i54 = select i1 %i.gb, i64 24, i64 16
  %.1.in.i.i.i.i.i55 = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i51, i64 %.1.in.v.i.i.i.i.i54
  %.1.i.i.i.i.i56 = load ptr, ptr %.1.in.i.i.i.i.i55, align 8 ; 2 uses
  %.not.i.i.i4.i.i57 = icmp eq ptr %.1.i.i.i.i.i56, null
  br i1 %.not.i.i.i4.i.i57, label %_ZNKSt8_Rb_treeIPN2v88internal8compiler4NodeESt4pairIKS4_NS1_14ZoneCompactSetINS2_6MapRefEEEESt10_Select1stISA_ESt4lessIS4_ENS1_13ZoneAllocatorISA_EEE14_M_lower_boundEPKSt13_Rb_tree_nodeISA_EPKSt18_Rb_tree_node_baseRS6_.exit.i.i.i.i58, label %.lr.ph.i.i.i.i.i50, !llvm.loop !15

_ZNKSt8_Rb_treeIPN2v88internal8compiler4NodeESt4pairIKS4_NS1_14ZoneCompactSetINS2_6MapRefEEEESt10_Select1stISA_ESt4lessIS4_ENS1_13ZoneAllocatorISA_EEE14_M_lower_boundEPKSt13_Rb_tree_nodeISA_EPKSt18_Rb_tree_node_baseRS6_.exit.i.i.i.i58: ; preds = %.lr.ph.i.i.i.i.i50
  %i.gc = icmp eq ptr %.19.i.i.i.i.i53, %i.fy
  br i1 %i.gc, label %_ZNK2v88internal8compiler15LoadElimination13AbstractState10LookupMapsEPNS1_4NodeEPNS0_14ZoneCompactSetINS1_6MapRefEEE.exit.thread, label %_ZNKSt3mapIPN2v88internal8compiler4NodeENS1_14ZoneCompactSetINS2_6MapRefEEESt4lessIS4_ENS1_13ZoneAllocatorISt4pairIKS4_S7_EEEE4findERSC_.exit.i.i59

_ZNKSt3mapIPN2v88internal8compiler4NodeENS1_14ZoneCompactSetINS2_6MapRefEEESt4lessIS4_ENS1_13ZoneAllocatorISt4pairIKS4_S7_EEEE4findERSC_.exit.i.i59: ; preds = %_ZNKSt8_Rb_treeIPN2v88internal8compiler4NodeESt4pairIKS4_NS1_14ZoneCompactSetINS2_6MapRefEEEESt10_Select1stISA_ESt4lessIS4_ENS1_13ZoneAllocatorISA_EEE14_M_lower_boundEPKSt13_Rb_tree_nodeISA_EPKSt18_Rb_tree_node_baseRS6_.exit.i.i.i.i58
  %i.gd = getelementptr inbounds nuw i8, ptr %.19.i.i.i.i.i53, i64 32
  %i.ge = load ptr, ptr %i.gd, align 8
  %i.gf = icmp ult ptr %.0.i.i.i36, %i.ge
  br i1 %i.gf, label %_ZNK2v88internal8compiler15LoadElimination13AbstractState10LookupMapsEPNS1_4NodeEPNS0_14ZoneCompactSetINS1_6MapRefEEE.exit.thread, label %bb.u

bb.u:                                             ; preds = %_ZNKSt3mapIPN2v88internal8compiler4NodeENS1_14ZoneCompactSetINS2_6MapRefEEESt4lessIS4_ENS1_13ZoneAllocatorISt4pairIKS4_S7_EEEE4findERSC_.exit.i.i59
  %i.gg = getelementptr inbounds nuw i8, ptr %.19.i.i.i.i.i53, i64 40
  %i.gh = load i64, ptr %i.gg, align 8            ; 3 uses
  %i.gi = icmp eq i64 %i.gh, %i.cy
  br i1 %i.gi, label %.thread81, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.gj = and i64 %i.gh, 3
  %i.gk = icmp eq i64 %i.gj, 2
  %or.cond.i.i = and i1 %i.da, %i.gk
  br i1 %or.cond.i.i, label %bb.w, label %_ZNK2v88internal8compiler15LoadElimination13AbstractState10LookupMapsEPNS1_4NodeEPNS0_14ZoneCompactSetINS1_6MapRefEEE.exit.thread

bb.w:                                             ; preds = %bb.v
  %i.gl = add nsw i64 %i.gh, -2
  %i.gm = inttoptr i64 %i.gl to ptr               ; 2 uses
  %i.gn = load ptr, ptr %i.gm, align 8
  %i.go = getelementptr inbounds nuw i8, ptr %i.gm, i64 8
  %i.gp = load i64, ptr %i.go, align 8            ; 3 uses
  %i.gq = load ptr, ptr %i.dc, align 8
  %i.gr = load i64, ptr %i.dd, align 8
  %.idx.i.i = shl nuw nsw i64 %i.gp, 3
  %.not.i.i.i.i = icmp eq i64 %i.gp, %i.gr
  br i1 %.not.i.i.i.i, label %bb.x, label %_ZNK2v88internal8compiler15LoadElimination13AbstractState10LookupMapsEPNS1_4NodeEPNS0_14ZoneCompactSetINS1_6MapRefEEE.exit.thread
end_hunk_0
