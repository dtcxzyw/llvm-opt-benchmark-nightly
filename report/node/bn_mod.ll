...
bb.a:
  ...
  %i.c = load i32, ptr %i.b, align 8, !tbaa !15   ; 10 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  %.067 = phi ptr [ %i.i, %bb.c ], [ %i.a, %bb.b ] ; 10 uses
...
._crit_edge86.critedge:                           ; preds = %bb.d
  %6 = load ptr, ptr %0, align 8, !tbaa !16
  %7 = load ptr, ptr %3, align 8, !tbaa !16
  %8 = call i64 @bn_sub_words(ptr noundef %6, ptr noundef nonnull %.067, ptr noundef %7, i32 noundef %i.c) #5 ; 0 uses
...
.epil.preheader:                                  ; preds = %._crit_edge86.loopexit.unr-lcssa, %._crit_edge
  %.183.epil.init = phi i64 [ 0, %._crit_edge ], [ %i.bp, %._crit_edge86.loopexit.unr-lcssa ] ; 2 uses
...
._crit_edge86:                                    ; preds = %.epil.preheader, %._crit_edge86.loopexit.unr-lcssa, %._crit_edge86.critedge
