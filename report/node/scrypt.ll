...
vector.memcheck48:                                ; preds = %._crit_edge.us.i.i, %.lr.ph78.us.i.preheader.i
...
vector.body56:                                    ; preds = %vector.memcheck48, %vector.body56
  %index57 = phi i64 [ %index.next63, %vector.body56 ], [ 0, %vector.memcheck48 ] ; 4 uses
...
scalar.ph51:                                      ; preds = %vector.memcheck48, %scalar.ph51
  %.277.us.i.i = phi ptr [ %i.eo, %scalar.ph51 ], [ %8, %vector.memcheck48 ] ; 5 uses
  %.06376.us.i.i = phi i64 [ %i.es, %scalar.ph51 ], [ 0, %vector.memcheck48 ] ; 6 uses
...
._crit_edge.us.i.i:                               ; preds = %vector.body56, %scalar.ph51
  ...
  br i1 %exitcond88.not.i.i, label %.lr.ph82.i.i.preheader, label %vector.memcheck48, !llvm.loop !29

.lr.ph82.i.i.preheader:                           ; preds = %._crit_edge.us.i.i
  %diff.check = icmp eq i64 %i.cd, %i.bz
  br i1 %diff.check, label %.lr.ph82.i.i, label %vector.body

vector.body:                                      ; preds = %.lr.ph82.i.i.preheader, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %.lr.ph82.i.i.preheader ] ; 3 uses
...
.lr.ph82.i.i:                                     ; preds = %.lr.ph82.i.i.preheader, %.lr.ph82.i.i
  %.181.i.i = phi ptr [ %i.gd, %.lr.ph82.i.i ], [ %i.cf, %.lr.ph82.i.i.preheader ] ; 9 uses
  %.380.i.i = phi i64 [ %i.ge, %.lr.ph82.i.i ], [ 0, %.lr.ph82.i.i.preheader ] ; 9 uses
