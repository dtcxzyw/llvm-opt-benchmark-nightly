...
.lr.ph78.us.i.i:                                  ; preds = %._crit_edge.us.i.i, %.lr.ph78.us.i.preheader.i
  ...
  br i1 %min.iters.check52, label %scalar.ph51.preheader, label %vector.memcheck48

scalar.ph51.preheader:                            ; preds = %vector.memcheck48, %.lr.ph78.us.i.i
  br label %scalar.ph51

vector.memcheck48:                                ; preds = %.lr.ph78.us.i.i
  %i.dd = mul i64 %i.by, %9
...
._crit_edge.us.i.i:                               ; preds = %vector.body56, %scalar.ph51
  ...
  br i1 %exitcond88.not.i.i, label %.lr.ph82.i.i.preheader, label %.lr.ph78.us.i.i, !llvm.loop !29
