...
begin_hunk_0_@_ZN2v88internal24CpuProfileJSONSerializer13SerializeImplEv:bb.a
  %i.v = tail call noundef i32 %i.u(ptr noundef nonnull align 8 dereferenceable(8) %i.q, ptr noundef %i.r, i32 noundef %i.j) #30, !inline_history !5
...
_ZN2v88internal18OutputStreamWriter12AddCharacterEc.exit: ; preds = %bb.a, %bb.b, %bb.e
  ...
  %i.ao = load i8, ptr %i.an, align 4, !range !28, !noundef !29
...
bb.g:                                             ; preds = %bb.f
  %i.bb = load i8, ptr %i.an, align 4, !range !28, !noundef !29
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.bi = call noundef i32 %i.bh(ptr noundef nonnull align 8 dereferenceable(8) %i.bd, ptr noundef %i.be, i32 noundef %i.ax) #30, !inline_history !5
...
_ZN2v88internal18OutputStreamWriter12AddCharacterEc.exit2: ; preds = %bb.f, %bb.g, %bb.j
  ...
  %i.bn = load i8, ptr %i.bm, align 4, !range !28, !noundef !29
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.cc = load i8, ptr %i.cb, align 4, !range !28, !noundef !29
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.cj = call noundef i32 %i.ci(ptr noundef nonnull align 8 dereferenceable(8) %i.ce, ptr noundef %i.cf, i32 noundef %i.bx) #30, !inline_history !5
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.cx = call noundef i32 %i.cw(ptr noundef nonnull align 8 dereferenceable(8) %i.cr, ptr noundef %i.ct, i32 noundef %i.cq) #30, !inline_history !134
...
bb.s:                                             ; preds = %_ZN2v88internal18OutputStreamWriter10WriteChunkEv.exit.i, %bb.p
  ...
  call void %i.dc(ptr noundef nonnull align 8 dereferenceable(8) %i.cz) #30, !inline_history !135
...
.lr.ph.i.i.i.i.i.i.i.i.i:                         ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i, %bb.c
  ...
  br i1 %.not.i.i.i.i.i.i.i.i.i, label %_ZNSt6vectorIN2v814CpuProfileNode8LineTickESaIS2_EEC2EmRKS3_.exit, label %.lr.ph.i.i.i.i.i.i.i.i.i, !llvm.loop !136
...
bb.d:                                             ; preds = %.lr.ph, %_ZN2v88internal18OutputStreamWriter12AddCharacterEc.exit12
  ...
  %i.m = load ptr, ptr %i.k, align 8              ; 5 uses
  ...
  br i1 %i.x, label %bb.e, label %_ZN2v88internal18OutputStreamWriter12AddCharacterEc.exit

bb.e:                                             ; preds = %bb.d
  %i.y = getelementptr inbounds nuw i8, ptr %i.m, i64 36 ; 2 uses
  %i.z = load i8, ptr %i.y, align 4, !range !28, !noundef !29
  %i.aa = trunc nuw i8 %i.z to i1
  br i1 %i.aa, label %_ZN2v88internal18OutputStreamWriter12AddCharacterEc.exit, label %bb.f
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ag = tail call noundef i32 %i.af(ptr noundef nonnull align 8 dereferenceable(8) %i.ab, ptr noundef %i.ac, i32 noundef %i.u) #30, !inline_history !5
...
_ZN2v88internal18OutputStreamWriter12AddCharacterEc.exit: ; preds = %bb.d, %bb.e, %bb.h
  ...
  %i.ak = getelementptr inbounds nuw [12 x i8], ptr %i.d, i64 %indvars.iv ; 2 uses
  ...
  %i.aq = load ptr, ptr %i.k, align 8             ; 5 uses
  ...
  br i1 %i.bb, label %bb.i, label %_ZN2v88internal18OutputStreamWriter12AddCharacterEc.exit11
...
bb.i:                                             ; preds = %_ZN2v88internal18OutputStreamWriter12AddCharacterEc.exit
  ...
  %i.bd = load i8, ptr %i.bc, align 4, !range !28, !noundef !29
  %i.be = trunc nuw i8 %i.bd to i1
  br i1 %i.be, label %_ZN2v88internal18OutputStreamWriter12AddCharacterEc.exit11, label %bb.j
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.bk = tail call noundef i32 %i.bj(ptr noundef nonnull align 8 dereferenceable(8) %i.bf, ptr noundef %i.bg, i32 noundef %i.ay) #30, !inline_history !5
...
bb.m:                                             ; preds = %_ZN2v88internal18OutputStreamWriter12AddCharacterEc.exit11
  %i.bm = load ptr, ptr %i.k, align 8             ; 5 uses
  ...
  br i1 %i.bx, label %bb.n, label %_ZN2v88internal18OutputStreamWriter12AddCharacterEc.exit12

bb.n:                                             ; preds = %bb.m
  %i.by = getelementptr inbounds nuw i8, ptr %i.bm, i64 36 ; 2 uses
  %i.bz = load i8, ptr %i.by, align 4, !range !28, !noundef !29
  %i.ca = trunc nuw i8 %i.bz to i1
  br i1 %i.ca, label %_ZN2v88internal18OutputStreamWriter12AddCharacterEc.exit12, label %bb.o
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.cg = tail call noundef i32 %i.cf(ptr noundef nonnull align 8 dereferenceable(8) %i.cb, ptr noundef %i.cc, i32 noundef %i.bu) #30, !inline_history !5
...
bb.t:                                             ; preds = %_ZN2v88internal7MemCopyEPvPKvm.exit
  %i.aa = load i8, ptr %i.g, align 4, !range !28, !noundef !29
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.ah = tail call noundef i32 %i.ag(ptr noundef nonnull align 8 dereferenceable(8) %i.ac, ptr noundef %i.ad, i32 noundef %i.x) #30, !inline_history !6
...
_ZN2v88internal18OutputStreamWriter15MaybeWriteChunkEv.exit: ; preds = %_ZN2v88internal7MemCopyEPvPKvm.exit, %bb.t, %bb.w
  ...
  br i1 %i.ak, label %bb.b, label %._crit_edge, !llvm.loop !138
...
.split.us:                                        ; preds = %bb.a
  ...
  br i1 %i.k, label %.lr.ph, label %tailrecurse.us._crit_edge, !prof !30
