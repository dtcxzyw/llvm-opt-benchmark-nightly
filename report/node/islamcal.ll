...
begin_hunk_0_@_ZNK6icu_7815IslamicCalendar14getRelatedYearER10UErrorCode:bb.a
  ...
  %.neg15.i = add nuw nsw i32 %i.l, 2
  %2 = icmp samesign ult i32 %i.k, 34
  %.neg16.i = sext i1 %2 to i32
  %.neg14.i = add nsw i32 %.neg15.i, %.neg16.i
...
bb.d:                                             ; preds = %bb.c, %bb.b
  %.sink15 = phi i1 [ %i.h, %bb.c ], [ %i.e, %bb.b ]
  %.0 = phi i32 [ %2, %bb.c ], [ %i.c, %bb.b ]
  %.sink = shl nsw i32 %.0, 1
  %3 = zext i1 %.sink15 to i32
  %4 = or disjoint i32 %.sink, %3
