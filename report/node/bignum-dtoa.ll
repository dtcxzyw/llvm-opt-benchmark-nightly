...
._crit_edge37.critedge:                           ; preds = %bb.a
  %6 = tail call noundef zeroext i16 @_ZN2v84base6Bignum21DivideModuloIntBignumERKS1_(ptr noundef nonnull align 8 dereferenceable(536) %2, ptr noundef nonnull align 8 dereferenceable(536) %3) #5
  %7 = tail call noundef i32 @_ZN2v84base6Bignum11PlusCompareERKS1_S3_S3_(ptr noundef nonnull align 8 dereferenceable(536) %2, ptr noundef nonnull align 8 dereferenceable(536) %2, ptr noundef nonnull align 8 dereferenceable(536) %3) #5
  %8 = icmp sgt i32 %7, -1
  %9 = zext i1 %8 to i16
  %spec.select.c = add i16 %6, %9
  %10 = trunc i16 %spec.select.c to i8
  %11 = add i8 %10, 48
  %12 = sext i32 %i.a to i64
