...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i:     ; preds = %bb.mm, %.lr.ph.i.i884
  %.033.i.i = phi i64 [ %i.ble, %.lr.ph.i.i884 ], [ %i.blo, %bb.mm ]
  %.02132.i.i = phi ptr [ %i.blf, %.lr.ph.i.i884 ], [ %i.blm, %bb.mm ]
  %i.blg = add i64 %.033.i.i, -1
  %i.blh = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i, i32 noundef 47, i64 noundef %i.blg) #33 ; 4 uses
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit.thread: ; preds = %bb.ml, %bb.mp, %bb.mm, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i
  %.095.i2007 = phi i1 [ %.095.i2225, %bb.mm ], [ %.095.i2225, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i ], [ %i.blv, %bb.mp ], [ %.095.i2225, %bb.ml ]
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i:     ; preds = %bb.ad, %.lr.ph.i.i71
  %.033.i.i = phi i64 [ %i.ie, %.lr.ph.i.i71 ], [ %i.io, %bb.ad ]
  %.02132.i.i = phi ptr [ %i.if, %.lr.ph.i.i71 ], [ %i.im, %bb.ad ]
  %i.ig = add i64 %.033.i.i, -1
  %i.ih = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i, i32 noundef 47, i64 noundef %i.ig) #33 ; 4 uses
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit.thread: ; preds = %bb.ac, %bb.ag, %bb.ad, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i
  %.095.i11529 = phi i1 [ %.095.i11549, %bb.ad ], [ %.095.i11549, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i ], [ %i.iv, %bb.ag ], [ %.095.i11549, %bb.ac ]
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i152:  ; preds = %bb.cp, %.lr.ph.i.i151
  ...
  %i.uj = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i154, i32 noundef 47, i64 noundef %i.ui) #33 ; 4 uses
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit161.thread: ; preds = %bb.cs, %bb.co, %bb.cp, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i152
  %.095.i520 = phi i1 [ %.095.i567, %bb.cp ], [ %.095.i567, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i152 ], [ %.095.i567, %bb.co ], [ %i.ux, %bb.cs ]
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i:     ; preds = %bb.ad, %.lr.ph.i.i97
  %.033.i.i = phi i64 [ %i.if, %.lr.ph.i.i97 ], [ %i.ip, %bb.ad ]
  %.02132.i.i = phi ptr [ %i.ig, %.lr.ph.i.i97 ], [ %i.in, %bb.ad ]
  %i.ih = add i64 %.033.i.i, -1
  %i.ii = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i, i32 noundef 47, i64 noundef %i.ih) #33 ; 4 uses
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit.thread: ; preds = %bb.ac, %bb.ag, %bb.ad, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i
  %.095.i88.i1244 = phi i1 [ %.095.i88.i1264, %bb.ad ], [ %.095.i88.i1264, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i ], [ %i.iw, %bb.ag ], [ %.095.i88.i1264, %bb.ac ]
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i233:  ; preds = %bb.dl, %.lr.ph.i.i232
  ...
  %i.xx = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i235, i32 noundef 47, i64 noundef %i.xw) #33 ; 4 uses
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit242.thread: ; preds = %bb.dk, %bb.do, %bb.dl, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i233
  %.095.i51.i1233 = phi i1 [ %.095.i51.i1287, %bb.dl ], [ %.095.i51.i1287, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i233 ], [ %i.yl, %bb.do ], [ %.095.i51.i1287, %bb.dk ]
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i378:  ; preds = %bb.fk, %.lr.ph.i.i377
  ...
  %i.ajs = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i380, i32 noundef 47, i64 noundef %i.ajr) #33 ; 4 uses
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit387.thread: ; preds = %bb.fj, %bb.fn, %bb.fk, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i378
  %.095.i14.i1211 = phi i1 [ %.095.i14.i1334, %bb.fk ], [ %.095.i14.i1334, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i378 ], [ %i.akg, %bb.fn ], [ %.095.i14.i1334, %bb.fj ]
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i536:  ; preds = %bb.gz, %.lr.ph.i.i535
  ...
  %i.asw = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i538, i32 noundef 47, i64 noundef %i.asv) #33 ; 4 uses
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit545.thread: ; preds = %bb.gy, %bb.hc, %bb.gz, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i536
  %.095.i.i1221 = phi i1 [ %.095.i.i1312, %bb.gz ], [ %.095.i.i1312, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i536 ], [ %i.atk, %bb.hc ], [ %.095.i.i1312, %bb.gy ]
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i:     ; preds = %bb.l, %.lr.ph.i.i
  %.033.i.i = phi i64 [ %i.dp, %.lr.ph.i.i ], [ %i.dz, %bb.l ]
  %.02132.i.i = phi ptr [ %i.dq, %.lr.ph.i.i ], [ %i.dx, %bb.l ]
  %i.dr = add i64 %.033.i.i, -1
  %i.ds = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i, i32 noundef 47, i64 noundef %i.dr) #33 ; 4 uses
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit.thread: ; preds = %bb.k, %bb.o, %bb.l, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i
  %.078389 = phi i1 [ %.078399, %bb.l ], [ %.078399, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i ], [ %i.eg, %bb.o ], [ %.078399, %bb.k ]
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.a:     ; preds = %bb.f, %.lr.ph.i
  ...
  %reass.sub = sub i64 %.033.i, %i.a
  %i.m = add i64 %reass.sub, 1
  %3 = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i, i32 noundef %i.k, i64 noundef %i.m) #33 ; 4 uses
  %.not26.i.a = icmp eq ptr %3, null
  br i1 %.not26.i.a, label %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcmm.exit, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i

_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i:     ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.a
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcmm.exit: ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.a, %bb.f, %bb.b, %bb.c, %bb.d, %bb.e
  %.1.i = phi i64 [ %i.d, %bb.b ], [ -1, %bb.c ], [ %i.q, %bb.e ], [ -1, %bb.d ], [ -1, %bb.f ], [ -1, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.a ]
  ret i64 %.1.i
}
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.a:     ; preds = %bb.f, %.lr.ph.i
  ...
  %reass.sub = sub i64 %.041.i, %i.a
  %i.m = add i64 %reass.sub, 1
  %3 = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02840.i, i32 noundef %i.k, i64 noundef %i.m) #33 ; 4 uses
  %.not34.i.a = icmp eq ptr %3, null
  br i1 %.not34.i.a, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findEPKcmm.exit, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findEPKcmm.exit: ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.a, %bb.f, %bb.b, %bb.c, %bb.d, %bb.e
  %.1.i = phi i64 [ %i.e, %bb.b ], [ -1, %bb.c ], [ %i.q, %bb.e ], [ -1, %bb.d ], [ -1, %bb.f ], [ -1, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.a ]
  ret i64 %.1.i
}
