...
begin_hunk_0_@_ZN3ada11serializers4ipv4B5cxx11Em:bb.a
  ...
  %i.c = trunc i64 %i.b to i8                     ; 7 uses
  %i.d = icmp eq i8 %i.c, 0
  br i1 %i.d, label %bb.l, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.e = icmp ult i8 %i.c, 10
  %2 = icmp ugt i8 %i.c, 99                       ; 2 uses
  %i.f = select i1 %2, i64 3, i64 2
...
begin_hunk_1_@_ZN3ada11serializers4ipv4B5cxx11Em:bb.a
  ...
  %i.ao = trunc i64 %i.an to i8                   ; 7 uses
  %i.ap = icmp eq i8 %i.ao, 0
  br i1 %i.ap, label %bb.p, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.aq = icmp ult i8 %i.ao, 10
  %3 = icmp ugt i8 %i.ao, 99                      ; 2 uses
  %i.ar = select i1 %3, i64 3, i64 2
  %i.as = select i1 %i.aq, i64 1, i64 %i.ar       ; 2 uses
  br i1 %3, label %._crit_edge.i.i.thread.i25, label %._crit_edge.i.i.i16
...
begin_hunk_2_@_ZN3ada11serializers4ipv4B5cxx11Em:bb.a
  ...
  %i.ba = getelementptr inbounds nuw i8, ptr %.ptr, i64 2
  store i8 %i.az, ptr %i.ba, align 1
  %i.bb = load i8, ptr %i.ax, align 2
  %i.bc = getelementptr inbounds nuw i8, ptr %.ptr, i64 1
...
begin_hunk_3_@_ZN3ada11serializers4ipv4B5cxx11Em:bb.a
  ...
  %i.bn = trunc i64 %i.bm to i8                   ; 7 uses
  %i.bo = icmp eq i8 %i.bn, 0
  br i1 %i.bo, label %bb.t, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.bp = icmp ult i8 %i.bn, 10
  %4 = icmp ugt i8 %i.bn, 99                      ; 2 uses
  %i.bq = select i1 %4, i64 3, i64 2
  %i.br = select i1 %i.bp, i64 1, i64 %i.bq       ; 2 uses
  br i1 %4, label %._crit_edge.i.i.thread.i25.1, label %._crit_edge.i.i.i16.1
...
begin_hunk_4_@_ZN3ada11serializers4ipv4B5cxx11Em:bb.a
  ...
  %i.ch = getelementptr inbounds nuw i8, ptr %.ptr.1, i64 2
  store i8 %i.cg, ptr %i.ch, align 1
  %i.ci = load i8, ptr %i.ce, align 2
  %i.cj = getelementptr inbounds nuw i8, ptr %.ptr.1, i64 1
...
bb.u:                                             ; preds = %bb.t
  ...
  %5 = icmp ugt i8 %i.cl, 99                      ; 2 uses
  %i.co = select i1 %5, i64 3, i64 2
  %i.cp = select i1 %i.cn, i64 1, i64 %i.co       ; 2 uses
  br i1 %5, label %._crit_edge.i.i.thread.i25.2, label %._crit_edge.i.i.i16.2
...
begin_hunk_6_@_ZN3ada11serializers4ipv4B5cxx11Em:bb.a
  ...
  %i.df = getelementptr inbounds nuw i8, ptr %.ptr.2, i64 2
  store i8 %i.de, ptr %i.df, align 1
  %i.dg = load i8, ptr %i.dc, align 2
  %i.dh = getelementptr inbounds nuw i8, ptr %.ptr.2, i64 1
