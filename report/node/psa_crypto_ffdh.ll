...
@switch.table.mbedtls_psa_ffdh_key_agreement.6 = private unnamed_addr constant [7 x i16] [i16 256, i16 384, i16 512, i16 poison, i16 768, i16 poison, i16 1024], align 8

; Function Attrs: nounwind uwtable
define i32 @mbedtls_psa_ffdh_export_public_key(ptr nofree noundef readonly captures(none) %0, ptr noundef %1, i64 noundef %2, ptr noundef %3, i64 noundef %4, ptr nofree noundef writeonly captures(none) %5) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define i32 @mbedtls_psa_ffdh_generate_key(ptr nofree noundef readnone captures(none) %0, ptr noundef %1, i64 noundef %2, ptr nofree noundef writeonly captures(none) %3) local_unnamed_addr #0 {
bb.a:
...
define range(i32 -138, 1) i32 @mbedtls_psa_ffdh_import_key(ptr nofree noundef readnone captures(none) %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2, ptr nofree noundef writeonly captures(none) %3, i64 noundef %4, ptr nofree noundef writeonly captures(none) %5, ptr nofree noundef writeonly captures(none) %6) local_unnamed_addr #4 {
bb.a:
...
; Function Attrs: nounwind uwtable
define i32 @mbedtls_psa_ffdh_key_agreement(ptr nofree noundef readonly captures(none) %0, ptr noundef %1, i64 noundef %2, ptr noundef %3, i64 noundef %4, ptr noundef %5, i64 noundef %6, ptr nofree noundef writeonly captures(none) %7) local_unnamed_addr #0 {
bb.a:
  %8 = alloca %struct.mbedtls_mpi, align 8        ; 6 uses
