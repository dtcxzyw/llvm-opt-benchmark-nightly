...
bb.b:                                             ; preds = %.loopexit
  ...
  br i1 %i.f, label %bb.c, label %.loopexit35, !llvm.loop !59
...
bb.d:                                             ; preds = %bb.e, %bb.c
  ...
  %i.j = load i8, ptr %.025, align 1, !tbaa !17
...
.loopexit:                                        ; preds = %bb.d, %.critedge
  ...
  %i.n = load i8, ptr %.0, align 1, !tbaa !17
...
.peel.next:                                       ; preds = %bb.b, %.peel.next
  ...
  br i1 %i.o, label %.peel.next, label %._crit_edge, !llvm.loop !61
...
.preheader:                                       ; preds = %bb.b
  ...
  br i1 %.not25, label %equal_nocase.exit.thread29, label %.lr.ph, !llvm.loop !63
...
bb.b:                                             ; preds = %.lr.ph
  ...
  br i1 %i.g, label %.lr.ph.i.preheader, label %.preheader, !llvm.loop !63
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %bb.e
  ...
  %i.j = load i8, ptr %.03955.i, align 1, !tbaa !17 ; 5 uses
  %i.k = load i8, ptr %.02557.i, align 1, !tbaa !17 ; 4 uses
...
.lr.ph.split.us.i:                                ; preds = %.lr.ph.i, %bb.b
  ...
  %i.f = load i8, ptr %.01518.us.i, align 1, !tbaa !17
...
bb.c:                                             ; preds = %.lr.ph.split.i
  ...
  br i1 %i.m, label %.lr.ph.split.i, label %.preheader, !llvm.loop !64
...
.lr.ph:                                           ; preds = %.preheader, %bb.f
  ...
  %i.o = load i8, ptr %.03955, align 1, !tbaa !17 ; 5 uses
  %i.p = load i8, ptr %.02557, align 1, !tbaa !17 ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  %i.b = load i8, ptr %2, align 1, !tbaa !17
...
bb.d:                                             ; preds = %bb.t, %.lr.ph.i
  ...
  %i.g = load i8, ptr %i.f, align 1, !tbaa !17    ; 4 uses
