...
_ZN2v86bigint6Digits9NormalizeEv.exit:            ; preds = %bb.b, %.lr.ph.i, %._ZN2v86bigint6Digits9NormalizeEv.exit.loopexit_crit_edge, %bb.a
  %.sroa.869.1 = phi i32 [ 0, %bb.a ], [ %4, %.lr.ph.i ], [ 0, %._ZN2v86bigint6Digits9NormalizeEv.exit.loopexit_crit_edge ], [ %indvars.i133, %bb.b ] ; 10 uses
...
.loopexit125:                                     ; preds = %bb.c, %.lr.ph.i45
  %indvars.i49101.lcssa = phi i32 [ %.promoted.i43, %.lr.ph.i45 ], [ %indvars.i49138, %bb.c ] ; 13 uses
...
_ZN2v86bigint18CompareNoNormalizeENS0_6DigitsES1_.exit: ; preds = %.loopexit125
  %9 = sub i32 %.sroa.869.1, %indvars.i49101.lcssa
...
bb.k:                                             ; preds = %bb.i
  ...
  %i.bv = add nuw nsw i32 %.sroa.869.1, 1
  %10 = sub i32 %i.bv, %indvars.i49101.lcssa
  %i.bw = add i32 %10, %i.bu                      ; 3 uses
