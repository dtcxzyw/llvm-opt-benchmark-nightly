Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/node/original/ucnv_io?download=true
...
bb.f:                                             ; preds = %bb.e, %_ZL12getTagNumberPKc.exit.i
  %i.u = load i32, ptr getelementptr inbounds nuw (i8, ptr @_ZL10gMainTable, i64 76), align 4
  %i.v = add i32 %i.u, -1
  %i.w = icmp ult i32 %.1.i.i, %i.v
  br i1 %i.w, label %bb.g, label %_ZL22findTaggedConverterNumPKcS0_P10UErrorCode.exit.thread

bb.g:                                             ; preds = %bb.f
  %i.x = load i32, ptr getelementptr inbounds nuw (i8, ptr @_ZL10gMainTable, i64 72), align 8 ; 4 uses
  %i.y = icmp ult i32 %i.s, %i.x
  br i1 %i.y, label %bb.h, label %_ZL22findTaggedConverterNumPKcS0_P10UErrorCode.exit.thread

bb.h:                                             ; preds = %bb.g
  %i.z = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_ZL10gMainTable, i64 32), align 8 ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  %i.af = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_ZL10gMainTable, i64 40), align 8
...
_ZL13isAliasInListPKcj.exit49.thread.i:           ; preds = %bb.r, %bb.o, %bb.n
  ...
  br i1 %exitcond.not.i, label %_ZL22findTaggedConverterNumPKcS0_P10UErrorCode.exit.thread, label %bb.n, !llvm.loop !31
...
bb.t:                                             ; preds = %_ZL22findTaggedConverterNumPKcS0_P10UErrorCode.exit
  %i.bn = load ptr, ptr @_ZL10gMainTable, align 8
...
define dso_local noundef ptr @ucnv_openAllNames_78(ptr noundef %0) local_unnamed_addr #3 {
bb.a:
...
; Function Attrs: mustprogress nounwind uwtable
define dso_local zeroext i16 @ucnv_io_countKnownConverters_78(ptr noundef %0) local_unnamed_addr #3 {
bb.a:
  %i.a = tail call fastcc noundef signext i8 @_ZL13haveAliasDataP10UErrorCode(ptr noundef %0)
  %.not = icmp eq i8 %i.a, 0
...
bb.c:                                             ; preds = %bb.b
  ...
  %or.cond273 = select i1 %i.i, i1 %i.l, i1 false
  br i1 %or.cond273, label %bb.d, label %._crit_edge248
...
._crit_edge248:                                   ; preds = %bb.c, %bb.f, %bb.e, %bb.d
  ...
  tail call void (ptr, ptr, ...) @udata_printError_78(ptr noundef %0, ptr noundef nonnull @.str, i32 noundef %i.w, i32 noundef %i.x, i32 noundef %i.aa, i32 noundef %i.ad, i32 noundef %i.ag) #14
...
bb.i:                                             ; preds = %bb.h
  tail call void (ptr, ptr, ...) @udata_printError_78(ptr noundef %0, ptr noundef nonnull @.str.1, i32 noundef %i.ai) #14
...
bb.j:                                             ; preds = %bb.h, %bb.g
  ...
  %i.ap = tail call noundef i32 %i.an(i32 noundef %i.ao) #14 ; 4 uses
  store i32 %i.ap, ptr %i.a, align 16
...
bb.k:                                             ; preds = %bb.j
  tail call void (ptr, ptr, ...) @udata_printError_78(ptr noundef nonnull %0, ptr noundef nonnull @.str.2, i32 noundef %i.ap) #14
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.av = tail call noundef i32 %i.as(i32 noundef %i.au) #14
  %i.aw = getelementptr inbounds nuw [4 x i8], ptr %i.a, i64 %indvars.iv
  store i32 %i.av, ptr %i.aw, align 4
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.lr.ph203.preheader, label %.lr.ph, !llvm.loop !32
...
bb.m:                                             ; preds = %bb.l
  tail call void (ptr, ptr, ...) @udata_printError_78(ptr noundef nonnull %0, ptr noundef nonnull @.str.1, i32 noundef %i.bq) #14
  store i32 8, ptr %4, align 4
  br label %.critedge
...
bb.n:                                             ; preds = %bb.l
  ...
  %i.cj = tail call noundef i32 %i.bz(ptr noundef nonnull %0, ptr noundef nonnull %i.cb, i32 noundef %i.ch, ptr noundef %i.ci, ptr noundef nonnull %4) #14 ; 0 uses
  %i.ck = load i32, ptr %4, align 4
  %i.cl = icmp slt i32 %i.ck, 1
  br i1 %i.cl, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  tail call void (ptr, ptr, ...) @udata_printError_78(ptr noundef nonnull %0, ptr noundef nonnull @.str.3) #14
  br label %.critedge
...
bb.r:                                             ; preds = %bb.p
  ...
  %i.da = load i32, ptr %i.cz, align 4            ; 10 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  store ptr %5, ptr %i.dc, align 8
  %i.dd = getelementptr inbounds nuw i8, ptr %6, i64 16
  store ptr %i.b, ptr %i.dd, align 8
  br label %bb.w
...
bb.u:                                             ; preds = %bb.t
  tail call void (ptr, ptr, ...) @udata_printError_78(ptr noundef nonnull %0, ptr noundef nonnull @.str.4, i32 noundef %i.da) #14
...
bb.v:                                             ; preds = %bb.t
  ...
  %.pre253 = load i8, ptr %i.co, align 1
  br label %bb.w
...
bb.w:                                             ; preds = %bb.v, %bb.s
  ...
  store ptr %spec.select, ptr %i.dr, align 8
...
bb.x:                                             ; preds = %.lr.ph207, %bb.x
  %i.ea = phi ptr [ %i.do, %.lr.ph207 ], [ %i.eh, %bb.x ]
  %indvars.iv228 = phi i64 [ 0, %.lr.ph207 ], [ %indvars.iv.next229, %bb.x ] ; 5 uses
  %i.eb = load ptr, ptr %i.dy, align 8
  %i.ec = getelementptr inbounds nuw [2 x i8], ptr %i.dt, i64 %indvars.iv228
  %i.ed = load i16, ptr %i.ec, align 2
  %i.ee = call noundef zeroext i16 %i.eb(i16 noundef zeroext %i.ed) #14
  %i.ef = getelementptr inbounds nuw [4 x i8], ptr %i.ea, i64 %indvars.iv228
  store i16 %i.ee, ptr %i.ef, align 2
  %i.eg = trunc i64 %indvars.iv228 to i16
  %i.eh = load ptr, ptr %i.dz, align 8            ; 3 uses
  %i.ei = getelementptr inbounds nuw [4 x i8], ptr %i.eh, i64 %indvars.iv228
  %i.ej = getelementptr inbounds nuw i8, ptr %i.ei, i64 2
  store i16 %i.eg, ptr %i.ej, align 2
  ...
  br i1 %exitcond232.not, label %._crit_edge208, label %bb.x, !llvm.loop !33

._crit_edge208:                                   ; preds = %bb.x, %bb.w
  %i.ek = phi ptr [ %i.do, %bb.w ], [ %i.eh, %bb.x ]
  %i.el = getelementptr inbounds nuw i8, ptr %6, i64 8 ; 4 uses
  call void @uprv_sortArray_78(ptr noundef nonnull %i.ek, i32 noundef %i.da, i32 noundef 4, ptr noundef nonnull @_ZL14io_compareRowsPKvS0_S0_, ptr noundef nonnull %6, i8 noundef signext 0, ptr noundef nonnull %4) #14
  %i.em = load i32, ptr %4, align 4
  %i.en = icmp sgt i32 %i.em, 0
  br i1 %i.en, label %.loopexit, label %bb.y
...
.lr.ph210:                                        ; preds = %.preheader
  %i.eo = getelementptr inbounds nuw i8, ptr %0, i64 48 ; 2 uses
...
bb.z:                                             ; preds = %.lr.ph210, %bb.z
  ...
  %i.eq = getelementptr inbounds nuw [4 x i8], ptr %i.ep, i64 %indvars.iv233
  %i.er = getelementptr inbounds nuw i8, ptr %i.eq, i64 2
  %i.es = load i16, ptr %i.er, align 2
  %i.et = load ptr, ptr %i.eo, align 8
  %i.eu = zext i16 %i.es to i64                   ; 2 uses
  %i.ev = getelementptr inbounds nuw [2 x i8], ptr %i.dt, i64 %i.eu
  %i.ew = getelementptr inbounds nuw [2 x i8], ptr %i.du, i64 %indvars.iv233
  %i.ex = call noundef i32 %i.et(ptr noundef nonnull %0, ptr noundef nonnull %i.ev, i32 noundef 2, ptr noundef %i.ew, ptr noundef nonnull %4) #14 ; 0 uses
  %i.ey = load ptr, ptr %i.eo, align 8
  %i.ez = getelementptr inbounds nuw [2 x i8], ptr %i.dw, i64 %i.eu
  %i.fa = getelementptr inbounds nuw [2 x i8], ptr %i.dx, i64 %indvars.iv233
  %i.fb = call noundef i32 %i.ey(ptr noundef nonnull %0, ptr noundef nonnull %i.ez, i32 noundef 2, ptr noundef %i.fa, ptr noundef nonnull %4) #14 ; 0 uses
  %indvars.iv.next234 = add nuw nsw i64 %indvars.iv233, 1 ; 2 uses
  %exitcond237.not = icmp eq i64 %indvars.iv.next234, %wide.trip.count236
  br i1 %exitcond237.not, label %.loopexit, label %bb.z, !llvm.loop !34
...
bb.ab:                                            ; preds = %.lr.ph213, %bb.ab
  ...
  %i.ff = load ptr, ptr %i.el, align 8
  %i.fg = getelementptr inbounds nuw [4 x i8], ptr %i.ff, i64 %indvars.iv238
  %i.fh = getelementptr inbounds nuw i8, ptr %i.fg, i64 2
  %i.fi = load i16, ptr %i.fh, align 2
  %i.fj = load ptr, ptr %i.fe, align 8
  %i.fk = zext i16 %i.fi to i64
  %i.fl = getelementptr inbounds nuw [2 x i8], ptr %i.dt, i64 %i.fk
  %i.fm = getelementptr inbounds nuw [2 x i8], ptr %i.fd, i64 %indvars.iv238
  %i.fn = call noundef i32 %i.fj(ptr noundef nonnull %0, ptr noundef nonnull %i.fl, i32 noundef 2, ptr noundef %i.fm, ptr noundef nonnull %4) #14 ; 0 uses
  %indvars.iv.next239 = add nuw nsw i64 %indvars.iv238, 1 ; 2 uses
  %exitcond242.not = icmp eq i64 %indvars.iv.next239, %wide.trip.count241
  br i1 %exitcond242.not, label %.lr.ph217, label %bb.ab, !llvm.loop !35

.lr.ph217:                                        ; preds = %bb.ab
  %i.fo = shl nuw nsw i64 %wide.trip.count241, 1  ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr align 2 %i.du, ptr align 2 %i.fd, i64 %i.fo, i1 false)
...
bb.ac:                                            ; preds = %.lr.ph217, %bb.ac
  ...
  %i.fq = load ptr, ptr %i.el, align 8
  %i.fr = getelementptr inbounds nuw [4 x i8], ptr %i.fq, i64 %indvars.iv243
  %i.fs = getelementptr inbounds nuw i8, ptr %i.fr, i64 2
  %i.ft = load i16, ptr %i.fs, align 2
  %i.fu = load ptr, ptr %i.fp, align 8
  %i.fv = zext i16 %i.ft to i64
  %i.fw = getelementptr inbounds nuw [2 x i8], ptr %i.dw, i64 %i.fv
  %i.fx = getelementptr inbounds nuw [2 x i8], ptr %i.fd, i64 %indvars.iv243
  %i.fy = call noundef i32 %i.fu(ptr noundef nonnull %0, ptr noundef nonnull %i.fw, i32 noundef 2, ptr noundef %i.fx, ptr noundef nonnull %4) #14 ; 0 uses
  ...
  br i1 %exitcond247.not, label %._crit_edge218, label %bb.ac, !llvm.loop !36

._crit_edge218:                                   ; preds = %bb.ac, %bb.aa
  %i.fz = phi i64 [ 0, %bb.aa ], [ %i.fo, %bb.ac ]
  call void @llvm.memcpy.p0.p0.i64(ptr align 2 %i.dx, ptr align 2 %i.fd, i64 %i.fz, i1 false)
  br label %.loopexit

.loopexit:                                        ; preds = %bb.z, %.preheader, %._crit_edge218, %._crit_edge208
  %i.ga = load ptr, ptr %i.el, align 8            ; 2 uses
  %.not195 = icmp eq ptr %i.ga, %5
  br i1 %.not195, label %bb.ae, label %bb.ad

bb.ad:                                            ; preds = %.loopexit
  call void @uprv_free_78(ptr noundef %i.ga) #14
  br label %bb.ae

bb.ae:                                            ; preds = %bb.ad, %.loopexit
  %i.gb = load i32, ptr %4, align 4
  %i.gc = icmp slt i32 %i.gb, 1
  br i1 %i.gc, label %bb.ag, label %bb.af

bb.af:                                            ; preds = %bb.ae
  call void (ptr, ptr, ...) @udata_printError_78(ptr noundef nonnull %0, ptr noundef nonnull @.str.5, i32 noundef %i.da) #14
  br label %.critedge

bb.ag:                                            ; preds = %bb.ae
  %i.gd = getelementptr inbounds nuw i8, ptr %0, i64 48 ; 2 uses
  %i.ge = load ptr, ptr %i.gd, align 8
  %i.gf = zext nneg i32 %i.ax to i64              ; 2 uses
  %i.gg = getelementptr inbounds nuw [2 x i8], ptr %i.al, i64 %i.gf
  %i.gh = sub i32 %i.bd, %i.ax
  %i.gi = shl nsw i32 %i.gh, 1
  %i.gj = getelementptr inbounds nuw [2 x i8], ptr %i.bt, i64 %i.gf
  %i.gk = call noundef i32 %i.ge(ptr noundef nonnull %0, ptr noundef nonnull %i.gg, i32 noundef %i.gi, ptr noundef nonnull %i.gj, ptr noundef nonnull %4) #14 ; 0 uses
...
bb.ah:                                            ; preds = %._crit_edge204._crit_edge, %bb.ag, %bb.q
  ...
  %i.gs = add nsw i32 %.pre-phi256, %i.c
  br label %.critedge

.critedge:                                        ; preds = %bb.m, %bb.o, %bb.u, %bb.af, %bb.a, %bb.b, %bb.ah, %bb.k, %bb.i, %._crit_edge248
  %.1175 = phi i32 [ 0, %._crit_edge248 ], [ 0, %bb.i ], [ 0, %bb.k ], [ %i.gs, %bb.ah ], [ 0, %bb.a ], [ 0, %bb.b ], [ 0, %bb.af ], [ 0, %bb.u ], [ 0, %bb.o ], [ 0, %bb.m ]
...
bb.a:
  ...
  %i.j = call noundef ptr %i.e(ptr noundef nonnull %i.a, ptr noundef %i.i) #14
  ...
  %i.p = call noundef ptr %i.k(ptr noundef nonnull %i.b, ptr noundef %i.o) #14
...
bb.a:
  %i.a = load ptr, ptr @_ZL10gAliasData, align 8  ; 2 uses
  %.not = icmp eq ptr %i.a, null
  br i1 %.not, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  tail call void @udata_close_78(ptr noundef nonnull %i.a) #14
...
bb.a:
  ...
  tail call void @uprv_free_78(ptr noundef %i.b) #14
...
bb.b:                                             ; preds = %bb.a
  %i.d = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_ZL10gMainTable, i64 40), align 8
