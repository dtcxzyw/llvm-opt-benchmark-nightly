...
.preheader:                                       ; preds = %bb.a
  ...
  store i32 %i.j, ptr %i.k, align 4, !tbaa !9
  ...
  store i32 %i.p, ptr %i.q, align 4, !tbaa !9
  ...
  store i32 %i.v, ptr %i.w, align 4, !tbaa !9
  br label %.loopexit
...
bb.a:
  ...
  %i.e = load i32, ptr %i.d, align 8, !tbaa !10   ; 4 uses
...
vector.ph.a:                                      ; preds = %vector.main.loop.iter.check
  ...
  %i.u = getelementptr i8, ptr %i.i, i64 %i.j     ; 2 uses
  ...
  store <16 x i8> %i.w, ptr %1, align 1, !tbaa !9
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.ae, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !19
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph
  ...
  %i.ag = load i8, ptr %.07382, align 1, !tbaa !9
  ...
  store i8 %i.aj, ptr %.06884, align 1, !tbaa !9
  %i.al = add i64 %.07083, -1                     ; 3 uses
  %i.am = icmp ne i64 %i.al, 0
  %i.an = icmp samesign ult i64 %indvars.iv, 63
  %i.ao = and i1 %i.am, %i.an
  br i1 %i.ao, label %vec.epilog.scalar.ph, label %._crit_edge.loopexit, !llvm.loop !23
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.preheader
  ...
  store i32 %.066.lcssa, ptr %i.d, align 8, !tbaa !10
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.at = load i32, ptr %i.as, align 8, !tbaa !5
  %i.au = add i32 %i.at, 1                        ; 2 uses
  store i32 %i.au, ptr %i.as, align 8, !tbaa !5
...
.lr.ph95:                                         ; preds = %bb.e
  %i.bd = load i32, ptr %i.bc, align 8, !tbaa !5
...
bb.f:                                             ; preds = %.lr.ph95, %bb.h
  ...
  store i32 %spec.select, ptr %i.bc, align 8, !tbaa !5
  %i.bq = icmp eq i32 %spec.select, 0
  br i1 %i.bq, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f
  %i.br = load i32, ptr %i.bf, align 4, !tbaa !5
  %i.bs = add i32 %i.br, 1
  store i32 %i.bs, ptr %i.bf, align 4, !tbaa !5
  br label %bb.h
...
vector.body155:                                   ; preds = %vector.body155, %vector.ph152
  ...
  %wide.load157 = load <8 x i8>, ptr %i.by, align 1, !tbaa !9
  %wide.load158 = load <8 x i8>, ptr %i.bz, align 1, !tbaa !9
  %i.ca = getelementptr inbounds nuw i8, ptr %i.bt, i64 %index156 ; 2 uses
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 8
  %wide.load159 = load <8 x i8>, ptr %i.ca, align 1, !tbaa !9
  %wide.load160 = load <8 x i8>, ptr %i.cb, align 1, !tbaa !9
  ...
  store <8 x i8> %i.cc, ptr %i.ce, align 1, !tbaa !9
  ...
  br i1 %i.cg, label %middle.block162, label %vector.body155, !llvm.loop !25
...
vec.epilog.iter.check167:                         ; preds = %middle.block162
  ...
  br i1 %min.epilog.iters.check168, label %vec.epilog.scalar.ph166.preheader, label %vec.epilog.ph169, !prof !26
...
vec.epilog.vector.body172:                        ; preds = %vec.epilog.vector.body172, %vec.epilog.ph169
  ...
  %wide.load174 = load <4 x i8>, ptr %i.ch, align 1, !tbaa !9
  %i.ci = getelementptr inbounds nuw i8, ptr %i.bt, i64 %index173
  %wide.load175 = load <4 x i8>, ptr %i.ci, align 1, !tbaa !9
  ...
  br i1 %i.cl, label %vec.epilog.middle.block177, label %vec.epilog.vector.body172, !llvm.loop !27
...
vec.epilog.scalar.ph166.prol:                     ; preds = %vec.epilog.scalar.ph166.preheader, %vec.epilog.scalar.ph166.prol
  ...
  br i1 %prol.iter.cmp.not, label %vec.epilog.scalar.ph166.prol.loopexit, label %vec.epilog.scalar.ph166.prol, !llvm.loop !28
...
vec.epilog.scalar.ph166:                          ; preds = %vec.epilog.scalar.ph166.prol.loopexit, %vec.epilog.scalar.ph166
  ...
  br i1 %exitcond.not.3, label %.loopexit, label %vec.epilog.scalar.ph166, !llvm.loop !30
...
.preheader:                                       ; preds = %bb.a
  ...
  store <4 x i32> %i.e, ptr %i.d, align 4, !tbaa !5
  br label %.loopexit
...
!9 = !{!7, !7, i64 0}
!10 = !{!11, !6, i64 304}
!11 = !{!"", !12, i64 0, !7, i64 192, !7, i64 224, !7, i64 240, !6, i64 304}
!12 = !{!"prov_cipher_ctx_st", !7, i64 0, !7, i64 16, !7, i64 32, !13, i64 48, !7, i64 56, !6, i64 64, !14, i64 72, !14, i64 80, !14, i64 88, !14, i64 96, !6, i64 104, !6, i64 108, !6, i64 108, !6, i64 108, !6, i64 108, !6, i64 108, !6, i64 108, !6, i64 108, !6, i64 108, !6, i64 112, !15, i64 120, !6, i64 128, !14, i64 136, !6, i64 144, !14, i64 152, !6, i64 160, !16, i64 168, !13, i64 176, !17, i64 184}
