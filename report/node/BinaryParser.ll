begin_hunk_0
  ...
  br i1 %i.bv, label %.lr.ph494, label %.critedge

.lr.ph494:                                        ; preds = %bb.l, %select.unfold
  %i.bw = phi i64 [ %i.iq, %select.unfold ], [ %i.bu, %bb.l ] ; 3 uses
  %i.bx = phi ptr [ %i.ip, %select.unfold ], [ %i.bt, %bb.l ] ; 3 uses
  %i.by = phi ptr [ %i.io, %select.unfold ], [ %i.bs, %bb.l ] ; 3 uses
  %.0305397493 = phi i64 [ %.3308, %select.unfold ], [ 0, %bb.l ] ; 31 uses
  %.0296398492 = phi i64 [ %.11, %select.unfold ], [ 0, %bb.l ] ; 30 uses
  %.0293399491 = phi i8 [ %.2295, %select.unfold ], [ 0, %bb.l ] ; 37 uses
  %.0184400490 = phi i64 [ %.13, %select.unfold ], [ 0, %bb.l ] ; 27 uses
  %.0179401489 = phi i8 [ %.4183, %select.unfold ], [ 0, %bb.l ] ; 32 uses
  %.0172402488 = phi i8 [ %.6178, %select.unfold ], [ 0, %bb.l ] ; 31 uses
  %.0161404487 = phi i8 [ %.5166, %select.unfold ], [ 0, %bb.l ] ; 35 uses
  %.0153405486 = phi i64 [ %.4157, %select.unfold ], [ 0, %bb.l ] ; 35 uses
  %.0148406485 = phi i32 [ %.4152, %select.unfold ], [ 0, %bb.l ] ; 32 uses
  %.0144407484 = phi i8 [ %.3147, %select.unfold ], [ 0, %bb.l ] ; 35 uses
...
begin_hunk_1
  ...
  %reass.sub412 = sub i64 %i.dy, %i.an
  %i.dz = add i64 %reass.sub412, 1
...
begin_hunk_3
  ...
  %reass.sub411 = sub i64 %i.ev, %i.an
  %i.ew = add i64 %reass.sub411, 1
...
begin_hunk_4
  ...
  %reass.sub410 = sub i64 %i.fp, %i.an
  %i.fq = add i64 %reass.sub410, 1                ; 2 uses
...
begin_hunk_5
  ...
  %reass.sub = sub i64 %i.hz, %i.an
  %i.ia = add i64 %reass.sub, 1
  br label %bb.be
...
begin_hunk_6
  ...
  br i1 %i.bp, label %.lr.ph226, label %.critedge

.lr.ph226:                                        ; preds = %bb.l, %.loopexit
  %i.bq = phi i64 [ %i.fc, %.loopexit ], [ %i.bo, %bb.l ] ; 3 uses
  %i.br = phi ptr [ %i.fb, %.loopexit ], [ %i.bn, %bb.l ] ; 3 uses
  %i.bs = phi ptr [ %i.fa, %.loopexit ], [ %i.bm, %bb.l ] ; 3 uses
  %.0131195225 = phi i64 [ %.4135, %.loopexit ], [ 0, %bb.l ] ; 16 uses
  %.0123197224 = phi i8 [ %.4127, %.loopexit ], [ 0, %bb.l ] ; 21 uses
  %.0119198223 = phi i64 [ %.3122, %.loopexit ], [ 0, %bb.l ] ; 20 uses
  %.0115199222 = phi i64 [ %.7, %.loopexit ], [ 0, %bb.l ] ; 19 uses
  %.0112200221 = phi i8 [ %.3, %.loopexit ], [ 0, %bb.l ] ; 20 uses
  %.0111201220 = phi i8 [ %.2, %.loopexit ], [ 0, %bb.l ] ; 20 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #18
  store i8 0, ptr %i.a, align 1
...
begin_hunk_7
  ...
  %reass.sub203 = sub i64 %i.dj, %i.an
  %i.dk = add i64 %reass.sub203, 1
...
begin_hunk_9
  ...
  %reass.sub202 = sub i64 %i.eb, %i.an
  %i.ec = add i64 %reass.sub202, 1
...
begin_hunk_10
  ...
  %i.eu = getelementptr inbounds nuw i8, ptr %i.et, i64 8
  %i.ev = load i64, ptr %i.eu, align 8
  %reass.sub = sub i64 %i.ev, %i.an
  %i.ew = add i64 %reass.sub, 1                   ; 2 uses
...
begin_hunk_12
  ...
  %reass.sub = sub i64 %i.dn, %i.an
  %i.do = add i64 %reass.sub, 1
