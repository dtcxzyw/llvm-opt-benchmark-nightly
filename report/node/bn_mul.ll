Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/node/original/bn_mul?download=true
begin_hunk_0
target datalayout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: nounwind uwtable
define dso_local i64 @bn_sub_part_words(ptr noundef %0, ptr noundef %1, ptr noundef %2, i32 noundef %3, i32 noundef %4) local_unnamed_addr #0 {
bb.a:
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.af = load i64, ptr %i.ad, align 8, !tbaa !11 ; 2 uses
  %i.ag = add i64 %spec.select149, %i.af
  %i.ah = sub i64 0, %i.ag
  store i64 %i.ah, ptr %i.ae, align 8, !tbaa !11
...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %.not, label %.preheader163, label %.lr.ph, !llvm.loop !13
...
.preheader163:                                    ; preds = %bb.i, %bb.f
  ...
  %5 = load i64, ptr %.0111.lcssa, align 8, !tbaa !11
  store i64 %5, ptr %.1115.lcssa, align 8, !tbaa !11
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.bx = load i64, ptr %i.bv, align 8, !tbaa !11
  store i64 %i.bx, ptr %i.bw, align 8, !tbaa !11
...
; Function Attrs: nounwind uwtable
define dso_local void @bn_mul_recursive(ptr noundef %0, ptr noundef %1, ptr noundef %2, i32 noundef %3, i32 noundef %4, i32 noundef %5, ptr noundef %6) local_unnamed_addr #0 {
bb.a:
