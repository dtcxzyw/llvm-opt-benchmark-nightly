...
@.str.171 = private unnamed_addr constant [30 x i8] c"../../deps/uv/src/uv-common.c\00", align 1
...
@.str.172 = private unnamed_addr constant [9 x i8] c"err == 0\00", align 1
...
@.str.173 = private unnamed_addr constant [21 x i8] c"Unknown system error\00", align 1
@stderr = external local_unnamed_addr global ptr, align 8
@.str.174 = private unnamed_addr constant [6 x i8] c"async\00", align 1
@.str.175 = private unnamed_addr constant [6 x i8] c"check\00", align 1
@.str.176 = private unnamed_addr constant [9 x i8] c"fs_event\00", align 1
@.str.177 = private unnamed_addr constant [8 x i8] c"fs_poll\00", align 1
@.str.178 = private unnamed_addr constant [7 x i8] c"handle\00", align 1
@.str.179 = private unnamed_addr constant [5 x i8] c"idle\00", align 1
@.str.180 = private unnamed_addr constant [5 x i8] c"pipe\00", align 1
@.str.181 = private unnamed_addr constant [5 x i8] c"poll\00", align 1
@.str.182 = private unnamed_addr constant [8 x i8] c"prepare\00", align 1
@.str.183 = private unnamed_addr constant [8 x i8] c"process\00", align 1
@.str.184 = private unnamed_addr constant [7 x i8] c"stream\00", align 1
@.str.185 = private unnamed_addr constant [4 x i8] c"tcp\00", align 1
@.str.186 = private unnamed_addr constant [6 x i8] c"timer\00", align 1
@.str.187 = private unnamed_addr constant [4 x i8] c"tty\00", align 1
@.str.188 = private unnamed_addr constant [4 x i8] c"udp\00", align 1
@.str.189 = private unnamed_addr constant [7 x i8] c"signal\00", align 1
@.str.190 = private unnamed_addr constant [10 x i8] c"<unknown>\00", align 1
@.str.191 = private unnamed_addr constant [18 x i8] c"[%c%c%c] %-8s %p\0A\00", align 1
@.str.192 = private unnamed_addr constant [3 x i8] c"R-\00", align 1
@.str.193 = private unnamed_addr constant [3 x i8] c"A-\00", align 1
@.str.194 = private unnamed_addr constant [3 x i8] c"I-\00", align 1
...
uv__malloc.exit:                                  ; preds = %bb.a
  %i.c = load ptr, ptr @uv__allocator.0, align 8
  %i.d = tail call ptr %i.c(i64 noundef %i.b) #25, !inline_history !8 ; 3 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %uv__malloc.exit.thread, label %bb.b

bb.b:                                             ; preds = %uv__malloc.exit
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.d, ptr nonnull align 1 %0, i64 %i.b, i1 false)
  br label %uv__malloc.exit.thread

uv__malloc.exit.thread:                           ; preds = %bb.a, %uv__malloc.exit, %bb.b
  %.0 = phi ptr [ %i.d, %bb.b ], [ null, %uv__malloc.exit ], [ null, %bb.a ]
  ret ptr %.0
}
...
bb.b:                                             ; preds = %bb.a
  %i.a = load ptr, ptr @uv__allocator.0, align 8
  %i.b = tail call ptr %i.a(i64 noundef %0) #25
  br label %bb.c
...
bb.a:
  %i.a = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %0) #24
  %spec.select = tail call i64 @llvm.umin.i64(i64 %1, i64 %i.a) ; 3 uses
  %i.b = add i64 %spec.select, 1                  ; 2 uses
  %.not.i = icmp eq i64 %i.b, 0
  br i1 %.not.i, label %uv__malloc.exit.thread, label %uv__malloc.exit

uv__malloc.exit:                                  ; preds = %bb.a
  %i.c = load ptr, ptr @uv__allocator.0, align 8
  %i.d = tail call ptr %i.c(i64 noundef %i.b) #25, !inline_history !8 ; 4 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %uv__malloc.exit.thread, label %bb.b

bb.b:                                             ; preds = %uv__malloc.exit
  %i.f = getelementptr inbounds nuw i8, ptr %i.d, i64 %spec.select
  store i8 0, ptr %i.f, align 1
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.d, ptr nonnull align 1 %0, i64 %spec.select, i1 false)
  br label %uv__malloc.exit.thread

uv__malloc.exit.thread:                           ; preds = %bb.a, %uv__malloc.exit, %bb.b
  %.011 = phi ptr [ %i.d, %bb.b ], [ null, %uv__malloc.exit ], [ null, %bb.a ]
  ret ptr %.011
}
...
bb.a:
  %i.a = tail call ptr @__errno_location() #26    ; 2 uses
  %i.b = load i32, ptr %i.a, align 4
  %i.c = load ptr, ptr @uv__allocator.3, align 8
  tail call void %i.c(ptr noundef %0) #25
...
bb.a:
  %i.a = load ptr, ptr @uv__allocator.2, align 8
  %i.b = tail call ptr %i.a(i64 noundef %0, i64 noundef %1) #25
  ret ptr %i.b
}
...
bb.b:                                             ; preds = %bb.a
  %i.a = load ptr, ptr @uv__allocator.1, align 8
  %i.b = tail call ptr %i.a(ptr noundef %0, i64 noundef %1) #25
  br label %bb.d

bb.c:                                             ; preds = %bb.a
  %i.c = tail call ptr @__errno_location() #26    ; 2 uses
  %i.d = load i32, ptr %i.c, align 4
  %i.e = load ptr, ptr @uv__allocator.3, align 8
  tail call void %i.e(ptr noundef %0) #25, !inline_history !9
...
uv__realloc.exit:                                 ; preds = %bb.a
  %i.a = load ptr, ptr @uv__allocator.1, align 8
  %i.b = tail call ptr %i.a(ptr noundef %0, i64 noundef %1) #25, !inline_history !10 ; 2 uses
  %i.c = icmp eq ptr %i.b, null
  br i1 %i.c, label %.sink.split, label %bb.b

.sink.split:                                      ; preds = %uv__realloc.exit, %bb.a
  %i.d = tail call ptr @__errno_location() #26    ; 2 uses
  %i.e = load i32, ptr %i.d, align 4
  %i.f = load ptr, ptr @uv__allocator.3, align 8
  tail call void %i.f(ptr noundef %0) #25
  store i32 %i.e, ptr %i.d, align 4
  br label %bb.b

bb.b:                                             ; preds = %.sink.split, %uv__realloc.exit
  %.0.i8 = phi ptr [ %i.b, %uv__realloc.exit ], [ null, %.sink.split ]
  ret ptr %.0.i8
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i32, ptr %i.c, align 4
  %i.e = load ptr, ptr @uv__allocator.3, align 8
  tail call void %i.e(ptr noundef %i.b) #25, !inline_history !9
  store i32 %i.d, ptr %i.c, align 4
...
bb.a:
end_hunk_0
begin_hunk_1_@uv_udp_init_ex:bb.a
bb.b:                                             ; preds = %bb.a
  %i.d = tail call i32 @uv__udp_init_ex(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %i.a) #25 ; 2 uses
  %i.e = icmp ne i32 %i.d, 0
  %.not17 = icmp samesign ult i32 %2, 256
  %or.cond18 = or i1 %.not17, %i.e
  br i1 %or.cond18, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.f = getelementptr inbounds nuw i8, ptr %1, i64 88 ; 2 uses
  %i.g = load i32, ptr %i.f, align 8
  %i.h = or i32 %i.g, 67108864
  store i32 %i.h, ptr %i.f, align 8
  br label %bb.d

bb.d:                                             ; preds = %bb.b, %bb.c, %bb.a
  %.0 = phi i32 [ %i.d, %bb.b ], [ -22, %bb.a ], [ 0, %bb.c ]
  ret i32 %.0
}
...
bb.a:
  %i.a = tail call i32 @uv__udp_init_ex(ptr noundef %0, ptr noundef %1, i32 noundef 0, i32 noundef 0) #25
  ret i32 %i.a
}
...
bb.d:                                             ; preds = %bb.b, %bb.c
  %.0 = phi i32 [ 28, %bb.c ], [ 16, %bb.b ]
  %i.d = tail call i32 @uv__udp_bind(ptr noundef nonnull %0, ptr noundef nonnull %1, i32 noundef %.0, i32 noundef %2) #25
  br label %bb.e

bb.e:                                             ; preds = %bb.b, %bb.a, %bb.d
  %.07 = phi i32 [ -22, %bb.a ], [ %i.d, %bb.d ], [ -22, %bb.b ]
  ret i32 %.07
}
...
bb.d:                                             ; preds = %bb.b, %bb.c
  %.0 = phi i32 [ 28, %bb.c ], [ 16, %bb.b ]
  %i.d = tail call i32 @uv__tcp_connect(ptr noundef %0, ptr noundef nonnull %1, ptr noundef nonnull %2, i32 noundef %.0, ptr noundef %3) #25
  br label %bb.e

bb.e:                                             ; preds = %bb.b, %bb.a, %bb.d
  %.08 = phi i32 [ -22, %bb.a ], [ %i.d, %bb.d ], [ -22, %bb.b ]
  ret i32 %.08
}
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %.not14, label %bb.i, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.g = tail call i32 @uv__udp_disconnect(ptr noundef nonnull %0) #25
  br label %bb.i

bb.e:                                             ; preds = %bb.b
  %i.h = load i16, ptr %1, align 2
  switch i16 %i.h, label %bb.i [
    i16 2, label %bb.g
    i16 10, label %bb.f
  ]
...
bb.h:                                             ; preds = %bb.g
  %i.l = tail call i32 @uv__udp_connect(ptr noundef nonnull %0, ptr noundef nonnull %1, i32 noundef %.0) #25
  br label %bb.i

bb.i:                                             ; preds = %bb.g, %bb.e, %bb.c, %bb.a, %bb.h, %bb.d
  %.010 = phi i32 [ -107, %bb.c ], [ %i.g, %bb.d ], [ -22, %bb.a ], [ -22, %bb.e ], [ %i.l, %bb.h ], [ -106, %bb.g ]
  ret i32 %.010
}
...
bb.a:
  %1 = alloca %struct.sockaddr_storage, align 8   ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = call i32 @uv_udp_getpeername(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %i.a) #25
...
bb.d:                                             ; preds = %bb.b, %bb.a, %bb.c
  %.0 = phi i32 [ %i.g, %bb.c ], [ 0, %bb.a ], [ 0, %bb.b ]
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %cond, label %bb.d, label %bb.c
...
bb.a:
  ...
  br i1 %.not.i, label %bb.b, label %uv__udp_check_before_send.exit.thread
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i32, ptr %i.c, align 8
  %i.e = and i32 %i.d, 33554432
  %.not15.i = icmp eq i32 %i.e, 0                 ; 2 uses
  br i1 %cond.i, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  br i1 %.not15.i, label %bb.e, label %uv__udp_check_before_send.exit.thread

bb.d:                                             ; preds = %bb.b
  br i1 %.not15.i, label %uv__udp_check_before_send.exit.thread, label %uv__udp_check_before_send.exit

bb.e:                                             ; preds = %bb.c
  %i.f = load i16, ptr %4, align 2
  switch i16 %i.f, label %uv__udp_check_before_send.exit.thread [
    i16 2, label %bb.g
...
uv__udp_check_before_send.exit:                   ; preds = %bb.e, %bb.g, %bb.f, %bb.d
  %.010.i = phi i32 [ 0, %bb.d ], [ 110, %bb.f ], [ 16, %bb.g ], [ 28, %bb.e ]
  %i.g = tail call i32 @uv__udp_send(ptr noundef %0, ptr noundef nonnull %1, ptr noundef %2, i32 noundef %3, ptr noundef %4, i32 noundef %.010.i, ptr noundef %5) #25
  br label %uv__udp_check_before_send.exit.thread

uv__udp_check_before_send.exit.thread:            ; preds = %bb.d, %bb.e, %bb.a, %bb.c, %uv__udp_check_before_send.exit
  %.0 = phi i32 [ %i.g, %uv__udp_check_before_send.exit ], [ -106, %bb.c ], [ -22, %bb.e ], [ -22, %bb.a ], [ -89, %bb.d ]
  ret i32 %.0
}
...
uv__udp_check_before_send.exit:                   ; preds = %bb.e, %bb.g, %bb.f, %bb.d
  %.010.i = phi i32 [ 0, %bb.d ], [ 110, %bb.f ], [ 16, %bb.g ], [ 28, %bb.e ]
  %i.g = tail call i32 @uv__udp_try_send(ptr noundef nonnull %0, ptr noundef %1, i32 noundef %2, ptr noundef %3, i32 noundef %.010.i) #25
  br label %uv__udp_check_before_send.exit.thread
...
bb.c:                                             ; preds = %bb.b
  %i.d = tail call i32 @uv__udp_try_send2(ptr noundef nonnull %0, i32 noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef %4) #25
  br label %bb.d

bb.d:                                             ; preds = %bb.b, %bb.a, %bb.c
  %.0 = phi i32 [ %i.d, %bb.c ], [ -22, %bb.a ], [ -11, %bb.b ]
  ret i32 %.0
}
...
bb.b:                                             ; preds = %bb.a
  %i.f = tail call i32 @uv__udp_recv_start(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %2) #25
  br label %bb.c

bb.c:                                             ; preds = %bb.a, %bb.b
  %.0 = phi i32 [ %i.f, %bb.b ], [ -22, %bb.a ]
  ret i32 %.0
}
...
bb.b:                                             ; preds = %bb.a
  %i.c = tail call i32 @uv__udp_recv_stop(ptr noundef nonnull %0) #25
  br label %bb.c

bb.c:                                             ; preds = %bb.a, %bb.b
  %.0 = phi i32 [ %i.c, %bb.b ], [ -22, %bb.a ]
  ret i32 %.0
}
...
bb.a:
  %3 = alloca %struct.uv__queue, align 8          ; 10 uses
...
uv__queue_move.exit:                              ; preds = %bb.a
...
bb.b:                                             ; preds = %.lr.ph, %.backedge
  %i.i = phi ptr [ %.pre, %.lr.ph ], [ %i.t, %.backedge ] ; 7 uses
