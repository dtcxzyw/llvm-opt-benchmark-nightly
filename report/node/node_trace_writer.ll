...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a:   ; preds = %bb.d, %.lr.ph.i.i
  ...
  %reass.sub = sub i64 %.041.i.i, %i.c
  %i.l = add i64 %reass.sub, 1
  %3 = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02840.i.i, i32 noundef %i.j, i64 noundef %i.l) #19 ; 4 uses
  %.not34.i.i.a = icmp eq ptr %3, null
  br i1 %.not34.i.i.a, label %._crit_edge, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i15:   ; preds = %bb.k, %.lr.ph.i.i14
  ...
  %reass.sub31 = sub i64 %.041.i.i16, %i.ae
  %i.ao = add i64 %reass.sub31, 1
  %4 = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02840.i.i17, i32 noundef %i.am, i64 noundef %i.ao) #19 ; 4 uses
  %.not34.i.i19 = icmp eq ptr %4, null
  br i1 %.not34.i.i19, label %._crit_edge, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i20

_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i20: ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i15
...
._crit_edge:                                      ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a, %bb.d, %bb.g, %bb.i, %bb.h, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findERKS4_m.exit23, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i15, %bb.k, %bb.c, %bb.b, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findERKS4_m.exit
  ret void
}
