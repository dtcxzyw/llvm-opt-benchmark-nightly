...
bb.bg:                                            ; preds = %bb.bf, %bb.be
  %6 = getelementptr inbounds nuw i8, ptr %0, i64 139404 ; 6 uses
  %7 = load i32, ptr %6, align 4
  %i.ic = shl nsw i32 %7, 1
  ...
  %i.ig = shl nsw i32 %i.if, %.
  %i.ih = add nsw i32 %i.id, %i.ig                ; 6 uses
  %8 = icmp sgt i32 %i.ih, %2
  br i1 %8, label %.loopexit, label %bb.bh
...
bb.bj:                                            ; preds = %bb.bi, %bb.bh
  ...
  %i.is = load i32, ptr %6, align 4               ; 13 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.jb = load i32, ptr %6, align 4, !alias.scope !23
...
.loopexit:                                        ; preds = %.lr.ph98, %middle.block159, %._crit_edge, %._crit_edge104, %bb.bg, %_ZL10utrie_foldP8UNewTriePFjS0_iiEP10UErrorCode.exit, %bb.a, %bb.b, %bb.e
  %.081 = phi i32 [ 0, %bb.a ], [ 0, %bb.e ], [ 0, %_ZL10utrie_foldP8UNewTriePFjS0_iiEP10UErrorCode.exit ], [ %i.ih, %bb.bg ], [ 0, %bb.b ], [ %i.ih, %._crit_edge104 ], [ %i.ih, %._crit_edge ], [ %i.ih, %middle.block159 ], [ %i.ih, %.lr.ph98 ]
  ret i32 %.081
}
