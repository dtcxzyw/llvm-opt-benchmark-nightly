...
_ZNK6icu_7813UnicodeString6charAtEi.exit35.thread: ; preds = %_ZNK6icu_7813UnicodeString6charAtEi.exit35, %bb.g, %_ZNK6icu_7813UnicodeString6charAtEi.exit, %bb.c
  %.1 = phi i32 [ %i.m, %bb.c ], [ %i.af, %_ZNK6icu_7813UnicodeString6charAtEi.exit ], [ %spec.select, %_ZNK6icu_7813UnicodeString6charAtEi.exit35 ], [ %i.af, %bb.g ] ; 2 uses
  %i.bb = icmp eq i32 %.1, -1
  br i1 %i.bb, label %bb.h, label %.thread

.thread:                                          ; preds = %bb.f, %_ZNK6icu_7813UnicodeString6charAtEi.exit35.thread
  %.139 = phi i32 [ %.1, %_ZNK6icu_7813UnicodeString6charAtEi.exit35.thread ], [ %i.af, %bb.f ]
