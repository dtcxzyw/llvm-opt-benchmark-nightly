...
_ZNSt11_Deque_baseIPN2v88internal8compiler10BasicBlockENS1_22RecyclingZoneAllocatorIS4_EEE18_M_deallocate_nodeEPS4_.exit.i.i.i.i: ; preds = %bb.ap, %bb.ao
  ...
  br i1 %i.ip, label %bb.an, label %_ZNSt11_Deque_baseIPN2v88internal8compiler10BasicBlockENS1_22RecyclingZoneAllocatorIS4_EEE16_M_destroy_nodesEPPS4_S9_.exit.i.i.i, !llvm.loop !2
...
bb.ar:                                            ; preds = %.lr.ph348
  ...
  br i1 %i.jq, label %bb.at, label %bb.as, !prof !12
...
bb.at:                                            ; preds = %bb.ar
  ...
  br i1 %i.jv, label %bb.av, label %bb.au, !prof !12
...
bb.aw:                                            ; preds = %bb.be
  ...
  br i1 %.not304.1, label %.loopexit574, label %bb.ax, !prof !15
...
.epil.preheader:                                  ; preds = %._crit_edge351.loopexit.unr-lcssa, %.lr.ph350
  ...
  br i1 %.not304.epil, label %.loopexit574, label %._crit_edge351, !prof !15
...
._crit_edge351:                                   ; preds = %._crit_edge351.loopexit.unr-lcssa, %.epil.preheader, %.preheader
  ...
  br i1 %.not.i.i219.not, label %_ZN2v88internal10ZoneVectorIPNS0_9BitVectorEE14EnsureCapacityEm.exit.i, label %bb.ay, !prof !12
...
_ZNSt5queueIPN2v88internal8compiler10BasicBlockENS1_9ZoneDequeIS4_EEE4pushERKS4_.exit221: ; preds = %bb.az, %bb.ba
  ...
  br i1 %i.lw, label %bb.bb, label %_ZN2v88internal4Zone8AllocateINS0_9BitVectorEEEPvm.exit.i, !prof !15
...
bb.bc:                                            ; preds = %_ZN2v88internal4Zone8AllocateINS0_9BitVectorEEEPvm.exit.i
  ...
  br i1 %i.mi, label %bb.bd, label %.lr.ph.i.i.i.i.i.i, !prof !15
...
bb.be:                                            ; preds = %bb.ax, %.lr.ph350.new
  ...
  br i1 %.not304, label %.loopexit574, label %bb.aw, !prof !15
