...
define range(i32 0, 256) i32 @mbedtls_ct_memcmp(ptr noundef captures(address) %0, ptr noundef captures(address) %1, i64 noundef %2) local_unnamed_addr #0 {
bb.a:
  %.not = icmp eq i64 %2, 0
...
define range(i32 0, 256) i32 @mbedtls_ct_memcmp_partial(ptr noundef captures(address) %0, ptr noundef captures(address) %1, i64 noundef %2, i64 noundef %3, i64 noundef %4) local_unnamed_addr #1 {
bb.a:
  %i.a = sub i64 %2, %4
  %.not = icmp eq i64 %2, 0
...
; Function Attrs: nounwind uwtable
define void @mbedtls_ct_memmove_left(ptr noundef captures(address) %0, i64 noundef %1, i64 noundef %2) local_unnamed_addr #1 {
bb.a:
  %.not = icmp eq i64 %1, 0
...
; Function Attrs: nounwind uwtable
define void @mbedtls_ct_memcpy_if(i64 noundef %0, ptr noundef captures(none) %1, ptr noundef readonly captures(none) %2, ptr noundef readonly captures(address_is_null) %3, i64 noundef %4) local_unnamed_addr #1 {
bb.a:
...
vector.memcheck:                                  ; preds = %.lr.ph34.preheader
  %i.h = sub i64 %i.b, %i.a
  %diff.check = icmp ult i64 %i.h, 16
  %i.i = sub i64 %i.b, %spec.select35
  %diff.check36 = icmp ult i64 %i.i, 16
...
; Function Attrs: nounwind uwtable
define void @mbedtls_ct_memcpy_offset(ptr noundef captures(none) %0, ptr noundef readonly captures(none) %1, i64 noundef %2, i64 noundef %3, i64 noundef %4, i64 noundef %5) local_unnamed_addr #1 {
bb.a:
...
define void @mbedtls_ct_zeroize_if(i64 noundef %0, ptr noundef captures(none) %1, i64 noundef %2) local_unnamed_addr #2 {
bb.a:
