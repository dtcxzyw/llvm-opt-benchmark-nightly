...
bb.a:
  %i.a = icmp eq i32 %2, 0
  br i1 %i.a, label %vector.ph48, label %5
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.3, %call.0.i
  ...
  %i.ca = icmp samesign ult i64 %.0.i3.i.i, 8062
  br i1 %i.ca, label %.lr.ph.i.i.3, label %.tail.i
...
.lr.ph.i:                                         ; preds = %.tail.i
  %i.cb = getelementptr inbounds nuw i8, ptr %3, i64 4104 ; 17 uses
  %i.cc = getelementptr inbounds [4 x i8], ptr @ZSTD_splitBlock_byChunks.hashParams, i64 %7
  %i.cd = getelementptr inbounds nuw i8, ptr %3, i64 4096
  %i.ce = getelementptr inbounds nuw i8, ptr %3, i64 8200 ; 2 uses
  br label %93

93:                                               ; preds = %mergeEvents.exit.i, %.lr.ph.i
  %94 = phi i64 [ %.sink, %.lr.ph.i ], [ %i.dn, %mergeEvents.exit.i ] ; 3 uses
  %.036.i = phi i64 [ 8192, %.lr.ph.i ], [ %i.dq, %mergeEvents.exit.i ] ; 3 uses
...
call.029.i:                                       ; preds = %93
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1024) %i.cb, i8 0, i64 1024, i1 false)
  store i64 0, ptr %i.ce, align 8, !tbaa !18
  br label %.lr.ph.i48.i

.lr.ph.i48.i:                                     ; preds = %.lr.ph.i48.i.3, %call.029.i
  %.0.i3.i49.i = phi i64 [ 0, %call.029.i ], [ %121, %.lr.ph.i48.i.3 ] ; 6 uses
  %96 = getelementptr inbounds nuw i8, ptr %95, i64 %.0.i3.i49.i
  %97 = load i8, ptr %96, align 1, !tbaa !22
  %98 = zext i8 %97 to i64
  %99 = getelementptr inbounds nuw [4 x i8], ptr %i.cb, i64 %98 ; 2 uses
  %100 = load i32, ptr %99, align 4, !tbaa !5
  %101 = add i32 %100, 1
  store i32 %101, ptr %99, align 4, !tbaa !5
  %102 = getelementptr inbounds nuw i8, ptr %95, i64 %.0.i3.i49.i
  %i.cf = getelementptr inbounds nuw i8, ptr %102, i64 43
  %103 = load i8, ptr %i.cf, align 1, !tbaa !22
  %104 = zext i8 %103 to i64
  %105 = getelementptr inbounds nuw [4 x i8], ptr %i.cb, i64 %104 ; 2 uses
  %i.cg = load i32, ptr %105, align 4, !tbaa !5
  %106 = add i32 %i.cg, 1
  store i32 %106, ptr %105, align 4, !tbaa !5
  %107 = getelementptr inbounds nuw i8, ptr %95, i64 %.0.i3.i49.i
  %108 = getelementptr inbounds nuw i8, ptr %107, i64 86
  %109 = load i8, ptr %108, align 1, !tbaa !22
  %i.ch = zext i8 %109 to i64
  %110 = getelementptr inbounds nuw [4 x i8], ptr %i.cb, i64 %i.ch ; 2 uses
  %111 = load i32, ptr %110, align 4, !tbaa !5
  %112 = add i32 %111, 1
  store i32 %112, ptr %110, align 4, !tbaa !5
  %113 = icmp samesign ult i64 %.0.i3.i49.i, 8062
  br i1 %113, label %.lr.ph.i48.i.3, label %.tail27.i

.lr.ph.i48.i.3:                                   ; preds = %.lr.ph.i48.i
  %114 = getelementptr inbounds nuw i8, ptr %95, i64 %.0.i3.i49.i
  %115 = getelementptr inbounds nuw i8, ptr %114, i64 129
  %116 = load i8, ptr %115, align 1, !tbaa !22
  %117 = zext i8 %116 to i64
  %118 = getelementptr inbounds nuw [4 x i8], ptr %i.cb, i64 %117 ; 2 uses
  %119 = load i32, ptr %118, align 4, !tbaa !5
  %120 = add i32 %119, 1
  store i32 %120, ptr %118, align 4, !tbaa !5
  %121 = add nuw nsw i64 %.0.i3.i49.i, 172
  br label %.lr.ph.i48.i

call.130.i:                                       ; preds = %93
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(2048) %i.cb, i8 0, i64 2048, i1 false)
...
.lr.ph.i51.i:                                     ; preds = %.lr.ph.i51.i.1, %call.130.i
  ...
  %125 = lshr i64 %124, 23
  %126 = and i64 %125, 511
  %127 = getelementptr inbounds nuw [4 x i8], ptr %i.cb, i64 %126 ; 2 uses
...
.lr.ph.i51.i.1:                                   ; preds = %.lr.ph.i51.i
  ...
  %135 = lshr i64 %134, 23
  %136 = and i64 %135, 511
  %137 = getelementptr inbounds nuw [4 x i8], ptr %i.cb, i64 %136 ; 2 uses
...
call.231.i:                                       ; preds = %93
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(4104) %i.cb, i8 0, i64 4104, i1 false)
...
.lr.ph.i55.i:                                     ; preds = %.lr.ph.i55.i.1, %call.231.i
  ...
  %146 = getelementptr inbounds nuw [4 x i8], ptr %i.cb, i64 %145 ; 2 uses
...
.lr.ph.i55.i.1:                                   ; preds = %.lr.ph.i55.i
  ...
  %156 = getelementptr inbounds nuw [4 x i8], ptr %i.cb, i64 %155 ; 2 uses
...
.lr.ph.i59.i:                                     ; preds = %.lr.ph.i59.i.1, %call.332.i
  ...
  %165 = getelementptr inbounds nuw [4 x i8], ptr %i.cb, i64 %164 ; 2 uses
...
.lr.ph.i59.i.1:                                   ; preds = %.lr.ph.i59.i
  ...
  %174 = getelementptr inbounds nuw [4 x i8], ptr %i.cb, i64 %173 ; 2 uses
...
.tail27.i:                                        ; preds = %.lr.ph.i59.i, %.lr.ph.i55.i, %.lr.ph.i51.i, %.lr.ph.i48.i
  ...
  store i64 %.sink.i, ptr %i.ce, align 8, !tbaa !18
  %178 = load i32, ptr %i.cc, align 4, !tbaa !5
  %179 = zext nneg i32 %178 to i64
  br label %bb.b

bb.b:                                             ; preds = %bb.b, %.tail27.i
  %.012.i.i.i11 = phi i64 [ 0, %.tail27.i ], [ %i.ct, %bb.b ] ; 3 uses
  %.01011.i.i.i12 = phi i64 [ 0, %.tail27.i ], [ %i.cs, %bb.b ]
  %i.ci = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %.012.i.i.i11
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !5
  %i.ck = zext i32 %i.cj to i64
  %i.cl = mul nuw nsw i64 %.sink.i, %i.ck
  %i.cm = getelementptr inbounds nuw [4 x i8], ptr %i.cb, i64 %.012.i.i.i11
  %i.cn = load i32, ptr %i.cm, align 4, !tbaa !5
  %i.co = zext i32 %i.cn to i64
  %i.cp = mul nsw i64 %94, %i.co
  ...
  %.0.highbits.i.i.i = lshr i64 %i.ct, %179
  %i.cu = icmp eq i64 %.0.highbits.i.i.i, 0
  br i1 %i.cu, label %bb.b, label %compareFingerprints.exit.i13, !llvm.loop !25

compareFingerprints.exit.i13:                     ; preds = %bb.b
  %i.cv = add nsw i32 %.02435.i, 14
  %i.cw = sext i32 %i.cv to i64
  %i.cx = mul i64 %94, %i.cw
  %i.cy = mul i64 %i.cx, %.sink.i
...
begin_hunk_3_@ZSTD_splitBlock:bb.a
  ...
  br i1 %i.dm, label %mergeEvents.exit.i, label %vector.body, !llvm.loop !26

mergeEvents.exit.i:                               ; preds = %vector.body
  %i.dn = add i64 %.sink.i, %94                   ; 2 uses
  store i64 %i.dn, ptr %i.cd, align 8, !tbaa !18
  %i.do = icmp sgt i32 %.02435.i, 0
  %i.dp = sext i1 %i.do to i32
  %spec.select.i = add nsw i32 %.02435.i, %i.dp
  %i.dq = add i64 %.036.i, 8192                   ; 2 uses
  %.not.i = icmp ugt i64 %i.dq, %92
