...
bb.a:
  %i.a = icmp eq i32 %2, 0
  br i1 %i.a, label %vector.ph32, label %bb.b
...
bb.b:                                             ; preds = %bb.a
  ...
  %.not28.i = icmp ult i64 %8, 8192
  br i1 %.not28.i, label %ZSTD_splitBlock_fromBorders.exit, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %bb.b
  %i.ca = getelementptr inbounds nuw i8, ptr %3, i64 4104 ; 4 uses
  %i.cb = getelementptr inbounds [4 x i8], ptr @ZSTD_splitBlock_byChunks.hashParams, i64 %5
  %i.cc = getelementptr inbounds nuw i8, ptr %3, i64 4096 ; 2 uses
  %i.cd = getelementptr inbounds nuw i8, ptr %3, i64 8200
  br label %bb.c

bb.c:                                             ; preds = %mergeEvents.exit.i, %.lr.ph.i
  %.030.i = phi i64 [ 8192, %.lr.ph.i ], [ %i.dp, %mergeEvents.exit.i ] ; 3 uses
  %.02429.i = phi i32 [ 3, %.lr.ph.i ], [ %spec.select.i, %mergeEvents.exit.i ] ; 3 uses
  %i.ce = getelementptr inbounds nuw i8, ptr %0, i64 %.030.i
  tail call void %7(ptr noundef nonnull %i.ca, ptr noundef %i.ce, i64 noundef 8192) #7, !inline_history !23
  %i.cf = load i32, ptr %i.cb, align 4, !tbaa !5
  %9 = load i64, ptr %i.cc, align 8, !tbaa !18    ; 3 uses
  %10 = load i64, ptr %i.cd, align 8, !tbaa !18   ; 3 uses
  %i.cg = zext nneg i32 %i.cf to i64
  br label %bb.d

bb.d:                                             ; preds = %bb.d, %bb.c
  %.012.i.i.i11 = phi i64 [ 0, %bb.c ], [ %i.cs, %bb.d ] ; 3 uses
  %.01011.i.i.i12 = phi i64 [ 0, %bb.c ], [ %i.cr, %bb.d ]
  %i.ch = getelementptr inbounds nuw [4 x i8], ptr %3, i64 %.012.i.i.i11
  %i.ci = load i32, ptr %i.ch, align 4, !tbaa !5
  %i.cj = zext i32 %i.ci to i64
  %i.ck = mul nsw i64 %10, %i.cj
  %i.cl = getelementptr inbounds nuw [4 x i8], ptr %i.ca, i64 %.012.i.i.i11
  %i.cm = load i32, ptr %i.cl, align 4, !tbaa !5
  %i.cn = zext i32 %i.cm to i64
  %i.co = mul nsw i64 %9, %i.cn
  ...
  %.0.highbits.i.i.i = lshr i64 %i.cs, %i.cg
  %i.ct = icmp eq i64 %.0.highbits.i.i.i, 0
  br i1 %i.ct, label %bb.d, label %compareFingerprints.exit.i13, !llvm.loop !24

compareFingerprints.exit.i13:                     ; preds = %bb.d
  %i.cu = add nsw i32 %.02429.i, 14
  %i.cv = sext i32 %i.cu to i64
  %i.cw = mul i64 %9, %i.cv
  %i.cx = mul i64 %i.cw, %10
...
begin_hunk_3_@ZSTD_splitBlock:bb.a
  ...
  br i1 %i.dl, label %mergeEvents.exit.i, label %vector.body, !llvm.loop !25

mergeEvents.exit.i:                               ; preds = %vector.body
  %i.dm = add i64 %10, %9
  store i64 %i.dm, ptr %i.cc, align 8, !tbaa !18
  %i.dn = icmp sgt i32 %.02429.i, 0
  %i.do = sext i1 %i.dn to i32
  %spec.select.i = add nsw i32 %.02429.i, %i.do
  %i.dp = add i64 %.030.i, 8192                   ; 2 uses
  %.not.i = icmp ugt i64 %i.dp, %8
  br i1 %.not.i, label %ZSTD_splitBlock_fromBorders.exit, label %bb.c, !llvm.loop !26

ZSTD_splitBlock_fromBorders.exit:                 ; preds = %mergeEvents.exit.i, %compareFingerprints.exit.i13, %bb.b, %fpDistance.exit28.i, %compareFingerprints.exit.i
  %.0 = phi i64 [ %1, %compareFingerprints.exit.i ], [ %.0.i, %fpDistance.exit28.i ], [ %1, %bb.b ], [ %.030.i, %compareFingerprints.exit.i13 ], [ %1, %mergeEvents.exit.i ]
  ret i64 %.0
}
