Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/node/original/bit_reader?download=true
...
BrotliPullByte.exit:                              ; preds = %bb.b
  %i.i = load i8, ptr %i.e, align 1, !tbaa !18
  %i.j = zext i8 %i.i to i64
  store i64 %i.j, ptr %0, align 8, !tbaa !15
  store i64 8, ptr %i.a, align 8, !tbaa !14
  %i.k = getelementptr inbounds nuw i8, ptr %i.e, i64 1
  store ptr %i.k, ptr %i.d, align 8, !tbaa !16
...
bb.a:
  ...
  %i.c = load i64, ptr %i.b, align 8, !tbaa !14   ; 7 uses
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 5 uses
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !16   ; 9 uses
...
BrotliPullByte.exit.i8:                           ; preds = %.lr.ph
  %i.m = load i8, ptr %i.e, align 1, !tbaa !18
  %i.n = zext i8 %i.m to i64
  %i.o = shl nuw nsw i64 %i.n, %i.c
  %i.p = or i64 %i.o, %i.a                        ; 3 uses
  store i64 %i.p, ptr %0, align 8, !tbaa !15
  %i.q = add nuw nsw i64 %i.c, 8                  ; 3 uses
  store i64 %i.q, ptr %i.b, align 8, !tbaa !14
  %i.r = getelementptr inbounds nuw i8, ptr %i.e, i64 1 ; 4 uses
  store ptr %i.r, ptr %i.d, align 8, !tbaa !16
...
BrotliPullByte.exit.i8.1:                         ; preds = %.lr.ph.1
  ...
  store i64 %i.x, ptr %0, align 8, !tbaa !15
  %i.y = or disjoint i64 %i.c, 16                 ; 2 uses
  store i64 %i.y, ptr %i.b, align 8, !tbaa !14
  %i.z = getelementptr inbounds nuw i8, ptr %i.e, i64 2 ; 2 uses
  store ptr %i.z, ptr %i.d, align 8, !tbaa !16
  br label %._crit_edge
...
._crit_edge:                                      ; preds = %BrotliPullByte.exit.i8, %BrotliPullByte.exit.i8.1, %bb.a
  ...
  store i64 %i.ad, ptr %0, align 8, !tbaa !15
...
.lr.ph33:                                         ; preds = %BrotliPullByte.exit.i
  ...
  br i1 %i.ah, label %BrotliSafeReadBits.exit11.thread, label %BrotliPullByte.exit.i, !llvm.loop !19
...
BrotliPullByte.exit.i:                            ; preds = %.lr.ph33.preheader, %.lr.ph33
  ...
  %i.al = load i8, ptr %i.aj, align 1, !tbaa !18
  %i.am = zext i8 %i.al to i64
  %i.an = shl i64 %i.am, %i.ai
  %i.ao = or i64 %i.an, %i.ak                     ; 3 uses
  store i64 %i.ao, ptr %0, align 8, !tbaa !15
  %i.ap = add i64 %i.ai, 8                        ; 4 uses
  store i64 %i.ap, ptr %i.b, align 8, !tbaa !14
  %i.aq = getelementptr inbounds nuw i8, ptr %i.aj, i64 1 ; 3 uses
  store ptr %i.aq, ptr %i.d, align 8, !tbaa !16
  %i.ar = icmp ult i64 %i.ap, %i.ae
  br i1 %i.ar, label %.lr.ph33, label %._crit_edge34, !llvm.loop !19
...
._crit_edge34:                                    ; preds = %BrotliPullByte.exit.i, %._crit_edge
  ...
  store i64 %5, ptr %i.b, align 8, !tbaa !14
  %6 = lshr i64 %3, %i.ae
...
bb.c:                                             ; preds = %BrotliSafeReadBits.exit11.thread
  ...
  store ptr %i.e, ptr %i.ax, align 8, !tbaa !22
  br label %BrotliBitReaderSetInput.exit
...
!13 = !{!"", !10, i64 0, !10, i64 8, !12, i64 16, !12, i64 24, !12, i64 32}
!14 = !{!13, !10, i64 8}
!15 = !{!13, !10, i64 0}
!16 = !{!13, !12, i64 16}
!17 = !{!13, !12, i64 32}
