...
.lr.ph.i:                                         ; preds = %bb.e, %bb.l
  %.02639.i = phi ptr [ %i.ae, %bb.l ], [ %i.q, %bb.e ] ; 2 uses
  %.02738.i = phi ptr [ %.1.i, %bb.l ], [ null, %bb.e ] ; 6 uses
  %i.r = call ptr @ares_llist_node_val(ptr noundef nonnull %.02639.i) #3 ; 3 uses
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 8
  %i.t = load i64, ptr %i.s, align 8, !tbaa !15   ; 4 uses
  %i.u = icmp ugt i64 %i.t, %i.n
  br i1 %i.u, label %bb.l, label %bb.f

bb.f:                                             ; preds = %.lr.ph.i
  %.not33.i = icmp eq ptr %.02738.i, null
...
bb.af:                                            ; preds = %bb.y
  %i.by = and i8 %.fr80.i.i, -33
  %i.bz = add i8 %i.by, -65
  %i.ca = icmp ult i8 %i.bz, 26
  %or.cond72.i.i = or i1 %.not60.i.i, %i.ca
...
ares_parse_dns_name_escape.exit.i:                ; preds = %bb.ag, %bb.ag, %bb.ag, %bb.ag, %bb.ag, %bb.af, %switch.early.test.i.i, %switch.early.test.i.i, %switch.early.test.i.i, %switch.early.test.i.i, %switch.early.test.i.i, %bb.ae
  ...
  %i.cb = call i32 @ares_buf_append_byte(ptr noundef nonnull %.073.ph108.i, i8 noundef zeroext %.pre-phi.sink.i.i) #3 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #3
  %.not91.i = icmp eq i32 %i.cb, 0
...
.backedge.i:                                      ; preds = %bb.ai, %ares_parse_dns_name_escape.exit.i
  %i.cc = call i32 @ares_buf_fetch_bytes(ptr noundef nonnull %i.al, ptr noundef nonnull %i.d, i64 noundef 1) #3
  %i.cd = icmp eq i32 %i.cc, 0
  br i1 %i.cd, label %bb.t, label %.outer._crit_edge.i, !llvm.loop !28
...
bb.ah:                                            ; preds = %bb.t
  ...
  %i.ch = add i8 %i.ax, -48
  %or.cond10.i = icmp ult i8 %i.ch, 10
  %i.ci = or i1 %or.cond10.i, %i.cg
  %or.cond93.i = or i1 %.not60.i.i, %i.ci
...
bb.ai:                                            ; preds = %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %bb.ah
  %i.cj = call i32 @ares_buf_append_byte(ptr noundef nonnull %.073.ph108.i, i8 noundef zeroext %i.ax) #3 ; 2 uses
...
.outer._crit_edge.i:                              ; preds = %ares_dns_labels_add.exit96.i, %.backedge.i, %ares_dns_labels_add.exit.i
  %i.ck = call ptr @ares_array_last(ptr noundef nonnull %i.j) #3 ; 2 uses
  %i.cl = icmp eq ptr %i.ck, null
  br i1 %i.cl, label %ares_dns_labels_get_last.exit.i, label %bb.aj

bb.aj:                                            ; preds = %.outer._crit_edge.i
  %i.cm = load ptr, ptr %i.ck, align 8, !tbaa !26
  br label %ares_dns_labels_get_last.exit.i

ares_dns_labels_get_last.exit.i:                  ; preds = %bb.aj, %.outer._crit_edge.i
  %.0.i98.i = phi ptr [ %i.cm, %bb.aj ], [ null, %.outer._crit_edge.i ]
  %i.cn = call i64 @ares_buf_len(ptr noundef %.0.i98.i) #3
  %i.co = icmp eq i64 %i.cn, 0
  br i1 %i.co, label %bb.ak, label %bb.al

bb.ak:                                            ; preds = %ares_dns_labels_get_last.exit.i
  %i.cp = call i32 @ares_array_remove_last(ptr noundef nonnull %i.j) #3 ; 0 uses
  br label %bb.al

bb.al:                                            ; preds = %bb.ak, %ares_dns_labels_get_last.exit.i
  %i.cq = call i64 @ares_array_len(ptr noundef nonnull %i.j) #3
  %i.cr = icmp eq i64 %i.cq, 1
  br i1 %i.cr, label %bb.am, label %bb.ap

bb.am:                                            ; preds = %bb.al
  %i.cs = call ptr @ares_array_last(ptr noundef nonnull %i.j) #3 ; 2 uses
  %i.ct = icmp eq ptr %i.cs, null
  br i1 %i.ct, label %ares_dns_labels_get_last.exit100.i, label %bb.an

bb.an:                                            ; preds = %bb.am
  %i.cu = load ptr, ptr %i.cs, align 8, !tbaa !26
  br label %ares_dns_labels_get_last.exit100.i

ares_dns_labels_get_last.exit100.i:               ; preds = %bb.an, %bb.am
  %.0.i99.i = phi ptr [ %i.cu, %bb.an ], [ null, %bb.am ]
  %i.cv = call i64 @ares_buf_len(ptr noundef %.0.i99.i) #3
  %i.cw = icmp eq i64 %i.cv, 0
  br i1 %i.cw, label %bb.ao, label %bb.ap

bb.ao:                                            ; preds = %ares_dns_labels_get_last.exit100.i
  %i.cx = call i32 @ares_array_remove_last(ptr noundef nonnull %i.j) #3 ; 0 uses
  br label %bb.ap

bb.ap:                                            ; preds = %bb.ao, %ares_dns_labels_get_last.exit100.i, %bb.al
  %i.cy = call i64 @ares_array_len(ptr noundef nonnull %i.j) #3
  %.not114.i = icmp eq i64 %i.cy, 0
  br i1 %.not114.i, label %._crit_edge113.i, label %.lr.ph112.i

.lr.ph112.i:                                      ; preds = %bb.ap, %bb.ar
  %.070110.i = phi i64 [ %i.de, %bb.ar ], [ 0, %bb.ap ]
  %.072109.i = phi i64 [ %i.df, %bb.ar ], [ 0, %bb.ap ] ; 2 uses
  %i.cz = call ptr @ares_array_at(ptr noundef nonnull %i.j, i64 noundef %.072109.i) #3 ; 2 uses
  %i.da = icmp eq ptr %i.cz, null
  br i1 %i.da, label %ares_dns_labels_get_at.exit.i, label %bb.aq

bb.aq:                                            ; preds = %.lr.ph112.i
  %i.db = load ptr, ptr %i.cz, align 8, !tbaa !26
  br label %ares_dns_labels_get_at.exit.i

ares_dns_labels_get_at.exit.i:                    ; preds = %bb.aq, %.lr.ph112.i
  %.0.i101.i = phi ptr [ %i.db, %bb.aq ], [ null, %.lr.ph112.i ]
  %i.dc = call i64 @ares_buf_len(ptr noundef %.0.i101.i) #3 ; 2 uses
  %i.dd = add i64 %i.dc, -64
  %or.cond27.i = icmp ult i64 %i.dd, -63
  br i1 %or.cond27.i, label %ares_split_dns_name.exit.thread, label %bb.ar

bb.ar:                                            ; preds = %ares_dns_labels_get_at.exit.i
  %i.de = add i64 %i.dc, %.070110.i               ; 2 uses
  %i.df = add nuw i64 %.072109.i, 1               ; 2 uses
  %i.dg = call i64 @ares_array_len(ptr noundef nonnull %i.j) #3
  %i.dh = icmp ult i64 %i.df, %i.dg
  br i1 %i.dh, label %.lr.ph112.i, label %._crit_edge113.loopexit.i, !llvm.loop !29

._crit_edge113.loopexit.i:                        ; preds = %bb.ar
  %i.di = add i64 %i.de, -257
  br label %._crit_edge113.i

._crit_edge113.i:                                 ; preds = %._crit_edge113.loopexit.i, %bb.ap
  %.070.lcssa.i = phi i64 [ -257, %bb.ap ], [ %i.di, %._crit_edge113.loopexit.i ]
  %i.dj = call i64 @ares_array_len(ptr noundef nonnull %i.j) #3
  %.not88.i = icmp eq i64 %i.dj, 0
  br i1 %.not88.i, label %ares_split_dns_name.exit, label %bb.as

bb.as:                                            ; preds = %._crit_edge113.i
  %i.dk = call i64 @ares_array_len(ptr noundef nonnull %i.j) #3
  %i.dl = add i64 %i.dk, %.070.lcssa.i
  %i.dm = icmp ult i64 %i.dl, -256
  br i1 %i.dm, label %ares_split_dns_name.exit.thread, label %ares_split_dns_name.exit
...
ares_split_dns_name.exit.thread:                  ; preds = %switch.early.test.i, %bb.ai, %ares_parse_dns_name_escape.exit.i, %ares_dns_labels_get_at.exit.i, %bb.p, %.thread, %ares_dns_labels_add.exit.thread.i, %bb.as, %ares_dns_labels_add.exit96.thread.i, %ares_parse_dns_name_escape.exit.thread.i
  %.4.i.ph = phi i32 [ 15, %ares_dns_labels_add.exit.thread.i ], [ 15, %.thread ], [ 8, %ares_dns_labels_get_at.exit.i ], [ 8, %ares_parse_dns_name_escape.exit.thread.i ], [ 15, %ares_dns_labels_add.exit96.thread.i ], [ 8, %bb.as ], [ %i.ap, %bb.p ], [ 8, %switch.early.test.i ], [ %i.cj, %bb.ai ], [ %i.cb, %ares_parse_dns_name_escape.exit.i ]
...
ares_split_dns_name.exit:                         ; preds = %._crit_edge113.i, %bb.as
  ...
  %.not138 = icmp eq i64 %i.dn, 0
  br i1 %.not138, label %._crit_edge, label %.lr.ph

bb.at:                                            ; preds = %bb.av
  %i.do = add nuw i64 %.059137, 1                 ; 2 uses
  %i.dp = call i64 @ares_array_len(ptr noundef nonnull %i.j) #3
  %i.dq = icmp ult i64 %i.do, %i.dp
  br i1 %i.dq, label %.lr.ph, label %._crit_edge, !llvm.loop !30

.lr.ph:                                           ; preds = %ares_split_dns_name.exit, %bb.at
  %.059137 = phi i64 [ %i.do, %bb.at ], [ 0, %ares_split_dns_name.exit ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f) #3
  store i64 0, ptr %i.f, align 8, !tbaa !31
  %i.dr = call ptr @ares_array_at(ptr noundef nonnull %i.j, i64 noundef %.059137) #3 ; 2 uses
  %i.ds = icmp eq ptr %i.dr, null
  br i1 %i.ds, label %ares_dns_labels_get_at.exit, label %bb.au

bb.au:                                            ; preds = %.lr.ph
  %i.dt = load ptr, ptr %i.dr, align 8, !tbaa !26
  br label %ares_dns_labels_get_at.exit

ares_dns_labels_get_at.exit:                      ; preds = %.lr.ph, %bb.au
  %.0.i99 = phi ptr [ %i.dt, %bb.au ], [ null, %.lr.ph ]
  %i.du = call ptr @ares_buf_peek(ptr noundef %.0.i99, ptr noundef nonnull %i.f) #3
  %i.dv = load i64, ptr %i.f, align 8, !tbaa !31
  %i.dw = trunc i64 %i.dv to i8
  %i.dx = call i32 @ares_buf_append_byte(ptr noundef %0, i8 noundef zeroext %i.dw) #3 ; 2 uses
  %.not87 = icmp eq i32 %i.dx, 0
...
bb.av:                                            ; preds = %ares_dns_labels_get_at.exit
