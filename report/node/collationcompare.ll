begin_hunk_0
  ...
  br i1 %i.cw, label %.preheader360, label %.outer
...
bb.t:                                             ; preds = %bb.t, %.outer
  %indvars.iv = phi i64 [ %indvars.iv.next, %bb.t ], [ %4, %.outer ] ; 3 uses
  ...
  br i1 %i.dr, label %bb.t, label %.preheader365.a, !llvm.loop !15

.preheader365.a:                                  ; preds = %bb.t, %.preheader365.a
  %indvars.iv509 = phi i64 [ %indvars.iv.next510, %.preheader365.a ], [ %5, %bb.t ] ; 3 uses
...
bb.u:                                             ; preds = %.preheader363, %._crit_edge443
  ...
  %.5 = phi i32 [ %.6, %._crit_edge443 ], [ %.4.ph, %.preheader363 ]
  %i.ea = icmp sgt i32 %.0241, %.0247.ph
...
begin_hunk_3
  ...
  %i.ee = icmp sgt i32 %.0239, %.0245.ph
...
.outer:                                           ; preds = %bb.p, %bb.w
  %.0247.ph = phi i32 [ %i.ey, %bb.w ], [ 0, %bb.p ] ; 2 uses
  %.0245.ph = phi i32 [ %i.ez, %bb.w ], [ 0, %bb.p ] ; 2 uses
  %.4.ph = phi i32 [ %.6, %bb.w ], [ undef, %bb.p ]
  %4 = sext i32 %.0247.ph to i64                  ; 2 uses
  %5 = sext i32 %.0245.ph to i64                  ; 2 uses
  br label %bb.t
...
.loopexit:                                        ; preds = %._crit_edge443, %bb.s, %bb.bb, %.thread342, %.thread334, %bb.ad, %bb.ac, %.thread303, %bb.n, %.thread329, %bb.av, %bb.au, %bb.a
  %.17 = phi i32 [ 0, %bb.a ], [ %i.cp, %.thread303 ], [ %.3, %bb.s ], [ 0, %bb.n ], [ 0, %.thread329 ], [ 0, %bb.av ], [ 0, %bb.bb ], [ %i.hm, %.thread334 ], [ 0, %bb.au ], [ %i.iq, %.thread342 ], [ %i.gg, %bb.ac ], [ %i.gh, %bb.ad ], [ %.6, %._crit_edge443 ]
  ret i32 %.17
}
