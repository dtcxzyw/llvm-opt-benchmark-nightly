...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = and <4 x i1> %i.cam, %i.can
  %5 = xor <4 x i1> %i.cam, %i.cal
  %i.caq = xor <4 x i1> %i.cao, splat (i1 true)
  %6 = select <4 x i1> %i.cal, <4 x i1> %i.caq, <4 x i1> zeroinitializer
  %predphi = select <4 x i1> %4, <4 x float> splat (float f0xFF7FFFFF), <4 x float> splat (float -inf)
  %predphi961 = select <4 x i1> %5, <4 x float> %predphi, <4 x float> %i.caj
  %predphi962 = select <4 x i1> %i.cap, <4 x float> splat (float +inf), <4 x float> %predphi961
  %predphi963 = select <4 x i1> %6, <4 x float> splat (float f0x7F7FFFFF), <4 x float> %predphi962
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = and <4 x i1> %i.ae, %i.af
  %5 = xor <4 x i1> %i.ae, %i.ad
  %i.ai = xor <4 x i1> %i.ag, splat (i1 true)
  %6 = select <4 x i1> %i.ad, <4 x i1> %i.ai, <4 x i1> zeroinitializer
  %predphi = select <4 x i1> %4, <4 x float> splat (float f0xFF7FFFFF), <4 x float> splat (float -inf)
  %predphi19 = select <4 x i1> %5, <4 x float> %predphi, <4 x float> %i.ab
  %predphi20 = select <4 x i1> %i.ah, <4 x float> splat (float +inf), <4 x float> %predphi19
  %predphi21 = select <4 x i1> %6, <4 x float> splat (float f0x7F7FFFFF), <4 x float> %predphi20
