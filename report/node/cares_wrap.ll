...
begin_hunk_1_@_ZN4node10cares_wrap12_GLOBAL__N_113ParseSoaReplyEPNS_11EnvironmentEPhiPN2v85LocalINS5_6ObjectEEE:bb.a
  ...
  %6 = load <4 x ptr>, ptr %5, align 16
  %7 = load <2 x ptr>, ptr %i.au, align 16
  %i.gq = insertelement <8 x ptr> poison, ptr %i.gk, i64 6
  %i.gr = insertelement <8 x ptr> %i.gq, ptr %i.go, i64 7
  %8 = shufflevector <4 x ptr> %6, <4 x ptr> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %9 = shufflevector <8 x ptr> %8, <8 x ptr> %i.gr, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 14, i32 15>
  %10 = shufflevector <2 x ptr> %7, <2 x ptr> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %11 = shufflevector <8 x ptr> %9, <8 x ptr> %10, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 6, i32 7>
  %.fr = freeze <8 x ptr> %11
