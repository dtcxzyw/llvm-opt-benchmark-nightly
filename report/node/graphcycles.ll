...
.lr.ph173:                                        ; preds = %.lr.ph173.lr.ph, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit
  ...
  %i.ag = phi i64 [ 0, %.lr.ph173.lr.ph ], [ %i.bm, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit ]
...
.lr.ph181:                                        ; preds = %.lr.ph181.lr.ph, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit46
  %i.bn = phi ptr [ %i.aj, %.lr.ph181.lr.ph ], [ %i.dn, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit46 ]
  ...
  %i.bo = phi i64 [ 0, %.lr.ph181.lr.ph ], [ %i.dm, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit46 ]
  br label %bb.h

bb.g:                                             ; preds = %bb.h
  %exitcond118.not = icmp eq i64 %indvars.iv.next114, %wide.trip.count117186
  %i.bp = load ptr, ptr %i.ah, align 8            ; 2 uses
...
bb.h:                                             ; preds = %.lr.ph181, %bb.g
  %i.bq = phi ptr [ %i.bn, %.lr.ph181 ], [ %i.bp, %bb.g ]
  %indvars.iv113180 = phi i64 [ %i.bo, %.lr.ph181 ], [ %indvars.iv.next114, %bb.g ] ; 2 uses
  %i.br = getelementptr inbounds nuw [4 x i8], ptr %i.bq, i64 %indvars.iv113180
  %i.bs = load i32, ptr %i.br, align 4            ; 2 uses
  %indvars.iv.next114 = add nuw nsw i64 %indvars.iv113180, 1 ; 4 uses
  %i.bt = icmp sgt i32 %i.bs, -1
  br i1 %i.bt, label %bb.k, label %bb.g
...
_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet4NextEPiS3_.exit23: ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit46, %bb.g, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet4NextEPiS3_.exit.preheader
  %.lcssa152 = phi ptr [ %i.bp, %bb.g ], [ %i.aj, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet4NextEPiS3_.exit.preheader ], [ %i.dn, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit46 ] ; 2 uses
  %i.bu = getelementptr inbounds nuw i8, ptr %i.ac, i64 32 ; 2 uses
  %.not.i.i.i.i = icmp eq ptr %.lcssa152, %i.bu
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE6resizeEj.exit.i.i: ; preds = %bb.i, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet4NextEPiS3_.exit23
  ...
  %i.bv = getelementptr inbounds nuw i8, ptr %i.ac, i64 68
  store i32 8, ptr %i.bv, align 4
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE6resizeEj.exit.i.i
  ...
  %i.bx = getelementptr inbounds nuw [4 x i8], ptr %i.bw, i64 %indvars.iv.i.i.i
  store i32 -1, ptr %i.bx, align 4
  %indvars.iv.next.i.i.i = add nuw nsw i64 %indvars.iv.i.i.i, 1 ; 2 uses
  %.val.i.i.i = load i32, ptr %i.ai, align 8
  %i.by = zext i32 %.val.i.i.i to i64
  %i.bz = icmp samesign ult i64 %indvars.iv.next.i.i.i, %i.by
  br i1 %i.bz, label %.lr.ph.i.i.i, label %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5clearEv.exit, !llvm.loop !11

_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5clearEv.exit: ; preds = %.lr.ph.i.i.i
  %i.ca = getelementptr inbounds nuw i8, ptr %i.ac, i64 72
  store i32 0, ptr %i.ca, align 8
  %i.cb = load ptr, ptr %i.ad, align 8            ; 2 uses
  %i.cc = getelementptr inbounds nuw i8, ptr %i.ac, i64 88 ; 2 uses
  %.not.i.i.i.i24 = icmp eq ptr %i.cb, %i.cc
...
bb.j:                                             ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5clearEv.exit
  tail call void @_ZN4absl13base_internal13LowLevelAlloc4FreeEPv(ptr noundef %i.cb) #12
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE6resizeEj.exit.i.i25: ; preds = %bb.j, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5clearEv.exit
  store ptr %i.cc, ptr %i.ad, align 8
  %i.cd = getelementptr inbounds nuw i8, ptr %i.ac, i64 124
  store i32 8, ptr %i.cd, align 4
...
.lr.ph.i.i.i26:                                   ; preds = %.lr.ph.i.i.i26, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE6resizeEj.exit.i.i25
  ...
  %i.cf = getelementptr inbounds nuw [4 x i8], ptr %i.ce, i64 %indvars.iv.i.i.i27
  ...
  %i.cg = zext i32 %.val.i.i.i29 to i64
  %i.ch = icmp samesign ult i64 %indvars.iv.next.i.i.i28, %i.cg
  br i1 %i.ch, label %.lr.ph.i.i.i26, label %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5clearEv.exit30, !llvm.loop !11

_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5clearEv.exit30: ; preds = %.lr.ph.i.i.i26
  %i.ci = getelementptr inbounds nuw i8, ptr %i.ac, i64 128
  store i32 0, ptr %i.ci, align 8
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ac, i64 16
  store i64 -1136490970041655429, ptr %i.cj, align 8
  %i.ck = getelementptr inbounds nuw i8, ptr %i.ac, i64 4 ; 2 uses
  %i.cl = load i32, ptr %i.ck, align 4            ; 2 uses
  %i.cm = icmp eq i32 %i.cl, -1
  br i1 %i.cm, label %_ZN4absl24synchronization_internal12_GLOBAL__N_110PointerMap6RemoveEPv.exit.thread, label %bb.m

bb.k:                                             ; preds = %bb.h
  %i.cn = trunc nuw i64 %indvars.iv.next114 to i32
  %i.co = load ptr, ptr %0, align 8
  %.val = load ptr, ptr %i.co, align 8
  %i.cp = zext nneg i32 %i.bs to i64
  %i.cq = getelementptr inbounds nuw [8 x i8], ptr %.val, i64 %i.cp
  %i.cr = load ptr, ptr %i.cq, align 8            ; 2 uses
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cr, i64 80
  %.val11 = load ptr, ptr %i.cs, align 8          ; 4 uses
  %i.ct = getelementptr i8, ptr %i.cr, i64 120
  %.val12 = load i32, ptr %i.ct, align 8
  %i.cu = add i32 %.val12, -1                     ; 2 uses
  %.02410.i.i31 = and i32 %i.cu, %i.af            ; 2 uses
  %i.cv = zext i32 %.02410.i.i31 to i64           ; 2 uses
  %i.cw = getelementptr inbounds nuw [4 x i8], ptr %.val11, i64 %i.cv
  %i.cx = load i32, ptr %i.cw, align 4            ; 2 uses
  %i.cy = icmp eq i32 %.lcssa90, %i.cx
  br i1 %i.cy, label %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i40, label %.lr.ph.i.i32

.lr.ph.i.i32:                                     ; preds = %bb.k, %bb.l
  %i.cz = phi i32 [ %i.dg, %bb.l ], [ %i.cx, %bb.k ] ; 2 uses
  ...
  br i1 %i.da, label %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i42, label %bb.l

bb.l:                                             ; preds = %.lr.ph.i.i32
  %i.db = icmp ne i32 %i.cz, -2
  %i.dc = trunc nuw i8 %.01912.i.i34 to i1
  %or.cond.i.i36 = select i1 %i.db, i1 true, i1 %i.dc ; 2 uses
  ...
  %i.dd = add i32 %.02413.i.i33, 1
  %.024.i.i39 = and i32 %i.dd, %i.cu              ; 2 uses
  %i.de = zext i32 %.024.i.i39 to i64             ; 2 uses
  %i.df = getelementptr inbounds nuw [4 x i8], ptr %.val11, i64 %i.de
  %i.dg = load i32, ptr %i.df, align 4            ; 2 uses
  %i.dh = icmp eq i32 %.lcssa90, %i.dg
  br i1 %i.dh, label %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i40, label %.lr.ph.i.i32, !llvm.loop !16

_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i42: ; preds = %.lr.ph.i.i32
  %i.di = trunc nuw i8 %.01912.i.i34 to i1
  %i.dj = select i1 %i.di, i32 %.02111.i.i35, i32 %.02413.i.i33
  %.pre.i43 = zext i32 %i.dj to i64               ; 2 uses
  ...
  %i.dk = icmp eq i32 %.pre7.i45, %.lcssa90
  br i1 %i.dk, label %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i40, label %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit46
...
_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i40: ; preds = %bb.l, %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i42, %bb.k
  %.pre-phi12.i41 = phi i64 [ %.pre.i43, %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i42 ], [ %i.cv, %bb.k ], [ %i.de, %bb.l ]
  %i.dl = getelementptr inbounds nuw [4 x i8], ptr %.val11, i64 %.pre-phi12.i41
...
_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit46: ; preds = %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i42, %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i40
  ...
  %i.dm = and i64 %indvars.iv.next114, 4294967295 ; 2 uses
  %umax116 = tail call i32 @llvm.umax.i32(i32 %i.cn, i32 %.val.i20)
  %wide.trip.count117 = zext i32 %umax116 to i64  ; 2 uses
  %exitcond118.not179 = icmp eq i64 %i.dm, %wide.trip.count117
  %i.dn = load ptr, ptr %i.ah, align 8            ; 2 uses
...
bb.m:                                             ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5clearEv.exit30
  %i.do = add nuw i32 %i.cl, 1
  store i32 %i.do, ptr %i.ck, align 4
  %i.dp = load ptr, ptr %0, align 8               ; 4 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %i.dp, i64 80 ; 4 uses
  %i.dr = getelementptr inbounds nuw i8, ptr %i.dp, i64 120 ; 5 uses
  %i.ds = load i32, ptr %i.dr, align 8            ; 5 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %i.dp, i64 124 ; 2 uses
  %i.du = load i32, ptr %i.dt, align 4
  %i.dv = icmp eq i32 %i.ds, %i.du
  br i1 %i.dv, label %bb.n, label %._crit_edge.i

._crit_edge.i:                                    ; preds = %bb.m
  %.pre.i47 = load ptr, ptr %i.dq, align 8
  br label %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE9push_backERKi.exit

bb.n:                                             ; preds = %bb.m
  %.not.i48 = icmp eq i32 %i.ds, -1
  br i1 %.not.i48, label %bb.o, label %.lr.ph.i.i49

.lr.ph.i.i49:                                     ; preds = %bb.n, %.lr.ph.i.i49
  %i.dw = phi i32 [ %i.dx, %.lr.ph.i.i49 ], [ %i.ds, %bb.n ]
  %i.dx = shl i32 %i.dw, 1                        ; 4 uses
  %.not5.i = icmp ugt i32 %i.dx, %i.ds
  br i1 %.not5.i, label %._crit_edge.i.i, label %.lr.ph.i.i49, !llvm.loop !17

._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i49
  store i32 %i.dx, ptr %i.dt, align 4
  %i.dy = zext i32 %i.dx to i64
  %i.dz = shl nuw nsw i64 %i.dy, 2
  br label %bb.o

bb.o:                                             ; preds = %._crit_edge.i.i, %bb.n
  %.lcssa.i.i = phi i64 [ %i.dz, %._crit_edge.i.i ], [ 17179869180, %bb.n ]
  %i.ea = load ptr, ptr @_ZN4absl24synchronization_internal12_GLOBAL__N_15arenaE, align 8
  %i.eb = tail call noundef ptr @_ZN4absl13base_internal13LowLevelAlloc14AllocWithArenaEmPNS1_5ArenaE(i64 noundef %.lcssa.i.i, ptr noundef %i.ea) #12 ; 4 uses
  %i.ec = load ptr, ptr %i.dq, align 8            ; 2 uses
  %i.ed = load i32, ptr %i.dr, align 8            ; 2 uses
  switch i32 %i.ed, label %bb.p [
...
bb.p:                                             ; preds = %bb.o
  ...
  %.idx.i.i.i.i = shl nuw nsw i64 %i.ee, 2
  tail call void @llvm.memmove.p0.p0.i64(ptr align 4 %i.eb, ptr align 4 %i.ec, i64 %.idx.i.i.i.i, i1 false)
  br label %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i

bb.q:                                             ; preds = %bb.o
  %i.ef = load i32, ptr %i.ec, align 4
  store i32 %i.ef, ptr %i.eb, align 4
  br label %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i

_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i:          ; preds = %bb.q, %bb.p, %bb.o
  %i.eg = load ptr, ptr %i.dq, align 8            ; 2 uses
  %i.eh = getelementptr inbounds nuw i8, ptr %i.dp, i64 88
  %.not.i4.i.i = icmp eq ptr %i.eg, %i.eh
...
bb.r:                                             ; preds = %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i
  tail call void @_ZN4absl13base_internal13LowLevelAlloc4FreeEPv(ptr noundef %i.eg) #12
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i: ; preds = %bb.r, %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i
  store ptr %i.eb, ptr %i.dq, align 8
  %.pre1.i = load i32, ptr %i.dr, align 8
  br label %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE9push_backERKi.exit
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE9push_backERKi.exit: ; preds = %._crit_edge.i, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i
  %i.ei = phi i32 [ %i.ds, %._crit_edge.i ], [ %.pre1.i, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i ]
  %i.ej = phi ptr [ %.pre.i47, %._crit_edge.i ], [ %i.eb, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i ]
  %i.ek = zext i32 %i.ei to i64
  %i.el = getelementptr inbounds nuw [4 x i8], ptr %i.ej, i64 %i.ek
  store i32 %.lcssa90, ptr %i.el, align 4
  %i.em = load i32, ptr %i.dr, align 8
  %i.en = add i32 %i.em, 1
  store i32 %i.en, ptr %i.dr, align 8
...
.lr.ph212:                                        ; preds = %.lr.ph212.lr.ph, %bb.y
  ...
  %i.bv = phi i64 [ 0, %.lr.ph212.lr.ph ], [ %i.dc, %bb.y ]
...
bb.p:                                             ; preds = %.lr.ph212, %bb.o
  ...
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i211, 1 ; 4 uses
  %i.by = icmp sgt i32 %i.bx, -1
...
bb.y:                                             ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE9push_backERKi.exit61.i, %bb.r
  ...
  %exitcond.not.i210 = icmp eq i64 %i.dc, %wide.trip.count.i
...
_ZN4absl24synchronization_internalL10ForwardDFSEPNS0_11GraphCycles3RepEii.exit: ; preds = %bb.q
  ...
  %.val52 = load i32, ptr %i.dd, align 8
  ...
  br i1 %i.dj, label %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i, label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %_ZN4absl24synchronization_internalL10ForwardDFSEPNS0_11GraphCycles3RepEii.exit, %bb.z
  %i.dk = phi i32 [ %i.dr, %bb.z ], [ %i.di, %_ZN4absl24synchronization_internalL10ForwardDFSEPNS0_11GraphCycles3RepEii.exit ] ; 2 uses
  ...
  br i1 %i.dl, label %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i, label %bb.z
...
bb.z:                                             ; preds = %.lr.ph.i.i
  ...
  br i1 %i.ds, label %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i, label %.lr.ph.i.i, !llvm.loop !16
...
_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i: ; preds = %.lr.ph.i.i
  ...
  br i1 %i.dv, label %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i, label %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit
...
_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i: ; preds = %bb.z, %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i, %_ZN4absl24synchronization_internalL10ForwardDFSEPNS0_11GraphCycles3RepEii.exit
  %.pre-phi12.i = phi i64 [ %.pre.i, %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i ], [ %i.dg, %_ZN4absl24synchronization_internalL10ForwardDFSEPNS0_11GraphCycles3RepEii.exit ], [ %i.dp, %bb.z ]
  %i.dw = getelementptr inbounds nuw [4 x i8], ptr %.val51, i64 %.pre-phi12.i
  store i32 -2, ptr %i.dw, align 4
  br label %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit

_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit: ; preds = %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i, %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i
  %.val49 = load ptr, ptr %i.aa, align 8          ; 4 uses
  %i.dx = getelementptr i8, ptr %i.o, i64 64
  %.val50 = load i32, ptr %i.dx, align 8
  ...
  br i1 %i.ed, label %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i64, label %.lr.ph.i.i56

.lr.ph.i.i56:                                     ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit, %bb.aa
  %i.ee = phi i32 [ %i.el, %bb.aa ], [ %i.ec, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit ] ; 2 uses
  ...
  br i1 %i.ef, label %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i66, label %bb.aa
...
bb.aa:                                            ; preds = %.lr.ph.i.i56
  ...
  br i1 %i.em, label %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i64, label %.lr.ph.i.i56, !llvm.loop !16
...
_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i66: ; preds = %.lr.ph.i.i56
  ...
  br i1 %i.ep, label %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i64, label %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit70
...
_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.thread.i64: ; preds = %bb.aa, %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i66, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit
  %.pre-phi12.i65 = phi i64 [ %.pre.i67, %_ZNK4absl24synchronization_internal12_GLOBAL__N_17NodeSet9FindIndexEi.exit.i66 ], [ %i.ea, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet5eraseEi.exit ], [ %i.ej, %bb.aa ]
  %i.eq = getelementptr inbounds nuw [4 x i8], ptr %.val49, i64 %.pre-phi12.i65
  store i32 -2, ptr %i.eq, align 4
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader, %.lr.ph.prol
  %.041120.prol = phi ptr [ %i.fb, %.lr.ph.prol ], [ %.val46, %.lr.ph.preheader ] ; 2 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph.prol ], [ 0, %.lr.ph.preheader ]
  %i.ew = load i32, ptr %.041120.prol, align 4
  %.val.prol = load ptr, ptr %i.a, align 8
  %i.ex = zext i32 %i.ew to i64
  %i.ey = getelementptr inbounds nuw [8 x i8], ptr %.val.prol, i64 %i.ex
  %i.ez = load ptr, ptr %i.ey, align 8
  %i.fa = getelementptr inbounds nuw i8, ptr %i.ez, i64 12
  store i8 0, ptr %i.fa, align 4
  %i.fb = getelementptr inbounds nuw i8, ptr %.041120.prol, i64 4 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !23

.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader
  %.041120.unr = phi ptr [ %.val46, %.lr.ph.preheader ], [ %i.fb, %.lr.ph.prol ]
  %i.fc = icmp ult i64 %i.et, 12
  br i1 %i.fc, label %_ZN4absl24synchronization_internalL7ReorderEPNS0_11GraphCycles3RepE.exit, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  %.041120 = phi ptr [ %i.ga, %.lr.ph ], [ %.041120.unr, %.lr.ph.prol.loopexit ] ; 5 uses
  %i.fd = load i32, ptr %.041120, align 4
  %.val = load ptr, ptr %i.a, align 8
  %i.fe = zext i32 %i.fd to i64
  %i.ff = getelementptr inbounds nuw [8 x i8], ptr %.val, i64 %i.fe
  %i.fg = load ptr, ptr %i.ff, align 8
  %i.fh = getelementptr inbounds nuw i8, ptr %i.fg, i64 12
  store i8 0, ptr %i.fh, align 4
  %i.fi = getelementptr inbounds nuw i8, ptr %.041120, i64 4
  %i.fj = load i32, ptr %i.fi, align 4
  %.val.1 = load ptr, ptr %i.a, align 8
  %i.fk = zext i32 %i.fj to i64
  %i.fl = getelementptr inbounds nuw [8 x i8], ptr %.val.1, i64 %i.fk
  %i.fm = load ptr, ptr %i.fl, align 8
  %i.fn = getelementptr inbounds nuw i8, ptr %i.fm, i64 12
  store i8 0, ptr %i.fn, align 4
  %i.fo = getelementptr inbounds nuw i8, ptr %.041120, i64 8
  %i.fp = load i32, ptr %i.fo, align 4
  %.val.2 = load ptr, ptr %i.a, align 8
  %i.fq = zext i32 %i.fp to i64
  %i.fr = getelementptr inbounds nuw [8 x i8], ptr %.val.2, i64 %i.fq
  %i.fs = load ptr, ptr %i.fr, align 8
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fs, i64 12
  store i8 0, ptr %i.ft, align 4
  %i.fu = getelementptr inbounds nuw i8, ptr %.041120, i64 12
  %i.fv = load i32, ptr %i.fu, align 4
  %.val.3 = load ptr, ptr %i.a, align 8
  %i.fw = zext i32 %i.fv to i64
  %i.fx = getelementptr inbounds nuw [8 x i8], ptr %.val.3, i64 %i.fw
  %i.fy = load ptr, ptr %i.fx, align 8
  %i.fz = getelementptr inbounds nuw i8, ptr %i.fy, i64 12
  store i8 0, ptr %i.fz, align 4
  %i.ga = getelementptr inbounds nuw i8, ptr %.041120, i64 16 ; 2 uses
  %.not45.3 = icmp eq ptr %i.ga, %i.es
...
bb.ab:                                            ; preds = %thread-pre-split.i
  %i.gb = load i32, ptr %i.o, align 8
  %i.gc = getelementptr inbounds nuw i8, ptr %i.a, i64 1048744 ; 9 uses
  %i.gd = load ptr, ptr %i.gc, align 8            ; 2 uses
  %i.ge = getelementptr inbounds nuw i8, ptr %i.a, i64 1048752 ; 3 uses
  %.not.i.i.i71 = icmp eq ptr %i.gd, %i.ge
  br i1 %.not.i.i.i71, label %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE5clearEv.exit.i72, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  tail call void @_ZN4absl13base_internal13LowLevelAlloc4FreeEPv(ptr noundef %i.gd) #12
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE5clearEv.exit.i72: ; preds = %bb.ac, %bb.ab
  store ptr %i.ge, ptr %i.gc, align 8
  %i.gf = getelementptr inbounds nuw i8, ptr %i.a, i64 1048784 ; 10 uses
  store i32 0, ptr %i.gf, align 8
  %i.gg = getelementptr inbounds nuw i8, ptr %i.a, i64 1048788 ; 3 uses
  store i32 8, ptr %i.gg, align 4
  %i.gh = load ptr, ptr %i.aj, align 8            ; 2 uses
  %.not.i.i22.i = icmp eq ptr %i.gh, %i.al
...
bb.ad:                                            ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE5clearEv.exit.i72
  tail call void @_ZN4absl13base_internal13LowLevelAlloc4FreeEPv(ptr noundef %i.gh) #12
...
bb.ae:                                            ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet4NextEPiS3_.exit.i, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE9push_backERKi.exit.i73
  ...
  %i.gi = add i32 %.val1664.i, -1                 ; 3 uses
  %i.gj = zext i32 %i.gi to i64
  %i.gk = getelementptr inbounds nuw [4 x i8], ptr %.val17.i, i64 %i.gj
  %i.gl = load i32, ptr %i.gk, align 4            ; 2 uses
  store i32 %i.gi, ptr %i.am, align 8
  %.val15.i = load ptr, ptr %i.a, align 8
  %i.gm = zext i32 %i.gl to i64
  %i.gn = getelementptr inbounds nuw [8 x i8], ptr %.val15.i, i64 %i.gm
  %i.go = load ptr, ptr %i.gn, align 8            ; 3 uses
  %i.gp = getelementptr inbounds nuw i8, ptr %i.go, i64 12 ; 2 uses
  %i.gq = load i8, ptr %i.gp, align 4, !range !12, !noundef !13
  %i.gr = trunc nuw i8 %i.gq to i1
  br i1 %i.gr, label %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet4NextEPiS3_.exit.i, label %bb.af, !llvm.loop !24

bb.af:                                            ; preds = %bb.ae
  store i8 1, ptr %i.gp, align 4
  %i.gs = load i32, ptr %i.gf, align 8            ; 5 uses
  %i.gt = load i32, ptr %i.gg, align 4
  %i.gu = icmp eq i32 %i.gs, %i.gt
  br i1 %i.gu, label %bb.ag, label %._crit_edge.i24.i

._crit_edge.i24.i:                                ; preds = %bb.af
  %.pre.i25.i = load ptr, ptr %i.gc, align 8
  br label %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE9push_backERKi.exit35.i

bb.ag:                                            ; preds = %bb.af
  %.not.i26.i = icmp eq i32 %i.gs, -1
  br i1 %.not.i26.i, label %bb.ah, label %.lr.ph.i.i27.i

.lr.ph.i.i27.i:                                   ; preds = %bb.ag, %.lr.ph.i.i27.i
  %i.gv = phi i32 [ %i.gw, %.lr.ph.i.i27.i ], [ %i.gs, %bb.ag ]
  %i.gw = shl i32 %i.gv, 1                        ; 4 uses
  %.not5.i28.i = icmp ugt i32 %i.gw, %i.gs
  br i1 %.not5.i28.i, label %._crit_edge.i.i28.i, label %.lr.ph.i.i27.i, !llvm.loop !17

._crit_edge.i.i28.i:                              ; preds = %.lr.ph.i.i27.i
  store i32 %i.gw, ptr %i.gg, align 4
  %i.gx = zext i32 %i.gw to i64
  %i.gy = shl nuw nsw i64 %i.gx, 2
  br label %bb.ah

bb.ah:                                            ; preds = %._crit_edge.i.i28.i, %bb.ag
  %.lcssa.i.i29.i = phi i64 [ %i.gy, %._crit_edge.i.i28.i ], [ 17179869180, %bb.ag ]
  %i.gz = load ptr, ptr @_ZN4absl24synchronization_internal12_GLOBAL__N_15arenaE, align 8
  %i.ha = tail call noundef ptr @_ZN4absl13base_internal13LowLevelAlloc14AllocWithArenaEmPNS1_5ArenaE(i64 noundef %.lcssa.i.i29.i, ptr noundef %i.gz) #12 ; 4 uses
  %i.hb = load ptr, ptr %i.gc, align 8            ; 2 uses
  %i.hc = load i32, ptr %i.gf, align 8            ; 2 uses
  switch i32 %i.hc, label %bb.ai [
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %.idx.i.i.i.i34.i = shl nuw nsw i64 %i.hd, 2
  tail call void @llvm.memmove.p0.p0.i64(ptr align 4 %i.ha, ptr align 4 %i.hb, i64 %.idx.i.i.i.i34.i, i1 false)
  br label %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i30.i

bb.aj:                                            ; preds = %bb.ah
  %i.he = load i32, ptr %i.hb, align 4
  store i32 %i.he, ptr %i.ha, align 4
  br label %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i30.i

_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i30.i:      ; preds = %bb.aj, %bb.ai, %bb.ah
  %i.hf = load ptr, ptr %i.gc, align 8            ; 2 uses
  %.not.i4.i.i31.i = icmp eq ptr %i.hf, %i.ge
...
bb.ak:                                            ; preds = %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i30.i
  tail call void @_ZN4absl13base_internal13LowLevelAlloc4FreeEPv(ptr noundef %i.hf) #12
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i32.i: ; preds = %bb.ak, %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i30.i
  store ptr %i.ha, ptr %i.gc, align 8
  %.pre1.i33.i = load i32, ptr %i.gf, align 8
  br label %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE9push_backERKi.exit35.i
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE9push_backERKi.exit35.i: ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i32.i, %._crit_edge.i24.i
  %i.hg = phi i32 [ %i.gs, %._crit_edge.i24.i ], [ %.pre1.i33.i, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i32.i ]
  %i.hh = phi ptr [ %.pre.i25.i, %._crit_edge.i24.i ], [ %i.ha, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i32.i ]
  %i.hi = zext i32 %i.hg to i64
  %i.hj = getelementptr inbounds nuw [4 x i8], ptr %i.hh, i64 %i.hi
  store i32 %i.gl, ptr %i.hj, align 4
  %i.hk = load i32, ptr %i.gf, align 8
  %i.hl = add i32 %i.hk, 1
  store i32 %i.hl, ptr %i.gf, align 8
  %i.hm = getelementptr inbounds nuw i8, ptr %i.go, i64 24
  %i.hn = getelementptr inbounds nuw i8, ptr %i.go, i64 64 ; 2 uses
  %.val.i.i75222 = load i32, ptr %i.hn, align 8   ; 2 uses
...
.lr.ph220:                                        ; preds = %.lr.ph220.lr.ph, %bb.av
  ...
  %i.ho = phi i64 [ 0, %.lr.ph220.lr.ph ], [ %i.iv, %bb.av ]
  %.val10.i.i80 = load ptr, ptr %i.hm, align 8
  br label %bb.am
...
bb.am:                                            ; preds = %.lr.ph220, %bb.al
  %indvars.iv.i78219 = phi i64 [ %i.ho, %.lr.ph220 ], [ %indvars.iv.next.i81, %bb.al ] ; 2 uses
  %i.hp = getelementptr inbounds nuw [4 x i8], ptr %.val10.i.i80, i64 %indvars.iv.i78219
  %i.hq = load i32, ptr %i.hp, align 4            ; 3 uses
  %indvars.iv.next.i81 = add nuw nsw i64 %indvars.iv.i78219, 1 ; 4 uses
  %i.hr = icmp sgt i32 %i.hq, -1
  br i1 %i.hr, label %bb.an, label %bb.al

bb.an:                                            ; preds = %bb.am
  %i.hs = trunc nuw i64 %indvars.iv.next.i81 to i32
  %.val.i82 = load ptr, ptr %i.a, align 8
  %i.ht = zext nneg i32 %i.hq to i64
  %i.hu = getelementptr inbounds nuw [8 x i8], ptr %.val.i82, i64 %i.ht
  %i.hv = load ptr, ptr %i.hu, align 8            ; 2 uses
  %i.hw = getelementptr inbounds nuw i8, ptr %i.hv, i64 12
  %i.hx = load i8, ptr %i.hw, align 4, !range !12, !noundef !13
  %i.hy = trunc nuw i8 %i.hx to i1
  br i1 %i.hy, label %bb.av, label %bb.ao

bb.ao:                                            ; preds = %bb.an
  %i.hz = load i32, ptr %i.hv, align 8
  %i.ia = icmp slt i32 %i.gb, %i.hz
  br i1 %i.ia, label %bb.ap, label %bb.av

bb.ap:                                            ; preds = %bb.ao
  %i.ib = load i32, ptr %i.am, align 8            ; 5 uses
  %i.ic = load i32, ptr %i.an, align 4
  %i.id = icmp eq i32 %i.ib, %i.ic
  br i1 %i.id, label %bb.aq, label %._crit_edge.i37.i83
...
bb.aq:                                            ; preds = %bb.ap
  %.not.i39.i86 = icmp eq i32 %i.ib, -1
  br i1 %.not.i39.i86, label %bb.ar, label %.lr.ph.i.i40.i87

.lr.ph.i.i40.i87:                                 ; preds = %bb.aq, %.lr.ph.i.i40.i87
  %i.ie = phi i32 [ %i.if, %.lr.ph.i.i40.i87 ], [ %i.ib, %bb.aq ]
  %i.if = shl i32 %i.ie, 1                        ; 4 uses
  %.not5.i42.i = icmp ugt i32 %i.if, %i.ib
  br i1 %.not5.i42.i, label %._crit_edge.i.i41.i88, label %.lr.ph.i.i40.i87, !llvm.loop !17

._crit_edge.i.i41.i88:                            ; preds = %.lr.ph.i.i40.i87
  store i32 %i.if, ptr %i.an, align 4
  %i.ig = zext i32 %i.if to i64
  %i.ih = shl nuw nsw i64 %i.ig, 2
  br label %bb.ar

bb.ar:                                            ; preds = %._crit_edge.i.i41.i88, %bb.aq
  %.lcssa.i.i42.i89 = phi i64 [ %i.ih, %._crit_edge.i.i41.i88 ], [ 17179869180, %bb.aq ]
  %i.ii = load ptr, ptr @_ZN4absl24synchronization_internal12_GLOBAL__N_15arenaE, align 8
  %i.ij = tail call noundef ptr @_ZN4absl13base_internal13LowLevelAlloc14AllocWithArenaEmPNS1_5ArenaE(i64 noundef %.lcssa.i.i42.i89, ptr noundef %i.ii) #12 ; 4 uses
  %i.ik = load ptr, ptr %i.aj, align 8            ; 2 uses
  %i.il = load i32, ptr %i.am, align 8            ; 2 uses
  switch i32 %i.il, label %bb.as [
...
bb.as:                                            ; preds = %bb.ar
  ...
  %.idx.i.i.i.i47.i94 = shl nuw nsw i64 %i.im, 2
  tail call void @llvm.memmove.p0.p0.i64(ptr align 4 %i.ij, ptr align 4 %i.ik, i64 %.idx.i.i.i.i47.i94, i1 false)
  br label %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i43.i90

bb.at:                                            ; preds = %bb.ar
  %i.in = load i32, ptr %i.ik, align 4
  store i32 %i.in, ptr %i.ij, align 4
  br label %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i43.i90

_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i43.i90:    ; preds = %bb.at, %bb.as, %bb.ar
  %i.io = load ptr, ptr %i.aj, align 8            ; 2 uses
  %.not.i4.i.i44.i91 = icmp eq ptr %i.io, %i.al
...
bb.au:                                            ; preds = %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i43.i90
  tail call void @_ZN4absl13base_internal13LowLevelAlloc4FreeEPv(ptr noundef %i.io) #12
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i45.i92: ; preds = %bb.au, %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i43.i90
  store ptr %i.ij, ptr %i.aj, align 8
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE9push_backERKi.exit48.i85: ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i45.i92, %._crit_edge.i37.i83
  %i.ip = phi i32 [ %i.ib, %._crit_edge.i37.i83 ], [ %.pre1.i46.i93, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i45.i92 ]
  %i.iq = phi ptr [ %.pre.i38.i84, %._crit_edge.i37.i83 ], [ %i.ij, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i45.i92 ]
  %i.ir = zext i32 %i.ip to i64
  %i.is = getelementptr inbounds nuw [4 x i8], ptr %i.iq, i64 %i.ir
  store i32 %i.hq, ptr %i.is, align 4
  %i.it = load i32, ptr %i.am, align 8
  %i.iu = add i32 %i.it, 1
  store i32 %i.iu, ptr %i.am, align 8
  br label %bb.av

bb.av:                                            ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE9push_backERKi.exit48.i85, %bb.ao, %bb.an
  %.val.i.i75 = load i32, ptr %i.hn, align 8
  %i.iv = and i64 %indvars.iv.next.i81, 4294967295 ; 2 uses
  %umax.i76 = tail call i32 @llvm.umax.i32(i32 %i.hs, i32 %.val.i.i75)
  %wide.trip.count.i77 = zext i32 %umax.i76 to i64 ; 2 uses
  %exitcond.not.i79218 = icmp eq i64 %i.iv, %wide.trip.count.i77
...
_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet4NextEPiS3_.exit.i: ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet4NextEPiS3_.exit.loopexit.i, %bb.ae
  %.val16.pr.i = phi i32 [ %.val16.pr.pre.i, %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet4NextEPiS3_.exit.loopexit.i ], [ %i.gi, %bb.ae ] ; 2 uses
  %i.iw = icmp eq i32 %.val16.pr.i, 0
  br i1 %i.iw, label %_ZN4absl24synchronization_internalL11BackwardDFSEPNS0_11GraphCycles3RepEii.exit, label %bb.ae
...
_ZN4absl24synchronization_internalL11BackwardDFSEPNS0_11GraphCycles3RepEii.exit: ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet4NextEPiS3_.exit.i
  %.val40.i = load ptr, ptr %i.gc, align 8
  %.val41.i = load i32, ptr %i.gf, align 8
  ...
  %i.ix = getelementptr inbounds nuw i8, ptr %i.a, i64 1048792 ; 5 uses
  %i.iy = load ptr, ptr %i.ix, align 8            ; 2 uses
  %i.iz = getelementptr inbounds nuw i8, ptr %i.a, i64 1048800 ; 2 uses
  %.not.i.i.i95 = icmp eq ptr %i.iy, %i.iz
...
bb.aw:                                            ; preds = %_ZN4absl24synchronization_internalL11BackwardDFSEPNS0_11GraphCycles3RepEii.exit
  tail call void @_ZN4absl13base_internal13LowLevelAlloc4FreeEPv(ptr noundef %i.iy) #12
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE5clearEv.exit.i96: ; preds = %bb.aw, %_ZN4absl24synchronization_internalL11BackwardDFSEPNS0_11GraphCycles3RepEii.exit
  store ptr %i.iz, ptr %i.ix, align 8
  %i.ja = getelementptr inbounds nuw i8, ptr %i.a, i64 1048832 ; 3 uses
  store i32 0, ptr %i.ja, align 8
  %i.jb = getelementptr inbounds nuw i8, ptr %i.a, i64 1048836
  store i32 8, ptr %i.jb, align 4
  %.val44.i = load ptr, ptr %i.gc, align 8
  %.val45.i = load i32, ptr %i.gf, align 8
  tail call fastcc void @_ZN4absl24synchronization_internalL10MoveToListEPNS0_11GraphCycles3RepEPNS0_12_GLOBAL__N_13VecIiEES7_(ptr noundef nonnull %i.a, ptr %.val44.i, i32 %.val45.i, ptr noundef nonnull %i.ix)
  %.val42.i = load ptr, ptr %i.ae, align 8
  %.val43.i = load i32, ptr %i.ah, align 8
  tail call fastcc void @_ZN4absl24synchronization_internalL10MoveToListEPNS0_11GraphCycles3RepEPNS0_12_GLOBAL__N_13VecIiEES7_(ptr noundef nonnull %i.a, ptr %.val42.i, i32 %.val43.i, ptr noundef nonnull %i.ix)
  %i.jc = getelementptr inbounds nuw i8, ptr %i.a, i64 1048840 ; 5 uses
  %.val28.i97 = load i32, ptr %i.gf, align 8      ; 2 uses
  %.val27.i = load i32, ptr %i.ah, align 8        ; 2 uses
  %i.jd = add i32 %.val27.i, %.val28.i97          ; 3 uses
  %i.je = getelementptr inbounds nuw i8, ptr %i.a, i64 1048884 ; 2 uses
  %i.jf = load i32, ptr %i.je, align 4            ; 2 uses
  %i.jg = icmp ugt i32 %i.jd, %i.jf
  br i1 %i.jg, label %.lr.ph.i.i.i, label %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE5clearEv.exit._ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE6resizeEj.exit_crit_edge.i
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE5clearEv.exit._ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE6resizeEj.exit_crit_edge.i: ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE5clearEv.exit.i96
  %.val31.pre.i = load ptr, ptr %i.jc, align 8
...
.lr.ph.i.i.i:                                     ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE5clearEv.exit.i96, %.lr.ph.i.i.i
  %i.jh = phi i32 [ %i.ji, %.lr.ph.i.i.i ], [ %i.jf, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE5clearEv.exit.i96 ]
  %i.ji = shl i32 %i.jh, 1                        ; 4 uses
  %i.jj = icmp ult i32 %i.ji, %i.jd
  br i1 %i.jj, label %.lr.ph.i.i.i, label %bb.ax, !llvm.loop !17

bb.ax:                                            ; preds = %.lr.ph.i.i.i
  store i32 %i.ji, ptr %i.je, align 4
  %i.jk = zext i32 %i.ji to i64
  %i.jl = shl nuw nsw i64 %i.jk, 2
  %i.jm = load ptr, ptr @_ZN4absl24synchronization_internal12_GLOBAL__N_15arenaE, align 8
  %i.jn = tail call noundef ptr @_ZN4absl13base_internal13LowLevelAlloc14AllocWithArenaEmPNS1_5ArenaE(i64 noundef %i.jl, ptr noundef %i.jm) #12 ; 4 uses
  %i.jo = load ptr, ptr %i.jc, align 8            ; 2 uses
  %i.jp = getelementptr inbounds nuw i8, ptr %i.a, i64 1048880
  %i.jq = load i32, ptr %i.jp, align 8            ; 2 uses
  switch i32 %i.jq, label %bb.ay [
...
bb.ay:                                            ; preds = %bb.ax
  ...
  %.idx.i.i.i.i.i = shl nuw nsw i64 %i.jr, 2
  tail call void @llvm.memmove.p0.p0.i64(ptr align 4 %i.jn, ptr align 4 %i.jo, i64 %.idx.i.i.i.i.i, i1 false)
  br label %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i.i

bb.az:                                            ; preds = %bb.ax
  %i.js = load i32, ptr %i.jo, align 4
  store i32 %i.js, ptr %i.jn, align 4
  br label %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i.i

_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i.i:        ; preds = %bb.az, %bb.ay, %bb.ax
  %i.jt = load ptr, ptr %i.jc, align 8            ; 2 uses
  %i.ju = getelementptr inbounds nuw i8, ptr %i.a, i64 1048848
  %.not.i4.i.i.i = icmp eq ptr %i.jt, %i.ju
...
bb.ba:                                            ; preds = %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i.i
  tail call void @_ZN4absl13base_internal13LowLevelAlloc4FreeEPv(ptr noundef %i.jt) #12
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i.i: ; preds = %bb.ba, %_ZSt6copy_nIPijS0_ET1_T_T0_S1_.exit.i.i.i
  store ptr %i.jn, ptr %i.jc, align 8
  %.val37.pre.i = load i32, ptr %i.gf, align 8
...
_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE6resizeEj.exit.i: ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i.i, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE5clearEv.exit._ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE6resizeEj.exit_crit_edge.i
  %.val31.i = phi ptr [ %.val31.pre.i, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE5clearEv.exit._ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE6resizeEj.exit_crit_edge.i ], [ %i.jn, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE4GrowEj.exit.i.i ] ; 2 uses
  ...
  %i.jv = getelementptr inbounds nuw i8, ptr %i.a, i64 1048880
  store i32 %i.jd, ptr %i.jv, align 8
  %.val33.i = load ptr, ptr %i.gc, align 8        ; 3 uses
  %i.jw = zext i32 %.val37.i to i64
  %.idx.i = shl nuw nsw i64 %i.jw, 2
  %i.jx = getelementptr inbounds nuw i8, ptr %.val33.i, i64 %.idx.i ; 2 uses
  %.val32.i = load ptr, ptr %i.ae, align 8        ; 3 uses
  %i.jy = zext i32 %.val35.i to i64
  %.idx47.i = shl nuw nsw i64 %i.jy, 2
  %i.jz = getelementptr inbounds nuw i8, ptr %.val32.i, i64 %.idx47.i ; 2 uses
  %i.ka = icmp ne i32 %.val37.i, 0
  %i.kb = icmp ne i32 %.val35.i, 0
  %i.kc = and i1 %i.kb, %i.ka
  br i1 %i.kc, label %.lr.ph.i.i46.i, label %._crit_edge.i.i.i

.lr.ph.i.i46.i:                                   ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE6resizeEj.exit.i, %.lr.ph.i.i46.i
  %.024.i.i.i = phi ptr [ %i.kg, %.lr.ph.i.i46.i ], [ %.val31.i, %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE6resizeEj.exit.i ] ; 2 uses
  ...
  %i.kd = load i32, ptr %.01922.i.i.i, align 4    ; 2 uses
  %i.ke = load i32, ptr %.01823.i.i.i, align 4    ; 2 uses
  %i.kf = icmp slt i32 %i.kd, %i.ke               ; 2 uses
  %.sink.i.i.i = tail call i32 @llvm.smin.i32(i32 %i.kd, i32 %i.ke)
  %.120.idx.i.i.i = select i1 %i.kf, i64 4, i64 0
  %.120.i.i.i = getelementptr inbounds nuw i8, ptr %.01922.i.i.i, i64 %.120.idx.i.i.i ; 3 uses
  %.1.idx.i.i.i = select i1 %i.kf, i64 0, i64 4
  %.1.i.i.i = getelementptr inbounds nuw i8, ptr %.01823.i.i.i, i64 %.1.idx.i.i.i ; 3 uses
  store i32 %.sink.i.i.i, ptr %.024.i.i.i, align 4
  %i.kg = getelementptr inbounds nuw i8, ptr %.024.i.i.i, i64 4 ; 2 uses
  %i.kh = icmp ne ptr %.1.i.i.i, %i.jx
  %i.ki = icmp ne ptr %.120.i.i.i, %i.jz
  %i.kj = select i1 %i.kh, i1 %i.ki, i1 false
  br i1 %i.kj, label %.lr.ph.i.i46.i, label %._crit_edge.i.i.i, !llvm.loop !26
...
begin_hunk_3_@_ZN4absl24synchronization_internal11GraphCycles10InsertEdgeENS0_7GraphIdES2_:bb.a
  br i1 %i.kn, label %bb.bb, label %bb.bc, !prof !27

bb.bb:                                            ; preds = %._crit_edge.i.i.i
  tail call void @llvm.memmove.p0.p0.i64(ptr align 4 %.0.lcssa.i.i.i, ptr align 4 %.018.lcssa.i.i.i, i64 %i.km, i1 false)
  br label %_ZSt4copyIPiS0_ET0_T_S2_S1_.exit.i.i.i

bb.bc:                                            ; preds = %._crit_edge.i.i.i
  %i.ko = icmp eq i64 %i.km, 4
  br i1 %i.ko, label %bb.bd, label %_ZSt4copyIPiS0_ET0_T_S2_S1_.exit.i.i.i

bb.bd:                                            ; preds = %bb.bc
  %i.kp = load i32, ptr %.018.lcssa.i.i.i, align 4
  store i32 %i.kp, ptr %.0.lcssa.i.i.i, align 4
  br label %_ZSt4copyIPiS0_ET0_T_S2_S1_.exit.i.i.i

_ZSt4copyIPiS0_ET0_T_S2_S1_.exit.i.i.i:           ; preds = %bb.bd, %bb.bc, %bb.bb
  %i.kq = getelementptr inbounds i8, ptr %.0.lcssa.i.i.i, i64 %i.km ; 2 uses
  %i.kr = ptrtoint ptr %i.jz to i64
  %i.ks = ptrtoint ptr %.019.lcssa.i.i.i to i64
  %i.kt = sub i64 %i.kr, %i.ks                    ; 3 uses
  %i.ku = icmp sgt i64 %i.kt, 4
  br i1 %i.ku, label %bb.be, label %bb.bf, !prof !27

bb.be:                                            ; preds = %_ZSt4copyIPiS0_ET0_T_S2_S1_.exit.i.i.i
  tail call void @llvm.memmove.p0.p0.i64(ptr align 4 %i.kq, ptr align 4 %.019.lcssa.i.i.i, i64 %i.kt, i1 false)
...
bb.bf:                                            ; preds = %_ZSt4copyIPiS0_ET0_T_S2_S1_.exit.i.i.i
  ...
  br i1 %i.kv, label %bb.bg, label %_ZSt5mergeIPiS0_S0_ET1_T_S2_T0_S3_S1_.exit.i

bb.bg:                                            ; preds = %bb.bf
  %i.kw = load i32, ptr %.019.lcssa.i.i.i, align 4
  store i32 %i.kw, ptr %i.kq, align 4
  br label %_ZSt5mergeIPiS0_S0_ET1_T_S2_T0_S3_S1_.exit.i

_ZSt5mergeIPiS0_S0_ET1_T_S2_T0_S3_S1_.exit.i:     ; preds = %bb.bg, %bb.bf, %bb.be
  %.val2649.i = load i32, ptr %i.ja, align 8
...
.lr.ph.i:                                         ; preds = %_ZSt5mergeIPiS0_S0_ET1_T_S2_T0_S3_S1_.exit.i, %.lr.ph.i
  ...
  %.val30.i100 = load ptr, ptr %i.jc, align 8
  %i.kx = getelementptr inbounds nuw [4 x i8], ptr %.val30.i100, i64 %indvars.iv.i99
  %i.ky = load i32, ptr %i.kx, align 4
  %.val29.i = load ptr, ptr %i.ix, align 8
  %i.kz = getelementptr inbounds nuw [4 x i8], ptr %.val29.i, i64 %indvars.iv.i99
  %i.la = load i32, ptr %i.kz, align 4
  %.val.i101 = load ptr, ptr %i.a, align 8
  %i.lb = zext i32 %i.la to i64
  %i.lc = getelementptr inbounds nuw [8 x i8], ptr %.val.i101, i64 %i.lb
  %i.ld = load ptr, ptr %i.lc, align 8
  store i32 %i.ky, ptr %i.ld, align 8
  %indvars.iv.next.i102 = add nuw nsw i64 %indvars.iv.i99, 1 ; 2 uses
  %.val26.i = load i32, ptr %i.ja, align 8
  %i.le = zext i32 %.val26.i to i64
  %i.lf = icmp samesign ult i64 %indvars.iv.next.i102, %i.le
  br i1 %i.lf, label %.lr.ph.i, label %_ZN4absl24synchronization_internalL7ReorderEPNS0_11GraphCycles3RepE.exit, !llvm.loop !28
...
.lr.ph:                                           ; preds = %.lr.ph.lr.ph, %bb.x
  ...
  %i.cd = phi i64 [ 0, %.lr.ph.lr.ph ], [ %i.dh, %bb.x ]
...
bb.p:                                             ; preds = %.lr.ph, %bb.o
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv119, 1 ; 4 uses
...
bb.x:                                             ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE9push_backERKi.exit70, %bb.q
  ...
  %i.dh = and i64 %indvars.iv.next, 4294967295    ; 2 uses
  %umax = call i32 @llvm.umax.i32(i32 %i.ci, i32 %.val.i)
  %wide.trip.count = zext i32 %umax to i64        ; 2 uses
  %exitcond.not118 = icmp eq i64 %i.dh, %wide.trip.count
...
_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet4NextEPiS3_.exit: ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_13VecIiE9push_backERKi.exit57, %thread-pre-split
  ...
  %i.di = load ptr, ptr %5, align 8               ; 2 uses
...
bb.y:                                             ; preds = %_ZN4absl24synchronization_internal12_GLOBAL__N_17NodeSet4NextEPiS3_.exit
  call void @_ZN4absl13base_internal13LowLevelAlloc4FreeEPv(ptr noundef %i.di) #12
