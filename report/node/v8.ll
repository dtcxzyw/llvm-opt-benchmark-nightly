...
bb.b:                                             ; preds = %bb.a
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str, ptr noundef nonnull @.str.7) #9
  unreachable

bb.c:                                             ; preds = %bb.a
  %i.b = add nsw i32 %i.a, 1
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.8, i32 noundef %i.a, i32 noundef %i.b, i32 noundef 1) #9
  unreachable
...
bb.e:                                             ; preds = %bb.d
  ...
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.9, i32 noundef %i.e, i32 noundef %i.f) #9
  unreachable
...
bb.h:                                             ; preds = %bb.g
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str, ptr noundef nonnull @.str.2) #9
  unreachable
...
begin_hunk_4_@_ZN2v88internal2V818InitializePlatformEPNS_8PlatformE:bb.a
  ...
  %i.k = tail call noundef ptr %i.j(ptr noundef nonnull align 8 dereferenceable(8) %0) #10
  tail call void @_ZN2v84base18SetPrintStackTraceEPFvvE(ptr noundef %i.k) #10
  tail call void @_ZN2v87tracing23TracingCategoryObserver5SetUpEv() #10
  tail call void @_ZN2v88internal7CppHeap24InitializeOncePerProcessEv() #10
...
bb.l:                                             ; preds = %bb.k
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.8, i32 noundef %i.l, i32 noundef %i.m, i32 noundef 2) #9
  unreachable
...
bb.n:                                             ; preds = %bb.m
  ...
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.9, i32 noundef %i.p, i32 noundef %i.q) #9
  unreachable
...
bb.b:                                             ; preds = %bb.a
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.3) #9
  unreachable
...
bb.d:                                             ; preds = %bb.c
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.8, i32 noundef %i.a, i32 noundef %i.b, i32 noundef 3) #9
  unreachable
...
bb.g:                                             ; preds = %_ZN2v88internal12_GLOBAL__N_119AdvanceStartupStateENS1_14V8StartupStateE.exit
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str, ptr noundef nonnull @.str.4) #9
  unreachable

bb.h:                                             ; preds = %_ZN2v88internal12_GLOBAL__N_119AdvanceStartupStateENS1_14V8StartupStateE.exit
  tail call void @_ZN2v88internal8FlagList23EnforceFlagImplicationsEv() #10
  %i.h = tail call noundef i32 @_ZN2v88internal8FlagList4HashEv() #10 ; 0 uses
...
bb.i:                                             ; preds = %bb.h
  tail call void @_ZN2v88internal8FlagList11FreezeFlagsEv() #10
  br label %bb.j
...
bb.k:                                             ; preds = %bb.j
  ...
  call void @_ZN2v88internal7Isolate19GetTurboCfgFileNameB5cxx11EPS1_(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %1, ptr noundef null) #10
...
begin_hunk_13_@_ZN2v88internal2V810InitializeEv:bb.a
  ...
  %i.t = call noundef ptr @_ZNSt13basic_filebufIcSt11char_traitsIcEE5closeEv(ptr noundef nonnull align 8 dereferenceable(240) %i.s) #10 ; 0 uses
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 112
  call void @_ZNSt12__basic_fileIcED1Ev(ptr noundef nonnull align 8 dead_on_return(9) dereferenceable(9) %i.u) #10
  ...
  call void @_ZNSt6localeD1Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %i.v) #10
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 248
  call void @_ZNSt8ios_baseD2Ev(ptr noundef nonnull align 8 dereferenceable(264) %i.w) #10
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.k
  ...
  %i.ab = add i64 %i.aa, 1
  call void @_ZdlPvm(ptr noundef %i.x, i64 noundef %i.ab) #11
...
bb.m:                                             ; preds = %bb.l
  call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str, ptr noundef nonnull @.str.5) #9
  unreachable
...
begin_hunk_16_@_ZN2v88internal2V810InitializeEv:bb.a
  ...
  call void @_ZN2v84base2OS10InitializeENS0_9AbortModeEPKc(i32 noundef %.0, ptr noundef %i.ak) #10
...
bb.n:                                             ; preds = %.critedge
  %i.am = call noundef ptr @_ZN2v88internal24GetPlatformPageAllocatorEv() #10 ; 2 uses
  ...
  call void %i.ar(ptr noundef nonnull align 8 dereferenceable(8) %i.am, i64 noundef %i.ao) #10
  %i.as = call noundef ptr @_ZN2v88internal30GetPlatformVirtualAddressSpaceEv() #10 ; 2 uses
  ...
  call void %i.ax(ptr noundef nonnull align 8 dereferenceable(44) %i.as, i64 noundef %i.au) #10
  br label %bb.o
...
bb.p:                                             ; preds = %bb.o
  call void @_ZN2v88internal8FlagList11PrintValuesEv() #10
  br label %bb.q
...
begin_hunk_18_@_ZN2v88internal2V810InitializeEv:bb.a
  ...
  %i.bf = call noundef ptr %i.be(ptr noundef nonnull align 8 dereferenceable(8) %i.bb) #10
  call void @_ZN2v88internal15ThreadIsolation10InitializeEPNS_23ThreadIsolatedAllocatorE(ptr noundef %i.bf) #10
  call void @_ZN2v88internal12IsolateGroup24InitializeOncePerProcessEv() #10
  call void @_ZN2v88internal7Isolate24InitializeOncePerProcessEv() #10
...
bb.r:                                             ; preds = %bb.q
  ...
  call void @_ZN2v88internal11CpuFeatures9ProbeImplEb(i1 noundef zeroext false) #10
  br label %_ZN2v88internal11CpuFeatures5ProbeEb.exit

_ZN2v88internal11CpuFeatures5ProbeEb.exit:        ; preds = %bb.q, %bb.r
  call void @_ZN2v88internal16ElementsAccessor24InitializeOncePerProcessEv() #10
  call void @_ZN2v88internal12Bootstrapper24InitializeOncePerProcessEv() #10
  call void @_ZN2v88internal15CallDescriptors24InitializeOncePerProcessEv() #10
  call void @_ZN2v88internal4wasm10WasmEngine24InitializeOncePerProcessEv() #10
  ...
  call void @_ZN2v88internal22ExternalReferenceTable29InitializeOncePerIsolateGroupENS_10MemorySpanImEE(ptr nonnull %i.bj, i64 1320) #10
...
bb.s:                                             ; preds = %_ZN2v88internal11CpuFeatures5ProbeEb.exit
  call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str, ptr noundef nonnull @.str.7) #9
  unreachable
...
bb.u:                                             ; preds = %bb.t
  call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.8, i32 noundef %i.bk, i32 noundef %i.bl, i32 noundef 4) #9
  unreachable
...
bb.w:                                             ; preds = %bb.v
  ...
  call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.9, i32 noundef %i.bo, i32 noundef %i.bp) #9
  unreachable
...
bb.d:                                             ; preds = %bb.c
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.8, i32 noundef %i.a, i32 noundef %i.b, i32 noundef 5) #9
  unreachable
...
bb.h:                                             ; preds = %_ZN2v88internal12_GLOBAL__N_119AdvanceStartupStateENS1_14V8StartupStateE.exit
  tail call void @_ZN2v88internal4wasm10WasmEngine14GlobalTearDownEv() #10
  tail call void @_ZN2v88internal15CallDescriptors8TearDownEv() #10
  tail call void @_ZN2v88internal16ElementsAccessor8TearDownEv() #10
  tail call void @_ZN2v819RegisteredExtension13UnregisterAllEv() #10
  tail call void @_ZN2v88internal8FlagList25ReleaseDynamicAllocationsEv() #10
  tail call void @_ZN2v88internal12IsolateGroup22TearDownOncePerProcessEv() #10
...
bb.k:                                             ; preds = %bb.j
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.8, i32 noundef %i.h, i32 noundef %i.i, i32 noundef 6) #9
  unreachable
...
bb.m:                                             ; preds = %bb.l
  ...
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.9, i32 noundef %i.l, i32 noundef %i.m) #9
  unreachable
...
bb.d:                                             ; preds = %bb.c
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.8, i32 noundef %i.a, i32 noundef %i.b, i32 noundef 7) #9
  unreachable
...
bb.h:                                             ; preds = %_ZN2v88internal12_GLOBAL__N_119AdvanceStartupStateENS1_14V8StartupStateE.exit
  tail call void @_ZN2v87tracing23TracingCategoryObserver8TearDownEv() #10
  tail call void @_ZN2v84base18SetPrintStackTraceEPFvvE(ptr noundef null) #10
...
bb.k:                                             ; preds = %bb.j
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.8, i32 noundef %i.h, i32 noundef %i.i, i32 noundef 8) #9
  unreachable
...
; Function Attrs: mustprogress nofree norecurse nounwind memory(readwrite, argmem: none, target_mem: none) uwtable
define hidden void @_ZN2v88internal2V821SetPlatformForTestingEPNS_8PlatformE(ptr noundef %0) local_unnamed_addr #4 align 2 {
bb.a:
...
define hidden void @_ZN2v88internal2V815SetSnapshotBlobEPNS_11StartupDataE(ptr noundef readnone captures(none) %0) local_unnamed_addr #5 align 2 {
bb.a:
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str.6) #9
  unreachable
}
...
bb.a:
  %i.a = tail call noundef double @_ZN2v84base2OS17TimeCurrentMillisEv() #10
  ret double %i.a
}
...
define dso_local void @_ZN2v822SandboxHardwareSupport30InitializeBeforeThreadCreationEv() local_unnamed_addr #6 align 2 {
bb.a:
  ret void
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define dso_local void @_ZN2v822SandboxHardwareSupport41PrepareCurrentThreadForHardwareSandboxingEv() local_unnamed_addr #6 align 2 {
bb.a:
  ret void
}
...
; Function Attrs: nounwind
declare void @_ZNSt12__basic_fileIcED1Ev(ptr noundef nonnull align 8 dead_on_return(9) dereferenceable(9)) unnamed_addr #8
...
attributes #4 = { mustprogress nofree norecurse nounwind memory(readwrite, argmem: none, target_mem: none) uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
