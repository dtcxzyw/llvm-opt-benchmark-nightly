...
.thread.loopexit:                                 ; preds = %.critedge2, %.lr.ph
  %.2.lcssa.ph = phi ptr [ %i.x, %.lr.ph ], [ %scevgep, %.critedge2 ]
...
.thread:                                          ; preds = %.thread.loopexit, %.lr.ph.preheader
  %.032.lcssa = phi i1 [ false, %.lr.ph.preheader ], [ %i.ab, %.thread.loopexit ]
  %.2.lcssa = phi ptr [ %.1, %.lr.ph.preheader ], [ %.2.lcssa.ph, %.thread.loopexit ] ; 4 uses
