...
bb.a:
  ...
  %5 = alloca %"struct.icu_78::number::impl::ParsedPatternInfo", align 16 ; 34 uses
...
begin_hunk_2_@_ZN6icu_786number4impl14CompactHandler22precomputeAllModifiersERNS1_22MutablePatternModifierER10UErrorCode:bb.a
  ...
  store <2 x ptr> <ptr getelementptr inbounds nuw inrange(-16, 96) (i8, ptr @_ZTVN6icu_786number4impl17ParsedPatternInfoE, i64 16), ptr getelementptr inbounds nuw inrange(-16, 88) (i8, ptr @_ZTVN6icu_7813UnicodeStringE, i64 16)>, ptr %5, align 16
  store i16 2, ptr %i.aq, align 16
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(33) %i.as, i8 0, i64 33, i1 false)
  ...
  store i64 281474976645120, ptr %i.ba, align 16
  store i32 0, ptr %i.bc, align 4
  store i8 0, ptr %i.bd, align 16
  ...
  store i8 0, ptr %i.bg, align 16
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(10) %i.bh, i8 0, i64 10, i1 false)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(24) %i.bi, i8 0, i64 24, i1 false)
  store ptr %i.ap, ptr %i.bj, align 8
  store i32 0, ptr %i.bk, align 16
...
.critedge:                                        ; preds = %bb.p
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 96) (i8, ptr @_ZTVN6icu_786number4impl17ParsedPatternInfoE, i64 16), ptr %5, align 16
