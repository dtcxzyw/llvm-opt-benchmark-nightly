...
.lr.ph1208.preheader:                             ; preds = %.preheader1138
  ...
  %5 = load i8, ptr %.022.i997.lcssa, align 1, !tbaa !26
  %6 = load i8, ptr %.025.i996.lcssa, align 1, !tbaa !26
  %7 = icmp eq i8 %5, %6
...
.lr.ph1208.2:                                     ; preds = %14
  ...
  %18 = load i8, ptr %16, align 1, !tbaa !26
  %19 = icmp eq i8 %17, %18
...
.lr.ph1208:                                       ; preds = %26
  ...
  %i.au = load i8, ptr %27, align 1, !tbaa !26
  %i.av = load i8, ptr %28, align 1, !tbaa !26
...
bb.f:                                             ; preds = %29
  ...
  %32 = load i8, ptr %i.ax, align 1, !tbaa !26
...
.critedge.i1003:                                  ; preds = %.lr.ph1208.6, %8, %.lr.ph1208.preheader, %.lr.ph1208.1, %14, %.lr.ph1208.2, %20, %.lr.ph1208.3, %26, %.lr.ph1208, %29, %bb.f, %33, %.preheader1138
  %.224.i1001.lcssa = phi ptr [ %.022.i997.lcssa, %.preheader1138 ], [ %.022.i997.lcssa, %.lr.ph1208.preheader ], [ %scevgep1368, %8 ], [ %9, %.lr.ph1208.1 ], [ %scevgep1368, %14 ], [ %15, %.lr.ph1208.2 ], [ %scevgep1368, %20 ], [ %21, %.lr.ph1208.3 ], [ %scevgep1368, %26 ], [ %27, %.lr.ph1208 ], [ %scevgep1368, %29 ], [ %30, %bb.f ], [ %scevgep1368, %33 ], [ %spec.select, %.lr.ph1208.6 ]
...
.lr.ph1214:                                       ; preds = %bb.o
  %i.ct = load i64, ptr %i.o, align 8, !tbaa !37  ; 2 uses
  %i.cu = add i64 %.0754, 1
  %i.cv = add i64 %i.cs, 1
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.dm, label %middle.block, label %vector.body, !llvm.loop !38
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %.not821, label %._crit_edge, label %scalar.ph, !llvm.loop !41
...
._crit_edge:                                      ; preds = %scalar.ph, %middle.block, %bb.o
  ...
  br i1 %i.ec, label %.critedge, label %bb.p, !llvm.loop !42

bb.p:                                             ; preds = %._crit_edge
  %i.ed = add nuw nsw i64 %i.s, 6                 ; 5 uses
  %.not822 = icmp ult i64 %i.ed, %3
  br i1 %.not822, label %bb.q, label %.critedge, !llvm.loop !42
...
bb.dy:                                            ; preds = %.lr.ph1176
  ...
  br i1 %.not.i876, label %.critedge.i877, label %.lr.ph1176, !llvm.loop !43
...
IsMatch.exit863:                                  ; preds = %.critedge.i877, %bb.dw
  ...
  br i1 %i.abf, label %IsMatch.exit863.thread1047, label %.critedge, !llvm.loop !42
...
IsMatch.exit863.thread1047:                       ; preds = %bb.eb, %.preheader1139, %IsMatch.exit863
  ...
  br i1 %.not819, label %bb.ec, label %.critedge, !llvm.loop !42
...
bb.ew:                                            ; preds = %.lr.ph1267
  ...
  br i1 %.not.i890, label %.critedge.i891, label %.lr.ph1267, !llvm.loop !43
...
bb.fr:                                            ; preds = %.lr.ph1234
  ...
  br i1 %.not.i932, label %.critedge.i933, label %.lr.ph1234, !llvm.loop !43
...
bb.go:                                            ; preds = %.lr.ph1288
  ...
  br i1 %.not.i946, label %.critedge.i947, label %.lr.ph1288, !llvm.loop !43
...
bb.hg:                                            ; preds = %.lr.ph1309
  ...
  br i1 %.not.i974, label %.critedge.i975, label %.lr.ph1309, !llvm.loop !43
