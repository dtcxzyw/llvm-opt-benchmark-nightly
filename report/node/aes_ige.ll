...
.lr.ph:                                           ; preds = %.lr.ph.preheader489, %.lr.ph
  %.2142 = phi ptr [ %i.uf, %.lr.ph ], [ %i.qk, %.lr.ph.preheader489 ] ; 3 uses
  ...
  %i.ud = getelementptr inbounds i8, ptr %.1125139, i64 -8
  %i.ue = getelementptr inbounds nuw i8, ptr %.2142, i64 10
  %i.uf = getelementptr inbounds i8, ptr %.2142, i64 -16 ; 5 uses
  %i.ug = load <8 x i8>, ptr %i.uc, align 1
  %7 = load <6 x i8>, ptr %i.ue, align 1, !tbaa !14
  %i.uh = load <16 x i8>, ptr %i.a, align 16, !tbaa !14
  %i.ui = shufflevector <6 x i8> %7, <6 x i8> poison, <16 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5>
  ...
  %i.up = load <8 x i8>, ptr %i.ud, align 1
