...
.lr.ph33.preheader:                               ; preds = %.preheader
  ...
  %min.iters.check45 = icmp ult i32 %i.o, 4
  br i1 %min.iters.check45, label %.lr.ph33.preheader55, label %vector.ph46

vector.ph46:                                      ; preds = %.lr.ph33.preheader
  %n.vec48 = and i64 %wide.trip.count, 2147483644 ; 3 uses
  br label %vector.body49

vector.body49:                                    ; preds = %vector.body49, %vector.ph46
  %index50 = phi i64 [ 0, %vector.ph46 ], [ %index.next51, %vector.body49 ] ; 2 uses
  %i.bn = getelementptr inbounds nuw [8 x i8], ptr %i.as, i64 %index50 ; 2 uses
  ...
  %i.bp = icmp eq i64 %index.next51, %n.vec48
  br i1 %i.bp, label %middle.block52, label %vector.body49, !llvm.loop !765

middle.block52:                                   ; preds = %vector.body49
  %cmp.n53 = icmp eq i64 %n.vec48, %wide.trip.count
  br i1 %cmp.n53, label %.loopexit, label %.lr.ph33.preheader55

.lr.ph33.preheader55:                             ; preds = %.lr.ph33.preheader, %middle.block52
  %indvars.iv35.ph = phi i64 [ 0, %.lr.ph33.preheader ], [ %n.vec48, %middle.block52 ]
  br label %.lr.ph33
...
.lr.ph33:                                         ; preds = %.lr.ph33.preheader55, %.lr.ph33
  %indvars.iv35 = phi i64 [ %indvars.iv.next36, %.lr.ph33 ], [ %indvars.iv35.ph, %.lr.ph33.preheader55 ] ; 2 uses
...
.loopexit:                                        ; preds = %.lr.ph33, %middle.block52, %.preheader, %._crit_edge
  ret i32 %i.o
}
