...
define hidden noundef range(i32 2, 8) i32 @_ZN6disasm15DisassemblerX6414FPUInstructionEPh(ptr noundef nonnull align 8 dereferenceable(176) %0, ptr nofree noundef readonly captures(none) %1) local_unnamed_addr #4 align 2 {
bb.a:
...
; Function Attrs: mustprogress nounwind uwtable
define hidden noundef range(i32 2, 8) i32 @_ZN6disasm15DisassemblerX6420MemoryFPUInstructionEiiPh(ptr noundef nonnull align 8 dereferenceable(176) %0, i32 noundef %1, i32 noundef %2, ptr nofree noundef readonly captures(none) %3) local_unnamed_addr #4 align 2 {
bb.a:
  %i.a = lshr i32 %2, 3
