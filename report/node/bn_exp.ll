...
.preheader.lr.ph:                                 ; preds = %.preheader81
  ...
  %xtraiter438 = and i64 %i.f, 2                  ; 2 uses
  %i.h = icmp samesign ult i32 %4, 2
  %unroll_iter442 = and i64 %i.f, 12
...
.epilog-lcssa:                                    ; preds = %bb.c, %.unr-lcssa
  ...
  %i.ah = getelementptr inbounds nuw [8 x i8], ptr %5, i64 %indvars.iv361
...
.preheader82.lr.ph:                               ; preds = %bb.d
  ...
  %6 = load ptr, ptr %0, align 8, !tbaa !16       ; 4 uses
  %i.as = zext nneg i32 %i.a to i64               ; 4 uses
...
.preheader82.us.preheader:                        ; preds = %.preheader82.lr.ph
  %i.at = zext nneg i32 %i.ak to i64              ; 3 uses
  %i.au = zext nneg i32 %i.aq to i64
  %i.av = zext nneg i32 %i.ar to i64
  %i.aw = zext nneg i32 %i.an to i64              ; 2 uses
  %xtraiter424 = and i64 %i.at, 1
  %i.ax = icmp eq i32 %i.aj, 0
  %unroll_iter428 = and i64 %i.at, 2147483646
  %lcmp.mod425.not = icmp eq i64 %xtraiter424, 0
  %lcmp.mod427 = icmp eq i32 %i.aj, 0
...
begin_hunk_6_@MOD_EXP_CTIME_COPY_FROM_PREBUF:bb.a
  ...
  %i.bt = icmp eq i64 %indvars.iv267.epil.init, 0
...
.split.us.us.split.split.split:                   ; preds = %.split.us.us.split.split.split.unr-lcssa, %.epil.preheader423
  ...
  %i.bw = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv273
...
.preheader82.us102.preheader:                     ; preds = %.preheader82.lr.ph
  %i.by = zext nneg i32 %i.ak to i64              ; 3 uses
  %i.bz = zext nneg i32 %i.aq to i64
  %i.ca = zext nneg i32 %i.ar to i64
  %i.cb = zext nneg i32 %i.an to i64              ; 2 uses
  %xtraiter417 = and i64 %i.by, 1
  %i.cc = icmp eq i32 %i.aj, 0
  %unroll_iter421 = and i64 %i.by, 2147483646
  %lcmp.mod418.not = icmp eq i64 %xtraiter417, 0
  %lcmp.mod420 = icmp eq i32 %i.aj, 0
...
begin_hunk_8_@MOD_EXP_CTIME_COPY_FROM_PREBUF:bb.a
  ...
  %i.cy = icmp eq i64 %indvars.iv223.epil.init, 0
...
.split.split.us.us.split.split:                   ; preds = %.split.split.us.us.split.split.unr-lcssa, %.epil.preheader416
  ...
  %i.db = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv229
...
.preheader82.preheader:                           ; preds = %.preheader82.lr.ph
  %i.dd = zext nneg i32 %i.an to i64              ; 2 uses
  %i.de = zext nneg i32 %i.ak to i64              ; 3 uses
  %i.df = zext nneg i32 %i.aq to i64
  %i.dg = zext nneg i32 %i.ar to i64
  %xtraiter431 = and i64 %i.de, 1
  %i.dh = icmp eq i32 %i.aj, 0
  %unroll_iter435 = and i64 %i.de, 2147483646
  %lcmp.mod432.not = icmp eq i64 %xtraiter431, 0
  %lcmp.mod434 = icmp eq i32 %i.aj, 0
  br label %.preheader82

.preheader82.us105.preheader:                     ; preds = %.preheader82.lr.ph
  %i.di = zext nneg i32 %i.ak to i64              ; 3 uses
  %i.dj = zext nneg i32 %i.aq to i64
  %i.dk = zext nneg i32 %i.ar to i64
  %i.dl = zext nneg i32 %i.an to i64              ; 2 uses
  %xtraiter = and i64 %i.di, 1
  %i.dm = icmp eq i32 %i.aj, 0
  %unroll_iter = and i64 %i.di, 2147483646
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod415 = icmp eq i32 %i.aj, 0
...
begin_hunk_10_@MOD_EXP_CTIME_COPY_FROM_PREBUF:bb.a
  ...
  %i.ei = icmp eq i64 %indvars.iv201.epil.init, 0
...
.split.split.split.us.us.split:                   ; preds = %.split.split.split.us.us.split.unr-lcssa, %.epil.preheader
  ...
  %i.el = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv207
...
begin_hunk_11_@MOD_EXP_CTIME_COPY_FROM_PREBUF:bb.a
  ...
  %i.fk = icmp eq i64 %indvars.iv.epil.init, 0
...
.split.split.split:                               ; preds = %.split.split.split.unr-lcssa, %.epil.preheader430
  ...
  %i.fo = getelementptr inbounds nuw [8 x i8], ptr %6, i64 %indvars.iv196
