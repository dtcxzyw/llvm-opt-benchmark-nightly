...
begin_hunk_0_@_ZN12v8_inspector23searchInTextByLinesImplEPNS_18V8InspectorSessionERKNS_8String16ES4_bb:bb.a
  ...
  %i.jj = call noalias noundef nonnull dereferenceable(64) ptr @_Znwm(i64 noundef 64) #13, !noalias !26 ; 8 uses
  %13 = getelementptr inbounds nuw i8, ptr %i.jj, i64 8
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN12v8_inspector8protocol8Debugger11SearchMatchE, i64 16), ptr %i.jj, align 8, !noalias !26
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN12v8_inspector8protocol8Debugger11SearchMatchE, i64 56), ptr %13, align 8, !noalias !26
