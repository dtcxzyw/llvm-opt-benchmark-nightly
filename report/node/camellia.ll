...
define void @mbedtls_camellia_init(ptr nofree noundef writeonly captures(none) initializes((0, 276)) %0) local_unnamed_addr #0 {
bb.a:
...
define range(i32 -36, 1) i32 @mbedtls_camellia_setkey_enc(ptr nofree noundef captures(none) initializes((4, 276)) %0, ptr nofree noundef readonly captures(none) %1, i32 noundef %2) local_unnamed_addr #4 {
bb.a:
...
; Function Attrs: nounwind uwtable
define range(i32 -36, 1) i32 @mbedtls_camellia_setkey_dec(ptr nofree noundef writeonly captures(none) %0, ptr nofree noundef readonly captures(none) %1, i32 noundef %2) local_unnamed_addr #2 {
bb.a:
  %3 = alloca %struct.mbedtls_camellia_context, align 4 ; 7 uses
  ...
  br i1 %.not, label %.prol.preheader, label %bb.c

.prol.preheader:                                  ; preds = %bb.a
  %i.b = load i32, ptr %3, align 4, !tbaa !8      ; 2 uses
  store i32 %i.b, ptr %0, align 4, !tbaa !8
  %i.c = icmp eq i32 %i.b, 4
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 4
  %i.e = getelementptr inbounds nuw i8, ptr %3, i64 196
  %i.f = select i1 %i.c, i32 8, i32 0             ; 2 uses
