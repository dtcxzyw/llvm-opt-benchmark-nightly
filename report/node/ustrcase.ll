...
bb.n:                                             ; preds = %bb.e, %bb.l, %bb.m
  ...
  %.1 = phi i32 [ %.070, %bb.l ], [ %.070, %bb.m ], [ %5, %bb.e ] ; 10 uses
...
.lr.ph.preheader.a:                               ; preds = %.preheader
  %i.at = sext i32 %1 to i64                      ; 5 uses
  %i.au = zext nneg i32 %.1 to i64                ; 2 uses
...
begin_hunk_2_@_ZN6icu_7812_GLOBAL__N_112appendResultEPDsiiiPKDsijPNS_5EditsE:bb.a
  ...
  br i1 %diff.check, label %.lr.ph.preheader116, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.au, 2147483632              ; 5 uses
...
begin_hunk_3_@_ZN6icu_7812_GLOBAL__N_112appendResultEPDsiiiPKDsijPNS_5EditsE:bb.a
  ...
  br i1 %i.be, label %middle.block.a, label %vector.body, !llvm.loop !8

middle.block.a:                                   ; preds = %vector.body
  %cmp.n.a = icmp eq i64 %n.vec, %i.au
  br i1 %cmp.n.a, label %.loopexit.loopexit, label %.lr.ph.preheader116

.lr.ph.preheader116:                              ; preds = %vector.memcheck, %.lr.ph.preheader.a, %middle.block.a
  %indvars.iv.ph = phi i64 [ %i.at, %vector.memcheck ], [ %i.at, %.lr.ph.preheader.a ], [ %i.ay, %middle.block.a ]
  %.2101.ph = phi i32 [ %.1, %vector.memcheck ], [ %.1, %.lr.ph.preheader.a ], [ %i.az, %middle.block.a ]
  %.07799.ph = phi ptr [ %4, %vector.memcheck ], [ %4, %.lr.ph.preheader.a ], [ %i.bb, %middle.block.a ]
  br label %.lr.ph
...
begin_hunk_4_@_ZN6icu_7812_GLOBAL__N_112appendResultEPDsiiiPKDsijPNS_5EditsE:bb.a
  ...
  br i1 %i.bj, label %.lr.ph, label %.loopexit.loopexit, !llvm.loop !11

bb.x:                                             ; preds = %bb.o
  %i.bk = add nsw i32 %.1, %1
  br label %.loopexit

.loopexit.loopexit:                               ; preds = %.lr.ph, %middle.block.a
  %indvars.iv.next.lcssa = phi i64 [ %i.ay, %middle.block.a ], [ %indvars.iv.next, %.lr.ph ]
...
begin_hunk_5_@_ZN6icu_7812_GLOBAL__N_17toLowerEijPDsiPKDsP12UCaseContextiiPNS_5EditsER10UErrorCode:bb.a
  ...
  br i1 %or.cond305, label %.thread187, label %bb.m, !llvm.loop !12
...
begin_hunk_6_@_ZN6icu_7810GreekUpper7toUpperEjPDsiPKDsiPNS_5EditsER10UErrorCode:bb.a
  ...
  br i1 %i.eg, label %.lr.ph286, label %._crit_edge.thread316, !llvm.loop !13
...
begin_hunk_7_@_ZN6icu_7810GreekUpper7toUpperEjPDsiPKDsiPNS_5EditsER10UErrorCode:bb.a
  ...
  br i1 %.not223, label %bb.b, label %.thread267, !llvm.loop !14
...
begin_hunk_8_@ustrcase_internalToUpper_78:bb.a
  ...
  br i1 %or.cond289.i, label %.thread173.i, label %bb.j, !llvm.loop !15
...
begin_hunk_9_@_ZL8_cmpFoldPKDsiS0_ijPiS1_P10UErrorCode:bb.a
  ...
  br i1 %i.aa, label %.preheader7.us, label %bb.h, !llvm.loop !16
...
begin_hunk_10_@_ZL8_cmpFoldPKDsiS0_ijPiS1_P10UErrorCode:bb.a
  ...
  br label %.preheader9.split.us, !llvm.loop !17
...
begin_hunk_11_@_ZL8_cmpFoldPKDsiS0_ijPiS1_P10UErrorCode:bb.a
  ...
  br i1 %i.aq, label %.preheader7, label %bb.k, !llvm.loop !16
...
begin_hunk_12_@_ZL8_cmpFoldPKDsiS0_ijPiS1_P10UErrorCode:bb.a
  ...
  br label %.preheader9.split, !llvm.loop !17
...
begin_hunk_13_@_ZL8_cmpFoldPKDsiS0_ijPiS1_P10UErrorCode:bb.a
  ...
  br i1 %i.bh, label %.preheader, label %bb.o, !llvm.loop !18
...
begin_hunk_15_@_ZL8_cmpFoldPKDsiS0_ijPiS1_P10UErrorCode:bb.a
  ...
  br i1 %.not246, label %.outer, label %bb.r, !llvm.loop !20
