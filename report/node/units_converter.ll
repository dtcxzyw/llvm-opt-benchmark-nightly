...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ck = load ptr, ptr %13, align 8, !noalias !14 ; 2 uses
  %i.cl = load i32, ptr %i.o, align 8, !noalias !14 ; 5 uses
...
bb.i:                                             ; preds = %bb.h, %bb.g, %bb.f
  %.131.i.i = phi i32 [ %i.ct, %bb.f ], [ %.03039.i.i, %bb.h ], [ %.03039.i.i, %bb.g ]
  %i.cv = load i8, ptr %i.cp, align 1, !noalias !20
  %i.cw = icmp eq i8 %i.cv, 47
  %spec.select.i18.i = select i1 %i.cw, i32 -1, i32 %.041.i.i
