...
.preheader88.preheader:                           ; preds = %.preheader88.lr.ph
  %i.at = and i64 %i.l, 24                        ; 3 uses
  %i.au = add nsw i64 %i.at, -8
  %i.av = or disjoint i64 %i.at, 1                ; 2 uses
  %umax = call i64 @llvm.umax.i64(i64 %i.av, i64 %i.l)
  %i.aw = sub nsw i64 %umax, %i.au                ; 2 uses
  %umax174 = call i64 @llvm.umax.i64(i64 %i.av, i64 %i.l) ; 2 uses
  %i.ax = sub nsw i64 %umax174, %i.at             ; 6 uses
