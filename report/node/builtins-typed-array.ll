...
.critedge:                                        ; preds = %bb.b, %_ZNSt6vectorISt5tupleIJPKcmN7simdutf14base64_optionsEEESaIS5_EED2Ev.exit
  ...
  %i.ad = tail call ptr @_ZN2v88internal8JSObject18ReadFromOptionsBagENS0_12DirectHandleINS0_6ObjectEEENS2_INS0_6StringEEEPNS0_7IsolateE(ptr %2, ptr nonnull %i.ac, ptr noundef nonnull %1) #15 ; 6 uses
...
bb.g:                                             ; preds = %_ZN2v88internal8IsStringENS0_6TaggedINS0_6ObjectEEE.exit
  %i.aw = tail call noalias noundef nonnull dereferenceable(72) ptr @_Znwm(i64 noundef 72) #16, !noalias !137 ; 24 uses
  ...
  %.sroa.6.0..sroa_idx.i43 = getelementptr inbounds nuw i8, ptr %i.aw, i64 24 ; 4 uses
  ...
  %.sroa.9.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.aw, i64 48 ; 4 uses
  ...
  %10 = load i64, ptr %i.ad, align 8              ; 2 uses
  %11 = add i64 %10, -1
  %12 = inttoptr i64 %11 to ptr                   ; 3 uses
  %i.ax = load atomic volatile i64, ptr %12 acquire, align 8
...
bb.k:                                             ; preds = %.thread.i, %bb.h
  ...
  %.sroa.012.1.i.i = phi i64 [ %i.bm, %.thread.i ], [ %10, %bb.h ] ; 2 uses
...
begin_hunk_7_@_ZN2v88internal12_GLOBAL__N_116HandleOptionsBagEPNS0_7IsolateENS0_12DirectHandleINS0_6ObjectEEE:bb.a
  ...
  %.fr133 = freeze i32 %i.eo                      ; 2 uses
  %i.ep = zext i32 %.fr133 to i64                 ; 12 uses
...
.lr.ph.preheader.i:                               ; preds = %_ZN2v88internal31SharedStringAccessGuardIfNeededD2Ev.exit.i
  ...
  %13 = icmp eq i32 %.fr133, 0
  %i.fh = load i64, ptr %.sroa.4.0..sroa_idx.i41, align 8
  %i.fi = icmp eq i64 %i.fh, %i.ep                ; 2 uses
  br i1 %13, label %.lr.ph.i.us.preheader, label %.lr.ph.i.preheader
...
.lr.ph.i.us.preheader:                            ; preds = %.lr.ph.preheader.i
  br i1 %i.fi, label %_ZNSt6vectorISt5tupleIJPKcmN7simdutf27last_chunk_handling_optionsEEESaIS5_EED2Ev.exit.thread, label %.loopexit.i.us

.loopexit.i.us:                                   ; preds = %.lr.ph.i.us.preheader
  %14 = getelementptr inbounds nuw i8, ptr %i.aw, i64 32
  %15 = load i64, ptr %14, align 8
  %16 = icmp eq i64 %15, %i.ep
  br i1 %16, label %_ZNSt6vectorISt5tupleIJPKcmN7simdutf27last_chunk_handling_optionsEEESaIS5_EED2Ev.exit.thread, label %.loopexit.i.us.1

.loopexit.i.us.1:                                 ; preds = %.loopexit.i.us
  %17 = getelementptr inbounds nuw i8, ptr %i.aw, i64 56
  %18 = load i64, ptr %17, align 8
  %19 = icmp eq i64 %18, %i.ep
  br i1 %19, label %_ZNSt6vectorISt5tupleIJPKcmN7simdutf27last_chunk_handling_optionsEEESaIS5_EED2Ev.exit.thread, label %.loopexit
...
.lr.ph.i.i.i:                                     ; preds = %bb.af, %.lr.ph.i.i.preheader.i
  %.01013.i.i.i = phi ptr [ %20, %bb.af ], [ %i.em, %.lr.ph.i.i.preheader.i ] ; 2 uses
  %.01112.i.i.i = phi ptr [ %21, %bb.af ], [ %i.fj, %.lr.ph.i.i.preheader.i ] ; 2 uses
  %i.fk = load i16, ptr %.01013.i.i.i, align 2
  %i.fl = load i8, ptr %.01112.i.i.i, align 1
  %i.fm = zext i8 %i.fl to i16
  %.not.i.i.i46 = icmp eq i16 %i.fk, %i.fm
  br i1 %.not.i.i.i46, label %bb.af, label %.loopexit.i

bb.af:                                            ; preds = %.lr.ph.i.i.i
  %20 = getelementptr inbounds nuw i8, ptr %.01013.i.i.i, i64 2 ; 2 uses
  %21 = getelementptr inbounds nuw i8, ptr %.01112.i.i.i, i64 1
  %.not16.i.i.i = icmp ult ptr %20, %i.fg
  br i1 %.not16.i.i.i, label %.lr.ph.i.i.i, label %_ZNSt6vectorISt5tupleIJPKcmN7simdutf27last_chunk_handling_optionsEEESaIS5_EED2Ev.exit.thread, !llvm.loop !161
...
.loopexit.i:                                      ; preds = %.lr.ph.i.i.i, %.lr.ph.i.preheader
  ...
  br i1 %i.fp, label %.lr.ph.i.i.preheader.i.1, label %.loopexit.i.1
...
.lr.ph.i.i.i.1:                                   ; preds = %bb.ag, %.lr.ph.i.i.preheader.i.1
  %.01013.i.i.i.1 = phi ptr [ %i.fv, %bb.ag ], [ %i.em, %.lr.ph.i.i.preheader.i.1 ] ; 2 uses
  %.01112.i.i.i.1 = phi ptr [ %25, %bb.ag ], [ %i.fr, %.lr.ph.i.i.preheader.i.1 ] ; 2 uses
  %i.fs = load i16, ptr %.01013.i.i.i.1, align 2
  %i.ft = load i8, ptr %.01112.i.i.i.1, align 1
  %i.fu = zext i8 %i.ft to i16
  %.not.i.i.i46.1 = icmp eq i16 %i.fs, %i.fu
  br i1 %.not.i.i.i46.1, label %bb.ag, label %.loopexit.i.1

.loopexit.i.1:                                    ; preds = %.lr.ph.i.i.i.1, %.loopexit.i
  %22 = getelementptr inbounds nuw i8, ptr %i.aw, i64 56
  %23 = load i64, ptr %22, align 8
  %24 = icmp eq i64 %23, %i.ep
  br i1 %24, label %.lr.ph.i.i.preheader.i.2, label %.loopexit

bb.ag:                                            ; preds = %.lr.ph.i.i.i.1
  %i.fv = getelementptr inbounds nuw i8, ptr %.01013.i.i.i.1, i64 2 ; 2 uses
  %25 = getelementptr inbounds nuw i8, ptr %.01112.i.i.i.1, i64 1
  %.not16.i.i.i.1 = icmp ult ptr %i.fv, %i.fg
  br i1 %.not16.i.i.i.1, label %.lr.ph.i.i.i.1, label %_ZNSt6vectorISt5tupleIJPKcmN7simdutf27last_chunk_handling_optionsEEESaIS5_EED2Ev.exit.thread, !llvm.loop !161
...
.lr.ph.i.i.i.2:                                   ; preds = %bb.ah, %.lr.ph.i.i.preheader.i.2
  %.01013.i.i.i.2 = phi ptr [ %26, %bb.ah ], [ %i.em, %.lr.ph.i.i.preheader.i.2 ] ; 2 uses
  %.01112.i.i.i.2 = phi ptr [ %27, %bb.ah ], [ %i.fx, %.lr.ph.i.i.preheader.i.2 ] ; 2 uses
  %i.fy = load i16, ptr %.01013.i.i.i.2, align 2
  %i.fz = load i8, ptr %.01112.i.i.i.2, align 1
  %i.ga = zext i8 %i.fz to i16
  %.not.i.i.i46.2 = icmp eq i16 %i.fy, %i.ga
  br i1 %.not.i.i.i46.2, label %bb.ah, label %.loopexit

bb.ah:                                            ; preds = %.lr.ph.i.i.i.2
  %26 = getelementptr inbounds nuw i8, ptr %.01013.i.i.i.2, i64 2 ; 2 uses
  %27 = getelementptr inbounds nuw i8, ptr %.01112.i.i.i.2, i64 1
  %.not16.i.i.i.2 = icmp ult ptr %26, %i.fg
  br i1 %.not16.i.i.i.2, label %.lr.ph.i.i.i.2, label %_ZNSt6vectorISt5tupleIJPKcmN7simdutf27last_chunk_handling_optionsEEESaIS5_EED2Ev.exit.thread, !llvm.loop !161
...
.lr.ph.preheader:                                 ; preds = %bb.z
  ...
  %7 = icmp eq i32 %i.cu, 0
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.loopexit.a
  %.sroa.059.0265 = phi ptr [ %i.dr, %.loopexit.a ], [ %i.cw, %.lr.ph.preheader ] ; 5 uses
  %i.dj = getelementptr inbounds nuw i8, ptr %.sroa.059.0265, i64 8
  %i.dk = load i64, ptr %i.dj, align 8
  %i.dl = icmp eq i64 %i.dk, %i.cv
  br i1 %i.dl, label %8, label %.loopexit.a

8:                                                ; preds = %.lr.ph
  br i1 %7, label %.thread252, label %.lr.ph.i.i.preheader
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %bb.aa
  %.01013.i.i = phi ptr [ %9, %bb.aa ], [ %i.cs, %.lr.ph.i.i.preheader ] ; 2 uses
  %.01112.i.i = phi ptr [ %10, %bb.aa ], [ %i.dn, %.lr.ph.i.i.preheader ] ; 2 uses
  %i.do = load i16, ptr %.01013.i.i, align 2
  %i.dp = load i8, ptr %.01112.i.i, align 1
  %i.dq = zext i8 %i.dp to i16
  %.not.i.i = icmp eq i16 %i.do, %i.dq
  br i1 %.not.i.i, label %bb.aa, label %.loopexit.a

bb.aa:                                            ; preds = %.lr.ph.i.i
  %9 = getelementptr inbounds nuw i8, ptr %.01013.i.i, i64 2 ; 2 uses
  %10 = getelementptr inbounds nuw i8, ptr %.01112.i.i, i64 1
  %.not16.i.i = icmp ult ptr %9, %i.di
  br i1 %.not16.i.i, label %.lr.ph.i.i, label %.thread252, !llvm.loop !161

.loopexit.a:                                      ; preds = %.lr.ph.i.i, %.lr.ph
...
.thread252:                                       ; preds = %8, %bb.aa, %bb.x
  %.sroa.4.7.in = phi ptr [ %.sroa.059.0265, %bb.aa ], [ %.sroa.065.0266, %bb.x ], [ %.sroa.059.0265, %8 ]
