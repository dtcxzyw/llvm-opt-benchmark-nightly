Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/node/original/loop-unrolling?download=true
...
bb.a:
  %i.a = icmp eq ptr %4, %5
  br i1 %i.a, label %._crit_edge67, label %.lr.ph60
...
.lr.ph66:                                         ; preds = %_ZN2v88internal8compiler15NodeOriginTable5ScopeD2Ev.exit
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.h = load i32, ptr %i.g, align 8
  %.not68 = icmp eq i32 %i.h, 0
  br i1 %.not68, label %._crit_edge67, label %.lr.ph66.split

bb.b:                                             ; preds = %.lr.ph60, %_ZN2v88internal8compiler15NodeOriginTable5ScopeD2Ev.exit
  %.sroa.053.058 = phi ptr [ %4, %.lr.ph60 ], [ %i.ax, %_ZN2v88internal8compiler15NodeOriginTable5ScopeD2Ev.exit ] ; 2 uses
  %.sroa.8.058 = phi i64 [ undef, %.lr.ph60 ], [ %.sroa.8.1, %_ZN2v88internal8compiler15NodeOriginTable5ScopeD2Ev.exit ]
  %i.i = getelementptr inbounds nuw i8, ptr %.sroa.053.058, i64 8
...
_ZN2v88internal8compiler15NodeOriginTable5ScopeD2Ev.exit: ; preds = %._crit_edge, %bb.f
  ...
  %i.ax = load ptr, ptr %.sroa.053.058, align 8   ; 2 uses
  %i.ay = icmp eq ptr %i.ax, %5
  br i1 %i.ay, label %.lr.ph66, label %bb.b
...
._crit_edge67:                                    ; preds = %._crit_edge64, %bb.a, %.lr.ph66
  ret void

.lr.ph66.split:                                   ; preds = %.lr.ph66, %._crit_edge64
  %i.bs = phi i32 [ %i.bz, %._crit_edge64 ], [ 1, %.lr.ph66 ]
  %.sroa.034.065 = phi ptr [ %i.ca, %._crit_edge64 ], [ %4, %.lr.ph66 ] ; 2 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %.sroa.034.065, i64 8
  %i.bu = load ptr, ptr %i.bt, align 8            ; 3 uses
  %.not69 = icmp eq i32 %i.bs, 0
  br i1 %.not69, label %._crit_edge64, label %.lr.ph63

.lr.ph63:                                         ; preds = %.lr.ph66.split
...
._crit_edge64:                                    ; preds = %bb.l, %.lr.ph66.split
  %i.bz = phi i32 [ 0, %.lr.ph66.split ], [ %i.cs, %bb.l ]
  %i.ca = load ptr, ptr %.sroa.034.065, align 8   ; 2 uses
  %i.cb = icmp eq ptr %i.ca, %5
  br i1 %i.cb, label %._crit_edge67, label %.lr.ph66.split, !llvm.loop !22

bb.h:                                             ; preds = %.lr.ph63, %bb.l
  %.02261 = phi i32 [ 0, %.lr.ph63 ], [ %i.cr, %bb.l ] ; 3 uses
  %i.cc = tail call noundef ptr @_ZN2v88internal8compiler10NodeCopier3mapEPNS1_4NodeEj(ptr noundef nonnull align 8 dereferenceable(20) %0, ptr noundef %i.bu, i32 noundef %.02261) #7 ; 3 uses
...
bb.l:                                             ; preds = %_ZNK2v88internal8compiler4Node10InputCountEv.exit
  %i.cr = add nuw i32 %.02261, 1                  ; 2 uses
  %i.cs = load i32, ptr %i.g, align 8             ; 2 uses
  %i.ct = icmp ult i32 %i.cr, %i.cs
  br i1 %i.ct, label %bb.h, label %._crit_edge64, !llvm.loop !24
...
_ZNK2v88internal8compiler4Node7InputAtEi.exit:    ; preds = %bb.m, %bb.n
  ...
  %i.dc = tail call noundef ptr @_ZN2v88internal8compiler10NodeCopier3mapEPNS1_4NodeEj(ptr noundef nonnull align 8 dereferenceable(20) %0, ptr noundef %i.db, i32 noundef %.02261) #7 ; 5 uses
