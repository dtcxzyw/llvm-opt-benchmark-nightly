...
define internal i64 @get_time(ptr nofree noundef readonly captures(none) %0) #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define internal fastcc void @ch_update_ping_deadline(ptr nofree noundef captures(none) initializes((1528, 1536)) %0) unnamed_addr #0 {
bb.a:
