...
bb.b:                                             ; preds = %bb.n, %bb.a
  %.043 = phi i8 [ %5, %bb.a ], [ %10, %bb.n ]    ; 4 uses
...
bb.j:                                             ; preds = %bb.i
  %7 = trunc nuw i8 %.043 to i1
  %i.au = tail call noundef ptr @_ZN2v88internal5Scope16LookupSloppyEvalEPNS0_13VariableProxyEPS1_S4_S4_b(ptr noundef nonnull %0, ptr noundef nonnull %.041, ptr noundef %2, ptr noundef %3, i1 noundef zeroext %7)
  br label %.thread
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ay = tail call noundef ptr @_ZN2v88internal5Scope10LookupWithEPNS0_13VariableProxyEPS1_S4_S4_b(ptr noundef nonnull %0, ptr noundef nonnull %.041, ptr noundef %2, ptr noundef %3, i1 noundef zeroext %8)
  br label %.thread
...
; Function Attrs: mustprogress nounwind uwtable
define hidden noundef zeroext i1 @_ZNK2v88internal5Scope23is_debug_evaluate_scopeEv(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(124) %0) local_unnamed_addr #0 align 2 {
bb.a:
...
.lr.ph:                                           ; preds = %.preheader, %bb.k
  ...
  %.04183 = phi i8 [ %10, %bb.k ], [ %6, %.preheader ] ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  %7 = trunc nuw i8 %.04183 to i1
  %i.ap = tail call noundef ptr @_ZN2v88internal5Scope16LookupSloppyEvalEPNS0_13VariableProxyEPS1_S4_S4_b(ptr noundef nonnull %0, ptr noundef nonnull %.03784, ptr noundef %2, ptr noundef %3, i1 noundef zeroext %7)
  br label %.thread
...
bb.h:                                             ; preds = %bb.g
  %8 = trunc nuw i8 %.04183 to i1
  %i.at = tail call noundef ptr @_ZN2v88internal5Scope10LookupWithEPNS0_13VariableProxyEPS1_S4_S4_b(ptr noundef nonnull %0, ptr noundef nonnull %.03784, ptr noundef %2, ptr noundef %3, i1 noundef zeroext %8)
  br label %.thread
...
define hidden noundef ptr @_ZN2v88internal11VariableMap6LookupEPKNS0_12AstRawStringE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(24) %0, ptr nofree noundef readonly captures(address) %1) local_unnamed_addr #6 align 2 {
bb.a:
...
end_hunk_0
begin_hunk_1_@_ZN2v88internal16DeclarationScope40RecordNeedsPrivateNameContextChainRecalcEv:bb.a
  ]
...
; Function Attrs: mustprogress nounwind uwtable
define hidden noundef range(i32 2147483647, 2147483646) i32 @_ZNK2v88internal5Scope17ContextLocalCountEv(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(124) %0) local_unnamed_addr #0 align 2 {
bb.a:
...
; Function Attrs: mustprogress nounwind uwtable
define hidden noundef ptr @_ZN2v88internal10ClassScope18DeclarePrivateNameEPKNS0_12AstRawStringENS0_12VariableModeENS0_12IsStaticFlagEPb(ptr noundef nonnull align 8 dereferenceable(145) %0, ptr noundef %1, i8 noundef zeroext %2, i8 noundef zeroext %3, ptr nofree noundef captures(none) %4) local_unnamed_addr #0 align 2 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none, target_mem: none) uwtable
define hidden noundef ptr @_ZN2v88internal10ClassScope22LookupLocalPrivateNameEPKNS0_12AstRawStringE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(145) %0, ptr nofree noundef readonly captures(address) %1) local_unnamed_addr #6 align 2 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, inaccessiblemem: none, target_mem: none) uwtable
define hidden ptr @_ZN2v88internal10ClassScope28GetUnresolvedPrivateNameTailEv(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(145) %0) local_unnamed_addr #6 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 128
  %i.b = load i64, ptr %i.a, align 8
  %i.c = and i64 %i.b, -2                         ; 2 uses
...
define hidden void @_ZN2v88internal10ClassScope30ResetUnresolvedPrivateNameTailENS_4base16ThreadedListBaseINS0_13VariableProxyENS2_9EmptyBaseENS4_14UnresolvedNextELb0EE8IteratorE(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(145) %0, ptr %1) local_unnamed_addr #15 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 128
  %i.b = load i64, ptr %i.a, align 8
  %i.c = and i64 %i.b, -2                         ; 2 uses
...
end_hunk_1
begin_hunk_2_@_ZN2v88internal10ClassScope28ResolvePrivateNamesPartiallyEv:bb.a
...
.critedge:                                        ; preds = %_ZN2v88internal10ClassScope22LookupLocalPrivateNameEPKNS0_12AstRawStringE.exit
  ...
  %.not46 = icmp eq i16 %i.ci, 0
  %i.cj = trunc i16 %i.ch to i8
  %i.ck = and i8 %i.cj, 15
  %i.cl = add nsw i8 %i.ck, -13
  %i.cm = icmp ult i8 %i.cl, -4
  %i.cn = select i1 %.not46, i1 true, i1 %i.cm
  %i.co = select i1 %i.cn, i8 0, i8 2
  %2 = load i8, ptr %i.am, align 8
  %i.cp = or i8 %i.co, %2
