...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %3 = add <16 x i16> %i.h, splat (i16 8192)
  %4 = icmp ult <16 x i16> %3, splat (i16 -1024)
  %5 = sext <16 x i1> %4 to <16 x i16>
  %i.i = bitcast <32 x i8> %i.g to <16 x i16>
  %6 = add <16 x i16> %i.i, splat (i16 8192)
  %7 = icmp ult <16 x i16> %6, splat (i16 -1024)
  %8 = sext <16 x i1> %7 to <16 x i16>
  %9 = shufflevector <16 x i16> %5, <16 x i16> %8, <32 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15, i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
  %i.j = bitcast <32 x i16> %9 to <64 x i8>
  %i.k = icmp slt <64 x i8> %i.j, zeroinitializer
  %i.l = bitcast <64 x i1> %i.k to i64
  %i.m = tail call noundef range(i64 0, 65) i64 @llvm.ctpop.i64(i64 %i.l)
  %i.n = lshr i64 %i.m, 1
