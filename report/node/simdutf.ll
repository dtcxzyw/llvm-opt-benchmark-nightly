...
bb.y:                                             ; preds = %bb.x
  ...
  %i.ki = tail call noundef range(i64 0, 64) i64 @llvm.ctpop.i64(i64 %i.kh) ; 2 uses
...
bb.y:                                             ; preds = %bb.x
  ...
  %i.lb = tail call noundef range(i64 0, 64) i64 @llvm.ctpop.i64(i64 %i.la) ; 2 uses
...
.thread.i:                                        ; preds = %bb.c
  ...
  %i.ak = tail call noundef range(i32 16, 33) i32 @llvm.ctpop.i32(i32 %i.y) ; 2 uses
...
.thread.i:                                        ; preds = %bb.c
  ...
  %i.ao = tail call noundef range(i32 16, 33) i32 @llvm.ctpop.i32(i32 %i.aa) ; 2 uses
