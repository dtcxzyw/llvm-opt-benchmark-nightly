...
vector.body:                                      ; preds = %vector.ph, %vector.body
  ...
  %wide.load = load <8 x i16>, ptr %i.ag, align 2, !alias.scope !667 ; 2 uses
  %wide.load54 = load <8 x i16>, ptr %i.ah, align 2, !alias.scope !667 ; 2 uses
  %wide.load55 = load <8 x i16>, ptr %i.ai, align 2, !alias.scope !667 ; 2 uses
  %wide.load56 = load <8 x i16>, ptr %i.aj, align 2, !alias.scope !667 ; 2 uses
  ...
  store <8 x i8> %i.as, ptr %next.gep, align 1, !alias.scope !668, !noalias !667
  store <8 x i8> %i.at, ptr %i.aw, align 1, !alias.scope !668, !noalias !667
  store <8 x i8> %i.au, ptr %i.ax, align 1, !alias.scope !668, !noalias !667
  store <8 x i8> %i.av, ptr %i.ay, align 1, !alias.scope !668, !noalias !667
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.az = icmp eq i64 %index.next, %n.vec
  br i1 %i.az, label %middle.block, label %vector.body, !llvm.loop !663
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load63 = load <8 x i16>, ptr %i.bd, align 2, !alias.scope !667 ; 2 uses
  %i.be = zext <8 x i16> %wide.load63 to <8 x i32>
  %i.bf = or <8 x i32> %vec.phi61, %i.be          ; 2 uses
  %i.bg = trunc <8 x i16> %wide.load63 to <8 x i8>
  store <8 x i8> %i.bg, ptr %next.gep62, align 1, !alias.scope !668, !noalias !667
  %index.next64 = add nuw i64 %index60, 8         ; 2 uses
  %i.bh = icmp eq i64 %index.next64, %n.vec59
  br i1 %i.bh, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !664
...
.preheader.i.prol:                                ; preds = %.preheader.i.preheader, %.preheader.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.preheader.i.prol.loopexit, label %.preheader.i.prol, !llvm.loop !665
...
.preheader.i:                                     ; preds = %.preheader.i.prol.loopexit, %.preheader.i
  ...
  br i1 %exitcond.not.i.3, label %.loopexit, label %.preheader.i, !llvm.loop !666
...
vector.body:                                      ; preds = %vector.ph, %vector.body
  ...
  %wide.load = load <8 x i16>, ptr %i.aj, align 2, !alias.scope !676
  %wide.load54 = load <8 x i16>, ptr %i.ak, align 2, !alias.scope !676
  %wide.load55 = load <8 x i16>, ptr %i.al, align 2, !alias.scope !676
  %wide.load56 = load <8 x i16>, ptr %i.am, align 2, !alias.scope !676
  ...
  store <8 x i8> %i.az, ptr %next.gep, align 1, !alias.scope !677, !noalias !676
  store <8 x i8> %i.ba, ptr %i.bd, align 1, !alias.scope !677, !noalias !676
  store <8 x i8> %i.bb, ptr %i.be, align 1, !alias.scope !677, !noalias !676
  store <8 x i8> %i.bc, ptr %i.bf, align 1, !alias.scope !677, !noalias !676
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bg = icmp eq i64 %index.next, %n.vec
  br i1 %i.bg, label %middle.block, label %vector.body, !llvm.loop !672
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load63 = load <8 x i16>, ptr %i.bk, align 2, !alias.scope !676
  ...
  store <8 x i8> %i.bo, ptr %next.gep62, align 1, !alias.scope !677, !noalias !676
  %index.next64 = add nuw i64 %index60, 8         ; 2 uses
  %i.bp = icmp eq i64 %index.next64, %n.vec59
  br i1 %i.bp, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !673
...
.preheader.i.prol:                                ; preds = %.preheader.i.preheader, %.preheader.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.preheader.i.prol.loopexit, label %.preheader.i.prol, !llvm.loop !674
...
.preheader.i:                                     ; preds = %.preheader.i.prol.loopexit, %.preheader.i
  ...
  br i1 %exitcond.not.i.3, label %.loopexit, label %.preheader.i, !llvm.loop !675
...
.lr.ph.i:                                         ; preds = %bb.a, %.critedge.i
  ...
  %i.f = load <4 x i64>, ptr %.03767.i, align 1, !noalias !681 ; 4 uses
...
bb.b:                                             ; preds = %.lr.ph.i
  ...
  store <2 x i64> %i.r, ptr %.066.i, align 1, !noalias !681
  br label %.critedge.i

.preheader.1.i:                                   ; preds = %.preheader.preheader.i
  %i.s = trunc nuw i16 %i.h to i8
  store i8 %i.s, ptr %.066.i, align 1, !noalias !681
  %i.t = getelementptr inbounds nuw i8, ptr %.03767.i, i64 2
  %i.u = load i16, ptr %i.t, align 2, !noalias !681 ; 2 uses
...
.preheader.2.i:                                   ; preds = %.preheader.1.i
  ...
  store i8 %i.x, ptr %i.w, align 1, !noalias !681
  %i.y = getelementptr inbounds nuw i8, ptr %.03767.i, i64 4
  %i.z = load i16, ptr %i.y, align 2, !noalias !681 ; 2 uses
...
.preheader.3.i:                                   ; preds = %.preheader.2.i
  ...
  store i8 %i.ac, ptr %i.ab, align 1, !noalias !681
  %i.ad = getelementptr inbounds nuw i8, ptr %.03767.i, i64 6
  %i.ae = load i16, ptr %i.ad, align 2, !noalias !681 ; 2 uses
...
.preheader.4.i:                                   ; preds = %.preheader.3.i
  ...
  store i8 %i.ah, ptr %i.ag, align 1, !noalias !681
  %i.ai = getelementptr inbounds nuw i8, ptr %.03767.i, i64 8
  %i.aj = load i16, ptr %i.ai, align 2, !noalias !681 ; 2 uses
...
.preheader.5.i:                                   ; preds = %.preheader.4.i
  ...
  store i8 %i.am, ptr %i.al, align 1, !noalias !681
  %i.an = getelementptr inbounds nuw i8, ptr %.03767.i, i64 10
  %i.ao = load i16, ptr %i.an, align 2, !noalias !681 ; 2 uses
...
.preheader.6.i:                                   ; preds = %.preheader.5.i
  ...
  store i8 %i.ar, ptr %i.aq, align 1, !noalias !681
  %i.as = getelementptr inbounds nuw i8, ptr %.03767.i, i64 12
  %i.at = load i16, ptr %i.as, align 2, !noalias !681 ; 2 uses
...
.preheader.7.i:                                   ; preds = %.preheader.6.i
  ...
  store i8 %i.aw, ptr %i.av, align 1, !noalias !681
  %i.ax = getelementptr inbounds nuw i8, ptr %.03767.i, i64 14
  %i.ay = load i16, ptr %i.ax, align 2, !noalias !681 ; 2 uses
...
.preheader.8.i:                                   ; preds = %.preheader.7.i
  ...
  store i8 %i.bb, ptr %i.ba, align 1, !noalias !681
  %i.bc = getelementptr inbounds nuw i8, ptr %.03767.i, i64 16
  %i.bd = load i16, ptr %i.bc, align 2, !noalias !681 ; 2 uses
...
.preheader.9.i:                                   ; preds = %.preheader.8.i
  ...
  store i8 %i.bg, ptr %i.bf, align 1, !noalias !681
  %i.bh = getelementptr inbounds nuw i8, ptr %.03767.i, i64 18
  %i.bi = load i16, ptr %i.bh, align 2, !noalias !681 ; 2 uses
...
.preheader.10.i:                                  ; preds = %.preheader.9.i
  ...
  store i8 %i.bl, ptr %i.bk, align 1, !noalias !681
  %i.bm = getelementptr inbounds nuw i8, ptr %.03767.i, i64 20
  %i.bn = load i16, ptr %i.bm, align 2, !noalias !681 ; 2 uses
...
.preheader.11.i:                                  ; preds = %.preheader.10.i
  ...
  store i8 %i.bq, ptr %i.bp, align 1, !noalias !681
  %i.br = getelementptr inbounds nuw i8, ptr %.03767.i, i64 22
  %i.bs = load i16, ptr %i.br, align 2, !noalias !681 ; 2 uses
  %i.bt = icmp ult i16 %i.bs, 256
...
.preheader.12.i:                                  ; preds = %.preheader.11.i
  ...
  store i8 %i.bv, ptr %i.bu, align 1, !noalias !681
  %i.bw = getelementptr inbounds nuw i8, ptr %.03767.i, i64 24
  %i.bx = load i16, ptr %i.bw, align 2, !noalias !681 ; 2 uses
...
.preheader.13.i:                                  ; preds = %.preheader.12.i
  ...
  store i8 %i.ca, ptr %i.bz, align 1, !noalias !681
  %i.cb = getelementptr inbounds nuw i8, ptr %.03767.i, i64 26
  %i.cc = load i16, ptr %i.cb, align 2, !noalias !681 ; 2 uses
...
.preheader.14.i:                                  ; preds = %.preheader.13.i
  ...
  store i8 %i.cf, ptr %i.ce, align 1, !noalias !681
  %i.cg = getelementptr inbounds nuw i8, ptr %.03767.i, i64 28
  %i.ch = load i16, ptr %i.cg, align 2, !noalias !681 ; 2 uses
...
.preheader.15.i:                                  ; preds = %.preheader.14.i
  ...
  store i8 %i.ck, ptr %i.cj, align 1, !noalias !681
  %i.cl = getelementptr inbounds nuw i8, ptr %.03767.i, i64 30
  %i.cm = load i16, ptr %i.cl, align 2, !noalias !681 ; 2 uses
...
.critedge.loopexit.i:                             ; preds = %.preheader.15.i
  ...
  store i8 %i.cp, ptr %i.co, align 1, !noalias !681
  br label %.critedge.i
...
.critedge.i:                                      ; preds = %.critedge.loopexit.i, %bb.b
  ...
  br i1 %i.cs, label %.lr.ph.i, label %.loopexit, !llvm.loop !680
...
vector.body:                                      ; preds = %vector.ph, %vector.body
  ...
  %i.al = getelementptr inbounds nuw i8, ptr %i.aj, i64 32
  %i.am = getelementptr inbounds nuw i8, ptr %i.aj, i64 48
  %wide.load = load <8 x i16>, ptr %i.aj, align 2, !alias.scope !693
  %wide.load20 = load <8 x i16>, ptr %i.ak, align 2, !alias.scope !693
  %wide.load21 = load <8 x i16>, ptr %i.al, align 2, !alias.scope !693
  %wide.load22 = load <8 x i16>, ptr %i.am, align 2, !alias.scope !693
  %i.an = tail call <8 x i16> @llvm.bswap.v8i16(<8 x i16> %wide.load) ; 2 uses
  ...
  %i.be = getelementptr i8, ptr %next.gep, i64 16
  %i.bf = getelementptr i8, ptr %next.gep, i64 24
  store <8 x i8> %i.az, ptr %next.gep, align 1, !alias.scope !694, !noalias !693
  store <8 x i8> %i.ba, ptr %i.bd, align 1, !alias.scope !694, !noalias !693
  store <8 x i8> %i.bb, ptr %i.be, align 1, !alias.scope !694, !noalias !693
  store <8 x i8> %i.bc, ptr %i.bf, align 1, !alias.scope !694, !noalias !693
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bg = icmp eq i64 %index.next, %n.vec
  br i1 %i.bg, label %middle.block, label %vector.body, !llvm.loop !689
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load29 = load <8 x i16>, ptr %i.bk, align 2, !alias.scope !693
  %i.bl = tail call <8 x i16> @llvm.bswap.v8i16(<8 x i16> %wide.load29) ; 2 uses
  %i.bm = zext <8 x i16> %i.bl to <8 x i32>
  %i.bn = or <8 x i32> %vec.phi27, %i.bm          ; 2 uses
  %i.bo = trunc <8 x i16> %i.bl to <8 x i8>
  store <8 x i8> %i.bo, ptr %next.gep28, align 1, !alias.scope !694, !noalias !693
  %index.next30 = add nuw i64 %index26, 8         ; 2 uses
  %i.bp = icmp eq i64 %index.next30, %n.vec25
  br i1 %i.bp, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !690
...
.preheader.i.i.prol:                              ; preds = %.preheader.i.i.preheader, %.preheader.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.preheader.i.i.prol.loopexit, label %.preheader.i.i.prol, !llvm.loop !691
...
.preheader.i.i:                                   ; preds = %.preheader.i.i.prol.loopexit, %.preheader.i.i
  ...
  br i1 %exitcond.not.i.i.3, label %.loopexit, label %.preheader.i.i, !llvm.loop !692
...
vector.body:                                      ; preds = %vector.ph, %vector.body
  ...
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ag, i64 32
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ag, i64 48
  %wide.load = load <8 x i16>, ptr %i.ag, align 2, !alias.scope !702 ; 2 uses
  %wide.load20 = load <8 x i16>, ptr %i.ah, align 2, !alias.scope !702 ; 2 uses
  %wide.load21 = load <8 x i16>, ptr %i.ai, align 2, !alias.scope !702 ; 2 uses
  %wide.load22 = load <8 x i16>, ptr %i.aj, align 2, !alias.scope !702 ; 2 uses
  %i.ak = zext <8 x i16> %wide.load to <8 x i32>
  ...
  %i.ax = getelementptr i8, ptr %next.gep, i64 16
  %i.ay = getelementptr i8, ptr %next.gep, i64 24
  store <8 x i8> %i.as, ptr %next.gep, align 1, !alias.scope !703, !noalias !702
  store <8 x i8> %i.at, ptr %i.aw, align 1, !alias.scope !703, !noalias !702
  store <8 x i8> %i.au, ptr %i.ax, align 1, !alias.scope !703, !noalias !702
  store <8 x i8> %i.av, ptr %i.ay, align 1, !alias.scope !703, !noalias !702
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.az = icmp eq i64 %index.next, %n.vec
  br i1 %i.az, label %middle.block, label %vector.body, !llvm.loop !698
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load29 = load <8 x i16>, ptr %i.bd, align 2, !alias.scope !702 ; 2 uses
  %i.be = zext <8 x i16> %wide.load29 to <8 x i32>
  %i.bf = or <8 x i32> %vec.phi27, %i.be          ; 2 uses
  %i.bg = trunc <8 x i16> %wide.load29 to <8 x i8>
  store <8 x i8> %i.bg, ptr %next.gep28, align 1, !alias.scope !703, !noalias !702
  %index.next30 = add nuw i64 %index26, 8         ; 2 uses
  %i.bh = icmp eq i64 %index.next30, %n.vec25
  br i1 %i.bh, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !699
...
.preheader.i.i.prol:                              ; preds = %.preheader.i.i.preheader, %.preheader.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.preheader.i.i.prol.loopexit, label %.preheader.i.i.prol, !llvm.loop !700
...
.preheader.i.i:                                   ; preds = %.preheader.i.i.prol.loopexit, %.preheader.i.i
  ...
  br i1 %exitcond.not.i.i.3, label %.loopexit, label %.preheader.i.i, !llvm.loop !701
...
.loopexit.i:                                      ; preds = %_ZN7simdutf8westmere12_GLOBAL__N_128convert_masked_utf8_to_utf32EPKcmRPDi.exit.i, %bb.c, %bb.b
  ...
  br i1 %.not.i, label %_ZN7simdutf8westmere12_GLOBAL__N_113utf8_to_utf3213convert_validEPKcmPDi.exit, label %.lr.ph93.i, !llvm.loop !1114
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i16>, ptr %i.ab, align 2, !alias.scope !1121 ; 2 uses
  %wide.load51 = load <4 x i16>, ptr %i.ac, align 2, !alias.scope !1121 ; 2 uses
  ...
  store <4 x i8> %i.ah, ptr %next.gep, align 1, !alias.scope !1122, !noalias !1121
  store <4 x i8> %i.ai, ptr %i.aj, align 1, !alias.scope !1122, !noalias !1121
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ak = icmp eq i64 %index.next, %n.vec
  br i1 %i.ak, label %middle.block, label %vector.body, !llvm.loop !1118
...
.preheader.i.prol:                                ; preds = %.preheader.i.preheader53, %.preheader.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.preheader.i.prol.loopexit, label %.preheader.i.prol, !llvm.loop !1119
...
.preheader.i:                                     ; preds = %.preheader.i.prol.loopexit, %.preheader.i
  ...
  br i1 %exitcond.not.i.3, label %.loopexit, label %.preheader.i, !llvm.loop !1120
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i16>, ptr %i.ad, align 2, !alias.scope !1129
  %wide.load51 = load <4 x i16>, ptr %i.ae, align 2, !alias.scope !1129
  ...
  store <4 x i8> %i.al, ptr %next.gep, align 1, !alias.scope !1130, !noalias !1129
  store <4 x i8> %i.am, ptr %i.an, align 1, !alias.scope !1130, !noalias !1129
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ao = icmp eq i64 %index.next, %n.vec
  br i1 %i.ao, label %middle.block, label %vector.body, !llvm.loop !1126
...
.preheader.i.prol:                                ; preds = %.preheader.i.preheader53, %.preheader.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.preheader.i.prol.loopexit, label %.preheader.i.prol, !llvm.loop !1127
...
.preheader.i:                                     ; preds = %.preheader.i.prol.loopexit, %.preheader.i
  ...
  br i1 %exitcond.not.i.3, label %.loopexit, label %.preheader.i, !llvm.loop !1128
...
.lr.ph.i:                                         ; preds = %bb.a, %.critedge.i
  ...
  %i.f = load <2 x i64>, ptr %.03255.i, align 1, !noalias !1134 ; 2 uses
  %i.g = tail call noundef i32 @llvm.x86.sse41.ptestz(<2 x i64> %i.f, <2 x i64> splat (i64 -71777214294589696))
  %.not.i = icmp eq i32 %i.g, 0
...
bb.b:                                             ; preds = %.lr.ph.i
  ...
  store i64 %i.l, ptr %.054.i, align 1, !noalias !1134
  br label %.critedge.i

.preheader.1.i:                                   ; preds = %.preheader.preheader.i
  %i.m = trunc nuw i16 %i.h to i8
  store i8 %i.m, ptr %.054.i, align 1, !noalias !1134
  %i.n = getelementptr inbounds nuw i8, ptr %.03255.i, i64 2
  %i.o = load i16, ptr %i.n, align 2, !noalias !1134 ; 2 uses
...
.preheader.2.i:                                   ; preds = %.preheader.1.i
  ...
  store i8 %i.r, ptr %i.q, align 1, !noalias !1134
  %i.s = getelementptr inbounds nuw i8, ptr %.03255.i, i64 4
  %i.t = load i16, ptr %i.s, align 2, !noalias !1134 ; 2 uses
...
.preheader.3.i:                                   ; preds = %.preheader.2.i
  ...
  store i8 %i.w, ptr %i.v, align 1, !noalias !1134
  %i.x = getelementptr inbounds nuw i8, ptr %.03255.i, i64 6
  %i.y = load i16, ptr %i.x, align 2, !noalias !1134 ; 2 uses
...
.preheader.4.i:                                   ; preds = %.preheader.3.i
  ...
  store i8 %i.ab, ptr %i.aa, align 1, !noalias !1134
  %i.ac = getelementptr inbounds nuw i8, ptr %.03255.i, i64 8
  %i.ad = load i16, ptr %i.ac, align 2, !noalias !1134 ; 2 uses
...
.preheader.5.i:                                   ; preds = %.preheader.4.i
  ...
  store i8 %i.ag, ptr %i.af, align 1, !noalias !1134
  %i.ah = getelementptr inbounds nuw i8, ptr %.03255.i, i64 10
  %i.ai = load i16, ptr %i.ah, align 2, !noalias !1134 ; 2 uses
...
.preheader.6.i:                                   ; preds = %.preheader.5.i
  ...
  store i8 %i.al, ptr %i.ak, align 1, !noalias !1134
  %i.am = getelementptr inbounds nuw i8, ptr %.03255.i, i64 12
  %i.an = load i16, ptr %i.am, align 2, !noalias !1134 ; 2 uses
...
.preheader.7.i:                                   ; preds = %.preheader.6.i
  ...
  store i8 %i.aq, ptr %i.ap, align 1, !noalias !1134
  %i.ar = getelementptr inbounds nuw i8, ptr %.03255.i, i64 14
  %i.as = load i16, ptr %i.ar, align 2, !noalias !1134 ; 2 uses
...
.critedge.loopexit.i:                             ; preds = %.preheader.7.i
  ...
  store i8 %i.av, ptr %i.au, align 1, !noalias !1134
  br label %.critedge.i
...
.critedge.i:                                      ; preds = %.critedge.loopexit.i, %bb.b
  ...
  br i1 %i.ay, label %.lr.ph.i, label %.loopexit, !llvm.loop !1133
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 8
  %wide.load = load <4 x i16>, ptr %i.ad, align 2, !alias.scope !1145
  %wide.load17 = load <4 x i16>, ptr %i.ae, align 2, !alias.scope !1145
  %i.af = tail call <4 x i16> @llvm.bswap.v4i16(<4 x i16> %wide.load) ; 2 uses
  ...
  %i.am = trunc <4 x i16> %i.ag to <4 x i8>
  %i.an = getelementptr i8, ptr %next.gep, i64 4
  store <4 x i8> %i.al, ptr %next.gep, align 1, !alias.scope !1146, !noalias !1145
  store <4 x i8> %i.am, ptr %i.an, align 1, !alias.scope !1146, !noalias !1145
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ao = icmp eq i64 %index.next, %n.vec
  br i1 %i.ao, label %middle.block, label %vector.body, !llvm.loop !1142
...
.preheader.i.i.prol:                              ; preds = %.preheader.i.i.preheader19, %.preheader.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.preheader.i.i.prol.loopexit, label %.preheader.i.i.prol, !llvm.loop !1143
...
.preheader.i.i:                                   ; preds = %.preheader.i.i.prol.loopexit, %.preheader.i.i
  ...
  br i1 %exitcond.not.i.i.3, label %.loopexit, label %.preheader.i.i, !llvm.loop !1144
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 8
  %wide.load = load <4 x i16>, ptr %i.ab, align 2, !alias.scope !1153 ; 2 uses
  %wide.load17 = load <4 x i16>, ptr %i.ac, align 2, !alias.scope !1153 ; 2 uses
  %i.ad = zext <4 x i16> %wide.load to <4 x i32>
  ...
  %i.aj = getelementptr i8, ptr %next.gep, i64 4
  store <4 x i8> %i.ah, ptr %next.gep, align 1, !alias.scope !1154, !noalias !1153
  store <4 x i8> %i.ai, ptr %i.aj, align 1, !alias.scope !1154, !noalias !1153
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.ak = icmp eq i64 %index.next, %n.vec
  br i1 %i.ak, label %middle.block, label %vector.body, !llvm.loop !1150
...
.preheader.i.i.prol:                              ; preds = %.preheader.i.i.preheader19, %.preheader.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.preheader.i.i.prol.loopexit, label %.preheader.i.i.prol, !llvm.loop !1151
...
.preheader.i.i:                                   ; preds = %.preheader.i.i.prol.loopexit, %.preheader.i.i
  ...
  br i1 %exitcond.not.i.i.3, label %.loopexit, label %.preheader.i.i, !llvm.loop !1152
