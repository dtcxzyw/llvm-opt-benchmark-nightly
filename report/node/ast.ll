...
bb.b:                                             ; preds = %.lr.ph, %_ZN2v88internal31ObjectLiteralBoilerplateBuilder32InitFlagsForPendingNullPrototypeEi.exit
  ...
  %.02986 = phi i8 [ 0, %.lr.ph ], [ %.231, %_ZN2v88internal31ObjectLiteralBoilerplateBuilder32InitFlagsForPendingNullPrototypeEi.exit ] ; 7 uses
...
_ZN2v88internal19MaterializedLiteral26NeedsInitialAllocationSiteEv.exit: ; preds = %_ZN2v88internal25LiteralBoilerplateBuilder17InitDepthAndFlagsEPNS0_19MaterializedLiteralE.exit, %.sink.split.i
  %.0.i = phi i1 [ false, %_ZN2v88internal25LiteralBoilerplateBuilder17InitDepthAndFlagsEPNS0_19MaterializedLiteralE.exit ], [ %2, %.sink.split.i ]
  %3 = trunc nuw i8 %.02986 to i1
  %4 = or i1 %.0.i, %3
  %5 = zext i1 %4 to i8
...
bb.l:                                             ; preds = %_ZN2v88internal19MaterializedLiteral26NeedsInitialAllocationSiteEv.exit, %bb.g
  ...
  %.130 = phi i8 [ %5, %_ZN2v88internal19MaterializedLiteral26NeedsInitialAllocationSiteEv.exit ], [ %.02986, %bb.g ]
  %i.bd = load i64, ptr %i.n, align 8
  %i.be = and i64 %i.bd, -2
  %i.bf = inttoptr i64 %i.be to ptr               ; 4 uses
  %i.bg = and i8 %.pre-phi, 63                    ; 3 uses
  %i.bh = icmp eq i8 %i.bg, 45
  br i1 %i.bh, label %_ZN2v88internal10Expression18IsCompileTimeValueEv.exit, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.bi = add nsw i8 %i.bg, -27
  %switch.i.i = icmp ult i8 %i.bi, -3
  br i1 %switch.i.i, label %_ZN2v88internal10Expression18IsCompileTimeValueEv.exit, label %bb.n

bb.n:                                             ; preds = %bb.m
  switch i8 %i.bg, label %_ZN2v88internal10Expression18IsCompileTimeValueEv.exit [
...
.sink.split.i.i:                                  ; preds = %bb.o, %bb.n
  ...
  %i.bj = getelementptr inbounds nuw i8, ptr %i.bc, i64 %.sink4.i.i
...
_ZN2v88internal10Expression18IsCompileTimeValueEv.exit: ; preds = %bb.l, %bb.m, %bb.n, %.sink.split.i.i
  %.1.i = phi i1 [ true, %bb.l ], [ false, %bb.m ], [ false, %bb.n ], [ %i.bm, %.sink.split.i.i ]
  %i.bn = trunc nuw i8 %.088 to i1
  %i.bo = and i1 %.1.i, %i.bn
  %i.bp = zext i1 %i.bo to i8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #16
  store i32 0, ptr %i.a, align 4
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bf, i64 4
...
_ZNK2v88internal7Literal8ToUint32EPj.exit.i:      ; preds = %_ZN2v88internal10Expression18IsCompileTimeValueEv.exit
  ...
  %i.ch = call noundef zeroext i1 @_ZNK2v88internal12AstRawString12AsArrayIndexEPj(ptr noundef nonnull align 8 dereferenceable(32) %i.cg, ptr noundef nonnull %i.a) #16
...
_ZN2v88internal31ObjectLiteralBoilerplateBuilder32InitFlagsForPendingNullPrototypeEi.exit: ; preds = %bb.c, %_ZNK2v88internal7Literal12AsArrayIndexEPj.exit.thread, %_ZNK2v88internal21ObjectLiteralProperty15IsNullPrototypeEv.exit
  ...
  %.1 = phi i8 [ %.088, %bb.c ], [ 0, %_ZNK2v88internal21ObjectLiteralProperty15IsNullPrototypeEv.exit ], [ %i.bp, %_ZNK2v88internal7Literal12AsArrayIndexEPj.exit.thread ] ; 2 uses
...
_ZN2v88internal31ObjectLiteralBoilerplateBuilder32InitFlagsForPendingNullPrototypeEi.exit.thread: ; preds = %_ZNK2v88internal21ObjectLiteralProperty15IsNullPrototypeEv.exit.thread.i, %_ZN2v88internal31ObjectLiteralBoilerplateBuilder32InitFlagsForPendingNullPrototypeEi.exit.thread.loopexit93, %.preheader, %bb.f, %bb.e
  ...
  %.2 = phi i32 [ %i.cs, %_ZN2v88internal31ObjectLiteralBoilerplateBuilder32InitFlagsForPendingNullPrototypeEi.exit.thread.loopexit93 ], [ 0, %bb.e ], [ 0, %bb.f ], [ 8, %.preheader ], [ 0, %_ZNK2v88internal21ObjectLiteralProperty15IsNullPrototypeEv.exit.thread.i ]
  %.04076.fr = freeze i32 %.04076                 ; 2 uses
  %i.ct = load i32, ptr %0, align 8
  %i.cu = and i32 %i.ct, -656
  %.032.masked = and i32 %.03274, -653
  %i.cv = zext nneg i8 %.02972 to i32
  %i.cw = shl nuw nsw i32 %i.cv, 2
  %.not66 = icmp eq i32 %.04076.fr, 0
  %.masked114 = and i32 %i.cw, 380
  %spec.select = select i1 %.not66, i32 0, i32 128
  %i.cx = icmp ult i32 %.05078, 33
  %i.cy = shl i32 %.04076.fr, 1
  %i.cz = icmp uge i32 %i.cy, %.05078
  %i.da = or i1 %i.cx, %i.cz
  %i.db = select i1 %i.da, i32 512, i32 0
  %.masked113 = or disjoint i32 %spec.select, %.032.masked
  %.masked = or i32 %.masked113, %.2
  %i.dc = or disjoint i32 %.masked, %i.db
  %i.dd = or i32 %i.dc, %.masked114
  %i.de = or i32 %i.dd, %i.cu
  store i32 %i.de, ptr %0, align 8
  br label %bb.q
