...
$_ZN2v88internal11FactoryBaseINS0_7FactoryEE26NewProtectedWeakFixedArrayEi = comdat any
end_hunk_0
begin_hunk_1_@_ZN2v88internal11FactoryBaseINS0_7FactoryEE16AllocateRawArrayEiNS0_14AllocationTypeENS0_14AllocationHintENS0_19AllocationAlignmentE:bb.a
...
define linkonce_odr hidden ptr @_ZN2v88internal14WeakFixedArray3NewINS0_7IsolateEEENS0_6HandleIS1_EEPT_iNS0_14AllocationTypeENS0_17MaybeDirectHandleINS0_6ObjectEEE(ptr noundef %0, i32 noundef %1, i8 noundef zeroext %2, ptr %3) local_unnamed_addr #5 comdat align 2 {
  %5 = icmp ult i32 %1, 134217729
  br i1 %5, label %7, label %6, !prof !9

6:                                                ; preds = %4
  tail call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str, ptr noundef nonnull @.str.23) #17
  unreachable
...
11:                                               ; preds = %7
  ...
  %14 = tail call i64 @_ZN2v88internal7Factory11AllocateRawEiNS0_14AllocationTypeENS0_19AllocationAlignmentENS0_14AllocationHintE(ptr noundef nonnull align 1 dereferenceable(1) %0, i32 noundef %13, i8 noundef zeroext %2, i8 noundef zeroext 0, i8 0) #15 ; 3 uses
  %15 = icmp eq i8 %2, 2
...
45:                                               ; preds = %_ZN2v88internal11FactoryBaseINS0_7FactoryEE16AllocateRawArrayEiNS0_14AllocationTypeENS0_14AllocationHintENS0_19AllocationAlignmentE.exit.i
  %46 = tail call noundef ptr @_ZN2v88internal11HandleScope6ExtendEPNS0_7IsolateE(ptr noundef nonnull %0) #15
...
_ZN2v88internal15TaggedArrayBaseINS0_14WeakFixedArrayENS0_19WeakFixedArrayShapeENS0_16HeapObjectLayoutEE8AllocateINS0_7IsolateEEENS0_6HandleIS2_EEPT_iPSt8optionalINS0_25PerThreadAssertScopeEmptyILb0EJLNS0_19PerThreadAssertTypeE1ELSE_2EEEEENS0_14AllocationTypeENS0_14AllocationHintE.exit: ; preds = %_ZN2v88internal11FactoryBaseINS0_7FactoryEE16AllocateRawArrayEiNS0_14AllocationTypeENS0_14AllocationHintENS0_19AllocationAlignmentE.exit.i, %45
  ...
  %53 = tail call { i64, ptr } asm sideeffect "cld;rep ; stosq", "=&{cx},=&{di},{ax},0,1,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(i64 %.sroa.014.0, i64 %38, ptr nonnull %50) #15, !srcloc !10 ; 0 uses
  br label %54
