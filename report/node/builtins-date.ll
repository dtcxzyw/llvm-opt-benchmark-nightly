...
bb.p:                                             ; preds = %.critedge90.i
  ...
  %4 = sdiv i32 %i.eq, 1000
  %i.es = sdiv i32 %i.eq, 60000
  %5 = insertelement <2 x i32> poison, i32 %i.es, i64 0
  ...
  %.0.i121.i = select i1 %i.be, double %.sroa.0153.0.i, double %9
  %10 = extractelement <2 x double> %8, i64 1
  %.0.i122.i = select i1 %.sroa.4151.1.i, double %.sroa.0150.1.i, double %10
...
bb.f:                                             ; preds = %.critedge.i
  ...
  %i.bk = sdiv i32 %i.bi, 1000
  %4 = sdiv i32 %i.bi, 60000
  %5 = insertelement <2 x i32> poison, i32 %4, i64 0
  %6 = insertelement <2 x i32> %5, i32 %i.bk, i64 1
  %7 = srem <2 x i32> %6, splat (i32 60)
  %i.bl = sitofp i32 %i.bg to double
  %i.bm = sitofp i32 %i.bj to double
  %8 = sitofp <2 x i32> %7 to <2 x double>        ; 2 uses
...
_ZN2v88internal6Object11NumberValueENS0_6TaggedIS1_EE.exit.i: ; preds = %bb.h, %bb.g
  ...
  %9 = extractelement <2 x double> %8, i64 0
  %10 = extractelement <2 x double> %8, i64 1
  %i.bx = tail call noundef double @_ZN2v88internal8MakeTimeEdddd(double noundef %i.bm, double noundef %9, double noundef %10, double noundef %i.bw) #11
  %i.by = tail call noundef double @_ZN2v88internal8MakeDateEdd(double noundef %i.bl, double noundef %i.bx) #11
...
bb.p:                                             ; preds = %.critedge88.i
  ...
  %4 = sdiv i32 %i.el, 1000
  %i.en = sdiv i32 %i.el, 60000
  %5 = insertelement <2 x i32> poison, i32 %i.en, i64 0
  %6 = insertelement <2 x i32> %5, i32 %4, i64 1
  %7 = srem <2 x i32> %6, splat (i32 60)
  %8 = sitofp <2 x i32> %7 to <2 x double>        ; 2 uses
  %9 = extractelement <2 x double> %8, i64 0
  %.0.i119.i = select i1 %i.be, double %.sroa.0151.0.i, double %9
  %10 = extractelement <2 x double> %8, i64 1
  %.0.i120.i = select i1 %.sroa.4149.1.i, double %.sroa.0148.1.i, double %10
...
bb.f:                                             ; preds = %.critedge.i
  ...
  %i.bf = sdiv i32 %i.bd, 1000
  %4 = sdiv i32 %i.bd, 60000
  %5 = insertelement <2 x i32> poison, i32 %4, i64 0
  %6 = insertelement <2 x i32> %5, i32 %i.bf, i64 1
  %7 = srem <2 x i32> %6, splat (i32 60)
  %i.bg = sitofp i32 %i.bb to double
  %i.bh = sitofp i32 %i.be to double
  %8 = sitofp <2 x i32> %7 to <2 x double>        ; 2 uses
...
_ZN2v88internal6Object11NumberValueENS0_6TaggedIS1_EE.exit.i: ; preds = %bb.h, %bb.g
  ...
  %9 = extractelement <2 x double> %8, i64 0
  %10 = extractelement <2 x double> %8, i64 1
  %i.bs = tail call noundef double @_ZN2v88internal8MakeTimeEdddd(double noundef %i.bh, double noundef %9, double noundef %10, double noundef %i.br) #11
  %i.bt = tail call noundef double @_ZN2v88internal8MakeDateEdd(double noundef %i.bg, double noundef %i.bs) #11
