Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/node/original/mul-fft?download=true
...
begin_hunk_0_@_ZN2v86bigint13ProcessorImpl11MultiplyFFTENS0_8RWDigitsENS0_6DigitsES3_:bb.a
  ...
  br i1 %or.cond33.i, label %.lr.ph.preheader.i24, label %.critedge.preheader.thread.i

.lr.ph.preheader.i24:                             ; preds = %.lr.ph42.i
  %i.gw = zext i32 %.02240.i to i64
  %i.gx = load ptr, ptr %i.es, align 8
  %i.gy = zext i32 %i.gt to i64
  br label %.lr.ph.i25

.critedge.preheader.i:                            ; preds = %.lr.ph.i25
  %i.gz = icmp eq i128 %i.hi, 0
  br i1 %i.gz, label %.critedge.preheader.thread.i, label %bb.m

.lr.ph.i25:                                       ; preds = %.lr.ph.i25, %.lr.ph.preheader.i24
  %indvars.iv48.i = phi i64 [ %i.gw, %.lr.ph.preheader.i24 ], [ %indvars.iv.next49.i, %.lr.ph.i25 ] ; 2 uses
  %indvars.iv.i26 = phi i64 [ 0, %.lr.ph.preheader.i24 ], [ %indvars.iv.next.i27, %.lr.ph.i25 ] ; 2 uses
  %.03234.i = phi i64 [ 0, %.lr.ph.preheader.i24 ], [ %i.hj, %.lr.ph.i25 ]
  %i.ha = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv48.i ; 2 uses
  %.0.copyload.i.i = load i64, ptr %i.ha, align 4
  %i.hb = getelementptr inbounds nuw [8 x i8], ptr %i.gx, i64 %indvars.iv.i26
  ...
  %i.hl = icmp samesign ult i64 %indvars.iv.next.i27, %i.gy
  %i.hm = icmp samesign ult i64 %indvars.iv.next49.i, %i.gj
  %or.cond.i = select i1 %i.hl, i1 %i.hm, i1 false
  br i1 %or.cond.i, label %.lr.ph.i25, label %.critedge.preheader.i, !llvm.loop !11

bb.m:                                             ; preds = %.critedge.preheader.i
...
.critedge.preheader.thread.i:                     ; preds = %bb.m, %.critedge.preheader.i, %.lr.ph42.i
...
_ZN2v86bigint12_GLOBAL__N_112FFTContainer21NormalizeAndRecombineEiiNS0_8RWDigitsEj.exit: ; preds = %.critedge.preheader.thread.i, %bb.l, %bb.k
  %i.hs = load ptr, ptr %i.dh, align 8            ; 2 uses
  %i.ht = icmp eq ptr %i.hs, null
  br i1 %i.ht, label %bb.o, label %bb.n

bb.n:                                             ; preds = %_ZN2v86bigint12_GLOBAL__N_112FFTContainer21NormalizeAndRecombineEiiNS0_8RWDigitsEj.exit
  call void @_ZdaPv(ptr noundef nonnull %i.hs) #13
  br label %bb.o

bb.o:                                             ; preds = %bb.n, %_ZN2v86bigint12_GLOBAL__N_112FFTContainer21NormalizeAndRecombineEiiNS0_8RWDigitsEj.exit
  %i.hu = load ptr, ptr %i.dl, align 8            ; 2 uses
  %i.hv = icmp eq ptr %i.hu, null
  br i1 %i.hv, label %bb.q, label %bb.p
...
bb.q:                                             ; preds = %bb.p, %bb.o
  ...
  br i1 %i.hx, label %_ZN2v86bigint12_GLOBAL__N_112FFTContainerD2Ev.exit28, label %bb.r

bb.r:                                             ; preds = %bb.q
  call void @_ZdaPv(ptr noundef nonnull %i.hw) #13
  br label %_ZN2v86bigint12_GLOBAL__N_112FFTContainerD2Ev.exit28

_ZN2v86bigint12_GLOBAL__N_112FFTContainerD2Ev.exit28: ; preds = %bb.q, %bb.r
...
bb.a:
  %2 = alloca %"class.v8::bigint::(anonymous namespace)::FFTContainer", align 8 ; 15 uses
...
.lr.ph:                                           ; preds = %bb.c
  ...
  %i.ah = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 8 uses
  %i.ai = add nuw nsw i32 %.sroa.5.0, 1           ; 5 uses
  ...
  %i.ao = getelementptr inbounds nuw i8, ptr %2, i64 32 ; 8 uses
  %.not.i.i = icmp eq i32 %.sroa.819.0, 0         ; 2 uses
  %wide.trip.count.i.i = zext nneg i32 %.sroa.819.0 to i64 ; 5 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %2, i64 40 ; 5 uses
  ...
  %i.au = shl nuw nsw i64 %wide.trip.count.i.i, 3
  %i.av = getelementptr inbounds nuw i8, ptr %3, i64 32
  %i.aw = zext nneg i32 %i.ai to i64              ; 9 uses
  %i.ax = shl nuw nsw i32 %i.ai, 4
  %i.ay = zext nneg i32 %i.ax to i64
  %i.az = getelementptr inbounds nuw i8, ptr %3, i64 40
  %i.ba = zext i32 %i.ab to i64
  %i.bb = shl nuw nsw i64 %i.ba, 3
  %i.bc = shl nuw nsw i32 %.sroa.12.0, 1          ; 2 uses
  %i.bd = zext nneg i32 %i.bc to i64
  %i.be = or disjoint i32 %i.bc, 1                ; 2 uses
  %i.bf = zext nneg i32 %i.be to i64
  %wide.trip.count = zext i32 %i.a to i64
  %xtraiter = and i64 %wide.trip.count.i.i, 3     ; 3 uses
  %i.bg = icmp samesign ult i32 %.sroa.819.0, 4
  %unroll_iter = and i64 %wide.trip.count.i.i, 2147483644
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod86 = icmp ne i64 %xtraiter, 0
  %xtraiter87 = and i64 %wide.trip.count.i.i, 7   ; 3 uses
  %i.bh = icmp samesign ult i32 %.sroa.819.0, 8
  %unroll_iter91 = and i64 %wide.trip.count.i.i, 2147483640
...
bb.d:                                             ; preds = %.lr.ph, %bb.r
  ...
  %i.bl = load i32, ptr %i.d, align 8             ; 4 uses
  ...
  %i.bp = load ptr, ptr %i.ae, align 8            ; 4 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  store ptr %i.bp, ptr %i.aj, align 8
  %i.bq = call noalias noundef nonnull ptr @_Znam(i64 noundef %i.am) #12, !inline_history !16
  store ptr %i.bq, ptr %i.an, align 8
  %i.br = load i32, ptr %2, align 8
  %i.bs = zext i32 %i.br to i64
  %i.bt = shl nuw nsw i64 %i.bs, 3
  %i.bu = call noalias noundef nonnull ptr @_Znam(i64 noundef %i.bt) #12, !inline_history !16
  store ptr %i.bu, ptr %i.ao, align 8
  br i1 %.not.i.i, label %.._crit_edge_crit_edge.i.i, label %.lr.ph.preheader.i.i

.._crit_edge_crit_edge.i.i:                       ; preds = %bb.e
  %.pre.i.i = load i32, ptr %i.ah, align 8
  br label %_ZN2v86bigint12_GLOBAL__N_112FFTContainerC2EjjPNS0_13ProcessorImplE.exit.i

.lr.ph.preheader.i.i:                             ; preds = %bb.e
  %i.bv = load ptr, ptr %i.an, align 8            ; 2 uses
  br i1 %i.bg, label %.lr.ph.i.i.epil.preheader, label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.preheader.i.i, %.lr.ph.i.i
  %indvars.iv.i.i = phi i64 [ %indvars.iv.next.i.i.3, %.lr.ph.i.i ], [ 0, %.lr.ph.preheader.i.i ] ; 5 uses
  %.01011.i.i = phi ptr [ %i.cs, %.lr.ph.i.i ], [ %i.bv, %.lr.ph.preheader.i.i ] ; 2 uses
  %niter = phi i64 [ %niter.next.3, %.lr.ph.i.i ], [ 0, %.lr.ph.preheader.i.i ]
  %i.bw = load ptr, ptr %i.ao, align 8
  %i.bx = getelementptr inbounds nuw [8 x i8], ptr %i.bw, i64 %indvars.iv.i.i
  store ptr %.01011.i.i, ptr %i.bx, align 8
  %i.by = load i32, ptr %i.ah, align 8
  %i.bz = zext i32 %i.by to i64
  %i.ca = getelementptr inbounds nuw [8 x i8], ptr %.01011.i.i, i64 %i.bz ; 2 uses
  %i.cb = load ptr, ptr %i.ao, align 8
  %i.cc = getelementptr inbounds nuw [8 x i8], ptr %i.cb, i64 %indvars.iv.i.i
  %i.cd = getelementptr inbounds nuw i8, ptr %i.cc, i64 8
  store ptr %i.ca, ptr %i.cd, align 8
  %i.ce = load i32, ptr %i.ah, align 8
  %i.cf = zext i32 %i.ce to i64
  %i.cg = getelementptr inbounds nuw [8 x i8], ptr %i.ca, i64 %i.cf ; 2 uses
  %i.ch = load ptr, ptr %i.ao, align 8
  %i.ci = getelementptr inbounds nuw [8 x i8], ptr %i.ch, i64 %indvars.iv.i.i
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 16
  store ptr %i.cg, ptr %i.cj, align 8
  %i.ck = load i32, ptr %i.ah, align 8
