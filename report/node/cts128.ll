...
.lr.ph.preheader:                                 ; preds = %iter.check, %vec.epilog.middle.block
  ...
  %7 = add nuw nsw i64 %spec.store.select, 15
  %8 = sub nsw i64 %7, %.152.ph
...
define dso_local range(i64 17, 1) i64 @CRYPTO_cts128_decrypt(ptr noundef %0, ptr noundef %1, i64 noundef %2, ptr noundef %3, ptr noundef %4, ptr noundef readonly captures(none) %5) local_unnamed_addr #0 {
bb.a:
