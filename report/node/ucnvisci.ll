...
bb.k:                                             ; preds = %bb.j, %bb.j
  %i.ax = icmp eq i8 %i.ab, -65                   ; 2 uses
  %2 = select i1 %i.ax, i16 2416, i16 2386
  %3 = select i1 %i.ax, i64 112, i64 82
  %i.ay = getelementptr inbounds nuw i8, ptr @_ZL13validityTable, i64 %3
