...
begin_hunk_1_@_ZN2v88internal10WasmScript19AddBreakpointToInfoENS0_12DirectHandleINS0_6ScriptEEEiNS2_INS0_10BreakPointEEE:bb.a
  ...
  br i1 %i.av, label %.lr.ph.i, label %.._crit_edge_crit_edge.i

.._crit_edge_crit_edge.i:                         ; preds = %_ZN2v88internal6Script25set_wasm_breakpoint_infosENS0_6TaggedINS0_10FixedArrayEEENS0_16WriteBarrierModeE.exit
  %.phi.trans.insert.i = getelementptr inbounds nuw i8, ptr %i.b, i64 648
...
.lr.ph.i:                                         ; preds = %_ZN2v88internal6Script25set_wasm_breakpoint_infosENS0_6TaggedINS0_10FixedArrayEEENS0_16WriteBarrierModeE.exit
  ...
  %3 = load i64, ptr %i.ax, align 8               ; 2 uses
  br label %bb.i
...
._crit_edge.i:                                    ; preds = %_ZN2v88internal12_GLOBAL__N_116GetBreakpointPosEPNS0_7IsolateENS0_6TaggedINS0_6ObjectEEE.exit.i, %.._crit_edge_crit_edge.i
  %4 = phi i64 [ %.pre.i, %.._crit_edge_crit_edge.i ], [ %3, %_ZN2v88internal12_GLOBAL__N_116GetBreakpointPosEPNS0_7IsolateENS0_6TaggedINS0_6ObjectEEE.exit.i ] ; 3 uses
  %.0.lcssa.i = phi i32 [ 0, %.._crit_edge_crit_edge.i ], [ %.0..i, %_ZN2v88internal12_GLOBAL__N_116GetBreakpointPosEPNS0_7IsolateENS0_6TaggedINS0_6ObjectEEE.exit.i ] ; 2 uses
...
begin_hunk_5_@_ZN2v88internal10WasmScript19AddBreakpointToInfoENS0_12DirectHandleINS0_6ScriptEEEiNS2_INS0_10BreakPointEEE:bb.a
  ...
  %5 = getelementptr inbounds nuw i8, ptr %i.b, i64 648
...
begin_hunk_8_@_ZN2v88internal10WasmScript15ClearBreakPointENS0_12DirectHandleINS0_6ScriptEEEiNS2_INS0_10BreakPointEEE:bb.a
  ...
  br i1 %i.ad, label %.lr.ph.i, label %.._crit_edge_crit_edge.i

.._crit_edge_crit_edge.i:                         ; preds = %_ZN2v88internal6HandleINS0_10FixedArrayEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit
  %.phi.trans.insert.i = getelementptr inbounds nuw i8, ptr %i.q, i64 648
  %.pre.i = load i64, ptr %.phi.trans.insert.i, align 8
  br label %._crit_edge.i
...
._crit_edge.i:                                    ; preds = %_ZN2v88internal12_GLOBAL__N_116GetBreakpointPosEPNS0_7IsolateENS0_6TaggedINS0_6ObjectEEE.exit.i, %.._crit_edge_crit_edge.i
  %5 = phi i64 [ %.pre.i, %.._crit_edge_crit_edge.i ], [ %4, %_ZN2v88internal12_GLOBAL__N_116GetBreakpointPosEPNS0_7IsolateENS0_6TaggedINS0_6ObjectEEE.exit.i ]
  %.0.lcssa.i = phi i32 [ 0, %.._crit_edge_crit_edge.i ], [ %.0..i, %_ZN2v88internal12_GLOBAL__N_116GetBreakpointPosEPNS0_7IsolateENS0_6TaggedINS0_6ObjectEEE.exit.i ] ; 2 uses
...
.preheader.a:                                     ; preds = %_ZN2v88internal6HandleINS0_14BreakPointInfoEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit
  %6 = getelementptr inbounds nuw i8, ptr %i.q, i64 648 ; 2 uses
...
begin_hunk_14_@_ZN2v88internal10WasmScript16CheckBreakPointsEPNS0_7IsolateENS0_12DirectHandleINS0_6ScriptEEEiNS0_12StackFrameIdE:bb.a
  ...
  br i1 %i.ab, label %.lr.ph.i, label %.._crit_edge_crit_edge.i

.._crit_edge_crit_edge.i:                         ; preds = %_ZN2v88internal6HandleINS0_10FixedArrayEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit
  %.phi.trans.insert.i = getelementptr inbounds nuw i8, ptr %0, i64 648
  %.pre.i = load i64, ptr %.phi.trans.insert.i, align 8
  br label %._crit_edge.i
...
.lr.ph.i:                                         ; preds = %_ZN2v88internal6HandleINS0_10FixedArrayEEC2ENS0_6TaggedIS2_EEPNS0_7IsolateE.exit
  ...
  %4 = load i64, ptr %i.ad, align 8               ; 2 uses
  br label %bb.d
