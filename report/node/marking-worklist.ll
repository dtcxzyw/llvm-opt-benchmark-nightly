...
_ZNSt6vectorIN2v88internal19ContextWorklistPairESaIS2_EE7reserveEm.exit: ; preds = %bb.d, %_ZNSt12_Vector_baseIN2v88internal19ContextWorklistPairESaIS2_EE13_M_deallocateEPS2_m.exit.i
  ...
  %i.at = add i64 %i.as, 1
  %3 = insertelement <2 x i64> poison, i64 %i.j, i64 0
  %4 = insertelement <2 x i64> %3, i64 %i.at, i64 1
  ...
  %i.au = tail call double @llvm.ceil.f64(double %12)
  %i.av = fptoui double %i.au to i64
  %.sroa.speculated.i.i.i = tail call i64 @llvm.umax.i64(i64 %11, i64 %i.av)
