...
bb.a:
  %.sroa.05 = alloca %"struct.std::_Optional_payload.23", align 8 ; 6 uses
...
begin_hunk_1_@_ZN2v88internal14SegmentedTableINS0_4wasm25WasmCodePointerTableEntryELm134217728EE31TryAllocateAndInitializeSegmentEv:bb.a
  ...
  br i1 %.sroa.6.sroa.0.0.i, label %1, label %bb.j

1:                                                ; preds = %_ZN2v88internal14SegmentedTableINS0_4wasm25WasmCodePointerTableEntryELm134217728EE18TryAllocateSegmentEv.exit
...
bb.j:                                             ; preds = %_ZN2v88internal14SegmentedTableINS0_4wasm25WasmCodePointerTableEntryELm134217728EE18TryAllocateSegmentEv.exit.thread, %_ZN2v88internal14SegmentedTableINS0_4wasm25WasmCodePointerTableEntryELm134217728EE18TryAllocateSegmentEv.exit
  %.sroa.04.0.extract.trunc27 = phi i32 [ %i.j, %_ZN2v88internal14SegmentedTableINS0_4wasm25WasmCodePointerTableEntryELm134217728EE18TryAllocateSegmentEv.exit.thread ], [ %.sroa.07.0.i, %_ZN2v88internal14SegmentedTableINS0_4wasm25WasmCodePointerTableEntryELm134217728EE18TryAllocateSegmentEv.exit ] ; 2 uses
end_hunk_1
...
_ZN2v88internal14SegmentedTableINS0_4wasm25WasmCodePointerTableEntryELm134217728EE18InitializeFreeListENS4_7SegmentEj.exit: ; preds = %._crit_edge.i, %bb.m, %bb.n
  ...
  %.sroa.05.4..sroa_idx37 = getelementptr inbounds nuw i8, ptr %.sroa.05, i64 12
  store i8 1, ptr %.sroa.05.4..sroa_idx37, align 4
  %.sroa.05.0..sroa.05.0..sroa.05.0..sroa.05.0..fca.0.load.pre = load i64, ptr %.sroa.05, align 8
  br label %bb.o

bb.o:                                             ; preds = %_ZN2v88internal14SegmentedTableINS0_4wasm25WasmCodePointerTableEntryELm134217728EE18InitializeFreeListENS4_7SegmentEj.exit, %1
  %.sroa.05.0..sroa.05.0..sroa.05.0..fca.0.load = phi i64 [ %.sroa.05.0..sroa.05.0..sroa.05.0..sroa.05.0..fca.0.load.pre, %_ZN2v88internal14SegmentedTableINS0_4wasm25WasmCodePointerTableEntryELm134217728EE18InitializeFreeListENS4_7SegmentEj.exit ], [ undef, %1 ]
