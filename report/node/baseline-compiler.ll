begin_hunk_0
  ...
  %.sroa.0.0.copyload.i24 = load i8, ptr %i.l, align 1 ; 7 uses
...
begin_hunk_1
  ...
  %.pre = and i8 %.sroa.0.0.copyload.i24, 7       ; 4 uses
  switch i8 %.sroa.0.0.copyload.i24, label %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit20 [
    i8 12, label %bb.c
    i8 4, label %bb.c
    i8 13, label %bb.d
    i8 5, label %bb.d
...
bb.d:                                             ; preds = %_ZN2v88internal8baseline17BaselineAssembler20ScratchRegisterScopeC2EPS2_.exit, %_ZN2v88internal8baseline17BaselineAssembler20ScratchRegisterScopeC2EPS2_.exit
  %i.x = or disjoint i8 %.pre, 64
  br label %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit20

_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit20: ; preds = %bb.c, %_ZN2v88internal8baseline17BaselineAssembler20ScratchRegisterScopeC2EPS2_.exit, %bb.d
  %.sroa.476.0 = phi i8 [ %i.x, %bb.d ], [ %.pre, %_ZN2v88internal8baseline17BaselineAssembler20ScratchRegisterScopeC2EPS2_.exit ], [ %.pre, %bb.c ]
  %.sroa.677.1 = phi i64 [ 0, %bb.d ], [ 0, %_ZN2v88internal8baseline17BaselineAssembler20ScratchRegisterScopeC2EPS2_.exit ], [ %i.w, %bb.c ]
  %i.y = phi ptr [ inttoptr (i64 2 to ptr), %bb.d ], [ inttoptr (i64 1 to ptr), %_ZN2v88internal8baseline17BaselineAssembler20ScratchRegisterScopeC2EPS2_.exit ], [ inttoptr (i64 2 to ptr), %bb.c ]
...
begin_hunk_2
  ...
  %.pre67 = and i8 %.sroa.0.0.copyload.i24, 7     ; 4 uses
  switch i8 %.sroa.0.0.copyload.i24, label %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit [
    i8 12, label %bb.e
    i8 4, label %bb.e
    i8 13, label %bb.f
    i8 5, label %bb.f
...
bb.f:                                             ; preds = %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit20, %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit20
  %i.ad = or disjoint i8 %.pre67, 64
  br label %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit

_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit:   ; preds = %bb.e, %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit20, %bb.f
  %.sroa.6.1 = phi i64 [ 0, %bb.f ], [ 0, %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit20 ], [ %i.ac, %bb.e ]
  %.sroa.4.0 = phi i8 [ %i.ad, %bb.f ], [ %.pre67, %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit20 ], [ %.pre67, %bb.e ]
  %i.ae = phi ptr [ inttoptr (i64 2 to ptr), %bb.f ], [ inttoptr (i64 1 to ptr), %_ZN2v88internal7OperandC2ENS0_8RegisterEi.exit20 ], [ inttoptr (i64 2 to ptr), %bb.e ]
