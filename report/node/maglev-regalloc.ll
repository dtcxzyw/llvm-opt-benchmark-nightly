...
.lr.ph:                                           ; preds = %.lr.ph58
  ...
  br i1 %i.bi, label %.lr.ph.preheader._crit_edge, label %.lr.ph58, !llvm.loop !6
...
.lr.ph58:                                         ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.bz, label %.lr.ph, label %._crit_edge, !llvm.loop !6
...
._crit_edge:                                      ; preds = %.lr.ph58, %.lr.ph41
  ...
  br i1 %.not, label %.critedge, label %.lr.ph41, !llvm.loop !8
