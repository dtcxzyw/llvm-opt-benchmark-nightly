Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/node/original/maglev-regalloc?download=true
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not.i.i, label %bb.c, label %_ZN2v88internal10ZoneVectorIPNS0_6maglev4NodeEE14EnsureCapacityEm.exit.i, !prof !20
...
.lr.ph.preheader.i:                               ; preds = %_ZN2v88internal10ZoneVectorIPNS0_6maglev4NodeEE14EnsureCapacityEm.exit.i
  %i.ac = ptrtoaddr ptr %i.y to i64               ; 2 uses
  %i.ad = ptrtoaddr ptr %i.z to i64
  %i.ae = shl nuw nsw i64 %i.r, 3
  %2 = add nuw i64 %i.ae, %i.ad
  %i.af = add i64 %i.ac, 8
  %umax.i = tail call i64 @llvm.umax.i64(i64 %2, i64 %i.af)
  %i.ag = xor i64 %i.ac, -1
  %i.ah = add i64 %umax.i, %i.ag
  %i.ai = and i64 %i.ah, -8
  %i.aj = add i64 %i.ai, 8
  tail call void @llvm.memset.p0.i64(ptr align 8 %i.y, i8 0, i64 %i.aj, i1 false)
  %.pre44 = load ptr, ptr %i.l, align 8
...
_ZN2v88internal10ZoneVectorIPNS0_6maglev4NodeEE6resizeEm.exit: ; preds = %_ZN2v88internal10ZoneVectorIPNS0_6maglev4NodeEE14EnsureCapacityEm.exit.i, %.lr.ph.preheader.i
  %i.ak = phi ptr [ %i.z, %_ZN2v88internal10ZoneVectorIPNS0_6maglev4NodeEE14EnsureCapacityEm.exit.i ], [ %.pre44, %.lr.ph.preheader.i ]
  store ptr %i.aa, ptr %i.j, align 8
  %i.al = getelementptr inbounds i8, ptr %i.aa, i64 -8
  %i.am = sub nsw i64 0, %i.h
  %i.an = getelementptr inbounds [8 x i8], ptr %i.al, i64 %i.am ; 2 uses
  %.not37 = icmp ult ptr %i.an, %i.ak
  br i1 %.not37, label %.critedge, label %.lr.ph41.preheader

.lr.ph41.preheader:                               ; preds = %_ZN2v88internal10ZoneVectorIPNS0_6maglev4NodeEE6resizeEm.exit
  %i.ao = load ptr, ptr %i.a, align 8
  %i.ap = getelementptr inbounds i8, ptr %i.ao, i64 -16
  br label %.lr.ph41

.lr.ph41:                                         ; preds = %.lr.ph41.preheader, %._crit_edge
  %.040 = phi ptr [ %i.cb, %._crit_edge ], [ %i.an, %.lr.ph41.preheader ] ; 6 uses
  %.02239 = phi ptr [ %.1.lcssa, %._crit_edge ], [ %i.ap, %.lr.ph41.preheader ] ; 4 uses
  %.02438 = phi i64 [ %.125.lcssa, %._crit_edge ], [ %i.h, %.lr.ph41.preheader ] ; 3 uses
  %i.aq = load ptr, ptr %.040, align 8
  %i.ar = getelementptr inbounds nuw [8 x i8], ptr %.040, i64 %.02438
  store ptr %i.aq, ptr %i.ar, align 8
  %i.as = ptrtoint ptr %.040 to i64               ; 2 uses
  %i.at = load i64, ptr %.02239, align 8
  %i.au = load ptr, ptr %i.l, align 8             ; 2 uses
  %i.av = ptrtoint ptr %i.au to i64
  %i.aw = sub i64 %i.as, %i.av
  %i.ax = ashr exact i64 %i.aw, 3
  %i.ay = icmp eq i64 %i.at, %i.ax
  br i1 %i.ay, label %.lr.ph.preheader, label %._crit_edge

.lr.ph.preheader:                                 ; preds = %.lr.ph41
  %i.az = add i64 %.02438, -1                     ; 3 uses
  %i.ba = getelementptr inbounds nuw i8, ptr %.02239, i64 8
  %i.bb = load ptr, ptr %i.ba, align 8
  %i.bc = getelementptr inbounds nuw [8 x i8], ptr %.040, i64 %i.az
  store ptr %i.bb, ptr %i.bc, align 8
  %i.bd = icmp eq i64 %i.az, 0
  br i1 %i.bd, label %.lr.ph.preheader._crit_edge, label %.lr.ph58

.lr.ph:                                           ; preds = %.lr.ph58
  %i.be = add i64 %i.bs, -1                       ; 3 uses
  %i.bf = getelementptr inbounds i8, ptr %.13557, i64 -8
  %i.bg = load ptr, ptr %i.bf, align 8
  %i.bh = getelementptr inbounds nuw [8 x i8], ptr %.040, i64 %i.be
  store ptr %i.bg, ptr %i.bh, align 8
  %i.bi = icmp eq i64 %i.be, 0
  br i1 %i.bi, label %.lr.ph.preheader._crit_edge, label %.lr.ph58, !llvm.loop !27

.lr.ph.preheader._crit_edge:                      ; preds = %.lr.ph.preheader, %.lr.ph
  %i.bj = load ptr, ptr %i.c, align 8             ; 3 uses
  %i.bk = load ptr, ptr %i.a, align 8             ; 3 uses
  %i.bl = icmp ult ptr %i.bk, %i.bj
  br i1 %i.bl, label %.lr.ph.preheader.i29, label %_ZN2v88internal10ZoneVectorINS0_6maglev32StraightForwardRegisterAllocator10BlockPatchEE6resizeEm.exit

.lr.ph.preheader.i29:                             ; preds = %.lr.ph.preheader._crit_edge
  %i.bm = ptrtoaddr ptr %i.bk to i64              ; 2 uses
  %i.bn = ptrtoaddr ptr %i.bj to i64
  %3 = add i64 %i.bm, 16
  %umax.i30 = tail call i64 @llvm.umax.i64(i64 %i.bn, i64 %3)
  %i.bo = xor i64 %i.bm, -1
  %i.bp = add i64 %umax.i30, %i.bo
  %i.bq = and i64 %i.bp, -16
  %i.br = add i64 %i.bq, 16
  tail call void @llvm.memset.p0.i64(ptr align 8 %i.bk, i8 0, i64 %i.br, i1 false)
  br label %_ZN2v88internal10ZoneVectorINS0_6maglev32StraightForwardRegisterAllocator10BlockPatchEE6resizeEm.exit

_ZN2v88internal10ZoneVectorINS0_6maglev32StraightForwardRegisterAllocator10BlockPatchEE6resizeEm.exit: ; preds = %.lr.ph.preheader._crit_edge, %.lr.ph.preheader.i29
  store ptr %i.bj, ptr %i.a, align 8
  br label %bb.d

.lr.ph58:                                         ; preds = %.lr.ph.preheader, %.lr.ph
  %i.bs = phi i64 [ %i.be, %.lr.ph ], [ %i.az, %.lr.ph.preheader ] ; 2 uses
  %.13557 = phi ptr [ %i.bt, %.lr.ph ], [ %.02239, %.lr.ph.preheader ] ; 2 uses
  %i.bt = getelementptr inbounds i8, ptr %.13557, i64 -16 ; 3 uses
  %i.bu = load i64, ptr %i.bt, align 8
  %i.bv = load ptr, ptr %i.l, align 8             ; 2 uses
  %i.bw = ptrtoint ptr %i.bv to i64
  %i.bx = sub i64 %i.as, %i.bw
  %i.by = ashr exact i64 %i.bx, 3
  %i.bz = icmp eq i64 %i.bu, %i.by
  br i1 %i.bz, label %.lr.ph, label %._crit_edge, !llvm.loop !27

._crit_edge:                                      ; preds = %.lr.ph58, %.lr.ph41
  %i.ca = phi ptr [ %i.au, %.lr.ph41 ], [ %i.bv, %.lr.ph58 ]
  %.125.lcssa = phi i64 [ %.02438, %.lr.ph41 ], [ %i.bs, %.lr.ph58 ]
  %.1.lcssa = phi ptr [ %.02239, %.lr.ph41 ], [ %i.bt, %.lr.ph58 ]
  %i.cb = getelementptr inbounds i8, ptr %.040, i64 -8 ; 2 uses
  %.not = icmp ult ptr %i.cb, %i.ca
  br i1 %.not, label %.critedge, label %.lr.ph41, !llvm.loop !28
...
._crit_edge.thread:                               ; preds = %bb.b, %._crit_edge
  %.024.lcssa43 = phi i32 [ %.2, %._crit_edge ], [ %i.o, %bb.b ]
...
_ZN2v88internal6maglev5Graph48min_maglev_stackslots_for_unoptimized_frame_sizeEv.exit: ; preds = %._crit_edge.thread, %bb.c
  %.024.lcssa42 = phi i32 [ %.024.lcssa43, %._crit_edge.thread ], [ %.2, %bb.c ] ; 2 uses
  %.0.i = phi i32 [ %i.ab, %._crit_edge.thread ], [ %i.af, %bb.c ]
  %i.ag = add i32 %.024.lcssa42, %i.p
  %i.ah = tail call i32 @llvm.usub.sat.i32(i32 %.0.i, i32 %i.ag)
  %.023 = add i32 %i.ah, %i.p
  br label %bb.h

.lr.ph:                                           ; preds = %bb.b, %bb.g
  %.032 = phi ptr [ %i.au, %bb.g ], [ %i.x, %bb.b ] ; 2 uses
  %.02431 = phi i32 [ %.2, %bb.g ], [ %i.o, %bb.b ] ; 4 uses
  %i.ai = load ptr, ptr %.032, align 8            ; 4 uses
...
bb.g:                                             ; preds = %bb.d, %bb.e, %bb.f, %.lr.ph
  %.2 = phi i32 [ %.02431, %.lr.ph ], [ %i.at, %bb.f ], [ %.02431, %bb.e ], [ %.02431, %bb.d ] ; 3 uses
  %i.au = getelementptr inbounds nuw i8, ptr %.032, i64 8 ; 2 uses
...
bb.h:                                             ; preds = %_ZN2v88internal6maglev5Graph48min_maglev_stackslots_for_unoptimized_frame_sizeEv.exit, %bb.a
  %.3 = phi i32 [ %.024.lcssa42, %_ZN2v88internal6maglev5Graph48min_maglev_stackslots_for_unoptimized_frame_sizeEv.exit ], [ %i.o, %bb.a ]
  %.1 = phi i32 [ %.023, %_ZN2v88internal6maglev5Graph48min_maglev_stackslots_for_unoptimized_frame_sizeEv.exit ], [ %i.p, %bb.a ]
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8              ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 40
  %i.d = load ptr, ptr %i.c, align 8, !noalias !45 ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %i.b, i64 32
  %i.f = load ptr, ptr %i.e, align 8, !noalias !46 ; 2 uses
  %i.g = icmp eq ptr %i.d, %i.f
  br i1 %i.g, label %._crit_edge191, label %.lr.ph190
end_hunk_0
