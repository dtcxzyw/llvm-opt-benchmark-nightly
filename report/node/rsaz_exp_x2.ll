...
.lr.ph48.i:                                       ; preds = %.lr.ph48.i.prol.loopexit, %.lr.ph48.i
  ...
  br i1 %i.ic, label %.lr.ph48.i, label %._crit_edge.i119, !llvm.loop !16
...
.lr.ph.i33.i:                                     ; preds = %.lr.ph.i33.i.prol.loopexit, %.lr.ph.i33.i
  ...
  br i1 %i.ki, label %.lr.ph.i33.i, label %from_words52.exit, !llvm.loop !18
...
.lr.ph.i38.i:                                     ; preds = %.lr.ph.i38.i.prol.loopexit, %.lr.ph.i38.i
  ...
  br i1 %i.lq, label %.lr.ph.i38.i, label %from_words52.exit, !llvm.loop !18
...
.lr.ph48.i138:                                    ; preds = %.lr.ph48.i138.prol.loopexit, %.lr.ph48.i138
  ...
  br i1 %i.na, label %.lr.ph48.i138, label %._crit_edge.i123, !llvm.loop !16
...
.lr.ph.i33.i134.prol:                             ; preds = %.lr.ph.i.i133, %.lr.ph.i33.i134.prol
  ...
  br i1 %prol.iter238.cmp.not, label %.lr.ph.i33.i134.prol.loopexit, label %.lr.ph.i33.i134.prol, !llvm.loop !20
...
.lr.ph.i33.i134:                                  ; preds = %.lr.ph.i33.i134.prol.loopexit, %.lr.ph.i33.i134
  ...
  br i1 %i.pg, label %.lr.ph.i33.i134, label %from_words52.exit143, !llvm.loop !18
...
.lr.ph.i38.i129.prol:                             ; preds = %.lr.ph.i38.preheader.i128, %.lr.ph.i38.i129.prol
  ...
  br i1 %prol.iter235.cmp.not, label %.lr.ph.i38.i129.prol.loopexit, label %.lr.ph.i38.i129.prol, !llvm.loop !21
...
.lr.ph.i38.i129:                                  ; preds = %.lr.ph.i38.i129.prol.loopexit, %.lr.ph.i38.i129
  ...
  br i1 %i.qo, label %.lr.ph.i38.i129, label %from_words52.exit143, !llvm.loop !18
...
from_words52.exit143:                             ; preds = %.lr.ph.i38.i129.prol.loopexit, %.lr.ph.i38.i129, %.lr.ph.i33.i134.prol.loopexit, %.lr.ph.i33.i134, %bb.p, %bb.q
  ...
  %i.qs = sub i64 0, %i.qr
  %i.qt = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.qs) #8, !srcloc !29 ; 2 uses
  %i.qu = add i64 %i.qr, -1
  %i.qv = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.qu) #8, !srcloc !29 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.rg, label %middle.block, label %vector.body, !llvm.loop !22
...
.lr.ph.i.i146:                                    ; preds = %scalar.ph, %middle.block
  ...
  %i.rq = sub i64 0, %i.rp
  %i.rr = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.rq) #8, !srcloc !29 ; 2 uses
  %i.rs = add i64 %i.rp, -1
  %i.rt = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.rs) #8, !srcloc !29 ; 2 uses
...
vector.body208:                                   ; preds = %vector.body208, %vector.ph202
  ...
  br i1 %i.se, label %middle.block215, label %vector.body208, !llvm.loop !24
...
get_digit.exit44:                                 ; preds = %bb.e
  store i64 %i.ch, ptr %.0.lcssa, align 8, !tbaa !11
