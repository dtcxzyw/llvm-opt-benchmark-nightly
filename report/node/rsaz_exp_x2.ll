...
.lr.ph48.i:                                       ; preds = %.preheader.i, %.lr.ph48.i
  ...
  br i1 %i.hf, label %.lr.ph48.i, label %._crit_edge.i119, !llvm.loop !17
...
.lr.ph.i.i:                                       ; preds = %._crit_edge.i119
  %i.hh = load i64, ptr %.032.lcssa.i, align 8, !tbaa !11 ; 4 uses
...
.lr.ph.i33.i.prol:                                ; preds = %.lr.ph.i.i, %.lr.ph.i33.i.prol
  ...
  store i8 %i.ia, ptr %.056.i36.i.prol, align 1, !tbaa !13
  ...
  br i1 %prol.iter227.cmp.not, label %.lr.ph.i33.i.prol.loopexit, label %.lr.ph.i33.i.prol, !llvm.loop !18
...
.lr.ph.i33.i:                                     ; preds = %.lr.ph.i33.i.prol.loopexit, %.lr.ph.i33.i
  ...
  store i8 %i.if, ptr %.056.i36.i, align 1, !tbaa !13
  ...
  store i8 %i.ja, ptr %i.iy, align 1, !tbaa !13
  %i.jc = add nsw i32 %.047.i35.i, -8
  %i.jd = icmp sgt i32 %.047.i35.i, 8
  br i1 %i.jd, label %.lr.ph.i33.i, label %from_words52.exit, !llvm.loop !19
...
.lr.ph.i38.preheader.i:                           ; preds = %bb.o
  %i.jh = load i64, ptr %.032.lcssa.i, align 8, !tbaa !11 ; 2 uses
...
.lr.ph.i38.i.prol:                                ; preds = %.lr.ph.i38.preheader.i, %.lr.ph.i38.i.prol
  ...
  store i8 %i.ji, ptr %.056.i41.i.prol, align 1, !tbaa !13
...
.lr.ph.i38.i:                                     ; preds = %.lr.ph.i38.i.prol.loopexit, %.lr.ph.i38.i
  ...
  store i8 %i.jn, ptr %.056.i41.i, align 1, !tbaa !13
  ...
  store i8 %i.ki, ptr %i.kg, align 1, !tbaa !13
  %i.kk = add nsw i32 %.047.i40.i, -8
  %i.kl = icmp sgt i32 %.047.i40.i, 8
  br i1 %i.kl, label %.lr.ph.i38.i, label %from_words52.exit, !llvm.loop !19
...
.lr.ph.preheader.i142:                            ; preds = %from_words52.exit
  ...
  call void @llvm.memset.p0.i64(ptr align 8 %6, i8 0, i64 %i.kn, i1 false), !tbaa !11
...
.lr.ph48.i138:                                    ; preds = %.preheader.i122, %.lr.ph48.i138
  ...
  %i.ko = load i64, ptr %.03245.i141, align 8, !tbaa !11 ; 2 uses
  ...
  %i.ks = load i64, ptr %i.kr, align 8, !tbaa !11
  %i.kt = shl i64 %i.ks, 4
  ...
  br i1 %i.ky, label %.lr.ph48.i138, label %._crit_edge.i123, !llvm.loop !17
...
.lr.ph.i.i133:                                    ; preds = %._crit_edge.i123
  %i.la = load i64, ptr %.032.lcssa.i124, align 8, !tbaa !11 ; 4 uses
...
.lr.ph.i33.i134.prol:                             ; preds = %.lr.ph.i.i133, %.lr.ph.i33.i134.prol
  ...
  store i8 %i.lt, ptr %.056.i36.i137.prol, align 1, !tbaa !13
  ...
  br i1 %prol.iter233.cmp.not, label %.lr.ph.i33.i134.prol.loopexit, label %.lr.ph.i33.i134.prol, !llvm.loop !21
...
.lr.ph.i33.i134:                                  ; preds = %.lr.ph.i33.i134.prol.loopexit, %.lr.ph.i33.i134
  ...
  store i8 %i.ly, ptr %.056.i36.i137, align 1, !tbaa !13
...
.lr.ph.i38.preheader.i128:                        ; preds = %bb.q
  %i.na = load i64, ptr %.032.lcssa.i124, align 8, !tbaa !11 ; 2 uses
...
.lr.ph.i38.i129.prol:                             ; preds = %.lr.ph.i38.preheader.i128, %.lr.ph.i38.i129.prol
  ...
  store i8 %i.nb, ptr %.056.i41.i132.prol, align 1, !tbaa !13
  ...
  br i1 %prol.iter230.cmp.not, label %.lr.ph.i38.i129.prol.loopexit, label %.lr.ph.i38.i129.prol, !llvm.loop !22
...
.lr.ph.i38.i129:                                  ; preds = %.lr.ph.i38.i129.prol.loopexit, %.lr.ph.i38.i129
  ...
  store i8 %i.ng, ptr %.056.i41.i132, align 1, !tbaa !13
...
from_words52.exit143:                             ; preds = %.lr.ph.i38.i129.prol.loopexit, %.lr.ph.i38.i129, %.lr.ph.i33.i134.prol.loopexit, %.lr.ph.i33.i134, %bb.p, %bb.q
  ...
  %i.oi = sub i64 0, %i.oh
  %i.oj = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.oi) #9, !srcloc !29 ; 2 uses
  %i.ok = add i64 %i.oh, -1
  %i.ol = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.ok) #9, !srcloc !29 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %i.om, align 8, !tbaa !11
  %wide.load197 = load <2 x i64>, ptr %i.on, align 8, !tbaa !11
  %i.oo = getelementptr inbounds nuw [8 x i8], ptr %i.w, i64 %index ; 2 uses
  %i.op = getelementptr inbounds nuw i8, ptr %i.oo, i64 16
  %wide.load198 = load <2 x i64>, ptr %i.oo, align 8, !tbaa !11
  %wide.load199 = load <2 x i64>, ptr %i.op, align 8, !tbaa !11
  ...
  store <2 x i64> %i.ou, ptr %i.om, align 8, !tbaa !11
  store <2 x i64> %i.ov, ptr %i.on, align 8, !tbaa !11
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ow = icmp eq i64 %index.next, %n.vec
  br i1 %i.ow, label %middle.block, label %vector.body, !llvm.loop !23
...
.lr.ph.i.i146:                                    ; preds = %scalar.ph, %middle.block
  ...
  %i.pg = sub i64 0, %i.pf
  %i.ph = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.pg) #9, !srcloc !29 ; 2 uses
  %i.pi = add i64 %i.pf, -1
  %i.pj = call i64 asm "", "=r,0,~{dirflag},~{fpsr},~{flags}"(i64 %i.pi) #9, !srcloc !29 ; 2 uses
...
vector.body208:                                   ; preds = %vector.body208, %vector.ph202
  ...
  %wide.load210 = load <2 x i64>, ptr %i.pk, align 8, !tbaa !11
  %wide.load211 = load <2 x i64>, ptr %i.pl, align 8, !tbaa !11
  %i.pm = getelementptr inbounds nuw [8 x i8], ptr %i.w, i64 %index209 ; 2 uses
  %i.pn = getelementptr inbounds nuw i8, ptr %i.pm, i64 16
  %wide.load212 = load <2 x i64>, ptr %i.pm, align 8, !tbaa !11
  %wide.load213 = load <2 x i64>, ptr %i.pn, align 8, !tbaa !11
  ...
  store <2 x i64> %i.ps, ptr %i.pk, align 8, !tbaa !11
  store <2 x i64> %i.pt, ptr %i.pl, align 8, !tbaa !11
  %index.next214 = add nuw i64 %index209, 4       ; 2 uses
  %i.pu = icmp eq i64 %index.next214, %n.vec203
  br i1 %i.pu, label %middle.block215, label %vector.body208, !llvm.loop !25
...
scalar.ph200:                                     ; preds = %scalar.ph200.preheader, %scalar.ph200
  ...
  %i.py = load i64, ptr %i.px, align 8, !tbaa !11
  %i.pz = and i64 %i.pw, %i.ph
  %i.qa = and i64 %i.py, %i.pj
  %i.qb = or i64 %i.qa, %i.pz
  store i64 %i.qb, ptr %i.pv, align 8, !tbaa !11
...
6:                                                ; preds = %6, %.preheader.preheader.new
  ...
  br i1 %niter86.ncmp.3.not, label %get_digit.exit40.unr-lcssa, label %6, !llvm.loop !33
...
bb.b:                                             ; preds = %bb.b, %.epil.preheader79
  ...
  br i1 %epil.iter81.cmp.not, label %get_digit.exit40, label %bb.b, !llvm.loop !34
