...
bb.t:                                             ; preds = %bb.s
  ...
  br i1 %.not181.i, label %bb.u, label %._crit_edge25, !prof !12
...
bb.w:                                             ; preds = %._crit_edge25, %bb.v
  ...
  %.6.i.val = load i32, ptr %.6.i, align 1, !tbaa !10
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %wide.load = load <8 x i8>, ptr %i.i, align 1, !tbaa !18, !alias.scope !19 ; 2 uses
  %wide.load31 = load <8 x i8>, ptr %10, align 1, !tbaa !18, !alias.scope !19 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec, ptr %0, align 1, !tbaa !18, !alias.scope !22, !noalias !19
  ...
  store <16 x i8> %interleaved.vec34, ptr %13, align 1, !tbaa !18, !alias.scope !22, !noalias !19
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %wide.load.1 = load <8 x i8>, ptr %17, align 1, !tbaa !18, !alias.scope !19 ; 2 uses
  %wide.load31.1 = load <8 x i8>, ptr %18, align 1, !tbaa !18, !alias.scope !19 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.1, ptr %21, align 1, !tbaa !18, !alias.scope !22, !noalias !19
  ...
  store <16 x i8> %interleaved.vec34.1, ptr %22, align 1, !tbaa !18, !alias.scope !22, !noalias !19
...
vector.body:                                      ; preds = %vector.body.1
  ...
  %wide.load.a = load <8 x i8>, ptr %i.s, align 1, !tbaa !18, !alias.scope !19 ; 2 uses
  %wide.load31.a = load <8 x i8>, ptr %i.t, align 1, !tbaa !18, !alias.scope !19 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.a, ptr %i.w, align 1, !tbaa !18, !alias.scope !22, !noalias !19
  ...
  store <16 x i8> %interleaved.vec34.a, ptr %i.x, align 1, !tbaa !18, !alias.scope !22, !noalias !19
...
vector.body.3:                                    ; preds = %vector.body
  ...
  %wide.load.3 = load <8 x i8>, ptr %26, align 1, !tbaa !18, !alias.scope !19 ; 2 uses
  %wide.load31.3 = load <8 x i8>, ptr %27, align 1, !tbaa !18, !alias.scope !19 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.3, ptr %30, align 1, !tbaa !18, !alias.scope !22, !noalias !19
  ...
  store <16 x i8> %interleaved.vec34.3, ptr %31, align 1, !tbaa !18, !alias.scope !22, !noalias !19
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load38 = load <4 x i8>, ptr %i.ad, align 1, !tbaa !18, !alias.scope !19 ; 2 uses
  ...
  store <8 x i8> %interleaved.vec40, ptr %i.af, align 1, !tbaa !18, !alias.scope !22, !noalias !19
  %index.next41 = add nuw i64 %index37, 4         ; 2 uses
  %i.ah = icmp eq i64 %index.next41, %n.vec36
  br i1 %i.ah, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !25
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  store i8 %i.am, ptr %i.an, align 1, !tbaa !18
  %i.ao = load i8, ptr %i.ak, align 1, !tbaa !18
  %i.ap = and i8 %i.ao, 15
  ...
  br i1 %i.as, label %.lr.ph.i, label %.loopexit.thread.i, !llvm.loop !28
...
.lr.ph13.i:                                       ; preds = %bb.i, %.lr.ph13.preheader.i
  ...
  %i.az = load i8, ptr %i.ay, align 1, !tbaa !18  ; 2 uses
...
bb.i:                                             ; preds = %.lr.ph13.i
  ...
  %i.bf = load i8, ptr %i.ay, align 1, !tbaa !18
  ...
  br i1 %.not90.i.i, label %.lr.ph13.i, label %.critedge.i.i, !llvm.loop !29
...
bb.k:                                             ; preds = %bb.j
  ...
  store i32 %i.bp, ptr %4, align 4, !tbaa !10
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !10 ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.cg = add i32 %i.cf, 1
  store i32 %i.cg, ptr %3, align 4, !tbaa !10
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %wide.load = load <8 x i8>, ptr %i.g, align 1, !tbaa !18, !alias.scope !30 ; 2 uses
  %wide.load35 = load <8 x i8>, ptr %9, align 1, !tbaa !18, !alias.scope !30 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec, ptr %0, align 1, !tbaa !18, !alias.scope !33, !noalias !30
  ...
  store <16 x i8> %interleaved.vec38, ptr %12, align 1, !tbaa !18, !alias.scope !33, !noalias !30
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %wide.load.1 = load <8 x i8>, ptr %16, align 1, !tbaa !18, !alias.scope !30 ; 2 uses
  %wide.load35.1 = load <8 x i8>, ptr %17, align 1, !tbaa !18, !alias.scope !30 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.1, ptr %20, align 1, !tbaa !18, !alias.scope !33, !noalias !30
  ...
  store <16 x i8> %interleaved.vec38.1, ptr %21, align 1, !tbaa !18, !alias.scope !33, !noalias !30
...
vector.body:                                      ; preds = %vector.body.1
  ...
  %wide.load.a = load <8 x i8>, ptr %i.q, align 1, !tbaa !18, !alias.scope !30 ; 2 uses
  %wide.load35.a = load <8 x i8>, ptr %i.r, align 1, !tbaa !18, !alias.scope !30 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.a, ptr %i.u, align 1, !tbaa !18, !alias.scope !33, !noalias !30
  ...
  store <16 x i8> %interleaved.vec38.a, ptr %i.v, align 1, !tbaa !18, !alias.scope !33, !noalias !30
...
vector.body.3:                                    ; preds = %vector.body
  ...
  %wide.load.3 = load <8 x i8>, ptr %25, align 1, !tbaa !18, !alias.scope !30 ; 2 uses
  %wide.load35.3 = load <8 x i8>, ptr %26, align 1, !tbaa !18, !alias.scope !30 ; 2 uses
  ...
  store <16 x i8> %interleaved.vec.3, ptr %29, align 1, !tbaa !18, !alias.scope !33, !noalias !30
  ...
  store <16 x i8> %interleaved.vec38.3, ptr %30, align 1, !tbaa !18, !alias.scope !33, !noalias !30
  br label %middle.block
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load42 = load <4 x i8>, ptr %i.ab, align 1, !tbaa !18, !alias.scope !30 ; 2 uses
  ...
  store <8 x i8> %interleaved.vec44, ptr %i.ad, align 1, !tbaa !18, !alias.scope !33, !noalias !30
...
.lr.ph13:                                         ; preds = %.lr.ph13.preheader, %bb.g
  ...
  %i.ay = load i8, ptr %i.ax, align 1, !tbaa !18  ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph13
  ...
  %i.bd = add i32 %i.bc, 1
  store i32 %i.bd, ptr %i.bb, align 4, !tbaa !10
  %i.be = load i8, ptr %i.ax, align 1, !tbaa !18
  ...
  br i1 %.not90.i, label %.lr.ph13, label %.critedge.i, !llvm.loop !29
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.cb = load i32, ptr %i.ca, align 4, !tbaa !10 ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.cf = add i32 %i.ce, 1
  store i32 %i.cf, ptr %3, align 4, !tbaa !10
...
attributes #2 = { nofree nosync nounwind memory(read, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
attributes #5 = { nounwind uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+bmi,+bmi2,+cmov,+cx8,+fxsr,+lzcnt,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
