...
bb.w:                                             ; preds = %._crit_edge25, %bb.v
  ...
  %.6.i.val = load i32, ptr %.6.i, align 1, !tbaa !5
...
bb.z:                                             ; preds = %bb.y
  ...
  store i32 %i.ci, ptr %1, align 4, !tbaa !5
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x i8> %interleaved.vec.a, ptr %12, align 1, !tbaa !16, !alias.scope !20, !noalias !17
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load38 = load <4 x i8>, ptr %i.ae, align 1, !tbaa !16, !alias.scope !17 ; 2 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  br i1 %i.at, label %.lr.ph.i, label %.loopexit.thread.i, !llvm.loop !27
...
bb.i:                                             ; preds = %.lr.ph13.i
  ...
  %i.bf = add i32 %i.be, 1
  store i32 %i.bf, ptr %i.bd, align 4, !tbaa !5
  %i.bg = load i8, ptr %i.az, align 1, !tbaa !16
...
bb.k:                                             ; preds = %bb.j
  ...
  store i32 %i.bq, ptr %4, align 4, !tbaa !5
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.cb = add i32 %i.ca, 1
  store i32 %i.cb, ptr %i.bz, align 4, !tbaa !5
  %i.cc = getelementptr inbounds nuw i8, ptr %2, i64 4
  %i.cd = load i32, ptr %i.cc, align 4, !tbaa !5  ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ch = add i32 %i.cg, 1
  store i32 %i.ch, ptr %3, align 4, !tbaa !5
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <16 x i8> %interleaved.vec.a, ptr %11, align 1, !tbaa !16, !alias.scope !32, !noalias !29
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load42 = load <4 x i8>, ptr %i.ac, align 1, !tbaa !16, !alias.scope !29 ; 2 uses
  ...
  store <8 x i8> %interleaved.vec44, ptr %i.ae, align 1, !tbaa !16, !alias.scope !32, !noalias !29
  %index.next45 = add nuw i64 %index41, 4         ; 2 uses
  %i.ag = icmp eq i64 %index.next45, %n.vec40
  br i1 %i.ag, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !35
...
bb.g:                                             ; preds = %.lr.ph13
  ...
  %i.be = add i32 %i.bd, 1
  store i32 %i.be, ptr %i.bc, align 4, !tbaa !5
...
bb.i:                                             ; preds = %bb.h
  ...
  store i32 %i.bp, ptr %4, align 4, !tbaa !5
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.ca = add i32 %i.bz, 1
  store i32 %i.ca, ptr %i.by, align 4, !tbaa !5
  %i.cb = getelementptr inbounds nuw i8, ptr %2, i64 4
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !5  ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.cg = add i32 %i.cf, 1
  store i32 %i.cg, ptr %3, align 4, !tbaa !5
