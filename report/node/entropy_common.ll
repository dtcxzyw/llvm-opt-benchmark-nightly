...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load.a = load <8 x i8>, ptr %i.s, align 1, !tbaa !18, !alias.scope !19
  %wide.load31.a = load <8 x i8>, ptr %i.t, align 1, !tbaa !18, !alias.scope !19
  ...
  %wide.load32 = load <8 x i8>, ptr %i.s, align 1, !tbaa !18, !alias.scope !19
  %wide.load33 = load <8 x i8>, ptr %i.t, align 1, !tbaa !18, !alias.scope !19
  ...
  store <16 x i8> %interleaved.vec.a, ptr %11, align 1, !tbaa !18, !alias.scope !22, !noalias !19
  ...
  br i1 %i.aa, label %middle.block, label %vector.body, !llvm.loop !24
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.ah, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !28
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  br i1 %i.as, label %.lr.ph.i, label %.loopexit.thread.i, !llvm.loop !29
...
bb.i:                                             ; preds = %.lr.ph13.i
  ...
  br i1 %.not90.i.i, label %.lr.ph13.i, label %.critedge.i.i, !llvm.loop !30
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load.a = load <8 x i8>, ptr %i.q, align 1, !tbaa !18, !alias.scope !31
  %wide.load35.a = load <8 x i8>, ptr %i.r, align 1, !tbaa !18, !alias.scope !31
  ...
  %wide.load36 = load <8 x i8>, ptr %i.q, align 1, !tbaa !18, !alias.scope !31
  %wide.load37 = load <8 x i8>, ptr %i.r, align 1, !tbaa !18, !alias.scope !31
  ...
  store <16 x i8> %interleaved.vec.a, ptr %10, align 1, !tbaa !18, !alias.scope !34, !noalias !31
  ...
  store <16 x i8> %interleaved.vec38.a, ptr %i.v, align 1, !tbaa !18, !alias.scope !34, !noalias !31
  %index.next = add nuw i64 %index, 16            ; 2 uses
  %i.y = icmp eq i64 %index.next, %n.vec
  br i1 %i.y, label %middle.block, label %vector.body, !llvm.loop !36
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load42 = load <4 x i8>, ptr %i.ab, align 1, !tbaa !18, !alias.scope !31 ; 2 uses
  ...
  store <8 x i8> %interleaved.vec44, ptr %i.ad, align 1, !tbaa !18, !alias.scope !34, !noalias !31
  %index.next45 = add nuw i64 %index41, 4         ; 2 uses
  %i.af = icmp eq i64 %index.next45, %n.vec40
  br i1 %i.af, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !37
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.ar, label %.lr.ph, label %.loopexit.thread, !llvm.loop !38
...
bb.g:                                             ; preds = %.lr.ph13
  ...
  br i1 %.not90.i, label %.lr.ph13, label %.critedge.i, !llvm.loop !30
...
!34 = !{!35}
!35 = distinct !{!35, !33}
!36 = distinct !{!36, !14, !25, !26}
!37 = distinct !{!37, !14, !25, !26}
!38 = distinct !{!38, !14, !25}
end_hunk_0
