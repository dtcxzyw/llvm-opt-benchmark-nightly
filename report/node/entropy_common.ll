...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  br i1 %i.at, label %.lr.ph.i, label %.loopexit.thread.i, !llvm.loop !26
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load42 = load <4 x i8>, ptr %i.ac, align 1, !tbaa !16, !alias.scope !28 ; 2 uses
  ...
  store <8 x i8> %interleaved.vec44, ptr %i.ae, align 1, !tbaa !16, !alias.scope !31, !noalias !28
