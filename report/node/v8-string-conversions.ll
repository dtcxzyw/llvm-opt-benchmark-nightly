...
bb.e:                                             ; preds = %bb.ab, %_ZNSt6vectorIDsSaIDsEEC2EmRKS0_.exit
  %.04138.i = phi ptr [ %i.g, %_ZNSt6vectorIDsSaIDsEEC2EmRKS0_.exit ], [ %.142.i, %bb.ab ] ; 5 uses
...
bb.ab:                                            ; preds = %bb.aa, %bb.x
  %.pn.i = phi i64 [ 4, %bb.aa ], [ 2, %bb.x ]
  %.142.i = getelementptr inbounds nuw i8, ptr %.04138.i, i64 %.pn.i ; 2 uses
...
_ZN12v8_inspector12_GLOBAL__N_118convertUTF8ToUTF16EPPKcS2_PPDsS4_Pbb.exit: ; preds = %bb.ab
  %i.ce = ptrtoint ptr %.142.i to i64
