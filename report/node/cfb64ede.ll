...
bb.u:                                             ; preds = %bb.t, %bb.l
  ...
  switch i32 %2, label %.preheader329.preheader [
    i32 32, label %bb.w
    i32 64, label %bb.v
  ]
end_hunk_2
...
.preheader329.preheader:                          ; preds = %bb.u
  ...
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(9) %i.b, ptr noundef nonnull align 1 dereferenceable(9) %i.p, i64 9, i1 false)
...
begin_hunk_4
  ...
  %9 = load i32, ptr %i.b, align 16
  %10 = load i32, ptr %i.k, align 4
  br label %bb.w

bb.w:                                             ; preds = %bb.u, %bb.v, %.preheader329.preheader
  %.1290 = phi i32 [ %9, %.preheader329.preheader ], [ %i.bz, %bb.v ], [ %.0284336, %bb.u ] ; 2 uses
  %.1285 = phi i32 [ %10, %.preheader329.preheader ], [ %i.cb, %bb.v ], [ %i.bz, %bb.u ] ; 2 uses
...
.preheader.preheader:                             ; preds = %bb.ag
  ...
  call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(9) %i.b, ptr noundef nonnull align 1 dereferenceable(9) %i.ad, i64 9, i1 false)
...
begin_hunk_7
  ...
  %11 = load i32, ptr %i.b, align 16
  %12 = load i32, ptr %i.y, align 4
  br label %bb.ai

bb.ai:                                            ; preds = %bb.ag, %bb.ah, %.preheader.preheader
  %.3292 = phi i32 [ %11, %.preheader.preheader ], [ %.7317, %bb.ah ], [ %.2286344, %bb.ag ] ; 2 uses
  %.3287 = phi i32 [ %12, %.preheader.preheader ], [ %.15309, %bb.ah ], [ %.7317, %bb.ag ] ; 2 uses
