...
begin_hunk_0_@CreateBackwardReferencesDH5:bb.a
  ...
  %i.auw = lshr i64 %i.auo, %i.aus
  %i.aux = and i64 %i.auw, 1                      ; 2 uses
  ...
  %12 = add nsw i64 %i.avc, 65534
  %13 = or disjoint i64 %12, %i.aux
...
begin_hunk_1_@CreateBackwardReferencesDH6:bb.a
  ...
  %i.ava = lshr i64 %i.aus, %i.auw
  %i.avb = and i64 %i.ava, 1                      ; 2 uses
  ...
  %12 = add nsw i64 %i.avg, 65534
  %13 = or disjoint i64 %12, %i.avb
...
begin_hunk_2_@CreateBackwardReferencesDH58:bb.a
  ...
  %i.azl = lshr i64 %i.azd, %i.azh
  %i.azm = and i64 %i.azl, 1                      ; 2 uses
  ...
  %12 = add nsw i64 %i.azr, 65534
  %13 = or disjoint i64 %12, %i.azm
...
begin_hunk_3_@CreateBackwardReferencesDH68:bb.a
  ...
  %i.azq = lshr i64 %i.azi, %i.azm
  %i.azr = and i64 %i.azq, 1                      ; 2 uses
  ...
  %12 = add nsw i64 %i.azw, 65534
  %13 = or disjoint i64 %12, %i.azr
...
begin_hunk_12_@CreateBackwardReferencesNH5:bb.a
  ...
  %i.acu = lshr i64 %i.acm, %i.acq
  %i.acv = and i64 %i.acu, 1                      ; 2 uses
  ...
  %12 = add nsw i64 %i.ada, 65534
  %13 = or disjoint i64 %12, %i.acv
...
begin_hunk_13_@CreateBackwardReferencesNH6:bb.a
  ...
  %i.acy = lshr i64 %i.acq, %i.acu
  %i.acz = and i64 %i.acy, 1                      ; 2 uses
  ...
  %12 = add nsw i64 %i.ade, 65534
  %13 = or disjoint i64 %12, %i.acz
...
begin_hunk_18_@CreateBackwardReferencesNH58:bb.a
  ...
  %i.ahg = lshr i64 %i.agy, %i.ahc
  %i.ahh = and i64 %i.ahg, 1                      ; 2 uses
  ...
  %12 = add nsw i64 %i.ahm, 65534
  %13 = or disjoint i64 %12, %i.ahh
...
begin_hunk_19_@CreateBackwardReferencesNH68:bb.a
  ...
  %i.ahl = lshr i64 %i.ahd, %i.ahh
  %i.ahm = and i64 %i.ahl, 1                      ; 2 uses
  ...
  %12 = add nsw i64 %i.ahr, 65534
  %13 = or disjoint i64 %12, %i.ahm
...
begin_hunk_22_@CreateBackwardReferencesNH65:bb.a
  ...
  %i.ahw = lshr i64 %i.aho, %i.ahs
  %i.ahx = and i64 %i.ahw, 1                      ; 2 uses
  ...
  %12 = add nsw i64 %i.aic, 65534
  %13 = or disjoint i64 %12, %i.ahx
