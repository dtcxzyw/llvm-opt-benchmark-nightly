...
define dso_local range(i64 0, 2147483657) i64 @CRYPTO_128_wrap(ptr noundef %0, ptr nofree noundef readonly captures(address_is_null) %1, ptr nofree noundef captures(none) %2, ptr nofree noundef readonly captures(none) %3, i64 noundef %4, ptr nofree noundef readonly captures(none) %5) local_unnamed_addr #0 {
bb.a:
...
bb.b:                                             ; preds = %.preheader.preheader, %bb.d
  ...
  %i.s = load i8, ptr %i.i, align 1, !tbaa !9
  %i.t = xor i8 %i.s, %i.r
  store i8 %i.t, ptr %i.i, align 1, !tbaa !9
  %i.u = icmp samesign ugt i64 %.143, 255
  br i1 %i.u, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %i.v = load i8, ptr %i.j, align 2, !tbaa !9
  %i.w = lshr i64 %.143, 8
  %i.x = trunc i64 %i.w to i8
  %i.y = xor i8 %i.v, %i.x
  store i8 %i.y, ptr %i.j, align 2, !tbaa !9
  %i.z = load i8, ptr %i.k, align 1, !tbaa !9
  %i.aa = lshr i64 %.143, 16
  %i.ab = trunc i64 %i.aa to i8
  %i.ac = xor i8 %i.z, %i.ab
  store i8 %i.ac, ptr %i.k, align 1, !tbaa !9
  %i.ad = load i8, ptr %i.l, align 4, !tbaa !9
  %i.ae = lshr i64 %.143, 24
  %i.af = trunc i64 %i.ae to i8
  %i.ag = xor i8 %i.ad, %i.af
  store i8 %i.ag, ptr %i.l, align 4, !tbaa !9
  br label %bb.d
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %exitcond.1.not, label %._crit_edge.1, label %bb.e, !llvm.loop !10
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  br i1 %exitcond.2.not, label %._crit_edge.2, label %bb.h, !llvm.loop !10
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  br i1 %exitcond.3.not, label %._crit_edge.3, label %bb.k, !llvm.loop !10
...
bb.n:                                             ; preds = %bb.p, %._crit_edge.3
  ...
  %i.cy = load i8, ptr %i.i, align 1, !tbaa !9
  %i.cz = xor i8 %i.cy, %i.cx
  store i8 %i.cz, ptr %i.i, align 1, !tbaa !9
  %i.da = icmp ugt i64 %.143.4, 255
  br i1 %i.da, label %bb.o, label %bb.p

bb.o:                                             ; preds = %bb.n
  %i.db = load i8, ptr %i.j, align 2, !tbaa !9
  %i.dc = lshr i64 %.143.4, 8
  %i.dd = trunc i64 %i.dc to i8
  %i.de = xor i8 %i.db, %i.dd
  store i8 %i.de, ptr %i.j, align 2, !tbaa !9
  %i.df = load i8, ptr %i.k, align 1, !tbaa !9
  %i.dg = lshr i64 %.143.4, 16
  %i.dh = trunc i64 %i.dg to i8
  %i.di = xor i8 %i.df, %i.dh
  store i8 %i.di, ptr %i.k, align 1, !tbaa !9
  %i.dj = load i8, ptr %i.l, align 4, !tbaa !9
  %i.dk = lshr i64 %.143.4, 24
  %i.dl = trunc i64 %i.dk to i8
  %i.dm = xor i8 %i.dj, %i.dl
  store i8 %i.dm, ptr %i.l, align 4, !tbaa !9
  br label %bb.p
...
bb.p:                                             ; preds = %bb.o, %bb.n
  ...
  br i1 %exitcond.4.not, label %._crit_edge.4, label %bb.n, !llvm.loop !10
...
bb.q:                                             ; preds = %bb.s, %._crit_edge.4
  ...
  %i.dt = load i8, ptr %i.i, align 1, !tbaa !9
  %i.du = xor i8 %i.dt, %i.ds
  store i8 %i.du, ptr %i.i, align 1, !tbaa !9
  %i.dv = icmp ugt i64 %.143.5, 255
  br i1 %i.dv, label %bb.r, label %bb.s

bb.r:                                             ; preds = %bb.q
  %i.dw = load i8, ptr %i.j, align 2, !tbaa !9
  %i.dx = lshr i64 %.143.5, 8
  %i.dy = trunc i64 %i.dx to i8
  %i.dz = xor i8 %i.dw, %i.dy
  store i8 %i.dz, ptr %i.j, align 2, !tbaa !9
  %i.ea = load i8, ptr %i.k, align 1, !tbaa !9
  %i.eb = lshr i64 %.143.5, 16
  %i.ec = trunc i64 %i.eb to i8
  %i.ed = xor i8 %i.ea, %i.ec
  store i8 %i.ed, ptr %i.k, align 1, !tbaa !9
  %i.ee = load i8, ptr %i.l, align 4, !tbaa !9
  %i.ef = lshr i64 %.143.5, 24
  %i.eg = trunc i64 %i.ef to i8
  %i.eh = xor i8 %i.ee, %i.eg
  store i8 %i.eh, ptr %i.l, align 4, !tbaa !9
  br label %bb.s
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  br i1 %exitcond.5.not, label %.split46, label %bb.q, !llvm.loop !10
...
; Function Attrs: nounwind uwtable
define dso_local range(i64 0, 2147483649) i64 @CRYPTO_128_unwrap(ptr noundef %0, ptr noundef %1, ptr noundef %2, ptr nofree noundef readonly captures(none) %3, i64 noundef %4, ptr nofree noundef readonly captures(none) %5) local_unnamed_addr #0 {
bb.a:
...
bb.c:                                             ; preds = %.lr.ph.preheader, %bb.e
  ...
  %i.r = load i8, ptr %i.j, align 1, !tbaa !9
  %i.s = xor i8 %i.r, %i.q
  store i8 %i.s, ptr %i.j, align 1, !tbaa !9
  %i.t = icmp ugt i64 %.145, 255
  br i1 %i.t, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.u = load i8, ptr %i.k, align 2, !tbaa !9
  %i.v = lshr i64 %.145, 8
  %i.w = trunc i64 %i.v to i8
  %i.x = xor i8 %i.u, %i.w
  store i8 %i.x, ptr %i.k, align 2, !tbaa !9
  %i.y = load i8, ptr %i.l, align 1, !tbaa !9
  %i.z = lshr i64 %.145, 16
  %i.aa = trunc i64 %i.z to i8
  %i.ab = xor i8 %i.y, %i.aa
  store i8 %i.ab, ptr %i.l, align 1, !tbaa !9
  %i.ac = load i8, ptr %i.m, align 4, !tbaa !9
  %i.ad = lshr i64 %.145, 24
  %i.ae = trunc i64 %i.ad to i8
  %i.af = xor i8 %i.ac, %i.ae
  store i8 %i.af, ptr %i.m, align 4, !tbaa !9
  br label %bb.e
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  br i1 %i.ak, label %bb.c, label %._crit_edge, !llvm.loop !12
...
._crit_edge:                                      ; preds = %bb.e, %bb.g
  ...
  %i.am = load i8, ptr %i.j, align 1, !tbaa !9
  %i.an = xor i8 %i.am, %i.al
  store i8 %i.an, ptr %i.j, align 1, !tbaa !9
