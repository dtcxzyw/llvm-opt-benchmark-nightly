...
begin_hunk_0_@BN_nist_mod_192:bb.a
  ...
  %i.c = load i32, ptr %i.b, align 8, !tbaa !9    ; 5 uses
...
begin_hunk_1_@BN_nist_mod_192:bb.a
  ...
  %5 = add nsw i32 %i.c, -3
  %6 = icmp slt i32 %i.c, 6
  br i1 %6, label %.lr.ph125.preheader, label %._crit_edge

.lr.ph125.preheader:                              ; preds = %nist_cp_bn.exit, %.preheader
  %.0106.lcssa137 = phi i32 [ %5, %.preheader ], [ 0, %nist_cp_bn.exit ]
  %7 = shl nuw nsw i32 %.0106.lcssa137, 3
  %8 = zext nneg i32 %7 to i64
  %scevgep.a = getelementptr i8, ptr %4, i64 %8
  %smax = tail call i32 @llvm.smax.i32(i32 %i.c, i32 3)
  %i.ad = shl i32 %smax, 3
  %i.ae = sub i32 40, %i.ad
  %i.af = zext i32 %i.ae to i64
  %i.ag = add nuw nsw i64 %i.af, 8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.a, i8 0, i64 %i.ag, i1 false), !tbaa !16
  br label %._crit_edge
...
begin_hunk_3_@BN_nist_mod_256:bb.a
  ...
  %5 = add nsw i32 %i.c, -4
  %6 = icmp slt i32 %i.c, 8
  br i1 %6, label %.lr.ph252.preheader, label %._crit_edge

.lr.ph252.preheader:                              ; preds = %nist_cp_bn.exit, %.preheader
  %.0204.lcssa266 = phi i32 [ %5, %.preheader ], [ 0, %nist_cp_bn.exit ]
  %7 = shl nuw nsw i32 %.0204.lcssa266, 3
  %8 = zext nneg i32 %7 to i64
  %scevgep.a = getelementptr i8, ptr %4, i64 %8
  %smax = tail call i32 @llvm.smax.i32(i32 %i.c, i32 4)
  %i.ag = shl i32 %smax, 3
  %i.ah = sub i32 56, %i.ag
  %i.ai = zext i32 %i.ah to i64
  %i.aj = add nuw nsw i64 %i.ai, 8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.a, i8 0, i64 %i.aj, i1 false), !tbaa !16
  br label %._crit_edge
...
begin_hunk_5_@BN_nist_mod_384:bb.a
  ...
  %5 = add nsw i32 %i.c, -6
  %6 = icmp slt i32 %i.c, 12
  br i1 %6, label %.lr.ph292.preheader, label %._crit_edge

.lr.ph292.preheader:                              ; preds = %nist_cp_bn.exit, %.preheader
  %.0246.lcssa312 = phi i32 [ %5, %.preheader ], [ 0, %nist_cp_bn.exit ]
  %7 = shl nuw nsw i32 %.0246.lcssa312, 3
  %8 = zext nneg i32 %7 to i64
  %scevgep.a = getelementptr i8, ptr %4, i64 %8
  %smax = tail call i32 @llvm.smax.i32(i32 %i.c, i32 6)
  %i.am = shl i32 %smax, 3
  %i.an = sub i32 88, %i.am
  %i.ao = zext i32 %i.an to i64
  %i.ap = add nuw nsw i64 %i.ao, 8
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep.a, i8 0, i64 %i.ap, i1 false), !tbaa !16
  br label %._crit_edge
