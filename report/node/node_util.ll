...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i:     ; preds = %bb.j, %.lr.ph.i.i
  %.033.i.i = phi i64 [ %i.ag, %.lr.ph.i.i ], [ %i.ap, %bb.j ]
  %.02132.i.i = phi ptr [ %i.af, %.lr.ph.i.i ], [ %i.an, %bb.j ]
  %i.ak = add i64 %.033.i.i, -13
  %i.al = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i, i32 noundef 47, i64 noundef %i.ak) #23 ; 4 uses
...
.lr.ph.i.i25:                                     ; preds = %bb.j, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit
  %i.at = getelementptr inbounds nuw i8, ptr %i.af, i64 %i.ag
  %i.au = ptrtoint ptr %i.at to i64
  br label %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i26

_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i26:   ; preds = %bb.k, %.lr.ph.i.i25
  %.033.i.i27 = phi i64 [ %i.ag, %.lr.ph.i.i25 ], [ %i.ba, %bb.k ]
  %.02132.i.i28 = phi ptr [ %i.af, %.lr.ph.i.i25 ], [ %i.ay, %bb.k ]
  %i.av = add i64 %.033.i.i27, -13
  %i.aw = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i28, i32 noundef 92, i64 noundef %i.av) #23 ; 4 uses
...
.lr.ph.i.i38:                                     ; preds = %bb.k, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i26, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit34
  %i.be = getelementptr inbounds nuw i8, ptr %i.af, i64 %i.ag
  %i.bf = ptrtoint ptr %i.be to i64
  br label %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i39

_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i39:   ; preds = %bb.l, %.lr.ph.i.i38
  %.033.i.i40 = phi i64 [ %i.ag, %.lr.ph.i.i38 ], [ %i.bl, %bb.l ]
  %.02132.i.i41 = phi ptr [ %i.af, %.lr.ph.i.i38 ], [ %i.bj, %bb.l ]
  %i.bg = add i64 %.033.i.i40, -13
  %i.bh = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i41, i32 noundef 47, i64 noundef %i.bg) #23 ; 4 uses
...
.lr.ph.i.i51:                                     ; preds = %bb.l, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i39, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit47
  %i.bp = getelementptr inbounds nuw i8, ptr %i.af, i64 %i.ag
  %i.bq = ptrtoint ptr %i.bp to i64
  br label %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i52

_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i52:   ; preds = %bb.n, %.lr.ph.i.i51
  %.033.i.i53 = phi i64 [ %i.ag, %.lr.ph.i.i51 ], [ %i.ca, %bb.n ]
  %.02132.i.i54 = phi ptr [ %i.af, %.lr.ph.i.i51 ], [ %i.by, %bb.n ]
  %i.br = add i64 %.033.i.i53, -13
  %i.bs = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i54, i32 noundef 92, i64 noundef %i.br) #23 ; 4 uses
