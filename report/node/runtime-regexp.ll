...
begin_hunk_4_@_ZN2v88internal48Runtime_StringReplaceNonGlobalRegExpWithFunctionEiPmPNS0_7IsolateE:_ZNK2v88internal9ArgumentsILNS0_13ArgumentsTypeE0EE17address_of_arg_atEi.exit
  ...
  %6 = icmp ugt i64 %i.ea, 562872644009983
  br label %.thread.a

.thread.a:                                        ; preds = %.thread, %bb.w
  %7 = phi i1 [ %6, %bb.w ], [ %5, %.thread ]
  %.1134.i234 = phi i1 [ true, %bb.w ], [ false, %.thread ]
  %.sroa.070.0233 = phi ptr [ %.0.i.i.i, %bb.w ], [ null, %.thread ] ; 3 uses
  %8 = phi i32 [ 3, %bb.w ], [ 2, %.thread ]
  %i.fg = add nuw nsw i32 %8, %i.ed               ; 2 uses
  %i.fh = icmp ugt i32 %i.fg, 65526
  %i.fi = select i1 %7, i1 true, i1 %i.fh
