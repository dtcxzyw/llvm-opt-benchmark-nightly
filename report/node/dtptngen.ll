...
begin_hunk_0_@_ZN6icu_7812FormatParserC2Ev:bb.a
  ...
  %.ptr.37 = getelementptr inbounds nuw i8, ptr %0, i64 2376
  store ptr getelementptr inbounds nuw inrange(-16, 88) (i8, ptr @_ZTVN6icu_7813UnicodeStringE, i64 16), ptr %.ptr.37, align 8
  %i.al = getelementptr inbounds nuw i8, ptr %0, i64 2384
  store i16 2, ptr %i.al, align 8
  %.ptr.38 = getelementptr inbounds nuw i8, ptr %0, i64 2440
  store ptr getelementptr inbounds nuw inrange(-16, 88) (i8, ptr @_ZTVN6icu_7813UnicodeStringE, i64 16), ptr %.ptr.38, align 8
...
.preheader.split.us:                              ; preds = %_ZNK6icu_7813UnicodeString6charAtEi.exit38.us
  ...
  br i1 %i.r, label %_ZNK6icu_7813UnicodeString6charAtEi.exit.us, label %.sink.split, !llvm.loop !91
...
bb.b:                                             ; preds = %_ZNK6icu_7813UnicodeString6charAtEi.exit38
  ...
  br i1 %exitcond.not, label %.critedge.outer.preheader, label %_ZNK6icu_7813UnicodeString6charAtEi.exit38, !llvm.loop !35
...
.critedge:                                        ; preds = %.lr.ph
  ...
  br i1 %exitcond59, label %.critedge.outer._crit_edge, label %.lr.ph, !llvm.loop !36
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not35, label %.loopexit, label %.critedge.outer, !llvm.loop !36
...
bb.e:                                             ; preds = %bb.d
  ...
  tail call void %i.r(ptr noundef nonnull align 8 dereferenceable(152) %i.n) #25, !inline_history !92
  br label %bb.f
