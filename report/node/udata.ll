...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.i, label %.thread32, label %bb.d

.thread32:                                        ; preds = %bb.u, %bb.s, %bb.q, %bb.o, %bb.m, %bb.k, %bb.i, %bb.g, %bb.e, %bb.c
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not.1, label %bb.w, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 8
  %i.l = load ptr, ptr %i.k, align 8
  %i.m = icmp eq ptr %i.l, %i.h
  br i1 %i.m, label %.thread32, label %bb.f
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %.not.2, label %bb.w, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 8
  %i.p = load ptr, ptr %i.o, align 8
  %i.q = icmp eq ptr %i.p, %i.h
  br i1 %i.q, label %.thread32, label %bb.h
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %.not.3, label %bb.w, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 8
  %i.t = load ptr, ptr %i.s, align 8
  %i.u = icmp eq ptr %i.t, %i.h
  br i1 %i.u, label %.thread32, label %bb.j
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %.not.4, label %bb.w, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.w = getelementptr inbounds nuw i8, ptr %i.v, i64 8
  %i.x = load ptr, ptr %i.w, align 8
  %i.y = icmp eq ptr %i.x, %i.h
  br i1 %i.y, label %.thread32, label %bb.l
...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %.not.5, label %bb.w, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 8
  %i.ab = load ptr, ptr %i.aa, align 8
  %i.ac = icmp eq ptr %i.ab, %i.h
  br i1 %i.ac, label %.thread32, label %bb.n
...
bb.n:                                             ; preds = %bb.m
  ...
  br i1 %.not.6, label %bb.w, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 8
  %i.af = load ptr, ptr %i.ae, align 8
  %i.ag = icmp eq ptr %i.af, %i.h
  br i1 %i.ag, label %.thread32, label %bb.p
...
bb.p:                                             ; preds = %bb.o
  ...
  br i1 %.not.7, label %bb.w, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ah, i64 8
  %i.aj = load ptr, ptr %i.ai, align 8
  %i.ak = icmp eq ptr %i.aj, %i.h
  br i1 %i.ak, label %.thread32, label %bb.r
...
bb.r:                                             ; preds = %bb.q
  ...
  br i1 %.not.8, label %bb.w, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.am = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  %i.an = load ptr, ptr %i.am, align 8
  %i.ao = icmp eq ptr %i.an, %i.h
  br i1 %i.ao, label %.thread32, label %bb.t
...
bb.t:                                             ; preds = %bb.s
  ...
  br i1 %.not.9, label %bb.w, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 8
  %i.ar = load ptr, ptr %i.aq, align 8
  %i.as = icmp eq ptr %i.ar, %i.h
  br i1 %i.as, label %.thread32, label %.loopexit

.loopexit:                                        ; preds = %bb.u
  tail call void @umtx_unlock_78(ptr noundef null) #10
  %3 = trunc nuw i8 %1 to i1
  br i1 %3, label %bb.v, label %bb.x

bb.v:                                             ; preds = %.loopexit
  store i32 -127, ptr %2, align 4
  br label %bb.x

bb.w:                                             ; preds = %bb.t, %bb.r, %bb.p, %bb.n, %bb.l, %bb.j, %bb.h, %bb.f, %bb.d, %bb.b
  %.lcssa = phi i64 [ 0, %bb.b ], [ 1, %bb.d ], [ 2, %bb.f ], [ 3, %bb.h ], [ 4, %bb.j ], [ 5, %bb.l ], [ 6, %bb.n ], [ 7, %bb.p ], [ 8, %bb.r ], [ 9, %bb.t ]
  %4 = getelementptr inbounds nuw [8 x i8], ptr @_ZL19gCommonICUDataArray, i64 %.lcssa
...
bb.x:                                             ; preds = %.loopexit, %bb.v, %.thread32
...
; Function Attrs: mustprogress nounwind uwtable
define internal fastcc noundef ptr @_ZL12doOpenChoicePKcS0_S0_PFaPvS0_S0_PK9UDataInfoES1_P10UErrorCode(ptr noundef %0, ptr noundef %1, ptr noundef nonnull %2, ptr nofree noundef readonly captures(address_is_null) %3, ptr noundef %4, ptr noundef nonnull %5) unnamed_addr #0 {
bb.a:
