...
bb.i:                                             ; preds = %qrx_get_cipher_ctx_idx.exit.thread
  ...
  %13 = lshr <4 x i64> %12, <i64 40, i64 32, i64 24, i64 16>
  %i.aq = lshr i64 %7, 48
  %i.ar = lshr i64 %7, 56
  %14 = insertelement <2 x i64> poison, i64 %i.ap, i64 0
  %15 = insertelement <2 x i64> %14, i64 %7, i64 1
  %16 = trunc <2 x i64> %15 to <2 x i8>
  %17 = trunc <4 x i64> %13 to <4 x i8>
  %i.as = trunc i64 %i.aq to i8
  %i.at = trunc nuw i64 %i.ar to i8
  %i.au = load <8 x i8>, ptr %gep.7, align 1, !tbaa !76
  %i.av = insertelement <8 x i8> poison, i8 %i.at, i64 0
  %i.aw = insertelement <8 x i8> %i.av, i8 %i.as, i64 1
  %18 = shufflevector <4 x i8> %17, <4 x i8> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %19 = shufflevector <8 x i8> %i.aw, <8 x i8> %18, <8 x i32> <i32 0, i32 1, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 poison>
  %20 = shufflevector <2 x i8> %16, <2 x i8> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %21 = shufflevector <8 x i8> %19, <8 x i8> %20, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 8, i32 9>
  %i.ax = xor <8 x i8> %i.au, %21
