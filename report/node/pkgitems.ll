...
begin_hunk_1_@_ZN6icu_787Package16enumDependenciesEPNS_4ItemEPvPFvS3_PKcS5_E:bb.a
  ...
  %i.bi = load i32, ptr %i.o, align 8
  %i.bj = sext i32 %i.bi to i64
  %i.bk = call noalias noundef nonnull ptr @_Znam(i64 noundef %i.bj) #12 ; 4 uses
  %i.bl = load ptr, ptr %i.m, align 8
  %5 = load i32, ptr %i.o, align 8
  %i.bm = call noundef i32 @ures_swap_78(ptr noundef %i.ax, ptr noundef %i.bl, i32 noundef %5, ptr noundef nonnull %i.bk, ptr noundef nonnull %i.c) #9, !inline_history !5 ; 0 uses
