...
_ZN2v88internal8Counters28gc_incremental_marking_startEv.exit.sink.split: ; preds = %bb.q, %bb.r, %bb.o, %bb.p
  ...
  %.ph = phi i64 [ 5, %bb.o ], [ 5, %bb.p ], [ 7, %bb.r ], [ 7, %bb.q ]
...
_ZN2v88internal8Counters28gc_incremental_marking_startEv.exit: ; preds = %_ZN2v88internal8Counters28gc_incremental_marking_startEv.exit.sink.split, %.critedge62, %_ZN2v88internal8Counters26incremental_marking_reasonEv.exit
  %9 = phi i64 [ 7, %.critedge62 ], [ 5, %_ZN2v88internal8Counters26incremental_marking_reasonEv.exit ], [ %.ph, %_ZN2v88internal8Counters28gc_incremental_marking_startEv.exit.sink.split ] ; 2 uses
  %i.cq = phi i32 [ 7, %.critedge62 ], [ 5, %_ZN2v88internal8Counters26incremental_marking_reasonEv.exit ], [ %.ph.a, %_ZN2v88internal8Counters28gc_incremental_marking_startEv.exit.sink.split ] ; 5 uses
