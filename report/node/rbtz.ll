...
bb.i:                                             ; preds = %bb.h
  ...
  %i.aa = tail call noalias ptr @uprv_malloc_78(i64 noundef %i.z) #12 ; 7 uses
...
.thread246:                                       ; preds = %bb.j, %_ZN6icu_7812LocalPointerINS_10TransitionEED2Ev.exit.thread
  call void @uprv_free_78(ptr noundef %i.aa) #11
  br label %.thread270

bb.ag:                                            ; preds = %_ZN6icu_7812LocalPointerINS_10TransitionEED2Ev.exit
  call void @uprv_free_78(ptr noundef nonnull %i.aa) #11
  br label %.thread270
...
.thread270:                                       ; preds = %bb.aj, %bb.ak, %bb.ag, %bb.al, %_ZN6icu_7812LocalPointerINS_10TransitionEED2Ev.exit176.thread, %.thread246, %_ZN6icu_7812LocalPointerINS_10TransitionEED2Ev.exit176
