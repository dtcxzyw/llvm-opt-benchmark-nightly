...
@.str = private unnamed_addr constant [50 x i8] c"../../deps/openssl/openssl/crypto/asn1/asn1_lib.c\00", align 1
...
define dso_local range(i32 0, 2) i32 @ASN1_check_infinite_end(ptr nofree noundef captures(none) %0, i64 noundef %1) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(read, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable
define dso_local range(i32 0, 2) i32 @ASN1_const_check_infinite_end(ptr nofree noundef captures(none) %0, i64 noundef %1) local_unnamed_addr #0 {
bb.a:
  %i.a = icmp slt i64 %1, 1
  br i1 %i.a, label %_asn1_check_infinite_end.exit, label %bb.b
...
define dso_local range(i32 0, 192) i32 @ASN1_get_object(ptr nofree noundef captures(none) %0, ptr nofree noundef writeonly captures(none) %1, ptr nofree noundef writeonly captures(none) %2, ptr nofree noundef writeonly captures(none) %3, i64 noundef %4) local_unnamed_addr #1 {
bb.a:
...
bb.c:                                             ; preds = %bb.a
  %i.c = load i8, ptr %i.a, align 1, !tbaa !13
...
.preheader:                                       ; preds = %bb.d, %bb.e
  ...
  %i.k = load i8, ptr %.051, align 1, !tbaa !13   ; 3 uses
...
bb.e:                                             ; preds = %.preheader
  ...
  br i1 %or.cond, label %asn1_get_length.exit.thread, label %.preheader, !llvm.loop !14
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  store i32 %.029, ptr %2, align 4, !tbaa !16
  store i32 %i.f, ptr %3, align 4, !tbaa !16
...
.lr.ph.preheader.i:                               ; preds = %.preheader33.i
  %i.ai = zext nneg i8 %i.ad to i64
  %i.aj = getelementptr i8, ptr %.152, i64 %i.ai
  %scevgep.i = getelementptr i8, ptr %i.aj, i64 1
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %bb.k, %.lr.ph.preheader.i
  %indvar = phi i32 [ %indvar.next, %bb.k ], [ 0, %.lr.ph.preheader.i ] ; 2 uses
  %.036.i = phi i32 [ %i.an, %bb.k ], [ %i.af, %.lr.ph.preheader.i ] ; 6 uses
  %.02835.i = phi ptr [ %i.am, %bb.k ], [ %i.ae, %.lr.ph.preheader.i ] ; 6 uses
...
bb.k:                                             ; preds = %.lr.ph.i
  ...
  br i1 %.not32.i, label %.thread, label %.lr.ph.i, !llvm.loop !17

.critedge.i:                                      ; preds = %.lr.ph.i
  %5 = icmp samesign ugt i32 %.036.i, 8
  br i1 %5, label %asn1_get_length.exit.thread, label %.preheader.i

.preheader.i:                                     ; preds = %.critedge.i
  %.not47.i = icmp eq i32 %.036.i, 0
  br i1 %.not47.i, label %.thread, label %.lr.ph44.i.preheader

.lr.ph44.i.preheader:                             ; preds = %.preheader.i
...
.lr.ph44.i:                                       ; preds = %.lr.ph44.i, %.lr.ph44.i.preheader.new
  ...
  %niter = phi i32 [ 0, %.lr.ph44.i.preheader.new ], [ %niter.next.3, %.lr.ph44.i ]
  ...
  br i1 %niter.ncmp.3.not, label %._crit_edge.i.unr-lcssa, label %.lr.ph44.i, !llvm.loop !18

._crit_edge.i.unr-lcssa:                          ; preds = %.lr.ph44.i
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %._crit_edge.i, label %.lr.ph44.i.epil.preheader

.lr.ph44.i.epil.preheader:                        ; preds = %._crit_edge.i.unr-lcssa, %.lr.ph44.i.preheader
  %.02642.i.epil.init = phi i64 [ 0, %.lr.ph44.i.preheader ], [ %i.at, %._crit_edge.i.unr-lcssa ]
  %.12941.i.epil.init = phi ptr [ %.02835.i, %.lr.ph44.i.preheader ], [ %i.aq, %._crit_edge.i.unr-lcssa ]
...
.lr.ph44.i.epil:                                  ; preds = %.lr.ph44.i.epil, %.lr.ph44.i.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge.i, label %.lr.ph44.i.epil, !llvm.loop !19
...
._crit_edge.i:                                    ; preds = %.lr.ph44.i.epil, %._crit_edge.i.unr-lcssa
  ...
  %i.au = zext nneg i32 %.036.i to i64
  %scevgep49.i = getelementptr i8, ptr %.02835.i, i64 %i.au
  %i.av = icmp slt i64 %.lcssa110, 0
  br i1 %i.av, label %asn1_get_length.exit.thread, label %.thread

bb.l:                                             ; preds = %bb.i
  %i.aw = zext nneg i8 %i.ad to i64
  br label %.thread

.thread:                                          ; preds = %bb.k, %bb.l, %.preheader33.i, %.preheader.i, %._crit_edge.i
  %.2.i.ph = phi ptr [ %scevgep49.i, %._crit_edge.i ], [ %i.ae, %.preheader33.i ], [ %.02835.i, %.preheader.i ], [ %i.ae, %bb.l ], [ %scevgep.i, %bb.k ]
  %.127.i.ph = phi i64 [ %.lcssa, %._crit_edge.i ], [ 0, %.preheader33.i ], [ 0, %.preheader.i ], [ %i.aw, %bb.l ], [ 0, %bb.k ] ; 2 uses
  store i64 %.127.i.ph, ptr %1, align 8, !tbaa !21
  br label %bb.n

bb.m:                                             ; preds = %bb.h
  %i.ax = getelementptr inbounds nuw i8, ptr %.152, i64 1
...
bb.n:                                             ; preds = %.thread, %bb.m
  %i.ay = phi i64 [ %.127.i.ph, %.thread ], [ 0, %bb.m ]
  %.2.i64 = phi ptr [ %.2.i.ph, %.thread ], [ %i.ax, %bb.m ] ; 2 uses
  %.04963 = phi i32 [ 0, %.thread ], [ 1, %bb.m ]
  %i.az = ptrtoint ptr %.2.i64 to i64
  %i.ba = ptrtoint ptr %i.a to i64
  %.neg = add i64 %4, %i.ba
  %i.bb = sub i64 %.neg, %i.az
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bd = or disjoint i32 %i.e, 128
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n
  %.031 = phi i32 [ %i.bd, %bb.o ], [ %i.e, %bb.n ]
  store ptr %.2.i64, ptr %0, align 8, !tbaa !10
  %i.be = or i32 %.031, %.04963
  br label %bb.q
...
bb.q:                                             ; preds = %asn1_get_length.exit.thread, %bb.p, %bb.b
  %.032 = phi i32 [ 128, %bb.b ], [ 128, %asn1_get_length.exit.thread ], [ %i.be, %bb.p ]
  ret i32 %.032
}
...
define dso_local void @ASN1_put_object(ptr nofree noundef captures(none) %0, i32 noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %4) local_unnamed_addr #3 {
bb.a:
...
bb.c:                                             ; preds = %bb.a
  ...
  store i8 %i.k, ptr %i.a, align 1, !tbaa !13
  br label %bb.d
...
.preheader:                                       ; preds = %bb.d
  ...
  store i8 %i.n, ptr %i.o, align 1, !tbaa !13
...
.peel.next.prol:                                  ; preds = %.peel.next.preheader, %.peel.next.prol
  ...
  br i1 %prol.iter.cmp.not, label %.peel.next.prol.loopexit, label %.peel.next.prol, !llvm.loop !23
...
bb.d:                                             ; preds = %bb.c, %bb.d
  ...
  br i1 %.not39, label %.preheader, label %bb.d, !llvm.loop !24
...
.peel.next:                                       ; preds = %.peel.next.prol.loopexit, %.peel.next
  ...
  store i8 %spec.select, ptr %i.v, align 1, !tbaa !13
  ...
  store i8 %spec.select.1, ptr %i.y, align 1, !tbaa !13
  ...
  store i8 %spec.select.2, ptr %i.ab, align 1, !tbaa !13
  ...
  br i1 %i.af, label %.peel.next, label %.loopexit, !llvm.loop !25
...
bb.f:                                             ; preds = %bb.e
  ...
  store i8 -128, ptr %.033, align 1, !tbaa !13
...
bb.h:                                             ; preds = %bb.g
  ...
  store i8 %i.al, ptr %.033, align 1, !tbaa !13
  br label %asn1_put_length.exit
...
.preheader.i:                                     ; preds = %bb.g, %.preheader.i
  ...
  br i1 %.not.i, label %bb.i, label %.preheader.i, !llvm.loop !27

bb.i:                                             ; preds = %.preheader.i
  %i.ap = trunc i32 %i.ao to i8
  %i.aq = or i8 %i.ap, -128
  store i8 %i.aq, ptr %.033, align 1, !tbaa !13
...
.prol.preheader:                                  ; preds = %bb.i, %.prol.preheader
  ...
  br i1 %prol.iter53.cmp.not, label %.prol.loopexit, label %.prol.preheader, !llvm.loop !28
...
.new:                                             ; preds = %.prol.loopexit, %.new
  ...
  store i8 %i.bc, ptr %i.be, align 1, !tbaa !13
  ...
  br i1 %i.bj, label %.new, label %.unr-lcssa, !llvm.loop !29
...
define dso_local noundef i32 @ASN1_put_eoc(ptr nofree noundef captures(none) %0) local_unnamed_addr #4 {
bb.a:
...
define dso_local range(i32 -2147483646, -2147483648) i32 @ASN1_object_size(i32 noundef %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #5 {
bb.a:
...
.preheader:                                       ; preds = %bb.d, %.preheader
  ...
  br i1 %.not29, label %.loopexit, label %.preheader, !llvm.loop !30
...
; Function Attrs: nounwind uwtable
define dso_local range(i32 0, 2) i32 @ASN1_STRING_copy(ptr nofree noundef captures(none) %0, ptr nofree noundef readonly captures(address_is_null) %1) local_unnamed_addr #1 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load i32, ptr %1, align 8, !tbaa !35
...
bb.c:                                             ; preds = %bb.b
  ...
  store i64 %i.k, ptr %i.i, align 8, !tbaa !31
  %i.l = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.m = load i64, ptr %i.l, align 8, !tbaa !31
  %i.n = and i64 %i.m, -129
  %i.o = or disjoint i64 %i.n, %i.k
  store i64 %i.o, ptr %i.i, align 8, !tbaa !31
  br label %bb.d
...
; Function Attrs: nounwind uwtable
define dso_local range(i32 0, 2) i32 @ASN1_STRING_set(ptr nofree noundef captures(none) %0, ptr nofree noundef readonly captures(address_is_null) %1, i32 noundef %2) local_unnamed_addr #1 {
bb.a:
...
._crit_edge:                                      ; preds = %bb.g, %bb.h
  ...
  store ptr %i.n, ptr %i.l, align 8, !tbaa !34
...
; Function Attrs: nounwind uwtable
define dso_local ptr @ASN1_STRING_dup(ptr nofree noundef readonly captures(address_is_null) %0) local_unnamed_addr #1 {
bb.a:
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.h = load i32, ptr %0, align 8, !tbaa !35
...
bb.b:                                             ; preds = %bb.a
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 4
  store i32 4, ptr %i.c, align 4, !tbaa !33
...
; Function Attrs: nounwind uwtable
define dso_local void @ASN1_STRING_free(ptr noundef %0) local_unnamed_addr #1 {
bb.a:
...
; Function Attrs: nounwind uwtable
define dso_local void @ossl_asn1_string_embed_free(ptr noundef %0, i32 noundef %1) local_unnamed_addr #1 {
bb.a:
  %i.a = icmp eq ptr %0, null
...
; Function Attrs: nounwind uwtable
define dso_local void @ASN1_STRING_clear_free(ptr noundef %0) local_unnamed_addr #1 {
bb.a:
  %i.a = icmp eq ptr %0, null
...
bb.f:                                             ; preds = %bb.e
  %i.l = load ptr, ptr %i.b, align 8, !tbaa !34
...
bb.a:
  %i.a = load i32, ptr %0, align 8, !tbaa !35     ; 3 uses
...
; Function Attrs: nounwind uwtable
define dso_local ptr @ossl_sk_ASN1_UTF8STRING2text(ptr noundef %0, ptr nofree noundef readonly captures(address_is_null) %1, i64 noundef %2) local_unnamed_addr #1 {
bb.a:
  %i.a = icmp eq ptr %1, null
...
.lr.ph53.split.peel.next:                         ; preds = %bb.d, %.lr.ph53.split.peel.next
  ...
  %i.az = load i32, ptr %i.ay, align 8, !tbaa !35
...
attributes #3 = { nofree norecurse nosync nounwind memory(write, argmem: readwrite, inaccessiblemem: none, target_mem: none) uwtable "frame-pointer"="all" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!30 = distinct !{!30, !15}
!31 = !{!32, !22, i64 16}
!32 = !{!"asn1_string_st", !7, i64 0, !7, i64 4, !11, i64 8, !22, i64 16}
!33 = !{!32, !7, i64 4}
!34 = !{!32, !11, i64 8}
!35 = !{!32, !7, i64 0}
!36 = distinct !{!36, !15, !26}
!37 = distinct !{!37, !15, !26}
!38 = distinct !{!38, !15}
!39 = distinct !{!39, !15, !26}
end_hunk_0
