...
define dso_local range(i32 0, 162) i32 @ASN1_get_object(ptr nofree noundef captures(none) %0, ptr nofree noundef writeonly captures(none) %1, ptr nofree noundef writeonly captures(none) %2, ptr nofree noundef writeonly captures(none) %3, i64 noundef %4) local_unnamed_addr #1 {
bb.a:
...
bb.n:                                             ; preds = %.thread, %bb.m
  %i.az = phi i64 [ %.127.i.ph, %.thread ], [ 0, %bb.m ]
  %.2.i64 = phi ptr [ %.2.i.ph, %.thread ], [ %i.ay, %bb.m ] ; 2 uses
  %.04963 = phi i32 [ 0, %.thread ], [ 1, %bb.m ]
  %i.ba = ptrtoint ptr %.2.i64 to i64
  %i.bb = ptrtoint ptr %i.a to i64
  %.neg = add i64 %4, %i.bb
  %i.bc = sub i64 %.neg, %i.ba
...
bb.p:                                             ; preds = %bb.o, %bb.n
  %.031 = phi i32 [ %i.be, %bb.o ], [ %i.e, %bb.n ]
  store ptr %.2.i64, ptr %0, align 8, !tbaa !12
...
bb.q:                                             ; preds = %asn1_get_length.exit.thread, %bb.p, %bb.b
  %.032 = phi i32 [ 128, %bb.b ], [ 128, %asn1_get_length.exit.thread ], [ %i.bf, %bb.p ]
  ret i32 %.032
}
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !12     ; 9 uses
  %.not = icmp eq i32 %1, 0
...
asn1_put_length.exit:                             ; preds = %.unr-lcssa, %bb.h, %bb.f
  ...
  store ptr %.134, ptr %0, align 8, !tbaa !12
  ret void
}
