...
bb.e:                                             ; preds = %.lr.ph, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit
  ...
  %i.al = phi i32 [ %i.m, %.lr.ph ], [ %i.be, %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit ] ; 2 uses
  ...
  br i1 %i.aq, label %3, label %bb.g

3:                                                ; preds = %bb.e
  %4 = icmp sgt i32 %i.ao, -1
  %.not.i = icmp slt i32 %i.ao, %i.al
  %or.cond10.i = and i1 %4, %.not.i
  br i1 %or.cond10.i, label %bb.f, label %_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit
...
_ZNK6icu_786number4impl15DecimalQuantity11getDigitPosEi.exit: ; preds = %3, %bb.f, %bb.g, %bb.h
  %.0.i = phi i8 [ %i.ba, %bb.h ], [ %i.au, %bb.f ], [ 0, %3 ], [ 0, %bb.g ]
  %i.bb = add i8 %.0.i, 48
