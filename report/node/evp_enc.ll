...
bb.e:                                             ; preds = %bb.b
  %i.f = load ptr, ptr %0, align 8, !tbaa !9      ; 5 uses
...
bb.l:                                             ; preds = %bb.k
  %i.w = load i64, ptr %i.c, align 8, !tbaa !41   ; 2 uses
...
bb.n:                                             ; preds = %bb.l
  ...
  store i32 %i.y, ptr %2, align 4, !tbaa !5
  br label %bb.af
...
bb.q:                                             ; preds = %bb.p
  store i32 %i.ae, ptr %2, align 4, !tbaa !5
  br label %bb.af

bb.r:                                             ; preds = %bb.o
  %i.ag = getelementptr inbounds nuw i8, ptr %i.f, i64 4
  %i.ah = load i32, ptr %i.ag, align 4, !tbaa !58 ; 6 uses
...
bb.aa:                                            ; preds = %bb.y
  ...
  %i.ax = load i8, ptr %i.aw, align 1, !tbaa !72  ; 3 uses
...
bb.ac:                                            ; preds = %.preheader
  ...
  br i1 %exitcond.not, label %bb.ae, label %.preheader, !llvm.loop !73
...
.preheader:                                       ; preds = %bb.aa, %bb.ac
  ...
  %i.bf = load i8, ptr %i.be, align 1, !tbaa !72
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %wide.load = load <16 x i8>, ptr %i.at, align 8, !tbaa !72
  %wide.load91 = load <16 x i8>, ptr %3, align 8, !tbaa !72
...
vector.body.1:                                    ; preds = %vector.ph
  ...
  %wide.load.1 = load <16 x i8>, ptr %6, align 8, !tbaa !72
  %wide.load91.1 = load <16 x i8>, ptr %7, align 8, !tbaa !72
...
vector.body.2:                                    ; preds = %vector.body.1
  ...
  %wide.load.2 = load <16 x i8>, ptr %11, align 8, !tbaa !72
  %wide.load91.2 = load <16 x i8>, ptr %12, align 8, !tbaa !72
...
vector.body.3:                                    ; preds = %vector.body.2
  ...
  %wide.load.3 = load <16 x i8>, ptr %16, align 8, !tbaa !72
  %wide.load91.3 = load <16 x i8>, ptr %17, align 8, !tbaa !72
...
vector.body.4:                                    ; preds = %vector.body.3
  ...
  %wide.load.4 = load <16 x i8>, ptr %21, align 8, !tbaa !72
  %wide.load91.4 = load <16 x i8>, ptr %22, align 8, !tbaa !72
...
vector.body:                                      ; preds = %vector.body.4
  ...
  %wide.load.a = load <16 x i8>, ptr %i.bk, align 8, !tbaa !72
  %wide.load91.a = load <16 x i8>, ptr %i.bl, align 8, !tbaa !72
...
vector.body.6:                                    ; preds = %vector.body
  ...
  %wide.load.6 = load <16 x i8>, ptr %26, align 8, !tbaa !72
  %wide.load91.6 = load <16 x i8>, ptr %27, align 8, !tbaa !72
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load95 = load <4 x i8>, ptr %i.bp, align 1, !tbaa !72
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader, %.lr.ph.prol
  ...
  %i.bt = load i8, ptr %i.bs, align 1, !tbaa !72
  %i.bu = getelementptr inbounds nuw i8, ptr %1, i64 %indvars.iv.prol
  store i8 %i.bt, ptr %i.bu, align 1, !tbaa !72
...
bb.a:
  ...
  br i1 %i.a, label %bb.b, label %bb.c, !prof !65
...
bb.c:                                             ; preds = %bb.a
  ...
  br i1 %i.c, label %bb.d, label %bb.e, !prof !65
...
bb.e:                                             ; preds = %bb.c
  ...
  br i1 %i.f, label %bb.f, label %bb.g, !prof !65
...
bb.g:                                             ; preds = %bb.e
  ...
  br i1 %i.i, label %bb.h, label %.preheader, !prof !65
...
safe_div_round_up_int.exit:                       ; preds = %bb.e, %bb.c, %bb.a
  ...
  %i.k = load ptr, ptr %0, align 8, !tbaa !9      ; 4 uses
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 4
  %i.m = load i32, ptr %i.l, align 4, !tbaa !58   ; 9 uses
...
safe_div_round_up_int.exit.thread:                ; preds = %bb.d
  %i.q = load ptr, ptr %0, align 8, !tbaa !9      ; 3 uses
...
bb.j:                                             ; preds = %bb.i
  store i32 %i.al, ptr %2, align 4, !tbaa !5
  br label %bb.ag
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ar = load i32, ptr %i.aq, align 4, !tbaa !61 ; 3 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.bt = load i32, ptr %i.aq, align 4, !tbaa !61
  %i.bu = add nsw i32 %i.bt, %4
  store i32 %i.bu, ptr %i.aq, align 4, !tbaa !61
  store i32 0, ptr %2, align 4, !tbaa !5
  br label %bb.ag
...
bb.ab:                                            ; preds = %bb.aa
  %i.co = load ptr, ptr %0, align 8, !tbaa !9
  %i.cp = getelementptr inbounds nuw i8, ptr %i.co, i64 40
  %i.cq = load ptr, ptr %i.cp, align 8, !tbaa !68
...
bb.ac:                                            ; preds = %bb.ab
  %i.ct = load i32, ptr %2, align 4, !tbaa !5
  %i.cu = add nsw i32 %i.ct, %i.cm
  store i32 %i.cu, ptr %2, align 4, !tbaa !5
  br label %bb.ad
...
bb.af:                                            ; preds = %bb.ae, %bb.ad
  store i32 %i.cl, ptr %i.aq, align 4, !tbaa !61
  br label %bb.ag
...
bb.c:                                             ; preds = %bb.b
  %i.g = load ptr, ptr %0, align 8, !tbaa !9      ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.m = tail call ptr %i.l(ptr noundef null, ptr noundef %i.k) #8, !inline_history !83
...
bb.i:                                             ; preds = %bb.h
  ...
  store i32 %1, ptr %i.v, align 8, !tbaa !55
  br label %bb.j
...
bb.p:                                             ; preds = %bb.o
  ...
  store i32 %1, ptr %i.ah, align 8, !tbaa !55
  br label %bb.r
...
bb.b:                                             ; preds = %bb.a
  %i.e = load ptr, ptr %0, align 8, !tbaa !9      ; 3 uses
  %i.f = icmp eq ptr %i.e, null
...
bb.h:                                             ; preds = %bb.g
  ...
  store i32 -1, ptr %i.k, align 8, !tbaa !55
  br label %.thread
...
bb.ap:                                            ; preds = %bb.ao
  %i.ci = load i64, ptr %i.a, align 8, !tbaa !41
...
.thread:                                          ; preds = %bb.y, %bb.t, %bb.o, %bb.n, %bb.l, %bb.ar, %bb.h, %bb.as
  %i.cl = load ptr, ptr %0, align 8, !tbaa !9
...
bb.a:
  ...
  store i64 %.sink, ptr %i.b, align 8, !tbaa !32
  %i.e = load ptr, ptr %0, align 8, !tbaa !9      ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  %i.b = load ptr, ptr %1, align 8, !tbaa !9      ; 3 uses
  %i.c = icmp eq ptr %i.b, null
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !22   ; 3 uses
...
EVP_CIPHER_up_ref.exit:                           ; preds = %bb.i, %bb.h, %bb.g
  ...
  store ptr %i.x, ptr %i.k, align 8, !tbaa !20
...
bb.n:                                             ; preds = %bb.l, %bb.k
  ...
  %.pre = load ptr, ptr %1, align 8, !tbaa !9     ; 3 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  store ptr %i.ai, ptr %i.aj, align 8, !tbaa !26
...
bb.r:                                             ; preds = %bb.p
  %i.al = load ptr, ptr %i.ad, align 8, !tbaa !26
  %i.am = load ptr, ptr %1, align 8, !tbaa !9     ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %i.f = load i32, ptr %i.c, align 8, !tbaa !46
...
bb.h:                                             ; preds = %bb.g
  %i.aj = load ptr, ptr %i.ah, align 8, !tbaa !33
...
bb.j:                                             ; preds = %bb.g
  %i.am = load ptr, ptr %i.ag, align 8, !tbaa !42
...
bb.n:                                             ; preds = %bb.g
  %i.aq = load ptr, ptr %i.ae, align 8, !tbaa !39
...
bb.p:                                             ; preds = %bb.g
  %i.as = load ptr, ptr %i.ad, align 8, !tbaa !44
...
bb.r:                                             ; preds = %bb.g
  %i.au = load ptr, ptr %i.ac, align 8, !tbaa !66
...
bb.t:                                             ; preds = %bb.g
  %i.ax = load ptr, ptr %i.ab, align 8, !tbaa !71
...
bb.x:                                             ; preds = %bb.g
  %i.bc = load ptr, ptr %i.z, align 8, !tbaa !49
...
bb.z:                                             ; preds = %bb.g
  %i.bf = load ptr, ptr %i.y, align 8, !tbaa !50
...
bb.ab:                                            ; preds = %bb.g
  %i.bi = load ptr, ptr %i.x, align 8, !tbaa !51
...
bb.ad:                                            ; preds = %bb.g
  %i.bl = load ptr, ptr %i.w, align 8, !tbaa !52
...
bb.af:                                            ; preds = %bb.g
  %i.bo = load ptr, ptr %i.v, align 8, !tbaa !21
...
bb.an:                                            ; preds = %bb.g
  %i.bx = load ptr, ptr %i.r, align 8, !tbaa !53
...
bb.ba:                                            ; preds = %bb.az
  %i.cm = load ptr, ptr %i.x, align 8, !tbaa !51
  %i.cn = icmp eq ptr %i.cm, null
  br i1 %i.cn, label %.sink.split, label %bb.bb

bb.bb:                                            ; preds = %bb.ba
  %i.co = load ptr, ptr %i.w, align 8, !tbaa !52
...
bb.bf:                                            ; preds = %bb.be, %bb.bd
  ...
  store ptr %2, ptr %i.cs, align 8, !tbaa !15
...
bb.bg:                                            ; preds = %.sink.split, %bb.e, %bb.be
  ...
  %i.cv = load i32, ptr %i.cu, align 8, !tbaa !23
...
bb.bi:                                            ; preds = %CRYPTO_DOWN_REF.exit.i, %CRYPTO_DOWN_REF.exit.thread.i
  ...
  %i.da = load ptr, ptr %i.cz, align 8, !tbaa !24
...
bb.a:
  ...
  %i.b = load i32, ptr %1, align 4, !tbaa !5
...
!14 = !{!"long", !7, i64 0}
!15 = !{!16, !18, i64 120}
!16 = !{!"evp_cipher_st", !6, i64 0, !6, i64 4, !6, i64 8, !6, i64 12, !14, i64 16, !6, i64 24, !12, i64 32, !12, i64 40, !12, i64 48, !6, i64 56, !12, i64 64, !12, i64 72, !12, i64 80, !12, i64 88, !6, i64 96, !17, i64 104, !17, i64 112, !18, i64 120, !19, i64 128, !12, i64 136, !12, i64 144, !12, i64 152, !12, i64 160, !12, i64 168, !12, i64 176, !12, i64 184, !12, i64 192, !12, i64 200, !12, i64 208, !12, i64 216, !12, i64 224, !12, i64 232, !12, i64 240, !12, i64 248, !12, i64 256, !12, i64 264, !12, i64 272, !12, i64 280, !12, i64 288}
!17 = !{!"p1 omnipotent char", !12, i64 0}
!18 = !{!"p1 _ZTS16ossl_provider_st", !12, i64 0}
!19 = !{!"", !7, i64 0}
!20 = !{!10, !12, i64 176}
!21 = !{!16, !12, i64 216}
!22 = !{!10, !11, i64 184}
...
!33 = !{!16, !12, i64 136}
!34 = !{!35, !36, i64 24}
!35 = !{!"evp_skey_st", !19, i64 0, !12, i64 8, !12, i64 16, !36, i64 24}
!36 = !{!"p1 _ZTS15evp_skeymgmt_st", !12, i64 0}
!37 = !{!38, !18, i64 24}
!38 = !{!"evp_skeymgmt_st", !6, i64 0, !17, i64 8, !17, i64 16, !18, i64 24, !19, i64 32, !12, i64 40, !12, i64 48, !12, i64 56, !12, i64 64, !12, i64 72, !12, i64 80, !12, i64 88}
!39 = !{!16, !12, i64 280}
!40 = !{!17, !17, i64 0}
!41 = !{!14, !14, i64 0}
!42 = !{!16, !12, i64 144}
...
!46 = !{!16, !6, i64 0}
!47 = !{}
!48 = !{!"branch_weights", !"expected", i32 3935085, i32 2143548563}
!49 = !{!16, !12, i64 184}
!50 = !{!16, !12, i64 192}
!51 = !{!16, !12, i64 200}
!52 = !{!16, !12, i64 208}
!53 = !{!16, !12, i64 248}
!54 = !{ptr @EVP_CIPHER_CTX_set_params}
!55 = !{!10, !6, i64 104}
!56 = !{!16, !6, i64 8}
!57 = !{!16, !14, i64 16}
!58 = !{!16, !6, i64 4}
