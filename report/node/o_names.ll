...
.lr.ph:                                           ; preds = %.thread, %bb.e
  ...
  %i.r = tail call noalias ptr @CRYPTO_zalloc(i64 noundef 24, ptr noundef nonnull @.str, i32 noundef 90) #8 ; 4 uses
  %i.s = icmp eq ptr %i.r, null
  br i1 %i.s, label %.loopexit, label %bb.f

bb.f:                                             ; preds = %.lr.ph
  store <2 x ptr> <ptr @ossl_lh_strcasehash, ptr @OPENSSL_strcasecmp>, ptr %i.r, align 8, !tbaa !12
