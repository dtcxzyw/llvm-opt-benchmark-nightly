...
define internal fastcc void @"_ZZN2v88internal8compiler56TryMatchBaseWithScaledIndexAndDisplacement64ForWordBinopEPNS1_19InstructionSelectorENS1_10turboshaft7OpIndexES5_bENK3$_0clES5_S5_"(ptr dead_on_unwind noalias nonnull writable writeonly align 8 captures(none) initializes((32, 33)) %0, ptr readonly captures(none) %.0.val.0.val, i32 %1, i32 %2) unnamed_addr #8 align 2 {
bb.a:
...
define internal fastcc void @"_ZZN2v88internal8compiler56TryMatchBaseWithScaledIndexAndDisplacement64ForWordBinopEPNS1_19InstructionSelectorENS1_10turboshaft7OpIndexES5_bENK3$_1clES5_S5_"(ptr dead_on_unwind noalias nonnull writable writeonly align 8 captures(none) initializes((32, 33)) %0, ptr %.0.val.0.val.0.val.8.val, ptr readonly captures(none) %.8.val, i32 %1, i32 %2) unnamed_addr #9 align 2 {
bb.a:
...
"_ZZN2v88internal8compiler56TryMatchBaseWithScaledIndexAndDisplacement64ForWordBinopEPNS1_19InstructionSelectorENS1_10turboshaft7OpIndexES5_bENK3$_2clES5_S5_S5_S5_.exit39.thread": ; preds = %bb.n, %bb.q, %bb.r
  %.sroa.0.sroa.0.0.copyload = load <32 x i8>, ptr %3, align 8
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #25, !noalias !11
  store <32 x i8> %.sroa.0.sroa.0.0.copyload, ptr %0, align 8
...
define hidden void @_ZN2v88internal8compiler44TryMatchBaseWithScaledIndexAndDisplacement32EPNS1_19InstructionSelectorENS1_10turboshaft7OpIndexE(ptr dead_on_unwind noalias writable writeonly sret(%"class.std::optional.34") align 8 captures(none) initializes((32, 33)) %0, ptr noundef %1, i32 %2) local_unnamed_addr #3 {
bb.a:
