...
bb.af:                                            ; preds = %bb.ae
  call void (ptr, ...) @_Z8V8_FatalPKcz(ptr noundef nonnull @.str) #24, !noalias !133
  unreachable
...
.critedge146:                                     ; preds = %..critedge146_crit_edge, %bb.ac, %bb.o, %bb.d, %bb.ae, %bb.ad, %bb.a
  %.sroa.0.0.copyload = phi i32 [ %.sroa.0.0.copyload.pre, %..critedge146_crit_edge ], [ %.sroa.0.0.copyload.pre197, %bb.ac ], [ %.sroa.0.0.copyload.pre197, %bb.o ], [ %.sroa.0.0.copyload.pre197, %bb.d ], [ %.sroa.0.0.copyload.pre197, %bb.ae ], [ %.sroa.0.0.copyload.pre197, %bb.ad ], [ %.sroa.0.0.copyload.pre197, %bb.a ]
