...
bb.g:                                             ; preds = %bb.f
  ...
  %i.cf = icmp eq ptr %i.ce, getelementptr inbounds nuw (i8, ptr @_ZN2v88internal8v8_flagsE, i64 1964)
  ...
  %18 = freeze i1 %op.rdx
  %19 = or i1 %18, %17
  %op.rdx65 = select i1 %19, i1 true, i1 %i.cf
  br i1 %op.rdx65, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.cg = call noundef nonnull align 8 dereferenceable(8) ptr @_ZN2v88internallsERSoRKNS0_4FlagE(ptr noundef nonnull align 8 dereferenceable(8) %0, ptr noundef nonnull align 8 dereferenceable(56) %.0.ptr60) ; 0 uses
  br label %bb.i
