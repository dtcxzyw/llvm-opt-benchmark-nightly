...
define internal noundef signext range(i8 0, 2) i8 @_ZN6icu_7812_GLOBAL__N_113versionFilterEiPv(i32 noundef %0, ptr nofree noundef readonly captures(none) %1) #0 {
bb.a:
...
; Function Attrs: mustprogress nounwind uwtable
define dso_local noundef nonnull align 8 dereferenceable(200) ptr @_ZN6icu_7810UnicodeSet20applyPropertyPatternERKNS_13UnicodeStringERNS_13ParsePositionER10UErrorCode(ptr noundef nonnull returned align 8 dereferenceable(200) %0, ptr noundef nonnull align 8 dereferenceable(64) %1, ptr nofree noundef nonnull align 8 captures(none) dereferenceable(16) %2, ptr noundef nonnull align 4 dereferenceable(4) %3) local_unnamed_addr #0 align 2 {
bb.a:
...
bb.k:                                             ; preds = %_ZNK6icu_7813UnicodeString7indexOfEDsi.exit, %thread-pre-split
  ...
  %.049118 = phi i8 [ 0, %thread-pre-split ], [ %6, %_ZNK6icu_7813UnicodeString7indexOfEDsi.exit ] ; 2 uses
...
_ZNK6icu_7813UnicodeString7indexOfEDsi.exit85:    ; preds = %._ZNK6icu_7813UnicodeString8pinIndexERi.exit_crit_edge.i80, %bb.n
  ...
  %i.cr = call noundef i32 @_ZNK6icu_7813UnicodeString9doIndexOfEDsii(ptr noundef nonnull align 8 dereferenceable(64) %1, i16 noundef zeroext 61, i32 noundef %.0.i79, i32 noundef %i.cq) #10 ; 4 uses
  ...
  %7 = icmp slt i32 %i.cr, 0
  %i.cu = icmp samesign uge i32 %i.cr, %.045
  %8 = trunc nuw i8 %.049118 to i1
  %or.cond57 = or i1 %i.cu, %8
  %or.cond59 = select i1 %7, i1 true, i1 %or.cond57
  ...
  br i1 %or.cond59, label %bb.p, label %bb.o
...
bb.p:                                             ; preds = %_ZNK6icu_7813UnicodeString7indexOfEDsi.exit85
  ...
  %.not55 = icmp eq i8 %.049118, 0
  br i1 %.not55, label %bb.q, label %_ZN6icu_7813UnicodeStringaSIA3_DsvEERS0_RKT_.exit
