...
bb.ah:                                            ; preds = %_ZN2v88internal4wasm12_GLOBAL__N_116RegisterReuseMap3AddENS1_15LiftoffRegisterES4_.exit, %bb.ag, %bb.b, %bb.d, %_ZN2v88internal4wasm16LiftoffAssembler15NextSpillOffsetENS1_9ValueKindEi.exit85, %bb.f
  %.sroa.0117.4 = phi i8 [ %.sroa.0117.0151, %bb.b ], [ %.sroa.0117.0151, %_ZN2v88internal4wasm16LiftoffAssembler15NextSpillOffsetENS1_9ValueKindEi.exit85 ], [ %.sroa.0117.0151, %bb.d ], [ %.sroa.0117.0151, %bb.f ], [ %.sroa.0117.3, %bb.ag ], [ %.sroa.0117.3, %_ZN2v88internal4wasm12_GLOBAL__N_116RegisterReuseMap3AddENS1_15LiftoffRegisterES4_.exit ]
  %.2 = phi i32 [ 0, %bb.b ], [ %.0.i84, %_ZN2v88internal4wasm16LiftoffAssembler15NextSpillOffsetENS1_9ValueKindEi.exit85 ], [ %.0.i84, %bb.d ], [ %.075152, %bb.f ], [ %.1, %bb.ag ], [ %.1, %_ZN2v88internal4wasm12_GLOBAL__N_116RegisterReuseMap3AddENS1_15LiftoffRegisterES4_.exit ]
...
.lr.ph:                                           ; preds = %bb.e, %bb.i
  %.029 = phi i32 [ %.0.i, %bb.i ], [ %i.x, %bb.e ] ; 2 uses
  %.02128 = phi ptr [ %i.ad, %bb.i ], [ %i.d, %bb.e ] ; 5 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %.02128, i64 12 ; 3 uses
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %.02128, ptr noundef nonnull align 4 dereferenceable(12) %i.ad, i64 12, i1 false)
  %i.ae = getelementptr inbounds nuw i8, ptr %.02128, i64 1
...
_ZN2v88internal4wasm16LiftoffAssembler15NextSpillOffsetENS1_9ValueKindEi.exit: ; preds = %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit, %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit25
  ...
  %i.ap = getelementptr inbounds nuw i8, ptr %.02128, i64 8 ; 2 uses
...
bb.f:                                             ; preds = %_ZN2v88internal4wasm16LiftoffAssembler15NextSpillOffsetENS1_9ValueKindEi.exit
  %i.as = load i8, ptr %.02128, align 4
