...
bb.a:
  ...
  %i.j = tail call range(i64 0, 65) i64 @llvm.ctlz.i64(i64 %spec.select.i.i, i1 false) ; 2 uses
...
bb.c:                                             ; preds = %bb.a
  %i.n = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.l) #24 ; 9 uses
  %i.o = icmp eq ptr %i.c, %i.b
  br i1 %i.o, label %_ZSt18uninitialized_moveIPN2v88internal4wasm15LiftoffRegisterES4_ET0_T_S6_S5_.exit, label %iter.check
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec17 = and i64 %i.q, -4                     ; 4 uses
  %i.x = getelementptr i8, ptr %i.n, i64 %n.vec17
  %i.y = getelementptr i8, ptr %i.c, i64 %n.vec17
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index18 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next22, %vec.epilog.vector.body ] ; 3 uses
  %next.gep19 = getelementptr i8, ptr %i.n, i64 %index18
  %next.gep20 = getelementptr i8, ptr %i.c, i64 %index18
  ...
  %i.z = icmp eq i64 %index.next22, %n.vec17
  br i1 %i.z, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !57

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n23 = icmp eq i64 %i.q, %n.vec17
...
.lr.ph.i.i.i.i.prol:                              ; preds = %.lr.ph.i.i.i.i.preheader, %.lr.ph.i.i.i.i.prol
  %.08.i.i.i.i.prol = phi ptr [ %i.ad, %.lr.ph.i.i.i.i.prol ], [ %.08.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader ] ; 2 uses
  %.sroa.04.07.i.i.i.i.prol = phi ptr [ %i.ac, %.lr.ph.i.i.i.i.prol ], [ %.sroa.04.07.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader ] ; 2 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph.i.i.i.i.prol ], [ 0, %.lr.ph.i.i.i.i.preheader ]
  %i.ab = load i8, ptr %.sroa.04.07.i.i.i.i.prol, align 1
  store i8 %i.ab, ptr %.08.i.i.i.i.prol, align 1
  %i.ac = getelementptr inbounds nuw i8, ptr %.sroa.04.07.i.i.i.i.prol, i64 1 ; 2 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %.08.i.i.i.i.prol, i64 1 ; 2 uses
...
.lr.ph.i.i.i.i.prol.loopexit:                     ; preds = %.lr.ph.i.i.i.i.prol, %.lr.ph.i.i.i.i.preheader
  %.08.i.i.i.i.unr = phi ptr [ %.08.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader ], [ %i.ad, %.lr.ph.i.i.i.i.prol ]
  %.sroa.04.07.i.i.i.i.unr = phi ptr [ %.sroa.04.07.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader ], [ %i.ac, %.lr.ph.i.i.i.i.prol ]
  %i.ae = sub i64 %.sroa.04.07.i.i.i.i.ph26, %2
  %i.af = icmp ugt i64 %i.ae, -8
  br i1 %i.af, label %_ZSt18uninitialized_moveIPN2v88internal4wasm15LiftoffRegisterES4_ET0_T_S6_S5_.exit, label %.lr.ph.i.i.i.i

.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.prol.loopexit, %.lr.ph.i.i.i.i
  %.08.i.i.i.i = phi ptr [ %i.bd, %.lr.ph.i.i.i.i ], [ %.08.i.i.i.i.unr, %.lr.ph.i.i.i.i.prol.loopexit ] ; 9 uses
  %.sroa.04.07.i.i.i.i = phi ptr [ %i.bc, %.lr.ph.i.i.i.i ], [ %.sroa.04.07.i.i.i.i.unr, %.lr.ph.i.i.i.i.prol.loopexit ] ; 9 uses
  %i.ag = load i8, ptr %.sroa.04.07.i.i.i.i, align 1
  store i8 %i.ag, ptr %.08.i.i.i.i, align 1
  %i.ah = getelementptr inbounds nuw i8, ptr %.sroa.04.07.i.i.i.i, i64 1
  %i.ai = getelementptr inbounds nuw i8, ptr %.08.i.i.i.i, i64 1
  %i.aj = load i8, ptr %i.ah, align 1
  store i8 %i.aj, ptr %i.ai, align 1
  %i.ak = getelementptr inbounds nuw i8, ptr %.sroa.04.07.i.i.i.i, i64 2
  %i.al = getelementptr inbounds nuw i8, ptr %.08.i.i.i.i, i64 2
  %i.am = load i8, ptr %i.ak, align 1
  store i8 %i.am, ptr %i.al, align 1
  %i.an = getelementptr inbounds nuw i8, ptr %.sroa.04.07.i.i.i.i, i64 3
  %i.ao = getelementptr inbounds nuw i8, ptr %.08.i.i.i.i, i64 3
  %i.ap = load i8, ptr %i.an, align 1
  store i8 %i.ap, ptr %i.ao, align 1
  %i.aq = getelementptr inbounds nuw i8, ptr %.sroa.04.07.i.i.i.i, i64 4
  %i.ar = getelementptr inbounds nuw i8, ptr %.08.i.i.i.i, i64 4
  %i.as = load i8, ptr %i.aq, align 1
  store i8 %i.as, ptr %i.ar, align 1
  %i.at = getelementptr inbounds nuw i8, ptr %.sroa.04.07.i.i.i.i, i64 5
  %i.au = getelementptr inbounds nuw i8, ptr %.08.i.i.i.i, i64 5
  %i.av = load i8, ptr %i.at, align 1
  store i8 %i.av, ptr %i.au, align 1
  %i.aw = getelementptr inbounds nuw i8, ptr %.sroa.04.07.i.i.i.i, i64 6
  %i.ax = getelementptr inbounds nuw i8, ptr %.08.i.i.i.i, i64 6
  %i.ay = load i8, ptr %i.aw, align 1
  store i8 %i.ay, ptr %i.ax, align 1
  %i.az = getelementptr inbounds nuw i8, ptr %.sroa.04.07.i.i.i.i, i64 7
  %i.ba = getelementptr inbounds nuw i8, ptr %.08.i.i.i.i, i64 7
  %i.bb = load i8, ptr %i.az, align 1
  store i8 %i.bb, ptr %i.ba, align 1
  %i.bc = getelementptr inbounds nuw i8, ptr %.sroa.04.07.i.i.i.i, i64 8 ; 2 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %.08.i.i.i.i, i64 8
  %i.be = icmp eq ptr %i.bc, %i.b
  br i1 %i.be, label %_ZSt18uninitialized_moveIPN2v88internal4wasm15LiftoffRegisterES4_ET0_T_S6_S5_.exit, label %.lr.ph.i.i.i.i, !llvm.loop !60
...
_ZSt18uninitialized_moveIPN2v88internal4wasm15LiftoffRegisterES4_ET0_T_S6_S5_.exit: ; preds = %.lr.ph.i.i.i.i.prol.loopexit, %.lr.ph.i.i.i.i, %middle.block, %vec.epilog.middle.block, %bb.c
  ...
  %i.bh = getelementptr inbounds nuw i8, ptr %i.n, i64 %i.bg
  store ptr %i.bh, ptr %i.a, align 8
  %i.bi = getelementptr inbounds nuw i8, ptr %i.n, i64 %i.l
