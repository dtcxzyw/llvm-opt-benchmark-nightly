...
bb.g:                                             ; preds = %_ZN2v88internal4wasm16LiftoffAssembler17GetUnusedRegisterENS1_8RegClassENS1_14LiftoffRegListE.exit
  ...
  %i.y = sub nsw i32 0, %2                        ; 2 uses
  %i.z = icmp samesign ult i32 %2, 129            ; 2 uses
  %i.aa = shl i32 %i.y, 24
  ...
  %storemerge.i.i.i = select i1 %i.z, i64 %.sroa.0.3.insert.insert11.i.i, i64 %.sroa.0.3.insert.insert.i.i
  %.fca.1.load.cast.i.i.i = select i1 %i.z, ptr inttoptr (i64 2 to ptr), ptr inttoptr (i64 5 to ptr)
  tail call void @_ZN2v88internal4wasm7liftoff13LoadFromStackEPNS1_16LiftoffAssemblerENS1_15LiftoffRegisterENS0_7OperandENS1_9ValueKindE(ptr noundef nonnull align 8 dereferenceable(824) %0, i8 %.sroa.06.0.i.i, i64 %storemerge.i.i.i, ptr nonnull %.fca.1.load.cast.i.i.i, i8 noundef zeroext %.sroa.2.0.extract.trunc)
...
_ZNK2v88internal4wasm15LiftoffVarState8constantEv.exit80: ; preds = %bb.u
  ...
  %i.dd = load i32, ptr %i.dc, align 4            ; 5 uses
...
_ZNK2v88internal4wasm13ValueTypeBase4kindEv.exit.i: ; preds = %_ZNK2v88internal4wasm15LiftoffVarState8constantEv.exit80, %bb.y
  %i.dl = sub nsw i32 0, %i.dd                    ; 2 uses
  %i.dm = icmp samesign ult i32 %i.dd, 129        ; 2 uses
  ...
  %storemerge.i.i = select i1 %i.dm, i64 %.sroa.036.3.insert.insert44.i, i64 %.sroa.036.3.insert.insert.i ; 4 uses
  %.fca.1.load.cast.i.i = select i1 %i.dm, ptr inttoptr (i64 2 to ptr), ptr inttoptr (i64 5 to ptr) ; 4 uses
  br i1 %.not93, label %bb.z, label %bb.aa

bb.z:                                             ; preds = %_ZNK2v88internal4wasm13ValueTypeBase4kindEv.exit.i
  tail call void @_ZN2v88internal9Assembler8emit_movENS0_7OperandENS0_9ImmediateEi(ptr noundef nonnull align 8 dereferenceable(824) %0, i64 %storemerge.i.i, ptr nonnull %.fca.1.load.cast.i.i, i64 %.sroa.2.sroa.0.0.insert.ext, i32 noundef 4) #21
...
bb.ab:                                            ; preds = %bb.aa
  tail call void @_ZN2v88internal9Assembler8emit_movENS0_7OperandENS0_9ImmediateEi(ptr noundef nonnull align 8 dereferenceable(824) %0, i64 %storemerge.i.i, ptr nonnull %.fca.1.load.cast.i.i, i64 %.sroa.2.sroa.0.0.insert.ext, i32 noundef 8) #21
  br label %_ZN2v88internal4wasm16LiftoffAssembler5SpillEiNS1_9WasmValueE.exit
...
bb.ad:                                            ; preds = %bb.ac
  ...
  tail call void @_ZN2v88internal9Assembler8emit_movENS0_7OperandENS0_8RegisterEi(ptr noundef nonnull align 8 dereferenceable(824) %0, i64 %storemerge.i.i, ptr nonnull %.fca.1.load.cast.i.i, i8 10, i32 noundef 8) #21
  br label %_ZN2v88internal4wasm16LiftoffAssembler5SpillEiNS1_9WasmValueE.exit
...
_ZNK2v88internal4wasm16LiftoffAssembler14TopSpillOffsetEv.exit.i: ; preds = %bb.r, %bb.q
  ...
  %3 = icmp samesign ugt i8 %i.ab, 8
  br i1 %3, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit3.i, label %_ZN2v88internal4wasm16LiftoffAssembler15SlotSizeForTypeENS1_9ValueKindE.exit.i
