begin_hunk_0
  ...
  br i1 %i.kr, label %.lr.ph487, label %._crit_edge482
...
begin_hunk_1
  ...
  br i1 %i.mj, label %.lr.ph487, label %._crit_edge482, !llvm.loop !18
...
._crit_edge482:                                   ; preds = %.thread443, %._crit_edge
  %.26.lcssa = phi i32 [ %.25, %._crit_edge ], [ %.30, %.thread443 ]
  %.13275.lcssa = phi i32 [ %.12274, %._crit_edge ], [ %.16278, %.thread443 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #7
  br label %bb.bx

bb.bx:                                            ; preds = %._crit_edge482, %._crit_edge507
  %.32 = phi i32 [ %.6287.lcssa, %._crit_edge507 ], [ %.26.lcssa, %._crit_edge482 ]
  %.18280 = phi i32 [ %.4266.lcssa, %._crit_edge507 ], [ %.13275.lcssa, %._crit_edge482 ]
  %.19261 = phi ptr [ %.4246, %._crit_edge507 ], [ %.17259, %._crit_edge482 ]
