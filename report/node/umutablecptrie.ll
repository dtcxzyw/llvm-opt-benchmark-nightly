...
.lr.ph.preheader.i.i.i:                           ; preds = %_ZN6icu_7812_GLOBAL__N_110getOverlapIjjEEiPKT_iPKT0_ii.exit.i.i.i
  ...
  %min.iters.check234 = icmp ult i64 %i.wb, 8
  br i1 %min.iters.check234, label %.lr.ph.i71.i.i.preheader, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %.lr.ph.preheader.i.i.i
  ...
  br i1 %diff.check, label %.lr.ph.i71.i.i.preheader, label %vector.ph235

vector.ph235:                                     ; preds = %vector.memcheck
  %n.vec237 = and i64 %i.wb, -8                   ; 4 uses
  %i.wi = add nsw i64 %n.vec237, %i.wa
  %i.wj = add nsw i64 %n.vec237, %i.vm            ; 2 uses
  %invariant.gep = getelementptr [4 x i8], ptr %i.sy, i64 %i.wa
  %invariant.gep453 = getelementptr [4 x i8], ptr %i.mg, i64 %i.vm
  br label %vector.body238

vector.body238:                                   ; preds = %vector.body238, %vector.ph235
  %index239 = phi i64 [ 0, %vector.ph235 ], [ %index.next241, %vector.body238 ] ; 3 uses
  %gep = getelementptr [4 x i8], ptr %invariant.gep, i64 %index239 ; 2 uses
  %i.wk = getelementptr inbounds nuw i8, ptr %gep, i64 16
  %wide.load = load <4 x i32>, ptr %gep, align 4
  %wide.load240 = load <4 x i32>, ptr %i.wk, align 4
  %gep454 = getelementptr [4 x i8], ptr %invariant.gep453, i64 %index239 ; 2 uses
  %i.wl = getelementptr inbounds nuw i8, ptr %gep454, i64 16
  store <4 x i32> %wide.load, ptr %gep454, align 4
  store <4 x i32> %wide.load240, ptr %i.wl, align 4
  %index.next241 = add nuw i64 %index239, 8       ; 2 uses
  %i.wm = icmp eq i64 %index.next241, %n.vec237
  br i1 %i.wm, label %middle.block242, label %vector.body238, !llvm.loop !51

middle.block242:                                  ; preds = %vector.body238
  %cmp.n243 = icmp eq i64 %i.wb, %n.vec237
  br i1 %cmp.n243, label %._crit_edge.loopexit.i75.i.i, label %.lr.ph.i71.i.i.preheader

.lr.ph.i71.i.i.preheader:                         ; preds = %vector.memcheck, %.lr.ph.preheader.i.i.i, %middle.block242
  %indvars.iv250.i.i.i.ph = phi i64 [ %i.wa, %vector.memcheck ], [ %i.wa, %.lr.ph.preheader.i.i.i ], [ %i.wi, %middle.block242 ] ; 4 uses
  %indvars.iv.i72.i.i.ph = phi i64 [ %i.vm, %vector.memcheck ], [ %i.vm, %.lr.ph.preheader.i.i.i ], [ %i.wj, %middle.block242 ] ; 2 uses
  %i.wn = sub nsw i64 0, %indvars.iv250.i.i.i.ph
  %xtraiter371 = and i64 %i.wn, 3                 ; 2 uses
  %lcmp.mod372.not = icmp eq i64 %xtraiter371, 0
  br i1 %lcmp.mod372.not, label %.lr.ph.i71.i.i.prol.loopexit, label %.lr.ph.i71.i.i.prol
...
.lr.ph.i71.i.i.prol:                              ; preds = %.lr.ph.i71.i.i.preheader, %.lr.ph.i71.i.i.prol
  ...
  %prol.iter373 = phi i64 [ %prol.iter373.next, %.lr.ph.i71.i.i.prol ], [ 0, %.lr.ph.i71.i.i.preheader ]
  ...
  br i1 %prol.iter373.cmp.not, label %.lr.ph.i71.i.i.prol.loopexit, label %.lr.ph.i71.i.i.prol, !llvm.loop !52

.lr.ph.i71.i.i.prol.loopexit:                     ; preds = %.lr.ph.i71.i.i.prol, %.lr.ph.i71.i.i.preheader
  %indvars.iv.next.i73.i.i.lcssa309.unr = phi i64 [ poison, %.lr.ph.i71.i.i.preheader ], [ %indvars.iv.next.i73.i.i.prol, %.lr.ph.i71.i.i.prol ]
...
._crit_edge.loopexit.i75.i.i:                     ; preds = %.lr.ph.i71.i.i.prol.loopexit, %.lr.ph.i71.i.i, %middle.block242
  %indvars.iv.next.i73.i.i.lcssa = phi i64 [ %i.wj, %middle.block242 ], [ %indvars.iv.next.i73.i.i.lcssa309.unr, %.lr.ph.i71.i.i.prol.loopexit ], [ %indvars.iv.next.i73.i.i.3, %.lr.ph.i71.i.i ]
...
bb.dd:                                            ; preds = %bb.dc
  ...
  %i.za = sub nsw i32 %indvars417.i.i.i, %.0237363.i.i.i
...
._crit_edge.i.i85.i.i:                            ; preds = %bb.df
  %i.zl = getelementptr inbounds nuw i8, ptr %6, i64 20
  ...
  %i.zm = and i32 %i.cs, 4096                     ; 4 uses
  %i.zn = load i32, ptr %i.ct, align 8
  %i.zo = ashr i32 %i.zn, 4                       ; 4 uses
  %i.zp = icmp slt i32 %i.zm, %i.zo               ; 2 uses
  br i1 %i.zp, label %.preheader351.lr.ph.i.i.i, label %._crit_edge.i86.i.i

.preheader351.lr.ph.i.i.i:                        ; preds = %._crit_edge.i.i85.i.i
  %i.zq = load i32, ptr %i.ym, align 4
  %i.zr = zext nneg i32 %i.zm to i64
  %i.zs = zext nneg i32 %i.zo to i64
...
.preheader351.i.i.i:                              ; preds = %bb.dn, %.preheader351.lr.ph.i.i.i
  ...
  %indvars.iv.next222.i.i = add nuw nsw i64 %indvars.iv221.i.i, 32 ; 2 uses
...
bb.dg:                                            ; preds = %.preheader351.i.i.i
  %i.adb = getelementptr inbounds nuw i8, ptr %i.gg, i64 %indvars.iv221.i.i
...
bb.dj:                                            ; preds = %bb.di
  %i.adf = trunc nuw nsw i64 %indvars.iv221.i.i to i32
  ...
  %i.adi = getelementptr inbounds nuw i8, ptr %i.gg, i64 %indvars.iv221.i.i ; 2 uses
...
bb.dm:                                            ; preds = %bb.di
  %i.adk = getelementptr inbounds nuw i8, ptr %i.gg, i64 %indvars.iv221.i.i
...
bb.dn:                                            ; preds = %bb.dm, %bb.dl, %bb.dk, %bb.dh, %bb.dg
  ...
  %i.adm = icmp samesign ult i64 %indvars.iv.next222.i.i, %i.zs
...
bb.dr:                                            ; preds = %bb.dq
  ...
  %.498.i.i.i = select i1 %i.adr, i32 131071, i32 2097151
  %.499.i.i.i = select i1 %i.adr, i32 200003, i32 1500007
  br label %bb.ds

bb.ds:                                            ; preds = %bb.dr, %bb.dq, %bb.dp
  %.sink497.i.i.i = phi i32 [ 15, %bb.dq ], [ %..i87.i.i, %bb.dr ], [ 12, %bb.dp ]
  %.sink.i88.i.i = phi i32 [ 32767, %bb.dq ], [ %.498.i.i.i, %bb.dr ], [ 4095, %bb.dp ]
  %.0.i294.i.i.i = phi i32 [ 50021, %bb.dq ], [ %.499.i.i.i, %bb.dr ], [ 6007, %bb.dp ] ; 5 uses
  store i32 %.sink497.i.i.i, ptr %i.nl, align 8
  store i32 %.sink.i88.i.i, ptr %i.zl, align 4
