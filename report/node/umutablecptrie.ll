...
.lr.ph.preheader.i68:                             ; preds = %bb.p
  ...
  %i.cz = getelementptr inbounds nuw [4 x i8], ptr %i.cx, i64 %i.cy ; 5 uses
  %i.da = zext nneg i32 %i.bx to i64              ; 2 uses
  %i.db = getelementptr inbounds nuw [4 x i8], ptr %i.cz, i64 %i.da
  %i.dc = ptrtoaddr ptr %i.cx to i64              ; 2 uses
  ...
  br i1 %min.iters.check106, label %.lr.ph.i69.preheader, label %vector.body112

vector.body112:                                   ; preds = %.lr.ph.preheader.i68
  ...
  %n.vec109 = and i64 %i.dn, 9223372036854775800  ; 2 uses
  %i.do = shl i64 %n.vec109, 2
  %next.gep114 = getelementptr i8, ptr %i.cz, i64 %i.do
  %i.dp = getelementptr i8, ptr %i.cz, i64 16
  store <4 x i32> %broadcast.splat111, ptr %i.cz, align 4
  store <4 x i32> %broadcast.splat111, ptr %i.dp, align 4
  %i.dq = icmp eq i64 %i.dn, %n.vec109
  br i1 %i.dq, label %_ZN6icu_7812_GLOBAL__N_19fillBlockEPjiij.exit71, label %.lr.ph.i69.preheader

.lr.ph.i69.preheader:                             ; preds = %.lr.ph.preheader.i68, %vector.body112
  %.07.i70.ph = phi ptr [ %i.cz, %.lr.ph.preheader.i68 ], [ %next.gep114, %vector.body112 ]
  br label %.lr.ph.i69
...
.lr.ph.i69:                                       ; preds = %.lr.ph.i69.preheader, %.lr.ph.i69
  ...
  br i1 %i.ds, label %.lr.ph.i69, label %_ZN6icu_7812_GLOBAL__N_19fillBlockEPjiij.exit71, !llvm.loop !19
...
_ZN6icu_7812_GLOBAL__N_19fillBlockEPjiij.exit71:  ; preds = %.lr.ph.i61, %.lr.ph.i69, %middle.block102, %vector.body112, %_ZN6icu_7812_GLOBAL__N_19fillBlockEPjiij.exit71.sink.split, %bb.m, %._crit_edge, %bb.a
  ret void
}
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  br i1 %niter.ncmp.1, label %.preheader.i.i.loopexit.unr-lcssa, label %bb.g, !llvm.loop !20
...
bb.l:                                             ; preds = %bb.l, %.lr.ph16.i.i
  ...
  br i1 %i.ax, label %bb.l, label %_ZN6icu_7812_GLOBAL__N_120MutableCodePointTrie10maskValuesEj.exit.i, !llvm.loop !21
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  br i1 %niter338.ncmp.1, label %.preheader.i114.i.loopexit.unr-lcssa, label %bb.o, !llvm.loop !20
...
bb.t:                                             ; preds = %bb.t, %.lr.ph16.i115.i
  ...
  br i1 %i.cp, label %bb.t, label %_ZN6icu_7812_GLOBAL__N_120MutableCodePointTrie10maskValuesEj.exit.i, !llvm.loop !21
...
bb.as:                                            ; preds = %bb.as, %.lr.ph.i124.i
  ...
  br i1 %exitcond.not.i128.i.3, label %.loopexit.i.i, label %bb.as, !llvm.loop !22
...
bb.au:                                            ; preds = %.lr.ph.i.i.i.i
  ...
  br i1 %i.hh, label %.lr.ph.i.i.i.i, label %_ZN6icu_7812_GLOBAL__N_115allValuesSameAsEPKjij.exit.i.i.i, !llvm.loop !23
...
bb.ay:                                            ; preds = %.lr.ph
  ...
  br i1 %.not96.not.i.i.i, label %.lr.ph, label %.critedge.i.i.i, !llvm.loop !24
...
.lr.ph:                                           ; preds = %bb.ax, %bb.ay
  ...
  br i1 %.not.i53.i.i, label %bb.ay, label %bb.bn, !llvm.loop !24
...
bb.bc:                                            ; preds = %bb.bb
  ...
  br i1 %exitcond.not.i.i.i.i, label %._crit_edge.i.i.i.i, label %bb.bb, !llvm.loop !25
...
bb.be:                                            ; preds = %bb.be, %.lr.ph.i105.i.i.i.new
  ...
  br i1 %niter355.ncmp.3, label %_ZN6icu_7812_GLOBAL__N_113AllSameBlocks3addEiij.exit.i.i.i.loopexit.unr-lcssa, label %bb.be, !llvm.loop !26
...
bb.bf:                                            ; preds = %bb.bf, %.epil.preheader348
  ...
  br i1 %epil.iter350.cmp.not, label %_ZN6icu_7812_GLOBAL__N_113AllSameBlocks3addEiij.exit.i.i.i, label %bb.bf, !llvm.loop !27
...
bb.bi:                                            ; preds = %bb.bi, %.lr.ph.i112.i.i.i.new
  ...
  br i1 %niter347.ncmp.3, label %.thread129.i.i.i.loopexit.unr-lcssa, label %bb.bi, !llvm.loop !26
...
bb.bj:                                            ; preds = %bb.bj, %.epil.preheader341
  ...
  br i1 %epil.iter.cmp.not, label %.thread129.i.i.i, label %bb.bj, !llvm.loop !29
...
bb.bk:                                            ; preds = %bb.bg, %.lr.ph.i50.i.i
  ...
  br i1 %i.ld, label %._crit_edge.i.i.i, label %.lr.ph.i50.i.i, !llvm.loop !30
...
.thread133.i.i.i:                                 ; preds = %bb.bn, %.thread127.i.i.i, %bb.bm, %bb.av
  ...
  br i1 %.not97.i.i.i, label %bb.at, label %_ZN6icu_7812_GLOBAL__N_120MutableCodePointTrie22compactWholeDataBlocksEiRNS0_13AllSameBlocksE.exit.i.i, !llvm.loop !31
...
bb.bo:                                            ; preds = %_ZNK6icu_7812_GLOBAL__N_120MutableCodePointTrie3getEi.exit58.i.i, %.loopexit.i.i
  %indvars.iv219.i.i = phi i64 [ 0, %.loopexit.i.i ], [ %indvars.iv.next220.i.i, %_ZNK6icu_7812_GLOBAL__N_120MutableCodePointTrie3getEi.exit58.i.i ] ; 5 uses
  %.not.i55.i.i = icmp samesign ult i64 %indvars.iv219.i.i, %i.gi
  br i1 %.not.i55.i.i, label %bb.bp, label %_ZNK6icu_7812_GLOBAL__N_120MutableCodePointTrie3getEi.exit58.i.i

bb.bp:                                            ; preds = %bb.bo
  %i.lo = lshr i64 %indvars.iv219.i.i, 4          ; 3 uses
...
bb.br:                                            ; preds = %bb.bp
  %i.lu = trunc nuw nsw i64 %indvars.iv219.i.i to i32
...
_ZNK6icu_7812_GLOBAL__N_120MutableCodePointTrie3getEi.exit58.i.i: ; preds = %bb.br, %bb.bq, %bb.bo
  ...
  %i.md = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %indvars.iv219.i.i
  store i32 %.1.i57.i.i, ptr %i.md, align 4
  %indvars.iv.next220.i.i = add nuw nsw i64 %indvars.iv219.i.i, 1 ; 2 uses
  %exitcond222.not.i.i = icmp eq i64 %indvars.iv.next220.i.i, 128
  br i1 %exitcond222.not.i.i, label %.lr.ph149.i.i.i, label %bb.bo, !llvm.loop !32
...
bb.bt:                                            ; preds = %bb.bt, %.epil.preheader356
  ...
  br i1 %epil.iter358.cmp.not, label %._crit_edge.loopexit.i.i.i, label %bb.bt, !llvm.loop !33
...
bb.bu:                                            ; preds = %bb.bu, %.lr.ph.i61.i.i.new
  ...
  br i1 %niter363.ncmp.3, label %._crit_edge.loopexit.i.i.i.unr-lcssa, label %bb.bu, !llvm.loop !34
...
bb.bx:                                            ; preds = %bb.bw, %bb.bv, %_ZNK6icu_7812_GLOBAL__N_113AllSameBlocks12findMostUsedEv.exit.i.i
  ...
  %.promoted167.i.i = phi i32 [ 50021, %bb.bv ], [ %.189, %bb.bw ], [ 6007, %_ZNK6icu_7812_GLOBAL__N_113AllSameBlocks12findMostUsedEv.exit.i.i ] ; 6 uses
  store i32 %.sink187, ptr %i.nl, align 8
  store i32 %.sink, ptr %i.nq, align 4
  tail call void @uprv_free_78(ptr noundef null) #10
  %i.nt = shl nuw nsw i32 %.promoted167.i.i, 2
...
bb.by:                                            ; preds = %bb.bx
  store i32 %.promoted167.i.i, ptr %i.nk, align 8
  %i.nx = getelementptr inbounds nuw i8, ptr %6, i64 12 ; 4 uses
  store i32 %.promoted167.i.i, ptr %i.nx, align 4
...
bb.bz:                                            ; preds = %bb.ct, %.lr.ph209.i.i.i
  ...
  %.0.i118.i168.i.i = phi i32 [ %.promoted167.i.i, %.lr.ph209.i.i.i ], [ %.0.i118.i169.i.i, %bb.ct ]
  %i.oh = phi ptr [ %i.nv, %.lr.ph209.i.i.i ], [ %i.oo, %bb.ct ] ; 3 uses
  %.0.i118.i165.i.i = phi i32 [ %.promoted167.i.i, %.lr.ph209.i.i.i ], [ %.0.i118.i163.i.i, %bb.ct ] ; 3 uses
  %.sink.i161.i.i = phi i32 [ %.sink, %.lr.ph209.i.i.i ], [ %.sink.i160.i.i, %bb.ct ]
  %.sink312.i158.i.i = phi i32 [ %.sink187, %.lr.ph209.i.i.i ], [ %.sink312.i157.i.i, %bb.ct ]
...
bb.ca:                                            ; preds = %bb.bz
  ...
  %i.oj = icmp sgt i32 %.0.i118.i.i.i, %.0.i118.i165.i.i
...
._crit_edge.i120.i.i.i:                           ; preds = %bb.cc, %bb.ca
  ...
  %.0.i118.i164.i.i = phi i32 [ %.0.i118.i.i.i, %bb.cc ], [ %.0.i118.i165.i.i, %bb.ca ]
...
bb.cd:                                            ; preds = %._crit_edge.i120.i.i.i, %bb.bz
  ...
  %.0.i118.i169.i.i = phi i32 [ %.0.i118.i.i.i, %._crit_edge.i120.i.i.i ], [ %.0.i118.i168.i.i, %bb.bz ] ; 5 uses
  %i.oo = phi ptr [ %i.om, %._crit_edge.i120.i.i.i ], [ %i.oh, %bb.bz ] ; 8 uses
  %.0.i118.i163.i.i = phi i32 [ %.0.i118.i164.i.i, %._crit_edge.i120.i.i.i ], [ %.0.i118.i165.i.i, %bb.bz ] ; 2 uses
  %.sink.i160.i.i = phi i32 [ %.sink.i.i.i, %._crit_edge.i120.i.i.i ], [ %.sink.i161.i.i, %bb.bz ] ; 7 uses
  %.sink312.i157.i.i = phi i32 [ %.sink312.i.i.i, %._crit_edge.i120.i.i.i ], [ %.sink312.i158.i.i, %bb.bz ] ; 3 uses
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i, %.lr.ph.i.i.i.preheader.i.i
  ...
  br i1 %niter381.ncmp.7, label %.lr.ph.i.i.i.i.i.epil, label %.lr.ph.i.i.i.i.i, !llvm.loop !35
...
.lr.ph.i.i.i.i.i.epil:                            ; preds = %.lr.ph.i.i.i.i.i, %.lr.ph.i.i.i.i.i.epil
  ...
  br i1 %epil.iter376.cmp.not, label %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeEj.exit.i.i.i.i, label %.lr.ph.i.i.i.i.i.epil, !llvm.loop !36

_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeEj.exit.i.i.i.i: ; preds = %.lr.ph.i.i.i.i.i.epil
  %i.po = shl i32 %i.pn, %.sink312.i157.i.i
  %i.pp = add nsw i32 %.0.i118.i169.i.i, -1
...
.lr.ph.i.preheader.us.i.i.i.i.i:                  ; preds = %.lr.ph.split.us.i.i.i.i.i
  %i.qb = and i32 %i.py, %.sink.i160.i.i
...
bb.ce:                                            ; preds = %.lr.ph.i.us.i.i.i.i.i
  ...
  br i1 %i.qj, label %.lr.ph.i.us.i.i.i.i.i, label %_ZN6icu_7812_GLOBAL__N_115allValuesSameAsEPKjij.exit.loopexit.us.i.i.i.i.i, !llvm.loop !23
...
bb.cf:                                            ; preds = %_ZN6icu_7812_GLOBAL__N_115allValuesSameAsEPKjij.exit.loopexit.us.i.i.i.i.i, %.lr.ph.split.us.i.i.i.i.i
  ...
  %i.ql = urem i32 %i.qk, %.0.i118.i169.i.i       ; 3 uses
  ...
  br i1 %i.qp, label %._crit_edge.i.i.i.i.i, label %.lr.ph.split.us.i.i.i.i.i, !llvm.loop !37
...
bb.cg:                                            ; preds = %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks9findEntryEPKjjj.exit.i.i.i.i
  ...
  %i.qw = and i32 %i.qv, %.sink.i160.i.i
...
bb.ch:                                            ; preds = %bb.ch, %.lr.ph191.split.i.i.i
  ...
  br i1 %or.cond.not.i.i.i.i, label %_ZN6icu_7812_GLOBAL__N_122isStartOfSomeFastBlockEjPKji.exit.i.i.i, label %bb.ch, !llvm.loop !38
...
bb.cj:                                            ; preds = %.preheader.i.i.i.i
  ...
  br i1 %.not29.i.i.i.i, label %_ZN6icu_7812_GLOBAL__N_116findAllSameBlockEPKjiiji.exit.i.i.i, label %.preheader.i.i.i.i, !llvm.loop !39
...
.loopexit36.i.i.i.i:                              ; preds = %.loopexit36.loopexit.i.i.i.i, %.lr.ph.i.i79.i.i
  ...
  br i1 %.not.not.i.i.i.i, label %.lr.ph.i.i79.i.i, label %.critedge.thread279.i.i.i, !llvm.loop !40
...
_ZN6icu_7812_GLOBAL__N_116findAllSameBlockEPKjiiji.exit.i.i.i: ; preds = %bb.cj
  ...
  br i1 %or.cond117.i.i.i, label %.lr.ph191.split.i.i.i, label %.critedge.i76.i.i, !llvm.loop !41
...
bb.ck:                                            ; preds = %.lr.ph.i130.i.i.i
  ...
  br i1 %i.sa, label %.lr.ph.i130.i.i.i, label %_ZN6icu_7812_GLOBAL__N_117getAllSameOverlapEPKjiji.exit.i.i.i, !llvm.loop !42
...
vector.ph:                                        ; preds = %.lr.ph198.preheader.i.i.i
  ...
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  %invariant.gep459 = getelementptr [4 x i8], ptr %i.mg, i64 %i.se
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %gep460 = getelementptr [4 x i8], ptr %invariant.gep459, i64 %index ; 2 uses
  %i.sn = getelementptr inbounds nuw i8, ptr %gep460, i64 16
  store <4 x i32> %broadcast.splat, ptr %gep460, align 4
  store <4 x i32> %broadcast.splat, ptr %i.sn, align 4
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.so = icmp eq i64 %index.next, %n.vec
  br i1 %i.so, label %middle.block, label %vector.body, !llvm.loop !43
...
.lr.ph198.i.i.i:                                  ; preds = %.lr.ph198.i.i.i.preheader, %.lr.ph198.i.i.i
  ...
  br i1 %exitcond258.not.i.i.i, label %._crit_edge199.loopexit.i.i.i, label %.lr.ph198.i.i.i, !llvm.loop !44
...
bb.cm:                                            ; preds = %bb.cm, %.new
  ...
  br i1 %niter371.ncmp.3, label %.epil.preheader364, label %bb.cm, !llvm.loop !45
...
bb.cn:                                            ; preds = %bb.cn, %.epil.preheader364
  ...
  br i1 %epil.iter366.cmp.not, label %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeIjEEjPKT_i.exit.i.i.i.i, label %bb.cn, !llvm.loop !46

_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeIjEEjPKT_i.exit.i.i.i.i: ; preds = %bb.cn
  %i.ua = shl i32 %i.tz, %.sink312.i157.i.i
  %i.ub = add nsw i32 %.0.i118.i169.i.i, -1
...
.lr.ph.split.us.i.i139.i.i.i:                     ; preds = %_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us.i.i.i.i.i, %.lr.ph.split.us.i.i139.i.preheader.i.i
  %i.uj = phi i32 [ %i.vb, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us.i.i.i.i.i ], [ %i.ug, %.lr.ph.split.us.i.i139.i.preheader.i.i ] ; 2 uses
  %.02237.us.i.i.i.i.i = phi i32 [ %i.uy, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us.i.i.i.i.i ], [ %i.ud, %.lr.ph.split.us.i.i139.i.preheader.i.i ] ; 2 uses
...
.lr.ph.i.preheader.us.i.i140.i.i.i:               ; preds = %.lr.ph.split.us.i.i139.i.i.i
  %i.um = and i32 %i.uj, %.sink.i160.i.i
...
.lr.ph.i.us.i.i141.i.i.i:                         ; preds = %bb.co, %.lr.ph.i.preheader.us.i.i140.i.i.i
  %.010.i.us.i.i.i.i.i = phi i32 [ %i.uv, %bb.co ], [ %i.on, %.lr.ph.i.preheader.us.i.i140.i.i.i ] ; 2 uses
  %.069.i.us.i.i.i.i.i = phi ptr [ %i.uu, %bb.co ], [ %i.sy, %.lr.ph.i.preheader.us.i.i140.i.i.i ] ; 2 uses
  %.078.i.us.i.i.i.i.i = phi ptr [ %i.ut, %bb.co ], [ %i.up, %.lr.ph.i.preheader.us.i.i140.i.i.i ] ; 2 uses
...
bb.co:                                            ; preds = %.lr.ph.i.us.i.i141.i.i.i
  %i.ut = getelementptr inbounds nuw i8, ptr %.078.i.us.i.i.i.i.i, i64 4
  %i.uu = getelementptr inbounds nuw i8, ptr %.069.i.us.i.i.i.i.i, i64 4
  %i.uv = add nsw i32 %.010.i.us.i.i.i.i.i, -1
  %i.uw = icmp sgt i32 %.010.i.us.i.i.i.i.i, 1
  br i1 %i.uw, label %.lr.ph.i.us.i.i141.i.i.i, label %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks9findEntryIjjEEiPKT_PKT0_ij.exit.i.i.i.i, !llvm.loop !47
...
_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us.i.i.i.i.i: ; preds = %.lr.ph.i.us.i.i141.i.i.i, %.lr.ph.split.us.i.i139.i.i.i
  %i.ux = add nuw nsw i32 %.02237.us.i.i.i.i.i, %i.ud
  %i.uy = urem i32 %i.ux, %.0.i118.i169.i.i       ; 3 uses
  %i.uz = zext nneg i32 %i.uy to i64
  %i.va = getelementptr inbounds nuw [4 x i8], ptr %i.oo, i64 %i.uz
  %i.vb = load i32, ptr %i.va, align 4            ; 2 uses
  %i.vc = icmp eq i32 %i.vb, 0
  br i1 %i.vc, label %._crit_edge.i.i136.i.i.i, label %.lr.ph.split.us.i.i139.i.i.i, !llvm.loop !48
...
._crit_edge.i.i136.i.i.i:                         ; preds = %_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us.i.i.i.i.i, %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeIjEEjPKT_i.exit.i.i.i.i
  %.022.lcssa.i.i.i.i.i = phi i32 [ %i.ud, %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeIjEEjPKT_i.exit.i.i.i.i ], [ %i.uy, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us.i.i.i.i.i ]
...
_ZNK6icu_7812_GLOBAL__N_111MixedBlocks9findBlockIjjEEiPKT_PKT0_i.exit.i.i.i: ; preds = %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks9findEntryIjjEEiPKT_PKT0_ij.exit.i.i.i.i
  ...
  %i.vi = and i32 %i.vh, %.sink.i160.i.i          ; 2 uses
...
_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.loopexit.i.i.i.i: ; preds = %.lr.ph.i.i143.i.i.i
  ...
  br i1 %i.vn, label %bb.cq, label %_ZN6icu_7812_GLOBAL__N_110getOverlapIjjEEiPKT_iPKT0_ii.exit.i.i.i, !llvm.loop !49
...
bb.cr:                                            ; preds = %.lr.ph.i.i143.i.i.i
  ...
  br i1 %i.vx, label %.lr.ph.i.i143.i.i.i, label %_ZN6icu_7812_GLOBAL__N_110getOverlapIjjEEiPKT_iPKT0_ii.exit.i.i.i, !llvm.loop !47
...
vector.ph236:                                     ; preds = %vector.memcheck
  ...
  %invariant.gep457 = getelementptr [4 x i8], ptr %i.mg, i64 %i.vm
...
vector.body239:                                   ; preds = %vector.body239, %vector.ph236
  ...
  %gep458 = getelementptr [4 x i8], ptr %invariant.gep457, i64 %index240 ; 2 uses
  %i.wl = getelementptr inbounds nuw i8, ptr %gep458, i64 16
  store <4 x i32> %wide.load, ptr %gep458, align 4
  ...
  br i1 %i.wm, label %middle.block243, label %vector.body239, !llvm.loop !50
...
.lr.ph.i71.i.i.prol:                              ; preds = %.lr.ph.i71.i.i.preheader, %.lr.ph.i71.i.i.prol
  ...
  br i1 %prol.iter374.cmp.not, label %.lr.ph.i71.i.i.prol.loopexit, label %.lr.ph.i71.i.i.prol, !llvm.loop !51
...
.lr.ph.i71.i.i:                                   ; preds = %.lr.ph.i71.i.i.prol.loopexit, %.lr.ph.i71.i.i
  ...
  br i1 %exitcond.not.i74.i.i.3, label %._crit_edge.loopexit.i75.i.i, label %.lr.ph.i71.i.i, !llvm.loop !52
...
bb.ct:                                            ; preds = %bb.cs, %._crit_edge.i68.i.i, %bb.cp, %._crit_edge199.i.i.i, %.critedge.thread.i.i.i
  ...
  br i1 %.not.i69.i.i, label %bb.bz, label %_ZN6icu_7812_GLOBAL__N_120MutableCodePointTrie11compactDataEiPjiiRNS0_11MixedBlocksER10UErrorCode.exit.i.i, !llvm.loop !53
...
_ZN6icu_7812_GLOBAL__N_120MutableCodePointTrie11compactDataEiPjiiRNS0_11MixedBlocksER10UErrorCode.exit.i.i: ; preds = %bb.ct, %bb.by
  %.promoted167.i.i5 = phi i32 [ %.promoted167.i.i, %bb.by ], [ %.0.i118.i163.i.i, %bb.ct ]
...
bb.db:                                            ; preds = %bb.df, %bb.da
  %indvars.iv421.i.i.i = phi i64 [ 0, %bb.da ], [ %indvars.iv.next422.i.i.i, %bb.df ] ; 3 uses
  %indvars.iv.i82.i.i = phi i64 [ 0, %bb.da ], [ %indvars.iv.next420.i.i.i, %bb.df ] ; 4 uses
  %.0237366.i.i.i = phi i32 [ -1, %bb.da ], [ %.1238.i.i.i, %bb.df ] ; 5 uses
  %indvars425.i.i.i = trunc i64 %indvars.iv421.i.i.i to i32 ; 2 uses
  ...
  %i.yu = getelementptr inbounds nuw [2 x i8], ptr %i.a, i64 %indvars.iv421.i.i.i
...
bb.df:                                            ; preds = %bb.de, %bb.dd, %bb.dc, %bb.db
  ...
  %indvars.iv.next420.i.i.i = add nuw nsw i64 %indvars.iv.i82.i.i, 4
  %indvars.iv.next422.i.i.i = add nuw nsw i64 %indvars.iv421.i.i.i, 1 ; 2 uses
  %exitcond.not.i83.i.i = icmp eq i64 %indvars.iv.next422.i.i.i, %wide.trip.count.i81.i.i
  br i1 %exitcond.not.i83.i.i, label %._crit_edge.i.i85.i.i, label %bb.db, !llvm.loop !54
...
.preheader351.i.i.i:                              ; preds = %bb.dn, %.preheader351.lr.ph.i.i.i
  %indvars.iv432.i.i.i = phi i64 [ %i.zs, %.preheader351.lr.ph.i.i.i ], [ %i.aco, %bb.dn ] ; 6 uses
  %.2239370.i.i.i = phi i32 [ %i.zr, %.preheader351.lr.ph.i.i.i ], [ %.3240.i.i.i, %bb.dn ] ; 5 uses
  %.0250369.i.i.i = phi i32 [ 0, %.preheader351.lr.ph.i.i.i ], [ %.3253.i.i.i, %bb.dn ] ; 5 uses
  %.0267368.i.i.i = phi i1 [ false, %.preheader351.lr.ph.i.i.i ], [ %.2269.i.i.i, %bb.dn ] ; 4 uses
  %i.zt = load ptr, ptr %0, align 8               ; 2 uses
  %i.zu = load i32, ptr %i.yh, align 8
  %i.zv = getelementptr inbounds nuw [4 x i8], ptr %i.zt, i64 %indvars.iv432.i.i.i ; 2 uses
  ...
  %i.aco = add nuw nsw i64 %indvars.iv432.i.i.i, 32 ; 2 uses
...
bb.dg:                                            ; preds = %.preheader351.i.i.i
  ...
  %i.add = icmp slt i32 %.2239370.i.i.i, 0
  br i1 %i.add, label %bb.dh, label %bb.dn

bb.dh:                                            ; preds = %bb.dg
  %i.ade = icmp ugt i32 %i.ach, 65535             ; 2 uses
  %.1268.i.i.i = select i1 %i.ade, i1 true, i1 %.0267368.i.i.i
  %.1251.v.i.i.i = select i1 %i.ade, i32 36, i32 32
  %.1251.i.i.i = add nsw i32 %.1251.v.i.i.i, %.0250369.i.i.i
  br label %bb.dn
...
bb.dl:                                            ; preds = %bb.dj
  ...
  %i.adk = add nsw i32 %.0250369.i.i.i, 32
  br label %bb.dn

bb.dm:                                            ; preds = %bb.di
  %i.adl = getelementptr inbounds nuw i8, ptr %i.gg, i64 %indvars.iv432.i.i.i
  store i8 3, ptr %i.adl, align 1
  %i.adm = add nsw i32 %.0250369.i.i.i, 36
  br label %bb.dn

bb.dn:                                            ; preds = %bb.dm, %bb.dl, %bb.dk, %bb.dh, %bb.dg
  %.2269.i.i.i = phi i1 [ %.1268.i.i.i, %bb.dh ], [ %.0267368.i.i.i, %bb.dg ], [ true, %bb.dm ], [ %.0267368.i.i.i, %bb.dl ], [ %.0267368.i.i.i, %bb.dk ] ; 2 uses
  %.3253.i.i.i = phi i32 [ %.1251.i.i.i, %bb.dh ], [ %.0250369.i.i.i, %bb.dg ], [ %i.adm, %bb.dm ], [ %i.adk, %bb.dl ], [ %.0250369.i.i.i, %bb.dk ] ; 2 uses
  %.3240.i.i.i = phi i32 [ 0, %bb.dh ], [ %.2239370.i.i.i, %bb.dg ], [ %.2239370.i.i.i, %bb.dm ], [ %.2239370.i.i.i, %bb.dl ], [ %.2239370.i.i.i, %bb.dk ]
...
._crit_edge388.i.i.i:                             ; preds = %._crit_edge388.loopexit.i.i.i, %bb.ee
  %i.aer = phi i32 [ %.pre476.i.i.i, %bb.ee ], [ %i.axk, %._crit_edge388.loopexit.i.i.i ]
  %.0270.lcssa.i.i.i = phi i32 [ 0, %bb.ee ], [ %i.aeq, %._crit_edge388.loopexit.i.i.i ] ; 3 uses
  %.0261.lcssa.i.i.i = phi i32 [ %i.act, %bb.ee ], [ %.6.i98.i.i, %._crit_edge388.loopexit.i.i.i ] ; 3 uses
  %i.aes = icmp slt i32 %i.aer, 0
  br i1 %i.aes, label %bb.ez, label %bb.fa

bb.ef:                                            ; preds = %bb.ey, %.lr.ph387.i.i.i
  %i.aet = phi i32 [ %.pre476.i.i.i, %.lr.ph387.i.i.i ], [ %i.axk, %bb.ey ]
  ...
  %.4241385.i.i.i = phi i32 [ %.pre476.i.i.i, %.lr.ph387.i.i.i ], [ %.5335.i.i.i, %bb.ey ] ; 5 uses
  %.0261381.i.i.i = phi i32 [ %i.act, %.lr.ph387.i.i.i ], [ %.6.i98.i.i, %bb.ey ] ; 20 uses
  ...
  %i.aex = icmp slt i32 %.4241385.i.i.i, 0
...
.thread337.i.i.i:                                 ; preds = %bb.eh, %bb.eg
  %.5340.i.i.i = phi i32 [ %.4241385.i.i.i, %bb.eh ], [ 0, %bb.eg ] ; 3 uses
...
bb.ej:                                            ; preds = %.thread337.i.i.i
  %i.afi = icmp eq i32 %.0261381.i.i.i, %i.act
...
bb.ek:                                            ; preds = %bb.ej
  ...
  %i.afk = sext i32 %.0261381.i.i.i to i64        ; 4 uses
  br label %bb.el
...
_ZN6icu_7812_GLOBAL__N_110getOverlapItjEEiPKT_iPKT0_ii.exit.i.i.i: ; preds = %bb.em, %bb.eo
  ...
  %.lcssa299 = phi i32 [ %i.afz, %bb.eo ], [ %i.afn, %bb.em ]
  %i.agi = sub nsw i32 %.0261381.i.i.i, %.lcssa299 ; 2 uses
  %i.agj = icmp slt i64 %indvars.iv.i.i92.i.i.lcssa, 32
  br i1 %i.agj, label %.lr.ph377.preheader.i.i.i, label %._crit_edge378.i.i.i
...
.lr.ph377.preheader.i.i.i:                        ; preds = %_ZN6icu_7812_GLOBAL__N_111equalBlocksItjEEbPKT_PKT0_i.exit.i.i.i.i, %_ZN6icu_7812_GLOBAL__N_110getOverlapItjEEiPKT_iPKT0_ii.exit.i.i.i, %bb.ej
  ...
  %i.agk = phi i32 [ %i.act, %bb.ej ], [ %i.agi, %_ZN6icu_7812_GLOBAL__N_110getOverlapItjEEiPKT_iPKT0_ii.exit.i.i.i ], [ %.0261381.i.i.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksItjEEbPKT_PKT0_i.exit.i.i.i.i ]
  %.0254496.i.i.i = phi i64 [ 0, %bb.ej ], [ %indvars.iv.i.i92.i.i.lcssa, %_ZN6icu_7812_GLOBAL__N_110getOverlapItjEEiPKT_iPKT0_ii.exit.i.i.i ], [ 0, %_ZN6icu_7812_GLOBAL__N_111equalBlocksItjEEbPKT_PKT0_i.exit.i.i.i.i ]
...
.lr.ph377.i.i.i:                                  ; preds = %.lr.ph377.i.i.i, %.lr.ph377.preheader.i.i.i
  ...
  %indvars.iv452.i.i.i = phi i64 [ %.0254496.i.i.i, %.lr.ph377.preheader.i.i.i ], [ %indvars.iv.next453.i.i.i, %.lr.ph377.i.i.i ] ; 2 uses
  %i.agl = load ptr, ptr %0, align 8
  %indvars.iv.next453.i.i.i = add nsw i64 %indvars.iv452.i.i.i, 1 ; 2 uses
  %i.agm = getelementptr [4 x i8], ptr %i.agl, i64 %indvars.iv452.i.i.i
  %i.agn = getelementptr [4 x i8], ptr %i.agm, i64 %indvars.iv434.i.i.i
  ...
  %i.agr = getelementptr inbounds [2 x i8], ptr %i.agq, i64 %indvars.iv454.i.i.i
  store i16 %i.agp, ptr %i.agr, align 2
  %i.ags = and i64 %indvars.iv.next453.i.i.i, 4294967295
  %exitcond459.not.i.i.i = icmp eq i64 %i.ags, 32
...
._crit_edge378.loopexit.i.i.i:                    ; preds = %.lr.ph377.i.i.i
  %i.agt = trunc nsw i64 %indvars.iv.next455.i.i.i to i32
...
._crit_edge378.i.i.i:                             ; preds = %._crit_edge378.loopexit.i.i.i, %_ZN6icu_7812_GLOBAL__N_110getOverlapItjEEiPKT_iPKT0_ii.exit.i.i.i
  %i.agu = phi i32 [ %i.agi, %_ZN6icu_7812_GLOBAL__N_110getOverlapItjEEiPKT_iPKT0_ii.exit.i.i.i ], [ %i.agk, %._crit_edge378.loopexit.i.i.i ] ; 2 uses
  %i.agv = phi ptr [ %i.afd, %_ZN6icu_7812_GLOBAL__N_110getOverlapItjEEiPKT_iPKT0_ii.exit.i.i.i ], [ %.pre475.i.i.i, %._crit_edge378.loopexit.i.i.i ]
  %.1262.lcssa.i.i.i = phi i32 [ %.0261381.i.i.i, %_ZN6icu_7812_GLOBAL__N_110getOverlapItjEEiPKT_iPKT0_ii.exit.i.i.i ], [ %i.agt, %._crit_edge378.loopexit.i.i.i ] ; 4 uses
  call fastcc void @_ZN6icu_7812_GLOBAL__N_111MixedBlocks6extendItEEvPKT_iii(ptr noundef nonnull align 8 dereferenceable(28) %6, ptr noundef %i.agv, i32 noundef %i.act, i32 noundef %.0261381.i.i.i, i32 noundef %.1262.lcssa.i.i.i)
  br i1 %.0267.lcssa.i.i.i, label %bb.ep, label %bb.ew

bb.ep:                                            ; preds = %._crit_edge378.i.i.i
  %i.agw = load ptr, ptr %i.ada, align 8
  call fastcc void @_ZN6icu_7812_GLOBAL__N_111MixedBlocks6extendItEEvPKT_iii(ptr noundef nonnull align 8 dereferenceable(28) %4, ptr noundef %i.agw, i32 noundef %i.act, i32 noundef %.0261381.i.i.i, i32 noundef %.1262.lcssa.i.i.i)
  br label %bb.ew

.thread.i99.i.i:                                  ; preds = %bb.eh, %bb.eg
  %.5336.i.i.i = phi i32 [ %.4241385.i.i.i, %bb.eh ], [ 0, %bb.eg ]
  %i.agx = sext i32 %.0261381.i.i.i to i64        ; 22 uses
  %i.agy = load ptr, ptr %0, align 8
  %i.agz = getelementptr inbounds nuw [4 x i8], ptr %i.agy, i64 %indvars.iv434.i.i.i
  ...
  %i.ahi = getelementptr [4 x i8], ptr %i.ahh, i64 %indvars.iv434.i.i.i
  ...
  %i.aht = getelementptr [4 x i8], ptr %i.ahs, i64 %indvars.iv434.i.i.i
  ...
  %i.aie = getelementptr [4 x i8], ptr %i.aid, i64 %indvars.iv434.i.i.i
  ...
  %i.aip = getelementptr [4 x i8], ptr %i.aio, i64 %indvars.iv434.i.i.i
  ...
  %i.aja = getelementptr [4 x i8], ptr %i.aiz, i64 %indvars.iv434.i.i.i
  ...
  %i.ajl = getelementptr [4 x i8], ptr %i.ajk, i64 %indvars.iv434.i.i.i
  ...
  %i.ajw = getelementptr inbounds nuw [4 x i8], ptr %i.ajv, i64 %indvars.iv434.i.i.i
  ...
  %indvars.iv.next439.i.i.i = add nsw i64 %i.agx, 9 ; 9 uses
  ...
  %i.akk = getelementptr inbounds nuw [4 x i8], ptr %i.akj, i64 %indvars.iv.next437.i.i.i
  ...
  %i.akq = getelementptr [2 x i8], ptr %i.akp, i64 %indvars.iv.next439.i.i.i
  %i.akr = getelementptr i8, ptr %i.akq, i64 2
  store i16 %i.ako, ptr %i.akr, align 2
  %i.aks = load ptr, ptr %0, align 8
  %i.akt = getelementptr [4 x i8], ptr %i.aks, i64 %indvars.iv.next437.i.i.i
  ...
  %i.alb = getelementptr [2 x i8], ptr %i.ala, i64 %indvars.iv.next439.i.i.i
  %i.alc = getelementptr i8, ptr %i.alb, i64 4
  store i16 %i.akz, ptr %i.alc, align 2
  %i.ald = load ptr, ptr %0, align 8
  %i.ale = getelementptr [4 x i8], ptr %i.ald, i64 %indvars.iv.next437.i.i.i
  ...
  %i.alm = getelementptr [2 x i8], ptr %i.all, i64 %indvars.iv.next439.i.i.i
  %i.aln = getelementptr i8, ptr %i.alm, i64 6
  store i16 %i.alk, ptr %i.aln, align 2
  %i.alo = load ptr, ptr %0, align 8
  %i.alp = getelementptr [4 x i8], ptr %i.alo, i64 %indvars.iv.next437.i.i.i
  ...
  %i.alx = getelementptr [2 x i8], ptr %i.alw, i64 %indvars.iv.next439.i.i.i
  %i.aly = getelementptr i8, ptr %i.alx, i64 8
  store i16 %i.alv, ptr %i.aly, align 2
  %i.alz = load ptr, ptr %0, align 8
  %i.ama = getelementptr [4 x i8], ptr %i.alz, i64 %indvars.iv.next437.i.i.i
  ...
  %i.ami = getelementptr [2 x i8], ptr %i.amh, i64 %indvars.iv.next439.i.i.i
  %i.amj = getelementptr i8, ptr %i.ami, i64 10
  store i16 %i.amg, ptr %i.amj, align 2
  %i.amk = load ptr, ptr %0, align 8
  %i.aml = getelementptr [4 x i8], ptr %i.amk, i64 %indvars.iv.next437.i.i.i
  ...
  %i.amt = getelementptr [2 x i8], ptr %i.ams, i64 %indvars.iv.next439.i.i.i
  %i.amu = getelementptr i8, ptr %i.amt, i64 12
  store i16 %i.amr, ptr %i.amu, align 2
  %i.amv = load ptr, ptr %0, align 8
  %i.amw = getelementptr [4 x i8], ptr %i.amv, i64 %indvars.iv.next437.i.i.i
...
begin_hunk_1_@umutablecptrie_buildImmutable_78:bb.a
  ...
  %i.api = getelementptr [2 x i8], ptr %i.aph, i64 %indvars.iv.next439.1.i.i.i
  %i.apj = getelementptr i8, ptr %i.api, i64 8
  store i16 %i.apg, ptr %i.apj, align 2
  %i.apk = load ptr, ptr %0, align 8
  %i.apl = getelementptr [4 x i8], ptr %i.apk, i64 %indvars.iv.next437.1.i.i.i
  ...
  %i.apt = getelementptr [2 x i8], ptr %i.aps, i64 %indvars.iv.next439.1.i.i.i
  %i.apu = getelementptr i8, ptr %i.apt, i64 10
  store i16 %i.apr, ptr %i.apu, align 2
  %i.apv = load ptr, ptr %0, align 8
  %i.apw = getelementptr [4 x i8], ptr %i.apv, i64 %indvars.iv.next437.1.i.i.i
  ...
  %i.aqe = getelementptr [2 x i8], ptr %i.aqd, i64 %indvars.iv.next439.1.i.i.i
  %i.aqf = getelementptr i8, ptr %i.aqe, i64 12
  store i16 %i.aqc, ptr %i.aqf, align 2
  %i.aqg = load ptr, ptr %0, align 8
  %i.aqh = getelementptr [4 x i8], ptr %i.aqg, i64 %indvars.iv.next437.1.i.i.i
  ...
  %i.aqp = getelementptr [2 x i8], ptr %i.aqo, i64 %indvars.iv.next439.1.i.i.i
  ...
  %i.aqs = getelementptr inbounds nuw [4 x i8], ptr %i.aqr, i64 %indvars.iv.next437.1.i.i.i
  ...
  %indvars.iv.next439.2.i.i.i = add nsw i64 %i.agx, 27 ; 9 uses
  %i.ara = getelementptr [2 x i8], ptr %i.aqz, i64 %indvars.iv.next439.1.i.i.i
  ...
  %i.are = getelementptr inbounds [2 x i8], ptr %i.ard, i64 %indvars.iv.next439.1.i.i.i
  store i16 %i.arc, ptr %i.are, align 2
  %i.arf = load ptr, ptr %0, align 8
  %i.arg = getelementptr inbounds nuw [4 x i8], ptr %i.arf, i64 %indvars.iv.next437.2.i.i.i
  ...
  %i.arm = getelementptr [2 x i8], ptr %i.arl, i64 %indvars.iv.next439.2.i.i.i
  %i.arn = getelementptr i8, ptr %i.arm, i64 2
  store i16 %i.ark, ptr %i.arn, align 2
  %i.aro = load ptr, ptr %0, align 8
  %i.arp = getelementptr [4 x i8], ptr %i.aro, i64 %indvars.iv.next437.2.i.i.i
  ...
  %i.arx = getelementptr [2 x i8], ptr %i.arw, i64 %indvars.iv.next439.2.i.i.i
  %i.ary = getelementptr i8, ptr %i.arx, i64 4
  store i16 %i.arv, ptr %i.ary, align 2
  %i.arz = load ptr, ptr %0, align 8
  %i.asa = getelementptr [4 x i8], ptr %i.arz, i64 %indvars.iv.next437.2.i.i.i
  ...
  %i.asi = getelementptr [2 x i8], ptr %i.ash, i64 %indvars.iv.next439.2.i.i.i
  %i.asj = getelementptr i8, ptr %i.asi, i64 6
  store i16 %i.asg, ptr %i.asj, align 2
  %i.ask = load ptr, ptr %0, align 8
  %i.asl = getelementptr [4 x i8], ptr %i.ask, i64 %indvars.iv.next437.2.i.i.i
  ...
  %i.ast = getelementptr [2 x i8], ptr %i.ass, i64 %indvars.iv.next439.2.i.i.i
  %i.asu = getelementptr i8, ptr %i.ast, i64 8
  store i16 %i.asr, ptr %i.asu, align 2
  %i.asv = load ptr, ptr %0, align 8
  %i.asw = getelementptr [4 x i8], ptr %i.asv, i64 %indvars.iv.next437.2.i.i.i
  ...
  %i.ate = getelementptr [2 x i8], ptr %i.atd, i64 %indvars.iv.next439.2.i.i.i
  %i.atf = getelementptr i8, ptr %i.ate, i64 10
  store i16 %i.atc, ptr %i.atf, align 2
  %i.atg = load ptr, ptr %0, align 8
  %i.ath = getelementptr [4 x i8], ptr %i.atg, i64 %indvars.iv.next437.2.i.i.i
  ...
  %i.atp = getelementptr [2 x i8], ptr %i.ato, i64 %indvars.iv.next439.2.i.i.i
  %i.atq = getelementptr i8, ptr %i.atp, i64 12
  store i16 %i.atn, ptr %i.atq, align 2
  %i.atr = load ptr, ptr %0, align 8
  %i.ats = getelementptr [4 x i8], ptr %i.atr, i64 %indvars.iv.next437.2.i.i.i
  ...
  %i.aua = getelementptr [2 x i8], ptr %i.atz, i64 %indvars.iv.next439.2.i.i.i
  %i.aub = getelementptr i8, ptr %i.aua, i64 14
  store i16 %i.aty, ptr %i.aub, align 2
  %i.auc = load ptr, ptr %0, align 8
  %i.aud = getelementptr inbounds nuw [4 x i8], ptr %i.auc, i64 %indvars.iv.next437.2.i.i.i
  ...
  %i.aul = getelementptr [2 x i8], ptr %i.auk, i64 %indvars.iv.next439.2.i.i.i
  ...
  %i.aup = getelementptr inbounds [2 x i8], ptr %i.auo, i64 %indvars.iv.next439.2.i.i.i
  store i16 %i.aun, ptr %i.aup, align 2
  %i.auq = load ptr, ptr %i.ada, align 8          ; 7 uses
  %i.aur = call fastcc noundef i32 @_ZNK6icu_7812_GLOBAL__N_111MixedBlocks9findBlockIttEEiPKT_PKT0_i(ptr noundef nonnull align 8 dereferenceable(28) %4, ptr noundef %i.auq, ptr noundef %i.auq, i32 noundef %.0261381.i.i.i) ; 2 uses
  %i.aus = icmp sgt i32 %i.aur, -1
  br i1 %i.aus, label %bb.ev, label %bb.eq

bb.eq:                                            ; preds = %.thread.i99.i.i
  %i.aut = icmp eq i32 %.0261381.i.i.i, %i.act
...
bb.es:                                            ; preds = %.lr.ph.i.i311.i.i.i.1
  ...
  br i1 %i.avf, label %.lr.ph.i.i311.i.i.i.1, label %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit.i.i.i.loopexit, !llvm.loop !58
...
bb.et:                                            ; preds = %.lr.ph.i.i311.i.i.i
  ...
  br i1 %i.avp, label %.lr.ph.i.i311.i.i.i, label %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit.i.i.i, !llvm.loop !58
...
_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit.i.i.i: ; preds = %bb.et, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit.i.i.i.loopexit
  ...
  %.lcssa295 = phi i32 [ %i.auy, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit.i.i.i.loopexit ], [ %i.avi, %bb.et ]
  %i.avq = sub nsw i32 %.0261381.i.i.i, %.lcssa295 ; 3 uses
  %i.avr = icmp sgt i64 %indvars.iv.in.i.i101.i.i.lcssa, 1
...
.lr.ph.i102.i.i.prol:                             ; preds = %.lr.ph.i102.i.i.preheader, %.lr.ph.i102.i.i.prol
  %indvars.iv446.i.i.i.prol = phi i64 [ %indvars.iv.next447.i.i.i.prol, %.lr.ph.i102.i.i.prol ], [ %i.agx, %.lr.ph.i102.i.i.preheader ] ; 2 uses
  ...
  %i.avv = getelementptr [2 x i8], ptr %i.avu, i64 %indvars.iv444.i.i.i.prol
  ...
  %i.avy = getelementptr inbounds [2 x i8], ptr %i.avu, i64 %indvars.iv446.i.i.i.prol
  ...
  br i1 %prol.iter388.cmp.not, label %.lr.ph.i102.i.i.prol.loopexit, label %.lr.ph.i102.i.i.prol, !llvm.loop !59
...
.lr.ph.i102.i.i.prol.loopexit:                    ; preds = %.lr.ph.i102.i.i.prol, %.lr.ph.i102.i.i.preheader
  ...
  %indvars.iv446.i.i.i.unr = phi i64 [ %i.agx, %.lr.ph.i102.i.i.preheader ], [ %indvars.iv.next447.i.i.i.prol, %.lr.ph.i102.i.i.prol ]
  ...
  %i.avz = add i64 %indvars.iv441.i.i.i.lcssa, -33
...
.lr.ph.i102.i.i:                                  ; preds = %.lr.ph.i102.i.i.prol.loopexit, %.lr.ph.i102.i.i
  ...
  %i.awv = getelementptr [2 x i8], ptr %i.awu, i64 %indvars.iv444.i.i.i
  ...
  %i.awz = getelementptr [2 x i8], ptr %i.awu, i64 %indvars.iv446.i.i.i
...
_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit.thread.i.i.i: ; preds = %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.loopexit.i.i.i.i, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit.i.i.i, %bb.eq
  %i.axb = phi i32 [ %i.avq, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit.i.i.i ], [ %i.act, %bb.eq ], [ %.0261381.i.i.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.loopexit.i.i.i.i ]
  %i.axc = add nsw i32 %.0261381.i.i.i, 36
...
.loopexit350.loopexit.i.i.i:                      ; preds = %.lr.ph.i102.i.i, %.lr.ph.i102.i.i.prol.loopexit
  ...
  %i.axd = trunc nsw i64 %indvars.iv.next447.i.i.i.lcssa to i32
...
.loopexit350.i.i.i:                               ; preds = %.loopexit350.loopexit.i.i.i, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit.thread.i.i.i, %.preheader349.i.i.i
  ...
  %.4265.i.i.i = phi i32 [ %i.axc, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit.thread.i.i.i ], [ %.0261381.i.i.i, %.preheader349.i.i.i ], [ %i.axd, %.loopexit350.loopexit.i.i.i ] ; 4 uses
  call fastcc void @_ZN6icu_7812_GLOBAL__N_111MixedBlocks6extendItEEvPKT_iii(ptr noundef nonnull align 8 dereferenceable(28) %6, ptr noundef %i.axe, i32 noundef %i.act, i32 noundef %.0261381.i.i.i, i32 noundef %.4265.i.i.i)
  br i1 %.0267.lcssa.i.i.i, label %bb.eu, label %bb.ev

bb.eu:                                            ; preds = %.loopexit350.i.i.i
  %i.axg = load ptr, ptr %i.ada, align 8
  call fastcc void @_ZN6icu_7812_GLOBAL__N_111MixedBlocks6extendItEEvPKT_iii(ptr noundef nonnull align 8 dereferenceable(28) %4, ptr noundef %i.axg, i32 noundef %i.act, i32 noundef %.0261381.i.i.i, i32 noundef %.4265.i.i.i)
  br label %bb.ev

bb.ev:                                            ; preds = %bb.eu, %.loopexit350.i.i.i, %.thread.i99.i.i
  %.5266.i.i.i = phi i32 [ %.0261381.i.i.i, %.thread.i99.i.i ], [ %.4265.i.i.i, %bb.eu ], [ %.4265.i.i.i, %.loopexit350.i.i.i ]
...
bb.ew:                                            ; preds = %bb.ev, %bb.ep, %._crit_edge378.i.i.i, %.thread337.i.i.i, %bb.ei, %bb.eh
  %.5335.i.i.i = phi i32 [ %.5340.i.i.i, %._crit_edge378.i.i.i ], [ %.4241385.i.i.i, %bb.ei ], [ %.5336.i.i.i, %bb.ev ], [ %.5340.i.i.i, %.thread337.i.i.i ], [ %.5340.i.i.i, %bb.ep ], [ %.4241385.i.i.i, %bb.eh ] ; 2 uses
  %.6.i98.i.i = phi i32 [ %.1262.lcssa.i.i.i, %._crit_edge378.i.i.i ], [ %.0261381.i.i.i, %bb.ei ], [ %.5266.i.i.i, %bb.ev ], [ %.0261381.i.i.i, %.thread337.i.i.i ], [ %.1262.lcssa.i.i.i, %bb.ep ], [ %.0261381.i.i.i, %bb.eh ] ; 2 uses
  %.2259.i.i.i = phi i32 [ %i.agu, %._crit_edge378.i.i.i ], [ %i.afc, %bb.ei ], [ %.1258.i.i.i, %bb.ev ], [ %i.afg, %.thread337.i.i.i ], [ %i.agu, %bb.ep ], [ %i.aet, %bb.eh ] ; 3 uses
...
bb.ey:                                            ; preds = %bb.ex, %bb.ew
  ...
  %i.axm = getelementptr inbounds nuw [2 x i8], ptr %i.b, i64 %indvars.iv460.i.i.i
  store i16 %i.axl, ptr %i.axm, align 2
  %indvars.iv.next435.i.i.i = add nuw nsw i64 %indvars.iv434.i.i.i, 32 ; 2 uses
  %i.axn = icmp samesign ult i64 %indvars.iv.next435.i.i.i, %i.aep
  br i1 %i.axn, label %bb.ef, label %._crit_edge388.loopexit.i.i.i, !llvm.loop !61
...
.preheader.i89.i.i:                               ; preds = %bb.fa
  ...
  br i1 %i.axp, label %.lr.ph401.i.i.i, label %.loopexit.i.i.i
...
bb.fc:                                            ; preds = %bb.fi, %.lr.ph401.i.i.i
  %indvars.iv472.i.i.i = phi i64 [ %i.axr, %.lr.ph401.i.i.i ], [ %indvars.iv.next473.i.i.i, %bb.fi ] ; 2 uses
  %.0233399.i.i.i = phi i32 [ 0, %.lr.ph401.i.i.i ], [ %i.bak, %bb.fi ] ; 6 uses
  %.0235397.i.i.i = phi i32 [ 32, %.lr.ph401.i.i.i ], [ %.1236346.i.i.i, %bb.fi ] ; 2 uses
  %.7396.i.i.i = phi i32 [ %.0261.lcssa.i.i.i, %.lr.ph401.i.i.i ], [ %.9.i.i.i, %bb.fi ] ; 9 uses
  %i.axs = sub nsw i32 %.0270.lcssa.i.i.i, %.0233399.i.i.i ; 6 uses
  %.not290.i.i.i = icmp slt i32 %i.axs, %.0235397.i.i.i
  %i.axt = load ptr, ptr %i.ada, align 8          ; 5 uses
  br i1 %.not290.i.i.i, label %bb.fe, label %bb.fd

bb.fd:                                            ; preds = %bb.fc
  %i.axu = call fastcc noundef i32 @_ZNK6icu_7812_GLOBAL__N_111MixedBlocks9findBlockIttEEiPKT_PKT0_i(ptr noundef nonnull align 8 dereferenceable(28) %6, ptr noundef %i.axt, ptr noundef nonnull %i.b, i32 noundef %.0233399.i.i.i)
  br label %_ZN6icu_7812_GLOBAL__N_113findSameBlockEPKtiiS2_ii.exit.i.i.i

bb.fe:                                            ; preds = %bb.fc
  %i.axv = sub i32 %.7396.i.i.i, %i.axs           ; 2 uses
  %i.axw = sext i32 %.0233399.i.i.i to i64
...
bb.ff:                                            ; preds = %.lr.ph.i.us.i.i.i.i
  ...
  br i1 %i.ayg, label %.lr.ph.i.us.i.i.i.i, label %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread.loopexit.i.i.i.i, !llvm.loop !58
...
_ZN6icu_7812_GLOBAL__N_113findSameBlockEPKtiiS2_ii.exit.i.i.i: ; preds = %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread.loopexit.i.i.i.i, %bb.fd
  %.1236.i.i.i = phi i32 [ %.0235397.i.i.i, %bb.fd ], [ %i.axs, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread.loopexit.i.i.i.i ] ; 2 uses
...
_ZN6icu_7812_GLOBAL__N_113findSameBlockEPKtiiS2_ii.exit.thread.i.i.i: ; preds = %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread14.loopexit.us.i.i.i.i, %_ZN6icu_7812_GLOBAL__N_113findSameBlockEPKtiiS2_ii.exit.i.i.i, %bb.fe
  ...
  %i.ayj = icmp eq i32 %.7396.i.i.i, %i.act
...
bb.fg:                                            ; preds = %_ZN6icu_7812_GLOBAL__N_113findSameBlockEPKtiiS2_ii.exit.thread.i.i.i
  %i.ayk = sext i32 %.0233399.i.i.i to i64        ; 2 uses
...
_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.loopexit.i328.i.i.i: ; preds = %.lr.ph.i.i324.i.i.i
  ...
  br i1 %i.ayq, label %.lr.ph.i321.i.i.i, label %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i.i.i, !llvm.loop !63
...
bb.fh:                                            ; preds = %.lr.ph.i.i324.i.i.i
  ...
  br i1 %i.aza, label %.lr.ph.i.i324.i.i.i, label %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i.i.i, !llvm.loop !58
...
_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i.i.i: ; preds = %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.loopexit.i328.i.i.i, %bb.fh, %_ZN6icu_7812_GLOBAL__N_113findSameBlockEPKtiiS2_ii.exit.thread.i.i.i
  ...
  %i.azb = sub nsw i32 %.7396.i.i.i, %.1231.i.i.i ; 2 uses
  %i.azc = icmp slt i32 %.1231.i.i.i, %.1236345.i.i.i
  br i1 %i.azc, label %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i..lr.ph393.preheader.i_crit_edge.i.i, label %._crit_edge394.i.i.i
...
_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i..lr.ph393.preheader.i_crit_edge.i.i: ; preds = %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i.i.i
  %.pre228.i.i = sext i32 %.0233399.i.i.i to i64
  br label %.lr.ph393.preheader.i.i.i
...
.lr.ph393.preheader.i.i.i:                        ; preds = %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i..lr.ph393.preheader.i_crit_edge.i.i, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.thread.i.i.i
  %.pre-phi.i.i = phi i64 [ %.pre228.i.i, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i..lr.ph393.preheader.i_crit_edge.i.i ], [ %i.ayk, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.thread.i.i.i ]
  %i.azd = phi i32 [ %i.azb, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i..lr.ph393.preheader.i_crit_edge.i.i ], [ %i.ayn, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.thread.i.i.i ]
  %.1231498.i.i.i = phi i32 [ %.1231.i.i.i, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i..lr.ph393.preheader.i_crit_edge.i.i ], [ %.014.i.i.i.i, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.thread.i.i.i ]
  %i.aze = sext i32 %.1231498.i.i.i to i64        ; 4 uses
  %i.azf = sext i32 %.7396.i.i.i to i64           ; 2 uses
  %wide.trip.count470.i.i.i = sext i32 %.1236345.i.i.i to i64 ; 3 uses
  %invariant.gep.i.i.i = getelementptr [2 x i8], ptr %i.b, i64 %.pre-phi.i.i ; 5 uses
  %i.azg = sub nsw i64 %wide.trip.count470.i.i.i, %i.aze
  %xtraiter392 = and i64 %i.azg, 3                ; 2 uses
  %lcmp.mod393.not = icmp eq i64 %xtraiter392, 0
  br i1 %lcmp.mod393.not, label %.lr.ph393.i.i.i.prol.loopexit, label %.lr.ph393.i.i.i.prol

.lr.ph393.i.i.i.prol:                             ; preds = %.lr.ph393.preheader.i.i.i, %.lr.ph393.i.i.i.prol
  %indvars.iv465.i.i.i.prol = phi i64 [ %indvars.iv.next466.i.i.i.prol, %.lr.ph393.i.i.i.prol ], [ %i.azf, %.lr.ph393.preheader.i.i.i ] ; 2 uses
  %indvars.iv463.i.i.i.prol = phi i64 [ %indvars.iv.next464.i.i.i.prol, %.lr.ph393.i.i.i.prol ], [ %i.aze, %.lr.ph393.preheader.i.i.i ] ; 2 uses
  %prol.iter394 = phi i64 [ %prol.iter394.next, %.lr.ph393.i.i.i.prol ], [ 0, %.lr.ph393.preheader.i.i.i ]
  ...
  %i.azj = getelementptr inbounds [2 x i8], ptr %i.azi, i64 %indvars.iv465.i.i.i.prol
  ...
  br i1 %prol.iter394.cmp.not, label %.lr.ph393.i.i.i.prol.loopexit, label %.lr.ph393.i.i.i.prol, !llvm.loop !64
...
.lr.ph393.i.i.i.prol.loopexit:                    ; preds = %.lr.ph393.i.i.i.prol, %.lr.ph393.preheader.i.i.i
  ...
  %indvars.iv465.i.i.i.unr = phi i64 [ %i.azf, %.lr.ph393.preheader.i.i.i ], [ %indvars.iv.next466.i.i.i.prol, %.lr.ph393.i.i.i.prol ]
  %indvars.iv463.i.i.i.unr = phi i64 [ %i.aze, %.lr.ph393.preheader.i.i.i ], [ %indvars.iv.next464.i.i.i.prol, %.lr.ph393.i.i.i.prol ]
  %i.azk = sub nsw i64 %i.aze, %wide.trip.count470.i.i.i
  %i.azl = icmp ugt i64 %i.azk, -4
  br i1 %i.azl, label %._crit_edge394.loopexit.i.i.i, label %.lr.ph393.i.i.i
...
.lr.ph393.i.i.i:                                  ; preds = %.lr.ph393.i.i.i.prol.loopexit, %.lr.ph393.i.i.i
  ...
  %indvars.iv463.i.i.i = phi i64 [ %indvars.iv.next464.i.i.i.3, %.lr.ph393.i.i.i ], [ %indvars.iv463.i.i.i.unr, %.lr.ph393.i.i.i.prol.loopexit ] ; 5 uses
  %gep.i.i.i = getelementptr [2 x i8], ptr %invariant.gep.i.i.i, i64 %indvars.iv463.i.i.i
  %i.azm = load i16, ptr %gep.i.i.i, align 2
  %i.azn = load ptr, ptr %i.ada, align 8
  %i.azo = getelementptr inbounds [2 x i8], ptr %i.azn, i64 %indvars.iv465.i.i.i
  store i16 %i.azm, ptr %i.azo, align 2
  %i.azp = getelementptr [2 x i8], ptr %invariant.gep.i.i.i, i64 %indvars.iv463.i.i.i
  %gep.i.i.i.1 = getelementptr i8, ptr %i.azp, i64 2
  %i.azq = load i16, ptr %gep.i.i.i.1, align 2
  %i.azr = load ptr, ptr %i.ada, align 8
  %i.azs = getelementptr [2 x i8], ptr %i.azr, i64 %indvars.iv465.i.i.i
  %i.azt = getelementptr i8, ptr %i.azs, i64 2
  store i16 %i.azq, ptr %i.azt, align 2
  %i.azu = getelementptr [2 x i8], ptr %invariant.gep.i.i.i, i64 %indvars.iv463.i.i.i
  %gep.i.i.i.2 = getelementptr i8, ptr %i.azu, i64 4
  %i.azv = load i16, ptr %gep.i.i.i.2, align 2
  %i.azw = load ptr, ptr %i.ada, align 8
  %i.azx = getelementptr [2 x i8], ptr %i.azw, i64 %indvars.iv465.i.i.i
  %i.azy = getelementptr i8, ptr %i.azx, i64 4
  store i16 %i.azv, ptr %i.azy, align 2
  %indvars.iv.next464.i.i.i.3 = add nsw i64 %indvars.iv463.i.i.i, 4 ; 2 uses
  %i.azz = getelementptr [2 x i8], ptr %invariant.gep.i.i.i, i64 %indvars.iv463.i.i.i
  %gep.i.i.i.3 = getelementptr i8, ptr %i.azz, i64 6
  %i.baa = load i16, ptr %gep.i.i.i.3, align 2
  %i.bab = load ptr, ptr %i.ada, align 8
  %indvars.iv.next466.i.i.i.3 = add nsw i64 %indvars.iv465.i.i.i, 4 ; 2 uses
  %i.bac = getelementptr [2 x i8], ptr %i.bab, i64 %indvars.iv465.i.i.i
  %i.bad = getelementptr i8, ptr %i.bac, i64 6
  store i16 %i.baa, ptr %i.bad, align 2
  %exitcond471.not.i.i.i.3 = icmp eq i64 %indvars.iv.next464.i.i.i.3, %wide.trip.count470.i.i.i
  br i1 %exitcond471.not.i.i.i.3, label %._crit_edge394.loopexit.i.i.i, label %.lr.ph393.i.i.i, !llvm.loop !65

._crit_edge394.loopexit.i.i.i:                    ; preds = %.lr.ph393.i.i.i, %.lr.ph393.i.i.i.prol.loopexit
  %indvars.iv.next466.i.i.i.lcssa = phi i64 [ %indvars.iv.next466.i.i.i.lcssa.unr, %.lr.ph393.i.i.i.prol.loopexit ], [ %indvars.iv.next466.i.i.i.3, %.lr.ph393.i.i.i ]
  %i.bae = trunc nsw i64 %indvars.iv.next466.i.i.i.lcssa to i32
  %.pre477.i.i.i = load ptr, ptr %i.ada, align 8
  br label %._crit_edge394.i.i.i

._crit_edge394.i.i.i:                             ; preds = %._crit_edge394.loopexit.i.i.i, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i.i.i
  %i.baf = phi i32 [ %i.azb, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i.i.i ], [ %i.azd, %._crit_edge394.loopexit.i.i.i ]
  %i.bag = phi ptr [ %i.axt, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i.i.i ], [ %.pre477.i.i.i, %._crit_edge394.loopexit.i.i.i ]
  %.8.lcssa.i.i.i = phi i32 [ %.7396.i.i.i, %_ZN6icu_7812_GLOBAL__N_110getOverlapIttEEiPKT_iPKT0_ii.exit329.i.i.i ], [ %i.bae, %._crit_edge394.loopexit.i.i.i ] ; 2 uses
  call fastcc void @_ZN6icu_7812_GLOBAL__N_111MixedBlocks6extendItEEvPKT_iii(ptr noundef nonnull align 8 dereferenceable(28) %6, ptr noundef %i.bag, i32 noundef %i.act, i32 noundef %.7396.i.i.i, i32 noundef %.8.lcssa.i.i.i)
  %.pre478.i.i.i = load ptr, ptr %i.ada, align 8
  br label %bb.fi

bb.fi:                                            ; preds = %._crit_edge394.i.i.i, %_ZN6icu_7812_GLOBAL__N_113findSameBlockEPKtiiS2_ii.exit.i.i.i
  %i.bah = phi ptr [ %.pre478.i.i.i, %._crit_edge394.i.i.i ], [ %i.axt, %_ZN6icu_7812_GLOBAL__N_113findSameBlockEPKtiiS2_ii.exit.i.i.i ]
  %.1236346.i.i.i = phi i32 [ %.1236345.i.i.i, %._crit_edge394.i.i.i ], [ %.1236.i.i.i, %_ZN6icu_7812_GLOBAL__N_113findSameBlockEPKtiiS2_ii.exit.i.i.i ] ; 2 uses
  %.9.i.i.i = phi i32 [ %.8.lcssa.i.i.i, %._crit_edge394.i.i.i ], [ %.7396.i.i.i, %_ZN6icu_7812_GLOBAL__N_113findSameBlockEPKtiiS2_ii.exit.i.i.i ] ; 2 uses
  %.0229.i.i.i = phi i32 [ %i.baf, %._crit_edge394.i.i.i ], [ %.0230.i.i.i, %_ZN6icu_7812_GLOBAL__N_113findSameBlockEPKtiiS2_ii.exit.i.i.i ]
  %i.bai = trunc i32 %.0229.i.i.i to i16
  %indvars.iv.next473.i.i.i = add nuw nsw i64 %indvars.iv472.i.i.i, 1
  %i.baj = getelementptr inbounds nuw [2 x i8], ptr %i.bah, i64 %indvars.iv472.i.i.i
  store i16 %i.bai, ptr %i.baj, align 2
  %i.bak = add nsw i32 %.1236346.i.i.i, %.0233399.i.i.i ; 2 uses
  %i.bal = icmp slt i32 %i.bak, %.0270.lcssa.i.i.i
  br i1 %i.bal, label %bb.fc, label %.loopexit.i.i.i, !llvm.loop !66
...
bb.fo:                                            ; preds = %bb.fn
  ...
  %.pre242.i = load i32, ptr %.phi.trans.insert.i, align 4 ; 2 uses
  br i1 %.not108.i, label %._crit_edge241.i, label %bb.fp
...
bb.fp:                                            ; preds = %bb.fo
  ...
  store i32 %.pre242.i, ptr %i.bbp, align 4
  %.pre240.i = load i32, ptr %i.bbi, align 4
  br label %._crit_edge241.i

._crit_edge241.i:                                 ; preds = %bb.fp, %bb.fo
  %i.bbq = phi i32 [ %.pre240.i, %bb.fp ], [ %i.bbj, %bb.fo ] ; 3 uses
  ...
  %.not109.i = icmp eq i32 %i.bbv, %.pre242.i
  %.pre243.i = load i32, ptr %i.dj, align 4       ; 2 uses
  br i1 %.not109.i, label %bb.fq, label %bb.fr

bb.fq:                                            ; preds = %._crit_edge241.i
  %i.bbw = getelementptr i8, ptr %i.bbt, i64 -8
  %i.bbx = load i32, ptr %i.bbw, align 4
  %.not110.i = icmp eq i32 %i.bbx, %.pre243.i
  br i1 %.not110.i, label %bb.fs, label %bb.fr

bb.fr:                                            ; preds = %bb.fq, %._crit_edge241.i
  %i.bby = add nsw i32 %i.bbq, 1
  store i32 %i.bby, ptr %i.bbi, align 4
  store i32 %.pre243.i, ptr %i.bbt, align 4
  ...
  %.pre244.i = load i32, ptr %i.bbi, align 4
  br label %bb.fs

bb.fs:                                            ; preds = %bb.fr, %bb.fq
  %i.bcf = phi i32 [ %.pre244.i, %bb.fr ], [ %i.bbq, %bb.fq ]
...
bb.fu:                                            ; preds = %bb.ft, %.thread132.i
  ...
  %.pre233.i = load i32, ptr %i.dj, align 4       ; 3 uses
  br i1 %.not105.i, label %bb.fv, label %bb.fw

bb.fv:                                            ; preds = %bb.fu
  %i.bcs = getelementptr i8, ptr %i.bcn, i64 -8
  %i.bct = load i32, ptr %i.bcs, align 4
  %.not106.i = icmp eq i32 %i.bct, %.pre233.i
  br i1 %.not106.i, label %bb.fz, label %bb.fw

bb.fw:                                            ; preds = %bb.fv, %bb.fu
  %.not107.i = icmp eq i32 %i.bcp, %.pre233.i
  br i1 %.not107.i, label %bb.fy, label %bb.fx

bb.fx:                                            ; preds = %bb.fw
  %i.bcu = add nsw i32 %i.bcl, 1
  store i32 %i.bcu, ptr %i.bck, align 4
  store i32 %.pre233.i, ptr %i.bcn, align 4
  %.pre234.i = load i32, ptr %i.bcq, align 4
  %.pre235.i = load ptr, ptr %i.gh, align 8
  %.pre236.i = load i32, ptr %i.bck, align 4      ; 2 uses
  %.pre245.i = sext i32 %.pre236.i to i64
  br label %bb.fy

bb.fy:                                            ; preds = %bb.fx, %bb.fw
  %.pre-phi.i = phi i64 [ %.pre245.i, %bb.fx ], [ %i.bcm, %bb.fw ]
  %i.bcv = phi i32 [ %.pre236.i, %bb.fx ], [ %i.bcl, %bb.fw ]
  %i.bcw = phi ptr [ %.pre235.i, %bb.fx ], [ %i.bcj, %bb.fw ]
  %i.bcx = phi i32 [ %.pre234.i, %bb.fx ], [ %i.bcr, %bb.fw ]
  ...
  %.pre237.i = load i32, ptr %i.bck, align 4
  br label %bb.fz

bb.fz:                                            ; preds = %bb.fy, %bb.fv
  %i.bda = phi i32 [ %.pre237.i, %bb.fy ], [ %i.bcl, %bb.fv ]
...
..lr.ph.i_crit_edge:                              ; preds = %bb.ga
  %.pre238.i.pre = load i32, ptr %i.dj, align 4
  br label %.lr.ph.i
...
.lr.ph.i:                                         ; preds = %..lr.ph.i_crit_edge, %bb.gd, %bb.gc, %bb.gb
  %.pre238.i = phi i32 [ %.pre238.i.pre, %..lr.ph.i_crit_edge ], [ %i.bdx, %bb.gd ], [ %.pre238.i.pre87, %bb.gc ], [ %.pre238.i.pre87, %bb.gb ]
  br label %bb.gf

bb.gf:                                            ; preds = %bb.gf, %.lr.ph.i
  %.095176.i = phi i32 [ %i.bdg, %.lr.ph.i ], [ %i.bei, %bb.gf ]
  ...
  store i32 %.pre238.i, ptr %i.beg, align 4
  %i.beh = add nuw nsw i32 %.095176.i, 1
  %i.bei = and i32 %i.beh, 3                      ; 2 uses
  %.not104.i = icmp eq i32 %i.bei, 2
  br i1 %.not104.i, label %._crit_edge.loopexit.i, label %bb.gf, !llvm.loop !67

._crit_edge.loopexit.i:                           ; preds = %bb.gf
  %.pre239.i = load i32, ptr %i.bdd, align 4
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.ga
  %i.bej = phi i32 [ %.pre239.i, %._crit_edge.loopexit.i ], [ %i.bde, %bb.ga ] ; 2 uses
...
.preheader.i:                                     ; preds = %bb.gj
  ...
  br i1 %i.bgl, label %.lr.ph180.i, label %.loopexit136.i
...
.lr.ph180.i:                                      ; preds = %.preheader.i
  ...
  br i1 %i.bgn, label %.epil.preheader395, label %.lr.ph180.i.new

.lr.ph180.i.new:                                  ; preds = %.lr.ph180.i
  %unroll_iter401 = and i32 %.097130.i, 2147483644
  br label %bb.gk

bb.gk:                                            ; preds = %bb.gk, %.lr.ph180.i.new
  %indvars.iv.i = phi i64 [ 0, %.lr.ph180.i.new ], [ %indvars.iv.next.i.3, %bb.gk ] ; 5 uses
  %.089177.i = phi ptr [ %i.bgk, %.lr.ph180.i.new ], [ %i.bhg, %bb.gk ] ; 5 uses
  %niter402 = phi i32 [ 0, %.lr.ph180.i.new ], [ %niter402.next.3, %bb.gk ]
  ...
  %i.bgr = getelementptr inbounds nuw i8, ptr %.089177.i, i64 2
  store i16 %i.bgq, ptr %.089177.i, align 2
  ...
  %i.bgw = getelementptr inbounds nuw i8, ptr %.089177.i, i64 4
  ...
  %i.bhb = getelementptr inbounds nuw i8, ptr %.089177.i, i64 6
  ...
  %i.bhg = getelementptr inbounds nuw i8, ptr %.089177.i, i64 8 ; 3 uses
  ...
  br i1 %niter402.ncmp.3, label %.loopexit136.i.loopexit.unr-lcssa, label %bb.gk, !llvm.loop !68
...
.epil.preheader395:                               ; preds = %.loopexit136.i.loopexit.unr-lcssa, %.lr.ph180.i
  %indvars.iv.i.epil.init = phi i64 [ 0, %.lr.ph180.i ], [ %indvars.iv.next.i.3, %.loopexit136.i.loopexit.unr-lcssa ]
  %.089177.i.epil.init = phi ptr [ %i.bgk, %.lr.ph180.i ], [ %i.bhg, %.loopexit136.i.loopexit.unr-lcssa ]
...
bb.gm:                                            ; preds = %bb.gm, %.epil.preheader395
  ...
  %.089177.i.epil = phi ptr [ %.089177.i.epil.init, %.epil.preheader395 ], [ %i.bhp, %bb.gm ] ; 2 uses
  ...
  %i.bhp = getelementptr inbounds nuw i8, ptr %.089177.i.epil, i64 2 ; 2 uses
  store i16 %i.bho, ptr %.089177.i.epil, align 2
  ...
  br i1 %epil.iter397.cmp.not, label %.loopexit136.i, label %bb.gm, !llvm.loop !69
...
bb.gn:                                            ; preds = %.loopexit136.i
  ...
  br i1 %i.bht, label %.lr.ph190.i.preheader, label %.loopexit.i

.lr.ph190.i.preheader:                            ; preds = %bb.gn
  %i.bhu = zext nneg i32 %i.bfo to i64            ; 2 uses
  %min.iters.check272 = icmp ult i32 %i.bfo, 20
  br i1 %min.iters.check272, label %.lr.ph190.i.preheader288, label %vector.memcheck265

vector.memcheck265:                               ; preds = %.lr.ph190.i.preheader
  ...
  br i1 %found.conflict270, label %.lr.ph190.i.preheader288, label %vector.ph273
...
vector.body276:                                   ; preds = %vector.body276, %vector.ph273
  ...
  %wide.load280 = load <4 x i32>, ptr %next.gep278, align 4, !alias.scope !70
  %wide.load281 = load <4 x i32>, ptr %i.bij, align 4, !alias.scope !70
  ...
  store <4 x i16> %i.bik, ptr %next.gep279, align 2, !alias.scope !73, !noalias !70
  store <4 x i16> %i.bil, ptr %i.bim, align 2, !alias.scope !73, !noalias !70
  %index.next282 = add nuw i64 %index277, 8       ; 2 uses
  %i.bin = icmp eq i64 %index.next282, %n.vec275
  br i1 %i.bin, label %middle.block283, label %vector.body276, !llvm.loop !75

middle.block283:                                  ; preds = %vector.body276
  %cmp.n284 = icmp eq i64 %n.vec275, %i.bhu
  br i1 %cmp.n284, label %.loopexit.i, label %.lr.ph190.i.preheader288

.lr.ph190.i.preheader288:                         ; preds = %vector.memcheck265, %.lr.ph190.i.preheader, %middle.block283
  %.085188.i.ph = phi i32 [ %i.bfo, %vector.memcheck265 ], [ %i.bfo, %.lr.ph190.i.preheader ], [ %i.bic, %middle.block283 ]
  %.086187.i.ph = phi ptr [ %i.bhs, %vector.memcheck265 ], [ %i.bhs, %.lr.ph190.i.preheader ], [ %i.bie, %middle.block283 ]
  %.2186.i.ph = phi ptr [ %.190.i, %vector.memcheck265 ], [ %.190.i, %.lr.ph190.i.preheader ], [ %i.big, %middle.block283 ]
  br label %.lr.ph190.i

.lr.ph190.i:                                      ; preds = %.lr.ph190.i.preheader288, %.lr.ph190.i
  %.085188.i = phi i32 [ %i.bis, %.lr.ph190.i ], [ %.085188.i.ph, %.lr.ph190.i.preheader288 ] ; 2 uses
  %.086187.i = phi ptr [ %i.bio, %.lr.ph190.i ], [ %.086187.i.ph, %.lr.ph190.i.preheader288 ] ; 2 uses
  %.2186.i = phi ptr [ %i.bir, %.lr.ph190.i ], [ %.2186.i.ph, %.lr.ph190.i.preheader288 ] ; 2 uses
  %i.bio = getelementptr inbounds nuw i8, ptr %.086187.i, i64 4
  %i.bip = load i32, ptr %.086187.i, align 4
  %i.biq = trunc i32 %i.bip to i16
  %i.bir = getelementptr inbounds nuw i8, ptr %.2186.i, i64 2
  store i16 %i.biq, ptr %.2186.i, align 2
  %i.bis = add nsw i32 %.085188.i, -1
  %i.bit = icmp samesign ugt i32 %.085188.i, 1
  br i1 %i.bit, label %.lr.ph190.i, label %.loopexit.i, !llvm.loop !76
...
bb.gp:                                            ; preds = %.loopexit136.i
  ...
  br i1 %i.biw, label %.lr.ph185.i.preheader, label %.loopexit.i

.lr.ph185.i.preheader:                            ; preds = %bb.gp
  %i.bix = zext nneg i32 %i.bfo to i64            ; 2 uses
  %min.iters.check250 = icmp ult i32 %i.bfo, 20
  br i1 %min.iters.check250, label %.lr.ph185.i.preheader289, label %vector.memcheck247

vector.memcheck247:                               ; preds = %.lr.ph185.i.preheader
  ...
  br i1 %found.conflict, label %.lr.ph185.i.preheader289, label %vector.ph251
...
vector.body254:                                   ; preds = %vector.body254, %vector.ph251
  ...
  %wide.load257 = load <4 x i32>, ptr %next.gep, align 4, !alias.scope !77
  %wide.load258 = load <4 x i32>, ptr %i.bjk, align 4, !alias.scope !77
  ...
  store <4 x i8> %i.bjl, ptr %next.gep256, align 1, !alias.scope !80, !noalias !77
  store <4 x i8> %i.bjm, ptr %i.bjn, align 1, !alias.scope !80, !noalias !77
  %index.next259 = add nuw i64 %index255, 8       ; 2 uses
  %i.bjo = icmp eq i64 %index.next259, %n.vec253
  br i1 %i.bjo, label %middle.block260, label %vector.body254, !llvm.loop !82

middle.block260:                                  ; preds = %vector.body254
  %cmp.n261 = icmp eq i64 %n.vec253, %i.bix
  br i1 %cmp.n261, label %.loopexit.i, label %.lr.ph185.i.preheader289

.lr.ph185.i.preheader289:                         ; preds = %vector.memcheck247, %.lr.ph185.i.preheader, %middle.block260
  %.0183.i.ph = phi i32 [ %i.bfo, %vector.memcheck247 ], [ %i.bfo, %.lr.ph185.i.preheader ], [ %i.bjf, %middle.block260 ]
  %.1182.i.ph = phi ptr [ %i.bhs, %vector.memcheck247 ], [ %i.bhs, %.lr.ph185.i.preheader ], [ %i.bjh, %middle.block260 ]
  %.094181.i.ph = phi ptr [ %i.bhr, %vector.memcheck247 ], [ %i.bhr, %.lr.ph185.i.preheader ], [ %i.bji, %middle.block260 ]
  br label %.lr.ph185.i

.lr.ph185.i:                                      ; preds = %.lr.ph185.i.preheader289, %.lr.ph185.i
  %.0183.i = phi i32 [ %i.bjt, %.lr.ph185.i ], [ %.0183.i.ph, %.lr.ph185.i.preheader289 ] ; 2 uses
  %.1182.i = phi ptr [ %i.bjp, %.lr.ph185.i ], [ %.1182.i.ph, %.lr.ph185.i.preheader289 ] ; 2 uses
  %.094181.i = phi ptr [ %i.bjs, %.lr.ph185.i ], [ %.094181.i.ph, %.lr.ph185.i.preheader289 ] ; 2 uses
  %i.bjp = getelementptr inbounds nuw i8, ptr %.1182.i, i64 4
  %i.bjq = load i32, ptr %.1182.i, align 4
  %i.bjr = trunc i32 %i.bjq to i8
  %i.bjs = getelementptr inbounds nuw i8, ptr %.094181.i, i64 1
  store i8 %i.bjr, ptr %.094181.i, align 1
  %i.bjt = add nsw i32 %.0183.i, -1
  %i.bju = icmp samesign ugt i32 %.0183.i, 1
  br i1 %i.bju, label %.lr.ph185.i, label %.loopexit.i, !llvm.loop !83

.loopexit.i:                                      ; preds = %.lr.ph185.i, %.lr.ph190.i, %middle.block260, %middle.block283, %bb.gp, %bb.go, %bb.gn
...
bb.j:                                             ; preds = %bb.j, %bb.i
  ...
  br i1 %i.ar, label %bb.j, label %bb.k, !llvm.loop !84
...
bb.b:                                             ; preds = %.lr.ph, %_ZN6icu_7812_GLOBAL__N_111MixedBlocks8addEntryIjEEvPKT_iji.exit
  ...
  %.fr45.i.i = freeze i32 %.val                   ; 4 uses
  %i.i = add nsw i32 %.fr45.i.i, %.126
...
bb.c:                                             ; preds = %bb.c, %bb.b
  ...
  br i1 %i.t, label %bb.c, label %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeIjEEjPKT_i.exit, !llvm.loop !45
...
.lr.ph.split.us.i.i:                              ; preds = %.lr.ph.i.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us.i.i
  %i.ak = phi i32 [ %i.bc, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us.i.i ], [ %i.ad, %.lr.ph.i.i ] ; 2 uses
  %.02237.us.i.i = phi i32 [ %i.az, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us.i.i ], [ %i.z, %.lr.ph.i.i ] ; 2 uses
...
.lr.ph.i.us.i.i:                                  ; preds = %bb.d, %.lr.ph.i.preheader.us.i.i
  %.010.i.us.i.i = phi i32 [ %i.aw, %bb.d ], [ %.fr45.i.i, %.lr.ph.i.preheader.us.i.i ] ; 2 uses
  %.069.i.us.i.i = phi ptr [ %i.av, %bb.d ], [ %i.ai, %.lr.ph.i.preheader.us.i.i ] ; 2 uses
  %.078.i.us.i.i = phi ptr [ %i.au, %bb.d ], [ %i.aq, %.lr.ph.i.preheader.us.i.i ] ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph.i.us.i.i
  %i.au = getelementptr inbounds nuw i8, ptr %.078.i.us.i.i, i64 4
  %i.av = getelementptr inbounds nuw i8, ptr %.069.i.us.i.i, i64 4
  %i.aw = add nsw i32 %.010.i.us.i.i, -1
  %i.ax = icmp sgt i32 %.010.i.us.i.i, 1
  br i1 %i.ax, label %.lr.ph.i.us.i.i, label %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks9findEntryIjjEEiPKT_PKT0_ij.exit.i, !llvm.loop !47

_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us.i.i: ; preds = %.lr.ph.i.us.i.i, %.lr.ph.split.us.i.i
  %i.ay = add nsw i32 %.02237.us.i.i, %i.z
  %i.az = srem i32 %i.ay, %i.w                    ; 3 uses
  %i.ba = sext i32 %i.az to i64
  %i.bb = getelementptr inbounds [4 x i8], ptr %i.aa, i64 %i.ba
  %i.bc = load i32, ptr %i.bb, align 4            ; 2 uses
  %i.bd = icmp eq i32 %i.bc, 0
  br i1 %i.bd, label %._crit_edge.i.i, label %.lr.ph.split.us.i.i, !llvm.loop !48

.lr.ph.split.i.i:                                 ; preds = %.lr.ph.i.i
  %i.be = icmp eq i32 %.fr45.i.i, 0
...
._crit_edge.i.i:                                  ; preds = %.lr.ph.split.split.i.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us40.i.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us.i.i, %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeIjEEjPKT_i.exit
  %.022.lcssa.i.i = phi i32 [ %i.z, %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeIjEEjPKT_i.exit ], [ %i.az, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us.i.i ], [ %i.bj, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIjjEEbPKT_PKT0_i.exit.thread27.us40.i.i ], [ %i.bq, %.lr.ph.split.split.i.i ]
...
bb.c:                                             ; preds = %bb.c, %bb.b
  ...
  br i1 %i.v, label %bb.c, label %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeItEEjPKT_i.exit, !llvm.loop !86
...
.lr.ph.split.us.i.i:                              ; preds = %.lr.ph.i.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us.i.i
  %i.ak = phi i32 [ %i.bc, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us.i.i ], [ %i.af, %.lr.ph.i.i ] ; 2 uses
  %.02237.us.i.i = phi i32 [ %i.az, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us.i.i ], [ %i.ab, %.lr.ph.i.i ] ; 2 uses
...
.lr.ph.i.us.i.i:                                  ; preds = %bb.d, %.lr.ph.i.preheader.us.i.i
  %.010.i.us.i.i = phi i32 [ %i.aw, %bb.d ], [ %.fr45.i.i, %.lr.ph.i.preheader.us.i.i ] ; 2 uses
  %.069.i.us.i.i = phi ptr [ %i.av, %bb.d ], [ %i.l, %.lr.ph.i.preheader.us.i.i ] ; 2 uses
  %.078.i.us.i.i = phi ptr [ %i.au, %bb.d ], [ %i.aq, %.lr.ph.i.preheader.us.i.i ] ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph.i.us.i.i
  %i.au = getelementptr inbounds nuw i8, ptr %.078.i.us.i.i, i64 2
  %i.av = getelementptr inbounds nuw i8, ptr %.069.i.us.i.i, i64 2
  %i.aw = add nsw i32 %.010.i.us.i.i, -1
  %i.ax = icmp sgt i32 %.010.i.us.i.i, 1
  br i1 %i.ax, label %.lr.ph.i.us.i.i, label %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks9findEntryIttEEiPKT_PKT0_ij.exit.i, !llvm.loop !58

_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us.i.i: ; preds = %.lr.ph.i.us.i.i, %.lr.ph.split.us.i.i
  %i.ay = add nsw i32 %.02237.us.i.i, %i.ab
  %i.az = srem i32 %i.ay, %i.y                    ; 3 uses
  %i.ba = sext i32 %i.az to i64
  %i.bb = getelementptr inbounds [4 x i8], ptr %i.ac, i64 %i.ba
  %i.bc = load i32, ptr %i.bb, align 4            ; 2 uses
  %i.bd = icmp eq i32 %i.bc, 0
  br i1 %i.bd, label %._crit_edge.i.i, label %.lr.ph.split.us.i.i, !llvm.loop !87
...
_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us40.i.i: ; preds = %.lr.ph.split.split.us.i.i
  ...
  %i.bm = load i32, ptr %i.bl, align 4            ; 2 uses
  %i.bn = icmp eq i32 %i.bm, 0
  br i1 %i.bn, label %._crit_edge.i.i, label %.lr.ph.split.split.us.i.i, !llvm.loop !87
...
._crit_edge.i.i:                                  ; preds = %.lr.ph.split.split.i.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us40.i.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us.i.i, %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeItEEjPKT_i.exit
  %.022.lcssa.i.i = phi i32 [ %i.ab, %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeItEEjPKT_i.exit ], [ %i.az, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us.i.i ], [ %i.bj, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us40.i.i ], [ %i.bq, %.lr.ph.split.split.i.i ]
  %i.bo = xor i32 %.022.lcssa.i.i, -1
...
.lr.ph.split.split.i.i:                           ; preds = %.lr.ph.split.i.i, %.lr.ph.split.split.i.i
  ...
  %i.bt = load i32, ptr %i.bs, align 4
  %i.bu = icmp eq i32 %i.bt, 0
  br i1 %i.bu, label %._crit_edge.i.i, label %.lr.ph.split.split.i.i, !llvm.loop !87
...
_ZN6icu_7812_GLOBAL__N_111MixedBlocks8addEntryItEEvPKT_iji.exit: ; preds = %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks9findEntryIttEEiPKT_PKT0_ij.exit.i, %bb.e
  ...
  br i1 %.not17, label %._crit_edge, label %bb.b, !llvm.loop !88
}
...
bb.a:
  ...
  %.val = load i32, ptr %i.a, align 8
  %.fr45.i = freeze i32 %.val                     ; 4 uses
  %i.b = add nsw i32 %.fr45.i, %3
  %i.c = add nsw i32 %3, 1
...
bb.b:                                             ; preds = %bb.b, %bb.a
  ...
  br i1 %i.m, label %bb.b, label %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeIjEEjPKT_i.exit, !llvm.loop !45
...
.lr.ph.split.us.i:                                ; preds = %.lr.ph.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksItjEEbPKT_PKT0_i.exit.thread27.us.i
  %i.ae = phi i32 [ %i.ax, %_ZN6icu_7812_GLOBAL__N_111equalBlocksItjEEbPKT_PKT0_i.exit.thread27.us.i ], [ %i.y, %.lr.ph.i ] ; 2 uses
  %.02237.us.i = phi i32 [ %i.au, %_ZN6icu_7812_GLOBAL__N_111equalBlocksItjEEbPKT_PKT0_i.exit.thread27.us.i ], [ %i.u, %.lr.ph.i ] ; 2 uses
...
.lr.ph.i.us.i:                                    ; preds = %bb.c, %.lr.ph.i.preheader.us.i
  %.010.i.us.i = phi i32 [ %i.ar, %bb.c ], [ %.fr45.i, %.lr.ph.i.preheader.us.i ] ; 2 uses
  %.069.i.us.i = phi ptr [ %i.aq, %bb.c ], [ %i.e, %.lr.ph.i.preheader.us.i ] ; 2 uses
  %.078.i.us.i = phi ptr [ %i.ap, %bb.c ], [ %i.ak, %.lr.ph.i.preheader.us.i ] ; 2 uses
...
bb.c:                                             ; preds = %.lr.ph.i.us.i
  %i.ap = getelementptr inbounds nuw i8, ptr %.078.i.us.i, i64 2
  %i.aq = getelementptr inbounds nuw i8, ptr %.069.i.us.i, i64 4
  %i.ar = add nsw i32 %.010.i.us.i, -1
  %i.as = icmp sgt i32 %.010.i.us.i, 1
  br i1 %i.as, label %.lr.ph.i.us.i, label %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks9findEntryItjEEiPKT_PKT0_ij.exit, !llvm.loop !56

_ZN6icu_7812_GLOBAL__N_111equalBlocksItjEEbPKT_PKT0_i.exit.thread27.us.i: ; preds = %.lr.ph.i.us.i, %.lr.ph.split.us.i
  %i.at = add nsw i32 %.02237.us.i, %i.u
  %i.au = srem i32 %i.at, %i.r                    ; 3 uses
  %i.av = sext i32 %i.au to i64
  %i.aw = getelementptr inbounds [4 x i8], ptr %i.v, i64 %i.av
  %i.ax = load i32, ptr %i.aw, align 4            ; 2 uses
  %i.ay = icmp eq i32 %i.ax, 0
  br i1 %i.ay, label %._crit_edge.i, label %.lr.ph.split.us.i, !llvm.loop !89

.lr.ph.split.i:                                   ; preds = %.lr.ph.i
  %i.az = icmp eq i32 %.fr45.i, 0
...
_ZN6icu_7812_GLOBAL__N_111equalBlocksItjEEbPKT_PKT0_i.exit.thread27.us40.i: ; preds = %.lr.ph.split.split.us.i
  ...
  br i1 %i.bi, label %._crit_edge.i, label %.lr.ph.split.split.us.i, !llvm.loop !89
...
._crit_edge.i:                                    ; preds = %.lr.ph.split.split.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksItjEEbPKT_PKT0_i.exit.thread27.us40.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksItjEEbPKT_PKT0_i.exit.thread27.us.i, %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeIjEEjPKT_i.exit
  %.022.lcssa.i = phi i32 [ %i.u, %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeIjEEjPKT_i.exit ], [ %i.au, %_ZN6icu_7812_GLOBAL__N_111equalBlocksItjEEbPKT_PKT0_i.exit.thread27.us.i ], [ %i.be, %_ZN6icu_7812_GLOBAL__N_111equalBlocksItjEEbPKT_PKT0_i.exit.thread27.us40.i ], [ %i.bl, %.lr.ph.split.split.i ]
...
.lr.ph.split.split.i:                             ; preds = %.lr.ph.split.i, %.lr.ph.split.split.i
  ...
  br i1 %i.bp, label %._crit_edge.i, label %.lr.ph.split.split.i, !llvm.loop !89
...
bb.b:                                             ; preds = %bb.b, %bb.a
  ...
  br i1 %i.o, label %bb.b, label %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeItEEjPKT_i.exit, !llvm.loop !86
...
.lr.ph.split.us.i:                                ; preds = %.lr.ph.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us.i
  %i.ag = phi i32 [ %i.ay, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us.i ], [ %i.aa, %.lr.ph.i ] ; 2 uses
  %.02237.us.i = phi i32 [ %i.av, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us.i ], [ %i.w, %.lr.ph.i ] ; 2 uses
...
.lr.ph.i.us.i:                                    ; preds = %bb.c, %.lr.ph.i.preheader.us.i
  %.010.i.us.i = phi i32 [ %i.as, %bb.c ], [ %.fr45.i, %.lr.ph.i.preheader.us.i ] ; 2 uses
  %.069.i.us.i = phi ptr [ %i.ar, %bb.c ], [ %i.e, %.lr.ph.i.preheader.us.i ] ; 2 uses
  %.078.i.us.i = phi ptr [ %i.aq, %bb.c ], [ %i.am, %.lr.ph.i.preheader.us.i ] ; 2 uses
...
bb.c:                                             ; preds = %.lr.ph.i.us.i
  %i.aq = getelementptr inbounds nuw i8, ptr %.078.i.us.i, i64 2
  %i.ar = getelementptr inbounds nuw i8, ptr %.069.i.us.i, i64 2
  %i.as = add nsw i32 %.010.i.us.i, -1
  %i.at = icmp sgt i32 %.010.i.us.i, 1
  br i1 %i.at, label %.lr.ph.i.us.i, label %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks9findEntryIttEEiPKT_PKT0_ij.exit, !llvm.loop !58

_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us.i: ; preds = %.lr.ph.i.us.i, %.lr.ph.split.us.i
  %i.au = add nsw i32 %.02237.us.i, %i.w
  %i.av = srem i32 %i.au, %i.t                    ; 3 uses
  %i.aw = sext i32 %i.av to i64
  %i.ax = getelementptr inbounds [4 x i8], ptr %i.x, i64 %i.aw
  %i.ay = load i32, ptr %i.ax, align 4            ; 2 uses
  %i.az = icmp eq i32 %i.ay, 0
  br i1 %i.az, label %._crit_edge.i, label %.lr.ph.split.us.i, !llvm.loop !87

.lr.ph.split.i:                                   ; preds = %.lr.ph.i
  %i.ba = icmp eq i32 %.fr45.i, 0
...
_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us40.i: ; preds = %.lr.ph.split.split.us.i
  ...
  br i1 %i.bj, label %._crit_edge.i, label %.lr.ph.split.split.us.i, !llvm.loop !87
...
._crit_edge.i:                                    ; preds = %.lr.ph.split.split.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us40.i, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us.i, %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeItEEjPKT_i.exit
  %.022.lcssa.i = phi i32 [ %i.w, %_ZNK6icu_7812_GLOBAL__N_111MixedBlocks12makeHashCodeItEEjPKT_i.exit ], [ %i.av, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us.i ], [ %i.bf, %_ZN6icu_7812_GLOBAL__N_111equalBlocksIttEEbPKT_PKT0_i.exit.thread27.us40.i ], [ %i.bm, %.lr.ph.split.split.i ]
...
.lr.ph.split.split.i:                             ; preds = %.lr.ph.split.i, %.lr.ph.split.split.i
  ...
  br i1 %i.bq, label %._crit_edge.i, label %.lr.ph.split.split.i, !llvm.loop !87
...
!41 = distinct !{!41, !6}
!42 = distinct !{!42, !6}
!43 = distinct !{!43, !6, !15, !14}
!44 = distinct !{!44, !6, !14, !15}
!45 = distinct !{!45, !6}
!46 = distinct !{!46, !28}
!47 = distinct !{!47, !6}
!48 = distinct !{!48, !6}
!49 = distinct !{!49, !6}
!50 = distinct !{!50, !6, !15, !14}
!51 = distinct !{!51, !28}
!52 = distinct !{!52, !6, !15}
!53 = distinct !{!53, !6}
!54 = distinct !{!54, !6}
