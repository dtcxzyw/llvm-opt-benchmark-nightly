...
bb.d:                                             ; preds = %bb.c
  %i.ah = icmp slt i32 %i.aa, 65537               ; 2 uses
  %2 = select i1 %i.ah, i64 16384, i64 278528
  %i.ai = tail call noalias ptr @uprv_malloc_78(i64 noundef %2) #11
...
_ZN6icu_7812LocalPointerINS_12_GLOBAL__N_120MutableCodePointTrieEEC2EPS2_R10UErrorCode.exit: ; preds = %bb.d
  %3 = select i1 %i.ah, i32 4096, i32 69632
...
_ZN6icu_7812_GLOBAL__N_120MutableCodePointTrie10maskValuesEj.exit.i: ; preds = %bb.l, %bb.t, %.preheader.i114.i, %.preheader.i.i, %bb.d
  %i.cq = icmp eq i32 %1, 0                       ; 6 uses
  %i.cr = select i1 %i.cq, i32 65536, i32 4096    ; 4 uses
  %7 = select i1 %i.cq, i32 4096, i32 256         ; 7 uses
...
begin_hunk_3_@umutablecptrie_buildImmutable_78:bb.a
  ...
  %8 = select i1 %i.cq, i32 1024, i32 64          ; 5 uses
...
bb.db:                                            ; preds = %bb.cz
  ...
  %wide.trip.count.i81.i.i = select i1 %i.cq, i64 1024, i64 64
  br label %bb.dc
...
begin_hunk_5_@umutablecptrie_buildImmutable_78:bb.a
  ...
  %9 = select i1 %i.cq, i32 4096, i32 0           ; 4 uses
  %i.zi = load i32, ptr %i.cs, align 8
  %i.zj = ashr i32 %i.zi, 4                       ; 4 uses
  %i.zk = icmp slt i32 %9, %i.zj                  ; 2 uses
...
bb.dq:                                            ; preds = %._crit_edge.i86.i.i
  %10 = select i1 %i.cq, i64 2048, i64 128
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(128) %i.act, ptr noundef nonnull align 16 dereferenceable(128) %i.a, i64 %10, i1 false)
