...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i:     ; preds = %bb.av, %.lr.ph.i.i
  %.041.i.i = phi i64 [ %i.hx, %.lr.ph.i.i ], [ %i.ig, %bb.av ]
  %.02840.i.i = phi ptr [ %i.hy, %.lr.ph.i.i ], [ %i.ie, %bb.av ]
  %i.ib = add i64 %.041.i.i, -25
  %i.ic = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02840.i.i, i32 noundef 69, i64 noundef %i.ib) #32 ; 4 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findEPKcm.exit.thread: ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i, %bb.av, %_ZNK4node16MaybeStackBufferIcLm1024EE8ToStringB5cxx11Ev.exit, %bb.au
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i150:  ; preds = %bb.bl, %.lr.ph.i.i149
  ...
  %i.jy = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02840.i.i152, i32 noundef 78, i64 noundef %i.jx) #32 ; 4 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findEPKcm.exit158.thread: ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i150, %bb.bl, %_ZNK4node16MaybeStackBufferIcLm1024EE8ToStringB5cxx11Ev.exit145, %bb.bk
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a:   ; preds = %bb.ao, %.lr.ph.i.i
  ...
  %reass.sub = sub i64 %.041.i.i, %i.ir
  %i.iz = add i64 %reass.sub, 1
  %47 = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02840.i.i, i32 noundef %i.ix, i64 noundef %i.iz) #32 ; 4 uses
  %.not34.i.i.a = icmp eq ptr %47, null
  br i1 %.not34.i.i.a, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findISt17basic_string_viewIcS2_EEENSt9enable_ifIXsr6__and_ISt14is_convertibleIRKT_S7_ESt6__not_IS9_IPSB_PKS4_EESE_IS9_ISC_PKcEEEE5valueEmE4typeESC_m.exit.thread, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findISt17basic_string_viewIcS2_EEENSt9enable_ifIXsr6__and_ISt14is_convertibleIRKT_S7_ESt6__not_IS9_IPSB_PKS4_EESE_IS9_ISC_PKcEEEE5valueEmE4typeESC_m.exit.thread: ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a, %bb.ao, %bb.am, %bb.an
