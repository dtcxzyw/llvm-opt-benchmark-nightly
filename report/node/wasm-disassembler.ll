...
bb.b:                                             ; preds = %.lr.ph, %bb.f
  ...
  %3 = getelementptr inbounds nuw i8, ptr %.sroa.010.013, i64 12
  %4 = load i32, ptr %3, align 4
  %.not.a = icmp eq i32 %4, %2
...
bb.f:                                             ; preds = %bb.b, %_ZN2v88internal4wasmlsERNS1_13StringBuilderEPKc.exit9
...
bb.ac:                                            ; preds = %bb.ab
  %i.bl = and i64 %i.bf, 4294967295
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bh, i64 %i.bl
  br label %_ZN2v88internal4wasm7Decoder13consume_bytesEjPKc.exit12

bb.ad:                                            ; preds = %bb.ab
  call preserve_mostcc void @_ZN2v88internal4wasm7Decoder6errorfIJjEEEvPKhPKcDpT_(ptr noundef nonnull align 8 dereferenceable(80) %0, ptr noundef %i.bh, ptr noundef nonnull @.str.72, i32 noundef %i.bg)
  %i.bn = load ptr, ptr %i.f, align 8
  br label %_ZN2v88internal4wasm7Decoder13consume_bytesEjPKc.exit12

_ZN2v88internal4wasm7Decoder13consume_bytesEjPKc.exit12: ; preds = %bb.ac, %bb.ad
  %storemerge.i11 = phi ptr [ %i.bn, %bb.ad ], [ %i.bm, %bb.ac ]
...
bb.ai:                                            ; preds = %bb.ag
  call preserve_mostcc void @_ZN2v88internal4wasm7Decoder6errorfIJjEEEvPKhPKcDpT_(ptr noundef nonnull align 8 dereferenceable(80) %0, ptr noundef %i.bx, ptr noundef nonnull @.str.72, i32 noundef %i.bw)
...
bb.ao:                                            ; preds = %bb.am
  ...
  %i.ci = call noundef ptr @_ZN2v88internal4wasm11SectionNameENS1_11SectionCodeE(i8 noundef signext 14) #20
  call preserve_mostcc void @_ZN2v88internal4wasm7Decoder6errorfIJPKcEEEvPKhS5_DpT_(ptr noundef nonnull align 8 dereferenceable(80) %0, ptr noundef %i.ch, ptr noundef nonnull @.str.829, ptr noundef %i.ci)
  br label %bb.aq

bb.ap:                                            ; preds = %bb.b
  %i.cj = load ptr, ptr %i.e, align 8
  %i.ck = call noundef ptr @_ZN2v88internal4wasm11SectionNameENS1_11SectionCodeE(i8 noundef signext %1) #20
  call preserve_mostcc void @_ZN2v88internal4wasm7Decoder6errorfIJPKcEEEvPKhS5_DpT_(ptr noundef nonnull align 8 dereferenceable(80) %0, ptr noundef %i.cj, ptr noundef nonnull @.str.830, ptr noundef %i.ck)
  br label %bb.as
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %i.cn = select i1 %i.cm, ptr @.str.831, ptr @.str.832
  %i.co = ptrtoint ptr %i.cl to i64
  %i.cp = ptrtoint ptr %2 to i64
  %i.cq = sub i64 %i.co, %i.cp
  call preserve_mostcc void @_ZN2v88internal4wasm7Decoder6errorfIJPKcmmEEEvPKhS5_DpT_(ptr noundef nonnull align 8 dereferenceable(80) %0, ptr noundef %i.cl, ptr noundef nonnull @.str.833, ptr noundef nonnull %i.cn, i64 noundef %3, i64 noundef %i.cq)
  br label %bb.as
...
.lr.ph.i:                                         ; preds = %bb.j, %bb.n
  ...
  %3 = load i8, ptr %2, align 4, !range !10, !noundef !11
  %4 = trunc nuw i8 %3 to i1
  %i.ap = getelementptr inbounds nuw i8, ptr %.sroa.030.033.i, i64 21
  %i.aq = load i8, ptr %i.ap, align 1, !range !10
...
.lr.ph.i:                                         ; preds = %bb.c, %bb.g
  ...
  %i.m = load i8, ptr %i.l, align 1, !range !10
...
bb.g:                                             ; preds = %bb.g, %.lr.ph.i
  ...
  br i1 %i.at, label %bb.g, label %bb.h, !llvm.loop !308
...
bb.h:                                             ; preds = %bb.g, %bb.e, %bb.f
  ...
  %i.av = load i8, ptr %i.au, align 8, !range !10
