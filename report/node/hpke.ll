...
bb.f:                                             ; preds = %bb.d
  ...
  %i.l = load i64, ptr %i.k, align 8, !tbaa !54   ; 9 uses
...
bb.m:                                             ; preds = %bb.k
  ...
  %i.ai = trunc i64 %7 to i8
  %10 = trunc nuw i64 %8 to i8
  %i.aj = load <8 x i8>, ptr %i.x, align 1, !tbaa !60
  %11 = insertelement <8 x i8> poison, i8 %10, i64 0
  %12 = insertelement <8 x i8> %11, i8 %i.ai, i64 1
  %i.ak = insertelement <8 x i8> %12, i8 %i.ah, i64 2
  %i.al = insertelement <8 x i8> %i.ak, i8 %i.ag, i64 3
  %i.am = insertelement <8 x i8> %i.al, i8 %i.af, i64 4
  %i.an = insertelement <8 x i8> %i.am, i8 %i.ae, i64 5
  %i.ao = insertelement <8 x i8> %i.an, i8 %i.ad, i64 6
  %i.ap = insertelement <8 x i8> %i.ao, i8 %9, i64 7
