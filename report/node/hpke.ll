...
bb.m:                                             ; preds = %bb.k
  ...
  %i.y = lshr i64 %i.l, 8
  %i.z = lshr i64 %i.l, 16
  %i.aa = lshr i64 %i.l, 24
  %i.ab = lshr i64 %i.l, 32
  %i.ac = lshr i64 %i.l, 40
  %7 = insertelement <2 x i64> poison, i64 %i.l, i64 0
  %8 = shufflevector <2 x i64> %7, <2 x i64> poison, <2 x i32> zeroinitializer
  %9 = lshr <2 x i64> %8, <i64 56, i64 48>
  %i.ad = trunc i64 %i.l to i8
  %i.ae = trunc i64 %i.y to i8
  %i.af = trunc i64 %i.z to i8
  %i.ag = trunc i64 %i.aa to i8
  %i.ah = trunc i64 %i.ab to i8
  %i.ai = trunc i64 %i.ac to i8
  %10 = trunc <2 x i64> %9 to <2 x i8>
  %i.aj = load <8 x i8>, ptr %i.x, align 1, !tbaa !60
  %11 = shufflevector <2 x i8> %10, <2 x i8> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.ak = insertelement <8 x i8> %11, i8 %i.ai, i64 2
  %i.al = insertelement <8 x i8> %i.ak, i8 %i.ah, i64 3
  %i.am = insertelement <8 x i8> %i.al, i8 %i.ag, i64 4
  %i.an = insertelement <8 x i8> %i.am, i8 %i.af, i64 5
  %i.ao = insertelement <8 x i8> %i.an, i8 %i.ae, i64 6
  %i.ap = insertelement <8 x i8> %i.ao, i8 %i.ad, i64 7
  %i.aq = xor <8 x i8> %i.aj, %i.ap
  store <8 x i8> %i.aq, ptr %i.v, align 4, !tbaa !60
  %i.ar = call fastcc i32 @hpke_aead_enc(ptr noundef %0, ptr noundef %i.a, ptr noundef %3, i64 noundef %4, ptr noundef %5, i64 noundef %6, ptr noundef %1, ptr noundef %2)
  %.not32.not = icmp eq i32 %i.ar, 0
...
bb.o:                                             ; preds = %bb.m
  %i.as = load i64, ptr %i.k, align 8, !tbaa !54
  %i.at = add i64 %i.as, 1
  store i64 %i.at, ptr %i.k, align 8, !tbaa !54
  call void @OPENSSL_cleanse(ptr noundef nonnull %i.a, i64 noundef 12) #5
  br label %bb.p
...
bb.m:                                             ; preds = %bb.k
  ...
  %i.aq = xor <8 x i8> %i.aj, %i.ap
  store <8 x i8> %i.aq, ptr %i.v, align 4, !tbaa !60
  %i.ar = call fastcc i32 @hpke_aead_dec(ptr noundef %0, ptr noundef %i.a, ptr noundef %3, i64 noundef %4, ptr noundef %5, i64 noundef %6, ptr noundef %1, ptr noundef %2)
  %.not32.not = icmp eq i32 %i.ar, 0
  br i1 %.not32.not, label %bb.n, label %bb.o
