...
begin_hunk_0_@_ZN4node9inspector5Agent15GetParentHandleEmSt17basic_string_viewIcSt11char_traitsIcEES5_
...
bb.a:
  %3 = alloca %"class.std::function.336", align 16 ; 8 uses
  %4 = alloca %"class.std::function.561", align 8 ; 7 uses
  tail call void @_ZN4node11Environment15InitializeLibuvEv(ptr noundef nonnull align 8 dereferenceable(3304) %0) #16
  tail call void @_ZN4node11Environment21InitializeDiagnosticsEv(ptr noundef nonnull align 8 dereferenceable(3304) %0) #16
end_hunk_0
begin_hunk_1_@_ZN4node15LoadEnvironmentEPNS_11EnvironmentESt8functionIFN2v810MaybeLocalINS3_5ValueEEERKNS_36StartExecutionCallbackInfoWithModuleEEES2_IFvS1_NS3_5LocalIS5_EESD_EE:bb.a
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.a, i8 0, i64 16, i1 false)
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 3184 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %2, i64 16, i1 false)
  %.sroa.0.0.copyload.i.i.pre.i.i = load <2 x i64>, ptr %3, align 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %i.e, i64 16, i1 false)
  store <2 x i64> %.sroa.0.0.copyload.i.i.pre.i.i, ptr %i.e, align 8
  ...
  store <2 x ptr> %i.i, ptr %i.f, align 16
...
end_hunk_1
begin_hunk_2_@_ZN4node25DefaultProcessExitHandlerEPNS_11EnvironmentEi:bb.a
; Function Attrs: mustprogress nounwind uwtable
...
end_hunk_2
begin_hunk_3_@_ZN4node21SetProcessExitHandlerEPNS_11EnvironmentEOSt8functionIFvS1_NS_8ExitCodeEEE:bb.a
  br i1 %.not.i.i.not.i.i.i, label %_ZNSt8functionIFvPN4node11EnvironmentENS0_8ExitCodeEEEC2EOS5_.exit.i.i, label %bb.b

bb.b:                                             ; preds = %bb.a
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %1, i64 16, i1 false)
...
_ZNSt8functionIFvPN4node11EnvironmentENS0_8ExitCodeEEEC2EOS5_.exit.i.i: ; preds = %bb.b, %bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %i.a, i64 16, i1 false)
  store <2 x i64> %.sroa.0.0.copyload.i.i.i.i, ptr %i.a, align 8
  ...
  store <2 x ptr> %i.g, ptr %i.e, align 16
...
end_hunk_3
begin_hunk_4_@_ZN4node21SetProcessExitHandlerEPNS_11EnvironmentEOSt8functionIFvS1_NS_8ExitCodeEEE:bb.a
; Function Attrs: mustprogress nounwind uwtable
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #16
end_hunk_4
begin_hunk_5_@_ZN4node21SetProcessExitHandlerEPNS_11EnvironmentEOSt8functionIFvS1_iEE:bb.a
_ZNSt8functionIFvPN4node11EnvironmentENS0_8ExitCodeEEEC2EOS5_.exit.i.i: ; preds = %_ZNSt8functionIFvPN4node11EnvironmentEiEEC2ERKS4_.exit, %bb.c
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #16
  store ptr %i.q, ptr %2, align 16
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 8
  store i64 0, ptr %.sroa.5.0..sroa_idx, align 8
  %.sroa.0.0.copyload.i.i.pre.i.i = load <2 x i64>, ptr %2, align 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %2, ptr noundef nonnull align 8 dereferenceable(32) %i.u, i64 16, i1 false)
  store <2 x i64> %.sroa.0.0.copyload.i.i.pre.i.i, ptr %i.u, align 8
  ...
  store <2 x ptr> %i.y, ptr %i.v, align 16
