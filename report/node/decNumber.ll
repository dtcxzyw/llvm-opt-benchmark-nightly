...
bb.n:                                             ; preds = %.lr.ph401
  ...
  %.not370 = icmp uge i32 %.0264400, %i.ao        ; 3 uses
  %i.ap = select i1 %.not370, i8 56, i8 48        ; 2 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %.not354 = icmp uge i32 %.7, %i.cp              ; 3 uses
  %i.cq = select i1 %.not354, i8 56, i8 48        ; 2 uses
...
bb.at:                                            ; preds = %bb.as
  ...
  %.not359 = icmp uge i32 %.14, %i.dy             ; 3 uses
  %i.dz = select i1 %.not359, i8 56, i8 48        ; 2 uses
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %.not349 = icmp uge i32 %.21, %i.ff             ; 3 uses
  %i.fg = select i1 %.not349, i8 56, i8 48        ; 2 uses
...
begin_hunk_7_@uprv_decNumberPower_78:bb.a
  ...
  %or.cond3 = and i1 %i.eu, %i.ev
  %spec.select213 = select i1 %or.cond3, i8 -128, i8 0 ; 4 uses
  %i.ew = and i32 %i.g, 64
...
bb.ai:                                            ; preds = %bb.ah, %bb.ag
  %8 = or disjoint i8 %spec.select213, 64
...
bb.am:                                            ; preds = %bb.al
  %9 = lshr i8 %i.i, 1
  %10 = and i8 %9, 64
  %spec.select217 = or disjoint i8 %spec.select213, %10
