...
bb.x:                                             ; preds = %bb.w, %bb.v
  ...
  %12 = getelementptr inbounds nuw i8, ptr %i.bv, i64 %i.cs
...
.loopexit76.i:                                    ; preds = %.lr.ph86.i.preheader, %.loopexit76.loopexit92.i
  ...
  %.2.i = getelementptr inbounds i8, ptr %i.cj, i64 -1 ; 4 uses
  %.2.i301 = ptrtoint ptr %.2.i to i64            ; 3 uses
  %.not7488.i = icmp ult ptr %.2.i, %i.bv
...
.lr.ph91.preheader.i:                             ; preds = %.loopexit76.i
  ...
  %14 = getelementptr inbounds i8, ptr %i.cj, i64 -2
  %.not74.peel.i = icmp ult ptr %14, %i.bv
...
bb.ar:                                            ; preds = %bb.ap, %bb.ao
  ...
  %i.gb = getelementptr inbounds nuw i8, ptr %11, i64 4
  store i32 0, ptr %i.gb, align 4
  store i32 1, ptr %11, align 4
  %i.gc = getelementptr inbounds nuw i8, ptr %11, i64 9
  store i8 1, ptr %i.gc, align 1
  %i.gd = call ptr @uprv_decContextDefault_78(ptr noundef nonnull %5, i32 noundef 64) #15 ; 0 uses
  ...
  store i32 %i.eu, ptr %4, align 4
end_hunk_0
begin_hunk_1_@uprv_decNumberOr_78:bb.a
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.s, label %bb.g, label %.thread256
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %or.cond212, label %bb.h, label %.thread256
...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %i.al, label %.thread249.thread.thread254, label %bb.m
...
bb.n:                                             ; preds = %bb.m
  ...
  br label %.thread249.thread.thread254
...
bb.t:                                             ; preds = %bb.s, %bb.r
  ...
  %8 = getelementptr inbounds nuw i8, ptr %i.ad, i64 %i.bh
...
.loopexit76.i:                                    ; preds = %.lr.ph86.i.preheader, %.loopexit76.loopexit92.i
  ...
  %.2.i = getelementptr inbounds i8, ptr %i.ay, i64 -1 ; 4 uses
  %.2.i277 = ptrtoint ptr %.2.i to i64            ; 3 uses
  %.not7488.i = icmp ult ptr %.2.i, %i.ad
  br i1 %.not7488.i, label %.thread249.thread.thread254, label %.lr.ph91.preheader.i

.lr.ph91.preheader.i:                             ; preds = %.loopexit76.i
  store i8 %.162.i, ptr %.2.i, align 1
  %10 = getelementptr inbounds i8, ptr %i.ay, i64 -2
  %.not74.peel.i = icmp ult ptr %10, %i.ad
  br i1 %.not74.peel.i, label %.thread249.thread.thread254, label %.lr.ph91.i.preheader

.lr.ph91.i.preheader:                             ; preds = %.lr.ph91.preheader.i
  %i.bm = add i64 %.2.i277, -2
  %i.bn = add i64 %i.a, 8
  %umin = call i64 @llvm.umin.i64(i64 %i.bm, i64 %i.bn) ; 2 uses
  %i.bo = add i64 %umin, 1
  %i.bp = sub i64 %i.bo, %.2.i277
  %scevgep = getelementptr i8, ptr %.2.i, i64 %i.bp
  %i.bq = xor i64 %umin, -1
  %i.br = add i64 %i.bq, %.2.i277
  call void @llvm.memset.p0.i64(ptr align 1 %scevgep, i8 0, i64 %i.br, i1 false)
  br label %.thread249.thread.thread254

.thread249.thread.thread254:                      ; preds = %.lr.ph91.i.preheader, %.lr.ph91.preheader.i, %.loopexit76.i, %bb.n, %bb.l
...
bb.ab:                                            ; preds = %bb.aa
  ...
  br i1 %i.cj, label %.critedge.thread.loopexit.i, label %bb.aa, !llvm.loop !108
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi309 = phi <4 x i32> [ zeroinitializer, %vector.ph ], [ %i.dg, %vector.body ]
  ...
  %wide.load310 = load <4 x i8>, ptr %i.cz, align 1
  %i.da = zext <4 x i8> %wide.load to <4 x i32>
  %i.db = zext <4 x i8> %wide.load310 to <4 x i32>
  %gep = getelementptr [4 x i8], ptr %invariant.gep, i64 %index ; 2 uses
  %i.dc = getelementptr inbounds nuw i8, ptr %gep, i64 16
  %wide.load311 = load <4 x i32>, ptr %gep, align 4
  %wide.load312 = load <4 x i32>, ptr %i.dc, align 4
  %i.dd = mul <4 x i32> %wide.load311, %i.da
  %i.de = mul <4 x i32> %wide.load312, %i.db
  %i.df = add <4 x i32> %i.dd, %vec.phi           ; 2 uses
  %i.dg = add <4 x i32> %i.de, %vec.phi309        ; 2 uses
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.dh = icmp eq i64 %index.next, %n.vec
  br i1 %i.dh, label %middle.block, label %vector.body, !llvm.loop !109
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  br i1 %i.dr, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !110
...
.thread101.i:                                     ; preds = %bb.ad, %._crit_edge.i
  %i.eg = sub nsw i32 0, %.4.lcssa.i
  %spec.select90.i = select i1 %i.bx, i32 %i.eg, i32 %.4.lcssa.i
  br label %_ZL9decGetIntPK9decNumber.exit

_ZL9decGetIntPK9decNumber.exit:                   ; preds = %bb.aa, %bb.x, %.thread.i, %.thread101.i
  %.3.i = phi i32 [ %spec.select90.i, %.thread101.i ], [ %..i, %.thread.i ], [ 0, %bb.x ], [ -2147483648, %bb.aa ] ; 8 uses
  %.not187 = icmp eq i32 %.3.i, -2147483648       ; 2 uses
  %i.eh = icmp slt i8 %i.f, 0
  %i.ei = trunc i32 %.3.i to i1
  %or.cond3 = and i1 %i.eh, %i.ei
end_hunk_1
