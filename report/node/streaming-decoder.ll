...
_ZN2v84base11OwnedVectorIKhEC2IS2_Qsr3stdE16is_convertible_vISt10unique_ptrITL0__St14default_deleteIS6_EES5_IT_S7_ISA_EEEEEONS1_ISA_EE.exit: ; preds = %_ZN2v84base11OwnedVectorIhED2Ev.exit, %bb.m, %.thread, %bb.n, %bb.o, %_ZNKSt14default_deleteIN2v88internal4wasm18StreamingProcessorEEclEPS3_.exit.i.i.i.i.i
  %i.dk = phi ptr [ null, %_ZN2v84base11OwnedVectorIhED2Ev.exit ], [ null, %bb.m ], [ %.pre69, %.thread ], [ null, %bb.n ], [ null, %bb.o ], [ %.pre, %_ZNKSt14default_deleteIN2v88internal4wasm18StreamingProcessorEEclEPS3_.exit.i.i.i.i.i ]
