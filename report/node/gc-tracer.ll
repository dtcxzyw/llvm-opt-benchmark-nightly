...
begin_hunk_2_@_ZN2v88internal8GCTracer10StartCycleENS0_16GarbageCollectorENS0_23GarbageCollectionReasonEPKcNS1_11MarkingTypeE:bb.a
  ...
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 37
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(21) %i.r, ptr noundef nonnull align 1 dereferenceable(21) %.sroa.10, i64 21, i1 false)
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 58
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(150) %i.s, ptr noundef nonnull align 2 dereferenceable(150) %.sroa.11, i64 150, i1 false)
  ...
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 1572
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(24) %i.t, ptr noundef nonnull align 4 dereferenceable(24) %.sroa.14, i64 24, i1 false)
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 1596
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(24) %i.u, ptr noundef nonnull align 4 dereferenceable(24) %.sroa.15, i64 24, i1 false)
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 1620
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(24) %i.v, ptr noundef nonnull align 4 dereferenceable(24) %.sroa.16, i64 24, i1 false)
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 1644
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(24) %i.w, ptr noundef nonnull align 4 dereferenceable(24) %.sroa.17, i64 24, i1 false)
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 1668
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(24) %i.x, ptr noundef nonnull align 4 dereferenceable(24) %.sroa.18, i64 24, i1 false)
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 1692
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(24) %i.y, ptr noundef nonnull align 4 dereferenceable(24) %.sroa.19, i64 24, i1 false)
