...
bb.c:                                             ; preds = %bb.a
  ...
  %spec.store.select = select i1 %i.i, i64 16, i64 %i.h ; 3 uses
  %i.j = add nuw nsw i64 %spec.store.select, 16   ; 2 uses
  %i.k = sub i64 %3, %i.j                         ; 4 uses
...
bb.h:                                             ; preds = %do_xor.exit
  ...
  %8 = add i64 %spec.store.select, %i.k
  %9 = add i64 %8, 16
  br label %bb.i

bb.i:                                             ; preds = %do_xor.exit, %bb.f, %bb.d, %bb.h, %bb.b
  %.044 = phi i64 [ 0, %bb.d ], [ %i.g, %bb.b ], [ %9, %bb.h ], [ 0, %bb.f ], [ 0, %do_xor.exit ]
