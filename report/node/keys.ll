...
begin_hunk_0_@_ZN2v88internal18FastKeyAccumulator11GetKeysFastENS0_17GetKeysConversionE:bb.a
  ...
  %.pre58 = load ptr, ptr %0, align 8             ; 4 uses
...
begin_hunk_1_@_ZN2v88internal18FastKeyAccumulator11GetKeysFastENS0_17GetKeysConversionE:bb.a
  ...
  %i.aj = getelementptr inbounds nuw i8, ptr %.pre58, i64 864
  %i.ak = load i64, ptr %i.aj, align 8
  %.not.i = icmp eq i64 %i.ai, %i.ak
  br i1 %.not.i, label %.critedge.i, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.al = getelementptr inbounds nuw i8, ptr %.pre58, i64 1856
...
_ZN2v88internal18FastKeyAccumulator37GetOwnKeysWithUninitializedEnumLengthEv.exit: ; preds = %bb.h, %bb.i
  ...
  br i1 %i.bd, label %_ZN2v88internal18FastKeyAccumulator37GetOwnKeysWithUninitializedEnumLengthEv.exit..critedge_crit_edge, label %bb.j

_ZN2v88internal18FastKeyAccumulator37GetOwnKeysWithUninitializedEnumLengthEv.exit..critedge_crit_edge: ; preds = %_ZN2v88internal18FastKeyAccumulator37GetOwnKeysWithUninitializedEnumLengthEv.exit
...
.critedge:                                        ; preds = %_ZN2v88internal18FastKeyAccumulator37GetOwnKeysWithUninitializedEnumLengthEv.exit..critedge_crit_edge, %bb.g, %bb.e
  %2 = phi ptr [ %.pre, %_ZN2v88internal18FastKeyAccumulator37GetOwnKeysWithUninitializedEnumLengthEv.exit..critedge_crit_edge ], [ %.pre58, %bb.g ], [ %.pre58, %bb.e ]
  %i.by = getelementptr inbounds nuw i8, ptr %0, i64 49
  %i.bz = load i8, ptr %i.by, align 1, !range !5, !noundef !6
  %i.ca = trunc nuw i8 %i.bz to i1
  %i.cb = tail call fastcc ptr @_ZN2v88internal12_GLOBAL__N_122GetOwnKeysWithElementsILb1EEENS0_11MaybeHandleINS0_10FixedArrayEEEPNS0_7IsolateENS0_12DirectHandleINS0_8JSObjectEEENS0_17GetKeysConversionEb(ptr noundef %2, ptr nonnull %.sroa.0.0.copyload.i11, i32 noundef %1, i1 noundef zeroext %i.ca)
  br label %bb.m
...
_ZSt13move_backwardIN2v88internal10AtomicSlotES2_ET0_T_S4_S3_.exit: ; preds = %.lr.ph.i.i.i.i.i, %._crit_edge.loopexit.i, %bb.d, %bb.c
