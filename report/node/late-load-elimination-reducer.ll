...
vector.ph:                                        ; preds = %._crit_edge.i.i
  %n.vec = and i64 %i.dd, 9223372036854775800     ; 3 uses
  %i.de = shl i64 %n.vec, 2
  %i.df = getelementptr i8, ptr %.0.lcssa.i.i, i64 %i.de
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %.0.lcssa.i.i, i64 %i.dg ; 2 uses
  ...
  br i1 %i.di, label %middle.block, label %vector.body, !llvm.loop !232
...
.lr.ph18.i.i.preheader:                           ; preds = %._crit_edge.i.i, %middle.block
  %.116.i.i.ph = phi ptr [ %.0.lcssa.i.i, %._crit_edge.i.i ], [ %i.df, %middle.block ]
  br label %.lr.ph18.i.i

.lr.ph18.i.i:                                     ; preds = %.lr.ph18.i.i.preheader, %.lr.ph18.i.i
  %.116.i.i = phi ptr [ %i.dj, %.lr.ph18.i.i ], [ %.116.i.i.ph, %.lr.ph18.i.i.preheader ] ; 2 uses
  %i.dj = getelementptr inbounds nuw i8, ptr %.116.i.i, i64 4 ; 2 uses
  store i32 %.pre20.i.i, ptr %.116.i.i, align 4
  %i.dk = icmp ult ptr %i.dj, %i.cv
  br i1 %i.dk, label %.lr.ph18.i.i, label %_ZN2v88internal10ZoneVectorINS0_8compiler10turboshaft7OpIndexEE6insertEPKS4_mRS6_.exit.i, !llvm.loop !235
...
bb.s:                                             ; preds = %_ZN2v88internal10ZoneVectorINS0_8compiler10turboshaft7OpIndexEE6insertEPKS4_mRS6_.exit.i, %bb.g
  %i.dl = phi i32 [ %.pre.i, %_ZN2v88internal10ZoneVectorINS0_8compiler10turboshaft7OpIndexEE6insertEPKS4_mRS6_.exit.i ], [ %i.ao, %bb.g ]
  %i.dm = add i32 %i.dl, %i.x
  %i.dn = zext i32 %i.dm to i64
  %i.do = load ptr, ptr %i.i, align 8
  %i.dp = getelementptr inbounds nuw [4 x i8], ptr %i.do, i64 %i.dn
  %i.dq = load i32, ptr %i.ai, align 4
  store i32 %i.dq, ptr %i.dp, align 4
...
_ZN2v88internal8compiler10turboshaft13SnapshotTableINS2_7OpIndexENS2_7KeyDataEE16RecordMergeValueERNS2_18SnapshotTableEntryIS4_S5_EERKS4_jj.exit: ; preds = %.lr.ph, %bb.s
  %i.dr = icmp eq ptr %i.ag, %i.ab
  br i1 %i.dr, label %.loopexit63, label %.lr.ph
...
bb.t:                                             ; preds = %.lr.ph81, %_ZN2v88internal8compiler10turboshaft13SnapshotTableINS2_7OpIndexENS2_7KeyDataEE3SetENS2_16SnapshotTableKeyIS4_S5_EES4_.exit
  %.03579 = phi ptr [ %i.o, %.lr.ph81 ], [ %i.gb, %_ZN2v88internal8compiler10turboshaft13SnapshotTableINS2_7OpIndexENS2_7KeyDataEE3SetENS2_16SnapshotTableKeyIS4_S5_EES4_.exit ] ; 2 uses
  %i.ds = load ptr, ptr %.03579, align 8          ; 8 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %i.ds, i64 52
  %i.du = load i32, ptr %i.dt, align 4
  %i.dv = zext i32 %i.du to i64
  %i.dw = load ptr, ptr %i.i, align 8
  %i.dx = getelementptr inbounds nuw [4 x i8], ptr %i.dw, i64 %i.dv ; 8 uses
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dx, i64 4 ; 4 uses
  %i.dz = load i32, ptr %i.dy, align 4            ; 2 uses
  %.not.i = icmp eq i32 %i.dz, -1
  br i1 %.not.i, label %bb.w, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.ea = load i32, ptr %i.dx, align 4
  %.not10.i = icmp eq i32 %i.ea, %i.dz
  br i1 %.not10.i, label %bb.w, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.eb = load ptr, ptr %3, align 8, !nonnull !7
...
bb.x:                                             ; preds = %bb.w
  %i.ec = getelementptr inbounds nuw i8, ptr %i.dx, i64 %.idx
  br i1 %.not61, label %._crit_edge.i.i.i.i.i.i, label %.lr.ph.i.i.i.i.i.i

.lr.ph.i.i.i.i.i.i:                               ; preds = %bb.x
  %.sroa.0.0.copyload.i.i.i.i.i.i.i.i = load i32, ptr %i.dx, align 4 ; 4 uses
  %scevgep.i.i.i.i.i.i = getelementptr i8, ptr %i.dy, i64 %i.s
  br label %bb.y

bb.y:                                             ; preds = %bb.ac, %.lr.ph.i.i.i.i.i.i
  %.059.i.i.i.i.i.i = phi i64 [ %i.r, %.lr.ph.i.i.i.i.i.i ], [ %i.el, %bb.ac ] ; 2 uses
  %.02958.i.i.i.i.i.i = phi ptr [ %i.dy, %.lr.ph.i.i.i.i.i.i ], [ %i.ek, %bb.ac ] ; 9 uses
  %i.ed = load i32, ptr %.02958.i.i.i.i.i.i, align 4
  %.not44.i.i.i.i.i.i = icmp eq i32 %i.ed, %.sroa.0.0.copyload.i.i.i.i.i.i.i.i
...
bb.z:                                             ; preds = %bb.y
  %i.ee = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 4
  %i.ef = load i32, ptr %i.ee, align 4
  %.not45.i.i.i.i.i.i = icmp eq i32 %i.ef, %.sroa.0.0.copyload.i.i.i.i.i.i.i.i
...
bb.aa:                                            ; preds = %bb.z
  %i.eg = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 8
  %i.eh = load i32, ptr %i.eg, align 4
  %.not46.i.i.i.i.i.i = icmp eq i32 %i.eh, %.sroa.0.0.copyload.i.i.i.i.i.i.i.i
...
bb.ab:                                            ; preds = %bb.aa
  %i.ei = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 12
  %i.ej = load i32, ptr %i.ei, align 4
  %.not47.i.i.i.i.i.i = icmp eq i32 %i.ej, %.sroa.0.0.copyload.i.i.i.i.i.i.i.i
...
bb.ac:                                            ; preds = %bb.ab
  %i.ek = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 16
  %i.el = add nsw i64 %.059.i.i.i.i.i.i, -1
  %i.em = icmp sgt i64 %.059.i.i.i.i.i.i, 1
  br i1 %i.em, label %bb.y, label %._crit_edge.i.i.i.i.i.i, !llvm.loop !236

._crit_edge.i.i.i.i.i.i:                          ; preds = %bb.ac, %bb.x
  %.pre-phi68.i.i.i.i.i.i = phi i64 [ %gepdiff.i.i, %bb.x ], [ %gepdiff7.i.i, %bb.ac ]
  %.029.lcssa.i.i.i.i.i.i = phi ptr [ %i.dy, %bb.x ], [ %scevgep.i.i.i.i.i.i, %bb.ac ] ; 5 uses
  %i.en = lshr exact i64 %.pre-phi68.i.i.i.i.i.i, 2
  switch i64 %i.en, label %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.thread.i [
    i64 3, label %bb.ad
...
._crit_edge._crit_edge65.i.i.i.i.i.i:             ; preds = %._crit_edge.i.i.i.i.i.i
  %.sroa.0.0.copyload.i.i35.pre.i.i.i.i.i.i = load i32, ptr %i.dx, align 4
  br label %bb.ah

._crit_edge._crit_edge.i.i.i.i.i.i:               ; preds = %._crit_edge.i.i.i.i.i.i
  %.sroa.0.0.copyload.i.i34.pre.i.i.i.i.i.i = load i32, ptr %i.dx, align 4
  br label %bb.af

bb.ad:                                            ; preds = %._crit_edge.i.i.i.i.i.i
  %.sroa.0.0.copyload.i.i33.i.i.i.i.i.i = load i32, ptr %i.dx, align 4 ; 2 uses
  %i.eo = load i32, ptr %.029.lcssa.i.i.i.i.i.i, align 4
  %.not.i.i.i.i.i.i = icmp eq i32 %i.eo, %.sroa.0.0.copyload.i.i33.i.i.i.i.i.i
...
bb.ae:                                            ; preds = %bb.ad
  %i.ep = getelementptr inbounds nuw i8, ptr %.029.lcssa.i.i.i.i.i.i, i64 4
  br label %bb.af
...
bb.af:                                            ; preds = %bb.ae, %._crit_edge._crit_edge.i.i.i.i.i.i
  ...
  %.1.i.i.i.i.i.i = phi ptr [ %i.ep, %bb.ae ], [ %.029.lcssa.i.i.i.i.i.i, %._crit_edge._crit_edge.i.i.i.i.i.i ] ; 3 uses
  %i.eq = load i32, ptr %.1.i.i.i.i.i.i, align 4
  %.not42.i.i.i.i.i.i = icmp eq i32 %i.eq, %.sroa.0.0.copyload.i.i34.i.i.i.i.i.i
...
bb.ag:                                            ; preds = %bb.af
  %i.er = getelementptr inbounds nuw i8, ptr %.1.i.i.i.i.i.i, i64 4
  br label %bb.ah
...
bb.ah:                                            ; preds = %bb.ag, %._crit_edge._crit_edge65.i.i.i.i.i.i
  ...
  %.2.i.i.i.i.i.i = phi ptr [ %i.er, %bb.ag ], [ %.029.lcssa.i.i.i.i.i.i, %._crit_edge._crit_edge65.i.i.i.i.i.i ] ; 2 uses
  %i.es = load i32, ptr %.2.i.i.i.i.i.i, align 4
  %.not43.i.i.i.i.i.i = icmp eq i32 %i.es, %.sroa.0.0.copyload.i.i35.i.i.i.i.i.i
...
_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit: ; preds = %bb.ab
  %i.et = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 12
...
_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit108: ; preds = %bb.aa
  %i.eu = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 8
  br label %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i
...
_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit110: ; preds = %bb.z
  %i.ev = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 4
  br label %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i
...
_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i: ; preds = %bb.y, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit108, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit110, %bb.ah, %bb.af, %bb.ad
  %.028.i.i.i.i.i.i = phi ptr [ %.1.i.i.i.i.i.i, %bb.af ], [ %.029.lcssa.i.i.i.i.i.i, %bb.ad ], [ %.2.i.i.i.i.i.i, %bb.ah ], [ %i.ev, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit110 ], [ %i.et, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit ], [ %i.eu, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit108 ], [ %.02958.i.i.i.i.i.i, %bb.y ]
  %i.ew = icmp eq ptr %i.ec, %.028.i.i.i.i.i.i
  br i1 %i.ew, label %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.thread.i, label %_ZZN2v88internal8compiler10turboshaft27LateLoadEliminationAnalyzer10BeginBlockILb1EEEbPKNS2_5BlockEENKUlNS2_16SnapshotTableKeyINS2_7OpIndexENS2_7KeyDataEEENS_4base6VectorIKS9_EEE_clESB_SF_.exit
...
_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.thread.i: ; preds = %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i, %bb.ah, %._crit_edge.i.i.i.i.i.i, %bb.w
  %.sroa.02.0.copyload.i = load i32, ptr %i.dx, align 4
...
_ZZN2v88internal8compiler10turboshaft27LateLoadEliminationAnalyzer10BeginBlockILb1EEEbPKNS2_5BlockEENKUlNS2_16SnapshotTableKeyINS2_7OpIndexENS2_7KeyDataEEENS_4base6VectorIKS9_EEE_clESB_SF_.exit: ; preds = %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.thread.i
  ...
  %i.ex = getelementptr inbounds nuw i8, ptr %i.ds, i64 48 ; 2 uses
  %i.ey = load i32, ptr %i.ex, align 8            ; 3 uses
  %.not62 = icmp eq i32 %i.ey, %.sroa.02.0.i
...
bb.ai:                                            ; preds = %_ZZN2v88internal8compiler10turboshaft27LateLoadEliminationAnalyzer10BeginBlockILb1EEEbPKNS2_5BlockEENKUlNS2_16SnapshotTableKeyINS2_7OpIndexENS2_7KeyDataEEENS_4base6VectorIKS9_EEE_clESB_SF_.exit
  %i.ez = load ptr, ptr %i.t, align 8             ; 2 uses
  %i.fa = load ptr, ptr %i.u, align 8             ; 2 uses
  %i.fb = icmp ult ptr %i.ez, %i.fa
  br i1 %i.fb, label %bb.ak, label %bb.aj, !prof !6
end_hunk_0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.di = icmp eq i64 %index.next, %n.vec
  br i1 %i.di, label %middle.block, label %vector.body, !llvm.loop !256
...
.lr.ph18.i.i:                                     ; preds = %.lr.ph18.i.i.preheader, %.lr.ph18.i.i
  ...
  store i32 %.pre20.i.i, ptr %.116.i.i, align 4
  %i.dk = icmp ult ptr %i.dj, %i.cv
  br i1 %i.dk, label %.lr.ph18.i.i, label %_ZN2v88internal10ZoneVectorINS0_8compiler10turboshaft7OpIndexEE6insertEPKS4_mRS6_.exit.i, !llvm.loop !257
...
bb.t:                                             ; preds = %.lr.ph81, %_ZN2v88internal8compiler10turboshaft13SnapshotTableINS2_7OpIndexENS2_7KeyDataEE3SetENS2_16SnapshotTableKeyIS4_S5_EES4_.exit
  %.03579 = phi ptr [ %i.o, %.lr.ph81 ], [ %i.fy, %_ZN2v88internal8compiler10turboshaft13SnapshotTableINS2_7OpIndexENS2_7KeyDataEE3SetENS2_16SnapshotTableKeyIS4_S5_EES4_.exit ] ; 2 uses
  %i.ds = load ptr, ptr %.03579, align 8          ; 8 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %i.ds, i64 52
  %i.du = load i32, ptr %i.dt, align 4
  %i.dv = zext i32 %i.du to i64
  %i.dw = load ptr, ptr %i.i, align 8
  %i.dx = getelementptr inbounds nuw [4 x i8], ptr %i.dw, i64 %i.dv ; 7 uses
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.dz = getelementptr inbounds nuw i8, ptr %i.dx, i64 %.idx
  br i1 %.not61, label %._crit_edge.i.i.i.i.i.i, label %.lr.ph.i.i.i.i.i.i
...
bb.v:                                             ; preds = %bb.z, %.lr.ph.i.i.i.i.i.i
  %.059.i.i.i.i.i.i = phi i64 [ %i.r, %.lr.ph.i.i.i.i.i.i ], [ %i.ei, %bb.z ] ; 2 uses
  %.02958.i.i.i.i.i.i = phi ptr [ %i.dy, %.lr.ph.i.i.i.i.i.i ], [ %i.eh, %bb.z ] ; 9 uses
  %i.ea = load i32, ptr %.02958.i.i.i.i.i.i, align 4
  %.not44.i.i.i.i.i.i = icmp eq i32 %i.ea, %.sroa.0.0.copyload.i.i.i.i.i.i.i.i
...
bb.w:                                             ; preds = %bb.v
  %i.eb = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 4
  %i.ec = load i32, ptr %i.eb, align 4
  %.not45.i.i.i.i.i.i = icmp eq i32 %i.ec, %.sroa.0.0.copyload.i.i.i.i.i.i.i.i
...
bb.x:                                             ; preds = %bb.w
  %i.ed = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 8
  %i.ee = load i32, ptr %i.ed, align 4
  %.not46.i.i.i.i.i.i = icmp eq i32 %i.ee, %.sroa.0.0.copyload.i.i.i.i.i.i.i.i
...
bb.y:                                             ; preds = %bb.x
  %i.ef = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 12
  %i.eg = load i32, ptr %i.ef, align 4
  %.not47.i.i.i.i.i.i = icmp eq i32 %i.eg, %.sroa.0.0.copyload.i.i.i.i.i.i.i.i
...
bb.z:                                             ; preds = %bb.y
  %i.eh = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 16
  %i.ei = add nsw i64 %.059.i.i.i.i.i.i, -1
  %i.ej = icmp sgt i64 %.059.i.i.i.i.i.i, 1
  br i1 %i.ej, label %bb.v, label %._crit_edge.i.i.i.i.i.i, !llvm.loop !236

._crit_edge.i.i.i.i.i.i:                          ; preds = %bb.z, %bb.u
  %.pre-phi68.i.i.i.i.i.i = phi i64 [ %gepdiff.i.i, %bb.u ], [ %gepdiff7.i.i, %bb.z ]
  %.029.lcssa.i.i.i.i.i.i = phi ptr [ %i.dy, %bb.u ], [ %scevgep.i.i.i.i.i.i, %bb.z ] ; 5 uses
  %i.ek = lshr exact i64 %.pre-phi68.i.i.i.i.i.i, 2
  switch i64 %i.ek, label %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.thread.i [
    i64 3, label %bb.aa
    i64 2, label %._crit_edge._crit_edge.i.i.i.i.i.i
    i64 1, label %._crit_edge._crit_edge65.i.i.i.i.i.i
  ]
...
bb.aa:                                            ; preds = %._crit_edge.i.i.i.i.i.i
  %.sroa.0.0.copyload.i.i33.i.i.i.i.i.i = load i32, ptr %i.dx, align 4 ; 2 uses
  %i.el = load i32, ptr %.029.lcssa.i.i.i.i.i.i, align 4
  %.not.i.i.i.i.i.i = icmp eq i32 %i.el, %.sroa.0.0.copyload.i.i33.i.i.i.i.i.i
...
bb.ab:                                            ; preds = %bb.aa
  %i.em = getelementptr inbounds nuw i8, ptr %.029.lcssa.i.i.i.i.i.i, i64 4
  br label %bb.ac
...
bb.ac:                                            ; preds = %bb.ab, %._crit_edge._crit_edge.i.i.i.i.i.i
  ...
  %.1.i.i.i.i.i.i = phi ptr [ %i.em, %bb.ab ], [ %.029.lcssa.i.i.i.i.i.i, %._crit_edge._crit_edge.i.i.i.i.i.i ] ; 3 uses
  %i.en = load i32, ptr %.1.i.i.i.i.i.i, align 4
  %.not42.i.i.i.i.i.i = icmp eq i32 %i.en, %.sroa.0.0.copyload.i.i34.i.i.i.i.i.i
...
bb.ad:                                            ; preds = %bb.ac
  %i.eo = getelementptr inbounds nuw i8, ptr %.1.i.i.i.i.i.i, i64 4
  br label %bb.ae
...
bb.ae:                                            ; preds = %bb.ad, %._crit_edge._crit_edge65.i.i.i.i.i.i
  ...
  %.2.i.i.i.i.i.i = phi ptr [ %i.eo, %bb.ad ], [ %.029.lcssa.i.i.i.i.i.i, %._crit_edge._crit_edge65.i.i.i.i.i.i ] ; 2 uses
  %i.ep = load i32, ptr %.2.i.i.i.i.i.i, align 4
  %.not43.i.i.i.i.i.i = icmp eq i32 %i.ep, %.sroa.0.0.copyload.i.i35.i.i.i.i.i.i
  br i1 %.not43.i.i.i.i.i.i, label %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.thread.i, label %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i
...
_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit: ; preds = %bb.y
  %i.eq = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 12
  br label %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i
...
_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit107: ; preds = %bb.x
  %i.er = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 8
  br label %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i
...
_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit109: ; preds = %bb.w
  %i.es = getelementptr inbounds nuw i8, ptr %.02958.i.i.i.i.i.i, i64 4
  br label %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i
...
_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i: ; preds = %bb.v, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit107, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit109, %bb.ae, %bb.ac, %bb.aa
  %.028.i.i.i.i.i.i = phi ptr [ %.1.i.i.i.i.i.i, %bb.ac ], [ %.029.lcssa.i.i.i.i.i.i, %bb.aa ], [ %.2.i.i.i.i.i.i, %bb.ae ], [ %i.es, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit109 ], [ %i.eq, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit ], [ %i.er, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i.loopexit.split.loop.exit107 ], [ %.02958.i.i.i.i.i.i, %bb.v ]
  %i.et = icmp eq ptr %i.dz, %.028.i.i.i.i.i.i
  br i1 %i.et, label %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.thread.i, label %_ZZN2v88internal8compiler10turboshaft27LateLoadEliminationAnalyzer10BeginBlockILb0EEEbPKNS2_5BlockEENKUlNS2_16SnapshotTableKeyINS2_7OpIndexENS2_7KeyDataEEENS_4base6VectorIKS9_EEE_clESB_SF_.exit
...
_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.thread.i: ; preds = %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i, %bb.ae, %._crit_edge.i.i.i.i.i.i, %bb.t
  %.sroa.01.0.copyload.i = load i32, ptr %i.dx, align 4
...
_ZZN2v88internal8compiler10turboshaft27LateLoadEliminationAnalyzer10BeginBlockILb0EEEbPKNS2_5BlockEENKUlNS2_16SnapshotTableKeyINS2_7OpIndexENS2_7KeyDataEEENS_4base6VectorIKS9_EEE_clESB_SF_.exit: ; preds = %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.i, %_ZN2v84base9all_equalINS0_6VectorIKNS_8internal8compiler10turboshaft7OpIndexEEEEEbRKT_.exit.thread.i
  ...
  %i.eu = getelementptr inbounds nuw i8, ptr %i.ds, i64 48 ; 2 uses
  %i.ev = load i32, ptr %i.eu, align 8            ; 3 uses
  %.not62 = icmp eq i32 %i.ev, %.sroa.01.0.i
...
bb.af:                                            ; preds = %_ZZN2v88internal8compiler10turboshaft27LateLoadEliminationAnalyzer10BeginBlockILb0EEEbPKNS2_5BlockEENKUlNS2_16SnapshotTableKeyINS2_7OpIndexENS2_7KeyDataEEENS_4base6VectorIKS9_EEE_clESB_SF_.exit
  %i.ew = load ptr, ptr %i.t, align 8             ; 2 uses
  %i.ex = load ptr, ptr %i.u, align 8             ; 2 uses
  %i.ey = icmp ult ptr %i.ew, %i.ex
  br i1 %i.ey, label %bb.ah, label %bb.ag, !prof !6

bb.ag:                                            ; preds = %bb.af
  %i.ez = load ptr, ptr %i.f, align 8
  %i.fa = ptrtoint ptr %i.ex to i64
  %i.fb = ptrtoint ptr %i.ez to i64
  %i.fc = sub i64 %i.fa, %i.fb
  %i.fd = ashr exact i64 %i.fc, 4
  %i.fe = add nsw i64 %i.fd, 1
  tail call preserve_mostcc void @_ZN2v88internal10ZoneVectorINS0_8compiler10turboshaft13SnapshotTableINS3_7OpIndexENS3_7KeyDataEE8LogEntryEE4GrowEm(ptr noundef nonnull align 8 dereferenceable(32) %i.v, i64 noundef %i.fe)
  %.pre.i.i.i39 = load ptr, ptr %i.t, align 8
  br label %bb.ah

bb.ah:                                            ; preds = %bb.af, %bb.ag
  %i.ff = phi ptr [ %i.ew, %bb.af ], [ %.pre.i.i.i39, %bb.ag ] ; 4 uses
