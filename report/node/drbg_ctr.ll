...
vector.ph:                                        ; preds = %bb.e, %bb.d
  ...
  %wide.load72 = load <16 x i8>, ptr %i.l, align 8, !tbaa !28
  %i.m = xor <16 x i8> %wide.load72, %.sroa.0.0.copyload
  store <16 x i8> %i.m, ptr %i.l, align 8, !tbaa !28
  %i.n = getelementptr inbounds nuw i8, ptr %0, i64 144 ; 2 uses
  %wide.load72.1 = load <16 x i8>, ptr %i.n, align 8, !tbaa !28
  %i.o = xor <16 x i8> %wide.load72.1, %.sroa.0.0.copyload
...
vector.body.2:                                    ; preds = %vector.ph
  ...
  %wide.load72.2 = load <16 x i8>, ptr %i.p, align 8, !tbaa !28
  %i.q = xor <16 x i8> %wide.load72.2, %.sroa.6.0
...
.thread:                                          ; preds = %bb.c, %bb.f, %bb.b
  %.234 = phi ptr [ %1, %bb.b ], [ %1, %bb.c ], [ %i.w, %bb.f ] ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph, %bb.i
  %.sroa.687.0 = phi <16 x i8> [ undef, %.lr.ph ], [ %.sroa.686.0, %bb.i ]
  %.363 = phi i64 [ %.2, %.lr.ph ], [ %i.al, %bb.i ]
  %.33562 = phi ptr [ %.234, %.lr.ph ], [ %i.ak, %bb.i ] ; 3 uses
  %.sroa.084.0.copyload = load <16 x i8>, ptr %.33562, align 1 ; 2 uses
  %i.ad = load i64, ptr %i.y, align 8, !tbaa !36
  %.not.i46 = icmp eq i64 %i.ad, 16               ; 2 uses
  br i1 %.not.i46, label %vector.ph74, label %bb.h

bb.h:                                             ; preds = %bb.g
  %.sroa.686.32.copyload = load <16 x i8>, ptr %.33562, align 1
  br label %vector.ph74

vector.ph74:                                      ; preds = %bb.h, %bb.g
  %.sroa.686.0 = phi <16 x i8> [ %.sroa.687.0, %bb.g ], [ %.sroa.686.32.copyload, %bb.h ] ; 2 uses
  %.0.i47 = phi i32 [ 32, %bb.g ], [ 48, %bb.h ]  ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #6
  store i32 16, ptr %i.a, align 4, !tbaa !26
  %wide.load79 = load <16 x i8>, ptr %i.z, align 8, !tbaa !28
  %i.ae = xor <16 x i8> %wide.load79, %.sroa.084.0.copyload
  store <16 x i8> %i.ae, ptr %i.z, align 8, !tbaa !28
  %wide.load79.1 = load <16 x i8>, ptr %i.ab, align 8, !tbaa !28
  %i.af = xor <16 x i8> %wide.load79.1, %.sroa.084.0.copyload
  store <16 x i8> %i.af, ptr %i.ab, align 8, !tbaa !28
  br i1 %.not.i46, label %ctr_BCC_blocks.exit56, label %vector.body76.2

vector.body76.2:                                  ; preds = %vector.ph74
  %wide.load79.2 = load <16 x i8>, ptr %i.ac, align 8, !tbaa !28
  %i.ag = xor <16 x i8> %wide.load79.2, %.sroa.686.0
  store <16 x i8> %i.ag, ptr %i.ac, align 8, !tbaa !28
  br label %ctr_BCC_blocks.exit56

ctr_BCC_blocks.exit56:                            ; preds = %vector.body76.2, %vector.ph74
...
bb.i:                                             ; preds = %ctr_BCC_blocks.exit56
  %i.ak = getelementptr inbounds nuw i8, ptr %.33562, i64 16 ; 2 uses
...
._crit_edge:                                      ; preds = %bb.i, %.thread
  %.335.lcssa = phi ptr [ %.234, %.thread ], [ %i.ak, %bb.i ]
...
bb.j:                                             ; preds = %._crit_edge
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.ap, ptr align 1 %.335.lcssa, i64 %.3.lcssa, i1 false)
...
.loopexit:                                        ; preds = %ctr_BCC_blocks.exit56, %ctr_BCC_blocks.exit, %._crit_edge, %bb.j, %bb.a
  %.137 = phi i32 [ 1, %._crit_edge ], [ 1, %bb.a ], [ 0, %ctr_BCC_blocks.exit ], [ 1, %bb.j ], [ 0, %ctr_BCC_blocks.exit56 ]
  ret i32 %.137
}
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not69.a, label %bb.d, label %bb.c
...
bb.d:                                             ; preds = %bb.c, %bb.b, %bb.a
  %.not77 = phi i1 [ false, %bb.c ], [ true, %bb.b ], [ true, %bb.a ]
  %i.m = call ptr @OSSL_PARAM_locate_const(ptr noundef %1, ptr noundef nonnull @.str.2) #6 ; 3 uses
  %.not70.a = icmp eq ptr %i.m, null
  br i1 %.not70.a, label %bb.g, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 8
  %i.o = load i32, ptr %i.n, align 8, !tbaa !91
  %.not71.a = icmp eq i32 %i.o, 4
  br i1 %.not71.a, label %bb.f, label %.critedge
...
bb.g:                                             ; preds = %bb.f, %bb.d
  %.058 = phi ptr [ %i.q, %bb.f ], [ null, %bb.d ] ; 2 uses
  %i.r = call ptr @OSSL_PARAM_locate_const(ptr noundef %1, ptr noundef nonnull @.str.3) #6 ; 3 uses
  %.not72.a = icmp eq ptr %i.r, null
  br i1 %.not72.a, label %bb.j, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.s = getelementptr inbounds nuw i8, ptr %i.r, i64 8
  %i.t = load i32, ptr %i.s, align 8, !tbaa !91
  %.not73.a = icmp eq i32 %i.t, 4
  br i1 %.not73.a, label %bb.i, label %.critedge
...
bb.j:                                             ; preds = %bb.i, %bb.g
  %.059 = phi ptr [ %i.w, %bb.i ], [ null, %bb.g ] ; 8 uses
  %i.y = call ptr @OSSL_PARAM_locate_const(ptr noundef %1, ptr noundef nonnull @.str.4) #6 ; 4 uses
  %.not74.a = icmp eq ptr %i.y, null
  br i1 %.not74.a, label %bb.aa, label %bb.k
...
bb.k:                                             ; preds = %bb.j
  ...
  %.not75.a = icmp eq i32 %i.ac, 4
  br i1 %.not75.a, label %bb.l, label %bb.m
...
bb.m:                                             ; preds = %bb.l, %bb.k
  call void @ossl_provider_free(ptr noundef %.059) #6
  br label %.critedge
...
bb.r:                                             ; preds = %bb.p
  ...
  %i.au = call ptr @evp_cipher_fetch_from_prov(ptr noundef %.059, ptr noundef nonnull %i.aa, ptr noundef null) #6 ; 2 uses
