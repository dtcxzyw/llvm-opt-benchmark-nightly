...
bb.f:                                             ; preds = %.lr.ph, %_ZNSt6vectorIhSaIhEED2Ev.exit16
  %i.ak = phi ptr [ %i.ad, %.lr.ph ], [ %5, %_ZNSt6vectorIhSaIhEED2Ev.exit16 ]
...
begin_hunk_1_@_ZN4LIEF5MachO7Builder9build_fatEv:bb.a
  call void @_ZdlPvm(ptr noundef nonnull %i.bm, i64 noundef %i.by) #19
  br label %_ZNSt6vectorIhSaIhEED2Ev.exit16

_ZNSt6vectorIhSaIhEED2Ev.exit16:                  ; preds = %bb.h, %_ZN4LIEF15vector_iostream5writeESt6vectorIhSaIhEE.exit12
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #22
  %3 = add nuw i64 %.025, 1                       ; 2 uses
  %4 = load ptr, ptr %i.d, align 8
  %5 = load ptr, ptr %0, align 8                  ; 2 uses
  %i.bz = ptrtoint ptr %4 to i64
