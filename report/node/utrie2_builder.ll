...
bb.i:                                             ; preds = %bb.h
  ...
  %6 = ptrtoint ptr %i.v to i64                   ; 4 uses
...
bb.m:                                             ; preds = %bb.i
  ...
  %i.ee = zext nneg i32 %i.p to i64               ; 3 uses
...
.lr.ph.i131.preheader:                            ; preds = %.preheader15.i130
  %i.eh = shl nuw nsw i64 %i.w, 2                 ; 2 uses
  %7 = add i64 %i.eh, %6                          ; 2 uses
  %8 = shl nuw nsw i64 %i.ee, 2                   ; 2 uses
  %i.ei = add i64 %7, %8
  %i.ej = add i64 %i.ei, 4
  ...
  %9 = xor i64 %6, -1
  %i.em = add i64 %umax, %9
  %10 = add nuw nsw i64 %i.eh, %8
  %11 = sub i64 %i.em, %10                        ; 2 uses
  %i.en = lshr i64 %11, 2
  %i.eo = add nuw nsw i64 %i.en, 1                ; 2 uses
  %min.iters.check233 = icmp ult i64 %11, 28
...
.lr.ph19.i134.preheader:                          ; preds = %.preheader.i133
  %i.eu = shl nuw nsw i64 %i.w, 2                 ; 2 uses
  %12 = add i64 %i.eu, %6                         ; 2 uses
  %13 = shl nuw nsw i64 %i.ee, 2                  ; 2 uses
  %i.ev = add i64 %12, %13
  %i.ew = add i64 %i.ev, 4
  %i.ex = shl nuw nsw i64 %i.ec, 2
  %i.ey = add i64 %12, %i.ex
  %umax245 = tail call i64 @llvm.umax.i64(i64 %i.ew, i64 %i.ey)
  %14 = xor i64 %6, -1
  %i.ez = add i64 %umax245, %14
  %15 = add nuw nsw i64 %i.eu, %13
  %16 = sub i64 %i.ez, %15                        ; 2 uses
  %i.fa = lshr i64 %16, 2
  %i.fb = add nuw nsw i64 %i.fa, 1                ; 2 uses
  %min.iters.check247 = icmp ult i64 %16, 28
...
bb.bn:                                            ; preds = %bb.bm
  ...
  %17 = ptrtoint ptr %i.mh to i64                 ; 2 uses
  ...
  %i.mn = shl nuw nsw i64 %i.mi, 2                ; 2 uses
  %18 = add i64 %i.mn, %17                        ; 2 uses
  %19 = shl nuw nsw i64 %i.ml, 2
  %i.mo = add i64 %18, %19
  %i.mp = add i64 %18, 4
  %umax300 = tail call i64 @llvm.umax.i64(i64 %i.mo, i64 %i.mp)
  %20 = xor i64 %17, -1
  %i.mq = add i64 %umax300, %20
  %21 = sub i64 %i.mq, %i.mn                      ; 2 uses
  %i.mr = lshr i64 %21, 2
  %i.ms = add nuw nsw i64 %i.mr, 1                ; 4 uses
  %min.iters.check302 = icmp ult i64 %21, 28      ; 2 uses
