...
pred.store.continue463:                           ; preds = %pred.store.if462, %vector.body458
...
pred.store.continue502:                           ; preds = %pred.store.if501, %vec.epilog.vector.body
...
pred.store.continue5:                             ; preds = %pred.store.if4, %pred.store.continue
...
pred.store.continue7:                             ; preds = %pred.store.if6, %pred.store.continue5
...
pred.store.continue39:                            ; preds = %pred.store.if38, %vec.epilog.vector.body
