...
bb.f:                                             ; preds = %.lr.ph
  %exitcond.not = icmp eq i32 %.012.in.i.i25, %i.f
  br i1 %exitcond.not, label %X509at_get_attr_by_NID.exit.thread, label %.lr.ph, !llvm.loop !10

.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.f
  %.012.in.i.i25 = phi i32 [ %.012.i.i, %bb.f ], [ -1, %.lr.ph.preheader ] ; 2 uses
  %.012.i.i = add nsw i32 %.012.in.i.i25, 1       ; 3 uses
  %i.g = tail call ptr @OPENSSL_sk_value(ptr noundef nonnull %i.b, i32 noundef %.012.i.i) #4
...
bb.b:                                             ; preds = %bb.a
  ...
  %.012.i38 = add nsw i32 %i.b, 1                 ; 2 uses
  %i.d = icmp slt i32 %.012.i38, %i.c
  br i1 %i.d, label %.lr.ph, label %X509at_get_attr_by_OBJ.exit.thread

bb.c:                                             ; preds = %.lr.ph
  %.012.i = add nsw i32 %.012.i39, 1              ; 2 uses
  %i.e = icmp slt i32 %.012.i, %i.c
  br i1 %i.e, label %.lr.ph, label %X509at_get_attr_by_OBJ.exit.thread, !llvm.loop !10

.lr.ph:                                           ; preds = %bb.b, %bb.c
  %.012.i39 = phi i32 [ %.012.i, %bb.c ], [ %.012.i38, %bb.b ] ; 5 uses
  %i.f = tail call ptr @OPENSSL_sk_value(ptr noundef nonnull %0, i32 noundef %.012.i39) #4
...
.thread:                                          ; preds = %X509at_get_attr_by_OBJ.exit
  %i.k = tail call ptr @X509at_get_attr(ptr noundef nonnull %0, i32 noundef %.012.i39)
  br label %bb.g

bb.d:                                             ; preds = %X509at_get_attr_by_OBJ.exit
  %4 = tail call i32 @llvm.smax.i32(i32 %.012.i39, i32 -1)
  %i.l = tail call i32 @OPENSSL_sk_num(ptr noundef nonnull %0) #4 ; 2 uses
  %.012.i1740 = add nuw nsw i32 %4, 1             ; 2 uses
  %i.m = icmp slt i32 %.012.i1740, %i.l
  br i1 %i.m, label %.lr.ph42, label %X509at_get_attr_by_OBJ.exit19.thread

bb.e:                                             ; preds = %.lr.ph42
  %.012.i17 = add nuw nsw i32 %.012.i1741, 1      ; 2 uses
  %i.n = icmp slt i32 %.012.i17, %i.l
  br i1 %i.n, label %.lr.ph42, label %X509at_get_attr_by_OBJ.exit19.thread, !llvm.loop !10

.lr.ph42:                                         ; preds = %bb.d, %bb.e
  %.012.i1741 = phi i32 [ %.012.i17, %bb.e ], [ %.012.i1740, %bb.d ] ; 2 uses
  %i.o = tail call ptr @OPENSSL_sk_value(ptr noundef nonnull %0, i32 noundef %.012.i1741) #4
...
X509at_get_attr_by_OBJ.exit19.thread:             ; preds = %bb.e, %bb.d
  %i.s = tail call ptr @X509at_get_attr(ptr noundef nonnull %0, i32 noundef %.012.i39) ; 4 uses
...
bb.b:                                             ; preds = %.lr.ph
  %i.d = add nuw nsw i32 %.067, 1                 ; 2 uses
  %exitcond.not = icmp eq i32 %i.d, %i.b
  br i1 %exitcond.not, label %._crit_edge.loopexit, label %.lr.ph, !llvm.loop !23

.lr.ph:                                           ; preds = %bb.a, %bb.b
  %.067 = phi i32 [ %i.d, %bb.b ], [ 0, %bb.a ]   ; 2 uses
  %i.e = call ptr @OPENSSL_sk_value(ptr noundef %0, i32 noundef %.067) #4
...
._crit_edge:                                      ; preds = %bb.a, %._crit_edge.loopexit, %bb.c
  %.0 = phi ptr [ null, %bb.c ], [ %.pre, %._crit_edge.loopexit ], [ null, %bb.a ]
