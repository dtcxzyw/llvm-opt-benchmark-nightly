...
vector.ph:                                        ; preds = %.lr.ph.i.i.i.preheader
  ...
  %i.ai = getelementptr i8, ptr %i.q, i64 %i.ah   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %i.q, i64 %i.ak ; 2 uses
  %next.gep38 = getelementptr i8, ptr %i.c, i64 %i.ak ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !118)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !121)
  %i.al = getelementptr i8, ptr %next.gep38, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep38, align 8, !alias.scope !121, !noalias !118
  %wide.load39 = load <2 x i64>, ptr %i.al, align 8, !alias.scope !121, !noalias !118
  %i.am = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !alias.scope !118, !noalias !121
  store <2 x i64> %wide.load39, ptr %i.am, align 8, !alias.scope !118, !noalias !121
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.an = icmp eq i64 %index.next, %n.vec
  br i1 %i.an, label %middle.block, label %vector.body, !llvm.loop !123
...
.lr.ph.i.i.i.preheader61:                         ; preds = %.lr.ph.i.i.i.preheader, %middle.block
  %.012.i.i.i.ph = phi ptr [ %i.q, %.lr.ph.i.i.i.preheader ], [ %i.ai, %middle.block ]
  %.0911.i.i.i.ph = phi ptr [ %i.c, %.lr.ph.i.i.i.preheader ], [ %i.aj, %middle.block ]
  br label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader61, %.lr.ph.i.i.i
  %.012.i.i.i = phi ptr [ %i.aq, %.lr.ph.i.i.i ], [ %.012.i.i.i.ph, %.lr.ph.i.i.i.preheader61 ] ; 2 uses
  %.0911.i.i.i = phi ptr [ %i.ap, %.lr.ph.i.i.i ], [ %.0911.i.i.i.ph, %.lr.ph.i.i.i.preheader61 ] ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !118)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !121)
  %i.ao = load i64, ptr %.0911.i.i.i, align 8, !alias.scope !121, !noalias !118
  store i64 %i.ao, ptr %.012.i.i.i, align 8, !alias.scope !118, !noalias !121
  %i.ap = getelementptr inbounds nuw i8, ptr %.0911.i.i.i, i64 8 ; 2 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %.012.i.i.i, i64 8 ; 2 uses
...
_ZNSt6vectorIN2v88internal6HandleINS1_10JSFunctionEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit: ; preds = %.lr.ph.i.i.i, %middle.block, %_ZSt12construct_atIN2v88internal6HandleINS1_10JSFunctionEEEJRNS1_6TaggedIS3_EERPNS1_7IsolateEEEDTgsnwcvPvLi0E_T_pispclsr3stdE7declvalIT0_EEEEPSC_DpOSD_.exit
  %.0.lcssa.i.i.i = phi ptr [ %i.q, %_ZSt12construct_atIN2v88internal6HandleINS1_10JSFunctionEEEJRNS1_6TaggedIS3_EERPNS1_7IsolateEEEDTgsnwcvPvLi0E_T_pispclsr3stdE7declvalIT0_EEEEPSC_DpOSD_.exit ], [ %i.ai, %middle.block ], [ %i.aq, %.lr.ph.i.i.i ] ; 2 uses
  %.0.lcssa.i.i.i42 = ptrtoaddr ptr %.0.lcssa.i.i.i to i64
  %i.ar = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i, i64 8 ; 5 uses
...
vector.ph46:                                      ; preds = %vector.memcheck41
  %n.vec48 = and i64 %i.au, 4611686018427387900   ; 3 uses
  %i.ax = shl i64 %n.vec48, 3                     ; 2 uses
  %i.ay = getelementptr i8, ptr %i.ar, i64 %i.ax  ; 2 uses
...
vector.body49:                                    ; preds = %vector.body49, %vector.ph46
  ...
  %i.ba = shl i64 %index50, 3                     ; 2 uses
  %next.gep51 = getelementptr i8, ptr %i.ar, i64 %i.ba ; 2 uses
  %next.gep52 = getelementptr i8, ptr %1, i64 %i.ba ; 2 uses
  ...
  %wide.load54 = load <2 x i64>, ptr %i.bb, align 8, !alias.scope !130, !noalias !127
  %i.bc = getelementptr i8, ptr %next.gep51, i64 16
  store <2 x i64> %wide.load53, ptr %next.gep51, align 8, !alias.scope !127, !noalias !130
  store <2 x i64> %wide.load54, ptr %i.bc, align 8, !alias.scope !127, !noalias !130
  %index.next55 = add nuw i64 %index50, 4         ; 2 uses
  %i.bd = icmp eq i64 %index.next55, %n.vec48
  br i1 %i.bd, label %middle.block56, label %vector.body49, !llvm.loop !132

middle.block56:                                   ; preds = %vector.body49
  %cmp.n57 = icmp eq i64 %i.au, %n.vec48
...
.lr.ph.i.i.i18.preheader60:                       ; preds = %vector.memcheck41, %.lr.ph.i.i.i18.preheader, %middle.block56
  %.012.i.i.i19.ph = phi ptr [ %i.ar, %vector.memcheck41 ], [ %i.ar, %.lr.ph.i.i.i18.preheader ], [ %i.ay, %middle.block56 ]
  %.0911.i.i.i20.ph = phi ptr [ %1, %vector.memcheck41 ], [ %1, %.lr.ph.i.i.i18.preheader ], [ %i.az, %middle.block56 ]
  br label %.lr.ph.i.i.i18

.lr.ph.i.i.i18:                                   ; preds = %.lr.ph.i.i.i18.preheader60, %.lr.ph.i.i.i18
  %.012.i.i.i19 = phi ptr [ %i.bg, %.lr.ph.i.i.i18 ], [ %.012.i.i.i19.ph, %.lr.ph.i.i.i18.preheader60 ] ; 2 uses
  %.0911.i.i.i20 = phi ptr [ %i.bf, %.lr.ph.i.i.i18 ], [ %.0911.i.i.i20.ph, %.lr.ph.i.i.i18.preheader60 ] ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !127)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !130)
  %i.be = load i64, ptr %.0911.i.i.i20, align 8, !alias.scope !130, !noalias !127
  store i64 %i.be, ptr %.012.i.i.i19, align 8, !alias.scope !127, !noalias !130
  %i.bf = getelementptr inbounds nuw i8, ptr %.0911.i.i.i20, i64 8 ; 2 uses
  %i.bg = getelementptr inbounds nuw i8, ptr %.012.i.i.i19, i64 8 ; 2 uses
  %.not.i.i.i21 = icmp eq ptr %i.bf, %i.b
...
_ZNSt6vectorIN2v88internal6HandleINS1_10JSFunctionEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit23: ; preds = %.lr.ph.i.i.i18, %middle.block56, %_ZNSt6vectorIN2v88internal6HandleINS1_10JSFunctionEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit
  %.0.lcssa.i.i.i22 = phi ptr [ %i.ar, %_ZNSt6vectorIN2v88internal6HandleINS1_10JSFunctionEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit ], [ %i.ay, %middle.block56 ], [ %i.bg, %.lr.ph.i.i.i18 ]
...
bb.e:                                             ; preds = %_ZNSt6vectorIN2v88internal6HandleINS1_10JSFunctionEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit23
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.c, i64 noundef %i.bk) #20
...
_ZNSt12_Vector_baseIN2v88internal6HandleINS1_10JSFunctionEEESaIS4_EE13_M_deallocateEPS4_m.exit: ; preds = %_ZNSt6vectorIN2v88internal6HandleINS1_10JSFunctionEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit23, %bb.e
  ...
  %i.bl = getelementptr inbounds nuw [8 x i8], ptr %i.q, i64 %i.l
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load39 = load <2 x i64>, ptr %i.al, align 8, !alias.scope !137, !noalias !134
  %i.am = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !alias.scope !134, !noalias !137
  store <2 x i64> %wide.load39, ptr %i.am, align 8, !alias.scope !134, !noalias !137
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.an = icmp eq i64 %index.next, %n.vec
  br i1 %i.an, label %middle.block, label %vector.body, !llvm.loop !139
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader61, %.lr.ph.i.i.i
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !134)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !137)
  %i.ao = load i64, ptr %.0911.i.i.i, align 8, !alias.scope !137, !noalias !134
  store i64 %i.ao, ptr %.012.i.i.i, align 8, !alias.scope !134, !noalias !137
  %i.ap = getelementptr inbounds nuw i8, ptr %.0911.i.i.i, i64 8 ; 2 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %.012.i.i.i, i64 8 ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.ap, %1
...
_ZNSt6vectorIN2v88internal6HandleINS1_17JSGeneratorObjectEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit: ; preds = %.lr.ph.i.i.i, %middle.block, %_ZSt12construct_atIN2v88internal6HandleINS1_17JSGeneratorObjectEEEJRNS1_6TaggedIS3_EERPNS1_7IsolateEEEDTgsnwcvPvLi0E_T_pispclsr3stdE7declvalIT0_EEEEPSC_DpOSD_.exit
  %.0.lcssa.i.i.i = phi ptr [ %i.q, %_ZSt12construct_atIN2v88internal6HandleINS1_17JSGeneratorObjectEEEJRNS1_6TaggedIS3_EERPNS1_7IsolateEEEDTgsnwcvPvLi0E_T_pispclsr3stdE7declvalIT0_EEEEPSC_DpOSD_.exit ], [ %i.ai, %middle.block ], [ %i.aq, %.lr.ph.i.i.i ] ; 2 uses
  %.0.lcssa.i.i.i42 = ptrtoaddr ptr %.0.lcssa.i.i.i to i64
  %i.ar = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i, i64 8 ; 5 uses
  %.not10.i.i.i17 = icmp eq ptr %1, %i.b
...
vector.body49:                                    ; preds = %vector.body49, %vector.ph46
  ...
  %wide.load54 = load <2 x i64>, ptr %i.bb, align 8, !alias.scope !144, !noalias !141
  %i.bc = getelementptr i8, ptr %next.gep51, i64 16
  store <2 x i64> %wide.load53, ptr %next.gep51, align 8, !alias.scope !141, !noalias !144
  store <2 x i64> %wide.load54, ptr %i.bc, align 8, !alias.scope !141, !noalias !144
  %index.next55 = add nuw i64 %index50, 4         ; 2 uses
  %i.bd = icmp eq i64 %index.next55, %n.vec48
  br i1 %i.bd, label %middle.block56, label %vector.body49, !llvm.loop !146
...
.lr.ph.i.i.i18:                                   ; preds = %.lr.ph.i.i.i18.preheader60, %.lr.ph.i.i.i18
  ...
  tail call void @llvm.experimental.noalias.scope.decl(metadata !141)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !144)
  %i.be = load i64, ptr %.0911.i.i.i20, align 8, !alias.scope !144, !noalias !141
  store i64 %i.be, ptr %.012.i.i.i19, align 8, !alias.scope !141, !noalias !144
  %i.bf = getelementptr inbounds nuw i8, ptr %.0911.i.i.i20, i64 8 ; 2 uses
  %i.bg = getelementptr inbounds nuw i8, ptr %.012.i.i.i19, i64 8 ; 2 uses
  %.not.i.i.i21 = icmp eq ptr %i.bf, %i.b
...
_ZNSt6vectorIN2v88internal6HandleINS1_17JSGeneratorObjectEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit23: ; preds = %.lr.ph.i.i.i18, %middle.block56, %_ZNSt6vectorIN2v88internal6HandleINS1_17JSGeneratorObjectEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit
  %.0.lcssa.i.i.i22 = phi ptr [ %i.ar, %_ZNSt6vectorIN2v88internal6HandleINS1_17JSGeneratorObjectEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit ], [ %i.ay, %middle.block56 ], [ %i.bg, %.lr.ph.i.i.i18 ]
  %i.bh = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %.not.i24 = icmp eq ptr %i.c, null
