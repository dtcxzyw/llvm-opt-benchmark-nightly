...
54:                                               ; preds = %.lr.ph, %.loopexit95
  ...
  %indvars.iv129 = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next130, %.loopexit95 ] ; 2 uses
  %.083112 = phi i32 [ 0, %.lr.ph ], [ %.2, %.loopexit95 ] ; 4 uses
  %56 = getelementptr inbounds nuw [8 x i8], ptr %23, i64 %indvars.iv129
...
begin_hunk_1
  ...
  %74 = load i32, ptr %.in, align 8, !tbaa !3     ; 2 uses
...
..loopexit_crit_edge.us.loopexit:                 ; preds = %111
  %.pre132 = load i32, ptr %83, align 4, !tbaa !90
  br label %..loopexit_crit_edge.us

..loopexit_crit_edge.us:                          ; preds = %..loopexit_crit_edge.us.loopexit, %98
  %103 = phi i32 [ %.pre132, %..loopexit_crit_edge.us.loopexit ], [ %94, %98 ] ; 2 uses
...
.loopexit95.loopexit:                             ; preds = %..loopexit_crit_edge.us
  %.pre133 = load i32, ptr %22, align 8, !tbaa !69
  br label %.loopexit95

.loopexit95:                                      ; preds = %.lr.ph104.split, %.loopexit95.loopexit, %64, %60
  %118 = phi i32 [ %55, %60 ], [ %55, %64 ], [ %55, %.lr.ph104.split ], [ %.pre133, %.loopexit95.loopexit ] ; 2 uses
...
._crit_edge.loopexit:                             ; preds = %.loopexit96
  %.pre134 = load i32, ptr %13, align 8, !tbaa !70
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %25
  %122 = phi i32 [ %.pre134, %._crit_edge.loopexit ], [ %26, %25 ] ; 2 uses
...
._crit_edge120.loopexit:                          ; preds = %._crit_edge
  %.pre135 = load i32, ptr %8, align 8, !tbaa !71
  br label %._crit_edge120

._crit_edge120:                                   ; preds = %._crit_edge120.loopexit, %2
  %125 = phi i32 [ %.pre135, %._crit_edge120.loopexit ], [ %9, %2 ] ; 2 uses
