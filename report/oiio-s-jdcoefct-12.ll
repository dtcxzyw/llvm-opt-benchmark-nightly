...
54:                                               ; preds = %.lr.ph, %.loopexit95
  ...
  %indvars.iv129 = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next130, %.loopexit95 ] ; [#uses=2 type=i64]
  %.083112 = phi i32 [ 0, %.lr.ph ], [ %.2, %.loopexit95 ] ; [#uses=4 type=i32]
  %56 = getelementptr inbounds nuw [8 x i8], ptr %23, i64 %indvars.iv129 ; [#uses=1 type=ptr]
...
begin_hunk_1
  ...
  %74 = load i32, ptr %.in, align 8, !tbaa !3     ; [#uses=2 type=i32]
...
.lr.ph104:                                        ; preds = %64
  ...
  %87 = icmp sgt i32 %74, 0                       ; [#uses=1 type=i1]
...
begin_hunk_3
  ...
  %wide.trip.count = zext nneg i32 %74 to i64     ; [#uses=1 type=i64]
...
..loopexit_crit_edge.us.loopexit:                 ; preds = %111
  %.pre132 = load i32, ptr %83, align 4, !tbaa !90 ; [#uses=1 type=i32]
  br label %..loopexit_crit_edge.us

..loopexit_crit_edge.us:                          ; preds = %..loopexit_crit_edge.us.loopexit, %98
  %103 = phi i32 [ %.pre132, %..loopexit_crit_edge.us.loopexit ], [ %94, %98 ] ; [#uses=2 type=i32]
...
.loopexit95.loopexit:                             ; preds = %..loopexit_crit_edge.us
  %.pre133 = load i32, ptr %22, align 8, !tbaa !69 ; [#uses=1 type=i32]
  br label %.loopexit95

.loopexit95:                                      ; preds = %.lr.ph104.split, %.loopexit95.loopexit, %64, %60
  %118 = phi i32 [ %55, %60 ], [ %55, %64 ], [ %55, %.lr.ph104.split ], [ %.pre133, %.loopexit95.loopexit ] ; [#uses=2 type=i32]
  %.2 = phi i32 [ %63, %60 ], [ %.083112, %64 ], [ %117, %.lr.ph104.split ], [ %106, %.loopexit95.loopexit ] ; [#uses=1 type=i32]
  %indvars.iv.next130 = add nuw nsw i64 %indvars.iv129, 1 ; [#uses=2 type=i64]
  %119 = sext i32 %118 to i64                     ; [#uses=1 type=i64]
  %120 = icmp slt i64 %indvars.iv.next130, %119   ; [#uses=1 type=i1]
...
._crit_edge.loopexit:                             ; preds = %.loopexit96
  %.pre134 = load i32, ptr %13, align 8, !tbaa !70 ; [#uses=1 type=i32]
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %25
  %122 = phi i32 [ %.pre134, %._crit_edge.loopexit ], [ %26, %25 ] ; [#uses=2 type=i32]
...
._crit_edge120.loopexit:                          ; preds = %._crit_edge
  %.pre135 = load i32, ptr %8, align 8, !tbaa !71 ; [#uses=1 type=i32]
  br label %._crit_edge120

._crit_edge120:                                   ; preds = %._crit_edge120.loopexit, %2
  %125 = phi i32 [ %.pre135, %._crit_edge120.loopexit ], [ %9, %2 ] ; [#uses=2 type=i32]
