...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %spec.select148 = tail call i32 @llvm.smax.i32(i32 %i.as, i32 %i.at) ; 2 uses
  %.not.i.i87 = icmp eq ptr %.sroa.11.2182, %.sroa.17.2183
  br i1 %.not.i.i87, label %bb.j, label %bb.i

bb.i:                                             ; preds = %bb.h
  %.sroa.6.0.insert.ext = zext i32 %spec.select148 to i64
...
bb.j:                                             ; preds = %bb.h
  %i.au = ptrtoint ptr %.sroa.17.2183 to i64      ; 2 uses
  %i.av = ptrtoint ptr %.sroa.0118.2181 to i64    ; 3 uses
...
.noexc89:                                         ; preds = %_ZNKSt6vectorIN3g2o10MatrixElemESaIS1_EE12_M_check_lenEmPKc.exit.i.i.i
  ...
  %.sroa.6.0.insert.ext109 = zext i32 %spec.select148 to i64
  ...
  %.not10.i.i.i.i.i.i = icmp eq ptr %.sroa.0118.2181, %.sroa.17.2183
...
vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.i.i.preheader
  ...
  %i.bo = getelementptr i8, ptr %.sroa.0118.2181, i64 %i.bm
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep328 = getelementptr i8, ptr %.sroa.0118.2181, i64 %i.bp ; 2 uses
...
.lr.ph.i.i.i.i.i.i.preheader333:                  ; preds = %.lr.ph.i.i.i.i.i.i.preheader, %middle.block
  ...
  %.0911.i.i.i.i.i.i.ph = phi ptr [ %.sroa.0118.2181, %.lr.ph.i.i.i.i.i.i.preheader ], [ %i.bo, %middle.block ]
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i.preheader333, %.lr.ph.i.i.i.i.i.i
  ...
  %.not.i.i.i.i.i.i = icmp eq ptr %i.bu, %.sroa.17.2183
...
_ZNSt6vectorIN3g2o10MatrixElemESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i: ; preds = %.lr.ph.i.i.i.i.i.i, %middle.block, %.noexc89
  ...
  %.not.i23.i.i.i = icmp eq ptr %.sroa.0118.2181, null
...
bb.l:                                             ; preds = %_ZNSt6vectorIN3g2o10MatrixElemESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i.i.i
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0118.2181, i64 noundef %i.aw) #21
...
_ZNSt6vectorIN3g2o10MatrixElemESaIS1_EE9push_backEOS1_.exit: ; preds = %_ZNSt6vectorIN3g2o10MatrixElemESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i, %bb.i
  %.sroa.0118.4 = phi ptr [ %i.be, %_ZNSt6vectorIN3g2o10MatrixElemESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %.sroa.0118.2181, %bb.i ] ; 3 uses
  ...
  %.sroa.17.4 = phi ptr [ %i.bw, %_ZNSt6vectorIN3g2o10MatrixElemESaIS1_EE17_M_realloc_insertIJS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i.i ], [ %.sroa.17.2183, %bb.i ] ; 3 uses
...
.preheader153:                                    ; preds = %bb.n, %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPN3g2o10MatrixElemESt6vectorIS3_SaIS3_EEEEEvT_S9_.exit.thread
  ...
  %.sroa.0118.0.lcssa287300 = phi ptr [ %.sroa.0118.0.lcssa288, %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPN3g2o10MatrixElemESt6vectorIS3_SaIS3_EEEEEvT_S9_.exit.thread ], [ %.sroa.0118.1.lcssa, %bb.n ] ; 2 uses
  %.sroa.17.0.lcssa290299 = phi ptr [ %.sroa.17.0.lcssa291, %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPN3g2o10MatrixElemESt6vectorIS3_SaIS3_EEEEEvT_S9_.exit.thread ], [ %.sroa.17.1.lcssa, %bb.n ]
...
.lr.ph201:                                        ; preds = %.noexc, %bb.n
  %.068200 = phi i64 [ %i.cl, %bb.n ], [ 0, %.noexc ] ; 2 uses
  %i.cg = getelementptr inbounds nuw [8 x i8], ptr %.sroa.0118.1.lcssa, i64 %.068200 ; 2 uses
...
bb.n:                                             ; preds = %.lr.ph201
  %i.cl = add nuw i64 %.068200, 1                 ; 2 uses
...
._crit_edge209:                                   ; preds = %._crit_edge205, %.preheader153
  %.not.i.i.i90 = icmp eq ptr %.sroa.0118.0.lcssa287300, null
  br i1 %.not.i.i.i90, label %_ZNSt6vectorIN3g2o10MatrixElemESaIS1_EED2Ev.exit, label %bb.o

bb.o:                                             ; preds = %._crit_edge209
  %i.cn = ptrtoint ptr %.sroa.17.0.lcssa290299 to i64
  %i.co = sub i64 %i.cn, %.pre-phi263301
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0118.0.lcssa287300, i64 noundef %i.co) #21
...
bb.p:                                             ; preds = %.lr.ph208, %._crit_edge205
  %.067207 = phi i64 [ 0, %.lr.ph208 ], [ %i.eg, %._crit_edge205 ] ; 3 uses
  %.1206 = phi i32 [ 0, %.lr.ph208 ], [ %i.cq, %._crit_edge205 ] ; 6 uses
  %i.cp = getelementptr inbounds nuw [4 x i8], ptr %i.by, i64 %.067207
  %i.cq = load i32, ptr %i.cp, align 4, !tbaa !40 ; 2 uses
  %i.cr = sub nsw i32 %i.cq, %.1206               ; 8 uses
  %i.cs = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.067207
...
.preheader152.us.preheader:                       ; preds = %.preheader152.lr.ph.split.us
  %i.cy = sext i32 %.1206 to i64                  ; 2 uses
...
.preheader152.us.us:                              ; preds = %.preheader152.us.us.preheader, %.split.us.us.split.us.us
  %indvars.iv247 = phi i64 [ 0, %.preheader152.us.us.preheader ], [ %indvars.iv.next248, %.split.us.us.split.us.us ] ; 6 uses
  %i.da = mul nuw nsw i64 %indvars.iv247, %i.cz
  %4 = trunc i64 %indvars.iv247 to i32
  %5 = add i32 %.1206, %4                         ; 2 uses
...
.preheader.us.us.us.us:                           ; preds = %bb.s, %.preheader152.us.us
  ...
  %6 = trunc i64 %indvars.iv249 to i32
  %7 = add i32 %.1206, %6                         ; 2 uses
  %spec.select149.us.us.us.us = tail call i32 @llvm.smin.i32(i32 %5, i32 %7)
  %spec.select150.us.us.us.us = tail call i32 @llvm.smax.i32(i32 %5, i32 %7)
  %8 = mul nsw i32 %i.cw, %spec.select149.us.us.us.us
  %9 = add nsw i32 %8, %spec.select150.us.us.us.us
  br label %bb.q
...
bb.r:                                             ; preds = %_ZNSt13unordered_mapIidSt4hashIiESt8equal_toIiESaISt4pairIKidEEE4findERS5_.exit.loopexit.us.us.us.us
  %i.de = mul nuw nsw i64 %indvars.iv249, %i.cz
...
bb.s:                                             ; preds = %_ZNSt13unordered_mapIidSt4hashIiESt8equal_toIiESaISt4pairIKidEEE4findERS5_.exit.loopexit.us.us.us.us, %bb.r
  ...
  %exitcond253.not = icmp eq i64 %indvars.iv.next250.a, %i.cz
...
.split.us.us.split.us.us:                         ; preds = %bb.s
  ...
  %exitcond256.not = icmp eq i64 %indvars.iv.next248, %i.cz
...
.preheader152.lr.ph.split:                        ; preds = %.preheader152.lr.ph
  ...
  %i.dz = sext i32 %.1206 to i64                  ; 2 uses
...
._crit_edge205:                                   ; preds = %.split, %.split.us.us.split, %.split.us.us.split.us.us, %bb.p
  %i.eg = add nuw i64 %.067207, 1                 ; 2 uses
...
bb.ac:                                            ; preds = %.loopexit, %.loopexit.split-lp, %bb.m
  %.sroa.0118.3 = phi ptr [ %.sroa.0118.1.lcssa, %bb.m ], [ %.sroa.0118.2181, %.loopexit ], [ %.sroa.0118.2181, %.loopexit.split-lp ] ; 3 uses
  %.sroa.17.3 = phi ptr [ %.sroa.17.1.lcssa, %bb.m ], [ %.sroa.17.2183, %.loopexit ], [ %.sroa.17.2183, %.loopexit.split-lp ]
...
bb.ad:                                            ; preds = %._crit_edge260, %.thread134
  ...
  %.sroa.17.3140 = phi ptr [ %.sroa.17.3, %._crit_edge260 ], [ %.sroa.17.1.lcssa, %.thread134 ]
  %.sroa.0118.3139 = phi ptr [ %.sroa.0118.3, %._crit_edge260 ], [ %.sroa.0118.1.lcssa, %.thread134 ]
  %i.fk = ptrtoint ptr %.sroa.17.3140 to i64
  %i.fl = sub i64 %i.fk, %.pre-phi269
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.0118.3139, i64 noundef %i.fl) #21
