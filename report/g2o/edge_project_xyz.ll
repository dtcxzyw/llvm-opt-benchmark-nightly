...
bb.a:
  ...
  %1 = load <2 x double>, ptr %i.h, align 8, !tbaa !55, !noalias !90 ; 3 uses
  %2 = load <2 x double>, ptr %i.i, align 8, !tbaa !55, !noalias !90 ; 4 uses
  %3 = fneg <2 x double> %2
  %4 = shufflevector <2 x double> %1, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %5 = insertelement <2 x double> %4, double %i.k, i64 1
  %6 = fmul <2 x double> %5, %3
  %7 = shufflevector <2 x double> %2, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %8 = insertelement <2 x double> %7, double %i.j, i64 1
  %9 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %1, <2 x double> %8, <2 x double> %6) ; 2 uses
  %i.l = fneg double %i.j
  %10 = extractelement <2 x double> %1, i64 0     ; 2 uses
  %11 = fmul double %10, %i.l
  %12 = extractelement <2 x double> %2, i64 0
  %13 = tail call double @llvm.fmuladd.f64(double %i.k, double %12, double %11) ; 2 uses
  %i.m = fadd <2 x double> %9, %9                 ; 2 uses
  %i.n = fadd double %13, %13
  ...
  %i.r = fmul double %10, %i.q
  %i.s = tail call double @llvm.fmuladd.f64(double %i.k, double %.sroa.027.8.vec.extract.i.i.i.i, double %i.r)
  %i.t = fmul double %i.p, %i.n
  %14 = extractelement <2 x double> %2, i64 1
  %i.u = fadd double %14, %i.t
