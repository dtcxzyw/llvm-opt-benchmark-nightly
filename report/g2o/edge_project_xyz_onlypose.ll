...
bb.a:
  ...
  %i.h = load double, ptr %i.e, align 16, !tbaa !21, !noalias !131 ; 2 uses
  %i.i = load double, ptr %i.d, align 8, !tbaa !21, !noalias !131 ; 3 uses
  %1 = load <2 x double>, ptr %i.f, align 8, !tbaa !21, !noalias !131 ; 3 uses
  %2 = load <2 x double>, ptr %i.g, align 8, !tbaa !21, !noalias !131 ; 4 uses
  %3 = fneg <2 x double> %2
  %4 = shufflevector <2 x double> %1, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %5 = insertelement <2 x double> %4, double %i.i, i64 1
  %6 = fmul <2 x double> %5, %3
  %7 = shufflevector <2 x double> %2, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %8 = insertelement <2 x double> %7, double %i.h, i64 1
  ...
  %11 = fmul double %10, %i.j
  %12 = extractelement <2 x double> %2, i64 0
  %13 = tail call double @llvm.fmuladd.f64(double %i.i, double %12, double %11) ; 2 uses
  %i.k = fadd <2 x double> %9, %9                 ; 2 uses
  %i.l = fadd double %13, %13
  ...
  %i.p = fmul double %10, %i.o
  %i.q = tail call double @llvm.fmuladd.f64(double %i.i, double %.sroa.027.8.vec.extract.i.i.i.i, double %i.p)
  %i.r = fmul double %i.n, %i.l
  %14 = extractelement <2 x double> %2, i64 1
  %i.s = fadd double %14, %i.r
