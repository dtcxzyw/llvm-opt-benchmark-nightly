...
bb.a:
  ...
  %i.bj = fadd <2 x double> %i.bf, %i.bi
  ...
  %i.cg = fadd <2 x double> %i.cc, %i.cf
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.n = load <1 x double>, ptr %i.l, align 16    ; 2 uses
  ...
  %i.r = load <1 x double>, ptr %i.q, align 8     ; 2 uses
  ...
  %i.v = load <1 x double>, ptr %i.u, align 16    ; 2 uses
  ...
  %i.z = load <2 x double>, ptr %i.y, align 8     ; 4 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.ej = shufflevector <1 x double> %i.n, <1 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.ek = fneg <2 x double> %i.at
  %i.el = fmul <2 x double> %i.ej, %i.ek
  %i.em = shufflevector <1 x double> %i.r, <1 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.en = fmul <2 x double> %i.em, %i.av
  %i.eo = fsub <2 x double> %i.el, %i.en
  %i.ep = shufflevector <1 x double> %i.v, <1 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.eq = fmul <2 x double> %i.ep, %i.ax
  %i.er = fsub <2 x double> %i.eo, %i.eq
  %i.es = shufflevector <2 x double> %i.z, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.et = fmul <2 x double> %i.es, %i.az
  %i.eu = fsub <2 x double> %i.er, %i.et
  %i.ev = shufflevector <2 x double> %i.z, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  ...
  %i.ff = fmul <2 x double> %i.aj, %i.em
  %i.fg = fsub <2 x double> %i.fe, %i.ff
  %i.fh = fmul <2 x double> %i.al, %i.ep
  %i.fi = fsub <2 x double> %i.fg, %i.fh
  %i.fj = fmul <2 x double> %i.an, %i.es
  %i.fk = fsub <2 x double> %i.fi, %i.fj
  %i.fl = fmul <2 x double> %i.ap, %i.ev
  ...
  %7 = shufflevector <1 x double> %i.n, <1 x double> poison, <2 x i32> zeroinitializer
  %i.fq = fneg <2 x double> %i.m
  %i.fr = fmul <2 x double> %7, %i.fq
  %8 = shufflevector <1 x double> %i.r, <1 x double> poison, <2 x i32> zeroinitializer
  %i.fs = fmul <2 x double> %i.p, %8
  %i.ft = fsub <2 x double> %i.fr, %i.fs
  %9 = shufflevector <1 x double> %i.v, <1 x double> poison, <2 x i32> zeroinitializer
  %i.fu = fmul <2 x double> %i.t, %9
  %i.fv = fsub <2 x double> %i.ft, %i.fu
  %10 = shufflevector <2 x double> %i.z, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fw = fmul <2 x double> %i.x, %10
  %i.fx = fsub <2 x double> %i.fv, %i.fw
  %11 = shufflevector <2 x double> %i.z, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.fy = fmul <2 x double> %i.ab, %11
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.jz = load <1 x double>, ptr %i.jy, align 16  ; 2 uses
  %i.ka = shufflevector <1 x double> %i.jz, <1 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %12 = load <2 x double>, ptr %i.kh, align 8     ; 3 uses
  %i.ki = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %13 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.ko = fmul <2 x double> %i.km, %13
  ...
  %i.ks = getelementptr inbounds nuw i8, ptr %0, i64 616 ; 2 uses
  %14 = load double, ptr %i.ks, align 8, !tbaa !8
  %15 = insertelement <2 x double> poison, double %14, i64 0
  %i.kt = shufflevector <2 x double> %15, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %20 = shufflevector <1 x double> %i.jz, <1 x double> poison, <2 x i32> zeroinitializer
  %i.mh = load <2 x double>, ptr %i.li, align 16, !tbaa !49
  %i.mi = fneg <2 x double> %i.mh
  %i.mj = fmul <2 x double> %20, %i.mi
  %i.mk = getelementptr inbounds nuw i8, ptr %0, i64 352
  %i.ml = load <2 x double>, ptr %i.mk, align 16, !tbaa !49
  %21 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> zeroinitializer
  %i.mm = fmul <2 x double> %i.ml, %21
  ...
  %22 = load <1 x double>, ptr %i.kn, align 16
  %23 = shufflevector <1 x double> %22, <1 x double> poison, <2 x i32> zeroinitializer
  %i.mq = fmul <2 x double> %i.mp, %23
  %i.mr = fsub <2 x double> %i.mn, %i.mq
  %i.ms = getelementptr inbounds nuw i8, ptr %0, i64 448
  %24 = load <2 x double>, ptr %i.ms, align 16, !tbaa !49
  %i.mt = load <2 x double>, ptr %i.ks, align 8   ; 2 uses
  %25 = shufflevector <2 x double> %i.mt, <2 x double> poison, <2 x i32> zeroinitializer
  %i.mu = fmul <2 x double> %24, %25
  ...
  %26 = shufflevector <2 x double> %i.mt, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.my = fmul <2 x double> %i.mx, %26
...
bb.a:
  ...
  %2 = load double, ptr %i.ac, align 8, !tbaa !8, !noalias !260 ; 2 uses
  %i.ad = load double, ptr %i.d, align 16, !tbaa !8, !noalias !260
  %.sroa.15.64.vec.insert = insertelement <2 x double> poison, double %i.ad, i64 0
  %i.ae = load double, ptr %i.j, align 16, !tbaa !8, !noalias !260
  %.sroa.15.72.vec.insert = insertelement <2 x double> %.sroa.15.64.vec.insert, double %i.ae, i64 1 ; 2 uses
  ...
  store <2 x double> %.sroa.9.40.vec.insert, ptr %.sroa.9.0..sroa_idx, align 16
  %.sroa.12.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 720
  store double %2, ptr %.sroa.12.0..sroa_idx, align 16
  %.sroa.13.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 728
  store double 0.000000e+00, ptr %.sroa.13.0..sroa_idx, align 8
  %.sroa.15.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 736
  store <2 x double> %.sroa.15.72.vec.insert, ptr %.sroa.15.0..sroa_idx, align 16
