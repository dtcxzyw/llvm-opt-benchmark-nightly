...
bb.a:
  ...
  %1 = load <2 x double>, ptr %i.a, align 8       ; 3 uses
  %i.d = shufflevector <2 x double> %1, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  ...
  %i.cv = fadd <2 x double> %i.cu, %i.cr
  %i.cw = getelementptr inbounds nuw i8, ptr %0, i64 288
  %i.cx = load double, ptr %i.cw, align 16, !tbaa !33
