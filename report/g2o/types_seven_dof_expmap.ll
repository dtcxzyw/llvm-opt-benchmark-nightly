...
.lr.ph.i.i.i.i:                                   ; preds = %bb.a, %.loopexit
  ...
  %.052170 = phi i64 [ 0, %bb.a ], [ %i.fa, %.loopexit ] ; 17 uses
...
_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal21scalar_score_coeff_opIdEEKNS_5BlockINS5_INS_3RefINS_6MatrixIdLi7ELi7ELi0ELi7ELi7EEELi0ENS_11OuterStrideILin1EEEEELi7ELi1ELb1EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit: ; preds = %.lr.ph.i.i.i.i.5, %.lr.ph.i.i.i.i.4, %.lr.ph.i.i.i.i.3, %.lr.ph.i.i.i.i.2, %.lr.ph.i.i.i.i.1, %.lr.ph.i.i.i.i
  ...
  %i.bl = sub nuw nsw i32 6, %i.bk                ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %8 = zext nneg i32 %i.bl to i64                 ; 10 uses
  %9 = xor i64 %8, 7                              ; 4 uses
  %i.cu = getelementptr inbounds nuw [8 x i8], ptr %i.ad, i64 %9 ; 11 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.cz = and i64 %i.cy, 1
  %i.da = call i64 @llvm.umin.i64(i64 %i.cz, i64 %8)
...
_ZN5Eigen8internal13first_alignedILi16EdlEET1_PKT0_S2_.exit.i.i.i.i.i.i: ; preds = %bb.f, %bb.e
  ...
  %.lhs.trunc = trunc i64 %i.db to i8
  %10 = sdiv i8 %.lhs.trunc, 2
  %.sext = sext i8 %10 to i64
  %i.dc = shl nsw i64 %.sext, 1                   ; 2 uses
  %i.dd = add nsw i64 %i.dc, %.0.i.i.i.i.i.i.i    ; 5 uses
  %.not177 = icmp eq i64 %.0.i.i.i.i.i.i.i, 0
  br i1 %.not177, label %_ZN5Eigen8internal31unaligned_dense_assignment_loopILb0EE3runINS0_31generic_dense_assignment_kernelINS0_9evaluatorINS_5BlockINS6_INS_3RefINS_6MatrixIdLi7ELi7ELi0ELi7ELi7EEELi0ENS_11OuterStrideILin1EEEEELi7ELi1ELb1EEELin1ELi1ELb0EEEEENS5_INS_14CwiseNullaryOpINS0_18scalar_constant_opIdEENS8_IdLin1ELi1ELi0ELi7ELi1EEEEEEENS0_13div_assign_opIddEELi0EEEEEvRT_ll.exit.i.i.i.i.i.i, label %.lr.ph.i.i.i.i.i.i.i
...
.lr.ph.i17.i.i.i.i.i.i.preheader:                 ; preds = %._crit_edge.i.i.i.i.i.i
  %i.dz = add nsw i64 %.0.i.i.i.i.i.i.i, %i.dc
  %i.ea = sub nsw i64 %8, %i.dz                   ; 3 uses
  %min.iters.check = icmp ult i64 %i.ea, 2
...
vector.ph:                                        ; preds = %.lr.ph.i17.i.i.i.i.i.i.preheader
  %n.vec = and i64 %i.ea, -2                      ; 3 uses
  %i.eb = add nsw i64 %i.dd, %n.vec
  %broadcast.splatinsert = insertelement <2 x double> poison, double %i.cv, i64 0
  %broadcast.splat = shufflevector <2 x double> %broadcast.splatinsert, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ec = getelementptr [8 x i8], ptr %i.cu, i64 %i.dd
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.ed = getelementptr [8 x i8], ptr %i.ec, i64 %index ; 2 uses
  %wide.load = load <2 x double>, ptr %i.ed, align 8, !tbaa !33
  %i.ee = fdiv <2 x double> %wide.load, %broadcast.splat
  store <2 x double> %i.ee, ptr %i.ed, align 8, !tbaa !33
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.ef = icmp eq i64 %index.next, %n.vec
  br i1 %i.ef, label %middle.block, label %vector.body, !llvm.loop !679
...
.lr.ph.i17.i.i.i.i.i.i.preheader177:              ; preds = %.lr.ph.i17.i.i.i.i.i.i.preheader, %middle.block
  %.05.i18.i.i.i.i.i.i.ph = phi i64 [ %i.dd, %.lr.ph.i17.i.i.i.i.i.i.preheader ], [ %i.eb, %middle.block ]
  br label %.lr.ph.i17.i.i.i.i.i.i

.lr.ph.i17.i.i.i.i.i.i:                           ; preds = %.lr.ph.i17.i.i.i.i.i.i.preheader177, %.lr.ph.i17.i.i.i.i.i.i
  %.05.i18.i.i.i.i.i.i = phi i64 [ %i.ej, %.lr.ph.i17.i.i.i.i.i.i ], [ %.05.i18.i.i.i.i.i.i.ph, %.lr.ph.i17.i.i.i.i.i.i.preheader177 ] ; 2 uses
  %i.eg = getelementptr inbounds [8 x i8], ptr %i.cu, i64 %.05.i18.i.i.i.i.i.i ; 2 uses
  %i.eh = load double, ptr %i.eg, align 8, !tbaa !33
  %i.ei = fdiv double %i.eh, %i.cv
  store double %i.ei, ptr %i.eg, align 8, !tbaa !33
  %i.ej = add nsw i64 %.05.i18.i.i.i.i.i.i, 1     ; 2 uses
  %exitcond.not.i19.i.i.i.i.i.i = icmp eq i64 %i.ej, %8
  br i1 %exitcond.not.i19.i.i.i.i.i.i, label %.loopexit, label %.lr.ph.i17.i.i.i.i.i.i, !llvm.loop !680

.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i, %.lr.ph.i.preheader.i.i.i.i.i
  %.021.i.i.i.i.i.i = phi i64 [ %i.en, %.lr.ph.i.i.i.i.i.i ], [ %.0.i.i.i.i.i.i.i, %.lr.ph.i.preheader.i.i.i.i.i ] ; 2 uses
  %i.ek = getelementptr inbounds [8 x i8], ptr %i.cu, i64 %.021.i.i.i.i.i.i ; 2 uses
  %i.el = load <2 x double>, ptr %i.ek, align 16, !tbaa !17
  %i.em = fdiv <2 x double> %i.el, %i.dx
  store <2 x double> %i.em, ptr %i.ek, align 16, !tbaa !17
  %i.en = add nuw nsw i64 %.021.i.i.i.i.i.i, 2    ; 2 uses
  %i.eo = icmp slt i64 %i.en, %i.dd
  br i1 %i.eo, label %.lr.ph.i.i.i.i.i.i, label %._crit_edge.i.i.i.i.i.i, !llvm.loop !681
...
bb.g:                                             ; preds = %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal21scalar_score_coeff_opIdEEKNS_5BlockINS5_INS_3RefINS_6MatrixIdLi7ELi7ELi0ELi7ELi7EEELi0ENS_11OuterStrideILin1EEEEELi7ELi1ELb1EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit
  %i.ep = icmp eq i64 %.0171, -1
  %spec.select54 = select i1 %i.ep, i64 %.052170, i64 %.0171
  %.pre = zext nneg i32 %i.bl to i64              ; 2 uses
  %.pre172 = xor i64 %.pre, 7
  br label %.loopexit
...
.loopexit:                                        ; preds = %.lr.ph.i17.i.i.i.i.i.i, %middle.block, %._crit_edge.i.i.i.i.i.i, %bb.g
  ...
  %i.eq = load ptr, ptr %0, align 8, !tbaa !671, !noalias !682 ; 3 uses
  %i.er = load i64, ptr %i.a, align 8, !tbaa !193, !noalias !682 ; 8 uses
  %i.es = mul nsw i64 %i.er, %.052170
  %i.et = getelementptr inbounds [8 x i8], ptr %i.eq, i64 %i.es ; 2 uses
  %i.eu = getelementptr inbounds nuw [8 x i8], ptr %i.et, i64 %.pre-phi173 ; 2 uses
  %i.ev = getelementptr inbounds nuw [8 x i8], ptr %i.eq, i64 %.052170 ; 2 uses
  %i.ew = mul nsw i64 %i.er, %.pre-phi173         ; 2 uses
  %i.ex = getelementptr inbounds [8 x i8], ptr %i.ev, i64 %i.ew ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #26
  %i.ey = getelementptr inbounds nuw [8 x i8], ptr %i.eq, i64 %.pre-phi173
  %i.ez = getelementptr inbounds [8 x i8], ptr %i.ey, i64 %i.ew ; 2 uses
  store ptr %i.ez, ptr %7, align 8, !tbaa !685, !alias.scope !687
  ...
  store i64 %i.er, ptr %i.g, align 8, !tbaa !692, !alias.scope !687
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #26
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #26
  store ptr %i.eu, ptr %3, align 8
  store i64 %.pre-phi, ptr %.sroa.484.0..sroa_idx, align 8
  store ptr %i.et, ptr %.sroa.686.0..sroa_idx, align 8
  ...
  store i64 %i.er, ptr %.sroa.1191.0..sroa_idx, align 8
  store i64 %.pre-phi173, ptr %.sroa.1292.0..sroa_idx, align 8
  store i64 %i.er, ptr %.sroa.14.0..sroa_idx, align 8
  store ptr %i.ex, ptr %i.h, align 8
  store i64 %.pre-phi, ptr %.sroa.18.96..sroa_idx, align 8
  store ptr %i.ev, ptr %.sroa.19.96..sroa_idx, align 8
  ...
  store ptr %i.eu, ptr %i.i, align 8, !tbaa !695
  store i64 %i.er, ptr %i.j, align 8, !tbaa !193
  store ptr %i.ex, ptr %i.k, align 8, !tbaa !697
  store i64 %i.er, ptr %i.l, align 8, !tbaa !193
  store i64 1, ptr %i.m, align 8, !tbaa !699
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #26
  store ptr %i.ez, ptr %4, align 8, !tbaa !725
  store i64 %i.er, ptr %i.n, align 8, !tbaa !193
  ...
  %i.fa = add nuw nsw i64 %.052170, 1             ; 2 uses
  %exitcond.not = icmp eq i64 %i.fa, 6
