...
bb.j:                                             ; preds = %bb.h
  ...
  %i.hw = extractelement <2 x i1> %i.hv, i64 0    ; 4 uses
  ...
  %i.hz = fcmp ogt double %i.ha, %i.hy            ; 2 uses
  %.1.i.i.i = select i1 %i.hz, i64 2, i64 %spec.select.i.i.i ; 3 uses
  %4 = select i1 %i.hw, i64 2, i64 1
  %i.ia = select i1 %i.hz, i64 0, i64 %4
  ...
  %i.ii = getelementptr [8 x i8], ptr %2, i64 %5  ; 3 uses
  ...
  %i.je = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %.fr.i.i.i
  ...
  %i.jl = getelementptr inbounds [8 x i8], ptr %3, i64 %5
