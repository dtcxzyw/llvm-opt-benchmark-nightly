...
bb.a:
  ...
  %i.aq = insertelement <2 x double> %i.n, double 0.000000e+00, i64 1
  store <2 x double> %i.aq, ptr %.sroa.6.0..sroa_idx, align 16
  ...
  %i.ar = insertelement <2 x double> %i.q, double 0.000000e+00, i64 1
  store <2 x double> %i.ar, ptr %.sroa.18.0..sroa_idx, align 16
...
_ZN5Eigen10MatrixBaseINS_3MapINS_6MatrixIdLi4ELi1ELi0ELi4ELi1EEELi0ENS_6StrideILi0ELi0EEEEEE9normalizeEv.exit: ; preds = %bb.a, %bb.b
  ...
  %.sroa.6.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 160
  %i.be = insertelement <2 x double> %i.ab, double 0.000000e+00, i64 1
  store <2 x double> %i.be, ptr %.sroa.6.0..sroa_idx.i, align 16
  %.sroa.9.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 176
  ...
  %.sroa.18.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 224
  %i.bf = insertelement <2 x double> %i.ae, double 0.000000e+00, i64 1
  store <2 x double> %i.bf, ptr %.sroa.18.0..sroa_idx.i, align 16
  %.sroa.21.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %0, i64 240
...
bb.a:
  ...
  %i.eg = load <2 x double>, ptr %i.b, align 8    ; 2 uses
  %i.eh = load double, ptr %i.k, align 8, !tbaa !22, !noalias !56
  %.sroa.0.8.vec.insert = insertelement <2 x double> %i.eg, double %i.eh, i64 1 ; 2 uses
  %i.ei = load double, ptr %i.s, align 8, !tbaa !22, !noalias !56 ; 2 uses
  %.sroa.9.32.vec.insert = shufflevector <2 x double> %i.eg, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.ej = getelementptr inbounds nuw i8, ptr %i.a, i64 232
  %i.ek = load double, ptr %i.ej, align 8, !tbaa !22, !noalias !56
  %.sroa.9.40.vec.insert = insertelement <2 x double> %.sroa.9.32.vec.insert, double %i.ek, i64 1 ; 2 uses
  %i.el = getelementptr inbounds nuw i8, ptr %i.a, i64 264
  %i.em = load double, ptr %i.el, align 8, !tbaa !22, !noalias !56 ; 2 uses
  %i.en = load double, ptr %i.aa, align 8, !tbaa !22, !noalias !56
  %.sroa.15.64.vec.insert = insertelement <2 x double> poison, double %i.en, i64 0
  %i.eo = load double, ptr %i.ad, align 8, !tbaa !22, !noalias !56
  %.sroa.15.72.vec.insert = insertelement <2 x double> %.sroa.15.64.vec.insert, double %i.eo, i64 1 ; 2 uses
  %i.ep = load double, ptr %i.ag, align 8, !tbaa !22, !noalias !56 ; 2 uses
  %i.eq = fneg <2 x double> %.sroa.0.8.vec.insert
  %i.er = load double, ptr %i.ce, align 8, !tbaa !22, !noalias !56 ; 2 uses
  ...
  %i.eu = fmul <2 x double> %i.et, %i.eq
  %i.ev = getelementptr inbounds nuw i8, ptr %i.a, i64 296
  %i.ew = load double, ptr %i.ev, align 8, !tbaa !22, !noalias !56 ; 2 uses
  ...
  %i.ez = fmul <2 x double> %.sroa.9.40.vec.insert, %i.ey
  %i.fa = fsub <2 x double> %i.eu, %i.ez
  %i.fb = load double, ptr %i.dc, align 8, !tbaa !22, !noalias !56 ; 2 uses
  ...
  %i.fe = fmul <2 x double> %.sroa.15.72.vec.insert, %i.fd
  %i.ff = fsub <2 x double> %i.fa, %i.fe
  %i.fg = fneg double %i.ep
  %i.fh = fmul double %i.fb, %i.fg
  %i.fi = fmul double %i.em, %i.ew
  %i.fj = fsub double %i.fh, %i.fi
  %i.fk = fmul double %i.ei, %i.er
  %i.fl = fsub double %i.fj, %i.fk
  %i.fm = getelementptr inbounds nuw i8, ptr %0, i64 336
  store <2 x double> %.sroa.0.8.vec.insert, ptr %i.fm, align 16
  %.sroa.6.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 352
  store double %i.ei, ptr %.sroa.6.0..sroa_idx, align 16
  ...
  store double %i.em, ptr %.sroa.12.0..sroa_idx, align 16
  ...
  store double %i.ep, ptr %.sroa.18.0..sroa_idx, align 16
  ...
  store <2 x double> %i.ff, ptr %.sroa.21.0..sroa_idx, align 16
  %.sroa.22.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 448
  store double %i.fl, ptr %.sroa.22.0..sroa_idx, align 16
