...
bb.a:
  ...
  %1 = getelementptr inbounds nuw i8, ptr %i.f, i64 480
  %i.ae = getelementptr inbounds nuw i8, ptr %i.f, i64 512
  %2 = getelementptr inbounds nuw i8, ptr %i.f, i64 544
  %i.af = getelementptr inbounds nuw i8, ptr %i.f, i64 576
  %3 = load double, ptr %i.af, align 16, !tbaa !112, !noalias !146
...
bb.a:
  ...
  %6 = load double, ptr %i.af, align 16, !tbaa !112, !noalias !151
  ...
  %8 = fmul double %7, %6
  %9 = load double, ptr %4, align 16, !tbaa !112, !noalias !151
  %10 = extractelement <2 x double> %i.i, i64 0
  %11 = fmul double %10, %9
  %12 = load double, ptr %i.ae, align 16, !tbaa !112, !noalias !151
  ...
  %16 = load double, ptr %5, align 16, !tbaa !112, !noalias !151
  ...
  %i.as = load double, ptr %4, align 16, !tbaa !118
  ...
  %i.aw = load double, ptr %i.ae, align 16, !tbaa !118
  ...
  %i.ba = load double, ptr %5, align 16, !tbaa !118
  ...
  %23 = load double, ptr %i.cd, align 16, !tbaa !112, !noalias !156
  ...
  %26 = load double, ptr %21, align 16, !tbaa !112, !noalias !156
  %27 = extractelement <2 x double> %i.bh, i64 0
  %28 = fmul double %27, %26
  %29 = load double, ptr %i.cc, align 16, !tbaa !112, !noalias !156
  ...
  %33 = load double, ptr %22, align 16, !tbaa !112, !noalias !156
  ...
  %i.ce = fdiv double 1.000000e+00, %37
  %i.cf = getelementptr inbounds nuw i8, ptr %3, i64 16
  %.sroa.281.16.vec.insert = insertelement <2 x double> poison, double %i.ce, i64 0
  %.sroa.281.16.vec.insert.a = insertelement <2 x double> poison, double %.sroa.4.16.vec.extract.i.i10, i64 0
  %i.cg = shufflevector <2 x double> %.sroa.281.16.vec.insert, <2 x double> poison, <2 x i32> zeroinitializer ; 9 uses
  %i.ch = load <2 x double>, ptr %3, align 16, !tbaa !112
  %i.ci = shufflevector <2 x double> %.sroa.281.16.vec.insert.a, <2 x double> poison, <2 x i32> zeroinitializer ; 9 uses
...
bb.a:
  ...
  %3 = load double, ptr %i.af, align 16, !tbaa !112, !noalias !167
  %4 = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 1
  %5 = fmul double %4, %3
  %6 = load double, ptr %1, align 16, !tbaa !112, !noalias !167
  %7 = extractelement <2 x double> %i.i, i64 0
  %8 = fmul double %7, %6
  %9 = load double, ptr %i.ae, align 16, !tbaa !112, !noalias !167
  %10 = extractelement <2 x double> %.sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i, i64 0
  %11 = fmul double %10, %9
  %12 = fadd double %8, %11
  %13 = load double, ptr %2, align 16, !tbaa !112, !noalias !167
  %14 = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 0
  %15 = fmul double %14, %13
  %16 = fadd double %12, %15
  %.sroa.4.16.vec.extract.i.i = fadd double %5, %16 ; 2 uses
...
bb.a:
  ...
  %3 = load double, ptr %i.bo, align 16, !tbaa !112, !noalias !172
  ...
  %i.bq = fmul double %i.bp, %3
  %4 = load double, ptr %i.bl, align 16, !tbaa !112, !noalias !172
  %i.br = extractelement <2 x double> %i.ac, i64 0
  %i.bs = fmul double %i.br, %4
  %5 = load double, ptr %i.bm, align 16, !tbaa !112, !noalias !172
  %i.bt = extractelement <2 x double> %.sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i, i64 0
  %i.bu = fmul double %i.bt, %5
  %i.bv = fadd double %i.bs, %i.bu
  %6 = load double, ptr %i.bn, align 16, !tbaa !112, !noalias !172
  ...
  %7 = load double, ptr %i.cu, align 16, !tbaa !112, !noalias !177
  %i.cv = extractelement <2 x double> %.sroa.0.i.i5.16..sroa.0.i.i5.16..sroa.0.i.i5.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i10, i64 1
  %i.cw = fmul double %i.cv, %7
  %8 = load double, ptr %i.cr, align 16, !tbaa !112, !noalias !177
  %i.cx = extractelement <2 x double> %i.bk, i64 0
  %i.cy = fmul double %i.cx, %8
  %9 = load double, ptr %i.cs, align 16, !tbaa !112, !noalias !177
  %i.cz = extractelement <2 x double> %.sroa.0.i.i5.8..sroa.0.i.i5.8..sroa.0.i.i5.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i9, i64 0
  %i.da = fmul double %i.cz, %9
  %i.db = fadd double %i.cy, %i.da
  %10 = load double, ptr %i.ct, align 16, !tbaa !112, !noalias !177
  %i.dc = extractelement <2 x double> %.sroa.0.i.i5.16..sroa.0.i.i5.16..sroa.0.i.i5.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i10, i64 0
  %i.dd = fmul double %i.dc, %10
