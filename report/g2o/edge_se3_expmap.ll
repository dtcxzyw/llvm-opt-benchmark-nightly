...
bb.b:                                             ; preds = %bb.a
  ...
  %.sroa.0120.16..07.i.i.i.i.ptr.2.i.i.i.i.i.i.i.i.i.i.sroa_idx188 = getelementptr inbounds nuw i8, ptr %.sroa.0120, i64 16
  store double %i.aq, ptr %.sroa.0120.16..07.i.i.i.i.ptr.2.i.i.i.i.i.i.i.i.i.i.sroa_idx188, align 16, !tbaa !8, !alias.scope !118
...
bb.c:                                             ; preds = %bb.a
  %i.cp = tail call double @acos(double noundef %i.ah) #20 ; 4 uses
  %i.cq = fneg double %i.ah
  %i.cr = tail call double @llvm.fmuladd.f64(double %i.cq, double %i.ah, double 1.000000e+00)
  %i.cs = tail call double @sqrt(double noundef %i.cr) #20
  ...
  %i.ct = fmul double %i.cp, 5.000000e-01
  %i.cu = tail call double @tan(double noundef %i.ct) #20
  %i.cv = insertelement <2 x double> poison, double %i.cs, i64 0
  %i.cw = insertelement <2 x double> %i.cv, double %i.cu, i64 1
  %i.cx = fmul <2 x double> %i.cw, splat (double 2.000000e+00)
  ...
  %i.da = fdiv <2 x double> %i.cz, %i.cx          ; 3 uses
  %i.db = shufflevector <2 x double> %i.da, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dc = fmul <2 x double> %i.ai, %i.db          ; 10 uses
  %i.dd = extractelement <2 x double> %i.da, i64 0
  %i.de = fmul double %i.aj, %i.dd                ; 3 uses
  %i.df = fneg double %i.de
  %.sroa.0.24..07.i.i.i.i.ptr.3.i.i.i.i.i.i.i.i.i.i21.sroa_idx186 = getelementptr inbounds nuw i8, ptr %.sroa.0, i64 24
  store double %i.df, ptr %.sroa.0.24..07.i.i.i.i.ptr.3.i.i.i.i.i.i.i.i.i.i21.sroa_idx186, align 8, !tbaa !8, !alias.scope !121
  %.sroa.0164.8.vec.extract168 = extractelement <2 x double> %i.dc, i64 1 ; 2 uses
  %i.dg = shufflevector <2 x double> %i.dc, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %.sroa.0.8..07.i.i.i.i.ptr.1.i.i.i.i.i.i.i.i.i.i19.sroa_idx184 = getelementptr inbounds nuw i8, ptr %.sroa.0, i64 8
  store double %i.de, ptr %.sroa.0.8..07.i.i.i.i.ptr.1.i.i.i.i.i.i.i.i.i.i19.sroa_idx184, align 8, !tbaa !8, !alias.scope !121
  %i.dh = fneg double %.sroa.0164.8.vec.extract168
  %.sroa.0.16..07.i.i.i.i.ptr.2.i.i.i.i.i.i.i.i.i.i20.sroa_idx185 = getelementptr inbounds nuw i8, ptr %.sroa.0, i64 16
  store double %i.dh, ptr %.sroa.0.16..07.i.i.i.i.ptr.2.i.i.i.i.i.i.i.i.i.i20.sroa_idx185, align 16, !tbaa !8, !alias.scope !121
  %i.di = extractelement <2 x double> %i.da, i64 1
  %i.dj = fsub double 1.000000e+00, %i.di
  %i.dk = fmul double %i.cp, %i.cp
  %i.dl = fdiv double %i.dj, %i.dk                ; 2 uses
  %.sroa.1525.56.vec.insert.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i27 = insertelement <2 x double> poison, double %i.dl, i64 0
  %i.dm = shufflevector <2 x double> %.sroa.1525.56.vec.insert.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i.i27, <2 x double> poison, <2 x i32> zeroinitializer ; 4 uses
  %.sroa.0.0..sroa.0.0..sroa.0.0. = load <2 x double>, ptr %.sroa.0, align 16 ; 4 uses
  %i.dn = fmul <2 x double> %.sroa.0.0..sroa.0.0..sroa.0.0., %i.dm ; 3 uses
  %i.do = shufflevector <2 x double> %.sroa.0.0..sroa.0.0..sroa.0.0., <2 x double> poison, <2 x i32> zeroinitializer
  %i.dp = fmul <2 x double> %i.do, %i.dn
  ...
  %i.dq = fmul <2 x double> %.sroa.0.24..sroa.0.24..sroa.0.24., %i.dm ; 3 uses
  ...
  %i.dr = shufflevector <2 x double> %.sroa.0.8..sroa.0.8..sroa.0.8., <2 x double> poison, <2 x i32> zeroinitializer
  %i.ds = fmul <2 x double> %i.dr, %i.dq
  ...
  %i.du = shufflevector <2 x double> %.sroa.0.16..sroa.0.16..sroa.0.16., <2 x double> poison, <2 x i32> zeroinitializer
  %i.dv = extractelement <2 x double> %.sroa.0.16..sroa.0.16..sroa.0.16., i64 0
  %i.dw = fmul double %i.dl, %i.dv                ; 2 uses
  %i.dx = shufflevector <2 x double> %.sroa.0.16..sroa.0.16..sroa.0.16., <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.dy = fmul <2 x double> %i.dx, %i.dn
  %i.dz = shufflevector <2 x double> %.sroa.0.24..sroa.0.24..sroa.0.24., <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.ea = fmul <2 x double> %i.dq, %i.dz
  %i.eb = fadd <2 x double> %i.dy, %i.ea
  %i.ec = shufflevector <2 x double> %i.dc, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ed = fmul <2 x double> %i.dn, %i.dg
  %i.ee = fmul double %i.dw, %.sroa.0164.8.vec.extract168
  %.sroa.0164.0.vec.extract166 = extractelement <2 x double> %i.dc, i64 0
  %i.ef = fneg double %.sroa.0164.0.vec.extract166 ; 2 uses
  %.sroa.16.56.vec.insert = insertelement <2 x double> %i.dg, double %i.ef, i64 1
  %i.eg = fmul <2 x double> %.sroa.16.56.vec.insert, %i.dm ; 3 uses
  %i.eh = fmul <2 x double> %i.du, %i.eg
  %i.ei = fadd <2 x double> %i.eh, %i.dt
  %i.ej = fmul <2 x double> %i.ec, %i.eg
  %i.ek = fadd <2 x double> %i.ej, %i.eb
  ...
  %i.eo = fadd <2 x double> %i.en, %i.ed
  %i.ep = fmul <2 x double> %i.eg, zeroinitializer
  %i.eq = fadd <2 x double> %i.ep, %i.eo
  %i.er = shufflevector <2 x double> %.sroa.0.0..sroa.0.0..sroa.0.0., <2 x double> %.sroa.0.8..sroa.0.8..sroa.0.8., <2 x i32> <i32 0, i32 2>
  %i.es = fmul <2 x double> %i.er, splat (double 5.000000e-01)
  %i.et = fsub <2 x double> <double 1.000000e+00, double 0.000000e+00>, %i.es
  %i.eu = fadd <2 x double> %i.ei, %i.et
  %i.ev = shufflevector <2 x double> %.sroa.0.16..sroa.0.16..sroa.0.16., <2 x double> %.sroa.0.24..sroa.0.24..sroa.0.24., <2 x i32> <i32 1, i32 3>
  %i.ew = fmul <2 x double> %i.ev, splat (double 5.000000e-01)
  %i.ex = fsub <2 x double> <double 0.000000e+00, double 1.000000e+00>, %i.ew
  %i.ey = fadd <2 x double> %i.ek, %i.ex
  %i.ez = fmul <2 x double> %i.dc, <double 1.000000e+00, double 5.000000e-01> ; 2 uses
  %i.fa = fsub <2 x double> <double poison, double 0.000000e+00>, %i.ez
  %i.fb = fmul <2 x double> %i.ez, <double 5.000000e-01, double poison>
  %i.fc = shufflevector <2 x double> %i.fa, <2 x double> %i.fb, <2 x i32> <i32 1, i32 2>
  %i.fd = shufflevector <2 x double> %.sroa.0.16..sroa.0.16..sroa.0.16., <2 x double> %.sroa.0.0..sroa.0.0..sroa.0.0., <2 x i32> <i32 1, i32 2>
  %i.fe = insertelement <2 x double> poison, double %i.dw, i64 0
  %i.ff = shufflevector <2 x double> %i.fe, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fg = fmul <2 x double> %i.fd, %i.ff
  %i.fh = insertelement <2 x double> %i.dc, double 0.000000e+00, i64 1
  %i.fi = fmul <2 x double> %i.fh, %i.dm          ; 4 uses
  %i.fj = extractelement <2 x double> %i.fi, i64 1
  %i.fk = fmul ninf double %i.fj, 0.000000e+00
  %i.fl = shufflevector <2 x double> %.sroa.0.24..sroa.0.24..sroa.0.24., <2 x double> %.sroa.0.16..sroa.0.16..sroa.0.16., <2 x i32> <i32 1, i32 2>
  %i.fm = fmul <2 x double> %i.fl, %i.fi
  %i.fn = shufflevector <2 x double> %.sroa.0.8..sroa.0.8..sroa.0.8., <2 x double> %i.dc, <2 x i32> <i32 2, i32 0>
  %i.fo = shufflevector <2 x double> %i.fi, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.fp = fmul <2 x double> %i.fn, %i.fo
  %i.fq = fadd <2 x double> %i.fm, %i.fp
  %i.fr = fadd <2 x double> %i.fg, %i.fq
  %foldExtExtBinop182 = fmul <2 x double> %i.dc, %i.fi
  %i.fs = extractelement <2 x double> %foldExtExtBinop182, i64 0
  %i.ft = fsub double %i.fk, %i.fs
  %i.fu = fadd double %i.ee, %i.ft
  %i.fv = shufflevector <2 x double> %i.dc, <2 x double> %.sroa.0.16..sroa.0.16..sroa.0.16., <2 x i32> <i32 0, i32 2>
  %i.fw = fmul <2 x double> %i.fv, splat (double 5.000000e-01)
  %i.fx = fsub <2 x double> zeroinitializer, %i.fw
  %i.fy = fadd <2 x double> %i.fx, %i.fr
  %i.fz = fadd <2 x double> %i.fc, <double -0.000000e+00, double 0.000000e+00>
  %i.ga = fadd <2 x double> %i.fz, %i.eq
...
.preheader.preheader:                             ; preds = %bb.c, %bb.b
  ...
  %i.gd = load <2 x double>, ptr %i.gc, align 16  ; 2 uses
  %i.ge = shufflevector <2 x double> %i.gd, <2 x double> poison, <2 x i32> zeroinitializer
  %i.gf = fmul <2 x double> %.sroa.0146.0, %i.ge
  %i.gg = getelementptr inbounds nuw i8, ptr %1, i64 40
  %i.gh = load <2 x double>, ptr %i.gg, align 8   ; 4 uses
  %i.gi = shufflevector <2 x double> %i.gh, <2 x double> poison, <2 x i32> zeroinitializer
  %i.gj = fmul <2 x double> %.sroa.10.0, %i.gi
  %i.gk = fadd <2 x double> %i.gf, %i.gj
  %i.gl = shufflevector <2 x double> %i.gh, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.gm = fmul <2 x double> %.sroa.18.0, %i.gl
  %i.gn = fadd <2 x double> %i.gm, %i.gk
  %i.go = shufflevector <2 x double> %i.gh, <2 x double> %i.gd, <2 x i32> <i32 0, i32 2>
  %i.gp = fmul <2 x double> %i.go, %i.gb          ; 2 uses
  %i.gq = extractelement <2 x double> %i.gh, i64 1
  %i.gr = fmul double %i.gq, %.sroa.23.0
  ...
  store <2 x double> %i.gn, ptr %scevgep, align 8, !tbaa !8
  %.sroa.4.0.scevgep.sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 40
  store double %i.gv, ptr %.sroa.4.0.scevgep.sroa_idx, align 8, !tbaa !8
  ret void
}
