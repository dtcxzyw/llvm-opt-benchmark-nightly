...
bb.a:
  ...
  %i.a = load double, ptr %1, align 16, !tbaa !8, !noalias !115 ; 4 uses
  %i.b = fmul double %i.a, 2.000000e+00           ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.d = load double, ptr %i.c, align 8, !tbaa !8, !noalias !115 ; 3 uses
  %i.e = fmul double %i.d, 2.000000e+00           ; 3 uses
  %2 = getelementptr inbounds nuw i8, ptr %1, i64 16
  %3 = load double, ptr %2, align 16, !tbaa !8, !noalias !115 ; 2 uses
  %4 = fmul double %3, 2.000000e+00               ; 4 uses
  %5 = getelementptr inbounds nuw i8, ptr %1, i64 24
  %6 = load double, ptr %5, align 8, !tbaa !8, !noalias !115 ; 3 uses
  %7 = fmul double %i.b, %6                       ; 2 uses
  %8 = fmul double %i.e, %6                       ; 2 uses
  %9 = fmul double %4, %6                         ; 2 uses
  %10 = fmul double %i.a, %i.b                    ; 2 uses
  %11 = fmul double %i.a, %i.e                    ; 2 uses
  %12 = fmul double %i.a, %4                      ; 2 uses
  %13 = fmul double %i.d, %i.e                    ; 2 uses
  %14 = fmul double %i.d, %4                      ; 2 uses
  %15 = fmul double %3, %4                        ; 2 uses
  %i.f = fadd double %13, %15
  %i.g = fsub double 1.000000e+00, %i.f
  %i.h = fsub double %11, %9
  %i.i = fadd double %12, %8
  %16 = fadd double %11, %9
  %i.j = fadd double %10, %15
  %17 = fsub double 1.000000e+00, %i.j
  %i.k = fsub double %14, %7
  %18 = fsub double %12, %8
  %19 = fadd double %14, %7
  %i.l = fadd double %10, %13
  %i.m = fsub double 1.000000e+00, %i.l
  %i.n = fadd double %i.g, %17
  %i.o = fadd double %i.m, %i.n
  %i.p = fadd double %i.o, -1.000000e+00
  %i.q = fmul double %i.p, 5.000000e-01           ; 4 uses
  %20 = fsub double %19, %i.k
  %.sroa.0.0.vec.insert = insertelement <2 x double> poison, double %20, i64 0
  %21 = fsub double %i.i, %18
  %.sroa.0.8.vec.insert = insertelement <2 x double> %.sroa.0.0.vec.insert, double %21, i64 1 ; 2 uses
  %i.r = fsub double %16, %i.h                    ; 2 uses
  %i.s = tail call noundef double @llvm.fabs.f64(double %i.q)
  %i.t = fcmp ogt double %i.s, 9.999900e-01
  br i1 %i.t, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.u = fmul <2 x double> %.sroa.0.8.vec.insert, splat (double 5.000000e-01) ; 7 uses
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.cx = fmul <2 x double> %.sroa.0.8.vec.insert, %i.cw ; 10 uses
