...
bb.b:                                             ; preds = %bb.a
  ...
  %8 = fmul <2 x double> %i.cf, %i.cg
  %i.ch = fmul <2 x double> %2, zeroinitializer
  %9 = fadd <2 x double> %8, %i.ch
  %10 = fadd <2 x double> %5, %9
  %foldExtExtBinop184 = fmul <2 x double> %i.am, %3
  %11 = extractelement <2 x double> %foldExtExtBinop184, i64 0
  %12 = fsub double 0.000000e+00, %11
  %13 = fadd double %6, %12
  %i.ci = fmul <2 x double> %2, splat (double 5.000000e-01)
  %i.cj = fsub <2 x double> zeroinitializer, %i.ci
  %i.ck = fadd <2 x double> %i.cj, %10
...
.preheader.preheader:                             ; preds = %bb.c, %bb.b
  ...
  %.sroa.23.0.in = phi double [ %13, %bb.b ], [ %i.fs, %bb.c ]
...
._crit_edge.i.i:
  ...
  %.sroa.4.24.vec.insert.uncasted.a = shufflevector <2 x double> %i.nt, <2 x double> %i.og, <2 x i32> <i32 0, i32 2>
  ...
  %i.pl = fneg <2 x double> %.sroa.4.24.vec.insert.uncasted.a
