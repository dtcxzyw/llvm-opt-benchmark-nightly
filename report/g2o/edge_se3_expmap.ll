...
begin_hunk_0_@_ZN3g2o13EdgeSE3Expmap14linearizeOplusEv:._crit_edge.i.i
  ...
  %2 = fneg double %.sroa.091.sroa.16.32.vec.extract
  %.sroa.9.56.vec.insert.i66.a = insertelement <2 x double> %.sroa.9.48.vec.insert.i65, double %2, i64 1 ; 3 uses
  ...
  %i.ob = fmul <2 x double> %.sroa.6.24.vec.insert.i64273, %i.oa
  ...
  %3 = fmul <2 x double> %.sroa.9.56.vec.insert.i66.a, %i.od
  %4 = fadd <2 x double> %i.oc, %3                ; 2 uses
  %5 = extractelement <2 x double> %.sroa.0118.i49.8..sroa.0118.i49.8..sroa.0118.i49.8..sroa.0118.8..sroa.0118.8.121.i61, i64 0
  %6 = fmul double %5, %.sroa.091.sroa.16.32.vec.extract
  %7 = extractelement <2 x double> %.sroa.0118.i49.16..sroa.0118.i49.16..sroa.0118.i49.16..sroa.0118.16..sroa.0118.16..i68, i64 0
  %8 = fmul double %7, 0.000000e+00
  %9 = fadd double %6, %8
  %10 = fmul double %1, %.sroa.091.sroa.16.40.vec.extract
  %11 = fsub double %9, %10
  %12 = extractelement <2 x double> %.sroa.0118.i49.16..sroa.0118.i49.16..sroa.0118.i49.16..sroa.0118.16..sroa.0118.16..i68, i64 1
  %13 = shufflevector <2 x double> %.sroa.0118.i49.16..sroa.0118.i49.16..sroa.0118.i49.16..sroa.0118.16..sroa.0118.16..i68, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.oe = fmul <2 x double> %.sroa.0.8.vec.insert.i67, %13
  %i.of = insertelement <2 x double> poison, double %i.nn, i64 0
  %i.og = shufflevector <2 x double> %i.of, <2 x double> poison, <2 x i32> zeroinitializer
  %i.oh = fmul <2 x double> %.sroa.6.24.vec.insert.i64273, %i.og
  %i.oi = fadd <2 x double> %i.oh, %i.oe
  %i.oj = shufflevector <2 x double> %i.nu, <2 x double> poison, <2 x i32> zeroinitializer
  %14 = fmul <2 x double> %i.oj, %.sroa.9.56.vec.insert.i66.a
  %15 = fadd <2 x double> %14, %i.oi              ; 2 uses
  %16 = fmul double %i.nn, %.sroa.091.sroa.16.32.vec.extract
  %17 = fmul double %i.nq, 0.000000e+00
  %18 = fadd double %17, %16
  %19 = fmul double %.sroa.091.sroa.16.40.vec.extract, %12
  %20 = fsub double %18, %19
  %21 = insertelement <2 x double> poison, double %i.nk, i64 0
  %22 = shufflevector <2 x double> %21, <2 x double> poison, <2 x i32> zeroinitializer
  %23 = fmul <2 x double> %.sroa.0.8.vec.insert.i67, %22
  %i.ok = insertelement <2 x double> poison, double %i.no, i64 0
  %i.ol = shufflevector <2 x double> %i.ok, <2 x double> poison, <2 x i32> zeroinitializer
  %i.om = fmul <2 x double> %.sroa.6.24.vec.insert.i64273, %i.ol
  %24 = fadd <2 x double> %23, %i.om
  %25 = shufflevector <2 x double> %i.nv, <2 x double> poison, <2 x i32> zeroinitializer
  %i.on = fmul <2 x double> %25, %.sroa.9.56.vec.insert.i66.a
  %i.oo = fadd <2 x double> %24, %i.on            ; 2 uses
  %26 = fmul double %i.no, %.sroa.091.sroa.16.32.vec.extract
  %27 = fmul double %i.ns, 0.000000e+00
  %28 = fadd double %27, %26
  %29 = fmul double %i.nk, %.sroa.091.sroa.16.40.vec.extract
  %30 = fsub double %28, %29
  %.sroa.4.24.vec.insert.uncasted = shufflevector <2 x double> %i.nt, <2 x double> %4, <2 x i32> <i32 0, i32 2>
  %bc227 = bitcast <2 x double> %4 to <2 x i64>
  %.sroa.7.32.vec.insert190 = shufflevector <2 x i64> %bc227, <2 x i64> poison, <2 x i32> <i32 1, i32 poison>
  %31 = bitcast double %11 to i64
  %.sroa.7.40.vec.insert191 = insertelement <2 x i64> %.sroa.7.32.vec.insert190, i64 %31, i64 1
  %.sroa.12.72.vec.insert195.uncasted.a = shufflevector <2 x double> %i.nu, <2 x double> %15, <2 x i32> <i32 0, i32 2>
  %bc229 = bitcast <2 x double> %15 to <2 x i64>
  %.sroa.15.80.vec.insert197 = shufflevector <2 x i64> %bc229, <2 x i64> poison, <2 x i32> <i32 1, i32 poison>
  %32 = bitcast double %20 to i64
  %.sroa.15.88.vec.insert198 = insertelement <2 x i64> %.sroa.15.80.vec.insert197, i64 %32, i64 1
  %.sroa.20.120.vec.insert202.uncasted = shufflevector <2 x double> %i.nv, <2 x double> %i.oo, <2 x i32> <i32 0, i32 2>
  %bc231 = bitcast <2 x double> %i.oo to <2 x i64>
  %.sroa.23.128.vec.insert204 = shufflevector <2 x i64> %bc231, <2 x i64> poison, <2 x i32> <i32 1, i32 poison>
  %i.op = bitcast double %30 to i64
  ...
  %i.ov = fneg <2 x double> %.sroa.4.24.vec.insert.uncasted
  store <2 x double> %i.ov, ptr %i.ou, align 16, !tbaa !49
  %i.ow = getelementptr i8, ptr %i.os, i64 32
  %33 = xor <2 x i64> %.sroa.7.40.vec.insert191, splat (i64 -9223372036854775808)
  store <2 x i64> %33, ptr %i.ow, align 16, !tbaa !49
  ...
  %i.pa = fneg <2 x double> %.sroa.12.72.vec.insert195.uncasted.a
  store <2 x double> %i.pa, ptr %i.oz, align 16, !tbaa !49
  %i.pb = getelementptr i8, ptr %i.os, i64 80
  %34 = xor <2 x i64> %.sroa.15.88.vec.insert198, splat (i64 -9223372036854775808)
  store <2 x i64> %34, ptr %i.pb, align 16, !tbaa !49
