...
bb.a:
  ...
  %9 = load double, ptr %i.g, align 16, !tbaa !11, !noalias !207 ; 4 uses
  %10 = insertelement <2 x double> poison, double %9, i64 0
  %11 = insertelement <2 x double> %10, double %i.d, i64 1 ; 2 uses
  %12 = fmul <2 x double> %11, %11
  %13 = fadd <2 x double> %12, %i.k
  %14 = tail call <2 x double> @llvm.sqrt.v2f64(<2 x double> %13) ; 6 uses
  %15 = load double, ptr %i.n, align 8, !tbaa !11, !noalias !208 ; 4 uses
  ...
  %16 = fmul <2 x double> %i.ad, %i.ad
  %17 = insertelement <2 x double> %i.w, double %15, i64 1 ; 2 uses
  %i.ae = fmul <2 x double> %17, %17
  %18 = fadd <2 x double> %i.ae, %i.v
  %19 = tail call <2 x double> @llvm.sqrt.v2f64(<2 x double> %18) ; 5 uses
  %i.af = shufflevector <2 x double> %14, <2 x double> %19, <2 x i32> <i32 1, i32 2>
  ...
  %i.ak = insertelement <2 x double> %i.aj, double %9, i64 1
  ...
  %i.ao = insertelement <2 x double> %i.an, double %15, i64 1
  ...
  %i.au = insertelement <2 x double> poison, double %15, i64 0
  ...
  %20 = insertelement <2 x double> %i.b, double %i.d, i64 0
  %21 = fneg <2 x double> %20
  %22 = insertelement <2 x double> %i.f, double %9, i64 1
  %23 = fmul <2 x double> %22, %21
  %i.ay = shufflevector <2 x double> %i.f, <2 x double> %i.b, <2 x i32> <i32 1, i32 2>
  %i.az = insertelement <2 x double> poison, double %i.d, i64 0 ; 2 uses
  %i.ba = insertelement <2 x double> %i.az, double %9, i64 1
  %24 = shufflevector <2 x double> %23, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.bb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ay, <2 x double> %i.ba, <2 x double> %24) ; 3 uses
  ...
  %i.bg = fadd <2 x double> %16, %i.bf
  %i.bh = tail call <2 x double> @llvm.sqrt.v2f64(<2 x double> %i.bg) ; 3 uses
  %i.bi = shufflevector <2 x double> %i.bh, <2 x double> %14, <2 x i32> <i32 1, i32 2>
  ...
  %i.bq = shufflevector <2 x double> %19, <2 x double> %i.bh, <2 x i32> <i32 1, i32 2>
  ...
  %i.bw = insertelement <2 x double> %i.az, double %i.r, i64 1
  %i.bx = fmul <2 x double> %i.bw, %i.ag          ; 3 uses
  %i.by = insertelement <2 x double> %i.aj, double %15, i64 0
  ...
  store double %i.cr, ptr %5, align 16, !tbaa !11
  ...
  store <2 x double> %i.cz, ptr %6, align 8, !tbaa !11
  ...
  store <2 x double> %i.dg, ptr %7, align 8, !tbaa !11
  %i.dh = extractelement <2 x double> %i.cq, i64 0
  store double %i.dh, ptr %8, align 8, !tbaa !11
...
_ZN5Eigen10QuaternionIdLi0EEC2INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEEEERKNS_10MatrixBaseIT_EE.exit: ; preds = %bb.b, %bb.c
  ...
  %i.gw = fmul <2 x double> %19, %i.gv            ; 2 uses
  %i.gx = extractelement <2 x double> %14, i64 1
  ...
  %i.hc = fmul <2 x double> %14, %i.hb            ; 2 uses
