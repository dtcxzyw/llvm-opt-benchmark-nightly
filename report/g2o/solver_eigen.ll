...
bb.j:                                             ; preds = %.lr.ph145, %._crit_edge143
  ...
  %i.gc = getelementptr inbounds nuw i8, ptr %i.fk, i64 24 ; 2 uses
...
bb.k:                                             ; preds = %.lr.ph142, %._crit_edge
  ...
  %1 = load <1 x double>, ptr %i.fy, align 8
  %i.lm = shufflevector <1 x double> %1, <1 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  ...
  %2 = load <1 x double>, ptr %i.gc, align 8
  %3 = shufflevector <1 x double> %2, <1 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %4 = fmul <2 x double> %i.la, %3
  %5 = load <1 x double>, ptr %i.gb, align 8
  %i.ml = shufflevector <1 x double> %5, <1 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.mm = fmul <2 x double> %i.lf, %i.ml
  %i.mn = fadd <2 x double> %4, %i.mm
  %6 = load <1 x double>, ptr %i.fz, align 8
  %i.mo = shufflevector <1 x double> %6, <1 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.mp = fmul <2 x double> %i.ll, %i.mo
  %i.mq = fadd <2 x double> %i.mn, %i.mp          ; 6 uses
  %i.mr = fmul <2 x double> %i.lq, %3
  ...
  %7 = load <1 x double>, ptr %i.ig, align 8
  %i.nb = shufflevector <1 x double> %7, <1 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.nc = fmul <2 x double> %i.la, %i.nb
  %8 = load <2 x double>, ptr %i.fx, align 8      ; 2 uses
  %i.nd = shufflevector <2 x double> %8, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.ne = fmul <2 x double> %i.lf, %i.nd
  %i.nf = fadd <2 x double> %i.nc, %i.ne
  %9 = shufflevector <2 x double> %8, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 3 uses
  %i.ng = fmul <2 x double> %i.ll, %9
  %i.nh = fadd <2 x double> %i.ng, %i.nf          ; 6 uses
  %i.ni = fmul <2 x double> %i.lq, %i.nb
  %i.nj = fmul <2 x double> %i.lt, %i.nd
  %i.nk = fadd <2 x double> %i.ni, %i.nj
  %i.nl = fmul <2 x double> %i.lx, %9
  %i.nm = fadd <2 x double> %i.nl, %i.nk          ; 6 uses
  %i.nn = fmul <2 x double> %i.mb, %i.nb
  %i.no = fmul <2 x double> %i.me, %i.nd
  %i.np = fadd <2 x double> %i.nn, %i.no
  %i.nq = fmul <2 x double> %i.mi, %9
  %i.nr = fadd <2 x double> %i.nq, %i.np          ; 6 uses
