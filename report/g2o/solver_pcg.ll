...
vector.ph137:                                     ; preds = %vector.memcheck134
  %i.es = add i64 %i.ek, %n.vec138                ; 2 uses
  %i.et = getelementptr [8 x i8], ptr %1, i64 %i.ek
...
vector.body139:                                   ; preds = %vector.body139, %vector.ph137
  ...
  %i.eu = getelementptr inbounds nuw [8 x i8], ptr %i.em, i64 %index140 ; 2 uses
  %i.ev = getelementptr inbounds nuw i8, ptr %i.eu, i64 16
  %wide.load141 = load <2 x double>, ptr %i.eu, align 8, !tbaa !90
  %wide.load142 = load <2 x double>, ptr %i.ev, align 8, !tbaa !90
  %i.ew = getelementptr [8 x i8], ptr %i.et, i64 %index140 ; 2 uses
  %i.ex = getelementptr inbounds nuw i8, ptr %i.ew, i64 16
  store <2 x double> %wide.load141, ptr %i.ew, align 8, !tbaa !90
  store <2 x double> %wide.load142, ptr %i.ex, align 8, !tbaa !90
  %index.next143 = add nuw i64 %index140, 4       ; 2 uses
  %i.ey = icmp eq i64 %index.next143, %n.vec138
  br i1 %i.ey, label %middle.block144, label %vector.body139, !llvm.loop !1006
...
scalar.ph135.preheader:                           ; preds = %vector.memcheck134, %.lr.ph, %middle.block144
  ...
  %.380.ph = phi i64 [ %i.ek, %vector.memcheck134 ], [ %i.ek, %.lr.ph ], [ %i.es, %middle.block144 ] ; 2 uses
...
scalar.ph135.prol:                                ; preds = %scalar.ph135.preheader, %scalar.ph135.prol
  %.081.prol = phi i64 [ %i.fd, %scalar.ph135.prol ], [ %.081.ph, %scalar.ph135.preheader ] ; 2 uses
  %.380.prol = phi i64 [ %i.fc, %scalar.ph135.prol ], [ %.380.ph, %scalar.ph135.preheader ] ; 2 uses
  %prol.iter = phi i64 [ %prol.iter.next, %scalar.ph135.prol ], [ 0, %scalar.ph135.preheader ]
  %i.ez = getelementptr inbounds nuw [8 x i8], ptr %i.em, i64 %.081.prol
  %i.fa = load double, ptr %i.ez, align 8, !tbaa !90
  %i.fb = getelementptr inbounds [8 x i8], ptr %1, i64 %.380.prol
  store double %i.fa, ptr %i.fb, align 8, !tbaa !90
  %i.fc = add nsw i64 %.380.prol, 1               ; 3 uses
  %i.fd = add nuw nsw i64 %.081.prol, 1           ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter151
  br i1 %prol.iter.cmp.not, label %scalar.ph135.prol.loopexit, label %scalar.ph135.prol, !llvm.loop !1007

scalar.ph135.prol.loopexit:                       ; preds = %scalar.ph135.prol, %scalar.ph135.preheader
  %.lcssa148.unr = phi i64 [ poison, %scalar.ph135.preheader ], [ %i.fc, %scalar.ph135.prol ]
  %.081.unr = phi i64 [ %.081.ph, %scalar.ph135.preheader ], [ %i.fd, %scalar.ph135.prol ]
  %.380.unr = phi i64 [ %.380.ph, %scalar.ph135.preheader ], [ %i.fc, %scalar.ph135.prol ]
  %i.fe = sub nsw i64 %.081.ph, %3
  %i.ff = icmp ugt i64 %i.fe, -4
  br i1 %i.ff, label %._crit_edge, label %scalar.ph135

._crit_edge:                                      ; preds = %scalar.ph135.prol.loopexit, %scalar.ph135, %middle.block144
  %.lcssa = phi i64 [ %i.es, %middle.block144 ], [ %.lcssa148.unr, %scalar.ph135.prol.loopexit ], [ %i.ga, %scalar.ph135 ]
  %i.fg = add nsw i64 %i.ed, %.lcssa
  %i.fh = add nsw i64 %.04883, 1                  ; 2 uses
  %exitcond90.not = icmp eq i64 %i.fh, %4
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond90.not, label %._crit_edge85.split, label %.lr.ph, !llvm.loop !1008

scalar.ph135:                                     ; preds = %scalar.ph135.prol.loopexit, %scalar.ph135
  %.081 = phi i64 [ %i.gb, %scalar.ph135 ], [ %.081.unr, %scalar.ph135.prol.loopexit ] ; 5 uses
  %.380 = phi i64 [ %i.ga, %scalar.ph135 ], [ %.380.unr, %scalar.ph135.prol.loopexit ] ; 5 uses
  %i.fi = getelementptr inbounds nuw [8 x i8], ptr %i.em, i64 %.081
  %i.fj = load double, ptr %i.fi, align 8, !tbaa !90
  %i.fk = getelementptr inbounds [8 x i8], ptr %1, i64 %.380
  store double %i.fj, ptr %i.fk, align 8, !tbaa !90
  %i.fl = getelementptr inbounds nuw [8 x i8], ptr %i.em, i64 %.081
  %i.fm = getelementptr inbounds nuw i8, ptr %i.fl, i64 8
  %i.fn = load double, ptr %i.fm, align 8, !tbaa !90
  %i.fo = getelementptr [8 x i8], ptr %1, i64 %.380
  %i.fp = getelementptr i8, ptr %i.fo, i64 8
  store double %i.fn, ptr %i.fp, align 8, !tbaa !90
  %i.fq = getelementptr inbounds nuw [8 x i8], ptr %i.em, i64 %.081
  %i.fr = getelementptr inbounds nuw i8, ptr %i.fq, i64 16
  %i.fs = load double, ptr %i.fr, align 8, !tbaa !90
  %i.ft = getelementptr [8 x i8], ptr %1, i64 %.380
  %i.fu = getelementptr i8, ptr %i.ft, i64 16
  store double %i.fs, ptr %i.fu, align 8, !tbaa !90
  %i.fv = getelementptr inbounds nuw [8 x i8], ptr %i.em, i64 %.081
  %i.fw = getelementptr inbounds nuw i8, ptr %i.fv, i64 24
  %i.fx = load double, ptr %i.fw, align 8, !tbaa !90
  %i.fy = getelementptr [8 x i8], ptr %1, i64 %.380
  %i.fz = getelementptr i8, ptr %i.fy, i64 24
  store double %i.fx, ptr %i.fz, align 8, !tbaa !90
  %i.ga = add nsw i64 %.380, 4                    ; 2 uses
  %i.gb = add nuw nsw i64 %.081, 4                ; 2 uses
  %exitcond89.not.3 = icmp eq i64 %i.gb, %3
  br i1 %exitcond89.not.3, label %._crit_edge, label %scalar.ph135, !llvm.loop !1009
}
...
bb.a:
  ...
  tail call void asm sideeffect "#EIGEN PRODUCT PACK LHS", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1010
  %i.b = sdiv i64 %4, 4
...
.preheader64.us.new:                              ; preds = %.preheader64.us, %.preheader64.us.new
  ...
  %i.l = load ptr, ptr %2, align 8, !tbaa !589
  %i.m = load i64, ptr %i.j, align 8, !tbaa !591
  ...
  %i.q = load <2 x double>, ptr %i.p, align 1, !tbaa !17
  ...
  store <2 x double> %i.q, ptr %i.u, align 16, !tbaa !17
  %i.v = getelementptr i8, ptr %i.u, i64 16
  store <2 x double> %i.t, ptr %i.v, align 16, !tbaa !17
  %i.w = or disjoint i64 %.05466.us, 1
  %i.x = load ptr, ptr %2, align 8, !tbaa !589
  %i.y = load i64, ptr %i.j, align 8, !tbaa !591
...
.epil.preheader:                                  ; preds = %._crit_edge.us.unr-lcssa, %.preheader64.us
  ...
  %i.al = load ptr, ptr %2, align 8, !tbaa !589
  %i.am = load i64, ptr %i.j, align 8, !tbaa !591
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.unr-lcssa, %.epil.preheader
  ...
  br i1 %i.ay, label %.preheader64.us, label %.preheader63, !llvm.loop !1012
...
.preheader62.us.new:                              ; preds = %.preheader62.us, %.preheader62.us.new
  ...
  br i1 %niter130.ncmp.1, label %._crit_edge.us78.unr-lcssa, label %.preheader62.us.new, !llvm.loop !1013
...
._crit_edge:                                      ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  ...
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond98.not, label %._crit_edge86.split, label %.preheader, !llvm.loop !1017
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %exitcond97.not.3, label %._crit_edge, label %scalar.ph, !llvm.loop !1018
...
.loopexit670:                                     ; preds = %._crit_edge741.split.split.us.us.us, %._crit_edge741.split.split.us763, %._crit_edge741.split.us.us.us, %.preheader669
  ...
  br i1 %i.af, label %bb.b, label %._crit_edge773, !llvm.loop !1019
...
.preheader663.lr.ph.split:                        ; preds = %.preheader664
  ...
  %i.ak = load ptr, ptr %1, align 8, !tbaa !988   ; 2 uses
  %i.al = load i64, ptr %i.ai, align 8, !tbaa !990 ; 8 uses
...
.lr.ph781.us.us.new:                              ; preds = %.lr.ph781.us.us, %.lr.ph781.us.us.new
  ...
  %i.az = load <4 x double>, ptr %.0229778.us.us, align 8, !tbaa !90
  ...
  %i.bh = load double, ptr %i.bg, align 8, !tbaa !90
  %i.bi = load <4 x double>, ptr %i.be, align 8, !tbaa !90
...
.epil.preheader:                                  ; preds = %._crit_edge782.us.us.unr-lcssa, %.lr.ph781.us.us
  ...
  %i.bq = load double, ptr %i.bp, align 8, !tbaa !90
  %i.br = load <4 x double>, ptr %.0229778.us.us.epil.init, align 8, !tbaa !90
...
.lr.ph723.us.us.us:                               ; preds = %._crit_edge734.us.us.us, %.preheader667.us.us
  ...
  %i.cu = load ptr, ptr %1, align 8, !tbaa !988
  %i.cv = load i64, ptr %i.z, align 8, !tbaa !990
...
bb.c:                                             ; preds = %bb.c, %.lr.ph723.us.us.us
  ...
  %i.da = load <2 x double>, ptr %.0235719.us.us.us, align 16, !tbaa !17
  %i.db = getelementptr inbounds nuw i8, ptr %.0235719.us.us.us, i64 16
  %i.dc = load <2 x double>, ptr %i.db, align 16, !tbaa !17
  %i.dd = load double, ptr %.0234720.us.us.us, align 8, !tbaa !90
  ...
  %i.dl = load <2 x double>, ptr %i.dk, align 16, !tbaa !17
  %i.dm = getelementptr inbounds nuw i8, ptr %.0235719.us.us.us, i64 48
  %i.dn = load <2 x double>, ptr %i.dm, align 16, !tbaa !17
  %i.do = getelementptr inbounds nuw i8, ptr %.0234720.us.us.us, i64 8
  %i.dp = load double, ptr %i.do, align 8, !tbaa !90
  ...
  %i.dx = load <2 x double>, ptr %i.dw, align 16, !tbaa !17
  %i.dy = getelementptr inbounds nuw i8, ptr %.0235719.us.us.us, i64 80
  %i.dz = load <2 x double>, ptr %i.dy, align 16, !tbaa !17
  ...
  %i.ej = load <2 x double>, ptr %i.ei, align 16, !tbaa !17
  %i.ek = getelementptr inbounds nuw i8, ptr %.0235719.us.us.us, i64 112
  %i.el = load <2 x double>, ptr %i.ek, align 16, !tbaa !17
  %i.em = getelementptr inbounds nuw i8, ptr %.0234720.us.us.us, i64 24
  %i.en = load double, ptr %i.em, align 8, !tbaa !90
  ...
  %i.ev = load <2 x double>, ptr %i.eu, align 16, !tbaa !17
  %i.ew = getelementptr inbounds nuw i8, ptr %.0235719.us.us.us, i64 144
  %i.ex = load <2 x double>, ptr %i.ew, align 16, !tbaa !17
  ...
  %i.fh = load <2 x double>, ptr %i.fg, align 16, !tbaa !17
  %i.fi = getelementptr inbounds nuw i8, ptr %.0235719.us.us.us, i64 176
  %i.fj = load <2 x double>, ptr %i.fi, align 16, !tbaa !17
  ...
  %i.ft = load <2 x double>, ptr %i.fs, align 16, !tbaa !17
  %i.fu = getelementptr inbounds nuw i8, ptr %.0235719.us.us.us, i64 208
  %i.fv = load <2 x double>, ptr %i.fu, align 16, !tbaa !17
  ...
  %i.gf = load <2 x double>, ptr %i.ge, align 16, !tbaa !17
  %i.gg = getelementptr inbounds nuw i8, ptr %.0235719.us.us.us, i64 240
  %i.gh = load <2 x double>, ptr %i.gg, align 16, !tbaa !17
  %i.gi = getelementptr inbounds nuw i8, ptr %.0234720.us.us.us, i64 56
  %i.gj = load double, ptr %i.gi, align 8, !tbaa !90
  ...
  br i1 %i.gt, label %bb.c, label %..preheader665_crit_edge.us.us.us, !llvm.loop !1049
...
.lr.ph733.us.us.us:                               ; preds = %..preheader665_crit_edge.us.us.us, %.lr.ph733.us.us.us
  ...
  %i.gu = load <2 x double>, ptr %.1236730.us.us.us, align 16, !tbaa !17
  %i.gv = getelementptr inbounds nuw i8, ptr %.1236730.us.us.us, i64 16
  %i.gw = load <2 x double>, ptr %i.gv, align 16, !tbaa !17
  %i.gx = load double, ptr %.1731.us.us.us, align 8, !tbaa !90
  ...
  br i1 %i.hh, label %.lr.ph733.us.us.us, label %._crit_edge734.us.us.us, !llvm.loop !1053
...
begin_hunk_1_@_ZN5Eigen8internal11gebp_kernelIddlNS0_16blas_data_mapperIdlLi0ELi0ELi1EEELi4ELi4ELb0ELb0EEclERKS3_PKdS8_llldllll:bb.a
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1071
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1072
  %i.ub = getelementptr inbounds nuw i8, ptr %.0243679, i64 224
  %i.uc = load <2 x double>, ptr %i.ub, align 16, !tbaa !17 ; 4 uses
  %i.ud = getelementptr inbounds nuw i8, ptr %.0243679, i64 240
  %i.ue = load <2 x double>, ptr %i.ud, align 16, !tbaa !17 ; 4 uses
  %i.uf = getelementptr inbounds nuw i8, ptr %.0241680, i64 224
  %i.ug = load double, ptr %i.uf, align 1, !tbaa !17
  ...
  %i.uk = load double, ptr %i.uj, align 1, !tbaa !17
  ...
  %i.uo = load double, ptr %i.un, align 1, !tbaa !17
  ...
  %i.us = load double, ptr %i.ur, align 1, !tbaa !17
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1073
  ...
  tail call void asm sideeffect "#end gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1074
  %i.vn = add nuw nsw i64 %.0240681, 8            ; 2 uses
  %i.vo = icmp slt i64 %i.vn, %i.s
  br i1 %i.vo, label %.lr.ph, label %.preheader666, !llvm.loop !1075
...
._crit_edge:                                      ; preds = %.lr.ph702, %.preheader666
  ...
  %i.vp = load <2 x double>, ptr %i.jy, align 1, !tbaa !17
  %i.vq = getelementptr inbounds nuw i8, ptr %i.jy, i64 16 ; 2 uses
  %i.vr = load <2 x double>, ptr %i.vq, align 1, !tbaa !17
  %i.vs = load <2 x double>, ptr %i.ka, align 1, !tbaa !17
  %i.vt = getelementptr inbounds nuw i8, ptr %i.ka, i64 16 ; 2 uses
  %i.vu = load <2 x double>, ptr %i.vt, align 1, !tbaa !17
  ...
  store <2 x double> %i.vw, ptr %i.jy, align 1, !tbaa !17
  store <2 x double> %i.vy, ptr %i.vq, align 1, !tbaa !17
  store <2 x double> %i.wa, ptr %i.ka, align 1, !tbaa !17
  store <2 x double> %i.wc, ptr %i.vt, align 1, !tbaa !17
  %i.wd = load <2 x double>, ptr %i.kc, align 1, !tbaa !17
  %i.we = getelementptr inbounds nuw i8, ptr %i.kc, i64 16 ; 2 uses
  %i.wf = load <2 x double>, ptr %i.we, align 1, !tbaa !17
  %i.wg = load <2 x double>, ptr %i.ke, align 1, !tbaa !17
  %i.wh = getelementptr inbounds nuw i8, ptr %i.ke, i64 16 ; 2 uses
  %i.wi = load <2 x double>, ptr %i.wh, align 1, !tbaa !17
  ...
  store <2 x double> %i.wk, ptr %i.kc, align 1, !tbaa !17
  store <2 x double> %i.wm, ptr %i.we, align 1, !tbaa !17
  store <2 x double> %i.wo, ptr %i.ke, align 1, !tbaa !17
  store <2 x double> %i.wq, ptr %i.wh, align 1, !tbaa !17
  %i.wr = add nuw nsw i64 %.0245711, 4            ; 2 uses
  %i.ws = icmp slt i64 %i.wr, %.sroa.speculated
  br i1 %i.ws, label %bb.e, label %._crit_edge713, !llvm.loop !1076
...
.lr.ph702:                                        ; preds = %.preheader666, %.lr.ph702
  ...
  tail call void asm sideeffect "#begin step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1077
  %i.wt = load <2 x double>, ptr %.1244699, align 16, !tbaa !17 ; 4 uses
  %i.wu = getelementptr inbounds nuw i8, ptr %.1244699, i64 16
  %i.wv = load <2 x double>, ptr %i.wu, align 16, !tbaa !17 ; 4 uses
  %i.ww = load double, ptr %.1242700, align 1, !tbaa !17
  ...
  %i.xa = load double, ptr %i.wz, align 1, !tbaa !17
  ...
  %i.xe = load double, ptr %i.xd, align 1, !tbaa !17
  ...
  %i.xi = load double, ptr %i.xh, align 1, !tbaa !17
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 2pX4", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1078
  ...
  br i1 %i.ye, label %.lr.ph702, label %._crit_edge, !llvm.loop !1079
...
.preheader.lr.ph.split:                           ; preds = %.preheader662
  ...
  %i.yp = load ptr, ptr %1, align 8, !tbaa !988   ; 4 uses
  %i.yq = load i64, ptr %i.yn, align 8, !tbaa !990 ; 4 uses
...
bb.f:                                             ; preds = %bb.f, %.preheader.prol
  ...
  %i.yt = load double, ptr %gep811.prol, align 8, !tbaa !90
  %i.yu = call double @llvm.fmuladd.f64(double %7, double 0.000000e+00, double %i.yt)
  store double %i.yu, ptr %gep811.prol, align 8, !tbaa !90
  %i.yv = add nsw i64 %.0226807.prol, 1           ; 2 uses
  %14 = icmp slt i64 %i.yv, %4
  br i1 %14, label %bb.f, label %._crit_edge809.split.prol, !llvm.loop !1080
...
.lr.ph800.us.us.new:                              ; preds = %.lr.ph800.us.us, %.lr.ph800.us.us.new
  ...
  %i.zd = load double, ptr %i.zc, align 8, !tbaa !90
  %i.ze = getelementptr inbounds nuw [8 x i8], ptr %gep806.us, i64 %.0798.us.us
  %i.zf = load double, ptr %i.ze, align 8, !tbaa !90
  ...
  %i.zk = load double, ptr %i.zj, align 8, !tbaa !90
  %i.zl = getelementptr inbounds nuw [8 x i8], ptr %gep806.us, i64 %i.zi
  %i.zm = load double, ptr %i.zl, align 8, !tbaa !90
  ...
  %i.zr = load double, ptr %i.zq, align 8, !tbaa !90
  %i.zs = getelementptr inbounds nuw [8 x i8], ptr %gep806.us, i64 %i.zp
  %i.zt = load double, ptr %i.zs, align 8, !tbaa !90
  ...
  %i.zy = load double, ptr %i.zx, align 8, !tbaa !90
  %i.zz = getelementptr inbounds nuw [8 x i8], ptr %gep806.us, i64 %i.zw
  %i.aaa = load double, ptr %i.zz, align 8, !tbaa !90
  ...
  br i1 %niter992.ncmp.3, label %._crit_edge801.us.us.unr-lcssa, label %.lr.ph800.us.us.new, !llvm.loop !1081
...
bb.g:                                             ; preds = %bb.g, %.epil.preheader986
  ...
  %i.aaf = load double, ptr %i.aae, align 8, !tbaa !90
  %i.aag = getelementptr inbounds nuw [8 x i8], ptr %gep806.us, i64 %.0798.us.us.epil
  %i.aah = load double, ptr %i.aag, align 8, !tbaa !90
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge801.us.us, label %bb.g, !llvm.loop !1082
...
._crit_edge801.us.us:                             ; preds = %bb.g, %._crit_edge801.us.us.unr-lcssa
  ...
  %i.aal = load double, ptr %gep811.us.us, align 8, !tbaa !90
  %i.aam = call double @llvm.fmuladd.f64(double %7, double %.lcssa, double %i.aal)
  store double %i.aam, ptr %gep811.us.us, align 8, !tbaa !90
  %i.aan = add nsw i64 %.0226807.us.us, 1         ; 2 uses
  %15 = icmp slt i64 %i.aan, %4
  br i1 %15, label %.lr.ph800.us.us, label %._crit_edge809.split.us.us, !llvm.loop !1080
...
._crit_edge809.split.us.us:                       ; preds = %._crit_edge801.us.us
  ...
  br i1 %exitcond856.not.a, label %.loopexit, label %.preheader.us, !llvm.loop !1083

._crit_edge791.split:                             ; preds = %bb.h
  %i.aap = add nuw nsw i64 %.0231792, 4           ; 2 uses
  %i.aaq = icmp slt i64 %i.aap, %i.d
  br i1 %i.aaq, label %.preheader663, label %.preheader662, !llvm.loop !1022
...
bb.i:                                             ; preds = %bb.i, %._crit_edge809.split
  ...
  %i.abk = load double, ptr %gep811.1, align 8, !tbaa !90
  %i.abl = call double @llvm.fmuladd.f64(double %7, double 0.000000e+00, double %i.abk)
  store double %i.abl, ptr %gep811.1, align 8, !tbaa !90
  %i.abm = add nsw i64 %.0226807.1, 1             ; 2 uses
  %17 = icmp slt i64 %i.abm, %4
  br i1 %17, label %bb.i, label %._crit_edge809.split.1, !llvm.loop !1080

._crit_edge809.split.1:                           ; preds = %bb.i
  %i.abn = add nsw i64 %.0227812, 2               ; 2 uses
  %exitcond854.not.1 = icmp eq i64 %i.abn, %6
  br i1 %exitcond854.not.1, label %.loopexit, label %.preheader, !llvm.loop !1083
...
bb.j:                                             ; preds = %.preheader, %bb.j
  ...
  %i.abp = load double, ptr %gep811, align 8, !tbaa !90
  %i.abq = call double @llvm.fmuladd.f64(double %7, double 0.000000e+00, double %i.abp)
  store double %i.abq, ptr %gep811, align 8, !tbaa !90
  %i.abr = add nsw i64 %.0226807, 1               ; 2 uses
  %18 = icmp slt i64 %i.abr, %4
  br i1 %18, label %bb.j, label %._crit_edge809.split, !llvm.loop !1080
...
bb.b:                                             ; preds = %.lr.ph356, %._crit_edge350
  ...
  %i.l = load ptr, ptr %1, align 8, !tbaa !988
  %i.m = load i64, ptr %i.c, align 8, !tbaa !990  ; 4 uses
...
.lr.ph:                                           ; preds = %bb.b, %.lr.ph
  ...
  tail call void asm sideeffect "#begin gebp micro kernel 1/half/quarterX4", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1084
  %i.am = getelementptr inbounds nuw i8, ptr %.0122330, i64 384
  tail call void @llvm.prefetch.p0(ptr nonnull %i.am, i32 0, i32 3, i32 1)
  tail call void asm sideeffect "#begin step of gebp micro kernel 1X4", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1085
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1086
  %i.an = load <2 x double>, ptr %.0124329, align 16, !tbaa !17 ; 4 uses
  %i.ao = load double, ptr %.0122330, align 1, !tbaa !17
  ...
  %i.as = load double, ptr %i.ar, align 1, !tbaa !17
  ...
  %i.aw = load double, ptr %i.av, align 1, !tbaa !17
  ...
  %i.ba = load double, ptr %i.az, align 1, !tbaa !17
  ...
  tail call void asm sideeffect "#end step of gebp micro kernel 1X4", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1087
  tail call void asm sideeffect "#begin step of gebp micro kernel 1X4", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1085
  tail call void asm sideeffect "#Note: these asm comments work around bug 935!", "~{dirflag},~{fpsr},~{flags}"() #35, !srcloc !1086
  %i.bl = getelementptr inbounds nuw i8, ptr %.0124329, i64 16
  %i.bm = load <2 x double>, ptr %i.bl, align 16, !tbaa !17 ; 4 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %.0122330, i64 32
  %i.bo = load double, ptr %i.bn, align 1, !tbaa !17
  ...
  %i.bs = load double, ptr %i.br, align 1, !tbaa !17
  ...
  %i.bw = load double, ptr %i.bv, align 1, !tbaa !17
  ...
  %i.ca = load double, ptr %i.bz, align 1, !tbaa !17
  ...
  %i.cm = load <2 x double>, ptr %i.cl, align 16, !tbaa !17 ; 4 uses
  %i.cn = getelementptr inbounds nuw i8, ptr %.0122330, i64 64
  %i.co = load double, ptr %i.cn, align 1, !tbaa !17
  ...
  %i.cs = load double, ptr %i.cr, align 1, !tbaa !17
  ...
  %i.cw = load double, ptr %i.cv, align 1, !tbaa !17
  ...
  %i.da = load double, ptr %i.cz, align 1, !tbaa !17
  ...
  %i.dm = load <2 x double>, ptr %i.dl, align 16, !tbaa !17 ; 4 uses
