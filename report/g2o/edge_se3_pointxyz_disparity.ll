...
bb.a:
  ...
  %1 = getelementptr inbounds nuw i8, ptr %i.g, i64 480
  %i.ae = getelementptr inbounds nuw i8, ptr %i.g, i64 512
  %2 = getelementptr inbounds nuw i8, ptr %i.g, i64 544
  %i.af = getelementptr inbounds nuw i8, ptr %i.g, i64 576
  %3 = load double, ptr %i.af, align 16, !tbaa !64, !noalias !146
  %4 = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 1
  %5 = fmul double %4, %3
  %6 = load double, ptr %1, align 16, !tbaa !64, !noalias !146
  %7 = extractelement <2 x double> %i.i, i64 0
  %8 = fmul double %7, %6
  %9 = load double, ptr %i.ae, align 16, !tbaa !64, !noalias !146
  %10 = extractelement <2 x double> %.sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i, i64 0
  %11 = fmul double %10, %9
  %12 = fadd double %8, %11
  %13 = load double, ptr %2, align 16, !tbaa !64, !noalias !146
  %14 = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 0
  %15 = fmul double %14, %13
  %16 = fadd double %12, %15
  %.sroa.4.16.vec.extract.i.i = fadd double %5, %16 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0.i.i)
  %.sroa.512.24.vec.insert.i.i.i.i.i.i.i.i.i = insertelement <2 x double> poison, double %.sroa.4.16.vec.extract.i.i, i64 0
  %i.ag = shufflevector <2 x double> %.sroa.512.24.vec.insert.i.i.i.i.i.i.i.i.i, <2 x double> poison, <2 x i32> zeroinitializer
...
bb.a:
  ...
  %4 = getelementptr inbounds nuw i8, ptr %i.g, i64 352 ; 2 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %i.g, i64 384 ; 2 uses
  %5 = getelementptr inbounds nuw i8, ptr %i.g, i64 416 ; 2 uses
  %i.af = getelementptr inbounds nuw i8, ptr %i.g, i64 448
  %6 = load double, ptr %i.af, align 16, !tbaa !64, !noalias !151
  ...
  %8 = fmul double %7, %6
  %9 = load double, ptr %4, align 16, !tbaa !64, !noalias !151
  %10 = extractelement <2 x double> %i.i, i64 0
  %11 = fmul double %10, %9
  %12 = load double, ptr %i.ae, align 16, !tbaa !64, !noalias !151
  ...
  %16 = load double, ptr %5, align 16, !tbaa !64, !noalias !151
  ...
  %i.as = load double, ptr %4, align 16, !tbaa !70
  ...
  %i.aw = load double, ptr %i.ae, align 16, !tbaa !70
  ...
  %i.ba = load double, ptr %5, align 16, !tbaa !70
  ...
  %21 = getelementptr inbounds nuw i8, ptr %i.bf, i64 480
  %i.cc = getelementptr inbounds nuw i8, ptr %i.bf, i64 512
  %22 = getelementptr inbounds nuw i8, ptr %i.bf, i64 544
  %i.cd = getelementptr inbounds nuw i8, ptr %i.bf, i64 576
  %23 = load double, ptr %i.cd, align 16, !tbaa !64, !noalias !156
  %24 = extractelement <2 x double> %.sroa.0.i.i4.16..sroa.0.i.i4.16..sroa.0.i.i4.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i9, i64 1
  %25 = fmul double %24, %23
  %26 = load double, ptr %21, align 16, !tbaa !64, !noalias !156
  %27 = extractelement <2 x double> %i.bh, i64 0
  %28 = fmul double %27, %26
  %29 = load double, ptr %i.cc, align 16, !tbaa !64, !noalias !156
  %30 = extractelement <2 x double> %.sroa.0.i.i4.8..sroa.0.i.i4.8..sroa.0.i.i4.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i8, i64 0
  %31 = fmul double %30, %29
  %32 = fadd double %28, %31
  %33 = load double, ptr %22, align 16, !tbaa !64, !noalias !156
  %34 = extractelement <2 x double> %.sroa.0.i.i4.16..sroa.0.i.i4.16..sroa.0.i.i4.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i9, i64 0
  %35 = fmul double %34, %33
  %36 = fadd double %32, %35
  %.sroa.4.16.vec.extract.i.i10 = fadd double %25, %36 ; 3 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0.i.i4)
  %37 = fmul double %.sroa.4.16.vec.extract.i.i10, %.sroa.4.16.vec.extract.i.i10
  %i.ce = getelementptr inbounds nuw i8, ptr %3, i64 16
  %.sroa.11100.88.vec.insert = insertelement <2 x double> poison, double %.sroa.4.16.vec.extract.i.i10, i64 0
  %i.cf = load <2 x double>, ptr %3, align 16, !tbaa !64
  %i.cg = shufflevector <2 x double> %.sroa.11100.88.vec.insert, <2 x double> poison, <2 x i32> zeroinitializer ; 9 uses
  ...
  %i.fh = shufflevector <2 x double> %38, <2 x double> poison, <2 x i32> zeroinitializer
...
bb.a:
  ...
  %2 = getelementptr inbounds nuw i8, ptr %i.g, i64 544
  %i.af = getelementptr inbounds nuw i8, ptr %i.g, i64 576
  %3 = load double, ptr %i.af, align 16, !tbaa !64, !noalias !167
  %4 = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 1
  %5 = fmul double %4, %3
  %6 = load double, ptr %1, align 16, !tbaa !64, !noalias !167
  %7 = extractelement <2 x double> %i.i, i64 0
  %8 = fmul double %7, %6
  %9 = load double, ptr %i.ae, align 16, !tbaa !64, !noalias !167
  %10 = extractelement <2 x double> %.sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i, i64 0
  %11 = fmul double %10, %9
  %12 = fadd double %8, %11
  %13 = load double, ptr %2, align 16, !tbaa !64, !noalias !167
  %14 = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 0
  %15 = fmul double %14, %13
  %16 = fadd double %12, %15
  %.sroa.4.16.vec.extract.i.i = fadd double %5, %16 ; 2 uses
...
bb.a:
  ...
  %3 = load double, ptr %i.bp, align 16, !tbaa !64, !noalias !172
  %i.bq = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 1
  %i.br = fmul double %i.bq, %3
  %4 = load double, ptr %i.bm, align 16, !tbaa !64, !noalias !172
  %i.bs = extractelement <2 x double> %i.ad, i64 0
  %i.bt = fmul double %i.bs, %4
  %5 = load double, ptr %i.bn, align 16, !tbaa !64, !noalias !172
  %i.bu = extractelement <2 x double> %.sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i, i64 0
  %i.bv = fmul double %i.bu, %5
  %i.bw = fadd double %i.bt, %i.bv
  %6 = load double, ptr %i.bo, align 16, !tbaa !64, !noalias !172
  %i.bx = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 0
  %i.by = fmul double %i.bx, %6
  ...
  %7 = load double, ptr %i.cv, align 16, !tbaa !64, !noalias !177
  %i.cw = extractelement <2 x double> %.sroa.0.i.i5.16..sroa.0.i.i5.16..sroa.0.i.i5.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i10, i64 1
  %i.cx = fmul double %i.cw, %7
  %8 = load double, ptr %i.cs, align 16, !tbaa !64, !noalias !177
  %i.cy = extractelement <2 x double> %i.bl, i64 0
  %i.cz = fmul double %i.cy, %8
  %9 = load double, ptr %i.ct, align 16, !tbaa !64, !noalias !177
  %i.da = extractelement <2 x double> %.sroa.0.i.i5.8..sroa.0.i.i5.8..sroa.0.i.i5.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i9, i64 0
  %i.db = fmul double %i.da, %9
  %i.dc = fadd double %i.cz, %i.db
  %10 = load double, ptr %i.cu, align 16, !tbaa !64, !noalias !177
  %i.dd = extractelement <2 x double> %.sroa.0.i.i5.16..sroa.0.i.i5.16..sroa.0.i.i5.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i10, i64 0
  %i.de = fmul double %i.dd, %10
