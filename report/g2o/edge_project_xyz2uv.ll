...
_ZNK3g2o16OptimizableGraph4Edge9parameterEi.exit: ; preds = %bb.a
  ...
  %.sroa.0.sroa.4.8.vec.insert = insertelement <2 x double> poison, double %i.cb, i64 0
  %2 = fadd double %i.br, %i.bw
  %i.cc = fsub double 1.000000e+00, %2
  %3 = fsub double %i.bv, %i.bo
  ...
  %i.cu = shufflevector <2 x double> %.sroa.0.sroa.4.8.vec.insert, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %4 = insertelement <2 x double> poison, double %i.cd, i64 0
  %i.da = shufflevector <2 x double> %4, <2 x double> poison, <2 x i32> zeroinitializer
  %i.db = fmul <2 x double> %i.da, %i.cz
  %i.dc = fadd <2 x double> %i.cw, %i.db
  %5 = insertelement <2 x double> poison, double %i.bz, i64 0
  %i.dd = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> zeroinitializer
  %i.de = fmul <2 x double> %i.dd, %i.cn
  %6 = insertelement <2 x double> poison, double %i.cc, i64 0
  %i.df = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dg = fmul <2 x double> %i.df, %i.ct
  %i.dh = fadd <2 x double> %i.de, %i.dg
  %7 = insertelement <2 x double> poison, double %i.ce, i64 0
  %i.di = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dj = fmul <2 x double> %i.di, %i.cz
  %i.dk = fadd <2 x double> %i.dh, %i.dj
  %8 = insertelement <2 x double> poison, double %i.ca, i64 0
  %i.dl = shufflevector <2 x double> %8, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dm = fmul <2 x double> %i.dl, %i.cn
  %9 = insertelement <2 x double> poison, double %3, i64 0
  %i.dn = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> zeroinitializer
  %i.do = fmul <2 x double> %i.dn, %i.ct
  ...
  %i.ds = fmul <2 x double> %i.dr, %i.cz
