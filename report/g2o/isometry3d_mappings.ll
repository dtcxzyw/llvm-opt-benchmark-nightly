...
bb.c:                                             ; preds = %bb.a
  %i.ae = fcmp ogt double %i.c, %i.a              ; 3 uses
  ...
  %i.ai = fcmp ogt double %i.e, %i.ah             ; 2 uses
  %.1.i.i.i = select i1 %i.ai, i64 2, i64 %spec.select.i.i.i ; 3 uses
  %3 = select i1 %i.ae, i64 2, i64 1
  %i.aj = select i1 %i.ai, i64 0, i64 %3
  %.fr.i.i.i = freeze i64 %i.aj                   ; 5 uses
  %.cmp.inv.i.i.i = icmp samesign ugt i64 %.fr.i.i.i, 1
  %.v.i.i.i = select i1 %.cmp.inv.i.i.i, i64 -2, i64 1
  %4 = add nsw i64 %.v.i.i.i, %.fr.i.i.i          ; 3 uses
  ...
  %i.ar = getelementptr [8 x i8], ptr %1, i64 %4  ; 3 uses
  %.idx.i68.i.i.i = mul nsw i64 %4, 24            ; 3 uses
  ...
  %i.bn = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %.fr.i.i.i
  ...
  %i.bu = getelementptr inbounds [8 x i8], ptr %2, i64 %4
...
bb.c:                                             ; preds = %bb.a
  %i.af = fcmp ogt double %i.c, %i.a              ; 3 uses
  ...
  %i.aj = fcmp ogt double %i.e, %i.ai             ; 2 uses
  %.1.i.i.i = select i1 %i.aj, i64 2, i64 %spec.select.i.i.i ; 3 uses
  %3 = select i1 %i.af, i64 2, i64 1
  %i.ak = select i1 %i.aj, i64 0, i64 %3
  ...
  %i.as = getelementptr [8 x i8], ptr %1, i64 %4  ; 3 uses
  %.idx.i68.i.i.i = mul nsw i64 %4, 24            ; 3 uses
  ...
  %i.bo = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %.fr.i.i.i
  ...
  %i.bv = getelementptr inbounds [8 x i8], ptr %2, i64 %4
...
bb.c:                                             ; preds = %bb.a
  %i.ak = fcmp ogt double %i.r, %i.q              ; 4 uses
  ...
  %i.an = fcmp ogt double %i.p, %i.am             ; 2 uses
  %.1.i.i.i.i = select i1 %i.an, i64 2, i64 %spec.select.i.i.i.i ; 3 uses
  %4 = select i1 %i.ak, i64 2, i64 1
  %i.ao = select i1 %i.an, i64 0, i64 %4
  %.fr.i.i.i.i = freeze i64 %i.ao                 ; 5 uses
  %.cmp.inv.i.i.i.i = icmp samesign ugt i64 %.fr.i.i.i.i, 1
  %.v.i.i.i.i = select i1 %.cmp.inv.i.i.i.i, i64 -2, i64 1
  %5 = add nsw i64 %.v.i.i.i.i, %.fr.i.i.i.i      ; 3 uses
  ...
  %i.av = fsub double %i.ar, %i.au
  %i.aw = getelementptr [8 x i8], ptr %3, i64 %5  ; 3 uses
  %.idx.i68.i.i.i.i = mul nsw i64 %5, 24          ; 3 uses
  ...
  %i.bs = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %.fr.i.i.i.i
  ...
  %i.bz = getelementptr inbounds [8 x i8], ptr %2, i64 %5
...
bb.c:                                             ; preds = %bb.a
  %i.ah = fcmp ogt double %i.c, %i.a              ; 3 uses
  ...
  %i.al = fcmp ogt double %i.e, %i.ak             ; 2 uses
  %.1.i.i.i = select i1 %i.al, i64 2, i64 %spec.select.i.i.i ; 5 uses
  %3 = select i1 %i.ah, i64 2, i64 1
  %i.am = select i1 %i.al, i64 0, i64 %3
  %.fr.i.i.i = freeze i64 %i.am                   ; 7 uses
  %.cmp.inv.i.i.i = icmp samesign ugt i64 %.fr.i.i.i, 1
  %.v.i.i.i = select i1 %.cmp.inv.i.i.i, i64 -2, i64 1
  %4 = add nsw i64 %.v.i.i.i, %.fr.i.i.i          ; 5 uses
  ...
  %.idx.i48.i.i.i = shl nsw i64 %4, 5
  %i.au = getelementptr i8, ptr %1, i64 %.idx.i48.i.i.i ; 3 uses
  %i.av = getelementptr [8 x i8], ptr %i.au, i64 %4
  ...
  %i.bd = getelementptr [8 x i8], ptr %i.aq, i64 %4
  %i.be = load double, ptr %i.bd, align 8, !tbaa !10
  ...
  %i.bq = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %.fr.i.i.i
  store double %i.bp, ptr %i.bq, align 8, !tbaa !10
  %i.br = getelementptr [8 x i8], ptr %i.an, i64 %4
  %i.bs = load double, ptr %i.br, align 8, !tbaa !10
  ...
  %i.bx = getelementptr inbounds [8 x i8], ptr %2, i64 %4
...
bb.c:                                             ; preds = %bb.a
  %i.ao = fcmp ogt double %i.v, %i.u              ; 4 uses
  ...
  %i.aq = load double, ptr %i.ap, align 8, !tbaa !10
  %i.ar = fcmp ogt double %i.p, %i.aq             ; 2 uses
  %.1.i.i.i.i = select i1 %i.ar, i64 2, i64 %spec.select.i.i.i.i ; 3 uses
  %3 = select i1 %i.ao, i64 2, i64 1
  %i.as = select i1 %i.ar, i64 0, i64 %3
  %.fr.i.i.i.i = freeze i64 %i.as                 ; 5 uses
  %.cmp.inv.i.i.i.i = icmp samesign ugt i64 %.fr.i.i.i.i, 1
  %.v.i.i.i.i = select i1 %.cmp.inv.i.i.i.i, i64 -2, i64 1
  %4 = add nsw i64 %.v.i.i.i.i, %.fr.i.i.i.i      ; 3 uses
  ...
  %i.az = fsub double %i.av, %i.ay
  %i.ba = getelementptr [8 x i8], ptr %2, i64 %4  ; 3 uses
  %.idx.i68.i.i.i.i = mul nsw i64 %4, 24          ; 3 uses
  ...
  %i.bw = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %.fr.i.i.i.i
  ...
  %i.cd = getelementptr inbounds [8 x i8], ptr %0, i64 %4
