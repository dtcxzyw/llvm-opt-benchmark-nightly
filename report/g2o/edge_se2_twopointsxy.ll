...
bb.b:                                             ; preds = %.lr.ph, %bb.d
  ...
  %.sroa.022.027 = phi ptr [ %i.i, %.lr.ph ], [ %i.u, %bb.d ] ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.t = icmp ne i32 %i.s, %i.q
  %spec.select = select i1 %i.t, i1 %.029, i1 false
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %.111 = phi i1 [ %.01028, %bb.c ], [ false, %bb.b ] ; 2 uses
  %.1 = phi i1 [ %spec.select, %bb.c ], [ %.029, %bb.b ] ; 3 uses
  %i.u = tail call noundef ptr @_ZSt18_Rb_tree_incrementPKSt18_Rb_tree_node_base(ptr noundef nonnull %.sroa.022.027) #30 ; 2 uses
...
.split:                                           ; preds = %bb.a, %._crit_edge
  ...
  %3 = load double, ptr %i.v, align 16, !tbaa !61
  %.sroa.019.0.vec.insert = insertelement <2 x double> poison, double %3, i64 0
  %4 = load double, ptr %i.w, align 8, !tbaa !61
  %i.x = getelementptr inbounds nuw i8, ptr %i.c, i64 176
  %i.y = getelementptr inbounds nuw i8, ptr %i.c, i64 192
  %i.z = load double, ptr %i.x, align 8, !tbaa !44, !noalias !117 ; 2 uses
  %i.aa = tail call double @sin(double noundef %i.z) #29, !noalias !117 ; 2 uses
  %i.ab = tail call double @cos(double noundef %i.z) #29, !noalias !117 ; 2 uses
  %i.ac = fneg double %i.aa
  %.sroa.0.0.vec.insert.i.i = insertelement <2 x double> poison, double %i.ab, i64 0
  %.sroa.0.8.vec.insert.i.i = insertelement <2 x double> %.sroa.0.0.vec.insert.i.i, double %i.aa, i64 1
  %.sroa.5.16.vec.insert.i.i = insertelement <2 x double> poison, double %i.ac, i64 0
  %.sroa.5.24.vec.insert.i.i = insertelement <2 x double> %.sroa.5.16.vec.insert.i.i, double %i.ab, i64 1
  %i.ad = shufflevector <2 x double> %.sroa.019.0.vec.insert, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ae = fmul <2 x double> %i.ad, %.sroa.0.8.vec.insert.i.i
  %5 = insertelement <2 x double> poison, double %4, i64 0
  %i.af = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ag = fmul <2 x double> %i.af, %.sroa.5.24.vec.insert.i.i
  %i.ah = fadd <2 x double> %i.ag, %i.ae
  %i.ai = load <2 x double>, ptr %i.y, align 16, !tbaa !124, !noalias !125
  %i.aj = fadd <2 x double> %i.ai, %i.ah
  %i.ak = getelementptr inbounds nuw i8, ptr %i.e, i64 160
  store <2 x double> %i.aj, ptr %i.ak, align 16, !tbaa !124
  %i.al = load ptr, ptr %i.e, align 16, !tbaa !39
  %i.am = getelementptr inbounds nuw i8, ptr %i.al, i64 216
  %i.an = load ptr, ptr %i.am, align 8
  tail call void %i.an(ptr noundef nonnull align 16 dereferenceable(200) %i.e), !inline_history !126
...
bb.f:                                             ; preds = %.split, %bb.e
  ...
  %6 = load double, ptr %i.ao, align 16, !tbaa !61
  %.sroa.016.0.vec.insert = insertelement <2 x double> poison, double %6, i64 0
  %7 = load double, ptr %i.ap, align 8, !tbaa !61
  %i.aq = getelementptr inbounds nuw i8, ptr %i.c, i64 176
  %i.ar = getelementptr inbounds nuw i8, ptr %i.c, i64 192
  %i.as = load double, ptr %i.aq, align 8, !tbaa !44, !noalias !127 ; 2 uses
  %i.at = tail call double @sin(double noundef %i.as) #29, !noalias !127 ; 2 uses
  %i.au = tail call double @cos(double noundef %i.as) #29, !noalias !127 ; 2 uses
  %i.av = fneg double %i.at
  %.sroa.0.0.vec.insert.i.i12 = insertelement <2 x double> poison, double %i.au, i64 0
  %.sroa.0.8.vec.insert.i.i13 = insertelement <2 x double> %.sroa.0.0.vec.insert.i.i12, double %i.at, i64 1
  %.sroa.5.16.vec.insert.i.i14 = insertelement <2 x double> poison, double %i.av, i64 0
  %.sroa.5.24.vec.insert.i.i15 = insertelement <2 x double> %.sroa.5.16.vec.insert.i.i14, double %i.au, i64 1
  %i.aw = shufflevector <2 x double> %.sroa.016.0.vec.insert, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ax = fmul <2 x double> %i.aw, %.sroa.0.8.vec.insert.i.i13
  %8 = insertelement <2 x double> poison, double %7, i64 0
  %i.ay = shufflevector <2 x double> %8, <2 x double> poison, <2 x i32> zeroinitializer
  %i.az = fmul <2 x double> %i.ay, %.sroa.5.24.vec.insert.i.i15
  %i.ba = fadd <2 x double> %i.az, %i.ax
  %i.bb = load <2 x double>, ptr %i.ar, align 16, !tbaa !124, !noalias !134
  %i.bc = fadd <2 x double> %i.bb, %i.ba
  %i.bd = getelementptr inbounds nuw i8, ptr %i.g, i64 160
  store <2 x double> %i.bc, ptr %i.bd, align 16, !tbaa !124
  %i.be = load ptr, ptr %i.g, align 16, !tbaa !39
  %i.bf = getelementptr inbounds nuw i8, ptr %i.be, i64 216
  %i.bg = load ptr, ptr %i.bf, align 8
  tail call void %i.bg(ptr noundef nonnull align 16 dereferenceable(200) %i.g), !inline_history !126
  br label %bb.g
...
define linkonce_odr void @_ZN3g2o21BaseVariableSizedEdgeILi4EN5Eigen6MatrixIdLi4ELi1ELi0ELi4ELi1EEEED2Ev(ptr noundef nonnull align 16 dead_on_return(416) dereferenceable(416) %0) unnamed_addr #5 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 232) (i8, ptr @_ZTVN3g2o21BaseVariableSizedEdgeILi4EN5Eigen6MatrixIdLi4ELi1ELi0ELi4ELi1EEEEE, i64 16), ptr %0, align 16, !tbaa !39
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 40
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVN3g2o21BaseVariableSizedEdgeILi4EN5Eigen6MatrixIdLi4ELi1ELi0ELi4ELi1EEEEE, i64 264), ptr %i.a, align 8, !tbaa !39
...
_ZNSt6vectorIN5Eigen3MapINS0_6MatrixIdLin1ELin1ELi0ELin1ELin1EEELi0ENS0_6StrideILi0ELi0EEEEESaIS6_EED2Ev.exit: ; preds = %bb.a, %bb.b
  ...
  %i.j = load ptr, ptr %i.i, align 16, !tbaa !185 ; 3 uses
  %.not.i.i.i1 = icmp eq ptr %i.j, null
  br i1 %.not.i.i.i1, label %_ZNSt6vectorIN3g2o21BaseVariableSizedEdgeILi4EN5Eigen6MatrixIdLi4ELi1ELi0ELi4ELi1EEEE13HessianHelperESaIS6_EED2Ev.exit, label %bb.c
...
bb.c:                                             ; preds = %_ZNSt6vectorIN5Eigen3MapINS0_6MatrixIdLin1ELin1ELi0ELin1ELin1EEELi0ENS0_6StrideILi0ELi0EEEEESaIS6_EED2Ev.exit
  ...
  %i.l = load ptr, ptr %i.k, align 16, !tbaa !188
...
_ZNSt6vectorIN3g2o21BaseVariableSizedEdgeILi4EN5Eigen6MatrixIdLi4ELi1ELi0ELi4ELi1EEEE13HessianHelperESaIS6_EED2Ev.exit: ; preds = %_ZNSt6vectorIN5Eigen3MapINS0_6MatrixIdLin1ELin1ELi0ELin1ELin1EEELi0ENS0_6StrideILi0ELi0EEEEESaIS6_EED2Ev.exit, %bb.c
  tail call void @_ZN3g2o16OptimizableGraph4EdgeD2Ev(ptr noundef nonnull align 16 dead_on_return(368) dereferenceable(368) %0) #29
  ret void
}

; Function Attrs: inlinehint mustprogress nounwind uwtable
define linkonce_odr void @_ZN3g2o18EdgeSE2TwoPointsXYD0Ev(ptr noundef nonnull align 16 dereferenceable(416) %0) unnamed_addr #5 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 232) (i8, ptr @_ZTVN3g2o21BaseVariableSizedEdgeILi4EN5Eigen6MatrixIdLi4ELi1ELi0ELi4ELi1EEEEE, i64 16), ptr %0, align 16, !tbaa !39
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 40
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVN3g2o21BaseVariableSizedEdgeILi4EN5Eigen6MatrixIdLi4ELi1ELi0ELi4ELi1EEEEE, i64 264), ptr %i.a, align 8, !tbaa !39
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = ptrtoint ptr %i.c to i64
  %i.h = sub i64 %i.f, %i.g
  tail call void @_ZdlPvm(ptr noundef nonnull %i.c, i64 noundef %i.h) #31, !inline_history !189
