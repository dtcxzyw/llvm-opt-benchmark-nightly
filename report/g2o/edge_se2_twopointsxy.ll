...
.split:                                           ; preds = %bb.a, %._crit_edge
  ...
  %3 = load <1 x double>, ptr %i.v, align 16
  %4 = load <1 x double>, ptr %i.w, align 8
  ...
  %i.ad = shufflevector <1 x double> %3, <1 x double> poison, <2 x i32> zeroinitializer
  %i.ae = fmul <2 x double> %i.ad, %.sroa.0.8.vec.insert.i.i
  %i.af = shufflevector <1 x double> %4, <1 x double> poison, <2 x i32> zeroinitializer
...
bb.f:                                             ; preds = %.split, %bb.e
  ...
  %5 = load <1 x double>, ptr %i.ao, align 16
  %6 = load <1 x double>, ptr %i.ap, align 8
  ...
  %i.aw = shufflevector <1 x double> %5, <1 x double> poison, <2 x i32> zeroinitializer
  %i.ax = fmul <2 x double> %i.aw, %.sroa.0.8.vec.insert.i.i13
  %i.ay = shufflevector <1 x double> %6, <1 x double> poison, <2 x i32> zeroinitializer
