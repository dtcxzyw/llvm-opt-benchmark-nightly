...
begin_hunk_0_@_ZN5Eigen8internal19gemv_dense_selectorILi2ELi1ELb1EE3runINS_9TransposeIKNS_3MapINS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEELi0ENS_6StrideILi0ELi0EEEEEEENS4_IKNS_5BlockIKS7_Li1ELin1ELb0EEEEENS4_INSD_ISA_Li1ELin1ELb0EEEEEEEvRKT_RKT0_RT1_RKNSQ_6ScalarE:bb.a
bb.d:                                             ; preds = %bb.c
...
.lr.ph.i.i.i.i.i.i.i.i.preheader:                 ; preds = %bb.c, %bb.e
  ...
  %i.m = load i64, ptr %.in, align 8, !tbaa !107  ; 6 uses
  %min.iters.check = icmp ult i64 %.sroa.533.0.copyload, 10
  %ident.check.not = icmp ne i64 %i.m, 1
  %or.cond.not49 = select i1 %min.iters.check, i1 true, i1 %ident.check.not
  %i.n = sub i64 %.sroa.031.0.copyload46, %i.l
  %diff.check = icmp ugt i64 %i.n, -32
  %or.cond48 = select i1 %or.cond.not49, i1 true, i1 %diff.check
  br i1 %or.cond48, label %.lr.ph.i.i.i.i.i.i.i.i.preheader50, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x double>, ptr %i.p, align 8, !tbaa !43
  %wide.load47 = load <2 x double>, ptr %i.q, align 8, !tbaa !43
  %i.r = getelementptr inbounds nuw i8, ptr %i.o, i64 16
  store <2 x double> %wide.load, ptr %i.o, align 8, !tbaa !43
  store <2 x double> %wide.load47, ptr %i.r, align 8, !tbaa !43
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.s = icmp eq i64 %index.next, %n.vec
  br i1 %i.s, label %middle.block, label %vector.body, !llvm.loop !359
...
.lr.ph.i.i.i.i.i.i.i.i.prol:                      ; preds = %.lr.ph.i.i.i.i.i.i.i.i.preheader50, %.lr.ph.i.i.i.i.i.i.i.i.prol
  %.05.i.i.i.i.i.i.i.i.prol = phi i64 [ %i.x, %.lr.ph.i.i.i.i.i.i.i.i.prol ], [ %.05.i.i.i.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.i.i.i.preheader50 ] ; 3 uses
  ...
  %i.w = load double, ptr %i.v, align 8, !tbaa !43
  store double %i.w, ptr %i.t, align 8, !tbaa !43
...
.lr.ph.i.i.i.i.i.i.i.i.prol.loopexit:             ; preds = %.lr.ph.i.i.i.i.i.i.i.i.prol, %.lr.ph.i.i.i.i.i.i.i.i.preheader50
  %.05.i.i.i.i.i.i.i.i.unr = phi i64 [ %.05.i.i.i.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.i.i.i.preheader50 ], [ %i.x, %.lr.ph.i.i.i.i.i.i.i.i.prol ]
...
.lr.ph.i.i.i.i.i.i.i.i:                           ; preds = %.lr.ph.i.i.i.i.i.i.i.i.prol.loopexit, %.lr.ph.i.i.i.i.i.i.i.i
  ...
  %i.ad = load double, ptr %i.ac, align 8, !tbaa !43
...
.loopexit:                                        ; preds = %.lr.ph.i.i.i.i.i.i.i.i.prol.loopexit, %.lr.ph.i.i.i.i.i.i.i.i, %middle.block, %bb.e
  ...
  store i64 %.sroa.541.0.copyload, ptr %i.aw, align 8, !tbaa !129
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #27
  store ptr %i.av, ptr %5, align 8, !tbaa !125
  %i.ax = getelementptr inbounds nuw i8, ptr %5, i64 8
  store i64 1, ptr %i.ax, align 8, !tbaa !126
  %i.ay = load ptr, ptr %2, align 8, !tbaa !140
  %.sroa.7.48..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 32
  %.sroa.7.48.copyload = load i64, ptr %.sroa.7.48..sroa_idx, align 8
  invoke void @_ZN5Eigen8internal29general_matrix_vector_productIldNS0_22const_blas_data_mapperIdlLi1EEELi1ELb0EdNS2_IdlLi0EEELb0ELi0EE3runEllRKS3_RKS4_Pdld(i64 noundef %.sroa.743.0.copyload, i64 noundef %.sroa.541.0.copyload, ptr noundef nonnull align 8 dereferenceable(16) %4, ptr noundef nonnull align 8 dereferenceable(16) %5, ptr noundef %i.ay, i64 noundef %.sroa.7.48.copyload, double noundef %i.a)
...
bb.g:                                             ; preds = %bb.f
  call void @free(ptr noundef nonnull %i.av) #27
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %.0389418.a = phi <2 x double> [ zeroinitializer, %.lr.ph ], [ %i.al, %bb.b ]
  ...
  %.0224419549 = add nsw i64 %i.aa, -2            ; 2 uses
  %i.ab = getelementptr [8 x i8], ptr %i.h, i64 %.0224419549
  %i.ac = load <2 x double>, ptr %i.ab, align 1, !tbaa !8 ; 8 uses
  %i.ad = getelementptr [8 x i8], ptr %.sroa.0329.0.copyload, i64 %.0224419549 ; 8 uses
  ...
  %i.al = fadd <2 x double> %.0389418.a, %i.ak    ; 2 uses
  %i.am = getelementptr [8 x i8], ptr %i.ad, i64 %i.n
  %i.an = load <2 x double>, ptr %i.am, align 1, !tbaa !8
  %i.ao = fmul <2 x double> %i.ac, %i.an
  %i.ap = fadd <2 x double> %.0390417, %i.ao      ; 2 uses
  %i.aq = getelementptr [8 x i8], ptr %i.ad, i64 %i.p
  %i.ar = load <2 x double>, ptr %i.aq, align 1, !tbaa !8
  %i.as = fmul <2 x double> %i.ac, %i.ar
  %i.at = fadd <2 x double> %.0391416, %i.as      ; 2 uses
  %i.au = getelementptr [8 x i8], ptr %i.ad, i64 %i.r
  %i.av = load <2 x double>, ptr %i.au, align 1, !tbaa !8
  %i.aw = fmul <2 x double> %i.ac, %i.av
  %i.ax = fadd <2 x double> %.0393415, %i.aw      ; 2 uses
  %i.ay = getelementptr [8 x i8], ptr %i.ad, i64 %i.t
  %i.az = load <2 x double>, ptr %i.ay, align 1, !tbaa !8
  %i.ba = fmul <2 x double> %i.ac, %i.az
  %i.bb = fadd <2 x double> %.0394414, %i.ba      ; 2 uses
  %i.bc = getelementptr [8 x i8], ptr %i.ad, i64 %i.v
  %i.bd = load <2 x double>, ptr %i.bc, align 1, !tbaa !8
  %i.be = fmul <2 x double> %i.ac, %i.bd
  %i.bf = fadd <2 x double> %.0395413, %i.be      ; 2 uses
  %i.bg = getelementptr [8 x i8], ptr %i.ad, i64 %i.x
  %i.bh = load <2 x double>, ptr %i.bg, align 1, !tbaa !8
  %i.bi = fmul <2 x double> %i.ac, %i.bh
  %i.bj = fadd <2 x double> %.0396412, %i.bi      ; 2 uses
  %i.bk = add nuw nsw i64 %i.aa, 2                ; 2 uses
  %.not238 = icmp sgt i64 %i.bk, %1
  br i1 %.not238, label %._crit_edge, label %bb.b, !llvm.loop !362
...
bb.c:                                             ; preds = %.lr.ph438, %bb.c
  ...
  %i.cx = load double, ptr %i.cw, align 8, !tbaa !43
  ...
  %i.dd = load double, ptr %i.dc, align 8, !tbaa !43
  %i.de = getelementptr [8 x i8], ptr %i.ct, i64 %i.cl
  %i.df = load double, ptr %i.de, align 8, !tbaa !43
  ...
  br i1 %exitcond.not, label %._crit_edge439, label %bb.c, !llvm.loop !363
...
._crit_edge439:                                   ; preds = %bb.c, %._crit_edge.._crit_edge439_crit_edge
  ...
  store double %i.em, ptr %i.ej, align 8, !tbaa !43
...
.lr.ph456:                                        ; preds = %.preheader407
  %i.fo = load ptr, ptr %3, align 8, !tbaa !125
...
bb.d:                                             ; preds = %.lr.ph456, %bb.d
  ...
  %.0399454.a = phi <2 x double> [ zeroinitializer, %.lr.ph456 ], [ %i.go, %bb.d ]
  %.0401453 = phi <2 x double> [ zeroinitializer, %.lr.ph456 ], [ %i.gs, %bb.d ]
  %.0402452 = phi <2 x double> [ zeroinitializer, %.lr.ph456 ], [ %i.gw, %bb.d ]
  %.0214455550 = add nsw i64 %i.gd, -2            ; 2 uses
  %i.ge = getelementptr [8 x i8], ptr %i.fo, i64 %.0214455550
  %i.gf = load <2 x double>, ptr %i.ge, align 1, !tbaa !8 ; 4 uses
  %i.gg = getelementptr [8 x i8], ptr %.sroa.0329.0.copyload, i64 %.0214455550 ; 4 uses
  %i.gh = getelementptr [8 x i8], ptr %i.gg, i64 %i.fp
  %i.gi = load <2 x double>, ptr %i.gh, align 1, !tbaa !8
...
.lr.ph469:                                        ; preds = %._crit_edge457
  %i.hg = load ptr, ptr %3, align 8, !tbaa !125
...
bb.e:                                             ; preds = %.lr.ph469, %bb.e
  ...
  %i.ht = load double, ptr %i.hs, align 8, !tbaa !43
  ...
  br i1 %exitcond549.not, label %._crit_edge470, label %bb.e, !llvm.loop !366
...
._crit_edge470:                                   ; preds = %bb.e, %._crit_edge457.._crit_edge470_crit_edge
  ...
  store double %i.it, ptr %i.iq, align 8, !tbaa !43
  ...
  br i1 %i.jf, label %.preheader407, label %.preheader406, !llvm.loop !367
...
.lr.ph481:                                        ; preds = %.preheader405
  %i.jg = load ptr, ptr %3, align 8, !tbaa !125   ; 3 uses
...
.lr.ph481.new:                                    ; preds = %.lr.ph481, %.lr.ph481.new
  ...
  %.0398479 = phi <2 x double> [ %i.km, %.lr.ph481.new ], [ zeroinitializer, %.lr.ph481 ]
  %.0398479.a = phi <2 x double> [ %i.ki, %.lr.ph481.new ], [ zeroinitializer, %.lr.ph481 ]
  %niter = phi i64 [ %niter.next.1, %.lr.ph481.new ], [ 0, %.lr.ph481 ]
  %.0208480552 = add nsw i64 %i.jq, -2            ; 2 uses
  %i.jr = getelementptr [8 x i8], ptr %i.jg, i64 %.0208480552
  %i.js = load <2 x double>, ptr %i.jr, align 1, !tbaa !8 ; 2 uses
  %i.jt = getelementptr [8 x i8], ptr %.sroa.0329.0.copyload, i64 %.0208480552 ; 2 uses
  %i.ju = getelementptr [8 x i8], ptr %i.jt, i64 %i.jh
  %i.jv = load <2 x double>, ptr %i.ju, align 1, !tbaa !8
  %i.jw = fmul <2 x double> %i.js, %i.jv
  %i.jx = fadd <2 x double> %.0398479.a, %i.jw
  %i.jy = getelementptr [8 x i8], ptr %i.jt, i64 %i.jj
  %i.jz = load <2 x double>, ptr %i.jy, align 1, !tbaa !8
  %i.ka = fmul <2 x double> %i.js, %i.jz
  %i.kb = fadd <2 x double> %.0398479, %i.ka
  %i.kc = getelementptr [8 x i8], ptr %i.jg, i64 %i.jq
  %i.kd = load <2 x double>, ptr %i.kc, align 1, !tbaa !8 ; 2 uses
  %i.ke = getelementptr [8 x i8], ptr %.sroa.0329.0.copyload, i64 %i.jq ; 2 uses
  %i.kf = getelementptr [8 x i8], ptr %i.ke, i64 %i.jh
  %i.kg = load <2 x double>, ptr %i.kf, align 1, !tbaa !8
  %i.kh = fmul <2 x double> %i.kd, %i.kg
  %i.ki = fadd <2 x double> %i.jx, %i.kh          ; 3 uses
  %i.kj = getelementptr [8 x i8], ptr %i.ke, i64 %i.jj
  %i.kk = load <2 x double>, ptr %i.kj, align 1, !tbaa !8
  %i.kl = fmul <2 x double> %i.kd, %i.kk
  %i.km = fadd <2 x double> %i.kb, %i.kl          ; 3 uses
  %i.kn = add nuw nsw i64 %i.jq, 4                ; 2 uses
  %niter.next.1 = add nuw i64 %niter, 2           ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge482.loopexit.unr-lcssa, label %.lr.ph481.new, !llvm.loop !368
...
.epil.preheader:                                  ; preds = %._crit_edge482.loopexit.unr-lcssa, %.lr.ph481
  %.0208480.epil.init = phi i64 [ 2, %.lr.ph481 ], [ %i.kn, %._crit_edge482.loopexit.unr-lcssa ]
  ...
  %.0208480552.epil = add nsw i64 %.0208480.epil.init, -2 ; 2 uses
  %i.ko = getelementptr [8 x i8], ptr %i.jg, i64 %.0208480552.epil
  %i.kp = load <2 x double>, ptr %i.ko, align 1, !tbaa !8 ; 2 uses
  %i.kq = getelementptr [8 x i8], ptr %.sroa.0329.0.copyload, i64 %.0208480552.epil ; 2 uses
  %i.kr = getelementptr [8 x i8], ptr %i.kq, i64 %i.jh
  %i.ks = load <2 x double>, ptr %i.kr, align 1, !tbaa !8
  %i.kt = fmul <2 x double> %i.kp, %i.ks
  %i.ku = fadd <2 x double> %.0400478.epil.init, %i.kt
  %i.kv = getelementptr [8 x i8], ptr %i.kq, i64 %i.jj
  %i.kw = load <2 x double>, ptr %i.kv, align 1, !tbaa !8
...
.lr.ph490:                                        ; preds = %._crit_edge482
  %i.ld = load ptr, ptr %3, align 8, !tbaa !125   ; 3 uses
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.lr.ph490
  %.lcssa651.unr = phi <2 x double> [ poison, %.lr.ph490 ], [ %i.lt, %.prol.loopexit.unr-lcssa ]
...
.lr.ph490.new:                                    ; preds = %.prol.loopexit, %.lr.ph490.new
  ...
  br i1 %exitcond550.not.1, label %._crit_edge491, label %.lr.ph490.new, !llvm.loop !369
...
.lr.ph499:                                        ; preds = %.preheader
  %i.nm = load ptr, ptr %3, align 8, !tbaa !125   ; 5 uses
...
.lr.ph499.new:                                    ; preds = %.lr.ph499, %.lr.ph499.new
  ...
  %niter687 = phi i64 [ %niter681.next.3, %.lr.ph499.new ], [ 0, %.lr.ph499 ]
  %.0205498554 = add nsw i64 %i.no, -2            ; 2 uses
  %i.np = getelementptr [8 x i8], ptr %i.nm, i64 %.0205498554
  %i.nq = load <2 x double>, ptr %i.np, align 1, !tbaa !8
  %gep = getelementptr [8 x i8], ptr %invariant.gep, i64 %.0205498554
  %i.nr = load <2 x double>, ptr %gep, align 1, !tbaa !8
  %i.ns = fmul <2 x double> %i.nq, %i.nr
  %i.nt = fadd <2 x double> %.0392497, %i.ns
  %i.nu = getelementptr [8 x i8], ptr %i.nm, i64 %i.no
  %i.nv = load <2 x double>, ptr %i.nu, align 1, !tbaa !8
  %gep.1 = getelementptr [8 x i8], ptr %invariant.gep, i64 %i.no
  %i.nw = load <2 x double>, ptr %gep.1, align 1, !tbaa !8
  %i.nx = fmul <2 x double> %i.nv, %i.nw
  %i.ny = fadd <2 x double> %i.nt, %i.nx
  %i.nz = add nuw nsw i64 %i.no, 2                ; 2 uses
  %i.oa = getelementptr [8 x i8], ptr %i.nm, i64 %i.nz
  %i.ob = load <2 x double>, ptr %i.oa, align 1, !tbaa !8
  %gep.2 = getelementptr [8 x i8], ptr %invariant.gep, i64 %i.nz
  %i.oc = load <2 x double>, ptr %gep.2, align 1, !tbaa !8
  %i.od = fmul <2 x double> %i.ob, %i.oc
  %i.oe = fadd <2 x double> %i.ny, %i.od
  %i.of = add nuw nsw i64 %i.no, 4                ; 2 uses
  %i.og = getelementptr [8 x i8], ptr %i.nm, i64 %i.of
  %i.oh = load <2 x double>, ptr %i.og, align 1, !tbaa !8
  %gep.3 = getelementptr [8 x i8], ptr %invariant.gep, i64 %i.of
  %i.oi = load <2 x double>, ptr %gep.3, align 1, !tbaa !8
  %i.oj = fmul <2 x double> %i.oh, %i.oi
  %i.ok = fadd <2 x double> %i.oe, %i.oj          ; 3 uses
  %i.ol = add nuw nsw i64 %i.no, 8                ; 2 uses
  %niter681.next.3 = add i64 %niter687, 4         ; 2 uses
  %niter681.ncmp.3 = icmp eq i64 %niter681.next.3, %unroll_iter680
  br i1 %niter681.ncmp.3, label %._crit_edge500.loopexit.unr-lcssa, label %.lr.ph499.new, !llvm.loop !371
...
bb.f:                                             ; preds = %bb.f, %.epil.preheader674
  %i.om = phi i64 [ %.epil.init, %.epil.preheader674 ], [ %i.os, %bb.f ] ; 2 uses
  %.0392497.epil = phi <2 x double> [ %.0392497.epil.init, %.epil.preheader674 ], [ %i.or, %bb.f ]
  %epil.iter = phi i64 [ 0, %.epil.preheader674 ], [ %epil.iter.next, %bb.f ]
  %.0205498554.epil = add nsw i64 %i.om, -2       ; 2 uses
  %i.on = getelementptr [8 x i8], ptr %i.nm, i64 %.0205498554.epil
  %i.oo = load <2 x double>, ptr %i.on, align 1, !tbaa !8
  %gep.epil = getelementptr [8 x i8], ptr %invariant.gep, i64 %.0205498554.epil
  %i.op = load <2 x double>, ptr %gep.epil, align 1, !tbaa !8
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge500, label %bb.f, !llvm.loop !372

._crit_edge500:                                   ; preds = %._crit_edge500.loopexit.unr-lcssa, %bb.f, %.preheader
  %.0392.lcssa = phi <2 x double> [ zeroinitializer, %.preheader ], [ %i.ok, %._crit_edge500.loopexit.unr-lcssa ], [ %i.or, %bb.f ] ; 2 uses
  ...
  %i.ot = extractelement <2 x double> %foldExtExtBinop, i64 0 ; 3 uses
...
.lr.ph506:                                        ; preds = %._crit_edge500
  ...
  %i.ow = load ptr, ptr %3, align 8, !tbaa !125   ; 5 uses
  %i.ox = sub i64 %1, %.0205.lcssa
  %xtraiter684 = and i64 %i.ox, 3                 ; 2 uses
...
.prol.preheader682:                               ; preds = %.lr.ph506, %.prol.preheader682
  %.0504.prol = phi double [ %i.pc, %.prol.preheader682 ], [ %i.ot, %.lr.ph506 ]
  %.1503.prol = phi i64 [ %i.pd, %.prol.preheader682 ], [ %.0205.lcssa, %.lr.ph506 ] ; 3 uses
  ...
  %i.oz = load double, ptr %gep510.prol, align 8, !tbaa !43
  %i.pa = load double, ptr %i.oy, align 8, !tbaa !43
  ...
  br i1 %prol.iter.cmp.not, label %.prol.loopexit683, label %.prol.preheader682, !llvm.loop !373

.prol.loopexit683:                                ; preds = %.prol.preheader682, %.lr.ph506
  %.lcssa648.unr = phi double [ poison, %.lr.ph506 ], [ %i.pc, %.prol.preheader682 ]
  %.0504.unr = phi double [ %i.ot, %.lr.ph506 ], [ %i.pc, %.prol.preheader682 ]
  %.1503.unr = phi i64 [ %.0205.lcssa, %.lr.ph506 ], [ %i.pd, %.prol.preheader682 ]
...
.lr.ph506.new:                                    ; preds = %.prol.loopexit683, %.lr.ph506.new
  %.0504 = phi double [ %i.qc, %.lr.ph506.new ], [ %.0504.unr, %.prol.loopexit683 ]
  %.1503 = phi i64 [ %i.qd, %.lr.ph506.new ], [ %.1503.unr, %.prol.loopexit683 ] ; 6 uses
  %gep510 = getelementptr [8 x i8], ptr %invariant.gep509, i64 %.1503
  %i.pg = getelementptr [8 x i8], ptr %i.ow, i64 %.1503
  %i.ph = load double, ptr %gep510, align 8, !tbaa !43
  %i.pi = load double, ptr %i.pg, align 8, !tbaa !43
  ...
  %i.pn = load double, ptr %gep510.1, align 8, !tbaa !43
  %i.po = load double, ptr %i.pm, align 8, !tbaa !43
  ...
  %i.pt = load double, ptr %gep510.2, align 8, !tbaa !43
  %i.pu = load double, ptr %i.ps, align 8, !tbaa !43
  ...
  %i.pz = load double, ptr %gep510.3, align 8, !tbaa !43
  %i.qa = load double, ptr %i.py, align 8, !tbaa !43
  ...
  br i1 %exitcond551.not.3, label %._crit_edge507, label %.lr.ph506.new, !llvm.loop !374

._crit_edge507:                                   ; preds = %.prol.loopexit683, %.lr.ph506.new, %._crit_edge500
  %.0.lcssa = phi double [ %i.ot, %._crit_edge500 ], [ %.lcssa648.unr, %.prol.loopexit683 ], [ %i.qc, %.lr.ph506.new ]
  %i.qe = mul nsw i64 %.3511, %5
  %i.qf = getelementptr inbounds [8 x i8], ptr %4, i64 %i.qe ; 2 uses
  %i.qg = load double, ptr %i.qf, align 8, !tbaa !43
  %i.qh = tail call double @llvm.fmuladd.f64(double %6, double %.0.lcssa, double %i.qg)
  store double %i.qh, ptr %i.qf, align 8, !tbaa !43
  %i.qi = add nuw nsw i64 %.3511, 1               ; 2 uses
  %exitcond552.not = icmp eq i64 %i.qi, %0
  br i1 %exitcond552.not, label %._crit_edge512, label %.preheader, !llvm.loop !375
...
bb.a:
  ...
  br i1 %i.b, label %bb.b, label %_ZN5Eigen8internal20manage_caching_sizesENS_6ActionEPlS2_S2_.exit, !prof !376
...
_ZN5Eigen8internal20manage_caching_sizesENS_6ActionEPlS2_S2_.exit: ; preds = %bb.a, %bb.b, %bb.d
  %i.e = load i64, ptr @_ZZN5Eigen8internal20manage_caching_sizesENS_6ActionEPlS2_S2_E12m_cacheSizes, align 8, !tbaa !377 ; 4 uses
  %i.f = load i64, ptr getelementptr inbounds nuw (i8, ptr @_ZZN5Eigen8internal20manage_caching_sizesENS_6ActionEPlS2_S2_E12m_cacheSizes, i64 8), align 8, !tbaa !378 ; 4 uses
  %i.g = load i64, ptr getelementptr inbounds nuw (i8, ptr @_ZZN5Eigen8internal20manage_caching_sizesENS_6ActionEPlS2_S2_E12m_cacheSizes, i64 16), align 8, !tbaa !142 ; 3 uses
...
bb.f:                                             ; preds = %_ZN5Eigen8internal20manage_caching_sizesENS_6ActionEPlS2_S2_.exit
  ...
  %i.m = load i64, ptr %0, align 8, !tbaa !100    ; 2 uses
  %i.n = icmp slt i64 %i.l, %i.m
  br i1 %i.n, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f
  %i.o = and i64 %i.l, 504                        ; 2 uses
  store i64 %i.o, ptr %0, align 8, !tbaa !100
  br label %bb.h
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %i.t = load i64, ptr %2, align 8, !tbaa !100    ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  store i64 %i.am, ptr %1, align 8, !tbaa !100
...
bb.n:                                             ; preds = %bb.l
  ...
  store i64 %.sroa.speculated149, ptr %1, align 8, !tbaa !100
  br label %.critedge116
end_hunk_0
