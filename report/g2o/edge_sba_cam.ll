...
bb.b:                                             ; preds = %bb.a
  ...
  %5 = load <1 x double>, ptr %i.ao, align 8
  %i.ap = shufflevector <1 x double> %5, <1 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  ...
  %9 = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 3 uses
  %i.bc = fmul <2 x double> %9, %i.bb
...
bb.c:                                             ; preds = %bb.a
  ...
  %10 = load <1 x double>, ptr %i.ie, align 8
  %i.if = shufflevector <1 x double> %10, <1 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  ...
  %14 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 3 uses
  %i.is = fmul <2 x double> %14, %i.ir
