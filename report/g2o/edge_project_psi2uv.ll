...
_ZNK3g2o16OptimizableGraph4Edge9parameterEi.exit: ; preds = %bb.a
  ...
  %.sroa.052.sroa.5.16.vec.insert = insertelement <1 x double> poison, double %.sroa.6108.0.copyload, i64 0
  %.sroa.052.sroa.7.24.vec.insert = insertelement <1 x double> poison, double %.sroa.7110.0.copyload, i64 0
  ...
  %i.z = shufflevector <1 x double> %.sroa.052.sroa.5.16.vec.insert, <1 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.aa = shufflevector <1 x double> %.sroa.052.sroa.7.24.vec.insert, <1 x double> poison, <2 x i32> zeroinitializer ; 2 uses
