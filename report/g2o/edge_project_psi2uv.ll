...
_ZNK3g2o16OptimizableGraph4Edge9parameterEi.exit: ; preds = %bb.a
  ...
  %i.dz = fdiv <2 x double> %.sroa.0128.0.copyload, %i.dy ; 6 uses
  %i.ea = fdiv double 1.000000e+00, %.sroa.5130.0.copyload ; 6 uses
  %.sroa.041.8.vec.extract = extractelement <2 x double> %i.dz, i64 1 ; 2 uses
  ...
  %i.ft = fdiv <2 x double> %i.fq, %i.fs          ; 10 uses
  ...
  %i.go = fadd double %i.gf, %i.gb
  %i.gp = insertelement <2 x double> poison, double %i.go, i64 0 ; 2 uses
  ...
  %i.ht = shufflevector <2 x double> %i.hs, <2 x double> poison, <2 x i32> zeroinitializer ; 5 uses
  ...
  %i.hv = fmul <2 x double> %i.ht, %.sroa.0.sroa.4.0..sroa.0.sroa.4.16..sroa.0.16..sroa.0.16..sroa.0.16. ; 3 uses
  ...
  %i.ia = bitcast <2 x i64> %i.hz to <2 x double> ; 8 uses
  ...
  %i.ie = bitcast <2 x i64> %i.id to <2 x double> ; 8 uses
  ...
  %1 = shufflevector <2 x double> %i.hv, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %2 = shufflevector <2 x double> %i.hw, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %3 = shufflevector <2 x double> %i.hx, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %4 = fmul <2 x double> %3, %i.ie
  %5 = fadd <2 x double> %i.it, %4
  %6 = insertelement <2 x double> poison, double %i.hy, i64 0
  %7 = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> zeroinitializer
  %i.iu = fmul <2 x double> %i.ft, %7
  ...
  %i.jp = bitcast <2 x i64> %i.jc to <2 x double> ; 2 uses
  %i.jq = shufflevector <2 x double> %i.jp, <2 x double> poison, <2 x i32> zeroinitializer
  %i.jr = fmul <2 x double> %i.jq, %i.ia
  %8 = shufflevector <2 x double> %i.jp, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %9 = fmul <2 x double> %8, %i.ie
  %10 = fadd <2 x double> %i.jr, %9
  %i.js = shufflevector <2 x double> %i.fn, <2 x double> poison, <2 x i32> zeroinitializer
  %i.jt = fmul <2 x double> %i.ft, %i.js
  %i.ju = fsub <2 x double> %10, %i.jt
  %i.jv = shufflevector <2 x double> %i.jd, <2 x double> poison, <2 x i32> zeroinitializer
  %i.jw = fmul <2 x double> %i.jv, %i.ia
  %11 = shufflevector <2 x double> %i.jd, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.jx = fmul <2 x double> %11, %i.ie
  %i.jy = fadd <2 x double> %i.jw, %i.jx
  %i.jz = fmul <2 x double> %i.ft, splat (double -0.000000e+00) ; 3 uses
  %i.ka = fsub <2 x double> %i.jy, %i.jz
  %i.kb = fmul <2 x double> %i.ie, zeroinitializer ; 2 uses
  %i.kc = fadd <2 x double> %i.kb, %i.ia
  %i.kd = fadd <2 x double> %i.kc, %i.jz
  %i.ke = fmul <2 x double> %i.ia, zeroinitializer ; 2 uses
  %i.kf = fadd <2 x double> %i.ke, %i.ie
  %i.kg = fadd <2 x double> %i.kf, %i.jz
  %i.kh = fadd <2 x double> %i.ke, %i.kb
  ...
  %.sroa.0166.sroa.10.32.vec.insert = insertelement <2 x double> poison, double %i.gt, i64 0
  %12 = shufflevector <2 x double> %i.dz, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.kp = insertelement <2 x double> %12, double %i.ek, i64 1
  ...
  %i.ld = fadd <2 x double> %i.kz, %i.lc          ; 4 uses
  ...
  %i.lh = shufflevector <2 x double> %.sroa.0166.sroa.10.32.vec.insert, <2 x double> poison, <2 x i32> zeroinitializer
  %i.li = fmul <2 x double> %i.lh, %i.kv
  %i.lj = fadd <2 x double> %i.lg, %i.li
  %13 = insertelement <2 x double> poison, double %i.gy, i64 0
  %i.lk = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ll = fmul <2 x double> %i.ft, %i.lk
  %i.lm = fadd <2 x double> %i.ll, %i.lj          ; 4 uses
  %14 = shufflevector <2 x double> %i.gp, <2 x double> poison, <2 x i32> zeroinitializer
  %15 = fmul <2 x double> %14, %i.kr
  %16 = insertelement <2 x double> poison, double %i.gv, i64 0
  %i.ln = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> zeroinitializer
  %i.lo = fmul <2 x double> %i.ln, %i.kv
  %i.lp = fadd <2 x double> %15, %i.lo
  ...
  %i.ls = fmul <2 x double> %i.lr, %i.ft
  %i.lt = fadd <2 x double> %i.lp, %i.ls          ; 4 uses
  %i.lu = fmul <2 x double> %i.ld, zeroinitializer ; 3 uses
  %17 = insertelement <2 x double> poison, double %i.eg, i64 0
  %i.lv = shufflevector <2 x double> %17, <2 x double> poison, <2 x i32> zeroinitializer
  %i.lw = fmul <2 x double> %i.lv, %i.lm
  %18 = fsub <2 x double> %i.lw, %i.lu
  %i.lx = fmul <2 x double> %12, %i.lt
  %i.ly = fadd <2 x double> %i.lx, %18
  %i.lz = fmul <2 x double> %i.ht, %i.ld
  %i.ma = fmul <2 x double> %i.lm, zeroinitializer ; 3 uses
  %19 = fsub <2 x double> %i.lz, %i.ma
  %20 = insertelement <2 x double> poison, double %i.ek, i64 0
  %i.mb = shufflevector <2 x double> %20, <2 x double> poison, <2 x i32> zeroinitializer
  %i.mc = fmul <2 x double> %i.mb, %i.lt
  %i.md = fadd <2 x double> %i.mc, %19
  %i.me = shufflevector <2 x double> %i.kq, <2 x double> poison, <2 x i32> zeroinitializer
  %i.mf = fmul <2 x double> %i.me, %i.ld
  %21 = shufflevector <2 x double> %i.kq, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.mg = fmul <2 x double> %21, %i.lm
  %i.mh = fadd <2 x double> %i.mf, %i.mg
  %i.mi = fmul <2 x double> %i.lt, zeroinitializer ; 3 uses
  %22 = fsub <2 x double> %i.mh, %i.mi
  %i.mj = fadd <2 x double> %i.ld, %i.ma
  %i.mk = fadd <2 x double> %i.mi, %i.mj
  %i.ml = fadd <2 x double> %i.lu, %i.lm
  %i.mm = fadd <2 x double> %i.mi, %i.ml
  %i.mn = fadd <2 x double> %i.lu, %i.ma
  ...
  store <2 x double> %22, ptr %i.mr, align 16, !tbaa !60
