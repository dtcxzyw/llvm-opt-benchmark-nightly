...
bb.a:
  ...
  %3 = load <2 x double>, ptr %i.w, align 16, !noalias !59 ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %1, i64 48
  %4 = load <2 x double>, ptr %i.x, align 16, !noalias !59 ; 2 uses
  %5 = getelementptr inbounds nuw i8, ptr %1, i64 80
  %6 = load <2 x double>, ptr %5, align 16, !noalias !59 ; 2 uses
  %7 = getelementptr inbounds nuw i8, ptr %1, i64 112
  %8 = load <2 x double>, ptr %7, align 16, !tbaa !8, !noalias !59
  %foldExtExtBinop41 = fmul <2 x double> %i.a, %3
  %foldExtExtBinop43 = fmul <2 x double> %.sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i, %4
  %foldExtExtBinop45 = fadd <2 x double> %foldExtExtBinop41, %foldExtExtBinop43
  %i.y = extractelement <2 x double> %6, i64 0
  %foldExtExtBinop47 = fmul <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, %6
  %foldExtExtBinop49 = fadd <2 x double> %foldExtExtBinop45, %foldExtExtBinop47
  %9 = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 1
  %i.z = extractelement <2 x double> %8, i64 0
  %i.aa = fmul double %9, %i.z
  %10 = extractelement <2 x double> %foldExtExtBinop49, i64 0
  %.sroa.4.16.vec.extract.i.i = fadd double %i.aa, %10 ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0.i.i)
  %i.ab = getelementptr inbounds nuw i8, ptr %2, i64 24
  %11 = getelementptr inbounds nuw i8, ptr %2, i64 40
  %i.ac = load double, ptr %11, align 8, !tbaa !12 ; 2 uses
  ...
  %12 = load <2 x double>, ptr %i.ab, align 8, !tbaa !12 ; 3 uses
  %i.ag = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ah = fmul <2 x double> %i.e, %i.ag
  %13 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %14 = fmul <2 x double> %i.i, %13
  %15 = fadd <2 x double> %i.ah, %14
  %16 = fadd <2 x double> %15, %i.af              ; 4 uses
  %17 = shufflevector <2 x double> %3, <2 x double> %4, <2 x i32> <i32 0, i32 2>
  %i.ai = fmul <2 x double> %12, %17              ; 2 uses
  %i.aj = fmul double %i.ac, %i.y
  %18 = extractelement <2 x double> %i.ai, i64 1
  %19 = fadd double %18, %i.aj
  %20 = extractelement <2 x double> %i.ai, i64 0
  %i.ak = fadd double %20, %19                    ; 4 uses
  %i.al = fmul <2 x double> %16, %16              ; 2 uses
  ...
  %i.as = fdiv <2 x double> %16, %i.ar
  %i.at = fdiv double %i.ak, %.scalar.i.i
  %.sroa.8.0.i = select i1 %i.ap, double %i.at, double %i.ak ; 3 uses
  %.sroa.0.0.i = select i1 %i.ap, <2 x double> %i.as, <2 x double> %16 ; 3 uses
