...
bb.b:                                             ; preds = %bb.a, %.backedge
  ...
  %.0116458 = phi i64 [ 0, %bb.a ], [ %.pre-phi, %.backedge ] ; 21 uses
  %.0118457 = phi i8 [ 1, %bb.a ], [ %.3, %.backedge ] ; 6 uses
  %.0120456 = phi i1 [ false, %bb.a ], [ %.1121, %.backedge ] ; 2 uses
  %i.p = sub i64 2, %indvar                       ; 3 uses
  %i.q = mul nuw nsw i64 %indvar, 24              ; 2 uses
  %scevgep = getelementptr nuw i8, ptr %0, i64 %i.q
  %i.r = getelementptr nuw i8, ptr %0, i64 %i.q
  %scevgep474.a = getelementptr nuw i8, ptr %i.r, i64 24 ; 2 uses
  %i.s = shl nuw nsw i64 %indvar, 5
  %i.t = getelementptr nuw i8, ptr %0, i64 %i.s
  %scevgep475 = getelementptr nuw i8, ptr %i.t, i64 8
  %.idx.i.i.i.i.i = shl nuw nsw i64 %.0116458, 5
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 %.idx.i.i.i.i.i ; 4 uses
  %.not404 = icmp eq i64 %.0116458, 2             ; 2 uses
...
_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit.thread: ; preds = %bb.b
  %i.v = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %.0116458
...
.lr.ph.i.i.i.i.epil.preheader:                    ; preds = %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit.unr-lcssa, %.lr.ph.i.i.i.i.preheader
  ...
  %lcmp.mod499 = trunc i64 %i.p to i1
...
_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit: ; preds = %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit.unr-lcssa, %.lr.ph.i.i.i.i.epil.preheader
  ...
  %i.aq = add i64 %.sroa.0.1.i.i.lcssa, %.0116458 ; 6 uses
  %i.ar = trunc i64 %i.aq to i32
  %i.as = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %.0116458
...
_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit..loopexit_crit_edge: ; preds = %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit.thread, %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit
  %.pre = add nuw nsw i64 %.0116458, 1
  %.pre421 = mul nuw nsw i64 %.0116458, 24
  br label %.loopexit
...
bb.c:                                             ; preds = %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit
  ...
  %i.au = getelementptr [8 x i8], ptr %0, i64 %.0116458 ; 4 uses
  %i.av = getelementptr [8 x i8], ptr %0, i64 %i.aq ; 5 uses
  %.not405 = icmp eq i64 %.0116458, 0
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %bb.c
  ...
  %exitcond.not.i.i.i.i.i.i = icmp eq i64 %.0116458, 1
...
_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi1ELi3ELb0EEELi1ELin1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit: ; preds = %.lr.ph.i.i.i.i.i.i, %.lr.ph.i.i.i.i.i.i.1, %bb.c
  %.idx.i.i.i.i = mul nuw nsw i64 %.0116458, 24   ; 4 uses
  %i.bc = getelementptr i8, ptr %0, i64 %.idx.i.i.i.i ; 2 uses
...
.lr.ph.i17.i.i.i.i.i.i.preheader:                 ; preds = %._crit_edge.i.i.i.i.i.i
  ...
  %min.iters.check479 = icmp ult i64 %i.bw, 12
  br i1 %min.iters.check479, label %.lr.ph.i17.i.i.i.i.i.i.preheader496, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %.lr.ph.i17.i.i.i.i.i.i.preheader
  ...
  %i.ca = shl i64 %i.bd, 3
  %i.cb = getelementptr i8, ptr %scevgep, i64 %i.by
  %i.cc = getelementptr i8, ptr %i.cb, i64 %i.bz
  %scevgep473.a = getelementptr i8, ptr %i.cc, i64 %i.ca
  %i.cd = shl i64 %.sroa.0.1.i.i.lcssa, 5
  %i.ce = getelementptr i8, ptr %scevgep475, i64 %i.cd
  %i.cf = getelementptr i8, ptr %i.ce, i64 %i.by
  %scevgep476 = getelementptr i8, ptr %i.cf, i64 %i.bz
  %i.cg = mul i64 %.sroa.0.1.i.i.lcssa, 24
  %scevgep477 = getelementptr i8, ptr %scevgep474.a, i64 %i.cg
  %bound0 = icmp ult ptr %scevgep473.a, %scevgep477
  %bound1 = icmp ult ptr %scevgep476, %scevgep474.a
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %.lr.ph.i17.i.i.i.i.i.i.preheader496, label %vector.ph480

vector.ph480:                                     ; preds = %vector.memcheck
  %n.vec481 = and i64 %i.bw, -4                   ; 3 uses
  %i.ch = add i64 %i.bn, %n.vec481
  br label %vector.body482

vector.body482:                                   ; preds = %vector.body482, %vector.ph480
  %index483 = phi i64 [ 0, %vector.ph480 ], [ %index.next488, %vector.body482 ] ; 2 uses
  %i.ci = add i64 %i.bn, %index483                ; 2 uses
  ...
  %wide.load484.a = load <2 x double>, ptr %i.cj, align 8, !tbaa !12, !alias.scope !70, !noalias !73
  %wide.load485 = load <2 x double>, ptr %i.cl, align 8, !tbaa !12, !alias.scope !70, !noalias !73
  %i.cm = getelementptr inbounds nuw i8, ptr %i.ck, i64 16 ; 2 uses
  %wide.load486 = load <2 x double>, ptr %i.ck, align 8, !tbaa !12, !alias.scope !73
  %wide.load487 = load <2 x double>, ptr %i.cm, align 8, !tbaa !12, !alias.scope !73
  store <2 x double> %wide.load486, ptr %i.cj, align 8, !tbaa !12, !alias.scope !70, !noalias !73
  store <2 x double> %wide.load487, ptr %i.cl, align 8, !tbaa !12, !alias.scope !70, !noalias !73
  store <2 x double> %wide.load484.a, ptr %i.ck, align 8, !tbaa !12, !alias.scope !73
  store <2 x double> %wide.load485, ptr %i.cm, align 8, !tbaa !12, !alias.scope !73
  %index.next488 = add nuw i64 %index483, 4       ; 2 uses
  %i.cn = icmp eq i64 %index.next488, %n.vec481
  br i1 %i.cn, label %middle.block489, label %vector.body482, !llvm.loop !75

middle.block489:                                  ; preds = %vector.body482
  %cmp.n490 = icmp eq i64 %i.bw, %n.vec481
  br i1 %cmp.n490, label %_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi3ELi1ELb1EEELin1ELi1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit, label %.lr.ph.i17.i.i.i.i.i.i.preheader496

.lr.ph.i17.i.i.i.i.i.i.preheader496:              ; preds = %vector.memcheck, %.lr.ph.i17.i.i.i.i.i.i.preheader, %middle.block489
  %.05.i18.i.i.i.i.i.i.ph = phi i64 [ %i.bn, %vector.memcheck ], [ %i.bn, %.lr.ph.i17.i.i.i.i.i.i.preheader ], [ %i.ch, %middle.block489 ]
  br label %.lr.ph.i17.i.i.i.i.i.i

.lr.ph.i17.i.i.i.i.i.i:                           ; preds = %.lr.ph.i17.i.i.i.i.i.i.preheader496, %.lr.ph.i17.i.i.i.i.i.i
  %.05.i18.i.i.i.i.i.i = phi i64 [ %i.cs, %.lr.ph.i17.i.i.i.i.i.i ], [ %.05.i18.i.i.i.i.i.i.ph, %.lr.ph.i17.i.i.i.i.i.i.preheader496 ] ; 3 uses
...
_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi3ELi1ELb1EEELin1ELi1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit: ; preds = %.lr.ph.i17.i.i.i.i.i.i, %middle.block489, %._crit_edge.i.i.i.i.i.i
  ...
  %.0115409 = add nuw nsw i64 %.0116458, 1        ; 3 uses
  %.not453 = icmp eq i64 %.sroa.0.1.i.i.lcssa, 1
  br i1 %.not453, label %.loopexit, label %.lr.ph
...
.loopexit:                                        ; preds = %.lr.ph, %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit..loopexit_crit_edge, %_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi3ELi1ELb1EEELin1ELi1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit
  ...
  %i.dh = sub nsw i64 2, %.0116458                ; 2 uses
  ...
  store i64 %.0116458, ptr %i.d, align 8, !tbaa !52
  store i64 3, ptr %i.e, align 8, !tbaa !85
  %i.dk = getelementptr [8 x i8], ptr %0, i64 %.0116458 ; 7 uses
  %.not132 = icmp eq i64 %.0116458, 0
...
.lr.ph.i.i.i.i.i.i.i.i.i.i:                       ; preds = %.loopexit
  ...
  %exitcond.not.i.i.i.i.i.i.i.i.i.i = icmp eq i64 %.0116458, 1
...
bb.d:                                             ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i.i.1, %.lr.ph.i.i.i.i.i.i.i.i.i.i
  ...
  br i1 %.not404, label %.thread433, label %bb.e

.thread433:                                       ; preds = %bb.d
...
bb.e:                                             ; preds = %bb.d
  ...
  store i64 %.0116458, ptr %.sroa.4.0..sroa_idx3.i.i.i.i, align 8
  ...
  store i64 %.0116458, ptr %.sroa.8224.56..sroa_idx, align 8
  ...
  store i64 %.0116458, ptr %i.i, align 8, !tbaa !92
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.el = trunc nuw i8 %.0118457 to i1
...
.preheader.us.i.preheader:                        ; preds = %bb.g
  ...
  br i1 %i.eo, label %.preheader.us.i.1420, label %_ZNK5Eigen9DenseBaseINS_13CwiseBinaryOpINS_8internal13scalar_cmp_opIddLNS2_14ComparisonNameE0EEEKNS_12ArrayWrapperINS_5BlockINS7_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi3ELi1ELb1EEELin1ELi1ELb0EEEEEKNS_14CwiseNullaryOpINS2_18scalar_constant_opIdEENS_5ArrayIdLin1ELi1ELi0ELi3ELi1EEEEEEEE3allEv.exit.1.thread
end_hunk_0
