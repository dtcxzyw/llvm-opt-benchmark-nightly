...
begin_hunk_0_@_ZN3g2o8internal22transformCartesianLineERKN5Eigen9TransformIdLi3ELi1ELi0EEERKNS1_6MatrixIdLi6ELi1ELi0ELi6ELi1EEE:bb.a
  ...
  %i.aa = load double, ptr %i.z, align 16, !tbaa !8, !noalias !99
  %i.ab = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 1
  %i.ac = fmul double %i.ab, %i.aa
  %i.ad = load double, ptr %i.w, align 16, !tbaa !8, !noalias !99 ; 2 uses
  %i.ae = extractelement <2 x double> %i.a, i64 0
  %i.af = fmul double %i.ae, %i.ad
  %i.ag = load double, ptr %i.x, align 16, !tbaa !8, !noalias !99 ; 2 uses
  %i.ah = extractelement <2 x double> %.sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i, i64 0
  %i.ai = fmul double %i.ah, %i.ag
  %i.aj = fadd double %i.af, %i.ai
  %i.ak = load double, ptr %i.y, align 16, !tbaa !8, !noalias !99 ; 2 uses
  %i.al = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 0
  %i.am = fmul double %i.al, %i.ak
  %i.an = fadd double %i.aj, %i.am
  %.sroa.4.16.vec.extract.i.i = fadd double %i.ac, %i.an ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0.i.i)
  %i.ao = getelementptr inbounds nuw i8, ptr %2, i64 24
  %i.ap = load double, ptr %i.ao, align 8, !tbaa !10 ; 2 uses
  ...
  %i.as = fmul <2 x double> %i.e, %i.ar
  %i.at = getelementptr inbounds nuw i8, ptr %2, i64 32
  %i.au = load double, ptr %i.at, align 16, !tbaa !10 ; 2 uses
  ...
  %i.ax = fmul <2 x double> %i.i, %i.aw
  %i.ay = fadd <2 x double> %i.as, %i.ax
  %i.az = getelementptr inbounds nuw i8, ptr %2, i64 40
  %i.ba = load double, ptr %i.az, align 8, !tbaa !10 ; 2 uses
  ...
  %i.bd = fmul <2 x double> %i.n, %i.bc
  %i.be = fadd <2 x double> %i.ay, %i.bd          ; 4 uses
  %i.bf = fmul double %i.ap, %i.ad
  %i.bg = fmul double %i.au, %i.ag
  %i.bh = fmul double %i.ba, %i.ak
  %i.bi = fadd double %i.bg, %i.bh
  %i.bj = fadd double %i.bf, %i.bi                ; 4 uses
  %i.bk = fmul <2 x double> %i.be, %i.be          ; 2 uses
  ...
  %i.bn = fadd double %i.bm, %i.bl                ; 2 uses
  %i.bo = fcmp ogt double %i.bn, 0.000000e+00     ; 2 uses
  %.scalar.i.i = tail call double @llvm.sqrt.f64(double %i.bn) ; 2 uses
  %i.bp = insertelement <2 x double> poison, double %.scalar.i.i, i64 0
  %i.bq = shufflevector <2 x double> %i.bp, <2 x double> poison, <2 x i32> zeroinitializer
  %i.br = fdiv <2 x double> %i.be, %i.bq
  %i.bs = fdiv double %i.bj, %.scalar.i.i
  %.sroa.8.0.i = select i1 %i.bo, double %i.bs, double %i.bj ; 3 uses
  %.sroa.0.0.i = select i1 %i.bo, <2 x double> %i.br, <2 x double> %i.be ; 3 uses
  %i.bt = fmul <2 x double> %i.v, %.sroa.0.0.i    ; 2 uses
  %shift38 = shufflevector <2 x double> %i.bt, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop39 = fadd <2 x double> %i.bt, %shift38
  %i.bu = extractelement <2 x double> %foldExtExtBinop39, i64 0
  %i.bv = fmul double %.sroa.4.16.vec.extract.i.i, %.sroa.8.0.i
  %i.bw = fadd double %i.bv, %i.bu                ; 2 uses
  %.sroa.6.16.vec.insert.i.i.i.i.i.i = insertelement <2 x double> poison, double %i.bw, i64 0
  %i.bx = shufflevector <2 x double> %.sroa.6.16.vec.insert.i.i.i.i.i.i, <2 x double> poison, <2 x i32> zeroinitializer
  %i.by = fmul <2 x double> %.sroa.0.0.i, %i.bx
  %i.bz = fsub <2 x double> %i.v, %i.by
  %i.ca = fmul double %.sroa.8.0.i, %i.bw
  %i.cb = fsub double %.sroa.4.16.vec.extract.i.i, %i.ca
  store <2 x double> %i.bz, ptr %0, align 16, !tbaa !8, !alias.scope !100
  %i.cc = getelementptr inbounds nuw i8, ptr %0, i64 16
  store double %i.cb, ptr %i.cc, align 16, !tbaa !10, !alias.scope !100
  %i.cd = getelementptr inbounds nuw i8, ptr %0, i64 24
  store <2 x double> %.sroa.0.0.i, ptr %i.cd, align 8, !tbaa !8, !alias.scope !100
  %i.ce = getelementptr inbounds nuw i8, ptr %0, i64 40
  store double %.sroa.8.0.i, ptr %i.ce, align 8, !tbaa !10, !alias.scope !100
  ret void
}
...
_ZN5Eigen10MatrixBaseINS_6MatrixIdLi3ELi1ELi0ELi3ELi1EEEE9normalizeEv.exit:
  ...
  %i.c = load double, ptr %i.b, align 16, !tbaa !10 ; 2 uses
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.e = load <2 x double>, ptr %i.d, align 8, !tbaa !8 ; 4 uses
  %i.f = getelementptr inbounds nuw i8, ptr %1, i64 40
  %i.g = load double, ptr %i.f, align 8, !tbaa !10 ; 4 uses
  ...
  store double %i.y, ptr %i.z, align 16, !tbaa !10
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 24
  store <2 x double> %.sroa.0.0, ptr %i.aa, align 8, !tbaa !8
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 40
  store double %.sroa.8.0, ptr %i.ab, align 8, !tbaa !10
  ret void
}
...
bb.b:                                             ; preds = %bb.a, %.backedge
  ...
  %scevgep471.a = getelementptr nuw i8, ptr %i.r, i64 24 ; 2 uses
  %i.s = shl nuw nsw i64 %indvar, 5
  %i.t = getelementptr nuw i8, ptr %0, i64 %i.s
  %scevgep472.a = getelementptr nuw i8, ptr %i.t, i64 8
...
_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit.thread: ; preds = %bb.b
  ...
  store i32 2, ptr %i.v, align 4, !tbaa !22
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i, %.lr.ph.i.i.i.i.preheader.new
  ...
  br i1 %niter.ncmp.1, label %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit.unr-lcssa, label %.lr.ph.i.i.i.i, !llvm.loop !101
...
_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit: ; preds = %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit.unr-lcssa, %.lr.ph.i.i.i.i.epil.preheader
  ...
  store i32 %i.ar, ptr %i.as, align 4, !tbaa !22
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %bb.c
  %i.aw = load double, ptr %i.au, align 8, !tbaa !10
  %i.ax = load double, ptr %i.av, align 8, !tbaa !10
  store double %i.ax, ptr %i.au, align 8, !tbaa !10
  store double %i.aw, ptr %i.av, align 8, !tbaa !10
...
.lr.ph.i.i.i.i.i.i.1:                             ; preds = %.lr.ph.i.i.i.i.i.i
  ...
  store double %i.bb, ptr %i.ay, align 8, !tbaa !10
  store double %i.ba, ptr %i.az, align 8, !tbaa !10
...
.lr.ph.i.i.i.i.i.i.i.preheader:                   ; preds = %_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi1ELi3ELb0EEELi1ELin1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit
  %i.bp = load double, ptr %i.be, align 8, !tbaa !10
  %i.bq = load double, ptr %i.bg, align 8, !tbaa !10
  store double %i.bq, ptr %i.be, align 8, !tbaa !10
  store double %i.bp, ptr %i.bg, align 8, !tbaa !10
...
vector.memcheck:                                  ; preds = %.lr.ph.i17.i.i.i.i.i.i.preheader
  ...
  %i.ce = getelementptr i8, ptr %scevgep472.a, i64 %i.cd
  %i.cf = getelementptr i8, ptr %i.ce, i64 %i.by
  %scevgep473.a = getelementptr i8, ptr %i.cf, i64 %i.bz
  %i.cg = mul i64 %.sroa.0.1.i.i.lcssa, 24
  %scevgep474 = getelementptr i8, ptr %scevgep471.a, i64 %i.cg
  %bound0 = icmp ult ptr %scevgep, %scevgep474
  %bound1 = icmp ult ptr %scevgep473.a, %scevgep471.a
...
vector.body479:                                   ; preds = %vector.body479, %vector.ph477
  ...
  %wide.load481.a = load <2 x double>, ptr %i.cj, align 8, !tbaa !10, !alias.scope !116, !noalias !117
  %wide.load482.a = load <2 x double>, ptr %i.cl, align 8, !tbaa !10, !alias.scope !116, !noalias !117
  %i.cm = getelementptr inbounds nuw i8, ptr %i.ck, i64 16 ; 2 uses
  %wide.load483.a = load <2 x double>, ptr %i.ck, align 8, !tbaa !10, !alias.scope !117
  %wide.load484 = load <2 x double>, ptr %i.cm, align 8, !tbaa !10, !alias.scope !117
  store <2 x double> %wide.load483.a, ptr %i.cj, align 8, !tbaa !10, !alias.scope !116, !noalias !117
  store <2 x double> %wide.load484, ptr %i.cl, align 8, !tbaa !10, !alias.scope !116, !noalias !117
  store <2 x double> %wide.load481.a, ptr %i.ck, align 8, !tbaa !10, !alias.scope !117
  store <2 x double> %wide.load482.a, ptr %i.cm, align 8, !tbaa !10, !alias.scope !117
  %index.next485 = add nuw i64 %index480, 4       ; 2 uses
  %i.cn = icmp eq i64 %index.next485, %n.vec478
  br i1 %i.cn, label %middle.block486, label %vector.body479, !llvm.loop !105
...
.lr.ph.i17.i.i.i.i.i.i:                           ; preds = %.lr.ph.i17.i.i.i.i.i.i.preheader494, %.lr.ph.i17.i.i.i.i.i.i
  ...
  %i.cq = load double, ptr %i.co, align 8, !tbaa !10
  %i.cr = load double, ptr %i.cp, align 8, !tbaa !10
  store double %i.cr, ptr %i.co, align 8, !tbaa !10
  store double %i.cq, ptr %i.cp, align 8, !tbaa !10
  %i.cs = add nsw i64 %.05.i18.i.i.i.i.i.i, 1     ; 2 uses
  %exitcond.not.i19.i.i.i.i.i.i = icmp eq i64 %i.cs, %i.at
  br i1 %exitcond.not.i19.i.i.i.i.i.i, label %_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi3ELi1ELb1EEELin1ELi1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit, label %.lr.ph.i17.i.i.i.i.i.i, !llvm.loop !106
...
.lr.ph.i.i.i.i.i.i135:                            ; preds = %_ZN5Eigen8internal31unaligned_dense_assignment_loopILb0EE3runINS0_31generic_dense_assignment_kernelINS0_9evaluatorINS_5BlockINS6_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi3ELi1ELb1EEELin1ELi1ELb0EEEEESB_NS0_14swap_assign_opIdEELi0EEEEEvRT_ll.exit.i.i.i.i.i.i, %.lr.ph.i.i.i.i.i.i135
  ...
  br i1 %i.cy, label %.lr.ph.i.i.i.i.i.i135, label %._crit_edge.i.i.i.i.i.i, !llvm.loop !107
...
_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi3ELi1ELb1EEELin1ELi1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit: ; preds = %.lr.ph.i17.i.i.i.i.i.i, %middle.block486, %._crit_edge.i.i.i.i.i.i
  ...
  %i.db = load double, ptr %i.cz, align 8, !tbaa !10
  %i.dc = load double, ptr %i.da, align 8, !tbaa !10
  store double %i.dc, ptr %i.cz, align 8, !tbaa !10
  store double %i.db, ptr %i.da, align 8, !tbaa !10
...
.loopexit:                                        ; preds = %.lr.ph, %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit..loopexit_crit_edge, %_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi3ELi1ELb1EEELin1ELi1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit
  ...
  store ptr %i.dj, ptr %8, align 8, !tbaa !27
  store i64 %i.dh, ptr %i.a, align 8, !tbaa !20
  store ptr %0, ptr %i.b, align 8, !tbaa !118
  store i64 %.pre-phi, ptr %i.c, align 8, !tbaa !20
  store i64 %.0116456, ptr %i.d, align 8, !tbaa !20
