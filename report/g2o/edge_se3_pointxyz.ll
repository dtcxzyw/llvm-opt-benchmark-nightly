...
bb.a:
  ...
  %1 = load <2 x double>, ptr %i.ae, align 16, !tbaa !66, !noalias !146
  %i.af = getelementptr inbounds nuw i8, ptr %i.f, i64 128
  %2 = load <2 x double>, ptr %i.af, align 16, !tbaa !66, !noalias !146
  %i.ag = getelementptr inbounds nuw i8, ptr %i.f, i64 160
  %3 = load <2 x double>, ptr %i.ag, align 16, !tbaa !66, !noalias !146
  %i.ah = getelementptr inbounds nuw i8, ptr %i.f, i64 192
  %4 = load <2 x double>, ptr %i.ah, align 16, !tbaa !66, !noalias !146
  %5 = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 1
  %i.ai = extractelement <2 x double> %4, i64 0
  %i.aj = fmul double %5, %i.ai
  %6 = extractelement <2 x double> %i.i, i64 0
  %i.ak = extractelement <2 x double> %1, i64 0
  %i.al = fmul double %6, %i.ak
  %7 = extractelement <2 x double> %.sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i, i64 0
  %i.am = extractelement <2 x double> %2, i64 0
  %i.an = fmul double %7, %i.am
  %i.ao = fadd double %i.al, %i.an
  %8 = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 0
  %i.ap = extractelement <2 x double> %3, i64 0
  %i.aq = fmul double %8, %i.ap
...
bb.a:
  ...
  %i.ae = getelementptr inbounds nuw i8, ptr %i.f, i64 352 ; 2 uses
  %4 = load <2 x double>, ptr %i.ae, align 16, !tbaa !66, !noalias !151
  %i.af = getelementptr inbounds nuw i8, ptr %i.f, i64 384 ; 2 uses
  %5 = load <2 x double>, ptr %i.af, align 16, !tbaa !66, !noalias !151
  %6 = getelementptr inbounds nuw i8, ptr %i.f, i64 416 ; 2 uses
  %7 = load <2 x double>, ptr %6, align 16, !tbaa !66, !noalias !151
  %8 = getelementptr inbounds nuw i8, ptr %i.f, i64 448
  %9 = load <2 x double>, ptr %8, align 16, !tbaa !66, !noalias !151
  ...
  %foldExtExtBinop40 = fmul <2 x double> %i.i, %4
  %foldExtExtBinop42 = fmul <2 x double> %.sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i, %5
  %foldExtExtBinop44 = fadd <2 x double> %foldExtExtBinop40, %foldExtExtBinop42
  %foldExtExtBinop46 = fmul <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, %7
  %foldExtExtBinop48 = fadd <2 x double> %foldExtExtBinop44, %foldExtExtBinop46
  %foldExtExtBinop50 = fadd <2 x double> %foldExtExtBinop, %foldExtExtBinop48 ; 2 uses
  %.sroa.4.16.vec.extract.i.i = extractelement <2 x double> %foldExtExtBinop50, i64 0
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0.i.i)
  ...
  %10 = shufflevector <2 x double> %foldExtExtBinop50, <2 x double> %i.ad, <2 x i32> <i32 0, i32 3>
  ...
  %i.as = load double, ptr %i.ae, align 16, !tbaa !55
  ...
  %i.aw = load double, ptr %i.af, align 16, !tbaa !55
  ...
  %i.ba = load double, ptr %6, align 16, !tbaa !55
...
bb.a:
  ...
  %1 = load <2 x double>, ptr %i.ae, align 16, !tbaa !66, !noalias !167
  %i.af = getelementptr inbounds nuw i8, ptr %i.g, i64 128
  %2 = load <2 x double>, ptr %i.af, align 16, !tbaa !66, !noalias !167
  %i.ag = getelementptr inbounds nuw i8, ptr %i.g, i64 160
  %3 = load <2 x double>, ptr %i.ag, align 16, !tbaa !66, !noalias !167
  %i.ah = getelementptr inbounds nuw i8, ptr %i.g, i64 192
  %4 = load <2 x double>, ptr %i.ah, align 16, !tbaa !66, !noalias !167
  %5 = extractelement <2 x double> %.sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.i.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i, i64 1
  %i.ai = extractelement <2 x double> %4, i64 0
  %i.aj = fmul double %5, %i.ai
  %6 = extractelement <2 x double> %i.i, i64 0
...
bb.a:
  ...
  %3 = load <2 x double>, ptr %i.af, align 16, !tbaa !66, !noalias !172
  %i.ag = getelementptr inbounds nuw i8, ptr %i.k, i64 64
  %4 = load <2 x double>, ptr %i.ag, align 16, !tbaa !66, !noalias !172
  %i.ah = getelementptr inbounds nuw i8, ptr %i.k, i64 96
  %5 = load <2 x double>, ptr %i.ah, align 16, !tbaa !66, !noalias !172
  %i.ai = getelementptr inbounds nuw i8, ptr %i.k, i64 128
  %6 = load <2 x double>, ptr %i.ai, align 16, !tbaa !66, !noalias !172
  ...
  %i.aj = extractelement <2 x double> %6, i64 0
  %i.ak = fmul double %7, %i.aj
  %8 = extractelement <2 x double> %.sroa.013.0.copyload, i64 0
  %i.al = extractelement <2 x double> %3, i64 0
  %i.am = fmul double %8, %i.al
  %9 = extractelement <2 x double> %.sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.i.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i, i64 0
  %i.an = extractelement <2 x double> %4, i64 0
  %i.ao = fmul double %9, %i.an
  ...
  %i.aq = extractelement <2 x double> %5, i64 0
  %i.ar = fmul double %10, %i.aq
  ...
  %11 = load <2 x double>, ptr %i.bl, align 16, !tbaa !66, !noalias !177
  %i.bm = getelementptr inbounds nuw i8, ptr %i.d, i64 240
  %12 = load <2 x double>, ptr %i.bm, align 16, !tbaa !66, !noalias !177
  %i.bn = getelementptr inbounds nuw i8, ptr %i.d, i64 272
  %13 = load <2 x double>, ptr %i.bn, align 16, !tbaa !66, !noalias !177
  %i.bo = getelementptr inbounds nuw i8, ptr %i.d, i64 304
  %14 = load <2 x double>, ptr %i.bo, align 16, !tbaa !66, !noalias !177
  %15 = extractelement <2 x double> %.sroa.0.i.i4.16..sroa.0.i.i4.16..sroa.0.i.i4.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i9, i64 1
  %i.bp = extractelement <2 x double> %14, i64 0
  %i.bq = fmul double %15, %i.bp
  %16 = extractelement <2 x double> %i.ae, i64 0
  %i.br = extractelement <2 x double> %11, i64 0
  %i.bs = fmul double %16, %i.br
  %17 = extractelement <2 x double> %.sroa.0.i.i4.8..sroa.0.i.i4.8..sroa.0.i.i4.8..sroa.0.i.8..sroa.0.i.8..sroa.0.8..sroa.0.8..i.i8, i64 0
  %i.bt = extractelement <2 x double> %12, i64 0
  %i.bu = fmul double %17, %i.bt
  %i.bv = fadd double %i.bs, %i.bu
  %18 = extractelement <2 x double> %.sroa.0.i.i4.16..sroa.0.i.i4.16..sroa.0.i.i4.16..sroa.0.i.16..sroa.0.i.16..sroa.0.16..sroa.0.16..i.i9, i64 0
  %i.bw = extractelement <2 x double> %13, i64 0
  %i.bx = fmul double %18, %i.bw
