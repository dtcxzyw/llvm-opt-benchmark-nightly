...
.lr.ph.i.i.i.i:                                   ; preds = %bb.a, %.loopexit
  ...
  %.052170 = phi i64 [ 0, %bb.a ], [ %i.eq, %.loopexit ] ; 16 uses
...
_ZN5Eigen8internal13first_alignedILi16EdlEET1_PKT0_S2_.exit.i.i.i.i.i.i: ; preds = %bb.f, %bb.e
  ...
  %.sext = sext i8 %9 to i64                      ; 2 uses
  %i.cu = shl nsw i64 %.sext, 1
...
.lr.ph.i17.i.i.i.i.i.i.preheader:                 ; preds = %._crit_edge.i.i.i.i.i.i
  %i.do = shl nsw i64 %.sext, 1
  %i.dp = add nsw i64 %.0.i.i.i.i.i.i.i, %i.do
  %i.dq = sub nsw i64 %8, %i.dp                   ; 3 uses
  %min.iters.check = icmp ult i64 %i.dq, 2
...
vector.ph:                                        ; preds = %.lr.ph.i17.i.i.i.i.i.i.preheader
  %n.vec = and i64 %i.dq, -2                      ; 3 uses
  %i.dr = add nsw i64 %i.cv, %n.vec
  %broadcast.splatinsert = insertelement <2 x double> poison, double %i.cn, i64 0
  %broadcast.splat = shufflevector <2 x double> %broadcast.splatinsert, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ds = getelementptr [8 x i8], ptr %i.cm, i64 %i.cv
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.dt = getelementptr [8 x i8], ptr %i.ds, i64 %index ; 2 uses
  %wide.load = load <2 x double>, ptr %i.dt, align 8, !tbaa !29
  %i.du = fdiv <2 x double> %wide.load, %broadcast.splat
  store <2 x double> %i.du, ptr %i.dt, align 8, !tbaa !29
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.dv = icmp eq i64 %index.next, %n.vec
  br i1 %i.dv, label %middle.block, label %vector.body, !llvm.loop !456
...
.lr.ph.i17.i.i.i.i.i.i.preheader177:              ; preds = %.lr.ph.i17.i.i.i.i.i.i.preheader, %middle.block
  %.05.i18.i.i.i.i.i.i.ph = phi i64 [ %i.cv, %.lr.ph.i17.i.i.i.i.i.i.preheader ], [ %i.dr, %middle.block ]
  br label %.lr.ph.i17.i.i.i.i.i.i

.lr.ph.i17.i.i.i.i.i.i:                           ; preds = %.lr.ph.i17.i.i.i.i.i.i.preheader177, %.lr.ph.i17.i.i.i.i.i.i
  %.05.i18.i.i.i.i.i.i = phi i64 [ %i.dz, %.lr.ph.i17.i.i.i.i.i.i ], [ %.05.i18.i.i.i.i.i.i.ph, %.lr.ph.i17.i.i.i.i.i.i.preheader177 ] ; 2 uses
  %i.dw = getelementptr inbounds [8 x i8], ptr %i.cm, i64 %.05.i18.i.i.i.i.i.i ; 2 uses
  %i.dx = load double, ptr %i.dw, align 8, !tbaa !29
  %i.dy = fdiv double %i.dx, %i.cn
  store double %i.dy, ptr %i.dw, align 8, !tbaa !29
  %i.dz = add nsw i64 %.05.i18.i.i.i.i.i.i, 1     ; 2 uses
  %exitcond.not.i19.i.i.i.i.i.i = icmp eq i64 %i.dz, %8
  br i1 %exitcond.not.i19.i.i.i.i.i.i, label %.loopexit, label %.lr.ph.i17.i.i.i.i.i.i, !llvm.loop !457

.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i, %.lr.ph.i.preheader.i.i.i.i.i
  %.021.i.i.i.i.i.i = phi i64 [ %i.ed, %.lr.ph.i.i.i.i.i.i ], [ %.0.i.i.i.i.i.i.i, %.lr.ph.i.preheader.i.i.i.i.i ] ; 2 uses
  %i.ea = getelementptr inbounds [8 x i8], ptr %i.cm, i64 %.021.i.i.i.i.i.i ; 2 uses
  %i.eb = load <2 x double>, ptr %i.ea, align 16, !tbaa !17
  %i.ec = fdiv <2 x double> %i.eb, %i.dm
  store <2 x double> %i.ec, ptr %i.ea, align 16, !tbaa !17
  %i.ed = add nuw nsw i64 %.021.i.i.i.i.i.i, 2    ; 2 uses
  %i.ee = icmp slt i64 %i.ed, %i.cv
  br i1 %i.ee, label %.lr.ph.i.i.i.i.i.i, label %._crit_edge.i.i.i.i.i.i, !llvm.loop !458
...
bb.g:                                             ; preds = %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal21scalar_score_coeff_opIdEEKNS_5BlockINS5_INS_3RefINS_6MatrixIdLi6ELi6ELi0ELi6ELi6EEELi0ENS_11OuterStrideILin1EEEEELi6ELi1ELb1EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit
  %i.ef = icmp eq i64 %.0171, -1
  %spec.select54 = select i1 %i.ef, i64 %.052170, i64 %.0171
...
.loopexit:                                        ; preds = %.lr.ph.i17.i.i.i.i.i.i, %middle.block, %._crit_edge.i.i.i.i.i.i, %bb.g
  ...
  %i.eg = load ptr, ptr %0, align 8, !tbaa !446, !noalias !459 ; 3 uses
  %i.eh = load i64, ptr %i.a, align 8, !tbaa !448, !noalias !459 ; 8 uses
  %i.ei = mul nsw i64 %i.eh, %.052170
  %i.ej = getelementptr inbounds [8 x i8], ptr %i.eg, i64 %i.ei ; 2 uses
  %i.ek = getelementptr inbounds nuw [8 x i8], ptr %i.ej, i64 %.pre-phi173 ; 2 uses
  %i.el = getelementptr inbounds nuw [8 x i8], ptr %i.eg, i64 %.052170 ; 2 uses
  %i.em = mul nsw i64 %i.eh, %.pre-phi173         ; 2 uses
  %i.en = getelementptr inbounds [8 x i8], ptr %i.el, i64 %i.em ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #27
  %i.eo = getelementptr inbounds nuw [8 x i8], ptr %i.eg, i64 %.pre-phi173
  %i.ep = getelementptr inbounds [8 x i8], ptr %i.eo, i64 %i.em ; 2 uses
  store ptr %i.ep, ptr %7, align 8, !tbaa !462, !alias.scope !464
  ...
  store i64 %i.eh, ptr %i.g, align 8, !tbaa !469, !alias.scope !464
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #27
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #27
  store ptr %i.ek, ptr %3, align 8
  store i64 %.pre-phi, ptr %.sroa.484.0..sroa_idx, align 8
  store ptr %i.ej, ptr %.sroa.686.0..sroa_idx, align 8
  ...
  store i64 %i.eh, ptr %.sroa.1191.0..sroa_idx, align 8
  store i64 %.pre-phi173, ptr %.sroa.1292.0..sroa_idx, align 8
  store i64 %i.eh, ptr %.sroa.14.0..sroa_idx, align 8
  store ptr %i.en, ptr %i.h, align 8
  store i64 %.pre-phi, ptr %.sroa.18.96..sroa_idx, align 8
  store ptr %i.el, ptr %.sroa.19.96..sroa_idx, align 8
  ...
  store ptr %i.ek, ptr %i.i, align 8, !tbaa !472
  store i64 %i.eh, ptr %i.j, align 8, !tbaa !448
  store ptr %i.en, ptr %i.k, align 8, !tbaa !474
  store i64 %i.eh, ptr %i.l, align 8, !tbaa !448
  store i64 1, ptr %i.m, align 8, !tbaa !476
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #27
  store ptr %i.ep, ptr %4, align 8, !tbaa !502
  store i64 %i.eh, ptr %i.n, align 8, !tbaa !448
  ...
  %i.eq = add nuw nsw i64 %.052170, 1             ; 2 uses
  %exitcond.not = icmp eq i64 %i.eq, 5
