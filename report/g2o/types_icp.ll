...
bb.a:
  ...
  %3 = fadd double %i.am, %i.aq
  %i.ar = fadd double %i.ai, %3                   ; 2 uses
  ...
  %4 = fadd double %i.bi, %i.bj
  %i.bk = fadd double %i.bh, %4                   ; 2 uses
  ...
  %5 = fadd double %i.cd, %i.ce
  %i.cf = fadd double %i.cc, %5                   ; 2 uses
  ...
  %i.ej = fmul double %i.ar, %i.cj
  %i.ek = fmul double %i.bk, %i.co
  %i.el = fmul double %i.cf, %i.cu
