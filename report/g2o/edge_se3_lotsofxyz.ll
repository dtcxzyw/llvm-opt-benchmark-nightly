...
bb.c:                                             ; preds = %.preheader71.us, %bb.e
  ...
  %.02472.us = phi i32 [ 1, %.preheader71.us ], [ %i.ak, %bb.e ] ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %i.ab = add i32 %.02472.us, -1                  ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %i.ak = add i32 %.02472.us, 1                   ; 2 uses
...
bb.f:                                             ; preds = %.lr.ph, %_ZN3g2o10BaseVertexILi3EN5Eigen6MatrixIdLi3ELi1ELi0ELi3ELi1EEEE11setEstimateERKS3_.exit
  ...
  %.02375 = phi i32 [ 1, %.lr.ph ], [ %i.ds, %_ZN3g2o10BaseVertexILi3EN5Eigen6MatrixIdLi3ELi1ELi0ELi3ELi1EEEE11setEstimateERKS3_.exit ] ; 2 uses
  %i.bi = add i32 %.02375, -1                     ; 3 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %3 = load <2 x double>, ptr %i.av, align 16, !tbaa !72, !noalias !145
  %4 = load <2 x double>, ptr %i.aw, align 16, !tbaa !72, !noalias !145
  %5 = load <2 x double>, ptr %i.ax, align 16, !tbaa !72, !noalias !145
  %6 = load <2 x double>, ptr %i.ay, align 16, !tbaa !72, !noalias !145
  ...
  %i.db = extractelement <2 x double> %5, i64 0
  %i.dc = fmul double %10, %i.db
