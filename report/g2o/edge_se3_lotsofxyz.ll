...
vector.scevcheck:                                 ; preds = %.preheader43.us
  ...
  %i.s = getelementptr i8, ptr %scevgep67, i64 %mul.result
  %i.t = icmp ult ptr %i.s, %scevgep67
  %7 = or i1 %i.t, %mul.overflow
  %scevgep72.a = getelementptr i8, ptr %scevgep71.a, i64 %i.p ; 2 uses
  %i.u = getelementptr i8, ptr %scevgep72.a, i64 %mul.result
  %i.v = icmp ult ptr %i.u, %scevgep72.a
  %.reass = or i1 %i.r, %ident.check
  %i.w = or i1 %.reass, %7
  %i.x = or i1 %i.v, %i.w
