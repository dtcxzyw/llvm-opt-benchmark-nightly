...
_ZN5Eigen14QuaternionBaseINS_10QuaternionIdLi0EEEE9normalizeEv.exit:
  ...
  %.sroa.0164.0.vec.insert.i.a = insertelement <2 x double> poison, double %i.l, i64 0
  ...
  %.sroa.0164.8.vec.insert.i = insertelement <2 x double> %.sroa.0164.0.vec.insert.i.a, double %4, i64 1 ; 2 uses
  %i.ac = fmul <2 x double> %.sroa.0164.8.vec.insert.i, %.sroa.0164.8.vec.insert.i ; 2 uses
  ...
  %i.aj = insertelement <2 x double> %5, double %4, i64 0
  %6 = fmul <2 x double> %i.aj, %i.ag             ; 2 uses
