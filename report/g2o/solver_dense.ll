...
vector.body581:                                   ; preds = %vector.body581, %vector.ph579
  ...
  %wide.load583.a = load <2 x double>, ptr %i.cg, align 8, !tbaa !378, !alias.scope !1495, !noalias !1498
  %wide.load584.a = load <2 x double>, ptr %i.ci, align 8, !tbaa !378, !alias.scope !1495, !noalias !1498
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ch, i64 16 ; 2 uses
  %wide.load585.a = load <2 x double>, ptr %i.ch, align 8, !tbaa !378, !alias.scope !1498
  %wide.load586 = load <2 x double>, ptr %i.cj, align 8, !tbaa !378, !alias.scope !1498
  store <2 x double> %wide.load585.a, ptr %i.cg, align 8, !tbaa !378, !alias.scope !1495, !noalias !1498
  store <2 x double> %wide.load586, ptr %i.ci, align 8, !tbaa !378, !alias.scope !1495, !noalias !1498
  store <2 x double> %wide.load583.a, ptr %i.ch, align 8, !tbaa !378, !alias.scope !1498
  store <2 x double> %wide.load584.a, ptr %i.cj, align 8, !tbaa !378, !alias.scope !1498
  %index.next587 = add nuw i64 %index582, 4       ; 2 uses
  %i.ck = icmp eq i64 %index.next587, %n.vec580
  br i1 %i.ck, label %middle.block588, label %vector.body581, !llvm.loop !1500
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i.prol.loopexit, %.lr.ph.i.i.i.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.i.i.i.1, label %_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEELi1ELin1ELb0EEELi1ELin1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit, label %.lr.ph.i.i.i.i.i.i, !llvm.loop !1501
...
vector.body558:                                   ; preds = %vector.body558, %vector.ph556
  ...
  %wide.load560.a = load <2 x double>, ptr %i.ec, align 8, !tbaa !378, !alias.scope !1502, !noalias !1505
  %wide.load561.a = load <2 x double>, ptr %i.ee, align 8, !tbaa !378, !alias.scope !1502, !noalias !1505
  %i.ef = getelementptr inbounds nuw i8, ptr %i.ed, i64 16 ; 2 uses
  %wide.load562.a = load <2 x double>, ptr %i.ed, align 8, !tbaa !378, !alias.scope !1505
  %wide.load563 = load <2 x double>, ptr %i.ef, align 8, !tbaa !378, !alias.scope !1505
  store <2 x double> %wide.load562.a, ptr %i.ec, align 8, !tbaa !378, !alias.scope !1502, !noalias !1505
  store <2 x double> %wide.load563, ptr %i.ee, align 8, !tbaa !378, !alias.scope !1502, !noalias !1505
  store <2 x double> %wide.load560.a, ptr %i.ed, align 8, !tbaa !378, !alias.scope !1505
  store <2 x double> %wide.load561.a, ptr %i.ef, align 8, !tbaa !378, !alias.scope !1505
  %index.next564 = add nuw i64 %index559, 4       ; 2 uses
  %i.eg = icmp eq i64 %index.next564, %n.vec557
  br i1 %i.eg, label %middle.block565, label %vector.body558, !llvm.loop !1507
...
.lr.ph.i17.i.i.i.i.i.i.preheader:                 ; preds = %._crit_edge.i.i.i.i.i.i
  %i.ez = add i64 %.sroa.0.1.i.i.lcssa, %.0.i.i.i.i.i.i.i
  %i.fa = add i64 %i.ez, %i.ds
...
vector.body536:                                   ; preds = %vector.body536, %vector.ph534
  ...
  %wide.load538.a = load <2 x double>, ptr %i.fr, align 8, !tbaa !378, !alias.scope !1509, !noalias !1512
  %wide.load539.a = load <2 x double>, ptr %i.ft, align 8, !tbaa !378, !alias.scope !1509, !noalias !1512
  %i.fu = getelementptr inbounds nuw i8, ptr %i.fs, i64 16 ; 2 uses
  %wide.load540.a = load <2 x double>, ptr %i.fs, align 8, !tbaa !378, !alias.scope !1512
  %wide.load541 = load <2 x double>, ptr %i.fu, align 8, !tbaa !378, !alias.scope !1512
  store <2 x double> %wide.load540.a, ptr %i.fr, align 8, !tbaa !378, !alias.scope !1509, !noalias !1512
  store <2 x double> %wide.load541, ptr %i.ft, align 8, !tbaa !378, !alias.scope !1509, !noalias !1512
  store <2 x double> %wide.load538.a, ptr %i.fs, align 8, !tbaa !378, !alias.scope !1512
  store <2 x double> %wide.load539.a, ptr %i.fu, align 8, !tbaa !378, !alias.scope !1512
  %index.next542 = add nuw i64 %index537, 4       ; 2 uses
  %i.fv = icmp eq i64 %index.next542, %n.vec535
  br i1 %i.fv, label %middle.block543, label %vector.body536, !llvm.loop !1514
...
.lr.ph.i17.i.i.i.i.i.i:                           ; preds = %.lr.ph.i17.i.i.i.i.i.i.prol.loopexit, %.lr.ph.i17.i.i.i.i.i.i
  ...
  br i1 %exitcond.not.i19.i.i.i.i.i.i.1, label %_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEELin1ELi1ELb1EEELin1ELi1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit, label %.lr.ph.i17.i.i.i.i.i.i, !llvm.loop !1515
...
.lr.ph.i.i.i.i.i.i134:                            ; preds = %_ZN5Eigen8internal31unaligned_dense_assignment_loopILb0EE3runINS0_31generic_dense_assignment_kernelINS0_9evaluatorINS_5BlockINS6_INS_6MatrixIdLin1ELin1ELi0ELin1ELin1EEELin1ELi1ELb1EEELin1ELi1ELb0EEEEESB_NS0_14swap_assign_opIdEELi0EEEEEvRT_ll.exit.i.i.i.i.i.i, %.lr.ph.i.i.i.i.i.i134
  ...
  br i1 %i.gv, label %.lr.ph.i.i.i.i.i.i134, label %._crit_edge.i.i.i.i.i.i, !llvm.loop !1516
...
vector.body512:                                   ; preds = %vector.body512, %vector.ph510
  ...
  %wide.load514.a = load <2 x double>, ptr %i.hq, align 8, !tbaa !378, !alias.scope !1517, !noalias !1520
  %wide.load515.a = load <2 x double>, ptr %i.hr, align 8, !tbaa !378, !alias.scope !1517, !noalias !1520
  %i.hs = getelementptr [8 x i8], ptr %i.hc, i64 %i.hp ; 3 uses
  %i.ht = getelementptr i8, ptr %i.hs, i64 16     ; 2 uses
  %wide.load516.a = load <2 x double>, ptr %i.hs, align 8, !tbaa !378, !alias.scope !1520
  %wide.load517 = load <2 x double>, ptr %i.ht, align 8, !tbaa !378, !alias.scope !1520
  store <2 x double> %wide.load516.a, ptr %i.hq, align 8, !tbaa !378, !alias.scope !1517, !noalias !1520
  store <2 x double> %wide.load517, ptr %i.hr, align 8, !tbaa !378, !alias.scope !1517, !noalias !1520
  store <2 x double> %wide.load514.a, ptr %i.hs, align 8, !tbaa !378, !alias.scope !1520
  store <2 x double> %wide.load515.a, ptr %i.ht, align 8, !tbaa !378, !alias.scope !1520
  %index.next518 = add nuw i64 %index513, 4       ; 2 uses
  %i.hu = icmp eq i64 %index.next518, %n.vec511
  br i1 %i.hu, label %middle.block519, label %vector.body512, !llvm.loop !1522
