...
.lr.ph300.us.us.1:                                ; preds = %._crit_edge301.split.us.us
  ...
  %gep390 = getelementptr i8, ptr %i.ee, i64 16
...
.lr.ph.us.us.preheader.1:                         ; preds = %.lr.ph300.us.us.1
  ...
  %bound0.1 = icmp ult ptr %gep390, %scevgep384.1
...
.lr.ph300.us.us.2:                                ; preds = %._crit_edge301.split.us.us.1
  ...
  %gep392 = getelementptr i8, ptr %i.fm, i64 24
...
.lr.ph.us.us.preheader.2:                         ; preds = %.lr.ph300.us.us.2
  ...
  %bound0.2 = icmp ult ptr %gep392, %scevgep384.2
  %bound1.2 = icmp ult ptr %i.fw, %scevgep382
...
.lr.ph312.us.preheader:                           ; preds = %bb.r
  ...
  %i.bq = getelementptr i8, ptr %4, i64 %i.bd
  %i.br = getelementptr i8, ptr %2, i64 %17
...
.lr.ph308.us.us.preheader:                        ; preds = %.lr.ph312.us
  %i.bz = getelementptr i8, ptr %i.bq, i64 %i.bt
...
.lr.ph303.us.us:                                  ; preds = %.lr.ph303.us.us.preheader, %._crit_edge304.us.us
  %.0132305.us.us = phi i64 [ %i.fe, %._crit_edge304.us.us ], [ 0, %.lr.ph303.us.us.preheader ] ; 5 uses
  %i.dq = shl i64 %.0132305.us.us, 3
  %i.dr = sub i64 %i.dj, %i.dq
  %scevgep385.a = getelementptr i8, ptr %4, i64 %i.dr
  ...
  %i.eh = getelementptr [8 x i8], ptr %i.eg, i64 %i.dz ; 3 uses
...
.lr.ph.us.us.us.preheader:                        ; preds = %.lr.ph303.us.us
  ...
  %bound1 = icmp ult ptr %i.eh, %scevgep385.a
