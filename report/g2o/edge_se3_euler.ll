...
.lr.ph308.us.us:                                  ; preds = %.lr.ph308.us.us.preheader, %._crit_edge309.us.us
  ...
  %.0134310.us.us = phi i64 [ %i.fz, %._crit_edge309.us.us ], [ 0, %.lr.ph308.us.us.preheader ] ; 12 uses
  ...
  %i.cw = add i64 %.sroa.speculated216.us.us, %.0134310.us.us ; 3 uses
  ...
  %17 = call i64 @llvm.smax.i64(i64 %16, i64 %i.cw) ; 2 uses
  %18 = sub i64 %17, %i.ck                        ; 2 uses
  %min.iters.check392 = icmp ugt i64 %18, 3
  %or.cond = and i1 %min.iters.check392, %ident.check.not
  %i.dd = and i64 %17, 3                          ; 2 uses
  %n.vec394 = sub nuw i64 %18, %i.dd              ; 2 uses
...
bb.x:                                             ; preds = %bb.ac, %.lr.ph308.us.us
  ...
  %i.dl = sub nuw nsw i64 %smin, %.0133306.us.us  ; 3 uses
...
._crit_edge.split.us.us:                          ; preds = %._crit_edge304.us.us, %bb.x
  ...
  %i.ev = add nuw i64 %.0133306.us.us, %.sroa.speculated210.us.us
