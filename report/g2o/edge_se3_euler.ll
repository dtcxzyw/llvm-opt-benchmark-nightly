...
bb.b:                                             ; preds = %bb.a
  ...
  %5 = load <2 x double>, ptr %i.ah, align 8      ; 2 uses
  %i.ai = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  ...
  %7 = fmul <2 x double> %i.am, %6
  %8 = fsub <2 x double> %i.ak, %7
  %9 = getelementptr inbounds nuw i8, ptr %0, i64 544
  %10 = load <2 x double>, ptr %9, align 16, !tbaa !10
  %i.an = getelementptr inbounds nuw i8, ptr %0, i64 632
  %11 = load double, ptr %i.an, align 8, !tbaa !8
  %12 = insertelement <2 x double> poison, double %11, i64 0
  %13 = shufflevector <2 x double> %12, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.ao = fmul <2 x double> %10, %13
  %i.ap = fsub <2 x double> %8, %i.ao
...
bb.c:                                             ; preds = %bb.a
  ...
  %14 = load <2 x double>, ptr %i.gn, align 8     ; 2 uses
  %i.go = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  ...
  %15 = shufflevector <2 x double> %14, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 3 uses
  %16 = fmul <2 x double> %i.gs, %15
  %17 = fsub <2 x double> %i.gq, %16
  %18 = getelementptr inbounds nuw i8, ptr %0, i64 544
  %19 = load <2 x double>, ptr %18, align 16, !tbaa !10
  %i.gt = getelementptr inbounds nuw i8, ptr %0, i64 632
  %20 = load double, ptr %i.gt, align 8, !tbaa !8
  ...
  %i.gu = fmul <2 x double> %19, %22
  %i.gv = fsub <2 x double> %17, %i.gu
