...
bb.b:                                             ; preds = %bb.a
  ...
  %i.o = load <1 x double>, ptr %i.l, align 16    ; 2 uses
  %i.p = shufflevector <1 x double> %i.o, <1 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.u = load <1 x double>, ptr %i.t, align 8     ; 2 uses
  %i.v = shufflevector <1 x double> %i.u, <1 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.ab = load <1 x double>, ptr %i.aa, align 16  ; 2 uses
  %i.ac = shufflevector <1 x double> %i.ab, <1 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.ai = load <2 x double>, ptr %i.ah, align 8   ; 4 uses
  ...
  %i.ao = shufflevector <2 x double> %i.ai, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %5 = shufflevector <1 x double> %i.o, <1 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.bd = fmul <2 x double> %5, %i.bc
  %i.be = getelementptr inbounds nuw i8, ptr %0, i64 368
  %i.bf = load <2 x double>, ptr %i.be, align 16, !tbaa !10
  %6 = shufflevector <1 x double> %i.u, <1 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.bg = fmul <2 x double> %i.bf, %6
  ...
  %7 = shufflevector <1 x double> %i.ab, <1 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.bk = fmul <2 x double> %i.bj, %7
  ...
  %8 = shufflevector <2 x double> %i.ai, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.bo = fmul <2 x double> %i.bn, %8
  ...
  %9 = shufflevector <2 x double> %i.ai, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.bs = fmul <2 x double> %i.br, %9
  ...
  %i.cc = fmul <2 x double> %5, %i.cb
  %i.cd = getelementptr inbounds nuw i8, ptr %0, i64 384
  %i.ce = load <2 x double>, ptr %i.cd, align 16, !tbaa !10
  %i.cf = fmul <2 x double> %6, %i.ce
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.gd = load <1 x double>, ptr %i.ga, align 16  ; 2 uses
  %i.ge = shufflevector <1 x double> %i.gd, <1 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.gj = load <1 x double>, ptr %i.gi, align 8   ; 2 uses
  %i.gk = shufflevector <1 x double> %i.gj, <1 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.gq = load <1 x double>, ptr %i.gp, align 16  ; 2 uses
  %i.gr = shufflevector <1 x double> %i.gq, <1 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.gx = load <2 x double>, ptr %i.gw, align 8   ; 4 uses
  ...
  %i.hd = shufflevector <2 x double> %i.gx, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %10 = shufflevector <1 x double> %i.gd, <1 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.hs = fmul <2 x double> %10, %i.hr
  %i.ht = getelementptr inbounds nuw i8, ptr %0, i64 368
  %i.hu = load <2 x double>, ptr %i.ht, align 16, !tbaa !10
  %11 = shufflevector <1 x double> %i.gj, <1 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.hv = fmul <2 x double> %i.hu, %11
  ...
  %12 = shufflevector <1 x double> %i.gq, <1 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.hz = fmul <2 x double> %i.hy, %12
  ...
  %13 = shufflevector <2 x double> %i.gx, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.id = fmul <2 x double> %i.ic, %13
  ...
  %14 = shufflevector <2 x double> %i.gx, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.ih = fmul <2 x double> %i.ig, %14
...
bb.a:
  ...
  %2 = load double, ptr %i.ac, align 8, !tbaa !8, !noalias !108 ; 2 uses
  %i.ad = load double, ptr %i.d, align 16, !tbaa !8, !noalias !108
