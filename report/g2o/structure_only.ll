...
bb.be:                                            ; preds = %bb.bd, %bb.ba
  ...
  br i1 %.not242, label %._crit_edge288, label %.lr.ph287, !llvm.loop !170
...
.thread:                                          ; preds = %bb.ag, %bb.bi
  ...
  br i1 %or.cond, label %.loopexit244, label %.preheader243, !llvm.loop !171
...
.loopexit244:                                     ; preds = %.thread, %.thread219
  ...
  br i1 %or.cond303.not, label %.loopexit246, label %.lr.ph295, !llvm.loop !172
...
bb.bk:                                            ; preds = %.loopexit246, %._crit_edge
  ...
  br i1 %.not239, label %._crit_edge301, label %bb.e, !llvm.loop !173
...
bb.b:                                             ; preds = %bb.a, %.backedge
  ...
  %.0116455 = phi i64 [ 0, %bb.a ], [ %.pre-phi, %.backedge ] ; 23 uses
  %.0118454 = phi i8 [ 1, %bb.a ], [ %.3, %.backedge ] ; 6 uses
  %.0120453 = phi i1 [ false, %bb.a ], [ %.1121, %.backedge ] ; 2 uses
  %i.p = sub i64 2, %indvar                       ; 3 uses
  %i.q = mul nuw nsw i64 %.0116455, 24
  %i.r = getelementptr nuw i8, ptr %0, i64 %i.q
  %scevgep470 = getelementptr nuw i8, ptr %i.r, i64 24 ; 2 uses
  %i.s = shl nuw nsw i64 %.0116455, 5
  %i.t = getelementptr nuw i8, ptr %0, i64 %i.s
  %scevgep471 = getelementptr nuw i8, ptr %i.t, i64 8
  %.idx.i.i.i.i.i = shl nuw nsw i64 %.0116455, 5
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 %.idx.i.i.i.i.i ; 4 uses
  %.not404 = icmp eq i64 %.0116455, 2             ; 2 uses
...
_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit.thread: ; preds = %bb.b
  %i.v = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %.0116455
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i, %.lr.ph.i.i.i.i.preheader.new
  ...
  br i1 %niter.ncmp.1, label %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit.unr-lcssa, label %.lr.ph.i.i.i.i, !llvm.loop !193
...
_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit: ; preds = %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit.unr-lcssa, %.lr.ph.i.i.i.i.epil.preheader
  ...
  %i.aq = add i64 %.sroa.0.1.i.i.lcssa, %.0116455 ; 6 uses
  %i.ar = trunc i64 %i.aq to i32
  %i.as = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %.0116455
...
_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit..loopexit_crit_edge: ; preds = %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit.thread, %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit
  %.pre = add nuw nsw i64 %.0116455, 1
  %.pre418 = mul nuw nsw i64 %.0116455, 24
  br label %.loopexit
...
bb.c:                                             ; preds = %_ZNK5Eigen9DenseBaseINS_12CwiseUnaryOpINS_8internal13scalar_abs_opIdEEKNS_5BlockINS_8DiagonalINS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi0EEELin1ELi1ELb0EEEEEE8maxCoeffIlEEdPT_.exit
  ...
  %i.au = getelementptr [8 x i8], ptr %0, i64 %.0116455 ; 4 uses
  %i.av = getelementptr [8 x i8], ptr %0, i64 %i.aq ; 5 uses
  %.not405 = icmp eq i64 %.0116455, 0
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %bb.c
  ...
  %exitcond.not.i.i.i.i.i.i = icmp eq i64 %.0116455, 1
...
_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi1ELi3ELb0EEELi1ELin1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit: ; preds = %.lr.ph.i.i.i.i.i.i, %.lr.ph.i.i.i.i.i.i.1, %bb.c
  %.idx.i.i.i.i = mul nuw nsw i64 %.0116455, 24   ; 4 uses
...
.lr.ph.i17.i.i.i.i.i.i.preheader:                 ; preds = %._crit_edge.i.i.i.i.i.i
  ...
  %min.iters.check475 = icmp ult i64 %i.bw, 12
  br i1 %min.iters.check475, label %.lr.ph.i17.i.i.i.i.i.i.preheader493, label %vector.memcheck
...
vector.memcheck:                                  ; preds = %.lr.ph.i17.i.i.i.i.i.i.preheader
  ...
  %i.ce = getelementptr i8, ptr %scevgep471, i64 %i.cd
  %i.cf = getelementptr i8, ptr %i.ce, i64 %i.by
  %scevgep472 = getelementptr i8, ptr %i.cf, i64 %i.bz
  %i.cg = mul i64 %.sroa.0.1.i.i.lcssa, 24
  %scevgep473 = getelementptr i8, ptr %scevgep470, i64 %i.cg
  %bound0 = icmp ult ptr %scevgep, %scevgep473
  %bound1 = icmp ult ptr %scevgep472, %scevgep470
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %.lr.ph.i17.i.i.i.i.i.i.preheader493, label %vector.ph476

vector.ph476:                                     ; preds = %vector.memcheck
  %n.vec477 = and i64 %i.bw, -4                   ; 3 uses
  %i.ch = add i64 %i.bn, %n.vec477
...
vector.body478:                                   ; preds = %vector.body478, %vector.ph476
  ...
  %i.ci = add i64 %i.bn, %index479                ; 2 uses
  ...
  %wide.load480 = load <2 x double>, ptr %i.cj, align 8, !tbaa !101, !alias.scope !208, !noalias !209
  %wide.load481 = load <2 x double>, ptr %i.cl, align 8, !tbaa !101, !alias.scope !208, !noalias !209
  %i.cm = getelementptr inbounds nuw i8, ptr %i.ck, i64 16 ; 2 uses
  %wide.load482 = load <2 x double>, ptr %i.ck, align 8, !tbaa !101, !alias.scope !209
  %wide.load483 = load <2 x double>, ptr %i.cm, align 8, !tbaa !101, !alias.scope !209
  store <2 x double> %wide.load482, ptr %i.cj, align 8, !tbaa !101, !alias.scope !208, !noalias !209
  store <2 x double> %wide.load483, ptr %i.cl, align 8, !tbaa !101, !alias.scope !208, !noalias !209
  store <2 x double> %wide.load480, ptr %i.ck, align 8, !tbaa !101, !alias.scope !209
  store <2 x double> %wide.load481, ptr %i.cm, align 8, !tbaa !101, !alias.scope !209
  %index.next484 = add nuw i64 %index479, 4       ; 2 uses
  %i.cn = icmp eq i64 %index.next484, %n.vec477
  br i1 %i.cn, label %middle.block485, label %vector.body478, !llvm.loop !197

middle.block485:                                  ; preds = %vector.body478
  %cmp.n486 = icmp eq i64 %i.bw, %n.vec477
  br i1 %cmp.n486, label %_ZN5Eigen9DenseBaseINS_5BlockINS1_INS_6MatrixIdLi3ELi3ELi0ELi3ELi3EEELi3ELi1ELb1EEELin1ELi1ELb0EEEE4swapIS5_EEvRKNS0_IT_EE.exit, label %.lr.ph.i17.i.i.i.i.i.i.preheader493

.lr.ph.i17.i.i.i.i.i.i.preheader493:              ; preds = %vector.memcheck, %.lr.ph.i17.i.i.i.i.i.i.preheader, %middle.block485
  %.05.i18.i.i.i.i.i.i.ph = phi i64 [ %i.bn, %vector.memcheck ], [ %i.bn, %.lr.ph.i17.i.i.i.i.i.i.preheader ], [ %i.ch, %middle.block485 ]
