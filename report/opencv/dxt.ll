...
.lr.ph.us.preheader:                              ; preds = %.lr.ph75
  ...
  %i.p = shl nuw nsw i64 %wide.trip.count, 3      ; 5 uses
  %i.q = add nsw i64 %i.p, -4                     ; 2 uses
  %i.r = shl nuw nsw i64 %i.c, 3                  ; 4 uses
  ...
  %6 = getelementptr i8, ptr %1, i64 %i.r
  %7 = getelementptr i8, ptr %6, i64 %i.p
  %i.t = getelementptr i8, ptr %1, i64 %i.r
  %i.u = getelementptr i8, ptr %i.t, i64 12
  %i.v = getelementptr i8, ptr %1, i64 %i.p
  %i.w = getelementptr i8, ptr %1, i64 %i.r
  %i.x = getelementptr i8, ptr %i.w, i64 %i.p
...
vector.memcheck109:                               ; preds = %.lr.ph.us
  ...
  %scevgep119 = getelementptr i8, ptr %7, i64 %i.aj ; 2 uses
  %scevgep118 = getelementptr i8, ptr %i.u, i64 %i.aj ; 2 uses
  %scevgep117 = getelementptr i8, ptr %i.v, i64 %i.aj ; 2 uses
...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %i.l = shl nuw nsw i64 %i.f, 3                  ; 7 uses
  %i.m = shl nuw nsw i64 %i.e, 4                  ; 4 uses
  %i.n = shl nuw nsw i64 %i.e, 3                  ; 7 uses
  ...
  %or.cond = and i1 %min.iters.check, %ident.check.not
  %6 = getelementptr i8, ptr %1, i64 %i.y
  %7 = getelementptr i8, ptr %6, i64 %i.j
  %i.am = getelementptr i8, ptr %1, i64 %i.y
  %i.an = getelementptr i8, ptr %i.am, i64 4
  %i.ao = getelementptr i8, ptr %1, i64 %i.n
  %i.ap = getelementptr i8, ptr %i.ao, i64 %i.j
  %i.aq = getelementptr i8, ptr %1, i64 %i.n
  %i.ar = getelementptr i8, ptr %i.aq, i64 4
  %i.as = getelementptr i8, ptr %1, i64 %i.m
  %i.at = getelementptr i8, ptr %i.as, i64 %i.j
  %i.au = getelementptr i8, ptr %1, i64 %i.m
  %i.av = getelementptr i8, ptr %i.au, i64 4
  %i.aw = getelementptr i8, ptr %1, i64 %i.l
  %i.ax = getelementptr i8, ptr %i.aw, i64 %i.j
  %i.ay = getelementptr i8, ptr %1, i64 %i.l
  %i.az = getelementptr i8, ptr %i.ay, i64 4
  %i.ba = getelementptr i8, ptr %1, i64 %i.j
  %i.bb = getelementptr i8, ptr %1, i64 %i.l
  %i.bc = getelementptr i8, ptr %i.bb, i64 %i.n
  %i.bd = getelementptr i8, ptr %i.bc, i64 %i.j
  %i.be = getelementptr i8, ptr %i.bd, i64 -4
  %i.bf = getelementptr i8, ptr %1, i64 %i.l
...
vector.memcheck:                                  ; preds = %.preheader
  ...
  %scevgep200 = getelementptr i8, ptr %7, i64 %i.cg ; 5 uses
  %scevgep199 = getelementptr i8, ptr %i.an, i64 %i.cg ; 5 uses
  %scevgep198 = getelementptr i8, ptr %i.ap, i64 %i.cg ; 5 uses
  %scevgep197 = getelementptr i8, ptr %i.ar, i64 %i.cg ; 5 uses
  %scevgep196 = getelementptr i8, ptr %i.at, i64 %i.cg ; 5 uses
  %scevgep195 = getelementptr i8, ptr %i.av, i64 %i.cg ; 5 uses
  %scevgep194 = getelementptr i8, ptr %i.ax, i64 %i.cg ; 5 uses
  %scevgep193 = getelementptr i8, ptr %i.az, i64 %i.cg ; 5 uses
  %scevgep192 = getelementptr i8, ptr %i.ba, i64 %i.cg ; 5 uses
  %i.ch = getelementptr i8, ptr %1, i64 %i.cg
  %scevgep191 = getelementptr i8, ptr %i.ch, i64 4 ; 5 uses
  %scevgep186 = getelementptr i8, ptr %i.be, i64 %i.cg ; 5 uses
...
.lr.ph.us.preheader:                              ; preds = %.lr.ph75
  ...
  %i.r = shl nuw nsw i64 %wide.trip.count, 4      ; 5 uses
  %i.s = add nsw i64 %i.r, -8                     ; 2 uses
  %i.t = shl nuw nsw i64 %i.c, 4                  ; 4 uses
  ...
  %6 = getelementptr i8, ptr %1, i64 %i.t
  %7 = getelementptr i8, ptr %6, i64 %i.r
  %i.v = getelementptr i8, ptr %1, i64 %i.t
  %i.w = getelementptr i8, ptr %i.v, i64 24
  %i.x = getelementptr i8, ptr %1, i64 %i.r
  %i.y = getelementptr i8, ptr %1, i64 %i.t
  %i.z = getelementptr i8, ptr %i.y, i64 %i.r
  %i.aa = getelementptr i8, ptr %i.z, i64 -8
...
vector.memcheck107:                               ; preds = %.lr.ph.us
  ...
  %scevgep117 = getelementptr i8, ptr %7, i64 %i.al ; 2 uses
  %scevgep116 = getelementptr i8, ptr %i.w, i64 %i.al ; 2 uses
  %scevgep115 = getelementptr i8, ptr %i.x, i64 %i.al ; 2 uses
...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %i.l = shl nuw nsw i64 %i.f, 4                  ; 7 uses
  %i.m = shl nuw nsw i64 %i.e, 5                  ; 4 uses
  %i.n = shl nuw nsw i64 %i.e, 4                  ; 7 uses
...
vector.memcheck:                                  ; preds = %.preheader
  ...
  %scevgep200 = getelementptr i8, ptr %7, i64 %i.cd ; 5 uses
  %scevgep199 = getelementptr i8, ptr %i.an, i64 %i.cd ; 5 uses
  %scevgep198 = getelementptr i8, ptr %i.ap, i64 %i.cd ; 5 uses
  %scevgep197 = getelementptr i8, ptr %i.ar, i64 %i.cd ; 5 uses
  %scevgep196 = getelementptr i8, ptr %i.at, i64 %i.cd ; 5 uses
  %scevgep195 = getelementptr i8, ptr %i.av, i64 %i.cd ; 5 uses
  %scevgep194 = getelementptr i8, ptr %i.ax, i64 %i.cd ; 5 uses
  %scevgep193 = getelementptr i8, ptr %i.az, i64 %i.cd ; 5 uses
  %scevgep192 = getelementptr i8, ptr %i.ba, i64 %i.cd ; 5 uses
  %i.ce = getelementptr i8, ptr %1, i64 %i.cd
  %scevgep191 = getelementptr i8, ptr %i.ce, i64 8 ; 5 uses
  %scevgep186 = getelementptr i8, ptr %i.be, i64 %i.cd ; 5 uses
