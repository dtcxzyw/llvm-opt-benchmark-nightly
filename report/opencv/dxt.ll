...
bb.as:                                            ; preds = %bb.aq, %bb.ar
  ...
  br i1 %i.ey, label %bb.ak, label %.loopexit801, !llvm.loop !440
...
bb.at:                                            ; preds = %.lr.ph819, %bb.bb
  ...
  %i.ez = load i32, ptr %.3818, align 4, !tbaa !42 ; 2 uses
...
bb.ay:                                            ; preds = %bb.av
  %i.fc = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.fd = load ptr, ptr %15, align 8, !tbaa !51   ; 2 uses
...
bb.bb:                                            ; preds = %bb.az, %bb.ba
  ...
  br i1 %exitcond.not, label %.loopexit801, label %bb.at, !llvm.loop !441
...
.lr.ph826:                                        ; preds = %.lr.ph826, %.lr.ph826.preheader.new
  ...
  %i.fv = load float, ptr %i.fu, align 4, !tbaa !137
  %i.fw = fneg float %i.fv
  %i.fx = getelementptr inbounds nuw i8, ptr %i.ft, i64 12 ; 2 uses
  %i.fy = load float, ptr %i.fx, align 4, !tbaa !137
  %i.fz = fneg float %i.fy
  store float %i.fw, ptr %i.fu, align 4, !tbaa !137
  store float %i.fz, ptr %i.fx, align 4, !tbaa !137
  ...
  %i.gc = load float, ptr %i.gb, align 4, !tbaa !137
  %i.gd = fneg float %i.gc
  %i.ge = getelementptr inbounds nuw i8, ptr %i.ga, i64 28 ; 2 uses
  %i.gf = load float, ptr %i.ge, align 4, !tbaa !137
  %i.gg = fneg float %i.gf
  store float %i.gd, ptr %i.gb, align 4, !tbaa !137
  store float %i.gg, ptr %i.ge, align 4, !tbaa !137
  %indvars.iv.next943.1 = add nuw nsw i64 %indvars.iv942, 4 ; 3 uses
  %niter.next.1 = add nuw nsw i64 %niter, 2       ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge827.loopexit.unr-lcssa, label %.lr.ph826, !llvm.loop !442
...
.lr.ph826.epil.preheader:                         ; preds = %._crit_edge827.loopexit.unr-lcssa, %.lr.ph826.preheader
  ...
  %i.gj = load float, ptr %i.gi, align 4, !tbaa !137
  %i.gk = fneg float %i.gj
  %i.gl = getelementptr inbounds nuw i8, ptr %i.gh, i64 12 ; 2 uses
  %i.gm = load float, ptr %i.gl, align 4, !tbaa !137
  %i.gn = fneg float %i.gm
  store float %i.gk, ptr %i.gi, align 4, !tbaa !137
  store float %i.gn, ptr %i.gl, align 4, !tbaa !137
...
bb.bc:                                            ; preds = %._crit_edge827
  ...
  %i.gt = load float, ptr %i.gs, align 4, !tbaa !137
  %i.gu = fneg float %i.gt
  store float %i.gu, ptr %i.gs, align 4, !tbaa !137
  br label %bb.bd
...
bb.bd:                                            ; preds = %.loopexit801, %bb.bc, %._crit_edge827, %bb.r, %._crit_edge, %bb.z, %._crit_edge815
  ...
  %i.gw = load ptr, ptr %i.gv, align 8, !tbaa !145
  %i.gx = load i32, ptr %i.gw, align 4, !tbaa !42 ; 7 uses
  %i.gy = and i32 %i.gx, 1
...
.lr.ph840:                                        ; preds = %.preheader799
  %i.ha = load i32, ptr %i.e, align 4, !tbaa !140 ; 2 uses
...
.lr.ph836.us:                                     ; preds = %.lr.ph836.us.preheader, %..loopexit798_crit_edge.us
  %i.hn = phi i32 [ %i.sn, %..loopexit798_crit_edge.us ], [ 4, %.lr.ph836.us.preheader ] ; 7 uses
  ...
  br i1 %i.hs, label %.lr.ph832.us.us.preheader, label %.lr.ph836.split.us843.preheader

.lr.ph836.split.us843.preheader:                  ; preds = %.lr.ph836.us
  %i.ht = sext i32 %i.hn to i64
  br label %.lr.ph836.split.us843
...
.lr.ph836.split.us843:                            ; preds = %.lr.ph836.split.us843.preheader, %.lr.ph836.split.us843
  %indvars.iv945 = phi i64 [ 0, %.lr.ph836.split.us843.preheader ], [ %indvars.iv.next946, %.lr.ph836.split.us843 ] ; 2 uses
  ...
  %i.jn = load <2 x float>, ptr %i.ji, align 4, !tbaa !109 ; 3 uses
  %i.jo = load float, ptr %i.jj, align 4, !tbaa !137
  %i.jp = load <2 x float>, ptr %i.jk, align 4, !tbaa !109 ; 3 uses
  %i.jq = load float, ptr %i.jl, align 4, !tbaa !137
  ...
  %i.ju = load <2 x float>, ptr %i.jh, align 4, !tbaa !109 ; 2 uses
  %i.jv = load <2 x float>, ptr %i.jm, align 4, !tbaa !109 ; 2 uses
  ...
  store <2 x float> %i.ka, ptr %i.jh, align 4, !tbaa !109
  %i.kb = fsub <2 x float> %i.jx, %i.jz
  store <2 x float> %i.kb, ptr %i.ji, align 4, !tbaa !109
  %i.kc = fadd <2 x float> %i.jt, %i.jw
  store <2 x float> %i.kc, ptr %i.jm, align 4, !tbaa !109
  %i.kd = fsub <2 x float> %i.jw, %i.jt
  store <2 x float> %i.kd, ptr %i.jk, align 4, !tbaa !109
  %indvars.iv.next946 = add nsw i64 %indvars.iv945, %i.ht ; 2 uses
  %i.ke = icmp slt i64 %indvars.iv.next946, %i.hc
  br i1 %i.ke, label %.lr.ph836.split.us843, label %..loopexit798_crit_edge.us, !llvm.loop !443
...
.lr.ph832.us.us:                                  ; preds = %.lr.ph832.us.us.preheader, %._crit_edge833.us.us
  ...
  %i.kf = getelementptr inbounds [8 x i8], ptr %2, i64 %indvars.iv957 ; 6 uses
  %i.kg = getelementptr inbounds nuw [8 x i8], ptr %i.kf, i64 %i.hq ; 4 uses
  %i.kh = getelementptr inbounds nuw i8, ptr %i.kg, i64 4
  %i.ki = getelementptr inbounds nuw [8 x i8], ptr %i.kg, i64 %i.hr ; 3 uses
  %i.kj = getelementptr inbounds nuw i8, ptr %i.ki, i64 4
  %i.kk = getelementptr inbounds nuw [8 x i8], ptr %i.kf, i64 %i.hr ; 2 uses
  %i.kl = load <2 x float>, ptr %i.kg, align 4, !tbaa !109 ; 3 uses
  %i.km = load float, ptr %i.kh, align 4, !tbaa !137
  %i.kn = load <2 x float>, ptr %i.ki, align 4, !tbaa !109 ; 3 uses
  %i.ko = load float, ptr %i.kj, align 4, !tbaa !137
  %i.kp = shufflevector <2 x float> %i.kl, <2 x float> %i.kn, <2 x i32> <i32 1, i32 2>
  %i.kq = shufflevector <2 x float> %i.kn, <2 x float> %i.kl, <2 x i32> <i32 1, i32 2>
  %i.kr = fsub <2 x float> %i.kp, %i.kq           ; 2 uses
  %i.ks = load <2 x float>, ptr %i.kf, align 4, !tbaa !109 ; 2 uses
  %i.kt = load <2 x float>, ptr %i.kk, align 4, !tbaa !109 ; 2 uses
  %i.ku = fsub <2 x float> %i.ks, %i.kt           ; 2 uses
  %i.kv = fadd <2 x float> %i.ks, %i.kt           ; 2 uses
  %i.kw = fadd float %i.km, %i.ko
  %foldExtExtBinop1489 = fadd <2 x float> %i.kl, %i.kn
  %i.kx = insertelement <2 x float> %foldExtExtBinop1489, float %i.kw, i64 1 ; 2 uses
  %i.ky = fadd <2 x float> %i.kx, %i.kv
  store <2 x float> %i.ky, ptr %i.kf, align 4, !tbaa !109
  %i.kz = fsub <2 x float> %i.kv, %i.kx
  store <2 x float> %i.kz, ptr %i.kg, align 4, !tbaa !109
  %i.la = fadd <2 x float> %i.kr, %i.ku
  store <2 x float> %i.la, ptr %i.kk, align 4, !tbaa !109
  %i.lb = fsub <2 x float> %i.ku, %i.kr
  store <2 x float> %i.lb, ptr %i.ki, align 4, !tbaa !109
  br i1 %or.cond1436, label %vector.memcheck, label %scalar.ph.preheader

vector.memcheck:                                  ; preds = %.lr.ph832.us.us
  %i.lc = udiv i64 %21, %i.hv
  %i.ld = shl i64 %i.lc, 3
  %i.le = mul i64 %i.ld, %i.hv                    ; 3 uses
  %i.lf = add i64 %i.le, %i.hw                    ; 2 uses
  %scevgep1102 = getelementptr i8, ptr %scevgep1100, i64 %i.lf ; 3 uses
  %.reass = add i64 %i.le, %invariant.op          ; 2 uses
  %scevgep1106 = getelementptr i8, ptr %scevgep1105.a, i64 %.reass ; 6 uses
  %i.lg = add i64 %i.le, %i.hy                    ; 2 uses
  %i.lh = add i64 %i.lg, %i.hw                    ; 2 uses
  %scevgep1110 = getelementptr i8, ptr %scevgep1109.a, i64 %i.lh ; 6 uses
  %.reass1530 = add i64 %i.lg, %invariant.op1529  ; 2 uses
  %scevgep1114 = getelementptr i8, ptr %scevgep1113.a, i64 %.reass1530 ; 6 uses
  %scevgep1125 = getelementptr i8, ptr %2, i64 %i.lf ; 3 uses
  %scevgep1128 = getelementptr i8, ptr %2, i64 %.reass ; 6 uses
  %scevgep1131 = getelementptr i8, ptr %2, i64 %i.lh ; 3 uses
  %scevgep1134 = getelementptr i8, ptr %2, i64 %.reass1530 ; 4 uses
  %i.li = insertelement <4 x ptr> %i.iv, ptr %scevgep1110, i64 0
  %i.lj = insertelement <4 x ptr> %i.li, ptr %scevgep1106, i64 1
  %i.lk = insertelement <4 x ptr> %i.lj, ptr %scevgep1114, i64 2
  %i.ll = icmp ult <4 x ptr> %i.hg, %i.lk
  %i.lm = insertelement <4 x ptr> poison, ptr %scevgep1102, i64 0
  %i.ln = shufflevector <4 x ptr> %i.lm, <4 x ptr> poison, <4 x i32> zeroinitializer
  %i.lo = icmp ult <4 x ptr> %i.io, %i.ln
  ...
  %bound11229 = icmp ult ptr %scevgep1121.a, %scevgep1114
  %found.conflict1230 = and i1 %bound01228, %bound11229
  %i.lq = insertelement <4 x ptr> %i.iw, ptr %scevgep1128, i64 0
  %i.lr = insertelement <4 x ptr> %i.lq, ptr %scevgep1131, i64 1
  %i.ls = insertelement <4 x ptr> %i.lr, ptr %scevgep1134, i64 2
end_hunk_0
begin_hunk_1_@_ZN2cvL3DFTIfEEvRKNS_13OcvDftOptionsEPKNS_7ComplexIT_EEPS6_:_ZNKSt9type_infoeqERKS_.exit733.thread791
  %i.yq = getelementptr inbounds [8 x i8], ptr %i.us, i64 %i.yp
  store <2 x float> %i.yg, ptr %i.yq, align 4, !tbaa !109
  %i.yr = add nuw nsw i32 %.2674884.us, 1
  %indvars.iv.next992 = add nuw nsw i64 %indvars.iv991, %i.ul
  %exitcond994.not = icmp eq i32 %.2674884.us, %smax
  br i1 %exitcond994.not, label %._crit_edge888.split.us, label %.lr.ph877.us, !llvm.loop !456
...
._crit_edge888.split.us:                          ; preds = %._crit_edge878.us, %.preheader793, %bb.bq
  ...
  %indvars.iv.next963 = add nsw i64 %indvars.iv962, %i.un
  %exitcond1001.not = icmp eq i64 %indvars.iv.next996, %wide.trip.count1000
  br i1 %exitcond1001.not, label %._crit_edge893, label %bb.bp, !llvm.loop !457

._crit_edge893:                                   ; preds = %._crit_edge888.split.us
  %indvars.iv.next1003 = add nsw i64 %indvars.iv1002, %i.um ; 2 uses
  %i.ys = icmp slt i64 %indvars.iv.next1003, %i.uq
  br i1 %i.ys, label %.preheader795, label %._crit_edge895.split, !llvm.loop !458

._crit_edge895.split:                             ; preds = %._crit_edge893, %.preheader795.lr.ph, %_ZN2cv10AutoBufferINS_7ComplexIfEELm136EEC2Em.exit
  %.not.i.i755 = icmp eq ptr %i.uf, %scevgep.i
  br i1 %.not.i.i755, label %_ZN2cv10AutoBufferINS_7ComplexIfEELm136EED2Ev.exit, label %bb.bs

bb.bs:                                            ; preds = %._crit_edge895.split
  call void @_ZdaPv(ptr noundef nonnull %i.uf) #20
...
bb.bt:                                            ; preds = %bb.bm, %_ZN2cv10AutoBufferINS_7ComplexIfEELm136EED2Ev.exit, %bb.bk, %bb.bl
  ...
  %i.yt = load i32, ptr %0, align 8, !tbaa !22
  %i.yu = trunc nuw i64 %indvars.iv.next1006 to i32
  %i.yv = icmp sgt i32 %i.yt, %i.yu
  br i1 %i.yv, label %bb.bi, label %._crit_edge901, !llvm.loop !459

._crit_edge901:                                   ; preds = %bb.bt, %.loopexit797
  %i.yw = fcmp une float %i.n, 1.000000e+00
  br i1 %i.yw, label %bb.bu, label %bb.bv

bb.bu:                                            ; preds = %._crit_edge901
  %i.yx = fneg float %i.n
  %.0638 = select i1 %i.i, float %i.yx, float %i.n ; 2 uses
  %i.yy = load i32, ptr %i.e, align 4, !tbaa !140 ; 3 uses
  %i.yz = icmp sgt i32 %i.yy, 0
  br i1 %i.yz, label %.lr.ph910.preheader, label %.critedge

.lr.ph910.preheader:                              ; preds = %bb.bu
  %wide.trip.count1014 = zext nneg i32 %i.yy to i64 ; 3 uses
  %min.iters.check1422 = icmp eq i32 %i.yy, 1
...
vector.body1427:                                  ; preds = %vector.body1427, %vector.ph1423
  ...
  %i.za = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %index1428 ; 2 uses
  %wide.vec1429 = load <4 x float>, ptr %i.za, align 4, !tbaa !109 ; 2 uses
  ...
  %i.zb = shufflevector <2 x float> %strided.vec1430, <2 x float> %broadcast.splatinsert1425, <4 x i32> <i32 0, i32 2, i32 1, i32 2>
  %i.zc = shufflevector <2 x float> %broadcast.splatinsert, <2 x float> %strided.vec1431, <4 x i32> <i32 0, i32 2, i32 0, i32 3>
  %interleaved.vec1432 = fmul <4 x float> %i.zb, %i.zc
  store <4 x float> %interleaved.vec1432, ptr %i.za, align 4, !tbaa !109
  %index.next1433 = add nuw i64 %index1428, 2     ; 2 uses
  %i.zd = icmp eq i64 %index.next1433, %n.vec1424
  br i1 %i.zd, label %middle.block1434, label %vector.body1427, !llvm.loop !460
...
.lr.ph910.preheader1491:                          ; preds = %.lr.ph910.preheader, %middle.block1434
  ...
  %i.ze = insertelement <2 x float> poison, float %i.n, i64 0
  %i.zf = insertelement <2 x float> %i.ze, float %.0638, i64 1
  br label %.lr.ph910
...
.lr.ph910:                                        ; preds = %.lr.ph910.preheader1491, %.lr.ph910
  ...
  %i.zg = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv1011 ; 2 uses
  %i.zh = load <2 x float>, ptr %i.zg, align 4, !tbaa !109
  %i.zi = fmul <2 x float> %i.zh, %i.zf
  store <2 x float> %i.zi, ptr %i.zg, align 4, !tbaa !109
  ...
  br i1 %exitcond1015.not, label %.critedge, label %.lr.ph910, !llvm.loop !461

bb.bv:                                            ; preds = %._crit_edge901
  br i1 %i.i, label %.preheader, label %.critedge

.preheader:                                       ; preds = %bb.bv
  %i.zj = load i32, ptr %i.e, align 4, !tbaa !140 ; 4 uses
  %.not716902 = icmp slt i32 %i.zj, 2
  br i1 %.not716902, label %._crit_edge905, label %.lr.ph904.preheader

.lr.ph904.preheader:                              ; preds = %.preheader
  %i.zk = add nsw i32 %i.zj, -2
  %i.zl = lshr i32 %i.zk, 1                       ; 2 uses
  %narrow1516 = add nuw i32 %i.zl, 1              ; 2 uses
  %i.zm = zext i32 %narrow1516 to i64             ; 2 uses
  %xtraiter1510 = and i64 %i.zm, 1
  %i.zn = icmp eq i32 %i.zl, 0
  br i1 %i.zn, label %.lr.ph904.epil.preheader, label %.lr.ph904.preheader.new

.lr.ph904.preheader.new:                          ; preds = %.lr.ph904.preheader
  %unroll_iter1514 = and i64 %i.zm, 4294967294
  br label %.lr.ph904
...
.lr.ph904:                                        ; preds = %.lr.ph904, %.lr.ph904.preheader.new
  ...
  %i.zo = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv1008 ; 2 uses
  %i.zp = getelementptr inbounds nuw i8, ptr %i.zo, i64 4 ; 2 uses
  %i.zq = load float, ptr %i.zp, align 4, !tbaa !137
  %i.zr = fneg float %i.zq
  %i.zs = getelementptr inbounds nuw i8, ptr %i.zo, i64 12 ; 2 uses
  %i.zt = load float, ptr %i.zs, align 4, !tbaa !137
  %i.zu = fneg float %i.zt
  store float %i.zr, ptr %i.zp, align 4, !tbaa !137
  store float %i.zu, ptr %i.zs, align 4, !tbaa !137
  %i.zv = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv1008 ; 2 uses
  %i.zw = getelementptr inbounds nuw i8, ptr %i.zv, i64 20 ; 2 uses
  %i.zx = load float, ptr %i.zw, align 4, !tbaa !137
  %i.zy = fneg float %i.zx
  %i.zz = getelementptr inbounds nuw i8, ptr %i.zv, i64 28 ; 2 uses
  %i.aaa = load float, ptr %i.zz, align 4, !tbaa !137
  %i.aab = fneg float %i.aaa
  store float %i.zy, ptr %i.zw, align 4, !tbaa !137
  store float %i.aab, ptr %i.zz, align 4, !tbaa !137
  ...
  br i1 %niter1515.ncmp.1, label %._crit_edge905.loopexit.unr-lcssa, label %.lr.ph904, !llvm.loop !462
...
.lr.ph904.epil.preheader:                         ; preds = %._crit_edge905.loopexit.unr-lcssa, %.lr.ph904.preheader
  ...
  %i.aac = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv1008.epil.init ; 2 uses
  %i.aad = getelementptr inbounds nuw i8, ptr %i.aac, i64 4 ; 2 uses
  %i.aae = load float, ptr %i.aad, align 4, !tbaa !137
  %i.aaf = fneg float %i.aae
  %i.aag = getelementptr inbounds nuw i8, ptr %i.aac, i64 12 ; 2 uses
  %i.aah = load float, ptr %i.aag, align 4, !tbaa !137
  %i.aai = fneg float %i.aah
  store float %i.aaf, ptr %i.aad, align 4, !tbaa !137
  store float %i.aai, ptr %i.aag, align 4, !tbaa !137
...
._crit_edge905.loopexit:                          ; preds = %._crit_edge905.loopexit.unr-lcssa, %.lr.ph904.epil.preheader
  ...
  %i.aaj = trunc nuw nsw i64 %indvars.iv.next1009.lcssa to i32
  br label %._crit_edge905

._crit_edge905:                                   ; preds = %._crit_edge905.loopexit, %.preheader
  %.8.lcssa = phi i32 [ 0, %.preheader ], [ %i.aaj, %._crit_edge905.loopexit ]
  %i.aak = icmp slt i32 %.8.lcssa, %i.zj
  br i1 %i.aak, label %bb.bw, label %.critedge

bb.bw:                                            ; preds = %._crit_edge905
  %i.aal = zext nneg i32 %i.zj to i64
  %i.aam = getelementptr [8 x i8], ptr %2, i64 %i.aal
  %i.aan = getelementptr i8, ptr %i.aam, i64 -4   ; 2 uses
  %i.aao = load float, ptr %i.aan, align 4, !tbaa !137
  %i.aap = fneg float %i.aao
  store float %i.aap, ptr %i.aan, align 4, !tbaa !137
  br label %.critedge
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <4 x float>, ptr %i.j, align 4, !tbaa !109 ; 2 uses
  %i.k = getelementptr inbounds nuw [8 x i8], ptr %i.j, i64 %i.c ; 2 uses
  %wide.vec103 = load <4 x float>, ptr %i.k, align 4, !tbaa !109 ; 2 uses
  %interleaved.vec = fadd <4 x float> %wide.vec, %wide.vec103
  store <4 x float> %interleaved.vec, ptr %i.j, align 4, !tbaa !109
  %interleaved.vec106 = fsub <4 x float> %wide.vec, %wide.vec103
  store <4 x float> %interleaved.vec106, ptr %i.k, align 4, !tbaa !109
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.l = icmp eq i64 %index.next, %n.vec
  br i1 %i.l, label %middle.block, label %vector.body, !llvm.loop !471
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge.us
  ...
  %i.ag = load <2 x float>, ptr %i.ae, align 4, !tbaa !109 ; 2 uses
  %i.ah = load <2 x float>, ptr %i.af, align 4, !tbaa !109 ; 2 uses
  %i.ai = fadd <2 x float> %i.ag, %i.ah
  store <2 x float> %i.ai, ptr %i.ae, align 4, !tbaa !109
  %i.aj = fsub <2 x float> %i.ag, %i.ah
  store <2 x float> %i.aj, ptr %i.af, align 4, !tbaa !109
...
vector.body149:                                   ; preds = %vector.memcheck109, %vector.body149
  ...
  %wide.vec151 = load <8 x float>, ptr %i.ap, align 4, !tbaa !109 ; 2 uses
  ...
  %wide.vec154 = load <8 x float>, ptr %i.aq, align 4, !tbaa !109 ; 2 uses
  ...
  %wide.vec157 = load <8 x float>, ptr %i.ao, align 4, !tbaa !109 ; 2 uses
  ...
  store <8 x float> %interleaved.vec160.a, ptr %i.ao, align 4, !tbaa !109
  ...
  store <8 x float> %interleaved.vec161, ptr %i.ap, align 4, !tbaa !109
  %index.next162 = add nuw i64 %index150, 4       ; 2 uses
  %i.ba = icmp eq i64 %index.next162, %n.vec148
  br i1 %i.ba, label %middle.block163, label %vector.body149, !llvm.loop !472
...
scalar.ph145:                                     ; preds = %scalar.ph145.preheader, %scalar.ph145
  ...
  %i.be = load float, ptr %i.bd, align 4, !tbaa !136
  %i.bf = getelementptr inbounds nuw i8, ptr %i.bd, i64 4
  %i.bg = load float, ptr %i.bf, align 4, !tbaa !137 ; 2 uses
  %i.bh = fneg float %i.bg
  %i.bi = load <2 x float>, ptr %i.bc, align 4, !tbaa !109 ; 2 uses
  ...
  %i.bq = load <2 x float>, ptr %i.bb, align 4, !tbaa !109 ; 2 uses
  %i.br = fadd <2 x float> %i.bq, %i.bp
  store <2 x float> %i.br, ptr %i.bb, align 4, !tbaa !109
  %i.bs = fsub <2 x float> %i.bq, %i.bp
  store <2 x float> %i.bs, ptr %i.bc, align 4, !tbaa !109
  ...
  br i1 %exitcond.not, label %._crit_edge.us, label %scalar.ph145, !llvm.loop !473
...
._crit_edge.us:                                   ; preds = %scalar.ph145, %middle.block163
  ...
  br i1 %i.bu, label %.lr.ph.us, label %._crit_edge76, !llvm.loop !474
...
.lr.ph75.split:                                   ; preds = %.lr.ph75.split.preheader168, %.lr.ph75.split
  ...
  %i.bx = load <2 x float>, ptr %i.bv, align 4, !tbaa !109 ; 2 uses
  %i.by = load <2 x float>, ptr %i.bw, align 4, !tbaa !109 ; 2 uses
  %i.bz = fadd <2 x float> %i.bx, %i.by
  store <2 x float> %i.bz, ptr %i.bv, align 4, !tbaa !109
  %i.ca = fsub <2 x float> %i.bx, %i.by
  store <2 x float> %i.ca, ptr %i.bw, align 4, !tbaa !109
  %indvars.iv.next = add nsw i64 %indvars.iv, %i.e ; 2 uses
  %i.cb = icmp slt i64 %indvars.iv.next, %i.f
  br i1 %i.cb, label %.lr.ph75.split, label %._crit_edge76, !llvm.loop !475
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <8 x float>, ptr %i.n, align 4, !tbaa !109 ; 2 uses
  ...
  %wide.vec181 = load <8 x float>, ptr %i.o, align 4, !tbaa !109 ; 2 uses
  ...
  %wide.vec184 = load <8 x float>, ptr %i.m, align 4, !tbaa !109 ; 2 uses
  ...
  store <8 x float> %interleaved.vec, ptr %i.m, align 4, !tbaa !109
  ...
  store <8 x float> %interleaved.vec187.a, ptr %i.n, align 4, !tbaa !109
  ...
  store <8 x float> %interleaved.vec188, ptr %i.o, align 4, !tbaa !109
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ad = icmp eq i64 %index.next, %n.vec
  br i1 %i.ad, label %middle.block, label %vector.body, !llvm.loop !476
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge.us
  ...
  %i.bq = load <2 x float>, ptr %i.bo, align 4, !tbaa !109 ; 3 uses
  %i.br = load <2 x float>, ptr %i.bp, align 4, !tbaa !109 ; 3 uses
  %i.bs = fadd <2 x float> %i.bq, %i.br           ; 2 uses
  %i.bt = load <2 x float>, ptr %i.bn, align 4, !tbaa !109 ; 2 uses
  ...
  store <2 x float> %i.by, ptr %i.bn, align 4, !tbaa !109
  ...
  store <2 x float> %i.ca, ptr %i.bo, align 4, !tbaa !109
  %i.cb = fsub <2 x float> %i.bz, %i.bx
  store <2 x float> %i.cb, ptr %i.bp, align 4, !tbaa !109
...
bb.aq:                                            ; preds = %bb.ak
  ...
  %i.ei = load <2 x double>, ptr %i.ef, align 8, !tbaa !113
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ef, ptr noundef nonnull align 8 dereferenceable(16) %i.eh, i64 16, i1 false), !tbaa.struct !535
  store <2 x double> %i.ei, ptr %i.eh, align 8, !tbaa !113
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %i.em = load <2 x double>, ptr %i.ek, align 8, !tbaa !113
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ek, ptr noundef nonnull align 8 dereferenceable(16) %i.el, i64 16, i1 false), !tbaa.struct !535
  store <2 x double> %i.em, ptr %i.el, align 8, !tbaa !113
  %i.en = getelementptr inbounds nuw [16 x i8], ptr %i.dr, i64 %i.ee ; 2 uses
  %i.eo = getelementptr i8, ptr %i.eh, i64 16     ; 2 uses
  %i.ep = load <2 x double>, ptr %i.en, align 8, !tbaa !113
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.en, ptr noundef nonnull align 8 dereferenceable(16) %i.eo, i64 16, i1 false), !tbaa.struct !535
  store <2 x double> %i.ep, ptr %i.eo, align 8, !tbaa !113
  br label %bb.as
...
bb.as:                                            ; preds = %bb.aq, %bb.ar
  ...
  br i1 %i.er, label %bb.ak, label %.loopexit814, !llvm.loop !512
...
bb.at:                                            ; preds = %.lr.ph832, %bb.bb
  ...
  %i.es = load i32, ptr %.3831, align 4, !tbaa !42 ; 2 uses
...
.lr.ph849.us:                                     ; preds = %.lr.ph849.us.preheader, %..loopexit811_crit_edge.us
  %i.hf = phi i32 [ %i.re, %..loopexit811_crit_edge.us ], [ 4, %.lr.ph849.us.preheader ] ; 7 uses
  ...
  br i1 %i.hk, label %.lr.ph845.us.us.preheader, label %.lr.ph849.split.us856.preheader
...
.lr.ph845.us.us:                                  ; preds = %.lr.ph845.us.us.preheader, %._crit_edge846.us.us
  ...
  %i.jw = getelementptr inbounds nuw [16 x i8], ptr %i.jv, i64 %i.hi ; 4 uses
  %i.jx = getelementptr inbounds nuw i8, ptr %i.jw, i64 8
  %i.jy = getelementptr inbounds nuw [16 x i8], ptr %i.jw, i64 %i.hj ; 3 uses
  %i.jz = getelementptr inbounds nuw i8, ptr %i.jy, i64 8
  %i.ka = getelementptr inbounds nuw [16 x i8], ptr %i.jv, i64 %i.hj ; 2 uses
...
vector.memcheck:                                  ; preds = %.lr.ph845.us.us
  %i.kt = udiv i64 %21, %i.hn
  %i.ku = shl i64 %i.kt, 4
  %i.kv = mul i64 %i.ku, %i.hn                    ; 3 uses
  %i.kw = add i64 %i.kv, %i.ho                    ; 2 uses
  %scevgep1116 = getelementptr i8, ptr %scevgep1114, i64 %i.kw ; 3 uses
  %.reass = add i64 %i.kv, %invariant.op          ; 2 uses
  %scevgep1120 = getelementptr i8, ptr %scevgep1119.a, i64 %.reass ; 6 uses
  %i.kx = add i64 %i.kv, %i.hq                    ; 2 uses
  %i.ky = add i64 %i.kx, %i.ho                    ; 2 uses
  %scevgep1124 = getelementptr i8, ptr %scevgep1123.a, i64 %i.ky ; 6 uses
  %.reass1536 = add i64 %i.kx, %invariant.op1535  ; 2 uses
  %scevgep1128 = getelementptr i8, ptr %scevgep1127.a, i64 %.reass1536 ; 6 uses
  %scevgep1139 = getelementptr i8, ptr %2, i64 %i.kw ; 3 uses
  %scevgep1142 = getelementptr i8, ptr %2, i64 %.reass ; 6 uses
  %scevgep1145 = getelementptr i8, ptr %2, i64 %i.ky ; 3 uses
  %scevgep1148 = getelementptr i8, ptr %2, i64 %.reass1536 ; 4 uses
  %i.kz = insertelement <4 x ptr> %i.in, ptr %scevgep1124, i64 0
  %i.la = insertelement <4 x ptr> %i.kz, ptr %scevgep1120, i64 1
  %i.lb = insertelement <4 x ptr> %i.la, ptr %scevgep1128, i64 2
  %i.lc = icmp ult <4 x ptr> %i.gy, %i.lb
  %i.ld = insertelement <4 x ptr> poison, ptr %scevgep1116, i64 0
  %i.le = shufflevector <4 x ptr> %i.ld, <4 x ptr> poison, <4 x i32> zeroinitializer
  %i.lf = icmp ult <4 x ptr> %i.ig, %i.le
  ...
  %i.lh = insertelement <4 x ptr> %i.io, ptr %scevgep1142, i64 0
  %i.li = insertelement <4 x ptr> %i.lh, ptr %scevgep1145, i64 1
  %i.lj = insertelement <4 x ptr> %i.li, ptr %scevgep1148, i64 2
  %i.lk = icmp ult <4 x ptr> %i.hb, %i.lj
  %i.ll = insertelement <4 x ptr> poison, ptr %scevgep1139, i64 0
end_hunk_2
begin_hunk_3_@_ZN2cvL3DFTIdEEvRKNS_13OcvDftOptionsEPKNS_7ComplexIT_EEPS6_:_ZNKSt9type_infoeqERKS_.exit.thread804
  store double %i.xi, ptr %.sroa.6.0..sroa_idx17, align 8, !tbaa !113
  ...
  br i1 %exitcond1007.not, label %._crit_edge901, label %.lr.ph900, !llvm.loop !528
...
._crit_edge901:                                   ; preds = %._crit_edge891, %.preheader806, %bb.bq
  ...
  br i1 %exitcond1014.not, label %._crit_edge906, label %bb.bp, !llvm.loop !529
...
._crit_edge906:                                   ; preds = %._crit_edge901
  ...
  br i1 %i.xk, label %.preheader808, label %._crit_edge908.split, !llvm.loop !530
...
bb.bt:                                            ; preds = %bb.bm, %_ZN2cv10AutoBufferINS_7ComplexIdEELm72EED2Ev.exit, %bb.bk, %bb.bl
  ...
  %i.xl = load i32, ptr %0, align 8, !tbaa !22
  %i.xm = trunc nuw i64 %indvars.iv.next1019 to i32
  %i.xn = icmp sgt i32 %i.xl, %i.xm
  br i1 %i.xn, label %bb.bi, label %._crit_edge914, !llvm.loop !531
...
bb.bu:                                            ; preds = %._crit_edge914
  ...
  %i.xq = load i32, ptr %i.e, align 4, !tbaa !140 ; 3 uses
...
vector.body1439:                                  ; preds = %vector.body1439, %vector.ph1437
  ...
  br i1 %i.xz, label %middle.block1443, label %vector.body1439, !llvm.loop !532
...
.lr.ph923:                                        ; preds = %.lr.ph923.preheader1497, %.lr.ph923
  ...
  %i.yd = load <2 x double>, ptr %i.yc, align 8, !tbaa !113
  %i.ye = fmul <2 x double> %i.yb, %i.yd
  store <2 x double> %i.ye, ptr %i.yc, align 8, !tbaa !113
  ...
  br i1 %exitcond1028.not, label %.critedge, label %.lr.ph923, !llvm.loop !533

bb.bv:                                            ; preds = %._crit_edge914
  br i1 %i.i, label %.preheader, label %.critedge

.preheader:                                       ; preds = %bb.bv
  %i.yf = load i32, ptr %i.e, align 4, !tbaa !140 ; 4 uses
...
.lr.ph917:                                        ; preds = %.lr.ph917, %.lr.ph917.preheader.new
  ...
  %i.ym = load double, ptr %i.yl, align 8, !tbaa !134
  %i.yn = fneg double %i.ym
  %i.yo = getelementptr inbounds nuw i8, ptr %i.yk, i64 24 ; 2 uses
  %i.yp = load double, ptr %i.yo, align 8, !tbaa !134
  %i.yq = fneg double %i.yp
  store double %i.yn, ptr %i.yl, align 8, !tbaa !134
  store double %i.yq, ptr %i.yo, align 8, !tbaa !134
  ...
  %i.yt = load double, ptr %i.ys, align 8, !tbaa !134
  %i.yu = fneg double %i.yt
  %i.yv = getelementptr inbounds nuw i8, ptr %i.yr, i64 56 ; 2 uses
  %i.yw = load double, ptr %i.yv, align 8, !tbaa !134
  %i.yx = fneg double %i.yw
  store double %i.yu, ptr %i.ys, align 8, !tbaa !134
  store double %i.yx, ptr %i.yv, align 8, !tbaa !134
  ...
  br i1 %niter1521.ncmp.1, label %._crit_edge918.loopexit.unr-lcssa, label %.lr.ph917, !llvm.loop !534
...
.lr.ph917.epil.preheader:                         ; preds = %._crit_edge918.loopexit.unr-lcssa, %.lr.ph917.preheader
  ...
  %i.za = load double, ptr %i.yz, align 8, !tbaa !134
  %i.zb = fneg double %i.za
  %i.zc = getelementptr inbounds nuw i8, ptr %i.yy, i64 24 ; 2 uses
  %i.zd = load double, ptr %i.zc, align 8, !tbaa !134
  %i.ze = fneg double %i.zd
  store double %i.zb, ptr %i.yz, align 8, !tbaa !134
  store double %i.ze, ptr %i.zc, align 8, !tbaa !134
...
bb.bw:                                            ; preds = %._crit_edge918
  ...
  %i.zk = load double, ptr %i.zj, align 8, !tbaa !134
  %i.zl = fneg double %i.zk
  store double %i.zl, ptr %i.zj, align 8, !tbaa !134
  br label %.critedge
...
.lr.ph75.split.preheader:                         ; preds = %.lr.ph75
  ...
  %ident.check.not = icmp eq i32 %3, 1
  %or.cond = and i1 %min.iters.check, %ident.check.not
  br i1 %or.cond, label %vector.memcheck, label %.lr.ph75.split.preheader161

.lr.ph75.split.preheader161:                      ; preds = %vector.memcheck, %.lr.ph75.split.preheader
  br label %.lr.ph75.split
...
vector.memcheck:                                  ; preds = %.lr.ph75.split.preheader
  ...
  %found.conflict101 = and i1 %bound099, %bound1100
  %conflict.rdx = or i1 %found.conflict, %found.conflict101
  br i1 %conflict.rdx, label %.lr.ph75.split.preheader161, label %vector.body
...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %wide.load102 = load <2 x double>, ptr %i.k, align 8 ; 2 uses
  %i.l = fadd <2 x double> %wide.load, %wide.load102
  %i.m = fsub <2 x double> %wide.load, %wide.load102
  ...
  br i1 %i.n, label %._crit_edge76, label %vector.body, !llvm.loop !544
...
.lr.ph.us.preheader:                              ; preds = %.lr.ph75
  ...
  %scevgep110.a = getelementptr i8, ptr %5, i64 16 ; 2 uses
  %scevgep111.a = getelementptr i8, ptr %5, i64 %i.s ; 2 uses
  %scevgep116.a = getelementptr i8, ptr %5, i64 24 ; 2 uses
  %scevgep117 = getelementptr i8, ptr %5, i64 %i.r ; 2 uses
  %i.v = add nsw i64 %wide.trip.count, -1         ; 3 uses
  %min.iters.check142 = icmp sgt i32 %3, 9
  %ident.check104.not = icmp eq i32 %4, 1
  %or.cond160 = and i1 %min.iters.check142, %ident.check104.not
  ...
  %n.vec144 = and i64 %i.v, -2                    ; 2 uses
  %i.af = or i64 %i.v, 1                          ; 2 uses
  %cmp.n157 = icmp eq i64 %i.v, %n.vec144
  br label %.lr.ph.us
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge.us
  ...
  %i.ai = load <2 x double>, ptr %i.ag, align 8, !tbaa !113 ; 2 uses
  %i.aj = load <2 x double>, ptr %i.ah, align 8, !tbaa !113 ; 2 uses
  %i.ak = fadd <2 x double> %i.ai, %i.aj
  store <2 x double> %i.ak, ptr %i.ag, align 8, !tbaa !113
  %i.al = fsub <2 x double> %i.ai, %i.aj
  store <2 x double> %i.al, ptr %i.ah, align 8, !tbaa !113
  br i1 %or.cond160, label %vector.memcheck105, label %scalar.ph141.preheader

vector.memcheck105:                               ; preds = %.lr.ph.us
  %i.am = mul i64 %i.q, %indvar                   ; 8 uses
  %scevgep115 = getelementptr i8, ptr %i.w, i64 %i.am ; 2 uses
  %scevgep114 = getelementptr i8, ptr %i.y, i64 %i.am ; 2 uses
  %scevgep113 = getelementptr i8, ptr %i.z, i64 %i.am ; 2 uses
  %i.an = getelementptr i8, ptr %1, i64 %i.am
  %scevgep112 = getelementptr i8, ptr %i.an, i64 24 ; 2 uses
  %scevgep109 = getelementptr i8, ptr %i.ab, i64 %i.am ; 2 uses
  %scevgep108 = getelementptr i8, ptr %i.ad, i64 %i.am ; 2 uses
  %scevgep107 = getelementptr i8, ptr %i.ae, i64 %i.am ; 2 uses
  %i.ao = getelementptr i8, ptr %1, i64 %i.am
  %scevgep106 = getelementptr i8, ptr %i.ao, i64 16 ; 2 uses
  %bound0118 = icmp ult ptr %scevgep106, %scevgep109
  %bound1119 = icmp ult ptr %scevgep108, %scevgep107
  %found.conflict120 = and i1 %bound0118, %bound1119
  %bound0121 = icmp ult ptr %scevgep106, %scevgep111.a
  %bound1122 = icmp ult ptr %scevgep110.a, %scevgep107
  %found.conflict123 = and i1 %bound0121, %bound1122
  %conflict.rdx124 = or i1 %found.conflict120, %found.conflict123
  %bound0125 = icmp ult ptr %scevgep108, %scevgep111.a
  %bound1126 = icmp ult ptr %scevgep110.a, %scevgep109
  %found.conflict127 = and i1 %bound0125, %bound1126
  ...
  %found.conflict131 = and i1 %bound0129, %bound1130
  %conflict.rdx132 = or i1 %conflict.rdx128, %found.conflict131
  %bound0133 = icmp ult ptr %scevgep112, %scevgep117
  %bound1134 = icmp ult ptr %scevgep116.a, %scevgep113
  %found.conflict135 = and i1 %bound0133, %bound1134
  %conflict.rdx136 = or i1 %conflict.rdx132, %found.conflict135
  %bound0137 = icmp ult ptr %scevgep114, %scevgep117
  %bound1138 = icmp ult ptr %scevgep116.a, %scevgep115
  %found.conflict139 = and i1 %bound0137, %bound1138
  %conflict.rdx140 = or i1 %conflict.rdx136, %found.conflict139
  br i1 %conflict.rdx140, label %scalar.ph141.preheader, label %vector.body145

vector.body145:                                   ; preds = %vector.memcheck105, %vector.body145
  %index146 = phi i64 [ %index.next155, %vector.body145 ], [ 0, %vector.memcheck105 ] ; 2 uses
  %i.ap = or disjoint i64 %index146, 1            ; 2 uses
  ...
  %wide.vec = load <4 x double>, ptr %i.ar, align 8, !tbaa !113 ; 2 uses
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 0, i32 2> ; 2 uses
  %strided.vec147.a = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.as = getelementptr inbounds [16 x i8], ptr %5, i64 %i.ap
  %wide.vec148 = load <4 x double>, ptr %i.as, align 8, !tbaa !113 ; 2 uses
  %strided.vec149 = shufflevector <4 x double> %wide.vec148, <4 x double> poison, <2 x i32> <i32 0, i32 2> ; 2 uses
  %strided.vec150.a = shufflevector <4 x double> %wide.vec148, <4 x double> poison, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.at = fneg <2 x double> %strided.vec150.a
  %i.au = fmul <2 x double> %strided.vec147.a, %i.at
  %i.av = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %strided.vec, <2 x double> %strided.vec149, <2 x double> %i.au) ; 2 uses
  %i.aw = fmul <2 x double> %strided.vec, %strided.vec150.a
  %i.ax = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %strided.vec147.a, <2 x double> %strided.vec149, <2 x double> %i.aw) ; 2 uses
  %wide.vec151 = load <4 x double>, ptr %i.aq, align 8, !tbaa !113 ; 2 uses
  ...
  %i.ay = fadd <2 x double> %strided.vec152, %i.av
  %i.az = fadd <2 x double> %strided.vec153, %i.ax
  %interleaved.vec = shufflevector <2 x double> %i.ay, <2 x double> %i.az, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec, ptr %i.aq, align 8, !tbaa !113
  %i.ba = fsub <2 x double> %strided.vec152, %i.av
  %i.bb = fsub <2 x double> %strided.vec153, %i.ax
  %interleaved.vec154 = shufflevector <2 x double> %i.ba, <2 x double> %i.bb, <4 x i32> <i32 0, i32 2, i32 1, i32 3>
  store <4 x double> %interleaved.vec154, ptr %i.ar, align 8, !tbaa !113
  %index.next155 = add nuw i64 %index146, 2       ; 2 uses
  %i.bc = icmp eq i64 %index.next155, %n.vec144
  br i1 %i.bc, label %middle.block156, label %vector.body145, !llvm.loop !545

middle.block156:                                  ; preds = %vector.body145
  br i1 %cmp.n157, label %._crit_edge.us, label %scalar.ph141.preheader

scalar.ph141.preheader:                           ; preds = %vector.memcheck105, %.lr.ph.us, %middle.block156
  %indvars.iv81.ph = phi i64 [ 1, %vector.memcheck105 ], [ 1, %.lr.ph.us ], [ %i.af, %middle.block156 ]
  %indvars.iv79.ph = phi i64 [ %i.o, %vector.memcheck105 ], [ %i.o, %.lr.ph.us ], [ %i.af, %middle.block156 ]
  br label %scalar.ph141

scalar.ph141:                                     ; preds = %scalar.ph141.preheader, %scalar.ph141
  %indvars.iv81 = phi i64 [ %indvars.iv.next82, %scalar.ph141 ], [ %indvars.iv81.ph, %scalar.ph141.preheader ] ; 2 uses
  %indvars.iv79 = phi i64 [ %indvars.iv.next80, %scalar.ph141 ], [ %indvars.iv79.ph, %scalar.ph141.preheader ] ; 2 uses
  ...
  %i.bg = load double, ptr %i.bf, align 8, !tbaa !133
  %i.bh = getelementptr inbounds nuw i8, ptr %i.bf, i64 8
  %i.bi = load double, ptr %i.bh, align 8, !tbaa !134 ; 2 uses
  %i.bj = fneg double %i.bi
  %i.bk = load <2 x double>, ptr %i.be, align 8, !tbaa !113 ; 2 uses
  ...
  %i.bs = load <2 x double>, ptr %i.bd, align 8, !tbaa !113 ; 2 uses
  %i.bt = fadd <2 x double> %i.bs, %i.br
  store <2 x double> %i.bt, ptr %i.bd, align 8, !tbaa !113
  %i.bu = fsub <2 x double> %i.bs, %i.br
  store <2 x double> %i.bu, ptr %i.be, align 8, !tbaa !113
  %indvars.iv.next82 = add nuw nsw i64 %indvars.iv81, 1 ; 2 uses
  %indvars.iv.next80 = add nsw i64 %indvars.iv79, %i.o
  %exitcond.not = icmp eq i64 %indvars.iv.next82, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge.us, label %scalar.ph141, !llvm.loop !546

._crit_edge.us:                                   ; preds = %scalar.ph141, %middle.block156
  ...
  %indvar.next = add i64 %indvar, 1
  br i1 %i.bw, label %.lr.ph.us, label %._crit_edge76, !llvm.loop !547

._crit_edge76:                                    ; preds = %vector.body, %.lr.ph75.split, %._crit_edge.us, %bb.a
  ret void

.lr.ph75.split:                                   ; preds = %.lr.ph75.split.preheader161, %.lr.ph75.split
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph75.split ], [ 0, %.lr.ph75.split.preheader161 ] ; 2 uses
  ...
  %i.bz = load <2 x double>, ptr %i.bx, align 8, !tbaa !113 ; 2 uses
  %i.ca = load <2 x double>, ptr %i.by, align 8, !tbaa !113 ; 2 uses
  %i.cb = fadd <2 x double> %i.bz, %i.ca
  store <2 x double> %i.cb, ptr %i.bx, align 8, !tbaa !113
  %i.cc = fsub <2 x double> %i.bz, %i.ca
  store <2 x double> %i.cc, ptr %i.by, align 8, !tbaa !113
  %indvars.iv.next = add nsw i64 %indvars.iv, %i.e ; 2 uses
  %i.cd = icmp slt i64 %indvars.iv.next, %i.f
  br i1 %i.cd, label %.lr.ph75.split, label %._crit_edge76, !llvm.loop !548
}
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <4 x double>, ptr %i.n, align 8, !tbaa !113 ; 2 uses
  %strided.vec = shufflevector <4 x double> %wide.vec, <4 x double> poison, <2 x i32> <i32 0, i32 2> ; 2 uses
  ...
  %wide.vec181 = load <4 x double>, ptr %i.o, align 8, !tbaa !113 ; 2 uses
  ...
  %wide.vec184 = load <4 x double>, ptr %i.m, align 8, !tbaa !113 ; 2 uses
  ...
  store <4 x double> %interleaved.vec, ptr %i.m, align 8, !tbaa !113
  ...
  store <4 x double> %interleaved.vec187.a, ptr %i.n, align 8, !tbaa !113
  ...
  store <4 x double> %interleaved.vec188, ptr %i.o, align 8, !tbaa !113
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.ad = icmp eq i64 %index.next, %n.vec
  br i1 %i.ad, label %middle.block, label %vector.body, !llvm.loop !549
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %._crit_edge.us
  ...
  %i.bn = load <2 x double>, ptr %i.bl, align 8, !tbaa !113 ; 3 uses
  %i.bo = load <2 x double>, ptr %i.bm, align 8, !tbaa !113 ; 3 uses
  ...
  store <2 x double> %i.bv, ptr %i.bk, align 8, !tbaa !113
  ...
  store <2 x double> %i.bx, ptr %i.bl, align 8, !tbaa !113
  %i.by = fsub <2 x double> %i.bw, %i.bu
  store <2 x double> %i.by, ptr %i.bm, align 8, !tbaa !113
  br i1 %or.cond308, label %vector.memcheck191, label %scalar.ph283.preheader
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !152  ; 3 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 1, ptr %i.b, align 8, !tbaa !84
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 12
  store i32 1, ptr %i.c, align 4, !tbaa !85
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt15_Sp_counted_ptrIPN2cv10OcvDctImplELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.a, align 8, !tbaa !16
  %i.d = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store ptr %1, ptr %i.d, align 8, !tbaa !155
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !155  ; 6 uses
  %i.c = icmp eq ptr %i.b, null
...
_ZN2cv10AutoBufferIiLm264EED2Ev.exit.i:           ; preds = %bb.c, %bb.b
  ...
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !115  ; 3 uses
...
!19 = !{!"double", !11, i64 0}
!20 = !{!"bool", !11, i64 0}
!21 = !{!"_ZTSN2cv13OcvDftOptionsE", !12, i64 0, !18, i64 8, !19, i64 16, !18, i64 24, !17, i64 32, !12, i64 40, !12, i64 44, !20, i64 48, !20, i64 49, !20, i64 50, !20, i64 51, !17, i64 56, !20, i64 64}
!22 = !{!21, !12, i64 0}
!23 = !{!21, !20, i64 64}
!24 = !{!21, !17, i64 56}
!25 = !{!21, !20, i64 51}
...
!27 = !{!"long", !11, i64 0}
!28 = !{!"_ZTSN2cv10AutoBufferIhLm1032EEE", !26, i64 0, !27, i64 8, !11, i64 16}
!29 = !{!28, !26, i64 0}
!30 = !{!28, !27, i64 8}
!31 = !{!"_ZTSN2cv10AutoBufferIiLm264EEE", !18, i64 0, !27, i64 8, !11, i64 16}
!32 = !{!31, !18, i64 0}
!33 = !{!31, !27, i64 8}
!34 = !{!"_ZTSN2cv3hal5DFT1DE"}
!35 = !{!"_ZTSN2cv15OcvDftBasicImplE", !34, i64 0, !21, i64 8, !11, i64 80, !28, i64 216, !31, i64 1264}
!36 = !{!35, !18, i64 16}
!37 = !{!"p1 _ZTSN2cv3hal5DFT1DE", !17, i64 0}
...
!40 = !{!"_ZTSSt12__shared_ptrIN2cv3hal5DFT1DELN9__gnu_cxx12_Lock_policyE2EE", !37, i64 0, !39, i64 8}
!41 = !{!40, !37, i64 0}
!42 = !{!12, !12, i64 0}
...
!50 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !49, i64 0, !27, i64 8, !11, i64 16}
!51 = !{!50, !26, i64 0}
!52 = !{!11, !11, i64 0}
!53 = !{!"_ZTSN2cv3hal5DFT2DE"}
!54 = !{!"_ZTSSt10shared_ptrIN2cv3hal5DFT1DEE", !40, i64 0}
!55 = !{!"_ZTSN2cv3PtrINS_3hal5DFT1DEEE", !54, i64 0}
!56 = !{!"_ZTSN2cv7DftModeE", !11, i64 0}
!57 = !{!"_ZTSNSt12_Vector_baseIiSaIiEE17_Vector_impl_dataE", !18, i64 0, !18, i64 8, !18, i64 16}
!58 = !{!"_ZTSNSt12_Vector_baseIiSaIiEE12_Vector_implE", !57, i64 0}
!59 = !{!"_ZTSSt12_Vector_baseIiSaIiEE", !58, i64 0}
!60 = !{!"_ZTSSt6vectorIiSaIiEE", !59, i64 0}
!61 = !{!"_ZTSN2cv10OcvDftImplE", !53, i64 0, !55, i64 8, !55, i64 24, !20, i64 40, !20, i64 41, !20, i64 42, !12, i64 44, !12, i64 48, !56, i64 52, !12, i64 56, !12, i64 60, !12, i64 64, !20, i64 68, !12, i64 72, !20, i64 76, !20, i64 77, !60, i64 80, !20, i64 104, !12, i64 108, !12, i64 112, !28, i64 120, !28, i64 1168, !28, i64 2216, !28, i64 3264}
!62 = !{!61, !20, i64 40}
!63 = !{!61, !20, i64 41}
!64 = !{!61, !20, i64 42}
!65 = !{!61, !12, i64 72}
...
!68 = !{!61, !12, i64 108}
!69 = !{!61, !12, i64 112}
!70 = !{!"p1 _ZTSN2cv3hal5DFT2DE", !17, i64 0}
!71 = !{!"_ZTSSt12__shared_ptrIN2cv3hal5DFT2DELN9__gnu_cxx12_Lock_policyE2EE", !70, i64 0, !39, i64 8}
!72 = !{!71, !70, i64 0}
!73 = !{!27, !27, i64 0}
!74 = !{!61, !12, i64 44}
!75 = !{!61, !12, i64 48}
...
!81 = !{!57, !18, i64 8}
!82 = !{!57, !18, i64 0}
!83 = !{!"_ZTSSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE", !12, i64 8, !12, i64 12}
!84 = !{!83, !12, i64 8}
!85 = !{!83, !12, i64 12}
!86 = !{!"p1 _ZTSN2cv15OcvDftBasicImplE", !17, i64 0}
!87 = !{!"_ZTSSt15_Sp_counted_ptrIPN2cv15OcvDftBasicImplELN9__gnu_cxx12_Lock_policyE2EE", !83, i64 0, !86, i64 16}
!88 = !{!87, !86, i64 16}
!89 = !{!39, !38, i64 0}
!90 = !{!"branch_weights", !"expected", i32 1, i32 2000}
!91 = !{!"_ZTSN2cv5Size_IiEE", !12, i64 0, !12, i64 4}
!92 = !{!"_ZTSN2cv11_InputArrayE", !12, i64 0, !17, i64 8, !91, i64 16}
!93 = !{!92, !17, i64 8}
!94 = !{!"p1 _ZTSN2cv12MatAllocatorE", !17, i64 0}
!95 = !{!"p1 _ZTSN2cv8UMatDataE", !17, i64 0}
!96 = !{!"_ZTSN2cv10DataLayoutE", !11, i64 0}
!97 = !{!"_ZTSN2cv8MatShapeE", !12, i64 0, !96, i64 4, !12, i64 8, !11, i64 12}
!98 = !{!"_ZTSN2cv7MatStepE", !11, i64 0}
!99 = !{!"_ZTSN2cv3MatE", !12, i64 0, !12, i64 4, !12, i64 8, !12, i64 12, !12, i64 16, !26, i64 24, !26, i64 32, !26, i64 40, !26, i64 48, !94, i64 56, !95, i64 64, !97, i64 72, !98, i64 128}
!100 = !{!99, !12, i64 0}
!101 = !{!99, !26, i64 24}
!102 = !{!99, !12, i64 12}
!103 = !{!99, !12, i64 8}
!104 = !{!"p1 _ZTSN2cv5utils5trace7details6Region4ImplE", !17, i64 0}
!105 = !{!"_ZTSN2cv5utils5trace7details6RegionE", !104, i64 0, !12, i64 8}
!106 = !{!105, !12, i64 8}
!107 = !{!97, !12, i64 0}
!108 = !{!"float", !11, i64 0}
!109 = !{!108, !108, i64 0}
...
!113 = !{!19, !19, i64 0}
!114 = !{!"_ZTSN2cv10AutoBufferIjLm264EEE", !18, i64 0, !27, i64 8, !11, i64 16}
!115 = !{!114, !18, i64 0}
!116 = !{!114, !27, i64 8}
!117 = !{!"_ZTSN2cv3hal5DCT2DE"}
!118 = !{!"_ZTSN2cv10OcvDctImplE", !117, i64 0, !21, i64 8, !11, i64 80, !114, i64 216, !31, i64 1288, !17, i64 2360, !20, i64 2368, !20, i64 2369, !20, i64 2370, !12, i64 2372, !12, i64 2376, !12, i64 2380, !12, i64 2384, !12, i64 2388}
!119 = !{!118, !12, i64 2380}
!120 = !{!118, !12, i64 2384}
!121 = !{!118, !12, i64 2388}
!122 = !{!118, !20, i64 2369}
...
!127 = !{!118, !12, i64 2376}
!128 = !{!118, !12, i64 2372}
!129 = !{!"p1 _ZTSN2cv3hal5DCT2DE", !17, i64 0}
!130 = !{!"_ZTSSt12__shared_ptrIN2cv3hal5DCT2DELN9__gnu_cxx12_Lock_policyE2EE", !129, i64 0, !39, i64 8}
!131 = !{!130, !129, i64 0}
!132 = !{!"_ZTSN2cv7ComplexIdEE", !19, i64 0, !19, i64 8}
!133 = !{!132, !19, i64 0}
!134 = !{!132, !19, i64 8}
!135 = !{!"_ZTSN2cv7ComplexIfEE", !108, i64 0, !108, i64 4}
!136 = !{!135, !108, i64 0}
!137 = !{!135, !108, i64 4}
!138 = !{!21, !17, i64 32}
!139 = !{!21, !18, i64 24}
...
!146 = !{!21, !20, i64 50}
!147 = !{!18, !18, i64 0}
!148 = !{i64 0, i64 4, !42, i64 8, i64 8, !147, i64 16, i64 8, !113, i64 24, i64 8, !147, i64 32, i64 8, !47, i64 40, i64 4, !42, i64 44, i64 4, !42, i64 48, i64 1, !46, i64 49, i64 1, !46, i64 50, i64 1, !46, i64 51, i64 1, !46, i64 56, i64 8, !47, i64 64, i64 1, !46}
!149 = !{!57, !18, i64 16}
!150 = !{!"p1 _ZTSN2cv10OcvDftImplE", !17, i64 0}
!151 = !{!"_ZTSSt15_Sp_counted_ptrIPN2cv10OcvDftImplELN9__gnu_cxx12_Lock_policyE2EE", !83, i64 0, !150, i64 16}
!152 = !{!151, !150, i64 16}
!153 = !{!"p1 _ZTSN2cv10OcvDctImplE", !17, i64 0}
!154 = !{!"_ZTSSt15_Sp_counted_ptrIPN2cv10OcvDctImplELN9__gnu_cxx12_Lock_policyE2EE", !83, i64 0, !153, i64 16}
!155 = !{!154, !153, i64 16}
!156 = !{!35, !12, i64 52}
!157 = !{!35, !20, i64 56}
!158 = !{!35, !20, i64 58}
