...
.lr.ph836.split.us845:                            ; preds = %.lr.ph836.split.us845.preheader, %.lr.ph836.split.us845
  ...
  br i1 %i.ke, label %.lr.ph836.split.us845, label %..loopexit798_crit_edge.us, !llvm.loop !443
...
..loopexit798_crit_edge.us:                       ; preds = %.lr.ph836.split.us845, %._crit_edge833.us.us
  ...
  br i1 %.not714.us, label %.preheader796, label %.lr.ph836.us, !llvm.loop !444
...
.lr.ph832.us.us:                                  ; preds = %.lr.ph832.us.us.preheader, %._crit_edge833.us.us
  ...
  %i.km = load <2 x float>, ptr %i.kh, align 4, !tbaa !109 ; 3 uses
  %i.kn = load float, ptr %i.ki, align 4, !tbaa !137
  %i.ko = load <2 x float>, ptr %i.kj, align 4, !tbaa !109 ; 3 uses
  %i.kp = load float, ptr %i.kk, align 4, !tbaa !137
  ...
  %i.kt = load <2 x float>, ptr %i.kg, align 4, !tbaa !109 ; 2 uses
  %i.ku = load <2 x float>, ptr %i.kl, align 4, !tbaa !109 ; 2 uses
  ...
  store <2 x float> %i.la, ptr %i.kh, align 4, !tbaa !109
  %i.lb = fadd <2 x float> %i.ks, %i.kv
  store <2 x float> %i.lb, ptr %i.kl, align 4, !tbaa !109
  %i.lc = fsub <2 x float> %i.kv, %i.ks
  store <2 x float> %i.lc, ptr %i.kj, align 4, !tbaa !109
...
.lr.ph849.split.us858:                            ; preds = %.lr.ph849.split.us858.preheader, %.lr.ph849.split.us858
  ...
  br i1 %i.ju, label %.lr.ph849.split.us858, label %..loopexit811_crit_edge.us, !llvm.loop !515
...
..loopexit811_crit_edge.us:                       ; preds = %.lr.ph849.split.us858, %._crit_edge846.us.us
  ...
  br i1 %.not714.us, label %.preheader809, label %.lr.ph849.us, !llvm.loop !516
...
.lr.ph845.us.us:                                  ; preds = %.lr.ph845.us.us.preheader, %._crit_edge846.us.us
  ...
  %i.kc = load <2 x double>, ptr %i.jx, align 8, !tbaa !113 ; 3 uses
  %i.kd = load double, ptr %i.jy, align 8, !tbaa !134
  %i.ke = load <2 x double>, ptr %i.jz, align 8, !tbaa !113 ; 3 uses
  %i.kf = load double, ptr %i.ka, align 8, !tbaa !134
  ...
  %i.kj = load <2 x double>, ptr %i.jw, align 8, !tbaa !113 ; 2 uses
  %i.kk = load <2 x double>, ptr %i.kb, align 8, !tbaa !113 ; 2 uses
  ...
  store <2 x double> %i.kr, ptr %i.jx, align 8, !tbaa !113
  %i.ks = fadd <2 x double> %i.ki, %i.kl
  store <2 x double> %i.ks, ptr %i.kb, align 8, !tbaa !113
  %i.kt = fsub <2 x double> %i.kl, %i.ki
  store <2 x double> %i.kt, ptr %i.jz, align 8, !tbaa !113
...
begin_hunk_3_@_ZN2cvL3DFTIdEEvRKNS_13OcvDftOptionsEPKNS_7ComplexIT_EEPS6_:_ZNKSt9type_infoeqERKS_.exit.thread804
  store <2 x double> %i.wt, ptr %i.xb, align 8, !tbaa !113
  %i.xc = add nuw nsw i32 %.2674897, 1
  %indvars.iv.next1005 = add nuw nsw i64 %indvars.iv1004, %i.sy
...
._crit_edge901:                                   ; preds = %._crit_edge891, %.preheader806, %bb.bq
  ...
  %indvars.iv.next976 = add nsw i64 %indvars.iv975, %i.ta
...
._crit_edge906:                                   ; preds = %._crit_edge901
  %indvars.iv.next1016 = add nsw i64 %indvars.iv1015, %i.sz ; 2 uses
  %i.xd = icmp slt i64 %indvars.iv.next1016, %i.td
  br i1 %i.xd, label %.preheader808, label %._crit_edge908.split, !llvm.loop !530

._crit_edge908.split:                             ; preds = %._crit_edge906, %.preheader808.lr.ph, %_ZN2cv10AutoBufferINS_7ComplexIdEELm72EEC2Em.exit
  %.not.i.i755 = icmp eq ptr %i.ss, %scevgep.i
...
bb.bt:                                            ; preds = %bb.bm, %_ZN2cv10AutoBufferINS_7ComplexIdEELm72EED2Ev.exit, %bb.bk, %bb.bl
  ...
  %i.xe = load i32, ptr %0, align 8, !tbaa !22
  %i.xf = trunc nuw i64 %indvars.iv.next1019 to i32
  %i.xg = icmp sgt i32 %i.xe, %i.xf
  br i1 %i.xg, label %bb.bi, label %._crit_edge914, !llvm.loop !531

._crit_edge914:                                   ; preds = %bb.bt, %.loopexit810
  %i.xh = fcmp une double %i.m, 1.000000e+00
  br i1 %i.xh, label %bb.bu, label %bb.bv

bb.bu:                                            ; preds = %._crit_edge914
  %i.xi = fneg double %i.m
  %.0638 = select i1 %i.i, double %i.xi, double %i.m ; 2 uses
  %i.xj = load i32, ptr %i.e, align 4, !tbaa !140 ; 3 uses
  %i.xk = icmp sgt i32 %i.xj, 0
  br i1 %i.xk, label %.lr.ph923.preheader, label %.critedge

.lr.ph923.preheader:                              ; preds = %bb.bu
  %wide.trip.count1027 = zext nneg i32 %i.xj to i64 ; 3 uses
  %min.iters.check1436 = icmp ult i32 %i.xj, 4
...
vector.ph1437:                                    ; preds = %.lr.ph923.preheader
  ...
  %i.xl = insertelement <2 x double> poison, double %i.m, i64 0
  %i.xm = insertelement <2 x double> %i.xl, double %.0638, i64 1 ; 2 uses
...
vector.body1439:                                  ; preds = %vector.body1439, %vector.ph1437
  ...
  %i.xn = getelementptr inbounds nuw [16 x i8], ptr %2, i64 %index1440 ; 2 uses
  %i.xo = getelementptr inbounds nuw [16 x i8], ptr %2, i64 %index1440
  %i.xp = getelementptr inbounds nuw i8, ptr %i.xo, i64 16 ; 2 uses
  %wide.load = load <2 x double>, ptr %i.xn, align 8
  %wide.load1441 = load <2 x double>, ptr %i.xp, align 8
  %i.xq = fmul <2 x double> %i.xm, %wide.load
  %i.xr = fmul <2 x double> %i.xm, %wide.load1441
  store <2 x double> %i.xq, ptr %i.xn, align 8
  store <2 x double> %i.xr, ptr %i.xp, align 8
  %index.next1442 = add nuw i64 %index1440, 2     ; 2 uses
  %i.xs = icmp eq i64 %index.next1442, %n.vec1438
  br i1 %i.xs, label %middle.block1443, label %vector.body1439, !llvm.loop !532
...
.lr.ph923.preheader1497:                          ; preds = %.lr.ph923.preheader, %middle.block1443
  ...
  %i.xu = insertelement <2 x double> %i.xt, double %.0638, i64 1
  br label %.lr.ph923
...
.lr.ph923:                                        ; preds = %.lr.ph923.preheader1497, %.lr.ph923
  ...
  %i.xv = getelementptr inbounds nuw [16 x i8], ptr %2, i64 %indvars.iv1024 ; 2 uses
  %i.xw = load <2 x double>, ptr %i.xv, align 8, !tbaa !113
  %i.xx = fmul <2 x double> %i.xu, %i.xw
  store <2 x double> %i.xx, ptr %i.xv, align 8, !tbaa !113
...
.preheader:                                       ; preds = %bb.bv
  %i.xy = load i32, ptr %i.e, align 4, !tbaa !140 ; 4 uses
  %.not716915 = icmp slt i32 %i.xy, 2
  br i1 %.not716915, label %._crit_edge918, label %.lr.ph917.preheader

.lr.ph917.preheader:                              ; preds = %.preheader
  %i.xz = add nsw i32 %i.xy, -2
  %i.ya = lshr i32 %i.xz, 1                       ; 2 uses
  %narrow1522 = add nuw i32 %i.ya, 1              ; 2 uses
  %i.yb = zext i32 %narrow1522 to i64             ; 2 uses
  %xtraiter1516 = and i64 %i.yb, 1
  %i.yc = icmp eq i32 %i.ya, 0
  br i1 %i.yc, label %.lr.ph917.epil.preheader, label %.lr.ph917.preheader.new

.lr.ph917.preheader.new:                          ; preds = %.lr.ph917.preheader
  %unroll_iter1520 = and i64 %i.yb, 4294967294
  br label %.lr.ph917
...
.lr.ph917:                                        ; preds = %.lr.ph917, %.lr.ph917.preheader.new
  ...
  %i.yd = getelementptr inbounds nuw [16 x i8], ptr %2, i64 %indvars.iv1021 ; 2 uses
  %i.ye = getelementptr inbounds nuw i8, ptr %i.yd, i64 8 ; 2 uses
  %i.yf = load double, ptr %i.ye, align 8, !tbaa !134
  %i.yg = fneg double %i.yf
  %i.yh = getelementptr inbounds nuw i8, ptr %i.yd, i64 24 ; 2 uses
  %i.yi = load double, ptr %i.yh, align 8, !tbaa !134
  %i.yj = fneg double %i.yi
  store double %i.yg, ptr %i.ye, align 8, !tbaa !134
  store double %i.yj, ptr %i.yh, align 8, !tbaa !134
  %i.yk = getelementptr inbounds nuw [16 x i8], ptr %2, i64 %indvars.iv1021 ; 2 uses
  %i.yl = getelementptr inbounds nuw i8, ptr %i.yk, i64 40 ; 2 uses
  %i.ym = load double, ptr %i.yl, align 8, !tbaa !134
  %i.yn = fneg double %i.ym
  %i.yo = getelementptr inbounds nuw i8, ptr %i.yk, i64 56 ; 2 uses
...
.lr.ph917.epil.preheader:                         ; preds = %._crit_edge918.loopexit.unr-lcssa, %.lr.ph917.preheader
  ...
  %i.yr = getelementptr inbounds nuw [16 x i8], ptr %2, i64 %indvars.iv1021.epil.init ; 2 uses
  %i.ys = getelementptr inbounds nuw i8, ptr %i.yr, i64 8 ; 2 uses
  %i.yt = load double, ptr %i.ys, align 8, !tbaa !134
  %i.yu = fneg double %i.yt
  %i.yv = getelementptr inbounds nuw i8, ptr %i.yr, i64 24 ; 2 uses
...
._crit_edge918.loopexit:                          ; preds = %._crit_edge918.loopexit.unr-lcssa, %.lr.ph917.epil.preheader
  ...
  %i.yy = trunc nuw nsw i64 %indvars.iv.next1022.lcssa to i32
  br label %._crit_edge918

._crit_edge918:                                   ; preds = %._crit_edge918.loopexit, %.preheader
  %.8.lcssa = phi i32 [ 0, %.preheader ], [ %i.yy, %._crit_edge918.loopexit ]
  %i.yz = icmp slt i32 %.8.lcssa, %i.xy
  br i1 %i.yz, label %bb.bw, label %.critedge

bb.bw:                                            ; preds = %._crit_edge918
  %i.za = zext nneg i32 %i.xy to i64
  %i.zb = getelementptr [16 x i8], ptr %2, i64 %i.za
  %i.zc = getelementptr i8, ptr %i.zb, i64 -8     ; 2 uses
...
vector.body147:                                   ; preds = %vector.memcheck107, %vector.body147
  ...
  %wide.vec150 = load <4 x double>, ptr %i.as, align 8, !tbaa !113 ; 2 uses
  ...
  %wide.vec153 = load <4 x double>, ptr %i.aq, align 8, !tbaa !113 ; 2 uses
  ...
  store <4 x double> %interleaved.vec156, ptr %i.ar, align 8, !tbaa !113
  %index.next157 = add nuw i64 %index148, 2       ; 2 uses
  %i.bc = icmp eq i64 %index.next157, %n.vec146
  br i1 %i.bc, label %middle.block158, label %vector.body147, !llvm.loop !545
...
scalar.ph143:                                     ; preds = %scalar.ph143.preheader, %scalar.ph143
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next82, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge.us, label %scalar.ph143, !llvm.loop !546
