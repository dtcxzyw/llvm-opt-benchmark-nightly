...
.lr.ph116.i.i.i:                                  ; preds = %.lr.ph120.split.i.i.i
  ...
  %2 = insertelement <3 x float> <float 0.000000e+00, float poison, float poison>, float %i.ag, i64 1
  br label %bb.b
...
bb.b:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph116.i.i.i
  ...
  %i.ax = load float, ptr %i.aw, align 4, !tbaa !12 ; 3 uses
  %3 = insertelement <3 x float> poison, float %i.ax, i64 0
  %4 = shufflevector <3 x float> %3, <3 x float> poison, <3 x i32> zeroinitializer
  %5 = insertelement <3 x float> %2, float %i.av, i64 2
  %6 = fmul <3 x float> %4, %5                    ; 6 uses
  %7 = load <8 x float>, ptr %i.au, align 4, !tbaa !12 ; 4 uses
  %8 = shufflevector <3 x float> %6, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.ay = shufflevector <8 x float> %7, <8 x float> poison, <2 x i32> <i32 1, i32 5>
  %i.az = fmul <2 x float> %8, %i.ay
  %i.ba = shufflevector <8 x float> %7, <8 x float> poison, <2 x i32> <i32 0, i32 4>
  ...
  %i.bc = shufflevector <8 x float> %7, <8 x float> poison, <2 x i32> <i32 2, i32 6> ; 2 uses
  %i.bd = shufflevector <3 x float> %6, <3 x float> poison, <2 x i32> zeroinitializer
  %i.be = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bc, <2 x float> %i.bd, <2 x float> %i.bb)
  %i.bf = shufflevector <8 x float> %7, <8 x float> poison, <2 x i32> <i32 3, i32 7>
  ...
  %i.bl = fmul float %10, %i.bk
  %11 = extractelement <3 x float> %6, i64 1
  %i.bm = tail call float @llvm.fmuladd.f32(float %i.bi, float %11, float %i.bl)
  %i.bn = getelementptr inbounds nuw i8, ptr %i.au, i64 40
  %i.bo = load float, ptr %i.bn, align 4, !tbaa !12 ; 2 uses
  %12 = extractelement <3 x float> %6, i64 0
  %i.bp = tail call float @llvm.fmuladd.f32(float %i.bo, float %12, float %i.bm)
