...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.kp = fmul <2 x double> %i.gq, %i.ko          ; 8 uses
  ...
  %i.kx = fmul <2 x double> %i.gq, %i.ks          ; 9 uses
  %i.ky = extractelement <2 x double> %i.kx, i64 0 ; 2 uses
  ...
  %19 = shufflevector <2 x double> %i.kp, <2 x double> %i.kx, <2 x i32> <i32 0, i32 2>
  %20 = fneg <2 x double> %19                     ; 6 uses
  %21 = shufflevector <2 x double> %i.kv, <2 x double> %20, <2 x i32> <i32 3, i32 1> ; 3 uses
  ...
  %22 = shufflevector <2 x double> %20, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.ny = fmul <2 x double> %i.nx, %22
  ...
  %i.oc = shufflevector <2 x double> %20, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %foldExtExtBinop553 = fmul <2 x double> %i.ni, %20
  %i.oq = extractelement <2 x double> %foldExtExtBinop553, i64 1
  %23 = extractelement <2 x double> %i.nh, i64 0
  %i.or = extractelement <2 x double> %20, i64 0
  %i.os = fmul double %i.mm, %i.or
  %i.ot = fmul double %i.ml, %i.ky
  %i.ou = call double @llvm.fmuladd.f64(double %23, double %i.kw, double %i.oq)
  ...
  %24 = shufflevector <2 x double> %20, <2 x double> %i.li, <2 x i32> <i32 1, i32 3>
  %i.pd = fmul <2 x double> %i.pc, %24
