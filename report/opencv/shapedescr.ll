...
bb.c:                                             ; preds = %bb.b
  ...
  %4 = fadd nnan <2 x float> %i.u, %i.y           ; 2 uses
  %i.ay = extractelement <2 x float> %4, i64 1
  %5 = fmul nnan float %i.ay, 5.000000e-01
  %i.az = extractelement <2 x float> %4, i64 0
  %6 = fmul nnan float %i.az, 5.000000e-01
  %foldExtExtBinop = fsub <2 x float> %i.y, %i.u
  %7 = extractelement <2 x float> %foldExtExtBinop, i64 0 ; 3 uses
  %foldExtExtBinop43 = fsub <2 x float> %i.y, %i.u
  %i.ba = extractelement <2 x float> %foldExtExtBinop43, i64 1 ; 3 uses
  %8 = fmul float %i.ba, %5
  %i.bb = tail call float @llvm.fmuladd.f32(float %6, float %7, float %8) ; 2 uses
  %i.bc = fneg float %i.ba
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.bw = tail call float @llvm.fmuladd.f32(float %7, float %i.bt, float %i.bv) ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ci = tail call float @llvm.fmuladd.f32(float %7, float %i.cf, float %i.cg)
