...
bb.b:                                             ; preds = %bb.a
  ...
  %i.s = fmul double %i.r, %i.m                   ; 3 uses
  ...
  %i.x = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.u, <2 x double> %i.w, <2 x double> splat (double 1.000000e+00)) ; 3 uses
...
_ZN2cv4IPPE10PoseSolver15rotateVec2ZAxisERKNS_4MatxIdLi3ELi1EEERNS2_IdLi3ELi3EEE.exit: ; preds = %bb.a, %bb.b
  ...
  %.sroa.17.0 = phi double [ %i.s, %bb.b ], [ 0.000000e+00, %bb.a ] ; 2 uses
  %.sink.i = phi double [ %i.aa, %bb.b ], [ -1.000000e+00, %bb.a ] ; 5 uses
  %i.ad = phi <2 x double> [ %i.p, %bb.b ], [ zeroinitializer, %bb.a ] ; 4 uses
  %i.ae = phi <2 x double> [ %i.ab, %bb.b ], [ <double 0.000000e+00, double 1.000000e+00>, %bb.a ] ; 3 uses
  %i.af = phi <2 x double> [ %i.ac, %bb.b ], [ <double 1.000000e+00, double 0.000000e+00>, %bb.a ] ; 6 uses
  ...
  %15 = shufflevector <2 x double> %i.ae, <2 x double> %i.af, <4 x i32> <i32 2, i32 poison, i32 poison, i32 1>
  %16 = shufflevector <2 x double> %i.af, <2 x double> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %17 = shufflevector <4 x double> %15, <4 x double> %16, <4 x i32> <i32 0, i32 5, i32 5, i32 3>
  %i.am = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.al, <4 x double> %i.ah, <4 x double> %17) ; 5 uses
...
bb.n:                                             ; preds = %bb.h
  ...
  %i.cy = fdiv <2 x double> %i.bh, %i.cx          ; 8 uses
  %i.cz = fdiv <2 x double> %i.bl, %i.cx          ; 9 uses
...
bb.s:                                             ; preds = %bb.q, %bb.r
  %i.dr = extractelement <2 x double> %i.cz, i64 0 ; 3 uses
  %i.ds = fneg double %i.di
  %18 = shufflevector <2 x double> %i.af, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %19 = shufflevector <2 x double> %i.af, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %20 = fmul <2 x double> %19, %i.cz
  %21 = getelementptr inbounds nuw i8, ptr %13, i64 4
  %22 = load i32, ptr %21, align 4, !tbaa !46
  %23 = getelementptr inbounds nuw i8, ptr %13, i64 24
  %24 = load ptr, ptr %23, align 8, !tbaa !47     ; 8 uses
  %25 = getelementptr inbounds nuw i8, ptr %13, i64 128 ; 6 uses
  %i.dt = shufflevector <2 x double> %i.ae, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %26 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cy, <2 x double> %i.dt, <2 x double> %20) ; 2 uses
  %27 = insertelement <2 x double> poison, double %i.dg, i64 0
  %28 = insertelement <2 x double> poison, double %.sroa.29.0, i64 0
  %29 = shufflevector <2 x double> %28, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %30 = extractelement <2 x double> %i.cy, i64 0  ; 2 uses
  %i.du = getelementptr inbounds nuw i8, ptr %24, i64 16
  %31 = icmp slt i32 %22, 2                       ; 6 uses
  %32 = extractelement <2 x double> %i.cz, i64 1  ; 2 uses
  %33 = fneg double %32                           ; 2 uses
  %34 = fmul double %i.dr, %33
  %35 = extractelement <2 x double> %i.cy, i64 1  ; 3 uses
  %36 = extractelement <2 x double> %i.db, i64 0  ; 2 uses
  %37 = call double @llvm.fmuladd.f64(double %36, double %35, double %34)
  %38 = fcmp olt double %37, 0.000000e+00
  %.0 = select i1 %38, double %i.ds, double %i.di ; 7 uses
  %39 = insertelement <2 x double> %27, double %.0, i64 1 ; 2 uses
  %40 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %39, <2 x double> %29, <2 x double> %26)
  store <2 x double> %40, ptr %24, align 8, !tbaa !37
  %41 = fmul double %i.dg, %33
  %42 = fmul double %.0, %36
  %43 = shufflevector <2 x double> %i.af, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.ei = fneg <2 x double> %39                   ; 3 uses
  %i.ej = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ei, <2 x double> %29, <2 x double> %26)
  %44 = fneg double %i.dr                         ; 2 uses
  %45 = call double @llvm.fmuladd.f64(double %.0, double %i.dr, double %41) ; 3 uses
  %i.ek = call double @llvm.fmuladd.f64(double %i.dg, double %35, double %42) ; 3 uses
  %i.el = fmul double %35, %44
  %i.em = call double @llvm.fmuladd.f64(double %30, double %32, double %i.el) ; 6 uses
  ...
  store double %i.es, ptr %i.du, align 8, !tbaa !37
  %i.et = load i64, ptr %25, align 8
  %.sink.idx.i = select i1 %31, i64 0, i64 %i.et
  %.sink.i282 = getelementptr inbounds nuw i8, ptr %24, i64 %.sink.idx.i
  %46 = extractelement <2 x double> %i.eq, i64 0
  %i.eu = call double @llvm.fmuladd.f64(double %i.dg, double %.sroa.33.0, double %46)
  store double %i.eu, ptr %.sink.i282, align 8, !tbaa !37
  %47 = load i64, ptr %25, align 8
  %.sink.idx.i283 = select i1 %31, i64 0, i64 %47
  %.sink.i284 = getelementptr inbounds nuw i8, ptr %24, i64 %.sink.idx.i283
  %48 = getelementptr inbounds nuw i8, ptr %.sink.i284, i64 8
  %i.ev = insertelement <2 x double> %i.cz, double %i.ek, i64 0
  %49 = fmul <2 x double> %43, %i.ev
  %50 = insertelement <2 x double> %i.cy, double %45, i64 0
  %i.ew = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %50, <2 x double> %18, <2 x double> %49) ; 3 uses
  %i.ex = extractelement <2 x double> %i.ew, i64 1
  %i.ey = call double @llvm.fmuladd.f64(double %.0, double %.sroa.33.0, double %i.ex)
  store double %i.ey, ptr %48, align 8, !tbaa !37
  %51 = load i64, ptr %25, align 8
  %.sink.idx.i285 = select i1 %31, i64 0, i64 %51
  %.sink.i286 = getelementptr inbounds nuw i8, ptr %24, i64 %.sink.idx.i285
  %52 = getelementptr inbounds nuw i8, ptr %.sink.i286, i64 16
  %i.ez = extractelement <2 x double> %i.ew, i64 0
  %i.fa = call double @llvm.fmuladd.f64(double %i.em, double %.sroa.33.0, double %i.ez)
  store double %i.fa, ptr %52, align 8, !tbaa !37
  %53 = load i64, ptr %25, align 8
  %54 = shl i64 %53, 1
  %.sink.idx.i287 = select i1 %31, i64 0, i64 %54
  %.sink.i288 = getelementptr inbounds nuw i8, ptr %24, i64 %.sink.idx.i287
  store double %i.ec, ptr %.sink.i288, align 8, !tbaa !37
  %i.fb = load i64, ptr %25, align 8
  %55 = shl i64 %i.fb, 1
  %.sink.idx.i289.a = select i1 %31, i64 0, i64 %55
  %.sink.i290.a = getelementptr inbounds nuw i8, ptr %24, i64 %.sink.idx.i289.a
  %i.fc = getelementptr inbounds nuw i8, ptr %.sink.i290.a, i64 8
  store double %i.ee, ptr %i.fc, align 8, !tbaa !37
  %i.fd = load i64, ptr %25, align 8
  %56 = shl i64 %i.fd, 1
  %.sink.idx.i291.a = select i1 %31, i64 0, i64 %56
  %.sink.i292.a = getelementptr inbounds nuw i8, ptr %24, i64 %.sink.idx.i291.a
  %i.fe = getelementptr inbounds nuw i8, ptr %.sink.i292.a, i64 16
  %57 = insertelement <2 x double> %i.dw, double %.0, i64 1
  %58 = insertelement <2 x double> poison, double %i.ek, i64 0
  %59 = insertelement <2 x double> %58, double %44, i64 1
  %60 = fmul <2 x double> %57, %59
  %61 = insertelement <2 x double> poison, double %45, i64 0
  %62 = insertelement <2 x double> %61, double %i.dg, i64 1
  %63 = shufflevector <2 x double> %i.ad, <2 x double> %i.cz, <2 x i32> <i32 1, i32 3>
  %64 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %62, <2 x double> %63, <2 x double> %60) ; 2 uses
  %65 = extractelement <2 x double> %64, i64 0
  %66 = call double @llvm.fmuladd.f64(double %i.em, double %.sink.i, double %65)
  store double %66, ptr %i.fe, align 8, !tbaa !37
  %67 = load i32, ptr %i.ef, align 4, !tbaa !46
  %68 = load ptr, ptr %i.eg, align 8, !tbaa !47   ; 8 uses
  store <2 x double> %i.ej, ptr %68, align 8, !tbaa !37
  %69 = extractelement <2 x double> %i.db, i64 1
  %70 = fmul double %i.dg, %69
  %71 = call double @llvm.fmuladd.f64(double %.0, double %30, double %70) ; 3 uses
  %i.ff = getelementptr inbounds nuw i8, ptr %68, i64 16
  %72 = fmul double %.sroa.17.0, %71
  %73 = extractelement <2 x double> %64, i64 1    ; 3 uses
  %74 = extractelement <2 x double> %i.ag, i64 1
  %75 = call double @llvm.fmuladd.f64(double %73, double %74, double %72)
  %76 = call double @llvm.fmuladd.f64(double %i.em, double %.sroa.29.0, double %75)
  store double %76, ptr %i.ff, align 8, !tbaa !37
  %i.fg = icmp slt i32 %67, 2                     ; 6 uses
  %i.fh = load i64, ptr %i.eh, align 8
  %.sink.idx.i299 = select i1 %i.fg, i64 0, i64 %i.fh
  %.sink.i300 = getelementptr inbounds nuw i8, ptr %68, i64 %.sink.idx.i299
  ...
  %77 = shufflevector <2 x double> %i.eq, <2 x double> %i.ew, <2 x i32> <i32 0, i32 3>
  %i.fk = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ei, <2 x double> %i.fj, <2 x double> %77) ; 2 uses
  ...
  %.sink.i302 = getelementptr inbounds nuw i8, ptr %68, i64 %.sink.idx.i301
  ...
  %.sink.i304 = getelementptr inbounds nuw i8, ptr %68, i64 %.sink.idx.i303
  %i.fq = getelementptr inbounds nuw i8, ptr %.sink.i304, i64 16
  %78 = extractelement <2 x double> %i.ag, i64 0
  %i.fr = fmul double %78, %71
  %i.fs = call double @llvm.fmuladd.f64(double %73, double %.sroa.17.0, double %i.fr)
  ...
  %.sink.i306 = getelementptr inbounds nuw i8, ptr %68, i64 %.sink.idx.i305
  ...
  %.sink.i308 = getelementptr inbounds nuw i8, ptr %68, i64 %.sink.idx.i307
  ...
  %.sink.i310 = getelementptr inbounds nuw i8, ptr %68, i64 %.sink.idx.i309
  %i.gg = getelementptr inbounds nuw i8, ptr %.sink.i310, i64 16
  %i.gh = fmul double %.sroa.25.0, %71
  %i.gi = call double @llvm.fmuladd.f64(double %73, double %i.dv, double %i.gh)
