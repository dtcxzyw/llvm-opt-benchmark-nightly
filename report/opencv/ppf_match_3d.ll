...
bb.t:                                             ; preds = %bb.s
  ...
  %i.dr = load float, ptr %i.dk, align 4, !tbaa !53
  %i.ds = fpext float %i.dr to double             ; 3 uses
  %i.dt = load <2 x float>, ptr %i.dj, align 4, !tbaa !53
  call void @llvm.lifetime.start.p0(ptr nonnull %19) #26
  %i.du = fpext <2 x float> %i.dt to <2 x double> ; 4 uses
  %27 = fsub <2 x double> %i.du, %i.cw            ; 3 uses
  %28 = fsub double %i.ds, %i.cx                  ; 3 uses
  %i.dv = extractelement <2 x double> %27, i64 0  ; 2 uses
  %i.dw = call double @llvm.fmuladd.f64(double %i.dv, double %i.dv, double 0.000000e+00)
  %i.dx = extractelement <2 x double> %27, i64 1  ; 2 uses
  %i.dy = call double @llvm.fmuladd.f64(double %i.dx, double %i.dx, double %i.dw)
  %i.dz = call double @llvm.fmuladd.f64(double %28, double %28, double %i.dy)
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.ee = fdiv double 1.000000e+00, %sqrt.i       ; 2 uses
  %29 = insertelement <2 x double> poison, double %i.ee, i64 0
  %30 = shufflevector <2 x double> %29, <2 x double> poison, <2 x i32> zeroinitializer
  %31 = fmul <2 x double> %27, %30                ; 2 uses
  %32 = fmul double %28, %i.ee
  %i.ef = insertelement <2 x double> %i.cy, double %i.ed, i64 1
  %i.eg = shufflevector <2 x double> %31, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.ej = shufflevector <2 x double> %31, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.ek = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ei, <2 x double> %i.ej, <2 x double> %i.eh)
  %33 = insertelement <2 x double> %i.de, double %i.eb, i64 1
  %i.el = insertelement <2 x double> poison, double %32, i64 0
  %34 = shufflevector <2 x double> %i.el, <2 x double> poison, <2 x i32> zeroinitializer
  %i.em = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %33, <2 x double> %34, <2 x double> %i.ek) ; 2 uses
...
.noexc:                                           ; preds = %bb.v
  ...
  %35 = extractelement <2 x double> %i.du, i64 0
  %i.hk = call double @llvm.fmuladd.f64(double %i.hj, double %35, double 0.000000e+00)
  %i.hl = extractelement <2 x double> %i.du, i64 1 ; 2 uses
  ...
  %36 = insertelement <2 x double> poison, double %i.ds, i64 0
  %37 = shufflevector <2 x double> %36, <2 x double> %i.du, <2 x i32> <i32 0, i32 2>
  %i.ho = insertelement <2 x double> <double poison, double 0.000000e+00>, double %i.hm, i64 0
  %i.hp = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hn, <2 x double> %37, <2 x double> %i.ho) ; 2 uses
  ...
  %i.hu = call double @llvm.fmuladd.f64(double %i.ht, double %i.ds, double %i.hs)
...
bb.a:
  ...
  %54 = alloca %"class.cv::Vec", align 16         ; 6 uses
...
bb.ai:                                            ; preds = %.lr.ph390, %_ZNSt12__shared_ptrIN2cv12ppf_match_3d6Pose3DELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit
  ...
  %i.hp = load float, ptr %i.hl, align 4, !tbaa !53
  %i.hq = fpext float %i.hp to double             ; 2 uses
  %i.hr = load <2 x float>, ptr %i.hk, align 4, !tbaa !53
  ...
  store <2 x double> %i.hs, ptr %54, align 16, !tbaa !36, !alias.scope !207
  store double %i.hq, ptr %i.ds, align 16, !tbaa !36, !alias.scope !207
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.jk = load <2 x float>, ptr %i.jg, align 4, !tbaa !53
  ...
  %i.jo = call double @llvm.fmuladd.f64(double %i.jn, double %i.jn, double 0.000000e+00)
  %i.jp = extractelement <2 x double> %i.jm, i64 1 ; 2 uses
  %69 = call double @llvm.fmuladd.f64(double %i.jp, double %i.jp, double %i.jo)
  %i.jq = call double @llvm.fmuladd.f64(double %68, double %68, double %69)
...
bb.an:                                            ; preds = %bb.am
  ...
  %i.kb = fdiv double 1.000000e+00, %sqrt.i       ; 2 uses
  %70 = insertelement <2 x double> poison, double %i.kb, i64 0
  %71 = shufflevector <2 x double> %70, <2 x double> poison, <2 x i32> zeroinitializer
  %72 = fmul <2 x double> %i.jm, %71              ; 2 uses
  %73 = fmul double %68, %i.kb
  %i.kc = insertelement <2 x double> %i.hv, double %i.ka, i64 1
  %i.kd = shufflevector <2 x double> %72, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.kg = shufflevector <2 x double> %72, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.kh = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.kf, <2 x double> %i.kg, <2 x double> %i.ke)
  %74 = insertelement <2 x double> %i.ic, double %i.ju, i64 1
  %i.ki = insertelement <2 x double> poison, double %73, i64 0
  %75 = shufflevector <2 x double> %i.ki, <2 x double> poison, <2 x i32> zeroinitializer
  %i.kj = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %74, <2 x double> %75, <2 x double> %i.kh) ; 2 uses
...
bb.ao:                                            ; preds = %bb.an, %bb.am
  ...
  %76 = extractelement <2 x double> %i.jl, i64 0
  %i.ky = call double @llvm.fmuladd.f64(double %i.kx, double %76, double 0.000000e+00)
  %i.kz = extractelement <2 x double> %i.jl, i64 1 ; 2 uses
  ...
  %77 = insertelement <2 x double> poison, double %i.jj, i64 0
  %78 = shufflevector <2 x double> %77, <2 x double> %i.jl, <2 x i32> <i32 0, i32 2>
  ...
  %i.li = call double @llvm.fmuladd.f64(double %i.lh, double %i.jj, double %i.lg)
