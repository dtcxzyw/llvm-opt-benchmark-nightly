...
bb.cp:                                            ; preds = %bb.co
  ...
  %i.pg = fmul double %i.pf, %i.lr
  %i.ph = fmul double %i.jg, %i.oy
  %i.pi = shufflevector <2 x double> %i.ov, <2 x double> poison, <3 x i32> <i32 0, i32 1, i32 poison> ; 5 uses
  %i.pj = shufflevector <2 x double> %i.pc, <2 x double> poison, <3 x i32> <i32 poison, i32 1, i32 poison>
  %i.pk = insertelement <3 x double> %i.pj, double %i.pg, i64 0 ; 2 uses
  %i.pl = shufflevector <3 x double> %i.pk, <3 x double> %i.pi, <3 x i32> <i32 0, i32 1, i32 4> ; 3 uses
  %39 = shufflevector <3 x double> %i.pl, <3 x double> %i.pi, <3 x i32> <i32 poison, i32 0, i32 3>
  ...
  %i.qh = shufflevector <2 x double> %i.qg, <2 x double> poison, <3 x i32> <i32 0, i32 poison, i32 poison> ; 2 uses
  %40 = shufflevector <3 x double> %i.qh, <3 x double> %39, <3 x i32> <i32 0, i32 4, i32 5>
  ...
  %41 = shufflevector <3 x double> %i.pk, <3 x double> %i.pi, <3 x i32> <i32 poison, i32 0, i32 3>
  store <2 x double> %i.pr, ptr %i.po, align 8
  store <2 x double> %i.pw, ptr %.sroa.5321.0..sroa_idx, align 8
  %42 = shufflevector <3 x double> %i.qh, <3 x double> %41, <3 x i32> <i32 0, i32 4, i32 5>
  ...
  %i.uo = call <3 x double> @llvm.fmuladd.v3f64(<3 x double> %i.se, <3 x double> %42, <3 x double> %i.un) ; 9 uses
...
bb.dq:                                            ; preds = %bb.do, %bb.dh
  ...
  %i.im = load double, ptr %i.ii, align 8, !tbaa !20, !noalias !288 ; 4 uses
  %i.in = load double, ptr %i.ij, align 8, !tbaa !20, !noalias !288 ; 4 uses
  %i.io = load double, ptr %46, align 8, !tbaa !20, !noalias !288 ; 2 uses
  %i.ip = load <2 x double>, ptr %i.hk, align 8, !tbaa !20, !noalias !288 ; 6 uses
  %i.iq = load <2 x double>, ptr %i.ik, align 8, !tbaa !20, !noalias !288 ; 8 uses
  %i.ir = load <2 x double>, ptr %i.hj, align 8, !tbaa !20, !noalias !288 ; 7 uses
...
_ZNK2cv4MatxIdLi3ELi3EE3invEiPb.exit:             ; preds = %bb.dq, %bb.dr
  ...
  %i.mo = insertelement <2 x double> poison, double %i.in, i64 1
...
bb.ds:                                            ; preds = %_ZNK2cv4MatxIdLi3ELi3EE3invEiPb.exit
  ...
  %i.nd = insertelement <2 x double> %i.nc, double %i.in, i64 1 ; 2 uses
  %i.ne = fneg <2 x double> %i.nd
  %i.nf = insertelement <2 x double> %i.jf, double %i.io, i64 1 ; 2 uses
  %i.ng = fmul <2 x double> %i.nf, %i.mh
  %i.nh = insertelement <2 x double> %i.js, double %i.im, i64 1 ; 2 uses
  %i.ni = fmul <2 x double> %i.nh, %i.nb
  %i.nj = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ip, <2 x double> %i.nd, <2 x double> %i.ni)
  %i.nk = fmul <2 x double> %i.ir, %i.ne
  %i.nl = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.nf, <2 x double> %i.iq, <2 x double> %i.nk)
  %i.nm = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ir, <2 x double> %i.nh, <2 x double> %i.ng)
