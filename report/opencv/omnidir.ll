...
bb.dq:                                            ; preds = %bb.do, %bb.dh
  ...
  %i.ja = insertelement <2 x double> %i.iz, double %i.ih, i64 0 ; 3 uses
...
_ZNK2cv4MatxIdLi3ELi3EE3invEiPb.exit460:          ; preds = %_ZNK2cv4MatxIdLi3ELi3EE3invEiPb.exit, %bb.ds
  ...
  %56 = fneg double %i.ig                         ; 2 uses
  %i.nl = insertelement <2 x double> poison, double %56, i64 0
  %57 = shufflevector <2 x double> %i.nl, <2 x double> poison, <2 x i32> zeroinitializer
  %i.nm = fmul <2 x double> %i.it, %57
  ...
  %58 = shufflevector <2 x double> %i.np, <2 x double> %i.in, <2 x i32> <i32 0, i32 3>
  %59 = fneg <2 x double> %58                     ; 2 uses
  %60 = shufflevector <2 x double> %i.ii, <2 x double> %i.it, <2 x i32> <i32 1, i32 2>
  %i.nq = fmul <2 x double> %60, %59
...
bb.dt:                                            ; preds = %_ZNK2cv4MatxIdLi3ELi3EE3invEiPb.exit460
  ...
  %61 = extractelement <2 x double> %i.it, i64 0
  %i.oc = extractelement <2 x double> %i.ii, i64 0
  %i.od = shufflevector <2 x double> %i.it, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.oe = insertelement <2 x double> %i.od, double %i.ih, i64 1
  %i.of = fneg <2 x double> %i.oe                 ; 3 uses
  %62 = fneg double %61                           ; 2 uses
  ...
  %63 = insertelement <2 x double> %i.ok, double %i.ie, i64 1
  %64 = shufflevector <2 x double> %i.of, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.ol = insertelement <2 x double> %64, double %62, i64 1
  %i.om = fmul <2 x double> %63, %i.ol
  ...
  %65 = shufflevector <2 x double> %59, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %66 = insertelement <2 x double> %65, double %56, i64 1
  %i.or = fmul <2 x double> %i.ip, %66
  ...
  %67 = insertelement <2 x double> %i.of, double %62, i64 1
  %i.pc = fmul <2 x double> %i.pb, %67
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.er
  ...
  %i.vk = phi <2 x double> [ %i.vg, %.lr.ph.preheader ], [ %i.zs, %bb.er ] ; 11 uses
...
bb.ej:                                            ; preds = %.lr.ph
  ...
  %i.vn = call double @sin(double noundef %i.vl) #22
  %68 = extractelement <2 x double> %i.vk, i64 0
  br label %bb.en
...
bb.em:                                            ; preds = %bb.el
  %69 = extractelement <2 x double> %i.vk, i64 0
  %i.vz = shufflevector <2 x double> %i.vk, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.wa = fmul <2 x double> %i.vz, <double -2.000000e+00, double 1.000000e+00>
  %i.wb = shufflevector <2 x double> %i.vk, <2 x double> poison, <2 x i32> zeroinitializer
  %i.wc = fmul <2 x double> %i.wb, <double 2.000000e+00, double 1.000000e+00>
  %i.wd = fneg <2 x double> %i.vk
  %i.we = shufflevector <2 x double> %i.wd, <2 x double> %i.vk, <2 x i32> <i32 0, i32 2>
  ...
  %i.wh = extractelement <2 x double> %i.wg, i64 1 ; 2 uses
  %i.wi = fadd double %i.wh, 4.000000e+00         ; 2 uses
  %i.wj = fadd double %i.wh, -4.000000e+00
  %i.wk = extractelement <2 x double> %i.wg, i64 0 ; 3 uses
  ...
  %i.wt = fdiv double %i.wr, %i.ws                ; 2 uses
  %i.wu = fsub double 1.000000e+00, %i.wt         ; 2 uses
  %70 = extractelement <2 x double> %i.vk, i64 1
  %71 = fmul double %70, %i.wu
  %72 = fmul double %71, 5.000000e-01
  %73 = fmul double %69, %i.wu
  %74 = fmul double %73, 5.000000e-01
  br label %bb.en

bb.en:                                            ; preds = %bb.ek, %bb.em, %bb.el, %bb.ej
  %.0325 = phi double [ %i.vm, %bb.ej ], [ %i.vq, %bb.ek ], [ %72, %bb.em ], [ 0.000000e+00, %bb.el ] ; 2 uses
  %.0324 = phi double [ %i.vn, %bb.ej ], [ %i.vv, %bb.ek ], [ %i.wt, %bb.em ], [ 0.000000e+00, %bb.el ] ; 2 uses
  %.0323 = phi double [ %68, %bb.ej ], [ %i.vy, %bb.ek ], [ %74, %bb.em ], [ 0.000000e+00, %bb.el ] ; 2 uses
  %75 = insertelement <2 x double> poison, double %.0324, i64 0
  %76 = shufflevector <2 x double> %75, <2 x double> poison, <2 x i32> zeroinitializer
  %i.wv = fmul <2 x double> %i.pl, %76
  %77 = insertelement <2 x double> poison, double %.0325, i64 0
  %78 = shufflevector <2 x double> %77, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ww = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.pk, <2 x double> %78, <2 x double> %i.wv)
  %79 = insertelement <2 x double> poison, double %.0323, i64 0
  %i.wx = shufflevector <2 x double> %79, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %80 = shufflevector <2 x double> %i.wy, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %81 = shufflevector <2 x double> %i.pm, <2 x double> %i.wy, <2 x i32> <i32 1, i32 2>
  %82 = insertelement <2 x double> %80, double %.0325, i64 0
  %i.xc = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %81, <2 x double> %82, <2 x double> %i.xb) ; 2 uses
  %i.xd = extractelement <2 x double> %i.xc, i64 0
  %i.xe = call double @llvm.fmuladd.f64(double %.sroa.12.0, double %.0323, double %i.xd) ; 3 uses
