...
.thread137:                                       ; preds = %bb.f, %.thread.i103, %bb.g
  ...
  %i.r = phi i32 [ %i.p, %bb.g ], [ %i.n, %.thread.i103 ], [ %i.l, %bb.f ] ; 14 uses
...
bb.l:                                             ; preds = %_ZNK2cv7MatExprcvNS_3MatEEv.exit112
  ...
  %wide.trip.count = zext i32 %i.r to i64         ; 3 uses
  ...
  %wide.trip.count229 = zext i32 %i.r to i64      ; 13 uses
  %wide.trip.count239 = zext nneg i32 %i.r to i64
  %i.cd = add nsw i64 %wide.trip.count229, -1     ; 5 uses
  %xtraiter = and i64 %wide.trip.count229, 1
  %i.ce = icmp eq i64 %i.cd, 0
  %unroll_iter = and i64 %wide.trip.count229, 2147483646
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod278 = trunc i32 %i.r to i1
  %xtraiter280 = and i64 %wide.trip.count229, 1
  %i.cf = icmp eq i64 %i.cd, 0
  %unroll_iter283 = and i64 %wide.trip.count229, 2147483646
  %lcmp.mod281.not = icmp eq i64 %xtraiter280, 0
  %lcmp.mod282 = trunc i32 %i.r to i1
  %xtraiter286 = and i64 %wide.trip.count229, 1
  %i.cg = icmp eq i64 %i.cd, 0
  %unroll_iter289 = and i64 %wide.trip.count229, 2147483646
  %lcmp.mod287.not = icmp eq i64 %xtraiter286, 0
  %lcmp.mod288 = trunc i32 %i.r to i1
  %xtraiter292 = and i64 %wide.trip.count229, 1
  %i.ch = icmp eq i64 %i.cd, 0
  %unroll_iter295 = and i64 %wide.trip.count229, 2147483646
  %lcmp.mod293.not = icmp eq i64 %xtraiter292, 0
  %lcmp.mod294 = trunc i32 %i.r to i1
  %xtraiter298 = and i64 %wide.trip.count229, 1
  %i.ci = icmp eq i64 %i.cd, 0
  %unroll_iter301 = and i64 %wide.trip.count229, 2147483646
  ...
  %xtraiter303 = and i64 %wide.trip.count229, 1
  %lcmp.mod304.not = icmp eq i64 %xtraiter303, 0
  %i.cj = add nsw i64 %wide.trip.count229, -1
  br label %bb.v
