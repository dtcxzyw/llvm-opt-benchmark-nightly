...
bb.ar:                                            ; preds = %bb.aq
  ...
  %.sroa.740.0.copyload.a = load float, ptr %.sroa.740.0..sroa_idx, align 4, !tbaa !116
  %.sroa.037.0.copyload = load float, ptr %i.is, align 4, !tbaa !116
  %23 = load <2 x double>, ptr %i.hl, align 8, !tbaa !30 ; 2 uses
  %i.jw = load <2 x double>, ptr %.sink.i204, align 8, !tbaa !30 ; 2 uses
  ...
  %24 = fpext float %.sroa.7.0.copyload to double ; 2 uses
  %25 = fpext float %.sroa.0.0.copyload to double ; 2 uses
  %26 = fpext float %.sroa.740.0.copyload.a to double
  %27 = fpext float %.sroa.037.0.copyload to double
  %28 = load <2 x double>, ptr %i.hq, align 8, !tbaa !30 ; 2 uses
  %29 = shufflevector <2 x double> %23, <2 x double> %i.jw, <2 x i32> <i32 1, i32 3>
  %i.jx = insertelement <2 x double> poison, double %26, i64 0 ; 2 uses
  %i.jy = shufflevector <2 x double> %i.jx, <2 x double> poison, <2 x i32> zeroinitializer
  %30 = fmul <2 x double> %29, %i.jy
  %31 = load <2 x double>, ptr %.sink.i222, align 8, !tbaa !30 ; 2 uses
  %32 = shufflevector <2 x double> %23, <2 x double> %i.jw, <2 x i32> <i32 0, i32 2>
  %33 = insertelement <2 x double> poison, double %27, i64 0 ; 2 uses
  %34 = shufflevector <2 x double> %33, <2 x double> poison, <2 x i32> zeroinitializer
  %35 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %32, <2 x double> %34, <2 x double> %30)
  %36 = shufflevector <2 x double> %28, <2 x double> %31, <2 x i32> <i32 1, i32 3>
  %37 = insertelement <2 x double> poison, double %24, i64 0
  %38 = shufflevector <2 x double> %37, <2 x double> poison, <2 x i32> zeroinitializer
  %39 = fmul <2 x double> %36, %38
  %i.jz = load <2 x double>, ptr %.sink.i210, align 8, !tbaa !30 ; 2 uses
  %i.ka = insertelement <2 x double> poison, double %i.it, i64 0
  %40 = insertelement <2 x double> %i.ka, double %i.iw, i64 1
  %41 = fadd <2 x double> %40, %35                ; 3 uses
  %i.kb = shufflevector <2 x double> %28, <2 x double> %31, <2 x i32> <i32 0, i32 2>
  %i.kc = insertelement <2 x double> poison, double %25, i64 0
  %i.kd = shufflevector <2 x double> %i.kc, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ke = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.kb, <2 x double> %i.kd, <2 x double> %39)
  ...
  %i.kj = shufflevector <2 x double> %i.jz, <2 x double> %i.ki, <2 x i32> <i32 1, i32 3>
  %i.kk = insertelement <2 x double> %i.jx, double %24, i64 1
  %i.kl = fmul <2 x double> %i.kj, %i.kk
  %i.km = shufflevector <2 x double> %i.jz, <2 x double> %i.ki, <2 x i32> <i32 0, i32 2>
  %i.kn = insertelement <2 x double> %33, double %25, i64 1
  ...
  %i.ks = shufflevector <2 x double> %i.kh, <2 x double> %41, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.kt = fmul <2 x double> %i.ks, %i.ks
  %i.ku = shufflevector <2 x double> %i.kh, <2 x double> %41, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.kv = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ku, <2 x double> %i.ku, <2 x double> %i.kt)
  %42 = shufflevector <2 x double> %i.kv, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.kw = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.kr, <2 x double> %i.kr, <2 x double> %42)
