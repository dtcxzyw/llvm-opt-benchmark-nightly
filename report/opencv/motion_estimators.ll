...
bb.aq:                                            ; preds = %.lr.ph, %bb.as
  %.0241 = phi i64 [ 0, %.lr.ph ], [ %i.ls, %bb.as ] ; 3 uses
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %.sroa.740.0.copyload.a = load float, ptr %i.is, align 4, !tbaa !116
  %.sroa.037.0.copyload = load float, ptr %.sroa.740.0..sroa_idx, align 4, !tbaa !116
  %23 = fpext float %.sroa.740.0.copyload.a to double
  %i.jw = load <2 x double>, ptr %i.hl, align 8, !tbaa !30 ; 2 uses
  %24 = fpext float %.sroa.037.0.copyload to double
  %25 = load <2 x double>, ptr %.sink.i204, align 8, !tbaa !30 ; 2 uses
  %26 = shufflevector <2 x double> %i.jw, <2 x double> %25, <2 x i32> <i32 1, i32 3>
  %27 = insertelement <2 x double> poison, double %24, i64 0 ; 2 uses
  %28 = shufflevector <2 x double> %27, <2 x double> poison, <2 x i32> zeroinitializer
  %29 = fmul <2 x double> %26, %28
  %30 = shufflevector <2 x double> %i.jw, <2 x double> %25, <2 x i32> <i32 0, i32 2>
  %i.jx = insertelement <2 x double> poison, double %23, i64 0 ; 2 uses
  %i.jy = shufflevector <2 x double> %i.jx, <2 x double> poison, <2 x i32> zeroinitializer
  %31 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %30, <2 x double> %i.jy, <2 x double> %29)
  %32 = insertelement <2 x double> poison, double %i.it, i64 0
  %33 = insertelement <2 x double> %32, double %i.iw, i64 1
  %34 = fadd <2 x double> %33, %31                ; 3 uses
  %35 = load <2 x double>, ptr %.sink.i210, align 8, !tbaa !30 ; 2 uses
  ...
  %36 = fpext float %.sroa.0.0.copyload to double ; 2 uses
  %37 = load <2 x double>, ptr %i.hq, align 8, !tbaa !30 ; 2 uses
  %38 = fpext float %.sroa.7.0.copyload to double ; 2 uses
  %i.jz = load <2 x double>, ptr %.sink.i222, align 8, !tbaa !30 ; 2 uses
  %39 = shufflevector <2 x double> %37, <2 x double> %i.jz, <2 x i32> <i32 1, i32 3>
  %i.ka = insertelement <2 x double> poison, double %38, i64 0
  %40 = shufflevector <2 x double> %i.ka, <2 x double> poison, <2 x i32> zeroinitializer
  %41 = fmul <2 x double> %39, %40
  %i.kb = shufflevector <2 x double> %37, <2 x double> %i.jz, <2 x i32> <i32 0, i32 2>
  %i.kc = insertelement <2 x double> poison, double %36, i64 0
  %i.kd = shufflevector <2 x double> %i.kc, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ke = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.kb, <2 x double> %i.kd, <2 x double> %41)
  %i.kf = insertelement <2 x double> poison, double %i.jf, i64 0
  %i.kg = insertelement <2 x double> %i.kf, double %i.ji, i64 1
  %i.kh = fadd <2 x double> %i.kg, %i.ke          ; 3 uses
  %i.ki = load <2 x double>, ptr %.sink.i228, align 8, !tbaa !30 ; 2 uses
  %i.kj = shufflevector <2 x double> %35, <2 x double> %i.ki, <2 x i32> <i32 1, i32 3>
  %i.kk = insertelement <2 x double> %27, double %38, i64 1
  %i.kl = fmul <2 x double> %i.kj, %i.kk
  %i.km = shufflevector <2 x double> %35, <2 x double> %i.ki, <2 x i32> <i32 0, i32 2>
  %i.kn = insertelement <2 x double> %i.jx, double %36, i64 1
  %i.ko = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.km, <2 x double> %i.kn, <2 x double> %i.kl)
  %i.kp = insertelement <2 x double> poison, double %i.iz, i64 0
  %i.kq = insertelement <2 x double> %i.kp, double %i.jl, i64 1
  %i.kr = fadd <2 x double> %i.kq, %i.ko          ; 3 uses
  %i.ks = shufflevector <2 x double> %34, <2 x double> %i.kh, <2 x i32> <i32 1, i32 3> ; 2 uses
  %i.kt = fmul <2 x double> %i.ks, %i.ks
  %i.ku = shufflevector <2 x double> %34, <2 x double> %i.kh, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.kv = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ku, <2 x double> %i.ku, <2 x double> %i.kt)
  %i.kw = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.kr, <2 x double> %i.kr, <2 x double> %i.kv)
  %i.kx = call <2 x double> @llvm.sqrt.v2f64(<2 x double> %i.kw) ; 3 uses
  %i.ky = fdiv <2 x double> %i.kr, %i.kx          ; 2 uses
  %i.kz = shufflevector <2 x double> %i.kx, <2 x double> poison, <2 x i32> zeroinitializer
  %i.la = fdiv <2 x double> %34, %i.kz
  %i.lb = shufflevector <2 x double> %i.kx, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.lc = fdiv <2 x double> %i.kh, %i.lb
  %i.ld = fsub <2 x double> %i.la, %i.lc
  %i.le = insertelement <2 x double> poison, double %i.jm, i64 0
  %i.lf = shufflevector <2 x double> %i.le, <2 x double> poison, <2 x i32> zeroinitializer
  %i.lg = fmul <2 x double> %i.lf, %i.ld          ; 2 uses
  %i.lh = extractelement <2 x double> %i.lg, i64 0
  store double %i.lh, ptr %.sink.i234, align 8, !tbaa !30
  %i.li = load i64, ptr %i.bi, align 8
  %i.lj = mul i64 %i.li, %i.jv
  %.sink.idx.i235 = select i1 %i.jp, i64 0, i64 %i.lj
  %.sink.i236 = getelementptr inbounds nuw i8, ptr %i.jq, i64 %.sink.idx.i235
  %i.lk = extractelement <2 x double> %i.lg, i64 1
  store double %i.lk, ptr %.sink.i236, align 8, !tbaa !30
  %i.ll = add nsw i32 %i.jn, 2
  %i.lm = load i64, ptr %i.bi, align 8
  %i.ln = sext i32 %i.ll to i64
  %i.lo = mul i64 %i.lm, %i.ln
  %.sink.idx.i237 = select i1 %i.jp, i64 0, i64 %i.lo
  %.sink.i238 = getelementptr inbounds nuw i8, ptr %i.jq, i64 %.sink.idx.i237
  %shift = shufflevector <2 x double> %i.ky, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fsub <2 x double> %i.ky, %shift
  %i.lp = extractelement <2 x double> %foldExtExtBinop, i64 0
  %i.lq = fmul double %i.jm, %i.lp
  store double %i.lq, ptr %.sink.i238, align 8, !tbaa !30
  %i.lr = add nsw i32 %.1111240, 1
  br label %bb.as

bb.as:                                            ; preds = %bb.aq, %bb.ar
  %.2112 = phi i32 [ %i.lr, %bb.ar ], [ %.1111240, %bb.aq ] ; 2 uses
  %i.ls = add nuw i64 %.0241, 1                   ; 2 uses
  %exitcond.not = icmp eq i64 %i.ls, %i.hg
...
.lr.ph.i:                                         ; preds = %bb.c
  ...
  %i.bg = load ptr, ptr %i.t, align 8, !tbaa !94  ; 26 uses
  %i.bh = load i32, ptr %i.v, align 4, !tbaa !89
  %.fr36.i = freeze i32 %i.bh
  %i.bi = icmp slt i32 %.fr36.i, 2                ; 4 uses
  %i.bj = load ptr, ptr %i.w, align 8, !tbaa !94  ; 26 uses
