...
bb.ar:                                            ; preds = %bb.aq
  ...
  %i.is = getelementptr inbounds nuw [28 x i8], ptr %i.ir, i64 %i.iq
  ...
  %23 = load <2 x float>, ptr %i.is, align 4, !tbaa !116
  %i.jw = load <2 x double>, ptr %i.hl, align 8, !tbaa !30 ; 2 uses
  %i.jx = load <2 x double>, ptr %.sink.i204, align 8, !tbaa !30 ; 2 uses
  %24 = load <2 x float>, ptr %i.je, align 4, !tbaa !116
  %25 = shufflevector <2 x float> %23, <2 x float> %24, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %26 = fpext <4 x float> %25 to <4 x double>     ; 6 uses
  ...
  %27 = shufflevector <4 x double> %26, <4 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.ka = fmul <2 x double> %i.jz, %27
  ...
  %i.kd = shufflevector <4 x double> %26, <4 x double> poison, <2 x i32> zeroinitializer
  ...
  %28 = shufflevector <4 x double> %26, <4 x double> poison, <2 x i32> <i32 3, i32 3>
  %i.kg = fmul <2 x double> %i.kf, %28
  ...
  %29 = shufflevector <4 x double> %26, <4 x double> poison, <2 x i32> <i32 2, i32 2>
  %i.km = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.kl, <2 x double> %29, <2 x double> %i.kg)
  ...
  %30 = shufflevector <4 x double> %26, <4 x double> poison, <2 x i32> <i32 1, i32 3>
  %i.ks = fmul <2 x double> %i.kr, %30
  %i.kt = shufflevector <2 x double> %i.kh, <2 x double> %i.kq, <2 x i32> <i32 0, i32 2>
  %31 = shufflevector <4 x double> %26, <4 x double> poison, <2 x i32> <i32 0, i32 2>
  %i.ku = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.kt, <2 x double> %31, <2 x double> %i.ks)
