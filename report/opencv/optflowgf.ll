...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %5 = shufflevector <4 x float> %i.el, <4 x float> poison, <2 x i32> <i32 1, i32 3>
  %i.es = fmul <2 x float> %i.er, %5
  %6 = shufflevector <4 x float> %i.el, <4 x float> poison, <2 x i32> <i32 3, i32 0>
  ...
  %shift = shufflevector <2 x float> %i.eu, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fadd <2 x float> %shift, %i.eq
  %i.ev = shufflevector <2 x float> %foldExtExtBinop, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %shift18 = shufflevector <2 x float> %i.eq, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop19 = fadd <2 x float> %i.eu, %shift18
  %i.ew = extractelement <2 x float> %foldExtExtBinop19, i64 0 ; 2 uses
