...
.lr.ph250.i.epil.preheader:                       ; preds = %.preheader.i.loopexit.unr-lcssa, %.lr.ph250.i.preheader
  ...
  %i.ym = sub nuw nsw i64 2, %indvars.iv296.i.epil.init
  %i.yn = getelementptr inbounds nuw [4 x i8], ptr %i.kr, i64 %i.ym
...
.lr.ph250.i:                                      ; preds = %.lr.ph250.i.preheader, %.lr.ph250.i
  ...
  %i.yt = sub nuw nsw i64 2, %indvars.iv296.i
  %i.yu = getelementptr inbounds nuw [4 x i8], ptr %i.kr, i64 %i.yt
  ...
  %i.za = sub nuw nsw i64 1, %indvars.iv296.i
  %i.zb = getelementptr inbounds nuw [4 x i8], ptr %i.kr, i64 %i.za
...
.lr.ph259.i.epil.preheader:                       ; preds = %.preheader234.i.loopexit.unr-lcssa, %.lr.ph259.i.preheader
  ...
  %i.akh = sub nuw nsw i64 4, %indvars.iv306.i209.epil.init
  %i.aki = getelementptr inbounds nuw [4 x i8], ptr %i.aem, i64 %i.akh
...
.lr.ph259.i:                                      ; preds = %.lr.ph259.i.preheader, %.lr.ph259.i
  ...
  %i.ako = sub nuw nsw i64 4, %indvars.iv306.i209
  %i.akp = getelementptr inbounds nuw [4 x i8], ptr %i.aem, i64 %i.ako
  ...
  %i.akv = sub nuw nsw i64 3, %indvars.iv306.i209
  %i.akw = getelementptr inbounds nuw [4 x i8], ptr %i.aem, i64 %i.akv
...
.lr.ph228.i:                                      ; preds = %.lr.ph228.i.preheader, %.lr.ph228.i
  ...
  %i.avc = sub nuw nsw i64 4, %indvars.iv274.i
  %i.avd = getelementptr inbounds nuw [8 x i8], ptr %i.arg, i64 %i.avc
  ...
  %i.avj = sub nuw nsw i64 3, %indvars.iv274.i
  %i.avk = getelementptr inbounds nuw [8 x i8], ptr %i.arg, i64 %i.avj
...
.lr.ph228.i.epil.preheader:                       ; preds = %._crit_edge229.i.loopexit.unr-lcssa, %.lr.ph228.i.preheader
  ...
  %i.avr = sub nuw nsw i64 4, %indvars.iv274.i.epil.init
  %i.avs = getelementptr inbounds nuw [8 x i8], ptr %i.arg, i64 %i.avr
