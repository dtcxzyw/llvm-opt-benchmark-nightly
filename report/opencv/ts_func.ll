...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %40 = shufflevector <2 x double> %i.fe, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %41 = insertelement <2 x double> %40, double %i.fa, i64 0
  %i.ha = insertelement <2 x double> %i.fe, double %i.fd, i64 0
...
bb.cf:                                            ; preds = %.preheader, %bb.cf
  ...
  %i.hz = extractelement <2 x double> %i.hw, i64 1 ; 2 uses
  %42 = extractelement <2 x double> %i.hx, i64 0
  %43 = fadd double %42, %i.hy                    ; 5 uses
  %44 = call double @llvm.fmuladd.f64(double %i.gf, double %43, double %i.gc)
  %i.ia = extractelement <2 x double> %i.hw, i64 0 ; 3 uses
  %45 = call double @llvm.fmuladd.f64(double %44, double %43, double %i.gd)
  %46 = fmul double %i.ia, %i.ga
  %47 = fmul double %i.hz, %46
  %i.ib = insertelement <2 x double> %i.hx, double %45, i64 1
  %i.ic = insertelement <2 x double> <double 2.000000e+00, double poison>, double %43, i64 1
  %i.id = insertelement <2 x double> <double poison, double 1.000000e+00>, double %43, i64 0
  %i.ie = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ib, <2 x double> %i.ic, <2 x double> %i.id) ; 2 uses
  %i.if = fmul double %i.ia, %i.gh
  %i.ig = fmul double %i.hz, %i.if
  %i.ih = extractelement <2 x double> %i.ie, i64 1
  %i.ii = call double @llvm.fmuladd.f64(double %i.ia, double %i.ih, double %47)
  ...
  %48 = call double @llvm.fmuladd.f64(double %i.hy, double 2.000000e+00, double %43)
  %49 = call double @llvm.fmuladd.f64(double %i.fz, double %48, double %i.in)
  %i.ir = insertelement <2 x double> %i.im, double %49, i64 1
  %i.is = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ir, <2 x double> %41, <2 x double> %i.ha)
  %i.it = fptrunc <2 x double> %i.is to <2 x float> ; 2 uses
  %i.iu = extractelement <2 x float> %i.it, i64 1
  ...
  %i.iy = extractelement <2 x float> %i.it, i64 0
