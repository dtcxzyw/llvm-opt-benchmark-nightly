...
.lr.ph140.us.us.us:                               ; preds = %.lr.ph140.us.us.us.preheader, %.split.us.split.us.split.us
  %.089.us.us.us249 = phi i64 [ %i.ej, %.split.us.split.us.split.us ], [ 0, %.lr.ph140.us.us.us.preheader ]
...
iter.check:                                       ; preds = %bb.u
  %i.eo = mul i64 %.091135.us.us.us.us.us, %i.dk
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.av = invoke noundef i64 @_ZNK2cv3Mat5totalEv(ptr noundef nonnull align 8 dereferenceable(208) %5)
          to label %.preheader48 unwind label %.loopexit.split-lp ; 4 uses
...
.preheader.lr.ph.us.us.lr.ph:                     ; preds = %.preheader48.split.us.split.us.preheader
  ...
  %i.bd = mul nuw nsw i64 %i.bc, %i.ai
  %i.be = mul i64 %i.av, %i.ai
...
.preheader.lr.ph.us.us:                           ; preds = %.preheader.lr.ph.us.us.lr.ph, %.preheader48.split.us.split.us
  ...
  %i.bk = getelementptr i8, ptr %i.bi, i64 %i.bb
  %scevgep = getelementptr i8, ptr %i.bk, i64 %i.bd
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.aa = lshr i64 1275511473185297, %i.z
...
.preheader.lr.ph.us.us.lr.ph:                     ; preds = %.preheader46.split.us.split.us.preheader
  %i.aw = mul i64 %i.ar, %i.aq
  %i.ax = add i64 %i.ar, -1
  %i.ay = mul i64 %i.ax, %i.ae
  %i.az = add nuw nsw i64 %i.at, 1
  %i.ba = mul nuw nsw i64 %i.az, %i.aq
...
.preheader.lr.ph.us.us:                           ; preds = %.preheader.lr.ph.us.us.lr.ph, %.preheader46.split.us.split.us
  ...
  %scevgep = getelementptr i8, ptr %i.bf, i64 %i.aw
  %i.bg = getelementptr i8, ptr %i.bd, i64 %i.ay
...
bb.m:                                             ; preds = %bb.g
  ...
  %i.ai = lshr i64 1275511473185297, %i.ah
  %i.aj = trunc i64 %i.ai to i32
  %i.ak = and i32 %i.aj, 15                       ; 2 uses
  %i.al = mul nuw nsw i32 %i.ak, %i.ae            ; 3 uses
  %i.am = zext nneg i32 %i.al to i64              ; 11 uses
