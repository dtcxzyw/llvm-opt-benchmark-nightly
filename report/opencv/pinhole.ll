...
bb.co:                                            ; preds = %bb.cn
  ...
  %i.fk = call double @cos(double noundef %i.fg) #13 ; 4 uses
  ...
  %i.fw = insertelement <2 x double> poison, double %i.fk, i64 0 ; 2 uses
  ...
  %i.ha = insertelement <2 x double> %i.fw, double %i.fn, i64 1
