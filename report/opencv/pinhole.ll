...
bb.co:                                            ; preds = %bb.cn
  %i.fi = call double @cos(double noundef %i.fd) #13 ; 6 uses
  ...
  %i.gi = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gg, <2 x double> zeroinitializer, <2 x double> %i.gh) ; 2 uses
  ...
  %50 = insertelement <2 x double> poison, double %i.fj, i64 0
  %51 = insertelement <2 x double> %50, double %i.fn, i64 1
  %52 = insertelement <2 x double> <double 0.000000e+00, double poison>, double %i.fi, i64 1
  %53 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %51, <2 x double> %52, <2 x double> %i.gi) ; 4 uses
  %54 = call double @llvm.fmuladd.f64(double %i.fi, double 0.000000e+00, double %i.gb) ; 3 uses
  %55 = extractelement <2 x double> %53, i64 0
  %56 = call double @llvm.fmuladd.f64(double %i.fk, double %i.fi, double %55) ; 3 uses
  %57 = fdiv double 1.000000e+00, %56             ; 5 uses
  %58 = extractelement <2 x double> %53, i64 1
  %59 = fmul double %58, %57                      ; 2 uses
  %60 = insertelement <2 x double> <double poison, double 0.000000e+00>, double %59, i64 0
  %61 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.fs, <2 x double> %60, <2 x double> %i.gj)
  %62 = fmul double %54, %57                      ; 3 uses
  %63 = shufflevector <2 x double> %i.fs, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.gm = insertelement <2 x double> %63, double %i.ge, i64 0
  %64 = insertelement <2 x double> poison, double %57, i64 0
  %65 = shufflevector <2 x double> %64, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %66 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gm, <2 x double> %65, <2 x double> zeroinitializer) ; 2 uses
  %67 = extractelement <2 x double> %66, i64 0
  %i.gn = call double @llvm.fmuladd.f64(double %i.fu, double 0.000000e+00, double %67)
  %68 = shufflevector <2 x double> %66, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.go = insertelement <2 x double> %68, double %i.gn, i64 1
  %69 = fadd <2 x double> %i.go, <double 0.000000e+00, double -0.000000e+00>
  %70 = insertelement <2 x double> <double 0.000000e+00, double poison>, double %62, i64 1
  %71 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.fz, <2 x double> %65, <2 x double> %i.gl)
  %i.gp = insertelement <2 x double> poison, double %62, i64 0
  %i.gq = insertelement <2 x double> %i.gp, double %i.fk, i64 1
  %i.gr = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gq, <2 x double> %i.ga, <2 x double> %61) ; 2 uses
  %72 = shufflevector <2 x double> %53, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %73 = insertelement <2 x double> <double poison, double 0.000000e+00>, double %57, i64 0
  %i.gs = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %72, <2 x double> %73, <2 x double> zeroinitializer)
  %i.gt = insertelement <2 x double> poison, double %54, i64 0
  %74 = shufflevector <2 x double> %i.gt, <2 x double> poison, <2 x i32> zeroinitializer
  %i.gu = insertelement <2 x double> <double 0.000000e+00, double poison>, double %57, i64 1
  %i.gv = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %74, <2 x double> %i.gu, <2 x double> %i.gs)
  %75 = insertelement <2 x double> poison, double %56, i64 0
  %76 = shufflevector <2 x double> %75, <2 x double> poison, <2 x i32> zeroinitializer
  %i.gw = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %76, <2 x double> zeroinitializer, <2 x double> %i.gv)
  %77 = insertelement <2 x double> %53, double %i.ge, i64 0
  %78 = insertelement <2 x double> poison, double %59, i64 0
  %79 = shufflevector <2 x double> %78, <2 x double> poison, <2 x i32> zeroinitializer
  %i.gx = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %77, <2 x double> %79, <2 x double> zeroinitializer) ; 2 uses
  %80 = shufflevector <2 x double> %i.fy, <2 x double> %i.gx, <2 x i32> <i32 0, i32 2>
  %81 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.fx, <2 x double> %70, <2 x double> %80) ; 2 uses
  %82 = shufflevector <2 x double> %81, <2 x double> %i.gr, <2 x i32> <i32 0, i32 3> ; 2 uses
  %i.gy = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %82, <2 x double> zeroinitializer, <2 x double> %69)
  %83 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %82, <2 x double> zeroinitializer, <2 x double> %71)
  %84 = fadd <2 x double> %i.gr, %81
  %85 = extractelement <2 x double> %i.gx, i64 1
  %i.gz = call double @llvm.fmuladd.f64(double %54, double %62, double %85)
  %i.ha = fadd double %56, %i.gz
  %i.hb = call double @cos(double noundef %i.fd) #13 ; 5 uses
  ...
  %86 = fadd double %i.hd, 0.000000e+00
  %87 = insertelement <2 x double> %i.hj, double 0.000000e+00, i64 1
  %i.hm = insertelement <2 x double> poison, double %i.hb, i64 0
  %88 = shufflevector <2 x double> %i.hm, <2 x double> poison, <2 x i32> zeroinitializer
  %89 = fadd double %i.hf, 0.000000e+00
  %i.hn = insertelement <2 x double> poison, double %i.he, i64 0
  %90 = insertelement <2 x double> %i.hn, double %i.hf, i64 1
  %i.ho = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %90, <2 x double> zeroinitializer, <2 x double> zeroinitializer) ; 3 uses
  %91 = extractelement <2 x double> %i.ho, i64 0
  %92 = call double @llvm.fmuladd.f64(double %i.hb, double 0.000000e+00, double %91)
  %93 = extractelement <2 x double> %i.ho, i64 1
  %i.hp = insertelement <2 x double> poison, double %i.hd, i64 0
  %94 = insertelement <2 x double> %i.hp, double %i.hb, i64 1
  %95 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %94, <2 x double> zeroinitializer, <2 x double> %i.ho) ; 2 uses
  %96 = insertelement <2 x double> %95, double %86, i64 1
  %97 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %87, <2 x double> %88, <2 x double> %96) ; 4 uses
  ...
  %98 = shufflevector <2 x double> %95, <2 x double> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 poison>
  %i.hw = insertelement <4 x double> %98, double %i.hc, i64 1
  %99 = insertelement <4 x double> %i.hw, double %92, i64 2
  %i.hx = insertelement <4 x double> %99, double %89, i64 3
  %i.hy = call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.hr, <4 x double> %i.hv, <4 x double> %i.hx) ; 7 uses
  %i.hz = call double @llvm.fmuladd.f64(double %i.hd, double 0.000000e+00, double %93)
  %i.ia = call double @llvm.fmuladd.f64(double %i.he, double %i.hb, double %i.hz) ; 3 uses
  %i.ib = fneg <2 x double> %97                   ; 3 uses
  %100 = extractelement <2 x double> %i.hl, i64 0
  %101 = call double @llvm.fmuladd.f64(double %100, double 0.000000e+00, double 0.000000e+00) ; 2 uses
  ...
  %102 = insertelement <2 x double> <double 0.000000e+00, double poison>, double %101, i64 1
  %103 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.id, <2 x double> %i.hl, <2 x double> %102)
  ...
  %i.ik = shufflevector <2 x double> %97, <2 x double> poison, <2 x i32> zeroinitializer
  %i.il = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ik, <2 x double> %i.if, <2 x double> zeroinitializer) ; 2 uses
  %i.im = shufflevector <2 x double> %97, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %i.ip = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ib, <2 x double> %i.io, <2 x double> %104)
  %105 = shufflevector <4 x double> %i.hy, <4 x double> poison, <2 x i32> zeroinitializer
  %106 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ib, <2 x double> %105, <2 x double> %i.ij)
  %i.iq = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ib, <2 x double> %i.id, <2 x double> %i.in)
  %107 = fadd double %101, 0.000000e+00
  %108 = extractelement <4 x double> %i.hy, i64 3
  %109 = fadd double %108, %107
  %110 = extractelement <4 x double> %i.hy, i64 0
  %111 = shufflevector <2 x double> %97, <2 x double> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %112 = shufflevector <4 x double> %i.hy, <4 x double> %111, <2 x i32> <i32 1, i32 5>
  %113 = shufflevector <2 x double> %i.ig, <2 x double> %i.il, <2 x i32> <i32 1, i32 3>
  %114 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %112, <2 x double> zeroinitializer, <2 x double> %113) ; 2 uses
  %i.ir = extractelement <2 x double> %114, i64 0
  %i.is = fadd double %110, %i.ir
  %i.it = extractelement <2 x double> %114, i64 1
  %115 = fadd double %i.ia, %i.it
  br label %bb.cp

bb.cp:                                            ; preds = %bb.co, %bb.cn, %bb.br
  %.sroa.22381.0.i = phi double [ 1.000000e+00, %bb.br ], [ %i.ha, %bb.co ], [ 1.000000e+00, %bb.cn ]
  %.sroa.18.0.i = phi double [ 0.000000e+00, %bb.br ], [ %109, %bb.co ], [ 0.000000e+00, %bb.cn ]
  %.sroa.22.0.i = phi double [ 1.000000e+00, %bb.br ], [ %115, %bb.co ], [ 1.000000e+00, %bb.cn ]
  %.sroa.20.0.i = phi double [ 0.000000e+00, %bb.br ], [ %i.is, %bb.co ], [ 0.000000e+00, %bb.cn ]
  %i.iu = phi <2 x double> [ zeroinitializer, %bb.br ], [ %84, %bb.co ], [ zeroinitializer, %bb.cn ]
  %i.iv = phi <2 x double> [ <double 0.000000e+00, double 1.000000e+00>, %bb.br ], [ %83, %bb.co ], [ <double 0.000000e+00, double 1.000000e+00>, %bb.cn ]
  %i.iw = phi <2 x double> [ <double 1.000000e+00, double 0.000000e+00>, %bb.br ], [ %i.gy, %bb.co ], [ <double 1.000000e+00, double 0.000000e+00>, %bb.cn ]
  %i.ix = phi <2 x double> [ zeroinitializer, %bb.br ], [ %i.iq, %bb.co ], [ zeroinitializer, %bb.cn ]
  %i.iy = phi <2 x double> [ <double 0.000000e+00, double 1.000000e+00>, %bb.br ], [ %106, %bb.co ], [ <double 0.000000e+00, double 1.000000e+00>, %bb.cn ]
  %i.iz = phi <2 x double> [ <double 1.000000e+00, double 0.000000e+00>, %bb.br ], [ %i.ip, %bb.co ], [ <double 1.000000e+00, double 0.000000e+00>, %bb.cn ]
  %i.ja = phi <2 x double> [ zeroinitializer, %bb.br ], [ %i.gw, %bb.co ], [ zeroinitializer, %bb.cn ] ; 2 uses
