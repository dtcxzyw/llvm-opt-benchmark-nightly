...
.lr.ph:                                           ; preds = %_ZN2cv3PtrINS_10OctreeNodeEEC2ERKS2_.exit, %_ZN2cv3PtrINS_10OctreeNodeEEaSERKS2_.exit76
  ...
  %i.eu = select i1 %.not.i, i8 0, i8 4
  %i.ev = and i64 %.031122, %i.dv
  %.not3.i = icmp eq i64 %i.ev, 0
  %i.ew = select i1 %.not3.i, i8 0, i8 2
  %4 = or disjoint i8 %i.ew, %i.eu
  %i.ex = and i64 %.031122, %i.ds
  %i.ey = icmp ne i64 %i.ex, 0                    ; 2 uses
  %i.ez = zext i1 %i.ey to i8
  %i.fa = or disjoint i8 %4, %i.ez                ; 2 uses
  %5 = zext nneg i8 %i.fa to i64                  ; 3 uses
  %6 = lshr i64 %5, 1
  %7 = and i64 %6, 1
  %8 = lshr i64 %5, 2
  %i.fb = uitofp i1 %i.ey to float
  %i.fc = uitofp nneg i64 %7 to float
  %i.fd = uitofp nneg i64 %8 to float
