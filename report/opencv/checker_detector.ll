...
bb.aq:                                            ; preds = %bb.ap
  ...
  %.043.in.in = select i1 %i.nd, ptr %i.mx, ptr %i.mr
  %.043.in.a = load i32, ptr %.043.in.in, align 4, !tbaa !61 ; 2 uses
  %.043 = sext i32 %.043.in.a to i64              ; 2 uses
  %i.ne = sdiv i32 %.043.in.a, 64
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %.025.in.in = select i1 %i.ke, ptr %i.ju, ptr %i.jk
  %.025.in.a = load i32, ptr %.025.in.in, align 4, !tbaa !61 ; 2 uses
  %.025 = sext i32 %.025.in.a to i64              ; 2 uses
  %i.kf = sdiv i32 %.025.in.a, 64
