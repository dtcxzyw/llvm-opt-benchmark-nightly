...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.ii, label %middle.block, label %vector.body, !llvm.loop !62
...
vector.body583:                                   ; preds = %vector.body583, %vector.ph565
  ...
  br i1 %i.ka, label %middle.block587, label %vector.body583, !llvm.loop !65
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %i.td, label %bb.g, label %.critedge, !llvm.loop !68
