...
bb.a:
  ...
  %8 = insertelement <2 x double> %i.v, double %i.w, i64 1 ; 2 uses
  %i.ak = insertelement <2 x double> poison, double %6, i64 0
  %9 = shufflevector <2 x double> %i.ak, <2 x double> poison, <2 x i32> zeroinitializer
  %i.al = fmul <2 x double> %8, %9
  ...
  %i.ap = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.aq = fmul <2 x double> %8, %i.ap
  ...
  %11 = insertelement <2 x double> poison, double %i.r, i64 0
  %12 = shufflevector <2 x double> %11, <2 x double> poison, <2 x i32> zeroinitializer
  %i.av = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ar, <2 x double> %12, <2 x double> %i.au) ; 2 uses
...
_ZN12_GLOBAL__N_118polishQuarticRootsEPKdPdi.exit: ; preds = %._crit_edge.i, %middle.block587, %bb.a
  ...
  %13 = insertelement <2 x double> poison, double %i.ae, i64 0
  %14 = insertelement <2 x double> %13, double %i.r, i64 1
