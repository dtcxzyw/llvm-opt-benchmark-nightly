...
.preheader.lr.ph:                                 ; preds = %_ZNSt6vectorIdSaIdEE6resizeEm.exit, %.preheader56
  %i.ai = load ptr, ptr %3, align 8, !tbaa !38
...
.preheader.epil:                                  ; preds = %.preheader.lr.ph, %.preheader.epil
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge, label %.preheader.epil, !llvm.loop !61
...
_ZNK2cv3Mat2atINS_6Point_IdEEEERKT_i.exit:        ; preds = %bb.f, %bb.h, %bb.j, %bb.k
  %i.bj = phi ptr [ %i.ak, %bb.f ], [ %i.ar, %bb.h ], [ %i.av, %bb.j ], [ %i.bc, %bb.k ] ; 4 uses
  %.0.i = phi ptr [ %i.al, %bb.f ], [ %i.as, %bb.h ], [ %i.ay, %bb.j ], [ %i.bi, %bb.k ]
  %i.bk = load double, ptr %.0.i, align 8, !tbaa !62
...
bb.w:                                             ; preds = %bb.s, %bb.u, %bb.v
  ...
  %i.do = load double, ptr %.0.i44.ph, align 8, !tbaa !65
...
bb.ab:                                            ; preds = %_ZNK2cv3Mat2atINS_6Point_IdEEEERKT_i.exit42
  ...
  %i.ej = load double, ptr %i.ei, align 8, !tbaa !65
  ...
  %i.em = load double, ptr %i.el, align 8, !tbaa !67
...
bb.ac:                                            ; preds = %bb.x, %bb.z, %bb.aa
  ...
  %i.ep = load double, ptr %i.eo, align 8, !tbaa !67
...
_ZNK2cv3Mat2atINS_7Point3_IdEEEERKT_i.exit50:     ; preds = %bb.ab, %bb.ad, %bb.af, %bb.ag
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.preheader56, label %bb.e, !llvm.loop !69
...
.preheader.epil:                                  ; preds = %.preheader.lr.ph, %.preheader.epil
  ...
  %lftr.wideiv = trunc i64 %indvars.iv.next65 to i32
  %epil.iter.cmp.not = icmp eq i32 %5, %lftr.wideiv
  br i1 %epil.iter.cmp.not, label %._crit_edge, label %.preheader.epil, !llvm.loop !70
...
bb.w:                                             ; preds = %bb.s, %bb.u, %bb.v
  %i.dp = phi ptr [ %i.di, %bb.v ], [ %i.db, %bb.u ], [ %i.cx, %bb.s ] ; 6 uses
  %.0.i44.ph = phi ptr [ %i.do, %bb.v ], [ %i.de, %bb.u ], [ %i.cy, %bb.s ]
  %i.dq = load double, ptr %.0.i44.ph, align 8, !tbaa !65
...
bb.ab:                                            ; preds = %_ZNK2cv3Mat2atINS_6Point_IfEEEERKT_i.exit42
  ...
  %i.eo = load double, ptr %i.en, align 8, !tbaa !67
...
bb.ac:                                            ; preds = %bb.x, %bb.z, %bb.aa
  ...
  %i.er = load double, ptr %i.eq, align 8, !tbaa !67
  %i.es = getelementptr inbounds nuw i8, ptr %i.bp, i64 24
  store double %i.er, ptr %i.es, align 8, !tbaa !8
  %i.et = load i32, ptr %i.ad, align 8
  %i.eu = icmp eq i32 %i.et, 1
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.dx = load ptr, ptr %i.de, align 8, !tbaa !75 ; 3 uses
  %i.dy = load ptr, ptr %i.df, align 8, !tbaa !78
...
.noexc:                                           ; preds = %bb.w
  %i.dz = load ptr, ptr %i.de, align 8, !tbaa !75
  %i.ea = getelementptr inbounds nuw i8, ptr %i.dz, i64 208
  store ptr %i.ea, ptr %i.de, align 8, !tbaa !75
...
_ZNSt6vectorIN2cv3MatESaIS1_EE9push_backERKS1_.exit: ; preds = %.noexc, %bb.x
  %i.eb = load ptr, ptr %i.dg, align 8, !tbaa !75 ; 3 uses
  %i.ec = load ptr, ptr %i.dh, align 8, !tbaa !78
...
.noexc51:                                         ; preds = %bb.y
  %i.ed = load ptr, ptr %i.dg, align 8, !tbaa !75
  %i.ee = getelementptr inbounds nuw i8, ptr %i.ed, i64 208
  store ptr %i.ee, ptr %i.dg, align 8, !tbaa !75
...
.lr.ph.i.i.i:                                     ; preds = %_ZNSt16allocator_traitsISaIN2cv3MatEEE9constructIS1_JRKS1_EEEvRS2_PT_DpOT0_.exit, %.lr.ph.i.i.i
  ...
  br i1 %.not.i.i.i, label %_ZNSt6vectorIN2cv3MatESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit, label %.lr.ph.i.i.i, !llvm.loop !81
...
.lr.ph.i.i.i27:                                   ; preds = %_ZNSt6vectorIN2cv3MatESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit, %.lr.ph.i.i.i27
  ...
  br i1 %.not.i.i.i30, label %_ZNSt6vectorIN2cv3MatESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit32, label %.lr.ph.i.i.i27, !llvm.loop !81
...
_ZNSt12_Vector_baseIN2cv3MatESaIS1_EE13_M_deallocateEPS1_m.exit: ; preds = %_ZNSt6vectorIN2cv3MatESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit32, %bb.c
  ...
  store ptr %.0.lcssa.i.i.i31, ptr %i.a, align 8, !tbaa !75
  %i.aa = getelementptr inbounds nuw [208 x i8], ptr %i.p, i64 %i.l
  store ptr %i.aa, ptr %i.w, align 8, !tbaa !78
  ret void
...
!61 = distinct !{!61, !29}
!62 = !{!63, !9, i64 0}
!63 = !{!"_ZTSN2cv6Point_IdEE", !9, i64 0, !9, i64 8}
!64 = !{!63, !9, i64 8}
!65 = !{!66, !9, i64 0}
!66 = !{!"_ZTSN2cv7Point3_IdEE", !9, i64 0, !9, i64 8, !9, i64 16}
!67 = !{!66, !9, i64 8}
!68 = !{!66, !9, i64 16}
!69 = distinct !{!69, !29}
!70 = distinct !{!70, !29}
