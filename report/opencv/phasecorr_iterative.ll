...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.il = getelementptr inbounds nuw [16 x i8], ptr %i.hu, i64 %indvars.iv.i29.i ; 2 uses
  %i.im = getelementptr inbounds nuw [16 x i8], ptr %i.hw, i64 %indvars.iv.i29.i
  %66 = getelementptr inbounds nuw i8, ptr %i.il, i64 8
  %i.in = getelementptr inbounds nuw [16 x i8], ptr %i.hs, i64 %indvars.iv.i29.i
  %67 = load double, ptr %66, align 8, !tbaa !75
  %68 = load double, ptr %i.il, align 8, !tbaa !75
  %i.io = load <2 x double>, ptr %i.im, align 8, !tbaa !75 ; 3 uses
  %69 = insertelement <2 x double> poison, double %67, i64 0
  %70 = shufflevector <2 x double> %69, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ip = fneg <2 x double> %i.io
  %i.iq = shufflevector <2 x double> %i.io, <2 x double> %i.ip, <2 x i32> <i32 1, i32 2>
  %i.ir = fmul <2 x double> %70, %i.iq
  %71 = insertelement <2 x double> poison, double %68, i64 0
  %i.is = shufflevector <2 x double> %71, <2 x double> poison, <2 x i32> zeroinitializer
  %i.it = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.is, <2 x double> %i.io, <2 x double> %i.ir) ; 4 uses
