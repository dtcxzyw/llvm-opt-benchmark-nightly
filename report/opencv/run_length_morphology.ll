...
.body:                                            ; preds = %.loopexit, %.loopexit.split-lp, %bb.ap, %.body.i
  ...
  %i.lt = load ptr, ptr %8, align 8, !tbaa !32    ; 3 uses
  %.not.i.i.i50 = icmp eq ptr %i.lt, null
  br i1 %.not.i.i.i50, label %_ZNSt6vectorIN2cv8ximgproc2rl6rlTypeESaIS3_EED2Ev.exit51, label %bb.bh

bb.bh:                                            ; preds = %.body
  %i.lu = getelementptr inbounds nuw i8, ptr %8, i64 16
...
_ZNSt6vectorIN2cv8ximgproc2rl6rlTypeESaIS3_EED2Ev.exit51: ; preds = %.body, %bb.bh
  ...
  %i.lz = load ptr, ptr %7, align 8, !tbaa !32    ; 3 uses
  %.not.i.i.i52 = icmp eq ptr %i.lz, null
...
_ZNSt6vectorIN2cv8ximgproc2rl6rlTypeESaIS3_EED2Ev.exit53: ; preds = %_ZNSt6vectorIN2cv8ximgproc2rl6rlTypeESaIS3_EED2Ev.exit51, %bb.bi
  ...
  %i.mf = load ptr, ptr %6, align 8, !tbaa !32    ; 3 uses
  %.not.i.i.i54 = icmp eq ptr %i.mf, null
...
bb.bj:                                            ; preds = %_ZNSt6vectorIN2cv8ximgproc2rl6rlTypeESaIS3_EED2Ev.exit53
  %i.mg = getelementptr inbounds nuw i8, ptr %6, i64 16
  %i.mh = load ptr, ptr %i.mg, align 8, !tbaa !33
  %i.mi = ptrtoint ptr %i.mh to i64
  %i.mj = ptrtoint ptr %i.mf to i64
  %i.mk = sub i64 %i.mi, %i.mj
  call void @_ZdlPvm(ptr noundef nonnull %i.mf, i64 noundef %i.mk) #17
...
bb.e:                                             ; preds = %.lr.ph251, %bb.d
  ...
  br i1 %exitcond.not, label %._crit_edge252, label %.lr.ph251, !llvm.loop !140
...
bb.h:                                             ; preds = %.lr.ph255
  ...
  br i1 %exitcond294.not, label %.preheader235, label %.lr.ph255, !llvm.loop !141
...
.lr.ph259.new:                                    ; preds = %.lr.ph259, %.lr.ph259.new
  ...
  br i1 %niter.ncmp.1, label %.preheader.lr.ph.unr-lcssa, label %.lr.ph259.new, !llvm.loop !142
...
bb.j:                                             ; preds = %.lr.ph
  ...
  br i1 %i.dx, label %.critedge, label %.lr.ph, !llvm.loop !143
...
.lr.ph:                                           ; preds = %.lr.ph260, %bb.j
  ...
  br i1 %i.ed, label %bb.j, label %..critedge.loopexit_crit_edge, !llvm.loop !143
...
bb.n:                                             ; preds = %bb.l, %bb.m, %bb.k
  ...
  br i1 %exitcond306.not, label %._crit_edge277, label %.preheader, !llvm.loop !144

._crit_edge277:                                   ; preds = %bb.n
  %i.en = trunc nuw i8 %.1105 to i1
  br i1 %i.en, label %._crit_edge277.thread, label %.lr.ph259, !llvm.loop !145
