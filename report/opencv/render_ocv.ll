...
_ZN2cv4util3getINS_4gapi3wip4draw4RectEJNS4_4TextENS4_5FTextES5_NS4_6CircleENS4_4LineENS4_6MosaicENS4_5ImageENS4_4PolyEEEERKT_RKNS0_7variantIJDpT0_EEE.exit: ; preds = %bb.b
  ...
  %30 = insertelement <2 x double> poison, double %i.bh, i64 0 ; 2 uses
  %i.bj = insertelement <2 x double> %30, double %i.bf, i64 1
  ...
  %i.bn = fmul <2 x double> %i.bm, <double -3.312640e-01, double -4.186880e-01>
  %i.bo = shufflevector <2 x double> %30, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bp = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bo, <2 x double> <double -1.687360e-01, double 5.000000e-01>, <2 x double> %i.bn) ; 2 uses
  %31 = shufflevector <2 x double> %i.bk, <2 x double> %i.bp, <2 x i32> <i32 0, i32 2>
  %i.bq = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bj, <2 x double> <double 2.990000e-01, double 5.000000e-01>, <2 x double> %31)
...
_ZN2cv4util3getINS_4gapi3wip4draw5FTextEJNS4_4TextES5_NS4_4RectENS4_6CircleENS4_4LineENS4_6MosaicENS4_5ImageENS4_4PolyEEEERKT_RKNS0_7variantIJDpT0_EEE.exit: ; preds = %bb.b
  ...
  %32 = insertelement <2 x double> poison, double %i.ef, i64 0 ; 2 uses
  %i.eh = insertelement <2 x double> %32, double %i.ed, i64 1
  ...
  %i.el = fmul <2 x double> %i.ek, <double -3.312640e-01, double -4.186880e-01>
  %i.em = shufflevector <2 x double> %32, <2 x double> poison, <2 x i32> zeroinitializer
  %i.en = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.em, <2 x double> <double -1.687360e-01, double 5.000000e-01>, <2 x double> %i.el) ; 2 uses
  %33 = shufflevector <2 x double> %i.ei, <2 x double> %i.en, <2 x i32> <i32 0, i32 2>
  %i.eo = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.eh, <2 x double> <double 2.990000e-01, double 5.000000e-01>, <2 x double> %33)
...
_ZN2cv4util3getINS_4gapi3wip4draw6CircleEJNS4_4TextENS4_5FTextENS4_4RectES5_NS4_4LineENS4_6MosaicENS4_5ImageENS4_4PolyEEEERKT_RKNS0_7variantIJDpT0_EEE.exit: ; preds = %bb.b
  ...
  %34 = insertelement <2 x double> poison, double %i.gn, i64 0 ; 2 uses
  %i.gp = insertelement <2 x double> %34, double %i.gl, i64 1
  ...
  %i.gt = fmul <2 x double> %i.gs, <double -3.312640e-01, double -4.186880e-01>
  %i.gu = shufflevector <2 x double> %34, <2 x double> poison, <2 x i32> zeroinitializer
  %i.gv = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gu, <2 x double> <double -1.687360e-01, double 5.000000e-01>, <2 x double> %i.gt) ; 2 uses
  %35 = shufflevector <2 x double> %i.gq, <2 x double> %i.gv, <2 x i32> <i32 0, i32 2>
  %i.gw = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gp, <2 x double> <double 2.990000e-01, double 5.000000e-01>, <2 x double> %35)
...
_ZN2cv4util3getINS_4gapi3wip4draw4LineEJNS4_4TextENS4_5FTextENS4_4RectENS4_6CircleES5_NS4_6MosaicENS4_5ImageENS4_4PolyEEEERKT_RKNS0_7variantIJDpT0_EEE.exit: ; preds = %bb.b
  ...
  %36 = insertelement <2 x double> poison, double %i.hq, i64 0 ; 2 uses
  %i.hs = insertelement <2 x double> %36, double %i.ho, i64 1
  ...
  %i.hw = fmul <2 x double> %i.hv, <double -3.312640e-01, double -4.186880e-01>
  %i.hx = shufflevector <2 x double> %36, <2 x double> poison, <2 x i32> zeroinitializer
  %i.hy = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hx, <2 x double> <double -1.687360e-01, double 5.000000e-01>, <2 x double> %i.hw) ; 2 uses
  %37 = shufflevector <2 x double> %i.ht, <2 x double> %i.hy, <2 x i32> <i32 0, i32 2>
  %i.hz = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hs, <2 x double> <double 2.990000e-01, double 5.000000e-01>, <2 x double> %37)
  ...
  %i.ic = extractelement <2 x double> %i.hy, i64 1
...
.loopexit:                                        ; preds = %.lr.ph.i.i.i.i.i.i, %bb.an
  ...
  %38 = insertelement <2 x double> poison, double %i.kb, i64 0 ; 2 uses
  %i.kd = insertelement <2 x double> %38, double %i.jw, i64 1
  ...
  %i.kh = fmul <2 x double> %i.kg, <double -3.312640e-01, double -4.186880e-01>
  %i.ki = shufflevector <2 x double> %38, <2 x double> poison, <2 x i32> zeroinitializer
  %i.kj = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ki, <2 x double> <double -1.687360e-01, double 5.000000e-01>, <2 x double> %i.kh) ; 2 uses
  %39 = shufflevector <2 x double> %i.ke, <2 x double> %i.kj, <2 x i32> <i32 0, i32 2>
  %i.kk = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.kd, <2 x double> <double 2.990000e-01, double 5.000000e-01>, <2 x double> %39)
