...
bb.a:
  ...
  %7 = insertelement <2 x i32> poison, i32 %i.q, i64 0
  %8 = insertelement <2 x i32> %7, i32 %i.p, i64 1
  %9 = sitofp <2 x i32> %8 to <2 x double>        ; 6 uses
  %10 = extractelement <2 x double> %9, i64 1
  %i.r = fsub double %10, %i.e                    ; 2 uses
  %11 = extractelement <2 x double> %9, i64 0     ; 2 uses
  %i.s = fsub double %11, %i.e
  ...
  %i.z = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.y, <2 x double> %12, <2 x double> zeroinitializer) ; 3 uses
  ...
  %i.ac = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.ai = insertelement <2 x double> poison, double %i.r, i64 0
  ...
  %i.am = insertelement <2 x double> %9, double %i.s, i64 1 ; 3 uses
  ...
  %i.ax = insertelement <2 x double> %9, double %i.r, i64 0
  ...
  %i.bg = call double @llvm.fmuladd.f64(double %i.m, double %11, double %i.bf)
