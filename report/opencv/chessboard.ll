...
bb.a:
  ...
  %16 = alloca %"class.cv::Matx.40", align 16     ; 10 uses
  ...
  %26 = alloca %"class.cv::details::Ellipse", align 16 ; 13 uses
...
.preheader312.lr.ph:                              ; preds = %bb.ac
  ...
  %i.aw = getelementptr inbounds nuw i8, ptr %16, i64 24
  %i.ax = getelementptr inbounds nuw i8, ptr %16, i64 32
  %i.ay = getelementptr inbounds nuw i8, ptr %16, i64 48
  %i.az = getelementptr inbounds nuw i8, ptr %16, i64 56
...
.preheader312.preheader:                          ; preds = %.preheader312.lr.ph
  ...
  %.4..4..4..sroa_idx425 = getelementptr inbounds nuw i8, ptr %26, i64 4
...
.preheader312:                                    ; preds = %.preheader312.preheader, %._crit_edge
  ...
  %46 = insertelement <2 x double> %i.bn, double %i.bm, i64 1 ; 3 uses
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.cq = load <2 x double>, ptr %16, align 16
  %i.cr = load double, ptr %i.au, align 8, !tbaa !38, !noalias !324 ; 2 uses
  %i.cs = load double, ptr %i.av, align 16, !tbaa !38, !noalias !324 ; 2 uses
  %i.ct = load <2 x double>, ptr %i.aw, align 8
  %i.cu = load <2 x double>, ptr %i.ay, align 16
  %48 = sitofp i32 %i.cp to double
  %49 = insertelement <2 x double> poison, double %48, i64 0
  %50 = shufflevector <2 x double> %49, <2 x double> poison, <2 x i32> zeroinitializer
  %51 = fadd <2 x double> %50, <double -4.000000e+01, double -0.000000e+00> ; 3 uses
  %52 = shufflevector <2 x double> %i.cq, <2 x double> poison, <2 x i32> zeroinitializer
  %53 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %52, <2 x double> %51, <2 x double> zeroinitializer) ; 2 uses
  ...
  %54 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cw, <2 x double> %46, <2 x double> %53)
  %55 = insertelement <2 x double> poison, double %i.cs, i64 0
  %56 = shufflevector <2 x double> %55, <2 x double> poison, <2 x i32> zeroinitializer
  %57 = fadd <2 x double> %56, %54
  %i.cx = shufflevector <2 x double> %i.ct, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cy = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cx, <2 x double> %51, <2 x double> zeroinitializer) ; 2 uses
  %i.cz = shufflevector <2 x double> %i.cu, <2 x double> poison, <2 x i32> zeroinitializer
  %58 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cz, <2 x double> %51, <2 x double> zeroinitializer) ; 2 uses
  %i.da = extractelement <2 x double> %53, i64 1
  %i.db = call double @llvm.fmuladd.f64(double %i.cr, double %i.bl, double %i.da)
  %i.dc = fadd double %i.cs, %i.db
  %59 = load <2 x double>, ptr %i.ax, align 16, !tbaa !38, !noalias !324 ; 4 uses
  %60 = load <2 x double>, ptr %i.az, align 8, !tbaa !38, !noalias !324 ; 4 uses
  %61 = shufflevector <2 x double> %59, <2 x double> poison, <2 x i32> zeroinitializer
  %i.dd = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %61, <2 x double> %46, <2 x double> %i.cy)
  %62 = shufflevector <2 x double> %59, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %63 = fadd <2 x double> %62, %i.dd
  %64 = shufflevector <2 x double> %60, <2 x double> poison, <2 x i32> zeroinitializer
  %i.de = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %64, <2 x double> %46, <2 x double> %58)
  %65 = shufflevector <2 x double> %60, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.df = fadd <2 x double> %65, %i.de            ; 2 uses
  %66 = shufflevector <2 x double> %59, <2 x double> %60, <2 x i32> <i32 0, i32 2>
  %67 = shufflevector <2 x double> %i.cy, <2 x double> %58, <2 x i32> <i32 1, i32 3>
  %i.dg = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %66, <2 x double> %47, <2 x double> %67)
  %68 = shufflevector <2 x double> %59, <2 x double> %60, <2 x i32> <i32 1, i32 3>
  %i.dh = fadd <2 x double> %68, %i.dg            ; 2 uses
  %69 = shufflevector <2 x double> %i.dh, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %70 = insertelement <2 x double> %69, double %i.dc, i64 0
  %71 = shufflevector <2 x double> %i.dh, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %72 = fdiv <2 x double> %70, %71                ; 2 uses
  %73 = extractelement <2 x double> %72, i64 0
  %74 = fptrunc double %73 to float               ; 2 uses
  %75 = extractelement <2 x double> %72, i64 1
  %76 = fptrunc double %75 to float               ; 2 uses
  %i.di = fdiv <2 x double> %57, %i.df
  %i.dj = fptrunc <2 x double> %i.di to <2 x float>
  %i.dk = fdiv <2 x double> %63, %i.df
  %i.dl = fptrunc <2 x double> %i.dk to <2 x float>
  %77 = insertelement <2 x float> poison, float %74, i64 0
  %i.dm = shufflevector <2 x float> %77, <2 x float> poison, <2 x i32> zeroinitializer
  %i.dn = fsub <2 x float> %i.dj, %i.dm           ; 3 uses
  %78 = insertelement <2 x float> poison, float %76, i64 0
  %79 = shufflevector <2 x float> %78, <2 x float> poison, <2 x i32> zeroinitializer
  %i.do = fsub <2 x float> %i.dl, %79             ; 3 uses
  ...
  store float %74, ptr %26, align 16, !alias.scope !321
  store float %76, ptr %.4..4..4..sroa_idx425, align 4, !alias.scope !321
...
bb.a:
  %6 = alloca %"class.cv::Matx.40", align 16      ; 10 uses
  %i.a = add nsw i32 %3, 1
  ...
  %8 = load double, ptr %i.l, align 8, !tbaa !38, !noalias !370 ; 2 uses
  %i.m = getelementptr inbounds nuw i8, ptr %6, i64 16
  %9 = load double, ptr %i.m, align 16, !tbaa !38, !noalias !370 ; 2 uses
  ...
  %10 = load <2 x double>, ptr %i.q, align 16
  %11 = getelementptr inbounds nuw i8, ptr %6, i64 56
  %.sroa_idx41 = getelementptr inbounds nuw i8, ptr %0, i64 4
  %12 = getelementptr inbounds nuw i8, ptr %0, i64 8
  %13 = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> zeroinitializer
  %14 = insertelement <2 x double> poison, double %i.j, i64 0
  %15 = insertelement <2 x double> %14, double %i.c, i64 1 ; 3 uses
  %16 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %13, <2 x double> %15, <2 x double> zeroinitializer) ; 2 uses
  ...
  %17 = insertelement <2 x double> poison, double %i.f, i64 0 ; 2 uses
  %18 = insertelement <2 x double> %17, double %i.k, i64 1 ; 3 uses
  %19 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.s, <2 x double> %18, <2 x double> %16)
  %i.t = insertelement <2 x double> poison, double %9, i64 0
  %i.u = shufflevector <2 x double> %i.t, <2 x double> poison, <2 x i32> zeroinitializer
  %20 = fadd <2 x double> %i.u, %19
  %21 = shufflevector <2 x double> %i.o, <2 x double> poison, <2 x i32> zeroinitializer
  %22 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %21, <2 x double> %15, <2 x double> zeroinitializer) ; 2 uses
  %i.v = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> zeroinitializer
  %23 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.v, <2 x double> %15, <2 x double> zeroinitializer) ; 2 uses
  %24 = extractelement <2 x double> %16, i64 1
  %25 = call double @llvm.fmuladd.f64(double %8, double %i.f, double %24)
  %26 = fadd double %9, %25
  %27 = load <2 x double>, ptr %i.p, align 16, !tbaa !38, !noalias !370 ; 4 uses
  %28 = load <2 x double>, ptr %11, align 8, !tbaa !38, !noalias !370 ; 4 uses
  %29 = shufflevector <2 x double> %27, <2 x double> poison, <2 x i32> zeroinitializer
  %30 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %29, <2 x double> %18, <2 x double> %22)
  %31 = shufflevector <2 x double> %27, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.w = fadd <2 x double> %31, %30
  %32 = shufflevector <2 x double> %28, <2 x double> poison, <2 x i32> zeroinitializer
  %33 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %32, <2 x double> %18, <2 x double> %23)
  %34 = shufflevector <2 x double> %28, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %35 = fadd <2 x double> %34, %33                ; 2 uses
  %36 = shufflevector <2 x double> %27, <2 x double> %28, <2 x i32> <i32 0, i32 2>
  %i.x = shufflevector <2 x double> %17, <2 x double> poison, <2 x i32> zeroinitializer
  %37 = shufflevector <2 x double> %22, <2 x double> %23, <2 x i32> <i32 1, i32 3>
  %i.y = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %36, <2 x double> %i.x, <2 x double> %37)
  %38 = shufflevector <2 x double> %27, <2 x double> %28, <2 x i32> <i32 1, i32 3>
  %i.z = fadd <2 x double> %38, %i.y              ; 2 uses
  %39 = shufflevector <2 x double> %i.z, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %i.aa = insertelement <2 x double> %39, double %26, i64 0
  %40 = shufflevector <2 x double> %i.z, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %41 = fdiv <2 x double> %i.aa, %40              ; 2 uses
  %42 = extractelement <2 x double> %41, i64 0
  %43 = fptrunc double %42 to float               ; 2 uses
  %44 = extractelement <2 x double> %41, i64 1
  %45 = fptrunc double %44 to float               ; 2 uses
  %i.ab = fdiv <2 x double> %20, %35
  %i.ac = fptrunc <2 x double> %i.ab to <2 x float>
  %i.ad = fdiv <2 x double> %i.w, %35
  %i.ae = fptrunc <2 x double> %i.ad to <2 x float>
  %46 = insertelement <2 x float> poison, float %43, i64 0
  %47 = shufflevector <2 x float> %46, <2 x float> poison, <2 x i32> zeroinitializer
  %48 = fsub <2 x float> %i.ac, %47               ; 3 uses
  %49 = insertelement <2 x float> poison, float %45, i64 0
  %50 = shufflevector <2 x float> %49, <2 x float> poison, <2 x i32> zeroinitializer
  %i.af = fsub <2 x float> %i.ae, %50             ; 3 uses
  %i.ag = fpext <2 x float> %48 to <2 x double>   ; 2 uses
  ...
  %i.an = extractelement <2 x float> %48, i64 0
  %i.ao = extractelement <2 x float> %48, i64 1
  ...
  store float %45, ptr %.sroa_idx41, align 4
  store <2 x float> %i.al, ptr %12, align 4
...
bb.a:
  %5 = alloca %"class.cv::Matx.40", align 16      ; 14 uses
  %6 = alloca %"class.cv::Matx.40", align 16      ; 14 uses
  %7 = alloca %"class.cv::Point_", align 8        ; 12 uses
  %8 = alloca %"class.cv::details::Ellipse", align 4 ; 14 uses
  %9 = alloca %"class.cv::Mat", align 8           ; 7 uses
  %10 = alloca %"class.cv::details::Ellipse", align 4 ; 14 uses
...
_ZN2cv7details10Chessboard5Board9PointIterdeEv.exit49.peel.begin: ; preds = %bb.b
  ...
  %.sroa_idx41.i = getelementptr inbounds nuw i8, ptr %8, i64 4 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %i.w = load <2 x double>, ptr %6, align 16
  %i.x = load double, ptr %i.i, align 8, !tbaa !38, !noalias !647 ; 2 uses
  %i.y = load double, ptr %i.j, align 16, !tbaa !38, !noalias !647 ; 2 uses
  %i.z = load <2 x double>, ptr %i.k, align 8
  %i.aa = load <2 x double>, ptr %i.m, align 16
  %13 = shufflevector <2 x double> %i.w, <2 x double> poison, <2 x i32> zeroinitializer
  %14 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %13, <2 x double> <double 6.000000e+01, double 1.000000e+02>, <2 x double> zeroinitializer) ; 2 uses
  %15 = insertelement <2 x double> poison, double %i.x, i64 0
  %i.ab = shufflevector <2 x double> %15, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ac = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ab, <2 x double> <double 1.000000e+02, double 6.000000e+01>, <2 x double> %14)
  %i.ad = insertelement <2 x double> poison, double %i.y, i64 0
  %i.ae = shufflevector <2 x double> %i.ad, <2 x double> poison, <2 x i32> zeroinitializer
  %16 = fadd <2 x double> %i.ae, %i.ac
  %17 = shufflevector <2 x double> %i.z, <2 x double> poison, <2 x i32> zeroinitializer
  %18 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %17, <2 x double> <double 6.000000e+01, double 1.000000e+02>, <2 x double> zeroinitializer) ; 2 uses
  %i.af = shufflevector <2 x double> %i.aa, <2 x double> poison, <2 x i32> zeroinitializer
  %19 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.af, <2 x double> <double 6.000000e+01, double 1.000000e+02>, <2 x double> zeroinitializer) ; 2 uses
  %i.ag = extractelement <2 x double> %14, i64 1
  %i.ah = call double @llvm.fmuladd.f64(double %i.x, double 1.000000e+02, double %i.ag)
  %i.ai = fadd double %i.y, %i.ah
  %20 = load <2 x double>, ptr %i.l, align 16, !tbaa !38, !noalias !647 ; 4 uses
  %21 = load <2 x double>, ptr %i.n, align 8, !tbaa !38, !noalias !647 ; 4 uses
  %22 = shufflevector <2 x double> %20, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aj = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> <double 1.000000e+02, double 6.000000e+01>, <2 x double> %18)
  %23 = shufflevector <2 x double> %20, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %24 = fadd <2 x double> %23, %i.aj
  %25 = shufflevector <2 x double> %21, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ak = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %25, <2 x double> <double 1.000000e+02, double 6.000000e+01>, <2 x double> %19)
  %26 = shufflevector <2 x double> %21, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.al = fadd <2 x double> %26, %i.ak            ; 2 uses
  %27 = shufflevector <2 x double> %20, <2 x double> %21, <2 x i32> <i32 0, i32 2>
  %28 = shufflevector <2 x double> %18, <2 x double> %19, <2 x i32> <i32 1, i32 3>
  %i.am = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %27, <2 x double> splat (double 1.000000e+02), <2 x double> %28)
  %29 = shufflevector <2 x double> %20, <2 x double> %21, <2 x i32> <i32 1, i32 3>
  %i.an = fadd <2 x double> %29, %i.am            ; 2 uses
  %30 = shufflevector <2 x double> %i.an, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %31 = insertelement <2 x double> %30, double %i.ai, i64 0
  %32 = shufflevector <2 x double> %i.an, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %33 = fdiv <2 x double> %31, %32                ; 2 uses
  %34 = extractelement <2 x double> %33, i64 0
  %35 = fptrunc double %34 to float               ; 2 uses
  %36 = extractelement <2 x double> %33, i64 1
  %37 = fptrunc double %36 to float               ; 2 uses
  %i.ao = fdiv <2 x double> %16, %i.al
  %i.ap = fptrunc <2 x double> %i.ao to <2 x float>
  %i.aq = fdiv <2 x double> %24, %i.al
  ...
  %i.au = fsub <2 x float> %i.ar, %40             ; 3 uses
  ...
  store float %35, ptr %8, align 4, !alias.scope !644
  store float %37, ptr %.sroa_idx41.i, align 4, !alias.scope !644
  store <2 x float> %i.ba, ptr %i.o, align 4, !alias.scope !644
  store float %i.bj, ptr %i.p, align 4, !tbaa !160, !alias.scope !644
  ...
  store float %i.bm, ptr %i.r, align 4, !tbaa !164, !alias.scope !644
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.by = load <2 x double>, ptr %6, align 16
  %i.bz = load double, ptr %i.i, align 8, !tbaa !38, !noalias !652 ; 2 uses
  %i.ca = load double, ptr %i.j, align 16, !tbaa !38, !noalias !652 ; 2 uses
  %i.cb = load <2 x double>, ptr %i.k, align 8
  %i.cc = load <2 x double>, ptr %i.m, align 16
  %41 = sitofp i32 %i.bx to double
  %42 = insertelement <2 x double> poison, double %41, i64 0
  %43 = shufflevector <2 x double> %42, <2 x double> poison, <2 x i32> zeroinitializer
  %44 = fadd <2 x double> %43, <double -4.000000e+01, double -0.000000e+00> ; 3 uses
  %45 = shufflevector <2 x double> %i.by, <2 x double> poison, <2 x i32> zeroinitializer
  %46 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %45, <2 x double> %44, <2 x double> zeroinitializer) ; 2 uses
  ...
  %47 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ce, <2 x double> <double 1.000000e+02, double 6.000000e+01>, <2 x double> %46)
  %48 = insertelement <2 x double> poison, double %i.ca, i64 0
  %49 = shufflevector <2 x double> %48, <2 x double> poison, <2 x i32> zeroinitializer
  %50 = fadd <2 x double> %49, %47
  %i.cf = shufflevector <2 x double> %i.cb, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cg = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cf, <2 x double> %44, <2 x double> zeroinitializer) ; 2 uses
  %i.ch = shufflevector <2 x double> %i.cc, <2 x double> poison, <2 x i32> zeroinitializer
  %51 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ch, <2 x double> %44, <2 x double> zeroinitializer) ; 2 uses
  %i.ci = extractelement <2 x double> %46, i64 1
  %i.cj = call double @llvm.fmuladd.f64(double %i.bz, double 1.000000e+02, double %i.ci)
  %i.ck = fadd double %i.ca, %i.cj
  %52 = load <2 x double>, ptr %i.l, align 16, !tbaa !38, !noalias !652 ; 4 uses
  %53 = load <2 x double>, ptr %i.n, align 8, !tbaa !38, !noalias !652 ; 4 uses
  %54 = shufflevector <2 x double> %52, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cl = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %54, <2 x double> <double 1.000000e+02, double 6.000000e+01>, <2 x double> %i.cg)
  %55 = shufflevector <2 x double> %52, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %56 = fadd <2 x double> %55, %i.cl
  %57 = shufflevector <2 x double> %53, <2 x double> poison, <2 x i32> zeroinitializer
  %i.cm = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %57, <2 x double> <double 1.000000e+02, double 6.000000e+01>, <2 x double> %51)
  %58 = shufflevector <2 x double> %53, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.cn = fadd <2 x double> %58, %i.cm            ; 2 uses
  %59 = shufflevector <2 x double> %52, <2 x double> %53, <2 x i32> <i32 0, i32 2>
  %60 = shufflevector <2 x double> %i.cg, <2 x double> %51, <2 x i32> <i32 1, i32 3>
  %i.co = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %59, <2 x double> splat (double 1.000000e+02), <2 x double> %60)
  %61 = shufflevector <2 x double> %52, <2 x double> %53, <2 x i32> <i32 1, i32 3>
  %i.cp = fadd <2 x double> %61, %i.co            ; 2 uses
  %62 = shufflevector <2 x double> %i.cp, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %63 = insertelement <2 x double> %62, double %i.ck, i64 0
  %64 = shufflevector <2 x double> %i.cp, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %65 = fdiv <2 x double> %63, %64                ; 2 uses
  %66 = extractelement <2 x double> %65, i64 0
  %67 = fptrunc double %66 to float               ; 2 uses
  %68 = extractelement <2 x double> %65, i64 1
  %69 = fptrunc double %68 to float               ; 2 uses
  %i.cq = fdiv <2 x double> %50, %i.cn
  %i.cr = fptrunc <2 x double> %i.cq to <2 x float>
  %i.cs = fdiv <2 x double> %56, %i.cn
  ...
  %i.cw = fsub <2 x float> %i.ct, %72             ; 3 uses
  ...
  store float %67, ptr %8, align 4, !alias.scope !650
  store float %69, ptr %.sroa_idx41.i, align 4, !alias.scope !650
  store <2 x float> %i.dc, ptr %i.o, align 4, !alias.scope !650
  store float %i.dl, ptr %i.p, align 4, !tbaa !160, !alias.scope !650
  ...
  store float %i.do, ptr %i.r, align 4, !tbaa !164, !alias.scope !650
...
.loopexit208:                                     ; preds = %bb.k
  ...
  %i.ec = getelementptr inbounds nuw i8, ptr %5, i64 24 ; 2 uses
  %i.ed = getelementptr inbounds nuw i8, ptr %5, i64 32 ; 2 uses
  %i.ee = getelementptr inbounds nuw i8, ptr %5, i64 48 ; 2 uses
  %i.ef = getelementptr inbounds nuw i8, ptr %5, i64 56 ; 2 uses
  %.sroa_idx41.i70 = getelementptr inbounds nuw i8, ptr %10, i64 4 ; 2 uses
...
bb.l:                                             ; preds = %bb.w, %.loopexit208
  ...
  %74 = shufflevector <2 x double> %i.eo, <2 x double> poison, <2 x i32> zeroinitializer ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.eu = load <2 x double>, ptr %5, align 16
  %i.ev = load double, ptr %i.ea, align 8, !tbaa !38, !noalias !657 ; 2 uses
  %i.ew = load double, ptr %i.eb, align 16, !tbaa !38, !noalias !657 ; 2 uses
  %i.ex = load <2 x double>, ptr %i.ec, align 8
  %i.ey = load <2 x double>, ptr %i.ee, align 16
  %75 = sitofp i32 %i.et to double
  %76 = insertelement <2 x double> poison, double %75, i64 0
  %77 = shufflevector <2 x double> %76, <2 x double> poison, <2 x i32> zeroinitializer
  %78 = fadd <2 x double> %77, <double -4.000000e+01, double -0.000000e+00> ; 3 uses
  %79 = shufflevector <2 x double> %i.eu, <2 x double> poison, <2 x i32> zeroinitializer
  %80 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %79, <2 x double> %78, <2 x double> zeroinitializer) ; 2 uses
  ...
  %81 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.fa, <2 x double> %73, <2 x double> %80)
  %82 = insertelement <2 x double> poison, double %i.ew, i64 0
  ...
  %i.fc = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.fb, <2 x double> %78, <2 x double> zeroinitializer) ; 2 uses
  %i.fd = shufflevector <2 x double> %i.ey, <2 x double> poison, <2 x i32> zeroinitializer
  %85 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.fd, <2 x double> %78, <2 x double> zeroinitializer) ; 2 uses
  %i.fe = extractelement <2 x double> %80, i64 1
  %i.ff = call double @llvm.fmuladd.f64(double %i.ev, double %i.em, double %i.fe)
  %i.fg = fadd double %i.ew, %i.ff
  %86 = load <2 x double>, ptr %i.ed, align 16, !tbaa !38, !noalias !657 ; 4 uses
  %87 = load <2 x double>, ptr %i.ef, align 8, !tbaa !38, !noalias !657 ; 4 uses
  %88 = shufflevector <2 x double> %86, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fh = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %88, <2 x double> %73, <2 x double> %i.fc)
  %89 = shufflevector <2 x double> %86, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %90 = fadd <2 x double> %89, %i.fh
  %91 = shufflevector <2 x double> %87, <2 x double> poison, <2 x i32> zeroinitializer
  %i.fi = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %91, <2 x double> %73, <2 x double> %85)
  %92 = shufflevector <2 x double> %87, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.fj = fadd <2 x double> %92, %i.fi            ; 2 uses
  %93 = shufflevector <2 x double> %86, <2 x double> %87, <2 x i32> <i32 0, i32 2>
  %94 = shufflevector <2 x double> %i.fc, <2 x double> %85, <2 x i32> <i32 1, i32 3>
  %i.fk = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %93, <2 x double> %74, <2 x double> %94)
  %95 = shufflevector <2 x double> %86, <2 x double> %87, <2 x i32> <i32 1, i32 3>
  %i.fl = fadd <2 x double> %95, %i.fk            ; 2 uses
  %96 = shufflevector <2 x double> %i.fl, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %97 = insertelement <2 x double> %96, double %i.fg, i64 0
  %98 = shufflevector <2 x double> %i.fl, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %99 = fdiv <2 x double> %97, %98                ; 2 uses
  %100 = extractelement <2 x double> %99, i64 0
  %101 = fptrunc double %100 to float             ; 2 uses
  %102 = extractelement <2 x double> %99, i64 1
  %103 = fptrunc double %102 to float             ; 2 uses
  %i.fm = fdiv <2 x double> %84, %i.fj
  %i.fn = fptrunc <2 x double> %i.fm to <2 x float>
  %i.fo = fdiv <2 x double> %90, %i.fj
  ...
  %i.fs = fsub <2 x float> %i.fp, %106            ; 3 uses
  ...
  store float %101, ptr %10, align 4, !alias.scope !654
  store float %103, ptr %.sroa_idx41.i70, align 4, !alias.scope !654
  store <2 x float> %i.fy, ptr %i.eg, align 4, !alias.scope !654
  store float %i.gh, ptr %i.eh, align 4, !tbaa !160, !alias.scope !654
  ...
  store float %i.gk, ptr %i.ej, align 4, !tbaa !164, !alias.scope !654
...
_ZN2cv7details10Chessboard5Board9PointIterdeEv.exit67.outer.peel.newph: ; preds = %bb.q
  ...
  %i.ha = fadd <2 x double> %i.gz, <double -4.000000e+01, double -0.000000e+00> ; 3 uses
...
bb.s:                                             ; preds = %bb.r
  %i.hg = load <2 x double>, ptr %5, align 16
  %i.hh = load double, ptr %i.ea, align 8, !tbaa !38, !noalias !662 ; 2 uses
  %i.hi = load double, ptr %i.eb, align 16, !tbaa !38, !noalias !662 ; 2 uses
  %i.hj = load <2 x double>, ptr %i.ec, align 8
  %i.hk = load <2 x double>, ptr %i.ee, align 16
  %107 = shufflevector <2 x double> %i.hg, <2 x double> poison, <2 x i32> zeroinitializer
  %108 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %107, <2 x double> %i.ha, <2 x double> zeroinitializer) ; 2 uses
  %109 = insertelement <2 x double> poison, double %i.hh, i64 0
  %i.hl = shufflevector <2 x double> %109, <2 x double> poison, <2 x i32> zeroinitializer
  %i.hm = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hl, <2 x double> %73, <2 x double> %108)
  ...
  %110 = fadd <2 x double> %i.ho, %i.hm
  %111 = shufflevector <2 x double> %i.hj, <2 x double> poison, <2 x i32> zeroinitializer
  %112 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %111, <2 x double> %i.ha, <2 x double> zeroinitializer) ; 2 uses
  %i.hp = shufflevector <2 x double> %i.hk, <2 x double> poison, <2 x i32> zeroinitializer
  %113 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hp, <2 x double> %i.ha, <2 x double> zeroinitializer) ; 2 uses
  %i.hq = extractelement <2 x double> %108, i64 1
  %i.hr = call double @llvm.fmuladd.f64(double %i.hh, double %i.em, double %i.hq)
  %i.hs = fadd double %i.hi, %i.hr
  %114 = load <2 x double>, ptr %i.ed, align 16, !tbaa !38, !noalias !662 ; 4 uses
  %115 = load <2 x double>, ptr %i.ef, align 8, !tbaa !38, !noalias !662 ; 4 uses
  %116 = shufflevector <2 x double> %114, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ht = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %116, <2 x double> %73, <2 x double> %112)
  %117 = shufflevector <2 x double> %114, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %118 = fadd <2 x double> %117, %i.ht
  %119 = shufflevector <2 x double> %115, <2 x double> poison, <2 x i32> zeroinitializer
  %i.hu = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %119, <2 x double> %73, <2 x double> %113)
  %120 = shufflevector <2 x double> %115, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.hv = fadd <2 x double> %120, %i.hu           ; 2 uses
  %121 = shufflevector <2 x double> %114, <2 x double> %115, <2 x i32> <i32 0, i32 2>
  %122 = shufflevector <2 x double> %112, <2 x double> %113, <2 x i32> <i32 1, i32 3>
  %i.hw = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %121, <2 x double> %74, <2 x double> %122)
  %123 = shufflevector <2 x double> %114, <2 x double> %115, <2 x i32> <i32 1, i32 3>
  %i.hx = fadd <2 x double> %123, %i.hw           ; 2 uses
  %124 = shufflevector <2 x double> %i.hx, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %125 = insertelement <2 x double> %124, double %i.hs, i64 0
  %126 = shufflevector <2 x double> %i.hx, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %127 = fdiv <2 x double> %125, %126             ; 2 uses
  %128 = extractelement <2 x double> %127, i64 0
  %129 = fptrunc double %128 to float             ; 2 uses
  %130 = extractelement <2 x double> %127, i64 1
  %131 = fptrunc double %130 to float             ; 2 uses
  %i.hy = fdiv <2 x double> %110, %i.hv
  %i.hz = fptrunc <2 x double> %i.hy to <2 x float>
  %i.ia = fdiv <2 x double> %118, %i.hv
  ...
  %i.ie = fsub <2 x float> %i.ib, %134            ; 3 uses
  ...
  store float %129, ptr %10, align 4, !alias.scope !660
  store float %131, ptr %.sroa_idx41.i70, align 4, !alias.scope !660
  store <2 x float> %i.ik, ptr %i.eg, align 4, !alias.scope !660
  store float %i.it, ptr %i.eh, align 4, !tbaa !160, !alias.scope !660
  ...
  store float %i.iw, ptr %i.ej, align 4, !tbaa !164, !alias.scope !660
