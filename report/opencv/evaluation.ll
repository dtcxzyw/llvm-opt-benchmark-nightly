...
bb.k:                                             ; preds = %bb.j
  %4 = getelementptr inbounds nuw i8, ptr %.pn17.i24, i64 40
  %.neg23.i37 = udiv exact i64 %i.ai, 20
  %.neg23.neg.i38 = sub nsw i64 0, %.neg23.i37
  %5 = getelementptr inbounds [20 x i8], ptr %4, i64 %.neg23.neg.i38
  tail call void @llvm.memmove.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %5, ptr noundef nonnull align 4 dereferenceable(1) %0, i64 %i.ai, i1 false)
