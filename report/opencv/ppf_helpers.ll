...
_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i: ; preds = %bb.m
  ...
  br i1 %.not.i.i.i.i, label %_ZN2cv10AutoBufferIiLm264EEC2Em.exit106.thread193, label %bb.o

_ZN2cv10AutoBufferIiLm264EEC2Em.exit106.thread193: ; preds = %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i
...
._crit_edge:                                      ; preds = %_ZN2cv10AutoBufferIiLm264EEC2Em.exit106.thread193, %.lr.ph
  %i.bj = phi ptr [ %i.bf, %.lr.ph ], [ %i.ao, %_ZN2cv10AutoBufferIiLm264EEC2Em.exit106.thread193 ] ; 2 uses
  %i.bk = phi ptr [ %i.bg, %.lr.ph ], [ %i.ao, %_ZN2cv10AutoBufferIiLm264EEC2Em.exit106.thread193 ] ; 3 uses
  %i.bl = phi ptr [ %i.ar, %.lr.ph ], [ null, %_ZN2cv10AutoBufferIiLm264EEC2Em.exit106.thread193 ]
...
.lr.ph.i:                                         ; preds = %bb.v, %.lr.ph.i
  %.0.us51.i = phi float [ %i.dl, %.lr.ph.i ], [ 0.000000e+00, %bb.v ]
  %.037.us50.i = phi ptr [ %i.dm, %.lr.ph.i ], [ %i.cm, %bb.v ] ; 5 uses
  %.039.us49.i = phi ptr [ %i.dn, %.lr.ph.i ], [ %i.ce, %bb.v ] ; 5 uses
  %i.cp = load float, ptr %.037.us50.i, align 4, !tbaa !86
  %i.cq = load float, ptr %.039.us49.i, align 4, !tbaa !86
  %i.cr = fsub float %i.cp, %i.cq                 ; 2 uses
  %i.cs = getelementptr inbounds nuw i8, ptr %.037.us50.i, i64 4
  %i.ct = load float, ptr %i.cs, align 4, !tbaa !86
  %i.cu = getelementptr inbounds nuw i8, ptr %.039.us49.i, i64 4
  %i.cv = load float, ptr %i.cu, align 4, !tbaa !86
  %i.cw = fsub float %i.ct, %i.cv                 ; 2 uses
  %i.cx = getelementptr inbounds nuw i8, ptr %.037.us50.i, i64 8
  %i.cy = load float, ptr %i.cx, align 4, !tbaa !86
  %i.cz = getelementptr inbounds nuw i8, ptr %.039.us49.i, i64 8
  %i.da = load float, ptr %i.cz, align 4, !tbaa !86
  %i.db = fsub float %i.cy, %i.da                 ; 2 uses
  %i.dc = getelementptr inbounds nuw i8, ptr %.037.us50.i, i64 12
  %i.dd = load float, ptr %i.dc, align 4, !tbaa !86
  %i.de = getelementptr inbounds nuw i8, ptr %.039.us49.i, i64 12
  ...
  %i.dl = fadd float %.0.us51.i, %i.dk            ; 2 uses
  %i.dm = getelementptr inbounds nuw i8, ptr %.037.us50.i, i64 16 ; 3 uses
  %i.dn = getelementptr inbounds nuw i8, ptr %.039.us49.i, i64 16 ; 2 uses
  %i.do = icmp ult ptr %i.dm, %i.co
  br i1 %i.do, label %.lr.ph.i, label %.preheader.i

.preheader.i:                                     ; preds = %.lr.ph.i, %bb.v
  %.us-phi.i = phi ptr [ %i.ce, %bb.v ], [ %i.dn, %.lr.ph.i ]
  %.us-phi47.i = phi ptr [ %i.cm, %bb.v ], [ %i.dm, %.lr.ph.i ] ; 2 uses
  %.us-phi48.i = phi float [ 0.000000e+00, %bb.v ], [ %i.dl, %.lr.ph.i ] ; 2 uses
  %i.dp = icmp ult ptr %.us-phi47.i, %i.cn
  br i1 %i.dp, label %.lr.ph57.i, label %_ZNK7cvflann2L2IfEclIPfS3_EEfT_T0_mf.exit

.lr.ph57.i:                                       ; preds = %.preheader.i, %.lr.ph57.i
  %.156.i = phi float [ %i.dv, %.lr.ph57.i ], [ %.us-phi48.i, %.preheader.i ]
  %.13855.i = phi ptr [ %i.dq, %.lr.ph57.i ], [ %.us-phi47.i, %.preheader.i ] ; 2 uses
  %.14054.i = phi ptr [ %i.ds, %.lr.ph57.i ], [ %.us-phi.i, %.preheader.i ] ; 2 uses
  %i.dq = getelementptr inbounds nuw i8, ptr %.13855.i, i64 4 ; 2 uses
  %i.dr = load float, ptr %.13855.i, align 4, !tbaa !86
  %i.ds = getelementptr inbounds nuw i8, ptr %.14054.i, i64 4
  %i.dt = load float, ptr %.14054.i, align 4, !tbaa !86
  %i.du = fsub float %i.dr, %i.dt                 ; 2 uses
  %i.dv = call float @llvm.fmuladd.f32(float %i.du, float %i.du, float %.156.i) ; 2 uses
...
_ZNK7cvflann2L2IfEclIPfS3_EEfT_T0_mf.exit:        ; preds = %.lr.ph57.i, %.preheader.i
  %.036.i = phi float [ %.us-phi48.i, %.preheader.i ], [ %i.dv, %.lr.ph57.i ] ; 2 uses
...
._crit_edge158:                                   ; preds = %._crit_edge158.loopexit, %_ZNK7cvflann2L2IfEclIPfS3_EEfT_T0_mf.exit
  ...
  %i.ec = fcmp ogt float %.076.lcssa, %i.eb
...
.lr.ph.i120:                                      ; preds = %.lr.ph157, %.lr.ph.i120
  %.0.us51.i121 = phi float [ %i.ff, %.lr.ph.i120 ], [ 0.000000e+00, %.lr.ph157 ]
  %.037.us50.i122 = phi ptr [ %i.fg, %.lr.ph.i120 ], [ %i.cm, %.lr.ph157 ] ; 5 uses
  %.039.us49.i123 = phi ptr [ %i.fh, %.lr.ph.i120 ], [ %i.ei, %.lr.ph157 ] ; 5 uses
  %i.ej = load float, ptr %.037.us50.i122, align 4, !tbaa !86
  %i.ek = load float, ptr %.039.us49.i123, align 4, !tbaa !86
  %i.el = fsub float %i.ej, %i.ek                 ; 2 uses
  %i.em = getelementptr inbounds nuw i8, ptr %.037.us50.i122, i64 4
  %i.en = load float, ptr %i.em, align 4, !tbaa !86
  %i.eo = getelementptr inbounds nuw i8, ptr %.039.us49.i123, i64 4
  %i.ep = load float, ptr %i.eo, align 4, !tbaa !86
  %i.eq = fsub float %i.en, %i.ep                 ; 2 uses
  %i.er = getelementptr inbounds nuw i8, ptr %.037.us50.i122, i64 8
  %i.es = load float, ptr %i.er, align 4, !tbaa !86
  %i.et = getelementptr inbounds nuw i8, ptr %.039.us49.i123, i64 8
  %i.eu = load float, ptr %i.et, align 4, !tbaa !86
  %i.ev = fsub float %i.es, %i.eu                 ; 2 uses
  %i.ew = getelementptr inbounds nuw i8, ptr %.037.us50.i122, i64 12
  %i.ex = load float, ptr %i.ew, align 4, !tbaa !86
  %i.ey = getelementptr inbounds nuw i8, ptr %.039.us49.i123, i64 12
  ...
  %i.ff = fadd float %.0.us51.i121, %i.fe         ; 2 uses
  %i.fg = getelementptr inbounds nuw i8, ptr %.037.us50.i122, i64 16 ; 3 uses
  %i.fh = getelementptr inbounds nuw i8, ptr %.039.us49.i123, i64 16 ; 2 uses
  %i.fi = icmp ult ptr %i.fg, %i.co
  br i1 %i.fi, label %.lr.ph.i120, label %.preheader.i111

.preheader.i111:                                  ; preds = %.lr.ph.i120, %.lr.ph157
  %.us-phi.i112 = phi ptr [ %i.ei, %.lr.ph157 ], [ %i.fh, %.lr.ph.i120 ]
  %.us-phi47.i113 = phi ptr [ %i.cm, %.lr.ph157 ], [ %i.fg, %.lr.ph.i120 ] ; 2 uses
  %.us-phi48.i114 = phi float [ 0.000000e+00, %.lr.ph157 ], [ %i.ff, %.lr.ph.i120 ] ; 2 uses
  %i.fj = icmp ult ptr %.us-phi47.i113, %i.cn
...
.lr.ph57.i116:                                    ; preds = %.preheader.i111, %.lr.ph57.i116
  %.156.i117 = phi float [ %i.fp, %.lr.ph57.i116 ], [ %.us-phi48.i114, %.preheader.i111 ]
  %.13855.i118 = phi ptr [ %i.fk, %.lr.ph57.i116 ], [ %.us-phi47.i113, %.preheader.i111 ] ; 2 uses
  %.14054.i119 = phi ptr [ %i.fm, %.lr.ph57.i116 ], [ %.us-phi.i112, %.preheader.i111 ] ; 2 uses
  %i.fk = getelementptr inbounds nuw i8, ptr %.13855.i118, i64 4 ; 2 uses
  %i.fl = load float, ptr %.13855.i118, align 4, !tbaa !86
  %i.fm = getelementptr inbounds nuw i8, ptr %.14054.i119, i64 4
  %i.fn = load float, ptr %.14054.i119, align 4, !tbaa !86
  %i.fo = fsub float %i.fl, %i.fn                 ; 2 uses
  %i.fp = call float @llvm.fmuladd.f32(float %i.fo, float %i.fo, float %.156.i117) ; 2 uses
...
_ZNK7cvflann2L2IfEclIPfS3_EEfT_T0_mf.exit124:     ; preds = %.lr.ph57.i116, %.preheader.i111
  %.036.i115 = phi float [ %.us-phi48.i114, %.preheader.i111 ], [ %i.fp, %.lr.ph57.i116 ] ; 2 uses
  %i.fr = fcmp ogt float %.076155, %.036.i115
...
bb.x:                                             ; preds = %bb.w, %_ZNK7cvflann2L2IfEclIPfS3_EEfT_T0_mf.exit124
  ...
  %.1 = phi float [ %.036.i115, %bb.w ], [ %.076155, %_ZNK7cvflann2L2IfEclIPfS3_EEfT_T0_mf.exit124 ] ; 2 uses
...
bb.y:                                             ; preds = %._crit_edge158
  store float %.076.lcssa, ptr %i.ea, align 4, !tbaa !86
  br label %bb.z
...
.preheader:                                       ; preds = %_ZNK7cvflann2L2IfEclIPfNS_12ZeroIteratorIfEEEEfT_T0_mf.exit, %bb.a
  %.045.lcssa = phi float [ 0.000000e+00, %bb.a ], [ %i.bq, %_ZNK7cvflann2L2IfEclIPfNS_12ZeroIteratorIfEEEEfT_T0_mf.exit ]
  %.not104 = icmp eq i64 %i.b, 0
  br i1 %.not104, label %._crit_edge82.thread, label %.lr.ph81

._crit_edge82.thread:                             ; preds = %.preheader
