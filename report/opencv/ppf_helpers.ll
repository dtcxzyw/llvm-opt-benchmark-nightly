...
bb.s:                                             ; preds = %.lr.ph, %bb.az
  ...
  %i.bw = getelementptr inbounds nuw i8, ptr %i.bt, i64 %i.bv ; 6 uses
  ...
  %49 = getelementptr inbounds nuw i8, ptr %i.bw, i64 4
  %50 = getelementptr inbounds nuw i8, ptr %i.bw, i64 8
  %51 = load float, ptr %i.bw, align 4, !tbaa !107
  %52 = load float, ptr %49, align 4, !tbaa !107
  %53 = load float, ptr %50, align 4, !tbaa !107
  %54 = fpext float %51 to double                 ; 3 uses
  %55 = fpext float %52 to double                 ; 3 uses
  %56 = fpext float %53 to double                 ; 3 uses
  %57 = load double, ptr %i.ak, align 8, !tbaa !164, !noalias !669
  %i.cd = call double @llvm.fmuladd.f64(double %57, double %54, double 0.000000e+00)
  %i.ce = load double, ptr %i.al, align 8, !tbaa !164, !noalias !669
  %58 = call double @llvm.fmuladd.f64(double %i.ce, double %55, double %i.cd)
  %59 = load double, ptr %i.am, align 8, !tbaa !164, !noalias !669
  %i.cf = call double @llvm.fmuladd.f64(double %59, double %56, double %58)
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.co = call double @llvm.fmuladd.f64(double %i.cn, double %54, double 0.000000e+00)
  ...
  %i.cv = shufflevector <2 x double> %60, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.cy = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cx, <2 x double> %62, <2 x double> %i.cw)
  ...
  %i.da = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cz, <2 x double> %64, <2 x double> %i.cy)
