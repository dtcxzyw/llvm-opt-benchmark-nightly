...
_ZNK2cv4text14line_estimateseqERKS1_.exit.thread: ; preds = %bb.f, %bb.g, %bb.h, %bb.i, %bb.j, %bb.k, %bb.l, %bb.m, %bb.n
  ...
  %4 = insertelement <2 x i32> poison, i32 %i.bv, i64 0
  %5 = insertelement <2 x i32> %4, i32 %i.bu, i64 1
  %6 = sitofp <2 x i32> %5 to <2 x float>         ; 2 uses
  ...
  %7 = shufflevector <2 x float> %6, <2 x float> poison, <2 x i32> <i32 1, i32 1> ; 5 uses
  %i.ce = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %7, <2 x float> %i.bz, <2 x float> %i.ca) ; 2 uses
  ...
  %i.ch = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %7, <2 x float> %i.cf, <2 x float> %i.cg) ; 2 uses
  ...
  %i.ck = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %7, <2 x float> %i.ci, <2 x float> %i.cj) ; 2 uses
  ...
  %i.dg = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %7, <2 x float> %i.cq, <2 x float> %i.cr)
  ...
  %i.dt = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %7, <2 x float> %i.dq, <2 x float> %i.dr) ; 2 uses
