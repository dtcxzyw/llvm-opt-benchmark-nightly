...
bb.a:
  ...
  %75 = alloca %"class.cv::Rect_", align 8        ; 10 uses
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %.sroa.4393.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %68, i64 4
  ...
  %.sroa.4362.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %75, i64 4
  %.sroa.5363.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %75, i64 8 ; 2 uses
  %.sroa.6364.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %75, i64 12
...
bb.ct:                                            ; preds = %_ZN2cv3MataSERKNS_7MatExprE.exit.i.i
  %i.aak = load ptr, ptr %19, align 8, !tbaa !109 ; 2 uses
  %i.aal = load ptr, ptr %i.aak, align 8, !tbaa !14
  %i.aam = getelementptr inbounds nuw i8, ptr %i.aal, i64 24
  %i.aan = load ptr, ptr %i.aam, align 8
  invoke void %i.aan(ptr noundef nonnull align 8 dereferenceable(8) %i.aak, ptr noundef nonnull align 8 dereferenceable(688) %19, ptr noundef nonnull align 8 dereferenceable(208) %12, i32 noundef -1)
...
bb.cu:                                            ; preds = %bb.ct
  ...
  %i.aao = load i32, ptr %i.en, align 4, !tbaa !103
  %i.aap = load ptr, ptr %i.eo, align 8, !tbaa !56 ; 3 uses
  %i.aaq = load float, ptr %i.aap, align 4, !tbaa !36
  %i.aar = call noundef float @sqrtf(float noundef %i.aaq) #21 ; 5 uses
  store float %i.aar, ptr %i.aap, align 4, !tbaa !36
  %i.aas = icmp slt i32 %i.aao, 2
  %i.aat = load i64, ptr %i.ep, align 8
  %.sink.idx.i.i288.i = select i1 %i.aas, i64 0, i64 %i.aat
  %.sink.i.i289.i = getelementptr inbounds nuw i8, ptr %i.aap, i64 %.sink.idx.i.i288.i ; 2 uses
  %i.aau = load float, ptr %.sink.i.i289.i, align 4, !tbaa !36
  %i.aav = call noundef float @sqrtf(float noundef %i.aau) #21 ; 5 uses
  store float %i.aav, ptr %.sink.i.i289.i, align 4, !tbaa !36
...
bb.cv:                                            ; preds = %bb.cu
  %i.aaw = invoke noundef nonnull align 8 dereferenceable(208) ptr @_ZN2cv3MataSEOS0_(ptr noundef nonnull align 8 dereferenceable(208) %13, ptr noundef nonnull align 8 dereferenceable(208) %20)
...
bb.cy:                                            ; preds = %bb.cx
  ...
  %i.aax = load ptr, ptr %22, align 8, !tbaa !109, !noalias !114 ; 2 uses
  %i.aay = load ptr, ptr %i.aax, align 8, !tbaa !14
  %i.aaz = getelementptr inbounds nuw i8, ptr %i.aay, i64 24
  %i.aba = load ptr, ptr %i.aaz, align 8
  invoke void %i.aba(ptr noundef nonnull align 8 dereferenceable(8) %i.aax, ptr noundef nonnull align 8 dereferenceable(688) %22, ptr noundef nonnull align 8 dereferenceable(208) %21, i32 noundef -1)
...
_ZNK2cv7MatExprcvNS_3MatEEv.exit.i.i:             ; preds = %bb.cy
  %i.abc = invoke { <2 x float>, <2 x float> } @_ZNK2cv3MatcvNS_4MatxIT_XT0_EXT1_EEEIfLi2ELi2EEEv(ptr noundef nonnull align 8 dereferenceable(208) %21)
...
bb.dd:                                            ; preds = %bb.dc, %bb.db
  %.pn22.i.i = phi { ptr, i32 } [ %i.abf, %bb.dc ], [ %i.abe, %bb.db ]
...
bb.dg:                                            ; preds = %bb.df, %bb.de
  %.pn24.i.i = phi { ptr, i32 } [ %i.abh, %bb.df ], [ %i.abg, %bb.de ]
  call void @llvm.lifetime.end.p0(ptr nonnull %19) #21
  br label %bb.dp
...
bb.dj:                                            ; preds = %bb.di, %bb.dh
  %.pn26.i.i = phi { ptr, i32 } [ %i.abj, %bb.di ], [ %i.abi, %bb.dh ]
  call void @llvm.lifetime.end.p0(ptr nonnull %20) #21
  br label %bb.dp
...
.body.i290.i:                                     ; preds = %bb.dm, %bb.cz
  %.pn28.i.i = phi { ptr, i32 } [ %i.abm, %bb.dm ], [ %i.abb, %bb.cz ]
...
bb.dn:                                            ; preds = %.body.i290.i, %bb.dl
  %.pn28.pn.i.i = phi { ptr, i32 } [ %.pn28.i.i, %.body.i290.i ], [ %i.abl, %bb.dl ]
...
bb.do:                                            ; preds = %bb.dn, %bb.dk
  %.pn28.pn.pn.i.i = phi { ptr, i32 } [ %.pn28.pn.i.i, %bb.dn ], [ %i.abk, %bb.dk ]
...
bb.dp:                                            ; preds = %bb.do, %bb.dj, %bb.dg, %bb.dd, %bb.da
  %.pn28.pn.pn.pn.pn.pn.i.i = phi { ptr, i32 } [ %.pn28.pn.pn.i.i, %bb.do ], [ %.pn24.i.i, %bb.dg ], [ %.pn22.i.i, %bb.dd ], [ %i.abd, %bb.da ], [ %.pn26.i.i, %bb.dj ]
...
bb.dq:                                            ; preds = %_ZNK2cv7MatExprcvNS_3MatEEv.exit.i.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %22) #21
  call void @llvm.lifetime.end.p0(ptr nonnull %21) #21
  %i.abn = fcmp olt float %i.aav, %i.aar
  %.sroa.speculated42.i.i = select i1 %i.abn, float %i.aav, float %i.aar
  %i.abo = fcmp olt float %i.aar, %i.aav
  %.sroa.speculated.i292.i = select i1 %i.abo, float %i.aav, float %i.aar
  %i.abp = fdiv float %.sroa.speculated42.i.i, %.sroa.speculated.i292.i
  call void @llvm.lifetime.end.p0(ptr nonnull %14) #21
  call void @_ZN2cv3MatD1Ev(ptr noundef nonnull align 8 dead_on_return(208) dereferenceable(208) %13) #21
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #21
  call void @_ZN2cv3MatD1Ev(ptr noundef nonnull align 8 dead_on_return(208) dereferenceable(208) %12) #21
  ...
  call void @_ZN2cv3MatD1Ev(ptr noundef nonnull align 8 dead_on_return(208) dereferenceable(208) %10) #21
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #21
  %i.abq = fsub float 1.000000e+00, %i.abp        ; 3 uses
  %i.abr = fcmp ord float %i.abq, 0.000000e+00
  %i.abs = fcmp une float %i.abq, 1.000000e+00
  %or.cond5.i = and i1 %i.abr, %i.abs
...
bb.dr:                                            ; preds = %bb.dq
  ...
  %i.acb = invoke noundef zeroext i1 @_ZN2cv5eigenERKNS_11_InputArrayERKNS_12_OutputArrayES5_(ptr noundef nonnull align 8 dereferenceable(24) %87, ptr noundef nonnull align 8 dereferenceable(24) %88, ptr noundef nonnull align 8 dereferenceable(24) %89)
...
.noexc.i:                                         ; preds = %bb.ds
  %i.acc = load ptr, ptr %3, align 8, !tbaa !109  ; 2 uses
  %i.acd = load ptr, ptr %i.acc, align 8, !tbaa !14
  %i.ace = getelementptr inbounds nuw i8, ptr %i.acd, i64 24
  %i.acf = load ptr, ptr %i.ace, align 8
  invoke void %i.acf(ptr noundef nonnull align 8 dereferenceable(8) %i.acc, ptr noundef nonnull align 8 dereferenceable(688) %3, ptr noundef nonnull align 8 dereferenceable(208) %86, i32 noundef -1)
...
.noexc305.i:                                      ; preds = %_ZN2cv3MataSERKNS_7MatExprE.exit.i299.i
  ...
  %i.acg = load ptr, ptr %5, align 8, !tbaa !109, !noalias !115 ; 2 uses
  %i.ach = load ptr, ptr %i.acg, align 8, !tbaa !14
  %i.aci = getelementptr inbounds nuw i8, ptr %i.ach, i64 24
  %i.acj = load ptr, ptr %i.aci, align 8
  invoke void %i.acj(ptr noundef nonnull align 8 dereferenceable(8) %i.acg, ptr noundef nonnull align 8 dereferenceable(688) %5, ptr noundef nonnull align 8 dereferenceable(208) %4, i32 noundef -1)
...
bb.dt:                                            ; preds = %.noexc305.i
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #21
  %i.acl = load i32, ptr %i.fi, align 4, !tbaa !103
  %i.acm = load ptr, ptr %i.fj, align 8, !tbaa !56 ; 5 uses
  %i.acn = load float, ptr %i.acm, align 4, !tbaa !36 ; 3 uses
  %i.aco = icmp slt i32 %i.acl, 2                 ; 2 uses
  %i.acp = load i64, ptr %i.fk, align 8
  %.sink.idx.i.i301.i = select i1 %i.aco, i64 0, i64 %i.acp
  %.sink.i.i302.i = getelementptr inbounds nuw i8, ptr %i.acm, i64 %.sink.idx.i.i301.i ; 2 uses
  %i.acq = load float, ptr %.sink.i.i302.i, align 4, !tbaa !36 ; 3 uses
  %i.acr = call noundef float @llvm.fabs.f32(float %i.acn)
  %i.acs = call noundef float @llvm.fabs.f32(float %i.acq)
  %i.act = fcmp olt float %i.acr, %i.acs
  br i1 %i.act, label %bb.du, label %bb.dw

bb.du:                                            ; preds = %bb.dt
  store float 1.000000e+00, ptr %i.acm, align 4, !tbaa !36
  %i.acu = load i64, ptr %i.fk, align 8
  %.sink.idx.i50.i.i = select i1 %i.aco, i64 0, i64 %i.acu
  %.sink.i51.i.i = getelementptr inbounds nuw i8, ptr %i.acm, i64 %.sink.idx.i50.i.i
  %i.acv = fdiv float %i.acq, %i.acn
  store float %i.acv, ptr %.sink.i51.i.i, align 4, !tbaa !36
  br label %bb.dx
...
bb.dw:                                            ; preds = %bb.dt
  ...
  %i.acx = fdiv float %i.acn, %i.acq
  store float %i.acx, ptr %i.acm, align 4, !tbaa !36
  br label %bb.dx
...
bb.ea:                                            ; preds = %bb.dz
  ...
  %i.acy = load ptr, ptr %8, align 8, !tbaa !109, !noalias !116 ; 2 uses
  %i.acz = load ptr, ptr %i.acy, align 8, !tbaa !14
  %i.ada = getelementptr inbounds nuw i8, ptr %i.acz, i64 24
  %i.adb = load ptr, ptr %i.ada, align 8
  invoke void %i.adb(ptr noundef nonnull align 8 dereferenceable(8) %i.acy, ptr noundef nonnull align 8 dereferenceable(688) %8, ptr noundef nonnull align 8 dereferenceable(208) %7, i32 noundef -1)
...
_ZNK2cv7MatExprcvNS_3MatEEv.exit58.i.i:           ; preds = %bb.ea
  %i.add = invoke { <2 x float>, <2 x float> } @_ZNK2cv3MatcvNS_4MatxIT_XT0_EXT1_EEEIfLi2ELi2EEEv(ptr noundef nonnull align 8 dereferenceable(208) %7)
...
.body56.i.i:                                      ; preds = %bb.ef, %bb.eb
  %.pn.i.i = phi { ptr, i32 } [ %i.adh, %bb.ef ], [ %i.adc, %bb.eb ]
...
bb.eg:                                            ; preds = %.body56.i.i, %bb.ee
  %.pn.pn.i.i = phi { ptr, i32 } [ %.pn.i.i, %.body56.i.i ], [ %i.adg, %bb.ee ]
...
bb.eh:                                            ; preds = %bb.eg, %bb.ed
  %.pn.pn.pn.i.i = phi { ptr, i32 } [ %.pn.pn.i.i, %bb.eg ], [ %i.adf, %bb.ed ]
...
bb.ei:                                            ; preds = %bb.eh, %bb.ec
  %.pn38.pn.pn.pn.pn.i.i = phi { ptr, i32 } [ %.pn.pn.pn.i.i, %bb.eh ], [ %i.ade, %bb.ec ]
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #21
  call void @_ZN2cv3MatD1Ev(ptr noundef nonnull align 8 dead_on_return(208) dereferenceable(208) %4) #21
  br label %bb.ej

bb.ej:                                            ; preds = %bb.ei, %.body.i300.i
  %.pn38.pn.pn.pn.pn.pn.pn.pn.i.i = phi { ptr, i32 } [ %.pn38.pn.pn.pn.pn.i.i, %bb.ei ], [ %i.ack, %.body.i300.i ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #21
  br label %.body306.i

bb.ek:                                            ; preds = %_ZNK2cv7MatExprcvNS_3MatEEv.exit58.i.i
  %i.adi = extractvalue { <2 x float>, <2 x float> } %i.add, 0
  %i.adj = extractvalue { <2 x float>, <2 x float> } %i.add, 1
  store <2 x float> %i.adi, ptr %69, align 16
  store <2 x float> %i.adj, ptr %i.e, align 8, !tbaa !44
  call void @_ZN2cv3MatD1Ev(ptr noundef nonnull align 8 dead_on_return(208) dereferenceable(208) %7) #21
