...
.preheader296.lr.ph:                              ; preds = %.preheader297
  ...
  %14 = load ptr, ptr %10, align 8                ; 9 uses
  %i.oe = load ptr, ptr %11, align 8              ; 9 uses
  %i.of = ptrtoaddr ptr %i.oe to i64              ; 5 uses
  %15 = ptrtoaddr ptr %14 to i64                  ; 5 uses
  %i.og = ptrtoaddr ptr %i.od to i64              ; 5 uses
  ...
  %i.om = sub i64 %i.c, %i.og
  %i.on = sub i64 %i.f, %i.og
  %i.oo = sub i64 %i.f, %15
  %i.op = sub i64 %i.i, %i.og
  %i.oq = sub i64 %i.i, %15
  %i.or = sub i64 %i.i, %i.of
  %i.os = sub i64 %i.l, %i.og
  %i.ot = sub i64 %i.l, %15
  %i.ou = sub i64 %i.l, %i.of
  %i.ov = sub i64 %i.l, %i.oi
  %i.ow = sub i64 %i.o, %i.og
  %i.ox = sub i64 %i.o, %15
  %i.oy = sub i64 %i.o, %i.of
  ...
  %scevgep751 = getelementptr i8, ptr %14, i64 %i.pb ; 3 uses
  %scevgep752 = getelementptr i8, ptr %i.oe, i64 %i.pb ; 3 uses
  ...
  %i.qg = insertelement <8 x ptr> poison, ptr %14, i64 0 ; 2 uses
  %i.qh = insertelement <8 x ptr> %i.qg, ptr %i.oe, i64 1
  ...
  %i.qz = insertelement <8 x ptr> poison, ptr %i.oe, i64 0 ; 2 uses
  ...
  %i.to = insertelement <4 x ptr> poison, ptr %14, i64 0
  ...
  %i.ua = insertelement <4 x ptr> poison, ptr %i.oe, i64 0
  ...
  %bound0891 = icmp ult ptr %14, %scevgep769
  ...
  %invariant.op1199 = sub i64 %i.c, %15
  %invariant.op1201 = sub i64 %i.c, %i.of
  %invariant.op1203 = sub i64 %i.c, %i.oi
  %invariant.op1205 = sub i64 %i.c, %.pre397679
  %invariant.op1207 = sub i64 %i.f, %i.of
...
vector.body1062:                                  ; preds = %.lr.ph339, %vector.body1062
  ...
  %i.xd = getelementptr inbounds nuw [4 x i8], ptr %14, i64 %index1063 ; 2 uses
  ...
  %i.xi = getelementptr inbounds nuw [4 x i8], ptr %i.oe, i64 %index1063 ; 2 uses
...
vector.body738:                                   ; preds = %vector.memcheck663, %vector.body738
  ...
  %i.zl = getelementptr inbounds nuw [4 x i8], ptr %14, i64 %index739
  ...
  %i.zn = getelementptr inbounds nuw [4 x i8], ptr %i.oe, i64 %index739
...
scalar.ph1058:                                    ; preds = %scalar.ph1058.preheader, %scalar.ph1058
  ...
  %i.aaj = getelementptr inbounds nuw [4 x i8], ptr %14, i64 %indvars.iv380 ; 2 uses
  ...
  %i.aar = getelementptr inbounds nuw [4 x i8], ptr %i.oe, i64 %indvars.iv380 ; 2 uses
...
scalar.ph734:                                     ; preds = %scalar.ph734.preheader, %scalar.ph734
  ...
  %i.abp = getelementptr inbounds nuw [4 x i8], ptr %14, i64 %indvars.iv385
  ...
  %i.abs = getelementptr inbounds nuw [4 x i8], ptr %i.oe, i64 %indvars.iv385
