...
bb.ab:                                            ; preds = %_ZNK2cv3Mat8rowRangeEii.exit97, %bb.aa
  ...
  %i.dm = load i32, ptr %i.dl, align 4, !tbaa !35 ; 50 uses
  %i.dn = getelementptr inbounds nuw i8, ptr %i.cv, i64 16
  %i.do = load i32, ptr %i.dn, align 4, !tbaa !34 ; 9 uses
  %i.dp = add i32 %i.do, %i.dm                    ; 5 uses
...
.lr.ph121.i:                                      ; preds = %._crit_edge67.i
  ...
  %35 = sub nsw i64 %wide.trip.count220.i, %i.qn
  %36 = add nsw i64 %35, 1                        ; 3 uses
...
.preheader42.us.us.preheader.i246:                ; preds = %.preheader42.lr.ph.split.us.i231
  ...
  %37 = add i32 %i.dp, -1
  %38 = sub i32 %i.dm, %37
  %39 = add i32 %38, -2                           ; 2 uses
  %i.ahk = zext i32 %39 to i64
  %i.ahl = add nuw nsw i64 %i.ahk, 1              ; 2 uses
  %min.iters.check456 = icmp ult i32 %39, 7
...
.preheader42.preheader.i217:                      ; preds = %.preheader42.lr.ph.split.i216
  ...
  %40 = add i32 %i.dp, -1
  %41 = sub i32 %i.dm, %40
  %42 = add i32 %41, -2                           ; 2 uses
  %i.ahz = zext i32 %42 to i64
  %i.aia = add nuw nsw i64 %i.ahz, 1              ; 2 uses
  %min.iters.check432 = icmp ult i32 %42, 7
...
.lr.ph121.i105:                                   ; preds = %._crit_edge67.i103
  ...
  %43 = sub nsw i64 %i.ajy, %i.ami
  %44 = add nsw i64 %43, 1                        ; 3 uses
  %min.iters.check528 = icmp ult i64 %44, 8
  %n.vec530 = and i64 %44, -8                     ; 3 uses
  %i.amj = add nsw i64 %n.vec530, %i.ako
  %invariant.gep962 = getelementptr [4 x i8], ptr %i.acf, i64 %i.ako
  %cmp.n537 = icmp eq i64 %44, %n.vec530
  ...
  %45 = sub nsw i64 %wide.trip.count220.i120, %i.aml
  %46 = add nsw i64 %45, 1                        ; 3 uses
  %min.iters.check480 = icmp ult i64 %46, 8
  %n.vec482 = and i64 %46, -8                     ; 3 uses
  %i.amm = add nsw i64 %n.vec482, %i.ako
  %invariant.gep964 = getelementptr [4 x i8], ptr %i.acf, i64 %i.ako
  %cmp.n490 = icmp eq i64 %46, %n.vec482
