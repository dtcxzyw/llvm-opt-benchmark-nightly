...
bb.aj:                                            ; preds = %.lr.ph, %_ZNSt6vectorIN2cv3MatESaIS1_EE9push_backERKS1_.exit
  ...
  %.0139381 = phi i64 [ 0, %.lr.ph ], [ %i.gq, %_ZNSt6vectorIN2cv3MatESaIS1_EE9push_backERKS1_.exit ] ; 2 uses
  %.sroa.4.0380 = phi ptr [ undef, %.lr.ph ], [ %.sroa.4.2, %_ZNSt6vectorIN2cv3MatESaIS1_EE9push_backERKS1_.exit ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %17) #28
  %i.ch = getelementptr inbounds nuw [208 x i8], ptr %i.cg, i64 %.0139381
...
_ZNK2cv3PtrINS_16BaseImageEncoderEE11dynamicCastINS_10ExrEncoderEEENS0_IT_EEv.exit: ; preds = %bb.az, %bb.ay, %bb.aw, %bb.av, %bb.au, %bb.at, %bb.at, %bb.at
  %.sroa.4.1 = phi ptr [ %.sroa.4.0380, %bb.at ], [ %.sroa.4.0380, %bb.at ], [ %.sroa.4.0380, %bb.at ], [ %i.da, %bb.ay ], [ null, %bb.aw ], [ %i.da, %bb.az ], [ null, %bb.av ], [ null, %bb.au ] ; 11 uses
...
bb.fe:                                            ; preds = %bb.gm, %bb.fl, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit310, %._crit_edge384
...
.invoke:                                          ; preds = %bb.fl
  ...
  %.sink490 = select i1 %i.ay, i64 64, i64 56
  %i.ot = select i1 %i.ay, ptr %16, ptr %i.os
  %i.ou = load ptr, ptr %i.or, align 8, !tbaa !27
  %i.ov = getelementptr inbounds nuw i8, ptr %i.ou, i64 %.sink490
...
begin_hunk_4_@_ZN2cv15ImageCollection8iteratorppEv:bb.a
  store i32 %i.p, ptr %i.e, align 8, !tbaa !364
  ret ptr %0
}
...
bb.a:
  %.sroa.0.0.copyload = load ptr, ptr %0, align 8, !tbaa !372 ; 2 uses
  ...
  %i.c = load i32, ptr %i.b, align 8, !tbaa !353
...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 %i.e, ptr %i.b, align 8, !tbaa !353
  ...
  %i.k = tail call noundef zeroext i1 %i.j(ptr noundef nonnull align 8 dereferenceable(720) %i.g), !inline_history !373 ; 0 uses
  %.pre.i = load i32, ptr %.sroa.2.0..0..sroa_idx, align 8, !tbaa !364
...
_ZN2cv15ImageCollection8iteratorppEv.exit:        ; preds = %bb.a, %bb.b
  ...
  store i32 %i.m, ptr %.sroa.2.0..0..sroa_idx, align 8, !tbaa !364
...
bb.p:                                             ; preds = %bb.n, %_ZNSt6vectorIN2cv3MatESaIS1_EE9push_backERKS1_.exit
  %storemerge111 = phi i32 [ 0, %bb.n ], [ %i.cg, %_ZNSt6vectorIN2cv3MatESaIS1_EE9push_backERKS1_.exit ] ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #28
...
bb.ak:                                            ; preds = %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit16.i.i
  call void @_ZdlPvm(ptr noundef nonnull %i.bm, i64 noundef %i.bp) #30
...
_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i: ; preds = %bb.ak, %_ZNSt6vectorIiSaIiEE11_S_relocateEPiS2_S2_RS0_.exit16.i.i
  ...
  %i.cb = getelementptr inbounds nuw [4 x i8], ptr %i.bx, i64 %i.bv
  store ptr %i.cb, ptr %i.t, align 8, !tbaa !136
  br label %_ZNSt6vectorIiSaIiEE9push_backERKi.exit
...
_ZNSt6vectorIiSaIiEE9push_backERKi.exit:          ; preds = %_ZNSt6vectorIiSaIiEE17_M_realloc_insertIJRKiEEEvN9__gnu_cxx17__normal_iteratorIPiS1_EEDpOT_.exit.i, %bb.ag
  %i.cc = load ptr, ptr %i.u, align 8, !tbaa !105 ; 3 uses
  %i.cd = load ptr, ptr %i.v, align 8, !tbaa !106
  %.not.i78 = icmp eq ptr %i.cc, %i.cd
  br i1 %.not.i78, label %bb.am, label %bb.al

bb.al:                                            ; preds = %_ZNSt6vectorIiSaIiEE9push_backERKi.exit
  invoke void @_ZN2cv3MatC1ERKS0_(ptr noundef nonnull align 8 dereferenceable(208) %i.cc, ptr noundef nonnull align 8 dereferenceable(208) %8)
          to label %.noexc79 unwind label %.loopexit99

.noexc79:                                         ; preds = %bb.al
  %i.ce = load ptr, ptr %i.u, align 8, !tbaa !105
  %i.cf = getelementptr inbounds nuw i8, ptr %i.ce, i64 208
  store ptr %i.cf, ptr %i.u, align 8, !tbaa !105
  br label %_ZNSt6vectorIN2cv3MatESaIS1_EE9push_backERKS1_.exit

bb.am:                                            ; preds = %_ZNSt6vectorIiSaIiEE9push_backERKi.exit
  invoke void @_ZNSt6vectorIN2cv3MatESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_(ptr noundef nonnull align 8 dereferenceable(24) %7, ptr %i.cc, ptr noundef nonnull align 8 dereferenceable(208) %8)
...
_ZNSt6vectorIN2cv3MatESaIS1_EE9push_backERKS1_.exit: ; preds = %.noexc79, %bb.am, %bb.r
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #28
  %i.cg = add nuw nsw i32 %storemerge111, 1       ; 2 uses
  %exitcond.not = icmp eq i32 %i.cg, 4
  br i1 %exitcond.not, label %bb.o, label %bb.p, !llvm.loop !374
...
bb.ap:                                            ; preds = %bb.o
  %i.ch = getelementptr inbounds nuw i8, ptr %.036, i64 8 ; 3 uses
  %i.ci = load ptr, ptr %i.ch, align 8, !tbaa !105 ; 3 uses
  %i.cj = load ptr, ptr %.036, align 8, !tbaa !174 ; 2 uses
  %i.ck = ptrtoint ptr %i.ci to i64
  %i.cl = ptrtoint ptr %i.cj to i64
  %i.cm = sub i64 %i.ck, %i.cl
  %i.cn = sdiv exact i64 %i.cm, 208               ; 3 uses
  %i.co = icmp ugt i64 %i.ab, %i.cn
  br i1 %i.co, label %bb.aq, label %bb.ar

bb.aq:                                            ; preds = %bb.ap
  %i.cp = sub nuw nsw i64 %i.ab, %i.cn
  invoke void @_ZNSt6vectorIN2cv3MatESaIS1_EE17_M_default_appendEm(ptr noundef nonnull align 8 dereferenceable(24) %.036, i64 noundef %i.cp)
          to label %_ZNSt6vectorIN2cv3MatESaIS1_EE6resizeEm.exit unwind label %bb.at

bb.ar:                                            ; preds = %bb.ap
  %i.cq = icmp ult i64 %i.ab, %i.cn
  br i1 %i.cq, label %bb.as, label %_ZNSt6vectorIN2cv3MatESaIS1_EE6resizeEm.exit

bb.as:                                            ; preds = %bb.ar
  %i.cr = getelementptr inbounds nuw [208 x i8], ptr %i.cj, i64 %i.ab ; 3 uses
  %.not.i.i = icmp eq ptr %i.ci, %i.cr
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.as, %.lr.ph.i.i.i.i
  %.05.i.i.i.i = phi ptr [ %i.cs, %.lr.ph.i.i.i.i ], [ %i.cr, %bb.as ] ; 2 uses
  ...
  %.not.i.i.i.i = icmp eq ptr %i.cs, %i.ci
...
_ZSt8_DestroyIPN2cv3MatES1_EvT_S3_RSaIT0_E.exit.i.i: ; preds = %.lr.ph.i.i.i.i
  store ptr %i.cr, ptr %i.ch, align 8, !tbaa !105
...
bb.au:                                            ; preds = %.lr.ph, %bb.ax
  %.038112 = phi i64 [ 0, %.lr.ph ], [ %i.df, %bb.ax ] ; 5 uses
  %i.cw = load ptr, ptr %7, align 8, !tbaa !174
  call void @llvm.lifetime.start.p0(ptr nonnull %13) #28
  %i.cx = load ptr, ptr %i.ch, align 8, !tbaa !105
  %i.cy = load ptr, ptr %.036, align 8, !tbaa !174 ; 2 uses
  %i.cz = ptrtoint ptr %i.cx to i64
  %i.da = ptrtoint ptr %i.cy to i64
  %i.db = sub i64 %i.cz, %i.da
  %i.dc = sdiv exact i64 %i.db, 208               ; 2 uses
  %.not.i.i82 = icmp ult i64 %.038112, %i.dc
  br i1 %.not.i.i82, label %bb.aw, label %bb.av

bb.av:                                            ; preds = %bb.au
  invoke void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.74, i64 noundef %.038112, i64 noundef %i.dc) #31
...
bb.aw:                                            ; preds = %bb.au
  %i.dd = getelementptr inbounds nuw [208 x i8], ptr %i.cw, i64 %.038112
  %i.de = getelementptr inbounds nuw [208 x i8], ptr %i.cy, i64 %.038112
  store i64 0, ptr %i.cu, align 8
  store i32 33619968, ptr %13, align 8, !tbaa !8
  store ptr %i.de, ptr %i.ct, align 8, !tbaa !12
  invoke void @_ZNK2cv3Mat6copyToERKNS_12_OutputArrayE(ptr noundef nonnull align 8 dereferenceable(208) %i.dd, ptr noundef nonnull align 8 dereferenceable(24) %13)
          to label %bb.ax unwind label %bb.az

bb.ax:                                            ; preds = %bb.aw
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #28
  %i.df = add nuw i64 %.038112, 1                 ; 2 uses
  %exitcond127.not = icmp eq i64 %i.df, %i.ab
  br i1 %exitcond127.not, label %.loopexit, label %bb.au, !llvm.loop !375
...
bb.ba:                                            ; preds = %bb.az, %bb.ay
  %.pn56 = phi { ptr, i32 } [ %i.dh, %bb.az ], [ %i.dg, %bb.ay ]
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #28
  br label %bb.bl

bb.bb:                                            ; preds = %bb.o
  %i.di = getelementptr inbounds nuw i8, ptr %.0, i64 8 ; 3 uses
  %i.dj = load ptr, ptr %i.di, align 8, !tbaa !376 ; 3 uses
  %i.dk = load ptr, ptr %.0, align 8, !tbaa !377  ; 2 uses
  %i.dl = ptrtoint ptr %i.dj to i64
  %i.dm = ptrtoint ptr %i.dk to i64
  %i.dn = sub i64 %i.dl, %i.dm
  %i.do = sdiv exact i64 %i.dn, 24                ; 3 uses
  %i.dp = icmp ugt i64 %i.ab, %i.do
  br i1 %i.dp, label %bb.bc, label %bb.bd

bb.bc:                                            ; preds = %bb.bb
  %i.dq = sub nuw nsw i64 %i.ab, %i.do
  invoke void @_ZNSt6vectorIS_IhSaIhEESaIS1_EE17_M_default_appendEm(ptr noundef nonnull align 8 dereferenceable(24) %.0, i64 noundef %i.dq)
          to label %_ZNSt6vectorIS_IhSaIhEESaIS1_EE6resizeEm.exit unwind label %bb.at

bb.bd:                                            ; preds = %bb.bb
  %i.dr = icmp ult i64 %i.ab, %i.do
  br i1 %i.dr, label %bb.be, label %_ZNSt6vectorIS_IhSaIhEESaIS1_EE6resizeEm.exit

bb.be:                                            ; preds = %bb.bd
  %i.ds = getelementptr inbounds nuw [24 x i8], ptr %i.dk, i64 %i.ab ; 3 uses
  %.not.i.i84 = icmp eq ptr %i.dj, %i.ds
...
.lr.ph.i.i.i.i85:                                 ; preds = %bb.be, %_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i.i
  %.05.i.i.i.i86 = phi ptr [ %i.dz, %_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i.i ], [ %i.ds, %bb.be ] ; 3 uses
  %i.dt = load ptr, ptr %.05.i.i.i.i86, align 8, !tbaa !309 ; 3 uses
  %.not.i.i.i.i.i.i.i.i = icmp eq ptr %i.dt, null
  br i1 %.not.i.i.i.i.i.i.i.i, label %_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i.i, label %bb.bf

bb.bf:                                            ; preds = %.lr.ph.i.i.i.i85
  %i.du = getelementptr inbounds nuw i8, ptr %.05.i.i.i.i86, i64 16
  %i.dv = load ptr, ptr %i.du, align 8, !tbaa !332
...
_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i.i: ; preds = %bb.bf, %.lr.ph.i.i.i.i85
  %i.dz = getelementptr inbounds nuw i8, ptr %.05.i.i.i.i86, i64 24 ; 2 uses
  %.not.i.i.i.i87 = icmp eq ptr %i.dz, %i.dj
...
_ZSt8_DestroyIPSt6vectorIhSaIhEES2_EvT_S4_RSaIT0_E.exit.i.i: ; preds = %_ZSt8_DestroyISt6vectorIhSaIhEEEvPT_.exit.i.i.i.i
  store ptr %i.ds, ptr %i.di, align 8, !tbaa !376
...
.lr.ph114:                                        ; preds = %_ZNSt6vectorIS_IhSaIhEESaIS1_EE6resizeEm.exit, %_ZNSt6vectorIhSaIhEE6assignIPKhvEEvT_S5_.exit
  %.037113 = phi i64 [ %i.en, %_ZNSt6vectorIhSaIhEE6assignIPKhvEEvT_S5_.exit ], [ 0, %_ZNSt6vectorIS_IhSaIhEESaIS1_EE6resizeEm.exit ] ; 5 uses
  %i.ea = load ptr, ptr %7, align 8, !tbaa !174
  %i.eb = getelementptr inbounds nuw [208 x i8], ptr %i.ea, i64 %.037113 ; 2 uses
  %i.ec = getelementptr inbounds nuw i8, ptr %i.eb, i64 24
  %i.ed = load ptr, ptr %i.ec, align 8, !tbaa !49 ; 2 uses
  %i.ee = load ptr, ptr %i.di, align 8, !tbaa !376
  %i.ef = load ptr, ptr %.0, align 8, !tbaa !377  ; 2 uses
  %i.eg = ptrtoint ptr %i.ee to i64
  %i.eh = ptrtoint ptr %i.ef to i64
  %i.ei = sub i64 %i.eg, %i.eh
  %i.ej = sdiv exact i64 %i.ei, 24                ; 2 uses
  %.not.i.i89 = icmp ult i64 %.037113, %i.ej
  br i1 %.not.i.i89, label %bb.bh, label %bb.bg

bb.bg:                                            ; preds = %.lr.ph114
  invoke void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.74, i64 noundef %.037113, i64 noundef %i.ej) #31
...
bb.bh:                                            ; preds = %.lr.ph114
  %i.ek = invoke noundef i64 @_ZNK2cv3Mat5totalEv(ptr noundef nonnull align 8 dereferenceable(208) %i.eb)
          to label %bb.bi unwind label %.loopexit97

bb.bi:                                            ; preds = %bb.bh
  %i.el = getelementptr inbounds nuw [24 x i8], ptr %i.ef, i64 %.037113
  %i.em = getelementptr inbounds nuw i8, ptr %i.ed, i64 %i.ek
  invoke void @_ZNSt6vectorIhSaIhEE13_M_assign_auxIPKhEEvT_S5_St20forward_iterator_tag(ptr noundef nonnull align 8 dereferenceable(24) %i.el, ptr noundef %i.ed, ptr noundef %i.em)
...
_ZNSt6vectorIhSaIhEE6assignIPKhvEEvT_S5_.exit:    ; preds = %bb.bi
  %i.en = add nuw i64 %.037113, 1                 ; 2 uses
  %exitcond129.not = icmp eq i64 %i.en, %i.ab
...
.loopexit:                                        ; preds = %bb.ax, %_ZNSt6vectorIhSaIhEE6assignIPKhvEEvT_S5_.exit, %_ZNSt6vectorIN2cv3MatESaIS1_EE6resizeEm.exit, %_ZNSt6vectorIS_IhSaIhEESaIS1_EE6resizeEm.exit
  %i.eo = load ptr, ptr %7, align 8, !tbaa !174   ; 3 uses
  %i.ep = load ptr, ptr %i.u, align 8, !tbaa !105 ; 2 uses
...
.lr.ph.i.i.i:                                     ; preds = %.loopexit, %.lr.ph.i.i.i
  %.05.i.i.i = phi ptr [ %i.eq, %.lr.ph.i.i.i ], [ %i.eo, %.loopexit ] ; 2 uses
  call void @_ZN2cv3MatD1Ev(ptr noundef nonnull align 8 dead_on_return(208) dereferenceable(208) %.05.i.i.i) #28
  %i.eq = getelementptr inbounds nuw i8, ptr %.05.i.i.i, i64 208 ; 2 uses
  %.not.i.i.i92 = icmp eq ptr %i.eq, %i.ep
...
_ZSt8_DestroyIPN2cv3MatES1_EvT_S3_RSaIT0_E.exit.i: ; preds = %_ZSt8_DestroyIPN2cv3MatES1_EvT_S3_RSaIT0_E.exitthread-pre-split.i, %.loopexit
  %i.er = phi ptr [ %.pr.i, %_ZSt8_DestroyIPN2cv3MatES1_EvT_S3_RSaIT0_E.exitthread-pre-split.i ], [ %i.eo, %.loopexit ] ; 3 uses
...
bb.bj:                                            ; preds = %_ZSt8_DestroyIPN2cv3MatES1_EvT_S3_RSaIT0_E.exit.i
  %i.es = load ptr, ptr %i.v, align 8, !tbaa !106
  %i.et = ptrtoint ptr %i.es to i64
  %i.eu = ptrtoint ptr %i.er to i64
  %i.ev = sub i64 %i.et, %i.eu
  call void @_ZdlPvm(ptr noundef nonnull %i.er, i64 noundef %i.ev) #30
...
bb.bl:                                            ; preds = %.loopexit97, %.loopexit.split-lp, %bb.at, %bb.ba, %bb.ao
  %.pn63.pn.pn = phi { ptr, i32 } [ %.pn63.pn, %bb.ao ], [ %.pn56, %bb.ba ], [ %i.cv, %bb.at ], [ %lpad.loopexit, %.loopexit97 ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = load ptr, ptr %0, align 8, !tbaa !377    ; 5 uses
...
_ZSt27__uninitialized_default_n_aIPSt6vectorIhSaIhEEmS2_ET_S4_T0_RSaIT1_E.exit: ; preds = %bb.b
  ...
  store ptr %scevgep.i.i.i, ptr %i.a, align 8, !tbaa !376
  br label %bb.f
...
.lr.ph.i.i.i:                                     ; preds = %_ZNKSt6vectorIS_IhSaIhEESaIS1_EE12_M_check_lenEmPKc.exit, %.lr.ph.i.i.i
  ...
  %i.aa = load ptr, ptr %i.z, align 8, !tbaa !332, !alias.scope !384, !noalias !381
  store ptr %i.aa, ptr %i.y, align 8, !tbaa !332, !alias.scope !381, !noalias !384
...
_ZNSt12_Vector_baseISt6vectorIhSaIhEESaIS2_EE13_M_deallocateEPS2_m.exit37: ; preds = %_ZNSt6vectorIS_IhSaIhEESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit, %bb.e
  store ptr %i.u, ptr %0, align 8, !tbaa !377
  %i.ag = getelementptr inbounds nuw [24 x i8], ptr %i.v, i64 %1
  store ptr %i.ag, ptr %i.a, align 8, !tbaa !376
