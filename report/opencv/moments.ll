...
.loopexit.us:                                     ; preds = %..loopexit.us_crit_edge, %.preheader.us.preheader
  ...
  %i.ju = phi <4 x double> [ %i.jd, %..loopexit.us_crit_edge ], [ %i.jm, %.preheader.us.preheader ] ; 5 uses
  %i.jv = uitofp nneg i32 %.087167.us to double   ; 8 uses
  %i.jw = load <2 x double>, ptr %7, align 16, !tbaa !22
  %i.jx = insertelement <2 x double> poison, double %i.jr, i64 0 ; 2 uses
  %i.jy = extractelement <4 x double> %i.ju, i64 0 ; 3 uses
  %i.jz = extractelement <4 x double> %i.ju, i64 1 ; 2 uses
  %i.ka = load <2 x double>, ptr %i.il, align 16, !tbaa !22
  %i.kb = insertelement <2 x double> <double poison, double -0.000000e+00>, double %i.jv, i64 0
  ...
  %i.lb = extractelement <2 x double> %i.js, i64 0 ; 2 uses
  ...
  %20 = call double @llvm.fmuladd.f64(double %i.jv, double %i.jy, double %i.lb)
  %21 = insertelement <2 x double> %i.js, double %20, i64 0
  %i.ls = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %21, <2 x double> <double 2.000000e+00, double 3.000000e+00>, <2 x double> %i.lr) ; 2 uses
