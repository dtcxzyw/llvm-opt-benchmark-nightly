...
_ZN20minEnclosingTriangleL14greaterOrEqualEdd.exit.thread.i.i.i.i: ; preds = %_ZN20minEnclosingTriangleL14greaterOrEqualEdd.exit.thread.i.i.i.i.backedge, %bb.k
  ...
  %i.bn = load <2 x float>, ptr %i.bm, align 4    ; 3 uses
  %i.bo = load float, ptr %.sroa_idx.i.i.i.i.i, align 4
  %i.bp = insertelement <2 x float> %i.bn, float %i.bg, i64 0
  %29 = fsub <2 x float> %i.bf, %i.bp
  %30 = fpext <2 x float> %29 to <2 x double>
  %31 = shufflevector <2 x float> %i.bn, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %i.bq = insertelement <2 x float> %31, float %i.bh, i64 0
  %i.br = fsub <2 x float> %i.bc, %i.bq
  %i.bs = fpext <2 x float> %i.br to <2 x double>
  %i.bt = fmul <2 x double> %i.bb, %i.bs
  %i.bu = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.az, <2 x double> %30, <2 x double> %i.bt)
  ...
  %i.ca = fcmp ogt double %i.bz, %i.by
...
_ZN20minEnclosingTriangleL14greaterOrEqualEdd.exit.i.i.i.i: ; preds = %_ZN20minEnclosingTriangleL14greaterOrEqualEdd.exit.thread.i.i.i.i
  %i.cc = fsub double %i.bz, %i.by
  %i.cd = call noundef double @llvm.fabs.f64(double %i.cc)
  %i.ce = call noundef double @llvm.fabs.f64(double %i.bz) ; 2 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.jk = shufflevector <2 x float> %i.ji, <2 x float> %i.iw, <2 x i32> <i32 1, i32 3>
  ...
  %i.jo = shufflevector <2 x float> %i.ji, <2 x float> %i.iw, <2 x i32> <i32 0, i32 2>
  ...
  %i.kg = fcmp ogt double %i.kf, %i.ke
...
_ZN20minEnclosingTriangleL14greaterOrEqualEdd.exit.i44.i.i.i: ; preds = %bb.t
  %i.kh = fsub double %i.kf, %i.ke
  %i.ki = call noundef double @llvm.fabs.f64(double %i.kh)
  %i.kj = call noundef double @llvm.fabs.f64(double %i.kf) ; 2 uses
  %i.kk = call noundef double @llvm.fabs.f64(double %i.ke) ; 2 uses
...
_ZN20minEnclosingTriangleL14isNotBTangencyERKSt6vectorIN2cv6Point_IfEESaIS3_EEjjjj.exit.i.i.i: ; preds = %bb.y, %._crit_edge.i.i.i.i
  ...
  %i.pt = shufflevector <2 x float> %i.pr, <2 x float> %i.pf, <2 x i32> <i32 1, i32 3>
  ...
  %i.px = shufflevector <2 x float> %i.pr, <2 x float> %i.pf, <2 x i32> <i32 0, i32 2>
  ...
  %i.qp = fcmp olt double %i.qo, %i.qn
  call void @llvm.lifetime.end.p0(ptr nonnull %16) #16
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %32 = shufflevector <2 x float> %i.un, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.ur = insertelement <2 x float> %32, float %i.uj, i64 1
  ...
  %i.uw = insertelement <2 x float> %i.un, float %i.uh, i64 1
  ...
  %i.vn = fcmp olt double %i.vm, %i.vl
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.cd = shufflevector <2 x float> %i.cb, <2 x float> %i.bp, <2 x i32> <i32 1, i32 3>
  ...
  %i.ch = shufflevector <2 x float> %i.cb, <2 x float> %i.bp, <2 x i32> <i32 0, i32 2>
  ...
  %i.cz = fcmp ogt double %i.cy, %i.cx
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %i.dv = shufflevector <2 x float> %i.dt, <2 x float> %i.dh, <2 x i32> <i32 1, i32 3>
  ...
  %i.dz = shufflevector <2 x float> %i.dt, <2 x float> %i.dh, <2 x i32> <i32 0, i32 2>
  ...
  %i.er = fcmp ogt double %i.eq, %i.ep
