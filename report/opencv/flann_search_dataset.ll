...
_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i: ; preds = %bb.m
  ...
  br i1 %.not.i.i.i.i, label %_ZN2cv10AutoBufferIiLm264EEC2Em.exit106.thread184, label %bb.o

_ZN2cv10AutoBufferIiLm264EEC2Em.exit106.thread184: ; preds = %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i
...
._crit_edge:                                      ; preds = %_ZN2cv10AutoBufferIiLm264EEC2Em.exit106.thread184, %.lr.ph
  %i.bn = phi ptr [ %i.bj, %.lr.ph ], [ %i.as, %_ZN2cv10AutoBufferIiLm264EEC2Em.exit106.thread184 ] ; 2 uses
...
.lr.ph157:                                        ; preds = %_ZN2cv10AutoBufferIiLm264EEC2Em.exit109
  ...
  %min.iters.check197 = icmp ult i64 %i.cg, 24
  %n.vec199 = and i64 %i.ci, 4611686018427387900  ; 3 uses
  %i.cj = shl i64 %n.vec199, 3                    ; 2 uses
  %cmp.n213 = icmp eq i64 %i.ci, %n.vec199
...
.lr.ph.i.preheader:                               ; preds = %bb.v
  br i1 %min.iters.check197, label %.lr.ph.i.preheader218, label %vector.ph198

vector.ph198:                                     ; preds = %.lr.ph.i.preheader
...
vector.body200:                                   ; preds = %vector.body200, %vector.ph198
  %index201 = phi i64 [ 0, %vector.ph198 ], [ %index.next210, %vector.body200 ] ; 2 uses
  %vec.phi202 = phi <2 x i32> [ zeroinitializer, %vector.ph198 ], [ %i.dm, %vector.body200 ]
  %vec.phi203 = phi <2 x i32> [ zeroinitializer, %vector.ph198 ], [ %i.dn, %vector.body200 ]
  %i.dd = shl i64 %index201, 3                    ; 2 uses
  %next.gep204 = getelementptr i8, ptr %i.cz, i64 %i.dd ; 2 uses
  %next.gep205 = getelementptr i8, ptr %i.cv, i64 %i.dd ; 2 uses
  %i.de = getelementptr i8, ptr %next.gep205, i64 16
  %wide.load206 = load <2 x i64>, ptr %next.gep205, align 8, !tbaa !341
  %wide.load207 = load <2 x i64>, ptr %i.de, align 8, !tbaa !341
  %i.df = getelementptr i8, ptr %next.gep204, i64 16
  %wide.load208 = load <2 x i64>, ptr %next.gep204, align 8, !tbaa !341
  %wide.load209 = load <2 x i64>, ptr %i.df, align 8, !tbaa !341
  %i.dg = xor <2 x i64> %wide.load208, %wide.load206
  %i.dh = xor <2 x i64> %wide.load209, %wide.load207
  ...
  %i.dm = add <2 x i32> %vec.phi202, %i.dk        ; 2 uses
  %i.dn = add <2 x i32> %vec.phi203, %i.dl        ; 2 uses
  %index.next210 = add nuw i64 %index201, 4       ; 2 uses
  %i.do = icmp eq i64 %index.next210, %n.vec199
  br i1 %i.do, label %middle.block211, label %vector.body200, !llvm.loop !419

middle.block211:                                  ; preds = %vector.body200
  %bin.rdx212 = add <2 x i32> %i.dn, %i.dm
  %i.dp = call i32 @llvm.vector.reduce.add.v2i32(<2 x i32> %bin.rdx212) ; 2 uses
  br i1 %cmp.n213, label %._crit_edge.loopexit.i, label %.lr.ph.i.preheader218

.lr.ph.i.preheader218:                            ; preds = %.lr.ph.i.preheader, %middle.block211
  %.027.i.ph = phi i32 [ 0, %.lr.ph.i.preheader ], [ %i.dp, %middle.block211 ]
  %.02026.i.ph = phi ptr [ %i.cz, %.lr.ph.i.preheader ], [ %i.db, %middle.block211 ]
  %.02125.i.ph = phi ptr [ %i.cv, %.lr.ph.i.preheader ], [ %i.dc, %middle.block211 ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader218, %.lr.ph.i
  %.027.i = phi i32 [ %i.dv, %.lr.ph.i ], [ %.027.i.ph, %.lr.ph.i.preheader218 ]
  %.02026.i = phi ptr [ %i.dx, %.lr.ph.i ], [ %.02026.i.ph, %.lr.ph.i.preheader218 ] ; 2 uses
  %.02125.i = phi ptr [ %i.dw, %.lr.ph.i ], [ %.02125.i.ph, %.lr.ph.i.preheader218 ] ; 2 uses
  %i.dq = load i64, ptr %.02125.i, align 8, !tbaa !341
  %i.dr = load i64, ptr %.02026.i, align 8, !tbaa !341
  %i.ds = xor i64 %i.dr, %i.dq
  %i.dt = call range(i64 0, 65) i64 @llvm.ctpop.i64(i64 %i.ds)
  %i.du = trunc nuw nsw i64 %i.dt to i32
  %i.dv = add nuw nsw i32 %.027.i, %i.du          ; 2 uses
  %i.dw = getelementptr inbounds nuw i8, ptr %.02125.i, i64 8 ; 2 uses
  %i.dx = getelementptr inbounds nuw i8, ptr %.02026.i, i64 8
  %.not.i = icmp eq ptr %i.dw, %i.da
  br i1 %.not.i, label %._crit_edge.loopexit.i, label %.lr.ph.i, !llvm.loop !420

._crit_edge.loopexit.i:                           ; preds = %.lr.ph.i, %middle.block211
  %.lcssa = phi i32 [ %i.dp, %middle.block211 ], [ %i.dv, %.lr.ph.i ]
  %scevgep.i = getelementptr i8, ptr %i.cz, i64 %.idx.i
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.v
  %.021.lcssa.i = phi ptr [ %i.cv, %bb.v ], [ %i.da, %._crit_edge.loopexit.i ]
  %.020.lcssa.i = phi ptr [ %i.cz, %bb.v ], [ %scevgep.i, %._crit_edge.loopexit.i ]
  %.0.lcssa.i = phi i32 [ 0, %bb.v ], [ %.lcssa, %._crit_edge.loopexit.i ] ; 2 uses
...
bb.w:                                             ; preds = %._crit_edge.i
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.c, ptr align 8 %.021.lcssa.i, i64 %i.ce, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.d, ptr align 8 %.020.lcssa.i, i64 %i.ce, i1 false)
  ...
  %i.eb = add nuw nsw i32 %.0.lcssa.i, %i.ea
...
_ZNK7cvflann7HammingIhEclIPhS3_EEiT_T0_mi.exit:   ; preds = %._crit_edge.i, %bb.w
  %.1.i = phi i32 [ %i.eb, %bb.w ], [ %.0.lcssa.i, %._crit_edge.i ] ; 2 uses
...
._crit_edge155:                                   ; preds = %._crit_edge155.loopexit, %_ZNK7cvflann7HammingIhEclIPhS3_EEiT_T0_mi.exit
  ...
  %.082.lcssa = phi i32 [ %.1.i, %_ZNK7cvflann7HammingIhEclIPhS3_EEiT_T0_mi.exit ], [ %.183, %._crit_edge155.loopexit ] ; 2 uses
  %i.eg = getelementptr inbounds nuw [4 x i8], ptr %i.bp, i64 %i.ef ; 2 uses
  %i.eh = load i32, ptr %i.eg, align 4, !tbaa !59
  %i.ei = icmp sgt i32 %.082.lcssa, %i.eh
...
.lr.ph154:                                        ; preds = %.lr.ph154.preheader, %bb.z
  ...
  %.082152 = phi i32 [ %.183, %bb.z ], [ %.1.i, %.lr.ph154.preheader ] ; 2 uses
...
.lr.ph.i112.preheader:                            ; preds = %.lr.ph154
  br i1 %min.iters.check, label %.lr.ph.i112.preheader217, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %vec.phi190 = phi <2 x i32> [ zeroinitializer, %vector.ph ], [ %i.fa, %vector.body ]
  %i.eq = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.eo, i64 %i.eq ; 2 uses
  %next.gep191 = getelementptr i8, ptr %i.cv, i64 %i.eq ; 2 uses
  %i.er = getelementptr i8, ptr %next.gep191, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep191, align 8, !tbaa !341
  %wide.load192 = load <2 x i64>, ptr %i.er, align 8, !tbaa !341
  %i.es = getelementptr i8, ptr %next.gep, i64 16
  %wide.load193 = load <2 x i64>, ptr %next.gep, align 8, !tbaa !341
  %wide.load194 = load <2 x i64>, ptr %i.es, align 8, !tbaa !341
  %i.et = xor <2 x i64> %wide.load193, %wide.load
  %i.eu = xor <2 x i64> %wide.load194, %wide.load192
  ...
  %i.fa = add <2 x i32> %vec.phi190, %i.ey        ; 2 uses
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %._crit_edge.loopexit.i117, label %.lr.ph.i112.preheader217

.lr.ph.i112.preheader217:                         ; preds = %.lr.ph.i112.preheader, %middle.block
  %.027.i113.ph = phi i32 [ 0, %.lr.ph.i112.preheader ], [ %i.fc, %middle.block ]
  %.02026.i114.ph = phi ptr [ %i.eo, %.lr.ph.i112.preheader ], [ %i.ep, %middle.block ]
  %.02125.i115.ph = phi ptr [ %i.cv, %.lr.ph.i112.preheader ], [ %i.ed, %middle.block ]
  br label %.lr.ph.i112

.lr.ph.i112:                                      ; preds = %.lr.ph.i112.preheader217, %.lr.ph.i112
  %.027.i113 = phi i32 [ %i.fi, %.lr.ph.i112 ], [ %.027.i113.ph, %.lr.ph.i112.preheader217 ]
  %.02026.i114 = phi ptr [ %i.fk, %.lr.ph.i112 ], [ %.02026.i114.ph, %.lr.ph.i112.preheader217 ] ; 2 uses
  %.02125.i115 = phi ptr [ %i.fj, %.lr.ph.i112 ], [ %.02125.i115.ph, %.lr.ph.i112.preheader217 ] ; 2 uses
  %i.fd = load i64, ptr %.02125.i115, align 8, !tbaa !341
  %i.fe = load i64, ptr %.02026.i114, align 8, !tbaa !341
  %i.ff = xor i64 %i.fe, %i.fd
  %i.fg = call range(i64 0, 65) i64 @llvm.ctpop.i64(i64 %i.ff)
  %i.fh = trunc nuw nsw i64 %i.fg to i32
  %i.fi = add nuw nsw i32 %.027.i113, %i.fh       ; 2 uses
  %i.fj = getelementptr inbounds nuw i8, ptr %.02125.i115, i64 8 ; 2 uses
  %i.fk = getelementptr inbounds nuw i8, ptr %.02026.i114, i64 8
...
._crit_edge.loopexit.i117:                        ; preds = %.lr.ph.i112, %middle.block
  %.lcssa188 = phi i32 [ %i.fc, %middle.block ], [ %i.fi, %.lr.ph.i112 ]
...
._crit_edge.i119:                                 ; preds = %._crit_edge.loopexit.i117, %.lr.ph154
  %.021.lcssa.i120 = phi ptr [ %i.cv, %.lr.ph154 ], [ %i.da, %._crit_edge.loopexit.i117 ]
  %.020.lcssa.i121 = phi ptr [ %i.eo, %.lr.ph154 ], [ %scevgep.i118, %._crit_edge.loopexit.i117 ]
  %.0.lcssa.i122 = phi i32 [ 0, %.lr.ph154 ], [ %.lcssa188, %._crit_edge.loopexit.i117 ] ; 2 uses
...
bb.x:                                             ; preds = %._crit_edge.i119
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.a, ptr align 8 %.021.lcssa.i120, i64 %i.ce, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 8 %i.b, ptr align 8 %.020.lcssa.i121, i64 %i.ce, i1 false)
  ...
  %i.fo = add nuw nsw i32 %.0.lcssa.i122, %i.fn
...
_ZNK7cvflann7HammingIhEclIPhS3_EEiT_T0_mi.exit127: ; preds = %._crit_edge.i119, %bb.x
  %.1.i126 = phi i32 [ %i.fo, %bb.x ], [ %.0.lcssa.i122, %._crit_edge.i119 ] ; 2 uses
  %i.fp = icmp sgt i32 %.082152, %.1.i126
...
bb.z:                                             ; preds = %bb.y, %_ZNK7cvflann7HammingIhEclIPhS3_EEiT_T0_mi.exit127
  ...
  %.183 = phi i32 [ %.1.i126, %bb.y ], [ %.082152, %_ZNK7cvflann7HammingIhEclIPhS3_EEiT_T0_mi.exit127 ] ; 2 uses
...
bb.aa:                                            ; preds = %._crit_edge155
  store i32 %.082.lcssa, ptr %i.eg, align 4, !tbaa !59
