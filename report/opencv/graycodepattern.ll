...
bb.d:                                             ; preds = %.lr.ph, %_ZNSt6vectorIhSaIhEE9push_backEOh.exit
  ...
  %i.ag = load i8, ptr %i.af, align 1, !tbaa !47  ; 2 uses
  ...
  %5 = uitofp i8 %i.ag to double
  %i.aq = load i8, ptr %i.ap, align 1, !tbaa !47  ; 2 uses
  %i.ar = uitofp i8 %i.aq to double
...
bb.t:                                             ; preds = %_ZNK2cv16structured_light20GrayCodePattern_Impl9grayToDecERKSt6vectorIhSaIhEE.exit, %_ZNSt6vectorIhSaIhEE9push_backEOh.exit110
  ...
  %7 = uitofp i8 %i.dd to double
  %i.dn = load i8, ptr %i.dm, align 1, !tbaa !47  ; 2 uses
