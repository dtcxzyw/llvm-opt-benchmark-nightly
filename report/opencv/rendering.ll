...
.preheader.preheader.i:                           ; preds = %.preheader.lr.ph.i
  ...
  %49 = insertelement <3 x float> poison, float %.sroa.8.0.copyload, i64 0
  %50 = insertelement <3 x float> %49, float %.sroa.13.16.copyload, i64 1
  %51 = insertelement <3 x float> %50, float %.sroa.18.32.copyload, i64 2
  %i.ss = insertelement <2 x float> poison, float %.sroa.8.0.1, i64 0
  %52 = insertelement <2 x float> %i.ss, float %.sroa.8.0.2, i64 1
  %i.st = insertelement <2 x float> poison, float %i.sl, i64 0
  %53 = shufflevector <2 x float> %i.st, <2 x float> poison, <2 x i32> zeroinitializer
...
bb.gc:                                            ; preds = %.noexc279, %.preheader.i
  ...
  %i.tn = fmul <2 x float> %53, %i.tm             ; 3 uses
...
_ZN2cv3VecIfLi3EEC2ESt16initializer_listIfE.exit135.i: ; preds = %bb.gh
  %54 = shufflevector <2 x float> %i.tn, <2 x float> poison, <3 x i32> <i32 1, i32 0, i32 poison>
  %55 = insertelement <3 x float> %54, float %i.tr, i64 2
  %56 = fmul <3 x float> %51, %55                 ; 6 uses
  %i.uk = extractelement <3 x float> %56, i64 0
  %57 = fmul float %i.uk, %.sroa.8.0
  %i.ul = fadd float %57, 0.000000e+00
  %i.um = extractelement <3 x float> %56, i64 1
  %58 = shufflevector <3 x float> %56, <3 x float> poison, <2 x i32> <i32 1, i32 2>
  %59 = fmul <2 x float> %58, %52                 ; 2 uses
  %60 = extractelement <2 x float> %59, i64 0
  %61 = fadd float %i.ul, %60
  %62 = shufflevector <3 x float> %56, <3 x float> poison, <2 x i32> zeroinitializer
  %i.un = fmul <2 x float> %62, %i.wq
  %i.uo = fadd <2 x float> %i.un, zeroinitializer
  %63 = shufflevector <3 x float> %56, <3 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.up = fmul <2 x float> %63, %i.ze
  %i.uq = fadd <2 x float> %i.uo, %i.up
  %64 = shufflevector <3 x float> %56, <3 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.ur = fmul <2 x float> %64, %i.abs
  %i.us = fadd <2 x float> %i.uq, %i.ur
  %65 = extractelement <2 x float> %59, i64 1
  %66 = fadd float %61, %65
  %i.ut = call float @llvm.fmuladd.f32(float %i.to, float %.sroa.8.0.copyload, float %i.um)
