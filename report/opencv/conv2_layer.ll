...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !226    ; 8 uses
  %i.b = load i32, ptr %1, align 4, !tbaa !222    ; 2 uses
...
bb.b:                                             ; preds = %.loopexit.i.i.i, %.lr.ph38.i.i.i
  ...
  %i.m = load ptr, ptr %i.a, align 8, !tbaa !339, !nonnull !98, !align !233
  %i.n = load i32, ptr %i.m, align 4, !tbaa !88
  %i.o = sext i32 %i.n to i64
  %i.p = sub nsw i64 %i.o, %i.l                   ; 2 uses
  %i.q = load ptr, ptr %i.f, align 8, !tbaa !340, !nonnull !98, !align !234
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !220
  %i.s = load ptr, ptr %i.g, align 8, !tbaa !341, !nonnull !98, !align !233
  %i.t = load i32, ptr %i.s, align 4, !tbaa !88
  %i.u = sext i32 %i.t to i64
  %i.v = shl nsw i64 %indvars.iv44.i.i.i, 5
  %.idx.i.i.i = mul i64 %i.v, %i.u
  %i.w = getelementptr inbounds nuw i8, ptr %i.r, i64 %.idx.i.i.i
  %i.x = load ptr, ptr %i.h, align 8, !tbaa !342, !nonnull !98, !align !233
  ...
  %i.ab = load ptr, ptr %i.i, align 8, !tbaa !343, !nonnull !98, !align !234
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !220
...
.preheader.i.i.i:                                 ; preds = %bb.b
  %i.ae = load ptr, ptr %i.j, align 8, !tbaa !344, !nonnull !98, !align !233
...
.lr.ph36.i.i.i:                                   ; preds = %.preheader.i.i.i, %.lr.ph36.i.i.i
  ...
  %i.ah = load ptr, ptr %i.a, align 8, !tbaa !339, !nonnull !98, !align !233
  ...
  %i.an = load ptr, ptr %i.j, align 8, !tbaa !344, !nonnull !98, !align !233
  %i.ao = load i32, ptr %i.an, align 4, !tbaa !88
  %i.ap = sext i32 %i.ao to i64
  %i.aq = icmp slt i64 %indvars.iv.next42.i.i.i, %i.ap
  br i1 %i.aq, label %.lr.ph36.i.i.i, label %.loopexit.i.i.i, !llvm.loop !335

bb.c:                                             ; preds = %bb.b
  %i.ar = shl nsw i64 %i.p, 2
  %i.as = load ptr, ptr %i.j, align 8, !tbaa !344, !nonnull !98, !align !233
...
.lr.ph.i.i.i:                                     ; preds = %bb.c, %.lr.ph.i.i.i
  ...
  %i.av = load ptr, ptr %i.a, align 8, !tbaa !339, !nonnull !98, !align !233
  ...
  %i.bb = load ptr, ptr %i.j, align 8, !tbaa !344, !nonnull !98, !align !233
  %i.bc = load i32, ptr %i.bb, align 4, !tbaa !88
  %i.bd = sext i32 %i.bc to i64
  %i.be = icmp slt i64 %indvars.iv.next.i.i.i, %i.bd
  br i1 %i.be, label %.lr.ph.i.i.i, label %.loopexit.i.i.i, !llvm.loop !336
...
.loopexit.i.i.i:                                  ; preds = %.lr.ph.i.i.i, %.lr.ph36.i.i.i, %bb.c, %.preheader.i.i.i
  ...
  %i.bf = load i32, ptr %i.c, align 4, !tbaa !223
  %i.bg = sext i32 %i.bf to i64
  %i.bh = icmp slt i64 %indvars.iv.next45.i.i.i, %i.bg
  br i1 %i.bh, label %bb.b, label %_ZSt10__invoke_rIvRZN2cv3dnn14Conv2LayerImpl17gatherNCHWcToNHWCEPKfiiiiPfiEUlRKNS0_5RangeEE_JS8_EENSt9enable_ifIX16is_invocable_r_vIT_T0_DpT1_EESC_E4typeEOSD_DpOSE_.exit, !llvm.loop !337
...
bb.b:                                             ; preds = %bb.a
  store ptr @_ZTIZN2cv3dnn14Conv2LayerImpl17gatherNCHWcToNHWCEPKfiiiiPfiEUlRKNS_5RangeEE_, ptr %0, align 8, !tbaa !236
...
bb.c:                                             ; preds = %bb.a
  ...
  store ptr %i.a, ptr %0, align 8, !tbaa !226
  br label %_ZNSt14_Function_base13_Base_managerIZN2cv3dnn14Conv2LayerImpl17gatherNCHWcToNHWCEPKfiiiiPfiEUlRKNS1_5RangeEE_E10_M_managerERSt9_Any_dataRKSC_St18_Manager_operation.exit

bb.d:                                             ; preds = %bb.a
  %i.b = load ptr, ptr %1, align 8, !tbaa !226
  %i.c = tail call noalias noundef nonnull dereferenceable(48) ptr @_Znwm(i64 noundef 48) #21 ; 2 uses
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(48) %i.c, ptr noundef nonnull align 8 dereferenceable(48) %i.b, i64 48, i1 false), !tbaa.struct !345
  store ptr %i.c, ptr %0, align 8, !tbaa !226
  br label %_ZNSt14_Function_base13_Base_managerIZN2cv3dnn14Conv2LayerImpl17gatherNCHWcToNHWCEPKfiiiiPfiEUlRKNS1_5RangeEE_E10_M_managerERSt9_Any_dataRKSC_St18_Manager_operation.exit

bb.e:                                             ; preds = %bb.a
  %i.d = load ptr, ptr %0, align 8, !tbaa !226    ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  store ptr @_ZTIZNK2cv3dnn14Conv2LayerImpl18scatterAndActivateEPKfiiiiPfEUlRKNS_5RangeEE_, ptr %0, align 8, !tbaa !236
...
bb.d:                                             ; preds = %bb.a
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(104) %i.c, ptr noundef nonnull align 8 dereferenceable(104) %i.b, i64 104, i1 false), !tbaa.struct !346
  store ptr %i.c, ptr %0, align 8, !tbaa !226
  br label %_ZNSt14_Function_base13_Base_managerIZNK2cv3dnn14Conv2LayerImpl18scatterAndActivateEPKfiiiiPfEUlRKNS1_5RangeEE_E10_M_managerERSt9_Any_dataRKSC_St18_Manager_operation.exit
...
bb.a:
  ...
  %i.d = load i32, ptr %1, align 4, !tbaa !222    ; 4 uses
...
.lr.ph73:                                         ; preds = %bb.a
  %i.h = load ptr, ptr %0, align 8, !tbaa !350, !nonnull !98, !align !233
  %i.i = load i32, ptr %i.h, align 4, !tbaa !88   ; 2 uses
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !351, !nonnull !98, !align !234
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !220
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !352, !nonnull !98, !align !233
  %i.o = load i32, ptr %i.n, align 4, !tbaa !88
  %i.p = sext i32 %i.o to i64
  %factor.op.mul = shl nsw i64 %i.p, 5
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !353, !nonnull !98, !align !233
  %i.s = load i32, ptr %i.r, align 4, !tbaa !88
  %i.t = sext i32 %i.s to i64
  %.idx45 = shl nsw i64 %i.t, 5
  %invariant.gep = getelementptr i8, ptr %i.l, i64 %.idx45
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.v = load ptr, ptr %i.u, align 8, !tbaa !354, !nonnull !98, !align !234
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !220
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.y = load ptr, ptr %i.x, align 8, !nonnull !98, !align !234 ; 2 uses
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.aa = load ptr, ptr %i.z, align 8, !nonnull !98, !align !234 ; 2 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.ac = load ptr, ptr %i.ab, align 8, !nonnull !98, !align !234
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 64
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 72
  %i.af = load ptr, ptr %i.ae, align 8, !tbaa !355, !nonnull !98, !align !233
  %i.ag = load i32, ptr %i.af, align 4, !tbaa !88 ; 4 uses
...
.lr.ph:                                           ; preds = %bb.b
  %i.bc = load ptr, ptr %i.y, align 8, !tbaa !220 ; 3 uses
  %.not48 = icmp eq ptr %i.bc, null               ; 9 uses
  %i.bd = load ptr, ptr %i.aa, align 8, !tbaa !220 ; 4 uses
  %.not49 = icmp eq ptr %i.bd, null               ; 17 uses
  %i.be = load ptr, ptr %i.ac, align 8, !tbaa !220 ; 2 uses
...
.lr.ph.split.preheader:                           ; preds = %.lr.ph
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(1) %i.c, ptr noundef nonnull align 4 dereferenceable(1) %scevgep, i64 %i.au, i1 false), !tbaa !216
...
.lr.ph.split.us:                                  ; preds = %.lr.ph
  %i.bf = load ptr, ptr %i.ad, align 8, !tbaa !356, !nonnull !98, !align !233
  %i.bg = load float, ptr %i.bf, align 4, !tbaa !216 ; 24 uses
...
.lr.ph.split.us.split.preheader:                  ; preds = %.lr.ph.split.us
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(1) %i.a, ptr noundef nonnull align 4 dereferenceable(1) %scevgep84, i64 %i.au, i1 false), !tbaa !216
...
.lr.ph.split.us.split.us.split.preheader:         ; preds = %.lr.ph.split.us.split.us
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 32 dereferenceable(1) %i.b, ptr noundef nonnull align 4 dereferenceable(1) %scevgep90, i64 %i.au, i1 false), !tbaa !216
  store float 1.000000e+00, ptr %i.a, align 32, !tbaa !216
  store float %i.bg, ptr %i.c, align 32, !tbaa !216
...
.lr.ph.split.us.split.us.split.us.preheader:      ; preds = %.lr.ph.split.us.split.us
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 32 dereferenceable(1) %i.b, i8 0, i64 %i.au, i1 false), !tbaa !216
  store float 1.000000e+00, ptr %i.a, align 32, !tbaa !216
  store float %i.bg, ptr %i.c, align 32, !tbaa !216
...
.lr.ph.split.us.split.us.split.us.1:              ; preds = %.lr.ph.split.us.split.us.split.us.preheader
  store float 1.000000e+00, ptr %.4..sroa_idx312, align 4, !tbaa !216
  store float %i.bg, ptr %.4..sroa_idx220, align 4, !tbaa !216
...
.lr.ph.split.us.split.us.split.us.2:              ; preds = %.lr.ph.split.us.split.us.split.us.1
  store float 1.000000e+00, ptr %.8..sroa_idx317, align 8, !tbaa !216
  store float %i.bg, ptr %.8..sroa_idx227, align 8, !tbaa !216
...
.lr.ph.split.us.split.us.split.us.3:              ; preds = %.lr.ph.split.us.split.us.split.us.2
  store float 1.000000e+00, ptr %.12..sroa_idx322, align 4, !tbaa !216
  store float %i.bg, ptr %.12..sroa_idx234, align 4, !tbaa !216
...
.lr.ph.split.us.split.us.split.us.4:              ; preds = %.lr.ph.split.us.split.us.split.us.3
  store float 1.000000e+00, ptr %.16..sroa_idx327, align 16, !tbaa !216
  store float %i.bg, ptr %.16..sroa_idx241, align 16, !tbaa !216
...
.lr.ph.split.us.split.us.split.us.5:              ; preds = %.lr.ph.split.us.split.us.split.us.4
  store float 1.000000e+00, ptr %.20..sroa_idx332, align 4, !tbaa !216
  store float %i.bg, ptr %.20..sroa_idx248, align 4, !tbaa !216
...
.lr.ph.split.us.split.us.split.us.6:              ; preds = %.lr.ph.split.us.split.us.split.us.5
  store float 1.000000e+00, ptr %.24..sroa_idx337, align 8, !tbaa !216
  store float %i.bg, ptr %.24..sroa_idx255, align 8, !tbaa !216
...
.lr.ph.split.us.split.us.split.us.7:              ; preds = %.lr.ph.split.us.split.us.split.us.6
  store float 1.000000e+00, ptr %.28..sroa_idx342, align 4, !tbaa !216
  store float %i.bg, ptr %.28..sroa_idx262, align 4, !tbaa !216
  br label %.preheader61

.lr.ph.split.us.split.us.split.1:                 ; preds = %.lr.ph.split.us.split.us.split.preheader
  store float 1.000000e+00, ptr %.4..sroa_idx311, align 4, !tbaa !216
  store float %i.bg, ptr %.4..sroa_idx219, align 4, !tbaa !216
...
.lr.ph.split.us.split.us.split.2:                 ; preds = %.lr.ph.split.us.split.us.split.1
  store float 1.000000e+00, ptr %.8..sroa_idx316, align 8, !tbaa !216
  store float %i.bg, ptr %.8..sroa_idx226, align 8, !tbaa !216
...
.lr.ph.split.us.split.us.split.3:                 ; preds = %.lr.ph.split.us.split.us.split.2
  store float 1.000000e+00, ptr %.12..sroa_idx321, align 4, !tbaa !216
  store float %i.bg, ptr %.12..sroa_idx233, align 4, !tbaa !216
...
.lr.ph.split.us.split.us.split.4:                 ; preds = %.lr.ph.split.us.split.us.split.3
  store float 1.000000e+00, ptr %.16..sroa_idx326, align 16, !tbaa !216
  store float %i.bg, ptr %.16..sroa_idx240, align 16, !tbaa !216
...
.lr.ph.split.us.split.us.split.5:                 ; preds = %.lr.ph.split.us.split.us.split.4
  store float 1.000000e+00, ptr %.20..sroa_idx331, align 4, !tbaa !216
  store float %i.bg, ptr %.20..sroa_idx247, align 4, !tbaa !216
...
.lr.ph.split.us.split.us.split.6:                 ; preds = %.lr.ph.split.us.split.us.split.5
  store float 1.000000e+00, ptr %.24..sroa_idx336, align 8, !tbaa !216
  store float %i.bg, ptr %.24..sroa_idx254, align 8, !tbaa !216
...
.lr.ph.split.us.split.us.split.7:                 ; preds = %.lr.ph.split.us.split.us.split.6
  store float 1.000000e+00, ptr %.28..sroa_idx341, align 4, !tbaa !216
  store float %i.bg, ptr %.28..sroa_idx261, align 4, !tbaa !216
  br label %.preheader61

bb.c:                                             ; preds = %.lr.ph.split.us.split.preheader
  %i.bn = load float, ptr %invariant.gep201, align 4, !tbaa !216
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %.lr.ph.split.us.split.preheader
  %i.bo = phi float [ %i.bn, %bb.c ], [ 0.000000e+00, %.lr.ph.split.us.split.preheader ]
  store float %i.bo, ptr %i.b, align 32, !tbaa !216
  store float %i.bg, ptr %i.c, align 32, !tbaa !216
...
bb.e:                                             ; preds = %.lr.ph.split.us.split.1
  ...
  %i.bp = load float, ptr %gep202.1, align 4, !tbaa !216
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %.lr.ph.split.us.split.1
  %i.bq = phi float [ %i.bp, %bb.e ], [ 0.000000e+00, %.lr.ph.split.us.split.1 ]
  store float %i.bq, ptr %.4..sroa_idx270, align 4, !tbaa !216
  store float %i.bg, ptr %.4..sroa_idx218, align 4, !tbaa !216
...
bb.g:                                             ; preds = %.lr.ph.split.us.split.2
  ...
  %i.bs = load float, ptr %gep202.2, align 4, !tbaa !216
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %.lr.ph.split.us.split.2
  %i.bt = phi float [ %i.bs, %bb.g ], [ 0.000000e+00, %.lr.ph.split.us.split.2 ]
  store float %i.bt, ptr %.8..sroa_idx276, align 8, !tbaa !216
  store float %i.bg, ptr %.8..sroa_idx225, align 8, !tbaa !216
...
bb.i:                                             ; preds = %.lr.ph.split.us.split.3
  ...
  %i.bu = load float, ptr %gep202.3, align 4, !tbaa !216
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %.lr.ph.split.us.split.3
  %i.bv = phi float [ %i.bu, %bb.i ], [ 0.000000e+00, %.lr.ph.split.us.split.3 ]
  store float %i.bv, ptr %.12..sroa_idx282, align 4, !tbaa !216
  store float %i.bg, ptr %.12..sroa_idx232, align 4, !tbaa !216
