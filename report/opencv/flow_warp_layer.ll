...
.preheader173.lr.ph.preheader:                    ; preds = %.lr.ph184
  ...
  %i.bq = shl i64 %i.bp, 2
  %13 = add i64 %i.bq, 4                          ; 4 uses
  %scevgep246.a = getelementptr i8, ptr %i.an, i64 %13
  %scevgep252.a = getelementptr i8, ptr %i.an, i64 %13
  %scevgep258 = getelementptr i8, ptr %i.an, i64 %13
  %scevgep264 = getelementptr i8, ptr %i.an, i64 %13
  %xtraiter = and i64 %wide.trip.count, 3         ; 3 uses
  %i.br = icmp ult i32 %i.r, 4
  %unroll_iter = and i64 %wide.trip.count, 2147483644
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod288 = icmp ne i64 %xtraiter, 0
  %min.iters.check = icmp ult i32 %i.r, 64
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  ...
  %scevgep248.a = getelementptr i8, ptr %i.an, i64 %i.gm
  %scevgep251.a = getelementptr i8, ptr %scevgep246.a, i64 %i.gm
  %i.gn = shl nsw i64 %i.fd, 2                    ; 2 uses
  %i.go = add i64 %i.gl, %i.gn                    ; 2 uses
  %scevgep254.a = getelementptr i8, ptr %i.an, i64 %i.go
  %scevgep257.a = getelementptr i8, ptr %scevgep252.a, i64 %i.go
  %i.gp = add nsw i64 %i.db, %i.fc
  %i.gq = shl i64 %i.gp, 2                        ; 2 uses
  %i.gr = add i64 %i.gj, %i.gq                    ; 2 uses
  %scevgep260 = getelementptr i8, ptr %i.an, i64 %i.gr
  %scevgep263 = getelementptr i8, ptr %scevgep258, i64 %i.gr
  %i.gs = add i64 %i.gq, %i.gn                    ; 2 uses
  %scevgep266 = getelementptr i8, ptr %i.an, i64 %i.gs
  %scevgep269 = getelementptr i8, ptr %scevgep264, i64 %i.gs
  %bound0 = icmp ult ptr %umin, %scevgep251.a
  %bound1 = icmp ult ptr %scevgep248.a, %scevgep245
  %found.conflict = and i1 %bound0, %bound1
  %bound0270 = icmp ult ptr %umin, %scevgep257.a
  %bound1271 = icmp ult ptr %scevgep254.a, %scevgep245
  ...
  %bound1274 = icmp ult ptr %scevgep260, %scevgep245
  ...
  %bound1278 = icmp ult ptr %scevgep266, %scevgep245
