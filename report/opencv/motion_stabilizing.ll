...
bb.m:                                             ; preds = %bb.g
  ...
  %17 = load <2 x float>, ptr %i.ak, align 4, !tbaa !62 ; 3 uses
  %i.bh = load <2 x float>, ptr %.sink.i, align 4, !tbaa !62 ; 3 uses
  %i.bi = load float, ptr %i.ap, align 4, !tbaa !62 ; 2 uses
  %18 = shufflevector <2 x float> %17, <2 x float> %i.bh, <4 x i32> <i32 0, i32 2, i32 0, i32 2>
  %19 = fadd <4 x float> %18, <float 0.000000e+00, float -0.000000e+00, float 0.000000e+00, float -0.000000e+00> ; 2 uses
  %20 = fadd float %i.bi, 0.000000e+00            ; 2 uses
  %21 = shufflevector <2 x float> %17, <2 x float> poison, <4 x i32> <i32 1, i32 poison, i32 1, i32 poison>
  %22 = insertelement <4 x float> poison, float %20, i64 0
  %23 = shufflevector <4 x float> %22, <4 x float> poison, <4 x i32> <i32 poison, i32 0, i32 poison, i32 0>
  %24 = shufflevector <4 x float> %21, <4 x float> %23, <4 x i32> <i32 0, i32 5, i32 2, i32 7>
  %25 = fmul <4 x float> %24, zeroinitializer
  ...
  %i.bl = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %19, <4 x float> %i.bk, <4 x float> %25)
  ...
  %i.cf = insertelement <2 x float> %i.bz, float %20, i64 1
  ...
  %26 = shufflevector <2 x float> %i.bh, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %27 = shufflevector <4 x float> %19, <4 x float> %26, <4 x i32> <i32 0, i32 4, i32 0, i32 4>
...
bb.p:                                             ; preds = %.preheader, %bb.p
  ...
  %i.dq = call float @llvm.fmuladd.f32(float %28, float %i.dp, float %i.do)
  %i.dr = fmul float %i.dk, %i.dp                 ; 2 uses
  %i.ds = fmul float %i.dj, %i.dp
  %i.dt = call float @llvm.fmuladd.f32(float %i.bi, float %i.dp, float %i.do) ; 2 uses
  ...
  %29 = insertelement <4 x float> poison, float %i.dr, i64 0
  %30 = insertelement <4 x float> %29, float %i.dt, i64 1
  %31 = fmul <4 x float> %30, <float 0.000000e+00, float 0.000000e+00, float poison, float poison>
  %i.eb = shufflevector <4 x float> %31, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  ...
  %32 = insertelement <2 x float> poison, float %i.dr, i64 0
  %33 = insertelement <2 x float> %32, float %i.dt, i64 1
  %i.es = fmul <2 x float> %33, %i.ch
