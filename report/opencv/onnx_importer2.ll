...
bb.l:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit185.thread, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit185
  ...
  %i.cd = load i32, ptr %i.bz, align 4, !tbaa !576
...
bb.w:                                             ; preds = %bb.s
  ...
  br i1 %exitcond.not, label %._crit_edge.i.i192, label %bb.s, !llvm.loop !616
...
.noexc212:                                        ; preds = %._crit_edge.i.i192
  ...
  store ptr %i.ec, ptr %i.db, align 8, !tbaa !273, !noalias !613
  %i.ed = getelementptr inbounds nuw i8, ptr %i.db, i64 8
  %.not.i.i.i = icmp ugt i32 %i.cq, 1
  store i64 %i.cr, ptr %i.ed, align 8, !tbaa !275, !noalias !613
...
bb.y:                                             ; preds = %.noexc212
  ...
  %i.ef = invoke noalias noundef nonnull ptr @_Znam(i64 noundef %i.ee) #29
          to label %.noexc.i211 unwind label %bb.z, !noalias !613 ; 2 uses

.noexc.i211:                                      ; preds = %bb.y
  store ptr %i.ef, ptr %i.db, align 8, !tbaa !273, !noalias !613
...
_ZN2cv10AutoBufferIlLm1EEC2Em.exit.i:             ; preds = %.noexc.i211, %.noexc212
  ...
  store i32 0, ptr %15, align 8, !tbaa !276, !alias.scope !613
  %i.eh = getelementptr inbounds nuw i8, ptr %15, i64 8
  store ptr %i.db, ptr %i.eh, align 8, !tbaa !15, !alias.scope !613
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i32>, ptr %next.gep, align 4, !tbaa !104, !noalias !613
  %wide.load734 = load <2 x i32>, ptr %i.el, align 4, !tbaa !104, !noalias !613
  ...
  store <2 x i64> %i.em, ptr %i.eo, align 8, !tbaa !93, !noalias !613
  store <2 x i64> %i.en, ptr %i.ep, align 8, !tbaa !93, !noalias !613
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.eq = icmp eq i64 %index.next, %n.vec
  br i1 %i.eq, label %middle.block, label %vector.body, !llvm.loop !617
...
bb.z:                                             ; preds = %bb.y
  %i.er = landingpad { ptr, i32 }
          cleanup
  call void @_ZdlPvm(ptr noundef nonnull %i.db, i64 noundef 24) #27, !noalias !613
  br label %.body213
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.es = load i32, ptr %.0910.i, align 4, !tbaa !104, !noalias !613
  %i.et = sext i32 %i.es to i64
  %i.eu = getelementptr inbounds nuw [8 x i8], ptr %i.eg, i64 %indvars.iv.i
  store i64 %i.et, ptr %i.eu, align 8, !tbaa !93, !noalias !613
  %i.ev = getelementptr inbounds nuw i8, ptr %.0910.i, i64 4
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %i.cr
  br i1 %exitcond.not.i, label %_ZN2cv3dnn14dnn5_v202606059DictValue8arrayIntIPiEES2_T_i.exit, label %scalar.ph, !llvm.loop !618
...
.preheader:                                       ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit267.thread, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit267
  ...
  %.pre577 = load i32, ptr %11, align 8, !tbaa !276
  br label %bb.br
