...
vector.body423:                                   ; preds = %.lr.ph296, %vector.body423
  ...
  %i.qc = getelementptr inbounds nuw [2 x i8], ptr %i.ou, i64 %index424 ; 4 uses
  ...
  %wide.load426 = load <8 x i16>, ptr %i.qc, align 2, !tbaa !47, !alias.scope !194
  ...
  %42 = sext <8 x i16> %i.tu to <8 x i32>
  %wide.load427 = load <8 x i16>, ptr %i.qc, align 2, !tbaa !47, !alias.scope !194
  %i.tv = sext <8 x i16> %wide.load427 to <8 x i32>
  %i.tw = mul nsw <8 x i32> %i.tv, %42
  ...
  %43 = shufflevector <8 x i16> %i.ra, <8 x i16> %i.sw, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.uy = shufflevector <8 x i16> %wide.load425, <8 x i16> %wide.load426, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %44 = sext <16 x i16> %i.uy to <16 x i32>
