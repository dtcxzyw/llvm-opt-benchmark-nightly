...
.lr.ph:                                           ; preds = %bb.a
  ...
  %12 = load <4 x float>, ptr %4, align 8
  %13 = load <4 x float>, ptr %i.d, align 4
  %14 = load <4 x float>, ptr %5, align 4
  %15 = load <4 x float>, ptr %10, align 8
  %16 = load <4 x float>, ptr %9, align 4
  %17 = load <4 x float>, ptr %11, align 4
  %18 = load <4 x float>, ptr %7, align 4
  %19 = load <4 x float>, ptr %6, align 8
  %20 = load <4 x float>, ptr %8, align 8
  %i.e = load <4 x float>, ptr %i.c, align 8
  %i.f = add nsw i32 %.sroa.3.0.extract.trunc, -1
  %i.g = sitofp i32 %i.f to float
  %21 = shufflevector <4 x float> %12, <4 x float> poison, <2 x i32> zeroinitializer
  %i.h = insertelement <2 x float> <float poison, float 0.000000e+00>, float %i.g, i64 0 ; 3 uses
  %i.i = fmul <2 x float> %21, %i.h
  %22 = shufflevector <4 x float> %18, <4 x float> poison, <2 x i32> zeroinitializer
  %i.j = fmul <2 x float> %22, %i.h
  %23 = shufflevector <4 x float> %15, <4 x float> poison, <2 x i32> zeroinitializer
  %i.k = fmul <2 x float> %23, %i.h
  ...
  %25 = shufflevector <4 x float> %19, <4 x float> poison, <2 x i32> zeroinitializer
  %26 = shufflevector <4 x float> %17, <4 x float> poison, <2 x i32> zeroinitializer
  %27 = shufflevector <4 x float> %16, <4 x float> poison, <2 x i32> zeroinitializer
  %28 = shufflevector <4 x float> %14, <4 x float> poison, <2 x i32> zeroinitializer
  %i.m = shufflevector <4 x float> %13, <4 x float> poison, <2 x i32> zeroinitializer
  br label %bb.b
...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.bi = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %25, <2 x float> %i.bg, <2 x float> %i.j)
  %i.bj = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %27, <2 x float> %i.bg, <2 x float> %i.k)
  %i.bk = fadd <2 x float> %28, %i.bh             ; 4 uses
  %i.bl = fadd <2 x float> %26, %i.bj             ; 4 uses
  ...
  %i.bp = fadd <2 x float> %24, %i.bi             ; 3 uses
