...
bb.a:
  ...
  %i.m = fpext <2 x float> %i.l to <2 x double>   ; 7 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.ck = shufflevector <2 x double> %i.s, <2 x double> %i.o, <3 x i32> <i32 0, i32 2, i32 poison>
  %i.cl = shufflevector <3 x double> %i.ck, <3 x double> %i.ae, <3 x i32> <i32 0, i32 1, i32 5> ; 2 uses
  ...
  %i.cy = tail call <3 x double> @llvm.fmuladd.v3f64(<3 x double> %i.cx, <3 x double> %i.cl, <3 x double> %i.cw)
