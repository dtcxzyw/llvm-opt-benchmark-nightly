...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.dl = shufflevector <4 x float> %wide.load, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %i.dp = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %1, <8 x float> %i.bg, <8 x float> %i.do)
