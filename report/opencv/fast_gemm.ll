...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %1 = shufflevector <4 x float> %wide.load, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3> ; 2 uses
  ...
  %2 = shufflevector <4 x float> %i.ca, <4 x float> %i.cm, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %i.dl = shufflevector <4 x float> %i.cy, <4 x float> %i.dk, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.dm = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %1, <8 x float> %i.bf, <8 x float> %2)
  %i.dn = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %1, <8 x float> %i.bg, <8 x float> %i.dl)
