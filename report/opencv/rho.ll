...
begin_hunk_0_@_ZN2cv13RHO_HEST_REFC6refineEv:bb.a
  ...
  %i.st = load <2 x float>, ptr %i.jc, align 4, !tbaa !76 ; 6 uses
  ...
  %i.ts = shufflevector <2 x float> %i.si, <2 x float> %i.st, <3 x i32> <i32 0, i32 2, i32 3>
  ...
  %1 = shufflevector <2 x float> %i.st, <2 x float> poison, <3 x i32> <i32 0, i32 1, i32 poison> ; 2 uses
  %2 = shufflevector <3 x float> %1, <3 x float> %i.tu, <3 x i32> <i32 0, i32 1, i32 3>
  %i.tz = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.ty, <3 x float> %2, <3 x float> %i.tt)
  ...
  %3 = shufflevector <3 x float> %1, <3 x float> %i.tu, <3 x i32> <i32 1, i32 3, i32 4>
  %i.ud = tail call <3 x float> @llvm.fmuladd.v3f32(<3 x float> %i.uc, <3 x float> %3, <3 x float> %i.tz)
