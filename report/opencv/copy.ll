...
begin_hunk_0_@_ZN2cv6repeatERKNS_11_InputArrayEiiRKNS_12_OutputArrayE:bb.a
  %i.p = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.q = load ptr, ptr %9, align 8, !tbaa !13     ; 2 uses
...
bb.t:                                             ; preds = %bb.q
  %i.y = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.z = load ptr, ptr %11, align 8, !tbaa !13    ; 2 uses
...
bb.y:                                             ; preds = %.noexc
  %i.ak = load ptr, ptr %i.a, align 8, !tbaa !41, !noalias !193
...
bb.aa:                                            ; preds = %.noexc65
  %i.an = load ptr, ptr %i.c, align 8, !tbaa !41, !noalias !194
...
_ZNK2cv11_InputArray6getMatEi.exit68:             ; preds = %bb.aa, %bb.ab
  ...
  %i.ap = load i32, ptr %i.ao, align 8, !tbaa !54 ; 6 uses
...
bb.ai:                                            ; preds = %bb.ag, %bb.ah
  ...
  %i.bi = load i32, ptr %13, align 8, !tbaa !33   ; 2 uses
...
bb.aj:                                            ; preds = %.preheader72.us, %bb.aj
  ...
  %20 = load ptr, ptr %i.bx, align 8, !tbaa !34
  %21 = load i64, ptr %i.by, align 8, !tbaa !23
  %22 = mul i64 %21, %indvars.iv79
  %23 = getelementptr inbounds nuw i8, ptr %20, i64 %22
  %24 = getelementptr inbounds i8, ptr %23, i64 %indvars.iv
  %25 = load ptr, ptr %i.bz, align 8, !tbaa !34
  %26 = load i64, ptr %i.ca, align 8, !tbaa !23
  ...
  %i.cd = load ptr, ptr %i.bx, align 8, !tbaa !34
  ...
  %i.ci = load ptr, ptr %i.bz, align 8, !tbaa !34
  %i.cj = load i64, ptr %i.ca, align 8, !tbaa !23
  ...
  br i1 %niter.ncmp.1.not, label %._crit_edge.us.unr-lcssa, label %bb.aj, !llvm.loop !190
...
.epil.preheader:                                  ; preds = %._crit_edge.us.unr-lcssa, %.preheader72.us
  ...
  %29 = load ptr, ptr %i.bx, align 8, !tbaa !34
  %30 = load i64, ptr %i.by, align 8, !tbaa !23
  %31 = mul i64 %30, %indvars.iv79
  %32 = getelementptr inbounds nuw i8, ptr %29, i64 %31
  %33 = getelementptr inbounds i8, ptr %32, i64 %indvars.iv.epil.init
  %34 = load ptr, ptr %i.bz, align 8, !tbaa !34
  %35 = load i64, ptr %i.ca, align 8, !tbaa !23
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.unr-lcssa, %.epil.preheader
  ...
  br i1 %exitcond.not, label %.preheader, label %.preheader72.us, !llvm.loop !191
...
.prol.loopexit.unr-lcssa:                         ; preds = %.lr.ph
  %i.ct = load ptr, ptr %i.cn, align 8, !tbaa !34 ; 2 uses
  %i.cu = load i64, ptr %i.co, align 8, !tbaa !23 ; 2 uses
...
.lr.ph.new:                                       ; preds = %.prol.loopexit, %.lr.ph.new
  ...
  %i.dg = load ptr, ptr %i.cn, align 8, !tbaa !34 ; 2 uses
  %i.dh = load i64, ptr %i.co, align 8, !tbaa !23 ; 2 uses
  ...
  %i.dn = load ptr, ptr %i.cn, align 8, !tbaa !34 ; 2 uses
  %i.do = load i64, ptr %i.co, align 8, !tbaa !23 ; 2 uses
  ...
  br i1 %exitcond86.not.1, label %._crit_edge, label %.lr.ph.new, !llvm.loop !192
...
._crit_edge:                                      ; preds = %.prol.loopexit, %.lr.ph.new, %.preheader
  ...
  %i.dv = load i32, ptr %i.du, align 8, !tbaa !26
...
bb.c:                                             ; preds = %bb.a
  ...
  store i32 33619968, ptr %5, align 8, !tbaa !60
  store ptr %0, ptr %i.f, align 8, !tbaa !41
