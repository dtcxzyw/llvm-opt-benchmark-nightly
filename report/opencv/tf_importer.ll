...
.body319.sink.split:                              ; preds = %bb.eu, %bb.du
  %.sink664 = phi ptr [ %i.pj, %bb.du ], [ %i.sj, %bb.eu ]
  %.pn130.ph = phi { ptr, i32 } [ %i.pi, %bb.du ], [ %i.si, %bb.eu ]
  %i.sl = load i64, ptr %i.ox, align 8, !tbaa !25
  %i.sm = add i64 %i.sl, 1
  call void @_ZdlPvm(ptr noundef %.sink664, i64 noundef %i.sm) #27
  br label %.body319
...
.lr.ph.i:                                         ; preds = %_ZN2cv10AutoBufferIlLm1EEC2Em.exit.i.thread, %_ZN2cv10AutoBufferIlLm1EEC2Em.exit.i
  ...
  %min.iters.check647 = icmp slt i32 %i.tq, 4
  br i1 %min.iters.check647, label %scalar.ph646.preheader, label %vector.ph648

vector.ph648:                                     ; preds = %.lr.ph.i
  %n.vec649 = and i64 %spec.select.i431, 2147483644 ; 4 uses
  %i.ua = shl nuw nsw i64 %n.vec649, 2
  %i.ub = getelementptr i8, ptr %i.tr, i64 %i.ua
  br label %vector.body650

vector.body650:                                   ; preds = %vector.body650, %vector.ph648
  %index651 = phi i64 [ 0, %vector.ph648 ], [ %index.next654, %vector.body650 ] ; 3 uses
  %i.uc = shl i64 %index651, 2
  %next.gep652 = getelementptr i8, ptr %i.tr, i64 %i.uc ; 2 uses
  %i.ud = getelementptr i8, ptr %next.gep652, i64 8
  %wide.load = load <2 x i32>, ptr %next.gep652, align 4, !tbaa !9, !noalias !879
  %wide.load653 = load <2 x i32>, ptr %i.ud, align 4, !tbaa !9, !noalias !879
  %i.ue = sext <2 x i32> %wide.load to <2 x i64>
  %i.uf = sext <2 x i32> %wide.load653 to <2 x i64>
  %i.ug = getelementptr inbounds nuw [8 x i8], ptr %i.tz, i64 %index651 ; 2 uses
  ...
  %index.next654 = add nuw i64 %index651, 4       ; 2 uses
  %i.ui = icmp eq i64 %index.next654, %n.vec649
  br i1 %i.ui, label %middle.block655, label %vector.body650, !llvm.loop !882

middle.block655:                                  ; preds = %vector.body650
  %cmp.n656 = icmp eq i64 %n.vec649, %spec.select.i431
  br i1 %cmp.n656, label %_ZN2cv3dnn14dnn5_v202606059DictValue8arrayIntIPiEES2_T_i.exit, label %scalar.ph646.preheader

scalar.ph646.preheader:                           ; preds = %.lr.ph.i, %middle.block655
  %indvars.iv.i.ph = phi i64 [ 0, %.lr.ph.i ], [ %n.vec649, %middle.block655 ]
  %.0910.i.ph = phi ptr [ %i.tr, %.lr.ph.i ], [ %i.ub, %middle.block655 ]
...
scalar.ph646:                                     ; preds = %scalar.ph646.preheader, %scalar.ph646
  %indvars.iv.i = phi i64 [ %indvars.iv.next.i, %scalar.ph646 ], [ %indvars.iv.i.ph, %scalar.ph646.preheader ] ; 2 uses
  %.0910.i = phi ptr [ %i.un, %scalar.ph646 ], [ %.0910.i.ph, %scalar.ph646.preheader ] ; 2 uses
  ...
  br i1 %exitcond.not.i, label %_ZN2cv3dnn14dnn5_v202606059DictValue8arrayIntIPiEES2_T_i.exit, label %scalar.ph646, !llvm.loop !883

_ZN2cv3dnn14dnn5_v202606059DictValue8arrayIntIPiEES2_T_i.exit: ; preds = %scalar.ph646, %middle.block655, %_ZN2cv10AutoBufferIlLm1EEC2Em.exit.i
