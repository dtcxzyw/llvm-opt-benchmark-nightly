...
.lr.ph77:                                         ; preds = %.lr.ph77.preheader, %.thread
  ...
  %.03775 = phi i64 [ %i.ep, %.thread ], [ 0, %.lr.ph77.preheader ] ; 7 uses
...
._crit_edge:                                      ; preds = %bb.k, %bb.j, %.lr.ph77
  %.034.lcssa = phi i64 [ %i.ep, %.lr.ph77 ], [ %.03471, %bb.j ], [ %i.eo, %bb.k ] ; 4 uses
...
.lr.ph.i.prol:                                    ; preds = %_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_.exit.i.i, %.lr.ph.i.prol
  %.011.i.prol = phi i64 [ %i.fj, %.lr.ph.i.prol ], [ %.03775, %_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_.exit.i.i ] ; 2 uses
...
.lr.ph.i.prol.loopexit:                           ; preds = %.lr.ph.i.prol, %_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_.exit.i.i
  %.011.i.unr = phi i64 [ %.03775, %_ZNSt6vectorIiSaIiEEC2EmRKiRKS0_.exit.i.i ], [ %i.fj, %.lr.ph.i.prol ]
