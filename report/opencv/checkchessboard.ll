...
.lr.ph:                                           ; preds = %.lr.ph77
  %i.er = getelementptr inbounds nuw [8 x i8], ptr %i.em, i64 %.03275
  %i.es = load float, ptr %i.er, align 4, !tbaa !67
  br label %bb.j

bb.j:                                             ; preds = %.lr.ph, %bb.k
  %.03771 = phi i64 [ %i.ep, %.lr.ph ], [ %i.ex, %bb.k ] ; 3 uses
  %i.et = getelementptr inbounds nuw [8 x i8], ptr %i.em, i64 %.03771
