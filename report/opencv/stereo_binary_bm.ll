...
bb.c:                                             ; preds = %bb.b
  ...
  %i.ao = load ptr, ptr %i.an, align 8, !tbaa !101 ; 20 uses
...
.lr.ph202.i:                                      ; preds = %.preheader172.i
  ...
  %scevgep43 = getelementptr i8, ptr %i.ao, i64 %.sroa.0.0.insert.ext.i.i
...
bb.k:                                             ; preds = %._crit_edge198.i, %.lr.ph202.i
  ...
  %scevgep42 = getelementptr i8, ptr %i.ao, i64 %i.gf
  %scevgep44.a = getelementptr i8, ptr %scevgep43, i64 %i.gf
  ...
  %i.gn = mul nsw i32 %i.gm, %i.ar
  %i.go = sext i32 %i.gn to i64
  %i.gp = getelementptr inbounds i8, ptr %i.ao, i64 %i.go ; 4 uses
