...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.pe = shufflevector <4 x float> %i.oy, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3> ; 2 uses
  %i.pf = shufflevector <4 x float> %i.oi, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3> ; 2 uses
  %i.pg = shufflevector <4 x float> %i.nc, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3> ; 2 uses
  ...
  %i.pn = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.mm, <8 x float> %i.pg, <8 x float> %i.pm)
  %i.po = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.ml, <8 x float> %i.pf, <8 x float> %i.pn)
  %i.pp = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.mk, <8 x float> %i.pe, <8 x float> %i.po)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.mg = insertelement <2 x double> %i.mf, double %i.me, i64 1
  %i.mh = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %i.lb
  %i.mi = shufflevector <2 x double> %i.mg, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  %i.mj = shufflevector <2 x double> %i.ly, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  %i.mk = shufflevector <2 x double> %i.li, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  ...
  %i.mt = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.kz, <4 x double> %i.mk, <4 x double> %i.ms)
  %i.mu = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.ky, <4 x double> %i.mj, <4 x double> %i.mt)
  %i.mv = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.kx, <4 x double> %i.mi, <4 x double> %i.mu)
