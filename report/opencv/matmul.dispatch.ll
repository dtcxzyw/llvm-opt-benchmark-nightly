...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %6 = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv231.i
  %7 = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv231.i
  %8 = getelementptr inbounds nuw i8, ptr %7, i64 4
  %9 = or disjoint i64 %indvars.iv231.i, 2        ; 2 uses
  %i.pv = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %9
  %i.pw = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %indvars.iv231.i
  %10 = getelementptr inbounds nuw i8, ptr %i.pw, i64 12
  %11 = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %indvars.iv231.i
  %i.px = load <8 x float>, ptr %2, align 4, !tbaa !22 ; 5 uses
  %12 = shufflevector <8 x float> %i.px, <8 x float> poison, <2 x i32> <i32 1, i32 6>
  %13 = shufflevector <8 x float> %i.px, <8 x float> poison, <2 x i32> <i32 0, i32 5>
  %14 = shufflevector <8 x float> %i.px, <8 x float> poison, <2 x i32> <i32 2, i32 7>
  %15 = load <2 x float>, ptr %i.kr, align 4, !tbaa !22 ; 2 uses
  %16 = shufflevector <8 x float> %i.px, <8 x float> poison, <2 x i32> <i32 3, i32 poison>
  %17 = shufflevector <2 x float> %16, <2 x float> %15, <2 x i32> <i32 0, i32 2>
  %18 = shufflevector <2 x float> %15, <2 x float> poison, <8 x i32> <i32 poison, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %19 = shufflevector <8 x float> %i.px, <8 x float> %18, <2 x i32> <i32 4, i32 9>
  %20 = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %9
  %21 = load float, ptr %8, align 4, !tbaa !22
  %22 = load float, ptr %6, align 4, !tbaa !22
  %23 = load float, ptr %i.pv, align 4, !tbaa !22
  %24 = load float, ptr %10, align 4, !tbaa !22
  ...
  %27 = fmul <2 x float> %26, %12
  %28 = insertelement <2 x float> poison, float %22, i64 0
  %29 = shufflevector <2 x float> %28, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.py = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %13, <2 x float> %29, <2 x float> %27)
  %30 = insertelement <2 x float> poison, float %23, i64 0
  %31 = shufflevector <2 x float> %30, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %32 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> %31, <2 x float> %i.py)
  %33 = insertelement <2 x float> poison, float %24, i64 0
  %34 = shufflevector <2 x float> %33, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %35 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %17, <2 x float> %34, <2 x float> %32)
  %36 = fadd <2 x float> %19, %35
  store <2 x float> %36, ptr %11, align 4, !tbaa !22
  ...
  %i.qb = fmul <2 x float> %26, %i.qa
  %i.qc = shufflevector <8 x float> %i.pz, <8 x float> poison, <2 x i32> <i32 0, i32 5>
  %i.qd = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.qc, <2 x float> %29, <2 x float> %i.qb)
  %i.qe = shufflevector <8 x float> %i.pz, <8 x float> poison, <2 x i32> <i32 2, i32 7>
  %i.qf = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.qe, <2 x float> %31, <2 x float> %i.qd)
  ...
  %i.qj = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.qi, <2 x float> %34, <2 x float> %i.qf)
  ...
  store <2 x float> %i.qm, ptr %20, align 4, !tbaa !22
