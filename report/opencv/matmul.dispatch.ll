...
vector.ph119:                                     ; preds = %vector.memcheck105
  ...
  %6 = shufflevector <4 x float> %broadcast.splatinsert125, <4 x float> %broadcast.splatinsert133, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
  ...
  %i.cg = shufflevector <4 x float> %broadcast.splatinsert129, <4 x float> %broadcast.splatinsert137, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
...
vector.body121:                                   ; preds = %vector.body121, %vector.ph119
  ...
  %8 = shufflevector <4 x float> %i.cw, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  ...
  %9 = shufflevector <4 x float> %i.ec, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.ed = fmul <4 x float> %i.dm, %broadcast.splat124
  %i.ee = fmul <4 x float> %i.dm, %broadcast.splat132
  %10 = shufflevector <4 x float> %i.ed, <4 x float> %i.ee, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %11 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %6, <8 x float> %8, <8 x float> %10)
  %12 = fmul <4 x float> %i.dm, %broadcast.splat140
  %13 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat142, <4 x float> %i.cw, <4 x float> %12)
  %14 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %broadcast.splat144, <4 x float> %i.ec, <4 x float> %13)
  %15 = fadd <4 x float> %broadcast.splat146, %14
  %16 = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.ch
  %i.ef = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %7, <8 x float> %9, <8 x float> %11)
  %i.eg = fadd <8 x float> %i.cg, %i.ef
  %i.eh = shufflevector <4 x float> %15, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  store <12 x float> %interleaved.vec147, ptr %16, align 4, !tbaa !22, !alias.scope !165, !noalias !166
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %17 = shufflevector <4 x float> %broadcast.splatinsert34, <4 x float> %broadcast.splatinsert44, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
  ...
  %18 = shufflevector <4 x float> %broadcast.splatinsert36, <4 x float> %broadcast.splatinsert46, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
  ...
  %20 = shufflevector <4 x float> %broadcast.splatinsert54, <4 x float> %broadcast.splatinsert64, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
  ...
  %21 = shufflevector <4 x float> %broadcast.splatinsert56, <4 x float> %broadcast.splatinsert66, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
  ...
  %i.lo = shufflevector <4 x float> %broadcast.splatinsert58, <4 x float> %broadcast.splatinsert70.a, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
  %22 = load float, ptr %i.km, align 4, !tbaa !22, !alias.scope !171
  %broadcast.splatinsert70 = insertelement <4 x float> poison, float %22, i64 0
  %i.lp = shufflevector <4 x float> %broadcast.splatinsert40, <4 x float> %broadcast.splatinsert50, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
  %i.lq = shufflevector <4 x float> %broadcast.splatinsert60, <4 x float> %broadcast.splatinsert70, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.mg = insertelement <4 x float> %i.mf, float %i.mc, i64 3
  %23 = shufflevector <4 x float> %i.mg, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3> ; 2 uses
  ...
  %i.nm = insertelement <4 x float> %i.nl, float %i.ni, i64 3
  %24 = shufflevector <4 x float> %i.nm, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3> ; 2 uses
  ...
  %i.oc = insertelement <4 x float> %i.ob, float %i.ny, i64 3
  %25 = shufflevector <4 x float> %i.oc, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3> ; 2 uses
  %i.od = fmul <4 x float> %i.mw, %broadcast.splat
  %i.oe = fmul <4 x float> %i.mw, %broadcast.splat43
  %i.of = shufflevector <4 x float> %i.od, <4 x float> %i.oe, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.og = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %17, <8 x float> %23, <8 x float> %i.of)
  %i.oh = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %18, <8 x float> %24, <8 x float> %i.og)
  %26 = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.lr
  %27 = fmul <4 x float> %i.mw, %broadcast.splat53
  %28 = fmul <4 x float> %i.mw, %broadcast.splat63
  %29 = shufflevector <4 x float> %27, <4 x float> %28, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %30 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %20, <8 x float> %23, <8 x float> %29)
  %31 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %21, <8 x float> %24, <8 x float> %30)
  %i.oi = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %19, <8 x float> %25, <8 x float> %i.oh)
  %32 = fadd <8 x float> %i.lp, %i.oi
  %i.oj = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.lo, <8 x float> %25, <8 x float> %31)
  %i.ok = fadd <8 x float> %i.lq, %i.oj
  %interleaved.vec = shufflevector <8 x float> %32, <8 x float> %i.ok, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
  store <16 x float> %interleaved.vec, ptr %26, align 4, !tbaa !22, !alias.scope !173, !noalias !174
...
vector.ph117:                                     ; preds = %vector.memcheck103
  ...
  %6 = shufflevector <2 x double> %broadcast.splatinsert123, <2 x double> %broadcast.splatinsert131, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  ...
  %i.cf = shufflevector <2 x double> %broadcast.splatinsert121, <2 x double> %broadcast.splatinsert129, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.cg = shufflevector <2 x double> %broadcast.splatinsert127, <2 x double> %broadcast.splatinsert135, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
...
vector.body119:                                   ; preds = %vector.body119, %vector.ph117
  ...
  %8 = shufflevector <2 x double> %i.co, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  ...
  %9 = shufflevector <2 x double> %i.de, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %10 = shufflevector <2 x double> %i.cw, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %11 = fmul <4 x double> %10, %i.cf
  %12 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %6, <4 x double> %8, <4 x double> %11)
  %13 = fmul <2 x double> %i.cw, %broadcast.splat138
  %14 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat140, <2 x double> %i.co, <2 x double> %13)
  %15 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %broadcast.splat142, <2 x double> %i.de, <2 x double> %14)
  %16 = fadd <2 x double> %broadcast.splat144, %15
  %17 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %i.ch
  %i.df = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %7, <4 x double> %9, <4 x double> %12)
  %i.dg = fadd <4 x double> %i.cg, %i.df
  %i.dh = shufflevector <2 x double> %16, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %interleaved.vec145 = shufflevector <4 x double> %i.dg, <4 x double> %i.dh, <6 x i32> <i32 0, i32 2, i32 4, i32 1, i32 3, i32 5>
  store <6 x double> %interleaved.vec145, ptr %17, align 8, !tbaa !29, !alias.scope !210, !noalias !211
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %18 = shufflevector <2 x double> %broadcast.splatinsert34, <2 x double> %broadcast.splatinsert44, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  ...
  %19 = shufflevector <2 x double> %broadcast.splatinsert36, <2 x double> %broadcast.splatinsert46, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  ...
  %21 = shufflevector <2 x double> %broadcast.splatinsert54, <2 x double> %broadcast.splatinsert64, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  ...
  %22 = shufflevector <2 x double> %broadcast.splatinsert56, <2 x double> %broadcast.splatinsert66, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.jt = load double, ptr %i.it, align 8, !tbaa !29, !alias.scope !216
  %broadcast.splatinsert70.a = insertelement <2 x double> poison, double %i.jt, i64 0
  %i.ju = shufflevector <2 x double> %broadcast.splatinsert58, <2 x double> %broadcast.splatinsert70.a, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %23 = load double, ptr %i.iu, align 8, !tbaa !29, !alias.scope !216
  %broadcast.splatinsert70 = insertelement <2 x double> poison, double %23, i64 0
  %i.jv = shufflevector <2 x double> %broadcast.splatinsert, <2 x double> %broadcast.splatinsert42, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.jw = shufflevector <2 x double> %broadcast.splatinsert52, <2 x double> %broadcast.splatinsert62, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.jx = shufflevector <2 x double> %broadcast.splatinsert40, <2 x double> %broadcast.splatinsert50, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %i.jy = shufflevector <2 x double> %broadcast.splatinsert60, <2 x double> %broadcast.splatinsert70, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %24 = shufflevector <2 x double> %i.kg, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  ...
  %25 = shufflevector <2 x double> %i.kw, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  ...
  %i.le = insertelement <2 x double> %i.ld, double %i.lc, i64 1
  %i.lf = shufflevector <2 x double> %i.le, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1> ; 2 uses
  %i.lg = shufflevector <2 x double> %i.ko, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %i.lh = fmul <4 x double> %i.lg, %i.jv
  %i.li = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %18, <4 x double> %24, <4 x double> %i.lh)
  %i.lj = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %19, <4 x double> %25, <4 x double> %i.li)
  %26 = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %i.jz
  %i.lk = shufflevector <2 x double> %i.ko, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 1>
  %27 = fmul <4 x double> %i.lk, %i.jw
  %28 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %21, <4 x double> %24, <4 x double> %27)
  %29 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %22, <4 x double> %25, <4 x double> %28)
  %i.ll = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %20, <4 x double> %i.lf, <4 x double> %i.lj)
  %30 = fadd <4 x double> %i.jx, %i.ll
  %i.lm = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.ju, <4 x double> %i.lf, <4 x double> %29)
  %i.ln = fadd <4 x double> %i.jy, %i.lm
  %interleaved.vec = shufflevector <4 x double> %30, <4 x double> %i.ln, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
  store <8 x double> %interleaved.vec, ptr %26, align 8, !tbaa !29, !alias.scope !218, !noalias !219
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %6 = shufflevector <4 x float> %broadcast.splatinsert, <4 x float> %broadcast.splatinsert26, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
  ...
  %broadcast.splatinsert36.a = insertelement <4 x float> poison, float %i.x, i64 0
  %i.y = shufflevector <4 x float> %broadcast.splatinsert30, <4 x float> %broadcast.splatinsert36.a, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
  %8 = load float, ptr %i.i, align 4, !tbaa !22, !alias.scope !265
  %broadcast.splatinsert36 = insertelement <4 x float> poison, float %8, i64 0
  %i.z = shufflevector <4 x float> %broadcast.splatinsert32, <4 x float> %broadcast.splatinsert36, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %9 = shufflevector <4 x float> %i.ap, <4 x float> %i.bf, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %i.cn = shufflevector <4 x float> %i.bw, <4 x float> %i.cm, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.co = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %6, <8 x float> %9, <8 x float> %7)
  %i.cp = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.y, <8 x float> %i.cn, <8 x float> %i.z)
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %6 = shufflevector <2 x double> %broadcast.splatinsert, <2 x double> %broadcast.splatinsert26, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  ...
  %broadcast.splatinsert36.a = insertelement <2 x double> poison, double %i.x, i64 0
  %i.y = shufflevector <2 x double> %broadcast.splatinsert30, <2 x double> %broadcast.splatinsert36.a, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %8 = load double, ptr %i.i, align 8, !tbaa !29, !alias.scope !297
  %broadcast.splatinsert36 = insertelement <2 x double> poison, double %8, i64 0
  %i.z = shufflevector <2 x double> %broadcast.splatinsert32, <2 x double> %broadcast.splatinsert36, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %9 = shufflevector <2 x double> %i.ah, <2 x double> %i.ap, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  ...
  %i.bh = shufflevector <2 x double> %i.ay, <2 x double> %i.bg, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.bi = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %6, <4 x double> %9, <4 x double> %7)
  %i.bj = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %i.y, <4 x double> %i.bh, <4 x double> %i.z)
