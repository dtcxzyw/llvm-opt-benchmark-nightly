...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %._crit_edge
  ...
  %i.ml = fpext float %i.mk to double             ; 8 uses
...
bb.bg:                                            ; preds = %.lr.ph, %bb.bw
  ...
  %i.mt = fpext float %i.ms to double             ; 8 uses
...
.noexc278:                                        ; preds = %bb.bi, %bb.bh
  ...
  %.sink27.i379 = fptrunc double %.sink27.in.i378 to float
  %43 = fptrunc double %.sink28.i377 to float
  %44 = fpext float %.sink27.i379 to double
  %45 = fpext float %43 to double
  %46 = fsub double %44, %i.mt                    ; 3 uses
  %47 = fsub double %45, %i.ml                    ; 3 uses
  %48 = fmul double %47, %47
  %i.oz = call double @llvm.fmuladd.f64(double %46, double %46, double %48)
...
bb.bj:                                            ; preds = %.noexc278
  ...
  %i.pf = shufflevector <2 x double> %49, <2 x double> poison, <2 x i32> zeroinitializer
...
.noexc279:                                        ; preds = %bb.bl, %bb.bk
  ...
  %52 = insertelement <2 x double> %i.mn, double %i.mt, i64 1 ; 2 uses
  %i.st = fsub <2 x double> %i.ss, %52            ; 5 uses
...
.noexc280:                                        ; preds = %bb.bo, %bb.bn
  ...
  %i.wu = fsub <2 x double> %i.wt, %52            ; 5 uses
