...
bb.c:                                             ; preds = %bb.b, %_ZNK2cv8internal14Matx_FastInvOpIdLi2ELi2EEclERKNS_4MatxIdLi2ELi2EEERS4_i.exit.i
  ...
  %.val = load double, ptr %i.ad, align 8, !tbaa !11
  %.val9 = load double, ptr %6, align 8, !tbaa !11
  %7 = insertelement <2 x double> poison, double %.val, i64 0
  %i.ae = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> zeroinitializer
  %i.af = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ab, <2 x double> %i.ae, <2 x double> zeroinitializer)
  %8 = insertelement <2 x double> poison, double %.val9, i64 0
  %9 = shufflevector <2 x double> %8, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ag = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ac, <2 x double> %9, <2 x double> %i.af)
...
bb.a:
  ...
  %i.l = load <2 x double>, ptr %i.g, align 8
  %.val4 = load double, ptr %2, align 8, !tbaa !11
  ...
  %3 = insertelement <2 x double> poison, double %.val4, i64 0
  %4 = shufflevector <2 x double> %3, <2 x double> poison, <2 x i32> zeroinitializer
  %i.q = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.p, <2 x double> %4, <2 x double> %i.o)
