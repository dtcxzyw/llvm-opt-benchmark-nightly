...
_ZNK2cv8MatShapeixEm.exit:                        ; preds = %bb.s
  ...
  %i.bo = load i32, ptr %i.bn, align 8, !tbaa !18
  store i32 %i.bo, ptr %i.f, align 4, !tbaa !18
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g) #16
  %i.bp = load i32, ptr %i.ae, align 4, !tbaa !69 ; 2 uses
...
bb.y:                                             ; preds = %bb.w
  %i.br = landingpad { ptr, i32 }
          cleanup
  %i.bs = load ptr, ptr %21, align 8, !tbaa !16   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i87: ; preds = %bb.y
  %i.bv = load i64, ptr %i.bt, align 8, !tbaa !17
  %i.bw = add i64 %i.bv, 1
...
_ZNK2cv8MatShapeixEm.exit90:                      ; preds = %_ZNK2cv8MatShapeixEm.exit
  ...
  store i32 %i.bz, ptr %i.g, align 4, !tbaa !18
  %i.ca = getelementptr inbounds nuw i8, ptr %3, i64 80
  %i.cb = load i32, ptr %i.ca, align 8, !tbaa !70
...
bb.ab:                                            ; preds = %bb.z
  %i.ck = landingpad { ptr, i32 }
          cleanup
  %i.cl = load ptr, ptr %19, align 8, !tbaa !16   ; 2 uses
...
_ZNK2cv8MatShapeixEm.exit96:                      ; preds = %_ZNK2cv8MatShapeixEm.exit90
  ...
  store i32 %i.cr, ptr %i.k, align 4, !tbaa !18
...
bb.ae:                                            ; preds = %bb.ac
  %i.cs = landingpad { ptr, i32 }
          cleanup
  %i.ct = load ptr, ptr %17, align 8, !tbaa !16   ; 2 uses
...
_ZNK2cv8MatShapeixEm.exit102:                     ; preds = %_ZNK2cv8MatShapeixEm.exit96
  ...
  %i.cz = load i32, ptr %i.cy, align 4, !tbaa !18 ; 4 uses
  store i32 %i.cz, ptr %i.l, align 4, !tbaa !18
...
bb.ah:                                            ; preds = %bb.af
  %i.db = landingpad { ptr, i32 }
          cleanup
  %i.dc = load ptr, ptr %15, align 8, !tbaa !16   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i105: ; preds = %bb.ah
  %i.df = load i64, ptr %i.dd, align 8, !tbaa !17
  %i.dg = add i64 %i.df, 1
...
_ZNK2cv8MatShapeixEm.exit108:                     ; preds = %_ZNK2cv8MatShapeixEm.exit102
  ...
  %i.di = load i32, ptr %i.dh, align 8, !tbaa !18
  store i32 %i.di, ptr %i.m, align 4, !tbaa !18
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.dy, align 4, !tbaa !18
  %wide.load291 = load <4 x i32>, ptr %i.dz, align 4, !tbaa !18
  ...
  %wide.load292 = load <4 x i32>, ptr %i.ec, align 8, !tbaa !18
  %wide.load293 = load <4 x i32>, ptr %i.ed, align 8, !tbaa !18
  ...
  br i1 %i.eg, label %middle.block, label %vector.body, !llvm.loop !45
...
middle.block:                                     ; preds = %vector.body
  ...
  store i32 %i.eh, ptr %i.n, align 4, !tbaa !18
  store i32 %i.ei, ptr %i.o, align 4, !tbaa !18
...
_ZNK2cv8MatShapeixEm.exit114:                     ; preds = %.lr.ph
  ...
  store i32 %i.eu, ptr %i.n, align 4, !tbaa !18
...
bb.an:                                            ; preds = %bb.al
  %i.ev = landingpad { ptr, i32 }
          cleanup
  %i.ew = load ptr, ptr %11, align 8, !tbaa !16   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i117: ; preds = %bb.an
  %i.ez = load i64, ptr %i.ex, align 8, !tbaa !17
  %i.fa = add i64 %i.ez, 1
...
_ZNK2cv8MatShapeixEm.exit120:                     ; preds = %_ZNK2cv8MatShapeixEm.exit114
  ...
  store i32 %i.fd, ptr %i.o, align 4, !tbaa !18
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond169.not = icmp eq i64 %indvars.iv.next, %wide.trip.count168
  br i1 %exitcond169.not, label %.lr.ph152, label %.lr.ph, !llvm.loop !46
...
.lr.ph152:                                        ; preds = %_ZNK2cv8MatShapeixEm.exit120
  ...
  store i32 1, ptr %i.fe, align 4, !tbaa !18
  %i.ff = getelementptr inbounds nuw i8, ptr %i.p, i64 4
  store i32 1, ptr %i.ff, align 4, !tbaa !18
  %i.fg = getelementptr inbounds nuw i8, ptr %i.q, i64 8
  store i32 1, ptr %i.fg, align 4, !tbaa !18
  %i.fh = getelementptr inbounds nuw i8, ptr %i.p, i64 8
  store i32 1, ptr %i.fh, align 4, !tbaa !18
...
vector.body300:                                   ; preds = %vector.body300, %vector.ph298
  ...
  %wide.load302 = load <4 x i32>, ptr %i.fs, align 8, !tbaa !18
  %wide.load303 = load <4 x i32>, ptr %i.ft, align 8, !tbaa !18
  ...
  store <4 x i32> %wide.load302, ptr %i.fw, align 4, !tbaa !18
  store <4 x i32> %wide.load303, ptr %i.fx, align 4, !tbaa !18
  %i.fy = getelementptr inbounds nuw [4 x i8], ptr %i.be, i64 %i.fr ; 2 uses
  %i.fz = getelementptr inbounds nuw i8, ptr %i.fy, i64 16
  %wide.load304 = load <4 x i32>, ptr %i.fy, align 4, !tbaa !18
  %wide.load305 = load <4 x i32>, ptr %i.fz, align 4, !tbaa !18
  %i.ga = getelementptr inbounds [4 x i8], ptr %i.q, i64 %i.fv ; 2 uses
  %i.gb = getelementptr inbounds nuw i8, ptr %i.ga, i64 16
  store <4 x i32> %wide.load304, ptr %i.ga, align 4, !tbaa !18
  store <4 x i32> %wide.load305, ptr %i.gb, align 4, !tbaa !18
  %index.next306 = add nuw i64 %index301, 8       ; 2 uses
  %i.gc = icmp eq i64 %index.next306, %n.vec299
  br i1 %i.gc, label %scalar.ph296.preheader, label %vector.body300, !llvm.loop !47
...
.lr.ph.i.i.i.i.i.i.i.i.i:                         ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i, %bb.aq
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(12) %.06.i.i.i.i.i.i.i.i.i, ptr noundef nonnull align 4 dereferenceable(12) %i.gg, i64 12, i1 false), !tbaa.struct !74
  %i.gn = getelementptr inbounds nuw i8, ptr %.06.i.i.i.i.i.i.i.i.i, i64 12 ; 2 uses
  %.not.i.i.i.i.i.i.i.i.i = icmp eq ptr %i.gn, %i.gm
  br i1 %.not.i.i.i.i.i.i.i.i.i, label %.loopexit, label %.lr.ph.i.i.i.i.i.i.i.i.i, !llvm.loop !48
...
bb.at:                                            ; preds = %bb.ar
  %i.go = landingpad { ptr, i32 }
          cleanup
  %i.gp = load ptr, ptr %9, align 8, !tbaa !16    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i124: ; preds = %bb.at
  %i.gs = load i64, ptr %i.gq, align 8, !tbaa !17
  %i.gt = add i64 %i.gs, 1
...
_ZNK2cv8MatShapeixEm.exit127:                     ; preds = %scalar.ph296
  ...
  store i32 %i.gw, ptr %i.gz, align 4, !tbaa !18
  ...
  store i32 %i.hb, ptr %i.hc, align 4, !tbaa !18
  ...
  br i1 %exitcond184.not, label %._crit_edge153, label %scalar.ph296, !llvm.loop !49
...
.loopexit:                                        ; preds = %.lr.ph.i.i.i.i.i.i.i.i.i, %_ZNSt6vectorISt5arrayIiLm3EESaIS1_EE17_S_check_init_lenEmRKS2_.exit.i, %.noexc121
  ...
  store ptr %.0.i.i.i.i.i, ptr %i.he, align 8, !tbaa !75
  %i.hf = load i32, ptr %i.l, align 4, !tbaa !18  ; 2 uses
...
.lr.ph161:                                        ; preds = %.loopexit
  ...
  %i.hi = load i32, ptr %i.c, align 4, !tbaa !18  ; 2 uses
...
._crit_edge162:                                   ; preds = %._crit_edge158, %.lr.ph161, %.loopexit
  ...
  store ptr %4, ptr %i.r, align 8, !tbaa !25
  call void @llvm.lifetime.start.p0(ptr nonnull %i.s) #16
  store ptr %6, ptr %i.s, align 8, !tbaa !25
  %i.hm = load i32, ptr %i.g, align 4, !tbaa !18
  ...
  store i32 %i.hn, ptr %i.ho, align 4, !tbaa !76
...
bb.au:                                            ; preds = %._crit_edge162
  %i.hr = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.hs = load ptr, ptr %i.hp, align 8, !tbaa !29 ; 2 uses
