...
.lr.ph792:                                        ; preds = %.lr.ph792.preheader, %.lr.ph792
  ...
  %i.iz = getelementptr inbounds nuw i8, ptr %4, i64 %.idx631 ; 4 uses
  ...
  %14 = getelementptr inbounds i8, ptr %i.jc, i64 %.idx632 ; 5 uses
  %i.jd = getelementptr inbounds nuw i8, ptr %14, i64 12
  %i.je = getelementptr inbounds nuw i8, ptr %i.iz, i64 4
  %i.jf = getelementptr inbounds nuw [4 x i8], ptr %14, i64 %i.co ; 4 uses
  %15 = getelementptr inbounds nuw i8, ptr %i.iz, i64 8
  %16 = getelementptr inbounds nuw i8, ptr %i.jf, i64 12
  %i.jg = getelementptr inbounds nuw i8, ptr %i.iz, i64 12
  %i.jh = getelementptr inbounds nuw i8, ptr %14, i64 8
  %i.ji = load float, ptr %i.jh, align 4, !tbaa !52
  %i.jj = getelementptr inbounds nuw i8, ptr %14, i64 20
  ...
  %17 = load float, ptr %i.jn, align 4, !tbaa !52
  %18 = load float, ptr %i.je, align 4, !tbaa !52 ; 2 uses
  %i.jo = load float, ptr %i.iz, align 4, !tbaa !52 ; 2 uses
  %19 = load float, ptr %15, align 4, !tbaa !52   ; 2 uses
  %20 = load float, ptr %i.jg, align 4, !tbaa !52 ; 2 uses
  %i.jp = load <2 x float>, ptr %14, align 4, !tbaa !52
  %21 = load <2 x float>, ptr %i.jd, align 4, !tbaa !52
  %22 = insertelement <2 x float> poison, float %18, i64 0
  %i.jq = shufflevector <2 x float> %22, <2 x float> poison, <2 x i32> zeroinitializer
  %23 = fmul <2 x float> %i.jq, %21
  %24 = insertelement <2 x float> poison, float %i.jo, i64 0
  %25 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
  %i.jr = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.jp, <2 x float> %25, <2 x float> %23)
  %i.js = load <2 x float>, ptr %i.jf, align 4, !tbaa !52
  %26 = insertelement <2 x float> poison, float %19, i64 0
  %27 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
  %i.jt = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.js, <2 x float> %27, <2 x float> %i.jr)
  %28 = load <2 x float>, ptr %16, align 4, !tbaa !52
  %29 = insertelement <2 x float> poison, float %20, i64 0
  %30 = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> zeroinitializer
  %31 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %28, <2 x float> %30, <2 x float> %i.jt)
  %32 = fmul float %18, %i.jk
  %i.ju = tail call float @llvm.fmuladd.f32(float %i.ji, float %i.jo, float %32)
  %33 = tail call float @llvm.fmuladd.f32(float %i.jm, float %19, float %i.ju)
  %i.jv = tail call float @llvm.fmuladd.f32(float %17, float %20, float %33)
  store <2 x float> %31, ptr %.3588791, align 4, !tbaa !52
...
.lr.ph820:                                        ; preds = %.lr.ph820.preheader, %.lr.ph820
  ...
  %i.jx = getelementptr inbounds nuw i8, ptr %4, i64 %.idx660 ; 4 uses
  ...
  %14 = getelementptr inbounds nuw i8, ptr %i.kd, i64 12
  %i.ke = getelementptr inbounds nuw i8, ptr %i.jx, i64 4
  %i.kf = getelementptr inbounds nuw [4 x i8], ptr %i.kd, i64 %i.co ; 4 uses
  %15 = getelementptr inbounds nuw i8, ptr %i.jx, i64 8
  %16 = getelementptr inbounds nuw i8, ptr %i.kf, i64 12
  %i.kg = getelementptr inbounds nuw i8, ptr %i.jx, i64 12
  ...
  %17 = load float, ptr %i.kn, align 4, !tbaa !52
  %18 = load float, ptr %i.ke, align 4, !tbaa !52 ; 2 uses
  %i.ko = load float, ptr %i.jx, align 4, !tbaa !52 ; 2 uses
  %19 = load float, ptr %15, align 4, !tbaa !52   ; 2 uses
  %20 = load float, ptr %i.kg, align 4, !tbaa !52 ; 2 uses
  %i.kp = load <2 x float>, ptr %i.kd, align 4, !tbaa !52
  %21 = load <2 x float>, ptr %14, align 4, !tbaa !52
  %22 = insertelement <2 x float> poison, float %18, i64 0
  %i.kq = shufflevector <2 x float> %22, <2 x float> poison, <2 x i32> zeroinitializer
  %23 = fmul <2 x float> %i.kq, %21
  %24 = insertelement <2 x float> poison, float %i.ko, i64 0
  %25 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
  %i.kr = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.kp, <2 x float> %25, <2 x float> %23)
  %i.ks = load <2 x float>, ptr %i.kf, align 4, !tbaa !52
  %26 = insertelement <2 x float> poison, float %19, i64 0
  %27 = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
  %i.kt = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ks, <2 x float> %27, <2 x float> %i.kr)
  %28 = load <2 x float>, ptr %16, align 4, !tbaa !52
  %29 = insertelement <2 x float> poison, float %20, i64 0
  %30 = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> zeroinitializer
  %31 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %28, <2 x float> %30, <2 x float> %i.kt)
  %32 = fmul float %18, %i.kk
  %i.ku = tail call float @llvm.fmuladd.f32(float %i.ki, float %i.ko, float %32)
  %33 = tail call float @llvm.fmuladd.f32(float %i.km, float %19, float %i.ku)
  %i.kv = tail call float @llvm.fmuladd.f32(float %17, float %20, float %33)
  store <2 x float> %31, ptr %.3617819, align 4, !tbaa !52
