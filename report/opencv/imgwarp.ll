...
.lr.ph.i:                                         ; preds = %bb.e
  ...
  %i.ab = insertelement <4 x float> <float 1.000000e+00, float 1.000000e+00, float poison, float 1.000000e+00>, float %i.d, i64 2 ; 2 uses
  ...
  %10 = shufflevector <4 x float> %i.ab, <4 x float> <float poison, float poison, float 1.000000e+00, float poison>, <4 x i32> <i32 2, i32 2, i32 6, i32 2> ; 2 uses
  br label %bb.f
...
_ZN2cv12cpu_baseline12_GLOBAL__N_113bicubicCoeffsEffmNS_5Size_IiEEifiRiS4_S4_RfS5_S5_S5_S5_S5_S5_S5_.exit.i: ; preds = %bb.g, %bb.f
  ...
  %i.bt = fmul <4 x float> %10, %i.br
  %i.bu = fsub <4 x float> %10, %i.br
...
_ZN2cv12cpu_baseline12_GLOBAL__N_113bicubicCoeffsEffmNS_5Size_IiEEifiRiS4_S4_RfS5_S5_S5_S5_S5_S5_S5_.exit.i: ; preds = %bb.g, %bb.f
  ...
  %i.ca = fmul float %i.bw, %i.bx                 ; 2 uses
  %i.cb = fmul float %i.bv, %i.bz                 ; 2 uses
  ...
  %i.ce = insertelement <2 x float> %i.cd, float %i.ca, i64 1 ; 2 uses
  %i.cf = fsub <2 x float> splat (float 1.000000e+00), %i.ce
  %i.cg = fsub <2 x float> %i.cf, %i.cc
  %i.ch = insertelement <2 x float> %i.bs, float %i.cb, i64 1 ; 2 uses
...
.preheader.preheader.i:                           ; preds = %_ZN2cv12cpu_baseline12_GLOBAL__N_113bicubicCoeffsEffmNS_5Size_IiEEifiRiS4_S4_RfS5_S5_S5_S5_S5_S5_S5_.exit.i
  ...
  %10 = shufflevector <2 x float> %i.ce, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.kd = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.kc, <2 x float> %10, <2 x float> zeroinitializer)
  ...
  %11 = shufflevector <2 x float> %i.ch, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.lg = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.lf, <2 x float> %11, <2 x float> %i.kx)
...
_ZN2cv12cpu_baseline12_GLOBAL__N_113bicubicCoeffsEffmNS_5Size_IiEEifiRiS4_S4_RfS5_S5_S5_S5_S5_S5_S5_.exit.i: ; preds = %bb.g, %bb.f
  ...
  %i.bz = fmul float %i.bs, %i.bx                 ; 4 uses
  %i.ca = fmul float %i.bt, %i.by                 ; 4 uses
  ...
  %i.cm = insertelement <2 x float> %i.cl, float %i.bz, i64 1 ; 2 uses
  %i.cn = fsub <2 x float> splat (float 1.000000e+00), %i.cm
  %i.co = fsub <2 x float> %i.cn, %i.ck
  %i.cp = insertelement <2 x float> %i.ch, float %i.ca, i64 1 ; 2 uses
...
bb.h:                                             ; preds = %_ZN2cv12cpu_baseline12_GLOBAL__N_113bicubicCoeffsEffmNS_5Size_IiEEifiRiS4_S4_RfS5_S5_S5_S5_S5_S5_S5_.exit.i
  ...
  %10 = shufflevector <2 x float> %i.cm, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.hh = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hg, <2 x float> %10, <2 x float> zeroinitializer)
  ...
  %11 = shufflevector <2 x float> %i.cp, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.iw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.iv, <2 x float> %11, <2 x float> %i.ij)
...
_ZN2cv12cpu_baseline12_GLOBAL__N_113bicubicCoeffsEffmNS_5Size_IiEEifiRiS4_S4_RfS5_S5_S5_S5_S5_S5_S5_.exit.i: ; preds = %bb.g, %bb.f
  ...
  %i.cd = fmul <2 x float> %i.ca, %i.cc           ; 8 uses
  ...
  %i.cj = insertelement <2 x float> poison, float %i.cg, i64 0 ; 4 uses
  ...
  %i.cn = insertelement <2 x float> poison, float %i.ch, i64 0 ; 3 uses
...
bb.h:                                             ; preds = %_ZN2cv12cpu_baseline12_GLOBAL__N_113bicubicCoeffsEffmNS_5Size_IiEEifiRiS4_S4_RfS5_S5_S5_S5_S5_S5_S5_.exit.i
  ...
  %i.ek = shufflevector <2 x float> %i.cj, <2 x float> poison, <2 x i32> zeroinitializer ; 4 uses
  ...
  %i.eo = shufflevector <2 x float> %i.cn, <2 x float> poison, <2 x i32> zeroinitializer ; 4 uses
  %i.ep = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.eh, <2 x float> %i.eo, <2 x float> %i.en)
  %i.eq = shufflevector <2 x float> %i.cd, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.gg = shufflevector <2 x float> %i.cd, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  ...
  %10 = shufflevector <2 x float> %i.cj, <2 x float> poison, <2 x i32> zeroinitializer ; 4 uses
  %i.gt = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.gl, <2 x float> %10, <2 x float> %i.gs)
  %i.gu = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.gp, <2 x float> %i.em, <2 x float> %i.gt)
  %11 = shufflevector <2 x float> %i.cn, <2 x float> poison, <2 x i32> zeroinitializer ; 4 uses
  %i.gv = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.gr, <2 x float> %11, <2 x float> %i.gu)
  %12 = shufflevector <2 x float> %i.cd, <2 x float> poison, <2 x i32> zeroinitializer
  %i.gw = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.gv, <2 x float> %12, <2 x float> zeroinitializer)
  ...
  %i.hg = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.gy, <2 x float> %10, <2 x float> %i.hf)
  %i.hh = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hc, <2 x float> %i.em, <2 x float> %i.hg)
  %i.hi = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.he, <2 x float> %11, <2 x float> %i.hh)
  ...
  %i.ht = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hl, <2 x float> %10, <2 x float> %i.hs)
  %i.hu = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hp, <2 x float> %i.em, <2 x float> %i.ht)
  %i.hv = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hr, <2 x float> %11, <2 x float> %i.hu)
  ...
  %i.ig = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.hy, <2 x float> %10, <2 x float> %i.if)
  %i.ih = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ic, <2 x float> %i.em, <2 x float> %i.ig)
  %i.ii = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ie, <2 x float> %11, <2 x float> %i.ih)
  %13 = shufflevector <2 x float> %i.cd, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ij = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ii, <2 x float> %13, <2 x float> %i.hw)
