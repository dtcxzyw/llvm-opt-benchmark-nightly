...
_ZN2cv12cpu_baseline12_GLOBAL__N_113bicubicCoeffsEffmNS_5Size_IiEEifiRiS4_S4_RfS5_S5_S5_S5_S5_S5_S5_.exit.i: ; preds = %bb.g, %bb.f
  ...
  %i.cc = fmul float %i.cb, %i.ca                 ; 3 uses
  %i.cd = fmul float %i.d, %i.by
  %i.ce = fmul float %i.bz, %i.cd                 ; 3 uses
  %i.cf = tail call float @llvm.fmuladd.f32(float %i.u, float %i.aw, float %i.w)
  %i.cg = tail call float @llvm.fmuladd.f32(float %i.by, float %i.cf, float 1.000000e+00) ; 3 uses
  %i.ch = fsub float 1.000000e+00, %i.cc
  %i.ci = fsub float %i.ch, %i.cg
  %i.cj = fsub float %i.ci, %i.ce                 ; 2 uses
...
bb.h:                                             ; preds = %_ZN2cv12cpu_baseline12_GLOBAL__N_113bicubicCoeffsEffmNS_5Size_IiEEifiRiS4_S4_RfS5_S5_S5_S5_S5_S5_S5_.exit.i
  ...
  %i.if = extractelement <2 x float> %i.ie, i64 1
  %10 = shufflevector <2 x float> %i.ds, <2 x float> %i.ek, <2 x i32> <i32 1, i32 2>
  %11 = insertelement <2 x float> poison, float %i.cc, i64 0
  %12 = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> zeroinitializer
  %13 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %10, <2 x float> %12, <2 x float> zeroinitializer)
  %14 = shufflevector <2 x float> %i.fe, <2 x float> %i.fw, <2 x i32> <i32 0, i32 2>
  ...
  %18 = shufflevector <2 x float> %i.gq, <2 x float> %i.hi, <2 x i32> <i32 0, i32 2>
  %19 = insertelement <2 x float> poison, float %i.cj, i64 0
  %20 = shufflevector <2 x float> %19, <2 x float> poison, <2 x i32> zeroinitializer
  %21 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %18, <2 x float> %20, <2 x float> %17)
  %i.ig = tail call float @llvm.fmuladd.f32(float %i.hp, float %i.bx, float %i.if)
  %i.ih = tail call float @llvm.fmuladd.f32(float %i.hs, float %i.bs, float %i.ig)
  %22 = insertelement <2 x float> %i.ie, float %i.ih, i64 1
  %23 = insertelement <2 x float> poison, float %i.ce, i64 0
  %24 = shufflevector <2 x float> %23, <2 x float> poison, <2 x i32> zeroinitializer
  %25 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %22, <2 x float> %24, <2 x float> %21)
  %26 = fpext <2 x float> %25 to <2 x double>     ; 2 uses
  %27 = extractelement <2 x double> %26, i64 0
  store double %27, ptr %.0136297.i, align 8, !tbaa !70
...
.sink.split.i:                                    ; preds = %.preheader.preheader.i, %bb.i, %bb.h
  %.sink.i = phi double [ %28, %bb.h ], [ %i.kz, %.preheader.preheader.i ], [ %.sroa.5.0.i, %bb.i ]
