...
.lr.ph:                                           ; preds = %_ZN2cvL14writeDecNumberEiiRSt6vectorIhSaIhEE.exit50, %_ZN2cvL14writeDecNumberEiiRSt6vectorIhSaIhEE.exit60
  ...
  %i.aw = load ptr, ptr %1, align 8, !tbaa !22    ; 2 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 %indvars.iv
  %i.ay = load i8, ptr %i.ax, align 1, !tbaa !16  ; 4 uses
...
_ZN2cvL9mapSymbolEc.exit:                         ; preds = %bb.e, %switch.lookup, %bb.b, %bb.d
  ...
  %i.bh = load i8, ptr %i.bg, align 1, !tbaa !16  ; 4 uses
...
.critedge:                                        ; preds = %_ZN2cvL9mapSymbolEc.exit54
  ...
  store <8 x i8> %i.bz, ptr %i.bu, align 1, !tbaa !16
  ...
  store i8 %i.ci, ptr %i.bs, align 1, !tbaa !16
  %i.cj = load ptr, ptr %i.c, align 8, !tbaa !95
  %i.ck = load ptr, ptr %2, align 8, !tbaa !95    ; 2 uses
...
bb.j:                                             ; preds = %.critedge42
  %i.cs = load ptr, ptr %1, align 8, !tbaa !22, !noalias !174
  %i.ct = load i64, ptr %i.n, align 8, !tbaa !25, !noalias !174
  %i.cu = getelementptr inbounds nuw i8, ptr %i.cs, i64 %i.ct
  %i.cv = getelementptr inbounds i8, ptr %i.cu, i64 -1
  %i.cw = load i8, ptr %i.cv, align 1, !tbaa !16  ; 4 uses
