...
.lr.ph380.preheader.i.i.i:                        ; preds = %.preheader377.i.i.i, %bb.bq
  ...
  %scevgep.i.i.i = getelementptr i8, ptr %i.a, i64 %i.oi
  %narrow.i.i.i = sub nuw nsw i32 32, %i.oh
  %i.oj = zext nneg i32 %narrow.i.i.i to i64      ; 3 uses
  call void @llvm.memset.p0.i64(ptr align 4 %scevgep.i.i.i, i8 0, i64 %i.oj, i1 false), !tbaa !89
  %scevgep444.i.i.i = getelementptr i8, ptr %i.b, i64 %i.oi
  call void @llvm.memset.p0.i64(ptr align 4 %scevgep444.i.i.i, i8 0, i64 %i.oj, i1 false), !tbaa !89
  %scevgep445.i.i.i = getelementptr i8, ptr %i.c, i64 %i.oi
  call void @llvm.memset.p0.i64(ptr align 4 %scevgep445.i.i.i, i8 0, i64 %i.oj, i1 false), !tbaa !89
...
bb.a:
  ...
  %i.ah = load i32, ptr %1, align 4, !tbaa !37    ; 16 uses
...
.lr.ph.i.i.i:                                     ; preds = %bb.a
  ...
  %i.bn = shl i64 %i.bm, 1
  %2 = mul i32 %i.ad, %i.ah                       ; 2 uses
  %3 = sub i32 %i.ao, %2                          ; 2 uses
...
bb.b:                                             ; preds = %_ZN2cv3dnn14dnn5_v20260605L27repackDepthwiseWeightsBlockIffEEvPKT_PT0_iii.exit.i.i.i, %.lr.ph.i.i.i
  ...
  %i.di = mul nsw i64 %i.aa, %i.dh                ; 2 uses
  %i.dj = mul i32 %i.ad, %indvar
  %i.dk = sub i32 %4, %i.dj
  ...
  %i.dq = mul nsw i64 %i.p, %i.dp                 ; 2 uses
  %i.dr = mul i32 %i.bz, %indvar
  %i.ds = add i32 %i.by, %i.dr
  %i.dt = sext i32 %i.ds to i64
  %i.du = mul nsw i64 %i.aa, %i.dt                ; 2 uses
  ...
  %i.ed = mul nsw i64 %i.p, %i.ec                 ; 2 uses
  %i.ee = mul i32 %i.br, %indvar
  %i.ef = add i32 %i.bq, %i.ee
  %i.eg = sext i32 %i.ef to i64
  %i.eh = mul nsw i64 %i.aa, %i.eg                ; 2 uses
  ...
  %i.eq = mul nsw i64 %i.p, %i.ep                 ; 2 uses
  %i.er = mul i32 %i.ad, %indvar
  %i.es = sub i32 %3, %i.er
  ...
  %i.ex = mul nsw i64 %i.aa, %i.ew                ; 2 uses
  %i.ey = mul i32 %i.ad, %indvar
  %i.ez = sub i32 %3, %i.ey
  ...
  %i.ff = mul nsw i64 %i.p, %i.fe                 ; 2 uses
  %i.fg = mul i32 %i.bb, %indvar
  %i.fh = add i32 %i.ba, %i.fg
  %i.fi = sext i32 %i.fh to i64
  %i.fj = mul nsw i64 %i.aa, %i.fi                ; 2 uses
  ...
  %i.fs = mul nsw i64 %i.p, %i.fr                 ; 2 uses
