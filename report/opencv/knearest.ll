...
._crit_edge262:                                   ; preds = %.lr.ph261.prol.loopexit, %.lr.ph261, %.preheader248
  %.1214.lcssa = phi float [ %.0213.lcssa, %.preheader248 ], [ %.lcssa451.unr, %.lr.ph261.prol.loopexit ], [ %i.ea, %.lr.ph261 ] ; 2 uses
  %i.ed = bitcast float %.1214.lcssa to i32
...
.lr.ph266:                                        ; preds = %._crit_edge262, %bb.d
  %.3264 = phi i32 [ %i.el, %bb.d ], [ %2, %._crit_edge262 ] ; 4 uses
  %i.eh = zext nneg i32 %.3264 to i64
...
bb.d:                                             ; preds = %.lr.ph266
  %i.el = add nsw i32 %.3264, -1
  %i.em = icmp sgt i32 %.3264, 1
