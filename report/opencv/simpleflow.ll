...
begin_hunk_0_@_ZN2cv7optflowL24selectPointsToRecalcFlowERKNS_3MatEifiiS3_RS1_S4_:bb.a
  %i.bl = getelementptr inbounds nuw [8 x i8], ptr %i.al, i64 %indvars.iv118.i ; 2 uses
  %.val.us.us91.i = load float, ptr %invariant.gep.i, align 4, !tbaa !67
  %.val52.us.us92.i = load float, ptr %i.am, align 4, !tbaa !67
  %.val53.us.us93.i = load float, ptr %i.bl, align 4, !tbaa !67
  %i.bm = getelementptr i8, ptr %i.bl, i64 4
  %.val54.us.us94.i = load float, ptr %i.bm, align 4, !tbaa !67
  %i.bn = fsub float %.val.us.us91.i, %.val53.us.us93.i ; 2 uses
  %i.bo = fsub float %.val52.us.us92.i, %.val54.us.us94.i ; 2 uses
  %i.bp = fmul float %i.bo, %i.bo
  %i.bq = call noundef float @llvm.fmuladd.f32(float %i.bn, float %i.bn, float %i.bp) ; 2 uses
  %i.br = load i64, ptr %i.v, align 8, !alias.scope !145
  %i.bs = mul i64 %i.br, %indvars.iv128.i
  %gep85.us.us.i = getelementptr i8, ptr %invariant.gep84.i, i64 %i.bs ; 2 uses
  %i.bt = load float, ptr %gep85.us.us.i, align 4, !tbaa !67
  %i.bu = fcmp ogt float %i.bq, %i.bt
  br i1 %i.bu, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  store float %i.bq, ptr %gep85.us.us.i, align 4, !tbaa !67
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %bb.h
  %indvars.iv.next119.i = add nuw nsw i64 %indvars.iv118.i, 1
  %.not50.us.us95.not.i = icmp samesign ult i64 %indvars.iv118.i, %i.an
  br i1 %.not50.us.us95.not.i, label %bb.h, label %._crit_edge.split.us.split.us96.i, !llvm.loop !130
...
._crit_edge.split.us.split.us96.i:                ; preds = %bb.j
  ...
  br i1 %.not.us.not.i, label %.preheader.us.i, label %._crit_edge89.split.i, !llvm.loop !131
...
._crit_edge89.split.i:                            ; preds = %._crit_edge.split.i.split, %._crit_edge.split.i.split.us.us, %._crit_edge.split.us.split.us96.i, %._crit_edge.split.us.split.us.us.us.i, %.preheader.lr.ph.i
  ...
  br i1 %exitcond.not.i, label %._crit_edge.split101.i, label %.preheader.lr.ph.i, !llvm.loop !132

._crit_edge.split.i.split:                        ; preds = %bb.m
  %indvars.iv.next115.i = add nuw nsw i64 %indvars.iv114.i, 1
  %.not.not.i = icmp samesign ult i64 %indvars.iv114.i, %i.ab
  br i1 %.not.not.i, label %.preheader.i, label %._crit_edge89.split.i, !llvm.loop !131

bb.k:                                             ; preds = %bb.m, %.preheader.i
  %indvars.iv108.i = phi i64 [ %i.af, %.preheader.i ], [ %indvars.iv.next109.i, %bb.m ] ; 3 uses
  %i.bw = load i64, ptr %i.s, align 8, !noalias !145 ; 2 uses
  ...
  %.val.i = load float, ptr %gep.i, align 4, !tbaa !67
  %i.ca = getelementptr i8, ptr %gep.i, i64 4
  %.val52.i = load float, ptr %i.ca, align 4, !tbaa !67
  %.val53.i = load float, ptr %i.bz, align 4, !tbaa !67
  %i.cb = getelementptr i8, ptr %i.bz, i64 4
  %.val54.i = load float, ptr %i.cb, align 4, !tbaa !67
...
bb.n:                                             ; preds = %_ZN2cv7optflowL19calcIrregularityMatERKNS_3MatEi.exit
  ...
  %i.cl = load ptr, ptr %10, align 8, !tbaa !37, !noalias !147 ; 2 uses
...
bb.o:                                             ; preds = %_ZNK2cv7MatExprcvNS_3MatEEv.exit
  ...
  %i.ct = load ptr, ptr %13, align 8, !tbaa !37, !noalias !148 ; 2 uses
...
bb.p:                                             ; preds = %_ZNK2cv7MatExprcvNS_3MatEEv.exit180
  %i.db = load ptr, ptr %14, align 8, !tbaa !37   ; 2 uses
  ...
  invoke void %i.de(ptr noundef nonnull align 8 dereferenceable(8) %i.db, ptr noundef nonnull align 8 dereferenceable(688) %14, ptr noundef nonnull align 8 dereferenceable(208) %6, i32 noundef -1)
          to label %_ZN2cv3MataSERKNS_7MatExprE.exit unwind label %bb.w, !inline_history !1
...
bb.q:                                             ; preds = %_ZN2cv3MataSERKNS_7MatExprE.exit
  %i.di = load ptr, ptr %15, align 8, !tbaa !37   ; 2 uses
  ...
  invoke void %i.dl(ptr noundef nonnull align 8 dereferenceable(8) %i.di, ptr noundef nonnull align 8 dereferenceable(688) %15, ptr noundef nonnull align 8 dereferenceable(208) %7, i32 noundef -1)
          to label %_ZN2cv3MataSERKNS_7MatExprE.exit181 unwind label %bb.z, !inline_history !1
...
_ZN2cv3MataSERKNS_7MatExprE.exit181:              ; preds = %bb.q
  ...
  %i.dq = load i32, ptr %i.dp, align 8, !tbaa !43 ; 2 uses
...
.preheader244.lr.ph:                              ; preds = %_ZN2cv3MataSERKNS_7MatExprE.exit181
  ...
  %i.eg = getelementptr inbounds nuw i8, ptr %7, i64 4 ; 11 uses
  %i.eh = getelementptr inbounds nuw i8, ptr %7, i64 24 ; 11 uses
  %i.ei = getelementptr inbounds nuw i8, ptr %7, i64 128 ; 11 uses
  %i.ej = getelementptr inbounds nuw i8, ptr %6, i64 4 ; 3 uses
  %i.ek = getelementptr inbounds nuw i8, ptr %6, i64 24 ; 3 uses
  %i.el = getelementptr inbounds nuw i8, ptr %6, i64 128 ; 3 uses
  %i.em = load i32, ptr %i.ds, align 4, !tbaa !44 ; 2 uses
...
.preheader244:                                    ; preds = %.preheader244.preheader, %._crit_edge272
  ...
  %indvars.iv297 = phi i32 [ -1, %.preheader244.preheader ], [ %indvars.iv.next298, %._crit_edge272 ] ; 3 uses
  %indvars.iv289.a = phi i64 [ 0, %.preheader244.preheader ], [ %indvars.iv.next301, %._crit_edge272 ] ; 3 uses
  %indvars.iv289 = phi i64 [ 0, %.preheader244.preheader ], [ %indvars.iv.next290, %._crit_edge272 ] ; 8 uses
  %i.es = icmp sgt i32 %i.er, 0
  br i1 %i.es, label %.lr.ph, label %._crit_edge272

.lr.ph:                                           ; preds = %.preheader244
  %i.et = shl i64 %indvars.iv289, 1               ; 9 uses
  %i.eu = trunc i64 %i.et to i32
  %i.ev = or disjoint i32 %i.eu, 1
  %i.ew = icmp slt i32 %i.ev, %3
  %i.ex = trunc nuw nsw i64 %indvars.iv289 to i32
  %.not157250.not = icmp slt i64 %indvars.iv289, %i.ep
  %16 = trunc nuw i64 %i.et to i32
  %i.ey = trunc nuw i64 %i.et to i32
  %17 = trunc i64 %i.et to i32
  %i.ez = icmp sgt i32 %3, %17
  %i.fa = and i64 %i.et, 4294967294               ; 2 uses
  %i.fb = trunc i64 %i.et to i32
...
._crit_edge272.loopexit:                          ; preds = %.loopexit
  %.pre316 = load i32, ptr %i.dp, align 8, !tbaa !43
...
._crit_edge272:                                   ; preds = %._crit_edge272.loopexit, %.preheader244
  ...
  %i.fm = phi i32 [ %i.kh, %._crit_edge272.loopexit ], [ %i.er, %.preheader244 ]
  %indvars.iv.next290 = add i64 %indvars.iv289, 1 ; 2 uses
  %i.fn = sext i32 %i.fl to i64
  %i.fo = icmp slt i64 %indvars.iv.next290, %i.fn
  %indvars.iv.next301 = add nuw nsw i64 %indvars.iv289.a, 2
  %indvars.iv.next298 = add i32 %indvars.iv297, 2
  br i1 %i.fo, label %.preheader244, label %._crit_edge274, !llvm.loop !137

bb.ab:                                            ; preds = %.lr.ph, %.loopexit
  %indvars.iv293.a = phi i32 [ -1, %.lr.ph ], [ %indvars.iv.next294.a, %.loopexit ] ; 3 uses
  %indvars.iv293 = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next294, %.loopexit ] ; 7 uses
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %.loopexit ] ; 9 uses
  %18 = trunc i64 %indvars.iv to i32
  %19 = mul i32 %18, -2                           ; 2 uses
  %i.fp = load i32, ptr %i.dt, align 4, !tbaa !65
  %i.fq = icmp slt i32 %i.fp, 2
  %i.fr = load ptr, ptr %i.du, align 8, !tbaa !64
  %i.fs = load i64, ptr %i.dv, align 8
  %i.ft = mul i64 %i.fs, %indvars.iv289
  %.sink.idx.i = select i1 %i.fq, i64 0, i64 %i.ft
  %.sink.i = getelementptr inbounds nuw i8, ptr %i.fr, i64 %.sink.idx.i
  %i.fu = getelementptr inbounds nuw i8, ptr %.sink.i, i64 %indvars.iv ; 2 uses
  %i.fv = load i8, ptr %i.fu, align 1, !tbaa !23
  %.not = icmp eq i8 %i.fv, 0
  br i1 %.not, label %bb.ac, label %.loopexit

bb.ac:                                            ; preds = %bb.ab
  %i.fw = load i32, ptr %i.dw, align 4, !tbaa !65
  %i.fx = icmp slt i32 %i.fw, 2
  %i.fy = load ptr, ptr %i.dx, align 8, !tbaa !64
  %i.fz = load i64, ptr %i.dy, align 8
  %i.ga = mul i64 %i.fz, %indvars.iv289
  %.sink.idx.i182 = select i1 %i.fx, i64 0, i64 %i.ga
  %.sink.i183 = getelementptr inbounds nuw i8, ptr %i.fy, i64 %.sink.idx.i182
  %i.gb = getelementptr inbounds nuw i8, ptr %.sink.i183, i64 %indvars.iv
  %i.gc = load i8, ptr %i.gb, align 1, !tbaa !23
  %.not156 = icmp ne i8 %i.gc, 0
  %brmerge.not342 = select i1 %.not156, i1 %i.ew, i1 false
  %.pre321 = shl nuw nsw i64 %indvars.iv, 1       ; 12 uses
  %i.gd = trunc i64 %.pre321 to i32
  %i.ge = or disjoint i32 %i.gd, 1
  %i.gf = icmp slt i32 %i.ge, %4
  %or.cond339 = select i1 %brmerge.not342, i1 %i.gf, i1 false
  br i1 %or.cond339, label %bb.ad, label %._crit_edge320

bb.ad:                                            ; preds = %bb.ac
  %i.gg = load i32, ptr %i.dz, align 4, !tbaa !65
  %i.gh = icmp slt i32 %i.gg, 2
  %i.gi = load ptr, ptr %i.ea, align 8, !tbaa !64
  %i.gj = load i64, ptr %i.eb, align 8
  %i.gk = mul i64 %i.gj, %indvars.iv289
  %.sink.idx.i184 = select i1 %i.gh, i64 0, i64 %i.gk
  %.sink.i185 = getelementptr inbounds nuw i8, ptr %i.gi, i64 %.sink.idx.i184
  %i.gl = getelementptr inbounds nuw i8, ptr %.sink.i185, i64 %indvars.iv
  %i.gm = load i8, ptr %i.gl, align 1, !tbaa !23  ; 2 uses
  %i.gn = zext nneg i8 %i.gm to i32               ; 3 uses
  %notmask = shl nsw i32 -1, %i.gn
  %i.go = xor i32 %notmask, -1                    ; 2 uses
  %i.gp = add nuw nsw i32 %i.ex, %i.go            ; 2 uses
  %i.gq = trunc nuw nsw i64 %indvars.iv to i32
  %i.gr = add nuw nsw i32 %i.gq, %i.go            ; 2 uses
...
.preheader240.preheader:                          ; preds = %bb.ad
  %.sroa.speculated229 = call i32 @llvm.smin.i32(i32 %i.ed, i32 %i.gr)
  %.sroa.speculated234 = call i32 @llvm.smin.i32(i32 %i.ec, i32 %i.gp)
  %i.gs = sext i32 %.sroa.speculated229 to i64
  %i.gt = sext i32 %.sroa.speculated234 to i64
...
._crit_edge253.loopexit:                          ; preds = %._crit_edge
  %i.gu = xor i1 %spec.select, true
  br label %._crit_edge253

._crit_edge253:                                   ; preds = %._crit_edge253.loopexit, %bb.ad
  %.0124.lcssa = phi i1 [ false, %bb.ad ], [ %i.gu, %._crit_edge253.loopexit ]
  %i.gv = shl nuw nsw i32 %i.gp, 1
  %i.gw = or disjoint i32 %i.gv, 1
  %.sroa.speculated214 = call i32 @llvm.smin.i32(i32 %i.ee, i32 %i.gw) ; 4 uses
  %i.gx = shl nuw nsw i32 %i.gr, 1
  %i.gy = or disjoint i32 %i.gx, 1
  %.sroa.speculated = call i32 @llvm.smin.i32(i32 %i.ef, i32 %i.gy) ; 4 uses
  %20 = zext i32 %.sroa.speculated214 to i64
  %.not158 = icmp eq i64 %i.et, %20
  %or.cond = select i1 %.0124.lcssa, i1 true, i1 %.not158
  %21 = zext i32 %.sroa.speculated to i64
  %.not159 = icmp eq i64 %.pre321, %21
...
.preheader241:                                    ; preds = %._crit_edge253
  %.not160263 = icmp slt i32 %.sroa.speculated214, %i.ey
  %22 = trunc nuw i64 %.pre321 to i32
  %.not161260 = icmp slt i32 %.sroa.speculated, %22
...
.preheader.preheader:                             ; preds = %.preheader241
  %23 = shl i32 -2, %i.gn                         ; 2 uses
  %24 = sub i32 %indvars.iv293.a, %23
  %smin313 = call i32 @llvm.smin.i32(i32 %24, i32 %i.ef) ; 3 uses
  %25 = add i32 %smin313, 1
  %26 = sub i32 %indvars.iv297, %23
  %smin319 = call i32 @llvm.smin.i32(i32 %26, i32 %i.ee)
  %27 = add i32 %smin319, 1
  %28 = and i32 %smin313, 1
  %lcmp.mod372.not.not = icmp eq i32 %28, 0
  %indvars.iv.next311.prol = or disjoint i64 %indvars.iv293, 1
  %29 = sub i32 0, %19
  %30 = icmp eq i32 %smin313, %29
  br label %.preheader

._crit_edge:                                      ; preds = %bb.ae
  %indvars.iv.next292 = add nuw nsw i64 %indvars.iv291, 1
  %.not157.not = icmp slt i64 %indvars.iv291, %i.gt
  br i1 %.not157.not, label %.preheader240, label %._crit_edge253.loopexit, !llvm.loop !138
...
bb.ae:                                            ; preds = %.preheader240, %bb.ae
  ...
  %i.gz = load i32, ptr %i.dt, align 4, !tbaa !65
  %i.ha = icmp slt i32 %i.gz, 2
  %i.hb = load ptr, ptr %i.du, align 8, !tbaa !64
  %i.hc = load i64, ptr %i.dv, align 8
  %i.hd = mul i64 %i.hc, %indvars.iv291
  %.sink.idx.i191 = select i1 %i.ha, i64 0, i64 %i.hd
  %.sink.i192 = getelementptr inbounds nuw i8, ptr %i.hb, i64 %.sink.idx.i191
  %i.he = getelementptr inbounds nuw i8, ptr %.sink.i192, i64 %indvars.iv287
  store i8 1, ptr %i.he, align 1, !tbaa !23
  %i.hf = load i32, ptr %i.dw, align 4, !tbaa !65
  %i.hg = icmp slt i32 %i.hf, 2
  %i.hh = load ptr, ptr %i.dx, align 8, !tbaa !64
  %i.hi = load i64, ptr %i.dy, align 8
  %i.hj = mul i64 %i.hi, %indvars.iv291
  %.sink.idx.i193 = select i1 %i.hg, i64 0, i64 %i.hj
  %.sink.i194 = getelementptr inbounds nuw i8, ptr %i.hh, i64 %.sink.idx.i193
  %i.hk = getelementptr inbounds nuw i8, ptr %.sink.i194, i64 %indvars.iv287
  %i.hl = load i8, ptr %i.hk, align 1, !tbaa !23
  %.not174 = icmp ne i8 %i.hl, 0
  %spec.select = select i1 %.not174, i1 %.1248, i1 false ; 3 uses
  %indvars.iv.next288 = add nuw nsw i64 %indvars.iv287, 1
  %.not166.not = icmp slt i64 %indvars.iv287, %i.gs
  br i1 %.not166.not, label %bb.ae, label %._crit_edge, !llvm.loop !139

bb.af:                                            ; preds = %._crit_edge253
  %i.hm = load i32, ptr %i.eg, align 4, !tbaa !65
  %i.hn = icmp slt i32 %i.hm, 2
  %i.ho = load ptr, ptr %i.eh, align 8, !tbaa !64
  %i.hp = load i64, ptr %i.ei, align 8
  %i.hq = mul i64 %i.hp, %i.et
  %.sink.idx.i195 = select i1 %i.hn, i64 0, i64 %i.hq
  %.sink.i196 = getelementptr inbounds nuw i8, ptr %i.ho, i64 %.sink.idx.i195
  %i.hr = getelementptr inbounds nuw i8, ptr %.sink.i196, i64 %.pre321
  store i8 -1, ptr %i.hr, align 1, !tbaa !23
  %i.hs = load i32, ptr %i.eg, align 4, !tbaa !65
  %i.ht = icmp slt i32 %i.hs, 2
  %i.hu = load ptr, ptr %i.eh, align 8, !tbaa !64
  %i.hv = load i64, ptr %i.ei, align 8
  %i.hw = sext i32 %.sroa.speculated214 to i64    ; 2 uses
  %i.hx = mul i64 %i.hv, %i.hw
  %.sink.idx.i197 = select i1 %i.ht, i64 0, i64 %i.hx
  %.sink.i198 = getelementptr inbounds nuw i8, ptr %i.hu, i64 %.sink.idx.i197
  %i.hy = getelementptr inbounds nuw i8, ptr %.sink.i198, i64 %.pre321
  store i8 -1, ptr %i.hy, align 1, !tbaa !23
  %i.hz = load i32, ptr %i.eg, align 4, !tbaa !65
  %i.ia = icmp slt i32 %i.hz, 2
  %i.ib = load ptr, ptr %i.eh, align 8, !tbaa !64
  %i.ic = load i64, ptr %i.ei, align 8
  %i.id = mul i64 %i.ic, %i.et
  %.sink.idx.i199 = select i1 %i.ia, i64 0, i64 %i.id
  %.sink.i200 = getelementptr inbounds nuw i8, ptr %i.ib, i64 %.sink.idx.i199
  %i.ie = sext i32 %.sroa.speculated to i64       ; 2 uses
  %i.if = getelementptr inbounds i8, ptr %.sink.i200, i64 %i.ie
  store i8 -1, ptr %i.if, align 1, !tbaa !23
  %i.ig = load i32, ptr %i.eg, align 4, !tbaa !65
  %i.ih = icmp slt i32 %i.ig, 2
  %i.ii = load ptr, ptr %i.eh, align 8, !tbaa !64
  %i.ij = load i64, ptr %i.ei, align 8
  %i.ik = mul i64 %i.ij, %i.hw
  %.sink.idx.i201 = select i1 %i.ih, i64 0, i64 %i.ik
  %.sink.i202 = getelementptr inbounds nuw i8, ptr %i.ii, i64 %.sink.idx.i201
  %i.il = getelementptr inbounds i8, ptr %.sink.i202, i64 %i.ie
  store i8 -1, ptr %i.il, align 1, !tbaa !23
  %.not162258 = icmp slt i32 %.sroa.speculated214, %16
  br i1 %.not162258, label %.loopexit, label %.preheader239.lr.ph

.preheader239.lr.ph:                              ; preds = %bb.af
  %31 = trunc nuw i64 %.pre321 to i32
  %.not163255 = icmp slt i32 %.sroa.speculated, %31
  %i.im = add i8 %i.gm, 1                         ; 3 uses
  br i1 %.not163255, label %.loopexit, label %.preheader239.preheader

.preheader239.preheader:                          ; preds = %.preheader239.lr.ph
  %32 = shl i32 -2, %i.gn                         ; 2 uses
  %33 = sub i32 %indvars.iv293.a, %32
  %smin = call i32 @llvm.smin.i32(i32 %33, i32 %i.ef) ; 3 uses
  %34 = add i32 %smin, 1
  %35 = sub i32 %indvars.iv297, %32
  %smin307 = call i32 @llvm.smin.i32(i32 %35, i32 %i.ee)
  %36 = add i32 %smin307, 1
  %37 = and i32 %smin, 1
  %lcmp.mod.not.not = icmp eq i32 %37, 0
  %indvars.iv.next296.prol = or disjoint i64 %indvars.iv293, 1
  %38 = sub i32 0, %19
  %39 = icmp eq i32 %smin, %38
  br label %.preheader239

.preheader239:                                    ; preds = %.preheader239.preheader, %._crit_edge257
  %indvars.iv302 = phi i64 [ %indvars.iv289.a, %.preheader239.preheader ], [ %indvars.iv.next301.a, %._crit_edge257 ] ; 4 uses
  br i1 %lcmp.mod.not.not, label %.prol.loopexit.unr-lcssa, label %.preheader239.a

.prol.loopexit.unr-lcssa:                         ; preds = %.preheader239
  %40 = load i32, ptr %i.ej, align 4, !tbaa !65
  %41 = icmp slt i32 %40, 2
  %42 = load ptr, ptr %i.ek, align 8, !tbaa !64
  %43 = load i64, ptr %i.el, align 8
  %44 = mul i64 %43, %indvars.iv302
  %.sink.idx.i203.prol = select i1 %41, i64 0, i64 %44
  %.sink.i204.prol = getelementptr inbounds nuw i8, ptr %42, i64 %.sink.idx.i203.prol
  %45 = getelementptr inbounds nuw i8, ptr %.sink.i204.prol, i64 %indvars.iv293
  store i8 %i.im, ptr %45, align 1, !tbaa !23
  br label %.preheader239.a

.preheader239.a:                                  ; preds = %.prol.loopexit.unr-lcssa, %.preheader239
  %indvars.iv300 = phi i64 [ %indvars.iv293, %.preheader239 ], [ %indvars.iv.next296.prol, %.prol.loopexit.unr-lcssa ]
  br i1 %39, label %._crit_edge257, label %bb.ag

._crit_edge257:                                   ; preds = %bb.ag, %.preheader239.a
  %indvars.iv.next301.a = add nuw nsw i64 %indvars.iv302, 1 ; 2 uses
  %lftr.wideiv308 = trunc i64 %indvars.iv.next301.a to i32
  %exitcond309.not = icmp eq i32 %36, %lftr.wideiv308
  br i1 %exitcond309.not, label %.loopexit, label %.preheader239, !llvm.loop !140

bb.ag:                                            ; preds = %.preheader239.a, %bb.ag
  %indvars.iv295 = phi i64 [ %indvars.iv.next296, %bb.ag ], [ %indvars.iv300, %.preheader239.a ] ; 3 uses
  %46 = load i32, ptr %i.ej, align 4, !tbaa !65
  %47 = icmp slt i32 %46, 2
  %48 = load ptr, ptr %i.ek, align 8, !tbaa !64
  %49 = load i64, ptr %i.el, align 8
  %50 = mul i64 %49, %indvars.iv302
  %.sink.idx.i203 = select i1 %47, i64 0, i64 %50
  %.sink.i204 = getelementptr inbounds nuw i8, ptr %48, i64 %.sink.idx.i203
  %51 = getelementptr inbounds nuw i8, ptr %.sink.i204, i64 %indvars.iv295
  store i8 %i.im, ptr %51, align 1, !tbaa !23
  %i.in = load i32, ptr %i.ej, align 4, !tbaa !65
  %i.io = icmp slt i32 %i.in, 2
  %i.ip = load ptr, ptr %i.ek, align 8, !tbaa !64
  %i.iq = load i64, ptr %i.el, align 8
  %i.ir = mul i64 %i.iq, %indvars.iv302
  %.sink.idx.i203.a = select i1 %i.io, i64 0, i64 %i.ir
  %.sink.i204.1 = getelementptr inbounds nuw i8, ptr %i.ip, i64 %.sink.idx.i203.a
  %.sink.i204.a = getelementptr inbounds nuw i8, ptr %.sink.i204.1, i64 %indvars.iv295
  %i.is = getelementptr inbounds nuw i8, ptr %.sink.i204.a, i64 1
  store i8 %i.im, ptr %i.is, align 1, !tbaa !23
  %indvars.iv.next296 = add nuw nsw i64 %indvars.iv295, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next296 to i32
  %exitcond.not.1 = icmp eq i32 %34, %lftr.wideiv.1
  br i1 %exitcond.not.1, label %._crit_edge257, label %bb.ag, !llvm.loop !141

.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge262
  %indvars.iv316 = phi i64 [ %indvars.iv289.a, %.preheader.preheader ], [ %indvars.iv.next307, %._crit_edge262 ] ; 4 uses
  br i1 %lcmp.mod372.not.not, label %.prol.loopexit370.unr-lcssa, label %.preheader.a

.prol.loopexit370.unr-lcssa:                      ; preds = %.preheader
  %52 = load i32, ptr %i.eg, align 4, !tbaa !65
  %53 = icmp slt i32 %52, 2
  %54 = load ptr, ptr %i.eh, align 8, !tbaa !64
  %55 = load i64, ptr %i.ei, align 8
  %56 = mul i64 %55, %indvars.iv316
  %.sink.idx.i205.prol = select i1 %53, i64 0, i64 %56
  %.sink.i206.prol = getelementptr inbounds nuw i8, ptr %54, i64 %.sink.idx.i205.prol
  %57 = getelementptr inbounds nuw i8, ptr %.sink.i206.prol, i64 %indvars.iv293
  store i8 -1, ptr %57, align 1, !tbaa !23
  br label %.preheader.a

.preheader.a:                                     ; preds = %.prol.loopexit370.unr-lcssa, %.preheader
  %indvars.iv306 = phi i64 [ %indvars.iv293, %.preheader ], [ %indvars.iv.next311.prol, %.prol.loopexit370.unr-lcssa ]
  br i1 %30, label %._crit_edge262, label %bb.ah

._crit_edge262:                                   ; preds = %bb.ah, %.preheader.a
  %indvars.iv.next307 = add nuw nsw i64 %indvars.iv316, 1 ; 2 uses
  %lftr.wideiv320 = trunc i64 %indvars.iv.next307 to i32
  %exitcond321.not = icmp eq i32 %27, %lftr.wideiv320
  br i1 %exitcond321.not, label %.loopexit, label %.preheader, !llvm.loop !142

bb.ah:                                            ; preds = %.preheader.a, %bb.ah
  %indvars.iv303 = phi i64 [ %indvars.iv.next304, %bb.ah ], [ %indvars.iv306, %.preheader.a ] ; 3 uses
  %58 = load i32, ptr %i.eg, align 4, !tbaa !65
  %59 = icmp slt i32 %58, 2
  %60 = load ptr, ptr %i.eh, align 8, !tbaa !64
  %61 = load i64, ptr %i.ei, align 8
  %62 = mul i64 %61, %indvars.iv316
  %.sink.idx.i205 = select i1 %59, i64 0, i64 %62
  %.sink.i206 = getelementptr inbounds nuw i8, ptr %60, i64 %.sink.idx.i205
  %63 = getelementptr inbounds nuw i8, ptr %.sink.i206, i64 %indvars.iv303
  store i8 -1, ptr %63, align 1, !tbaa !23
  %i.it = load i32, ptr %i.eg, align 4, !tbaa !65
  %i.iu = icmp slt i32 %i.it, 2
  %i.iv = load ptr, ptr %i.eh, align 8, !tbaa !64
  %i.iw = load i64, ptr %i.ei, align 8
  %i.ix = mul i64 %i.iw, %indvars.iv316
  %.sink.idx.i205.a = select i1 %i.iu, i64 0, i64 %i.ix
  %.sink.i206.1 = getelementptr inbounds nuw i8, ptr %i.iv, i64 %.sink.idx.i205.a
  %.sink.i206.a = getelementptr inbounds nuw i8, ptr %.sink.i206.1, i64 %indvars.iv303
  %i.iy = getelementptr inbounds nuw i8, ptr %.sink.i206.a, i64 1
  store i8 -1, ptr %i.iy, align 1, !tbaa !23
  %indvars.iv.next304 = add nuw nsw i64 %indvars.iv303, 2 ; 2 uses
  %lftr.wideiv314.1 = trunc i64 %indvars.iv.next304 to i32
  %exitcond315.not.1 = icmp eq i32 %25, %lftr.wideiv314.1
  br i1 %exitcond315.not.1, label %._crit_edge262, label %bb.ah, !llvm.loop !143

._crit_edge320:                                   ; preds = %bb.ac
  store i8 1, ptr %i.fu, align 1, !tbaa !23
  br i1 %i.ez, label %.split.preheader, label %.split267.us

.split.preheader:                                 ; preds = %._crit_edge320
  %i.iz = trunc nuw i64 %.pre321 to i32
  %i.ja = icmp sgt i32 %4, %i.iz
  br i1 %i.ja, label %bb.ak, label %.split.1
...
.split.preheader.1:                               ; preds = %.split267.us
  %i.jb = trunc nuw i64 %.pre321 to i32
  %i.jc = icmp sgt i32 %4, %i.jb
  br i1 %i.jc, label %bb.ai, label %.split.1.1

bb.ai:                                            ; preds = %.split.preheader.1
  %i.jd = load i32, ptr %i.eg, align 4, !tbaa !65
  %i.je = icmp slt i32 %i.jd, 2
  %i.jf = load ptr, ptr %i.eh, align 8, !tbaa !64
  %i.jg = load i64, ptr %i.ei, align 8
  %i.jh = mul i64 %i.jg, %i.fe
  %.sink.idx.i209.1312 = select i1 %i.je, i64 0, i64 %i.jh
  %.sink.i210.1313 = getelementptr inbounds nuw i8, ptr %i.jf, i64 %.sink.idx.i209.1312
  %i.ji = getelementptr inbounds nuw i8, ptr %.sink.i210.1313, i64 %.pre321
  store i8 -1, ptr %i.ji, align 1, !tbaa !23
  br label %.split.1.1

.split.1.1:                                       ; preds = %bb.ai, %.split.preheader.1
  %i.jj = or disjoint i64 %.pre321, 1             ; 2 uses
  %i.jk = trunc nuw i64 %i.jj to i32
  %i.jl = icmp sgt i32 %4, %i.jk
  br i1 %i.jl, label %bb.aj, label %.loopexit

bb.aj:                                            ; preds = %.split.1.1
  %i.jm = load i32, ptr %i.eg, align 4, !tbaa !65
  %i.jn = icmp slt i32 %i.jm, 2
  %i.jo = load ptr, ptr %i.eh, align 8, !tbaa !64
  %i.jp = load i64, ptr %i.ei, align 8
  %i.jq = mul i64 %i.jp, %i.fe
  %.sink.idx.i209.1.1 = select i1 %i.jn, i64 0, i64 %i.jq
  %.sink.i210.1.1 = getelementptr inbounds nuw i8, ptr %i.jo, i64 %.sink.idx.i209.1.1
  %i.jr = getelementptr inbounds nuw i8, ptr %.sink.i210.1.1, i64 %i.jj
  store i8 -1, ptr %i.jr, align 1, !tbaa !23
  br label %.loopexit

bb.ak:                                            ; preds = %.split.preheader
  %i.js = load i32, ptr %i.eg, align 4, !tbaa !65
  %i.jt = icmp slt i32 %i.js, 2
  %i.ju = load ptr, ptr %i.eh, align 8, !tbaa !64
  %i.jv = load i64, ptr %i.ei, align 8
  %i.jw = mul i64 %i.jv, %i.fa
  %.sink.idx.i209 = select i1 %i.jt, i64 0, i64 %i.jw
  %.sink.i210 = getelementptr inbounds nuw i8, ptr %i.ju, i64 %.sink.idx.i209
  %i.jx = getelementptr inbounds nuw i8, ptr %.sink.i210, i64 %.pre321
  store i8 -1, ptr %i.jx, align 1, !tbaa !23
  br label %.split.1

.split.1:                                         ; preds = %bb.ak, %.split.preheader
  %i.jy = or disjoint i64 %.pre321, 1             ; 2 uses
  %i.jz = trunc nuw i64 %i.jy to i32
  %i.ka = icmp sgt i32 %4, %i.jz
  br i1 %i.ka, label %bb.al, label %.split267.us

bb.al:                                            ; preds = %.split.1
  %i.kb = load i32, ptr %i.eg, align 4, !tbaa !65
  %i.kc = icmp slt i32 %i.kb, 2
  %i.kd = load ptr, ptr %i.eh, align 8, !tbaa !64
  %i.ke = load i64, ptr %i.ei, align 8
  %i.kf = mul i64 %i.ke, %i.fa
  %.sink.idx.i209.1 = select i1 %i.kc, i64 0, i64 %i.kf
  %.sink.i210.1 = getelementptr inbounds nuw i8, ptr %i.kd, i64 %.sink.idx.i209.1
  %i.kg = getelementptr inbounds nuw i8, ptr %.sink.i210.1, i64 %i.jy
  store i8 -1, ptr %i.kg, align 1, !tbaa !23
...
.loopexit:                                        ; preds = %._crit_edge257, %._crit_edge262, %.split267.us, %bb.aj, %.split.1.1, %bb.af, %.preheader239.lr.ph, %.preheader241, %bb.ab
  ...
  %i.kh = load i32, ptr %i.ds, align 4, !tbaa !44 ; 2 uses
  %i.ki = sext i32 %i.kh to i64
  %i.kj = icmp slt i64 %indvars.iv.next, %i.ki
  %indvars.iv.next294 = add nuw nsw i64 %indvars.iv293, 2
  %indvars.iv.next294.a = add i32 %indvars.iv293.a, 2
  br i1 %i.kj, label %bb.ab, label %._crit_edge272.loopexit, !llvm.loop !144
...
bb.a:
  ...
  store ptr %4, ptr %i.f, align 8, !tbaa !13
  call void @llvm.lifetime.start.p0(ptr nonnull %12) #20
  %i.g = getelementptr inbounds nuw i8, ptr %12, i64 8
  %i.h = getelementptr inbounds nuw i8, ptr %12, i64 16
  store i64 0, ptr %i.h, align 8
  store i32 50397184, ptr %12, align 8, !tbaa !42
  store ptr %5, ptr %i.g, align 8, !tbaa !13
  ...
  store i32 0, ptr %i.k, align 8, !tbaa !40
  ...
  store ptr %5, ptr %i.m, align 8, !tbaa !13
  call void @llvm.lifetime.start.p0(ptr nonnull %14) #20
  ...
  store ptr %0, ptr %i.n, align 8, !tbaa !13
...
bb.a:
  ...
  %i.d = load i32, ptr %i.c, align 4, !tbaa !44   ; 6 uses
  ...
  %i.e = load ptr, ptr %5, align 8, !tbaa !37     ; 2 uses
  ...
  invoke void %i.h(ptr noundef nonnull align 8 dereferenceable(8) %i.e, ptr noundef nonnull align 8 dereferenceable(688) %5, ptr noundef nonnull align 8 dereferenceable(208) %3, i32 noundef -1)
          to label %_ZN2cv3MataSERKNS_7MatExprE.exit unwind label %bb.b, !inline_history !1
...
.preheader139.lr.ph.split:                        ; preds = %.preheader139.lr.ph
  ...
  %i.ab = load ptr, ptr %i.x, align 8, !tbaa !64
  %i.ac = load i32, ptr %i.w, align 4, !tbaa !65
  %i.ad = icmp slt i32 %i.ac, 2                   ; 2 uses
  %i.ae = load ptr, ptr %i.v, align 8, !tbaa !64  ; 2 uses
...
bb.c:                                             ; preds = %._crit_edge152
  ...
  br i1 %exitcond.not, label %._crit_edge157, label %bb.d, !llvm.loop !149
