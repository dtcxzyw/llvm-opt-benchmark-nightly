...
.preheader:                                       ; preds = %bb.a, %bb.b
  ...
  %i.m = load <4 x float>, ptr %i.i, align 4, !tbaa !27 ; 3 uses
  ...
  %i.ab = load <2 x float>, ptr %i.z, align 4, !tbaa !27 ; 2 uses
  ...
  %5 = load float, ptr %i.an, align 4, !tbaa !262 ; 6 uses
  %i.ao = load float, ptr %i.am, align 4, !tbaa !309 ; 5 uses
  %i.ap = fmul float %i.y, %5
  %i.aq = extractelement <4 x float> %i.m, i64 0  ; 5 uses
  %i.ar = extractelement <2 x float> %i.ab, i64 0 ; 5 uses
  %i.as = tail call float @llvm.fmuladd.f32(float %i.aq, float %i.ar, float %i.ap)
  %i.at = tail call float @llvm.fmuladd.f32(float %i.ao, float %i.p, float %i.as)
  %i.au = fneg float %i.ao                        ; 2 uses
  %i.av = tail call float @llvm.fmuladd.f32(float %i.au, float %i.ar, float %i.at)
  %i.aw = fneg float %i.aq
  %i.ax = tail call float @llvm.fmuladd.f32(float %i.aw, float %5, float %i.av)
...
.critedge:                                        ; preds = %.preheader
  ...
  %6 = fsub float %i.ar, %5
  %7 = fsub float %5, %i.p
  %8 = fsub float %i.ao, %i.y
  %9 = fsub float %i.aq, %i.ao
  ...
  %i.bj = tail call float @llvm.fmuladd.f32(float %i.y, float %5, float %i.bi)
  %i.bk = fneg float %5
  %i.bl = fmul float %i.aq, %i.bk
  %i.bm = tail call float @llvm.fmuladd.f32(float %i.p, float %i.ao, float %i.bl)
  ...
  %10 = insertelement <4 x float> %i.br, float %6, i64 2
  %11 = insertelement <4 x float> %10, float %8, i64 3
