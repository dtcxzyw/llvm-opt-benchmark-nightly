...
begin_hunk_0_@_ZN2cv3dnn17PriorBoxLayerImpl7forwardERKNS_11_InputArrayERKNS_12_OutputArrayES7_:bb.a
  ...
  %i.bc = getelementptr inbounds nuw i8, ptr %0, i64 208 ; 6 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %0, i64 288
  %i.be = getelementptr inbounds nuw i8, ptr %0, i64 212 ; 2 uses
...
.preheader148.us.us:                              ; preds = %.preheader148.us.us.preheader, %._crit_edge.split.us.split.us.split.us187.us
  %.076177.us.us = phi i64 [ %i.fr, %._crit_edge.split.us.split.us.split.us187.us ], [ 0, %.preheader148.us.us.preheader ] ; 2 uses
...
.preheader147.us.us.us184.us:                     ; preds = %._crit_edge154.split.us.split.us172.us.us.us, %.preheader148.us.us
  %.075164.us.us.us185.us = phi i64 [ 0, %.preheader148.us.us ], [ %i.fq, %._crit_edge154.split.us.split.us172.us.us.us ] ; 2 uses
...
.lr.ph.us.us169.us.us.us:                         ; preds = %._crit_edge.split.us160.us.us.us.us, %.preheader147.us.us.us184.us
  %.074152.us.us170.us.us.us = phi i64 [ 0, %.preheader147.us.us.us184.us ], [ %i.fp, %._crit_edge.split.us160.us.us.us.us ] ; 3 uses
  %.279151.us.us171.us.us.us = phi ptr [ %.178163.us.us.us186.us, %.preheader147.us.us.us184.us ], [ %.lcssa278, %._crit_edge.split.us160.us.us.us.us ] ; 8 uses
  %i.eh = getelementptr inbounds nuw [4 x i8], ptr %i.bm, i64 %.074152.us.us170.us.us.us
  %i.ei = load float, ptr %i.eh, align 4, !tbaa !67 ; 2 uses
  %i.ej = getelementptr inbounds nuw [4 x i8], ptr %i.br, i64 %.074152.us.us170.us.us.us
  ...
  br i1 %min.iters.check, label %_ZN2cv3dnn17PriorBoxLayerImpl8addPriorEffffffbPf.exit.us157.us.us.us.us.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.us.us169.us.us.us
  %scevgep = getelementptr i8, ptr %.279151.us.us171.us.us.us, i64 %i.cb ; 3 uses
  %bound0 = icmp ult ptr %.279151.us.us171.us.us.us, %i.bs
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %19 = shufflevector <4 x float> %broadcast.splatinsert299, <4 x float> %broadcast.splatinsert302, <8 x i32> <i32 0, i32 0, i32 0, i32 0, i32 4, i32 4, i32 4, i32 4>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %22 = fmul <8 x float> %21, %19                 ; 2 uses
  %i.ew = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.er, <8 x float> splat (float 5.000000e-01), <8 x float> %22)
  %i.ex = call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.es, <8 x float> splat (float 5.000000e-01), <8 x float> %22)
  ...
  br i1 %i.ez, label %middle.block, label %vector.body, !llvm.loop !155
...
_ZN2cv3dnn17PriorBoxLayerImpl8addPriorEffffffbPf.exit.us157.us.us.us.us.preheader: ; preds = %vector.memcheck, %.lr.ph.us.us169.us.us.us, %middle.block
  ...
  %i.fa = shufflevector <2 x float> %i.en, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.fb = shufflevector <4 x float> %i.fa, <4 x float> <float poison, float poison, float -1.000000e+00, float 1.000000e+00>, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
...
_ZN2cv3dnn17PriorBoxLayerImpl8addPriorEffffffbPf.exit.us157.us.us.us.us: ; preds = %_ZN2cv3dnn17PriorBoxLayerImpl8addPriorEffffffbPf.exit.us157.us.us.us.us.preheader, %_ZN2cv3dnn17PriorBoxLayerImpl8addPriorEffffffbPf.exit.us157.us.us.us.us
  ...
  %.380149.us159.us.us.us.us = phi ptr [ %i.fo, %_ZN2cv3dnn17PriorBoxLayerImpl8addPriorEffffffbPf.exit.us157.us.us.us.us ], [ %.380149.us159.us.us.us.us.ph, %_ZN2cv3dnn17PriorBoxLayerImpl8addPriorEffffffbPf.exit.us157.us.us.us.us.preheader ] ; 2 uses
  %i.fc = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %indvars.iv
  %i.fd = load float, ptr %i.fc, align 4, !tbaa !67
  %i.fe = getelementptr inbounds nuw [4 x i8], ptr %i.by, i64 %indvars.iv
  %i.ff = load float, ptr %i.fe, align 4, !tbaa !67
  %i.fg = insertelement <2 x float> poison, float %i.fd, i64 0
  %i.fh = insertelement <2 x float> %i.fg, float %i.ff, i64 1
  %i.fi = fadd <2 x float> %i.fh, %i.eg
  %i.fj = load <2 x float>, ptr %i.bc, align 8, !tbaa !67
  %i.fk = fmul <2 x float> %i.fi, %i.fj           ; 2 uses
  %i.fl = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.em, <2 x float> splat (float 5.000000e-01), <2 x float> %i.fk)
  %i.fm = shufflevector <2 x float> %i.fk, <2 x float> %i.fl, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.fn = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.fb, <4 x float> <float 5.000000e-01, float 5.000000e-01, float 1.000000e+00, float -1.000000e+00>, <4 x float> %i.fm)
  store <4 x float> %i.fn, ptr %.380149.us159.us.us.us.us, align 4, !tbaa !67
  %i.fo = getelementptr inbounds nuw i8, ptr %.380149.us159.us.us.us.us, i64 16 ; 2 uses
...
._crit_edge.split.us160.us.us.us.us:              ; preds = %_ZN2cv3dnn17PriorBoxLayerImpl8addPriorEffffffbPf.exit.us157.us.us.us.us, %middle.block
  %.lcssa278 = phi ptr [ %i.eo, %middle.block ], [ %i.fo, %_ZN2cv3dnn17PriorBoxLayerImpl8addPriorEffffffbPf.exit.us157.us.us.us.us ] ; 3 uses
  %i.fp = add nuw i64 %.074152.us.us170.us.us.us, 1 ; 2 uses
  %exitcond224.not = icmp eq i64 %i.fp, %i.bq
...
._crit_edge154.split.us.split.us172.us.us.us:     ; preds = %._crit_edge.split.us160.us.us.us.us
  %i.fq = add nuw i64 %.075164.us.us.us185.us, 1  ; 2 uses
  %exitcond225.not = icmp eq i64 %i.fq, %i.ay
...
._crit_edge.split.us.split.us.split.us187.us:     ; preds = %._crit_edge154.split.us.split.us172.us.us.us
  %i.fr = add nuw i64 %.076177.us.us, 1           ; 2 uses
  %exitcond226.not = icmp eq i64 %i.fr, %i.av
...
._crit_edge178.split:                             ; preds = %._crit_edge.split.us.split.us.split.us187.us, %._crit_edge.split.us.split.us.split.us.us.us.us, %.preheader148.lr.ph.split.split.us, %.preheader148.lr.ph.split, %.preheader148.lr.ph, %bb.x
  %i.fs = getelementptr inbounds nuw i8, ptr %0, i64 361
  %i.ft = load i8, ptr %i.fs, align 1, !tbaa !56, !range !78, !noundef !79
  %i.fu = trunc nuw i8 %i.ft to i1
  br i1 %i.fu, label %bb.aa, label %_ZN2cv3Mat3ptrIfEEPT_ii.exit
...
bb.aa:                                            ; preds = %._crit_edge178.split
  ...
  %i.fy = load i64, ptr %i.fx, align 8, !tbaa !69
  %i.fz = trunc i64 %i.fy to i32
  %i.ga = shl i32 %i.ag, 2
  %.tr = mul i32 %i.ga, %i.ai
  %i.gb = mul i32 %.tr, %i.fz                     ; 3 uses
...
vector.body360:                                   ; preds = %vector.body360, %vector.ph358
  ...
  %i.gd = getelementptr inbounds nuw [4 x i8], ptr %i.au, i64 %index361 ; 3 uses
  %i.ge = getelementptr inbounds nuw i8, ptr %i.gd, i64 16 ; 2 uses
  %wide.load362 = load <4 x float>, ptr %i.gd, align 4, !tbaa !67 ; 2 uses
  %wide.load363 = load <4 x float>, ptr %i.ge, align 4, !tbaa !67 ; 2 uses
  %i.gf = fcmp olt <4 x float> %wide.load362, zeroinitializer
  %i.gg = fcmp olt <4 x float> %wide.load363, zeroinitializer
  %i.gh = select <4 x i1> %i.gf, <4 x float> zeroinitializer, <4 x float> %wide.load362 ; 2 uses
  %i.gi = select <4 x i1> %i.gg, <4 x float> zeroinitializer, <4 x float> %wide.load363 ; 2 uses
  %i.gj = fcmp ogt <4 x float> %i.gh, splat (float 1.000000e+00)
  %i.gk = fcmp ogt <4 x float> %i.gi, splat (float 1.000000e+00)
  %i.gl = select <4 x i1> %i.gj, <4 x float> splat (float 1.000000e+00), <4 x float> %i.gh
  %i.gm = select <4 x i1> %i.gk, <4 x float> splat (float 1.000000e+00), <4 x float> %i.gi
  store <4 x float> %i.gl, ptr %i.gd, align 4, !tbaa !67
  store <4 x float> %i.gm, ptr %i.ge, align 4, !tbaa !67
  %index.next364 = add nuw i64 %index361, 8       ; 2 uses
  %i.gn = icmp eq i64 %index.next364, %n.vec359
  br i1 %i.gn, label %middle.block365, label %vector.body360, !llvm.loop !157

middle.block365:                                  ; preds = %vector.body360
  %cmp.n366 = icmp eq i64 %n.vec359, %i.gc
...
.lr.ph:                                           ; preds = %.lr.ph.preheader405, %.lr.ph
  %.059193 = phi i64 [ %i.gs, %.lr.ph ], [ %.059193.ph, %.lr.ph.preheader405 ] ; 2 uses
  %i.go = getelementptr inbounds nuw [4 x i8], ptr %i.au, i64 %.059193 ; 2 uses
  %i.gp = load float, ptr %i.go, align 4, !tbaa !67 ; 2 uses
  %i.gq = fcmp olt float %i.gp, 0.000000e+00
  %.sroa.speculated140 = select i1 %i.gq, float 0.000000e+00, float %i.gp ; 2 uses
  %i.gr = fcmp ogt float %.sroa.speculated140, 1.000000e+00
  %.sroa.speculated = select i1 %i.gr, float 1.000000e+00, float %.sroa.speculated140
  store float %.sroa.speculated, ptr %i.go, align 4, !tbaa !67
  %i.gs = add nuw i64 %.059193, 1                 ; 2 uses
  %exitcond237.not = icmp eq i64 %i.gs, %i.gc
...
_ZN2cv3Mat3ptrIfEEPT_ii.exit:                     ; preds = %.lr.ph, %middle.block365, %bb.aa, %._crit_edge178.split
  %i.gt = getelementptr inbounds nuw i8, ptr %i.as, i64 4
  %i.gu = load i32, ptr %i.gt, align 4, !tbaa !87
  %i.gv = icmp slt i32 %i.gu, 2
  %.pn143.in.v = select i1 %i.gv, i64 128, i64 136
  ...
  %i.gw = getelementptr inbounds nuw i8, ptr %0, i64 240 ; 2 uses
  %i.gx = getelementptr inbounds nuw i8, ptr %0, i64 248
  %i.gy = load ptr, ptr %i.gx, align 8, !tbaa !65
  %i.gz = load ptr, ptr %i.gw, align 8, !tbaa !66 ; 10 uses
  %i.ha = ptrtoint ptr %i.gy to i64
  %i.hb = ptrtoint ptr %i.gz to i64
  %i.hc = sub i64 %i.ha, %i.hb
  %i.hd = icmp eq i64 %i.hc, 4
  br i1 %i.hd, label %bb.ab, label %.preheader146
...
.preheader145.lr.ph.split:                        ; preds = %.preheader145.lr.ph
  ...
  %i.hg = load i64, ptr %i.hf, align 8, !tbaa !69 ; 9 uses
  %.not215 = icmp eq i64 %i.hg, 0
  br i1 %.not215, label %.loopexit, label %.preheader145.us.preheader

.preheader145.us.preheader:                       ; preds = %.preheader145.lr.ph.split
  %i.hh = getelementptr inbounds nuw i8, ptr %i.gz, i64 4 ; 4 uses
  %i.hi = getelementptr inbounds nuw i8, ptr %i.gz, i64 8 ; 4 uses
  %i.hj = getelementptr inbounds nuw i8, ptr %i.gz, i64 12 ; 4 uses
  %i.hk = add i64 %i.hg, -1                       ; 2 uses
  %i.hl = getelementptr i8, ptr %i.au, i64 %.pn143
  %scevgep368 = getelementptr i8, ptr %i.hl, i64 4
  %i.hm = getelementptr i8, ptr %i.au, i64 %.pn143
  %scevgep370 = getelementptr i8, ptr %i.hm, i64 8
  %i.hn = getelementptr i8, ptr %i.au, i64 %.pn143
  %scevgep372 = getelementptr i8, ptr %i.hn, i64 12
  %scevgep375 = getelementptr i8, ptr %i.au, i64 %.pn143
  %i.ho = shl i64 %i.hg, 4
  %i.hp = getelementptr i8, ptr %i.au, i64 %.pn143
  %scevgep377 = getelementptr i8, ptr %i.hp, i64 %i.ho
  %scevgep379 = getelementptr i8, ptr %i.gz, i64 16
  %min.iters.check384 = icmp ult i64 %i.hg, 18
  %mul.result = shl i64 %i.hk, 4                  ; 3 uses
  %mul.overflow = icmp ugt i64 %i.hk, 1152921504606846975
  %n.vec386 = and i64 %i.hg, 2305843009213693948  ; 4 uses
  %i.hq = shl nuw nsw i64 %n.vec386, 2
  %cmp.n401 = icmp eq i64 %i.hg, %n.vec386
...
vector.scevcheck:                                 ; preds = %.preheader144.us.us
  %i.hr = shl i64 %.1199.us.us, 2                 ; 3 uses
end_hunk_0
