...
begin_hunk_0_@_ZN2cv12cpu_baseline12_GLOBAL__N_113hlineSmooth5NIhNS_12_GLOBAL__N_113ufixedpoint16EEEvPKT_iPKT0_iPS8_iib:bb.a
  ...
  store i16 %i.arl, ptr %i.arm, align 2, !tbaa !47
  %i.arn = load i16, ptr %2, align 2, !tbaa !47, !noalias !1502
  %i.aro = zext i16 %i.arn to i32
  %i.arp = load i8, ptr %i.aqn, align 1, !tbaa !22, !noalias !1502
  ...
  %i.art = load i16, ptr %i.anq, align 2, !tbaa !47, !noalias !1503
  %i.aru = zext i16 %i.art to i32
  %i.arv = load i8, ptr %i.aqv, align 1, !tbaa !22, !noalias !1503
  ...
  %i.asa = load i16, ptr %i.anr, align 2, !tbaa !47, !noalias !1504
  %i.asb = zext i16 %i.asa to i32
  %i.asc = load i8, ptr %i.are, align 1, !tbaa !22, !noalias !1504
  ...
  store i16 %i.asg, ptr %i.ash, align 2, !tbaa !47
  ...
  br i1 %exitcond668.not, label %._crit_edge622, label %scalar.ph1393, !llvm.loop !1352
...
vector.ph1454:                                    ; preds = %vector.memcheck1424
  ...
  %i.asx = load i16, ptr %i.asp, align 2, !tbaa !47, !alias.scope !1512, !noalias !1513
  ...
  %i.asz = load i16, ptr %i.asq, align 2, !tbaa !47, !alias.scope !1512, !noalias !1514
  ...
  %i.atb = load i16, ptr %i.asp, align 2, !tbaa !47, !alias.scope !1512, !noalias !1515
...
vector.body1462:                                  ; preds = %vector.body1462, %vector.ph1454
  ...
  %wide.load1464 = load <8 x i8>, ptr %i.ate, align 1, !tbaa !22, !alias.scope !1516, !noalias !1513
  ...
  %wide.load1465 = load <8 x i16>, ptr %i.atd, align 2, !tbaa !47, !alias.scope !1517, !noalias !1518
  %i.atj = tail call <8 x i16> @llvm.uadd.sat.v8i16(<8 x i16> %wide.load1465, <8 x i16> %i.ati)
  store <8 x i16> %i.atj, ptr %i.atd, align 2, !tbaa !47, !alias.scope !1517, !noalias !1519
  %i.atk = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep713, i64 %index1463 ; 2 uses
  %wide.load1466 = load <8 x i8>, ptr %i.ate, align 1, !tbaa !22, !alias.scope !1516, !noalias !1514
  ...
  %wide.load1467 = load <8 x i16>, ptr %i.atk, align 2, !tbaa !47, !alias.scope !1520, !noalias !1521
  ...
  %wide.load1468 = load <8 x i8>, ptr %i.atq, align 1, !tbaa !22, !alias.scope !1522, !noalias !1515
  ...
  store <8 x i16> %i.atv, ptr %i.atk, align 2, !tbaa !47, !alias.scope !1520, !noalias !1519
  %index.next1469 = add nuw i64 %index1463, 8     ; 2 uses
  %i.atw = icmp eq i64 %index.next1469, %n.vec1455
  br i1 %i.atw, label %middle.block1470, label %vector.body1462, !llvm.loop !1369
...
scalar.ph1452:                                    ; preds = %scalar.ph1452.preheader, %scalar.ph1452
  ...
  %i.aty = load i16, ptr %i.asp, align 2, !tbaa !47, !noalias !1513
  %i.atz = zext i16 %i.aty to i32
  %i.aua = load i8, ptr %gep712, align 1, !tbaa !22, !noalias !1513
  ...
  %i.aue = load i16, ptr %i.atx, align 2, !tbaa !47, !noalias !1523
  %i.auf = tail call i16 @llvm.uadd.sat.i16(i16 %i.aue, i16 %i.aud)
  store i16 %i.auf, ptr %i.atx, align 2, !tbaa !47
  %gep714 = getelementptr inbounds nuw [2 x i8], ptr %invariant.gep713, i64 %indvars.iv669 ; 2 uses
  %i.aug = load i16, ptr %i.asq, align 2, !tbaa !47, !noalias !1514
  %i.auh = zext i16 %i.aug to i32
  %i.aui = load i8, ptr %gep712, align 1, !tbaa !22, !noalias !1514
  ...
  %i.aum = load i16, ptr %gep714, align 2, !tbaa !47, !noalias !1524
  %i.aun = tail call i16 @llvm.uadd.sat.i16(i16 %i.aum, i16 %i.aul)
  %gep716 = getelementptr i8, ptr %invariant.gep715, i64 %indvars.iv669
  %i.auo = load i16, ptr %i.asp, align 2, !tbaa !47, !noalias !1515
  %i.aup = zext i16 %i.auo to i32
  %i.auq = load i8, ptr %gep716, align 1, !tbaa !22, !noalias !1515
  ...
  store i16 %i.auu, ptr %gep714, align 2, !tbaa !47
  ...
  br i1 %exitcond673.not, label %.loopexit, label %scalar.ph1452, !llvm.loop !1370
...
.preheader242.lr.ph:                              ; preds = %bb.a
  ...
  %i.l = shl nsw i64 %i.e, 1
  %i.m = shl nsw i64 %i.e, 1
  %i.n = getelementptr i8, ptr %0, i64 %i.h
  %i.o = getelementptr i8, ptr %4, i64 %i.j
  %i.p = getelementptr i8, ptr %4, i64 %i.j
...
.preheader242:                                    ; preds = %.preheader242.lr.ph, %.loopexit240
  ...
  %indvars.iv356 = phi i64 [ %i.g, %.preheader242.lr.ph ], [ %indvars.iv.next357, %.loopexit240 ] ; 3 uses
  ...
  %scevgep492 = getelementptr i8, ptr %i.o, i64 %i.v ; 2 uses
  %i.w = zext i32 %indvars.iv345 to i64
  %i.x = shl nuw nsw i64 %i.w, 1
  %scevgep493 = getelementptr i8, ptr %2, i64 %i.x
  %i.y = mul i64 %i.l, %indvars.iv376
  %scevgep465 = getelementptr i8, ptr %i.p, i64 %i.y ; 2 uses
  %8 = shl nsw i64 %indvars.iv356, 1
  %scevgep466 = getelementptr i8, ptr %2, i64 %8
  %9 = sub i64 %i.f, %indvars.iv376
  %10 = shl i64 %9, 1
  %scevgep467 = getelementptr i8, ptr %2, i64 %10
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  %i.ah = load i16, ptr %i.af, align 2, !tbaa !47, !noalias !1607
  %i.ai = zext i16 %i.ah to i32
  %i.aj = load i8, ptr %i.ag, align 1, !tbaa !22, !noalias !1607
  ...
  store i16 %i.am, ptr %i.an, align 2, !tbaa !47
  br label %._crit_edge
...
.lr.ph.new:                                       ; preds = %.lr.ph, %.lr.ph.new
  ...
  %i.ap = load i16, ptr %i.af, align 2, !tbaa !47, !noalias !1607
  %i.aq = zext i16 %i.ap to i32
  %i.ar = load i8, ptr %i.ao, align 1, !tbaa !22, !noalias !1607
  ...
  store i16 %i.au, ptr %i.av, align 2, !tbaa !47
  %indvars.iv.next = or disjoint i64 %indvars.iv, 1 ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %0, i64 %indvars.iv.next
  %i.ax = load i16, ptr %i.af, align 2, !tbaa !47, !noalias !1607
  %i.ay = zext i16 %i.ax to i32
  %i.az = load i8, ptr %i.aw, align 1, !tbaa !22, !noalias !1607
  ...
  store i16 %i.bc, ptr %i.bd, align 2, !tbaa !47
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %.lr.ph.new, !llvm.loop !1527
...
vector.memcheck491:                               ; preds = %.lr.ph246.us
  %scevgep495 = getelementptr i8, ptr %i.n, i64 %i.bl
...
vector.ph505:                                     ; preds = %vector.memcheck491
  %i.bm = load i16, ptr %i.bj, align 2, !tbaa !47, !alias.scope !1608, !noalias !1609
...
vector.body509:                                   ; preds = %vector.body509, %vector.ph505
  ...
  %wide.load511 = load <8 x i8>, ptr %i.bp, align 1, !tbaa !22, !alias.scope !1610, !noalias !1609
  ...
  %wide.load512 = load <8 x i16>, ptr %i.bo, align 2, !tbaa !47, !alias.scope !1611, !noalias !1612
  %i.bu = tail call <8 x i16> @llvm.uadd.sat.v8i16(<8 x i16> %wide.load512, <8 x i16> %i.bt)
  store <8 x i16> %i.bu, ptr %i.bo, align 2, !tbaa !47, !alias.scope !1611, !noalias !1613
  %index.next513 = add nuw i64 %index510, 8       ; 2 uses
  %i.bv = icmp eq i64 %index.next513, %n.vec506
  br i1 %i.bv, label %middle.block514, label %vector.body509, !llvm.loop !1536
...
scalar.ph503.prol:                                ; preds = %scalar.ph503.preheader
  ...
  %i.bx = load i16, ptr %i.bj, align 2, !tbaa !47, !noalias !1609
  %i.by = zext i16 %i.bx to i32
  %i.bz = load i8, ptr %gep.prol, align 1, !tbaa !22, !noalias !1609
  ...
  %i.cd = load i16, ptr %i.bw, align 2, !tbaa !47, !noalias !1614
  %i.ce = tail call i16 @llvm.uadd.sat.i16(i16 %i.cd, i16 %i.cc)
  store i16 %i.ce, ptr %i.bw, align 2, !tbaa !47
...
scalar.ph503:                                     ; preds = %scalar.ph503.prol.loopexit, %scalar.ph503
  ...
  %i.ch = load i16, ptr %i.bj, align 2, !tbaa !47, !noalias !1609
  %i.ci = zext i16 %i.ch to i32
  %i.cj = load i8, ptr %gep, align 1, !tbaa !22, !noalias !1609
  ...
  %i.cn = load i16, ptr %i.cg, align 2, !tbaa !47, !noalias !1614
  %i.co = tail call i16 @llvm.uadd.sat.i16(i16 %i.cn, i16 %i.cm)
  store i16 %i.co, ptr %i.cg, align 2, !tbaa !47
  ...
  %i.cq = load i16, ptr %i.bj, align 2, !tbaa !47, !noalias !1609
  %i.cr = zext i16 %i.cq to i32
  %i.cs = load i8, ptr %gep.1, align 1, !tbaa !22, !noalias !1609
  ...
  %i.cw = load i16, ptr %i.cp, align 2, !tbaa !47, !noalias !1614
  %i.cx = tail call i16 @llvm.uadd.sat.i16(i16 %i.cw, i16 %i.cv)
  store i16 %i.cx, ptr %i.cp, align 2, !tbaa !47
  %indvars.iv.next338.1 = add nuw nsw i64 %indvars.iv337, 2 ; 2 uses
  %exitcond341.not.1 = icmp eq i64 %indvars.iv.next338.1, %i.h
  br i1 %exitcond341.not.1, label %._crit_edge247.us, label %scalar.ph503, !llvm.loop !1537
...
._crit_edge247.us:                                ; preds = %scalar.ph503.prol.loopexit, %scalar.ph503, %middle.block514
  ...
  br i1 %exitcond348.not, label %.loopexit241, label %.lr.ph246.us, !llvm.loop !1538
...
.lr.ph251.split:                                  ; preds = %.lr.ph251.split.preheader, %.lr.ph251.split
  ...
  br i1 %exitcond336.not, label %.loopexit241.thread, label %.lr.ph251.split, !llvm.loop !1538
...
vector.ph479:                                     ; preds = %.preheader238.us
  %i.dp = load i16, ptr %i.dn, align 2, !tbaa !47, !alias.scope !1615, !noalias !1616
...
vector.body483:                                   ; preds = %vector.body483, %vector.ph479
  ...
  %wide.load485 = load <8 x i8>, ptr %i.ds, align 1, !tbaa !22, !alias.scope !1617, !noalias !1616
  ...
  %wide.load486 = load <8 x i16>, ptr %i.dr, align 2, !tbaa !47, !alias.scope !1618, !noalias !1619
  %i.dx = tail call <8 x i16> @llvm.uadd.sat.v8i16(<8 x i16> %wide.load486, <8 x i16> %i.dw)
  store <8 x i16> %i.dx, ptr %i.dr, align 2, !tbaa !47, !alias.scope !1618, !noalias !1620
  %index.next487 = add nuw i64 %index484, 8       ; 2 uses
  %i.dy = icmp eq i64 %index.next487, %n.vec480
  br i1 %i.dy, label %middle.block488, label %vector.body483, !llvm.loop !1547
...
scalar.ph477.prol:                                ; preds = %scalar.ph477.preheader
  ...
  %i.ea = load i16, ptr %i.dn, align 2, !tbaa !47, !noalias !1616
  %i.eb = zext i16 %i.ea to i32
  %i.ec = load i8, ptr %gep435.prol, align 1, !tbaa !22, !noalias !1616
  ...
  %i.eg = load i16, ptr %i.dz, align 2, !tbaa !47, !noalias !1621
  %i.eh = tail call i16 @llvm.uadd.sat.i16(i16 %i.eg, i16 %i.ef)
  store i16 %i.eh, ptr %i.dz, align 2, !tbaa !47
...
begin_hunk_1_@_ZN2cv12cpu_baseline12_GLOBAL__N_120hlineSmoothONa_yzy_aIhNS_12_GLOBAL__N_113ufixedpoint16EEEvPKT_iPKT0_iPS8_iib:bb.a
  %i.od = load i16, ptr %2, align 2, !tbaa !47, !noalias !1637
  %i.oe = zext i16 %i.od to i32
  %i.of = load i8, ptr %i.oc, align 1, !tbaa !22, !noalias !1637
  ...
  store i16 %i.oi, ptr %i.oj, align 2, !tbaa !47
  ...
  %i.ol = load i16, ptr %2, align 2, !tbaa !47, !noalias !1637
  %i.om = zext i16 %i.ol to i32
  %i.on = load i8, ptr %i.ok, align 1, !tbaa !22, !noalias !1637
...
vector.ph575:                                     ; preds = %vector.memcheck557
  %i.pk = load i16, ptr %i.ph, align 2, !tbaa !47, !alias.scope !1648, !noalias !1649
...
vector.body579:                                   ; preds = %vector.body579, %vector.ph575
  ...
  %wide.load581 = load <8 x i8>, ptr %i.pn, align 1, !tbaa !22, !alias.scope !1650, !noalias !1649
  ...
  %wide.load582 = load <8 x i16>, ptr %i.pm, align 2, !tbaa !47, !alias.scope !1651, !noalias !1652
  %i.ps = tail call <8 x i16> @llvm.uadd.sat.v8i16(<8 x i16> %wide.load582, <8 x i16> %i.pr)
  store <8 x i16> %i.ps, ptr %i.pm, align 2, !tbaa !47, !alias.scope !1651, !noalias !1653
  %index.next583 = add nuw i64 %index580, 8       ; 2 uses
  %i.pt = icmp eq i64 %index.next583, %n.vec576
  br i1 %i.pt, label %middle.block584, label %vector.body579, !llvm.loop !1603
...
scalar.ph573.prol:                                ; preds = %scalar.ph573.preheader
  ...
  %i.pv = load i16, ptr %i.ph, align 2, !tbaa !47, !noalias !1649
  %i.pw = zext i16 %i.pv to i32
  %i.px = load i8, ptr %gep441.prol, align 1, !tbaa !22, !noalias !1649
  ...
  %i.qb = load i16, ptr %i.pu, align 2, !tbaa !47, !noalias !1654
  %i.qc = tail call i16 @llvm.uadd.sat.i16(i16 %i.qb, i16 %i.qa)
  store i16 %i.qc, ptr %i.pu, align 2, !tbaa !47
...
scalar.ph573:                                     ; preds = %scalar.ph573.prol.loopexit, %scalar.ph573
  ...
  %i.qf = load i16, ptr %i.ph, align 2, !tbaa !47, !noalias !1649
  %i.qg = zext i16 %i.qf to i32
  %i.qh = load i8, ptr %gep441, align 1, !tbaa !22, !noalias !1649
  ...
  %i.ql = load i16, ptr %i.qe, align 2, !tbaa !47, !noalias !1654
  %i.qm = tail call i16 @llvm.uadd.sat.i16(i16 %i.ql, i16 %i.qk)
  store i16 %i.qm, ptr %i.qe, align 2, !tbaa !47
  ...
  %i.qo = load i16, ptr %i.ph, align 2, !tbaa !47, !noalias !1649
  %i.qp = zext i16 %i.qo to i32
  %i.qq = load i8, ptr %gep441.1, align 1, !tbaa !22, !noalias !1649
  ...
  %i.qu = load i16, ptr %i.qn, align 2, !tbaa !47, !noalias !1654
  %i.qv = tail call i16 @llvm.uadd.sat.i16(i16 %i.qu, i16 %i.qt)
  store i16 %i.qv, ptr %i.qn, align 2, !tbaa !47
  %indvars.iv.next403.1 = add nuw nsw i64 %indvars.iv402, 2 ; 2 uses
  %exitcond406.not.1 = icmp eq i64 %indvars.iv.next403.1, %i.km
  br i1 %exitcond406.not.1, label %._crit_edge304.us, label %scalar.ph573, !llvm.loop !1604
...
._crit_edge304.us:                                ; preds = %scalar.ph573.prol.loopexit, %scalar.ph573, %middle.block584
  ...
  br i1 %i.qx, label %.lr.ph303.us, label %.loopexit, !llvm.loop !1605
...
.lr.ph306.split:                                  ; preds = %.lr.ph306.split.preheader, %.lr.ph306.split
  ...
  br i1 %exitcond401.not, label %.loopexit, label %.lr.ph306.split, !llvm.loop !1605
...
.loopexit:                                        ; preds = %.lr.ph306.split, %._crit_edge304.us, %._crit_edge298
  ...
  br i1 %i.rd, label %.preheader237, label %._crit_edge316, !llvm.loop !1606
...
.preheader229:                                    ; preds = %.preheader229.lr.ph, %.loopexit227
  ...
  %indvars.iv343 = phi i64 [ %i.g, %.preheader229.lr.ph ], [ %indvars.iv.next344, %.loopexit227 ] ; 3 uses
  ...
  %scevgep479 = getelementptr i8, ptr %i.o, i64 %i.v ; 2 uses
  %i.w = zext i32 %indvars.iv332 to i64
  %i.x = shl nuw nsw i64 %i.w, 1
  %scevgep480 = getelementptr i8, ptr %2, i64 %i.x
  %i.y = mul i64 %i.l, %indvars.iv363
  %scevgep452 = getelementptr i8, ptr %i.p, i64 %i.y ; 2 uses
  %8 = shl nsw i64 %indvars.iv343, 1
  %scevgep453 = getelementptr i8, ptr %2, i64 %8
  %9 = sub i64 %i.f, %indvars.iv363
  %10 = shl i64 %9, 1
  %scevgep454 = getelementptr i8, ptr %2, i64 %10
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  %i.ag = getelementptr inbounds nuw i8, ptr %0, i64 %indvars.iv.epil.init
  %i.ah = load i16, ptr %i.af, align 2, !tbaa !47, !noalias !1735
  %i.ai = zext i16 %i.ah to i32
  %i.aj = load i8, ptr %i.ag, align 1, !tbaa !22, !noalias !1735
  %i.ak = zext i8 %i.aj to i32
  %i.al = mul nuw nsw i32 %i.ak, %i.ai
  %.sroa.speculated.i.epil = tail call i32 @llvm.umin.i32(i32 range(i32 0, 83557126) %i.al, i32 65535)
  %i.am = trunc nuw i32 %.sroa.speculated.i.epil to i16
...
.lr.ph.new:                                       ; preds = %.lr.ph, %.lr.ph.new
  ...
  %niter = phi i64 [ %niter.next.1, %.lr.ph.new ], [ 0, %.lr.ph ]
  %i.ao = getelementptr inbounds nuw i8, ptr %0, i64 %indvars.iv
  %i.ap = load i16, ptr %i.af, align 2, !tbaa !47, !noalias !1735
  %i.aq = zext i16 %i.ap to i32
  %i.ar = load i8, ptr %i.ao, align 1, !tbaa !22, !noalias !1735
  %i.as = zext i8 %i.ar to i32
  %i.at = mul nuw nsw i32 %i.as, %i.aq
  %.sroa.speculated.i = tail call i32 @llvm.umin.i32(i32 range(i32 0, 83557126) %i.at, i32 65535)
  %i.au = trunc nuw i32 %.sroa.speculated.i to i16
  ...
  %indvars.iv.next = or disjoint i64 %indvars.iv, 1 ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %0, i64 %indvars.iv.next
  %i.ax = load i16, ptr %i.af, align 2, !tbaa !47, !noalias !1735
  %i.ay = zext i16 %i.ax to i32
  %i.az = load i8, ptr %i.aw, align 1, !tbaa !22, !noalias !1735
  %i.ba = zext i8 %i.az to i32
  %i.bb = mul nuw nsw i32 %i.ba, %i.ay
  %.sroa.speculated.i.1 = tail call i32 @llvm.umin.i32(i32 range(i32 0, 83557126) %i.bb, i32 65535)
  %i.bc = trunc nuw i32 %.sroa.speculated.i.1 to i16
  ...
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %.lr.ph.new, !llvm.loop !1657
...
vector.memcheck478:                               ; preds = %.lr.ph233.us
  %scevgep482 = getelementptr i8, ptr %i.n, i64 %i.bl
...
vector.ph492:                                     ; preds = %vector.memcheck478
  %i.bm = load i16, ptr %i.bj, align 2, !tbaa !47, !alias.scope !1736, !noalias !1737
...
vector.body496:                                   ; preds = %vector.body496, %vector.ph492
  ...
  %wide.load498 = load <8 x i8>, ptr %i.bp, align 1, !tbaa !22, !alias.scope !1738, !noalias !1737
  %i.bq = zext <8 x i8> %wide.load498 to <8 x i32>
  %i.br = mul nuw nsw <8 x i32> %i.bq, %i.bn
  %i.bs = tail call <8 x i32> @llvm.umin.v8i32(<8 x i32> %i.br, <8 x i32> splat (i32 65535))
  %i.bt = trunc nuw <8 x i32> %i.bs to <8 x i16>
  %wide.load499 = load <8 x i16>, ptr %i.bo, align 2, !tbaa !47, !alias.scope !1739, !noalias !1740
  %i.bu = tail call <8 x i16> @llvm.uadd.sat.v8i16(<8 x i16> %wide.load499, <8 x i16> %i.bt)
  store <8 x i16> %i.bu, ptr %i.bo, align 2, !tbaa !47, !alias.scope !1739, !noalias !1741
  %index.next500 = add nuw i64 %index497, 8       ; 2 uses
  %i.bv = icmp eq i64 %index.next500, %n.vec493
  br i1 %i.bv, label %middle.block501, label %vector.body496, !llvm.loop !1666
...
scalar.ph490.prol:                                ; preds = %scalar.ph490.preheader
  ...
  %i.bx = load i16, ptr %i.bj, align 2, !tbaa !47, !noalias !1737
  %i.by = zext i16 %i.bx to i32
  %i.bz = load i8, ptr %gep.prol, align 1, !tbaa !22, !noalias !1737
  %i.ca = zext i8 %i.bz to i32
  %i.cb = mul nuw nsw i32 %i.ca, %i.by
  ...
  %i.cd = load i16, ptr %i.bw, align 2, !tbaa !47, !noalias !1742
  %i.ce = tail call i16 @llvm.uadd.sat.i16(i16 %i.cd, i16 %i.cc)
  store i16 %i.ce, ptr %i.bw, align 2, !tbaa !47
...
scalar.ph490:                                     ; preds = %scalar.ph490.prol.loopexit, %scalar.ph490
  ...
  %i.ch = load i16, ptr %i.bj, align 2, !tbaa !47, !noalias !1737
  %i.ci = zext i16 %i.ch to i32
  %i.cj = load i8, ptr %gep, align 1, !tbaa !22, !noalias !1737
  %i.ck = zext i8 %i.cj to i32
  %i.cl = mul nuw nsw i32 %i.ck, %i.ci
  ...
  %i.cn = load i16, ptr %i.cg, align 2, !tbaa !47, !noalias !1742
  %i.co = tail call i16 @llvm.uadd.sat.i16(i16 %i.cn, i16 %i.cm)
  store i16 %i.co, ptr %i.cg, align 2, !tbaa !47
  ...
  %i.cq = load i16, ptr %i.bj, align 2, !tbaa !47, !noalias !1737
  %i.cr = zext i16 %i.cq to i32
  %i.cs = load i8, ptr %gep.1, align 1, !tbaa !22, !noalias !1737
  %i.ct = zext i8 %i.cs to i32
  %i.cu = mul nuw nsw i32 %i.ct, %i.cr
  ...
  %i.cw = load i16, ptr %i.cp, align 2, !tbaa !47, !noalias !1742
  %i.cx = tail call i16 @llvm.uadd.sat.i16(i16 %i.cw, i16 %i.cv)
  store i16 %i.cx, ptr %i.cp, align 2, !tbaa !47
  %indvars.iv.next325.1 = add nuw nsw i64 %indvars.iv324, 2 ; 2 uses
  %exitcond328.not.1 = icmp eq i64 %indvars.iv.next325.1, %i.h
  br i1 %exitcond328.not.1, label %._crit_edge234.us, label %scalar.ph490, !llvm.loop !1667
...
._crit_edge234.us:                                ; preds = %scalar.ph490.prol.loopexit, %scalar.ph490, %middle.block501
  ...
  br i1 %exitcond335.not, label %.loopexit228, label %.lr.ph233.us, !llvm.loop !1668
...
.lr.ph238.split:                                  ; preds = %.lr.ph238.split.preheader, %.lr.ph238.split
  ...
  br i1 %exitcond323.not, label %.loopexit228.thread, label %.lr.ph238.split, !llvm.loop !1668
...
vector.ph466:                                     ; preds = %.preheader225.us
  %i.dp = load i16, ptr %i.dn, align 2, !tbaa !47, !alias.scope !1743, !noalias !1744
...
vector.body470:                                   ; preds = %vector.body470, %vector.ph466
  ...
  %wide.load472 = load <8 x i8>, ptr %i.ds, align 1, !tbaa !22, !alias.scope !1745, !noalias !1744
  %i.dt = zext <8 x i8> %wide.load472 to <8 x i32>
  %i.du = mul nuw nsw <8 x i32> %i.dt, %i.dq
  %i.dv = tail call <8 x i32> @llvm.umin.v8i32(<8 x i32> %i.du, <8 x i32> splat (i32 65535))
  %i.dw = trunc nuw <8 x i32> %i.dv to <8 x i16>
  %wide.load473 = load <8 x i16>, ptr %i.dr, align 2, !tbaa !47, !alias.scope !1746, !noalias !1747
  %i.dx = tail call <8 x i16> @llvm.uadd.sat.v8i16(<8 x i16> %wide.load473, <8 x i16> %i.dw)
  store <8 x i16> %i.dx, ptr %i.dr, align 2, !tbaa !47, !alias.scope !1746, !noalias !1748
  %index.next474 = add nuw i64 %index471, 8       ; 2 uses
  %i.dy = icmp eq i64 %index.next474, %n.vec467
  br i1 %i.dy, label %middle.block475, label %vector.body470, !llvm.loop !1677
...
scalar.ph464.prol:                                ; preds = %scalar.ph464.preheader
  ...
  %i.ea = load i16, ptr %i.dn, align 2, !tbaa !47, !noalias !1744
  %i.eb = zext i16 %i.ea to i32
  %i.ec = load i8, ptr %gep422.prol, align 1, !tbaa !22, !noalias !1744
  %i.ed = zext i8 %i.ec to i32
  %i.ee = mul nuw nsw i32 %i.ed, %i.eb
  ...
  %i.eg = load i16, ptr %i.dz, align 2, !tbaa !47, !noalias !1749
  %i.eh = tail call i16 @llvm.uadd.sat.i16(i16 %i.eg, i16 %i.ef)
  store i16 %i.eh, ptr %i.dz, align 2, !tbaa !47
...
begin_hunk_2_@_ZN2cv12cpu_baseline12_GLOBAL__N_113hlineSmooth5NItNS_12_GLOBAL__N_113ufixedpoint32EEEvPKT_iPKT0_iPS8_iib:bb.a
  ...
  %i.aka = load i32, ptr %i.ahi, align 4, !tbaa !74, !noalias !2768
  %i.akb = zext i32 %i.aka to i64
  %i.akc = load i16, ptr %i.ajz, align 2, !tbaa !113, !noalias !2768
  ...
  %i.aki = load i32, ptr %i.ahj, align 4, !tbaa !74, !noalias !2769
  %i.akj = zext i32 %i.aki to i64
  %i.akk = load i16, ptr %i.akh, align 2, !tbaa !113, !noalias !2769
  ...
  %i.akr = load i32, ptr %i.ahk, align 4, !tbaa !74, !noalias !2770
  %i.aks = zext i32 %i.akr to i64
  %i.akt = load i16, ptr %i.akq, align 2, !tbaa !113, !noalias !2770
  ...
  store i32 %i.akx, ptr %i.aky, align 4, !tbaa !74
  %i.akz = load i32, ptr %2, align 4, !tbaa !74, !noalias !2771
  ...
  %i.ald = load i32, ptr %i.ahi, align 4, !tbaa !74, !noalias !2772
  ...
  %i.ali = load i32, ptr %i.ahj, align 4, !tbaa !74, !noalias !2773
  ...
  store i32 %i.alm, ptr %i.aln, align 4, !tbaa !74
  ...
  br i1 %exitcond667.not, label %._crit_edge621, label %scalar.ph1038, !llvm.loop !2661
...
vector.ph1078:                                    ; preds = %vector.memcheck1066
  ...
  %i.amc = load i32, ptr %i.alw, align 4, !tbaa !74, !alias.scope !2776, !noalias !2777
  ...
  %i.ame = load i32, ptr %i.alx, align 4, !tbaa !74, !alias.scope !2776, !noalias !2778
  ...
  %i.amg = load i32, ptr %i.alw, align 4, !tbaa !74, !alias.scope !2776, !noalias !2779
...
vector.body1086:                                  ; preds = %vector.body1086, %vector.ph1078
  ...
  %wide.load1088 = load <4 x i16>, ptr %i.amj, align 2, !tbaa !113, !noalias !2777
  ...
  %wide.load1089 = load <4 x i32>, ptr %i.ami, align 4, !tbaa !74, !alias.scope !2780, !noalias !2781
  %i.amo = tail call <4 x i32> @llvm.uadd.sat.v4i32(<4 x i32> %wide.load1089, <4 x i32> %i.amn)
  store <4 x i32> %i.amo, ptr %i.ami, align 4, !tbaa !74, !alias.scope !2780, !noalias !2776
  ...
  %wide.load1090 = load <4 x i32>, ptr %i.amp, align 4, !tbaa !74, !alias.scope !2782, !noalias !2783
  ...
  %wide.load1091 = load <4 x i16>, ptr %i.amu, align 2, !tbaa !113, !noalias !2779
  ...
  store <4 x i32> %i.amz, ptr %i.amp, align 4, !tbaa !74, !alias.scope !2782, !noalias !2776
  %index.next1092 = add nuw i64 %index1087, 4     ; 2 uses
  %i.ana = icmp eq i64 %index.next1092, %n.vec1079
  br i1 %i.ana, label %middle.block1093, label %vector.body1086, !llvm.loop !2676
...
scalar.ph1076:                                    ; preds = %scalar.ph1076.preheader, %scalar.ph1076
  ...
  %i.anc = load i32, ptr %i.alw, align 4, !tbaa !74, !noalias !2777
  %i.and = zext i32 %i.anc to i64
  %i.ane = load i16, ptr %gep711, align 2, !tbaa !113, !noalias !2777
  ...
  %i.ani = load i32, ptr %i.anb, align 4, !tbaa !74, !noalias !2784
  %i.anj = tail call i32 @llvm.uadd.sat.i32(i32 %i.ani, i32 %i.anh)
  store i32 %i.anj, ptr %i.anb, align 4, !tbaa !74
  %gep713 = getelementptr inbounds nuw [4 x i8], ptr %invariant.gep712, i64 %indvars.iv668 ; 2 uses
  %i.ank = load i32, ptr %i.alx, align 4, !tbaa !74, !noalias !2778
  ...
  %i.ano = load i32, ptr %gep713, align 4, !tbaa !74, !noalias !2785
  ...
  %i.anq = load i32, ptr %i.alw, align 4, !tbaa !74, !noalias !2779
  %i.anr = zext i32 %i.anq to i64
  %i.ans = load i16, ptr %gep715, align 2, !tbaa !113, !noalias !2779
  ...
  store i32 %i.anw, ptr %gep713, align 4, !tbaa !74
  ...
  br i1 %exitcond672.not, label %.loopexit, label %scalar.ph1076, !llvm.loop !2677
...
.preheader242.lr.ph:                              ; preds = %bb.a
  ...
  %i.l = shl nsw i64 %i.e, 2
  %i.m = shl nsw i64 %i.e, 2
  %i.n = getelementptr i8, ptr %4, i64 %i.j
  %i.o = getelementptr i8, ptr %4, i64 %i.j
  %i.p = getelementptr i8, ptr %4, i64 %i.j
  %xtraiter = and i64 %i.h, 1
  %i.q = icmp eq i32 %1, 1
...
.preheader242:                                    ; preds = %.preheader242.lr.ph, %.loopexit240
  ...
  %scevgep483 = getelementptr i8, ptr %i.n, i64 %i.u
  %i.v = zext i32 %indvars.iv345 to i64
  %i.w = shl nuw nsw i64 %i.v, 2
  %scevgep484 = getelementptr i8, ptr %2, i64 %i.w
  %i.x = mul i64 %i.l, %indvars.iv376
  %scevgep461 = getelementptr i8, ptr %i.o, i64 %i.x
  %8 = shl nsw i64 %indvars.iv356, 2
  %scevgep462 = getelementptr i8, ptr %2, i64 %8
  %9 = sub i64 %i.f, %indvars.iv376
  %10 = shl i64 %9, 2
  %scevgep463 = getelementptr i8, ptr %2, i64 %10
  %smin = tail call i32 @llvm.smin.i32(i32 %5, i32 %indvars.iv349)
  %i.y = zext i32 %smin to i64
  %i.z = shl nuw nsw i64 %i.y, 2
  %scevgep464 = getelementptr i8, ptr %scevgep463, i64 %i.z
  %i.aa = mul i64 %i.k, %indvars.iv376
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  %i.af = load i32, ptr %i.ad, align 4, !tbaa !74, !noalias !2861
  %i.ag = zext i32 %i.af to i64
  %i.ah = load i16, ptr %i.ae, align 2, !tbaa !113, !noalias !2861
...
.lr.ph.new:                                       ; preds = %.lr.ph, %.lr.ph.new
  ...
  %i.an = load i32, ptr %i.ad, align 4, !tbaa !74, !noalias !2861
  %i.ao = zext i32 %i.an to i64
  %i.ap = load i16, ptr %i.am, align 2, !tbaa !113, !noalias !2861
  ...
  store i32 %i.as, ptr %i.at, align 4, !tbaa !74
  %indvars.iv.next = or disjoint i64 %indvars.iv, 1 ; 2 uses
  %i.au = getelementptr inbounds nuw [2 x i8], ptr %0, i64 %indvars.iv.next
  %i.av = load i32, ptr %i.ad, align 4, !tbaa !74, !noalias !2861
  %i.aw = zext i32 %i.av to i64
  %i.ax = load i16, ptr %i.au, align 2, !tbaa !113, !noalias !2861
  ...
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %.lr.ph.new, !llvm.loop !2788
...
vector.ph490:                                     ; preds = %.lr.ph246.us
  %i.bk = load i32, ptr %i.bh, align 4, !tbaa !74, !alias.scope !2862, !noalias !2863
...
vector.body494:                                   ; preds = %vector.body494, %vector.ph490
  ...
  %wide.load496 = load <4 x i16>, ptr %i.bn, align 2, !tbaa !113, !noalias !2863
  ...
  %wide.load497 = load <4 x i32>, ptr %i.bm, align 4, !tbaa !74, !alias.scope !2864, !noalias !2865
  %i.bs = tail call <4 x i32> @llvm.uadd.sat.v4i32(<4 x i32> %wide.load497, <4 x i32> %i.br)
  store <4 x i32> %i.bs, ptr %i.bm, align 4, !tbaa !74, !alias.scope !2864, !noalias !2862
  %index.next498 = add nuw i64 %index495, 4       ; 2 uses
  %i.bt = icmp eq i64 %index.next498, %n.vec491
  br i1 %i.bt, label %middle.block499, label %vector.body494, !llvm.loop !2796
...
scalar.ph488.prol:                                ; preds = %scalar.ph488.preheader
  ...
  %i.bv = load i32, ptr %i.bh, align 4, !tbaa !74, !noalias !2863
  %i.bw = zext i32 %i.bv to i64
  %i.bx = load i16, ptr %gep.prol, align 2, !tbaa !113, !noalias !2863
  ...
  %i.cb = load i32, ptr %i.bu, align 4, !tbaa !74, !noalias !2866
  %i.cc = tail call i32 @llvm.uadd.sat.i32(i32 %i.cb, i32 %i.ca)
  store i32 %i.cc, ptr %i.bu, align 4, !tbaa !74
  %indvars.iv.next338.prol = or disjoint i64 %indvars.iv337.ph, 1
...
scalar.ph488:                                     ; preds = %scalar.ph488.prol.loopexit, %scalar.ph488
  ...
  %i.cf = load i32, ptr %i.bh, align 4, !tbaa !74, !noalias !2863
  %i.cg = zext i32 %i.cf to i64
  %i.ch = load i16, ptr %gep, align 2, !tbaa !113, !noalias !2863
  ...
  %i.cl = load i32, ptr %i.ce, align 4, !tbaa !74, !noalias !2866
  %i.cm = tail call i32 @llvm.uadd.sat.i32(i32 %i.cl, i32 %i.ck)
  store i32 %i.cm, ptr %i.ce, align 4, !tbaa !74
  %indvars.iv.next338 = add nuw nsw i64 %indvars.iv337, 1 ; 2 uses
  ...
  %i.co = load i32, ptr %i.bh, align 4, !tbaa !74, !noalias !2863
  %i.cp = zext i32 %i.co to i64
  %i.cq = load i16, ptr %gep.1, align 2, !tbaa !113, !noalias !2863
  ...
  %i.cu = load i32, ptr %i.cn, align 4, !tbaa !74, !noalias !2866
  %i.cv = tail call i32 @llvm.uadd.sat.i32(i32 %i.cu, i32 %i.ct)
  store i32 %i.cv, ptr %i.cn, align 4, !tbaa !74
  %indvars.iv.next338.1 = add nuw nsw i64 %indvars.iv337, 2 ; 2 uses
  %exitcond341.not.1 = icmp eq i64 %indvars.iv.next338.1, %i.h
  br i1 %exitcond341.not.1, label %._crit_edge247.us, label %scalar.ph488, !llvm.loop !2797

._crit_edge247.us:                                ; preds = %scalar.ph488.prol.loopexit, %scalar.ph488, %middle.block499
  %i.cw = add nsw i32 %.0168248.us, 1
  %indvars.iv.next343 = add nuw nsw i64 %indvars.iv342, 1 ; 2 uses
  %exitcond348.not = icmp eq i64 %indvars.iv.next343, %wide.trip.count347
  br i1 %exitcond348.not, label %.loopexit241, label %.lr.ph246.us, !llvm.loop !2798
...
.lr.ph251.split:                                  ; preds = %.lr.ph251.split.preheader, %.lr.ph251.split
  ...
  br i1 %exitcond336.not, label %.loopexit241.thread, label %.lr.ph251.split, !llvm.loop !2798
...
begin_hunk_3_@_ZN2cv12cpu_baseline12_GLOBAL__N_120hlineSmoothONa_yzy_aItNS_12_GLOBAL__N_113ufixedpoint32EEEvPKT_iPKT0_iPS8_iib:bb.a
  ...
  br i1 %i.nq, label %.preheader.us, label %._crit_edge298.loopexit, !llvm.loop !2848
...
.lr.ph293:                                        ; preds = %.lr.ph293.prol.loopexit, %.lr.ph293
  ...
  %i.ns = load i32, ptr %2, align 4, !tbaa !74, !noalias !2883
  %i.nt = zext i32 %i.ns to i64
  %i.nu = load i16, ptr %i.nr, align 2, !tbaa !113, !noalias !2883
  ...
  store i32 %i.nx, ptr %i.ny, align 4, !tbaa !74
  ...
  %i.oa = load i32, ptr %2, align 4, !tbaa !74, !noalias !2883
  %i.ob = zext i32 %i.oa to i64
  %i.oc = load i16, ptr %i.nz, align 2, !tbaa !113, !noalias !2883
...
vector.ph543:                                     ; preds = %.lr.ph303.us
  %i.oz = load i32, ptr %i.ow, align 4, !tbaa !74, !alias.scope !2890, !noalias !2891
...
vector.body547:                                   ; preds = %vector.body547, %vector.ph543
  ...
  %wide.load549 = load <4 x i16>, ptr %i.pc, align 2, !tbaa !113, !noalias !2891
  ...
  %wide.load550 = load <4 x i32>, ptr %i.pb, align 4, !tbaa !74, !alias.scope !2892, !noalias !2893
  %i.ph = tail call <4 x i32> @llvm.uadd.sat.v4i32(<4 x i32> %wide.load550, <4 x i32> %i.pg)
  store <4 x i32> %i.ph, ptr %i.pb, align 4, !tbaa !74, !alias.scope !2892, !noalias !2890
  %index.next551 = add nuw i64 %index548, 4       ; 2 uses
  %i.pi = icmp eq i64 %index.next551, %n.vec544
  br i1 %i.pi, label %middle.block552, label %vector.body547, !llvm.loop !2857
...
scalar.ph541.prol:                                ; preds = %scalar.ph541.preheader
  ...
  %i.pk = load i32, ptr %i.ow, align 4, !tbaa !74, !noalias !2891
  %i.pl = zext i32 %i.pk to i64
  %i.pm = load i16, ptr %gep442.prol, align 2, !tbaa !113, !noalias !2891
  ...
  %i.pq = load i32, ptr %i.pj, align 4, !tbaa !74, !noalias !2894
  %i.pr = tail call i32 @llvm.uadd.sat.i32(i32 %i.pq, i32 %i.pp)
  store i32 %i.pr, ptr %i.pj, align 4, !tbaa !74
...
scalar.ph541:                                     ; preds = %scalar.ph541.prol.loopexit, %scalar.ph541
  ...
  %i.pu = load i32, ptr %i.ow, align 4, !tbaa !74, !noalias !2891
  %i.pv = zext i32 %i.pu to i64
  %i.pw = load i16, ptr %gep442, align 2, !tbaa !113, !noalias !2891
  ...
  %i.qa = load i32, ptr %i.pt, align 4, !tbaa !74, !noalias !2894
  %i.qb = tail call i32 @llvm.uadd.sat.i32(i32 %i.qa, i32 %i.pz)
  store i32 %i.qb, ptr %i.pt, align 4, !tbaa !74
  ...
  %i.qd = load i32, ptr %i.ow, align 4, !tbaa !74, !noalias !2891
  %i.qe = zext i32 %i.qd to i64
  %i.qf = load i16, ptr %gep442.1, align 2, !tbaa !113, !noalias !2891
  ...
  %i.qj = load i32, ptr %i.qc, align 4, !tbaa !74, !noalias !2894
  %i.qk = tail call i32 @llvm.uadd.sat.i32(i32 %i.qj, i32 %i.qi)
  store i32 %i.qk, ptr %i.qc, align 4, !tbaa !74
  %indvars.iv.next404.1 = add nuw nsw i64 %indvars.iv403, 2 ; 2 uses
  %exitcond407.not.1 = icmp eq i64 %indvars.iv.next404.1, %i.kk
  br i1 %exitcond407.not.1, label %._crit_edge304.us, label %scalar.ph541, !llvm.loop !2858
...
._crit_edge304.us:                                ; preds = %scalar.ph541.prol.loopexit, %scalar.ph541, %middle.block552
  ...
  br i1 %i.qm, label %.lr.ph303.us, label %.loopexit, !llvm.loop !2859
...
.lr.ph306.split:                                  ; preds = %.lr.ph306.split.preheader, %.lr.ph306.split
  ...
  br i1 %exitcond402.not, label %.loopexit, label %.lr.ph306.split, !llvm.loop !2859
...
.loopexit:                                        ; preds = %.lr.ph306.split, %._crit_edge304.us, %._crit_edge298
  ...
  br i1 %i.qs, label %.preheader237, label %._crit_edge316, !llvm.loop !2860
...
.preheader228:                                    ; preds = %.preheader228.lr.ph, %.loopexit226
  ...
  %indvars.iv342 = phi i64 [ %i.g, %.preheader228.lr.ph ], [ %indvars.iv.next343, %.loopexit226 ] ; 3 uses
  ...
  %scevgep469 = getelementptr i8, ptr %i.n, i64 %i.u
  %i.v = zext i32 %indvars.iv331 to i64
  %i.w = shl nuw nsw i64 %i.v, 2
  %scevgep470 = getelementptr i8, ptr %2, i64 %i.w
  %i.x = mul i64 %i.l, %indvars.iv362
  %scevgep447 = getelementptr i8, ptr %i.o, i64 %i.x
  %8 = shl nsw i64 %indvars.iv342, 2
  %scevgep448 = getelementptr i8, ptr %2, i64 %8
  %9 = sub i64 %i.f, %indvars.iv362
  %10 = shl i64 %9, 2
  %scevgep449 = getelementptr i8, ptr %2, i64 %10
  %smin = tail call i32 @llvm.smin.i32(i32 %5, i32 %indvars.iv335)
  %i.y = zext i32 %smin to i64
  %i.z = shl nuw nsw i64 %i.y, 2
  %scevgep450 = getelementptr i8, ptr %scevgep449, i64 %i.z
  %i.aa = mul i64 %i.k, %indvars.iv362
  %scevgep = getelementptr i8, ptr %i.p, i64 %i.aa
...
.epil.preheader:                                  ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph
  ...
  %i.ae = getelementptr inbounds nuw [2 x i8], ptr %0, i64 %indvars.iv.epil.init
  %i.af = load i32, ptr %i.ad, align 4, !tbaa !74, !noalias !2968
  %i.ag = zext i32 %i.af to i64
  %i.ah = load i16, ptr %i.ae, align 2, !tbaa !113, !noalias !2968
  %i.ai = zext i16 %i.ah to i64
  %i.aj = mul nuw nsw i64 %i.ai, %i.ag
  %.sroa.speculated.i.epil = tail call i64 @llvm.umin.i64(i64 range(i64 0, 281470681677826) %i.aj, i64 4294967295)
  %i.ak = trunc nuw i64 %.sroa.speculated.i.epil to i32
...
.lr.ph.new:                                       ; preds = %.lr.ph, %.lr.ph.new
  ...
  %niter = phi i64 [ %niter.next.1, %.lr.ph.new ], [ 0, %.lr.ph ]
  %i.am = getelementptr inbounds nuw [2 x i8], ptr %0, i64 %indvars.iv
  %i.an = load i32, ptr %i.ad, align 4, !tbaa !74, !noalias !2968
  %i.ao = zext i32 %i.an to i64
  %i.ap = load i16, ptr %i.am, align 2, !tbaa !113, !noalias !2968
  %i.aq = zext i16 %i.ap to i64
  %i.ar = mul nuw nsw i64 %i.aq, %i.ao
  %.sroa.speculated.i = tail call i64 @llvm.umin.i64(i64 range(i64 0, 281470681677826) %i.ar, i64 4294967295)
  %i.as = trunc nuw i64 %.sroa.speculated.i to i32
  ...
  %indvars.iv.next = or disjoint i64 %indvars.iv, 1 ; 2 uses
  %i.au = getelementptr inbounds nuw [2 x i8], ptr %0, i64 %indvars.iv.next
  %i.av = load i32, ptr %i.ad, align 4, !tbaa !74, !noalias !2968
  %i.aw = zext i32 %i.av to i64
  %i.ax = load i16, ptr %i.au, align 2, !tbaa !113, !noalias !2968
  %i.ay = zext i16 %i.ax to i64
  %i.az = mul nuw nsw i64 %i.ay, %i.aw
  %.sroa.speculated.i.1 = tail call i64 @llvm.umin.i64(i64 range(i64 0, 281470681677826) %i.az, i64 4294967295)
  %i.ba = trunc nuw i64 %.sroa.speculated.i.1 to i32
  ...
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.loopexit.unr-lcssa, label %.lr.ph.new, !llvm.loop !2897
...
vector.ph476:                                     ; preds = %.lr.ph232.us
  %i.bk = load i32, ptr %i.bh, align 4, !tbaa !74, !alias.scope !2969, !noalias !2970
...
vector.body480:                                   ; preds = %vector.body480, %vector.ph476
  ...
  %wide.load482 = load <4 x i16>, ptr %i.bn, align 2, !tbaa !113, !noalias !2970
  %i.bo = zext <4 x i16> %wide.load482 to <4 x i64>
  %i.bp = mul nuw nsw <4 x i64> %i.bo, %i.bl
  %i.bq = tail call <4 x i64> @llvm.umin.v4i64(<4 x i64> %i.bp, <4 x i64> splat (i64 4294967295))
  %i.br = trunc nuw <4 x i64> %i.bq to <4 x i32>
  %wide.load483 = load <4 x i32>, ptr %i.bm, align 4, !tbaa !74, !alias.scope !2971, !noalias !2972
  %i.bs = tail call <4 x i32> @llvm.uadd.sat.v4i32(<4 x i32> %wide.load483, <4 x i32> %i.br)
  store <4 x i32> %i.bs, ptr %i.bm, align 4, !tbaa !74, !alias.scope !2971, !noalias !2969
  %index.next484 = add nuw i64 %index481, 4       ; 2 uses
  %i.bt = icmp eq i64 %index.next484, %n.vec477
  br i1 %i.bt, label %middle.block485, label %vector.body480, !llvm.loop !2905
...
scalar.ph474.prol:                                ; preds = %scalar.ph474.preheader
  ...
  %i.bv = load i32, ptr %i.bh, align 4, !tbaa !74, !noalias !2970
  %i.bw = zext i32 %i.bv to i64
  %i.bx = load i16, ptr %gep.prol, align 2, !tbaa !113, !noalias !2970
  %i.by = zext i16 %i.bx to i64
  %i.bz = mul nuw nsw i64 %i.by, %i.bw
  ...
  %i.cb = load i32, ptr %i.bu, align 4, !tbaa !74, !noalias !2973
  %i.cc = tail call i32 @llvm.uadd.sat.i32(i32 %i.cb, i32 %i.ca)
  store i32 %i.cc, ptr %i.bu, align 4, !tbaa !74
...
scalar.ph474:                                     ; preds = %scalar.ph474.prol.loopexit, %scalar.ph474
  ...
  %i.cf = load i32, ptr %i.bh, align 4, !tbaa !74, !noalias !2970
  %i.cg = zext i32 %i.cf to i64
  %i.ch = load i16, ptr %gep, align 2, !tbaa !113, !noalias !2970
  %i.ci = zext i16 %i.ch to i64
  %i.cj = mul nuw nsw i64 %i.ci, %i.cg
  ...
  %i.cl = load i32, ptr %i.ce, align 4, !tbaa !74, !noalias !2973
  %i.cm = tail call i32 @llvm.uadd.sat.i32(i32 %i.cl, i32 %i.ck)
  store i32 %i.cm, ptr %i.ce, align 4, !tbaa !74
  ...
  %i.co = load i32, ptr %i.bh, align 4, !tbaa !74, !noalias !2970
  %i.cp = zext i32 %i.co to i64
  %i.cq = load i16, ptr %gep.1, align 2, !tbaa !113, !noalias !2970
  %i.cr = zext i16 %i.cq to i64
  %i.cs = mul nuw nsw i64 %i.cr, %i.cp
  ...
  %i.cu = load i32, ptr %i.cn, align 4, !tbaa !74, !noalias !2973
  %i.cv = tail call i32 @llvm.uadd.sat.i32(i32 %i.cu, i32 %i.ct)
  store i32 %i.cv, ptr %i.cn, align 4, !tbaa !74
  %indvars.iv.next324.1 = add nuw nsw i64 %indvars.iv323, 2 ; 2 uses
  %exitcond327.not.1 = icmp eq i64 %indvars.iv.next324.1, %i.h
  br i1 %exitcond327.not.1, label %._crit_edge233.us, label %scalar.ph474, !llvm.loop !2906
...
._crit_edge233.us:                                ; preds = %scalar.ph474.prol.loopexit, %scalar.ph474, %middle.block485
  ...
  br i1 %exitcond334.not, label %.loopexit227, label %.lr.ph232.us, !llvm.loop !2907
...
.lr.ph237.split:                                  ; preds = %.lr.ph237.split.preheader, %.lr.ph237.split
  ...
  br i1 %exitcond322.not, label %.loopexit227.thread, label %.lr.ph237.split, !llvm.loop !2907
