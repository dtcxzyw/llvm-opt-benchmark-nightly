...
.loopexit555:                                     ; preds = %.lr.ph582, %middle.block1138, %bb.g, %._crit_edge
  ...
  %i.vw = sext i32 %i.vv to i64                   ; 14 uses
...
vector.memcheck1141:                              ; preds = %.lr.ph586
  ...
  %i.wp = getelementptr i8, ptr %4, i64 %i.wo
  %scevgep1142.a = getelementptr i8, ptr %i.wp, i64 2 ; 5 uses
  %scevgep1143 = getelementptr i8, ptr %0, i64 %i.wk
  %i.wq = getelementptr i8, ptr %0, i64 %i.wk
  %i.wr = getelementptr i8, ptr %i.wq, i64 %i.wm
  %scevgep1144 = getelementptr i8, ptr %i.wr, i64 1
  %8 = add nsw i64 %i.wg, %i.vw                   ; 2 uses
  %scevgep1145 = getelementptr i8, ptr %0, i64 %8
  %i.ws = getelementptr i8, ptr %0, i64 %8
  %i.wt = getelementptr i8, ptr %i.ws, i64 %i.wm
  %scevgep1146 = getelementptr i8, ptr %i.wt, i64 1
  %9 = add nsw i64 %i.we, %i.vw                   ; 2 uses
  %scevgep1147.a = getelementptr i8, ptr %0, i64 %9
  %i.wu = getelementptr i8, ptr %0, i64 %9
  ...
  %bound01152 = icmp ult ptr %i.vy, %scevgep1144
  %bound11153 = icmp ult ptr %scevgep1143, %scevgep1142.a
  %found.conflict1154 = and i1 %bound01152, %bound11153
  %bound01155 = icmp ult ptr %i.vy, %scevgep1146
  %bound11156 = icmp ult ptr %scevgep1145, %scevgep1142.a
  ...
  %bound11160 = icmp ult ptr %scevgep1147.a, %scevgep1142.a
  ...
  %bound11164 = icmp ult ptr %scevgep1149, %scevgep1142.a
  ...
  %bound11168 = icmp ult ptr %i.vx, %scevgep1142.a
...
.loopexit491:                                     ; preds = %scalar.ph1100, %scalar.ph1179, %middle.block1129, %middle.block1205, %bb.k, %.preheader490
  ...
  %i.aev = sext i32 %i.aeu to i64                 ; 19 uses
...
.lr.ph516:                                        ; preds = %.preheader488
  ...
  %min.iters.check1244 = icmp ult i32 %i.afi, 23
...
vector.memcheck1208:                              ; preds = %.lr.ph516
  ...
  %i.afs = getelementptr i8, ptr %i.afr, i64 %i.afn
  %scevgep1211 = getelementptr i8, ptr %i.afs, i64 1
  %8 = add nsw i64 %i.afg, %i.aev                 ; 2 uses
  %scevgep1212.a = getelementptr i8, ptr %0, i64 %8
  %i.aft = getelementptr i8, ptr %0, i64 %8
  ...
  %scevgep1215.a = getelementptr i8, ptr %0, i64 %i.afy
  %scevgep1216 = getelementptr i8, ptr %0, i64 %i.afl
  %i.afz = getelementptr i8, ptr %0, i64 %i.afl
  %i.aga = getelementptr i8, ptr %i.afz, i64 %i.afn
  %scevgep1217 = getelementptr i8, ptr %i.aga, i64 1
  %9 = add nsw i64 %i.afc, %i.aev                 ; 2 uses
  %scevgep1218.a = getelementptr i8, ptr %0, i64 %9
  %i.agb = getelementptr i8, ptr %0, i64 %9
  ...
  %found.conflict1222 = and i1 %bound01220, %bound11221
  %bound01223 = icmp ult ptr %i.aex, %scevgep1211
  ...
  %bound01235 = icmp ult ptr %i.aex, %scevgep1217
  %bound11236 = icmp ult ptr %scevgep1216, %scevgep1209
  ...
  %bound11240 = icmp ult ptr %scevgep1218.a, %scevgep1209
...
.loopexit591:                                     ; preds = %scalar.ph1261, %middle.block1279, %bb.j, %._crit_edge
  ...
  %i.ait = sext i32 %i.ais to i64                 ; 14 uses
...
.lr.ph617:                                        ; preds = %.preheader
  %i.aiz = mul i32 %1, -2
  %i.aja = sext i32 %i.aiz to i64                 ; 3 uses
  ...
  %i.ajg = sext i32 %1 to i64                     ; 5 uses
...
vector.memcheck1282:                              ; preds = %.lr.ph617
  ...
  %i.ajr = getelementptr i8, ptr %0, i64 %i.ajl
  %i.ajs = getelementptr i8, ptr %i.ajr, i64 %i.ajn
  %scevgep1286 = getelementptr i8, ptr %i.ajs, i64 1
  %8 = add nsw i64 %i.ajg, %i.ait                 ; 2 uses
  %scevgep1287.a = getelementptr i8, ptr %0, i64 %8
  %i.ajt = getelementptr i8, ptr %0, i64 %8
  ...
  %scevgep1291.a = getelementptr i8, ptr %0, i64 %i.ajy
  %9 = add nsw i64 %i.aja, %i.ait                 ; 2 uses
  %scevgep1292.a = getelementptr i8, ptr %0, i64 %9
  %i.ajz = getelementptr i8, ptr %0, i64 %9
  ...
  %bound01297 = icmp ult ptr %i.aiv, %scevgep1286
  %bound11298 = icmp ult ptr %scevgep1285.a, %scevgep1283
  ...
  %bound11302 = icmp ult ptr %scevgep1287.a, %scevgep1283
  ...
  %bound01309 = icmp ult ptr %i.aiv, %scevgep1291.a
  ...
  %bound11314 = icmp ult ptr %scevgep1292.a, %scevgep1283
