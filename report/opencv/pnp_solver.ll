...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %15 = load double, ptr %i.nd, align 8, !tbaa !61, !noalias !129
  ...
  %16 = load double, ptr %i.nf, align 8, !tbaa !61, !noalias !129
  ...
  %i.ww = shufflevector <2 x double> %17, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.xc = shufflevector <2 x double> %18, <2 x double> poison, <2 x i32> zeroinitializer
