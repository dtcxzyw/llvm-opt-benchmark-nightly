...
bb.b:                                             ; preds = %bb.a
  ...
  %15 = load float, ptr %i.cd, align 4, !tbaa !74
  %16 = load float, ptr %i.cc, align 4, !tbaa !74
  %17 = load float, ptr %i.ce, align 4, !tbaa !74
  %i.dk = fpext float %15 to double               ; 2 uses
  %i.dl = fpext float %16 to double               ; 2 uses
  %i.dm = fpext float %17 to double               ; 2 uses
  ...
  %i.eb = extractelement <2 x double> %i.dp, i64 0 ; 2 uses
  %i.ec = extractelement <2 x double> %i.dp, i64 1 ; 2 uses
  %18 = tail call double @llvm.fmuladd.f64(double %i.ec, double %i.eb, double %i.cq)
  %i.ed = tail call double @llvm.fmuladd.f64(double %i.cp, double %i.co, double %18) ; 9 uses
  %19 = extractelement <2 x double> %i.ea, i64 0  ; 13 uses
  ...
  %i.eh = fmul double %i.ed, %i.ed                ; 4 uses
  %i.ei = tail call double @llvm.fmuladd.f64(double %i.dc, double %i.eg, double %i.cx)
  %i.ej = fmul double %i.dh, %19
  %i.ek = fneg double %i.ed
  %i.el = fmul double %i.dh, %i.ed
  %i.em = fmul double %19, %i.el
  ...
  %i.fw = fmul double %i.fg, %i.ed                ; 2 uses
  %i.fx = tail call double @llvm.fmuladd.f64(double %i.fw, double %i.ef, double %i.fv)
  %i.fy = tail call double @llvm.fmuladd.f64(double %i.dj, double %19, double %i.fx)
  %i.fz = tail call double @llvm.fmuladd.f64(double %i.ey, double %19, double %i.fy)
  %i.ga = fmul double %i.cy, %i.fb                ; 3 uses
  %i.gb = fmul double %i.fl, %i.ed
  %i.gc = fmul double %19, %i.gb
  %i.gd = tail call double @llvm.fmuladd.f64(double %i.ga, double %19, double %i.fz)
  ...
  %i.gk = tail call double @llvm.fmuladd.f64(double %i.fj, double %19, double %i.gj)
  ...
  %i.hc = tail call double @llvm.fmuladd.f64(double %i.hb, double %19, double %i.fs)
  ...
  %i.hf = tail call double @llvm.fmuladd.f64(double %i.dj, double %19, double %i.he)
  %i.hg = tail call double @llvm.fmuladd.f64(double %i.gn, double %19, double %i.hf)
  %i.hh = tail call double @llvm.fmuladd.f64(double %i.ga, double %19, double %i.hg)
  ...
  %i.hn = tail call double @llvm.fmuladd.f64(double %i.fj, double %19, double %i.hm)
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.os = insertelement <2 x double> %i.or, double %i.ed, i64 1
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.pn = call double @llvm.fmuladd.f64(double %i.pm, double %19, double %i.pj)
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.qk = call double @llvm.fmuladd.f64(double %i.qj, double %i.ed, double %i.qg)
