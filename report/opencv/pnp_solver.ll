...
.preheader164:                                    ; preds = %bb.b, %.preheader164
  ...
  %i.ba = fpext float %i.az to double             ; 11 uses
  ...
  %i.bw = fpext <2 x float> %i.bv to <2 x double> ; 10 uses
  %i.bx = extractelement <2 x double> %i.bw, i64 1 ; 3 uses
  %i.by = shufflevector <2 x double> %i.bw, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.bz = fmul <2 x double> %i.by, %i.bd          ; 11 uses
  %i.ca = shufflevector <2 x double> %i.bw, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.cb = fmul <2 x double> %i.ca, %i.bd          ; 10 uses
  ...
  %i.dg = shufflevector <2 x double> %i.bz, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %i.dm = insertelement <2 x double> poison, double %i.ba, i64 0 ; 2 uses
  ...
  %i.er = shufflevector <2 x double> %i.cb, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %15 = shufflevector <2 x double> %i.dm, <2 x double> poison, <2 x i32> zeroinitializer
  %16 = fmul <2 x double> %15, %i.bw              ; 6 uses
  %17 = shufflevector <2 x double> %i.bw, <2 x double> %16, <2 x i32> <i32 3, i32 1> ; 5 uses
  %i.fq = fmul <2 x double> %17, zeroinitializer  ; 5 uses
  %18 = shufflevector <2 x double> %16, <2 x double> %i.bw, <2 x i32> <i32 0, i32 2> ; 6 uses
  %i.fr = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bn, <2 x double> %18, <2 x double> %i.fq)
  %i.fs = fadd <2 x double> %i.n, %i.fr           ; 2 uses
  %19 = shufflevector <2 x double> %i.bz, <2 x double> %16, <2 x i32> <i32 1, i32 2> ; 5 uses
  %i.ft = shufflevector <2 x double> %i.cc, <2 x double> %i.fq, <2 x i32> <i32 1, i32 2> ; 2 uses
  %i.fu = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cs, <2 x double> %19, <2 x double> %i.ft)
  %i.fv = fadd <2 x double> %i.s, %i.fu           ; 2 uses
  %i.fw = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dj, <2 x double> %18, <2 x double> %i.fq)
  %i.fx = fadd <2 x double> %i.x, %i.fw           ; 2 uses
  %i.fy = fsub <2 x double> %i.ft, %19
  %i.fz = fadd <2 x double> %i.aa, %i.fy          ; 2 uses
  %i.ga = fmul <2 x double> %17, %i.bn
  %i.gb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> zeroinitializer, <2 x double> %i.ga)
  %i.gc = fadd <2 x double> %i.ae, %i.gb          ; 2 uses
  %20 = shufflevector <2 x double> %i.cb, <2 x double> %16, <2 x i32> <i32 1, i32 3> ; 3 uses
  %i.gd = fmul <2 x double> %20, %i.cs
  %i.ge = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %19, <2 x double> zeroinitializer, <2 x double> %i.gd)
  %i.gf = fadd <2 x double> %i.ah, %i.ge          ; 2 uses
  %i.gg = fmul <2 x double> %17, %i.dj
  %i.gh = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> zeroinitializer, <2 x double> %i.gg)
  %i.gi = fadd <2 x double> %i.ak, %i.gh          ; 2 uses
  %i.gj = fneg <2 x double> %20
  %i.gk = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %19, <2 x double> zeroinitializer, <2 x double> %i.gj)
  %i.gl = fadd <2 x double> %i.am, %i.gk          ; 2 uses
  %i.gm = fmul <2 x double> %i.fl, %17
  %i.gn = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.fn, <2 x double> %18, <2 x double> %i.gm)
  %i.go = fadd <2 x double> %i.ao, %i.gn          ; 2 uses
  %i.gp = fmul <2 x double> %i.er, %20
  %i.gq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dg, <2 x double> %19, <2 x double> %i.gp)
  %i.gr = fadd <2 x double> %i.ap, %i.gq          ; 2 uses
  %21 = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.gs = fmul <2 x double> %21, %17
  %i.gt = shufflevector <2 x double> %16, <2 x double> poison, <2 x i32> zeroinitializer
  %i.gu = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gt, <2 x double> %18, <2 x double> %i.gs)
