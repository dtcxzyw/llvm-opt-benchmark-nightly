...
.preheader133.us.preheader:                       ; preds = %.lr.ph158.split.us
  %i.cp = zext i32 %i.cn to i64                   ; 6 uses
...
.preheader136.preheader:                          ; preds = %.lr.ph158.split
  %i.he = zext i32 %i.cn to i64                   ; 6 uses
...
.preheader136.preheader:                          ; preds = %.lr.ph158.split
  %i.gy = zext i32 %i.cn to i64                   ; 6 uses
