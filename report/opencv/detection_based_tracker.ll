...
.lr.ph209:                                        ; preds = %.lr.ph209.preheader, %.lr.ph209
  ...
  %3 = load <2 x i32>, ptr %i.dn, align 4         ; 2 uses
  ...
  %i.ds = add nsw <2 x i32> %i.dr, %3
  %i.dt = sitofp <2 x i32> %3 to <2 x float>
...
bb.m:                                             ; preds = %bb.l
  ...
  %4 = load <2 x i32>, ptr %i.eg, align 4         ; 2 uses
  %i.eh = getelementptr inbounds nuw i8, ptr %i.eg, i64 8
  %i.ei = load <2 x i32>, ptr %i.eh, align 4, !tbaa !60
  %i.ej = add nsw <2 x i32> %i.ei, %4
  %i.ek = sitofp <2 x i32> %4 to <2 x float>
