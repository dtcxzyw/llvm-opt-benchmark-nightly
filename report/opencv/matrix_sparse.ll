...
@.str.1 = private unnamed_addr constant [65 x i8] c"/opt-bench/work/opencv/opencv/modules/core/src/matrix_sparse.cpp\00", align 1
...
@.str.16 = private unnamed_addr constant [36 x i8] c"idx < (size_t)(dims > 0 ? dims : 1)\00", align 1
...
@_ZZN2cvL14getConvertElemEiiE3tab = internal unnamed_addr constant <{ <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, [25 x [32 x ptr]] }> <{ <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv12convertData_IhhEEvPKvPvi, ptr @_ZN2cv12convertData_IhaEEvPKvPvi, ptr @_ZN2cv12convertData_IhtEEvPKvPvi, ptr @_ZN2cv12convertData_IhsEEvPKvPvi, ptr @_ZN2cv12convertData_IhiEEvPKvPvi, ptr @_ZN2cv12convertData_IhfEEvPKvPvi, ptr @_ZN2cv12convertData_IhdEEvPKvPvi, [25 x ptr] zeroinitializer }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv12convertData_IahEEvPKvPvi, ptr @_ZN2cv12convertData_IaaEEvPKvPvi, ptr @_ZN2cv12convertData_IatEEvPKvPvi, ptr @_ZN2cv12convertData_IasEEvPKvPvi, ptr @_ZN2cv12convertData_IaiEEvPKvPvi, ptr @_ZN2cv12convertData_IafEEvPKvPvi, ptr @_ZN2cv12convertData_IadEEvPKvPvi, [25 x ptr] zeroinitializer }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv12convertData_IthEEvPKvPvi, ptr @_ZN2cv12convertData_ItaEEvPKvPvi, ptr @_ZN2cv12convertData_IttEEvPKvPvi, ptr @_ZN2cv12convertData_ItsEEvPKvPvi, ptr @_ZN2cv12convertData_ItiEEvPKvPvi, ptr @_ZN2cv12convertData_ItfEEvPKvPvi, ptr @_ZN2cv12convertData_ItdEEvPKvPvi, [25 x ptr] zeroinitializer }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv12convertData_IshEEvPKvPvi, ptr @_ZN2cv12convertData_IsaEEvPKvPvi, ptr @_ZN2cv12convertData_IstEEvPKvPvi, ptr @_ZN2cv12convertData_IssEEvPKvPvi, ptr @_ZN2cv12convertData_IsiEEvPKvPvi, ptr @_ZN2cv12convertData_IsfEEvPKvPvi, ptr @_ZN2cv12convertData_IsdEEvPKvPvi, [25 x ptr] zeroinitializer }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv12convertData_IihEEvPKvPvi, ptr @_ZN2cv12convertData_IiaEEvPKvPvi, ptr @_ZN2cv12convertData_IitEEvPKvPvi, ptr @_ZN2cv12convertData_IisEEvPKvPvi, ptr @_ZN2cv12convertData_IiiEEvPKvPvi, ptr @_ZN2cv12convertData_IifEEvPKvPvi, ptr @_ZN2cv12convertData_IidEEvPKvPvi, [25 x ptr] zeroinitializer }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv12convertData_IfhEEvPKvPvi, ptr @_ZN2cv12convertData_IfaEEvPKvPvi, ptr @_ZN2cv12convertData_IftEEvPKvPvi, ptr @_ZN2cv12convertData_IfsEEvPKvPvi, ptr @_ZN2cv12convertData_IfiEEvPKvPvi, ptr @_ZN2cv12convertData_IffEEvPKvPvi, ptr @_ZN2cv12convertData_IfdEEvPKvPvi, [25 x ptr] zeroinitializer }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv12convertData_IdhEEvPKvPvi, ptr @_ZN2cv12convertData_IdaEEvPKvPvi, ptr @_ZN2cv12convertData_IdtEEvPKvPvi, ptr @_ZN2cv12convertData_IdsEEvPKvPvi, ptr @_ZN2cv12convertData_IdiEEvPKvPvi, ptr @_ZN2cv12convertData_IdfEEvPKvPvi, ptr @_ZN2cv12convertData_IddEEvPKvPvi, [25 x ptr] zeroinitializer }>, [25 x [32 x ptr]] zeroinitializer }>, align 16
@.str.18 = private unnamed_addr constant [10 x i8] c"func != 0\00", align 1
@__func__._ZN2cvL14getConvertElemEii = private unnamed_addr constant [15 x i8] c"getConvertElem\00", align 1
@_ZZN2cvL19getConvertScaleElemEiiE3tab = internal unnamed_addr constant <{ <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }>, [25 x [32 x ptr]] }> <{ <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv17convertScaleData_IhhEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IhaEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IhtEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IhsEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IhiEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IhfEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IhdEEvPKvPvidd, [25 x ptr] zeroinitializer }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv17convertScaleData_IahEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IaaEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IatEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IasEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IaiEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IafEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IadEEvPKvPvidd, [25 x ptr] zeroinitializer }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv17convertScaleData_IthEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_ItaEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IttEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_ItsEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_ItiEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_ItfEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_ItdEEvPKvPvidd, [25 x ptr] zeroinitializer }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv17convertScaleData_IshEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IsaEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IstEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IssEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IsiEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IsfEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IsdEEvPKvPvidd, [25 x ptr] zeroinitializer }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv17convertScaleData_IihEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IiaEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IitEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IisEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IiiEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IifEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IidEEvPKvPvidd, [25 x ptr] zeroinitializer }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv17convertScaleData_IfhEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IfaEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IftEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IfsEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IfiEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IffEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IfdEEvPKvPvidd, [25 x ptr] zeroinitializer }>, <{ ptr, ptr, ptr, ptr, ptr, ptr, ptr, [25 x ptr] }> <{ ptr @_ZN2cv17convertScaleData_IdhEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IdaEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IdtEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IdsEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IdiEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IdfEEvPKvPvidd, ptr @_ZN2cv17convertScaleData_IddEEvPKvPvidd, [25 x ptr] zeroinitializer }>, [25 x [32 x ptr]] zeroinitializer }>, align 16
...
define void @_ZN2cv9SparseMat3HdrC2EiPKii(ptr noundef nonnull align 8 dereferenceable(216) initializes((0, 12), (16, 24), (40, 88)) %0, i32 noundef %1, ptr nofree noundef readonly captures(none) %2, i32 noundef %3) unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  ...
  %i.r = mul nuw nsw i32 %i.k, %i.q
  %i.s = add nsw i32 %i.m, %i.r
  %i.t = sext i32 %i.s to i64
  %i.u = add nsw i64 %i.t, 7
  %i.v = and i64 %i.u, -8
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  store i64 %i.v, ptr %i.w, align 8, !tbaa !26
  %i.x = icmp sgt i32 %1, 0
  br i1 %i.x, label %.lr.ph, label %.lr.ph21

.lr.ph:                                           ; preds = %bb.a
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 88 ; 6 uses
  %wide.trip.count = zext nneg i32 %1 to i64      ; 5 uses
  %min.iters.check = icmp ult i32 %1, 12
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ab = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %index ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 16
  %wide.load = load <4 x i32>, ptr %i.ab, align 4, !tbaa !27
  %wide.load33 = load <4 x i32>, ptr %i.ac, align 4, !tbaa !27
  %i.ad = getelementptr inbounds nuw [4 x i8], ptr %i.y, i64 %index ; 2 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 16
  store <4 x i32> %wide.load, ptr %i.ad, align 8, !tbaa !27
  store <4 x i32> %wide.load33, ptr %i.ae, align 8, !tbaa !27
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.af = icmp eq i64 %index.next, %n.vec
  br i1 %i.af, label %middle.block, label %vector.body, !llvm.loop !78
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %i.ag = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv.prol
  %i.ah = load i32, ptr %i.ag, align 4, !tbaa !27
  %i.ai = getelementptr inbounds nuw [4 x i8], ptr %i.y, i64 %indvars.iv.prol
  store i32 %i.ah, ptr %i.ai, align 4, !tbaa !27
...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  ...
  br i1 %i.ak, label %.preheader, label %scalar.ph

.preheader:                                       ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block
  %i.al = icmp samesign ult i32 %1, 32
  br i1 %i.al, label %.lr.ph21, label %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i

.lr.ph21:                                         ; preds = %bb.a, %.preheader
  %.0.lcssa32 = phi i32 [ %1, %.preheader ], [ 0, %bb.a ] ; 2 uses
  %i.am = shl nuw nsw i32 %.0.lcssa32, 2
  %i.an = zext nneg i32 %i.am to i64
  %i.ao = getelementptr i8, ptr %0, i64 %i.an
  %scevgep = getelementptr i8, ptr %i.ao, i64 88
  %i.ap = shl nuw nsw i32 %.0.lcssa32, 2
  %narrow = sub nuw nsw i32 128, %i.ap
  %i.aq = zext nneg i32 %narrow to i64
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %scevgep, i8 0, i64 %i.aq, i1 false), !tbaa !27
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.at = getelementptr inbounds nuw [4 x i8], ptr %i.y, i64 %indvars.iv
  store i32 %i.as, ptr %i.at, align 4, !tbaa !27
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.au = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv.next
  %i.av = load i32, ptr %i.au, align 4, !tbaa !27
  %i.aw = getelementptr inbounds nuw [4 x i8], ptr %i.y, i64 %indvars.iv.next
  store i32 %i.av, ptr %i.aw, align 4, !tbaa !27
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %i.ax = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv.next.1
  %i.ay = load i32, ptr %i.ax, align 4, !tbaa !27
  %i.az = getelementptr inbounds nuw [4 x i8], ptr %i.y, i64 %indvars.iv.next.1
  store i32 %i.ay, ptr %i.az, align 4, !tbaa !27
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3 ; 2 uses
  %i.ba = getelementptr inbounds nuw [4 x i8], ptr %2, i64 %indvars.iv.next.2
  %i.bb = load i32, ptr %i.ba, align 4, !tbaa !27
  %i.bc = getelementptr inbounds nuw [4 x i8], ptr %i.y, i64 %indvars.iv.next.2
  store i32 %i.bb, ptr %i.bc, align 4, !tbaa !27
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4 ; 2 uses
  %exitcond.not.3 = icmp eq i64 %indvars.iv.next.3, %wide.trip.count
  br i1 %exitcond.not.3, label %.preheader, label %scalar.ph, !llvm.loop !80
...
_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i:  ; preds = %.preheader, %.lr.ph21
  ...
  %i.be = invoke noalias noundef nonnull dereferenceable(64) ptr @_Znwm(i64 noundef 64) #22
          to label %.noexc unwind label %bb.d     ; 3 uses

.noexc:                                           ; preds = %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i
  ...
  store ptr %i.be, ptr %i.d, align 8, !tbaa !32
  %i.bg = getelementptr inbounds nuw i8, ptr %i.be, i64 64 ; 2 uses
  store ptr %i.bg, ptr %i.bf, align 8, !tbaa !33
  store ptr %i.bg, ptr %i.bd, align 8, !tbaa !34
  %.pre = load ptr, ptr %i.c, align 8, !tbaa !35  ; 2 uses
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %0, i64 48
  %.pre26 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !36
  %.not.i.i3.i = icmp eq ptr %.pre26, %.pre
  br i1 %.not.i.i3.i, label %_ZNSt6vectorIhSaIhEE5clearEv.exit.i, label %_ZSt8_DestroyIPhhEvT_S1_RSaIT0_E.exit.i.i.i

_ZSt8_DestroyIPhhEvT_S1_RSaIT0_E.exit.i.i.i:      ; preds = %.noexc
  %i.bh = getelementptr inbounds nuw i8, ptr %0, i64 48
  store ptr %.pre, ptr %i.bh, align 8, !tbaa !36
  br label %_ZNSt6vectorIhSaIhEE5clearEv.exit.i

_ZNSt6vectorIhSaIhEE5clearEv.exit.i:              ; preds = %_ZSt8_DestroyIPhhEvT_S1_RSaIT0_E.exit.i.i.i, %.noexc
  %i.bi = load i64, ptr %i.w, align 8, !tbaa !26  ; 2 uses
  %.not.i = icmp eq i64 %i.bi, 0
  br i1 %.not.i, label %bb.c, label %bb.b

bb.b:                                             ; preds = %_ZNSt6vectorIhSaIhEE5clearEv.exit.i
  invoke void @_ZNSt6vectorIhSaIhEE17_M_default_appendEm(ptr noundef nonnull align 8 dereferenceable(24) %i.c, i64 noundef %i.bi)
          to label %bb.c unwind label %bb.d

bb.c:                                             ; preds = %_ZNSt6vectorIhSaIhEE5clearEv.exit.i, %bb.b
...
bb.d:                                             ; preds = %_ZNKSt6vectorImSaImEE12_M_check_lenEmPKc.exit.i, %bb.b
  %i.bk = landingpad { ptr, i32 }
          cleanup
  %i.bl = load ptr, ptr %i.d, align 8, !tbaa !32  ; 3 uses
  %.not.i.i.i15 = icmp eq ptr %i.bl, null
  br i1 %.not.i.i.i15, label %_ZNSt6vectorImSaImEED2Ev.exit, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.bm = load ptr, ptr %i.bd, align 8, !tbaa !34
  %i.bn = ptrtoint ptr %i.bm to i64
  %i.bo = ptrtoint ptr %i.bl to i64
  %i.bp = sub i64 %i.bn, %i.bo
  tail call void @_ZdlPvm(ptr noundef nonnull %i.bl, i64 noundef %i.bp) #23
  br label %_ZNSt6vectorImSaImEED2Ev.exit

_ZNSt6vectorImSaImEED2Ev.exit:                    ; preds = %bb.d, %bb.e
  %i.bq = load ptr, ptr %i.c, align 8, !tbaa !35  ; 3 uses
  %.not.i.i.i16 = icmp eq ptr %i.bq, null
  br i1 %.not.i.i.i16, label %_ZNSt6vectorIhSaIhEED2Ev.exit, label %bb.f
...
_ZNSt6vectorIhSaIhEED2Ev.exit:                    ; preds = %_ZNSt6vectorImSaImEED2Ev.exit, %bb.f
  resume { ptr, i32 } %i.bk
}
