...
.lr.ph.epil.preheader:                            ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.preheader
  ...
  %i.bn = add nuw nsw i64 %indvars.iv.epil.init, %9 ; 2 uses
  %i.bo = getelementptr inbounds nuw i8, ptr %.sink.i, i64 %i.bn
  %i.bp = load i8, ptr %i.bo, align 1, !tbaa !20  ; 2 uses
  %i.bq = sub nuw nsw i64 %9, %indvars.iv.epil.init ; 2 uses
  %i.br = getelementptr inbounds nuw i8, ptr %.sink.i, i64 %i.bq
  %i.bs = load i8, ptr %i.br, align 1, !tbaa !20  ; 2 uses
  %i.bt = icmp ugt i8 %i.bp, %.03681.epil.init
  %i.bu = trunc nuw i64 %i.bn to i32
  ...
  %i.bw = trunc nuw i64 %i.bq to i32
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.cs = trunc nuw i64 %i.cm to i32
