...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %1 = shufflevector <2 x double> %broadcast.splat32, <2 x double> %broadcast.splat40, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %2 = shufflevector <2 x double> %broadcast.splat30, <2 x double> %broadcast.splat38, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %3 = shufflevector <2 x double> %broadcast.splat28, <2 x double> %broadcast.splat36, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = shufflevector <2 x double> %i.bk, <2 x double> %i.cb, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %5 = shufflevector <2 x double> %i.bg, <2 x double> %i.bx, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %6 = shufflevector <2 x double> %i.ax, <2 x double> %i.bo, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %7 = shufflevector <2 x double> %i.bc, <2 x double> %i.bt, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %8 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %6, <4 x double> %3, <4 x double> %7)
  %9 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %5, <4 x double> %2, <4 x double> %8)
  %i.cw = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %4, <4 x double> %1, <4 x double> %9)
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %5 = shufflevector <2 x double> %broadcast.splatinsert29, <2 x double> %broadcast.splatinsert37, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %6 = shufflevector <2 x double> %broadcast.splatinsert27, <2 x double> %broadcast.splatinsert35, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
  %7 = shufflevector <2 x double> %broadcast.splatinsert25, <2 x double> %broadcast.splatinsert33, <4 x i32> <i32 0, i32 0, i32 2, i32 2>
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %8 = shufflevector <2 x double> %i.bk, <2 x double> %i.ca, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %9 = shufflevector <2 x double> %i.bg, <2 x double> %i.bw, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %10 = shufflevector <2 x double> %i.ay, <2 x double> %i.bo, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %11 = shufflevector <2 x double> %i.bc, <2 x double> %i.bs, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %12 = fmul <4 x double> %11, %i.ah
  %13 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %10, <4 x double> %7, <4 x double> %12)
  %14 = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %9, <4 x double> %6, <4 x double> %13)
  %i.cv = tail call <4 x double> @llvm.fmuladd.v4f64(<4 x double> %8, <4 x double> %5, <4 x double> %14)
