...
begin_hunk_0_@_ZNSt6vectorIiSaIiEE14_M_fill_assignEmRKi:bb.a
  %i.x = load ptr, ptr %0, align 8, !tbaa !45     ; 3 uses
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.z = load ptr, ptr %i.a, align 8, !tbaa !44
  store ptr %i.k, ptr %0, align 8, !tbaa !45
  store ptr %i.l, ptr %i.y, align 8, !tbaa !62
  store ptr %i.w, ptr %i.a, align 8, !tbaa !44
...
bb.e:                                             ; preds = %bb.a
  ...
  %i.ae = load ptr, ptr %i.ad, align 8, !tbaa !62 ; 8 uses
...
bb.f:                                             ; preds = %bb.e
  %i.aj = load i32, ptr %2, align 4, !tbaa !66    ; 3 uses
...
.lr.ph.i.i.i:                                     ; preds = %bb.a
  ...
  %i.d = sext i32 %.val2 to i64                   ; 3 uses
...
bb.b:                                             ; preds = %._crit_edge8.split.i.i.i, %.lr.ph.i.i.i
  %indvar = phi i64 [ %indvar.next, %._crit_edge8.split.i.i.i ], [ 0, %.lr.ph.i.i.i ] ; 3 uses
  %.0329.i.i.i = phi i64 [ %i.cp, %._crit_edge8.split.i.i.i ], [ %i.d, %.lr.ph.i.i.i ] ; 6 uses
  %i.af = add i64 %indvar, %i.d
  %i.ag = shl i64 %.0329.i.i.i, 5
  %2 = or disjoint i64 %i.ag, 1
  %i.ah = sdiv i64 %.0329.i.i.i, %i.j             ; 5 uses
  %i.ai = mul i64 %i.ah, %i.j                     ; 0 uses
  %.recomposed = srem i64 %.0329.i.i.i, %i.j      ; 2 uses
  %i.aj = sdiv i64 %.recomposed, %i.i             ; 6 uses
  %i.ak = mul i64 %i.aj, %i.i                     ; 0 uses
  %.recomposed17 = srem i64 %.recomposed, %i.i
  %i.al = shl nsw i64 %i.aj, 5                    ; 4 uses
  %i.am = add i64 %i.al, 32
  %.sroa.speculated3.i.i.i = tail call i64 @llvm.smin.i64(i64 %i.m, i64 %i.am) ; 2 uses
  %i.an = shl i64 %.recomposed17, 5               ; 5 uses
  %i.ao = add i64 %i.an, 32
  %.sroa.speculated.i.i.i = tail call i64 @llvm.smin.i64(i64 %i.p, i64 %i.ao) ; 3 uses
  %i.ap = mul i64 %i.ah, %i.v                     ; 4 uses
  %i.aq = getelementptr inbounds [4 x i8], ptr %i.s, i64 %i.ap
  %i.ar = getelementptr inbounds [4 x i8], ptr %i.y, i64 %i.ap
  %i.as = icmp sgt i64 %i.m, %i.al
  %i.at = icmp sgt i64 %i.p, %i.an
...
.preheader.i.i.i.preheader:                       ; preds = %bb.b
  %i.au = shl i64 %.0329.i.i.i, 7                 ; 3 uses
  %scevgep13 = getelementptr i8, ptr %i.s, i64 %i.au ; 2 uses
  %i.av = shl i64 %indvar, 5
  %i.aw = sub i64 %i.ae, %i.av                    ; 2 uses
  %i.ax = shl i64 %.0329.i.i.i, 5
  %3 = or disjoint i64 %i.ax, 1
  %4 = getelementptr i8, ptr %i.y, i64 %i.au
  %scevgep10 = getelementptr i8, ptr %4, i64 4
  %scevgep = getelementptr i8, ptr %i.y, i64 %i.au
  %i.ay = mul i64 %i.z, %i.aj
  %i.az = mul i64 %i.f, %i.ah
  %i.ba = add i64 %i.az, %i.aj
  %i.bb = sub i64 0, %i.ba                        ; 2 uses
  %i.bc = mul i64 %i.aa, %i.bb                    ; 2 uses
  %i.bd = mul i64 %i.ab, %i.ah                    ; 2 uses
  ...
  %i.bv = add i64 %i.bu, %i.ap
  %i.bw = shl i64 %i.bv, 2
  %scevgep15 = getelementptr i8, ptr %scevgep13, i64 %i.bw
  %i.bx = mul i64 %i.f, %i.ah
  %i.by = add i64 %i.bx, %i.aj
  %.reass = mul i64 %i.by, %factor.op.mul         ; 2 uses
  %i.bz = add i64 %2, %.reass
  %i.ca = tail call i64 @llvm.smax.i64(i64 %.sroa.speculated.i.i.i, i64 %i.bz) ; 2 uses
  %i.cb = shl i64 %i.af, 5
  %i.cc = add i64 %i.cb, %.reass
  %i.cd = sub i64 %i.ca, %i.cc                    ; 2 uses
  %min.iters.check = icmp ugt i64 %i.cd, 7
  %or.cond = select i1 %min.iters.check, i1 %ident.check.not, i1 false
  %bound0 = icmp ult ptr %scevgep9, %scevgep15
  %bound1 = icmp ult ptr %scevgep14, %scevgep12
  %found.conflict = and i1 %bound0, %bound1
  %i.ce = or i1 %found.conflict, %stride.check
  %i.cf = and i64 %i.ca, 7                        ; 2 uses
  %n.vec = sub i64 %i.cd, %i.cf                   ; 2 uses
  %i.cg = add i64 %i.an, %n.vec
  %cmp.n = icmp eq i64 %i.cf, 0
  br label %.preheader.i.i.i

.preheader.i.i.i:                                 ; preds = %.preheader.i.i.i.preheader, %._crit_edge.i.i.i
  %.0317.i.i.i = phi i64 [ %i.cq, %._crit_edge.i.i.i ], [ %i.al, %.preheader.i.i.i.preheader ] ; 3 uses
  %invariant.gep.i.i.i = getelementptr [4 x i8], ptr %i.aq, i64 %.0317.i.i.i ; 2 uses
  %i.ch = mul nsw i64 %.0317.i.i.i, %i.p
  %i.ci = getelementptr [4 x i8], ptr %i.ar, i64 %i.ch ; 2 uses
  %or.cond.not = xor i1 %or.cond, true
  %brmerge = select i1 %or.cond.not, i1 true, i1 %i.ce
  br i1 %brmerge, label %scalar.ph.preheader, label %vector.body

vector.body:                                      ; preds = %.preheader.i.i.i, %vector.body
  %index = phi i64 [ %index.next, %vector.body ], [ 0, %.preheader.i.i.i ] ; 2 uses
  %i.cj = add i64 %i.an, %index                   ; 2 uses
  %i.ck = getelementptr [4 x i8], ptr %invariant.gep.i.i.i, i64 %i.cj ; 2 uses
  %i.cl = getelementptr i8, ptr %i.ck, i64 16
  %wide.load = load <4 x float>, ptr %i.ck, align 4, !tbaa !278, !alias.scope !279
  %wide.load16 = load <4 x float>, ptr %i.cl, align 4, !tbaa !278, !alias.scope !279
  %i.cm = getelementptr [4 x i8], ptr %i.ci, i64 %i.cj ; 2 uses
  %i.cn = getelementptr i8, ptr %i.cm, i64 16
  store <4 x float> %wide.load, ptr %i.cm, align 4, !tbaa !278, !alias.scope !280, !noalias !279
  store <4 x float> %wide.load16, ptr %i.cn, align 4, !tbaa !278, !alias.scope !280, !noalias !279
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.co = icmp eq i64 %index.next, %n.vec
  br i1 %i.co, label %middle.block, label %vector.body, !llvm.loop !265

middle.block:                                     ; preds = %vector.body
  br i1 %cmp.n, label %._crit_edge.i.i.i, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %.preheader.i.i.i, %middle.block
  %.06.i.i.i.ph = phi i64 [ %i.cg, %middle.block ], [ %i.an, %.preheader.i.i.i ]
  br label %scalar.ph

._crit_edge8.split.i.i.i:                         ; preds = %._crit_edge.i.i.i, %bb.b
  %i.cp = add nsw i64 %.0329.i.i.i, 1             ; 2 uses
  %exitcond.not.i.i.i = icmp eq i64 %i.cp, %i.b
...
._crit_edge.i.i.i:                                ; preds = %scalar.ph, %middle.block
  %i.cq = add nsw i64 %.0317.i.i.i, 1             ; 2 uses
  %i.cr = icmp slt i64 %i.cq, %.sroa.speculated3.i.i.i
  br i1 %i.cr, label %.preheader.i.i.i, label %._crit_edge8.split.i.i.i, !llvm.loop !267

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %.06.i.i.i = phi i64 [ %i.cv, %scalar.ph ], [ %.06.i.i.i.ph, %scalar.ph.preheader ] ; 3 uses
  %i.cs = mul nsw i64 %.06.i.i.i, %i.m
  %gep.i.i.i = getelementptr [4 x i8], ptr %invariant.gep.i.i.i, i64 %i.cs
  %i.ct = load float, ptr %gep.i.i.i, align 4, !tbaa !278
  %i.cu = getelementptr [4 x i8], ptr %i.ci, i64 %.06.i.i.i
  store float %i.ct, ptr %i.cu, align 4, !tbaa !278
  %i.cv = add nsw i64 %.06.i.i.i, 1               ; 2 uses
  %i.cw = icmp slt i64 %i.cv, %.sroa.speculated.i.i.i
  br i1 %i.cw, label %scalar.ph, label %._crit_edge.i.i.i, !llvm.loop !268
...
bb.b:                                             ; preds = %bb.a
  store ptr getelementptr inbounds nuw inrange(-16, 296) (i8, ptr @_ZTVN2cv3dnn14dnn5_v2026060514TransposeLayerE, i64 16), ptr %i.b, align 8, !tbaa !29
