...
bb.b:                                             ; preds = %._crit_edge8.split.i.i.i, %.lr.ph.i.i.i
  ...
  %.0329.i.i.i = phi i64 [ %i.cp, %._crit_edge8.split.i.i.i ], [ %i.d, %.lr.ph.i.i.i ] ; 3 uses
  %i.af = add i64 %indvar, %i.d
  %i.ag = shl i64 %indvar, 5
  %6 = add i64 %3, %i.ag
...
.preheader.i.i.i.preheader:                       ; preds = %bb.b
  %i.au = shl i64 %indvar, 7                      ; 2 uses
  %7 = add i64 %2, %i.au                          ; 2 uses
  %scevgep13 = getelementptr i8, ptr %i.s, i64 %7 ; 2 uses
  %i.av = shl i64 %indvar, 5
  %i.aw = sub i64 %i.ae, %i.av                    ; 2 uses
  %i.ax = shl i64 %indvar, 5
  %8 = add i64 %3, %i.ax
  %scevgep10 = getelementptr i8, ptr %5, i64 %i.au
  %scevgep = getelementptr i8, ptr %i.y, i64 %7
