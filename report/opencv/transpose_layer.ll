...
bb.b:                                             ; preds = %._crit_edge8.split.i.i.i, %.lr.ph.i.i.i
  ...
  %.0329.i.i.i = phi i64 [ %i.co, %._crit_edge8.split.i.i.i ], [ %i.d, %.lr.ph.i.i.i ] ; 6 uses
...
.preheader.i.i.i.preheader:                       ; preds = %bb.b
  %i.as = shl i64 %.0329.i.i.i, 7                 ; 3 uses
  %scevgep13 = getelementptr i8, ptr %i.s, i64 %i.as ; 2 uses
  %i.at = shl i64 %indvar, 5
  %i.au = sub i64 %i.ae, %i.at                    ; 2 uses
  %i.av = shl i64 %.0329.i.i.i, 5
  %2 = or disjoint i64 %i.av, 1
  %3 = getelementptr i8, ptr %i.y, i64 %i.as
  %scevgep10 = getelementptr i8, ptr %3, i64 4
  %scevgep = getelementptr i8, ptr %i.y, i64 %i.as
  %i.aw = add i64 %indvar, %i.d
  %i.ax = shl i64 %.0329.i.i.i, 5
  %4 = or disjoint i64 %i.ax, 1
