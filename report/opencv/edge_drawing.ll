...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  store double %i.bf, ptr %i.bg, align 8, !tbaa !46
  ...
  store double %i.bl, ptr %i.bm, align 8, !tbaa !46
...
.lr.ph:                                           ; preds = %._crit_edge246, %.preheader234.lr.ph
  ...
  %i.br = load ptr, ptr %i.bq, align 8, !tbaa !279 ; 7 uses
  %i.bs = getelementptr inbounds nuw [8 x i8], ptr %i.o, i64 %indvars.iv297
  %i.bt = load ptr, ptr %i.bs, align 8, !tbaa !279 ; 7 uses
...
vector.body383:                                   ; preds = %.lr.ph, %vector.body383
  ...
  %wide.load385 = load <2 x double>, ptr %i.by, align 8, !tbaa !46
  %wide.load386 = load <2 x double>, ptr %i.bz, align 8, !tbaa !46
  %i.ca = getelementptr inbounds nuw [8 x i8], ptr %i.bt, i64 %i.bx ; 2 uses
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 16
  store <2 x double> %wide.load385, ptr %i.ca, align 8, !tbaa !46
  store <2 x double> %wide.load386, ptr %i.cb, align 8, !tbaa !46
  %index.next387 = add nuw i64 %index384, 4       ; 2 uses
  %i.cc = icmp eq i64 %index.next387, %n.vec382
  br i1 %i.cc, label %middle.block388, label %vector.body383, !llvm.loop !726
...
scalar.ph379.prol:                                ; preds = %scalar.ph379.preheader, %scalar.ph379.prol
  ...
  store double %i.cf, ptr %i.cg, align 8, !tbaa !46
...
.preheader233:                                    ; preds = %scalar.ph379.prol.loopexit, %scalar.ph379, %middle.block388
  ...
  %i.cz = load ptr, ptr %i.cy, align 8, !tbaa !279 ; 2 uses
...
.lr.ph245:                                        ; preds = %.preheader233
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep, i8 0, i64 %i.bb, i1 false), !tbaa !46
...
scalar.ph379:                                     ; preds = %scalar.ph379.prol.loopexit, %scalar.ph379
  ...
  store double %i.dh, ptr %i.di, align 8, !tbaa !46
  ...
  store double %i.dk, ptr %i.dl, align 8, !tbaa !46
...
._crit_edge246:                                   ; preds = %.preheader233, %.lr.ph245
  ...
  store double 1.000000e+00, ptr %i.dq, align 8, !tbaa !46
...
bb.e:                                             ; preds = %.lr.ph270, %._crit_edge266
  ...
  %i.ej = load ptr, ptr %i.ei, align 8, !tbaa !279 ; 13 uses
  %i.ek = getelementptr inbounds nuw [8 x i8], ptr %i.ej, i64 %indvars.iv302 ; 2 uses
  %i.el = load double, ptr %i.ek, align 8, !tbaa !46 ; 2 uses
...
.new:                                             ; preds = %.prol.loopexit, %.new
  ...
  %i.ex = load ptr, ptr %i.ew, align 8, !tbaa !279
  ...
  %i.fe = load ptr, ptr %i.fd, align 8, !tbaa !279
...
.lr.ph254:                                        ; preds = %bb.f
  ...
  %i.fo = load ptr, ptr %i.fn, align 8, !tbaa !279 ; 6 uses
...
vector.body439:                                   ; preds = %vector.body439, %vector.ph437
  ...
  %wide.load441 = load <2 x double>, ptr %i.fr, align 8, !tbaa !46, !alias.scope !748, !noalias !749
  %wide.load442 = load <2 x double>, ptr %i.fs, align 8, !tbaa !46, !alias.scope !748, !noalias !749
  %i.ft = getelementptr inbounds nuw [8 x i8], ptr %i.ej, i64 %i.fq ; 3 uses
  %i.fu = getelementptr inbounds nuw i8, ptr %i.ft, i64 16 ; 2 uses
  %wide.load443 = load <2 x double>, ptr %i.ft, align 8, !tbaa !46, !alias.scope !749
  %wide.load444 = load <2 x double>, ptr %i.fu, align 8, !tbaa !46, !alias.scope !749
  store <2 x double> %wide.load443, ptr %i.fr, align 8, !tbaa !46, !alias.scope !748, !noalias !749
  store <2 x double> %wide.load444, ptr %i.fs, align 8, !tbaa !46, !alias.scope !748, !noalias !749
  store <2 x double> %wide.load441, ptr %i.ft, align 8, !tbaa !46, !alias.scope !749
  store <2 x double> %wide.load442, ptr %i.fu, align 8, !tbaa !46, !alias.scope !749
  %index.next445 = add nuw i64 %index440, 4       ; 2 uses
  %i.fv = icmp eq i64 %index.next445, %n.vec438
  br i1 %i.fv, label %middle.block446, label %vector.body439, !llvm.loop !734
...
scalar.ph435.prol:                                ; preds = %scalar.ph435.preheader
  ...
  %i.fz = load double, ptr %i.fy, align 8, !tbaa !46
  store double %i.fz, ptr %i.fw, align 8, !tbaa !46
  store double %i.fx, ptr %i.fy, align 8, !tbaa !46
...
scalar.ph435:                                     ; preds = %scalar.ph435.prol.loopexit, %scalar.ph435
  ...
  %i.gc = load double, ptr %i.gb, align 8, !tbaa !46
  %i.gd = getelementptr inbounds nuw [8 x i8], ptr %i.ej, i64 %indvars.iv311 ; 2 uses
  %i.ge = load double, ptr %i.gd, align 8, !tbaa !46
  store double %i.ge, ptr %i.gb, align 8, !tbaa !46
  store double %i.gc, ptr %i.gd, align 8, !tbaa !46
  ...
  %i.gg = load double, ptr %i.gf, align 8, !tbaa !46
  %i.gh = getelementptr inbounds nuw [8 x i8], ptr %i.ej, i64 %indvars.iv.next312 ; 2 uses
  %i.gi = load double, ptr %i.gh, align 8, !tbaa !46
  store double %i.gi, ptr %i.gf, align 8, !tbaa !46
  store double %i.gg, ptr %i.gh, align 8, !tbaa !46
...
.loopexit231.loopexit:                            ; preds = %scalar.ph435.prol.loopexit, %scalar.ph435, %middle.block446
  %.pre346 = load double, ptr %i.ek, align 8, !tbaa !46
...
vector.body420:                                   ; preds = %vector.body420, %vector.ph416
  ...
  %wide.load422 = load <2 x double>, ptr %i.gn, align 8, !tbaa !46
  %i.go = fdiv <2 x double> %wide.load422, %broadcast.splat419
  store <2 x double> %i.go, ptr %i.gn, align 8, !tbaa !46
  %index.next423 = add nuw i64 %index421, 2       ; 2 uses
  %i.gp = icmp eq i64 %index.next423, %n.vec417
  br i1 %i.gp, label %middle.block424, label %vector.body420, !llvm.loop !736
...
.lr.ph258:                                        ; preds = %.lr.ph258.preheader471, %.lr.ph258
  ...
  %i.gr = load double, ptr %i.gq, align 8, !tbaa !46
  %i.gs = fdiv double %i.gr, %i.gj
  store double %i.gs, ptr %i.gq, align 8, !tbaa !46
...
.lr.ph262:                                        ; preds = %.lr.ph265.split
  ...
  %i.gw = load ptr, ptr %i.gv, align 8, !tbaa !279 ; 4 uses
  %i.gx = getelementptr inbounds nuw [8 x i8], ptr %i.gw, i64 %indvars.iv302 ; 2 uses
  %i.gy = load double, ptr %i.gx, align 8, !tbaa !46
...
vector.body399:                                   ; preds = %vector.body399, %vector.ph397
  ...
  %wide.load401 = load <2 x double>, ptr %i.he, align 8, !tbaa !46, !alias.scope !750, !noalias !751
  %wide.load402 = load <2 x double>, ptr %i.hf, align 8, !tbaa !46, !alias.scope !750, !noalias !751
  ...
  %wide.load404 = load <2 x double>, ptr %i.hh, align 8, !tbaa !46, !alias.scope !751
  %wide.load405 = load <2 x double>, ptr %i.hi, align 8, !tbaa !46, !alias.scope !751
  ...
  store <2 x double> %reverse408, ptr %i.he, align 8, !tbaa !46, !alias.scope !750, !noalias !751
  store <2 x double> %reverse409, ptr %i.hf, align 8, !tbaa !46, !alias.scope !750, !noalias !751
  %index.next410 = add nuw i64 %index400, 4       ; 2 uses
  %i.hj = icmp eq i64 %index.next410, %n.vec398
  br i1 %i.hj, label %middle.block411, label %vector.body399, !llvm.loop !741
...
scalar.ph395:                                     ; preds = %scalar.ph395.preheader, %scalar.ph395
  ...
  %i.hn = load double, ptr %i.hm, align 8, !tbaa !46
  %i.ho = tail call double @llvm.fmuladd.f64(double %i.gz, double %i.hn, double %i.hl)
  store double %i.ho, ptr %i.hk, align 8, !tbaa !46
...
.lr.ph.i184:                                      ; preds = %.unr-lcssa, %bb.h
  ...
  %i.hq = load ptr, ptr %i.hp, align 8, !tbaa !279 ; 2 uses
...
.lr.ph.i191:                                      ; preds = %_ZN2cv8ximgproc15EdgeDrawingImpl16DeallocateMatrixEPPdi.exit, %bb.j
  ...
  %i.ht = load ptr, ptr %i.hs, align 8, !tbaa !279 ; 2 uses
...
.lr.ph.i199:                                      ; preds = %_ZN2cv8ximgproc15EdgeDrawingImpl16DeallocateMatrixEPPdi.exit195, %bb.l
  ...
  %i.hw = load ptr, ptr %i.hv, align 8, !tbaa !279 ; 2 uses
...
.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge275
  ...
  %i.hz = load ptr, ptr %i.hy, align 8, !tbaa !279 ; 3 uses
  %i.ia = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv339
  %i.ib = load ptr, ptr %i.ia, align 8, !tbaa !279 ; 3 uses
...
vector.body455:                                   ; preds = %vector.body455, %vector.ph453
  ...
  %wide.load458 = load <2 x double>, ptr %i.ih, align 8, !tbaa !46
  ...
  store <2 x double> %wide.load457, ptr %i.ij, align 8, !tbaa !46
  store <2 x double> %wide.load458, ptr %i.ik, align 8, !tbaa !46
  %index.next459 = add nuw i64 %index456, 4       ; 2 uses
  %i.il = icmp eq i64 %index.next459, %n.vec454
  br i1 %i.il, label %middle.block460, label %vector.body455, !llvm.loop !745
...
scalar.ph451:                                     ; preds = %scalar.ph451.preheader, %scalar.ph451
  ...
  store double %i.in, ptr %i.io, align 8, !tbaa !46
...
.lr.ph.i207:                                      ; preds = %.lr.ph.i207.preheader, %bb.n
  ...
  %i.ir = load ptr, ptr %i.iq, align 8, !tbaa !279 ; 2 uses
