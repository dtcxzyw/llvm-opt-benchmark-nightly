...
.lr.ph171.i.split.us:                             ; preds = %.lr.ph171.i.split.us.preheader, %_ZN2cvL8MatrAXPYIdddEEviiPKT_iPKT0_iPT1_i.exit124.i.us
  ...
  %.0104165.i.us = phi ptr [ %i.dr, %_ZN2cvL8MatrAXPYIdddEEviiPKT_iPKT0_iPT1_i.exit124.i.us ], [ %4, %.lr.ph171.i.split.us.preheader ] ; 5 uses
  %.0105163.i.us = phi ptr [ %i.ds, %_ZN2cvL8MatrAXPYIdddEEviiPKT_iPKT0_iPT1_i.exit124.i.us ], [ %7, %.lr.ph171.i.split.us.preheader ] ; 4 uses
...
.lr.ph158.i.us:                                   ; preds = %.lr.ph158.i.us.preheader, %.lr.ph158.i.us
  ...
  %i.cd = getelementptr inbounds [8 x i8], ptr %.0104165.i.us, i64 %i.cc
  ...
  %i.ck = getelementptr inbounds [8 x i8], ptr %.0104165.i.us, i64 %i.cj
...
bb.c:                                             ; preds = %bb.b
  %i.cq = load double, ptr %.0104165.i.us, align 8, !tbaa !17
...
.lr.ph158.i.us.epil.preheader:                    ; preds = %.lr.ph162.preheader.i.us.loopexit.unr-lcssa, %.lr.ph158.i.us.preheader
  ...
  %i.cs = getelementptr inbounds [8 x i8], ptr %.0104165.i.us, i64 %i.cr
...
.lr.ph162.i.us:                                   ; preds = %.lr.ph162.preheader.i.us, %.lr.ph162.i.us
  ...
  %i.dc = getelementptr inbounds nuw [8 x i8], ptr %.0105163.i.us, i64 %indvars.iv204.i.us
  ...
  %i.di = getelementptr inbounds nuw [8 x i8], ptr %.0105163.i.us, i64 %indvars.iv.next205.i.us
...
.lr.ph162.i.us.epil.preheader:                    ; preds = %_ZN2cvL8MatrAXPYIdddEEviiPKT_iPKT0_iPT1_i.exit124.i.us.loopexit.unr-lcssa, %.lr.ph162.preheader.i.us
  ...
  %i.do = getelementptr inbounds nuw [8 x i8], ptr %.0105163.i.us, i64 %indvars.iv204.i.us.epil.init
...
_ZN2cvL8MatrAXPYIdddEEviiPKT_iPKT0_iPT1_i.exit124.i.us: ; preds = %.lr.ph162.i.us.epil.preheader, %_ZN2cvL8MatrAXPYIdddEEviiPKT_iPKT0_iPT1_i.exit124.i.us.loopexit.unr-lcssa, %.lr.ph171.i.split.us
  ...
  %i.dr = getelementptr inbounds [8 x i8], ptr %.0104165.i.us, i64 %i.bc
  %i.ds = getelementptr inbounds [8 x i8], ptr %.0105163.i.us, i64 %i.be
...
.lr.ph171.i.split:                                ; preds = %_ZN2cvL8MatrAXPYIdddEEviiPKT_iPKT0_iPT1_i.exit124.i, %.lr.ph171.i.split.preheader
  ...
  %.0104165.i = phi ptr [ %4, %.lr.ph171.i.split.preheader ], [ %i.hr, %_ZN2cvL8MatrAXPYIdddEEviiPKT_iPKT0_iPT1_i.exit124.i ] ; 8 uses
  %.0105163.i = phi ptr [ %7, %.lr.ph171.i.split.preheader ], [ %i.hs, %_ZN2cvL8MatrAXPYIdddEEviiPKT_iPKT0_iPT1_i.exit124.i ] ; 2 uses
...
vector.body15:                                    ; preds = %vector.body15, %vector.ph11
  ...
  %i.ea = getelementptr inbounds [8 x i8], ptr %.0104165.i, i64 %index16 ; 2 uses
...
.lr.ph155.i.prol:                                 ; preds = %.lr.ph155.i.preheader62, %.lr.ph155.i.prol
  ...
  %i.ei = getelementptr inbounds [8 x i8], ptr %.0104165.i, i64 %i.eh
...
.lr.ph.i.i:                                       ; preds = %._crit_edge.i.i, %.lr.ph.i.preheader.i
  ...
  %.02024.i.i = phi ptr [ %i.fo, %._crit_edge.i.i ], [ %9, %.lr.ph.i.preheader.i ] ; 5 uses
  %i.eo = mul nsw i64 %indvars.iv30.i.i, %i.ba
  %i.ep = getelementptr inbounds [8 x i8], ptr %.0104165.i, i64 %i.eo
...
vector.body50:                                    ; preds = %vector.body50, %vector.ph46
  ...
  %i.et = getelementptr inbounds nuw [8 x i8], ptr %.02024.i.i, i64 %index51 ; 2 uses
...
scalar.ph44.prol:                                 ; preds = %scalar.ph44.preheader
  ...
  %i.fa = getelementptr inbounds nuw [8 x i8], ptr %.02024.i.i, i64 %indvars.iv.i.i.ph
...
scalar.ph44:                                      ; preds = %scalar.ph44.prol.loopexit, %scalar.ph44
  ...
  %i.fg = getelementptr inbounds nuw [8 x i8], ptr %.02024.i.i, i64 %indvars.iv.i.i
  ...
  %i.fl = getelementptr inbounds nuw [8 x i8], ptr %.02024.i.i, i64 %indvars.iv.next.i.i
...
._crit_edge.i.i:                                  ; preds = %scalar.ph44.prol.loopexit, %scalar.ph44, %middle.block57
  ...
  %i.fo = getelementptr inbounds [8 x i8], ptr %.02024.i.i, i64 %i.ax
...
.lr.ph155.i:                                      ; preds = %.lr.ph155.i.prol.loopexit, %.lr.ph155.i
  ...
  %i.fy = getelementptr inbounds [8 x i8], ptr %.0104165.i, i64 %i.fx
