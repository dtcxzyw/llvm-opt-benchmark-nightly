...
bb.a:
  ...
  %2 = load <2 x float>, ptr %1, align 4, !tbaa !48 ; 2 uses
  %3 = shufflevector <2 x float> %2, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.l = fmul <2 x float> %3, %i.k                ; 2 uses
  %i.m = shufflevector <2 x float> %i.k, <2 x float> poison, <2 x i32> <i32 1, i32 0>
  %4 = shufflevector <2 x float> %2, <2 x float> poison, <2 x i32> zeroinitializer
  %i.n = fmul <2 x float> %i.m, %4                ; 4 uses
