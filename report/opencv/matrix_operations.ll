...
.preheader65.us.preheader:                        ; preds = %.lr.ph.split
  ...
  %i.em = getelementptr i8, ptr %i.ai, i64 %6
...
_ZNK2cv8MatShapeclEv.exit:                        ; preds = %bb.f, %.thread.i
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #16
  %i.z = zext nneg i32 %i.f to i64                ; 22 uses
...
.preheader65.us.preheader:                        ; preds = %.lr.ph.split
  ...
  %i.dn = zext nneg i32 %i.dm to i64              ; 10 uses
  ...
  %i.dr = shl nuw nsw i64 %i.dn, 1                ; 2 uses
  %i.ds = add nuw nsw i64 %i.dr, 2
  %umax = call i64 @llvm.umax.i64(i64 %i.ds, i64 %i.dj)
  %i.dt = add nsw i64 %umax, -2
  %i.du = sub nsw i64 %i.dt, %i.dn
  %.fr = freeze i64 %i.du                         ; 2 uses
  %5 = urem i64 %.fr, %i.z
  %6 = sub nuw i64 %.fr, %5
  ...
  %lcmp.mod220.not = icmp eq i64 %xtraiter219, 0
  %i.eh = getelementptr i8, ptr %i.ah, i64 %6
...
.preheader65.us.preheader:                        ; preds = %.lr.ph.split
  ...
  %i.dk = shl nuw nsw i64 %i.dg, 1
  %i.dl = add nuw nsw i64 %i.dk, 2
  %umax = call i64 @llvm.umax.i64(i64 %i.dl, i64 %i.cz)
  %i.dm = add nsw i64 %umax, -2
  %i.dn = sub nsw i64 %i.dm, %i.dg
...
.preheader65.us.preheader:                        ; preds = %.lr.ph.split
  ...
  %i.gk = zext nneg i32 %i.gj to i64              ; 3 uses
  %i.gl = shl nuw nsw i64 %i.gk, 1                ; 3 uses
  ...
  %i.gp = add nsw i64 %umax, -2
  %i.gq = sub nsw i64 %i.gp, %i.gk
  %i.gr = udiv i64 %i.gq, %i.aa
  %i.gs = mul i64 %i.gr, %i.go
...
.preheader57.us.preheader:                        ; preds = %.lr.ph.split
  ...
  %i.es = getelementptr i8, ptr %i.ai, i64 %6
...
.preheader57.us.preheader:                        ; preds = %.lr.ph.split
  ...
  %i.eb = zext nneg i32 %i.ea to i64              ; 10 uses
  ...
  %lcmp.mod212.not = icmp eq i64 %xtraiter211, 0
  %i.eu = getelementptr i8, ptr %i.ah, i64 %6
