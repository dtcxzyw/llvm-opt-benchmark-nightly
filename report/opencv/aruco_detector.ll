...
.preheader155.i:                                  ; preds = %_ZNSt6vectorIN2cv6Point_IfEESaIS2_EEC2IN9__gnu_cxx17__normal_iteratorIPNS1_IiEES_IS8_SaIS8_EEEEvEET_SD_RKS3_.exit.i, %_ZNSt6vectorIN2cv6Point_IfEESaIS2_EE9push_backERKS2_.exit.i
  ...
  %i.bs = getelementptr inbounds nuw [8 x i8], ptr %i.bj, i64 %i.bp ; 4 uses
  %.val98.i = load float, ptr %i.bs, align 4, !tbaa !142
  %18 = getelementptr i8, ptr %i.bs, i64 4
  %.val99.i = load float, ptr %18, align 4
  ...
  %19 = insertelement <4 x float> poison, float %.val98.i, i64 0
  %i.bv = shufflevector <4 x float> %19, <4 x float> poison, <4 x i32> zeroinitializer
  %i.bw = fcmp oeq <4 x float> %i.bu, %i.bv
  %i.bx = shufflevector <8 x float> %i.bt, <8 x float> poison, <4 x i32> <i32 1, i32 3, i32 5, i32 7>
  %20 = insertelement <4 x float> poison, float %.val99.i, i64 0
  %21 = shufflevector <4 x float> %20, <4 x float> poison, <4 x i32> zeroinitializer
  %i.by = fcmp oeq <4 x float> %i.bx, %21
