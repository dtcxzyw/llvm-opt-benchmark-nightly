...
bb.ax:                                            ; preds = %bb.aw
  ...
  %56 = sitofp <2 x i32> %i.hd to <2 x float>     ; 2 uses
  ...
  %59 = fmul float %i.hb, %i.hh                   ; 2 uses
  %60 = fmul float %i.hb, %57                     ; 2 uses
  %61 = fmul float %i.hb, %58                     ; 2 uses
  %i.hi = call float @llvm.fmuladd.f32(float %i.gy, float %59, float 0.000000e+00)
  %i.hj = call float @llvm.fmuladd.f32(float %i.gz, float %60, float %i.hi)
  %i.hk = call float @llvm.fmuladd.f32(float %i.ha, float %61, float %i.hj)
  ...
  %62 = insertelement <2 x float> %i.hm, float %i.he, i64 1
  %i.hn = insertelement <2 x float> poison, float %59, i64 0
  %63 = shufflevector <2 x float> %i.hn, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ho = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %62, <2 x float> %63, <2 x float> zeroinitializer)
  %i.hp = shufflevector <4 x float> %i.hl, <4 x float> poison, <2 x i32> <i32 1, i32 poison>
  %64 = insertelement <2 x float> %i.hp, float %i.hf, i64 1
  %i.hq = insertelement <2 x float> poison, float %60, i64 0
  %65 = shufflevector <2 x float> %i.hq, <2 x float> poison, <2 x i32> zeroinitializer
  %i.hr = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %64, <2 x float> %65, <2 x float> %i.ho)
  %i.hs = shufflevector <4 x float> %i.hl, <4 x float> poison, <2 x i32> <i32 2, i32 poison>
  %66 = insertelement <2 x float> %i.hs, float %i.hg, i64 1
  %i.ht = insertelement <2 x float> poison, float %61, i64 0
  %i.hu = shufflevector <2 x float> %i.ht, <2 x float> poison, <2 x i32> zeroinitializer
  %i.hv = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %66, <2 x float> %i.hu, <2 x float> %i.hr)
