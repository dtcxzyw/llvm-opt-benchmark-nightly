...
._crit_edge1061:                                  ; preds = %._crit_edge1061.loopexit, %bb.n
  ...
  %45 = extractelement <2 x double> %i.eq, i64 0  ; 2 uses
  %46 = extractelement <2 x double> %i.eq, i64 1  ; 2 uses
  %47 = fmul double %45, %46
  %i.er = fmul double %47, 2.000000e+00
  %48 = fadd double %45, %46
  %i.es = fdiv double %i.er, %48
