...
.noexc:                                           ; preds = %bb.w
  %i.dl = load ptr, ptr %i.dh, align 8, !tbaa !25
  %i.dm = getelementptr inbounds nuw i8, ptr %i.dl, i64 16 ; 2 uses
  store ptr %i.dm, ptr %i.dh, align 8, !tbaa !25
...
.noexc70:                                         ; preds = %bb.x
  %.pre.i = load ptr, ptr %i.dh, align 8, !tbaa !25
  br label %_ZNSt6vectorIN2cv8Subdiv2D6VertexESaIS2_EE12emplace_backIJEEERS2_DpOT_.exit.i
...
_ZNSt6vectorIN2cv8Subdiv2D6VertexESaIS2_EE12emplace_backIJEEERS2_DpOT_.exit.i: ; preds = %.noexc70, %.noexc
  ...
  %i.do = load ptr, ptr %0, align 8, !tbaa !18    ; 2 uses
...
bb.y:                                             ; preds = %_ZNSt6vectorIN2cv8Subdiv2D6VertexESaIS2_EE12emplace_backIJEEERS2_DpOT_.exit.i, %._crit_edge.i
  ...
  store i32 %i.dz, ptr %i.de, align 4, !tbaa !38
...
bb.z:                                             ; preds = %bb.y
  %i.ea = load ptr, ptr %0, align 8, !tbaa !18
  %i.eb = getelementptr inbounds nuw [16 x i8], ptr %i.ea, i64 %i.dx
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.eb, ptr noundef nonnull align 4 dereferenceable(16) %3, i64 16, i1 false), !tbaa.struct !40
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #27
  store i32 %i.dw, ptr %i.a, align 4, !tbaa !15
  %i.ec = getelementptr inbounds nuw i8, ptr %0, i64 48 ; 3 uses
  %i.ed = load i32, ptr %i.ec, align 8, !tbaa !37 ; 2 uses
...
._crit_edge.i72:                                  ; preds = %bb.z
  %.pre4.i = load ptr, ptr %i.ef, align 8, !tbaa !14
  br label %bb.ad

bb.aa:                                            ; preds = %bb.z
  %i.eg = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 4 uses
  %i.eh = load ptr, ptr %i.eg, align 8, !tbaa !26 ; 3 uses
...
.noexc75:                                         ; preds = %bb.ab
  %i.ek = load ptr, ptr %i.eg, align 8, !tbaa !26
  %i.el = getelementptr inbounds nuw i8, ptr %i.ek, i64 32 ; 2 uses
  store ptr %i.el, ptr %i.eg, align 8, !tbaa !26
...
.noexc76:                                         ; preds = %bb.ac
  %.pre.i74 = load ptr, ptr %i.eg, align 8, !tbaa !26
  br label %_ZNSt6vectorIN2cv8Subdiv2D8QuadEdgeESaIS2_EE12emplace_backIJEEERS2_DpOT_.exit.i
...
_ZNSt6vectorIN2cv8Subdiv2D8QuadEdgeESaIS2_EE12emplace_backIJEEERS2_DpOT_.exit.i: ; preds = %.noexc76, %.noexc75
  ...
  %i.en = load ptr, ptr %i.ef, align 8, !tbaa !14 ; 2 uses
  ...
  store i32 %i.et, ptr %i.ec, align 8, !tbaa !37
  br label %bb.ad
...
bb.ad:                                            ; preds = %_ZNSt6vectorIN2cv8Subdiv2D8QuadEdgeESaIS2_EE12emplace_backIJEEERS2_DpOT_.exit.i, %._crit_edge.i72
  ...
  %i.fa = load i32, ptr %i.ez, align 4, !tbaa !15
  store i32 %i.fa, ptr %i.ec, align 8, !tbaa !37
...
bb.ae:                                            ; preds = %bb.ad
  %i.fb = load ptr, ptr %i.ef, align 8, !tbaa !14
  %i.fc = getelementptr inbounds nuw [32 x i8], ptr %i.fb, i64 %i.ex
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(32) %i.fc, ptr noundef nonnull align 4 dereferenceable(32) %2, i64 32, i1 false), !tbaa.struct !42
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #27
  %i.fd = ashr i32 %.promoted, 2
  %i.fe = sext i32 %i.fd to i64
  %i.ff = load ptr, ptr %i.ef, align 8, !tbaa !14 ; 4 uses
  ...
  store i32 %i.fy, ptr %i.fm, align 4, !tbaa !15
  store i32 %i.fv, ptr %i.fu, align 4, !tbaa !15
  %i.gl = load i32, ptr %i.gf, align 4, !tbaa !15
  %i.gm = load i32, ptr %i.gk, align 4, !tbaa !15
  store i32 %i.gm, ptr %i.gf, align 4, !tbaa !15
  store i32 %i.gl, ptr %i.gk, align 4, !tbaa !15
  br label %bb.af
...
bb.ag:                                            ; preds = %bb.af
  ...
  %i.gs = load ptr, ptr %i.ef, align 8, !tbaa !14 ; 4 uses
  ...
  %i.gy = load i32, ptr %i.gx, align 4, !tbaa !15 ; 3 uses
  %i.gz = and i32 %i.gy, -4
  %i.ha = add i32 %i.gy, 1
  ...
  br i1 %.not52, label %bb.ah, label %bb.af, !llvm.loop !87

bb.ah:                                            ; preds = %bb.ag
  store i32 %i.hc, ptr %i.b, align 4, !tbaa !15
...
.lr.ph:                                           ; preds = %bb.ah, %bb.ao
  ...
  %i.hz = load i32, ptr %i.hy, align 4, !tbaa !15 ; 2 uses
  %i.ia = add i32 %i.hz, 1
  %i.ib = and i32 %i.ia, 3
  ...
  %i.ij = load i32, ptr %i.ii, align 4, !tbaa !15
  ...
  %i.io = load i32, ptr %i.in, align 4, !tbaa !15 ; 2 uses
  %i.ip = xor i32 %i.il, 2
  ...
  %i.iu = load ptr, ptr %0, align 8, !tbaa !18    ; 4 uses
...
bb.an:                                            ; preds = %bb.am
  ...
  %i.mg = load i32, ptr %i.mf, align 4, !tbaa !15 ; 2 uses
...
.loopexit:                                        ; preds = %bb.ao, %bb.am, %bb.ah, %._crit_edge97
  ...
  %i.ms = load i32, ptr %i.mr, align 8, !tbaa !45
