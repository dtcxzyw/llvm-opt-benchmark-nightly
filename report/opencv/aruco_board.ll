...
bb.m:                                             ; preds = %bb.l
  ...
  %i.cm = load ptr, ptr %i.cl, align 8, !tbaa !56 ; 8 uses
  %1 = load float, ptr %i.cm, align 4, !tbaa !145
  %2 = fadd float %1, 0.000000e+00
  %3 = getelementptr inbounds nuw i8, ptr %i.cm, i64 4
  %4 = load float, ptr %3, align 4, !tbaa !146
  %5 = fadd float %4, 0.000000e+00
  %i.cn = getelementptr inbounds nuw i8, ptr %i.cm, i64 12
  %6 = load float, ptr %i.cn, align 4, !tbaa !145
  %7 = fadd float %2, %6
  %i.co = getelementptr inbounds nuw i8, ptr %i.cm, i64 16
  %8 = load float, ptr %i.co, align 4, !tbaa !146
  %9 = fadd float %5, %8
  %i.cp = getelementptr inbounds nuw i8, ptr %i.cm, i64 24
  %10 = load float, ptr %i.cp, align 4, !tbaa !145
  %11 = fadd float %7, %10
  %12 = getelementptr inbounds nuw i8, ptr %i.cm, i64 28
  %13 = load float, ptr %12, align 4, !tbaa !146
  %14 = fadd float %9, %13
  %15 = getelementptr inbounds nuw i8, ptr %i.cm, i64 36
  %16 = load float, ptr %15, align 4, !tbaa !145
  %17 = fadd float %11, %16
  %18 = getelementptr inbounds nuw i8, ptr %i.cm, i64 40
  %19 = load float, ptr %18, align 4, !tbaa !146
  %20 = fadd float %14, %19
  %21 = fmul float %17, 2.500000e-01
  %i.cq = fmul float %20, 2.500000e-01
  %i.cr = fsub float %.sroa.0113.0.copyload, %21  ; 2 uses
...
.preheader.peel.next:                             ; preds = %_ZNSt6vectorIiSaIiEE9push_backEOi.exit.peel, %_ZNSt6vectorIiSaIiEE9push_backEOi.exit
  ...
  %i.el = load ptr, ptr %i.ek, align 8, !tbaa !56 ; 8 uses
  %22 = load float, ptr %i.el, align 4, !tbaa !145
  %23 = fadd float %22, 0.000000e+00
  %24 = getelementptr inbounds nuw i8, ptr %i.el, i64 4
  %25 = load float, ptr %24, align 4, !tbaa !146
  %26 = fadd float %25, 0.000000e+00
  %i.em = getelementptr inbounds nuw i8, ptr %i.el, i64 12
  %27 = load float, ptr %i.em, align 4, !tbaa !145
  %28 = fadd float %23, %27
  %i.en = getelementptr inbounds nuw i8, ptr %i.el, i64 16
  %29 = load float, ptr %i.en, align 4, !tbaa !146
  %30 = fadd float %26, %29
  %i.eo = getelementptr inbounds nuw i8, ptr %i.el, i64 24
  %31 = load float, ptr %i.eo, align 4, !tbaa !145
  %32 = fadd float %28, %31
  %33 = getelementptr inbounds nuw i8, ptr %i.el, i64 28
  %34 = load float, ptr %33, align 4, !tbaa !146
  %35 = fadd float %30, %34
  %36 = getelementptr inbounds nuw i8, ptr %i.el, i64 36
  %37 = load float, ptr %36, align 4, !tbaa !145
  %38 = fadd float %32, %37
  %39 = getelementptr inbounds nuw i8, ptr %i.el, i64 40
  %40 = load float, ptr %39, align 4, !tbaa !146
  %41 = fadd float %35, %40
  %42 = fmul float %38, 2.500000e-01
  %i.ep = fmul float %41, 2.500000e-01
  %i.eq = fsub float %.sroa.0113.0.copyload, %42  ; 2 uses
