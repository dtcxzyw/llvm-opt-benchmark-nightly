...
.lr.ph:                                           ; preds = %_ZN2cv3dnn14dnn5_v20260605L5totalERKNS_8MatShapeEii.exit121
  ...
  %16 = shl nsw i64 %i.kw, 2
  %scevgep187 = getelementptr inbounds nuw i8, ptr %0, i64 168
  %scevgep188.a = getelementptr i8, ptr %i.ka, i64 %16
  %min.iters.check = icmp ult i32 %i.kv, 12
  %umax = call i64 @llvm.umax.i64(i64 %i.ms, i64 1)
  %17 = mul i64 %umax, %i.kw
  %18 = shl i64 %17, 2
  %scevgep = getelementptr i8, ptr %i.jy, i64 %18 ; 2 uses
  %bound0 = icmp ult ptr %i.jy, %scevgep187
  %bound1 = icmp ult ptr %i.mt, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  %bound0189 = icmp ult ptr %i.jy, %scevgep188.a
  %bound1190 = icmp ult ptr %i.ka, %scevgep
