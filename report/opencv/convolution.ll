...
.preheader.preheader.i.i.i:                       ; preds = %bb.ai, %.lr.ph.i.i.i
  ...
  %i.eo = shufflevector <4 x float> %i.ee, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3> ; 2 uses
  %i.ep = shufflevector <4 x float> %i.eg, <4 x float> %i.ei, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.eq = shufflevector <4 x float> %i.ea, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3> ; 2 uses
  ...
  %i.ew = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.eq, <8 x float> <float f0x3C360B61, float f0x3C360B61, float f0x3C360B61, float f0x3C360B61, float f0x3F360B61, float f0x3F360B61, float f0x3F360B61, float f0x3F360B61>, <8 x float> %i.ev)
  %i.ex = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.eo, <8 x float> <float f0x3D360B61, float f0x3D360B61, float f0x3D360B61, float f0x3D360B61, float f0x3E360B61, float f0x3E360B61, float f0x3E360B61, float f0x3E360B61>, <8 x float> %i.ew)
  %i.ey = shufflevector <4 x float> %i.el, <4 x float> %i.en, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %3 = shufflevector <8 x float> %i.eo, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %i.fd = shufflevector <4 x float> %i.fc, <4 x float> %i.bw, <4 x i32> <i32 0, i32 1, i32 2, i32 4> ; 5 uses
  ...
  %i.fh = shufflevector <4 x float> %i.fg, <4 x float> %i.bw, <4 x i32> <i32 0, i32 1, i32 7, i32 6> ; 3 uses
  ...
  %i.fr = shufflevector <4 x float> %i.fh, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3> ; 2 uses
  %i.fs = shufflevector <4 x float> %i.fj, <4 x float> %i.fl, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ft = shufflevector <4 x float> %i.fd, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3> ; 2 uses
  ...
  %i.fz = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.ft, <8 x float> <float f0x3C360B61, float f0x3C360B61, float f0x3C360B61, float f0x3C360B61, float f0x3F360B61, float f0x3F360B61, float f0x3F360B61, float f0x3F360B61>, <8 x float> %i.fy)
  %i.ga = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %i.fr, <8 x float> <float f0x3D360B61, float f0x3D360B61, float f0x3D360B61, float f0x3D360B61, float f0x3E360B61, float f0x3E360B61, float f0x3E360B61, float f0x3E360B61>, <8 x float> %i.fz)
  %i.gb = shufflevector <4 x float> %i.fo, <4 x float> %i.fq, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %4 = shufflevector <8 x float> %i.fr, <8 x float> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
