...
.preheader.preheader.i.i.i:                       ; preds = %bb.ai, %.lr.ph.i.i.i
  ...
  %3 = fmul <4 x float> %i.ec, zeroinitializer    ; 2 uses
  %4 = fadd <4 x float> %i.ea, %3
  %i.ef = fmul <4 x float> %i.ec, splat (float f0xBE638E39)
  %5 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ea, <4 x float> splat (float f0xBE638E39), <4 x float> %i.ef)
  %i.eg = fmul <4 x float> %i.ec, splat (float f0xBEB60B61)
  %6 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ea, <4 x float> splat (float f0x3F360B61), <4 x float> %i.eg)
  %7 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ee, <4 x float> splat (float f0x3E360B61), <4 x float> %6)
  %i.eh = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ea, <4 x float> zeroinitializer, <4 x float> %3)
  %8 = fadd <4 x float> %i.ee, %i.eh
  %i.ei = shufflevector <4 x float> %i.ee, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %9 = shufflevector <4 x float> %4, <4 x float> %5, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %10 = shufflevector <4 x float> %i.ee, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %11 = shufflevector <4 x float> %i.ea, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.ej = shufflevector <4 x float> %i.ec, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.ek = fmul <8 x float> %i.ej, <float f0x3E638E39, float f0x3E638E39, float f0x3E638E39, float f0x3E638E39, float f0x3CB60B61, float f0x3CB60B61, float f0x3CB60B61, float f0x3CB60B61>
  %i.el = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %11, <8 x float> <float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0x3C360B61, float f0x3C360B61, float f0x3C360B61, float f0x3C360B61>, <8 x float> %i.ek)
  %12 = shufflevector <4 x float> %i.ee, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %13 = shufflevector <4 x float> %i.ea, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %14 = shufflevector <4 x float> %i.ec, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %15 = fmul <8 x float> %14, <float f0xBCB60B61, float f0xBCB60B61, float f0xBCB60B61, float f0xBCB60B61, float f0x3EB60B61, float f0x3EB60B61, float f0x3EB60B61, float f0x3EB60B61>
  %16 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %13, <8 x float> <float f0x3C360B61, float f0x3C360B61, float f0x3C360B61, float f0x3C360B61, float f0x3F360B61, float f0x3F360B61, float f0x3F360B61, float f0x3F360B61>, <8 x float> %15)
  %i.em = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %12, <8 x float> <float f0x3D360B61, float f0x3D360B61, float f0x3D360B61, float f0x3D360B61, float f0x3E360B61, float f0x3E360B61, float f0x3E360B61, float f0x3E360B61>, <8 x float> %16)
  %i.en = shufflevector <4 x float> %7, <4 x float> %8, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %17 = shufflevector <8 x float> %i.ei, <8 x float> %10, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %18 = shufflevector <8 x float> %9, <8 x float> %i.el, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.eo = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %17, <16 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0x3D360B61, float f0x3D360B61, float f0x3D360B61, float f0x3D360B61>, <16 x float> %18)
  ...
  %i.er = shufflevector <4 x float> %i.eq, <4 x float> %i.bw, <4 x i32> <i32 0, i32 1, i32 2, i32 4> ; 6 uses
  ...
  %i.ev = shufflevector <4 x float> %i.eu, <4 x float> %i.bw, <4 x i32> <i32 0, i32 1, i32 7, i32 6> ; 5 uses
  %19 = fmul <4 x float> %i.et, zeroinitializer   ; 2 uses
  %20 = fadd <4 x float> %i.er, %19
  %i.ew = fmul <4 x float> %i.et, splat (float f0xBE638E39)
  %21 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.er, <4 x float> splat (float f0xBE638E39), <4 x float> %i.ew)
  %i.ex = fmul <4 x float> %i.et, splat (float f0xBEB60B61)
  %22 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.er, <4 x float> splat (float f0x3F360B61), <4 x float> %i.ex)
  %23 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ev, <4 x float> splat (float f0x3E360B61), <4 x float> %22)
  %i.ey = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.er, <4 x float> zeroinitializer, <4 x float> %19)
  %24 = fadd <4 x float> %i.ev, %i.ey
  %i.ez = shufflevector <4 x float> %i.ev, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %25 = shufflevector <4 x float> %20, <4 x float> %21, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %26 = shufflevector <4 x float> %i.ev, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %27 = shufflevector <4 x float> %i.er, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.fa = shufflevector <4 x float> %i.et, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %i.fb = fmul <8 x float> %i.fa, <float f0x3E638E39, float f0x3E638E39, float f0x3E638E39, float f0x3E638E39, float f0x3CB60B61, float f0x3CB60B61, float f0x3CB60B61, float f0x3CB60B61>
  %i.fc = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %27, <8 x float> <float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0x3C360B61, float f0x3C360B61, float f0x3C360B61, float f0x3C360B61>, <8 x float> %i.fb)
  %28 = shufflevector <4 x float> %i.ev, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %29 = shufflevector <4 x float> %i.er, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %30 = shufflevector <4 x float> %i.et, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %31 = fmul <8 x float> %30, <float f0xBCB60B61, float f0xBCB60B61, float f0xBCB60B61, float f0xBCB60B61, float f0x3EB60B61, float f0x3EB60B61, float f0x3EB60B61, float f0x3EB60B61>
  %32 = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %29, <8 x float> <float f0x3C360B61, float f0x3C360B61, float f0x3C360B61, float f0x3C360B61, float f0x3F360B61, float f0x3F360B61, float f0x3F360B61, float f0x3F360B61>, <8 x float> %31)
  %i.fd = tail call <8 x float> @llvm.fmuladd.v8f32(<8 x float> %28, <8 x float> <float f0x3D360B61, float f0x3D360B61, float f0x3D360B61, float f0x3D360B61, float f0x3E360B61, float f0x3E360B61, float f0x3E360B61, float f0x3E360B61>, <8 x float> %32)
  %i.fe = shufflevector <4 x float> %23, <4 x float> %24, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %33 = shufflevector <8 x float> %i.ez, <8 x float> %26, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %34 = shufflevector <8 x float> %25, <8 x float> %i.fc, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
  %i.ff = tail call <16 x float> @llvm.fmuladd.v16f32(<16 x float> %33, <16 x float> <float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0xBE638E39, float f0x3D360B61, float f0x3D360B61, float f0x3D360B61, float f0x3D360B61>, <16 x float> %34)
