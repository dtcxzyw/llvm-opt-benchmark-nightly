...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x i32> %broadcast.splat, ptr %i.p, align 4, !tbaa !46
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.q = icmp eq i64 %index.next, %n.vec
  br i1 %i.q, label %middle.block, label %vector.body, !llvm.loop !51
...
.lr.ph.i.i.i.preheader5:                          ; preds = %.lr.ph.i.i.i.preheader, %middle.block
  %.06.i.i.i.ph = phi ptr [ %i.j, %.lr.ph.i.i.i.preheader ], [ %i.n, %middle.block ]
  br label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader5, %.lr.ph.i.i.i
  %.06.i.i.i = phi ptr [ %i.r, %.lr.ph.i.i.i ], [ %.06.i.i.i.ph, %.lr.ph.i.i.i.preheader5 ] ; 2 uses
  store i32 %i.h, ptr %.06.i.i.i, align 4, !tbaa !46
  %i.r = getelementptr inbounds nuw i8, ptr %.06.i.i.i, i64 4 ; 2 uses
...
vector.ph:                                        ; preds = %.lr.ph.i.i.i.preheader
  ...
  %i.ap = getelementptr i8, ptr %i.al, i64 %i.ao
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %i.al, i64 %i.aq ; 2 uses
  %i.ar = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %broadcast.splat, ptr %next.gep, align 8, !tbaa !80
  store <2 x i64> %broadcast.splat, ptr %i.ar, align 8, !tbaa !80
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.as = icmp eq i64 %index.next, %n.vec
  br i1 %i.as, label %middle.block, label %vector.body, !llvm.loop !87
...
.lr.ph.i.i.i.preheader8:                          ; preds = %.lr.ph.i.i.i.preheader, %middle.block
  %.06.i.i.i.ph = phi ptr [ %i.al, %.lr.ph.i.i.i.preheader ], [ %i.ap, %middle.block ]
  br label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader8, %.lr.ph.i.i.i
  %.06.i.i.i = phi ptr [ %i.at, %.lr.ph.i.i.i ], [ %.06.i.i.i.ph, %.lr.ph.i.i.i.preheader8 ] ; 2 uses
  store i64 %i.aj, ptr %.06.i.i.i, align 8, !tbaa !80
  %i.at = getelementptr inbounds nuw i8, ptr %.06.i.i.i, i64 8 ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.at, %i.ai
...
bb.n:                                             ; preds = %_ZN6google8protobuf13RepeatedFieldIlE9MergeFromERKS2_.exit
  %i.bh = load i32, ptr %i.b, align 4, !tbaa !76  ; 5 uses
  %.not.i.i.i = icmp slt i32 %i.bh, %i.bg
  br i1 %.not.i.i.i, label %bb.o, label %_ZN6google8protobuf13RepeatedFieldIlE7ReserveEi.exit.i.i
end_hunk_2
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.as = icmp eq i64 %index.next, %n.vec
  br i1 %i.as, label %middle.block, label %vector.body, !llvm.loop !105
...
bb.n:                                             ; preds = %_ZN6google8protobuf13RepeatedFieldImE9MergeFromERKS2_.exit
  %i.bh = load i32, ptr %i.b, align 4, !tbaa !96  ; 5 uses
  %.not.i.i.i = icmp slt i32 %i.bh, %i.bg
  br i1 %.not.i.i.i, label %bb.o, label %_ZN6google8protobuf13RepeatedFieldImE7ReserveEi.exit.i.i
end_hunk_3
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x float> %broadcast.splat, ptr %i.p, align 4, !tbaa !117
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.q = icmp eq i64 %index.next, %n.vec
  br i1 %i.q, label %middle.block, label %vector.body, !llvm.loop !124
...
.lr.ph.i.i.i.preheader5:                          ; preds = %.lr.ph.i.i.i.preheader, %middle.block
  %.07.i.i.i.ph = phi ptr [ %i.j, %.lr.ph.i.i.i.preheader ], [ %i.n, %middle.block ]
  br label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader5, %.lr.ph.i.i.i
  %.07.i.i.i = phi ptr [ %i.r, %.lr.ph.i.i.i ], [ %.07.i.i.i.ph, %.lr.ph.i.i.i.preheader5 ] ; 2 uses
  store float %i.h, ptr %.07.i.i.i, align 4, !tbaa !117
  %i.r = getelementptr inbounds nuw i8, ptr %.07.i.i.i, i64 4 ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.r, %i.g
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x double> %broadcast.splat, ptr %i.ar, align 8, !tbaa !137
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.as = icmp eq i64 %index.next, %n.vec
  br i1 %i.as, label %middle.block, label %vector.body, !llvm.loop !144
...
.lr.ph.i.i.i.preheader8:                          ; preds = %.lr.ph.i.i.i.preheader, %middle.block
  %.07.i.i.i.ph = phi ptr [ %i.al, %.lr.ph.i.i.i.preheader ], [ %i.ap, %middle.block ]
  br label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader8, %.lr.ph.i.i.i
  %.07.i.i.i = phi ptr [ %i.at, %.lr.ph.i.i.i ], [ %.07.i.i.i.ph, %.lr.ph.i.i.i.preheader8 ] ; 2 uses
  store double %i.aj, ptr %.07.i.i.i, align 8, !tbaa !137
  %i.at = getelementptr inbounds nuw i8, ptr %.07.i.i.i, i64 8 ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.at, %i.ai
...
bb.n:                                             ; preds = %_ZN6google8protobuf13RepeatedFieldIdE9MergeFromERKS2_.exit
  %i.bh = load i32, ptr %i.b, align 4, !tbaa !133 ; 5 uses
  %.not.i.i.i = icmp slt i32 %i.bh, %i.bg
  br i1 %.not.i.i.i, label %bb.o, label %_ZN6google8protobuf13RepeatedFieldIdE7ReserveEi.exit.i.i
end_hunk_5
