...
.lr.ph842.split.us:                               ; preds = %.lr.ph842.split.us.preheader, %._crit_edge.us
  ...
  %13 = phi <2 x float> [ %i.ij, %.lr.ph842.split.us.preheader ], [ %17, %._crit_edge.us ] ; 2 uses
  %i.jg = phi <2 x float> [ %i.ik, %.lr.ph842.split.us.preheader ], [ %i.md, %._crit_edge.us ] ; 2 uses
  %i.jh = phi <2 x float> [ %i.il, %.lr.ph842.split.us.preheader ], [ %i.me, %._crit_edge.us ] ; 2 uses
  %i.ji = phi <2 x float> [ %i.im, %.lr.ph842.split.us.preheader ], [ %i.mf, %._crit_edge.us ] ; 2 uses
  %14 = phi <4 x float> [ zeroinitializer, %.lr.ph842.split.us.preheader ], [ %18, %._crit_edge.us ] ; 2 uses
...
.lr.ph.split.us.us.preheader:                     ; preds = %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit624.us
  %i.kb = extractelement <2 x float> %i.jg, i64 1
...
.lr.ph.split.us871:                               ; preds = %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit624.us, %bb.ar
  ...
  %i.kc = phi <4 x float> [ %i.lz, %bb.ar ], [ %14, %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit624.us ] ; 2 uses
...
bb.aq:                                            ; preds = %.lr.ph.split.us871
  ...
  %i.lm = load i16, ptr %i.ll, align 2, !tbaa !87
  %i.ln = load i16, ptr %.0443801.us857, align 2, !tbaa !87
  ...
  %15 = shufflevector <4 x i32> %i.lu, <4 x i32> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 0>
  %16 = shufflevector <4 x i32> %i.lt, <4 x i32> %15, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.lv = sitofp <4 x i32> %16 to <4 x float>
  %i.lw = insertelement <4 x float> <float 1.000000e+00, float 1.000000e+00, float poison, float 1.000000e+00>, float %i.lh, i64 2
...
._crit_edge.us.loopexit:                          ; preds = %bb.at
  %i.mb = shufflevector <2 x float> %30, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.mc = insertelement <2 x float> %i.mb, float %.5488.us.us, i64 1
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %bb.ar, %._crit_edge.us.loopexit
  %17 = phi <2 x float> [ %30, %._crit_edge.us.loopexit ], [ %13, %bb.ar ] ; 2 uses
  %i.md = phi <2 x float> [ %i.mc, %._crit_edge.us.loopexit ], [ %i.jg, %bb.ar ] ; 2 uses
  %i.me = phi <2 x float> [ %i.ow, %._crit_edge.us.loopexit ], [ %i.jh, %bb.ar ] ; 2 uses
  %i.mf = phi <2 x float> [ %i.ox, %._crit_edge.us.loopexit ], [ %i.ji, %bb.ar ] ; 2 uses
  %18 = phi <4 x float> [ %31, %._crit_edge.us.loopexit ], [ %i.lz, %bb.ar ] ; 2 uses
...
.lr.ph.split.us.us:                               ; preds = %.lr.ph.split.us.us.preheader, %bb.at
  ...
  %19 = phi <2 x float> [ %30, %bb.at ], [ %13, %.lr.ph.split.us.us.preheader ] ; 2 uses
  %i.mh = phi <2 x float> [ %i.ow, %bb.at ], [ %i.jh, %.lr.ph.split.us.us.preheader ] ; 2 uses
  %i.mi = phi <2 x float> [ %i.ox, %bb.at ], [ %i.ji, %.lr.ph.split.us.us.preheader ] ; 2 uses
  %20 = phi <4 x float> [ %31, %bb.at ], [ %14, %.lr.ph.split.us.us.preheader ] ; 2 uses
...
bb.as:                                            ; preds = %.lr.ph.split.us.us
  ...
  %21 = mul nsw i32 %i.nl, %i.nl
  %22 = uitofp nneg i32 %21 to float
  %23 = load <2 x i16>, ptr %.0443801.us.us, align 2, !tbaa !87 ; 3 uses
  %24 = extractelement <2 x i16> %23, i64 0
  %25 = extractelement <2 x i16> %23, i64 1
  %26 = insertelement <4 x i32> poison, i32 %i.nr, i64 0
  %27 = shufflevector <4 x i32> %26, <4 x i32> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 0>
  %28 = insertelement <4 x float> <float 1.000000e+00, float 1.000000e+00, float poison, float 1.000000e+00>, float %i.no, i64 2
  %i.ns = sext i16 %25 to i32                     ; 4 uses
  %i.nt = sext i16 %24 to i32                     ; 4 uses
  %i.nu = mul nsw i32 %i.nr, %i.ns
  %i.nv = mul nsw i32 %i.nr, %i.nt
  %i.nw = insertelement <4 x i32> poison, i32 %i.nv, i64 0
  %i.nx = insertelement <4 x i32> %i.nw, i32 %i.nu, i64 1
  %29 = shufflevector <4 x i32> %i.nx, <4 x i32> %27, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.ny = sitofp <4 x i32> %29 to <4 x float>
  %i.nz = fmul nnan <4 x float> %28, %i.ny
  %i.oa = fadd <4 x float> %20, %i.nz
  ...
  %i.os = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ok, <2 x float> %i.or, <2 x float> %i.mh)
  %i.ot = insertelement <2 x float> poison, float %22, i64 0
  %i.ou = insertelement <2 x float> %i.ot, float %i.no, i64 1
  %i.ov = fadd <2 x float> %i.mi, %i.ou
  br label %bb.at

bb.at:                                            ; preds = %bb.as, %.lr.ph.split.us.us
  %.5488.us.us = phi float [ %.3486792.us.us, %.lr.ph.split.us.us ], [ %i.op, %bb.as ] ; 2 uses
  %30 = phi <2 x float> [ %19, %.lr.ph.split.us.us ], [ %i.on, %bb.as ] ; 3 uses
  %i.ow = phi <2 x float> [ %i.mh, %.lr.ph.split.us.us ], [ %i.os, %bb.as ] ; 2 uses
  %i.ox = phi <2 x float> [ %i.mi, %.lr.ph.split.us.us ], [ %i.ov, %bb.as ] ; 2 uses
  %31 = phi <4 x float> [ %20, %.lr.ph.split.us.us ], [ %i.oa, %bb.as ] ; 2 uses
...
._crit_edge843.loopexit:                          ; preds = %._crit_edge.us
  %i.pa = fmul <4 x float> %18, <float f0x37800000, float f0x37800000, float f0xB7800000, float f0xB7800000>
  br label %._crit_edge843

._crit_edge843:                                   ; preds = %.lr.ph842, %._crit_edge843.loopexit, %bb.an
  %32 = phi <2 x float> [ %i.ij, %bb.an ], [ %17, %._crit_edge843.loopexit ], [ %i.ij, %.lr.ph842 ] ; 2 uses
  %i.pb = phi <2 x float> [ %i.ik, %bb.an ], [ %i.md, %._crit_edge843.loopexit ], [ %i.ik, %.lr.ph842 ] ; 2 uses
  %i.pc = phi <2 x float> [ %i.il, %bb.an ], [ %i.me, %._crit_edge843.loopexit ], [ %i.il, %.lr.ph842 ] ; 2 uses
  %i.pd = phi <2 x float> [ %i.im, %bb.an ], [ %i.mf, %._crit_edge843.loopexit ], [ %i.im, %.lr.ph842 ] ; 2 uses
  %33 = phi <4 x float> [ <float 0.000000e+00, float 0.000000e+00, float -0.000000e+00, float -0.000000e+00>, %bb.an ], [ %i.pa, %._crit_edge843.loopexit ], [ <float 0.000000e+00, float 0.000000e+00, float -0.000000e+00, float -0.000000e+00>, %.lr.ph842 ] ; 8 uses
...
bb.au:                                            ; preds = %._crit_edge843
  %i.pf = fmul <2 x float> %i.pb, splat (float f0xB7800000)
  %i.pg = fmul <2 x float> %i.pc, splat (float f0xB7800000)
  %i.ph = fmul <2 x float> %i.pd, splat (float f0x37800000)
  %i.pi = fmul <2 x float> %32, <float f0x37800000, float f0xB7800000>
...
bb.av:                                            ; preds = %bb.au, %._crit_edge843
  ...
  %i.pk = phi <2 x float> [ %i.pi, %bb.au ], [ %32, %._crit_edge843 ] ; 7 uses
  %i.pl = phi <2 x float> [ %i.pf, %bb.au ], [ %i.pb, %._crit_edge843 ] ; 13 uses
  %i.pm = phi <2 x float> [ %i.pg, %bb.au ], [ %i.pc, %._crit_edge843 ] ; 9 uses
  %i.pn = phi <2 x float> [ %i.ph, %bb.au ], [ %i.pd, %._crit_edge843 ] ; 8 uses
...
bb.bc:                                            ; preds = %bb.av
  ...
  %34 = shufflevector <4 x float> %33, <4 x float> poison, <2 x i32> zeroinitializer
  %i.xn = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.xm, <2 x float> %34, <2 x float> zeroinitializer)
  %35 = shufflevector <4 x float> %33, <4 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.xo = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.we, <2 x float> %35, <2 x float> %i.xn)
  %36 = shufflevector <4 x float> %33, <4 x float> poison, <2 x i32> <i32 2, i32 2>
  %i.xp = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ww, <2 x float> %36, <2 x float> %i.xo)
  %37 = shufflevector <4 x float> %33, <4 x float> poison, <2 x i32> <i32 3, i32 3>
  ...
  %i.xs = extractelement <2 x float> %i.ww, i64 0
  %i.xt = extractelement <4 x float> %33, i64 0   ; 2 uses
  %38 = call float @llvm.fmuladd.f32(float %i.xr, float %i.xt, float 0.000000e+00)
  %i.xu = extractelement <4 x float> %33, i64 1   ; 2 uses
  %39 = call float @llvm.fmuladd.f32(float %i.xs, float %i.xu, float %38)
  %40 = extractelement <4 x float> %33, i64 2     ; 2 uses
  %i.xv = call float @llvm.fmuladd.f32(float %i.uz, float %40, float %39)
  %41 = extractelement <4 x float> %33, i64 3     ; 2 uses
  %i.xw = call float @llvm.fmuladd.f32(float %i.vh, float %41, float %i.xv) ; 3 uses
...
bb.bh:                                            ; preds = %bb.bg, %bb.be
  ...
  %i.zu = call float @llvm.fmuladd.f32(float %i.zm, float %i.xt, float 0.000000e+00)
  %i.zv = call float @llvm.fmuladd.f32(float %i.zn, float %i.xu, float %i.zu)
  %i.zw = call float @llvm.fmuladd.f32(float %i.vh, float %40, float %i.zv)
  %i.zx = call float @llvm.fmuladd.f32(float %i.zl, float %41, float %i.zw)
...
bb.ab:                                            ; preds = %.lr.ph1045, %bb.ce
  %.05321044 = phi float [ 1.000000e+00, %.lr.ph1045 ], [ %.2534.lcssa, %bb.ce ]
...
._crit_edge1009.loopexit:                         ; preds = %._crit_edge976
  %16 = extractelement <2 x float> %23, i64 1
  %17 = fmul float %16, f0xB7800000
  %18 = fmul float %.3560.lcssa.a, f0xB7800000
  %19 = extractelement <2 x float> %23, i64 0
  %20 = fmul float %19, f0x37800000
  %21 = fmul float %.1595.lcssa, f0x37800000
  br label %._crit_edge1009

._crit_edge1009:                                  ; preds = %._crit_edge1009.loopexit, %.thread
  %.0594.lcssa = phi float [ 0.000000e+00, %.thread ], [ %21, %._crit_edge1009.loopexit ]
  %.0591.lcssa = phi float [ 0.000000e+00, %.thread ], [ %20, %._crit_edge1009.loopexit ]
  %.0588.lcssa = phi float [ -0.000000e+00, %.thread ], [ %18, %._crit_edge1009.loopexit ]
  %.2559.lcssa.a = phi float [ -0.000000e+00, %.thread ], [ %17, %._crit_edge1009.loopexit ]
  %.2545.lcssa.a = phi float [ %.1558907, %.thread ], [ %.3546.lcssa.a, %._crit_edge1009.loopexit ] ; 2 uses
  %.2534.lcssa.a = phi float [ %.1544909, %.thread ], [ %.3.lcssa.a, %._crit_edge1009.loopexit ] ; 2 uses
  %.2534.lcssa = phi float [ %.1533, %.thread ], [ %.3.lcssa, %._crit_edge1009.loopexit ]
...
bb.be:                                            ; preds = %.lr.ph1008, %._crit_edge976
  ...
  %.25341006 = phi float [ %.1533, %.lr.ph1008 ], [ %.3.lcssa, %._crit_edge976 ] ; 2 uses
  %.25341006.a = phi float [ %.1544909, %.lr.ph1008 ], [ %.3.lcssa.a, %._crit_edge976 ] ; 2 uses
  %.25451004 = phi float [ %.1558907, %.lr.ph1008 ], [ %.3546.lcssa.a, %._crit_edge976 ] ; 2 uses
  %.25591002 = phi float [ 0.000000e+00, %.lr.ph1008 ], [ %.3560.lcssa.a, %._crit_edge976 ] ; 2 uses
  %.0594995 = phi float [ 0.000000e+00, %.lr.ph1008 ], [ %.1595.lcssa, %._crit_edge976 ] ; 2 uses
  ...
  %22 = phi <2 x float> [ zeroinitializer, %.lr.ph1008 ], [ %23, %._crit_edge976 ] ; 2 uses
...
._crit_edge976:                                   ; preds = %bb.bs, %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit747
  %.1595.lcssa = phi float [ %.0594995, %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit747 ], [ %.2596, %bb.bs ] ; 2 uses
  %.3560.lcssa.a = phi float [ %.25591002, %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit747 ], [ %.2590, %bb.bs ] ; 2 uses
  %.3546.lcssa.a = phi float [ %.25451004, %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit747 ], [ %.5562, %bb.bs ] ; 2 uses
  %.3.lcssa.a = phi float [ %.25341006.a, %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit747 ], [ %.5548, %bb.bs ] ; 2 uses
  %.3.lcssa = phi float [ %.25341006, %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit747 ], [ %.6, %bb.bs ] ; 2 uses
  %i.qn = phi <2 x float> [ %i.pt, %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit747 ], [ %i.uq, %bb.bs ] ; 2 uses
  %i.qo = phi <2 x float> [ %i.pu, %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit747 ], [ %i.un, %bb.bs ] ; 2 uses
  %i.qp = phi <4 x float> [ %i.pv, %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit747 ], [ %i.uo, %bb.bs ] ; 2 uses
  %23 = phi <2 x float> [ %22, %_ZNK2cv3Mat3ptrIhEEPKT_ii.exit747 ], [ %i.up, %bb.bs ] ; 3 uses
...
.lr.ph975:                                        ; preds = %.lr.ph975.preheader, %bb.bs
  ...
  %.3972 = phi float [ %.25341006, %.lr.ph975.preheader ], [ %.6, %bb.bs ] ; 4 uses
  %.3546970 = phi float [ %.25341006.a, %.lr.ph975.preheader ], [ %.5548, %bb.bs ] ; 3 uses
  %.3560968 = phi float [ %.25451004, %.lr.ph975.preheader ], [ %.5562, %bb.bs ] ; 3 uses
  %.1589963 = phi float [ %.25591002, %.lr.ph975.preheader ], [ %.2590, %bb.bs ] ; 2 uses
  %.1595961 = phi float [ %.0594995, %.lr.ph975.preheader ], [ %.2596, %bb.bs ] ; 2 uses
  %i.qq = phi <2 x float> [ %i.pu, %.lr.ph975.preheader ], [ %i.un, %bb.bs ] ; 3 uses
  %24 = phi <4 x float> [ %i.pv, %.lr.ph975.preheader ], [ %i.uo, %bb.bs ] ; 3 uses
  %i.qr = phi <2 x float> [ %22, %.lr.ph975.preheader ], [ %i.up, %bb.bs ] ; 2 uses
  %i.qs = phi <2 x float> [ %i.pt, %.lr.ph975.preheader ], [ %i.uq, %bb.bs ] ; 3 uses
...
bb.bm:                                            ; preds = %bb.bh, %bb.bj, %bb.bl, %bb.bk
  ...
  %25 = sitofp i32 %i.sy to float
  %i.ta = insertelement <2 x i32> poison, i32 %i.sz, i64 0
  %26 = insertelement <2 x i32> %i.ta, i32 %.0524, i64 1
  %27 = sitofp <2 x i32> %26 to <2 x float>       ; 2 uses
  %i.tb = fadd float %.1595961, %25               ; 2 uses
  %i.tc = extractelement <2 x float> %27, i64 1
  %i.td = call float @llvm.fmuladd.f32(float %i.tc, float %i.ry, float %.1589963) ; 2 uses
  %i.te = fadd <2 x float> %i.qr, %27             ; 2 uses
...
bb.br:                                            ; preds = %bb.bn, %bb.bp, %bb.bq
  ...
  %i.ub = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.tz, <2 x float> %i.ua, <2 x float> %i.qq)
...
bb.bs:                                            ; preds = %bb.bm, %bb.br, %.lr.ph975
  %.2596 = phi float [ %.1595961, %.lr.ph975 ], [ %i.tb, %bb.br ], [ %i.tb, %bb.bm ] ; 2 uses
  %.2590 = phi float [ %.1589963, %.lr.ph975 ], [ %i.td, %bb.br ], [ %i.td, %bb.bm ] ; 2 uses
  ...
  %i.un = phi <2 x float> [ %i.qq, %.lr.ph975 ], [ %i.ub, %bb.br ], [ %i.qq, %bb.bm ] ; 2 uses
  %i.uo = phi <4 x float> [ %24, %.lr.ph975 ], [ %i.ul, %bb.br ], [ %24, %bb.bm ] ; 2 uses
  %i.up = phi <2 x float> [ %i.qr, %.lr.ph975 ], [ %i.te, %bb.br ], [ %i.te, %bb.bm ] ; 2 uses
  %i.uq = phi <2 x float> [ %i.qs, %.lr.ph975 ], [ %i.tx, %bb.br ], [ %i.qs, %bb.bm ] ; 2 uses
  ...
  br i1 %exitcond1073.not, label %._crit_edge976, label %.lr.ph975, !llvm.loop !406

bb.bt:                                            ; preds = %._crit_edge1009
  %i.us = fmul <2 x float> %i.pq, splat (float f0xB7800000)
  %i.ut = fmul float %.2545.lcssa.a, f0x37800000
  %i.uu = fmul float %.2534.lcssa.a, f0xB7800000
...
bb.bu:                                            ; preds = %bb.bt, %._crit_edge1009
  %.6563 = phi float [ %i.ut, %bb.bt ], [ %.2545.lcssa.a, %._crit_edge1009 ] ; 13 uses
  %.6549 = phi float [ %i.uu, %bb.bt ], [ %.2534.lcssa.a, %._crit_edge1009 ] ; 18 uses
  %i.ux = phi <2 x float> [ %i.us, %bb.bt ], [ %i.pq, %._crit_edge1009 ] ; 12 uses
  %i.uy = phi <2 x float> [ %i.uv, %bb.bt ], [ %i.pr, %._crit_edge1009 ] ; 8 uses
  %i.uz = phi <4 x float> [ %i.uw, %bb.bt ], [ %i.ps, %._crit_edge1009 ] ; 7 uses
  %i.va = extractelement <4 x float> %i.uz, i64 3 ; 18 uses
  %i.vb = fneg float %i.va
  %i.vc = fmul float %i.va, %i.vb
  %i.vd = extractelement <4 x float> %i.uz, i64 2 ; 14 uses
  ...
  %i.vm = extractelement <2 x float> %i.ux, i64 0 ; 12 uses
  %i.vn = fmul float %i.vm, %i.vl
  %i.vo = call float @llvm.fmuladd.f32(float %i.vn, float %.6549, float %i.vj)
  %i.vp = extractelement <2 x float> %i.ux, i64 1 ; 15 uses
...
bb.bz:                                            ; preds = %bb.bu
  ...
  %28 = fmul float %i.va, %i.vd                   ; 3 uses
  %29 = fneg float %i.vd                          ; 2 uses
  %30 = fmul float %28, %29
  %31 = shufflevector <2 x float> %i.ux, <2 x float> poison, <2 x i32> zeroinitializer
  %32 = shufflevector <4 x float> %i.uz, <4 x float> poison, <2 x i32> <i32 2, i32 2> ; 3 uses
  %i.yz = shufflevector <2 x float> %i.uy, <2 x float> %32, <2 x i32> <i32 0, i32 3>
  %i.za = fmul <2 x float> %31, %i.yz             ; 2 uses
  ...
  %34 = shufflevector <2 x float> %32, <2 x float> %i.ux, <2 x i32> <i32 0, i32 3>
  %i.zz = insertelement <2 x float> poison, float %i.zu, i64 0
  %i.aaa = insertelement <2 x float> %i.zz, float %i.zv, i64 1
  %i.aab = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.zy, <2 x float> %34, <2 x float> %i.aaa)
  ...
  %i.aar = shufflevector <2 x float> %35, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.abh = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %37, <2 x float> %i.abg, <2 x float> %i.abf)
  ...
  %38 = insertelement <2 x float> %i.aaw, float %28, i64 0
  %i.abv = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %38, <2 x float> %i.zi, <2 x float> %i.abu)
  ...
  %39 = insertelement <2 x float> %i.aby, float %i.aan, i64 1
  %i.abz = insertelement <2 x float> poison, float %.0594.lcssa, i64 0
  %40 = shufflevector <2 x float> %i.abz, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.aca = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %39, <2 x float> %40, <2 x float> zeroinitializer)
  %41 = insertelement <2 x float> poison, float %.0591.lcssa, i64 0
  %42 = shufflevector <2 x float> %41, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.acb = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aaq, <2 x float> %42, <2 x float> %i.aca)
  %43 = insertelement <2 x float> poison, float %.0588.lcssa, i64 0
  %44 = shufflevector <2 x float> %43, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.acc = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.abi, <2 x float> %44, <2 x float> %i.acb)
  %45 = insertelement <2 x float> poison, float %.2559.lcssa.a, i64 0
  %i.acd = shufflevector <2 x float> %45, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  ...
  %i.adj = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.adi, <2 x float> %40, <2 x float> zeroinitializer)
  %i.adk = shufflevector <2 x float> %i.abx, <2 x float> %i.abi, <2 x i32> <i32 0, i32 2>
  %i.adl = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.adk, <2 x float> %42, <2 x float> %i.adj)
  ...
  %i.ado = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.adn, <2 x float> %44, <2 x float> %i.adl)
