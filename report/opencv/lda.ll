...
.preheader794:                                    ; preds = %.preheader794.lr.ph.split, %._crit_edge926
  ...
  %smin1194 = tail call i32 @llvm.smin.i32(i32 %11, i32 %i.z)
  %12 = trunc nuw i64 %indvars.iv1056 to i32      ; 2 uses
  %smin1041 = tail call i32 @llvm.smin.i32(i32 %12, i32 %i.z) ; 2 uses
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %.preheader.us
  ...
  %i.ajr = getelementptr inbounds nuw [8 x i8], ptr %i.ajq, i64 %indvars.iv1056
  ...
  %i.ajv = getelementptr inbounds nuw [8 x i8], ptr %i.aju, i64 %indvars.iv1056
  ...
  %i.ajz = getelementptr inbounds nuw [8 x i8], ptr %i.ajy, i64 %indvars.iv1056
  ...
  %i.akd = getelementptr inbounds nuw [8 x i8], ptr %i.akc, i64 %indvars.iv1056
...
.preheader.lr.ph.split:                           ; preds = %.preheader794
  %13 = add nuw nsw i32 %smin1041, 1
  %wide.trip.count1042 = zext nneg i32 %13 to i64 ; 2 uses
  %xtraiter1195 = and i64 %wide.trip.count1042, 3 ; 3 uses
  %14 = icmp ult i32 %smin1194, 3
  %unroll_iter1200 = and i64 %wide.trip.count1042, 2147483644
...
.preheader:                                       ; preds = %.preheader.lr.ph.split, %._crit_edge922
  ...
  br i1 %14, label %.epil.preheader1191, label %.preheader.new
...
.preheader.us.epil.a:                             ; preds = %.preheader.us.epil.a, %.preheader.us.epil.preheader
  ...
  %15 = getelementptr inbounds nuw [8 x i8], ptr %i.vc, i64 %indvars.iv1050.epil
  %16 = load ptr, ptr %15, align 8, !tbaa !147
  %17 = getelementptr inbounds nuw [8 x i8], ptr %16, i64 %indvars.iv1056
...
._crit_edge926:                                   ; preds = %._crit_edge922, %._crit_edge926.loopexit.unr-lcssa, %.preheader.us.epil.a
  ...
  br i1 %18, label %.preheader794, label %.loopexit, !llvm.loop !368
...
bb.ch:                                            ; preds = %bb.ch, %.epil.preheader1191
  ...
  %i.akk = getelementptr inbounds nuw [8 x i8], ptr %i.akj, i64 %indvars.iv1056
...
._crit_edge922:                                   ; preds = %bb.ch, %._crit_edge922.unr-lcssa
  ...
  %i.akn = getelementptr inbounds nuw [8 x i8], ptr %i.akf, i64 %indvars.iv1056
...
.preheader.new:                                   ; preds = %.preheader, %.preheader.new
  ...
  %i.aks = getelementptr inbounds nuw [8 x i8], ptr %i.akr, i64 %indvars.iv1056
  ...
  %i.akz = getelementptr inbounds nuw [8 x i8], ptr %i.aky, i64 %indvars.iv1056
  ...
  %i.alg = getelementptr inbounds nuw [8 x i8], ptr %i.alf, i64 %indvars.iv1056
  ...
  %i.aln = getelementptr inbounds nuw [8 x i8], ptr %i.alm, i64 %indvars.iv1056
