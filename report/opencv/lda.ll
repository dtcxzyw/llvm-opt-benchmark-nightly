...
.preheader809:                                    ; preds = %.preheader809.lr.ph, %.thread786
  ...
  %.0773875 = phi i32 [ %i.z, %.preheader809.lr.ph ], [ %.1774, %.thread786 ] ; 27 uses
...
.preheader809.split.us:                           ; preds = %.preheader809.split, %.preheader809.split.preheader, %.preheader809.split.us.split.loop.exit1114
  %.us-phi = phi i32 [ %i.bu, %.preheader809.split.us.split.loop.exit1114 ], [ 0, %.preheader809.split.preheader ], [ 0, %.preheader809.split ] ; 10 uses
...
bb.p:                                             ; preds = %bb.l
  %5 = getelementptr inbounds nuw [8 x i8], ptr %i.cl, i64 %i.cj ; 2 uses
  %6 = load double, ptr %5, align 8, !tbaa !77    ; 11 uses
  ...
  %i.ij = load double, ptr %i.ii, align 8, !tbaa !77 ; 4 uses
  ...
  %i.io = fmul double %i.il, %i.in                ; 4 uses
  switch i32 %.0609878, label %bb.r [
    i32 10, label %.lr.ph818.preheader
    i32 30, label %bb.q
  ]

.lr.ph818.preheader:                              ; preds = %bb.p
  %i.ip = fadd double %.0618877, %6
...
.thread1095:                                      ; preds = %.lr.ph818.epil, %.thread1095.unr-lcssa
  %i.ix = getelementptr i8, ptr %5, i64 -8
...
bb.q:                                             ; preds = %bb.p
  %i.ke = fsub double %i.ij, %6                   ; 2 uses
  %i.kf = fmul double %i.ke, 5.000000e-01         ; 2 uses
  %i.kg = tail call double @llvm.fmuladd.f64(double %i.kf, double %i.kf, double %i.io) ; 2 uses
...
.lr.ph823.preheader:                              ; preds = %bb.q
  ...
  %i.km = fdiv double %i.io, %i.kl
  %i.kn = fsub double %6, %i.km                   ; 6 uses
...
bb.r:                                             ; preds = %bb.p, %.thread1095, %bb.q, %._crit_edge824
  %.3621 = phi double [ %.0618877, %bb.p ], [ %i.kv, %._crit_edge824 ], [ %.0618877, %bb.q ], [ %i.ip, %.thread1095 ] ; 3 uses
  %.2596 = phi double [ %6, %bb.p ], [ f0x3FEED916872B020C, %._crit_edge824 ], [ %6, %bb.q ], [ %i.jh, %.thread1095 ] ; 2 uses
  %.3593 = phi double [ %i.ij, %bb.p ], [ f0x3FEED916872B020C, %._crit_edge824 ], [ %i.ij, %bb.q ], [ %i.jh, %.thread1095 ]
  %.3589 = phi double [ %i.io, %bb.p ], [ f0x3FEED916872B020C, %._crit_edge824 ], [ %i.io, %bb.q ], [ %i.jj, %.thread1095 ]
...
bb.bb:                                            ; preds = %.lr.ph917, %.loopexit800
  %indvar = phi i32 [ 0, %.lr.ph917 ], [ %indvar.next, %.loopexit800 ] ; 2 uses
  ...
  %i.ve = sub i32 %i.z, %indvar                   ; 2 uses
  %i.vf = zext i32 %indvars.iv1023 to i64
  %i.vg = zext i32 %indvars.iv1010 to i64
  %i.vh = getelementptr inbounds nuw [8 x i8], ptr %i.ut, i64 %indvars.iv1035
  %i.vi = load double, ptr %i.vh, align 8, !tbaa !77 ; 6 uses
  %i.vj = getelementptr inbounds nuw [8 x i8], ptr %i.uv, i64 %indvars.iv1035
  %i.vk = load double, ptr %i.vj, align 8, !tbaa !77 ; 22 uses
  %i.vl = fcmp oeq double %i.vk, 0.000000e+00
  br i1 %i.vl, label %bb.bc, label %bb.bm

bb.bc:                                            ; preds = %bb.bb
  %i.vm = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %indvars.iv1035
  %i.vn = load ptr, ptr %i.vm, align 8, !tbaa !147
  %i.vo = getelementptr inbounds nuw [8 x i8], ptr %i.vn, i64 %indvars.iv1035
  store double 1.000000e+00, ptr %i.vo, align 8, !tbaa !77
...
.lr.ph914.preheader:                              ; preds = %bb.bc
  %i.vp = trunc nsw i64 %indvars.iv1035 to i32
  br label %.lr.ph914
...
.lr.ph914:                                        ; preds = %.lr.ph914.preheader, %.loopexit796
  ...
  %indvars.iv1025 = phi i64 [ %i.vf, %.lr.ph914.preheader ], [ %indvars.iv.next1026, %.loopexit796 ] ; 2 uses
  %.0554910 = phi i32 [ %i.vp, %.lr.ph914.preheader ], [ %.1555, %.loopexit796 ] ; 4 uses
  ...
  %i.vq = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %indvars.iv.next1033
  %i.vr = load ptr, ptr %i.vq, align 8, !tbaa !147 ; 10 uses
  %i.vs = getelementptr inbounds nuw [8 x i8], ptr %i.vr, i64 %indvars.iv.next1033
  %i.vt = load double, ptr %i.vs, align 8, !tbaa !77
  %i.vu = fsub double %i.vt, %i.vi                ; 4 uses
  %i.vv = sext i32 %.0554910 to i64               ; 3 uses
  %.not661896 = icmp slt i64 %indvars.iv1035, %i.vv
  br i1 %.not661896, label %._crit_edge901, label %.lr.ph900.preheader

.lr.ph900.preheader:                              ; preds = %.lr.ph914
  %i.vw = sub i32 %indvars.iv1006, %.0554910
  %i.vx = sub i32 %i.ve, %.0554910
  %xtraiter1189 = and i32 %i.vw, 3                ; 2 uses
...
.lr.ph900.prol:                                   ; preds = %.lr.ph900.preheader, %.lr.ph900.prol
  %indvars.iv1018.prol = phi i64 [ %indvars.iv.next1019.prol, %.lr.ph900.prol ], [ %i.vv, %.lr.ph900.preheader ] ; 3 uses
  ...
  %i.vy = getelementptr inbounds [8 x i8], ptr %i.vr, i64 %indvars.iv1018.prol
...
.lr.ph900.prol.loopexit:                          ; preds = %.lr.ph900.prol, %.lr.ph900.preheader
  ...
  %indvars.iv1018.unr = phi i64 [ %i.vv, %.lr.ph900.preheader ], [ %indvars.iv.next1019.prol, %.lr.ph900.prol ]
...
.lr.ph900:                                        ; preds = %.lr.ph900.prol.loopexit, %.lr.ph900
  ...
  %i.wj = getelementptr inbounds [8 x i8], ptr %i.vr, i64 %indvars.iv1018
  ...
  %i.wq = getelementptr inbounds [8 x i8], ptr %i.vr, i64 %indvars.iv.next1019
  ...
  %i.wx = getelementptr inbounds [8 x i8], ptr %i.vr, i64 %indvars.iv.next1019.1
  ...
  %i.xe = getelementptr inbounds [8 x i8], ptr %i.vr, i64 %indvars.iv.next1019.2
...
bb.be:                                            ; preds = %bb.bd
  %i.xm = fcmp une double %i.vu, 0.000000e+00
  %i.xn = fneg double %.0552.lcssa                ; 2 uses
  %i.xo = getelementptr inbounds nuw [8 x i8], ptr %i.vr, i64 %indvars.iv1035 ; 2 uses
  br i1 %i.xm, label %bb.bf, label %bb.bg

bb.bf:                                            ; preds = %bb.be
  %i.xp = fdiv double %i.xn, %i.vu
...
bb.bh:                                            ; preds = %bb.bd
  %i.xr = getelementptr inbounds nuw [8 x i8], ptr %i.vr, i64 %indvars.iv1032
  ...
  %i.ym = getelementptr inbounds nuw [8 x i8], ptr %i.vr, i64 %indvars.iv1035
...
bb.bk:                                            ; preds = %bb.bi, %bb.bj, %bb.bf, %bb.bg
  %i.yz = getelementptr inbounds nuw [8 x i8], ptr %i.vr, i64 %indvars.iv1035
...
begin_hunk_2_@_ZN2cv23EigenvalueDecomposition4hqr2Ev:bb.a
  %i.aep = load ptr, ptr %i.aeo, align 8, !tbaa !147 ; 4 uses
  %i.aeq = getelementptr inbounds nuw [8 x i8], ptr %i.aep, i64 %indvars.iv1012
  %i.aer = load double, ptr %i.aeq, align 8, !tbaa !77 ; 2 uses
  %i.aes = getelementptr inbounds nuw [8 x i8], ptr %i.ut, i64 %indvars.iv1012
  %i.aet = load double, ptr %i.aes, align 8, !tbaa !77
  %i.aeu = fsub double %i.aet, %i.vi              ; 3 uses
  %i.aev = fmul double %i.acp, %i.acp
  %i.aew = tail call double @llvm.fmuladd.f64(double %i.aeu, double %i.aeu, double %i.aev)
  %i.aex = tail call double @llvm.fmuladd.f64(double %i.abr, double %i.vk, double %i.aew) ; 2 uses
  %i.aey = fmul double %i.aeu, 2.000000e+00
  %i.aez = fmul double %i.vk, %i.aey              ; 6 uses
  %i.afa = fcmp oeq double %i.aex, 0.000000e+00
  %i.afb = fcmp oeq double %i.aez, 0.000000e+00
  %or.cond = select i1 %i.afa, i1 %i.afb, i1 false
  br i1 %or.cond, label %bb.by, label %bb.bz

bb.by:                                            ; preds = %bb.bx
  %i.afc = tail call noundef double @llvm.fabs.f64(double %i.acn)
  %i.afd = fadd double %i.abs, %i.afc
  %i.afe = tail call noundef double @llvm.fabs.f64(double %i.aen)
  %i.aff = fadd double %i.afd, %i.afe
  %i.afg = tail call noundef double @llvm.fabs.f64(double %i.aer)
  %i.afh = fadd double %i.aff, %i.afg
  %i.afi = tail call noundef double @llvm.fabs.f64(double %.0548891)
  %i.afj = fadd double %i.afi, %i.afh
  %i.afk = fmul double %i.uw, %i.afj
  br label %bb.bz

bb.bz:                                            ; preds = %bb.by, %bb.bx
  %.0539 = phi double [ %i.afk, %bb.by ], [ %i.aex, %bb.bx ] ; 5 uses
  %i.afl = fneg <2 x double> %i.ack               ; 3 uses
  %i.afm = insertelement <2 x double> poison, double %.0548891, i64 0
  %i.afn = shufflevector <2 x double> %i.afm, <2 x double> poison, <2 x i32> zeroinitializer
  %i.afo = fmul <2 x double> %i.afn, %i.afl
  %i.afp = insertelement <2 x double> poison, double %i.aen, i64 0
  %i.afq = shufflevector <2 x double> %i.afp, <2 x double> poison, <2 x i32> zeroinitializer
  %i.afr = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.afq, <2 x double> %i.abw, <2 x double> %i.afo)
  %i.afs = shufflevector <2 x double> %i.afr, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.aft = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.abv, <2 x double> %i.ack, <2 x double> %i.afs) ; 5 uses
  %i.afu = getelementptr [8 x i8], ptr %.pre1063, i64 %indvars.iv1035 ; 2 uses
  %i.afv = getelementptr i8, ptr %i.afu, i64 -8   ; 2 uses
  %i.afw = tail call noundef double @llvm.fabs.f64(double %.0539)
  %i.afx = tail call noundef double @llvm.fabs.f64(double %i.aez)
  %i.afy = fcmp ogt double %i.afw, %i.afx
  br i1 %i.afy, label %bb.ca, label %bb.cb

bb.ca:                                            ; preds = %bb.bz
  %i.afz = fdiv double %i.aez, %.0539             ; 3 uses
  %i.aga = tail call double @llvm.fmuladd.f64(double %i.afz, double %i.aez, double %.0539)
  %i.agb = fneg double %i.afz
  %i.agc = insertelement <2 x double> poison, double %i.afz, i64 0
  %i.agd = insertelement <2 x double> %i.agc, double %i.agb, i64 1
  %i.age = shufflevector <2 x double> %i.aft, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.agf = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.agd, <2 x double> %i.aft, <2 x double> %i.age)
  %i.agg = insertelement <2 x double> poison, double %i.aga, i64 0
  %i.agh = shufflevector <2 x double> %i.agg, <2 x double> poison, <2 x i32> zeroinitializer
  %i.agi = fdiv <2 x double> %i.agf, %i.agh
  br label %_ZN2cv23EigenvalueDecomposition11complex_divEddddRdS1_.exit687

bb.cb:                                            ; preds = %bb.bz
  %i.agj = fdiv double %.0539, %i.aez             ; 2 uses
  %i.agk = tail call double @llvm.fmuladd.f64(double %i.agj, double %.0539, double %i.aez)
  %i.agl = insertelement <2 x double> poison, double %i.agj, i64 0
  %i.agm = shufflevector <2 x double> %i.agl, <2 x double> poison, <2 x i32> zeroinitializer
  %i.agn = shufflevector <2 x double> %i.aft, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.ago = fneg <2 x double> %i.aft
  %i.agp = shufflevector <2 x double> %i.aft, <2 x double> %i.ago, <2 x i32> <i32 0, i32 3>
  %i.agq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.agm, <2 x double> %i.agn, <2 x double> %i.agp)
  %i.agr = insertelement <2 x double> poison, double %i.agk, i64 0
  %i.ags = shufflevector <2 x double> %i.agr, <2 x double> poison, <2 x i32> zeroinitializer
  %i.agt = fdiv <2 x double> %i.agq, %i.ags
  br label %_ZN2cv23EigenvalueDecomposition11complex_divEddddRdS1_.exit687

_ZN2cv23EigenvalueDecomposition11complex_divEddddRdS1_.exit687: ; preds = %bb.ca, %bb.cb
  %i.agu = phi <2 x double> [ %i.agi, %bb.ca ], [ %i.agt, %bb.cb ] ; 4 uses
  store <2 x double> %i.agu, ptr %i.afv, align 8, !tbaa !77
  %i.agv = tail call noundef double @llvm.fabs.f64(double %i.aen)
  %i.agw = tail call noundef double @llvm.fabs.f64(double %.0548891) ; 2 uses
  %i.agx = fadd double %i.abs, %i.agw
  %i.agy = fcmp ogt double %i.agv, %i.agx
  br i1 %i.agy, label %bb.cc, label %bb.cd

bb.cc:                                            ; preds = %_ZN2cv23EigenvalueDecomposition11complex_divEddddRdS1_.exit687
  %i.agz = fneg double %i.acn                     ; 2 uses
  %i.aha = extractelement <2 x double> %i.agu, i64 0
  %i.ahb = extractelement <2 x double> %i.afl, i64 0
  %i.ahc = tail call double @llvm.fmuladd.f64(double %i.agz, double %i.aha, double %i.ahb)
  %i.ahd = extractelement <2 x double> %i.agu, i64 1
  %i.ahe = tail call double @llvm.fmuladd.f64(double %i.vk, double %i.ahd, double %i.ahc)
  %i.ahf = fdiv double %i.ahe, %i.aen
  %i.ahg = getelementptr inbounds [8 x i8], ptr %i.aep, i64 %i.zp
  store double %i.ahf, ptr %i.ahg, align 8, !tbaa !77
  %i.ahh = load double, ptr %i.afu, align 8, !tbaa !77
  %i.ahi = extractelement <2 x double> %i.afl, i64 1
  %i.ahj = tail call double @llvm.fmuladd.f64(double %i.agz, double %i.ahh, double %i.ahi)
  %i.ahk = load double, ptr %i.afv, align 8, !tbaa !77
  %i.ahl = tail call double @llvm.fmuladd.f64(double %i.abr, double %i.ahk, double %i.ahj)
  %i.ahm = fdiv double %i.ahl, %i.aen
  %i.ahn = getelementptr inbounds nuw [8 x i8], ptr %i.aep, i64 %indvars.iv1035
  store double %i.ahm, ptr %i.ahn, align 8, !tbaa !77
  br label %bb.cg

bb.cd:                                            ; preds = %_ZN2cv23EigenvalueDecomposition11complex_divEddddRdS1_.exit687
  %i.aho = fneg double %i.aer
  %i.ahp = fneg <2 x double> %i.abw
  %i.ahq = insertelement <2 x double> poison, double %i.aho, i64 0
  %i.ahr = shufflevector <2 x double> %i.ahq, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ahs = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ahr, <2 x double> %i.agu, <2 x double> %i.ahp) ; 5 uses
  %i.aht = getelementptr inbounds [8 x i8], ptr %i.aep, i64 %i.zp
  %i.ahu = fcmp ogt double %i.agw, %i.abs
  br i1 %i.ahu, label %bb.ce, label %bb.cf

bb.ce:                                            ; preds = %bb.cd
  %i.ahv = fdiv double %i.vk, %.0548891           ; 3 uses
  %i.ahw = tail call double @llvm.fmuladd.f64(double %i.ahv, double %i.vk, double %.0548891)
  %i.ahx = fneg double %i.ahv
  %i.ahy = insertelement <2 x double> poison, double %i.ahx, i64 0
  %i.ahz = insertelement <2 x double> %i.ahy, double %i.ahv, i64 1
  %i.aia = shufflevector <2 x double> %i.ahs, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.aib = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ahz, <2 x double> %i.ahs, <2 x double> %i.aia)
  %i.aic = insertelement <2 x double> poison, double %i.ahw, i64 0
  %i.aid = shufflevector <2 x double> %i.aic, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aie = fdiv <2 x double> %i.aib, %i.aid
  br label %_ZN2cv23EigenvalueDecomposition11complex_divEddddRdS1_.exit690

bb.cf:                                            ; preds = %bb.cd
  %i.aif = fdiv double %.0548891, %i.vk           ; 2 uses
  %i.aig = tail call double @llvm.fmuladd.f64(double %i.aif, double %.0548891, double %i.vk)
  %i.aih = insertelement <2 x double> poison, double %i.aif, i64 0
  %i.aii = shufflevector <2 x double> %i.aih, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aij = shufflevector <2 x double> %i.ahs, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  %i.aik = fneg <2 x double> %i.ahs
  %i.ail = shufflevector <2 x double> %i.aik, <2 x double> %i.ahs, <2 x i32> <i32 0, i32 3>
  %i.aim = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.aii, <2 x double> %i.aij, <2 x double> %i.ail)
  %i.ain = insertelement <2 x double> poison, double %i.aig, i64 0
  %i.aio = shufflevector <2 x double> %i.ain, <2 x double> poison, <2 x i32> zeroinitializer
  %i.aip = fdiv <2 x double> %i.aim, %i.aio
  br label %_ZN2cv23EigenvalueDecomposition11complex_divEddddRdS1_.exit690

_ZN2cv23EigenvalueDecomposition11complex_divEddddRdS1_.exit690: ; preds = %bb.ce, %bb.cf
  %i.aiq = phi <2 x double> [ %i.aie, %bb.ce ], [ %i.aip, %bb.cf ]
  %i.air = shufflevector <2 x double> %i.aiq, <2 x double> poison, <2 x i32> <i32 1, i32 0>
  store <2 x double> %i.air, ptr %i.aht, align 8, !tbaa !77
  br label %bb.cg
...
bb.cg:                                            ; preds = %bb.cc, %_ZN2cv23EigenvalueDecomposition11complex_divEddddRdS1_.exit690, %_ZN2cv23EigenvalueDecomposition11complex_divEddddRdS1_.exit684
  %i.ais = getelementptr [8 x i8], ptr %.pre1063, i64 %indvars.iv1035
  %i.ait = getelementptr i8, ptr %i.ais, i64 -8
  %i.aiu = load <2 x double>, ptr %i.ait, align 8, !tbaa !77
  %i.aiv = tail call <2 x double> @llvm.fabs.v2f64(<2 x double> %i.aiu) ; 2 uses
  %i.aiw = extractelement <2 x double> %i.aiv, i64 0 ; 2 uses
  %i.aix = extractelement <2 x double> %i.aiv, i64 1 ; 2 uses
  %i.aiy = fcmp olt double %i.aiw, %i.aix
  %.sroa.speculated701 = select i1 %i.aiy, double %i.aix, double %i.aiw ; 3 uses
  %i.aiz = fmul double %.sroa.speculated701, f0x3CB0000000000000
  %i.aja = fmul double %.sroa.speculated701, %i.aiz
  %i.ajb = fcmp ule double %i.aja, 1.000000e+00
  %.not660888 = icmp sgt i64 %indvars.iv1012, %indvars.iv1035
  %or.cond928 = or i1 %i.ajb, %.not660888
  %i.ajc = trunc nuw nsw i64 %indvars.iv1012 to i32 ; 2 uses
  br i1 %or.cond928, label %.loopexit798, label %.lr.ph890.preheader

.lr.ph890.preheader:                              ; preds = %bb.cg
  %i.ajd = insertelement <2 x double> poison, double %.sroa.speculated701, i64 0
  %i.aje = shufflevector <2 x double> %i.ajd, <2 x double> poison, <2 x i32> zeroinitializer
  br label %.lr.ph890
...
.lr.ph890:                                        ; preds = %.lr.ph890.preheader, %.lr.ph890
  ...
  %i.ajf = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %indvars.iv1014
  %i.ajg = load ptr, ptr %i.ajf, align 8, !tbaa !147
  %i.ajh = getelementptr [8 x i8], ptr %i.ajg, i64 %indvars.iv1035
  %i.aji = getelementptr i8, ptr %i.ajh, i64 -8   ; 2 uses
  %i.ajj = load <2 x double>, ptr %i.aji, align 8, !tbaa !77
  %i.ajk = fdiv <2 x double> %i.ajj, %i.aje
  store <2 x double> %i.ajk, ptr %i.aji, align 8, !tbaa !77
  %indvars.iv.next1015 = add nuw nsw i64 %indvars.iv1014, 1
  %sext1092 = shl i64 %indvars.iv1014, 32
  %i.ajl = ashr exact i64 %sext1092, 32
  %.not660.not = icmp slt i64 %i.ajl, %indvars.iv1035
  br i1 %.not660.not, label %.lr.ph890, label %.loopexit798, !llvm.loop !363

.loopexit798:                                     ; preds = %.lr.ph890, %bb.cg, %._crit_edge885
  %.1549 = phi double [ %i.acn, %._crit_edge885 ], [ %.0548891, %bb.cg ], [ %.0548891, %.lr.ph890 ]
  %.1 = phi i32 [ %.0543894, %._crit_edge885 ], [ %i.ajc, %bb.cg ], [ %i.ajc, %.lr.ph890 ]
  %i.ajm = phi <2 x double> [ %i.ack, %._crit_edge885 ], [ %i.abw, %bb.cg ], [ %i.abw, %.lr.ph890 ]
  %indvars.iv.next1013 = add nsw i64 %indvars.iv1012, -1
  %i.ajn = icmp sgt i64 %indvars.iv1012, 0
  br i1 %i.ajn, label %.preheader799, label %.loopexit800, !llvm.loop !364
...
.loopexit800:                                     ; preds = %.loopexit798, %.loopexit796, %bb.bs, %bb.bm
  ...
  %i.ajo = icmp sgt i64 %indvars.iv1035, 0
  ...
  br i1 %i.ajo, label %bb.bb, label %.preheader794.lr.ph.split, !llvm.loop !365

.preheader794:                                    ; preds = %.preheader794.lr.ph.split, %.preheader.us.epil.a
  %indvars.iv1056 = phi i64 [ 0, %.preheader794.lr.ph.split ], [ %epil.iter1203.next, %.preheader.us.epil.a ] ; 2 uses
  %indvars.iv1060 = phi i64 [ %i.vd, %.preheader794.lr.ph.split ], [ %indvars.iv.next1061, %.preheader.us.epil.a ] ; 14 uses
  %indvars.iv1058 = phi i64 [ %wide.trip.count, %.preheader794.lr.ph.split ], [ %indvars.iv.next1051.epil, %.preheader.us.epil.a ] ; 3 uses
  %7 = sub i64 %i.n, %indvars.iv1056
  %8 = and i64 %indvars.iv1060, 2147483648
  %.not658918.not = icmp eq i64 %8, 0
  br i1 %.not658918.not, label %.preheader.preheader, label %.preheader.us.preheader

.preheader.preheader:                             ; preds = %.preheader794
  %xtraiter1206 = and i64 %indvars.iv1058, 3      ; 3 uses
  %9 = icmp ult i64 %7, 3
  %unroll_iter1211 = and i64 %indvars.iv1058, -4
  %lcmp.mod1208.not = icmp eq i64 %xtraiter1206, 0
  %lcmp.mod1210 = icmp ne i64 %xtraiter1206, 0
  br label %.preheader

.preheader.us.preheader:                          ; preds = %.preheader794
  %xtraiter1213 = and i64 %wide.trip.count, 3     ; 3 uses
  %10 = icmp ult i32 %i.a, 4
  br i1 %10, label %.preheader.us.epil.preheader, label %.preheader.us.preheader.new

.preheader.us.preheader.new:                      ; preds = %.preheader.us.preheader
  %unroll_iter1217 = and i64 %wide.trip.count, 2147483644
  br label %.preheader.us

.preheader.us:                                    ; preds = %.preheader.us, %.preheader.us.preheader.new
  %indvars.iv1050 = phi i64 [ 0, %.preheader.us.preheader.new ], [ %indvars.iv.next1051.3, %.preheader.us ] ; 5 uses
  %niter1207 = phi i64 [ 0, %.preheader.us.preheader.new ], [ %niter1207.next.3, %.preheader.us ]
  %i.ajp = getelementptr inbounds nuw [8 x i8], ptr %i.vc, i64 %indvars.iv1050
  %i.ajq = load ptr, ptr %i.ajp, align 8, !tbaa !147
  %i.ajr = getelementptr inbounds nuw [8 x i8], ptr %i.ajq, i64 %indvars.iv1060
  store double 0.000000e+00, ptr %i.ajr, align 8, !tbaa !77
  %i.ajs = getelementptr inbounds nuw [8 x i8], ptr %i.vc, i64 %indvars.iv1050
  %i.ajt = getelementptr inbounds nuw i8, ptr %i.ajs, i64 8
  %i.aju = load ptr, ptr %i.ajt, align 8, !tbaa !147
  %i.ajv = getelementptr inbounds nuw [8 x i8], ptr %i.aju, i64 %indvars.iv1060
  store double 0.000000e+00, ptr %i.ajv, align 8, !tbaa !77
  %i.ajw = getelementptr inbounds nuw [8 x i8], ptr %i.vc, i64 %indvars.iv1050
  %i.ajx = getelementptr inbounds nuw i8, ptr %i.ajw, i64 16
  %i.ajy = load ptr, ptr %i.ajx, align 8, !tbaa !147
  %i.ajz = getelementptr inbounds nuw [8 x i8], ptr %i.ajy, i64 %indvars.iv1060
  store double 0.000000e+00, ptr %i.ajz, align 8, !tbaa !77
  %i.aka = getelementptr inbounds nuw [8 x i8], ptr %i.vc, i64 %indvars.iv1050
  %i.akb = getelementptr inbounds nuw i8, ptr %i.aka, i64 24
  %i.akc = load ptr, ptr %i.akb, align 8, !tbaa !147
  %i.akd = getelementptr inbounds nuw [8 x i8], ptr %i.akc, i64 %indvars.iv1060
  store double 0.000000e+00, ptr %i.akd, align 8, !tbaa !77
  %indvars.iv.next1051.3 = add nuw nsw i64 %indvars.iv1050, 4 ; 2 uses
  %niter1207.next.3 = add i64 %niter1207, 4       ; 2 uses
  %niter1207.ncmp.3 = icmp eq i64 %niter1207.next.3, %unroll_iter1217
  br i1 %niter1207.ncmp.3, label %.loopexit.loopexit.unr-lcssa, label %.preheader.us, !llvm.loop !366

.preheader:                                       ; preds = %.preheader.preheader, %._crit_edge922
  %indvars.iv1044 = phi i64 [ %indvars.iv.next1045, %._crit_edge922 ], [ 0, %.preheader.preheader ] ; 2 uses
  %i.ake = getelementptr inbounds nuw [8 x i8], ptr %i.vc, i64 %indvars.iv1044
  %i.akf = load ptr, ptr %i.ake, align 8, !tbaa !147 ; 6 uses
  br i1 %9, label %.epil.preheader1191, label %.preheader.new

.preheader.us.epil.a:                             ; preds = %._crit_edge922
  %indvars.iv.next1061 = add nsw i64 %indvars.iv1060, -1
  %.not1130 = icmp eq i64 %indvars.iv1060, 0
  %indvars.iv.next1051.epil = add nsw i64 %indvars.iv1058, -1
  %epil.iter1203.next = add i64 %indvars.iv1056, 1
  br i1 %.not1130, label %.loopexit, label %.preheader794, !llvm.loop !367

._crit_edge922.unr-lcssa:                         ; preds = %.preheader.new
  br i1 %lcmp.mod1208.not, label %._crit_edge922, label %.epil.preheader1191
...
.epil.preheader1191:                              ; preds = %._crit_edge922.unr-lcssa, %.preheader
  ...
  %.0535919.epil.init = phi double [ 0.000000e+00, %.preheader ], [ %i.alp, %._crit_edge922.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod1210)
  br label %bb.ch
...
bb.ch:                                            ; preds = %bb.ch, %.epil.preheader1191
  ...
  %.0535919.epil = phi double [ %.0535919.epil.init, %.epil.preheader1191 ], [ %i.akm, %bb.ch ]
  %epil.iter1196 = phi i64 [ 0, %.epil.preheader1191 ], [ %epil.iter1196.next, %bb.ch ]
  %i.akg = getelementptr inbounds nuw [8 x i8], ptr %i.akf, i64 %indvars.iv1038.epil
  %i.akh = load double, ptr %i.akg, align 8, !tbaa !77
  %i.aki = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %indvars.iv1038.epil
  %i.akj = load ptr, ptr %i.aki, align 8, !tbaa !147
  %i.akk = getelementptr inbounds nuw [8 x i8], ptr %i.akj, i64 %indvars.iv1060
  %i.akl = load double, ptr %i.akk, align 8, !tbaa !77
  %i.akm = tail call double @llvm.fmuladd.f64(double %i.akh, double %i.akl, double %.0535919.epil) ; 2 uses
  %indvars.iv.next1039.epil = add nuw nsw i64 %indvars.iv1038.epil, 1
  %epil.iter1196.next = add i64 %epil.iter1196, 1 ; 2 uses
  %epil.iter1196.cmp.not = icmp eq i64 %epil.iter1196.next, %xtraiter1206
  br i1 %epil.iter1196.cmp.not, label %._crit_edge922, label %bb.ch, !llvm.loop !368

._crit_edge922:                                   ; preds = %bb.ch, %._crit_edge922.unr-lcssa
  %.lcssa = phi double [ %i.alp, %._crit_edge922.unr-lcssa ], [ %i.akm, %bb.ch ]
  %i.akn = getelementptr inbounds nuw [8 x i8], ptr %i.akf, i64 %indvars.iv1060
  store double %.lcssa, ptr %i.akn, align 8, !tbaa !77
  ...
  br i1 %exitcond1049.not, label %.preheader.us.epil.a, label %.preheader, !llvm.loop !366

.preheader.new:                                   ; preds = %.preheader, %.preheader.new
  %indvars.iv1038 = phi i64 [ %indvars.iv.next1039.3, %.preheader.new ], [ 0, %.preheader ] ; 6 uses
  %.0535919 = phi double [ %i.alp, %.preheader.new ], [ 0.000000e+00, %.preheader ]
  %niter1201 = phi i64 [ %niter1201.next.3, %.preheader.new ], [ 0, %.preheader ]
  %i.ako = getelementptr inbounds nuw [8 x i8], ptr %i.akf, i64 %indvars.iv1038
  %i.akp = load double, ptr %i.ako, align 8, !tbaa !77
  %i.akq = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %indvars.iv1038
  %i.akr = load ptr, ptr %i.akq, align 8, !tbaa !147
  %i.aks = getelementptr inbounds nuw [8 x i8], ptr %i.akr, i64 %indvars.iv1060
  %i.akt = load double, ptr %i.aks, align 8, !tbaa !77
  %i.aku = tail call double @llvm.fmuladd.f64(double %i.akp, double %i.akt, double %.0535919)
  %indvars.iv.next1039 = or disjoint i64 %indvars.iv1038, 1 ; 2 uses
  %i.akv = getelementptr inbounds nuw [8 x i8], ptr %i.akf, i64 %indvars.iv.next1039
  %i.akw = load double, ptr %i.akv, align 8, !tbaa !77
  %i.akx = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %indvars.iv.next1039
  %i.aky = load ptr, ptr %i.akx, align 8, !tbaa !147
  %i.akz = getelementptr inbounds nuw [8 x i8], ptr %i.aky, i64 %indvars.iv1060
  %i.ala = load double, ptr %i.akz, align 8, !tbaa !77
  %i.alb = tail call double @llvm.fmuladd.f64(double %i.akw, double %i.ala, double %i.aku)
  %indvars.iv.next1039.1 = or disjoint i64 %indvars.iv1038, 2 ; 2 uses
  %i.alc = getelementptr inbounds nuw [8 x i8], ptr %i.akf, i64 %indvars.iv.next1039.1
  %i.ald = load double, ptr %i.alc, align 8, !tbaa !77
  %i.ale = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %indvars.iv.next1039.1
  %i.alf = load ptr, ptr %i.ale, align 8, !tbaa !147
  %i.alg = getelementptr inbounds nuw [8 x i8], ptr %i.alf, i64 %indvars.iv1060
  %i.alh = load double, ptr %i.alg, align 8, !tbaa !77
  %i.ali = tail call double @llvm.fmuladd.f64(double %i.ald, double %i.alh, double %i.alb)
  %indvars.iv.next1039.2 = or disjoint i64 %indvars.iv1038, 3 ; 2 uses
  %i.alj = getelementptr inbounds nuw [8 x i8], ptr %i.akf, i64 %indvars.iv.next1039.2
  %i.alk = load double, ptr %i.alj, align 8, !tbaa !77
  %i.all = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %indvars.iv.next1039.2
  %i.alm = load ptr, ptr %i.all, align 8, !tbaa !147
  %i.aln = getelementptr inbounds nuw [8 x i8], ptr %i.alm, i64 %indvars.iv1060
  %i.alo = load double, ptr %i.aln, align 8, !tbaa !77
  %i.alp = tail call double @llvm.fmuladd.f64(double %i.alk, double %i.alo, double %i.ali) ; 3 uses
  %indvars.iv.next1039.3 = add nuw nsw i64 %indvars.iv1038, 4 ; 2 uses
  %niter1201.next.3 = add i64 %niter1201, 4       ; 2 uses
  %niter1201.ncmp.3 = icmp eq i64 %niter1201.next.3, %unroll_iter1211
  br i1 %niter1201.ncmp.3, label %._crit_edge922.unr-lcssa, label %.preheader.new, !llvm.loop !369

.loopexit.loopexit.unr-lcssa:                     ; preds = %.preheader.us
  %lcmp.mod1215.not = icmp eq i64 %xtraiter1213, 0
  br i1 %lcmp.mod1215.not, label %.loopexit, label %.preheader.us.epil.preheader

.preheader.us.epil.preheader:                     ; preds = %.loopexit.loopexit.unr-lcssa, %.preheader.us.preheader
  %indvars.iv1052.epil.init = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next1051.3, %.loopexit.loopexit.unr-lcssa ]
  %lcmp.mod1216 = icmp ne i64 %xtraiter1213, 0
...
.preheader.us.epil:                               ; preds = %.preheader.us.epil, %.preheader.us.epil.preheader
  %indvars.iv1052.epil = phi i64 [ %indvars.iv1052.epil.init, %.preheader.us.epil.preheader ], [ %indvars.iv.next1053.epil, %.preheader.us.epil ] ; 2 uses
  %epil.iter1214 = phi i64 [ 0, %.preheader.us.epil.preheader ], [ %epil.iter1214.next, %.preheader.us.epil ]
  %11 = getelementptr inbounds nuw [8 x i8], ptr %i.vc, i64 %indvars.iv1052.epil
  %12 = load ptr, ptr %11, align 8, !tbaa !147
  %13 = getelementptr inbounds nuw [8 x i8], ptr %12, i64 %indvars.iv1060
  store double 0.000000e+00, ptr %13, align 8, !tbaa !77
  %indvars.iv.next1053.epil = add nuw nsw i64 %indvars.iv1052.epil, 1
  %epil.iter1214.next = add i64 %epil.iter1214, 1 ; 2 uses
  %epil.iter1214.cmp.not = icmp eq i64 %epil.iter1214.next, %xtraiter1213
  br i1 %epil.iter1214.cmp.not, label %.loopexit, label %.preheader.us.epil, !llvm.loop !370

.loopexit:                                        ; preds = %.preheader.us.epil.a, %.loopexit.loopexit.unr-lcssa, %.preheader.us.epil, %._crit_edge879
  ret void
