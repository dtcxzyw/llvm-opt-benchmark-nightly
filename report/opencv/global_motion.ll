...
bb.e:                                             ; preds = %.lr.ph80, %bb.e
  ...
  %i.ch = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv84 ; 2 uses
  %.sroa_idx65 = getelementptr inbounds nuw i8, ptr %i.ch, i64 4
  %i.ci = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv84
  %6 = load float, ptr %i.ch, align 4
  %7 = load float, ptr %.sroa_idx65, align 4
  ...
  %i.co = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.cs = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cr, <2 x float> %10, <2 x float> %i.cp) ; 2 uses
