...
.lr.ph.epil.preheader:                            ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.preheader
  ...
  %6 = insertelement <2 x float> poison, float %i.g, i64 0
  %i.i = insertelement <2 x float> %6, float %i.e, i64 1
  %7 = fmul <2 x float> %i.h, %i.i
  ...
  %i.l = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.k, <2 x float> %i.h, <2 x float> %8)
  %i.m = fadd <2 x float> %.epil.init, %i.l
  br label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph.epil.preheader, %._crit_edge.loopexit.unr-lcssa, %bb.a
  %i.n = phi <2 x float> [ zeroinitializer, %bb.a ], [ %i.as, %._crit_edge.loopexit.unr-lcssa ], [ %i.m, %.lr.ph.epil.preheader ] ; 2 uses
  %i.o = extractelement <2 x float> %i.n, i64 1   ; 3 uses
  %9 = fmul float %i.o, %i.o
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  %10 = insertelement <2 x float> poison, float %i.ab, i64 0
  %i.ad = insertelement <2 x float> %10, float %i.z, i64 1
  %11 = fmul <2 x float> %i.ac, %i.ad
  ...
  %i.ag = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.af, <2 x float> %i.ac, <2 x float> %12)
  ...
  %13 = insertelement <2 x float> poison, float %i.am, i64 0
  %i.ao = insertelement <2 x float> %13, float %i.ak, i64 1
  %14 = fmul <2 x float> %i.an, %i.ao
  ...
  %i.ar = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aq, <2 x float> %i.an, <2 x float> %15)
...
bb.e:                                             ; preds = %.lr.ph80, %bb.e
  ...
  %foldExtExtBinop.a = fadd <2 x float> %i.co, %shift
  %i.cp = extractelement <2 x float> %foldExtExtBinop.a, i64 0
