...
bb.bi:                                            ; preds = %bb.bb
  ...
  %11 = fmul double %.0163, %i.jv
  %i.kg = extractelement <2 x double> %i.kf, i64 0 ; 4 uses
  %i.kh = fmul double %i.kg, 2.000000e+00
  %12 = shufflevector <2 x double> %i.kf, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  ...
  %i.kp = insertelement <2 x double> %12, double %11, i64 0
  %i.kq = insertelement <2 x double> %i.kd, double 4.000000e+00, i64 1
  ...
  %14 = extractelement <2 x double> %i.kf, i64 1  ; 2 uses
  %i.la = fmul double %14, 2.000000e+00           ; 2 uses
  ...
  %i.lh = call double @llvm.fmuladd.f64(double %13, double %i.lg, double %i.lf)
