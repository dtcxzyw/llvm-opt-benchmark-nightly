...
bb.bi:                                            ; preds = %bb.bb
  ...
  %i.kh = extractelement <2 x double> %i.kf, i64 0 ; 4 uses
...
bb.bj:                                            ; preds = %bb.bi
  ...
  %11 = insertelement <2 x double> poison, double %i.lw, i64 0
  %12 = shufflevector <2 x double> %11, <2 x double> %i.kf, <2 x i32> <i32 0, i32 2>
  %13 = fmul <2 x double> %12, <double -2.000000e+00, double f0xBFD5555555555555> ; 4 uses
  %14 = fadd double %i.lx, f0x4000C152382D7365
  %15 = call double @cos(double noundef %14) #25
  %i.lz = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ma = insertelement <2 x double> poison, double %i.ly, i64 0
  %i.mb = insertelement <2 x double> %i.ma, double %15, i64 1
  %16 = shufflevector <2 x double> %13, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.mc = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.lz, <2 x double> %i.mb, <2 x double> %16)
  ...
  %i.mf = call double @llvm.fmuladd.f64(double %17, double %i.me, double %18)
  br label %bb.bn
