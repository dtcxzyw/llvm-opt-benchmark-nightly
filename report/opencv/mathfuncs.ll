...
.split.us227.split.preheader:                     ; preds = %.split.us227
  ...
  %i.cz = and i16 %i.cy, 127
  %i.da = or disjoint i16 %i.cz, 1024
  %13 = or disjoint i32 %i.f, 1024
...
.split.us227.split.us.preheader:                  ; preds = %.split.us227
  ...
  %i.dc = and i16 %i.db, 127
  %i.dd = or disjoint i16 %i.dc, 1024
  %14 = or disjoint i32 %i.f, 1024
...
.lr.ph223.us.us.us:                               ; preds = %.preheader209.us.us.us
  ...
  %i.et = sub nuw nsw i32 %14, %i.es
  %i.eu = call i32 @llvm.smin.i32(i32 %.fr248, i32 %i.dk)
  %i.ev = call i32 @llvm.smin.i32(i32 %i.eu, i32 %i.et) ; 2 uses
...
.lr.ph218.us:                                     ; preds = %.preheader212.us
  ...
  %i.jt = sub nuw nsw i32 %13, %i.js
  %i.ju = call i32 @llvm.smin.i32(i32 %.fr248, i32 %i.iq)
  %i.jv = call i32 @llvm.smin.i32(i32 %i.ju, i32 %i.jt) ; 2 uses
