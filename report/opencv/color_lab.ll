...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.083 = phi float [ %i.ak, %bb.c ], [ %i.al, %bb.d ] ; 3 uses
  ...
  %5 = insertelement <2 x float> <float poison, float -0.000000e+00>, float %i.ab, i64 0
  %6 = insertelement <2 x float> <float poison, float -0.000000e+00>, float %i.au, i64 0
  %7 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %5, <2 x float> <float 1.560000e+02, float 0.000000e+00>, <2 x float> %6)
  %8 = insertelement <2 x float> <float poison, float 0.000000e+00>, float %spec.store.select1, i64 0
  %9 = insertelement <2 x float> <float -5.000000e+00, float poison>, float %spec.store.select1, i64 1
  %10 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %7, <2 x float> %8, <2 x float> %9)
  %i.az = insertelement <2 x float> %i.aw, float %i.at, i64 1
  %11 = fmul <2 x float> %10, %i.az               ; 4 uses
  %12 = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %13 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %12, <2 x float> %i.w, <2 x float> %i.ax)
  %i.ba = shufflevector <2 x float> %11, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bb = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ba, <2 x float> %i.y, <2 x float> %13) ; 3 uses
  %14 = extractelement <2 x float> %11, i64 1
  %i.bc = call float @llvm.fmuladd.f32(float %14, float %i.c, float %i.ay)
  %15 = extractelement <2 x float> %11, i64 0
  %i.bd = call float @llvm.fmuladd.f32(float %15, float %i.g, float %i.bc) ; 3 uses
