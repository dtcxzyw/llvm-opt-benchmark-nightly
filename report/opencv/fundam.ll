...
.lr.ph:                                           ; preds = %.lr.ph.preheader90, %.lr.ph
  ...
  %i.br = getelementptr inbounds nuw [8 x i8], ptr %i.o, i64 %indvars.iv
  %9 = getelementptr inbounds nuw [8 x i8], ptr %i.q, i64 %indvars.iv
  %10 = load <2 x float>, ptr %i.br, align 4, !tbaa !68 ; 4 uses
  %11 = extractelement <2 x float> %10, i64 1
  %12 = fmul float %11, %i.ai
  %13 = extractelement <2 x float> %10, i64 0
  %i.bs = call float @llvm.fmuladd.f32(float %i.af, float %13, float %12)
  ...
  %i.bv = fmul <2 x float> %14, %i.aa
  %i.bw = shufflevector <2 x float> %10, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.ca = load <2 x float>, ptr %9, align 4, !tbaa !68
