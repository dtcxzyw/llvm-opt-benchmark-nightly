...
bb.a:
  ...
  %i.h = extractelement <3 x double> %i.c, i64 2  ; 3 uses
...
_ZN2cv4MatxIdLi4ELi4EEC2ESt16initializer_listIdE.exit: ; preds = %.thread, %bb.b
  ...
  %i.am = shufflevector <3 x double> %i.c, <3 x double> poison, <2 x i32> <i32 2, i32 0> ; 2 uses
  ...
  %i.ap = fmul <2 x double> %i.am, %i.ao          ; 3 uses
  ...
  %2 = fmul double %i.d, %i.u
  %3 = extractelement <2 x double> %i.ap, i64 1   ; 2 uses
  %4 = fmul double %i.h, %3
  %i.aw = fmul double %i.d, %3
  ...
  %5 = insertelement <4 x double> %i.ay, double %4, i64 2
  %6 = insertelement <4 x double> %5, double %2, i64 3
  %i.az = fmul <4 x double> %i.aj, %6
