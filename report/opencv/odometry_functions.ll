...
bb.a:
  ...
  %19 = alloca %"class.cv::Matx.23", align 16     ; 13 uses
...
bb.ad:                                            ; preds = %bb.k, %bb.v
  ...
  %27 = load float, ptr %i.bo, align 4, !tbaa !23, !noalias !187
  ...
  %i.bz = fpext <2 x float> %i.by to <2 x double> ; 13 uses
  %28 = load <1 x float>, ptr %26, align 4, !tbaa !23, !noalias !187
  %i.ca = load float, ptr %i.bp, align 4, !tbaa !23, !noalias !187 ; 2 uses
  ...
  %i.cd = fpext <2 x float> %i.cc to <2 x double> ; 12 uses
  %29 = insertelement <2 x float> poison, float %27, i64 0
  %30 = insertelement <2 x float> %29, float %i.ca, i64 1
  %i.ce = fpext <2 x float> %30 to <2 x double>   ; 10 uses
  %31 = shufflevector <1 x float> %28, <1 x float> poison, <2 x i32> <i32 poison, i32 0>
  %32 = insertelement <2 x float> %31, float %i.ca, i64 0
  %33 = fpext <2 x float> %32 to <2 x double>     ; 6 uses
  %34 = extractelement <2 x double> %i.cd, i64 1
  %35 = fneg double %34                           ; 2 uses
  %i.cf = insertelement <2 x double> poison, double %35, i64 0
  %i.cg = shufflevector <2 x double> %i.cf, <2 x double> poison, <2 x i32> zeroinitializer
  %36 = shufflevector <2 x double> %33, <2 x double> %i.ce, <2 x i32> <i32 1, i32 2>
  %37 = fmul <2 x double> %i.cg, %36
  %38 = shufflevector <2 x double> %i.bz, <2 x double> %i.bw, <2 x i32> <i32 1, i32 3>
  %39 = shufflevector <2 x double> %i.ce, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %i.ch = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %38, <2 x double> %39, <2 x double> %37) ; 2 uses
  %40 = shufflevector <2 x double> %i.ch, <2 x double> %i.bz, <2 x i32> <i32 1, i32 3>
  %i.ci = fneg <2 x double> %40                   ; 2 uses
  %i.cj = shufflevector <2 x double> %i.bz, <2 x double> %i.ce, <2 x i32> <i32 0, i32 2>
  %i.ck = fmul <2 x double> %i.cj, %i.ci
  %41 = shufflevector <2 x double> %i.ch, <2 x double> %33, <2 x i32> <i32 0, i32 3>
  %i.cl = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bw, <2 x double> %41, <2 x double> %i.ck) ; 2 uses
...
bb.ae:                                            ; preds = %bb.ad
  %i.cr = fdiv double 1.000000e+00, %i.cp         ; 2 uses
  %42 = fneg <2 x double> %33                     ; 3 uses
  %i.cs = extractelement <2 x double> %i.bz, i64 1
  %43 = extractelement <2 x double> %i.bw, i64 1
  %i.ct = shufflevector <2 x double> %i.bw, <2 x double> %i.cd, <2 x i32> <i32 1, i32 3>
  %i.cu = fmul <2 x double> %i.ct, %42
  %44 = shufflevector <2 x double> %i.cd, <2 x double> %i.bz, <2 x i32> <i32 1, i32 3>
  %i.cv = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %44, <2 x double> %i.ce, <2 x double> %i.cu)
  %i.cw = insertelement <2 x double> poison, double %i.cr, i64 0
  %i.cx = shufflevector <2 x double> %i.cw, <2 x double> poison, <2 x i32> zeroinitializer ; 4 uses
  %i.cy = fmul <2 x double> %i.cv, %i.cx
  %45 = extractelement <2 x double> %i.ce, i64 0
  %46 = fneg double %45                           ; 2 uses
  %47 = fneg double %43
  %48 = extractelement <2 x double> %i.bw, i64 0
  %i.cz = extractelement <2 x double> %i.bz, i64 0
  %49 = fmul double %i.cz, %47
  %i.da = call double @llvm.fmuladd.f64(double %48, double %i.cs, double %49)
  %50 = insertelement <2 x double> %42, double %46, i64 1
  %51 = fmul <2 x double> %50, %i.bz
  %52 = shufflevector <2 x double> %i.cd, <2 x double> %i.bw, <2 x i32> <i32 0, i32 3>
  %53 = shufflevector <2 x double> %33, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %54 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %52, <2 x double> %53, <2 x double> %51)
  %55 = shufflevector <2 x double> %i.cd, <2 x double> poison, <2 x i32> zeroinitializer
  %56 = shufflevector <2 x double> %i.ci, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  ...
  %59 = shufflevector <2 x double> %i.cd, <2 x double> %i.ce, <2 x i32> <i32 1, i32 3>
  %60 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.db, <2 x double> %59, <2 x double> %58)
  %61 = shufflevector <2 x double> %i.bw, <2 x double> poison, <2 x i32> zeroinitializer
  %62 = insertelement <2 x double> %42, double %35, i64 0
  %63 = fmul <2 x double> %61, %62
  %64 = shufflevector <2 x double> %i.cd, <2 x double> %i.bz, <2 x i32> <i32 0, i32 2>
  %65 = shufflevector <2 x double> %i.bw, <2 x double> %i.ce, <2 x i32> <i32 1, i32 2>
  %66 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %64, <2 x double> %65, <2 x double> %63)
  %67 = fmul <2 x double> %54, %i.cx
  %68 = fmul <2 x double> %60, %i.cx
  %69 = fmul <2 x double> %66, %i.cx
  %70 = fmul double %i.da, %i.cr
  br label %bb.af

bb.af:                                            ; preds = %bb.ae, %bb.ad
  %.sroa.11344.0 = phi double [ %70, %bb.ae ], [ 0.000000e+00, %bb.ad ] ; 2 uses
  %71 = phi <2 x double> [ %i.cy, %bb.ae ], [ zeroinitializer, %bb.ad ] ; 5 uses
  %72 = phi <2 x double> [ %68, %bb.ae ], [ zeroinitializer, %bb.ad ] ; 3 uses
  %73 = phi <2 x double> [ %69, %bb.ae ], [ zeroinitializer, %bb.ad ] ; 3 uses
  %i.dc = phi <2 x double> [ %67, %bb.ae ], [ zeroinitializer, %bb.ad ] ; 4 uses
  ...
  %i.dy = extractelement <2 x double> %i.ce, i64 0 ; 2 uses
  %i.dz = call double @llvm.fmuladd.f64(double %i.dy, double %i.di, double 0.000000e+00)
  %i.ea = extractelement <2 x double> %33, i64 1  ; 2 uses
  %i.eb = call double @llvm.fmuladd.f64(double %i.ea, double %i.dl, double %i.dz)
  %74 = extractelement <2 x double> %i.ce, i64 1  ; 2 uses
  %i.ec = call double @llvm.fmuladd.f64(double %74, double %i.do, double %i.eb) ; 2 uses
...
bb.ah:                                            ; preds = %bb.af, %.noexc280
  ...
  %i.fe = getelementptr inbounds nuw i8, ptr %19, i64 16
  %i.ff = load double, ptr %i.fe, align 16, !tbaa !71, !noalias !189 ; 2 uses
  %i.fg = getelementptr inbounds nuw i8, ptr %19, i64 48
  %i.fh = load double, ptr %i.fg, align 16, !tbaa !71, !noalias !189 ; 2 uses
  %i.fi = getelementptr inbounds nuw i8, ptr %19, i64 80
  %i.fj = load double, ptr %i.fi, align 16, !tbaa !71, !noalias !189 ; 2 uses
  %i.fk = call double @llvm.fmuladd.f64(double %i.dy, double %i.ff, double 0.000000e+00)
  %i.fl = call double @llvm.fmuladd.f64(double %i.ea, double %i.fh, double %i.fk)
  %i.fm = call double @llvm.fmuladd.f64(double %74, double %i.fj, double %i.fl) ; 3 uses
  %i.fn = insertelement <2 x double> poison, double %i.ff, i64 0
  ...
  %i.fq = insertelement <2 x double> poison, double %i.fh, i64 0
  ...
  %i.fv = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cd, <2 x double> %i.fu, <2 x double> %i.fs) ; 4 uses
  %75 = extractelement <2 x double> %i.fv, i64 0
  %i.fw = shufflevector <2 x double> %i.dc, <2 x double> poison, <2 x i32> zeroinitializer
  %76 = shufflevector <2 x double> %72, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.fx = shufflevector <2 x double> %72, <2 x double> poison, <2 x i32> zeroinitializer
  %77 = shufflevector <2 x double> %73, <2 x double> poison, <2 x i32> zeroinitializer
  %78 = shufflevector <2 x double> %71, <2 x double> <double poison, double 0.000000e+00>, <2 x i32> <i32 1, i32 3>
  %79 = extractelement <2 x double> %71, i64 0
  %80 = shufflevector <2 x double> %73, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.fy = insertelement <2 x double> poison, double %.sroa.11344.0, i64 0
  %i.fz = shufflevector <2 x double> %i.fy, <2 x double> poison, <2 x i32> zeroinitializer
  %81 = shufflevector <2 x double> %i.fv, <2 x double> %71, <2 x i32> <i32 1, i32 3>
  %82 = load <2 x double>, ptr %19, align 16, !tbaa !71, !noalias !189 ; 3 uses
  %83 = load <2 x double>, ptr %i.dj, align 16, !tbaa !71, !noalias !189 ; 3 uses
  %84 = load <2 x double>, ptr %i.dm, align 16, !tbaa !71, !noalias !189 ; 3 uses
  %85 = shufflevector <2 x double> %82, <2 x double> poison, <2 x i32> zeroinitializer
  %86 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bw, <2 x double> %85, <2 x double> zeroinitializer)
  %87 = shufflevector <2 x double> %83, <2 x double> poison, <2 x i32> zeroinitializer
  %88 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bz, <2 x double> %87, <2 x double> %86)
  %i.ga = shufflevector <2 x double> %84, <2 x double> poison, <2 x i32> zeroinitializer
  %89 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cd, <2 x double> %i.ga, <2 x double> %88) ; 4 uses
  %90 = shufflevector <2 x double> %82, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %91 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bw, <2 x double> %90, <2 x double> zeroinitializer)
  %92 = shufflevector <2 x double> %83, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.gb = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bz, <2 x double> %92, <2 x double> %91)
  %i.gc = shufflevector <2 x double> %84, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.gd = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cd, <2 x double> %i.gc, <2 x double> %i.gb) ; 4 uses
  %i.ge = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %89, <2 x double> %i.fw, <2 x double> zeroinitializer)
  %i.gf = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gd, <2 x double> %76, <2 x double> %i.ge)
  %i.gg = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %89, <2 x double> %i.fx, <2 x double> zeroinitializer)
  %i.gh = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gd, <2 x double> %77, <2 x double> %i.gg)
  %i.gi = insertelement <2 x double> %89, double -0.000000e+00, i64 1
  %i.gj = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gi, <2 x double> %78, <2 x double> zeroinitializer)
  %i.gk = shufflevector <2 x double> %i.gd, <2 x double> %89, <2 x i32> <i32 0, i32 3>
  %i.gl = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gk, <2 x double> %71, <2 x double> %i.gj) ; 2 uses
  %93 = extractelement <2 x double> %i.gl, i64 0
  %i.gm = extractelement <2 x double> %i.dc, i64 1 ; 2 uses
  %i.gn = call double @llvm.fmuladd.f64(double %75, double %i.gm, double %93) ; 2 uses
  %i.go = extractelement <2 x double> %i.gd, i64 1
  %i.gp = extractelement <2 x double> %i.gl, i64 1
  %i.gq = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.fv, <2 x double> %80, <2 x double> %i.gf) ; 3 uses
  %i.gr = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.fv, <2 x double> %i.fz, <2 x double> %i.gh) ; 3 uses
  %94 = shufflevector <2 x double> %i.ce, <2 x double> poison, <2 x i32> zeroinitializer
  %95 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %94, <2 x double> %82, <2 x double> zeroinitializer)
  %96 = shufflevector <2 x double> %33, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %97 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %96, <2 x double> %83, <2 x double> %95)
  %i.gs = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %39, <2 x double> %84, <2 x double> %97) ; 4 uses
  %i.gt = call double @llvm.fmuladd.f64(double %i.go, double %79, double %i.gp)
  %98 = shufflevector <2 x double> %i.dc, <2 x double> %i.gs, <2 x i32> <i32 1, i32 2>
  %i.gu = insertelement <2 x double> <double poison, double 0.000000e+00>, double %i.gt, i64 0
  %i.gv = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %81, <2 x double> %98, <2 x double> %i.gu) ; 3 uses
  %99 = shufflevector <2 x double> %i.dc, <2 x double> %71, <2 x i32> <i32 0, i32 2>
  %i.gw = insertelement <2 x double> %i.gv, double 0.000000e+00, i64 0
  %i.gx = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gs, <2 x double> %99, <2 x double> %i.gw) ; 2 uses
  %i.gy = extractelement <2 x double> %i.gx, i64 1
  %i.gz = call double @llvm.fmuladd.f64(double %i.fm, double %i.gm, double %i.gy) ; 2 uses
  %i.ha = shufflevector <2 x double> %i.gx, <2 x double> <double 0.000000e+00, double poison>, <2 x i32> <i32 2, i32 0>
  %i.hb = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.gs, <2 x double> %72, <2 x double> %i.ha)
  ...
  %i.he = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hd, <2 x double> %73, <2 x double> %i.hb) ; 3 uses
  %i.hf = extractelement <2 x double> %i.he, i64 0
  %i.hg = call double @llvm.fmuladd.f64(double %i.fm, double %.sroa.11344.0, double %i.hf) ; 2 uses
