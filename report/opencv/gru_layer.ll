Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/opencv/original/gru_layer?download=true
...
_ZNK2cv8MatShapeixEm.exit:                        ; preds = %bb.j
  ...
  %i.aw = load i32, ptr %i.as, align 4, !tbaa !82 ; 2 uses
  %i.ax = load i32, ptr %i.at, align 4, !tbaa !82
...
_ZNK2cv8MatShapeixEm.exit132:                     ; preds = %_ZNK2cv8MatShapeixEm.exit
  ...
  %i.ba = load i32, ptr %i.az, align 4, !tbaa !82 ; 2 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ac, i64 120
  %i.bc = load i32, ptr %i.bb, align 4, !tbaa !82
...
bb.t:                                             ; preds = %bb.q
  %i.bh = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.bi = load ptr, ptr %19, align 8, !tbaa !45   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i139: ; preds = %bb.t
  %i.bl = load i64, ptr %i.bj, align 8, !tbaa !44
  %i.bm = add i64 %i.bl, 1
...
_ZN2cv3dnn12GRULayerImpl17hasRuntimeWeightsINS_8MatShapeEEEbRKSt6vectorIT_SaIS5_EE.exit.thread: ; preds = %bb.g, %bb.h, %_ZN2cv3dnn12GRULayerImpl17hasRuntimeWeightsINS_8MatShapeEEEbRKSt6vectorIT_SaIS5_EE.exit
  ...
  %i.br = load ptr, ptr %i.bo, align 8, !tbaa !58 ; 5 uses
...
bb.z:                                             ; preds = %bb.w
  %i.by = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.bz = load ptr, ptr %21, align 8, !tbaa !45   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i147: ; preds = %bb.z
  %i.cc = load i64, ptr %i.ca, align 8, !tbaa !44
  %i.cd = add i64 %i.cc, 1
...
bb.aa:                                            ; preds = %_ZN2cv3dnn12GRULayerImpl17hasRuntimeWeightsINS_8MatShapeEEEbRKSt6vectorIT_SaIS5_EE.exit.thread
  ...
  %i.cf = load i32, ptr %i.ce, align 4, !tbaa !81
...
bb.ad:                                            ; preds = %bb.ab
  %i.ch = landingpad { ptr, i32 }
          cleanup
  %i.ci = load ptr, ptr %13, align 8, !tbaa !45   ; 2 uses
...
_ZNK2cv8MatShapeixEm.exit155:                     ; preds = %bb.aa
  ...
  %i.co = load i32, ptr %i.cn, align 4, !tbaa !81
...
bb.ag:                                            ; preds = %bb.ae
  %i.cq = landingpad { ptr, i32 }
          cleanup
  %i.cr = load ptr, ptr %11, align 8, !tbaa !45   ; 2 uses
...
_ZNK2cv8MatShapeixEm.exit161:                     ; preds = %_ZNK2cv8MatShapeixEm.exit155
  ...
  %i.cx = load i32, ptr %i.cw, align 4, !tbaa !82
  %i.cy = getelementptr inbounds nuw i8, ptr %i.br, i64 296
  %i.cz = load i32, ptr %i.cy, align 4, !tbaa !82
...
bb.ah:                                            ; preds = %_ZNK2cv8MatShapeixEm.exit161, %bb.u
  ...
  %.074 = phi i32 [ %i.av, %bb.u ], [ %i.cx, %_ZNK2cv8MatShapeixEm.exit161 ] ; 7 uses
  %.073 = phi i32 [ %i.ar, %bb.u ], [ %i.cz, %_ZNK2cv8MatShapeixEm.exit161 ]
...
_ZNK2cv8MatShapeixEm.exit.i:                      ; preds = %_ZNK2cv8MatShapeixEm.exit.i, %_ZNK2cv8MatShapeixEm.exit.i.preheader.new
  ...
  %i.ef = load i32, ptr %i.ee, align 4, !tbaa !82
  ...
  %i.ek = load i32, ptr %i.ej, align 4, !tbaa !82
  ...
  %i.ep = load i32, ptr %i.eo, align 4, !tbaa !82
  ...
  %i.eu = load i32, ptr %i.et, align 4, !tbaa !82
  %i.ev = sext i32 %i.eu to i64
  %i.ew = mul i64 %i.er, %i.ev                    ; 3 uses
  %indvars.iv.next.i.7 = add nuw nsw i64 %indvars.iv.i, 8 ; 2 uses
  %niter.next.7 = add i64 %niter, 8               ; 2 uses
  %niter.ncmp.7 = icmp eq i64 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %_ZN2cv3dnn14dnn5_v20260605L5totalERKNS_8MatShapeEii.exit.loopexit.unr-lcssa, label %_ZNK2cv8MatShapeixEm.exit.i, !llvm.loop !3
...
bb.ak:                                            ; preds = %bb.ai
  %i.ex = landingpad { ptr, i32 }
          cleanup
  %i.ey = load ptr, ptr %9, align 8, !tbaa !45    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i: ; preds = %bb.ak
  %i.fb = load i64, ptr %i.ez, align 8, !tbaa !44
  %i.fc = add i64 %i.fb, 1
...
_ZNK2cv8MatShapeixEm.exit.i.epil:                 ; preds = %_ZNK2cv8MatShapeixEm.exit.i.epil, %_ZNK2cv8MatShapeixEm.exit.i.epil.preheader
  ...
  %i.fe = load i32, ptr %i.fd, align 4, !tbaa !82
  %i.ff = sext i32 %i.fe to i64
  %i.fg = mul i64 %.02128.i.epil, %i.ff           ; 2 uses
  %indvars.iv.next.i.epil = add nuw nsw i64 %indvars.iv.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %_ZN2cv3dnn14dnn5_v20260605L5totalERKNS_8MatShapeEii.exit, label %_ZNK2cv8MatShapeixEm.exit.i.epil, !llvm.loop !216
...
bb.ap:                                            ; preds = %bb.am
  %i.fk = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.fl = load ptr, ptr %24, align 8, !tbaa !45   ; 2 uses
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %i.fw = load i32, ptr %i.h, align 4, !tbaa !81
...
bb.au:                                            ; preds = %bb.as
  %i.fy = landingpad { ptr, i32 }
          cleanup
  %i.fz = load ptr, ptr %7, align 8, !tbaa !45    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i180: ; preds = %bb.au
  %i.gc = load i64, ptr %i.ga, align 8, !tbaa !44
  %i.gd = add i64 %i.gc, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i181: ; preds = %bb.au, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i180
