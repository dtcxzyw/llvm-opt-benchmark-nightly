...
.preheader427:                                    ; preds = %bb.j, %bb.k
  ...
  %24 = fmul double %i.ej, %i.ej
  %25 = fadd double %i.ej, 0.000000e+00
  %i.gr = insertelement <2 x double> poison, double %24, i64 0
  %i.gs = insertelement <2 x double> %i.gr, double %25, i64 1
...
.preheader429:                                    ; preds = %bb.m, %bb.n
  ...
  %i.iz = fmul <2 x double> %i.iy, %i.iw          ; 10 uses
  %26 = extractelement <2 x double> %i.iz, i64 0
  ...
  %28 = fsub double 0.000000e+00, %i.ky
  %i.la = insertelement <2 x double> poison, double %27, i64 0
  %i.lb = insertelement <2 x double> %i.la, double %28, i64 1
  ...
  %i.le = fmul <2 x double> %i.iz, %i.ld          ; 5 uses
  ...
  %29 = insertelement <2 x double> %i.jg, double %i.jc, i64 1
  %30 = shufflevector <2 x double> %i.lp, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %31 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %29, <2 x double> %i.lq, <2 x double> %30)
  %32 = insertelement <2 x double> poison, double %i.iq, i64 0
  %33 = insertelement <2 x double> %32, double %i.ir, i64 1
  %34 = fadd <2 x double> %33, %31                ; 2 uses
  %i.ls = extractelement <2 x double> %34, i64 0
  store double %i.ls, ptr %i.aj, align 8, !tbaa !61
  %35 = extractelement <2 x double> %34, i64 1
  store double %35, ptr %i.ar, align 8, !tbaa !61
  %36 = load <2 x double>, ptr %i.at, align 8, !tbaa !61
  %37 = fsub double 0.000000e+00, %i.kx
  ...
  %i.lw = shufflevector <2 x double> %i.le, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 3 uses
  %i.lx = insertelement <2 x double> %i.jq, double %i.jc, i64 1
  %i.ly = fmul <2 x double> %i.lw, %i.lx
  %i.lz = shufflevector <2 x double> %i.le, <2 x double> poison, <2 x i32> zeroinitializer ; 3 uses
  ...
  %39 = fmul double %i.ie, %i.ie
  %i.mi = fmul double %26, %i.jd                  ; 4 uses
  ...
  %i.mn = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.jw, <2 x double> %i.mm, <2 x double> %i.lp)
  %i.mo = fadd <2 x double> %i.ln, %i.mn
  store <2 x double> %i.mo, ptr %i.an, align 8, !tbaa !61
  %i.mp = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.kq, <2 x double> %i.mj, <2 x double> %i.lh)
  %i.mq = fadd <2 x double> %i.lr, %i.mp
  store <2 x double> %i.mq, ptr %i.aq, align 8, !tbaa !61
  ...
  %i.ne = insertelement <4 x double> <double poison, double -0.000000e+00, double poison, double poison>, double %39, i64 0
  ...
  %40 = shufflevector <2 x double> %i.jg, <2 x double> %i.iz, <2 x i32> <i32 0, i32 3>
  %foldExtExtBinop1275.a = fmul <2 x double> %40, %i.lw
  %41 = shufflevector <2 x double> %i.iz, <2 x double> <double 0.000000e+00, double poison>, <2 x i32> <i32 2, i32 0>
  %42 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.lz, <2 x double> %41, <2 x double> %foldExtExtBinop1275.a) ; 2 uses
  %43 = shufflevector <2 x double> %38, <2 x double> %42, <2 x i32> <i32 0, i32 2>
  %44 = fadd <2 x double> %36, %43
  store <2 x double> %44, ptr %i.at, align 8, !tbaa !61
  %i.nm = load double, ptr %i.bc, align 8, !tbaa !61
  %45 = extractelement <2 x double> %42, i64 1
  %i.nn = fadd double %i.nm, %45
...
.preheader434:                                    ; preds = %bb.x, %bb.y
  ...
  %i.zy = load float, ptr %i.zo, align 4, !tbaa !67 ; 2 uses
  %i.zz = load float, ptr %i.zp, align 4, !tbaa !67 ; 2 uses
  %i.aaa = fpext float %i.zy to double            ; 6 uses
  %i.aab = fpext float %i.zz to double            ; 5 uses
  %i.aac = insertelement <2 x float> poison, float %i.zy, i64 0
  ...
  %i.aag = insertelement <2 x float> poison, float %i.zz, i64 0
  ...
  %46 = fmul double %i.zx, %i.zx
  %47 = fsub double 0.000000e+00, %i.zx
  %i.acm = insertelement <2 x double> poison, double %46, i64 0
...
.preheader437:                                    ; preds = %bb.aa, %bb.ab
  ...
  %48 = fmul double %i.afq, %i.afq
  %49 = fsub double 0.000000e+00, %i.ahv
  %i.ahw = insertelement <2 x double> poison, double %48, i64 0
...
.preheader218:                                    ; preds = %bb.i, %bb.j
  ...
  %18 = fmul double %i.bh, %i.bh
  %19 = fadd double %i.bh, 0.000000e+00
  %i.cw = insertelement <2 x double> poison, double %18, i64 0
  %i.cx = insertelement <2 x double> %i.cw, double %19, i64 1
