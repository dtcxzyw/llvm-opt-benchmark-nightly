...
.preheader434:                                    ; preds = %bb.x, %bb.y
  ...
  %i.aae = getelementptr inbounds [4 x i8], ptr %i.t, i64 %i.aad ; 2 uses
  %i.aaf = getelementptr i8, ptr %i.aae, i64 8
  ...
  %24 = load <2 x float>, ptr %i.aaf, align 4, !tbaa !67 ; 4 uses
  %25 = extractelement <2 x float> %24, i64 0
  %i.aao = fpext float %25 to double              ; 6 uses
  %26 = extractelement <2 x float> %24, i64 1
  %27 = fpext float %26 to double                 ; 5 uses
  %i.aap = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aaq = fmul <2 x float> %i.aag, %i.aap
  %i.aar = fpext <2 x float> %i.aaq to <2 x double> ; 8 uses
  %28 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.aas = fmul <2 x float> %i.aag, %28
