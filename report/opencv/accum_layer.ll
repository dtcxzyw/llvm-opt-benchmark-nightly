...
_ZSt8_DestroyIPN2cv3MatES1_EvT_S3_RSaIT0_E.exitthread-pre-split.i125: ; preds = %.lr.ph.i.i.i122
  %.pr.i126 = load ptr, ptr %20, align 8, !tbaa !76
...
bb.aw:                                            ; preds = %_ZSt8_DestroyIPN2cv3MatES1_EvT_S3_RSaIT0_E.exit.i127
  %i.ev = load ptr, ptr %i.ar, align 8, !tbaa !78
...
bb.bb:                                            ; preds = %bb.ba
  ...
  %i.fd = load ptr, ptr %i.ag, align 8, !tbaa !77
  %i.fe = load ptr, ptr %15, align 8, !tbaa !76   ; 2 uses
  %i.ff = ptrtoint ptr %i.fd to i64
  %i.fg = ptrtoint ptr %i.fe to i64
  %i.fh = sub i64 %i.ff, %i.fg
  %i.fi = sdiv exact i64 %i.fh, 208
  %i.fj = load i8, ptr %i.ah, align 8, !tbaa !59, !range !81, !noundef !82
...
bb.a:
  ...
  %i.c = load i32, ptr %i.b, align 4, !tbaa !64   ; 3 uses
  ...
  %i.e = load i8, ptr %i.d, align 8, !tbaa !59, !range !81, !noundef !82
  %i.f = trunc nuw i8 %i.e to i1
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !87   ; 3 uses
  %i.i = load ptr, ptr %1, align 8, !tbaa !86     ; 5 uses
...
._crit_edge157:                                   ; preds = %_ZNK2cv8MatShapeixEm.exit84
  ...
  %i.aa = load ptr, ptr %i.g, align 8, !tbaa !88  ; 3 uses
...
_ZNK2cv8MatShapeixEm.exit70:                      ; preds = %_ZNK2cv8MatShapeixEm.exit
  ...
  %i.at = load i32, ptr %i.as, align 4, !tbaa !64
  br label %bb.ao
...
bb.s:                                             ; preds = %.lr.ph156
  %i.bf = load i32, ptr %i.au, align 4, !tbaa !74
...
._crit_edge:                                      ; preds = %bb.ak, %.preheader133
  ...
  %i.br = load i32, ptr %i.bq, align 4, !tbaa !58 ; 4 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.ak
  ...
  %i.bt = load i32, ptr %i.bs, align 4, !tbaa !74 ; 3 uses
...
_ZNK2cv8MatShapeixEm.exit96:                      ; preds = %_ZNK2cv8MatShapeixEm.exit90
  ...
  %i.cl = load i32, ptr %i.ck, align 4, !tbaa !64
...
_ZNK2cv8MatShapeixEm.exit102:                     ; preds = %_ZNK2cv8MatShapeixEm.exit96
  %i.ct = load i32, ptr %i.cb, align 4, !tbaa !64
...
bb.al:                                            ; preds = %._crit_edge
  %i.df = sdiv i32 %.0129.lcssa, %i.br
  %i.dg = sitofp i32 %i.df to double
  %i.dh = sitofp i32 %i.br to double              ; 2 uses
  %i.di = fmul nnan double %i.dh, %i.dg
  %i.dj = fptosi double %i.di to i32
  %i.dk = sdiv i32 %.0130.lcssa, %i.br
  %i.dl = sitofp i32 %i.dk to double
  %i.dm = fmul nnan double %i.dh, %i.dl
  %i.dn = fptosi double %i.dm to i32
  br label %bb.an

bb.am:                                            ; preds = %._crit_edge
  %i.do = getelementptr inbounds nuw i8, ptr %0, i64 156
  %i.dp = load i32, ptr %i.do, align 4, !tbaa !55
  %i.dq = getelementptr inbounds nuw i8, ptr %0, i64 160
  %i.dr = load i32, ptr %i.dq, align 8, !tbaa !56
  br label %bb.an

bb.an:                                            ; preds = %bb.am, %bb.al
  %i.ds = phi i32 [ %i.dj, %bb.al ], [ %i.dp, %bb.am ] ; 2 uses
  %i.dt = phi i32 [ %i.dn, %bb.al ], [ %i.dr, %bb.am ] ; 2 uses
  %.not55 = icmp sgt i32 %i.ds, %.0129.lcssa
  %.not56 = icmp sgt i32 %i.dt, %.0130.lcssa
  %or.cond = select i1 %.not55, i1 %.not56, i1 false ; 2 uses
end_hunk_0
