...
.lr.ph419:                                        ; preds = %.lr.ph419.preheader, %bb.dy
  ...
  %i.rh = load i32, ptr %i.rg, align 4, !tbaa !45 ; 2 uses
...
bb.dw:                                            ; preds = %.lr.ph419
  ...
  %i.rj = load double, ptr %i.ri, align 8, !tbaa !66
...
.lr.ph419.1:                                      ; preds = %.lr.ph419, %bb.dw
  ...
  store double %i.rm, ptr %i.rn, align 8, !tbaa !66
  ...
  %i.rp = load i32, ptr %i.ro, align 4, !tbaa !45 ; 2 uses
...
bb.dx:                                            ; preds = %.lr.ph419.1
  ...
  %i.rr = load double, ptr %i.rq, align 8, !tbaa !66
...
bb.dy:                                            ; preds = %bb.dx, %.lr.ph419.1
  ...
  store double %i.ru, ptr %i.rv, align 8, !tbaa !66
  %indvars.iv.next474.1 = add nuw nsw i64 %indvars.iv473, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge420.loopexit.unr-lcssa, label %.lr.ph419, !llvm.loop !128
...
.lr.ph419.epil.preheader:                         ; preds = %._crit_edge420.loopexit.unr-lcssa, %.lr.ph419.preheader
  ...
  %i.ry = load i32, ptr %i.rx, align 4, !tbaa !45 ; 2 uses
...
bb.ea:                                            ; preds = %.lr.ph419.epil.preheader
  ...
  %i.sa = load double, ptr %i.rz, align 8, !tbaa !66
...
bb.eb:                                            ; preds = %.lr.ph426, %.split423.us
  ...
  %i.tq = load double, ptr %i.tp, align 8, !tbaa !66 ; 4 uses
  %i.tr = getelementptr inbounds nuw [8 x i8], ptr %i.sm, i64 %indvars.iv492
  %i.ts = load double, ptr %i.tr, align 8, !tbaa !66 ; 5 uses
  %i.tt = getelementptr inbounds nuw [4 x i8], ptr %i.si, i64 %indvars.iv492
  %i.tu = load i32, ptr %i.tt, align 4, !tbaa !45
...
vector.body647:                                   ; preds = %vector.body647, %vector.ph637
  ...
  %wide.load649 = load <2 x double>, ptr %i.ua, align 8, !tbaa !66, !alias.scope !159 ; 2 uses
  %i.ub = getelementptr inbounds nuw [8 x i8], ptr %i.tm, i64 %index648
  %wide.load650 = load <2 x double>, ptr %i.ub, align 8, !tbaa !66, !alias.scope !160
  %i.uc = getelementptr inbounds nuw [8 x i8], ptr %i.sq, i64 %index648
  %wide.load651 = load <2 x double>, ptr %i.uc, align 8, !tbaa !66, !alias.scope !161
  ...
  store <2 x double> %i.uh, ptr %i.ui, align 8, !tbaa !66, !alias.scope !162, !noalias !163
  %index.next652 = add nuw i64 %index648, 2       ; 2 uses
  %i.uj = icmp eq i64 %index.next652, %n.vec638
  br i1 %i.uj, label %middle.block653, label %vector.body647, !llvm.loop !134
...
vector.body610:                                   ; preds = %vector.body610, %vector.ph598
  ...
  %wide.load612 = load <2 x double>, ptr %i.uk, align 8, !tbaa !66, !alias.scope !164 ; 2 uses
  %i.ul = getelementptr inbounds nuw [8 x i8], ptr %i.tm, i64 %index611
  %wide.load613 = load <2 x double>, ptr %i.ul, align 8, !tbaa !66, !alias.scope !165
  %i.um = getelementptr inbounds nuw [8 x i8], ptr %i.sq, i64 %index611
  %wide.load614 = load <2 x double>, ptr %i.um, align 8, !tbaa !66, !alias.scope !166
  ...
  store <2 x double> %i.us, ptr %i.ut, align 8, !tbaa !66, !alias.scope !167, !noalias !168
  %index.next615 = add nuw i64 %index611, 2       ; 2 uses
  %i.uu = icmp eq i64 %index.next615, %n.vec599
  br i1 %i.uu, label %middle.block616, label %vector.body610, !llvm.loop !140
...
.split.us:                                        ; preds = %.split.us.preheader656, %.split.us
  ...
  %i.uw = load double, ptr %i.uv, align 8, !tbaa !66 ; 2 uses
  %i.ux = getelementptr inbounds nuw [8 x i8], ptr %i.tm, i64 %indvars.iv485
  %i.uy = load double, ptr %i.ux, align 8, !tbaa !66
  %i.uz = getelementptr inbounds nuw [8 x i8], ptr %i.sq, i64 %indvars.iv485
  %i.va = load double, ptr %i.uz, align 8, !tbaa !66
...
.split:                                           ; preds = %.split.preheader657, %.split
  ...
  %i.vj = load double, ptr %i.vi, align 8, !tbaa !66 ; 2 uses
  %i.vk = getelementptr inbounds nuw [8 x i8], ptr %i.tm, i64 %indvars.iv478
  %i.vl = load double, ptr %i.vk, align 8, !tbaa !66
  %i.vm = getelementptr inbounds nuw [8 x i8], ptr %i.sq, i64 %indvars.iv478
  %i.vn = load double, ptr %i.vm, align 8, !tbaa !66
...
.split423.us:                                     ; preds = %.split, %.split.us, %middle.block653, %middle.block616
  ...
  br i1 %exitcond498.not, label %._crit_edge427, label %bb.eb, !llvm.loop !143
...
._crit_edge427:                                   ; preds = %.split423.us, %._crit_edge420
  ...
  store i32 50397184, ptr %32, align 8, !tbaa !57
  store ptr %29, ptr %i.pd, align 8, !tbaa !58
...
bb.ec:                                            ; preds = %._crit_edge427
  ...
  store i32 0, ptr %i.pf, align 8, !tbaa !54
  store i32 0, ptr %i.pg, align 4, !tbaa !55
  store i32 16842752, ptr %33, align 8, !tbaa !57
  store ptr %29, ptr %i.ph, align 8, !tbaa !58
  call void @llvm.lifetime.start.p0(ptr nonnull %34) #19
  store i64 0, ptr %i.pj, align 8
  store i32 33619968, ptr %34, align 8, !tbaa !57
  store ptr %i.qr, ptr %i.pi, align 8, !tbaa !58
