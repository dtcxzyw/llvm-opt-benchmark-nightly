...
vector.body315:                                   ; preds = %.loopexit.us.us.preheader, %vector.body315
  ...
  %2 = fsub <4 x float> %i.ht, %i.ib
  %3 = fsub <4 x float> %i.in, %i.iz
  %4 = shufflevector <4 x float> %2, <4 x float> %3, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
vector.body:                                      ; preds = %.lr.ph58.us, %vector.body
  ...
  %5 = fsub <4 x float> %i.ma, %i.mi
  %6 = fsub <4 x float> %i.mu, %i.ng
  %7 = shufflevector <4 x float> %5, <4 x float> %6, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
vector.body445:                                   ; preds = %.lr.ph, %vector.body445
  ...
  %8 = fsub <4 x float> %i.um, %i.uu
  %9 = fsub <4 x float> %i.vg, %i.vs
...
vector.body458:                                   ; preds = %.loopexit.us.us.preheader, %vector.body458
  ...
  %2 = fsub <4 x float> %i.nb, %i.nj
  %3 = fsub <4 x float> %i.nv, %i.oh
  %4 = shufflevector <4 x float> %2, <4 x float> %3, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %5 = fsub <4 x float> %i.ot, %i.pf
  %6 = fsub <4 x float> %i.pr, %i.qd
  %7 = shufflevector <4 x float> %5, <4 x float> %6, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
...
vector.body:                                      ; preds = %.lr.ph61.us, %vector.body
  ...
  %8 = fsub <4 x float> %i.sx, %i.tf
  %9 = fsub <4 x float> %i.tr, %i.ud
  %10 = shufflevector <4 x float> %8, <4 x float> %9, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %11 = fsub <4 x float> %i.up, %i.vb
  %12 = fsub <4 x float> %i.vn, %i.vz
...
vector.body658:                                   ; preds = %.lr.ph, %vector.body658
  ...
  %14 = fsub <4 x float> %i.afw, %i.age
  %15 = fsub <4 x float> %i.agq, %i.ahc
  ...
  %17 = fsub <4 x float> %i.aho, %i.aia
  %18 = fsub <4 x float> %i.aim, %i.aiy
  %19 = shufflevector <4 x float> %17, <4 x float> %18, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
