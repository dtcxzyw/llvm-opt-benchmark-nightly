...
bb.cg:                                            ; preds = %.lr.ph512, %._crit_edge510
  ...
  %i.kq = and i64 %i.kp, -8
  %scevgep635 = getelementptr i8, ptr %scevgep, i64 %i.kq
  %i.kr = mul i64 %i.ey, %indvars.iv
  %i.ks = getelementptr i8, ptr %i.de, i64 %i.kr
  %scevgep636 = getelementptr i8, ptr %i.ks, i64 144
  %i.kt = lshr i64 %i.kp, 3
  %i.ku = mul i64 %i.kt, 144
  %scevgep637 = getelementptr i8, ptr %scevgep636, i64 %i.ku
...
vector.memcheck:                                  ; preds = %.lr.ph.preheader
  %bound0 = icmp ult ptr %i.kw, %scevgep637
  %bound1 = icmp ult ptr %i.kz, %scevgep635
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep639.a = getelementptr i8, ptr %i.kz, i64 %i.lf ; 18 uses
  %i.lg = getelementptr i8, ptr %i.kz, i64 %i.lf  ; 18 uses
  %next.gep640 = getelementptr i8, ptr %i.lg, i64 144
  store <2 x double> zeroinitializer, ptr %next.gep, align 8, !tbaa !25, !alias.scope !99, !noalias !102
  %i.lh = load double, ptr %next.gep639.a, align 8, !tbaa !25, !alias.scope !102
  %i.li = load double, ptr %next.gep640, align 8, !tbaa !25, !alias.scope !102
  %i.lj = insertelement <2 x double> poison, double %i.lh, i64 0
  %i.lk = insertelement <2 x double> %i.lj, double %i.li, i64 1
  %i.ll = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 72
  ...
  %i.lt = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 8
  ...
  %i.lz = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 80
  ...
  %i.mh = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 16
  ...
  %i.mn = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 88
  ...
  %i.mv = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 24
  ...
  %i.nb = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 96
  ...
  %i.nj = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 32
  ...
  %i.np = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 104
  ...
  %i.nx = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 40
  ...
  %i.od = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 112
  ...
  %i.ol = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 48
  ...
  %i.or = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 120
  ...
  %i.oz = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 56
  ...
  %i.pf = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 128
  ...
  %i.pn = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 64
  ...
  %i.pt = getelementptr inbounds nuw i8, ptr %next.gep639.a, i64 136
...
.lr.ph:                                           ; preds = %.lr.ph.preheader652, %.lr.ph
  %.0330508 = phi ptr [ %i.sd, %.lr.ph ], [ %.0330508.ph, %.lr.ph.preheader652 ] ; 11 uses
  %.0331507 = phi ptr [ %i.se, %.lr.ph ], [ %.0331507.ph, %.lr.ph.preheader652 ] ; 19 uses
...
.preheader.preheader:                             ; preds = %.preheader.lr.ph
  ...
  %wide.trip.count574 = zext nneg i32 %i.sr to i64
  ...
  %lcmp.mod653 = icmp ne i64 %xtraiter, 0
  %xtraiter654 = and i64 %i.th, 7                 ; 3 uses
  %i.tj = icmp ult i32 %i.su, 225
  %unroll_iter658 = and i64 %i.th, 1152921504606846968
  %lcmp.mod656.not = icmp eq i64 %xtraiter654, 0
  %lcmp.mod657 = icmp ne i64 %xtraiter654, 0
  %i.tk = icmp eq i64 %i.tg, 0
  %unroll_iter664 = and i64 %i.th, 1152921504606846974
  %i.tl = and i64 %i.tf, 32
  %lcmp.mod662.not.not = icmp eq i64 %i.tl, 0
  %lcmp.mod663 = trunc i64 %i.th to i1
  br label %.preheader

._crit_edge525:                                   ; preds = %.preheader495
  %indvars.iv.next560 = add nuw nsw i64 %indvars.iv559, 1 ; 2 uses
  %i.tm = trunc nuw i64 %indvars.iv.next560 to i32
  %i.tn = icmp sgt i32 %i.kb, %i.tm
  br i1 %i.tn, label %.preheader496, label %.preheader494, !llvm.loop !109

bb.ch:                                            ; preds = %.preheader496, %.preheader495
  %indvars.iv553 = phi i64 [ %i.kh, %.preheader496 ], [ %indvars.iv.next554, %.preheader495 ] ; 5 uses
  %.idx622 = shl nsw i64 %indvars.iv553, 8
  %i.to = getelementptr inbounds nuw i8, ptr %i.sh, i64 %.idx622
  %i.tp = trunc i64 %indvars.iv553 to i32
  %.reass.reass.reass = add i32 %i.tp, %invariant.op ; 2 uses
  %i.tq = sext i32 %.reass.reass.reass to i64     ; 2 uses
  %i.tr = getelementptr inbounds [8 x i8], ptr %i.sl, i64 %i.tq ; 3 uses
  %i.ts = load double, ptr %i.tr, align 8, !tbaa !25
  %i.tt = getelementptr inbounds nuw i8, ptr %i.tr, i64 8
  %i.tu = load double, ptr %i.tt, align 8, !tbaa !25
  %i.tv = fadd double %i.ts, %i.tu
  %i.tw = getelementptr inbounds nuw [8 x i8], ptr %i.tr, i64 %i.cz ; 2 uses
  %i.tx = load double, ptr %i.tw, align 8, !tbaa !25
  %i.ty = fadd double %i.tv, %i.tx
  %i.tz = getelementptr inbounds nuw i8, ptr %i.tw, i64 8
  %i.ua = load double, ptr %i.tz, align 8, !tbaa !25
  %i.ub = fadd double %i.ty, %i.ua
  %i.uc = fadd double %i.ub, 1.000000e-04
  %i.ud = call double @sqrt(double noundef %i.uc) #18
  %i.ue = getelementptr inbounds [8 x i8], ptr %i.sn, i64 %i.tq ; 3 uses
  ...
  %i.uj = getelementptr inbounds nuw [8 x i8], ptr %i.ue, i64 %i.cz ; 2 uses
  %i.uk = load double, ptr %i.uj, align 8, !tbaa !25
  %i.ul = fadd double %i.ui, %i.uk
  %i.um = getelementptr inbounds nuw i8, ptr %i.uj, i64 8
  %i.un = load double, ptr %i.um, align 8, !tbaa !25
  %i.uo = fadd double %i.ul, %i.un
  %i.up = fadd double %i.uo, 1.000000e-04
  %i.uq = call double @sqrt(double noundef %i.up) #18
  %gep527 = getelementptr [8 x i8], ptr %invariant.gep526, i64 %indvars.iv553 ; 3 uses
  %i.ur = load double, ptr %gep527, align 8, !tbaa !25
  %i.us = getelementptr inbounds nuw i8, ptr %gep527, i64 8
  %i.ut = load double, ptr %i.us, align 8, !tbaa !25
  %i.uu = fadd double %i.ur, %i.ut
  %i.uv = getelementptr inbounds nuw [8 x i8], ptr %gep527, i64 %i.cz ; 2 uses
  %i.uw = load double, ptr %i.uv, align 8, !tbaa !25
  %i.ux = fadd double %i.uu, %i.uw
  %i.uy = getelementptr inbounds nuw i8, ptr %i.uv, i64 8
  %i.uz = load double, ptr %i.uy, align 8, !tbaa !25
  %i.va = fadd double %i.ux, %i.uz
  %i.vb = fadd double %i.va, 1.000000e-04
  %i.vc = call double @sqrt(double noundef %i.vb) #18
  %i.vd = insertelement <2 x double> poison, double %i.uq, i64 0
  %i.ve = insertelement <2 x double> %i.vd, double %i.vc, i64 1
  %i.vf = fdiv <2 x double> splat (double 1.000000e+00), %i.ve ; 4 uses
  %gep529 = getelementptr [8 x i8], ptr %invariant.gep528, i64 %indvars.iv553 ; 3 uses
  %i.vg = load double, ptr %gep529, align 8, !tbaa !25
  %i.vh = getelementptr inbounds nuw i8, ptr %gep529, i64 8
end_hunk_0
