...
.lr.ph.preheader.i:                               ; preds = %.lr.ph.preheader.i.preheader, %._crit_edge501.i.loopexit
  ...
  %i.jm = mul i64 %23, %indvars.iv.i              ; 2 uses
  %25 = add i64 %i.ea, %i.jm
  %26 = add i64 %i.eb, %i.jm
  %umax113 = call i64 @llvm.umax.i64(i64 %25, i64 %26)
  %i.jn = mul i64 %24, %indvars.iv.i
  %27 = add i64 %i.jn, %i.ec
  %i.jo = add i64 %umax113, %27
  %28 = lshr i64 %i.jo, 3                         ; 2 uses
  %29 = add nuw nsw i64 %28, 1                    ; 2 uses
  %30 = mul i64 %indvars.iv.i, %i.cf
  %31 = getelementptr [8 x i8], ptr %i.cm, i64 %30 ; 6 uses
  %32 = getelementptr inbounds nuw i8, ptr %31, i64 %.idx.i
  %33 = mul i64 %indvars.iv.i, %i.ce
  %34 = getelementptr [8 x i8], ptr %i.ck, i64 %33 ; 6 uses
  %min.iters.check = icmp eq i64 %28, 0
...
vector.memcheck:                                  ; preds = %.lr.ph.preheader.i
  ...
  %bound0 = icmp ult ptr %31, %scevgep112
  %bound1 = icmp ult ptr %34, %scevgep110
  %found.conflict = and i1 %bound0, %bound1
  br i1 %found.conflict, label %.lr.ph.i.preheader, label %vector.ph

vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %29, 4611686018427387902       ; 4 uses
  %i.kb = shl i64 %n.vec, 3
  %i.kc = getelementptr i8, ptr %31, i64 %i.kb
  %i.kd = mul i64 %n.vec, 144
  %i.ke = getelementptr i8, ptr %34, i64 %i.kd
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %i.kf = shl i64 %index, 3
  %next.gep = getelementptr i8, ptr %31, i64 %i.kf ; 10 uses
  %i.kg = mul i64 %index, 144                     ; 2 uses
  %next.gep114.a = getelementptr i8, ptr %34, i64 %i.kg ; 18 uses
  %i.kh = getelementptr i8, ptr %34, i64 %i.kg    ; 18 uses
...
.lr.ph.i.preheader:                               ; preds = %vector.memcheck, %.lr.ph.preheader.i, %middle.block
  %.0330499.i.ph = phi ptr [ %31, %vector.memcheck ], [ %31, %.lr.ph.preheader.i ], [ %i.kc, %middle.block ]
  %.0331498.i.ph = phi ptr [ %34, %vector.memcheck ], [ %34, %.lr.ph.preheader.i ], [ %i.ke, %middle.block ]
  br label %.lr.ph.i
