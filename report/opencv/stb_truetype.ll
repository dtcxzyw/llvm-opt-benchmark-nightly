...
bb.a:
  ...
  %i.e = load float, ptr %i.d, align 4, !tbaa !192 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.i = load float, ptr %i.h, align 4, !tbaa !193 ; 2 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  store float %.sink, ptr %i.am, align 4, !tbaa !199
  ...
  %i.bb = load float, ptr %i.ba, align 4, !tbaa !200
...
bb.p:                                             ; preds = %bb.n, %bb.m, %bb.l, %bb.k
  ...
  br i1 %exitcond.not, label %_ZN2cvL17stbtt__find_tableEPhjjPKc.exit.thread, label %bb.k, !llvm.loop !201
...
bb.e:                                             ; preds = %_ZN2cv31stbtt_GetGlyphBitmapBoxSubpixelEPKNS_14stbtt_fontinfoEiffffPiS3_S3_S3_.exit.i
  ...
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %_ZN2cvL29stbtt_BakeFontBitmap_internalEPhifS0_iiiiPNS_15stbtt_bakedcharE.exit, label %_ZN2cv22stbtt_GetGlyphHMetricsEPKNS_14stbtt_fontinfoEiPiS3_.exit.i, !llvm.loop !206
...
bb.d:                                             ; preds = %bb.i, %.lr.ph.i
  %indvars.iv.i = phi i64 [ 0, %.lr.ph.i ], [ %indvars.iv.next.i, %bb.i ] ; 2 uses
  %indvars.iv.tr.i = trunc nuw i64 %indvars.iv.i to i32
  %i.x = shl nuw nsw i32 %indvars.iv.tr.i, 4
  %i.y = add i32 %i.x, %i.l
...
bb.j:                                             ; preds = %bb.o, %.lr.ph.i197
  ...
  %indvars.iv.tr.i200 = trunc nuw i64 %indvars.iv.i199 to i32
  %i.bc = shl nuw nsw i32 %indvars.iv.tr.i200, 4
...
_ZN2cvL17stbtt__find_tableEPhjjPKc.exit203.thread496: ; preds = %bb.a
  ...
  store i32 0, ptr %i.bz, align 8, !tbaa !207
...
bb.q:                                             ; preds = %bb.v, %.lr.ph.i211
  ...
  %indvars.iv.tr.i214 = trunc nuw i64 %indvars.iv.i213 to i32
  %i.cm = shl nuw nsw i32 %indvars.iv.tr.i214, 4
...
bb.x:                                             ; preds = %bb.ac, %.lr.ph.i225
  ...
  %indvars.iv.tr.i228 = trunc nuw i64 %indvars.iv.i227 to i32
  %i.ds = shl nuw nsw i32 %indvars.iv.tr.i228, 4
...
bb.ae:                                            ; preds = %bb.aj, %.lr.ph.i239
  ...
  %indvars.iv.tr.i242 = trunc nuw i64 %indvars.iv.i241 to i32
  %i.ey = shl nuw nsw i32 %indvars.iv.tr.i242, 4
...
bb.al:                                            ; preds = %bb.aq, %.lr.ph.i253
  ...
  %indvars.iv.tr.i256 = trunc nuw i64 %indvars.iv.i255 to i32
  %i.ge = shl nuw nsw i32 %indvars.iv.tr.i256, 4
...
bb.as:                                            ; preds = %bb.ax, %.lr.ph.i267
  ...
  %indvars.iv.tr.i270 = trunc nuw i64 %indvars.iv.i269 to i32
  %i.hk = shl nuw nsw i32 %indvars.iv.tr.i270, 4
...
bb.ay:                                            ; preds = %bb.bd, %.lr.ph.i281
  ...
  %indvars.iv.tr.i284 = trunc nuw i64 %indvars.iv.i283 to i32
  %i.iq = shl nuw nsw i32 %indvars.iv.tr.i284, 4
...
bb.bf:                                            ; preds = %bb.bk, %.lr.ph.i295
  ...
  %indvars.iv.tr.i298 = trunc nuw i64 %indvars.iv.i297 to i32
  %i.jx = shl nuw nsw i32 %indvars.iv.tr.i298, 4
...
_ZN2cvL17stbtt__find_tableEPhjjPKc.exit301.thread: ; preds = %bb.bk, %bb.bj, %bb.be
  ...
  store i32 %.sink964, ptr %i.kr, align 4, !tbaa !208
...
bb.bl:                                            ; preds = %bb.bq, %.lr.ph.i309
  ...
  %indvars.iv.tr.i312 = trunc nuw i64 %indvars.iv.i311 to i32
  %i.ld = shl nuw nsw i32 %indvars.iv.tr.i312, 4
...
_ZN2cvL17stbtt__find_tableEPhjjPKc.exit315.thread.critedge: ; preds = %_ZN2cvL17stbtt__find_tableEPhjjPKc.exit287.thread
  ...
  store i32 0, ptr %i.lx, align 4, !tbaa !208
  br label %_ZN2cvL17stbtt__find_tableEPhjjPKc.exit315.thread
...
_ZN2cvL17stbtt__find_tableEPhjjPKc.exit315.thread: ; preds = %bb.bq, %bb.bp, %_ZN2cvL17stbtt__find_tableEPhjjPKc.exit301.thread, %_ZN2cvL17stbtt__find_tableEPhjjPKc.exit315.thread.critedge
  ...
  store i32 %.sink966, ptr %i.ly, align 8, !tbaa !207
...
bb.bs:                                            ; preds = %bb.bx, %.lr.ph.i323
  ...
  %indvars.iv.tr.i326 = trunc nuw i64 %indvars.iv.i325 to i32
  %i.mk = shl nuw nsw i32 %indvars.iv.tr.i326, 4
...
bb.bz:                                            ; preds = %bb.ce, %.lr.ph.i337
  ...
  %indvars.iv.tr.i340 = trunc nuw i64 %indvars.iv.i339 to i32
  %i.nq = shl nuw nsw i32 %indvars.iv.tr.i340, 4
...
_ZN2cvL17stbtt__find_tableEPhjjPKc.exit343:       ; preds = %bb.ce, %_ZN2cvL17stbtt__find_tableEPhjjPKc.exit203.thread496, %_ZN2cvL17stbtt__find_tableEPhjjPKc.exit329.thread, %bb.by, %bb.cd
  ...
  store i32 %i.on, ptr %i.oo, align 8, !tbaa !209
...
bb.ck:                                            ; preds = %bb.cp, %.lr.ph.i351
  ...
  %indvars.iv.tr.i354 = trunc nuw i64 %indvars.iv.i353 to i32
  %i.pb = shl nuw nsw i32 %indvars.iv.tr.i354, 4
...
bb.cq:                                            ; preds = %bb.co
  ...
  store ptr %i.px, ptr %i.k, align 8, !tbaa !120
  store i64 %.sroa.4.8.insert.shift.i, ptr %.sroa.437.0..sroa_idx, align 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %4, ptr noundef nonnull align 8 dereferenceable(16) %i.k, i64 16, i1 false), !tbaa.struct !210
  %i.qa = getelementptr inbounds nuw i8, ptr %4, i64 8 ; 17 uses
  %i.qb = load i32, ptr %i.qa, align 8, !tbaa !211 ; 2 uses
  %i.qc = add nsw i32 %i.qb, 2
  %i.qd = getelementptr inbounds nuw i8, ptr %4, i64 12 ; 2 uses
  %i.qe = load i32, ptr %i.qd, align 4, !tbaa !212 ; 48 uses
...
bb.cr:                                            ; preds = %bb.cq
  %i.qh = load ptr, ptr %4, align 8, !tbaa !213
...
_ZN2cvL15stbtt__buf_get8EPNS_10stbtt__bufE.exit:  ; preds = %bb.cq, %bb.cr
  ...
  store i32 %i.qm, ptr %i.qa, align 8, !tbaa !211
...
bb.cs:                                            ; preds = %_ZN2cvL15stbtt__buf_get8EPNS_10stbtt__bufE.exit
  %i.qn = load ptr, ptr %4, align 8, !tbaa !213
  %i.qo = add nsw i32 %i.qm, 1                    ; 2 uses
  store i32 %i.qo, ptr %i.qa, align 8, !tbaa !211
...
bb.ct:                                            ; preds = %_ZN2cvL15stbtt__buf_get8EPNS_10stbtt__bufE.exit.i.i
  %i.qv = load ptr, ptr %4, align 8, !tbaa !213
  %i.qw = add nsw i32 %i.qu, 1                    ; 2 uses
  store i32 %i.qw, ptr %i.qa, align 8, !tbaa !211
...
bb.cv:                                            ; preds = %bb.cu
  %i.rd = load ptr, ptr %4, align 8, !tbaa !213
...
_ZN2cvL15stbtt__buf_get8EPNS_10stbtt__bufE.exit.i18.i.1: ; preds = %bb.cx, %_ZN2cvL15stbtt__buf_get8EPNS_10stbtt__bufE.exit.i18.i
  ...
  br i1 %niter.ncmp.1, label %_ZN2cvL14stbtt__buf_getEPNS_10stbtt__bufEi.exit21.loopexit.i.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !214
...
_ZN2cvL15stbtt__buf_get8EPNS_10stbtt__bufE.exit.i18.i452.1: ; preds = %bb.ed, %_ZN2cvL15stbtt__buf_get8EPNS_10stbtt__bufE.exit.i18.i452
  ...
  br i1 %niter1105.ncmp.1, label %_ZN2cvL14stbtt__buf_getEPNS_10stbtt__bufEi.exit21.loopexit.i455.unr-lcssa, label %.lr.ph.i.i448, !llvm.loop !214
...
_ZN2cvL14stbtt__buf_getEPNS_10stbtt__bufEi.exit21.i456: ; preds = %_ZN2cvL14stbtt__buf_getEPNS_10stbtt__bufEi.exit21.loopexit.i455, %_ZN2cvL15stbtt__buf_get8EPNS_10stbtt__bufE.exit.i444
  ...
  store i32 %..i.i22.i458, ptr %i.qa, align 8, !tbaa !211
...
_ZN2cvL20stbtt__cff_get_indexEPNS_10stbtt__bufE.exit465: ; preds = %_ZN2cvL14stbtt__buf_getEPNS_10stbtt__bufEi.exit21.i456, %_ZN2cvL15stbtt__buf_get8EPNS_10stbtt__bufE.exit.i.1.i440
  ...
  store ptr %.sroa.0.0.i.i461, ptr %i.adc, align 8, !tbaa !120
  ...
  %.sroa.08.0.copyload = load ptr, ptr %5, align 8, !tbaa !120
  ...
  store ptr %i.ade, ptr %i.adg, align 8, !tbaa !120
...
_ZN2cvL16stbtt__buf_rangeEPKNS_10stbtt__bufEii.exit: ; preds = %bb.eg
  ...
  store i32 %..i, ptr %i.qa, align 8, !tbaa !211
  ...
  store ptr %i.adr, ptr %i.pu, align 8, !tbaa !120
  store i64 %i.ads, ptr %.sroa.429.0..sroa_idx, align 8
  %i.adt = load i32, ptr %i.qd, align 4, !tbaa !212 ; 3 uses
  ...
  store ptr %.sroa.0.0.i, ptr %i.pv, align 8, !tbaa !120
...
bb.eh:                                            ; preds = %_ZN2cvL16stbtt__buf_rangeEPKNS_10stbtt__bufEii.exit, %bb.ef
  ...
  store i32 %..i469, ptr %i.qa, align 8, !tbaa !211
  ...
  store ptr %i.aeg, ptr %i.aei, align 8, !tbaa !120
...
bb.el:                                            ; preds = %bb.eq, %.lr.ph.i477
  ...
  %indvars.iv.tr.i480 = trunc nuw i64 %indvars.iv.i479 to i32
  %i.aev = shl nuw nsw i32 %indvars.iv.tr.i480, 4
...
_ZN2cvL17stbtt__find_tableEPhjjPKc.exit483.thread: ; preds = %bb.eq, %bb.ei, %bb.ej, %bb.ek, %bb.ep, %bb.er
  ...
  store i32 -1, ptr %i.afx, align 8, !tbaa !215
...
bb.es:                                            ; preds = %.lr.ph, %bb.eu
  ...
  %i.agj = shl nuw nsw i32 %indvars.iv.tr, 3
...
bb.eu:                                            ; preds = %.sink.split, %bb.et, %bb.es
  ...
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge, label %bb.es, !llvm.loop !216
...
bb.ev:                                            ; preds = %._crit_edge
  ...
  %i.aho = load i32, ptr %i.om, align 8, !tbaa !207
...
.thread:                                          ; preds = %bb.ew, %bb.fa, %bb.ez, %bb.ey, %bb.ex
  ...
  store i32 0, ptr %i.om, align 8, !tbaa !207
...
bb.b:                                             ; preds = %bb.a
  %i.a = load ptr, ptr %0, align 8, !tbaa !217    ; 2 uses
...
bb.g:                                             ; preds = %bb.l, %.lr.ph.i.i.i
  ...
  %i.t = shl nuw nsw i32 %indvars.iv.tr.i.i.i, 4
  %i.u = add nuw i32 %i.t, %i.j
...
bb.o:                                             ; preds = %bb.t, %.lr.ph.i58.i.i
  ...
  %indvars.iv.tr.i61.i.i = trunc nuw i64 %indvars.iv.i60.i.i to i32
  %i.bd = shl nuw nsw i32 %indvars.iv.tr.i61.i.i, 4
  %i.be = add nuw i32 %i.bd, %i.at
...
.loopexit.i:                                      ; preds = %bb.t, %bb.aa, %bb.x, %bb.s, %bb.n, %.thread.i.i, %bb.m, %_ZN2cvL17stbtt__find_tableEPhjjPKc.exit.i.i, %bb.b
  ...
  br i1 %i.cf, label %_ZN2cvL31stbtt_FindMatchingFont_internalEPhjPci.exit, label %bb.b, !llvm.loop !219
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.i = load i32, ptr %i.h, align 4, !tbaa !220  ; 7 uses
...
.lr.ph.us:                                        ; preds = %.lr.ph.us.preheader, %bb.j
  ...
  %i.n = load i32, ptr %i.m, align 4, !tbaa !222  ; 2 uses
end_hunk_3
