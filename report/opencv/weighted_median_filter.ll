...
.preheader.lr.ph.i:                               ; preds = %.lr.ph.i.i
  ...
  br i1 %i.dx, label %.lr.ph340.i.us, label %.lr.ph340.i

.lr.ph340.i.us:                                   ; preds = %.preheader.lr.ph.i, %._crit_edge341.i.us
  %indvars.iv397.i.us = phi i64 [ %indvars.iv.next398.i.us, %._crit_edge341.i.us ], [ 0, %.preheader.lr.ph.i ] ; 6 uses
  %60 = getelementptr inbounds nuw [8 x i8], ptr %i.df, i64 %indvars.iv397.i.us
  %61 = load ptr, ptr %60, align 8, !tbaa !35
  %62 = trunc nuw nsw i64 %indvars.iv397.i.us to i32 ; 2 uses
  br label %.split1.us.i.us

.split1.us.i.us:                                  ; preds = %bb.bm, %.lr.ph340.i.us
  %indvars.iv402.i.us = phi i64 [ %indvars.iv397.i.us, %.lr.ph340.i.us ], [ %indvars.iv.next403.i.us, %bb.bm ] ; 5 uses
...
bb.bh:                                            ; preds = %.split1.us.i.us
  %i.ee = trunc nuw nsw i64 %indvars.iv402.i.us to i32 ; 2 uses
...
bb.bm:                                            ; preds = %bb.bl, %bb.bk, %bb.bj, %bb.bi, %bb.bh, %.split1.us.i.us, %.split1.us.i.us
  ...
  %i.ex = getelementptr inbounds nuw [4 x i8], ptr %61, i64 %indvars.iv402.i.us
  ...
  br i1 %exitcond301.not, label %._crit_edge341.i.us, label %.split1.us.i.us, !llvm.loop !50

._crit_edge341.i.us:                              ; preds = %bb.bm
  %indvars.iv.next398.i.us = add nuw nsw i64 %indvars.iv397.i.us, 1 ; 2 uses
  %exitcond302.not = icmp eq i64 %indvars.iv.next398.i.us, 256
  br i1 %exitcond302.not, label %.loopexit.i, label %.lr.ph340.i.us, !llvm.loop !51

.lr.ph340.i:                                      ; preds = %.preheader.lr.ph.i, %._crit_edge341.i
  %indvars.iv397.i = phi i64 [ %indvars.iv.next398.i, %._crit_edge341.i ], [ 0, %.preheader.lr.ph.i ] ; 5 uses
  %64 = getelementptr inbounds nuw [8 x i8], ptr %i.df, i64 %indvars.iv397.i
  %65 = load ptr, ptr %64, align 8, !tbaa !35
  br label %.lr.ph340.split.i
...
._crit_edge341.i:                                 ; preds = %.lr.ph340.split.i
  %indvars.iv.next398.i = add nuw nsw i64 %indvars.iv397.i, 1 ; 2 uses
  %exitcond300.not = icmp eq i64 %indvars.iv.next398.i, 256
  br i1 %exitcond300.not, label %.loopexit.i, label %.lr.ph340.i, !llvm.loop !51

.lr.ph340.split.i:                                ; preds = %.lr.ph340.i, %.lr.ph340.split.i
  %indvars.iv399.i = phi i64 [ %indvars.iv.next400.i, %.lr.ph340.split.i ], [ %indvars.iv397.i, %.lr.ph340.i ] ; 4 uses
  %i.fa = sub nsw i64 %indvars.iv397.i, %indvars.iv399.i
  ...
  %i.fk = getelementptr inbounds nuw [4 x i8], ptr %i.fj, i64 %indvars.iv397.i
  store float %i.fh, ptr %i.fk, align 4, !tbaa !48
  %i.fl = getelementptr inbounds nuw [4 x i8], ptr %65, i64 %indvars.iv399.i
...
.loopexit.i:                                      ; preds = %._crit_edge341.i, %._crit_edge341.i.us, %._crit_edge338.i, %._crit_edge
  %.0222 = phi i32 [ 256, %._crit_edge ], [ %.sroa.speculated274.i, %._crit_edge338.i ], [ 256, %._crit_edge341.i.us ], [ 256, %._crit_edge341.i ] ; 3 uses
  %.0221 = phi ptr [ null, %._crit_edge ], [ %i.kk, %._crit_edge338.i ], [ %i.df, %._crit_edge341.i.us ], [ %i.df, %._crit_edge341.i ] ; 3 uses
