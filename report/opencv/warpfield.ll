...
.lr.ph:                                           ; preds = %bb.b
  ...
  %.sroa.0.4.vec.extract.i = extractelement <2 x float> %1, i64 1 ; 3 uses
...
bb.c:                                             ; preds = %.lr.ph, %_ZNSt12__shared_ptrIN2cv6dynafu8WarpNodeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit
  ...
  %i.w = load ptr, ptr %i.v, align 8, !tbaa !139  ; 13 uses
...
bb.g:                                             ; preds = %bb.f, %bb.e, %bb.c
  ...
  %i.af = load <2 x float>, ptr %i.w, align 4, !tbaa !145 ; 4 uses
  %i.ag = load float, ptr %i.ae, align 4, !tbaa !200 ; 3 uses
  %foldExtExtBinop = fsub <2 x float> %i.af, %1
  %i.ah = extractelement <2 x float> %foldExtExtBinop, i64 0 ; 2 uses
  %7 = extractelement <2 x float> %i.af, i64 1    ; 2 uses
  %i.ai = fsub float %7, %.sroa.0.4.vec.extract.i ; 2 uses
  %8 = fsub float %i.ag, %2                       ; 2 uses
  %9 = fmul float %i.ai, %i.ai
  %i.aj = call float @llvm.fmuladd.f32(float %i.ah, float %i.ah, float %9)
  %i.ak = call float @llvm.fmuladd.f32(float %8, float %8, float %i.aj)
...
bb.j:                                             ; preds = %bb.h
  %foldExtExtBinop152 = fsub <2 x float> %1, %i.af ; 2 uses
  %i.bq = extractelement <2 x float> %foldExtExtBinop152, i64 0
  %10 = fsub float %.sroa.0.4.vec.extract.i, %7   ; 2 uses
  %11 = fsub float %2, %i.ag                      ; 2 uses
  %i.br = call float @llvm.fmuladd.f32(float %i.bc, float %i.bq, float 0.000000e+00)
  %12 = call float @llvm.fmuladd.f32(float %i.be, float %10, float %i.br)
  %i.bs = call float @llvm.fmuladd.f32(float %i.bg, float %11, float %12)
  ...
  %i.cb = shufflevector <2 x float> %foldExtExtBinop152, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.ce = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cd, <2 x float> %14, <2 x float> %i.cc)
