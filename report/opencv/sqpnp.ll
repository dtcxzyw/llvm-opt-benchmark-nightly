...
bb.a:
  ...
  %11 = alloca %"class.cv::Matx.4", align 16      ; 9 uses
  ...
  %i.hf = getelementptr inbounds nuw i8, ptr %6, i64 120 ; 2 uses
  ...
  %i.hi = getelementptr inbounds nuw i8, ptr %6, i64 144 ; 3 uses
  ...
  %i.hu = getelementptr inbounds nuw i8, ptr %6, i64 32 ; 3 uses
  ...
  %i.ij = getelementptr inbounds nuw i8, ptr %6, i64 152
  ...
  %i.im = getelementptr inbounds nuw i8, ptr %6, i64 176 ; 2 uses
  ...
  %i.ip = getelementptr inbounds nuw i8, ptr %6, i64 200 ; 2 uses
  ...
  %i.iv = getelementptr inbounds nuw i8, ptr %6, i64 40
  ...
  %i.jk = getelementptr inbounds nuw i8, ptr %6, i64 160 ; 2 uses
  ...
  %i.jn = getelementptr inbounds nuw i8, ptr %6, i64 184 ; 2 uses
  ...
  %i.jq = getelementptr inbounds nuw i8, ptr %6, i64 208 ; 3 uses
  ...
  %i.kc = load double, ptr %i.iy, align 16, !tbaa !43 ; 3 uses
  %i.kd = load double, ptr %i.jb, align 8, !tbaa !43 ; 3 uses
  %i.ke = load double, ptr %i.je, align 16, !tbaa !43 ; 3 uses
  ...
  %13 = load double, ptr %i.jh, align 8, !tbaa !43 ; 3 uses
  %14 = load double, ptr %i.jk, align 16, !tbaa !43 ; 3 uses
  %15 = load double, ptr %i.jn, align 8, !tbaa !43 ; 3 uses
  %16 = load double, ptr %i.jq, align 16, !tbaa !43 ; 3 uses
  %i.ld = load <2 x double>, ptr %i.gt, align 8, !tbaa !43 ; 3 uses
  %17 = load <2 x double>, ptr %i.gw, align 16, !tbaa !43 ; 3 uses
  %18 = load <2 x double>, ptr %i.gz, align 8, !tbaa !43 ; 3 uses
  %i.le = load <2 x double>, ptr %i.hc, align 16, !tbaa !43 ; 3 uses
  %i.lf = load <2 x double>, ptr %i.hf, align 8, !tbaa !43 ; 3 uses
  %i.lg = load <2 x double>, ptr %i.hi, align 16, !tbaa !43 ; 3 uses
  %i.lh = load <2 x double>, ptr %i.hl, align 8, !tbaa !43 ; 3 uses
  %i.li = load <2 x double>, ptr %i.ho, align 16, !tbaa !43 ; 3 uses
  ...
  %19 = load double, ptr %9, align 16, !tbaa !43  ; 2 uses
  %i.lm = load double, ptr %i.jt, align 8, !tbaa !43 ; 2 uses
  %i.ln = load double, ptr %i.ju, align 16, !tbaa !43 ; 2 uses
  %i.lo = load double, ptr %i.jv, align 8, !tbaa !43 ; 2 uses
  %i.lp = load double, ptr %i.jw, align 16, !tbaa !43 ; 2 uses
  %i.lq = load double, ptr %i.jx, align 8, !tbaa !43 ; 2 uses
  %i.lr = load double, ptr %i.jy, align 16, !tbaa !43 ; 2 uses
  %i.ls = load double, ptr %i.jz, align 8, !tbaa !43 ; 2 uses
  %i.lt = load double, ptr %i.ka, align 16, !tbaa !43 ; 2 uses
  %20 = load <2 x double>, ptr %6, align 16, !tbaa !43 ; 3 uses
  %21 = insertelement <2 x double> poison, double %19, i64 0
  %22 = shufflevector <2 x double> %21, <2 x double> poison, <2 x i32> zeroinitializer
  %23 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> %20, <2 x double> zeroinitializer)
  %i.lu = call double @llvm.fmuladd.f64(double %19, double %i.kb, double 0.000000e+00)
  ...
  %24 = load <2 x double>, ptr %i.kg, align 8, !tbaa !43 ; 4 uses
  %25 = load <2 x double>, ptr %i.kh, align 8, !tbaa !43 ; 4 uses
  %26 = load <2 x double>, ptr %i.ki, align 8, !tbaa !43 ; 4 uses
  %27 = load <2 x double>, ptr %i.km, align 8, !tbaa !43 ; 3 uses
  %28 = load double, ptr %i.kq, align 16, !tbaa !43 ; 2 uses
  %29 = shufflevector <2 x double> %24, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %30 = shufflevector <2 x double> %25, <2 x double> poison, <2 x i32> zeroinitializer
  %31 = shufflevector <2 x double> %25, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %32 = shufflevector <2 x double> %26, <2 x double> poison, <2 x i32> zeroinitializer
  %33 = shufflevector <2 x double> %26, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %34 = shufflevector <2 x double> %27, <2 x double> poison, <2 x i32> zeroinitializer
  %35 = shufflevector <2 x double> %24, <2 x double> poison, <2 x i32> zeroinitializer
  %36 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %35, <2 x double> %20, <2 x double> zeroinitializer)
  %37 = shufflevector <2 x double> %24, <2 x double> %27, <2 x i32> <i32 0, i32 3>
  %38 = shufflevector <2 x double> %20, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %39 = insertelement <2 x double> %38, double %i.kb, i64 0
  %40 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %37, <2 x double> %39, <2 x double> zeroinitializer)
  %41 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %29, <2 x double> %i.ld, <2 x double> %36)
  %42 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %30, <2 x double> %17, <2 x double> %41)
  %i.ml = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %31, <2 x double> %18, <2 x double> %42)
  %43 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %32, <2 x double> %i.le, <2 x double> %i.ml)
  %i.mm = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %33, <2 x double> %i.lf, <2 x double> %43)
  %44 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.lk, <2 x double> %i.lg, <2 x double> %i.mm)
  %i.mn = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ll, <2 x double> %i.lh, <2 x double> %44)
  %45 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %34, <2 x double> %i.li, <2 x double> %i.mn) ; 6 uses
  %46 = extractelement <2 x double> %45, i64 1    ; 3 uses
  %47 = extractelement <2 x double> %45, i64 0    ; 3 uses
  store double %47, ptr %i.kn, align 8, !tbaa !43
  %48 = shufflevector <2 x double> %i.kx, <2 x double> poison, <2 x i32> zeroinitializer
  %i.mo = shufflevector <2 x double> %24, <2 x double> %i.kx, <2 x i32> <i32 1, i32 2>
  %49 = insertelement <2 x double> %25, double %i.ky, i64 1
  %50 = shufflevector <2 x double> %17, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %51 = insertelement <2 x double> %50, double %i.kc, i64 0
  %52 = shufflevector <2 x double> %i.kz, <2 x double> poison, <2 x i32> zeroinitializer
  %53 = shufflevector <2 x double> %25, <2 x double> %i.kz, <2 x i32> <i32 1, i32 2>
  %54 = shufflevector <2 x double> %18, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.mp = insertelement <2 x double> %54, double %i.kd, i64 0
  %55 = shufflevector <2 x double> %26, <2 x double> %i.kz, <2 x i32> <i32 0, i32 3>
  %i.mq = shufflevector <2 x double> %i.le, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.mr = insertelement <2 x double> %i.mq, double %i.ke, i64 0
  store double %46, ptr %i.ko, align 16, !tbaa !43
  %i.ms = shufflevector <2 x double> %i.la, <2 x double> poison, <2 x i32> zeroinitializer
  %56 = shufflevector <2 x double> %26, <2 x double> %i.la, <2 x i32> <i32 1, i32 2>
  %i.mt = shufflevector <2 x double> %i.lf, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %57 = insertelement <2 x double> %i.mt, double %13, i64 0
  %i.mu = insertelement <2 x double> %i.la, double %i.kk, i64 0
  %58 = shufflevector <2 x double> %i.lg, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.mv = insertelement <2 x double> %58, double %14, i64 0
  %59 = shufflevector <2 x double> %i.kw, <2 x double> %i.lb, <2 x i32> <i32 0, i32 2>
  %i.mw = shufflevector <2 x double> %i.lh, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.mx = insertelement <2 x double> %i.mw, double %15, i64 0
  %60 = shufflevector <2 x double> %27, <2 x double> %i.lb, <2 x i32> <i32 0, i32 3>
  %i.my = shufflevector <2 x double> %i.li, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.mz = insertelement <2 x double> %i.my, double %16, i64 0
  %61 = load <2 x double>, ptr %i.hu, align 16, !tbaa !43 ; 4 uses
  %62 = extractelement <2 x double> %61, i64 1
  %63 = call double @llvm.fmuladd.f64(double %i.lm, double %62, double %i.lu)
  %64 = call double @llvm.fmuladd.f64(double %i.ln, double %i.kc, double %63)
  %i.na = call double @llvm.fmuladd.f64(double %i.lo, double %i.kd, double %64)
  %65 = call double @llvm.fmuladd.f64(double %i.lp, double %i.ke, double %i.na)
  %i.nb = call double @llvm.fmuladd.f64(double %i.lq, double %13, double %65)
  %i.nc = call double @llvm.fmuladd.f64(double %i.lr, double %14, double %i.nb)
  %i.nd = call double @llvm.fmuladd.f64(double %i.ls, double %15, double %i.nc)
  %i.ne = call double @llvm.fmuladd.f64(double %i.lt, double %16, double %i.nd)
  store double %i.ne, ptr %i.kf, align 16, !tbaa !43
  %66 = shufflevector <2 x double> %i.ld, <2 x double> %61, <2 x i32> <i32 0, i32 2>
  %67 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.lw, <2 x double> %66, <2 x double> %23)
  %68 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ly, <2 x double> %17, <2 x double> %67)
  %i.nf = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ma, <2 x double> %18, <2 x double> %68)
  %i.ng = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mc, <2 x double> %i.le, <2 x double> %i.nf)
  %i.nh = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.me, <2 x double> %i.lf, <2 x double> %i.ng)
  %i.ni = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mg, <2 x double> %i.lg, <2 x double> %i.nh)
  %69 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mi, <2 x double> %i.lh, <2 x double> %i.ni)
  %70 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mk, <2 x double> %i.li, <2 x double> %69) ; 3 uses
  store <2 x double> %70, ptr %11, align 16, !tbaa !43
  %71 = insertelement <2 x double> poison, double %28, i64 0
  %72 = shufflevector <2 x double> %71, <2 x double> poison, <2 x i32> zeroinitializer
  %73 = insertelement <2 x double> %38, double %i.kb, i64 1
  %74 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %72, <2 x double> %73, <2 x double> zeroinitializer)
  %75 = shufflevector <2 x double> %61, <2 x double> %i.ld, <2 x i32> <i32 1, i32 2>
  %76 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mo, <2 x double> %75, <2 x double> %40)
  %77 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %49, <2 x double> %51, <2 x double> %76)
  %78 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %53, <2 x double> %i.mp, <2 x double> %77)
  %79 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %55, <2 x double> %i.mr, <2 x double> %78)
  %80 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %48, <2 x double> %61, <2 x double> %74)
  %81 = insertelement <2 x double> poison, double %i.ky, i64 0
  %82 = shufflevector <2 x double> %81, <2 x double> poison, <2 x i32> zeroinitializer
  %83 = insertelement <2 x double> %50, double %i.kc, i64 1
  %84 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %82, <2 x double> %83, <2 x double> %80)
  %i.nj = insertelement <2 x double> %54, double %i.kd, i64 1
  %i.nk = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %52, <2 x double> %i.nj, <2 x double> %84)
  %85 = shufflevector <2 x double> %i.kz, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %86 = insertelement <2 x double> %i.mq, double %i.ke, i64 1
  %87 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %85, <2 x double> %86, <2 x double> %i.nk)
  %i.nl = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %56, <2 x double> %57, <2 x double> %79)
  %88 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.mu, <2 x double> %i.mv, <2 x double> %i.nl)
  %89 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %59, <2 x double> %i.mx, <2 x double> %88)
  %i.nm = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %60, <2 x double> %i.mz, <2 x double> %89) ; 3 uses
  store <2 x double> %i.nm, ptr %i.kp, align 8, !tbaa !43
  %i.nn = insertelement <2 x double> %i.mt, double %13, i64 1
  %i.no = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ms, <2 x double> %i.nn, <2 x double> %87)
  %90 = shufflevector <2 x double> %i.la, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %91 = insertelement <2 x double> %58, double %14, i64 1
  %i.np = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %90, <2 x double> %91, <2 x double> %i.no)
  %92 = shufflevector <2 x double> %i.lb, <2 x double> poison, <2 x i32> zeroinitializer
  %93 = insertelement <2 x double> %i.mw, double %15, i64 1
  %i.nq = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %92, <2 x double> %93, <2 x double> %i.np)
  %94 = shufflevector <2 x double> %i.lb, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %95 = insertelement <2 x double> %i.my, double %16, i64 1
  %i.nr = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %94, <2 x double> %95, <2 x double> %i.nq) ; 7 uses
  store <2 x double> %i.nr, ptr %i.lc, align 8, !tbaa !43
  ...
  %96 = extractelement <2 x double> %i.nr, i64 0  ; 3 uses
  %foldExtExtBinop = fmul <2 x double> %i.nr, %i.nr ; 2 uses
  %97 = extractelement <2 x double> %70, i64 0    ; 3 uses
  %98 = fmul double %97, %46                      ; 2 uses
  %foldExtExtBinop.a = fmul <2 x double> %45, %45
  %i.ns = extractelement <2 x double> %foldExtExtBinop.a, i64 0 ; 2 uses
  %i.nt = extractelement <2 x double> %i.nm, i64 1 ; 3 uses
  %i.nu = fmul double %47, %i.nt                  ; 2 uses
  %i.nv = fmul double %i.nt, %i.nt                ; 2 uses
  %i.nw = fneg double %98
  %foldExtExtBinop170 = fmul <2 x double> %70, %foldExtExtBinop
  %99 = extractelement <2 x double> %foldExtExtBinop170, i64 0
  %100 = extractelement <2 x double> %i.nr, i64 1 ; 3 uses
  %i.nx = call double @llvm.fmuladd.f64(double %i.nw, double %100, double %99)
  %i.ny = call double @llvm.fmuladd.f64(double %i.ns, double %100, double %i.nx)
  %i.nz = fmul double %i.nu, -2.000000e+00
  %i.oa = call double @llvm.fmuladd.f64(double %i.nz, double %96, double %i.ny)
  %i.ob = call double @llvm.fmuladd.f64(double %i.nv, double %46, double %i.oa) ; 2 uses
...
bb.c:                                             ; preds = %bb.a
  %i.oq = fdiv double 1.000000e+00, %i.ob         ; 4 uses
  %i.or = fneg <2 x double> %45
  %i.os = shufflevector <2 x double> %i.nm, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %101 = fneg <2 x double> %45
  %102 = shufflevector <2 x double> %i.nr, <2 x double> %101, <2 x i32> <i32 0, i32 3>
  %i.ot = fmul <2 x double> %i.os, %102           ; 2 uses
  %103 = fneg double %i.nu
  %104 = call double @llvm.fmuladd.f64(double %97, double %96, double %103)
  %105 = extractelement <2 x double> %i.ot, i64 1
  %106 = call double @llvm.fmuladd.f64(double %47, double %96, double %105)
  %107 = fneg double %i.oq                        ; 2 uses
  %108 = shufflevector <2 x double> %i.nr, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %109 = shufflevector <2 x double> %i.ot, <2 x double> %foldExtExtBinop, <2 x i32> <i32 0, i32 2>
  %110 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.or, <2 x double> %108, <2 x double> %109)
  %111 = insertelement <2 x double> poison, double %107, i64 0
  %112 = insertelement <2 x double> %111, double %i.oq, i64 1
  %113 = fmul <2 x double> %110, %112
  %114 = fneg double %i.nv
  %115 = call double @llvm.fmuladd.f64(double %97, double %100, double %114)
  %116 = fneg double %115
  %117 = fmul double %i.oq, %116
  %118 = fsub double %98, %i.ns
  %119 = fneg double %118
  %120 = insertelement <3 x double> poison, double %i.oq, i64 0
  %121 = insertelement <3 x double> %120, double %106, i64 2
  %122 = shufflevector <3 x double> %121, <3 x double> poison, <3 x i32> <i32 0, i32 0, i32 2>
  %123 = insertelement <3 x double> poison, double %119, i64 0
  %124 = insertelement <3 x double> %123, double %104, i64 1
  %125 = insertelement <3 x double> %124, double %107, i64 2
  %i.ou = fmul <3 x double> %122, %125            ; 3 uses
  %126 = shufflevector <3 x double> %i.ou, <3 x double> poison, <3 x i32> <i32 1, i32 poison, i32 poison>
  %127 = insertelement <3 x double> %126, double %117, i64 1
  %128 = shufflevector <2 x double> %113, <2 x double> poison, <3 x i32> <i32 0, i32 1, i32 poison> ; 2 uses
  %129 = shufflevector <3 x double> %127, <3 x double> %128, <3 x i32> <i32 0, i32 1, i32 3>
  %130 = shufflevector <3 x double> %i.ou, <3 x double> poison, <3 x i32> <i32 2, i32 poison, i32 poison>
  %131 = shufflevector <3 x double> %130, <3 x double> %128, <3 x i32> <i32 0, i32 3, i32 4>
...
_ZN2cv5sqpnp10PoseSolver24analyticalInverse3x3SymmERKNS_4MatxIdLi3ELi3EEERS3_RKd.exit: ; preds = %bb.b, %bb.c
  %i.pc = phi double [ %.pre156, %bb.b ], [ %28, %bb.c ]
  %i.pd = phi <3 x double> [ %i.on, %bb.b ], [ %i.ou, %bb.c ]
  %i.pe = phi <3 x double> [ %i.oo, %bb.b ], [ %129, %bb.c ]
  %i.pf = phi <3 x double> [ %i.op, %bb.b ], [ %131, %bb.c ]
