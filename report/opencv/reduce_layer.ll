...
bb.l:                                             ; preds = %bb.i
  %i.m = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.n = load ptr, ptr %8, align 8, !tbaa !44     ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.v = load i32, ptr %11, align 4, !tbaa !98
...
bb.o:                                             ; preds = %.critedge, %bb.n
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_9ReduceSumIfEEEE, i64 16), ptr %12, align 8, !tbaa !31
  %i.x = getelementptr inbounds nuw i8, ptr %12, i64 8 ; 2 uses
  store ptr %0, ptr %i.x, align 8, !tbaa !117
  %i.y = getelementptr inbounds nuw i8, ptr %12, i64 16 ; 2 uses
  store ptr %1, ptr %i.y, align 8, !tbaa !117
...
vector.body75:                                    ; preds = %vector.body75, %vector.ph73
  ...
  %wide.load80 = load <4 x i32>, ptr %next.gep79, align 4, !tbaa !77
  %wide.load81 = load <4 x i32>, ptr %i.ak, align 4, !tbaa !77
  ...
  br i1 %i.an, label %middle.block83, label %vector.body75, !llvm.loop !1980
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader88, %.lr.ph.i.i
  ...
  %i.ap = load i32, ptr %.08.i.i, align 4, !tbaa !77
  ...
  br i1 %.not.i.i, label %.preheader.lr.ph.i, label %.lr.ph.i.i, !llvm.loop !1981
...
.preheader.lr.ph.i:                               ; preds = %.lr.ph.i.i, %middle.block83, %bb.q
  ...
  store i32 %.05.lcssa.i.i, ptr %i.at, align 8, !tbaa !1985
  %i.au = getelementptr inbounds nuw i8, ptr %12, i64 28
  store i32 %.05.lcssa.i.i, ptr %i.au, align 4, !tbaa !722
  %i.av = getelementptr inbounds nuw i8, ptr %12, i64 32
  store i32 1, ptr %i.av, align 8, !tbaa !1986
  %i.aw = getelementptr inbounds nuw i8, ptr %12, i64 36
  store i32 1, ptr %i.aw, align 4, !tbaa !1987
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #23
  %i.ax = load ptr, ptr %i.x, align 8, !tbaa !723, !nonnull !100, !align !122
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 24
  %i.az = load ptr, ptr %i.ay, align 8, !tbaa !123 ; 9 uses
  %i.ba = load ptr, ptr %i.y, align 8, !tbaa !724, !nonnull !100, !align !122
...
bb.s:                                             ; preds = %bb.s, %.preheader.us.preheader.i.new
  ...
  %i.bg = load float, ptr %i.bf, align 4, !tbaa !699
  ...
  %i.ci = load float, ptr %i.ch, align 4, !tbaa !699
  %i.cj = fadd float %i.cf, %i.ci                 ; 3 uses
  %indvars.iv.next.i.7 = add nuw nsw i64 %indvars.iv.i, 8 ; 2 uses
  %niter.next.7 = add i64 %niter, 8               ; 2 uses
  %niter.ncmp.7 = icmp eq i64 %niter.next.7, %unroll_iter
  br i1 %niter.ncmp.7, label %._crit_edge.us.i.unr-lcssa, label %bb.s, !llvm.loop !11
...
bb.t:                                             ; preds = %bb.t, %.epil.preheader
  ...
  %i.cl = load float, ptr %i.ck, align 4, !tbaa !699
  %i.cm = fadd float %.sroa.4.015.us.i.epil, %i.cl ; 2 uses
  %indvars.iv.next.i.epil = add nuw nsw i64 %indvars.iv.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %._crit_edge.us.i, label %bb.t, !llvm.loop !1982

._crit_edge.us.i:                                 ; preds = %bb.t, %._crit_edge.us.i.unr-lcssa
  %.lcssa = phi float [ %i.cj, %._crit_edge.us.i.unr-lcssa ], [ %i.cm, %bb.t ]
  %18 = bitcast float %.lcssa to i32
  br label %_ZNK2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_9ReduceSumIfEEEclERKNS_5RangeE.exit

_ZNK2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_9ReduceSumIfEEEclERKNS_5RangeE.exit: ; preds = %.preheader.lr.ph.i, %._crit_edge.us.i
  %storemerge = phi i32 [ %18, %._crit_edge.us.i ], [ 0, %.preheader.lr.ph.i ]
  store i32 %storemerge, ptr %i.bc, align 4
  call void @_ZN2cv16ParallelLoopBodyD2Ev(ptr noundef nonnull align 8 dead_on_return(40) dereferenceable(40) %12) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #23
  br label %bb.ao

bb.u:                                             ; preds = %bb.n
  %i.cn = load ptr, ptr %2, align 8, !tbaa !94    ; 2 uses
  %i.co = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 2 uses
  %i.cp = load ptr, ptr %i.co, align 8, !tbaa !94 ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.cu = load ptr, ptr %i.ct, align 8, !tbaa !123
...
bb.x:                                             ; preds = %bb.v
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_9ReduceSumIfEEEE, i64 16), ptr %13, align 8, !tbaa !31
  %i.cx = getelementptr inbounds nuw i8, ptr %13, i64 8
  store ptr %0, ptr %i.cx, align 8, !tbaa !117
  %i.cy = getelementptr inbounds nuw i8, ptr %13, i64 16
  store ptr %1, ptr %i.cy, align 8, !tbaa !117
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %next.gep, align 4, !tbaa !77
  %wide.load70 = load <4 x i32>, ptr %i.dk, align 4, !tbaa !77
  ...
  br i1 %i.dn, label %middle.block, label %vector.body, !llvm.loop !1983
...
.lr.ph.i.i35:                                     ; preds = %.lr.ph.i.i35.preheader92, %.lr.ph.i.i35
  ...
  %i.dp = load i32, ptr %.08.i.i36, align 4, !tbaa !77
  ...
  br i1 %.not.i.i38, label %_ZN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_9ReduceSumIfEEEC2ERKNS_3MatERS6_.exit40, label %.lr.ph.i.i35, !llvm.loop !1984
...
bb.ad:                                            ; preds = %bb.u
  ...
  br i1 %i.ec, label %.noexc.i.i, label %bb.ae, !prof !114
...
bb.ae:                                            ; preds = %bb.ad
  ...
  store ptr %i.ed, ptr %16, align 8, !tbaa !76
  ...
  store ptr %i.ef, ptr %i.eg, align 8, !tbaa !78
  %i.eh = load ptr, ptr %2, align 8, !tbaa !94    ; 3 uses
  %i.ei = load ptr, ptr %i.co, align 8, !tbaa !94
  %i.ej = ptrtoint ptr %i.ei to i64
  %i.ek = ptrtoint ptr %i.eh to i64
  %i.el = sub i64 %i.ej, %i.ek                    ; 4 uses
  %i.em = icmp sgt i64 %i.el, 4
  br i1 %i.em, label %bb.af, label %bb.ag, !prof !115
...
bb.ah:                                            ; preds = %bb.ag
  %i.eo = load i32, ptr %i.eh, align 4, !tbaa !77
  store i32 %i.eo, ptr %i.ed, align 4, !tbaa !77
  br label %_ZNSt6vectorIiSaIiEEC2ERKS1_.exit

_ZNSt6vectorIiSaIiEEC2ERKS1_.exit:                ; preds = %bb.af, %bb.ag, %bb.ah
  %i.ep = getelementptr inbounds i8, ptr %i.ed, i64 %i.el
  store ptr %i.ep, ptr %i.ee, align 8, !tbaa !75
...
_ZNSt6vectorIiSaIiEED2Ev.exit:                    ; preds = %bb.ai, %bb.aj
  ...
  %i.ew = load i32, ptr %i.ev, align 8, !tbaa !726 ; 2 uses
...
bb.o:                                             ; preds = %.critedge, %bb.n
  call void @llvm.lifetime.start.p0(ptr nonnull %12) #23
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_8ReduceL1IfEEEE, i64 16), ptr %12, align 8, !tbaa !31
  %i.x = getelementptr inbounds nuw i8, ptr %12, i64 8 ; 2 uses
  store ptr %0, ptr %i.x, align 8, !tbaa !117
  %i.y = getelementptr inbounds nuw i8, ptr %12, i64 16 ; 2 uses
  store ptr %1, ptr %i.y, align 8, !tbaa !117
...
vector.body75:                                    ; preds = %vector.body75, %vector.ph73
  ...
  %index.next82 = add nuw i64 %index76, 8         ; 2 uses
  %i.an = icmp eq i64 %index.next82, %n.vec74
  br i1 %i.an, label %middle.block83, label %vector.body75, !llvm.loop !1988
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader88, %.lr.ph.i.i
  ...
  %i.ar = getelementptr inbounds nuw i8, ptr %.08.i.i, i64 4 ; 2 uses
  %.not.i.i = icmp eq ptr %i.ar, %i.aa
  br i1 %.not.i.i, label %.preheader.lr.ph.i, label %.lr.ph.i.i, !llvm.loop !1989
...
.preheader.lr.ph.i:                               ; preds = %.lr.ph.i.i, %middle.block83, %bb.q
  ...
  %i.at = getelementptr inbounds nuw i8, ptr %12, i64 24
  store i32 %.05.lcssa.i.i, ptr %i.at, align 8, !tbaa !1992
  %i.au = getelementptr inbounds nuw i8, ptr %12, i64 28
  store i32 %.05.lcssa.i.i, ptr %i.au, align 4, !tbaa !730
  %i.av = getelementptr inbounds nuw i8, ptr %12, i64 32
  store i32 1, ptr %i.av, align 8, !tbaa !1993
  %i.aw = getelementptr inbounds nuw i8, ptr %12, i64 36
  store i32 1, ptr %i.aw, align 4, !tbaa !1994
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #23
  %i.ax = load ptr, ptr %i.x, align 8, !tbaa !731, !nonnull !100, !align !122
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 24
  %i.az = load ptr, ptr %i.ay, align 8, !tbaa !123 ; 3 uses
  %i.ba = load ptr, ptr %i.y, align 8, !tbaa !732, !nonnull !100, !align !122
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ba, i64 24
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !123
  %i.bd = icmp sgt i32 %.05.lcssa.i.i, 0
...
bb.s:                                             ; preds = %bb.s, %.preheader.us.preheader.i.new
  ...
  %i.bf = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %indvars.iv.i
  %i.bg = load float, ptr %i.bf, align 4, !tbaa !699 ; 3 uses
  ...
  %i.bn = load float, ptr %i.bm, align 4, !tbaa !699 ; 3 uses
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.us.i.unr-lcssa, label %bb.s, !llvm.loop !12
...
.epil.preheader:                                  ; preds = %._crit_edge.us.i.unr-lcssa, %.preheader.us.preheader.i
  ...
  %i.bt = load float, ptr %i.bs, align 4, !tbaa !699 ; 3 uses
...
._crit_edge.us.i:                                 ; preds = %._crit_edge.us.i.unr-lcssa, %.epil.preheader
  %.lcssa = phi float [ %i.br, %._crit_edge.us.i.unr-lcssa ], [ %i.bx, %.epil.preheader ]
  %18 = bitcast float %.lcssa to i32
  br label %_ZNK2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_8ReduceL1IfEEEclERKNS_5RangeE.exit

_ZNK2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_8ReduceL1IfEEEclERKNS_5RangeE.exit: ; preds = %.preheader.lr.ph.i, %._crit_edge.us.i
  %storemerge = phi i32 [ %18, %._crit_edge.us.i ], [ 0, %.preheader.lr.ph.i ]
  store i32 %storemerge, ptr %i.bc, align 4
  call void @_ZN2cv16ParallelLoopBodyD2Ev(ptr noundef nonnull align 8 dead_on_return(40) dereferenceable(40) %12) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #23
...
bb.t:                                             ; preds = %bb.n
  %i.by = load ptr, ptr %2, align 8, !tbaa !94    ; 2 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %2, i64 8 ; 2 uses
  %i.ca = load ptr, ptr %i.bz, align 8, !tbaa !94 ; 2 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.cd = load ptr, ptr %i.cc, align 8, !tbaa !123
  %i.ce = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.cf = load ptr, ptr %i.ce, align 8, !tbaa !123
...
bb.w:                                             ; preds = %bb.u
  call void @llvm.lifetime.start.p0(ptr nonnull %13) #23
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_8ReduceL1IfEEEE, i64 16), ptr %13, align 8, !tbaa !31
  %i.ci = getelementptr inbounds nuw i8, ptr %13, i64 8
  store ptr %0, ptr %i.ci, align 8, !tbaa !117
  %i.cj = getelementptr inbounds nuw i8, ptr %13, i64 16
  store ptr %1, ptr %i.cj, align 8, !tbaa !117
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #23
  invoke void @_ZN2cv8MatShapeC1ERKS0_(ptr noundef nonnull align 4 dereferenceable(52) %4, ptr noundef nonnull align 4 dereferenceable(52) %i.s)
...
.lr.ph.i.i35:                                     ; preds = %.lr.ph.i.i35.preheader92, %.lr.ph.i.i35
  ...
  %i.da = load i32, ptr %.08.i.i36, align 4, !tbaa !77
  ...
  br i1 %.not.i.i38, label %_ZN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_8ReduceL1IfEEEC2ERKNS_3MatERS6_.exit40, label %.lr.ph.i.i35, !llvm.loop !1991
...
_ZN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_8ReduceL1IfEEEC2ERKNS_3MatERS6_.exit40: ; preds = %.lr.ph.i.i35, %middle.block, %bb.y
  ...
  store i32 %.05.lcssa.i.i39, ptr %i.de, align 8, !tbaa !1992
  %i.df = getelementptr inbounds nuw i8, ptr %13, i64 28
  store i32 %.05.lcssa.i.i39, ptr %i.df, align 4, !tbaa !730
  %i.dg = getelementptr inbounds nuw i8, ptr %13, i64 32
  store i32 1, ptr %i.dg, align 8, !tbaa !1993
  %i.dh = getelementptr inbounds nuw i8, ptr %13, i64 36
  store i32 1, ptr %i.dh, align 4, !tbaa !1994
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #23
  call void @llvm.lifetime.start.p0(ptr nonnull %14) #23
  store i32 0, ptr %14, align 4, !tbaa !127
  %i.di = getelementptr inbounds nuw i8, ptr %14, i64 4
  store i32 1, ptr %i.di, align 4, !tbaa !128
  invoke void @_ZN2cv13parallel_for_ERKNS_5RangeERKNS_16ParallelLoopBodyEd(ptr noundef nonnull align 4 dereferenceable(8) %14, ptr noundef nonnull align 8 dereferenceable(8) %13, double noundef f0x3F50000000000000)
...
bb.ac:                                            ; preds = %bb.t
  ...
  br i1 %i.dn, label %.noexc.i.i, label %bb.ad, !prof !114
...
bb.ad:                                            ; preds = %bb.ac
  ...
  store ptr %i.do, ptr %16, align 8, !tbaa !76
  ...
  store ptr %i.dq, ptr %i.dr, align 8, !tbaa !78
  %i.ds = load ptr, ptr %2, align 8, !tbaa !94    ; 3 uses
  %i.dt = load ptr, ptr %i.bz, align 8, !tbaa !94
  %i.du = ptrtoint ptr %i.dt to i64
  %i.dv = ptrtoint ptr %i.ds to i64
  %i.dw = sub i64 %i.du, %i.dv                    ; 4 uses
  %i.dx = icmp sgt i64 %i.dw, 4
  br i1 %i.dx, label %bb.ae, label %bb.af, !prof !115
...
bb.ag:                                            ; preds = %bb.af
  %i.dz = load i32, ptr %i.ds, align 4, !tbaa !77
  store i32 %i.dz, ptr %i.do, align 4, !tbaa !77
  br label %_ZNSt6vectorIiSaIiEEC2ERKS1_.exit

_ZNSt6vectorIiSaIiEEC2ERKS1_.exit:                ; preds = %bb.ae, %bb.af, %bb.ag
  %i.ea = getelementptr inbounds i8, ptr %i.do, i64 %i.dw
  store ptr %i.ea, ptr %i.dp, align 8, !tbaa !75
...
_ZNSt6vectorIiSaIiEED2Ev.exit:                    ; preds = %bb.ah, %bb.ai
  ...
  %i.eh = load i32, ptr %i.eg, align 8, !tbaa !734 ; 2 uses
...
bb.o:                                             ; preds = %.critedge, %bb.n
  call void @llvm.lifetime.start.p0(ptr nonnull %12) #23
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_8ReduceL2IfEEEE, i64 16), ptr %12, align 8, !tbaa !31
  %i.x = getelementptr inbounds nuw i8, ptr %12, i64 8 ; 2 uses
  store ptr %0, ptr %i.x, align 8, !tbaa !117
  %i.y = getelementptr inbounds nuw i8, ptr %12, i64 16 ; 2 uses
  store ptr %1, ptr %i.y, align 8, !tbaa !117
...
vector.body75:                                    ; preds = %vector.body75, %vector.ph73
  ...
  %index.next82 = add nuw i64 %index76, 8         ; 2 uses
  %i.an = icmp eq i64 %index.next82, %n.vec74
  br i1 %i.an, label %middle.block83, label %vector.body75, !llvm.loop !1995
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader88, %.lr.ph.i.i
  ...
  %i.ar = getelementptr inbounds nuw i8, ptr %.08.i.i, i64 4 ; 2 uses
  %.not.i.i = icmp eq ptr %i.ar, %i.aa
  br i1 %.not.i.i, label %.preheader.lr.ph.i, label %.lr.ph.i.i, !llvm.loop !1996
...
.preheader.lr.ph.i:                               ; preds = %.lr.ph.i.i, %middle.block83, %bb.q
  %.05.lcssa.i.i = phi i32 [ 1, %bb.q ], [ %i.ao, %middle.block83 ], [ %i.aq, %.lr.ph.i.i ] ; 5 uses
  %i.at = getelementptr inbounds nuw i8, ptr %12, i64 24
  store i32 %.05.lcssa.i.i, ptr %i.at, align 8, !tbaa !2000
  %i.au = getelementptr inbounds nuw i8, ptr %12, i64 28
  store i32 %.05.lcssa.i.i, ptr %i.au, align 4, !tbaa !738
  %i.av = getelementptr inbounds nuw i8, ptr %12, i64 32
  store i32 1, ptr %i.av, align 8, !tbaa !2001
  %i.aw = getelementptr inbounds nuw i8, ptr %12, i64 36
  store i32 1, ptr %i.aw, align 4, !tbaa !2002
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #23
  %i.ax = load ptr, ptr %i.x, align 8, !tbaa !739, !nonnull !100, !align !122
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 24
  %i.az = load ptr, ptr %i.ay, align 8, !tbaa !123 ; 5 uses
  %i.ba = load ptr, ptr %i.y, align 8, !tbaa !740, !nonnull !100, !align !122
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ba, i64 24
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !123
  %i.bd = icmp sgt i32 %.05.lcssa.i.i, 0
...
bb.x:                                             ; preds = %bb.v
  call void @llvm.lifetime.start.p0(ptr nonnull %13) #23
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_8ReduceL2IfEEEE, i64 16), ptr %13, align 8, !tbaa !31
  %i.ci = getelementptr inbounds nuw i8, ptr %13, i64 8
  store ptr %0, ptr %i.ci, align 8, !tbaa !117
  %i.cj = getelementptr inbounds nuw i8, ptr %13, i64 16
  store ptr %1, ptr %i.cj, align 8, !tbaa !117
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.cy = icmp eq i64 %index.next, %n.vec
  br i1 %i.cy, label %middle.block, label %vector.body, !llvm.loop !1998
...
.lr.ph.i.i35:                                     ; preds = %.lr.ph.i.i35.preheader92, %.lr.ph.i.i35
  ...
  %i.dc = getelementptr inbounds nuw i8, ptr %.08.i.i36, i64 4 ; 2 uses
  %.not.i.i38 = icmp eq ptr %i.dc, %i.cl
  br i1 %.not.i.i38, label %_ZN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_8ReduceL2IfEEEC2ERKNS_3MatERS6_.exit40, label %.lr.ph.i.i35, !llvm.loop !1999
...
_ZN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_8ReduceL2IfEEEC2ERKNS_3MatERS6_.exit40: ; preds = %.lr.ph.i.i35, %middle.block, %bb.z
  ...
  %i.de = getelementptr inbounds nuw i8, ptr %13, i64 24
  store i32 %.05.lcssa.i.i39, ptr %i.de, align 8, !tbaa !2000
  %i.df = getelementptr inbounds nuw i8, ptr %13, i64 28
  store i32 %.05.lcssa.i.i39, ptr %i.df, align 4, !tbaa !738
  %i.dg = getelementptr inbounds nuw i8, ptr %13, i64 32
  store i32 1, ptr %i.dg, align 8, !tbaa !2001
  %i.dh = getelementptr inbounds nuw i8, ptr %13, i64 36
  store i32 1, ptr %i.dh, align 4, !tbaa !2002
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #23
  call void @llvm.lifetime.start.p0(ptr nonnull %14) #23
  store i32 0, ptr %14, align 4, !tbaa !127
  %i.di = getelementptr inbounds nuw i8, ptr %14, i64 4
...
bb.ad:                                            ; preds = %bb.u
  ...
  %i.dm = sub i64 %i.dk, %i.dl                    ; 3 uses
  %i.dn = icmp ugt i64 %i.dm, 9223372036854775804
  br i1 %i.dn, label %.noexc.i.i, label %bb.ae, !prof !114
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.dw = sub i64 %i.du, %i.dv                    ; 4 uses
  %i.dx = icmp sgt i64 %i.dw, 4
  br i1 %i.dx, label %bb.af, label %bb.ag, !prof !115
...
_ZNSt6vectorIiSaIiEED2Ev.exit:                    ; preds = %bb.ai, %bb.aj
  %i.eg = getelementptr inbounds nuw i8, ptr %15, i64 120
  %i.eh = load i32, ptr %i.eg, align 8, !tbaa !742 ; 2 uses
  %i.ei = sext i32 %i.eh to i64
end_hunk_2
...
bb.o:                                             ; preds = %.critedge, %bb.n
  call void @llvm.lifetime.start.p0(ptr nonnull %12) #23
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_15ReduceSumSquareIfEEEE, i64 16), ptr %12, align 8, !tbaa !31
  %i.x = getelementptr inbounds nuw i8, ptr %12, i64 8 ; 2 uses
  store ptr %0, ptr %i.x, align 8, !tbaa !117
  %i.y = getelementptr inbounds nuw i8, ptr %12, i64 16 ; 2 uses
  store ptr %1, ptr %i.y, align 8, !tbaa !117
...
vector.body75:                                    ; preds = %vector.body75, %vector.ph73
  ...
  %index.next82 = add nuw i64 %index76, 8         ; 2 uses
  %i.an = icmp eq i64 %index.next82, %n.vec74
  br i1 %i.an, label %middle.block83, label %vector.body75, !llvm.loop !2011
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader88, %.lr.ph.i.i
  ...
  %i.ar = getelementptr inbounds nuw i8, ptr %.08.i.i, i64 4 ; 2 uses
  %.not.i.i = icmp eq ptr %i.ar, %i.aa
  br i1 %.not.i.i, label %.preheader.lr.ph.i, label %.lr.ph.i.i, !llvm.loop !2012
...
.preheader.lr.ph.i:                               ; preds = %.lr.ph.i.i, %middle.block83, %bb.q
  %.05.lcssa.i.i = phi i32 [ 1, %bb.q ], [ %i.ao, %middle.block83 ], [ %i.aq, %.lr.ph.i.i ] ; 5 uses
  %i.at = getelementptr inbounds nuw i8, ptr %12, i64 24
  store i32 %.05.lcssa.i.i, ptr %i.at, align 8, !tbaa !2016
  %i.au = getelementptr inbounds nuw i8, ptr %12, i64 28
  store i32 %.05.lcssa.i.i, ptr %i.au, align 4, !tbaa !754
  %i.av = getelementptr inbounds nuw i8, ptr %12, i64 32
  store i32 1, ptr %i.av, align 8, !tbaa !2017
  %i.aw = getelementptr inbounds nuw i8, ptr %12, i64 36
  store i32 1, ptr %i.aw, align 4, !tbaa !2018
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #23
  %i.ax = load ptr, ptr %i.x, align 8, !tbaa !755, !nonnull !100, !align !122
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 24
  %i.az = load ptr, ptr %i.ay, align 8, !tbaa !123 ; 5 uses
  %i.ba = load ptr, ptr %i.y, align 8, !tbaa !756, !nonnull !100, !align !122
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ba, i64 24
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !123
  %i.bd = icmp sgt i32 %.05.lcssa.i.i, 0
...
bb.s:                                             ; preds = %bb.s, %.preheader.us.preheader.i.new
  ...
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %._crit_edge.us.i.unr-lcssa, label %bb.s, !llvm.loop !15
...
bb.t:                                             ; preds = %bb.t, %.epil.preheader
  ...
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %._crit_edge.us.i, label %bb.t, !llvm.loop !2013

._crit_edge.us.i:                                 ; preds = %bb.t, %._crit_edge.us.i.unr-lcssa
  %.lcssa = phi float [ %i.bt, %._crit_edge.us.i.unr-lcssa ], [ %i.bw, %bb.t ]
  %18 = bitcast float %.lcssa to i32
  br label %_ZNK2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_15ReduceSumSquareIfEEEclERKNS_5RangeE.exit

_ZNK2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_15ReduceSumSquareIfEEEclERKNS_5RangeE.exit: ; preds = %.preheader.lr.ph.i, %._crit_edge.us.i
  %storemerge = phi i32 [ %18, %._crit_edge.us.i ], [ 0, %.preheader.lr.ph.i ]
  store i32 %storemerge, ptr %i.bc, align 4
  call void @_ZN2cv16ParallelLoopBodyD2Ev(ptr noundef nonnull align 8 dead_on_return(40) dereferenceable(40) %12) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %12) #23
...
bb.u:                                             ; preds = %bb.n
  %i.bx = load ptr, ptr %2, align 8, !tbaa !94    ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.ce = load ptr, ptr %i.cd, align 8, !tbaa !123
...
bb.x:                                             ; preds = %bb.v
  call void @llvm.lifetime.start.p0(ptr nonnull %13) #23
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_15ReduceSumSquareIfEEEE, i64 16), ptr %13, align 8, !tbaa !31
  %i.ch = getelementptr inbounds nuw i8, ptr %13, i64 8
  store ptr %0, ptr %i.ch, align 8, !tbaa !117
  %i.ci = getelementptr inbounds nuw i8, ptr %13, i64 16
  store ptr %1, ptr %i.ci, align 8, !tbaa !117
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #23
  invoke void @_ZN2cv8MatShapeC1ERKS0_(ptr noundef nonnull align 4 dereferenceable(52) %4, ptr noundef nonnull align 4 dereferenceable(52) %i.s)
          to label %_ZN2cv3dnn14dnn5_v20260605L5shapeERKNS_3MatE.exit.i33 unwind label %bb.aa
...
.lr.ph.i.i35:                                     ; preds = %.lr.ph.i.i35.preheader92, %.lr.ph.i.i35
  ...
  %i.cz = load i32, ptr %.08.i.i36, align 4, !tbaa !77
  ...
  br i1 %.not.i.i38, label %_ZN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_15ReduceSumSquareIfEEEC2ERKNS_3MatERS6_.exit40, label %.lr.ph.i.i35, !llvm.loop !2015
...
_ZN2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_15ReduceSumSquareIfEEEC2ERKNS_3MatERS6_.exit40: ; preds = %.lr.ph.i.i35, %middle.block, %bb.z
  ...
  store i32 %.05.lcssa.i.i39, ptr %i.dd, align 8, !tbaa !2016
  %i.de = getelementptr inbounds nuw i8, ptr %13, i64 28
  store i32 %.05.lcssa.i.i39, ptr %i.de, align 4, !tbaa !754
  %i.df = getelementptr inbounds nuw i8, ptr %13, i64 32
  store i32 1, ptr %i.df, align 8, !tbaa !2017
  %i.dg = getelementptr inbounds nuw i8, ptr %13, i64 36
  store i32 1, ptr %i.dg, align 4, !tbaa !2018
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #23
  call void @llvm.lifetime.start.p0(ptr nonnull %14) #23
  store i32 0, ptr %14, align 4, !tbaa !127
  %i.dh = getelementptr inbounds nuw i8, ptr %14, i64 4
  store i32 1, ptr %i.dh, align 4, !tbaa !128
  invoke void @_ZN2cv13parallel_for_ERKNS_5RangeERKNS_16ParallelLoopBodyEd(ptr noundef nonnull align 4 dereferenceable(8) %14, ptr noundef nonnull align 8 dereferenceable(8) %13, double noundef f0x3F50000000000000)
          to label %bb.ab unwind label %bb.ac
...
bb.ad:                                            ; preds = %bb.u
  ...
  br i1 %i.dm, label %.noexc.i.i, label %bb.ae, !prof !114
...
bb.ae:                                            ; preds = %bb.ad
  ...
  store ptr %i.dn, ptr %16, align 8, !tbaa !76
  ...
  store ptr %i.dp, ptr %i.dq, align 8, !tbaa !78
  %i.dr = load ptr, ptr %2, align 8, !tbaa !94    ; 3 uses
  %i.ds = load ptr, ptr %i.by, align 8, !tbaa !94
  %i.dt = ptrtoint ptr %i.ds to i64
  %i.du = ptrtoint ptr %i.dr to i64
  %i.dv = sub i64 %i.dt, %i.du                    ; 4 uses
  %i.dw = icmp sgt i64 %i.dv, 4
  br i1 %i.dw, label %bb.af, label %bb.ag, !prof !115
...
bb.ah:                                            ; preds = %bb.ag
  %i.dy = load i32, ptr %i.dr, align 4, !tbaa !77
  store i32 %i.dy, ptr %i.dn, align 4, !tbaa !77
  br label %_ZNSt6vectorIiSaIiEEC2ERKS1_.exit

_ZNSt6vectorIiSaIiEEC2ERKS1_.exit:                ; preds = %bb.af, %bb.ag, %bb.ah
  %i.dz = getelementptr inbounds i8, ptr %i.dn, i64 %i.dv
  store ptr %i.dz, ptr %i.do, align 8, !tbaa !75
...
bb.ai:                                            ; preds = %_ZNSt6vectorIiSaIiEEC2ERKS1_.exit
  %i.ea = load ptr, ptr %16, align 8, !tbaa !76   ; 3 uses
  %.not.i.i.i = icmp eq ptr %i.ea, null
  br i1 %.not.i.i.i, label %_ZNSt6vectorIiSaIiEED2Ev.exit, label %bb.aj

bb.aj:                                            ; preds = %bb.ai
  %i.eb = load ptr, ptr %i.dq, align 8, !tbaa !78
...
_ZNSt6vectorIiSaIiEED2Ev.exit:                    ; preds = %bb.ai, %bb.aj
  ...
  %i.eg = load i32, ptr %i.ef, align 8, !tbaa !758 ; 2 uses
