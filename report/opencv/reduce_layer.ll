...
bb.t:                                             ; preds = %bb.t, %.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %_ZNK2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_9ReduceSumIfEEEclERKNS_5RangeE.exit, label %bb.t, !llvm.loop !1982
...
bb.t:                                             ; preds = %bb.t, %.epil.preheader
  ...
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %_ZNK2cv3dnn15ReduceLayerImpl16ReduceAllInvokerINS1_15ReduceSumSquareIfEEEclERKNS_5RangeE.exit, label %bb.t, !llvm.loop !2013
