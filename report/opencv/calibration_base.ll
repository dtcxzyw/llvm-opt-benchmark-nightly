...
bb.a:
  %i.a = tail call double @cos(double noundef %0) #20 ; 6 uses
  %i.b = tail call double @sin(double noundef %0) #20 ; 6 uses
  ...
  %i.ab = tail call double @llvm.fmuladd.f64(double %i.d, double 0.000000e+00, double 0.000000e+00) ; 3 uses
  %6 = insertelement <2 x double> %i.s, double %i.b, i64 1 ; 4 uses
  %i.ac = insertelement <2 x double> poison, double %i.ab, i64 0
  %7 = shufflevector <2 x double> %i.ac, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ad = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> zeroinitializer, <2 x double> %7) ; 2 uses
  %8 = shufflevector <2 x double> %i.p, <2 x double> %i.ad, <2 x i32> <i32 0, i32 2>
  %9 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.n, <2 x double> %i.o, <2 x double> %8) ; 21 uses
  ...
  %10 = shufflevector <2 x double> %i.ad, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.ag = insertelement <2 x double> %10, double %i.k, i64 1
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.bd = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bc, <2 x double> %9, <2 x double> %i.bb)
  ...
  %i.bg = shufflevector <2 x double> %i.ah, <2 x double> %9, <2 x i32> <i32 0, i32 2>
  ...
  %i.bm = shufflevector <2 x double> %9, <2 x double> %i.ah, <2 x i32> <i32 1, i32 2>
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ca = shufflevector <2 x double> %i.z, <2 x double> %9, <2 x i32> <i32 1, i32 3>
  ...
  %i.cd = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  ...
  %i.cl = shufflevector <2 x double> %9, <2 x double> %i.ah, <2 x i32> <i32 1, i32 2>
  ...
  %i.df = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.de, <2 x double> %9, <2 x double> %i.dd)
  %i.dg = shufflevector <2 x double> %9, <2 x double> <double poison, double 0.000000e+00>, <2 x i32> <i32 1, i32 3>
  ...
  %i.dj = shufflevector <2 x double> %i.ah, <2 x double> %9, <2 x i32> <i32 0, i32 2>
  ...
  %i.eb = shufflevector <2 x double> %9, <2 x double> %i.ea, <2 x i32> <i32 1, i32 2>
  ...
  %i.ef = shufflevector <2 x double> %9, <2 x double> %i.ea, <2 x i32> <i32 3, i32 1>
  ...
  %i.eo = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> zeroinitializer, <2 x double> %i.en)
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.fj = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> zeroinitializer, <2 x double> zeroinitializer)
  ...
  %i.fq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %6, <2 x double> zeroinitializer, <2 x double> %i.fp)
  %i.fr = insertelement <2 x double> %i.m, double %i.fd, i64 1
  %i.fs = shufflevector <2 x double> %6, <2 x double> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  ...
  %i.gd = shufflevector <2 x double> %9, <2 x double> %i.ah, <2 x i32> <i32 1, i32 2>
  ...
  %i.gz = shufflevector <2 x double> %i.ah, <2 x double> %9, <2 x i32> <i32 0, i32 2>
  ...
  %i.ho = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.hn, <2 x double> %9, <2 x double> %i.hi)
  ...
  %i.ib = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> zeroinitializer, <2 x double> %i.ia)
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.ip = fadd <2 x double> %9, %i.io             ; 2 uses
  ...
  %i.jb = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.jl = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> <i32 1, i32 1>
