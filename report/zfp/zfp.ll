...
begin_hunk_0_@zfp_stream_rewind:bb.a
bb.a:
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.ak = add nsw i32 %.0710, -2                  ; 2 uses
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  %i.ao = add nsw i32 %.0710, -2                  ; 2 uses
...
zfp_field_stride.exit:                            ; preds = %bb.a, %bb.b, %bb.c, %bb.d
  %i.m = phi i64 [ 1, %bb.c ], [ 1, %bb.b ], [ 1, %bb.a ], [ %i.l, %bb.d ]
  %i.n = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.o = load i64, ptr %i.n, align 8, !tbaa !14
  %.not.i = icmp eq i64 %i.o, 0
  br i1 %.not.i, label %zfp_field_dimensionality.exit, label %bb.e

bb.e:                                             ; preds = %zfp_field_stride.exit
  %i.p = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.q = load i64, ptr %i.p, align 8, !tbaa !16
  %.not4.i = icmp eq i64 %i.q, 0
  br i1 %.not4.i, label %zfp_field_dimensionality.exit, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.r = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.s = load i64, ptr %i.r, align 8, !tbaa !17
  %.not5.i = icmp eq i64 %i.s, 0
  br i1 %.not5.i, label %zfp_field_dimensionality.exit, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.t = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.u = load i64, ptr %i.t, align 8, !tbaa !18
  %.not6.i = icmp eq i64 %i.u, 0
  %i.v = select i1 %.not6.i, i64 2, i64 3
  br label %zfp_field_dimensionality.exit

zfp_field_dimensionality.exit:                    ; preds = %zfp_field_stride.exit, %bb.e, %bb.f, %bb.g
  %i.w = phi i64 [ 0, %bb.e ], [ 1, %bb.f ], [ %i.v, %bb.g ], [ 4294967295, %zfp_field_stride.exit ]
  %i.x = load i32, ptr %1, align 8, !tbaa !13
  %.off = add i32 %i.x, -1                        ; 2 uses
  %switch = icmp ult i32 %.off, 4
  br i1 %switch, label %bb.h, label %bb.j

bb.h:                                             ; preds = %zfp_field_dimensionality.exit
  %i.y = zext i32 %i.b to i64
  %i.z = getelementptr inbounds nuw [256 x i8], ptr @__const.zfp_compress.ftable, i64 %i.y
  %i.aa = getelementptr inbounds nuw [128 x i8], ptr %i.z, i64 %i.m
  %i.ab = getelementptr inbounds nuw [32 x i8], ptr %i.aa, i64 %i.w
  %i.ac = zext nneg i32 %.off to i64
...
bb.i:                                             ; preds = %bb.h
  tail call void %i.ae(ptr noundef nonnull %0, ptr noundef nonnull %1) #20
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !29
  %i.ah = tail call i64 @stream_flush(ptr noundef %i.ag) #20 ; 0 uses
  %i.ai = load ptr, ptr %i.af, align 8, !tbaa !29
  %i.aj = tail call i64 @stream_size(ptr noundef %i.ai) #20
  br label %bb.j

bb.j:                                             ; preds = %bb.h, %zfp_field_dimensionality.exit, %bb.i
  %.0 = phi i64 [ 0, %zfp_field_dimensionality.exit ], [ %i.aj, %bb.i ], [ 0, %bb.h ]
  ret i64 %.0
}

; Function Attrs: nounwind uwtable
define internal void @compress_int32_1(ptr noundef %0, ptr nofree noundef readonly captures(none) %1) #12 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 72
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !15   ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.d = load i64, ptr %i.c, align 8, !tbaa !14   ; 3 uses
  %i.e = and i64 %i.d, 4294967292                 ; 3 uses
  %.not = icmp eq i64 %i.e, 0
  br i1 %.not, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  %.017 = phi i64 [ %i.g, %.lr.ph ], [ 0, %bb.a ]
  %.01416 = phi ptr [ %i.h, %.lr.ph ], [ %i.b, %bb.a ] ; 2 uses
  %i.f = tail call i64 @zfp_encode_block_int32_1(ptr noundef %0, ptr noundef %.01416) #20 ; 0 uses
  %i.g = add nuw nsw i64 %.017, 4                 ; 2 uses
  %i.h = getelementptr inbounds nuw i8, ptr %.01416, i64 16 ; 2 uses
  %i.i = icmp samesign ult i64 %i.g, %i.e
  br i1 %i.i, label %.lr.ph, label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph, %bb.a
  %.014.lcssa = phi ptr [ %i.b, %bb.a ], [ %i.h, %.lr.ph ]
  %.not21 = icmp eq i64 %i.e, %i.d
  br i1 %.not21, label %bb.c, label %bb.b

bb.b:                                             ; preds = %._crit_edge
  %i.j = and i64 %i.d, -4294967293
  %i.k = tail call i64 @zfp_encode_partial_block_strided_int32_1(ptr noundef %0, ptr noundef %.014.lcssa, i64 noundef %i.j, i64 noundef 1) #20 ; 0 uses
  br label %bb.c
...
; Function Attrs: nounwind uwtable
define internal void @compress_int64_1(ptr noundef %0, ptr nofree noundef readonly captures(none) %1) #12 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 72
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !15   ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 8
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  %.017 = phi i64 [ %i.g, %.lr.ph ], [ 0, %bb.a ]
  %.01416 = phi ptr [ %i.h, %.lr.ph ], [ %i.b, %bb.a ] ; 2 uses
  %i.f = tail call i64 @zfp_encode_block_int64_1(ptr noundef %0, ptr noundef %.01416) #20 ; 0 uses
  %i.g = add nuw nsw i64 %.017, 4                 ; 2 uses
  %i.h = getelementptr inbounds nuw i8, ptr %.01416, i64 32 ; 2 uses
  %i.i = icmp samesign ult i64 %i.g, %i.e
  br i1 %i.i, label %.lr.ph, label %._crit_edge
...
bb.b:                                             ; preds = %._crit_edge
  %i.j = and i64 %i.d, -4294967293
  %i.k = tail call i64 @zfp_encode_partial_block_strided_int64_1(ptr noundef %0, ptr noundef %.014.lcssa, i64 noundef %i.j, i64 noundef 1) #20 ; 0 uses
  br label %bb.c
...
; Function Attrs: nounwind uwtable
define internal void @compress_float_1(ptr noundef %0, ptr nofree noundef readonly captures(none) %1) #12 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 72
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !15   ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 8
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  %.017 = phi i64 [ %i.g, %.lr.ph ], [ 0, %bb.a ]
  %.01416 = phi ptr [ %i.h, %.lr.ph ], [ %i.b, %bb.a ] ; 2 uses
  %i.f = tail call i64 @zfp_encode_block_float_1(ptr noundef %0, ptr noundef %.01416) #20 ; 0 uses
  %i.g = add nuw nsw i64 %.017, 4                 ; 2 uses
  %i.h = getelementptr inbounds nuw i8, ptr %.01416, i64 16 ; 2 uses
  %i.i = icmp samesign ult i64 %i.g, %i.e
  br i1 %i.i, label %.lr.ph, label %._crit_edge
...
bb.b:                                             ; preds = %._crit_edge
  %i.j = and i64 %i.d, -4294967293
  %i.k = tail call i64 @zfp_encode_partial_block_strided_float_1(ptr noundef %0, ptr noundef %.014.lcssa, i64 noundef %i.j, i64 noundef 1) #20 ; 0 uses
  br label %bb.c
end_hunk_0
