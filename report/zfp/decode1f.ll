...
decode_block_int32_1.exit.i:                      ; preds = %stream_skip.exit.i.i, %stream_read_bits.exit.i11
  ...
  %i.fm = load i32, ptr %i.a, align 256, !tbaa !19
  %2 = xor i32 %i.fm, -1431655766                 ; 2 uses
  %i.fn = load i32, ptr %i.ff, align 8, !tbaa !19
  %i.fo = xor i32 %i.fn, -1431655766              ; 2 uses
  %3 = load i32, ptr %i.fj, align 4, !tbaa !19
  %i.fp = xor i32 %3, -1431655766
  %i.fq = add i32 %i.fp, 1431655766               ; 2 uses
  %i.fr = ashr i32 %i.fq, 1
  %i.fs = add nsw i32 %i.fi, %i.fr                ; 3 uses
  %i.ft = ashr i32 %i.fs, 1
  %4 = sub nsw i32 %i.fq, %i.ft                   ; 2 uses
  %5 = add nsw i32 %4, %i.fs                      ; 2 uses
  %i.fu = sub nsw i32 %4, %i.fs                   ; 2 uses
  %i.fv = add i32 %2, -1431655764
  %i.fw = add i32 %i.fv, %i.fo                    ; 2 uses
  %i.fx = sub i32 %2, %i.fo                       ; 2 uses
  %i.fy = add nsw i32 %5, %i.fw
  %i.fz = sub nsw i32 %i.fw, %5
  %i.ga = add nsw i32 %i.fu, %i.fx
