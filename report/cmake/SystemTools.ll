Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/cmake/original/SystemTools?download=true
...
bb.j:                                             ; preds = %bb.o
  %i.af = sub nuw nsw i64 %.01937, %i.ag          ; 2 uses
...
bb.d:                                             ; preds = %.lr.ph, %bb.ai
  %.026117 = phi i64 [ 0, %.lr.ph ], [ %i.eg, %bb.ai ] ; 15 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i43: ; preds = %bb.q
  ...
  %spec.select.i.i.i = sub nuw i64 %6, %.026117   ; 4 uses
