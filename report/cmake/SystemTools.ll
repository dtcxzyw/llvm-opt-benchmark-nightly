...
bb.k:                                             ; preds = %.lr.ph, %bb.j
  ...
  %i.ag = call i64 @llvm.umin.i64(i64 %.02137, i64 4096) ; 6 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ab = icmp ugt i64 %.029117, %i.aa
  br i1 %i.ab, label %bb.f, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i

bb.f:                                             ; preds = %bb.e
  invoke void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.21, ptr noundef nonnull @.str.27, i64 noundef %.029117, i64 noundef %i.aa) #34
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i: ; preds = %bb.e
  ...
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 %.029117 ; 2 uses
  %i.af = sub nuw i64 %i.aa, %.029117             ; 4 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.bs = icmp ugt i64 %.029117, %i.br
  br i1 %i.bs, label %bb.r, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i43

bb.r:                                             ; preds = %bb.q
  invoke void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.21, ptr noundef nonnull @.str.27, i64 noundef %.029117, i64 noundef %i.br) #34
...
bb.z:                                             ; preds = %bb.p, %bb.o
  ...
  %i.cy = icmp ugt i64 %.029117, %i.cx
  br i1 %i.cy, label %bb.aa, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i60

bb.aa:                                            ; preds = %bb.z
  invoke void (ptr, ...) @_ZSt24__throw_out_of_range_fmtPKcz(ptr noundef nonnull @.str.21, ptr noundef nonnull @.str.27, i64 noundef %.029117, i64 noundef %i.cx) #34
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i60: ; preds = %bb.z
  %i.cz = sub i64 %i.z, %.029117
  store ptr %i.t, ptr %5, align 8, !tbaa !18, !alias.scope !189
  %i.da = load ptr, ptr %2, align 8, !tbaa !24, !noalias !189
  %i.db = getelementptr inbounds nuw i8, ptr %i.da, i64 %.029117 ; 2 uses
  %i.dc = sub nuw i64 %i.cx, %.029117
