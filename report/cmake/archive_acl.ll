...
.lr.ph347:                                        ; preds = %bb.d
  ...
  %i.d = load i32, ptr %1, align 4, !tbaa !36
...
bb.e:                                             ; preds = %.critedge.i, %.preheader333
  ...
  %i.e = load i32, ptr %.2235, align 4, !tbaa !36 ; 2 uses
...
bb.f:                                             ; preds = %.preheader
  ...
  %.pre = load i32, ptr %i.g, align 4, !tbaa !36
...
.preheader53.i:                                   ; preds = %.critedge2.i, %.preheader53.i.backedge
  ...
  %i.i = load i32, ptr %storemerge.i, align 4, !tbaa !36
...
bb.g:                                             ; preds = %.preheader.i
  ...
  %.pre362 = load i32, ptr %i.l, align 4, !tbaa !36
...
bb.h:                                             ; preds = %.critedge6.i
  ...
  store ptr %.2235, ptr %i.o, align 16, !tbaa !58
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 8
  store ptr %storemerge48.i, ptr %i.p, align 8, !tbaa !59
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %.critedge6.i
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.q = icmp eq i32 %i.m, 58
  br i1 %i.q, label %.preheader333, label %.preheader332, !llvm.loop !51
...
.lr.ph.preheader:                                 ; preds = %.preheader332
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %scevgep, i8 0, i64 %i.y, i1 false), !tbaa !38
  br label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph.preheader, %.preheader332
  %i.z = load ptr, ptr %3, align 16, !tbaa !58    ; 10 uses
...
bb.j:                                             ; preds = %._crit_edge
  %i.ad = load i32, ptr %i.z, align 4, !tbaa !36  ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  store ptr %i.ao, ptr %3, align 16, !tbaa !58
  br label %.thread
...
.thread:                                          ; preds = %bb.m, %bb.l, %bb.n, %bb.o, %bb.p, %bb.q
  ...
  %i.as = load ptr, ptr %i.ar, align 16, !tbaa !58 ; 4 uses
  %i.at = getelementptr inbounds nuw i8, ptr %i.aq, i64 24
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !59 ; 4 uses
...
.preheader.i155:                                  ; preds = %.thread, %bb.u
  ...
  %i.av = load i32, ptr %.01621.i, align 4, !tbaa !36 ; 3 uses
...
bb.u:                                             ; preds = %bb.t, %bb.s, %bb.r
  ...
  br i1 %i.be, label %.preheader.i155, label %isint_w.exit, !llvm.loop !52
...
bb.v:                                             ; preds = %isint_w.exit.thread
  ...
  %i.bj = load ptr, ptr %i.bi, align 16, !tbaa !58 ; 2 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %i.bi, i64 8
  %i.bl = load ptr, ptr %i.bk, align 8, !tbaa !59 ; 2 uses
...
.preheader.i159:                                  ; preds = %bb.v, %bb.z
  ...
  %i.bm = load i32, ptr %.01621.i161, align 4, !tbaa !36 ; 3 uses
...
bb.z:                                             ; preds = %bb.y, %bb.x, %bb.w
  ...
  br i1 %i.bv, label %.preheader.i159, label %isint_w.exit165, !llvm.loop !52
...
isint_w.exit165:                                  ; preds = %.preheader.i159, %bb.z, %bb.v, %isint_w.exit.thread, %isint_w.exit
  ...
  %i.bw = load ptr, ptr %i.aq, align 16, !tbaa !58 ; 4 uses
...
bb.aa:                                            ; preds = %isint_w.exit165
  ...
  %i.ce = load i32, ptr %i.bw, align 4, !tbaa !36
...
begin_hunk_1_@archive_acl_from_text_w:bb.a
  ...
  br i1 %i.fx, label %.preheader.i191, label %isint_w.exit197.thread, !llvm.loop !52
...
bb.ce:                                            ; preds = %bb.cd
  %i.gf = load i32, ptr %0, align 8, !tbaa !29
...
bb.cf:                                            ; preds = %bb.cd
  %i.gj = load i32, ptr %0, align 8, !tbaa !29
...
bb.cg:                                            ; preds = %bb.cd
  %i.gn = load i32, ptr %0, align 8, !tbaa !29
  %i.go = and i32 %i.gn, -8
...
bb.cj:                                            ; preds = %bb.ci
  %i.gt = load i32, ptr %.sroa.0.2312, align 4, !tbaa !36
...
is_nfs4_perms_w.exit.backedge:                    ; preds = %.preheader330, %.lr.ph.i, %.lr.ph.i186, %bb.au, %bb.av, %bb.at, %ismode_w.exit.thread258, %bb.ac, %bb.ae, %bb.ag, %bb.ai, %bb.aa, %bb.ab, %bb.ad, %bb.af, %bb.ah, %bb.cm, %bb.j, %isint_w.exit165, %.split, %.split278, %.split301, %.split302, %ismode_w.exit.thread, %.loopexit
  ...
  %i.ha = load i32, ptr %.6239, align 4, !tbaa !36
...
.critedge:                                        ; preds = %is_nfs4_perms_w.exit.backedge, %.lr.ph347, %bb.d
  ...
  %.012.i.i = load ptr, ptr %i.hb, align 8, !tbaa !30 ; 3 uses
...
.lr.ph.i.i:                                       ; preds = %.critedge, %.lr.ph.i.i
  ...
  %i.hd = load i32, ptr %i.hc, align 8, !tbaa !31
...
archive_acl_reset.exit:                           ; preds = %.lr.ph.i.i, %.critedge
  ...
  store i32 %spec.select.i, ptr %i.hk, align 8, !tbaa !28
  %i.hl = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %.012.i.i, ptr %i.hl, align 8, !tbaa !26
...
bb.e:                                             ; preds = %.lr.ph411, %is_nfs4_perms.exit.backedge
  ...
  %i.f = load i8, ptr %.0271404, align 1, !tbaa !35
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.critedge2.i
  ...
  %i.g = load i8, ptr %.2273, align 1, !tbaa !35  ; 2 uses
...
.lr.ph72.ithread-pre-split:                       ; preds = %bb.f
  ...
  %.pr = load i8, ptr %i.j, align 1, !tbaa !35
  br label %.lr.ph72.i
...
.lr.ph80.i:                                       ; preds = %.lr.ph80.i.preheader, %bb.g
  %.11282 = phi ptr [ %i.o, %bb.g ], [ %.10281, %.lr.ph80.i.preheader ] ; 7 uses
  %.11269 = phi i64 [ %i.p, %bb.g ], [ %i.l, %.lr.ph80.i.preheader ] ; 6 uses
  %i.n = load i8, ptr %.11282, align 1, !tbaa !35 ; 4 uses
...
bb.g:                                             ; preds = %.lr.ph80.i
  %i.o = getelementptr inbounds nuw i8, ptr %.11282, i64 1
  %i.p = add i64 %.11269, -1                      ; 2 uses
  %.not57.i = icmp eq i64 %i.p, 0
...
.lr.ph86.i:                                       ; preds = %.lr.ph86.i.preheader, %bb.h
  %.8279 = phi ptr [ %i.r, %bb.h ], [ %.11282, %.lr.ph86.i.preheader ] ; 4 uses
  %.8266 = phi i64 [ %i.s, %bb.h ], [ %.11269, %.lr.ph86.i.preheader ] ; 3 uses
  %i.q = load i8, ptr %.8279, align 1, !tbaa !35  ; 3 uses
...
bb.h:                                             ; preds = %.lr.ph86.i
  %i.r = getelementptr inbounds nuw i8, ptr %.8279, i64 1
  %i.s = add i64 %.8266, -1                       ; 2 uses
  %.not62.i = icmp eq i64 %i.s, 0
...
next_field.exit:                                  ; preds = %.lr.ph80.i, %.lr.ph80.i, %.lr.ph80.i, %.lr.ph86.i, %.lr.ph86.i, %.critedge6.i.thread, %..critedge8.i.loopexit_crit_edge
  ...
  %.0246 = phi i8 [ %.pre.pre, %..critedge8.i.loopexit_crit_edge ], [ %i.q, %.lr.ph86.i ], [ %.pr109.i, %.critedge6.i.thread ], [ %i.q, %.lr.ph86.i ], [ %i.n, %.lr.ph80.i ], [ %i.n, %.lr.ph80.i ], [ %i.n, %.lr.ph80.i ]
  ...
  %i.t = icmp samesign ult i64 %indvars.iv, %i.d
  br i1 %i.t, label %bb.i, label %bb.j

bb.i:                                             ; preds = %next_field.exit
  %i.u = getelementptr inbounds nuw [16 x i8], ptr %5, i64 %indvars.iv ; 2 uses
  store ptr %.2245485, ptr %i.u, align 16, !tbaa !71
  %i.v = getelementptr inbounds nuw i8, ptr %i.u, i64 8
  store ptr %.1242487, ptr %i.v, align 8, !tbaa !72
  br label %bb.j

bb.j:                                             ; preds = %bb.i, %next_field.exit
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.w = icmp eq i8 %.0246, 58
  br i1 %i.w, label %.preheader386, label %.preheader385, !llvm.loop !64

.preheader385:                                    ; preds = %bb.j
  %i.x = trunc nuw nsw i64 %indvars.iv to i32     ; 3 uses
  %i.y = trunc nuw i64 %indvars.iv.next to i32
  %i.z = icmp samesign ugt i32 %.0123, %i.y
  br i1 %i.z, label %.lr.ph.preheader, label %._crit_edge

.lr.ph.preheader:                                 ; preds = %.preheader385
  %i.aa = shl i64 %indvars.iv, 4
  %6 = getelementptr i8, ptr %5, i64 %i.aa
  %scevgep437 = getelementptr i8, ptr %6, i64 16
  %i.ab = sub nsw i64 %i.e, %indvars.iv
  %i.ac = shl i64 %i.ab, 4
  %i.ad = and i64 %i.ac, 68719476720
  %i.ae = add nuw nsw i64 %i.ad, 16
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %scevgep437, i8 0, i64 %i.ae, i1 false), !tbaa !37
  br label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph.preheader, %.preheader385
  %i.af = load ptr, ptr %5, align 16, !tbaa !71   ; 14 uses
  %i.ag = icmp eq ptr %i.af, null
  %i.ah = load ptr, ptr %i.c, align 8             ; 2 uses
  %i.ai = icmp eq ptr %i.ah, null
  %or.cond5 = select i1 %i.ag, i1 true, i1 %i.ai
  br i1 %or.cond5, label %archive_acl_add_entry_len_l.exit, label %bb.k

bb.k:                                             ; preds = %._crit_edge
  %i.aj = load i8, ptr %i.af, align 1, !tbaa !35  ; 2 uses
  %i.ak = icmp eq i8 %i.aj, 35
  br i1 %i.ak, label %is_nfs4_perms.exit.backedge, label %bb.l
...
bb.o:                                             ; preds = %bb.n
  %i.aq = icmp ugt i64 %i.an, 6
  br i1 %i.aq, label %bb.p, label %.thread

bb.p:                                             ; preds = %bb.o
  %i.ar = getelementptr inbounds nuw i8, ptr %i.af, i64 1 ; 2 uses
  %i.as = load i32, ptr %i.ar, align 1
  %i.at = xor i32 %i.as, 1969317477
  %i.au = getelementptr i8, ptr %i.ar, i64 4
  %i.av = load i16, ptr %i.au, align 1
  %i.aw = zext i16 %i.av to i32
  %i.ax = xor i32 %i.aw, 29804
...
bb.q:                                             ; preds = %bb.p
  %.not373 = icmp eq i64 %i.an, 7
  br i1 %.not373, label %.thread, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.bc = getelementptr inbounds nuw i8, ptr %i.af, i64 7
  store ptr %i.bc, ptr %5, align 16, !tbaa !71
  br label %.thread
...
.thread:                                          ; preds = %bb.n, %bb.m, %bb.o, %bb.p, %bb.q, %bb.r
  ...
  %i.bd = zext nneg i32 %.1120 to i64
  %i.be = getelementptr inbounds nuw [16 x i8], ptr %5, i64 %i.bd ; 4 uses
  %i.bf = getelementptr inbounds nuw i8, ptr %i.be, i64 16
  %i.bg = load ptr, ptr %i.bf, align 16, !tbaa !71 ; 4 uses
  %i.bh = getelementptr inbounds nuw i8, ptr %i.be, i64 24
  %i.bi = load ptr, ptr %i.bh, align 8, !tbaa !72 ; 4 uses
  %.not.i167 = icmp ult ptr %i.bg, %i.bi          ; 4 uses
...
.preheader.i:                                     ; preds = %.thread, %bb.v
  ...
  %.01621.i = phi ptr [ %i.bs, %bb.v ], [ %i.bg, %.thread ] ; 2 uses
  %i.bj = load i8, ptr %.01621.i, align 1, !tbaa !35 ; 3 uses
  %i.bk = add i8 %i.bj, -58
  %or.cond.i = icmp ult i8 %i.bk, -10
  br i1 %or.cond.i, label %isint.exit.thread, label %bb.s

bb.s:                                             ; preds = %.preheader.i
  %i.bl = icmp sgt i32 %.022.i, 214748364
  br i1 %i.bl, label %bb.v, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.bm = icmp eq i32 %.022.i, 214748364
  %i.bn = icmp samesign ugt i8 %i.bj, 55
  %or.cond19.i = and i1 %i.bm, %i.bn
  br i1 %or.cond19.i, label %bb.v, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.bo = mul nsw i32 %.022.i, 10
  %i.bp = zext nneg i8 %i.bj to i32
  %i.bq = add i32 %i.bo, -48
  %i.br = add i32 %i.bq, %i.bp
  br label %bb.v

bb.v:                                             ; preds = %bb.u, %bb.t, %bb.s
  %.1.i = phi i32 [ %i.br, %bb.u ], [ 2147483647, %bb.t ], [ 2147483647, %bb.s ] ; 3 uses
  %i.bs = getelementptr inbounds nuw i8, ptr %.01621.i, i64 1 ; 2 uses
  %exitcond.not.i = icmp eq ptr %i.bs, %i.bi
  br i1 %exitcond.not.i, label %isint.exit, label %.preheader.i, !llvm.loop !65

isint.exit:                                       ; preds = %bb.v
  %i.bt = icmp eq i32 %.1.i, -1
  br i1 %i.bt, label %isint.exit.thread, label %isint.exit177

isint.exit.thread:                                ; preds = %.preheader.i, %.thread, %isint.exit
  %i.bu = add nuw nsw i32 %.1120, 3               ; 2 uses
  %.not150 = icmp samesign ugt i32 %i.bu, %i.x
  br i1 %.not150, label %isint.exit177, label %bb.w

bb.w:                                             ; preds = %isint.exit.thread
  %i.bv = zext nneg i32 %i.bu to i64
  %i.bw = getelementptr inbounds nuw [16 x i8], ptr %5, i64 %i.bv ; 2 uses
  %i.bx = load ptr, ptr %i.bw, align 16, !tbaa !71 ; 2 uses
  %i.by = getelementptr inbounds nuw i8, ptr %i.bw, i64 8
  %i.bz = load ptr, ptr %i.by, align 8, !tbaa !72 ; 2 uses
  %.not.i168 = icmp ult ptr %i.bx, %i.bz
...
.preheader.i170:                                  ; preds = %bb.w, %bb.aa
  ...
  %.01621.i172 = phi ptr [ %i.cj, %bb.aa ], [ %i.bx, %bb.w ] ; 2 uses
  %i.ca = load i8, ptr %.01621.i172, align 1, !tbaa !35 ; 3 uses
  %i.cb = add i8 %i.ca, -58
  %or.cond.i173 = icmp ult i8 %i.cb, -10
  br i1 %or.cond.i173, label %isint.exit177, label %bb.x

bb.x:                                             ; preds = %.preheader.i170
  %i.cc = icmp sgt i32 %.022.i171, 214748364
  br i1 %i.cc, label %bb.aa, label %bb.y

bb.y:                                             ; preds = %bb.x
  %i.cd = icmp eq i32 %.022.i171, 214748364
  %i.ce = icmp samesign ugt i8 %i.ca, 55
  %or.cond19.i174 = and i1 %i.cd, %i.ce
  br i1 %or.cond19.i174, label %bb.aa, label %bb.z

bb.z:                                             ; preds = %bb.y
  %i.cf = mul nsw i32 %.022.i171, 10
  %i.cg = zext nneg i8 %i.ca to i32
  %i.ch = add i32 %i.cf, -48
  %i.ci = add i32 %i.ch, %i.cg
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %bb.y, %bb.x
  %.1.i175 = phi i32 [ %i.ci, %bb.z ], [ 2147483647, %bb.y ], [ 2147483647, %bb.x ] ; 2 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %.01621.i172, i64 1 ; 2 uses
  %exitcond.not.i176 = icmp eq ptr %i.cj, %i.bz
...
isint.exit177:                                    ; preds = %.preheader.i170, %bb.aa, %bb.w, %isint.exit.thread, %isint.exit
  ...
  %i.ck = load ptr, ptr %i.be, align 16, !tbaa !71 ; 4 uses
  %i.cl = getelementptr inbounds nuw i8, ptr %i.ck, i64 1 ; 6 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %i.be, i64 8
  %i.cn = load ptr, ptr %i.cm, align 8, !tbaa !72 ; 2 uses
  %i.co = ptrtoint ptr %i.cn to i64
  %i.cp = ptrtoint ptr %i.ck to i64
  %i.cq = sub i64 %i.co, %i.cp                    ; 4 uses
  %i.cr = icmp eq ptr %i.cn, %i.ck
  br i1 %i.cr, label %is_nfs4_perms.exit.backedge, label %bb.ab

bb.ab:                                            ; preds = %isint.exit177
  %i.cs = load i8, ptr %i.ck, align 1, !tbaa !35
  switch i8 %i.cs, label %is_nfs4_perms.exit.backedge [
    i8 117, label %bb.ac
    i8 103, label %bb.ae
    i8 111, label %bb.ag
    i8 109, label %bb.ai
...
bb.ac:                                            ; preds = %bb.ab
  switch i64 %i.cq, label %is_nfs4_perms.exit.backedge [
    i64 1, label %bb.ap
    i64 4, label %bb.ad
  ]
