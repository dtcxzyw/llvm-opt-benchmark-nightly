...
.lr.ph:                                           ; preds = %bb.c, %.lr.ph
  ...
  %4 = zext i8 %i.w to i32                        ; 2 uses
  %5 = or disjoint i32 %i.u, %4
  %i.x = or disjoint i32 %i.u, %i.q
  %i.y = lshr i32 %i.p, 2
  %i.z = lshr i32 %i.x, 12
  %i.aa = lshr i32 %5, 6
  %i.ab = insertelement <4 x i32> poison, i32 %i.y, i64 0
  %i.ac = insertelement <4 x i32> %i.ab, i32 %i.z, i64 1
  %i.ad = insertelement <4 x i32> %i.ac, i32 %i.aa, i64 2
  %i.ae = insertelement <4 x i32> %i.ad, i32 %4, i64 3
