...
bb.ex:                                            ; preds = %bb.ew, %bb.ev, %.lr.ph45.i.i.i
  ...
  br i1 %i.aki, label %.lr.ph45.i.i.i, label %tr_copy.exit.i.i, !llvm.loop !77
...
bb.ez:                                            ; preds = %bb.ey
  ...
  store i32 -1, ptr %i.akm, align 8, !tbaa !74
  br label %bb.fa
...
.lr.ph.i550.i.i:                                  ; preds = %bb.fa, %bb.fd
  ...
  %i.akx = load i32, ptr %.07291.i.i.i, align 4, !tbaa !9 ; 2 uses
...
bb.fb:                                            ; preds = %.lr.ph.i550.i.i
  ...
  %i.alc = load i32, ptr %i.alb, align 4, !tbaa !9
...
bb.fc:                                            ; preds = %bb.fb
  ...
  store i32 %i.aky, ptr %i.ale, align 4, !tbaa !9
  %i.alf = sext i32 %i.akx to i64
  %i.alg = getelementptr inbounds [4 x i8], ptr %i.cb, i64 %i.alf
  %i.alh = load i32, ptr %i.alg, align 4, !tbaa !9 ; 2 uses
  ...
  store i32 %.1.i.i.i308, ptr %i.alb, align 4, !tbaa !9
  br label %bb.fd
...
bb.fd:                                            ; preds = %bb.fc, %bb.fb, %.lr.ph.i550.i.i
  ...
  br i1 %.not.i551.i.i, label %.preheader.i.i.i, label %.lr.ph.i550.i.i, !llvm.loop !78
...
.lr.ph99.i.i.i:                                   ; preds = %.preheader.i.i.i, %bb.ff
  ...
  %i.aln = load i32, ptr %.07496.i.i.i, align 4, !tbaa !9
  %i.alo = sext i32 %i.aln to i64
  %i.alp = getelementptr inbounds [4 x i8], ptr %i.cb, i64 %i.alo ; 2 uses
  %i.alq = load i32, ptr %i.alp, align 4, !tbaa !9 ; 3 uses
...
bb.fe:                                            ; preds = %.lr.ph99.i.i.i
  store i32 %.4.i.i.i, ptr %i.alp, align 4, !tbaa !9
  br label %bb.ff
...
bb.ff:                                            ; preds = %bb.fe, %.lr.ph99.i.i.i
  ...
  br i1 %.not84.i.i.i, label %._crit_edge.i552.i.i, label %.lr.ph99.i.i.i, !llvm.loop !79
...
._crit_edge.i552.i.i:                             ; preds = %bb.ff, %.preheader.i.i.i
  ...
  br i1 %i.alx, label %.lr.ph107.i.i.i, label %tr_copy.exit.i.i
...
.lr.ph107.i.i.i:                                  ; preds = %._crit_edge.i552.i.i, %bb.fi
  ...
  %i.aly = load i32, ptr %.173105.i.i.i, align 4, !tbaa !9 ; 2 uses
...
bb.fg:                                            ; preds = %.lr.ph107.i.i.i
  ...
  %i.amd = load i32, ptr %i.amc, align 4, !tbaa !9
...
bb.fh:                                            ; preds = %bb.fg
  ...
  store i32 %i.alz, ptr %i.amf, align 4, !tbaa !9
  %i.amg = sext i32 %i.aly to i64
  %i.amh = getelementptr inbounds [4 x i8], ptr %i.cb, i64 %i.amg
  %i.ami = load i32, ptr %i.amh, align 4, !tbaa !9 ; 2 uses
  ...
  store i32 %.6.i.i.i, ptr %i.amc, align 4, !tbaa !9
  br label %bb.fi
...
bb.fi:                                            ; preds = %bb.fh, %bb.fg, %.lr.ph107.i.i.i
  ...
  br i1 %i.amn, label %.lr.ph107.i.i.i, label %tr_copy.exit.i.i, !llvm.loop !80

tr_copy.exit.i.i:                                 ; preds = %bb.fi, %bb.ex, %._crit_edge.i552.i.i, %._crit_edge.i.i.i
  %i.amo = icmp eq i32 %i.ain, 0
  br i1 %i.amo, label %tr_introsort.exit.i, label %bb.fj
...
bb.fj:                                            ; preds = %tr_copy.exit.i.i
  ...
  %i.ams = load ptr, ptr %i.amr, align 16, !tbaa !68
  %i.amt = getelementptr inbounds nuw i8, ptr %i.amr, i64 8
  %i.amu = load ptr, ptr %i.amt, align 8, !tbaa !72
  %i.amv = getelementptr inbounds nuw i8, ptr %i.amr, i64 16
  %i.amw = load ptr, ptr %i.amv, align 16, !tbaa !73
  %i.amx = getelementptr inbounds nuw i8, ptr %i.amr, i64 24
  %i.amy = load i32, ptr %i.amx, align 8, !tbaa !74
  %i.amz = getelementptr inbounds nuw i8, ptr %i.amr, i64 28
  %i.ana = load i32, ptr %i.amz, align 4, !tbaa !75
  br label %.outer.i.i.backedge

._crit_edge.thread.i.i299:                        ; preds = %.critedge2.i.i, %bb.bx, %tr_heapsort.exit.i.i, %._crit_edge.i.i305, %.lr.ph646.split.us.i.i
  %i.anb = load i32, ptr %.0455.ph.i.i, align 4, !tbaa !9 ; 2 uses
...
.preheader.i:                                     ; preds = %._crit_edge.thread.i.i299, %bb.fk
  ...
  store i32 %i.ani, ptr %i.ank, align 4, !tbaa !9
...
bb.fk:                                            ; preds = %.preheader.i
  %i.ann = load i32, ptr %i.anl, align 4, !tbaa !9 ; 2 uses
  %i.ano = icmp sgt i32 %i.ann, -1
  br i1 %i.ano, label %.preheader.i, label %.critedge.i.i300, !llvm.loop !81
...
.critedge.i.i300:                                 ; preds = %bb.fk, %.preheader.i, %._crit_edge.thread.i.i299
  ...
  br i1 %i.anp, label %bb.fl, label %bb.gh

bb.fl:                                            ; preds = %.critedge.i.i300
  %.pre.i.i301 = load i32, ptr %.1456.i.i, align 4, !tbaa !9
  br label %bb.fm
...
bb.fm:                                            ; preds = %bb.fm, %bb.fl
  ...
  store i32 %i.ans, ptr %i.anr, align 4, !tbaa !9
  %i.ant = getelementptr inbounds nuw i8, ptr %i.anr, i64 4 ; 3 uses
  %i.anu = load i32, ptr %i.ant, align 4, !tbaa !9 ; 3 uses
  %i.anv = icmp slt i32 %i.anu, 0
  br i1 %i.anv, label %bb.fm, label %bb.fn, !llvm.loop !82
...
bb.fn:                                            ; preds = %bb.fm
  ...
  %i.aoa = load i32, ptr %i.anz, align 4, !tbaa !9
  %.not517.i.i = icmp eq i32 %i.any, %i.aoa
  br i1 %.not517.i.i, label %tr_ilg.exit556.i.i, label %bb.fo
...
bb.fq:                                            ; preds = %bb.fp
  ...
  %i.aoj = getelementptr inbounds nuw [4 x i8], ptr @lg_table, i64 %i.aoi
  %i.aok = load i32, ptr %i.aoj, align 4, !tbaa !9
...
bb.fr:                                            ; preds = %bb.fp
  ...
  %i.aop = load i32, ptr %i.aoo, align 4, !tbaa !9
...
bb.ft:                                            ; preds = %bb.fs
  ...
  %i.aot = getelementptr inbounds nuw [4 x i8], ptr @lg_table, i64 %i.aos
  %i.aou = load i32, ptr %i.aot, align 4, !tbaa !9
  %i.aov = add nsw i32 %i.aou, 8
  br label %tr_ilg.exit556.i.i

bb.fu:                                            ; preds = %bb.fs
  %i.aow = zext nneg i32 %i.aog to i64
  %i.aox = getelementptr inbounds nuw [4 x i8], ptr @lg_table, i64 %i.aow
  %i.aoy = load i32, ptr %i.aox, align 4, !tbaa !9
  br label %tr_ilg.exit556.i.i

tr_ilg.exit556.i.i:                               ; preds = %bb.fu, %bb.ft, %bb.fr, %bb.fq, %bb.fn
  ...
  br i1 %i.apb, label %bb.fv, label %tr_ilg.exit556._crit_edge.i.i

bb.fv:                                            ; preds = %tr_ilg.exit556.i.i
  ...
  br i1 %6, label %.lr.ph685.i.i, label %tr_ilg.exit556._crit_edge.i.i

.lr.ph685.i.i:                                    ; preds = %bb.fv, %.lr.ph685.i.i
  %i.aph = phi ptr [ %i.apl, %.lr.ph685.i.i ], [ %.1456.i.i, %bb.fv ] ; 2 uses
  %i.api = load i32, ptr %i.aph, align 4, !tbaa !9
  %i.apj = sext i32 %i.api to i64
  %i.apk = getelementptr inbounds [4 x i8], ptr %i.cb, i64 %i.apj
  store i32 %i.apg, ptr %i.apk, align 4, !tbaa !9
  %i.apl = getelementptr inbounds nuw i8, ptr %i.aph, i64 4 ; 2 uses
  %i.apm = icmp ult ptr %i.apl, %i.apa
  br i1 %i.apm, label %.lr.ph685.i.i, label %tr_ilg.exit556._crit_edge.i.i, !llvm.loop !83

tr_ilg.exit556._crit_edge.i.i:                    ; preds = %.lr.ph685.i.i, %bb.fv, %tr_ilg.exit556.i.i
  ...
  br i1 %.not.i557.i.i, label %bb.fw, label %bb.fy

bb.fw:                                            ; preds = %tr_ilg.exit556._crit_edge.i.i
...
bb.fy:                                            ; preds = %bb.fx, %tr_ilg.exit556._crit_edge.i.i
  %.pn221.i = phi i32 [ %i.aps, %bb.fx ], [ %.sroa.9.3.i, %tr_ilg.exit556._crit_edge.i.i ]
  %.sroa.0.7.i = phi i32 [ %i.apt, %bb.fx ], [ %.sroa.0.3.i, %tr_ilg.exit556._crit_edge.i.i ] ; 3 uses
  %.sroa.9.7.i = sub i32 %.pn221.i, %i.apq        ; 3 uses
...
bb.gd:                                            ; preds = %bb.gc
  ...
  store i32 -1, ptr %i.aqr, align 8, !tbaa !74
  br label %bb.ge
...
bb.gi:                                            ; preds = %bb.gh
  ...
  %i.arm = load ptr, ptr %i.arl, align 16, !tbaa !68
  %i.arn = getelementptr inbounds nuw i8, ptr %i.arl, i64 8
  %i.aro = load ptr, ptr %i.arn, align 8, !tbaa !72
  %i.arp = getelementptr inbounds nuw i8, ptr %i.arl, i64 16
  %i.arq = load ptr, ptr %i.arp, align 16, !tbaa !73
  %i.arr = getelementptr inbounds nuw i8, ptr %i.arl, i64 24
  %i.ars = load i32, ptr %i.arr, align 8, !tbaa !74
  %i.art = getelementptr inbounds nuw i8, ptr %i.arl, i64 28
  %i.aru = load i32, ptr %i.art, align 4, !tbaa !75
  br label %.outer.i.i.backedge

.lr.ph650.i.i:                                    ; preds = %.lr.ph646.split.i.i
  br i1 %i.tk, label %bb.gj, label %._crit_edge72.i.i.i

bb.gj:                                            ; preds = %.lr.ph650.i.i
  %i.arv = load i32, ptr %i.to, align 4, !tbaa !9 ; 2 uses
  %i.arw = sext i32 %i.arv to i64
  %i.arx = getelementptr inbounds [4 x i8], ptr %.0452.ph.i.i, i64 %i.arw
  %i.ary = load i32, ptr %i.arx, align 4, !tbaa !9
  %i.arz = load i32, ptr %i.tq, align 4, !tbaa !9 ; 2 uses
  %i.asa = sext i32 %i.arz to i64
  %i.asb = getelementptr inbounds [4 x i8], ptr %.0452.ph.i.i, i64 %i.asa
  %i.asc = load i32, ptr %i.asb, align 4, !tbaa !9
  %i.asd = icmp slt i32 %i.ary, %i.asc
  br i1 %i.asd, label %bb.gk, label %._crit_edge72.i.i.i

bb.gk:                                            ; preds = %bb.gj
  store i32 %i.arv, ptr %i.tq, align 4, !tbaa !9
  store i32 %i.arz, ptr %i.to, align 4, !tbaa !9
  br label %._crit_edge72.i.i.i

._crit_edge72.i.i.i:                              ; preds = %bb.gk, %bb.gj, %.lr.ph650.i.i
  %.0.i565.i.i = phi i32 [ %i.tl, %bb.gk ], [ %i.tl, %bb.gj ], [ %i.ti, %.lr.ph650.i.i ] ; 8 uses
...
.lr.ph.i568.i.i:                                  ; preds = %tr_fixdown.exit.i.i.i, %.lr.ph.preheader.i.i.i
  ...
  br i1 %i.asp, label %.lr.ph.i.preheader.i.i.i, label %tr_fixdown.exit.i.i.i
...
.lr.ph.i.i.i.i304:                                ; preds = %bb.gl, %.lr.ph.i.preheader.i.i.i
  %i.ast = phi i32 [ %i.atp, %bb.gl ], [ %i.asr, %.lr.ph.i.preheader.i.i.i ] ; 2 uses
  %i.asu = phi i32 [ %i.ato, %bb.gl ], [ %i.ass, %.lr.ph.i.preheader.i.i.i ]
  %.030.i.i.i.i = phi i32 [ %spec.select.i.i.i.i, %bb.gl ], [ %i.asq, %.lr.ph.i.preheader.i.i.i ] ; 2 uses
