...
bb.c:                                             ; preds = %.lr.ph.i
  ...
  br i1 %exitcond.not.i, label %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE6substrEmm.exit.i, label %.lr.ph.i, !llvm.loop !9
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE6substrEmm.exit.i: ; preds = %bb.c, %.lr.ph.i
  ...
  %i.g = tail call i64 @llvm.umin.i64(i64 %.sroa.01.0.copyload, i64 %.0104.lcssa.ph.i) ; 2 uses
  %.sroa.speculated.i.i = sub nuw i64 %i.g, %.086.i44 ; 3 uses
  %i.h = sub i64 %0, %.094.i38
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i.i: ; preds = %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE6substrEmm.exit.i.i.i
  ...
  %bcmp.i.i = tail call i32 @bcmp(ptr readonly %i.k, ptr nonnull readonly %i.b, i64 %.sroa.speculated.i.i)
...
.backedge.i:                                      ; preds = %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit.thread.i, %_ZN12_GLOBAL__N_114LiteralMatchesESt17basic_string_viewIcSt11char_traitsIcEEmS3_.exit153.i, %.preheader.i, %bb.s, %_ZN12_GLOBAL__N_114LiteralMatchesESt17basic_string_viewIcSt11char_traitsIcEEmS3_.exit144.i, %bb.f
  %.094.be.i = phi i64 [ %i.m, %bb.f ], [ %i.ef, %_ZN12_GLOBAL__N_114LiteralMatchesESt17basic_string_viewIcSt11char_traitsIcEEmS3_.exit144.i ], [ %i.gd, %_ZN12_GLOBAL__N_114LiteralMatchesESt17basic_string_viewIcSt11char_traitsIcEEmS3_.exit153.i ], [ %0, %bb.s ], [ %i.fd, %.preheader.i ], [ %0, %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit.thread.i ] ; 2 uses
...
.lr.ph275.i:                                      ; preds = %bb.j, %.lr.ph275.preheader.i
  ...
  %i.dh = load i8, ptr %i.dg, align 1, !tbaa !20
...
bb.j:                                             ; preds = %.lr.ph275.i
  ...
  %exitcond308.not.i.a = icmp eq i64 %i.di, %.sroa.01.0.copyload
  br i1 %exitcond308.not.i.a, label %.critedge3.i, label %.lr.ph275.i, !llvm.loop !10
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE6substrEmm.exit137.i: ; preds = %.critedge3.i
  %i.dk = tail call i64 @llvm.umin.i64(i64 %.sroa.01.0.copyload, i64 %.0116.lcssa.ph.i) ; 2 uses
  %.sroa.speculated.i134.i = sub nuw i64 %i.dk, %i.de ; 3 uses
  %i.dl = getelementptr inbounds nuw i8, ptr %.sroa.22.0.copyload, i64 %i.de ; 3 uses
  %i.dm = icmp ne i64 %i.dk, %i.de                ; 4 uses
...
bb.l:                                             ; preds = %bb.m
  ...
  br i1 %exitcond309.not.i, label %bb.n, label %bb.m, !llvm.loop !11
...
bb.n:                                             ; preds = %bb.l
  %i.ea = add i64 %i.dr, %.094.i38                ; 6 uses
  br i1 %i.dp, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  %.not126.i = icmp eq i64 %i.ea, %0
  br i1 %.not126.i, label %bb.s, label %.critedge, !llvm.loop !12
...
bb.q:                                             ; preds = %bb.p
  ...
  br i1 %i.ec, label %bb.r, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i141.i
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i141.i: ; preds = %bb.q
  %i.ed = getelementptr inbounds nuw i8, ptr %1, i64 %i.ea
  %bcmp.i142.i = tail call i32 @bcmp(ptr readonly %i.ed, ptr nonnull readonly %i.dq, i64 %.sroa.speculated.i134341.i)
  %i.ee = icmp eq i32 %bcmp.i142.i, 0
  br i1 %i.ee, label %_ZN12_GLOBAL__N_114LiteralMatchesESt17basic_string_viewIcSt11char_traitsIcEEmS3_.exit144.i, label %.critedge

_ZN12_GLOBAL__N_114LiteralMatchesESt17basic_string_viewIcSt11char_traitsIcEEmS3_.exit144.i: ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i141.i
  %i.ef = add i64 %i.ea, %.sroa.speculated.i134341.i
...
bb.u:                                             ; preds = %bb.t
  %i.eg = getelementptr inbounds nuw i8, ptr %1, i64 %.094.i38
...
bb.v:                                             ; preds = %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE6substrEmm.exit137.jt1.i
  %i.ei = getelementptr inbounds nuw i8, ptr %.sroa.22.0.copyload, i64 %i.cx
  %i.ej = getelementptr inbounds nuw i8, ptr %1, i64 %.094.i38
  %i.ek = load i8, ptr %i.ej, align 1, !tbaa !20
  br label %.split203.i

bb.w:                                             ; preds = %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE6substrEmm.exit137.jt0.i
  %i.el = getelementptr inbounds nuw i8, ptr %.sroa.22.0.copyload, i64 %i.cz
  %i.em = getelementptr inbounds nuw i8, ptr %1, i64 %.094.i38
...
.split203.i:                                      ; preds = %bb.v, %bb.u
  %i.eo = phi i8 [ %i.ek, %bb.v ], [ %i.eh, %bb.u ]
  %i.ep = phi i1 [ false, %bb.v ], [ %i.dm, %bb.u ]
  %i.eq = phi ptr [ %i.ei, %bb.v ], [ %i.dl, %bb.u ]
  ...
  br i1 %i.et, label %bb.x, label %.critedge

_ZN12_GLOBAL__N_116ClassAllowsStartENS_16PlaceholderClassEc.exit.i: ; preds = %bb.w, %bb.u
  %i.eu = phi i8 [ %i.en, %bb.w ], [ %i.eh, %bb.u ]
  %i.ev = phi i1 [ false, %bb.w ], [ %i.dm, %bb.u ]
  %i.ew = phi ptr [ %i.el, %bb.w ], [ %i.dl, %bb.u ]
  ...
  br i1 %i.ez, label %bb.x, label %.critedge

bb.x:                                             ; preds = %_ZN12_GLOBAL__N_116ClassAllowsStartENS_16PlaceholderClassEc.exit.i, %.split203.i
  %i.fa = phi i1 [ %i.ep, %.split203.i ], [ %i.ev, %_ZN12_GLOBAL__N_116ClassAllowsStartENS_16PlaceholderClassEc.exit.i ]
  %i.fb = phi ptr [ %i.eq, %.split203.i ], [ %i.ew, %_ZN12_GLOBAL__N_116ClassAllowsStartENS_16PlaceholderClassEc.exit.i ]
  ...
  %i.fc = phi i1 [ false, %.split203.i ], [ true, %_ZN12_GLOBAL__N_116ClassAllowsStartENS_16PlaceholderClassEc.exit.i ] ; 2 uses
  %cond332.i = phi i1 [ %cond330.i, %.split203.i ], [ %cond331.i, %_ZN12_GLOBAL__N_116ClassAllowsStartENS_16PlaceholderClassEc.exit.i ]
  %i.fd = add nuw i64 %.094.i38, 1                ; 4 uses
  br i1 %i.fa, label %.preheader228.i, label %.preheader.i

.preheader.i:                                     ; preds = %bb.x
  %i.fe = icmp ult i64 %i.fd, %0
  br i1 %i.fe, label %.lr.ph281.i, label %.backedge.i
...
.lr.ph281.split.i:                                ; preds = %.lr.ph281.i, %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit.thread.i
  %.0105280.i = phi i64 [ %i.fo, %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit.thread.i ], [ %i.fd, %.lr.ph281.i ] ; 2 uses
  %i.ff = getelementptr inbounds nuw i8, ptr %1, i64 %.0105280.i
  %i.fg = load i8, ptr %i.ff, align 1, !tbaa !20
  %.fr222.i = freeze i8 %i.fg                     ; 4 uses
  %i.fh = and i8 %.fr222.i, -33
  %i.fi = add i8 %i.fh, -65
  %i.fj = icmp ult i8 %i.fi, 26                   ; 2 uses
  %i.fk = add i8 %.fr222.i, -48
  %i.fl = icmp ult i8 %i.fk, 10                   ; 2 uses
  br i1 %i.fc, label %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit.i, label %bb.y

bb.y:                                             ; preds = %.lr.ph281.split.i
  %or.cond225.i.a = or i1 %i.fl, %i.fj
  br i1 %or.cond225.i.a, label %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit.thread.i, label %switch.early.test.i
...
_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit.i: ; preds = %.lr.ph281.split.i
  %i.fm = icmp eq i8 %.fr222.i, 95
  %spec.select.i.i.i = or i1 %i.fm, %i.fl
  %i.fn = or i1 %i.fj, %spec.select.i.i.i
  br i1 %i.fn, label %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit.thread.i, label %.critedge
...
_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit.thread.i: ; preds = %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit.i, %switch.early.test.i, %switch.early.test.i, %bb.y
  %i.fo = add i64 %.0105280.i, 1                  ; 2 uses
  %exitcond310.not.i = icmp eq i64 %i.fo, %0
  br i1 %exitcond310.not.i, label %.backedge.i, label %.lr.ph281.split.i, !llvm.loop !13

.preheader228.i:                                  ; preds = %bb.x, %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit158.thread.i
  %.1106.i = phi i64 [ %i.gc, %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit158.thread.i ], [ %i.fd, %bb.x ] ; 8 uses
  %i.fp = sub i64 %0, %.1106.i
  %.not.i147.i = icmp ult i64 %i.fp, %.sroa.speculated.i134344.i
  br i1 %.not.i147.i, label %bb.ab, label %bb.z

bb.z:                                             ; preds = %.preheader228.i
  %i.fq = icmp ugt i64 %.1106.i, %0
  br i1 %i.fq, label %bb.aa, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i150.i
...
_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i150.i: ; preds = %bb.z
  %i.fr = getelementptr inbounds nuw i8, ptr %1, i64 %.1106.i
  %bcmp.i151.i = tail call i32 @bcmp(ptr nonnull readonly %i.fr, ptr nonnull readonly %i.fb, i64 %.sroa.speculated.i134344.i)
  %i.fs = icmp eq i32 %bcmp.i151.i, 0
  br i1 %i.fs, label %_ZN12_GLOBAL__N_114LiteralMatchesESt17basic_string_viewIcSt11char_traitsIcEEmS3_.exit153.i, label %bb.ab
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %.fr221.i = freeze i8 %i.fu                     ; 4 uses
  %i.fv = and i8 %.fr221.i, -33
  %i.fw = add i8 %i.fv, -65
  %i.fx = icmp ult i8 %i.fw, 26                   ; 2 uses
  %i.fy = add i8 %.fr221.i, -48
  %i.fz = icmp ult i8 %i.fy, 10                   ; 2 uses
  br i1 %i.fc, label %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit158.i, label %bb.ad

bb.ad:                                            ; preds = %bb.ac
  %or.cond227.i = or i1 %i.fz, %i.fx
...
_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit158.i: ; preds = %bb.ac
  %i.ga = icmp eq i8 %.fr221.i, 95
  %spec.select.i.i157.i = or i1 %i.ga, %i.fz
  %i.gb = or i1 %i.fx, %spec.select.i.i157.i
  br i1 %i.gb, label %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit158.thread.i, label %.critedge
...
_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit158.thread.i: ; preds = %_ZN12_GLOBAL__N_115ClassAllowsContENS_16PlaceholderClassEc.exit158.i, %switch.early.test220.i, %switch.early.test220.i, %bb.ad
  %i.gc = add nuw i64 %.1106.i, 1
  br label %.preheader228.i, !llvm.loop !14

_ZN12_GLOBAL__N_114LiteralMatchesESt17basic_string_viewIcSt11char_traitsIcEEmS3_.exit153.i: ; preds = %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i.i150.i
  %i.gd = add i64 %.1106.i, %.sroa.speculated.i134344.i
  br label %.backedge.i
...
_ZN12_GLOBAL__N_18TryMatchESt17basic_string_viewIcSt11char_traitsIcEES3_.exit: ; preds = %.backedge.i, %bb.b
  ...
  %i.ge = icmp eq i64 %.094.i.lcssa, %0
  br i1 %i.ge, label %bb.ae, label %.critedge
...
bb.ae:                                            ; preds = %_ZN12_GLOBAL__N_18TryMatchESt17basic_string_viewIcSt11char_traitsIcEES3_.exit
  %i.gf = getelementptr inbounds nuw i8, ptr %.0.ptr46, i64 16
  %.sroa.0.0.copyload = load i64, ptr %i.gf, align 16, !tbaa !16
