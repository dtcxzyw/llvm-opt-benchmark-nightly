...
bb.i:                                             ; preds = %bb.h
  ...
  %i.de = tail call i64 @cm_zlib_adler32(i64 noundef %i.dd, ptr noundef %i.ct, i32 noundef %spec.select.i) #11
...
bb.j:                                             ; preds = %bb.h
  ...
  %i.dh = tail call i64 @cm_zlib_crc32(i64 noundef %i.dg, ptr noundef %i.ct, i32 noundef %spec.select.i) #11
...
; Function Attrs: nounwind uwtable
define dso_local range(i32 -2, 1) i32 @cm_zlib_deflateResetKeep(ptr nofree noundef captures(address) %0) local_unnamed_addr #0 {
bb.a:
  %i.a = icmp eq ptr %0, null
  br i1 %i.a, label %deflateStateCheck.exit.thread, label %bb.b
...
bb.i:                                             ; preds = %bb.h
  %i.ab = tail call i64 @cm_zlib_crc32(i64 noundef 0, ptr noundef null, i32 noundef 0) #11
  br label %bb.k

bb.j:                                             ; preds = %bb.h
  %i.ac = tail call i64 @cm_zlib_adler32(i64 noundef 0, ptr noundef null, i32 noundef 0) #11
  br label %bb.k
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  tail call void @cm_zlib__tr_init(ptr noundef nonnull %i.i) #11
  br label %deflateStateCheck.exit.thread
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define dso_local range(i32 -2, 1) i32 @cm_zlib_deflateSetHeader(ptr nofree noundef readonly captures(address) %0, ptr noundef %1) local_unnamed_addr #3 {
bb.a:
  %i.a = icmp eq ptr %0, null
end_hunk_0
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  tail call void @cm_zlib__tr_stored_block(ptr noundef nonnull %0, ptr noundef null, i64 noundef 0, i32 noundef %i.aq) #11
  ...
  tail call void @cm_zlib__tr_flush_bits(ptr noundef %i.bq) #11
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.dz = tail call i64 @cm_zlib_adler32(i64 noundef %i.dy, ptr noundef %i.dm, i32 noundef %spec.select.i268) #11
...
bb.m:                                             ; preds = %bb.k
  ...
  %i.ec = tail call i64 @cm_zlib_crc32(i64 noundef %i.eb, ptr noundef %i.dm, i32 noundef %spec.select.i268) #11
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.iq = tail call i64 @cm_zlib_adler32(i64 noundef %i.ip, ptr noundef %i.ig, i32 noundef %spec.select265) #11
...
bb.an:                                            ; preds = %bb.al
  ...
  %i.it = tail call i64 @cm_zlib_crc32(i64 noundef %i.is, ptr noundef %i.ig, i32 noundef %spec.select265) #11
...
bb.aw:                                            ; preds = %bb.av, %bb.au, %bb.at
  ...
  tail call void @cm_zlib__tr_stored_block(ptr noundef nonnull %0, ptr noundef %i.ki, i64 noundef %i.kj, i32 noundef %i.kg) #11
  ...
  tail call void @cm_zlib__tr_flush_bits(ptr noundef %i.ko) #11
