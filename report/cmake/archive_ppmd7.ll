...
begin_hunk_0_@UpdateModel:bb.a
  ...
  store i8 %i.t, ptr %i.q, align 1, !tbaa !53
  br label %bb.k
...
bb.f:                                             ; preds = %bb.c
  ...
  %i.z = load i8, ptr %i.b, align 2, !tbaa !57    ; 2 uses
...
.preheader:                                       ; preds = %bb.f, %.preheader
  ...
  %i.ab = load i8, ptr %i.aa, align 2, !tbaa !57
  %.not188 = icmp eq i8 %i.ab, %i.z
  br i1 %.not188, label %bb.g, label %.preheader, !llvm.loop !125
...
bb.h:                                             ; preds = %bb.g
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(6) %1, ptr noundef nonnull align 2 dereferenceable(6) %i.aa, i64 6, i1 false), !tbaa.struct !65
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(6) %i.aa, ptr noundef nonnull align 2 dereferenceable(6) %.0169, i64 6, i1 false), !tbaa.struct !65
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(6) %.0169, ptr noundef nonnull align 2 dereferenceable(6) %1, i64 6, i1 false), !tbaa.struct !65
...
bb.l:                                             ; preds = %bb.k
  ...
  store ptr %i.ap, ptr %0, align 8, !tbaa !47
...
bb.n:                                             ; preds = %bb.l
  %i.as = load ptr, ptr %i.a, align 8, !tbaa !56
  ...
  store i32 %i.ay, ptr %i.az, align 2
  br label %bb.ao

bb.o:                                             ; preds = %bb.k
  %i.ba = load ptr, ptr %i.a, align 8, !tbaa !56
  %i.bb = load i8, ptr %i.ba, align 2, !tbaa !57
  %i.bc = getelementptr inbounds nuw i8, ptr %0, i64 88 ; 5 uses
  %i.bd = load ptr, ptr %i.bc, align 8, !tbaa !63 ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 1
  store ptr %i.be, ptr %i.bc, align 8, !tbaa !63
  store i8 %i.bb, ptr %i.bd, align 1, !tbaa !16
  %i.bf = load ptr, ptr %i.bc, align 8, !tbaa !63 ; 2 uses
...
bb.t:                                             ; preds = %bb.s
  %i.bp = load ptr, ptr %i.bg, align 8, !tbaa !9  ; 2 uses
...
bb.u:                                             ; preds = %bb.t, %bb.r
  ...
  %i.bv = load i32, ptr %i.am, align 8, !tbaa !62
  %i.bw = add i32 %i.bv, -1                       ; 2 uses
  store i32 %i.bw, ptr %i.am, align 8, !tbaa !62
  %i.bx = icmp eq i32 %i.bw, 0
  %.pre = load ptr, ptr %0, align 8, !tbaa !47    ; 3 uses
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.cb = load ptr, ptr %i.bc, align 8, !tbaa !63
  %.neg = sext i1 %i.ca to i64
  %i.cc = getelementptr inbounds i8, ptr %i.cb, i64 %.neg
  store ptr %i.cc, ptr %i.bc, align 8, !tbaa !63
  br label %bb.x

bb.w:                                             ; preds = %bb.q
  %i.cd = load ptr, ptr %i.a, align 8, !tbaa !56
  %i.ce = getelementptr inbounds nuw i8, ptr %i.cd, i64 2
  store i32 %i.bl, ptr %i.ce, align 2
  %i.cf = load ptr, ptr %0, align 8, !tbaa !47    ; 2 uses
  %i.cg = load ptr, ptr %i.bg, align 8, !tbaa !9  ; 2 uses
...
bb.x:                                             ; preds = %bb.u, %bb.v, %bb.w
  ...
  %i.cq = load ptr, ptr %i.cp, align 8, !tbaa !64 ; 2 uses
  %.not194227 = icmp eq ptr %i.cq, %i.cm
  br i1 %.not194227, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %bb.x
  %i.cr = load ptr, ptr %i.a, align 8, !tbaa !56
  ...
  %i.cx = load i16, ptr %i.cw, align 2, !tbaa !52
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.dy = load i32, ptr %i.dx, align 4, !tbaa !123 ; 2 uses
...
AllocUnits.exit.thread:                           ; preds = %bb.ab
  ...
  %i.eb = load i32, ptr %i.ea, align 4, !tbaa !123
  store i32 %i.eb, ptr %i.dx, align 4, !tbaa !123
  br label %bb.af
...
bb.ac:                                            ; preds = %bb.ab
  ...
  %i.eg = load ptr, ptr %i.dc, align 8, !tbaa !113
  %i.eh = load ptr, ptr %i.dd, align 8, !tbaa !114 ; 3 uses
...
bb.ad:                                            ; preds = %bb.ac
  ...
  store ptr %i.en, ptr %i.dd, align 8, !tbaa !114
...
AllocUnits.exit._crit_edge:                       ; preds = %AllocUnits.exit
  %.pre229 = load ptr, ptr %i.bg, align 8, !tbaa !9
  br label %bb.af
...
bb.af:                                            ; preds = %AllocUnits.exit._crit_edge, %AllocUnits.exit.thread
  ...
  %i.er = load i32, ptr %i.eq, align 4, !tbaa !50 ; 2 uses
...
.prol.loopexit.unr-lcssa:                         ; preds = %bb.af
  %i.ev = load i32, ptr %i.et, align 4, !tbaa !123
  store i32 %i.ev, ptr %.0.i211, align 4, !tbaa !123
  %i.ew = getelementptr inbounds nuw i8, ptr %i.et, i64 4
  %i.ex = load i32, ptr %i.ew, align 4, !tbaa !123
  %i.ey = getelementptr inbounds nuw i8, ptr %.0.i211, i64 4
  store i32 %i.ex, ptr %i.ey, align 4, !tbaa !123
  %i.ez = getelementptr inbounds nuw i8, ptr %i.et, i64 8
  %i.fa = load i32, ptr %i.ez, align 4, !tbaa !123
  %i.fb = getelementptr inbounds nuw i8, ptr %.0.i211, i64 8
  store i32 %i.fa, ptr %i.fb, align 4, !tbaa !123
...
.unr-lcssa:                                       ; preds = %.new, %.prol.loopexit
  ...
  %i.gb = load i32, ptr %i.ga, align 4, !tbaa !123
  store i32 %i.gb, ptr %i.et, align 4, !tbaa !123
  %i.gc = ptrtoint ptr %i.ep to i64
  store i32 %i.er, ptr %i.ga, align 4, !tbaa !123
  %i.gd = ptrtoint ptr %.0.i211 to i64
  %i.ge = sub i64 %i.gd, %i.gc
  %i.gf = trunc i64 %i.ge to i32
  store i32 %i.gf, ptr %i.eq, align 4, !tbaa !50
  br label %.critedge
...
.critedge:                                        ; preds = %.unr-lcssa, %bb.aa, %bb.z
  ...
  %i.gi = load i16, ptr %i.gh, align 2, !tbaa !52 ; 2 uses
...
bb.ag:                                            ; preds = %bb.y
  %i.gv = load i32, ptr %i.da, align 4, !tbaa !123 ; 2 uses
...
AllocUnits.exit207.thread:                        ; preds = %bb.ag
  ...
  %i.gy = load i32, ptr %i.gx, align 4, !tbaa !123
  store i32 %i.gy, ptr %i.da, align 4, !tbaa !123
  br label %bb.ak

bb.ah:                                            ; preds = %bb.ag
  %i.gz = load i8, ptr %i.db, align 4, !tbaa !16
  %i.ha = zext i8 %i.gz to i32
  %i.hb = mul nuw nsw i32 %i.ha, 12               ; 2 uses
  %i.hc = load ptr, ptr %i.dc, align 8, !tbaa !113
  %i.hd = load ptr, ptr %i.dd, align 8, !tbaa !114 ; 3 uses
...
bb.ai:                                            ; preds = %bb.ah
  ...
  store ptr %i.hj, ptr %i.dd, align 8, !tbaa !114
...
bb.ak:                                            ; preds = %AllocUnits.exit207, %AllocUnits.exit207.thread
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 2 dereferenceable(6) %.0.i205218, ptr noundef nonnull align 2 dereferenceable(6) %i.hl, i64 6, i1 false), !tbaa.struct !65
  %i.hm = load ptr, ptr %i.bg, align 8, !tbaa !9  ; 2 uses
...
bb.al:                                            ; preds = %bb.ak, %.critedge
  ...
  %i.id = load ptr, ptr %i.a, align 8, !tbaa !56
  %i.ie = getelementptr inbounds nuw i8, ptr %i.id, i64 1
  %i.if = load i8, ptr %i.ie, align 1, !tbaa !53
...
.critedge203:                                     ; preds = %bb.an, %bb.am
  ...
  store i16 %storemerge201, ptr %i.ii, align 2, !tbaa !52
  %i.jg = getelementptr inbounds nuw i8, ptr %.0168228, i64 4
  %i.jh = load i32, ptr %i.jg, align 4, !tbaa !50
  ...
  %i.jn = load ptr, ptr %i.a, align 8, !tbaa !56
  %i.jo = load i8, ptr %i.jn, align 2, !tbaa !57
  store i8 %i.jo, ptr %i.jl, align 2, !tbaa !57
  %i.jp = trunc nuw nsw i32 %.0174 to i8
  %i.jq = getelementptr inbounds nuw i8, ptr %i.jl, i64 1
  store i8 %i.jp, ptr %i.jq, align 1, !tbaa !53
  %i.jr = add i16 %i.di, 1
  store i16 %i.jr, ptr %.0168228, align 4, !tbaa !48
  %i.js = load ptr, ptr %i.bg, align 8, !tbaa !9  ; 3 uses
  %i.jt = getelementptr inbounds nuw i8, ptr %.0168228, i64 8
  %i.ju = load i32, ptr %i.jt, align 4, !tbaa !73
