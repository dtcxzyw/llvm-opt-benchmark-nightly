Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/cmake/original/block_header_encoder?download=true
inline.NumInlined: 1
inline.NumDeleted: 1
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %or.cond.not, label %bb.d, label %.thread

bb.d:                                             ; preds = %bb.c, %bb.b
  %.136 = phi i32 [ %.035, %bb.c ], [ 6, %bb.b ]  ; 2 uses
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.h = load i64, ptr %i.g, align 8, !tbaa !14   ; 2 uses
  %.not53.a = icmp eq i64 %i.h, -1
  br i1 %.not53.a, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.i = tail call i32 @lzma_vli_size(i64 noundef %i.h) #5 ; 2 uses
  %.not54.a = icmp eq i32 %i.i, 0
  %i.j = add i32 %i.i, %.136
  br i1 %.not54.a, label %.thread, label %bb.f
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %i.o, label %.thread, label %.lr.ph.preheader
...
.lr.ph.preheader:                                 ; preds = %bb.g
  ...
  br i1 %.not56, label %bb.h, label %.thread
...
bb.h:                                             ; preds = %.lr.ph.preheader
  ...
  %.not55 = icmp eq i64 %i.u, -1
  br i1 %.not55, label %._crit_edge, label %.lr.ph.1

.lr.ph.1:                                         ; preds = %bb.h
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #6
  %i.v = call i32 @lzma_filter_flags_size(ptr noundef nonnull %i.a, ptr noundef nonnull %i.t) #6 ; 2 uses
  %.not56.1 = icmp eq i32 %i.v, 0
  %i.w = load i32, ptr %i.a, align 4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #6
  br i1 %.not56.1, label %bb.i, label %.thread
...
bb.i:                                             ; preds = %.lr.ph.1
  ...
  %.not55.1 = icmp eq i64 %i.aa, -1
  br i1 %.not55.1, label %._crit_edge, label %.lr.ph.2

.lr.ph.2:                                         ; preds = %bb.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #6
  %i.ab = call i32 @lzma_filter_flags_size(ptr noundef nonnull %i.a, ptr noundef nonnull %i.z) #6 ; 2 uses
  %.not56.2 = icmp eq i32 %i.ab, 0
  %i.ac = load i32, ptr %i.a, align 4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #6
  br i1 %.not56.2, label %bb.j, label %.thread
...
bb.j:                                             ; preds = %.lr.ph.2
  ...
  %.not55.2 = icmp eq i64 %i.ag, -1
  br i1 %.not55.2, label %._crit_edge, label %.lr.ph.3

.lr.ph.3:                                         ; preds = %bb.j
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #6
  %i.ah = call i32 @lzma_filter_flags_size(ptr noundef nonnull %i.a, ptr noundef nonnull %i.af) #6 ; 2 uses
  %.not56.3 = icmp eq i32 %i.ah, 0
  %i.ai = load i32, ptr %i.a, align 4
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #6
  br i1 %.not56.3, label %bb.k, label %.thread
...
bb.k:                                             ; preds = %.lr.ph.3
  ...
  %.not55.3 = icmp eq i64 %i.am, -1
  br i1 %.not55.3, label %._crit_edge, label %.thread
...
.thread:                                          ; preds = %.lr.ph.preheader, %.lr.ph.1, %.lr.ph.2, %.lr.ph.3, %bb.k, %._crit_edge, %bb.e, %bb.c, %bb.g, %bb.f, %bb.a
...
bb.d:                                             ; preds = %bb.c
  ...
  %.not55.a = icmp eq i32 %i.o, 0
  br i1 %.not55.a, label %bb.e, label %.loopexit
...
bb.f:                                             ; preds = %bb.e, %bb.c
  ...
  %.not56.a = icmp eq i64 %i.r, -1
  br i1 %.not56.a, label %bb.i, label %bb.g
...
bb.g:                                             ; preds = %bb.f
  ...
  %.not57.a = icmp eq i32 %i.s, 0
  br i1 %.not57.a, label %bb.h, label %.loopexit
...
.preheader.preheader:                             ; preds = %bb.j
  ...
  %.not58.a = icmp eq i32 %i.aa, 0
  br i1 %.not58.a, label %bb.k, label %.loopexit
...
bb.k:                                             ; preds = %.preheader.preheader
  ...
  %.not59 = icmp eq i64 %i.ad, -1
  br i1 %.not59, label %bb.o, label %.preheader.1
...
.preheader.1:                                     ; preds = %bb.k
  ...
  %.not58.1.a = icmp eq i32 %i.ae, 0
  br i1 %.not58.1.a, label %bb.l, label %.loopexit
...
bb.l:                                             ; preds = %.preheader.1
  ...
  %.not59.1 = icmp eq i64 %i.ah, -1
  br i1 %.not59.1, label %bb.o, label %.preheader.2
...
.preheader.2:                                     ; preds = %bb.l
  ...
  %.not58.2.a = icmp eq i32 %i.ai, 0
  br i1 %.not58.2.a, label %bb.m, label %.loopexit
...
bb.m:                                             ; preds = %.preheader.2
  ...
  %.not59.2 = icmp eq i64 %i.al, -1
  br i1 %.not59.2, label %bb.o, label %.preheader.3
...
.preheader.3:                                     ; preds = %bb.m
  ...
  %.not58.3.a = icmp eq i32 %i.am, 0
  br i1 %.not58.3.a, label %bb.n, label %.loopexit
...
bb.n:                                             ; preds = %.preheader.3
  ...
  %.not59.3 = icmp eq i64 %i.ap, -1
  br i1 %.not59.3, label %bb.o, label %.loopexit

bb.o:                                             ; preds = %bb.n, %bb.m, %bb.l, %bb.k
  %.0.lcssa61 = phi i8 [ 0, %bb.k ], [ 1, %bb.l ], [ 2, %bb.m ], [ 3, %bb.n ]
  %i.aq = load i8, ptr %i.l, align 1, !tbaa !19
  %i.ar = or i8 %i.aq, %.0.lcssa61
