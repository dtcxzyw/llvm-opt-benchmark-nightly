...
.lr.ph1110:                                       ; preds = %bb.ef
  ...
  br i1 %i.aab, label %.lr.ph1110.._crit_edge1111.loopexit.split.loop.exit1722_crit_edge, label %.lr.ph1903, !llvm.loop !124
...
bb.ef:                                            ; preds = %bb.ee
  ...
  br i1 %exitcond1367.not, label %._crit_edge1111, label %.lr.ph1110, !llvm.loop !124
