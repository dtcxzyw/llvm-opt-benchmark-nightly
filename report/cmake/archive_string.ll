...
bb.db:                                            ; preds = %bb.da
  ...
  store i32 %i.tb, ptr %i.ar, align 4, !tbaa !25
  %i.th = call i32 %.0625(ptr noundef nonnull %i.as, ptr noundef nonnull %i.tf, i64 noundef %i.tg) #23, !callees !53 ; 4 uses
  %i.ti = icmp slt i32 %i.th, 1
  br i1 %i.ti, label %.lr.ph1142.preheader, label %bb.dc

bb.dc:                                            ; preds = %bb.db
  %i.tj = load i32, ptr %i.as, align 8, !tbaa !25 ; 4 uses
...
bb.dd:                                            ; preds = %bb.dc
  ...
  %i.tv = load i8, ptr %i.tu, align 1, !tbaa !20
  ...
  %i.ub = load i8, ptr %i.ua, align 1, !tbaa !20
...
bb.df:                                            ; preds = %bb.de
  ...
  store i32 %i.ud, ptr %i.at, align 8, !tbaa !25
  %i.uj = call i32 %.0625(ptr noundef nonnull %i.au, ptr noundef nonnull %i.uh, i64 noundef %i.ui) #23, !callees !53 ; 4 uses
  %i.uk = icmp slt i32 %i.uj, 1
  br i1 %i.uk, label %.lr.ph1142.preheader, label %bb.dg

bb.dg:                                            ; preds = %bb.df
  %i.ul = load i32, ptr %i.au, align 4, !tbaa !25 ; 4 uses
...
bb.dh:                                            ; preds = %bb.dg
  ...
  %i.uq = load i8, ptr %i.up, align 1, !tbaa !20
  ...
  %i.ux = load i8, ptr %i.uw, align 1, !tbaa !20
  ...
  %i.vd = load i8, ptr %i.vc, align 1, !tbaa !20
...
bb.dj:                                            ; preds = %bb.di
  ...
  store i32 %i.vf, ptr %i.av, align 4, !tbaa !25
  %i.vl = call i32 %.0625(ptr noundef nonnull %i.aw, ptr noundef nonnull %i.vj, i64 noundef %i.vk) #23, !callees !53 ; 4 uses
  %i.vm = icmp slt i32 %i.vl, 1
  br i1 %i.vm, label %.lr.ph1142.preheader, label %bb.dk

bb.dk:                                            ; preds = %bb.dj
  %i.vn = load i32, ptr %i.aw, align 16, !tbaa !25 ; 4 uses
...
bb.dl:                                            ; preds = %bb.dk
  ...
  %i.vs = load i8, ptr %i.vr, align 1, !tbaa !20
  ...
  %i.vz = load i8, ptr %i.vy, align 1, !tbaa !20
  ...
  %i.wf = load i8, ptr %i.we, align 1, !tbaa !20
...
bb.dn:                                            ; preds = %bb.dm
  ...
  store i32 %i.wh, ptr %i.ax, align 16, !tbaa !25
  %i.wn = call i32 %.0625(ptr noundef nonnull %i.ay, ptr noundef nonnull %i.wl, i64 noundef %i.wm) #23, !callees !53 ; 5 uses
  %i.wo = icmp slt i32 %i.wn, 1
  br i1 %i.wo, label %.lr.ph1142.preheader, label %bb.do

bb.do:                                            ; preds = %bb.dn
  %i.wp = load i32, ptr %i.ay, align 4, !tbaa !25 ; 4 uses
...
bb.dp:                                            ; preds = %bb.do
  ...
  %i.xh = load i8, ptr %i.xg, align 1, !tbaa !20
...
bb.dr:                                            ; preds = %bb.dq
  ...
  store i32 %i.xj, ptr %i.az, align 4, !tbaa !25
...
.lr.ph1142:                                       ; preds = %.lr.ph1142.preheader, %bb.eg
  ...
  %i.xq = load i32, ptr %i.a, align 4, !tbaa !25  ; 2 uses
  %i.xr = sext i32 %.05961138 to i64
  %i.xs = getelementptr inbounds [4 x i8], ptr %i.c, i64 %i.xr
  %i.xt = load i32, ptr %i.xs, align 4, !tbaa !25 ; 2 uses
  br label %bb.ds
...
bb.ds:                                            ; preds = %bb.ea, %.lr.ph1142
  ...
  %i.xy = load i32, ptr %i.xx, align 4, !tbaa !134 ; 2 uses
...
bb.dw:                                            ; preds = %bb.du
  ...
  %i.ye = load i32, ptr %i.yd, align 4, !tbaa !135 ; 2 uses
...
bb.ea:                                            ; preds = %bb.dz, %bb.dx, %bb.dv, %bb.dt
  ...
  br i1 %.not.i820, label %get_nfc.exit821.thread, label %bb.ds, !llvm.loop !120

get_nfc.exit821.thread:                           ; preds = %bb.ea
  %i.yj = add nsw i32 %.05961138, 1
  br label %bb.eg, !llvm.loop !122

get_nfc.exit821:                                  ; preds = %bb.dy
  %i.yk = getelementptr inbounds nuw i8, ptr %i.xx, i64 8
  %i.yl = load i32, ptr %i.yk, align 4, !tbaa !136
  store i32 %i.yl, ptr %i.a, align 4, !tbaa !25
...
.lr.ph1102.prol:                                  ; preds = %.lr.ph1102.preheader
  ...
  store i32 %i.yu, ptr %i.yv, align 4, !tbaa !25
  ...
  store i32 %i.yx, ptr %i.yy, align 4, !tbaa !25
...
.lr.ph1102:                                       ; preds = %.lr.ph1102.prol.loopexit, %.lr.ph1102
  ...
  store i32 %i.zb, ptr %i.zc, align 4, !tbaa !25
  %i.zd = getelementptr inbounds [4 x i8], ptr %i.d, i64 %indvars.iv
  %i.ze = load i32, ptr %i.zd, align 4, !tbaa !25
  %i.zf = getelementptr inbounds [4 x i8], ptr %i.d, i64 %.05881101
  store i32 %i.ze, ptr %i.zf, align 4, !tbaa !25
  ...
  store i32 %i.zk, ptr %i.zl, align 4, !tbaa !25
  %indvars.iv.next.1 = add nsw i64 %indvars.iv, 2 ; 2 uses
  %lftr.wideiv.1 = trunc i64 %indvars.iv.next.1 to i32
  %exitcond.not.1 = icmp eq i32 %.11140, %lftr.wideiv.1
  br i1 %exitcond.not.1, label %._crit_edge1103, label %.lr.ph1102, !llvm.loop !123
...
bb.ec:                                            ; preds = %bb.eb
  ...
  %i.zu = load i32, ptr %i.zt, align 4, !tbaa !25 ; 3 uses
...
.lr.ph1110.preheader:                             ; preds = %bb.ec
  ...
  %i.zx = call i32 %.0625(ptr noundef nonnull %i.zw, ptr noundef %.37201133, i64 noundef %.37401132) #23, !callees !53 ; 3 uses
  %i.zy = icmp slt i32 %i.zx, 1
  br i1 %i.zy, label %._crit_edge1111, label %.lr.ph1903

.lr.ph1110:                                       ; preds = %bb.ef
  %indvars.iv.next1365 = add nuw nsw i64 %indvars.iv13641899, 1 ; 3 uses
  %i.zz = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %indvars.iv.next1365 ; 2 uses
  %i.aaa = call i32 %.0625(ptr noundef nonnull %i.zz, ptr noundef nonnull %i.abd, i64 noundef %i.abe) #23, !callees !53 ; 3 uses
  %i.aab = icmp slt i32 %i.aaa, 1
  %5 = trunc nuw i64 %indvars.iv.next1365 to i32  ; 2 uses
  br i1 %i.aab, label %._crit_edge1111, label %.lr.ph1903, !llvm.loop !124

.lr.ph1903:                                       ; preds = %.lr.ph1110.preheader, %.lr.ph1110
  %6 = phi i32 [ %5, %.lr.ph1110 ], [ %.05961138, %.lr.ph1110.preheader ] ; 2 uses
  ...
  %indvars.iv13641899 = phi i64 [ %indvars.iv.next1365, %.lr.ph1110 ], [ %4, %.lr.ph1110.preheader ] ; 2 uses
  %i.aae = load i32, ptr %i.aad, align 4, !tbaa !25 ; 4 uses
...
bb.ed:                                            ; preds = %.lr.ph1903
  ...
  %i.aaj = load i8, ptr %i.aai, align 1, !tbaa !20
  ...
  %i.aaq = load i8, ptr %i.aap, align 1, !tbaa !20
  ...
  %i.aaw = load i8, ptr %i.aav, align 1, !tbaa !20
...
bb.ef:                                            ; preds = %bb.ee
  ...
  %i.abf = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %indvars.iv13641899
  store i32 %i.aay, ptr %i.abf, align 4, !tbaa !25
  %7 = icmp slt i32 %6, 9
  br i1 %7, label %.lr.ph1110, label %.lr.ph1110.._crit_edge1111.loopexit.split.loop.exit1722_crit_edge, !llvm.loop !124

.lr.ph1110.._crit_edge1111.loopexit.split.loop.exit1722_crit_edge: ; preds = %bb.ef
  br label %._crit_edge1111, !llvm.loop !124
...
._crit_edge1111:                                  ; preds = %bb.ee, %.lr.ph1110, %.lr.ph1110.preheader, %.lr.ph1110.._crit_edge1111.loopexit.split.loop.exit1722_crit_edge, %bb.ec
  ...
  %.0.lcssa = phi i32 [ %.05961138, %bb.ec ], [ %.05961138, %.lr.ph1110.preheader ], [ 10, %.lr.ph1110.._crit_edge1111.loopexit.split.loop.exit1722_crit_edge ], [ %5, %.lr.ph1110 ], [ %6, %bb.ee ] ; 2 uses
...
.preheader881:                                    ; preds = %._crit_edge1143
  ...
  %i.abm = load i32, ptr %i.a, align 4, !tbaa !25
  %i.abn = call i64 %.0624(ptr noundef %.26821083, i64 noundef %i.abl, i32 noundef %i.abm) #23, !callees !54 ; 2 uses
...
bb.ei:                                            ; preds = %bb.eh
  %i.abu = load ptr, ptr %0, align 8, !tbaa !19
  %i.abv = ptrtoint ptr %.26821083 to i64
  %i.abw = ptrtoint ptr %i.abu to i64
  %i.abx = sub i64 %i.abv, %i.abw
  store i64 %i.abx, ptr %i.s, align 8, !tbaa !18
  %i.aby = load i64, ptr %i.ac, align 8, !tbaa !26
...
bb.ej:                                            ; preds = %bb.ei
  %i.ace = load ptr, ptr %0, align 8, !tbaa !19   ; 2 uses
  %i.acf = load i64, ptr %i.s, align 8, !tbaa !18
  %i.acg = getelementptr inbounds nuw i8, ptr %i.ace, i64 %i.acf
  %i.ach = load i64, ptr %i.ac, align 8, !tbaa !26
...
bb.el:                                            ; preds = %bb.ek
  ...
  %i.acl = load i8, ptr %.18.lcssa, align 1, !tbaa !20
  %i.acm = getelementptr inbounds nuw i8, ptr %.35715, i64 1
  store i8 %i.acl, ptr %.35715, align 1, !tbaa !20
  br label %bb.em
...
bb.em:                                            ; preds = %bb.el, %bb.ek
  ...
  %i.aco = load i8, ptr %.20, align 1, !tbaa !20
  %i.acp = getelementptr inbounds nuw i8, ptr %.36716, i64 1
  store i8 %i.aco, ptr %.36716, align 1, !tbaa !20
  br label %bb.en
...
bb.eq:                                            ; preds = %bb.ep
  %i.add = load ptr, ptr %0, align 8, !tbaa !19   ; 2 uses
  %i.ade = load i64, ptr %i.s, align 8, !tbaa !18 ; 2 uses
  %i.adf = getelementptr inbounds nuw i8, ptr %i.add, i64 %i.ade ; 3 uses
  %i.adg = load i64, ptr %i.ac, align 8, !tbaa !26
  %i.adh = sub nsw i64 %i.adg, %.0627             ; 2 uses
  %i.adi = ptrtoint ptr %i.adf to i64
  %gepdiff = sub nsw i64 %i.adh, %i.ade
  %i.adj = load i32, ptr %i.a, align 4, !tbaa !25
  %i.adk = call i64 %.0624(ptr noundef %i.adf, i64 noundef %gepdiff, i32 noundef %i.adj) #23, !callees !54 ; 2 uses
  %i.adl = icmp eq i64 %i.adk, 0
  br i1 %i.adl, label %bb.ep, label %._crit_edge1153.loopexit, !llvm.loop !125
...
.preheader865:                                    ; preds = %.preheader865.lr.ph, %._crit_edge1158
  ...
  %i.adv = load i32, ptr %i.adr, align 4, !tbaa !25
  %i.adw = call i64 %.0624(ptr noundef %.421162, i64 noundef %i.adu, i32 noundef %i.adv) #23, !callees !54 ; 2 uses
...
.lr.ph1157:                                       ; preds = %.preheader865, %bb.es
  ...
  %i.adz = load ptr, ptr %0, align 8, !tbaa !19
  %i.aea = ptrtoint ptr %i.adz to i64
  %i.aeb = sub i64 %i.ady, %i.aea
  store i64 %i.aeb, ptr %i.s, align 8, !tbaa !18
  %i.aec = load i64, ptr %i.ac, align 8, !tbaa !26
...
bb.es:                                            ; preds = %.lr.ph1157
  %i.aeg = load ptr, ptr %0, align 8, !tbaa !19   ; 2 uses
  %i.aeh = load i64, ptr %i.s, align 8, !tbaa !18 ; 2 uses
  %i.aei = getelementptr inbounds nuw i8, ptr %i.aeg, i64 %i.aeh ; 3 uses
  %i.aej = load i64, ptr %i.ac, align 8, !tbaa !26
