...
bb.f:                                             ; preds = %bb.d, %bb.e, %bb.c, %bb.b, %bb.a
  %.0 = phi i64 [ 0, %bb.c ], [ 0, %bb.a ], [ 0, %bb.b ], [ %i.l, %bb.e ], [ %i.l, %bb.d ]
  ret i64 %.0
}
...
bb.g:                                             ; preds = %.backedge.i.i, %bb.f
  %.139.i24.i = phi i64 [ 16, %bb.f ], [ %.139.be.i.i, %.backedge.i.i ] ; 2 uses
  %.243.i23.i = phi ptr [ %i.a, %bb.f ], [ %.243.be.i.i, %.backedge.i.i ] ; 2 uses
  ...
  %spec.select.i.i = tail call i64 @llvm.umin.i64(i64 %.139.i24.i, i64 %i.bc) ; 6 uses
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.bf, ptr align 1 %.243.i23.i, i64 %spec.select.i.i, i1 false)
...
.backedge.i.i:                                    ; preds = %.split.i.i, %bb.h
  %.139.be.i.i = sub i64 %.139.i24.i, %spec.select.i.i ; 2 uses
...
bb.e:                                             ; preds = %bb.j, %bb.d
  %.014.i.i = phi ptr [ %i.p, %bb.d ], [ %i.ah, %bb.j ]
  %.0.i.i = phi ptr [ %i.s, %bb.d ], [ %spec.select.i.i, %bb.j ] ; 5 uses
  %i.t = call ptr @strchr(ptr noundef nonnull dereferenceable(1) %.0.i.i, i32 noundef 47) #25 ; 2 uses
  %i.u = icmp eq ptr %i.t, null
  br i1 %i.u, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.v = call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.0.i.i) #25 ; 2 uses
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  br i1 %i.aa, label %get_path_component.exit.thread19.i.i, label %get_path_component.exit.i.i

get_path_component.exit.i.i:                      ; preds = %bb.h
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 16 %i.d, ptr nonnull align 1 %.0.i.i, i64 %.0.i.i.i, i1 false)
  %i.ab = getelementptr inbounds nuw i8, ptr %i.d, i64 %.0.i.i.i
  store i8 0, ptr %i.ab, align 1, !tbaa !71
  %i.ac = icmp eq i64 %.0.i.i.i, 0
  br i1 %i.ac, label %isoent_find_out_boot_file.exit.thread, label %get_path_component.exit.thread19.i.i

get_path_component.exit.thread19.i.i:             ; preds = %get_path_component.exit.i.i, %bb.h
  %.013.i21.i.i = phi i64 [ %.0.i.i.i, %get_path_component.exit.i.i ], [ -1, %bb.h ]
  %i.ad = getelementptr inbounds i8, ptr %.0.i.i, i64 %.013.i21.i.i ; 2 uses
  ...
  %i.ag = getelementptr inbounds nuw i8, ptr %.014.i.i, i64 64
...
bb.i:                                             ; preds = %get_path_component.exit.thread19.i.i
...
isoent_find_out_boot_file.exit.thread:            ; preds = %bb.f, %get_path_component.exit.i.i, %get_path_component.exit.thread19.i.i, %bb.j
...
bb.k:                                             ; preds = %bb.i
  ...
  br i1 %i.bb, label %zisofs_rewind_boot_file.exit.thread245, label %bb.l

zisofs_rewind_boot_file.exit.thread245:           ; preds = %bb.k
...
.preheader.i:                                     ; preds = %bb.l
  ...
  br i1 %.not122.i, label %.thread.thread179.i, label %.lr.ph.i
...
bb.n:                                             ; preds = %bb.av, %.lr.ph.i
  %.060124.i = phi i64 [ %i.bu, %.lr.ph.i ], [ %i.cx, %bb.av ] ; 2 uses
  %.063123.i = phi i64 [ %i.bs, %.lr.ph.i ], [ %i.cy, %bb.av ] ; 2 uses
  %i.cq = call i64 @lseek(i32 noundef %i.bk, i64 noundef 0, i32 noundef 1) #23
  %i.cr = call i64 @lseek(i32 noundef %i.bk, i64 noundef %.063123.i, i32 noundef 0) #23 ; 0 uses
...
bb.o:                                             ; preds = %bb.n
  %i.cx = sub i64 %.060124.i, %i.ct               ; 2 uses
  %i.cy = add nsw i64 %i.ct, %.063123.i
...
bb.z:                                             ; preds = %.critedge76.i.i.i, %.critedge.i.i.i
  ...
  %.161.i.i.i = phi i64 [ %i.eb, %.critedge76.i.i.i ], [ %i.ct, %.critedge.i.i.i ] ; 3 uses
  %.159.i.i.i = phi ptr [ %i.ce, %.critedge76.i.i.i ], [ %i.bv, %.critedge.i.i.i ]
...
bb.aa:                                            ; preds = %bb.z
  ...
  %spec.select.i.i.i = call i64 @llvm.umin.i64(i64 %.161.i.i.i, i64 %i.eg) ; 3 uses
  %i.eh = getelementptr inbounds nuw i8, ptr %i.dq, i64 %i.ee
  call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.eh, ptr nonnull align 1 %.159.i.i.i, i64 %spec.select.i.i.i, i1 false)
  ...
  %i.ek = sub nsw i64 %.161.i.i.i, %spec.select.i.i.i ; 3 uses
...
zisofs_extract_init.exit.thread126.i.i:           ; preds = %zisofs_extract_init.exit.zisofs_extract_init.exit.thread126_crit_edge.i.i, %bb.z
  ...
  %.3.i128.i.i = phi i64 [ %i.ek, %zisofs_extract_init.exit.zisofs_extract_init.exit.thread126_crit_edge.i.i ], [ %.161.i.i.i, %bb.z ] ; 2 uses
  %i.eo = and i8 %4, 1
...
bb.ad:                                            ; preds = %bb.ac, %bb.o
  %.1101.i.i = phi i64 [ %.3.i128.i.i, %bb.ac ], [ %i.ct, %bb.o ] ; 5 uses
  %.199.i.i = phi ptr [ %i.et, %bb.ac ], [ %i.bv, %bb.o ] ; 2 uses
...
bb.ag:                                            ; preds = %bb.ae
  ...
  %i.ff = sub nsw i64 %i.ct, %.1101.i.i
...
bb.an:                                            ; preds = %bb.am, %bb.al
  %.0106.i.i = phi i32 [ %i.fm, %bb.al ], [ %i.fn, %bb.am ]
...
.thread137.i.i:                                   ; preds = %bb.ap, %bb.ad
  ...
  store ptr %.199.i.i, ptr %i.ck, align 8, !tbaa !144
  %i.gg = zext i32 %i.gf to i64
  %spec.select181.i.i = call i64 @llvm.umin.i64(i64 %.1101.i.i, i64 %i.gg)
...
zisofs_extract.exit.i:                            ; preds = %wb_consume.exit.thread141.i.i, %wb_consume.exit123.i.i, %bb.au, %bb.aq
  %.2102.i.i = phi i64 [ %i.gs, %bb.au ], [ %i.gs, %wb_consume.exit123.i.i ], [ %.1101.i.i, %bb.aq ], [ %.1101.i.i, %wb_consume.exit.thread141.i.i ]
  ...
  %i.hk = sub i64 %i.ct, %.2102.i.i               ; 2 uses
...
bb.av:                                            ; preds = %zisofs_extract.exit.i, %zisofs_extract.exit.thread84.i
  ...
  br i1 %.not.i, label %.thread.thread179.i, label %bb.n

.thread.i:                                        ; preds = %zisofs_extract.exit.i, %zisofs_extract_init.exit.i.i
  %.lcssa195.sink.i.ph = phi i64 [ %i.ek, %zisofs_extract_init.exit.i.i ], [ %i.hk, %zisofs_extract.exit.i ]
  %i.hm = trunc i64 %.lcssa195.sink.i.ph to i32   ; 2 uses
  %i.hn = icmp eq i32 %i.hm, 0
  br i1 %i.hn, label %.thread.thread179.i, label %wb_write_padding_to_temp.exit.thread.i

.thread.thread179.i:                              ; preds = %bb.av, %.thread.i, %.preheader.i
...
wb_write_padding_to_temp.exit.i:                  ; preds = %.thread.thread179.i
...
wb_write_padding_to_temp.exit.thread.i:           ; preds = %wb_consume.exit123.i.i, %wb_consume.exit.i.i, %wb_consume.exit123.thread.i.i, %bb.as, %bb.y, %bb.ao, %bb.r, %bb.t, %bb.af, %bb.ah, %bb.aj, %wb_consume.exit.thread.i.i, %wb_write_padding_to_temp.exit.i, %.thread.thread179.i, %.thread.i, %.thread.thread.i.a
  %.3.i = phi i32 [ %i.hm, %.thread.i ], [ 0, %.thread.thread179.i ], [ %spec.select89.i, %wb_write_padding_to_temp.exit.i ], [ -30, %.thread.thread.i.a ], [ -30, %wb_consume.exit.thread.i.i ], [ -30, %bb.aj ], [ -30, %bb.ah ], [ -30, %bb.af ], [ -30, %bb.t ], [ -30, %bb.r ], [ -30, %bb.ao ], [ -30, %bb.y ], [ -30, %bb.as ], [ -30, %wb_consume.exit123.thread.i.i ], [ %i.gc, %wb_consume.exit.i.i ], [ %i.hf, %wb_consume.exit123.i.i ] ; 2 uses
...
bb.ay:                                            ; preds = %zisofs_rewind_boot_file.exit._crit_edge, %zisofs_rewind_boot_file.exit.thread245
  %i.ie = phi ptr [ %.pre, %zisofs_rewind_boot_file.exit._crit_edge ], [ %i.au, %zisofs_rewind_boot_file.exit.thread245 ] ; 2 uses
...
._crit_edge:                                      ; preds = %bb.az
  %.pre337 = load ptr, ptr %i.e, align 8, !tbaa !72
  br label %bb.ba

bb.ba:                                            ; preds = %._crit_edge, %bb.ay
  %i.ij = phi ptr [ %.pre337, %._crit_edge ], [ %i.ie, %bb.ay ] ; 22 uses
...
.lr.ph.i.i199:                                    ; preds = %bb.bf, %.lr.ph.i.i199
  %.012.i.i = phi ptr [ %i.jn, %.lr.ph.i.i199 ], [ %i.jl, %bb.bf ] ; 2 uses
  %i.jm = getelementptr inbounds nuw i8, ptr %.012.i.i, i64 24
  ...
  br i1 %.not.i.i200, label %isofile_free.exit.i, label %.lr.ph.i.i199, !llvm.loop !90

isofile_free.exit.i:                              ; preds = %.lr.ph.i.i199, %bb.bf
...
._crit_edge.i:                                    ; preds = %bb.bg
  ...
  %.not.i197 = icmp eq i32 %i.kp, 0
  br i1 %.not.i197, label %bb.bi, label %isoent_create_boot_catalog.exit.thread
...
bb.h:                                             ; preds = %wb_consume.exit53, %wb_consume.exit50.thread
  %.036 = phi i64 [ %i.y, %wb_consume.exit50.thread ], [ %i.aq, %wb_consume.exit53 ] ; 3 uses
  %.not45 = icmp eq i64 %.036, 0
  br i1 %.not45, label %wb_consume.exit, label %bb.i

bb.i:                                             ; preds = %bb.h
  %spec.select = tail call i64 @llvm.umin.i64(i64 %.036, i64 %i.ah) ; 4 uses
...
bb.d:                                             ; preds = %bb.f, %.lr.ph.i
  ...
  %.01316.i = phi i64 [ %i.m, %.lr.ph.i ], [ %i.u, %bb.f ] ; 2 uses
  %i.p = load i32, ptr %i.o, align 8, !tbaa !38
  %i.q = tail call i64 @write(i32 noundef %i.p, ptr noundef %.017.i, i64 noundef %.01316.i) #23 ; 3 uses
...
bb.f:                                             ; preds = %bb.d
  %i.u = sub i64 %.01316.i, %i.q                  ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %.not62, label %._crit_edge, label %.critedge

._crit_edge:                                      ; preds = %bb.h
  %.pre71 = load ptr, ptr %i.h, align 8, !tbaa !39 ; 2 uses
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %.pre71, i64 176
  %.pre72 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !87 ; 2 uses
  %.phi.trans.insert73 = getelementptr inbounds nuw i8, ptr %.pre72, i64 8
  %.pre74 = load i64, ptr %.phi.trans.insert73, align 8, !tbaa !122
  br label %bb.k

bb.i:                                             ; preds = %bb.g
  %i.w = tail call fastcc i32 @wb_write_to_temp(ptr noundef nonnull %0, ptr noundef %1, i64 noundef %i.p)
  %.not61 = icmp eq i32 %i.w, 0
...
.lr.ph:                                           ; preds = %bb.h, %wb_consume.exit.thread
  ...
  %i.bf = tail call i32 @cm_zlib_deflate(ptr noundef nonnull %i.f, i32 noundef %.184) #23 ; 2 uses
...
bb.b:                                             ; preds = %bb.c, %.lr.ph.i
  ...
  %.01316.i = phi i64 [ %i.h, %.lr.ph.i ], [ %i.p, %bb.c ] ; 2 uses
  %i.m = load i32, ptr %i.l, align 8, !tbaa !38
  %i.n = tail call i64 @write(i32 noundef %i.m, ptr noundef %.017.i, i64 noundef %.01316.i) #23 ; 3 uses
  %i.o = icmp slt i64 %i.n, 0
  br i1 %i.o, label %write_to_temp.exit, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.p = sub i64 %.01316.i, %i.n                  ; 2 uses
...
bb.f:                                             ; preds = %bb.e, %bb.a
  %.142 = phi ptr [ %i.u, %bb.e ], [ %1, %bb.a ]
  %.038 = phi i64 [ %i.g, %bb.e ], [ %2, %bb.a ]  ; 2 uses
  %.not4763 = icmp eq i64 %.038, 0
  br i1 %.not4763, label %.thread, label %.lr.ph

.lr.ph:                                           ; preds = %bb.f, %.backedge
  %.13965 = phi i64 [ %.139.be, %.backedge ], [ %.038, %bb.f ] ; 2 uses
  %.24364 = phi ptr [ %.243.be, %.backedge ], [ %.142, %bb.f ] ; 2 uses
  ...
  %spec.select = tail call i64 @llvm.umin.i64(i64 %.13965, i64 %i.x) ; 6 uses
  %i.y = getelementptr inbounds nuw i8, ptr %i.v, i64 732
  %i.z = sub i64 65536, %i.x
  %i.aa = getelementptr inbounds nuw i8, ptr %i.y, i64 %i.z
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.aa, ptr align 1 %.24364, i64 %spec.select, i1 false)
...
.backedge:                                        ; preds = %bb.g, %.split
  %.139.be = sub i64 %.13965, %spec.select        ; 2 uses
...
bb.g:                                             ; preds = %bb.h, %.lr.ph.i
  ...
  %.01316.i = phi i64 [ %i.g, %.lr.ph.i ], [ %i.x, %bb.h ] ; 2 uses
  %i.u = load i32, ptr %i.t, align 8, !tbaa !38
  %i.v = tail call i64 @write(i32 noundef %i.u, ptr noundef %.017.i, i64 noundef %.01316.i) #23 ; 3 uses
  %i.w = icmp slt i64 %i.v, 0
  br i1 %i.w, label %write_to_temp.exit, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.x = sub i64 %.01316.i, %i.v                  ; 2 uses
...
bb.b:                                             ; preds = %.loopexit, %bb.a
  %.032 = phi ptr [ %i.b, %bb.a ], [ %.3, %.loopexit ] ; 13 uses
  %.031 = phi i32 [ 0, %bb.a ], [ %.2, %.loopexit ] ; 4 uses
  %.0 = phi i32 [ %1, %bb.a ], [ %i.bb, %.loopexit ] ; 2 uses
  %i.f = load i32, ptr %i.c, align 8, !tbaa !275
  %i.g = tail call fastcc i32 @set_directory_record(ptr noundef null, i64 noundef -1, ptr noundef %.032, ptr noundef readonly %0, i32 noundef 1, i32 noundef %i.f)
