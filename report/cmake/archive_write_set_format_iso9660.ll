...
.backedge.i.i:                                    ; preds = %.split.i.i, %bb.h
  %.139.be.i.i = sub nuw nsw i64 %.139.i24.i, %spec.select.i.i ; 2 uses
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.ek = sub nuw nsw i64 %.161.i.i.i, %spec.select.i.i.i ; 2 uses
...
zisofs_extract_init.exit.thread126.i.i:           ; preds = %bb.ab, %bb.aa, %bb.z
  ...
  %.3.i.i.i = phi i64 [ %i.ek, %bb.aa ], [ %.161.i.i.i, %bb.z ], [ %i.ek, %bb.ab ] ; 2 uses
  %i.eo = and i8 %2, 1
...
bb.ad:                                            ; preds = %bb.ac, %bb.o
  %.1101.i.i = phi i64 [ %.3.i.i.i, %bb.ac ], [ %i.ct, %bb.o ] ; 5 uses
...
wb_write_padding_to_temp.exit.thread.i:           ; preds = %wb_consume.exit123.i.i, %wb_consume.exit.i.i, %wb_write_padding_to_temp.exit.i, %.thread.thread179.i, %.thread.i, %wb_consume.exit123.thread.i.i, %bb.as, %wb_consume.exit.thread.i.i, %bb.ao, %bb.aj, %bb.ah, %bb.af, %bb.y, %bb.t, %bb.r, %.thread.thread.i.a
  %.3.i = phi i32 [ %i.hm, %.thread.i ], [ -30, %.thread.thread.i.a ], [ %spec.select89.i, %wb_write_padding_to_temp.exit.i ], [ 0, %.thread.thread179.i ], [ -30, %bb.ao ], [ -30, %wb_consume.exit.thread.i.i ], [ -30, %bb.aj ], [ -30, %bb.ah ], [ -30, %bb.af ], [ -30, %bb.t ], [ -30, %bb.r ], [ -30, %bb.y ], [ %i.gc, %wb_consume.exit.i.i ], [ -30, %bb.as ], [ -30, %wb_consume.exit123.thread.i.i ], [ %i.hf, %wb_consume.exit123.i.i ] ; 2 uses
...
wb_consume.exit53:                                ; preds = %bb.j, %bb.k
  ...
  %i.aq = sub nuw i64 %.036, %spec.select
...
.backedge:                                        ; preds = %bb.g, %.split
  %.139.be = sub nuw i64 %.13965, %spec.select    ; 2 uses
