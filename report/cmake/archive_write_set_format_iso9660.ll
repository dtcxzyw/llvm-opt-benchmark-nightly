...
set_digit.exit:
  ...
  %3 = add nsw i32 %i.h, 1900
  %4 = insertelement <4 x i32> poison, i32 %3, i64 0
  %5 = shufflevector <4 x i32> %4, <4 x i32> poison, <4 x i32> zeroinitializer
  %i.i = sdiv <4 x i32> %5, <i32 1000, i32 100, i32 10, i32 1>
  %6 = load <2 x i32>, ptr %i.d, align 4, !tbaa !90
  %7 = shufflevector <2 x i32> %6, <2 x i32> poison, <4 x i32> <i32 1, i32 1, i32 0, i32 0>
  %8 = add nsw <4 x i32> %7, <i32 1, i32 1, i32 0, i32 0>
  %i.j = sdiv <4 x i32> %8, <i32 10, i32 1, i32 10, i32 1>
  %i.k = shufflevector <4 x i32> %i.i, <4 x i32> %i.j, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
