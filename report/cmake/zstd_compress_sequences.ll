...
bb.b:                                             ; preds = %bb.a
  ...
  %notmask.i26.i = shl nsw i32 -1, %i.cg
  %13 = xor i32 %notmask.i26.i, -1
  %14 = zext i16 %i.cd to i32
  %15 = and i32 %13, %14
  %16 = zext nneg i32 %15 to i64
  %i.ch = zext nneg i8 %i.bx to i64
  %i.ci = shl i64 %16, %i.ch
...
bb.e:                                             ; preds = %bb.d
  ...
  %notmask.i27.i = shl nsw i32 -1, %i.cm
  %17 = xor i32 %notmask.i27.i, -1
  %i.cn = and i32 %.pre158.i, %17
...
.thread.i:                                        ; preds = %bb.e, %bb.d, %..thread_crit_edge.i
  ...
  %notmask.i28.i = shl nsw i32 -1, %i.dc
  %18 = xor i32 %notmask.i28.i, -1
  %i.de = and i32 %i.dd, %18
...
.lr.ph.i:                                         ; preds = %bb.p, %.lr.ph.preheader.i
  ...
  %notmask.i.i.i = shl nsw i32 -1, %i.et
  %20 = xor i32 %notmask.i.i.i, -1
  %i.eu = zext nneg i32 %20 to i64
  ...
  %notmask.i.i37.i = shl nsw i32 -1, %i.fi
  %21 = xor i32 %notmask.i.i37.i, -1
  %i.fj = zext nneg i32 %21 to i64
  ...
  %notmask.i.i41.i = shl nsw i32 -1, %i.fx
  %22 = xor i32 %notmask.i.i41.i, -1
  %i.fy = zext nneg i32 %22 to i64
...
bb.i:                                             ; preds = %bb.h, %.lr.ph.i
  ...
  %notmask.i43.i = shl nsw i32 -1, %i.ei
  %23 = xor i32 %notmask.i43.i, -1
  %i.gy = zext i16 %i.gx to i32
  %i.gz = and i32 %i.gy, %23
  ...
  %notmask.i44.i = shl nsw i32 -1, %i.en
  %24 = xor i32 %notmask.i44.i, -1
  %i.hh = zext i16 %i.hg to i32
  %i.hi = and i32 %i.hh, %24
...
bb.n:                                             ; preds = %bb.m
  ...
  %notmask.i46.i = shl nsw i32 -1, %i.hx
  %25 = xor i32 %notmask.i46.i, -1
  %i.hy = and i32 %.pre160.i, %25
...
.thread133.i:                                     ; preds = %bb.n, %bb.m, %..thread133_crit_edge.i
  ...
  %notmask.i48.i = shl nsw i32 -1, %i.in
  %26 = xor i32 %notmask.i48.i, -1
  %i.ip = and i32 %i.io, %26
...
bb.o:                                             ; preds = %bb.k
  ...
  %notmask.i49.i = shl nsw i32 -1, %i.ej
  %27 = xor i32 %notmask.i49.i, -1
  %i.iw = and i32 %i.iv, %27
