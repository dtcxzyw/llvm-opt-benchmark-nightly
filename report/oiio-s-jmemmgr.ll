begin_hunk_0
  ...
  %6 = load i32, ptr %.in, align 8, !tbaa !3      ; [#uses=1 type=i32]
  %.fr110 = freeze i32 %6                         ; [#uses=3 type=i32]
  %7 = icmp sgt i32 %.fr110, 8                    ; [#uses=1 type=i1]
...
.lr.ph:                                           ; preds = %3
  ...
  %23 = icmp slt i32 %.fr110, 9                   ; [#uses=1 type=i1]
...
.lr.ph.split.us.preheader:                        ; preds = %.lr.ph
  %.pre116 = load i32, ptr %17, align 8, !tbaa !99 ; [#uses=1 type=i32]
  %.135 = select i1 %.not96, ptr %24, ptr %25     ; [#uses=1 type=ptr]
  br label %.lr.ph.split.us

.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %42
  %26 = phi i32 [ %48, %42 ], [ %.pre116, %.lr.ph.split.us.preheader ] ; [#uses=1 type=i32]
...
.lr.ph.split:                                     ; preds = %.lr.ph
  %54 = icmp samesign ult i32 %.fr110, 13         ; [#uses=1 type=i1]
  %.pre115 = load i32, ptr %17, align 8, !tbaa !99 ; [#uses=3 type=i32]
...
.lr.ph.split.split.us:                            ; preds = %.lr.ph.split.split.us.preheader, %71
  %55 = phi i32 [ %77, %71 ], [ %.pre115, %.lr.ph.split.split.us.preheader ] ; [#uses=1 type=i32]
...
.lr.ph.split.split.split.us:                      ; preds = %.lr.ph.split.split, %99
  %83 = phi i32 [ %106, %99 ], [ %.pre115, %.lr.ph.split.split ] ; [#uses=1 type=i32]
...
.lr.ph.split.split.split:                         ; preds = %.lr.ph.split.split, %128
  %112 = phi i32 [ %135, %128 ], [ %.pre115, %.lr.ph.split.split ] ; [#uses=1 type=i32]
