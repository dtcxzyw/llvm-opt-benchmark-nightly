...
bb.a:
  %.val = load ptr, ptr %0, align 8, !nonnull !7, !align !8, !noundef !7
...
bb.b:                                             ; preds = %bb.a
  ...
  %.val5 = load ptr, ptr %i.c, align 8, !nonnull !7, !align !8, !noundef !7
...
bb.a:
  %.val2 = load ptr, ptr %0, align 8, !nonnull !7, !align !8, !noundef !7 ; 4 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %.val = load ptr, ptr %i.b, align 8, !nonnull !7, !align !8, !noundef !7
...
bb.c:                                             ; preds = %bb.a
  %.val.i.i = load ptr, ptr %.val2, align 8, !alias.scope !2728, !nonnull !7, !noundef !7
  %i.d = getelementptr inbounds nuw i8, ptr %.val2, i64 8
  %.val3.i.i = load i64, ptr %i.d, align 8, !alias.scope !2728, !noundef !7 ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %.val2, i64 32
  %i.f = load i64, ptr %i.e, align 8, !alias.scope !2728, !noundef !7
...
bb.a:
  %.val5 = load ptr, ptr %0, align 8, !nonnull !7, !align !8, !noundef !7 ; 2 uses
  %i.a = getelementptr inbounds nuw i8, ptr %.val5, i64 8
  %.val1.i.i = load i64, ptr %i.a, align 8, !alias.scope !2735, !noundef !7 ; 2 uses
  %i.b = getelementptr inbounds nuw i8, ptr %.val5, i64 32 ; 3 uses
  %i.c = load i64, ptr %i.b, align 8, !alias.scope !2735, !noundef !7 ; 4 uses
...
bb.b:                                             ; preds = %_RNvXNtNtCs14kzo5Se9zC_5bytes3buf8buf_implQINtNtNtCskKLDkoKarTP_4core2io6cursor6CursorNtNtB6_9bytes_mut8BytesMutENtB2_3Buf7advanceCsl8OoimOLbh_6qdrant.exit, %bb.a
  ...
  %.val = load ptr, ptr %i.e, align 8, !nonnull !7, !align !8, !noundef !7
...
_RNvXNtNtCs14kzo5Se9zC_5bytes3buf8buf_implQINtNtNtCskKLDkoKarTP_4core2io6cursor6CursorNtNtB6_9bytes_mut8BytesMutENtB2_3Buf7advanceCsl8OoimOLbh_6qdrant.exit: ; preds = %bb.c
  %i.f = add i64 %i.d, %i.c
  store i64 %i.f, ptr %i.b, align 8, !alias.scope !2736
...
_RNvXNtNtCs14kzo5Se9zC_5bytes3buf8buf_implQINtNtNtCskKLDkoKarTP_4core2io6cursor6CursorNtNtB6_9bytes_mut8BytesMutENtB2_3Buf7advanceCsl8OoimOLbh_6qdrant.exit9: ; preds = %bb.c
  %i.h = add i64 %i.c, %1
  store i64 %i.h, ptr %i.b, align 8, !alias.scope !2737
  br label %bb.d
...
bb.c:                                             ; preds = %bb.a
  %.val.i.i = load ptr, ptr %.val2, align 8, !alias.scope !2740, !nonnull !7, !noundef !7
  %i.d = getelementptr inbounds nuw i8, ptr %.val2, i64 8
  %.val3.i.i = load i64, ptr %i.d, align 8, !alias.scope !2740, !noundef !7 ; 2 uses
  %i.e = getelementptr inbounds nuw i8, ptr %.val2, i64 32
  %i.f = load i64, ptr %i.e, align 8, !alias.scope !2740, !noundef !7
  %..i.i.i = tail call noundef i64 @llvm.umin.i64(i64 %.val3.i.i, i64 %i.f) ; 2 uses
  %i.g = sub nuw i64 %.val3.i.i, %..i.i.i
  %i.h = getelementptr inbounds nuw i8, ptr %.val.i.i, i64 %..i.i.i
  %i.i = insertvalue { ptr, i64 } poison, ptr %i.h, 0
...
bb.a:
  %.val5 = load ptr, ptr %0, align 8, !nonnull !7, !align !8, !noundef !7 ; 2 uses
  %i.a = getelementptr inbounds nuw i8, ptr %.val5, i64 8
  %.val1.i.i = load i64, ptr %i.a, align 8, !alias.scope !2747, !noundef !7 ; 2 uses
  %i.b = getelementptr inbounds nuw i8, ptr %.val5, i64 32 ; 3 uses
  %i.c = load i64, ptr %i.b, align 8, !alias.scope !2747, !noundef !7 ; 4 uses
  %i.d = tail call i64 @llvm.usub.sat.i64(i64 %.val1.i.i, i64 %i.c) ; 3 uses
  %.not10 = icmp ugt i64 %.val1.i.i, %i.c
  br i1 %.not10, label %bb.c, label %bb.b
...
_RNvXNtNtCs14kzo5Se9zC_5bytes3buf8buf_implQINtNtNtCskKLDkoKarTP_4core2io6cursor6CursorNtNtB6_9bytes_mut8BytesMutENtB2_3Buf7advanceCsl8OoimOLbh_6qdrant.exit: ; preds = %bb.c
  %i.f = add i64 %i.d, %i.c
  store i64 %i.f, ptr %i.b, align 8, !alias.scope !2748
  %i.g = sub nuw i64 %1, %i.d
  br label %bb.b

_RNvXNtNtCs14kzo5Se9zC_5bytes3buf8buf_implQINtNtNtCskKLDkoKarTP_4core2io6cursor6CursorNtNtB6_9bytes_mut8BytesMutENtB2_3Buf7advanceCsl8OoimOLbh_6qdrant.exit9: ; preds = %bb.c
  %i.h = add i64 %i.c, %1
  store i64 %i.h, ptr %i.b, align 8, !alias.scope !2749
  br label %bb.d
...
bb.a:
  ...
  %i.h = load i64, ptr %i.g, align 8, !alias.scope !2765, !noalias !2764, !noundef !7 ; 3 uses
  %i.i = icmp eq i64 %i.h, 0
  br i1 %i.i, label %bb.j, label %bb.b

bb.b:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f), !noalias !2766
  call void @_RNvMs5_NtCsexYYUdYSQU6_5alloc7raw_vecNtB5_11RawVecInner15try_allocate_inCsl8OoimOLbh_6qdrant(ptr noalias nofree noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.f, i64 noundef 0, i1 noundef zeroext false, i64 noundef 1, i64 noundef 1), !noalias !2766
  %i.j = load i64, ptr %i.f, align 8, !range !13, !noalias !2766, !noundef !7
  %i.k = trunc nuw i64 %i.j to i1
  %i.l = getelementptr inbounds nuw i8, ptr %i.f, i64 8
  %i.m = load i64, ptr %i.l, align 8, !range !14, !noalias !2766, !noundef !7 ; 3 uses
  %i.n = getelementptr inbounds nuw i8, ptr %i.f, i64 16 ; 2 uses
  br i1 %i.k, label %bb.c, label %_RNvMs_NtCs14kzo5Se9zC_5bytes9bytes_mutNtB4_8BytesMut13with_capacity.exit.i, !prof !10

bb.c:                                             ; preds = %bb.b
  %i.o = load i64, ptr %i.n, align 8, !noalias !2766
  tail call void @_RNvNtCsexYYUdYSQU6_5alloc7raw_vec12handle_error(i64 noundef %i.m, i64 %i.o) #26, !noalias !2766
  unreachable

_RNvMs_NtCs14kzo5Se9zC_5bytes9bytes_mutNtB4_8BytesMut13with_capacity.exit.i: ; preds = %bb.b
  %i.p = load ptr, ptr %i.n, align 8, !noalias !2766, !nonnull !7, !noundef !7
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f), !noalias !2766
  %i.q = lshr i64 %i.m, 10
  ...
  %.sroa.015.0.copyload.i = load ptr, ptr %1, align 8, !alias.scope !2765, !noalias !2764 ; 4 uses
  %.sroa.719.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  %.sroa.719.0.copyload.i = load i64, ptr %.sroa.719.0..sroa_idx.i, align 8, !alias.scope !2765, !noalias !2764
  %.sroa.8.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %1, i64 24 ; 2 uses
  %.sroa.8.0.copyload.i = load ptr, ptr %.sroa.8.0..sroa_idx.i, align 8, !alias.scope !2765, !noalias !2764 ; 2 uses
  store ptr %i.p, ptr %1, align 8, !alias.scope !2765, !noalias !2764
  store i64 0, ptr %i.g, align 8, !alias.scope !2765, !noalias !2764
  store i64 %i.m, ptr %.sroa.719.0..sroa_idx.i, align 8, !alias.scope !2765, !noalias !2764
  store ptr %i.v, ptr %.sroa.8.0..sroa_idx.i, align 8, !alias.scope !2765, !noalias !2764
...
bb.d:                                             ; preds = %_RNvMs_NtCs14kzo5Se9zC_5bytes9bytes_mutNtB4_8BytesMut13with_capacity.exit.i
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e), !noalias !2767
  ...
  store i64 %i.ac, ptr %i.e, align 8, !noalias !2767
  %i.ae = getelementptr inbounds nuw i8, ptr %i.e, i64 8
  store ptr %i.aa, ptr %i.ae, align 8, !noalias !2767
  %i.af = getelementptr inbounds nuw i8, ptr %i.e, i64 16
  store i64 %i.ab, ptr %i.af, align 8, !noalias !2767
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !2767
  call void @_RNvXsE_NtCs14kzo5Se9zC_5bytes5bytesNtB5_5BytesINtNtCskKLDkoKarTP_4core7convert4FromINtNtCsexYYUdYSQU6_5alloc3vec3VechEE4from(ptr noalias nofree noundef nonnull sret([32 x i8]) align 8 captures(address) dereferenceable(32) %i.d, ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(24) %i.e), !noalias !2767
  ...
  store i64 %i.y, ptr %i.c, align 8, !noalias !2769
  %i.ag = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  %i.ah = load i64, ptr %i.ag, align 8, !alias.scope !2768, !noalias !2767, !noundef !7 ; 4 uses
  %.not.i.i.i = icmp ugt i64 %i.y, %i.ah
  br i1 %.not.i.i.i, label %bb.e, label %bb.h, !prof !10

bb.e:                                             ; preds = %bb.d
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !2769
  store i64 %i.ah, ptr %i.b, align 8, !noalias !2769
  ...
  store ptr @_RNvXsZ_NtNtCskKLDkoKarTP_4core3fmt3numjNtB7_5Debug3fmt, ptr %.sroa.42.0..sroa_idx.i.i.i, align 8, !noalias !2769
  %i.ai = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store ptr %i.b, ptr %i.ai, align 8, !noalias !2769
  %.sroa.46.0..sroa_idx.i.i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  store ptr @_RNvXsZ_NtNtCskKLDkoKarTP_4core3fmt3numjNtB7_5Debug3fmt, ptr %.sroa.46.0..sroa_idx.i.i.i, align 8, !noalias !2769
  invoke void @_RNvNtCskKLDkoKarTP_4core9panicking9panic_fmt(ptr noundef nonnull @1, ptr noundef nonnull %i.a, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @7) #25
          to label %.noexc.i.i unwind label %bb.g, !noalias !2767
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.al = load ptr, ptr %i.ak, align 8, !alias.scope !2772, !noalias !2767, !noundef !7
  %i.am = load ptr, ptr %i.d, align 8, !alias.scope !2772, !noalias !2767, !nonnull !7, !align !8, !noundef !7
  %i.an = getelementptr inbounds nuw i8, ptr %i.am, i64 32
  %i.ao = load ptr, ptr %i.an, align 8, !noalias !2773, !nonnull !7, !noundef !7
  %i.ap = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  %i.aq = load ptr, ptr %i.ap, align 8, !alias.scope !2772, !noalias !2767, !noundef !7
  invoke void %i.ao(ptr noundef %i.al, ptr noundef %i.aq, i64 noundef %i.ah)
          to label %_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueNtNtCs14kzo5Se9zC_5bytes5bytes5BytesECsl8OoimOLbh_6qdrant.exit.i.i unwind label %bb.i, !noalias !2767, !inline_history !0

bb.h:                                             ; preds = %bb.d
  %i.ar = sub nuw i64 %i.ah, %i.y
  %i.as = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  %i.at = load ptr, ptr %i.as, align 8, !alias.scope !2768, !noalias !2767, !noundef !7
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d), !noalias !2767
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e), !noalias !2767
  br label %_RNvMs_NtCs14kzo5Se9zC_5bytes9bytes_mutNtB4_8BytesMut6freeze.exit.i

bb.i:                                             ; preds = %bb.g
  %i.av = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCskKLDkoKarTP_4core9panicking16panic_in_cleanup() #22, !noalias !2767
  unreachable
...
_RNvMs_NtCs14kzo5Se9zC_5bytes9bytes_mutNtB4_8BytesMut6freeze.exit.i: ; preds = %bb.h, %bb.f
  ...
  store ptr %.sroa.0.0.i, ptr %.sroa.5, align 8, !alias.scope !2764, !noalias !2765
  br label %bb.j
...
bb.j:                                             ; preds = %_RNvMs_NtCs14kzo5Se9zC_5bytes9bytes_mutNtB4_8BytesMut6freeze.exit.i, %bb.a
  ...
  store ptr %.sink.i, ptr %.sink27.i.sroa.phi, align 8, !alias.scope !2764, !noalias !2765
...
bb.a:
  ...
  %i.e = load i64, ptr %i.d, align 8, !alias.scope !2778, !noalias !2779, !noundef !7 ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.a, ptr noundef nonnull align 8 dereferenceable(24) %1, i64 24, i1 false), !noalias !2779
  store i64 0, ptr %1, align 8, !alias.scope !2778, !noalias !2779
  %.sroa.44.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %1, i64 8
  store ptr inttoptr (i64 1 to ptr), ptr %.sroa.44.0..sroa_idx.i, align 8, !alias.scope !2778, !noalias !2779
  store i64 0, ptr %i.d, align 8, !alias.scope !2778, !noalias !2779
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !alias.scope !2784, !noalias !2785, !noundef !7 ; 2 uses
  %i.c = icmp eq i64 %i.b, 0
  br i1 %i.c, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.d = load ptr, ptr %1, align 8, !alias.scope !2784, !noalias !2785, !nonnull !7, !noundef !7
  store ptr inttoptr (i64 1 to ptr), ptr %1, align 8, !alias.scope !2784, !noalias !2785, !captures !15
  store i64 0, ptr %i.a, align 8, !alias.scope !2784, !noalias !2785
  %.sroa.45.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 8
...
bb.a:
  ...
  %.val.i = load ptr, ptr %0, align 8, !alias.scope !2791, !nonnull !7, !align !8, !noundef !7
  %i.a = tail call noundef i64 @_RNvXs_NtNtNtCs1EZwNlLr5NN_2h25proto7streams10prioritizeINtB4_11PrioritizedNtNtCs14kzo5Se9zC_5bytes5bytes5BytesENtNtNtB1e_3buf8buf_impl3Buf9remainingCsl8OoimOLbh_6qdrant(ptr noundef nonnull align 8 %.val.i), !noalias !2791
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.c = load i64, ptr %i.b, align 8, !alias.scope !2791, !noundef !7
...
bb.a:
  ...
  %.val.i = load ptr, ptr %0, align 8, !alias.scope !2794, !nonnull !7, !align !8, !noundef !7
  %i.a = tail call noundef i64 @_RNvXs_NtNtNtCsgwvynAR9gqy_2h25proto7streams10prioritizeINtB4_11PrioritizedINtNtNtCs3WWrd2JY12C_5hyper5proto2h27SendBufNtNtCs14kzo5Se9zC_5bytes5bytes5BytesEENtNtNtB1W_3buf8buf_impl3Buf9remainingCsl8OoimOLbh_6qdrant(ptr noundef nonnull align 8 %.val.i), !noalias !2794
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.c = load i64, ptr %i.b, align 8, !alias.scope !2794, !noundef !7
  %..i.i = tail call noundef i64 @llvm.umin.i64(i64 %i.c, i64 %i.a)
  %i.d = icmp ne i64 %..i.i, 0
  ret i1 %i.d
}
...
bb.a:
  ...
  %.val.i = load ptr, ptr %0, align 8, !alias.scope !2797, !nonnull !7, !align !8, !noundef !7
  %.val.i.i = load ptr, ptr %.val.i, align 8, !noalias !2797, !nonnull !7, !align !8, !noundef !7
  %.val.i.i.i = load ptr, ptr %.val.i.i, align 8, !noalias !2797, !nonnull !7, !align !8, !noundef !7
  %i.a = getelementptr i8, ptr %.val.i.i.i, i64 8
  %.val.i.i.i.i = load i64, ptr %i.a, align 8, !noalias !2797, !noundef !7
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.c = load i64, ptr %i.b, align 8, !alias.scope !2797, !noundef !7
...
bb.a:
  ...
  %.val.i = load ptr, ptr %0, align 8, !alias.scope !2800, !nonnull !7, !align !8, !noundef !7
  %i.a = getelementptr i8, ptr %.val.i, i64 8
  %.val.i.i = load i64, ptr %i.a, align 8, !noalias !2800, !noundef !7
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.c = load i64, ptr %i.b, align 8, !alias.scope !2800, !noundef !7
...
bb.a:
  %.val = load ptr, ptr %0, align 8, !nonnull !7, !align !8, !noundef !7 ; 2 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  %.val1 = load ptr, ptr %i.a, align 8, !nonnull !7, !align !8, !noundef !7
  %i.b = getelementptr inbounds nuw i8, ptr %.val, i64 8
  %.val1.i.i.i = load i64, ptr %i.b, align 8, !alias.scope !2803, !noundef !7
  %i.c = getelementptr inbounds nuw i8, ptr %.val, i64 32
  %i.d = load i64, ptr %i.c, align 8, !alias.scope !2803, !noundef !7
...
bb.a:
  ...
  %.val1 = load ptr, ptr %i.a, align 8, !nonnull !7, !align !8, !noundef !7
  %i.b = getelementptr inbounds nuw i8, ptr %.val, i64 8
  %.val1.i.i.i = load i64, ptr %i.b, align 8, !alias.scope !2806, !noundef !7
  %i.c = getelementptr inbounds nuw i8, ptr %.val, i64 32
  %i.d = load i64, ptr %i.c, align 8, !alias.scope !2806, !noundef !7
  %i.e = tail call noundef i64 @llvm.usub.sat.i64(i64 %.val1.i.i.i, i64 %i.d)
