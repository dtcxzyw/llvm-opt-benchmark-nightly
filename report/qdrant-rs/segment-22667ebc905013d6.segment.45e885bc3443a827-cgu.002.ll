...
bb.b:                                             ; preds = %bb.a
  ...
  %.val3.i.i.i = load i64, ptr %i.c, align 8, !range !8137, !alias.scope !8131, !noalias !8138, !noundef !5 ; 3 uses
  %spec.select.i.i.i.i = icmp ult i64 %.val3.i.i.i, -2
  %spec.select.i.i.i.i.a = icmp ugt i64 %.val3.i.i.i, -3
  ...
  br i1 %spec.select.i.i.i.i, label %bb.kd, label %bb.c
