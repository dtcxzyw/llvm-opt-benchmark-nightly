...
_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueINtNtNtNtCsG258MDvU3F_3std11collections4hash3map7HashMapyRNtNtNtCsl8OoimOLbh_6qdrant6common9telemetry13TelemetryDataEEB1D_.exit: ; preds = %.body58, %bb.b
  ...
  %.pn52.a = phi { ptr, i32 } [ %i.bv, %bb.b ], [ %.pn, %.body58 ] ; 2 uses
...
.body:                                            ; preds = %bb.gs, %bb.f, %bb.i, %bb.gw, %_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueINtNtNtNtCsG258MDvU3F_3std11collections4hash3map7HashMapyRNtNtNtCsl8OoimOLbh_6qdrant6common9telemetry13TelemetryDataEEB1D_.exit
  %.pn54 = phi { ptr, i32 } [ %.pn52.a, %_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueINtNtNtNtCsG258MDvU3F_3std11collections4hash3map7HashMapyRNtNtNtCsl8OoimOLbh_6qdrant6common9telemetry13TelemetryDataEEB1D_.exit ], [ %.pn52.a, %bb.gw ], [ %i.cb, %bb.f ], [ %i.cd, %bb.i ], [ %i.wh, %bb.gs ]
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %bb.dq, %bb.dr
  ...
  %i.rk = add i64 %.sroa.01.0.i.i.i.i.i.i.i, %i.rj
  %i.rl = and i64 %i.rk, %i.rb
  %i.rm = sub nsw i64 0, %i.rl
  %i.rn = getelementptr inbounds [32 x i8], ptr %i.rc, i64 %i.rm ; 3 uses
  %i.ro = getelementptr inbounds i8, ptr %i.rn, i64 -32
  %i.rp = invoke noundef zeroext i1 @_RNvXCsjqcU1oJFKXj_9hashbrownmINtB2_10EquivalentmE10equivalentCsl8OoimOLbh_6qdrant(ptr noalias nofree noundef nonnull readonly align 4 captures(address, read_provenance) dereferenceable(4) %i.nf, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(32) %i.ro)
          to label %.noexc57.i.i unwind label %.loopexit.i62.i, !noalias !390

.noexc57.i.i:                                     ; preds = %.lr.ph.i.i.i.i.i.i
  br i1 %i.rp, label %_RINvMs1_NtCsjqcU1oJFKXj_9hashbrown3mapINtB6_7HashMapmNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryNtNtNtCsG258MDvU3F_3std4hash6random11RandomStateE3getmECsl8OoimOLbh_6qdrant.exit.i.i.i.i, label %bb.dr, !prof !6

._crit_edge.i.i.i.i.i.i:                          ; preds = %bb.dr, %bb.dq
  %i.rq = icmp eq <16 x i8> %.sroa.0.0.copyload.i24.i.i.i.i.i.i, splat (i8 -1)
  %i.rr = bitcast <16 x i1> %i.rq to i16
  %i.rs = icmp eq i16 %i.rr, 0
  br i1 %i.rs, label %bb.ds, label %select.unfold.i.i.i.i, !prof !28

bb.dr:                                            ; preds = %.noexc57.i.i
  %i.rt = add i16 %.sroa.06.0.i31.i.i.i.i.i.i, -1
  %i.ru = and i16 %i.rt, %.sroa.06.0.i31.i.i.i.i.i.i ; 2 uses
  %.not.i.not.i.i.i.i.i.i = icmp eq i16 %i.ru, 0
  br i1 %.not.i.not.i.i.i.i.i.i, label %._crit_edge.i.i.i.i.i.i, label %.lr.ph.i.i.i.i.i.i

bb.ds:                                            ; preds = %._crit_edge.i.i.i.i.i.i
  %i.rv = add i64 %.sroa.9.0.i.i.i.i.i.i.i, 16    ; 2 uses
  %i.rw = add i64 %.sroa.01.0.i.i.i.i.i.i.i, %i.rv
  br label %bb.dq

_RINvMs1_NtCsjqcU1oJFKXj_9hashbrown3mapINtB6_7HashMapmNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryNtNtNtCsG258MDvU3F_3std4hash6random11RandomStateE3getmECsl8OoimOLbh_6qdrant.exit.i.i.i.i: ; preds = %.noexc57.i.i
  %i.rx = getelementptr inbounds i8, ptr %i.rn, i64 -24 ; 2 uses
  %i.ry = load i64, ptr %i.rx, align 8, !range !474, !noalias !475, !noundef !8 ; 3 uses
  %i.rz = icmp ne i64 %i.ry, -9223372036854775805
  call void @llvm.assume(i1 %i.rz)
  %i.sa = xor i64 %i.ry, -9223372036854775808
  %i.sb = icmp slt i64 %i.ry, 0
  %i.sc = select i1 %i.sb, i64 %i.sa, i64 3
  switch i64 %i.sc, label %bb.dt [
    i64 0, label %bb.dy
    i64 1, label %bb.du
    i64 2, label %bb.dv
    i64 3, label %bb.dw
...
select.unfold.i.i.i.i:                            ; preds = %._crit_edge.i.i.i.i.i.i, %bb.do
  store i64 -1, ptr %i.c, align 8, !alias.scope !450, !noalias !476
...
bb.dt:                                            ; preds = %_RINvMs1_NtCsjqcU1oJFKXj_9hashbrown3mapINtB6_7HashMapmNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryNtNtNtCsG258MDvU3F_3std4hash6random11RandomStateE3getmECsl8OoimOLbh_6qdrant.exit.i.i.i.i
  unreachable

bb.du:                                            ; preds = %_RINvMs1_NtCsjqcU1oJFKXj_9hashbrown3mapINtB6_7HashMapmNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryNtNtNtCsG258MDvU3F_3std4hash6random11RandomStateE3getmECsl8OoimOLbh_6qdrant.exit.i.i.i.i
  %i.sd = getelementptr inbounds i8, ptr %i.rn, i64 -16
  %i.se = load i64, ptr %i.sd, align 8, !noalias !475, !noundef !8
  %i.sf = insertelement <2 x i64> <i64 poison, i64 undef>, i64 %i.se, i64 0
  br label %bb.dy

bb.dv:                                            ; preds = %_RINvMs1_NtCsjqcU1oJFKXj_9hashbrown3mapINtB6_7HashMapmNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryNtNtNtCsG258MDvU3F_3std4hash6random11RandomStateE3getmECsl8OoimOLbh_6qdrant.exit.i.i.i.i
  br label %bb.dy

bb.dw:                                            ; preds = %_RINvMs1_NtCsjqcU1oJFKXj_9hashbrown3mapINtB6_7HashMapmNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryNtNtNtCsG258MDvU3F_3std4hash6random11RandomStateE3getmECsl8OoimOLbh_6qdrant.exit.i.i.i.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !477
  invoke void @_RNvXs4_NtCsexYYUdYSQU6_5alloc6stringNtB5_6StringNtNtCskKLDkoKarTP_4core5clone5Clone5clone(ptr noalias nofree noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.b, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.rx)
          to label %.noexc58.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split.i.i, !noalias !390

.noexc58.i.i:                                     ; preds = %bb.dw
  %.sroa.08.0.copyload.i.i.i.i = load i64, ptr %i.b, align 8, !noalias !477
  %i.sg = load <2 x i64>, ptr %.sroa.4.0..sroa_idx.i.i.i.i, align 8, !noalias !477
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !477
  br label %bb.dy

bb.dx:                                            ; preds = %_RINvMs1_NtCsjqcU1oJFKXj_9hashbrown3mapINtB6_7HashMapmNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryNtNtNtCsG258MDvU3F_3std4hash6random11RandomStateE3getmECsl8OoimOLbh_6qdrant.exit.i.i.i.i
  br label %bb.dy
...
bb.dz:                                            ; preds = %_RNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry24get_collection_telemetry.exit.i.i.i
  store i64 -1, ptr %i.c, align 8, !noalias !448
  br label %_RNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards00Bb_.exit.i.i.i

_RNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards00Bb_.exit.i.i.i: ; preds = %bb.dz, %bb.dy, %select.unfold.i.i.i.i
  %.sroa.0.0.copyload66.i.i = phi i64 [ -1, %bb.dz ], [ -1, %select.unfold.i.i.i.i ], [ %.sroa.02.0.i.i.i.i, %bb.dy ] ; 5 uses
  %i.si = getelementptr inbounds nuw i8, ptr %.val5.i.i.i.i.i, i64 816
  %i.sj = load i64, ptr %i.si, align 8, !range !155, !noalias !449, !noundef !8
  %.not17.i.i.i = icmp eq i64 %i.sj, -1
  br i1 %.not17.i.i.i, label %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtNtCsPYQCUnoTxQ_10collection6shards9telemetry19ReplicaSetTelemetryENtNtNtNtBb_4iter6traits8iterator8Iterator4findNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0s_0EB2U_.exit.thread.i.i.i, label %bb.ea

bb.ea:                                            ; preds = %_RNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards00Bb_.exit.i.i.i
  %i.sk = getelementptr inbounds nuw i8, ptr %.val5.i.i.i.i.i, i64 824
  %i.sl = load ptr, ptr %i.sk, align 8, !noalias !449, !nonnull !8, !noundef !8 ; 2 uses
  %i.sm = getelementptr inbounds nuw i8, ptr %.val5.i.i.i.i.i, i64 832
  %i.sn = load i64, ptr %i.sm, align 8, !noalias !449, !noundef !8 ; 2 uses
  %.idx = mul nuw nsw i64 %i.sn, 544
  %i.so = getelementptr inbounds nuw i8, ptr %i.sl, i64 %.idx
  call void @llvm.experimental.noalias.scope.decl(metadata !478)
  %i.sp = load i32, ptr %i.nf, align 8, !alias.scope !478, !noalias !481
  %i.sq = icmp eq i64 %i.sn, 0
  br i1 %i.sq, label %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtNtCsPYQCUnoTxQ_10collection6shards9telemetry19ReplicaSetTelemetryENtNtNtNtBb_4iter6traits8iterator8Iterator4findNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0s_0EB2U_.exit.thread.i.i.i, label %.lr.ph

bb.eb:                                            ; preds = %.lr.ph
  %i.sr = getelementptr inbounds nuw i8, ptr %i.st, i64 544 ; 2 uses
  %i.ss = icmp eq ptr %i.sr, %i.so
  br i1 %i.ss, label %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtNtCsPYQCUnoTxQ_10collection6shards9telemetry19ReplicaSetTelemetryENtNtNtNtBb_4iter6traits8iterator8Iterator4findNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0s_0EB2U_.exit.thread.i.i.i, label %.lr.ph

.lr.ph:                                           ; preds = %bb.ea, %bb.eb
  %i.st = phi ptr [ %i.sr, %bb.eb ], [ %i.sl, %bb.ea ] ; 14 uses
  %i.su = getelementptr inbounds nuw i8, ptr %i.st, i64 536
  %i.sv = load i32, ptr %i.su, align 8, !noalias !483, !noundef !8
  %i.sw = icmp eq i32 %i.sv, %i.sp
  br i1 %i.sw, label %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtNtCsPYQCUnoTxQ_10collection6shards9telemetry19ReplicaSetTelemetryENtNtNtNtBb_4iter6traits8iterator8Iterator4findNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0s_0EB2U_.exit.i.i.i, label %bb.eb

_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtNtCsPYQCUnoTxQ_10collection6shards9telemetry19ReplicaSetTelemetryENtNtNtNtBb_4iter6traits8iterator8Iterator4findNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0s_0EB2U_.exit.i.i.i: ; preds = %.lr.ph
  %i.sx = getelementptr inbounds nuw i8, ptr %i.st, i64 24
  %i.sy = load i64, ptr %i.sx, align 8, !range !163, !noalias !449, !noundef !8 ; 2 uses
  %.not19.i.i.i = icmp eq i64 %i.sy, 2
  br i1 %.not19.i.i.i, label %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtNtCsPYQCUnoTxQ_10collection6shards9telemetry19ReplicaSetTelemetryENtNtNtNtBb_4iter6traits8iterator8Iterator4findNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0s_0EB2U_.exit.thread.i.i.i, label %_RNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0B9_.exit.i.i

_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtNtCsPYQCUnoTxQ_10collection6shards9telemetry19ReplicaSetTelemetryENtNtNtNtBb_4iter6traits8iterator8Iterator4findNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0s_0EB2U_.exit.thread.i.i.i: ; preds = %bb.eb, %bb.ea, %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtNtCsPYQCUnoTxQ_10collection6shards9telemetry19ReplicaSetTelemetryENtNtNtNtBb_4iter6traits8iterator8Iterator4findNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0s_0EB2U_.exit.i.i.i, %_RNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards00Bb_.exit.i.i.i
  %i.sz = icmp eq i64 %.sroa.0.0.copyload66.i.i, -1
  br i1 %i.sz, label %_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryEECsl8OoimOLbh_6qdrant.exit.i.i.i, label %bb.ec

bb.ec:                                            ; preds = %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtNtCsPYQCUnoTxQ_10collection6shards9telemetry19ReplicaSetTelemetryENtNtNtNtBb_4iter6traits8iterator8Iterator4findNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0s_0EB2U_.exit.thread.i.i.i
  %i.ta = icmp ne i64 %.sroa.0.0.copyload66.i.i, -9223372036854775805
  call void @llvm.assume(i1 %i.ta)
  %i.tb = icmp sgt i64 %.sroa.0.0.copyload66.i.i, -1
  br i1 %i.tb, label %bb.ed, label %_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryEECsl8OoimOLbh_6qdrant.exit.i.i.i
...
bb.ed:                                            ; preds = %bb.ec
  invoke void @_RNvXsp_NtCsexYYUdYSQU6_5alloc3vecINtB5_3VechENtNtNtCskKLDkoKarTP_4core3ops4drop4Drop4dropCsl8OoimOLbh_6qdrant(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.c)
          to label %_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueNtNtCsPYQCUnoTxQ_10collection9telemetry31ShardCleanStatusFailedTelemetryECsl8OoimOLbh_6qdrant.exit.i.i.i.i.i unwind label %bb.ee, !noalias !449
...
bb.ee:                                            ; preds = %bb.ed
  ...
  invoke void @_RNvXs1_NtCsexYYUdYSQU6_5alloc7raw_vecINtB5_6RawVechENtNtNtCskKLDkoKarTP_4core3ops4drop4Drop4dropCsl8OoimOLbh_6qdrant(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.c)
          to label %.thread80.i.i unwind label %bb.ef, !noalias !449

bb.ef:                                            ; preds = %bb.ee
  %i.td = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCskKLDkoKarTP_4core9panicking16panic_in_cleanup() #16, !noalias !449
  unreachable

_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueNtNtCsPYQCUnoTxQ_10collection9telemetry31ShardCleanStatusFailedTelemetryECsl8OoimOLbh_6qdrant.exit.i.i.i.i.i: ; preds = %bb.ed
  invoke void @_RNvXs1_NtCsexYYUdYSQU6_5alloc7raw_vecINtB5_6RawVechENtNtNtCskKLDkoKarTP_4core3ops4drop4Drop4dropCsl8OoimOLbh_6qdrant(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.c)
          to label %_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryEECsl8OoimOLbh_6qdrant.exit.i.i.i unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split.i.i, !noalias !390

_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryEECsl8OoimOLbh_6qdrant.exit.i.i.i: ; preds = %_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueNtNtCsPYQCUnoTxQ_10collection9telemetry31ShardCleanStatusFailedTelemetryECsl8OoimOLbh_6qdrant.exit.i.i.i.i.i, %bb.ec, %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtNtCsPYQCUnoTxQ_10collection6shards9telemetry19ReplicaSetTelemetryENtNtNtNtBb_4iter6traits8iterator8Iterator4findNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0s_0EB2U_.exit.thread.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !448
  br label %_RNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0B9_.exit.thread.i.i

select.unfold.loopexit.i.i:                       ; preds = %._crit_edge.i.i.i.i77
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.8.i.i)
  br label %_RNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0B9_.exit.thread.i.i

_RNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0B9_.exit.i.i: ; preds = %_RINvXs2J_NtNtCskKLDkoKarTP_4core5slice4iterINtB7_4IterNtNtNtCsPYQCUnoTxQ_10collection6shards9telemetry19ReplicaSetTelemetryENtNtNtNtBb_4iter6traits8iterator8Iterator4findNCNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0s_0EB2U_.exit.i.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.8.i.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.8.0..sroa_idx4.i.i.i.i, i64 16, i1 false), !noalias !484
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !448
  %.not43.i.i = icmp eq i64 %.sroa.0.0.copyload66.i.i, -2
  br i1 %.not43.i.i, label %_RNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0B9_.exit.thread.i.i, label %bb.eg

bb.eg:                                            ; preds = %_RNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0B9_.exit.i.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.o), !noalias !385
  store i64 %.sroa.0.0.copyload66.i.i, ptr %i.o, align 8, !noalias !385
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.8.0..sroa_idx.i.i, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.8.i.i, i64 16, i1 false), !noalias !385
  %i.te = load i64, ptr %i.nx, align 8, !noalias !390, !noundef !8
  %i.tf = load i8, ptr %i.ny, align 1, !range !396, !noalias !390, !noundef !8
  %i.tg = getelementptr inbounds nuw i8, ptr %i.st, i64 433
  %i.th = load i8, ptr %i.tg, align 1, !range !215, !noalias !390, !noundef !8
  %i.ti = getelementptr inbounds nuw i8, ptr %i.st, i64 328
  %i.tj = load i64, ptr %i.ti, align 8, !noalias !390, !noundef !8
  %i.tk = getelementptr inbounds nuw i8, ptr %i.st, i64 32
  %i.tl = load <2 x i64>, ptr %i.tk, align 8, !noalias !390
  %i.tm = getelementptr inbounds nuw i8, ptr %i.st, i64 48
  %i.tn = load <2 x i64>, ptr %i.tm, align 8, !noalias !390
  %i.to = getelementptr inbounds nuw i8, ptr %i.st, i64 64
  %i.tp = load <2 x i64>, ptr %i.to, align 8, !noalias !390
  %i.tq = getelementptr inbounds nuw i8, ptr %i.st, i64 80
  %i.tr = load i64, ptr %i.tq, align 8, !noalias !390
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.5.i.i)
  %i.ts = getelementptr inbounds nuw i8, ptr %i.st, i64 336 ; 2 uses
  %i.tt = load ptr, ptr %i.ts, align 8, !noalias !390, !noundef !8
  %.not44.i.i = icmp eq ptr %i.tt, null
  br i1 %.not44.i.i, label %bb.ei, label %bb.eh

_RNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0B9_.exit.thread.i.i: ; preds = %_RNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry24get_collection_telemetry0B9_.exit.i.i.i.i.i, %_RNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0B9_.exit.i.i, %select.unfold.loopexit.i.i, %_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryEECsl8OoimOLbh_6qdrant.exit.i.i.i, %bb.dl, %bb.dk
  %i.tu = load i64, ptr %i.nx, align 8, !noalias !390, !noundef !8
  %i.tv = load i8, ptr %i.ny, align 1, !range !396, !noalias !390, !noundef !8
  store i64 %i.tu, ptr %i.hb, align 8, !noalias !385
  store i8 %i.tv, ptr %i.hc, align 1, !noalias !385
  store i8 -1, ptr %i.hd, align 8, !noalias !385
  store i64 0, ptr %i.p, align 8, !noalias !385
  store i64 0, ptr %i.hf, align 8, !noalias !385
  store i64 0, ptr %i.hh, align 8, !noalias !385
...
bb.eh:                                            ; preds = %bb.eg
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g), !noalias !385
  invoke void @_RNvXNtCsjqcU1oJFKXj_9hashbrown3mapINtB2_7HashMapNtNtCsexYYUdYSQU6_5alloc6string6StringjNtNtNtCsG258MDvU3F_3std4hash6random11RandomStateENtNtCskKLDkoKarTP_4core5clone5Clone5cloneCsl8OoimOLbh_6qdrant(ptr noalias nofree noundef nonnull sret([48 x i8]) align 8 captures(none) dereferenceable(48) %i.g, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(48) %i.ts)
          to label %bb.ek unwind label %bb.ej, !noalias !390

bb.ei:                                            ; preds = %bb.ek, %bb.eg
  %.sroa.09.0.i.i = phi ptr [ %.sroa.031.0.copyload.i.i, %bb.ek ], [ null, %bb.eg ]
  %i.tw = getelementptr inbounds nuw i8, ptr %i.st, i64 464
  %.sroa.012.sroa.0.0.copyload.i.i = load i64, ptr %i.tw, align 8, !noalias !390 ; 2 uses
  %.sroa.012.sroa.3.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.st, i64 472
  %.sroa.012.sroa.3.0.copyload.i.i = load i64, ptr %.sroa.012.sroa.3.0..sroa_idx.i.i, align 8, !noalias !390 ; 2 uses
  %.sroa.313.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.st, i64 480
  %.sroa.313.0.copyload.i.i = load i8, ptr %.sroa.313.0..sroa_idx.i.i, align 8, !noalias !390 ; 2 uses
  %.sroa.618.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.st, i64 481
  %cond = icmp eq i8 %.sroa.313.0.copyload.i.i, 0
  %i.tx = icmp eq i64 %.sroa.012.sroa.3.0.copyload.i.i, 0
  %.not46.i.i = icmp eq i64 %.sroa.012.sroa.0.0.copyload.i.i, 0
  %or.cond.i.i = select i1 %i.tx, i1 %.not46.i.i, i1 false
  %spec.select.i.i = select i1 %or.cond.i.i, i8 2, i8 0
  %.sroa.313.0.i.i = select i1 %cond, i8 %spec.select.i.i, i8 %.sroa.313.0.copyload.i.i
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.ho, ptr noundef nonnull align 8 dereferenceable(24) %i.o, i64 24, i1 false), !noalias !385
  store i64 %i.te, ptr %i.hb, align 8, !noalias !385
  store i8 %i.tf, ptr %i.hc, align 1, !noalias !385
  store i8 %i.th, ptr %i.hd, align 8, !noalias !385
  store i64 1, ptr %i.p, align 8, !noalias !385
  store i64 %i.tj, ptr %i.he, align 8, !noalias !385
  store i64 %i.sy, ptr %i.hf, align 8, !noalias !385
  store <2 x i64> %i.tl, ptr %i.hg, align 8, !noalias !385
  store <2 x i64> %i.tn, ptr %i.hi, align 8, !noalias !385
  store <2 x i64> %i.tp, ptr %i.hk, align 8, !noalias !385
  store i64 %i.tr, ptr %i.hm, align 8, !noalias !385
  store ptr %.sroa.09.0.i.i, ptr %i.hn, align 8, !noalias !385
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %.sroa.5.0..sroa_idx11.i.i, ptr noundef nonnull align 8 dereferenceable(40) %.sroa.5.i.i, i64 40, i1 false), !noalias !385
  store i64 %.sroa.012.sroa.0.0.copyload.i.i, ptr %i.hp, align 8, !noalias !385
  store i64 %.sroa.012.sroa.3.0.copyload.i.i, ptr %.sroa.012.sroa.3.0..sroa_idx37.i.i, align 8, !noalias !385
  store i8 %.sroa.313.0.i.i, ptr %.sroa.313.0..sroa_idx16.i.i, align 8, !noalias !385
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(7) %.sroa.618.0..sroa_idx20.i.i, ptr noundef nonnull align 1 dereferenceable(7) %.sroa.618.0..sroa_idx.i.i, i64 7, i1 false), !noalias !390
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.5.i.i)
  call void @llvm.lifetime.end.p0(ptr nonnull %i.o), !noalias !385
  br label %bb.el

bb.ej:                                            ; preds = %bb.eh
  %i.ty = landingpad { ptr, i32 }
          cleanup
  invoke fastcc void @_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtCsPYQCUnoTxQ_10collection9telemetry25ShardCleanStatusTelemetryEECsl8OoimOLbh_6qdrant(ptr noalias nofree noundef align 8 dereferenceable(24) %i.o) #19
          to label %.thread80.i.i unwind label %bb.dj, !noalias !390

bb.ek:                                            ; preds = %bb.eh
  %.sroa.031.0.copyload.i.i = load ptr, ptr %i.g, align 8, !noalias !385
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %.sroa.5.i.i, ptr noundef nonnull align 8 dereferenceable(40) %.sroa.432.0..sroa_idx.i.i, i64 40, i1 false), !noalias !385
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g), !noalias !385
  br label %bb.ei

bb.el:                                            ; preds = %bb.ei, %_RNCNvNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry16aggregate_shards0B9_.exit.thread.i.i
  call void @llvm.lifetime.start.p0(ptr nonnull %i.n), !noalias !385
  %i.tz = load i64, ptr %i.nx, align 8, !noalias !390, !noundef !8
  invoke void @_RNvMs1_NtCsjqcU1oJFKXj_9hashbrown3mapINtB5_7HashMapyNtNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry27DistributedReplicaTelemetryNtNtNtCsG258MDvU3F_3std4hash6random11RandomStateE6insertBW_(ptr noalias nofree noundef nonnull sret([192 x i8]) align 8 captures(none) dereferenceable(192) %i.n, ptr noalias nofree noundef nonnull align 8 dereferenceable(48) %i.r, i64 noundef %i.tz, ptr noalias nofree noundef nonnull align 8 captures(address) dereferenceable(192) %i.p)
          to label %bb.em unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split.i.i, !noalias !390

bb.em:                                            ; preds = %bb.el
  %i.ua = load i64, ptr %i.n, align 8, !range !163, !alias.scope !397, !noalias !385, !noundef !8
  %i.ub = icmp eq i64 %i.ua, 2
  br i1 %i.ub, label %_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtNtNtCsl8OoimOLbh_6qdrant6common13telemetry_ops21distributed_telemetry27DistributedReplicaTelemetryEEB15_.exit.i.i, label %bb.en

bb.en:                                            ; preds = %bb.em
  %i.uc = load ptr, ptr %i.hq, align 8, !alias.scope !400, !noalias !385, !noundef !8
  %i.ud = icmp eq ptr %i.uc, null
  br i1 %i.ud, label %_RINvNtCskKLDkoKarTP_4core3ptr9drop_glueINtNtB4_6option6OptionINtNtNtNtCsG258MDvU3F_3std11collections4hash3map7HashMapNtNtCsexYYUdYSQU6_5alloc6string6StringjEEECsl8OoimOLbh_6qdrant.exit.i.i.i.i, label %bb.eo
