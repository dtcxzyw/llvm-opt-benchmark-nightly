...
_RNvXs6_NtNtCsPYQCUnoTxQ_10collection10operations23shard_selector_internalNtB5_21ShardSelectorInternalNtNtCskKLDkoKarTP_4core3cmp9PartialEq2eq.exit: ; preds = %bb.g, %bb.f, %bb.a, %bb.b, %bb.c, %bb.e, %bb.h, %bb.i, %bb.j, %bb.k
  %.sroa.0.0.shrunk.i = phi i1 [ false, %bb.a ], [ %i.v, %bb.e ], [ false, %bb.h ], [ true, %bb.b ], [ %i.aw, %bb.i ], [ false, %bb.c ], [ %i.ax, %bb.j ], [ %i.bc, %bb.k ], [ %i.am, %bb.g ], [ false, %bb.f ]
  %i.bd = xor i1 %.sroa.0.0.shrunk.i, true
  ret i1 %i.bd
}
...
declare hidden void @_RNvXsp_NtCsexYYUdYSQU6_5alloc3vecINtB5_3VecIBw_IBw_IBw_NtNtCs607s0NAIaWN_7segment5types11ScoredPointEEEENtNtNtCskKLDkoKarTP_4core3ops4drop4Drop4dropCsl8OoimOLbh_6qdrant(ptr noalias nofree noundef align 8 dereferenceable(24)) unnamed_addr #0
...
; Function Attrs: nonlazybind uwtable
declare hidden void @_RNvXsp_NtCsexYYUdYSQU6_5alloc3vecINtB5_3VecIBw_IBw_NtNtCs607s0NAIaWN_7segment5types11ScoredPointEEENtNtNtCskKLDkoKarTP_4core3ops4drop4Drop4dropCsl8OoimOLbh_6qdrant(ptr noalias nofree noundef align 8 dereferenceable(24)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare hidden void @_RNvXsp_NtCsexYYUdYSQU6_5alloc3vecINtB5_3VecIBw_NtNtCs607s0NAIaWN_7segment5types11ScoredPointEENtNtNtCskKLDkoKarTP_4core3ops4drop4Drop4dropCsl8OoimOLbh_6qdrant(ptr noalias nofree noundef align 8 dereferenceable(24)) unnamed_addr #0

; Function Attrs: nonlazybind uwtable
declare hidden void @_RNvXsp_NtCsexYYUdYSQU6_5alloc3vecINtB5_3VecIBw_NtNtNtCs5QaNqjAn6vc_5shard8retrieve15record_internal14RecordInternalEENtNtNtCskKLDkoKarTP_4core3ops4drop4Drop4dropCsl8OoimOLbh_6qdrant(ptr noalias nofree noundef align 8 dereferenceable(24)) unnamed_addr #0
