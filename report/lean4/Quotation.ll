...
define noundef nonnull ptr @l_Lean_Elab_Term_Quotation_MatchResult_ctorIdx(ptr noundef %0) local_unnamed_addr #3 {
bb.a:
...
; Function Attrs: nounwind uwtable
define noundef nonnull ptr @l_Lean_Elab_Term_Quotation_MatchResult_ctorIdx___boxed(ptr noundef %0) local_unnamed_addr #1 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64                   ; 2 uses
  %i.b = and i64 %i.a, 1
...
lean_obj_tag.exit.i:                              ; preds = %bb.c, %bb.b
  ...
  switch i32 %.0.i.i, label %2 [
    i32 0, label %l_Lean_Elab_Term_Quotation_MatchResult_ctorIdx.exit
    i32 1, label %1
  ]

1:                                                ; preds = %lean_obj_tag.exit.i
  br label %l_Lean_Elab_Term_Quotation_MatchResult_ctorIdx.exit

2:                                                ; preds = %lean_obj_tag.exit.i
  br label %l_Lean_Elab_Term_Quotation_MatchResult_ctorIdx.exit

l_Lean_Elab_Term_Quotation_MatchResult_ctorIdx.exit: ; preds = %lean_obj_tag.exit.i, %1, %2
...
3:                                                ; preds = %l_Lean_Elab_Term_Quotation_MatchResult_ctorIdx.exit
  %4 = load i32, ptr %0, align 4, !tbaa !11       ; 3 uses
  %5 = icmp sgt i32 %4, 1
  br i1 %5, label %bb.d, label %bb.e, !prof !16
...
lean_dec.exit:                                    ; preds = %bb.f, %bb.e, %bb.d, %l_Lean_Elab_Term_Quotation_MatchResult_ctorIdx.exit
  ret ptr %.0.i
}
