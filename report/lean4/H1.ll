...
define noundef nonnull ptr @l___private_Std_Http_Protocol_H1_0__Std_Http_Protocol_H1_Machine_BodyMode_ctorIdx(ptr noundef %0) local_unnamed_addr #3 {
bb.a:
...
; Function Attrs: nounwind uwtable
define noundef nonnull ptr @l___private_Std_Http_Protocol_H1_0__Std_Http_Protocol_H1_Machine_BodyMode_ctorIdx___boxed(ptr noundef %0) local_unnamed_addr #0 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64                   ; 2 uses
  %i.b = and i64 %i.a, 1
...
lean_obj_tag.exit.i:                              ; preds = %bb.c, %bb.b
  ...
  switch i32 %.0.i.i, label %2 [
    i32 0, label %l___private_Std_Http_Protocol_H1_0__Std_Http_Protocol_H1_Machine_BodyMode_ctorIdx.exit
    i32 1, label %1
  ]

1:                                                ; preds = %lean_obj_tag.exit.i
  br label %l___private_Std_Http_Protocol_H1_0__Std_Http_Protocol_H1_Machine_BodyMode_ctorIdx.exit

2:                                                ; preds = %lean_obj_tag.exit.i
  br label %l___private_Std_Http_Protocol_H1_0__Std_Http_Protocol_H1_Machine_BodyMode_ctorIdx.exit

l___private_Std_Http_Protocol_H1_0__Std_Http_Protocol_H1_Machine_BodyMode_ctorIdx.exit: ; preds = %lean_obj_tag.exit.i, %1, %2
...
3:                                                ; preds = %l___private_Std_Http_Protocol_H1_0__Std_Http_Protocol_H1_Machine_BodyMode_ctorIdx.exit
...
lean_dec.exit:                                    ; preds = %bb.f, %bb.e, %bb.d, %l___private_Std_Http_Protocol_H1_0__Std_Http_Protocol_H1_Machine_BodyMode_ctorIdx.exit
  ret ptr %.0.i
}
