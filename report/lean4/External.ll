Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/lean4/original/External?download=true
...
bb.ev:                                            ; preds = %.split798, %lean_nat_eq.exit369
  br i1 %.not.i316, label %bb.ew, label %lean_dec.exit266
...
bb.ey:                                            ; preds = %bb.ew
  %.not.i341 = icmp eq i32 %i.hg, 0
  br i1 %.not.i341, label %lean_dec.exit266, label %bb.ez

bb.ez:                                            ; preds = %bb.ey
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.d) #7
  br label %lean_dec.exit266

lean_dec.exit266:                                 ; preds = %bb.ez, %bb.ey, %bb.ex, %bb.ev
  %i.hj = load i32, ptr %.0186, align 8, !tbaa !11 ; 3 uses
  %i.hk = icmp sgt i32 %i.hj, 1
  br i1 %i.hk, label %bb.fa, label %bb.fb, !prof !10

bb.fa:                                            ; preds = %lean_dec.exit266
  %i.hl = add nsw i32 %i.hj, -1
  store i32 %i.hl, ptr %.0186, align 8, !tbaa !11
  br label %lean_dec_ref.exit356

bb.fb:                                            ; preds = %lean_dec.exit266
  %.not.i355 = icmp eq i32 %i.hj, 0
  br i1 %.not.i355, label %lean_dec_ref.exit356, label %bb.fc

bb.fc:                                            ; preds = %bb.fb
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %.0186) #7
  br label %lean_dec_ref.exit356

lean_dec_ref.exit356:                             ; preds = %bb.fa, %bb.fb, %bb.fc
  %i.hm = icmp ult ptr %i.go, inttoptr (i64 4294967296 to ptr)
  %or.cond.i440 = or i1 %i.hm, %.not.i300
  br i1 %or.cond.i440, label %lean_nat_to_int.exit442, label %bb.fd

bb.fd:                                            ; preds = %lean_dec_ref.exit356
  %i.hn = lshr i64 %i.gp, 1
  %i.ho = tail call ptr @lean_big_size_t_to_int(i64 noundef %i.hn) #7 ; 2 uses
  %.pre = ptrtoint ptr %i.ho to i64
  br label %lean_nat_to_int.exit442

lean_nat_to_int.exit442:                          ; preds = %lean_dec_ref.exit356, %bb.fd
  %.pre-phi = phi i64 [ %i.gp, %lean_dec_ref.exit356 ], [ %.pre, %bb.fd ] ; 2 uses
  %.1.i441 = phi ptr [ %i.go, %lean_dec_ref.exit356 ], [ %i.ho, %bb.fd ] ; 4 uses
  %i.hp = and i64 %.pre-phi, 1
  %.not.i443 = icmp eq i64 %i.hp, 0
  br i1 %.not.i443, label %bb.fh, label %bb.fe, !prof !9

bb.fe:                                            ; preds = %lean_nat_to_int.exit442
...
bb.fh:                                            ; preds = %lean_nat_to_int.exit442
  %i.hx = tail call ptr @lean_int_big_neg(ptr noundef %.1.i441) #7 ; 3 uses
  %i.hy = load i32, ptr %.1.i441, align 4, !tbaa !11 ; 3 uses
  %i.hz = icmp sgt i32 %i.hy, 1
  br i1 %i.hz, label %bb.fi, label %bb.fj, !prof !10

bb.fi:                                            ; preds = %bb.fh
  %i.ia = add nsw i32 %i.hy, -1
  store i32 %i.ia, ptr %.1.i441, align 4, !tbaa !11
  br label %lean_int_neg.exit.thread

bb.fj:                                            ; preds = %bb.fh
  %.not.i343 = icmp eq i32 %i.hy, 0
  br i1 %.not.i343, label %lean_int_neg.exit.thread, label %bb.fk

bb.fk:                                            ; preds = %bb.fj
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %.1.i441) #7
  br label %lean_int_neg.exit.thread

bb.fl:                                            ; preds = %.split798, %lean_nat_eq.exit369
  br i1 %.not.i298, label %bb.fm, label %lean_dec.exit262
...
bb.fo:                                            ; preds = %bb.fm
  %.not.i345 = icmp eq i32 %i.ib, 0
  br i1 %.not.i345, label %lean_dec.exit262, label %bb.fp

bb.fp:                                            ; preds = %bb.fo
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.gv) #7
  br label %lean_dec.exit262

lean_dec.exit262:                                 ; preds = %bb.fp, %bb.fo, %bb.fn, %bb.fl
  br i1 %.not.i300, label %bb.fq, label %lean_dec.exit260

bb.fq:                                            ; preds = %lean_dec.exit262
...
lean_inc.exit315.thread:                          ; preds = %bb.gt, %bb.gs, %bb.gr, %bb.gy, %bb.gx, %bb.gw, %bb.t, %bb.s, %bb.r, %bb.af, %bb.ae, %bb.ad, %bb.cr, %bb.cq, %bb.cp, %bb.dh, %bb.dg, %bb.df, %bb.fx, %bb.fw, %bb.fv, %bb.j, %bb.i, %bb.h
  ...
  br i1 %i.im, label %bb.fy, label %bb.fz, !prof !10

bb.fy:                                            ; preds = %lean_inc.exit315.thread
  %i.in = add nsw i32 %i.il, -1                   ; 2 uses
  store i32 %i.in, ptr %i.d, align 4, !tbaa !11
  br label %bb.gb

bb.fz:                                            ; preds = %lean_inc.exit315.thread
  %.not.i349 = icmp eq i32 %i.il, 0
  br i1 %.not.i349, label %lean_dec.exit, label %bb.ga
...
bb.gb:                                            ; preds = %bb.ga, %bb.fy
  %i.io = phi i32 [ %.pr, %bb.ga ], [ %i.in, %bb.fy ] ; 3 uses
  %i.ip = icmp sgt i32 %i.io, 1
  br i1 %i.ip, label %bb.gc, label %bb.gd, !prof !24
...
bb.gd:                                            ; preds = %bb.gb
  %.not.i351 = icmp eq i32 %i.io, 0
  br i1 %.not.i351, label %lean_dec.exit, label %bb.ge

bb.ge:                                            ; preds = %bb.gd
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.d) #7
  br label %lean_dec.exit

lean_dec.exit:                                    ; preds = %bb.fz, %bb.ge, %bb.gd, %bb.gc
  br i1 %i.ik, label %lean_dec.exit.thread, label %bb.gf

bb.gf:                                            ; preds = %lean_dec.exit
  %i.ir = load i32, ptr %.0184, align 4, !tbaa !11 ; 3 uses
  %i.is = icmp sgt i32 %i.ir, 1
  br i1 %i.is, label %bb.gg, label %bb.gh, !prof !10
...
bb.gh:                                            ; preds = %bb.gf
  %.not.i353 = icmp eq i32 %i.ir, 0
  br i1 %.not.i353, label %lean_dec_ref.exit354, label %bb.gi

bb.gi:                                            ; preds = %bb.gh
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %.0184) #7
  br label %lean_dec_ref.exit354

lean_dec_ref.exit354:                             ; preds = %bb.gg, %bb.gh, %bb.gi
  %i.iu = ptrtoint ptr %.10232489 to i64
  %i.iv = and i64 %i.iu, 1
  %.not.i294 = icmp eq i64 %i.iv, 0
  br i1 %.not.i294, label %bb.gj, label %lean_inc.exit295

bb.gj:                                            ; preds = %lean_dec_ref.exit354
  %.val.i.i448 = load i32, ptr %.10232489, align 4, !tbaa !11 ; 3 uses
  %i.iw = icmp sgt i32 %.val.i.i448, 0
  br i1 %i.iw, label %bb.gk, label %bb.gl, !prof !10

bb.gk:                                            ; preds = %bb.gj
  %i.ix = add nuw i32 %.val.i.i448, 1
  store i32 %i.ix, ptr %.10232489, align 4, !tbaa !11
  br label %lean_inc.exit295

bb.gl:                                            ; preds = %bb.gj
  %.not.i.i449 = icmp eq i32 %.val.i.i448, 0
  br i1 %.not.i.i449, label %lean_inc.exit295, label %bb.gm

bb.gm:                                            ; preds = %bb.gl
  %i.iy = atomicrmw sub ptr %.10232489, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit295

lean_inc.exit295:                                 ; preds = %bb.gm, %bb.gl, %bb.gk, %lean_dec_ref.exit354
  ...
  br i1 %i.ja, label %bb.gn, label %lean_alloc_ctor.exit451

bb.gn:                                            ; preds = %lean_inc.exit295
  tail call void @lean_internal_panic_out_of_memory() #8
  unreachable

lean_dec.exit.thread:                             ; preds = %lean_nat_lt.exit.thread, %bb.gp, %bb.gu, %lean_obj_once.exit, %lean_dec.exit290, %lean_dec.exit278, %lean_dec.exit274, %lean_dec.exit260, %lean_dec.exit
  tail call void @lean_inc_heartbeat() #7
  %i.jb = tail call noalias ptr @mi_malloc_small(i64 noundef 24) #7 ; 2 uses
  %i.jc = icmp eq ptr %i.jb, null
  br i1 %i.jc, label %bb.go, label %lean_alloc_ctor.exit451

bb.go:                                            ; preds = %lean_dec.exit.thread
  tail call void @lean_internal_panic_out_of_memory() #8
  unreachable

bb.gp:                                            ; preds = %bb.dx, %bb.dw, %bb.dv, %bb.dl, %bb.dt, %bb.dp, %bb.do, %bb.dn
  br i1 %.not.i316, label %bb.gq, label %lean_dec.exit.thread

bb.gq:                                            ; preds = %bb.gp
  %.val.i.i453 = load i32, ptr %i.d, align 4, !tbaa !11 ; 3 uses
  %i.jd = icmp sgt i32 %.val.i.i453, 0
  br i1 %i.jd, label %bb.gr, label %bb.gs, !prof !10

bb.gr:                                            ; preds = %bb.gq
  %i.je = add nuw i32 %.val.i.i453, 1
  store i32 %i.je, ptr %i.d, align 4, !tbaa !11
  br label %lean_inc.exit315.thread

bb.gs:                                            ; preds = %bb.gq
  %.not.i.i454 = icmp eq i32 %.val.i.i453, 0
  br i1 %.not.i.i454, label %lean_inc.exit315.thread, label %bb.gt

bb.gt:                                            ; preds = %bb.gs
  %i.jf = atomicrmw sub ptr %i.d, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit315.thread

bb.gu:                                            ; preds = %bb.ax, %bb.am, %bb.au, %bb.aw, %bb.aq, %bb.ap, %bb.ao, %bb.ay
  br i1 %.not.i316, label %bb.gv, label %lean_dec.exit.thread

bb.gv:                                            ; preds = %bb.gu
  %.val.i.i456 = load i32, ptr %i.d, align 4, !tbaa !11 ; 3 uses
  %i.jg = icmp sgt i32 %.val.i.i456, 0
  br i1 %i.jg, label %bb.gw, label %bb.gx, !prof !10

bb.gw:                                            ; preds = %bb.gv
  %i.jh = add nuw i32 %.val.i.i456, 1
  store i32 %i.jh, ptr %i.d, align 4, !tbaa !11
  br label %lean_inc.exit315.thread

bb.gx:                                            ; preds = %bb.gv
  %.not.i.i457 = icmp eq i32 %.val.i.i456, 0
  br i1 %.not.i.i457, label %lean_inc.exit315.thread, label %bb.gy

bb.gy:                                            ; preds = %bb.gx
  %i.ji = atomicrmw sub ptr %i.d, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit315.thread

lean_int_neg.exit.thread:                         ; preds = %bb.fg, %bb.ff, %bb.fi, %bb.fj, %bb.fk, %bb.ce, %lean_dec_ref.exit360
  %.9200 = phi ptr [ %i.hx, %bb.fj ], [ %i.cv, %lean_dec_ref.exit360 ], [ %i.dv, %bb.ce ], [ %i.hx, %bb.fi ], [ %i.hx, %bb.fk ], [ %i.hw, %bb.fg ], [ %i.hv, %bb.ff ]
  %.9 = phi ptr [ %i.gv, %bb.fj ], [ %i.dc, %lean_dec_ref.exit360 ], [ %i.dc, %bb.ce ], [ %i.gv, %bb.fi ], [ %i.gv, %bb.fk ], [ %i.gv, %bb.fg ], [ %i.gv, %bb.ff ]
  %i.jj = tail call ptr @lean_array_push(ptr noundef %.0184, ptr noundef %.9200) #7
  br label %bb.b

lean_alloc_ctor.exit451:                          ; preds = %lean_dec.exit.thread, %lean_inc.exit295
  %.sink912 = phi ptr [ %i.iz, %lean_inc.exit295 ], [ %i.jb, %lean_dec.exit.thread ] ; 5 uses
  %.sink = phi i32 [ 16908312, %lean_inc.exit295 ], [ 131096, %lean_dec.exit.thread ]
  %.0184848.sink = phi ptr [ %.10232489, %lean_inc.exit295 ], [ %.0184, %lean_dec.exit.thread ]
  %i.jk = getelementptr inbounds nuw i8, ptr %.sink912, i64 4
  store i32 1, ptr %.sink912, align 4, !tbaa !11
  store i32 %.sink, ptr %i.jk, align 4
  %i.jl = getelementptr inbounds nuw i8, ptr %.sink912, i64 8
  store ptr %.0186, ptr %i.jl, align 8, !tbaa !13
  %i.jm = getelementptr inbounds nuw i8, ptr %.sink912, i64 16
  store ptr %.0184848.sink, ptr %i.jm, align 8, !tbaa !13
  ret ptr %.sink912
}
