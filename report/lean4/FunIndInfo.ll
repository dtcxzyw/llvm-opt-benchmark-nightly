...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define noundef nonnull ptr @l_Lean_Meta_FunIndParamKind_ctorIdx___boxed(ptr noundef %0) local_unnamed_addr #0 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64
  %i.b = lshr i64 %i.a, 1
  %i.c = trunc i64 %i.b to i8
  switch i8 %i.c, label %2 [
    i8 0, label %l_Lean_Meta_FunIndParamKind_ctorIdx.exit
    i8 1, label %1
  ]

1:                                                ; preds = %bb.a
  br label %l_Lean_Meta_FunIndParamKind_ctorIdx.exit

2:                                                ; preds = %bb.a
  br label %l_Lean_Meta_FunIndParamKind_ctorIdx.exit

l_Lean_Meta_FunIndParamKind_ctorIdx.exit:         ; preds = %bb.a, %1, %2
...
l_Lean_Meta_FunIndParamKind_ctorIdx.exit:         ; preds = %1, %2, %3
  %.0.i = phi ptr [ inttoptr (i64 5 to ptr), %3 ], [ inttoptr (i64 3 to ptr), %2 ], [ inttoptr (i64 1 to ptr), %1 ]
  ret ptr %.0.i
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define noundef nonnull ptr @l_Lean_Meta_FunIndParamKind_toCtorIdx___boxed(ptr noundef %0) local_unnamed_addr #0 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64
  %i.b = lshr i64 %i.a, 1
  %i.c = trunc i64 %i.b to i8
  switch i8 %i.c, label %2 [
    i8 0, label %l_Lean_Meta_FunIndParamKind_toCtorIdx.exit
    i8 1, label %1
  ]

1:                                                ; preds = %bb.a
  br label %l_Lean_Meta_FunIndParamKind_toCtorIdx.exit

2:                                                ; preds = %bb.a
  br label %l_Lean_Meta_FunIndParamKind_toCtorIdx.exit

l_Lean_Meta_FunIndParamKind_toCtorIdx.exit:       ; preds = %bb.a, %1, %2
...
l_Lean_Meta_FunIndParamKind_ctorIdx.exit:         ; preds = %2, %3, %4
...
5:                                                ; preds = %l_Lean_Meta_FunIndParamKind_ctorIdx.exit
  br label %lean_dec.exit

6:                                                ; preds = %l_Lean_Meta_FunIndParamKind_ctorIdx.exit
  br label %lean_dec.exit

lean_dec.exit:                                    ; preds = %6, %5, %l_Lean_Meta_FunIndParamKind_ctorIdx.exit
  %.0.i13 = phi ptr [ inttoptr (i64 5 to ptr), %6 ], [ inttoptr (i64 3 to ptr), %5 ], [ inttoptr (i64 1 to ptr), %l_Lean_Meta_FunIndParamKind_ctorIdx.exit ]
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define noundef nonnull ptr @l_Lean_Meta_instBEqFunIndParamKind_beq___boxed(ptr noundef %0, ptr noundef %1) #0 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64
  %i.b = lshr i64 %i.a, 1
  %i.c = trunc i64 %i.b to i8
  ...
  switch i8 %i.c, label %3 [
    i8 0, label %l_Lean_Meta_FunIndParamKind_ctorIdx.exit.i
    i8 1, label %2
  ]

2:                                                ; preds = %bb.a
  br label %l_Lean_Meta_FunIndParamKind_ctorIdx.exit.i

3:                                                ; preds = %bb.a
  br label %l_Lean_Meta_FunIndParamKind_ctorIdx.exit.i

l_Lean_Meta_FunIndParamKind_ctorIdx.exit.i:       ; preds = %3, %2, %bb.a
  %.0.i12.i = phi ptr [ inttoptr (i64 5 to ptr), %3 ], [ inttoptr (i64 3 to ptr), %2 ], [ inttoptr (i64 1 to ptr), %bb.a ]
  switch i8 %i.f, label %5 [
    i8 0, label %l_Lean_Meta_instBEqFunIndParamKind_beq.exit
    i8 1, label %4
  ]

4:                                                ; preds = %l_Lean_Meta_FunIndParamKind_ctorIdx.exit.i
  br label %l_Lean_Meta_instBEqFunIndParamKind_beq.exit

5:                                                ; preds = %l_Lean_Meta_FunIndParamKind_ctorIdx.exit.i
  br label %l_Lean_Meta_instBEqFunIndParamKind_beq.exit

l_Lean_Meta_instBEqFunIndParamKind_beq.exit:      ; preds = %l_Lean_Meta_FunIndParamKind_ctorIdx.exit.i, %4, %5
  %.0.i13.i = phi ptr [ inttoptr (i64 5 to ptr), %5 ], [ inttoptr (i64 3 to ptr), %4 ], [ inttoptr (i64 1 to ptr), %l_Lean_Meta_FunIndParamKind_ctorIdx.exit.i ]
