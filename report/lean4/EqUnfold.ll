Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/lean4/original/EqUnfold?download=true
...
lean_alloc_ctor.exit188:                          ; preds = %lean_string_dec_eq.exit
  ...
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(5) %i.bn, i8 0, i64 5, i1 false)
