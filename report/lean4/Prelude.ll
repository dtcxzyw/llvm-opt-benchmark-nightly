...
define noundef nonnull ptr @l_Lean_Name_ctorIdx(ptr noundef %0) local_unnamed_addr #4 {
bb.a:
...
; Function Attrs: nounwind uwtable
define noundef nonnull ptr @l_Lean_Name_ctorIdx___boxed(ptr noundef %0) local_unnamed_addr #1 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64                   ; 2 uses
  %i.b = and i64 %i.a, 1
...
lean_obj_tag.exit.i:                              ; preds = %bb.c, %bb.b
  ...
  switch i32 %.0.i.i, label %2 [
    i32 0, label %l_Lean_Name_ctorIdx.exit
    i32 1, label %1
  ]

1:                                                ; preds = %lean_obj_tag.exit.i
  br label %l_Lean_Name_ctorIdx.exit

2:                                                ; preds = %lean_obj_tag.exit.i
  br label %l_Lean_Name_ctorIdx.exit

l_Lean_Name_ctorIdx.exit:                         ; preds = %lean_obj_tag.exit.i, %1, %2
...
3:                                                ; preds = %l_Lean_Name_ctorIdx.exit
...
lean_dec.exit:                                    ; preds = %bb.f, %bb.e, %bb.d, %l_Lean_Name_ctorIdx.exit
  ret ptr %.0.i
}
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define noundef nonnull ptr @l_Lean_SourceInfo_ctorIdx(ptr noundef %0) local_unnamed_addr #4 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64                   ; 2 uses
  %i.b = and i64 %i.a, 1
  %.not.i = icmp eq i64 %i.b, 0
...
; Function Attrs: nounwind uwtable
define noundef nonnull ptr @l_Lean_SourceInfo_ctorIdx___boxed(ptr noundef %0) local_unnamed_addr #1 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64                   ; 2 uses
  %i.b = and i64 %i.a, 1
  %.not.i.i = icmp eq i64 %i.b, 0                 ; 2 uses
...
lean_obj_tag.exit.i:                              ; preds = %bb.c, %bb.b
  %.0.i.i = phi i32 [ %i.d, %bb.b ], [ %i.f, %bb.c ]
  switch i32 %.0.i.i, label %2 [
    i32 0, label %l_Lean_SourceInfo_ctorIdx.exit
    i32 1, label %1
  ]

1:                                                ; preds = %lean_obj_tag.exit.i
  br label %l_Lean_SourceInfo_ctorIdx.exit

2:                                                ; preds = %lean_obj_tag.exit.i
  br label %l_Lean_SourceInfo_ctorIdx.exit

l_Lean_SourceInfo_ctorIdx.exit:                   ; preds = %lean_obj_tag.exit.i, %1, %2
  %.0.i = phi ptr [ inttoptr (i64 5 to ptr), %2 ], [ inttoptr (i64 3 to ptr), %1 ], [ inttoptr (i64 1 to ptr), %lean_obj_tag.exit.i ]
  br i1 %.not.i.i, label %3, label %lean_dec.exit

3:                                                ; preds = %l_Lean_SourceInfo_ctorIdx.exit
  %4 = load i32, ptr %0, align 4, !tbaa !10       ; 3 uses
  %5 = icmp sgt i32 %4, 1
  br i1 %5, label %bb.d, label %bb.e, !prof !11
...
lean_dec.exit:                                    ; preds = %bb.f, %bb.e, %bb.d, %l_Lean_SourceInfo_ctorIdx.exit
  ret ptr %.0.i
}
