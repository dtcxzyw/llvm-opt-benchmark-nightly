...
_ZNSt6vectorIN4lean13equiv_manager4nodeESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i: ; preds = %bb.f, %_ZNSt6vectorIN4lean13equiv_manager4nodeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit16.i.i
  ...
  store ptr %i.y, ptr %i.h, align 8, !tbaa !14
  br label %_ZNSt6vectorIN4lean13equiv_manager4nodeESaIS2_EE9push_backERKS2_.exit
...
_ZN4lean13equiv_manager4findEj.exit:              ; preds = %bb.b, %_ZN4lean13equiv_manager4findEj.exit
  ...
  %.not.i21 = icmp eq i32 %i.g, %.07.i20
...
bb.c:                                             ; preds = %_ZN4lean13equiv_manager4findEj.exit22
  ...
  %i.j = load i32, ptr %i.i, align 4, !tbaa !17   ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  store i32 %.07.i20, ptr %3, align 4, !tbaa !16
  br label %bb.g

bb.e:                                             ; preds = %bb.c
  %i.n = icmp ugt i32 %i.j, %i.l
  store i32 %.07.i, ptr %i.h, align 4, !tbaa !16
  br i1 %i.n, label %bb.g, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.o = add i32 %i.j, 1
  store i32 %i.o, ptr %i.i, align 4, !tbaa !17
  br label %bb.g
...
bb.m:                                             ; preds = %_ZNSt6vectorIN4lean13equiv_manager4nodeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit16.i.i.i
  %i.bf = load ptr, ptr %i.ar, align 8, !tbaa !14
...
_ZNSt6vectorIN4lean13equiv_manager4nodeESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i.i: ; preds = %bb.m, %_ZNSt6vectorIN4lean13equiv_manager4nodeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit16.i.i.i
  store ptr %i.bb, ptr %0, align 8, !tbaa !13
  store ptr %i.be, ptr %i.ak, align 8, !tbaa !12
  %i.bi = getelementptr inbounds nuw [8 x i8], ptr %i.bb, i64 %i.az
  store ptr %i.bi, ptr %i.ar, align 8, !tbaa !14
  br label %_ZN4lean13equiv_manager7mk_nodeEv.exit
...
_ZN4lean13equiv_manager7mk_nodeEv.exit:           ; preds = %bb.i, %_ZNSt6vectorIN4lean13equiv_manager4nodeESaIS2_EE17_M_realloc_insertIJRKS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i.i
  ...
  %i.bk = load ptr, ptr %1, align 8, !tbaa !30, !noalias !59 ; 5 uses
  store ptr %i.bk, ptr %2, align 8, !tbaa !30, !alias.scope !59
...
bb.n:                                             ; preds = %_ZN4lean13equiv_manager7mk_nodeEv.exit
  %.val.i.i.i.i.i.i.i.i = load i32, ptr %i.bk, align 4, !tbaa !41, !noalias !59 ; 3 uses
  %i.bn = icmp sgt i32 %.val.i.i.i.i.i.i.i.i, 0
end_hunk_0
begin_hunk_1_@_ZN4lean13equiv_manager13is_equiv_coreERKNS_4exprES3_:bb.a
...
_ZN4lean13equiv_manager4findEj.exit.i:            ; preds = %bb.u, %_ZN4lean13equiv_manager4findEj.exit.i
  ...
  %.not.i21.i = icmp eq i32 %i.eq, %.07.i20.i
...
bb.v:                                             ; preds = %_ZN4lean13equiv_manager4findEj.exit22.i
  %i.es = getelementptr inbounds nuw i8, ptr %3, i64 4 ; 2 uses
  %i.et = load i32, ptr %i.es, align 4, !tbaa !17 ; 3 uses
  %i.eu = getelementptr inbounds nuw i8, ptr %i.er, i64 4
  %i.ev = load i32, ptr %i.eu, align 4, !tbaa !17 ; 2 uses
  %i.ew = icmp ult i32 %i.et, %i.ev
  br i1 %i.ew, label %bb.w, label %bb.x

bb.w:                                             ; preds = %bb.v
  store i32 %.07.i20.i, ptr %3, align 4, !tbaa !16
  br label %_ZN4leaneqERKNS_3natES2_.exit

bb.x:                                             ; preds = %bb.v
  %i.ex = icmp ugt i32 %i.et, %i.ev
  store i32 %.07.i.i, ptr %i.er, align 4, !tbaa !16
  br i1 %i.ex, label %_ZN4leaneqERKNS_3natES2_.exit, label %bb.y

bb.y:                                             ; preds = %bb.x
  %i.ey = add i32 %i.et, 1
  store i32 %i.ey, ptr %i.es, align 4, !tbaa !17
  br label %_ZN4leaneqERKNS_3natES2_.exit
...
_ZN4lean13equiv_manager4findEj.exit.i:            ; preds = %bb.b, %_ZN4lean13equiv_manager4findEj.exit.i
  ...
  %.not.i21.i = icmp eq i32 %i.i, %.07.i20.i
  br i1 %.not.i21.i, label %_ZN4lean13equiv_manager4findEj.exit22.i, label %_ZN4lean13equiv_manager4findEj.exit.i
...
bb.c:                                             ; preds = %_ZN4lean13equiv_manager4findEj.exit22.i
  ...
  %i.l = load i32, ptr %i.k, align 4, !tbaa !17   ; 3 uses
...
bb.e:                                             ; preds = %bb.c
  %i.p = icmp ugt i32 %i.l, %i.n
  store i32 %.07.i.i, ptr %i.j, align 4, !tbaa !16
  br i1 %i.p, label %_ZN4lean13equiv_manager5mergeEjj.exit, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.q = add i32 %i.l, 1
  store i32 %i.q, ptr %i.k, align 4, !tbaa !17
  br label %_ZN4lean13equiv_manager5mergeEjj.exit
