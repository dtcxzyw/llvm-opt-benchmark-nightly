...
bb.a:
  ...
  %.val32 = load i64, ptr %i.a, align 8, !tbaa !15
...
bb.h:                                             ; preds = %lean_dec.exit18
  %i.l = load i32, ptr %6, align 4, !tbaa !12     ; 3 uses
  %i.m = icmp sgt i32 %i.l, 1
  br i1 %i.m, label %bb.i, label %bb.j, !prof !13

bb.i:                                             ; preds = %bb.h
  %i.n = add nsw i32 %i.l, -1
  store i32 %i.n, ptr %6, align 4, !tbaa !12
...
lean_dec.exit16:                                  ; preds = %bb.k, %bb.j, %bb.i, %lean_dec.exit18
  %i.o = load i32, ptr %5, align 4, !tbaa !12     ; 3 uses
  %i.p = icmp sgt i32 %i.o, 1
  br i1 %i.p, label %bb.l, label %bb.m, !prof !13

bb.l:                                             ; preds = %lean_dec.exit16
  %i.q = add nsw i32 %i.o, -1
  store i32 %i.q, ptr %5, align 4, !tbaa !12
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %i.b = load i32, ptr %3, align 4, !tbaa !12     ; 3 uses
  %i.c = icmp sgt i32 %i.b, 1
...
lean_dec_ref.exit132.peel:                        ; preds = %bb.d, %bb.c, %bb.b
  ...
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !10   ; 7 uses
...
bb.e:                                             ; preds = %lean_dec_ref.exit132.peel
  %.val.i.i.peel = load i32, ptr %i.f, align 4, !tbaa !12 ; 3 uses
...
bb.h:                                             ; preds = %bb.e
  ...
  store i32 %i.k, ptr %i.f, align 4, !tbaa !12
  br label %lean_inc.exit108.peel
...
bb.k:                                             ; preds = %bb.j
  %i.t = load i32, ptr %i.o, align 4, !tbaa !12   ; 3 uses
  %i.u = icmp sgt i32 %i.t, 1
...
bb.n:                                             ; preds = %bb.k
  %i.v = add nsw i32 %i.t, -1
  store i32 %i.v, ptr %i.o, align 4, !tbaa !12
  br label %lean_dec.exit111.peel
...
bb.p:                                             ; preds = %bb.o
  %.val.i.i134.peel = load i32, ptr %i.o, align 4, !tbaa !12 ; 3 uses
...
bb.s:                                             ; preds = %bb.p
  ...
  store i32 %i.ab, ptr %i.o, align 4, !tbaa !12
  br label %lean_inc.exit106.peel
...
bb.t:                                             ; preds = %lean_inc.exit106.peel
  ...
  %i.af = load i32, ptr %i.o, align 4, !tbaa !12  ; 3 uses
...
bb.w:                                             ; preds = %bb.t
  ...
  store i32 %i.ah, ptr %i.o, align 4, !tbaa !12
  br label %lean_dec.exit115.peel
...
bb.z:                                             ; preds = %lean_obj_tag.exit.peel
  %.val.i140.peel = load i32, ptr %i.al, align 4, !tbaa !12 ; 4 uses
...
bb.ad:                                            ; preds = %bb.aa
  ...
  store i32 %i.av, ptr %i.al, align 4, !tbaa !12
  br label %lean_dec.exit.peel

.preheader.i.peel:                                ; preds = %bb.z
  %i.aw = getelementptr inbounds nuw i8, ptr %i.al, i64 8
  %i.ax = load ptr, ptr %i.aw, align 8, !tbaa !10 ; 4 uses
...
bb.ae:                                            ; preds = %.preheader.i.peel
  %i.ba = load i32, ptr %i.ax, align 4, !tbaa !12 ; 3 uses
...
bb.ah:                                            ; preds = %bb.ae
  ...
  store i32 %i.bc, ptr %i.ax, align 4, !tbaa !12
  br label %lean_dec.exit.i.peel
...
.lr.ph.peel.newph:                                ; preds = %lean_dec.exit.peel, %lean_dec.exit
  ...
  %i.bh = load ptr, ptr %i.bg, align 8, !tbaa !10 ; 7 uses
...
bb.bg:                                            ; preds = %.loopexit253
  %i.cz = load i32, ptr %.lcssa245, align 4, !tbaa !12 ; 3 uses
  %i.da = icmp sgt i32 %i.cz, 1
  br i1 %i.da, label %bb.bh, label %bb.bi, !prof !13

bb.bh:                                            ; preds = %bb.bg
  %i.db = add nsw i32 %i.cz, -1
  store i32 %i.db, ptr %.lcssa245, align 4, !tbaa !12
...
bb.bs:                                            ; preds = %lean_obj_tag.exit
  %.val.i140 = load i32, ptr %i.dh, align 4, !tbaa !12 ; 4 uses
...
.preheader.i:                                     ; preds = %bb.bs
  ...
  %i.dr = load ptr, ptr %i.dq, align 8, !tbaa !10 ; 4 uses
...
bb.by:                                            ; preds = %bb.bx
  ...
  store i32 %i.dy, ptr %i.dh, align 4, !tbaa !12
  br label %lean_dec.exit
...
.loopexit254:                                     ; preds = %lean_obj_tag.exit, %lean_obj_tag.exit.peel
  ...
  %i.ea = load ptr, ptr %i.dz, align 8, !tbaa !10 ; 5 uses
  %.val = load i32, ptr %.lcssa249, align 8, !tbaa !12
...
bb.cg:                                            ; preds = %lean_inc.exit
  %i.eh = load i32, ptr %.lcssa249, align 8, !tbaa !12 ; 3 uses
  %i.ei = icmp sgt i32 %i.eh, 1
  br i1 %i.ei, label %bb.ch, label %bb.ci, !prof !13

bb.ch:                                            ; preds = %bb.cg
  %i.ej = add nsw i32 %i.eh, -1
  store i32 %i.ej, ptr %.lcssa249, align 8, !tbaa !12
  br label %bb.ck
...
lean_dec.exit:                                    ; preds = %bb.ca, %bb.bz, %bb.by, %lean_dec.exit.i
  ...
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph.peel.newph, !llvm.loop !20
...
.thread147.sink.split:                            ; preds = %bb.ck, %lean_dec.exit113, %lean_dec.exit117, %.loopexit, %._crit_edge
  ...
  store ptr %l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00__private_Lean_Meta_Tactic_Grind_CollectParams_0__Lean_Meta_Grind_Collector_collect_spec__0___closed__3_value.sink, ptr %i.eo, align 8, !tbaa !10
  br label %.thread147
...
lean_inc.exit514:                                 ; preds = %bb.e, %bb.d, %bb.c
  ...
  %.val.i.i703 = load i32, ptr %.0395, align 4, !tbaa !12 ; 6 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  store i32 %i.k, ptr %.0395, align 4, !tbaa !12
...
bb.mx:                                            ; preds = %bb.mw
  ...
  store i32 %i.th, ptr %i.rf, align 4, !tbaa !12
...
bb.nh:                                            ; preds = %bb.ng
  ...
  store i32 %i.tr, ptr %.0395, align 4, !tbaa !12
...
lean_dec.exit517:                                 ; preds = %lean_inc.exit514.thread, %bb.nj, %bb.ni, %bb.nh
  ...
  %i.tv = load ptr, ptr %i.tu, align 8, !tbaa !10 ; 5 uses
  %i.tw = getelementptr inbounds nuw i8, ptr %i.tt, i64 16
  %i.tx = load ptr, ptr %i.tw, align 8, !tbaa !10 ; 5 uses
  %.val698 = load i32, ptr %i.tt, align 8, !tbaa !12
...
lean_alloc_ctor.exit832:                          ; preds = %bb.nw
  ...
  store i64 0, ptr %i.up, align 8, !tbaa !15
  store i32 1, ptr %i.um, align 8, !tbaa !12
  store i32 131104, ptr %i.uo, align 4
  %i.uq = getelementptr inbounds nuw i8, ptr %i.um, i64 8
  store ptr %i.tv, ptr %i.uq, align 8, !tbaa !10
  %i.ur = getelementptr inbounds nuw i8, ptr %i.um, i64 16
  store ptr %i.tx, ptr %i.ur, align 8, !tbaa !10
  br label %lean_dec.exit
...
lean_alloc_ctor.exit833:                          ; preds = %lean_dec.exit
  ...
  store i32 1, ptr %i.uu, align 4, !tbaa !12
  store i32 65552, ptr %i.uw, align 4
  %i.ux = getelementptr inbounds nuw i8, ptr %i.uu, i64 8
  store ptr inttoptr (i64 1 to ptr), ptr %i.ux, align 8, !tbaa !10
  br label %bb.nz
...
lean_dec.exit:                                    ; preds = %bb.ca, %bb.bz, %bb.by, %lean_dec.exit.i
  %i.em = add nuw i64 %.079175, 1                 ; 2 uses
  %exitcond.not = icmp eq i64 %i.em, %1
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph.peel.newph, !llvm.loop !21
...
bb.b:                                             ; preds = %bb.a
  %i.d = load i32, ptr %3, align 4, !tbaa !12     ; 3 uses
  %i.e = icmp sgt i32 %i.d, 1
  br i1 %i.e, label %bb.c, label %bb.d, !prof !13

bb.c:                                             ; preds = %bb.b
  %i.f = add nsw i32 %i.d, -1
  store i32 %i.f, ptr %3, align 4, !tbaa !12
