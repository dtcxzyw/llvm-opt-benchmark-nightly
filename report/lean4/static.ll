...
bb.a:
  ...
  br i1 %.not, label %bb.c, label %bb.b, !prof !61
...
bb.c:                                             ; preds = %bb.a
  ...
  %.val = load i64, ptr %i.k, align 8, !tbaa !62
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.i = load i8, ptr %i.h, align 2, !tbaa !60    ; 2 uses
...
bb.d:                                             ; preds = %bb.b
  ...
  %.val.i = load i64, ptr %i.m, align 8, !tbaa !62
...
bb.e:                                             ; preds = %_Z20_mi_page_ptr_unalignPK9mi_page_sPKv.exit, %bb.a
  ...
  store i64 %i.t, ptr %i.q, align 8, !tbaa !65
  ...
  br i1 %i.x, label %bb.f, label %bb.g, !prof !61
...
bb.g:                                             ; preds = %bb.e
  ...
  br i1 %i.y, label %bb.h, label %_ZL19mi_free_block_localP9mi_page_sP10mi_block_sbb.exit, !prof !61
...
bb.c:                                             ; preds = %bb.a
  %i.k = getelementptr i8, ptr %0, i64 40
  %.val.i = load i64, ptr %i.k, align 8, !tbaa !62
...
bb.a:
  ...
  %1 = icmp eq i64 %i.c, 0
  %2 = or i1 %i.e, %1
  br i1 %2, label %_ZL19mi_free_block_localP9mi_page_sP10mi_block_sbb.exit, label %bb.b, !prof !61
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %i.ac, label %bb.e, label %_ZL19mi_free_block_localP9mi_page_sP10mi_block_sbb.exit, !prof !61
...
_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.i.i: ; preds = %bb.c, %_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.i.i
  ...
  br i1 %i.ab, label %._crit_edge.i.i, label %_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.i.i, !llvm.loop !0
...
bb.d:                                             ; preds = %._crit_edge.i.i
  ...
  %i.ag = load i16, ptr %i.af, align 2, !tbaa !71 ; 2 uses
  %i.ah = zext i16 %i.ag to i64                   ; 2 uses
  %.0.val30.i.i = load i64, ptr %i.ad, align 8, !tbaa !65 ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %bb.d, %.lr.ph.i.i
  ...
  %.0.val.i.i = load i64, ptr %i.al, align 8, !tbaa !65 ; 2 uses
  %i.an = icmp ne i64 %.0.val.i.i, 0
  %i.ao = icmp samesign ult i64 %.02031.i.i, %i.ah
  %i.ap = select i1 %i.an, i1 %i.ao, i1 false
  br i1 %i.ap, label %.lr.ph.i.i, label %._crit_edge34.i.i, !llvm.loop !1
...
bb.f:                                             ; preds = %._crit_edge34.i.i
  ...
  store i64 %i.at, ptr %.0.lcssa.i.i, align 8, !tbaa !65
  store ptr %i.ad, ptr %i.ar, align 8, !tbaa !63
  %i.au = trunc nuw i64 %.020.lcssa.i.i to i16
  %i.av = getelementptr inbounds nuw i8, ptr %i.p, i64 32 ; 2 uses
  %i.aw = load i16, ptr %i.av, align 8, !tbaa !66
  %i.ax = sub i16 %i.aw, %i.au
  store i16 %i.ax, ptr %i.av, align 8, !tbaa !66
  br label %_ZL28_mi_page_thread_free_collectP9mi_page_s.exit.i
...
bb.g:                                             ; preds = %_ZL28_mi_page_thread_free_collectP9mi_page_s.exit.i
  ...
  br i1 %i.bc, label %.sink.split.i, label %_Z21_mi_page_free_collectP9mi_page_sb.exit, !prof !68

.sink.split.i:                                    ; preds = %bb.g
  store ptr %i.az, ptr %i.ba, align 8, !tbaa !72
...
_Z21_mi_page_free_collectP9mi_page_sb.exit:       ; preds = %bb.g, %_ZL28_mi_page_thread_free_collectP9mi_page_s.exit.i, %.sink.split.i
  ...
  store i64 %i.bh, ptr %0, align 8, !tbaa !65
  store ptr %0, ptr %i.ay, align 8, !tbaa !63
  %i.bi = getelementptr inbounds nuw i8, ptr %i.p, i64 32 ; 2 uses
  %i.bj = load i16, ptr %i.bi, align 8, !tbaa !66
  %i.bk = add i16 %i.bj, -1                       ; 2 uses
  store i16 %i.bk, ptr %i.bi, align 8, !tbaa !66
  %i.bl = icmp eq i16 %i.bk, 0
  br i1 %i.bl, label %bb.h, label %bb.i, !prof !61
...
begin_hunk_1_@_Z29_mi_page_try_use_delayed_freeP9mi_page_s12mi_delayed_eb:.critedge.outer
  ...
  br i1 %.not.2.not, label %.critedge.outer.3, label %bb.d, !prof !61
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.ad, label %_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.thread, label %.critedge.2, !llvm.loop !2
...
.critedge.3:                                      ; preds = %bb.g, %.critedge.outer.3
  ...
  br i1 %.not.3.not, label %.critedge.outer.4, label %bb.f, !prof !61
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %i.an, label %_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.thread, label %.critedge.3, !llvm.loop !2
...
.critedge.4:                                      ; preds = %bb.i, %.critedge.outer.4
  ...
  br i1 %.not.4.not.not, label %bb.h, label %_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.thread, !prof !68
...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %i.aw, label %_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.thread, label %.critedge.4, !llvm.loop !2

bb.j:                                             ; preds = %bb.a
  %i.ax = cmpxchg weak ptr %i.a, i64 %i.c, i64 %i.e release monotonic, align 8
  %i.ay = extractvalue { i64, i1 } %i.ax, 1
  br i1 %i.ay, label %_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.thread, label %.critedge, !llvm.loop !2
...
_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.i: ; preds = %bb.c, %_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.i
  ...
  br i1 %i.l, label %._crit_edge.i, label %_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.i, !llvm.loop !0
...
bb.d:                                             ; preds = %._crit_edge.i
  ...
  %i.q = load i16, ptr %i.p, align 2, !tbaa !71   ; 2 uses
  %i.r = zext i16 %i.q to i64                     ; 2 uses
  %.0.val30.i = load i64, ptr %i.n, align 8, !tbaa !65 ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.d, %.lr.ph.i
  ...
  %.0.val.i = load i64, ptr %i.v, align 8, !tbaa !65 ; 2 uses
  %i.x = icmp ne i64 %.0.val.i, 0
  %i.y = icmp samesign ult i64 %.02031.i, %i.r
  %i.z = select i1 %i.x, i1 %i.y, i1 false
  br i1 %i.z, label %.lr.ph.i, label %._crit_edge34.i, !llvm.loop !1
...
bb.f:                                             ; preds = %._crit_edge34.i
  ...
  store i64 %i.ad, ptr %.0.lcssa.i, align 8, !tbaa !65
  store ptr %i.n, ptr %i.ab, align 8, !tbaa !63
  %i.ae = trunc nuw i64 %.020.lcssa.i to i16
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 2 uses
  %i.ag = load i16, ptr %i.af, align 8, !tbaa !66
  %i.ah = sub i16 %i.ag, %i.ae
  store i16 %i.ah, ptr %i.af, align 8, !tbaa !66
  br label %_ZL28_mi_page_thread_free_collectP9mi_page_s.exit
...
bb.g:                                             ; preds = %_ZL28_mi_page_thread_free_collectP9mi_page_s.exit
  ...
  br i1 %i.am, label %.sink.split, label %bb.h, !prof !68
...
.preheader:                                       ; preds = %bb.h, %.preheader
  ...
  %.0.val = load i64, ptr %.0, align 8, !tbaa !65 ; 2 uses
  %i.an = inttoptr i64 %.0.val to ptr
  %.not23 = icmp eq i64 %.0.val, 0
  br i1 %.not23, label %bb.i, label %.preheader, !llvm.loop !3

bb.i:                                             ; preds = %.preheader
  %i.ao = ptrtoint ptr %i.al to i64
  store i64 %i.ao, ptr %.0, align 8, !tbaa !65
  br label %.sink.split

.sink.split:                                      ; preds = %bb.g, %bb.i
  store ptr %i.aj, ptr %i.ak, align 8, !tbaa !72
  store ptr null, ptr %i.ai, align 8, !tbaa !63
...
bb.a:
  ...
  %2 = icmp eq i64 %1, 0
  %3 = or i1 %i.c, %2
  br i1 %3, label %_ZL15_mi_usable_sizePKvPKc.exit, label %bb.b, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not.i, label %bb.c, label %bb.d, !prof !68

bb.c:                                             ; preds = %bb.b
  %i.p = getelementptr i8, ptr %i.m, i64 40
  %.val12.i = load i64, ptr %i.p, align 8, !tbaa !62
...
bb.a:
  ...
  %2 = icmp eq i64 %i.c, 0
  %3 = or i1 %i.e, %2
  br i1 %3, label %mi_free.exit, label %bb.b, !prof !61
...
bb.a:
  ...
  %3 = icmp eq i64 %i.c, 0
  %4 = or i1 %i.e, %3
  br i1 %4, label %mi_free_size.exit, label %bb.b, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  %3 = icmp eq i64 %2, 0
  %4 = or i1 %i.d, %3
  br i1 %4, label %_ZL15_mi_usable_sizePKvPKc.exit, label %bb.c, !prof !61
...
bb.d:                                             ; preds = %bb.c
  ...
  %.val12.i = load i64, ptr %i.q, align 8, !tbaa !62
  br label %_ZL15_mi_usable_sizePKvPKc.exit
...
bb.a:
  ...
  br i1 %6, label %_ZL15_mi_usable_sizePKvPKc.exit.thread, label %bb.b, !prof !61
...
_ZL15_mi_usable_sizePKvPKc.exit:                  ; preds = %bb.c, %bb.d
  ...
  br i1 %.not43, label %bb.e, label %mi_free.exit, !prof !249
...
bb.e:                                             ; preds = %_ZL15_mi_usable_sizePKvPKc.exit.thread, %_ZL15_mi_usable_sizePKvPKc.exit
  ...
  br i1 %i.u, label %bb.f, label %mi_heap_malloc.exit, !prof !68
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.ac, label %mi_heap_malloc.exit, label %mi_heap_malloc.exit.thread, !prof !61

mi_heap_malloc.exit.thread:                       ; preds = %bb.f
  %.val.i.i.i.i.i = load i64, ptr %i.ab, align 8, !tbaa !65
  %i.ad = inttoptr i64 %.val.i.i.i.i.i to ptr
  store ptr %i.ad, ptr %i.aa, align 8, !tbaa !72
  %i.ae = getelementptr inbounds nuw i8, ptr %i.z, i64 32 ; 2 uses
  %i.af = load i16, ptr %i.ae, align 8, !tbaa !66
  %i.ag = add i16 %i.af, 1
  store i16 %i.ag, ptr %i.ae, align 8, !tbaa !66
  br label %bb.g
...
mi_heap_malloc.exit:                              ; preds = %bb.e, %bb.f
  ...
  br i1 %.not36, label %mi_free.exit, label %bb.g, !prof !250
...
bb.j:                                             ; preds = %bb.i
  store i8 0, ptr %.0.i.i.i41, align 1, !tbaa !69
  br label %bb.k

bb.k:                                             ; preds = %bb.i, %bb.j, %bb.h
  %.not37 = icmp eq ptr %1, null
  br i1 %.not37, label %mi_free.exit, label %bb.l, !prof !61
...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %6, label %mi_free.exit, label %bb.m, !prof !61
...
bb.m:                                             ; preds = %bb.l
  ...
  br i1 %i.bb, label %bb.n, label %bb.r, !prof !68

bb.n:                                             ; preds = %bb.m
  %i.bc = getelementptr inbounds nuw i8, ptr %i.ba, i64 14
  %i.bd = load i8, ptr %i.bc, align 2, !tbaa !69
  %i.be = icmp eq i8 %i.bd, 0
  br i1 %i.be, label %bb.o, label %bb.q, !prof !68

bb.o:                                             ; preds = %bb.n
  %i.bf = getelementptr inbounds nuw i8, ptr %i.ba, i64 24 ; 2 uses
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !63
  %i.bh = ptrtoint ptr %i.bg to i64
  store i64 %i.bh, ptr %1, align 8, !tbaa !65
  store ptr %1, ptr %i.bf, align 8, !tbaa !63
  %i.bi = getelementptr inbounds nuw i8, ptr %i.ba, i64 32 ; 2 uses
  %i.bj = load i16, ptr %i.bi, align 8, !tbaa !66
  %i.bk = add i16 %i.bj, -1                       ; 2 uses
  store i16 %i.bk, ptr %i.bi, align 8, !tbaa !66
  %i.bl = icmp eq i16 %i.bk, 0
  br i1 %i.bl, label %bb.p, label %mi_free.exit, !prof !61

bb.p:                                             ; preds = %bb.o
  tail call void @_Z15_mi_page_retireP9mi_page_s(ptr noundef nonnull %i.ba) #55, !inline_history !73
  br label %mi_free.exit

bb.q:                                             ; preds = %bb.n
  tail call fastcc void @_ZL21mi_free_generic_localP9mi_page_sP12mi_segment_sPv(ptr noundef nonnull %i.ba, ptr noundef nonnull %1) #55, !inline_history !73
  br label %mi_free.exit

bb.r:                                             ; preds = %bb.m
  tail call fastcc void @_ZL18mi_free_generic_mtP9mi_page_sP12mi_segment_sPv(ptr noundef nonnull %i.ba, ptr noundef nonnull %i.an, ptr noundef nonnull %1) #57, !inline_history !73
  br label %mi_free.exit
...
bb.b:                                             ; preds = %bb.a
  ...
  %3 = icmp eq i64 %i.f, 0
  %4 = or i1 %i.h, %3
  br i1 %4, label %mi_free.exit, label %bb.c, !prof !61
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.r = load i32, ptr %i.q, align 4, !tbaa !67
  %i.s = zext i32 %i.r to i64
  %i.t = sub nsw i64 0, %i.s
  %i.u = getelementptr inbounds i8, ptr %i.p, i64 %i.t ; 6 uses
  %i.v = icmp eq i64 %i.l, %i.j
  br i1 %i.v, label %bb.d, label %bb.h, !prof !68

bb.d:                                             ; preds = %bb.c
  %i.w = getelementptr inbounds nuw i8, ptr %i.u, i64 14
  %i.x = load i8, ptr %i.w, align 2, !tbaa !69
  %i.y = icmp eq i8 %i.x, 0
  br i1 %i.y, label %bb.e, label %bb.g, !prof !68

bb.e:                                             ; preds = %bb.d
  %i.z = getelementptr inbounds nuw i8, ptr %i.u, i64 24 ; 2 uses
  %i.aa = load ptr, ptr %i.z, align 8, !tbaa !63
  %i.ab = ptrtoint ptr %i.aa to i64
  store i64 %i.ab, ptr %1, align 8, !tbaa !65
  store ptr %1, ptr %i.z, align 8, !tbaa !63
  %i.ac = getelementptr inbounds nuw i8, ptr %i.u, i64 32 ; 2 uses
  %i.ad = load i16, ptr %i.ac, align 8, !tbaa !66
  %i.ae = add i16 %i.ad, -1                       ; 2 uses
  store i16 %i.ae, ptr %i.ac, align 8, !tbaa !66
  %i.af = icmp eq i16 %i.ae, 0
  br i1 %i.af, label %bb.f, label %mi_free.exit, !prof !61

bb.f:                                             ; preds = %bb.e
  tail call void @_Z15_mi_page_retireP9mi_page_s(ptr noundef nonnull %i.u) #55, !inline_history !73
  br label %mi_free.exit

bb.g:                                             ; preds = %bb.d
  tail call fastcc void @_ZL21mi_free_generic_localP9mi_page_sP12mi_segment_sPv(ptr noundef nonnull %i.u, ptr noundef nonnull %1) #55, !inline_history !73
  br label %mi_free.exit

bb.h:                                             ; preds = %bb.c
  tail call fastcc void @_ZL18mi_free_generic_mtP9mi_page_sP12mi_segment_sPv(ptr noundef nonnull %i.u, ptr noundef nonnull %i.g, ptr noundef nonnull %1) #57, !inline_history !73
  br label %mi_free.exit
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = extractvalue { i64, i1 } %i.c, 1
  %i.e = extractvalue { i64, i1 } %i.c, 0
  br i1 %i.d, label %mi_heap_reallocn.exit, label %bb.c, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = extractvalue { i64, i1 } %i.c, 1
  %i.e = extractvalue { i64, i1 } %i.c, 0
  br i1 %i.d, label %mi_heap_recalloc.exit, label %bb.c, !prof !61
...
_Z10_mi_strlenPKc.exit:                           ; preds = %bb.a
  ...
  br i1 %i.c, label %bb.b, label %mi_heap_malloc.exit, !prof !68
...
bb.b:                                             ; preds = %_Z10_mi_strlenPKc.exit
  ...
  br i1 %i.k, label %mi_heap_malloc.exit, label %mi_heap_malloc.exit.thread, !prof !61
...
.preheader.i.i:                                   ; preds = %bb.a, %.preheader.i.i
  ...
  %i.e = load i8, ptr %i.d, align 1, !tbaa !69
  %i.f = icmp ne i8 %i.e, 0
  %i.g = icmp ult i64 %.0.i.i, %1
  %i.h = and i1 %i.g, %i.f
  %i.i = add i64 %.0.i.i, 1                       ; 3 uses
  br i1 %i.h, label %.preheader.i.i, label %_Z11_mi_strnlenPKcm.exit.i, !llvm.loop !4

_Z11_mi_strnlenPKcm.exit.i:                       ; preds = %.preheader.i.i
  %i.j = icmp ult i64 %i.i, 1025
  br i1 %i.j, label %bb.b, label %mi_heap_malloc.exit.i, !prof !68
...
bb.b:                                             ; preds = %_Z11_mi_strnlenPKcm.exit.i
  ...
  br i1 %i.r, label %mi_heap_malloc.exit.i, label %mi_heap_malloc.exit.thread.i, !prof !61
...
mi_heap_malloc.exit.thread.i:                     ; preds = %bb.b
  ...
  store ptr %i.s, ptr %i.p, align 8, !tbaa !72
...
bb.c:                                             ; preds = %mi_heap_malloc.exit.i, %mi_heap_malloc.exit.thread.i
  ...
  store i8 0, ptr %i.y, align 1, !tbaa !69
...
_Z10_mi_strlenPKc.exit.i:                         ; preds = %bb.c
  ...
  br i1 %i.e, label %bb.d, label %mi_heap_malloc.exit.i, !prof !68
...
bb.d:                                             ; preds = %_Z10_mi_strlenPKc.exit.i
  ...
  br i1 %i.m, label %mi_heap_malloc.exit.i, label %mi_heap_malloc.exit.thread.i, !prof !61

mi_heap_malloc.exit.thread.i:                     ; preds = %bb.d
  %.val.i.i.i.i.i.i = load i64, ptr %i.l, align 8, !tbaa !65
  %i.n = inttoptr i64 %.val.i.i.i.i.i.i to ptr
  store ptr %i.n, ptr %i.k, align 8, !tbaa !72
...
bb.e:                                             ; preds = %mi_heap_malloc.exit.i, %mi_heap_malloc.exit.thread.i
  ...
  store i8 0, ptr %i.t, align 1, !tbaa !69
...
.critedge.i.i.i:                                  ; preds = %bb.c, %bb.b, %.lr.ph.i.i.i
  ...
  br i1 %exitcond.not.i.i.i, label %.loopexit.i.i, label %.lr.ph.i.i.i, !llvm.loop !5
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.z, label %mi_free.exit, label %mi_is_in_heap_region.exit, !prof !61
...
mi_is_in_heap_region.exit.thread2:                ; preds = %mi_is_in_heap_region.exit.thread2.loopexit, %mi_is_in_heap_region.exit
  ...
  %2 = or i1 %i.ak, %1
  br i1 %2, label %mi_free.exit, label %bb.f, !prof !61
...
bb.f:                                             ; preds = %mi_is_in_heap_region.exit.thread2
  ...
  br i1 %i.ay, label %bb.g, label %bb.k, !prof !68

bb.g:                                             ; preds = %bb.f
  %i.az = getelementptr inbounds nuw i8, ptr %i.ax, i64 14
  %i.ba = load i8, ptr %i.az, align 2, !tbaa !69
  %i.bb = icmp eq i8 %i.ba, 0
  br i1 %i.bb, label %bb.h, label %bb.j, !prof !68

bb.h:                                             ; preds = %bb.g
  %i.bc = getelementptr inbounds nuw i8, ptr %i.ax, i64 24 ; 2 uses
  %i.bd = load ptr, ptr %i.bc, align 8, !tbaa !63
  %i.be = ptrtoint ptr %i.bd to i64
  store i64 %i.be, ptr %0, align 8, !tbaa !65
  store ptr %0, ptr %i.bc, align 8, !tbaa !63
  %i.bf = getelementptr inbounds nuw i8, ptr %i.ax, i64 32 ; 2 uses
  %i.bg = load i16, ptr %i.bf, align 8, !tbaa !66
  %i.bh = add i16 %i.bg, -1                       ; 2 uses
  store i16 %i.bh, ptr %i.bf, align 8, !tbaa !66
  %i.bi = icmp eq i16 %i.bh, 0
  br i1 %i.bi, label %bb.i, label %mi_free.exit, !prof !61

bb.i:                                             ; preds = %bb.h
  tail call void @_Z15_mi_page_retireP9mi_page_s(ptr noundef nonnull %i.ax) #55, !inline_history !73
  br label %mi_free.exit

bb.j:                                             ; preds = %bb.g
  tail call fastcc void @_ZL21mi_free_generic_localP9mi_page_sP12mi_segment_sPv(ptr noundef nonnull %i.ax, ptr noundef %0) #55, !inline_history !73
  br label %mi_free.exit

bb.k:                                             ; preds = %bb.f
  tail call fastcc void @_ZL18mi_free_generic_mtP9mi_page_sP12mi_segment_sPv(ptr noundef nonnull %i.ax, ptr noundef nonnull %.pre-phi8, ptr noundef %0) #57, !inline_history !73
  br label %mi_free.exit
...
bb.a:
  ...
  br i1 %i.a, label %.split.us, label %.split, !prof !68
...
bb.b:                                             ; preds = %mi_heap_malloc.exit.us
  ...
  br i1 %.not.us, label %.split8.us, label %.lr.ph, !llvm.loop !251

.lr.ph:                                           ; preds = %.split.us, %bb.b
  %i.h = phi ptr [ %i.g, %bb.b ], [ %i.f, %.split.us ]
  tail call void %i.h(), !inline_history !6
  %i.i = load ptr, ptr %i.e, align 8, !tbaa !77   ; 3 uses
  %i.j = getelementptr inbounds nuw i8, ptr %i.i, i64 16
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !72   ; 3 uses
  %i.l = icmp eq ptr %i.k, null
  br i1 %i.l, label %mi_heap_malloc.exit.us, label %mi_heap_malloc.exit.us.thread, !prof !61

mi_heap_malloc.exit.us.thread:                    ; preds = %.lr.ph
  %i.m = getelementptr inbounds nuw i8, ptr %i.i, i64 16
  %.val.i.i.i.i.i.us = load i64, ptr %i.k, align 8, !tbaa !65
...
mi_heap_malloc.exit.us:                           ; preds = %.lr.ph
  %i.r = tail call noalias noundef ptr @_Z18_mi_malloc_genericP9mi_heap_smbm(ptr noundef nonnull %0, i64 noundef %1, i1 noundef zeroext false, i64 noundef 0) #55, !inline_history !74 ; 2 uses
  %i.s = icmp eq ptr %i.r, null
  br i1 %i.s, label %bb.b, label %.critedge, !llvm.loop !251
...
bb.c:                                             ; preds = %mi_heap_malloc.exit
  ...
  br i1 %.not, label %.split8.us, label %mi_heap_malloc.exit, !llvm.loop !251
...
bb.d:                                             ; preds = %.split8.us
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.u, align 8, !tbaa !89
...
mi_heap_malloc.exit:                              ; preds = %.split, %bb.c
  ...
  tail call void %i.v(), !inline_history !6
  ...
  %i.x = icmp eq ptr %i.w, null
  br i1 %i.x, label %bb.c, label %.critedge, !llvm.loop !251
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt9bad_alloc, i64 16), ptr %i.b, align 8, !tbaa !89
...
bb.a:
  %i.a = icmp ult i64 %1, 1025
  br i1 %i.a, label %bb.b, label %mi_heap_malloc.exit, !prof !68
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = load ptr, ptr %i.g, align 8, !tbaa !72   ; 3 uses
  %i.i = icmp eq ptr %i.h, null
  br i1 %i.i, label %mi_heap_malloc.exit, label %mi_heap_malloc.exit.thread, !prof !61

mi_heap_malloc.exit.thread:                       ; preds = %bb.b
  %.val.i.i.i.i.i = load i64, ptr %i.h, align 8, !tbaa !65
  %i.j = inttoptr i64 %.val.i.i.i.i.i to ptr
  store ptr %i.j, ptr %i.g, align 8, !tbaa !72
...
mi_heap_malloc.exit:                              ; preds = %bb.a, %bb.b
  ...
  br i1 %i.o, label %bb.c, label %bb.d, !prof !90
...
bb.l:                                             ; preds = %bb.c
  ...
  br i1 %8, label %mi_usable_size.exit, label %bb.m, !prof !61
...
bb.n:                                             ; preds = %bb.m
  ...
  %.val12.i.i = load i64, ptr %i.ar, align 8, !tbaa !62
...
bb.s:                                             ; preds = %bb.r
  ...
  br i1 %i.bb, label %bb.t, label %mi_heap_malloc_aligned_at.exit, !prof !68
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !77 ; 2 uses
...
mi_heap_malloc_aligned_at.exit.thread55:          ; preds = %bb.u
  %.val.i.i.i.i = load i64, ptr %i.bi, align 8, !tbaa !65
  %i.bn = inttoptr i64 %.val.i.i.i.i to ptr
  store ptr %i.bn, ptr %i.bh, align 8, !tbaa !72
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bg, i64 32 ; 2 uses
  %i.bp = load i16, ptr %i.bo, align 8, !tbaa !66
  %i.bq = add i16 %i.bp, 1
  store i16 %i.bq, ptr %i.bo, align 8, !tbaa !66
  br label %bb.v
...
bb.x:                                             ; preds = %bb.w, %bb.v
  ...
  br i1 %8, label %_ZL30mi_heap_malloc_zero_aligned_atP9mi_heap_smmmb.exit, label %bb.y, !prof !61
...
bb.y:                                             ; preds = %bb.x
  ...
  br i1 %i.ck, label %bb.z, label %bb.ad, !prof !68

bb.z:                                             ; preds = %bb.y
  %i.cl = getelementptr inbounds nuw i8, ptr %i.cj, i64 14
  %i.cm = load i8, ptr %i.cl, align 2, !tbaa !69
  %i.cn = icmp eq i8 %i.cm, 0
  br i1 %i.cn, label %bb.aa, label %bb.ac, !prof !68

bb.aa:                                            ; preds = %bb.z
  %i.co = getelementptr inbounds nuw i8, ptr %i.cj, i64 24 ; 2 uses
  %i.cp = load ptr, ptr %i.co, align 8, !tbaa !63
  %i.cq = ptrtoint ptr %i.cp to i64
  store i64 %i.cq, ptr %1, align 8, !tbaa !65
  store ptr %1, ptr %i.co, align 8, !tbaa !63
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cj, i64 32 ; 2 uses
  %i.cs = load i16, ptr %i.cr, align 8, !tbaa !66
  %i.ct = add i16 %i.cs, -1                       ; 2 uses
  store i16 %i.ct, ptr %i.cr, align 8, !tbaa !66
  %i.cu = icmp eq i16 %i.ct, 0
  br i1 %i.cu, label %bb.ab, label %_ZL30mi_heap_malloc_zero_aligned_atP9mi_heap_smmmb.exit, !prof !61

bb.ab:                                            ; preds = %bb.aa
  tail call void @_Z15_mi_page_retireP9mi_page_s(ptr noundef nonnull %i.cj) #55, !inline_history !73
  br label %_ZL30mi_heap_malloc_zero_aligned_atP9mi_heap_smmmb.exit

bb.ac:                                            ; preds = %bb.z
  tail call fastcc void @_ZL21mi_free_generic_localP9mi_page_sP12mi_segment_sPv(ptr noundef nonnull %i.cj, ptr noundef nonnull %1) #55, !inline_history !73
  br label %_ZL30mi_heap_malloc_zero_aligned_atP9mi_heap_smmmb.exit

bb.ad:                                            ; preds = %bb.y
  tail call fastcc void @_ZL18mi_free_generic_mtP9mi_page_sP12mi_segment_sPv(ptr noundef nonnull %i.cj, ptr noundef nonnull %i.bw, ptr noundef nonnull %1) #57, !inline_history !73
  br label %_ZL30mi_heap_malloc_zero_aligned_atP9mi_heap_smmmb.exit
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = extractvalue { i64, i1 } %i.c, 1
  %i.e = extractvalue { i64, i1 } %i.c, 0
  br i1 %i.d, label %mi_heap_recalloc_aligned_at.exit, label %bb.c, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = extractvalue { i64, i1 } %i.c, 1
  %i.e = extractvalue { i64, i1 } %i.c, 0
  br i1 %i.d, label %mi_heap_recalloc_aligned.exit, label %bb.c, !prof !61
...
bb.a:
  ...
  %2 = icmp eq i64 %1, 0
  %3 = or i1 %i.c, %2
  br i1 %3, label %mi_usable_size.exit, label %bb.b, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not.i.i, label %bb.c, label %bb.d, !prof !68

bb.c:                                             ; preds = %bb.b
  %i.p = getelementptr i8, ptr %i.m, i64 40
  %.val12.i.i = load i64, ptr %i.p, align 8, !tbaa !62
  br label %mi_usable_size.exit
...
bb.b:                                             ; preds = %bb.a
  ...
  %3 = icmp eq i64 %2, 0
  %4 = or i1 %i.d, %3
  br i1 %4, label %_ZL15_mi_usable_sizePKvPKc.exit.i, label %bb.c, !prof !61
...
bb.d:                                             ; preds = %bb.c
  %i.q = getelementptr i8, ptr %i.n, i64 40
  %.val12.i.i = load i64, ptr %i.q, align 8, !tbaa !62
...
select.unfold:                                    ; preds = %_ZL15_mi_usable_sizePKvPKc.exit.i, %bb.a
  ...
  store i32 12, ptr %i.t, align 4, !tbaa !97
...
_Z10_mi_strlenPKc.exit.i.i:                       ; preds = %bb.a
  ...
  %i.e = icmp ult i64 %i.d, 1025
  br i1 %i.e, label %bb.b, label %mi_heap_malloc.exit.i.i, !prof !68
...
bb.b:                                             ; preds = %_Z10_mi_strlenPKc.exit.i.i
  ...
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !72   ; 3 uses
  %i.m = icmp eq ptr %i.l, null
  br i1 %i.m, label %mi_heap_malloc.exit.i.i, label %mi_heap_malloc.exit.thread.i.i, !prof !61

mi_heap_malloc.exit.thread.i.i:                   ; preds = %bb.b
  %.val.i.i.i.i.i.i.i = load i64, ptr %i.l, align 8, !tbaa !65
...
_Z10_mi_strlenPKc.exit.i.i:                       ; preds = %bb.d
  ...
  br i1 %i.h, label %bb.f, label %mi_heap_malloc.exit.i.i, !prof !68
...
bb.f:                                             ; preds = %_Z10_mi_strlenPKc.exit.i.i
  ...
  br i1 %i.p, label %mi_heap_malloc.exit.i.i, label %mi_heap_malloc.exit.thread.i.i, !prof !61

mi_heap_malloc.exit.thread.i.i:                   ; preds = %bb.f
  %.val.i.i.i.i.i.i.i = load i64, ptr %i.o, align 8, !tbaa !65
...
bb.k:                                             ; preds = %bb.i, %bb.j, %bb.g
  ...
  %1 = icmp eq i64 %i.v, 0
  %2 = or i1 %i.x, %1
  br i1 %2, label %mi_free.exit, label %bb.l, !prof !61
...
begin_hunk_7_@_ZL33mi_segments_try_abandon_to_targetP9mi_heap_smP17mi_segments_tld_s:bb.a
  ...
  %.0.val = load i64, ptr %i.i, align 8, !tbaa !62
  %i.j = icmp ugt i64 %.0.val, 16777216
  br i1 %i.j, label %bb.e, label %.critedge2

bb.e:                                             ; preds = %.lr.ph
  %i.k = getelementptr inbounds nuw i8, ptr %.031, i64 72
  %.0 = load ptr, ptr %i.k, align 8, !tbaa !77    ; 2 uses
  %cond = icmp eq ptr %.0, null
  br i1 %cond, label %.critedge, label %.lr.ph, !llvm.loop !366
...
bb.f:                                             ; preds = %bb.n, %.lr.ph.i
  ...
  %.019.val.i = load i64, ptr %i.ab, align 8, !tbaa !62
...
_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.i.i.i: ; preds = %bb.h, %_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.i.i.i
  ...
  br i1 %i.am, label %._crit_edge.i.i.i, label %_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit.i.i.i, !llvm.loop !0
...
bb.i:                                             ; preds = %._crit_edge.i.i.i
  ...
  %i.ar = load i16, ptr %i.aq, align 2, !tbaa !71 ; 2 uses
  %i.as = zext i16 %i.ar to i64                   ; 2 uses
  %.0.val30.i.i.i = load i64, ptr %i.ao, align 8, !tbaa !65 ; 2 uses
...
.lr.ph.i.i.i:                                     ; preds = %bb.i, %.lr.ph.i.i.i
  ...
  %.0.val.i.i.i = load i64, ptr %i.aw, align 8, !tbaa !65 ; 2 uses
  %i.ay = icmp ne i64 %.0.val.i.i.i, 0
  %i.az = icmp samesign ult i64 %.02031.i.i.i, %i.as
  %i.ba = select i1 %i.ay, i1 %i.az, i1 false
  br i1 %i.ba, label %.lr.ph.i.i.i, label %._crit_edge34.i.i.i, !llvm.loop !1
...
bb.k:                                             ; preds = %._crit_edge34.i.i.i
  ...
  %i.bd = load ptr, ptr %i.bc, align 8, !tbaa !63
  %i.be = ptrtoint ptr %i.bd to i64
  store i64 %i.be, ptr %.0.lcssa.i.i.i, align 8, !tbaa !65
  store ptr %i.ao, ptr %i.bc, align 8, !tbaa !63
  %i.bf = trunc nuw i64 %.020.lcssa.i.i.i to i16
  %i.bg = getelementptr inbounds nuw i8, ptr %.01925.i, i64 32 ; 2 uses
  %i.bh = load i16, ptr %i.bg, align 8, !tbaa !66
  %i.bi = sub i16 %i.bh, %i.bf
  store i16 %i.bi, ptr %i.bg, align 8, !tbaa !66
  br label %_ZL28_mi_page_thread_free_collectP9mi_page_s.exit.i.i
...
bb.l:                                             ; preds = %_ZL28_mi_page_thread_free_collectP9mi_page_s.exit.i.i
  ...
  %i.bm = load ptr, ptr %i.bl, align 8, !tbaa !72
  %i.bn = icmp eq ptr %i.bm, null
  br i1 %i.bn, label %.sink.split.i.i, label %_Z21_mi_page_free_collectP9mi_page_sb.exit.i, !prof !68

.sink.split.i.i:                                  ; preds = %bb.l
  store ptr %i.bk, ptr %i.bl, align 8, !tbaa !72
  store ptr null, ptr %i.bj, align 8, !tbaa !63
...
_Z21_mi_page_free_collectP9mi_page_sb.exit.i:     ; preds = %.sink.split.i.i, %bb.l, %_ZL28_mi_page_thread_free_collectP9mi_page_s.exit.i.i
  %i.br = load i64, ptr %i.z, align 8, !tbaa !193
  %i.bs = load i64, ptr %i.aa, align 8, !tbaa !194
  %i.bt = add i64 %i.bs, 1
...
.thread.i:                                        ; preds = %_Z21_mi_page_free_collectP9mi_page_sb.exit.i
  store i8 0, ptr %i.q, align 1, !tbaa !224
...
_ZL24mi_segment_force_abandonP12mi_segment_sP17mi_segments_tld_s.exit: ; preds = %.thread.i, %bb.o, %bb.p
  ...
  br i1 %exitcond.not, label %.critedge, label %bb.c, !llvm.loop !368
...
bb.a:
  ...
  %i.b = load i8, ptr %i.a, align 8, !tbaa !223, !range !113, !noundef !114
...
bb.b:                                             ; preds = %bb.a
  ...
  %4 = icmp eq i64 %3, 0
  %5 = or i1 %i.f, %4
  br i1 %5, label %mi_usable_size.exit.thread, label %bb.c, !prof !61
...
bb.d:                                             ; preds = %bb.c
  ...
  %.val12.i.i = load i64, ptr %i.s, align 8, !tbaa !62
  br label %mi_usable_size.exit
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = load i32, ptr %i.b, align 8, !tbaa !126
...
_Z22_mi_segment_page_startPK12mi_segment_sPK9mi_page_sPm.exit: ; preds = %bb.d, %bb.f, %bb.g
  ...
  store i64 %i.ae, ptr %i.f, align 8, !tbaa !62
  %.not = icmp eq i64 %1, 0
...
bb.h:                                             ; preds = %_Z22_mi_segment_page_startPK12mi_segment_sPK9mi_page_sPm.exit
  ...
  %i.ah = load i8, ptr %i.ag, align 8, !tbaa !223, !range !113, !noundef !114
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.a = tail call i32 @pthread_key_create(ptr noundef nonnull @_mi_heap_default_key, ptr noundef nonnull @_ZL15mi_pthread_donePv) #55, !inline_history !26 ; 0 uses
  %i.b = tail call align 8 ptr @llvm.threadlocal.address.p0(ptr align 8 @_mi_heap_default)
  store ptr @_mi_heap_main, ptr %i.b, align 8, !tbaa !76
  %i.c = load i32, ptr @_mi_heap_default_key, align 4, !tbaa !97 ; 2 uses
  %.not.i.i.i.i = icmp eq i32 %i.c, -1
  br i1 %.not.i.i.i.i, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.d = tail call i32 @pthread_setspecific(i32 noundef %i.c, ptr noundef nonnull @_mi_heap_main) #55, !inline_history !27 ; 0 uses
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b, %bb.a
  tail call void @mi_process_init() #55
  %i.e = load i8, ptr getelementptr inbounds nuw (i8, ptr @_mi_heap_main, i64 188), align 4, !tbaa !206, !range !113, !noundef !114
...
bb.a:
  %i.a = load i64, ptr getelementptr inbounds nuw (i8, ptr @_ZL7options, i64 832), align 16, !tbaa !137
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.g = invoke fastcc noundef zeroext i1 @_ZL20_mi_thread_heap_initv()
          to label %bb.e unwind label %bb.g, !inline_history !197
...
bb.g:                                             ; preds = %bb.d
  ...
  tail call void @__clang_call_terminate(ptr %i.r) #56, !inline_history !197
  unreachable
...
bb.k:                                             ; preds = %bb.j
  ...
  %4 = icmp eq i64 %3, 0
  %5 = or i1 %i.ac, %4
  br i1 %5, label %_Z27_mi_segment_huge_page_resetP12mi_segment_sP9mi_page_sP10mi_block_s.exit, label %bb.l, !prof !61
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.aj = load i32, ptr %i.ai, align 4, !tbaa !67
  ...
  br i1 %.not.i.i.i, label %bb.m, label %bb.n, !prof !68

bb.m:                                             ; preds = %bb.l
  %i.ap = getelementptr i8, ptr %i.am, i64 40
  %.val12.i.i.i = load i64, ptr %i.ap, align 8, !tbaa !62
...
bb.b:                                             ; preds = %_ZSt37atomic_compare_exchange_weak_explicitImEbPSt6atomicIT_EPNSt15__type_identityIS1_E4typeES6_St12memory_orderS8_.exit, %bb.a
  ...
  br i1 %i.e, label %bb.c, label %.thread, !prof !61
...
.thread:                                          ; preds = %bb.b
  %i.i = and i64 %.031, -4
  store i64 %i.i, ptr %1, align 8, !tbaa !65
  %i.j = or i64 %i.d, %i.c
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.t = ptrtoint ptr %i.s to i64
  store i64 %i.t, ptr %1, align 8, !tbaa !65
...
bb.l:                                             ; preds = %bb.k
  ...
  %6 = icmp eq i64 %5, 0
  %7 = or i1 %i.bd, %6
  br i1 %7, label %mi_usable_size.exit, label %bb.m, !prof !61
...
bb.n:                                             ; preds = %bb.m
  ...
  %.val12.i.i = load i64, ptr %i.bq, align 8, !tbaa !62
  br label %mi_usable_size.exit
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  br i1 %.not16.i.7, label %._crit_edge.i, label %.lr.ph.i, !llvm.loop !9
...
_Z25_mi_bitmap_unclaim_acrossPSt6atomicImEmmm.exit: ; preds = %bb.g, %._crit_edge.i, %._crit_edge.thread.i, %bb.b
  ...
  %i.bj = load i8, ptr %i.bi, align 2, !tbaa !385, !range !113, !noundef !114
