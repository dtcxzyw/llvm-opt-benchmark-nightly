...
bb.a:
  ...
  br i1 %i.e, label %_ZL19mi_free_block_localP9mi_page_sP10mi_block_sbb.exit, label %bb.b, !prof !61
...
bb.a:
  ...
  br i1 %i.c, label %_ZL15_mi_usable_sizePKvPKc.exit, label %bb.b, !prof !61
...
bb.a:
  ...
  br i1 %i.c, label %_ZL15_mi_usable_sizePKvPKc.exit.thread, label %bb.b, !prof !61
...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %i.c, label %mi_free.exit, label %bb.m, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.h, label %mi_free.exit, label %bb.c, !prof !61
...
mi_is_in_heap_region.exit.thread2:                ; preds = %mi_is_in_heap_region.exit.thread2.loopexit, %mi_is_in_heap_region.exit
  ...
  br i1 %i.ak, label %mi_free.exit, label %bb.f, !prof !61
...
bb.a:
  ...
  %i.b = add i64 %i.a, -1                         ; 2 uses
  %i.c = icmp slt i64 %i.b, 33554432
  br i1 %i.c, label %mi_usable_size.exit, label %bb.b, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = add i64 %i.b, -1                         ; 2 uses
  %i.d = icmp slt i64 %i.c, 33554432
  br i1 %i.d, label %_ZL15_mi_usable_sizePKvPKc.exit.i, label %bb.c, !prof !61
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.f, label %mi_usable_size.exit.thread, label %bb.c, !prof !61
...
bb.k:                                             ; preds = %bb.j
  ...
  br i1 %i.ac, label %_Z27_mi_segment_huge_page_resetP12mi_segment_sP9mi_page_sP10mi_block_s.exit, label %bb.l, !prof !61
