...
bb.k:                                             ; preds = %.preheader.i105.preheader.us
  %i.x = load i32, ptr %13, align 4, !tbaa !12    ; 3 uses
...
bb.n:                                             ; preds = %bb.k
  ...
  store i32 %i.z, ptr %13, align 4, !tbaa !12
  br label %lean_dec.exit.i108.us
...
bb.ab:                                            ; preds = %.preheader.i.preheader.us
  %i.ap = load i32, ptr %10, align 4, !tbaa !12   ; 3 uses
...
bb.ae:                                            ; preds = %bb.ab
  ...
  store i32 %i.ar, ptr %10, align 4, !tbaa !12
  br label %lean_dec.exit.i.us
...
.preheader.i.preheader.us:                        ; preds = %lean_inc.exit85.us
  %10 = load ptr, ptr %i.af, align 8, !tbaa !10   ; 4 uses
...
.preheader.i105.preheader.us:                     ; preds = %lean_inc.exit83.us
  %13 = load ptr, ptr %i.n, align 8, !tbaa !10    ; 4 uses
