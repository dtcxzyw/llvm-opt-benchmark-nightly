...
bb.bf:                                            ; preds = %l_Std_DHashMap_Internal_Raw_u2080_expand___at___00Std_DHashMap_Internal_Raw_u2080_insertIfNew___at___00__private_Lean_Meta_CollectMVars_0__addMVars_spec__0_spec__1___redArg.exit
  ...
  store ptr %i.dw, ptr %i.dy, align 8, !tbaa !10
  store ptr %.0.i155, ptr %i.dx, align 8, !tbaa !10
...
bb.bj:                                            ; preds = %bb.bi
  ...
  store ptr %.0.i.i147, ptr %i.ef, align 8, !tbaa !10
  store ptr %.0.i155, ptr %i.ee, align 8, !tbaa !10
  br label %lean_dec.exit
...
bb.b:                                             ; preds = %lean_obj_tag.exit99.us
  ...
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !10   ; 7 uses
...
bb.c:                                             ; preds = %bb.b
  %.val.i.i100.us = load i32, ptr %i.o, align 4, !tbaa !12 ; 3 uses
...
bb.f:                                             ; preds = %bb.c
  ...
  store i32 %i.t, ptr %i.o, align 4, !tbaa !12
  br label %lean_inc.exit83.us

lean_inc.exit83.us:                               ; preds = %bb.f, %bb.e, %bb.d, %bb.b
  %.val.i103.us = load i32, ptr %i.e, align 8, !tbaa !12 ; 4 uses
...
.preheader.i105.us.preheader:                     ; preds = %lean_inc.exit83.us
  %10 = load ptr, ptr %i.n, align 8, !tbaa !10    ; 4 uses
...
bb.j:                                             ; preds = %bb.g
  ...
  store i32 %i.w, ptr %i.e, align 8, !tbaa !12
  br label %lean_dec_ref_known.exit112.us

bb.k:                                             ; preds = %.preheader.i105.us.preheader
  %i.x = load i32, ptr %10, align 4, !tbaa !12    ; 3 uses
...
bb.n:                                             ; preds = %bb.k
  ...
  store i32 %i.z, ptr %10, align 4, !tbaa !12
  br label %lean_dec.exit.i108.us
...
bb.o:                                             ; preds = %lean_dec_ref_known.exit112.us
  %i.aa = load i32, ptr %i.o, align 4, !tbaa !12  ; 3 uses
...
bb.r:                                             ; preds = %bb.o
  ...
  store i32 %i.ac, ptr %i.o, align 4, !tbaa !12
  br label %lean_dec.exit76.us
...
bb.s:                                             ; preds = %lean_obj_tag.exit.us, %lean_obj_tag.exit.thread.us
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !10 ; 7 uses
...
bb.t:                                             ; preds = %bb.s
  %.val.i.i.us = load i32, ptr %i.ag, align 4, !tbaa !12 ; 3 uses
...
bb.w:                                             ; preds = %bb.t
  ...
  store i32 %i.al, ptr %i.ag, align 4, !tbaa !12
  br label %lean_inc.exit85.us

lean_inc.exit85.us:                               ; preds = %bb.w, %bb.v, %bb.u, %bb.s
  %.val.i94.us = load i32, ptr %i.e, align 8, !tbaa !12 ; 4 uses
...
.preheader.i.us.preheader:                        ; preds = %lean_inc.exit85.us
  %13 = load ptr, ptr %i.af, align 8, !tbaa !10   ; 4 uses
...
bb.aa:                                            ; preds = %bb.x
  ...
  store i32 %i.ao, ptr %i.e, align 8, !tbaa !12
  br label %lean_dec_ref_known.exit.us

bb.ab:                                            ; preds = %.preheader.i.us.preheader
  %i.ap = load i32, ptr %13, align 4, !tbaa !12   ; 3 uses
...
bb.ae:                                            ; preds = %bb.ab
  ...
  store i32 %i.ar, ptr %13, align 4, !tbaa !12
  br label %lean_dec.exit.i.us
...
bb.af:                                            ; preds = %lean_dec_ref_known.exit.us
  %i.as = load i32, ptr %i.ag, align 4, !tbaa !12 ; 3 uses
...
bb.ai:                                            ; preds = %bb.af
  ...
  store i32 %i.au, ptr %i.ag, align 4, !tbaa !12
  br label %lean_dec.exit78.us
...
bb.aj:                                            ; preds = %lean_dec.exit.us
  %.val.i.i117.us = load i32, ptr %i.d, align 4, !tbaa !12 ; 3 uses
...
bb.am:                                            ; preds = %bb.aj
  ...
  store i32 %i.bb, ptr %i.d, align 4, !tbaa !12
  br label %.thread129.us
...
lean_dec.exit:                                    ; preds = %.lr.ph, %.thread129
  ...
  %i.bh = load ptr, ptr %i.bg, align 8, !tbaa !10 ; 5 uses
...
lean_dec_ref.exit92:                              ; preds = %bb.ao, %bb.ap, %bb.aq
  ...
  %i.bo = load ptr, ptr %i.bn, align 8, !tbaa !10 ; 5 uses
  %.val = load i32, ptr %i.e, align 8, !tbaa !12
...
.sink.split:                                      ; preds = %bb.ba, %._crit_edge
  ...
  store i32 1, ptr %.sink188, align 4, !tbaa !12
  store i32 %.sink, ptr %i.cf, align 4
  %i.cg = getelementptr inbounds nuw i8, ptr %.sink188, i64 8
  store ptr %.059.lcssa.sink, ptr %i.cg, align 8, !tbaa !10
  br label %bb.bg
...
bb.a:
  ...
  %.val44 = load i64, ptr %i.d, align 8, !tbaa !15
  %i.e = load i32, ptr %2, align 8, !tbaa !12     ; 3 uses
  %i.f = icmp sgt i32 %i.e, 1
  br i1 %i.f, label %bb.b, label %bb.c, !prof !13

bb.b:                                             ; preds = %bb.a
  %i.g = add nsw i32 %i.e, -1
  store i32 %i.g, ptr %2, align 8, !tbaa !12
...
lean_dec.exit28:                                  ; preds = %bb.d, %bb.c, %bb.b
  ...
  %.val = load i64, ptr %i.h, align 8, !tbaa !15
  %i.i = load i32, ptr %3, align 8, !tbaa !12     ; 3 uses
  %i.j = icmp sgt i32 %i.i, 1
  br i1 %i.j, label %bb.e, label %bb.f, !prof !13

bb.e:                                             ; preds = %lean_dec.exit28
  %i.k = add nsw i32 %i.i, -1
  store i32 %i.k, ptr %3, align 8, !tbaa !12
...
bb.h:                                             ; preds = %lean_dec.exit26
  %i.o = load i32, ptr %9, align 4, !tbaa !12     ; 3 uses
