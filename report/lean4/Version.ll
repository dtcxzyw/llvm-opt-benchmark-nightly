...
define nonnull ptr @l___private_Lake_Util_Version_0__Lake_VerComponent_ctorIdx(ptr noundef %0) local_unnamed_addr #3 {
bb.a:
...
; Function Attrs: nounwind uwtable
define nonnull ptr @l___private_Lake_Util_Version_0__Lake_VerComponent_ctorIdx___boxed(ptr noundef %0) local_unnamed_addr #0 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64                   ; 2 uses
  %i.b = and i64 %i.a, 1
...
bb.c:                                             ; preds = %bb.a
  ...
  %1 = load i32, ptr %0, align 4, !tbaa !14       ; 3 uses
  %2 = icmp sgt i32 %1, 1
  br i1 %2, label %bb.d, label %bb.e, !prof !15
