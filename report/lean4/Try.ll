...
lean_inc.exit72:                                  ; preds = %bb.l, %bb.k, %bb.j, %bb.h
  br i1 %.not.i85, label %bb.m, label %lean_dec.exit79

bb.m:                                             ; preds = %lean_inc.exit72
...
bb.o:                                             ; preds = %bb.m
  %.not.i80 = icmp eq i32 %i.v, 0
  br i1 %.not.i80, label %lean_dec.exit79, label %bb.p

bb.p:                                             ; preds = %bb.o
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.i) #10
  br label %lean_dec.exit79

lean_dec.exit79:                                  ; preds = %bb.g, %lean_inc.exit72, %bb.n, %bb.o, %bb.p
  %.064 = phi ptr [ inttoptr (i64 1 to ptr), %bb.p ], [ inttoptr (i64 1 to ptr), %lean_inc.exit72 ], [ inttoptr (i64 1 to ptr), %bb.n ], [ inttoptr (i64 1 to ptr), %bb.o ], [ %i.i, %bb.g ] ; 3 uses
  %.not.i76 = icmp eq i64 %.pre124, 0
  br i1 %.not.i76, label %bb.q, label %lean_dec.exit77

bb.q:                                             ; preds = %lean_dec.exit79
...
bb.s:                                             ; preds = %bb.q
  %.not.i81 = icmp eq i32 %i.y, 0
  br i1 %.not.i81, label %lean_dec.exit77, label %bb.t

bb.t:                                             ; preds = %bb.s
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.q) #10
  br label %lean_dec.exit77

lean_dec.exit77:                                  ; preds = %bb.t, %bb.s, %bb.r, %lean_dec.exit79
  %i.ab = and i64 %.pre, 510
  %.not = icmp eq i64 %i.ab, 0
  br i1 %.not, label %bb.u, label %bb.x

bb.u:                                             ; preds = %lean_dec.exit77
...
bb.x:                                             ; preds = %lean_dec.exit77
  %i.ae = ptrtoint ptr %.064 to i64
  %i.af = and i64 %i.ae, 1
  %.not.i89 = icmp eq i64 %i.af, 0
  br i1 %.not.i89, label %bb.y, label %lean_del_object.exit.thread105

bb.y:                                             ; preds = %bb.x
  tail call void @lean_free_object(ptr noundef nonnull %.064) #10
  br label %lean_del_object.exit.thread105

lean_obj_tag.exit93:                              ; preds = %lean_obj_tag.exit.thread
  %i.ag = and i64 %i.j, 8589934590
  %i.ah = icmp eq i64 %i.ag, 0
  br i1 %i.ah, label %bb.z, label %lean_del_object.exit.thread

bb.z:                                             ; preds = %lean_obj_tag.exit93
...
bb.aa:                                            ; preds = %bb.z
  %.val.i.i94 = load i32, ptr %i.aj, align 4, !tbaa !10 ; 3 uses
  %i.am = icmp sgt i32 %.val.i.i94, 0
  br i1 %i.am, label %bb.ab, label %bb.ac, !prof !16

bb.ab:                                            ; preds = %bb.aa
  %i.an = add nuw i32 %.val.i.i94, 1
  store i32 %i.an, ptr %i.aj, align 4, !tbaa !10
  br label %lean_inc.exit

bb.ac:                                            ; preds = %bb.aa
  %.not.i.i95 = icmp eq i32 %.val.i.i94, 0
  br i1 %.not.i.i95, label %lean_inc.exit, label %bb.ad
...
lean_inc.exit:                                    ; preds = %bb.ad, %bb.ac, %bb.ab, %bb.z
  %.val.i97 = load i32, ptr %i.i, align 8, !tbaa !10 ; 4 uses
  %i.ap = icmp eq i32 %.val.i97, 1
...
.preheader.i.preheader:                           ; preds = %lean_inc.exit
  ...
  %i.as = and i64 %i.ar, 1
  %.not.i.i98 = icmp eq i64 %i.as, 0
  br i1 %.not.i.i98, label %bb.ae, label %lean_dec.exit.i
...
bb.ai:                                            ; preds = %lean_inc.exit
  %i.aw = icmp sgt i32 %.val.i97, 1
  br i1 %i.aw, label %bb.aj, label %bb.ak, !prof !16

bb.aj:                                            ; preds = %bb.ai
  %i.ax = add nsw i32 %.val.i97, -1
  store i32 %i.ax, ptr %i.i, align 8, !tbaa !10
  br label %lean_dec_ref_known.exit

bb.ak:                                            ; preds = %bb.ai
  %.not.i8.i = icmp eq i32 %.val.i97, 0
...
bb.ao:                                            ; preds = %bb.am
  %.not.i83 = icmp eq i32 %i.ay, 0
  br i1 %.not.i83, label %lean_del_object.exit, label %bb.ap
...
lean_del_object.exit:                             ; preds = %lean_dec_ref_known.exit, %bb.an, %bb.ao, %bb.ap
  ...
  br i1 %i.bc, label %lean_del_object.exit.thread105, label %bb.aq
...
._crit_edge:                                      ; preds = %lean_del_object.exit.thread105, %bb.a
  tail call void @lean_inc_heartbeat() #10
...
lean_del_object.exit.thread.sink.split.sink.split: ; preds = %._crit_edge, %bb.aq, %bb.v
  %.sink146 = phi ptr [ %i.ac, %bb.v ], [ %i.bd, %bb.aq ], [ %i.bf, %._crit_edge ] ; 3 uses
  %.sink.ph = phi ptr [ inttoptr (i64 3 to ptr), %bb.v ], [ inttoptr (i64 3 to ptr), %bb.aq ], [ inttoptr (i64 1 to ptr), %._crit_edge ]
  %i.bi = getelementptr inbounds nuw i8, ptr %.sink146, i64 4
  store i32 1, ptr %.sink146, align 4, !tbaa !10
...
lean_del_object.exit.thread.sink.split:           ; preds = %lean_del_object.exit.thread.sink.split.sink.split, %bb.u
  %.064.sink = phi ptr [ %.064, %bb.u ], [ %.sink146, %lean_del_object.exit.thread.sink.split.sink.split ] ; 2 uses
  %.sink = phi ptr [ inttoptr (i64 3 to ptr), %bb.u ], [ %.sink.ph, %lean_del_object.exit.thread.sink.split.sink.split ]
  %i.bj = getelementptr inbounds nuw i8, ptr %.064.sink, i64 8
  store ptr %.sink, ptr %i.bj, align 8, !tbaa !14
  br label %lean_del_object.exit.thread

lean_del_object.exit.thread:                      ; preds = %lean_obj_tag.exit, %lean_obj_tag.exit93, %lean_del_object.exit.thread.sink.split
  %.5.ph = phi ptr [ %.064.sink, %lean_del_object.exit.thread.sink.split ], [ %i.i, %lean_obj_tag.exit93 ], [ %i.i, %lean_obj_tag.exit ]
  ret ptr %.5.ph
}
...
.lr.ph:                                           ; preds = %bb.a
  ...
  %i.d = and i64 %i.c, 1
  %.not.i126 = icmp eq i64 %i.d, 0
  %i.e = icmp eq ptr %1, inttoptr (i64 1 to ptr)
  br label %bb.e

._crit_edge:                                      ; preds = %lean_dec_ref.exit117, %bb.a
  %.068.lcssa = phi ptr [ %5, %bb.a ], [ %.275156, %lean_dec_ref.exit117 ]
...
bb.c:                                             ; preds = %._crit_edge
  %.not.i116 = icmp eq i32 %i.f, 0
  br i1 %.not.i116, label %bb.bv, label %bb.d
...
lean_inc_ref.exit:                                ; preds = %bb.f, %bb.g, %bb.h
  ...
  %.val.i.i130 = load i32, ptr %i.q, align 4, !tbaa !10 ; 3 uses
  %i.r = icmp sgt i32 %.val.i.i130, 0
  br i1 %i.r, label %bb.i, label %bb.j, !prof !16

bb.i:                                             ; preds = %lean_inc_ref.exit
  %i.s = add nuw i32 %.val.i.i130, 1
  store i32 %i.s, ptr %i.q, align 4, !tbaa !10
  br label %lean_inc_ref.exit132

bb.j:                                             ; preds = %lean_inc_ref.exit
  %.not.i.i131 = icmp eq i32 %.val.i.i130, 0
  br i1 %.not.i.i131, label %lean_inc_ref.exit132, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.t = atomicrmw sub ptr %i.q, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc_ref.exit132

lean_inc_ref.exit132:                             ; preds = %bb.i, %bb.j, %bb.k
  ...
  %.not.i80 = trunc i64 %i.w to i1                ; 5 uses
  br i1 %.not.i80, label %lean_inc.exit81, label %bb.l

bb.l:                                             ; preds = %lean_inc_ref.exit132
  %.val.i.i133 = load i32, ptr %i.v, align 4, !tbaa !10 ; 3 uses
  %i.x = icmp sgt i32 %.val.i.i133, 0
  br i1 %i.x, label %bb.m, label %bb.n, !prof !16

bb.m:                                             ; preds = %bb.l
  %i.y = add nuw i32 %.val.i.i133, 1
  store i32 %i.y, ptr %i.v, align 4, !tbaa !10
  br label %lean_inc.exit81

bb.n:                                             ; preds = %bb.l
  %.not.i.i134 = icmp eq i32 %.val.i.i133, 0
  br i1 %.not.i.i134, label %lean_inc.exit81, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.z = atomicrmw sub ptr %i.v, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit81

lean_inc.exit81:                                  ; preds = %bb.o, %bb.n, %bb.m, %lean_inc_ref.exit132
  ...
  %i.ad = and i64 %i.ac, 1
  %.not.i78 = icmp eq i64 %i.ad, 0                ; 3 uses
  br i1 %.not.i78, label %bb.p, label %lean_inc.exit79

bb.p:                                             ; preds = %lean_inc.exit81
  %.val.i.i136 = load i32, ptr %i.ab, align 4, !tbaa !10 ; 3 uses
  %i.ae = icmp sgt i32 %.val.i.i136, 0
  br i1 %i.ae, label %bb.q, label %bb.r, !prof !16

bb.q:                                             ; preds = %bb.p
  %i.af = add nuw i32 %.val.i.i136, 1
  store i32 %i.af, ptr %i.ab, align 4, !tbaa !10
  br label %lean_inc.exit79

bb.r:                                             ; preds = %bb.p
  %.not.i.i137 = icmp eq i32 %.val.i.i136, 0
  br i1 %.not.i.i137, label %lean_inc.exit79, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.ag = atomicrmw sub ptr %i.ab, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit79

lean_inc.exit79:                                  ; preds = %bb.s, %bb.r, %bb.q, %lean_inc.exit81
  %i.ah = load i32, ptr %i.o, align 8, !tbaa !10  ; 3 uses
  %i.ai = icmp sgt i32 %i.ah, 1
  br i1 %i.ai, label %bb.t, label %bb.u, !prof !16

bb.t:                                             ; preds = %lean_inc.exit79
  %i.aj = add nsw i32 %i.ah, -1
  store i32 %i.aj, ptr %i.o, align 8, !tbaa !10
  br label %lean_dec_ref.exit115

bb.u:                                             ; preds = %lean_inc.exit79
  %.not.i114 = icmp eq i32 %i.ah, 0
  br i1 %.not.i114, label %lean_dec_ref.exit115, label %bb.v

bb.v:                                             ; preds = %bb.u
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.o) #10
  br label %lean_dec_ref.exit115

lean_dec_ref.exit115:                             ; preds = %bb.t, %bb.u, %bb.v
  %i.ak = getelementptr inbounds nuw [8 x i8], ptr %i.b, i64 %.066171
...
.split:                                           ; preds = %lean_dec_ref.exit115
  %i.ao = icmp ult ptr %i.v, %i.ab
  br i1 %i.ao, label %bb.ai, label %bb.w

lean_nat_lt.exit:                                 ; preds = %lean_dec_ref.exit115
...
bb.w:                                             ; preds = %.split, %lean_nat_lt.exit
  br i1 %.not.i78, label %bb.x, label %lean_dec.exit94
...
bb.z:                                             ; preds = %bb.x
  %.not.i95 = icmp eq i32 %i.aq, 0
  br i1 %.not.i95, label %lean_dec.exit94, label %bb.aa

bb.aa:                                            ; preds = %bb.z
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.ab) #10
  br label %lean_dec.exit94

lean_dec.exit94:                                  ; preds = %bb.aa, %bb.z, %bb.y, %bb.w
  br i1 %.not.i80, label %lean_dec.exit92, label %bb.ab

bb.ab:                                            ; preds = %lean_dec.exit94
...
bb.ad:                                            ; preds = %bb.ab
  %.not.i96 = icmp eq i32 %i.at, 0
  br i1 %.not.i96, label %lean_dec.exit92, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.v) #10
  br label %lean_dec.exit92

lean_dec.exit92:                                  ; preds = %bb.ae, %bb.ad, %bb.ac, %lean_dec.exit94
  %i.aw = load i32, ptr %i.q, align 4, !tbaa !10  ; 3 uses
  %i.ax = icmp sgt i32 %i.aw, 1
  br i1 %i.ax, label %bb.af, label %bb.ag, !prof !16

bb.af:                                            ; preds = %lean_dec.exit92
  %i.ay = add nsw i32 %i.aw, -1
  store i32 %i.ay, ptr %i.q, align 4, !tbaa !10
  br label %lean_dec_ref.exit113

bb.ag:                                            ; preds = %lean_dec.exit92
  %.not.i112 = icmp eq i32 %i.aw, 0
  br i1 %.not.i112, label %lean_dec_ref.exit113, label %bb.ah
...
bb.ai:                                            ; preds = %.split, %lean_nat_lt.exit
  br i1 %.not.i126, label %.critedge.i127, label %lean_nat_eq.exit, !prof !9

.critedge.i127:                                   ; preds = %bb.ai
...
lean_nat_eq.exit:                                 ; preds = %bb.ai, %.critedge.i127
  %.0.i128 = phi i1 [ %i.az, %.critedge.i127 ], [ %i.e, %bb.ai ] ; 2 uses
...
bb.al:                                            ; preds = %bb.aj
  %.not.i98 = icmp eq i32 %i.bf, 0
  br i1 %.not.i98, label %lean_dec.exit90, label %bb.am

bb.am:                                            ; preds = %bb.al
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.ab) #10
  br label %lean_dec.exit90

lean_dec.exit90:                                  ; preds = %lean_nat_le.exit.thread, %bb.ak, %bb.al, %bb.am, %lean_nat_le.exit
  %.070 = phi ptr [ %spec.select, %lean_nat_le.exit.thread ], [ %i.ab, %lean_nat_le.exit ], [ %i.bd, %bb.am ], [ %i.bd, %bb.al ], [ %i.bd, %bb.ak ] ; 10 uses
  %i.bi = ptrtoint ptr %.070 to i64               ; 4 uses
  %i.bj = trunc i64 %i.bi to i1
  %or.cond166 = select i1 %.not.i80, i1 %i.bj, i1 false, !prof !27
  br i1 %or.cond166, label %.split197, label %lean_nat_lt.exit122, !prof !27

.split197:                                        ; preds = %lean_dec.exit90
  %i.bk = icmp ult ptr %i.v, %.070
  br i1 %i.bk, label %bb.az, label %bb.an

lean_nat_lt.exit122:                              ; preds = %lean_dec.exit90
  %i.bl = tail call zeroext i1 @lean_nat_big_lt(ptr noundef %i.v, ptr noundef %.070) #10
  br i1 %i.bl, label %bb.az, label %bb.an

bb.an:                                            ; preds = %.split197, %lean_nat_lt.exit122
  %i.bm = and i64 %i.bi, 1
  %.not.i87 = icmp eq i64 %i.bm, 0
  br i1 %.not.i87, label %bb.ao, label %lean_dec.exit88

bb.ao:                                            ; preds = %bb.an
  %i.bn = load i32, ptr %.070, align 4, !tbaa !10 ; 3 uses
  %i.bo = icmp sgt i32 %i.bn, 1
  br i1 %i.bo, label %bb.ap, label %bb.aq, !prof !16

bb.ap:                                            ; preds = %bb.ao
  %i.bp = add nsw i32 %i.bn, -1
  store i32 %i.bp, ptr %.070, align 4, !tbaa !10
  br label %lean_dec.exit88

bb.aq:                                            ; preds = %bb.ao
  %.not.i100 = icmp eq i32 %i.bn, 0
  br i1 %.not.i100, label %lean_dec.exit88, label %bb.ar

bb.ar:                                            ; preds = %bb.aq
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %.070) #10
  br label %lean_dec.exit88

lean_dec.exit88:                                  ; preds = %bb.ar, %bb.aq, %bb.ap, %bb.an
  br i1 %.not.i80, label %lean_dec.exit86, label %bb.as

bb.as:                                            ; preds = %lean_dec.exit88
...
bb.au:                                            ; preds = %bb.as
  %.not.i102 = icmp eq i32 %i.bq, 0
  br i1 %.not.i102, label %lean_dec.exit86, label %bb.av

bb.av:                                            ; preds = %bb.au
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.v) #10
  br label %lean_dec.exit86

lean_dec.exit86:                                  ; preds = %bb.av, %bb.au, %bb.at, %lean_dec.exit88
  %i.bt = load i32, ptr %i.q, align 8, !tbaa !10  ; 3 uses
  %i.bu = icmp sgt i32 %i.bt, 1
  br i1 %i.bu, label %bb.aw, label %bb.ax, !prof !16

bb.aw:                                            ; preds = %lean_dec.exit86
  %i.bv = add nsw i32 %i.bt, -1
  store i32 %i.bv, ptr %i.q, align 8, !tbaa !10
  br label %lean_dec_ref.exit113

bb.ax:                                            ; preds = %lean_dec.exit86
  %.not.i110 = icmp eq i32 %i.bt, 0
  br i1 %.not.i110, label %lean_dec_ref.exit113, label %bb.ay

bb.ay:                                            ; preds = %bb.ax
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.q) #10
  br label %lean_dec_ref.exit113

bb.az:                                            ; preds = %.split197, %lean_nat_lt.exit122
  %.not.i139 = icmp eq i64 %i.am, 0
  br i1 %.not.i139, label %bb.bb, label %bb.ba
...
lean_usize_of_nat.exit:                           ; preds = %bb.ba, %bb.bb
  ...
  br i1 %.not.i80, label %lean_dec.exit84, label %bb.bc
...
bb.be:                                            ; preds = %bb.bc
  %.not.i104 = icmp eq i32 %i.bz, 0
  br i1 %.not.i104, label %lean_dec.exit84, label %bb.bf

bb.bf:                                            ; preds = %bb.be
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.v) #10
  br label %lean_dec.exit84

lean_dec.exit84:                                  ; preds = %bb.bf, %bb.be, %bb.bd, %lean_usize_of_nat.exit
  %i.cc = and i64 %i.bi, 1
  %.not.i140 = icmp eq i64 %i.cc, 0
  br i1 %.not.i140, label %bb.bg, label %lean_usize_of_nat.exit141

lean_usize_of_nat.exit141:                        ; preds = %lean_dec.exit84
  %i.cd = lshr i64 %i.bi, 1
  br label %lean_dec.exit

bb.bg:                                            ; preds = %lean_dec.exit84
  %i.ce = tail call i64 @lean_usize_of_big_nat(ptr noundef %.070) #10 ; 3 uses
  %i.cf = load i32, ptr %.070, align 4, !tbaa !10 ; 3 uses
  %i.cg = icmp sgt i32 %i.cf, 1
  br i1 %i.cg, label %bb.bh, label %bb.bi, !prof !16

bb.bh:                                            ; preds = %bb.bg
  %i.ch = add nsw i32 %i.cf, -1
  store i32 %i.ch, ptr %.070, align 4, !tbaa !10
  br label %lean_dec.exit

bb.bi:                                            ; preds = %bb.bg
  %.not.i106 = icmp eq i32 %i.cf, 0
  br i1 %.not.i106, label %lean_dec.exit, label %bb.bj

bb.bj:                                            ; preds = %bb.bi
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %.070) #10
  br label %lean_dec.exit

lean_dec.exit:                                    ; preds = %lean_usize_of_nat.exit141, %bb.bj, %bb.bi, %bb.bh
  %i.ci = phi i64 [ %i.ce, %bb.bj ], [ %i.ce, %bb.bi ], [ %i.ce, %bb.bh ], [ %i.cd, %lean_usize_of_nat.exit141 ]
  %i.cj = ptrtoint ptr %i.al to i64
  %i.ck = and i64 %i.cj, 1
  %.not.i76 = icmp eq i64 %i.ck, 0
  br i1 %.not.i76, label %bb.bk, label %lean_inc.exit77

bb.bk:                                            ; preds = %lean_dec.exit
  %.val.i.i142 = load i32, ptr %i.al, align 4, !tbaa !10 ; 3 uses
  %i.cl = icmp sgt i32 %.val.i.i142, 0
  br i1 %i.cl, label %bb.bl, label %bb.bm, !prof !16

bb.bl:                                            ; preds = %bb.bk
  %i.cm = add nuw i32 %.val.i.i142, 1
  store i32 %i.cm, ptr %i.al, align 4, !tbaa !10
  br label %lean_inc.exit77

bb.bm:                                            ; preds = %bb.bk
  %.not.i.i143 = icmp eq i32 %.val.i.i142, 0
  br i1 %.not.i.i143, label %lean_inc.exit77, label %bb.bn

bb.bn:                                            ; preds = %bb.bm
  %i.cn = atomicrmw sub ptr %i.al, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit77

lean_inc.exit77:                                  ; preds = %bb.bn, %bb.bm, %bb.bl, %lean_dec.exit
...
bb.bo:                                            ; preds = %lean_inc.exit77
  %i.cr = add nsw i32 %i.cp, -1
  store i32 %i.cr, ptr %i.q, align 8, !tbaa !10
  br label %lean_dec_ref.exit109

bb.bp:                                            ; preds = %lean_inc.exit77
  %.not.i108 = icmp eq i32 %i.cp, 0
  br i1 %.not.i108, label %lean_dec_ref.exit109, label %bb.bq
...
lean_dec_ref.exit113:                             ; preds = %lean_dec_ref.exit109, %bb.ay, %bb.ax, %bb.aw, %bb.ah, %bb.ag, %bb.af
  %i.ct = ptrtoint ptr %i.al to i64
  %i.cu = and i64 %i.ct, 1
  %.not.i = icmp eq i64 %i.cu, 0
  br i1 %.not.i, label %bb.br, label %.thread152

bb.br:                                            ; preds = %lean_dec_ref.exit113
  %.val.i.i145 = load i32, ptr %i.al, align 4, !tbaa !10 ; 3 uses
  %i.cv = icmp sgt i32 %.val.i.i145, 0
  br i1 %i.cv, label %bb.bs, label %bb.bt, !prof !16

bb.bs:                                            ; preds = %bb.br
  %i.cw = add nuw i32 %.val.i.i145, 1
  store i32 %i.cw, ptr %i.al, align 4, !tbaa !10
  br label %.thread152

bb.bt:                                            ; preds = %bb.br
  %.not.i.i146 = icmp eq i32 %.val.i.i145, 0
  br i1 %.not.i.i146, label %.thread152, label %bb.bu
...
begin_hunk_3_@l___private_Init_Data_Array_Basic_0__Array_findSomeRevM_x3f_find___at___00Lean_PersistentArray_findSomeRevM_x3f___at___00Lean_resolveLocalName___at___00Lean_unresolveNameGlobalAvoidingLocals_x3f___at___00Lean_unresolveNameGlobalAvoidingLocals___at___00__private_Lean_Elab_Tactic_Try_0__Lean_Elab_Tactic_Try_toIdent_spec__0_spec__0_spec__1_spec__3_spec__4___redArg:bb.a
  %.val.i.i274 = load i32, ptr %i.aj, align 4, !tbaa !10 ; 3 uses
...
bb.dc:                                            ; preds = %bb.da
  ...
  br i1 %.not.i.i275, label %lean_inc.exit149, label %bb.dd

bb.dd:                                            ; preds = %bb.dc
  %i.fj = atomicrmw sub ptr %i.aj, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit149

lean_inc.exit149:                                 ; preds = %bb.dd, %bb.dc, %bb.db, %lean_inc_ref.exit273
  ...
  %i.fm = and i64 %i.fl, 1
  %.not.i171 = icmp eq i64 %i.fm, 0
  br i1 %.not.i171, label %bb.de, label %lean_dec.exit172.thread

bb.de:                                            ; preds = %lean_inc.exit149
...
bb.dg:                                            ; preds = %bb.de
  %.not.i200 = icmp eq i32 %i.fn, 0
  br i1 %.not.i200, label %lean_dec.exit172.thread, label %bb.dh
...
bb.di:                                            ; preds = %lean_inc_ref.exit267
  ...
  %i.fr = and i64 %i.fq, 1
  %.not.i169 = icmp eq i64 %i.fr, 0
  br i1 %.not.i169, label %bb.dj, label %lean_dec.exit170
...
bb.dl:                                            ; preds = %bb.dj
  %.not.i202 = icmp eq i32 %i.fs, 0
  br i1 %.not.i202, label %lean_dec.exit170, label %bb.dm

bb.dm:                                            ; preds = %bb.dl
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.et) #10
  br label %lean_dec.exit170

lean_dec.exit170:                                 ; preds = %bb.dm, %bb.dl, %bb.dk, %bb.di
...
bb.dn:                                            ; preds = %lean_dec.exit170
  %i.ga = add nsw i32 %i.fy, -1
  store i32 %i.ga, ptr %i.fw, align 4, !tbaa !10
  br label %lean_dec_ref.exit217

bb.do:                                            ; preds = %lean_dec.exit170
  %.not.i216 = icmp eq i32 %i.fy, 0
  br i1 %.not.i216, label %lean_dec_ref.exit217, label %bb.dp

bb.dp:                                            ; preds = %bb.do
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.fw) #10
  br label %lean_dec_ref.exit217

lean_dec_ref.exit217:                             ; preds = %bb.dn, %bb.do, %bb.dp
  %i.gb = icmp eq i8 %i.fx, 0
  br i1 %i.gb, label %bb.dq, label %bb.du

bb.dq:                                            ; preds = %lean_dec_ref.exit217
  %i.gc = load i32, ptr %.0124356, align 4, !tbaa !10 ; 3 uses
  %i.gd = icmp sgt i32 %i.gc, 1
  br i1 %i.gd, label %bb.dr, label %bb.ds, !prof !16

bb.dr:                                            ; preds = %bb.dq
  %i.ge = add nsw i32 %i.gc, -1
  store i32 %i.ge, ptr %.0124356, align 4, !tbaa !10
  br label %lean_dec.exit184.backedge

bb.ds:                                            ; preds = %bb.dq
  %.not.i214 = icmp eq i32 %i.gc, 0
  br i1 %.not.i214, label %lean_dec.exit184.backedge, label %bb.dt

bb.dt:                                            ; preds = %bb.ds
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %.0124356) #10
  br label %lean_dec.exit184.backedge

bb.du:                                            ; preds = %lean_dec_ref.exit217
  %i.gf = tail call zeroext i8 @l_Lean_MacroScopesView_isSuffixOf(ptr noundef %4, ptr noundef nonnull %.0124356) #10
  %i.gg = load i32, ptr %.0124356, align 4, !tbaa !10 ; 3 uses
  %i.gh = icmp sgt i32 %i.gg, 1
  br i1 %i.gh, label %bb.dv, label %bb.dw, !prof !16

bb.dv:                                            ; preds = %bb.du
  %i.gi = add nsw i32 %i.gg, -1
  store i32 %i.gi, ptr %.0124356, align 4, !tbaa !10
  br label %lean_dec_ref.exit213

bb.dw:                                            ; preds = %bb.du
  %.not.i212 = icmp eq i32 %i.gg, 0
  br i1 %.not.i212, label %lean_dec_ref.exit213, label %bb.dx

bb.dx:                                            ; preds = %bb.dw
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %.0124356) #10
  br label %lean_dec_ref.exit213

lean_dec_ref.exit213:                             ; preds = %bb.dv, %bb.dw, %bb.dx
  %.not = icmp eq i8 %i.gf, 0
  br i1 %.not, label %lean_dec.exit184.backedge, label %bb.dy

lean_dec.exit184.backedge:                        ; preds = %lean_dec_ref.exit213, %bb.z, %bb.dr, %bb.ds, %bb.dt, %lean_obj_tag.exit286
  br label %lean_dec.exit184

bb.dy:                                            ; preds = %lean_dec_ref.exit213
  %.val.i.i277 = load i32, ptr %i.aa, align 8, !tbaa !10 ; 3 uses
  %i.gj = icmp sgt i32 %.val.i.i277, 0
  br i1 %i.gj, label %bb.dz, label %bb.ea, !prof !16

bb.dz:                                            ; preds = %bb.dy
  %i.gk = add nuw i32 %.val.i.i277, 1
  store i32 %i.gk, ptr %i.aa, align 8, !tbaa !10
  br label %lean_dec.exit172.thread

bb.ea:                                            ; preds = %bb.dy
  %.not.i.i278 = icmp eq i32 %.val.i.i277, 0
  br i1 %.not.i.i278, label %lean_dec.exit172.thread, label %bb.eb

bb.eb:                                            ; preds = %bb.ea
  %i.gl = atomicrmw sub ptr %i.aa, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_dec.exit172.thread

bb.ec:                                            ; preds = %lean_obj_tag.exit229
...
bb.ee:                                            ; preds = %bb.ec
  %.not.i204 = icmp eq i32 %i.gm, 0
  br i1 %.not.i204, label %lean_dec.exit168, label %bb.ef

bb.ef:                                            ; preds = %bb.ee
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.at) #10
  br label %lean_dec.exit168

lean_dec.exit168:                                 ; preds = %lean_obj_tag.exit229.thread, %bb.ef, %bb.ee, %bb.ed
  %i.gp = ptrtoint ptr %i.aj to i64
  %i.gq = and i64 %i.gp, 1
  %.not.i147 = icmp eq i64 %i.gq, 0
  br i1 %.not.i147, label %bb.eg, label %lean_inc.exit

bb.eg:                                            ; preds = %lean_dec.exit168
  %.val.i.i280 = load i32, ptr %i.aj, align 4, !tbaa !10 ; 3 uses
  %i.gr = icmp sgt i32 %.val.i.i280, 0
  br i1 %i.gr, label %bb.eh, label %bb.ei, !prof !16

bb.eh:                                            ; preds = %bb.eg
  %i.gs = add nuw i32 %.val.i.i280, 1
  store i32 %i.gs, ptr %i.aj, align 4, !tbaa !10
  br label %lean_inc.exit

bb.ei:                                            ; preds = %bb.eg
  %.not.i.i281 = icmp eq i32 %.val.i.i280, 0
  br i1 %.not.i.i281, label %lean_inc.exit, label %bb.ej

bb.ej:                                            ; preds = %bb.ei
  %i.gt = atomicrmw sub ptr %i.aj, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit

lean_inc.exit:                                    ; preds = %bb.ej, %bb.ei, %bb.eh, %lean_dec.exit168
...
lean_dec.exit172.thread:                          ; preds = %bb.eb, %bb.ea, %bb.dz, %bb.df, %bb.dg, %bb.dh, %lean_inc.exit149, %lean_inc.exit, %lean_inc.exit163, %lean_obj_tag.exit
  ...
  br i1 %.not.i283, label %bb.el, label %bb.ek

bb.ek:                                            ; preds = %lean_dec.exit172.thread
  %i.gx = lshr i64 %i.gv, 1
  %i.gy = trunc i64 %i.gx to i32
  br label %lean_obj_tag.exit286

bb.el:                                            ; preds = %lean_dec.exit172.thread
  %i.gz = getelementptr i8, ptr %.8146, i64 4
  %.val.i285 = load i32, ptr %i.gz, align 4
  %i.ha = lshr i32 %.val.i285, 24
  br label %lean_obj_tag.exit286

lean_obj_tag.exit286:                             ; preds = %bb.ek, %bb.el
  %.0.i284 = phi i32 [ %i.gy, %bb.ek ], [ %i.ha, %bb.el ]
  %i.hb = icmp eq i32 %.0.i284, 0
  br i1 %i.hb, label %lean_dec.exit184.backedge, label %bb.em

bb.em:                                            ; preds = %lean_obj_tag.exit286
  %i.hc = and i64 %i.x, 1
  %.not.i165 = icmp eq i64 %i.hc, 0
  br i1 %.not.i165, label %bb.en, label %lean_dec.exit166

bb.en:                                            ; preds = %bb.em
  %i.hd = load i32, ptr %.1.i291, align 4, !tbaa !10 ; 3 uses
  %i.he = icmp sgt i32 %i.hd, 1
  br i1 %i.he, label %bb.eo, label %bb.ep, !prof !16

bb.eo:                                            ; preds = %bb.en
  %i.hf = add nsw i32 %i.hd, -1
  store i32 %i.hf, ptr %.1.i291, align 4, !tbaa !10
  br label %lean_dec.exit166

bb.ep:                                            ; preds = %bb.en
  %.not.i206 = icmp eq i32 %i.hd, 0
  br i1 %.not.i206, label %lean_dec.exit166, label %bb.eq

bb.eq:                                            ; preds = %bb.ep
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %.1.i291) #10
  br label %lean_dec.exit166

lean_dec.exit166:                                 ; preds = %bb.eq, %bb.ep, %bb.eo, %bb.em
  %i.hg = load i32, ptr %4, align 4, !tbaa !10    ; 3 uses
  %i.hh = icmp sgt i32 %i.hg, 1
  br i1 %i.hh, label %bb.er, label %bb.es, !prof !16

bb.er:                                            ; preds = %lean_dec.exit166
  %i.hi = add nsw i32 %i.hg, -1
  store i32 %i.hi, ptr %4, align 4, !tbaa !10
  br label %lean_dec_ref.exit211

bb.es:                                            ; preds = %lean_dec.exit166
  %.not.i210 = icmp eq i32 %i.hg, 0
  br i1 %.not.i210, label %lean_dec_ref.exit211, label %bb.et

bb.et:                                            ; preds = %bb.es
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %4) #10
  br label %lean_dec_ref.exit211

lean_dec_ref.exit211:                             ; preds = %bb.er, %bb.es, %bb.et
  br i1 %.not.i150.a, label %bb.eu, label %bb.ey

bb.eu:                                            ; preds = %lean_dec_ref.exit211
...
bb.ew:                                            ; preds = %bb.eu
  %.not.i208 = icmp eq i32 %i.hj, 0
  br i1 %.not.i208, label %bb.ey, label %bb.ex

bb.ex:                                            ; preds = %bb.ew
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %3) #10
  br label %bb.ey

bb.ey:                                            ; preds = %lean_dec_ref.exit221, %bb.l, %bb.k, %bb.j, %bb.ex, %bb.ew, %bb.ev, %lean_dec_ref.exit211
  %.2.ph = phi ptr [ %.8146, %lean_dec_ref.exit211 ], [ %.8146, %bb.ev ], [ %.8146, %bb.ew ], [ %.8146, %bb.ex ], [ inttoptr (i64 1 to ptr), %bb.j ], [ inttoptr (i64 1 to ptr), %bb.k ], [ inttoptr (i64 1 to ptr), %bb.l ], [ inttoptr (i64 1 to ptr), %lean_dec_ref.exit221 ]
  ret ptr %.2.ph
}
...
lean_dec.exit39:                                  ; preds = %lean_obj_tag.exit, %bb.a
  %.029 = phi ptr [ %6, %bb.a ], [ %.1.i66, %lean_obj_tag.exit ] ; 11 uses
  %i.d = ptrtoint ptr %.029 to i64                ; 2 uses
  %i.e = and i64 %i.d, 1
...
lean_nat_eq.exit:                                 ; preds = %lean_dec.exit39
  %i.f = tail call zeroext i1 @lean_nat_big_eq(ptr noundef %.029, ptr noundef nonnull inttoptr (i64 1 to ptr)) #10
  br i1 %i.f, label %bb.b, label %bb.n

lean_nat_eq.exit.thread:                          ; preds = %lean_dec.exit39
  %.not71 = icmp eq ptr %.029, inttoptr (i64 1 to ptr)
  br i1 %.not71, label %lean_dec.exit41, label %.thread64

bb.b:                                             ; preds = %lean_nat_eq.exit
  %i.g = load i32, ptr %.029, align 4, !tbaa !10  ; 3 uses
