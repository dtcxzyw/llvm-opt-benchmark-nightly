...
lean_del_object.exit.thread109:                   ; preds = %bb.x, %bb.y, %lean_del_object.exit
...
bb.e:                                             ; preds = %.lr.ph, %lean_dec_ref.exit118
  ...
  %.068173 = phi ptr [ %5, %.lr.ph ], [ %.3157, %lean_dec_ref.exit118 ] ; 2 uses
  %.070172 = phi ptr [ undef, %.lr.ph ], [ %.3157, %lean_dec_ref.exit118 ]
...
lean_dec_ref.exit110:                             ; preds = %bb.bo, %bb.bp, %bb.bq
  ...
  %.068..070 = select i1 %.0.i129, ptr %.070172, ptr %.068173
...
lean_dec_ref.exit118:                             ; preds = %lean_dec_ref.exit110, %.thread153
  %.3157 = phi ptr [ %i.cy, %.thread153 ], [ %.068..070, %lean_dec_ref.exit110 ] ; 3 uses
...
lean_dec.exit175.thread:                          ; preds = %bb.eb, %bb.ea, %bb.dz, %bb.df, %bb.dg, %bb.dh, %lean_inc.exit152, %lean_inc.exit, %lean_inc.exit166, %lean_obj_tag.exit
  %.9143 = phi ptr [ %i.aa, %lean_obj_tag.exit ], [ %i.aa, %bb.eb ], [ %i.aa, %bb.ea ], [ %i.aa, %bb.dz ], [ %i.fk, %bb.df ], [ %i.fk, %bb.dg ], [ %i.fk, %bb.dh ], [ %i.fk, %lean_inc.exit152 ], [ %i.gu, %lean_inc.exit ], [ %i.ar, %lean_inc.exit166 ] ; 6 uses
