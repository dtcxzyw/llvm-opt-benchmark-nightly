...
bb.a:
  ...
  %i.p = load i8, ptr %i.o, align 8, !tbaa !28, !range !29, !noundef !30
...
_ZNSt6vectorIjSaIjEE9push_backERKj.exit.thread17: ; preds = %bb.b
  store i32 %i.k, ptr %i.u, align 4, !tbaa !32
...
bb.c:                                             ; preds = %bb.b
  %i.z = load ptr, ptr %i.s, align 8, !tbaa !33   ; 4 uses
...
_ZNKSt6vectorIjSaIjEE12_M_check_lenEmPKc.exit.i.i: ; preds = %bb.c
  ...
  %i.aj = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ai) #10 ; 4 uses
  %i.ak = getelementptr inbounds i8, ptr %i.aj, i64 %i.ac ; 2 uses
  store i32 %i.k, ptr %i.ak, align 4, !tbaa !32
  %i.al = icmp sgt i64 %i.ac, 0
  br i1 %i.al, label %bb.e, label %_ZNSt6vectorIjSaIjEE11_S_relocateEPjS2_S2_RS0_.exit16.i.i

bb.e:                                             ; preds = %_ZNKSt6vectorIjSaIjEE12_M_check_lenEmPKc.exit.i.i
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 4 %i.aj, ptr align 4 %i.z, i64 %i.ac, i1 false)
...
bb.f:                                             ; preds = %_ZNSt6vectorIjSaIjEE11_S_relocateEPjS2_S2_RS0_.exit16.i.i
  %i.an = load ptr, ptr %i.v, align 8, !tbaa !37
  %i.ao = ptrtoint ptr %i.an to i64
  %i.ap = sub i64 %i.ao, %i.ab
  tail call void @_ZdlPvm(ptr noundef nonnull %i.z, i64 noundef %i.ap) #11
  br label %_ZNSt6vectorIjSaIjEE9push_backERKj.exit

_ZNSt6vectorIjSaIjEE9push_backERKj.exit:          ; preds = %_ZNSt6vectorIjSaIjEE11_S_relocateEPjS2_S2_RS0_.exit16.i.i, %bb.f
  store ptr %i.aj, ptr %i.s, align 8, !tbaa !33
  store ptr %i.am, ptr %i.t, align 8, !tbaa !31
  %i.aq = getelementptr inbounds nuw [4 x i8], ptr %i.aj, i64 %i.ah
  store ptr %i.aq, ptr %i.v, align 8, !tbaa !37
  %.pre = load ptr, ptr %i.l, align 8, !tbaa !25  ; 2 uses
  %.phi.trans.insert = getelementptr inbounds nuw [24 x i8], ptr %.pre, i64 %i.m
  %.pre10 = load i8, ptr %.phi.trans.insert, align 8, !tbaa !28, !range !29
  %i.ar = trunc nuw i8 %.pre10 to i1
  %i.as = getelementptr inbounds nuw [24 x i8], ptr %.pre, i64 %i.m ; 2 uses
  br i1 %i.ar, label %bb.g, label %_ZN4lean10object_refD2Ev.exit.i

bb.g:                                             ; preds = %_ZNSt6vectorIjSaIjEE9push_backERKj.exit.thread, %_ZNSt6vectorIjSaIjEE9push_backERKj.exit
  %i.at = phi ptr [ %i.r, %_ZNSt6vectorIjSaIjEE9push_backERKj.exit.thread ], [ %i.as, %_ZNSt6vectorIjSaIjEE9push_backERKj.exit ] ; 5 uses
  %i.au = getelementptr inbounds nuw i8, ptr %i.at, i64 8
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !10 ; 4 uses
...
bb.h:                                             ; preds = %bb.g
  %i.ay = load i32, ptr %i.av, align 4, !tbaa !35 ; 3 uses
  %i.az = icmp sgt i32 %i.ay, 1
  br i1 %i.az, label %bb.i, label %bb.j, !prof !36

bb.i:                                             ; preds = %bb.h
  %i.ba = add nsw i32 %i.ay, -1
  store i32 %i.ba, ptr %i.av, align 4, !tbaa !35
  br label %_ZN4lean10object_refD2Ev.exit.i

bb.j:                                             ; preds = %bb.h
  %.not.i1.i.i.i = icmp eq i32 %i.ay, 0
  br i1 %.not.i1.i.i.i, label %_ZN4lean10object_refD2Ev.exit.i, label %bb.k

bb.k:                                             ; preds = %bb.j
  invoke void @lean_dec_ref_cold(ptr noundef nonnull %i.av)
...
bb.l:                                             ; preds = %bb.k
  ...
  tail call void @__clang_call_terminate(ptr %i.bc) #12
  unreachable
...
_ZN4lean10object_refD2Ev.exit.i:                  ; preds = %_ZNSt6vectorIjSaIjEE9push_backERKj.exit.thread17, %bb.k, %bb.j, %bb.i, %bb.g, %_ZNSt6vectorIjSaIjEE9push_backERKj.exit
  %i.bd = phi ptr [ %i.at, %bb.k ], [ %i.at, %bb.j ], [ %i.at, %bb.i ], [ %i.at, %bb.g ], [ %i.as, %_ZNSt6vectorIjSaIjEE9push_backERKj.exit ], [ %i.y, %_ZNSt6vectorIjSaIjEE9push_backERKj.exit.thread17 ] ; 2 uses
  store i8 1, ptr %i.bd, align 8, !tbaa !28
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 8
  %i.bf = load ptr, ptr %1, align 8, !tbaa !10    ; 5 uses
  store ptr %i.bf, ptr %i.be, align 8, !tbaa !10
  %i.bg = ptrtoint ptr %i.bf to i64
  %i.bh = and i64 %i.bg, 1
  %.not.i.i.i.i.i = icmp eq i64 %i.bh, 0
  br i1 %.not.i.i.i.i.i, label %bb.m, label %_ZN4lean8optionalINS_4exprEEaSERKS1_.exit

bb.m:                                             ; preds = %_ZN4lean10object_refD2Ev.exit.i
  %.val.i.i.i.i.i.i = load i32, ptr %i.bf, align 4, !tbaa !35 ; 3 uses
  %i.bi = icmp sgt i32 %.val.i.i.i.i.i.i, 0
  br i1 %i.bi, label %bb.n, label %bb.o, !prof !36

bb.n:                                             ; preds = %bb.m
  %i.bj = add nuw i32 %.val.i.i.i.i.i.i, 1
  store i32 %i.bj, ptr %i.bf, align 4, !tbaa !35
...
bb.p:                                             ; preds = %bb.o
  %i.bk = atomicrmw sub ptr %i.bf, i32 1 monotonic, align 4 ; 0 uses
  br label %_ZN4lean8optionalINS_4exprEEaSERKS1_.exit

_ZN4lean8optionalINS_4exprEEaSERKS1_.exit:        ; preds = %_ZN4lean10object_refD2Ev.exit.i, %bb.n, %bb.o, %bb.p
  %i.bl = load ptr, ptr %i.l, align 8, !tbaa !25
  %i.bm = getelementptr inbounds nuw [24 x i8], ptr %i.bl, i64 %i.m
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 16 ; 2 uses
  %i.bo = load ptr, ptr %2, align 8, !tbaa !10    ; 7 uses
  %i.bp = ptrtoint ptr %i.bo to i64
  %i.bq = and i64 %i.bp, 1
  %.not.i.i.i.i4 = icmp eq i64 %i.bq, 0
...
bb.q:                                             ; preds = %_ZN4lean8optionalINS_4exprEEaSERKS1_.exit
  %.val.i.i.i.i.i = load i32, ptr %i.bo, align 4, !tbaa !35 ; 3 uses
  %i.br = icmp sgt i32 %.val.i.i.i.i.i, 0
  br i1 %i.br, label %bb.r, label %bb.s, !prof !36

bb.r:                                             ; preds = %bb.q
  %i.bs = add nuw i32 %.val.i.i.i.i.i, 1
  store i32 %i.bs, ptr %i.bo, align 4, !tbaa !35
...
bb.t:                                             ; preds = %bb.s
  %i.bt = atomicrmw sub ptr %i.bo, i32 1 monotonic, align 4 ; 0 uses
...
_ZN4lean3incEP11lean_object.exit.i.i:             ; preds = %bb.t, %bb.s, %bb.r, %_ZN4lean8optionalINS_4exprEEaSERKS1_.exit
  %i.bu = phi ptr [ %i.bo, %_ZN4lean8optionalINS_4exprEEaSERKS1_.exit ], [ %i.bo, %bb.r ], [ %i.bo, %bb.s ], [ %.pre.i.i, %bb.t ]
  %i.bv = load ptr, ptr %i.bn, align 8, !tbaa !10 ; 4 uses
  %i.bw = ptrtoint ptr %i.bv to i64
  %i.bx = and i64 %i.bw, 1
  %.not.i.i4.i.i = icmp eq i64 %i.bx, 0
  br i1 %.not.i.i4.i.i, label %bb.u, label %_ZN4lean4expraSERKS0_.exit

bb.u:                                             ; preds = %_ZN4lean3incEP11lean_object.exit.i.i
  %i.by = load i32, ptr %i.bv, align 4, !tbaa !35 ; 3 uses
  %i.bz = icmp sgt i32 %i.by, 1
  br i1 %i.bz, label %bb.v, label %bb.w, !prof !36

bb.v:                                             ; preds = %bb.u
  %i.ca = add nsw i32 %i.by, -1
  store i32 %i.ca, ptr %i.bv, align 4, !tbaa !35
  br label %_ZN4lean4expraSERKS0_.exit

bb.w:                                             ; preds = %bb.u
  %.not.i1.i.i.i5 = icmp eq i32 %i.by, 0
...
_ZN4lean4expraSERKS0_.exit:                       ; preds = %_ZN4lean3incEP11lean_object.exit.i.i, %bb.v, %bb.w, %bb.x
  store ptr %i.bu, ptr %i.bn, align 8, !tbaa !10
  ret void
}
...
bb.b:                                             ; preds = %.lr.ph, %_ZN4lean10object_refD2Ev.exit
  ...
  %i.h = load i32, ptr %.sroa.013.016, align 4, !tbaa !32
  ...
  %i.l = load i8, ptr %i.k, align 8, !tbaa !28, !range !29, !noundef !30
  %i.m = trunc nuw i8 %i.l to i1
  br i1 %i.m, label %bb.c, label %_ZN4lean8optionalINS_4exprEED2Ev.exit

bb.c:                                             ; preds = %bb.b
  %i.n = getelementptr inbounds nuw i8, ptr %i.k, i64 8
  %i.o = load ptr, ptr %i.n, align 8, !tbaa !10   ; 4 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  call void @__clang_call_terminate(ptr %i.v) #12
  unreachable
...
_ZN4lean8optionalINS_4exprEED2Ev.exit:            ; preds = %bb.g, %bb.f, %bb.e, %bb.c, %bb.b
  ...
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !10   ; 4 uses
...
bb.i:                                             ; preds = %_ZN4lean8optionalINS_4exprEED2Ev.exit
  ...
  br i1 %i.ad, label %bb.j, label %bb.k, !prof !36
...
_ZN4lean10object_refD2Ev.exit:                    ; preds = %bb.l, %bb.k, %bb.j, %_ZN4lean8optionalINS_4exprEED2Ev.exit
  %i.ah = load ptr, ptr %1, align 8, !tbaa !10
...
!11 = !{!"long", !4, i64 0}
!12 = !{!11, !11, i64 0}
!13 = !{!"p1 _ZTSN4lean10expr_cache5entryE", !8, i64 0}
!14 = !{!"_ZTSNSt12_Vector_baseIN4lean10expr_cache5entryESaIS2_EE17_Vector_impl_dataE", !13, i64 0, !13, i64 8, !13, i64 16}
!15 = !{!"_ZTSNSt12_Vector_baseIN4lean10expr_cache5entryESaIS2_EE12_Vector_implE", !14, i64 0}
!16 = !{!"_ZTSSt12_Vector_baseIN4lean10expr_cache5entryESaIS2_EE", !15, i64 0}
!17 = !{!"_ZTSSt6vectorIN4lean10expr_cache5entryESaIS2_EE", !16, i64 0}
!18 = !{!"p1 int", !8, i64 0}
!19 = !{!"_ZTSNSt12_Vector_baseIjSaIjEE17_Vector_impl_dataE", !18, i64 0, !18, i64 8, !18, i64 16}
!20 = !{!"_ZTSNSt12_Vector_baseIjSaIjEE12_Vector_implE", !19, i64 0}
!21 = !{!"_ZTSSt12_Vector_baseIjSaIjEE", !20, i64 0}
!22 = !{!"_ZTSSt6vectorIjSaIjEE", !21, i64 0}
!23 = !{!"_ZTSN4lean10expr_cacheE", !5, i64 0, !17, i64 8, !22, i64 32}
!24 = !{!23, !5, i64 0}
!25 = !{!14, !13, i64 0}
!26 = !{!"bool", !4, i64 0}
!27 = !{!"_ZTSN4lean8optionalINS_4exprEEE", !26, i64 0, !4, i64 8}
!28 = !{!27, !26, i64 0}
!29 = !{i8 0, i8 2}
!30 = !{}
!31 = !{!19, !18, i64 8}
!32 = !{!5, !5, i64 0}
!33 = !{!19, !18, i64 0}
!34 = !{!"_ZTS11lean_object", !5, i64 0, !5, i64 4, !5, i64 6, !5, i64 7}
!35 = !{!34, !5, i64 0}
