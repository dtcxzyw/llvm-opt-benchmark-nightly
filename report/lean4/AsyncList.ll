...
define nonnull ptr @l_IO_AsyncList_ctorIdx___redArg(ptr noundef %0) local_unnamed_addr #0 {
bb.a:
...
define nonnull ptr @l_IO_AsyncList_ctorIdx___redArg___boxed(ptr noundef %0) local_unnamed_addr #1 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64                   ; 2 uses
  %i.b = and i64 %i.a, 1
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read) uwtable
define nonnull ptr @l_IO_AsyncList_ctorIdx(ptr nofree noundef readnone captures(none) %0, ptr nofree noundef readnone captures(none) %1, ptr noundef %2) local_unnamed_addr #0 {
bb.a:
...
l_IO_AsyncList_ctorIdx___redArg.exit:             ; preds = %bb.b, %bb.c
...
; Function Attrs: nounwind uwtable
define nonnull ptr @l_IO_AsyncList_ctorIdx___boxed(ptr nofree noundef readnone captures(none) %0, ptr nofree noundef readnone captures(none) %1, ptr noundef %2) local_unnamed_addr #1 {
bb.a:
  %i.a = ptrtoint ptr %2 to i64                   ; 2 uses
  %i.b = and i64 %i.a, 1
