...
define noundef nonnull ptr @l___private_Lean_Meta_Match_SolveOverlap_0__Lean_Meta_Match_InjectionAnyResult_ctorIdx(ptr noundef %0) local_unnamed_addr #3 {
bb.a:
...
; Function Attrs: nounwind uwtable
define noundef nonnull ptr @l___private_Lean_Meta_Match_SolveOverlap_0__Lean_Meta_Match_InjectionAnyResult_ctorIdx___boxed(ptr noundef %0) local_unnamed_addr #0 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64                   ; 2 uses
  %i.b = and i64 %i.a, 1
...
lean_obj_tag.exit.i:                              ; preds = %bb.c, %bb.b
  ...
  switch i32 %.0.i.i, label %2 [
    i32 0, label %l___private_Lean_Meta_Match_SolveOverlap_0__Lean_Meta_Match_InjectionAnyResult_ctorIdx.exit
    i32 1, label %1
  ]

1:                                                ; preds = %lean_obj_tag.exit.i
  br label %l___private_Lean_Meta_Match_SolveOverlap_0__Lean_Meta_Match_InjectionAnyResult_ctorIdx.exit

2:                                                ; preds = %lean_obj_tag.exit.i
  br label %l___private_Lean_Meta_Match_SolveOverlap_0__Lean_Meta_Match_InjectionAnyResult_ctorIdx.exit

l___private_Lean_Meta_Match_SolveOverlap_0__Lean_Meta_Match_InjectionAnyResult_ctorIdx.exit: ; preds = %lean_obj_tag.exit.i, %1, %2
...
3:                                                ; preds = %l___private_Lean_Meta_Match_SolveOverlap_0__Lean_Meta_Match_InjectionAnyResult_ctorIdx.exit
  %4 = load i32, ptr %0, align 4, !tbaa !12       ; 3 uses
  %5 = icmp sgt i32 %4, 1
  br i1 %5, label %bb.d, label %bb.e, !prof !13
...
lean_dec.exit:                                    ; preds = %bb.f, %bb.e, %bb.d, %l___private_Lean_Meta_Match_SolveOverlap_0__Lean_Meta_Match_InjectionAnyResult_ctorIdx.exit
  ret ptr %.0.i
}
