...
lean_inc.exit:                                    ; preds = %lean_nat_lt.exit, %l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00__private_Lean_Meta_Tactic_BVDecide_LRAT_Trim_0__Lean_Meta_Tactic_BVDecide_LRAT_trim_M_run_spec__2.exit, %bb.cn, %bb.co, %bb.cp
  %.1125 = phi ptr [ %.027.i208, %l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00__private_Lean_Meta_Tactic_BVDecide_LRAT_Trim_0__Lean_Meta_Tactic_BVDecide_LRAT_trim_M_run_spec__2.exit ], [ %.027.i208, %bb.cp ], [ %.027.i208, %bb.co ], [ %.027.i208, %bb.cn ], [ %.0.i192, %lean_nat_lt.exit ]
  %.1123 = phi ptr [ %i.fd, %l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00__private_Lean_Meta_Tactic_BVDecide_LRAT_Trim_0__Lean_Meta_Tactic_BVDecide_LRAT_trim_M_run_spec__2.exit ], [ %i.fd, %bb.cp ], [ %i.fd, %bb.co ], [ %i.fd, %bb.cn ], [ inttoptr (i64 1 to ptr), %lean_nat_lt.exit ] ; 4 uses
  %i.dd = ptrtoint ptr %.1123 to i64              ; 2 uses
  %i.de = and i64 %i.dd, 1
...
lean_mk_empty_byte_array.exit:                    ; preds = %lean_inc.exit
  ...
  %i.do = tail call ptr @l___private_Init_Data_Nat_Fold_0__Nat_foldTR_loop___at___00__private_Lean_Meta_Tactic_BVDecide_LRAT_Trim_0__Lean_Meta_Tactic_BVDecide_LRAT_trim_M_run_spec__1___redArg(ptr noundef %.1123, ptr noundef nonnull %i.dh)
...
.critedge.i:                                      ; preds = %lean_mk_empty_byte_array.exit
  %i.dw = tail call ptr @lean_nat_big_add(ptr noundef %i.z, ptr noundef %.1123) #6
  br label %lean_nat_add.exit
...
lean_obj_once.exit225:                            ; preds = %bb.bz, %bb.ca
  ...
  %i.ec = tail call ptr @lean_mk_array(ptr noundef %.1123, ptr noundef nonnull inttoptr (i64 1 to ptr)) #6
  tail call void @lean_inc_heartbeat() #6
...
lean_alloc_ctor.exit226:                          ; preds = %lean_obj_once.exit225
  ...
  store ptr %.1125, ptr %i.eg, align 8, !tbaa !15
