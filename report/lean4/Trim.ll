...
lean_dec.exit:                                    ; preds = %lean_inc.exit145, %bb.bh, %bb.bi, %bb.bj, %bb.ba
  %.0127 = phi ptr [ %i.ao, %bb.ba ], [ inttoptr (i64 1 to ptr), %bb.bj ], [ inttoptr (i64 1 to ptr), %bb.bi ], [ inttoptr (i64 1 to ptr), %bb.bh ], [ inttoptr (i64 1 to ptr), %lean_inc.exit145 ]
...
lean_inc.exit:                                    ; preds = %lean_nat_lt.exit, %l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00__private_Lean_Meta_Tactic_BVDecide_LRAT_Trim_0__Lean_Meta_Tactic_BVDecide_LRAT_trim_M_run_spec__2.exit, %bb.cn, %bb.co, %bb.cp
  %.1125 = phi ptr [ %i.fd, %l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00__private_Lean_Meta_Tactic_BVDecide_LRAT_Trim_0__Lean_Meta_Tactic_BVDecide_LRAT_trim_M_run_spec__2.exit ], [ %i.fd, %bb.cp ], [ %i.fd, %bb.co ], [ %i.fd, %bb.cn ], [ inttoptr (i64 1 to ptr), %lean_nat_lt.exit ] ; 4 uses
  %.1123 = phi ptr [ %.027.i208, %l___private_Init_Data_Array_Basic_0__Array_foldlMUnsafe_fold___at___00__private_Lean_Meta_Tactic_BVDecide_LRAT_Trim_0__Lean_Meta_Tactic_BVDecide_LRAT_trim_M_run_spec__2.exit ], [ %.027.i208, %bb.cp ], [ %.027.i208, %bb.co ], [ %.027.i208, %bb.cn ], [ %.0.i192, %lean_nat_lt.exit ]
  %i.dd = ptrtoint ptr %.1125 to i64              ; 2 uses
  %i.de = and i64 %i.dd, 1
...
lean_mk_empty_byte_array.exit:                    ; preds = %lean_inc.exit
  ...
  %i.do = tail call ptr @l___private_Init_Data_Nat_Fold_0__Nat_foldTR_loop___at___00__private_Lean_Meta_Tactic_BVDecide_LRAT_Trim_0__Lean_Meta_Tactic_BVDecide_LRAT_trim_M_run_spec__1___redArg(ptr noundef %.1125, ptr noundef nonnull %i.dh)
...
.critedge.i:                                      ; preds = %lean_mk_empty_byte_array.exit
  %i.dw = tail call ptr @lean_nat_big_add(ptr noundef %i.z, ptr noundef %.1125) #6
  br label %lean_nat_add.exit
...
lean_obj_once.exit225:                            ; preds = %bb.bz, %bb.ca
  ...
  %i.ec = tail call ptr @lean_mk_array(ptr noundef %.1125, ptr noundef nonnull inttoptr (i64 1 to ptr)) #6
  tail call void @lean_inc_heartbeat() #6
...
lean_alloc_ctor.exit226:                          ; preds = %lean_obj_once.exit225
  ...
  store ptr %.1123, ptr %i.eg, align 8, !tbaa !15
...
lean_dec.exit138.sink.split:                      ; preds = %lean_dec.exit138.sink.split.sink.split, %lean_dec_ref.exit160
  ...
  %.5.ph = phi ptr [ %.0127, %lean_dec_ref.exit160 ], [ %.sink264, %lean_dec.exit138.sink.split.sink.split ] ; 2 uses
...
lean_inc.exit406:                                 ; preds = %bb.am, %bb.al, %bb.ak, %lean_dec_ref_known.exit.thread
  br i1 %.not.i387, label %bb.an, label %lean_inc.exit404

bb.an:                                            ; preds = %lean_inc.exit406
  %.val.i.i480 = load i32, ptr %i.s, align 4, !tbaa !12 ; 3 uses
  %i.co = icmp sgt i32 %.val.i.i480, 0
  br i1 %i.co, label %bb.ao, label %bb.ap, !prof !14

bb.ao:                                            ; preds = %bb.an
  %i.cp = add nuw i32 %.val.i.i480, 1
  store i32 %i.cp, ptr %i.s, align 4, !tbaa !12
  br label %lean_inc.exit404

bb.ap:                                            ; preds = %bb.an
  %.not.i.i481 = icmp eq i32 %.val.i.i480, 0
  br i1 %.not.i.i481, label %lean_inc.exit404, label %bb.aq

bb.aq:                                            ; preds = %bb.ap
  %i.cq = atomicrmw sub ptr %i.s, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit404

lean_inc.exit404:                                 ; preds = %bb.aq, %bb.ap, %bb.ao, %lean_inc.exit406
  %.val.i.i483 = load i32, ptr %.3328595, align 4, !tbaa !12 ; 3 uses
  %i.cr = icmp sgt i32 %.val.i.i483, 0
  br i1 %i.cr, label %bb.ar, label %bb.as, !prof !14

bb.ar:                                            ; preds = %lean_inc.exit404
  %i.cs = add nuw i32 %.val.i.i483, 1
  store i32 %i.cs, ptr %.3328595, align 4, !tbaa !12
  br label %lean_inc_ref.exit485

bb.as:                                            ; preds = %lean_inc.exit404
  %.not.i.i484 = icmp eq i32 %.val.i.i483, 0
  br i1 %.not.i.i484, label %lean_inc_ref.exit485, label %bb.at

bb.at:                                            ; preds = %bb.as
  %i.ct = atomicrmw sub ptr %.3328595, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc_ref.exit485

lean_inc_ref.exit485:                             ; preds = %bb.ar, %bb.as, %bb.at
  ...
  store ptr %.3328595, ptr %i.dc, align 8, !tbaa !15
...
.split:                                           ; preds = %lean_inc_ref.exit485
  %i.dh = icmp eq ptr %.0273, %1
  br i1 %i.dh, label %bb.dc, label %bb.au

lean_nat_eq.exit:                                 ; preds = %lean_inc_ref.exit485
...
bb.aw:                                            ; preds = %bb.au
  %.not.i460 = icmp eq i32 %i.dj, 0
  br i1 %.not.i460, label %lean_dec_ref.exit461, label %bb.ax

bb.ax:                                            ; preds = %bb.aw
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.cu) #6
  br label %lean_dec_ref.exit461

lean_dec_ref.exit461:                             ; preds = %bb.ax, %bb.aw, %bb.av
  %i.dm = getelementptr i8, ptr %.3328595, i64 4
...
bb.ay:                                            ; preds = %lean_dec_ref.exit461
  %i.do = getelementptr inbounds nuw i8, ptr %.3328595, i64 24
  %i.dp = load ptr, ptr %i.do, align 8, !tbaa !15 ; 2 uses
  %i.dq = getelementptr i8, ptr %i.dp, i64 8
  %.val472 = load i64, ptr %i.dq, align 8, !tbaa !9
  br i1 %.not.i468, label %lean_inc.exit402, label %bb.az

bb.az:                                            ; preds = %bb.ay
  %.val.i.i488 = load i32, ptr %.0273, align 4, !tbaa !12 ; 3 uses
  %i.dr = icmp sgt i32 %.val.i.i488, 0
  br i1 %i.dr, label %bb.ba, label %bb.bb, !prof !14

bb.ba:                                            ; preds = %bb.az
  %i.ds = add nuw i32 %.val.i.i488, 1
  store i32 %i.ds, ptr %.0273, align 4, !tbaa !12
  br label %lean_inc.exit402

bb.bb:                                            ; preds = %bb.az
  %.not.i.i489 = icmp eq i32 %.val.i.i488, 0
  br i1 %.not.i.i489, label %lean_inc.exit402, label %bb.bc

bb.bc:                                            ; preds = %bb.bb
  %i.dt = atomicrmw sub ptr %.0273, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit402

lean_inc.exit402:                                 ; preds = %bb.bc, %bb.bb, %bb.ba, %bb.ay
  %i.du = tail call ptr @l___private_Init_Data_Array_Basic_0__Array_forIn_x27Unsafe_loop___at___00__private_Lean_Meta_Tactic_BVDecide_LRAT_Trim_0__Lean_Meta_Tactic_BVDecide_LRAT_trim_mapping_spec__0(ptr noundef %.0273, ptr noundef nonnull %i.dp, i64 noundef %.val472, i64 noundef 0, ptr noundef nonnull @l_WellFounded_opaqueFix_u2083___at___00__private_Lean_Meta_Tactic_BVDecide_LRAT_Trim_0__Lean_Meta_Tactic_BVDecide_LRAT_trim_mapping_spec__3___redArg___closed__0_value, ptr nonnull poison, ptr noundef nonnull %.0307) ; 5 uses
  %i.dv = getelementptr inbounds nuw i8, ptr %i.du, i64 8
  %i.dw = load ptr, ptr %i.dv, align 8, !tbaa !15 ; 5 uses
  %i.dx = ptrtoint ptr %i.dw to i64
  %i.dy = and i64 %i.dx, 1
  %.not.i399 = icmp eq i64 %i.dy, 0
  br i1 %.not.i399, label %bb.bd, label %lean_inc.exit400

bb.bd:                                            ; preds = %lean_inc.exit402
  %.val.i.i491 = load i32, ptr %i.dw, align 4, !tbaa !12 ; 3 uses
  %i.dz = icmp sgt i32 %.val.i.i491, 0
  br i1 %i.dz, label %bb.be, label %bb.bf, !prof !14

bb.be:                                            ; preds = %bb.bd
  %i.ea = add nuw i32 %.val.i.i491, 1
  store i32 %i.ea, ptr %i.dw, align 4, !tbaa !12
  br label %lean_inc.exit400

bb.bf:                                            ; preds = %bb.bd
  %.not.i.i492 = icmp eq i32 %.val.i.i491, 0
  br i1 %.not.i.i492, label %lean_inc.exit400, label %bb.bg

bb.bg:                                            ; preds = %bb.bf
  %i.eb = atomicrmw sub ptr %i.dw, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit400

lean_inc.exit400:                                 ; preds = %bb.bg, %bb.bf, %bb.be, %lean_inc.exit402
  %i.ec = getelementptr inbounds nuw i8, ptr %i.du, i64 16
  %i.ed = load ptr, ptr %i.ec, align 8, !tbaa !15 ; 5 uses
  %i.ee = ptrtoint ptr %i.ed to i64
  %i.ef = and i64 %i.ee, 1
  %.not.i397 = icmp eq i64 %i.ef, 0
  br i1 %.not.i397, label %bb.bh, label %lean_inc.exit398

bb.bh:                                            ; preds = %lean_inc.exit400
  %.val.i.i494 = load i32, ptr %i.ed, align 4, !tbaa !12 ; 3 uses
  %i.eg = icmp sgt i32 %.val.i.i494, 0
  br i1 %i.eg, label %bb.bi, label %bb.bj, !prof !14

bb.bi:                                            ; preds = %bb.bh
  %i.eh = add nuw i32 %.val.i.i494, 1
  store i32 %i.eh, ptr %i.ed, align 4, !tbaa !12
  br label %lean_inc.exit398

bb.bj:                                            ; preds = %bb.bh
  %.not.i.i495 = icmp eq i32 %.val.i.i494, 0
  br i1 %.not.i.i495, label %lean_inc.exit398, label %bb.bk

bb.bk:                                            ; preds = %bb.bj
  %i.ei = atomicrmw sub ptr %i.ed, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit398

lean_inc.exit398:                                 ; preds = %bb.bk, %bb.bj, %bb.bi, %lean_inc.exit400
  %i.ej = load i32, ptr %i.du, align 8, !tbaa !12 ; 3 uses
  %i.ek = icmp sgt i32 %i.ej, 1
  br i1 %i.ek, label %bb.bl, label %bb.bm, !prof !14

bb.bl:                                            ; preds = %lean_inc.exit398
  %i.el = add nsw i32 %i.ej, -1
  store i32 %i.el, ptr %i.du, align 8, !tbaa !12
  br label %lean_dec_ref.exit459

bb.bm:                                            ; preds = %lean_inc.exit398
  %.not.i458 = icmp eq i32 %i.ej, 0
  br i1 %.not.i458, label %lean_dec_ref.exit459, label %bb.bn

bb.bn:                                            ; preds = %bb.bm
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.du) #6
  br label %lean_dec_ref.exit459

lean_dec_ref.exit459:                             ; preds = %bb.bl, %bb.bm, %bb.bn
  %i.em = tail call ptr @l_WellFounded_opaqueFix_u2083___at___00__private_Lean_Meta_Tactic_BVDecide_LRAT_Trim_0__Lean_Meta_Tactic_BVDecide_LRAT_trim_mapping_spec__3___redArg___lam__0(ptr noundef nonnull %.3328595, ptr noundef %i.s, ptr noundef %i.u, i8 noundef zeroext 1, ptr nonnull poison, ptr noundef %i.dw, ptr noundef nonnull %4, ptr noundef %i.ed) ; 4 uses
  br i1 %.not.i387, label %bb.bo, label %lean_dec.exit363.thread

bb.bo:                                            ; preds = %lean_dec_ref.exit459
...
bb.bp:                                            ; preds = %bb.bo
  ...
  br label %lean_dec.exit363.thread

bb.bq:                                            ; preds = %bb.bo
  %.not.i422.a = icmp eq i32 %i.en, 0
  br i1 %.not.i422.a, label %lean_dec.exit363.thread, label %bb.br

bb.br:                                            ; preds = %bb.bq
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.s) #6
  br label %lean_dec.exit363.thread

bb.bs:                                            ; preds = %lean_dec_ref.exit461
  %i.eq = getelementptr inbounds nuw i8, ptr %.3328595, i64 32
  %i.er = load ptr, ptr %i.eq, align 8, !tbaa !15 ; 2 uses
  %i.es = getelementptr inbounds nuw i8, ptr %.3328595, i64 40
  %i.et = load ptr, ptr %i.es, align 8, !tbaa !15 ; 2 uses
  %i.eu = getelementptr i8, ptr %i.er, i64 8
  %.val471 = load i64, ptr %i.eu, align 8, !tbaa !9
  br i1 %.not.i.i531, label %bb.bt, label %lean_inc_n.exit

bb.bt:                                            ; preds = %bb.bs
  %.val.i.i498 = load i32, ptr %.0273, align 4, !tbaa !12 ; 3 uses
  %i.ev = icmp sgt i32 %.val.i.i498, 0
  br i1 %i.ev, label %bb.bu, label %bb.bv, !prof !14

bb.bu:                                            ; preds = %bb.bt
  %i.ew = add nuw i32 %.val.i.i498, 2
  store i32 %i.ew, ptr %.0273, align 4, !tbaa !12
  br label %lean_inc_n.exit

bb.bv:                                            ; preds = %bb.bt
  %.not.i.i499 = icmp eq i32 %.val.i.i498, 0
  br i1 %.not.i.i499, label %lean_inc_n.exit, label %bb.bw
...
lean_dec_ref.exit457:                             ; preds = %bb.cf, %bb.cg, %bb.ch
  ...
  %i.fv = and i64 %i.fu, 1
  %.not.i391 = icmp eq i64 %i.fv, 0
  br i1 %.not.i391, label %bb.ci, label %lean_inc.exit392

bb.ci:                                            ; preds = %lean_dec_ref.exit457
  %.val.i.i506 = load i32, ptr %i.ft, align 4, !tbaa !12 ; 3 uses
  %i.fw = icmp sgt i32 %.val.i.i506, 0
  br i1 %i.fw, label %bb.cj, label %bb.ck, !prof !14

bb.cj:                                            ; preds = %bb.ci
  %i.fx = add nuw i32 %.val.i.i506, 1
  store i32 %i.fx, ptr %i.ft, align 4, !tbaa !12
  br label %lean_inc.exit392

bb.ck:                                            ; preds = %bb.ci
  %.not.i.i507 = icmp eq i32 %.val.i.i506, 0
  br i1 %.not.i.i507, label %lean_inc.exit392, label %bb.cl

bb.cl:                                            ; preds = %bb.ck
  %i.fy = atomicrmw sub ptr %i.ft, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit392

lean_inc.exit392:                                 ; preds = %bb.cl, %bb.ck, %bb.cj, %lean_dec_ref.exit457
  ...
  %i.gc = and i64 %i.gb, 1
  %.not.i389 = icmp eq i64 %i.gc, 0
  br i1 %.not.i389, label %bb.cm, label %lean_inc.exit390

bb.cm:                                            ; preds = %lean_inc.exit392
  %.val.i.i509 = load i32, ptr %i.ga, align 4, !tbaa !12 ; 3 uses
  %i.gd = icmp sgt i32 %.val.i.i509, 0
  br i1 %i.gd, label %bb.cn, label %bb.co, !prof !14

bb.cn:                                            ; preds = %bb.cm
  %i.ge = add nuw i32 %.val.i.i509, 1
  store i32 %i.ge, ptr %i.ga, align 4, !tbaa !12
  br label %lean_inc.exit390

bb.co:                                            ; preds = %bb.cm
  %.not.i.i510 = icmp eq i32 %.val.i.i509, 0
  br i1 %.not.i.i510, label %lean_inc.exit390, label %bb.cp

bb.cp:                                            ; preds = %bb.co
  %i.gf = atomicrmw sub ptr %i.ga, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc.exit390

lean_inc.exit390:                                 ; preds = %bb.cp, %bb.co, %bb.cn, %lean_inc.exit392
  %i.gg = load i32, ptr %i.fr, align 8, !tbaa !12 ; 3 uses
  %i.gh = icmp sgt i32 %i.gg, 1
  br i1 %i.gh, label %bb.cq, label %bb.cr, !prof !14

bb.cq:                                            ; preds = %lean_inc.exit390
  %i.gi = add nsw i32 %i.gg, -1
  store i32 %i.gi, ptr %i.fr, align 8, !tbaa !12
  br label %lean_dec_ref.exit455

bb.cr:                                            ; preds = %lean_inc.exit390
  %.not.i454 = icmp eq i32 %i.gg, 0
  br i1 %.not.i454, label %lean_dec_ref.exit455, label %bb.cs

bb.cs:                                            ; preds = %bb.cr
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.fr) #6
  br label %lean_dec_ref.exit455

lean_dec_ref.exit455:                             ; preds = %bb.cq, %bb.cr, %bb.cs
  ...
  br i1 %.not.i387, label %bb.ct, label %lean_dec.exit363.thread

bb.ct:                                            ; preds = %lean_dec_ref.exit455
...
bb.da:                                            ; preds = %bb.cy
  %.not.i426 = icmp eq i32 %i.go, 0
  br i1 %.not.i426, label %lean_dec.exit363.thread, label %bb.db
...
bb.dc:                                            ; preds = %.split, %lean_nat_eq.exit
  %i.gr = load i32, ptr %.3328595, align 4, !tbaa !12 ; 3 uses
  %i.gs = icmp sgt i32 %i.gr, 1
  br i1 %i.gs, label %bb.dd, label %bb.de, !prof !14

bb.dd:                                            ; preds = %bb.dc
  %i.gt = add nsw i32 %i.gr, -1
  store i32 %i.gt, ptr %.3328595, align 4, !tbaa !12
  br label %lean_dec_ref.exit453

bb.de:                                            ; preds = %bb.dc
  %.not.i452 = icmp eq i32 %i.gr, 0
  br i1 %.not.i452, label %lean_dec_ref.exit453, label %bb.df

bb.df:                                            ; preds = %bb.de
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %.3328595) #6
  br label %lean_dec_ref.exit453

lean_dec_ref.exit453:                             ; preds = %bb.dd, %bb.de, %bb.df
  br i1 %.not.i405.a, label %bb.dg, label %lean_dec.exit357

bb.dg:                                            ; preds = %lean_dec_ref.exit453
...
bb.di:                                            ; preds = %bb.dg
  %.not.i428 = icmp eq i32 %i.gu, 0
  br i1 %.not.i428, label %lean_dec.exit357, label %bb.dj

bb.dj:                                            ; preds = %bb.di
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.u) #6
  br label %lean_dec.exit357

lean_dec.exit357:                                 ; preds = %bb.dj, %bb.di, %bb.dh, %lean_dec_ref.exit453
  br i1 %.not.i387, label %bb.dk, label %bb.iy

bb.dk:                                            ; preds = %lean_dec.exit357
...
bb.dm:                                            ; preds = %bb.dk
  %.not.i430 = icmp eq i32 %i.gx, 0
  br i1 %.not.i430, label %bb.iy, label %bb.dn

bb.dn:                                            ; preds = %bb.dm
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.s) #6
  br label %bb.iy

lean_dec.exit367:                                 ; preds = %.thread589, %bb.ag, %bb.ah, %bb.ai, %lean_dec.exit369, %bb.ac, %bb.ad, %bb.ae
  %.0329 = phi i8 [ %i.bx, %lean_dec.exit369 ], [ %i.bx, %bb.ae ], [ %i.bx, %bb.ad ], [ %i.bx, %bb.ac ], [ %i.bl, %.thread589 ], [ %i.cf, %bb.ai ], [ %i.cf, %bb.ag ], [ %i.cf, %bb.ah ]
  %i.ha = icmp eq i8 %.0329, 1
  br i1 %i.ha, label %bb.dr, label %bb.do

bb.do:                                            ; preds = %lean_dec.exit367
  br i1 %i.v, label %lean_dec.exit363, label %bb.dp

bb.dp:                                            ; preds = %bb.do
  tail call void @lean_inc_heartbeat() #6
  %i.hb = tail call noalias ptr @mi_malloc_small(i64 noundef 24) #6 ; 6 uses
  %i.hc = icmp eq ptr %i.hb, null
  br i1 %i.hc, label %bb.dq, label %lean_alloc_ctor.exit512

bb.dq:                                            ; preds = %bb.dp
  tail call void @lean_internal_panic_out_of_memory() #7
  unreachable

lean_alloc_ctor.exit512:                          ; preds = %bb.dp
...
bb.dr:                                            ; preds = %lean_dec.exit367
  %.val.i.i513 = load i32, ptr %i.aq, align 4, !tbaa !12 ; 3 uses
  %i.hg = icmp sgt i32 %.val.i.i513, 0
  br i1 %i.hg, label %bb.ds, label %bb.dt, !prof !14

bb.ds:                                            ; preds = %bb.dr
  %i.hh = add nuw i32 %.val.i.i513, 1
  store i32 %i.hh, ptr %i.aq, align 4, !tbaa !12
  br label %lean_inc_ref.exit515

bb.dt:                                            ; preds = %bb.dr
  %.not.i.i514 = icmp eq i32 %.val.i.i513, 0
  br i1 %.not.i.i514, label %lean_inc_ref.exit515, label %bb.du

bb.du:                                            ; preds = %bb.dt
  %i.hi = atomicrmw sub ptr %i.aq, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc_ref.exit515

lean_inc_ref.exit515:                             ; preds = %bb.ds, %bb.dt, %bb.du
  %.val.i.i516 = load i32, ptr %i.ao, align 4, !tbaa !12 ; 3 uses
  %i.hj = icmp sgt i32 %.val.i.i516, 0
  br i1 %i.hj, label %bb.dv, label %bb.dw, !prof !14

bb.dv:                                            ; preds = %lean_inc_ref.exit515
  %i.hk = add nuw i32 %.val.i.i516, 1
  store i32 %i.hk, ptr %i.ao, align 4, !tbaa !12
  br label %lean_inc_ref.exit518

bb.dw:                                            ; preds = %lean_inc_ref.exit515
  %.not.i.i517 = icmp eq i32 %.val.i.i516, 0
  br i1 %.not.i.i517, label %lean_inc_ref.exit518, label %bb.dx

bb.dx:                                            ; preds = %bb.dw
  %i.hl = atomicrmw sub ptr %i.ao, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc_ref.exit518

lean_inc_ref.exit518:                             ; preds = %bb.dv, %bb.dw, %bb.dx
  %.val.i.i519 = load i32, ptr %i.am, align 8, !tbaa !12 ; 3 uses
  %i.hm = icmp sgt i32 %.val.i.i519, 0
  br i1 %i.hm, label %bb.dy, label %bb.dz, !prof !14

bb.dy:                                            ; preds = %lean_inc_ref.exit518
  %i.hn = add nuw i32 %.val.i.i519, 1
  store i32 %i.hn, ptr %i.am, align 8, !tbaa !12
  br label %lean_inc_ref.exit521

bb.dz:                                            ; preds = %lean_inc_ref.exit518
  %.not.i.i520 = icmp eq i32 %.val.i.i519, 0
  br i1 %.not.i.i520, label %lean_inc_ref.exit521, label %bb.ea

bb.ea:                                            ; preds = %bb.dz
  %i.ho = atomicrmw sub ptr %i.am, i32 1 monotonic, align 4 ; 0 uses
  br label %lean_inc_ref.exit521

lean_inc_ref.exit521:                             ; preds = %bb.dy, %bb.dz, %bb.ea
  %i.hp = ptrtoint ptr %.0308 to i64
  %i.hq = and i64 %i.hp, 1
  %.not.i522 = icmp eq i64 %i.hq, 0
  br i1 %.not.i522, label %bb.eb, label %lean_del_object.exit

bb.eb:                                            ; preds = %lean_inc_ref.exit521
  tail call void @lean_free_object(ptr noundef nonnull %.0308) #6
  br label %lean_del_object.exit

lean_del_object.exit:                             ; preds = %lean_inc_ref.exit521, %bb.eb
...
bb.ec:                                            ; preds = %lean_del_object.exit
  ...
  %i.hu = and i64 %i.ht, 1
  %.not.i352 = icmp eq i64 %i.hu, 0
  br i1 %.not.i352, label %bb.ed, label %lean_dec.exit353
...
bb.ef:                                            ; preds = %bb.ed
  %.not.i432 = icmp eq i32 %i.hv, 0
  br i1 %.not.i432, label %lean_dec.exit353, label %bb.eg

bb.eg:                                            ; preds = %bb.ef
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.hs) #6
  br label %lean_dec.exit353

lean_dec.exit353:                                 ; preds = %bb.eg, %bb.ef, %bb.ee, %bb.ec
  %i.hy = load ptr, ptr %i.an, align 8, !tbaa !15 ; 4 uses
  %i.hz = ptrtoint ptr %i.hy to i64
  %i.ia = and i64 %i.hz, 1
  %.not.i350 = icmp eq i64 %i.ia, 0
  br i1 %.not.i350, label %bb.eh, label %lean_dec.exit351

bb.eh:                                            ; preds = %lean_dec.exit353
...
bb.ej:                                            ; preds = %bb.eh
  %.not.i434 = icmp eq i32 %i.ib, 0
  br i1 %.not.i434, label %lean_dec.exit351, label %bb.ek

bb.ek:                                            ; preds = %bb.ej
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %i.hy) #6
  br label %lean_dec.exit351

lean_dec.exit351:                                 ; preds = %bb.ek, %bb.ej, %bb.ei, %lean_dec.exit353
  %i.ie = load ptr, ptr %i.al, align 8, !tbaa !15 ; 4 uses
  %i.if = ptrtoint ptr %i.ie to i64
  %i.ig = and i64 %i.if, 1
  %.not.i348 = icmp eq i64 %i.ig, 0
  br i1 %.not.i348, label %bb.el, label %lean_dec.exit349

bb.el:                                            ; preds = %lean_dec.exit351
...
bb.en:                                            ; preds = %bb.el
  %.not.i436 = icmp eq i32 %i.ih, 0
  br i1 %.not.i436, label %lean_dec.exit349, label %bb.eo
...
bb.er:                                            ; preds = %bb.ep
  %.not.i438 = icmp eq i32 %.0277.val, 0
  br i1 %.not.i438, label %lean_dec.exit349, label %bb.es

bb.es:                                            ; preds = %bb.er
  tail call void @lean_dec_ref_cold(ptr noundef nonnull %.0277) #6
  br label %lean_dec.exit349

lean_dec.exit349:                                 ; preds = %bb.eq, %bb.er, %bb.es, %lean_dec.exit351, %bb.em, %bb.en, %bb.eo
  %.0310 = phi ptr [ %.0277, %lean_dec.exit351 ], [ %.0277, %bb.eo ], [ %.0277, %bb.en ], [ %.0277, %bb.em ], [ inttoptr (i64 1 to ptr), %bb.es ], [ inttoptr (i64 1 to ptr), %bb.er ], [ inttoptr (i64 1 to ptr), %bb.eq ] ; 2 uses
  br i1 %.not.i468, label %bb.et, label %.critedge.i, !prof !14

bb.et:                                            ; preds = %lean_dec.exit349
  %i.im = ptrtoint ptr %i.ak to i64               ; 2 uses
  %i.in = and i64 %i.im, 1
  %.not656 = icmp eq i64 %i.in, 0
  br i1 %.not656, label %.critedge.i, label %bb.eu, !prof !11
