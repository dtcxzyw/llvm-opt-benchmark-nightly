begin_hunk_0
  %16 = getelementptr inbounds nuw i8, ptr %0, i64 32 ; [#uses=1 type=ptr]
  %17 = load i64, ptr %16, align 8, !noundef !4   ; [#uses=1 type=i64]
  %18 = icmp eq i64 %.sroa.0.0.i, %17             ; [#uses=1 type=i1]
...
19:                                               ; preds = %_RNvMs_NtCsdNqyU9N9qTX_12sharded_slab3tidINtB4_3TidNtNtB6_3cfg13DefaultConfigE7currentCs7p2uQeJxui2_9deltalake.exit
  %20 = getelementptr inbounds nuw i8, ptr %0, i64 24 ; [#uses=1 type=ptr]
end_hunk_0
begin_hunk_1

55:                                               ; preds = %51
  %56 = trunc i64 %.sroa.0.018.i.i.i.i to i32     ; [#uses=1 type=i32]
  %57 = and i32 %56, 31                           ; [#uses=2 type=i32]
  %.not.i.i.i.i = icmp eq i32 %57, 31             ; [#uses=1 type=i1]
  br i1 %.not.i.i.i.i, label %._crit_edge.i.i.i.i, label %.lr.ph.preheader.i.i.i.i

.lr.ph.preheader.i.i.i.i:                         ; preds = %55
  %58 = shl nuw nsw i32 1, %57                    ; [#uses=1 type=i32]
  %59 = freeze i32 %58                            ; [#uses=3 type=i32]
  %60 = add i32 %59, -1                           ; [#uses=1 type=i32]
  %xtraiter = and i32 %59, 7                      ; [#uses=3 type=i32]
  %61 = icmp ult i32 %60, 7                       ; [#uses=1 type=i1]
...
.lr.ph.preheader.i.i.i.i.new:                     ; preds = %.lr.ph.preheader.i.i.i.i
  %unroll_iter = and i32 %59, -8                  ; [#uses=1 type=i32]
...
.lr.ph.i.i.i.i.epil.preheader:                    ; preds = %._crit_edge.i.i.i.i.loopexit.unr-lcssa, %.lr.ph.preheader.i.i.i.i
  %lcmp.mod41 = icmp ne i32 %xtraiter, 0          ; [#uses=1 type=i1]
...
._crit_edge.i.i.i.i:                              ; preds = %._crit_edge.i.i.i.i.loopexit.unr-lcssa, %.lr.ph.i.i.i.i.epil, %55
  %62 = icmp ugt i64 %.sroa.0.018.i.i.i.i, 7      ; [#uses=1 type=i1]
  br i1 %62, label %65, label %63

.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i, %.lr.ph.preheader.i.i.i.i.new
  %niter = phi i32 [ 0, %.lr.ph.preheader.i.i.i.i.new ], [ %niter.next.7, %.lr.ph.i.i.i.i ] ; [#uses=1 type=i32]
end_hunk_3
begin_hunk_4
  %niter.ncmp.7 = icmp eq i32 %niter.next.7, %unroll_iter ; [#uses=1 type=i1]
  br i1 %niter.ncmp.7, label %._crit_edge.i.i.i.i.loopexit.unr-lcssa, label %.lr.ph.i.i.i.i

63:                                               ; preds = %._crit_edge.i.i.i.i
  %64 = add nuw nsw i64 %.sroa.0.018.i.i.i.i, 1   ; [#uses=1 type=i64]
...
_RNvNtNtCsdNqyU9N9qTX_12sharded_slab4page4slot19exponential_backoff.exit.i.i.i.i: ; preds = %65, %63, %47
  %.sroa.0.1.i.i.i.i = phi i64 [ 0, %47 ], [ %.sroa.0.018.i.i.i.i, %65 ], [ %64, %63 ] ; [#uses=1 type=i64]
  %.sroa.06.1.i.i.i.i = phi i64 [ %.sroa.01.0.i.i.i.i.i, %47 ], [ %.sroa.06.019.i.i.i.i, %65 ], [ %.sroa.06.019.i.i.i.i, %63 ] ; [#uses=2 type=i64]
  %.sroa.02.1.i.i.i.i = phi i1 [ %.sroa.02.020.i.i.i.i, %47 ], [ true, %65 ], [ true, %63 ] ; [#uses=2 type=i1]
  %66 = lshr i64 %.sroa.06.1.i.i.i.i, 51          ; [#uses=1 type=i64]
  %67 = icmp eq i64 %29, %66                      ; [#uses=1 type=i1]
  %or.cond.not.i.i.i.i = or i1 %.sroa.02.1.i.i.i.i, %67 ; [#uses=1 type=i1]
...
68:                                               ; preds = %_RNvMs_NtCsdNqyU9N9qTX_12sharded_slab3tidINtB4_3TidNtNtB6_3cfg13DefaultConfigE7currentCs7p2uQeJxui2_9deltalake.exit
  ...
  %69 = and i64 %1, 274877906943                  ; [#uses=2 type=i64]
  %70 = add nuw nsw i64 %69, 32                   ; [#uses=1 type=i64]
  %71 = lshr i64 %70, 6                           ; [#uses=1 type=i64]
  %72 = tail call range(i64 31, 65) i64 @llvm.ctlz.i64(i64 %71, i1 false) ; [#uses=1 type=i64]
  %73 = sub nuw nsw i64 64, %72                   ; [#uses=5 type=i64]
  %74 = getelementptr inbounds nuw i8, ptr %0, i64 24 ; [#uses=1 type=ptr]
  %75 = load i64, ptr %74, align 8, !alias.scope !11112, !noundef !4 ; [#uses=1 type=i64]
  %.not.i3 = icmp ult i64 %73, %75                ; [#uses=1 type=i1]
...
76:                                               ; preds = %68
  %77 = getelementptr inbounds nuw i8, ptr %0, i64 16 ; [#uses=1 type=ptr]
  %78 = load ptr, ptr %77, align 8, !alias.scope !11112, !nonnull !4, !noundef !4 ; [#uses=1 type=ptr]
  %79 = getelementptr inbounds nuw [40 x i8], ptr %78, i64 %73 ; [#uses=3 type=ptr]
  %80 = lshr i64 %1, 51                           ; [#uses=3 type=i64]
  tail call void @llvm.experimental.noalias.scope.decl(metadata !11115)
  %81 = getelementptr inbounds nuw i8, ptr %0, i64 8 ; [#uses=1 type=ptr]
  %82 = load i64, ptr %81, align 8, !alias.scope !11118, !noundef !4 ; [#uses=2 type=i64]
  %83 = icmp ult i64 %73, %82                     ; [#uses=1 type=i1]
...
_RNvMs0_NtCsdNqyU9N9qTX_12sharded_slab5shardINtB5_5ShardNtNtNtCsbG4i8A5DnWX_18tracing_subscriber8registry7sharded9DataInnerNtNtB7_3cfg13DefaultConfigE5localCs7p2uQeJxui2_9deltalake.exit.i: ; preds = %76
  %85 = load ptr, ptr %0, align 8, !alias.scope !11118, !nonnull !4, !noundef !4 ; [#uses=1 type=ptr]
  %86 = getelementptr inbounds nuw [8 x i8], ptr %85, i64 %73 ; [#uses=2 type=ptr]
  %87 = getelementptr inbounds nuw i8, ptr %79, i64 32 ; [#uses=1 type=ptr]
  %88 = load i64, ptr %87, align 8, !noalias !11112, !noundef !4 ; [#uses=1 type=i64]
  %89 = sub i64 %69, %88                          ; [#uses=3 type=i64]
  %90 = load ptr, ptr %79, align 8, !noalias !11119, !align !1680, !noundef !4 ; [#uses=2 type=ptr]
  %.not.i.i.i5 = icmp eq ptr %90, null            ; [#uses=1 type=i1]
...
91:                                               ; preds = %_RNvMs0_NtCsdNqyU9N9qTX_12sharded_slab5shardINtB5_5ShardNtNtNtCsbG4i8A5DnWX_18tracing_subscriber8registry7sharded9DataInnerNtNtB7_3cfg13DefaultConfigE5localCs7p2uQeJxui2_9deltalake.exit.i
  %92 = getelementptr inbounds nuw i8, ptr %79, i64 8 ; [#uses=1 type=ptr]
  %93 = load i64, ptr %92, align 8, !noalias !11119, !noundef !4 ; [#uses=1 type=i64]
  %94 = icmp ult i64 %89, %93                     ; [#uses=1 type=i1]
...
95:                                               ; preds = %91
  %96 = getelementptr inbounds nuw [96 x i8], ptr %90, i64 %89 ; [#uses=3 type=ptr]
  %97 = getelementptr inbounds nuw i8, ptr %96, i64 80 ; [#uses=2 type=ptr]
  %98 = load atomic i64, ptr %97 acquire, align 8, !noalias !11119 ; [#uses=2 type=i64]
  %99 = lshr i64 %98, 51                          ; [#uses=1 type=i64]
  %100 = icmp eq i64 %80, %99                     ; [#uses=1 type=i1]
...
.lr.ph23.i.i.i.i6:                                ; preds = %95
  %.cmp.i.i.i.i7 = icmp ult i64 %1, -4503599627370496 ; [#uses=1 type=i1]
  %.v.i.i.i.i8 = select i1 %.cmp.i.i.i.i7, i64 1, i64 -8190 ; [#uses=1 type=i64]
  %101 = add nsw i64 %.v.i.i.i.i8, %80            ; [#uses=1 type=i64]
  %102 = shl nuw i64 %101, 51                     ; [#uses=1 type=i64]
  br label %103

103:                                              ; preds = %_RNvNtNtCsdNqyU9N9qTX_12sharded_slab4page4slot19exponential_backoff.exit.i.i.i.i14, %.lr.ph23.i.i.i.i6
  %.sroa.02.020.i.i.i.i9 = phi i1 [ false, %.lr.ph23.i.i.i.i6 ], [ %.sroa.02.1.i.i.i.i17, %_RNvNtNtCsdNqyU9N9qTX_12sharded_slab4page4slot19exponential_backoff.exit.i.i.i.i14 ] ; [#uses=1 type=i1]
  %.sroa.06.019.i.i.i.i10 = phi i64 [ %98, %.lr.ph23.i.i.i.i6 ], [ %.sroa.06.1.i.i.i.i16, %_RNvNtNtCsdNqyU9N9qTX_12sharded_slab4page4slot19exponential_backoff.exit.i.i.i.i14 ] ; [#uses=4 type=i64]
  %.sroa.0.018.i.i.i.i11 = phi i64 [ 0, %.lr.ph23.i.i.i.i6 ], [ %.sroa.0.1.i.i.i.i15, %_RNvNtNtCsdNqyU9N9qTX_12sharded_slab4page4slot19exponential_backoff.exit.i.i.i.i14 ] ; [#uses=4 type=i64]
  %104 = and i64 %.sroa.06.019.i.i.i.i10, 2251799813685247 ; [#uses=1 type=i64]
  %105 = or disjoint i64 %104, %102               ; [#uses=1 type=i64]
  %106 = cmpxchg ptr %97, i64 %.sroa.06.019.i.i.i.i10, i64 %105 acq_rel acquire, align 8, !noalias !11119 ; [#uses=2 type={ i64, i1 }]
  %.sroa.18.0.in.i.i.i.i.i12 = extractvalue { i64, i1 } %106, 1 ; [#uses=1 type=i1]
  %.sroa.01.0.i.i.i.i.i13 = extractvalue { i64, i1 } %106, 0 ; [#uses=2 type=i64]
...
107:                                              ; preds = %103
  %108 = and i64 %.sroa.01.0.i.i.i.i.i13, 2251799813685244 ; [#uses=1 type=i64]
  %109 = icmp eq i64 %108, 0                      ; [#uses=1 type=i1]
...
110:                                              ; preds = %107
  ...
  %111 = load i64, ptr %86, align 8, !noalias !11119, !noundef !4 ; [#uses=1 type=i64]
  %112 = getelementptr inbounds nuw i8, ptr %96, i64 88 ; [#uses=1 type=ptr]
...
113:                                              ; preds = %107
  %114 = trunc i64 %.sroa.0.018.i.i.i.i11 to i32  ; [#uses=1 type=i32]
  %115 = and i32 %114, 31                         ; [#uses=2 type=i32]
  %.not.i.i.i.i19 = icmp eq i32 %115, 31          ; [#uses=1 type=i1]
...
.lr.ph.preheader.i.i.i.i20:                       ; preds = %113
  ...
  %117 = freeze i32 %116                          ; [#uses=3 type=i32]
  %118 = add i32 %117, -1                         ; [#uses=1 type=i32]
  %xtraiter42 = and i32 %117, 7                   ; [#uses=3 type=i32]
  %119 = icmp ult i32 %118, 7                     ; [#uses=1 type=i1]
...
.lr.ph.preheader.i.i.i.i20.new:                   ; preds = %.lr.ph.preheader.i.i.i.i20
  %unroll_iter46 = and i32 %117, -8               ; [#uses=1 type=i32]
...
.lr.ph.i.i.i.i21.epil.preheader:                  ; preds = %._crit_edge.i.i.i.i24.loopexit.unr-lcssa, %.lr.ph.preheader.i.i.i.i20
  %lcmp.mod45 = icmp ne i32 %xtraiter42, 0        ; [#uses=1 type=i1]
  tail call void @llvm.assume(i1 %lcmp.mod45)
  br label %.lr.ph.i.i.i.i21.epil

end_hunk_5
begin_hunk_6
  %epil.iter43.cmp.not = icmp eq i32 %epil.iter43.next, %xtraiter42 ; [#uses=1 type=i1]
...
._crit_edge.i.i.i.i24:                            ; preds = %._crit_edge.i.i.i.i24.loopexit.unr-lcssa, %.lr.ph.i.i.i.i21.epil, %113
  %120 = icmp ugt i64 %.sroa.0.018.i.i.i.i11, 7   ; [#uses=1 type=i1]
  br i1 %120, label %123, label %121

.lr.ph.i.i.i.i21:                                 ; preds = %.lr.ph.i.i.i.i21, %.lr.ph.preheader.i.i.i.i20.new
  %niter47 = phi i32 [ 0, %.lr.ph.preheader.i.i.i.i20.new ], [ %niter47.next.7, %.lr.ph.i.i.i.i21 ] ; [#uses=1 type=i32]
end_hunk_6
begin_hunk_7
  %niter47.ncmp.7 = icmp eq i32 %niter47.next.7, %unroll_iter46 ; [#uses=1 type=i1]
  br i1 %niter47.ncmp.7, label %._crit_edge.i.i.i.i24.loopexit.unr-lcssa, label %.lr.ph.i.i.i.i21

121:                                              ; preds = %._crit_edge.i.i.i.i24
  %122 = add nuw nsw i64 %.sroa.0.018.i.i.i.i11, 1 ; [#uses=1 type=i64]
...
_RNvNtNtCsdNqyU9N9qTX_12sharded_slab4page4slot19exponential_backoff.exit.i.i.i.i14: ; preds = %123, %121, %103
  %.sroa.0.1.i.i.i.i15 = phi i64 [ 0, %103 ], [ %.sroa.0.018.i.i.i.i11, %123 ], [ %122, %121 ] ; [#uses=1 type=i64]
  %.sroa.06.1.i.i.i.i16 = phi i64 [ %.sroa.01.0.i.i.i.i.i13, %103 ], [ %.sroa.06.019.i.i.i.i10, %123 ], [ %.sroa.06.019.i.i.i.i10, %121 ] ; [#uses=2 type=i64]
  %.sroa.02.1.i.i.i.i17 = phi i1 [ %.sroa.02.020.i.i.i.i9, %103 ], [ true, %123 ], [ true, %121 ] ; [#uses=2 type=i1]
  %124 = lshr i64 %.sroa.06.1.i.i.i.i16, 51       ; [#uses=1 type=i64]
  %125 = icmp eq i64 %80, %124                    ; [#uses=1 type=i1]
  %or.cond.not.i.i.i.i18 = or i1 %.sroa.02.1.i.i.i.i17, %125 ; [#uses=1 type=i1]
