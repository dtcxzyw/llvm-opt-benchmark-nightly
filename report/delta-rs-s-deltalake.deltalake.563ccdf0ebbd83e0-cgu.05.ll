...
55:                                               ; preds = %51
  ...
  %57 = and i32 %56, 31                           ; [#uses=4 type=i32]
...
.lr.ph.preheader.i.i.i.i:                         ; preds = %55
  %58 = shl nuw nsw i32 1, %57                    ; [#uses=2 type=i32]
  %xtraiter = and i32 %58, 7                      ; [#uses=2 type=i32]
  %59 = icmp samesign ult i32 %57, 3              ; [#uses=1 type=i1]
...
.lr.ph.preheader.i.i.i.i.new:                     ; preds = %.lr.ph.preheader.i.i.i.i
  %unroll_iter = and i32 %58, 2147483640          ; [#uses=1 type=i32]
...
.lr.ph.i.i.i.i.epil.preheader:                    ; preds = %._crit_edge.i.i.i.i.loopexit.unr-lcssa, %.lr.ph.preheader.i.i.i.i
  %lcmp.mod41 = icmp samesign ult i32 %57, 3      ; [#uses=1 type=i1]
...
._crit_edge.i.i.i.i:                              ; preds = %._crit_edge.i.i.i.i.loopexit.unr-lcssa, %.lr.ph.i.i.i.i.epil, %55
  %60 = icmp ugt i64 %.sroa.0.018.i.i.i.i, 7      ; [#uses=1 type=i1]
...
61:                                               ; preds = %._crit_edge.i.i.i.i
  %62 = add nuw nsw i64 %.sroa.0.018.i.i.i.i, 1   ; [#uses=1 type=i64]
...
_RNvNtNtCsdNqyU9N9qTX_12sharded_slab4page4slot19exponential_backoff.exit.i.i.i.i: ; preds = %63, %61, %47
  %.sroa.0.1.i.i.i.i = phi i64 [ 0, %47 ], [ %.sroa.0.018.i.i.i.i, %63 ], [ %62, %61 ] ; [#uses=1 type=i64]
  %.sroa.06.1.i.i.i.i = phi i64 [ %.sroa.01.0.i.i.i.i.i, %47 ], [ %.sroa.06.019.i.i.i.i, %63 ], [ %.sroa.06.019.i.i.i.i, %61 ] ; [#uses=2 type=i64]
  %.sroa.02.1.i.i.i.i = phi i1 [ %.sroa.02.020.i.i.i.i, %47 ], [ true, %63 ], [ true, %61 ] ; [#uses=2 type=i1]
  %64 = lshr i64 %.sroa.06.1.i.i.i.i, 51          ; [#uses=1 type=i64]
  %65 = icmp eq i64 %29, %64                      ; [#uses=1 type=i1]
  %or.cond.not.i.i.i.i = or i1 %.sroa.02.1.i.i.i.i, %65 ; [#uses=1 type=i1]
...
66:                                               ; preds = %_RNvMs_NtCsdNqyU9N9qTX_12sharded_slab3tidINtB4_3TidNtNtB6_3cfg13DefaultConfigE7currentCs7p2uQeJxui2_9deltalake.exit
  ...
  %67 = and i64 %1, 274877906943                  ; [#uses=2 type=i64]
  %68 = add nuw nsw i64 %67, 32                   ; [#uses=1 type=i64]
  %69 = lshr i64 %68, 6                           ; [#uses=1 type=i64]
  %70 = tail call range(i64 31, 65) i64 @llvm.ctlz.i64(i64 %69, i1 false) ; [#uses=1 type=i64]
  %71 = sub nuw nsw i64 64, %70                   ; [#uses=5 type=i64]
  %72 = getelementptr inbounds nuw i8, ptr %0, i64 24 ; [#uses=1 type=ptr]
  %73 = load i64, ptr %72, align 8, !alias.scope !11112, !noundef !4 ; [#uses=1 type=i64]
  %.not.i3 = icmp ult i64 %71, %73                ; [#uses=1 type=i1]
...
74:                                               ; preds = %66
  %75 = getelementptr inbounds nuw i8, ptr %0, i64 16 ; [#uses=1 type=ptr]
  %76 = load ptr, ptr %75, align 8, !alias.scope !11112, !nonnull !4, !noundef !4 ; [#uses=1 type=ptr]
  %77 = getelementptr inbounds nuw [40 x i8], ptr %76, i64 %71 ; [#uses=3 type=ptr]
  %78 = lshr i64 %1, 51                           ; [#uses=3 type=i64]
  tail call void @llvm.experimental.noalias.scope.decl(metadata !11115)
  %79 = getelementptr inbounds nuw i8, ptr %0, i64 8 ; [#uses=1 type=ptr]
  %80 = load i64, ptr %79, align 8, !alias.scope !11118, !noundef !4 ; [#uses=2 type=i64]
  %81 = icmp ult i64 %71, %80                     ; [#uses=1 type=i1]
...
_RNvMs0_NtCsdNqyU9N9qTX_12sharded_slab5shardINtB5_5ShardNtNtNtCsbG4i8A5DnWX_18tracing_subscriber8registry7sharded9DataInnerNtNtB7_3cfg13DefaultConfigE5localCs7p2uQeJxui2_9deltalake.exit.i: ; preds = %74
  %83 = load ptr, ptr %0, align 8, !alias.scope !11118, !nonnull !4, !noundef !4 ; [#uses=1 type=ptr]
  %84 = getelementptr inbounds nuw [8 x i8], ptr %83, i64 %71 ; [#uses=2 type=ptr]
  %85 = getelementptr inbounds nuw i8, ptr %77, i64 32 ; [#uses=1 type=ptr]
  %86 = load i64, ptr %85, align 8, !noalias !11112, !noundef !4 ; [#uses=1 type=i64]
  %87 = sub i64 %67, %86                          ; [#uses=3 type=i64]
  %88 = load ptr, ptr %77, align 8, !noalias !11119, !align !1680, !noundef !4 ; [#uses=2 type=ptr]
  %.not.i.i.i5 = icmp eq ptr %88, null            ; [#uses=1 type=i1]
...
89:                                               ; preds = %_RNvMs0_NtCsdNqyU9N9qTX_12sharded_slab5shardINtB5_5ShardNtNtNtCsbG4i8A5DnWX_18tracing_subscriber8registry7sharded9DataInnerNtNtB7_3cfg13DefaultConfigE5localCs7p2uQeJxui2_9deltalake.exit.i
  %90 = getelementptr inbounds nuw i8, ptr %77, i64 8 ; [#uses=1 type=ptr]
  %91 = load i64, ptr %90, align 8, !noalias !11119, !noundef !4 ; [#uses=1 type=i64]
  %92 = icmp ult i64 %87, %91                     ; [#uses=1 type=i1]
...
93:                                               ; preds = %89
  %94 = getelementptr inbounds nuw [96 x i8], ptr %88, i64 %87 ; [#uses=3 type=ptr]
  %95 = getelementptr inbounds nuw i8, ptr %94, i64 80 ; [#uses=2 type=ptr]
  %96 = load atomic i64, ptr %95 acquire, align 8, !noalias !11119 ; [#uses=2 type=i64]
  %97 = lshr i64 %96, 51                          ; [#uses=1 type=i64]
  %98 = icmp eq i64 %78, %97                      ; [#uses=1 type=i1]
...
.lr.ph23.i.i.i.i6:                                ; preds = %93
  ...
  %99 = add nsw i64 %.v.i.i.i.i8, %78             ; [#uses=1 type=i64]
  %100 = shl nuw i64 %99, 51                      ; [#uses=1 type=i64]
  br label %101
...
101:                                              ; preds = %_RNvNtNtCsdNqyU9N9qTX_12sharded_slab4page4slot19exponential_backoff.exit.i.i.i.i14, %.lr.ph23.i.i.i.i6
  ...
  %.sroa.06.019.i.i.i.i10 = phi i64 [ %96, %.lr.ph23.i.i.i.i6 ], [ %.sroa.06.1.i.i.i.i16, %_RNvNtNtCsdNqyU9N9qTX_12sharded_slab4page4slot19exponential_backoff.exit.i.i.i.i14 ] ; [#uses=4 type=i64]
  ...
  %102 = and i64 %.sroa.06.019.i.i.i.i10, 2251799813685247 ; [#uses=1 type=i64]
  %103 = or disjoint i64 %102, %100               ; [#uses=1 type=i64]
  %104 = cmpxchg ptr %95, i64 %.sroa.06.019.i.i.i.i10, i64 %103 acq_rel acquire, align 8, !noalias !11119 ; [#uses=2 type={ i64, i1 }]
  %.sroa.18.0.in.i.i.i.i.i12 = extractvalue { i64, i1 } %104, 1 ; [#uses=1 type=i1]
  %.sroa.01.0.i.i.i.i.i13 = extractvalue { i64, i1 } %104, 0 ; [#uses=2 type=i64]
...
105:                                              ; preds = %101
  %106 = and i64 %.sroa.01.0.i.i.i.i.i13, 2251799813685244 ; [#uses=1 type=i64]
  %107 = icmp eq i64 %106, 0                      ; [#uses=1 type=i1]
...
108:                                              ; preds = %105
  ...
  %109 = load i64, ptr %84, align 8, !noalias !11119, !noundef !4 ; [#uses=1 type=i64]
  %110 = getelementptr inbounds nuw i8, ptr %94, i64 88 ; [#uses=1 type=ptr]
...
111:                                              ; preds = %105
  %112 = trunc i64 %.sroa.0.018.i.i.i.i11 to i32  ; [#uses=1 type=i32]
  %113 = and i32 %112, 31                         ; [#uses=4 type=i32]
  %.not.i.i.i.i19 = icmp eq i32 %113, 31          ; [#uses=1 type=i1]
  br i1 %.not.i.i.i.i19, label %._crit_edge.i.i.i.i24, label %.lr.ph.preheader.i.i.i.i20

.lr.ph.preheader.i.i.i.i20:                       ; preds = %111
  %114 = shl nuw nsw i32 1, %113                  ; [#uses=2 type=i32]
  %xtraiter42 = and i32 %114, 7                   ; [#uses=2 type=i32]
  %115 = icmp samesign ult i32 %113, 3            ; [#uses=1 type=i1]
...
.lr.ph.preheader.i.i.i.i20.new:                   ; preds = %.lr.ph.preheader.i.i.i.i20
  %unroll_iter46 = and i32 %114, 2147483640       ; [#uses=1 type=i32]
...
.lr.ph.i.i.i.i21.epil.preheader:                  ; preds = %._crit_edge.i.i.i.i24.loopexit.unr-lcssa, %.lr.ph.preheader.i.i.i.i20
  %lcmp.mod45 = icmp samesign ult i32 %113, 3     ; [#uses=1 type=i1]
...
._crit_edge.i.i.i.i24:                            ; preds = %._crit_edge.i.i.i.i24.loopexit.unr-lcssa, %.lr.ph.i.i.i.i21.epil, %111
  %116 = icmp ugt i64 %.sroa.0.018.i.i.i.i11, 7   ; [#uses=1 type=i1]
...
117:                                              ; preds = %._crit_edge.i.i.i.i24
  %118 = add nuw nsw i64 %.sroa.0.018.i.i.i.i11, 1 ; [#uses=1 type=i64]
...
_RNvNtNtCsdNqyU9N9qTX_12sharded_slab4page4slot19exponential_backoff.exit.i.i.i.i14: ; preds = %119, %117, %101
  %.sroa.0.1.i.i.i.i15 = phi i64 [ 0, %101 ], [ %.sroa.0.018.i.i.i.i11, %119 ], [ %118, %117 ] ; [#uses=1 type=i64]
  %.sroa.06.1.i.i.i.i16 = phi i64 [ %.sroa.01.0.i.i.i.i.i13, %101 ], [ %.sroa.06.019.i.i.i.i10, %119 ], [ %.sroa.06.019.i.i.i.i10, %117 ] ; [#uses=2 type=i64]
  %.sroa.02.1.i.i.i.i17 = phi i1 [ %.sroa.02.020.i.i.i.i9, %101 ], [ true, %119 ], [ true, %117 ] ; [#uses=2 type=i1]
  %120 = lshr i64 %.sroa.06.1.i.i.i.i16, 51       ; [#uses=1 type=i64]
  %121 = icmp eq i64 %78, %120                    ; [#uses=1 type=i1]
  %or.cond.not.i.i.i.i18 = or i1 %.sroa.02.1.i.i.i.i17, %121 ; [#uses=1 type=i1]
