...
update_width.exit:                                ; preds = %bb.j, %bb.l, %bb.m
  ...
  %i.bc = load i32, ptr %i.bb, align 8, !tbaa !18 ; 4 uses
  %5 = urem i32 %i.bc, 200
  ...
  %6 = udiv i32 1000000, %i.ar                    ; 4 uses
