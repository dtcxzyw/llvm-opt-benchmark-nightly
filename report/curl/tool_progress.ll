...
bb.w:                                             ; preds = %.thread, %bb.v
  ...
  %5 = getelementptr inbounds nuw i8, ptr %i.cc, i64 8
  %6 = load i64, ptr %5, align 8, !tbaa !40
  %i.cd = sub nsw i64 %.0104.lcssa, %6
  br label %bb.y
...
bb.y:                                             ; preds = %bb.x, %bb.w
  ...
  %7 = fdiv double %i.ch, %i.cj
  %8 = fptosi double %7 to i64
  %9 = sitofp i64 %.059 to double
  %10 = fdiv double %9, %i.cj
  %i.ck = fptosi double %10 to i64
  %i.cl = call i64 @llvm.smax.i64(i64 %8, i64 %i.ck) ; 4 uses
