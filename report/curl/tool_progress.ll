...
bb.x:                                             ; preds = %bb.v
  ...
  %i.ch = load i32, ptr %i.v, align 8
  %i.ci = call i64 @curlx_timediff_ms(i64 %i.n, i32 %i.o, i64 %i.cg, i32 %i.ch) #6
  br label %bb.y
...
bb.y:                                             ; preds = %bb.x, %bb.w
  ...
  %i.ck = sitofp i64 %spec.select to double
  %i.cl = fdiv double %i.ck, 1.000000e+03
  %i.cm = sitofp i64 %.059 to double
  %i.cn = insertelement <2 x double> poison, double %i.cj, i64 0
  %i.co = insertelement <2 x double> %i.cn, double %i.cm, i64 1
  %i.cp = insertelement <2 x double> poison, double %i.cl, i64 0
  ...
  %i.cv = fptosi double %i.cu to i64
  %i.cw = call i64 @llvm.smax.i64(i64 %i.ct, i64 %i.cv) ; 4 uses
  %i.cx = icmp ne i64 %i.cw, 0
  %or.cond7 = select i1 %.064.lcssa, i1 %i.cx, i1 false
  br i1 %or.cond7, label %bb.z, label %bb.aa

bb.z:                                             ; preds = %bb.y
  %i.cy = load i64, ptr @all_dltotal, align 8, !tbaa !27 ; 2 uses
  %i.cz = sdiv i64 %i.cy, %i.cw
  %i.da = sub nsw i64 %i.cy, %.0105.lcssa
  %i.db = sdiv i64 %i.da, %i.cw
  call void @timebuf(ptr noundef nonnull %i.a, i64 noundef 9, i64 noundef %i.db)
  call void @timebuf(ptr noundef nonnull %i.b, i64 noundef 9, i64 noundef %i.cz)
  br label %bb.ab
...
bb.ab:                                            ; preds = %bb.aa, %bb.z
  ...
  %i.dc = call i32 @curl_multi_get_offt(ptr noundef %0, i32 noundef 5, ptr noundef nonnull %i.g) #6 ; 0 uses
  %i.dd = call i32 @curl_multi_get_offt(ptr noundef %0, i32 noundef 2, ptr noundef nonnull %i.h) #6 ; 0 uses
  %i.de = load ptr, ptr @tool_stderr, align 8, !tbaa !34
  %i.df = call ptr @max5data(i64 noundef %.0105.lcssa, ptr noundef nonnull %i.d, i64 noundef 6) ; 0 uses
  %i.dg = getelementptr inbounds nuw i8, ptr %i.d, i64 6 ; 2 uses
  %i.dh = call ptr @max5data(i64 noundef %.0104.lcssa, ptr noundef nonnull %i.dg, i64 noundef 6) ; 0 uses
  %i.di = load i64, ptr %i.g, align 8, !tbaa !27
  %i.dj = load i64, ptr %i.h, align 8, !tbaa !27
  %i.dk = getelementptr inbounds nuw i8, ptr %i.d, i64 12 ; 2 uses
  %i.dl = call ptr @max5data(i64 noundef %i.cw, ptr noundef nonnull %i.dk, i64 noundef 6) ; 0 uses
  %i.dm = select i1 %2, ptr @.str.12, ptr @.str.13
  %i.dn = call i32 (ptr, ptr, ...) @curl_mfprintf(ptr noundef %i.de, ptr noundef nonnull @.str.11, ptr noundef nonnull %i.e, ptr noundef nonnull %i.f, ptr noundef nonnull %i.d, ptr noundef nonnull %i.dg, i64 noundef %i.di, i64 noundef %i.dj, ptr noundef nonnull %i.b, ptr noundef nonnull %i.c, ptr noundef nonnull %i.a, ptr noundef nonnull %i.dk, ptr noundef nonnull %i.dm) #6 ; 0 uses
