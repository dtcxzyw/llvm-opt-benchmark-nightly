...
bb.a:
  ...
  %i.e = load i8, ptr %i.d, align 4, !tbaa !100   ; 3 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 992 ; 6 uses
  %i.g = load i16, ptr %i.f, align 8
  %.tr.i = zext i8 %i.e to i16
  %tr.sh.diff.i = shl nuw nsw i16 %.tr.i, 2       ; 3 uses
  %2 = and i16 %tr.sh.diff.i, 64
  %i.h = and i16 %i.g, -127
  %i.i = or disjoint i16 %2, %i.h
  %3 = shl i8 %i.e, 2
  %i.j = and i8 %3, 4
  %i.k = zext nneg i8 %i.j to i16
  %i.l = or disjoint i16 %i.i, %i.k
  %i.m = lshr i8 %i.e, 5
  %i.n = and i8 %i.m, 2
  %.masked.masked.i = zext nneg i8 %i.n to i16
  %4 = and i16 %tr.sh.diff.i, 56
  %i.o = or disjoint i16 %i.l, %4
  %i.p = or disjoint i16 %i.o, %.masked.masked.i
  store i16 %i.p, ptr %i.f, align 8
  %i.q = tail call zeroext i1 @Curl_peer_equal(ptr noundef %1, ptr noundef %i.c) #7
  %5 = and i16 %tr.sh.diff.i, 128
  %i.r = select i1 %i.q, i16 %5, i16 0
...
bb.j:                                             ; preds = %bb.h, %bb.i
  ...
  %i.ce = load i8, ptr %i.cd, align 4, !tbaa !100 ; 3 uses
  %i.cf = getelementptr inbounds nuw i8, ptr %0, i64 1192 ; 6 uses
  %i.cg = load i16, ptr %i.cf, align 8
  %.tr.i132 = zext i8 %i.ce to i16
  %tr.sh.diff.i133 = shl nuw nsw i16 %.tr.i132, 2 ; 3 uses
  %6 = and i16 %tr.sh.diff.i133, 64
  %i.ch = and i16 %i.cg, -127
  %i.ci = or disjoint i16 %6, %i.ch
  %7 = shl i8 %i.ce, 2
  %i.cj = and i8 %7, 4
  %i.ck = zext nneg i8 %i.cj to i16
  %i.cl = or disjoint i16 %i.ci, %i.ck
  %i.cm = lshr i8 %i.ce, 5
  %i.cn = and i8 %i.cm, 2
  %.masked.masked.i132 = zext nneg i8 %i.cn to i16
  %8 = and i16 %tr.sh.diff.i133, 56
  %i.co = or disjoint i16 %i.cl, %8
  %i.cp = or disjoint i16 %i.co, %.masked.masked.i132
  store i16 %i.cp, ptr %i.cf, align 8
  %i.cq = tail call zeroext i1 @Curl_peer_equal(ptr noundef null, ptr noundef null) #7
  %9 = and i16 %tr.sh.diff.i133, 128
  %i.cr = select i1 %i.cq, i16 %9, i16 0
