begin_hunk_0_@_ZNK5arrow8internal6Bitmap4DiffB5cxx11ERKS1_:bb.a
  ...
  call void %i.ak(ptr noundef nonnull align 8 dereferenceable(16) %i.ac) #14
  %i.al = load ptr, ptr %i.ac, align 8, !tbaa !57
  %i.am = getelementptr inbounds nuw i8, ptr %i.al, i64 24
  %i.an = load ptr, ptr %i.am, align 8
  call void %i.an(ptr noundef nonnull align 8 dereferenceable(16) %i.ac) #14
...
begin_hunk_1_@_ZNK5arrow8internal6Bitmap4DiffB5cxx11ERKS1_:bb.a
  ...
  call void %i.ba(ptr noundef nonnull align 8 dereferenceable(16) %i.as) #14
  %i.bb = load ptr, ptr %i.as, align 8, !tbaa !57
  %i.bc = getelementptr inbounds nuw i8, ptr %i.bb, i64 24
  %i.bd = load ptr, ptr %i.bc, align 8
  call void %i.bd(ptr noundef nonnull align 8 dereferenceable(16) %i.as) #14
...
begin_hunk_2_@_ZNK5arrow8internal6Bitmap4DiffB5cxx11ERKS1_:bb.a
  ...
  call void %i.bq(ptr noundef nonnull align 8 dereferenceable(16) %i.bi) #14
  %i.br = load ptr, ptr %i.bi, align 8, !tbaa !57
  %i.bs = getelementptr inbounds nuw i8, ptr %i.br, i64 24
  %i.bt = load ptr, ptr %i.bs, align 8
  call void %i.bt(ptr noundef nonnull align 8 dereferenceable(16) %i.bi) #14
...
begin_hunk_3_@_ZNK5arrow8internal6Bitmap4DiffB5cxx11ERKS1_:bb.a
  ...
  call void %i.cg(ptr noundef nonnull align 8 dereferenceable(16) %i.by) #14
  %i.ch = load ptr, ptr %i.by, align 8, !tbaa !57
  %i.ci = getelementptr inbounds nuw i8, ptr %i.ch, i64 24
  %i.cj = load ptr, ptr %i.ci, align 8
  call void %i.cj(ptr noundef nonnull align 8 dereferenceable(16) %i.by) #14
...
begin_hunk_4_@_ZNSt12__shared_ptrIN5arrow12BooleanArrayELN9__gnu_cxx12_Lock_policyE2EED2Ev:bb.a
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #14
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !57
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #14
...
begin_hunk_10_@_ZNSt23_Sp_counted_ptr_inplaceIN5arrow6BufferESaIvELN9__gnu_cxx12_Lock_policyE2EE10_M_disposeEv:_ZNSt16allocator_traitsISaIvEE7destroyIN5arrow6BufferEEEvRS0_PT_.exit
  ...
  %i.c = load ptr, ptr %i.b, align 8
  tail call void %i.c(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.a) #14
  ret void
}
...
begin_hunk_12_@_ZN5arrow6BufferC2EPKhl:bb.a
  ...
  store i8 1, ptr %i.b, align 1, !tbaa !92
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 16
  store ptr %1, ptr %i.c, align 8, !tbaa !93
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i64 %2, ptr %i.d, align 8, !tbaa !94
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i64 %2, ptr %i.e, align 8, !tbaa !95
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 2 uses
  store i8 1, ptr %i.f, align 8, !tbaa !96
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = load <2 x ptr>, ptr %3, align 16, !tbaa !97
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %3, i8 0, i64 16, i1 false)
  %i.l = load ptr, ptr %i.j, align 8, !tbaa !61   ; 8 uses
  store <2 x ptr> %i.k, ptr %i.h, align 8, !tbaa !97
...
begin_hunk_14_@_ZN5arrow6BufferC2EPKhl:bb.a
  ...
  call void %i.t(ptr noundef nonnull align 8 dereferenceable(16) %i.l) #14
  %i.u = load ptr, ptr %i.l, align 8, !tbaa !57
  %i.v = getelementptr inbounds nuw i8, ptr %i.u, i64 24
  %i.w = load ptr, ptr %i.v, align 8
  call void %i.w(ptr noundef nonnull align 8 dereferenceable(16) %i.l) #14
...
_ZNSt10shared_ptrIN5arrow13MemoryManagerEEaSEOS2_.exit.i: ; preds = %bb.h, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i, %bb.d, %bb.b
  ...
  %i.ad = load ptr, ptr %i.ac, align 8, !tbaa !99 ; 3 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 24
  %i.af = load i8, ptr %i.ae, align 8, !tbaa !102, !range !108, !noundef !109
  store i8 %i.af, ptr %i.b, align 1, !tbaa !92
...
bb.i:                                             ; preds = %_ZNSt10shared_ptrIN5arrow13MemoryManagerEEaSEOS2_.exit.i
  store i8 %i.aj, ptr %i.f, align 8, !tbaa !96
...
begin_hunk_17_@_ZN5arrow6BufferC2EPKhl:bb.a
  ...
  call void %i.as(ptr noundef nonnull align 8 dereferenceable(16) %i.ak) #14
  %i.at = load ptr, ptr %i.ak, align 8, !tbaa !57
  %i.au = getelementptr inbounds nuw i8, ptr %i.at, i64 24
  %i.av = load ptr, ptr %i.au, align 8
  call void %i.av(ptr noundef nonnull align 8 dereferenceable(16) %i.ak) #14
...
begin_hunk_20_@_ZN5arrow6BufferD2Ev:bb.a
  ...
  tail call void %i.aa(ptr noundef nonnull align 8 dereferenceable(16) %i.s) #14
  %i.ab = load ptr, ptr %i.s, align 8, !tbaa !57
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 24
  %i.ad = load ptr, ptr %i.ac, align 8
  tail call void %i.ad(ptr noundef nonnull align 8 dereferenceable(16) %i.s) #14
  br label %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit
...
bb.a:
  ...
  %i.a = tail call noalias noundef nonnull dereferenceable(56) ptr @_Znwm(i64 noundef 56) #13, !noalias !110 ; 6 uses
...
begin_hunk_22_@_ZNSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EEC2IN5arrow12BooleanArrayESaIvEJRKlRSt10shared_ptrINS4_6BufferEEDniS8_EEERPT_St20_Sp_alloc_shared_tagIT0_EDpOT1_:bb.a
  ...
  call void %i.r(ptr noundef nonnull align 8 dereferenceable(16) %i.j) #14
  %i.s = load ptr, ptr %i.j, align 8, !tbaa !57
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 24
  %i.u = load ptr, ptr %i.t, align 8
  call void %i.u(ptr noundef nonnull align 8 dereferenceable(16) %i.j) #14
...
_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow12BooleanArrayESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit: ; preds = %bb.b, %bb.d, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i, %bb.h
  ...
  store ptr %i.d, ptr %1, align 8, !tbaa !113
  ret void
}
...
begin_hunk_24_@_ZNSt23_Sp_counted_ptr_inplaceIN5arrow12BooleanArrayESaIvELN9__gnu_cxx12_Lock_policyE2EE10_M_disposeEv:_ZNSt16allocator_traitsISaIvEE7destroyIN5arrow12BooleanArrayEEEvRS0_PT_.exit
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !57
  %i.c = load ptr, ptr %i.b, align 8
  tail call void %i.c(ptr noundef nonnull align 8 dereferenceable(40) %i.a) #14
  ret void
}
...
!80 = !{!34, !35, i64 8}
!81 = !{!82, !35, i64 8}
!82 = !{!"_ZTSSt9type_info", !35, i64 8}
!83 = !{!84, !85, i64 8}
!84 = !{!"_ZTSN5arrow6BufferE", !85, i64 8, !85, i64 9, !35, i64 16, !28, i64 24, !28, i64 32, !86, i64 40, !87, i64 48, !89, i64 64}
!85 = !{!"bool", !5, i64 0}
!86 = !{!"_ZTSN5arrow20DeviceAllocationTypeE", !5, i64 0}
!87 = !{!"_ZTSSt10shared_ptrIN5arrow6BufferEE", !88, i64 0}
!88 = !{!"_ZTSSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EE", !65, i64 0, !62, i64 8}
!89 = !{!"_ZTSSt10shared_ptrIN5arrow13MemoryManagerEE", !90, i64 0}
!90 = !{!"_ZTSSt12__shared_ptrIN5arrow13MemoryManagerELN9__gnu_cxx12_Lock_policyE2EE", !91, i64 0, !62, i64 8}
!91 = !{!"p1 _ZTSN5arrow13MemoryManagerE", !36, i64 0}
!92 = !{!84, !85, i64 9}
!93 = !{!84, !35, i64 16}
!94 = !{!84, !28, i64 24}
!95 = !{!84, !28, i64 32}
...
!98 = !{!90, !91, i64 0}
!99 = !{!100, !101, i64 0}
!100 = !{!"_ZTSSt12__shared_ptrIN5arrow6DeviceELN9__gnu_cxx12_Lock_policyE2EE", !101, i64 0, !62, i64 8}
!101 = !{!"p1 _ZTSN5arrow6DeviceE", !36, i64 0}
!102 = !{!103, !85, i64 24}
!103 = !{!"_ZTSN5arrow6DeviceE", !104, i64 8, !85, i64 24}
!104 = !{!"_ZTSSt23enable_shared_from_thisIN5arrow6DeviceEE", !105, i64 0}
!105 = !{!"_ZTSSt8weak_ptrIN5arrow6DeviceEE", !106, i64 0}
!106 = !{!"_ZTSSt10__weak_ptrIN5arrow6DeviceELN9__gnu_cxx12_Lock_policyE2EE", !101, i64 0, !107, i64 8}
!107 = !{!"_ZTSSt12__weak_countILN9__gnu_cxx12_Lock_policyE2EE", !63, i64 0}
!108 = !{i8 0, i8 2}
!109 = !{}
!110 = !{!111}
!111 = distinct !{!111, !112, !"_ZSt18__allocate_guardedISaISt23_Sp_counted_ptr_inplaceIN5arrow12BooleanArrayESaIvELN9__gnu_cxx12_Lock_policyE2EEEESt15__allocated_ptrIT_ERS9_: argument 0"}
!112 = distinct !{!112, !"_ZSt18__allocate_guardedISaISt23_Sp_counted_ptr_inplaceIN5arrow12BooleanArrayESaIvELN9__gnu_cxx12_Lock_policyE2EEEESt15__allocated_ptrIT_ERS9_"}
!113 = !{!76, !76, i64 0}
end_hunk_26
