...
bb.f:                                             ; preds = %.lr.ph, %bb.e
  ...
  %i.ag = getelementptr inbounds nuw [48 x i8], ptr %i.af, i64 %.0913 ; 3 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.ag) ]
  %i.ah = load ptr, ptr %1, align 8, !tbaa !70
  %i.ai = getelementptr inbounds nuw [48 x i8], ptr %i.ah, i64 %.0913 ; 3 uses
...
_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc.exit: ; preds = %bb.a
  %i.c = load ptr, ptr %1, align 8, !tbaa !59     ; 4 uses
