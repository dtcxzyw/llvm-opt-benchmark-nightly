...
bb.c:                                             ; preds = %bb.a, %bb.c
  ...
  %.013 = phi i64 [ 0, %bb.a ], [ %i.q, %bb.c ]   ; 2 uses
...
begin_hunk_1_@_mi_os_random_weak:bb.a
  ...
  %i.o = lshr i64 %i.n, 31
  %i.p = xor i64 %i.o, %i.n
  %i.q = add nuw i64 %.013, 1
  %i.r = add i64 %i.p, 1                          ; 3 uses
  %1 = icmp ult i64 %.013, %i.f
...
bb.d:                                             ; preds = %bb.d, %.critedge
  ...
  %.013.i = phi i64 [ 0, %.critedge ], [ %i.r, %bb.d ] ; 2 uses
...
begin_hunk_3_@mi_random_init_ex:bb.a
  ...
  %i.p = lshr i64 %i.o, 31
  %i.q = xor i64 %i.p, %i.o
  %i.r = add nuw i64 %.013.i, 1
  %i.s = add i64 %i.q, 1                          ; 4 uses
  %2 = icmp ult i64 %.013.i, %i.g
