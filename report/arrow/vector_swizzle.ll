inline.NumInlined: 30535
inline.NumDeleted: 3684
begin_hunk_0_@_ZN5arrow7compute8internal21RegisterVectorSwizzleEPNS0_16FunctionRegistryE:bb.a
...
begin_hunk_1_@_ZN5arrow7compute8internal21RegisterVectorSwizzleEPNS0_16FunctionRegistryE:bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i.i.i, ptr noundef nonnull align 8 dereferenceable(32) %6, i64 16, i1 false), !tbaa.struct !141
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %6, ptr noundef nonnull align 16 dereferenceable(32) %i.ao, i64 16, i1 false), !tbaa.struct !141
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %i.ao, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i.i.i, i64 16, i1 false), !tbaa.struct !141
