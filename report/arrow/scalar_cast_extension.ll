...
begin_hunk_0_@_ZN5arrow7compute8internal17GetExtensionCastsEv:._crit_edge.i.i
  ...
  %5 = alloca %"class.std::vector.25", align 8    ; 11 uses
...
_ZNSt12_Vector_baseIN5arrow7compute9InputTypeESaIS2_EED2Ev.exit.i.i: ; preds = %bb.e
  %i.be = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %11 = load ptr, ptr %5, align 8, !tbaa !69, !noalias !40 ; 3 uses
  %.not.i.i4.i.i = icmp eq ptr %11, null
  br i1 %.not.i.i4.i.i, label %.body.i, label %12

12:                                               ; preds = %_ZNSt12_Vector_baseIN5arrow7compute9InputTypeESaIS2_EED2Ev.exit.i.i
  %13 = load ptr, ptr %i.n, align 8, !tbaa !72, !noalias !40
  %14 = ptrtoint ptr %13 to i64
  %15 = ptrtoint ptr %11 to i64
  %16 = sub i64 %14, %15
  call void @_ZdlPvm(ptr noundef nonnull %11, i64 noundef %16) #21
  br label %.body.i
...
.body.i:                                          ; preds = %bb.ap, %12, %_ZNSt12_Vector_baseIN5arrow7compute9InputTypeESaIS2_EED2Ev.exit.i.i
  %.pn.pn.i = phi { ptr, i32 } [ %.pn.i, %bb.ap ], [ %i.be, %_ZNSt12_Vector_baseIN5arrow7compute9InputTypeESaIS2_EED2Ev.exit.i.i ], [ %i.be, %12 ]
...
_ZNSt10shared_ptrIN5arrow7compute8internal12CastFunctionEEC2ERKS4_.exit: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %bb.au, %bb.av
  ...
  %i.ep = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #22
          to label %.noexc12 unwind label %_ZNSt12_Vector_baseISt10shared_ptrIN5arrow7compute8internal12CastFunctionEESaIS5_EED2Ev.exit.i ; 3 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit22: ; preds = %.body, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i20, %_ZNSt12_Vector_baseISt10shared_ptrIN5arrow7compute8internal12CastFunctionEESaIS5_EED2Ev.exit.i
  %.pn4 = phi { ptr, i32 } [ %17, %_ZNSt12_Vector_baseISt10shared_ptrIN5arrow7compute8internal12CastFunctionEESaIS5_EED2Ev.exit.i ], [ %eh.lpad-body, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i20 ], [ %eh.lpad-body, %.body ]
...
bb.a:
  ...
  %i.g = load ptr, ptr %0, align 8, !tbaa !100
...
5:                                                ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit
  %6 = load ptr, ptr %0, align 8, !tbaa !100      ; 2 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit26: ; preds = %bb.m, %bb.l, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE7_S_copyEPcPKcm.exit
  ...
  %.pre = load ptr, ptr %0, align 8, !tbaa !100   ; 3 uses
