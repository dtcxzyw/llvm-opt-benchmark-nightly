...
bb.b:                                             ; preds = %bb.a
  ...
  %6 = icmp ult i8 %1, 100
  %i.d = select i1 %6, i64 2, i64 3
  %i.e = select i1 %i.c, i64 1, i64 %i.d          ; 2 uses
  %7 = icmp ugt i8 %1, 99
  br i1 %7, label %._crit_edge.i.i.thread.i.i, label %._crit_edge.i.i.i.i
...
begin_hunk_2_@_ZZN5arrow8internal12_GLOBAL__N_115IntegersInRangeINS_9UInt8TypeEhEENS_6StatusERKNS_9ArraySpanET0_S8_ENKUlhE0_clEh:bb.a
  ...
  %i.aa = load i8, ptr %.0.val, align 1, !tbaa !7 ; 9 uses
...
bb.e:                                             ; preds = %_ZN5arrow8internal7ToCharsIhJEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEET_DpOT0_.exit
  ...
  %8 = icmp ult i8 %i.aa, 100
  %i.ae = select i1 %8, i64 2, i64 3
  %i.af = select i1 %i.ad, i64 1, i64 %i.ae       ; 2 uses
  %9 = icmp ugt i8 %i.aa, 99
  br i1 %9, label %._crit_edge.i.i.thread.i.i11, label %._crit_edge.i.i.i.i7
...
begin_hunk_4_@_ZZN5arrow8internal12_GLOBAL__N_115IntegersInRangeINS_9UInt8TypeEhEENS_6StatusERKNS_9ArraySpanET0_S8_ENKUlhE0_clEh:bb.a
  ...
  %i.bb = load i8, ptr %.8.val, align 1, !tbaa !7 ; 9 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  %10 = icmp ult i8 %i.bb, 100
  %i.bf = select i1 %10, i64 2, i64 3
  %i.bg = select i1 %i.be, i64 1, i64 %i.bf       ; 2 uses
  %11 = icmp ugt i8 %i.bb, 99
  br i1 %11, label %._crit_edge.i.i.thread.i.i17, label %._crit_edge.i.i.i.i13
