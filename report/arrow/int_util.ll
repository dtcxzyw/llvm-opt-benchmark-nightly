...
vector.body69:                                    ; preds = %vector.body69, %vector.ph62
  ...
  %i.ad = shl nuw i64 %index70, 3                 ; 32 uses
  ...
  %i.hu = insertelement <16 x i8> %i.ht, i8 %i.he, i64 15 ; 2 uses
  %i.hv = load i8, ptr %i.fz, align 1, !tbaa !7, !noalias !542
end_hunk_0
...
vec.epilog.vector.body90:                         ; preds = %vec.epilog.vector.body90, %vec.epilog.ph83
  ...
  %i.aho = shl nuw i64 %index91, 3                ; 8 uses
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %i.aqv = getelementptr inbounds nuw i8, ptr %.088173.i, i64 %.082.lcssa.i
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.aqw = getelementptr inbounds nuw i8, ptr %i.aqv, i64 %index ; 2 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %i.arl = getelementptr inbounds nuw i8, ptr %.088173.i, i64 %.082.lcssa.i
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.arm = getelementptr inbounds nuw i8, ptr %i.arl, i64 %index52
...
end_hunk_1
begin_hunk_2_@_ZN5arrow8internal12_GLOBAL__N_124CheckIntegersInRangeImplINS_8Int8TypeEEENS_6StatusERKNS_9ArraySpanERKNS_6ScalarESA_:bb.a
...
vector.body69:                                    ; preds = %vector.body69, %vector.ph62
  ...
  %i.ad = shl nuw i64 %index70, 3                 ; 16 uses
  ...
  %i.hp = getelementptr inbounds nuw i8, ptr %i.ax, i64 166
  %i.hq = getelementptr inbounds nuw i8, ptr %i.az, i64 182
  %i.hr = getelementptr inbounds nuw i8, ptr %i.bb, i64 198
  %i.hs = getelementptr inbounds nuw i8, ptr %i.bd, i64 214
  %i.ht = getelementptr inbounds nuw i8, ptr %i.bf, i64 230
  %i.hu = getelementptr inbounds nuw i8, ptr %i.bh, i64 246
  %i.hv = load i16, ptr %i.hf, align 2, !tbaa !16, !noalias !564
end_hunk_2
begin_hunk_3_@_ZN5arrow8internal12_GLOBAL__N_124CheckIntegersInRangeImplINS_9Int16TypeEEENS_6StatusERKNS_9ArraySpanERKNS_6ScalarESA_:bb.a
...
vec.epilog.vector.body90:                         ; preds = %vec.epilog.vector.body90, %vec.epilog.ph83
  ...
  %i.se = shl nuw i64 %index91, 3                 ; 4 uses
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %i.xp = getelementptr inbounds nuw [2 x i8], ptr %.088173.i, i64 %.082.lcssa.i
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.xq = getelementptr inbounds nuw [2 x i8], ptr %i.xp, i64 %index ; 2 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %i.yf = getelementptr inbounds nuw [2 x i8], ptr %.088173.i, i64 %.082.lcssa.i
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index52 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next55, %vec.epilog.vector.body ] ; 2 uses
  %vec.phi53 = phi <4 x i1> [ %i.ye, %vec.epilog.ph ], [ %i.yk, %vec.epilog.vector.body ]
  %i.yg = getelementptr inbounds nuw [2 x i8], ptr %i.yf, i64 %index52
...
end_hunk_3
begin_hunk_4_@_ZN5arrow8internal12_GLOBAL__N_124CheckIntegersInRangeImplINS_9Int16TypeEEENS_6StatusERKNS_9ArraySpanERKNS_6ScalarESA_:bb.a
...
vector.body54:                                    ; preds = %vector.body54, %vector.ph47
  ...
  %i.ad = shl nuw i64 %index55, 3                 ; 8 uses
...
vector.ph:                                        ; preds = %_ZZN5arrow8internal12_GLOBAL__N_115IntegersInRangeINS_9Int32TypeEiEENS_6StatusERKNS_9ArraySpanET0_S8_ENKUliE_clEi.exit119.i.preheader
  ...
  %i.kq = getelementptr inbounds nuw [4 x i8], ptr %.088173.i, i64 %.082.lcssa.i
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.kr = getelementptr inbounds nuw [4 x i8], ptr %i.kq, i64 %index ; 2 uses
...
end_hunk_4
begin_hunk_5_@_ZN5arrow8internal12_GLOBAL__N_124CheckIntegersInRangeImplINS_9Int32TypeEEENS_6StatusERKNS_9ArraySpanERKNS_6ScalarESA_:bb.a
...
vector.body54:                                    ; preds = %vector.body54, %vector.ph47
  ...
  %i.ad = shl nuw i64 %index55, 3                 ; 4 uses
...
vector.ph:                                        ; preds = %_ZZN5arrow8internal12_GLOBAL__N_115IntegersInRangeINS_9Int64TypeElEENS_6StatusERKNS_9ArraySpanET0_S8_ENKUllE_clEl.exit119.i.preheader
  ...
  %i.gu = getelementptr inbounds nuw [8 x i8], ptr %.088173.i, i64 %.082.lcssa.i
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.gv = getelementptr inbounds nuw [8 x i8], ptr %i.gu, i64 %index ; 2 uses
...
end_hunk_5
begin_hunk_6_@_ZN5arrow8internal12_GLOBAL__N_124CheckIntegersInRangeImplINS_9Int64TypeEEENS_6StatusERKNS_9ArraySpanERKNS_6ScalarESA_:bb.a
  %i.ne = and i8 %i.nd, 7
...
vector.body69:                                    ; preds = %vector.body69, %vector.ph62
  ...
  %i.ht = insertelement <16 x i8> %i.hs, i8 %i.hd, i64 14
  %i.hu = insertelement <16 x i8> %i.ht, i8 %i.he, i64 15 ; 2 uses
  %i.hv = load i8, ptr %i.fz, align 1, !tbaa !7, !noalias !620
end_hunk_6
begin_hunk_7_@_ZN5arrow8internal12_GLOBAL__N_124CheckIntegersInRangeImplINS_9UInt8TypeEEENS_6StatusERKNS_9ArraySpanERKNS_6ScalarESA_:bb.a
...
.preheader133.i:                                  ; preds = %.preheader133.i, %.preheader133.preheader.i
  ...
  %op.rdx99 = or i1 %i.awr, %.3146.i              ; 2 uses
end_hunk_7
begin_hunk_8_@_ZN5arrow8internal12_GLOBAL__N_124CheckIntegersInRangeImplINS_9UInt8TypeEEENS_6StatusERKNS_9ArraySpanERKNS_6ScalarESA_:bb.a
  %i.axq = and i8 %i.axp, 7
  %i.axr = lshr i8 %i.axo, %i.axq
  %i.axs = trunc i8 %i.axr to i1
...
vector.body69:                                    ; preds = %vector.body69, %vector.ph62
  ...
  %i.ht = getelementptr inbounds nuw i8, ptr %i.bf, i64 230
  %i.hu = getelementptr inbounds nuw i8, ptr %i.bh, i64 246
  %i.hv = load i16, ptr %i.hf, align 2, !tbaa !16, !noalias !640
end_hunk_8
begin_hunk_9_@_ZN5arrow8internal12_GLOBAL__N_124CheckIntegersInRangeImplINS_10UInt16TypeEEENS_6StatusERKNS_9ArraySpanERKNS_6ScalarESA_:bb.a
...
vec.epilog.vector.body90:                         ; preds = %vec.epilog.vector.body90, %vec.epilog.ph83
  ...
  %i.se = shl nuw i64 %index91, 3                 ; 8 uses
  %i.sf = getelementptr inbounds nuw [2 x i8], ptr %.088173.i, i64 %i.se ; 8 uses
  %i.sg = getelementptr inbounds nuw [2 x i8], ptr %.088173.i, i64 %i.se ; 8 uses
  %i.sh = getelementptr inbounds nuw i8, ptr %i.sg, i64 16
  %i.si = getelementptr inbounds nuw [2 x i8], ptr %.088173.i, i64 %i.se ; 8 uses
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %i.abl = getelementptr inbounds nuw [2 x i8], ptr %.088173.i, i64 %.082.lcssa.i
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.abm = getelementptr inbounds nuw [2 x i8], ptr %i.abl, i64 %index ; 2 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %i.acb = getelementptr inbounds nuw [2 x i8], ptr %.088173.i, i64 %.082.lcssa.i
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index52 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next55, %vec.epilog.vector.body ] ; 2 uses
  %vec.phi53 = phi <4 x i1> [ %i.aca, %vec.epilog.ph ], [ %i.acg, %vec.epilog.vector.body ]
  %i.acc = getelementptr inbounds nuw [2 x i8], ptr %i.acb, i64 %index52
...
end_hunk_9
begin_hunk_10_@_ZN5arrow8internal12_GLOBAL__N_124CheckIntegersInRangeImplINS_10UInt16TypeEEENS_6StatusERKNS_9ArraySpanERKNS_6ScalarESA_:bb.a
...
.preheader133.i:                                  ; preds = %.preheader133.i, %.preheader133.preheader.i
  ...
  %i.pv = insertelement <8 x i1> %i.pu, i1 %i.pj, i64 4
end_hunk_10
begin_hunk_11_@_ZN5arrow8internal12_GLOBAL__N_124CheckIntegersInRangeImplINS_10UInt32TypeEEENS_6StatusERKNS_9ArraySpanERKNS_6ScalarESA_:bb.a
  %i.qq = select i1 %i.qn, i1 %spec.select130.i, i1 false
  %i.qr = or i1 %.5150.i, %i.qq
  %i.qs = add nuw nsw i64 %.2151.i, 1             ; 2 uses
  %i.qt = getelementptr inbounds nuw [4 x i8], ptr %.088173.i, i64 %i.qs
...
vector.ph:                                        ; preds = %_ZZN5arrow8internal12_GLOBAL__N_115IntegersInRangeINS_10UInt64TypeEmEENS_6StatusERKNS_9ArraySpanET0_S8_ENKUlmE_clEm.exit119.i.preheader
  ...
  %i.ae = getelementptr inbounds nuw [8 x i8], ptr %.088173.i, i64 %.082.lcssa.i
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.af = getelementptr inbounds nuw [8 x i8], ptr %i.ae, i64 %index ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 16
