...
.lr.ph:                                           ; preds = %bb.b, %_ZN5arrow8internalL17ExpandedUIntWidthEmh.exit
  ...
  %i.d = load <16 x i64>, ptr %.06789, align 8, !tbaa !148
  ...
  br i1 %.not.i, label %bb.c, label %_ZN5arrow8internalL17ExpandedUIntWidthEmh.exit, !prof !149
...
bb.f:                                             ; preds = %_ZN5arrow8internalL17ExpandedUIntWidthEmh.exit.thread
  %i.q = load <8 x i64>, ptr %.168, align 8, !tbaa !148
  ...
  %i.v = load i64, ptr %i.u, align 8, !tbaa !148
  %.not.i73 = icmp ugt i64 %i.s, %i.v
  br i1 %.not.i73, label %bb.g, label %_ZN5arrow8internalL17ExpandedUIntWidthEmh.exit79, !prof !149
...
.lr.ph97:                                         ; preds = %_ZN5arrow8internalL17ExpandedUIntWidthEmh.exit79, %_ZN5arrow8internalL17ExpandedUIntWidthEmh.exit86
  ...
  %i.ae = load i64, ptr %.37095, align 8, !tbaa !148 ; 4 uses
  ...
  br i1 %.not.i80, label %bb.j, label %_ZN5arrow8internalL17ExpandedUIntWidthEmh.exit86, !prof !149
...
_ZN5arrow8internalL17ExpandedUIntWidthEmh.exit86: ; preds = %.lr.ph97, %bb.j, %bb.k, %bb.l
  ...
  br i1 %i.ao, label %.lr.ph97, label %.loopexit, !llvm.loop !327
...
.lr.ph:                                           ; preds = %bb.d, %_ZN5arrow8internalL17ExpandedUIntWidthEmh.exit
  ...
  %i.f = load <8 x i64>, ptr %.05380, align 8, !tbaa !148
  %i.g = load <8 x i8>, ptr %.05281, align 1, !tbaa !142
  ...
  br i1 %.not.i, label %bb.e, label %_ZN5arrow8internalL17ExpandedUIntWidthEmh.exit, !prof !149
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <2 x i64>, ptr %next.gep107, align 8, !tbaa !148
  %wide.load108 = load <2 x i64>, ptr %i.ah, align 8, !tbaa !148
  %i.ai = getelementptr i8, ptr %next.gep, i64 2
  %wide.load109 = load <2 x i8>, ptr %next.gep, align 1, !tbaa !142
  %wide.load110 = load <2 x i8>, ptr %i.ai, align 1, !tbaa !142
  ...
  br i1 %i.ap, label %middle.block, label %vector.body, !llvm.loop !328
...
.lr.ph91:                                         ; preds = %.lr.ph91.preheader112, %.lr.ph91
  ...
  %i.ar = load i64, ptr %.25588, align 8, !tbaa !148
  %i.as = load i8, ptr %.289, align 1, !tbaa !142
  ...
  br i1 %i.ax, label %.lr.ph91, label %._crit_edge, !llvm.loop !329
...
._crit_edge:                                      ; preds = %.lr.ph91, %middle.block
  ...
  %i.ba = load i64, ptr %i.az, align 8, !tbaa !148
  %.not.i70 = icmp ugt i64 %.lcssa, %i.ba
  br i1 %.not.i70, label %bb.h, label %_ZN5arrow8internalL17ExpandedUIntWidthEmh.exit76, !prof !152
...
bb.c:                                             ; preds = %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_1clEmm.exit"
  %i.d = load <4 x i64>, ptr %.047, align 8, !tbaa !148
  ...
  br i1 %.not.i, label %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_1clEmm.exit", label %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_1clEmm.exit27.preheader", !prof !153, !llvm.loop !330
...
bb.d:                                             ; preds = %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_0clEmm.exit"
  ...
  %i.j = load i64, ptr %.148, align 8, !tbaa !148
  %i.k = add i64 %i.j, 128
  %.not.i24 = icmp ult i64 %i.k, 256
  br i1 %.not.i24, label %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_0clEmm.exit", label %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_1clEmm.exit27.preheader", !prof !153, !llvm.loop !331
...
bb.e:                                             ; preds = %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_1clEmm.exit27"
  %i.m = load <4 x i64>, ptr %.3, align 8, !tbaa !148
  ...
  br i1 %.not.i25, label %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_1clEmm.exit27", label %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_1clEmm.exit32.preheader", !prof !153, !llvm.loop !332
...
bb.f:                                             ; preds = %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_0clEmm.exit29"
  ...
  %i.s = load i64, ptr %.4, align 8, !tbaa !148
  %i.t = add i64 %i.s, 32768
  %.not.i28 = icmp ult i64 %i.t, 65536
  br i1 %.not.i28, label %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_0clEmm.exit29", label %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_1clEmm.exit32.preheader", !prof !153, !llvm.loop !333
...
bb.g:                                             ; preds = %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_1clEmm.exit32"
  %i.v = load <4 x i64>, ptr %.6, align 8, !tbaa !148
  ...
  br i1 %.not.i30, label %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_1clEmm.exit32", label %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_1clEmm.exit32.thread", !prof !153, !llvm.loop !334
...
bb.h:                                             ; preds = %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_0clEmm.exit34"
  ...
  %i.ab = load i64, ptr %.7, align 8, !tbaa !148
  %i.ac = add i64 %i.ab, 2147483648
  %.not.i33 = icmp ult i64 %i.ac, 4294967296
  br i1 %.not.i33, label %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_0clEmm.exit34", label %"_ZZN5arrow8internal14DetectIntWidthEPKllhENK3$_1clEmm.exit32.thread", !prof !153, !llvm.loop !335
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #22, !inline_history !133
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !234
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #22, !inline_history !133
  br label %_ZNSt12__shared_ptrIN5arrow8DataTypeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i

bb.d:                                             ; preds = %bb.b
  %i.n = load i8, ptr @__libc_single_threaded, align 1, !tbaa !142
  %.not.i.i.i.i = icmp eq i8 %i.n, 0
  br i1 %.not.i.i.i.i, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.o = add nsw i32 %i.f, -1
  store i32 %i.o, ptr %i.c, align 8, !tbaa !141
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i: ; preds = %bb.f, %bb.e
  ...
  br i1 %i.q, label %bb.g, label %_ZNSt12__shared_ptrIN5arrow8DataTypeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i, !prof !149

bb.g:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i
  tail call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #22, !inline_history !238
  br label %_ZNSt12__shared_ptrIN5arrow8DataTypeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i
...
_ZNSt12__shared_ptrIN5arrow8DataTypeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i: ; preds = %bb.g, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i, %bb.c, %bb.a
  ...
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !239  ; 4 uses
...
bb.h:                                             ; preds = %_ZNSt12__shared_ptrIN5arrow8DataTypeELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i
  ...
  %i.u = load i8, ptr @__libc_single_threaded, align 1, !tbaa !142
  %.not.i.i.i.i.i = icmp eq i8 %i.u, 0
  br i1 %.not.i.i.i.i.i, label %bb.j, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.v = load i32, ptr %i.t, align 4, !tbaa !141  ; 2 uses
...
bb.k:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i
  %i.z = load ptr, ptr %i.s, align 8, !tbaa !234
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 24
  %i.ab = load ptr, ptr %i.aa, align 8
  tail call void %i.ab(ptr noundef nonnull align 8 dereferenceable(16) %i.s) #22, !inline_history !134
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #22, !noalias !1554
  call void @_ZN5arrow8internal19StringStreamWrapperC1Ev(ptr noundef nonnull align 8 dereferenceable(16) %3), !noalias !1554
  %i.a = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !254, !noalias !1554, !nonnull !240, !align !244
  %i.c = call noundef i64 @strlen(ptr noundef nonnull align 1 dereferenceable(25) %2) #22, !noalias !1554
  %i.d = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.b, ptr noundef nonnull align 1 dereferenceable(25) %2, i64 noundef %i.c)
          to label %_ZZN5arrow8internal12JoinToStringIJRA25_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS4_EEDaSF_.exit.i unwind label %bb.b, !noalias !1554 ; 0 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #22, !noalias !1554
...
bb.e:                                             ; preds = %_ZN5arrow8internal12JoinToStringIJRA25_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_.exit
  %i.g = load ptr, ptr %4, align 8, !tbaa !196    ; 2 uses
  %i.h = getelementptr inbounds nuw i8, ptr %4, i64 16 ; 2 uses
  %i.i = icmp eq ptr %i.g, %i.h
  br i1 %i.i, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.e
  %i.j = load i64, ptr %i.h, align 8, !tbaa !142
  %i.k = add i64 %i.j, 1
...
bb.f:                                             ; preds = %_ZN5arrow8internal12JoinToStringIJRA25_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_.exit
  %i.l = landingpad { ptr, i32 }
          cleanup
  %i.m = load ptr, ptr %4, align 8, !tbaa !196    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i3: ; preds = %bb.f
  %i.p = load i64, ptr %i.n, align 8, !tbaa !142
  %i.q = add i64 %i.p, 1
...
!98 = distinct !{!98, !144}
!99 = distinct !{!99, !144}
!100 = distinct !{!100, !144}
!101 = distinct !{!101, !144}
!102 = distinct !{!102, !144}
!103 = distinct !{!103, !144}
!104 = distinct !{!104, !144}
!105 = distinct !{!105, !144}
!106 = distinct !{!106, !144}
!107 = distinct !{!107, !144}
!108 = distinct !{!108, !144}
!109 = distinct !{!109, !144}
!110 = distinct !{!110, !144}
!111 = distinct !{!111, !144}
!112 = distinct !{!112, !144}
!113 = distinct !{!113, !144}
!114 = distinct !{!114, !144}
!115 = distinct !{!115, !144}
!116 = distinct !{!116, !144}
!117 = distinct !{!117, !144}
!118 = distinct !{!118, !144}
!119 = distinct !{!119, !144}
!120 = distinct !{!120, !144}
!121 = distinct !{!121, !144}
!122 = distinct !{!122, !144}
!123 = distinct !{!123, !144}
!124 = distinct !{!124, !144}
!125 = distinct !{!125, !144}
!126 = distinct !{!126, !144}
!127 = distinct !{!127, !144}
!128 = distinct !{!128, !144}
!129 = distinct !{!129, !144}
!130 = distinct !{!130, !144}
!131 = distinct !{!131, !144}
!132 = distinct !{!132, !144}
!133 = distinct !{ptr @_ZN5arrow6ScalarD2Ev, null, null, null}
!134 = distinct !{ptr @_ZN5arrow6ScalarD2Ev, null, null, null, null}
!135 = !{i32 8, !"PIC Level", i32 2}
!136 = !{i32 7, !"uwtable", i32 2}
!137 = !{!"Ubuntu clang version 23.0.0 (++20260326081736+e69c7312f31b-1~exp1~20260326081905.1542)"}
!138 = !{!"Simple C++ TBAA"}
!139 = !{!"omnipotent char", !138, i64 0}
!140 = !{!"int", !139, i64 0}
!141 = !{!140, !140, i64 0}
!142 = !{!139, !139, i64 0}
...
!154 = !{!"any pointer", !139, i64 0}
!155 = !{!"p1 omnipotent char", !154, i64 0}
!156 = !{!"p1 int", !154, i64 0}
!157 = !{!"p1 _ZTSN5arrow8DataTypeE", !154, i64 0}
!158 = !{!"_ZTSN5arrow8internal12_GLOBAL__N_116TransposeIntsSrcE", !155, i64 0, !155, i64 8, !147, i64 16, !147, i64 24, !147, i64 32, !156, i64 40, !157, i64 48}
!159 = !{!158, !155, i64 0}
!160 = !{!158, !155, i64 8}
!161 = !{!158, !147, i64 16}
!162 = !{!158, !147, i64 24}
