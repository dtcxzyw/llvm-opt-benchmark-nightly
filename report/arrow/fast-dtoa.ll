...
bb.e:                                             ; preds = %_ZNK14arrow_vendored17double_conversion6Single20NormalizedBoundariesEPNS0_5DiyFpES3_.exit.i, %_ZNK14arrow_vendored17double_conversion6Double20NormalizedBoundariesEPNS0_5DiyFpES3_.exit.i
  ...
  %i.br = lshr i64 %i.bq, 32                      ; 5 uses
  %i.bs = and i64 %i.bq, 4294967295               ; 5 uses
  ...
  %9 = lshr i64 %.sroa.073.0.i, 32                ; 2 uses
  %10 = insertelement <2 x i64> poison, i64 %.sroa.073.0.i, i64 0
  %11 = insertelement <2 x i64> %10, i64 %i.bk, i64 1
  %12 = and <2 x i64> %11, splat (i64 4294967295) ; 2 uses
  %i.ck = mul nuw i64 %i.br, %i.cj
  %13 = mul nuw i64 %i.br, %9
  %14 = insertelement <2 x i64> poison, i64 %i.br, i64 0
  %15 = shufflevector <2 x i64> %14, <2 x i64> poison, <2 x i32> zeroinitializer
  %16 = mul nuw <2 x i64> %15, %12                ; 2 uses
  %17 = mul nuw i64 %i.bs, %i.cj                  ; 2 uses
  %18 = mul nuw i64 %i.bs, %9                     ; 2 uses
  %19 = insertelement <2 x i64> poison, i64 %i.bs, i64 0
  %20 = shufflevector <2 x i64> %19, <2 x i64> poison, <2 x i32> zeroinitializer
  %21 = mul nuw <2 x i64> %20, %12
  %22 = lshr <2 x i64> %21, splat (i64 32)
  %23 = insertelement <2 x i64> poison, i64 %18, i64 0
  %24 = insertelement <2 x i64> %23, i64 %17, i64 1
  %25 = and <2 x i64> %24, splat (i64 4294967295)
  %26 = and <2 x i64> %16, splat (i64 4294967295)
  %27 = add nuw nsw <2 x i64> %25, splat (i64 2147483648)
  %28 = add nuw nsw <2 x i64> %27, %22
  %29 = add nuw nsw <2 x i64> %28, %26
  %30 = lshr i64 %17, 32
  %31 = lshr i64 %18, 32
  %32 = lshr <2 x i64> %16, splat (i64 32)
  %33 = lshr <2 x i64> %29, splat (i64 32)
  %i.cl = add nuw i64 %30, %i.ck
  %34 = add nuw i64 %31, %13
  %35 = insertelement <2 x i64> poison, i64 %34, i64 0
  %36 = insertelement <2 x i64> %35, i64 %i.cl, i64 1
  %37 = add nuw <2 x i64> %36, %32
  %38 = add <2 x i64> %37, %33                    ; 2 uses
  %39 = extractelement <2 x i64> %38, i64 0       ; 2 uses
  %i.cm = add i64 %39, 1                          ; 3 uses
  %40 = extractelement <2 x i64> %38, i64 1
  %i.cn = sub i64 %39, %40                        ; 2 uses
  %i.co = add i64 %i.cn, 2                        ; 4 uses
  %i.cp = sub nsw i32 0, %i.cf
  %i.cq = zext nneg i32 %i.cp to i64              ; 5 uses
  %i.cr = shl nuw i64 1, %i.cq                    ; 5 uses
  %i.cs = lshr i64 %i.cm, %i.cq
  %i.ct = trunc i64 %i.cs to i32                  ; 2 uses
  %i.cu = add i64 %i.cr, -1                       ; 2 uses
  %i.cv = and i64 %i.cm, %i.cu                    ; 2 uses
