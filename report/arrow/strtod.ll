...
bb.f:                                             ; preds = %bb.e
  %3 = fcmp oeq double %i.c, 0.000000e+00
...
bb.j:                                             ; preds = %bb.i
  ...
  br i1 %i.z, label %4, label %bb.l

4:                                                ; preds = %bb.j
  %5 = fcmp oeq double %i.c, 0.000000e+00
  br i1 %5, label %_ZNK14arrow_vendored17double_conversion6Double10NextDoubleEv.exit, label %bb.k
...
_ZNK14arrow_vendored17double_conversion6Double10NextDoubleEv.exit: ; preds = %bb.a, %bb.l, %bb.k, %4, %bb.i, %bb.h, %bb.g, %bb.f, %bb.d, %bb.b
  %.1 = phi double [ %i.ab, %bb.k ], [ %i.c, %bb.i ], [ %i.c, %bb.b ], [ 0x7FF0000000000000, %bb.d ], [ 0.000000e+00, %bb.f ], [ %i.w, %bb.h ], [ %i.u, %bb.g ], [ 0.000000e+00, %4 ], [ %i.ad, %bb.l ], [ %i.c, %bb.a ]
...
bb.j:                                             ; preds = %bb.i
  %3 = fcmp oeq double %i.y, 0.000000e+00
...
bb.n:                                             ; preds = %bb.m
  ...
  br i1 %i.av, label %4, label %bb.p

4:                                                ; preds = %bb.n
  %5 = fcmp oeq double %i.y, 0.000000e+00
  br i1 %5, label %_ZN14arrow_vendored17double_conversion13StrtodTrimmedENS0_6VectorIKcEEi.exit, label %bb.o
...
_ZN14arrow_vendored17double_conversion13StrtodTrimmedENS0_6VectorIKcEEi.exit: ; preds = %_ZN14arrow_vendored17double_conversionL10TrimAndCutENS0_6VectorIKcEEiPciPS3_Pi.exit, %bb.f, %bb.h, %bb.j, %bb.k, %bb.l, %bb.m, %4, %bb.o, %bb.p
  %.1.i = phi double [ %i.ax, %bb.o ], [ %i.y, %bb.m ], [ %i.y, %bb.f ], [ 0x7FF0000000000000, %bb.h ], [ 0.000000e+00, %bb.j ], [ %i.as, %bb.l ], [ %i.aq, %bb.k ], [ 0.000000e+00, %4 ], [ %i.az, %bb.p ], [ %i.y, %_ZN14arrow_vendored17double_conversionL10TrimAndCutENS0_6VectorIKcEEiPciPS3_Pi.exit ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #6
...
bb.n:                                             ; preds = %_ZN14arrow_vendored17double_conversionL18SanitizedDoubletofEd.exit54
  %i.y = bitcast double %.0.i497081 to i64        ; 3 uses
...
bb.p:                                             ; preds = %bb.o
  %4 = fcmp oeq double %.0.i497081, 0.000000e+00
