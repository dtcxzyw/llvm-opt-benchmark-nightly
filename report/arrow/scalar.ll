...
bb.i:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i
  ...
  %i.au = add nuw nsw i8 %i.as, %narrow.i10.i     ; 3 uses
  %i.av = add i8 %i.al, -13
...
bb.m:                                             ; preds = %bb.l
  switch i32 %2, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i [
    ...
    i32 1, label %.split14.i
    i32 2, label %.split.i
  ]

.split14.i:                                       ; preds = %bb.m
...
_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i: ; preds = %.split14.i, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i, %.split.i, %bb.m
  %.pn25.i.i8.i = phi i64 [ %i.ci, %.split14.i ], [ %i.co, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i ], [ %i.cl, %.split.i ], [ %i.cg, %bb.m ]
...
bb.r:                                             ; preds = %bb.q, %bb.q
  ...
  br i1 %i.dc, label %bb.s, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358

bb.s:                                             ; preds = %bb.r
  %i.dd = add i8 %i.ct, -48                       ; 2 uses
  %narrow.i.i = mul nuw nsw i8 %i.db, 10
  %i.de = icmp ugt i8 %i.dd, 9
  %i.df = add nuw nsw i8 %i.dd, %narrow.i.i       ; 2 uses
  %i.dg = icmp ugt i8 %i.df, 23
  %or.cond.i = select i1 %i.de, i1 true, i1 %i.dg, !prof !364
  br i1 %or.cond.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, label %bb.t, !prof !364
...
bb.t:                                             ; preds = %bb.s
  ...
  br i1 %i.dj, label %bb.u, label %bb.ag
...
bb.w:                                             ; preds = %bb.v, %bb.v
  ...
  br i1 %i.dr, label %bb.x, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358

bb.x:                                             ; preds = %bb.w
  %i.ds = add i8 %i.cy, -48                       ; 2 uses
  %narrow.i.i78 = mul nuw nsw i8 %i.dq, 10
  %i.dt = icmp ult i8 %i.ds, 10
  %i.du = add nuw nsw i8 %i.ds, %narrow.i.i78     ; 2 uses
  br i1 %i.dt, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i79, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358

_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i79: ; preds = %bb.x
  ...
  br i1 %i.dy, label %bb.y, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358

bb.y:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i79
  %i.dz = add i8 %i.ct, -48                       ; 2 uses
  %narrow.i8.i80 = mul nuw nsw i8 %i.dx, 10
  %i.ea = icmp ult i8 %i.dz, 10
  %i.eb = add nuw nsw i8 %i.dz, %narrow.i8.i80    ; 2 uses
  br i1 %i.ea, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358

_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i: ; preds = %bb.y
  %i.ec = icmp ugt i8 %i.du, 23
  %i.ed = icmp ugt i8 %i.eb, 59
  %or.cond6.i = select i1 %i.ec, i1 true, i1 %i.ed, !prof !367
  br i1 %or.cond6.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, label %bb.z, !prof !368

bb.z:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i
...
bb.ad:                                            ; preds = %bb.ac
  ...
  br i1 %i.eq, label %bb.ae, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !218
...
bb.ag:                                            ; preds = %bb.ae, %bb.af, %bb.ab, %bb.z, %bb.aa, %bb.t, %bb.u, %bb.p, %bb.ac
  %.064 = phi i64 [ %1, %bb.ab ], [ %i.cv, %bb.p ], [ %1, %bb.ac ], [ %i.cw, %bb.t ], [ %i.dl, %bb.z ], [ %i.cw, %bb.u ], [ %i.dl, %bb.aa ], [ %i.el, %bb.af ], [ %i.el, %bb.ae ] ; 6 uses
  switch i64 %.064, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102 [
    i64 13, label %bb.ah
    i64 16, label %bb.aj
    i64 19, label %bb.an
    i64 21, label %bb.an
...
bb.ah:                                            ; preds = %bb.ag
  ...
  br i1 %i.ex, label %bb.ai, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.fc = add nuw nsw i8 %i.fa, %narrow.i.i82     ; 2 uses
  %i.fd = icmp ugt i8 %i.fc, 23
  %or.cond.i83 = select i1 %i.fb, i1 true, i1 %i.fd, !prof !364
  br i1 %or.cond.i83, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, label %_ZN5arrow8internal6detailL7ParseHHINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit84, !prof !364

_ZN5arrow8internal6detailL7ParseHHINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit84: ; preds = %bb.ai
...
bb.aj:                                            ; preds = %bb.ag
  ...
  br i1 %.not.i85, label %bb.ak, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !218
...
bb.ak:                                            ; preds = %bb.aj
  ...
  br i1 %i.fl, label %bb.al, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358
...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.fq = add nuw nsw i8 %i.fo, %narrow.i.i87     ; 2 uses
  br i1 %i.fp, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i88, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358

_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i88: ; preds = %bb.al
  ...
  br i1 %i.fu, label %bb.am, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358

bb.am:                                            ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i88
  ...
  %i.fz = add nuw nsw i8 %i.fx, %narrow.i10.i89   ; 2 uses
  br i1 %i.fy, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit11.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358

_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit11.i: ; preds = %bb.am
  %i.ga = icmp ugt i8 %i.fq, 23
  %i.gb = icmp ugt i8 %i.fz, 59
  %or.cond8.i = select i1 %i.ga, i1 true, i1 %i.gb, !prof !367
  br i1 %or.cond8.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, label %_ZN5arrow8internal6detailL10ParseHH_MMINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit, !prof !368
...
bb.an:                                            ; preds = %bb.ag, %bb.ag, %bb.ag, %bb.ag, %bb.ag, %bb.ag, %bb.ag, %bb.ag, %bb.ag, %bb.ag
  ...
  br i1 %.not.i90, label %bb.ao, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !218

bb.ao:                                            ; preds = %bb.an
  %i.gk = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.gl = load i8, ptr %i.gk, align 1, !tbaa !66
  %.not7.i92 = icmp eq i8 %i.gl, 58
  br i1 %.not7.i92, label %bb.ap, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !218

bb.ap:                                            ; preds = %bb.ao
  %i.gm = load i8, ptr %i.gh, align 1, !tbaa !66
  %i.gn = add i8 %i.gm, -48                       ; 2 uses
  %i.go = icmp ult i8 %i.gn, 10
  br i1 %i.go, label %bb.aq, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %i.gt = add nuw nsw i8 %i.gr, %narrow.i.i93     ; 2 uses
  br i1 %i.gs, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i94, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358

_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i94: ; preds = %bb.aq
  ...
  br i1 %i.gx, label %bb.ar, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358

bb.ar:                                            ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i94
  ...
  %i.hc = add nuw nsw i8 %i.ha, %narrow.i15.i     ; 2 uses
  br i1 %i.hb, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358

_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i: ; preds = %bb.ar
  ...
  br i1 %i.hg, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !358
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i: ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i
  ...
  br i1 %or.cond13.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, label %_ZN5arrow8internal6detailL13ParseHH_MM_SSINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit, !prof !368
...
bb.as:                                            ; preds = %_ZN5arrow8internal6detailL13ParseHH_MM_SSINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit, %_ZN5arrow8internal6detailL10ParseHH_MMINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit, %_ZN5arrow8internal6detailL7ParseHHINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit84
  ...
  br i1 %i.hz, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, label %bb.at, !prof !209
...
bb.au:                                            ; preds = %bb.at
  switch i32 %2, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97 [
    i32 3, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i101
    i32 1, label %.split14.i100
    i32 2, label %.split.i96
  ]

.split14.i100:                                    ; preds = %bb.au
  ...
  br i1 %i.id, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97, !prof !362

.split.i96:                                       ; preds = %bb.au
  ...
  br i1 %i.ig, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97, !prof !362

_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i101: ; preds = %bb.au
  ...
  br i1 %i.ij, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97, !prof !362

_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97: ; preds = %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i101, %.split.i96, %.split14.i100, %bb.au
  %.pn25.i.i8.i98 = phi i64 [ %i.ie, %.split14.i100 ], [ %i.ik, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i101 ], [ %i.ih, %.split.i96 ], [ %i.ia, %bb.au ]
  store i64 %.pn25.i.i8.i98, ptr %3, align 8, !tbaa !350
  br label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102

bb.av:                                            ; preds = %bb.at
  %i.il = getelementptr inbounds nuw i8, ptr %0, i64 19
  %i.im = load i8, ptr %i.il, align 1, !tbaa !66
  %.not76 = icmp eq i8 %i.im, 46
  br i1 %.not76, label %bb.aw, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, !prof !218
...
bb.ax:                                            ; preds = %bb.aw
  ...
  br i1 %i.ip, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, label %bb.az, !prof !209

bb.ay:                                            ; preds = %bb.aw
  %i.iq = icmp samesign ugt i64 %.064, 26
  br i1 %i.iq, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, label %bb.az, !prof !209

bb.az:                                            ; preds = %bb.aw, %bb.ay, %bb.ax
  %.pn.i = phi i64 [ 3, %bb.ax ], [ 6, %bb.ay ], [ 9, %bb.aw ] ; 2 uses
  %i.ir = icmp eq i64 %.pn.i, %i.io
  br i1 %i.ir, label %.split, label %bb.ba, !prof !218
...
.split:                                           ; preds = %bb.az
  ...
  br i1 %i.is, label %bb.bc, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, !prof !300
...
bb.ba:                                            ; preds = %bb.az
  ...
  br i1 %i.it, label %bb.bb, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit, !prof !218
...
_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread20: ; preds = %bb.bb, %switch.lookup
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #28
  br label %bb.bc

_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit: ; preds = %bb.ba
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #28
  br label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread

bb.bc:                                            ; preds = %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread20, %.split
  switch i32 %2, label %default.unreachable [
    i32 3, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i109
    i32 1, label %.split14.i108
    i32 2, label %.split.i104
  ]

.split14.i108:                                    ; preds = %bb.bc
  %i.ix = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %i.ia, i64 1000) ; 2 uses
  %i.iy = extractvalue { i64, i1 } %i.ix, 1
  br i1 %i.iy, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, label %bb.bd, !prof !362

.split.i104:                                      ; preds = %bb.bc
  %i.iz = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %i.ia, i64 1000000) ; 2 uses
  %i.ja = extractvalue { i64, i1 } %i.iz, 1
  br i1 %i.ja, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, label %bb.bd, !prof !362

_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i109: ; preds = %bb.bc
  %i.jb = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %i.ia, i64 1000000000) ; 2 uses
  %i.jc = extractvalue { i64, i1 } %i.jb, 1
  br i1 %i.jc, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, label %bb.bd, !prof !362

default.unreachable:                              ; preds = %bb.bc
  unreachable

bb.bd:                                            ; preds = %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i109, %.split.i104, %.split14.i108
  %.pn = phi { i64, i1 } [ %i.ix, %.split14.i108 ], [ %i.jb, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i109 ], [ %i.iz, %.split.i104 ]
  %.pn25.i.i8.i106 = extractvalue { i64, i1 } %.pn, 0
  %i.jd = load i32, ptr %i.b, align 4, !tbaa !3
  %i.je = zext i32 %i.jd to i64
  %i.jf = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %.pn25.i.i8.i106, i64 %i.je) ; 2 uses
...
_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread: ; preds = %.split14.i108, %.split.i104, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i109, %bb.ax, %bb.ay, %bb.aw, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit, %.split, %bb.bd
  %.0 = phi i1 [ false, %bb.ax ], [ false, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit ], [ %not., %bb.bd ], [ false, %.split ], [ false, %bb.aw ], [ false, %bb.ay ], [ false, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i109 ], [ false, %.split.i104 ], [ false, %.split14.i108 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #28
  br label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102

_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102: ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i, %bb.ar, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i94, %bb.ap, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i, %bb.aq, %bb.ao, %bb.an, %bb.am, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i88, %bb.ak, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit11.i, %bb.al, %bb.aj, %bb.ah, %bb.ai, %bb.y, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i79, %bb.w, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i, %bb.x, %bb.r, %bb.s, %bb.ag, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i101, %.split.i96, %.split14.i100, %bb.av, %bb.as, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, %bb.ad
  %.3 = phi i1 [ false, %bb.ad ], [ false, %bb.r ], [ false, %.split14.i100 ], [ false, %bb.am ], [ false, %bb.ah ], [ false, %bb.ag ], [ false, %bb.y ], [ %.0, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread ], [ false, %bb.av ], [ false, %bb.as ], [ true, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97 ], [ false, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i101 ], [ false, %.split.i96 ], [ false, %bb.s ], [ false, %bb.x ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i ], [ false, %bb.w ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i79 ], [ false, %bb.ai ], [ false, %bb.aj ], [ false, %bb.al ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit11.i ], [ false, %bb.ak ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i88 ], [ false, %bb.an ], [ false, %bb.ao ], [ false, %bb.aq ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i ], [ false, %bb.ap ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i94 ], [ false, %bb.ar ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28
  br label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit

_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit: ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i, %_ZN5arrow8internal13ParseUnsignedEPKcmPt.exit.i, %bb.g, %bb.e, %bb.d, %_ZNK14arrow_vendored4date14year_month_day2okEv.exit.i, %bb.i, %bb.c, %bb.f, %bb.b, %bb.h, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102, %bb.n, %.split.i, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i, %bb.a
  %.5 = phi i1 [ false, %bb.a ], [ %.3, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit102 ], [ false, %bb.n ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i ], [ true, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i ], [ false, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i ], [ false, %.split.i ], [ false, %bb.h ], [ false, %bb.b ], [ false, %bb.f ], [ false, %bb.c ], [ false, %bb.i ], [ false, %_ZNK14arrow_vendored4date14year_month_day2okEv.exit.i ], [ false, %bb.d ], [ false, %bb.e ], [ false, %bb.g ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPt.exit.i ]
  ret i1 %.5
}
...
bb.i:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i
  ...
  %i.ar = add nuw nsw i8 %i.ap, %narrow.i10.i     ; 3 uses
  %i.as = add i8 %i.ai, -13
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.n = icmp ult i8 %i.m, 10
  %i.o = add nuw nsw i8 %i.m, %narrow.i.i         ; 2 uses
...
bb.e:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i
  ...
  %i.x = add nuw nsw i8 %i.v, %narrow.i10.i       ; 2 uses
...
_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit.i: ; preds = %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i, %.split14.i.i, %.split.i.i, %bb.f
  %.pn25.i.i8.i.i = phi i64 [ %i.af, %.split14.i.i ], [ %i.ah, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i ], [ %i.ag, %.split.i.i ], [ %i.ae, %bb.f ] ; 2 uses
...
bb.g:                                             ; preds = %bb.a
  ...
  br i1 %i.ak, label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit, label %bb.h, !prof !209

bb.h:                                             ; preds = %bb.g
  %i.al = getelementptr inbounds nuw i8, ptr %2, i64 2
  %i.am = load i8, ptr %i.al, align 1, !tbaa !66
  %.not.i14 = icmp eq i8 %i.am, 58
  br i1 %.not.i14, label %bb.i, label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit, !prof !218

bb.i:                                             ; preds = %bb.h
  %i.an = getelementptr inbounds nuw i8, ptr %2, i64 5
  %i.ao = load i8, ptr %i.an, align 1, !tbaa !66
  %.not7.i = icmp eq i8 %i.ao, 58
  br i1 %.not7.i, label %bb.j, label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit, !prof !218

bb.j:                                             ; preds = %bb.i
  %i.ap = load i8, ptr %2, align 1, !tbaa !66
  %i.aq = add i8 %i.ap, -48                       ; 2 uses
  %i.ar = icmp ult i8 %i.aq, 10
  br i1 %i.ar, label %bb.k, label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit, !prof !358
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.aw = add nuw nsw i8 %i.au, %narrow.i.i16     ; 2 uses
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i17: ; preds = %bb.k
  ...
  br i1 %i.ba, label %bb.l, label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit, !prof !358

bb.l:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i17
  ...
  %i.bf = add nuw nsw i8 %i.bd, %narrow.i15.i     ; 2 uses
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i: ; preds = %bb.l
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i: ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i
  ...
  br i1 %or.cond13.i, label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit, label %bb.m, !prof !368

bb.m:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i
  ...
  switch i32 %i.d, label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit24.thread [
    i32 3, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i23
    i32 1, label %.split14.i.i22
    i32 2, label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit24
  ]

.split14.i.i22:                                   ; preds = %bb.m
  %i.bz = mul nuw nsw i64 %i.by, 1000
  br label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit24.thread

_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i23: ; preds = %bb.m
  br label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit24

_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit24.thread: ; preds = %.split14.i.i22, %bb.m
  %.pn25.i.i8.i.i20.ph = phi i64 [ %i.by, %bb.m ], [ %i.bz, %.split14.i.i22 ]
  %i.ca = trunc nuw nsw i64 %.pn25.i.i8.i.i20.ph to i32
  store i32 %i.ca, ptr %4, align 4, !tbaa !3
  br label %bb.n

_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit24: ; preds = %bb.m, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i23
  %.sink = phi i64 [ 1000000000, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i23 ], [ 1000000, %bb.m ]
  %i.cb = mul nuw nsw i64 %i.by, %.sink           ; 2 uses
  %i.cc = trunc i64 %i.cb to i32
  store i32 %i.cc, ptr %4, align 4, !tbaa !3
  %i.cd = icmp samesign ult i64 %i.cb, 2147483648
  br i1 %i.cd, label %bb.n, label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit, !prof !300

bb.n:                                             ; preds = %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit24.thread, %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit24
  %i.ce = icmp eq i64 %3, 8
  br i1 %i.ce, label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.cf = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.cg = load i8, ptr %i.cf, align 1, !tbaa !66
  %.not = icmp eq i8 %i.cg, 46
  br i1 %.not, label %bb.p, label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit, !prof !218
...
bb.q:                                             ; preds = %bb.p
  ...
  br i1 %i.cj, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, label %bb.t, !prof !209

bb.r:                                             ; preds = %bb.p
  %i.ck = icmp ugt i64 %i.ci, 6
  br i1 %i.ck, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, label %bb.t, !prof !209

bb.s:                                             ; preds = %bb.p
  %i.cl = icmp ugt i64 %i.ci, 9
  br i1 %i.cl, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, label %bb.t, !prof !209

bb.t:                                             ; preds = %bb.s, %bb.r, %bb.q
  %.pn.i = phi i64 [ 3, %bb.q ], [ 6, %bb.r ], [ 9, %bb.s ] ; 2 uses
  %i.cm = icmp eq i64 %.pn.i, %i.ci
  br i1 %i.cm, label %.split, label %bb.u, !prof !218
...
.split:                                           ; preds = %bb.t
  ...
  br i1 %i.cn, label %.split._crit_edge, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, !prof !300
...
bb.u:                                             ; preds = %bb.t
  ...
  br i1 %i.co, label %bb.v, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit, !prof !218

bb.v:                                             ; preds = %bb.u
  %reass.sub = sub i64 %.pn.i, %3                 ; 2 uses
  %i.cp = icmp ugt i64 %reass.sub, -9
  br i1 %i.cp, label %switch.lookup, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread39
...
switch.lookup:                                    ; preds = %bb.v
  ...
  br label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread39

_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread39: ; preds = %bb.v, %switch.lookup
  %i.ct = phi i32 [ 0, %bb.v ], [ %i.cs, %switch.lookup ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #28
  br label %bb.w

_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit: ; preds = %bb.u
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #28
  br label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread

bb.w:                                             ; preds = %.split._crit_edge, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread39
  %i.cu = phi i32 [ %.pre, %.split._crit_edge ], [ %i.ct, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread39 ]
  %i.cv = load i32, ptr %4, align 4, !tbaa !3
  %i.cw = add i32 %i.cv, %i.cu
  store i32 %i.cw, ptr %4, align 4, !tbaa !3
  br label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread

_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread: ; preds = %bb.p, %bb.q, %bb.r, %bb.s, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit, %.split, %bb.w
  %.1.i36 = phi i1 [ false, %.split ], [ false, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit ], [ true, %bb.w ], [ false, %bb.s ], [ false, %bb.r ], [ false, %bb.q ], [ false, %bb.p ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #28
  br label %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit

_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit: ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i, %bb.l, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i17, %bb.j, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i, %bb.k, %bb.i, %bb.h, %bb.e, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i, %bb.c, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit11.i, %bb.d, %bb.b, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit.i, %bb.o, %bb.n, %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit24, %bb.g, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread
  %.1 = phi i1 [ %.1.i36, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread ], [ false, %bb.o ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i ], [ false, %bb.g ], [ false, %bb.e ], [ false, %_ZZN5arrow8internal15StringConverterINS_10Time32TypeEvE7ConvertERKS2_PKcmPiENKUlS8_E_clES8_.exit24 ], [ true, %bb.n ], [ %i.aj, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit.i ], [ false, %bb.j ], [ false, %bb.l ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i17 ], [ false, %bb.b ], [ false, %bb.d ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit11.i ], [ false, %bb.c ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i ], [ false, %bb.h ], [ false, %bb.i ], [ false, %bb.k ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i ]
  ret i1 %.1
}
...
_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit.i: ; preds = %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i, %.split14.i.i, %.split.i.i, %bb.f
  %.pn25.i.i8.i.i = phi i64 [ %i.af, %.split14.i.i ], [ %i.ah, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i ], [ %i.ag, %.split.i.i ], [ %i.ae, %bb.f ]
...
bb.g:                                             ; preds = %bb.a
  ...
  br i1 %i.ai, label %_ZZN5arrow8internal15StringConverterINS_10Time64TypeEvE7ConvertERKS2_PKcmPlENKUlS8_E_clES8_.exit, label %bb.h, !prof !209

bb.h:                                             ; preds = %bb.g
  %i.aj = getelementptr inbounds nuw i8, ptr %2, i64 2
  %i.ak = load i8, ptr %i.aj, align 1, !tbaa !66
  %.not.i13 = icmp eq i8 %i.ak, 58
  br i1 %.not.i13, label %bb.i, label %_ZZN5arrow8internal15StringConverterINS_10Time64TypeEvE7ConvertERKS2_PKcmPlENKUlS8_E_clES8_.exit, !prof !218

bb.i:                                             ; preds = %bb.h
  %i.al = getelementptr inbounds nuw i8, ptr %2, i64 5
  %i.am = load i8, ptr %i.al, align 1, !tbaa !66
  %.not7.i = icmp eq i8 %i.am, 58
  br i1 %.not7.i, label %bb.j, label %_ZZN5arrow8internal15StringConverterINS_10Time64TypeEvE7ConvertERKS2_PKcmPlENKUlS8_E_clES8_.exit, !prof !218

bb.j:                                             ; preds = %bb.i
  %i.an = load i8, ptr %2, align 1, !tbaa !66
  %i.ao = add i8 %i.an, -48                       ; 2 uses
  %i.ap = icmp ult i8 %i.ao, 10
  br i1 %i.ap, label %bb.k, label %_ZZN5arrow8internal15StringConverterINS_10Time64TypeEvE7ConvertERKS2_PKcmPlENKUlS8_E_clES8_.exit, !prof !358
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.au = add nuw nsw i8 %i.as, %narrow.i.i15     ; 2 uses
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i16: ; preds = %bb.k
  %i.av = getelementptr inbounds nuw i8, ptr %2, i64 3
  %i.aw = load i8, ptr %i.av, align 1, !tbaa !66
  %i.ax = add i8 %i.aw, -48                       ; 2 uses
  %i.ay = icmp ult i8 %i.ax, 10
  br i1 %i.ay, label %bb.l, label %_ZZN5arrow8internal15StringConverterINS_10Time64TypeEvE7ConvertERKS2_PKcmPlENKUlS8_E_clES8_.exit, !prof !358

bb.l:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i16
  ...
  %i.bd = add nuw nsw i8 %i.bb, %narrow.i15.i     ; 2 uses
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i: ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i
  ...
  br i1 %or.cond13.i, label %_ZZN5arrow8internal15StringConverterINS_10Time64TypeEvE7ConvertERKS2_PKcmPlENKUlS8_E_clES8_.exit, label %bb.m, !prof !368
...
bb.m:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i
  ...
  switch i32 %i.d, label %bb.n [
    i32 3, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i22
    i32 1, label %.split14.i.i21
    i32 2, label %.split.i.i17
  ]

.split14.i.i21:                                   ; preds = %bb.m
  %i.bx = mul nuw nsw i64 %i.bw, 1000
  br label %bb.n

.split.i.i17:                                     ; preds = %bb.m
  %i.by = mul nuw nsw i64 %i.bw, 1000000
  br label %bb.n

_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i22: ; preds = %bb.m
  %i.bz = mul nuw nsw i64 %i.bw, 1000000000
  br label %bb.n

bb.n:                                             ; preds = %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i22, %.split14.i.i21, %.split.i.i17, %bb.m
  %.pn25.i.i8.i.i19 = phi i64 [ %i.bx, %.split14.i.i21 ], [ %i.bz, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i22 ], [ %i.by, %.split.i.i17 ], [ %i.bw, %bb.m ]
  store i64 %.pn25.i.i8.i.i19, ptr %4, align 8, !tbaa !350
  %i.ca = icmp eq i64 %3, 8
  br i1 %i.ca, label %_ZZN5arrow8internal15StringConverterINS_10Time64TypeEvE7ConvertERKS2_PKcmPlENKUlS8_E_clES8_.exit, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.cb = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.cc = load i8, ptr %i.cb, align 1, !tbaa !66
  %.not = icmp eq i8 %i.cc, 46
  br i1 %.not, label %bb.p, label %_ZZN5arrow8internal15StringConverterINS_10Time64TypeEvE7ConvertERKS2_PKcmPlENKUlS8_E_clES8_.exit, !prof !218
...
bb.q:                                             ; preds = %bb.p
  ...
  br i1 %i.cf, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, label %bb.t, !prof !209

bb.r:                                             ; preds = %bb.p
  %i.cg = icmp ugt i64 %i.ce, 6
  br i1 %i.cg, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, label %bb.t, !prof !209

bb.s:                                             ; preds = %bb.p
  %i.ch = icmp ugt i64 %i.ce, 9
  br i1 %i.ch, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, label %bb.t, !prof !209

bb.t:                                             ; preds = %bb.s, %bb.r, %bb.q
  %.pn.i = phi i64 [ 3, %bb.q ], [ 6, %bb.r ], [ 9, %bb.s ] ; 2 uses
  %i.ci = icmp eq i64 %.pn.i, %i.ce
  br i1 %i.ci, label %.split, label %bb.u, !prof !218
...
.split:                                           ; preds = %bb.t
  ...
  br i1 %i.cj, label %.split._crit_edge, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread, !prof !300
...
bb.u:                                             ; preds = %bb.t
  ...
  br i1 %i.ck, label %bb.v, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit, !prof !218

bb.v:                                             ; preds = %bb.u
  %reass.sub = sub i64 %.pn.i, %3                 ; 2 uses
  %i.cl = icmp ugt i64 %reass.sub, -9
  br i1 %i.cl, label %switch.lookup, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread38
...
switch.lookup:                                    ; preds = %bb.v
  ...
  br label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread38

_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread38: ; preds = %bb.v, %switch.lookup
  %i.cp = phi i32 [ 0, %bb.v ], [ %i.co, %switch.lookup ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #28
  br label %bb.w
...
bb.w:                                             ; preds = %.split._crit_edge, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread38
  %i.cq = phi i32 [ %.pre, %.split._crit_edge ], [ %i.cp, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread38 ]
...
_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread: ; preds = %bb.p, %bb.q, %bb.r, %bb.s, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit, %.split, %bb.w
  %.1.i35 = phi i1 [ false, %.split ], [ false, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit ], [ true, %bb.w ], [ false, %bb.s ], [ false, %bb.r ], [ false, %bb.q ], [ false, %bb.p ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #28
  br label %_ZZN5arrow8internal15StringConverterINS_10Time64TypeEvE7ConvertERKS2_PKcmPlENKUlS8_E_clES8_.exit

_ZZN5arrow8internal15StringConverterINS_10Time64TypeEvE7ConvertERKS2_PKcmPlENKUlS8_E_clES8_.exit: ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i, %bb.l, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i16, %bb.j, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i, %bb.k, %bb.i, %bb.h, %bb.e, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i, %bb.c, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit11.i, %bb.d, %bb.b, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit.i, %bb.o, %bb.n, %bb.g, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread
  %.1 = phi i1 [ %.1.i35, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread ], [ false, %bb.o ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i16 ], [ false, %bb.g ], [ false, %bb.e ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i ], [ true, %bb.n ], [ true, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit.i ], [ false, %bb.j ], [ false, %bb.l ], [ false, %bb.b ], [ false, %bb.d ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit11.i ], [ false, %bb.c ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i ], [ false, %bb.h ], [ false, %bb.i ], [ false, %bb.k ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i ]
  ret i1 %.1
}
