...
bb.h:                                             ; preds = %bb.i, %bb.g
  %.0.i.i = phi i64 [ %i.af, %bb.g ], [ %i.al, %bb.i ] ; 3 uses
  %i.ag = and i64 %.0.i.i, -2                     ; 2 uses
  %i.ah = icmp eq i64 %i.ag, 0
end_hunk_0
begin_hunk_1_@_mi_heap_page_reclaim:bb.a
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.ci, label %middle.block, label %vector.body, !llvm.loop !64
...
.lr.ph.i.i.preheader:                             ; preds = %.lr.ph.preheader.i.i, %middle.block
  %.034.i.i.ph = phi i64 [ %.138.i.i, %.lr.ph.preheader.i.i ], [ %i.ce, %middle.block ]
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  %.034.i.i = phi i64 [ %i.ck, %.lr.ph.i.i ], [ %.034.i.i.ph, %.lr.ph.i.i.preheader ] ; 3 uses
  %i.cj = getelementptr inbounds nuw [8 x i8], ptr %i.bn, i64 %.034.i.i
  store ptr %i.bi, ptr %i.cj, align 8, !tbaa !14
  %i.ck = add nuw nsw i64 %.034.i.i, 1
...
mi_page_queue_push_at_end.exit:                   ; preds = %.lr.ph.i.i, %middle.block, %bb.m, %bb.n, %bb.o, %bb.s
  %i.cl = getelementptr inbounds nuw i8, ptr %0, i64 168 ; 2 uses
  %i.cm = load i64, ptr %i.cl, align 8, !tbaa !66
  %i.cn = add i64 %i.cm, 1
  store i64 %i.cn, ptr %i.cl, align 8, !tbaa !66
  ret void
}
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  store ptr %spec.store.select.i, ptr %i.an, align 8, !tbaa !14
...
mi_heap_queue_first_update.exit:                  ; preds = %.lr.ph.i, %middle.block, %bb.l, %bb.h, %bb.g, %bb.f
  ...
  %i.aq = getelementptr inbounds nuw i8, ptr %.val, i64 168 ; 2 uses
  ...
  %i.au = load i64, ptr %i.at, align 8, !tbaa !53
  %i.av = add i64 %i.au, -1
  store i64 %i.av, ptr %i.at, align 8, !tbaa !53
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ap, i8 0, i64 16, i1 false)
  %i.aw = atomicrmw and ptr %1, i64 -2 monotonic, align 8 ; 0 uses
  ret void
}
...
bb.j:                                             ; preds = %bb.i
  store i64 %i.r, ptr %i.ah, align 8, !tbaa !71
  br label %bb.l

bb.k:                                             ; preds = %bb.e, %bb.f, %mi_page_queue_of.exit
  %i.ak = atomicrmw and ptr %0, i64 -3 monotonic, align 8 ; 0 uses
  tail call fastcc void @mi_page_queue_remove(ptr noundef nonnull %i.t, ptr noundef nonnull %0)
  %i.al = load ptr, ptr %i.b, align 8, !tbaa !29
  %i.am = load ptr, ptr %i.al, align 8, !tbaa !33 ; 2 uses
  %i.an = load atomic i64, ptr %0 monotonic, align 8
  store ptr null, ptr %i.b, align 8, !tbaa !29
  %i.ao = and i64 %i.an, 3
  store atomic i64 %i.ao, ptr %0 release, align 8
  tail call void @_mi_arenas_page_free(ptr noundef nonnull %0, ptr noundef %i.am) #14
end_hunk_1
...
.lr.ph.i.preheader:                               ; preds = %.lr.ph.preheader.i, %middle.block
  %.034.i.ph = phi i64 [ %.138.i, %.lr.ph.preheader.i ], [ %i.aj, %middle.block ]
  br label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  %.034.i = phi i64 [ %i.ap, %.lr.ph.i ], [ %.034.i.ph, %.lr.ph.i.preheader ] ; 3 uses
  %i.ao = getelementptr inbounds nuw [8 x i8], ptr %i.r, i64 %.034.i
  store ptr %spec.store.select.i, ptr %i.ao, align 8, !tbaa !14
  %i.ap = add nuw nsw i64 %.034.i, 1
...
mi_heap_queue_first_update.exit:                  ; preds = %.lr.ph.i, %middle.block, %bb.l, %bb.h, %bb.g, %bb.f
  ...
  %i.ax = load ptr, ptr %i.aw, align 8, !tbaa !32 ; 3 uses
  store ptr %i.ax, ptr %i.b, align 8, !tbaa !52
...
bb.m:                                             ; preds = %mi_heap_queue_first_update.exit
  ...
  store ptr %2, ptr %i.ay, align 8, !tbaa !30
  store ptr %2, ptr %i.aw, align 8, !tbaa !32
...
bb.n:                                             ; preds = %mi_heap_queue_first_update.exit
  ...
  %i.ba = load i64, ptr %i.az, align 8, !tbaa !9  ; 5 uses
  %i.bb = icmp ugt i64 %i.ba, 1024
  br i1 %i.bb, label %mi_heap_queue_first_update.exit76, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.bc = add nuw nsw i64 %i.ba, 7
  %i.bd = lshr i64 %i.bc, 3                       ; 6 uses
  %i.be = getelementptr inbounds nuw i8, ptr %.val64, i64 232 ; 3 uses
  %i.bf = getelementptr inbounds nuw [8 x i8], ptr %i.be, i64 %i.bd
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !14
  %i.bh = icmp eq ptr %i.bg, %2
  br i1 %i.bh, label %mi_heap_queue_first_update.exit76.thread, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.bi = icmp samesign ult i64 %i.ba, 9
  br i1 %i.bi, label %.lr.ph.preheader.i71, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.bj = tail call fastcc i64 @mi_bin(i64 noundef %i.ba)
  %i.bk = getelementptr inbounds nuw i8, ptr %.val64, i64 1264
  br label %bb.r

bb.r:                                             ; preds = %bb.r, %bb.q
  %.pn.i66 = phi ptr [ %0, %bb.q ], [ %.027.i67, %bb.r ] ; 2 uses
  %.027.i67 = getelementptr inbounds i8, ptr %.pn.i66, i64 -32 ; 2 uses
  %i.bl = getelementptr inbounds i8, ptr %.pn.i66, i64 -8
  %i.bm = load i64, ptr %i.bl, align 8, !tbaa !9  ; 2 uses
  %i.bn = tail call fastcc i64 @mi_bin(i64 noundef %i.bm)
  %i.bo = icmp eq i64 %i.bj, %i.bn
  %i.bp = icmp ugt ptr %.027.i67, %i.bk
  %i.bq = select i1 %i.bo, i1 %i.bp, i1 false
  br i1 %i.bq, label %bb.r, label %bb.s, !llvm.loop !47

bb.s:                                             ; preds = %bb.r
  %i.br = add i64 %i.bm, 7
  %i.bs = lshr i64 %i.br, 3                       ; 2 uses
  %i.bt = add nuw nsw i64 %i.bs, 1
  %.not.i68 = icmp samesign ult i64 %i.bs, %i.bd
  %spec.select.i69 = select i1 %.not.i68, i64 %i.bt, i64 %i.bd ; 2 uses
  %.not3233.i70 = icmp samesign ugt i64 %spec.select.i69, %i.bd
...
vector.body9:                                     ; preds = %vector.body9, %vector.ph4
  ...
  %i.ca = icmp eq i64 %index.next11, %n.vec6
  br i1 %i.ca, label %middle.block12, label %vector.body9, !llvm.loop !88

middle.block12:                                   ; preds = %vector.body9
  %cmp.n13 = icmp eq i64 %i.bv, %n.vec6
...
.lr.ph.i73.preheader:                             ; preds = %.lr.ph.preheader.i71, %middle.block12
  %.034.i74.ph = phi i64 [ %.138.i72, %.lr.ph.preheader.i71 ], [ %i.bw, %middle.block12 ]
  br label %.lr.ph.i73

.lr.ph.i73:                                       ; preds = %.lr.ph.i73.preheader, %.lr.ph.i73
  %.034.i74 = phi i64 [ %i.cc, %.lr.ph.i73 ], [ %.034.i74.ph, %.lr.ph.i73.preheader ] ; 3 uses
  %i.cb = getelementptr inbounds nuw [8 x i8], ptr %i.be, i64 %.034.i74
  store ptr %2, ptr %i.cb, align 8, !tbaa !14
  %i.cc = add nuw nsw i64 %.034.i74, 1
  %exitcond.not.i75 = icmp eq i64 %.034.i74, %i.bd
...
mi_heap_queue_first_update.exit76:                ; preds = %bb.n, %bb.m
  %.val63 = phi i64 [ %.val63.pre, %bb.m ], [ %i.ba, %bb.n ]
  %i.cd = icmp eq i64 %.val63, 65552
  br i1 %i.cd, label %bb.t, label %mi_heap_queue_first_update.exit76.thread

bb.t:                                             ; preds = %mi_heap_queue_first_update.exit76
  %i.ce = atomicrmw or ptr %2, i64 1 monotonic, align 8 ; 0 uses
...
mi_heap_queue_first_update.exit76.thread:         ; preds = %.lr.ph.i73, %middle.block12, %bb.o, %bb.s, %mi_heap_queue_first_update.exit76
  %i.cf = atomicrmw and ptr %2, i64 -2 monotonic, align 8 ; 0 uses
  br label %mi_page_set_in_full.exit
