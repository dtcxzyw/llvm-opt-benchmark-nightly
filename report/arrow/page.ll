...
define hidden range(i64 0, 74) i64 @_mi_bin(i64 noundef %0) local_unnamed_addr #0 {
bb.a:
...
define internal fastcc range(i64 0, 74) i64 @mi_bin(i64 noundef %0) unnamed_addr #1 {
bb.a:
...
bb.d:                                             ; preds = %bb.c
  ...
  %reass.sub14 = sub nsw i64 %i.l, %1
  %i.m = add nsw i64 %reass.sub14, 249
  br label %bb.e
...
define hidden range(i64 0, 75) i64 @_mi_page_bin(ptr noundef readonly captures(address) %0) local_unnamed_addr #5 {
bb.a:
...
begin_hunk_3_@_mi_malloc_generic:bb.a
  ...
  %i.t = tail call fastcc range(i64 0, 74) i64 @mi_bin(i64 noundef range(i64 0, -9223372036854775808) %i.r)
...
begin_hunk_4_@mi_find_page:bb.a
  ...
  %i.d = tail call fastcc range(i64 0, 74) i64 @mi_bin(i64 noundef range(i64 0, -9223372036854775808) %i.b)
