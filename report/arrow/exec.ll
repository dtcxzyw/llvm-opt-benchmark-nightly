...
begin_hunk_0_@_ZN5arrow7compute6detail14PropagateNullsEPNS0_13KernelContextERKNS0_8ExecSpanEPNS_9ArrayDataE:bb.a
  ...
  %i.o = getelementptr inbounds nuw i8, ptr %8, i64 48 ; 8 uses
...
._crit_edge.i:                                    ; preds = %._crit_edge.i.loopexit, %bb.f
  ...
  %i.z = phi ptr [ %i.bh, %._crit_edge.i.loopexit ], [ null, %bb.f ] ; 5 uses
...
common.resume:                                    ; preds = %bb.p, %bb.q, %_ZN5arrow7compute6detail12_GLOBAL__N_114NullPropagatorD2Ev.exit27
  %common.resume.op = phi { ptr, i32 } [ %eh.lpad-body, %_ZN5arrow7compute6detail12_GLOBAL__N_114NullPropagatorD2Ev.exit27 ], [ %lpad.phi.i, %bb.q ], [ %lpad.phi.i, %bb.p ]
...
bb.s:                                             ; preds = %_ZN5arrow7compute6detail12_GLOBAL__N_114NullPropagatorC2EPNS0_13KernelContextERKNS0_8ExecSpanEPNS_9ArrayDataE.exit
  ...
  %i.ce = load ptr, ptr %i.o, align 8, !tbaa !333, !noalias !351 ; 5 uses
...
bb.ag:                                            ; preds = %_ZN5arrow7compute6detail12_GLOBAL__N_114NullPropagatorC2EPNS0_13KernelContextERKNS0_8ExecSpanEPNS_9ArrayDataE.exit
  %i.ed = load ptr, ptr %i.o, align 8, !tbaa !333, !noalias !345 ; 8 uses
...
.invoke105:                                       ; preds = %_ZN5arrow6StatusD2Ev.exit51.i.i, %bb.al
  %13 = phi i64 [ %i.ex, %bb.al ], [ %i.jg, %_ZN5arrow6StatusD2Ev.exit51.i.i ]
  %14 = phi ptr [ %i.cd, %bb.al ], [ %i.ji, %_ZN5arrow6StatusD2Ev.exit51.i.i ]
  %15 = phi i64 [ %i.ez, %bb.al ], [ 0, %_ZN5arrow6StatusD2Ev.exit51.i.i ]
  %.in = getelementptr inbounds nuw i8, ptr %i.er, i64 8
  %16 = load i64, ptr %.in, align 8, !tbaa !293, !noalias !363
  invoke void @_ZN5arrow8internal10CopyBitmapEPKhllPhl(ptr noundef %i.et, i64 noundef %13, i64 noundef %16, ptr noundef %14, i64 noundef %15)
          to label %.critedge.sink.split.i.i unwind label %.loopexit.split-lp
...
bb.ar:                                            ; preds = %bb.ap
  ...
  %.pre = load ptr, ptr %i.o, align 8, !tbaa !333, !noalias !363
...
bb.at:                                            ; preds = %bb.as
  %i.fm = invoke noalias noundef nonnull dereferenceable(96) ptr @_Znwm(i64 noundef 96) #29
          to label %.noexc16 unwind label %.loopexit.split-lp ; 6 uses
...
_ZNK5arrow9ArraySpan9GetBufferEi.exit.i5.i:       ; preds = %.noexc16, %bb.as, %bb.ar, %bb.aq, %bb.ao
  %17 = phi ptr [ %i.ed, %.noexc16 ], [ %i.ed, %bb.aq ], [ %i.ed, %bb.ao ], [ %.pre, %bb.ar ], [ %i.ed, %bb.as ]
  ...
  %i.ft = getelementptr inbounds nuw i8, ptr %17, i64 40
...
bb.bh:                                            ; preds = %bb.bg
  ...
  %i.gz = invoke noalias noundef nonnull dereferenceable(96) ptr @_Znwm(i64 noundef 96) #29
          to label %.noexc17 unwind label %.loopexit.split-lp ; 6 uses
...
begin_hunk_15_@_ZN5arrow7compute6detail14PropagateNullsEPNS0_13KernelContextERKNS0_8ExecSpanEPNS_9ArrayDataE:bb.a
  ...
  %18 = load ptr, ptr %i.o, align 8, !tbaa !333, !noalias !363
  %i.ht = getelementptr inbounds nuw i8, ptr %18, i64 40
...
bb.by:                                            ; preds = %.noexc20
  %i.jl = load ptr, ptr %i.m, align 8, !tbaa !392, !noalias !391 ; 4 uses
...
.loopexit.split-lp:                               ; preds = %.invoke105, %.invoke, %_ZN5arrow6StatusD2Ev.exit.i.i, %bb.ai, %bb.at, %bb.bh, %_ZN5arrow6StatusD2Ev.exit.i1.i, %bb.bx, %bb.by
  %lpad.loopexit.split-lp.a = landingpad { ptr, i32 }
          cleanup
  br label %.body

.body:                                            ; preds = %.loopexit, %.loopexit.split-lp, %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow6BufferESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit10.i.i.i.i.i.i.i, %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow6BufferESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit10.i.i.i.i.i29.i.i, %.body.i.i
  %eh.lpad-body = phi { ptr, i32 } [ %eh.lpad-body.i.i, %.body.i.i ], [ %i.fs, %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow6BufferESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit10.i.i.i.i.i.i.i ], [ %i.hf, %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow6BufferESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit10.i.i.i.i.i29.i.i ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit.split-lp.a, %.loopexit.split-lp ]
  %.val = load ptr, ptr %i.m, align 8, !tbaa !392 ; 3 uses
  %.not.i.i.i.i25 = icmp eq ptr %.val, null
  br i1 %.not.i.i.i.i25, label %_ZN5arrow7compute6detail12_GLOBAL__N_114NullPropagatorD2Ev.exit27, label %bb.ca

bb.ca:                                            ; preds = %.body
  %i.ks = getelementptr inbounds nuw i8, ptr %8, i64 32
  %.val7 = load ptr, ptr %i.ks, align 8
  %i.kt = ptrtoint ptr %.val7 to i64
  %i.ku = ptrtoint ptr %.val to i64
  %i.kv = sub i64 %i.kt, %i.ku
  call void @_ZdlPvm(ptr noundef nonnull %.val, i64 noundef %i.kv) #31
  br label %_ZN5arrow7compute6detail12_GLOBAL__N_114NullPropagatorD2Ev.exit27

_ZN5arrow7compute6detail12_GLOBAL__N_114NullPropagatorD2Ev.exit27: ; preds = %.body, %bb.ca
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #27
  br label %common.resume
