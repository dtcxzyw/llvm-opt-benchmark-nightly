...
.lr.ph.i:                                         ; preds = %bb.b, %.thread.i
  %.03184.i = phi i64 [ %.637.ph.i, %.thread.i ], [ -1, %bb.b ] ; 8 uses
  %.03883.i = phi i1 [ %.442.ph.i, %.thread.i ], [ true, %bb.b ]
...
.thread.i:                                        ; preds = %bb.d, %_ZNK5arrow5Datum13chunked_arrayEv.exit.i, %bb.c, %_ZNK5arrow5Datum5arrayEv.exit.i, %.lr.ph.i
  %.442.ph.i = phi i1 [ %.03883.i, %.lr.ph.i ], [ false, %bb.c ], [ false, %_ZNK5arrow5Datum5arrayEv.exit.i ], [ false, %_ZNK5arrow5Datum13chunked_arrayEv.exit.i ], [ false, %bb.d ] ; 2 uses
  %.637.ph.i = phi i64 [ %.03184.i, %.lr.ph.i ], [ %.03184.i, %bb.c ], [ %i.s, %_ZNK5arrow5Datum5arrayEv.exit.i ], [ %i.w, %_ZNK5arrow5Datum13chunked_arrayEv.exit.i ], [ %.03184.i, %bb.d ] ; 2 uses
...
._crit_edge.loopexit.i:                           ; preds = %.thread.i
  %i.aa = tail call i64 @llvm.smax.i64(i64 %.637.ph.i, i64 0)
...
_ZN5arrow7compute6detail16InferBatchLengthERKSt6vectorINS_5DatumESaIS3_EEPb.exit.thread: ; preds = %bb.b, %._crit_edge.loopexit.i
  %.038.lcssa.i = phi i1 [ true, %bb.b ], [ %.442.ph.i, %._crit_edge.loopexit.i ]
  %.031.lcssa.i = phi i64 [ 0, %bb.b ], [ %i.aa, %._crit_edge.loopexit.i ]
  %.not49.i = icmp ne ptr %i.f, %i.g
  %or.cond.not.i = and i1 %.not49.i, %.038.lcssa.i
  %.8.i = select i1 %or.cond.not.i, i64 1, i64 %.031.lcssa.i
...
.lr.ph:                                           ; preds = %bb.a, %.thread
  %.03184 = phi i64 [ %.637.ph, %.thread ], [ -1, %bb.a ] ; 9 uses
  %.03883 = phi i1 [ %.442.ph, %.thread ], [ true, %bb.a ]
...
.thread:                                          ; preds = %.lr.ph, %bb.c, %_ZNK5arrow5Datum13chunked_arrayEv.exit, %bb.b, %_ZNK5arrow5Datum5arrayEv.exit
  %.442.ph = phi i1 [ %.03883, %.lr.ph ], [ false, %bb.b ], [ false, %_ZNK5arrow5Datum5arrayEv.exit ], [ false, %_ZNK5arrow5Datum13chunked_arrayEv.exit ], [ false, %bb.c ] ; 2 uses
  %.637.ph = phi i64 [ %.03184, %.lr.ph ], [ %.03184, %bb.b ], [ %i.i, %_ZNK5arrow5Datum5arrayEv.exit ], [ %i.m, %_ZNK5arrow5Datum13chunked_arrayEv.exit ], [ %.03184, %bb.c ] ; 2 uses
...
._crit_edge.loopexit:                             ; preds = %.thread
  %i.q = tail call i64 @llvm.smax.i64(i64 %.637.ph, i64 0)
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.a
  %.038.lcssa = phi i1 [ true, %bb.a ], [ %.442.ph, %._crit_edge.loopexit ]
  %.031.lcssa = phi i64 [ 0, %bb.a ], [ %i.q, %._crit_edge.loopexit ]
  %.not49 = icmp ne ptr %i.c, %i.a
  %or.cond.not = and i1 %.not49, %.038.lcssa
  %.8 = select i1 %or.cond.not, i64 1, i64 %.031.lcssa
  br label %.thread74

.thread74:                                        ; preds = %bb.c, %bb.b, %._crit_edge
  %.sink = phi i8 [ 1, %._crit_edge ], [ 0, %bb.b ], [ 0, %bb.c ]
  %.6 = phi i64 [ %.8, %._crit_edge ], [ %.03184, %bb.b ], [ %.03184, %bb.c ]
...
.lr.ph:                                           ; preds = %bb.b, %_ZNSt6vectorIPKN5arrow9ArraySpanESaIS3_EE9push_backEOS3_.exit
  ...
  %.sroa.21.0104 = phi ptr [ %.sroa.21.1.a, %_ZNSt6vectorIPKN5arrow9ArraySpanESaIS3_EE9push_backEOS3_.exit ], [ null, %bb.b ] ; 4 uses
...
bb.i:                                             ; preds = %_ZNSt6vectorIPKN5arrow9ArraySpanESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit16.i.i.i
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.056.0106, i64 noundef %i.w) #32
...
_ZNSt6vectorIPKN5arrow9ArraySpanESaIS3_EE9push_backEOS3_.exit: ; preds = %bb.e, %_ZNSt6vectorIPKN5arrow9ArraySpanESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i, %bb.c, %.lr.ph
  %.sroa.21.1.a = phi ptr [ %.sroa.21.0104, %.lr.ph ], [ %.sroa.21.0104, %bb.c ], [ %i.ai, %_ZNSt6vectorIPKN5arrow9ArraySpanESaIS3_EE17_M_realloc_insertIJS3_EEEvN9__gnu_cxx17__normal_iteratorIPS3_S5_EEDpOT_.exit.i.i ], [ %.sroa.21.0104, %bb.e ] ; 10 uses
...
bb.u:                                             ; preds = %bb.n, %bb.m, %bb.j
  ...
  %.sroa.21.0.lcssa134 = phi ptr [ %.sroa.21.0.lcssa131145, %bb.n ], [ %.sroa.21.0.lcssa131145, %bb.m ], [ %.sroa.21.1.a, %bb.j ]
...
.thread:                                          ; preds = %"_ZZN5arrow7compute6detail19PropagateNullsSpansERKNS0_8ExecSpanEPNS_9ArraySpanEENK3$_0clERKS5_S9_.exit48", %..thread_crit_edge, %"_ZZN5arrow7compute6detail19PropagateNullsSpansERKNS0_8ExecSpanEPNS_9ArraySpanEENK3$_0clERKS5_S9_.exit.preheader", %bb.p
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.056.0.lcssa138, i64 noundef %i.ch) #32
...
begin_hunk_12_@_ZN5arrow7compute6detail19PropagateNullsSpansERKNS0_8ExecSpanEPNS_9ArraySpanE:bb.a
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %.sroa.056.094, i64 noundef %i.cj) #32
...
bb.d:                                             ; preds = %bb.b
  ...
  %or.cond = select i1 %1, i1 true, i1 %i.o
  br i1 %or.cond, label %_ZN5arrow8internal24may_have_validity_bitmapENS_4Type4typeE.exit, label %2

2:                                                ; preds = %bb.d
  %3 = getelementptr inbounds nuw i8, ptr %0, i64 8
  %4 = load i64, ptr %3, align 8, !tbaa !293
  %5 = icmp ne i64 %i.l, %4
  %cond.fr = freeze i1 %5
...
_ZN5arrow8internal24may_have_validity_bitmapENS_4Type4typeE.exit: ; preds = %2, %bb.a, %_ZN5arrow8internal24may_have_validity_bitmapENS_4Type4typeE.exit.fold.split, %bb.d, %bb.c
  %.1 = phi i32 [ 2, %bb.a ], [ %i.j, %bb.c ], [ 1, %bb.d ], [ %spec.select, %2 ], [ 1, %_ZN5arrow8internal24may_have_validity_bitmapENS_4Type4typeE.exit.fold.split ]
  ret i32 %.1
}
