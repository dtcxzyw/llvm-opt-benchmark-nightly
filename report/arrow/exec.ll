...
.loopexit.split-lp:                               ; preds = %.lr.ph.i9.i
...
.body:                                            ; preds = %.invoke, %_ZN5arrow6StatusD2Ev.exit51.i.i.invoke, %bb.by, %bb.bx, %_ZN5arrow6StatusD2Ev.exit.i1.i, %bb.bh, %bb.at, %bb.ai, %_ZN5arrow6StatusD2Ev.exit.i.i
  %lpad.loopexit.split-lp = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %.val = load ptr, ptr %i.m, align 8, !tbaa !392 ; 2 uses
...
_ZN5arrow7compute6detail12_GLOBAL__N_114NullPropagatorD2Ev.exit27: ; preds = %.body, %bb.ca
  %eh.lpad-body98 = phi { ptr, i32 } [ %lpad.loopexit.split-lp, %.body ], [ %eh.lpad-body97, %bb.ca ]
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #27
  br label %common.resume
