...
vector.scevcheck:                                 ; preds = %iter.check
  ...
  %mul.result = shl i64 %i.g, 1                   ; 2 uses
  %mul.overflow = icmp slt i64 %i.g, 0
  ...
  %i.l = getelementptr i8, ptr %scevgep119, i64 %mul.result
  %i.m = icmp ult ptr %i.l, %scevgep119
  %i.n = or i1 %i.m, %mul.overflow
  %i.o = or i1 %i.j, %i.n
...
vector.scevcheck:                                 ; preds = %iter.check
  %i.j = xor i64 %i.g, -1
  %i.k = add i64 %2, %i.j                         ; 2 uses
  %i.l = shl i64 %i.f, 6                          ; 4 uses
  %scevgep = getelementptr i8, ptr %0, i64 %i.l   ; 2 uses
  %mul.result = shl i64 %i.k, 2                   ; 4 uses
  %mul.overflow = icmp ugt i64 %i.k, 4611686018427387903
  ...
  %i.p = getelementptr i8, ptr %scevgep131, i64 %mul.result
  %i.q = icmp ult ptr %i.p, %scevgep131
  %i.r = getelementptr i8, ptr %0, i64 %i.l
  %scevgep135.a = getelementptr i8, ptr %i.r, i64 2 ; 2 uses
  %i.s = getelementptr i8, ptr %scevgep135.a, i64 %mul.result
  %i.t = icmp ult ptr %i.s, %scevgep135.a
  %4 = or i1 %i.t, %mul.overflow
  %scevgep139.a = getelementptr i8, ptr %0, i64 %i.l
  %scevgep133 = getelementptr i8, ptr %scevgep139.a, i64 3 ; 2 uses
  %i.u = getelementptr i8, ptr %scevgep133, i64 %mul.result
  %i.v = icmp ult ptr %i.u, %scevgep133
  %i.w = or i1 %i.q, %i.n
  %i.x = or i1 %i.w, %4
  %i.y = or i1 %i.v, %i.x
...
vector.scevcheck:                                 ; preds = %iter.check
  %i.r = xor i64 %i.o, -1
  %i.s = add i64 %2, %i.r                         ; 2 uses
  %i.t = shl i64 %i.n, 7                          ; 8 uses
  %scevgep = getelementptr i8, ptr %0, i64 %i.t   ; 2 uses
  %mul.result = shl i64 %i.s, 3                   ; 8 uses
  %mul.overflow = icmp ugt i64 %i.s, 2305843009213693951
  ...
  %i.x = getelementptr i8, ptr %scevgep151, i64 %mul.result
  %i.y = icmp ult ptr %i.x, %scevgep151
  %i.z = getelementptr i8, ptr %0, i64 %i.t
  %scevgep155.a = getelementptr i8, ptr %i.z, i64 2 ; 2 uses
  %i.aa = getelementptr i8, ptr %scevgep155.a, i64 %mul.result
  %i.ab = icmp ult ptr %i.aa, %scevgep155.a
  %4 = or i1 %i.ab, %mul.overflow
  %scevgep159.a = getelementptr i8, ptr %0, i64 %i.t
  %scevgep153 = getelementptr i8, ptr %scevgep159.a, i64 3 ; 2 uses
  %i.ac = getelementptr i8, ptr %scevgep153, i64 %mul.result
  %i.ad = icmp ult ptr %i.ac, %scevgep153
  %i.ae = getelementptr i8, ptr %0, i64 %i.t
  %scevgep163.a = getelementptr i8, ptr %i.ae, i64 4 ; 2 uses
  %i.af = getelementptr i8, ptr %scevgep163.a, i64 %mul.result
  ...
  %i.ai = getelementptr i8, ptr %scevgep167.a, i64 %mul.result
  ...
  %i.al = getelementptr i8, ptr %scevgep171.a, i64 %mul.result
  ...
  %i.ao = getelementptr i8, ptr %scevgep175.a, i64 %mul.result
