...
bb.d:                                             ; preds = %.thread297, %bb.c
  ...
  %i.i = getelementptr inbounds nuw i8, ptr %.0186, i64 8 ; 6 uses
...
bb.ah:                                            ; preds = %bb.af
  ...
  %i.bv = tail call ptr %i.bu(ptr noundef %3, i64 noundef 1, i64 noundef 32) #11 ; 5 uses
...
bb.am:                                            ; preds = %bb.ah
  store ptr @.str, ptr %i.bv, align 8, !tbaa !22
  %4 = getelementptr inbounds nuw i8, ptr %i.bv, i64 8
  store ptr @.str, ptr %4, align 8, !tbaa !21
  store ptr %i.bv, ptr %i.br, align 8, !tbaa !24
  store ptr %i.bv, ptr %i.g, align 8, !tbaa !34
  br label %bb.an
...
bb.ay:                                            ; preds = %bb.ax, %bb.aw
  store ptr @.str, ptr %.0186, align 8, !tbaa !22
  store ptr @.str, ptr %i.i, align 8, !tbaa !21
  store ptr %.0186, ptr %i.b, align 8, !tbaa !18
  store ptr %.0186, ptr %i.g, align 8, !tbaa !34
  br label %bb.az
...
.thread297:                                       ; preds = %bb.ar, %bb.bc, %bb.o, %.thread305, %bb.bi
  ...
  br i1 %.not256, label %.thread297.thread, label %bb.d, !llvm.loop !35
...
bb.e:                                             ; preds = %.preheader
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.f, ptr noundef nonnull align 8 dereferenceable(16) %.030, i64 16, i1 false), !tbaa.struct !37
...
.thread38:                                        ; preds = %bb.h
  ...
  store ptr %i.f, ptr %i.l, align 8, !tbaa !34
...
bb.a:
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.a, ptr noundef nonnull align 8 dereferenceable(16) %i.b, i64 16, i1 false), !tbaa.struct !37
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 32
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.c, ptr noundef nonnull align 8 dereferenceable(16) %i.d, i64 16, i1 false), !tbaa.struct !37
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.q = load ptr, ptr %2, align 8, !tbaa !36
...
begin_hunk_12_@uriCopyAuthorityA:bb.a
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.w, ptr noundef nonnull align 8 dereferenceable(16) %i.x, i64 16, i1 false), !tbaa.struct !37
  br label %bb.h

bb.h:                                             ; preds = %bb.f, %bb.g, %bb.c
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 80
  %i.z = getelementptr inbounds nuw i8, ptr %1, i64 80
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.y, ptr noundef nonnull align 8 dereferenceable(16) %i.z, i64 16, i1 false), !tbaa.struct !37
  br label %bb.i
...
bb.h:                                             ; preds = %bb.c, %bb.g
  %i.s = load ptr, ptr %1, align 8, !tbaa !36
...
bb.ah:                                            ; preds = %bb.af
  ...
  %i.bx = tail call ptr %i.bw(ptr noundef %3, i64 noundef 1, i64 noundef 32) #11 ; 5 uses
...
bb.am:                                            ; preds = %bb.ah
  store ptr @.str.3, ptr %i.bx, align 8, !tbaa !54
  %4 = getelementptr inbounds nuw i8, ptr %i.bx, i64 8
  store ptr @.str.3, ptr %4, align 8, !tbaa !53
  store ptr %i.bx, ptr %i.bt, align 8, !tbaa !55
  store ptr %i.bx, ptr %i.g, align 8, !tbaa !61
  br label %bb.an
...
bb.ay:                                            ; preds = %bb.ax, %bb.aw
  ...
  store ptr @.str.3, ptr %i.i, align 8, !tbaa !53
  store ptr %.0186, ptr %i.b, align 8, !tbaa !50
  store ptr %.0186, ptr %i.g, align 8, !tbaa !61
  br label %bb.az
...
.thread297:                                       ; preds = %bb.ar, %bb.bc, %bb.o, %.thread305, %bb.bi
  ...
  %.not256 = icmp eq ptr %.6192.ph, null
  br i1 %.not256, label %.thread297.thread, label %bb.d, !llvm.loop !62
...
bb.e:                                             ; preds = %.preheader
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.f, ptr noundef nonnull align 8 dereferenceable(16) %.030, i64 16, i1 false), !tbaa.struct !63
  %i.h = icmp eq ptr %.028, null
  br i1 %i.h, label %bb.f, label %bb.g
...
.thread38:                                        ; preds = %bb.h
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 104
  store ptr %i.f, ptr %i.l, align 8, !tbaa !61
  %i.m = getelementptr inbounds nuw i8, ptr %i.f, i64 16
...
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.b = getelementptr inbounds nuw i8, ptr %1, i64 16
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.a, ptr noundef nonnull align 8 dereferenceable(16) %i.b, i64 16, i1 false), !tbaa.struct !63
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 32
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.c, ptr noundef nonnull align 8 dereferenceable(16) %i.d, i64 16, i1 false), !tbaa.struct !63
  %i.e = getelementptr inbounds nuw i8, ptr %1, i64 48 ; 2 uses
...
begin_hunk_26_@uriCopyAuthorityW:bb.a
  ...
  %i.x = getelementptr inbounds nuw i8, ptr %1, i64 64
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.p, i8 0, i64 16, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.w, ptr noundef nonnull align 8 dereferenceable(16) %i.x, i64 16, i1 false), !tbaa.struct !63
  br label %bb.h

bb.h:                                             ; preds = %bb.f, %bb.g, %bb.c
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 80
  %i.z = getelementptr inbounds nuw i8, ptr %1, i64 80
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.y, ptr noundef nonnull align 8 dereferenceable(16) %i.z, i64 16, i1 false), !tbaa.struct !63
  br label %bb.i
