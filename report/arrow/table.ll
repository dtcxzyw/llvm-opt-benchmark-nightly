...
_ZNSt12_Vector_baseISt10shared_ptrIN5arrow5TableEESaIS3_EE11_M_allocateEm.exit.i: ; preds = %bb.t
  ...
  %i.bi = load ptr, ptr %22, align 8, !tbaa !286  ; 3 uses
...
_ZNSt12_Vector_baseISt10shared_ptrIN5arrow5TableEESaIS3_EE13_M_deallocateEPS3_m.exit.i: ; preds = %bb.u, %_ZNSt6vectorISt10shared_ptrIN5arrow5TableEESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit.i
  ...
  store ptr %i.bq, ptr %22, align 8, !tbaa !286
...
24:                                               ; preds = %_ZN5arrow6ResultISt10shared_ptrINS_5TableEEED2Ev.exit
  %25 = getelementptr inbounds nuw i8, ptr %.sroa.0265.0282, i64 16 ; 2 uses
  %26 = icmp eq ptr %25, %i.bs
  br i1 %26, label %._crit_edge284.loopexit, label %bb.w
...
bb.w:                                             ; preds = %.lr.ph283, %24
  %.sroa.0265.0282 = phi ptr [ %i.bt, %.lr.ph283 ], [ %25, %24 ] ; 2 uses
  %i.by = load ptr, ptr %23, align 8, !tbaa !286  ; 3 uses
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.ca = load ptr, ptr %23, align 8, !tbaa !286
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 16
  store ptr %i.cb, ptr %23, align 8, !tbaa !286
...
bb.ad:                                            ; preds = %bb.z
  ...
  %i.ch = load ptr, ptr %23, align 8, !tbaa !312  ; 2 uses
...
_ZN5arrow6ResultISt10shared_ptrINS_5TableEEED2Ev.exit: ; preds = %bb.ak, %_ZN5arrow6ResultISt10shared_ptrINS_5TableEEE7DestroyEv.exit.i, %_ZN5arrow6ResultISt10shared_ptrINS_5TableEEE7DestroyEv.exit.thread.i, %bb.ar
  ...
  br i1 %i.cd, label %24, label %._crit_edge284.loopexit

._crit_edge284.loopexit:                          ; preds = %24, %_ZN5arrow6ResultISt10shared_ptrINS_5TableEEED2Ev.exit
...
._crit_edge284:                                   ; preds = %._crit_edge284.loopexit, %_ZNSt6vectorISt10shared_ptrIN5arrow5TableEESaIS3_EE7reserveEm.exit
  ...
  %spec.select = phi ptr [ %6, %_ZNSt6vectorISt10shared_ptrIN5arrow5TableEESaIS3_EE7reserveEm.exit ], [ %spec.select.ph, %._crit_edge284.loopexit ]
  %.not.i.i115 = icmp eq ptr %i.dw, null
  br i1 %.not.i.i115, label %bb.ax, label %bb.as
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i117: ; preds = %bb.aw, %bb.av
  ...
  br i1 %i.el, label %27, label %bb.ax, !prof !65

27:                                               ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i117
...
bb.ax:                                            ; preds = %._crit_edge284, %bb.at, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i117, %27
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #28
  br label %_ZNSt12__shared_ptrIN5arrow6SchemaELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit

_ZNSt12__shared_ptrIN5arrow6SchemaELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit: ; preds = %bb.ax, %.critedge.a
  %.373 = phi i1 [ false, %.critedge.a ], [ %.lcssa275, %bb.ax ]
  %.1 = phi ptr [ %1, %.critedge.a ], [ %spec.select, %bb.ax ]
...
bb.ay:                                            ; preds = %_ZNSt12__shared_ptrIN5arrow6SchemaELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit
  ...
  br i1 %.not.i.i.i.i.i119, label %_ZN5arrow6ResultISt10shared_ptrINS_6SchemaEEE7DestroyEv.exit.i, label %bb.az
...
_ZN5arrow6ResultISt10shared_ptrINS_6SchemaEEE7DestroyEv.exit.i: ; preds = %bb.be, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i121, %bb.ba, %bb.ay
...
_ZN5arrow6ResultISt10shared_ptrINS_6SchemaEEED2Ev.exit: ; preds = %_ZN5arrow6ResultISt10shared_ptrINS_6SchemaEEE7DestroyEv.exit.i, %_ZN5arrow6ResultISt10shared_ptrINS_6SchemaEEE7DestroyEv.exit.thread.i, %bb.bf
...
_ZNSt6vectorISt10shared_ptrIN5arrow6SchemaEESaIS3_EED2Ev.exit: ; preds = %_ZSt8_DestroyIPSt10shared_ptrIN5arrow6SchemaEES3_EvT_S5_RSaIT0_E.exit.i, %bb.bm
  ...
  br i1 %.373, label %bb.ct, label %bb.eo
...
bb.ct:                                            ; preds = %_ZNSt12__shared_ptrIN5arrow6SchemaELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit150, %_ZNSt6vectorISt10shared_ptrIN5arrow6SchemaEESaIS3_EED2Ev.exit
  %.2 = phi ptr [ %.1, %_ZNSt6vectorISt10shared_ptrIN5arrow6SchemaEESaIS3_EED2Ev.exit ], [ %1, %_ZNSt12__shared_ptrIN5arrow6SchemaELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit150 ] ; 3 uses
...
begin_hunk_16
  ...
  %i.md = load ptr, ptr %29, align 8, !tbaa !312  ; 2 uses
...
bb.eo:                                            ; preds = %_ZNSt12__shared_ptrIN5arrow6SchemaELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit139, %_ZNSt6vectorISt10shared_ptrIN5arrow6SchemaEESaIS3_EED2Ev.exit, %_ZNSt12__shared_ptrIN5arrow6SchemaELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit227
  %i.rg = load ptr, ptr %6, align 8, !tbaa !289   ; 3 uses
  %30 = getelementptr inbounds nuw i8, ptr %6, i64 8
  %i.rh = load ptr, ptr %30, align 8, !tbaa !286  ; 2 uses
