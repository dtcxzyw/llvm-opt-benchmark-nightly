...
bb.a:
  ...
  %3 = load i128, ptr %1, align 8
  %.not9.i.i.i.i.i = icmp ne i128 %2, %3          ; 2 uses
  %4 = zext i1 %.not9.i.i.i.i.i to i32            ; 0 uses
...
bb.a:
  ...
  %7 = load i128, ptr %5, align 8
  %8 = load i128, ptr %6, align 8
  %9 = xor i128 %7, %8
  %10 = or i128 %4, %9
  %.not9.i.i.i.i.i = icmp ne i128 %10, 0          ; 2 uses
  %11 = zext i1 %.not9.i.i.i.i.i to i32           ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #11
  ret i1 %.not9.i.i.i.i.i
}
...
bb.d:                                             ; preds = %bb.c
  ...
  %8 = icmp ne i128 %6, %7
  %9 = zext i1 %8 to i32
  %bcmp.i.i.i.i.i.i.i.fr = freeze i32 %9
...
bb.d:                                             ; preds = %bb.c
  ...
  %8 = load i128, ptr %5, align 8
  %9 = xor i128 %7, %8
  %10 = getelementptr i8, ptr %4, i64 16
  %11 = getelementptr i8, ptr %5, i64 16
  %12 = load i128, ptr %10, align 8
  %13 = load i128, ptr %11, align 8
  %14 = xor i128 %12, %13
  %15 = or i128 %9, %14
  %.not9.i.i.i.i.i.i.i = icmp ne i128 %15, 0      ; 2 uses
  %16 = zext i1 %.not9.i.i.i.i.i.i.i to i32       ; 0 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #11
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #11
