...
_ZN5arrow15BasicDecimal2563AbsERKS0_.exit:        ; preds = %bb.a, %bb.b
  ...
  %.sroa.8.0.i = phi i64 [ %i.o, %bb.b ], [ %.sroa.8.0.copyload.i, %bb.a ] ; 2 uses
  %.sroa.6.0.i = phi i64 [ %i.k, %bb.b ], [ %.sroa.6.0.copyload.i, %bb.a ] ; 2 uses
...
_ZN5arrow15BasicDecimal2563AbsERKS0_.exit17:      ; preds = %_ZN5arrow15BasicDecimal2563AbsERKS0_.exit, %bb.c
  ...
  %.sroa.8.0.i11 = phi i64 [ %i.ac, %bb.c ], [ %.sroa.8.0.copyload.i7, %_ZN5arrow15BasicDecimal2563AbsERKS0_.exit ] ; 2 uses
  %.sroa.6.0.i12 = phi i64 [ %i.y, %bb.c ], [ %.sroa.6.0.copyload.i5, %_ZN5arrow15BasicDecimal2563AbsERKS0_.exit ] ; 2 uses
  %.sroa.0.0.i13 = phi i64 [ %i.u, %bb.c ], [ %.sroa.0.0.copyload.i3, %_ZN5arrow15BasicDecimal2563AbsERKS0_.exit ] ; 2 uses
  %i.ah = zext i64 %.sroa.0.0.i to i128           ; 3 uses
  %i.ai = zext i64 %.sroa.0.0.i13 to i128         ; 3 uses
  %i.aj = mul nuw i128 %i.ai, %i.ah               ; 2 uses
  %i.ak = trunc i128 %i.aj to i64                 ; 3 uses
  %i.al = lshr i128 %i.aj, 64
  %i.am = zext i64 %.sroa.6.0.i to i128           ; 2 uses
  %i.an = mul nuw i128 %i.ai, %i.am
  %i.ao = add nuw i128 %i.al, %i.an               ; 2 uses
  %i.ap = lshr i128 %i.ao, 64
  %i.aq = zext i64 %.sroa.8.0.i to i128
  %i.ar = mul nuw i128 %i.ai, %i.aq
  %i.as = add nuw i128 %i.ap, %i.ar               ; 2 uses
  %i.at = lshr i128 %i.as, 64
  %2 = mul i64 %.sroa.0.0.i13, %.sroa.10.0.i
  %3 = trunc nuw i128 %i.at to i64
  %i.au = zext i64 %.sroa.6.0.i12 to i128         ; 2 uses
  ...
  %4 = mul i64 %.sroa.6.0.i12, %.sroa.8.0.i
  %5 = trunc nuw i128 %i.be to i64
  %i.bf = zext i64 %.sroa.8.0.i11 to i128
  ...
  %6 = mul i64 %.sroa.8.0.i11, %.sroa.6.0.i
  %7 = trunc nuw i128 %i.bk to i64
  %8 = mul i64 %.sroa.10.0.i10, %.sroa.0.0.i
  %9 = add i64 %6, %8
  %10 = add i64 %9, %4
  %11 = add i64 %10, %2
  %12 = add i64 %11, %3
  %13 = add i64 %12, %5
  %i.bl = add i64 %13, %7                         ; 2 uses
