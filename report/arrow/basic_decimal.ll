...
bb.ac:                                            ; preds = %bb.q
  %i.ea = sub nsw i64 %i.ae, %.0.i109.i.a         ; 4 uses
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %exitcond.not.i114.i = icmp eq i64 %i.fc, %.pre12
...
._crit_edge.i117.i:                               ; preds = %._crit_edge.i117.loopexit.i, %_ZN5arrowL14ShiftArrayLeftEPjll.exit.thread.i
  %i.fh = phi i32 [ %.pre.i, %._crit_edge.i117.loopexit.i ], [ %i.z, %_ZN5arrowL14ShiftArrayLeftEPjll.exit.thread.i ]
...
.lr.ph.i118.i:                                    ; preds = %.lr.ph.i118.i.preheader40, %.lr.ph.i118.i
  %i.fj = phi i32 [ %i.fo, %.lr.ph.i118.i ], [ %.ph, %.lr.ph.i118.i.preheader40 ]
  %.019.i120.i = phi i64 [ %i.fm, %.lr.ph.i118.i ], [ %.019.i120.i.ph, %.lr.ph.i118.i.preheader40 ] ; 2 uses
  %i.fk = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %.019.i120.i
  %i.fl = shl i32 %i.fj, %i.eb
  %i.fm = add nuw nsw i64 %.019.i120.i, 1         ; 3 uses
  ...
  %exitcond.not.i121.i = icmp eq i64 %i.fm, %.0.i.i
...
bb.ad:                                            ; preds = %.lr.ph.i126.i
  ...
  %i.gt = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %.0.i127.i.1 ; 2 uses
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.ha = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %.0.i127.i.2 ; 2 uses
  %i.hb = load i32, ptr %i.ha, align 4, !tbaa !3
  %i.hc = lshr i32 %i.hb, %i.eb
  %i.hd = getelementptr [4 x i8], ptr %i.b, i64 %.0.i127.i.1
...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.hm = getelementptr [4 x i8], ptr %i.b, i64 %.0.i127.i.2
...
.lr.ph.preheader.i.i.i:                           ; preds = %_ZN5arrowL15ShiftArrayRightEPjll.exit.i
  ...
  %.not.i.i132.i = icmp eq i32 %i.hs, 0
...
.lr.ph36.i.i.thread.i:                            ; preds = %.lr.ph.preheader.i.i.i
  ...
  %i.ib = zext i32 %.pre.i12955.i to i64
...
.preheader.i.thread28.i.i:                        ; preds = %.lr.ph36.i.i.i, %.lr.ph36.i.i.thread.i
  ...
  %i.io = getelementptr i8, ptr %.phi.trans.insert.i56.i, i64 -4
...
.lr.ph36.i.i.i:                                   ; preds = %bb.ag
  ...
  %i.iu = zext i32 %.pre.i129.i to i64            ; 2 uses
  %i.iv = icmp eq i64 %i.it, 0
  br i1 %i.iv, label %bb.aq, label %.preheader.i.thread28.i.i

bb.ah:                                            ; preds = %._crit_edge.thread.i, %.lr.ph38.i
  %.08437.i = phi i64 [ 0, %.lr.ph38.i ], [ %i.iy, %._crit_edge.thread.i ] ; 3 uses
  %i.iw = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %.08437.i ; 12 uses
  %i.ix = load i32, ptr %i.iw, align 4, !tbaa !3  ; 4 uses
  %i.iy = add nuw nsw i64 %.08437.i, 1            ; 3 uses
...
._crit_edge.i:                                    ; preds = %bb.ap, %bb.ao, %bb.an, %.lr.ph.i
  ...
  br i1 %i.kj, label %.lr.ph34.i, label %._crit_edge.thread.i
...
._crit_edge35.i:                                  ; preds = %.lr.ph34.i.3, %.lr.ph34.i.2, %.lr.ph34.i.1, %.lr.ph34.i
  %.lcssa = phi i64 [ %i.mb, %.lr.ph34.i ], [ %i.ml, %.lr.ph34.i.1 ], [ %i.mv, %.lr.ph34.i.2 ], [ %i.nf, %.lr.ph34.i.3 ]
  %i.lu = add i32 %.2.i, -1
...
._crit_edge.thread.i:                             ; preds = %._crit_edge35.i, %._crit_edge.i, %bb.am
  %.3.i = phi i32 [ %i.lu, %._crit_edge35.i ], [ %.2.i, %._crit_edge.i ], [ %.2.i, %bb.am ]
  %i.ng = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %.08437.i
...
.lr.ph.preheader.i.i148.i:                        ; preds = %bb.aq
  ...
  %.not.i.i151.i = icmp eq i32 %i.ni, 0
...
.preheader.i.thread28.i140.i:                     ; preds = %.lr.ph36.i.i137.i
  %i.nq = getelementptr i8, ptr %.phi.trans.insert.i138.i, i64 -4
...
.lr.ph36.i.i137.i:                                ; preds = %bb.ar
  ...
  %.phi.trans.insert.i138.i = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %i.nv ; 2 uses
  %.pre.i139.i = load i32, ptr %.phi.trans.insert.i138.i, align 4, !tbaa !3
  %i.nw = zext i32 %.pre.i139.i to i64            ; 2 uses
  %i.nx = icmp eq i64 %i.nv, 0
  br i1 %i.nx, label %bb.as, label %.preheader.i.thread28.i140.i

bb.as:                                            ; preds = %.lr.ph36.i.i137.i, %.preheader.i.thread28.i140.i, %bb.ar, %._crit_edge.i.i134.i
  %.sroa.0.i133.0.i = phi i64 [ %i.np, %.preheader.i.thread28.i140.i ], [ %i.np, %bb.ar ], [ %i.np, %.lr.ph36.i.i137.i ], [ %i.nk, %._crit_edge.i.i134.i ]
  %.sink.i142.i = phi i64 [ %i.nu, %.preheader.i.thread28.i140.i ], [ 0, %bb.ar ], [ %i.nw, %.lr.ph36.i.i137.i ], [ 0, %._crit_edge.i.i134.i ]
...
bb.at:                                            ; preds = %bb.as
  ...
  %i.ny = load i64, ptr %.sroa.4.0..sroa_idx.i130.i, align 8, !tbaa !9 ; 2 uses
  %29 = xor i64 %i.ny, -1
  %30 = icmp eq i64 %28, 0
  %31 = sub i64 0, %i.ny
  %32 = sub i64 0, %28
...
bb.av:                                            ; preds = %bb.au
  ...
  %i.nz = load i64, ptr %.sroa.4.0..sroa_idx.i144.i, align 8, !tbaa !9 ; 2 uses
  %34 = xor i64 %i.nz, -1
  %35 = icmp eq i64 %33, 0
  %36 = sub i64 0, %i.nz
  %37 = sub i64 0, %33
