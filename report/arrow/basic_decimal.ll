...
bb.a:
  ...
  %.035.i.i.i.i.lcssa.sroa.gep179 = getelementptr inbounds nuw i8, ptr %6, i64 8
  %.035.i.i.i.i.lcssa.sroa.gep180 = getelementptr inbounds nuw i8, ptr %6, i64 16
  %.035.i.i.i.i.lcssa.sroa.gep181 = getelementptr inbounds nuw i8, ptr %6, i64 24
  %.035.i.i.i.lcssa.sroa.gep182 = getelementptr inbounds nuw i8, ptr %5, i64 8
  %.035.i.i.i.lcssa.sroa.gep183 = getelementptr inbounds nuw i8, ptr %5, i64 16
  %.035.i.i.i.lcssa.sroa.gep184 = getelementptr inbounds nuw i8, ptr %5, i64 24
  %.035.i.i144.i.lcssa.sroa.gep185 = getelementptr inbounds nuw i8, ptr %4, i64 8
  %.035.i.i144.i.lcssa.sroa.gep186 = getelementptr inbounds nuw i8, ptr %4, i64 16
  %.035.i.i144.i.lcssa.sroa.gep187 = getelementptr inbounds nuw i8, ptr %4, i64 24
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.i.i.unr-lcssa, %.epil.preheader
  %.lcssa168 = phi i64 [ %i.gd, %._crit_edge.i.i.unr-lcssa ], [ %20, %.epil.preheader ]
...
.lr.ph.i.i.i.preheader.i:                         ; preds = %._crit_edge.i.i
  %i.dx = add nsw i64 %.120.lcssa.i.i.i, -8
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.p, %.lr.ph.i.i.i.preheader.i
  %.02533.i.i.i.i = phi i64 [ %i.dy, %bb.p ], [ %i.dx, %.lr.ph.i.i.i.preheader.i ] ; 3 uses
...
.thread.i.i.i.i:                                  ; preds = %.lr.ph37.i.i.i.i.3, %.lr.ph37.i.i.i.i.2, %.lr.ph37.i.i.i.i.1, %.lr.ph37.i.i.i.i
  %.035.i.i.i.i.lcssa.sroa.phi = phi ptr [ %6, %.lr.ph37.i.i.i.i ], [ %.035.i.i.i.i.lcssa.sroa.gep179, %.lr.ph37.i.i.i.i.1 ], [ %.035.i.i.i.i.lcssa.sroa.gep180, %.lr.ph37.i.i.i.i.2 ], [ %.035.i.i.i.i.lcssa.sroa.gep181, %.lr.ph37.i.i.i.i.3 ]
  %.035.i.i.i.i.lcssa = phi i64 [ 1, %.lr.ph37.i.i.i.i ], [ 2, %.lr.ph37.i.i.i.i.1 ], [ 3, %.lr.ph37.i.i.i.i.2 ], [ 4, %.lr.ph37.i.i.i.i.3 ]
  %.lcssa164 = phi i64 [ %i.eh, %.lr.ph37.i.i.i.i ], [ %i.er, %.lr.ph37.i.i.i.i.1 ], [ %i.fc, %.lr.ph37.i.i.i.i.2 ], [ %i.fn, %.lr.ph37.i.i.i.i.3 ]
...
bb.r:                                             ; preds = %.lr.ph37.i.i.i.i.1
  ...
  %.not188 = icmp eq i64 %i.ej, 1
  br i1 %.not188, label %.preheader.i.i.i.i, label %.lr.ph37.i.i.i.i.2
...
bb.s:                                             ; preds = %.lr.ph37.i.i.i.i.2
  ...
  %.not189 = icmp eq i64 %i.et, 1
  br i1 %.not189, label %.preheader.i.i.i.i, label %.lr.ph37.i.i.i.i.3
...
bb.z:                                             ; preds = %bb.o
  %i.ht = sub i64 %i.bm, %.120.lcssa.i.i111.i     ; 8 uses
...
vector.ph106:                                     ; preds = %.lr.ph.i120.i
  %n.vec107 = and i64 %i.hy, -8                   ; 3 uses
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %i.hz, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  %broadcast.splatinsert108 = insertelement <4 x i32> poison, i32 %i.hv, i64 0
...
vector.body110:                                   ; preds = %vector.body110, %vector.ph106
  ...
  %i.ia = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %index111 ; 2 uses
  %i.ib = getelementptr inbounds nuw [4 x i8], ptr %i.c, i64 %index111 ; 2 uses
  %i.ic = getelementptr inbounds nuw i8, ptr %i.ib, i64 4
  %i.id = getelementptr inbounds nuw i8, ptr %i.ib, i64 20
  %wide.load112 = load <4 x i32>, ptr %i.ic, align 4, !tbaa !6 ; 3 uses
  %wide.load113 = load <4 x i32>, ptr %i.id, align 4, !tbaa !6 ; 4 uses
  %i.ie = shufflevector <4 x i32> %vector.recur, <4 x i32> %wide.load112, <4 x i32> <i32 3, i32 4, i32 5, i32 6>
  %i.if = shufflevector <4 x i32> %wide.load112, <4 x i32> %wide.load113, <4 x i32> <i32 3, i32 4, i32 5, i32 6>
  %i.ig = shl <4 x i32> %i.ie, %broadcast.splat109
  %i.ih = shl <4 x i32> %i.if, %broadcast.splat109
  %i.ii = lshr <4 x i32> %wide.load112, %broadcast.splat
  %i.ij = lshr <4 x i32> %wide.load113, %broadcast.splat
  ...
  %i.in = icmp eq i64 %index.next114, %n.vec107
  br i1 %i.in, label %middle.block115, label %vector.body110, !llvm.loop !43

middle.block115:                                  ; preds = %vector.body110
  %vector.recur.extract = extractelement <4 x i32> %wide.load113, i64 3
  %cmp.n116 = icmp eq i64 %i.hy, %n.vec107
...
scalar.ph104.preheader:                           ; preds = %.lr.ph.i120.i, %middle.block115
  %.ph163 = phi i32 [ %i.hu, %.lr.ph.i120.i ], [ %vector.recur.extract, %middle.block115 ]
...
scalar.ph104:                                     ; preds = %scalar.ph104.preheader, %scalar.ph104
  %i.ir = phi i32 [ %i.iw, %scalar.ph104 ], [ %.ph163, %scalar.ph104.preheader ]
  %.019.i.i = phi i64 [ %i.iu, %scalar.ph104 ], [ %.019.i.i.ph, %scalar.ph104.preheader ] ; 2 uses
...
vector.ph120:                                     ; preds = %.lr.ph.i125.i
  ...
  %broadcast.splatinsert122 = insertelement <4 x i32> poison, i32 %i.ja, i64 0
  %broadcast.splat123 = shufflevector <4 x i32> %broadcast.splatinsert122, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  %broadcast.splatinsert124 = insertelement <4 x i32> poison, i32 %i.hv, i64 0
...
vector.body126:                                   ; preds = %vector.body126, %vector.ph120
  ...
  %i.jb = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %index127 ; 2 uses
  %i.jc = getelementptr inbounds nuw [4 x i8], ptr %i.b, i64 %index127 ; 2 uses
  %i.jd = getelementptr inbounds nuw i8, ptr %i.jc, i64 4
  %i.je = getelementptr inbounds nuw i8, ptr %i.jc, i64 20
  %wide.load129 = load <4 x i32>, ptr %i.jd, align 4, !tbaa !6 ; 3 uses
  %wide.load130 = load <4 x i32>, ptr %i.je, align 4, !tbaa !6 ; 4 uses
  %i.jf = shufflevector <4 x i32> %vector.recur128, <4 x i32> %wide.load129, <4 x i32> <i32 3, i32 4, i32 5, i32 6>
  %i.jg = shufflevector <4 x i32> %wide.load129, <4 x i32> %wide.load130, <4 x i32> <i32 3, i32 4, i32 5, i32 6>
  %i.jh = shl <4 x i32> %i.jf, %broadcast.splat125
  %i.ji = shl <4 x i32> %i.jg, %broadcast.splat125
  %i.jj = lshr <4 x i32> %wide.load129, %broadcast.splat123
  %i.jk = lshr <4 x i32> %wide.load130, %broadcast.splat123
  ...
  %i.jo = icmp eq i64 %index.next131, %n.vec121
  br i1 %i.jo, label %middle.block132, label %vector.body126, !llvm.loop !45
