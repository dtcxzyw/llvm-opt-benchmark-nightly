...
.critedge:                                        ; preds = %bb.aa, %bb.x, %bb.y, %bb.s, %bb.o, %bb.e, %bb.f, %bb.h, %bb.n, %.split97.us, %bb.ad, %.split97.us.thread129
  %.2 = phi i32 [ 0, %.split97.us ], [ 0, %.split97.us.thread129 ], [ 0, %bb.ad ], [ 4, %bb.e ], [ 4, %bb.n ], [ 0, %bb.o ], [ 4, %bb.h ], [ 4, %bb.f ], [ 4, %bb.s ], [ 4, %bb.y ], [ 4, %bb.x ], [ 4, %bb.aa ]
  ret i32 %.2
}
