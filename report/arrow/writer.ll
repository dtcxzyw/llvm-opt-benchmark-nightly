...
bb.avl:                                           ; preds = %tailrecurse
  %i.fid = getelementptr inbounds nuw i8, ptr %.tr1792, i64 8 ; 7 uses
  ...
  %186 = load ptr, ptr %i.fid, align 8, !tbaa !115, !noalias !1319 ; 4 uses
  %i.fie = getelementptr inbounds nuw i8, ptr %186, i64 16
...
bb.avm:                                           ; preds = %bb.avl
  %i.fih = getelementptr inbounds nuw i8, ptr %186, i64 40
