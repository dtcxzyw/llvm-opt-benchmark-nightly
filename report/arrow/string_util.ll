...
define void @_ZN5arrow8internal19StringStreamWrapperC2Ev(ptr noundef nonnull writeonly align 8 captures(none) dereferenceable(16) %0) unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.a:
  ...
  %3 = load ptr, ptr %2, align 8, !tbaa !32, !noalias !27 ; 3 uses
  %.not.i.not.i.i = icmp eq ptr %3, null
  %i.d = getelementptr inbounds nuw i8, ptr %i.a, i64 32
  %i.e = load ptr, ptr %i.d, align 8, !noalias !27 ; 2 uses
  %4 = icmp ugt ptr %3, %i.e
  %.08.i.i.i = select i1 %4, ptr %3, ptr %i.e     ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !36, !noalias !27 ; 2 uses
...
bb.c:                                             ; preds = %bb.d, %bb.b
  %i.l = landingpad { ptr, i32 }
          cleanup
  %i.m = load ptr, ptr %0, align 8, !tbaa !37, !alias.scope !27 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i: ; preds = %bb.c
  %i.o = load i64, ptr %i.b, align 8, !tbaa !31, !alias.scope !27
  %i.p = add i64 %i.o, 1
  tail call void @_ZdlPvm(ptr noundef %i.m, i64 noundef %i.p) #11
