...
define void @_ZN5arrow10StopSourceD2Ev(ptr noundef nonnull readonly align 8 captures(none) dead_on_return(16) dereferenceable(16) %0) unnamed_addr #1 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !27
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 8 ; 2 uses
  %i.c = tail call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.b) #27 ; 2 uses
...
bb.c:                                             ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit
  ...
  br i1 %.not.i.i1, label %_ZN5arrow6StatusaSEOS0_.exit, label %bb.d, !prof !32

bb.d:                                             ; preds = %bb.c
  %i.j = getelementptr inbounds nuw i8, ptr %i.i, i64 1
  %i.k = load i8, ptr %i.j, align 1, !tbaa !33, !range !44, !noundef !45
  %i.l = trunc nuw i8 %i.k to i1
  br i1 %i.l, label %_ZN5arrow6StatusaSEOS0_.exit, label %bb.e

bb.e:                                             ; preds = %bb.d
  tail call void @_ZN5arrow6Status11DeleteStateEv(ptr noundef nonnull align 8 dereferenceable(8) %i.h) #27
  br label %_ZN5arrow6StatusaSEOS0_.exit

_ZN5arrow6StatusaSEOS0_.exit:                     ; preds = %bb.c, %bb.d, %bb.e
  %i.m = load ptr, ptr %1, align 8, !tbaa !29
  store ptr %i.m, ptr %i.h, align 8, !tbaa !29
  store ptr null, ptr %1, align 8, !tbaa !29
  br label %bb.f

bb.f:                                             ; preds = %_ZN5arrow6StatusaSEOS0_.exit, %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit
  %i.n = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.b) #27 ; 0 uses
  ret void
}
...
define void @_ZN5arrow10StopSource21RequestStopFromSignalEi(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(16) %0, i32 noundef %1) local_unnamed_addr #3 align 2 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !27
...
_ZNSt10lock_guardISt5mutexEC2ERS0_.exit:          ; preds = %bb.a
  %i.d = load ptr, ptr %0, align 8, !tbaa !27     ; 3 uses
  ...
  br i1 %.not.i.i1, label %_ZN5arrow6StatusD2Ev.exit, label %bb.c, !prof !32

bb.c:                                             ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit
  %i.g = getelementptr inbounds nuw i8, ptr %i.f, i64 1
  %i.h = load i8, ptr %i.g, align 1, !tbaa !33, !range !44, !noundef !45
  %i.i = trunc nuw i8 %i.h to i1
  br i1 %i.i, label %_ZN5arrow6StatusD2Ev.exit, label %bb.d

bb.d:                                             ; preds = %bb.c
  tail call void @_ZN5arrow6Status11DeleteStateEv(ptr noundef nonnull align 8 dereferenceable(8) %i.e) #27
  %.pre = load ptr, ptr %0, align 8, !tbaa !27
  br label %_ZN5arrow6StatusD2Ev.exit

_ZN5arrow6StatusD2Ev.exit:                        ; preds = %bb.d, %bb.c, %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit
  %i.j = phi ptr [ %.pre, %bb.d ], [ %i.d, %bb.c ], [ %i.d, %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit ]
  store ptr null, ptr %i.e, align 8, !tbaa !29
  store atomic i32 0, ptr %i.j seq_cst, align 4
  %i.k = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.b) #27 ; 0 uses
  ret void
}

; Function Attrs: mustprogress nofree norecurse nounwind memory(readwrite, target_mem: none) uwtable
define void @_ZN5arrow10StopSource5tokenEv(ptr dead_on_unwind noalias writable writeonly sret(%"class.arrow::StopToken") align 8 captures(none) initializes((0, 16)) %0, ptr noundef nonnull readonly align 8 captures(none) dereferenceable(16) %1) local_unnamed_addr #4 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !18   ; 2 uses
  %i.c = load <2 x ptr>, ptr %1, align 8, !tbaa !46
  %.not.i.i.i = icmp eq ptr %i.b, null
  br i1 %.not.i.i.i, label %_ZNSt12__shared_ptrIN5arrow14StopSourceImplELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, label %bb.b
...
_ZNSt12__shared_ptrIN5arrow14StopSourceImplELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit: ; preds = %bb.d, %bb.c, %bb.a
  store <2 x ptr> %i.c, ptr %0, align 8, !tbaa !46
  ret void
}

; Function Attrs: mustprogress nofree norecurse nounwind willreturn memory(readwrite, inaccessiblemem: none, target_mem: none) uwtable
define noundef zeroext i1 @_ZNK5arrow9StopToken15IsStopRequestedEv(ptr noundef nonnull readonly align 8 captures(none) dereferenceable(16) %0) local_unnamed_addr #3 align 2 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  store ptr null, ptr %0, align 8, !tbaa !29, !alias.scope !47
  br label %bb.o
...
bb.d:                                             ; preds = %bb.c
  store ptr null, ptr %0, align 8, !tbaa !29, !alias.scope !50
  br label %bb.o

bb.e:                                             ; preds = %bb.c
  %i.c = load ptr, ptr %1, align 8, !tbaa !27
  %i.d = getelementptr inbounds nuw i8, ptr %i.c, i64 8 ; 3 uses
  %i.e = tail call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.d) #27 ; 2 uses
  %.not.i.i = icmp eq i32 %i.e, 0
  br i1 %.not.i.i, label %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit, label %bb.f

bb.f:                                             ; preds = %bb.e
  tail call void @_ZSt20__throw_system_errori(i32 noundef %i.e) #28
  unreachable
...
_ZNSt10lock_guardISt5mutexEC2ERS0_.exit:          ; preds = %bb.e
  ...
  br i1 %i.i, label %bb.g, label %bb.m

bb.g:                                             ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit
  %i.j = load atomic i32, ptr %i.f seq_cst, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #27
  invoke void @_ZN5arrow8internal19CancelledFromSignalIJRA20_KcEEENS_6StatusEiDpOT_(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Status") align 8 %2, i32 noundef %i.j, ptr noundef nonnull align 1 dereferenceable(20) @.str)
...
bb.i:                                             ; preds = %bb.g
  %i.l = load ptr, ptr %1, align 8, !tbaa !27     ; 3 uses
  ...
  br i1 %.not.i.i5, label %_ZN5arrow6StatusD2Ev.exit, label %bb.j, !prof !32

bb.j:                                             ; preds = %bb.i
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 1
  %i.p = load i8, ptr %i.o, align 1, !tbaa !33, !range !44, !noundef !45
  %i.q = trunc nuw i8 %i.p to i1
  br i1 %i.q, label %_ZN5arrow6StatusD2Ev.exit, label %bb.k

bb.k:                                             ; preds = %bb.j
  call void @_ZN5arrow6Status11DeleteStateEv(ptr noundef nonnull align 8 dereferenceable(8) %i.m) #27
  %.pre.pre = load ptr, ptr %1, align 8, !tbaa !27
  br label %_ZN5arrow6StatusD2Ev.exit

_ZN5arrow6StatusD2Ev.exit:                        ; preds = %bb.k, %bb.j, %bb.i
  %.pre = phi ptr [ %.pre.pre, %bb.k ], [ %i.l, %bb.j ], [ %i.l, %bb.i ]
  %i.r = load ptr, ptr %2, align 8, !tbaa !29
  store ptr %i.r, ptr %i.m, align 8, !tbaa !29
...
bb.m:                                             ; preds = %_ZN5arrow6StatusD2Ev.exit, %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit
  %i.t = phi ptr [ %.pre, %_ZN5arrow6StatusD2Ev.exit ], [ %i.f, %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit ]
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 48
  store ptr null, ptr %0, align 8, !tbaa !29
  invoke void @_ZN5arrow6Status8CopyFromERKS0_(ptr noundef nonnull align 8 dereferenceable(8) %0, ptr noundef nonnull align 8 dereferenceable(8) %i.u)
          to label %_ZN5arrow6StatusC2ERKS0_.exit unwind label %bb.h

_ZN5arrow6StatusC2ERKS0_.exit:                    ; preds = %bb.m
  %i.v = call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.d) #27 ; 0 uses
  br label %bb.o

bb.n:                                             ; preds = %bb.l, %bb.h
  %.pn = phi { ptr, i32 } [ %i.k, %bb.h ], [ %i.s, %bb.l ]
  %i.w = call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.d) #27 ; 0 uses
  resume { ptr, i32 } %.pn

bb.o:                                             ; preds = %_ZN5arrow6StatusC2ERKS0_.exit, %bb.d, %bb.b
  ret void
}
...
bb.a:
  %3 = alloca %"class.std::shared_ptr.23", align 8 ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3)
  call void @_ZN5arrow8internal22StatusDetailFromSignalEi(ptr dead_on_unwind nonnull writable sret(%"class.std::shared_ptr.23") align 8 %3, i32 noundef %1), !noalias !53
  invoke void @_ZN5arrow6Status17FromDetailAndArgsIJRA20_KcEEES0_NS_10StatusCodeESt10shared_ptrINS_12StatusDetailEEDpOT_(ptr dead_on_unwind writable sret(%"class.arrow::Status") align 8 %0, i8 noundef signext 8, ptr noundef nonnull %3, ptr noundef nonnull align 1 dereferenceable(20) %2)
          to label %bb.b unwind label %bb.i

bb.b:                                             ; preds = %bb.a
  %i.a = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !18, !noalias !53 ; 8 uses
  %.not.i.i.i = icmp eq ptr %i.b, null
  br i1 %.not.i.i.i, label %_ZN5arrow8internal16StatusFromSignalIJRA20_KcEEENS_6StatusEiNS_10StatusCodeEDpOT_.exit, label %bb.c
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  %i.j = load ptr, ptr %i.i, align 8
  call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #27, !inline_history !56
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !16
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #27, !inline_history !56
  br label %_ZN5arrow8internal16StatusFromSignalIJRA20_KcEEENS_6StatusEiNS_10StatusCodeEDpOT_.exit

bb.e:                                             ; preds = %bb.c
  %i.n = load i8, ptr @__libc_single_threaded, align 1, !tbaa !25, !noalias !53
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i: ; preds = %bb.g, %bb.f
  ...
  br i1 %i.q, label %bb.h, label %_ZN5arrow8internal16StatusFromSignalIJRA20_KcEEENS_6StatusEiNS_10StatusCodeEDpOT_.exit, !prof !26

bb.h:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i
  call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #27
  br label %_ZN5arrow8internal16StatusFromSignalIJRA20_KcEEENS_6StatusEiNS_10StatusCodeEDpOT_.exit

bb.i:                                             ; preds = %bb.a
  %i.r = landingpad { ptr, i32 }
          cleanup
  call void @_ZNSt12__shared_ptrIN5arrow12StatusDetailELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %3) #27
  resume { ptr, i32 } %i.r

_ZN5arrow8internal16StatusFromSignalIJRA20_KcEEENS_6StatusEiNS_10StatusCodeEDpOT_.exit: ; preds = %bb.b, %bb.d, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i, %bb.h
...
bb.a:
  %1 = alloca %"class.arrow::Status", align 8     ; 6 uses
...
common.resume:                                    ; preds = %.body.i, %bb.e
  %common.resume.op = phi { ptr, i32 } [ %i.e, %bb.e ], [ %eh.lpad-body.i, %.body.i ]
...
_ZN5arrow12_GLOBAL__N_115SignalStopState8instanceEv.exit: ; preds = %bb.a, %bb.b, %bb.d
  %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i = load ptr, ptr @_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance, align 8, !tbaa !58 ; 3 uses
  %i.f = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 16 ; 7 uses
  %i.g = tail call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.f) #27 ; 2 uses
  %.not.i.i.i = icmp eq i32 %i.g, 0
  br i1 %.not.i.i.i, label %_ZN5arrow12_GLOBAL__N_115SignalStopState7enabledEv.exit, label %bb.f

bb.f:                                             ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState8instanceEv.exit
  tail call void @_ZSt20__throw_system_errori(i32 noundef %i.g) #28
  unreachable

_ZN5arrow12_GLOBAL__N_115SignalStopState7enabledEv.exit: ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState8instanceEv.exit
  %i.h = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 80 ; 3 uses
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !61
  %.not.i.i.not = icmp eq ptr %i.i, null
  %i.j = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.f) #27 ; 0 uses
  br i1 %.not.i.i.not, label %bb.j, label %bb.g

bb.g:                                             ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState7enabledEv.exit
  call void @llvm.lifetime.start.p0(ptr nonnull %1) #27
  call void @_ZN5arrow6Status8FromArgsIJRA34_KcEEES0_NS_10StatusCodeEDpOT_(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Status") align 8 %1, i8 noundef signext 4, ptr noundef nonnull align 1 dereferenceable(34) @.str.1)
  call void @_ZN5arrow6ResultIPNS_10StopSourceEEC2ERKNS_6StatusE(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef nonnull align 8 dereferenceable(8) %1) #27
  %i.k = load ptr, ptr %1, align 8, !tbaa !29     ; 2 uses
  %.not.i3 = icmp eq ptr %i.k, null
  br i1 %.not.i3, label %_ZN5arrow6StatusD2Ev.exit, label %bb.h, !prof !32

bb.h:                                             ; preds = %bb.g
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 1
  %i.m = load i8, ptr %i.l, align 1, !tbaa !33, !range !44, !noundef !45
  %i.n = trunc nuw i8 %i.m to i1
  br i1 %i.n, label %_ZN5arrow6StatusD2Ev.exit, label %bb.i
...
bb.j:                                             ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState7enabledEv.exit
  %i.o = tail call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.f) #27 ; 2 uses
  %.not.i.i.i4 = icmp eq i32 %i.o, 0
  br i1 %.not.i.i.i4, label %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i, label %bb.k

bb.k:                                             ; preds = %bb.j
  tail call void @_ZSt20__throw_system_errori(i32 noundef %i.o) #28
  unreachable

_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i:        ; preds = %bb.j
  %i.p = invoke noalias noundef nonnull dereferenceable(32) ptr @_Znwm(i64 noundef 32) #26
          to label %.noexc.i unwind label %bb.r   ; 6 uses

.noexc.i:                                         ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i
  %i.q = getelementptr inbounds nuw i8, ptr %i.p, i64 8
  store i32 1, ptr %i.q, align 8, !tbaa !13, !noalias !64
  %i.r = getelementptr inbounds nuw i8, ptr %i.p, i64 12
  store i32 1, ptr %i.r, align 4, !tbaa !15, !noalias !64
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt23_Sp_counted_ptr_inplaceIN5arrow10StopSourceESaIvELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.p, align 8, !tbaa !16, !noalias !64
  %i.s = getelementptr inbounds nuw i8, ptr %i.p, i64 16 ; 2 uses
  invoke void @_ZN5arrow10StopSourceC1Ev(ptr noundef nonnull align 8 dereferenceable(16) %i.s)
          to label %_ZSt11make_sharedIN5arrow10StopSourceEJEESt10shared_ptrIT_EDpOT0_.exit.i unwind label %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow10StopSourceESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit8.i.i.i.i.i, !noalias !64

_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow10StopSourceESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit8.i.i.i.i.i: ; preds = %.noexc.i
  %i.t = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvm(ptr noundef nonnull %i.p, i64 noundef 32) #29, !noalias !64
  br label %.body.i

_ZSt11make_sharedIN5arrow10StopSourceEJEESt10shared_ptrIT_EDpOT0_.exit.i: ; preds = %.noexc.i
  store ptr %i.s, ptr %i.h, align 8, !tbaa !67
  %i.u = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 88 ; 2 uses
  %i.v = load ptr, ptr %i.u, align 8, !tbaa !18   ; 8 uses
  store ptr %i.p, ptr %i.u, align 8, !tbaa !18
  %.not.i.i.i.i.i = icmp eq ptr %i.v, null
  br i1 %.not.i.i.i.i.i, label %_ZN5arrow12_GLOBAL__N_115SignalStopState6EnableEv.exit, label %bb.l

bb.l:                                             ; preds = %_ZSt11make_sharedIN5arrow10StopSourceEJEESt10shared_ptrIT_EDpOT0_.exit.i
...
bb.m:                                             ; preds = %bb.l
  ...
  store i32 0, ptr %i.aa, align 4, !tbaa !15
  %i.ab = load ptr, ptr %i.v, align 8, !tbaa !16
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 16
  %i.ad = load ptr, ptr %i.ac, align 8
  tail call void %i.ad(ptr noundef nonnull align 8 dereferenceable(16) %i.v) #27, !inline_history !68
  %i.ae = load ptr, ptr %i.v, align 8, !tbaa !16
  %i.af = getelementptr inbounds nuw i8, ptr %i.ae, i64 24
  %i.ag = load ptr, ptr %i.af, align 8
  tail call void %i.ag(ptr noundef nonnull align 8 dereferenceable(16) %i.v) #27, !inline_history !68
  br label %_ZN5arrow12_GLOBAL__N_115SignalStopState6EnableEv.exit

bb.n:                                             ; preds = %bb.l
  %i.ah = load i8, ptr @__libc_single_threaded, align 1, !tbaa !25
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i: ; preds = %bb.p, %bb.o
  %.0.i.i.i.i.i.i.i = phi i32 [ %i.z, %bb.o ], [ %i.aj, %bb.p ]
  %i.ak = icmp eq i32 %.0.i.i.i.i.i.i.i, 1
  br i1 %i.ak, label %bb.q, label %_ZN5arrow12_GLOBAL__N_115SignalStopState6EnableEv.exit, !prof !26
...
.body.i:                                          ; preds = %bb.r, %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow10StopSourceESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit8.i.i.i.i.i
  %eh.lpad-body.i = phi { ptr, i32 } [ %i.al, %bb.r ], [ %i.t, %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow10StopSourceESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit8.i.i.i.i.i ]
  %i.am = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.f) #27 ; 0 uses
  br label %common.resume

_ZN5arrow12_GLOBAL__N_115SignalStopState6EnableEv.exit: ; preds = %_ZSt11make_sharedIN5arrow10StopSourceEJEESt10shared_ptrIT_EDpOT0_.exit.i, %bb.m, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i, %bb.q
  %i.an = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.f) #27 ; 0 uses
  %i.ao = tail call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.f) #27 ; 2 uses
  %.not.i.i.i5 = icmp eq i32 %i.ao, 0
  br i1 %.not.i.i.i5, label %_ZN5arrow12_GLOBAL__N_115SignalStopState11stop_sourceEv.exit, label %bb.s

bb.s:                                             ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState6EnableEv.exit
  tail call void @_ZSt20__throw_system_errori(i32 noundef %i.ao) #28
  unreachable
...
_ZN5arrow12_GLOBAL__N_115SignalStopState11stop_sourceEv.exit: ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState6EnableEv.exit
  %i.ap = load ptr, ptr %i.h, align 8, !tbaa !61
  %i.aq = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.f) #27 ; 0 uses
  store ptr null, ptr %0, align 8, !tbaa !29
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 8
  store ptr %i.ap, ptr %i.ar, align 8, !tbaa !67
  br label %bb.t

bb.t:                                             ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState11stop_sourceEv.exit, %_ZN5arrow6StatusD2Ev.exit
  ret void
}
...
bb.f:                                             ; preds = %bb.e
  %i.c = load ptr, ptr %2, align 8, !tbaa !69     ; 2 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.f, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  %i.h = load ptr, ptr %5, align 8, !tbaa !69     ; 2 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit6: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i4
  ...
  %i.m = load ptr, ptr %3, align 8, !tbaa !69     ; 2 uses
...
_ZN5arrow12_GLOBAL__N_115SignalStopState8instanceEv.exit: ; preds = %bb.a, %bb.b, %bb.d
  %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i = load ptr, ptr @_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance, align 8, !tbaa !58 ; 3 uses
  %i.f = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 16 ; 2 uses
  %i.g = tail call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.f) #27 ; 2 uses
  %.not.i.i.i = icmp eq i32 %i.g, 0
...
_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i:        ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState8instanceEv.exit
  %i.h = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 80
  store ptr null, ptr %i.h, align 8, !tbaa !67
  %i.i = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 88 ; 2 uses
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !18   ; 8 uses
  store ptr null, ptr %i.i, align 8, !tbaa !18
  %.not.i.i.i.i = icmp eq ptr %i.j, null
  br i1 %.not.i.i.i.i, label %_ZN5arrow12_GLOBAL__N_115SignalStopState7DisableEv.exit, label %bb.g
...
bb.h:                                             ; preds = %bb.g
  store i32 0, ptr %i.k, align 8, !tbaa !13
  ...
  tail call void %i.r(ptr noundef nonnull align 8 dereferenceable(16) %i.j) #27, !inline_history !70
  %i.s = load ptr, ptr %i.j, align 8, !tbaa !16
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 24
  %i.u = load ptr, ptr %i.t, align 8
  tail call void %i.u(ptr noundef nonnull align 8 dereferenceable(16) %i.j) #27, !inline_history !70
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i: ; preds = %bb.k, %bb.j
  %.0.i.i.i.i.i.i = phi i32 [ %i.n, %bb.j ], [ %i.x, %bb.k ]
  %i.y = icmp eq i32 %.0.i.i.i.i.i.i, 1
  br i1 %i.y, label %bb.l, label %_ZN5arrow12_GLOBAL__N_115SignalStopState7DisableEv.exit, !prof !26
...
_ZN5arrow12_GLOBAL__N_115SignalStopState7DisableEv.exit: ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i, %bb.h, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i, %bb.l
  %i.z = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.f) #27 ; 0 uses
  ret void
}
...
bb.a:
  %2 = alloca %"class.std::unique_ptr.79", align 8 ; 6 uses
  %3 = alloca %"class.arrow::Result.60", align 8  ; 12 uses
  %4 = alloca %"class.arrow::Result.64", align 8  ; 11 uses
  %5 = alloca %"class.arrow::internal::SignalHandler", align 8 ; 5 uses
  %.sroa.6.i = alloca [156 x i8], align 4         ; 6 uses
  %i.a = load atomic i8, ptr @_ZGVZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance acquire, align 8
  %i.b = icmp eq i8 %i.a, 0
  br i1 %i.b, label %bb.b, label %_ZN5arrow12_GLOBAL__N_115SignalStopState8instanceEv.exit, !prof !57
...
common.resume:                                    ; preds = %.body.i, %bb.e
  %common.resume.op = phi { ptr, i32 } [ %i.e, %bb.e ], [ %.pn33.pn.pn.i, %.body.i ]
  resume { ptr, i32 } %common.resume.op
...
_ZN5arrow12_GLOBAL__N_115SignalStopState8instanceEv.exit: ; preds = %bb.a, %bb.b, %bb.d
  %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i = load ptr, ptr @_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance, align 8, !tbaa !58 ; 10 uses
  %i.f = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 16 ; 5 uses
  %i.g = tail call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.f) #27 ; 2 uses
  %.not.i.i.i = icmp eq i32 %i.g, 0
  br i1 %.not.i.i.i, label %_ZN5arrow12_GLOBAL__N_115SignalStopState7enabledEv.exit, label %bb.f
...
_ZN5arrow12_GLOBAL__N_115SignalStopState7enabledEv.exit: ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState8instanceEv.exit
  ...
  %.not.i.i.not = icmp eq ptr %i.i, null
  %i.j = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.f) #27 ; 0 uses
  br i1 %.not.i.i.not, label %bb.g, label %bb.h
...
bb.h:                                             ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState7enabledEv.exit
  tail call void @llvm.experimental.noalias.scope.decl(metadata !71)
  %i.k = tail call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.f) #27, !noalias !71 ; 2 uses
  %.not.i.i.i3 = icmp eq i32 %i.k, 0
  br i1 %.not.i.i.i3, label %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i, label %bb.i

bb.i:                                             ; preds = %bb.h
  tail call void @_ZSt20__throw_system_errori(i32 noundef %i.k) #28
  unreachable

_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i:        ; preds = %bb.h
  %i.l = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 56 ; 3 uses
  %.val.i = load ptr, ptr %i.l, align 8, !tbaa !74, !noalias !71
  %i.m = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 64 ; 5 uses
  %.val37.i = load ptr, ptr %i.m, align 8, !tbaa !74, !noalias !71
  %i.n = icmp eq ptr %.val.i, %.val37.i
  br i1 %i.n, label %bb.l, label %bb.j

bb.j:                                             ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i
  invoke void @_ZN5arrow6Status8FromArgsIJRA35_KcEEES0_NS_10StatusCodeEDpOT_(ptr dead_on_unwind writable sret(%"class.arrow::Status") align 8 %0, i8 noundef signext 4, ptr noundef nonnull align 1 dereferenceable(35) @.str.7)
          to label %_ZN5arrow12_GLOBAL__N_115SignalStopState16RegisterHandlersERKSt6vectorIiSaIiEE.exit unwind label %bb.k
...
bb.l:                                             ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i
  %i.p = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 120 ; 4 uses
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !76, !noalias !71
  %.not.i4 = icmp eq ptr %i.q, null
  br i1 %.not.i4, label %bb.m, label %bb.ag

bb.m:                                             ; preds = %bb.l
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #27, !noalias !71
  invoke void @_ZN5arrow8internal8SelfPipe4MakeEb(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Result.60") align 8 %3, i1 noundef zeroext true)
          to label %bb.n unwind label %bb.p

bb.n:                                             ; preds = %bb.m
  %i.r = load ptr, ptr %3, align 8, !tbaa !29, !noalias !71
  %i.s = icmp eq ptr %i.r, null                   ; 2 uses
  br i1 %i.s, label %bb.r, label %bb.o, !prof !32
...
bb.q:                                             ; preds = %bb.o
  %i.u = landingpad { ptr, i32 }
          cleanup
  call void @_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEED2Ev(ptr noundef nonnull align 8 dereferenceable(24) %3) #27
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #27, !noalias !71
  br label %.body.i

bb.r:                                             ; preds = %bb.n
  %i.v = getelementptr inbounds nuw i8, ptr %3, i64 8 ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 128
  %i.x = load <2 x ptr>, ptr %i.v, align 8, !tbaa !46, !noalias !79
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.v, i8 0, i64 16, i1 false), !noalias !71
  %i.y = load ptr, ptr %i.w, align 8, !tbaa !18, !noalias !71 ; 8 uses
  store <2 x ptr> %i.x, ptr %i.p, align 8, !tbaa !46, !noalias !71
  %.not.i.i.i.i.i = icmp eq ptr %i.y, null
  br i1 %.not.i.i.i.i.i, label %_ZN5arrow6StatusC2ERKS0_.exit.i, label %bb.s
...
bb.t:                                             ; preds = %bb.s
  store i32 0, ptr %i.z, align 8, !tbaa !13
  %i.ad = getelementptr inbounds nuw i8, ptr %i.y, i64 12
  store i32 0, ptr %i.ad, align 4, !tbaa !15
  %i.ae = load ptr, ptr %i.y, align 8, !tbaa !16
  %i.af = getelementptr inbounds nuw i8, ptr %i.ae, i64 16
  %i.ag = load ptr, ptr %i.af, align 8
  call void %i.ag(ptr noundef nonnull align 8 dereferenceable(16) %i.y) #27, !inline_history !84
  %i.ah = load ptr, ptr %i.y, align 8, !tbaa !16
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ah, i64 24
  %i.aj = load ptr, ptr %i.ai, align 8
  call void %i.aj(ptr noundef nonnull align 8 dereferenceable(16) %i.y) #27, !inline_history !84
  br label %_ZN5arrow6StatusC2ERKS0_.exit.i

bb.u:                                             ; preds = %bb.s
  %i.ak = load i8, ptr @__libc_single_threaded, align 1, !tbaa !25, !noalias !71
  %.not.i.i.i.i.i.i = icmp eq i8 %i.ak, 0
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i: ; preds = %bb.w, %bb.v
  %.0.i.i.i.i.i.i.i = phi i32 [ %i.ac, %bb.v ], [ %i.am, %bb.w ]
  %i.an = icmp eq i32 %.0.i.i.i.i.i.i.i, 1
  br i1 %i.an, label %bb.x, label %_ZN5arrow6StatusC2ERKS0_.exit.i, !prof !26
...
_ZN5arrow6StatusC2ERKS0_.exit.i:                  ; preds = %bb.x, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i, %bb.t, %bb.r, %bb.o
  %i.ao = load ptr, ptr %3, align 8, !tbaa !29, !noalias !71 ; 2 uses
...
end_hunk_0
begin_hunk_1_@_ZN5arrow12_GLOBAL__N_115SignalStopState18UnregisterHandlersEv:bb.a
  br label %_ZN5arrow6StatusD2Ev.exit
...
_ZN5arrow6StatusD2Ev.exit47:                      ; preds = %bb.af, %bb.ae, %bb.ad, %_ZN5arrow6ResultINS_8internal13SignalHandlerEED2Ev.exit42
  %.pn24.pn.pn.pn = phi { ptr, i32 } [ %.pn, %_ZN5arrow6ResultINS_8internal13SignalHandlerEED2Ev.exit42 ], [ %.pn24.pn.pn, %bb.ad ], [ %.pn24.pn.pn, %bb.ae ], [ %.pn24.pn.pn, %bb.af ]
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #27
  %.not.i.i.i48 = icmp eq ptr %i.e, null
  br i1 %.not.i.i.i48, label %_ZNSt6vectorIN5arrow12_GLOBAL__N_115SignalStopState18SavedSignalHandlerESaIS3_EED2Ev.exit49, label %bb.ag

bb.ag:                                            ; preds = %_ZN5arrow6StatusD2Ev.exit47
  %i.bi = ptrtoint ptr %i.i to i64
  %i.bj = ptrtoint ptr %i.e to i64
  %i.bk = sub i64 %i.bi, %i.bj
  call void @_ZdlPvm(ptr noundef nonnull %i.e, i64 noundef %i.bk) #29
  br label %_ZNSt6vectorIN5arrow12_GLOBAL__N_115SignalStopState18SavedSignalHandlerESaIS3_EED2Ev.exit49

_ZNSt6vectorIN5arrow12_GLOBAL__N_115SignalStopState18SavedSignalHandlerESaIS3_EED2Ev.exit49: ; preds = %_ZN5arrow6StatusD2Ev.exit47, %bb.ag
  %i.bl = call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.a) #27 ; 0 uses
...
bb.a:
  ...
  tail call void %i.c(ptr noundef nonnull align 8 dereferenceable(16) %0) #27, !inline_history !134
...
bb.d:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i
  ...
  tail call void %i.l(ptr noundef nonnull align 8 dereferenceable(16) %0) #27, !inline_history !134
...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !29     ; 5 uses
  %i.b = icmp eq ptr %i.a, null
  br i1 %i.b, label %bb.i, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 48
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !18   ; 8 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.l = load ptr, ptr %i.k, align 8
  tail call void %i.l(ptr noundef nonnull align 8 dereferenceable(16) %i.d) #27, !inline_history !135
  %i.m = load ptr, ptr %i.d, align 8, !tbaa !16
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 24
  %i.o = load ptr, ptr %i.n, align 8
  tail call void %i.o(ptr noundef nonnull align 8 dereferenceable(16) %i.d) #27, !inline_history !135
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i: ; preds = %bb.g, %bb.f
  ...
  br i1 %i.s, label %bb.h, label %_ZNSt12__shared_ptrIN5arrow12StatusDetailELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i, !prof !26
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  %i.j = load ptr, ptr %i.i, align 8
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #27, !inline_history !136
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !16
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #27, !inline_history !136
...
define internal fastcc void @_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvENKUlvE_clEv() unnamed_addr #11 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %0 = alloca %"class.std::shared_ptr.26", align 8 ; 6 uses
  %1 = alloca %"class.std::weak_ptr.38", align 16 ; 5 uses
  store ptr null, ptr @_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance, align 8, !tbaa !58
  %i.a = tail call noalias noundef nonnull dereferenceable(160) ptr @_Znwm(i64 noundef 160) #26, !noalias !137 ; 7 uses
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store i32 1, ptr %i.b, align 8, !tbaa !13
  %i.c = getelementptr inbounds nuw i8, ptr %i.a, i64 12 ; 3 uses
  store i32 1, ptr %i.c, align 4, !tbaa !15
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt23_Sp_counted_ptr_inplaceIN5arrow12_GLOBAL__N_115SignalStopStateESaIvELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.a, align 8, !tbaa !16
  %i.d = getelementptr inbounds nuw i8, ptr %i.a, i64 16 ; 3 uses
  %i.e = getelementptr inbounds nuw i8, ptr %i.a, i64 24 ; 3 uses
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(136) %i.e, i8 0, i64 136, i1 false)
  store ptr %i.a, ptr getelementptr inbounds nuw (i8, ptr @_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance, i64 8), align 8, !tbaa !18
  store ptr %i.d, ptr @_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance, align 8, !tbaa !140
  store ptr %i.d, ptr %i.d, align 8, !tbaa !141
  %i.f = load i8, ptr @__libc_single_threaded, align 1, !tbaa !25
  %.not.i.i3.i.i.i.i.i.i = icmp eq i8 %i.f, 0
...
_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE15_M_weak_add_refEv.exit.i.i.i.i.thread.i.i.i: ; preds = %bb.a
  ...
  br label %_ZSt11make_sharedIN5arrow12_GLOBAL__N_115SignalStopStateEJEESt10shared_ptrIT_EDpOT0_.exit
...
_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE15_M_weak_add_refEv.exit.i.i.i.i.i.i.i: ; preds = %bb.a
  ...
  %.pre.i.i.i.i.i.i = load ptr, ptr %i.e, align 8, !tbaa !144 ; 4 uses
  %.not6.i.i.i.i.i.i.i = icmp eq ptr %.pre.i.i.i.i.i.i, null
  br i1 %.not6.i.i.i.i.i.i.i, label %_ZSt11make_sharedIN5arrow12_GLOBAL__N_115SignalStopStateEJEESt10shared_ptrIT_EDpOT0_.exit, label %bb.b

bb.b:                                             ; preds = %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE15_M_weak_add_refEv.exit.i.i.i.i.i.i.i
  %i.h = getelementptr inbounds nuw i8, ptr %.pre.i.i.i.i.i.i, i64 12 ; 3 uses
  %i.i = load i8, ptr @__libc_single_threaded, align 1, !tbaa !25
  %.not.i7.i.i.i.i.i.i.i = icmp eq i8 %i.i, 0
...
bb.d:                                             ; preds = %bb.b
  %i.l = atomicrmw volatile add ptr %i.h, i32 -1 acq_rel, align 4
  br label %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i.i

_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i.i: ; preds = %bb.d, %bb.c
  %.0.i.i.i.i.i.i.i.i.i = phi i32 [ %i.j, %bb.c ], [ %i.l, %bb.d ]
  %i.m = icmp eq i32 %.0.i.i.i.i.i.i.i.i.i, 1
  br i1 %i.m, label %bb.e, label %_ZSt11make_sharedIN5arrow12_GLOBAL__N_115SignalStopStateEJEESt10shared_ptrIT_EDpOT0_.exit

bb.e:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i.i
  %i.n = load ptr, ptr %.pre.i.i.i.i.i.i, align 8, !tbaa !16
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 24
  %i.p = load ptr, ptr %i.o, align 8
  tail call void %i.p(ptr noundef nonnull align 8 dereferenceable(16) %.pre.i.i.i.i.i.i) #27, !inline_history !145
  br label %_ZSt11make_sharedIN5arrow12_GLOBAL__N_115SignalStopStateEJEESt10shared_ptrIT_EDpOT0_.exit

_ZSt11make_sharedIN5arrow12_GLOBAL__N_115SignalStopStateEJEESt10shared_ptrIT_EDpOT0_.exit: ; preds = %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE15_M_weak_add_refEv.exit.i.i.i.i.thread.i.i.i, %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE15_M_weak_add_refEv.exit.i.i.i.i.i.i.i, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i.i, %bb.e
  store ptr %i.a, ptr %i.e, align 8, !tbaa !144
  %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val = load ptr, ptr @_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance, align 8, !tbaa !58 ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %1)
  call void @llvm.lifetime.start.p0(ptr nonnull %0) #27
  tail call void @llvm.experimental.noalias.scope.decl(metadata !146)
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.r = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val, i64 8
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !144, !noalias !146 ; 12 uses
  store ptr %i.s, ptr %i.q, align 8, !tbaa !18, !alias.scope !146
  %i.t = icmp eq ptr %i.s, null
  br i1 %i.t, label %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE23_M_add_ref_lock_nothrowEv.exit.i.i.i.i.i, label %bb.f

bb.f:                                             ; preds = %_ZSt11make_sharedIN5arrow12_GLOBAL__N_115SignalStopStateEJEESt10shared_ptrIT_EDpOT0_.exit
  %i.u = getelementptr inbounds nuw i8, ptr %i.s, i64 8 ; 6 uses
  %i.v = load atomic i32, ptr %i.u monotonic, align 8, !noalias !146
  br label %bb.g

bb.g:                                             ; preds = %bb.h, %bb.f
  %.06.i.i.i.i.i.i = phi i32 [ %i.v, %bb.f ], [ %i.z, %bb.h ] ; 3 uses
  %.not.not.not.i.not.i.i.i.i.i = icmp eq i32 %.06.i.i.i.i.i.i, 0
  br i1 %.not.not.not.i.not.i.i.i.i.i, label %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE23_M_add_ref_lock_nothrowEv.exit.i.i.i.i.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.w = add nsw i32 %.06.i.i.i.i.i.i, 1
  %i.x = cmpxchg weak ptr %i.u, i32 %.06.i.i.i.i.i.i, i32 %i.w acq_rel monotonic, align 8, !noalias !146 ; 2 uses
  %i.y = extractvalue { i32, i1 } %i.x, 1
  %i.z = extractvalue { i32, i1 } %i.x, 0
  br i1 %i.y, label %bb.i, label %bb.g, !llvm.loop !149

_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE23_M_add_ref_lock_nothrowEv.exit.i.i.i.i.i: ; preds = %bb.g, %_ZSt11make_sharedIN5arrow12_GLOBAL__N_115SignalStopStateEJEESt10shared_ptrIT_EDpOT0_.exit
  %i.aa = tail call ptr @__cxa_allocate_exception(i64 8) #27, !noalias !146 ; 2 uses
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt12bad_weak_ptr, i64 16), ptr %i.aa, align 8, !tbaa !16, !noalias !146
  invoke void @__cxa_throw(ptr nonnull %i.aa, ptr nonnull @_ZTISt12bad_weak_ptr, ptr nonnull @_ZNSt12bad_weak_ptrD1Ev) #28
...
bb.i:                                             ; preds = %bb.h
  %i.ab = load ptr, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val, align 8, !tbaa !141, !noalias !146 ; 2 uses
  store ptr %i.ab, ptr %0, align 8, !tbaa !58, !alias.scope !146
  %i.ac = getelementptr inbounds nuw i8, ptr %i.s, i64 12 ; 7 uses
...
_ZNSt8weak_ptrIN5arrow12_GLOBAL__N_115SignalStopStateEEC2IS2_vEERKSt10shared_ptrIT_E.exit.i: ; preds = %bb.k, %bb.j
  %i.ah = invoke noalias noundef nonnull dereferenceable(112) ptr @_Znwm(i64 noundef 112) #26
          to label %.noexc.i unwind label %bb.af  ; 15 uses

.noexc.i:                                         ; preds = %_ZNSt8weak_ptrIN5arrow12_GLOBAL__N_115SignalStopStateEEC2IS2_vEERKSt10shared_ptrIT_E.exit.i
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ah, i64 8
  store i32 1, ptr %i.ai, align 8, !tbaa !13, !noalias !150
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ah, i64 12
  store i32 1, ptr %i.aj, align 4, !tbaa !15, !noalias !150
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt23_Sp_counted_ptr_inplaceIN5arrow8internal13AtForkHandlerESaIvELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.ah, align 8, !tbaa !16, !noalias !150
  %i.ak = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #26
          to label %bb.l unwind label %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow8internal13AtForkHandlerESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit11.i.i.i.i.i, !noalias !150 ; 3 uses

_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow8internal13AtForkHandlerESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit11.i.i.i.i.i: ; preds = %.noexc.i
  %i.al = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ah, i64 noundef 112) #29, !noalias !150
  br label %.body.i

bb.l:                                             ; preds = %.noexc.i
  %i.am = getelementptr inbounds nuw i8, ptr %i.ah, i64 16 ; 2 uses
  store ptr %i.ab, ptr %i.ak, align 8, !tbaa !141, !noalias !150
  %i.an = getelementptr inbounds nuw i8, ptr %i.ak, i64 8
  store ptr %i.s, ptr %i.an, align 8, !tbaa !144, !noalias !150
  %i.ao = getelementptr inbounds nuw i8, ptr %i.ah, i64 40
  store ptr @_ZNSt17_Function_handlerIFSt3anyvEZN5arrow12_GLOBAL__N_115SignalStopState4InitEvEUlvE_E9_M_invokeERKSt9_Any_data, ptr %i.ao, align 8, !tbaa !153, !noalias !150
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ah, i64 32
  store ptr %i.ak, ptr %i.am, align 8, !noalias !150
  %.sroa.4.0..sroa_idx.i.i.i.i.i.i = getelementptr inbounds nuw i8, ptr %i.ah, i64 24
  store i64 0, ptr %.sroa.4.0..sroa_idx.i.i.i.i.i.i, align 8, !tbaa !25, !noalias !150
  store ptr @_ZNSt17_Function_handlerIFSt3anyvEZN5arrow12_GLOBAL__N_115SignalStopState4InitEvEUlvE_E10_M_managerERSt9_Any_dataRKS7_St18_Manager_operation, ptr %i.ap, align 8, !tbaa !156, !noalias !150
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ah, i64 48
  %i.ar = getelementptr inbounds nuw i8, ptr %i.ah, i64 72
  store ptr @_ZNSt17_Function_handlerIFvSt3anyEZN5arrow12_GLOBAL__N_115SignalStopState4InitEvEUlS0_E_E9_M_invokeERKSt9_Any_dataOS0_, ptr %i.ar, align 8, !tbaa !157, !noalias !150
  %i.as = getelementptr inbounds nuw i8, ptr %i.ah, i64 64
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.aq, i8 0, i64 16, i1 false), !noalias !150
  store ptr @_ZNSt17_Function_handlerIFvSt3anyEZN5arrow12_GLOBAL__N_115SignalStopState4InitEvEUlS0_E_E10_M_managerERSt9_Any_dataRKS7_St18_Manager_operation, ptr %i.as, align 8, !tbaa !156, !noalias !150
  %i.at = getelementptr inbounds nuw i8, ptr %i.ah, i64 80
  %i.au = getelementptr inbounds nuw i8, ptr %i.ah, i64 104
  store ptr @_ZNSt17_Function_handlerIFvSt3anyEZN5arrow12_GLOBAL__N_115SignalStopState4InitEvEUlS0_E0_E9_M_invokeERKSt9_Any_dataOS0_, ptr %i.au, align 8, !tbaa !157, !noalias !150
  %i.av = getelementptr inbounds nuw i8, ptr %i.ah, i64 96
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.at, i8 0, i64 16, i1 false), !noalias !150
  store ptr @_ZNSt17_Function_handlerIFvSt3anyEZN5arrow12_GLOBAL__N_115SignalStopState4InitEvEUlS0_E0_E10_M_managerERSt9_Any_dataRKS7_St18_Manager_operation, ptr %i.av, align 8, !tbaa !156, !noalias !150
  %i.aw = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val, i64 104 ; 2 uses
  store ptr %i.am, ptr %i.aw, align 8, !tbaa !159
  %i.ax = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val, i64 112 ; 3 uses
  %i.ay = load ptr, ptr %i.ax, align 8, !tbaa !18 ; 8 uses
  store ptr %i.ah, ptr %i.ax, align 8, !tbaa !18
  %.not.i.i.i.i7.i = icmp eq ptr %i.ay, null
  br i1 %.not.i.i.i.i7.i, label %_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit.i, label %bb.m
...
bb.n:                                             ; preds = %bb.m
  store i32 0, ptr %i.az, align 8, !tbaa !13
  %i.bd = getelementptr inbounds nuw i8, ptr %i.ay, i64 12
  store i32 0, ptr %i.bd, align 4, !tbaa !15
  %i.be = load ptr, ptr %i.ay, align 8, !tbaa !16
  %i.bf = getelementptr inbounds nuw i8, ptr %i.be, i64 16
  %i.bg = load ptr, ptr %i.bf, align 8
  tail call void %i.bg(ptr noundef nonnull align 8 dereferenceable(16) %i.ay) #27, !inline_history !161
  %i.bh = load ptr, ptr %i.ay, align 8, !tbaa !16
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bh, i64 24
  %i.bj = load ptr, ptr %i.bi, align 8
  tail call void %i.bj(ptr noundef nonnull align 8 dereferenceable(16) %i.ay) #27, !inline_history !161
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i: ; preds = %bb.q, %bb.p
  %.0.i.i.i.i.i.i.i = phi i32 [ %i.bc, %bb.p ], [ %i.bm, %bb.q ]
  %i.bn = icmp eq i32 %.0.i.i.i.i.i.i.i, 1
  br i1 %i.bn, label %bb.r, label %_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit.i, !prof !26

bb.r:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i
  tail call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.ay) #27
  br label %_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit.i

_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit.i: ; preds = %bb.r, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i, %bb.n, %bb.l
  %i.bo = load atomic i64, ptr %i.u acquire, align 8 ; 2 uses
  %i.bp = icmp eq i64 %i.bo, 4294967297
  %i.bq = trunc i64 %i.bo to i32                  ; 2 uses
  br i1 %i.bp, label %bb.s, label %bb.t

bb.s:                                             ; preds = %_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit.i
  store i32 0, ptr %i.u, align 8, !tbaa !13
  store i32 0, ptr %i.ac, align 4, !tbaa !15
  %i.br = load ptr, ptr %i.s, align 8, !tbaa !16
  %i.bs = getelementptr inbounds nuw i8, ptr %i.br, i64 16
  %i.bt = load ptr, ptr %i.bs, align 8
  tail call void %i.bt(ptr noundef nonnull align 8 dereferenceable(16) %i.s) #27, !inline_history !162
  %i.bu = load ptr, ptr %i.s, align 8, !tbaa !16
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bu, i64 24
  %i.bw = load ptr, ptr %i.bv, align 8
  tail call void %i.bw(ptr noundef nonnull align 8 dereferenceable(16) %i.s) #27, !inline_history !162
  br label %_ZNSt12__shared_ptrIN5arrow12_GLOBAL__N_115SignalStopStateELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i

bb.t:                                             ; preds = %_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit.i
  %i.bx = load i8, ptr @__libc_single_threaded, align 1, !tbaa !25
  %.not.i.i.i12.i = icmp eq i8 %i.bx, 0
  br i1 %.not.i.i.i12.i, label %bb.v, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.by = add nsw i32 %i.bq, -1
  store i32 %i.by, ptr %i.u, align 8, !tbaa !3
  br label %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i13.i

bb.v:                                             ; preds = %bb.t
  %i.bz = atomicrmw volatile add ptr %i.u, i32 -1 acq_rel, align 4
  br label %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i13.i

_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i13.i: ; preds = %bb.v, %bb.u
  %.0.i.i.i.i14.i = phi i32 [ %i.bq, %bb.u ], [ %i.bz, %bb.v ]
  %i.ca = icmp eq i32 %.0.i.i.i.i14.i, 1
  br i1 %i.ca, label %bb.w, label %_ZNSt12__shared_ptrIN5arrow12_GLOBAL__N_115SignalStopStateELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i, !prof !26

bb.w:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i13.i
...
_ZNSt12__shared_ptrIN5arrow12_GLOBAL__N_115SignalStopStateELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i: ; preds = %bb.w, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i13.i, %bb.s
  call void @llvm.lifetime.end.p0(ptr nonnull %0) #27
  %i.cb = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  %i.cc = load ptr, ptr %i.ax, align 8, !tbaa !18 ; 2 uses
  %i.cd = load <2 x ptr>, ptr %i.aw, align 8, !tbaa !46
  store <2 x ptr> %i.cd, ptr %1, align 16, !tbaa !46
  %.not.i.i.i15.i = icmp eq ptr %i.cc, null
  br i1 %.not.i.i.i15.i, label %_ZNSt8weak_ptrIN5arrow8internal13AtForkHandlerEEC2IS2_vEERKSt10shared_ptrIT_E.exit.i, label %bb.x

bb.x:                                             ; preds = %_ZNSt12__shared_ptrIN5arrow12_GLOBAL__N_115SignalStopStateELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i
  %i.ce = getelementptr inbounds nuw i8, ptr %i.cc, i64 12 ; 3 uses
  %i.cf = load i8, ptr @__libc_single_threaded, align 1, !tbaa !25
  %.not.i.i.i.i16.i = icmp eq i8 %i.cf, 0
  br i1 %.not.i.i.i.i16.i, label %bb.z, label %bb.y

bb.y:                                             ; preds = %bb.x
  %i.cg = load i32, ptr %i.ce, align 4, !tbaa !3
  %i.ch = add nsw i32 %i.cg, 1
  store i32 %i.ch, ptr %i.ce, align 4, !tbaa !3
...
_ZNSt8weak_ptrIN5arrow8internal13AtForkHandlerEEC2IS2_vEERKSt10shared_ptrIT_E.exit.i: ; preds = %bb.z, %bb.y, %_ZNSt12__shared_ptrIN5arrow12_GLOBAL__N_115SignalStopStateELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i
  invoke void @_ZN5arrow8internal14RegisterAtForkESt8weak_ptrINS0_13AtForkHandlerEE(ptr noundef nonnull %1)
          to label %bb.aa unwind label %bb.aj

bb.aa:                                            ; preds = %_ZNSt8weak_ptrIN5arrow8internal13AtForkHandlerEEC2IS2_vEERKSt10shared_ptrIT_E.exit.i
  %i.cj = load ptr, ptr %i.cb, align 8, !tbaa !144 ; 4 uses
  %.not.i.i17.i = icmp eq ptr %i.cj, null
  br i1 %.not.i.i17.i, label %bb.ap, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.ck = getelementptr inbounds nuw i8, ptr %i.cj, i64 12 ; 3 uses
  %i.cl = load i8, ptr @__libc_single_threaded, align 1, !tbaa !25
  %.not.i.i.i18.i = icmp eq i8 %i.cl, 0
  br i1 %.not.i.i.i18.i, label %bb.ad, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  %i.cm = load i32, ptr %i.ck, align 4, !tbaa !3  ; 2 uses
...
bb.ad:                                            ; preds = %bb.ab
  %i.co = atomicrmw volatile add ptr %i.ck, i32 -1 acq_rel, align 4
  br label %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i19.i

_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i19.i: ; preds = %bb.ad, %bb.ac
  %.0.i.i.i.i20.i = phi i32 [ %i.cm, %bb.ac ], [ %i.co, %bb.ad ]
  %i.cp = icmp eq i32 %.0.i.i.i.i20.i, 1
  br i1 %i.cp, label %bb.ae, label %bb.ap

bb.ae:                                            ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i19.i
  %i.cq = load ptr, ptr %i.cj, align 8, !tbaa !16
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 24
  %i.cs = load ptr, ptr %i.cr, align 8
  call void %i.cs(ptr noundef nonnull align 8 dereferenceable(16) %i.cj) #27, !inline_history !163
  br label %bb.ap

bb.af:                                            ; preds = %_ZNSt8weak_ptrIN5arrow12_GLOBAL__N_115SignalStopStateEEC2IS2_vEERKSt10shared_ptrIT_E.exit.i
  %i.ct = landingpad { ptr, i32 }
          cleanup
  br label %.body.i

.body.i:                                          ; preds = %bb.af, %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow8internal13AtForkHandlerESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit11.i.i.i.i.i
  %eh.lpad-body.i = phi { ptr, i32 } [ %i.ct, %bb.af ], [ %i.al, %_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN5arrow8internal13AtForkHandlerESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit11.i.i.i.i.i ]
  %i.cu = load i8, ptr @__libc_single_threaded, align 1, !tbaa !25
  %.not.i.i.i.i22.i = icmp eq i8 %i.cu, 0
  br i1 %.not.i.i.i.i22.i, label %bb.ah, label %bb.ag

bb.ag:                                            ; preds = %.body.i
  %i.cv = load i32, ptr %i.ac, align 4, !tbaa !3  ; 2 uses
  %i.cw = add nsw i32 %i.cv, -1
  store i32 %i.cw, ptr %i.ac, align 4, !tbaa !3
  br label %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i23.i

bb.ah:                                            ; preds = %.body.i
  %i.cx = atomicrmw volatile add ptr %i.ac, i32 -1 acq_rel, align 4
  br label %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i23.i

_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i23.i: ; preds = %bb.ah, %bb.ag
  %.0.i.i.i.i.i24.i = phi i32 [ %i.cv, %bb.ag ], [ %i.cx, %bb.ah ]
  %i.cy = icmp eq i32 %.0.i.i.i.i.i24.i, 1
  br i1 %i.cy, label %bb.ai, label %_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit25.i

bb.ai:                                            ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i23.i
  %i.cz = load ptr, ptr %i.s, align 8, !tbaa !16
  %i.da = getelementptr inbounds nuw i8, ptr %i.cz, i64 24
  %i.db = load ptr, ptr %i.da, align 8
  tail call void %i.db(ptr noundef nonnull align 8 dereferenceable(16) %i.s) #27, !inline_history !164
  br label %_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit25.i

_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit25.i: ; preds = %bb.ai, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i23.i
  call void @_ZNSt12__shared_ptrIN5arrow12_GLOBAL__N_115SignalStopStateELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %0) #27
  call void @llvm.lifetime.end.p0(ptr nonnull %0) #27
  br label %.body

bb.aj:                                            ; preds = %_ZNSt8weak_ptrIN5arrow8internal13AtForkHandlerEEC2IS2_vEERKSt10shared_ptrIT_E.exit.i
  %i.dc = landingpad { ptr, i32 }
          cleanup                                 ; 3 uses
  %i.dd = load ptr, ptr %i.cb, align 8, !tbaa !144 ; 4 uses
  %.not.i.i26.i = icmp eq ptr %i.dd, null
  br i1 %.not.i.i26.i, label %.body, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  %i.de = getelementptr inbounds nuw i8, ptr %i.dd, i64 12 ; 3 uses
  %i.df = load i8, ptr @__libc_single_threaded, align 1, !tbaa !25
  %.not.i.i.i27.i = icmp eq i8 %i.df, 0
  br i1 %.not.i.i.i27.i, label %bb.am, label %bb.al

bb.al:                                            ; preds = %bb.ak
  %i.dg = load i32, ptr %i.de, align 4, !tbaa !3  ; 2 uses
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i28.i: ; preds = %bb.am, %bb.al
  %.0.i.i.i.i29.i = phi i32 [ %i.dg, %bb.al ], [ %i.di, %bb.am ]
  %i.dj = icmp eq i32 %.0.i.i.i.i29.i, 1
  br i1 %i.dj, label %bb.an, label %.body

bb.an:                                            ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i28.i
  %i.dk = load ptr, ptr %i.dd, align 8, !tbaa !16
  %i.dl = getelementptr inbounds nuw i8, ptr %i.dk, i64 24
  %i.dm = load ptr, ptr %i.dl, align 8
  call void %i.dm(ptr noundef nonnull align 8 dereferenceable(16) %i.dd) #27, !inline_history !163
  br label %.body

bb.ao:                                            ; preds = %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE23_M_add_ref_lock_nothrowEv.exit.i.i.i.i.i
  %i.dn = landingpad { ptr, i32 }
          cleanup
  br label %.body

.body:                                            ; preds = %_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit25.i, %bb.aj, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i28.i, %bb.an, %bb.ao
  %eh.lpad-body = phi { ptr, i32 } [ %i.dn, %bb.ao ], [ %eh.lpad-body.i, %_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit25.i ], [ %i.dc, %bb.aj ], [ %i.dc, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i28.i ], [ %i.dc, %bb.an ]
...
bb.ap:                                            ; preds = %bb.ae, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i19.i, %bb.aa
...
bb.a:
  ...
  store ptr null, ptr %i.b, align 8, !tbaa !159
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 128 ; 3 uses
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !18   ; 8 uses
  store ptr null, ptr %i.c, align 8, !tbaa !18
  %.not.i.i.i.i.i.i = icmp eq ptr %i.d, null
  br i1 %.not.i.i.i.i.i.i, label %_ZNSt12__shared_ptrIN5arrow8internal13AtForkHandlerELN9__gnu_cxx12_Lock_policyE2EE5resetEv.exit.i.i.i, label %bb.b
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 16
  %i.l = load ptr, ptr %i.k, align 8
  tail call void %i.l(ptr noundef nonnull align 8 dereferenceable(16) %i.d) #27, !inline_history !165
  %i.m = load ptr, ptr %i.d, align 8, !tbaa !16
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 24
  %i.o = load ptr, ptr %i.n, align 8
  tail call void %i.o(ptr noundef nonnull align 8 dereferenceable(16) %i.d) #27, !inline_history !165
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i: ; preds = %bb.f, %bb.e
  ...
  br i1 %i.s, label %bb.g, label %_ZNSt12__shared_ptrIN5arrow8internal13AtForkHandlerELN9__gnu_cxx12_Lock_policyE2EE5resetEv.exit.i.i.i, !prof !26

bb.g:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i
  tail call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.d) #27
  br label %_ZNSt12__shared_ptrIN5arrow8internal13AtForkHandlerELN9__gnu_cxx12_Lock_policyE2EE5resetEv.exit.i.i.i

_ZNSt12__shared_ptrIN5arrow8internal13AtForkHandlerELN9__gnu_cxx12_Lock_policyE2EE5resetEv.exit.i.i.i: ; preds = %bb.g, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i, %bb.c, %bb.a
  invoke fastcc void @_ZN5arrow12_GLOBAL__N_115SignalStopState18UnregisterHandlersEv(ptr noundef nonnull align 8 dereferenceable(144) %i.a)
          to label %bb.h unwind label %bb.bc

bb.h:                                             ; preds = %_ZNSt12__shared_ptrIN5arrow8internal13AtForkHandlerELN9__gnu_cxx12_Lock_policyE2EE5resetEv.exit.i.i.i
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 2 uses
  %i.u = tail call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.t) #27 ; 2 uses
  %.not.i.i.i3.i.i.i = icmp eq i32 %i.u, 0
  br i1 %.not.i.i.i3.i.i.i, label %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i.i.i.i, label %bb.i

bb.i:                                             ; preds = %bb.h
  invoke void @_ZSt20__throw_system_errori(i32 noundef %i.u) #28
          to label %.noexc.i.i.i unwind label %bb.bc

.noexc.i.i.i:                                     ; preds = %bb.i
  unreachable

_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i.i.i.i:  ; preds = %bb.h
  ...
  %.not.i.i.i.i4.i.i.i = icmp eq ptr %i.x, null
  br i1 %.not.i.i.i.i4.i.i.i, label %bb.p, label %bb.j

bb.j:                                             ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i.i.i.i
...
bb.k:                                             ; preds = %bb.j
  store i32 0, ptr %i.y, align 8, !tbaa !13
  %i.ac = getelementptr inbounds nuw i8, ptr %i.x, i64 12
  store i32 0, ptr %i.ac, align 4, !tbaa !15
  %i.ad = load ptr, ptr %i.x, align 8, !tbaa !16
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 16
  %i.af = load ptr, ptr %i.ae, align 8
  tail call void %i.af(ptr noundef nonnull align 8 dereferenceable(16) %i.x) #27, !inline_history !166
  %i.ag = load ptr, ptr %i.x, align 8, !tbaa !16
  %i.ah = getelementptr inbounds nuw i8, ptr %i.ag, i64 24
  %i.ai = load ptr, ptr %i.ah, align 8
  tail call void %i.ai(ptr noundef nonnull align 8 dereferenceable(16) %i.x) #27, !inline_history !166
  br label %bb.p
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i.i: ; preds = %bb.n, %bb.m
  ...
  br i1 %i.am, label %bb.o, label %bb.p, !prof !26

bb.o:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i.i
  tail call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.x) #27
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i.i, %bb.k, %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i.i.i.i
  %i.an = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.t) #27 ; 0 uses
  ...
  br i1 %.not.i.i.i, label %bb.ac, label %bb.q
...
bb.q:                                             ; preds = %bb.p
  ...
  invoke void %i.au(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Status") align 8 %1, ptr noundef nonnull align 8 dereferenceable(8) %i.ar)
          to label %bb.r unwind label %bb.bc

bb.r:                                             ; preds = %bb.q
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #27
  store ptr null, ptr %2, align 8, !tbaa !29
  invoke void @_ZN5arrow6Status8CopyFromERKS0_(ptr noundef nonnull align 8 dereferenceable(8) %2, ptr noundef nonnull align 8 dereferenceable(8) %1)
          to label %_ZN5arrow6StatusC2ERKS0_.exit.i.i.i unwind label %bb.bc

_ZN5arrow6StatusC2ERKS0_.exit.i.i.i:              ; preds = %bb.r
  %i.av = load ptr, ptr %2, align 8, !tbaa !29
  %i.aw = icmp eq ptr %i.av, null
  br i1 %i.aw, label %_ZN5arrow6StatusD2Ev.exit.i.i.i, label %bb.s, !prof !32

bb.s:                                             ; preds = %_ZN5arrow6StatusC2ERKS0_.exit.i.i.i
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #27
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #27
...
bb.t:                                             ; preds = %bb.s
  invoke void @_ZNK5arrow6Status4WarnERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(8) %2, ptr noundef nonnull align 8 dereferenceable(32) %3)
          to label %bb.u unwind label %bb.bc

bb.u:                                             ; preds = %bb.t
  %i.ax = load ptr, ptr %3, align 8, !tbaa !69    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i.i.i: ; preds = %bb.u, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #27
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #27
  %.pr.i.i.i = load ptr, ptr %2, align 8, !tbaa !29 ; 2 uses
  %.not.i.i.i.i = icmp eq ptr %.pr.i.i.i, null
  br i1 %.not.i.i.i.i, label %_ZN5arrow6StatusD2Ev.exit.i.i.i, label %bb.v, !prof !133

bb.v:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i.i.i
  %i.bc = getelementptr inbounds nuw i8, ptr %.pr.i.i.i, i64 1
  %i.bd = load i8, ptr %i.bc, align 1, !tbaa !33, !range !44, !noundef !45
  %i.be = trunc nuw i8 %i.bd to i1
  br i1 %i.be, label %_ZN5arrow6StatusD2Ev.exit.i.i.i, label %bb.w
...
_ZN5arrow6StatusD2Ev.exit.i.i.i:                  ; preds = %bb.w, %bb.v, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i.i.i, %_ZN5arrow6StatusC2ERKS0_.exit.i.i.i
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #27
...
bb.af:                                            ; preds = %bb.ad
  ...
  %.not.i.i.i8.i.i.i = icmp eq i8 %i.bz, 0
  br i1 %.not.i.i.i8.i.i.i, label %bb.ah, label %bb.ag
...
bb.ap:                                            ; preds = %_ZNSt12__shared_ptrIN5arrow8internal13AtForkHandlerELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i.i.i
  ...
  br i1 %.not.i.i.i14.i.i.i, label %_ZNKSt14default_deleteISt6threadEclEPS0_.exit.i.i.i.i, label %bb.aq
...
_ZNSt12__shared_ptrIN5arrow10StopSourceELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i.i.i: ; preds = %bb.aw, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i17.i.i.i, %bb.as, %_ZNSt10unique_ptrISt6threadSt14default_deleteIS0_EED2Ev.exit.i.i.i
  ...
  %.val.i.i.i = load ptr, ptr %i.dk, align 8      ; 3 uses
...
bb.ax:                                            ; preds = %_ZNSt12__shared_ptrIN5arrow10StopSourceELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i.i.i
  ...
  %i.dn = ptrtoint ptr %.val.i.i.i to i64
  %i.do = sub i64 %i.dm, %i.dn
  call void @_ZdlPvm(ptr noundef nonnull %.val.i.i.i, i64 noundef %i.do) #29
...
define internal noundef ptr @_ZNSt23_Sp_counted_ptr_inplaceIN5arrow12_GLOBAL__N_115SignalStopStateESaIvELN9__gnu_cxx12_Lock_policyE2EE14_M_get_deleterERKSt9type_info(ptr noundef nonnull readnone align 8 captures(ret: address, provenance) dereferenceable(160) %0, ptr noundef nonnull readonly align 8 captures(address) dereferenceable(16) %1) unnamed_addr #14 align 2 {
bb.a:
...
end_hunk_1
begin_hunk_2_@_ZNSt17_Function_handlerIFSt3anyvEZN5arrow12_GLOBAL__N_115SignalStopState4InitEvEUlvE_E9_M_invokeERKSt9_Any_data:bb.a
  store ptr %i.s, ptr %i.r, align 8, !tbaa !25, !alias.scope !175
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #27, !noalias !175
  ret void
}
...
bb.b:                                             ; preds = %bb.a
  store ptr @_ZTIZN5arrow12_GLOBAL__N_115SignalStopState4InitEvEUlvE_, ptr %0, align 8, !tbaa !192
...
bb.d:                                             ; preds = %bb.a
  ...
  store <2 x ptr> %i.b, ptr %i.c, align 8, !tbaa !46
...
_ZNSt14_Function_base13_Base_managerIZN5arrow12_GLOBAL__N_115SignalStopState4InitEvEUlvE_E15_M_init_functorIRKS4_EEvRSt9_Any_dataOT_.exit.i: ; preds = %bb.g, %bb.f, %bb.d
  store ptr %i.c, ptr %0, align 8, !tbaa !46
  br label %_ZNSt14_Function_base13_Base_managerIZN5arrow12_GLOBAL__N_115SignalStopState4InitEvEUlvE_E10_M_managerERSt9_Any_dataRKS6_St18_Manager_operation.exit

bb.h:                                             ; preds = %bb.a
  %.val9.i = load ptr, ptr %0, align 8, !tbaa !46 ; 3 uses
  %i.i = icmp eq ptr %.val9.i, null
  br i1 %i.i, label %_ZNSt14_Function_base13_Base_managerIZN5arrow12_GLOBAL__N_115SignalStopState4InitEvEUlvE_E10_M_managerERSt9_Any_dataRKS6_St18_Manager_operation.exit, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.j = getelementptr i8, ptr %.val9.i, i64 8
  %.val.i.i = load ptr, ptr %i.j, align 8, !tbaa !144 ; 4 uses
  %.not.i.i.i.i.i = icmp eq ptr %.val.i.i, null
  br i1 %.not.i.i.i.i.i, label %_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit.i.i, label %bb.j
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i: ; preds = %bb.l, %bb.k
  ...
  br i1 %i.p, label %bb.m, label %_ZZN5arrow12_GLOBAL__N_115SignalStopState4InitEvENUlvE_D2Ev.exit.i.i

bb.m:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i
  %i.q = load ptr, ptr %.val.i.i, align 8, !tbaa !16
  %i.r = getelementptr inbounds nuw i8, ptr %i.q, i64 24
  %i.s = load ptr, ptr %i.r, align 8
  tail call void %i.s(ptr noundef nonnull align 8 dereferenceable(16) %.val.i.i) #27, !inline_history !194
...
declare void @_ZN5arrow8internal8SelfPipe4MakeEb(ptr dead_on_unwind writable sret(%"class.arrow::Result.60") align 8, i1 noundef zeroext) local_unnamed_addr #9
...
bb.a:
  ...
  %i.b = icmp eq ptr %i.a, null
  br i1 %i.b, label %bb.b, label %_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEE7DestroyEv.exit.thread, !prof !32

bb.b:                                             ; preds = %bb.a
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !18   ; 8 uses
  %.not.i.i.i.i = icmp eq ptr %i.d, null
  br i1 %.not.i.i.i.i, label %_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEE7DestroyEv.exit, label %bb.c
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 16
  %i.l = load ptr, ptr %i.k, align 8
  tail call void %i.l(ptr noundef nonnull align 8 dereferenceable(16) %i.d) #27, !inline_history !204
  %i.m = load ptr, ptr %i.d, align 8, !tbaa !16
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 24
  %i.o = load ptr, ptr %i.n, align 8
  tail call void %i.o(ptr noundef nonnull align 8 dereferenceable(16) %i.d) #27, !inline_history !204
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i: ; preds = %bb.g, %bb.f
  ...
  br i1 %i.s, label %bb.h, label %_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEE7DestroyEv.exit, !prof !26

bb.h:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i
  tail call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.d) #27
  br label %_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEE7DestroyEv.exit

_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEE7DestroyEv.exit: ; preds = %bb.b, %bb.d, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i, %bb.h
  %.pr = load ptr, ptr %0, align 8, !tbaa !29     ; 2 uses
  %.not.i = icmp eq ptr %.pr, null
  br i1 %.not.i, label %_ZN5arrow6StatusD2Ev.exit, label %_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEE7DestroyEv.exit.thread, !prof !86

_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEE7DestroyEv.exit.thread: ; preds = %bb.a, %_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEE7DestroyEv.exit
  %i.t = phi ptr [ %.pr, %_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEE7DestroyEv.exit ], [ %i.a, %bb.a ]
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 1
  %i.v = load i8, ptr %i.u, align 1, !tbaa !33, !range !44, !noundef !45
  %i.w = trunc nuw i8 %i.v to i1
  br i1 %i.w, label %_ZN5arrow6StatusD2Ev.exit, label %bb.i

bb.i:                                             ; preds = %_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEE7DestroyEv.exit.thread
  tail call void @_ZN5arrow6Status11DeleteStateEv(ptr noundef nonnull align 8 dereferenceable(8) %0) #27
  br label %_ZN5arrow6StatusD2Ev.exit

_ZN5arrow6StatusD2Ev.exit:                        ; preds = %_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEE7DestroyEv.exit, %_ZN5arrow6ResultISt10shared_ptrINS_8internal8SelfPipeEEE7DestroyEv.exit.thread, %bb.i
  ret void
}

declare void @_ZN5arrow8internal16SetSignalHandlerEiRKNS0_13SignalHandlerE(ptr dead_on_unwind writable sret(%"class.arrow::Result.64") align 8, i32 noundef, ptr noundef nonnull align 8 dereferenceable(152)) local_unnamed_addr #9
...
_ZN5arrow12_GLOBAL__N_115SignalStopState8instanceEv.exit: ; preds = %bb.a, %bb.b, %bb.d
  %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i = load ptr, ptr @_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance, align 8, !tbaa !58 ; 2 uses
  %.not = icmp eq ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, null
  br i1 %.not, label %bb.h, label %bb.f

bb.f:                                             ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState8instanceEv.exit
  %i.f = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 136
  %i.g = load atomic ptr, ptr %i.f seq_cst, align 8 ; 3 uses
  %.not.i2 = icmp eq ptr %i.g, null
  br i1 %.not.i2, label %_ZN5arrow12_GLOBAL__N_115SignalStopState14DoHandleSignalEi.exit, label %bb.g
...
bb.g:                                             ; preds = %bb.f
  ...
  tail call void %i.k(ptr noundef nonnull align 8 dereferenceable(8) %i.g, i64 noundef %i.h), !inline_history !205
  br label %_ZN5arrow12_GLOBAL__N_115SignalStopState14DoHandleSignalEi.exit

_ZN5arrow12_GLOBAL__N_115SignalStopState14DoHandleSignalEi.exit: ; preds = %bb.f, %bb.g
  tail call void @_ZN5arrow8internal22ReinstateSignalHandlerEiPFviE(i32 noundef %0, ptr noundef nonnull @_ZN5arrow12_GLOBAL__N_115SignalStopState12HandleSignalEi), !inline_history !205
  br label %bb.h

bb.h:                                             ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState14DoHandleSignalEi.exit, %_ZN5arrow12_GLOBAL__N_115SignalStopState8instanceEv.exit
  ret void
}
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #27
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #27, !noalias !206
  call void @_ZN5arrow8internal19StringStreamWrapperC1Ev(ptr noundef nonnull align 8 dereferenceable(16) %3), !noalias !206
  %i.a = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !209, !noalias !206, !nonnull !45, !align !219
  %i.c = call noundef i64 @strlen(ptr noundef nonnull align 1 dereferenceable(35) %2) #27, !noalias !206
  %i.d = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.b, ptr noundef nonnull align 1 dereferenceable(35) %2, i64 noundef %i.c)
          to label %_ZZN5arrow8internal12JoinToStringIJRA35_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS4_EEDaSF_.exit.i unwind label %bb.b, !noalias !206 ; 0 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #27, !noalias !206
  br label %common.resume
...
bb.e:                                             ; preds = %_ZN5arrow8internal12JoinToStringIJRA35_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_.exit
  %i.g = load ptr, ptr %4, align 8, !tbaa !69     ; 2 uses
...
bb.f:                                             ; preds = %_ZN5arrow8internal12JoinToStringIJRA35_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_.exit
  %i.l = landingpad { ptr, i32 }
          cleanup
  %i.m = load ptr, ptr %4, align 8, !tbaa !69     ; 2 uses
...
bb.a:
  %1 = alloca %"class.arrow::Result.94", align 8  ; 14 uses
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 8
  br label %.backedge

.backedge:                                        ; preds = %.backedge.backedge, %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %1) #27
  %i.b = load ptr, ptr %0, align 8, !tbaa !76     ; 2 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !16
  %i.d = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  %i.e = load ptr, ptr %i.d, align 8
  call void %i.e(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Result.94") align 8 %1, ptr noundef nonnull align 8 dereferenceable(8) %i.b)
  %i.f = load ptr, ptr %1, align 8, !tbaa !29     ; 3 uses
  %.not = icmp eq ptr %i.f, null                  ; 3 uses
  br i1 %.not, label %bb.d, label %_ZNK5arrow6Status9IsInvalidEv.exit

_ZNK5arrow6Status9IsInvalidEv.exit:               ; preds = %.backedge
  %i.g = load i8, ptr %i.f, align 8, !tbaa !220
  %i.h = icmp eq i8 %i.g, 4
  br i1 %i.h, label %.thread.thread, label %bb.c
...
bb.c:                                             ; preds = %_ZNK5arrow6Status9IsInvalidEv.exit
  invoke void @_ZNK5arrow6Status4WarnEv(ptr noundef nonnull align 8 dereferenceable(8) %1)
          to label %bb.l unwind label %bb.b

bb.d:                                             ; preds = %.backedge
  %i.j = load i64, ptr %i.a, align 8, !tbaa !100
  %i.k = load atomic i8, ptr @_ZGVZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance acquire, align 8
  %i.l = icmp eq i8 %i.k, 0
  br i1 %i.l, label %bb.e, label %bb.i, !prof !57

bb.e:                                             ; preds = %bb.d
  %i.m = call i32 @__cxa_guard_acquire(ptr nonnull @_ZGVZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance) #27
...
bb.g:                                             ; preds = %bb.f
  %i.n = call i32 @__cxa_atexit(ptr nonnull @_ZNSt12__shared_ptrIN5arrow12_GLOBAL__N_115SignalStopStateELN9__gnu_cxx12_Lock_policyE2EED2Ev, ptr nonnull @_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance, ptr nonnull @__dso_handle) #27 ; 0 uses
...
bb.i:                                             ; preds = %bb.g, %bb.e, %bb.d
  %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i = load ptr, ptr @_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance, align 8, !tbaa !58 ; 2 uses
  %i.p = trunc i64 %i.j to i32
  %i.q = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 16 ; 2 uses
  %i.r = call noundef i32 @pthread_mutex_lock(ptr noundef nonnull align 8 dereferenceable(40) %i.q) #27 ; 2 uses
  %.not.i.i.i = icmp eq i32 %i.r, 0
  br i1 %.not.i.i.i, label %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i, label %bb.j
...
_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i:        ; preds = %bb.i
  %i.s = getelementptr inbounds nuw i8, ptr %_ZZN5arrow12_GLOBAL__N_115SignalStopState8instanceEvE8instance.val.i, i64 80
  %i.t = load ptr, ptr %i.s, align 8, !tbaa !61   ; 2 uses
  %.not.i6 = icmp eq ptr %i.t, null
  br i1 %.not.i6, label %_ZN5arrow12_GLOBAL__N_115SignalStopState13ReceiveSignalEi.exit, label %bb.k

bb.k:                                             ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !27
  store atomic i32 %i.p, ptr %i.u seq_cst, align 4
  br label %_ZN5arrow12_GLOBAL__N_115SignalStopState13ReceiveSignalEi.exit

_ZN5arrow12_GLOBAL__N_115SignalStopState13ReceiveSignalEi.exit: ; preds = %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit.i, %bb.k
  %i.v = call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) %i.q) #27 ; 0 uses
  br label %bb.l

bb.l:                                             ; preds = %_ZN5arrow12_GLOBAL__N_115SignalStopState13ReceiveSignalEi.exit, %bb.c
  %.pr = load ptr, ptr %1, align 8, !tbaa !29     ; 2 uses
  %.not.i.i = icmp eq ptr %.pr, null
  br i1 %.not.i.i, label %_ZN5arrow6ResultImED2Ev.exit, label %.thread, !prof !86

.thread:                                          ; preds = %bb.l
  %i.w = getelementptr inbounds nuw i8, ptr %.pr, i64 1
  %i.x = load i8, ptr %i.w, align 1, !tbaa !33, !range !44, !noundef !45
  %i.y = trunc nuw i8 %i.x to i1
  br i1 %i.y, label %_ZN5arrow6ResultImED2Ev.exit, label %bb.m

.thread.thread:                                   ; preds = %_ZNK5arrow6Status9IsInvalidEv.exit
  %i.z = getelementptr inbounds nuw i8, ptr %i.f, i64 1
  %i.aa = load i8, ptr %i.z, align 1, !tbaa !33, !range !44, !noundef !45
  %i.ab = trunc nuw i8 %i.aa to i1
  br i1 %i.ab, label %.loopexit.sink.split, label %.thread18

.thread18:                                        ; preds = %.thread.thread
  call void @_ZN5arrow6Status11DeleteStateEv(ptr noundef nonnull align 8 dereferenceable(16) %1) #27
...
_ZN5arrow6ResultImED2Ev.exit:                     ; preds = %bb.l, %.thread
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #27
  br i1 %.not, label %.backedge.backedge, label %.loopexit

.backedge.backedge:                               ; preds = %_ZN5arrow6ResultImED2Ev.exit, %bb.m
  br label %.backedge
...
.body:                                            ; preds = %bb.n, %bb.h, %bb.b
  %.pn = phi { ptr, i32 } [ %i.i, %bb.b ], [ %i.ac, %bb.n ], [ %i.o, %bb.h ]
  %i.ad = load ptr, ptr %1, align 8, !tbaa !29    ; 2 uses
  %.not.i.i7 = icmp eq ptr %i.ad, null
  br i1 %.not.i.i7, label %_ZN5arrow6ResultImED2Ev.exit8, label %bb.o, !prof !32

bb.o:                                             ; preds = %.body
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 1
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !33, !range !44, !noundef !45
  %i.ag = trunc nuw i8 %i.af to i1
  br i1 %i.ag, label %_ZN5arrow6ResultImED2Ev.exit8, label %bb.p

bb.p:                                             ; preds = %bb.o
  call void @_ZN5arrow6Status11DeleteStateEv(ptr noundef nonnull align 8 dereferenceable(16) %1) #27
  br label %_ZN5arrow6ResultImED2Ev.exit8

_ZN5arrow6ResultImED2Ev.exit8:                    ; preds = %.body, %bb.o, %bb.p
  call void @llvm.lifetime.end.p0(ptr nonnull %1) #27
  resume { ptr, i32 } %.pn
...
.loopexit:                                        ; preds = %bb.m, %_ZN5arrow6ResultImED2Ev.exit, %.loopexit.sink.split
  ret void
}
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr void @_ZNSt6thread24_M_thread_deps_never_runEv() #1 comdat align 2 {
bb.a:
  ret void
}
...
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVNSt6thread11_State_implINS_8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES7_EEEEEE, i64 16), ptr %0, align 8, !tbaa !16
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !18   ; 8 uses
  %.not.i.i.i.i = icmp eq ptr %i.b, null
  br i1 %.not.i.i.i.i, label %_ZNSt6thread8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES6_EEED2Ev.exit, label %bb.b
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  %i.j = load ptr, ptr %i.i, align 8
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #27, !inline_history !221
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !16
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #27, !inline_history !221
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i: ; preds = %bb.f, %bb.e
  ...
  br i1 %i.q, label %bb.g, label %_ZNSt6thread8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES6_EEED2Ev.exit, !prof !26

bb.g:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i
  tail call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #27
  br label %_ZNSt6thread8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES6_EEED2Ev.exit

_ZNSt6thread8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES6_EEED2Ev.exit: ; preds = %bb.a, %bb.c, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i, %bb.g
  tail call void @_ZNSt6thread6_StateD2Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %0) #27
  ret void
}
...
bb.a:
  ...
  br i1 %.not.i.i.i.i.i, label %_ZNSt6thread11_State_implINS_8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES7_EEEEED2Ev.exit, label %bb.b
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.i = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  %i.j = load ptr, ptr %i.i, align 8
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #27, !inline_history !222
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !16
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #27, !inline_history !222
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i: ; preds = %bb.f, %bb.e
  ...
  br i1 %i.q, label %bb.g, label %_ZNSt6thread11_State_implINS_8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES7_EEEEED2Ev.exit, !prof !26

bb.g:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i
  tail call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #27, !inline_history !223
  br label %_ZNSt6thread11_State_implINS_8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES7_EEEEED2Ev.exit

_ZNSt6thread11_State_implINS_8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES7_EEEEED2Ev.exit: ; preds = %bb.a, %bb.c, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i, %bb.g
  tail call void @_ZNSt6thread6_StateD2Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(32) %0) #27, !inline_history !223
  tail call void @_ZdlPvm(ptr noundef nonnull %0, i64 noundef 32) #29
  ret void
}
...
bb.a:
  %1 = alloca %"class.std::shared_ptr.10", align 16 ; 6 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 24
  call void @llvm.lifetime.start.p0(ptr nonnull %1)
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !46
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.e = load <2 x ptr>, ptr %i.a, align 8, !tbaa !46
  store ptr null, ptr %i.d, align 8, !tbaa !18
  store <2 x ptr> %i.e, ptr %1, align 16, !tbaa !46
  store ptr null, ptr %i.a, align 8, !tbaa !76
  invoke void %i.c(ptr noundef nonnull %1)
          to label %bb.b unwind label %bb.i
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not.i.i.i.i.i.i, label %_ZNSt6thread8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES6_EEEclEv.exit, label %bb.c
...
bb.d:                                             ; preds = %bb.c
  ...
  store i32 0, ptr %i.l, align 4, !tbaa !15
  %i.m = load ptr, ptr %i.g, align 8, !tbaa !16
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 16
  %i.o = load ptr, ptr %i.n, align 8
  call void %i.o(ptr noundef nonnull align 8 dereferenceable(16) %i.g) #27, !inline_history !224
  %i.p = load ptr, ptr %i.g, align 8, !tbaa !16
  %i.q = getelementptr inbounds nuw i8, ptr %i.p, i64 24
  %i.r = load ptr, ptr %i.q, align 8
  call void %i.r(ptr noundef nonnull align 8 dereferenceable(16) %i.g) #27, !inline_history !224
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i: ; preds = %bb.g, %bb.f
  %.0.i.i.i.i.i.i.i.i = phi i32 [ %i.k, %bb.f ], [ %i.u, %bb.g ]
  %i.v = icmp eq i32 %.0.i.i.i.i.i.i.i.i, 1
  br i1 %i.v, label %bb.h, label %_ZNSt6thread8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES6_EEEclEv.exit, !prof !26

bb.h:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i
  call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.g) #27
  br label %_ZNSt6thread8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES6_EEEclEv.exit

bb.i:                                             ; preds = %bb.a
  %i.w = landingpad { ptr, i32 }
          cleanup
  call void @_ZNSt12__shared_ptrIN5arrow8internal8SelfPipeELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %1) #27
  resume { ptr, i32 } %i.w

_ZNSt6thread8_InvokerISt5tupleIJPFvSt10shared_ptrIN5arrow8internal8SelfPipeEEES6_EEEclEv.exit: ; preds = %bb.b, %bb.d, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i, %bb.h
  call void @llvm.lifetime.end.p0(ptr nonnull %1)
  ret void
}
...
; Function Attrs: mustprogress uwtable
define linkonce_odr noundef nonnull align 8 dereferenceable(8) ptr @_ZN5arrow4util12ArrowLogBaselsIA38_cEERS1_RKT_(ptr noundef nonnull align 8 dereferenceable(8) %0, ptr noundef nonnull align 1 dereferenceable(38) %1) local_unnamed_addr #0 comdat align 2 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !16
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  %i.c = load ptr, ptr %i.b, align 8
...
declare void @_ZN5arrow8internal19UninitializedResultEv(ptr dead_on_unwind writable sret(%"class.arrow::Status") align 8) local_unnamed_addr #9
...
end_hunk_2
begin_hunk_3_@_ZNSt23_Sp_counted_ptr_inplaceIN5arrow14StopSourceImplESaIvELN9__gnu_cxx12_Lock_policyE2EE10_M_destroyEv
...
bb.a:
  ...
  %4 = alloca %"class.std::__cxx11::basic_string", align 8 ; 9 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #27
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #27, !noalias !225
  call void @_ZN5arrow8internal19StringStreamWrapperC1Ev(ptr noundef nonnull align 8 dereferenceable(16) %3), !noalias !225
  %i.a = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !209, !noalias !225, !nonnull !45, !align !219
  %i.c = call noundef i64 @strlen(ptr noundef nonnull align 1 dereferenceable(20) %2) #27, !noalias !225
  %i.d = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.b, ptr noundef nonnull align 1 dereferenceable(20) %2, i64 noundef %i.c)
          to label %_ZZN5arrow8internal12JoinToStringIJRA20_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS4_EEDaSF_.exit.i unwind label %bb.b, !noalias !225 ; 0 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  %.pn.i = phi { ptr, i32 } [ %i.f, %bb.c ], [ %i.e, %bb.b ]
  call void @_ZN5arrow8internal19StringStreamWrapperD1Ev(ptr noundef nonnull align 8 dead_on_return(16) dereferenceable(16) %3) #27
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #27, !noalias !225
  br label %common.resume
...
bb.a:
  ...
  %5 = alloca %"class.std::__cxx11::basic_string", align 8 ; 6 uses
  %6 = alloca %"class.std::shared_ptr.23", align 16 ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #27, !noalias !228
  call void @_ZN5arrow8internal19StringStreamWrapperC1Ev(ptr noundef nonnull align 8 dereferenceable(16) %4), !noalias !228
  %i.a = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !209, !noalias !228, !nonnull !45, !align !219
  %i.c = call noundef i64 @strlen(ptr noundef nonnull align 1 dereferenceable(20) %3) #27, !noalias !228
  %i.d = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.b, ptr noundef nonnull align 1 dereferenceable(20) %3, i64 noundef %i.c)
          to label %_ZZN5arrow8internal12JoinToStringIJRA20_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS4_EEDaSF_.exit.i unwind label %bb.b, !noalias !228 ; 0 uses
...
_ZN5arrow8internal12JoinToStringIJRA20_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_.exit: ; preds = %_ZZN5arrow8internal12JoinToStringIJRA20_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS4_EEDaSF_.exit.i
  ...
  %i.h = load <2 x ptr>, ptr %2, align 8, !tbaa !46
  store ptr null, ptr %i.g, align 8, !tbaa !18
  store <2 x ptr> %i.h, ptr %6, align 16, !tbaa !46
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.q = getelementptr inbounds nuw i8, ptr %i.p, i64 16
  %i.r = load ptr, ptr %i.q, align 8
  call void %i.r(ptr noundef nonnull align 8 dereferenceable(16) %i.j) #27, !inline_history !232
  %i.s = load ptr, ptr %i.j, align 8, !tbaa !16
  %i.t = getelementptr inbounds nuw i8, ptr %i.s, i64 24
  %i.u = load ptr, ptr %i.t, align 8
  call void %i.u(ptr noundef nonnull align 8 dereferenceable(16) %i.j) #27, !inline_history !232
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i: ; preds = %bb.j, %bb.i
  ...
  br i1 %i.y, label %bb.k, label %_ZNSt12__shared_ptrIN5arrow12StatusDetailELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !26

bb.k:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i
  call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.j) #27
  br label %_ZNSt12__shared_ptrIN5arrow12StatusDetailELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit
...
bb.l:                                             ; preds = %_ZN5arrow8internal12JoinToStringIJRA20_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_.exit
  %i.ae = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  call void @_ZNSt12__shared_ptrIN5arrow12StatusDetailELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %6) #27
  %i.af = load ptr, ptr %5, align 8, !tbaa !69    ; 2 uses
...
declare void @_ZN5arrow8internal22StatusDetailFromSignalEi(ptr dead_on_unwind writable sret(%"class.std::shared_ptr.23") align 8, i32 noundef) local_unnamed_addr #9
...
bb.a:
  ...
  %4 = alloca %"class.std::__cxx11::basic_string", align 8 ; 9 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #27
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #27, !noalias !233
  call void @_ZN5arrow8internal19StringStreamWrapperC1Ev(ptr noundef nonnull align 8 dereferenceable(16) %3), !noalias !233
  %i.a = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !209, !noalias !233, !nonnull !45, !align !219
  %i.c = call noundef i64 @strlen(ptr noundef nonnull align 1 dereferenceable(34) %2) #27, !noalias !233
  %i.d = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.b, ptr noundef nonnull align 1 dereferenceable(34) %2, i64 noundef %i.c)
          to label %_ZZN5arrow8internal12JoinToStringIJRA34_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS4_EEDaSF_.exit.i unwind label %bb.b, !noalias !233 ; 0 uses

_ZZN5arrow8internal12JoinToStringIJRA34_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS4_EEDaSF_.exit.i: ; preds = %bb.a
  invoke void @_ZN5arrow8internal19StringStreamWrapper3strB5cxx11Ev(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %4, ptr noundef nonnull align 8 dereferenceable(16) %3)
          to label %_ZN5arrow8internal12JoinToStringIJRA34_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_.exit unwind label %bb.c
...
bb.c:                                             ; preds = %_ZZN5arrow8internal12JoinToStringIJRA34_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS4_EEDaSF_.exit.i
  %i.f = landingpad { ptr, i32 }
          cleanup
  br label %bb.d
...
bb.d:                                             ; preds = %bb.c, %bb.b
  %.pn.i = phi { ptr, i32 } [ %i.f, %bb.c ], [ %i.e, %bb.b ]
  call void @_ZN5arrow8internal19StringStreamWrapperD1Ev(ptr noundef nonnull align 8 dead_on_return(16) dereferenceable(16) %3) #27
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #27, !noalias !233
  br label %common.resume

_ZN5arrow8internal12JoinToStringIJRA34_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_.exit: ; preds = %_ZZN5arrow8internal12JoinToStringIJRA34_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS4_EEDaSF_.exit.i
  call void @_ZN5arrow8internal19StringStreamWrapperD1Ev(ptr noundef nonnull align 8 dead_on_return(16) dereferenceable(16) %3) #27
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #27, !noalias !233
  invoke void @_ZN5arrow6StatusC1ENS_10StatusCodeERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE(ptr noundef nonnull align 8 dereferenceable(8) %0, i8 noundef signext %1, ptr noundef nonnull align 8 dereferenceable(32) %4)
          to label %bb.e unwind label %bb.f

bb.e:                                             ; preds = %_ZN5arrow8internal12JoinToStringIJRA34_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_.exit
  %i.g = load ptr, ptr %4, align 8, !tbaa !69     ; 2 uses
  %i.h = getelementptr inbounds nuw i8, ptr %4, i64 16 ; 2 uses
  %i.i = icmp eq ptr %i.g, %i.h
  br i1 %i.i, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
...
bb.f:                                             ; preds = %_ZN5arrow8internal12JoinToStringIJRA34_KcEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_.exit
  %i.l = landingpad { ptr, i32 }
          cleanup
  %i.m = load ptr, ptr %4, align 8, !tbaa !69     ; 2 uses
  %i.n = getelementptr inbounds nuw i8, ptr %4, i64 16 ; 2 uses
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !174  ; 7 uses
  %i.c = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.d = load i64, ptr %i.c, align 8, !tbaa !174  ; 7 uses
  %i.e = add i64 %i.d, %i.b                       ; 4 uses
  %i.f = load ptr, ptr %1, align 8, !tbaa !69     ; 3 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit: ; preds = %bb.a, %bb.b
  ...
  %.pre = load ptr, ptr %2, align 8, !tbaa !69    ; 4 uses
...
.critedge:                                        ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit12
  ...
  store ptr %i.s, ptr %0, align 8, !tbaa !173
  %i.t = load ptr, ptr %i.r, align 8, !tbaa !69   ; 2 uses
...
bb.e:                                             ; preds = %.critedge
  ...
  %i.x = load i64, ptr %i.w, align 8, !tbaa !174  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i: ; preds = %.critedge
  store ptr %i.t, ptr %0, align 8, !tbaa !69
  %i.aa = load i64, ptr %i.u, align 8, !tbaa !25
  store i64 %i.aa, ptr %i.s, align 8, !tbaa !25
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit: ; preds = %bb.e, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i
  ...
  %i.ac = load i64, ptr %i.ab, align 8, !tbaa !174
