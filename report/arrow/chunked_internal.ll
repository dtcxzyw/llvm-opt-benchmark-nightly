...
begin_hunk_0_@_ZN5arrow7compute8internal16GetArrayPointersERKSt6vectorISt10shared_ptrINS_5ArrayEESaIS5_EE:bb.a
  ...
  %next.gep17 = getelementptr i8, ptr %i.c, i64 %offset.idx16 ; 2 uses
  %i.ai = getelementptr i8, ptr %i.c, i64 %offset.idx16
  %next.gep18 = getelementptr i8, ptr %i.ai, i64 32 ; 2 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %next.gep17) ]
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %next.gep18) ]
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader22, %.lr.ph.i
  ...
  %.sroa.03.06.i = phi ptr [ %i.an, %.lr.ph.i ], [ %.sroa.03.06.i.ph, %.lr.ph.i.preheader22 ] ; 3 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.03.06.i) ]
...
bb.c:                                             ; preds = %bb.c, %.lr.ph.new
  ...
  %i.l = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.09 ; 2 uses
...
bb.d:                                             ; preds = %bb.d, %.epil.preheader
  ...
  %i.ar = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %.09.epil ; 2 uses
...
bb.c:                                             ; preds = %bb.c, %.lr.ph.new
  ...
  %niter = phi i64 [ 0, %.lr.ph.new ], [ %niter.next.3, %bb.c ]
  %i.s = getelementptr inbounds nuw [16 x i8], ptr %i.c, i64 %.010 ; 2 uses
...
bb.d:                                             ; preds = %bb.d, %.epil.preheader
  ...
  %epil.iter = phi i64 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.d ]
  %i.aq = getelementptr inbounds nuw [16 x i8], ptr %i.c, i64 %.010.epil ; 2 uses
...
.critedge:                                        ; preds = %.preheader, %bb.e
  %.sroa.031.035 = phi ptr [ %i.o, %bb.e ], [ %i.e, %.preheader ] ; 3 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.031.035) ]
...
.lr.ph42:                                         ; preds = %._crit_edge, %._crit_edge38
  ...
  %i.ag = getelementptr inbounds nuw [8 x i8], ptr %i.e, i64 %.02140 ; 2 uses
...
begin_hunk_8_@_ZN5arrow7compute8internal18ChunkedIndexMapper17PhysicalToLogicalEv:bb.a
  ...
  %i.p = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %.01522.epil ; 2 uses
...
begin_hunk_9_@_ZN5arrow7compute8internal18ChunkedIndexMapper17PhysicalToLogicalEv:bb.a
  ...
  %i.af = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %.01522 ; 2 uses
...
begin_hunk_10_@_ZN5arrow7compute8internal18ChunkedIndexMapper17PhysicalToLogicalEv:bb.a
  ...
  %i.bd = getelementptr inbounds nuw [8 x i8], ptr %.sroa.019.037, i64 %i.bc ; 2 uses
...
begin_hunk_11_@_ZN5arrow7compute8internal18ChunkedIndexMapper17PhysicalToLogicalEv:bb.a
  ...
  %i.bl = getelementptr inbounds nuw [8 x i8], ptr %.sroa.019.037, i64 %i.bk ; 2 uses
...
begin_hunk_12_@_ZN5arrow7compute8internal18ChunkedIndexMapper17PhysicalToLogicalEv:bb.a
  ...
  %i.bu = getelementptr inbounds nuw [8 x i8], ptr %.sroa.019.037, i64 %i.bt ; 2 uses
