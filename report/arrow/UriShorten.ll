...
bb.d:                                             ; preds = %bb.c
  tail call void @uriResetUriA(ptr noundef nonnull %0) #3
...
bb.g:                                             ; preds = %bb.f
  %i.j = tail call i32 @uriCompareRangeA(ptr noundef nonnull %1, ptr noundef nonnull %2) #3
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.k = tail call i32 @uriCopyAuthorityA(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %.013) #3
  %.not108.i = icmp eq i32 %i.k, 0
  br i1 %.not108.i, label %uriRemoveBaseUriImplA.exit, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.l = tail call i32 @uriCopyPathA(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %.013) #3
...
bb.l:                                             ; preds = %bb.k
  %5 = load i32, ptr %i.n, align 1
  %6 = load i32, ptr %i.p, align 1
  %7 = icmp ne i32 %5, %6
  %8 = zext i1 %7 to i32
...
bb.o:                                             ; preds = %bb.n
  %9 = load i128, ptr %i.r, align 1
  %10 = load i128, ptr %i.t, align 1
  %11 = icmp ne i128 %9, %10
...
bb.r:                                             ; preds = %bb.q
  %i.y = tail call i32 @uriCompareRangeA(ptr noundef nonnull %i.u, ptr noundef nonnull %i.w) #3
  br label %uriEqualsAuthorityA.exit.i

bb.s:                                             ; preds = %bb.p
  %i.z = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.aa = getelementptr inbounds nuw i8, ptr %2, i64 32
  %i.ab = tail call i32 @uriCompareRangeA(ptr noundef nonnull %i.z, ptr noundef nonnull %i.aa) #3
  br label %uriEqualsAuthorityA.exit.i

uriEqualsAuthorityA.exit.i:                       ; preds = %bb.s, %bb.r, %bb.o, %bb.l
  %.0.shrunk.i.in.i = phi i32 [ %i.ab, %bb.s ], [ %8, %bb.l ], [ %12, %bb.o ], [ %i.y, %bb.r ]
...
uriEqualsAuthorityA.exit.thread.i:                ; preds = %uriEqualsAuthorityA.exit.i, %bb.q, %bb.n, %bb.k
  %i.ac = tail call i32 @uriCopyAuthorityA(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %.013) #3
...
bb.t:                                             ; preds = %uriEqualsAuthorityA.exit.thread.i
  %i.ad = tail call i32 @uriCopyPathA(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %.013) #3
...
bb.v:                                             ; preds = %bb.u
  %i.af = tail call i32 @uriCopyPathA(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %.013) #3
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.ah = tail call i32 @uriFixAmbiguityA(ptr noundef nonnull %0, ptr noundef nonnull %.013) #3
...
.lr.ph.i:                                         ; preds = %bb.x, %.critedge111.i
  ...
  %i.ap = tail call i32 @uriCompareRangeA(ptr noundef nonnull %.085140.i, ptr noundef nonnull %.083141.i) #3
...
bb.aa:                                            ; preds = %.lr.ph151.i
  ...
  %i.bl = tail call ptr %i.bk(ptr noundef nonnull %.013, i64 noundef 32) #3 ; 7 uses
...
.lr.ph:                                           ; preds = %.peel.next.i, %uriAppendSegmentA.exit.i
  ...
  %i.bw = tail call ptr %i.bv(ptr noundef nonnull %.013, i64 noundef 32) #3 ; 7 uses
...
bb.ak:                                            ; preds = %.lr.ph157.i
  ...
  %i.cp = tail call ptr %i.co(ptr noundef nonnull %.013, i64 noundef 32) #3 ; 8 uses
...
bb.ao:                                            ; preds = %.critedge113.i
  ...
  %i.cy = tail call ptr %i.cx(ptr noundef nonnull %.013, i64 noundef 32) #3 ; 8 uses
...
begin_hunk_12
  ...
  %i.dj = tail call ptr %i.di(ptr noundef nonnull %.013, i64 noundef 32) #3 ; 7 uses
...
uriRemoveBaseUriImplA.exit:                       ; preds = %.lr.ph, %.critedge115.i, %bb.ao, %bb.ak, %bb.aa, %bb.w, %bb.v, %bb.t, %uriEqualsAuthorityA.exit.thread.i, %bb.i, %bb.h, %bb.f, %bb.e, %bb.d
  ...
  %i.dw = tail call i32 @uriFreeUriMembersMmA(ptr noundef nonnull %0, ptr noundef nonnull %.013) #3 ; 0 uses
...
bb.g:                                             ; preds = %bb.f
  %i.j = tail call i32 @uriCompareRangeW(ptr noundef nonnull %1, ptr noundef nonnull %2) #3
  %.not.i = icmp eq i32 %i.j, 0
  br i1 %.not.i, label %bb.j, label %bb.h
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.k = tail call i32 @uriCopyAuthorityW(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %.013) #3
  %.not108.i = icmp eq i32 %i.k, 0
  br i1 %.not108.i, label %uriRemoveBaseUriImplW.exit, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.l = tail call i32 @uriCopyPathW(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %.013) #3
  %.not109.i = icmp eq i32 %i.l, 0
...
bb.r:                                             ; preds = %bb.q
  %i.y = tail call i32 @uriCompareRangeW(ptr noundef nonnull %i.u, ptr noundef nonnull %i.w) #3
  br label %uriEqualsAuthorityW.exit.i

bb.s:                                             ; preds = %bb.p
  %i.z = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.aa = getelementptr inbounds nuw i8, ptr %2, i64 32
  %i.ab = tail call i32 @uriCompareRangeW(ptr noundef nonnull %i.z, ptr noundef nonnull %i.aa) #3
  br label %uriEqualsAuthorityW.exit.i
...
uriEqualsAuthorityW.exit.thread.i:                ; preds = %uriEqualsAuthorityW.exit.i, %bb.q, %bb.n, %bb.k
  %i.ac = tail call i32 @uriCopyAuthorityW(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %.013) #3
  %.not94.i = icmp eq i32 %i.ac, 0
  br i1 %.not94.i, label %uriRemoveBaseUriImplW.exit, label %bb.t

bb.t:                                             ; preds = %uriEqualsAuthorityW.exit.thread.i
  %i.ad = tail call i32 @uriCopyPathW(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %.013) #3
  %.not95.i = icmp eq i32 %i.ad, 0
...
bb.v:                                             ; preds = %bb.u
  %i.af = tail call i32 @uriCopyPathW(ptr noundef nonnull %0, ptr noundef nonnull %1, ptr noundef nonnull %.013) #3
  %.not106.i = icmp eq i32 %i.af, 0
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.ah = tail call i32 @uriFixAmbiguityW(ptr noundef nonnull %0, ptr noundef nonnull %.013) #3
  %.not107.i = icmp eq i32 %i.ah, 0
...
.lr.ph.i:                                         ; preds = %bb.x, %.critedge111.i
  %.083141.i = phi ptr [ %i.bb, %.critedge111.i ], [ %i.al, %bb.x ] ; 5 uses
  %.085140.i = phi ptr [ %i.av, %.critedge111.i ], [ %i.aj, %bb.x ] ; 6 uses
  %i.ap = tail call i32 @uriCompareRangeW(ptr noundef nonnull %.085140.i, ptr noundef nonnull %.083141.i) #3
  %.not96.i = icmp eq i32 %i.ap, 0
  br i1 %.not96.i, label %bb.y, label %.lr.ph151.i
...
uriRemoveBaseUriImplW.exit:                       ; preds = %.lr.ph, %.critedge115.i, %bb.ao, %bb.ak, %bb.aa, %bb.w, %bb.v, %bb.t, %uriEqualsAuthorityW.exit.thread.i, %bb.i, %bb.h, %bb.f, %bb.e, %bb.d
  ...
  %i.dw = tail call i32 @uriFreeUriMembersMmW(ptr noundef nonnull %0, ptr noundef nonnull %.013) #3 ; 0 uses
