begin_hunk_0
  ...
  %i.bc = srem i64 %i.az, 8                       ; 5 uses
  %i.bd = sub nsw i64 8, %i.bc                    ; 8 uses
...
begin_hunk_2
  ...
  %i.ce = srem i64 %i.cb, 8                       ; 5 uses
  %i.cf = sub nsw i64 8, %i.ce                    ; 8 uses
