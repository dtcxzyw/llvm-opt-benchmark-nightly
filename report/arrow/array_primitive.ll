...
bb.a:
  ...
  %i.e = load <2 x ptr>, ptr %1, align 8, !tbaa !39
  store <2 x ptr> %i.e, ptr %8, align 16, !tbaa !39
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load i8, ptr @__libc_single_threaded, align 1, !tbaa !40
...
_ZNSt10shared_ptrIN5arrow8DataTypeEEC2ERKS2_.exit: ; preds = %bb.a, %bb.c, %bb.d
  ...
  %i.n = load <2 x ptr>, ptr %4, align 8, !tbaa !39
...
_ZNSt10shared_ptrIN5arrow6BufferEEC2ERKS2_.exit16: ; preds = %_ZNSt10shared_ptrIN5arrow6BufferEEC2ERKS2_.exit, %bb.i, %bb.j
  ...
  %i.ac = invoke noalias noundef nonnull dereferenceable(32) ptr @_Znwm(i64 noundef 32) #13
          to label %.noexc.a unwind label %11     ; 5 uses

.noexc.a:                                         ; preds = %_ZNSt10shared_ptrIN5arrow6BufferEEC2ERKS2_.exit16
...
_ZSt10_ConstructISt10shared_ptrIN5arrow6BufferEEJRKS3_EEvPT_DpOT0_.exit.i.i.i.i.i.i: ; preds = %bb.m, %bb.l, %.noexc.a
...
bb.aj:                                            ; preds = %bb.ah
  ...
  %.not.i.i.i19.a = icmp eq i8 %i.dd, 0
  br i1 %.not.i.i.i19.a, label %bb.al, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  %i.de = add nsw i32 %i.cv, -1
  store i32 %i.de, ptr %i.cs, align 4, !tbaa !3
...
bb.aq:                                            ; preds = %bb.ap
  ...
  store i32 %i.dx, ptr %i.dl, align 4, !tbaa !3
...
bb.bc:                                            ; preds = %bb.bb
  ...
  store i32 %i.fe, ptr %i.ez, align 4, !tbaa !3
...
bb.bj:                                            ; preds = %bb.bi
  ...
  store i32 %i.gb, ptr %i.fp, align 4, !tbaa !3
...
bb.bn:                                            ; preds = %bb.bm, %11
  %.pn.pn = phi { ptr, i32 } [ %i.ge, %bb.bm ], [ %12, %11 ]
...
bb.e:                                             ; preds = %bb.d
  ...
  store i32 %i.o, ptr %i.c, align 4, !tbaa !3
end_hunk_1
begin_hunk_2_@_ZN5arrow12BooleanArrayC2ElRKSt10shared_ptrINS_6BufferEES5_ll:bb.a
...
_ZNK5arrow9ArrayData12MayHaveNullsEv.exit.thread.i: ; preds = %_ZNK5arrow9ArrayData12MayHaveNullsEv.exit.i, %bb.a
  ...
  %i.as = select i1 %i.ap, ptr %i.ar, ptr null, !prof !101
  %i.at = getelementptr inbounds nuw i8, ptr %i.ai, i64 32
  %i.au = load i64, ptr %i.at, align 8, !tbaa !118
  %i.av = getelementptr inbounds nuw i8, ptr %i.ai, i64 16
  %i.aw = load i64, ptr %i.av, align 8, !tbaa !102
  %i.ax = tail call noundef i64 @_ZN5arrow8internal12CountSetBitsEPKhll(ptr noundef %i.as, i64 noundef %i.au, i64 noundef %i.aw)
  br label %_ZNK5arrow12BooleanArray10true_countEv.exit

_ZNK5arrow12BooleanArray10true_countEv.exit:      ; preds = %bb.b, %_ZNK5arrow9ArrayData12MayHaveNullsEv.exit.thread.i
  %.0.i = phi i64 [ %i.ah, %bb.b ], [ %i.ax, %_ZNK5arrow9ArrayData12MayHaveNullsEv.exit.thread.i ]
  %i.ay = add i64 %i.e, %.0.i
  %i.az = sub i64 %i.d, %i.ay
  ret i64 %i.az
}
...
_ZNK5arrow9ArrayData12MayHaveNullsEv.exit:        ; preds = %bb.a
  ...
  br i1 %.not.i.i.not, label %_ZNK5arrow9ArrayData12MayHaveNullsEv.exit.thread, label %bb.b

bb.b:                                             ; preds = %_ZNK5arrow9ArrayData12MayHaveNullsEv.exit
  %i.h = load ptr, ptr %i.a, align 8, !tbaa !46   ; 3 uses
  ...
  %i.m = load i8, ptr %i.l, align 1, !tbaa !52, !range !61, !noundef !62
  %i.n = trunc nuw i8 %i.m to i1
  %i.o = getelementptr inbounds nuw i8, ptr %i.k, i64 16
  %i.p = load ptr, ptr %i.o, align 8
  %i.q = select i1 %i.n, ptr %i.p, ptr null, !prof !101
  %i.r = getelementptr inbounds nuw i8, ptr %i.h, i64 32
  %i.s = load i64, ptr %i.r, align 8, !tbaa !118  ; 2 uses
  ...
  %i.w = load i8, ptr %i.v, align 1, !tbaa !52, !range !61, !noundef !62
  %i.x = trunc nuw i8 %i.w to i1
  %i.y = getelementptr inbounds nuw i8, ptr %i.u, i64 16
  %i.z = load ptr, ptr %i.y, align 8
  %i.aa = select i1 %i.x, ptr %i.z, ptr null, !prof !101
  %i.ab = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  %i.ac = load i64, ptr %i.ab, align 8, !tbaa !102
  %i.ad = tail call noundef i64 @_ZN5arrow8internal15CountAndSetBitsEPKhlS2_ll(ptr noundef %i.q, i64 noundef %i.s, ptr noundef %i.aa, i64 noundef %i.s, i64 noundef %i.ac)
  br label %bb.c

_ZNK5arrow9ArrayData12MayHaveNullsEv.exit.thread: ; preds = %bb.a, %_ZNK5arrow9ArrayData12MayHaveNullsEv.exit
  %i.ae = load ptr, ptr %i.a, align 8, !tbaa !46  ; 3 uses
  ...
  %i.ak = load i8, ptr %i.aj, align 1, !tbaa !52, !range !61, !noundef !62
  %i.al = trunc nuw i8 %i.ak to i1
  %i.am = getelementptr inbounds nuw i8, ptr %i.ai, i64 16
  %i.an = load ptr, ptr %i.am, align 8
  %i.ao = select i1 %i.al, ptr %i.an, ptr null, !prof !101
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ae, i64 32
  %i.aq = load i64, ptr %i.ap, align 8, !tbaa !118
  %i.ar = getelementptr inbounds nuw i8, ptr %i.ae, i64 16
  %i.as = load i64, ptr %i.ar, align 8, !tbaa !102
  %i.at = tail call noundef i64 @_ZN5arrow8internal12CountSetBitsEPKhll(ptr noundef %i.ao, i64 noundef %i.aq, i64 noundef %i.as)
  br label %bb.c

bb.c:                                             ; preds = %_ZNK5arrow9ArrayData12MayHaveNullsEv.exit.thread, %bb.b
  %.0 = phi i64 [ %i.ad, %bb.b ], [ %i.at, %_ZNK5arrow9ArrayData12MayHaveNullsEv.exit.thread ]
  ret i64 %.0
}
...
bb.a:
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVN5arrow20DayTimeIntervalArrayE, i64 16), ptr %0, align 8, !tbaa !33
...
bb.an:                                            ; preds = %.lr.ph.i.i.i
  ...
  %i.dn = icmp eq i64 %i.dm, 4294967297
end_hunk_3
begin_hunk_4_@_ZN5arrow25MonthDayNanoIntervalArrayC2ERKSt10shared_ptrINS_8DataTypeEElRKS1_INS_6BufferEES9_ll:bb.a
