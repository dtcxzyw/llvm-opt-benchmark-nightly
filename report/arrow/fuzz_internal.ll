...
bb.s:                                             ; preds = %bb.r
  ...
  br i1 %.not145.a, label %bb.v, label %3

3:                                                ; preds = %bb.s
  %4 = icmp samesign ugt i32 %i.bj, 429496729
  br i1 %4, label %bb.w, label %bb.t, !prof !32
...
bb.v:                                             ; preds = %bb.u, %bb.s, %bb.q, %bb.o, %bb.m, %bb.k, %bb.i, %bb.g, %bb.e, %bb.c, %bb.a
  %.10.a = phi i32 [ %., %bb.u ], [ %i.bj, %bb.s ], [ %i.bb, %bb.q ], [ %i.au, %bb.o ], [ %i.an, %bb.m ], [ %i.ag, %bb.k ], [ %i.z, %bb.i ], [ %i.s, %bb.g ], [ %i.l, %bb.e ], [ %i.e, %bb.c ], [ 0, %bb.a ]
  store i32 %.10.a, ptr %2, align 4, !tbaa !3
  br label %bb.w

bb.w:                                             ; preds = %bb.t, %3, %bb.u, %bb.r, %bb.p, %bb.n, %bb.l, %bb.j, %bb.h, %bb.f, %bb.d, %bb.b, %bb.v
