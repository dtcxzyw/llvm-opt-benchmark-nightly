...
bb.t:                                             ; preds = %bb.s
  ...
  br i1 %i.bk, label %.critedge, label %bb.u, !prof !32
...
bb.u:                                             ; preds = %bb.t
  ...
  %.not147 = icmp ult i8 %4, 10
  %or.cond.not = and i1 %.not146, %.not147        ; 2 uses
  ...
  br i1 %cond9, label %bb.v, label %.critedge
...
.critedge:                                        ; preds = %bb.t, %bb.u, %bb.r, %bb.p, %bb.n, %bb.l, %bb.j, %bb.h, %bb.f, %bb.d, %bb.b, %bb.v
