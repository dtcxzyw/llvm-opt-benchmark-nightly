...
vector.memcheck:                                  ; preds = %bb.o
  %i.dg = shl i64 %.04181, 2
  %i.dh = add i64 %i.dg, %i.bb
  %i.di = sub i64 %i.cp, %i.dh
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.dj = shl i64 %n.vec, 2                       ; 2 uses
  %i.dk = getelementptr i8, ptr %i.cf, i64 %i.dj
  %i.dl = getelementptr i8, ptr %i.co, i64 %i.dj
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.dm = shl i64 %index, 2                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.cf, i64 %i.dm ; 2 uses
  %next.gep105 = getelementptr i8, ptr %i.co, i64 %i.dm ; 2 uses
  %i.dn = getelementptr i8, ptr %next.gep105, i64 16
  %wide.load = load <4 x i32>, ptr %next.gep105, align 4, !tbaa !3, !noalias !927
  %wide.load106 = load <4 x i32>, ptr %i.dn, align 4, !tbaa !3, !noalias !927
  %i.do = add <4 x i32> %broadcast.splat, %wide.load
  %i.dp = add <4 x i32> %broadcast.splat, %wide.load106
  %i.dq = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %i.do, ptr %next.gep, align 4, !tbaa !3, !noalias !927
  store <4 x i32> %i.dp, ptr %i.dq, align 4, !tbaa !3, !noalias !927
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.dr = icmp eq i64 %index.next, %n.vec
  br i1 %i.dr, label %middle.block, label %vector.body, !llvm.loop !930
...
.lr.ph.i.i.preheader:                             ; preds = %vector.memcheck, %bb.o, %middle.block
  %.010.i.i.ph = phi ptr [ %i.cf, %vector.memcheck ], [ %i.cf, %bb.o ], [ %i.dk, %middle.block ]
  %.079.i.i.ph = phi ptr [ %i.co, %vector.memcheck ], [ %i.co, %bb.o ], [ %i.dl, %middle.block ]
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  %.010.i.i = phi ptr [ %i.dv, %.lr.ph.i.i ], [ %.010.i.i.ph, %.lr.ph.i.i.preheader ] ; 2 uses
  %.079.i.i = phi ptr [ %i.du, %.lr.ph.i.i ], [ %.079.i.i.ph, %.lr.ph.i.i.preheader ] ; 2 uses
  %i.ds = load i32, ptr %.079.i.i, align 4, !tbaa !3, !noalias !927
  %i.dt = add i32 %8, %i.ds
  store i32 %i.dt, ptr %.010.i.i, align 4, !tbaa !3, !noalias !927
  %i.du = getelementptr inbounds nuw i8, ptr %.079.i.i, i64 4 ; 2 uses
  %i.dv = getelementptr inbounds nuw i8, ptr %.010.i.i, i64 4
  %.not.i.i = icmp eq ptr %i.du, %i.cr
...
._crit_edge:                                      ; preds = %.loopexit, %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit
  ...
  %i.dw = lshr i64 %.0.lcssa.i, 2
  %i.dx = getelementptr inbounds nuw [4 x i8], ptr %i.az, i64 %i.dw
  store i32 %.037.lcssa, ptr %i.dx, align 4, !tbaa !3
  store ptr null, ptr %0, align 8, !tbaa !51
  %i.dy = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 0, ptr %i.dy, align 8, !tbaa !45
  br label %.thread76
...
.thread76:                                        ; preds = %.thread76.loopexit, %._crit_edge, %bb.b
  %i.dz = load ptr, ptr %6, align 8, !tbaa !51    ; 2 uses
  %i.ea = icmp eq ptr %i.dz, null
  br i1 %i.ea, label %bb.p, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i, !prof !54

bb.p:                                             ; preds = %.thread76
  %i.eb = getelementptr inbounds nuw i8, ptr %6, i64 8
  %i.ec = load ptr, ptr %i.eb, align 8, !tbaa !314 ; 3 uses
  %.not.i.i.i.i70 = icmp eq ptr %i.ec, null
...
_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i: ; preds = %bb.p
  ...
  call void %i.ef(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.ec) #20, !inline_history !934
...
_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i: ; preds = %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i, %.thread76
  %i.eg = phi ptr [ %.pr.pre.i, %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i ], [ %i.dz, %.thread76 ]
  %i.eh = getelementptr inbounds nuw i8, ptr %i.eg, i64 1
  %i.ei = load i8, ptr %i.eh, align 1, !tbaa !55, !range !65, !noundef !66
  %i.ej = trunc nuw i8 %i.ei to i1
  br i1 %i.ej, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit, label %bb.q
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.af = load i8, ptr @__libc_single_threaded, align 1, !tbaa !45
end_hunk_0
...
vector.memcheck:                                  ; preds = %bb.o
  %i.dd = shl i64 %.04181, 3
  %i.de = add i64 %i.dd, %i.bb
  %i.df = sub i64 %i.co, %i.de
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %i.ce, i64 %i.dj ; 2 uses
  %next.gep105 = getelementptr i8, ptr %i.cn, i64 %i.dj ; 2 uses
  %i.dk = getelementptr i8, ptr %next.gep105, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep105, align 8, !tbaa !175, !noalias !968
  %wide.load106 = load <2 x i64>, ptr %i.dk, align 8, !tbaa !175, !noalias !968
  %i.dl = add <2 x i64> %broadcast.splat, %wide.load
  %i.dm = add <2 x i64> %broadcast.splat, %wide.load106
  %i.dn = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %i.dl, ptr %next.gep, align 8, !tbaa !175, !noalias !968
  store <2 x i64> %i.dm, ptr %i.dn, align 8, !tbaa !175, !noalias !968
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.do = icmp eq i64 %index.next, %n.vec
  br i1 %i.do, label %middle.block, label %vector.body, !llvm.loop !971
...
.lr.ph.i.i.preheader:                             ; preds = %vector.memcheck, %bb.o, %middle.block
  %.010.i.i.ph = phi ptr [ %i.ce, %vector.memcheck ], [ %i.ce, %bb.o ], [ %i.dh, %middle.block ]
  %.079.i.i.ph = phi ptr [ %i.cn, %vector.memcheck ], [ %i.cn, %bb.o ], [ %i.di, %middle.block ]
  br label %.lr.ph.i.i
...
._crit_edge:                                      ; preds = %.loopexit, %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit
  ...
  %i.dt = lshr i64 %.0.lcssa.i, 3
  %i.du = getelementptr inbounds nuw [8 x i8], ptr %i.az, i64 %i.dt
  store i64 %.037.lcssa, ptr %i.du, align 8, !tbaa !175
  store ptr null, ptr %0, align 8, !tbaa !51
  %i.dv = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i32 0, ptr %i.dv, align 8, !tbaa !45
  br label %.thread76
...
.thread76:                                        ; preds = %.thread76.loopexit, %._crit_edge, %bb.b
  %i.dw = load ptr, ptr %6, align 8, !tbaa !51    ; 2 uses
  %i.dx = icmp eq ptr %i.dw, null
  br i1 %i.dx, label %bb.p, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i, !prof !54

bb.p:                                             ; preds = %.thread76
  %i.dy = getelementptr inbounds nuw i8, ptr %6, i64 8
  %i.dz = load ptr, ptr %i.dy, align 8, !tbaa !314 ; 3 uses
  %.not.i.i.i.i70 = icmp eq ptr %i.dz, null
  br i1 %.not.i.i.i.i70, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i
...
_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i: ; preds = %bb.p
  ...
  call void %i.ec(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.dz) #20, !inline_history !934
  %.pr.pre.i = load ptr, ptr %6, align 8, !tbaa !51 ; 2 uses
  %.not.i.i71 = icmp eq ptr %.pr.pre.i, null
  br i1 %.not.i.i71, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i, !prof !294

_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i: ; preds = %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i, %.thread76
  %i.ed = phi ptr [ %.pr.pre.i, %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i ], [ %i.dw, %.thread76 ]
  %i.ee = getelementptr inbounds nuw i8, ptr %i.ed, i64 1
  %i.ef = load i8, ptr %i.ee, align 1, !tbaa !55, !range !65, !noundef !66
  %i.eg = trunc nuw i8 %i.ef to i1
  br i1 %i.eg, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit, label %bb.q
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #20
  %i.a = load ptr, ptr %1, align 8, !tbaa !111, !nonnull !66, !align !132 ; 2 uses
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 8
...
bb.b:                                             ; preds = %_ZN5arrow6ResultISt10shared_ptrINS_9ArrayDataEEED2Ev.exit
  ...
  %i.p = load ptr, ptr %1, align 8, !tbaa !111, !nonnull !66, !align !132 ; 2 uses
  %i.q = getelementptr inbounds nuw i8, ptr %i.p, i64 8
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !71
  %i.s = load ptr, ptr %i.p, align 8, !tbaa !67   ; 2 uses
...
bb.c:                                             ; preds = %.lr.ph, %bb.b
  %i.x = phi ptr [ %i.d, %.lr.ph ], [ %i.s, %bb.b ]
  %.01936 = phi i64 [ 0, %.lr.ph ], [ %i.o, %bb.b ] ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #20
  %i.y = getelementptr inbounds nuw [16 x i8], ptr %i.x, i64 %.01936
  ...
  %i.ad = getelementptr inbounds nuw [16 x i8], ptr %.val26, i64 %.01936 ; 2 uses
  %i.ae = load i64, ptr %i.ad, align 8, !tbaa !157
  %i.af = getelementptr inbounds nuw i8, ptr %i.ad, i64 8
  %i.ag = load i64, ptr %i.af, align 8, !tbaa !159
  invoke void @_ZNK5arrow9ArrayData9SliceSafeEll(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Result.156") align 8 %4, ptr noundef nonnull align 8 dereferenceable(120) %i.ac, i64 noundef %i.ae, i64 noundef %i.ag)
          to label %bb.d unwind label %bb.f

bb.d:                                             ; preds = %bb.c
  %i.ah = load ptr, ptr %4, align 8, !tbaa !51
  %i.ai = icmp eq ptr %i.ah, null                 ; 2 uses
  br i1 %i.ai, label %bb.g, label %bb.e, !prof !54
...
bb.g:                                             ; preds = %bb.d
  %i.ak = load <2 x ptr>, ptr %i.m, align 8, !tbaa !91, !noalias !974
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.m, i8 0, i64 16, i1 false)
  %i.al = load ptr, ptr %3, align 16, !tbaa !67
  %i.am = getelementptr inbounds nuw [16 x i8], ptr %i.al, i64 %.01936 ; 2 uses
  %i.an = getelementptr inbounds nuw i8, ptr %i.am, i64 8
  %i.ao = load ptr, ptr %i.an, align 8, !tbaa !36 ; 8 uses
  store <2 x ptr> %i.ak, ptr %i.am, align 8, !tbaa !91
  %.not.i.i.i.i28 = icmp eq ptr %i.ao, null
  br i1 %.not.i.i.i.i28, label %_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, label %bb.h
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.au = load ptr, ptr %i.ao, align 8, !tbaa !42
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 16
  %i.aw = load ptr, ptr %i.av, align 8
  call void %i.aw(ptr noundef nonnull align 8 dereferenceable(16) %i.ao) #20, !inline_history !137
  %i.ax = load ptr, ptr %i.ao, align 8, !tbaa !42
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 24
  %i.az = load ptr, ptr %i.ay, align 8
  call void %i.az(ptr noundef nonnull align 8 dereferenceable(16) %i.ao) #20, !inline_history !137
  br label %_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i: ; preds = %bb.l, %bb.k
  ...
  br i1 %i.bd, label %bb.m, label %_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !46

bb.m:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i
  call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.ao) #20
  br label %_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit

_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit: ; preds = %bb.g, %bb.i, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i, %bb.m, %bb.e
  %i.be = load ptr, ptr %4, align 8, !tbaa !51    ; 2 uses
