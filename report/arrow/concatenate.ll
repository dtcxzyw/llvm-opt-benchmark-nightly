...
bb.b:                                             ; preds = %bb.a
  ...
  %i.n = xor i64 %i.e, 576460752303423487         ; 2 uses
...
.preheader.i.prol:                                ; preds = %.preheader.i.preheader, %.preheader.i.prol
  %.07.i.i.i.i.prol = phi ptr [ %i.r, %.preheader.i.prol ], [ %.val8, %.preheader.i.preheader ] ; 3 uses
  %.056.i.i.i.i.prol = phi i64 [ %i.q, %.preheader.i.prol ], [ %i.g, %.preheader.i.preheader ]
  ...
  %i.p = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i.prol, i64 8
  store i64 0, ptr %i.p, align 8, !tbaa !148
  %i.q = add i64 %.056.i.i.i.i.prol, -1           ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i.prol, i64 16 ; 3 uses
...
.preheader.i:                                     ; preds = %.preheader.i.prol.loopexit, %.preheader.i
  %.07.i.i.i.i = phi ptr [ %i.ai, %.preheader.i ], [ %.07.i.i.i.i.unr, %.preheader.i.prol.loopexit ] ; 17 uses
  %.056.i.i.i.i = phi i64 [ %i.ah, %.preheader.i ], [ %.056.i.i.i.i.unr, %.preheader.i.prol.loopexit ]
  store i64 -1, ptr %.07.i.i.i.i, align 8, !tbaa !147
  %i.s = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 8
  store i64 0, ptr %i.s, align 8, !tbaa !148
  %i.t = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 16
  store i64 -1, ptr %i.t, align 8, !tbaa !147
  %i.u = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 24
  store i64 0, ptr %i.u, align 8, !tbaa !148
  %i.v = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 32
  store i64 -1, ptr %i.v, align 8, !tbaa !147
  %i.w = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 40
  store i64 0, ptr %i.w, align 8, !tbaa !148
  %i.x = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 48
  store i64 -1, ptr %i.x, align 8, !tbaa !147
  %i.y = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 56
  store i64 0, ptr %i.y, align 8, !tbaa !148
  %i.z = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 64
  store i64 -1, ptr %i.z, align 8, !tbaa !147
  %i.aa = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 72
  store i64 0, ptr %i.aa, align 8, !tbaa !148
  %i.ab = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 80
  store i64 -1, ptr %i.ab, align 8, !tbaa !147
  %i.ac = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 88
  store i64 0, ptr %i.ac, align 8, !tbaa !148
  %i.ad = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 96
  store i64 -1, ptr %i.ad, align 8, !tbaa !147
  %i.ae = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 104
  store i64 0, ptr %i.ae, align 8, !tbaa !148
  %i.af = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 112
  store i64 -1, ptr %i.af, align 8, !tbaa !147
  %i.ag = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 120
  store i64 0, ptr %i.ag, align 8, !tbaa !148
  %i.ah = add i64 %.056.i.i.i.i, -8               ; 2 uses
  %i.ai = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i, i64 128 ; 2 uses
  %.not.i.i.i.i.7 = icmp eq i64 %i.ah, 0
...
_ZSt27__uninitialized_default_n_aIPN5arrow12_GLOBAL__N_15RangeEmS2_ET_S4_T0_RSaIT1_E.exit.i: ; preds = %.preheader.i, %.preheader.i.prol.loopexit
  %.lcssa = phi ptr [ %.lcssa.unr, %.preheader.i.prol.loopexit ], [ %i.ai, %.preheader.i ]
...
bb.c:                                             ; preds = %bb.b
  %i.aj = icmp ult i64 %i.n, %i.g
  br i1 %i.aj, label %bb.d, label %_ZNKSt6vectorIN5arrow12_GLOBAL__N_15RangeESaIS2_EE12_M_check_lenEmPKc.exit.i
...
_ZNKSt6vectorIN5arrow12_GLOBAL__N_15RangeESaIS2_EE12_M_check_lenEmPKc.exit.i: ; preds = %bb.c
  ...
  %i.ak = add nuw nsw i64 %.sroa.speculated.i.i, %i.e
  %i.al = tail call i64 @llvm.umin.i64(i64 %i.ak, i64 576460752303423487) ; 2 uses
  %i.am = shl nuw nsw i64 %i.al, 4
  %i.an = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.am) #22 ; 4 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %i.an, i64 %i.d ; 3 uses
  %xtraiter15 = and i64 %i.g, 7                   ; 2 uses
...
.prol.preheader:                                  ; preds = %_ZNKSt6vectorIN5arrow12_GLOBAL__N_15RangeESaIS2_EE12_M_check_lenEmPKc.exit.i, %.prol.preheader
  %.07.i.i.i32.i.prol = phi ptr [ %i.ar, %.prol.preheader ], [ %i.ao, %_ZNKSt6vectorIN5arrow12_GLOBAL__N_15RangeESaIS2_EE12_M_check_lenEmPKc.exit.i ] ; 3 uses
  %.056.i.i.i33.i.prol = phi i64 [ %i.aq, %.prol.preheader ], [ %i.g, %_ZNKSt6vectorIN5arrow12_GLOBAL__N_15RangeESaIS2_EE12_M_check_lenEmPKc.exit.i ]
  ...
  %i.ap = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i.prol, i64 8
  store i64 0, ptr %i.ap, align 8, !tbaa !148
  %i.aq = add i64 %.056.i.i.i33.i.prol, -1        ; 2 uses
  %i.ar = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i.prol, i64 16 ; 2 uses
...
_ZNKSt6vectorIN5arrow12_GLOBAL__N_15RangeESaIS2_EE12_M_check_lenEmPKc.exit.i.new: ; preds = %.prol.loopexit, %_ZNKSt6vectorIN5arrow12_GLOBAL__N_15RangeESaIS2_EE12_M_check_lenEmPKc.exit.i.new
  ...
  %.056.i.i.i33.i = phi i64 [ %i.bh, %_ZNKSt6vectorIN5arrow12_GLOBAL__N_15RangeESaIS2_EE12_M_check_lenEmPKc.exit.i.new ], [ %.056.i.i.i33.i.unr, %.prol.loopexit ]
  store i64 -1, ptr %.07.i.i.i32.i, align 8, !tbaa !147
  %i.as = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 8
  store i64 0, ptr %i.as, align 8, !tbaa !148
  %i.at = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 16
  store i64 -1, ptr %i.at, align 8, !tbaa !147
  %i.au = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 24
  store i64 0, ptr %i.au, align 8, !tbaa !148
  %i.av = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 32
  store i64 -1, ptr %i.av, align 8, !tbaa !147
  %i.aw = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 40
  store i64 0, ptr %i.aw, align 8, !tbaa !148
  %i.ax = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 48
  store i64 -1, ptr %i.ax, align 8, !tbaa !147
  %i.ay = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 56
  store i64 0, ptr %i.ay, align 8, !tbaa !148
  %i.az = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 64
  store i64 -1, ptr %i.az, align 8, !tbaa !147
  %i.ba = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 72
  store i64 0, ptr %i.ba, align 8, !tbaa !148
  %i.bb = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 80
  store i64 -1, ptr %i.bb, align 8, !tbaa !147
  %i.bc = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 88
  store i64 0, ptr %i.bc, align 8, !tbaa !148
  %i.bd = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 96
  store i64 -1, ptr %i.bd, align 8, !tbaa !147
  %i.be = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 104
  store i64 0, ptr %i.be, align 8, !tbaa !148
  %i.bf = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 112
  store i64 -1, ptr %i.bf, align 8, !tbaa !147
  %i.bg = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 120
  store i64 0, ptr %i.bg, align 8, !tbaa !148
  %i.bh = add i64 %.056.i.i.i33.i, -8             ; 2 uses
  %i.bi = getelementptr inbounds nuw i8, ptr %.07.i.i.i32.i, i64 128
  %.not.i.i.i34.i.7 = icmp eq i64 %i.bh, 0
...
.lr.ph.i.i.i.i:                                   ; preds = %_ZSt27__uninitialized_default_n_aIPN5arrow12_GLOBAL__N_15RangeEmS2_ET_S4_T0_RSaIT1_E.exit35.i, %.lr.ph.i.i.i.i
  %.03.i.i.i.i = phi ptr [ %i.bk, %.lr.ph.i.i.i.i ], [ %i.an, %_ZSt27__uninitialized_default_n_aIPN5arrow12_GLOBAL__N_15RangeEmS2_ET_S4_T0_RSaIT1_E.exit35.i ] ; 2 uses
  %.092.i.i.i.i = phi ptr [ %i.bj, %.lr.ph.i.i.i.i ], [ %.val7, %_ZSt27__uninitialized_default_n_aIPN5arrow12_GLOBAL__N_15RangeEmS2_ET_S4_T0_RSaIT1_E.exit35.i ] ; 2 uses
  ...
  %i.bj = getelementptr inbounds nuw i8, ptr %.092.i.i.i.i, i64 16 ; 2 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %.03.i.i.i.i, i64 16
  %.not.i.i.i37.i = icmp eq ptr %i.bj, %.val8
...
bb.e:                                             ; preds = %_ZNSt6vectorIN5arrow12_GLOBAL__N_15RangeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit.i
  %i.bl = load ptr, ptr %i.h, align 8, !tbaa !169
  %i.bm = ptrtoint ptr %i.bl to i64
  %i.bn = sub i64 %i.bm, %i.c
  tail call void @_ZdlPvm(ptr noundef nonnull %.val7, i64 noundef %i.bn) #23
...
_ZNSt12_Vector_baseIN5arrow12_GLOBAL__N_15RangeESaIS2_EE13_M_deallocateEPS2_m.exit39.i: ; preds = %bb.e, %_ZNSt6vectorIN5arrow12_GLOBAL__N_15RangeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit.i
  store ptr %i.an, ptr %0, align 8, !tbaa !167
  %i.bo = getelementptr inbounds nuw [16 x i8], ptr %i.ao, i64 %i.g
  store ptr %i.bo, ptr %i.a, align 8, !tbaa !168
  %i.bp = getelementptr inbounds nuw [16 x i8], ptr %i.an, i64 %i.al
  store ptr %i.bp, ptr %i.h, align 8, !tbaa !169
  br label %_ZNSt6vectorIN5arrow12_GLOBAL__N_15RangeESaIS2_EE17_M_default_appendEm.exit

bb.f:                                             ; preds = %bb.a
  %i.bq = icmp ult i64 %1, %i.e
  br i1 %i.bq, label %bb.g, label %_ZNSt6vectorIN5arrow12_GLOBAL__N_15RangeESaIS2_EE17_M_default_appendEm.exit

bb.g:                                             ; preds = %bb.f
  %i.br = getelementptr inbounds nuw [16 x i8], ptr %.val7, i64 %1 ; 2 uses
  %.not.i9 = icmp eq ptr %.val8, %i.br
