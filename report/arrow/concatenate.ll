...
bb.n:                                             ; preds = %bb.l
  ...
  %i.co = load ptr, ptr %i.cn, align 8, !noalias !927 ; 7 uses
  %i.cp = ptrtoaddr ptr %i.co to i64              ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  %8 = ptrtoaddr ptr %i.cq to i64
  %i.db = sub i32 %.03782, %i.cs                  ; 2 uses
  %i.dc = add i64 %i.ci, -4
  %i.dd = add i64 %i.dc, %8
  %i.de = sub i64 %i.dd, %i.cp                    ; 2 uses
...
bb.n:                                             ; preds = %bb.l
  ...
  %i.cn = load ptr, ptr %i.cm, align 8, !noalias !968 ; 8 uses
