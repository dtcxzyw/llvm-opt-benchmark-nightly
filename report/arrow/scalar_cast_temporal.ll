...
bb.a:
  ...
  br i1 %.not, label %bb.i, label %bb.b, !prof !85
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.b = load ptr, ptr %8, align 8, !tbaa !51     ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %i.f = load ptr, ptr %4, align 8, !tbaa !84     ; 2 uses
  %.not.i.i = icmp eq ptr %i.f, null
  br i1 %.not.i.i, label %_ZN5arrow6StatusD2Ev.exit, label %bb.e, !prof !85

bb.e:                                             ; preds = %bb.d
  %i.g = getelementptr inbounds nuw i8, ptr %i.f, i64 1
  %i.h = load i8, ptr %i.g, align 1, !tbaa !94, !range !95, !noundef !96
...
_ZN5arrow6StatusD2Ev.exit:                        ; preds = %bb.f, %bb.e, %bb.d
  %i.j = load ptr, ptr %6, align 8, !tbaa !84
  store ptr %i.j, ptr %4, align 8, !tbaa !84
  store ptr null, ptr %6, align 8, !tbaa !84
  %i.k = load ptr, ptr %7, align 8, !tbaa !100    ; 2 uses
...
bb.h:                                             ; preds = %bb.c
  %i.q = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.r = load ptr, ptr %7, align 8, !tbaa !100    ; 2 uses
...
bb.i:                                             ; preds = %bb.a
  ...
  br i1 %.not.i18, label %bb.j, label %bb.s, !prof !85

bb.j:                                             ; preds = %bb.i
  %i.y = getelementptr inbounds nuw i8, ptr %3, i64 7
  %i.z = load i8, ptr %i.y, align 1, !tbaa !52
  %.not7.i = icmp eq i8 %i.z, 45
  br i1 %.not7.i, label %bb.k, label %bb.s, !prof !85

bb.k:                                             ; preds = %bb.j
  %i.aa = load i8, ptr %3, align 1, !tbaa !52
  %i.ab = add i8 %i.aa, -48                       ; 2 uses
  %i.ac = icmp ult i8 %i.ab, 10
  br i1 %i.ac, label %bb.l, label %bb.s, !prof !180
...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %i.ag, label %bb.m, label %bb.s, !prof !180
...
bb.m:                                             ; preds = %bb.l
  ...
  br i1 %i.ak, label %bb.n, label %bb.s, !prof !180

bb.n:                                             ; preds = %bb.m
  %narrow.i = mul nuw nsw i8 %i.ab, 10
  %narrow43.i = add nuw nsw i8 %i.af, %narrow.i
  %i.al = zext nneg i8 %narrow43.i to i16
  ...
  br i1 %i.at, label %_ZN5arrow8internal13ParseUnsignedEPKcmPt.exit.i, label %bb.s, !prof !180
...
_ZN5arrow8internal13ParseUnsignedEPKcmPt.exit.i:  ; preds = %bb.n
  ...
  br i1 %i.az, label %bb.o, label %bb.s, !prof !180
...
bb.o:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPt.exit.i
  ...
  br i1 %i.bd, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i, label %bb.s, !prof !180
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i:  ; preds = %bb.o
  ...
  br i1 %i.bi, label %bb.p, label %bb.s, !prof !180
...
bb.p:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i
  ...
  %or.cond35.not39.i = select i1 %i.bm, i1 true, i1 %spec.select.i.i.i, !prof !181
  %.not8.i.i = icmp eq i8 %i.bn, 0
  %or.cond36.i = select i1 %or.cond35.not39.i, i1 true, i1 %.not8.i.i, !prof !182
  br i1 %or.cond36.i, label %bb.s, label %bb.q, !prof !182
...
_ZNK14arrow_vendored4date14year_month_day2okEv.exit.i: ; preds = %.thread.i.i.i, %bb.r
  ...
  br i1 %.not42.i, label %bb.s, label %bb.z, !prof !183
...
bb.s:                                             ; preds = %bb.o, %bb.i, %bb.m, %bb.j, %bb.p, %_ZNK14arrow_vendored4date14year_month_day2okEv.exit.i, %bb.k, %bb.l, %bb.n, %_ZN5arrow8internal13ParseUnsignedEPKcmPt.exit.i, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i
  ...
  %i.bx = load ptr, ptr %11, align 8, !tbaa !51   ; 2 uses
...
bb.u:                                             ; preds = %bb.t
  %i.cb = load ptr, ptr %4, align 8, !tbaa !84    ; 2 uses
  %.not.i.i19 = icmp eq ptr %i.cb, null
  br i1 %.not.i.i19, label %_ZN5arrow6StatusD2Ev.exit22, label %bb.v, !prof !85

bb.v:                                             ; preds = %bb.u
  %i.cc = getelementptr inbounds nuw i8, ptr %i.cb, i64 1
  %i.cd = load i8, ptr %i.cc, align 1, !tbaa !94, !range !95, !noundef !96
...
_ZN5arrow6StatusD2Ev.exit22:                      ; preds = %bb.w, %bb.v, %bb.u
  %i.cf = load ptr, ptr %9, align 8, !tbaa !84
  store ptr %i.cf, ptr %4, align 8, !tbaa !84
  store ptr null, ptr %9, align 8, !tbaa !84
  %i.cg = load ptr, ptr %10, align 8, !tbaa !100  ; 2 uses
...
bb.y:                                             ; preds = %bb.t
  %i.cm = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.cn = load ptr, ptr %10, align 8, !tbaa !100  ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i26: ; preds = %bb.y
  %i.cq = load i64, ptr %i.co, align 8, !tbaa !52
  %i.cr = add i64 %i.cq, 1
...
bb.b:                                             ; preds = %bb.a
  %i.a = load ptr, ptr %5, align 8, !tbaa !100, !noalias !545 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %bb.b
  %i.d = load i64, ptr %i.b, align 8, !tbaa !52, !noalias !545
  %i.e = add i64 %i.d, 1
...
bb.c:                                             ; preds = %bb.a
  %i.f = landingpad { ptr, i32 }
          cleanup
  %i.g = load ptr, ptr %5, align 8, !tbaa !100, !noalias !545 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i6.i: ; preds = %bb.c
  %i.j = load i64, ptr %i.h, align 8, !tbaa !52, !noalias !545
  %i.k = add i64 %i.j, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit8.i: ; preds = %bb.c, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i6.i
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #20, !noalias !545
  resume { ptr, i32 } %i.f
...
bb.n:                                             ; preds = %bb.m
  %narrow.i = mul nuw nsw i8 %i.ab, 10
  %narrow42.i = add nuw nsw i8 %i.af, %narrow.i
  %i.al = zext nneg i8 %narrow42.i to i16
  %i.am = mul nuw nsw i16 %i.al, 10
  %i.an = zext nneg i8 %i.aj to i16
  %i.ao = add nuw nsw i16 %i.am, %i.an
  %i.ap = getelementptr inbounds nuw i8, ptr %3, i64 3
...
bb.p:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i
  ...
  %i.bo = add i8 %i.be, -13
  %spec.select.i.i.i = icmp ult i8 %i.bo, -12
  %or.cond34.not38.i = select i1 %i.bm, i1 true, i1 %spec.select.i.i.i, !prof !181
  %.not8.i.i = icmp eq i8 %i.bn, 0
  %or.cond35.i = select i1 %or.cond34.not38.i, i1 true, i1 %.not8.i.i, !prof !182
  br i1 %or.cond35.i, label %bb.s, label %bb.q, !prof !182
...
_ZNK14arrow_vendored4date14year_month_day2okEv.exit.i: ; preds = %.thread.i.i.i, %bb.r
  ...
  br i1 %.not41.i, label %bb.s, label %bb.z, !prof !183
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #20, !noalias !668
  %i.a = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !110, !noalias !669
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #20, !noalias !668
  ret void
}
...
bb.a:
  ...
  store ptr null, ptr %0, align 8, !tbaa !84, !alias.scope !675
  %i.b = getelementptr inbounds nuw i8, ptr %4, i64 128
  %i.c = load i8, ptr %i.b, align 8, !tbaa !103
...
_ZSt26__throw_bad_variant_accessb.exit.i.i.i.invoke: ; preds = %bb.a, %_ZSt26__throw_bad_variant_accessb.exit.i.i.i
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVSt18bad_variant_access, i64 16), ptr %i.d, align 8, !tbaa !43
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  store ptr %.str.11.sink, ptr %i.e, align 8, !tbaa !107
...
.noexc11:                                         ; preds = %bb.e, %.lr.ph.i.i.i.i
  ...
  store i64 %.sink.i.i.i.i, ptr %.2, align 8, !tbaa !126
  %i.bm = add i64 %.334.i.i.i.i, 1                ; 2 uses
  %exitcond.not.i.i.i.i = icmp eq i64 %i.bm, %i.aq
  br i1 %exitcond.not.i.i.i.i, label %.loopexit.i.i.i.i, label %.lr.ph.i.i.i.i, !llvm.loop !1417
...
.loopexit.split-lp:                               ; preds = %.loopexit, %.loopexit.split-lp.loopexit.split-lp.loopexit, %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp, %.loopexit.split-lp.loopexit, %bb.g
  ...
  %i.bp = load ptr, ptr %0, align 8, !tbaa !84    ; 2 uses
  %.not.i = icmp eq ptr %i.bp, null
  br i1 %.not.i, label %_ZN5arrow6StatusD2Ev.exit, label %bb.h, !prof !85

bb.h:                                             ; preds = %.loopexit.split-lp
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 1
  %i.br = load i8, ptr %i.bq, align 1, !tbaa !94, !range !95, !noundef !96
...
bb.a:
  ...
  %i.d = load ptr, ptr %0, align 8, !tbaa !1429, !nonnull !96, !align !147
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 72
  %i.f = load i32, ptr %i.e, align 8, !tbaa !170  ; 4 uses
  %i.g = icmp ult i64 %2, 10
  br i1 %i.g, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, label %bb.b, !prof !62

bb.b:                                             ; preds = %bb.a
  %i.h = getelementptr inbounds nuw i8, ptr %3, i64 4
  %i.i = load i8, ptr %i.h, align 1, !tbaa !52
  %.not.i.i = icmp eq i8 %i.i, 45
  br i1 %.not.i.i, label %bb.c, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, !prof !85

bb.c:                                             ; preds = %bb.b
  %i.j = getelementptr inbounds nuw i8, ptr %3, i64 7
  %i.k = load i8, ptr %i.j, align 1, !tbaa !52
  %.not7.i.i = icmp eq i8 %i.k, 45
  br i1 %.not7.i.i, label %bb.d, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, !prof !85

bb.d:                                             ; preds = %bb.c
  %i.l = load i8, ptr %3, align 1, !tbaa !52
  %i.m = add i8 %i.l, -48                         ; 2 uses
  %i.n = icmp ult i8 %i.m, 10
  br i1 %i.n, label %bb.e, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, !prof !180
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.r, label %bb.f, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, !prof !180
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.v, label %bb.g, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, !prof !180
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %i.ae, label %_ZN5arrow8internal13ParseUnsignedEPKcmPt.exit.i.i, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, !prof !180
...
_ZN5arrow8internal13ParseUnsignedEPKcmPt.exit.i.i: ; preds = %bb.g
  ...
  %i.aj = add i8 %i.ai, -48                       ; 2 uses
  %i.ak = icmp ult i8 %i.aj, 10
  br i1 %i.ak, label %bb.h, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, !prof !180
...
bb.h:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPt.exit.i.i
  ...
  br i1 %i.ao, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i.i, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, !prof !180
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i.i: ; preds = %bb.h
  ...
  br i1 %i.at, label %bb.i, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, !prof !180
...
bb.i:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i.i
  ...
  %or.cond34.not38.i.i = select i1 %i.ax, i1 true, i1 %spec.select.i.i.i.i, !prof !181
  %.not8.i.i.i = icmp eq i8 %i.ay, 0
  %or.cond35.i.i = select i1 %or.cond34.not38.i.i, i1 true, i1 %.not8.i.i.i, !prof !182
  br i1 %or.cond35.i.i, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, label %bb.j, !prof !182
...
_ZNK14arrow_vendored4date14year_month_day2okEv.exit.i.i: ; preds = %.thread.i.i.i.i, %bb.k
  ...
  br i1 %.not41.i.i, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, label %bb.l, !prof !183
...
bb.l:                                             ; preds = %_ZNK14arrow_vendored4date14year_month_day2okEv.exit.i.i
  ...
  br i1 %i.cj, label %bb.m, label %bb.n, !prof !180
...
.split.i.i:                                       ; preds = %bb.m
  ...
  br i1 %i.cm, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread50, !prof !1430
...
_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i: ; preds = %bb.m
  ...
  br i1 %i.cp, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread50, !prof !1430
...
bb.o:                                             ; preds = %bb.n, %bb.n
  ...
  %i.cv = load i8, ptr %i.cu, align 1, !tbaa !52  ; 3 uses
...
bb.q:                                             ; preds = %bb.o
  ...
  %i.da = load i8, ptr %i.cz, align 1, !tbaa !52  ; 4 uses
...
bb.r:                                             ; preds = %bb.q, %bb.q
  ...
  br i1 %i.de, label %bb.s, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread.sink.split, !prof !180

bb.s:                                             ; preds = %bb.r
  %i.df = add i8 %i.cv, -48                       ; 2 uses
  %narrow.i.i.i = mul nuw nsw i8 %i.dd, 10
  %i.dg = icmp ugt i8 %i.df, 9
  %i.dh = add nuw nsw i8 %narrow.i.i.i, %i.df     ; 2 uses
  %i.di = icmp ugt i8 %i.dh, 23
  %or.cond.i.i = select i1 %i.dg, i1 true, i1 %i.di, !prof !1432
  br i1 %or.cond.i.i, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread.sink.split, label %bb.t, !prof !1432
...
bb.t:                                             ; preds = %bb.s
  ...
  store i64 %spec.select.i, ptr %7, align 8, !tbaa !126
  br label %.sink.split.i

bb.u:                                             ; preds = %bb.q
  %i.dn = add i64 %2, -5                          ; 2 uses
  %i.do = getelementptr inbounds nuw i8, ptr %3, i64 %i.dn ; 3 uses
  %i.dp = load i8, ptr %i.do, align 1, !tbaa !52  ; 2 uses
  switch i8 %i.dp, label %bb.z [
    i8 43, label %bb.v
    i8 45, label %bb.v
  ]
...
bb.v:                                             ; preds = %bb.u, %bb.u
  ...
  br i1 %i.dt, label %bb.w, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread.sink.split, !prof !180

bb.w:                                             ; preds = %bb.v
  %i.du = add i8 %i.da, -48                       ; 2 uses
  %narrow.i.i78.i = mul nuw nsw i8 %i.ds, 10
  %i.dv = icmp ult i8 %i.du, 10
  %i.dw = add nuw nsw i8 %narrow.i.i78.i, %i.du   ; 2 uses
  br i1 %i.dv, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i79.i, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread.sink.split, !prof !180
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i79.i: ; preds = %bb.w
  ...
  br i1 %i.ea, label %bb.x, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread.sink.split, !prof !180
...
bb.x:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i79.i
  ...
  %i.ed = add nuw nsw i8 %narrow.i8.i80.i, %i.eb  ; 2 uses
  br i1 %i.ec, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i.i, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread.sink.split, !prof !180

_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i.i: ; preds = %bb.x
  %i.ee = icmp ugt i8 %i.dw, 23
  %i.ef = icmp ugt i8 %i.ed, 59
  %or.cond6.i.i = select i1 %i.ee, i1 true, i1 %i.ef, !prof !275
  br i1 %or.cond6.i.i, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread.sink.split, label %bb.y, !prof !276
...
bb.y:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i.i
  ...
  %spec.select161.i = select i1 %i.el, i64 %i.em, i64 %i.ek
  store i64 %spec.select161.i, ptr %7, align 8, !tbaa !126
  br label %.sink.split.i

bb.z:                                             ; preds = %bb.u
  %i.en = add i64 %2, -6                          ; 3 uses
  %i.eo = getelementptr inbounds nuw i8, ptr %3, i64 %i.en ; 2 uses
  %i.ep = load i8, ptr %i.eo, align 1, !tbaa !52  ; 2 uses
...
bb.aa:                                            ; preds = %bb.z, %bb.z
  ...
  br i1 %i.eq, label %bb.ab, label %.sink.split.i
...
bb.ab:                                            ; preds = %bb.aa
  ...
  br i1 %i.es, label %bb.ac, label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit.thread.sink.split, !prof !85

bb.ac:                                            ; preds = %bb.ab
  %i.et = icmp eq i8 %i.ep, 43
  br i1 %i.et, label %bb.ad, label %.sink.split.i
