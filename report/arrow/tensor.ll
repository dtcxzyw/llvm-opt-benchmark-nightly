...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep30 = getelementptr i8, ptr %i.n, i64 %offset.idx ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %.promoted, i64 %offset.idx ; 2 uses
  %next.gep29 = getelementptr i8, ptr %i.n, i64 %offset.idx ; 2 uses
...
vector.ph:                                        ; preds = %.lr.ph21
  ...
  %i.an = getelementptr i8, ptr %i.m, i64 %i.al
  br label %vector.body
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx = shl i64 %index, 2                 ; 2 uses
  %next.gep = getelementptr i8, ptr %.promoted, i64 %offset.idx ; 2 uses
  %next.gep28 = getelementptr i8, ptr %i.m, i64 %offset.idx ; 2 uses
