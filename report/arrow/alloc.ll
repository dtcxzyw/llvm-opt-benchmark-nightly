...
.lr.ph:                                           ; preds = %.split.us, %bb.b
  ...
  tail call void %i.h() #16, !inline_history !39
...
mi_heap_malloc.exit:                              ; preds = %.split, %bb.c
  ...
  tail call void %i.u() #16, !inline_history !39
...
mi_heap_malloc.exit:                              ; preds = %bb.a, %bb.b
  ...
  br i1 %i.o, label %bb.c, label %bb.d, !prof !40
...
mi_heap_malloc.exit.i:                            ; preds = %bb.b, %bb.a
  ...
  br i1 %i.q, label %bb.c, label %mi_heap_alloc_new.exit, !prof !40
...
mi_heap_malloc.exit.i:                            ; preds = %bb.d, %bb.c
  ...
  br i1 %i.r, label %bb.e, label %mi_heap_alloc_new.exit, !prof !40
...
mi_heap_malloc.exit.i.i:                          ; preds = %bb.d, %bb.c
  ...
  br i1 %i.t, label %bb.e, label %mi_heap_alloc_new_n.exit, !prof !40
...
mi_malloc.exit:                                   ; preds = %bb.a, %bb.b
  %i.p = tail call noalias ptr @_mi_malloc_generic(ptr noundef %i.b, i64 noundef %0, i1 noundef zeroext false, i64 noundef 0) #16 ; 2 uses
  %i.q = icmp eq ptr %i.p, null
  br i1 %i.q, label %bb.c, label %bb.d, !prof !40
...
mi_try_new_handler.exit:                          ; preds = %.lr.ph
  tail call void %i.c() #16, !inline_history !39
...
mi_try_new_handler.exit:                          ; preds = %.lr.ph
  ...
  %i.d = tail call noalias ptr @mi_malloc_aligned(i64 noundef %0, i64 noundef %1) #16 ; 2 uses
  %i.e = icmp eq ptr %i.d, null
  br i1 %i.e, label %.lr.ph, label %.critedge, !llvm.loop !42
...
mi_try_new_handler.exit:                          ; preds = %.lr.ph
  tail call void %i.e() #16, !inline_history !39
  ...
  br i1 %i.h, label %.lr.ph, label %.critedge, !llvm.loop !43
...
mi_try_new_handler.exit.i:                        ; preds = %.lr.ph.i
  tail call void %i.h() #16, !inline_history !44
  ...
  br i1 %i.k, label %.lr.ph.i, label %mi_new_realloc.exit, !llvm.loop !43
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.p = load i8, ptr %i.o, align 8, !tbaa !46
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.s = load i8, ptr %i.r, align 8, !tbaa !47, !range !32, !noundef !33
  %i.t = trunc nuw i8 %i.s to i1
  br i1 %i.t, label %bb.j, label %mi_page_is_used_at_frac.exit48

bb.j:                                             ; preds = %bb.i
  %i.u = load ptr, ptr %i.j, align 8, !tbaa !45
  %i.v = icmp eq ptr %.040, %i.u
  br i1 %i.v, label %bb.k, label %bb.l, !prof !29

bb.k:                                             ; preds = %bb.j
  %i.w = load ptr, ptr %.040, align 8, !tbaa !52
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 57
  %i.y = load i8, ptr %i.x, align 1, !tbaa !53, !range !32, !noundef !33
...
bb.m:                                             ; preds = %bb.l
  %i.ac = load ptr, ptr %.040, align 8, !tbaa !52
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 57
  %i.ae = load i8, ptr %i.ad, align 1, !tbaa !53, !range !32, !noundef !33
...
mi_page_is_used_at_frac.exit:                     ; preds = %bb.m
  ...
  %i.ah = load i16, ptr %i.ag, align 4, !tbaa !60 ; 2 uses
...
bb.p:                                             ; preds = %bb.o, %.thread
  ...
  %i.az = load ptr, ptr %.040, align 8, !tbaa !52
...
mi_page_is_used_at_frac.exit48:                   ; preds = %bb.d, %bb.h, %bb.i, %.thread, %bb.c
  ...
  %i.bc = load i16, ptr %i.bb, align 4, !tbaa !60 ; 2 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.bn = load i32, ptr %i.bm, align 8, !tbaa !64
...
begin_hunk_18_@mi_free_try_collect_mt:bb.a
  ...
  br i1 %i.bu, label %mi_page_unown_from_free.exit, label %.preheader.i, !prof !65
...
.loopexit.i:                                      ; preds = %bb.v, %.preheader.i
  ...
  br i1 %i.bw, label %mi_page_unown_from_free.exit, label %.preheader.i, !prof !66, !llvm.loop !67
...
!38 = distinct !{!38, !26}
!39 = distinct !{null}
!40 = !{!"branch_weights", !"expected", i32 1074010193, i32 1073473455}
!41 = distinct !{!41, !26}
!42 = distinct !{!42, !26}
!43 = distinct !{!43, !26}
!44 = distinct !{ptr @mi_new_realloc, null}
!45 = !{!8, !15, i64 64}
!46 = !{!8, !5, i64 56}
!47 = !{!48, !14, i64 224}
!48 = !{!"mi_heap_s", !49, i64 0, !50, i64 8, !4, i64 16, !12, i64 24, !51, i64 32, !12, i64 168, !12, i64 176, !12, i64 184, !12, i64 192, !12, i64 200, !15, i64 208, !12, i64 216, !14, i64 224, !14, i64 225, !5, i64 226, !5, i64 232, !5, i64 1264, !17, i64 3664}
!49 = !{!"p1 _ZTS8mi_tld_s", !10, i64 0}
!50 = !{!"p1 _ZTS10mi_arena_s", !10, i64 0}
!51 = !{!"mi_random_cxt_s", !5, i64 0, !5, i64 64, !4, i64 128, !14, i64 132}
!52 = !{!48, !49, i64 0}
!53 = !{!54, !14, i64 57}
!54 = !{!"mi_tld_s", !12, i64 0, !12, i64 8, !4, i64 16, !55, i64 24, !15, i64 32, !15, i64 40, !56, i64 48, !14, i64 56, !14, i64 57, !57, i64 64, !17, i64 4368}
!55 = !{!"p1 _ZTS12mi_subproc_s", !10, i64 0}
!56 = !{!"long long", !5, i64 0}
!57 = !{!"mi_stats_s", !4, i64 0, !58, i64 8, !58, i64 32, !58, i64 56, !58, i64 80, !58, i64 104, !58, i64 128, !58, i64 152, !58, i64 176, !58, i64 200, !58, i64 224, !58, i64 248, !59, i64 272, !59, i64 280, !59, i64 288, !59, i64 296, !59, i64 304, !59, i64 312, !59, i64 320, !59, i64 328, !59, i64 336, !59, i64 344, !59, i64 352, !59, i64 360, !59, i64 368, !58, i64 376, !58, i64 400, !58, i64 424, !58, i64 448, !59, i64 472, !59, i64 480, !59, i64 488, !59, i64 496, !5, i64 504, !5, i64 600, !5, i64 632, !5, i64 2408, !5, i64 4184}
!58 = !{!"mi_stat_count_s", !12, i64 0, !12, i64 8, !12, i64 16}
!59 = !{!"mi_stat_counter_s", !12, i64 0}
!60 = !{!8, !11, i64 20}
!61 = !{!48, !50, i64 8}
!62 = !{!63, !12, i64 16}
!63 = !{!"mi_page_queue_s", !16, i64 0, !16, i64 8, !12, i64 16, !12, i64 24}
!64 = !{!8, !4, i64 112}
!65 = !{!"branch_weights", i32 1999, i32 1}
!66 = !{!"branch_weights", i32 1, i32 0}
!67 = distinct !{!67, !26}
!68 = distinct !{!68, !26}
end_hunk_20
