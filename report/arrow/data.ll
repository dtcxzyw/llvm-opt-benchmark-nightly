...
begin_hunk_0_@_ZN5arrow8internal19FillZeroLengthArrayEPKNS_8DataTypeEPNS_9ArraySpanE:bb.a
  ...
  %.0.i = phi i64 [ 72, %_ZN5arrow12_GLOBAL__N_113GetNumBuffersERKNS_8DataTypeE.exit.loopexit71 ], [ 24, %_ZN5arrow12_GLOBAL__N_113GetNumBuffersERKNS_8DataTypeE.exit.loopexit ], [ 48, %tailrecurse.i ]
  %2 = phi i64 [ 24, %_ZN5arrow12_GLOBAL__N_113GetNumBuffersERKNS_8DataTypeE.exit.loopexit71 ], [ 48, %_ZN5arrow12_GLOBAL__N_113GetNumBuffersERKNS_8DataTypeE.exit.loopexit ], [ 24, %tailrecurse.i ]
...
.lr.ph:                                           ; preds = %_ZN5arrow8internal24may_have_validity_bitmapENS_4Type4typeE.exit.thread
  %scevgep = getelementptr i8, ptr %i.g, i64 %.0.i
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %scevgep, i8 0, i64 %2, i1 false), !tbaa !39
  br label %._crit_edge
