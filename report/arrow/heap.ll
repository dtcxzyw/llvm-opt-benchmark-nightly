...
.preheader.i.split.us:                            ; preds = %.preheader.i, %.critedge.i.us
  %.02229.i.us = phi i64 [ %i.k, %.critedge.i.us ], [ 0, %.preheader.i ] ; 2 uses
...
.critedge.i.us:                                   ; preds = %mi_heap_page_collect.exit.us.us, %.preheader.i.split.us
  %i.k = add nuw nsw i64 %.02229.i.us, 1          ; 2 uses
  %exitcond.i.us = icmp eq i64 %i.k, 75
  br i1 %exitcond.i.us, label %mi_heap_visit_pages.exit, label %.preheader.i.split.us, !llvm.loop !20

.lr.ph.us:                                        ; preds = %.preheader.i.split.us, %mi_heap_page_collect.exit.us.us
  %.020.i12.us.us = phi ptr [ %i.m, %mi_heap_page_collect.exit.us.us ], [ %i.j, %.preheader.i.split.us ] ; 5 uses
  %i.l = getelementptr inbounds nuw i8, ptr %.020.i12.us.us, i64 72
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !22   ; 2 uses
  tail call void @_mi_page_free_collect(ptr noundef nonnull %.020.i12.us.us, i1 noundef zeroext %i.c) #9
  %i.n = getelementptr i8, ptr %.020.i12.us.us, i64 16
  %.val.i.us.us = load i16, ptr %i.n, align 8, !tbaa !27
  %i.o = icmp eq i16 %.val.i.us.us, 0
  br i1 %i.o, label %bb.d, label %bb.c

bb.c:                                             ; preds = %.lr.ph.us
  tail call void @_mi_page_abandon(ptr noundef nonnull %.020.i12.us.us, ptr noundef nonnull %i.i) #9
  br label %mi_heap_page_collect.exit.us.us

bb.d:                                             ; preds = %.lr.ph.us
  tail call void @_mi_page_free(ptr noundef nonnull %.020.i12.us.us, ptr noundef nonnull %i.i) #9
  br label %mi_heap_page_collect.exit.us.us

mi_heap_page_collect.exit.us.us:                  ; preds = %bb.d, %bb.c
  %.not.i.us.us = icmp eq ptr %i.m, null
  br i1 %.not.i.us.us, label %.critedge.i.us, label %.lr.ph.us, !llvm.loop !28
...
.lr.ph:                                           ; preds = %.preheader.i.split, %mi_heap_page_collect.exit
  %.020.i12 = phi ptr [ %i.s, %mi_heap_page_collect.exit ], [ %i.q, %.preheader.i.split ] ; 4 uses
  %i.r = getelementptr inbounds nuw i8, ptr %.020.i12, i64 72
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !22   ; 2 uses
  tail call void @_mi_page_free_collect(ptr noundef nonnull %.020.i12, i1 noundef zeroext %i.c) #9
  %i.t = getelementptr i8, ptr %.020.i12, i64 16
  %.val.i = load i16, ptr %i.t, align 8, !tbaa !27
  %i.u = icmp eq i16 %.val.i, 0
  br i1 %i.u, label %bb.e, label %mi_heap_page_collect.exit

bb.e:                                             ; preds = %.lr.ph
  tail call void @_mi_page_free(ptr noundef nonnull %.020.i12, ptr noundef nonnull %i.p) #9
...
.critedge.i:                                      ; preds = %mi_heap_page_collect.exit, %.preheader.i.split
  ...
  br i1 %exitcond.i, label %mi_heap_visit_pages.exit, label %.preheader.i.split, !llvm.loop !20

mi_heap_visit_pages.exit:                         ; preds = %.critedge.i, %.critedge.i.us, %bb.b
  %i.w = icmp eq i32 %1, 1
  %i.x = load ptr, ptr %0, align 8, !tbaa !29
...
bb.a:
  ...
  %i.d = icmp ne ptr %i.b, @_mi_heap_empty
  %i.e = and i1 %i.c, %i.d
  br i1 %i.e, label %mi_heap_get_default.exit, label %bb.b, !prof !31
...
mi_heap_get_default.exit:                         ; preds = %bb.a, %bb.b
  ...
  %i.g = load ptr, ptr %.0.i, align 8, !tbaa !29
...
bb.a:
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %5, ptr noundef nonnull align 8 dereferenceable(24) %i.a, i64 24, i1 false), !tbaa.struct !39
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.a, ptr noundef nonnull align 8 dereferenceable(24) %5, i64 24, i1 false), !tbaa.struct !39
  store ptr %4, ptr %0, align 8, !tbaa !29
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 226
  store i8 %3, ptr %i.b, align 2, !tbaa !42
  %i.c = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.d = load i32, ptr %i.c, align 8, !tbaa !43
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i32 %i.d, ptr %i.e, align 8, !tbaa !44
...
bb.b:                                             ; preds = %bb.a
  ...
  store i8 %i.j, ptr %i.k, align 8, !tbaa !46
...
bb.c:                                             ; preds = %.critedge, %bb.b
  ...
  store i64 %i.r, ptr %i.s, align 8, !tbaa !48
  %i.t = load ptr, ptr %0, align 8, !tbaa !29     ; 2 uses
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 57
  %i.v = load i8, ptr %i.u, align 1, !tbaa !49, !range !50, !noundef !51
...
bb.d:                                             ; preds = %bb.c
  %i.y = lshr i64 %i.r, 2
  store i64 %i.y, ptr %i.s, align 8, !tbaa !48
  br label %bb.e
...
bb.f:                                             ; preds = %bb.e
  store ptr %0, ptr %i.z, align 8, !tbaa !32
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  store i64 %i.ag, ptr %i.ah, align 8, !tbaa !52
  ...
  store ptr %0, ptr %i.aj, align 8, !tbaa !53
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.i = load i32, ptr %i.h, align 8, !tbaa !43
...
bb.f:                                             ; preds = %bb.d
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.l, ptr noundef nonnull align 8 dereferenceable(24) %4, i64 24, i1 false), !tbaa.struct !39
