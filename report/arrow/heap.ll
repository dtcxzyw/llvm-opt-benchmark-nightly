Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/arrow/original/heap?download=true
...
%struct.mi_page_s = type { i64, ptr, i16, i16, i16, i8, i8, ptr, i64, i64, ptr, i8, i8, ptr, ptr, ptr, i64, %struct.mi_memid_s }
...
@.str = private unnamed_addr constant [35 x i8] c"unable to allocate heap meta-data\0A\00", align 1
@.str.1 = private unnamed_addr constant [100 x i8] c"'mi_heap_destroy' called but ignored as the heap was not created with 'allow_destroy' (heap at %p)\0A\00", align 1
@.str.2 = private unnamed_addr constant [69 x i8] c"cannot unload heaps that are not associated with an exclusive arena\0A\00", align 1
@.str.3 = private unnamed_addr constant [70 x i8] c"cannot reload heaps that were not associated with an exclusive arena\0A\00", align 1
@.str.4 = private unnamed_addr constant [50 x i8] c"cannot reload heaps that were not unloaded first\0A\00", align 1
@.str.5 = private unnamed_addr constant [64 x i8] c"trying to reload a heap at a different arena address: %p vs %p\0A\00", align 1
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void @_mi_deferred_free(ptr noundef nonnull %0, i1 noundef zeroext %i.c) #9
  tail call void @_mi_heap_collect_retired(ptr noundef nonnull %0, i1 noundef zeroext %i.c) #9
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 168
  %i.e = load i64, ptr %i.d, align 8, !tbaa !19
  %i.f = icmp eq i64 %i.e, 0
  br i1 %i.f, label %mi_heap_visit_pages.exit, label %.preheader.i

.preheader.i:                                     ; preds = %bb.b
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 1264 ; 2 uses
  %i.h = icmp eq i32 %1, 2
  br i1 %i.h, label %.preheader.i.split.us, label %.preheader.i.split

.preheader.i.split.us:                            ; preds = %.preheader.i, %.critedge.i.us
  %.02229.i.us = phi i64 [ %i.o, %.critedge.i.us ], [ 0, %.preheader.i ] ; 2 uses
  %i.i = getelementptr inbounds nuw [32 x i8], ptr %i.g, i64 %.02229.i.us ; 3 uses
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !22   ; 2 uses
  %.not.i11.us = icmp eq ptr %i.j, null
  br i1 %.not.i11.us, label %.critedge.i.us, label %.lr.ph.us

.lr.ph.us:                                        ; preds = %.preheader.i.split.us, %mi_heap_page_collect.exit.us.us
  %.0.i12.us.us = phi ptr [ %i.l, %mi_heap_page_collect.exit.us.us ], [ %i.j, %.preheader.i.split.us ] ; 5 uses
  %i.k = getelementptr inbounds nuw i8, ptr %.0.i12.us.us, i64 72
  %i.l = load ptr, ptr %i.k, align 8, !tbaa !27   ; 2 uses
  tail call void @_mi_page_free_collect(ptr noundef nonnull %.0.i12.us.us, i1 noundef zeroext %i.c) #9
  %i.m = getelementptr i8, ptr %.0.i12.us.us, i64 16
  %.val.i.us.us = load i16, ptr %i.m, align 8, !tbaa !28
  %i.n = icmp eq i16 %.val.i.us.us, 0
  br i1 %i.n, label %bb.d, label %bb.c

bb.c:                                             ; preds = %.lr.ph.us
  tail call void @_mi_page_abandon(ptr noundef nonnull %.0.i12.us.us, ptr noundef nonnull %i.i) #9
  br label %mi_heap_page_collect.exit.us.us

bb.d:                                             ; preds = %.lr.ph.us
  tail call void @_mi_page_free(ptr noundef nonnull %.0.i12.us.us, ptr noundef nonnull %i.i) #9
  br label %mi_heap_page_collect.exit.us.us

mi_heap_page_collect.exit.us.us:                  ; preds = %bb.d, %bb.c
  %.not.i.us.us = icmp eq ptr %i.l, null
  br i1 %.not.i.us.us, label %.critedge.i.us, label %.lr.ph.us, !llvm.loop !0

.critedge.i.us:                                   ; preds = %mi_heap_page_collect.exit.us.us, %.preheader.i.split.us
  %i.o = add nuw nsw i64 %.02229.i.us, 1          ; 2 uses
  %exitcond.i.us = icmp eq i64 %i.o, 75
  br i1 %exitcond.i.us, label %mi_heap_visit_pages.exit, label %.preheader.i.split.us, !llvm.loop !1

.preheader.i.split:                               ; preds = %.preheader.i, %.critedge.i
  %.02229.i = phi i64 [ %i.v, %.critedge.i ], [ 0, %.preheader.i ] ; 2 uses
  %i.p = getelementptr inbounds nuw [32 x i8], ptr %i.g, i64 %.02229.i ; 2 uses
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !22   ; 2 uses
  %.not.i11 = icmp eq ptr %i.q, null
  br i1 %.not.i11, label %.critedge.i, label %.lr.ph

.lr.ph:                                           ; preds = %.preheader.i.split, %mi_heap_page_collect.exit
  %.0.i12 = phi ptr [ %i.s, %mi_heap_page_collect.exit ], [ %i.q, %.preheader.i.split ] ; 4 uses
  %i.r = getelementptr inbounds nuw i8, ptr %.0.i12, i64 72
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !27   ; 2 uses
  tail call void @_mi_page_free_collect(ptr noundef nonnull %.0.i12, i1 noundef zeroext %i.c) #9
  %i.t = getelementptr i8, ptr %.0.i12, i64 16
  %.val.i = load i16, ptr %i.t, align 8, !tbaa !28
  %i.u = icmp eq i16 %.val.i, 0
  br i1 %i.u, label %bb.e, label %mi_heap_page_collect.exit

bb.e:                                             ; preds = %.lr.ph
  tail call void @_mi_page_free(ptr noundef nonnull %.0.i12, ptr noundef nonnull %i.p) #9
  br label %mi_heap_page_collect.exit

mi_heap_page_collect.exit:                        ; preds = %.lr.ph, %bb.e
  %.not.i = icmp eq ptr %i.s, null
  br i1 %.not.i, label %.critedge.i, label %.lr.ph, !llvm.loop !0

.critedge.i:                                      ; preds = %mi_heap_page_collect.exit, %.preheader.i.split
  %i.v = add nuw nsw i64 %.02229.i, 1             ; 2 uses
  %exitcond.i = icmp eq i64 %i.v, 75
  br i1 %exitcond.i, label %mi_heap_visit_pages.exit, label %.preheader.i.split, !llvm.loop !1

mi_heap_visit_pages.exit:                         ; preds = %.critedge.i, %.critedge.i.us, %bb.b
  %i.w = icmp eq i32 %1, 1
  %i.x = load ptr, ptr %0, align 8, !tbaa !30
  tail call void @_mi_arenas_collect(i1 noundef zeroext %i.w, i1 noundef zeroext %i.c, ptr noundef %i.x) #9
  %i.y = icmp samesign ult i32 %1, 2
  br i1 %i.y, label %bb.f, label %bb.g

bb.f:                                             ; preds = %mi_heap_visit_pages.exit
  %i.z = load ptr, ptr %0, align 8, !tbaa !30
  tail call void @_mi_stats_merge_thread(ptr noundef %i.z) #9
  br label %bb.g

bb.g:                                             ; preds = %mi_heap_visit_pages.exit, %bb.f, %bb.a
  ret void
}
...
bb.a:
  ...
  tail call fastcc void @mi_heap_collect_ex(ptr noundef %0, i32 noundef %i.a)
  ret void
}
...
bb.a:
  ...
  tail call fastcc void @mi_heap_collect_ex(ptr noundef %i.b, i32 noundef %i.c)
  ret void
}
...
bb.a:
  ...
  %i.e = and i1 %i.c, %i.d
  br i1 %i.e, label %bb.c, label %bb.b, !prof !32

bb.b:                                             ; preds = %bb.a
  tail call void @mi_thread_init() #9
  %i.f = load ptr, ptr %i.a, align 8, !tbaa !31
  br label %bb.c

bb.c:                                             ; preds = %bb.b, %bb.a
  %.0 = phi ptr [ %i.f, %bb.b ], [ %i.b, %bb.a ]
  ret ptr %.0
}
...
bb.a:
  ...
  %i.d = icmp ne ptr %i.b, @_mi_heap_empty
  %i.e = and i1 %i.c, %i.d
  br i1 %i.e, label %mi_heap_get_default.exit, label %bb.b, !prof !32
...
mi_heap_get_default.exit:                         ; preds = %bb.a, %bb.b
  %.0.i = phi ptr [ %i.f, %bb.b ], [ %i.b, %bb.a ]
  %i.g = load ptr, ptr %.0.i, align 8, !tbaa !30
...
; Function Attrs: nounwind uwtable
define hidden void @_mi_heap_init(ptr noundef %0, ptr noundef %1, i1 noundef zeroext %2, i8 noundef zeroext %3, ptr noundef %4) local_unnamed_addr #0 {
bb.a:
  %5 = alloca %struct.mi_memid_s, align 8         ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %5)
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 3664 ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %5, ptr noundef nonnull align 8 dereferenceable(24) %i.a, i64 24, i1 false), !tbaa.struct !42
  call void @llvm.assume(i1 true) [ "align"(ptr %0, i64 8) ]
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(3688) %0, ptr noundef nonnull readonly align 8 dereferenceable(3688) @_mi_heap_empty, i64 range(i64 2400, 3689) 3664, i1 false)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.a, ptr noundef nonnull align 8 dereferenceable(24) %5, i64 24, i1 false), !tbaa.struct !42
  store ptr %4, ptr %0, align 8, !tbaa !30
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 226
  store i8 %3, ptr %i.b, align 2, !tbaa !43
  %i.c = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.d = load i32, ptr %i.c, align 8, !tbaa !44
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i32 %i.d, ptr %i.e, align 8, !tbaa !45
  %i.f = tail call ptr @_mi_arena_from_id(ptr noundef %1) #9
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 8
  store ptr %i.f, ptr %i.g, align 8, !tbaa !46
  br i1 %2, label %.critedge, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.h = tail call i64 @mi_option_get(i32 noundef 35) #9
  %i.i = icmp sgt i64 %i.h, -1
  %i.j = zext i1 %i.i to i8
  %i.k = getelementptr inbounds nuw i8, ptr %0, i64 224
  store i8 %i.j, ptr %i.k, align 8, !tbaa !47
  %i.l = tail call i64 @mi_option_get(i32 noundef 36) #9
...
bb.c:                                             ; preds = %.critedge, %bb.b
  %i.p = phi i8 [ 0, %.critedge ], [ %i.n, %bb.b ]
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 225
  store i8 %i.p, ptr %i.q, align 1, !tbaa !67
  %i.r = tail call i64 @mi_option_get_clamp(i32 noundef 36, i64 noundef -1, i64 noundef 32) #9 ; 3 uses
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 216 ; 2 uses
  store i64 %i.r, ptr %i.s, align 8, !tbaa !68
  %i.t = load ptr, ptr %0, align 8, !tbaa !30     ; 2 uses
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 57
  %i.v = load i8, ptr %i.u, align 1, !tbaa !69, !range !48, !noundef !49
  %i.w = trunc nuw i8 %i.v to i1
  %i.x = icmp sgt i64 %i.r, 0
  %or.cond = select i1 %i.w, i1 %i.x, i1 false
  br i1 %or.cond, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.y = lshr i64 %i.r, 2
  store i64 %i.y, ptr %i.s, align 8, !tbaa !68
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c
  %i.z = getelementptr inbounds nuw i8, ptr %i.t, i64 32 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void @_mi_random_init(ptr noundef nonnull %i.ac) #9
  br label %bb.h

bb.g:                                             ; preds = %bb.e
  %i.ad = getelementptr inbounds nuw i8, ptr %i.aa, i64 32
  tail call void @_mi_random_split(ptr noundef nonnull %i.ad, ptr noundef nonnull %i.ac) #9
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.af = tail call i64 @_mi_random_next(ptr noundef nonnull %i.ae) #9
  %i.ag = or i64 %i.af, 1
  %i.ah = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i64 %i.ag, ptr %i.ah, align 8, !tbaa !70
  tail call void @_mi_heap_guarded_init(ptr noundef nonnull %0) #9
  %i.ai = load ptr, ptr %0, align 8, !tbaa !30
  ...
  store ptr %i.ak, ptr %i.al, align 8, !tbaa !51
  store ptr %0, ptr %i.aj, align 8, !tbaa !50
...
declare ptr @_mi_arena_from_id(ptr noundef) local_unnamed_addr #2
...
bb.a:
  ...
  %i.b = tail call i64 @_mi_random_next(ptr noundef nonnull %i.a) #9
  ret i64 %i.b
}

declare void @_mi_heap_guarded_init(ptr noundef) local_unnamed_addr #2

; Function Attrs: nounwind uwtable
define hidden ptr @_mi_heap_create(i32 noundef %0, i1 noundef zeroext %1, ptr noundef %2, ptr noundef %3) local_unnamed_addr #0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  %i.c = call ptr @_mi_meta_zalloc(i64 noundef 3688, ptr noundef nonnull %4) #9
  br label %bb.d

bb.c:                                             ; preds = %bb.a
  %i.d = tail call ptr @_mi_subproc() #9
  %i.e = tail call ptr @_mi_arena_from_id(ptr noundef %2) #9
  %i.f = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.g = load i64, ptr %i.f, align 8, !tbaa !71
  %i.h = getelementptr inbounds nuw i8, ptr %3, i64 16
  %i.i = load i32, ptr %i.h, align 8, !tbaa !44
  %i.j = call ptr @_mi_arenas_alloc(ptr noundef %i.d, i64 noundef 65536, i1 noundef zeroext true, i1 noundef zeroext true, ptr noundef %i.e, i64 noundef %i.g, i32 noundef %i.i, ptr noundef nonnull %4) #9
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %.0 = phi ptr [ %i.c, %bb.b ], [ %i.j, %bb.c ]  ; 4 uses
  %i.k = icmp eq ptr %.0, null
  br i1 %i.k, label %bb.e, label %bb.f

bb.e:                                             ; preds = %bb.d
  call void (i32, ptr, ...) @_mi_error_message(i32 noundef 12, ptr noundef nonnull @.str) #9
  br label %bb.g

bb.f:                                             ; preds = %bb.d
  %i.l = getelementptr inbounds nuw i8, ptr %.0, i64 3664
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.l, ptr noundef nonnull align 8 dereferenceable(24) %4, i64 24, i1 false), !tbaa.struct !42
  %i.m = trunc i32 %0 to i8
  call void @_mi_heap_init(ptr noundef nonnull %.0, ptr noundef %2, i1 noundef zeroext %1, i8 noundef zeroext %i.m, ptr noundef %3)
  br label %bb.g
...
declare ptr @_mi_arena_id_none() local_unnamed_addr #2

declare ptr @_mi_meta_zalloc(i64 noundef, ptr noundef) local_unnamed_addr #2
...
; Function Attrs: nounwind uwtable
define hidden ptr @mi_heap_new_ex(i32 noundef %0, i1 noundef zeroext %1, ptr noundef %2) local_unnamed_addr #0 {
bb.a:
  %i.a = tail call align 8 ptr @llvm.threadlocal.address.p0(ptr align 8 @_mi_heap_default) ; 2 uses
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !31   ; 3 uses
  %i.c = icmp ne ptr %i.b, null
  %i.d = icmp ne ptr %i.b, @_mi_heap_empty
  %i.e = and i1 %i.c, %i.d
  br i1 %i.e, label %mi_heap_get_backing.exit, label %bb.b, !prof !32
...
mi_heap_get_backing.exit:                         ; preds = %bb.a, %bb.b
  ...
  %i.g = load ptr, ptr %.0.i.i, align 8, !tbaa !30
  %i.h = getelementptr inbounds nuw i8, ptr %i.g, i64 32
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !39
...
bb.a:
  ...
  %i.d = icmp ne ptr %i.b, @_mi_heap_empty
  %i.e = and i1 %i.c, %i.d
  br i1 %i.e, label %mi_heap_new_ex.exit, label %bb.b, !prof !32
...
mi_heap_new_ex.exit:                              ; preds = %bb.a, %bb.b
  ...
  %i.g = load ptr, ptr %.0.i.i.i, align 8, !tbaa !30
  %i.h = getelementptr inbounds nuw i8, ptr %i.g, i64 32
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !39
  %i.j = load ptr, ptr %i.i, align 8, !tbaa !30
...
bb.a:
  ...
  %i.f = and i1 %i.d, %i.e
  br i1 %i.f, label %mi_heap_new_ex.exit, label %bb.b, !prof !32
...
mi_heap_new_ex.exit:                              ; preds = %bb.a, %bb.b
  ...
  %i.h = load ptr, ptr %.0.i.i.i, align 8, !tbaa !30
...
bb.d:                                             ; preds = %bb.b, %bb.c
  ...
  store i32 %i.e, ptr %i.f, align 8, !tbaa !45
  br label %bb.e
...
bb.a:
  ...
  %i.b = load i8, ptr %i.a, align 2, !tbaa !43
...
bb.b:                                             ; preds = %bb.a
  ...
  %.01014 = load ptr, ptr %i.e, align 8, !tbaa !31 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.c, %_mi_heap_page_destroy.exit
  %.0.i3 = phi ptr [ %i.i, %_mi_heap_page_destroy.exit ], [ %i.g, %bb.c ] ; 7 uses
  %i.h = getelementptr inbounds nuw i8, ptr %.0.i3, i64 72 ; 2 uses
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !27   ; 2 uses
  %i.j = getelementptr i8, ptr %.0.i3, i64 40
  %.val.i = load i64, ptr %i.j, align 8, !tbaa !52 ; 2 uses
...
_mi_heap_page_destroy.exit:                       ; preds = %.lr.ph, %bb.d
  %i.n = getelementptr inbounds nuw i8, ptr %.0.i3, i64 16
  store i16 0, ptr %i.n, align 8, !tbaa !28
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.h, i8 0, i64 16, i1 false)
  %i.o = load atomic i64, ptr %.0.i3 monotonic, align 8
  %i.p = and i64 %i.o, 3
  %i.q = getelementptr inbounds nuw i8, ptr %.0.i3, i64 64
  store ptr null, ptr %i.q, align 8, !tbaa !53
  store atomic i64 %i.p, ptr %.0.i3 release, align 8
  %i.r = load ptr, ptr %0, align 8, !tbaa !30
  tail call void @_mi_arenas_page_free(ptr noundef nonnull %.0.i3, ptr noundef %i.r) #9
...
.critedge.i:                                      ; preds = %_mi_heap_page_destroy.exit, %bb.c
  ...
  br i1 %exitcond.i, label %mi_heap_visit_pages.exit, label %bb.c, !llvm.loop !1
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i8, ptr %i.c, align 8, !tbaa !47, !range !48, !noundef !49
...
.lr.ph.i:                                         ; preds = %bb.m, %_mi_heap_page_destroy.exit.i
  %.0.i3.i = phi ptr [ %i.af, %_mi_heap_page_destroy.exit.i ], [ %i.ad, %bb.m ] ; 7 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %.0.i3.i, i64 72 ; 2 uses
  %i.af = load ptr, ptr %i.ae, align 8, !tbaa !27 ; 2 uses
  %i.ag = getelementptr i8, ptr %.0.i3.i, i64 40
  %.val.i.i = load i64, ptr %i.ag, align 8, !tbaa !52 ; 2 uses
...
_mi_heap_page_destroy.exit.i:                     ; preds = %bb.n, %.lr.ph.i
  %i.ak = getelementptr inbounds nuw i8, ptr %.0.i3.i, i64 16
  store i16 0, ptr %i.ak, align 8, !tbaa !28
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ae, i8 0, i64 16, i1 false)
  %i.al = load atomic i64, ptr %.0.i3.i monotonic, align 8
  %i.am = and i64 %i.al, 3
  %i.an = getelementptr inbounds nuw i8, ptr %.0.i3.i, i64 64
  store ptr null, ptr %i.an, align 8, !tbaa !53
  store atomic i64 %i.am, ptr %.0.i3.i release, align 8
  %i.ao = load ptr, ptr %0, align 8, !tbaa !30
  tail call void @_mi_arenas_page_free(ptr noundef nonnull %.0.i3.i, ptr noundef %i.ao) #9
  %.not.i.i7 = icmp eq ptr %i.af, null
  br i1 %.not.i.i7, label %.critedge.i.i, label %.lr.ph.i, !llvm.loop !0
...
.critedge.i.i:                                    ; preds = %_mi_heap_page_destroy.exit.i, %bb.m
  ...
  br i1 %exitcond.i.i, label %_mi_heap_destroy_pages.exit, label %bb.m, !llvm.loop !1
...
bb.o:                                             ; preds = %_mi_heap_destroy_pages.exit, %_mi_heap_destroy_pages.exit.thread
  %.sink = phi ptr [ %i.ab, %_mi_heap_destroy_pages.exit ], [ %i.aa, %_mi_heap_destroy_pages.exit.thread ]
  call void @llvm.assume(i1 true) [ "align"(ptr %0, i64 8) ]
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(2400) %.sink, ptr noundef nonnull readonly align 8 dereferenceable(2400) getelementptr inbounds nuw (i8, ptr @_mi_heap_empty, i64 1264), i64 range(i64 2400, 3689) 2400, i1 false)
...
bb.v:                                             ; preds = %bb.u
  ...
  store ptr %i.bg, ptr %i.bh, align 8, !tbaa !51
  br label %mi_heap_delete.exit.sink.split

bb.w:                                             ; preds = %bb.u
  store ptr %i.bg, ptr %i.az, align 8, !tbaa !50
  br label %mi_heap_delete.exit.sink.split
...
bb.f:                                             ; preds = %bb.f, %bb.e
  ...
  br i1 %i.n, label %bb.f, label %bb.g, !llvm.loop !2
...
bb.i:                                             ; preds = %bb.h
  ...
  store ptr %i.r, ptr %i.s, align 8, !tbaa !51
  br label %bb.k

bb.j:                                             ; preds = %bb.h
  store ptr %i.r, ptr %i.k, align 8, !tbaa !50
  br label %bb.k
...
.lr.ph:                                           ; preds = %bb.b, %bb.g
  ...
  %i.h = load i8, ptr %i.g, align 8, !tbaa !47, !range !48, !noundef !49
...
.lr.ph.i:                                         ; preds = %bb.e, %_mi_heap_page_destroy.exit.i
  %.0.i3.i = phi ptr [ %i.q, %_mi_heap_page_destroy.exit.i ], [ %i.o, %bb.e ] ; 7 uses
  %i.p = getelementptr inbounds nuw i8, ptr %.0.i3.i, i64 72 ; 2 uses
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !27   ; 2 uses
  %i.r = getelementptr i8, ptr %.0.i3.i, i64 40
  %.val.i.i = load i64, ptr %i.r, align 8, !tbaa !52 ; 2 uses
  %i.s = icmp ugt i64 %.val.i.i, 65536
  br i1 %i.s, label %bb.f, label %_mi_heap_page_destroy.exit.i

bb.f:                                             ; preds = %.lr.ph.i
  %i.t = load ptr, ptr %.010, align 8, !tbaa !30
...
_mi_heap_page_destroy.exit.i:                     ; preds = %bb.f, %.lr.ph.i
  %i.v = getelementptr inbounds nuw i8, ptr %.0.i3.i, i64 16
  store i16 0, ptr %i.v, align 8, !tbaa !28
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.p, i8 0, i64 16, i1 false)
  %i.w = load atomic i64, ptr %.0.i3.i monotonic, align 8
  %i.x = and i64 %i.w, 3
  %i.y = getelementptr inbounds nuw i8, ptr %.0.i3.i, i64 64
  store ptr null, ptr %i.y, align 8, !tbaa !53
  store atomic i64 %i.x, ptr %.0.i3.i release, align 8
  %i.z = load ptr, ptr %.010, align 8, !tbaa !30
  tail call void @_mi_arenas_page_free(ptr noundef nonnull %.0.i3.i, ptr noundef %i.z) #9
  %.not.i.i = icmp eq ptr %i.q, null
  br i1 %.not.i.i, label %.critedge.i.i, label %.lr.ph.i, !llvm.loop !0
...
.critedge.i.i:                                    ; preds = %_mi_heap_page_destroy.exit.i, %bb.e
  ...
  br i1 %exitcond.i.i, label %_mi_heap_destroy_pages.exit, label %bb.e, !llvm.loop !1
...
bb.h:                                             ; preds = %bb.h, %bb.g
  ...
  br i1 %i.q, label %bb.h, label %bb.i, !llvm.loop !2
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.h = load ptr, ptr %i.c, align 8, !tbaa !46   ; 2 uses
...
bb.h:                                             ; preds = %bb.f
  ...
  %i.m = and i1 %i.k, %i.l
  br i1 %i.m, label %mi_heap_get_default.exit, label %bb.i, !prof !32

bb.i:                                             ; preds = %bb.h
  tail call void @mi_thread_init() #9
  %i.n = load ptr, ptr %i.i, align 8, !tbaa !31
  br label %mi_heap_get_default.exit

mi_heap_get_default.exit:                         ; preds = %bb.h, %bb.i
  %.0.i = phi ptr [ %i.n, %bb.i ], [ %i.j, %bb.h ]
  %i.o = load ptr, ptr %.0.i, align 8, !tbaa !30  ; 2 uses
  ...
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.p, align 8, !tbaa !54
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.q, align 8, !tbaa !54
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 264
  %i.s = getelementptr inbounds nuw i8, ptr %0, i64 280
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.r, align 8, !tbaa !54
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.s, align 8, !tbaa !54
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 296
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 312
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.t, align 8, !tbaa !54
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.u, align 8, !tbaa !54
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 328
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 344
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.v, align 8, !tbaa !54
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.w, align 8, !tbaa !54
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 360
  %i.y = getelementptr inbounds nuw i8, ptr %0, i64 376
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.x, align 8, !tbaa !54
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.y, align 8, !tbaa !54
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 392
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 408
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.z, align 8, !tbaa !54
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.aa, align 8, !tbaa !54
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 424
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 440
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.ab, align 8, !tbaa !54
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.ac, align 8, !tbaa !54
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 456
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 472
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.ad, align 8, !tbaa !54
  store <2 x ptr> <ptr @_mi_page_empty, ptr @_mi_page_empty>, ptr %i.ae, align 8, !tbaa !54
