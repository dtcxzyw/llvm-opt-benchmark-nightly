...
begin_hunk_0_@_ZN5arrow7compute8internal23RegisterVectorSelectionEPNS0_16FunctionRegistryE:bb.a
  ...
  %18 = alloca %"struct.arrow::compute::VectorKernel", align 8 ; 20 uses
...
begin_hunk_1_@_ZN5arrow7compute8internal23RegisterVectorSelectionEPNS0_16FunctionRegistryE:bb.a
  ...
  %26 = alloca %"struct.arrow::compute::VectorKernel", align 8 ; 20 uses
...
end_hunk_1
begin_hunk_2_@_ZN5arrow7compute8internal23RegisterVectorSelectionEPNS0_16FunctionRegistryE:bb.a
  ...
  %i.f = getelementptr inbounds nuw i8, ptr %18, i64 124
  store i32 1, ptr %i.f, align 4, !tbaa !68
  %i.g = getelementptr inbounds nuw i8, ptr %18, i64 128
  store i8 1, ptr %i.g, align 8, !tbaa !69
  %i.h = getelementptr inbounds nuw i8, ptr %18, i64 129
  store i8 1, ptr %i.h, align 1, !tbaa !70
  %i.i = getelementptr inbounds nuw i8, ptr %18, i64 130
  store i8 1, ptr %i.i, align 2, !tbaa !71
  %.sroa.4.0..sroa_idx = getelementptr inbounds nuw i8, ptr %18, i64 16
  store <2 x i64> <i64 ptrtoint (ptr @_ZN5arrow7compute8internal14OptionsWrapperINS0_13FilterOptionsEE4InitEPNS0_13KernelContextERKNS0_14KernelInitArgsE to i64), i64 0>, ptr %.sroa.4.0..sroa_idx, align 8, !tbaa !40
...
end_hunk_2
begin_hunk_3_@_ZN5arrow7compute8internal23RegisterVectorSelectionEPNS0_16FunctionRegistryE:bb.a
  store i32 1, ptr %i.cy, align 4, !tbaa !68
  %i.cz = getelementptr inbounds nuw i8, ptr %26, i64 128
  store i8 1, ptr %i.cz, align 8, !tbaa !69
  %i.da = getelementptr inbounds nuw i8, ptr %26, i64 129
  %i.db = getelementptr inbounds nuw i8, ptr %26, i64 130
  store i8 1, ptr %i.db, align 2, !tbaa !71
  %.sroa.4319.0..sroa_idx = getelementptr inbounds nuw i8, ptr %26, i64 16
  store <2 x i64> <i64 ptrtoint (ptr @_ZN5arrow7compute8internal14OptionsWrapperINS0_11TakeOptionsEE4InitEPNS0_13KernelContextERKNS0_14KernelInitArgsE to i64), i64 0>, ptr %.sroa.4319.0..sroa_idx, align 8, !tbaa !40
  ...
  store i8 0, ptr %i.da, align 1, !tbaa !70
