...
begin_hunk_0_@_ZN5arrow8internal29MakeSparseCOOTensorFromTensorERKNS_6TensorERKSt10shared_ptrINS_8DataTypeEEPNS_10MemoryPoolEPS4_INS_11SparseIndexEEPS4_INS_6BufferEE:bb.a
  ...
  %i.by = sext i32 %i.z to i64                    ; 21 uses
...
.lr.ph.i.i.i.i.i.preheader.us.preheader.i:        ; preds = %.lr.ph.i
  %i.dl = and i64 %i.by, -4
  %scevgep.i.a = getelementptr i8, ptr %i.cx, i64 %i.dl
  %i.dm = and i64 %i.by, 3
...
.lr.ph.i.i.i.i.i.preheader.us.i:                  ; preds = %.thread.us.i, %.lr.ph.i.i.i.i.i.preheader.us.preheader.i
  %indvars.iv.i = phi ptr [ %scevgep.i.a, %.lr.ph.i.i.i.i.i.preheader.us.preheader.i ], [ %scevgep423.i, %.thread.us.i ] ; 5 uses
...
.lr.ph.i.i.i.i.i.us.i:                            ; preds = %bb.ag, %.lr.ph.i.i.i.i.i.preheader.us.i
  ...
  %.02946.i.i.i.i.i.us.i = phi ptr [ %i.dv, %bb.ag ], [ %.0240353.us.i, %.lr.ph.i.i.i.i.i.preheader.us.i ] ; 10 uses
...
bb.ai:                                            ; preds = %bb.ah
  %i.dz = getelementptr inbounds nuw i8, ptr %.02946.i.i.i.i.i.us.i, i64 5
  br label %bb.aj
