...
mi_os_prim_alloc_aligned.exit.thread:             ; preds = %bb.z, %bb.y, %bb.w, %.thread118.i, %_mi_align_up.exit, %mi_os_prim_alloc_aligned.exit, %mi_os_prim_alloc_aligned.exit.thread27
  %.0 = phi ptr [ %.2.i31, %mi_os_prim_alloc_aligned.exit.thread27 ], [ null, %mi_os_prim_alloc_aligned.exit ], [ null, %_mi_align_up.exit ], [ null, %.thread118.i ], [ null, %bb.w ], [ null, %bb.y ], [ null, %bb.z ]
