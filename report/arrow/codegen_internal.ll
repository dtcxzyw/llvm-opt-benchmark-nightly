...
bb.aq:                                            ; preds = %.thread212
  ...
  %6 = load <2 x ptr>, ptr %i.cx, align 8, !tbaa !38, !noalias !226 ; 3 uses
  %7 = extractelement <2 x ptr> %6, i64 1         ; 10 uses
...
.lr.ph179:                                        ; preds = %bb.aq
  %.not.i.i.i94 = icmp eq ptr %7, null
...
bb.as:                                            ; preds = %bb.ar
  ...
  %i.dd = getelementptr inbounds nuw i8, ptr %7, i64 12
  store i32 0, ptr %i.dd, align 4, !tbaa !63
  %i.de = load ptr, ptr %7, align 8, !tbaa !64
  %i.df = getelementptr inbounds nuw i8, ptr %i.de, i64 16
  %i.dg = load ptr, ptr %i.df, align 8
  call void %i.dg(ptr noundef nonnull align 8 dereferenceable(16) %7) #26, !inline_history !142
  %i.dh = load ptr, ptr %7, align 8, !tbaa !64
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 24
  %i.dj = load ptr, ptr %i.di, align 8
  call void %i.dj(ptr noundef nonnull align 8 dereferenceable(16) %7) #26, !inline_history !142
...
_ZNSt10shared_ptrIN5arrow8DataTypeEEC2ERKS2_.exit96: ; preds = %bb.ax, %bb.az, %bb.ba
  store ptr %8, ptr %.0177, align 8, !tbaa !113
  %i.ds = getelementptr inbounds nuw i8, ptr %.0177, i64 8
  %i.dt = getelementptr inbounds nuw i8, ptr %.0177, i64 16
  %i.du = load ptr, ptr %i.dt, align 8, !tbaa !34 ; 8 uses
  store <2 x ptr> %6, ptr %i.ds, align 8, !tbaa !38
