...
begin_hunk_0_@_ZNSt6vectorISt10shared_ptrIN5arrow8DataTypeEESaIS3_EEC2ESt16initializer_listIS3_ERKS4_:_ZNSt6vectorISt10shared_ptrIN5arrow8DataTypeEESaIS3_EE17_S_check_init_lenEmRKS4_.exit.i
...
end_hunk_0
begin_hunk_1_@_ZNSt6vectorISt10shared_ptrIN5arrow8DataTypeEESaIS3_EEC2ESt16initializer_listIS3_ERKS4_:_ZNSt6vectorISt10shared_ptrIN5arrow8DataTypeEESaIS3_EE17_S_check_init_lenEmRKS4_.exit.i
...
.lr.ph.i.i.i.i.preheader.i:                       ; preds = %_ZNSt6vectorISt10shared_ptrIN5arrow8DataTypeEESaIS3_EE17_S_check_init_lenEmRKS4_.exit.i
  %4 = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %.idx6) #28
          to label %.lr.ph.i.i.i.i.preheader.i.a unwind label %5 ; 3 uses

.lr.ph.i.i.i.i.preheader.i.a:                     ; preds = %.lr.ph.i.i.i.i.preheader.i
  store ptr %4, ptr %0, align 8, !tbaa !53
  %i.d = getelementptr inbounds nuw i8, ptr %4, i64 %.idx6
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 16
end_hunk_1
begin_hunk_2_@_ZNSt6vectorISt10shared_ptrIN5arrow8DataTypeEESaIS3_EEC2ESt16initializer_listIS3_ERKS4_:_ZNSt6vectorISt10shared_ptrIN5arrow8DataTypeEESaIS3_EE17_S_check_init_lenEmRKS4_.exit.i
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 8
  store ptr %.0.lcssa.i.i.i.i.i, ptr %i.p, align 8, !tbaa !56
  ret void

5:                                                ; preds = %.lr.ph.i.i.i.i.preheader.i
  %6 = landingpad { ptr, i32 }
          cleanup
  %7 = load ptr, ptr %0, align 8, !tbaa !53       ; 3 uses
  %.not.i.i4 = icmp eq ptr %7, null
  br i1 %.not.i.i4, label %_ZNSt12_Vector_baseISt10shared_ptrIN5arrow8DataTypeEESaIS3_EED2Ev.exit, label %8
...
_ZNSt12_Vector_baseISt10shared_ptrIN5arrow8DataTypeEESaIS3_EED2Ev.exit: ; preds = %5, %8
  resume { ptr, i32 } %6
}
...
5:                                                ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit
  %6 = load ptr, ptr %0, align 8, !tbaa !44       ; 2 uses
  %cond30 = icmp eq i64 %1, 1
  br i1 %cond30, label %bb.i, label %bb.j

bb.i:                                             ; preds = %5
  %i.t = load i8, ptr %6, align 1, !tbaa !39
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i
  %8 = load i64, ptr %i.h, align 8, !tbaa !39
  %i.ad = add i64 %8, 1
  tail call void @_ZdlPvm(ptr noundef %.pre, i64 noundef %i.ad) #26
