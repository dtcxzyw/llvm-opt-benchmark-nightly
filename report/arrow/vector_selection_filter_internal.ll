...
bb.ig:                                            ; preds = %bb.ie
  ...
  br i1 %.not.i.i.i141.i, label %bb.ii, label %bb.ih
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i142.i: ; preds = %bb.ii, %bb.ih
  %.0.i.i.i.i143.i = phi i32 [ %i.yh, %bb.ih ], [ %i.yr, %bb.ii ]
  %i.ys = icmp eq i32 %.0.i.i.i.i143.i, 1
  br i1 %i.ys, label %bb.ij, label %_ZNSt12__shared_ptrIN5arrow5ArrayELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i112, !prof !66

bb.ij:                                            ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i142.i
...
_ZNSt12__shared_ptrIN5arrow5ArrayELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i112: ; preds = %bb.ij, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i142.i, %bb.if, %_ZNSt6vectorISt10shared_ptrIN5arrow5ArrayEESaIS3_EE9push_backEOS3_.exit.i
...
bb.im:                                            ; preds = %bb.il, %bb.ik
  %.pn.i = phi { ptr, i32 } [ %i.yu, %bb.il ], [ %i.yt, %bb.ik ]
  call void @llvm.lifetime.end.p0(ptr nonnull %17) #26, !noalias !901
  br label %bb.na

bb.in:                                            ; preds = %._crit_edge.i
  %.not.i.i.i144.i = icmp eq i8 %i.wp, 3
  br i1 %.not.i.i.i144.i, label %_ZNK5arrow5Datum13chunked_arrayEv.exit.i84, label %bb.io
...
bb.io:                                            ; preds = %bb.in
  ...
  invoke void @__cxa_throw(ptr nonnull %i.yv, ptr nonnull @_ZTISt18bad_variant_access, ptr nonnull @_ZNSt9exceptionD2Ev) #28
          to label %.noexc145.i unwind label %bb.ip

.noexc145.i:                                      ; preds = %bb.io
  unreachable

_ZNK5arrow5Datum13chunked_arrayEv.exit.i84:       ; preds = %bb.in
  ...
  %i.za = invoke noundef nonnull align 8 dereferenceable(24) ptr @_ZNSt6vectorISt10shared_ptrIN5arrow5ArrayEESaIS3_EEaSERKS5_(ptr noundef nonnull align 8 dereferenceable(24) %i.yz, ptr noundef nonnull align 8 dereferenceable(24) %i.yx)
          to label %bb.iu unwind label %bb.ip     ; 0 uses

bb.ip:                                            ; preds = %_ZNK5arrow5Datum13chunked_arrayEv.exit.i84, %bb.io
  %i.zb = landingpad { ptr, i32 }
          cleanup
  br label %bb.na

bb.iq:                                            ; preds = %._crit_edge.i
  ...
  invoke void @_ZN5arrow6Status8FromArgsIJRA28_KcEEES0_NS_10StatusCodeEDpOT_(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Status") align 8 %18, i8 noundef signext 3, ptr noundef nonnull align 1 dereferenceable(28) @.str.11)
          to label %_ZN5arrow6Status9TypeErrorIJRA28_KcEEES0_DpOT_.exit.i113 unwind label %bb.it

_ZN5arrow6Status9TypeErrorIJRA28_KcEEES0_DpOT_.exit.i113: ; preds = %bb.iq
  ...
  br i1 %.not.i147.i, label %_ZN5arrow6StatusD2Ev.exit148.i, label %bb.ir, !prof !132

bb.ir:                                            ; preds = %_ZN5arrow6Status9TypeErrorIJRA28_KcEEES0_DpOT_.exit.i113
  ...
  br i1 %i.zf, label %_ZN5arrow6StatusD2Ev.exit148.i, label %bb.is
...
_ZN5arrow6StatusD2Ev.exit148.i:                   ; preds = %bb.is, %bb.ir, %_ZN5arrow6Status9TypeErrorIJRA28_KcEEES0_DpOT_.exit.i113
...
bb.iu:                                            ; preds = %_ZNK5arrow5Datum13chunked_arrayEv.exit.i84, %_ZNSt12__shared_ptrIN5arrow5ArrayELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i112
...
bb.iv:                                            ; preds = %bb.iu
  ...
  br i1 %i.aab, label %bb.iw, label %_ZNSt6vectorIS_ISt10shared_ptrIN5arrow5ArrayEESaIS3_EESaIS5_EE17_S_check_init_lenEmRKS6_.exit.i149.i

bb.iw:                                            ; preds = %bb.iv
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.9) #28
          to label %.noexc156.i unwind label %bb.iz

.noexc156.i:                                      ; preds = %bb.iw
  unreachable

_ZNSt6vectorIS_ISt10shared_ptrIN5arrow5ArrayEESaIS3_EESaIS5_EE17_S_check_init_lenEmRKS6_.exit.i149.i: ; preds = %bb.iv
...
.lr.ph.preheader.i.i.i.i.i151.i:                  ; preds = %_ZNSt6vectorIS_ISt10shared_ptrIN5arrow5ArrayEESaIS3_EESaIS5_EE17_S_check_init_lenEmRKS6_.exit.i149.i
  ...
  %i.aad = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.aac) #29
          to label %.noexc157.i unwind label %bb.iz ; 4 uses
...
.lr.ph295.i:                                      ; preds = %_ZNSt12_Vector_baseISt6vectorISt10shared_ptrIN5arrow5ArrayEESaIS4_EESaIS6_EEC2EmRKS7_.exit.thread.i155.i
  ...
  %wide.trip.count309.i = zext nneg i32 %i.wa to i64
  br label %bb.ja

bb.ix:                                            ; preds = %_ZN5arrow6ResultISt10shared_ptrINS_9ArrayDataEEED2Ev.exit.i97
  %i.aax = add nuw nsw i64 %.087290.i, 1          ; 2 uses
  %exitcond311.not.i = icmp eq i64 %i.aax, %i.zz
  br i1 %exitcond311.not.i, label %.thread.i, label %bb.ja, !llvm.loop !926
...
bb.iz:                                            ; preds = %.lr.ph.preheader.i.i.i.i.i151.i, %bb.iw
  %i.aaz = landingpad { ptr, i32 }
          cleanup
  br label %bb.my

bb.ja:                                            ; preds = %bb.ix, %.lr.ph295.i
  %.087290.i = phi i64 [ 0, %.lr.ph295.i ], [ %i.aax, %bb.ix ] ; 3 uses
  %.088289.i = phi i64 [ 0, %.lr.ph295.i ], [ %.492.i, %bb.ix ] ; 4 uses
  ...
  invoke void @_ZN5arrow9ArraySpan10SetMembersERKNS_9ArrayDataE(ptr noundef nonnull align 8 dereferenceable(128) %22, ptr noundef nonnull align 8 dereferenceable(120) %i.abg)
          to label %_ZN5arrow9ArraySpanC2ERKNS_9ArrayDataE.exit.i88 unwind label %bb.jb
...
_ZN5arrow9ArraySpanC2ERKNS_9ArrayDataE.exit.i88:  ; preds = %bb.ja
  ...
  invoke void @_ZN5arrow7compute8internal14GetTakeIndicesERKNS_9ArraySpanENS0_13FilterOptions21NullSelectionBehaviorEPNS_10MemoryPoolE(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Result.234") align 8 %21, ptr noundef nonnull align 8 dereferenceable(128) %22, i32 noundef %i.abi, ptr noundef %i.abj)
          to label %bb.jc unwind label %bb.jf

bb.jc:                                            ; preds = %_ZN5arrow9ArraySpanC2ERKNS_9ArrayDataE.exit.i88
...
.lr.ph.i.i.i90:                                   ; preds = %bb.jc, %.lr.ph.i.i.i90
  %.0.i2.i.i.i91 = phi ptr [ %i.abm, %.lr.ph.i.i.i90 ], [ %i.abk, %bb.jc ] ; 2 uses
...
_ZSt8_DestroyIPN5arrow9ArraySpanES1_EvT_S3_RSaIT0_E.exit.i.i.i94: ; preds = %_ZSt8_DestroyIPN5arrow9ArraySpanES1_EvT_S3_RSaIT0_E.exit.loopexit.i.i.i92, %bb.jc
  %i.abn = phi ptr [ %.pre.i.i.i93, %_ZSt8_DestroyIPN5arrow9ArraySpanES1_EvT_S3_RSaIT0_E.exit.loopexit.i.i.i92 ], [ %i.abk, %bb.jc ] ; 3 uses
  %.not.i.i.i.i160.i = icmp eq ptr %i.abn, null
  br i1 %.not.i.i.i.i160.i, label %_ZN5arrow9ArraySpanD2Ev.exit.i95, label %bb.jd

bb.jd:                                            ; preds = %_ZSt8_DestroyIPN5arrow9ArraySpanES1_EvT_S3_RSaIT0_E.exit.i.i.i94
...
_ZN5arrow9ArraySpanD2Ev.exit.i95:                 ; preds = %bb.jd, %_ZSt8_DestroyIPN5arrow9ArraySpanES1_EvT_S3_RSaIT0_E.exit.i.i.i94
  ...
  br i1 %i.abt, label %bb.jg, label %bb.je, !prof !132

bb.je:                                            ; preds = %_ZN5arrow9ArraySpanD2Ev.exit.i95
...
bb.jf:                                            ; preds = %_ZN5arrow9ArraySpanC2ERKNS_9ArrayDataE.exit.i88
...
.body.i87:                                        ; preds = %bb.jf, %bb.jb
  %.pn96.i = phi { ptr, i32 } [ %i.abu, %bb.jf ], [ %i.abh, %bb.jb ]
  call void @llvm.lifetime.end.p0(ptr nonnull %22) #26, !noalias !901
  br label %bb.mx

bb.jg:                                            ; preds = %_ZN5arrow9ArraySpanD2Ev.exit.i95
  ...
  br i1 %i.abz, label %bb.jh, label %bb.kp

bb.jh:                                            ; preds = %bb.jg
  call void @llvm.lifetime.start.p0(ptr nonnull %24) #26, !noalias !901
  %.not.i.i.i161.i = icmp eq ptr %i.abw, null
  br i1 %.not.i.i.i161.i, label %_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i103, label %bb.ji
...
bb.ji:                                            ; preds = %bb.jh
  ...
  br i1 %.not.i.i.i.i162.i, label %bb.jk, label %bb.jj
...
_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i103: ; preds = %bb.jk, %bb.jj, %bb.jh
...
bb.jl:                                            ; preds = %_ZN5arrow6ResultINS_5DatumEED2Ev.exit.i106
...
.lr.ph287.i:                                      ; preds = %_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i103, %bb.jl
  %indvars.iv306.i = phi i64 [ %indvars.iv.next307.i, %bb.jl ], [ 0, %_ZNSt12__shared_ptrIN5arrow9ArrayDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit.i103 ] ; 3 uses
  ...
  invoke void @_ZN5arrow5DatumC1ERKSt10shared_ptrINS_5ArrayEE(ptr noundef nonnull align 8 dereferenceable(24) %26, ptr noundef nonnull align 8 dereferenceable(16) %i.aci)
          to label %bb.jm unwind label %bb.jq

bb.jm:                                            ; preds = %.lr.ph287.i
  ...
  invoke void @_ZN5arrow7compute11TakeOptionsC1Eb(ptr noundef nonnull align 8 dereferenceable(17) %27, i1 noundef zeroext false)
          to label %_ZN5arrow7compute11TakeOptions13NoBoundsCheckEv.exit.i104 unwind label %bb.jr

_ZN5arrow7compute11TakeOptions13NoBoundsCheckEv.exit.i104: ; preds = %bb.jm
...
bb.jn:                                            ; preds = %_ZN5arrow7compute11TakeOptions13NoBoundsCheckEv.exit.i104
  ...
  invoke void @_ZSt10__do_visitIvZNSt8__detail9__variant16_Variant_storageILb0EJN5arrow5Datum5EmptyESt10shared_ptrINS3_6ScalarEES6_INS3_9ArrayDataEES6_INS3_12ChunkedArrayEES6_INS3_11RecordBatchEES6_INS3_5TableEEEE8_M_resetEvEUlOT_E_JRSt7variantIJS5_S8_SA_SC_SE_SG_EEEEDcOT0_DpOT1_(ptr noundef nonnull align 1 dereferenceable(1) %9, ptr noundef nonnull align 8 dereferenceable(24) %26)
          to label %_ZN5arrow5DatumD2Ev.exit.i unwind label %bb.jo
...
_ZN5arrow5DatumD2Ev.exit.i:                       ; preds = %bb.jn
  ...
  br i1 %i.acm, label %bb.jv, label %bb.jp, !prof !132

bb.jp:                                            ; preds = %_ZN5arrow5DatumD2Ev.exit.i
