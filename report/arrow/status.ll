...
.noexc.i:                                         ; preds = %bb.b
  call void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.23) #19
  unreachable
...
bb.h:                                             ; preds = %bb.g
  ...
  call void %i.w(ptr noundef nonnull align 8 dereferenceable(16) %i.o) #21, !inline_history !25
  %i.x = load ptr, ptr %i.o, align 8, !tbaa !23
  %i.y = getelementptr inbounds nuw i8, ptr %i.x, i64 24
  %i.z = load ptr, ptr %i.y, align 8
  call void %i.z(ptr noundef nonnull align 8 dereferenceable(16) %i.o) #21, !inline_history !25
...
.critedge15:                                      ; preds = %bb.a, %.critedge
  %i.c = call noalias noundef nonnull dereferenceable(56) ptr @_Znwm(i64 noundef 56) #20 ; 7 uses
...
bb.q:                                             ; preds = %bb.a, %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c, %bb.b
  %.0 = phi ptr [ @.str.18, %bb.p ], [ @.str.17, %bb.o ], [ @.str.4, %bb.b ], [ @.str.5, %bb.c ], [ @.str.6, %bb.d ], [ @.str.7, %bb.e ], [ @.str.8, %bb.f ], [ @.str.9, %bb.g ], [ @.str.10, %bb.h ], [ @.str.11, %bb.i ], [ @.str.12, %bb.j ], [ @.str.13, %bb.k ], [ @.str.14, %bb.l ], [ @.str.15, %bb.m ], [ @.str.16, %bb.n ], [ @.str.3, %bb.a ] ; 3 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 3 uses
  store ptr %i.a, ptr %0, align 8, !tbaa !7
  %i.b = tail call noundef i64 @strlen(ptr noundef nonnull dereferenceable(1) %.0) #21 ; 8 uses
  %i.c = icmp ugt i64 %i.b, 15
  br i1 %i.c, label %bb.r, label %._crit_edge.i.i

bb.r:                                             ; preds = %bb.q
  %i.d = icmp slt i64 %i.b, 0
  br i1 %i.d, label %.noexc.i, label %bb.s
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i: ; preds = %bb.s
  %i.g = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.e) #20 ; 2 uses
  store ptr %i.g, ptr %0, align 8, !tbaa !11
  store i64 %i.b, ptr %i.a, align 8, !tbaa !16
  br label %._crit_edge.i.i

._crit_edge.i.i:                                  ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i, %bb.q
  %i.h = phi ptr [ %i.g, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i ], [ %i.a, %bb.q ] ; 3 uses
  switch i64 %i.b, label %bb.u [
    i64 1, label %bb.t
    i64 0, label %bb.v
  ]
