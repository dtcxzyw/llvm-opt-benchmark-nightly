...
begin_hunk_0_@_ZN5arrow4util8internal25ByteStreamSplitDecodeSimdIN5xsimd4avx2ELi4EEEvPKhillPh:bb.a
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  br i1 %exitcond.not.i.1, label %.preheader72.i, label %.lr.ph.i, !llvm.loop !50
...
.preheader.preheader.i:                           ; preds = %.preheader.preheader.i, %.lr.ph80.i
  ...
  br i1 %exitcond87.not.i, label %_ZN5arrow4util8internal25ByteStreamSplitDecodeSimdIN5xsimd4fma3INS3_6sse4_2EEELi4EEEvPKhillPh.exit, label %.preheader.preheader.i, !llvm.loop !51
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <8 x i8>, ptr %i.cv, align 1, !tbaa !7, !alias.scope !71
  %i.cw = getelementptr i8, ptr %i.cv, i64 %3
  %wide.load122 = load <8 x i8>, ptr %i.cw, align 1, !tbaa !7, !alias.scope !72
  %i.cx = getelementptr i8, ptr %i.cv, i64 %i.ch
  %wide.load123 = load <8 x i8>, ptr %i.cx, align 1, !tbaa !7, !alias.scope !73
  %i.cy = getelementptr i8, ptr %i.cv, i64 %i.ci
  %wide.load124 = load <8 x i8>, ptr %i.cy, align 1, !tbaa !7, !alias.scope !74
  ...
  store <8 x i32> %i.dk, ptr %i.da, align 1, !alias.scope !75, !noalias !76
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.dl = icmp eq i64 %index.next, %n.vec
  br i1 %i.dl, label %middle.block, label %vector.body, !llvm.loop !58
...
.lr.ph.prol:                                      ; preds = %.lr.ph.preheader166
  ...
  %i.dr = shl nuw nsw i64 %.05979.ph, 2
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  br i1 %exitcond.not.1, label %.preheader76, label %.lr.ph, !llvm.loop !59
...
.preheader.preheader:                             ; preds = %.lr.ph85, %.preheader.preheader
  ...
  %i.en = load <32 x i8>, ptr %i.em, align 1, !tbaa !7, !noalias !77 ; 2 uses
  %i.eo = getelementptr i8, ptr %i.em, i64 %3
  %i.ep = load <32 x i8>, ptr %i.eo, align 1, !tbaa !7, !noalias !77 ; 2 uses
  %i.eq = getelementptr i8, ptr %i.em, i64 %i.dv
  %i.er = load <32 x i8>, ptr %i.eq, align 1, !tbaa !7, !noalias !77 ; 2 uses
  %i.es = getelementptr i8, ptr %i.em, i64 %i.dw
  %i.et = load <32 x i8>, ptr %i.es, align 1, !tbaa !7, !noalias !77 ; 2 uses
  ...
  br i1 %exitcond93.not, label %_ZN5arrow4util8internal25ByteStreamSplitDecodeSimdIN5xsimd4fma3INS3_6sse4_2EEELi4EEEvPKhillPh.exit, label %.preheader.preheader, !llvm.loop !64
...
vector.body211:                                   ; preds = %vector.body211, %vector.ph209
  ...
  %wide.load213 = load <4 x i8>, ptr %i.ae, align 1, !tbaa !7, !alias.scope !108
  %i.af = getelementptr i8, ptr %i.ae, i64 %3
  %wide.load214 = load <4 x i8>, ptr %i.af, align 1, !tbaa !7, !alias.scope !109
  %i.ag = getelementptr i8, ptr %i.ae, i64 %i.e
  %wide.load215 = load <4 x i8>, ptr %i.ag, align 1, !tbaa !7, !alias.scope !110
  %i.ah = getelementptr i8, ptr %i.ae, i64 %i.f
  %wide.load216 = load <4 x i8>, ptr %i.ah, align 1, !tbaa !7, !alias.scope !111
  %i.ai = getelementptr i8, ptr %i.ae, i64 %i.g
  %wide.load217 = load <4 x i8>, ptr %i.ai, align 1, !tbaa !7, !alias.scope !112
  %i.aj = getelementptr i8, ptr %i.ae, i64 %i.h
  %wide.load218 = load <4 x i8>, ptr %i.aj, align 1, !tbaa !7, !alias.scope !113
  %i.ak = getelementptr i8, ptr %i.ae, i64 %i.i
  %wide.load219 = load <4 x i8>, ptr %i.ak, align 1, !tbaa !7, !alias.scope !114
  %i.al = getelementptr i8, ptr %i.ae, i64 %i.j
  %wide.load220 = load <4 x i8>, ptr %i.al, align 1, !tbaa !7, !alias.scope !115
...
end_hunk_0
begin_hunk_1_@_ZN5arrow4util8internal25ByteStreamSplitDecodeSimdIN5xsimd4avx2ELi8EEEvPKhillPh:bb.a
  ...
  br i1 %exitcond.not.i, label %.preheader72.i, label %.lr.ph.i, !llvm.loop !89
...
.preheader.preheader.i:                           ; preds = %.preheader.preheader.i, %.lr.ph80.i
  ...
  br i1 %exitcond89.not.i, label %_ZN5arrow4util8internal25ByteStreamSplitDecodeSimdIN5xsimd4fma3INS3_6sse4_2EEELi8EEEvPKhillPh.exit, label %.preheader.preheader.i, !llvm.loop !90
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i8>, ptr %i.ez, align 1, !tbaa !7, !alias.scope !118
  %i.fa = getelementptr i8, ptr %i.ez, i64 %3
  %wide.load150 = load <4 x i8>, ptr %i.fa, align 1, !tbaa !7, !alias.scope !119
  %i.fb = getelementptr i8, ptr %i.ez, i64 %i.dz
  %wide.load151 = load <4 x i8>, ptr %i.fb, align 1, !tbaa !7, !alias.scope !120
  %i.fc = getelementptr i8, ptr %i.ez, i64 %i.ea
  %wide.load152 = load <4 x i8>, ptr %i.fc, align 1, !tbaa !7, !alias.scope !121
  %i.fd = getelementptr i8, ptr %i.ez, i64 %i.eb
  %wide.load153 = load <4 x i8>, ptr %i.fd, align 1, !tbaa !7, !alias.scope !122
  %i.fe = getelementptr i8, ptr %i.ez, i64 %i.ec
  %wide.load154 = load <4 x i8>, ptr %i.fe, align 1, !tbaa !7, !alias.scope !123
  %i.ff = getelementptr i8, ptr %i.ez, i64 %i.ed
  %wide.load155 = load <4 x i8>, ptr %i.ff, align 1, !tbaa !7, !alias.scope !124
  %i.fg = getelementptr i8, ptr %i.ez, i64 %i.ee
  %wide.load156 = load <4 x i8>, ptr %i.fg, align 1, !tbaa !7, !alias.scope !125
  %i.fh = shl nuw nsw i64 %i.ey, 3
  ...
  store <4 x i64> %i.ge, ptr %i.fi, align 1, !alias.scope !126, !noalias !127
...
.lr.ph:                                           ; preds = %.lr.ph.preheader226, %.lr.ph
  ...
  br i1 %exitcond.not, label %.preheader76, label %.lr.ph, !llvm.loop !102
...
.preheader.preheader:                             ; preds = %.lr.ph85, %.preheader.preheader
  ...
  %i.gz = load <32 x i8>, ptr %i.gy, align 1, !tbaa !7, !noalias !128 ; 2 uses
  %i.ha = getelementptr i8, ptr %i.gy, i64 %3
  %i.hb = load <32 x i8>, ptr %i.ha, align 1, !tbaa !7, !noalias !128 ; 2 uses
  %i.hc = getelementptr i8, ptr %i.gy, i64 %i.gg
  %i.hd = load <32 x i8>, ptr %i.hc, align 1, !tbaa !7, !noalias !128 ; 2 uses
  %i.he = getelementptr i8, ptr %i.gy, i64 %i.gh
  %i.hf = load <32 x i8>, ptr %i.he, align 1, !tbaa !7, !noalias !128 ; 2 uses
  %i.hg = getelementptr i8, ptr %i.gy, i64 %i.gi
  %i.hh = load <32 x i8>, ptr %i.hg, align 1, !tbaa !7, !noalias !128 ; 2 uses
  %i.hi = getelementptr i8, ptr %i.gy, i64 %i.gj
  %i.hj = load <32 x i8>, ptr %i.hi, align 1, !tbaa !7, !noalias !128 ; 2 uses
  %i.hk = getelementptr i8, ptr %i.gy, i64 %i.gk
  %i.hl = load <32 x i8>, ptr %i.hk, align 1, !tbaa !7, !noalias !128 ; 2 uses
  %i.hm = getelementptr i8, ptr %i.gy, i64 %i.gl
  %i.hn = load <32 x i8>, ptr %i.hm, align 1, !tbaa !7, !noalias !128 ; 2 uses
  ...
  %i.kq = shl nuw i64 %.05784, 8
  %i.kr = getelementptr i8, ptr %4, i64 %i.kq     ; 8 uses
  store <32 x i8> %i.jq, ptr %i.kr, align 1, !tbaa !7
  %.sroa.52.768..sroa_idx = getelementptr inbounds nuw i8, ptr %i.kr, i64 32
  store <8 x i32> %i.jt, ptr %.sroa.52.768..sroa_idx, align 1, !tbaa !7
  %.sroa.53.768..sroa_idx = getelementptr inbounds nuw i8, ptr %i.kr, i64 64
  store <32 x i8> %i.jy, ptr %.sroa.53.768..sroa_idx, align 1, !tbaa !7
  %.sroa.54.768..sroa_idx = getelementptr inbounds nuw i8, ptr %i.kr, i64 96
  store <8 x i32> %i.kb, ptr %.sroa.54.768..sroa_idx, align 1, !tbaa !7
  %.sroa.55.768..sroa_idx = getelementptr inbounds nuw i8, ptr %i.kr, i64 128
  store <32 x i8> %i.ke, ptr %.sroa.55.768..sroa_idx, align 1, !tbaa !7
  %.sroa.56.768..sroa_idx = getelementptr inbounds nuw i8, ptr %i.kr, i64 160
  store <8 x i32> %i.kh, ptr %.sroa.56.768..sroa_idx, align 1, !tbaa !7
  %.sroa.57.768..sroa_idx = getelementptr inbounds nuw i8, ptr %i.kr, i64 192
  store <32 x i8> %i.km, ptr %.sroa.57.768..sroa_idx, align 1, !tbaa !7
  %.sroa.58.768..sroa_idx = getelementptr inbounds nuw i8, ptr %i.kr, i64 224
  store <8 x i32> %i.kp, ptr %.sroa.58.768..sroa_idx, align 1, !tbaa !7
  %i.ks = add nuw nsw i64 %.05784, 1              ; 2 uses
  %exitcond95.not = icmp eq i64 %i.ks, %i.dw
  br i1 %exitcond95.not, label %_ZN5arrow4util8internal25ByteStreamSplitDecodeSimdIN5xsimd4fma3INS3_6sse4_2EEELi8EEEvPKhillPh.exit, label %.preheader.preheader, !llvm.loop !107
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.e, label %iter.check72, label %.preheader98.i.i

iter.check72:                                     ; preds = %bb.b
  %i.f = sub i64 %2, %i.d                         ; 6 uses
  %min.iters.check55 = icmp ult i64 %i.f, 8
  br i1 %min.iters.check55, label %.preheader99.i.i.preheader, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %iter.check72
  %i.g = xor i64 %i.d, -1
  %i.h = add i64 %2, %i.g                         ; 2 uses
  %i.i = shl i64 %i.c, 5                          ; 2 uses
  %scevgep35 = getelementptr i8, ptr %0, i64 %i.i ; 2 uses
  %mul.result = shl i64 %i.h, 1                   ; 2 uses
  %mul.overflow = icmp slt i64 %i.h, 0
  %i.j = getelementptr i8, ptr %scevgep35, i64 %mul.result
  %i.k = icmp ult ptr %i.j, %scevgep35
  %i.l = getelementptr i8, ptr %0, i64 %i.i
  %scevgep36 = getelementptr i8, ptr %i.l, i64 1  ; 2 uses
  %i.m = getelementptr i8, ptr %scevgep36, i64 %mul.result
  %i.n = icmp ult ptr %i.m, %scevgep36
  %i.o = or i1 %i.n, %mul.overflow
  %i.p = or i1 %i.k, %i.o
  br i1 %i.p, label %.preheader99.i.i.preheader, label %vector.memcheck37

vector.memcheck37:                                ; preds = %vector.scevcheck
  %scevgep38 = getelementptr i8, ptr %3, i64 %i.d ; 2 uses
  %scevgep39 = getelementptr i8, ptr %3, i64 %2   ; 2 uses
  %i.q = getelementptr i8, ptr %3, i64 %2
  %scevgep40 = getelementptr i8, ptr %i.q, i64 %i.d ; 2 uses
  %i.r = shl i64 %2, 1                            ; 2 uses
  %scevgep41 = getelementptr i8, ptr %3, i64 %i.r ; 2 uses
  %i.s = shl i64 %i.c, 5
  %scevgep42 = getelementptr i8, ptr %0, i64 %i.s ; 2 uses
  %scevgep43 = getelementptr i8, ptr %0, i64 %i.r ; 2 uses
  %bound044 = icmp ult ptr %scevgep38, %scevgep41
  %bound145 = icmp ult ptr %scevgep40, %scevgep39
