...
%"class.arrow::internal::StringStreamWrapper" = type { %"class.std::unique_ptr.19", ptr }
...
$_ZN5arrow8internal12JoinToStringIJRA23_KcRlEEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ = comdat any
...
define void @_ZN5arrow8internal11BytesToBitsENS_4util4spanIKhEEPNS_10MemoryPoolE(ptr dead_on_unwind noalias writable sret(%"class.arrow::Result") align 8 %0, ptr nofree readonly captures(none) %1, i64 %2, ptr noundef %3) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
bb.a:
  %4 = alloca %"class.arrow::Result.2", align 8   ; 12 uses
  ...
  call void @_ZN5arrow14AllocateBufferElPNS_10MemoryPoolE(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Result.2") align 8 %4, i64 noundef %i.e, ptr noundef %3)
  %i.f = load ptr, ptr %4, align 8, !tbaa !7
  %i.g = icmp eq ptr %i.f, null
  br i1 %i.g, label %bb.c, label %bb.b, !prof !11

bb.b:                                             ; preds = %bb.a
  call void @_ZN5arrow6ResultISt10shared_ptrINS_6BufferEEEC2ERKNS_6StatusE(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr noundef nonnull align 8 dereferenceable(8) %4) #18
  br label %bb.g
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.i = load i64, ptr %i.h, align 8, !tbaa !18, !noalias !20 ; 2 uses
  store i64 %i.i, ptr %5, align 8, !tbaa !18, !alias.scope !20
  store ptr null, ptr %i.h, align 8, !tbaa !18, !noalias !20
  %.cast = inttoptr i64 %i.i to ptr               ; 4 uses
  %i.j = getelementptr inbounds nuw i8, ptr %.cast, i64 9
  %i.k = load i8, ptr %i.j, align 1, !tbaa !21, !range !34, !noundef !35
  %i.l = trunc nuw i8 %i.k to i1
  %i.m = getelementptr inbounds nuw i8, ptr %.cast, i64 8
  %i.n = load i8, ptr %i.m, align 8, !range !34
  %i.o = trunc nuw i8 %i.n to i1
  %i.p = select i1 %i.l, i1 %i.o, i1 false, !prof !11
  %i.q = getelementptr inbounds nuw i8, ptr %.cast, i64 16
  %i.r = load ptr, ptr %i.q, align 8
  %i.s = select i1 %i.p, ptr %i.r, ptr null, !prof !11 ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %.cast, i64 32
...
bb.d:                                             ; preds = %.lr.ph.i.a
  %i.x = srem i64 %.04.i, 8
  %i.y = getelementptr inbounds i8, ptr @_ZN5arrow8bit_utilL8kBitmaskE, i64 %i.x
  %i.z = load i8, ptr %i.y, align 1, !tbaa !37
  %i.aa = sdiv i64 %.04.i, 8
  %i.ab = getelementptr inbounds i8, ptr %i.s, i64 %i.aa ; 2 uses
  %i.ac = load i8, ptr %i.ab, align 1, !tbaa !37
  %i.ad = or i8 %i.ac, %i.z
  store i8 %i.ad, ptr %i.ab, align 1, !tbaa !37
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %.lr.ph.i.a
  %i.ae = add nuw i64 %.04.i, 1                   ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.ae, %2
  br i1 %exitcond.not.i, label %_ZN5arrow8internal12_GLOBAL__N_117FillBitsFromBytesENS_4util4spanIKhEEPh.exit, label %.lr.ph.i.a, !llvm.loop !38

_ZN5arrow8internal12_GLOBAL__N_117FillBitsFromBytesENS_4util4spanIKhEEPh.exit: ; preds = %bb.e, %bb.c
...
_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit: ; preds = %_ZN5arrow8internal12_GLOBAL__N_117FillBitsFromBytesENS_4util4spanIKhEEPh.exit
  ...
  %i.ag = load <2 x ptr>, ptr %6, align 16, !tbaa !40
  store <2 x ptr> %i.ag, ptr %i.af, align 8, !tbaa !40
...
_ZNKSt14default_deleteIN5arrow6BufferEEclEPS1_.exit.i: ; preds = %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit
  ...
  call void %i.ak(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.ah) #18, !inline_history !43
...
bb.f:                                             ; preds = %_ZN5arrow8internal12_GLOBAL__N_117FillBitsFromBytesENS_4util4spanIKhEEPh.exit
  %i.al = landingpad { ptr, i32 }
          cleanup
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #18
  %i.am = load ptr, ptr %5, align 8, !tbaa !18    ; 3 uses
...
_ZNKSt14default_deleteIN5arrow6BufferEEclEPS1_.exit.i16: ; preds = %bb.f
  %i.an = load ptr, ptr %i.am, align 8, !tbaa !41
  %i.ao = getelementptr inbounds nuw i8, ptr %i.an, i64 8
  %i.ap = load ptr, ptr %i.ao, align 8
  call void %i.ap(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.am) #18, !inline_history !43
  br label %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit17

_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit17: ; preds = %_ZNKSt14default_deleteIN5arrow6BufferEEclEPS1_.exit.i16, %bb.f
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #18
  call void @_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %4) #18
...
bb.g:                                             ; preds = %_ZNSt10unique_ptrIN5arrow6BufferESt14default_deleteIS1_EED2Ev.exit, %bb.b
  ...
  br i1 %i.ar, label %bb.h, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i, !prof !11
...
_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i: ; preds = %bb.h
  ...
  call void %i.aw(ptr noundef nonnull align 8 dead_on_return(80) dereferenceable(80) %i.at) #18, !inline_history !44
  %.pr.pre.i = load ptr, ptr %4, align 8, !tbaa !7 ; 2 uses
  %.not.i.i18 = icmp eq ptr %.pr.pre.i, null
  br i1 %.not.i.i18, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i, !prof !45
...
_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.thread.i: ; preds = %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i, %bb.g
  %i.ax = phi ptr [ %.pr.pre.i, %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEE7DestroyEv.exit.i ], [ %i.aq, %bb.g ]
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 1
  %i.az = load i8, ptr %i.ay, align 1, !tbaa !46, !range !34, !noundef !35
  %i.ba = trunc nuw i8 %i.az to i1
  br i1 %i.ba, label %_ZN5arrow6ResultISt10unique_ptrINS_6BufferESt14default_deleteIS2_EEED2Ev.exit, label %bb.i
...
_ZN5arrow6StatusC2ERKS0_.exit:                    ; preds = %bb.a
  ...
  br i1 %i.b, label %bb.b, label %bb.g, !prof !54
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.f, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  %i.h = load ptr, ptr %5, align 8, !tbaa !55     ; 2 uses
  %i.i = getelementptr inbounds nuw i8, ptr %5, i64 16 ; 2 uses
  %i.j = icmp eq ptr %i.h, %i.i
  br i1 %i.j, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit6, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i4

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i4: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %i.k = load i64, ptr %i.i, align 8, !tbaa !37
  %i.l = add i64 %i.k, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit6: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i4
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #18
  %i.m = load ptr, ptr %3, align 8, !tbaa !55     ; 2 uses
