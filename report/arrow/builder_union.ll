...
begin_hunk_0_@_ZNSt6vectorISt10shared_ptrIN5arrow6BufferEESaIS3_EE17_M_default_appendEm:bb.a
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.ax, label %middle.block, label %vector.body, !llvm.loop !380
...
_ZSt24__uninitialized_fill_n_aIPimiiET_S1_T0_RKT1_RSaIT2_E.exit: ; preds = %.lr.ph.i.i.i.i.i.i.i, %middle.block, %bb.l
  ...
  br i1 %i.az, label %bb.n, label %bb.o, !prof !118
...
_ZSt22__uninitialized_move_aIPiS0_SaIiEET0_T_S3_S2_RT1_.exit69: ; preds = %bb.p, %bb.o, %bb.n
  ...
  store ptr %i.bd, ptr %i.c, align 8, !tbaa !167
...
vector.body119:                                   ; preds = %vector.body119, %vector.ph114
  ...
  br i1 %i.bk, label %middle.block123, label %vector.body119, !llvm.loop !382
...
bb.q:                                             ; preds = %bb.b
  %i.bm = load ptr, ptr %0, align 8, !tbaa !103   ; 5 uses
...
bb.s:                                             ; preds = %_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit
  ...
  %i.bz = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.by) #18
  br label %bb.t
...
vector.body147:                                   ; preds = %vector.body147, %vector.ph142
  ...
  br i1 %i.cl, label %middle.block151, label %vector.body147, !llvm.loop !384
...
_ZSt24__uninitialized_fill_n_aIPimiiET_S1_T0_RKT1_RSaIT2_E.exit80: ; preds = %.lr.ph.i.i.i.i.i.i.i76, %middle.block151
  ...
  br i1 %i.cn, label %bb.u, label %bb.v, !prof !118
...
_ZSt34__uninitialized_move_if_noexcept_aIPiS0_SaIiEET0_T_S3_S2_RT1_.exit: ; preds = %bb.w, %bb.v, %bb.u
  ...
  br i1 %i.cs, label %bb.x, label %bb.y, !prof !118
...
_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim.exit: ; preds = %bb.aa, %bb.ab
  store ptr %i.ca, ptr %0, align 8, !tbaa !103
  store ptr %i.cv, ptr %i.c, align 8, !tbaa !167
  %i.cx = getelementptr inbounds nuw [4 x i8], ptr %i.ca, i64 %i.bv
  store ptr %i.cx, ptr %i.a, align 8, !tbaa !175
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <2 x ptr> %broadcast.splat, ptr %i.aw, align 8, !tbaa !110
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ax = icmp eq i64 %index.next, %n.vec
  br i1 %i.ax, label %middle.block, label %vector.body, !llvm.loop !388
...
bb.o:                                             ; preds = %_ZSt24__uninitialized_fill_n_aIPPN5arrow12ArrayBuilderEmS2_S2_ET_S4_T0_RKT1_RSaIT2_E.exit
  ...
  br i1 %i.ba, label %bb.p, label %_ZSt22__uninitialized_move_aIPPN5arrow12ArrayBuilderES3_SaIS2_EET0_T_S6_S5_RT1_.exit69

bb.p:                                             ; preds = %bb.o
  %i.bb = load ptr, ptr %1, align 8, !tbaa !110
  store ptr %i.bb, ptr %.0.i.i.i.i.i, align 8, !tbaa !110
  br label %_ZSt22__uninitialized_move_aIPPN5arrow12ArrayBuilderES3_SaIS2_EET0_T_S6_S5_RT1_.exit69

_ZSt22__uninitialized_move_aIPPN5arrow12ArrayBuilderES3_SaIS2_EET0_T_S6_S5_RT1_.exit69: ; preds = %bb.p, %bb.o, %bb.n
  %i.bc = phi ptr [ %.0.i.i.i.i.i, %bb.p ], [ %.0.i.i.i.i.i, %bb.o ], [ %.pre, %bb.n ]
  %i.bd = getelementptr inbounds nuw i8, ptr %i.bc, i64 %i.k
  store ptr %i.bd, ptr %i.c, align 8, !tbaa !168
...
vector.body119:                                   ; preds = %vector.body119, %vector.ph114
  ...
  store <2 x ptr> %broadcast.splat118, ptr %i.bj, align 8, !tbaa !110
  %index.next122 = add nuw i64 %index120, 4       ; 2 uses
  %i.bk = icmp eq i64 %index.next122, %n.vec116
  br i1 %i.bk, label %middle.block123, label %vector.body119, !llvm.loop !390
...
bb.q:                                             ; preds = %bb.b
  %i.bm = load ptr, ptr %0, align 8, !tbaa !106   ; 5 uses
  %i.bn = ptrtoint ptr %i.bm to i64               ; 3 uses
  %i.bo = sub i64 %i.f, %i.bn
  %i.bp = ashr exact i64 %i.bo, 3                 ; 4 uses
  %i.bq = sub nsw i64 1152921504606846975, %i.bp
  %i.br = icmp ult i64 %i.bq, %2
  br i1 %i.br, label %bb.r, label %_ZNKSt6vectorIPN5arrow12ArrayBuilderESaIS2_EE12_M_check_lenEmPKc.exit
...
bb.t:                                             ; preds = %bb.s, %_ZNKSt6vectorIPN5arrow12ArrayBuilderESaIS2_EE12_M_check_lenEmPKc.exit
  %i.ca = phi ptr [ %i.bz, %bb.s ], [ null, %_ZNKSt6vectorIPN5arrow12ArrayBuilderESaIS2_EE12_M_check_lenEmPKc.exit ] ; 5 uses
  %i.cb = getelementptr inbounds i8, ptr %i.ca, i64 %i.bx ; 5 uses
  %.idx.i.i.i.i.i75 = shl nuw nsw i64 %2, 3       ; 2 uses
  %i.cc = getelementptr inbounds nuw i8, ptr %i.cb, i64 %.idx.i.i.i.i.i75
  %i.cd = load ptr, ptr %3, align 8, !tbaa !110   ; 2 uses
...
vector.body147:                                   ; preds = %vector.body147, %vector.ph142
  ...
  store <2 x ptr> %broadcast.splat146, ptr %i.ck, align 8, !tbaa !110
  %index.next150 = add nuw i64 %index148, 4       ; 2 uses
  %i.cl = icmp eq i64 %index.next150, %n.vec144
  br i1 %i.cl, label %middle.block151, label %vector.body147, !llvm.loop !392
...
.lr.ph.i.i.i.i.i.i.i76:                           ; preds = %.lr.ph.i.i.i.i.i.i.i76.preheader, %.lr.ph.i.i.i.i.i.i.i76
  ...
  store ptr %i.cd, ptr %.07.i.i.i.i.i.i.i77, align 8, !tbaa !110
...
bb.v:                                             ; preds = %_ZSt24__uninitialized_fill_n_aIPPN5arrow12ArrayBuilderEmS2_S2_ET_S4_T0_RKT1_RSaIT2_E.exit80
  ...
  br i1 %i.co, label %bb.w, label %_ZSt34__uninitialized_move_if_noexcept_aIPPN5arrow12ArrayBuilderES3_SaIS2_EET0_T_S6_S5_RT1_.exit

bb.w:                                             ; preds = %bb.v
  %i.cp = load ptr, ptr %i.bm, align 8, !tbaa !110
  store ptr %i.cp, ptr %i.ca, align 8, !tbaa !110
  br label %_ZSt34__uninitialized_move_if_noexcept_aIPPN5arrow12ArrayBuilderES3_SaIS2_EET0_T_S6_S5_RT1_.exit
...
bb.z:                                             ; preds = %bb.y
  %i.cu = load ptr, ptr %1, align 8, !tbaa !110
  store ptr %i.cu, ptr %i.cq, align 8, !tbaa !110
  br label %bb.aa
...
_ZNSt12_Vector_baseIPN5arrow12ArrayBuilderESaIS2_EE13_M_deallocateEPS2_m.exit: ; preds = %bb.aa, %bb.ab
  store ptr %i.ca, ptr %0, align 8, !tbaa !106
  store ptr %i.cv, ptr %i.c, align 8, !tbaa !168
  %i.cx = getelementptr inbounds nuw [8 x i8], ptr %i.ca, i64 %i.bv
  store ptr %i.cx, ptr %i.a, align 8, !tbaa !176
