...
vector.body119:                                   ; preds = %vector.body119, %vector.ph114
  ...
  br i1 %i.bm, label %middle.block123, label %vector.body119, !llvm.loop !382
...
bb.q:                                             ; preds = %bb.b
  %i.bo = load ptr, ptr %0, align 8, !tbaa !103   ; 5 uses
...
bb.s:                                             ; preds = %_ZNKSt6vectorIiSaIiEE12_M_check_lenEmPKc.exit
  ...
  %i.cb = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ca) #18
  br label %bb.t
...
vector.body147:                                   ; preds = %vector.body147, %vector.ph142
  ...
  br i1 %i.cn, label %middle.block151, label %vector.body147, !llvm.loop !384
...
bb.ab:                                            ; preds = %bb.aa
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.bo, i64 noundef %i.cy) #19
  br label %_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim.exit

_ZNSt12_Vector_baseIiSaIiEE13_M_deallocateEPim.exit: ; preds = %bb.aa, %bb.ab
  store ptr %i.cc, ptr %0, align 8, !tbaa !103
  store ptr %i.cx, ptr %i.c, align 8, !tbaa !167
  %i.cz = getelementptr inbounds nuw [4 x i8], ptr %i.cc, i64 %i.bx
  store ptr %i.cz, ptr %i.a, align 8, !tbaa !175
...
vector.body119:                                   ; preds = %vector.body119, %vector.ph114
  ...
  store <2 x ptr> %broadcast.splat118, ptr %i.bl, align 8, !tbaa !110
  %index.next122 = add nuw i64 %index120, 4       ; 2 uses
  %i.bm = icmp eq i64 %index.next122, %n.vec116
  br i1 %i.bm, label %middle.block123, label %vector.body119, !llvm.loop !390
...
.lr.ph.i.i.i71:                                   ; preds = %.lr.ph.i.i.i71.preheader154, %.lr.ph.i.i.i71
  ...
  %i.bn = getelementptr inbounds nuw i8, ptr %.07.i.i.i72, i64 8 ; 2 uses
  %.not.i.i.i73 = icmp eq ptr %i.bn, %i.d
  br i1 %.not.i.i.i73, label %_ZSt4fillIPPN5arrow12ArrayBuilderES2_EvT_S4_RKT0_.exit, label %.lr.ph.i.i.i71, !llvm.loop !391

bb.q:                                             ; preds = %bb.b
  %i.bo = load ptr, ptr %0, align 8, !tbaa !106   ; 5 uses
  %i.bp = ptrtoint ptr %i.bo to i64               ; 3 uses
  %i.bq = sub i64 %i.f, %i.bp
  %i.br = ashr exact i64 %i.bq, 3                 ; 4 uses
  %i.bs = sub nsw i64 1152921504606846975, %i.br
  %i.bt = icmp ult i64 %i.bs, %2
  br i1 %i.bt, label %bb.r, label %_ZNKSt6vectorIPN5arrow12ArrayBuilderESaIS2_EE12_M_check_lenEmPKc.exit
...
bb.t:                                             ; preds = %bb.s, %_ZNKSt6vectorIPN5arrow12ArrayBuilderESaIS2_EE12_M_check_lenEmPKc.exit
  %i.cc = phi ptr [ %i.cb, %bb.s ], [ null, %_ZNKSt6vectorIPN5arrow12ArrayBuilderESaIS2_EE12_M_check_lenEmPKc.exit ] ; 5 uses
  %i.cd = getelementptr inbounds i8, ptr %i.cc, i64 %i.bz ; 5 uses
  %.idx.i.i.i.i.i75 = shl nuw nsw i64 %2, 3       ; 2 uses
  %i.ce = getelementptr inbounds nuw i8, ptr %i.cd, i64 %.idx.i.i.i.i.i75
  %i.cf = load ptr, ptr %3, align 8, !tbaa !110   ; 2 uses
...
vector.ph142:                                     ; preds = %bb.t
  ...
  %i.ck = getelementptr i8, ptr %i.cd, i64 %i.cj
  %broadcast.splatinsert145 = insertelement <2 x ptr> poison, ptr %i.cf, i64 0
...
vector.body147:                                   ; preds = %vector.body147, %vector.ph142
  ...
  store <2 x ptr> %broadcast.splat146, ptr %i.cm, align 8, !tbaa !110
  %index.next150 = add nuw i64 %index148, 4       ; 2 uses
  %i.cn = icmp eq i64 %index.next150, %n.vec144
  br i1 %i.cn, label %middle.block151, label %vector.body147, !llvm.loop !392
...
.lr.ph.i.i.i.i.i.i.i76:                           ; preds = %.lr.ph.i.i.i.i.i.i.i76.preheader, %.lr.ph.i.i.i.i.i.i.i76
  ...
  store ptr %i.cf, ptr %.07.i.i.i.i.i.i.i77, align 8, !tbaa !110
  %i.co = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i.i.i.i77, i64 8 ; 2 uses
  %.not.i.i.i.i.i.i.i78 = icmp eq ptr %i.co, %i.ce
...
bb.v:                                             ; preds = %_ZSt24__uninitialized_fill_n_aIPPN5arrow12ArrayBuilderEmS2_S2_ET_S4_T0_RKT1_RSaIT2_E.exit80
  ...
  br i1 %i.cq, label %bb.w, label %_ZSt34__uninitialized_move_if_noexcept_aIPPN5arrow12ArrayBuilderES3_SaIS2_EET0_T_S6_S5_RT1_.exit

bb.w:                                             ; preds = %bb.v
  %i.cr = load ptr, ptr %i.bo, align 8, !tbaa !110
  store ptr %i.cr, ptr %i.cc, align 8, !tbaa !110
  br label %_ZSt34__uninitialized_move_if_noexcept_aIPPN5arrow12ArrayBuilderES3_SaIS2_EET0_T_S6_S5_RT1_.exit
...
bb.z:                                             ; preds = %bb.y
  %i.cw = load ptr, ptr %1, align 8, !tbaa !110
  store ptr %i.cw, ptr %i.cs, align 8, !tbaa !110
  br label %bb.aa
...
_ZNSt12_Vector_baseIPN5arrow12ArrayBuilderESaIS2_EE13_M_deallocateEPS2_m.exit: ; preds = %bb.aa, %bb.ab
  store ptr %i.cc, ptr %0, align 8, !tbaa !106
  store ptr %i.cx, ptr %i.c, align 8, !tbaa !168
  %i.cz = getelementptr inbounds nuw [8 x i8], ptr %i.cc, i64 %i.bx
  store ptr %i.cz, ptr %i.a, align 8, !tbaa !176
