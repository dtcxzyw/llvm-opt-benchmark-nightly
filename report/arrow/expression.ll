...
bb.v:                                             ; preds = %.lr.ph, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit137
  %.sroa.0203.0261 = phi ptr [ %i.do, %.lr.ph ], [ %i.eh, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit137 ] ; 2 uses
  %.sroa.0200.0260 = phi ptr [ %i.dj, %.lr.ph ], [ %i.gf, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit137 ] ; 3 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #32
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #32
  call void @llvm.lifetime.start.p0(ptr nonnull %10) #32
  %i.ee = load ptr, ptr %.sroa.0200.0260, align 8, !tbaa !33, !noalias !170
  %i.ef = getelementptr inbounds nuw i8, ptr %.sroa.0200.0260, i64 8
...
bb.w:                                             ; preds = %bb.v
  ...
  %i.eh = getelementptr inbounds nuw i8, ptr %.sroa.0203.0261, i64 16
  invoke void @_ZNK5arrow7compute10Expression8ToStringB5cxx11Ev(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %11, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0203.0261)
...
begin_hunk_2_@_ZNK5arrow7compute10Expression8ToStringB5cxx11Ev:bb.a
  ...
  %i.gf = getelementptr inbounds nuw i8, ptr %.sroa.0200.0260, i64 32 ; 2 uses
...
.lr.ph:                                           ; preds = %_ZNSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_N5arrow7compute10Comparison4typeEESaISC_ENSt8__detail10_Select1stESt8equal_toIS5_ESt4hashIS5_ENSE_18_Mod_range_hashingENSE_20_Default_ranged_hashENSE_20_Prime_rehash_policyENSE_17_Hashtable_traitsILb1ELb0ELb1EEEE19_M_allocate_bucketsEm.exit, %bb.j
  %.031 = phi ptr [ %i.i, %bb.j ], [ %i.h, %_ZNSt10_HashtableINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_N5arrow7compute10Comparison4typeEESaISC_ENSt8__detail10_Select1stESt8equal_toIS5_ESt4hashIS5_ENSE_18_Mod_range_hashingENSE_20_Default_ranged_hashENSE_20_Prime_rehash_policyENSE_17_Hashtable_traitsILb1ELb0ELb1EEEE19_M_allocate_bucketsEm.exit ] ; 8 uses
  ...
  %i.i = load ptr, ptr %.031, align 8, !tbaa !423 ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph
  ...
  store ptr %i.o, ptr %.031, align 8, !tbaa !423
  store ptr %.031, ptr %i.g, align 8, !tbaa !998
  store ptr %i.g, ptr %i.m, align 8, !tbaa !430
  %i.p = load ptr, ptr %.031, align 8, !tbaa !423
  %.not28 = icmp eq ptr %i.p, null
  br i1 %.not28, label %bb.j, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.q = getelementptr inbounds nuw [8 x i8], ptr %.0.i, i64 %.02530
  store ptr %.031, ptr %i.q, align 8, !tbaa !430
  br label %bb.j

bb.i:                                             ; preds = %.lr.ph
  %i.r = load ptr, ptr %i.n, align 8, !tbaa !423
  store ptr %i.r, ptr %.031, align 8, !tbaa !423
  %i.s = load ptr, ptr %i.m, align 8, !tbaa !430
  store ptr %.031, ptr %i.s, align 8, !tbaa !423
  br label %bb.j
...
.lr.ph:                                           ; preds = %_ZNSt10_HashtableIN5arrow8FieldRefESt4pairIKS1_NS0_5DatumEESaIS5_ENSt8__detail10_Select1stESt8equal_toIS1_ENS1_4HashENS7_18_Mod_range_hashingENS7_20_Default_ranged_hashENS7_20_Prime_rehash_policyENS7_17_Hashtable_traitsILb1ELb0ELb1EEEE19_M_allocate_bucketsEm.exit, %bb.j
  %.031 = phi ptr [ %i.i, %bb.j ], [ %i.h, %_ZNSt10_HashtableIN5arrow8FieldRefESt4pairIKS1_NS0_5DatumEESaIS5_ENSt8__detail10_Select1stESt8equal_toIS1_ENS1_4HashENS7_18_Mod_range_hashingENS7_20_Default_ranged_hashENS7_20_Prime_rehash_policyENS7_17_Hashtable_traitsILb1ELb0ELb1EEEE19_M_allocate_bucketsEm.exit ] ; 8 uses
  %.02530 = phi i64 [ %.1, %bb.j ], [ 0, %_ZNSt10_HashtableIN5arrow8FieldRefESt4pairIKS1_NS0_5DatumEESaIS5_ENSt8__detail10_Select1stESt8equal_toIS1_ENS1_4HashENS7_18_Mod_range_hashingENS7_20_Default_ranged_hashENS7_20_Prime_rehash_policyENS7_17_Hashtable_traitsILb1ELb0ELb1EEEE19_M_allocate_bucketsEm.exit ] ; 2 uses
  %i.i = load ptr, ptr %.031, align 8, !tbaa !423 ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph
  ...
  store ptr %i.o, ptr %.031, align 8, !tbaa !423
  store ptr %.031, ptr %i.g, align 8, !tbaa !422
  store ptr %i.g, ptr %i.m, align 8, !tbaa !430
  %i.p = load ptr, ptr %.031, align 8, !tbaa !423
  %.not28 = icmp eq ptr %i.p, null
  br i1 %.not28, label %bb.j, label %bb.h
...
.lr.ph.i.i.i:                                     ; preds = %bb.b, %bb.h
  %.02229.i.i.i = phi i64 [ %i.l, %bb.h ], [ %1, %bb.b ] ; 5 uses
  %.02328.i.i.i = phi i32 [ %i.m, %bb.h ], [ 1, %bb.b ] ; 4 uses
  %i.f = icmp ult i64 %.02229.i.i.i, 100
  br i1 %i.f, label %bb.c, label %bb.d

bb.c:                                             ; preds = %.lr.ph.i.i.i
  %i.g = add i32 %.02328.i.i.i, 1
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i.i

bb.d:                                             ; preds = %.lr.ph.i.i.i
  %i.h = icmp ult i64 %.02229.i.i.i, 1000
  br i1 %i.h, label %bb.e, label %bb.f

bb.e:                                             ; preds = %bb.d
  %i.i = add i32 %.02328.i.i.i, 2
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i.i

bb.f:                                             ; preds = %bb.d
  %i.j = icmp ult i64 %.02229.i.i.i, 10000
  br i1 %i.j, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f
  %i.k = add i32 %.02328.i.i.i, 3
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i.i

bb.h:                                             ; preds = %bb.f
  %i.l = udiv i64 %.02229.i.i.i, 10000
  %i.m = add i32 %.02328.i.i.i, 4                 ; 2 uses
  %i.n = icmp ult i64 %.02229.i.i.i, 100000
...
.lr.ph.i.i.i24:                                   ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6resizeEm.exit, %bb.x
  %.02229.i.i.i25 = phi i64 [ %i.bp, %bb.x ], [ %1, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6resizeEm.exit ] ; 5 uses
  %.02328.i.i.i26 = phi i32 [ %i.bq, %bb.x ], [ 1, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6resizeEm.exit ] ; 4 uses
  %i.bj = icmp ult i64 %.02229.i.i.i25, 100
  br i1 %i.bj, label %bb.s, label %bb.t

bb.s:                                             ; preds = %.lr.ph.i.i.i24
  %i.bk = add i32 %.02328.i.i.i26, 1
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i.i27

bb.t:                                             ; preds = %.lr.ph.i.i.i24
  %i.bl = icmp ult i64 %.02229.i.i.i25, 1000
  br i1 %i.bl, label %bb.u, label %bb.v

bb.u:                                             ; preds = %bb.t
  %i.bm = add i32 %.02328.i.i.i26, 2
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i.i27

bb.v:                                             ; preds = %bb.t
  %i.bn = icmp ult i64 %.02229.i.i.i25, 10000
  br i1 %i.bn, label %bb.w, label %bb.x

bb.w:                                             ; preds = %bb.v
  %i.bo = add i32 %.02328.i.i.i26, 3
  br label %_ZNSt8__detail14__to_chars_lenImEEjT_i.exit.i.i27

bb.x:                                             ; preds = %bb.v
  %i.bp = udiv i64 %.02229.i.i.i25, 10000
  %i.bq = add i32 %.02328.i.i.i26, 4              ; 2 uses
  %i.br = icmp ult i64 %.02229.i.i.i25, 100000
...
3:                                                ; preds = %bb.s
  ...
  br i1 %4, label %.thread, label %bb.t, !prof !87

bb.t:                                             ; preds = %3
  %5 = load i8, ptr %i.bc, align 1, !tbaa !86
  %6 = add i8 %5, -48                             ; 2 uses
  %.not145 = icmp ne i64 %i.bg, 1
  %i.bk = icmp ugt i8 %6, 9
  %or.cond = or i1 %.not145, %i.bk
  br i1 %or.cond, label %.thread, label %bb.u, !prof !1273
...
bb.g:                                             ; preds = %.lr.ph
  ...
  store ptr %i.o, ptr %.031, align 8, !tbaa !423
  store ptr %.031, ptr %i.g, align 8, !tbaa !1636
  store ptr %i.g, ptr %i.m, align 8, !tbaa !430
  %i.p = load ptr, ptr %.031, align 8, !tbaa !423
  %.not28 = icmp eq ptr %i.p, null
  br i1 %.not28, label %bb.j, label %bb.h
...
.lr.ph:                                           ; preds = %_ZNSt10_HashtableIN5arrow7compute10ExpressionES2_SaIS2_ENSt8__detail9_IdentityESt8equal_toIS2_ENS2_4HashENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb1ELb1ELb1EEEE19_M_allocate_bucketsEm.exit, %bb.j
  %.031 = phi ptr [ %i.i, %bb.j ], [ %i.h, %_ZNSt10_HashtableIN5arrow7compute10ExpressionES2_SaIS2_ENSt8__detail9_IdentityESt8equal_toIS2_ENS2_4HashENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb1ELb1ELb1EEEE19_M_allocate_bucketsEm.exit ] ; 8 uses
  %.02530 = phi i64 [ %.1, %bb.j ], [ 0, %_ZNSt10_HashtableIN5arrow7compute10ExpressionES2_SaIS2_ENSt8__detail9_IdentityESt8equal_toIS2_ENS2_4HashENS4_18_Mod_range_hashingENS4_20_Default_ranged_hashENS4_20_Prime_rehash_policyENS4_17_Hashtable_traitsILb1ELb1ELb1EEEE19_M_allocate_bucketsEm.exit ] ; 2 uses
  %i.i = load ptr, ptr %.031, align 8, !tbaa !423 ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph
  ...
  store ptr %i.o, ptr %.031, align 8, !tbaa !423
  store ptr %.031, ptr %i.g, align 8, !tbaa !1166
  store ptr %i.g, ptr %i.m, align 8, !tbaa !430
  %i.p = load ptr, ptr %.031, align 8, !tbaa !423
  %.not28 = icmp eq ptr %i.p, null
  br i1 %.not28, label %bb.j, label %bb.h
...
!1273 = !{!"branch_weights", i32 4001, i32 4000000}
!1274 = !{!1275}
