...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %bb.z
  %.05.i.i = phi i64 [ %i.dk, %bb.z ], [ 0, %.lr.ph.i.i.preheader ] ; 7 uses
...
._crit_edge:                                      ; preds = %bb.u
  %.05.i.i.lcssa63 = phi i64 [ %.05.i.i, %bb.u ]
  br label %bb.v

bb.v:                                             ; preds = %split.a, %._crit_edge
  %.lcssa = phi i32 [ %i.cs, %._crit_edge ], [ %i.cs, %split.a ]
  %.05.i.i.lcssa57 = phi i64 [ %.05.i.i.lcssa63, %._crit_edge ], [ %.05.i.i.lcssa62, %split.a ]
...
.lr.ph.i.i..invoke_crit_edge:                     ; preds = %.lr.ph.i.i
  %.05.i.i.lcssa61 = phi i64 [ %.05.i.i, %.lr.ph.i.i ]
  br label %.invoke

.invoke:                                          ; preds = %.invokesplit, %.lr.ph.i.i..invoke_crit_edge
  %.05.i.i.lcssa = phi i64 [ %.05.i.i.lcssa61, %.lr.ph.i.i..invoke_crit_edge ], [ %.05.i.i.lcssa64.a, %.invokesplit ]
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %bb.y
  %.05.i.i = phi i64 [ %i.di, %bb.y ], [ 0, %.lr.ph.i.i.preheader ] ; 6 uses
...
.lr.ph.i.i..invoke_crit_edge:                     ; preds = %.lr.ph.i.i
  %.05.i.i.lcssa60 = phi i64 [ %.05.i.i, %.lr.ph.i.i ]
  br label %.invoke

.invoke:                                          ; preds = %.invokesplit, %.lr.ph.i.i..invoke_crit_edge
  %.05.i.i.lcssa = phi i64 [ %.05.i.i.lcssa60, %.lr.ph.i.i..invoke_crit_edge ], [ %.05.i.i.lcssa62, %.invokesplit ]
