...
.lr.ph.i:                                         ; preds = %bb.a, %.lr.ph.i
  ...
  tail call void @_ZSt10destroy_atIN5arrow9ArraySpanEEvPT_(ptr noundef %.0.i2.i), !inline_history !1703
...
bb.b:                                             ; preds = %_ZSt8_DestroyIPN5arrow9ArraySpanES1_EvT_S3_RSaIT0_E.exit.i
  ...
  %i.k = sub i64 %i.i, %i.j
  tail call void @_ZdlPvm(ptr noundef nonnull %i.f, i64 noundef %i.k) #19, !inline_history !1704
...
bb.a:
  %i.a = load i8, ptr %0, align 8, !tbaa !1705, !range !75, !noundef !40
...
bb.f:                                             ; preds = %bb.d
  %i.k = load ptr, ptr %i.c, align 8, !tbaa !1710 ; 2 uses
...
bb.i:                                             ; preds = %bb.g
  %i.p = load ptr, ptr %i.c, align 8, !tbaa !1710 ; 3 uses
...
bb.j:                                             ; preds = %bb.i, %bb.f
  ...
  store ptr %i.v, ptr %i.c, align 8, !tbaa !1710
  %i.w = add nsw i64 %i.e, -64
  store i64 %i.w, ptr %i.d, align 8, !tbaa !1708
...
_ZN5arrow8internal15BitBlockCounter8NextWordEv.exit: ; preds = %bb.b, %bb.k
  ...
  %i.ac = load i64, ptr %i.ab, align 8, !tbaa !1711
  %i.ad = add nsw i64 %i.ac, %1
  store i64 %i.ad, ptr %i.ab, align 8, !tbaa !1711
  br label %bb.m

bb.l:                                             ; preds = %bb.a
  %i.ae = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.af = load i64, ptr %i.ae, align 8, !tbaa !1712
  %i.ag = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 2 uses
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !1711 ; 2 uses
  ...
  store i64 %i.ak, ptr %i.ag, align 8, !tbaa !1711
  br label %bb.m
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  tail call void @_ZSt10destroy_atIN5arrow9ArraySpanEEvPT_(ptr noundef %.0.i2), !inline_history !1713
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  tail call void @_ZSt10destroy_atIN5arrow9ArraySpanEEvPT_(ptr noundef %.0.i.i2), !inline_history !1714
...
bb.b:                                             ; preds = %_ZNSt12_Destroy_auxILb0EE9__destroyIPN5arrow9ArraySpanEEEvT_S5_.exit.i
  ...
  %i.j = ptrtoint ptr %i.f to i64
  %i.k = sub i64 %i.i, %i.j
  tail call void @_ZdlPvm(ptr noundef nonnull %i.f, i64 noundef %i.k) #19, !inline_history !1715
  br label %_ZNSt6vectorIN5arrow9ArraySpanESaIS1_EED2Ev.exit
...
bb.a:
  ...
  store i32 %i.e, ptr %i.a, align 4, !tbaa !3, !noalias !1716
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #18, !noalias !1716
  store i32 86400, ptr %i.b, align 4, !tbaa !3, !noalias !1716
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #18, !noalias !1716
  store i32 86400000, ptr %i.c, align 4, !tbaa !3, !noalias !1716
  %i.f = getelementptr inbounds nuw i8, ptr %.0.val.0.val, i64 72
  %i.g = load i32, ptr %i.f, align 8, !tbaa !1719, !noalias !1716 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  %i.i = load ptr, ptr %3, align 8, !tbaa !88, !noalias !1723 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i: ; preds = %bb.c
  %i.l = load i64, ptr %i.j, align 8, !tbaa !92, !noalias !1723
  %i.m = add i64 %i.l, 1
