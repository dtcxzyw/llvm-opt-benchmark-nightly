...
._crit_edge:                                      ; preds = %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit80, %bb.bc
  %.0137.lcssa = phi i64 [ %2, %bb.bc ], [ %i.fn, %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit80 ]
  %.0.lcssa = phi i64 [ 0, %bb.bc ], [ %i.fo, %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit80 ]
...
.lr.ph:                                           ; preds = %bb.bc, %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit80
  %.1 = phi i64 [ %i.fn, %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit80 ], [ %2, %bb.bc ]
  ...
  %.0144 = phi i64 [ %i.fo, %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit80 ], [ 0, %bb.bc ]
  %14 = getelementptr inbounds nuw [16 x i8], ptr %i.ez, i64 %.025146 ; 4 uses
...
begin_hunk_3_@_ZN5arrow2io20TransformInputStream4ReadElPv:bb.a
  ...
  %i.fn = sub nsw i64 %.1, %i.fl                  ; 2 uses
  %i.fo = add nsw i64 %i.fl, %.0144               ; 2 uses
