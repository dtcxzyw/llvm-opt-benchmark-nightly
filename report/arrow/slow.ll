...
bb.b:                                             ; preds = %bb.a
  ...
  %i.k = load double, ptr %i.j, align 8, !tbaa !125
  br label %bb.f
...
select.unfold.i.i:                                ; preds = %select.unfold.i.i.backedge, %.preheader
  ...
  %i.t = fpext double %.01422.i.i to x86_fp80
  %i.u = fmul x86_fp80 %i.t, f0x401DFFFFFFFC00000000
  %i.v = fptrunc x86_fp80 %i.u to double          ; 2 uses
  %i.w = add i64 %.023.i.i, -1                    ; 2 uses
...
_ZNSt8__detail8_AdaptorISt26linear_congruential_engineImLm16807ELm0ELm2147483647EEdEclEv.exit27: ; preds = %.unr-lcssa, %bb.d
  %.016.i.i26 = phi double [ f0x3FEFFFFFFFFFFFFF, %bb.d ], [ %i.y, %.unr-lcssa ]
  %i.ak = tail call double @llvm.fmuladd.f64(double %.016.i.i26, double 2.000000e+00, double -1.000000e+00) ; 3 uses
  %i.al = fmul double %i.ak, %i.ak
  %i.am = tail call double @llvm.fmuladd.f64(double %i.x, double %i.x, double %i.al) ; 4 uses
  %i.an = fcmp ogt double %i.am, 1.000000e+00
  %i.ao = fcmp oeq double %i.am, 0.000000e+00
...
bb.e:                                             ; preds = %_ZNSt8__detail8_AdaptorISt26linear_congruential_engineImLm16807ELm0ELm2147483647EEdEclEv.exit27
  ...
  %i.at = tail call double @sqrt(double noundef %i.as) #24, !tbaa !3 ; 2 uses
  %i.au = fmul double %i.x, %i.at
  %i.av = getelementptr inbounds nuw i8, ptr %0, i64 16
  store double %i.au, ptr %i.av, align 8, !tbaa !125
  store i8 1, ptr %i.a, align 8, !tbaa !30
  %i.aw = fmul double %i.ak, %i.at
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.b
  %.0 = phi double [ %i.k, %bb.b ], [ %i.aw, %bb.e ]
  %i.ax = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.ay = load double, ptr %i.ax, align 8, !tbaa !129
  %i.az = load double, ptr %2, align 8, !tbaa !26
  %i.ba = tail call double @llvm.fmuladd.f64(double %.0, double %i.ay, double %i.az)
  ret double %i.ba
}
...
!90 = !{!"p1 _ZTSN5arrow2io16RandomAccessFileE", !36, i64 0}
!91 = !{!92}
!92 = distinct !{!92, !93, !"_ZN5arrow2io20SlowRandomAccessFile5CloseEv: argument 0"}
!93 = distinct !{!93, !"_ZN5arrow2io20SlowRandomAccessFile5CloseEv"}
!94 = !{ptr @_ZN5arrow2io20SlowRandomAccessFile5CloseEv}
!95 = !{!96}
!96 = distinct !{!96, !97, !"_ZN5arrow2io20SlowRandomAccessFile5AbortEv: argument 0"}
!97 = distinct !{!97, !"_ZN5arrow2io20SlowRandomAccessFile5AbortEv"}
!98 = !{ptr @_ZN5arrow2io20SlowRandomAccessFile5AbortEv}
!99 = !{ptr @_ZNK5arrow2io20SlowRandomAccessFile6closedEv}
!100 = !{!101}
!101 = distinct !{!101, !102, !"_ZN5arrow2io20SlowRandomAccessFile4SeekEl: argument 0"}
!102 = distinct !{!102, !"_ZN5arrow2io20SlowRandomAccessFile4SeekEl"}
!103 = !{ptr @_ZN5arrow2io20SlowRandomAccessFile4SeekEl}
!104 = !{!105}
!105 = distinct !{!105, !106, !"_ZNK5arrow2io20SlowRandomAccessFile4TellEv: argument 0"}
!106 = distinct !{!106, !"_ZNK5arrow2io20SlowRandomAccessFile4TellEv"}
!107 = !{ptr @_ZNK5arrow2io20SlowRandomAccessFile4TellEv}
!108 = !{!109}
!109 = distinct !{!109, !110, !"_ZN5arrow2io20SlowRandomAccessFile4ReadElPv: argument 0"}
!110 = distinct !{!110, !"_ZN5arrow2io20SlowRandomAccessFile4ReadElPv"}
!111 = !{ptr @_ZN5arrow2io20SlowRandomAccessFile4ReadElPv, ptr @_ZN5arrow2io16LatencyGenerator5SleepEv}
!112 = !{ptr @_ZN5arrow2io20SlowRandomAccessFile4ReadElPv}
!113 = !{!114}
!114 = distinct !{!114, !115, !"_ZN5arrow2io20SlowRandomAccessFile4ReadEl: argument 0"}
!115 = distinct !{!115, !"_ZN5arrow2io20SlowRandomAccessFile4ReadEl"}
!116 = !{ptr @_ZN5arrow2io20SlowRandomAccessFile4ReadEl, ptr @_ZN5arrow2io16LatencyGenerator5SleepEv}
!117 = !{ptr @_ZN5arrow2io20SlowRandomAccessFile4ReadEl}
!118 = distinct !{null}
!119 = distinct !{null, null}
!120 = !{!121, !122, i64 8}
!121 = !{!"_ZTSSt9type_info", !122, i64 8}
!122 = !{!"p1 omnipotent char", !36, i64 0}
!123 = !{i8 0, i8 2}
!124 = !{}
end_hunk_0
