...
define void @_ZN5arrow2io16LatencyGeneratorD0Ev(ptr nofree nonnull readnone align 8 captures(none) dead_on_return(8) %0) unnamed_addr #0 align 2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define void @_ZN5arrow2io16LatencyGenerator4MakeEd(ptr dead_on_unwind noalias nofree writable writeonly sret(%"class.std::shared_ptr") align 8 captures(none) initializes((0, 16)) %0, double noundef %1) local_unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
...
; Function Attrs: mustprogress uwtable
define void @_ZN5arrow2io16LatencyGenerator4MakeEdi(ptr dead_on_unwind noalias nofree writable writeonly sret(%"class.std::shared_ptr") align 8 captures(none) initializes((0, 16)) %0, double noundef %1, i32 noundef %2) local_unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
_ZNSt12__shared_ptrIN5arrow2io20LatencyGeneratorImplELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit:
...
define void @_ZN5arrow2io15SlowInputStreamD2Ev(ptr noundef nonnull align 8 dereferenceable(40) initializes((0, 8)) %0, ptr nofree noundef readonly captures(none) %1) unnamed_addr #5 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
end_hunk_0
begin_hunk_1_@_ZTv0_n32_N5arrow2io15SlowInputStream4ReadElPv
define void @_ZTv0_n32_N5arrow2io15SlowInputStream4ReadElPv(ptr dead_on_unwind noalias writable sret(%"class.arrow::Result") align 8 %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2, ptr noundef %3) unnamed_addr #11 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  ...
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !33, !noalias !70 ; 2 uses
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !7, !noalias !70
  %i.h = getelementptr inbounds nuw i8, ptr %i.g, i64 16
  %i.i = load ptr, ptr %i.h, align 8, !noalias !70
  %i.j = tail call noundef double %i.i(ptr noundef nonnull align 8 dereferenceable(8) %i.f), !noalias !70, !inline_history !73 ; 3 uses
  %i.k = fcmp ugt double %i.j, 0.000000e+00
  br i1 %i.k, label %bb.b, label %_ZN5arrow2io15SlowInputStream4ReadElPv.exit
...
bb.b:                                             ; preds = %bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #24, !noalias !70
  store i64 %i.l, ptr %4, align 8, !tbaa !9, !noalias !70
  %i.q = getelementptr inbounds nuw i8, ptr %4, i64 8
  store i64 %i.p, ptr %i.q, align 8, !tbaa !12, !noalias !70
  br label %bb.c

bb.c:                                             ; preds = %bb.d, %bb.b
  %i.r = call i32 @nanosleep(ptr noundef nonnull %4, ptr noundef nonnull %4), !noalias !70
  %i.s = icmp eq i32 %i.r, -1
  br i1 %i.s, label %bb.d, label %.critedge.i.i.i

bb.d:                                             ; preds = %bb.c
  %i.t = tail call ptr @__errno_location() #25
  %i.u = load i32, ptr %i.t, align 4, !tbaa !3, !noalias !70
  %i.v = icmp eq i32 %i.u, 4
  br i1 %i.v, label %bb.c, label %.critedge.i.i.i, !llvm.loop !13

.critedge.i.i.i:                                  ; preds = %bb.d, %bb.c
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #24, !noalias !70
  br label %_ZN5arrow2io15SlowInputStream4ReadElPv.exit

_ZN5arrow2io15SlowInputStream4ReadElPv.exit:      ; preds = %bb.a, %.critedge.i.i.i
  %i.w = getelementptr inbounds nuw i8, ptr %i.d, i64 8
  %i.x = load ptr, ptr %i.w, align 8, !tbaa !53, !noalias !70 ; 2 uses
  %i.y = load ptr, ptr %i.x, align 8, !tbaa !7, !noalias !70
  %i.z = getelementptr i8, ptr %i.y, i64 -64
  %i.aa = load i64, ptr %i.z, align 8, !noalias !70
  %i.ab = getelementptr inbounds i8, ptr %i.x, i64 %i.aa ; 2 uses
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !7, !noalias !70
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 16
  %i.ae = load ptr, ptr %i.ad, align 8, !noalias !70
  call void %i.ae(ptr dead_on_unwind writable sret(%"class.arrow::Result") align 8 %0, ptr noundef nonnull align 8 dereferenceable(8) %i.ab, i64 noundef %2, ptr noundef %3), !inline_history !74
  ret void
}

; Function Attrs: mustprogress uwtable
define void @_ZN5arrow2io15SlowInputStream4ReadEl(ptr dead_on_unwind noalias writable sret(%"class.arrow::Result.8") align 8 %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %1, i64 noundef %2) unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  ...
  %i.f = tail call noundef double %i.e(ptr noundef nonnull align 8 dereferenceable(8) %i.b), !inline_history !69 ; 3 uses
  %i.g = fcmp ugt double %i.f, 0.000000e+00
  br i1 %i.g, label %bb.b, label %_ZN5arrow2io16LatencyGenerator5SleepEv.exit

bb.b:                                             ; preds = %bb.a
  %i.h = fptosi double %i.f to i64                ; 2 uses
...
define void @_ZTv0_n40_N5arrow2io15SlowInputStream4ReadEl(ptr dead_on_unwind noalias writable sret(%"class.arrow::Result.8") align 8 %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) unnamed_addr #11 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %3 = alloca %struct.timespec, align 8           ; 6 uses
  %i.a = load ptr, ptr %1, align 8, !tbaa !7
...
; Function Attrs: mustprogress uwtable
define void @_ZN5arrow2io15SlowInputStream4PeekEl(ptr dead_on_unwind noalias writable sret(%"class.arrow::Result.12") align 8 %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(40) %1, i64 noundef %2) unnamed_addr #2 align 2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define void @_ZN5arrow2io20SlowRandomAccessFile5CloseEv(ptr dead_on_unwind noalias writable sret(%"class.arrow::Status") align 8 %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(56) %1) unnamed_addr #2 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 24
...
; Function Attrs: uwtable
define void @_ZTv0_n32_N5arrow2io20SlowRandomAccessFile5CloseEv(ptr dead_on_unwind noalias writable sret(%"class.arrow::Status") align 8 %0, ptr nofree noundef readonly captures(none) %1) unnamed_addr #11 align 2 {
bb.a:
  %i.a = load ptr, ptr %1, align 8, !tbaa !7
  %i.b = getelementptr inbounds i8, ptr %i.a, i64 -32
  %i.c = load i64, ptr %i.b, align 8
  ...
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !88, !noalias !91 ; 2 uses
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !7, !noalias !91
  ...
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !7, !noalias !91
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 16
  %i.m = load ptr, ptr %i.l, align 8, !noalias !91
  tail call void %i.m(ptr dead_on_unwind writable sret(%"class.arrow::Status") align 8 %0, ptr noundef nonnull align 8 dereferenceable(28) %i.j), !inline_history !94
  ret void
}

; Function Attrs: mustprogress uwtable
define void @_ZN5arrow2io20SlowRandomAccessFile5AbortEv(ptr dead_on_unwind noalias writable sret(%"class.arrow::Status") align 8 %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(56) %1) unnamed_addr #2 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !88   ; 2 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !7
...
; Function Attrs: uwtable
define void @_ZTv0_n48_N5arrow2io20SlowRandomAccessFile5AbortEv(ptr dead_on_unwind noalias writable sret(%"class.arrow::Status") align 8 %0, ptr nofree noundef readonly captures(none) %1) unnamed_addr #11 align 2 {
bb.a:
  %i.a = load ptr, ptr %1, align 8, !tbaa !7
  ...
  %i.d = getelementptr inbounds i8, ptr %1, i64 %i.c
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !88, !noalias !95 ; 2 uses
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !7, !noalias !95
  %i.h = getelementptr i8, ptr %i.g, i64 -56
  %i.i = load i64, ptr %i.h, align 8, !noalias !95
  %i.j = getelementptr inbounds i8, ptr %i.f, i64 %i.i ; 2 uses
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !7, !noalias !95
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 32
  %i.m = load ptr, ptr %i.l, align 8, !noalias !95
  tail call void %i.m(ptr dead_on_unwind writable sret(%"class.arrow::Status") align 8 %0, ptr noundef nonnull align 8 dereferenceable(28) %i.j), !inline_history !98
  ret void
}

; Function Attrs: mustprogress uwtable
define noundef zeroext i1 @_ZNK5arrow2io20SlowRandomAccessFile6closedEv(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(56) %0) unnamed_addr #2 align 2 {
bb.a:
...
; Function Attrs: uwtable
define noundef zeroext i1 @_ZTv0_n64_NK5arrow2io20SlowRandomAccessFile6closedEv(ptr nofree noundef readonly captures(none) %0) unnamed_addr #11 align 2 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !7
  ...
  %i.n = tail call noundef zeroext i1 %i.m(ptr noundef nonnull align 8 dereferenceable(28) %i.j), !inline_history !99
  ret i1 %i.n
}

; Function Attrs: mustprogress uwtable
define void @_ZN5arrow2io20SlowRandomAccessFile7GetSizeEv(ptr dead_on_unwind noalias writable sret(%"class.arrow::Result") align 8 %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(56) %1) unnamed_addr #2 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !88   ; 2 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !7
  ...
  %i.e = load ptr, ptr %i.d, align 8
  tail call void %i.e(ptr dead_on_unwind writable sret(%"class.arrow::Result") align 8 %0, ptr noundef nonnull align 8 dereferenceable(24) %i.b)
  ret void
}

; Function Attrs: mustprogress uwtable
define void @_ZN5arrow2io20SlowRandomAccessFile4SeekEl(ptr dead_on_unwind noalias writable sret(%"class.arrow::Status") align 8 %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(56) %1, i64 noundef %2) unnamed_addr #2 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 24
  ...
  tail call void %i.f(ptr dead_on_unwind writable sret(%"class.arrow::Status") align 8 %0, ptr noundef nonnull align 8 dereferenceable(8) %i.c, i64 noundef %2)
  ret void
}

; Function Attrs: uwtable
define void @_ZThn8_N5arrow2io20SlowRandomAccessFile4SeekEl(ptr dead_on_unwind noalias writable sret(%"class.arrow::Status") align 8 %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) unnamed_addr #11 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !88, !noalias !100
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 8 ; 2 uses
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !7, !noalias !100
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  %i.f = load ptr, ptr %i.e, align 8, !noalias !100
  tail call void %i.f(ptr dead_on_unwind writable sret(%"class.arrow::Status") align 8 %0, ptr noundef nonnull align 8 dereferenceable(8) %i.c, i64 noundef %2), !inline_history !103
  ret void
}

; Function Attrs: mustprogress uwtable
define void @_ZNK5arrow2io20SlowRandomAccessFile4TellEv(ptr dead_on_unwind noalias writable sret(%"class.arrow::Result") align 8 %0, ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(56) %1) unnamed_addr #2 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !88   ; 2 uses
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !7
  ...
  %i.i = load ptr, ptr %i.h, align 8
  tail call void %i.i(ptr dead_on_unwind writable sret(%"class.arrow::Result") align 8 %0, ptr noundef nonnull align 8 dereferenceable(28) %i.f)
  ret void
}

; Function Attrs: uwtable
define void @_ZTv0_n56_NK5arrow2io20SlowRandomAccessFile4TellEv(ptr dead_on_unwind noalias writable sret(%"class.arrow::Result") align 8 %0, ptr nofree noundef readonly captures(none) %1) unnamed_addr #11 align 2 {
bb.a:
  %i.a = load ptr, ptr %1, align 8, !tbaa !7
  ...
  %i.d = getelementptr inbounds i8, ptr %1, i64 %i.c
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 24
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !88, !noalias !104 ; 2 uses
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !7, !noalias !104
  %i.h = getelementptr i8, ptr %i.g, i64 -56
  %i.i = load i64, ptr %i.h, align 8, !noalias !104
  %i.j = getelementptr inbounds i8, ptr %i.f, i64 %i.i ; 2 uses
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !7, !noalias !104
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 40
  %i.m = load ptr, ptr %i.l, align 8, !noalias !104
  tail call void %i.m(ptr dead_on_unwind writable sret(%"class.arrow::Result") align 8 %0, ptr noundef nonnull align 8 dereferenceable(28) %i.j), !inline_history !107
  ret void
}
