...
_ZN14arrow_vendored4dateL10get_tz_dirB5cxx11Ev.exit: ; preds = %bb.al, %bb.aj, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  ...
  %i.cy = load i64, ptr %i.bd, align 8, !tbaa !39 ; 8 uses
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a:   ; preds = %bb.at, %.lr.ph.i.i
  ...
  %reass.sub = sub i64 %.041.i.i, %i.cx
  %i.df = add i64 %reass.sub, 1
  %14 = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02840.i.i, i32 noundef %i.dd, i64 noundef %i.df) #31 ; 4 uses
  %.not34.i.i.a = icmp eq ptr %14, null
  br i1 %.not34.i.i.a, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit, label %_ZNSt11char_traitsIcE7compareEPKcS2_m.exit.i.i
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit: ; preds = %bb.at, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a, %bb.as, %bb.ar, %.sink.split.i, %_ZN14arrow_vendored4dateL10get_tz_dirB5cxx11Ev.exit127, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findERKS4_m.exit
  %15 = phi i64 [ %i.cy, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findERKS4_m.exit ], [ %i.cy, %bb.as ], [ 0, %bb.ar ], [ %.pre459, %.sink.split.i ], [ %i.dv, %_ZN14arrow_vendored4dateL10get_tz_dirB5cxx11Ev.exit127 ], [ %i.cy, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i.a ], [ %i.cy, %bb.at ]
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i185:  ; preds = %bb.bz, %.lr.ph.i.i184
  ...
  %i.id = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02840.i.i187, i32 noundef 90, i64 noundef %i.ic) #31 ; 4 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findEPKcm.exit.thread: ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i185, %bb.bz, %_ZSt7getlineIcSt11char_traitsIcESaIcEERSt13basic_istreamIT_T0_ES7_RNSt7__cxx1112basic_stringIS4_S5_T1_EE.exit180, %bb.by
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i233:  ; preds = %bb.cr, %.lr.ph.i.i232
  ...
  %i.lf = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02840.i.i235, i32 noundef 111, i64 noundef %i.le) #31 ; 4 uses
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i246:  ; preds = %bb.ct, %.lr.ph.i.i245
  ...
  %i.lq = call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02840.i.i248, i32 noundef 39, i64 noundef %.041.i.i247) #31 ; 4 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit272.a: ; preds = %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i233, %bb.cr, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE4findERKS4_m.exit241, %bb.cq, %.noexc228
...
_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i:     ; preds = %bb.f, %.lr.ph.i.i
  %.033.i.i = phi i64 [ %i.i, %.lr.ph.i.i ], [ %i.s, %bb.f ]
  %.02132.i.i = phi ptr [ %i.j, %.lr.ph.i.i ], [ %i.q, %bb.f ]
  %i.n = add i64 %.033.i.i, -4
  %i.o = tail call ptr @memchr(ptr noundef nonnull dereferenceable(1) %.02132.i.i, i32 noundef 112, i64 noundef %i.n) #31 ; 4 uses
...
_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit.thread: ; preds = %bb.f, %_ZNSt11char_traitsIcE4findEPKcmRS1_.exit.i.i, %_ZNKSt17basic_string_viewIcSt11char_traitsIcEE4findEPKcm.exit
