...
begin_hunk_0_@_ZN14arrow_vendored4date9time_zone9load_dataIiEEvRSiiiii:bb.a
  ...
  %i.i = phi ptr [ %.sroa.8.0178.a, %bb.g ], [ %i.d, %_ZNSt12_Vector_baseIN14arrow_vendored4date6detail10transitionESaIS3_EE11_M_allocateEm.exit.i.i ] ; 4 uses
...
begin_hunk_1_@_ZN14arrow_vendored4date9time_zone9load_dataIiEEvRSiiiii:bb.a
  ...
  %.sroa.8.0175 = getelementptr inbounds nuw i8, ptr %i.i, i64 16
  br label %bb.g
...
bb.g:                                             ; preds = %.thread, %bb.e, %.loopexit180
  %.sroa.8.0178.a = phi ptr [ %.sroa.8.0175, %.thread ], [ %.sroa.8.0, %bb.e ], [ %.sroa.8.0, %.loopexit180 ] ; 2 uses
...
_ZN14arrow_vendored4dateL16load_transitionsIiEESt6vectorINS0_6detail10transitionESaIS4_EERSii.exit: ; preds = %bb.g, %bb.a, %_ZNSt12_Vector_baseIN14arrow_vendored4date6detail10transitionESaIS3_EE11_M_allocateEm.exit.i.i
  ...
  %.sroa.8.1 = phi ptr [ null, %bb.a ], [ %i.d, %_ZNSt12_Vector_baseIN14arrow_vendored4date6detail10transitionESaIS3_EE11_M_allocateEm.exit.i.i ], [ %.sroa.8.0178.a, %bb.g ]
