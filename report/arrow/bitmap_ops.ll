...
bb.b:                                             ; preds = %_ZN5arrow8internal21BinaryBitBlockCounter8NextWordINS0_6detail11BitBlockAndEEENS0_13BitBlockCountEv.exit, %bb.a
  ...
  %.07 = phi i64 [ 0, %bb.a ], [ %i.bb, %_ZN5arrow8internal21BinaryBitBlockCounter8NextWordINS0_6detail11BitBlockAndEEENS0_13BitBlockCountEv.exit ] ; 2 uses
...
._crit_edge.i:                                    ; preds = %._crit_edge.i.loopexit, %bb.d
  ...
  %i.p = sdiv i16 %i.m, 8
  %i.q = sext i16 %i.p to i64                     ; 2 uses
  %i.r = getelementptr inbounds i8, ptr %.sroa.0.0, i64 %i.q
  %i.s = getelementptr inbounds i8, ptr %.sroa.9.0, i64 %i.q
  %i.t = sub nsw i64 %.sroa.17.0, %i.n
  %i.u = and i64 %.sroa.speculated26.i, 65535
...
.lr.ph.i:                                         ; preds = %bb.d, %.lr.ph.i
  %.01535.i = phi i64 [ %i.an, %.lr.ph.i ], [ 0, %bb.d ] ; 3 uses
  %.01634.i = phi i16 [ %spec.select20.i, %.lr.ph.i ], [ 0, %bb.d ]
  %i.w = add nsw i64 %.01535.i, %i.c              ; 2 uses
  %i.x = lshr i64 %i.w, 3
  %i.y = getelementptr inbounds nuw i8, ptr %.sroa.0.0, i64 %i.x
  %i.z = load i8, ptr %i.y, align 1, !tbaa !7
  %i.aa = trunc i64 %i.w to i8
  %i.ab = and i8 %i.aa, 7
  %i.ac = lshr i8 %i.z, %i.ab
  %i.ad = add nsw i64 %.01535.i, %i.f             ; 2 uses
  %i.ae = lshr i64 %i.ad, 3
  %i.af = getelementptr inbounds nuw i8, ptr %.sroa.9.0, i64 %i.ae
  %i.ag = load i8, ptr %i.af, align 1, !tbaa !7
  %i.ah = trunc i64 %i.ad to i8
  %i.ai = and i8 %i.ah, 7
  %i.aj = lshr i8 %i.ag, %i.ai
  %i.ak = and i8 %i.ac, 1
  %i.al = and i8 %i.ak, %i.aj
  %i.am = zext nneg i8 %i.al to i16
  %spec.select20.i = add i16 %.01634.i, %i.am     ; 2 uses
  %i.an = add nuw nsw i64 %.01535.i, 1            ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.an, %i.n
  br i1 %exitcond.not.i, label %._crit_edge.i.loopexit, label %.lr.ph.i, !llvm.loop !16

bb.e:                                             ; preds = %bb.c
  %i.ao = load i64, ptr %.sroa.0.0, align 1       ; 2 uses
  br i1 %brmerge.not.i, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %i.ap = load i64, ptr %.sroa.9.0, align 1
  %i.aq = and i64 %i.ap, %i.ao
  br label %bb.h

bb.g:                                             ; preds = %bb.e
  %i.ar = getelementptr inbounds nuw i8, ptr %.sroa.0.0, i64 8
  %i.as = load i64, ptr %i.ar, align 1
  %.0.i.i = tail call noundef i64 @llvm.fshr.i64(i64 %i.as, i64 %i.ao, i64 %i.c)
  %i.at = load i64, ptr %.sroa.9.0, align 1
  %i.au = getelementptr inbounds nuw i8, ptr %.sroa.9.0, i64 8
  %i.av = load i64, ptr %i.au, align 1
  %.0.i22.i = tail call noundef i64 @llvm.fshr.i64(i64 %i.av, i64 %i.at, i64 %i.f)
  %i.aw = and i64 %.0.i22.i, %.0.i.i
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f
  %.sink.i = phi i64 [ %i.aw, %bb.g ], [ %i.aq, %bb.f ]
  %i.ax = tail call noundef range(i64 0, 65) i64 @llvm.ctpop.i64(i64 %.sink.i)
  %i.ay = getelementptr inbounds nuw i8, ptr %.sroa.0.0, i64 8
  %i.az = getelementptr inbounds nuw i8, ptr %.sroa.9.0, i64 8
  %i.ba = add nsw i64 %.sroa.17.0, -64
  br label %_ZN5arrow8internal21BinaryBitBlockCounter8NextWordINS0_6detail11BitBlockAndEEENS0_13BitBlockCountEv.exit
...
_ZN5arrow8internal21BinaryBitBlockCounter8NextWordINS0_6detail11BitBlockAndEEENS0_13BitBlockCountEv.exit: ; preds = %._crit_edge.i, %bb.h
  %.sroa.9.1 = phi ptr [ %i.s, %._crit_edge.i ], [ %i.az, %bb.h ]
  %.sroa.17.1 = phi i64 [ %i.t, %._crit_edge.i ], [ %i.ba, %bb.h ]
  %.sroa.0.1 = phi ptr [ %i.r, %._crit_edge.i ], [ %i.ay, %bb.h ]
  %.sroa.0.0.i = phi i1 [ %i.v, %._crit_edge.i ], [ false, %bb.h ]
  %.sroa.4.0.i = phi i64 [ %.016.lcssa.i, %._crit_edge.i ], [ %i.ax, %bb.h ]
  %sext = shl nuw i64 %.sroa.4.0.i, 48
  %6 = ashr exact i64 %sext, 48
  %i.bb = add nsw i64 %6, %.07
