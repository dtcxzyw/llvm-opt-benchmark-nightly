...
end_hunk_0
begin_hunk_1_@_ZNSt12__shared_ptrIN5arrow8internal10ThreadPoolELN9__gnu_cxx12_Lock_policyE2EED2Ev:bb.a
...
end_hunk_1
begin_hunk_2_@_ZN5arrow2io8internal18CoalesceReadRangesESt6vectorINS0_9ReadRangeESaIS3_EEll:bb.a
  br i1 %i.bc, label %bb.p, label %bb.s

bb.p:                                             ; preds = %.lr.ph.i.i.i.i32.i
  %.sroa.0.0.copyload = load <2 x i64>, ptr %.sroa.0.018.i.ptr.i.i.i.i, align 8, !noalias !352
  %i.bd = icmp samesign ugt i64 %.sroa.0.018.i.idx.i.i.i.i, 16
  br i1 %i.bd, label %bb.q, label %bb.r, !prof !89

end_hunk_2
begin_hunk_3_@_ZN5arrow2io8internal18CoalesceReadRangesESt6vectorINS0_9ReadRangeESaIS3_EEll:bb.a
...
_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPN5arrow2io9ReadRangeESt6vectorIS4_SaIS4_EEEES9_ET0_T_SB_SA_.exit.i.i.i.i.i: ; preds = %bb.r, %bb.q
  store <2 x i64> %.sroa.0.0.copyload, ptr %i.a, align 8, !noalias !352
  br label %bb.t

bb.s:                                             ; preds = %.lr.ph.i.i.i.i32.i
end_hunk_3
begin_hunk_4_@_ZN5arrow2io8internal18CoalesceReadRangesESt6vectorINS0_9ReadRangeESaIS3_EEll:bb.a
  br i1 %i.bq, label %bb.v, label %bb.z

bb.v:                                             ; preds = %.lr.ph.i26.i.i.i.i
  %.sroa.099.0.copyload = load <2 x i64>, ptr %.sroa.0.018.i27.i.i.i.i, align 8, !noalias !352
...
_ZSt13move_backwardIN9__gnu_cxx17__normal_iteratorIPN5arrow2io9ReadRangeESt6vectorIS4_SaIS4_EEEES9_ET0_T_SB_SA_.exit.i43.i.i.i.i: ; preds = %bb.y, %bb.x, %bb.w
  store <2 x i64> %.sroa.099.0.copyload, ptr %i.a, align 8, !noalias !352
  br label %bb.aa
...
end_hunk_8
begin_hunk_9_@_ZSt19__throw_logic_errorPKc
...
end_hunk_9
begin_hunk_10_@_ZSt16__introsort_loopIN9__gnu_cxx17__normal_iteratorIPN5arrow2io9ReadRangeESt6vectorIS4_SaIS4_EEEElNS0_5__ops15_Iter_comp_iterIZNS3_8internal12_GLOBAL__N_117ReadRangeCombiner8CoalesceES8_EUlRKS4_SG_E_EEEvT_SJ_T0_T1_:bb.a
...
bb.k:                                             ; preds = %bb.j
  ...
  store <2 x i64> %.sroa.0.0.copyload, ptr %i.bv, align 8
...
bb.l:                                             ; preds = %bb.j
end_hunk_10
begin_hunk_11_@_ZSt16__introsort_loopIN9__gnu_cxx17__normal_iteratorIPN5arrow2io9ReadRangeESt6vectorIS4_SaIS4_EEEElNS0_5__ops15_Iter_comp_iterIZNS3_8internal12_GLOBAL__N_117ReadRangeCombiner8CoalesceES8_EUlRKS4_SG_E_EEEvT_SJ_T0_T1_:bb.a
...
bb.m:                                             ; preds = %bb.l
  ...
  store <2 x i64> %.sroa.049.0.copyload, ptr %i.bw, align 8
  br label %_ZSt22__move_median_to_firstIN9__gnu_cxx17__normal_iteratorIPN5arrow2io9ReadRangeESt6vectorIS4_SaIS4_EEEENS0_5__ops15_Iter_comp_iterIZNS3_8internal12_GLOBAL__N_117ReadRangeCombiner8CoalesceES8_EUlRKS4_SG_E_EEEvT_SJ_SJ_SJ_T0_.exit.i.preheader
...
bb.o:                                             ; preds = %.lr.ph42
end_hunk_11
begin_hunk_12_@_ZSt16__introsort_loopIN9__gnu_cxx17__normal_iteratorIPN5arrow2io9ReadRangeESt6vectorIS4_SaIS4_EEEElNS0_5__ops15_Iter_comp_iterIZNS3_8internal12_GLOBAL__N_117ReadRangeCombiner8CoalesceES8_EUlRKS4_SG_E_EEEvT_SJ_T0_T1_:bb.a
...
bb.r:                                             ; preds = %bb.q
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.fr26, ptr noundef nonnull align 8 dereferenceable(16) %i.bw, i64 16, i1 false), !tbaa.struct !358
  store <2 x i64> %.sroa.055.0.copyload, ptr %i.bw, align 8
  br label %_ZSt22__move_median_to_firstIN9__gnu_cxx17__normal_iteratorIPN5arrow2io9ReadRangeESt6vectorIS4_SaIS4_EEEENS0_5__ops15_Iter_comp_iterIZNS3_8internal12_GLOBAL__N_117ReadRangeCombiner8CoalesceES8_EUlRKS4_SG_E_EEEvT_SJ_SJ_SJ_T0_.exit.i.preheader

bb.s:                                             ; preds = %bb.q
  %.sroa.057.0.copyload = load <2 x i64>, ptr %.fr26, align 8
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.fr26, ptr noundef nonnull align 8 dereferenceable(16) %i.bv, i64 16, i1 false), !tbaa.struct !358
  store <2 x i64> %.sroa.057.0.copyload, ptr %i.bv, align 8
  br label %_ZSt22__move_median_to_firstIN9__gnu_cxx17__normal_iteratorIPN5arrow2io9ReadRangeESt6vectorIS4_SaIS4_EEEENS0_5__ops15_Iter_comp_iterIZNS3_8internal12_GLOBAL__N_117ReadRangeCombiner8CoalesceES8_EUlRKS4_SG_E_EEEvT_SJ_SJ_SJ_T0_.exit.i.preheader
