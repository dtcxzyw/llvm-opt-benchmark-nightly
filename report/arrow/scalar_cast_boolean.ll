...
begin_hunk_1_@_ZN5arrow7compute8internal15GetBooleanCastsEv:bb.a
  ...
  %i.ge = getelementptr inbounds nuw i8, ptr %9, i64 16 ; 2 uses
...
.body149:                                         ; preds = %_ZNSt12_Vector_baseIN5arrow7compute9InputTypeESaIS2_EED2Ev.exit.i143, %bb.gt
  %.pn61.pn = phi { ptr, i32 } [ %.pn61, %bb.gt ], [ %i.qs, %_ZNSt12_Vector_baseIN5arrow7compute9InputTypeESaIS2_EED2Ev.exit.i143 ]
...
begin_hunk_7_@_ZN5arrow7compute8internal15GetBooleanCastsEv:bb.a
  ...
  %i.vi = getelementptr inbounds nuw i8, ptr %21, i64 16 ; 2 uses
...
_ZNSt10shared_ptrIN5arrow7compute8internal12CastFunctionEEC2ERKS4_.exit: ; preds = %._crit_edge339, %bb.gw, %bb.gx
  ...
  %i.vz = invoke noalias noundef nonnull dereferenceable(16) ptr @_Znwm(i64 noundef 16) #21
          to label %.noexc unwind label %27       ; 3 uses
...
.body202:                                         ; preds = %_ZNSt12_Vector_baseIN5arrow7compute9InputTypeESaIS2_EED2Ev.exit.i196, %bb.jm
  %.pn56.pn = phi { ptr, i32 } [ %.pn56, %bb.jm ], [ %i.yx, %_ZNSt12_Vector_baseIN5arrow7compute9InputTypeESaIS2_EED2Ev.exit.i196 ]
...
27:                                               ; preds = %_ZNSt10shared_ptrIN5arrow7compute8internal12CastFunctionEEC2ERKS4_.exit
...
bb.jz:                                            ; preds = %.body202, %.body149, %.body, %bb.gz, %bb.ee, %bb.bp, %27, %bb.bo, %bb.bl, %bb.bk
  %.pn66.pn.pn.pn.pn = phi { ptr, i32 } [ %i.gp, %bb.bl ], [ %i.gs, %bb.bp ], [ %i.og, %bb.ee ], [ %28, %27 ], [ %.pn, %bb.bo ], [ %i.go, %bb.bk ], [ %i.wl, %bb.gz ], [ %.pn61.pn, %.body149 ], [ %.pn56.pn, %.body202 ], [ %.pn66.pn, %.body ]
