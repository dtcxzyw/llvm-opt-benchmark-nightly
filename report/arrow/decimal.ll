...
bb.f:                                             ; preds = %bb.b
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %3, i8 0, i64 32, i1 false)
  call void @_ZNK5arrow15BasicDecimal25619GetWholeAndFractionEiPS0_S1_(ptr noundef nonnull align 8 dereferenceable(32) %0, i32 noundef %1, ptr noundef nonnull %2, ptr noundef nonnull %3)
  %.sroa.013.0.copyload.a = load i64, ptr %2, align 8
  %.sroa.414.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %2, i64 8
  %4 = load <3 x i64>, ptr %.sroa.414.0..sroa_idx.a, align 8
  ...
  %i.af = uitofp i64 %.sroa.013.0.copyload.a to double
