...
bb.f:                                             ; preds = %bb.b
  ...
  call void @_ZNK5arrow15BasicDecimal25619GetWholeAndFractionEiPS0_S1_(ptr noundef nonnull align 8 dereferenceable(32) %0, i32 noundef %1, ptr noundef nonnull %2, ptr noundef nonnull %3)
  %.sroa.515.0..sroa_idx = getelementptr inbounds nuw i8, ptr %2, i64 16
  %4 = load <2 x i64>, ptr %.sroa.515.0..sroa_idx, align 16
  %5 = uitofp <2 x i64> %4 to <2 x double>
  %6 = fmul nnan <2 x double> %5, <double f0x47F0000000000000, double f0x4BF0000000000000> ; 2 uses
  ...
  %9 = uitofp <2 x i64> %8 to <2 x double>        ; 2 uses
  %10 = extractelement <2 x double> %9, i64 1
  %i.ad = fmul nnan double %10, f0x43F0000000000000
  %i.ae = fadd double %i.ad, %7
  %11 = extractelement <2 x double> %9, i64 0
  %i.af = fadd double %i.ae, %11
  %i.ag = load <4 x i64>, ptr %3, align 8
  %i.ah = sub nsw i32 0, %1                       ; 2 uses
  %i.ai = icmp samesign ult i32 %1, 77
  br i1 %i.ai, label %bb.g, label %bb.h, !prof !28
...
bb.h:                                             ; preds = %bb.f
  ...
  %i.ao = call double @pow(double noundef 1.000000e+01, double noundef %i.an) #26, !tbaa !3
  br label %_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit12
...
bb.i:                                             ; preds = %_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit12, %_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit
  %.0 = phi double [ %i.ac, %_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit ], [ %i.az, %_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit12 ]
  ret double %.0
}
