...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.c, label %bb.c, label %bb.d, !prof !28

bb.c:                                             ; preds = %bb.b
  %i.d = sext i32 %i.a to i64
  %i.e = getelementptr [8 x i8], ptr @_ZN5arrowL18kDoublePowersOfTenE, i64 %i.d
...
bb.d:                                             ; preds = %bb.b
  %i.h = sitofp i32 %i.a to double
  %i.i = tail call double @pow(double noundef 1.000000e+01, double noundef %i.h) #26, !tbaa !3
  br label %_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit
...
_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit: ; preds = %bb.c, %bb.d
  ...
  %i.o = extractelement <4 x double> %i.k, i64 1
  %i.p = fadd double %i.o, %i.n
  %i.q = extractelement <4 x double> %i.j, i64 0
  %i.r = fadd double %i.p, %i.q
  %i.s = fmul double %i.r, %.0.i.i
  br label %bb.h
...
bb.f:                                             ; preds = %bb.e
  %i.ah = sext i32 %i.af to i64
  %i.ai = getelementptr [8 x i8], ptr @_ZN5arrowL18kDoublePowersOfTenE, i64 %i.ah
...
bb.g:                                             ; preds = %bb.e
  %i.al = sitofp i32 %i.af to double
  %i.am = call double @pow(double noundef 1.000000e+01, double noundef %i.al) #26, !tbaa !3
  br label %_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit12

_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit12: ; preds = %bb.f, %bb.g
  %.0.i.i11 = phi double [ %i.ak, %bb.f ], [ %i.am, %bb.g ]
  %i.an = uitofp <4 x i64> %i.ae to <4 x double>  ; 2 uses
  %i.ao = fmul nnan <4 x double> %i.an, <double poison, double f0x43F0000000000000, double f0x47F0000000000000, double f0x4BF0000000000000> ; 3 uses
  %i.ap = extractelement <4 x double> %i.ao, i64 2
  %i.aq = extractelement <4 x double> %i.ao, i64 3
  %i.ar = fadd double %i.ap, %i.aq
  %i.as = extractelement <4 x double> %i.ao, i64 1
  %i.at = fadd double %i.as, %i.ar
  %i.au = extractelement <4 x double> %i.an, i64 0
...
bb.h:                                             ; preds = %_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit12, %_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit
  %.0 = phi double [ %i.s, %_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit ], [ %i.ax, %_ZN5arrow12_GLOBAL__N_124Decimal256RealConversion21ToRealPositiveNoSplitIdEET_RKNS_10Decimal256Ei.exit12 ]
  ret double %.0
}
...
attributes #19 = { mustprogress nocallback nofree nosync nounwind willreturn memory(errnomem: write) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+crc32,+cx8,+fxsr,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87" "tune-cpu"="generic" }
attributes #20 = { mustprogress nocallback nofree nosync nounwind willreturn memory(argmem: write) "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+crc32,+cx8,+fxsr,+mmx,+popcnt,+sse,+sse2,+sse3,+sse4.1,+sse4.2,+ssse3,+x87" "tune-cpu"="generic" }
...
!81 = distinct !{!81, !"_ZN5arrow12_GLOBAL__N_121DecimalRealConversionINS_9Decimal64ENS0_23Decimal64RealConversionEE8FromRealIfEENS_6ResultIS2_EET_ii"}
!82 = !{!83, !85, !80}
!83 = distinct !{!83, !84, !"_ZN5arrow6Status8FromArgsIJRA16_KcRfRA15_S2_EEES0_NS_10StatusCodeEDpOT_: argument 0"}
!84 = distinct !{!84, !"_ZN5arrow6Status8FromArgsIJRA16_KcRfRA15_S2_EEES0_NS_10StatusCodeEDpOT_"}
!85 = distinct !{!85, !86, !"_ZN5arrow6Status7InvalidIJRA16_KcRfRA15_S2_EEES0_DpOT_: argument 0"}
!86 = distinct !{!86, !"_ZN5arrow6Status7InvalidIJRA16_KcRfRA15_S2_EEES0_DpOT_"}
!87 = !{!88}
!88 = distinct !{!88, !89, !"_ZN5arrow12_GLOBAL__N_121DecimalRealConversionINS_9Decimal64ENS0_23Decimal64RealConversionEE8FromRealIdEENS_6ResultIS2_EET_ii: argument 0"}
!89 = distinct !{!89, !"_ZN5arrow12_GLOBAL__N_121DecimalRealConversionINS_9Decimal64ENS0_23Decimal64RealConversionEE8FromRealIdEENS_6ResultIS2_EET_ii"}
!90 = !{!91, !93, !88}
!91 = distinct !{!91, !92, !"_ZN5arrow6Status8FromArgsIJRA16_KcRdRA15_S2_EEES0_NS_10StatusCodeEDpOT_: argument 0"}
!92 = distinct !{!92, !"_ZN5arrow6Status8FromArgsIJRA16_KcRdRA15_S2_EEES0_NS_10StatusCodeEDpOT_"}
!93 = distinct !{!93, !94, !"_ZN5arrow6Status7InvalidIJRA16_KcRdRA15_S2_EEES0_DpOT_: argument 0"}
!94 = distinct !{!94, !"_ZN5arrow6Status7InvalidIJRA16_KcRdRA15_S2_EEES0_DpOT_"}
!95 = distinct !{!95, !67}
!96 = !{!97}
!97 = distinct !{!97, !98, !"_ZN5arrow10Decimal12810FromStringERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE: argument 0"}
!98 = distinct !{!98, !"_ZN5arrow10Decimal12810FromStringERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE"}
!99 = !{!100, !97}
!100 = distinct !{!100, !101, !"_ZN5arrow10Decimal12810FromStringESt17basic_string_viewIcSt11char_traitsIcEE: argument 0"}
!101 = distinct !{!101, !"_ZN5arrow10Decimal12810FromStringESt17basic_string_viewIcSt11char_traitsIcEE"}
!102 = !{!103}
!103 = distinct !{!103, !104, !"_ZN5arrow10Decimal12810FromStringESt17basic_string_viewIcSt11char_traitsIcEE: argument 0"}
!104 = distinct !{!104, !"_ZN5arrow10Decimal12810FromStringESt17basic_string_viewIcSt11char_traitsIcEE"}
!105 = !{!106}
!106 = distinct !{!106, !107, !"_ZN5arrow12_GLOBAL__N_121DecimalRealConversionINS_10Decimal128ENS0_24Decimal128RealConversionEE8FromRealIfEENS_6ResultIS2_EET_ii: argument 0"}
!107 = distinct !{!107, !"_ZN5arrow12_GLOBAL__N_121DecimalRealConversionINS_10Decimal128ENS0_24Decimal128RealConversionEE8FromRealIfEENS_6ResultIS2_EET_ii"}
!108 = !{!109, !111, !106}
!109 = distinct !{!109, !110, !"_ZN5arrow6Status8FromArgsIJRA16_KcRfRA15_S2_EEES0_NS_10StatusCodeEDpOT_: argument 0"}
!110 = distinct !{!110, !"_ZN5arrow6Status8FromArgsIJRA16_KcRfRA15_S2_EEES0_NS_10StatusCodeEDpOT_"}
!111 = distinct !{!111, !112, !"_ZN5arrow6Status7InvalidIJRA16_KcRfRA15_S2_EEES0_DpOT_: argument 0"}
!112 = distinct !{!112, !"_ZN5arrow6Status7InvalidIJRA16_KcRfRA15_S2_EEES0_DpOT_"}
!113 = !{!114}
end_hunk_0
