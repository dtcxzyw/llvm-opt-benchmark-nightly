...
bb.f:                                             ; preds = %bb.b
  ...
  %8 = fadd double %7, %5
  %9 = uitofp i64 %.sroa.414.0.copyload to double
  %i.ad = fmul nnan double %9, f0x43F0000000000000
  %i.ae = fadd double %i.ad, %8
  %10 = uitofp i64 %.sroa.013.0.copyload to double
  %i.af = fadd double %i.ae, %10
