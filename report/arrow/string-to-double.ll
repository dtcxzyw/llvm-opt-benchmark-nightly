...
bb.cq:                                            ; preds = %bb.cm, %bb.cn
  %.promoted485 = phi ptr [ %i.ll, %bb.cn ], [ %i.lg, %bb.cm ] ; 6 uses
...
bb.cu:                                            ; preds = %.preheader, %bb.cy
  ...
  %5 = phi ptr [ %6, %bb.cy ], [ %.promoted485, %.preheader ]
...
split.a:                                          ; preds = %bb.cx
  %.1194.lcssa.ph = phi i32 [ %.1194, %bb.cx ]
  %.lcssa502.ph = phi ptr [ %scevgep539, %bb.cx ]
  br label %bb.cz

._crit_edge798:                                   ; preds = %bb.cy
  %scevgep797.lcssa = phi ptr [ %scevgep797, %bb.cy ]
  %split = phi i32 [ %.1194, %bb.cy ]
  %split799 = phi ptr [ %6, %bb.cy ]              ; 0 uses
  %scevgep799 = getelementptr i8, ptr %scevgep797.lcssa, i64 -1
  br label %bb.cz, !llvm.loop !37

bb.cz:                                            ; preds = %split.a, %._crit_edge798
  %.1194.lcssa = phi i32 [ %split, %._crit_edge798 ], [ %.1194.lcssa.ph, %split.a ] ; 2 uses
  %.lcssa502 = phi ptr [ %scevgep799, %._crit_edge798 ], [ %.lcssa502.ph, %split.a ] ; 2 uses
...
bb.cq:                                            ; preds = %bb.cm, %bb.cn
  %.promoted485 = phi ptr [ %i.kn, %bb.cn ], [ %i.kh, %bb.cm ] ; 4 uses
...
.preheader:                                       ; preds = %.preheader.preheader, %bb.cx
  %lsr.iv820 = phi ptr [ %scevgep819, %.preheader.preheader ], [ %scevgep821, %bb.cx ] ; 4 uses
  %i.kw = phi i16 [ %i.le, %bb.cx ], [ %i.ks, %.preheader.preheader ] ; 2 uses
  %5 = phi ptr [ %6, %bb.cx ], [ %.promoted485, %.preheader.preheader ]
...
bb.cw:                                            ; preds = %bb.cu, %bb.cv
  ...
  %6 = getelementptr inbounds nuw i8, ptr %5, i64 2 ; 3 uses
...
split.a:                                          ; preds = %bb.cx
  %.1194.lcssa.ph = phi i32 [ %.1194, %bb.cx ]
  %lsr.iv820.lcssa822 = phi ptr [ %6, %bb.cx ]
  br label %bb.cy

._crit_edge818:                                   ; preds = %bb.cw
  %lsr.iv820.lcssa = phi ptr [ %lsr.iv820, %bb.cw ]
  %split = phi i32 [ %.1194, %bb.cw ]
  %split819 = phi ptr [ %6, %bb.cw ]              ; 0 uses
  br label %bb.cy

bb.cy:                                            ; preds = %split.a, %._crit_edge818
  %.1194.lcssa = phi i32 [ %split, %._crit_edge818 ], [ %.1194.lcssa.ph, %split.a ] ; 2 uses
...
_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us: ; preds = %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us.preheader, %bb.h
  %i.bg = phi ptr [ %i.bn, %bb.h ], [ %i.be, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us.preheader ] ; 4 uses
...
bb.h:                                             ; preds = %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us
  ...
  %i.bm = add nuw nsw i32 %.2124.us234, 3         ; 2 uses
...
.split:                                           ; preds = %.split.preheader, %bb.m
  ...
  %.2124 = phi i32 [ %i.cj, %bb.m ], [ %.0135.lcssa, %.split.preheader ] ; 4 uses
...
_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexitsplit: ; preds = %bb.h
  ...
  %.us-phi233.ph.ph = phi i1 [ %spec.select203.us, %bb.h ]
...
_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us._ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit_crit_edge: ; preds = %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us
  %.lcssa117 = phi ptr [ %i.bg, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us ]
  %.lcssa115 = phi ptr [ %i.bg, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us ] ; 0 uses
  %.2124.us234.lcssa = phi i32 [ %.2124.us234, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us ]
  %split116 = phi i1 [ %.0121.us235, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us ]
  br label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit
...
_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit: ; preds = %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexitsplit, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us._ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit_crit_edge
  %.promoted.i159.ph = phi ptr [ %.lcssa117, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us._ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit_crit_edge ], [ %.lcssa114, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexitsplit ]
  ...
  %.us-phi233.ph = phi i1 [ %split116, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us._ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit_crit_edge ], [ %.us-phi233.ph.ph, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexitsplit ]
...
_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit82split: ; preds = %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157
  ...
  %.0121.lcssa.ph = phi i1 [ %.0121, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157 ]
  %.promoted.i159.ph83.ph = phi ptr [ %i.bs, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157 ]
...
_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread._ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit82_crit_edge: ; preds = %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread
  %.2124.lcssa113 = phi i32 [ %.2124, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread ]
  %.2124.lcssa111 = phi i32 [ %.2124, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread ] ; 0 uses
  %split110 = phi i1 [ %.0121, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread ]
  %split111 = phi ptr [ %i.cd, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread ]
  br label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit82
...
_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit82: ; preds = %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit82split, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread._ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit82_crit_edge
  %.2124.lcssa = phi i32 [ %.2124.lcssa113, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread._ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit82_crit_edge ], [ %.2124.lcssa110, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit82split ]
  %.0121.lcssa = phi i1 [ %split110, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread._ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit82_crit_edge ], [ %.0121.lcssa.ph, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit82split ]
  %.promoted.i159.ph83 = phi ptr [ %split111, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread._ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit82_crit_edge ], [ %.promoted.i159.ph83.ph, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.loopexit82split ]
  br label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit
