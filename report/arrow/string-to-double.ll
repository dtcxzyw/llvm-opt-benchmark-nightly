...
.split119.us:                                     ; preds = %.backedge.us
  ...
  br i1 %i.dz, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit82, label %.backedge.us, !llvm.loop !53
...
.backedge.us:                                     ; preds = %.split119.us.preheader, %.split119.us
  ...
  br i1 %or.cond19.i84.us, label %.split119.us, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit87, !llvm.loop !53
...
.backedge:                                        ; preds = %bb.ae, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit100
  ...
  br i1 %or.cond19.i84, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i94, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit87, !llvm.loop !53
...
bb.ad:                                            ; preds = %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i94
  ...
  %.pre.pre = load i8, ptr %i.eg, align 1, !tbaa !15 ; 2 uses
...
bb.ae:                                            ; preds = %bb.ad
  %i.eo = load i8, ptr %i.el, align 1, !tbaa !15  ; 4 uses
...
bb.af:                                            ; preds = %.lr.ph.i
  ...
  store ptr %i.ex, ptr %i.a, align 8, !tbaa !7
  %.not.not.i = icmp eq ptr %i.ex, %1
  br i1 %.not.not.i, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit82, label %.lr.ph.i, !llvm.loop !16
...
bb.a:
  ...
  %.promoted = load ptr, ptr %0, align 8, !tbaa !7 ; 4 uses
...
.split.us:                                        ; preds = %.backedge360.us
  ...
  br i1 %i.h, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit.thread, label %.backedge360.us, !llvm.loop !54
...
.backedge360.us:                                  ; preds = %.split.us.preheader, %.split.us
  ...
  br i1 %i.k, label %.split.us, label %.preheader358, !llvm.loop !54
...
.backedge360:                                     ; preds = %.backedge360thread-pre-split, %bb.c
  ...
  br i1 %i.t, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i, label %.preheader358, !llvm.loop !54
...
bb.c:                                             ; preds = %bb.b
  %i.w = load i8, ptr %i.p, align 1, !tbaa !15    ; 2 uses
  %i.x = sext i8 %i.w to i32
  %i.y = icmp eq i32 %i.x, %i.c
  br i1 %i.y, label %bb.d, label %.backedge360

bb.d:                                             ; preds = %bb.c
  %i.z = load i8, ptr %i.u, align 1, !tbaa !15    ; 3 uses
...
bb.e:                                             ; preds = %.preheader358, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175
  ...
  %.0129 = phi i8 [ %.5134, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175 ], [ 0, %.preheader358 ] ; 20 uses
  %.0122 = phi i32 [ %.7, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175 ], [ 0, %.preheader358 ] ; 23 uses
  %.0116 = phi i64 [ %.5, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175 ], [ 0, %.preheader358 ] ; 22 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %.not.i, label %bb.g, label %_ZN14arrow_vendored17double_conversionL24IsCharacterDigitForRadixEiic.exit
...
bb.h:                                             ; preds = %_ZN14arrow_vendored17double_conversionL24IsCharacterDigitForRadixEiic.exit162.thread282
...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %i.m, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.sink.split, label %bb.j, !llvm.loop !55

bb.j:                                             ; preds = %bb.i
  store ptr %i.am, ptr %0, align 8, !tbaa !7
  %i.an = icmp ne ptr %i.am, %1
  %or.cond513.not = select i1 %or.cond.i160, i1 %i.an, i1 false
  br i1 %or.cond513.not, label %bb.k, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175, !llvm.loop !55

bb.k:                                             ; preds = %bb.j
  %i.ao = getelementptr inbounds nuw i8, ptr %.promoted389, i64 2 ; 15 uses
  %i.ap = icmp eq ptr %i.ao, %1
  br i1 %i.ap, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175, label %bb.l, !llvm.loop !55

bb.l:                                             ; preds = %bb.k
  %i.aq = load i8, ptr %i.am, align 1, !tbaa !15
  %i.ar = sext i8 %i.aq to i32
  %i.as = icmp eq i32 %i.c, %i.ar
  br i1 %i.as, label %bb.m, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175, !llvm.loop !55

bb.m:                                             ; preds = %bb.l
  %i.at = load i8, ptr %i.ao, align 1, !tbaa !15  ; 3 uses
  ...
  br i1 %i.ax, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.sink.split, label %switch.early.test349, !llvm.loop !55

switch.early.test349:                             ; preds = %bb.m
  switch i8 %i.at, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175 [
...
.critedge:                                        ; preds = %bb.h, %_ZN14arrow_vendored17double_conversionL24IsCharacterDigitForRadixEiic.exit162.thread282
...
.lr.ph.i:                                         ; preds = %.critedge, %bb.n
  ...
  %i.bb = tail call fastcc noundef zeroext i1 @_ZN14arrow_vendored17double_conversionL12isWhitespaceEi(i32 noundef %i.ba)
  br i1 %i.bb, label %bb.n, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.thread311

bb.n:                                             ; preds = %.lr.ph.i
  %i.bc = getelementptr inbounds nuw i8, ptr %i.ay, i64 1 ; 4 uses
  store ptr %i.bc, ptr %0, align 8, !tbaa !7
...
bb.o:                                             ; preds = %bb.g, %_ZN14arrow_vendored17double_conversionL24IsCharacterDigitForRadixEiic.exit, %bb.e
  %.0137 = phi i64 [ -87, %_ZN14arrow_vendored17double_conversionL24IsCharacterDigitForRadixEiic.exit ], [ -48, %bb.e ], [ -55, %bb.g ]
...
.lr.ph388:                                        ; preds = %.preheader, %.lr.ph388
  ...
  br i1 %i.bm, label %.lr.ph388, label %._crit_edge, !llvm.loop !56
...
bb.p:                                             ; preds = %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread, %._crit_edge
  %i.bt = phi i8 [ %i.af, %._crit_edge ], [ %i.ct, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread ] ; 3 uses
  %i.bu = phi ptr [ %.promoted389, %._crit_edge ], [ %i.cu, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread ] ; 4 uses
  %.1130 = phi i8 [ %.0129, %._crit_edge ], [ %.2131, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread ] ; 2 uses
  %.2124 = phi i32 [ %i.bs, %._crit_edge ], [ %spec.select149, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread ] ; 3 uses
  %.0121 = phi i1 [ true, %._crit_edge ], [ %spec.select328, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread ] ; 2 uses
  br i1 %i.m, label %.split289, label %bb.q

.split289:                                        ; preds = %bb.p
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bu, i64 1 ; 4 uses
  store ptr %i.bv, ptr %0, align 8, !tbaa !7
  %i.bw = icmp eq ptr %i.bv, %1
  br i1 %i.bw, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread287, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread
...
bb.q:                                             ; preds = %bb.p
  ...
  br i1 %i.ca, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i182, label %switch.early.test350

switch.early.test350:                             ; preds = %bb.q
  switch i8 %i.bt, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188 [
...
_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i182: ; preds = %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %switch.early.test350, %bb.q
  %i.cb = getelementptr inbounds nuw i8, ptr %i.bu, i64 1 ; 7 uses
  store ptr %i.cb, ptr %0, align 8, !tbaa !7
  %i.cc = icmp eq ptr %i.cb, %1
  br i1 %i.cc, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread287, label %bb.r

bb.r:                                             ; preds = %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i182
  %i.cd = getelementptr inbounds nuw i8, ptr %i.bu, i64 2 ; 4 uses
  %i.ce = icmp eq ptr %i.cd, %1
  br i1 %i.ce, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.cf = load i8, ptr %i.cb, align 1, !tbaa !15
  %i.cg = sext i8 %i.cf to i32
  %i.ch = icmp eq i32 %i.c, %i.cg
  br i1 %i.ch, label %bb.t, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread

bb.t:                                             ; preds = %bb.s
  %i.ci = load i8, ptr %i.cd, align 1, !tbaa !15  ; 3 uses
  ...
  br i1 %i.cm, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i187, label %switch.early.test351

switch.early.test351:                             ; preds = %bb.t
  switch i8 %i.ci, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread [
...
_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i187: ; preds = %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %switch.early.test351, %bb.t
  store ptr %i.cd, ptr %0, align 8, !tbaa !7
...
_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188: ; preds = %switch.early.test350
  ...
  store ptr %i.cn, ptr %0, align 8, !tbaa !7
  %i.co = icmp eq ptr %i.cn, %1
  br i1 %i.co, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread287, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread

_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread: ; preds = %switch.early.test351, %bb.s, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i187, %bb.r, %.split289, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188
  %i.cp = phi ptr [ %i.cb, %switch.early.test351 ], [ %i.cb, %bb.s ], [ %i.cd, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i187 ], [ %i.cb, %bb.r ], [ %i.bv, %.split289 ], [ %i.cn, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188 ] ; 4 uses
  br i1 %4, label %bb.u, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201thread-pre-split

bb.u:                                             ; preds = %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread
  %i.cq = load i8, ptr %i.cp, align 1, !tbaa !15  ; 2 uses
  %i.cr = icmp eq i8 %i.cq, 46
  br i1 %i.cr, label %bb.v, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201

bb.v:                                             ; preds = %bb.u
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cp, i64 1 ; 2 uses
  store ptr %i.cs, ptr %0, align 8, !tbaa !7
  br label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201thread-pre-split

_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201thread-pre-split: ; preds = %bb.v, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread
  %.ph471 = phi ptr [ %i.cp, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread ], [ %i.cs, %bb.v ] ; 2 uses
  %.2131.ph = phi i8 [ %.1130, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread ], [ 1, %bb.v ]
  %.pr472 = load i8, ptr %.ph471, align 1, !tbaa !15
  br label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201

_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201: ; preds = %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201thread-pre-split, %bb.u
  %i.ct = phi i8 [ %.pr472, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201thread-pre-split ], [ %i.cq, %bb.u ] ; 5 uses
  %i.cu = phi ptr [ %.ph471, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201thread-pre-split ], [ %i.cp, %bb.u ] ; 2 uses
  %.2131 = phi i8 [ %.2131.ph, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201thread-pre-split ], [ %.1130, %bb.u ] ; 2 uses
  ...
  br i1 %i.cy, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread, label %switch.early.test352

switch.early.test352:                             ; preds = %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit201
  switch i8 %i.ct, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread287 [
...
_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread287: ; preds = %switch.early.test352, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i182, %.split289, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188
  %.promoted.i204 = phi ptr [ %i.cu, %switch.early.test352 ], [ %i.cb, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i182 ], [ %i.bv, %.split289 ], [ %i.cn, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188 ] ; 3 uses
  %.not6.not.i205 = icmp eq ptr %.promoted.i204, %1
  %i.dc = or i1 %5, %.not6.not.i205
  %or.cond515 = or i1 %i.dc, %4
  br i1 %or.cond515, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit211, label %.lr.ph.i206

.lr.ph.i206:                                      ; preds = %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread287, %bb.w
  %i.dd = phi ptr [ %i.dh, %bb.w ], [ %.promoted.i204, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread287 ] ; 2 uses
  ...
  br i1 %i.dg, label %bb.w, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.thread311

bb.w:                                             ; preds = %.lr.ph.i206
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dd, i64 1 ; 4 uses
  store ptr %i.dh, ptr %0, align 8, !tbaa !7
  %.not.not.i210 = icmp eq ptr %i.dh, %1
  br i1 %.not.not.i210, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit211, label %.lr.ph.i206, !llvm.loop !16

_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit211: ; preds = %bb.w, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread287
  %i.di = phi ptr [ %.promoted.i204, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit188.thread287 ], [ %i.dh, %bb.w ]
  %i.dj = add nsw i32 %.0135.lcssa, -1
  %i.dk = shl nuw i32 1, %i.dj                    ; 2 uses
end_hunk_0
begin_hunk_1_@_ZN14arrow_vendored17double_conversionL17RadixStringToIeeeILi4EPKcEEdPT0_S4_btbbdbPb:bb.a
bb.ar:                                            ; preds = %bb.aq
  br i1 %2, label %bb.as, label %bb.au

bb.as:                                            ; preds = %bb.ar
  br i1 %i.go, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.thread311, label %bb.at
...
.lr.ph.i.i:                                       ; preds = %bb.av, %.lr.ph.i.i
  ...
  br i1 %i.gu, label %.lr.ph.i.i, label %._crit_edge.i.i, !llvm.loop !59
...
._crit_edge.i.i:                                  ; preds = %.lr.ph.i.i, %bb.av
  ...
  br i1 %i.gv, label %_ZN14arrow_vendored17double_conversion6DoubleC2ENS0_5DiyFpE.exit, label %bb.aw

bb.aw:                                            ; preds = %._crit_edge.i.i
  %i.gw = icmp slt i32 %.015.lcssa.i.i, -1074
  br i1 %i.gw, label %_ZN14arrow_vendored17double_conversion6DoubleC2ENS0_5DiyFpE.exit, label %.preheader.i.i
...
.lr.ph25.i.i:                                     ; preds = %.preheader.i.i, %.lr.ph25.i.i
  ...
  br i1 %i.hg, label %.lr.ph25.i.i, label %._crit_edge26.i.i, !llvm.loop !60
...
_ZN14arrow_vendored17double_conversion6DoubleC2ENS0_5DiyFpE.exit: ; preds = %._crit_edge.i.i, %bb.aw, %._crit_edge26.i.i
...
_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit175.thread311: ; preds = %.lr.ph.i, %.lr.ph.i206, %bb.as, %_ZN14arrow_vendored17double_conversion6DoubleC2ENS0_5DiyFpE.exit, %bb.au, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit.thread
  %.4 = phi double [ %i.ae, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit.thread ], [ -0.000000e+00, %bb.as ], [ %i.hp, %_ZN14arrow_vendored17double_conversion6DoubleC2ENS0_5DiyFpE.exit ], [ %i.gq, %bb.au ], [ %6, %.lr.ph.i206 ], [ %6, %.lr.ph.i ]
  ret double %.4
}
...
.split.us:                                        ; preds = %.backedge.us
  ...
  store ptr %i.g, ptr %0, align 8, !tbaa !7
  %i.h = icmp eq ptr %i.g, %1
  br i1 %i.h, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit, label %.backedge.us, !llvm.loop !61

.backedge.us:                                     ; preds = %.split.us.preheader, %.split.us
  %i.i = phi ptr [ %i.g, %.split.us ], [ %i.e, %.split.us.preheader ] ; 3 uses
  %i.j = load i8, ptr %i.i, align 1, !tbaa !15    ; 2 uses
  %i.k = icmp eq i8 %i.j, 48
  br i1 %i.k, label %.split.us, label %.preheader208, !llvm.loop !61
...
.lr.ph.split:                                     ; preds = %.lr.ph, %.backedge
  ...
  store ptr %i.u, ptr %0, align 8, !tbaa !7
  %i.v = icmp eq ptr %i.u, %1
  br i1 %i.v, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit, label %bb.b, !llvm.loop !61
...
.backedge:                                        ; preds = %.backedgethread-pre-split, %bb.c
  ...
  br i1 %i.y, label %.lr.ph.split, label %.preheader208, !llvm.loop !61
...
bb.c:                                             ; preds = %bb.b
  %i.ab = load i8, ptr %i.u, align 1, !tbaa !15   ; 2 uses
  %i.ac = sext i8 %i.ab to i32
  %i.ad = icmp eq i32 %i.ac, %i.c
  br i1 %i.ad, label %bb.d, label %.backedge

bb.d:                                             ; preds = %bb.c
  %i.ae = load i8, ptr %i.z, align 1, !tbaa !15   ; 2 uses
...
.split178:                                        ; preds = %bb.d
  store ptr %i.z, ptr %0, align 8, !tbaa !7
...
._crit_edge:                                      ; preds = %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit, %.preheader208
  %.0116.lcssa = phi i64 [ 0, %.preheader208 ], [ %i.ar, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit ] ; 2 uses
  %.lcssa214 = phi ptr [ %.promoted225, %.preheader208 ], [ %i.dh, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit ] ; 2 uses
...
bb.e:                                             ; preds = %.lr.ph.i
  ...
  store ptr %i.an, ptr %0, align 8, !tbaa !7
  %.not.not.i = icmp eq ptr %i.an, %1
  br i1 %.not.not.i, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit.thread.thread, label %.lr.ph.i, !llvm.loop !62
...
bb.f:                                             ; preds = %.lr.ph228, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit
  ...
  %.0116227 = phi i64 [ 0, %.lr.ph228 ], [ %i.ar, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit ]
...
.lr.ph232:                                        ; preds = %.preheader, %.lr.ph232
  ...
  br i1 %i.ax, label %.lr.ph232, label %._crit_edge233, !llvm.loop !63
...
.split.us236:                                     ; preds = %._crit_edge233
  ...
  br i1 %i.be, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us
...
_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us: ; preds = %.split.us236, %.split183.us
  ...
  %i.bg = load i8, ptr %i.bf, align 1, !tbaa !15  ; 3 uses
...
.split183.us:                                     ; preds = %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us
  ...
  store ptr %i.bm, ptr %0, align 8, !tbaa !7
  %i.bn = icmp eq ptr %i.bm, %1
  br i1 %i.bn, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us, !llvm.loop !64
...
.split:                                           ; preds = %._crit_edge233, %bb.k
  ...
  store ptr %i.br, ptr %0, align 8, !tbaa !7
...
bb.g:                                             ; preds = %.split
  ...
  br i1 %i.bu, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.bv = load i8, ptr %i.br, align 1, !tbaa !15
  %i.bw = sext i8 %i.bv to i32
  %i.bx = icmp eq i32 %i.bw, %i.r
  br i1 %i.bx, label %bb.i, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread

bb.i:                                             ; preds = %bb.h
  %i.by = load i8, ptr %i.bt, align 1, !tbaa !15  ; 2 uses
...
bb.j:                                             ; preds = %bb.i
  store ptr %i.bt, ptr %0, align 8, !tbaa !7
...
_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread: ; preds = %bb.j, %bb.i, %bb.g, %bb.h, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157
  %i.cc = phi ptr [ %i.bt, %bb.j ], [ %i.br, %bb.i ], [ %i.br, %bb.g ], [ %i.br, %bb.h ], [ %i.br, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157 ] ; 3 uses
  %i.cd = load i8, ptr %i.cc, align 1, !tbaa !15  ; 4 uses
...
_ZN14arrow_vendored17double_conversionL7isDigitEii.exit: ; preds = %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us, %.split183.us, %.split.us236
  %.promoted.i159 = phi ptr [ %i.bm, %.split183.us ], [ %i.bd, %.split.us236 ], [ %i.bf, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us ], [ %i.br, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157 ], [ %i.cc, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread ] ; 2 uses
  %.us-phi = phi i32 [ %i.bl, %.split183.us ], [ %.0135.lcssa, %.split.us236 ], [ %.2124.us238, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread.us ], [ %.2124, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157.thread ], [ %.2124, %_ZN14arrow_vendored17double_conversionL7AdvanceIPcEEbPT_tiRS3_.exit157 ]
...
.lr.ph.i161:                                      ; preds = %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit, %bb.l
  %i.cj = phi ptr [ %i.cn, %bb.l ], [ %.promoted.i159, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit ] ; 2 uses
  %i.ck = load i8, ptr %i.cj, align 1, !tbaa !15
  %i.cl = sext i8 %i.ck to i32
  %i.cm = tail call fastcc noundef zeroext i1 @_ZN14arrow_vendored17double_conversionL12isWhitespaceEi(i32 noundef %i.cl)
  br i1 %i.cm, label %bb.l, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit.thread201
...
bb.n:                                             ; preds = %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit166
  ...
  br i1 %i.cs, label %bb.o, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit.thread
...
bb.p:                                             ; preds = %bb.f
  ...
  store ptr %i.cw, ptr %0, align 8, !tbaa !7
  %i.cx = icmp eq ptr %i.cw, %1                   ; 2 uses
  br i1 %i.s, label %.split189, label %bb.q

.split189:                                        ; preds = %bb.p
  br i1 %i.cx, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit.thread.thread, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit

bb.q:                                             ; preds = %bb.p
  br i1 %i.cx, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit.thread.thread, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.cy = getelementptr inbounds nuw i8, ptr %.promoted235, i64 2 ; 4 uses
  %i.cz = icmp eq ptr %i.cy, %1
  br i1 %i.cz, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.da = load i8, ptr %i.cw, align 1, !tbaa !15
  %i.db = sext i8 %i.da to i32
  %i.dc = icmp eq i32 %i.db, %i.r
  br i1 %i.dc, label %bb.t, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPcEEbPT_S3_.exit

bb.t:                                             ; preds = %bb.s
  %i.dd = load i8, ptr %i.cy, align 1, !tbaa !15  ; 2 uses
...
bb.u:                                             ; preds = %bb.t
  store ptr %i.cy, ptr %0, align 8, !tbaa !7
