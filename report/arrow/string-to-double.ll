...
.lr.ph.i._crit_edge._crit_edge:                   ; preds = %.lr.ph.i._crit_edge.thread, %.lr.ph.i._crit_edge
  %.lcssa427607 = phi ptr [ %1, %.lr.ph.i._crit_edge.thread ], [ %i.w, %.lr.ph.i._crit_edge ] ; 2 uses
...
._crit_edge543:                                   ; preds = %bb.c, %.lr.ph.i._crit_edge._crit_edge
  %.pre-phi561 = phi i64 [ %.pre560, %.lr.ph.i._crit_edge._crit_edge ], [ %5, %bb.c ]
  %i.ag = phi i8 [ %i.ad, %.lr.ph.i._crit_edge._crit_edge ], [ %.pre, %bb.c ] ; 2 uses
  %i.ah = phi ptr [ %.lcssa427607, %.lr.ph.i._crit_edge._crit_edge ], [ %1, %bb.c ] ; 4 uses
...
bb.t:                                             ; preds = %bb.r
  ...
  %i.bo = load ptr, ptr %i.a, align 8             ; 4 uses
...
bb.v:                                             ; preds = %bb.t
  %.promoted.i245530 = ptrtoint ptr %i.bo to i64
...
.lr.ph433.preheader:                              ; preds = %.lr.ph.i247.preheader
  %i.bu = add i64 %5, %i.f                        ; 2 uses
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bo, i64 1 ; 2 uses
  %.not.not.i251683 = icmp eq ptr %i.bv, %i.g
...
_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit252: ; preds = %.lr.ph433.preheader, %.lr.ph433._ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit252.loopexit_crit_edge, %bb.v
  %.pre-phi559 = phi i64 [ %.promoted.i245530, %bb.v ], [ %i.bu, %.lr.ph433._ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit252.loopexit_crit_edge ], [ %i.bu, %.lr.ph433.preheader ]
  %i.cd = sub i64 %.pre-phi559, %5
...
bb.ag:                                            ; preds = %bb.ae
  ...
  %i.da = load ptr, ptr %i.a, align 8             ; 4 uses
...
bb.ai:                                            ; preds = %bb.ag
  %.promoted.i257531 = ptrtoint ptr %i.da to i64
...
.lr.ph438.preheader:                              ; preds = %.lr.ph.i259.preheader
  %i.dg = add i64 %5, %i.f                        ; 2 uses
  %i.dh = getelementptr inbounds nuw i8, ptr %i.da, i64 1 ; 2 uses
  %.not.not.i263684 = icmp eq ptr %i.dh, %i.g
...
_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit264: ; preds = %.lr.ph438.preheader, %.lr.ph438._ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit264.loopexit_crit_edge, %bb.ai
  %.pre-phi557 = phi i64 [ %.promoted.i257531, %bb.ai ], [ %i.dg, %.lr.ph438._ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit264.loopexit_crit_edge ], [ %i.dg, %.lr.ph438.preheader ]
  %i.dp = sub i64 %.pre-phi557, %5
...
.lr.ph.i267.preheader:                            ; preds = %bb.au
  ...
  br i1 %i.fj, label %.lr.ph441.preheader, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit272.loopexit
...
.lr.ph441.preheader:                              ; preds = %.lr.ph.i267.preheader
  ...
  %.not.not.i271685 = icmp eq ptr %i.fm, %i.g
...
.lr.ph.i267:                                      ; preds = %.lr.ph.i267.lr.ph, %.lr.ph441
  ...
  br i1 %i.fq, label %.lr.ph441, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit272.loopexit, !llvm.loop !16
...
_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit272.loopexit: ; preds = %.lr.ph.i267, %._ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit272.loopexit_crit_edge.a, %.lr.ph.i267.preheader
  %6 = phi ptr [ %.promoted.i265, %.lr.ph.i267.preheader ], [ %scevgep534, %._ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit272.loopexit_crit_edge.a ], [ %i.fn, %.lr.ph.i267 ]
  %.pre555 = ptrtoint ptr %6 to i64
...
_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i277: ; preds = %.lr.ph446, %.backedge411
  ...
  br i1 %i.gf, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit281.thread.loopexit651, label %bb.ax
...
bb.ax:                                            ; preds = %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i277
  ...
  %or.cond649 = select i1 %i.gk, i1 %i.gm, i1 false
...
_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit281.thread: ; preds = %.lr.ph446.split.us, %.lr.ph446.split.us.preheader, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit281.thread.loopexit651
  %.us-phi = phi i64 [ %i.gr, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKcEEbPT_tiRS4_.exit281.thread.loopexit651 ], [ %i.fv, %.lr.ph446.split.us.preheader ], [ %i.fv, %.lr.ph446.split.us ]
  %i.gs = sub i64 %.us-phi, %5
...
._crit_edge:                                      ; preds = %.backedge411, %.backedge411.us, %bb.ap, %bb.aw
  %.lcssa445 = phi ptr [ %.promoted444, %bb.aw ], [ %.promoted444, %bb.ap ], [ %i.ga, %.backedge411.us ], [ %i.gh, %.backedge411 ] ; 3 uses
...
.critedge227:                                     ; preds = %bb.aj, %._crit_edge
  %i.gx = phi i8 [ %i.ds, %bb.aj ], [ %.pre549, %._crit_edge ] ; 3 uses
  %.promoted451 = phi ptr [ %i.dr, %bb.aj ], [ %.lcssa445, %._crit_edge ] ; 2 uses
  %i.gy = phi i8 [ 0, %bb.aj ], [ %i.gw, %._crit_edge ] ; 2 uses
...
bb.az:                                            ; preds = %.lr.ph459, %.backedge410
  %i.he = phi i8 [ %i.gx, %.lr.ph459 ], [ %i.hw, %.backedge410 ] ; 2 uses
  ...
  %.0182455 = phi i8 [ %i.gy, %.lr.ph459 ], [ %i.hs, %.backedge410 ]
...
.critedge:                                        ; preds = %.backedge410, %.critedge227
  ...
  %.0182.lcssa = phi i8 [ %i.gy, %.critedge227 ], [ %i.hs, %.backedge410 ]
  ...
  %.lcssa = phi i8 [ %i.gx, %.critedge227 ], [ %i.hw, %.backedge410 ]
...
bb.br:                                            ; preds = %bb.bo
  ...
  %or.cond650 = select i1 %i.in, i1 %i.iz, i1 false
...
bb.by:                                            ; preds = %bb.bx
  ...
  br i1 %i.jz, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread608, label %.backedge
...
bb.ca:                                            ; preds = %bb.bz
  br i1 %i.ki, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread608, label %.backedge

_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i295: ; preds = %bb.bz
  br i1 %i.ki, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread608, label %bb.cb
...
.lr.ph489.preheader:                              ; preds = %.lr.ph.i302.preheader
  ...
  %.not.not.i306686 = icmp eq ptr %i.ms, %i.g
...
.lr.ph492.preheader:                              ; preds = %.lr.ph.i310.preheader
  ...
  %.not.not.i314687 = icmp eq ptr %i.nf, %i.g
...
bb.dh:                                            ; preds = %bb.cv, %bb.cq, %bb.cl, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread608, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384, %bb.dg
  ...
  %i.ob = phi i32 [ %.0170.lcssa, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384 ], [ %i.oa, %bb.dg ], [ %i.nm, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread608 ], [ %i.ld, %bb.cl ], [ %i.lj, %bb.cq ], [ %i.lr, %bb.cv ]
  %i.oc = add nsw i32 %.5190390614, 1
  %i.od = sext i32 %.5190390614 to i64
...
bb.di:                                            ; preds = %bb.cv, %bb.cq, %bb.cl, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread608, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384, %bb.dh, %bb.dg
  %.6191 = phi i32 [ %i.oc, %bb.dh ], [ %.5190, %bb.dg ], [ %.0185.lcssa, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384 ], [ %.3188, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread608 ], [ %.4189, %bb.cl ], [ %.4189, %bb.cq ], [ %.4189, %bb.cv ] ; 5 uses
  %.9 = phi i32 [ %i.of, %bb.dh ], [ %i.oa, %bb.dg ], [ %.0170.lcssa, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384 ], [ %i.nm, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread608 ], [ %i.ld, %bb.cl ], [ %i.lj, %bb.cq ], [ %i.lr, %bb.cv ]
  ...
  br i1 %i.oi, label %.lr.ph690, label %_ZN14arrow_vendored17double_conversion17TrimTrailingZerosENS0_6VectorIKcEE.exit
...
bb.dk:                                            ; preds = %.lr.ph690, %bb.dj
  %i.om = phi i32 [ %.6191, %.lr.ph690 ], [ %i.ok, %bb.dj ]
  %indvars.iv.i688 = phi i64 [ %i.oj, %.lr.ph690 ], [ %i.on, %bb.dj ]
  %i.on = add nsw i64 %indvars.iv.i688, -1        ; 3 uses
...
_ZN14arrow_vendored17double_conversion17TrimTrailingZerosENS0_6VectorIKcEE.exit: ; preds = %bb.dj, %._ZN14arrow_vendored17double_conversion17TrimTrailingZerosENS0_6VectorIKcEE.exit_crit_edge691, %bb.di
  %.sroa.3.1.i = phi i32 [ 0, %bb.di ], [ %i.om, %._ZN14arrow_vendored17double_conversion17TrimTrailingZerosENS0_6VectorIKcEE.exit_crit_edge691 ], [ 0, %bb.dj ] ; 3 uses
