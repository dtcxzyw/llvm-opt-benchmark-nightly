...
bb.az:                                            ; preds = %.lr.ph460, %.backedge411
  ...
  %.0173457 = phi i8 [ 0, %.lr.ph460 ], [ %.1174, %.backedge411 ] ; 2 uses
...
bb.bb:                                            ; preds = %bb.az
  ...
  %5 = trunc nuw i8 %.0173457 to i1
  %i.ho = icmp ne i8 %i.hg, 48
  %narrow405 = or i1 %i.ho, %5
  %6 = zext i1 %narrow405 to i8
  br label %bb.bc

bb.bc:                                            ; preds = %bb.bb, %bb.ba
  %.1186 = phi i32 [ %i.hj, %bb.ba ], [ %.0185455, %bb.bb ] ; 5 uses
  %.1174 = phi i8 [ %.0173457, %bb.ba ], [ %6, %bb.bb ] ; 5 uses
...
.critedge:                                        ; preds = %.backedge411, %.critedge227
  ...
  %.0185.lcssa = phi i32 [ 0, %.critedge227 ], [ %.1186, %.backedge411 ] ; 5 uses
  %.0182.lcssa = phi i8 [ %i.ha, %.critedge227 ], [ %i.ht, %.backedge411 ]
  %.0173.lcssa = phi i8 [ 0, %.critedge227 ], [ %.1174, %.backedge411 ] ; 4 uses
  %.0170.lcssa = phi i32 [ 0, %.critedge227 ], [ %.1171, %.backedge411 ] ; 6 uses
...
bb.bu:                                            ; preds = %.lr.ph479, %.backedge
  ...
  %.2175475 = phi i8 [ %.0173.lcssa, %.lr.ph479 ], [ %.3176, %.backedge ] ; 2 uses
...
bb.bx:                                            ; preds = %bb.bw, %bb.bv
  %.3188 = phi i32 [ %i.js, %bb.bv ], [ %.2187474, %bb.bw ] ; 3 uses
  %.3176 = phi i8 [ %.2175475, %bb.bv ], [ %8, %bb.bw ] ; 3 uses
...
.critedge11:                                      ; preds = %.critedge11.loopexit, %.critedge
  %i.ks = phi ptr [ %.lcssa453, %.critedge ], [ %.lcssa472, %.critedge11.loopexit ] ; 6 uses
...
bb.cj:                                            ; preds = %bb.ci
  ...
  br i1 %i.lc, label %bb.ck, label %bb.cm

bb.ck:                                            ; preds = %bb.cj
  br i1 %i.k, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384.sink.split, label %bb.cl
...
bb.cn:                                            ; preds = %bb.cm, %bb.cm
  ...
  br i1 %i.lh, label %bb.co, label %bb.cq

bb.co:                                            ; preds = %bb.cn
  br i1 %i.k, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384.sink.split, label %bb.cp
...
bb.cq:                                            ; preds = %bb.cm, %bb.cn
  ...
  br i1 %i.lk, label %bb.cs, label %bb.cr
...
bb.cs:                                            ; preds = %bb.cr, %bb.cq
  br i1 %i.k, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384.sink.split, label %bb.ct
...
_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384.sink.split: ; preds = %bb.cs, %bb.co, %bb.ck
...
_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384: ; preds = %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384.sink.split, %bb.bp
  %.5190.ph383 = phi i32 [ %.0185.lcssa, %bb.bp ], [ %.4189, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384.sink.split ]
  %.5178.ph = phi i8 [ %.0173.lcssa, %bb.bp ], [ %.4177, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384.sink.split ]
  %.8164.ph = phi i32 [ 0, %bb.bp ], [ %.4160, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384.sink.split ]
...
_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.sink.split: ; preds = %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i286, %bb.bh, %bb.bf, %.lr.ph.i310, %.lr.ph.i310.preheader, %._ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.loopexit_crit_edge
  ...
  %.5178.ph693 = phi i8 [ %.4177, %.lr.ph.i310 ], [ %.4177, %.lr.ph.i310.preheader ], [ %.4177, %._ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.loopexit_crit_edge ], [ %.1174, %bb.bf ], [ %.1174, %bb.bh ], [ %.1174, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i286 ]
...
_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315: ; preds = %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.sink.split, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit307
  ...
  %.5178 = phi i8 [ %.4177, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit307 ], [ %.5178.ph693, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.sink.split ]
...
bb.dd:                                            ; preds = %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread609, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315
  %11 = phi i32 [ %9, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384 ], [ %10, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315 ], [ %i.nj, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread609 ] ; 2 uses
  %.5178391 = phi i8 [ %.5178.ph, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384 ], [ %.5178, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315 ], [ %.3176, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread609 ]
  %.5190390 = phi i32 [ %.5190.ph383, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread384 ], [ %.5190, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315 ], [ %.3188, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKcEEbPT_S4_.exit315.thread609 ] ; 3 uses
  %12 = trunc nuw i8 %.5178391 to i1
  br i1 %12, label %bb.de, label %bb.df
...
bb.df:                                            ; preds = %bb.de, %bb.dd
  %.6191 = phi i32 [ %i.nx, %bb.de ], [ %.5190390, %bb.dd ] ; 5 uses
  %.9 = phi i32 [ %i.oa, %bb.de ], [ %11, %bb.dd ]
...
bb.bx:                                            ; preds = %bb.bw, %bb.bv
  %.3188 = phi i32 [ %i.jg, %bb.bv ], [ %.2187474, %bb.bw ] ; 3 uses
  %.3176 = phi i8 [ %.2175475, %bb.bv ], [ %8, %bb.bw ] ; 3 uses
...
.critedge11:                                      ; preds = %.critedge11.loopexit, %.critedge
  %i.kb = phi ptr [ %.lcssa453, %.critedge ], [ %.lcssa472, %.critedge11.loopexit ] ; 6 uses
  %.4189 = phi i32 [ %.0185.lcssa, %.critedge ], [ %.2187.lcssa, %.critedge11.loopexit ] ; 6 uses
  %.4177 = phi i8 [ %.0173.lcssa, %.critedge ], [ %.2175.lcssa, %.critedge11.loopexit ] ; 5 uses
  %.4169 = phi i32 [ %.0165.lcssa, %.critedge ], [ %.2167.lcssa, %.critedge11.loopexit ]
  %.4160 = phi i32 [ 0, %.critedge ], [ %.2158.lcssa, %.critedge11.loopexit ] ; 4 uses
...
bb.cj:                                            ; preds = %bb.ci
  ...
  br i1 %i.kl, label %bb.ck, label %bb.cm

bb.ck:                                            ; preds = %bb.cj
  br i1 %i.j, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384.sink.split, label %bb.cl
...
bb.cn:                                            ; preds = %bb.cm, %bb.cm
  ...
  br i1 %i.kr, label %bb.co, label %bb.cq

bb.co:                                            ; preds = %bb.cn
  br i1 %i.j, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384.sink.split, label %bb.cp
...
bb.cq:                                            ; preds = %bb.cm, %bb.cn
  ...
  br i1 %i.ku, label %bb.cs, label %bb.cr
...
bb.cs:                                            ; preds = %bb.cr, %bb.cq
  br i1 %i.j, label %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384.sink.split, label %bb.ct
...
_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384.sink.split: ; preds = %bb.cs, %bb.co, %bb.ck
...
_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384: ; preds = %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384.sink.split, %bb.bp
  %.5190.ph383 = phi i32 [ %.0185.lcssa, %bb.bp ], [ %.4189, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384.sink.split ]
  %.5178.ph = phi i8 [ %.0173.lcssa, %bb.bp ], [ %.4177, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384.sink.split ]
  %.8164.ph = phi i32 [ 0, %bb.bp ], [ %.4160, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384.sink.split ]
  %9 = add nsw i32 %.8164.ph, %.0170.lcssa
  br label %bb.dc
...
_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.sink.split: ; preds = %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i286, %bb.bh, %bb.bf, %.lr.ph.i310, %.lr.ph.i310.preheader, %._ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.loopexit_crit_edge
  ...
  %.5178.ph685 = phi i8 [ %.4177, %.lr.ph.i310 ], [ %.4177, %.lr.ph.i310.preheader ], [ %.4177, %._ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.loopexit_crit_edge ], [ %.1174, %bb.bf ], [ %.1174, %bb.bh ], [ %.1174, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i286 ]
...
_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315: ; preds = %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.sink.split, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit307
  ...
  %.5178 = phi i8 [ %.4177, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit307 ], [ %.5178.ph685, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.sink.split ]
...
bb.dc:                                            ; preds = %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread597, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315
  %11 = phi i32 [ %9, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384 ], [ %10, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315 ], [ %i.ml, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread597 ] ; 2 uses
  %.5178391 = phi i8 [ %.5178.ph, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384 ], [ %.5178, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315 ], [ %.3176, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread597 ]
  %.5190390 = phi i32 [ %.5190.ph383, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread384 ], [ %.5190, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315 ], [ %.3188, %_ZN14arrow_vendored17double_conversionL17AdvanceToNonspaceIPKtEEbPT_S4_.exit315.thread597 ] ; 3 uses
  %12 = trunc nuw i8 %.5178391 to i1
  br i1 %12, label %bb.dd, label %bb.de
...
bb.de:                                            ; preds = %bb.dd, %bb.dc
  %.6191 = phi i32 [ %i.nb, %bb.dd ], [ %.5190390, %bb.dc ] ; 5 uses
  %.9 = phi i32 [ %i.ne, %bb.dd ], [ %11, %bb.dc ]
