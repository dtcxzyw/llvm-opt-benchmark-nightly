...
.split.us:                                        ; preds = %.lr.ph, %.backedge361.us
  ...
  br i1 %i.f, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit.thread.split.us, label %.backedge361.us
...
_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit.thread.split.us: ; preds = %.split.us
...
_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i: ; preds = %.lr.ph, %.backedge361
  ...
  br i1 %i.m, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit.thread, label %12

.backedge361thread-pre-split:                     ; preds = %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i, %switch.early.test, %12
  %.ph = phi ptr [ %i.l, %12 ], [ %i.l, %switch.early.test ], [ %13, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i ] ; 2 uses
  %.pr = load i16, ptr %.ph, align 2, !tbaa !39
...
.backedge361:                                     ; preds = %.backedge361thread-pre-split, %bb.b
  ...
  br i1 %i.n, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i, label %.preheader359, !llvm.loop !72

12:                                               ; preds = %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i
  %13 = getelementptr inbounds nuw i8, ptr %i.k, i64 4 ; 4 uses
  %14 = icmp eq ptr %13, %1
  br i1 %14, label %.backedge361thread-pre-split, label %bb.b

bb.b:                                             ; preds = %12
  %i.o = load i16, ptr %i.l, align 2, !tbaa !39   ; 2 uses
  %i.p = icmp eq i16 %i.o, %3
  br i1 %i.p, label %bb.c, label %.backedge361

bb.c:                                             ; preds = %bb.b
  %i.q = load i16, ptr %13, align 2, !tbaa !39
...
_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i: ; preds = %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %switch.early.test, %bb.c
  store ptr %13, ptr %0, align 8, !tbaa !38
  br label %.backedge361thread-pre-split

_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit.thread: ; preds = %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit.thread.split.us
...
bb.d:                                             ; preds = %.preheader359, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit177
  ...
  %.promoted392 = phi ptr [ %i.cz, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit177 ], [ %.promoted388, %.preheader359 ] ; 9 uses
...
.lr.ph396:                                        ; preds = %_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit252, %.backedge
  ...
  store ptr %i.eb, ptr %0, align 8, !tbaa !38
...
.split326:                                        ; preds = %.lr.ph396
  br i1 %i.ec, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit279.thread, label %.backedge

.backedge:                                        ; preds = %bb.aj, %bb.ai, %switch.early.test357, %.split326, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
  %i.ed = phi ptr [ %i.eb, %.split326 ], [ %i.eb, %bb.aj ], [ %i.eg, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a ], [ %i.eb, %switch.early.test357 ], [ %i.eb, %bb.ai ] ; 2 uses
  %i.ee = load i16, ptr %i.ed, align 2, !tbaa !39 ; 2 uses
  %i.ef = add i16 %i.ee, -48
  %or.cond.i266 = icmp ult i16 %i.ef, 10
  br i1 %or.cond.i266, label %.lr.ph396, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit279.thread, !llvm.loop !76

_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i273: ; preds = %.lr.ph396
  br i1 %i.ec, label %_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit279.thread, label %bb.ai
...
bb.ak:                                            ; preds = %bb.aj
  ...
  br i1 %or.cond19.i26.i275, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a, label %switch.early.test357

switch.early.test357:                             ; preds = %bb.ak
  switch i16 %.fr408, label %.backedge [
    i16 102, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 101, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 100, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 99, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 98, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 97, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 70, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 69, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 68, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 67, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 66, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
    i16 65, label %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a
  ]

_ZN14arrow_vendored17double_conversionL7isDigitEii.exit30.thread.i278.a: ; preds = %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %switch.early.test357, %bb.ak
  store ptr %i.eg, ptr %0, align 8, !tbaa !38
  br label %.backedge

_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit279.thread: ; preds = %.backedge, %.split326, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i273, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit252
  %.2113 = phi i32 [ 0, %_ZN14arrow_vendored17double_conversionL7AdvanceIPKtEEbPT_tiRS4_.exit252 ], [ %.1112, %_ZN14arrow_vendored17double_conversionL7isDigitEii.exit.thread.i273 ], [ %.1112, %.split326 ], [ %.1112, %.backedge ] ; 2 uses
