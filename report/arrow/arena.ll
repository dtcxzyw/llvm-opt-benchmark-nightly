Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/arrow/original/arena?download=true
...
.lr.ph.split.us:                                  ; preds = %.lr.ph, %.thread137.us
  %.091183.us = phi i64 [ %i.x, %.thread137.us ], [ 0, %.lr.ph ] ; 4 uses
  %i.h = icmp ult i64 %.091183.us, %i.b
  %i.i = add i64 %.091183.us, %i.e                ; 2 uses
  %.not111.us = icmp ult i64 %i.i, %i.b
  %i.j = select i1 %.not111.us, i64 0, i64 %i.b
  %spec.select.us = sub nuw i64 %i.i, %i.j
  %.088.us = select i1 %i.h, i64 %spec.select.us, i64 %.091183.us
  %i.k = getelementptr inbounds nuw [8 x i8], ptr %i.f, i64 %.088.us
...
bb.d:                                             ; preds = %.thread.us
  ...
  %i.n = load i8, ptr %i.m, align 4, !tbaa !55, !range !23, !noundef !24
...
mi_arena_id_is_suitable.exit.i.us:                ; preds = %.thread.us, %bb.d
  ...
  %i.q = load i8, ptr %i.p, align 4, !tbaa !22, !range !23, !noundef !24
...
bb.e:                                             ; preds = %.thread.i.us
  ...
  %i.t = load i32, ptr %i.s, align 8, !tbaa !79   ; 2 uses
...
.thread137.us:                                    ; preds = %bb.f, %bb.e, %mi_arena_id_is_suitable.exit.i.us, %bb.d, %.lr.ph.split.us
  %i.x = add nuw i64 %.091183.us, 1               ; 2 uses
...
.lr.ph.split.split.preheader:                     ; preds = %.lr.ph.split
  ...
  %i.z = load i8, ptr %i.y, align 4, !tbaa !55, !range !23, !noundef !24
...
bb.k:                                             ; preds = %.lr.ph192
  %.not226 = icmp eq i64 %i.ae, 1
  %.not116.peel = icmp ult i64 %i.ai, %i.af
  %i.ak = select i1 %.not116.peel, i64 0, i64 %i.af
  %spec.select120.peel = sub nuw i64 %i.ai, %i.ak
  %.0.peel = select i1 %.not226, i64 0, i64 %spec.select120.peel
  %i.al = getelementptr inbounds nuw [8 x i8], ptr %i.aj, i64 %.0.peel
...
.thread157.peel.a:                                ; preds = %.lr.ph192, %bb.k
  %.086160.peel = phi ptr [ %i.am, %bb.k ], [ %4, %.lr.ph192 ] ; 5 uses
  br i1 %3, label %bb.m, label %bb.l

bb.l:                                             ; preds = %.thread157.peel.a
  %i.an = getelementptr inbounds nuw i8, ptr %.086160.peel, i64 20
  %i.ao = load i8, ptr %i.an, align 4, !tbaa !55, !range !23, !noundef !24
  %i.ap = trunc nuw i8 %i.ao to i1
  br i1 %i.ap, label %.thread163.peel, label %bb.m

bb.m:                                             ; preds = %bb.l, %.thread157.peel.a
  %i.aq = icmp eq ptr %.086160.peel, %4
...
mi_arena_id_is_suitable.exit.i127.peel:           ; preds = %bb.n
  %i.ar = getelementptr inbounds nuw i8, ptr %.086160.peel, i64 52
  %i.as = load i8, ptr %i.ar, align 4, !tbaa !22, !range !23, !noundef !24
  %i.at = trunc nuw i8 %i.as to i1
  br i1 %i.at, label %.thread163.peel, label %.thread.i128.peel

.thread.i128.peel:                                ; preds = %mi_arena_id_is_suitable.exit.i127.peel
  %i.au = getelementptr inbounds nuw i8, ptr %.086160.peel, i64 48
  %i.av = load i32, ptr %i.au, align 8, !tbaa !79 ; 2 uses
...
bb.o:                                             ; preds = %.thread.i128.peel, %bb.m
  %i.ay = tail call fastcc ptr @mi_arena_try_alloc_at(ptr noundef %.086160.peel, i64 noundef %1, i1 noundef zeroext %2, i64 noundef %5, ptr noundef %7) ; 2 uses
...
.peel.next:                                       ; preds = %.thread163.peel, %.thread163
  %.087191 = phi i64 [ %i.bp, %.thread163 ], [ 1, %.thread163.peel ] ; 4 uses
  br i1 %.not115, label %bb.p, label %.thread180

bb.p:                                             ; preds = %.peel.next
  %i.az = icmp ult i64 %.087191, %i.af
  %i.ba = add i64 %.087191, %i.ai                 ; 2 uses
  %.not116 = icmp ult i64 %i.ba, %i.af
  %i.bb = select i1 %.not116, i64 0, i64 %i.af
  %spec.select120 = sub nuw i64 %i.ba, %i.bb
  %.0 = select i1 %i.az, i64 %spec.select120, i64 %.087191
  %i.bc = getelementptr inbounds nuw [8 x i8], ptr %i.aj, i64 %.0
...
bb.q:                                             ; preds = %.thread157.a
  ...
  %i.bf = load i8, ptr %i.be, align 4, !tbaa !55, !range !23, !noundef !24
...
mi_arena_id_is_suitable.exit.i127:                ; preds = %.thread157.a, %bb.q
  ...
  %i.bi = load i8, ptr %i.bh, align 4, !tbaa !22, !range !23, !noundef !24
...
.thread.i128:                                     ; preds = %mi_arena_id_is_suitable.exit.i127
  ...
  %i.bl = load i32, ptr %i.bk, align 8, !tbaa !79 ; 2 uses
...
.thread163:                                       ; preds = %.thread.i128, %mi_arena_id_is_suitable.exit.i127, %bb.q, %bb.p, %bb.r
  %i.bp = add nuw i64 %.087191, 1                 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  br i1 %i.i, label %.split57, label %.split58
...
bb.d:                                             ; preds = %.split58, %.split57, %.split, %mi_bbitmap_try_find_and_clearN.exit
  %i.m = load i64, ptr %i.a, align 8, !tbaa !25   ; 3 uses
  %i.n = shl i64 %i.m, 16
  ...
  store i32 %i.q, ptr %.sroa.5.0..sroa_idx, align 4, !tbaa !15
  ...
  %i.s = load i8, ptr %i.r, align 4, !tbaa !55, !range !23, !noundef !24
  %i.t = getelementptr inbounds nuw i8, ptr %4, i64 20
  store i8 %i.s, ptr %i.t, align 4, !tbaa !27
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 22
  %i.v = load i8, ptr %i.u, align 2, !tbaa !120, !range !23, !noundef !24
...
bb.e:                                             ; preds = %bb.d
  ...
  store i8 %i.ab, ptr %i.aa, align 2, !tbaa !75
...
bb.f:                                             ; preds = %bb.e, %bb.d
  %.0 = phi i64 [ %i.ad, %bb.e ], [ %1, %bb.d ]   ; 2 uses
...
bb.k:                                             ; preds = %bb.h
  ...
  %i.au = load i64, ptr %i.a, align 8, !tbaa !25
...
.critedge:                                        ; preds = %.thread, %bb.l, %bb.m
  ...
  store i8 1, ptr %i.bd, align 1, !tbaa !74
  br label %mi_bbitmap_try_find_and_clearN.exit.thread
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.bp = load i64, ptr %i.d, align 8, !tbaa !25
  %i.bq = shl i64 %i.bp, 16
  call void @__mi_stat_decrease_mt(ptr noundef nonnull %i.bo, i64 noundef %i.bq) #14
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #14
  br label %mi_bbitmap_try_find_and_clearN.exit.thread

mi_bbitmap_try_find_and_clearN.exit.thread:       ; preds = %bb.b, %bb.k, %.split58, %.split57, %.split, %.critedge, %bb.n, %bb.o, %mi_bbitmap_try_find_and_clearN.exit
  %.4 = phi ptr [ null, %mi_bbitmap_try_find_and_clearN.exit ], [ null, %bb.k ], [ %i.o, %.critedge ], [ %i.o, %bb.n ], [ %i.o, %bb.o ], [ null, %.split58 ], [ null, %.split ], [ null, %.split57 ], [ null, %bb.b ]
