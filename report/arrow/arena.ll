...
begin_hunk_0_@mi_arena_reload:bb.a
  br label %bb.n

bb.n:                                             ; preds = %bb.m, %bb.l
  %i.j = load atomic i64, ptr %i.h monotonic, align 8 ; 2 uses
...
bb.o:                                             ; preds = %.critedge.i, %.lr.ph.i
  %.03339.i = phi i64 [ 0, %.lr.ph.i ], [ %i.q, %.critedge.i ] ; 2 uses
  %i.l = getelementptr inbounds nuw [8 x i8], ptr %i.k, i64 %.03339.i ; 2 uses
  %i.m = load atomic ptr, ptr %i.l monotonic, align 8
  %i.n = icmp eq ptr %i.m, null
  br i1 %i.n, label %bb.p, label %.critedge.i

bb.p:                                             ; preds = %bb.o
  %i.o = cmpxchg ptr %i.l, ptr null, ptr %0 release monotonic, align 8
  %i.p = extractvalue { ptr, i1 } %i.o, 1
  br i1 %i.p, label %bb.q, label %.critedge.i

bb.q:                                             ; preds = %bb.p
  br i1 %.not, label %bb.s, label %.sink.split

.critedge.i:                                      ; preds = %bb.p, %bb.o
  %i.q = add nuw i64 %.03339.i, 1                 ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.q, %i.j
  br i1 %exitcond.not.i, label %._crit_edge.i, label %bb.o, !llvm.loop !91

._crit_edge.i:                                    ; preds = %.critedge.i, %bb.n
  %i.r = atomicrmw add ptr %i.h, i64 1 acq_rel, align 8 ; 2 uses
  %i.s = icmp ugt i64 %i.r, 159
  br i1 %i.s, label %mi_arenas_add.exit, label %bb.r

bb.r:                                             ; preds = %._crit_edge.i
  %i.t = load ptr, ptr %i.i, align 8, !tbaa !58
  %i.u = getelementptr inbounds nuw i8, ptr %i.t, i64 2312
  tail call void @__mi_stat_counter_increase_mt(ptr noundef nonnull %i.u, i64 noundef 1) #14
  %i.v = getelementptr inbounds nuw i8, ptr %i.h, i64 8
  %i.w = getelementptr inbounds nuw [8 x i8], ptr %i.v, i64 %i.r
  store atomic ptr %0, ptr %i.w release, align 8
  br i1 %.not, label %bb.s, label %.sink.split

mi_arenas_add.exit:                               ; preds = %._crit_edge.i
  %i.x = atomicrmw sub ptr %i.h, i64 1 acq_rel, align 8 ; 0 uses
  store ptr null, ptr %i.i, align 8, !tbaa !58
  br label %.loopexit
...
bb.s:                                             ; preds = %.sink.split, %bb.r, %bb.q
  ...
  %i.aa = tail call zeroext i1 @_mi_bitmap_forall_set(ptr noundef %i.z, ptr noundef nonnull @mi_arena_page_register, ptr noundef nonnull %0, ptr noundef null) #14 ; 0 uses
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 120
  br label %bb.t

bb.t:                                             ; preds = %bb.s, %bb.v
  %.03342 = phi i64 [ 0, %bb.s ], [ %i.aj, %bb.v ] ; 3 uses
  %i.ac = getelementptr inbounds nuw [8 x i8], ptr %i.ab, i64 %.03342
  %i.ad = load ptr, ptr %i.ac, align 8, !tbaa !46
  %i.ae = tail call i64 @mi_bitmap_popcount(ptr noundef %i.ad) #14
  %.not40 = icmp eq i64 %i.ae, 0
  br i1 %.not40, label %bb.v, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.af = load ptr, ptr %i.i, align 8, !tbaa !58
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 1336
  %i.ah = getelementptr inbounds nuw [8 x i8], ptr %i.ag, i64 %.03342
  %i.ai = atomicrmw sub ptr %i.ah, i64 1 acq_rel, align 8 ; 0 uses
  br label %bb.v
...
define internal fastcc ptr @mi_arenas_try_find_free(ptr nofree noundef captures(none) %0, i64 noundef range(i64 0, 18014398509481984) %1, i1 noundef zeroext %2, i1 noundef zeroext %3, ptr noundef %4, i64 noundef %5, i32 noundef %6, ptr nofree noundef writeonly captures(none) %7) unnamed_addr #7 {
bb.a:
  %i.a = load atomic i64, ptr %0 monotonic, align 8 ; 3 uses
  %i.b = tail call i64 @llvm.usub.sat.i64(i64 %i.a, i64 1) ; 5 uses
...
bb.k:                                             ; preds = %.lr.ph192
  ...
  br i1 %.not118.peel, label %.thread163.peel, label %.thread157.peel

.thread157.peel:                                  ; preds = %.lr.ph192, %bb.k
  %.087160.peel = phi ptr [ %i.am, %bb.k ], [ %4, %.lr.ph192 ] ; 5 uses
  br i1 %3, label %bb.m, label %bb.l

bb.l:                                             ; preds = %.thread157.peel
...
bb.m:                                             ; preds = %bb.l, %.thread157.peel
...
bb.p:                                             ; preds = %.peel.next
  ...
  br i1 %.not118, label %.thread163, label %.thread157

.thread157:                                       ; preds = %bb.p
  br i1 %3, label %mi_arena_id_is_suitable.exit.i127, label %bb.q

bb.q:                                             ; preds = %.thread157
...
mi_arena_id_is_suitable.exit.i127:                ; preds = %.thread157, %bb.q
