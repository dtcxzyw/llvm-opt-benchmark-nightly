...
begin_hunk_0_@mi_abandoned_visit_blocks:bb.a
  ...
  %i.am = call zeroext i1 %i.aj(ptr noundef null, ptr noundef nonnull %5, ptr noundef null, i64 noundef %i.ak, ptr noundef %i.al) #15
...
begin_hunk_1_@mi_abandoned_visit_blocks:bb.a
  ...
  br i1 %i.au, label %.lr.ph65, label %._crit_edge66, !llvm.loop !113
...
begin_hunk_2_@abandoned_page_visit_at:bb.a
  ...
  %i.m = call zeroext i1 %i.h(ptr noundef null, ptr noundef nonnull %4, ptr noundef null, i64 noundef %i.j, ptr noundef %i.l) #15
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  br i1 %exitcond.not, label %bb.o, label %bb.p, !llvm.loop !114
...
bb.v:                                             ; preds = %bb.s
  ...
  br i1 %exitcond63.not, label %.loopexit, label %bb.s, !llvm.loop !115
...
bb.v:                                             ; preds = %bb.u, %bb.t
  ...
  br i1 %exitcond.not, label %.loopexit, label %bb.t, !llvm.loop !116
...
.thread138.us:                                    ; preds = %bb.f, %bb.e, %mi_arena_id_is_suitable.exit.i.us, %bb.d, %.lr.ph.split.us
  ...
  br i1 %exitcond.not, label %.thread155, label %.lr.ph.split.us, !llvm.loop !117
...
.thread164:                                       ; preds = %.thread.i129, %mi_arena_id_is_suitable.exit.i128, %bb.q, %bb.p, %bb.r
  ...
  br i1 %exitcond209.not, label %.thread181, label %.peel.next, !llvm.loop !118
...
begin_hunk_8_@mi_arena_try_alloc_at:bb.a
  ...
  %i.v = load i8, ptr %i.u, align 2, !tbaa !119, !range !18, !noundef !19
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.ax = call zeroext i1 %i.au(i1 noundef zeroext true, ptr noundef nonnull %.179107, i64 noundef %spec.select, ptr noundef nonnull %i.a, ptr noundef %i.aw) #15
...
begin_hunk_11_@mi_arenas_page_alloc_fresh:bb.a
  ...
  store i8 %i.bd, ptr %i.bk, align 1, !tbaa !123
  %i.bl = call range(i64 0, 65) i64 @llvm.ctpop.i64(i64 %1)
  %or.cond120 = icmp eq i64 %i.bl, 1
  br i1 %or.cond120, label %bb.u, label %bb.v

bb.u:                                             ; preds = %bb.t
  %i.bm = call i64 asm "tzcnt\09$1, $0", "=r,r,0,~{cc},~{dirflag},~{fpsr},~{flags}"(i64 range(i64 1, 0) %1, i64 64) #17, !srcloc !124
...
bb.v:                                             ; preds = %bb.t, %bb.u
  ...
  store i8 %.sink, ptr %i.bo, align 2, !tbaa !125
...
begin_hunk_12_@mi_arena_try_purge_visitor:bb.a
  ...
  br i1 %exitcond.not, label %.loopexit, label %bb.d, !llvm.loop !126
...
!116 = distinct !{!116, !49}
!117 = distinct !{!117, !49}
!118 = distinct !{!118, !49, !98}
!119 = !{!12, !9, i64 22}
!120 = !{!121}
!121 = distinct !{!121, !122, !"_mi_memid_none: argument 0"}
!122 = distinct !{!122, !"_mi_memid_none"}
!123 = !{!34, !9, i64 57}
!124 = !{i64 421076}
!125 = !{!34, !5, i64 22}
!126 = distinct !{!126, !49}
