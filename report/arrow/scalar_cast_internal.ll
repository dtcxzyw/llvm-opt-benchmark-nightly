...
vector.ph2113:                                    ; preds = %vector.main.loop.iter.check2111
  ...
  %n.vec2115 = and i64 %i.th, 9223372036854775792 ; 5 uses
  %i.tx = shl nuw i64 %n.vec2115, 1               ; 2 uses
  %i.ty = getelementptr i8, ptr %i.tl, i64 %i.tx
  %i.tz = getelementptr i8, ptr %i.tq, i64 %i.tx
  br label %vector.body2116

vector.body2116:                                  ; preds = %vector.body2116, %vector.ph2113
  %index2117 = phi i64 [ 0, %vector.ph2113 ], [ %index.next2124, %vector.body2116 ] ; 2 uses
  %offset.idx2118 = shl i64 %index2117, 1         ; 2 uses
  %next.gep2119 = getelementptr i8, ptr %i.tl, i64 %offset.idx2118 ; 2 uses
  %next.gep2121 = getelementptr i8, ptr %i.tq, i64 %offset.idx2118 ; 2 uses
...
vec.epilog.ph2134:                                ; preds = %vector.main.loop.iter.check2111, %vec.epilog.iter.check2132
  ...
  %n.vec2136 = and i64 %i.th, 9223372036854775804 ; 4 uses
  %i.ud = shl nuw i64 %n.vec2136, 1               ; 2 uses
  %i.ue = getelementptr i8, ptr %i.tl, i64 %i.ud
  %i.uf = getelementptr i8, ptr %i.tq, i64 %i.ud
  br label %vec.epilog.vector.body2137

vec.epilog.vector.body2137:                       ; preds = %vec.epilog.vector.body2137, %vec.epilog.ph2134
  %index2138 = phi i64 [ %vec.epilog.resume.val2127, %vec.epilog.ph2134 ], [ %index.next2142, %vec.epilog.vector.body2137 ] ; 2 uses
  %i.ug = shl i64 %index2138, 1                   ; 2 uses
  %next.gep2139 = getelementptr i8, ptr %i.tl, i64 %i.ug
  %next.gep2140 = getelementptr i8, ptr %i.tq, i64 %i.ug
...
vector.ph1994:                                    ; preds = %vector.memcheck1989
  %n.vec1996 = and i64 %i.aei, 9223372036854775800 ; 4 uses
  %i.aey = shl i64 %n.vec1996, 2                  ; 2 uses
  %i.aez = getelementptr i8, ptr %i.aem, i64 %i.aey
  %i.afa = getelementptr i8, ptr %i.aer, i64 %i.aey
  br label %vector.body1997

vector.body1997:                                  ; preds = %vector.body1997, %vector.ph1994
  %index1998 = phi i64 [ 0, %vector.ph1994 ], [ %index.next2005, %vector.body1997 ] ; 2 uses
  %offset.idx1999 = shl i64 %index1998, 2         ; 2 uses
  %next.gep2000 = getelementptr i8, ptr %i.aem, i64 %offset.idx1999 ; 2 uses
  %next.gep2002 = getelementptr i8, ptr %i.aer, i64 %offset.idx1999 ; 2 uses
...
vector.ph1972:                                    ; preds = %.lr.ph.preheader.i75.i83
  %n.vec1974 = and i64 %i.ahc, 9223372036854775800 ; 4 uses
  %i.ahm = shl i64 %n.vec1974, 2                  ; 2 uses
  %i.ahn = getelementptr i8, ptr %i.ahg, i64 %i.ahm
  %i.aho = getelementptr i8, ptr %i.ahl, i64 %i.ahm
...
vector.body1975:                                  ; preds = %vector.body1975, %vector.ph1972
  ...
  %offset.idx1977 = shl i64 %index1976, 2         ; 2 uses
  %next.gep1978 = getelementptr i8, ptr %i.ahg, i64 %offset.idx1977 ; 2 uses
  %next.gep1980 = getelementptr i8, ptr %i.ahl, i64 %offset.idx1977 ; 2 uses
...
vector.ph1668:                                    ; preds = %vector.main.loop.iter.check
  ...
  %n.vec1670 = and i64 %i.bkj, 9223372036854775792 ; 5 uses
  %i.bkz = shl nuw i64 %n.vec1670, 1              ; 2 uses
  %i.bla = getelementptr i8, ptr %i.bkn, i64 %i.bkz
  %i.blb = getelementptr i8, ptr %i.bks, i64 %i.bkz
  br label %vector.body1671

vector.body1671:                                  ; preds = %vector.body1671, %vector.ph1668
  %index1672 = phi i64 [ 0, %vector.ph1668 ], [ %index.next1679, %vector.body1671 ] ; 2 uses
  %offset.idx1673 = shl i64 %index1672, 1         ; 2 uses
  %next.gep1674 = getelementptr i8, ptr %i.bkn, i64 %offset.idx1673 ; 2 uses
  %next.gep1676 = getelementptr i8, ptr %i.bks, i64 %offset.idx1673 ; 2 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec1685 = and i64 %i.bkj, 9223372036854775804 ; 4 uses
  %i.blf = shl nuw i64 %n.vec1685, 1              ; 2 uses
  %i.blg = getelementptr i8, ptr %i.bkn, i64 %i.blf
  %i.blh = getelementptr i8, ptr %i.bks, i64 %i.blf
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index1686 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next1690, %vec.epilog.vector.body ] ; 2 uses
  %i.bli = shl i64 %index1686, 1                  ; 2 uses
  %next.gep1687 = getelementptr i8, ptr %i.bkn, i64 %i.bli
  %next.gep1688 = getelementptr i8, ptr %i.bks, i64 %i.bli
...
vector.ph1550:                                    ; preds = %vector.memcheck
  %n.vec1552 = and i64 %i.bvk, 9223372036854775800 ; 4 uses
  %i.bwa = shl i64 %n.vec1552, 2                  ; 2 uses
  %i.bwb = getelementptr i8, ptr %i.bvo, i64 %i.bwa
  %i.bwc = getelementptr i8, ptr %i.bvt, i64 %i.bwa
  br label %vector.body1553

vector.body1553:                                  ; preds = %vector.body1553, %vector.ph1550
  %index1554 = phi i64 [ 0, %vector.ph1550 ], [ %index.next1561, %vector.body1553 ] ; 2 uses
  %offset.idx1555 = shl i64 %index1554, 2         ; 2 uses
  %next.gep1556 = getelementptr i8, ptr %i.bvo, i64 %offset.idx1555 ; 2 uses
  %next.gep1558 = getelementptr i8, ptr %i.bvt, i64 %offset.idx1555 ; 2 uses
...
vector.ph1511:                                    ; preds = %.lr.ph.preheader.i75.i392
  %n.vec1513 = and i64 %i.cay, 9223372036854775800 ; 4 uses
  %i.cbi = shl i64 %n.vec1513, 2                  ; 2 uses
  %i.cbj = getelementptr i8, ptr %i.cbc, i64 %i.cbi
  %i.cbk = getelementptr i8, ptr %i.cbh, i64 %i.cbi
  br label %vector.body1514

vector.body1514:                                  ; preds = %vector.body1514, %vector.ph1511
  %index1515 = phi i64 [ 0, %vector.ph1511 ], [ %index.next1522, %vector.body1514 ] ; 2 uses
  %offset.idx1516 = shl i64 %index1515, 2         ; 2 uses
  %next.gep1517 = getelementptr i8, ptr %i.cbc, i64 %offset.idx1516 ; 2 uses
  %next.gep1519 = getelementptr i8, ptr %i.cbh, i64 %offset.idx1516 ; 2 uses
...
vector.ph1397:                                    ; preds = %.lr.ph.preheader.i82.i461
  %n.vec1399 = and i64 %i.cky, 9223372036854775804 ; 4 uses
  %i.cli = shl i64 %n.vec1399, 3                  ; 2 uses
  %i.clj = getelementptr i8, ptr %i.clc, i64 %i.cli
  %i.clk = getelementptr i8, ptr %i.clh, i64 %i.cli
  br label %vector.body1400

vector.body1400:                                  ; preds = %vector.body1400, %vector.ph1397
  %index1401 = phi i64 [ 0, %vector.ph1397 ], [ %index.next1408, %vector.body1400 ] ; 2 uses
  %offset.idx1402 = shl i64 %index1401, 3         ; 2 uses
  %next.gep1403 = getelementptr i8, ptr %i.clc, i64 %offset.idx1402 ; 2 uses
  %next.gep1405 = getelementptr i8, ptr %i.clh, i64 %offset.idx1402 ; 2 uses
...
vector.ph1359:                                    ; preds = %.lr.ph.preheader.i48.i583
  %n.vec1361 = and i64 %i.cog, 9223372036854775800 ; 4 uses
  %i.coq = shl i64 %n.vec1361, 2                  ; 2 uses
  %i.cor = getelementptr i8, ptr %i.cok, i64 %i.coq
  %i.cos = getelementptr i8, ptr %i.cop, i64 %i.coq
  br label %vector.body1362

vector.body1362:                                  ; preds = %vector.body1362, %vector.ph1359
  %index1363 = phi i64 [ 0, %vector.ph1359 ], [ %index.next1370, %vector.body1362 ] ; 2 uses
  %offset.idx1364 = shl i64 %index1363, 2         ; 2 uses
  %next.gep1365 = getelementptr i8, ptr %i.cok, i64 %offset.idx1364 ; 2 uses
  %next.gep1367 = getelementptr i8, ptr %i.cop, i64 %offset.idx1364 ; 2 uses
...
vector.ph1321:                                    ; preds = %.lr.ph.preheader.i70.i553
  %n.vec1323 = and i64 %i.crn, 9223372036854775800 ; 4 uses
  %i.crx = shl i64 %n.vec1323, 2                  ; 2 uses
  %i.cry = getelementptr i8, ptr %i.crr, i64 %i.crx
  %i.crz = getelementptr i8, ptr %i.crw, i64 %i.crx
  br label %vector.body1324

vector.body1324:                                  ; preds = %vector.body1324, %vector.ph1321
  %index1325 = phi i64 [ 0, %vector.ph1321 ], [ %index.next1332, %vector.body1324 ] ; 2 uses
  %offset.idx1326 = shl i64 %index1325, 2         ; 2 uses
  %next.gep1327 = getelementptr i8, ptr %i.crr, i64 %offset.idx1326 ; 2 uses
  %next.gep1329 = getelementptr i8, ptr %i.crw, i64 %offset.idx1326 ; 2 uses
