...
bb.c:                                             ; preds = %.lr.ph328
  ...
  br i1 %.not8.i71, label %._crit_edge357, label %.lr.ph328, !llvm.loop !89

_ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit75: ; preds = %.lr.ph328
...
.preheader301:                                    ; preds = %.preheader301.lr.ph, %_ZN14arrow_vendored10fast_float6bigint3addEm.exit132
  %.0356 = phi ptr [ %.10326, %.preheader301.lr.ph ], [ %.2.lcssa, %_ZN14arrow_vendored10fast_float6bigint3addEm.exit132 ] ; 5 uses
...
._crit_edge357:                                   ; preds = %bb.c, %_ZN14arrow_vendored10fast_float6bigint3addEm.exit132, %._crit_edge, %_ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit75
  %i.ig = getelementptr inbounds nuw i8, ptr %1, i64 48
  %i.ih = load ptr, ptr %i.ig, align 8, !tbaa !98 ; 5 uses
...
bb.o:                                             ; preds = %._crit_edge357
  ...
  %i.ij = load i64, ptr %i.ii, align 8, !tbaa !87 ; 2 uses
...
._crit_edge376:                                   ; preds = %bb.p, %.lr.ph375, %.preheader296
  ...
  br i1 %.not8.i380, label %_ZN14arrow_vendored10fast_float12is_truncatedIcEEbPKT_S4_.exit, label %.lr.ph383
...
bb.q:                                             ; preds = %.lr.ph383
  ...
  br i1 %.not8.i, label %_ZN14arrow_vendored10fast_float12is_truncatedIcEEbPKT_S4_.exit, label %.lr.ph383, !llvm.loop !89

_ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit: ; preds = %.lr.ph383, %bb.o
...
bb.u:                                             ; preds = %.lr.ph104
  ...
  br i1 %5, label %.lr.ph104, label %.critedge.i.i.us, !llvm.loop !117

.critedge.i.i.us:                                 ; preds = %bb.u, %bb.t
  %6 = icmp ult i16 %i.co, 62
  br i1 %6, label %_ZN14arrow_vendored10fast_float8stackvecILt62EE8try_pushEm.exit.thread.i.i.us.a, label %_ZN14arrow_vendored10fast_float8stackvecILt62EE10try_extendENS0_4spanImEE.exit

_ZN14arrow_vendored10fast_float8stackvecILt62EE8try_pushEm.exit.thread.i.i.us.a: ; preds = %.critedge.i.i.us
  %i.de = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %i.db
  store i64 1, ptr %i.de, align 8, !tbaa !72
  %7 = add nuw nsw i16 %i.co, 1                   ; 2 uses
  store i16 %7, ptr %i.a, align 8, !tbaa !91
...
.lr.ph104:                                        ; preds = %bb.t, %bb.u
  ...
  %8 = load i64, ptr %i.df, align 8, !tbaa !72
  %9 = tail call { i64, i1 } @llvm.uadd.with.overflow.i64(i64 %8, i64 1) ; 2 uses
  %10 = extractvalue { i64, i1 } %9, 1
  %11 = extractvalue { i64, i1 } %9, 0
  store i64 %11, ptr %i.df, align 8, !tbaa !72
  br i1 %10, label %bb.u, label %.critedge.us, !llvm.loop !117

.critedge.us:                                     ; preds = %.lr.ph104, %_ZN14arrow_vendored10fast_float8stackvecILt62EE8try_pushEm.exit.thread.i.i.us.a, %._crit_edge.i49.us, %bb.q, %.lr.ph.split.us
  %i.dg = phi i16 [ %i.aq, %.lr.ph.split.us ], [ %i.co, %bb.q ], [ %7, %_ZN14arrow_vendored10fast_float8stackvecILt62EE8try_pushEm.exit.thread.i.i.us.a ], [ %i.co, %._crit_edge.i49.us ], [ %i.co, %.lr.ph104 ]
