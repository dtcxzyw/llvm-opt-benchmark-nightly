...
.lr.ph..critedge.loopexit_crit_edge:              ; preds = %.lr.ph
  %.0254.lcssa.a = phi ptr [ %.0254, %.lr.ph ]
  br label %.critedge.loopexit

.critedge.loopexit:                               ; preds = %.critedge.loopexitsplit, %.lr.ph..critedge.loopexit_crit_edge
  %.1.ph = phi ptr [ %.0254.lcssa.a, %.lr.ph..critedge.loopexit_crit_edge ], [ %scevgep, %.critedge.loopexitsplit ]
  br label %.critedge
...
.lr.ph261..critedge.i_crit_edge:                  ; preds = %.lr.ph261
  %.1191258.lcssa.a = phi ptr [ %.1191258, %.lr.ph261 ]
  br label %.critedge.i

.critedge.i:                                      ; preds = %.critedge.isplit, %.lr.ph261..critedge.i_crit_edge
  %.lcssa548 = phi i1 [ %i.z, %.lr.ph261..critedge.i_crit_edge ], [ %i.z, %.critedge.isplit ]
  %.1191.lcssa.ph = phi ptr [ %.1191258.lcssa.a, %.lr.ph261..critedge.i_crit_edge ], [ %scevgep385, %.critedge.isplit ] ; 7 uses
  %.0182.lcssa.ph = phi i64 [ %.0182259, %.lr.ph261..critedge.i_crit_edge ], [ %i.ad, %.critedge.isplit ] ; 4 uses
...
.lr.ph279:                                        ; preds = %.lr.ph279.preheader, %bb.l
  ...
  %.10200277 = phi ptr [ %i.bm, %bb.l ], [ %.11201.lcssa, %.lr.ph279.preheader ] ; 3 uses
...
.lr.ph279.._crit_edge.loopexit_crit_edge:         ; preds = %.lr.ph279
  %.10200277.lcssa.a = phi ptr [ %.10200277, %.lr.ph279 ]
  br label %._crit_edge.loopexit

._crit_edge.loopexit:                             ; preds = %._crit_edge.loopexitsplit, %.lr.ph279.._crit_edge.loopexit_crit_edge
  %.10200.lcssa.ph = phi ptr [ %.10200277.lcssa.a, %.lr.ph279.._crit_edge.loopexit_crit_edge ], [ %scevgep387, %._crit_edge.loopexitsplit ] ; 2 uses
  %.6188.lcssa.ph = phi i64 [ %.6188278, %.lr.ph279.._crit_edge.loopexit_crit_edge ], [ %i.bp, %._crit_edge.loopexitsplit ]
...
.lr.ph288:                                        ; preds = %.lr.ph288.preheader, %bb.x
  ...
  %.9199286 = phi ptr [ %i.cr, %bb.x ], [ %.4194, %.lr.ph288.preheader ] ; 3 uses
...
.lr.ph288..critedge7.i_crit_edge:                 ; preds = %.lr.ph288
  %.9199286.lcssa.a = phi ptr [ %.9199286, %.lr.ph288 ]
  br label %.critedge7.i

.critedge7.i:                                     ; preds = %.critedge7.isplit, %.lr.ph288..critedge7.i_crit_edge
  %.9199.lcssa.ph = phi ptr [ %.9199286.lcssa.a, %.lr.ph288..critedge7.i_crit_edge ], [ %scevgep389, %.critedge7.isplit ]
  %.076.i.lcssa.ph = phi i64 [ %.076.i287, %.lr.ph288..critedge7.i_crit_edge ], [ %.177.i, %.critedge7.isplit ] ; 2 uses
...
.lr.ph324:                                        ; preds = %.lr.ph324.preheader, %.noexc
  %lsr.iv564 = phi i64 [ %lsr.iv562, %.lr.ph324.preheader ], [ %lsr.iv.next565, %.noexc ]
  %lsr.iv560 = phi i64 [ %lsr.iv558, %.lr.ph324.preheader ], [ %lsr.iv.next561, %.noexc ]
...
.lr.ph332..critedge2.i.loopexit_crit_edge:        ; preds = %.lr.ph332
  %.10331.lcssa.a = phi ptr [ %.10331, %.lr.ph332 ]
  br label %.critedge2.i.loopexit

.critedge2.i.loopexit:                            ; preds = %.critedge2.i.loopexitsplit, %.lr.ph332..critedge2.i.loopexit_crit_edge
  %.6208.lcssa.ph = phi i64 [ %.6208330, %.lr.ph332..critedge2.i.loopexit_crit_edge ], [ %i.fy, %.critedge2.i.loopexitsplit ]
  %.10.lcssa.ph = phi ptr [ %.10331.lcssa.a, %.lr.ph332..critedge2.i.loopexit_crit_edge ], [ %scevgep393, %.critedge2.i.loopexitsplit ] ; 2 uses
...
.lr.ph341..critedge4.i_crit_edge:                 ; preds = %.lr.ph341
  %.9339.lcssa.a = phi ptr [ %.9339, %.lr.ph341 ]
  br label %.critedge4.i

.critedge4.i:                                     ; preds = %.critedge4.isplit, %.lr.ph341..critedge4.i_crit_edge
  %.9.lcssa.ph = phi ptr [ %.9339.lcssa.a, %.lr.ph341..critedge4.i_crit_edge ], [ %scevgep395, %.critedge4.isplit ]
  %.069.i.lcssa.ph = phi i64 [ %.069.i340, %.lr.ph341..critedge4.i_crit_edge ], [ %.170.i, %.critedge4.isplit ] ; 2 uses
...
_ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit75: ; preds = %_ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit75split, %.lr.ph329._ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit75_crit_edge
  %.10.lcssa = phi ptr [ %.10327.lcssa.a, %.lr.ph329._ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit75_crit_edge ], [ %scevgep, %_ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit75split ] ; 2 uses
...
_ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit.loopexit: ; preds = %_ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit.loopexitsplit, %.lr.ph384._ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit.loopexit_crit_edge
  %.3.ph = phi ptr [ %.8382.lcssa.a, %.lr.ph384._ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit.loopexit_crit_edge ], [ %scevgep456, %_ZN14arrow_vendored10fast_float10skip_zerosIcEEvRPKT_S4_.exit.loopexitsplit ]
