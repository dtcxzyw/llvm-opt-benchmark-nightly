...
bb.g:                                             ; preds = %bb.f
  ...
  %narrow48.i.i = add nuw nsw i8 %i.m, %narrow.i.i
  %i.s = zext nneg i8 %narrow48.i.i to i16
...
bb.i:                                             ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i.i
  ...
  %i.au = add nuw nsw i8 %i.as, %narrow.i10.i.i   ; 3 uses
  %i.av = add i8 %i.al, -13
...
bb.q:                                             ; preds = %bb.p, %bb.p
  ...
  br i1 %.not76.i, label %bb.r, label %.thread.i
...
bb.r:                                             ; preds = %bb.q
  ...
  br i1 %i.cu, label %bb.s, label %bb.u
...
bb.u:                                             ; preds = %.thread.i, %bb.r
  %i.db = phi i8 [ %i.cx, %.thread.i ], [ %i.ct, %bb.r ] ; 2 uses
...
bb.v:                                             ; preds = %bb.u, %bb.u
  ...
  br i1 %i.di, label %bb.w, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146

bb.w:                                             ; preds = %bb.v
  %i.dj = add i8 %i.db, -48                       ; 2 uses
  %narrow.i.i.i = mul nuw nsw i8 %i.dh, 10
  %i.dk = icmp ugt i8 %i.dj, 9
  %i.dl = add nuw nsw i8 %narrow.i.i.i, %i.dj     ; 2 uses
  %i.dm = icmp ugt i8 %i.dl, 23
  %or.cond.i.i = select i1 %i.dk, i1 true, i1 %i.dm, !prof !151
  br i1 %or.cond.i.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, label %bb.x, !prof !151
...
bb.x:                                             ; preds = %bb.w
  ...
  br i1 %.not76.i, label %bb.am, label %bb.y
...
bb.aa:                                            ; preds = %bb.z, %bb.z
  ...
  br i1 %i.dx, label %bb.ab, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146

bb.ab:                                            ; preds = %bb.aa
  %i.dy = add i8 %i.de, -48                       ; 2 uses
  %narrow.i.i79.i = mul nuw nsw i8 %i.dw, 10
  %i.dz = icmp ult i8 %i.dy, 10
  %i.ea = add nuw nsw i8 %narrow.i.i79.i, %i.dy   ; 2 uses
  br i1 %i.dz, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i80.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i80.i: ; preds = %bb.ab
  ...
  br i1 %i.ee, label %bb.ac, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
bb.ac:                                            ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i80.i
  ...
  %i.eh = add nuw nsw i8 %narrow.i8.i81.i, %i.ef  ; 2 uses
  br i1 %i.eg, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i.i: ; preds = %bb.ac
  ...
  br i1 %or.cond6.i.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, label %bb.ad, !prof !153
...
bb.ad:                                            ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i.i
  ...
  %spec.select162.i = select i1 %i.ep, i64 %i.eq, i64 %i.eo
  store i64 %spec.select162.i, ptr %6, align 8, !tbaa !72
  br i1 %.not76.i, label %bb.am, label %bb.ae
...
bb.ag:                                            ; preds = %bb.af, %bb.af
  ...
  br i1 %i.eu, label %bb.ah, label %bb.am
...
bb.ah:                                            ; preds = %bb.ag
  ...
  br i1 %i.ew, label %bb.ai, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !106
...
bb.ak:                                            ; preds = %bb.aj, %bb.ai
  br i1 %.not76.i, label %bb.am, label %bb.al

bb.al:                                            ; preds = %bb.ak
  store i8 1, ptr %5, align 1, !tbaa !49
  br label %bb.am

bb.am:                                            ; preds = %bb.al, %bb.ak, %bb.ag, %bb.af, %bb.ae, %bb.ad, %bb.y, %bb.x, %bb.t, %bb.s
  %.064.i = phi i64 [ %i.da, %bb.t ], [ %i.cz, %bb.s ], [ %i.dc, %bb.y ], [ %i.dc, %bb.x ], [ %i.dr, %bb.ae ], [ %i.dr, %bb.ad ], [ %i.er, %bb.al ], [ %i.er, %bb.ak ], [ %2, %bb.ag ], [ %2, %bb.af ] ; 6 uses
  switch i64 %.064.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i [
    i64 13, label %bb.an
    i64 16, label %bb.ap
    i64 19, label %bb.at
    i64 21, label %bb.at
...
bb.an:                                            ; preds = %bb.am
  ...
  br i1 %i.fd, label %bb.ao, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
bb.ao:                                            ; preds = %bb.an
  ...
  %i.fi = add nuw nsw i8 %i.fg, %narrow.i.i83.i   ; 2 uses
  %i.fj = icmp ugt i8 %i.fi, 23
  %or.cond.i84.i = select i1 %i.fh, i1 true, i1 %i.fj, !prof !151
  br i1 %or.cond.i84.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, label %_ZN5arrow8internal6detailL7ParseHHINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit85.i, !prof !151
...
bb.ap:                                            ; preds = %bb.am
  ...
  br i1 %.not.i86.i, label %bb.aq, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !106
...
bb.aq:                                            ; preds = %bb.ap
  ...
  br i1 %i.fr, label %bb.ar, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %i.fw = add nuw nsw i8 %i.fu, %narrow.i.i88.i   ; 2 uses
  br i1 %i.fv, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i89.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i89.i: ; preds = %bb.ar
  ...
  br i1 %i.ga, label %bb.as, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
bb.as:                                            ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i89.i
  ...
  %i.gf = add nuw nsw i8 %i.gd, %narrow.i10.i90.i ; 2 uses
  br i1 %i.ge, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit11.i.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit11.i.i: ; preds = %bb.as
  ...
  br i1 %or.cond8.i.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, label %_ZN5arrow8internal6detailL10ParseHH_MMINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit.i, !prof !153
...
bb.at:                                            ; preds = %bb.am, %bb.am, %bb.am, %bb.am, %bb.am, %bb.am, %bb.am, %bb.am, %bb.am, %bb.am
  ...
  br i1 %.not.i91.i, label %bb.au, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !106

bb.au:                                            ; preds = %bb.at
  %i.gq = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.gr = load i8, ptr %i.gq, align 1, !tbaa !29
  %.not7.i93.i = icmp eq i8 %i.gr, 58
  br i1 %.not7.i93.i, label %bb.av, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !106

bb.av:                                            ; preds = %bb.au
  %i.gs = load i8, ptr %i.gn, align 1, !tbaa !29
  %i.gt = add i8 %i.gs, -48                       ; 2 uses
  %i.gu = icmp ult i8 %i.gt, 10
  br i1 %i.gu, label %bb.aw, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
bb.aw:                                            ; preds = %bb.av
  ...
  %i.gz = add nuw nsw i8 %i.gx, %narrow.i.i94.i   ; 2 uses
  br i1 %i.gy, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i95.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i95.i: ; preds = %bb.aw
  ...
  br i1 %i.hd, label %bb.ax, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
bb.ax:                                            ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i95.i
  ...
  %i.hi = add nuw nsw i8 %i.hg, %narrow.i15.i.i   ; 2 uses
  br i1 %i.hh, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i.i: ; preds = %bb.ax
  ...
  br i1 %i.hm, label %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !146
...
_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i.i: ; preds = %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i.i
  ...
  br i1 %or.cond13.i.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, label %_ZN5arrow8internal6detailL13ParseHH_MM_SSINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit.i, !prof !153
...
bb.ay:                                            ; preds = %_ZN5arrow8internal6detailL13ParseHH_MM_SSINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit.i, %_ZN5arrow8internal6detailL10ParseHH_MMINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit.i, %_ZN5arrow8internal6detailL7ParseHHINSt6chrono8durationIlSt5ratioILl1ELl1EEEEEEbPKcPT_.exit85.i
  ...
  %i.id = add nsw i64 %i.ic, %.sroa.0109.0.i
  ...
  br i1 %i.if, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, label %bb.az, !prof !140

bb.az:                                            ; preds = %bb.ay
  %i.ih = icmp samesign ult i64 %.064.i, 20
  br i1 %i.ih, label %bb.ba, label %bb.bd

bb.ba:                                            ; preds = %bb.az
  switch i32 %3, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97.i [
    i32 3, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i100.i
    i32 1, label %bb.bb
    i32 2, label %bb.bc
  ]
...
bb.bb:                                            ; preds = %bb.ba
  ...
  br i1 %i.ij, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97.i, !prof !144
...
bb.bc:                                            ; preds = %bb.ba
  ...
  br i1 %i.im, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97.i, !prof !144
...
_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i100.i: ; preds = %bb.ba
  ...
  br i1 %i.ip, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97.i, !prof !144
...
_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97.i: ; preds = %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i100.i, %bb.bc, %bb.bb, %bb.ba
  ...
  store i64 %.pn25.i.i8.i98.i, ptr %4, align 8, !tbaa !72
  br label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i

bb.bd:                                            ; preds = %bb.az
  %i.ir = getelementptr inbounds nuw i8, ptr %1, i64 19
  %i.is = load i8, ptr %i.ir, align 1, !tbaa !29
  %.not77.i = icmp eq i8 %i.is, 46
  br i1 %.not77.i, label %bb.be, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i, !prof !106
...
bb.bf:                                            ; preds = %bb.be
  ...
  br i1 %i.iv, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread.i, label %bb.bh, !prof !140

bb.bg:                                            ; preds = %bb.be
  %i.iw = icmp samesign ugt i64 %.064.i, 26
  br i1 %i.iw, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread.i, label %bb.bh, !prof !140

bb.bh:                                            ; preds = %bb.bg, %bb.bf, %bb.be
  %.pn.i.i = phi i64 [ 3, %bb.bf ], [ 6, %bb.bg ], [ 9, %bb.be ] ; 2 uses
  %i.ix = icmp eq i64 %.pn.i.i, %i.iu
  br i1 %i.ix, label %bb.bi, label %bb.bj, !prof !106
...
bb.bi:                                            ; preds = %bb.bh
  ...
  br i1 %i.iy, label %bb.bl, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread.i, !prof !158
...
bb.bj:                                            ; preds = %bb.bh
  ...
  br i1 %i.iz, label %bb.bk, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.i, !prof !106

bb.bk:                                            ; preds = %bb.bj
  %reass.sub = sub i64 %.pn.i.i, %.064.i
  %switch.tableidx = add i64 %reass.sub, 19       ; 2 uses
  %i.ja = icmp ult i64 %switch.tableidx, 8
  br i1 %i.ja, label %switch.lookup, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread128.i
...
switch.lookup:                                    ; preds = %bb.bk
  ...
  br label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread128.i

_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread128.i: ; preds = %bb.bk, %switch.lookup
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #19
  br label %bb.bl

_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.i: ; preds = %bb.bj
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #19
  br label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread.i

bb.bl:                                            ; preds = %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread128.i, %bb.bi
  switch i32 %3, label %default.unreachable.i [
    i32 3, label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i106.i
    i32 1, label %bb.bm
    i32 2, label %bb.bn
  ]
...
bb.bm:                                            ; preds = %bb.bl
  ...
  br i1 %i.je, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread.i, label %bb.bo, !prof !144

bb.bn:                                            ; preds = %bb.bl
  %i.jf = call { i64, i1 } @llvm.smul.with.overflow.i64(i64 %i.ig, i64 1000000) ; 2 uses
  %i.jg = extractvalue { i64, i1 } %i.jf, 1
  br i1 %i.jg, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread.i, label %bb.bo, !prof !144
...
_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i106.i: ; preds = %bb.bl
  ...
  br i1 %i.ji, label %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread.i, label %bb.bo, !prof !144

default.unreachable.i:                            ; preds = %bb.bl
  unreachable

bb.bo:                                            ; preds = %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i106.i, %bb.bn, %bb.bm
  %.pn.i = phi { i64, i1 } [ %i.jd, %bb.bm ], [ %i.jh, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i106.i ], [ %i.jf, %bb.bn ]
  %.pn25.i.i8.i104.i = extractvalue { i64, i1 } %.pn.i, 0
  %i.jj = load i32, ptr %i.b, align 4, !tbaa !3
  %i.jk = zext i32 %i.jj to i64
  %i.jl = call { i64, i1 } @llvm.sadd.with.overflow.i64(i64 %.pn25.i.i8.i104.i, i64 %i.jk) ; 2 uses
...
_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread.i: ; preds = %bb.bo, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i106.i, %bb.bn, %bb.bm, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.i, %bb.bi, %bb.bg, %bb.bf, %bb.be
  %.0.i = phi i1 [ false, %bb.bf ], [ false, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.i ], [ %not..i, %bb.bo ], [ false, %bb.bi ], [ false, %bb.be ], [ false, %bb.bg ], [ false, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i106.i ], [ false, %bb.bn ], [ false, %bb.bm ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #19
  br label %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i

_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i: ; preds = %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread.i, %bb.bd, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97.i, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i100.i, %bb.bc, %bb.bb, %bb.ay, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i.i, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i.i, %bb.ax, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i95.i, %bb.aw, %bb.av, %bb.au, %bb.at, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit11.i.i, %bb.as, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i89.i, %bb.ar, %bb.aq, %bb.ap, %bb.ao, %bb.an, %bb.am, %bb.ah, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i.i, %bb.ac, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i80.i, %bb.ab, %bb.aa, %bb.w, %bb.v
  %.3.i = phi i1 [ false, %bb.ah ], [ false, %bb.v ], [ false, %bb.bb ], [ false, %bb.as ], [ false, %bb.an ], [ false, %bb.am ], [ false, %bb.ac ], [ %.0.i, %_ZN5arrow8internal6detailL15ParseSubSecondsEPKcmNS_8TimeUnit4typeEPj.exit.thread.i ], [ false, %bb.bd ], [ false, %bb.ay ], [ true, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i97.i ], [ false, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i100.i ], [ false, %bb.bc ], [ false, %bb.w ], [ false, %bb.ab ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit9.i.i ], [ false, %bb.aa ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i80.i ], [ false, %bb.ao ], [ false, %bb.ap ], [ false, %bb.ar ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit11.i.i ], [ false, %bb.aq ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i89.i ], [ false, %bb.at ], [ false, %bb.au ], [ false, %bb.aw ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit19.i.i ], [ false, %bb.av ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i95.i ], [ false, %bb.ax ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit16.i.i ]
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #19
  br label %_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit

_ZN5arrow8internalL21ParseTimestampISO8601EPKcmNS_8TimeUnit4typeEPlPb.exit: ; preds = %bb.a, %bb.b, %bb.c, %bb.d, %bb.e, %bb.f, %bb.g, %_ZN5arrow8internal13ParseUnsignedEPKcmPt.exit.i.i, %bb.h, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i.i, %bb.i, %_ZNK14arrow_vendored4date14year_month_day2okEv.exit.i.i, %bb.o, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i.i, %bb.p, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i
  %.5.i = phi i1 [ false, %bb.a ], [ %.3.i, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeElPl.exit101.i ], [ false, %bb.p ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPh.exit.i.i ], [ true, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.thread.i.i ], [ false, %_ZN5arrow4util17CastSecondsToUnitENS_8TimeUnit4typeEl.exit.i.i ], [ false, %bb.o ], [ false, %bb.h ], [ false, %bb.b ], [ false, %bb.f ], [ false, %bb.c ], [ false, %bb.i ], [ false, %_ZNK14arrow_vendored4date14year_month_day2okEv.exit.i.i ], [ false, %bb.d ], [ false, %bb.e ], [ false, %bb.g ], [ false, %_ZN5arrow8internal13ParseUnsignedEPKcmPt.exit.i.i ]
  ret i1 %.5.i
}
