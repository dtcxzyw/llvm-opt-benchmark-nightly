...
.thread83.i:                                      ; preds = %.thread78.i
  ...
  %cond.fr.i = freeze i1 %.mux.i                  ; 3 uses
  %spec.select.i = select i1 %cond.fr.i, ptr @.str.5, ptr @.str.6
  %i.k = select i1 %cond.fr.i, i64 5, i64 8
  %2 = select i1 %cond.fr.i, i64 20, i64 32
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(20) %1, ptr noundef nonnull align 4 dereferenceable(20) %spec.select.i, i64 %2, i1 false)
