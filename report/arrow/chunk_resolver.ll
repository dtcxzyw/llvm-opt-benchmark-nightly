Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/arrow/original/chunk_resolver?download=true
...
_ZNSt6vectorIlSaIlEE20_M_allocate_and_copyIN9__gnu_cxx17__normal_iteratorIPKlS1_EEEEPlmT_S9_.exit: ; preds = %bb.e, %bb.f, %bb.g
  %2 = load ptr, ptr %0, align 8, !tbaa !41       ; 3 uses
...
bb.h:                                             ; preds = %_ZNSt6vectorIlSaIlEE20_M_allocate_and_copyIN9__gnu_cxx17__normal_iteratorIPKlS1_EEEEPlmT_S9_.exit
  %3 = load ptr, ptr %i.g, align 8, !tbaa !44
  %4 = ptrtoint ptr %3 to i64
  %5 = ptrtoint ptr %2 to i64
  %6 = sub i64 %4, %5
  tail call void @_ZdlPvm(ptr noundef nonnull %2, i64 noundef %6) #16
...
bb.d:                                             ; preds = %.preheader, %bb.d
  %.013.i.i.i = phi i32 [ %.114.i.i.i, %bb.d ], [ 0, %.preheader ] ; 2 uses
  %.0.i.i.i = phi i32 [ %.1.i.i.i, %bb.d ], [ %i.h, %.preheader ] ; 2 uses
  %i.u = lshr i32 %.0.i.i.i, 1                    ; 3 uses
  %i.v = add i32 %i.u, %.013.i.i.i                ; 2 uses
  ...
  %i.z = sub i32 %.0.i.i.i, %i.u
  %.114.i.i.i = select i1 %.not.i.i.i, i32 %.013.i.i.i, i32 %i.v ; 3 uses
  %.1.i.i.i = select i1 %.not.i.i.i, i32 %i.u, i32 %i.z ; 2 uses
  %i.aa = icmp ugt i32 %.1.i.i.i, 1
...
_ZN5arrow13ChunkResolver6BisectEmPKmjj.exit.loopexit.i.i: ; preds = %bb.d
  %.pre.i.i = sext i32 %.114.i.i.i to i64
...
_ZN5arrow12_GLOBAL__N_116ResolveOneInlineIhEENS_18TypedChunkLocationIT_EEjPKmS3_ii.exit.i: ; preds = %_ZN5arrow13ChunkResolver6BisectEmPKmjj.exit.loopexit.i.i, %bb.c, %bb.b
  ...
  %.0.i.i = phi i32 [ %.114.i.i.i, %_ZN5arrow13ChunkResolver6BisectEmPKmjj.exit.loopexit.i.i ], [ %i.i, %bb.b ], [ %.015.i, %bb.c ]
