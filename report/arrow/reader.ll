...
begin_hunk_3
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %4, ptr noundef nonnull align 16 dereferenceable(32) %17, i64 16, i1 false), !tbaa.struct !2244
...
_ZN5arrow6ResultINS_3ipc8internal9FileBlockEED2Ev.exit200: ; preds = %bb.gf, %bb.gg, %bb.gh
  ...
  %i.un = load ptr, ptr %i.um, align 16, !tbaa !1758 ; 2 uses
...
bb.gk:                                            ; preds = %bb.dl, %_ZN5arrow6ResultINS_3ipc8internal9FileBlockEED2Ev.exit, %bb.di
  ...
  %i.us = load ptr, ptr %i.ur, align 16, !tbaa !1758 ; 2 uses
