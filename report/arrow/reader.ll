...
begin_hunk_3_@_ZN5arrow3ipc12_GLOBAL__N_125RecordBatchFileReaderImpl33ReadRecordBatchWithCustomMetadataEi:bb.a
  ...
  %.sroa.0.0.copyload.i.i.i = load <2 x i64>, ptr %4, align 16, !tbaa !76
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(32) %4, ptr noundef nonnull align 16 dereferenceable(32) %17, i64 16, i1 false), !tbaa.struct !2590
  store <2 x i64> %.sroa.0.0.copyload.i.i.i, ptr %17, align 16, !tbaa !76
...
_ZN5arrow6ResultINS_3ipc8internal9FileBlockEED2Ev.exit200: ; preds = %bb.gf, %bb.gg, %bb.gh
  ...
  %i.un = load ptr, ptr %i.um, align 16, !tbaa !2023 ; 2 uses
...
bb.gk:                                            ; preds = %bb.dl, %_ZN5arrow6ResultINS_3ipc8internal9FileBlockEED2Ev.exit, %bb.di
  ...
  %i.us = load ptr, ptr %i.ur, align 16, !tbaa !2023 ; 2 uses
