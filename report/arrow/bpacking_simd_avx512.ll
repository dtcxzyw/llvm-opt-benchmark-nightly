...
.lr.ph:                                           ; preds = %_ZN5arrow8internal12unpack_exactILi32ELb1EmEEiPKhPT1_ii.exit, %.lr.ph
  ...
  %4 = extractelement <3 x i64> %i.ar, i64 2
  %5 = lshr i64 %4, 32
  %6 = insertelement <8 x i64> %i.au, i64 %5, i64 5
  %7 = load i64, ptr %i.aq, align 1
  %8 = insertelement <2 x i64> poison, i64 %7, i64 0
  %9 = shufflevector <2 x i64> %8, <2 x i64> poison, <8 x i32> <i32 0, i32 0, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %10 = lshr <8 x i64> %9, <i64 0, i64 32, i64 undef, i64 undef, i64 undef, i64 undef, i64 undef, i64 undef>
  %.sroa.0353.56.vec.insert.i39 = shufflevector <8 x i64> %6, <8 x i64> %10, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 8, i32 9>
  %i.av = and <8 x i64> %.sroa.0353.56.vec.insert.i39, splat (i64 4294967295)
