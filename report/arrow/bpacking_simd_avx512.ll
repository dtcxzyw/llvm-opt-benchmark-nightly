...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %5 = extractelement <8 x i64> %i.cym, i64 1
  %i.cyo = extractelement <8 x i64> %i.cym, i64 2
  %6 = extractelement <8 x i64> %i.cym, i64 3
  %i.cyp = extractelement <8 x i64> %i.cym, i64 4
  %7 = extractelement <8 x i64> %i.cym, i64 5
  %i.cyq = extractelement <8 x i64> %i.cym, i64 6
  %8 = extractelement <8 x i64> %i.cym, i64 7
  %9 = getelementptr inbounds nuw i8, ptr %.025.lcssa.i600, i64 %i.cyn
  %i.cyr = getelementptr inbounds nuw i8, ptr %.025.lcssa.i600, i64 %5
  %10 = getelementptr inbounds nuw i8, ptr %.025.lcssa.i600, i64 %i.cyo
  %i.cys = getelementptr inbounds nuw i8, ptr %.025.lcssa.i600, i64 %6
  %11 = getelementptr inbounds nuw i8, ptr %.025.lcssa.i600, i64 %i.cyp
  %i.cyt = getelementptr inbounds nuw i8, ptr %.025.lcssa.i600, i64 %7
  %12 = getelementptr inbounds nuw i8, ptr %.025.lcssa.i600, i64 %i.cyq
  %i.cyu = getelementptr inbounds nuw i8, ptr %.025.lcssa.i600, i64 %8
  %i.cyv = load i24, ptr %9, align 1, !alias.scope !182
  %i.cyw = load i24, ptr %i.cyr, align 1, !alias.scope !182
  %i.cyx = load i24, ptr %10, align 1, !alias.scope !182
  %i.cyy = load i24, ptr %i.cys, align 1, !alias.scope !182
  %i.cyz = load i24, ptr %11, align 1, !alias.scope !182
  %i.cza = load i24, ptr %i.cyt, align 1, !alias.scope !182
  %i.czb = load i24, ptr %12, align 1, !alias.scope !182
