...
.lr.ph.i.i:                                       ; preds = %_ZN5arrow8internal12unpack_exactILi1ELb1EbEEiPKhPT1_ii.exit.i.i, %.lr.ph.i.i
  ...
  %i.by = insertelement <16 x i32> poison, i32 %i.bx, i64 0
  ...
  %6 = shufflevector <16 x i32> %5, <16 x i32> poison, <16 x i32> zeroinitializer
  %i.cj = lshr <16 x i32> %6, <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
...
.lr.ph.i.i:                                       ; preds = %_ZN5arrow8internal12unpack_exactILi1ELb1EhEEiPKhPT1_ii.exit.i.i, %.lr.ph.i.i
  ...
  %5 = insertelement <16 x i32> poison, i32 %i.ci, i64 0
  %6 = shufflevector <16 x i32> %5, <16 x i32> poison, <16 x i32> zeroinitializer
  %i.cu = lshr <16 x i32> %6, <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
...
.lr.ph.i.i:                                       ; preds = %_ZN5arrow8internal12unpack_exactILi1ELb1EtEEiPKhPT1_ii.exit.i.i, %.lr.ph.i.i
  ...
  %i.cy = load i32, ptr %.02530.i.i, align 1      ; 6 uses
  %i.cz = insertelement <16 x i32> poison, i32 %i.cy, i64 0
  ...
  %5 = insertelement <16 x i32> poison, i32 %i.cy, i64 0
  %6 = shufflevector <16 x i32> %5, <16 x i32> poison, <16 x i32> zeroinitializer
  %i.dk = lshr <16 x i32> %6, <i32 16, i32 17, i32 18, i32 19, i32 20, i32 21, i32 22, i32 23, i32 24, i32 25, i32 26, i32 27, i32 28, i32 29, i32 30, i32 31>
