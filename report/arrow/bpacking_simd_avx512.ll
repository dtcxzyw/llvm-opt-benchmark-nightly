...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %n.vec = and i64 %i.an, 536870896               ; 5 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx = and i64 %index, 2305843009213693936
  %offset.idx42 = shl i64 %index, 3
  %next.gep = getelementptr i8, ptr %.026.lcssa, i64 %offset.idx42 ; 4 uses
  %i.au = getelementptr inbounds nuw i8, ptr %.025.lcssa, i64 %offset.idx ; 4 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec48 = and i64 %i.an, 536870908             ; 4 uses
  %5 = shl nuw nsw i64 %n.vec48, 3
  %i.bg = shl nuw nsw i64 %n.vec48, 3
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %6 = and i64 %index49, 2305843009213693948
  %7 = shl i64 %index49, 3
  %next.gep50 = getelementptr i8, ptr %.026.lcssa, i64 %7
  %i.bi = getelementptr inbounds nuw i8, ptr %.025.lcssa, i64 %6
  %wide.load51 = load <4 x i8>, ptr %i.bi, align 1, !alias.scope !236
  %i.bj = zext <4 x i8> %wide.load51 to <4 x i64>
  store <4 x i64> %i.bj, ptr %next.gep50, align 8, !tbaa !19, !alias.scope !239, !noalias !236
...
.lr.ph.i28.preheader:                             ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %indvars.iv.ph = phi i64 [ 0, %iter.check ], [ 0, %vector.memcheck ], [ %4, %vec.epilog.iter.check ], [ %5, %vec.epilog.middle.block ]
