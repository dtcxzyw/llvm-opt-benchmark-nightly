...
.lr.ph.i524:                                      ; preds = %_ZN5arrow8internal12unpack_exactILi20ELb1EjEEiPKhPT1_ii.exit.i, %.lr.ph.i524
  ...
  %5 = getelementptr inbounds nuw i8, ptr %.02531.i526, i64 4 ; 2 uses
  %6 = getelementptr inbounds nuw i8, ptr %.02531.i526, i64 8
  %i.bwu = getelementptr inbounds nuw i8, ptr %.02531.i526, i64 12
  %7 = load <2 x i32>, ptr %5, align 1
  %8 = load <2 x i32>, ptr %6, align 1
  %9 = tail call <2 x i32> @llvm.fshl.v2i32(<2 x i32> %8, <2 x i32> %7, <2 x i32> <i32 4, i32 16>)
  %i.bwv = getelementptr inbounds nuw i8, ptr %.02531.i526, i64 16
  %i.bww = getelementptr inbounds nuw i8, ptr %.02531.i526, i64 20
  %10 = getelementptr inbounds nuw i8, ptr %.02531.i526, i64 24 ; 2 uses
  %11 = getelementptr inbounds nuw i8, ptr %.02531.i526, i64 28
  %12 = getelementptr inbounds nuw i8, ptr %.02531.i526, i64 32
  %13 = load <2 x i32>, ptr %10, align 1
  %i.bwx = load <2 x i32>, ptr %11, align 1
  %i.bwy = tail call <2 x i32> @llvm.fshl.v2i32(<2 x i32> %i.bwx, <2 x i32> %13, <2 x i32> <i32 4, i32 16>)
  %i.bwz = getelementptr inbounds nuw i8, ptr %.02531.i526, i64 36
  %i.bxa = load i32, ptr %12, align 1             ; 2 uses
  %14 = load i32, ptr %i.bww, align 1             ; 2 uses
  %15 = load i32, ptr %i.bwu, align 1             ; 2 uses
  %i.bxb = load i32, ptr %.02531.i526, align 1    ; 2 uses
  %16 = load i32, ptr %i.bwz, align 1             ; 2 uses
  %17 = load i32, ptr %10, align 1                ; 2 uses
  %18 = load i32, ptr %i.bwv, align 1             ; 2 uses
  %i.bxc = load i32, ptr %5, align 1              ; 2 uses
  %19 = insertelement <4 x i32> poison, i32 %i.bxc, i64 0
  %20 = insertelement <4 x i32> %19, i32 %18, i64 1
  %21 = insertelement <4 x i32> %20, i32 %17, i64 2
  %22 = insertelement <4 x i32> %21, i32 %16, i64 3
  %23 = insertelement <4 x i32> poison, i32 %i.bxb, i64 0
  %24 = insertelement <4 x i32> %23, i32 %15, i64 1
  %25 = insertelement <4 x i32> %24, i32 %14, i64 2
  %26 = insertelement <4 x i32> %25, i32 %i.bxa, i64 3
  %27 = tail call <4 x i32> @llvm.fshl.v4i32(<4 x i32> %22, <4 x i32> %26, <4 x i32> <i32 12, i32 8, i32 12, i32 8>)
  %i.bxd = insertelement <16 x i32> poison, i32 %i.bxb, i64 0
  %28 = shufflevector <4 x i32> %27, <4 x i32> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison> ; 3 uses
  %29 = shufflevector <16 x i32> %i.bxd, <16 x i32> %28, <16 x i32> <i32 0, i32 16, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.bxe = lshr i32 %i.bxc, 8
  %i.bxf = insertelement <16 x i32> %29, i32 %i.bxe, i64 2
  %i.bxg = shufflevector <2 x i32> %9, <2 x i32> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %i.bxi = lshr i32 %15, 4
  %i.bxj = insertelement <16 x i32> %i.bxh, i32 %i.bxi, i64 5
  %i.bxk = lshr i32 %18, 12
  %30 = shufflevector <16 x i32> %i.bxj, <16 x i32> %28, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 17, i32 poison, i32 poison, i32 18, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %i.bxl = insertelement <16 x i32> %30, i32 %i.bxk, i64 7
  %i.bxm = insertelement <16 x i32> %i.bxl, i32 %14, i64 8
  %i.bxn = lshr i32 %17, 8
  %i.bxo = insertelement <16 x i32> %i.bxm, i32 %i.bxn, i64 10
  %i.bxp = shufflevector <2 x i32> %i.bwy, <2 x i32> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %i.bxr = lshr i32 %i.bxa, 4
  %i.bxs = insertelement <16 x i32> %i.bxq, i32 %i.bxr, i64 13
  %31 = shufflevector <16 x i32> %i.bxs, <16 x i32> %28, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 19, i32 poison>
  %i.bxt = lshr i32 %16, 12
  %.sroa.0127.60.vec.insert.i.i528 = insertelement <16 x i32> %31, i32 %i.bxt, i64 15
