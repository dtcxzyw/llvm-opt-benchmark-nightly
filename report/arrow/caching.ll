...
$_ZNSt23_Sp_counted_ptr_inplaceIN5arrow6BufferESaIvELN9__gnu_cxx12_Lock_policyE2EEC2IJSt10shared_ptrIS1_ERKlSA_EEES2_DpOT_ = comdat any

$_ZN5arrow6BufferC2ESt10shared_ptrIS0_Ell = comdat any
...
$_ZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ = comdat any
...
@.str.18 = private unnamed_addr constant [45 x i8] c"Range was not requested for caching: offset=\00", align 1
@.str.19 = private unnamed_addr constant [9 x i8] c" length=\00", align 1
...
bb.a:
  ...
  store i64 33554432, ptr %i.a, align 8, !tbaa !11
...
bb.a:
  ...
  store i64 33554432, ptr %i.a, align 8, !tbaa !11
  %i.b = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i8 1, ptr %i.b, align 8, !tbaa !12
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 24
  store i64 0, ptr %i.c, align 8, !tbaa !13
  ret void
}
...
bb.a:
  ...
  %i.c = shl nsw i64 %2, 20
  %i.d = shl nsw i64 %4, 20
  %i.e = sitofp i64 %i.c to double
  %i.f = fmul double %i.b, %i.e
  %i.g = tail call double @llvm.round.f64(double %i.f)
  %i.h = fptosi double %i.g to i64                ; 2 uses
  %i.i = sitofp i64 %i.h to double
  %i.j = fmul double %3, %i.i
  %i.k = fsub double 1.000000e+00, %3
  %i.l = fdiv double %i.j, %i.k
  %i.m = tail call double @llvm.round.f64(double %i.l)
  %i.n = fptosi double %i.m to i64
  %.sroa.speculated = tail call i64 @llvm.smin.i64(i64 %i.d, i64 %i.n)
  store i64 %i.h, ptr %0, align 8, !tbaa !7
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i64 %.sroa.speculated, ptr %i.o, align 8, !tbaa !11
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i8 0, ptr %i.p, align 8, !tbaa !12
...
bb.b:                                             ; preds = %bb.a
  %i.d = tail call noalias noundef nonnull dereferenceable(168) ptr @_Znwm(i64 noundef 168) #20 ; 9 uses
  %i.e = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(152) %i.e, i8 0, i64 152, i1 false)
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN5arrow2io8internal14ReadRangeCache4ImplE, i64 16), ptr %i.d, align 8, !tbaa !16
  ...
  invoke void @_ZN5arrow2io9IOContextC2Ev(ptr noundef nonnull align 8 dereferenceable(40) %i.g)
          to label %_ZN5arrow2io8internal14ReadRangeCache8LazyImplC2Ev.exit unwind label %.body

.body:                                            ; preds = %bb.b
  %i.h = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZNSt12__shared_ptrIN5arrow2io16RandomAccessFileELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %i.f) #21
  tail call void @_ZdlPvm(ptr noundef nonnull %i.d, i64 noundef 168) #22
  br label %bb.q
...
_ZN5arrow2io8internal14ReadRangeCache8LazyImplC2Ev.exit: ; preds = %bb.b
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN5arrow2io8internal14ReadRangeCache8LazyImplE, i64 16), ptr %i.d, align 8, !tbaa !16
  %i.j = getelementptr inbounds nuw i8, ptr %i.d, i64 128
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.j, i8 0, i64 40, i1 false)
  br label %bb.d

bb.c:                                             ; preds = %bb.a
  %i.k = tail call noalias noundef nonnull dereferenceable(128) ptr @_Znwm(i64 noundef 128) #20 ; 7 uses
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 16
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(112) %i.l, i8 0, i64 112, i1 false)
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN5arrow2io8internal14ReadRangeCache4ImplE, i64 16), ptr %i.k, align 8, !tbaa !16
  ...
  invoke void @_ZN5arrow2io9IOContextC2Ev(ptr noundef nonnull align 8 dereferenceable(40) %i.n)
          to label %_ZN5arrow2io8internal14ReadRangeCache4ImplC2Ev.exit unwind label %.body9

.body9:                                           ; preds = %bb.c
  %i.o = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZNSt12__shared_ptrIN5arrow2io16RandomAccessFileELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %i.m) #21
  tail call void @_ZdlPvm(ptr noundef nonnull %i.k, i64 noundef 128) #22
  br label %bb.q

_ZN5arrow2io8internal14ReadRangeCache4ImplC2Ev.exit: ; preds = %bb.c
  %i.p = getelementptr inbounds nuw i8, ptr %i.k, i64 96
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.p, i8 0, i64 32, i1 false)
  br label %bb.d

bb.d:                                             ; preds = %_ZN5arrow2io8internal14ReadRangeCache4ImplC2Ev.exit, %_ZN5arrow2io8internal14ReadRangeCache8LazyImplC2Ev.exit
  %i.q = phi ptr [ %i.d, %_ZN5arrow2io8internal14ReadRangeCache8LazyImplC2Ev.exit ], [ %i.k, %_ZN5arrow2io8internal14ReadRangeCache4ImplC2Ev.exit ] ; 3 uses
  store ptr %i.q, ptr %0, align 8, !tbaa !18
  %i.r = getelementptr inbounds nuw i8, ptr %i.q, i64 8
  %i.s = getelementptr inbounds nuw i8, ptr %i.q, i64 16
  %i.t = load <2 x ptr>, ptr %1, align 8, !tbaa !21
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %1, i8 0, i64 16, i1 false)
  %i.u = load ptr, ptr %i.s, align 8, !tbaa !22   ; 8 uses
  store <2 x ptr> %i.t, ptr %i.r, align 8, !tbaa !21
  %.not.i.i.i.i = icmp eq ptr %i.u, null
  br i1 %.not.i.i.i.i, label %_ZNSt10shared_ptrIN5arrow2io16RandomAccessFileEEaSEOS3_.exit, label %bb.e
...
bb.f:                                             ; preds = %bb.e
  store i32 0, ptr %i.v, align 8, !tbaa !25
  ...
  tail call void %i.ac(ptr noundef nonnull align 8 dereferenceable(16) %i.u) #21, !inline_history !28
  %i.ad = load ptr, ptr %i.u, align 8, !tbaa !16
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 24
  %i.af = load ptr, ptr %i.ae, align 8
  tail call void %i.af(ptr noundef nonnull align 8 dereferenceable(16) %i.u) #21, !inline_history !28
  br label %_ZNSt10shared_ptrIN5arrow2io16RandomAccessFileEEaSEOS3_.exit

bb.g:                                             ; preds = %bb.e
  %i.ag = load i8, ptr @__libc_single_threaded, align 1, !tbaa !29
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i: ; preds = %bb.i, %bb.h
  %.0.i.i.i.i.i.i = phi i32 [ %i.y, %bb.h ], [ %i.ai, %bb.i ]
  %i.aj = icmp eq i32 %.0.i.i.i.i.i.i, 1
  br i1 %i.aj, label %bb.j, label %_ZNSt10shared_ptrIN5arrow2io16RandomAccessFileEEaSEOS3_.exit, !prof !30
...
_ZNSt10shared_ptrIN5arrow2io16RandomAccessFileEEaSEOS3_.exit: ; preds = %bb.d, %bb.f, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i, %bb.j
  %i.ak = load ptr, ptr %0, align 8, !tbaa !18    ; 4 uses
  %i.al = getelementptr inbounds nuw i8, ptr %i.ak, i64 24
  store ptr %2, ptr %i.al, align 8, !tbaa !31
  %i.am = getelementptr inbounds nuw i8, ptr %i.ak, i64 32
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.am, ptr noundef nonnull align 8 dereferenceable(40) %3, i64 24, i1 false)
  ...
  %i.aq = load <2 x ptr>, ptr %i.ao, align 8, !tbaa !21
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ao, i8 0, i64 16, i1 false)
  %i.ar = load ptr, ptr %i.ap, align 8, !tbaa !22 ; 8 uses
  store <2 x ptr> %i.aq, ptr %i.an, align 8, !tbaa !21
  %.not.i.i.i.i.i.i = icmp eq ptr %i.ar, null
  br i1 %.not.i.i.i.i.i.i, label %_ZN5arrow2io9IOContextaSEOS1_.exit, label %bb.k

bb.k:                                             ; preds = %_ZNSt10shared_ptrIN5arrow2io16RandomAccessFileEEaSEOS3_.exit
...
bb.l:                                             ; preds = %bb.k
  ...
  store i32 0, ptr %i.aw, align 4, !tbaa !27
  %i.ax = load ptr, ptr %i.ar, align 8, !tbaa !16
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ax, i64 16
  %i.az = load ptr, ptr %i.ay, align 8
  tail call void %i.az(ptr noundef nonnull align 8 dereferenceable(16) %i.ar) #21, !inline_history !48
  %i.ba = load ptr, ptr %i.ar, align 8, !tbaa !16
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ba, i64 24
  %i.bc = load ptr, ptr %i.bb, align 8
  tail call void %i.bc(ptr noundef nonnull align 8 dereferenceable(16) %i.ar) #21, !inline_history !48
  br label %_ZN5arrow2io9IOContextaSEOS1_.exit

bb.m:                                             ; preds = %bb.k
  %i.bd = load i8, ptr @__libc_single_threaded, align 1, !tbaa !29
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i: ; preds = %bb.o, %bb.n
  %.0.i.i.i.i.i.i.i.i = phi i32 [ %i.av, %bb.n ], [ %i.bf, %bb.o ]
  %i.bg = icmp eq i32 %.0.i.i.i.i.i.i.i.i, 1
  br i1 %i.bg, label %bb.p, label %_ZN5arrow2io9IOContextaSEOS1_.exit, !prof !30

bb.p:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i
  tail call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.ar) #21
  br label %_ZN5arrow2io9IOContextaSEOS1_.exit

_ZN5arrow2io9IOContextaSEOS1_.exit:               ; preds = %_ZNSt10shared_ptrIN5arrow2io16RandomAccessFileEEaSEOS3_.exit, %bb.l, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i, %bb.p
  %i.bh = load ptr, ptr %0, align 8, !tbaa !18
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bh, i64 72
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.bi, ptr noundef nonnull align 8 dereferenceable(32) %4, i64 32, i1 false), !tbaa.struct !49
  ret void
...
_ZNKSt14default_deleteIN5arrow2io8internal14ReadRangeCache4ImplEEclEPS4_.exit.i: ; preds = %bb.a
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !16
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.d = load ptr, ptr %i.c, align 8
  tail call void %i.d(ptr noundef nonnull align 8 dead_on_return(128) dereferenceable(128) %i.a) #21, !inline_history !52
  br label %_ZNSt10unique_ptrIN5arrow2io8internal14ReadRangeCache4ImplESt14default_deleteIS4_EED2Ev.exit

_ZNSt10unique_ptrIN5arrow2io8internal14ReadRangeCache4ImplESt14default_deleteIS4_EED2Ev.exit: ; preds = %bb.a, %_ZNKSt14default_deleteIN5arrow2io8internal14ReadRangeCache4ImplEEclEPS4_.exit.i
  ret void
}
...
bb.a:
  ...
  %i.b = load <2 x ptr>, ptr %2, align 8, !tbaa !53
  store <2 x ptr> %i.b, ptr %3, align 16, !tbaa !53
  %i.c = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 3 uses
  %i.d = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !55
  store ptr %i.e, ptr %i.c, align 16, !tbaa !55
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %2, i8 0, i64 24, i1 false)
  %i.f = load ptr, ptr %i.a, align 8, !tbaa !16
  %i.g = getelementptr inbounds nuw i8, ptr %i.f, i64 32
  %i.h = load ptr, ptr %i.g, align 8
  invoke void %i.h(ptr dead_on_unwind writable sret(%"class.arrow::Status") align 8 %0, ptr noundef nonnull align 8 dereferenceable(128) %i.a, ptr noundef nonnull %3)
          to label %bb.b unwind label %bb.d

bb.b:                                             ; preds = %bb.a
  %i.i = load ptr, ptr %3, align 16, !tbaa !57    ; 3 uses
  %.not.i.i.i = icmp eq ptr %i.i, null
  br i1 %.not.i.i.i, label %_ZNSt6vectorIN5arrow2io9ReadRangeESaIS2_EED2Ev.exit, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.j = load ptr, ptr %i.c, align 16, !tbaa !55
  %i.k = ptrtoint ptr %i.j to i64
  %i.l = ptrtoint ptr %i.i to i64
  %i.m = sub i64 %i.k, %i.l
  call void @_ZdlPvm(ptr noundef nonnull %i.i, i64 noundef %i.m) #22
  br label %_ZNSt6vectorIN5arrow2io9ReadRangeESaIS2_EED2Ev.exit

_ZNSt6vectorIN5arrow2io9ReadRangeESaIS2_EED2Ev.exit: ; preds = %bb.b, %bb.c
  ret void

bb.d:                                             ; preds = %bb.a
  %i.n = landingpad { ptr, i32 }
          cleanup
  %i.o = load ptr, ptr %3, align 16, !tbaa !57    ; 3 uses
  %.not.i.i.i2 = icmp eq ptr %i.o, null
  br i1 %.not.i.i.i2, label %_ZNSt6vectorIN5arrow2io9ReadRangeESaIS2_EED2Ev.exit3, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.p = load ptr, ptr %i.c, align 16, !tbaa !55
  %i.q = ptrtoint ptr %i.p to i64
  %i.r = ptrtoint ptr %i.o to i64
  %i.s = sub i64 %i.q, %i.r
  call void @_ZdlPvm(ptr noundef nonnull %i.o, i64 noundef %i.s) #22
  br label %_ZNSt6vectorIN5arrow2io9ReadRangeESaIS2_EED2Ev.exit3

_ZNSt6vectorIN5arrow2io9ReadRangeESaIS2_EED2Ev.exit3: ; preds = %bb.d, %bb.e
  resume { ptr, i32 } %i.n
}
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8
  tail call void %i.d(ptr dead_on_unwind writable sret(%"class.arrow::Result") align 8 %0, ptr noundef nonnull align 8 dereferenceable(128) %i.a, i64 %2, i64 %3)
  ret void
}
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8
  tail call void %i.d(ptr dead_on_unwind writable sret(%"class.arrow::Future") align 8 %0, ptr noundef nonnull align 8 dereferenceable(128) %i.a)
  ret void
}
...
bb.a:
  ...
  %i.h = load ptr, ptr %i.g, align 8
  invoke void %i.h(ptr dead_on_unwind writable sret(%"class.arrow::Future") align 8 %0, ptr noundef nonnull align 8 dereferenceable(128) %i.a, ptr noundef nonnull %3)
          to label %bb.b unwind label %bb.d
...
; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr void @_ZN5arrow2io8internal14ReadRangeCache4ImplD2Ev(ptr noundef nonnull align 8 dead_on_return(128) dereferenceable(128) %0) unnamed_addr #7 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 64) (i8, ptr @_ZTVN5arrow2io8internal14ReadRangeCache4ImplE, i64 16), ptr %0, align 8, !tbaa !16
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !58   ; 3 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 112
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !59   ; 2 uses
  %.not4.i.i.i = icmp eq ptr %i.b, %i.d
  br i1 %.not4.i.i.i, label %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exit.i, label %.lr.ph.i.i.i

.lr.ph.i.i.i:                                     ; preds = %bb.a, %_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i.i
  %.05.i.i.i = phi ptr [ %i.v, %_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i.i ], [ %i.b, %bb.a ] ; 2 uses
  ...
  br i1 %.not.i.i.i.i.i.i.i.i.i, label %_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i.i, label %bb.b
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.n(ptr noundef nonnull align 8 dereferenceable(16) %i.f) #21, !inline_history !60
  %i.o = load ptr, ptr %i.f, align 8, !tbaa !16
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 24
  %i.q = load ptr, ptr %i.p, align 8
  tail call void %i.q(ptr noundef nonnull align 8 dereferenceable(16) %i.f) #21, !inline_history !60
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i.i.i.i: ; preds = %bb.f, %bb.e
  ...
  br i1 %i.u, label %bb.g, label %_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i.i, !prof !30
...
_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i.i: ; preds = %bb.g, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i.i.i.i, %bb.c, %.lr.ph.i.i.i
  %i.v = getelementptr inbounds nuw i8, ptr %.05.i.i.i, i64 32 ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.v, %i.d
  br i1 %.not.i.i.i, label %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exitthread-pre-split.i, label %.lr.ph.i.i.i, !llvm.loop !61

_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exitthread-pre-split.i: ; preds = %_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i.i
  %.pr.i = load ptr, ptr %i.a, align 8, !tbaa !58
  br label %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exit.i

_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exit.i: ; preds = %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exitthread-pre-split.i, %bb.a
  %i.w = phi ptr [ %.pr.i, %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exitthread-pre-split.i ], [ %i.b, %bb.a ] ; 3 uses
  %.not.i.i1.i = icmp eq ptr %i.w, null
  br i1 %.not.i.i1.i, label %_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EED2Ev.exit, label %bb.h

bb.h:                                             ; preds = %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exit.i
...
_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EED2Ev.exit: ; preds = %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exit.i, %bb.h
  ...
  br i1 %.not.i.i.i.i, label %_ZN5arrow2io9IOContextD2Ev.exit, label %bb.i

bb.i:                                             ; preds = %_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EED2Ev.exit
...
bb.j:                                             ; preds = %bb.i
  ...
  store i32 0, ptr %i.ai, align 4, !tbaa !27
  %i.aj = load ptr, ptr %i.ad, align 8, !tbaa !16
  %i.ak = getelementptr inbounds nuw i8, ptr %i.aj, i64 16
  %i.al = load ptr, ptr %i.ak, align 8
  tail call void %i.al(ptr noundef nonnull align 8 dereferenceable(16) %i.ad) #21, !inline_history !64
  %i.am = load ptr, ptr %i.ad, align 8, !tbaa !16
  %i.an = getelementptr inbounds nuw i8, ptr %i.am, i64 24
  %i.ao = load ptr, ptr %i.an, align 8
  tail call void %i.ao(ptr noundef nonnull align 8 dereferenceable(16) %i.ad) #21, !inline_history !64
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i: ; preds = %bb.m, %bb.l
  ...
  br i1 %i.as, label %bb.n, label %_ZN5arrow2io9IOContextD2Ev.exit, !prof !30

bb.n:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i
  tail call void @_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv(ptr noundef nonnull align 8 dereferenceable(16) %i.ad) #21
  br label %_ZN5arrow2io9IOContextD2Ev.exit

_ZN5arrow2io9IOContextD2Ev.exit:                  ; preds = %_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EED2Ev.exit, %bb.j, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i, %bb.n
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !22 ; 8 uses
  %.not.i.i = icmp eq ptr %i.au, null
  br i1 %.not.i.i, label %_ZNSt12__shared_ptrIN5arrow2io16RandomAccessFileELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, label %bb.o

bb.o:                                             ; preds = %_ZN5arrow2io9IOContextD2Ev.exit
