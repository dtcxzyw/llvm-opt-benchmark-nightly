...
bb.d:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i
  ...
  tail call void %i.l(ptr noundef nonnull align 8 dereferenceable(16) %0) #21, !inline_history !160
...
bb.a:
  ...
  br i1 %.not4.i.i, label %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exit, label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %bb.a, %_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i
  %.05.i.i = phi ptr [ %i.u, %_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i ], [ %i.a, %bb.a ] ; 2 uses
  ...
  br i1 %.not.i.i.i.i.i.i.i.i, label %_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i, label %bb.b
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.e) #21, !inline_history !161
  %i.n = load ptr, ptr %i.e, align 8, !tbaa !16
  %i.o = getelementptr inbounds nuw i8, ptr %i.n, i64 24
  %i.p = load ptr, ptr %i.o, align 8
  tail call void %i.p(ptr noundef nonnull align 8 dereferenceable(16) %i.e) #21, !inline_history !161
  br label %_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i.i.i: ; preds = %bb.f, %bb.e
  ...
  br i1 %i.t, label %bb.g, label %_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i, !prof !30
...
_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i: ; preds = %bb.g, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i.i.i.i.i.i.i, %bb.c, %.lr.ph.i.i
  %i.u = getelementptr inbounds nuw i8, ptr %.05.i.i, i64 32 ; 2 uses
  %.not.i.i = icmp eq ptr %i.u, %i.c
  br i1 %.not.i.i, label %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exitthread-pre-split, label %.lr.ph.i.i, !llvm.loop !61

_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exitthread-pre-split: ; preds = %_ZSt8_DestroyIN5arrow2io8internal15RangeCacheEntryEEvPT_.exit.i.i
  %.pr = load ptr, ptr %0, align 8, !tbaa !58
  br label %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exit

_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exit: ; preds = %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exitthread-pre-split, %bb.a
  %i.v = phi ptr [ %.pr, %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exitthread-pre-split ], [ %i.a, %bb.a ] ; 3 uses
  %.not.i.i1 = icmp eq ptr %i.v, null
  br i1 %.not.i.i1, label %_ZNSt12_Vector_baseIN5arrow2io8internal15RangeCacheEntryESaIS3_EED2Ev.exit, label %bb.h

bb.h:                                             ; preds = %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exit
...
_ZNSt12_Vector_baseIN5arrow2io8internal15RangeCacheEntryESaIS3_EED2Ev.exit: ; preds = %_ZSt8_DestroyIPN5arrow2io8internal15RangeCacheEntryES3_EvT_S5_RSaIT0_E.exit, %bb.h
  ret void
}

; Function Attrs: inlinehint mustprogress nounwind uwtable
define linkonce_odr void @_ZN5arrow6FutureISt10shared_ptrINS_6BufferEEED2Ev(ptr noundef nonnull align 8 dead_on_return(16) dereferenceable(16) %0) unnamed_addr #9 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.a:
  ...
  br i1 %i.g, label %bb.b, label %_ZNKSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE12_M_check_lenEmPKc.exit

bb.b:                                             ; preds = %bb.a
  tail call void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.8) #23
  unreachable

_ZNKSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE12_M_check_lenEmPKc.exit: ; preds = %bb.a
  ...
  %i.s = load <2 x ptr>, ptr %3, align 8, !tbaa !21
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %3, i8 0, i64 16, i1 false)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %i.q, ptr noundef nonnull align 8 dereferenceable(16) %2, i64 16, i1 false), !tbaa.struct !78
  store <2 x ptr> %i.s, ptr %i.r, align 8, !tbaa !21
...
.lr.ph.i.i.i:                                     ; preds = %_ZNKSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE12_M_check_lenEmPKc.exit, %.lr.ph.i.i.i
  %.012.i.i.i = phi ptr [ %i.y, %.lr.ph.i.i.i ], [ %i.p, %_ZNKSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE12_M_check_lenEmPKc.exit ] ; 3 uses
  %.0911.i.i.i = phi ptr [ %i.x, %.lr.ph.i.i.i ], [ %i.c, %_ZNKSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE12_M_check_lenEmPKc.exit ] ; 4 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !163)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !166)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.012.i.i.i, ptr noundef nonnull align 8 dereferenceable(32) %.0911.i.i.i, i64 16, i1 false), !tbaa.struct !78, !alias.scope !168
  ...
  %i.w = load <2 x ptr>, ptr %i.u, align 8, !tbaa !21, !alias.scope !166, !noalias !163
  store ptr null, ptr %i.v, align 8, !tbaa !22, !alias.scope !166, !noalias !163
  store <2 x ptr> %i.w, ptr %i.t, align 8, !tbaa !21, !alias.scope !163, !noalias !166
  store ptr null, ptr %i.u, align 8, !tbaa !66, !alias.scope !166, !noalias !163
  ...
  br i1 %.not.i.i.i, label %_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit, label %.lr.ph.i.i.i, !llvm.loop !169
...
_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit: ; preds = %.lr.ph.i.i.i, %_ZNKSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE12_M_check_lenEmPKc.exit
  %.0.lcssa.i.i.i = phi ptr [ %i.p, %_ZNKSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE12_M_check_lenEmPKc.exit ], [ %i.y, %.lr.ph.i.i.i ]
...
.lr.ph.i.i.i28:                                   ; preds = %_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit, %.lr.ph.i.i.i28
  %.012.i.i.i29 = phi ptr [ %i.af, %.lr.ph.i.i.i28 ], [ %i.z, %_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit ] ; 3 uses
  %.0911.i.i.i30 = phi ptr [ %i.ae, %.lr.ph.i.i.i28 ], [ %1, %_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit ] ; 4 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !170)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !173)
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.012.i.i.i29, ptr noundef nonnull align 8 dereferenceable(32) %.0911.i.i.i30, i64 16, i1 false), !tbaa.struct !78, !alias.scope !175
  %i.aa = getelementptr inbounds nuw i8, ptr %.012.i.i.i29, i64 16
  %i.ab = getelementptr inbounds nuw i8, ptr %.0911.i.i.i30, i64 16 ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %.0911.i.i.i30, i64 24
  %i.ad = load <2 x ptr>, ptr %i.ab, align 8, !tbaa !21, !alias.scope !173, !noalias !170
  store ptr null, ptr %i.ac, align 8, !tbaa !22, !alias.scope !173, !noalias !170
  store <2 x ptr> %i.ad, ptr %i.aa, align 8, !tbaa !21, !alias.scope !170, !noalias !173
  store ptr null, ptr %i.ab, align 8, !tbaa !66, !alias.scope !173, !noalias !170
  %i.ae = getelementptr inbounds nuw i8, ptr %.0911.i.i.i30, i64 32 ; 2 uses
  %i.af = getelementptr inbounds nuw i8, ptr %.012.i.i.i29, i64 32 ; 2 uses
  %.not.i.i.i31 = icmp eq ptr %i.ae, %i.b
  br i1 %.not.i.i.i31, label %_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33, label %.lr.ph.i.i.i28, !llvm.loop !169
...
_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33: ; preds = %.lr.ph.i.i.i28, %_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit
  %.0.lcssa.i.i.i32 = phi ptr [ %i.z, %_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit ], [ %i.af, %.lr.ph.i.i.i28 ]
  %i.ag = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %.not.i34 = icmp eq ptr %i.c, null
  br i1 %.not.i34, label %_ZNSt12_Vector_baseIN5arrow2io8internal15RangeCacheEntryESaIS3_EE13_M_deallocateEPS3_m.exit, label %bb.c

bb.c:                                             ; preds = %_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33
...
_ZNSt12_Vector_baseIN5arrow2io8internal15RangeCacheEntryESaIS3_EE13_M_deallocateEPS3_m.exit: ; preds = %_ZNSt6vectorIN5arrow2io8internal15RangeCacheEntryESaIS3_EE11_S_relocateEPS3_S6_S6_RS4_.exit33, %bb.c
  store ptr %i.p, ptr %0, align 8, !tbaa !58
  store ptr %.0.lcssa.i.i.i32, ptr %i.a, align 8, !tbaa !59
  %i.ak = getelementptr inbounds nuw [32 x i8], ptr %i.p, i64 %i.l
  store ptr %i.ak, ptr %i.ag, align 8, !tbaa !63
  ret void
}
...
bb.a:
  ...
  br i1 %i.b, label %bb.b, label %_ZN5arrow6ResultISt6vectorINS_2io9ReadRangeESaIS3_EEE7DestroyEv.exit.thread, !prof !90
...
_ZN5arrow6ResultISt6vectorINS_2io9ReadRangeESaIS3_EEE7DestroyEv.exit: ; preds = %bb.b
  ...
  %.pr.pre = load ptr, ptr %0, align 8, !tbaa !87 ; 2 uses
  %.not.i = icmp eq ptr %.pr.pre, null
  br i1 %.not.i, label %_ZN5arrow6StatusD2Ev.exit, label %_ZN5arrow6ResultISt6vectorINS_2io9ReadRangeESaIS3_EEE7DestroyEv.exit.thread, !prof !111

_ZN5arrow6ResultISt6vectorINS_2io9ReadRangeESaIS3_EEE7DestroyEv.exit.thread: ; preds = %bb.a, %_ZN5arrow6ResultISt6vectorINS_2io9ReadRangeESaIS3_EEE7DestroyEv.exit
  %i.j = phi ptr [ %.pr.pre, %_ZN5arrow6ResultISt6vectorINS_2io9ReadRangeESaIS3_EEE7DestroyEv.exit ], [ %i.a, %bb.a ]
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 1
  %i.l = load i8, ptr %i.k, align 1, !tbaa !110, !range !14, !noundef !15
  %i.m = trunc nuw i8 %i.l to i1
  br i1 %i.m, label %_ZN5arrow6StatusD2Ev.exit, label %bb.c

bb.c:                                             ; preds = %_ZN5arrow6ResultISt6vectorINS_2io9ReadRangeESaIS3_EEE7DestroyEv.exit.thread
  tail call void @_ZN5arrow6Status11DeleteStateEv(ptr noundef nonnull align 8 dereferenceable(8) %0) #21
  br label %_ZN5arrow6StatusD2Ev.exit

_ZN5arrow6StatusD2Ev.exit:                        ; preds = %bb.b, %_ZN5arrow6ResultISt6vectorINS_2io9ReadRangeESaIS3_EEE7DestroyEv.exit, %_ZN5arrow6ResultISt6vectorINS_2io9ReadRangeESaIS3_EEE7DestroyEv.exit.thread, %bb.c
  ret void
}
...
; Function Attrs: mustprogress uwtable
define linkonce_odr ptr @_ZSt7__mergeIN9__gnu_cxx17__normal_iteratorIPN5arrow2io8internal15RangeCacheEntryESt6vectorIS5_SaIS5_EEEESA_SA_NS0_5__ops15_Iter_less_iterEET1_T_SE_T0_SF_SD_T2_(ptr %0, ptr %1, ptr %2, ptr %3, ptr %4) local_unnamed_addr #3 comdat personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = icmp eq ptr %0, %1
  %i.b = icmp eq ptr %2, %3
  %or.cond48 = select i1 %i.a, i1 true, i1 %i.b
  br i1 %or.cond48, label %.critedge, label %.lr.ph

.lr.ph:                                           ; preds = %bb.a, %bb.x
  %.sroa.0.051 = phi ptr [ %i.bj, %bb.x ], [ %4, %bb.a ] ; 5 uses
  %.sroa.044.050 = phi ptr [ %.sroa.044.1, %bb.x ], [ %0, %bb.a ] ; 6 uses
  %.sroa.040.049 = phi ptr [ %.sroa.040.1, %bb.x ], [ %2, %bb.a ] ; 6 uses
  %i.c = load i64, ptr %.sroa.040.049, align 8, !tbaa !69
  %i.d = load i64, ptr %.sroa.044.050, align 8, !tbaa !69
  %i.e = icmp slt i64 %i.c, %i.d
  %i.f = getelementptr inbounds nuw i8, ptr %.sroa.0.051, i64 16 ; 2 uses
  %i.g = getelementptr inbounds nuw i8, ptr %.sroa.0.051, i64 24 ; 6 uses
  br i1 %i.e, label %bb.b, label %bb.m

bb.b:                                             ; preds = %.lr.ph
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.0.051, ptr noundef nonnull align 8 dereferenceable(32) %.sroa.040.049, i64 16, i1 false), !tbaa.struct !78
  %i.h = getelementptr inbounds nuw i8, ptr %.sroa.040.049, i64 16
  %i.i = load ptr, ptr %i.h, align 8, !tbaa !66
  store ptr %i.i, ptr %i.f, align 8, !tbaa !66
  %i.j = getelementptr inbounds nuw i8, ptr %.sroa.040.049, i64 24
  %i.k = load ptr, ptr %i.j, align 8, !tbaa !22   ; 4 uses
  %i.l = load ptr, ptr %i.g, align 8, !tbaa !22   ; 3 uses
  %.not.i.i.i.i.i = icmp eq ptr %i.k, %i.l
  br i1 %.not.i.i.i.i.i, label %_ZN5arrow2io8internal15RangeCacheEntryaSERKS2_.exit, label %bb.c

bb.c:                                             ; preds = %bb.b
  %.not7.i.i.i.i.i = icmp eq ptr %i.k, null
  br i1 %.not7.i.i.i.i.i, label %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE15_M_add_ref_copyEv.exit.i.i.i.i.i, label %bb.d
...
bb.f:                                             ; preds = %bb.d
  ...
  %.pr.pre.i.i.i.i.i = load ptr, ptr %i.g, align 8, !tbaa !22
  br label %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE15_M_add_ref_copyEv.exit.i.i.i.i.i

_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE15_M_add_ref_copyEv.exit.i.i.i.i.i: ; preds = %bb.f, %bb.e, %bb.c
  %i.r = phi ptr [ %i.l, %bb.c ], [ %i.l, %bb.e ], [ %.pr.pre.i.i.i.i.i, %bb.f ] ; 8 uses
  %.not8.i.i.i.i.i = icmp eq ptr %i.r, null
  br i1 %.not8.i.i.i.i.i, label %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE10_M_releaseEv.exit.i.i.i.i.i, label %bb.g

bb.g:                                             ; preds = %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE15_M_add_ref_copyEv.exit.i.i.i.i.i
...
bb.h:                                             ; preds = %bb.g
  ...
  store i32 0, ptr %i.w, align 4, !tbaa !27
  %i.x = load ptr, ptr %i.r, align 8, !tbaa !16
  %i.y = getelementptr inbounds nuw i8, ptr %i.x, i64 16
  %i.z = load ptr, ptr %i.y, align 8
  tail call void %i.z(ptr noundef nonnull align 8 dereferenceable(16) %i.r) #21, !inline_history !176
  %i.aa = load ptr, ptr %i.r, align 8, !tbaa !16
  %i.ab = getelementptr inbounds nuw i8, ptr %i.aa, i64 24
  %i.ac = load ptr, ptr %i.ab, align 8
  tail call void %i.ac(ptr noundef nonnull align 8 dereferenceable(16) %i.r) #21, !inline_history !176
  br label %_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE10_M_releaseEv.exit.i.i.i.i.i

bb.i:                                             ; preds = %bb.g
  %i.ad = load i8, ptr @__libc_single_threaded, align 1, !tbaa !29
  %.not.i9.i.i.i.i.i = icmp eq i8 %i.ad, 0
  br i1 %.not.i9.i.i.i.i.i, label %bb.k, label %bb.j

bb.j:                                             ; preds = %bb.i
end_hunk_0
begin_hunk_1_@_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev:bb.a
...
_ZNSt12_Vector_baseIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE11_M_allocateEm.exit: ; preds = %bb.a
  ...
  %7 = select i1 %5, i64 576460752303423487, i64 %6 ; 2 uses
...
bb.i:                                             ; preds = %_ZNSt6vectorIN5arrow2io9ReadRangeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.c, i64 noundef %i.aw) #22
...
_ZNSt12_Vector_baseIN5arrow2io9ReadRangeESaIS2_EE13_M_deallocateEPS2_m.exit38: ; preds = %_ZNSt6vectorIN5arrow2io9ReadRangeESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit, %bb.i
  ...
  store ptr %i.ax, ptr %i.a, align 8, !tbaa !77
  %i.ay = getelementptr inbounds nuw [16 x i8], ptr %i.ag, i64 %i.ae
  store ptr %i.ay, ptr %i.h, align 8, !tbaa !55
  br label %bb.j
...
_ZNKSt6vectorIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE12_M_check_lenEmPKc.exit: ; preds = %bb.a
  ...
  %i.s = load <2 x ptr>, ptr %2, align 8, !tbaa !21
  store ptr null, ptr %i.r, align 8, !tbaa !22
  store <2 x ptr> %i.s, ptr %i.q, align 8, !tbaa !21
...
.lr.ph.i.i.i:                                     ; preds = %_ZNKSt6vectorIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE12_M_check_lenEmPKc.exit, %.lr.ph.i.i.i
  ...
  %i.u = load <2 x ptr>, ptr %.0911.i.i.i, align 8, !tbaa !21, !alias.scope !251, !noalias !248
  store ptr null, ptr %i.t, align 8, !tbaa !22, !alias.scope !251, !noalias !248
  store <2 x ptr> %i.u, ptr %.012.i.i.i, align 8, !tbaa !21, !alias.scope !248, !noalias !251
  store ptr null, ptr %.0911.i.i.i, align 8, !tbaa !66, !alias.scope !251, !noalias !248
...
_ZNSt6vectorIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit: ; preds = %.lr.ph.i.i.i, %_ZNKSt6vectorIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE12_M_check_lenEmPKc.exit
  %.0.lcssa.i.i.i = phi ptr [ %i.p, %_ZNKSt6vectorIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE12_M_check_lenEmPKc.exit ], [ %i.w, %.lr.ph.i.i.i ]
...
.lr.ph.i.i.i17:                                   ; preds = %_ZNSt6vectorIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit, %.lr.ph.i.i.i17
  ...
  %i.z = load <2 x ptr>, ptr %.0911.i.i.i19, align 8, !tbaa !21, !alias.scope !256, !noalias !253
  store ptr null, ptr %i.y, align 8, !tbaa !22, !alias.scope !256, !noalias !253
  store <2 x ptr> %i.z, ptr %.012.i.i.i18, align 8, !tbaa !21, !alias.scope !253, !noalias !256
  store ptr null, ptr %.0911.i.i.i19, align 8, !tbaa !66, !alias.scope !256, !noalias !253
  ...
  br i1 %.not.i.i.i20, label %_ZNSt6vectorIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22, label %.lr.ph.i.i.i17, !llvm.loop !238
...
_ZNSt6vectorIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22: ; preds = %.lr.ph.i.i.i17, %_ZNSt6vectorIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit
  %.0.lcssa.i.i.i21 = phi ptr [ %i.x, %_ZNSt6vectorIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit ], [ %i.ab, %.lr.ph.i.i.i17 ]
  %i.ac = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %.not.i23 = icmp eq ptr %i.c, null
  br i1 %.not.i23, label %_ZNSt12_Vector_baseIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE13_M_deallocateEPS4_m.exit, label %bb.c

bb.c:                                             ; preds = %_ZNSt6vectorIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22
...
_ZNSt12_Vector_baseIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE13_M_deallocateEPS4_m.exit: ; preds = %_ZNSt6vectorIN5arrow6FutureINS0_8internal5EmptyEEESaIS4_EE11_S_relocateEPS4_S7_S7_RS5_.exit22, %bb.c
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !218, !nonnull !15, !align !228
  %i.c = call noundef i64 @strlen(ptr noundef nonnull align 1 dereferenceable(45) %1) #21
  %i.d = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.b, ptr noundef nonnull align 1 dereferenceable(45) %1, i64 noundef %i.c)
          to label %_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E2_clIS4_EEDaSI_.exit unwind label %bb.c ; 0 uses

_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E2_clIS4_EEDaSI_.exit: ; preds = %bb.a
  %i.e = load ptr, ptr %i.a, align 8, !tbaa !218, !nonnull !15, !align !228
  %i.f = load i64, ptr %2, align 8, !tbaa !50
  %i.g = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo9_M_insertIlEERSoT_(ptr noundef nonnull align 8 dereferenceable(8) %i.e, i64 noundef %i.f)
          to label %_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E1_clIS5_EEDaSI_.exit unwind label %bb.d ; 0 uses

_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E1_clIS5_EEDaSI_.exit: ; preds = %_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E2_clIS4_EEDaSI_.exit
  %i.h = load ptr, ptr %i.a, align 8, !tbaa !218, !nonnull !15, !align !228
  %i.i = call noundef i64 @strlen(ptr noundef nonnull align 1 dereferenceable(9) %3) #21
  %i.j = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZSt16__ostream_insertIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_PKS3_l(ptr noundef nonnull align 8 dereferenceable(8) %i.h, ptr noundef nonnull align 1 dereferenceable(9) %3, i64 noundef %i.i)
          to label %_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E0_clIS7_EEDaSI_.exit unwind label %bb.e ; 0 uses

_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E0_clIS7_EEDaSI_.exit: ; preds = %_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E1_clIS5_EEDaSI_.exit
  %i.k = load ptr, ptr %i.a, align 8, !tbaa !218, !nonnull !15, !align !228
  %i.l = load i64, ptr %4, align 8, !tbaa !50
  %i.m = invoke noundef nonnull align 8 dereferenceable(8) ptr @_ZNSo9_M_insertIlEERSoT_(ptr noundef nonnull align 8 dereferenceable(8) %i.k, i64 noundef %i.l)
          to label %_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS5_EEDaSI_.exit unwind label %bb.f ; 0 uses

_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS5_EEDaSI_.exit: ; preds = %_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E0_clIS7_EEDaSI_.exit
...
bb.b:                                             ; preds = %_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS5_EEDaSI_.exit
...
bb.d:                                             ; preds = %_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E2_clIS4_EEDaSI_.exit
  %i.o = landingpad { ptr, i32 }
          cleanup
  br label %bb.h

bb.e:                                             ; preds = %_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E1_clIS5_EEDaSI_.exit
  %i.p = landingpad { ptr, i32 }
          cleanup
  br label %bb.h

bb.f:                                             ; preds = %_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E0_clIS7_EEDaSI_.exit
  %i.q = landingpad { ptr, i32 }
          cleanup
  br label %bb.h

bb.g:                                             ; preds = %_ZZN5arrow8internal12JoinToStringIJRA45_KcRlRA9_S2_S5_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEDpOT_ENKUlOT_E_clIS5_EEDaSI_.exit
...
; Function Attrs: mustprogress uwtable
define linkonce_odr void @_ZN5arrow6FutureINS_8internal5EmptyEEC2ENS_6ResultIS2_EE(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef %1) unnamed_addr #3 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %2 = alloca %"class.std::__shared_ptr.13", align 16 ; 5 uses
  %3 = alloca %"class.std::unique_ptr.104", align 8 ; 7 uses
  %4 = alloca %"class.std::unique_ptr.104", align 8 ; 7 uses
  %5 = alloca %"class.arrow::Result.100", align 8 ; 8 uses
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %0, i8 0, i64 16, i1 false)
  %i.a = load ptr, ptr %1, align 8, !tbaa !87
  %i.b = icmp eq ptr %i.a, null
  br i1 %i.b, label %bb.b, label %bb.m, !prof !90

bb.b:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #21
  invoke void @_ZN5arrow10FutureImpl12MakeFinishedENS_11FutureStateE(ptr dead_on_unwind nonnull writable sret(%"class.std::unique_ptr.104") align 8 %3, i8 noundef signext 1)
...
.noexc:                                           ; preds = %bb.c
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !22   ; 8 uses
  %i.e = load <2 x ptr>, ptr %0, align 8, !tbaa !21
  %i.f = load <2 x ptr>, ptr %2, align 16, !tbaa !21
  store <2 x ptr> %i.f, ptr %0, align 8, !tbaa !21
  store <2 x ptr> %i.e, ptr %2, align 16, !tbaa !21
...
bb.e:                                             ; preds = %bb.d
  ...
  call void %i.n(ptr noundef nonnull align 8 dereferenceable(16) %i.d) #21, !inline_history !258
  %i.o = load ptr, ptr %i.d, align 8, !tbaa !16
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 24
  %i.q = load ptr, ptr %i.p, align 8
  call void %i.q(ptr noundef nonnull align 8 dereferenceable(16) %i.d) #21, !inline_history !258
  br label %bb.j
