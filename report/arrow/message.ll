...
bb.ca:                                            ; preds = %bb.cn, %.lr.ph.i
  %.sroa.01.06.i = phi ptr [ %i.iy, %.lr.ph.i ], [ %i.lg, %bb.cn ] ; 4 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.01.06.i) ]
...
bb.t:                                             ; preds = %_ZN5arrow6StatusD2Ev.exit23.thread, %_ZN5arrow6StatusD2Ev.exit
  ...
  %i.bg = load ptr, ptr %i.a, align 8, !tbaa !16, !nonnull !43, !noundef !43 ; 3 uses
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !707, !nonnull !43, !noundef !43 ; 5 uses
...
_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit74: ; preds = %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit69, %bb.az, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i72, %bb.bd
  %i.ex = load ptr, ptr %i.c, align 8, !tbaa !707, !nonnull !43, !noundef !43 ; 2 uses
...
bb.cm:                                            ; preds = %_ZNSt10shared_ptrIN5arrow6BufferEEC2ERKS2_.exit106
  %i.ig = load ptr, ptr %i.c, align 8, !tbaa !707, !nonnull !43, !noundef !43 ; 2 uses
...
bb.a:
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !707, !nonnull !43, !noundef !43 ; 3 uses
...
_ZN5arrow6StatusD2Ev.exit66:                      ; preds = %_ZN5arrow6StatusD2Ev.exit62
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #28
  %i.av = load ptr, ptr %i.c, align 8, !tbaa !707, !nonnull !43, !noundef !43 ; 2 uses
...
.critedge52:                                      ; preds = %_ZNSt10shared_ptrIN5arrow6BufferEEC2ERKS2_.exit69
  %i.bf = load ptr, ptr %i.c, align 8, !tbaa !707, !nonnull !43, !noundef !43 ; 2 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.bg
  ...
  %.sroa.099.0140 = phi ptr [ %i.b, %.lr.ph ], [ %i.ex, %bb.bg ] ; 8 uses
  %.0108148 = phi i64 [ %2, %.lr.ph ], [ %i.ew, %bb.bg ] ; 4 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.099.0140) ]
  %i.j = load ptr, ptr %.sroa.099.0140, align 8, !tbaa !16 ; 4 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.p = getelementptr inbounds nuw i8, ptr %.sroa.099.0140, i64 8 ; 2 uses
  %i.q = load ptr, ptr %i.p, align 8, !tbaa !13   ; 3 uses
...
bb.q:                                             ; preds = %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit
  ...
  store <2 x ptr> %i.aq, ptr %.sroa.099.0140, align 8, !tbaa !11
...
bb.af:                                            ; preds = %_ZN5arrow6ResultISt10shared_ptrINS_6BufferEEED2Ev.exit
  %.pre = load ptr, ptr %.sroa.099.0140, align 8, !tbaa !16 ; 3 uses
...
bb.ai:                                            ; preds = %bb.ah
  ...
  %i.co = getelementptr inbounds nuw i8, ptr %.sroa.099.0140, i64 8
  %i.cp = load ptr, ptr %i.co, align 8, !tbaa !13 ; 2 uses
  %i.cq = load <2 x ptr>, ptr %.sroa.099.0140, align 8, !tbaa !11
...
bb.bg:                                            ; preds = %bb.ag
  ...
  %i.ex = getelementptr inbounds nuw i8, ptr %.sroa.099.0140, i64 16 ; 2 uses
  %i.ey = icmp eq ptr %i.ex, %i.d
  br i1 %i.ey, label %.thread115, label %bb.b

.thread115:                                       ; preds = %bb.bg, %bb.a, %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit82, %bb.ah
  %.2121 = phi i64 [ %i.cl, %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit82 ], [ %i.cl, %bb.ah ], [ 0, %bb.a ], [ %i.cl, %bb.bg ]
  %.236120 = phi i64 [ %i.cm, %_ZNSt12__shared_ptrIN5arrow6BufferELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit82 ], [ %i.cm, %bb.ah ], [ 0, %bb.a ], [ %i.cm, %bb.bg ]
  %i.ez = load ptr, ptr %i.a, align 8, !tbaa !747 ; 2 uses
  %i.fa = getelementptr inbounds [16 x i8], ptr %i.ez, i64 %.2121
