...
bb.ca:                                            ; preds = %bb.cn, %.lr.ph.i
  %.sroa.01.06.i = phi ptr [ %i.iz, %.lr.ph.i ], [ %i.lh, %bb.cn ] ; 4 uses
...
bb.b:                                             ; preds = %.lr.ph, %bb.bg
  %.0150 = phi i64 [ %2, %.lr.ph ], [ %i.ew, %bb.bg ] ; 4 uses
  %.034149 = phi i64 [ 0, %.lr.ph ], [ %i.cm, %bb.bg ] ; 2 uses
  %.0108148 = phi i64 [ 0, %.lr.ph ], [ %i.cl, %bb.bg ]
  %.sroa.0102.0147 = phi ptr [ %i.b, %.lr.ph ], [ %i.ex, %bb.bg ] ; 8 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.sroa.0102.0147) ]
...
begin_hunk_9_@_ZN5arrow3ipc14MessageDecoder18MessageDecoderImpl17ConsumeDataChunksElPv:bb.a
  ...
  %.sroa.speculated = call i64 @llvm.smin.i64(i64 %i.cj, i64 %.0150) ; 4 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %3, i64 %.034149
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.ck, ptr align 1 %i.ch, i64 %.sroa.speculated, i1 false)
  %i.cl = add i64 %.0108148, 1                    ; 4 uses
  %i.cm = add i64 %.sroa.speculated, %.034149     ; 4 uses
  %.not128 = icmp sgt i64 %.0150, %i.cj
  br i1 %.not128, label %bb.bg, label %bb.ah

bb.ah:                                            ; preds = %bb.ag
  %.not.not = icmp sgt i64 %i.cj, %.0150
...
bb.bg:                                            ; preds = %bb.ag
  %i.ew = sub nsw i64 %.0150, %.sroa.speculated
