...
bb.r:                                             ; preds = %.noexc
  %i.bx = sub nuw nsw i64 %.020.i, %.sroa.speculated.i ; 2 uses
  %.not.i59 = icmp eq i64 %i.bx, 0
  br i1 %.not.i59, label %_ZN5arrow6StatusD2Ev.exit64.loopexit, label %_ZN5arrow6StatusD2Ev.exit.i
