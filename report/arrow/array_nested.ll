...
bb.x:                                             ; preds = %.critedge2.us.i, %.preheader.split.us.i
  ...
  %.077.us.i = phi i64 [ %.03178.i, %.preheader.split.us.i ], [ %i.cj, %.critedge2.us.i ] ; 4 uses
...
.critedge.i.loopexitsplit:                        ; preds = %.critedge2.i
  %.077.i.lcssa43 = phi i64 [ %i.dn, %.critedge2.i ]
  br label %.critedge.i.loopexit

..critedge.i.loopexit_crit_edge:                  ; preds = %bb.af
  %.077.i.lcssa39 = phi i64 [ %.077.i, %bb.af ]
  %.077.i.lcssa42 = phi i64 [ %.077.i, %bb.af ]   ; 0 uses
  br label %.critedge.i.loopexit

.critedge.i.loopexit:                             ; preds = %.critedge.i.loopexitsplit, %..critedge.i.loopexit_crit_edge
  %.us-phi.i.ph = phi i64 [ %.077.i.lcssa39, %..critedge.i.loopexit_crit_edge ], [ %.077.i.lcssa43, %.critedge.i.loopexitsplit ]
  br label %.critedge.i

.critedge.i.loopexit33split:                      ; preds = %.critedge2.us.i
  %.us-phi.i.ph34.ph = phi i64 [ %smax.i, %.critedge2.us.i ]
  br label %.critedge.i.loopexit33

..critedge.i.loopexit33_crit_edge:                ; preds = %bb.y
  %.077.us.i.lcssa = phi i64 [ %.077.us.i, %bb.y ]
  %.077.us.i.lcssa.a = phi i64 [ %.077.us.i, %bb.y ] ; 0 uses
  br label %.critedge.i.loopexit33

.critedge.i.loopexit33:                           ; preds = %.critedge.i.loopexit33split, %..critedge.i.loopexit33_crit_edge
  %.us-phi.i.ph34 = phi i64 [ %.077.us.i.lcssa, %..critedge.i.loopexit33_crit_edge ], [ %.us-phi.i.ph34.ph, %.critedge.i.loopexit33split ]
  br label %.critedge.i
...
bb.x:                                             ; preds = %.critedge2.us.i, %.preheader.split.us.i
  ...
  %.077.us.i = phi i64 [ %.03178.i, %.preheader.split.us.i ], [ %i.ch, %.critedge2.us.i ] ; 4 uses
...
.critedge.i.loopexitsplit:                        ; preds = %.critedge2.i
  %.077.i.lcssa43 = phi i64 [ %i.dl, %.critedge2.i ]
  br label %.critedge.i.loopexit
...
.preheader.split.us.split.i:                      ; preds = %.preheader.split.us.split.i.preheader, %.critedge2.us.i
  ...
  %.077.us.i = phi i64 [ %i.cg, %.critedge2.us.i ], [ %.03180.i, %.preheader.split.us.split.i.preheader ] ; 3 uses
...
.critedge.i.loopexitsplit:                        ; preds = %.critedge2.i
  %.077.i.lcssa38 = phi i64 [ %i.di, %.critedge2.i ]
  br label %.critedge.i.loopexit

..critedge.i.loopexit_crit_edge:                  ; preds = %bb.ad
  %.077.i.lcssa37 = phi i64 [ %.077.i, %bb.ad ]
  %.077.i.lcssa37.a = phi i64 [ %.077.i, %bb.ad ] ; 0 uses
  br label %.critedge.i.loopexit

.critedge.i.loopexit:                             ; preds = %.critedge.i.loopexitsplit, %..critedge.i.loopexit_crit_edge
  %.us-phi.i.ph = phi i64 [ %.077.i.lcssa37, %..critedge.i.loopexit_crit_edge ], [ %.077.i.lcssa38, %.critedge.i.loopexitsplit ]
  br label %.critedge.i

.critedge.i.loopexit33split:                      ; preds = %.critedge2.us.i
  %.us-phi.i.ph34.ph = phi i64 [ %smax86.i, %.critedge2.us.i ]
  br label %.critedge.i.loopexit33

.preheader.split.us.split.i..critedge.i.loopexit33_crit_edge: ; preds = %.preheader.split.us.split.i
  %.077.us.i.lcssa = phi i64 [ %.077.us.i, %.preheader.split.us.split.i ]
  %.077.us.i.lcssa.a = phi i64 [ %.077.us.i, %.preheader.split.us.split.i ] ; 0 uses
  br label %.critedge.i.loopexit33

.critedge.i.loopexit33:                           ; preds = %.critedge.i.loopexit33split, %.preheader.split.us.split.i..critedge.i.loopexit33_crit_edge
  %.us-phi.i.ph34 = phi i64 [ %.077.us.i.lcssa, %.preheader.split.us.split.i..critedge.i.loopexit33_crit_edge ], [ %.us-phi.i.ph34.ph, %.critedge.i.loopexit33split ]
  br label %.critedge.i
