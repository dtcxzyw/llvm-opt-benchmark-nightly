...
end_hunk_0
begin_hunk_1_@_ZN5arrow4util17UTF8StringToUTF16B5cxx11ESt17basic_string_viewIcSt11char_traitsIcEE:bb.a
  store i64 %i.u, ptr %i.v, align 8, !tbaa !69
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #25
  br label %bb.i

.body:                                            ; preds = %bb.b, %_ZNKSt7__cxx1112basic_stringIDsSt11char_traitsIDsESaIDsEE11_M_is_localEv.exit.i.i.i
  %i.w = extractvalue { ptr, i32 } %i.f, 1
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #25
  %i.x = call i32 @llvm.eh.typeid.for.p0(ptr nonnull @_ZTISt9exception) #25
  %i.y = icmp eq i32 %i.w, %i.x
  br i1 %i.y, label %bb.d, label %bb.j

bb.d:                                             ; preds = %.body
  %i.z = extractvalue { ptr, i32 } %i.f, 0
  %i.aa = call ptr @__cxa_begin_catch(ptr %i.z) #25 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #25
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #25
  %i.ab = load ptr, ptr %i.aa, align 8, !tbaa !49
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 16
  %i.ad = load ptr, ptr %i.ac, align 8
  %i.ae = call noundef ptr %i.ad(ptr noundef nonnull align 8 dereferenceable(8) %i.aa) #25
  store ptr %i.ae, ptr %i.a, align 8, !tbaa !19
  invoke void @_ZN5arrow6Status7InvalidIJPKcEEES0_DpOT_(ptr dead_on_unwind nonnull writable sret(%"class.arrow::Status") align 8 %4, ptr noundef nonnull align 8 dereferenceable(8) %i.a)
          to label %bb.e unwind label %bb.h

bb.e:                                             ; preds = %bb.d
  call void @_ZN5arrow6ResultINSt7__cxx1112basic_stringIDsSt11char_traitsIDsESaIDsEEEEC2ERKNS_6StatusE(ptr noundef nonnull align 8 dereferenceable(40) %0, ptr noundef nonnull align 8 dereferenceable(8) %4) #25
  %i.af = load ptr, ptr %4, align 8, !tbaa !16    ; 2 uses
  %.not.i = icmp eq ptr %i.af, null
  br i1 %.not.i, label %_ZN5arrow6StatusD2Ev.exit, label %bb.f, !prof !14

bb.f:                                             ; preds = %bb.e
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 1
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !21, !range !33, !noundef !34
  %i.ai = trunc nuw i8 %i.ah to i1
  br i1 %i.ai, label %_ZN5arrow6StatusD2Ev.exit, label %bb.g
...
bb.i:                                             ; preds = %_ZN5arrow6StatusD2Ev.exit, %_ZNSt7__cxx1112basic_stringIDsSt11char_traitsIDsESaIDsEED2Ev.exit
  ret void

bb.j:                                             ; preds = %bb.h, %.body
  %.merged = phi { ptr, i32 } [ %i.f, %.body ], [ %i.aj, %bb.h ]
...
bb.a:
  %2 = alloca %"class.std::__cxx11::basic_string.10", align 8 ; 6 uses
  %3 = alloca %"class.std::__cxx11::basic_string.10", align 8 ; 6 uses
  %4 = alloca %"class.std::allocator.11", align 1 ; 3 uses
  %5 = alloca %"class.std::__cxx11::basic_string.10", align 8 ; 6 uses
  store ptr null, ptr %0, align 8, !tbaa !16
...
_ZN5arrow6StatusC2ERKS0_.exit:                    ; preds = %bb.a
  ...
  br i1 %i.b, label %bb.b, label %bb.g, !prof !35
...
bb.c:                                             ; preds = %bb.b
  ...
  invoke void @_ZNK5arrow6Status8ToStringB5cxx11Ev(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string.10") align 8 %5, ptr noundef nonnull align 8 dereferenceable(8) %1)
          to label %bb.d unwind label %bb.h

bb.d:                                             ; preds = %bb.c
  invoke void @_ZStplIcSt11char_traitsIcESaIcEENSt7__cxx1112basic_stringIT_T0_T1_EEOS8_S9_(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string.10") align 8 %2, ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 8 dereferenceable(32) %5)
          to label %bb.e unwind label %bb.h
...
bb.f:                                             ; preds = %bb.e
  %i.c = load ptr, ptr %2, align 8, !tbaa !36     ; 2 uses
  %i.d = getelementptr inbounds nuw i8, ptr %2, i64 16 ; 2 uses
  %i.e = icmp eq ptr %i.c, %i.d
  br i1 %i.e, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.f
  %i.f = load i64, ptr %i.d, align 8, !tbaa !9
  %i.g = add i64 %i.f, 1
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit6: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i4
  ...
  %i.m = load ptr, ptr %3, align 8, !tbaa !36     ; 2 uses
