...
begin_hunk_3_@uriFixPercentEncodingInplaceA:bb.a
  ...
  %3 = getelementptr inbounds nuw i8, ptr %.045.i, i64 1 ; 2 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  store i8 %i.aq, ptr %3, align 1, !tbaa !17
  ...
  %4 = getelementptr inbounds nuw i8, ptr %.045.i, i64 3
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %bb.f, %bb.d
  %.140.i = phi i32 [ %.03944.i, %bb.d ], [ %i.z, %bb.g ], [ %i.z, %bb.f ] ; 2 uses
  %.2.i = phi ptr [ %2, %bb.d ], [ %4, %bb.g ], [ %3, %bb.f ] ; 2 uses
...
begin_hunk_8_@uriFixPercentEncodingMallocA:bb.a
  ...
  %4 = getelementptr inbounds nuw i8, ptr %.045.i, i64 1 ; 2 uses
...
bb.j:                                             ; preds = %bb.h
  ...
  store i8 %i.bd, ptr %4, align 1, !tbaa !17
  ...
  %5 = getelementptr inbounds nuw i8, ptr %.045.i, i64 3
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %bb.i, %bb.g
  %.140.i = phi i32 [ %.03944.i, %bb.g ], [ %i.am, %bb.j ], [ %i.am, %bb.i ] ; 2 uses
  %.2.i = phi ptr [ %3, %bb.g ], [ %5, %bb.j ], [ %4, %bb.i ] ; 2 uses
...
bb.h:                                             ; preds = %bb.g, %bb.f, %bb.d
  ...
  %.140.i = phi i32 [ %i.ab, %bb.f ], [ %i.ab, %bb.g ], [ %.03945.i, %bb.d ] ; 2 uses
...
bb.k:                                             ; preds = %bb.j, %bb.i, %bb.g
  ...
  %.140.i = phi i32 [ %i.ap, %bb.i ], [ %i.ap, %bb.j ], [ %.03945.i, %bb.g ] ; 2 uses
