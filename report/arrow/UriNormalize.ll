...
bb.x:                                             ; preds = %bb.w
  ...
  %i.ey = tail call ptr %i.ew(ptr noundef nonnull %3, i64 noundef %i.ex) #6, !inline_history !68 ; 6 uses
...
bb.ah:                                            ; preds = %bb.ag
  ...
  %i.kd = tail call ptr %i.kb(ptr noundef nonnull %3, i64 noundef %i.kc) #6, !inline_history !68 ; 7 uses
...
bb.cw:                                            ; preds = %bb.cv
  ...
  %i.xj = tail call ptr %i.xi(ptr noundef nonnull %3, i64 noundef %i.xh) #6, !inline_history !78 ; 4 uses
...
bb.da:                                            ; preds = %bb.cz
  ...
  %i.yb = tail call ptr %i.ya(ptr noundef nonnull %3, i64 noundef %i.xz) #6, !inline_history !78 ; 4 uses
...
bb.de:                                            ; preds = %bb.dd
  ...
  %i.yt = tail call ptr %i.ys(ptr noundef nonnull %3, i64 noundef %i.yr) #6, !inline_history !78 ; 4 uses
...
bb.di:                                            ; preds = %bb.dh
  ...
  %i.zl = tail call ptr %i.zk(ptr noundef nonnull %3, i64 noundef %i.zj) #6, !inline_history !78 ; 4 uses
...
bb.dt:                                            ; preds = %bb.ds
  ...
  %i.aat = tail call ptr %i.aas(ptr noundef nonnull %3, i64 noundef %i.aar) #6, !inline_history !78 ; 4 uses
...
bb.dw:                                            ; preds = %bb.dv
  ...
  tail call void %i.abg(ptr noundef nonnull %3, ptr noundef nonnull %i.abc) #6, !inline_history !79
  br label %bb.dx

bb.dx:                                            ; preds = %bb.dw, %bb.dv, %bb.du
  %i.abh = load ptr, ptr %i.aay, align 8, !tbaa !39
  tail call void %i.abh(ptr noundef nonnull %3, ptr noundef nonnull %.061121.i) #6, !inline_history !79
...
bb.dy:                                            ; preds = %bb.dy, %.preheader.i288
  ...
  tail call void %i.abk(ptr noundef nonnull %3, ptr noundef nonnull %.1123.i) #6, !inline_history !79
...
bb.ed:                                            ; preds = %bb.ec
  ...
  %i.aby = tail call ptr %i.abx(ptr noundef nonnull %3, i64 noundef %i.abw) #6, !inline_history !78 ; 4 uses
