...
.preheader.i216:                                  ; preds = %uriContainsUppercaseLettersA.exit, %.preheader.i216
  ...
  br i1 %or.cond648.not, label %.preheader.i216, label %uriContainsUppercaseLettersA.exit220, !llvm.loop !63
...
bb.p:                                             ; preds = %bb.o
  %i.at = load ptr, ptr %0, align 8, !tbaa !17    ; 27 uses
...
pred.store.if450:                                 ; preds = %pred.store.continue449
  ...
  store i8 %i.de, ptr %next.gep425, align 1, !tbaa !18
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.preheader.i221.preheader, label %vec.epilog.ph, !prof !86
...
vec.epilog.vector.body:                           ; preds = %pred.store.continue474, %vec.epilog.ph
  ...
  %wide.load466 = load <4 x i8>, ptr %next.gep462, align 1, !tbaa !18 ; 5 uses
...
pred.store.if467:                                 ; preds = %vec.epilog.vector.body
  ...
  store i8 %i.ea, ptr %next.gep462, align 1, !tbaa !18
...
pred.store.if469:                                 ; preds = %pred.store.continue468
  ...
  store i8 %i.ed, ptr %next.gep463, align 1, !tbaa !18
...
pred.store.if471:                                 ; preds = %pred.store.continue470
  ...
  store i8 %i.eg, ptr %next.gep464, align 1, !tbaa !18
...
pred.store.if473:                                 ; preds = %pred.store.continue472
  ...
  store i8 %i.ej, ptr %next.gep465, align 1, !tbaa !18
...
pred.store.continue474:                           ; preds = %pred.store.if473, %pred.store.continue472
  ...
  br i1 %i.ek, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !66
...
.preheader.i221:                                  ; preds = %.preheader.i221.preheader, %bb.t
  ...
  %i.el = load i8, ptr %.018.i, align 1, !tbaa !18 ; 2 uses
  %i.em = add i8 %i.el, -65
...
bb.s:                                             ; preds = %.preheader.i221
  ...
  store i8 %i.en, ptr %.018.i, align 1, !tbaa !18
  br label %bb.t
...
bb.x:                                             ; preds = %bb.w
  %i.ew = load ptr, ptr %3, align 8, !tbaa !25
  %i.ex = and i64 %i.es, 2147483647               ; 3 uses
  %i.ey = tail call ptr %i.ew(ptr noundef nonnull %3, i64 noundef %i.ex) #7, !inline_history !68 ; 6 uses
...
.lr.ph.i224:                                      ; preds = %.lr.ph.i224, %.lr.ph.i224.preheader.new
  ...
  %i.fb = load ptr, ptr %0, align 8, !tbaa !21
  %i.fc = getelementptr inbounds nuw i8, ptr %i.fb, i64 %indvars.iv.i
  %i.fd = load i8, ptr %i.fc, align 1, !tbaa !18  ; 3 uses
  %i.fe = add i8 %i.fd, -65
  ...
  store i8 %spec.select.i, ptr %i.fg, align 1, !tbaa !18
  %indvars.iv.next.i = or disjoint i64 %indvars.iv.i, 1 ; 2 uses
  %i.fh = load ptr, ptr %0, align 8, !tbaa !21
  %i.fi = getelementptr inbounds nuw i8, ptr %i.fh, i64 %indvars.iv.next.i
  %i.fj = load i8, ptr %i.fi, align 1, !tbaa !18  ; 3 uses
  %i.fk = add i8 %i.fj, -65
  ...
  store i8 %spec.select.i.1, ptr %i.fm, align 1, !tbaa !18
...
.lr.ph.i224.epil.preheader:                       ; preds = %._crit_edge.i.unr-lcssa, %.lr.ph.i224.preheader
  ...
  %i.fn = load ptr, ptr %0, align 8, !tbaa !21
  %i.fo = getelementptr inbounds nuw i8, ptr %i.fn, i64 %indvars.iv.i.epil.init
  %i.fp = load i8, ptr %i.fo, align 1, !tbaa !18  ; 3 uses
  %i.fq = add i8 %i.fp, -65
  ...
  store i8 %spec.select.i.epil, ptr %i.fs, align 1, !tbaa !18
  br label %._crit_edge.i

._crit_edge.i:                                    ; preds = %._crit_edge.i.unr-lcssa, %.lr.ph.i224.epil.preheader
  store ptr %i.ey, ptr %0, align 8, !tbaa !21
  %i.ft = getelementptr inbounds nuw i8, ptr %i.ey, i64 %i.ex
  store ptr %i.ft, ptr %i.ax, align 8, !tbaa !21
...
bb.z:                                             ; preds = %uriLowercaseInplaceA.exit
  ...
  %i.fy = load ptr, ptr %i.fx, align 8, !tbaa !26 ; 29 uses
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.gb = load i32, ptr %i.ga, align 4, !tbaa !85
  %.not181 = icmp eq i32 %i.gb, 0
  %i.gc = getelementptr inbounds nuw i8, ptr %0, i64 72 ; 3 uses
  %i.gd = load ptr, ptr %i.gc, align 8, !tbaa !21 ; 7 uses
...
vector.body483:                                   ; preds = %pred.store.continue533, %vector.ph481
  ...
  %wide.load501 = load <16 x i8>, ptr %next.gep485, align 1, !tbaa !18 ; 17 uses
...
pred.store.if502:                                 ; preds = %vector.body483
  ...
  store i8 %i.hc, ptr %next.gep485, align 1, !tbaa !18
...
pred.store.if504:                                 ; preds = %pred.store.continue503
  ...
  store i8 %i.hf, ptr %next.gep486, align 1, !tbaa !18
...
pred.store.if506:                                 ; preds = %pred.store.continue505
  ...
  store i8 %i.hi, ptr %next.gep487, align 1, !tbaa !18
...
pred.store.if508:                                 ; preds = %pred.store.continue507
  ...
  store i8 %i.hl, ptr %next.gep488, align 1, !tbaa !18
...
pred.store.if510:                                 ; preds = %pred.store.continue509
  ...
  store i8 %i.ho, ptr %next.gep489, align 1, !tbaa !18
...
pred.store.if518:                                 ; preds = %pred.store.continue517
  ...
  store i8 %i.ia, ptr %next.gep493, align 1, !tbaa !18
...
pred.store.if520:                                 ; preds = %pred.store.continue519
  ...
  store i8 %i.id, ptr %next.gep494, align 1, !tbaa !18
...
pred.store.if522:                                 ; preds = %pred.store.continue521
  ...
  store i8 %i.ig, ptr %next.gep495, align 1, !tbaa !18
...
pred.store.if524:                                 ; preds = %pred.store.continue523
  ...
  store i8 %i.ij, ptr %next.gep496, align 1, !tbaa !18
...
pred.store.if526:                                 ; preds = %pred.store.continue525
  ...
  store i8 %i.im, ptr %next.gep497, align 1, !tbaa !18
...
pred.store.if528:                                 ; preds = %pred.store.continue527
  ...
  store i8 %i.ip, ptr %next.gep498, align 1, !tbaa !18
...
pred.store.if530:                                 ; preds = %pred.store.continue529
  ...
  store i8 %i.is, ptr %next.gep499, align 1, !tbaa !18
...
pred.store.if532:                                 ; preds = %pred.store.continue531
  ...
  store i8 %i.iv, ptr %next.gep500, align 1, !tbaa !18
...
pred.store.continue533:                           ; preds = %pred.store.if532, %pred.store.continue531
  ...
  br i1 %i.iw, label %middle.block535, label %vector.body483, !llvm.loop !70
...
vec.epilog.iter.check540:                         ; preds = %middle.block535
  ...
  br i1 %min.epilog.iters.check541, label %.preheader.i228.preheader, label %vec.epilog.ph542, !prof !86
...
vec.epilog.vector.body544:                        ; preds = %pred.store.continue558, %vec.epilog.ph542
  ...
  %wide.load550 = load <4 x i8>, ptr %next.gep546, align 1, !tbaa !18 ; 5 uses
...
pred.store.if551:                                 ; preds = %vec.epilog.vector.body544
  ...
  store i8 %i.jf, ptr %next.gep546, align 1, !tbaa !18
...
pred.store.if553:                                 ; preds = %pred.store.continue552
  ...
  store i8 %i.ji, ptr %next.gep547, align 1, !tbaa !18
...
pred.store.if555:                                 ; preds = %pred.store.continue554
  ...
  store i8 %i.jl, ptr %next.gep548, align 1, !tbaa !18
...
pred.store.if557:                                 ; preds = %pred.store.continue556
  ...
  store i8 %i.jo, ptr %next.gep549, align 1, !tbaa !18
...
pred.store.continue558:                           ; preds = %pred.store.if557, %pred.store.continue556
  ...
  br i1 %i.jp, label %vec.epilog.middle.block560, label %vec.epilog.vector.body544, !llvm.loop !71
...
.preheader.i228:                                  ; preds = %.preheader.i228.preheader, %bb.ad
  ...
  %i.jq = load i8, ptr %.018.i229, align 1, !tbaa !18 ; 2 uses
  %i.jr = add i8 %i.jq, -65
...
bb.ac:                                            ; preds = %.preheader.i228
  ...
  store i8 %i.js, ptr %.018.i229, align 1, !tbaa !18
  br label %bb.ad
...
bb.ah:                                            ; preds = %bb.ag
  %i.kb = load ptr, ptr %3, align 8, !tbaa !25
  %i.kc = and i64 %i.jx, 2147483647               ; 3 uses
  %i.kd = tail call ptr %i.kb(ptr noundef nonnull %3, i64 noundef %i.kc) #7, !inline_history !68 ; 7 uses
...
.lr.ph.i235:                                      ; preds = %.lr.ph.i235, %.lr.ph.i235.preheader.new
  ...
  %i.kg = load ptr, ptr %i.fx, align 8, !tbaa !21
  %i.kh = getelementptr inbounds nuw i8, ptr %i.kg, i64 %indvars.iv.i236
  %i.ki = load i8, ptr %i.kh, align 1, !tbaa !18  ; 3 uses
  %i.kj = add i8 %i.ki, -65
  ...
  store i8 %spec.select.i238, ptr %i.kl, align 1, !tbaa !18
  %indvars.iv.next.i239 = or disjoint i64 %indvars.iv.i236, 1 ; 2 uses
  %i.km = load ptr, ptr %i.fx, align 8, !tbaa !21
  %i.kn = getelementptr inbounds nuw i8, ptr %i.km, i64 %indvars.iv.next.i239
  %i.ko = load i8, ptr %i.kn, align 1, !tbaa !18  ; 3 uses
  %i.kp = add i8 %i.ko, -65
  ...
  store i8 %spec.select.i238.1, ptr %i.kr, align 1, !tbaa !18
  ...
  br i1 %niter657.ncmp.1, label %._crit_edge.i241.unr-lcssa, label %.lr.ph.i235, !llvm.loop !69
...
.lr.ph.i235.epil.preheader:                       ; preds = %._crit_edge.i241.unr-lcssa, %.lr.ph.i235.preheader
  ...
  %i.ks = load ptr, ptr %i.fx, align 8, !tbaa !21
  %i.kt = getelementptr inbounds nuw i8, ptr %i.ks, i64 %indvars.iv.i236.epil.init
  %i.ku = load i8, ptr %i.kt, align 1, !tbaa !18  ; 3 uses
  %i.kv = add i8 %i.ku, -65
...
uriLowercaseInplaceA.exit232.loopexit:            ; preds = %bb.ad, %vec.epilog.middle.block560, %middle.block535
  %.pre = load ptr, ptr %i.fx, align 8, !tbaa !26
  %.pre332 = load ptr, ptr %i.gc, align 8, !tbaa !87
  br label %uriLowercaseInplaceA.exit232
...
uriLowercaseInplaceA.exit232:                     ; preds = %uriLowercaseInplaceA.exit232.loopexit, %bb.ab, %uriLowercaseMallocA.exit243
  ...
  store ptr %i.ld, ptr %i.lg, align 8, !tbaa !84
...
bb.ak:                                            ; preds = %bb.aj
  %i.lj = load ptr, ptr %i.fw, align 8, !tbaa !27
...
bb.al:                                            ; preds = %bb.ak
  ...
  %i.lm = load ptr, ptr %i.ll, align 8, !tbaa !28
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.lp = load i32, ptr %i.lo, align 4, !tbaa !85
...
bb.aq:                                            ; preds = %bb.ao
  ...
  store i32 %i.ls, ptr %i.a, align 4, !tbaa !8
  br label %bb.ar
...
bb.ar:                                            ; preds = %bb.aq, %bb.an
  ...
  %i.lw = load ptr, ptr %i.lv, align 8, !tbaa !84 ; 3 uses
...
vector.body568:                                   ; preds = %pred.store.continue618, %vector.ph566
  ...
  %wide.load586 = load <16 x i8>, ptr %next.gep570, align 1, !tbaa !18 ; 17 uses
...
pred.store.if607:                                 ; preds = %pred.store.continue606
  ...
  store i8 %i.ob, ptr %next.gep580, align 1, !tbaa !18
...
pred.store.if609:                                 ; preds = %pred.store.continue608
  ...
  store i8 %i.oe, ptr %next.gep581, align 1, !tbaa !18
...
pred.store.if611:                                 ; preds = %pred.store.continue610
  ...
  store i8 %i.oh, ptr %next.gep582, align 1, !tbaa !18
...
pred.store.if613:                                 ; preds = %pred.store.continue612
  ...
  store i8 %i.ok, ptr %next.gep583, align 1, !tbaa !18
...
pred.store.if615:                                 ; preds = %pred.store.continue614
  ...
  store i8 %i.on, ptr %next.gep584, align 1, !tbaa !18
...
pred.store.if617:                                 ; preds = %pred.store.continue616
  ...
  store i8 %i.oq, ptr %next.gep585, align 1, !tbaa !18
...
pred.store.continue618:                           ; preds = %pred.store.if617, %pred.store.continue616
  ...
  br i1 %i.or, label %middle.block620, label %vector.body568, !llvm.loop !73
...
vec.epilog.iter.check625:                         ; preds = %middle.block620
  ...
  br i1 %min.epilog.iters.check626, label %.preheader.i245.preheader, label %vec.epilog.ph627, !prof !86
...
vec.epilog.vector.body629:                        ; preds = %pred.store.continue643, %vec.epilog.ph627
  ...
  %wide.load635 = load <4 x i8>, ptr %next.gep631, align 1, !tbaa !18 ; 5 uses
...
pred.store.if636:                                 ; preds = %vec.epilog.vector.body629
  ...
  store i8 %i.pa, ptr %next.gep631, align 1, !tbaa !18
...
pred.store.if638:                                 ; preds = %pred.store.continue637
  ...
  store i8 %i.pd, ptr %next.gep632, align 1, !tbaa !18
...
pred.store.if640:                                 ; preds = %pred.store.continue639
  ...
  store i8 %i.pg, ptr %next.gep633, align 1, !tbaa !18
...
pred.store.if642:                                 ; preds = %pred.store.continue641
  ...
  store i8 %i.pj, ptr %next.gep634, align 1, !tbaa !18
...
pred.store.continue643:                           ; preds = %pred.store.if642, %pred.store.continue641
  ...
  br i1 %i.pk, label %vec.epilog.middle.block645, label %vec.epilog.vector.body629, !llvm.loop !74
...
.preheader.i245:                                  ; preds = %.preheader.i245.preheader, %bb.at
  ...
  %i.pl = load i8, ptr %.018.i246, align 1, !tbaa !18 ; 2 uses
  %i.pm = add i8 %i.pl, -65
...
bb.as:                                            ; preds = %.preheader.i245
  ...
  store i8 %i.pn, ptr %.018.i246, align 1, !tbaa !18
  br label %bb.at
...
uriContainsUglyPercentEncodingA.exit.thread296:   ; preds = %uriContainsUglyPercentEncodingA.exit.thread296.sink.split, %uriContainsUglyPercentEncodingA.exit
  ...
  %i.ps = load ptr, ptr %i.pr, align 8, !tbaa !29 ; 4 uses
  %i.pt = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.pu = load ptr, ptr %i.pt, align 8, !tbaa !88 ; 3 uses
...
.lr.ph.i253:                                      ; preds = %uriContainsUglyPercentEncodingA.exit.thread296, %bb.ax
  ...
  %i.qa = load i8, ptr %.02132.i254, align 1, !tbaa !18
...
bb.au:                                            ; preds = %.lr.ph.i253
  ...
  %i.qd = load i8, ptr %i.qc, align 1, !tbaa !18  ; 2 uses
  %i.qe = add i8 %i.qd, -97
  %or.cond30.i255 = icmp ult i8 %i.qe, 6
  br i1 %or.cond30.i255, label %bb.ay, label %bb.av

bb.av:                                            ; preds = %bb.au
  %i.qf = load i8, ptr %i.pz, align 1, !tbaa !18
  %i.qg = add i8 %i.qf, -97
  %or.cond31.i256 = icmp ult i8 %i.qg, 6
  br i1 %or.cond31.i256, label %bb.ay, label %bb.aw

bb.aw:                                            ; preds = %bb.av
  %i.qh = tail call zeroext i8 @uriHexdigToIntA(i8 noundef signext %i.qd) #7
  %i.qi = load i8, ptr %i.pz, align 1, !tbaa !18
  %i.qj = tail call zeroext i8 @uriHexdigToIntA(i8 noundef signext %i.qi) #7
  %i.qk = zext i8 %i.qh to i32
  %i.ql = shl nuw nsw i32 %i.qk, 4
  %i.qm = zext i8 %i.qj to i32
  %i.qn = add nuw nsw i32 %i.ql, %i.qm
  %i.qo = tail call i32 @uriIsUnreserved(i32 noundef %i.qn) #7
...
bb.ax:                                            ; preds = %bb.aw, %.lr.ph.i253
  ...
  br i1 %i.qr, label %.lr.ph.i253, label %uriContainsUglyPercentEncodingA.exit258, !llvm.loop !64

bb.ay:                                            ; preds = %bb.av, %bb.au, %bb.aw
  %i.qs = load i32, ptr %2, align 4, !tbaa !8
  %i.qt = or i32 %i.qs, 2
  store i32 %i.qt, ptr %2, align 4, !tbaa !8
...
bb.ba:                                            ; preds = %bb.az
  ...
  %i.qw = load ptr, ptr %i.qv, align 8, !tbaa !29 ; 2 uses
...
bb.bb:                                            ; preds = %bb.ba
  ...
  %i.qy = load i32, ptr %i.qx, align 4, !tbaa !85
...
bb.bf:                                            ; preds = %bb.bd
  ...
  store i32 %i.rb, ptr %i.a, align 4, !tbaa !8
  br label %uriContainsUglyPercentEncodingA.exit258.thread300
...
uriContainsUglyPercentEncodingA.exit258.thread302: ; preds = %bb.ay, %uriContainsUglyPercentEncodingA.exit.thread296, %uriContainsUglyPercentEncodingA.exit258
  ...
  %.0155320 = load ptr, ptr %i.rc, align 8, !tbaa !89 ; 2 uses
...
.lr.ph:                                           ; preds = %uriContainsUglyPercentEncodingA.exit258.thread302, %.loopexit315
  ...
  %i.rd = load ptr, ptr %.0155322, align 8, !tbaa !31 ; 8 uses
  %i.re = getelementptr inbounds nuw i8, ptr %.0155322, i64 8
  %i.rf = load ptr, ptr %i.re, align 8, !tbaa !32 ; 4 uses
...
bb.bh:                                            ; preds = %bb.bg
  %i.rl = load i8, ptr %i.rd, align 1, !tbaa !18
  %i.rm = icmp eq i8 %i.rl, 46
  br i1 %i.rm, label %.thread309, label %bb.bk

bb.bi:                                            ; preds = %bb.bg
  %i.rn = load i8, ptr %i.rd, align 1, !tbaa !18
...
.lr.ph.i262:                                      ; preds = %bb.bk, %bb.bo
  ...
  %i.rv = load i8, ptr %.02132.i263, align 1, !tbaa !18
...
bb.bl:                                            ; preds = %.lr.ph.i262
  ...
  %i.ry = load i8, ptr %i.rx, align 1, !tbaa !18  ; 2 uses
  %i.rz = add i8 %i.ry, -97
  %or.cond30.i264 = icmp ult i8 %i.rz, 6
  br i1 %or.cond30.i264, label %.thread309, label %bb.bm

bb.bm:                                            ; preds = %bb.bl
  %i.sa = load i8, ptr %i.ru, align 1, !tbaa !18
  %i.sb = add i8 %i.sa, -97
  %or.cond31.i265 = icmp ult i8 %i.sb, 6
  br i1 %or.cond31.i265, label %.thread309, label %bb.bn

bb.bn:                                            ; preds = %bb.bm
  %i.sc = tail call zeroext i8 @uriHexdigToIntA(i8 noundef signext %i.ry) #7
  %i.sd = load i8, ptr %i.ru, align 1, !tbaa !18
  %i.se = tail call zeroext i8 @uriHexdigToIntA(i8 noundef signext %i.sd) #7
  %i.sf = zext i8 %i.sc to i32
  %i.sg = shl nuw nsw i32 %i.sf, 4
  %i.sh = zext i8 %i.se to i32
  %i.si = add nuw nsw i32 %i.sg, %i.sh
  %i.sj = tail call i32 @uriIsUnreserved(i32 noundef %i.si) #7
...
bb.bo:                                            ; preds = %bb.bn, %.lr.ph.i262
  ...
  br i1 %i.sm, label %.lr.ph.i262, label %.loopexit315, !llvm.loop !64

.thread309:                                       ; preds = %bb.bj, %bb.bh, %bb.bn, %bb.bl, %bb.bm
  %i.sn = load i32, ptr %2, align 4, !tbaa !8
  %i.so = or i32 %i.sn, 8
  store i32 %i.so, ptr %2, align 4, !tbaa !8
  br label %.loopexit316.thread

.loopexit315:                                     ; preds = %bb.bo, %.lr.ph, %bb.bk
  %i.sp = getelementptr inbounds nuw i8, ptr %.0155322, i64 16
  %.0155 = load ptr, ptr %i.sp, align 8, !tbaa !89 ; 2 uses
...
bb.br:                                            ; preds = %bb.bq, %bb.bp
  ...
  %i.sz = load ptr, ptr %i.sy, align 8, !tbaa !33 ; 3 uses
  %i.ta = getelementptr inbounds nuw i8, ptr %0, i64 148 ; 2 uses
  %i.tb = load i32, ptr %i.ta, align 4, !tbaa !85
...
.lr.ph325:                                        ; preds = %.preheader314, %.lr.ph325
  ...
  %i.tc = load ptr, ptr %.0324, align 8, !tbaa !31
  ...
  %i.tf = load ptr, ptr %i.te, align 8, !tbaa !34 ; 2 uses
...
bb.bt:                                            ; preds = %.lr.ph328
  ...
  %i.tj = load ptr, ptr %i.ti, align 8, !tbaa !34 ; 2 uses
...
.loopexit316.thread:                              ; preds = %uriContainsUglyPercentEncodingA.exit258.thread302, %.thread309, %.loopexit316
  ...
  %i.tw = load ptr, ptr %i.tv, align 8, !tbaa !35 ; 4 uses
  %i.tx = getelementptr inbounds nuw i8, ptr %0, i64 120
  %i.ty = load ptr, ptr %i.tx, align 8, !tbaa !91 ; 3 uses
...
.lr.ph.i271:                                      ; preds = %.loopexit316.thread, %bb.by
  ...
  %i.ue = load i8, ptr %.02132.i272, align 1, !tbaa !18
...
bb.by:                                            ; preds = %bb.bx, %.lr.ph.i271
  ...
  br i1 %i.uv, label %.lr.ph.i271, label %uriContainsUglyPercentEncodingA.exit276, !llvm.loop !64
...
uriContainsUglyPercentEncodingA.exit276:          ; preds = %bb.bv, %bb.bw, %bb.bx, %bb.by, %.loopexit316.thread
  ...
  %i.ux = load ptr, ptr %i.uw, align 8, !tbaa !36 ; 4 uses
  %i.uy = getelementptr inbounds nuw i8, ptr %0, i64 136
  %i.uz = load ptr, ptr %i.uy, align 8, !tbaa !92 ; 3 uses
...
.lr.ph.i280:                                      ; preds = %uriContainsUglyPercentEncodingA.exit276, %bb.cc
  ...
  %i.vf = load i8, ptr %.02132.i281, align 1, !tbaa !18
...
bb.cc:                                            ; preds = %bb.cb, %.lr.ph.i280
  ...
  br i1 %i.vw, label %.lr.ph.i280, label %uriContainsUglyPercentEncodingA.exit285, !llvm.loop !64
...
bb.cd:                                            ; preds = %uriContainsUglyPercentEncodingA.exit285
  %i.vx = load i32, ptr %2, align 4, !tbaa !8
  %i.vy = or i32 %i.vx, 16
  store i32 %i.vy, ptr %2, align 4, !tbaa !8
  br label %bb.ce
...
.thread311:                                       ; preds = %bb.ce
  %i.vz = load i32, ptr %2, align 4, !tbaa !8
  %i.wa = or i32 %i.vz, 32
  store i32 %i.wa, ptr %2, align 4, !tbaa !8
  br label %bb.ef
...
bb.ck:                                            ; preds = %bb.ci
  ...
  store i32 %i.wj, ptr %i.a, align 4, !tbaa !8
  br label %bb.cl
...
bb.cr:                                            ; preds = %bb.cp
  ...
  store i32 %i.ws, ptr %i.a, align 4, !tbaa !8
  br label %.thread310
...
.thread310:                                       ; preds = %bb.co, %bb.cr, %bb.cm, %bb.cl, %bb.cs
  ...
  %i.wv = load i32, ptr %i.wu, align 4, !tbaa !85
...
bb.cw:                                            ; preds = %bb.cv
  ...
  %i.xi = load ptr, ptr %3, align 8, !tbaa !25
  %i.xj = tail call ptr %i.xi(ptr noundef nonnull %3, i64 noundef %i.xh) #7, !inline_history !78 ; 4 uses
  %i.xk = icmp eq ptr %i.xj, null
  br i1 %i.xk, label %bb.ee, label %.thread.i.i

.thread.i.i:                                      ; preds = %bb.cw
  %i.xl = load ptr, ptr %0, align 8, !tbaa !37
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.xj, ptr align 1 %i.xl, i64 %i.xh, i1 false)
  store ptr %i.xj, ptr %0, align 8, !tbaa !37
  %i.xm = getelementptr inbounds i8, ptr %i.xj, i64 %i.xh
  store ptr %i.xm, ptr %i.xb, align 8, !tbaa !38
  %i.xn = or disjoint i32 %i.wt, 1                ; 2 uses
  store i32 %i.xn, ptr %i.a, align 4, !tbaa !8
  br label %bb.cx
...
bb.cy:                                            ; preds = %bb.cx
  %i.xs = load ptr, ptr %i.xp, align 8, !tbaa !37 ; 3 uses
...
bb.cz:                                            ; preds = %bb.cy
  ...
  %i.xu = load ptr, ptr %i.xt, align 8, !tbaa !38 ; 2 uses
...
bb.da:                                            ; preds = %bb.cz
  ...
  %i.ya = load ptr, ptr %3, align 8, !tbaa !25
  %i.yb = tail call ptr %i.ya(ptr noundef nonnull %3, i64 noundef %i.xz) #7, !inline_history !78 ; 4 uses
  %i.yc = icmp eq ptr %i.yb, null
  br i1 %i.yc, label %bb.ee, label %.thread.i82.i

.thread.i82.i:                                    ; preds = %bb.da
  %i.yd = load ptr, ptr %i.xp, align 8, !tbaa !37
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.yb, ptr align 1 %i.yd, i64 %i.xz, i1 false)
  store ptr %i.yb, ptr %i.xp, align 8, !tbaa !37
  %i.ye = getelementptr inbounds i8, ptr %i.yb, i64 %i.xz
  store ptr %i.ye, ptr %i.xt, align 8, !tbaa !38
...
bb.dc:                                            ; preds = %bb.db
  %i.yk = load ptr, ptr %i.yh, align 8, !tbaa !37 ; 3 uses
...
bb.dd:                                            ; preds = %bb.dc
  ...
  %i.ym = load ptr, ptr %i.yl, align 8, !tbaa !38 ; 2 uses
...
bb.de:                                            ; preds = %bb.dd
  ...
  %i.ys = load ptr, ptr %3, align 8, !tbaa !25
  %i.yt = tail call ptr %i.ys(ptr noundef nonnull %3, i64 noundef %i.yr) #7, !inline_history !78 ; 4 uses
  %i.yu = icmp eq ptr %i.yt, null
  br i1 %i.yu, label %bb.ee, label %.thread.i87.i

.thread.i87.i:                                    ; preds = %bb.de
  %i.yv = load ptr, ptr %i.yh, align 8, !tbaa !37
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.yt, ptr align 1 %i.yv, i64 %i.yr, i1 false)
  store ptr %i.yt, ptr %i.yh, align 8, !tbaa !37
  %i.yw = getelementptr inbounds i8, ptr %i.yt, i64 %i.yr
  store ptr %i.yw, ptr %i.yl, align 8, !tbaa !38
  %i.yx = or disjoint i32 %i.yg, 16               ; 2 uses
  store i32 %i.yx, ptr %i.a, align 4, !tbaa !8
  br label %bb.df
...
bb.dg:                                            ; preds = %bb.df
  %i.zc = load ptr, ptr %i.yz, align 8, !tbaa !37 ; 3 uses
...
bb.dh:                                            ; preds = %bb.dg
  ...
  %i.ze = load ptr, ptr %i.zd, align 8, !tbaa !38 ; 2 uses
...
bb.di:                                            ; preds = %bb.dh
  ...
  %i.zk = load ptr, ptr %3, align 8, !tbaa !25
  %i.zl = tail call ptr %i.zk(ptr noundef nonnull %3, i64 noundef %i.zj) #7, !inline_history !78 ; 4 uses
  %i.zm = icmp eq ptr %i.zl, null
  br i1 %i.zm, label %bb.ee, label %.thread.i92.i

.thread.i92.i:                                    ; preds = %bb.di
  %i.zn = load ptr, ptr %i.yz, align 8, !tbaa !37
  tail call void @llvm.memcpy.p0.p0.i64(ptr nonnull align 1 %i.zl, ptr align 1 %i.zn, i64 %i.zj, i1 false)
  store ptr %i.zl, ptr %i.yz, align 8, !tbaa !37
  %i.zo = getelementptr inbounds i8, ptr %i.zl, i64 %i.zj
  store ptr %i.zo, ptr %i.zd, align 8, !tbaa !38
  %i.zp = or disjoint i32 %i.yy, 32               ; 2 uses
  store i32 %i.zp, ptr %i.a, align 4, !tbaa !8
  br label %bb.dj
...
bb.do:                                            ; preds = %bb.dn
  ...
  %i.aad = load <2 x ptr>, ptr %i.zz, align 8, !tbaa !21
  store <2 x ptr> %i.aad, ptr %i.aac, align 8, !tbaa !21
  br label %bb.dr
...
bb.dr:                                            ; preds = %bb.dq, %bb.dp, %bb.do, %bb.dl, %bb.dk, %bb.dj
  %i.aah = load i32, ptr %i.a, align 4, !tbaa !8  ; 2 uses
...
.lr.ph.i286:                                      ; preds = %.preheader116.i, %bb.ea
  ...
  %i.aak = load ptr, ptr %.062119.i, align 8, !tbaa !37 ; 3 uses
...
bb.ds:                                            ; preds = %.lr.ph.i286
  ...
  %i.aam = load ptr, ptr %i.aal, align 8, !tbaa !38 ; 2 uses
...
bb.du:                                            ; preds = %bb.dx, %.lr.ph122.i
  ...
  %i.abb = load ptr, ptr %i.aba, align 8, !tbaa !34 ; 2 uses
  %i.abc = load ptr, ptr %.061121.i, align 8, !tbaa !31 ; 3 uses
...
bb.dv:                                            ; preds = %bb.du
  ...
  %i.abe = load ptr, ptr %i.abd, align 8, !tbaa !32
  %i.abf = icmp ugt ptr %i.abe, %i.abc
  br i1 %i.abf, label %bb.dw, label %bb.dx

bb.dw:                                            ; preds = %bb.dv
  %i.abg = load ptr, ptr %i.aay, align 8, !tbaa !39
  tail call void %i.abg(ptr noundef nonnull %3, ptr noundef nonnull %i.abc) #7, !inline_history !79
  br label %bb.dx

bb.dx:                                            ; preds = %bb.dw, %bb.dv, %bb.du
  %i.abh = load ptr, ptr %i.aay, align 8, !tbaa !39
  tail call void %i.abh(ptr noundef nonnull %3, ptr noundef nonnull %.061121.i) #7, !inline_history !79
...
bb.dy:                                            ; preds = %bb.dy, %.preheader.i288
  ...
  %i.abj = load ptr, ptr %i.abi, align 8, !tbaa !34 ; 2 uses
  %i.abk = load ptr, ptr %i.aaz, align 8, !tbaa !39
  tail call void %i.abk(ptr noundef nonnull %3, ptr noundef nonnull %.1123.i) #7, !inline_history !79
...
bb.ea:                                            ; preds = %.thread.i97.i, %bb.ds, %.lr.ph.i286
  ...
  %i.abm = load ptr, ptr %i.abl, align 8, !tbaa !34 ; 2 uses
...
bb.ec:                                            ; preds = %bb.eb
  ...
  %i.abr = load ptr, ptr %i.abq, align 8, !tbaa !38 ; 2 uses
...
uriMakeOwnerA.exit:                               ; preds = %.thread.i102.i, %bb.ec, %bb.eb
  store i32 1, ptr %i.wu, align 4, !tbaa !85
  br label %bb.ef
