...
.lr.ph.i28.preheader.i760:                        ; preds = %._crit_edge.i756
  ...
  %umax1747 = tail call i64 @llvm.umax.i64(i64 %i.jag, i64 24)
  %i.jah = add nsw i64 %umax1747, -8              ; 2 uses
...
vector.memcheck1741:                              ; preds = %.lr.ph.i28.preheader.i760
  %umax = tail call i64 @llvm.umax.i64(i64 %i.jag, i64 24)
  %i.jak = add nsw i64 %umax, -8
