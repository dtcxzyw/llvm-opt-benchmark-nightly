...
begin_hunk_0_@_ZN5arrow8internal13unpack_scalarIhEEvPKhPT_iii:bb.a
  ...
  %i.akm = tail call i32 @llvm.fshl.i32(i32 %.val81.i.i.i.i, i32 %.val82.i.i.i.i, i32 4)
  %i.akn = tail call i32 @llvm.fshl.i32(i32 %.val80.i.i.i.i, i32 %.val81.i.i.i.i, i32 1)
...
begin_hunk_2_@_ZN5arrow8internal13unpack_scalarIhEEvPKhPT_iii:bb.a
  ...
  %i.alz = tail call i32 @llvm.fshl.i32(i32 %.val77.i.i.i148.i, i32 %.val78.i.i.i147.i, i32 6)
  %5 = tail call i32 @llvm.fshl.i32(i32 %.val.i.i.i149.i, i32 %.val77.i.i.i148.i, i32 3)
  %6 = tail call i32 @llvm.fshl.i32(i32 %.val79.i.i.i.i, i32 %.val80.i.i.i.i, i32 5)
  %7 = lshr i32 %.val79.i.i.i.i, 9
  %8 = lshr i32 %.val79.i.i.i.i, 2
...
begin_hunk_3_@_ZN5arrow8internal13unpack_scalarIhEEvPKhPT_iii:bb.a
  ...
  %i.amn = trunc i32 %7 to i8
  %i.amo = trunc i32 %8 to i8
  %i.amp = trunc i32 %6 to i8
...
begin_hunk_5_@_ZN5arrow8internal13unpack_scalarItEEvPKhPT_iii:bb.a
  ...
  %i.yg = lshr i32 %.val76.i.i.i.i, 20
  %i.yh = lshr i32 %.val76.i.i.i.i, 15
  %i.yi = lshr i32 %.val76.i.i.i.i, 25
  %i.yj = trunc nuw nsw i32 %i.yi to i16
  %i.yk = trunc nuw nsw i32 %i.yg to i16
  %i.yl = trunc i32 %i.yh to i16
...
begin_hunk_6_@_ZN5arrow8internal13unpack_scalarItEEvPKhPT_iii:bb.a
  ...
  %i.yx = lshr i32 %.val75.i.i.i.i, 18
  %i.yy = lshr i32 %.val75.i.i.i.i, 13
  %i.yz = lshr i32 %.val75.i.i.i.i, 23
  %i.za = trunc i32 %i.yw to i16
  %i.zb = trunc nuw nsw i32 %i.yz to i16
  %i.zc = trunc nuw nsw i32 %i.yx to i16
  %i.zd = trunc i32 %i.yy to i16
...
begin_hunk_7_@_ZN5arrow8internal13unpack_scalarItEEvPKhPT_iii:bb.a
  ...
  %i.aeg = lshr i32 %.val78.i.i.i.i, 18
  %i.aeh = lshr i32 %.val78.i.i.i.i, 12
  %i.aei = lshr i32 %.val78.i.i.i.i, 24
  %i.aej = trunc nuw nsw i32 %i.aei to i16
  %i.aek = trunc nuw nsw i32 %i.aeg to i16
  %i.ael = trunc i32 %i.aeh to i16
...
begin_hunk_8_@_ZN5arrow8internal13unpack_scalarItEEvPKhPT_iii:bb.a
  ...
  %i.agc = lshr i32 %.val75.i.i.i157.i, 18
  %i.agd = lshr i32 %.val75.i.i.i157.i, 12
  %i.age = lshr i32 %.val75.i.i.i157.i, 24
  %i.agf = trunc nuw nsw i32 %i.age to i16
  %i.agg = trunc nuw nsw i32 %i.agc to i16
  %i.agh = trunc i32 %i.agd to i16
