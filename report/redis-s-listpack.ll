...
lpDecodeBacklen.exit:                             ; preds = %19, %30, %41, %48
  %.0.i = phi i64 [ %33, %30 ], [ %22, %19 ], [ %55, %48 ], [ %44, %41 ] ; [#uses=8 type=i64]
  %56 = icmp samesign ult i64 %.0.i, 128          ; [#uses=1 type=i1]
  br i1 %56, label %lpEncodeBacklenBytes.exit, label %57

57:                                               ; preds = %lpDecodeBacklen.exit
  %58 = icmp samesign ult i64 %.0.i, 16383        ; [#uses=1 type=i1]
  br i1 %58, label %lpEncodeBacklenBytes.exit, label %59

59:                                               ; preds = %57
  %60 = icmp samesign ult i64 %.0.i, 2097151      ; [#uses=1 type=i1]
  br i1 %60, label %lpEncodeBacklenBytes.exit, label %61

61:                                               ; preds = %59
  %62 = icmp samesign ult i64 %.0.i, 268435455    ; [#uses=1 type=i1]
...
lpEncodeBacklenBytes.exit:                        ; preds = %61, %45, %lpDecodeBacklen.exit.thread, %lpDecodeBacklen.exit, %57, %59
  %.0.i17 = phi i64 [ %.0.i, %59 ], [ %.0.i, %lpDecodeBacklen.exit ], [ %.0.i, %57 ], [ %13, %lpDecodeBacklen.exit.thread ], [ -1, %45 ], [ %.0.i, %61 ] ; [#uses=1 type=i64]
  ...
  %reass.sub = sub nsw i64 %.0.i14.neg30, %.0.i17 ; [#uses=1 type=i64]
