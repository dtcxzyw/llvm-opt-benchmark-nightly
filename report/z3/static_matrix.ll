...
bb.j:                                             ; preds = %.lr.ph, %_ZN2lp6addmulER8rationalRKS0_S3_.exit
  %.sroa.052.055 = phi ptr [ %i.bj, %.lr.ph ], [ %i.cm, %_ZN2lp6addmulER8rationalRKS0_S3_.exit ] ; 4 uses
  %i.bt = load i32, ptr %.sroa.052.055, align 8, !tbaa !59 ; 3 uses
  %i.bu = icmp eq i32 %i.bt, %3
  br i1 %i.bu, label %_ZN2lp6addmulER8rationalRKS0_S3_.exit, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.bv = load ptr, ptr %i.bn, align 8, !tbaa !132
  ...
  br i1 %i.bz, label %bb.l, label %bb.t

bb.l:                                             ; preds = %bb.k
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #21
  %i.ca = getelementptr inbounds nuw i8, ptr %.sroa.052.055, i64 8
  invoke void @_ZmlRK8rationalS1_(ptr dead_on_unwind nonnull writable sret(%class.rational) align 8 %5, ptr noundef nonnull align 8 dereferenceable(32) %4, ptr noundef nonnull align 8 dereferenceable(32) %i.ca)
          to label %bb.m unwind label %bb.q

bb.m:                                             ; preds = %bb.l
  invoke void @_ZN2lp13static_matrixI8rationalS1_E15add_new_elementEjjRKS1_(ptr noundef nonnull align 8 dereferenceable(184) %0, i32 noundef %i.a, i32 noundef %i.bt, ptr noundef nonnull align 8 dereferenceable(32) %5)
          to label %bb.n unwind label %bb.r

bb.n:                                             ; preds = %bb.m
  %i.cb = load ptr, ptr @_ZN8rational13g_mpq_managerE, align 8, !tbaa !42 ; 2 uses
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.cb, ptr noundef nonnull align 8 dereferenceable(32) %5)
          to label %.noexc.i unwind label %bb.o

.noexc.i:                                         ; preds = %bb.n
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.cb, ptr noundef nonnull align 8 dereferenceable(16) %i.bo)
...
bb.s:                                             ; preds = %bb.r, %bb.q
  %.pn = phi { ptr, i32 } [ %i.cg, %bb.r ], [ %i.cf, %bb.q ]
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #21
  br label %bb.aa

bb.t:                                             ; preds = %bb.k
  %i.ch = sext i32 %i.by to i64
  %i.ci = load ptr, ptr %i.al, align 8, !tbaa !40
  %i.cj = getelementptr inbounds nuw [40 x i8], ptr %i.ci, i64 %i.ch
  %i.ck = getelementptr inbounds nuw i8, ptr %i.cj, i64 8
  %i.cl = getelementptr inbounds nuw i8, ptr %.sroa.052.055, i64 8
  invoke void @_ZN8rational6addmulERKS_S1_(ptr noundef nonnull align 8 dereferenceable(32) %i.ck, ptr noundef nonnull align 8 dereferenceable(32) %i.cl, ptr noundef nonnull align 8 dereferenceable(32) %4)
...
_ZN2lp6addmulER8rationalRKS0_S3_.exit:            ; preds = %bb.t, %_ZN8rationalD2Ev.exit, %bb.j
  %i.cm = getelementptr inbounds nuw i8, ptr %.sroa.052.055, i64 40 ; 2 uses
  %i.cn = icmp eq ptr %i.cm, %i.bl
  br i1 %i.cn, label %.preheader.loopexit, label %bb.j
...
bb.u:                                             ; preds = %bb.u, %.epil.preheader
  ...
  %i.co = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv.epil
  %i.cp = load i32, ptr %i.co, align 4, !tbaa !27
  %i.cq = zext i32 %i.cp to i64
  %i.cr = getelementptr inbounds nuw [4 x i8], ptr %i.bq, i64 %i.cq
  store i32 -1, ptr %i.cr, align 4, !tbaa !27
...
bb.v:                                             ; preds = %bb.v, %.lr.ph57.new
  ...
  %i.cz = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  %i.da = load i32, ptr %i.cz, align 4, !tbaa !27
  %i.db = zext i32 %i.da to i64
  %i.dc = getelementptr inbounds nuw [4 x i8], ptr %i.bq, i64 %i.db
  store i32 -1, ptr %i.dc, align 4, !tbaa !27
  %i.dd = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  ...
  %i.di = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  %i.dj = getelementptr inbounds nuw i8, ptr %i.di, i64 80
  %i.dk = load i32, ptr %i.dj, align 4, !tbaa !27
  %i.dl = zext i32 %i.dk to i64
  %i.dm = getelementptr inbounds nuw [4 x i8], ptr %i.bq, i64 %i.dl
  store i32 -1, ptr %i.dm, align 4, !tbaa !27
  %i.dn = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  %i.do = getelementptr inbounds nuw i8, ptr %i.dn, i64 120
  %i.dp = load i32, ptr %i.do, align 4, !tbaa !27
  %i.dq = zext i32 %i.dp to i64
  %i.dr = getelementptr inbounds nuw [4 x i8], ptr %i.bq, i64 %i.dq
  store i32 -1, ptr %i.dr, align 4, !tbaa !27
...
._crit_edge61:                                    ; preds = %bb.z, %._crit_edge
  %i.ds = load ptr, ptr @_ZN8rational13g_mpq_managerE, align 8, !tbaa !42 ; 2 uses
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.ds, ptr noundef nonnull align 8 dereferenceable(32) %4)
          to label %.noexc.i50 unwind label %bb.w

.noexc.i50:                                       ; preds = %._crit_edge61
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.ds, ptr noundef nonnull align 8 dereferenceable(16) %i.p)
...
bb.w:                                             ; preds = %.noexc.i50, %._crit_edge61
  ...
  call void @__clang_call_terminate(ptr %i.du) #22
  unreachable
...
.lr.ph60:                                         ; preds = %.lr.ph60.preheader, %bb.z
  %indvars.iv64 = phi i64 [ %i.cy, %.lr.ph60.preheader ], [ %i.dv, %bb.z ]
  %i.dv = add nsw i64 %indvars.iv64, -1           ; 3 uses
  %i.dw = load ptr, ptr %i.al, align 8, !tbaa !40
  %i.dx = getelementptr inbounds nuw [40 x i8], ptr %i.dw, i64 %i.dv ; 2 uses
...
bb.x:                                             ; preds = %.lr.ph60
  invoke void @_ZN2lp13static_matrixI8rationalS1_E14remove_elementERSt6vectorINS_8row_cellIS1_EE13std_allocatorIS5_EERS5_(ptr noundef nonnull align 8 dereferenceable(184) %0, ptr noundef nonnull align 8 dereferenceable(24) %i.al, ptr noundef nonnull align 8 dereferenceable(40) %i.dx)
...
bb.m:                                             ; preds = %bb.l
  invoke void @_ZN2lp13static_matrixI8rationalNS_12numeric_pairIS1_EEE15add_new_elementEjjRKS1_(ptr noundef nonnull align 8 dereferenceable(184) %0, i32 noundef %i.a, i32 noundef %i.bt, ptr noundef nonnull align 8 dereferenceable(32) %5)
          to label %bb.n unwind label %bb.r
...
bb.x:                                             ; preds = %.lr.ph60
  invoke void @_ZN2lp13static_matrixI8rationalNS_12numeric_pairIS1_EEE14remove_elementERSt6vectorINS_8row_cellIS1_EE13std_allocatorIS7_EERS7_(ptr noundef nonnull align 8 dereferenceable(184) %0, ptr noundef nonnull align 8 dereferenceable(24) %i.al, ptr noundef nonnull align 8 dereferenceable(40) %i.dx)
          to label %bb.z unwind label %bb.y
...
.body:                                            ; preds = %bb.i, %bb.n
  %eh.lpad-body = phi { ptr, i32 } [ %i.cl, %bb.n ], [ %i.az, %bb.i ]
  call void @_ZN8rationalD2Ev(ptr noundef nonnull align 8 dead_on_return(32) dereferenceable(32) %7) #21
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #21
  br label %bb.ah
...
bb.p:                                             ; preds = %.lr.ph, %_ZN2lp6addmulER8rationalRKS0_S3_.exit
  %.sroa.058.061 = phi ptr [ %i.cc, %.lr.ph ], [ %i.dg, %_ZN2lp6addmulER8rationalRKS0_S3_.exit ] ; 4 uses
  %i.cn = load i32, ptr %.sroa.058.061, align 8, !tbaa !59 ; 3 uses
  %i.co = icmp eq i32 %i.cn, %3
  br i1 %i.co, label %_ZN2lp6addmulER8rationalRKS0_S3_.exit, label %bb.q

bb.q:                                             ; preds = %bb.p
  %i.cp = load ptr, ptr %i.cg, align 8, !tbaa !132
  ...
  br i1 %i.ct, label %bb.r, label %bb.z

bb.r:                                             ; preds = %bb.q
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #21
  %i.cu = getelementptr inbounds nuw i8, ptr %.sroa.058.061, i64 8
  invoke void @_ZmlRK8rationalS1_(ptr dead_on_unwind nonnull writable sret(%class.rational) align 8 %8, ptr noundef nonnull align 8 dereferenceable(32) %6, ptr noundef nonnull align 8 dereferenceable(32) %i.cu)
          to label %bb.s unwind label %bb.w

bb.s:                                             ; preds = %bb.r
  invoke void @_ZN2lp13static_matrixI8rationalNS_12numeric_pairIS1_EEE15add_new_elementEjjRKS1_(ptr noundef nonnull align 8 dereferenceable(184) %0, i32 noundef %i.a, i32 noundef %i.cn, ptr noundef nonnull align 8 dereferenceable(32) %8)
          to label %bb.t unwind label %bb.x

bb.t:                                             ; preds = %bb.s
  %i.cv = load ptr, ptr @_ZN8rational13g_mpq_managerE, align 8, !tbaa !42 ; 2 uses
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.cv, ptr noundef nonnull align 8 dereferenceable(32) %8)
          to label %.noexc.i53 unwind label %bb.u

.noexc.i53:                                       ; preds = %bb.t
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.cv, ptr noundef nonnull align 8 dereferenceable(16) %i.ch)
...
bb.z:                                             ; preds = %bb.q
  %i.db = sext i32 %i.cs to i64
  %i.dc = load ptr, ptr %i.be, align 8, !tbaa !40
  %i.dd = getelementptr inbounds nuw [40 x i8], ptr %i.dc, i64 %i.db
  %i.de = getelementptr inbounds nuw i8, ptr %i.dd, i64 8
  %i.df = getelementptr inbounds nuw i8, ptr %.sroa.058.061, i64 8
  invoke void @_ZN8rational6addmulERKS_S1_(ptr noundef nonnull align 8 dereferenceable(32) %i.de, ptr noundef nonnull align 8 dereferenceable(32) %i.df, ptr noundef nonnull align 8 dereferenceable(32) %6)
...
_ZN2lp6addmulER8rationalRKS0_S3_.exit:            ; preds = %bb.z, %_ZN8rationalD2Ev.exit54, %bb.p
  %i.dg = getelementptr inbounds nuw i8, ptr %.sroa.058.061, i64 40 ; 2 uses
  %i.dh = icmp eq ptr %i.dg, %i.ce
  br i1 %i.dh, label %.preheader.loopexit, label %bb.p
...
bb.aa:                                            ; preds = %bb.aa, %.epil.preheader
  ...
  %i.di = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv.epil
  %i.dj = load i32, ptr %i.di, align 4, !tbaa !27
  %i.dk = zext i32 %i.dj to i64
  %i.dl = getelementptr inbounds nuw [4 x i8], ptr %i.cj, i64 %i.dk
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %bb.aa, %.preheader
  %i.dm = load ptr, ptr %i.bj, align 8, !tbaa !80
  %i.dn = ptrtoint ptr %i.dm to i64
  %i.do = ptrtoint ptr %.pre to i64
  %i.dp = sub i64 %i.dn, %i.do
  %i.dq = sdiv exact i64 %i.dp, 40                ; 2 uses
  %i.dr = and i64 %i.dq, 4294967295
  %.not64 = icmp eq i64 %i.dr, 0
  br i1 %.not64, label %._crit_edge67, label %.lr.ph66.preheader

.lr.ph66.preheader:                               ; preds = %._crit_edge
  %i.ds = and i64 %i.dq, 4294967295
  br label %.lr.ph66
...
bb.ab:                                            ; preds = %bb.ab, %.lr.ph63.new
  ...
  %i.dt = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  %i.du = load i32, ptr %i.dt, align 4, !tbaa !27
  %i.dv = zext i32 %i.du to i64
  %i.dw = getelementptr inbounds nuw [4 x i8], ptr %i.cj, i64 %i.dv
  store i32 -1, ptr %i.dw, align 4, !tbaa !27
  %i.dx = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  %i.dy = getelementptr inbounds nuw i8, ptr %i.dx, i64 40
  %i.dz = load i32, ptr %i.dy, align 4, !tbaa !27
  %i.ea = zext i32 %i.dz to i64
  %i.eb = getelementptr inbounds nuw [4 x i8], ptr %i.cj, i64 %i.ea
  ...
  %i.eg = getelementptr inbounds nuw [4 x i8], ptr %i.cj, i64 %i.ef
  ...
  %i.el = getelementptr inbounds nuw [4 x i8], ptr %i.cj, i64 %i.ek
...
._crit_edge67:                                    ; preds = %bb.af, %._crit_edge
  %i.em = load ptr, ptr @_ZN8rational13g_mpq_managerE, align 8, !tbaa !42 ; 2 uses
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.em, ptr noundef nonnull align 8 dereferenceable(32) %6)
          to label %.noexc.i56 unwind label %bb.ac

.noexc.i56:                                       ; preds = %._crit_edge67
  %i.en = getelementptr inbounds nuw i8, ptr %6, i64 16
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.em, ptr noundef nonnull align 8 dereferenceable(16) %i.en)
...
bb.ac:                                            ; preds = %.noexc.i56, %._crit_edge67
  ...
  call void @__clang_call_terminate(ptr %i.ep) #22
  unreachable
...
.lr.ph66:                                         ; preds = %.lr.ph66.preheader, %bb.af
  %indvars.iv70 = phi i64 [ %i.ds, %.lr.ph66.preheader ], [ %i.eq, %bb.af ]
  %i.eq = add nsw i64 %indvars.iv70, -1           ; 3 uses
  %i.er = load ptr, ptr %i.be, align 8, !tbaa !40
  %i.es = getelementptr inbounds nuw [40 x i8], ptr %i.er, i64 %i.eq ; 2 uses
  %i.et = getelementptr inbounds nuw i8, ptr %i.es, i64 8
  %i.eu = load i32, ptr %i.et, align 8, !tbaa !44
  %i.ev = icmp eq i32 %i.eu, 0
  br i1 %i.ev, label %bb.ad, label %bb.af

bb.ad:                                            ; preds = %.lr.ph66
  invoke void @_ZN2lp13static_matrixI8rationalNS_12numeric_pairIS1_EEE14remove_elementERSt6vectorINS_8row_cellIS1_EE13std_allocatorIS7_EERS7_(ptr noundef nonnull align 8 dereferenceable(184) %0, ptr noundef nonnull align 8 dereferenceable(24) %i.be, ptr noundef nonnull align 8 dereferenceable(40) %i.es)
...
bb.s:                                             ; preds = %bb.r
  invoke void @_ZN2lp13static_matrixI8rationalS1_E15add_new_elementEjjRKS1_(ptr noundef nonnull align 8 dereferenceable(184) %0, i32 noundef %i.a, i32 noundef %i.cn, ptr noundef nonnull align 8 dereferenceable(32) %8)
          to label %bb.t unwind label %bb.x
...
bb.ad:                                            ; preds = %.lr.ph66
  invoke void @_ZN2lp13static_matrixI8rationalS1_E14remove_elementERSt6vectorINS_8row_cellIS1_EE13std_allocatorIS5_EERS5_(ptr noundef nonnull align 8 dereferenceable(184) %0, ptr noundef nonnull align 8 dereferenceable(24) %i.be, ptr noundef nonnull align 8 dereferenceable(40) %i.es)
          to label %bb.af unwind label %bb.ae
...
bb.c:                                             ; preds = %.lr.ph, %bb.i
  %.sroa.033.036 = phi ptr [ %i.w, %.lr.ph ], [ %i.av, %bb.i ] ; 4 uses
  %i.af = load i32, ptr %.sroa.033.036, align 8, !tbaa !59 ; 2 uses
  %i.ag = load ptr, ptr %i.aa, align 8, !tbaa !132
  %i.ah = zext i32 %i.af to i64
  %i.ai = getelementptr inbounds nuw [4 x i8], ptr %i.ag, i64 %i.ah
  %i.aj = load i32, ptr %i.ai, align 4, !tbaa !27 ; 2 uses
  %i.ak = icmp eq i32 %i.aj, -1
  br i1 %i.ak, label %bb.d, label %bb.h

bb.d:                                             ; preds = %bb.c
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #21
  %i.al = getelementptr inbounds nuw i8, ptr %.sroa.033.036, i64 8
  call void @_ZmlRK8rationalS1_(ptr dead_on_unwind nonnull writable sret(%class.rational) align 8 %4, ptr noundef nonnull align 8 dereferenceable(32) %1, ptr noundef nonnull align 8 dereferenceable(32) %i.al)
  invoke void @_ZN2lp13static_matrixI8rationalNS_12numeric_pairIS1_EEE15add_new_elementEjjRKS1_(ptr noundef nonnull align 8 dereferenceable(184) %0, i32 noundef %3, i32 noundef %i.af, ptr noundef nonnull align 8 dereferenceable(32) %4)
          to label %bb.e unwind label %bb.g

bb.e:                                             ; preds = %bb.d
  %i.am = load ptr, ptr @_ZN8rational13g_mpq_managerE, align 8, !tbaa !42 ; 2 uses
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.am, ptr noundef nonnull align 8 dereferenceable(32) %4)
          to label %.noexc.i unwind label %bb.f

.noexc.i:                                         ; preds = %bb.e
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.am, ptr noundef nonnull align 8 dereferenceable(16) %i.ab)
...
bb.h:                                             ; preds = %bb.c
  ...
  %i.ar = load ptr, ptr %i.d, align 8, !tbaa !40
  %i.as = getelementptr inbounds nuw [40 x i8], ptr %i.ar, i64 %i.aq
  %i.at = getelementptr inbounds nuw i8, ptr %i.as, i64 8
  %i.au = getelementptr inbounds nuw i8, ptr %.sroa.033.036, i64 8
  call void @_ZN8rational6addmulERKS_S1_(ptr noundef nonnull align 8 dereferenceable(32) %i.at, ptr noundef nonnull align 8 dereferenceable(32) %i.au, ptr noundef nonnull align 8 dereferenceable(32) %1)
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %_ZN8rationalD2Ev.exit
  %i.av = getelementptr inbounds nuw i8, ptr %.sroa.033.036, i64 40 ; 2 uses
  %i.aw = icmp eq ptr %i.av, %i.y
  br i1 %i.aw, label %.preheader.loopexit, label %bb.c
...
bb.j:                                             ; preds = %bb.j, %.epil.preheader
  ...
  %i.ax = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv.epil
  %i.ay = load i32, ptr %i.ax, align 4, !tbaa !27
  %i.az = zext i32 %i.ay to i64
  %i.ba = getelementptr inbounds nuw [4 x i8], ptr %i.ad, i64 %i.az
  store i32 -1, ptr %i.ba, align 4, !tbaa !27
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %bb.j, %.preheader
  %i.bb = load ptr, ptr %i.e, align 8, !tbaa !80
...
bb.k:                                             ; preds = %bb.k, %.lr.ph38.new
  ...
  %i.bi = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  %i.bj = load i32, ptr %i.bi, align 4, !tbaa !27
  %i.bk = zext i32 %i.bj to i64
  %i.bl = getelementptr inbounds nuw [4 x i8], ptr %i.ad, i64 %i.bk
  store i32 -1, ptr %i.bl, align 4, !tbaa !27
  %i.bm = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  ...
  store i32 -1, ptr %i.bq, align 4, !tbaa !27
  %i.br = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  ...
  store i32 -1, ptr %i.bv, align 4, !tbaa !27
  %i.bw = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
...
.lr.ph41:                                         ; preds = %.lr.ph41.preheader, %bb.m
  %indvars.iv45 = phi i64 [ %i.bh, %.lr.ph41.preheader ], [ %i.cb, %bb.m ]
  %i.cb = add nsw i64 %indvars.iv45, -1           ; 3 uses
  %i.cc = load ptr, ptr %i.d, align 8, !tbaa !40
  %i.cd = getelementptr inbounds nuw [40 x i8], ptr %i.cc, i64 %i.cb ; 2 uses
  %i.ce = getelementptr inbounds nuw i8, ptr %i.cd, i64 8
  %i.cf = load i32, ptr %i.ce, align 8, !tbaa !44
  %i.cg = icmp eq i32 %i.cf, 0
  br i1 %i.cg, label %bb.l, label %bb.m

bb.l:                                             ; preds = %.lr.ph41
  call void @_ZN2lp13static_matrixI8rationalNS_12numeric_pairIS1_EEE14remove_elementERSt6vectorINS_8row_cellIS1_EE13std_allocatorIS7_EERS7_(ptr noundef nonnull align 8 dereferenceable(184) %0, ptr noundef nonnull align 8 dereferenceable(24) %i.d, ptr noundef nonnull align 8 dereferenceable(40) %i.cd)
  br label %bb.m

bb.m:                                             ; preds = %bb.l, %.lr.ph41
  %.not.wide = icmp eq i64 %i.cb, 0
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.al = getelementptr inbounds nuw i8, ptr %.sroa.033.036, i64 8
  call void @_ZmlRK8rationalS1_(ptr dead_on_unwind nonnull writable sret(%class.rational) align 8 %4, ptr noundef nonnull align 8 dereferenceable(32) %1, ptr noundef nonnull align 8 dereferenceable(32) %i.al)
  invoke void @_ZN2lp13static_matrixI8rationalS1_E15add_new_elementEjjRKS1_(ptr noundef nonnull align 8 dereferenceable(184) %0, i32 noundef %3, i32 noundef %i.af, ptr noundef nonnull align 8 dereferenceable(32) %4)
          to label %bb.e unwind label %bb.g
...
bb.l:                                             ; preds = %.lr.ph41
  call void @_ZN2lp13static_matrixI8rationalS1_E14remove_elementERSt6vectorINS_8row_cellIS1_EE13std_allocatorIS5_EERS5_(ptr noundef nonnull align 8 dereferenceable(184) %0, ptr noundef nonnull align 8 dereferenceable(24) %i.d, ptr noundef nonnull align 8 dereferenceable(40) %i.cd)
  br label %bb.m
...
.body:                                            ; preds = %bb.i, %bb.o
  %eh.lpad-body = phi { ptr, i32 } [ %i.co, %bb.o ], [ %i.az, %bb.i ]
  call void @_ZN8rationalD2Ev(ptr noundef nonnull align 8 dead_on_return(32) dereferenceable(32) %7) #21
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #21
  br label %bb.aj
...
bb.q:                                             ; preds = %.lr.ph, %_ZN2lp8lar_term14const_iteratorppEv.exit
  ...
  %i.cq = getelementptr inbounds nuw i8, ptr %.sroa.072.076, i64 8
  %i.cr = load i32, ptr %i.cq, align 8, !tbaa !227 ; 3 uses
  %i.cs = getelementptr inbounds nuw i8, ptr %.sroa.072.076, i64 16 ; 2 uses
  %i.ct = icmp eq i32 %i.cr, %3
  br i1 %i.ct, label %_ZN2lp6addmulER8rationalRKS0_S3_.exit, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.cu = load ptr, ptr %i.cj, align 8, !tbaa !132
  %i.cv = zext i32 %i.cr to i64
  %i.cw = getelementptr inbounds nuw [4 x i8], ptr %i.cu, i64 %i.cv
  %i.cx = load i32, ptr %i.cw, align 4, !tbaa !27 ; 2 uses
  %i.cy = icmp eq i32 %i.cx, -1
  br i1 %i.cy, label %bb.s, label %bb.aa

bb.s:                                             ; preds = %bb.r
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #21
  invoke void @_ZmlRK8rationalS1_(ptr dead_on_unwind nonnull writable sret(%class.rational) align 8 %8, ptr noundef nonnull align 8 dereferenceable(32) %6, ptr noundef nonnull align 8 dereferenceable(32) %i.cs)
          to label %bb.t unwind label %bb.x

bb.t:                                             ; preds = %bb.s
  invoke void @_ZN2lp13static_matrixI8rationalS1_E15add_new_elementEjjRKS1_(ptr noundef nonnull align 8 dereferenceable(184) %0, i32 noundef %i.a, i32 noundef %i.cr, ptr noundef nonnull align 8 dereferenceable(32) %8)
          to label %bb.u unwind label %bb.y

bb.u:                                             ; preds = %bb.t
  %i.cz = load ptr, ptr @_ZN8rational13g_mpq_managerE, align 8, !tbaa !42 ; 2 uses
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.cz, ptr noundef nonnull align 8 dereferenceable(32) %8)
          to label %.noexc.i62 unwind label %bb.v

.noexc.i62:                                       ; preds = %bb.u
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.cz, ptr noundef nonnull align 8 dereferenceable(16) %i.ck)
...
bb.z:                                             ; preds = %bb.y, %bb.x
  %.pn = phi { ptr, i32 } [ %i.de, %bb.y ], [ %i.dd, %bb.x ]
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #21
  br label %bb.ai

bb.aa:                                            ; preds = %bb.r
  %i.df = sext i32 %i.cx to i64
  %i.dg = load ptr, ptr %i.be, align 8, !tbaa !40
  %i.dh = getelementptr inbounds nuw [40 x i8], ptr %i.dg, i64 %i.df
  %i.di = getelementptr inbounds nuw i8, ptr %i.dh, i64 8
  invoke void @_ZN8rational6addmulERKS_S1_(ptr noundef nonnull align 8 dereferenceable(32) %i.di, ptr noundef nonnull align 8 dereferenceable(32) %i.cs, ptr noundef nonnull align 8 dereferenceable(32) %6)
...
_ZN2lp6addmulER8rationalRKS0_S3_.exit:            ; preds = %bb.aa, %_ZN8rationalD2Ev.exit63, %bb.q
  %i.dj = getelementptr inbounds nuw i8, ptr %.sroa.072.076, i64 48 ; 3 uses
  %.not1.i.i.i.i = icmp eq ptr %i.dj, %i.cd
...
.lr.ph.i.i.i.i:                                   ; preds = %_ZN2lp6addmulER8rationalRKS0_S3_.exit, %bb.ab
  %.sroa.072.1 = phi ptr [ %i.dn, %bb.ab ], [ %i.dj, %_ZN2lp6addmulER8rationalRKS0_S3_.exit ] ; 3 uses
  %i.dk = getelementptr inbounds nuw i8, ptr %.sroa.072.1, i64 4
  %i.dl = load i32, ptr %i.dk, align 4, !tbaa !222
  %i.dm = icmp eq i32 %i.dl, 2
  br i1 %i.dm, label %_ZN2lp8lar_term14const_iteratorppEv.exit, label %bb.ab

bb.ab:                                            ; preds = %.lr.ph.i.i.i.i
  %i.dn = getelementptr inbounds nuw i8, ptr %.sroa.072.1, i64 48 ; 3 uses
  %.not.i.i.i.i = icmp eq ptr %i.dn, %i.cd
...
_ZN2lp8lar_term14const_iteratorppEv.exit:         ; preds = %.lr.ph.i.i.i.i, %bb.ab, %_ZN2lp6addmulER8rationalRKS0_S3_.exit
  %.sroa.072.2 = phi ptr [ %i.dj, %_ZN2lp6addmulER8rationalRKS0_S3_.exit ], [ %i.dn, %bb.ab ], [ %.sroa.072.1, %.lr.ph.i.i.i.i ] ; 2 uses
...
bb.ac:                                            ; preds = %bb.ac, %.epil.preheader
  ...
  %i.do = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv.epil
  %i.dp = load i32, ptr %i.do, align 4, !tbaa !27
  %i.dq = zext i32 %i.dp to i64
  %i.dr = getelementptr inbounds nuw [4 x i8], ptr %i.cm, i64 %i.dq
  store i32 -1, ptr %i.dr, align 4, !tbaa !27
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
...
._crit_edge:                                      ; preds = %._crit_edge.loopexit.unr-lcssa, %bb.ac, %.preheader
  %i.ds = load ptr, ptr %i.bj, align 8, !tbaa !80
  %i.dt = ptrtoint ptr %i.ds to i64
  %i.du = ptrtoint ptr %.pre to i64
  %i.dv = sub i64 %i.dt, %i.du
  %i.dw = sdiv exact i64 %i.dv, 40                ; 2 uses
  %i.dx = and i64 %i.dw, 4294967295
  %.not79 = icmp eq i64 %i.dx, 0
  br i1 %.not79, label %._crit_edge82, label %.lr.ph81.preheader

.lr.ph81.preheader:                               ; preds = %._crit_edge
  %i.dy = and i64 %i.dw, 4294967295
  br label %.lr.ph81
...
bb.ad:                                            ; preds = %bb.ad, %.lr.ph78.new
  ...
  %i.dz = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  %i.ea = load i32, ptr %i.dz, align 4, !tbaa !27
  %i.eb = zext i32 %i.ea to i64
  %i.ec = getelementptr inbounds nuw [4 x i8], ptr %i.cm, i64 %i.eb
  store i32 -1, ptr %i.ec, align 4, !tbaa !27
  %i.ed = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  %i.ee = getelementptr inbounds nuw i8, ptr %i.ed, i64 40
  %i.ef = load i32, ptr %i.ee, align 4, !tbaa !27
  %i.eg = zext i32 %i.ef to i64
  %i.eh = getelementptr inbounds nuw [4 x i8], ptr %i.cm, i64 %i.eg
  store i32 -1, ptr %i.eh, align 4, !tbaa !27
  %i.ei = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  %i.ej = getelementptr inbounds nuw i8, ptr %i.ei, i64 80
  %i.ek = load i32, ptr %i.ej, align 4, !tbaa !27
  %i.el = zext i32 %i.ek to i64
  %i.em = getelementptr inbounds nuw [4 x i8], ptr %i.cm, i64 %i.el
  store i32 -1, ptr %i.em, align 4, !tbaa !27
  %i.en = getelementptr inbounds nuw [40 x i8], ptr %.pre, i64 %indvars.iv
  %i.eo = getelementptr inbounds nuw i8, ptr %i.en, i64 120
  %i.ep = load i32, ptr %i.eo, align 4, !tbaa !27
  %i.eq = zext i32 %i.ep to i64
  %i.er = getelementptr inbounds nuw [4 x i8], ptr %i.cm, i64 %i.eq
  store i32 -1, ptr %i.er, align 4, !tbaa !27
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4 ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
...
._crit_edge82:                                    ; preds = %bb.ah, %._crit_edge
  %i.es = load ptr, ptr @_ZN8rational13g_mpq_managerE, align 8, !tbaa !42 ; 2 uses
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.es, ptr noundef nonnull align 8 dereferenceable(32) %6)
          to label %.noexc.i66 unwind label %bb.ae

.noexc.i66:                                       ; preds = %._crit_edge82
  %i.et = getelementptr inbounds nuw i8, ptr %6, i64 16
  invoke void @_ZN11mpz_managerILb1EE3delEPS0_R3mpz(ptr noundef %i.es, ptr noundef nonnull align 8 dereferenceable(16) %i.et)
...
bb.ae:                                            ; preds = %.noexc.i66, %._crit_edge82
  ...
  call void @__clang_call_terminate(ptr %i.ev) #22
  unreachable
...
.lr.ph81:                                         ; preds = %.lr.ph81.preheader, %bb.ah
  %indvars.iv85 = phi i64 [ %i.dy, %.lr.ph81.preheader ], [ %i.ew, %bb.ah ]
  %i.ew = add nsw i64 %indvars.iv85, -1           ; 3 uses
  %i.ex = load ptr, ptr %i.be, align 8, !tbaa !40
  %i.ey = getelementptr inbounds nuw [40 x i8], ptr %i.ex, i64 %i.ew ; 2 uses
  %i.ez = getelementptr inbounds nuw i8, ptr %i.ey, i64 8
  %i.fa = load i32, ptr %i.ez, align 8, !tbaa !44
  %i.fb = icmp eq i32 %i.fa, 0
  br i1 %i.fb, label %bb.af, label %bb.ah

bb.af:                                            ; preds = %.lr.ph81
  invoke void @_ZN2lp13static_matrixI8rationalS1_E14remove_elementERSt6vectorINS_8row_cellIS1_EE13std_allocatorIS5_EERS5_(ptr noundef nonnull align 8 dereferenceable(184) %0, ptr noundef nonnull align 8 dereferenceable(24) %i.be, ptr noundef nonnull align 8 dereferenceable(40) %i.ey)
...
bb.d:                                             ; preds = %.lr.ph, %_ZN2lp8lar_term14const_iteratorppEv.exit
  ...
  %i.am = getelementptr inbounds nuw i8, ptr %.sroa.049.054, i64 8
  %i.an = load i32, ptr %i.am, align 8, !tbaa !227 ; 4 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %.sroa.049.054, i64 16 ; 2 uses
  %i.ap = load ptr, ptr %i.ae, align 8, !tbaa !132
  %i.aq = zext i32 %i.an to i64
  %i.ar = getelementptr inbounds nuw [4 x i8], ptr %i.ap, i64 %i.aq
  %i.as = load i32, ptr %i.ar, align 4, !tbaa !27 ; 2 uses
  %i.at = icmp eq i32 %i.as, -1
  br i1 %i.at, label %bb.e, label %bb.x

bb.e:                                             ; preds = %bb.d
  %i.au = load ptr, ptr %i.ag, align 8, !tbaa !70 ; 2 uses
  %i.av = load ptr, ptr %i.af, align 8, !tbaa !31 ; 2 uses
  %i.aw = ptrtoint ptr %i.au to i64
  %i.ax = ptrtoint ptr %i.av to i64
  %i.ay = sub i64 %i.aw, %i.ax
  %i.az = sdiv exact i64 %i.ay, 24
  %i.ba = trunc i64 %i.az to i32
  %.not1.i = icmp ult i32 %i.an, %i.ba
...
.lr.ph.i36:                                       ; preds = %bb.e, %_ZN2lp13static_matrixI8rationalS1_E10add_columnEv.exit
  %i.bb = phi ptr [ %i.dv, %_ZN2lp13static_matrixI8rationalS1_E10add_columnEv.exit ], [ %i.av, %bb.e ] ; 5 uses
  %i.bc = phi ptr [ %i.do, %_ZN2lp13static_matrixI8rationalS1_E10add_columnEv.exit ], [ %i.au, %bb.e ] ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #21
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %6, i8 0, i64 24, i1 false)
  %i.bd = load ptr, ptr %i.ah, align 8, !tbaa !113
  %.not.i.i.i = icmp eq ptr %i.bc, %i.bd
...
_ZNSt6vectorIS_IN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EES4_IS6_EE9push_backEOS6_.exit.thread.i: ; preds = %.lr.ph.i36
  ...
  store ptr %i.be, ptr %i.ag, align 8, !tbaa !70
...
bb.f:                                             ; preds = %.lr.ph.i36
  ...
  br i1 %i.bi, label %bb.g, label %_ZNKSt6vectorIS_IN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EES4_IS6_EE12_M_check_lenEmPKc.exit.i
...
_ZNKSt6vectorIS_IN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EES4_IS6_EE12_M_check_lenEmPKc.exit.i: ; preds = %bb.f
  %i.bj = sdiv exact i64 %i.bh, 24                ; 3 uses
  %.sroa.speculated.i.i = call i64 @llvm.umax.i64(i64 %i.bj, i64 1)
  %i.bk = add nsw i64 %.sroa.speculated.i.i, %i.bj ; 2 uses
  %i.bl = icmp ult i64 %i.bk, %i.bj
  %i.bm = call i64 @llvm.umin.i64(i64 %i.bk, i64 384307168202282325)
  %i.bn = select i1 %i.bl, i64 384307168202282325, i64 %i.bm ; 3 uses
  %.not.i.i = icmp ne i64 %i.bn, 0
...
.noexc43:                                         ; preds = %_ZNKSt6vectorIS_IN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EES4_IS6_EE12_M_check_lenEmPKc.exit.i
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %6, i8 0, i64 24, i1 false)
  %.not10.i.i.i.i = icmp eq ptr %i.bb, %i.bc
...
.lr.ph.i.i.i.i41:                                 ; preds = %.noexc43, %.lr.ph.i.i.i.i41
  %.012.i.i.i.i = phi ptr [ %i.bw, %.lr.ph.i.i.i.i41 ], [ %i.bp, %.noexc43 ] ; 3 uses
  %.0911.i.i.i.i = phi ptr [ %i.bv, %.lr.ph.i.i.i.i41 ], [ %i.bb, %.noexc43 ] ; 4 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !231)
  call void @llvm.experimental.noalias.scope.decl(metadata !234)
  %i.br = load <2 x ptr>, ptr %.0911.i.i.i.i, align 8, !tbaa !34, !alias.scope !234, !noalias !231
  store <2 x ptr> %i.br, ptr %.012.i.i.i.i, align 8, !tbaa !34, !alias.scope !231, !noalias !234
  %i.bs = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i, i64 16
  %i.bt = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i, i64 16
  %i.bu = load ptr, ptr %i.bt, align 8, !tbaa !122, !alias.scope !234, !noalias !231
  store ptr %i.bu, ptr %i.bs, align 8, !tbaa !122, !alias.scope !231, !noalias !234
  ...
  %i.bv = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i, i64 24 ; 2 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i, i64 24 ; 2 uses
  %.not.i.i.i.i42 = icmp eq ptr %i.bv, %i.bc
...
_ZNSt6vectorIS_IN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EES4_IS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit22.i: ; preds = %.lr.ph.i.i.i.i41, %.noexc43
  %.0.lcssa.i.i.i.i = phi ptr [ %i.bp, %.noexc43 ], [ %i.bw, %.lr.ph.i.i.i.i41 ]
  %i.bx = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i, i64 24 ; 2 uses
...
bb.h:                                             ; preds = %_ZNSt6vectorIS_IN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EES4_IS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit22.i
  invoke void @_ZN6memory10deallocateEPv(ptr noundef nonnull %i.bb)
...
_ZNSt6vectorIS_IN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EES4_IS6_EE9push_backEOS6_.exit.i: ; preds = %_ZNSt6vectorIS_IN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EES4_IS6_EE11_S_relocateEPS6_S9_S9_RS7_.exit22.i, %bb.h
  store ptr %i.bp, ptr %i.af, align 8, !tbaa !31
  store ptr %i.bx, ptr %i.ag, align 8, !tbaa !70
  %i.by = getelementptr inbounds nuw [24 x i8], ptr %i.bp, i64 %i.bn
  store ptr %i.by, ptr %i.ah, align 8, !tbaa !113
  br label %_ZNSt6vectorIN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EED2Ev.exit.i
...
_ZNSt6vectorIN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EED2Ev.exit.i: ; preds = %_ZNSt6vectorIS_IN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EES4_IS6_EE9push_backEOS6_.exit.i, %_ZNSt6vectorIS_IN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EES4_IS6_EE9push_backEOS6_.exit.thread.i
  %i.bz = phi ptr [ %i.be, %_ZNSt6vectorIS_IN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EES4_IS6_EE9push_backEOS6_.exit.thread.i ], [ %i.bx, %_ZNSt6vectorIS_IN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EES4_IS6_EE9push_backEOS6_.exit.i ]
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #21
  %i.ca = load ptr, ptr %i.ae, align 8, !tbaa !132 ; 4 uses
...
bb.i:                                             ; preds = %_ZNSt6vectorIN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EED2Ev.exit.i
  ...
  %i.cd = load i32, ptr %i.cc, align 4, !tbaa !27 ; 5 uses
  %i.ce = getelementptr inbounds i8, ptr %i.ca, i64 -8 ; 2 uses
  %i.cf = load i32, ptr %i.ce, align 4, !tbaa !27
  %i.cg = icmp eq i32 %i.cd, %i.cf
  br i1 %i.cg, label %bb.k, label %_ZN2lp13static_matrixI8rationalS1_E10add_columnEv.exit

bb.j:                                             ; preds = %_ZNSt6vectorIN2lp8row_cellINS0_12empty_structEEE13std_allocatorIS3_EED2Ev.exit.i
  %i.ch = call noalias noundef ptr @_ZN6memory8allocateEm(i64 noundef 16) ; 3 uses
  store i32 2, ptr %i.ch, align 4, !tbaa !27
  ...
  store ptr %i.cj, ptr %i.ae, align 8, !tbaa !132
...
bb.k:                                             ; preds = %bb.i
  ...
  %i.cn = shl i32 %i.cm, 2
  %i.co = add i32 %i.cn, 8                        ; 2 uses
  %.not.i40 = icmp ugt i32 %i.cm, %i.cd
  br i1 %.not.i40, label %bb.l, label %bb.m

bb.l:                                             ; preds = %bb.k
  %i.cp = shl i32 %i.cd, 2
  %i.cq = add i32 %i.cp, 8
  %.not27.i = icmp ugt i32 %i.co, %i.cq
  br i1 %.not27.i, label %bb.r, label %bb.m

bb.m:                                             ; preds = %bb.l, %bb.k
  %i.cr = call ptr @__cxa_allocate_exception(i64 40) #21 ; 6 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #21
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #21
...
bb.n:                                             ; preds = %bb.m
  store ptr getelementptr inbounds nuw inrange(-16, 32) (i8, ptr @_ZTV17default_exception, i64 16), ptr %i.cr, align 8, !tbaa !237
  %i.cs = getelementptr inbounds nuw i8, ptr %i.cr, i64 8 ; 2 uses
  %i.ct = getelementptr inbounds nuw i8, ptr %i.cr, i64 24 ; 3 uses
  store ptr %i.ct, ptr %i.cs, align 8, !tbaa !239
  %i.cu = load ptr, ptr %4, align 8, !tbaa !242   ; 2 uses
  %i.cv = getelementptr inbounds nuw i8, ptr %4, i64 16 ; 7 uses
  %i.cw = icmp eq ptr %i.cu, %i.cv
  br i1 %i.cw, label %bb.o, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i

bb.o:                                             ; preds = %bb.n
  %i.cx = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.cy = load i64, ptr %i.cx, align 8, !tbaa !244 ; 3 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i: ; preds = %bb.n
  store ptr %i.cu, ptr %i.cs, align 8, !tbaa !242
  %i.db = load i64, ptr %i.cv, align 8, !tbaa !245
  store i64 %i.db, ptr %i.ct, align 8, !tbaa !245
...
_ZN17default_exceptionC2EONSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i, %bb.o
  %i.dc = phi i64 [ %i.cy, %bb.o ], [ %.pre.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i ]
  %i.dd = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.de = getelementptr inbounds nuw i8, ptr %i.cr, i64 16
  store i64 %i.dc, ptr %i.de, align 8, !tbaa !244
  store ptr %i.cv, ptr %4, align 8, !tbaa !242
  store i64 0, ptr %i.dd, align 8, !tbaa !244
  store i8 0, ptr %i.cv, align 8, !tbaa !245
  invoke void @__cxa_throw(ptr nonnull %i.cr, ptr nonnull @_ZTI17default_exception, ptr nonnull @_ZN17default_exceptionD2Ev) #24
...
bb.p:                                             ; preds = %_ZN17default_exceptionC2EONSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit.i
  %i.df = landingpad { ptr, i32 }
          cleanup
  %i.dg = load ptr, ptr %4, align 8, !tbaa !242   ; 2 uses
  %i.dh = icmp eq ptr %i.dg, %i.cv
  br i1 %i.dh, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.thread.i, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i29.i
