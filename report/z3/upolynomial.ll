...
bb.n:                                             ; preds = %bb.c, %_ZN13mpzzp_manager7dividesERK3mpzS2_.exit, %bb.b, %bb.a, %_ZN15_scoped_numeralI13mpzzp_managerED2Ev.exit
  %.1 = phi i1 [ %i.bv, %_ZN15_scoped_numeralI13mpzzp_managerED2Ev.exit ], [ false, %bb.a ], [ true, %bb.b ], [ false, %_ZN13mpzzp_manager7dividesERK3mpzS2_.exit ], [ false, %bb.c ]
  ret i1 %.1
}
...
bb.p:                                             ; preds = %bb.a, %_ZN15_scoped_numeralI13mpzzp_managerED2Ev.exit29, %bb.b
  %.0 = phi i1 [ %i.aq, %_ZN15_scoped_numeralI13mpzzp_managerED2Ev.exit29 ], [ false, %bb.b ], [ true, %bb.a ]
  ret i1 %.0
}
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.c
  ...
  %.019 = phi i32 [ 0, %.lr.ph.preheader ], [ %.2, %bb.c ] ; 2 uses
  %.01417 = phi i32 [ 0, %.lr.ph.preheader ], [ %.115, %bb.c ] ; 3 uses
...
bb.b:                                             ; preds = %.lr.ph
  ...
  %i.d = icmp ne i32 %.0.i, %.01417
  %i.e = icmp ne i32 %.01417, 0
  %or.cond = and i1 %i.e, %i.d
  %i.f = zext i1 %or.cond to i32
  %spec.select = add i32 %.019, %i.f
  br label %bb.c

bb.c:                                             ; preds = %.lr.ph, %bb.b
  %.115 = phi i32 [ %.0.i, %bb.b ], [ %.01417, %.lr.ph ]
  %.2 = phi i32 [ %spec.select, %bb.b ], [ %.019, %.lr.ph ] ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge, label %.lr.ph, !llvm.loop !154

._crit_edge:                                      ; preds = %bb.c, %bb.a
  %.0.lcssa = phi i32 [ 0, %bb.a ], [ %.2, %bb.c ]
  ret i32 %.0.lcssa
}
...
.lr.ph.i:                                         ; preds = %bb.c, %.lr.ph.preheader.i
  ...
  %.019.i = phi i32 [ 0, %.lr.ph.preheader.i ], [ %.2.i, %bb.c ] ; 2 uses
  %.01417.i = phi i32 [ 0, %.lr.ph.preheader.i ], [ %.115.i, %bb.c ] ; 3 uses
...
bb.b:                                             ; preds = %.lr.ph.i
  ...
  %i.d = icmp ne i32 %.0.i.i, %.01417.i
  %i.e = icmp ne i32 %.01417.i, 0
  %or.cond.i = and i1 %i.e, %i.d
  %i.f = zext i1 %or.cond.i to i32
  %spec.select.i = add i32 %.019.i, %i.f
  br label %bb.c

bb.c:                                             ; preds = %bb.b, %.lr.ph.i
  %.115.i = phi i32 [ %.0.i.i, %bb.b ], [ %.01417.i, %.lr.ph.i ]
  %.2.i = phi i32 [ %spec.select.i, %bb.b ], [ %.019.i, %.lr.ph.i ] ; 2 uses
...
_ZN11upolynomial7manager12sign_changesEjPK3mpz.exit: ; preds = %bb.c, %bb.a
  %.0.lcssa.i = phi i32 [ 0, %bb.a ], [ %.2.i, %bb.c ]
  ret i32 %.0.lcssa.i
}
...
bb.c:                                             ; preds = %bb.b, %bb.o
  ...
  %.03455 = phi i32 [ 0, %bb.b ], [ %i.bd, %bb.o ] ; 2 uses
  %.03554 = phi i32 [ 0, %bb.b ], [ %.237.ph, %bb.o ] ; 3 uses
  %.03953 = phi i32 [ 0, %bb.b ], [ %.140.ph, %bb.o ] ; 3 uses
...
_ZN11upolynomial12core_manager10checkpointEv.exit._crit_edge: ; preds = %_ZN13mpzzp_manager3addERK3mpzS2_RS0_.exit, %_ZN11upolynomial12core_manager10checkpointEv.exit.preheader
  %.031.lcssa = phi i64 [ 0, %_ZN11upolynomial12core_manager10checkpointEv.exit.preheader ], [ %indvars.iv, %_ZN13mpzzp_manager3addERK3mpzS2_RS0_.exit ]
  %i.ay = load ptr, ptr %i.b, align 8, !tbaa !31
  %i.az = getelementptr inbounds nuw [16 x i8], ptr %i.ay, i64 %.031.lcssa
...
bb.m:                                             ; preds = %_ZN11upolynomial12core_manager10checkpointEv.exit._crit_edge
  %.not = icmp eq i32 %.0.i, %.03953
  %i.bc = icmp eq i32 %.03953, 0
  %or.cond = or i1 %i.bc, %.not
  br i1 %or.cond, label %bb.o, label %bb.n

bb.n:                                             ; preds = %bb.m
  %.not62 = icmp eq i32 %.03554, 0
  br i1 %.not62, label %bb.o, label %.loopexit

bb.o:                                             ; preds = %bb.n, %_ZN11upolynomial12core_manager10checkpointEv.exit._crit_edge, %bb.m
  %.140.ph = phi i32 [ %.03953, %_ZN11upolynomial12core_manager10checkpointEv.exit._crit_edge ], [ %.0.i, %bb.m ], [ %.0.i, %bb.n ]
  %.237.ph = phi i32 [ %.03554, %_ZN11upolynomial12core_manager10checkpointEv.exit._crit_edge ], [ %.03554, %bb.m ], [ 1, %bb.n ] ; 2 uses
  %i.bd = add nuw i32 %.03455, 1                  ; 2 uses
...
.loopexit:                                        ; preds = %bb.o, %bb.n, %bb.a
  %.4 = phi i32 [ 0, %bb.a ], [ 2, %bb.n ], [ %.237.ph, %bb.o ]
  ret i32 %.4
}
