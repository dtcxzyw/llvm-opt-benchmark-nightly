...
.outer:                                           ; preds = %bb.e, %bb.a
  %.018.ph.a = phi i32 [ %i.f, %bb.e ], [ %i.a, %bb.a ]
  %.017.ph = phi i32 [ %.017, %bb.e ], [ 0, %bb.a ]
  %.020.ph = add i32 %.018.ph.a, -1               ; 2 uses
  br label %bb.b

bb.b:                                             ; preds = %.outer, %bb.c
  %.017 = phi i32 [ %i.k, %bb.c ], [ %.017.ph, %.outer ] ; 3 uses
  %i.d = sub nsw i32 %.020.ph, %.017              ; 2 uses
  %i.e = sdiv i32 %i.d, 2
  %i.f = add nsw i32 %i.e, %.017                  ; 5 uses
...
.loopexit:                                        ; preds = %bb.e, %bb.d, %bb.c
  %.122.ph = phi i32 [ -1, %bb.c ], [ -1, %bb.e ], [ %i.f, %bb.d ]
  ret i32 %.122.ph
}
...
.preheader:                                       ; preds = %bb.au, %_ZN6vectorIjLb0EjE5resetEv.exit
  %.0.lcssa = phi i32 [ 0, %_ZN6vectorIjLb0EjE5resetEv.exit ], [ %.255, %bb.au ] ; 2 uses
...
bb.k:                                             ; preds = %.lr.ph, %bb.au
  %.0133 = phi i32 [ 0, %.lr.ph ], [ %.2, %bb.au ] ; 6 uses
  %.053132 = phi i32 [ 0, %.lr.ph ], [ %.255, %bb.au ] ; 5 uses
  %i.cr = icmp eq i32 %.053132, %i.z
  br i1 %i.cr, label %.preheader128, label %bb.t

.preheader128:                                    ; preds = %bb.k
  %i.cs = icmp ult i32 %.0133, %i.y
  br i1 %i.cs, label %.lr.ph135, label %.loopexit

.lr.ph135:                                        ; preds = %.preheader128
  %i.ct = zext i32 %.0133 to i64
  br label %bb.l
...
bb.t:                                             ; preds = %bb.k
  ...
  %i.fb = zext i32 %.0133 to i64                  ; 5 uses
  ...
  %i.ff = zext i32 %.053132 to i64                ; 4 uses
...
bb.at:                                            ; preds = %_ZN6vectorIjLb0EjE9push_backEOj.exit119, %bb.al
  %i.lz = add i32 %.0133, 1
  %i.ma = add i32 %.053132, 1
  br label %bb.au

bb.au:                                            ; preds = %_ZN6vectorIjLb0EjE9push_backEOj.exit110, %bb.at, %_ZN6vectorIjLb0EjE9push_backEOj.exit95
  %.255 = phi i32 [ %.053132, %_ZN6vectorIjLb0EjE9push_backEOj.exit95 ], [ %i.jx, %_ZN6vectorIjLb0EjE9push_backEOj.exit110 ], [ %i.ma, %bb.at ] ; 2 uses
  %.2 = phi i32 [ %i.hp, %_ZN6vectorIjLb0EjE9push_backEOj.exit95 ], [ %.0133, %_ZN6vectorIjLb0EjE9push_backEOj.exit110 ], [ %i.lz, %bb.at ] ; 2 uses
