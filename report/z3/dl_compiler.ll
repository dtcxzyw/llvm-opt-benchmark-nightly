...
.lr.ph.i.i:                                       ; preds = %bb.g, %.lr.ph.i.i.preheader.new
  %.013.i.i = phi ptr [ %i.h, %.lr.ph.i.i.preheader.new ], [ %i.w, %bb.g ] ; 4 uses
  %.0712.i.i = phi i32 [ 0, %.lr.ph.i.i.preheader.new ], [ %.1.i.i.1, %bb.g ] ; 2 uses
  %niter = phi i64 [ 0, %.lr.ph.i.i.preheader.new ], [ %niter.next.1, %bb.g ]
  %i.p = load ptr, ptr %.013.i.i, align 8, !tbaa !14
  %i.q = icmp eq ptr %i.p, null
  br i1 %i.q, label %bb.d, label %bb.c

bb.c:                                             ; preds = %.lr.ph.i.i
  store ptr null, ptr %.013.i.i, align 8, !tbaa !14
  br label %.lr.ph.i.i.1

bb.d:                                             ; preds = %.lr.ph.i.i
  %i.r = add i32 %.0712.i.i, 1
  br label %.lr.ph.i.i.1

.lr.ph.i.i.1:                                     ; preds = %bb.d, %bb.c
  %.1.i.i = phi i32 [ %i.r, %bb.d ], [ %.0712.i.i, %bb.c ] ; 2 uses
  %i.s = getelementptr inbounds nuw i8, ptr %.013.i.i, i64 16 ; 2 uses
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.w = getelementptr inbounds nuw i8, ptr %.013.i.i, i64 32 ; 2 uses
...
.lr.ph.i.i.epil.preheader:                        ; preds = %._crit_edge.i.i.unr-lcssa, %.lr.ph.i.i.preheader
  %.013.i.i.epil.init = phi ptr [ %i.h, %.lr.ph.i.i.preheader ], [ %i.w, %._crit_edge.i.i.unr-lcssa ] ; 2 uses
  %.0712.i.i.epil.init = phi i32 [ 0, %.lr.ph.i.i.preheader ], [ %.1.i.i.1, %._crit_edge.i.i.unr-lcssa ] ; 2 uses
  %lcmp.mod5 = trunc i64 %i.n to i1
  tail call void @llvm.assume(i1 %lcmp.mod5)
  %i.y = load ptr, ptr %.013.i.i.epil.init, align 8, !tbaa !14
  %i.z = icmp eq ptr %i.y, null
  br i1 %i.z, label %bb.i, label %bb.h

bb.h:                                             ; preds = %.lr.ph.i.i.epil.preheader
  store ptr null, ptr %.013.i.i.epil.init, align 8, !tbaa !14
  br label %._crit_edge.i.i

bb.i:                                             ; preds = %.lr.ph.i.i.epil.preheader
  %i.aa = add i32 %.0712.i.i.epil.init, 1
  br label %._crit_edge.i.i

._crit_edge.i.i:                                  ; preds = %bb.h, %bb.i, %._crit_edge.i.i.unr-lcssa
  %.1.i.i.lcssa = phi i32 [ %.1.i.i.1, %._crit_edge.i.i.unr-lcssa ], [ %i.aa, %bb.i ], [ %.0712.i.i.epil.init, %bb.h ]
...
_ZNK15ref_vector_coreI4expr19ref_manager_wrapperIS0_11ast_managerEE5emptyEv.exit412.thread: ; preds = %._crit_edge843, %_ZN7obj_refI3app11ast_managerED2Ev.exit563, %_ZNK15ref_vector_coreI4expr19ref_manager_wrapperIS0_11ast_managerEE5emptyEv.exit412
  ...
  %.not881 = icmp eq i32 %i.s, 0
  br i1 %.not881, label %._crit_edge871, label %.lr.ph870

.lr.ph870:                                        ; preds = %_ZNK15ref_vector_coreI4expr19ref_manager_wrapperIS0_11ast_managerEE5emptyEv.exit412.thread
  %i.atl = getelementptr inbounds nuw i8, ptr %i.q, i64 32
  %wide.trip.count953 = zext i32 %i.s to i64
  br label %bb.kk

._crit_edge871:                                   ; preds = %bb.lf, %_ZNK15ref_vector_coreI4expr19ref_manager_wrapperIS0_11ast_managerEE5emptyEv.exit412.thread
...
bb.kk:                                            ; preds = %.lr.ph870, %bb.lf
  %i.atn = phi ptr [ null, %.lr.ph870 ], [ %i.awv, %bb.lf ] ; 3 uses
  %indvars.iv950 = phi i64 [ 0, %.lr.ph870 ], [ %indvars.iv.next951, %bb.lf ] ; 3 uses
  %i.ato = load ptr, ptr %i.atk, align 8, !tbaa !28
  %i.atp = getelementptr inbounds nuw [8 x i8], ptr %i.ato, i64 %indvars.iv950
  %i.atq = load ptr, ptr %i.atp, align 8, !tbaa !250
  %i.atr = getelementptr inbounds nuw [8 x i8], ptr %i.atl, i64 %indvars.iv950
...
_ZNK9table2mapI17default_map_entryIj7svectorIjjEE6u_hash4u_eqE9find_coreERKj.exit575._ZNK6vectorIjLb0EjE4sizeEv.exit580_crit_edge: ; preds = %_ZNK9table2mapI17default_map_entryIj7svectorIjjEE6u_hash4u_eqE9find_coreERKj.exit575
  %.pre981.a = load i32, ptr inttoptr (i64 -4 to ptr), align 4, !tbaa !27
...
_ZNK6vectorIjLb0EjE4sizeEv.exit580:               ; preds = %_ZNK9table2mapI17default_map_entryIj7svectorIjjEE6u_hash4u_eqE9find_coreERKj.exit575._ZNK6vectorIjLb0EjE4sizeEv.exit580_crit_edge, %bb.ks
  %i.ave = phi i32 [ %i.avb, %bb.ks ], [ %.pre981.a, %_ZNK9table2mapI17default_map_entryIj7svectorIjjEE6u_hash4u_eqE9find_coreERKj.exit575._ZNK6vectorIjLb0EjE4sizeEv.exit580_crit_edge ] ; 2 uses
  ...
  %i.avh = inttoptr i64 %.sroa.8710.16.insert.ext712 to ptr ; 2 uses
...
.loopexit:                                        ; preds = %.lr.ph.i.i566, %.lr.ph34.i.i572, %bb.kr, %.preheader.i.i570
  ...
  %i.avm = inttoptr i64 %.sroa.8710.16.insert.ext to ptr
  br label %bb.lc
...
bb.kw:                                            ; preds = %bb.kv
  br i1 %i.avp, label %._crit_edge982, label %bb.kx

._crit_edge982:                                   ; preds = %bb.kw
  %.pre983 = load ptr, ptr %39, align 8, !tbaa !314
  br label %bb.lc
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.ky
  ...
  %.phi.trans.insert978 = getelementptr inbounds nuw i8, ptr %41, i64 8
  %.pre979 = load i64, ptr %.phi.trans.insert978, align 8, !tbaa !360
  br label %_ZN17default_exceptionC2EONSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit
...
_ZN17default_exceptionC2EONSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit: ; preds = %bb.kz, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  %i.awb = phi i64 [ %i.avx, %bb.kz ], [ %.pre979, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ]
...
bb.lc:                                            ; preds = %._crit_edge982, %.loopexit, %bb.kt, %_ZNK6vectorIjLb0EjE4sizeEv.exit580
  %i.awk = phi ptr [ %i.atn, %_ZNK6vectorIjLb0EjE4sizeEv.exit580 ], [ %i.atn, %.loopexit ], [ %i.atn, %bb.kt ], [ %.pre983, %._crit_edge982 ] ; 4 uses
  %.sroa.8710.1 = phi ptr [ %i.avh, %_ZNK6vectorIjLb0EjE4sizeEv.exit580 ], [ %i.avm, %.loopexit ], [ %i.avh, %bb.kt ], [ %i.ats, %._crit_edge982 ]
  %.sroa.5.1 = phi i32 [ 0, %_ZNK6vectorIjLb0EjE4sizeEv.exit580 ], [ 1, %.loopexit ], [ 0, %bb.kt ], [ 2, %._crit_edge982 ]
...
bb.lf:                                            ; preds = %.noexc585, %bb.ld
  ...
  store ptr %.sroa.8710.1, ptr %.sroa.8710.0..sroa_idx, align 8, !tbaa !320
  ...
  br i1 %exitcond954.not, label %._crit_edge871, label %bb.kk, !llvm.loop !441

bb.lg:                                            ; preds = %._crit_edge871
...
bb.lm:                                            ; preds = %bb.ll, %bb.lk, %bb.li, %bb.lg, %._crit_edge871
