...
bb.s:                                             ; preds = %_ZNK8seq_util3str7is_unitEPK4expr.exit
  %i.bq = getelementptr inbounds nuw i8, ptr %.091192, i64 8 ; 2 uses
  %.not = icmp eq ptr %i.bq, %i.bn
  br i1 %.not, label %._crit_edge, label %bb.t

bb.t:                                             ; preds = %.lr.ph, %bb.s
  %.091192 = phi ptr [ %i.bh, %.lr.ph ], [ %i.bq, %bb.s ] ; 2 uses
  %i.br = load ptr, ptr %.091192, align 8, !tbaa !8 ; 2 uses
...
bb.v:                                             ; preds = %_ZNK8seq_util3str7is_unitEPK4expr.exit118
  %i.cp = getelementptr inbounds nuw i8, ptr %.078194, i64 8 ; 2 uses
...
bb.w:                                             ; preds = %.lr.ph195, %bb.v
  %.078194 = phi ptr [ %i.cg, %.lr.ph195 ], [ %i.cp, %bb.v ] ; 2 uses
  %i.cq = load ptr, ptr %.078194, align 8, !tbaa !8 ; 2 uses
...
_ZNK8seq_util3str7is_unitEPK4exprRPS1_.exit82.thread: ; preds = %bb.n, %bb.m, %_ZNK8seq_util3str7is_unitEPK4expr.exit.i81, %bb.aa, %bb.ac
  %i.gt = invoke noundef zeroext i1 @_ZNK8seq_util3str9is_stringEPK4exprR7zstring(ptr noundef nonnull align 8 dereferenceable(20) %i.l, ptr noundef nonnull %.0188, ptr noundef nonnull align 8 dereferenceable(80) %5)
          to label %bb.be unwind label %bb.k

bb.be:                                            ; preds = %_ZNK8seq_util3str7is_unitEPK4exprRPS1_.exit82.thread
  br i1 %i.gt, label %bb.bf, label %.thread217

bb.bf:                                            ; preds = %bb.be
  %i.gu = invoke noundef zeroext i1 @_ZNK8seq_util3str9is_stringEPK4exprR7zstring(ptr noundef nonnull align 8 dereferenceable(20) %i.l, ptr noundef nonnull %.0189, ptr noundef nonnull align 8 dereferenceable(80) %6)
          to label %bb.bg unwind label %bb.k

bb.bg:                                            ; preds = %bb.bf
  br i1 %i.gu, label %bb.bh, label %.thread217
...
bb.bh:                                            ; preds = %bb.bg
  ...
  %.not54225.not = icmp eq i32 %.sroa.speculated, 0
  br i1 %.not54225.not, label %._crit_edge, label %.lr.ph
...
bb.bj:                                            ; preds = %.lr.ph, %bb.bi
  ...
  br i1 %.not, label %bb.bi, label %.thread210

._crit_edge:                                      ; preds = %bb.bi, %bb.bh
  %.not223 = icmp ugt i32 %i.gv, %i.gw
  br i1 %.not223, label %bb.bl, label %bb.bk
...
bb.bz:                                            ; preds = %_ZN7zstringD2Ev.exit107, %bb.bk
  ...
  %.2179 = phi i32 [ %i.hd, %bb.bk ], [ %.1178, %_ZN7zstringD2Ev.exit107 ] ; 2 uses
...
.thread204.backedge:                              ; preds = %bb.ca, %_ZN7zstringD2Ev.exit118, %bb.l, %bb.z, %_ZN7obj_refI4expr11ast_managerED2Ev.exit, %bb.ak
  %.0182.be = phi i32 [ %.1183, %_ZN7obj_refI4expr11ast_managerED2Ev.exit ], [ %i.bp, %bb.l ], [ %i.ea, %bb.z ], [ %i.fm, %bb.ak ], [ %.1183, %_ZN7zstringD2Ev.exit118 ], [ %i.ib, %bb.ca ]
  %.0177.be = phi i32 [ %i.fj, %_ZN7obj_refI4expr11ast_managerED2Ev.exit ], [ %i.bo, %bb.l ], [ %i.dz, %bb.z ], [ %i.fj, %bb.ak ], [ %.2179, %_ZN7zstringD2Ev.exit118 ], [ %.2179, %bb.ca ]
  br label %.thread204
...
.thread217:                                       ; preds = %bb.bg, %bb.be, %_ZNK15ref_vector_coreI4expr19ref_manager_wrapperIS0_11ast_managerEE4sizeEv.exit, %_ZNK15ref_vector_coreI4expr19ref_manager_wrapperIS0_11ast_managerEE4sizeEv.exit72
  %.5187 = phi i32 [ %.0182, %_ZNK15ref_vector_coreI4expr19ref_manager_wrapperIS0_11ast_managerEE4sizeEv.exit ], [ %.0182, %_ZNK15ref_vector_coreI4expr19ref_manager_wrapperIS0_11ast_managerEE4sizeEv.exit72 ], [ %.1183, %bb.be ], [ %.1183, %bb.bg ]
  %.6 = phi i32 [ %.0177, %_ZNK15ref_vector_coreI4expr19ref_manager_wrapperIS0_11ast_managerEE4sizeEv.exit ], [ %.0177, %_ZNK15ref_vector_coreI4expr19ref_manager_wrapperIS0_11ast_managerEE4sizeEv.exit72 ], [ %.1178, %bb.be ], [ %.1178, %bb.bg ]
