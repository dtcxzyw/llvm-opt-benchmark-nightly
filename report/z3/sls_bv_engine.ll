...
bb.an:                                            ; preds = %_ZNK3app13get_decl_kindEv.exit
  %i.gb = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.gc = load ptr, ptr %i.gb, align 8, !tbaa !219, !nonnull !165, !align !166 ; 2 uses
  %i.gd = load ptr, ptr %i.aw, align 8, !tbaa !200 ; 3 uses
  %i.ge = getelementptr inbounds nuw i8, ptr %i.gc, i64 120
  %i.gf = getelementptr inbounds nuw i8, ptr %i.gd, i64 12
  %i.gg = load i32, ptr %i.gf, align 4, !tbaa !213 ; 3 uses
  %i.gh = getelementptr inbounds nuw i8, ptr %i.gc, i64 128
  %i.gi = load i32, ptr %i.gh, align 8, !tbaa !122 ; 3 uses
  %i.gj = add i32 %i.gi, -1
  %i.gk = and i32 %i.gj, %i.gg                    ; 2 uses
  %i.gl = load ptr, ptr %i.ge, align 8, !tbaa !127 ; 3 uses
  %i.gm = zext i32 %i.gi to i64
  %i.gn = getelementptr inbounds nuw [64 x i8], ptr %i.gl, i64 %i.gm
  %.not34.i.i.i.i417 = icmp eq i32 %i.gk, %i.gi
  br i1 %.not34.i.i.i.i417, label %.lr.ph38.i.i.i.i424.preheader, label %.lr.ph.i.i.i.i418.preheader

.lr.ph.i.i.i.i418.preheader:                      ; preds = %bb.an
  %i.go = zext i32 %i.gk to i64
  %.idx.i.i.i.i416 = shl nuw nsw i64 %i.go, 6
  %i.gp = getelementptr inbounds nuw i8, ptr %i.gl, i64 %.idx.i.i.i.i416
  br label %.lr.ph.i.i.i.i418

.lr.ph.i.i.i.i418:                                ; preds = %.lr.ph.i.i.i.i418.preheader, %bb.aq
  %.035.i.i.i.i419 = phi ptr [ %i.gw, %bb.aq ], [ %i.gp, %.lr.ph.i.i.i.i418.preheader ] ; 3 uses
  %i.gq = load ptr, ptr %.035.i.i.i.i419, align 8, !tbaa !216 ; 4 uses
  %i.gr = icmp ult ptr %i.gq, inttoptr (i64 2 to ptr)
  br i1 %i.gr, label %bb.ap, label %bb.ao

bb.ao:                                            ; preds = %.lr.ph.i.i.i.i418
  %i.gs = getelementptr inbounds nuw i8, ptr %i.gq, i64 12
  %i.gt = load i32, ptr %i.gs, align 4, !tbaa !213
  %i.gu = icmp eq i32 %i.gt, %i.gg
  %i.gv = icmp eq ptr %i.gq, %i.gd
  %or.cond.i.i.i.i420 = and i1 %i.gv, %i.gu
  br i1 %or.cond.i.i.i.i420, label %_ZN11sls_tracker9get_valueEP4expr.exit432, label %bb.aq

bb.ap:                                            ; preds = %.lr.ph.i.i.i.i418
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.gq) ]
  br label %bb.aq

bb.aq:                                            ; preds = %bb.ap, %bb.ao
  %i.gw = getelementptr inbounds nuw i8, ptr %.035.i.i.i.i419, i64 64 ; 2 uses
  %.not.i.i.i.i421 = icmp eq ptr %i.gw, %i.gn
  br i1 %.not.i.i.i.i421, label %.lr.ph38.i.i.i.i424.preheader, label %.lr.ph.i.i.i.i418, !llvm.loop !5

.lr.ph38.i.i.i.i424.preheader:                    ; preds = %bb.aq, %bb.an
  br label %.lr.ph38.i.i.i.i424

.lr.ph38.i.i.i.i424:                              ; preds = %.lr.ph38.i.i.i.i424.preheader, %.lr.ph38.backedge.i.i.i.i428
  %.137.i.i.i.i426 = phi ptr [ %.pn.i.i429, %.lr.ph38.backedge.i.i.i.i428 ], [ %i.gl, %.lr.ph38.i.i.i.i424.preheader ] ; 3 uses
  %i.gx = load ptr, ptr %.137.i.i.i.i426, align 8, !tbaa !216 ; 4 uses
  %i.gy = icmp ult ptr %i.gx, inttoptr (i64 2 to ptr)
  br i1 %i.gy, label %bb.as, label %bb.ar

bb.ar:                                            ; preds = %.lr.ph38.i.i.i.i424
  %i.gz = getelementptr inbounds nuw i8, ptr %i.gx, i64 12
  %i.ha = load i32, ptr %i.gz, align 4, !tbaa !213
  %i.hb = icmp eq i32 %i.ha, %i.gg
  %i.hc = icmp eq ptr %i.gx, %i.gd
  %or.cond31.i.i.i.i427 = and i1 %i.hc, %i.hb
  br i1 %or.cond31.i.i.i.i427, label %_ZN11sls_tracker9get_valueEP4expr.exit432, label %.lr.ph38.backedge.i.i.i.i428

bb.as:                                            ; preds = %.lr.ph38.i.i.i.i424
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %i.gx) ]
  br label %.lr.ph38.backedge.i.i.i.i428

.lr.ph38.backedge.i.i.i.i428:                     ; preds = %bb.as, %bb.ar
  %.pn.i.i429 = getelementptr inbounds nuw i8, ptr %.137.i.i.i.i426, i64 64
  br label %.lr.ph38.i.i.i.i424, !llvm.loop !6

_ZN11sls_tracker9get_valueEP4expr.exit432:        ; preds = %bb.ao, %bb.ar
  %.026.i.i.i.i431 = phi ptr [ %.137.i.i.i.i426, %bb.ar ], [ %.035.i.i.i.i419, %bb.ao ]
  %i.hd = getelementptr inbounds nuw i8, ptr %.026.i.i.i.i431, i64 16
  %i.he = load i32, ptr %i.hd, align 8, !tbaa !62
  %i.hf = icmp eq i32 %i.he, 0
  %i.hg = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.hh = select i1 %i.hf, ptr %i.hg, ptr %i.ay   ; 3 uses
...
bb.at:                                            ; preds = %_ZN11sls_tracker9get_valueEP4expr.exit432
  %i.hm = load i32, ptr %i.hh, align 8, !tbaa !62
  store i32 %i.hm, ptr %2, align 8, !tbaa !62
  %i.hn = getelementptr inbounds nuw i8, ptr %2, i64 4 ; 2 uses
  %i.ho = load i8, ptr %i.hn, align 4
  %i.hp = and i8 %i.ho, -2
  store i8 %i.hp, ptr %i.hn, align 4
  br label %.critedge

bb.au:                                            ; preds = %_ZN11sls_tracker9get_valueEP4expr.exit432
  %i.hq = load ptr, ptr %i.ax, align 8, !tbaa !196, !nonnull !165, !align !166
  tail call void @_ZN11mpz_managerILb0EE7big_setER3mpzRKS1_(ptr noundef nonnull align 8 dereferenceable(600) %i.hq, ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.hh)
  br label %.critedge

bb.av:                                            ; preds = %_ZNK3app13get_decl_kindEv.exit
  %i.hr = getelementptr inbounds nuw i8, ptr %0, i64 56 ; 2 uses
  %i.hs = getelementptr inbounds nuw i8, ptr %0, i64 60
...
bb.aw:                                            ; preds = %bb.av
  %i.hw = load i32, ptr %i.hr, align 8, !tbaa !62
  store i32 %i.hw, ptr %2, align 8, !tbaa !62
  %i.hx = getelementptr inbounds nuw i8, ptr %2, i64 4 ; 2 uses
  %i.hy = load i8, ptr %i.hx, align 4
  %i.hz = and i8 %i.hy, -2
  store i8 %i.hz, ptr %i.hx, align 4
  br label %_ZN11mpz_managerILb0EE3setER3mpzRKS1_.exit434

bb.ax:                                            ; preds = %bb.av
  %i.ia = load ptr, ptr %i.ax, align 8, !tbaa !196, !nonnull !165, !align !166
  tail call void @_ZN11mpz_managerILb0EE7big_setER3mpzRKS1_(ptr noundef nonnull align 8 dereferenceable(600) %i.ia, ptr noundef nonnull align 8 dereferenceable(16) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.hr)
  br label %_ZN11mpz_managerILb0EE3setER3mpzRKS1_.exit434

_ZN11mpz_managerILb0EE3setER3mpzRKS1_.exit434:    ; preds = %bb.aw, %bb.ax
  %i.ib = getelementptr inbounds nuw i8, ptr %0, i64 24 ; 2 uses
  %i.ic = load ptr, ptr %i.ib, align 8, !tbaa !219, !nonnull !165, !align !166 ; 2 uses
  %i.id = load ptr, ptr %i.aw, align 8, !tbaa !200 ; 3 uses
  %i.ie = getelementptr inbounds nuw i8, ptr %i.ic, i64 120
  %i.if = getelementptr inbounds nuw i8, ptr %i.id, i64 12
  %i.ig = load i32, ptr %i.if, align 4, !tbaa !213 ; 3 uses
  %i.ih = getelementptr inbounds nuw i8, ptr %i.ic, i64 128
  %i.ii = load i32, ptr %i.ih, align 8, !tbaa !122 ; 3 uses
  %i.ij = add i32 %i.ii, -1
  %i.ik = and i32 %i.ij, %i.ig                    ; 2 uses
  %i.il = load ptr, ptr %i.ie, align 8, !tbaa !127 ; 3 uses
  %i.im = zext i32 %i.ii to i64
  %i.in = getelementptr inbounds nuw [64 x i8], ptr %i.il, i64 %i.im
  %.not34.i.i.i.i436 = icmp eq i32 %i.ik, %i.ii
  br i1 %.not34.i.i.i.i436, label %.lr.ph38.i.i.i.i443.preheader, label %.lr.ph.i.i.i.i437.preheader

.lr.ph.i.i.i.i437.preheader:                      ; preds = %_ZN11mpz_managerILb0EE3setER3mpzRKS1_.exit434
  %i.io = zext i32 %i.ik to i64
  %.idx.i.i.i.i435 = shl nuw nsw i64 %i.io, 6
  %i.ip = getelementptr inbounds nuw i8, ptr %i.il, i64 %.idx.i.i.i.i435
  br label %.lr.ph.i.i.i.i437

.lr.ph.i.i.i.i437:                                ; preds = %.lr.ph.i.i.i.i437.preheader, %bb.ba
  %.035.i.i.i.i438 = phi ptr [ %i.iw, %bb.ba ], [ %i.ip, %.lr.ph.i.i.i.i437.preheader ] ; 3 uses
  %i.iq = load ptr, ptr %.035.i.i.i.i438, align 8, !tbaa !216 ; 4 uses
  %i.ir = icmp ult ptr %i.iq, inttoptr (i64 2 to ptr)
  br i1 %i.ir, label %bb.az, label %bb.ay

bb.ay:                                            ; preds = %.lr.ph.i.i.i.i437
  %i.is = getelementptr inbounds nuw i8, ptr %i.iq, i64 12
  %i.it = load i32, ptr %i.is, align 4, !tbaa !213
...
.lr.ph773:                                        ; preds = %_ZN11sls_tracker9get_valueEP4expr.exit451
  ...
  %wide.trip.count886 = zext i32 %i.i to i64
  br label %bb.be
...
bb.br:                                            ; preds = %_ZN11mpz_managerILb0EE3setER3mpzRKS1_.exit472, %.critedge2
  ...
  %indvars.iv870 = phi i64 [ 1, %_ZN11mpz_managerILb0EE3setER3mpzRKS1_.exit472 ], [ %indvars.iv.next871, %.critedge2 ] ; 2 uses
...
bb.bt:                                            ; preds = %.lr.ph769, %_ZN11mpz_managerILb0EE3setER3mpzRKS1_.exit507
  %indvars.iv872 = phi i64 [ %indvars.iv870, %.lr.ph769 ], [ %indvars.iv.next873, %_ZN11mpz_managerILb0EE3setER3mpzRKS1_.exit507 ] ; 2 uses
