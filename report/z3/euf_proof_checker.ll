...
bb.a:
  ...
  %i.a = load ptr, ptr %0, align 8, !tbaa !371    ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr %i.e, ptr %0, align 8, !tbaa !371
  br label %bb.k
...
bb.e:                                             ; preds = %bb.d
  store ptr getelementptr inbounds nuw inrange(-16, 32) (i8, ptr @_ZTV17default_exception, i64 16), ptr %i.m, align 8, !tbaa !39
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 8 ; 2 uses
  %i.o = getelementptr inbounds nuw i8, ptr %i.m, i64 24 ; 3 uses
  store ptr %i.o, ptr %i.n, align 8, !tbaa !364
  %i.p = load ptr, ptr %1, align 8, !tbaa !365    ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.t = load i64, ptr %i.s, align 8, !tbaa !366  ; 3 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.e
  store ptr %i.p, ptr %i.n, align 8, !tbaa !365
  %i.w = load i64, ptr %i.q, align 8, !tbaa !367
  store i64 %i.w, ptr %i.o, align 8, !tbaa !367
  %.phi.trans.insert = getelementptr inbounds nuw i8, ptr %1, i64 8
  %.pre = load i64, ptr %.phi.trans.insert, align 8, !tbaa !366
  br label %_ZN17default_exceptionC2EONSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit
...
_ZN17default_exceptionC2EONSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit: ; preds = %bb.f, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  ...
  store i64 %i.x, ptr %i.z, align 8, !tbaa !366
  store ptr %i.q, ptr %1, align 8, !tbaa !365
  store i64 0, ptr %i.y, align 8, !tbaa !366
  store i8 0, ptr %i.q, align 8, !tbaa !367
...
bb.g:                                             ; preds = %_ZN17default_exceptionC2EONSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit
  %i.aa = landingpad { ptr, i32 }
          cleanup
  %i.ab = load ptr, ptr %1, align 8, !tbaa !365   ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i33: ; preds = %bb.g
  %i.ad = load i64, ptr %i.q, align 8, !tbaa !367
  %i.ae = add i64 %i.ad, 1
...
bb.j:                                             ; preds = %bb.c
  ...
  %i.aj = load ptr, ptr %0, align 8, !tbaa !371   ; 6 uses
...
_ZNK6vectorISt4pairIP4exprS2_ELb0EjE4sizeEv.exit: ; preds = %bb.j
  ...
  store i32 %i.am, ptr %i.an, align 4, !tbaa !35
...
.lr.ph.i.i.i.i.i.i.prol:                          ; preds = %.lr.ph.i.i.i.i.i.i.preheader, %.lr.ph.i.i.i.i.i.i.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.i.i.i.prol, !llvm.loop !547
...
.lr.ph.i.i.i.i.i.i:                               ; preds = %.lr.ph.i.i.i.i.i.i.prol.loopexit, %.lr.ph.i.i.i.i.i.i
  ...
  br i1 %i.bg, label %.loopexit, label %.lr.ph.i.i.i.i.i.i, !llvm.loop !548
...
_ZN6vectorISt4pairIP4exprS2_ELb0EjE7destroyEv.exit: ; preds = %_ZSt20uninitialized_move_nIPSt4pairIP4exprS2_EjS4_ES0_IT_T1_ES5_T0_S6_.exit, %.loopexit
  ...
  store ptr %i.bk, ptr %0, align 8, !tbaa !371
  store i32 %i.j, ptr %i.ai, align 4, !tbaa !35
  br label %bb.k
...
bb.a:
  %.sroa.026 = alloca i64, align 8                ; 6 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 72 ; 5 uses
  %i.b = load i32, ptr %1, align 4, !tbaa !111    ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.026)
  store i32 0, ptr %.sroa.026, align 8, !tbaa !552
  %.4..4..4..sroa_idx = getelementptr inbounds nuw i8, ptr %.sroa.026, i64 4
  store i32 0, ptr %.4..4..4..sroa_idx, align 4, !tbaa !553
  %i.c = load ptr, ptr %i.a, align 8, !tbaa !356  ; 3 uses
...
_ZNK6vectorISt4pairIjjELb0EjE3getEjRKS1_.exit:    ; preds = %bb.a, %_ZNK6vectorISt4pairIjjELb0EjE4sizeEv.exit.i, %bb.b
  %.0.i = phi ptr [ %i.h, %bb.b ], [ %.sroa.026, %_ZNK6vectorISt4pairIjjELb0EjE4sizeEv.exit.i ], [ %.sroa.026, %bb.a ]
  ...
  %i.k = load i32, ptr %i.j, align 8, !tbaa !376
...
bb.c:                                             ; preds = %_ZNK6vectorISt4pairIjjELb0EjE3getEjRKS1_.exit
  ...
  %i.n = load i32, ptr %1, align 4, !tbaa !111    ; 4 uses
  %i.o = load i32, ptr %i.j, align 8, !tbaa !35
  %i.p = load ptr, ptr %i.a, align 8, !tbaa !356  ; 5 uses
...
_ZNK6vectorISt4pairIjjELb0EjE4sizeEv.exit.i6:     ; preds = %bb.c
  ...
  %i.s = load i32, ptr %i.r, align 4, !tbaa !35   ; 3 uses
...
thread-pre-split.i.i.preheader:                   ; preds = %_ZNK6vectorISt4pairIjjELb0EjE4sizeEv.exit.i.i, %_ZNK6vectorISt4pairIjjELb0EjE4sizeEv.exit.thread.i.i
  ...
  %.ph47.a = phi i32 [ %i.u, %_ZNK6vectorISt4pairIjjELb0EjE4sizeEv.exit.thread.i.i ], [ %i.t, %_ZNK6vectorISt4pairIjjELb0EjE4sizeEv.exit.i.i ] ; 4 uses
...
bb.d:                                             ; preds = %_ZNK6vectorISt4pairIjjELb0EjE4sizeEv.exit.thread.i.i
  store i32 %i.u, ptr %i.r, align 4, !tbaa !35
...
_ZNK6vectorISt4pairIjjELb0EjE8capacityEv.exit.thread.i.i: ; preds = %_ZNK6vectorISt4pairIjjELb0EjE8capacityEv.exit.i.i, %thread-pre-split.i.i
  ...
  %.pr.pre.i.i = load ptr, ptr %i.a, align 8, !tbaa !356
  br label %thread-pre-split.i.i, !llvm.loop !549

bb.e:                                             ; preds = %_ZNK6vectorISt4pairIjjELb0EjE8capacityEv.exit.i.i
  %i.aa = getelementptr inbounds i8, ptr %i.v, i64 -4
  store i32 %.ph47.a, ptr %i.aa, align 4, !tbaa !35
  %.not1319.i.i = icmp eq i32 %.0.i17.i.i.ph, %.ph47.a
...
.lr.ph.preheader.i.i:                             ; preds = %bb.e
  ...
  %.pre.i = load ptr, ptr %i.a, align 8, !tbaa !356
  br label %_ZN6vectorISt4pairIjjELb0EjE4setxEjRKS1_S4_.exit
...
_ZN6vectorISt4pairIjjELb0EjE4setxEjRKS1_S4_.exit: ; preds = %_ZNK6vectorISt4pairIjjELb0EjE4sizeEv.exit.i6, %bb.d, %bb.e, %.lr.ph.preheader.i.i
  ...
  store i32 %i.o, ptr %i.ai, align 4, !tbaa !552
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 4
  store i32 %i.m, ptr %i.aj, align 4, !tbaa !553
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 80 ; 3 uses
  %i.al = load ptr, ptr %i.ak, align 8, !tbaa !97 ; 5 uses
...
_ZNK6vectorIP4exprLb0EjE4sizeEv.exit.i:           ; preds = %_ZN6vectorISt4pairIjjELb0EjE4setxEjRKS1_S4_.exit
  ...
  %i.ao = load i32, ptr %i.an, align 4, !tbaa !35 ; 3 uses
...
bb.f:                                             ; preds = %_ZNK6vectorIP4exprLb0EjE4sizeEv.exit.thread.i.i
  store i32 %i.aq, ptr %i.an, align 4, !tbaa !35
...
_ZNK6vectorIP4exprLb0EjE8capacityEv.exit.thread.i.i: ; preds = %_ZNK6vectorIP4exprLb0EjE8capacityEv.exit.i.i, %thread-pre-split.i.i10
  ...
  %.pr.pre.i.i19 = load ptr, ptr %i.ak, align 8, !tbaa !97
  br label %thread-pre-split.i.i10, !llvm.loop !550

bb.g:                                             ; preds = %_ZNK6vectorIP4exprLb0EjE8capacityEv.exit.i.i
  %i.aw = getelementptr inbounds i8, ptr %i.ar, i64 -4
  store i32 %.ph45, ptr %i.aw, align 4, !tbaa !35
...
.lr.ph.preheader.i.i15:                           ; preds = %bb.g
  ...
  tail call void @llvm.memset.p0.i64(ptr align 8 %i.az, i8 0, i64 %i.bb, i1 false), !tbaa !98
  br label %_ZN6vectorIP4exprLb0EjE4setxEjRKS1_S4_.exit
...
_ZN6vectorIP4exprLb0EjE4setxEjRKS1_S4_.exit:      ; preds = %.lr.ph.preheader.i.i15, %_ZNK6vectorIP4exprLb0EjE4sizeEv.exit.i, %bb.f, %bb.g
  ...
  store ptr %1, ptr %i.be, align 8, !tbaa !98
  br label %bb.h
...
bb.a:
  ...
  store i32 1, ptr %i.f, align 8, !tbaa !78
