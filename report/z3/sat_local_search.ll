...
bb.i:                                             ; preds = %bb.i, %.lr.ph.new
  ...
  %i.ch = zext nneg i32 %.074153 to i64
  ...
  %8 = zext nneg i32 %.074153 to i64
  %9 = getelementptr inbounds nuw i8, ptr %i.cb, i64 %8
  %i.cn = getelementptr inbounds nuw i8, ptr %9, i64 1
  ...
  %10 = zext nneg i32 %.074153 to i64
  %11 = getelementptr inbounds nuw i8, ptr %i.cb, i64 %10
  %i.cs = getelementptr inbounds nuw i8, ptr %11, i64 2
  ...
  %i.cx = add nuw nsw i32 %.074153, 4             ; 2 uses
  %i.cy = zext nneg i32 %.074153 to i64
  %12 = getelementptr inbounds nuw i8, ptr %i.cb, i64 %i.cy
  %i.cz = getelementptr inbounds nuw i8, ptr %12, i64 3
