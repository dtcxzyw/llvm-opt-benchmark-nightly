...
.lr.ph623.preheader:                              ; preds = %bb.fb
  ...
  %.pre680 = load ptr, ptr %19, align 8, !tbaa !110
  %i.aeg = add i32 %i.zj, -2
  br label %.lr.ph623

.lr.ph623:                                        ; preds = %.lr.ph623.preheader, %bb.fg
  %i.aeh = phi ptr [ %i.aei, %bb.fg ], [ %.pre679, %.lr.ph623.preheader ]
  %.050622 = phi i32 [ %i.aer, %bb.fg ], [ 0, %.lr.ph623.preheader ] ; 2 uses
  %i.aei = invoke noundef ptr @_ZN10polynomial7manager3imp9exact_divEPKNS_10polynomialES4_(ptr noundef nonnull align 8 dereferenceable(824) %0, ptr noundef %i.aeh, ptr noundef %.pre680)
...
.lr.ph625.preheader:                              ; preds = %bb.gq
  %.pre681 = load ptr, ptr %20, align 8, !tbaa !110
...
.lr.ph625:                                        ; preds = %.lr.ph625.preheader, %bb.gw
  %i.ams = phi ptr [ %i.amt, %bb.gw ], [ %.pre681, %.lr.ph625.preheader ]
