Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/z3/original/qfaufbv_tactic?download=true
inline.NumInlined: 636
inline.NumDeleted: 341
loop-unroll.NumCompletelyUnrolled: 3
loop-unroll.NumRuntimeUnrolled: 6
loop-unroll.NumUnrolled: 9
begin_hunk_0_@_ZN6vectorIjLb0EjE13expand_vectorEv:bb.a
...
bb.k:                                             ; preds = %bb.d
  ...
  store ptr %i.ak, ptr %0, align 8, !tbaa !141
  store i32 %i.j, ptr %i.aj, align 4, !tbaa !142
  br label %bb.l
...
bb.f:                                             ; preds = %bb.e
  store ptr getelementptr inbounds nuw inrange(-16, 32) (i8, ptr @_ZTV17default_exception, i64 16), ptr %i.o, align 8, !tbaa !12
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 8 ; 2 uses
  %i.q = getelementptr inbounds nuw i8, ptr %i.o, i64 24 ; 3 uses
  store ptr %i.q, ptr %i.p, align 8, !tbaa !180
  %i.r = load ptr, ptr %1, align 8, !tbaa !172    ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.v = load i64, ptr %i.u, align 8, !tbaa !173  ; 3 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.f
  ...
  %i.y = load i64, ptr %i.s, align 8, !tbaa !171
  store i64 %i.y, ptr %i.q, align 8, !tbaa !171
...
_ZN17default_exceptionC2EONSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE.exit: ; preds = %bb.g, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  ...
  store i64 %i.z, ptr %i.ab, align 8, !tbaa !173
  store ptr %i.s, ptr %1, align 8, !tbaa !172
  store i64 0, ptr %i.aa, align 8, !tbaa !173
  store i8 0, ptr %i.s, align 8, !tbaa !171
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i29: ; preds = %bb.h
  %i.af = load i64, ptr %i.s, align 8, !tbaa !171
  %i.ag = add i64 %i.af, 1
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 8, !tbaa !262
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !265, !nonnull !136, !align !266
  store i32 %i.b, ptr %i.d, align 4, !tbaa !142
  ret void
}
...
bb.a:
  ...
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !267, !nonnull !136, !align !137 ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 88
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !226  ; 3 uses
...
_ZNK15ref_vector_coreI9func_decl19ref_manager_wrapperIS0_11ast_managerEE4sizeEv.exit: ; preds = %bb.a
  ...
  %i.g = load i32, ptr %i.f, align 4, !tbaa !142  ; 2 uses
...
._crit_edge:                                      ; preds = %.lr.ph
  ...
  %.pre5 = load ptr, ptr %.phi.trans.insert, align 8, !tbaa !226 ; 2 uses
...
_ZN6vectorIP9func_declLb0EjE3endEv.exit.i:        ; preds = %_ZNK15ref_vector_coreI9func_decl19ref_manager_wrapperIS0_11ast_managerEE4sizeEv.exit, %._crit_edge
  ...
  %i.p = load i32, ptr %i.o, align 4, !tbaa !142  ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %_ZN15ref_vector_coreI9func_decl19ref_manager_wrapperIS0_11ast_managerEE7dec_refEPS0_.exit.i.i
  ...
  %i.v = load ptr, ptr %.06.i.i, align 8, !tbaa !227 ; 3 uses
  %i.w = load ptr, ptr %i.m, align 8, !tbaa !229, !nonnull !136, !align !137
...
bb.b:                                             ; preds = %.lr.ph.i.i
  ...
  %i.y = load i32, ptr %i.x, align 4, !tbaa !114
  %i.z = add i32 %i.y, -1                         ; 2 uses
  store i32 %i.z, ptr %i.x, align 4, !tbaa !114
...
_ZN15ref_vector_coreI9func_decl19ref_manager_wrapperIS0_11ast_managerEE7dec_refEPS0_.exit.i.i: ; preds = %bb.c, %bb.b, %.lr.ph.i.i
  ...
  br i1 %i.ac, label %.lr.ph.i.i, label %_ZN15ref_vector_coreI9func_decl19ref_manager_wrapperIS0_11ast_managerEE13dec_range_refEPKPS0_S7_.exit.i, !llvm.loop !230

_ZN15ref_vector_coreI9func_decl19ref_manager_wrapperIS0_11ast_managerEE13dec_range_refEPKPS0_S7_.exit.i: ; preds = %_ZN15ref_vector_coreI9func_decl19ref_manager_wrapperIS0_11ast_managerEE7dec_refEPS0_.exit.i.i
  %.pre.i = load ptr, ptr %i.n, align 8, !tbaa !226 ; 2 uses
...
_ZN15ref_vector_coreI9func_decl19ref_manager_wrapperIS0_11ast_managerEE13dec_range_refEPKPS0_S7_.exit.thread7.i: ; preds = %_ZN15ref_vector_coreI9func_decl19ref_manager_wrapperIS0_11ast_managerEE13dec_range_refEPKPS0_S7_.exit.i, %_ZN6vectorIP9func_declLb0EjE3endEv.exit.i
  ...
  store i32 %.lcssa15, ptr %i.ae, align 4, !tbaa !142
...
declare void @_ZN8ast_mark4markEP3astb(ptr noundef nonnull align 8 dereferenceable(56), ptr noundef, i1 noundef zeroext) unnamed_addr #2
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !199, !nonnull !136, !align !137
  ...
  %i.j = load ptr, ptr %i.a, align 8, !tbaa !140  ; 5 uses
...
bb.d:                                             ; preds = %bb.c
  %i.l = load ptr, ptr %i.j, align 8, !tbaa !12
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dead_on_return(32) dereferenceable(32) %i.j) #20, !inline_history !198
...
_Z7deallocI25dependent_expr_simplifierEvPT_.exit.i: ; preds = %bb.d, %bb.c
  store ptr %i.i, ptr %i.a, align 8, !tbaa !140
...
_ZNK15ref_vector_coreI4expr19ref_manager_wrapperIS0_11ast_managerEE3endEv.exit: ; preds = %_ZN10scoped_ptrI25dependent_expr_simplifierEaSEPS0_.exit
  ...
  %i.s = load i32, ptr %i.r, align 4, !tbaa !142  ; 2 uses
...
.lr.ph:                                           ; preds = %_ZNK15ref_vector_coreI4expr19ref_manager_wrapperIS0_11ast_managerEE3endEv.exit, %.lr.ph
  ...
  %i.w = load ptr, ptr %.012, align 8, !tbaa !152
...
bb.e:                                             ; preds = %.loopexit
  ...
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !199, !nonnull !136, !align !137 ; 2 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 184
  store ptr %i.ac, ptr %i.aa, align 8, !tbaa !48
  ...
  store ptr null, ptr %i.af, align 8, !tbaa !236
  %i.ag = getelementptr inbounds nuw i8, ptr %i.aa, i64 24
  %i.ah = ptrtoint ptr %i.ac to i64
  store i64 %i.ah, ptr %i.ag, align 8, !tbaa !48
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 32) (i8, ptr @_ZTV8ast_mark, i64 16), ptr %i.aj, align 8, !tbaa !12
  ...
  %i.am = load ptr, ptr %i.y, align 8, !tbaa !149 ; 4 uses
...
bb.g:                                             ; preds = %bb.f
  tail call void @_ZN26model_reconstruction_trailD2Ev(ptr noundef nonnull align 8 dead_on_return(97) dereferenceable(97) %i.am) #20
...
; Function Attrs: inlinehint mustprogress nounwind uwtable
define linkonce_odr hidden void @_ZN16tactic_exceptionD2Ev(ptr noundef nonnull align 8 dead_on_return(40) dereferenceable(40) %0) unnamed_addr #9 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  store ptr getelementptr inbounds nuw inrange(-16, 32) (i8, ptr @_ZTV16tactic_exception, i64 16), ptr %0, align 8, !tbaa !12
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.a
  %i.e = load i64, ptr %i.c, align 8, !tbaa !171
  %i.f = add i64 %i.e, 1
...
declare void @_ZN26model_reconstruction_trail19get_model_converterEv(ptr dead_on_unwind writable sret(%class.ref.47) align 8, ptr noundef nonnull align 8 dereferenceable(97)) local_unnamed_addr #2

; Function Attrs: mustprogress nounwind uwtable
define linkonce_odr hidden void @_ZN3refI15model_converterED2Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %0) unnamed_addr #6 comdat align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !181    ; 5 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.g(ptr noundef nonnull align 8 dead_on_return(12) dereferenceable(12) %i.a) #20, !inline_history !274
...
declare void @_ZN13tactic_reportD1Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8)) unnamed_addr #4

; Function Attrs: nounwind
declare void @_ZN17statistics_reportD1Ev(ptr noundef nonnull align 8 dead_on_return(40) dereferenceable(40)) unnamed_addr #4
