...
begin_hunk_0_@_ZN12_GLOBAL__N_111tptp_parser4nextEv:bb.a
  %i.mj = load i64, ptr %i.mh, align 8, !tbaa !141, !noalias !1232
  %i.mk = add i64 %i.mj, 1
  call void @_ZdlPvm(ptr noundef %i.mg, i64 noundef %i.mk) #30
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #29, !noalias !1232
...
bb.dj:                                            ; preds = %bb.di, %bb.de
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #29, !noalias !1232
...
.critedge45.sink.split.i:                         ; preds = %bb.cd, %_ZNK12_GLOBAL__N_15lexer4peekEj.exit160.i, %bb.cb, %bb.ca, %bb.bz, %bb.by, %bb.bx, %bb.bw, %bb.bv, %bb.bu, %_ZNK12_GLOBAL__N_15lexer4peekEj.exit158.i, %bb.bt, %bb.bs, %_ZNK12_GLOBAL__N_15lexer4peekEj.exit156.i, %bb.br, %bb.bq, %bb.bp, %bb.bo, %bb.bn, %bb.bm, %bb.bl, %bb.bk, %bb.bj, %bb.bi, %_ZN12_GLOBAL__N_15lexer3getEv.exit155.i
  ...
  store i32 %.sink326.i, ptr %5, align 8, !tbaa !161, !alias.scope !1232
...
.loopexit.split-lp.i:                             ; preds = %.loopexit.split-lp.loopexit.i.loopexit, %.loopexit.split-lp.loopexit.i.loopexit.split-lp, %.loopexit.i.loopexit, %.loopexit.i.loopexit.split-lp, %.loopexit, %.loopexit.split-lp, %bb.dj, %.loopexit.split-lp.loopexit.split-lp.i, %bb.ar, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i128.i, %bb.n
  ...
  %i.ml = load ptr, ptr %i.bg, align 8, !tbaa !225, !alias.scope !1232 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i177.i: ; preds = %.loopexit.split-lp.i
  %i.mn = load i64, ptr %i.bh, align 8, !tbaa !141, !alias.scope !1232
  %i.mo = add i64 %i.mn, 1
...
.critedge2:                                       ; preds = %.lr.ph
  ...
  br i1 %exitcond.not, label %.critedge, label %.lr.ph, !llvm.loop !1233
...
bb.e:                                             ; preds = %._crit_edge.i.i.i
  %i.w = load i8, ptr %i.e, align 1, !tbaa !141
  store i8 %i.w, ptr %i.v, align 1, !tbaa !141
...
bb.a:
  %.val3 = load ptr, ptr %0, align 8, !tbaa !359  ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  store i8 0, ptr %i.b, align 1, !tbaa !360
  br label %bb.d

bb.c:                                             ; preds = %bb.a
  %i.c = getelementptr inbounds nuw i8, ptr %1, i64 65
  store i8 1, ptr %i.c, align 1, !tbaa !360
  %i.d = getelementptr inbounds nuw i8, ptr %1, i64 936
  %i.e = load i8, ptr %i.d, align 8, !tbaa !1237, !range !242, !noundef !132
  br label %bb.d

bb.d:                                             ; preds = %bb.b, %bb.c
  %i.f = phi i8 [ 0, %bb.b ], [ %i.e, %bb.c ]
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 66
  store i8 %i.f, ptr %i.g, align 2, !tbaa !361
  ...
  %i.j = load ptr, ptr %i.h, align 8, !tbaa !225  ; 2 uses
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 904
  %i.l = load i64, ptr %i.k, align 8, !tbaa !140  ; 8 uses
  %i.m = icmp ugt i64 %i.l, 15
  br i1 %i.m, label %bb.e, label %._crit_edge.i.i

bb.e:                                             ; preds = %bb.d
  %i.n = icmp slt i64 %i.l, 0
  br i1 %i.n, label %.noexc.i, label %bb.f
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %i.p, label %.noexc6.i, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i, !prof !227
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i: ; preds = %bb.f
  %i.q = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.o) #32 ; 2 uses
  store ptr %i.q, ptr %0, align 8, !tbaa !225
  store i64 %i.l, ptr %i.i, align 8, !tbaa !141
  br label %._crit_edge.i.i

._crit_edge.i.i:                                  ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i, %bb.d
  %i.r = phi ptr [ %i.q, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm.exit.i.i ], [ %i.i, %bb.d ] ; 3 uses
...
bb.g:                                             ; preds = %._crit_edge.i.i
  %i.s = load i8, ptr %i.j, align 1, !tbaa !141
  store i8 %i.s, ptr %i.r, align 1, !tbaa !141
