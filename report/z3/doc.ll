...
.lr.ph:                                           ; preds = %.lr.ph.backedge, %.lr.ph.lr.ph
  %.02357 = phi i32 [ 0, %.lr.ph.lr.ph ], [ %.02357.be, %.lr.ph.backedge ] ; 4 uses
  %i.f = load ptr, ptr %i.a, align 8, !tbaa !26
  %i.g = zext i32 %.02357 to i64                  ; 2 uses
...
.lr.ph.i.outer:                                   ; preds = %bb.b, %.thread.i
  %.030.ph = phi i32 [ %.131, %.thread.i ], [ undef, %bb.b ] ; 2 uses
  %.01944.i.ph = phi i32 [ %i.bn, %.thread.i ], [ 0, %bb.b ] ; 6 uses
  %.02043.i.ph = phi i32 [ %.237.i, %.thread.i ], [ 0, %bb.b ] ; 2 uses
...
.thread.i:                                        ; preds = %bb.f, %.lr.ph.i, %bb.d, %.lr.ph.i.outer
  %.01944.i.lcssa = phi i32 [ %.01944.i.ph, %.lr.ph.i.outer ], [ %.01944.i.ph, %bb.d ], [ %.01944.i, %.lr.ph.i ], [ %.01944.i, %bb.f ]
  %.131 = phi i32 [ %.030.ph, %.lr.ph.i.outer ], [ %.01944.i.ph, %bb.d ], [ %.01944.i, %bb.f ], [ %.030.ph, %.lr.ph.i ] ; 3 uses
  %.237.i = phi i32 [ %.02043.i.ph, %.lr.ph.i.outer ], [ 1, %bb.d ], [ 1, %bb.f ], [ 0, %.lr.ph.i ] ; 2 uses
...
_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread38: ; preds = %bb.e, %bb.g
  tail call void @_ZN10union_bvecI11tbv_manager3tbvE5eraseERS0_j(ptr noundef nonnull align 8 dereferenceable(80) %i.a, ptr noundef nonnull align 8 dereferenceable(552) %0, i32 noundef %.02357)
...
_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread: ; preds = %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread.loopexit, %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread38
  %.2 = phi i32 [ %.02357, %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread38 ], [ %i.bp, %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread.loopexit ] ; 2 uses
...
.lr.ph:                                           ; preds = %bb.a, %.thread
  ...
  %.02043 = phi i32 [ %.237, %.thread ], [ 0, %bb.a ] ; 2 uses
...
.thread:                                          ; preds = %.lr.ph, %bb.d, %bb.e
  %.237 = phi i32 [ 0, %bb.e ], [ %.02043, %.lr.ph ], [ 1, %bb.d ] ; 2 uses
