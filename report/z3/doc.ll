Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/z3/original/doc?download=true
...
bb.a:
  ...
  br i1 %i.d, label %.thread46, label %.lr.ph.lr.ph
...
.lr.ph:                                           ; preds = %.lr.ph.backedge, %.lr.ph.lr.ph
  %.02565 = phi i32 [ 0, %.lr.ph.lr.ph ], [ %.02357.be, %.lr.ph.backedge ] ; 4 uses
  %.02357 = phi i32 [ undef, %.lr.ph.lr.ph ], [ %.164.be, %.lr.ph.backedge ]
  ...
  br i1 %i.k, label %.thread46, label %bb.b
...
bb.b:                                             ; preds = %.lr.ph
  ...
  br i1 %.not2942.not.i, label %.thread46, label %.lr.ph.i.outer

.lr.ph.i.outer:                                   ; preds = %bb.b, %.thread.i
  %.030.ph = phi i32 [ %.131, %.thread.i ], [ %.02357, %bb.b ] ; 3 uses
  %.01944.i.ph = phi i32 [ %.237.i, %.thread.i ], [ 0, %bb.b ] ; 2 uses
  %.02043.i.ph = phi i32 [ %i.bn, %.thread.i ], [ 0, %bb.b ] ; 6 uses
  %i.r = shl nuw i32 %.02043.i.ph, 1
  %i.s = lshr i32 %.02043.i.ph, 4
...
.thread.i.thread.peel:                            ; preds = %bb.e
  %i.ap = add nuw nsw i32 %.02043.i.ph, 1         ; 2 uses
  %exitcond.not.i74.peel = icmp eq i32 %i.ap, %i.q
  br i1 %exitcond.not.i74.peel, label %.thread46, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.thread.i.thread.peel, %.thread.i.thread
  %.01944.i = phi i32 [ %i.bo, %.thread.i.thread ], [ %i.ap, %.thread.i.thread.peel ] ; 6 uses
  %i.aq = shl nuw i32 %.01944.i, 1
  %i.ar = lshr i32 %.01944.i, 4
...
.thread.i:                                        ; preds = %bb.f, %.lr.ph.i, %bb.d, %.lr.ph.i.outer
  %.01944.i.lcssa = phi i32 [ %.02043.i.ph, %.lr.ph.i.outer ], [ %.02043.i.ph, %bb.d ], [ %.01944.i, %.lr.ph.i ], [ %.01944.i, %bb.f ]
  %.131 = phi i32 [ %.030.ph, %.lr.ph.i.outer ], [ %.02043.i.ph, %bb.d ], [ %.01944.i, %bb.f ], [ %.030.ph, %.lr.ph.i ] ; 4 uses
  %.237.i = phi i32 [ %.01944.i.ph, %.lr.ph.i.outer ], [ 1, %bb.d ], [ 1, %bb.f ], [ 0, %.lr.ph.i ] ; 2 uses
  %i.bn = add nuw nsw i32 %.01944.i.lcssa, 1      ; 2 uses
...
.thread.i.thread:                                 ; preds = %bb.g
  %i.bo = add nuw nsw i32 %.01944.i, 1            ; 2 uses
  %exitcond.not.i74 = icmp eq i32 %i.bo, %i.q
  br i1 %exitcond.not.i74, label %.thread46, label %.lr.ph.i, !llvm.loop !71

_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit:   ; preds = %.thread.i
  %cond.not.not = icmp eq i32 %.237.i, 0
  br i1 %cond.not.not, label %.thread46, label %bb.h
...
_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread: ; preds = %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread.loopexit, %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread38
  %.2 = phi i32 [ %.02565, %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread38 ], [ %i.bp, %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread.loopexit ] ; 2 uses
  %i.bq = load i32, ptr %i.b, align 8, !tbaa !27
  %.not = icmp ult i32 %.2, %i.bq
  br i1 %.not, label %.lr.ph.backedge, label %.thread46

.lr.ph.backedge:                                  ; preds = %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread, %bb.h
  %.02357.be = phi i32 [ %.2, %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread ], [ 0, %bb.h ]
  %.164.be = phi i32 [ %.030.ph, %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread ], [ %.131, %bb.h ]
  br label %.lr.ph, !llvm.loop !73

bb.h:                                             ; preds = %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit
  %i.br = shl i32 %.131, 1                        ; 2 uses
  ...
  %i.cf = xor i32 %i.ce, 3
  tail call void @_ZN11tbv_manager3setER3tbvj4tbit(ptr noundef nonnull align 8 dereferenceable(552) %0, ptr noundef nonnull align 4 dereferenceable(4) %i.l, i32 noundef %.131, i32 noundef %i.cf)
  ...
  br i1 %i.ci, label %.thread46, label %.lr.ph.backedge

.thread46:                                        ; preds = %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit, %bb.h, %_ZN11doc_manager11diff_by_012ERK3tbvS2_Rj.exit.thread, %.lr.ph, %bb.b, %.thread.i.thread, %.thread.i.thread.peel, %bb.a
...
.lr.ph:                                           ; preds = %bb.a, %.thread
  %.01944 = phi i32 [ %.237, %.thread ], [ 0, %bb.a ] ; 2 uses
  %.02043 = phi i32 [ %i.ab, %.thread ], [ 0, %bb.a ] ; 4 uses
  %i.d = shl nuw i32 %.02043, 1
  %i.e = lshr i32 %.02043, 4
...
bb.d:                                             ; preds = %bb.c
  store i32 %.02043, ptr %3, align 4, !tbaa !69
  br label %.thread
...
.thread:                                          ; preds = %.lr.ph, %bb.d, %bb.e
  %.237 = phi i32 [ 0, %bb.e ], [ %.01944, %.lr.ph ], [ 1, %bb.d ] ; 2 uses
  %i.ab = add nuw nsw i32 %.02043, 1              ; 2 uses
...
.thread38:                                        ; preds = %bb.e, %.thread, %bb.b, %bb.a
  %spec.select = phi i32 [ 0, %bb.a ], [ %.237, %.thread ], [ 2, %bb.b ], [ 3, %bb.e ]
  ret i32 %spec.select
}
