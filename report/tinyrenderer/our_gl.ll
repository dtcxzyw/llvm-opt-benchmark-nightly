...
bb.a:
  ...
  %i.h = load <2 x double>, ptr %1, align 8, !tbaa !16, !noalias !26 ; 2 uses
  ...
  %i.p = fdiv <2 x double> %i.i, %i.o             ; 13 uses
  %i.q = extractelement <2 x double> %i.p, i64 0
  %3 = shufflevector <2 x double> %i.h, <2 x double> poison, <3 x i32> <i32 0, i32 1, i32 poison>
  %4 = insertelement <3 x double> %3, double %i.d, i64 2
  %5 = fneg <3 x double> %4                       ; 5 uses
  %6 = shufflevector <3 x double> %5, <3 x double> poison, <2 x i32> <i32 2, i32 poison>
  %i.r = insertelement <2 x double> %6, double 0.000000e+00, i64 1 ; 2 uses
  %7 = shufflevector <3 x double> <double poison, double 0.000000e+00, double poison>, <3 x double> %5, <2 x i32> <i32 4, i32 1> ; 2 uses
  %i.s = shufflevector <3 x double> %5, <3 x double> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.t = insertelement <2 x double> %i.s, double 1.000000e+00, i64 1 ; 2 uses
  %8 = shufflevector <3 x double> %5, <3 x double> poison, <2 x i32> <i32 2, i32 2>
  %9 = insertelement <2 x double> %i.p, double 0.000000e+00, i64 0
  %10 = shufflevector <3 x double> %5, <3 x double> poison, <2 x i32> <i32 1, i32 1>
  %11 = shufflevector <2 x double> %i.p, <2 x double> <double 0.000000e+00, double poison>, <2 x i32> <i32 2, i32 0>
  %i.u = load double, ptr %i.c, align 8, !tbaa !27, !noalias !28
  %i.v = load <2 x double>, ptr %i.b, align 8, !tbaa !16, !noalias !28
  %i.w = load <2 x double>, ptr %2, align 8, !tbaa !16, !noalias !28 ; 2 uses
  %i.x = fneg <2 x double> %i.p
  %i.y = fmul <2 x double> %i.v, %i.x
  %i.z = extractelement <2 x double> %i.w, i64 0
  %i.aa = shufflevector <2 x double> %i.p, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.ab = shufflevector <2 x double> %i.p, <2 x double> poison, <2 x i32> zeroinitializer
  %i.ac = fdiv double %i.e, %sqrt.i.i             ; 7 uses
  %i.ad = fneg double %i.ac
  %i.ae = fmul double %i.z, %i.ad
  %i.af = insertelement <2 x double> %i.aa, double %i.ac, i64 1
  %i.ag = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.w, <2 x double> %i.af, <2 x double> %i.y) ; 3 uses
  %i.ah = tail call double @llvm.fmuladd.f64(double %i.u, double %i.q, double %i.ae) ; 3 uses
  %i.ai = extractelement <2 x double> %i.ag, i64 0 ; 2 uses
  %i.aj = tail call double @llvm.fmuladd.f64(double %i.ai, double %i.ai, double 0.000000e+00)
  %i.ak = tail call double @llvm.fmuladd.f64(double %i.ah, double %i.ah, double %i.aj)
  %i.al = extractelement <2 x double> %i.ag, i64 1 ; 2 uses
  %i.am = tail call noundef double @llvm.fmuladd.f64(double %i.al, double %i.al, double %i.ak)
  %sqrt.i.i1 = tail call noundef double @llvm.sqrt.f64(double %i.am) ; 2 uses
  %i.an = insertelement <2 x double> <double 0.000000e+00, double poison>, double %i.ac, i64 1
  %i.ao = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.an, <2 x double> %8, <2 x double> <double 1.000000e+00, double 0.000000e+00>)
  %i.ap = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %9, <2 x double> %10, <2 x double> %i.ao)
  %i.aq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %11, <2 x double> %i.s, <2 x double> %i.ap) ; 2 uses
  %i.ar = fdiv double %i.ah, %sqrt.i.i1           ; 6 uses
  %i.as = insertelement <2 x double> poison, double %sqrt.i.i1, i64 0
  %i.at = shufflevector <2 x double> %i.as, <2 x double> poison, <2 x i32> zeroinitializer
  %i.au = fdiv <2 x double> %i.ag, %i.at          ; 8 uses
  %i.av = extractelement <2 x double> %i.au, i64 0 ; 2 uses
  %i.aw = fneg double %i.ar
  %i.ax = extractelement <2 x double> %i.au, i64 1
  %i.ay = fneg <2 x double> %i.au
  %i.az = fmul <2 x double> %i.p, %i.ay
  %i.ba = shufflevector <2 x double> %i.au, <2 x double> %i.p, <2 x i32> <i32 1, i32 2>
  %i.bb = insertelement <2 x double> poison, double %i.ac, i64 0
  %i.bc = insertelement <2 x double> %i.bb, double %i.ar, i64 1
  %i.bd = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ba, <2 x double> %i.bc, <2 x double> %i.az) ; 3 uses
  %i.be = extractelement <2 x double> %i.bd, i64 1 ; 2 uses
  %i.bf = extractelement <2 x double> %i.bd, i64 0 ; 2 uses
  %i.bg = extractelement <2 x double> %i.p, i64 1
  %i.bh = fadd double %i.ac, 0.000000e+00
  %i.bi = fmul double %i.ac, %i.aw
  %i.bj = tail call double @llvm.fmuladd.f64(double %i.bg, double %i.av, double %i.bi) ; 2 uses
  %i.bk = tail call double @llvm.fmuladd.f64(double %i.be, double %i.be, double 0.000000e+00)
  %i.bl = tail call double @llvm.fmuladd.f64(double %i.bf, double %i.bf, double %i.bk)
  %i.bm = insertelement <2 x double> %i.p, double %i.bj, i64 0 ; 2 uses
  %i.bn = insertelement <2 x double> %i.bm, double 0.000000e+00, i64 1
  %i.bo = insertelement <2 x double> poison, double %i.bl, i64 0
  %i.bp = insertelement <2 x double> %i.bo, double %i.bh, i64 1
  %i.bq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bm, <2 x double> %i.bn, <2 x double> %i.bp) ; 2 uses
  %i.br = extractelement <2 x double> %i.bq, i64 0
  %sqrt.i.i2 = tail call noundef double @llvm.sqrt.f64(double %i.br) ; 2 uses
  %i.bs = insertelement <2 x double> poison, double %sqrt.i.i2, i64 0
  %i.bt = shufflevector <2 x double> %i.bs, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bu = fdiv <2 x double> %i.bd, %i.bt          ; 7 uses
  %i.bv = shufflevector <2 x double> %i.bu, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.bw = insertelement <2 x double> %i.bv, double %i.ac, i64 1
  %i.bx = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bw, <2 x double> %i.r, <2 x double> zeroinitializer) ; 2 uses
  %foldExtExtBinop = fadd <2 x double> %i.p, %i.bx
  %i.by = shufflevector <2 x double> %foldExtExtBinop, <2 x double> %i.bq, <2 x i32> <i32 1, i32 3>
  %i.bz = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ab, <2 x double> zeroinitializer, <2 x double> %i.by)
  %i.ca = shufflevector <2 x double> %i.bu, <2 x double> %i.p, <2 x i32> <i32 0, i32 3>
  %i.cb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ca, <2 x double> %7, <2 x double> %i.bx)
  %i.cc = fdiv double %i.bj, %sqrt.i.i2           ; 2 uses
  %i.cd = insertelement <2 x double> poison, double %i.cc, i64 0 ; 2 uses
  %i.ce = shufflevector <2 x double> %i.cd, <2 x double> %i.p, <2 x i32> <i32 0, i32 2>
  %i.cf = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ce, <2 x double> %i.t, <2 x double> %i.cb)
  %i.cg = shufflevector <2 x double> %i.au, <2 x double> %i.bu, <2 x i32> <i32 0, i32 3>
  %i.ch = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cg, <2 x double> %i.r, <2 x double> zeroinitializer) ; 2 uses
  %shift = shufflevector <2 x double> %i.ch, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop82 = fadd <2 x double> %i.bu, %shift
  ...
  %i.ck = shufflevector <2 x double> %i.cj, <2 x double> %i.bu, <2 x i32> <i32 0, i32 2>
  %i.cl = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ck, <2 x double> %7, <2 x double> %i.ch)
  %i.cm = shufflevector <2 x double> %i.au, <2 x double> poison, <2 x i32> <i32 1, i32 poison>
  %i.cn = insertelement <2 x double> %i.cm, double %i.cc, i64 1
  %i.co = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cn, <2 x double> %i.t, <2 x double> %i.cl)
  %i.cp = shufflevector <2 x double> %i.bu, <2 x double> %i.au, <2 x i32> <i32 1, i32 2>
  %i.cq = fadd <2 x double> %i.cp, zeroinitializer
  %i.cr = insertelement <2 x double> %i.bu, double %i.ar, i64 1
  %i.cs = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cr, <2 x double> zeroinitializer, <2 x double> %i.cq) ; 2 uses
  %i.ct = shufflevector <2 x double> %foldExtExtBinop82, <2 x double> %i.cs, <2 x i32> <i32 0, i32 2>
  %i.cu = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ci, <2 x double> zeroinitializer, <2 x double> %i.ct)
  %i.cv = tail call double @llvm.fmuladd.f64(double %i.av, double 0.000000e+00, double 0.000000e+00) ; 2 uses
  %i.cw = fadd double %i.ar, %i.cv
  %i.cx = tail call double @llvm.fmuladd.f64(double %i.ar, double 0.000000e+00, double %i.cv)
  %i.cy = fadd double %i.ax, %i.cx
  store double %i.cy, ptr @ModelView, align 8
  %i.cz = shufflevector <2 x double> %i.au, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.da = insertelement <2 x double> %i.cs, double %i.cw, i64 0
  %i.db = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cz, <2 x double> zeroinitializer, <2 x double> %i.da)
  store <2 x double> %i.db, ptr getelementptr inbounds nuw (i8, ptr @ModelView, i64 8), align 8
  store <2 x double> %i.co, ptr getelementptr inbounds nuw (i8, ptr @ModelView, i64 24), align 8
  store <2 x double> %i.cu, ptr getelementptr inbounds nuw (i8, ptr @ModelView, i64 40), align 8
  store <2 x double> %i.cf, ptr getelementptr inbounds nuw (i8, ptr @ModelView, i64 56), align 8
  store <2 x double> %i.bz, ptr getelementptr inbounds nuw (i8, ptr @ModelView, i64 72), align 8
  %i.dc = extractelement <2 x double> %i.aq, i64 1
  store double %i.dc, ptr getelementptr inbounds nuw (i8, ptr @ModelView, i64 88), align 8
  ...
  %i.dd = extractelement <2 x double> %i.aq, i64 0
  store double %i.dd, ptr getelementptr inbounds nuw (i8, ptr @ModelView, i64 120), align 8, !tbaa !18
  ret void
}
