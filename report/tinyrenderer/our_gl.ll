...
bb.a:
  ...
  %5 = fneg double %i.d                           ; 2 uses
  %6 = fneg double %4                             ; 2 uses
  %7 = fneg double %3                             ; 2 uses
  %8 = insertelement <2 x double> <double poison, double 0.000000e+00>, double %5, i64 0 ; 2 uses
  %9 = insertelement <2 x double> <double poison, double 0.000000e+00>, double %6, i64 0 ; 2 uses
  %i.r = insertelement <2 x double> <double poison, double 1.000000e+00>, double %7, i64 0 ; 2 uses
  %10 = insertelement <2 x double> poison, double %5, i64 0
  %i.s = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> zeroinitializer
  %11 = insertelement <2 x double> %i.p, double 0.000000e+00, i64 0
  %i.t = insertelement <2 x double> poison, double %6, i64 0
  %12 = shufflevector <2 x double> %i.t, <2 x double> poison, <2 x i32> zeroinitializer
  %13 = shufflevector <2 x double> %i.p, <2 x double> <double 0.000000e+00, double poison>, <2 x i32> <i32 2, i32 0>
  ...
  %i.ao = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.an, <2 x double> %i.s, <2 x double> <double 1.000000e+00, double 0.000000e+00>)
  %i.ap = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %11, <2 x double> %12, <2 x double> %i.ao)
  %i.aq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %13, <2 x double> %15, <2 x double> %i.ap) ; 2 uses
  ...
  %i.bx = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bw, <2 x double> %8, <2 x double> zeroinitializer) ; 2 uses
  ...
  %i.cb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ca, <2 x double> %9, <2 x double> %i.bx)
  ...
  %i.cf = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ce, <2 x double> %i.r, <2 x double> %i.cb)
  %i.cg = shufflevector <2 x double> %i.au, <2 x double> %i.bu, <2 x i32> <i32 0, i32 3>
  %i.ch = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cg, <2 x double> %8, <2 x double> zeroinitializer) ; 2 uses
  ...
  %i.cl = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ck, <2 x double> %9, <2 x double> %i.ch)
  ...
  %i.co = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cn, <2 x double> %i.r, <2 x double> %i.cl)
