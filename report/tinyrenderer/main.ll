...
.preheader:                                       ; preds = %bb.a, %.preheader
  ...
  %3 = extractelement <2 x double> %i.p, i64 0
  %4 = and i64 %indvars.iv, 1
  %.not13.i.not = icmp eq i64 %4, 0
  ...
  %i.x = load double, ptr %spec.select.i.1.i9, align 8, !tbaa !14 ; 2 uses
  %5 = tail call noundef double @llvm.fmuladd.f64(double %i.l, double %i.x, double %i.u) ; 2 uses
  %i.y = tail call double @llvm.fmuladd.f64(double %i.w, double %i.o, double 0.000000e+00)
  %6 = insertelement <2 x double> poison, double %i.m, i64 0
  %7 = insertelement <2 x double> %6, double %i.w, i64 1
  %8 = and i64 %indvars.iv, 1
  %.not13.i.1 = icmp eq i64 %8, 0
  %9 = getelementptr inbounds nuw i8, ptr %i.j, i64 16
  %10 = and i64 %indvars.iv, 1
  %.not13.i.2.not = icmp eq i64 %10, 0
  %11 = getelementptr inbounds nuw i8, ptr %i.j, i64 8
  %12 = load double, ptr %spec.select.i.220.i.1, align 8, !tbaa !14 ; 2 uses
  %13 = load double, ptr %spec.select.i.220.i, align 8, !tbaa !14 ; 3 uses
  %14 = insertelement <2 x double> %i.p, double %13, i64 0
  %i.z = load <2 x double>, ptr %spec.select.i.i8, align 8, !tbaa !14 ; 4 uses
  %i.aa = extractelement <2 x double> %i.z, i64 1 ; 2 uses
  %i.ab = tail call noundef double @llvm.fmuladd.f64(double %i.l, double %i.aa, double %i.y)
  %i.ac = insertelement <2 x double> poison, double %i.ab, i64 0
  %i.ad = insertelement <2 x double> %i.ac, double %i.x, i64 1
  %i.ae = fneg <2 x double> %i.ad                 ; 3 uses
  %i.af = insertelement <2 x double> %i.ae, double %5, i64 0
  %i.ag = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %14, <2 x double> %i.af, <2 x double> zeroinitializer) ; 2 uses
  %i.ah = extractelement <2 x double> %i.ag, i64 0
  %15 = tail call double @llvm.fmuladd.f64(double %12, double %5, double 0.000000e+00)
  %16 = insertelement <2 x double> <double poison, double 0.000000e+00>, double %15, i64 0
  %i.ai = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %7, <2 x double> %i.ae, <2 x double> %16) ; 2 uses
  %i.aj = extractelement <2 x double> %i.ai, i64 1
  %i.ak = tail call noundef double @llvm.fmuladd.f64(double %3, double %i.aa, double %i.aj) ; 2 uses
  ...
  %i.ao = select i1 %.not13.i.1, double %i.am, double %i.an
  store double %i.ao, ptr %9, align 16, !tbaa !14
  ...
  %17 = insertelement <2 x double> poison, double %12, i64 0 ; 2 uses
  %18 = insertelement <2 x double> %17, double %i.w, i64 1
  ...
  %i.ax = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %18, <2 x double> %i.aw, <2 x double> zeroinitializer) ; 2 uses
  ...
  %i.bd = select i1 %.not13.i.not, double %i.bc, double %i.bb
  store double %i.bd, ptr %i.v, align 8, !tbaa !14
  %i.be = extractelement <2 x double> %i.ax, i64 0
  %i.bf = tail call double @llvm.fmuladd.f64(double %13, double %i.ap, double %i.be)
  %i.bg = insertelement <2 x double> %17, double %i.n, i64 1
  ...
  %i.bl = select i1 %.not13.i.2.not, double %i.bk, double %i.bj
  store double %i.bl, ptr %11, align 8, !tbaa !14
  %i.bm = fneg double %i.ak
  %i.bn = extractelement <2 x double> %i.bi, i64 0
  %i.bo = tail call double @llvm.fmuladd.f64(double %13, double %i.bm, double %i.bn)
  %i.bp = extractelement <2 x double> %i.az, i64 1
  %i.bq = tail call noundef double @llvm.fmuladd.f64(double %i.m, double %i.bp, double %i.bo)
  %i.br = trunc nuw nsw i64 %indvars.iv to i32    ; 2 uses
  %19 = and i32 %i.br, 1
  %.not13.i.3 = icmp eq i32 %19, 0
  %20 = select i1 %.not13.i.3, i32 1, i32 -1
  %21 = sitofp i32 %20 to double
  %22 = fmul double %i.bq, %21
  store double %22, ptr %i.j, align 16, !tbaa !14
