...
bb.a:
  ...
  %4 = load double, ptr %i.bd, align 8, !tbaa !14 ; 3 uses
  %i.br = insertelement <2 x double> poison, double %4, i64 0
  ...
  %5 = load double, ptr %i.bf, align 8, !tbaa !14 ; 3 uses
  %i.bx = insertelement <2 x double> poison, double %5, i64 0
  ...
  %i.dg = fmul double %.sroa.3.0.copyload.i, %4
  %i.dh = fmul double %.sroa.0.0.copyload.i, %4
  %i.di = fadd double %i.de, %i.dg
  %i.dj = fadd double %i.df, %i.dh
  %i.dk = fmul double %.sroa.3.0.copyload.i17, %5
  %i.dl = fmul double %.sroa.0.0.copyload.i15, %5
...
.preheader:                                       ; preds = %bb.a, %.preheader
  ...
  %i.y = tail call noundef double @llvm.fmuladd.f64(double %i.l, double %3, double %i.t) ; 2 uses
  ...
  %i.ag = load double, ptr %spec.select.i.220.i, align 8, !tbaa !14 ; 3 uses
  %4 = insertelement <2 x double> %i.p, double %i.ag, i64 0
  %5 = load <2 x double>, ptr %spec.select.i.i8, align 8, !tbaa !14 ; 4 uses
  %6 = load double, ptr %spec.select.i.220.i.1, align 8, !tbaa !14 ; 2 uses
  %i.ah = extractelement <2 x double> %5, i64 1   ; 2 uses
  ...
  %i.ak = insertelement <2 x double> %i.aj, double %3, i64 1
  %i.al = fneg <2 x double> %i.ak                 ; 3 uses
  %i.am = insertelement <2 x double> %i.al, double %i.y, i64 0
  %i.an = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %4, <2 x double> %i.am, <2 x double> zeroinitializer) ; 2 uses
  %i.ao = extractelement <2 x double> %i.an, i64 0
  %i.ap = tail call double @llvm.fmuladd.f64(double %6, double %i.y, double 0.000000e+00)
  ...
  %8 = insertelement <2 x double> %7, double %i.l, i64 1
  %9 = shufflevector <2 x double> %5, <2 x double> poison, <2 x i32> <i32 poison, i32 0>
  %10 = insertelement <2 x double> %9, double %i.at, i64 0
  %11 = shufflevector <2 x double> %i.ar, <2 x double> %i.s, <2 x i32> <i32 0, i32 3>
  %12 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %8, <2 x double> %10, <2 x double> %11) ; 3 uses
  %13 = fneg <2 x double> %12                     ; 2 uses
  %i.av = extractelement <2 x double> %13, i64 0
  %i.aw = extractelement <2 x double> %12, i64 0
  %14 = select i1 %.not13.i.1, double %i.aw, double %i.av
  store double %14, ptr %i.ad, align 16, !tbaa !14
  %15 = extractelement <2 x double> %13, i64 1
  %16 = tail call double @llvm.fmuladd.f64(double %i.m, double %15, double %i.ao)
  %i.ax = insertelement <2 x double> poison, double %6, i64 0 ; 2 uses
  %i.ay = insertelement <2 x double> %i.ax, double %i.x, i64 1
  %i.az = fneg <2 x double> %5
  %17 = shufflevector <2 x double> %12, <2 x double> %i.az, <2 x i32> <i32 1, i32 2>
  %i.ba = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ay, <2 x double> %17, <2 x double> zeroinitializer) ; 2 uses
  %i.bb = shufflevector <2 x double> %i.an, <2 x double> %i.ba, <2 x i32> <i32 1, i32 3>
  %i.bc = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.p, <2 x double> %5, <2 x double> %i.bb) ; 3 uses
  %i.bd = extractelement <2 x double> %i.bc, i64 0
  %i.be = tail call noundef double @llvm.fmuladd.f64(double %i.n, double %i.bd, double %16) ; 2 uses
  ...
  %i.bi = tail call double @llvm.fmuladd.f64(double %i.ag, double %i.au, double %i.bh)
  %i.bj = insertelement <2 x double> %i.ax, double %i.n, i64 1
  ...
  %i.br = tail call double @llvm.fmuladd.f64(double %i.ag, double %i.bp, double %i.bq)
