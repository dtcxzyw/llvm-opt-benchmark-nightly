...
begin_hunk_0_@i915_gem_object_needs_bit17_swizzle
...
define internal i32 @shmem_get_pages(ptr noundef %0) #0 align 16 prefalign(16) {
bb.a:
  %i.a = getelementptr i8, ptr %0, i64 8
  %i.b = load ptr, ptr %i.a, align 8              ; 3 uses
  %i.c = getelementptr i8, ptr %0, i64 720
  ...
  %i.k = tail call i64 @dma_max_mapping_size(ptr noundef %i.j) #9
  %i.l = load ptr, ptr getelementptr inbounds nuw (i8, ptr @kmalloc_caches, i64 32), align 16
  %i.m = tail call noalias align 8 dereferenceable_or_null(16) ptr @__kmalloc_cache_noprof(ptr noundef %i.l, i32 noundef 11456, i64 noundef 16) #11 ; 8 uses
  %.not58 = icmp eq ptr %i.m, null
  br i1 %.not58, label %.loopexit, label %.lr.ph

.lr.ph:                                           ; preds = %bb.a
  %i.n = tail call i64 @llvm.umin.i64(i64 %i.k, i64 4294967295)
  %i.o = trunc nuw i64 %i.n to i32
  %i.p = and i32 %i.o, -4096                      ; 2 uses
  %i.q = getelementptr i8, ptr %0, i64 216        ; 3 uses
  %i.r = load i64, ptr %i.q, align 8
  %i.s = tail call i32 @shmem_sg_alloc_table(ptr noundef %i.b, ptr noundef nonnull %i.m, i64 noundef %i.r, ptr noundef %i.d, ptr noundef %i.h, i32 noundef %i.p) #10 ; 2 uses
  %.not44.peel = icmp eq i32 %i.s, 0
  br i1 %.not44.peel, label %bb.b, label %.loopexit46

bb.b:                                             ; preds = %.lr.ph
  %i.t = tail call i32 @i915_gem_gtt_prepare_pages(ptr noundef %0, ptr noundef nonnull %i.m) #9 ; 2 uses
  %.not45.peel = icmp eq i32 %i.t, 0
  br i1 %.not45.peel, label %.loopexit71, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.u = icmp ugt i32 %i.p, 4096
  br i1 %i.u, label %bb.d, label %.loopexit72

bb.d:                                             ; preds = %bb.c
  tail call void @shmem_sg_free_table(ptr noundef nonnull %i.m, ptr noundef %i.h, i1 noundef zeroext false, i1 noundef zeroext false) #10
  tail call void @kfree(ptr noundef nonnull %i.m) #9
  %i.v = load ptr, ptr getelementptr inbounds nuw (i8, ptr @kmalloc_caches, i64 32), align 16
  %i.w = tail call noalias align 8 dereferenceable_or_null(16) ptr @__kmalloc_cache_noprof(ptr noundef %i.v, i32 noundef 11456, i64 noundef 16) #11 ; 6 uses
  %.not.peel = icmp eq ptr %i.w, null
  br i1 %.not.peel, label %.loopexit, label %.peel.next

.peel.next:                                       ; preds = %bb.d
  %.pre = load i64, ptr %i.q, align 8
  %i.x = tail call i32 @shmem_sg_alloc_table(ptr noundef %i.b, ptr noundef nonnull %i.w, i64 noundef %.pre, ptr noundef %i.d, ptr noundef %i.h, i32 noundef 4096) #10 ; 2 uses
  %.not44 = icmp eq i32 %i.x, 0
  br i1 %.not44, label %bb.e, label %.loopexit46

bb.e:                                             ; preds = %.peel.next
  %i.y = tail call i32 @i915_gem_gtt_prepare_pages(ptr noundef %0, ptr noundef nonnull %i.w) #9 ; 2 uses
  %.not45 = icmp eq i32 %i.y, 0
  br i1 %.not45, label %.loopexit71, label %.loopexit72

.loopexit72:                                      ; preds = %bb.e, %bb.c
  %.lcssa68 = phi i32 [ %i.t, %bb.c ], [ %i.y, %bb.e ]
  %.lcssa65 = phi ptr [ %i.m, %bb.c ], [ %i.w, %bb.e ] ; 2 uses
  %i.z = load ptr, ptr %i.i, align 8
  %i.aa = load i64, ptr %i.q, align 8
  %i.ab = lshr i64 %i.aa, 12
  tail call void (ptr, ptr, ...) @_dev_warn(ptr noundef %i.z, ptr noundef nonnull @.str.4, i64 noundef %i.ab) #12
  tail call void @shmem_sg_free_table(ptr noundef nonnull %.lcssa65, ptr noundef %i.h, i1 noundef zeroext false, i1 noundef zeroext false) #10
  br label %.loopexit46

.loopexit71:                                      ; preds = %bb.e, %bb.b
  %.lcssa64 = phi ptr [ %i.m, %bb.b ], [ %i.w, %bb.e ] ; 2 uses
  %i.ac = tail call zeroext i1 @i915_gem_object_needs_bit17_swizzle(ptr noundef %0) #9
  br i1 %i.ac, label %bb.f, label %bb.g

bb.f:                                             ; preds = %.loopexit71
  tail call void @i915_gem_object_do_bit_17_swizzle(ptr noundef %0, ptr noundef nonnull %.lcssa64) #9
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %.loopexit71
  %i.ad = tail call zeroext i1 @i915_gem_object_can_bypass_llc(ptr noundef %0) #9
  br i1 %i.ad, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %i.ae = getelementptr i8, ptr %0, i64 660       ; 2 uses
  %i.af = load i16, ptr %i.ae, align 4
  %i.ag = or i16 %i.af, 512
  store i16 %i.ag, ptr %i.ae, align 4
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.g
  tail call void @__i915_gem_object_set_pages(ptr noundef %0, ptr noundef nonnull %.lcssa64) #9
  br label %.loopexit

.loopexit46:                                      ; preds = %.lr.ph, %.peel.next, %.loopexit72
  %i.ah = phi ptr [ %.lcssa65, %.loopexit72 ], [ %i.m, %.lr.ph ], [ %i.w, %.peel.next ]
  %.041 = phi i32 [ %.lcssa68, %.loopexit72 ], [ %i.s, %.lr.ph ], [ %i.x, %.peel.next ] ; 2 uses
  %i.ai = icmp eq i32 %.041, -28
  %spec.store.select = select i1 %i.ai, i32 -12, i32 %.041
  tail call void @kfree(ptr noundef nonnull %i.ah) #9
  br label %.loopexit

.loopexit:                                        ; preds = %bb.d, %bb.a, %.loopexit46, %bb.i
  %.0 = phi i32 [ %spec.store.select, %.loopexit46 ], [ 0, %bb.i ], [ -12, %bb.a ], [ -12, %bb.d ]
  ret i32 %.0
}

; Function Attrs: fn_ret_thunk_extern noredzone nounwind null_pointer_is_valid sspstrong
define internal void @shmem_put_pages(ptr noundef %0, ptr noundef %1) #0 align 16 prefalign(16) {
bb.a:
  %i.a = tail call zeroext i1 @i915_gem_object_has_struct_page(ptr noundef %0) #9
  br i1 %i.a, label %bb.b, label %bb.c, !prof !23

bb.b:                                             ; preds = %bb.a
  tail call void @i915_gem_object_put_pages_shmem(ptr noundef %0, ptr noundef %1) #10
  br label %bb.d

bb.c:                                             ; preds = %bb.a
  tail call void @i915_gem_object_put_pages_phys(ptr noundef %0, ptr noundef %1) #9
  br label %bb.d
...
; Function Attrs: fn_ret_thunk_extern noredzone nounwind null_pointer_is_valid sspstrong
define internal noundef i32 @shmem_truncate(ptr nofree noundef captures(none) initializes((760, 768)) %0) #0 align 16 prefalign(16) {
bb.a:
  %i.a = getelementptr i8, ptr %0, i64 16
  %i.b = load ptr, ptr %i.a, align 8
  %i.c = getelementptr i8, ptr %i.b, i64 32
  %.val = load ptr, ptr %i.c, align 8
  tail call void @shmem_truncate_range(ptr noundef %.val, i64 noundef 0, i64 noundef -1) #9
  %i.d = getelementptr i8, ptr %0, i64 912        ; 2 uses
  %i.e = load i8, ptr %i.d, align 8
  %i.f = and i8 %i.e, -4
  %i.g = or disjoint i8 %i.f, 2
  store i8 %i.g, ptr %i.d, align 8
  %i.h = getelementptr i8, ptr %0, i64 760
  store ptr inttoptr (i64 -14 to ptr), ptr %i.h, align 8
  ret i32 0
}

; Function Attrs: fn_ret_thunk_extern noredzone nounwind null_pointer_is_valid sspstrong
define internal i32 @shmem_shrink(ptr noundef %0, i32 noundef %1) #0 align 16 prefalign(16) {
bb.a:
  %i.a = getelementptr i8, ptr %0, i64 912
...
bb.b:                                             ; preds = %bb.a
  %i.d = tail call i32 @i915_gem_object_truncate(ptr noundef %0) #9
  br label %bb.e
...
bb.d:                                             ; preds = %bb.c
  ...
  tail call void @__shmem_writeback(i64 poison, ptr noundef %.val.val) #10
  br label %bb.e

bb.e:                                             ; preds = %bb.c, %bb.d, %bb.a, %bb.b
  %.0 = phi i32 [ 0, %bb.a ], [ %i.d, %bb.b ], [ 0, %bb.d ], [ 0, %bb.c ]
  ret i32 %.0
}

; Function Attrs: fn_ret_thunk_extern noredzone nounwind null_pointer_is_valid sspstrong
define internal i32 @shmem_pread(ptr noundef %0, ptr noundef %1) #0 align 16 prefalign(16) {
bb.a:
  %i.a = tail call zeroext i1 @i915_gem_object_has_struct_page(ptr noundef %0) #9
  br i1 %i.a, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.b = tail call i32 @i915_gem_object_pread_phys(ptr noundef %0, ptr noundef %1) #9
  br label %bb.c

bb.c:                                             ; preds = %bb.a, %bb.b
  %.0 = phi i32 [ %i.b, %bb.b ], [ -19, %bb.a ]
  ret i32 %.0
}
...
bb.a:
  ...
  %i.d = getelementptr i8, ptr %0, i64 2928
  %i.e = load ptr, ptr %i.d, align 8
  %i.f = tail call ptr @i915_gem_object_create_region(ptr noundef %i.e, i64 noundef %i.c, i64 noundef 0, i32 noundef 0) #9 ; 8 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.j = call i64 @kernel_write(ptr noundef %i.i, ptr noundef %1, i64 noundef %2, ptr noundef nonnull %i.a) #9 ; 3 uses
...
bb.d:                                             ; preds = %bb.c, %bb.b
  %.015 = phi i64 [ %i.j, %bb.b ], [ -5, %bb.c ]
  %i.l = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.f, i32 -1, ptr elementtype(i32) %i.f) #8, !srcloc !28 ; 2 uses
  %i.m = icmp eq i32 %i.l, 1
  br i1 %i.m, label %bb.g, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.n = icmp slt i32 %i.l, 1
  br i1 %i.n, label %bb.f, label %i915_gem_object_put.exit, !prof !15

bb.f:                                             ; preds = %bb.e
  call void @refcount_warn_saturate(ptr noundef %i.f, i32 noundef 3) #9
  br label %i915_gem_object_put.exit

bb.g:                                             ; preds = %bb.d
  call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !29
  call void @drm_gem_object_free(ptr noundef %i.f) #9
  br label %i915_gem_object_put.exit

i915_gem_object_put.exit:                         ; preds = %bb.e, %bb.f, %bb.g
  %i.o = inttoptr i64 %.015 to ptr
  br label %bb.h

bb.h:                                             ; preds = %bb.c, %bb.a, %i915_gem_object_put.exit
  %.0 = phi ptr [ %i.f, %bb.a ], [ %i.o, %i915_gem_object_put.exit ], [ %i.f, %bb.c ]
