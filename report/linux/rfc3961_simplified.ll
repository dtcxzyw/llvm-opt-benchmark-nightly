...
.critedge68:                                      ; preds = %.critedge
  ...
  %12 = getelementptr i8, ptr %.val70, i64 -16
  %.val70.val = load i32, ptr %12, align 8
  %13 = add i32 %.val70.val, 7
  %14 = and i32 %13, -8
  %i.k = add i32 %10, %14
...
_kzalloc_noprof.exit:                             ; preds = %.critedge
  ...
  %10 = getelementptr i8, ptr %.val41, i64 -16
  %.val41.val = load i32, ptr %10, align 8
  %11 = add i32 %.val41.val, 7
  %12 = and i32 %11, -8
  %i.l = add i32 %8, %12
...
.critedge:                                        ; preds = %bb.a
  ...
  %i.e = getelementptr i8, ptr %.val58, i64 -16
  %.val59.val.a = load i32, ptr %i.e, align 8
  %i.f = add i32 %.val59.val.a, 7
  %i.g = or i32 %i.f, 7
  %8 = add i32 %i.g, 1
  %i.h = getelementptr i8, ptr %.val58, i64 -8
...
_kzalloc_noprof.exit:                             ; preds = %bb.a
  ...
  %i.j = getelementptr i8, ptr %.val65, i64 -16
  %.val67.val.a = load i32, ptr %i.j, align 8
  %7 = add i32 %.val67.val.a, 7
  %8 = or i32 %7, 7
  %9 = add i32 %8, 1
  %i.k = getelementptr i8, ptr %.val65, i64 -8
  %.val65.val = load i32, ptr %i.k, align 8
  %10 = shl i32 %.val65.val, 1
  %11 = add i32 %10, 14
  %12 = and i32 %11, -16
  %i.l = add i32 %9, %12
  %i.m = zext i32 %i.l to i64
...
bb.b:                                             ; preds = %_kzalloc_noprof.exit
  ...
  %i.v = add i32 %.val66.val, 7
  %13 = and i32 %i.v, -8
  %i.w = zext i32 %13 to i64
