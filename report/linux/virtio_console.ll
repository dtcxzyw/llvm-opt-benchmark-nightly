...
.lr.ph160:                                        ; preds = %.lr.ph160, %.lr.ph160.preheader.new
  ...
  %1 = zext nneg i32 %.1105158 to i64
  %2 = getelementptr [8 x i8], ptr %i.k, i64 %1
  ...
  %4 = zext nneg i32 %.1105158 to i64
  %5 = getelementptr [8 x i8], ptr %i.k, i64 %4
  ...
  %i.cg = add nuw nsw i32 %.1105158, 4            ; 3 uses
  ...
  %7 = zext nneg i32 %.1105158 to i64
  %8 = getelementptr [8 x i8], ptr %i.k, i64 %7
