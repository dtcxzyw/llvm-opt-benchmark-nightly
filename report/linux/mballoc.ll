...
begin_hunk_0_@mb_free_blocks:bb.a
  %.084 = phi i1 [ %i.ds, %mb_test_bit.exit133 ], [ false, %mb_test_and_clear_bits.exit ] ; 4 uses
  %.not96 = icmp eq i32 %phi.call, -1
  br i1 %.not96, label %bb.t, label %bb.o, !prof !20

bb.o:                                             ; preds = %bb.n
  %.val = load ptr, ptr %i.l, align 32            ; 4 uses
  %i.dt = getelementptr i8, ptr %.val, i64 168
  %i.du = load i16, ptr %i.dt, align 8
  %i.dv = and i16 %i.du, 32
  %.not100.not = icmp eq i16 %i.dv, 0
  br i1 %.not100.not, label %bb.q, label %bb.p

bb.p:                                             ; preds = %bb.o
  tail call fastcc void @mb_regenerate_buddy(ptr noundef %1) #16, !srcloc !257
  br label %bb.ao

bb.q:                                             ; preds = %bb.o
  %i.dw = load i32, ptr %i.j, align 4             ; 2 uses
  %i.dx = getelementptr i8, ptr %.val, i64 16
  %.val106.val = load i64, ptr %i.dx, align 16
  %i.dy = getelementptr i8, ptr %.val, i64 104
  %.val106.val107 = load ptr, ptr %i.dy, align 8
  %i.dz = getelementptr i8, ptr %.val106.val107, i64 20
  %.val106.val107.val = load i32, ptr %i.dz, align 4
  %i.ea = zext i32 %i.dw to i64
  %i.eb = mul i64 %.val106.val, %i.ea
  %i.ec = zext i32 %.val106.val107.val to i64
  %i.ed = add i64 %i.eb, %i.ec
  %i.ee = getelementptr i8, ptr %.val, i64 84
  %i.ef = load i32, ptr %i.ee, align 4
  %i.eg = shl i32 %phi.call, %i.ef
  %i.eh = sext i32 %i.eg to i64
  %i.ei = add i64 %i.ed, %i.eh
  tail call void @ext4_mark_group_bitmap_corrupted(ptr noundef %i.d, i32 noundef %i.dw, i32 noundef 4) #15
  %i.ej = load i32, ptr %i.j, align 4
  %.not101 = icmp eq ptr %0, null
  br i1 %.not101, label %bb.s, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.ek = getelementptr i8, ptr %0, i64 64
  %i.el = load i64, ptr %i.ek, align 8
  br label %bb.s

bb.s:                                             ; preds = %bb.q, %bb.r
  %i.em = phi i64 [ %i.el, %bb.r ], [ 0, %bb.q ]
  tail call void (ptr, i32, ptr, i32, i64, i64, ptr, ...) @__ext4_grp_locked_error(ptr noundef nonnull @__func__.mb_free_blocks, i32 noundef 2049, ptr noundef %i.d, i32 noundef %i.ej, i64 noundef %i.em, i64 noundef %i.ei, ptr noundef nonnull @.str.96, i32 noundef %phi.call) #15
  br label %bb.ao
...
mb_find_buddy.exit38.thread.i:                    ; preds = %mb_find_buddy.exit38.i, %bb.ak
  %4 = add i32 %.159.i, 1                         ; 3 uses
  %5 = icmp slt i32 %.161.i, %4
  br i1 %5, label %.lr.ph.i.i, label %mb_clear_bits.exit.i
...
.lr.ph.i.i:                                       ; preds = %mb_find_buddy.exit38.thread.i
  ...
  %i.in = and i32 %i.im, 56
  %i.io = and i64 %i.il, -8
  %i.ip = inttoptr i64 %i.io to ptr
  br label %bb.al

bb.al:                                            ; preds = %.backedge.i.i, %.lr.ph.i.i
  %.015.i.i = phi i32 [ %.161.i, %.lr.ph.i.i ], [ %i.ix, %.backedge.i.i ] ; 5 uses
  %i.iq = and i32 %.015.i.i, 31
  %i.ir = icmp eq i32 %i.iq, 0
  %i.is = sub i32 %4, %.015.i.i
  %i.it = icmp sgt i32 %i.is, 31
  %or.cond.i.i135 = and i1 %i.ir, %i.it
  br i1 %or.cond.i.i135, label %bb.am, label %bb.an

bb.am:                                            ; preds = %bb.al
  %i.iu = ashr exact i32 %.015.i.i, 3
  %i.iv = sext i32 %i.iu to i64
  %i.iw = getelementptr i8, ptr %.01781.i, i64 %i.iv
...
.backedge.i.i:                                    ; preds = %bb.an, %bb.am
  ...
  %6 = icmp slt i32 %i.ix, %4
  br i1 %6, label %bb.al, label %mb_clear_bits.exit.i, !llvm.loop !3
...
mb_clear_bits.exit.i:                             ; preds = %.backedge.i.i, %mb_find_buddy.exit38.thread.i
  ...
  %i.je = add i32 %reass.sub, 1
  %i.jf = add i32 %i.je, %i.jd
  store i32 %i.jf, ptr %i.jc, align 4
  br label %mb_buddy_mark_free.exit

mb_buddy_mark_free.exit:                          ; preds = %bb.ah, %mb_clear_bits.exit.i, %mb_find_buddy.exit.i, %bb.ab
  %i.jg = load ptr, ptr %i.r, align 8
  tail call fastcc void @mb_set_largest_free_order(ptr noundef %i.d, ptr noundef %i.jg) #16, !srcloc !259
  %i.jh = load ptr, ptr %i.r, align 8
  tail call fastcc void @mb_update_avg_fragment_size(ptr noundef %i.d, ptr noundef %i.jh) #16, !srcloc !260
  br label %bb.ao
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %i.ch = icmp eq i32 %.084128, %i.cg
  %i.ci = load i32, ptr %i.d, align 4
  %i.cj = zext i32 %i.ci to i64
  %.281 = select i1 %i.ch, i64 %i.cj, i64 %.180132 ; 2 uses
  %i.ck = getelementptr i8, ptr %i.cc, i64 20
