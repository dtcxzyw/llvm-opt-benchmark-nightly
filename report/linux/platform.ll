...
bb.b:                                             ; preds = %.lr.ph, %bb.c
  ...
  %.01216 = phi i32 [ %2, %.lr.ph ], [ %.214.a, %bb.c ] ; 2 uses
...
._crit_edge:                                      ; preds = %bb.b, %bb.c, %bb.a
  %.2 = phi ptr [ null, %bb.a ], [ null, %bb.c ], [ %i.f, %bb.b ]
  ret ptr %.2
}
...
bb.b:                                             ; preds = %.lr.ph, %bb.c
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %bb.c ] ; 2 uses
  %.01115 = phi i32 [ %1, %.lr.ph ], [ %.213.a, %bb.c ] ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %.213.a = add i32 %.01115, %i.j
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge, label %bb.b, !llvm.loop !12

._crit_edge:                                      ; preds = %bb.b, %bb.c, %bb.a
  %.2 = phi ptr [ null, %bb.a ], [ null, %bb.c ], [ %i.e, %bb.b ]
  ret ptr %.2
}
...
bb.b:                                             ; preds = %bb.c, %.lr.ph.i
  ...
  %.01216.i = phi i32 [ %1, %.lr.ph.i ], [ %.214.i.a, %bb.c ] ; 2 uses
...
platform_get_resource.exit:                       ; preds = %bb.b, %bb.c, %bb.a
  %.2.i = phi ptr [ null, %bb.a ], [ %i.e, %bb.b ], [ null, %bb.c ] ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %platform_get_resource.exit
  ...
  %i.k = tail call ptr @devm_ioremap_resource(ptr noundef %i.j, ptr noundef %.2.i) #15
  ret ptr %i.k
}
...
bb.b:                                             ; preds = %bb.c, %.lr.ph.i.i
  ...
  %.01216.i.i = phi i32 [ %1, %.lr.ph.i.i ], [ %.214.i.i.a, %bb.c ] ; 2 uses
...
devm_platform_get_and_ioremap_resource.exit:      ; preds = %bb.b, %bb.c, %bb.a
  %.2.i.i = phi ptr [ null, %bb.a ], [ null, %bb.c ], [ %i.e, %bb.b ]
  %i.j = getelementptr i8, ptr %0, i64 16
  %i.k = tail call ptr @devm_ioremap_resource(ptr noundef %i.j, ptr noundef %.2.i.i) #15
  ret ptr %i.k
}
...
bb.b:                                             ; preds = %bb.c, %.lr.ph.i
  %indvars.iv.i = phi i64 [ 0, %.lr.ph.i ], [ %indvars.iv.next.i, %bb.c ] ; 2 uses
  %.01216.i = phi i32 [ %1, %.lr.ph.i ], [ %.214.i, %bb.c ] ; 2 uses
...
.thread:                                          ; preds = %bb.c, %bb.a
  %i.l = tail call zeroext i1 @is_acpi_device_node(ptr noundef %i.b) #15 ; 0 uses
  br label %.critedge

platform_get_resource.exit:                       ; preds = %bb.b
  %i.m = getelementptr i8, ptr %i.g, i64 24       ; 3 uses
  %i.n = tail call zeroext i1 @is_acpi_device_node(ptr noundef %i.b) #15
  %i.o = icmp ne ptr %i.g, null                   ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  %i.r = tail call zeroext i1 @is_acpi_device_node(ptr noundef %i.b) #15 ; 0 uses
  br label %.critedge73.thread

bb.f:                                             ; preds = %platform_get_resource.exit
  br i1 %i.o, label %.thread93, label %.critedge

.thread93:                                        ; preds = %bb.d, %bb.f
  %i.s = load i64, ptr %i.m, align 8
  %i.t = and i64 %i.s, 255
  %.not68 = icmp eq i64 %i.t, 0
  br i1 %.not68, label %bb.j, label %bb.g

bb.g:                                             ; preds = %.thread93
  %i.u = load i64, ptr %i.g, align 8
  %i.v = trunc i64 %i.u to i32
  %i.w = tail call ptr @irq_get_irq_data(i32 noundef %i.v) #15 ; 2 uses
...
.thread78:                                        ; preds = %bb.g
  ...
  %i.z = getelementptr i8, ptr %i.w, i64 16       ; 3 uses
  %i.aa = load ptr, ptr %i.z, align 8             ; 2 uses
  %i.ab = load i32, ptr %i.aa, align 8
  %i.ac = and i32 %i.ab, -16
  store i32 %i.ac, ptr %i.aa, align 8
  %i.ad = and i32 %i.y, 15
  %i.ae = load ptr, ptr %i.z, align 8             ; 2 uses
  %i.af = load i32, ptr %i.ae, align 8
  %i.ag = or i32 %i.af, %i.ad
  store i32 %i.ag, ptr %i.ae, align 8
  %i.ah = load ptr, ptr %i.z, align 8             ; 2 uses
  %i.ai = load i32, ptr %i.ah, align 8
  %i.aj = or i32 %i.ai, 33554432
  store i32 %i.aj, ptr %i.ah, align 8
  br label %bb.j

.critedge:                                        ; preds = %.thread, %bb.f
  %i.ak = icmp eq i32 %1, 0
  br i1 %i.ak, label %bb.h, label %.critedge73.thread

bb.h:                                             ; preds = %.critedge
  %i.al = tail call zeroext i1 @is_acpi_device_node(ptr noundef %i.b) #15
  br i1 %i.al, label %bb.i, label %.critedge73.thread

bb.i:                                             ; preds = %bb.h
  %i.am = tail call zeroext i1 @is_acpi_device_node(ptr noundef %i.b) #15 ; 0 uses
  br label %.critedge73.thread
...
bb.k:                                             ; preds = %bb.j
  ...
  tail call void (ptr, ...) @__SCT__WARN_trap(ptr noundef %i.ap) #15
...
.critedge73:                                      ; preds = %bb.j
  ...
  %or.cond5 = and i1 %i.ar, %i.aq
  br i1 %or.cond5, label %bb.l, label %.critedge73.thread

bb.l:                                             ; preds = %.critedge73
  %i.as = tail call ptr @__dev_fwnode(ptr noundef %i.a) #15 ; 2 uses
  %i.at = tail call zeroext i1 @is_acpi_device_node(ptr noundef %i.as) #15
  br i1 %i.at, label %bb.m, label %get_irq_affinity.exit

bb.m:                                             ; preds = %bb.l
  %i.au = tail call zeroext i1 @is_acpi_device_node(ptr noundef %i.as) #15 ; 0 uses
...
.critedge73.thread:                               ; preds = %bb.e, %bb.h, %bb.i, %.critedge, %bb.g, %bb.k, %.critedge73, %get_irq_affinity.exit
  %.0 = phi i32 [ -22, %bb.k ], [ %i.ao, %get_irq_affinity.exit ], [ %i.ao, %.critedge73 ], [ -6, %bb.g ], [ -6, %.critedge ], [ -6, %bb.i ], [ -6, %bb.h ], [ -22, %bb.e ]
  ret i32 %.0
}
...
._crit_edge.thread:                               ; preds = %bb.f
  ...
  %.not73113 = icmp eq ptr %i.x, null
  br i1 %.not73113, label %.loopexit, label %._crit_edge90
...
bb.k:                                             ; preds = %bb.e, %bb.d, %bb.c, %platform_irq_count.exit, %bb.b, %bb.a, %.loopexit, %._crit_edge90
  %.0 = phi i32 [ -1, %bb.a ], [ -34, %bb.b ], [ %..0.i, %platform_irq_count.exit ], [ -28, %bb.c ], [ -12, %bb.e ], [ %.2, %.loopexit ], [ %spec.select, %._crit_edge90 ], [ -28, %bb.d ]
  ret i32 %.0
}
...
bb.b:                                             ; preds = %.lr.ph, %platform_disable_acpi_irq.exit
  %.015 = phi i32 [ 0, %.lr.ph ], [ %i.s, %platform_disable_acpi_irq.exit ] ; 3 uses
...
bb.d:                                             ; preds = %bb.e, %.lr.ph.i.i
  ...
  %.01216.i.i = phi i32 [ %.015, %.lr.ph.i.i ], [ %.214.i.i, %bb.e ] ; 2 uses
...
platform_disable_acpi_irq.exit:                   ; preds = %bb.e, %bb.f, %platform_get_resource.exit.i, %bb.c, %bb.b
  %i.s = add nuw i32 %.015, 1                     ; 2 uses
  %i.t = load i32, ptr %1, align 4
  %i.u = icmp ult i32 %i.s, %i.t
  br i1 %i.u, label %bb.b, label %._crit_edge, !llvm.loop !21
