Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/linux/original/i915_gem_pages?download=true
...
bb.p:                                             ; preds = %bb.n, %bb.o
  ...
  br i1 %i.bg, label %find_next_bit.exit.thread, label %bb.m, !prof !28, !llvm.loop !23
...
.critedge:                                        ; preds = %bb.q
  ...
  tail call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock orb ${1:b},$0", "=*m,iq,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i8) %i.bn, i32 8, ptr elementtype(i8) %i.bn) #7, !srcloc !29
  %i.bo = getelementptr i8, ptr %0, i64 692       ; 2 uses
  tail call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock incl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.bo, ptr elementtype(i32) %i.bo) #7, !srcloc !13
  br label %bb.t
...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  tail call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock incl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.e, ptr elementtype(i32) %i.e) #7, !srcloc !13
  br label %bb.d
...
bb.a:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %1, i8 0, i64 56, i1 false), !annotation !14
...
bb.b:                                             ; preds = %bb.m, %bb.a
  %i.j = load i8, ptr %i.a, align 8, !range !15, !noundef !16
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  switch i32 %.0.i.i, label %i915_gem_object_pin_pages.exit.thread [
    i32 0, label %bb.f
    i32 -35, label %bb.h
    i32 -114, label %bb.j
  ]
...
bb.f:                                             ; preds = %bb.e
  %i.o = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %0, i32 1, ptr elementtype(i32) %0) #7, !srcloc !17 ; 3 uses
...
bb.h:                                             ; preds = %bb.e, %i915_gem_object_get.exit.i.i
  %i.s = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %0, i32 1, ptr elementtype(i32) %0) #7, !srcloc !17 ; 3 uses
...
bb.j:                                             ; preds = %bb.e, %i915_gem_object_get.exit.i.i, %i915_gem_object_get.exit.i.i
  ...
  br i1 %i.w, label %raw_atomic_fetch_add_unless.exit.i, label %.lr.ph.i, !prof !18

.lr.ph.i:                                         ; preds = %bb.j, %arch_atomic_try_cmpxchg.exit.i
  %.047.i = phi i32 [ %i.ac, %arch_atomic_try_cmpxchg.exit.i ], [ %i.v, %bb.j ] ; 2 uses
  %i.x = add i32 %.047.i, 1
  %i.y = call { i8, i32 } asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgl $3, $1", "={@ccz},=*m,={ax},r,*m,2,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.g, i32 range(i32 2, 1) %i.x, ptr elementtype(i32) %i.g, i32 %.047.i) #7, !srcloc !19 ; 2 uses
...
arch_atomic_try_cmpxchg.exit.i:                   ; preds = %.lr.ph.i
  ...
  br i1 %i.ad, label %raw_atomic_fetch_add_unless.exit.i, label %.lr.ph.i, !prof !20
...
bb.l:                                             ; preds = %bb.k, %raw_atomic_fetch_add_unless.exit.i
  call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock incl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.g, ptr elementtype(i32) %i.g) #7, !srcloc !13
...
i915_gem_object_pin_pages.exit.thread:            ; preds = %bb.k, %bb.m, %i915_gem_object_get.exit.i.i, %bb.e, %.lr.ph.i, %bb.l
  %.1 = phi i32 [ 0, %.lr.ph.i ], [ 0, %bb.l ], [ %.0.i.i, %i915_gem_object_get.exit.i.i ], [ %i.ag, %bb.k ], [ %i.ah, %bb.m ], [ %.0.i.i, %bb.e ]
...
bb.i:                                             ; preds = %unmap_object.exit, %bb.f
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.q, i8 0, i64 16, i1 false), !annotation !14
...
select.unfold.i.backedge:                         ; preds = %.lr.ph, %bb.k, %.critedge.i
  ...
  br label %select.unfold.i, !llvm.loop !30
...
.critedge.i:                                      ; preds = %..critedge_crit_edge.i, %select.unfold.i
  ...
  br i1 %i.ab, label %.lr.ph, label %select.unfold.i.backedge, !llvm.loop !30

bb.k:                                             ; preds = %.lr.ph
  %i.ac = add nsw i64 %i.ae, -1
  %i.ad = icmp sgt i64 %i.ae, 1
  br i1 %i.ad, label %.lr.ph, label %select.unfold.i.backedge, !llvm.loop !30
...
.lr.ph:                                           ; preds = %.critedge.i, %bb.k
  ...
  br i1 %.not.i20.i, label %bb.k, label %select.unfold.i.backedge, !prof !11
...
select.unfold25.i.backedge:                       ; preds = %.lr.ph44, %bb.n, %.critedge2.i
  ...
  br label %select.unfold25.i, !llvm.loop !31
...
.critedge2.i:                                     ; preds = %..critedge2_crit_edge.i, %select.unfold25.i
  ...
  br i1 %i.ar, label %.lr.ph44, label %select.unfold25.i.backedge, !llvm.loop !31

bb.n:                                             ; preds = %.lr.ph44
  %i.as = add nsw i64 %i.au, -1
  %i.at = icmp sgt i64 %i.au, 1
  br i1 %i.at, label %.lr.ph44, label %select.unfold25.i.backedge, !llvm.loop !31
