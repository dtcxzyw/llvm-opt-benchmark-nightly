Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/linux/original/i915_gem_domain?download=true
inline.NumInlined: 101
inline.NumDeleted: 48
begin_hunk_0_@i915_gem_object_set_cache_level:bb.a
}
...
.preheader.i.i.i.i.i.i:                           ; preds = %bb.g, %raw_atomic_try_cmpxchg_relaxed.exit.i.i.i.i.i.i
  ...
  %i.aa = tail call { i8, i32 } asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgl $3, $1", "={@ccz},=*m,={ax},r,*m,2,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %i.x, i32 %i.z, ptr nonnull elementtype(i32) %i.x, i32 %.0.i.i.i.i.i.i) #8, !srcloc !17 ; 2 uses
  %i.ab = extractvalue { i8, i32 } %i.aa, 0       ; 2 uses
  %i.ac = icmp ult i8 %i.ab, 2
  tail call void @llvm.assume(i1 %i.ac)
  %i.ad = trunc nuw i8 %i.ab to i1
  br i1 %i.ad, label %raw_atomic_try_cmpxchg_relaxed.exit.thread.i.i.i.i.i.i, label %raw_atomic_try_cmpxchg_relaxed.exit.i.i.i.i.i.i, !prof !14

raw_atomic_try_cmpxchg_relaxed.exit.i.i.i.i.i.i:  ; preds = %.preheader.i.i.i.i.i.i
  %i.ae = extractvalue { i8, i32 } %i.aa, 1       ; 2 uses
  %i.af = icmp eq i32 %i.ae, 0
  br i1 %i.af, label %raw_atomic_try_cmpxchg_relaxed.exit.thread.i.i.i.i.i.i, label %.preheader.i.i.i.i.i.i, !llvm.loop !1
...
bb.n:                                             ; preds = %bb.m
  %i.as = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %i.x, i32 1, ptr nonnull elementtype(i32) %i.x) #8, !srcloc !12 ; 3 uses
  %.not.i.i.i.i.i.i.i.i = icmp eq i32 %i.as, 0
  br i1 %.not.i.i.i.i.i.i.i.i, label %.sink.split.i.i.i.i.i.i.i.i, label %bb.o, !prof !13

bb.o:                                             ; preds = %bb.n
  %i.at = add i32 %i.as, 1
  %i.au = or i32 %i.at, %i.as
  %.not10.i.i.i.i.i.i.i.i = icmp sgt i32 %i.au, -1
...
bb.q:                                             ; preds = %bb.p
  tail call void %i.ay(ptr noundef nonnull %i.x) #7, !inline_history !0
  br label %i915_gem_object_unlock.exit

i915_gem_object_unlock.exit:                      ; preds = %bb.p, %bb.q
  %i.az = load ptr, ptr %i.ap, align 8
  tail call void @ww_mutex_unlock(ptr noundef %i.az) #7
  br label %bb.r
...
bb.r:                                             ; preds = %bb.m, %i915_gem_object_lock_interruptible.exit.thread, %i915_gem_object_lookup.exit, %bb.k, %bb.l, %i915_gem_object_unlock.exit
  %.0 = phi i32 [ %i.av, %i915_gem_object_unlock.exit ], [ -6, %bb.l ], [ 0, %bb.k ], [ %i.ar, %bb.m ], [ -95, %i915_gem_object_lookup.exit ], [ -35, %i915_gem_object_lock_interruptible.exit.thread ] ; 3 uses
  %i.ba = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %i.x, i32 -1, ptr nonnull elementtype(i32) %i.x) #8, !srcloc !12 ; 2 uses
  %i.bb = icmp eq i32 %i.ba, 1
  br i1 %i.bb, label %bb.u, label %bb.s

bb.s:                                             ; preds = %bb.r
  %i.bc = icmp slt i32 %i.ba, 1
  br i1 %i.bc, label %bb.t, label %i915_gem_object_put.exit, !prof !13
...
bb.b:                                             ; preds = %bb.a
  %i.f = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %0, i32 1, ptr nonnull elementtype(i32) %0) #8, !srcloc !12 ; 3 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  tail call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock orb ${1:b},$0", "=*m,iq,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i8) %i.al, i32 2, ptr elementtype(i8) %i.al) #8, !srcloc !21
...
i915_gem_object_is_framebuffer.exit.thread.i:     ; preds = %i915_gem_object_is_framebuffer.exit.i, %bb.j
  tail call fastcc void @flush_write_domain(ptr noundef %0, i32 noundef -2) #9, !srcloc !15
