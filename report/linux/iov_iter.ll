...
define dso_local ptr @iovec_from_user(ptr noundef %0, i64 noundef %1, i64 noundef %2, ptr noundef %3, i1 noundef zeroext %4) local_unnamed_addr #0 align 16 prefalign(16) {
bb.a:
  %i.a = icmp eq i64 %1, 0
...
bb.c:                                             ; preds = %bb.b
  %i.c = icmp ugt i64 %1, %2
  br i1 %i.c, label %_kmalloc_noprof.exit, label %bb.d

_kmalloc_noprof.exit:                             ; preds = %bb.c
  %i.d = shl nuw nsw i64 %1, 4
  %i.e = tail call noalias align 8 ptr @__kmalloc_noprof(i64 noundef range(i64 0, 68719476721) %i.d, i32 noundef 3264) #17 ; 2 uses
  %.not = icmp eq ptr %i.e, null
  br i1 %.not, label %bb.l, label %bb.d

bb.d:                                             ; preds = %_kmalloc_noprof.exit, %bb.c
  %.027 = phi ptr [ %i.e, %_kmalloc_noprof.exit ], [ %3, %bb.c ] ; 5 uses
  br i1 %4, label %bb.e, label %__access_ok.exit.i, !prof !11

bb.e:                                             ; preds = %bb.d
  %i.f = trunc nuw nsw i64 %1 to i32
  %i.g = tail call fastcc i32 @copy_compat_iovec_from_user(ptr noundef %.027, ptr noundef %0, i32 noundef %i.f) #16, !srcloc !143
