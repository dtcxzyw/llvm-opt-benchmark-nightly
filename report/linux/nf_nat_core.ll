...
nf_ct_is_confirmed.exit:
  ...
  br i1 %.not, label %bb.a, label %bb.ca
...
bb.t:                                             ; preds = %.split.us._crit_edge.1, %bb.s
...
.split.us.2:                                      ; preds = %bb.t
  br i1 %spec.select.i.i.us.1, label %.split.us._crit_edge.2, label %bb.u
...
bb.v:                                             ; preds = %.split.us._crit_edge.2, %bb.u
  %i.fe = phi i32 [ %i.fa, %bb.u ], [ %.pre77.2, %.split.us._crit_edge.2 ]
  %.039.i.i.us.2 = phi i32 [ %i.ey, %bb.u ], [ 0, %.split.us._crit_edge.2 ]
  %.036.i.i.us.2 = phi i64 [ %i.fd, %bb.u ], [ 4294967295, %.split.us._crit_edge.2 ]
...
.split.us.3:                                      ; preds = %bb.v
  %.not46.i.i.us.2 = icmp ne i32 %i.fk, %i.fe
  %spec.select.i.i.us.2 = or i1 %spec.select.i.i.us.1, %.not46.i.i.us.2
  br i1 %spec.select.i.i.us.2, label %.split.us._crit_edge.3, label %bb.w

bb.w:                                             ; preds = %.split.us.3
...
.split.us._crit_edge.3:                           ; preds = %.split.us.3, %bb.w
  %.039.i.i.us.3 = phi i32 [ %i.fq, %bb.w ], [ 0, %.split.us.3 ]
  %.036.i.i.us.3 = phi i64 [ %i.fv, %bb.w ], [ 4294967295, %.split.us.3 ]
...
.split:                                           ; preds = %bb.r
  ...
  br i1 %i.be, label %find_best_ips_proto.exit.i, label %bb.x

bb.x:                                             ; preds = %.split
  br i1 %i.go, label %._crit_edge.1, label %bb.y
...
._crit_edge.1:                                    ; preds = %bb.x
  %.phi.trans.insert.1 = getelementptr i8, ptr %1, i64 24
  %.pre75.1 = load i32, ptr %.phi.trans.insert.1, align 4
  br label %bb.z

bb.z:                                             ; preds = %._crit_edge.1, %bb.y
  %i.gx = phi i32 [ %i.gt, %bb.y ], [ %.pre75.1, %._crit_edge.1 ]
  %.039.i.i.1 = phi i32 [ %i.gr, %bb.y ], [ 0, %._crit_edge.1 ]
  %.036.i.i.1 = phi i64 [ %i.gw, %bb.y ], [ 4294967295, %._crit_edge.1 ]
...
12:                                               ; preds = %bb.z
  br i1 %spec.select.i.i.1, label %._crit_edge.2, label %bb.aa
...
bb.ab:                                            ; preds = %._crit_edge.2, %bb.aa
  %i.hl = phi i32 [ %i.hh, %bb.aa ], [ %.pre75.2, %._crit_edge.2 ]
  %.039.i.i.2 = phi i32 [ %i.hf, %bb.aa ], [ 0, %._crit_edge.2 ]
  %.036.i.i.2 = phi i64 [ %i.hk, %bb.aa ], [ 4294967295, %._crit_edge.2 ]
...
13:                                               ; preds = %bb.ab
  ...
  br i1 %spec.select.i.i.2, label %._crit_edge.3, label %bb.ac
...
._crit_edge.3:                                    ; preds = %13, %bb.ac
  %.039.i.i.3 = phi i32 [ %i.ht, %bb.ac ], [ 0, %13 ]
  %.036.i.i.3 = phi i64 [ %i.hy, %bb.ac ], [ 4294967295, %13 ]
...
find_best_ips_proto.exit.i:                       ; preds = %.split, %bb.z, %bb.ab, %._crit_edge.3, %.split.us, %bb.t, %bb.v, %.split.us._crit_edge.3, %bb.o, %find_appropriate_src.exit.thread.i
  %i.ie = and i32 %i.au, 20
  %.not43.i = icmp eq i32 %i.ie, 0
  br i1 %.not43.i, label %bb.ad, label %l4proto_in_range.exit.thread.i

bb.ad:                                            ; preds = %find_best_ips_proto.exit.i
  %i.if = and i32 %i.au, 2
  %.not44.i = icmp eq i32 %i.if, 0
  br i1 %.not44.i, label %bb.aj, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.ig = and i32 %i.au, 32
  %.not46.i = icmp eq i32 %i.ig, 0
  br i1 %.not46.i, label %bb.af, label %l4proto_in_range.exit.thread.i
...
.l4proto_in_range.exit.thread61_crit_edge.i:      ; preds = %bb.af
...
bb.ah:                                            ; preds = %bb.af, %bb.af, %bb.af, %bb.af
...
l4proto_in_range.exit.i:                          ; preds = %bb.ah, %bb.ag
  %i.it = phi i16 [ %i.io, %bb.ag ], [ %i.ir, %bb.ah ]
  %.sink.i.i = phi i16 [ %i.in, %bb.ag ], [ %i.iq, %bb.ah ]
...
l4proto_in_range.exit.thread61.i:                 ; preds = %l4proto_in_range.exit.i, %.l4proto_in_range.exit.thread61_crit_edge.i
  ...
  br i1 %i.iy, label %get_unique_tuple.exit, label %bb.ai

bb.ai:                                            ; preds = %l4proto_in_range.exit.thread61.i
...
l4proto_in_range.exit.thread.i:                   ; preds = %bb.aj, %bb.ai, %l4proto_in_range.exit.i, %bb.ah, %bb.ag, %bb.ae, %find_best_ips_proto.exit.i
...
bb.am:                                            ; preds = %l4proto_in_range.exit.thread.i, %l4proto_in_range.exit.thread.i, %l4proto_in_range.exit.thread.i
  ...
  br i1 %.not.i51.i, label %bb.an, label %bb.aq

bb.an:                                            ; preds = %bb.am
  %i.jt = icmp eq i32 %2, 1
  br i1 %i.jt, label %get_unique_tuple.exit, label %bb.ao
...
bb.ao:                                            ; preds = %bb.an
  ...
  br i1 %i.jw, label %bb.ap, label %bb.at
...
bb.aq:                                            ; preds = %bb.am
  ...
  br i1 %i.kg, label %bb.ar, label %bb.as, !prof !10

bb.ar:                                            ; preds = %bb.aq
  br label %bb.as

bb.as:                                            ; preds = %bb.ar, %bb.aq
  %.055.i.i = phi i32 [ %i.kf, %bb.ar ], [ %i.kb, %bb.aq ] ; 2 uses
  %.054.i.i = phi i32 [ %i.kb, %bb.ar ], [ %i.kf, %bb.aq ]
  %reass.sub68 = sub nsw i32 %.054.i.i, %.055.i.i
  %i.kh = add nsw i32 %reass.sub68, 1
  br label %bb.at

bb.at:                                            ; preds = %bb.as, %bb.ap, %bb.ao, %bb.al, %bb.ak
  %i.ki = phi i32 [ %i.jg, %bb.al ], [ %i.jg, %bb.ak ], [ %i.jr, %bb.as ], [ %i.jr, %bb.ap ], [ %i.jr, %bb.ao ] ; 2 uses
  %.156.i.i = phi i32 [ %i.jl, %bb.al ], [ 0, %bb.ak ], [ %.055.i.i, %bb.as ], [ %..i57.i, %bb.ap ], [ 1024, %bb.ao ]
  %.151.i.i = phi ptr [ %i.jf, %bb.al ], [ %i.jf, %bb.ak ], [ %.050.v.i.i.sroa.sel.v.sroa.sel.v.sroa.sel, %bb.as ], [ %.050.v.i.i.sroa.sel.v.sroa.sel.v.sroa.sel, %bb.ap ], [ %.050.v.i.i.sroa.sel.v.sroa.sel.v.sroa.sel, %bb.ao ] ; 2 uses
  %.0.i53.i = phi i32 [ %i.jq, %bb.al ], [ 65536, %bb.ak ], [ %i.kh, %bb.as ], [ %.65.i.i, %bb.ap ], [ 64512, %bb.ao ] ; 4 uses
  %i.kj = and i32 %i.ki, 32
  %.not63.i.i = icmp eq i32 %i.kj, 0
  br i1 %.not63.i.i, label %bb.av, label %bb.au
...
bb.av:                                            ; preds = %bb.at
  ...
  br i1 %or.cond.i.i, label %bb.aw, label %bb.ax
...
bb.ax:                                            ; preds = %bb.aw, %bb.av, %bb.au
  %.049.i.i = phi i16 [ %i.kp, %bb.au ], [ %i.kt, %bb.aw ], [ 0, %bb.av ]
...
.lr.ph.i54.preheader.preheader.i:                 ; preds = %bb.ax
