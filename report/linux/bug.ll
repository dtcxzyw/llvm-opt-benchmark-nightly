...
._crit_edge.i.i:                                  ; preds = %bb.e, %.lr.ph32.i.i
  ...
  br i1 %.not.i.i, label %module_find_bug.exit.i, label %.lr.ph32.i.i, !llvm.loop !2
...
bb.a:
  tail call void asm "incl %gs:$0", "=*m,*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) @__preempt_count, ptr nonnull elementtype(i32) @__preempt_count) #12, !srcloc !15
  tail call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #12, !srcloc !16
  %i.a = tail call i64 asm "movq %gs:$1, $0", "=r,*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i64) @this_cpu_off) #13, !srcloc !17
...
bb.b:                                             ; preds = %bb.a
  %i.g = tail call i64 asm "movq %gs:$1, $0", "=r,*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i64) @this_cpu_off) #13, !srcloc !18
  %i.h = add i64 %i.g, ptrtoint (ptr @context_tracking to i64)
  %i.i = inttoptr i64 %i.h to ptr                 ; 2 uses
  %i.j = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.i, i32 4, ptr elementtype(i32) %i.i) #12, !srcloc !19 ; 0 uses
  %i.k = tail call fastcc i32 @__report_bug(ptr noundef null, i64 noundef %0, ptr noundef %1) #14, !srcloc !28
  %i.l = tail call i64 asm "movq %gs:$1, $0", "=r,*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i64) @this_cpu_off) #13, !srcloc !18
  %i.m = add i64 %i.l, ptrtoint (ptr @context_tracking to i64)
  %i.n = inttoptr i64 %i.m to ptr                 ; 2 uses
  %i.o = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.n, i32 4, ptr elementtype(i32) %i.n) #12, !srcloc !19 ; 0 uses
  br label %bb.c
...
bb.c:                                             ; preds = %warn_rcu_enter.exit, %bb.b
  ...
  %i.q = tail call i8 asm sideeffect "decl %gs:$0", "=*m,={@cce},*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) @__preempt_count, ptr nonnull elementtype(i32) @__preempt_count) #12, !srcloc !21 ; 2 uses
  %i.r = icmp ult i8 %i.q, 2
  tail call void @llvm.assume(i1 %i.r)
  %i.s = trunc nuw i8 %i.q to i1
  br i1 %i.s, label %bb.d, label %warn_rcu_exit.exit, !prof !22

bb.d:                                             ; preds = %bb.c
  %i.t = tail call i64 @llvm.read_register.i64(metadata !3)
  %i.u = tail call i64 asm sideeffect "call __SCT__preempt_schedule_notrace", "={rsp},{rsp},~{dirflag},~{fpsr},~{flags}"(i64 %i.t) #12, !srcloc !23
  tail call void @llvm.write_register.i64(metadata !3, i64 %i.u)
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  br i1 %i.m, label %.lr.ph.i, label %clear_once_table.exit, !llvm.loop !30
...
.lr.ph.i12:                                       ; preds = %._crit_edge, %.lr.ph.i12
  ...
  br i1 %i.t, label %.lr.ph.i12, label %clear_once_table.exit14, !llvm.loop !30
...
!17 = !{i64 2156037728}
!18 = !{i64 2156040489}
!19 = !{i64 2148946578, i64 2148946617, i64 2148946638, i64 2148946675, i64 2148946698, i64 2148946707}
!20 = !{i64 2156043785}
!21 = !{i64 2149930141}
