...
bb.b:                                             ; preds = %.lr.ph
  ...
  br i1 %.not.i.i.i.i, label %.sink.split.i.i.i.i, label %bb.c, !prof !17

bb.c:                                             ; preds = %bb.b
  %i.h = add i32 %i.g, 1
  %i.i = or i32 %i.h, %i.g
  %.not10.i.i.i.i = icmp sgt i32 %i.i, -1
  br i1 %.not10.i.i.i.i, label %in6_ifa_hold.exit, label %.sink.split.i.i.i.i, !prof !22
...
in6_ifa_hold.exit:                                ; preds = %bb.c, %.sink.split.i.i.i.i
  ...
  tail call fastcc void @ipv6_del_addr(ptr noundef %.027) #19, !srcloc !162
  tail call void @_raw_write_lock_bh(ptr noundef %i.a) #18
  br label %bb.d
...
select.unfold._crit_edge.i:                       ; preds = %select.unfold.i, %bb.c
  ...
  %i.s = trunc i64 %indvars.iv.next.i to i32      ; 2 uses
  store i32 %i.s, ptr %i.d, align 8
  %exitcond13.not.i = icmp eq i32 %i.s, 256
  br i1 %exitcond13.not.i, label %if6_get_first.exit, label %bb.c, !llvm.loop !163
...
bb.d:                                             ; preds = %.lr.ph
  ...
  br i1 %i.n, label %.lr.ph, label %if6_get_next.exit, !llvm.loop !164
...
.lr.ph:                                           ; preds = %bb.c, %bb.d
  ...
  br i1 %.not36.i, label %bb.d, label %.if6_get_next.exit.loopexit_crit_edge, !llvm.loop !164

.if6_get_next.exit.loopexit_crit_edge:            ; preds = %.lr.ph
  br label %if6_get_next.exit, !llvm.loop !164
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %i.y, label %bb.e, label %ipv6_store_devconf.exit, !prof !17

bb.e:                                             ; preds = %bb.d
  call void asm sideeffect "1449: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 1449b - ., 3; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 1449) #20, !srcloc !166
  call void asm sideeffect "1:\09 ud2 \0A.pushsection __bug_table,\22aw\22\0A\09912: .pushsection .discard.annotate_data, \22M\22, @progbits, 8; .long 912b - ., 1; .popsection\0A\092:\0A\09\09.long 1b - .\09# bug_entry::bug_addr\0A\09.long ${0:c} - .\09# bug_entry::format\0A\09.long ${1:c} - .\09# bug_entry::file\0A\09.word ${2:c}\09# bug_entry::line\0A\09.word ${3:c}\09# bug_entry::flags\0A\09.org 2b + ${4:c}\0A.popsection\0A", "i,i,i,i,i,~{dirflag},~{fpsr},~{flags}"(ptr nonnull @.str, ptr nonnull @.str.1, i32 5665, i32 0, i64 16) #20, !srcloc !167
  unreachable
