...
select.unfold:                                    ; preds = %bb.d, %drm_vma_node_unmap.exit
  ...
  br i1 %.not28, label %.critedge, label %bb.d, !llvm.loop !38
...
bb.d:                                             ; preds = %bb.c, %bb.b, %bb.a
  ...
  %i.k = tail call fastcc i32 @__assign_mmap_offset_handle(ptr noundef %0, i32 noundef %2, i32 noundef %.0, ptr noundef %3) #13, !srcloc !39
  br label %bb.e
...
.preheader.i.i.i.i.i.i:                           ; preds = %bb.b, %arch_atomic_try_cmpxchg.exit.i.i.i.i.i.i
  ...
  %i.f = tail call { i8, i32 } asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgl $3, $1", "={@ccz},=*m,={ax},r,*m,2,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %i.c, i32 %i.e, ptr nonnull elementtype(i32) %i.c, i32 %.0.i.i.i.i.i.i) #11, !srcloc !13 ; 2 uses
  %i.g = extractvalue { i8, i32 } %i.f, 0         ; 2 uses
  %i.h = icmp ult i8 %i.g, 2
  tail call void @llvm.assume(i1 %i.h)
  %i.i = trunc nuw i8 %i.g to i1
  br i1 %i.i, label %arch_atomic_try_cmpxchg.exit.thread.i.i.i.i.i.i, label %arch_atomic_try_cmpxchg.exit.i.i.i.i.i.i, !prof !14

arch_atomic_try_cmpxchg.exit.i.i.i.i.i.i:         ; preds = %.preheader.i.i.i.i.i.i
  %i.j = extractvalue { i8, i32 } %i.f, 1         ; 2 uses
  %i.k = icmp eq i32 %i.j, 0
  br i1 %i.k, label %arch_atomic_try_cmpxchg.exit.thread.i.i.i.i.i.i, label %.preheader.i.i.i.i.i.i, !llvm.loop !0
...
i915_gem_object_lookup.exit:                      ; preds = %kref_get_unless_zero.exit.i.i
  ...
  %i.p = tail call i32 @ww_mutex_lock_interruptible(ptr noundef %i.o, ptr noundef null) #10 ; 2 uses
...
bb.d:                                             ; preds = %i915_gem_object_lookup.exit
  %i.q = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %i.c, i32 1, ptr nonnull elementtype(i32) %i.c) #11, !srcloc !17 ; 3 uses
  %.not.i.i.i.i.i.i19.i.i = icmp eq i32 %i.q, 0
  br i1 %.not.i.i.i.i.i.i19.i.i, label %.sink.split.i.i.i.i.i.i21.i.i, label %bb.e, !prof !16

bb.e:                                             ; preds = %bb.d
  %i.r = add i32 %i.q, 1
  %i.s = or i32 %i.r, %i.q
  %.not10.i.i.i.i.i.i20.i.i = icmp sgt i32 %i.s, -1
...
bb.f:                                             ; preds = %i915_gem_object_lookup.exit, %i915_gem_object_lookup.exit
  %i.t = getelementptr i8, ptr %i.c, i64 480      ; 2 uses
  %.val21.i = load ptr, ptr %i.t, align 8         ; 2 uses
  %.val21.val.i = load i32, ptr %.val21.i, align 8
  %i.u = and i32 %.val21.val.i, 16
  %.not22.i = icmp eq i32 %i.u, 0
  br i1 %.not22.i, label %bb.g, label %__assign_mmap_offset.exit

bb.g:                                             ; preds = %bb.f
  %i.v = getelementptr i8, ptr %.val21.i, i64 56
...
bb.i:                                             ; preds = %bb.h
  %i.x = tail call i64 %i.w(ptr noundef nonnull %i.c) #10, !inline_history !40
...
bb.k:                                             ; preds = %bb.j
  %i.y = tail call zeroext i1 @i915_gem_object_has_struct_page(ptr noundef nonnull %i.c) #10
  br i1 %i.y, label %bb.m, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.z = tail call zeroext i1 @i915_gem_object_has_iomem(ptr noundef nonnull %i.c) #10
  br i1 %i.z, label %bb.m, label %__assign_mmap_offset.exit

bb.m:                                             ; preds = %bb.l, %bb.k, %bb.j
  %i.aa = tail call fastcc ptr @mmap_offset_attach(ptr noundef nonnull %i.c, i32 noundef range(i32 0, 5) %2, ptr noundef %0) #13, !srcloc !41 ; 3 uses
...
bb.o:                                             ; preds = %bb.m
  ...
  %.val.i = load i64, ptr %i.ae, align 8
  %i.af = shl i64 %.val.i, 12
  store i64 %i.af, ptr %3, align 8
  br label %__assign_mmap_offset.exit

__assign_mmap_offset.exit:                        ; preds = %bb.f, %bb.h, %bb.i, %bb.j, %bb.l, %bb.n, %bb.o
  %.0.i = phi i32 [ -19, %bb.j ], [ -19, %bb.f ], [ 0, %bb.i ], [ -19, %bb.h ], [ %i.ad, %bb.n ], [ 0, %bb.o ], [ -19, %bb.l ]
  %i.ag = load ptr, ptr %i.t, align 8
  %i.ah = getelementptr i8, ptr %i.ag, i64 80
  %i.ai = load ptr, ptr %i.ah, align 8            ; 2 uses
  %.not.i16 = icmp eq ptr %i.ai, null
  br i1 %.not.i16, label %i915_gem_object_unlock.exit, label %bb.p

bb.p:                                             ; preds = %__assign_mmap_offset.exit
  tail call void %i.ai(ptr noundef nonnull %i.c) #10, !inline_history !2
...
i915_gem_object_unlock.exit:                      ; preds = %__assign_mmap_offset.exit, %bb.p
  ...
  tail call void @ww_mutex_unlock(ptr noundef %i.aj) #10
  br label %bb.q
...
bb.q:                                             ; preds = %i915_gem_object_lookup.exit, %i915_gem_object_lock_interruptible.exit.thread, %i915_gem_object_unlock.exit
  ...
  %i.ak = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %i.c, i32 -1, ptr nonnull elementtype(i32) %i.c) #11, !srcloc !17 ; 2 uses
  %i.al = icmp eq i32 %i.ak, 1
  br i1 %i.al, label %bb.t, label %bb.r

bb.r:                                             ; preds = %bb.q
  %i.am = icmp slt i32 %i.ak, 1
  br i1 %i.am, label %bb.s, label %i915_gem_object_put.exit, !prof !16
...
bb.g:                                             ; preds = %bb.e, %bb.b, %bb.d, %bb.c, %bb.f
  ...
  %i.o = tail call fastcc i32 @__assign_mmap_offset_handle(ptr noundef %2, i32 noundef %i.m, i32 noundef %.012, ptr noundef %i.n) #13, !srcloc !42
  br label %bb.h
...
begin_hunk_1_@mmap_offset_attach:bb.a
  %i.aq = tail call i32 @drm_vma_node_allow_once(ptr noundef %.036, ptr noundef nonnull %2) #10 ; 0 uses
  br label %bb.m
...
bb.m:                                             ; preds = %bb.c, %insert_mmo.exit, %bb.k, %bb.l
  %.0 = phi ptr [ %.036, %insert_mmo.exit ], [ %i.as, %bb.l ], [ %.036, %bb.k ], [ inttoptr (i64 -12 to ptr), %bb.c ]
  ret ptr %.0
}
...
bb.a:
  ...
  %i.d = tail call ptr asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgq $2, $1", "={ax},=*m,r,0,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i64) %i.c, ptr null, ptr %1, ptr elementtype(i64) %i.c) #11, !srcloc !47 ; 0 uses
...
bb.a:
  ...
  %i.e = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.d, i32 1, ptr elementtype(i32) %i.d) #11, !srcloc !17 ; 3 uses
  %.not.i.i.i.i.i.i = icmp eq i32 %i.e, 0
  br i1 %.not.i.i.i.i.i.i, label %.sink.split.i.i.i.i.i.i, label %bb.b, !prof !16

bb.b:                                             ; preds = %bb.a
  %i.f = add i32 %i.e, 1
  %i.g = or i32 %i.f, %i.e
  %.not10.i.i.i.i.i.i = icmp sgt i32 %i.g, -1
  br i1 %.not10.i.i.i.i.i.i, label %i915_gem_object_get.exit, label %.sink.split.i.i.i.i.i.i, !prof !14
...
bb.a:
  ...
  %i.e = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.d, i32 -1, ptr elementtype(i32) %i.d) #11, !srcloc !17 ; 2 uses
  %i.f = icmp eq i32 %i.e, 1
  br i1 %i.f, label %bb.d, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.g = icmp slt i32 %i.e, 1
  br i1 %i.g, label %bb.c, label %i915_gem_object_put.exit, !prof !16
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %.not36, label %.critedge, label %i915_error_to_vmf_fault.exit, !prof !14

.critedge:                                        ; preds = %bb.a, %bb.b
  %i.k = getelementptr i8, ptr %i.e, i64 248      ; 2 uses
  %i.l = load ptr, ptr %i.k, align 8
  %i.m = tail call i32 @ww_mutex_lock_interruptible(ptr noundef %i.l, ptr noundef null) #10
  switch i32 %i.m, label %i915_error_to_vmf_fault.exit [
    i32 -35, label %bb.c
    i32 0, label %bb.e
    i32 -114, label %bb.e
  ]
...
bb.c:                                             ; preds = %.critedge
  %i.n = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.e, i32 1, ptr elementtype(i32) %i.e) #11, !srcloc !17 ; 3 uses
  %.not.i.i.i.i.i.i19.i.i = icmp eq i32 %i.n, 0
  br i1 %.not.i.i.i.i.i.i19.i.i, label %.sink.split.i.i.i.i.i.i21.i.i, label %bb.d, !prof !16
...
bb.e:                                             ; preds = %.critedge, %.critedge
  %i.q = getelementptr i8, ptr %i.e, i64 688      ; 5 uses
  %i.r = load volatile i32, ptr %i.q, align 8     ; 2 uses
  %i.s = icmp eq i32 %i.r, 0
  br i1 %i.s, label %i915_gem_object_pin_pages.exit, label %.lr.ph.i, !prof !24

.lr.ph.i:                                         ; preds = %bb.e, %raw_atomic_try_cmpxchg.exit.i
  %.047.i = phi i32 [ %i.y, %raw_atomic_try_cmpxchg.exit.i ], [ %i.r, %bb.e ] ; 2 uses
  %i.t = add i32 %.047.i, 1
  %i.u = tail call { i8, i32 } asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgl $3, $1", "={@ccz},=*m,={ax},r,*m,2,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.q, i32 range(i32 2, 1) %i.t, ptr elementtype(i32) %i.q, i32 %.047.i) #11, !srcloc !13 ; 2 uses
  %i.v = extractvalue { i8, i32 } %i.u, 0         ; 2 uses
  %i.w = icmp ult i8 %i.v, 2
  tail call void @llvm.assume(i1 %i.w)
  %i.x = trunc nuw i8 %i.v to i1
  br i1 %i.x, label %i915_gem_object_pin_pages.exit.thread, label %raw_atomic_try_cmpxchg.exit.i, !prof !14

raw_atomic_try_cmpxchg.exit.i:                    ; preds = %.lr.ph.i
  %i.y = extractvalue { i8, i32 } %i.u, 1         ; 2 uses
  %i.z = icmp eq i32 %i.y, 0
  br i1 %i.z, label %i915_gem_object_pin_pages.exit, label %.lr.ph.i, !prof !25
...
bb.i:                                             ; preds = %bb.h, %bb.g
  tail call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock decl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.q, ptr elementtype(i32) %i.q) #11, !srcloc !26
  br label %bb.j
...
bb.k:                                             ; preds = %bb.j
  tail call void %i.be(ptr noundef %i.e) #10, !inline_history !2
  br label %i915_gem_object_unlock.exit
...
bb.l:                                             ; preds = %i915_gem_object_unlock.exit
  ...
  tail call void asm sideeffect "", "~{dirflag},~{fpsr},~{flags}"() #11, !srcloc !28
  br label %i915_error_to_vmf_fault.exit
...
bb.d:                                             ; preds = %bb.q, %bb.c
  %i.x = load i8, ptr %i.q, align 8, !range !29, !noundef !30
...
bb.h:                                             ; preds = %bb.g
  %i.ac = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.d, i32 1, ptr elementtype(i32) %i.d) #11, !srcloc !17 ; 3 uses
  %.not.i.i.i.i.i.i.i.i = icmp eq i32 %i.ac, 0
  br i1 %.not.i.i.i.i.i.i.i.i, label %.sink.split.i.i.i.i.i.i.i.i, label %bb.i, !prof !16
...
bb.j:                                             ; preds = %bb.g, %i915_gem_object_get.exit.i.i
  %i.ag = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.d, i32 1, ptr elementtype(i32) %i.d) #11, !srcloc !17 ; 3 uses
  %.not.i.i.i.i.i.i19.i7.i = icmp eq i32 %i.ag, 0
  br i1 %.not.i.i.i.i.i.i19.i7.i, label %.sink.split.i.i.i.i.i.i21.i9.i, label %bb.k, !prof !16

bb.k:                                             ; preds = %bb.j
  %i.ah = add i32 %i.ag, 1
  %i.ai = or i32 %i.ah, %i.ag
  %.not10.i.i.i.i.i.i20.i8.i = icmp sgt i32 %i.ai, -1
  br i1 %.not10.i.i.i.i.i.i20.i8.i, label %.thread51, label %.sink.split.i.i.i.i.i.i21.i9.i, !prof !14
...
bb.l:                                             ; preds = %bb.g, %i915_gem_object_get.exit.i.i, %i915_gem_object_get.exit.i.i
...
.thread.thread:                                   ; preds = %bb.n, %bb.o
  ...
  call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock decl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.am, ptr elementtype(i32) %i.am) #11, !srcloc !26
...
.thread:                                          ; preds = %bb.g, %i915_gem_object_get.exit.i.i, %bb.p
  %.1 = phi i32 [ %.0.i.i, %i915_gem_object_get.exit.i.i ], [ %i.ao, %bb.p ], [ %.0.i.i, %bb.g ]
...
bb.a:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %1, i8 0, i64 56, i1 false), !annotation !23
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #11
  store i32 0, ptr %i.a, align 4, !annotation !23
  ...
  callbr void asm sideeffect "1: jmp ${2:l} # objtool NOPs this \0A\09.pushsection __jump_table,  \22aw\22 \0A\09 .balign 8 \0A\09912: .pushsection .discard.annotate_data, \22M\22, @progbits, 8; .long 912b - ., 1; .popsection\0A.long 1b - . \0A\09.long ${2:l} - . \0A\09 .quad  ${0:c} + ${1:c} + 2 - . \0A\09.popsection \0A\09", "i,i,!i,~{dirflag},~{fpsr},~{flags}"(ptr nonnull getelementptr inbounds nuw (i8, ptr @__tracepoint_i915_gem_object_fault, i64 8), i1 false) #11
          to label %trace_i915_gem_object_fault.exit [label %cpumask_test_cpu.exit.i.i], !srcloc !19

cpumask_test_cpu.exit.i.i:                        ; preds = %bb.a
  %i.aa = tail call i32 asm sideeffect "movl %gs:$1, $0", "=r,*m,~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) @cpu_number) #11, !srcloc !50
  %i.ab = zext i32 %i.aa to i64
  %i.ac = tail call i8 asm sideeffect " btq  $2,$1", "={@ccc},*m,Ir,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i64) @__cpu_online_mask, i64 range(i64 0, 4294967296) %i.ab) #11, !srcloc !51 ; 2 uses
...
bb.b:                                             ; preds = %cpumask_test_cpu.exit.i.i
  ...
  tail call void asm sideeffect "incq %gs:$0", "=*m,*m,~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i64) %i.af, ptr elementtype(i64) %i.af) #11, !srcloc !52
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  tail call void asm sideeffect "incq %gs:$0", "=*m,*m,~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i64) %i.ak, ptr elementtype(i64) %i.ak) #11, !srcloc !55
...
bb.e:                                             ; preds = %bb.ap, %trace_i915_gem_object_fault.exit
  %i.bl = load i8, ptr %i.am, align 8, !range !29, !noundef !30
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  switch i32 %.0.i.i, label %.thread140 [
    i32 0, label %bb.i
    i32 -35, label %bb.k
    i32 -114, label %bb.m
  ]
...
bb.i:                                             ; preds = %bb.h
  %i.bq = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.f, i32 1, ptr elementtype(i32) %i.f) #11, !srcloc !17 ; 3 uses
  %.not.i.i.i.i.i.i.i.i = icmp eq i32 %i.bq, 0
  br i1 %.not.i.i.i.i.i.i.i.i, label %.sink.split.i.i.i.i.i.i.i.i, label %bb.j, !prof !16
...
bb.k:                                             ; preds = %bb.h, %i915_gem_object_get.exit.i.i
  %i.bu = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.f, i32 1, ptr elementtype(i32) %i.f) #11, !srcloc !17 ; 3 uses
  %.not.i.i.i.i.i.i19.i7.i = icmp eq i32 %i.bu, 0
  br i1 %.not.i.i.i.i.i.i19.i7.i, label %.sink.split.i.i.i.i.i.i21.i9.i, label %bb.l, !prof !16

bb.l:                                             ; preds = %bb.k
  %i.bv = add i32 %i.bu, 1
  %i.bw = or i32 %i.bv, %i.bu
  %.not10.i.i.i.i.i.i20.i8.i = icmp sgt i32 %i.bw, -1
  br i1 %.not10.i.i.i.i.i.i20.i8.i, label %.thread142, label %.sink.split.i.i.i.i.i.i21.i9.i, !prof !14
...
bb.m:                                             ; preds = %bb.h, %i915_gem_object_get.exit.i.i, %i915_gem_object_get.exit.i.i
...
bb.n:                                             ; preds = %bb.m
  ...
  br i1 %i.ca, label %i915_gem_object_pin_pages.exit, label %.lr.ph.i, !prof !24
...
.lr.ph.i:                                         ; preds = %bb.n, %raw_atomic_try_cmpxchg.exit.i
  ...
  %i.cc = call { i8, i32 } asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgl $3, $1", "={@ccz},=*m,={ax},r,*m,2,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.at, i32 range(i32 2, 1) %i.cb, ptr elementtype(i32) %i.at, i32 %.047.i) #11, !srcloc !13 ; 2 uses
  %i.cd = extractvalue { i8, i32 } %i.cc, 0       ; 2 uses
  %i.ce = icmp ult i8 %i.cd, 2
  call void @llvm.assume(i1 %i.ce)
  %i.cf = trunc nuw i8 %i.cd to i1
  br i1 %i.cf, label %i915_gem_object_pin_pages.exit.thread, label %raw_atomic_try_cmpxchg.exit.i, !prof !14

raw_atomic_try_cmpxchg.exit.i:                    ; preds = %.lr.ph.i
  %i.cg = extractvalue { i8, i32 } %i.cc, 1       ; 2 uses
  %i.ch = icmp eq i32 %i.cg, 0
  br i1 %i.ch, label %i915_gem_object_pin_pages.exit, label %.lr.ph.i, !prof !25
...
bb.q:                                             ; preds = %bb.p
  ...
  %.val.i = load i32, ptr %i.av, align 8, !noalias !56 ; 2 uses
...
bb.s:                                             ; preds = %bb.r, %bb.q
  ...
  store i32 12, ptr %2, align 4, !alias.scope !56
  %i.cw = zext nneg i32 %.0.i116 to i64           ; 2 uses
  %i.cx = urem i64 %i.z, %i.cw
  %i.cy = sub nuw i64 %i.z, %i.cx                 ; 2 uses
  store i64 %i.cy, ptr %i.aw, align 4, !alias.scope !56
  %i.cz = load i64, ptr %i.ax, align 8, !noalias !56
