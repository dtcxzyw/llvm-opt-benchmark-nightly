...
begin_hunk_0_@efi_adjust_memory_range_protection:bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #5
  %i.e = and i64 %0, -4096                        ; 5 uses
  %i.f = add i64 %1, %0                           ; 3 uses
  %i.g = add i64 %i.f, 4095
  %i.h = and i64 %i.g, -4096                      ; 3 uses
  %i.i = load ptr, ptr @memattr, align 8          ; 5 uses
  %.not = icmp eq ptr %i.i, null
  br i1 %.not, label %bb.i, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.j = load i8, ptr @efi_is64, align 1, !range !4, !noundef !5
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.n = sub i64 %i.h, %i.e                       ; 2 uses
  %i.o = tail call win64cc i64 %i.m(ptr noundef nonnull %i.i, i64 noundef %i.e, i64 noundef %i.n, i64 noundef 131072) #6 ; 2 uses
  %.not88 = icmp eq i64 %i.o, 0
...
.thread:                                          ; preds = %bb.b
  ...
  %i.r = and i64 %0, 4294963200                   ; 2 uses
  %i.s = lshr i64 %0, 32                          ; 2 uses
  %i.t = sub i64 %i.h, %i.e                       ; 2 uses
  %i.u = and i64 %i.t, 4294963200                 ; 2 uses
  %i.v = lshr i64 %i.t, 32                        ; 2 uses
  %i.w = call i64 (i32, ...) @__efi64_thunk(i32 noundef %i.q, ptr noundef nonnull %i.i, i64 noundef %i.r, i64 noundef %i.s, i64 noundef %i.u, i64 noundef %i.v, i64 noundef 131072, i64 noundef 0, ptr noundef nonnull %i.a) #6
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #5
  %i.x = trunc i64 %i.w to i32                    ; 3 uses
  %i.y = call noundef i32 @llvm.fshl.i32(i32 %i.x, i32 %i.x, i32 1)
  %i.z = zext i32 %i.y to i64                     ; 2 uses
  %i.aa = call range(i64 0, -9223372034707292160) i64 @llvm.fshl.i64(i64 range(i64 0, 4294967296) %i.z, i64 range(i64 0, 4294967296) %i.z, i64 63)
  %.not8890 = icmp eq i32 %i.x, 0
  br i1 %.not8890, label %bb.f, label %bb.d

bb.d:                                             ; preds = %.thread, %bb.c
  %i.ab = phi i64 [ %i.aa, %.thread ], [ %i.o, %bb.c ]
  %i.ac = call i32 (ptr, ...) @efi_printk(ptr noundef nonnull @.str) #6 ; 0 uses
  br label %.loopexit

bb.e:                                             ; preds = %bb.c
  %i.ad = load ptr, ptr @memattr, align 8         ; 2 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 16
  %i.af = load ptr, ptr %i.ae, align 8
  %i.ag = tail call win64cc i64 %i.af(ptr noundef %i.ad, i64 noundef %i.e, i64 noundef %i.n, i64 noundef 16384) #6
  br label %bb.g

bb.f:                                             ; preds = %.thread
  %i.ah = load ptr, ptr @memattr, align 8         ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #5
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ah, i64 8
  %i.aj = load i32, ptr %i.ai, align 8
  %i.ak = call i64 (i32, ...) @__efi64_thunk(i32 noundef %i.aj, ptr noundef %i.ah, i64 noundef %i.r, i64 noundef %i.s, i64 noundef %i.u, i64 noundef %i.v, i64 noundef 16384, i64 noundef 0, ptr noundef nonnull %i.b) #6
...
bb.g:                                             ; preds = %bb.f, %bb.e
  %i.ap = phi i64 [ %i.ag, %bb.e ], [ %i.ao, %bb.f ] ; 2 uses
  %.not89 = icmp eq i64 %i.ap, 0
  br i1 %.not89, label %.loopexit, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.aq = call i32 (ptr, ...) @efi_printk(ptr noundef nonnull @.str.1) #6 ; 0 uses
  br label %.loopexit

bb.i:                                             ; preds = %bb.a
  %i.ar = load ptr, ptr @efi_dxe_table, align 8
  %i.as = icmp ne ptr %i.ar, null
  %i.at = icmp ult i64 %0, %i.f
  %or.cond = and i1 %i.as, %i.at
  br i1 %or.cond, label %.lr.ph, label %.loopexit

.lr.ph:                                           ; preds = %bb.i
  %i.au = load i8, ptr @efi_is64, align 1, !range !4, !noundef !5
...
bb.j:                                             ; preds = %.lr.ph, %bb.u
  %.08294 = phi i64 [ %0, %.lr.ph ], [ %i.bq, %bb.u ] ; 3 uses
  br i1 %i.av, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.az = load ptr, ptr @efi_dxe_table, align 8
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 56
  %i.bb = load ptr, ptr %i.ba, align 8
  %i.bc = call win64cc i64 %i.bb(i64 noundef %.08294, ptr noundef nonnull %2) #6
  br label %bb.m

bb.l:                                             ; preds = %bb.j
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #5
  %i.bd = load ptr, ptr @efi_dxe_table, align 8
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 40
  %i.bf = load i32, ptr %i.be, align 8
  %i.bg = and i64 %.08294, 4294967295
  %i.bh = lshr i64 %.08294, 32
  %i.bi = call i64 (i32, ...) @__efi64_thunk(i32 noundef %i.bf, i64 noundef %i.bg, i64 noundef %i.bh, ptr noundef nonnull %2, ptr noundef nonnull %i.c) #6
...
bb.m:                                             ; preds = %bb.l, %bb.k
  %i.bn = phi i64 [ %i.bc, %bb.k ], [ %i.bm, %bb.l ]
  %.not86 = icmp eq i64 %i.bn, 0
  br i1 %.not86, label %bb.n, label %.loopexit

bb.n:                                             ; preds = %bb.m
  %i.bo = load i64, ptr %2, align 8               ; 2 uses
  %i.bp = load i64, ptr %i.aw, align 8
  %i.bq = add i64 %i.bp, %i.bo                    ; 3 uses
  %i.br = load i32, ptr %i.ax, align 8
  switch i32 %i.br, label %bb.u [
    i32 5, label %bb.o
    i32 2, label %bb.o
  ]
...
bb.o:                                             ; preds = %bb.n, %bb.n
  ...
  %i.bt = and i64 %i.bs, 147456
  %i.bu = icmp eq i64 %i.bt, 0
  br i1 %i.bu, label %bb.u, label %bb.p

bb.p:                                             ; preds = %bb.o
  %i.bv = call i64 @llvm.umax.i64(i64 %i.e, i64 %i.bo) ; 5 uses
  %i.bw = call i64 @llvm.umin.i64(i64 %i.h, i64 %i.bq) ; 2 uses
  %i.bx = sub i64 %i.bw, %i.bv                    ; 3 uses
  br i1 %i.av, label %bb.q, label %bb.r

bb.q:                                             ; preds = %bb.p
  %i.by = load ptr, ptr @efi_dxe_table, align 8
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 64
  %i.ca = load ptr, ptr %i.bz, align 8
  %i.cb = call win64cc i64 %i.ca(i64 noundef %i.bv, i64 noundef %i.bx, i64 noundef 8) #6
  br label %bb.s

bb.r:                                             ; preds = %bb.p
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #5
  %i.cc = load ptr, ptr @efi_dxe_table, align 8
  %i.cd = getelementptr inbounds nuw i8, ptr %i.cc, i64 44
  %i.ce = load i32, ptr %i.cd, align 4
  %i.cf = and i64 %i.bv, 4294967295
  %i.cg = lshr i64 %i.bv, 32
  %i.ch = and i64 %i.bx, 4294967295
  %i.ci = lshr i64 %i.bx, 32
  %i.cj = call i64 (i32, ...) @__efi64_thunk(i32 noundef %i.ce, i64 noundef %i.cf, i64 noundef %i.cg, i64 noundef %i.ch, i64 noundef %i.ci, i64 noundef 8, i64 noundef 0, ptr noundef nonnull %i.d) #6
...
bb.s:                                             ; preds = %bb.r, %bb.q
  %i.co = phi i64 [ %i.cb, %bb.q ], [ %i.cn, %bb.r ] ; 2 uses
  %.not87 = icmp eq i64 %i.co, 0
  br i1 %.not87, label %bb.u, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.cp = call i32 (ptr, ...) @efi_printk(ptr noundef nonnull @.str.2, i64 noundef %i.bv, i64 noundef %i.bw, i64 noundef %i.co) #6 ; 0 uses
  br label %.loopexit

bb.u:                                             ; preds = %bb.n, %bb.s, %bb.o
  %i.cq = icmp ult i64 %i.bq, %i.f
  br i1 %i.cq, label %bb.j, label %.loopexit, !llvm.loop !6

.loopexit:                                        ; preds = %bb.m, %bb.u, %bb.t, %bb.i, %bb.g, %bb.h, %bb.d
  %.0 = phi i64 [ %i.ab, %bb.d ], [ 0, %bb.i ], [ 0, %bb.g ], [ %i.ap, %bb.h ], [ 0, %bb.t ], [ 0, %bb.u ], [ 0, %bb.m ]
...
bb.a:
  ...
  %i.j = alloca [3 x i64], align 16               ; 3 uses
  ...
  %.not = icmp eq i64 %i.x, 6076298535811760713
  br i1 %.not, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  tail call fastcc void @efi_exit(ptr noundef %0, i64 noundef -9223372036854775806) #7
  unreachable
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.ap = call range(i64 0, -9223372034707292160) i64 @llvm.fshl.i64(i64 range(i64 0, 4294967296) %i.ao, i64 range(i64 0, 4294967296) %i.ao, i64 63)
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %bb.e
  %i.aq = phi i64 [ %i.ae, %bb.e ], [ %i.ap, %bb.f ] ; 2 uses
  %.not.i = icmp eq i64 %i.aq, 0
  br i1 %.not.i, label %bb.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.ar = call i32 (ptr, ...) @efi_printk(ptr noundef nonnull @.str.9) #6 ; 0 uses
  br label %bb.l

bb.i:                                             ; preds = %bb.g
  %i.as = call i64 @efi_allocate_pages(i64 noundef 4096, ptr noundef nonnull %i.t, i64 noundef -1) #6 ; 2 uses
  %.not21.i = icmp eq i64 %i.as, 0
  br i1 %.not21.i, label %bb.j, label %bb.l

bb.j:                                             ; preds = %bb.i
  %i.at = load i64, ptr %i.t, align 8
  %i.au = inttoptr i64 %i.at to ptr
  %i.av = call ptr @memset(ptr noundef %i.au, i32 noundef 0, i64 noundef 4096) #6 ; 7 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 498
  store i16 1, ptr %i.aw, align 1
  %i.ax = getelementptr inbounds nuw i8, ptr %i.av, i64 506
  store i16 -1, ptr %i.ax, align 1
  %i.ay = getelementptr inbounds nuw i8, ptr %i.av, i64 528
  store i8 33, ptr %i.ay, align 1
  %i.az = getelementptr inbounds nuw i8, ptr %i.av, i64 556
  store i32 2147483647, ptr %i.az, align 1
  %i.ba = load ptr, ptr @image, align 8
  %i.bb = call ptr @efi_convert_cmdline(ptr noundef %i.ba) #6 ; 2 uses
  %.not22.i = icmp eq ptr %i.bb, null
  br i1 %.not22.i, label %bb.k, label %efi_allocate_bootparams.exit

bb.k:                                             ; preds = %bb.j
  %i.bc = load i64, ptr %i.t, align 8
  call void @efi_free(i64 noundef 4096, i64 noundef %i.bc) #6
  br label %bb.l

efi_allocate_bootparams.exit:                     ; preds = %bb.j
  %i.bd = ptrtoint ptr %i.bb to i64               ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %i.av, i64 552
  %i.bf = getelementptr inbounds nuw i8, ptr %i.av, i64 200
...
bb.m:                                             ; preds = %efi_allocate_bootparams.exit, %bb.c
  %.071 = phi ptr [ %i.av, %efi_allocate_bootparams.exit ], [ %2, %bb.c ] ; 25 uses
  %i.bj = call ptr @get_efi_config_table(i64 4761552760513311930, i64 -5103829374540632427) #6 ; 3 uses
  store ptr %i.bj, ptr @efi_dxe_table, align 8
  %.not32 = icmp eq ptr %i.bj, null
  br i1 %.not32, label %bb.p, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.bk = load i64, ptr %i.bj, align 8
  %.not33 = icmp eq i64 %i.bk, 6220110259735058500
  br i1 %.not33, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.bl = call i32 (ptr, ...) @efi_printk(ptr noundef nonnull @.str.3) #6 ; 0 uses
  store ptr null, ptr @efi_dxe_table, align 8
  br label %bb.p
...
bb.s:                                             ; preds = %bb.r, %bb.q
  %i.cc = call i64 @efi_setup_5level_paging() #6  ; 2 uses
  %.not34 = icmp eq i64 %i.cc, 0
  br i1 %.not34, label %bb.t, label %.sink.split

bb.t:                                             ; preds = %bb.s
  %i.cd = getelementptr inbounds nuw i8, ptr %.071, i64 552
  %i.ce = load i32, ptr %i.cd, align 1
  %i.cf = zext i32 %i.ce to i64
  %i.cg = getelementptr inbounds nuw i8, ptr %.071, i64 200
  %i.ch = load i32, ptr %i.cg, align 1
  %i.ci = zext i32 %i.ch to i64
  %i.cj = shl nuw i64 %i.ci, 32
  %i.ck = or disjoint i64 %i.cj, %i.cf
  %i.cl = inttoptr i64 %i.ck to ptr               ; 4 uses
  br label %bb.u

bb.u:                                             ; preds = %bb.x, %bb.t
  %indvars.iv.i = phi i64 [ 0, %bb.t ], [ %indvars.iv.next.i, %bb.x ] ; 2 uses
  %i.cm = getelementptr inbounds nuw [14 x i8], ptr @parse_options.opts, i64 %indvars.iv.i ; 2 uses
  %i.cn = call ptr @strstr(ptr noundef %i.cl, ptr noundef nonnull %i.cm) #6 ; 3 uses
  %i.co = icmp eq ptr %i.cn, %i.cl
  br i1 %i.co, label %.critedge.i, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.cp = icmp ugt ptr %i.cn, %i.cl
  br i1 %i.cp, label %bb.w, label %bb.x

bb.w:                                             ; preds = %bb.v
  %i.cq = getelementptr inbounds i8, ptr %i.cn, i64 -1
  %i.cr = load i8, ptr %i.cq, align 1
  %i.cs = zext i8 %i.cr to i64
  %i.ct = getelementptr inbounds nuw i8, ptr @_ctype, i64 %i.cs
  %i.cu = load i8, ptr %i.ct, align 1
  %i.cv = and i8 %i.cu, 32
  %.not.i41 = icmp eq i8 %i.cv, 0
  br i1 %.not.i41, label %bb.x, label %.critedge.i

.critedge.i:                                      ; preds = %bb.w, %bb.u
  store ptr %i.cm, ptr @cmdline_memmap_override, align 8
  br label %parse_options.exit

bb.x:                                             ; preds = %bb.w, %bb.v
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, 3
  br i1 %exitcond.not.i, label %parse_options.exit, label %bb.u, !llvm.loop !9

parse_options.exit:                               ; preds = %bb.x, %.critedge.i
  %i.cw = call i64 @efi_parse_options(ptr noundef %i.cl) #6 ; 2 uses
  %.not35 = icmp eq i64 %i.cw, 0
  br i1 %.not35, label %bb.y, label %.sink.split

bb.y:                                             ; preds = %parse_options.exit
  %i.cx = load i32, ptr @efi_mem_encrypt, align 4
  %i.cy = icmp sgt i32 %i.cx, 0
  br i1 %i.cy, label %bb.z, label %bb.aa

bb.z:                                             ; preds = %bb.y
  %i.cz = getelementptr inbounds nuw i8, ptr %.071, i64 566 ; 2 uses
  %i.da = load i16, ptr %i.cz, align 1
  %i.db = or i16 %i.da, 128
  store i16 %i.db, ptr %i.cz, align 1
  br label %bb.aa
...
bb.aa:                                            ; preds = %bb.z, %bb.y
  ...
  store ptr %.071, ptr @boot_params_ptr, align 8
  %i.dc = load i32, ptr @output_len, align 4
  %i.dd = zext i32 %i.dc to i64
  %i.de = load i64, ptr @kernel_total_size, align 8 ; 2 uses
  %i.df = call i64 @llvm.umax.i64(i64 %i.de, i64 %i.dd)
  %i.dg = add i64 %i.df, 2097151
  %i.dh = and i64 %i.dg, -2097152                 ; 2 uses
  %i.di = load i8, ptr @efi_nokaslr, align 1, !range !4, !noundef !5
  %i.dj = trunc nuw i8 %i.di to i1
  br i1 %i.dj, label %bb.aj, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.dk = sub i64 1056964608, %i.de
  %i.dl = call i64 @efi_get_random_bytes(i64 noundef 8, ptr noundef nonnull %i.s) #6 ; 0 uses
  %i.dm = call i64 @kaslr_get_random_long(ptr noundef nonnull @.str.13) #6
  %i.dn = load i64, ptr %i.s, align 8
  %i.do = xor i64 %i.dn, %i.dm                    ; 2 uses
  store i64 %i.do, ptr %i.s, align 8
  %i.dp = lshr i64 %i.do, 32
  %i.dq = mul i64 %i.dp, %i.dk
  %i.dr = lshr i64 %i.dq, 32
  %i.ds = add nuw nsw i64 %i.dr, 16777216
  %i.dt = and i64 %i.ds, 8587837440
  %i.du = load ptr, ptr @efi_system_table, align 8 ; 2 uses
  %i.dv = getelementptr inbounds nuw i8, ptr %i.du, i64 8
  %i.dw = load i32, ptr %i.dv, align 8
  %i.dx = icmp ult i32 %i.dw, 131073
  br i1 %i.dx, label %bb.ac, label %bb.ag

bb.ac:                                            ; preds = %bb.ab
  %i.dy = getelementptr inbounds nuw i8, ptr %i.du, i64 24 ; 2 uses
  br i1 %i.bn, label %bb.ad, label %bb.ae

bb.ad:                                            ; preds = %bb.ac
  %i.dz = load i64, ptr %i.dy, align 8
  br label %efistub_fw_vendor.exit.i

bb.ae:                                            ; preds = %bb.ac
  %i.ea = load i32, ptr %i.dy, align 8
  %i.eb = zext i32 %i.ea to i64
  br label %efistub_fw_vendor.exit.i

efistub_fw_vendor.exit.i:                         ; preds = %bb.ae, %bb.ad
  %i.ec = phi i64 [ %i.dz, %bb.ad ], [ %i.eb, %bb.ae ]
  %i.ed = inttoptr i64 %i.ec to ptr
  %i.ee = call i32 @memcmp(ptr noundef %i.ed, ptr noundef nonnull @efi_decompress_kernel.ami, i64 noundef 40) #6
  %.not.i43 = icmp eq i32 %i.ee, 0
  br i1 %.not.i43, label %bb.af, label %bb.ag
...
bb.ba:                                            ; preds = %bb.bq, %.lr.ph.i
  ...
  %.157.i = phi ptr [ %.020.i, %.lr.ph.i ], [ %.2.i, %bb.bq ] ; 6 uses
  %i.hg = load ptr, ptr %i.m, align 8             ; 2 uses
  br i1 %i.bn, label %bb.bb, label %.thread35.i
...
.thread35.i:                                      ; preds = %bb.ba
  ...
  %or.cond36.i = select i1 %i.if, i1 %i.ih, i1 false
...
bb.bm:                                            ; preds = %bb.bl
  br i1 %i.bn, label %.thread44.i, label %.thread91.i.i
...
bb.bn:                                            ; preds = %preserve_pci_rom_image.exit.i, %preserve_pci_rom_image.exit.thread52.i
  %.03456.i = phi ptr [ %i.md, %preserve_pci_rom_image.exit.thread52.i ], [ undef, %preserve_pci_rom_image.exit.i ] ; 3 uses
  %.not27.i = icmp eq ptr %.157.i, null
  %i.mu = ptrtoint ptr %.03456.i to i64           ; 2 uses
  br i1 %.not27.i, label %bb.bp, label %bb.bo

bb.bo:                                            ; preds = %bb.bn
  store i64 %i.mu, ptr %.157.i, align 8
  br label %bb.bq
...
bb.bq:                                            ; preds = %bb.bp, %bb.bo, %preserve_pci_rom_image.exit.i, %preserve_pci_rom_image.exit.thread.i, %.thread35.i, %bb.bb
  %.2.i = phi ptr [ %.157.i, %bb.bb ], [ %.157.i, %preserve_pci_rom_image.exit.thread.i ], [ %.157.i, %preserve_pci_rom_image.exit.i ], [ %.157.i, %.thread35.i ], [ %.03456.i, %bb.bp ], [ %.03456.i, %bb.bo ]
...
.lr.ph.i.i.i.i.i:                                 ; preds = %bb.bx, %.loopexit.i.i.i.i.i
  %.02135.i.i.i.i.i = phi ptr [ %i.pi, %.loopexit.i.i.i.i.i ], [ %i.ot, %bb.bx ] ; 4 uses
  %i.oz = load i8, ptr %.02135.i.i.i.i.i, align 2
...
bb.by:                                            ; preds = %.lr.ph.i.i.i.i.i
  %i.pa = getelementptr inbounds nuw i8, ptr %.02135.i.i.i.i.i, i64 1
  %i.pb = load i8, ptr %i.pa, align 1
  %i.pc = zext i8 %i.pb to i64
  %i.pd = getelementptr inbounds nuw i8, ptr %.02135.i.i.i.i.i, i64 %i.pc
...
get_table_record.exit.i.i.i:                      ; preds = %.lr.ph.i.i.i.i.i, %bb.bs
  %i.pl = phi ptr [ %i.ob, %bb.bs ], [ %.02135.i.i.i.i.i, %.lr.ph.i.i.i.i.i ] ; 2 uses
...
bb.cc:                                            ; preds = %.preheader.i.i.i
  ...
  br i1 %exitcond.not.i.i.i, label %apple_set_os.exit.i, label %.preheader.i.i.i, !llvm.loop !17

.preheader.i.i.i:                                 ; preds = %get_table_record.exit.i.i.i, %bb.cc
  %indvars.iv.i.i.i = phi i64 [ %indvars.iv.next.i.i.i, %bb.cc ], [ 0, %get_table_record.exit.i.i.i ] ; 2 uses
  %i.po = getelementptr inbounds nuw [15 x i8], ptr @apple_match_product_name.type1_product_matches, i64 %indvars.iv.i.i.i
  %i.pp = call i32 @strcmp(ptr noundef nonnull %i.pn, ptr noundef nonnull %i.po) #6
  %.not19.i.i.i = icmp eq i32 %i.pp, 0
  br i1 %.not19.i.i.i, label %bb.cd, label %bb.cc

bb.cd:                                            ; preds = %.preheader.i.i.i
  %i.pq = load ptr, ptr @efi_system_table, align 8
...
bb.ck:                                            ; preds = %setup_quirks.exit
  ...
  br i1 %i.rg, label %._crit_edge.i.i.i.a, label %alloc_e820ext.exit.i.thread.i

._crit_edge.i.i.i.a:                              ; preds = %bb.ck
...
bb.cq:                                            ; preds = %bb.cy, %.lr.ph.i.i
  ...
  %.05680.i.i = phi ptr [ null, %.lr.ph.i.i ], [ %.157.ph.i.i, %bb.cy ] ; 6 uses
...
bb.dc:                                            ; preds = %.critedge14.i.i.i, %.critedge.i.i.i, %._crit_edge.i.i, %bb.cp
  %.255.i.i = phi i32 [ %.154.ph.i.i, %._crit_edge.i.i ], [ 128, %.critedge.i.i.i ], [ 128, %.critedge14.i.i.i ], [ 0, %bb.cp ]
