...
.lr.ph.preheader.i.i:                             ; preds = %bb.ga, %.lr.ph396.preheader.i.i
  %indvars.iv417.i.i = phi i64 [ 0, %.lr.ph396.preheader.i.i ], [ %indvars.iv.next418.i.i, %bb.ga ] ; 2 uses
  ...
  %i.qy = mul nuw nsw i64 %indvars.iv417.i.i, 5
...
bb.ga:                                            ; preds = %intel_write_sha_text.exit249.i.i, %._crit_edge390.i.i
  ...
  %exitcond421.not.i.i = icmp eq i64 %indvars.iv.next418.i.i, %i.oc
  br i1 %exitcond421.not.i.i, label %._crit_edge397.i.i, label %.lr.ph.preheader.i.i, !llvm.loop !125
