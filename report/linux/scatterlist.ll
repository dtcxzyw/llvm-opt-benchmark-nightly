...
begin_hunk_0_@sg_free_append_table:bb.a
  ...
  br i1 %.not27.i, label %__sg_free_table.exit, label %bb.b, !prof !13
...
bb.b:                                             ; preds = %.peel.begin
  ...
  br i1 %.not57.not.peel, label %.thread67, label %bb.c, !prof !38
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %.not57.not.peel85, label %.loopexit, label %bb.e, !prof !38
...
bb.f:                                             ; preds = %.peel.next81, %bb.g
  ...
  br i1 %.not57.not, label %.loopexit, label %bb.g, !prof !38
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %.not59, label %.thread72, label %bb.f, !llvm.loop !37
...
bb.a:
  ...
  br i1 %i.e, label %bb.b, label %.critedge136, !prof !13

bb.b:                                             ; preds = %bb.a
  tail call void asm sideeffect "540: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 540b - ., 3; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 540) #14, !srcloc !44
  tail call void asm sideeffect "1:\09 ud2 \0A.pushsection __bug_table,\22aw\22\0A\09912: .pushsection .discard.annotate_data, \22M\22, @progbits, 8; .long 912b - ., 1; .popsection\0A\092:\0A\09\09.long 1b - .\09# bug_entry::bug_addr\0A\09.long ${0:c} - .\09# bug_entry::format\0A\09.long ${1:c} - .\09# bug_entry::file\0A\09.word ${2:c}\09# bug_entry::line\0A\09.word ${3:c}\09# bug_entry::flags\0A\09.org 2b + ${4:c}\0A.popsection\0A.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 1b - ., 8; .popsection", "i,i,i,i,i,~{dirflag},~{fpsr},~{flags}"(ptr nonnull @.str, ptr nonnull @.str.1, i32 472, i32 2305, i64 16) #14, !srcloc !45
  tail call void asm sideeffect "541: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 541b - ., 4; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 541) #14, !srcloc !46
  br label %bb.aa
...
bb.c:                                             ; preds = %.critedge136
  ...
  br i1 %.not129, label %.critedge138, label %.critedge139.thread150, !prof !15

.critedge139.thread150:                           ; preds = %bb.c
  tail call void asm sideeffect "542: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 542b - ., 3; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 542) #14, !srcloc !47
  tail call void asm sideeffect "1:\09 ud2 \0A.pushsection __bug_table,\22aw\22\0A\09912: .pushsection .discard.annotate_data, \22M\22, @progbits, 8; .long 912b - ., 1; .popsection\0A\092:\0A\09\09.long 1b - .\09# bug_entry::bug_addr\0A\09.long ${0:c} - .\09# bug_entry::format\0A\09.long ${1:c} - .\09# bug_entry::file\0A\09.word ${2:c}\09# bug_entry::line\0A\09.word ${3:c}\09# bug_entry::flags\0A\09.org 2b + ${4:c}\0A.popsection\0A.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 1b - ., 8; .popsection", "i,i,i,i,i,~{dirflag},~{fpsr},~{flags}"(ptr nonnull @.str, ptr nonnull @.str.1, i32 481, i32 2305, i64 16) #14, !srcloc !48
  tail call void asm sideeffect "543: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 543b - ., 4; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 543) #14, !srcloc !49
  br label %bb.aa
...
bb.f:                                             ; preds = %bb.e
  ...
  br i1 %.not130, label %.critedge139, label %.lr.ph, !llvm.loop !40
...
bb.j:                                             ; preds = %bb.h, %bb.i
  ...
  br i1 %exitcond.not, label %.preheader164, label %bb.g, !llvm.loop !41
...
bb.k:                                             ; preds = %bb.l
  ...
  br i1 %exitcond192.not, label %._crit_edge219, label %.lr.ph218, !llvm.loop !42
...
bb.l:                                             ; preds = %.lr.ph218
  ...
  br i1 %.not.i143, label %bb.k, label %._crit_edge220, !llvm.loop !42

._crit_edge220:                                   ; preds = %bb.l
  br label %._crit_edge219, !llvm.loop !42
...
._crit_edge219:                                   ; preds = %bb.k, %.lr.ph218, %._crit_edge220, %.preheader
  ...
  %i.ca = sub nuw i32 %.0108.lcssa206, %.0113181
...
bb.n:                                             ; preds = %bb.m
  ...
  br i1 %i.ce, label %bb.o, label %sg_next.exit.i, !prof !13
...
bb.w:                                             ; preds = %get_next_sg.exit
  ...
  br i1 %.not.i.i145, label %bb.y, label %bb.x, !prof !15

bb.x:                                             ; preds = %bb.w
  tail call void asm sideeffect "472: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 472b - ., 3; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 472) #14, !srcloc !16
...
bb.y:                                             ; preds = %bb.w
  ...
  br i1 %exitcond193.not, label %._crit_edge, label %.preheader, !llvm.loop !43
...
bb.b:                                             ; preds = %bb.a
  ...
  %or.cond = select i1 %.not27.i.i, i1 true, i1 %.not2830.i.i, !prof !50
  br i1 %or.cond, label %sg_free_append_table.exit, label %.lr.ph.preheader.i.i, !prof !50
...
bb.e:                                             ; preds = %bb.a
  ...
  br i1 %.not14, label %sg_free_append_table.exit, label %bb.f, !prof !15

bb.f:                                             ; preds = %bb.e
  tail call void asm sideeffect "547: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 547b - ., 3; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 547) #14, !srcloc !51
  tail call void asm sideeffect "1:\09 ud2 \0A.pushsection __bug_table,\22aw\22\0A\09912: .pushsection .discard.annotate_data, \22M\22, @progbits, 8; .long 912b - ., 1; .popsection\0A\092:\0A\09\09.long 1b - .\09# bug_entry::bug_addr\0A\09.long ${0:c} - .\09# bug_entry::format\0A\09.long ${1:c} - .\09# bug_entry::file\0A\09.word ${2:c}\09# bug_entry::line\0A\09.word ${3:c}\09# bug_entry::flags\0A\09.org 2b + ${4:c}\0A.popsection\0A.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 1b - ., 8; .popsection", "i,i,i,i,i,~{dirflag},~{fpsr},~{flags}"(ptr nonnull @.str, ptr nonnull @.str.1, i32 596, i32 2305, i64 16) #14, !srcloc !52
  tail call void asm sideeffect "548: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 548b - ., 4; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 548) #14, !srcloc !53
  br label %sg_free_append_table.exit
