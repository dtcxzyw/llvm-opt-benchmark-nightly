...
begin_hunk_0_@tcp_send_probe0:bb.a
  br label %tcp_reset_xmit_timer.exit

tcp_reset_xmit_timer.exit:                        ; preds = %bb.h, %bb.i
  %i.am = phi i64 [ %i.al, %bb.i ], [ 0, %bb.h ]
  %i.an = add i64 %i.am, %i.ag
  %i.ao = getelementptr i8, ptr %0, i64 1200
...
.thread:                                          ; preds = %.thread.loopexit, %.lr.ph.split.us.preheader, %.thread.loopexit99
  ...
  %i.ae = or i16 %i.ad, 4096
  store i16 %i.ae, ptr %i.ac, align 4
  br label %bb.g

bb.f:                                             ; preds = %.outer._crit_edge
  %i.af = getelementptr i8, ptr %0, i64 3         ; 2 uses
  %i.ag = load i8, ptr %i.af, align 1
  %i.ah = trunc i32 %.038.ph82.us to i8
  %i.ai = add i8 %i.ag, %i.ah
  store i8 %i.ai, ptr %i.af, align 1
  br label %bb.g

bb.g:                                             ; preds = %.outer._crit_edge, %bb.f, %.thread
  %.040 = phi i32 [ %.253, %.thread ], [ 0, %bb.f ], [ 0, %.outer._crit_edge ]
  ret i32 %.040
}
...
bb.a:
  %i.a = getelementptr i8, ptr %0, i64 392        ; 4 uses
  %i.b = load ptr, ptr %i.a, align 8              ; 2 uses
  %i.c = icmp eq ptr %i.b, %i.a
  %spec.store.select.i.i = select i1 %i.c, ptr null, ptr %i.b ; 2 uses
  %.not20 = icmp eq ptr %spec.store.select.i.i, %i.a
  br i1 %.not20, label %tcp_has_tx_tstamp.exit.thread, label %.lr.ph

bb.b:                                             ; preds = %tcp_skb_can_collapse.exit
  %i.d = sub nuw i32 %.01421, %i.f
  %.not = icmp eq ptr %.023, %i.a
  br i1 %.not, label %tcp_has_tx_tstamp.exit.thread, label %.lr.ph, !llvm.loop !179

.lr.ph:                                           ; preds = %bb.a, %bb.b
  %.01322 = phi ptr [ %.023, %bb.b ], [ %spec.store.select.i.i, %bb.a ] ; 6 uses
  %.01421 = phi i32 [ %i.d, %bb.b ], [ %1, %bb.a ] ; 2 uses
  %.023 = load ptr, ptr %.01322, align 8          ; 5 uses
  %i.e = getelementptr i8, ptr %.01322, i64 112
  %i.f = load i32, ptr %i.e, align 8              ; 2 uses
  %.not16 = icmp ugt i32 %.01421, %i.f
  br i1 %.not16, label %bb.c, label %tcp_has_tx_tstamp.exit.thread

bb.c:                                             ; preds = %.lr.ph
  %i.g = getelementptr i8, ptr %.01322, i64 56
  %i.h = load i8, ptr %i.g, align 8               ; 2 uses
  %i.i = and i8 %i.h, 3
  %.not.i = icmp eq i8 %i.i, 0
  br i1 %.not.i, label %tcp_has_tx_tstamp.exit, label %tcp_has_tx_tstamp.exit.thread

tcp_has_tx_tstamp.exit:                           ; preds = %bb.c
  %i.j = getelementptr i8, ptr %.01322, i64 192
  %.val.i = load i32, ptr %i.j, align 8
  %i.k = getelementptr i8, ptr %.01322, i64 200
  %.val2.i = load ptr, ptr %i.k, align 8
  %i.l = zext i32 %.val.i to i64
  %i.m = getelementptr i8, ptr %.val2.i, i64 %i.l ; 2 uses
  %i.n = getelementptr i8, ptr %i.m, i64 3
  %i.o = load i8, ptr %i.n, align 1
  %i.p = and i8 %i.o, -53
  %i.q = and i8 %i.h, 4
  %i.r = or disjoint i8 %i.p, %i.q
  %or.cond = icmp eq i8 %i.r, 0
  br i1 %or.cond, label %bb.d, label %tcp_has_tx_tstamp.exit.thread, !prof !180

bb.d:                                             ; preds = %tcp_has_tx_tstamp.exit
  %i.s = getelementptr i8, ptr %.023, i64 192
  %.val11.i = load i32, ptr %i.s, align 8
  %i.t = getelementptr i8, ptr %.023, i64 200
  %.val12.i = load ptr, ptr %i.t, align 8
  %i.u = load i8, ptr %i.m, align 8
  %i.v = zext i32 %.val11.i to i64
  %i.w = getelementptr i8, ptr %.val12.i, i64 %i.v
  %i.x = load i8, ptr %i.w, align 8
  %i.y = xor i8 %i.x, %i.u
  %i.z = and i8 %i.y, 4
  %.not.i13.i = icmp eq i8 %i.z, 0
  br i1 %.not.i13.i, label %tcp_skb_can_collapse.exit, label %tcp_has_tx_tstamp.exit.thread, !prof !21

tcp_skb_can_collapse.exit:                        ; preds = %bb.d
  %i.aa = getelementptr i8, ptr %.01322, i64 129
  %.val7.i = load i32, ptr %i.aa, align 1
  %i.ab = getelementptr i8, ptr %.023, i64 129
  %.val.i17 = load i32, ptr %i.ab, align 1
  %i.ac = xor i32 %.val.i17, %.val7.i
  %i.ad = and i32 %i.ac, 4194304
  %.not.i18 = icmp eq i32 %i.ad, 0
  br i1 %.not.i18, label %bb.b, label %tcp_has_tx_tstamp.exit.thread

tcp_has_tx_tstamp.exit.thread:                    ; preds = %tcp_skb_can_collapse.exit, %tcp_has_tx_tstamp.exit, %.lr.ph, %bb.b, %bb.c, %bb.d, %bb.a
  %.015 = phi i1 [ true, %bb.a ], [ true, %.lr.ph ], [ false, %tcp_has_tx_tstamp.exit ], [ true, %bb.b ], [ false, %bb.c ], [ false, %bb.d ], [ false, %tcp_skb_can_collapse.exit ]
  ret i1 %.015
}
