...
begin_hunk_0_@tcp_write_xmit:bb.a
  %i.abb = and i8 %.val120, 31
  %i.abc = zext nneg i8 %i.abb to i32
  %i.abd = shl nuw i32 1, %i.abc
  %i.abe = and i32 %i.abd, 12
  %.not256 = icmp eq i32 %i.abe, 0
  br i1 %.not256, label %bb.dy, label %bb.dx

bb.dx:                                            ; preds = %bb.dw
  %i.abf = getelementptr i8, ptr %0, i64 1456     ; 2 uses
  %i.abg = load i32, ptr %i.abf, align 16
  %i.abh = add i32 %i.abg, %.3249
  store i32 %i.abh, ptr %i.abf, align 16
  br label %bb.dy
...
bb.dz:                                            ; preds = %bb.dy
  %i.abi = tail call zeroext i1 @tcp_schedule_loss_probe(ptr noundef %0, i1 noundef zeroext false) #21 ; 0 uses
...
tcp_cwnd_validate.exit.thread:                    ; preds = %tcp_cwnd_validate.exit.tcp_cwnd_validate.exit.thread_crit_edge, %tcp_chrono_start.exit
  %i.abj = phi i32 [ %.pre, %tcp_cwnd_validate.exit.tcp_cwnd_validate.exit.thread_crit_edge ], [ %i.xa, %tcp_chrono_start.exit ]
  %.not118 = icmp eq i32 %i.abj, 0
  br i1 %.not118, label %bb.ea, label %tcp_mtu_probe.exit.thread211

bb.ea:                                            ; preds = %tcp_cwnd_validate.exit.thread
  %i.abk = getelementptr i8, ptr %0, i64 1604
  %.val126 = load i32, ptr %i.abk, align 4
  %.val127 = load i32, ptr %i.is, align 4
  %i.abl = icmp ne i32 %.val126, %.val127
  br label %tcp_mtu_probe.exit.thread211

tcp_mtu_probe.exit.thread211:                     ; preds = %bb.n, %tcp_cwnd_validate.exit.thread, %bb.ea, %bb.dy, %bb.dz, %tcp_mtu_probe.exit
  %.0 = phi i1 [ false, %tcp_mtu_probe.exit ], [ false, %bb.dy ], [ false, %bb.dz ], [ false, %tcp_cwnd_validate.exit.thread ], [ %i.abl, %bb.ea ], [ false, %bb.n ]
  ret i1 %.0
}
...
bb.a:
  br i1 %1, label %bb.b, label %bb.c, !prof !16
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void asm sideeffect "", "~{dirflag},~{fpsr},~{flags}"() #19, !srcloc !116
  br label %bb.c
...
skb_fclone_busy.exit.i:                           ; preds = %bb.d
  ...
  br i1 %i.n, label %bb.e, label %skb_still_in_host_queue.exit, !prof !37

bb.e:                                             ; preds = %skb_fclone_busy.exit.i
  %i.o = getelementptr i8, ptr %0, i64 376        ; 2 uses
  tail call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock orb ${1:b},$0", "=*m,iq,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i8) %i.o, i32 1, ptr elementtype(i8) %i.o) #19, !srcloc !38
...
skb_still_in_host_queue.exit.thread:              ; preds = %skb_fclone_busy.exit7.i
  ...
  tail call void asm sideeffect "incq %gs:$0", "=*m,*m,~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i64) %i.z, ptr elementtype(i64) %i.z) #19, !srcloc !39
  br label %bb.aj
...
.lr.ph:                                           ; preds = %skb_still_in_host_queue.exit
  ...
  br i1 %i.ai, label %._crit_edge, label %.lr.ph222, !prof !117
...
._crit_edge:                                      ; preds = %.lr.ph222, %.lr.ph
  ...
  br i1 %i.ar, label %bb.g, label %bb.h, !prof !16

bb.g:                                             ; preds = %._crit_edge
  tail call void asm sideeffect "1493: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 1493b - ., 3; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 1493) #19, !srcloc !118
  tail call void asm sideeffect "1:\09 ud2 \0A.pushsection __bug_table,\22aw\22\0A\09912: .pushsection .discard.annotate_data, \22M\22, @progbits, 8; .long 912b - ., 1; .popsection\0A\092:\0A\09\09.long 1b - .\09# bug_entry::bug_addr\0A\09.long ${0:c} - .\09# bug_entry::format\0A\09.long ${1:c} - .\09# bug_entry::file\0A\09.word ${2:c}\09# bug_entry::line\0A\09.word ${3:c}\09# bug_entry::flags\0A\09.org 2b + ${4:c}\0A.popsection\0A.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 1b - ., 8; .popsection", "i,i,i,i,i,~{dirflag},~{fpsr},~{flags}"(ptr nonnull @.str, ptr nonnull @.str.1, i32 3575, i32 2307, i64 16) #19, !srcloc !119
  tail call void asm sideeffect "1494: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 1494b - ., 4; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 1494) #19, !srcloc !120
  br label %bb.aj
...
bb.q:                                             ; preds = %tcp_set_skb_tso_segs.exit
  ...
  tail call fastcc void @tcp_adjust_pcount(ptr noundef %0, ptr noundef %1, i32 noundef %i.ch) #21, !srcloc !121
...
bb.s:                                             ; preds = %bb.r
  tail call fastcc void @tcp_retrans_try_collapse(ptr noundef %0, ptr noundef %1, i32 noundef %i.cj) #21, !srcloc !122
  br label %bb.t
...
tcp_ecn_clear_syn.exit:                           ; preds = %bb.x, %bb.w, %bb.v, %bb.u
  ...
  tail call void asm sideeffect "addq $1, %gs:$0", "=*m,re,*m,~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i64) %i.df, i64 %i.db, ptr elementtype(i64) %i.df) #19, !srcloc !123
...
bb.y:                                             ; preds = %tcp_ecn_clear_syn.exit
  ...
  tail call void asm "incq %gs:$0", "=*m,*m,~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i64) %i.dm, ptr elementtype(i64) %i.dm) #19, !srcloc !124
  br label %bb.z
...
bb.z:                                             ; preds = %tcp_ecn_clear_syn.exit, %bb.y
  ...
  br i1 %i.eb, label %bb.aa, label %bb.ad, !prof !16
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.ei = tail call fastcc i32 @__tcp_transmit_skb(ptr noundef %0, ptr noundef nonnull %i.ee, i32 noundef 0, i32 noundef 2080, i32 noundef %i.eh) #21, !srcloc !40 ; 2 uses
  store i64 %i.ed, ptr %i.ec, align 8
...
bb.ac:                                            ; preds = %bb.ab
  ...
  tail call fastcc void @tcp_update_skb_after_send(ptr noundef %0, ptr noundef %1, i64 noundef %i.ek) #21, !srcloc !125
  tail call fastcc void @tcp_rate_skb_sent(ptr noundef %0, ptr noundef %1) #21, !srcloc !126
  br label %bb.ae

bb.ad:                                            ; preds = %bb.z
  %i.el = getelementptr i8, ptr %0, i64 1704
  %i.em = load i32, ptr %i.el, align 8
  %i.en = tail call fastcc i32 @__tcp_transmit_skb(ptr noundef %0, ptr noundef %1, i32 noundef 1, i32 noundef 2080, i32 noundef %i.em) #21, !srcloc !40
end_hunk_0
