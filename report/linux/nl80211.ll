...
bb.ae:                                            ; preds = %bb.ad, %bb.ac
  ...
  %i.ds = load i8, ptr %i.dr, align 8, !range !25, !noundef !26
...
bb.au:                                            ; preds = %bb.at, %bb.ap, %bb.ao
  ...
  %i.ff = load i8, ptr %i.fe, align 8, !range !25, !noundef !26
...
bb.av:                                            ; preds = %bb.au, %bb.h
  ...
  %i.fj = call fastcc i32 @nl80211_put_iftypes(ptr noundef %2, i32 noundef 32, i16 noundef zeroext %i.fi) #28, !srcloc !135
...
bb.aw:                                            ; preds = %bb.av
  ...
  %i.fn = load i8, ptr %i.fm, align 8, !range !25, !noundef !26
...
bb.ay:                                            ; preds = %bb.ax
  ...
  %i.fz = load i8, ptr %i.fy, align 8, !range !25, !noundef !26 ; 2 uses
...
bb.bc:                                            ; preds = %bb.bb
  %i.gq = load i8, ptr %i.fy, align 8, !range !25, !noundef !26
  %i.gr = trunc nuw i8 %i.gq to i1
  %i.gs = call fastcc i32 @nl80211_send_band_rateinfo(ptr noundef %2, ptr noundef %i.gj, i1 noundef zeroext %i.gr) #28, !srcloc !136
...
bb.bd:                                            ; preds = %bb.bc
  ...
  %i.gv = load i8, ptr %i.fy, align 8, !range !25, !noundef !26
...
bb.bg:                                            ; preds = %.lr.ph805
  ...
  %i.hp = load i8, ptr %i.fy, align 8, !range !25, !noundef !26
  %i.hq = trunc nuw i8 %i.hp to i1
  %i.hr = call fastcc i32 @nl80211_msg_put_channel(ptr noundef %2, ptr noundef %i.ay, ptr noundef %i.ho, i1 noundef zeroext %i.hq) #28, !srcloc !137
...
bb.bh:                                            ; preds = %bb.bg
  ...
  %i.hy = load i8, ptr %i.fy, align 8, !range !25, !noundef !26
...
bb.bi:                                            ; preds = %bb.bh
  ...
  br i1 %i.ib, label %.lr.ph805, label %._crit_edge806.split.loop.exit, !llvm.loop !125
...
._crit_edge806:                                   ; preds = %bb.bh, %._crit_edge806.split.loop.exit
  ...
  %spec.select935 = select i1 %cond.fr, i64 %i.ie, i64 0
  br label %._crit_edge806.thread

._crit_edge806.thread:                            ; preds = %._crit_edge806, %bb.bf
  %i.if = phi i64 [ 0, %bb.bf ], [ %spec.select935, %._crit_edge806 ]
...
bb.bj:                                            ; preds = %bb.bd, %._crit_edge806.thread
  ...
  %i.is = load i8, ptr %i.fy, align 8, !range !25, !noundef !26
...
bb.bl:                                            ; preds = %._crit_edge879, %bb.bj
  ...
  br i1 %or.cond, label %bb.az, label %.loopexit.loopexit, !llvm.loop !126
...
bb.bo:                                            ; preds = %bb.bn, %bb.bm, %.loopexit
  %i.jo = load i8, ptr %i.fy, align 8, !range !25, !noundef !26
...
bb.bq:                                            ; preds = %bb.bp
  %i.jw = call fastcc i32 @nl80211_add_commands_unsplit(ptr noundef %0, ptr noundef %2) #28, !srcloc !138 ; 3 uses
  %i.jx = icmp slt i32 %i.jw, 0
  br i1 %i.jx, label %.thread730, label %bb.br

bb.br:                                            ; preds = %bb.bq
  %i.jy = getelementptr i8, ptr %6, i64 48        ; 2 uses
  %i.jz = load i8, ptr %i.jy, align 8, !range !25, !noundef !26
