...
.lr.ph.split.us.i.i:                              ; preds = %.lr.ph.split.us.i.i, %.lr.ph.i37.i
  ...
  %i.gb = mul nuw i32 %i.ga, 56064
  %i.gc = udiv i32 %i.gb, 65535
  ...
  %i.gj = mul nuw i32 %i.gi, 56064
  %i.gk = udiv i32 %i.gj, 65535
  ...
  %i.gr = mul nuw i32 %i.gq, 56064
  %i.gs = udiv i32 %i.gr, 65535
...
.lr.ph.split.us.i.i:                              ; preds = %bb.az, %.lr.ph.split.us.i.i
  ...
  %i.hb = mul nuw i32 %i.ha, 56064
  %i.hc = udiv i32 %i.hb, 65535
  ...
  %i.hj = mul nuw i32 %i.hi, 56064
  %i.hk = udiv i32 %i.hj, 65535
...
.lr.ph.split.us.i:                                ; preds = %.lr.ph.split.us.i, %.lr.ph.i
  ...
  %i.av = mul nuw i32 %i.au, 56064
  %i.aw = udiv i32 %i.av, 65535
  ...
  %i.bd = mul nuw i32 %i.bc, 56064
  %i.be = udiv i32 %i.bd, 65535
  ...
  %i.bl = mul nuw i32 %i.bk, 56064
  %i.bm = udiv i32 %i.bl, 65535
