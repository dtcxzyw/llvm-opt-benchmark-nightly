Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/linux/original/intel_gsc_uc_heci_cmd_submit?download=true
...
bb.p:                                             ; preds = %.thread84, %bb.k
  %.145 = phi i32 [ %.044, %bb.k ], [ %spec.select56, %.thread84 ] ; 3 uses
...
__drm_to_dev.exit60:                              ; preds = %bb.u, %bb.v
  ...
  tail call void (ptr, ptr, ...) @_dev_err(ptr noundef %i.bk, ptr noundef nonnull @.str.1, i32 noundef %.145) #9
  br label %bb.w

bb.w:                                             ; preds = %i915_request_put.exit, %__drm_to_dev.exit60, %bb.a, %bb.c
  %.0 = phi i32 [ %i.f, %bb.c ], [ -19, %bb.a ], [ %.145, %__drm_to_dev.exit60 ], [ 0, %i915_request_put.exit ]
  ret i32 %.0
}
...
bb.j:                                             ; preds = %bb.e, %i915_gem_object_get.exit.i.i, %i915_gem_object_get.exit.i.i
  ...
  %i.aq = load i8, ptr %i.b, align 8, !range !18, !noundef !19
...
bb.p:                                             ; preds = %bb.m, %i915_gem_object_get.exit.i.i99
...
bb.r:                                             ; preds = %bb.m, %i915_gem_object_get.exit.i.i99, %i915_gem_object_get.exit.i.i99
  %i.bf = load volatile i32, ptr %i.f, align 4    ; 2 uses
  %.not.i.i = icmp eq i32 %i.bf, 0
  br i1 %.not.i.i, label %intel_context_pin_ww.exit, label %.lr.ph.i.i, !prof !20
...
.lr.ph.i.i:                                       ; preds = %bb.r, %arch_atomic_try_cmpxchg.exit.i.i
  ...
  %i.bh = call { i8, i32 } asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgl $3, $1", "={@ccz},=*m,={ax},r,*m,2,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.f, i32 %i.bg, ptr elementtype(i32) %i.f, i32 %.04.i.i) #8, !srcloc !21 ; 2 uses
...
arch_atomic_try_cmpxchg.exit.i.i:                 ; preds = %.lr.ph.i.i
  ...
  br i1 %.not7.i.i, label %intel_context_pin_ww.exit, label %.lr.ph.i.i, !prof !22
...
bb.ab:                                            ; preds = %bb.y, %__drm_to_dev.exit, %bb.x, %bb.w, %bb.u, %bb.t
  %.059 = phi i32 [ %i.ce, %bb.t ], [ %i.cg, %bb.u ], [ %i.cn, %bb.w ], [ %i.cv, %bb.x ], [ %i.cz, %__drm_to_dev.exit ], [ 0, %bb.y ] ; 3 uses
...
i915_request_get.exit:                            ; preds = %bb.ab, %bb.ad, %.sink.split.i.i.i.i.i.i
  %.not82 = icmp eq i32 %.059, 0
  br i1 %.not82, label %.critedge, label %bb.ae, !prof !12

bb.ae:                                            ; preds = %i915_request_get.exit
  %i.di = call zeroext i1 @i915_request_set_error_once(ptr noundef %i.bn, i32 noundef %.059) #7 ; 0 uses
...
bb.aj:                                            ; preds = %.thread132, %bb.ae
  %.160 = phi i32 [ %.059, %bb.ae ], [ %spec.select85, %.thread132 ] ; 4 uses
...
i915_request_put.exit:                            ; preds = %bb.an, %bb.am, %bb.al, %bb.aj, %bb.s
  %.261 = phi i32 [ %i.bq, %bb.s ], [ %.160, %bb.aj ], [ %.160, %bb.al ], [ %.160, %bb.am ], [ %.160, %bb.an ] ; 3 uses
...
.preheader.i:                                     ; preds = %i915_request_put.exit, %atomic_add_unless.exit.i
  ...
  br i1 %i.eq, label %atomic_add_unless.exit.i, label %.lr.ph.i, !prof !20
...
.lr.ph.i:                                         ; preds = %.preheader.i, %arch_atomic_try_cmpxchg.exit.i.i108
  ...
  %i.es = call { i8, i32 } asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgl $3, $1", "={@ccz},=*m,={ax},r,*m,2,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.f, i32 %i.er, ptr elementtype(i32) %i.f, i32 %.010.i) #8, !srcloc !21 ; 2 uses
...
arch_atomic_try_cmpxchg.exit.i.i108:              ; preds = %.lr.ph.i
  ...
  br i1 %i.ex, label %atomic_add_unless.exit.i, label %.lr.ph.i, !prof !22

atomic_add_unless.exit.i:                         ; preds = %arch_atomic_try_cmpxchg.exit.i.i108, %.preheader.i
  %i.ey = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgl $2, $1", "={ax},=*m,r,0,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.f, i32 2, i32 1, ptr elementtype(i32) %i.f) #8, !srcloc !24
  %i.ez = icmp eq i32 %i.ey, 1
  br i1 %i.ez, label %bb.ap, label %.preheader.i, !llvm.loop !15

bb.ap:                                            ; preds = %atomic_add_unless.exit.i
  %i.fa = load ptr, ptr %i.t, align 8
  %i.fb = getelementptr i8, ptr %i.fa, i64 88
  %i.fc = load ptr, ptr %i.fb, align 8
  call void %i.fc(ptr noundef %1) #7, !inline_history !16
  br label %intel_context_unpin.exit

intel_context_unpin.exit:                         ; preds = %.lr.ph.i, %bb.ap, %bb.ao, %intel_context_pin_ww.exit
  %.3 = phi i32 [ %.261, %bb.ap ], [ %.261, %bb.ao ], [ %i.bm, %intel_context_pin_ww.exit ], [ %.261, %.lr.ph.i ] ; 2 uses
...
bb.aq:                                            ; preds = %intel_context_unpin.exit.thread
  %i.ff = add nuw nsw i32 %.058, 1                ; 2 uses
  %exitcond.not = icmp eq i32 %i.ff, 10
  br i1 %exitcond.not, label %intel_context_unpin.exit.thread137, label %bb.b

intel_context_unpin.exit.thread137:               ; preds = %bb.m, %i915_gem_object_get.exit.i.i99, %bb.e, %i915_gem_object_get.exit.i.i, %bb.aq, %intel_context_unpin.exit.thread, %intel_context_unpin.exit
  %.4 = phi i32 [ %i.fe, %intel_context_unpin.exit.thread ], [ %.3, %intel_context_unpin.exit ], [ -11, %bb.aq ], [ %.0.i.i87, %i915_gem_object_get.exit.i.i99 ], [ %.0.i.i, %i915_gem_object_get.exit.i.i ], [ %.0.i.i, %bb.e ], [ %.0.i.i87, %bb.m ]
...
!21 = !{i64 2148893998, i64 2148894037, i64 2148894058, i64 2148894095, i64 2148894118, i64 2148894127}
!22 = !{!"branch_weights", i32 127, i32 255873}
!23 = !{i64 2161727604}
!24 = !{i64 2148890936, i64 2148890975, i64 2148890996, i64 2148891033, i64 2148891056, i64 2148891065}
