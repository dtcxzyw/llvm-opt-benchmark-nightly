...
bb.h:                                             ; preds = %bb.g
  %i.r = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.j, i32 -1, ptr elementtype(i32) %i.j) #14, !srcloc !20 ; 2 uses
  %i.s = icmp eq i32 %i.r, 1
  br i1 %i.s, label %bb.k, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.t = icmp slt i32 %i.r, 1
  br i1 %i.t, label %bb.j, label %lrc_create_wa_ctx.exit, !prof !21
...
bb.k:                                             ; preds = %bb.h
  ...
  tail call void @drm_gem_object_free(ptr noundef %i.j) #13, !callees !23, !inline_history !3
  br label %lrc_create_wa_ctx.exit
...
bb.n:                                             ; preds = %lrc_create_wa_ctx.exit._crit_edge, %lrc_create_wa_ctx.exit.thread
  ...
  br i1 %.not53, label %bb.ah, label %bb.o
...
bb.t:                                             ; preds = %bb.s
  %i.ao = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.ah, i32 1, ptr elementtype(i32) %i.ah) #14, !srcloc !20 ; 3 uses
  %.not.i.i.i.i.i.i.i.i = icmp eq i32 %i.ao, 0
  br i1 %.not.i.i.i.i.i.i.i.i, label %.sink.split.i.i.i.i.i.i.i.i, label %bb.u, !prof !21

bb.u:                                             ; preds = %bb.t
  %i.ap = add i32 %i.ao, 1
  %i.aq = or i32 %i.ap, %i.ao
  %.not10.i.i.i.i.i.i.i.i = icmp sgt i32 %i.aq, -1
...
i915_gem_object_get.exit.i.i:                     ; preds = %.sink.split.i.i.i.i.i.i.i.i, %bb.u
  %i.ar = getelementptr i8, ptr %i.ah, i64 544    ; 3 uses
  %i.as = load ptr, ptr %i.ad, align 8            ; 2 uses
  store ptr %i.ar, ptr %i.ad, align 8
  store ptr %i.ac, ptr %i.ar, align 8
  %i.at = getelementptr i8, ptr %i.ah, i64 552
...
bb.v:                                             ; preds = %bb.s, %i915_gem_object_get.exit.i.i
  %i.au = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.ah, i32 1, ptr elementtype(i32) %i.ah) #14, !srcloc !20 ; 3 uses
  %.not.i.i.i.i.i.i19.i7.i = icmp eq i32 %i.au, 0
  br i1 %.not.i.i.i.i.i.i19.i7.i, label %.sink.split.i.i.i.i.i.i21.i9.i, label %bb.w, !prof !21

bb.w:                                             ; preds = %bb.v
  %i.av = add i32 %i.au, 1
  %i.aw = or i32 %i.av, %i.au
  %.not10.i.i.i.i.i.i20.i8.i = icmp sgt i32 %i.aw, -1
  br i1 %.not10.i.i.i.i.i.i20.i8.i, label %.thread72, label %.sink.split.i.i.i.i.i.i21.i9.i, !prof !24

.sink.split.i.i.i.i.i.i21.i9.i:                   ; preds = %bb.w, %bb.v
  %.sink.i.i.i.i.i.i22.i10.i = phi i32 [ 2, %bb.v ], [ 1, %bb.w ]
  call void @refcount_warn_saturate(ptr noundef %i.ah, i32 noundef %.sink.i.i.i.i.i.i22.i10.i) #13
  br label %.thread72

.thread72:                                        ; preds = %bb.w, %.sink.split.i.i.i.i.i.i21.i9.i
  store ptr %i.ah, ptr %i.ae, align 8
  br label %bb.ac

bb.x:                                             ; preds = %bb.s, %i915_gem_object_get.exit.i.i, %i915_gem_object_get.exit.i.i
  %i.ax = load ptr, ptr %i.aa, align 8
  %i.ay = call i32 @i915_ggtt_pin(ptr noundef %i.ax, ptr noundef nonnull %1, i32 noundef 0, i32 noundef 32) #13 ; 2 uses
  %.not55 = icmp eq i32 %i.ay, 0
  br i1 %.not55, label %bb.y, label %.thread
...
bb.y:                                             ; preds = %bb.x
  ...
  br i1 %i.bd, label %bb.aa, label %.preheader

.preheader:                                       ; preds = %bb.y
  store i32 0, ptr %i.a, align 8
  br i1 %.not56, label %.thread67, label %bb.z
...
.thread67:                                        ; preds = %bb.z, %.preheader
  %.pre-phi = phi i64 [ %.pre89, %bb.z ], [ %i.be, %.preheader ] ; 3 uses
  %i.bh = phi i64 [ %i.bg, %bb.z ], [ 0, %.preheader ]
...
bb.aa:                                            ; preds = %bb.y
  ...
  br i1 %.not57, label %.loopexit, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.cb = load ptr, ptr %i.aa, align 8
  %i.cc = getelementptr i8, ptr %i.cb, i64 268    ; 2 uses
  call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock decl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.cc, ptr elementtype(i32) %i.cc) #14, !srcloc !25
  br label %.thread

.thread:                                          ; preds = %bb.s, %i915_gem_object_get.exit.i.i, %bb.ab, %bb.x
  %.2 = phi i32 [ %i.ay, %bb.x ], [ %i.ca, %bb.ab ], [ %.0.i.i, %i915_gem_object_get.exit.i.i ], [ %.0.i.i, %bb.s ]
  %i.cd = icmp eq i32 %.2, -35
  br i1 %i.cd, label %bb.ac, label %bb.ad

bb.ac:                                            ; preds = %.thread72, %.thread
  %i.ce = call i32 @i915_gem_ww_ctx_backoff(ptr noundef nonnull %1) #13
  %.not58 = icmp eq i32 %i.ce, 0
  br i1 %.not58, label %bb.p, label %bb.ad

.loopexit:                                        ; preds = %bb.aa, %.thread67
...
bb.ad:                                            ; preds = %bb.ac, %.thread
  ...
  %i.ch = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %.val, i32 -1, ptr elementtype(i32) %.val) #14, !srcloc !20 ; 2 uses
  %i.ci = icmp eq i32 %i.ch, 1
  br i1 %i.ci, label %bb.ag, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.cj = icmp slt i32 %i.ch, 1
  br i1 %i.cj, label %bb.af, label %i915_vma_put.exit, !prof !21
...
bb.ag:                                            ; preds = %bb.ad
  ...
  call void @drm_gem_object_free(ptr noundef %.val) #13, !callees !23, !inline_history !3
  br label %i915_vma_put.exit

i915_vma_put.exit:                                ; preds = %bb.ae, %bb.af, %bb.ag
  call void @llvm.memset.p0.i64(ptr noundef align 8 dereferenceable(24) %i.a, i8 0, i64 24, i1 false)
  br label %bb.ah

bb.ah:                                            ; preds = %.loopexit, %i915_vma_put.exit, %bb.n, %bb.a, %bb.b, %__drm_to_dev.exit
...
bb.a:
  ...
  %i.at = load i8, ptr %i.as, align 8, !range !16, !noundef !17
...
.lr.ph:                                           ; preds = %bb.c, %.lr.ph
  %.118 = phi ptr [ %.1, %.lr.ph ], [ %.116, %bb.c ] ; 2 uses
...
._crit_edge:                                      ; preds = %.lr.ph, %bb.c
  %.1.lcssa = phi ptr [ %.116, %bb.c ], [ %.1, %.lr.ph ]
  ret ptr %.1.lcssa
}
