...
bb.l:                                             ; preds = %bb.k
  ...
  %or.cond = or i1 %i.u, %i.v                     ; 2 uses
  %.0 = select i1 %or.cond, i32 800, i32 900      ; 2 uses
  ...
  %9 = sdiv i32 %i.aa, 800
  %i.ab = sdiv i32 %i.aa, 900
  %10 = select i1 %or.cond, i32 %9, i32 %i.ab
  %i.ac = getelementptr i8, ptr %5, i64 108
  %i.ad = load i32, ptr %i.ac, align 4
  %i.ae = getelementptr i8, ptr %5, i64 112
  %i.af = load i32, ptr %i.ae, align 8
  %i.ag = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef %i.r, ptr noundef nonnull dereferenceable(1) @format_bandwidth, i32 noundef %i.x, i32 noundef %.0, i32 noundef %10, i32 noundef %i.ad, i32 noundef %i.af) #6
