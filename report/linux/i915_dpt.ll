Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/linux/original/i915_dpt?download=true
...
bb.a:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %2, i8 0, i64 56, i1 false), !annotation !22
  ...
  tail call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock incl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.h, ptr elementtype(i32) %i.h) #7, !srcloc !23
...
bb.b:                                             ; preds = %bb.a, %__i915_gem_ww_fini.exit
  %.03045 = phi ptr [ null, %bb.a ], [ %.13139, %__i915_gem_ww_fini.exit ] ; 3 uses
  %i.p = load ptr, ptr %i.c, align 8              ; 10 uses
  %i.q = load i8, ptr %i.i, align 8, !range !24, !noundef !11
...
bb.f:                                             ; preds = %bb.e
  %i.w = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.p, i32 1, ptr elementtype(i32) %i.p) #7, !srcloc !12 ; 3 uses
  %.not.i.i.i.i.i.i.i.i = icmp eq i32 %i.w, 0
  br i1 %.not.i.i.i.i.i.i.i.i, label %.sink.split.i.i.i.i.i.i.i.i, label %bb.g, !prof !13

bb.g:                                             ; preds = %bb.f
  %i.x = add i32 %i.w, 1
  %i.y = or i32 %i.x, %i.w
  %.not10.i.i.i.i.i.i.i.i = icmp sgt i32 %i.y, -1
...
bb.h:                                             ; preds = %bb.e, %i915_gem_object_get.exit.i.i
  %i.ac = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.p, i32 1, ptr elementtype(i32) %i.p) #7, !srcloc !12 ; 3 uses
  %.not.i.i.i.i.i.i19.i7.i = icmp eq i32 %i.ac, 0
  br i1 %.not.i.i.i.i.i.i19.i7.i, label %.sink.split.i.i.i.i.i.i21.i9.i, label %bb.i, !prof !13

bb.i:                                             ; preds = %bb.h
  %i.ad = add i32 %i.ac, 1
  %i.ae = or i32 %i.ad, %i.ac
  %.not10.i.i.i.i.i.i20.i8.i = icmp sgt i32 %i.ae, -1
  br i1 %.not10.i.i.i.i.i.i20.i8.i, label %i915_vma_get.exit.thread41, label %.sink.split.i.i.i.i.i.i21.i9.i, !prof !14
...
i915_vma_get.exit.thread41:                       ; preds = %.sink.split.i.i.i.i.i.i21.i9.i, %bb.i
...
bb.j:                                             ; preds = %bb.e, %i915_gem_object_get.exit.i.i, %i915_gem_object_get.exit.i.i
  ...
  %i.ag = call ptr @i915_gem_object_ggtt_pin_ww(ptr noundef %i.af, ptr noundef nonnull %2, ptr noundef null, i64 noundef 0, i64 noundef %i.l, i64 noundef %spec.select) #8 ; 10 uses
  %i.ah = icmp ugt ptr %i.ag, inttoptr (i64 -4096 to ptr)
  br i1 %i.ah, label %i915_vma_get.exit, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.ai = call ptr @i915_vma_pin_iomap(ptr noundef %i.ag) #8 ; 3 uses
  %i.aj = getelementptr i8, ptr %i.ag, i64 268    ; 2 uses
  call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock decl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.aj, ptr elementtype(i32) %i.aj) #7, !srcloc !25
  %i.ak = icmp ugt ptr %i.ai, inttoptr (i64 -4096 to ptr)
  br i1 %i.ak, label %i915_vma_get.exit, label %bb.l

bb.l:                                             ; preds = %bb.k
  store ptr %i.ag, ptr %i.m, align 8
  store ptr %i.ai, ptr %i.n, align 8
  %i.al = getelementptr i8, ptr %i.ag, i64 184
  %i.am = load ptr, ptr %i.al, align 8            ; 3 uses
  %i.an = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.am, i32 1, ptr elementtype(i32) %i.am) #7, !srcloc !12 ; 3 uses
  %.not.i.i.i.i.i.i.i = icmp eq i32 %i.an, 0
  br i1 %.not.i.i.i.i.i.i.i, label %.sink.split.i.i.i.i.i.i.i, label %bb.m, !prof !13

bb.m:                                             ; preds = %bb.l
  %i.ao = add i32 %i.an, 1
  %i.ap = or i32 %i.ao, %i.an
  %.not10.i.i.i.i.i.i.i = icmp sgt i32 %i.ap, -1
  br i1 %.not10.i.i.i.i.i.i.i, label %.thread10.i, label %.sink.split.i.i.i.i.i.i.i, !prof !14

.sink.split.i.i.i.i.i.i.i:                        ; preds = %bb.m, %bb.l
  %.sink.i.i.i.i.i.i.i = phi i32 [ 2, %bb.l ], [ 1, %bb.m ]
  call void @refcount_warn_saturate(ptr noundef %i.am, i32 noundef %.sink.i.i.i.i.i.i.i) #8
  br label %.thread10.i

i915_vma_get.exit:                                ; preds = %bb.k, %bb.j
  %.1.in.in = phi ptr [ %i.ag, %bb.j ], [ %i.ai, %bb.k ]
  %.1.in = ptrtoint ptr %.1.in.in to i64
  %.1 = trunc i64 %.1.in to i32                   ; 2 uses
  %i.aq = icmp eq i32 %.1, -35
  br i1 %i.aq, label %bb.n, label %.thread10.i

bb.n:                                             ; preds = %i915_vma_get.exit.thread41, %i915_vma_get.exit
  %.13144 = phi ptr [ %.03045, %i915_vma_get.exit.thread41 ], [ %i.ag, %i915_vma_get.exit ] ; 3 uses
  %i.ar = call i32 @i915_gem_ww_ctx_backoff(ptr noundef nonnull %2) #8 ; 2 uses
  switch i32 %i.ar, label %.thread10.i [
    i32 0, label %__i915_gem_ww_fini.exit
    i32 -35, label %__i915_gem_ww_fini.exit
  ]

.thread10.i:                                      ; preds = %bb.e, %i915_gem_object_get.exit.i.i, %.sink.split.i.i.i.i.i.i.i, %bb.m, %bb.n, %i915_vma_get.exit
  %.13140 = phi ptr [ %.13144, %bb.n ], [ %i.ag, %i915_vma_get.exit ], [ %i.ag, %.sink.split.i.i.i.i.i.i.i ], [ %i.ag, %bb.m ], [ %.03045, %i915_gem_object_get.exit.i.i ], [ %.03045, %bb.e ]
  %.013.i = phi i32 [ %i.ar, %bb.n ], [ %.1, %i915_vma_get.exit ], [ 0, %.sink.split.i.i.i.i.i.i.i ], [ 0, %bb.m ], [ %.0.i.i, %i915_gem_object_get.exit.i.i ], [ %.0.i.i, %bb.e ]
...
__i915_gem_ww_fini.exit:                          ; preds = %bb.n, %bb.n, %.thread10.i
  %.13139 = phi ptr [ %.13144, %bb.n ], [ %.13140, %.thread10.i ], [ %.13144, %bb.n ] ; 2 uses
  %.09.i = phi i32 [ -35, %bb.n ], [ %.013.i, %.thread10.i ], [ -35, %bb.n ] ; 3 uses
  %i.as = icmp eq i32 %.09.i, -35
  br i1 %i.as, label %bb.b, label %bb.o, !llvm.loop !21

bb.o:                                             ; preds = %__i915_gem_ww_fini.exit
  %i.at = load ptr, ptr %i.c, align 8
  %i.au = getelementptr i8, ptr %i.at, i64 912    ; 2 uses
  %i.av = load i8, ptr %i.au, align 8
  %i.aw = or i8 %i.av, 4
  store i8 %i.aw, ptr %i.au, align 8
  call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock decl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.h, ptr elementtype(i32) %i.h) #7, !srcloc !25
  call void @intel_runtime_pm_put_unchecked(ptr noundef %i.f) #8
  %.not = icmp eq i32 %.09.i, 0
  %i.ax = sext i32 %.09.i to i64
  %i.ay = inttoptr i64 %i.ax to ptr
  %i.az = select i1 %.not, ptr %.13139, ptr %i.ay
...
bb.a:
  ...
  %i.e = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %.val, i32 -1, ptr elementtype(i32) %.val) #7, !srcloc !12 ; 2 uses
  %i.f = icmp eq i32 %i.e, 1
  br i1 %i.f, label %bb.d, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.g = icmp slt i32 %i.e, 1
  br i1 %i.g, label %bb.c, label %i915_vma_put.exit, !prof !13
...
bb.d:                                             ; preds = %bb.a
  ...
  tail call void @drm_gem_object_free(ptr noundef %.val) #8, !callees !17, !inline_history !0
  br label %i915_vma_put.exit
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.ae = tail call i32 @ww_mutex_lock_interruptible(ptr noundef %i.ad, ptr noundef null) #8 ; 2 uses
  switch i32 %i.ae, label %.thread90 [
    i32 -35, label %bb.l
    i32 0, label %bb.n
    i32 -114, label %bb.n
  ]
...
bb.l:                                             ; preds = %bb.k
  %i.af = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %.1, i32 1, ptr elementtype(i32) %.1) #7, !srcloc !12 ; 3 uses
  %.not.i.i.i.i.i.i19.i.i = icmp eq i32 %i.af, 0
  br i1 %.not.i.i.i.i.i.i19.i.i, label %.sink.split.i.i.i.i.i.i21.i.i, label %bb.m, !prof !13

bb.m:                                             ; preds = %bb.l
  %i.ag = add i32 %i.af, 1
  %i.ah = or i32 %i.ag, %i.af
  %.not10.i.i.i.i.i.i20.i.i = icmp sgt i32 %i.ah, -1
  br i1 %.not10.i.i.i.i.i.i20.i.i, label %.thread, label %.sink.split.i.i.i.i.i.i21.i.i, !prof !14
...
bb.n:                                             ; preds = %bb.k, %bb.k
  %i.ai = tail call i32 @i915_gem_object_set_cache_level(ptr noundef %.1, i32 noundef 0) #8 ; 2 uses
  %i.aj = getelementptr i8, ptr %.1, i64 480
  %i.ak = load ptr, ptr %i.aj, align 8
  %i.al = getelementptr i8, ptr %i.ak, i64 80
  %i.am = load ptr, ptr %i.al, align 8            ; 2 uses
  %.not.i74 = icmp eq ptr %i.am, null
  br i1 %.not.i74, label %bb.p, label %bb.o

bb.o:                                             ; preds = %bb.n
  tail call void %i.am(ptr noundef %.1) #8, !inline_history !26
  br label %bb.p

bb.p:                                             ; preds = %bb.o, %bb.n
  %i.an = load ptr, ptr %i.ac, align 8
  tail call void @ww_mutex_unlock(ptr noundef %i.an) #8
  %.not70 = icmp eq i32 %i.ai, 0
  br i1 %.not70, label %bb.t, label %.thread90

.thread90:                                        ; preds = %bb.k, %.thread, %bb.p
  %.06579 = phi i32 [ -35, %.thread ], [ %i.ai, %bb.p ], [ %i.ae, %bb.k ]
  %i.ao = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %.1, i32 -1, ptr elementtype(i32) %.1) #7, !srcloc !12 ; 2 uses
  %i.ap = icmp eq i32 %i.ao, 1
  br i1 %i.ap, label %bb.s, label %bb.q

bb.q:                                             ; preds = %.thread90
  %i.aq = icmp slt i32 %i.ao, 1
  br i1 %i.aq, label %bb.r, label %i915_gem_object_put.exit, !prof !13
...
bb.s:                                             ; preds = %.thread90
  tail call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #7, !srcloc !16
  tail call void @drm_gem_object_free(ptr noundef %.1) #8, !callees !17, !inline_history !0
  br label %i915_gem_object_put.exit
...
bb.u:                                             ; preds = %bb.t
  %i.av = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %.1, i32 -1, ptr elementtype(i32) %.1) #7, !srcloc !12 ; 2 uses
  %i.aw = icmp eq i32 %i.av, 1
  br i1 %i.aw, label %bb.x, label %bb.v

bb.v:                                             ; preds = %bb.u
  %i.ax = icmp slt i32 %i.av, 1
  br i1 %i.ax, label %bb.w, label %i915_gem_object_put.exit75, !prof !13
...
bb.a:
  ...
  %i.f = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %0, i32 -1, ptr elementtype(i32) %0) #7, !srcloc !12 ; 2 uses
  %i.g = icmp eq i32 %i.f, 1
  br i1 %i.g, label %bb.d, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.h = icmp slt i32 %i.f, 1
  br i1 %i.h, label %bb.c, label %i915_vm_put.exit, !prof !13
...
bb.d:                                             ; preds = %bb.a
  tail call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #7, !srcloc !16
  tail call void @i915_vm_release(ptr noundef %0) #8, !callees !17, !inline_history !0
  br label %i915_vm_put.exit
