...
prepare_scan_control.exit:                        ; preds = %bb.v, %bb.w, %bb.x
  ...
  %i.dv = call i64 asm "movq %gs:${1:a}, $0", "=r,i,~{dirflag},~{fpsr},~{flags}"(ptr nonnull @current_task) #17, !srcloc !26
...
.split.i.i.i.i:                                   ; preds = %bb.y
  ...
  %i.ek = load i8, ptr @numa_demotion_enabled, align 1, !range !25
...
bb.ab:                                            ; preds = %can_reclaim_anon_pages.exit.thread.i.i.i
  ...
  br i1 %.not67.i.i.i, label %bb.ac, label %bb.ai, !prof !18

bb.ac:                                            ; preds = %bb.ab
  call void asm sideeffect "990: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 990b - ., 3; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 990) #15, !srcloc !172
  call void asm sideeffect "1:\09 ud2 \0A.pushsection __bug_table,\22aw\22\0A\09912: .pushsection .discard.annotate_data, \22M\22, @progbits, 8; .long 912b - ., 1; .popsection\0A\092:\0A\09\09.long 1b - .\09# bug_entry::bug_addr\0A\09.long ${0:c} - .\09# bug_entry::format\0A\09.long ${1:c} - .\09# bug_entry::file\0A\09.word ${2:c}\09# bug_entry::line\0A\09.word ${3:c}\09# bug_entry::flags\0A\09.org 2b + ${4:c}\0A.popsection\0A.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 1b - ., 8; .popsection", "i,i,i,i,i,~{dirflag},~{fpsr},~{flags}"(ptr nonnull @.str.51, ptr nonnull @.str.50, i32 2524, i32 2307, i64 16) #15, !srcloc !173
  call void asm sideeffect "991: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 991b - ., 4; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 991) #15, !srcloc !174
  br label %bb.ai
...
bb.al:                                            ; preds = %bb.ak, %.lr.ph.i.i.i.i.1
  ...
  br i1 %niter.ncmp.1, label %lruvec_lru_size.exit.i.i.i.unr-lcssa, label %.lr.ph.i.i.i.i, !llvm.loop !1
...
bb.ap:                                            ; preds = %bb.ao, %.lr.ph.i.1.i.i.i.1
  ...
  br i1 %niter383.ncmp.1, label %lruvec_lru_size.exit.1.i.i.i.loopexit.unr-lcssa, label %.lr.ph.i.1.i.i.i, !llvm.loop !1
...
bb.au:                                            ; preds = %bb.at, %.lr.ph.i.2.i.i.i.1
  ...
  br i1 %niter389.ncmp.1, label %lruvec_lru_size.exit.2.i.i.i.loopexit.unr-lcssa, label %.lr.ph.i.2.i.i.i, !llvm.loop !1

.thread273:                                       ; preds = %.thread, %bb.ar
  %.ph246 = phi i64 [ 0, %.thread ], [ %i.hl, %bb.ar ]
  %.ph248 = phi i8 [ %i.go, %.thread ], [ %i.hm, %bb.ar ]
  store i64 0, ptr %i.ag, align 16, !annotation !19
