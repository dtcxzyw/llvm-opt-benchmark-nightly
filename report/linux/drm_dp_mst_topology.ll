...
bb.j:                                             ; preds = %.split.us.i
  ...
  %i.dn = sub i32 %.042.us.i, %i.da               ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.et = sub i32 %.042.1.i, %i.ef                ; 2 uses
...
bb.o:                                             ; preds = %bb.n
  ...
  %i.fl = sub i32 %.042.2.i, %i.ex                ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.gd = sub i32 %.042.3.i, %i.fp                ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.gv = sub i32 %.042.4.i, %i.gh                ; 2 uses
...
bb.v:                                             ; preds = %bb.t
  ...
  %i.hd = sub i32 %.042.i, %i.dr                  ; 2 uses
