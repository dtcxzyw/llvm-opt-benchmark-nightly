Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/linux/original/kapi?download=true
inline.NumInlined: 7
inline.NumDeleted: 6
begin_hunk_0
...
module asm(target_features: "+cmov,+cx8,+fxsr,+retpoline-external-thunk,+retpoline-indirect-branches,+retpoline-indirect-calls,-aes,-amx-avx512,-avx,-avx10.1,-avx10.2,-avx2,-avx512bf16,-avx512bitalg,-avx512bmm,-avx512bw,-avx512cd,-avx512dq,-avx512f,-avx512fp16,-avx512ifma,-avx512vbmi,-avx512vbmi2,-avx512vl,-avx512vnni,-avx512vp2intersect,-avx512vpopcntdq,-avxifma,-avxneconvert,-avxvnni,-avxvnniint16,-avxvnniint8,-f16c,-fma,-fma4,-gfni,-kl,-mmx,-pclmul,-sha,-sha512,-sm3,-sm4,-sse,-sse2,-sse3,-sse4.1,-sse4.2,-sse4a,-ssse3,-vaes,-vpclmulqdq,-widekl,-x87,-xop", target_cpu: "x86-64")
    ".section \22.export_symbol\22,\22a\22 ; __export_symbol_pps_register_source: ; .asciz \22\22 ; .ascii \22\22 \22\\0\22 ; .balign 8 ; .quad pps_register_source ; .previous"
    ".section \22.export_symbol\22,\22a\22 ; __export_symbol_pps_unregister_source: ; .asciz \22\22 ; .ascii \22\22 \22\\0\22 ; .balign 8 ; .quad pps_unregister_source ; .previous"
    ".section \22.export_symbol\22,\22a\22 ; __export_symbol_pps_event: ; .asciz \22\22 ; .ascii \22\22 \22\\0\22 ; .balign 8 ; .quad pps_event ; .previous"
...
.thread72:                                        ; preds = %bb.f, %pps_add_offset.exit
  ...
  %.sroa.0.0 = phi i64 [ %i.c, %bb.f ], [ %i.ak, %pps_add_offset.exit ] ; 2 uses
  %i.am = getelementptr i8, ptr %0, i64 144
  ...
  %i.an = getelementptr i8, ptr %0, i64 136       ; 2 uses
  %i.ao = load i32, ptr %i.an, align 8
  %i.ap = add i32 %i.ao, 1
  store i32 %i.ap, ptr %i.an, align 8
  %i.aq = and i32 %i.p, 2
  %.not3275 = icmp eq i32 %i.aq, 0
  br i1 %.not3275, label %.thread78, label %bb.i

bb.i:                                             ; preds = %.thread72, %bb.h
  %.sroa.0.177 = phi i64 [ %.sroa.0.0, %.thread72 ], [ %i.c, %bb.h ] ; 4 uses
  %.sroa.14.176 = phi i32 [ %.sroa.14.0, %.thread72 ], [ %i.f, %bb.h ] ; 2 uses
  %i.ar = and i32 %i.n, 32
  %.not33 = icmp eq i32 %i.ar, 0
  br i1 %.not33, label %.thread, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.as = getelementptr i8, ptr %0, i64 120
...
.thread:                                          ; preds = %bb.i, %pps_add_offset.exit44
  %.sroa.14.2 = phi i32 [ %.sroa.14.176, %bb.i ], [ %.sroa.14.6, %pps_add_offset.exit44 ]
  %.sroa.0.2 = phi i64 [ %.sroa.0.177, %bb.i ], [ %i.bk, %pps_add_offset.exit44 ]
  %i.bl = getelementptr i8, ptr %0, i64 160
  store i64 %.sroa.0.2, ptr %i.bl, align 8
  ...
  %i.bm = getelementptr i8, ptr %0, i64 140       ; 2 uses
...
.thread78:                                        ; preds = %.thread72, %.thread
  %i.bp = getelementptr i8, ptr %0, i64 180       ; 2 uses
  %i.bq = load i32, ptr %i.bp, align 4
  %i.br = add i32 %i.bq, 1
  store i32 %i.br, ptr %i.bp, align 4
  %i.bs = getelementptr i8, ptr %0, i64 192
  %i.bt = tail call i32 @__wake_up(ptr noundef %i.bs, i32 noundef 1, i32 noundef 0, ptr noundef null) #9 ; 0 uses
  %i.bu = getelementptr i8, ptr %0, i64 992
  tail call void @kill_fasync(ptr noundef %i.bu, i32 noundef 29, i32 noundef 1) #9
  br label %bb.k
