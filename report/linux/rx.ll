...
begin_hunk_0_@ieee80211_rx_handlers:bb.a
  ...
  br i1 %.not.i, label %._crit_edge, label %bb.b, !llvm.loop !57
...
bb.b:                                             ; preds = %bb.a
  tail call void asm sideeffect "2286: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 2286b - ., 3; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 2286) #17, !srcloc !80
  tail call void asm sideeffect "1:\09 ud2 \0A.pushsection __bug_table,\22aw\22\0A\09912: .pushsection .discard.annotate_data, \22M\22, @progbits, 8; .long 912b - ., 1; .popsection\0A\092:\0A\09\09.long 1b - .\09# bug_entry::bug_addr\0A\09.long ${0:c} - .\09# bug_entry::format\0A\09.long ${1:c} - .\09# bug_entry::file\0A\09.word ${2:c}\09# bug_entry::line\0A\09.word ${3:c}\09# bug_entry::flags\0A\09.org 2b + ${4:c}\0A.popsection\0A.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 1b - ., 8; .popsection", "i,i,i,i,i,~{dirflag},~{fpsr},~{flags}"(ptr nonnull @.str, ptr nonnull @.str.1, i32 4434, i32 2305, i64 16) #17, !srcloc !81
  tail call void asm sideeffect "2287: nop\0A\09.pushsection .discard.annotate_insn, \22M\22, @progbits, 8; .long 2287b - ., 4; .popsection", "i,~{dirflag},~{fpsr},~{flags}"(i32 2287) #17, !srcloc !82
  br label %bb.v
...
bb.r:                                             ; preds = %bb.r, %.lr.ph.new
  ...
  br i1 %niter.ncmp.1.not, label %._crit_edge.unr-lcssa, label %bb.r, !llvm.loop !79
...
bb.t:                                             ; preds = %bb.s, %bb.p
  ...
  call fastcc void @ieee80211_rx_handlers(ptr noundef nonnull %6, ptr noundef nonnull %5) #18, !srcloc !85
  br label %bb.u
