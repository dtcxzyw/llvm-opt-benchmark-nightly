...
.lr.ph54.split.us.preheader:                      ; preds = %.lr.ph54
  ...
  %lcmp.mod85 = trunc i32 %.fr64 to i1
  %xtraiter86 = and i32 %.fr64, 1
  %i.w = icmp eq i32 %i.u, 0
  %unroll_iter90 = and i32 %.fr64, -2
  %lcmp.mod87.not = icmp eq i32 %xtraiter86, 0
  %lcmp.mod89 = trunc i32 %.fr64 to i1
...
.lr.ph54.split.us:                                ; preds = %.lr.ph54.split.us.preheader, %..loopexit_crit_edge.us
  ...
  %.04053.us = phi i32 [ %.3.us, %..loopexit_crit_edge.us ], [ 0, %.lr.ph54.split.us.preheader ] ; 5 uses
...
bb.f:                                             ; preds = %bb.e, %bb.d
  %.039.us.in = phi ptr [ %i.af, %bb.e ], [ %i.ad, %bb.d ]
  %.039.us = load i8, ptr %.039.us.in, align 1
  %.039.us.fr = freeze i8 %.039.us                ; 3 uses
  %i.ag = and i8 %.039.us.fr, 127
  %i.ah = zext nneg i8 %i.ag to i32
  %i.ai = mul nuw nsw i32 %i.ah, 5                ; 4 uses
  %or.cond48.us = icmp eq i8 %.039.us.fr, -1
...
.lr.ph.split.us61.new:                            ; preds = %.lr.ph.split.us61, %.lr.ph.split.us61.new
  %.151.us56 = phi i32 [ %.2.us58.1, %.lr.ph.split.us61.new ], [ %.04053.us, %.lr.ph.split.us61 ]
  %.04150.us57 = phi i32 [ %i.be, %.lr.ph.split.us61.new ], [ 0, %.lr.ph.split.us61 ] ; 4 uses
  %niter = phi i32 [ %niter.next.1, %.lr.ph.split.us61.new ], [ 0, %.lr.ph.split.us61 ]
  %i.aj = sext i32 %.04150.us57 to i64
  ...
  %i.ap = zext nneg i32 %.04150.us57 to i64
  %i.aq = shl nuw i64 1, %i.ap
  %i.ar = trunc i64 %i.aq to i32
  %i.as = select i1 %i.ao, i32 %i.ar, i32 0
  %.2.us58 = or i32 %.151.us56, %i.as
  %i.at = or disjoint i32 %.04150.us57, 1         ; 2 uses
  ...
  %i.be = add nuw i32 %.04150.us57, 2             ; 2 uses
  %niter.next.1 = add nuw i32 %niter, 2           ; 2 uses
  %niter.ncmp.1 = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %..loopexit_crit_edge.us.loopexit83.unr-lcssa, label %.lr.ph.split.us61.new, !llvm.loop !107

..loopexit_crit_edge.us.loopexit.unr-lcssa:       ; preds = %bb.j
  br i1 %lcmp.mod87.not, label %..loopexit_crit_edge.us.loopexit, label %.lr.ph.split.us.us.epil.preheader

.lr.ph.split.us.us.epil.preheader:                ; preds = %..loopexit_crit_edge.us.loopexit.unr-lcssa, %.lr.ph.split.us.us.preheader
  %.151.us.us.epil.init = phi i32 [ %.04053.us, %.lr.ph.split.us.us.preheader ], [ %.2.us.us.1, %..loopexit_crit_edge.us.loopexit.unr-lcssa ] ; 2 uses
  %.04150.us.us.epil.init = phi i32 [ 0, %.lr.ph.split.us.us.preheader ], [ %i.dn, %..loopexit_crit_edge.us.loopexit.unr-lcssa ] ; 2 uses
  tail call void @llvm.assume(i1 %lcmp.mod89)
  %i.bf = sext i32 %.04150.us.us.epil.init to i64
...
bb.g:                                             ; preds = %.lr.ph.split.us.us.epil.preheader
  %i.bm = zext nneg i32 %.04150.us.us.epil.init to i64
  %i.bn = shl nuw i64 1, %i.bm
  %i.bo = trunc i64 %i.bn to i32                  ; 2 uses
  %i.bp = or i32 %.151.us.us.epil.init, %i.bo
...
..loopexit_crit_edge.us.loopexit:                 ; preds = %.lr.ph.split.us.us.epil.preheader, %bb.g, %..loopexit_crit_edge.us.loopexit.unr-lcssa
  %.2.us.us.lcssa = phi i32 [ %.2.us.us.1, %..loopexit_crit_edge.us.loopexit.unr-lcssa ], [ %i.bp, %bb.g ], [ %.151.us.us.epil.init, %.lr.ph.split.us.us.epil.preheader ]
  %.pre = load i8, ptr %i.k, align 2
  %.pre70 = load i8, ptr %i.l, align 2
  br label %..loopexit_crit_edge.us

..loopexit_crit_edge.us.loopexit83.unr-lcssa:     ; preds = %.lr.ph.split.us61.new
  br i1 %lcmp.mod.not, label %..loopexit_crit_edge.us, label %.epil.preheader

.epil.preheader:                                  ; preds = %..loopexit_crit_edge.us.loopexit83.unr-lcssa, %.lr.ph.split.us61
  %.151.us56.epil.init = phi i32 [ %.04053.us, %.lr.ph.split.us61 ], [ %.2.us58.1, %..loopexit_crit_edge.us.loopexit83.unr-lcssa ]
  %.04150.us57.epil.init = phi i32 [ 0, %.lr.ph.split.us61 ], [ %i.be, %..loopexit_crit_edge.us.loopexit83.unr-lcssa ] ; 2 uses
  tail call void @llvm.assume(i1 %lcmp.mod85)
  %i.bs = sext i32 %.04150.us57.epil.init to i64
  ...
  %i.by = zext nneg i32 %.04150.us57.epil.init to i64
  %i.bz = shl nuw i64 1, %i.by
  %i.ca = trunc i64 %i.bz to i32
  %i.cb = select i1 %i.bx, i32 %i.ca, i32 0
  %.2.us58.epil = or i32 %.151.us56.epil.init, %i.cb
  br label %..loopexit_crit_edge.us

..loopexit_crit_edge.us:                          ; preds = %.epil.preheader, %..loopexit_crit_edge.us.loopexit83.unr-lcssa, %..loopexit_crit_edge.us.loopexit, %bb.f
  %i.cc = phi i8 [ %i.x, %bb.f ], [ %.pre70, %..loopexit_crit_edge.us.loopexit ], [ %i.x, %..loopexit_crit_edge.us.loopexit83.unr-lcssa ], [ %i.x, %.epil.preheader ] ; 2 uses
  %i.cd = phi i8 [ %i.y, %bb.f ], [ %.pre, %..loopexit_crit_edge.us.loopexit ], [ %i.y, %..loopexit_crit_edge.us.loopexit83.unr-lcssa ], [ %i.y, %.epil.preheader ] ; 2 uses
  %.3.us = phi i32 [ %.04053.us, %bb.f ], [ %.2.us.us.lcssa, %..loopexit_crit_edge.us.loopexit ], [ %.2.us58.1, %..loopexit_crit_edge.us.loopexit83.unr-lcssa ], [ %.2.us58.epil, %.epil.preheader ] ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
...
.lr.ph.split.us.us:                               ; preds = %.lr.ph.split.us.us.preheader, %bb.j
  %.151.us.us = phi i32 [ %.2.us.us.1, %bb.j ], [ %.04053.us, %.lr.ph.split.us.us.preheader ] ; 2 uses
  %.04150.us.us = phi i32 [ %i.dn, %bb.j ], [ 0, %.lr.ph.split.us.us.preheader ] ; 4 uses
  %niter91 = phi i32 [ %niter91.next.1, %bb.j ], [ 0, %.lr.ph.split.us.us.preheader ]
  %i.cm = sext i32 %.04150.us.us to i64
...
bb.h:                                             ; preds = %.lr.ph.split.us.us
  %i.ct = zext nneg i32 %.04150.us.us to i64
  %i.cu = shl nuw i64 1, %i.ct
  %i.cv = trunc i64 %i.cu to i32                  ; 2 uses
  %i.cw = or i32 %.151.us.us, %i.cv
...
.lr.ph.split.us.us.1:                             ; preds = %bb.h, %.lr.ph.split.us.us
  %.2.us.us = phi i32 [ %i.cw, %bb.h ], [ %.151.us.us, %.lr.ph.split.us.us ] ; 2 uses
  %i.cz = or disjoint i32 %.04150.us.us, 1        ; 2 uses
...
bb.j:                                             ; preds = %bb.i, %.lr.ph.split.us.us.1
  ...
  %i.dn = add nuw i32 %.04150.us.us, 2            ; 2 uses
  %niter91.next.1 = add nuw i32 %niter91, 2       ; 2 uses
  %niter91.ncmp.1 = icmp eq i32 %niter91.next.1, %unroll_iter90
  br i1 %niter91.ncmp.1, label %..loopexit_crit_edge.us.loopexit.unr-lcssa, label %.lr.ph.split.us.us, !llvm.loop !107

.loopexit49:                                      ; preds = %..loopexit_crit_edge.us, %.lr.ph54, %.critedge, %bb.b
  %.0 = phi i32 [ 1, %bb.b ], [ 0, %.critedge ], [ 0, %.lr.ph54 ], [ %.3.us, %..loopexit_crit_edge.us ]
  ret i32 %.0
}
