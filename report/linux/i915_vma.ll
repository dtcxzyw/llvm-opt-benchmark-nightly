Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/linux/original/i915_vma?download=true
...
__drm_to_dev.exit:                                ; preds = %bb.g, %bb.h
  ...
  tail call void (ptr, ptr, i32, ptr, ...) @__drm_dev_dbg(ptr noundef null, ptr noundef %i.bg, i32 noundef 1, ptr noundef nonnull @.str.10, i64 noundef %.0142, ptr noundef nonnull %i.bh, i64 noundef %.1150) #14
  br label %.thread
...
bb.l:                                             ; preds = %bb.k
  %.not165 = icmp uge i64 %i.ab, %.1150
  %i.bv = sub nuw i64 %.1150, %i.ab
...
fls64.exit:                                       ; preds = %bb.r
  ...
  %i.ct = tail call i32 asm "bsrq $1,${0:q}", "=r,r,0,~{dirflag},~{fpsr},~{flags}"(i64 range(i64 2097152, 4294967296) %i.cs, i32 -1) #19, !srcloc !59
  ...
  %i.cy = and i64 %i.cx, -2097152
  %.1143 = select i1 %.not163, i64 %i.cf, i64 %i.cy
  br label %bb.s
...
bb.s:                                             ; preds = %fls64.exit, %bb.r, %bb.q, %bb.p
  ...
  %i.cz = tail call i32 @i915_gem_gtt_insert(ptr noundef %i.ae, ptr noundef %1, ptr noundef %0, i64 noundef %.2, i64 noundef %.1145, i64 noundef %.0146, i64 noundef %i.ac, i64 noundef %.1150, i32 noundef %i.t) #14 ; 2 uses
  %.not164 = icmp eq i32 %i.cz, 0
  br i1 %.not164, label %bb.t, label %.thread

bb.t:                                             ; preds = %bb.s, %bb.o
  %i.da = getelementptr i8, ptr %0, i64 488       ; 4 uses
  %i.db = load ptr, ptr %i.ad, align 8            ; 2 uses
  %i.dc = getelementptr i8, ptr %i.db, i64 488
  %i.dd = getelementptr i8, ptr %0, i64 496       ; 2 uses
  %i.de = load ptr, ptr %i.dd, align 8            ; 2 uses
  %i.df = load ptr, ptr %i.da, align 8            ; 2 uses
  %i.dg = getelementptr i8, ptr %i.df, i64 8
  store ptr %i.de, ptr %i.dg, align 8
  store volatile ptr %i.df, ptr %i.de, align 8
  %i.dh = getelementptr i8, ptr %i.db, i64 496    ; 2 uses
  %i.di = load ptr, ptr %i.dh, align 8            ; 2 uses
  store ptr %i.da, ptr %i.dh, align 8
  store ptr %i.dc, ptr %i.da, align 8
  store ptr %i.di, ptr %i.dd, align 8
  store volatile ptr %i.da, ptr %i.di, align 8
  %i.dj = trunc i64 %i.z to i32
  store i32 %i.dj, ptr %i.q, align 8
  br label %.thread

.thread:                                          ; preds = %bb.n, %bb.l, %bb.k, %bb.m, %bb.s, %bb.o, %bb.t, %__drm_to_dev.exit
  %.1 = phi i32 [ -28, %__drm_to_dev.exit ], [ 0, %bb.t ], [ %i.ce, %bb.o ], [ %i.cz, %bb.s ], [ -28, %bb.n ], [ -22, %bb.l ], [ -22, %bb.k ], [ -28, %bb.m ]
  ret i32 %.1
}
...
bb.b:                                             ; preds = %bb.k, %bb.a
  ...
  %i.g = load i8, ptr %i.b, align 8, !range !37, !noundef !38
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  switch i32 %.0.i.i, label %.thread14 [
    i32 0, label %bb.f
    i32 -35, label %bb.h
    i32 -114, label %bb.j
  ]
...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %.not10.i.i.i.i.i.i20.i8.i, label %.thread, label %.sink.split.i.i.i.i.i.i21.i9.i, !prof !16
...
.thread14:                                        ; preds = %bb.e, %i915_gem_object_get.exit.i.i, %bb.k, %bb.j
  %.1 = phi i32 [ %i.x, %bb.k ], [ %i.v, %bb.j ], [ %.0.i.i, %i915_gem_object_get.exit.i.i ], [ %.0.i.i, %bb.e ]
...
bb.b:                                             ; preds = %bb.a
  %i.a = tail call fastcc i32 @__i915_ggtt_pin(ptr noundef %0, ptr noundef nonnull %1, i32 noundef %2, i32 noundef %3) #15, !srcloc !61
  br label %.loopexit
...
bb.d:                                             ; preds = %bb.c, %__i915_gem_ww_fini.exit
  ...
  %i.h = load i8, ptr %i.c, align 8, !range !37, !noundef !38
...
bb.h:                                             ; preds = %bb.g
  %i.n = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.g, i32 1, ptr elementtype(i32) %i.g) #16, !srcloc !18 ; 3 uses
  %.not.i.i.i.i.i.i.i.i = icmp eq i32 %i.n, 0
  br i1 %.not.i.i.i.i.i.i.i.i, label %.sink.split.i.i.i.i.i.i.i.i, label %bb.i, !prof !13
...
bb.j:                                             ; preds = %bb.g, %i915_gem_object_get.exit.i.i
  %i.t = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.g, i32 1, ptr elementtype(i32) %i.g) #16, !srcloc !18 ; 3 uses
  %.not.i.i.i.i.i.i19.i7.i = icmp eq i32 %i.t, 0
  br i1 %.not.i.i.i.i.i.i19.i7.i, label %.sink.split.i.i.i.i.i.i21.i9.i, label %bb.k, !prof !13
...
.thread:                                          ; preds = %.sink.split.i.i.i.i.i.i21.i9.i, %bb.k
  store ptr %i.g, ptr %i.f, align 8
  br label %bb.m

bb.l:                                             ; preds = %bb.g, %i915_gem_object_get.exit.i.i, %i915_gem_object_get.exit.i.i
  %i.w = call fastcc i32 @__i915_ggtt_pin(ptr noundef %0, ptr noundef nonnull %4, i32 noundef %2, i32 noundef %3) #15, !srcloc !62 ; 2 uses
  %i.x = icmp eq i32 %i.w, -35
  br i1 %i.x, label %bb.m, label %.thread10.i

bb.m:                                             ; preds = %.thread, %bb.l
  %i.y = call i32 @i915_gem_ww_ctx_backoff(ptr noundef nonnull %4) #14 ; 2 uses
  switch i32 %i.y, label %.thread10.i [
    i32 0, label %__i915_gem_ww_fini.exit
    i32 -35, label %__i915_gem_ww_fini.exit
  ]

.thread10.i:                                      ; preds = %bb.g, %i915_gem_object_get.exit.i.i, %bb.m, %bb.l
  %.013.i = phi i32 [ %i.y, %bb.m ], [ %i.w, %bb.l ], [ %.0.i.i, %i915_gem_object_get.exit.i.i ], [ %.0.i.i, %bb.g ]
  call void @i915_gem_ww_ctx_fini(ptr noundef nonnull %4) #14
  br label %__i915_gem_ww_fini.exit

__i915_gem_ww_fini.exit:                          ; preds = %bb.m, %bb.m, %.thread10.i
  %.09.i = phi i32 [ -35, %bb.m ], [ %.013.i, %.thread10.i ], [ -35, %bb.m ] ; 2 uses
  %i.z = icmp eq i32 %.09.i, -35
  br i1 %i.z, label %bb.d, label %.loopexit, !llvm.loop !60
...
bb.d:                                             ; preds = %bb.c
  ...
  tail call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock decl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.j, ptr elementtype(i32) %i.j) #16, !srcloc !29
  br label %.loopexit
