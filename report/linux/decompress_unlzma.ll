...
.thread:                                          ; preds = %bb.a, %bb.b
  %.076107 = phi ptr [ %i.c, %bb.b ], [ %0, %bb.a ] ; 11 uses
...
bb.d:                                             ; preds = %.thread, %bb.g
  ...
  %i.t = phi ptr [ %.076107, %.thread ], [ %i.ab, %bb.g ] ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  %i.w = call i64 %nofill..i(ptr noundef nonnull %.076107, i64 noundef 65536) #11, !inline_history !11 ; 3 uses
...
._crit_edge:                                      ; preds = %bb.j, %.lr.ph127.preheader, %.preheader114
  ...
  %.070.lcssa = phi i32 [ %i.al, %.preheader114 ], [ %i.av, %.lr.ph127.preheader ], [ 0, %bb.j ] ; 2 uses
  %.069.lcssa = phi i32 [ 0, %.preheader114 ], [ %i.at, %.lr.ph127.preheader ], [ 0, %bb.j ]
...
read_int.exit101:                                 ; preds = %bb.l
  %notmask = shl nsw i32 -1, %.069.lcssa
  %i.bi = xor i32 %notmask, -1
  %notmask86 = shl nsw i32 -1, %.070.lcssa
...
bb.p:                                             ; preds = %.thread108, %bb.o
  %i.bt = add nsw i32 %.070.lcssa, %.068.lcssa162
...
bb.q:                                             ; preds = %.preheader168
  %i.ce = call i64 %nofill..i(ptr noundef nonnull %.076107, i64 noundef 65536) #11, !inline_history !16 ; 3 uses
...
rc_read.exit.i:                                   ; preds = %bb.r, %bb.q
  %i.cg = getelementptr i8, ptr %.076107, i64 %i.ce ; 2 uses
  store ptr %i.cg, ptr %i.p, align 8
  br label %bb.s

bb.s:                                             ; preds = %rc_read.exit.i, %.preheader168
  %i.ch = phi ptr [ %.076107, %rc_read.exit.i ], [ %i.cd, %.preheader168 ] ; 2 uses
...
.thread110:                                       ; preds = %bb.z, %bb.x, %bb.v, %bb.ac, %bb.ad
  %.077 = phi i32 [ 0, %bb.ad ], [ -1, %bb.ac ], [ -1, %bb.v ], [ -1, %bb.x ], [ -1, %bb.z ]
  call void @vfree(ptr noundef nonnull %i.by) #11
  br label %bb.ae

bb.ae:                                            ; preds = %bb.p, %.thread110
  %.178 = phi i32 [ -1, %bb.p ], [ %.077, %.thread110 ] ; 2 uses
...
bb.ag:                                            ; preds = %bb.ae, %bb.af, %bb.o, %bb.i
  %.2 = phi i32 [ -1, %bb.i ], [ -1, %bb.o ], [ %.178, %bb.ae ], [ %.178, %bb.af ] ; 2 uses
  br i1 %.not, label %bb.ah, label %bb.ai

bb.ah:                                            ; preds = %bb.ag
  call void @kfree(ptr noundef nonnull %.076107) #11
  br label %bb.ai
