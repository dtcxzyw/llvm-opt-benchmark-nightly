...
bb.a:
  ...
  %2 = icmp eq i32 %i.d, -114
  %spec.store.select.i.i = select i1 %2, i32 0, i32 %i.d
...
.thread10.i:                                      ; preds = %7, %bb.j, %bb.l, %bb.k
  %.11423 = phi ptr [ %.11427, %bb.l ], [ %i.t, %bb.k ], [ %i.t, %bb.j ], [ %.013, %7 ]
  %.013.i = phi i32 [ %i.y, %bb.l ], [ %i.w, %bb.k ], [ 0, %bb.j ], [ %.0.i.i, %7 ]
