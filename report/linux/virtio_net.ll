...
bb.e:                                             ; preds = %bb.d
  ...
  %3 = zext nneg i32 %1 to i64                    ; 3 uses
  %i.z = getelementptr [1728 x i8], ptr %i.y, i64 %3
  %i.aa = getelementptr i8, ptr %i.z, i64 600
  tail call void @mutex_lock(ptr noundef %i.aa) #24
  %i.ab = load ptr, ptr %i.x, align 8
  %i.ac = getelementptr [1728 x i8], ptr %i.ab, i64 %3 ; 4 uses
...
virtnet_send_rx_notf_coal_vq_cmds.exit.i:         ; preds = %.thread40.i.i, %bb.i
  ...
  %i.av = getelementptr [1728 x i8], ptr %i.au, i64 %3
