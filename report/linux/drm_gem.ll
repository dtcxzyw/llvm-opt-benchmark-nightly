...
.split.us:                                        ; preds = %.split.us.preheader, %bb.g
  %.040.us = phi i32 [ %i.ai, %bb.g ], [ -1, %.split.us.preheader ] ; 5 uses
  %.not.us = icmp eq i32 %.040.us, -1             ; 2 uses
  br i1 %.not.us, label %.thread.us, label %bb.b

bb.b:                                             ; preds = %.split.us
  %i.l = sext i32 %.040.us to i64
