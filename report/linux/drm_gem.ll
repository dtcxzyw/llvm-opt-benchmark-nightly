Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/linux/original/drm_gem?download=true
...
._crit_edge.us:                                   ; preds = %.lr.ph55.us, %.preheader.us
  %.not46.us = icmp slt i32 %.038.us, %i.ah
...
bb.f:                                             ; preds = %._crit_edge.us
  ...
  tail call void @ww_mutex_unlock(ptr noundef %i.af) #12
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %._crit_edge.us
  %i.ag = icmp eq i32 %i.x, -35
  br i1 %i.ag, label %.split.us, label %.thread48
...
bb.a:
  ...
  call void @mutex_lock(ptr noundef %i.c) #12
  %i.d = getelementptr i8, ptr %1, i64 8          ; 3 uses
  %.not63 = icmp eq ptr %5, null
  %i.e = getelementptr i8, ptr %5, i64 8
end_hunk_0
