...
module asm(target_features: "+cmov,+cx8,+fxsr,+retpoline-external-thunk,+retpoline-indirect-branches,+retpoline-indirect-calls,-aes,-amx-avx512,-avx,-avx10.1,-avx10.2,-avx2,-avx512bf16,-avx512bitalg,-avx512bmm,-avx512bw,-avx512cd,-avx512dq,-avx512f,-avx512fp16,-avx512ifma,-avx512vbmi,-avx512vbmi2,-avx512vl,-avx512vnni,-avx512vp2intersect,-avx512vpopcntdq,-avxifma,-avxneconvert,-avxvnni,-avxvnniint16,-avxvnniint8,-f16c,-fma,-fma4,-gfni,-kl,-mmx,-pclmul,-sha,-sha512,-sm3,-sm4,-sse,-sse2,-sse3,-sse4.1,-sse4.2,-sse4a,-ssse3,-vaes,-vpclmulqdq,-widekl,-x87,-xop", target_cpu: "x86-64")
    ".section \22.export_symbol\22,\22a\22 ; __export_symbol_lzo1x_1_compress: ; .asciz \22GPL\22 ; .ascii \22\22 \22\\0\22 ; .balign 8 ; .quad lzo1x_1_compress ; .previous"
    ".section \22.export_symbol\22,\22a\22 ; __export_symbol_lzorle1x_1_compress: ; .asciz \22GPL\22 ; .ascii \22\22 \22\\0\22 ; .balign 8 ; .quad lzorle1x_1_compress ; .previous"

@__UNIQUE_ID_addressable_lzo1x_1_compress_434 = internal global ptr @lzo1x_1_compress, section ".discard.addressable", align 8
@__UNIQUE_ID_addressable_lzorle1x_1_compress_435 = internal global ptr @lzorle1x_1_compress, section ".discard.addressable", align 8
@llvm.compiler.used = appending global [2 x ptr] [ptr @__UNIQUE_ID_addressable_lzo1x_1_compress_434, ptr @__UNIQUE_ID_addressable_lzorle1x_1_compress_435], section "llvm.metadata"
...
define dso_local noundef i32 @lzo1x_1_compress(ptr noundef %0, i64 noundef %1, ptr noundef %2, ptr nofree noundef writeonly captures(none) %3, ptr nofree noundef captures(none) %4) #0 align 16 prefalign(16) {
bb.a:
  tail call fastcc void @lzogeneric1x_1_compress(ptr noundef %0, i64 noundef %1, ptr noundef %2, ptr noundef %3, ptr noundef %4, i8 noundef zeroext 0) #6
  ret i32 0
}

; Function Attrs: fn_ret_thunk_extern nofree norecurse noredzone nosync nounwind null_pointer_is_valid sspstrong memory(readwrite, inaccessiblemem: none, target_mem: none)
define internal fastcc void @lzogeneric1x_1_compress(ptr noundef %0, i64 noundef %1, ptr noundef %2, ptr nofree noundef writeonly captures(none) %3, ptr nofree noundef captures(none) %4, i8 noundef zeroext range(i8 0, 2) %5) unnamed_addr #0 align 16 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = getelementptr i8, ptr %2, i64 2          ; 2 uses
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  %.059 = phi i64 [ 49151, %bb.b ], [ 49152, %bb.a ]
  %i.g = icmp ugt i64 %1, 20
  br i1 %i.g, label %.lr.ph, label %.thread

.lr.ph:                                           ; preds = %bb.c, %bb.d
  %.05480 = phi ptr [ %i.o, %bb.d ], [ %0, %bb.c ] ; 3 uses
  %.05679 = phi i64 [ %i.p, %bb.d ], [ %1, %bb.c ] ; 3 uses
  %i.h = tail call i64 @llvm.umin.i64(i64 %.05679, i64 %.059) ; 5 uses
  %i.i = ptrtoint ptr %.05480 to i64
  %i.j = add i64 %i.h, %i.i                       ; 2 uses
  %i.k = load i64, ptr %i.b, align 8              ; 2 uses
  %i.l = add i64 %i.k, %i.h
  %i.m = lshr i64 %i.l, 5
  %i.n = add i64 %i.m, %i.j
  %.not68 = icmp ugt i64 %i.n, %i.j
  br i1 %.not68, label %bb.d, label %.thread.loopexit

bb.d:                                             ; preds = %.lr.ph
  tail call void @llvm.memset.p0.i64(ptr noundef align 1 dereferenceable(16384) %4, i8 0, i64 16384, i1 false)
  call fastcc void @lzo1x_1_do_compress(ptr noundef %.05480, i64 noundef %i.h, ptr noundef nonnull %i.a, ptr noundef nonnull %i.b, ptr noundef %4, ptr noundef nonnull %i.c, i8 noundef zeroext %5) #6
  %i.o = getelementptr i8, ptr %.05480, i64 %i.h
  %i.p = sub nuw i64 %.05679, %i.h                ; 3 uses
  %i.q = icmp ugt i64 %i.p, 20
  br i1 %i.q, label %.lr.ph, label %..thread.loopexit_crit_edge

..thread.loopexit_crit_edge:                      ; preds = %bb.d
  %.pre.pre = load i64, ptr %i.b, align 8
  br label %.thread.loopexit

.thread.loopexit:                                 ; preds = %.lr.ph, %..thread.loopexit_crit_edge
  %.pre = phi i64 [ %.pre.pre, %..thread.loopexit_crit_edge ], [ %i.k, %.lr.ph ]
  %.056.lcssa.ph = phi i64 [ %i.p, %..thread.loopexit_crit_edge ], [ %.05679, %.lr.ph ]
  %.pre102.pre = load ptr, ptr %i.a, align 8
  br label %.thread

.thread:                                          ; preds = %.thread.loopexit, %bb.c
  %.pre102 = phi ptr [ %i.f, %bb.c ], [ %.pre102.pre, %.thread.loopexit ] ; 9 uses
  %i.r = phi i64 [ 0, %bb.c ], [ %.pre, %.thread.loopexit ]
  %.056.lcssa = phi i64 [ %1, %bb.c ], [ %.056.lcssa.ph, %.thread.loopexit ]
  %i.s = add i64 %i.r, %.056.lcssa                ; 15 uses
  store i64 %i.s, ptr %i.b, align 8
  %.not69 = icmp eq i64 %i.s, 0
  br i1 %.not69, label %.loopexit, label %bb.e

bb.e:                                             ; preds = %.thread
  %i.t = getelementptr i8, ptr %0, i64 %1
  %i.u = sub i64 0, %i.s
  %i.v = getelementptr i8, ptr %i.t, i64 %i.u     ; 3 uses
  %i.w = icmp eq ptr %.pre102, %i.f
  %i.x = icmp ult i64 %i.s, 239
