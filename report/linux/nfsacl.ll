...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %.not.i, label %xdr_stream_encode_u32.exit.thread, label %bb.f, !prof !12
...
10:                                               ; preds = %9, %8, %.lr.ph.i.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !17
...
bb.m:                                             ; preds = %bb.l
  %i.ap = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %i.q, i32 -1, ptr nonnull elementtype(i32) %i.q) #8, !srcloc !15 ; 2 uses
  %i.aq = icmp eq i32 %i.ap, 1
  br i1 %i.aq, label %bb.p, label %bb.n

bb.n:                                             ; preds = %bb.m
  %i.ar = icmp slt i32 %i.ap, 1
  br i1 %i.ar, label %bb.o, label %posix_acl_release.exit, !prof !12
...
bb.a:
  ...
  br i1 %.not.i, label %posix_acl_release.exit, label %xdr_stream_decode_u32.exit, !prof !12
...
bb.n:                                             ; preds = %bb.m
  %i.ar = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %i.s, i32 -1, ptr nonnull elementtype(i32) %i.s) #8, !srcloc !15 ; 2 uses
  %i.as = icmp eq i32 %i.ar, 1
  br i1 %i.as, label %bb.q, label %bb.o

bb.o:                                             ; preds = %bb.n
  %i.at = icmp slt i32 %i.ar, 1
  br i1 %i.at, label %bb.p, label %posix_acl_release.exit, !prof !12
...
!15 = !{i64 2148952581, i64 2148952620, i64 2148952641, i64 2148952678, i64 2148952701, i64 2148952710}
!16 = !{i64 2151092380}
!17 = distinct !{!17, !13}
!18 = distinct !{!18, !13}
end_hunk_0
