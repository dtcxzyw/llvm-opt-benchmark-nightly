Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/linux/original/i915_overlay?download=true
inline.NumInlined: 138
inline.NumDeleted: 56
begin_hunk_0_@i915_overlay_off:bb.a
  %.val.i44 = load ptr, ptr %i.t, align 8
  br label %dev_name.exit45

dev_name.exit45:                                  ; preds = %__drm_to_dev.exit41, %bb.d
  %.0.i43 = phi ptr [ %.val.i44, %bb.d ], [ %i.v, %__drm_to_dev.exit41 ]
  tail call void (ptr, ...) @__SCT__WARN_trap(ptr noundef %i.r, ptr noundef %i.s, ptr noundef %.0.i43, ptr noundef nonnull @.str.3) #8
  tail call void asm sideeffect "", "~{dirflag},~{fpsr},~{flags}"() #9, !srcloc !24
  br label %bb.e

bb.e:                                             ; preds = %dev_name.exit45, %bb.a
  %i.w = or i32 %i.d, 1                           ; 2 uses
  %i.x = getelementptr i8, ptr %i.b, i64 216
  store ptr @i915_overlay_off_tail, ptr %i.x, align 8
...
bb.k:                                             ; preds = %bb.i
  ...
  tail call fastcc void @i915_overlay_flip_prepare(ptr noundef %i.b, ptr noundef null) #10, !srcloc !25
  tail call void @i915_request_add(ptr noundef %.0.i47) #8
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.h = tail call i32 %i.g(ptr noundef %i.e, i32 8364, i1 noundef zeroext true) #8, !inline_history !26
  %i.i = and i32 %i.h, 512
  %.not18 = icmp eq i32 %i.i, 0
  br i1 %.not18, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  tail call fastcc void @i915_overlay_release_old_vma(ptr noundef %i.b) #10, !srcloc !14
  br label %bb.k
...
bb.a:
  ...
  tail call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock incl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.a, ptr elementtype(i32) %i.a) #9, !srcloc !27
...
bb.b:                                             ; preds = %bb.k, %bb.a
  %.015 = phi ptr [ null, %bb.a ], [ %.11631, %bb.k ] ; 3 uses
  %i.i = load i8, ptr %i.b, align 8, !range !28, !noundef !29
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.0.i.i = phi i32 [ %i.l, %bb.c ], [ %i.m, %bb.d ] ; 4 uses
...
bb.f:                                             ; preds = %bb.e
  %i.n = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %1, i32 1, ptr elementtype(i32) %1) #9, !srcloc !15 ; 3 uses
...
bb.h:                                             ; preds = %bb.e, %i915_gem_object_get.exit.i.i
  %i.r = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %1, i32 1, ptr elementtype(i32) %1) #9, !srcloc !15 ; 3 uses
...
bb.i:                                             ; preds = %bb.h
  ...
  br i1 %.not10.i.i.i.i.i.i20.i8.i, label %PTR_ERR_OR_ZERO.exit.thread28, label %.sink.split.i.i.i.i.i.i21.i9.i, !prof !11
...
PTR_ERR_OR_ZERO.exit.thread:                      ; preds = %bb.e, %i915_gem_object_get.exit.i.i, %bb.j, %bb.k, %PTR_ERR_OR_ZERO.exit
  %.11627 = phi ptr [ %.11631, %bb.k ], [ %i.u, %PTR_ERR_OR_ZERO.exit ], [ %i.u, %bb.j ], [ %.015, %i915_gem_object_get.exit.i.i ], [ %.015, %bb.e ] ; 3 uses
  %.1 = phi i32 [ %i.z, %bb.k ], [ %i.x, %PTR_ERR_OR_ZERO.exit ], [ 0, %bb.j ], [ %.0.i.i, %i915_gem_object_get.exit.i.i ], [ %.0.i.i, %bb.e ] ; 2 uses
  call void @i915_gem_ww_ctx_fini(ptr noundef nonnull %3) #8
  call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock decl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.a, ptr elementtype(i32) %i.a) #9, !srcloc !16
...
bb.a:
  ...
  tail call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock decl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.a, ptr elementtype(i32) %i.a) #9, !srcloc !16
  ret void
}
...
.preheader.i.i.i.i.i.i:                           ; preds = %bb.b, %arch_atomic_try_cmpxchg.exit.i.i.i.i.i.i
  ...
  %i.f = tail call { i8, i32 } asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgl $3, $1", "={@ccz},=*m,={ax},r,*m,2,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %i.c, i32 %i.e, ptr nonnull elementtype(i32) %i.c, i32 %.0.i.i.i.i.i.i) #9, !srcloc !31 ; 2 uses
...
__drm_to_dev.exit:                                ; preds = %bb.d, %bb.e
  ...
  %i.s = tail call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr nonnull elementtype(i32) %i.c, i32 -1, ptr nonnull elementtype(i32) %i.c) #9, !srcloc !15 ; 2 uses
  %i.t = icmp eq i32 %i.s, 1
  br i1 %i.t, label %bb.h, label %bb.f

bb.f:                                             ; preds = %__drm_to_dev.exit
  %i.u = icmp slt i32 %i.s, 1
  br i1 %i.u, label %bb.g, label %i915_gem_object_put.exit, !prof !13
