...
bb.b:                                             ; preds = %bb.c, %read_seqbegin.exit.us
  ...
  %.03239.us = phi i64 [ %i.ae, %bb.c ], [ 0, %read_seqbegin.exit.us ] ; 4 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.w = getelementptr i8, ptr %1, i64 %.03239.us
  %i.x = sub nuw nsw i64 4096, %.03239.us
...
bb.d:                                             ; preds = %read_seqbegin.exit, %bb.g
  ...
  %.03239 = phi i64 [ 0, %read_seqbegin.exit ], [ %.1, %bb.g ] ; 6 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.av = getelementptr i8, ptr %1, i64 %.03239
  %i.aw = sub nuw nsw i64 4096, %.03239
  ...
  %i.bd = add nsw i64 %.03239, %i.bc
  br label %bb.g

bb.g:                                             ; preds = %bb.e, %bb.f
  %.1 = phi i64 [ %i.bd, %bb.f ], [ %.03239, %bb.e ] ; 3 uses
  %i.be = icmp ult i64 %.1, 4096
  br i1 %i.be, label %bb.d, label %.critedge.thread

.critedge:                                        ; preds = %bb.d
  %i.bf = icmp eq i64 %.03239, 0
...
.critedge.thread:                                 ; preds = %bb.g, %bb.h, %.critedge
  %.03237 = phi i64 [ %.03239, %.critedge ], [ 0, %bb.h ], [ %.1, %bb.g ]
  tail call void asm sideeffect "", "~{memory},~{dirflag},~{fpsr},~{flags}"() #8, !srcloc !24
...
.loopexit:                                        ; preds = %.critedge.thread, %.critedge.thread.us, %bb.a
  %.0 = phi i64 [ 0, %bb.a ], [ %.03237.us, %.critedge.thread.us ], [ %.03237, %.critedge.thread ]
  ret i64 %.0
}
...
bb.c:                                             ; preds = %bb.b
  ...
  %exitcond.not.i32.not = icmp slt i32 %1, 2147483646
  br i1 %exitcond.not.i32.not, label %.lr.ph35, label %prev_by_hint.exit.thread

bb.d:                                             ; preds = %bb.j
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %prev_by_hint.exit.thread, label %.lr.ph35.1

.lr.ph35.1:                                       ; preds = %bb.d
...
.critedge.split.loop.exit22.i:                    ; preds = %bb.g, %bb.j
  %indvars.iv.i33.lcssa41 = phi i64 [ %i.g, %bb.j ], [ %indvars.iv.next.i, %bb.g ]
  %i.ae = trunc nuw nsw i64 %indvars.iv.i33.lcssa41 to i32
  br label %prev_by_hint.exit

prev_by_hint.exit.thread:                         ; preds = %bb.d, %.lr.ph35, %bb.h, %.lr.ph35.1, %bb.e, %bb.g, %bb.c, %.prev_by_hint.exit.thread_crit_edge
  %i.af = phi ptr [ %.pre, %.prev_by_hint.exit.thread_crit_edge ], [ %i.f, %bb.c ], [ %i.f, %bb.g ], [ %i.f, %bb.e ], [ %i.f, %.lr.ph35.1 ], [ %i.f, %bb.h ], [ %i.f, %.lr.ph35 ], [ %i.f, %bb.d ] ; 4 uses
...
.lr.ph:                                           ; preds = %.preheader, %bb.l
  %.03710 = phi i32 [ %.037., %bb.l ], [ %i.b, %.preheader ] ; 2 uses
  %.0409 = phi i32 [ %..040, %bb.l ], [ 0, %.preheader ] ; 2 uses
  %i.ar = add i32 %.03710, %.0409
...
bb.l:                                             ; preds = %.lr.ph
  ...
  %..040 = select i1 %i.az, i32 %i.as, i32 %.0409 ; 4 uses
  %.037. = select i1 %i.az, i32 %.03710, i32 %i.as ; 2 uses
  %i.ba = sub i32 %.037., %..040
  %i.bb = icmp sgt i32 %i.ba, 1
  br i1 %i.bb, label %.lr.ph, label %._crit_edge.loopexit

._crit_edge.loopexit:                             ; preds = %bb.l
  %.phi.trans.insert14 = sext i32 %..040 to i64
...
._crit_edge:                                      ; preds = %.preheader, %._crit_edge.loopexit
  ...
  %.040.lcssa = phi i32 [ %..040, %._crit_edge.loopexit ], [ 0, %.preheader ]
  %.not49 = icmp ugt i64 %.pre-phi19, %.0.val
  %spec.select = select i1 %.not49, i32 -1, i32 %.040.lcssa
  br label %prev_by_hint.exit

prev_by_hint.exit:                                ; preds = %bb.i, %bb.f, %.lr.ph, %.critedge.split.loop.exit22.i, %._crit_edge, %bb.a, %bb.k, %prev_by_hint.exit.thread
  %.0 = phi i32 [ -1, %prev_by_hint.exit.thread ], [ %i.ak, %bb.k ], [ %spec.select, %._crit_edge ], [ %i.as, %.lr.ph ], [ -1, %bb.a ], [ %i.ae, %.critedge.split.loop.exit22.i ], [ %i.j, %bb.f ], [ %i.j, %bb.i ]
  ret i32 %.0
}
