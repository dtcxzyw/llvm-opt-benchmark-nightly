Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/linux/original/hexdump?download=true
inline.NumInlined: 3
inline.NumDeleted: 1
loop-unroll.NumRuntimeUnrolled: 1
loop-unroll.NumUnrolled: 1
begin_hunk_0_@bin2hex:bb.a
  %i.l = getelementptr i8, ptr @hex_asc, i64 %i.k
  %i.m = load i8, ptr %i.l, align 1
  %i.n = getelementptr i8, ptr %0, i64 2          ; 2 uses
  store i8 %i.m, ptr %i.i, align 1
  br label %.lr.ph.prol.loopexit

.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader
  %.lcssa.unr = phi ptr [ poison, %.lr.ph.preheader ], [ %i.n, %.lr.ph.prol ]
  %.09.unr = phi ptr [ %1, %.lr.ph.preheader ], [ %i.b, %.lr.ph.prol ]
  %.048.unr = phi i64 [ %2, %.lr.ph.preheader ], [ %i.a, %.lr.ph.prol ]
  %.057.unr = phi ptr [ %0, %.lr.ph.preheader ], [ %i.n, %.lr.ph.prol ]
  %i.o = icmp eq i64 %2, 1
  br i1 %i.o, label %._crit_edge, label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  %.09 = phi ptr [ %i.ad, %.lr.ph ], [ %.09.unr, %.lr.ph.prol.loopexit ] ; 3 uses
  %.048 = phi i64 [ %i.ac, %.lr.ph ], [ %.048.unr, %.lr.ph.prol.loopexit ]
  %.057 = phi ptr [ %i.ap, %.lr.ph ], [ %.057.unr, %.lr.ph.prol.loopexit ] ; 5 uses
  %i.p = getelementptr i8, ptr %.09, i64 1
  %i.q = load i8, ptr %.09, align 1
  %i.r = zext i8 %i.q to i32                      ; 2 uses
  %i.s = lshr i32 %i.r, 4
  %i.t = zext nneg i32 %i.s to i64
  %i.u = getelementptr i8, ptr @hex_asc, i64 %i.t
  %i.v = load i8, ptr %i.u, align 1
  %i.w = getelementptr i8, ptr %.057, i64 1
  store i8 %i.v, ptr %.057, align 1
  %i.x = and i32 %i.r, 15
  %i.y = zext nneg i32 %i.x to i64
  %i.z = getelementptr i8, ptr @hex_asc, i64 %i.y
  %i.aa = load i8, ptr %i.z, align 1
  %i.ab = getelementptr i8, ptr %.057, i64 2
  store i8 %i.aa, ptr %i.w, align 1
  %i.ac = add i64 %.048, -2                       ; 2 uses
  %i.ad = getelementptr i8, ptr %.09, i64 2
  %i.ae = load i8, ptr %i.p, align 1
  %i.af = zext i8 %i.ae to i32                    ; 2 uses
  %i.ag = lshr i32 %i.af, 4
  %i.ah = zext nneg i32 %i.ag to i64
  %i.ai = getelementptr i8, ptr @hex_asc, i64 %i.ah
  %i.aj = load i8, ptr %i.ai, align 1
  %i.ak = getelementptr i8, ptr %.057, i64 3
  store i8 %i.aj, ptr %i.ab, align 1
  %i.al = and i32 %i.af, 15
  %i.am = zext nneg i32 %i.al to i64
  %i.an = getelementptr i8, ptr @hex_asc, i64 %i.am
  %i.ao = load i8, ptr %i.an, align 1
  %i.ap = getelementptr i8, ptr %.057, i64 4      ; 2 uses
  store i8 %i.ao, ptr %i.ak, align 1
  %.not.1 = icmp eq i64 %i.ac, 0
  br i1 %.not.1, label %._crit_edge, label %.lr.ph, !llvm.loop !11

._crit_edge:                                      ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %bb.a
  %.05.lcssa = phi ptr [ %0, %bb.a ], [ %.lcssa.unr, %.lr.ph.prol.loopexit ], [ %i.ap, %.lr.ph ]
  ret ptr %.05.lcssa
}

; Function Attrs: fn_ret_thunk_extern nofree noredzone nounwind null_pointer_is_valid sspstrong
define dso_local i32 @hex_dump_to_buffer(ptr nofree noundef readonly captures(none) %0, i64 noundef %1, i32 noundef %2, i32 noundef %3, ptr nofree noundef writeonly captures(none) %4, i64 noundef %5, i1 noundef zeroext %6) #3 align 16 prefalign(16) {
bb.a:
...
.lr.ph206.preheader:                              ; preds = %.preheader173
  %i.ca = sext i32 %.4143 to i64
  %i.cb = add nuw nsw i32 %i.n, 1                 ; 2 uses
  br label %.lr.ph206

.lr.ph206:                                        ; preds = %.lr.ph206.preheader, %bb.n
  %indvars.iv237 = phi i64 [ %i.ca, %.lr.ph206.preheader ], [ %indvars.iv.next238.a, %bb.n ] ; 4 uses
  %i.cc = shl i64 %indvars.iv237, 32
  %sext.a = add i64 %i.cc, 8589934592
  %i.cd = ashr exact i64 %sext.a, 32
  %i.ce = icmp ult i64 %5, %i.cd
  br i1 %i.ce, label %.loopexit172.loopexit213, label %bb.n

bb.n:                                             ; preds = %.lr.ph206
  %indvars.iv.next238.a = add nsw i64 %indvars.iv237, 1 ; 2 uses
  %i.cf = getelementptr i8, ptr %4, i64 %indvars.iv237
  store i8 32, ptr %i.cf, align 1
  %lftr.wideiv = trunc i64 %indvars.iv.next238.a to i32
  %exitcond.not = icmp eq i32 %i.cb, %lftr.wideiv
  br i1 %exitcond.not, label %.preheader.preheader, label %.lr.ph206, !llvm.loop !18

.preheader.preheader:                             ; preds = %bb.n, %.preheader173
  %.6208.ph = phi i32 [ %.4143, %.preheader173 ], [ %i.cb, %bb.n ]
  br label %.preheader
...
.preheader:                                       ; preds = %.preheader.preheader, %bb.q
  ...
  %i.cj = icmp ult i64 %5, %i.ci
  br i1 %i.cj, label %.loopexit172, label %bb.o

bb.o:                                             ; preds = %.preheader
  %i.ck = getelementptr i8, ptr %0, i64 %i.cg
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.co = getelementptr i8, ptr @_ctype, i64 %i.cn
  %i.cp = load i8, ptr %i.co, align 1
  %i.cq = and i8 %i.cp, -105
  %.not161 = icmp eq i8 %i.cq, 0
  %spec.select165 = select i1 %.not161, i8 46, i8 %i.cl
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  %i.cr = phi i8 [ 46, %bb.o ], [ %spec.select165, %bb.p ]
  %i.cs = add i32 %.6208, 1                       ; 2 uses
...
.loopexit:                                        ; preds = %bb.q, %.thread, %bb.b
  %.7 = phi i32 [ 0, %bb.b ], [ %.4143, %.thread ], [ %i.cs, %bb.q ] ; 2 uses
  %i.cw = sext i32 %.7 to i64
  %i.cx = getelementptr i8, ptr %4, i64 %i.cw
  store i8 0, ptr %i.cx, align 1
  br label %bb.t

.loopexit172.loopexit213:                         ; preds = %.lr.ph206
  %i.cy = trunc nsw i64 %indvars.iv237 to i32
  br label %.loopexit172

.loopexit172:                                     ; preds = %bb.k, %bb.j, %.preheader175, %.preheader, %.loopexit172.loopexit213
  %.8 = phi i32 [ %.6208, %.preheader ], [ %i.cy, %.loopexit172.loopexit213 ], [ %i.bi, %bb.j ], [ %.3142202, %.preheader175 ], [ %i.ay, %bb.k ]
  %i.cz = sext i32 %.8 to i64
...
bb.r:                                             ; preds = %.loopexit178
  %i.db = trunc nuw nsw i64 %spec.select to i32
  %i.dc = add nuw nsw i32 %i.db, 1
  %i.dd = add nuw nsw i32 %i.dc, %i.n
  br label %bb.t

bb.s:                                             ; preds = %.loopexit178
  %i.de = shl i32 %spec.store.select, 1
  %i.df = or disjoint i32 %i.de, 1
  %i.dg = mul i32 %i.df, %i.k
  %i.dh = add i32 %i.dg, -1
  br label %bb.t

bb.t:                                             ; preds = %bb.r, %bb.s, %.loopexit
  %.0 = phi i32 [ %.7, %.loopexit ], [ %i.dd, %bb.r ], [ %i.dh, %bb.s ]
  ret i32 %.0
}
