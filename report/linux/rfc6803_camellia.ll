...
bb.d:                                             ; preds = %_kzalloc_noprof.exit
  ...
  %i.ae = add i32 %.val.val, -1
  %8 = or i32 %i.ae, 7
  %9 = add i32 %8, 1
  %i.af = zext i32 %9 to i64
...
_kzalloc_noprof.exit:                             ; preds = %bb.c
  ...
  %i.u = add i32 %.val104.val, -1
  %5 = or i32 %i.u, 7                             ; 2 uses
...
bb.d:                                             ; preds = %_kzalloc_noprof.exit
  ...
  %i.al = add i32 %.val102.val, -1
  %9 = or i32 %i.al, 7
  %10 = add i32 %9, 1
  %i.am = zext i32 %10 to i64
  %i.an = getelementptr i8, ptr %i.aj, i64 %i.am  ; 4 uses
  %i.ao = zext i32 %6 to i64
