Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/linux/original/i915_gem_dmabuf?download=true
inline.NumInlined: 66
inline.NumDeleted: 38
begin_hunk_0_@i915_gem_prime_export:bb.a
bb.a:
  %2 = alloca %struct.dma_buf_export_info, align 8 ; 9 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #6
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %2, ptr noundef nonnull align 8 dereferenceable(56) @__const.i915_gem_prime_export.exp_info, i64 40, i1 false)
  %i.a = getelementptr inbounds nuw i8, ptr %2, i64 16
  store ptr @i915_dmabuf_ops, ptr %i.a, align 8
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.q = tail call i64 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddq ${0:q}, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i64) %i.p, i64 1, ptr elementtype(i64) %i.p) #6, !srcloc !21
...
bb.g:                                             ; preds = %bb.f
  ...
  tail call void asm sideeffect "", "~{dirflag},~{fpsr},~{flags}"() #6, !srcloc !23
...
bb.b:                                             ; preds = %bb.a
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(56) %2, i8 0, i64 56, i1 false), !annotation !13
...
bb.c:                                             ; preds = %bb.b, %__i915_gem_ww_fini.exit
  %i.k = load i8, ptr %i.c, align 8, !range !14, !noundef !15
...
i915_gem_object_get.exit.i.i:                     ; preds = %.sink.split.i.i.i.i.i.i.i.i, %bb.h
  %i.s = load ptr, ptr %i.g, align 8              ; 2 uses
  store ptr %i.e, ptr %i.g, align 8
  store ptr %i.f, ptr %i.e, align 8
  store ptr %i.s, ptr %i.h, align 8
  store volatile ptr %i.e, ptr %i.s, align 8
  switch i32 %.0.i.i, label %.thread10.i [
    i32 -35, label %bb.i
    i32 0, label %bb.k
    i32 -114, label %bb.k
...
bb.i:                                             ; preds = %bb.f, %i915_gem_object_get.exit.i.i
  %i.t = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %.val, i32 1, ptr elementtype(i32) %.val) #6, !srcloc !10 ; 3 uses
  %.not.i.i.i.i.i.i19.i7.i = icmp eq i32 %i.t, 0
  br i1 %.not.i.i.i.i.i.i19.i7.i, label %.sink.split.i.i.i.i.i.i21.i9.i, label %bb.j, !prof !11

bb.j:                                             ; preds = %bb.i
  %i.u = add i32 %i.t, 1
  %i.v = or i32 %i.u, %i.t
  %.not10.i.i.i.i.i.i20.i8.i = icmp sgt i32 %i.v, -1
...
i915_gem_object_pin_pages.exit.thread21:          ; preds = %.sink.split.i.i.i.i.i.i21.i9.i, %bb.j
  store ptr %.val, ptr %i.j, align 8
  br label %bb.n

bb.k:                                             ; preds = %bb.f, %i915_gem_object_get.exit.i.i, %i915_gem_object_get.exit.i.i
  %i.w = call i32 @i915_gem_object_migrate(ptr noundef %.val, ptr noundef nonnull %2, i32 noundef 0) #7 ; 2 uses
  %.not16 = icmp eq i32 %i.w, 0
  br i1 %.not16, label %bb.l, label %i915_gem_object_pin_pages.exit

bb.l:                                             ; preds = %bb.k
  %i.x = call i32 @i915_gem_object_wait_migration(ptr noundef %.val, i32 noundef 0) #7 ; 2 uses
  %.not17 = icmp eq i32 %i.x, 0
  br i1 %.not17, label %bb.m, label %i915_gem_object_pin_pages.exit

bb.m:                                             ; preds = %bb.l
  %i.y = load volatile i32, ptr %i.i, align 8     ; 2 uses
  %i.z = icmp eq i32 %i.y, 0
  br i1 %i.z, label %raw_atomic_fetch_add_unless.exit.i, label %.lr.ph.i, !prof !16

.lr.ph.i:                                         ; preds = %bb.m, %arch_atomic_try_cmpxchg.exit.i
  %.047.i = phi i32 [ %i.af, %arch_atomic_try_cmpxchg.exit.i ], [ %i.y, %bb.m ] ; 2 uses
  %i.aa = add i32 %.047.i, 1
  %i.ab = call { i8, i32 } asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgl $3, $1", "={@ccz},=*m,={ax},r,*m,2,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.i, i32 range(i32 2, 1) %i.aa, ptr elementtype(i32) %i.i, i32 %.047.i) #6, !srcloc !17 ; 2 uses
  %i.ac = extractvalue { i8, i32 } %i.ab, 0       ; 2 uses
  %i.ad = icmp ult i8 %i.ac, 2
  call void @llvm.assume(i1 %i.ad)
  %i.ae = trunc nuw i8 %i.ac to i1
  br i1 %i.ae, label %.thread10.i, label %arch_atomic_try_cmpxchg.exit.i, !prof !12

arch_atomic_try_cmpxchg.exit.i:                   ; preds = %.lr.ph.i
  %i.af = extractvalue { i8, i32 } %i.ab, 1       ; 2 uses
  %i.ag = icmp eq i32 %i.af, 0
  br i1 %i.ag, label %raw_atomic_fetch_add_unless.exit.i, label %.lr.ph.i, !prof !18

raw_atomic_fetch_add_unless.exit.i:               ; preds = %arch_atomic_try_cmpxchg.exit.i, %bb.m
  %i.ah = call i32 @__i915_gem_object_get_pages(ptr noundef %.val) #7
  br label %i915_gem_object_pin_pages.exit

i915_gem_object_pin_pages.exit:                   ; preds = %raw_atomic_fetch_add_unless.exit.i, %bb.l, %bb.k
  %.1 = phi i32 [ %i.ah, %raw_atomic_fetch_add_unless.exit.i ], [ %i.w, %bb.k ], [ %i.x, %bb.l ] ; 2 uses
  %i.ai = icmp eq i32 %.1, -35
  br i1 %i.ai, label %bb.n, label %.thread10.i

bb.n:                                             ; preds = %i915_gem_object_pin_pages.exit.thread21, %i915_gem_object_pin_pages.exit
  %i.aj = call i32 @i915_gem_ww_ctx_backoff(ptr noundef nonnull %2) #7 ; 2 uses
  switch i32 %i.aj, label %.thread10.i [
    i32 0, label %__i915_gem_ww_fini.exit
    i32 -35, label %__i915_gem_ww_fini.exit
  ]

.thread10.i:                                      ; preds = %.lr.ph.i, %bb.f, %i915_gem_object_get.exit.i.i, %bb.n, %i915_gem_object_pin_pages.exit
  %.013.i = phi i32 [ %i.aj, %bb.n ], [ %.1, %i915_gem_object_pin_pages.exit ], [ %.0.i.i, %i915_gem_object_get.exit.i.i ], [ %.0.i.i, %bb.f ], [ 0, %.lr.ph.i ]
...
__i915_gem_ww_fini.exit:                          ; preds = %bb.n, %bb.n, %.thread10.i
  ...
  %i.ak = icmp eq i32 %.09.i, -35
  br i1 %i.ak, label %bb.c, label %.loopexit, !llvm.loop !24
...
bb.a:
  ...
  tail call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock decl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.b, ptr elementtype(i32) %i.b) #6, !srcloc !20
  ret void
}
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %sg_next.exit42
  ...
  %.03144 = phi i32 [ %i.ab, %sg_next.exit42 ], [ 0, %.lr.ph.preheader ]
  %.03343 = phi ptr [ %.06.i, %sg_next.exit42 ], [ %i.n, %.lr.ph.preheader ] ; 5 uses
  %.030.val = load i64, ptr %.03045, align 8
  %i.o = and i64 %.030.val, -4
  %i.p = getelementptr i8, ptr %.03045, i64 12
  %i.q = load i32, ptr %i.p, align 4
  %i.r = load i64, ptr %.03343, align 8           ; 2 uses
  %i.s = and i64 %i.r, 3
  %i.t = or disjoint i64 %i.s, %i.o
  store i64 %i.t, ptr %.03343, align 8
  %i.u = getelementptr i8, ptr %.03343, i64 8
  store i32 0, ptr %i.u, align 8
  %i.v = getelementptr i8, ptr %.03343, i64 12
...
bb.d:                                             ; preds = %.lr.ph
  %i.x = getelementptr i8, ptr %.03343, i64 32    ; 2 uses
...
sg_next.exit:                                     ; preds = %.lr.ph, %bb.d, %bb.e
  ...
  %i.ab = add nuw i32 %.03144, 1                  ; 2 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  switch i32 %.0.i.i, label %i915_gem_object_pin_pages.exit.thread29 [
    i32 0, label %bb.f
    i32 -35, label %bb.h
    i32 -114, label %bb.j
  ]
...
.thread:                                          ; preds = %bb.i, %.sink.split.i.i.i.i.i.i21.i9.i
  store ptr %.val, ptr %i.j, align 8
  br label %bb.k

bb.j:                                             ; preds = %bb.e, %i915_gem_object_get.exit.i.i, %i915_gem_object_get.exit.i.i
  %i.w = load volatile i32, ptr %i.i, align 8     ; 2 uses
  %i.x = icmp eq i32 %i.w, 0
  br i1 %i.x, label %i915_gem_object_pin_pages.exit, label %.lr.ph.i, !prof !16

.lr.ph.i:                                         ; preds = %bb.j, %arch_atomic_try_cmpxchg.exit.i
  %.047.i = phi i32 [ %i.ad, %arch_atomic_try_cmpxchg.exit.i ], [ %i.w, %bb.j ] ; 2 uses
  %i.y = add i32 %.047.i, 1
  %i.z = call { i8, i32 } asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgl $3, $1", "={@ccz},=*m,={ax},r,*m,2,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.i, i32 range(i32 2, 1) %i.y, ptr elementtype(i32) %i.i, i32 %.047.i) #6, !srcloc !17 ; 2 uses
  %i.aa = extractvalue { i8, i32 } %i.z, 0        ; 2 uses
  %i.ab = icmp ult i8 %i.aa, 2
  call void @llvm.assume(i1 %i.ab)
  %i.ac = trunc nuw i8 %i.aa to i1
  br i1 %i.ac, label %i915_gem_object_pin_pages.exit.thread, label %arch_atomic_try_cmpxchg.exit.i, !prof !12

arch_atomic_try_cmpxchg.exit.i:                   ; preds = %.lr.ph.i
  %i.ad = extractvalue { i8, i32 } %i.z, 1        ; 2 uses
  %i.ae = icmp eq i32 %i.ad, 0
  br i1 %i.ae, label %i915_gem_object_pin_pages.exit, label %.lr.ph.i, !prof !18

i915_gem_object_pin_pages.exit:                   ; preds = %arch_atomic_try_cmpxchg.exit.i, %bb.j
  %i.af = call i32 @__i915_gem_object_get_pages(ptr noundef %.val) #7 ; 2 uses
...
i915_gem_object_pin_pages.exit.thread:            ; preds = %.lr.ph.i, %i915_gem_object_pin_pages.exit
  %i.ag = call i32 @i915_gem_object_set_to_cpu_domain(ptr noundef %.val, i1 noundef zeroext %i.b) #7
  call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock decl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.i, ptr elementtype(i32) %i.i) #6, !srcloc !20
  br label %i915_gem_object_pin_pages.exit.thread29

i915_gem_object_pin_pages.exit.thread29:          ; preds = %bb.e, %i915_gem_object_get.exit.i.i, %i915_gem_object_pin_pages.exit.thread, %i915_gem_object_pin_pages.exit
  %.1 = phi i32 [ %i.af, %i915_gem_object_pin_pages.exit ], [ %i.ag, %i915_gem_object_pin_pages.exit.thread ], [ %.0.i.i, %i915_gem_object_get.exit.i.i ], [ %.0.i.i, %bb.e ] ; 2 uses
  %i.ah = icmp eq i32 %.1, -35
  br i1 %i.ah, label %bb.k, label %bb.l

bb.k:                                             ; preds = %.thread, %i915_gem_object_pin_pages.exit.thread29
  %i.ai = call i32 @i915_gem_ww_ctx_backoff(ptr noundef nonnull %2) #7 ; 2 uses
  %.not15 = icmp eq i32 %i.ai, 0
  br i1 %.not15, label %bb.b, label %bb.l

bb.l:                                             ; preds = %bb.k, %i915_gem_object_pin_pages.exit.thread29
  %.2 = phi i32 [ %i.ai, %bb.k ], [ %.1, %i915_gem_object_pin_pages.exit.thread29 ]
  call void @i915_gem_ww_ctx_fini(ptr noundef nonnull %2) #7
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #6
  ret i32 %.2
}
...
bb.b:                                             ; preds = %bb.k, %bb.a
  %i.j = load i8, ptr %i.b, align 8, !range !14, !noundef !15
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  switch i32 %.0.i.i, label %i915_gem_object_pin_pages.exit.thread26 [
    i32 0, label %bb.f
    i32 -35, label %bb.h
    i32 -114, label %bb.j
  ]
...
bb.f:                                             ; preds = %bb.e
  %i.o = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %.val, i32 1, ptr elementtype(i32) %.val) #6, !srcloc !10 ; 3 uses
...
i915_gem_object_get.exit.i.i:                     ; preds = %.sink.split.i.i.i.i.i.i.i.i, %bb.g
  ...
  store volatile ptr %i.d, ptr %i.r, align 8
  switch i32 %.0.i.i, label %i915_gem_object_pin_pages.exit.thread26 [
    i32 -35, label %bb.h
    i32 0, label %bb.j
    i32 -114, label %bb.j
...
bb.h:                                             ; preds = %bb.e, %i915_gem_object_get.exit.i.i
  %i.s = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %.val, i32 1, ptr elementtype(i32) %.val) #6, !srcloc !10 ; 3 uses
...
bb.j:                                             ; preds = %bb.e, %i915_gem_object_get.exit.i.i, %i915_gem_object_get.exit.i.i
  %i.v = load volatile i32, ptr %i.h, align 8     ; 2 uses
  %i.w = icmp eq i32 %i.v, 0
  br i1 %i.w, label %i915_gem_object_pin_pages.exit, label %.lr.ph.i, !prof !16

.lr.ph.i:                                         ; preds = %bb.j, %arch_atomic_try_cmpxchg.exit.i
  %.047.i = phi i32 [ %i.ac, %arch_atomic_try_cmpxchg.exit.i ], [ %i.v, %bb.j ] ; 2 uses
  %i.x = add i32 %.047.i, 1
  %i.y = call { i8, i32 } asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock cmpxchgl $3, $1", "={@ccz},=*m,={ax},r,*m,2,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.h, i32 range(i32 2, 1) %i.x, ptr elementtype(i32) %i.h, i32 %.047.i) #6, !srcloc !17 ; 2 uses
  %i.z = extractvalue { i8, i32 } %i.y, 0         ; 2 uses
  %i.aa = icmp ult i8 %i.z, 2
  call void @llvm.assume(i1 %i.aa)
  %i.ab = trunc nuw i8 %i.z to i1
  br i1 %i.ab, label %i915_gem_object_pin_pages.exit.thread, label %arch_atomic_try_cmpxchg.exit.i, !prof !12

arch_atomic_try_cmpxchg.exit.i:                   ; preds = %.lr.ph.i
  %i.ac = extractvalue { i8, i32 } %i.y, 1        ; 2 uses
  %i.ad = icmp eq i32 %i.ac, 0
  br i1 %i.ad, label %i915_gem_object_pin_pages.exit, label %.lr.ph.i, !prof !18

i915_gem_object_pin_pages.exit:                   ; preds = %arch_atomic_try_cmpxchg.exit.i, %bb.j
  %i.ae = call i32 @__i915_gem_object_get_pages(ptr noundef %.val) #7 ; 2 uses
...
i915_gem_object_pin_pages.exit.thread:            ; preds = %.lr.ph.i, %i915_gem_object_pin_pages.exit
  %i.af = call i32 @i915_gem_object_set_to_gtt_domain(ptr noundef %.val, i1 noundef zeroext false) #7
  call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock decl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.h, ptr elementtype(i32) %i.h) #6, !srcloc !20
  br label %i915_gem_object_pin_pages.exit.thread26

i915_gem_object_pin_pages.exit.thread26:          ; preds = %bb.e, %i915_gem_object_get.exit.i.i, %i915_gem_object_pin_pages.exit.thread, %i915_gem_object_pin_pages.exit
  %.1 = phi i32 [ %i.ae, %i915_gem_object_pin_pages.exit ], [ %i.af, %i915_gem_object_pin_pages.exit.thread ], [ %.0.i.i, %i915_gem_object_get.exit.i.i ], [ %.0.i.i, %bb.e ] ; 2 uses
  %i.ag = icmp eq i32 %.1, -35
  br i1 %i.ag, label %bb.k, label %bb.l

bb.k:                                             ; preds = %.thread, %i915_gem_object_pin_pages.exit.thread26
  %i.ah = call i32 @i915_gem_ww_ctx_backoff(ptr noundef nonnull %2) #7 ; 2 uses
  %.not12 = icmp eq i32 %i.ah, 0
  br i1 %.not12, label %bb.b, label %bb.l

bb.l:                                             ; preds = %bb.k, %i915_gem_object_pin_pages.exit.thread26
  %.2 = phi i32 [ %i.ah, %bb.k ], [ %.1, %i915_gem_object_pin_pages.exit.thread26 ]
  call void @i915_gem_ww_ctx_fini(ptr noundef nonnull %2) #7
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #6
  ret i32 %.2
}
...
bb.a:
  ...
  tail call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock decl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.d, ptr elementtype(i32) %i.d) #6, !srcloc !20
  ret void
}
