...
bb.k:                                             ; preds = %tnode_new.exit198
  %i.bm = getelementptr i8, ptr %.037423, i64 -32 ; 3 uses
  ...
  %.not89.i416 = icmp eq i64 %i.bp, 0
  br i1 %.not89.i416, label %inflate.exit, label %.lr.ph419
...
bb.l:                                             ; preds = %.lr.ph419, %bb.db
  %.080.i417 = phi i64 [ %i.bp, %.lr.ph419 ], [ %i.bw, %bb.db ] ; 2 uses
  %i.bw = add i64 %.080.i417, -1                  ; 4 uses
  %i.bx = getelementptr [8 x i8], ptr %.037423, i64 %.080.i417
...
empty_child_inc.exit.i173:                        ; preds = %tnode_full.exit.thread
  %.not309.a = icmp eq ptr %i.cp, null
  br i1 %.not309.a, label %bb.o, label %tnode_full.exit40.i178
...
tnode_full.exit40.i178.thread:                    ; preds = %bb.o, %bb.p
  ...
  %.pre523.a = load i8, ptr %i.bz, align 4
  %.pre524.a = load i8, ptr %i.cc, align 1        ; 2 uses
  %.pre530 = zext i8 %.pre523.a to i32
  %.pre532 = zext i8 %.pre524.a to i32
  %.pre534 = add nuw nsw i32 %.pre532, %.pre530
  %.pre536 = zext i8 %.val95.i to i32
  %i.cx = icmp eq i32 %.pre534, %.pre536
  %i.cy = icmp ne i8 %.pre524.a, 0
...
tnode_full.exit40.i178:                           ; preds = %empty_child_inc.exit.i173
  ...
  %.not310 = icmp eq i8 %i.dd, 0
  %spec.select = or i1 %i.dh, %.not310            ; 2 uses
...
bb.an:                                            ; preds = %tnode_new.exit
  ...
  %.not94.i413 = icmp eq i64 %i.gl, 0
  br i1 %.not94.i413, label %._crit_edge, label %.lr.ph
...
bb.ao:                                            ; preds = %.lr.ph, %put_child.exit103
  %.082.i415 = phi i64 [ %i.gm, %.lr.ph ], [ %i.ku, %put_child.exit103 ] ; 2 uses
  %.083.i414 = phi i64 [ %i.gl, %.lr.ph ], [ %i.kt, %put_child.exit103 ] ; 3 uses
  %i.gu = add nsw i64 %.083.i414, -1              ; 4 uses
  %i.gv = getelementptr [8 x i8], ptr %i.by, i64 %.082.i415
