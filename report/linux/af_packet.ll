...
bb.ar:                                            ; preds = %bb.aq
  %i.ga = icmp sgt i32 %.0140.i, 0
  br i1 %i.ga, label %.loopexit.sink.split.i, label %.loopexit.i, !prof !26

bb.as:                                            ; preds = %bb.aq
  %i.gb = load ptr, ptr %i.bk, align 32           ; 2 uses
  %i.gc = getelementptr i8, ptr %i.fy, i64 180    ; 3 uses
  store i16 %.0131.i, ptr %i.gc, align 4
  %i.gd = getelementptr i8, ptr %i.fy, i64 16
  store ptr %.0127.i, ptr %i.gd, align 8
  %i.ge = load i32, ptr %.sroa.5.0..sroa_idx.i.i, align 4
  %i.gf = getelementptr i8, ptr %i.fy, i64 144
  store i32 %i.ge, ptr %i.gf, align 8
  %i.gg = load i32, ptr %.sroa.2.0..sroa_idx.i.i, align 8
  %i.gh = getelementptr i8, ptr %i.fy, i64 168
  store i32 %i.gg, ptr %i.gh, align 8
  %i.gi = load i64, ptr %6, align 8               ; 2 uses
  %i.gj = load i8, ptr %i.cv, align 1
  switch i8 %i.gj, label %.thread.i.i.i [
    i8 0, label %bb.av
    i8 1, label %bb.at
    i8 11, label %bb.au
  ]
...
.thread.i.i.i:                                    ; preds = %bb.as
  ...
  %i.gk = getelementptr i8, ptr %i.fy, i64 32
  store i64 0, ptr %i.gk, align 8
  %i.gl = getelementptr i8, ptr %i.fy, i64 129
  br label %bb.ax

bb.av:                                            ; preds = %bb.au, %bb.at, %bb.as
  %.06.i.i.i = phi i32 [ 2, %bb.au ], [ 0, %bb.as ], [ 1, %bb.at ]
  %i.gm = getelementptr i8, ptr %i.fy, i64 32
  store i64 %i.gi, ptr %i.gm, align 8
  %.not.i.i.i182.i = icmp eq i64 %i.gi, 0
  %i.gn = getelementptr i8, ptr %i.fy, i64 129    ; 3 uses
  br i1 %.not.i.i.i182.i, label %bb.ax, label %bb.aw

bb.aw:                                            ; preds = %bb.av
  %i.go = load i32, ptr %i.gn, align 1
  %i.gp = and i32 %i.go, -4
  %i.gq = or disjoint i32 %i.gp, %.06.i.i.i
  br label %skb_set_delivery_type_by_clockid.exit.i.i

bb.ax:                                            ; preds = %bb.av, %.thread.i.i.i
  %i.gr = phi ptr [ %i.gl, %.thread.i.i.i ], [ %i.gn, %bb.av ] ; 2 uses
  %i.gs = load i32, ptr %i.gr, align 1
  %i.gt = and i32 %i.gs, -4
  br label %skb_set_delivery_type_by_clockid.exit.i.i

skb_set_delivery_type_by_clockid.exit.i.i:        ; preds = %bb.ax, %bb.aw
  %i.gu = phi ptr [ %i.gr, %bb.ax ], [ %i.gn, %bb.aw ]
  %.sink.i.i.i.i = phi i32 [ %i.gt, %bb.ax ], [ %i.gq, %bb.aw ]
  store i32 %.sink.i.i.i.i, ptr %i.gu, align 1
  %i.gv = getelementptr i8, ptr %i.fy, i64 24
  %i.gw = load ptr, ptr %i.gv, align 8
  %i.gx = getelementptr i8, ptr %i.fy, i64 192    ; 9 uses
  %.val5.i.i.i = load i32, ptr %i.gx, align 8
  %i.gy = getelementptr i8, ptr %i.fy, i64 200    ; 11 uses
  %.val6.i.i.i = load ptr, ptr %i.gy, align 8
  %i.gz = zext i32 %.val5.i.i.i to i64
  %i.ha = getelementptr i8, ptr %.val6.i.i.i, i64 %i.gz ; 2 uses
  %i.hb = getelementptr i8, ptr %i.ha, i64 28     ; 2 uses
  %i.hc = load i32, ptr %.sroa.3.0..sroa_idx.i.i, align 4 ; 5 uses
  %.not.i.i108.i.i = icmp eq i32 %i.hc, 0
...
bb.ay:                                            ; preds = %skb_set_delivery_type_by_clockid.exit.i.i
  %i.hd = getelementptr i8, ptr %i.ha, i64 3
  call void @__sock_tx_timestamp(i32 noundef %i.hc, ptr noundef %i.hd) #20
  %i.he = and i32 %i.hc, 128
  %i.hf = icmp eq i32 %i.he, 0
  %i.hg = icmp eq ptr %i.hb, null
  %or.cond.not18.i.i.i.i = or i1 %i.hg, %i.hf
  %i.hh = and i32 %i.hc, 262915
  %.not13.i.i.i.i = icmp eq i32 %i.hh, 0
...
bb.az:                                            ; preds = %bb.ay
  %.not14.i.i.i.i = icmp sgt i32 %i.hc, -1
  br i1 %.not14.i.i.i.i, label %bb.bb, label %bb.ba

bb.ba:                                            ; preds = %bb.az
  %i.hi = load i32, ptr %.sroa.4.0..sroa_idx.i.i, align 8
  br label %.sink.split.i.i.i.i

bb.bb:                                            ; preds = %bb.az
  %i.hj = getelementptr i8, ptr %i.gw, i64 484    ; 2 uses
  %i.hk = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.hj, i32 1, ptr elementtype(i32) %i.hj) #21, !srcloc !81
  br label %.sink.split.i.i.i.i

.sink.split.i.i.i.i:                              ; preds = %bb.bb, %bb.ba
  %.sink.i.i109.i.i = phi i32 [ %i.hk, %bb.bb ], [ %i.hi, %bb.ba ]
  store i32 %.sink.i.i109.i.i, ptr %i.hb, align 4
...
skb_setup_tx_timestamp.exit.i.i:                  ; preds = %.sink.split.i.i.i.i, %bb.ay, %skb_set_delivery_type_by_clockid.exit.i.i
  ...
  %.val4.i.i.i = load i32, ptr %i.gx, align 8
  %.val5.i110.i.i = load ptr, ptr %i.gy, align 8
  %i.ho = zext i32 %.val4.i.i.i to i64
  %i.hp = getelementptr i8, ptr %.val5.i110.i.i, i64 %i.ho
  %i.hq = getelementptr i8, ptr %i.hp, i64 40
  store ptr %i.hn, ptr %i.hq, align 8
  %.val.i.i.i = load i32, ptr %i.gx, align 8
  %.val3.i.i.i = load ptr, ptr %i.gy, align 8
  %i.hr = zext i32 %.val.i.i.i to i64
  %i.hs = getelementptr i8, ptr %.val3.i.i.i, i64 %i.hr ; 2 uses
  %i.ht = load i8, ptr %i.hs, align 8
  %i.hu = or i8 %i.ht, 3
  store i8 %i.hu, ptr %i.hs, align 8
  %i.hv = getelementptr i8, ptr %i.fy, i64 208    ; 4 uses
  %i.hw = load ptr, ptr %i.hv, align 8
  %i.hx = zext nneg i32 %i.fc to i64
  %i.hy = getelementptr i8, ptr %i.hw, i64 %i.hx  ; 2 uses
  store ptr %i.hy, ptr %i.hv, align 8
  %i.hz = getelementptr i8, ptr %i.fy, i64 188    ; 2 uses
  %i.ia = load i32, ptr %i.hz, align 4
  %i.ib = add i32 %i.ia, %i.fc
  store i32 %i.ib, ptr %i.hz, align 4
  %i.ic = load ptr, ptr %i.gy, align 8
  %i.id = ptrtoint ptr %i.hy to i64
  %i.ie = ptrtoint ptr %i.ic to i64
  %i.if = sub i64 %i.id, %i.ie
  %i.ig = trunc i64 %i.if to i16
  %i.ih = getelementptr i8, ptr %i.fy, i64 184
  store i16 %i.ig, ptr %i.ih, align 8
  %i.ii = getelementptr i8, ptr %i.gb, i64 4
  %i.ij = load i16, ptr %i.ii, align 4
  %i.ik = icmp eq i16 %i.ij, 2
  br i1 %i.ik, label %bb.bc, label %bb.be

bb.bc:                                            ; preds = %skb_setup_tx_timestamp.exit.i.i
  %i.il = load ptr, ptr %i.cx, align 16           ; 2 uses
  %.not.i.i186.i = icmp eq ptr %i.il, null
  br i1 %.not.i.i186.i, label %dev_hard_header.exit.thread.i.i, label %bb.bd

bb.bd:                                            ; preds = %bb.bc
  %i.im = load ptr, ptr %i.il, align 8            ; 2 uses
  %.not11.i.i.i = icmp eq ptr %i.im, null
...
dev_hard_header.exit.i.i:                         ; preds = %bb.bd
  %i.in = call i32 %i.im(ptr noundef nonnull %i.fy, ptr noundef nonnull %.0127.i, i16 noundef zeroext %i.cy, ptr noundef %.0146.i, ptr noundef null, i32 noundef range(i32 0, -2147483648) %.0143.i) #20, !inline_history !82
  %i.io = icmp slt i32 %i.in, 0
  br i1 %i.io, label %packet_sock_flag.exit.i, label %dev_hard_header.exit.thread.i.i, !prof !83
...
bb.bf:                                            ; preds = %bb.be
  %i.ip = call i32 @llvm.umin.i32(i32 range(i32 0, 65536) %i.fx, i32 range(i32 0, -2147483648) %.0143.i) ; 8 uses
  %i.iq = load i16, ptr %i.co, align 4
  %i.ir = zext i16 %i.iq to i32
  %i.is = call ptr @skb_push(ptr noundef nonnull %i.fy, i32 noundef %i.ir) #20 ; 0 uses
  %i.it = load i16, ptr %i.co, align 4
  %i.iu = zext i16 %i.it to i32
  %i.iv = sub nsw i32 %i.fx, %i.iu
  %i.iw = call ptr @skb_put(ptr noundef nonnull %i.fy, i32 noundef %i.iv) #20 ; 0 uses
  %i.ix = call i32 @skb_store_bits(ptr noundef nonnull %i.fy, i32 noundef 0, ptr noundef %.1199.i, i32 noundef %i.ip) #20 ; 2 uses
  %.not100.i.i = icmp eq i32 %i.ix, 0
  br i1 %.not100.i.i, label %bb.bg, label %tpacket_fill_skb.exit.i, !prof !26

bb.bg:                                            ; preds = %bb.bf
  %i.iy = load ptr, ptr %i.hv, align 8            ; 2 uses
  %i.iz = load i16, ptr %i.co, align 4
  %i.ja = zext i16 %i.iz to i32
  %.not.i111.i.i = icmp samesign ult i32 %i.ip, %i.ja
  br i1 %.not.i111.i.i, label %bb.bh, label %dev_validate_header.exit.thread121.i.i, !prof !23

bb.bh:                                            ; preds = %bb.bg
  %i.jb = load i8, ptr %i.cw, align 2
  %i.jc = zext i8 %i.jb to i32
  %i.jd = icmp samesign ult i32 %i.ip, %i.jc
  br i1 %i.jd, label %packet_sock_flag.exit.i, label %bb.bi

bb.bi:                                            ; preds = %bb.bh
  %i.je = call zeroext i1 @capable(i32 noundef 17) #20
  br i1 %i.je, label %bb.bj, label %bb.bk

bb.bj:                                            ; preds = %bb.bi
  %i.jf = zext nneg i32 %i.ip to i64
  %i.jg = getelementptr i8, ptr %i.iy, i64 %i.jf
  %i.jh = load i16, ptr %i.co, align 4
  %i.ji = zext i16 %i.jh to i32
  %i.jj = sub nsw i32 %i.ji, %i.ip
  %i.jk = sext i32 %i.jj to i64
  call void @llvm.memset.p0.i64(ptr align 1 %i.jg, i8 0, i64 %i.jk, i1 false)
  br label %dev_validate_header.exit.thread121.i.i

bb.bk:                                            ; preds = %bb.bi
  %i.jl = load ptr, ptr %i.cx, align 16           ; 2 uses
  %.not16.i.i.i = icmp eq ptr %i.jl, null
  br i1 %.not16.i.i.i, label %packet_sock_flag.exit.i, label %bb.bl

bb.bl:                                            ; preds = %bb.bk
  %i.jm = getelementptr i8, ptr %i.jl, i64 32
  %i.jn = load ptr, ptr %i.jm, align 8            ; 2 uses
  %.not17.i.i.i = icmp eq ptr %i.jn, null
...
dev_validate_header.exit.i.i:                     ; preds = %bb.bl
  %i.jo = call zeroext i1 %i.jn(ptr noundef %i.iy, i32 noundef %i.ip) #20, !inline_history !84
  br i1 %i.jo, label %dev_validate_header.exit.thread121.i.i, label %packet_sock_flag.exit.i
...
dev_hard_header.exit.thread.i.i:                  ; preds = %dev_validate_header.exit.thread121.i.i, %bb.be, %dev_hard_header.exit.i.i, %bb.bd, %bb.bc
  %.192.i.i = phi i32 [ %.0143.i, %dev_hard_header.exit.i.i ], [ %i.jr, %dev_validate_header.exit.thread121.i.i ], [ %.0143.i, %bb.be ], [ %.0143.i, %bb.bd ], [ %.0143.i, %bb.bc ] ; 8 uses
  %.190.i.i = phi ptr [ %.1199.i, %dev_hard_header.exit.i.i ], [ %i.jq, %dev_validate_header.exit.thread121.i.i ], [ %.1199.i, %bb.be ], [ %.1199.i, %bb.bd ], [ %.1199.i, %bb.bc ] ; 5 uses
  %i.js = ptrtoint ptr %.190.i.i to i64           ; 2 uses
  ...
  %i.ka = add i32 %i.jz, %.192.i.i
  store i32 %i.ka, ptr %i.jy, align 8
  %i.kb = getelementptr i8, ptr %i.fy, i64 216    ; 2 uses
  %i.kc = load i32, ptr %i.kb, align 8
  %i.kd = add i32 %i.kc, %.192.i.i
  store i32 %i.kd, ptr %i.kb, align 8
  %i.ke = call i32 asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock xaddl $0, $1", "=r,=*m,0,*m,~{memory},~{cc},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.cz, i32 range(i32 -2147483647, -2147483648) %.192.i.i, ptr elementtype(i32) %i.cz) #21, !srcloc !22 ; 3 uses
  %.not.i.i113.i.i = icmp eq i32 %i.ke, 0
  br i1 %.not.i.i113.i.i, label %.sink.split.i.i114.i.i, label %bb.bm, !prof !23

bb.bm:                                            ; preds = %dev_hard_header.exit.thread.i.i
  %i.kf = add i32 %i.ke, %.192.i.i
  %i.kg = or i32 %i.kf, %i.ke
  %.not10.i.i.i.i = icmp sgt i32 %i.kg, -1
...
.lr.ph.i.i:                                       ; preds = %refcount_add.exit.i.i
  %i.kh = getelementptr i8, ptr %i.fy, i64 126    ; 4 uses
  %.val105.peel.i.i = load i32, ptr %i.gx, align 8
  %.val106.peel.i.i = load ptr, ptr %i.gy, align 8
  %i.ki = zext i32 %.val105.peel.i.i to i64
  %i.kj = getelementptr i8, ptr %.val106.peel.i.i, i64 %i.ki
  %i.kk = getelementptr i8, ptr %i.kj, i64 2
  %i.kl = load i8, ptr %i.kk, align 2             ; 3 uses
  %i.km = icmp ugt i8 %i.kl, 16
  br i1 %i.km, label %.loopexit.i.i, label %bb.bn, !prof !23

bb.bn:                                            ; preds = %.lr.ph.i.i
  %i.kn = call zeroext i1 @is_vmalloc_addr(ptr noundef %.190.i.i) #20
  br i1 %i.kn, label %bb.bp, label %bb.bo

bb.bo:                                            ; preds = %bb.bn
  %i.ko = load i64, ptr @vmemmap_base, align 8
  %i.kp = inttoptr i64 %i.ko to ptr
  %i.kq = add i64 %i.js, 2147483648
  %i.kr = icmp ugt ptr %.190.i.i, inttoptr (i64 -2147483649 to ptr)
  %i.ks = load i64, ptr @phys_base, align 8
  %i.kt = load i64, ptr @page_offset_base, align 8
  %i.ku = sub i64 -2147483648, %i.kt
  %i.kv = select i1 %i.kr, i64 %i.ks, i64 %i.ku
  %i.kw = add i64 %i.kq, %i.kv
  %i.kx = lshr i64 %i.kw, 12
  %i.ky = getelementptr [64 x i8], ptr %i.kp, i64 %i.kx
  br label %pgv_to_page.exit.peel.i.i

bb.bp:                                            ; preds = %bb.bn
  %i.kz = call ptr @vmalloc_to_page(ptr noundef %.190.i.i) #20
  br label %pgv_to_page.exit.peel.i.i
...
pgv_to_page.exit.peel.i.i:                        ; preds = %bb.bp, %bb.bo
  ...
  %i.ld = and i64 %i.lc, 1
  %i.le = add nsw i64 %i.ld, -1
  %i.lf = or i64 %i.le, %i.lc
  %i.lg = ptrtoint ptr %.0.i116.peel.i.i to i64   ; 3 uses
  %i.lh = and i64 %i.lf, %i.lg
  %i.li = inttoptr i64 %i.lh to ptr               ; 2 uses
  %i.lj = getelementptr i8, ptr %i.li, i64 48
  %i.lk = load i32, ptr %i.lj, align 16
  %.mask.i.i.peel.i.i = and i32 %i.lk, -16777216
...
.critedge12.i.peel.i.i:                           ; preds = %pgv_to_page.exit.peel.i.i
  %i.ll = getelementptr i8, ptr %i.li, i64 52     ; 2 uses
  call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock incl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.ll, ptr elementtype(i32) %i.ll) #21, !srcloc !50
  br label %get_page.exit.peel.i.i

get_page.exit.peel.i.i:                           ; preds = %.critedge12.i.peel.i.i, %bb.br, %bb.bq
  %.val.peel.i.i = load i32, ptr %i.gx, align 8
  %.val102.peel.i.i = load ptr, ptr %i.gy, align 8
  %i.lm = zext i32 %.val.peel.i.i to i64
  %i.ln = getelementptr i8, ptr %.val102.peel.i.i, i64 %i.lm
  %i.lo = getelementptr i8, ptr %i.ln, i64 48
  %i.lp = zext nneg i8 %i.kl to i64
  %i.lq = getelementptr [16 x i8], ptr %i.lo, i64 %i.lp ; 3 uses
  store i64 %i.lg, ptr %i.lq, align 8
  %i.lr = getelementptr i8, ptr %i.lq, i64 12
  store i32 %i.ju, ptr %i.lr, align 4
  %i.ls = getelementptr i8, ptr %i.lq, i64 8
  store i32 %i.jw, ptr %i.ls, align 8
  %i.lt = load volatile i64, ptr %i.lb, align 8   ; 2 uses
  %i.lu = and i64 %i.lt, 1
  ...
  %.val107.peel.i.i = load ptr, ptr %i.lz, align 8
  %i.ma = ptrtoint ptr %.val107.peel.i.i to i64
  %i.mb = and i64 %i.ma, 2
  %.not127.peel.i.i = icmp eq i64 %i.mb, 0
  br i1 %.not127.peel.i.i, label %__skb_fill_netmem_desc.exit.peel.i.i, label %bb.bs

bb.bs:                                            ; preds = %get_page.exit.peel.i.i
  %i.mc = load i8, ptr %i.kh, align 2
  %i.md = or i8 %i.mc, 64
  store i8 %i.md, ptr %i.kh, align 2
  br label %__skb_fill_netmem_desc.exit.peel.i.i

__skb_fill_netmem_desc.exit.peel.i.i:             ; preds = %bb.bs, %get_page.exit.peel.i.i
  %i.me = add nuw nsw i8 %i.kl, 1
  %.val103.peel.i.i = load i32, ptr %i.gx, align 8
  %.val104.peel.i.i = load ptr, ptr %i.gy, align 8
  %i.mf = zext i32 %.val103.peel.i.i to i64
...
.peel.next.i.i:                                   ; preds = %__skb_fill_netmem_desc.exit.peel.i.i
  %i.mj = call i32 @llvm.smin.i32(i32 %i.mi, i32 4096)
  br label %bb.bt

bb.bt:                                            ; preds = %__skb_fill_netmem_desc.exit.i.i, %.peel.next.i.i
  %.2132.i.i = phi ptr [ %i.la, %.peel.next.i.i ], [ %i.nf, %__skb_fill_netmem_desc.exit.i.i ] ; 5 uses
  %.293131.i.i = phi i32 [ %i.mi, %.peel.next.i.i ], [ %i.on, %__skb_fill_netmem_desc.exit.i.i ]
  %.095130.i.i = phi i32 [ %i.mj, %.peel.next.i.i ], [ %i.oo, %__skb_fill_netmem_desc.exit.i.i ] ; 3 uses
  %.val105.i.i = load i32, ptr %i.gx, align 8
  %.val106.i.i = load ptr, ptr %i.gy, align 8
  %i.mk = zext i32 %.val105.i.i to i64
  %i.ml = getelementptr i8, ptr %.val106.i.i, i64 %i.mk
  %i.mm = getelementptr i8, ptr %i.ml, i64 2
  %i.mn = load i8, ptr %i.mm, align 2             ; 3 uses
  %i.mo = icmp ugt i8 %i.mn, 16
  br i1 %i.mo, label %.loopexit.i.i, label %bb.bu, !prof !23

.loopexit.i.i:                                    ; preds = %bb.bt, %.lr.ph.i.i
  %i.mp = call i32 (ptr, ...) @_printk(ptr noundef nonnull @.str.22, i32 noundef 17) #24 ; 0 uses
  br label %packet_sock_flag.exit.i

bb.bu:                                            ; preds = %bb.bt
  %i.mq = call zeroext i1 @is_vmalloc_addr(ptr noundef %.2132.i.i) #20
  br i1 %i.mq, label %bb.bv, label %bb.bw

bb.bv:                                            ; preds = %bb.bu
  %i.mr = call ptr @vmalloc_to_page(ptr noundef %.2132.i.i) #20
  br label %pgv_to_page.exit.i.i

bb.bw:                                            ; preds = %bb.bu
  %i.ms = load i64, ptr @vmemmap_base, align 8
  %i.mt = inttoptr i64 %i.ms to ptr
  %i.mu = ptrtoint ptr %.2132.i.i to i64
  %i.mv = add i64 %i.mu, 2147483648
  %i.mw = icmp ugt ptr %.2132.i.i, inttoptr (i64 -2147483649 to ptr)
  %i.mx = load i64, ptr @phys_base, align 8
  %i.my = load i64, ptr @page_offset_base, align 8
  %i.mz = sub i64 -2147483648, %i.my
  %i.na = select i1 %i.mw, i64 %i.mx, i64 %i.mz
  %i.nb = add i64 %i.mv, %i.na
  %i.nc = lshr i64 %i.nb, 12
  %i.nd = getelementptr [64 x i8], ptr %i.mt, i64 %i.nc
  br label %pgv_to_page.exit.i.i

pgv_to_page.exit.i.i:                             ; preds = %bb.bw, %bb.bv
  %.0.i116.i.i = phi ptr [ %i.mr, %bb.bv ], [ %i.nd, %bb.bw ] ; 2 uses
  %i.ne = sext i32 %.095130.i.i to i64
  %i.nf = getelementptr i8, ptr %.2132.i.i, i64 %i.ne
  %i.ng = getelementptr i8, ptr %.0.i116.i.i, i64 8 ; 2 uses
  %i.nh = load volatile i64, ptr %i.ng, align 8   ; 2 uses
  %i.ni = and i64 %i.nh, 1
  %i.nj = add nsw i64 %i.ni, -1
  %i.nk = or i64 %i.nj, %i.nh
  %i.nl = ptrtoint ptr %.0.i116.i.i to i64        ; 3 uses
  %i.nm = and i64 %i.nk, %i.nl
  %i.nn = inttoptr i64 %i.nm to ptr               ; 2 uses
  %i.no = getelementptr i8, ptr %i.nn, i64 48
  %i.np = load i32, ptr %i.no, align 16
  %.mask.i.i.i.i = and i32 %i.np, -16777216
...
.critedge12.i.i.i:                                ; preds = %pgv_to_page.exit.i.i
  %i.nq = getelementptr i8, ptr %i.nn, i64 52     ; 2 uses
  call void asm sideeffect ".pushsection .smp_locks,\22a\22\0A.balign 4\0A.long 671f - .\0A.popsection\0A671:\0A\09lock incl $0", "=*m,*m,~{memory},~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) %i.nq, ptr elementtype(i32) %i.nq) #21, !srcloc !50
  br label %get_page.exit.i.i

get_page.exit.i.i:                                ; preds = %.critedge12.i.i.i, %bb.by, %bb.bx
  %.val.i.i = load i32, ptr %i.gx, align 8
  %.val102.i.i = load ptr, ptr %i.gy, align 8
  %i.nr = zext i32 %.val.i.i to i64
  %i.ns = getelementptr i8, ptr %.val102.i.i, i64 %i.nr
  %i.nt = getelementptr i8, ptr %i.ns, i64 48
  %i.nu = zext nneg i8 %i.mn to i64
  %i.nv = getelementptr [16 x i8], ptr %i.nt, i64 %i.nu ; 3 uses
  store i64 %i.nl, ptr %i.nv, align 8
  %i.nw = getelementptr i8, ptr %i.nv, i64 12
  store i32 0, ptr %i.nw, align 4
  %i.nx = getelementptr i8, ptr %i.nv, i64 8
  store i32 %.095130.i.i, ptr %i.nx, align 8
  %i.ny = load volatile i64, ptr %i.ng, align 8   ; 2 uses
  %i.nz = and i64 %i.ny, 1
  %i.oa = add nsw i64 %i.nz, -1
  %i.ob = or i64 %i.oa, %i.ny
  %i.oc = and i64 %i.ob, %i.nl
  %i.od = inttoptr i64 %i.oc to ptr
  %i.oe = getelementptr i8, ptr %i.od, i64 8
  %.val107.i.i = load ptr, ptr %i.oe, align 8
  %i.of = ptrtoint ptr %.val107.i.i to i64
  %i.og = and i64 %i.of, 2
  %.not127.i.i = icmp eq i64 %i.og, 0
  br i1 %.not127.i.i, label %__skb_fill_netmem_desc.exit.i.i, label %bb.bz

bb.bz:                                            ; preds = %get_page.exit.i.i
  %i.oh = load i8, ptr %i.kh, align 2
  %i.oi = or i8 %i.oh, 64
  store i8 %i.oi, ptr %i.kh, align 2
  br label %__skb_fill_netmem_desc.exit.i.i

__skb_fill_netmem_desc.exit.i.i:                  ; preds = %bb.bz, %get_page.exit.i.i
  %i.oj = add nuw nsw i8 %i.mn, 1
  %.val103.i.i = load i32, ptr %i.gx, align 8
  %.val104.i.i = load ptr, ptr %i.gy, align 8
  %i.ok = zext i32 %.val103.i.i to i64
  %i.ol = getelementptr i8, ptr %.val104.i.i, i64 %i.ok
  %i.om = getelementptr i8, ptr %i.ol, i64 2
  store i8 %i.oj, ptr %i.om, align 2
  %i.on = sub i32 %.293131.i.i, %.095130.i.i      ; 3 uses
  %i.oo = call i32 @llvm.smin.i32(i32 %i.on, i32 4096)
  %.not101.i.i = icmp eq i32 %i.on, 0
...
._crit_edge.i185.i:                               ; preds = %__skb_fill_netmem_desc.exit.i.i, %__skb_fill_netmem_desc.exit.peel.i.i, %refcount_add.exit.i.i
  call fastcc void @packet_parse_headers(ptr noundef nonnull %i.fy, ptr noundef %i.gb) #22, !srcloc !97
  br label %tpacket_fill_skb.exit.i

tpacket_fill_skb.exit.i:                          ; preds = %._crit_edge.i185.i, %bb.bf
  %.1.i184.i = phi i32 [ %.0143.i, %._crit_edge.i185.i ], [ %i.ix, %bb.bf ] ; 4 uses
  %i.op = icmp sgt i32 %.1.i184.i, -1
  br i1 %i.op, label %bb.ca, label %packet_sock_flag.exit.i, !prof !98

bb.ca:                                            ; preds = %tpacket_fill_skb.exit.i
  %i.oq = load i32, ptr %i.bx, align 8
  %i.or = add i32 %i.oq, %.0132.i
  %i.os = icmp ule i32 %.1.i184.i, %i.or
  %or.cond3.i = select i1 %i.os, i1 true, i1 %i.cc
...
packet_extra_vlan_len_allowed.exit.i:             ; preds = %bb.cb
  %i.ot = load ptr, ptr %i.hv, align 8
  %i.ou = load ptr, ptr %i.gy, align 8            ; 2 uses
  %i.ov = ptrtoint ptr %i.ot to i64
  %i.ow = ptrtoint ptr %i.ou to i64
  %i.ox = sub i64 %i.ov, %i.ow                    ; 2 uses
  %i.oy = trunc i64 %i.ox to i16
  %i.oz = getelementptr i8, ptr %i.fy, i64 186
  store i16 %i.oy, ptr %i.oz, align 2
  %i.pa = and i64 %i.ox, 65535
  %i.pb = getelementptr i8, ptr %i.ou, i64 %i.pa
  %i.pc = getelementptr i8, ptr %i.pb, i64 12
  %i.pd = load i16, ptr %i.pc, align 1
  %.fr.i = freeze i16 %i.pd
  %i.pe = icmp eq i16 %.fr.i, 129
  br i1 %i.pe, label %bb.ch, label %packet_sock_flag.exit.i
...
packet_sock_flag.exit.i:                          ; preds = %bb.af, %bb.ag, %bb.aj, %bb.ak, %tpacket_parse_header.exit.i, %bb.am, %__packet_snd_vnet_parse.exit.i, %dev_hard_header.exit.i.i, %bb.bh, %bb.bk, %bb.bl, %dev_validate_header.exit.i.i, %.loopexit.i.i, %tpacket_fill_skb.exit.i, %bb.cb, %packet_extra_vlan_len_allowed.exit.i, %bb.ci
  ...
  %.0.i = phi ptr [ null, %tpacket_parse_header.exit.i ], [ null, %__packet_snd_vnet_parse.exit.i ], [ null, %bb.am ], [ null, %bb.aj ], [ %i.fy, %bb.ci ], [ null, %bb.ag ], [ null, %bb.af ], [ null, %bb.ak ], [ %i.fy, %dev_hard_header.exit.i.i ], [ %i.fy, %packet_extra_vlan_len_allowed.exit.i ], [ %i.fy, %tpacket_fill_skb.exit.i ], [ %i.fy, %bb.bk ], [ %i.fy, %bb.bl ], [ %i.fy, %bb.bh ], [ %i.fy, %dev_validate_header.exit.i.i ], [ %i.fy, %.loopexit.i.i ], [ %i.fy, %bb.cb ] ; 2 uses
  %i.pf = load volatile i64, ptr %i.cm, align 16
  %i.pg = and i64 %i.pf, 8
  %.not212.i = icmp eq i64 %i.pg, 0
...
bb.cf:                                            ; preds = %bb.cc
  %i.ph = getelementptr i8, ptr %i.dp, i64 20
  store volatile i32 0, ptr %i.ph, align 4
  br label %__packet_set_status.exit.i

bb.cg:                                            ; preds = %bb.cc
  %i.pi = call ptr asm sideeffect "lea (2f)(%rip), $0\0A1:\0A.pushsection __bug_table,\22aw\22\0A\09912: .pushsection .discard.annotate_data, \22M\22, @progbits, 8; .long 912b - ., 1; .popsection\0A\092:\0A\09\09.long 1b - .\09# bug_entry::bug_addr\0A\09.long ${1:c} - .\09# bug_entry::format\0A\09.long ${2:c} - .\09# bug_entry::file\0A\09.word ${3:c}\09# bug_entry::line\0A\09.word ${4:c}\09# bug_entry::flags\0A\09.org 2b + ${5:c}\0A.popsection\0A", "=r,i,i,i,i,i,~{dirflag},~{fpsr},~{flags}"(ptr nonnull @.str.15, ptr nonnull @.str.3, i32 421, i32 2321, i64 16) #21, !srcloc !99
end_hunk_0
