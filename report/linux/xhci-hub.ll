...
._crit_edge266.i.peel:                            ; preds = %.lr.ph265.preheader.i.peel, %.lr.ph272.i
  %.0216.lcssa.i.peel = phi i16 [ %i.hu, %.lr.ph272.i ], [ %spec.select.peel, %.lr.ph265.preheader.i.peel ] ; 3 uses
  %i.hx = zext i16 %.0216.lcssa.i.peel to i32
  %i.hy = icmp ugt i16 %.0216.lcssa.i.peel, 9
  %i.hz = icmp eq i32 %i.hv, 0
  %or.cond.i.peel = and i1 %i.hk, %i.hz           ; 2 uses
  %i.ia = icmp ugt i16 %.0216.lcssa.i.peel, 10    ; 2 uses
...
._crit_edge266.i:                                 ; preds = %.lr.ph265.preheader.i, %.lr.ph272.i.peel.newph
  %.0216.lcssa.i = phi i16 [ %i.jf, %.lr.ph272.i.peel.newph ], [ %spec.select, %.lr.ph265.preheader.i ] ; 4 uses
  %i.ji = zext i16 %.0216.lcssa.i to i32          ; 2 uses
  ...
  %i.jk = icmp ugt i16 %.0216.lcssa.i, 9
...
bb.ab:                                            ; preds = %._crit_edge266.i
  ...
  %i.jo = icmp eq i16 %.0216.lcssa.i, 10
...
bb.ad:                                            ; preds = %bb.ac, %bb.ab
  ...
  %i.js = icmp ugt i16 %.0216.lcssa.i, 10         ; 2 uses
...
.loopexit:                                        ; preds = %bb.r, %bb.g, %bb.i
  ...
  %.047 = phi i32 [ -19, %bb.i ], [ %i.o, %bb.g ], [ %i.o, %bb.r ]
...
bb.t:                                             ; preds = %bb.s, %.loopexit
  ...
  %i.bt = select i1 %i.br, i32 %.047, i32 0
  ret i32 %i.bt
}
...
bb.i:                                             ; preds = %bb.f, %bb.g, %bb.h
  %.089 = phi i32 [ 66016, %bb.g ], [ 66016, %bb.h ], [ 65536, %bb.f ]
...
arch_clear_bit.exit106:                           ; preds = %bb.q, %bb.o, %bb.p, %arch_test_bit.exit
  %.090 = phi i32 [ %i.ak, %arch_test_bit.exit ], [ %i.bb, %bb.p ], [ %i.ak, %bb.o ], [ %i.ak, %bb.q ]
  %i.bc = and i32 %.090, -251527171
