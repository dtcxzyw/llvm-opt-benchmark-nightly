...
bb.c:                                             ; preds = %bb.b
  %i.y = sub nuw i32 %i.v, %i.w                   ; 2 uses
...
snd_interval_list.exit:                           ; preds = %.split.split.split.split.us, %.split.split.us.split.us.split.split.us, %.split.split.split, %.split.split, %.split.split.us.split.us.split, %.split.split.us.split.us, %.split.split.us, %bb.a
  ...
  store i32 0, ptr %i.v, align 4, !annotation !16
...
bb.g:                                             ; preds = %bb.f, %bb.h
  ...
  %i.l = tail call i64 asm "tzcnt $1,$0", "=r,r,~{dirflag},~{fpsr},~{flags}"(i64 range(i64 1, 4294967296) %i.k) #24, !srcloc !18
