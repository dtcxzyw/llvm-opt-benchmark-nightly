...
begin_hunk_0_@_RNvNtNtCslghKHtsL3a4_5tokio4time5sleep5sleep:bb.a
  store i64 2, ptr %i.w, align 8, !alias.scope !627, !noalias !629
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !628
  br label %bb.h
...
bb.e:                                             ; preds = %bb.a
  ...
  %i.y = call { i64, ptr } @_RNvMs1_NtNtCslghKHtsL3a4_5tokio7runtime9schedulerNtB5_6Handle7current(ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %3), !noalias !630 ; 2 uses
  %i.z = extractvalue { i64, ptr } %i.y, 0        ; 3 uses
  %i.aa = extractvalue { i64, ptr } %i.y, 1       ; 4 uses
  store i64 %i.z, ptr %i.a, align 8, !noalias !631
  %i.ab = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store ptr %i.aa, ptr %i.ab, align 8, !noalias !631
  ...
  %i.ae = invoke noundef nonnull align 8 ptr @_RNvMs_NtNtCslghKHtsL3a4_5tokio7runtime6driverNtB4_6Handle4time(ptr noundef nonnull align 8 %i.ad, ptr noalias nofree noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(24) %3)
          to label %_RNvMNtNtCslghKHtsL3a4_5tokio4time5sleepNtB2_5Sleep11new_timeout.exit4 unwind label %bb.f, !noalias !630 ; 0 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  invoke fastcc void @_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtNtCslghKHtsL3a4_5tokio7runtime9scheduler6HandleEBH_(ptr noalias nofree noundef align 8 dereferenceable(16) %i.a) #25
          to label %common.resume unwind label %bb.g, !noalias !630

bb.g:                                             ; preds = %bb.f
  %i.ag = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCs3oUPovFnLWP_4core9panicking16panic_in_cleanup() #27, !noalias !630
  unreachable
...
_RNvMNtNtCslghKHtsL3a4_5tokio4time5sleepNtB2_5Sleep11new_timeout.exit4: ; preds = %bb.e
  ...
  store i64 %i.ai, ptr %i.aj, align 8, !alias.scope !630, !noalias !632
  %i.ak = getelementptr inbounds nuw i8, ptr %0, i64 104
  store i32 %i.ah, ptr %i.ak, align 8, !alias.scope !630, !noalias !632
  store i64 %i.z, ptr %0, align 8, !alias.scope !630, !noalias !632
  %i.al = getelementptr inbounds nuw i8, ptr %0, i64 8
  store ptr %i.aa, ptr %i.al, align 8, !alias.scope !630, !noalias !632
  %i.am = getelementptr inbounds nuw i8, ptr %0, i64 16
  store i64 2, ptr %i.am, align 8, !alias.scope !630, !noalias !632
...
bb.a:
  ...
  %i.b = tail call noundef ptr @memchr(ptr noundef nonnull readonly %1, i32 noundef %i.a, i64 noundef range(i64 0, -9223372036854775808) %2) #30, !alias.scope !635 ; 2 uses
...
bb.a:
  ...
  %i.e = load i64, ptr %2, align 8, !range !638, !noundef !8
...
bb.p:                                             ; preds = %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtCs1xwejQucwHj_5alloc6string6StringECslghKHtsL3a4_5tokio.exit17
  ...
  %i.r = load i64, ptr %i.q, align 8, !noundef !8 ; 4 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.w = load ptr, ptr %i.v, align 8, !alias.scope !639, !nonnull !8, !noundef !8
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 %i.t
  %i.y = load i8, ptr %i.x, align 1, !noalias !639, !noundef !8
  %i.z = icmp sgt i8 %i.y, -65
  br i1 %i.z, label %.split.i, label %bb.s, !prof !6
...
bb.b:                                             ; preds = %bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !648
  %i.h = getelementptr inbounds nuw i8, ptr %i.c, i64 8 ; 2 uses
  %i.i = load ptr, ptr %i.h, align 8, !alias.scope !647, !noalias !646, !nonnull !8, !noundef !8
  %i.j = getelementptr inbounds nuw i8, ptr %i.c, i64 16
  %i.k = load i64, ptr %i.j, align 8, !alias.scope !647, !noalias !646, !noundef !8 ; 2 uses
  invoke void @_RNvNtNtCs3oUPovFnLWP_4core3str8converts9from_utf8(ptr noalias nofree noundef nonnull sret([24 x i8]) align 8 captures(none) dereferenceable(24) %i.b, ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) %i.i, i64 noundef %i.k)
          to label %bb.d unwind label %bb.c, !noalias !648
...
bb.c:                                             ; preds = %bb.b
  ...
  invoke void @_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueINtNtCs1xwejQucwHj_5alloc3vec3VechEECslghKHtsL3a4_5tokio(ptr noalias nofree noundef nonnull align 8 dereferenceable(24) %i.c) #25
          to label %.thread18 unwind label %bb.e, !noalias !646

bb.d:                                             ; preds = %bb.b
  %i.m = load i64, ptr %i.b, align 8, !range !7, !noalias !648, !noundef !8
  %i.n = trunc nuw i64 %i.m to i1
  br i1 %i.n, label %bb.f, label %.thread25

.thread25:                                        ; preds = %bb.d
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.6.sroa.0, ptr noundef nonnull align 8 dereferenceable(16) %i.c, i64 16, i1 false), !alias.scope !648
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !648
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c)
  br label %bb.k
...
bb.e:                                             ; preds = %bb.c
  %i.o = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCs3oUPovFnLWP_4core9panicking16panic_in_cleanup() #27, !noalias !646
  unreachable

bb.f:                                             ; preds = %bb.d
  %i.p = getelementptr inbounds nuw i8, ptr %i.b, i64 8 ; 2 uses
  %i.q = load <2 x i64>, ptr %i.p, align 8, !noalias !648
  %i.r = load i64, ptr %i.p, align 8, !noalias !648
  %.sroa.012.0.copyload = load i64, ptr %i.c, align 8, !noalias !646 ; 2 uses
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.6.sroa.0, ptr noundef nonnull align 8 dereferenceable(16) %i.h, i64 16, i1 false), !noalias !8
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !648
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !649)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !650)
  %.not.i = icmp eq i64 %.sroa.012.0.copyload, -1
  br i1 %.not.i, label %bb.k, label %bb.g, !prof !651

bb.g:                                             ; preds = %bb.f
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !652
  store i64 %.sroa.012.0.copyload, ptr %i.a, align 8, !noalias !649
  %.sroa.6.0..sroa_idx9 = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.6.0..sroa_idx9, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.6.sroa.0, i64 16, i1 false), !noalias !649
  %.sroa.6.sroa.6.0..sroa.6.0..sroa_idx9.sroa_idx = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  store <2 x i64> %i.q, ptr %.sroa.6.sroa.6.0..sroa.6.0..sroa_idx9.sroa_idx, align 8, !noalias !649
  invoke void @_RNvNtCs3oUPovFnLWP_4core6result13unwrap_failed(ptr noalias nofree noundef nonnull readonly captures(address, read_provenance) @42, i64 noundef 38, ptr noundef nonnull %i.a, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @18, ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @43) #31
          to label %bb.i unwind label %bb.h, !noalias !652
...
bb.h:                                             ; preds = %bb.g
  ...
  invoke void @_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueNtNtCs1xwejQucwHj_5alloc6string13FromUtf8ErrorECslghKHtsL3a4_5tokio(ptr noalias nofree noundef nonnull align 8 dereferenceable(40) %i.a) #25
          to label %.thread18 unwind label %bb.j, !noalias !652
...
bb.k:                                             ; preds = %bb.f, %.thread25
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.6.sroa.0, i64 16, i1 false), !alias.scope !652
