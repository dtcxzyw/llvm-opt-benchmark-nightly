...
bb.a:
  ...
  br i1 %1, label %bb.c, label %bb.b, !prof !30
...
bb.e:                                             ; preds = %bb.d, %_RNvMNtCs3oUPovFnLWP_4core6resultINtB2_6ResultINtNtNtB4_4task4poll4PollNtNtNtCslghKHtsL3a4_5tokio4task4coop16RestoreOnPendingENtNtNtCsaL1QbXo9JQH_3std6thread5local11AccessErrorE9unwrap_orB1c_.exit.thread
  ...
  %.not94.i = trunc i64 %i.ad to i1
  br i1 %.not94.i, label %_RNvMNtNtCslghKHtsL3a4_5tokio4sync15batch_semaphoreNtB2_9Semaphore12poll_acquire.exit.thread.thread, label %.lr.ph.i
...
bb.i:                                             ; preds = %.thread27.i, %.noexc
  ...
  %.not.i = trunc i64 %.sroa.01.0.i42.i to i1
  br i1 %.not.i, label %.thread52.i, label %.lr.ph.i
