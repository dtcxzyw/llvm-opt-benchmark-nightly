...
bb.a:
  ...
  %i.a = tail call noundef align 8 dereferenceable_or_null(344) ptr @_RNvCsjHpjAFo4bi0_7___rustc12___rust_alloc(i64 noundef 344, i64 noundef 8) #24, !noalias !163 ; 12 uses
  %i.b = icmp eq ptr %i.a, null
  br i1 %i.b, label %bb.b, label %_RNvNtCs1xwejQucwHj_5alloc5boxed14box_new_uninit.exit, !prof !6

bb.b:                                             ; preds = %bb.a
  tail call void @_RNvNtCs1xwejQucwHj_5alloc5alloc18handle_alloc_error(i64 noundef 8, i64 noundef 344) #28, !noalias !163
  unreachable
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.5)
  call void @_RNvMNtNtNtCslghKHtsL3a4_5tokio4sync5watch10big_notifyNtB2_9BigNotify3new(ptr noalias nofree noundef nonnull sret([256 x i8]) align 8 captures(none) dereferenceable(256) %.sroa.5)
  tail call void @_RNvCsjHpjAFo4bi0_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #24, !noalias !166
  %i.a = tail call noundef align 8 dereferenceable_or_null(336) ptr @_RNvCsjHpjAFo4bi0_7___rustc12___rust_alloc(i64 noundef 336, i64 noundef 8) #24, !noalias !166 ; 10 uses
  %i.b = icmp eq ptr %i.a, null
  br i1 %i.b, label %bb.b, label %_RNvNtCs1xwejQucwHj_5alloc5boxed14box_new_uninit.exit, !prof !6

bb.b:                                             ; preds = %bb.a
  tail call void @_RNvNtCs1xwejQucwHj_5alloc5alloc18handle_alloc_error(i64 noundef 8, i64 noundef 336) #28, !noalias !166
  unreachable
...
bb.a:
  tail call void @_RNvCsjHpjAFo4bi0_7___rustc35___rust_no_alloc_shim_is_unstable_v2() #24, !noalias !169
  %i.a = tail call noundef align 8 dereferenceable_or_null(64) ptr @_RNvCsjHpjAFo4bi0_7___rustc12___rust_alloc(i64 noundef 64, i64 noundef 8) #24, !noalias !169 ; 8 uses
  %i.b = icmp eq ptr %i.a, null
  br i1 %i.b, label %.noexc, label %_RNvMNtCs1xwejQucwHj_5alloc5boxedINtB2_3BoxINtNtB4_4sync8ArcInnerINtNtNtCslghKHtsL3a4_5tokio4sync7oneshot5InneruEEE3newB17_.exit, !prof !6
...
._crit_edge:                                      ; preds = %bb.a
  ...
  br i1 %i.h, label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueINtNtB4_6option6OptionINtNtNtNtCslghKHtsL3a4_5tokio4loom3std11parking_lot10MutexGuardNtNtNtB16_4sync15batch_semaphore8WaitlistEEEB16_.exit, label %bb.c, !prof !5
...
bb.g:                                             ; preds = %bb.b
  ...
  br i1 %i.l, label %_RNCNvMNtNtCslghKHtsL3a4_5tokio4sync15batch_semaphoreNtB4_9Semaphore18add_permits_locked0B8_.exit, label %bb.h, !prof !5
...
_RNCNvMNtNtCslghKHtsL3a4_5tokio4sync15batch_semaphoreNtB4_9Semaphore18add_permits_locked0B8_.exit: ; preds = %bb.g, %bb.h, %bb.b
  ...
  %i.n = load i64, ptr %i.e, align 8, !noundef !4
...
bb.i:                                             ; preds = %.lr.ph, %bb.aa
  %i.r = load ptr, ptr %i.p, align 8, !noundef !4 ; 2 uses
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.t = load atomic i64, ptr %i.s acquire, align 8, !noalias !172
  %i.u = load i64, ptr %i.d, align 8, !alias.scope !172, !noundef !4 ; 3 uses
  br label %bb.k
...
bb.k:                                             ; preds = %bb.k, %bb.j
  ...
  %i.w = cmpxchg ptr %i.s, i64 %.sroa.02.0.i, i64 %i.v acq_rel acquire, align 8, !noalias !172 ; 2 uses
...
bb.l:                                             ; preds = %bb.i
  %i.x = load i64, ptr %i.d, align 8, !noundef !4 ; 2 uses
...
thread-pre-split51:                               ; preds = %.loopexit, %bb.l
  ...
  br i1 %i.z, label %bb.s, label %bb.r, !prof !5
...
bb.n:                                             ; preds = %bb.k
  ...
  store i64 %i.aa, ptr %i.d, align 8, !alias.scope !172
...
bb.p:                                             ; preds = %.loopexit, %bb.l, %bb.u
  ...
  br i1 %i.ad, label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueINtNtNtNtCslghKHtsL3a4_5tokio4loom3std11parking_lot10MutexGuardNtNtNtBK_4sync15batch_semaphore8WaitlistEEBK_.exit, label %bb.q, !prof !5
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.c, label %bb.e, label %bb.d, !prof !5
...
bb.a:
  ...
  br i1 %i.a, label %bb.c, label %bb.b, !prof !5
...
bb.a:
  %i.a = load ptr, ptr %1, align 8, !nonnull !4, !align !7, !noundef !4 ; 2 uses
  %i.b = load ptr, ptr %i.a, align 8, !nonnull !4, !align !7, !noundef !4
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %.not5.i.i, label %bb.f, label %bb.g, !prof !6
...
bb.h:                                             ; preds = %bb.e
  ...
  br i1 %i.g, label %_RNvMs_NtNtNtCslghKHtsL3a4_5tokio7runtime4task5stateNtB4_8Snapshot7ref_inc.exit.i.i, label %bb.i, !prof !5
...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %i.d, label %_RNvMs_NtNtNtCslghKHtsL3a4_5tokio7runtime4task5stateNtB4_8Snapshot7ref_inc.exit.i.i, label %bb.f, !prof !5
...
bb.f:                                             ; preds = %bb.c
  ...
  br i1 %i.e, label %_RNvMs_NtNtNtCslghKHtsL3a4_5tokio7runtime4task5stateNtB4_8Snapshot7ref_inc.exit.i.i, label %bb.g, !prof !5
...
bb.j:                                             ; preds = %.noexc6
  %i.at = load ptr, ptr %1, align 8, !alias.scope !234, !noalias !235, !nonnull !4
...
bb.l:                                             ; preds = %bb.i, %bb.h
  ...
  %i.aw = load ptr, ptr %1, align 8, !alias.scope !238, !noalias !239, !nonnull !4, !noundef !4 ; 3 uses
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 %.sroa.3.0.i.ph.i ; 2 uses
  %i.ay = load i8, ptr %i.ax, align 1, !noalias !240, !noundef !4
  %i.az = and i8 %i.ay, 1
  %i.ba = zext nneg i8 %i.az to i64
  %i.bb = add i64 %.sroa.3.0.i.ph.i, -16
  %i.bc = load i64, ptr %i.h, align 8, !alias.scope !238, !noalias !239, !noundef !4
  %i.bd = and i64 %i.bc, %i.bb
  store i8 %i.j, ptr %i.ax, align 1, !noalias !240
...
bb.d:                                             ; preds = %bb.b
  %i.g = landingpad { ptr, i32 }
          cleanup
  %i.h = atomicrmw sub ptr %i.b, i64 1 release, align 8, !noalias !245
...
bb.a:
  ...
  %i.c = load ptr, ptr %0, align 8, !nonnull !4, !align !7, !noundef !4 ; 5 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !266)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !267)
  %i.d = load ptr, ptr %i.c, align 8, !alias.scope !266, !noalias !267, !noundef !4 ; 9 uses
  %.not.i = icmp eq ptr %i.d, null
  br i1 %.not.i, label %bb.r, label %bb.b, !prof !6
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load i8, ptr %i.f, align 8, !range !9, !noalias !270, !noundef !4
...
_RNvYNCNKNvNtNtCslghKHtsL3a4_5tokio7runtime7context7CONTEXT00INtNtNtCs3oUPovFnLWP_4core3ops8function6FnOnceTINtNtB13_6option6OptionQIB1I_NtB8_7ContextEEEE9call_onceBc_.exit.i.i.i: ; preds = %bb.b
  %i.i = tail call noundef ptr @_RNvMNtNtNtNtCsaL1QbXo9JQH_3std3sys12thread_local6native5eagerINtB2_7StorageNtNtNtCslghKHtsL3a4_5tokio7runtime7context7ContextE16get_or_init_slowB1h_(ptr noundef nonnull align 8 %i.e), !noalias !270 ; 2 uses
...
_RNvYNCNKNvNtNtCslghKHtsL3a4_5tokio7runtime7context7CONTEXT00INtNtNtCs3oUPovFnLWP_4core3ops8function6FnOnceTINtNtB13_6option6OptionQIB1I_NtB8_7ContextEEEE9call_onceBc_.exit.thread.i.i.i: ; preds = %_RNvYNCNKNvNtNtCslghKHtsL3a4_5tokio7runtime7context7CONTEXT00INtNtNtCs3oUPovFnLWP_4core3ops8function6FnOnceTINtNtB13_6option6OptionQIB1I_NtB8_7ContextEEEE9call_onceBc_.exit.i.i.i, %bb.b
  ...
  %i.l = load i8, ptr %i.k, align 1, !range !10, !noalias !271, !noundef !4 ; 2 uses
  %i.m = trunc nuw i8 %i.l to i1
  %i.n = getelementptr inbounds nuw i8, ptr %.sroa.0.0.i.i2.i.i.i, i64 69 ; 2 uses
  %i.o = load i8, ptr %i.n, align 1, !noalias !271 ; 4 uses
...
_RNvMs4_NtNtCslghKHtsL3a4_5tokio4sync7oneshotINtB5_5InneruE9poll_recvB9_.exit.thread.i: ; preds = %bb.c
  tail call void @_RNvNtNtCslghKHtsL3a4_5tokio4task4coop14register_waker(ptr noalias nofree noundef nonnull align 8 dereferenceable(32) %1), !noalias !266
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !269
  store i24 0, ptr %i.a, align 4, !noalias !269
  %i.p = getelementptr inbounds nuw i8, ptr %i.a, i64 1
  call void @_RNvXs4_NtNtCslghKHtsL3a4_5tokio4task4coopNtB5_16RestoreOnPendingNtNtNtCs3oUPovFnLWP_4core3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull dereferenceable(2) %i.p), !noalias !266
...
_RNvMNtCs3oUPovFnLWP_4core6resultINtB2_6ResultINtNtNtB4_4task4poll4PollNtNtNtCslghKHtsL3a4_5tokio4task4coop16RestoreOnPendingENtNtNtCsaL1QbXo9JQH_3std6thread5local11AccessErrorE9unwrap_orB1c_.exit.i.i: ; preds = %bb.d, %_RNvYNCNKNvNtNtCslghKHtsL3a4_5tokio7runtime7context7CONTEXT00INtNtNtCs3oUPovFnLWP_4core3ops8function6FnOnceTINtNtB13_6option6OptionQIB1I_NtB8_7ContextEEEE9call_onceBc_.exit.thread.i.i.i
  ...
  store i8 %.sroa.33.0.i.i.i.i.i, ptr %i.n, align 1, !noalias !271
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !269
  store i24 0, ptr %i.a, align 4, !noalias !269
  %i.r = getelementptr inbounds nuw i8, ptr %i.a, i64 1
  call void @_RNvXs4_NtNtCslghKHtsL3a4_5tokio4task4coopNtB5_16RestoreOnPendingNtNtNtCs3oUPovFnLWP_4core3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull dereferenceable(2) %i.r), !noalias !272
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !269
...
bb.e:                                             ; preds = %_RNvMNtNtCslghKHtsL3a4_5tokio4sync7oneshotNtB2_4Task9drop_task.exit.thread.i.i, %bb.m
  ...
  invoke void @_RNvXs4_NtNtCslghKHtsL3a4_5tokio4task4coopNtB5_16RestoreOnPendingNtNtNtCs3oUPovFnLWP_4core3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull dereferenceable(2) %i.b)
          to label %common.resume.i unwind label %bb.q, !noalias !272
...
_RNvMNtCs3oUPovFnLWP_4core6resultINtB2_6ResultINtNtNtB4_4task4poll4PollNtNtNtCslghKHtsL3a4_5tokio4task4coop16RestoreOnPendingENtNtNtCsaL1QbXo9JQH_3std6thread5local11AccessErrorE9unwrap_orB1c_.exit.thread.i.i: ; preds = %_RNvMNtCs3oUPovFnLWP_4core6resultINtB2_6ResultINtNtNtB4_4task4poll4PollNtNtNtCslghKHtsL3a4_5tokio4task4coop16RestoreOnPendingENtNtNtCsaL1QbXo9JQH_3std6thread5local11AccessErrorE9unwrap_orB1c_.exit.i.i, %_RNvYNCNKNvNtNtCslghKHtsL3a4_5tokio7runtime7context7CONTEXT00INtNtNtCs3oUPovFnLWP_4core3ops8function6FnOnceTINtNtB13_6option6OptionQIB1I_NtB8_7ContextEEEE9call_onceBc_.exit.i.i.i
  ...
  store i8 %.sroa.03.011.i34.off8.i.i, ptr %i.b, align 1, !noalias !269
  %i.t = getelementptr inbounds nuw i8, ptr %i.b, i64 1
  store i8 %.sroa.03.011.i34.off16.i.i, ptr %i.t, align 1, !noalias !269
  %i.u = getelementptr inbounds nuw i8, ptr %i.d, i64 48 ; 4 uses
  %i.v = load atomic i64, ptr %i.u acquire, align 8, !noalias !269 ; 3 uses
  %i.w = and i64 %i.v, 2
...
bb.g:                                             ; preds = %_RNvMNtCs3oUPovFnLWP_4core6resultINtB2_6ResultINtNtNtB4_4task4poll4PollNtNtNtCslghKHtsL3a4_5tokio4task4coop16RestoreOnPendingENtNtNtCsaL1QbXo9JQH_3std6thread5local11AccessErrorE9unwrap_orB1c_.exit.thread.i.i
  ...
  %i.z = load i8, ptr %i.y, align 8, !range !10, !noalias !269, !noundef !4
  store i8 0, ptr %i.y, align 8, !noalias !269
...
bb.j:                                             ; preds = %bb.h
  ...
  %i.ab = load ptr, ptr %1, align 8, !alias.scope !273, !noalias !266, !nonnull !4, !align !7, !noundef !4 ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %i.d, i64 40 ; 2 uses
  %i.ad = load ptr, ptr %i.ac, align 8, !noalias !269, !noundef !4
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ab, i64 8
  %i.af = load ptr, ptr %i.ae, align 8, !noalias !272, !noundef !4
  %i.ag = icmp eq ptr %i.ad, %i.af
  br i1 %i.ag, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.ah = load ptr, ptr %i.ab, align 8, !noalias !272, !nonnull !4, !align !7, !noundef !4
  %i.ai = load ptr, ptr %i.aa, align 8, !noalias !269, !nonnull !4, !align !7, !noundef !4
...
bb.l:                                             ; preds = %bb.k, %bb.j
  %i.ak = atomicrmw and ptr %i.u, i64 -2 acq_rel, align 8, !noalias !269
  %i.al = and i64 %i.ak, 2
  %.not28.i.i = icmp eq i64 %i.al, 0
  br i1 %.not28.i.i, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  %i.am = load ptr, ptr %i.aa, align 8, !noalias !269, !nonnull !4, !align !7, !noundef !4
  %i.an = getelementptr inbounds nuw i8, ptr %i.am, i64 24
  %i.ao = load ptr, ptr %i.an, align 8, !noalias !272, !nonnull !4, !noundef !4
  %i.ap = load ptr, ptr %i.ac, align 8, !noalias !269, !noundef !4
  invoke void %i.ao(ptr noundef %i.ap)
          to label %_RNvMNtNtCslghKHtsL3a4_5tokio4sync7oneshotNtB2_4Task9drop_task.exit.thread.i.i unwind label %bb.e, !noalias !272, !inline_history !11

bb.n:                                             ; preds = %bb.l
  %i.aq = atomicrmw or ptr %i.u, i64 1 acq_rel, align 8, !noalias !269 ; 0 uses
  store i8 0, ptr %i.b, align 1, !noalias !269
  %i.ar = getelementptr inbounds nuw i8, ptr %i.d, i64 56 ; 2 uses
  %i.as = load i8, ptr %i.ar, align 8, !range !10, !noalias !269, !noundef !4
  store i8 0, ptr %i.ar, align 8, !noalias !269
...
_RNvMNtNtCslghKHtsL3a4_5tokio4sync7oneshotNtB2_4Task9drop_task.exit.thread.i.i: ; preds = %bb.m, %bb.h
  ...
  %i.at = load ptr, ptr %1, align 8, !alias.scope !275, !noalias !266, !nonnull !4, !align !7, !noundef !4 ; 2 uses
  %i.au = load ptr, ptr %i.at, align 8, !noalias !276, !nonnull !4, !align !7, !noundef !4
  %i.av = load ptr, ptr %i.au, align 8, !noalias !276, !nonnull !4, !noundef !4
  %i.aw = getelementptr inbounds nuw i8, ptr %i.at, i64 8
  %i.ax = load ptr, ptr %i.aw, align 8, !noalias !276, !noundef !4
  %i.ay = invoke { ptr, ptr } %i.av(ptr noundef %i.ax)
          to label %bb.o unwind label %bb.e, !noalias !272, !inline_history !277 ; 2 uses
...
bb.o:                                             ; preds = %_RNvMNtNtCslghKHtsL3a4_5tokio4sync7oneshotNtB2_4Task9drop_task.exit.thread.i.i
  ...
  store ptr %i.ba, ptr %i.az, align 8, !noalias !278
  %i.bc = getelementptr inbounds nuw i8, ptr %i.d, i64 40
  store ptr %i.bb, ptr %i.bc, align 8, !noalias !278
  %i.bd = atomicrmw or ptr %i.u, i64 1 acq_rel, align 8, !noalias !269
  %i.be = and i64 %i.bd, 2
...
bb.p:                                             ; preds = %bb.o
  ...
  %i.bg = load i8, ptr %i.bf, align 8, !range !10, !noalias !269, !noundef !4
  store i8 0, ptr %i.bf, align 8, !noalias !269
...
bb.q:                                             ; preds = %bb.e
  %i.bh = landingpad { ptr, i32 }
          filter [0 x ptr] zeroinitializer        ; 0 uses
  call void @_RNvNtCs3oUPovFnLWP_4core9panicking16panic_in_cleanup() #26, !noalias !272
  unreachable
...
_RNvMs4_NtNtCslghKHtsL3a4_5tokio4sync7oneshotINtB5_5InneruE9poll_recvB9_.exit.i: ; preds = %bb.o, %bb.k
  call void @_RNvXs4_NtNtCslghKHtsL3a4_5tokio4task4coopNtB5_16RestoreOnPendingNtNtNtCs3oUPovFnLWP_4core3ops4drop4Drop4drop(ptr noalias nofree noundef nonnull dereferenceable(2) %i.b), !noalias !272
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !269
  br label %_RNvXs3_NtNtCslghKHtsL3a4_5tokio4sync7oneshotINtB5_8ReceiveruENtNtNtCs3oUPovFnLWP_4core6future6future6Future4pollB9_.exit

bb.r:                                             ; preds = %bb.a
  tail call void @_RNvNtCs3oUPovFnLWP_4core9panicking9panic_fmt(ptr noundef nonnull @71, ptr noundef nonnull inttoptr (i64 43 to ptr), ptr noalias nofree noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @73) #29, !noalias !272
  unreachable
...
bb.s:                                             ; preds = %bb.p, %bb.n, %bb.i, %bb.g
  ...
  %i.bi = load ptr, ptr %i.c, align 8, !alias.scope !280, !noalias !267, !noundef !4 ; 2 uses
...
bb.t:                                             ; preds = %bb.s
  %i.bk = atomicrmw sub ptr %i.bi, i64 1 release, align 8, !noalias !281
...
bb.u:                                             ; preds = %bb.t
  ...
  invoke void @_RNvMsn_NtCs1xwejQucwHj_5alloc4syncINtB5_3ArcINtNtNtCslghKHtsL3a4_5tokio4sync7oneshot5InneruEE9drop_slowBN_(ptr noalias nofree noundef nonnull align 8 dereferenceable(8) %i.c) #27
          to label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueINtNtB4_6option6OptionINtNtCs1xwejQucwHj_5alloc4sync3ArcINtNtNtCslghKHtsL3a4_5tokio4sync7oneshot5InneruEEEEB1C_.exit.i unwind label %bb.v, !noalias !267
...
bb.f:                                             ; preds = %.lr.ph.i
  %.not28.i.a = icmp eq ptr %.sroa.0.295.i, null
  br i1 %.not28.i.a, label %bb.g, label %.noexc

bb.g:                                             ; preds = %bb.f
  %i.ae = cmpxchg weak ptr %i.c, i8 0, i8 1 acquire monotonic, align 1
  %i.af = extractvalue { i8, i1 } %i.ae, 1
  br i1 %i.af, label %.noexc, label %bb.h, !prof !5
...
bb.l:                                             ; preds = %bb.k
  ...
  br i1 %i.an, label %.thread.i, label %bb.m, !prof !5
...
.thread.i:                                        ; preds = %.thread.loopexit.i, %bb.m, %bb.l, %bb.k
  ...
  %i.ar = load i8, ptr %i.aq, align 8, !range !10, !noundef !4
  %i.as = trunc nuw i8 %i.ar to i1
  br i1 %i.as, label %bb.p, label %bb.n

bb.n:                                             ; preds = %.thread.i
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 2 uses
  %i.au = load atomic i64, ptr %i.at acquire, align 8, !noalias !299
  br label %bb.o
...
bb.o:                                             ; preds = %bb.o, %bb.n
  ...
  %i.aw = cmpxchg ptr %i.at, i64 %.sroa.02.0.i.i, i64 %i.av acq_rel acquire, align 8, !noalias !299 ; 2 uses
...
bb.p:                                             ; preds = %.thread.i
  ...
  br i1 %i.ay, label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueINtNtNtNtCslghKHtsL3a4_5tokio4loom3std11parking_lot10MutexGuardNtNtNtBK_4sync15batch_semaphore8WaitlistEEBK_.exit.i, label %bb.q, !prof !5
...
bb.u:                                             ; preds = %bb.s
  %i.bb = load ptr, ptr %i.u, align 8, !noalias !300, !align !7, !noundef !4 ; 2 uses
...
bb.v:                                             ; preds = %bb.u
  %.val5.i.i.i = load ptr, ptr %i.bc, align 8, !alias.scope !301, !noalias !300, !noundef !4
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val) ]
  %i.bd = getelementptr inbounds nuw i8, ptr %.val, i64 8
  %i.be = load ptr, ptr %i.bd, align 8, !noalias !302, !noundef !4 ; 2 uses
...
_RINvMNtCs3oUPovFnLWP_4core6optionINtB3_6OptionRNtNtNtB5_4task4wake5WakerE6map_orbNCNCNvMNtNtCslghKHtsL3a4_5tokio4sync15batch_semaphoreNtB1o_9Semaphore12poll_acquire00EB1s_.exit.thread.i.i: ; preds = %bb.v, %._RINvMNtCs3oUPovFnLWP_4core6optionINtB3_6OptionRNtNtNtB5_4task4wake5WakerE6map_orbNCNCNvMNtNtCslghKHtsL3a4_5tokio4sync15batch_semaphoreNtB1o_9Semaphore12poll_acquire00EB1s_.exit.thread_crit_edge.i.i
  ...
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.val) ]
  %i.bi = load ptr, ptr %i.bh, align 8, !noalias !300, !nonnull !4, !noundef !4
...
_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueINtNtB4_6option6OptionNtNtNtB4_4task4wake5WakerEECslghKHtsL3a4_5tokio.exit.i.i: ; preds = %_RINvMNtCs3oUPovFnLWP_4core6optionINtB3_6OptionRNtNtNtB5_4task4wake5WakerE6map_orbNCNCNvMNtNtCslghKHtsL3a4_5tokio4sync15batch_semaphoreNtB1o_9Semaphore12poll_acquire00EB1s_.exit.thread.i.i
  ...
  %i.bm = load ptr, ptr %i.u, align 8, !noalias !300, !align !7, !noundef !4
  %i.bn = load ptr, ptr %i.bc, align 8, !noalias !300
  store ptr %i.bk, ptr %i.u, align 8, !noalias !300
  store ptr %i.bl, ptr %i.bc, align 8, !noalias !300
...
bb.x:                                             ; preds = %bb.w, %_RNCNvMNtNtCslghKHtsL3a4_5tokio4sync15batch_semaphoreNtB4_9Semaphore12poll_acquire0B8_.exit.i
  ...
  br i1 %i.bq, label %_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueINtNtNtNtCslghKHtsL3a4_5tokio4loom3std11parking_lot10MutexGuardNtNtNtBK_4sync15batch_semaphore8WaitlistEEBK_.exit49.i, label %bb.y, !prof !5
...
bb.c:                                             ; preds = %bb.a
  ...
  tail call void %i.g(ptr noundef %i.i), !inline_history !11
  br label %bb.b
...
bb.e:                                             ; preds = %bb.b
  %i.j = load ptr, ptr %0, align 8, !nonnull !4, !align !7, !noundef !4
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 24
  %i.l = load ptr, ptr %i.k, align 8, !nonnull !4, !noundef !4
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.n = load ptr, ptr %i.m, align 8, !noundef !4
  tail call void %i.l(ptr noundef %i.n), !inline_history !11
  br label %bb.d
}
...
bb.a:
  ...
  %i.c = load i64, ptr %i.b, align 8, !alias.scope !313, !noundef !4 ; 2 uses
  %i.d = icmp eq i64 %i.c, 0
...
.preheader.i:                                     ; preds = %bb.a
  ...
  %.promoted = load i16, ptr %i.e, align 8, !alias.scope !314
  br label %bb.b
...
bb.b:                                             ; preds = %_RINvMsi_NtCskt5MLIAl8nl_9hashbrown3rawINtB6_12RawIterRangeTjINtNtNtCsaL1QbXo9JQH_3std6thread11join_handle10JoinHandleuEEE9next_implKb0_ECslghKHtsL3a4_5tokio.exit.i, %.preheader.i
  ...
  %.promoted.i.i = load ptr, ptr %i.a, align 8, !alias.scope !314 ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %bb.b
  %.promoted13.i.i = load ptr, ptr %i.f, align 8, !alias.scope !314
  br label %bb.c

._crit_edge.i.i:                                  ; preds = %bb.c
  store ptr %i.m, ptr %i.f, align 8, !alias.scope !314
  store ptr %i.l, ptr %i.a, align 8, !alias.scope !314
...
bb.c:                                             ; preds = %bb.c, %.lr.ph.i.i
  ...
  %.val79.i.i = load <16 x i8>, ptr %i.i, align 16, !noalias !314
...
_RINvMsi_NtCskt5MLIAl8nl_9hashbrown3rawINtB6_12RawIterRangeTjINtNtNtCsaL1QbXo9JQH_3std6thread11join_handle10JoinHandleuEEE9next_implKb0_ECslghKHtsL3a4_5tokio.exit.i: ; preds = %bb.b, %._crit_edge.i.i
  ...
  store i16 %i.r, ptr %i.e, align 8, !alias.scope !314
  %i.s = sub nsw i64 0, %i.q
  %i.t = getelementptr inbounds [32 x i8], ptr %i.n, i64 %i.s
  %i.u = add i64 %i.h, -1                         ; 3 uses
  store i64 %i.u, ptr %i.b, align 8, !alias.scope !313
  %i.v = getelementptr inbounds i8, ptr %i.t, i64 -24
  tail call fastcc void @_RINvNtCs3oUPovFnLWP_4core3ptr9drop_glueINtNtNtCsaL1QbXo9JQH_3std6thread11join_handle10JoinHandleuEECslghKHtsL3a4_5tokio(ptr noalias nofree noundef align 8 dereferenceable(24) %i.v), !noalias !313
