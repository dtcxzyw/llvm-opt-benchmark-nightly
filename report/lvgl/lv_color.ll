...
bb.b:                                             ; preds = %bb.a
  %.mask51 = and i16 %8, 255
  %.sroa.3.0.insert.ext.i = zext nneg i16 %.mask51 to i24
  %.sroa.0.0.insert.insert.i = mul nuw i24 %.sroa.3.0.insert.ext.i, 65793
  br label %bb.j

bb.c:                                             ; preds = %bb.a
  %i.d = zext nneg i16 %i.b to i32                ; 2 uses
  %i.e = zext i16 %0 to i32
  %i.f = mul nuw nsw i32 %i.e, 17                 ; 2 uses
  %i.g = udiv i32 %i.f, 24
  %i.h = udiv i32 %i.f, 1032                      ; 2 uses
  %.neg = mul nuw nsw i32 %i.h, 213
  %i.i = add nuw nsw i32 %.neg, %i.g
  %i.j = mul nuw nsw i32 %i.i, 6
  %.mask = and i16 %8, 255                        ; 2 uses
  %i.k = zext nneg i16 %.mask to i32              ; 2 uses
  %i.l = xor i16 %i.b, 255
  %i.m = mul nuw i16 %i.l, %.mask
  %i.n = lshr i16 %i.m, 8
  %i.o = trunc nuw i16 %i.n to i8                 ; 6 uses
  %i.p = and i32 %i.j, 254                        ; 2 uses
  %i.q = mul nuw nsw i32 %i.p, %i.d
  %i.r = lshr i32 %i.q, 8
  %i.s = xor i32 %i.r, 255
  %i.t = mul nuw nsw i32 %i.s, %i.k
  %i.u = lshr i32 %i.t, 8
  %i.v = trunc nuw i32 %i.u to i8                 ; 3 uses
  %i.w = xor i32 %i.p, 255
  %i.x = mul nuw nsw i32 %i.w, %i.d
  %i.y = lshr i32 %i.x, 8
  %i.z = xor i32 %i.y, 255
  %i.aa = mul nuw nsw i32 %i.z, %i.k
  %i.ab = lshr i32 %i.aa, 8
  %i.ac = trunc nuw i32 %i.ab to i8               ; 3 uses
...
bb.i:                                             ; preds = %bb.c, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d
  %.042 = phi i8 [ %i.a, %bb.h ], [ %i.ac, %bb.g ], [ %i.v, %bb.d ], [ %i.o, %bb.e ], [ %i.o, %bb.f ], [ %i.a, %bb.c ]
  %.041 = phi i8 [ %i.o, %bb.h ], [ %i.o, %bb.g ], [ %i.a, %bb.d ], [ %i.a, %bb.e ], [ %i.v, %bb.f ], [ %i.ac, %bb.c ]
  %.0 = phi i8 [ %i.v, %bb.h ], [ %i.a, %bb.g ], [ %i.o, %bb.d ], [ %i.ac, %bb.e ], [ %i.a, %bb.f ], [ %i.o, %bb.c ]
