...
bb.g:                                             ; preds = %bb.c, %bb.f, %bb.e, %bb.a
  %.0 = phi i32 [ %i.m, %bb.a ], [ %i.s, %bb.c ], [ %i.z, %bb.e ], [ %i.af, %bb.f ] ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.cw = ashr i32 %i.cv, 10
  %i.cx = sub nsw i32 %i.cw, %0                   ; 2 uses
  %i.cy = add i32 %i.cx, 1
end_hunk_0
begin_hunk_1_@lv_atan2:bb.a
  %i.c = icmp samesign ugt i32 %spec.select, %.050
  br i1 %i.c, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.d = mul i32 %.050, 45
  %i.e = udiv i32 %i.d, %spec.select
  %i.f = or disjoint i32 %.148, 16
  br label %bb.d

bb.c:                                             ; preds = %bb.a
  %i.g = mul i32 %spec.select, 45
  %i.h = udiv i32 %i.g, %.050
  br label %bb.d

bb.d:                                             ; preds = %bb.c, %bb.b
  %.249 = phi i32 [ %i.f, %bb.b ], [ %.148, %bb.c ] ; 3 uses
  %.0 = phi i32 [ %i.e, %bb.b ], [ %i.h, %bb.c ]  ; 2 uses
  %i.i = and i32 %.0, 255                         ; 9 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %.145 = select i1 %i.l, i32 2, i32 %spec.select62
...
bb.g:                                             ; preds = %bb.f, %bb.e
  %.sink70 = phi i1 [ %i.r, %bb.f ], [ %i.n, %bb.e ]
  %.sink69.in = phi i1 [ %i.q, %bb.f ], [ %i.m, %bb.e ]
  %.4.sink = phi i32 [ %.4, %bb.f ], [ %.145, %bb.e ]
  %.sink69 = zext i1 %.sink69.in to i32
  %i.s = zext i1 %.sink70 to i32
  %.5 = add nuw nsw i32 %i.s, %.sink69
  %spec.select67 = add nuw nsw i32 %.5, %.4.sink
  %i.t = add i32 %spec.select67, %.0              ; 2 uses
  %i.u = and i32 %.249, 16
  %.not = icmp eq i32 %i.u, 0
  %i.v = sub i32 90, %i.t
  %spec.select64 = select i1 %.not, i32 %i.t, i32 %i.v ; 4 uses
  %i.w = and i32 %.249, 2
  %.not58 = icmp eq i32 %i.w, 0
  %i.x = and i32 %.249, 1
  %.not59 = icmp eq i32 %i.x, 0                   ; 2 uses
...
bb.i:                                             ; preds = %bb.h
  %i.y = add i32 %spec.select64, 180
  br label %bb.l

bb.j:                                             ; preds = %bb.h
  %i.z = sub i32 180, %spec.select64
  br label %bb.l

bb.k:                                             ; preds = %bb.g
  %i.aa = sub i32 360, %spec.select64
  %spec.select65 = select i1 %.not59, i32 %spec.select64, i32 %i.aa
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.i, %bb.j
  %.2 = phi i32 [ %i.y, %bb.i ], [ %i.z, %bb.j ], [ %spec.select65, %bb.k ]
...
!14 = !{!"", !5, i64 0, !13, i64 8, !13, i64 16}
!15 = !{!"p1 _ZTS13_lv_display_t", !11, i64 0}
!16 = !{!"p1 _ZTS11_lv_group_t", !11, i64 0}
!17 = !{!"p1 _ZTS11_lv_indev_t", !11, i64 0}
!18 = !{!"p1 _ZTS9_lv_obj_t", !11, i64 0}
!19 = !{!"p1 _ZTS11_lv_event_t", !11, i64 0}
!20 = !{!"", !14, i64 0, !12, i64 24, !4, i64 25, !12, i64 26, !12, i64 27, !5, i64 28, !12, i64 32, !5, i64 36, !5, i64 40, !5, i64 44, !5, i64 48, !11, i64 56, !11, i64 64}
!21 = !{!"p1 _ZTS11_lv_timer_t", !11, i64 0}
!22 = !{!"", !12, i64 0, !12, i64 1, !12, i64 2, !21, i64 8, !14, i64 16}
!23 = !{!"", !5, i64 0, !4, i64 4, !11, i64 8, !11, i64 16}
!24 = !{!"_lv_draw_buf_handlers_t", !11, i64 0, !11, i64 8, !11, i64 16, !11, i64 24, !11, i64 32, !11, i64 40, !11, i64 48}
!25 = !{!"p1 _ZTS11_lv_cache_t", !11, i64 0}
!26 = !{!"p1 _ZTS15_lv_draw_unit_t", !11, i64 0}
!27 = !{!"", !26, i64 0, !5, i64 8, !5, i64 12, !5, i64 16, !5, i64 20, !12, i64 24}
!28 = !{!"long", !4, i64 0}
!29 = !{!"", !11, i64 0, !28, i64 8, !28, i64 16, !14, i64 24}
!30 = !{!"p1 _ZTS14_snippet_stack", !11, i64 0}
!31 = !{!"_lv_global_t", !11, i64 0, !12, i64 8, !12, i64 9, !14, i64 16, !15, i64 40, !15, i64 48, !14, i64 56, !12, i64 80, !5, i64 84, !5, i64 88, !13, i64 96, !14, i64 104, !16, i64 128, !14, i64 136, !17, i64 160, !18, i64 168, !5, i64 176, !11, i64 184, !12, i64 192, !5, i64 196, !5, i64 200, !19, i64 208, !5, i64 216, !20, i64 224, !22, i64 296, !23, i64 336, !24, i64 360, !24, i64 416, !24, i64 472, !14, i64 528, !25, i64 552, !25, i64 560, !27, i64 568, !14, i64 600, !4, i64 624, !11, i64 816, !11, i64 824, !11, i64 832, !29, i64 840, !14, i64 888, !30, i64 912, !11, i64 920, !5, i64 928, !4, i64 932}
!32 = !{!31, !5, i64 200}
!33 = distinct !{!33, !10}
!34 = distinct !{!34, !10}
!35 = !{!"", !8, i64 0, !8, i64 2}
