...
.lr.ph83.split:                                   ; preds = %.lr.ph83, %.lr.ph83.splitthread-pre-split
  ...
  %i.de = phi i64 [ %i.ec, %.lr.ph83.splitthread-pre-split ], [ %i.cw, %.lr.ph83 ] ; 3 uses
...
bb.p:                                             ; preds = %._crit_edge.i72, %.lr.ph51.i
  %indvars.iv.i = phi i64 [ 0, %.lr.ph51.i ], [ %i.dm, %._crit_edge.i72 ] ; 3 uses
  ...
  %indvars.i = trunc nuw i64 %indvars.iv.i to i32
...
bb.r:                                             ; preds = %bb.q, %.lr.ph.i71
  ...
  %.222.i = phi i32 [ %indvars.i, %bb.q ], [ %.12139.i, %.lr.ph.i71 ] ; 2 uses
...
._crit_edge.i72:                                  ; preds = %bb.r, %bb.p
  ...
  %i.dm = and i64 %indvars.iv.next.i, 4294967295  ; 2 uses
  %i.dn = icmp ugt i64 %i.dd, %i.dm
  br i1 %i.dn, label %bb.p, label %._crit_edge52.i, !llvm.loop !41

._crit_edge52.i:                                  ; preds = %._crit_edge.i72
  %i.do = zext i32 %.121.lcssa.i to i64
...
bb.s:                                             ; preds = %._crit_edge52.i
  ...
  %i.dp = getelementptr inbounds nuw i8, ptr %.130.lcssa.i, i64 40 ; 2 uses
  %i.dq = load ptr, ptr %i.dp, align 8, !tbaa !23 ; 2 uses
  br i1 %.not.i.i, label %bb.u, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.dr = getelementptr inbounds nuw i8, ptr %.127.lcssa.i, i64 40
  store ptr %i.dq, ptr %i.dr, align 8, !tbaa !23
  br label %lv_lru_remove_item.exit.i

bb.u:                                             ; preds = %bb.s
  %i.ds = getelementptr inbounds nuw [8 x i8], ptr %i.df, i64 %i.do
  store ptr %i.dq, ptr %i.ds, align 8, !tbaa !22
  br label %lv_lru_remove_item.exit.i

lv_lru_remove_item.exit.i:                        ; preds = %bb.u, %bb.t
  %i.dt = getelementptr inbounds nuw i8, ptr %.130.lcssa.i, i64 16
  %i.du = load i64, ptr %i.dt, align 8, !tbaa !27
  %i.dv = add i64 %i.du, %i.de
  store i64 %i.dv, ptr %i.cv, align 8, !tbaa !16
  %i.dw = load ptr, ptr %i.cy, align 8, !tbaa !19
  %i.dx = load ptr, ptr %.130.lcssa.i, align 8, !tbaa !25
  tail call void %i.dw(ptr noundef %i.dx) #2, !inline_history !42
  %i.dy = load ptr, ptr %i.cz, align 8, !tbaa !20
  %i.dz = getelementptr inbounds nuw i8, ptr %.130.lcssa.i, i64 8
  %i.ea = load ptr, ptr %i.dz, align 8, !tbaa !26
  tail call void %i.dy(ptr noundef %i.ea) #2, !inline_history !42
  tail call void @lv_memset(ptr noundef nonnull %.130.lcssa.i, i8 noundef zeroext 0, i64 noundef 48) #2
  %i.eb = load ptr, ptr %i.da, align 8, !tbaa !31
  store ptr %i.eb, ptr %i.dp, align 8, !tbaa !23
...
lv_lru_remove_lru_item.exit:                      ; preds = %.lr.ph83.split, %._crit_edge52.i, %lv_lru_remove_item.exit.i
  %i.ec = phi i64 [ %i.de, %.lr.ph83.split ], [ %i.de, %._crit_edge52.i ], [ %.pre, %lv_lru_remove_item.exit.i ] ; 3 uses
  %i.ed = icmp ult i64 %i.ec, %i.cu
  br i1 %i.ed, label %.lr.ph83.splitthread-pre-split, label %.loopexit, !llvm.loop !43

.loopexit:                                        ; preds = %lv_lru_remove_lru_item.exit, %..loopexit_crit_edge, %bb.o
  %i.ee = phi i64 [ %.pre87, %..loopexit_crit_edge ], [ %i.cw, %bb.o ], [ %i.ec, %lv_lru_remove_lru_item.exit ]
  %sext = shl i64 %.057.in, 32
  %i.ef = ashr exact i64 %sext, 32
  %i.eg = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.eh = sub i64 %i.ee, %i.ef
  store i64 %i.eh, ptr %i.eg, align 8, !tbaa !16
  br label %bb.v
...
bb.b:                                             ; preds = %.lr.ph51, %._crit_edge
  %indvars.iv = phi i64 [ 0, %.lr.ph51 ], [ %i.j, %._crit_edge ] ; 3 uses
...
bb.d:                                             ; preds = %.lr.ph, %bb.c
  ...
  %.222 = phi i32 [ %indvars, %bb.c ], [ %.12139, %.lr.ph ] ; 2 uses
...
._crit_edge:                                      ; preds = %bb.d, %bb.b
  ...
  %i.j = and i64 %indvars.iv.next, 4294967295     ; 2 uses
  %i.k = icmp ugt i64 %i.b, %i.j
  br i1 %i.k, label %bb.b, label %._crit_edge52, !llvm.loop !41

._crit_edge52:                                    ; preds = %._crit_edge
  %i.l = zext i32 %.121.lcssa to i64
...
bb.e:                                             ; preds = %._crit_edge52
  ...
  %i.m = getelementptr inbounds nuw i8, ptr %.130.lcssa, i64 40 ; 2 uses
  %i.n = load ptr, ptr %i.m, align 8, !tbaa !23   ; 2 uses
  br i1 %.not.i, label %bb.g, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.o = getelementptr inbounds nuw i8, ptr %.127.lcssa, i64 40
...
bb.g:                                             ; preds = %bb.e
  ...
  store ptr %i.n, ptr %i.q, align 8, !tbaa !22
  br label %lv_lru_remove_item.exit

lv_lru_remove_item.exit:                          ; preds = %bb.f, %bb.g
  %i.r = getelementptr inbounds nuw i8, ptr %.130.lcssa, i64 16
  %i.s = load i64, ptr %i.r, align 8, !tbaa !27
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.u = load i64, ptr %i.t, align 8, !tbaa !16
  %i.v = add i64 %i.u, %i.s
  store i64 %i.v, ptr %i.t, align 8, !tbaa !16
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.x = load ptr, ptr %i.w, align 8, !tbaa !19
  %i.y = load ptr, ptr %.130.lcssa, align 8, !tbaa !25
  tail call void %i.x(ptr noundef %i.y) #2, !inline_history !45
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 64
  %i.aa = load ptr, ptr %i.z, align 8, !tbaa !20
  %i.ab = getelementptr inbounds nuw i8, ptr %.130.lcssa, i64 8
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !26
  tail call void %i.aa(ptr noundef %i.ac) #2, !inline_history !45
  ...
  store ptr %i.ae, ptr %i.m, align 8, !tbaa !23
  store ptr %.130.lcssa, ptr %i.ad, align 8, !tbaa !31
