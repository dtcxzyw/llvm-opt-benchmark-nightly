...
@lv_example_grid_6.col_dsc = internal global [4 x i32] [i32 60, i32 60, i32 60, i32 536870911], align 16
@lv_example_grid_6.row_dsc = internal global [4 x i32] [i32 45, i32 45, i32 45, i32 536870911], align 16
@.str = private unnamed_addr constant [6 x i8] c"%d,%d\00", align 1

; Function Attrs: nounwind uwtable
define void @lv_example_grid_6() local_unnamed_addr #0 {
bb.a:
  %0 = tail call ptr @lv_screen_active() #2
  %1 = tail call ptr @lv_obj_create(ptr noundef %0) #2 ; 13 uses
  ...
  tail call void @lv_obj_set_style_base_dir(ptr noundef %1, i32 noundef 1, i32 noundef 0) #2
  tail call void @lv_obj_set_grid_dsc_array(ptr noundef %1, ptr noundef nonnull @lv_example_grid_6.col_dsc, ptr noundef nonnull @lv_example_grid_6.row_dsc) #2
  %2 = tail call ptr @lv_obj_create(ptr noundef %1) #2 ; 2 uses
  ...
  %4 = tail call ptr @lv_obj_create(ptr noundef %1) #2 ; 2 uses
  ...
  %6 = tail call ptr @lv_obj_create(ptr noundef %1) #2 ; 2 uses
  ...
  %8 = tail call ptr @lv_obj_create(ptr noundef %1) #2 ; 2 uses
  ...
  %10 = tail call ptr @lv_obj_create(ptr noundef %1) #2 ; 2 uses
  ...
  %12 = tail call ptr @lv_obj_create(ptr noundef %1) #2 ; 2 uses
  ...
  %14 = tail call ptr @lv_obj_create(ptr noundef %1) #2 ; 2 uses
  ...
  %15 = tail call ptr @lv_obj_create(ptr noundef %1) #2 ; 2 uses
  ...
  %16 = tail call ptr @lv_obj_create(ptr noundef %1) #2 ; 2 uses
