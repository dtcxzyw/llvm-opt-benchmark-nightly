...
define void @lv_example_grid_6() local_unnamed_addr #0 {
  ...
  %2 = tail call ptr @lv_obj_create(ptr noundef %1) #2 ; 5 uses
  ...
  tail call void @lv_obj_set_style_base_dir(ptr noundef %2, i32 noundef 1, i32 noundef 0) #2
  tail call void @lv_obj_set_grid_dsc_array(ptr noundef %2, ptr noundef nonnull @lv_example_grid_6.col_dsc, ptr noundef nonnull @lv_example_grid_6.row_dsc) #2
  br label %bb.a

bb.a:                                             ; preds = %0, %bb.a
  %.017 = phi i8 [ 0, %0 ], [ %7, %bb.a ]         ; 3 uses
  %3 = urem i8 %.017, 3
  %4 = udiv i8 %.017, 3
