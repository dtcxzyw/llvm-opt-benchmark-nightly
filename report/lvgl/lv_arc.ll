...
.preheader.preheader:                             ; preds = %bb.k
  ...
  %i.ba = add i32 %i.ay, %smax344
  %i.bb = add i32 %i.ba, 359
  %i.bc = sub i32 %i.bb, %i.au
  %.fr355 = freeze i32 %i.bc                      ; 2 uses
  %10 = urem i32 %.fr355, 360
  %11 = sub nuw i32 %.fr355, %10
  %i.bd = add i32 %11, %i.au                      ; 2 uses
...
.preheader342.preheader:                          ; preds = %bb.ap
  ...
  %i.gh = zext i16 %i.gg to i32                   ; 3 uses
  ...
  %i.go = add i32 %i.gm, %smax
  %i.gp = add i32 %i.go, 359
  %i.gq = sub i32 %i.gp, %i.gh
  %.fr = freeze i32 %i.gq                         ; 2 uses
  %12 = urem i32 %.fr, 360
  %13 = sub nuw i32 %.fr, %12
  %i.gr = add i32 %13, %i.gh                      ; 2 uses
