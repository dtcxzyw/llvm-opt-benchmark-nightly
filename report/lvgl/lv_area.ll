...
begin_hunk_0_@lv_area_align:bb.a
  ...
  %.neg71 = sdiv i32 %i.hp, -2
  %i.hq = add nsw i32 %.neg71, %i.hj
  br label %bb.v
...
bb.r:                                             ; preds = %bb.a
  ...
  %i.hw = getelementptr inbounds nuw i8, ptr %1, i64 12
  %i.hx = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.hy = load i32, ptr %i.hw, align 4, !tbaa !12
  %i.hz = load i32, ptr %i.hr, align 4, !tbaa !11
  %i.ia = load i32, ptr %i.hx, align 4, !tbaa !10
  %i.ib = load i32, ptr %1, align 4, !tbaa !9
  %.neg83 = xor i32 %i.hy, -1
  %.neg81 = xor i32 %i.hz, -1
  %.neg80 = add i32 %i.ib, %.neg81
  %.neg82 = add i32 %i.ht, 1
  %i.ic = sub i32 %.neg82, %i.hv
  %i.id = add i32 %i.ic, %.neg83
  %i.ie = add i32 %i.id, %i.ia
  br label %bb.v

bb.s:                                             ; preds = %bb.a
  %i.if = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ig = load i32, ptr %i.if, align 4, !tbaa !11
  %i.ih = load i32, ptr %0, align 4, !tbaa !9
  %i.ii = add i32 %i.ig, 1
  %i.ij = sub i32 %i.ii, %i.ih
  br label %bb.v
...
bb.t:                                             ; preds = %bb.a
  ...
  %i.ip = getelementptr inbounds nuw i8, ptr %0, i64 12
  %i.iq = load i32, ptr %i.ip, align 4, !tbaa !12
  %i.ir = getelementptr inbounds nuw i8, ptr %0, i64 4
  %i.is = load i32, ptr %i.ir, align 4, !tbaa !10
  %i.it = add i32 %i.iq, 1
  %i.iu = sub i32 %i.it, %i.is
  %i.iv = sdiv i32 %i.iu, 2
  %i.iw = getelementptr inbounds nuw i8, ptr %1, i64 12
  %i.ix = load i32, ptr %i.iw, align 4, !tbaa !12
  %i.iy = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.iz = load i32, ptr %i.iy, align 4, !tbaa !10
  %i.ja = add i32 %i.ix, 1
  %i.jb = sub i32 %i.ja, %i.iz
  %.neg = sdiv i32 %i.jb, -2
  %i.jc = add nsw i32 %.neg, %i.iv
  br label %bb.v

bb.u:                                             ; preds = %bb.a
  %i.jd = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.je = load i32, ptr %i.jd, align 4, !tbaa !11
  %i.jf = load i32, ptr %0, align 4, !tbaa !9
  %i.jg = getelementptr inbounds nuw i8, ptr %0, i64 12
  %i.jh = load i32, ptr %i.jg, align 4, !tbaa !12
  %i.ji = getelementptr inbounds nuw i8, ptr %0, i64 4
  %i.jj = load i32, ptr %i.ji, align 4, !tbaa !10
  %i.jk = getelementptr inbounds nuw i8, ptr %1, i64 12
  %i.jl = load i32, ptr %i.jk, align 4, !tbaa !12
  %i.jm = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.jn = load i32, ptr %i.jm, align 4, !tbaa !10
  %.neg111 = xor i32 %i.jl, -1
  %.neg110 = add i32 %i.jh, 1
  %i.jo = sub i32 %.neg110, %i.jj
  %i.jp = add i32 %i.jo, %.neg111
  %i.jq = add i32 %i.je, 1
  %i.jr = sub i32 %i.jq, %i.jf
  %i.js = add i32 %i.jp, %i.jn
  br label %bb.v

bb.v:                                             ; preds = %bb.a, %bb.u, %bb.t, %bb.s, %bb.r, %bb.q, %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c, %bb.b
  %.070 = phi i32 [ %i.jc, %bb.t ], [ %i.u, %bb.b ], [ %i.js, %bb.u ], [ 0, %bb.c ], [ 0, %bb.d ], [ %i.ba, %bb.e ], [ %i.bx, %bb.f ], [ %i.cr, %bb.g ], [ %i.df, %bb.h ], [ %i.ec, %bb.i ], [ %.neg96, %bb.j ], [ %.neg94, %bb.k ], [ %.neg92, %bb.l ], [ %i.fp, %bb.m ], [ %i.gh, %bb.n ], [ %i.gw, %bb.o ], [ 0, %bb.p ], [ %i.hq, %bb.q ], [ %i.ie, %bb.r ], [ 0, %bb.s ], [ 0, %bb.a ]
  %.0 = phi i32 [ %i.io, %bb.t ], [ %i.s, %bb.b ], [ %i.jr, %bb.u ], [ %i.ag, %bb.c ], [ %i.ap, %bb.d ], [ 0, %bb.e ], [ %i.bm, %bb.f ], [ %i.cq, %bb.g ], [ 0, %bb.h ], [ %i.do, %bb.i ], [ 0, %bb.j ], [ %i.es, %bb.k ], [ %i.fj, %bb.l ], [ 0, %bb.m ], [ %i.gb, %bb.n ], [ %i.gv, %bb.o ], [ %.neg86, %bb.p ], [ %.neg84, %bb.q ], [ %.neg80, %bb.r ], [ %i.ij, %bb.s ], [ 0, %bb.a ]
  %i.jt = getelementptr inbounds nuw i8, ptr %0, i64 4
  %i.ju = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 2 uses
  %i.jv = getelementptr inbounds nuw i8, ptr %1, i64 4
  %i.jw = add i32 %.0, %3
  %i.jx = add i32 %.070, %4
  %i.jy = load i32, ptr %i.jt, align 4, !tbaa !10
  %i.jz = load i32, ptr %0, align 4, !tbaa !9
  %i.ka = load <2 x i32>, ptr %i.ju, align 4, !tbaa !13
  %i.kb = load <2 x i32>, ptr %1, align 4, !tbaa !13
  %i.kc = add i32 %i.jx, %i.jy                    ; 2 uses
  %i.kd = add i32 %i.jw, %i.jz                    ; 2 uses
  store i32 %i.kd, ptr %1, align 4, !tbaa !9
  store i32 %i.kc, ptr %i.jv, align 4, !tbaa !10
  %i.ke = insertelement <2 x i32> poison, i32 %i.kd, i64 0
  %i.kf = insertelement <2 x i32> %i.ke, i32 %i.kc, i64 1
  %i.kg = add <2 x i32> %i.kf, %i.ka
  %i.kh = sub <2 x i32> %i.kg, %i.kb
  store <2 x i32> %i.kh, ptr %i.ju, align 4, !tbaa !13
  ret void
}
...
.lr.ph127.split.us:                               ; preds = %.lr.ph127.split.us.preheader320, %.lr.ph127.split.us
  ...
  %i.dh = add nsw <2 x i32> %i.dg, %i.df
  store <2 x i32> %i.dh, ptr %i.ct, align 4, !tbaa !13
  %indvars.iv.next146 = add i64 %indvars.iv145, 1 ; 2 uses
  %i.di = and i64 %indvars.iv.next146, 4294967295
  %i.dj = icmp samesign ugt i64 %1, %i.di
  br i1 %i.dj, label %.lr.ph127.split.us, label %.loopexit, !llvm.loop !31
...
vector.scevcheck205:                              ; preds = %.lr.ph127.split.split.preheader
  ...
  br i1 %i.do, label %.lr.ph127.split.split.preheader323, label %vector.memcheck206

vector.memcheck206:                               ; preds = %vector.scevcheck205
  %i.dp = shl nuw nsw i64 %1, 3                   ; 2 uses
  %i.dq = getelementptr i8, ptr %0, i64 %i.dp
  %scevgep207 = getelementptr i8, ptr %i.dq, i64 -4
  %scevgep208 = getelementptr i8, ptr %0, i64 4
  %scevgep209 = getelementptr i8, ptr %0, i64 %i.dp
  %scevgep210 = getelementptr i8, ptr %5, i64 8
  %bound0211 = icmp ult ptr %0, %i.by
  ...
  %bound1215 = icmp ult ptr %i.by, %scevgep209
...
vector.body232:                                   ; preds = %vector.body232, %vector.ph220
  ...
  %i.dr = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %index233 ; 2 uses
  %wide.vec234 = load <8 x i32>, ptr %i.dr, align 4, !tbaa !13 ; 2 uses
  ...
  %i.ds = mul nsw <4 x i32> %strided.vec235, %broadcast.splat223
  %i.dt = mul nsw <4 x i32> %strided.vec236, %broadcast.splat225
  %i.du = sub nsw <4 x i32> %i.ds, %i.dt
  %i.dv = mul nsw <4 x i32> %i.du, %broadcast.splat227
  %i.dw = load i32, ptr %5, align 4, !tbaa !15, !alias.scope !51
  %broadcast.splatinsert237 = insertelement <4 x i32> poison, i32 %i.dw, i64 0
  %i.dx = mul <4 x i32> %strided.vec235, %broadcast.splat229
  %i.dy = mul <4 x i32> %strided.vec236, %broadcast.splat231
  %i.dz = add <4 x i32> %i.dy, %i.dx
  %i.ea = load i32, ptr %i.by, align 4, !tbaa !16, !alias.scope !52
  %broadcast.splatinsert239 = insertelement <4 x i32> poison, i32 %i.ea, i64 0
  %i.eb = shufflevector <4 x i32> %broadcast.splatinsert237, <4 x i32> %broadcast.splatinsert239, <8 x i32> <i32 0, i32 4, i32 0, i32 4, i32 0, i32 4, i32 0, i32 4>
  %i.ec = shufflevector <4 x i32> %i.dv, <4 x i32> %i.dz, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  %i.ed = ashr <8 x i32> %i.ec, splat (i32 18)
  %interleaved.vec241 = add nsw <8 x i32> %i.eb, %i.ed
  store <8 x i32> %interleaved.vec241, ptr %i.dr, align 4, !tbaa !13
  %index.next242 = add nuw i64 %index233, 4       ; 2 uses
  %i.ee = icmp eq i64 %index.next242, %n.vec221
...
vector.scevcheck246:                              ; preds = %.lr.ph127.split.split.us.preheader
  ...
  br i1 %i.ej, label %.lr.ph127.split.split.us.preheader321, label %vector.memcheck247

vector.memcheck247:                               ; preds = %vector.scevcheck246
  %i.ek = shl nuw nsw i64 %1, 3                   ; 2 uses
  %i.el = getelementptr i8, ptr %0, i64 %i.ek
  %scevgep248 = getelementptr i8, ptr %i.el, i64 -4
  %scevgep249 = getelementptr i8, ptr %0, i64 4
  %scevgep250 = getelementptr i8, ptr %0, i64 %i.ek
  %scevgep251 = getelementptr i8, ptr %5, i64 8
  %bound0252 = icmp ult ptr %0, %i.by
  ...
  %bound1256 = icmp ult ptr %i.by, %scevgep250
...
vector.ph261:                                     ; preds = %vector.memcheck247
  ...
  %broadcast.splatinsert267 = insertelement <4 x i32> poison, i32 %i.bx, i64 0
  %broadcast.splat268 = shufflevector <4 x i32> %broadcast.splatinsert267, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  %broadcast.splatinsert269 = insertelement <4 x i32> poison, i32 %i.bw, i64 0
...
vector.body271:                                   ; preds = %vector.body271, %vector.ph261
  ...
  %i.em = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %index272 ; 2 uses
  %wide.vec273 = load <8 x i32>, ptr %i.em, align 4, !tbaa !13 ; 2 uses
  ...
  %i.en = sub nsw <4 x i32> %.reass326, %.reass328
  %i.eo = load i32, ptr %5, align 4, !tbaa !15, !alias.scope !53
  %broadcast.splatinsert276 = insertelement <4 x i32> poison, i32 %i.eo, i64 0
  %i.ep = add nsw <4 x i32> %.reass332, %.reass330
  %i.eq = load i32, ptr %i.by, align 4, !tbaa !16, !alias.scope !54
  %broadcast.splatinsert278 = insertelement <4 x i32> poison, i32 %i.eq, i64 0
  %i.er = shufflevector <4 x i32> %broadcast.splatinsert276, <4 x i32> %broadcast.splatinsert278, <8 x i32> <i32 0, i32 4, i32 0, i32 4, i32 0, i32 4, i32 0, i32 4>
  %i.es = shufflevector <4 x i32> %i.en, <4 x i32> %i.ep, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  %i.et = ashr <8 x i32> %i.es, splat (i32 18)
  %interleaved.vec280 = add nsw <8 x i32> %i.er, %i.et
  store <8 x i32> %interleaved.vec280, ptr %i.em, align 4, !tbaa !13
  %index.next281 = add nuw i64 %index272, 4       ; 2 uses
  %i.eu = icmp eq i64 %index.next281, %n.vec262
...
.lr.ph127.split.split.us:                         ; preds = %.lr.ph127.split.split.us.preheader321, %.lr.ph127.split.split.us
  ...
  %i.ev = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv141 ; 3 uses
  %i.ew = getelementptr inbounds nuw i8, ptr %i.ev, i64 4
  %i.ex = load i32, ptr %i.ew, align 4, !tbaa !16
  %i.ey = load i32, ptr %i.ev, align 4, !tbaa !15
  %i.ez = mul nsw i32 %i.ex, %4                   ; 2 uses
  %i.fa = mul nsw i32 %i.ey, %3                   ; 2 uses
  %i.fb = mul nsw i32 %i.fa, %i.bw
  %i.fc = mul nsw i32 %i.ez, %i.bw
  %i.fd = mul nsw i32 %i.ez, %i.bx
  %i.fe = mul nsw i32 %i.fa, %i.bx
  %i.ff = add nsw i32 %i.fd, %i.fb
  %i.fg = sub nsw i32 %i.fe, %i.fc
  %i.fh = insertelement <2 x i32> poison, i32 %i.fg, i64 0
  %i.fi = insertelement <2 x i32> %i.fh, i32 %i.ff, i64 1
  %i.fj = ashr <2 x i32> %i.fi, splat (i32 18)
  %i.fk = load <2 x i32>, ptr %5, align 4, !tbaa !13
  %i.fl = add nsw <2 x i32> %i.fk, %i.fj
  store <2 x i32> %i.fl, ptr %i.ev, align 4, !tbaa !13
  %indvars.iv.next142 = add i64 %indvars.iv141, 1 ; 2 uses
  %i.fm = and i64 %indvars.iv.next142, 4294967295
  %i.fn = icmp samesign ugt i64 %1, %i.fm
  br i1 %i.fn, label %.lr.ph127.split.split.us, label %.loopexit, !llvm.loop !40
...
.lr.ph127.split.split:                            ; preds = %.lr.ph127.split.split.preheader323, %.lr.ph127.split.split
  ...
  %i.fo = getelementptr inbounds nuw [8 x i8], ptr %0, i64 %indvars.iv137 ; 3 uses
  %i.fp = load i32, ptr %i.fo, align 4, !tbaa !15 ; 2 uses
  %i.fq = getelementptr inbounds nuw i8, ptr %i.fo, i64 4
  %i.fr = load i32, ptr %i.fq, align 4, !tbaa !16 ; 2 uses
  %i.fs = mul nsw i32 %i.fp, %i.bx
  %i.ft = mul nsw i32 %i.fr, %i.bw
  %.reass = mul i32 %i.fp, %factor.op.mul
  %.reass124 = mul i32 %i.fr, %factor.op.mul123
  %i.fu = sub nsw i32 %i.fs, %i.ft
  %i.fv = add i32 %.reass124, %.reass
  %i.fw = mul nsw i32 %i.fu, %3
  %i.fx = insertelement <2 x i32> poison, i32 %i.fw, i64 0
  %i.fy = insertelement <2 x i32> %i.fx, i32 %i.fv, i64 1
  %i.fz = ashr <2 x i32> %i.fy, splat (i32 18)
  %i.ga = load <2 x i32>, ptr %5, align 4, !tbaa !13
  %i.gb = add nsw <2 x i32> %i.ga, %i.fz
  store <2 x i32> %i.gb, ptr %i.fo, align 4, !tbaa !13
  %indvars.iv.next138 = add i64 %indvars.iv137, 1 ; 2 uses
  %i.gc = and i64 %indvars.iv.next138, 4294967295
  %i.gd = icmp samesign ugt i64 %1, %i.gc
  br i1 %i.gd, label %.lr.ph127.split.split, label %.loopexit, !llvm.loop !41
