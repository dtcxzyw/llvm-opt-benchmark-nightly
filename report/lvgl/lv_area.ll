...
bb.b:                                             ; preds = %._crit_edge.thread, %._crit_edge
  ...
  %7 = add nsw i32 %i.bp, %i.bo
  %8 = sdiv i32 %7, 10
  %9 = ashr i32 %8, 5                             ; 9 uses
  %10 = mul nsw i32 %i.bk, %i.bn
  %11 = mul nsw i32 %i.bm, %i.be
  %12 = add nsw i32 %11, %10
  %13 = sdiv i32 %12, 10
  %i.bq = ashr i32 %13, 5                         ; 9 uses
  %factor.op.mul = mul i32 %9, %4                 ; 2 uses
...
vector.ph300:                                     ; preds = %vector.memcheck286
  ...
  %broadcast.splatinsert304 = insertelement <4 x i32> poison, i32 %9, i64 0
...
.lr.ph127.split.us:                               ; preds = %.lr.ph127.split.us.preheader320, %.lr.ph127.split.us
  ...
  %i.cq = mul nsw i32 %i.cp, %9
  %i.cr = mul nsw i32 %i.co, %9
...
vector.ph220:                                     ; preds = %vector.memcheck206
  ...
  %broadcast.splatinsert224 = insertelement <4 x i32> poison, i32 %9, i64 0
...
vector.ph261:                                     ; preds = %vector.memcheck247
  ...
  %broadcast.splatinsert269 = insertelement <4 x i32> poison, i32 %9, i64 0
...
.lr.ph127.split.split.us:                         ; preds = %.lr.ph127.split.split.us.preheader321, %.lr.ph127.split.split.us
  ...
  %i.eu = mul nsw i32 %i.et, %9
  %i.ev = mul nsw i32 %i.es, %9
