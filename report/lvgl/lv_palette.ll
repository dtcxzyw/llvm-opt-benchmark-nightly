Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/lvgl/original/lv_palette?download=true
begin_hunk_0
...
bb.b:                                             ; preds = %bb.a
  %i.b = tail call i24 @lv_color_black() #2
  br label %bb.d
...
bb.d:                                             ; preds = %bb.c, %bb.b
  %.sroa.0.0 = phi i24 [ %i.b, %bb.b ], [ %.sroa.0.0.copyload, %bb.c ]
  ret i24 %.sroa.0.0
}
...
bb.c:                                             ; preds = %bb.a
  %i.c = add i8 %1, -6
  %or.cond = icmp ult i8 %i.c, -5
  br i1 %or.cond, label %bb.d, label %bb.e

bb.d:                                             ; preds = %bb.c
  %i.d = tail call i24 @lv_color_black() #2
  br label %bb.f

bb.e:                                             ; preds = %bb.c
  %i.e = zext nneg i32 %0 to i64
  %i.f = getelementptr inbounds nuw [15 x i8], ptr @lv_palette_lighten.colors, i64 %i.e
...
bb.f:                                             ; preds = %bb.e, %bb.d, %bb.b
  %.sroa.0.0 = phi i24 [ %i.b, %bb.b ], [ %i.d, %bb.d ], [ %.sroa.0.0.copyload, %bb.e ]
  ret i24 %.sroa.0.0
}
...
bb.e:                                             ; preds = %bb.c
  %i.e = zext nneg i32 %0 to i64
  %i.f = getelementptr inbounds nuw [12 x i8], ptr @lv_palette_darken.colors, i64 %i.e
  %i.g = zext nneg i8 %1 to i64
  %i.h = getelementptr [3 x i8], ptr %i.f, i64 %i.g
  %i.i = getelementptr i8, ptr %i.h, i64 -3
  %.sroa.0.0.copyload = load i24, ptr %i.i, align 1
