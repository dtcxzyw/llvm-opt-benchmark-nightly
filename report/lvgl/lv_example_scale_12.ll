...
bb.a:
  ...
  %i.p = load ptr, ptr @scale, align 8, !tbaa !10
  ...
  %i.x = load ptr, ptr @scale, align 8, !tbaa !10
  ...
  %i.aa = load ptr, ptr @scale, align 8, !tbaa !10
...
bb.b:                                             ; preds = %bb.a
  %i.l = icmp samesign ult i32 %i.j, 68
  br i1 %i.l, label %heading_to_cardinal.exit, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.m = icmp samesign ult i32 %i.j, 113
  br i1 %i.m, label %heading_to_cardinal.exit, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.n = icmp samesign ult i32 %i.j, 158
  br i1 %i.n, label %heading_to_cardinal.exit, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.o = icmp samesign ult i32 %i.j, 203
  br i1 %i.o, label %heading_to_cardinal.exit, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.p = icmp samesign ult i32 %i.j, 248
  br i1 %i.p, label %heading_to_cardinal.exit, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.q = icmp samesign ult i32 %i.j, 293
  br i1 %i.q, label %heading_to_cardinal.exit, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.r = icmp samesign ult i32 %i.j, 338
  %.str.18..str.i = select i1 %i.r, ptr @.str.18, ptr @.str
...
!10 = !{!9, !9, i64 0}
!11 = !{!"p1 _ZTS11_lv_layer_t", !8, i64 0}
!12 = !{!"short", !4, i64 0}
!13 = !{!"", !4, i64 0, !4, i64 1, !4, i64 2}
!14 = !{!"long", !4, i64 0}
