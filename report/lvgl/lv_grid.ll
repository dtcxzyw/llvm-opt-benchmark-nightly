...
bb.r:                                             ; preds = %.lr.ph141.i.i
  ...
  store i32 %i.cd, ptr %i.ce, align 4, !tbaa !55
...
bb.s:                                             ; preds = %bb.r, %.lr.ph141.i.i
  ...
  br i1 %i.cj, label %.lr.ph141.i.i, label %._crit_edge142.i.i, !llvm.loop !37
...
bb.w:                                             ; preds = %bb.v
  ...
  store i32 536870911, ptr %i.cz, align 4, !tbaa !55
  br label %bb.x
...
bb.ad:                                            ; preds = %bb.ac, %bb.ab, %bb.aa, %bb.z, %.lr.ph.i49.i
  ...
  br i1 %i.eb, label %.lr.ph.i49.i, label %._crit_edge.i51.i, !llvm.loop !38
...
.sink.split.i53.i:                                ; preds = %._crit_edge.thread.i52.i, %._crit_edge.i51.i
  ...
  store i32 %.3103.lcssa.sink.i.i, ptr %i.ed, align 4, !tbaa !55
...
.lr.ph130.i.i._crit_edge:                         ; preds = %.lr.ph130.i.i, %.sink.split.i53.i
  ...
  br i1 %i.ee, label %.lr.ph130.i.i, label %.lr.ph134.i.i, !llvm.loop !39
...
.lr.ph134.i.i:                                    ; preds = %.lr.ph130.i.i._crit_edge, %bb.ai
  ...
  %i.ei = load i32, ptr %i.eh, align 4, !tbaa !55 ; 5 uses
...
bb.ag:                                            ; preds = %bb.af
  %i.eo = load i32, ptr %i.en, align 4, !tbaa !55
  %i.ep = add nsw i32 %i.eo, %.095133.i.i
  br label %bb.ai

bb.ah:                                            ; preds = %bb.af
  store i32 %i.ei, ptr %i.en, align 4, !tbaa !55
  %i.eq = add nsw i32 %i.ei, %.095133.i.i
  %.pre.i42.i = load i32, ptr %i.df, align 8, !tbaa !62 ; 2 uses
  br label %bb.ai
...
bb.aj:                                            ; preds = %.lr.ph142.i.i
  ...
  store i32 %i.fl, ptr %i.fm, align 4, !tbaa !55
...
bb.ak:                                            ; preds = %bb.aj, %.lr.ph142.i.i
  ...
  br i1 %i.fr, label %.lr.ph142.i.i, label %._crit_edge143.i.i, !llvm.loop !41
...
bb.an:                                            ; preds = %bb.am
  ...
  %.not.i.a = icmp eq i32 %i.gi, 0
  br label %bb.ao

bb.ao:                                            ; preds = %bb.an, %bb.am
  %i.gj = phi i1 [ false, %bb.am ], [ %.not.i.a, %bb.an ]
  ...
  %i.gm = load ptr, ptr %i.dj, align 8, !tbaa !64 ; 15 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load99 = load <4 x i32>, ptr %i.gs, align 4, !tbaa !55
...
vector.body107:                                   ; preds = %vector.body107, %vector.ph103
  ...
  %wide.load109.a = load <4 x i32>, ptr %i.ix, align 4, !tbaa !55, !alias.scope !68, !noalias !69
  %wide.load110.a = load <4 x i32>, ptr %i.iy, align 4, !tbaa !55, !alias.scope !68, !noalias !69
  %i.iz = getelementptr inbounds nuw [4 x i8], ptr %i.gm, i64 %index108 ; 2 uses
  %i.ja = getelementptr inbounds nuw i8, ptr %i.iz, i64 16
  %wide.load111.a = load <4 x i32>, ptr %i.iz, align 4, !tbaa !55, !alias.scope !69
  %wide.load112 = load <4 x i32>, ptr %i.ja, align 4, !tbaa !55, !alias.scope !69
  %i.jb = add <4 x i32> %wide.load109.a, %wide.load111.a
  %i.jc = add <4 x i32> %wide.load110.a, %wide.load112
  %i.jd = sub <4 x i32> %broadcast.splat106, %i.jb
  %i.je = sub <4 x i32> %broadcast.splat106, %i.jc
  store <4 x i32> %i.jd, ptr %i.ix, align 4, !tbaa !55, !alias.scope !68, !noalias !69
  store <4 x i32> %i.je, ptr %i.iy, align 4, !tbaa !55, !alias.scope !68, !noalias !69
  %index.next113 = add nuw i64 %index108, 8       ; 2 uses
  %i.jf = icmp eq i64 %index.next113, %n.vec104
  br i1 %i.jf, label %middle.block114, label %vector.body107, !llvm.loop !49
...
.lr.ph84.i.preheader:                             ; preds = %vector.memcheck, %.lr.ph84.preheader.i, %middle.block114
  ...
  %5 = trunc i32 %i.ev to i1
  br i1 %5, label %.lr.ph84.i.prol, label %.lr.ph84.i.prol.loopexit

.lr.ph84.i.prol:                                  ; preds = %.lr.ph84.i.preheader
  %i.jg = getelementptr inbounds nuw [4 x i8], ptr %i.dh, i64 %indvars.iv92.i.ph ; 2 uses
  %i.jh = load i32, ptr %i.jg, align 4, !tbaa !55
  ...
  store i32 %i.jl, ptr %i.jg, align 4, !tbaa !55
...
.lr.ph84.i:                                       ; preds = %.lr.ph84.i.prol.loopexit, %.lr.ph84.i
  ...
  store i32 %i.jt, ptr %i.jo, align 4, !tbaa !55
  ...
  store i32 %i.jz, ptr %i.ju, align 4, !tbaa !55
...
grid_align.exit:                                  ; preds = %.lr.ph84.i.prol.loopexit, %.lr.ph84.i, %middle.block114, %._crit_edge81.i
  ...
  store i32 %i.kb, ptr %i.kc, align 8, !tbaa !70
...
bb.az:                                            ; preds = %bb.ay, %grid_align.exit
  ...
  %i.kl = load i32, ptr %i.w, align 4, !tbaa !59  ; 8 uses
  %i.km = load ptr, ptr %i.ab, align 8, !tbaa !61 ; 9 uses
...
vector.body123:                                   ; preds = %vector.body123, %vector.ph119
  ...
  %vec.phi125.a = phi <4 x i32> [ zeroinitializer, %vector.ph119 ], [ %i.kv, %vector.body123 ]
  ...
  %wide.load127.a = load <4 x i32>, ptr %i.kr, align 4, !tbaa !55
  %wide.load128 = load <4 x i32>, ptr %i.ks, align 4, !tbaa !55
  %i.kt = add <4 x i32> %vec.phi125.a, %broadcast.splat122
  %i.ku = add <4 x i32> %vec.phi126, %broadcast.splat122
  %i.kv = add <4 x i32> %i.kt, %wide.load127.a    ; 2 uses
  ...
  br i1 %i.kx, label %middle.block130, label %vector.body123, !llvm.loop !51
...
bb.bd:                                            ; preds = %._crit_edge.i66.i
  ...
  store i32 %i.lf, ptr %i.y, align 4, !tbaa !55
  br label %bb.bi

bb.be:                                            ; preds = %._crit_edge.i66.i
  %i.lg = sub nsw i32 %i.kj, %i.ld                ; 2 uses
  store i32 %i.lg, ptr %i.y, align 4, !tbaa !55
  br label %bb.bi
...
bb.bg:                                            ; preds = %._crit_edge.i66.i
  ...
  store i32 %i.lm, ptr %i.y, align 4, !tbaa !55
  br label %bb.bi
...
bb.bh:                                            ; preds = %._crit_edge.i66.i
  ...
  store i32 %i.lp, ptr %i.y, align 4, !tbaa !55
  br label %bb.bi
