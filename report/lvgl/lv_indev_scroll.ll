...
bb.ad:                                            ; preds = %bb.ac, %bb.ad
  ...
  %.070114 = phi i32 [ 256, %bb.ac ], [ %5, %bb.ad ]
  ...
  %.sroa.0.0.extract.trunc.i.i = trunc i64 %i.cy to i32
  %2 = tail call range(i32 1, -2147483648) i32 @llvm.smax.i32(i32 %.sroa.0.0.extract.trunc.i.i, i32 1)
  %3 = ptrtoint ptr %i.cx to i64
  %.sroa.0.0.extract.trunc.i.i78 = trunc i64 %3 to i32
  %i.cz = tail call range(i32 1, -2147483648) i32 @llvm.smax.i32(i32 %.sroa.0.0.extract.trunc.i.i78, i32 1)
  %i.da = ashr exact i32 %sext116, 16
  %4 = mul nsw i32 %2, %i.da
  %5 = lshr i32 %4, 8                             ; 2 uses
  %6 = ashr exact i32 %sext117, 16
  %7 = mul nsw i32 %i.cz, %6
  %i.db = lshr i32 %7, 8                          ; 2 uses
...
bb.ae:                                            ; preds = %bb.ad
  %i.dd = trunc i32 %5 to i16                     ; 2 uses
