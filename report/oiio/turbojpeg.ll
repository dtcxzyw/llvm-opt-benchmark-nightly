...
begin_hunk_0_@setDecodeDefaults:bb.a
  ...
  %spec.select = select i1 %i.f, i32 1, i32 3     ; 3 uses
  %i.g = getelementptr inbounds nuw i8, ptr %0, i64 1024
  store i32 %spec.select, ptr %i.g, align 8, !tbaa !339
...
begin_hunk_1_@setDecodeDefaults:bb.a
  ...
  %narrow = select i1 %i.f, i64 96, i64 288
  %i.m = tail call ptr %i.l(ptr noundef nonnull %i.a, i32 noundef 1, i64 noundef %narrow) #25 ; 11 uses
