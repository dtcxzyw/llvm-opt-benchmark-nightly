...
.outer.i.i.outer:                                 ; preds = %bb.t, %bb.d
  %.0103.ph.i.i = phi i64 [ %i.bf, %bb.t ], [ 1, %bb.d ] ; 5 uses
  %.0100.ph.i.i.ph = phi i64 [ %.0100.ph6.i.i.ph, %bb.t ], [ 1024, %bb.d ]
  %.not109.ph.i.i = phi i1 [ true, %bb.t ], [ false, %bb.d ]
  %.098.ph.i.i.ph = phi i32 [ %switch.select120.i.i, %bb.t ], [ 256, %bb.d ]
  %.095.ph.i.i.ph = phi i64 [ %.196.peel.i.i, %bb.t ], [ 0, %bb.d ]
  %.086.ph.i.i.ph = phi i64 [ %i.bg, %bb.t ], [ 0, %bb.d ]
  %.086.ph.i.i = phi i64 [ %.189.peel.i.i, %bb.t ], [ 0, %bb.d ]
  %.084.ph.i.i.ph = phi i64 [ %.187.peel.i.i, %bb.t ], [ 0, %bb.d ]
  %.083.ph.i.i = phi ptr [ %.083.ph13.i.i.ph, %bb.t ], [ %i.u, %bb.d ]
  br label %.outer.i.i

.outer.i.i:                                       ; preds = %bb.m, %.outer.i.i.outer
  %.0100.ph6.i.i.ph = phi i64 [ %i.ap, %bb.m ], [ %.0100.ph.i.i.ph, %.outer.i.i.outer ] ; 5 uses
  %.not109.ph7.i.i.ph = phi i1 [ false, %bb.m ], [ %.not109.ph.i.i, %.outer.i.i.outer ]
  %.098.ph.i.i = phi i32 [ %.098.lcssa.i.i, %bb.m ], [ %.098.ph.i.i.ph, %.outer.i.i.outer ]
  %.095.ph.i.i = phi i64 [ %.196.peel.i.i, %bb.m ], [ %.095.ph.i.i.ph, %.outer.i.i.outer ]
  %.088.ph.i.i = phi i64 [ 0, %bb.m ], [ %.086.ph.i.i.ph, %.outer.i.i.outer ]
  %.086.ph.i.i.a = phi i64 [ %.187.peel.i.i, %bb.m ], [ %.086.ph.i.i, %.outer.i.i.outer ]
  %.084.ph.i.i = phi i64 [ %.187.peel.i.i, %bb.m ], [ %.084.ph.i.i.ph, %.outer.i.i.outer ]
  %.083.ph13.i.i.ph = phi ptr [ %i.aq, %bb.m ], [ %.083.ph.i.i, %.outer.i.i.outer ] ; 12 uses
  br label %.outer5.i.i

.outer5.i.i:                                      ; preds = %.outer.i.i, %bb.n
  %.not109.ph.i.i.a = phi i1 [ false, %bb.n ], [ %.not109.ph7.i.i.ph, %.outer.i.i ]
  %.098.ph6.i.i = phi i32 [ %.098.lcssa.i.i, %bb.n ], [ %.098.ph.i.i, %.outer.i.i ] ; 3 uses
  %.093.ph.i.i = phi i64 [ %i.as, %bb.n ], [ %.095.ph.i.i, %.outer.i.i ]
  %.088.ph8.i.i = phi i64 [ 0, %bb.n ], [ %.088.ph.i.i, %.outer.i.i ] ; 4 uses
  %.086.ph9.i.i = phi i64 [ %i.as, %bb.n ], [ %.086.ph.i.i.a, %.outer.i.i ] ; 4 uses
  %.084.ph10.i.i = phi i64 [ %.187.peel.i.i, %bb.n ], [ %.084.ph.i.i, %.outer.i.i ]
  br i1 %.not109.ph.i.i.a, label %bb.f, label %bb.e

bb.e:                                             ; preds = %.outer5.i.i
  %i.w = getelementptr inbounds i8, ptr %.083.ph13.i.i.ph, i64 %.086.ph9.i.i
  %i.x = sub i64 %.0100.ph6.i.i.ph, %.086.ph9.i.i
  %i.y = call i64 @FT_Stream_TryRead(ptr noundef %0, ptr noundef %i.w, i64 noundef %i.x) #20 ; 2 uses
  %i.z = add nsw i64 %i.y, %.086.ph9.i.i
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %.outer5.i.i
  %.196.peel.i.i = phi i64 [ %i.y, %bb.e ], [ %.093.ph.i.i, %.outer5.i.i ] ; 3 uses
  %.189.peel.i.i = phi i64 [ 0, %bb.e ], [ %.086.ph9.i.i, %.outer5.i.i ]
  %.187.peel.i.i = phi i64 [ %i.z, %bb.e ], [ %.084.ph10.i.i, %.outer5.i.i ] ; 8 uses
  %i.aa = icmp slt i64 %.088.ph8.i.i, %.187.peel.i.i
  br i1 %i.aa, label %bb.g, label %.loopexit60.i.i

bb.g:                                             ; preds = %bb.f
  %i.ab = getelementptr inbounds i8, ptr %.083.ph13.i.i.ph, i64 %.088.ph8.i.i
...
.lr.ph.i.i:                                       ; preds = %.loopexit60.i.i, %bb.h
  ...
  %i.ah = getelementptr inbounds i8, ptr %.083.ph13.i.i.ph, i64 %.09224.i.i
...
.critedge.i.i:                                    ; preds = %bb.h, %.loopexit60.i.i
  %i.ak = icmp eq i64 %.196.peel.i.i, 0
  br i1 %i.ak, label %bb.i, label %bb.j

bb.i:                                             ; preds = %.critedge.i.i
  %i.al = icmp eq i64 %.0103.ph.i.i, 1
...
bb.k:                                             ; preds = %bb.j
  %i.an = icmp samesign ugt i64 %.0100.ph6.i.i.ph, 65535
  br i1 %i.an, label %bb.l, label %bb.m

bb.l:                                             ; preds = %bb.k
  %i.ao = icmp eq i64 %.0103.ph.i.i, 1
  %..i.i = select i1 %i.ao, i32 176, i32 6
  br label %bdf_readstream_.exit.sink.split.i

bb.m:                                             ; preds = %bb.k
  %i.ap = shl nuw nsw i64 %.0100.ph6.i.i.ph, 1    ; 2 uses
  %i.aq = call ptr @ft_mem_qrealloc(ptr noundef %i.t, i64 noundef 1, i64 noundef %.0100.ph6.i.i.ph, i64 noundef %i.ap, ptr noundef %.083.ph13.i.i.ph, ptr noundef nonnull %i.c) #20 ; 2 uses
  %i.ar = load i32, ptr %i.c, align 4, !tbaa !3
  %.not116.i.i = icmp eq i32 %i.ar, 0
  br i1 %.not116.i.i, label %.outer.i.i, label %bdf_readstream_.exit.i

bb.n:                                             ; preds = %bb.j
  %i.as = sub nsw i64 %.187.peel.i.i, %.093.lcssa.i.i ; 3 uses
  %i.at = getelementptr inbounds i8, ptr %.083.ph13.i.i.ph, i64 %.093.lcssa.i.i
  call void @llvm.memmove.p0.p0.i64(ptr align 1 %.083.ph13.i.i.ph, ptr nonnull align 1 %i.at, i64 %i.as, i1 false)
  br label %.outer5.i.i

bb.o:                                             ; preds = %.lr.ph.i.i, %.lr.ph.i.i
  %i.au = getelementptr inbounds i8, ptr %.083.ph13.i.i.ph, i64 %.09224.i.i ; 2 uses
  store i8 0, ptr %i.au, align 1, !tbaa !41
  %i.av = getelementptr inbounds i8, ptr %.083.ph13.i.i.ph, i64 %.093.lcssa.i.i ; 3 uses
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.ba = call i32 %i.ay(ptr noundef nonnull %i.av, i64 noundef %i.az, i64 noundef %.0103.ph.i.i, ptr noundef nonnull %i.b, ptr noundef %i.i) #20, !inline_history !44 ; 3 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.bd = call i32 %i.bc(ptr noundef nonnull %i.av, i64 noundef %i.az, i64 noundef %.0103.ph.i.i, ptr noundef nonnull %i.b, ptr noundef %i.i) #20, !inline_history !44 ; 2 uses
...
bdf_readstream_.exit.i:                           ; preds = %bb.s, %bb.m, %bdf_readstream_.exit.sink.split.i, %bb.i, %bb.c
  %.3.i.i = phi ptr [ %.083.ph13.i.i.ph, %bb.i ], [ %i.u, %bb.c ], [ %i.aq, %bb.m ], [ %.083.ph13.i.i.ph, %bdf_readstream_.exit.sink.split.i ], [ %.083.ph13.i.i.ph, %bb.s ]
...
.lr.ph86:                                         ; preds = %._crit_edge82, %.lr.ph86
  ...
  %i.bf = load ptr, ptr %.06983, align 8, !tbaa !168
  tail call void @ft_mem_free(ptr noundef %i.c, ptr noundef %i.bf) #20
  store ptr null, ptr %.06983, align 8, !tbaa !168
...
.lr.ph:                                           ; preds = %bb.aw, %bb.az
  %.0313449 = phi i64 [ %i.is, %bb.az ], [ 0, %bb.aw ] ; 5 uses
  %.0314448 = phi ptr [ %.1, %bb.az ], [ %i.ia, %bb.aw ] ; 6 uses
  %i.ib = getelementptr inbounds nuw i8, ptr %0, i64 %.0313449
...
bb.ax:                                            ; preds = %.lr.ph
  %i.im = load i8, ptr %.0314448, align 1, !tbaa !41
  %i.in = shl i8 %i.im, 4
  ...
  store i8 %i.ir, ptr %.0314448, align 1, !tbaa !41
  %i.is = add nuw i64 %.0313449, 1                ; 3 uses
  %i.it = icmp uge i64 %i.is, %i.hw
  %i.iu = and i64 %.0313449, 1
  %.not389 = icmp eq i64 %i.iu, 0
  %or.cond421 = or i1 %i.it, %.not389
  br i1 %or.cond421, label %bb.az, label %bb.ay

bb.ay:                                            ; preds = %bb.ax
  %i.iv = getelementptr inbounds nuw i8, ptr %.0314448, i64 1 ; 2 uses
  store i8 0, ptr %i.iv, align 1, !tbaa !41
  br label %bb.az

bb.az:                                            ; preds = %bb.ax, %bb.ay
  %.1 = phi ptr [ %i.iv, %bb.ay ], [ %.0314448, %bb.ax ] ; 2 uses
...
.critedge423:                                     ; preds = %bb.az, %bb.aw, %bb.bb, %bb.ba
  %.0314447 = phi ptr [ %.0314448, %bb.ba ], [ %.0314448, %bb.bb ], [ %i.ia, %bb.aw ], [ %.1, %bb.az ] ; 2 uses
  %.0313445 = phi i64 [ %.0313449, %bb.ba ], [ %.0313449, %bb.bb ], [ 0, %bb.aw ], [ %i.hw, %bb.az ]
...
begin_hunk_9_@bdf_parse_glyphs_:bb.a
  ...
  %i.jj = load i8, ptr %.0314447, align 1, !tbaa !41
  %i.jk = and i8 %i.jj, %i.ji
  store i8 %i.jk, ptr %.0314447, align 1, !tbaa !41
  br label %bb.bd

bb.bd:                                            ; preds = %bb.bc, %.critedge423
  %i.jl = icmp eq i64 %.0313445, %i.hw
