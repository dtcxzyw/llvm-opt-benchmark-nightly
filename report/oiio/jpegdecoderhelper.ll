...
bb.t:                                             ; preds = %_ZN8ultrahdrL27jpeg_extract_marker_payloadEP22jpeg_decompress_structjPKhjRSt6vectorIhSaIhEERl.exit122
  ...
  %i.dt = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.ds, i64 noundef 256, ptr noundef nonnull @.str.3, i32 noundef %i.dm, i32 noundef %i.dp) #25 ; 0 uses
  br label %.critedge92
...
bb.v:                                             ; preds = %bb.u
  ...
  %i.dy = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.dx, i64 noundef 256, ptr noundef nonnull @.str.4, i32 noundef 8192, i32 noundef 8192, i32 noundef %i.dm, i32 noundef %i.dp) #25 ; 0 uses
  br label %.critedge92
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.eg = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.ef, i64 noundef 256, ptr noundef nonnull @.str.5, i32 noundef %i.ea) #25 ; 0 uses
  br label %.critedge92
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.eo = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.en, i64 noundef 256, ptr noundef nonnull @.str.6, i32 noundef %i.el, i32 noundef %i.ej) #25 ; 0 uses
  br label %.critedge92
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.ev = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.eu, i64 noundef 256, ptr noundef nonnull @.str.7, i32 noundef %i.es, i32 noundef %i.eq) #25 ; 0 uses
  br label %.critedge92
...
bb.ah:                                            ; preds = %._crit_edge212, %bb.ag
  ...
  %i.ii = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.id, i64 noundef 256, ptr noundef nonnull @.str.9, i32 noundef %i.hu, i32 noundef %i.ib, i32 noundef %i.ht, i32 noundef %i.if, i32 noundef %i.ih, i32 noundef %i.ia) #25 ; 0 uses
  br label %.critedge92
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.ip = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.io, i64 noundef 256, ptr noundef nonnull @.str.10, i32 noundef %i.ht, i32 noundef %i.im, i32 noundef %i.ik, i32 noundef %i.hx) #25 ; 0 uses
  br label %.critedge92

bb.ak:                                            ; preds = %bb.ai, %._crit_edge
  %i.iq = call range(i32 0, 33) i32 @llvm.ctpop.i32(i32 %4)
  %i.ir = icmp eq i32 %i.iq, 1
  br i1 %i.ir, label %.split, label %bb.aq

.split:                                           ; preds = %bb.ak
  %i.is = call range(i32 0, 33) i32 @llvm.cttz.i32(i32 %4, i1 true)
  switch i32 %i.is, label %bb.aq [
    i32 0, label %.critedge92
    i32 16, label %bb.al
    i32 18, label %.thread
    i32 17, label %.thread130
  ]

bb.al:                                            ; preds = %.split
  %i.it = icmp eq i32 %i.ea, 1
  br i1 %i.it, label %.thread130, label %.thread

.thread:                                          ; preds = %.split, %bb.al
  %i.iu = getelementptr inbounds nuw i8, ptr %6, i64 60
  %i.iv = load i32, ptr %i.iu, align 4, !tbaa !96 ; 2 uses
  %i.iw = add i32 %i.iv, -4
  %or.cond12 = icmp ult i32 %i.iw, -2
  br i1 %or.cond12, label %bb.am, label %bb.an

bb.am:                                            ; preds = %.thread
  store i32 1, ptr %0, align 4, !tbaa !49
  %i.ix = getelementptr inbounds nuw i8, ptr %0, i64 4
  store i32 1, ptr %i.ix, align 4, !tbaa !52
  %i.iy = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.iz = call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.iy, i64 noundef 256, ptr noundef nonnull @.str.11, i32 noundef %i.iv) #25 ; 0 uses
  br label %.critedge92

bb.an:                                            ; preds = %.thread
  %i.ja = getelementptr inbounds nuw i8, ptr %1, i64 176
  store i32 %i.dm, ptr %i.ja, align 8, !tbaa !3
  %i.jb = getelementptr inbounds nuw i8, ptr %1, i64 188
  store i32 %i.dp, ptr %i.jb, align 4, !tbaa !3
  ...
  %i.jd = zext i32 %i.dm to i64
  %i.je = zext i32 %i.dp to i64
  %i.jf = shl nuw nsw i64 %i.jd, 2
  %i.jg = mul i64 %i.jf, %i.je
  call void @_ZNSt6vectorIhSaIhEE6resizeEm(ptr noundef nonnull align 8 dereferenceable(24) %i.jc, i64 noundef %i.jg)
  %i.jh = getelementptr inbounds nuw i8, ptr %6, i64 64
  store i32 12, ptr %i.jh, align 8, !tbaa !97
  br label %bb.aq

.thread130:                                       ; preds = %.split, %bb.al
  %i.ji = getelementptr inbounds nuw i8, ptr %6, i64 60 ; 2 uses
  %i.jj = load i32, ptr %i.ji, align 4, !tbaa !96 ; 2 uses
  %i.jk = and i32 %i.jj, -3
  %or.cond15.not = icmp eq i32 %i.jk, 1
  br i1 %or.cond15.not, label %.lr.ph170, label %bb.ao

.lr.ph170:                                        ; preds = %.thread130
  %i.jl = getelementptr inbounds nuw i8, ptr %1, i64 152
  %i.jm = getelementptr inbounds nuw i8, ptr %6, i64 408
  %i.jn = load i32, ptr %i.jm, align 8, !tbaa !85 ; 2 uses
  %invariant.op = add i32 %i.jn, -1
