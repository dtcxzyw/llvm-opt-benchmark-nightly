begin_hunk_0_@decode_mcu:bb.a
  ...
  %i.r = tail call i32 %i.q(ptr noundef nonnull %0) #6, !inline_history !112
...
begin_hunk_1_@decode_mcu:bb.a
  ...
  br i1 %i.z, label %bb.d, label %._crit_edge.i, !llvm.loop !113
...
begin_hunk_2_@decode_mcu:bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %4, ptr noundef nonnull align 8 dereferenceable(16) %i.ay, i64 16, i1 false), !tbaa.struct !114
...
begin_hunk_4_@decode_mcu:bb.a
  ...
  br i1 %i.fc, label %.lr.ph.i26, label %._crit_edge.loopexit.i, !llvm.loop !117
...
bb.bd:                                            ; preds = %bb.bc
  ...
  store i16 %i.iw, ptr %i.bi, align 2, !tbaa !118
  br label %bb.be
...
begin_hunk_6_@decode_mcu:bb.a
  ...
  br i1 %i.mw, label %.lr.ph833.i, label %._crit_edge834.loopexit.i, !llvm.loop !119
...
begin_hunk_7_@decode_mcu:bb.a
  ...
  store i16 %i.qi, ptr %i.qn, align 2, !tbaa !118
  br label %bb.cy
...
begin_hunk_8_@decode_mcu:bb.a
  ...
  br i1 %i.qr, label %bb.bf, label %.thread790.i, !llvm.loop !120
...
begin_hunk_9_@decode_mcu:bb.a
  ...
  br i1 %i.uh, label %.lr.ph819.i, label %._crit_edge820.loopexit.i, !llvm.loop !121
...
begin_hunk_10_@decode_mcu:bb.a
  ...
  br i1 %i.xk, label %bb.cz, label %.thread790.i, !llvm.loop !122
...
begin_hunk_11_@decode_mcu:bb.a
  ...
  br i1 %exitcond.not.i, label %._crit_edge849.i, label %bb.j, !llvm.loop !123
...
begin_hunk_12_@decode_mcu:bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ay, ptr noundef nonnull align 4 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !114
...
begin_hunk_13_@decode_mcu:bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %3, ptr noundef nonnull align 8 dereferenceable(16) %i.xy, i64 16, i1 false), !tbaa.struct !114
...
bb.et:                                            ; preds = %bb.es
  ...
  %i.yi = load ptr, ptr %i.yh, align 8, !tbaa !115
  br label %bb.eu
...
bb.fi:                                            ; preds = %bb.fh
  ...
  store i16 %i.aaf, ptr %i.yj, align 2, !tbaa !118
  br label %bb.fj
...
bb.e:                                             ; preds = %bb.d
  %i.ae = load ptr, ptr %0, align 8, !tbaa !127   ; 2 uses
...
begin_hunk_22_@add_huff_table:bb.a
  ...
  store i32 0, ptr %i.aq, align 4, !tbaa !128
  br label %bb.g
