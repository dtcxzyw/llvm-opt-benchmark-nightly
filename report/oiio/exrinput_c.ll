...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load <2 x i32>, ptr %i.d, align 8, !tbaa !3 ; 3 uses
  %3 = extractelement <2 x i32> %i.e, i64 0       ; 5 uses
  %4 = extractelement <2 x i32> %i.e, i64 1       ; 5 uses
...
begin_hunk_1_@_ZNK11OpenImageIO4v3_116OpenEXRCoreInput8PartInfo14compute_mipresEiRNS0_9ImageSpecE:bb.a
  ...
  br i1 %i.h, label %.lr.ph.split.us.preheader.a, label %.lr.ph.split

.lr.ph.split.us.preheader.a:                      ; preds = %.lr.ph
  %xtraiter = and i32 %1, 1
  %lcmp.mod.not = icmp eq i32 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.lr.ph.split.us.prol.loopexit, label %.lr.ph.split.us.prol.a

.lr.ph.split.us.prol.a:                           ; preds = %.lr.ph.split.us.preheader.a
  %.1.us.prol = sdiv i32 %3, 2
  %storemerge.us.prol = sdiv i32 %4, 2
  %.sroa.speculated30.us.prol = tail call i32 @llvm.smax.i32(i32 %.1.us.prol, i32 1) ; 2 uses
  %.sroa.speculated.us.prol = tail call i32 @llvm.smax.i32(i32 %storemerge.us.prol, i32 1) ; 2 uses
  %i.i = add nsw i32 %1, -1
  br label %.lr.ph.split.us.prol.loopexit

.lr.ph.split.us.prol.loopexit:                    ; preds = %.lr.ph.split.us.prol.a, %.lr.ph.split.us.preheader.a
  %.sroa.speculated30.us.lcssa.unr = phi i32 [ poison, %.lr.ph.split.us.preheader.a ], [ %.sroa.speculated30.us.prol, %.lr.ph.split.us.prol.a ]
  %.sroa.speculated.us.lcssa.unr = phi i32 [ poison, %.lr.ph.split.us.preheader.a ], [ %.sroa.speculated.us.prol, %.lr.ph.split.us.prol.a ]
  %.050.us.unr = phi i32 [ %1, %.lr.ph.split.us.preheader.a ], [ %i.i, %.lr.ph.split.us.prol.a ]
  %.04449.us.unr = phi i32 [ %3, %.lr.ph.split.us.preheader.a ], [ %.sroa.speculated30.us.prol, %.lr.ph.split.us.prol.a ]
  %.04548.us.unr = phi i32 [ %4, %.lr.ph.split.us.preheader.a ], [ %.sroa.speculated.us.prol, %.lr.ph.split.us.prol.a ]
  %i.j = icmp eq i32 %1, 1
  br i1 %i.j, label %.loopexit, label %.lr.ph.split.us

.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.prol.loopexit, %.lr.ph.split.us
  %.050.us = phi i32 [ %i.k, %.lr.ph.split.us ], [ %.050.us.unr, %.lr.ph.split.us.prol.loopexit ]
  %.04449.us = phi i32 [ %.sroa.speculated30.us.1, %.lr.ph.split.us ], [ %.04449.us.unr, %.lr.ph.split.us.prol.loopexit ]
  %.04548.us = phi i32 [ %.sroa.speculated.us.1, %.lr.ph.split.us ], [ %.04548.us.unr, %.lr.ph.split.us.prol.loopexit ]
  %.1.us = sdiv i32 %.04449.us, 2
  %storemerge.us = sdiv i32 %.04548.us, 2
  %.sroa.speculated30.us = tail call i32 @llvm.smax.i32(i32 %.1.us, i32 1)
  %.sroa.speculated.us = tail call i32 @llvm.smax.i32(i32 %storemerge.us, i32 1)
  %.1.us.161 = lshr i32 %.sroa.speculated30.us, 1
  %storemerge.us.162 = lshr i32 %.sroa.speculated.us, 1
  %.sroa.speculated30.us.1 = tail call i32 @llvm.smax.i32(i32 %.1.us.161, i32 1) ; 2 uses
  %.sroa.speculated.us.1 = tail call i32 @llvm.smax.i32(i32 %storemerge.us.162, i32 1) ; 2 uses
  %i.k = add nsw i32 %.050.us, -2                 ; 2 uses
  %.not.us.1 = icmp eq i32 %i.k, 0
  br i1 %.not.us.1, label %.loopexit, label %.lr.ph.split.us, !llvm.loop !299

.lr.ph.split:                                     ; preds = %.lr.ph, %.lr.ph.split
  %.050 = phi i32 [ %i.p, %.lr.ph.split ], [ %1, %.lr.ph ]
  %i.l = phi <2 x i32> [ %i.o, %.lr.ph.split ], [ %i.e, %.lr.ph ]
  %i.m = add nsw <2 x i32> %i.l, splat (i32 1)
  %i.n = sdiv <2 x i32> %i.m, splat (i32 2)
  %i.o = tail call <2 x i32> @llvm.smax.v2i32(<2 x i32> %i.n, <2 x i32> splat (i32 1)) ; 3 uses
  %i.p = add nsw i32 %.050, -1                    ; 2 uses
  %.not = icmp eq i32 %i.p, 0
  br i1 %.not, label %.loopexit.loopexit59, label %.lr.ph.split, !llvm.loop !299
...
.loopexit.loopexit59:                             ; preds = %.lr.ph.split
  %5 = extractelement <2 x i32> %i.o, i64 1
  %6 = extractelement <2 x i32> %i.o, i64 0
  br label %.loopexit

.loopexit:                                        ; preds = %.lr.ph.split.us.prol.loopexit, %.lr.ph.split.us, %.loopexit.loopexit59, %.preheader, %bb.b, %bb.c
  %.146 = phi i32 [ %4, %bb.c ], [ %4, %bb.b ], [ %4, %.preheader ], [ %5, %.loopexit.loopexit59 ], [ %.sroa.speculated.us.lcssa.unr, %.lr.ph.split.us.prol.loopexit ], [ %.sroa.speculated.us.1, %.lr.ph.split.us ] ; 2 uses
  %.2 = phi i32 [ %3, %bb.c ], [ %3, %bb.b ], [ %3, %.preheader ], [ %6, %.loopexit.loopexit59 ], [ %.sroa.speculated30.us.lcssa.unr, %.lr.ph.split.us.prol.loopexit ], [ %.sroa.speculated30.us.1, %.lr.ph.split.us ] ; 4 uses
  %i.s = getelementptr inbounds nuw i8, ptr %2, i64 12
  store i32 %.2, ptr %i.s, align 4, !tbaa !300
  %7 = getelementptr inbounds nuw i8, ptr %2, i64 16
  store i32 %.146, ptr %7, align 8, !tbaa !301
  ...
  %.sroa.0.0.copyload = load i32, ptr %i.u, align 8, !tbaa !3 ; 2 uses
  %.sroa.5.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 212
  %.sroa.5.0.copyload = load i32, ptr %.sroa.5.0..sroa_idx, align 4, !tbaa !3 ; 2 uses
  %.sroa.7.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 216
  %.sroa.7.0.copyload = load i32, ptr %.sroa.7.0..sroa_idx, align 8, !tbaa !3
  %.sroa.8.0..sroa_idx = getelementptr inbounds nuw i8, ptr %0, i64 220
  %.sroa.8.0.copyload = load i32, ptr %.sroa.8.0..sroa_idx, align 4, !tbaa !3
  store i32 %.sroa.03.0.copyload, ptr %2, align 8, !tbaa !302
  %i.v = getelementptr inbounds nuw i8, ptr %2, i64 4
  store i32 %.sroa.4.0.copyload, ptr %i.v, align 4, !tbaa !303
  %i.w = icmp eq i32 %1, 0
  br i1 %i.w, label %bb.d, label %bb.e

bb.d:                                             ; preds = %.loopexit
  %reass.sub = sub i32 %.sroa.7.0.copyload, %.sroa.0.0.copyload
  %8 = add i32 %reass.sub, 1
  %reass.sub54 = sub i32 %.sroa.8.0.copyload, %.sroa.5.0.copyload
  %9 = add i32 %reass.sub54, 1
  br label %bb.e

bb.e:                                             ; preds = %.loopexit, %bb.d
  %.sroa.03.0.copyload.sink = phi i32 [ %.sroa.0.0.copyload, %bb.d ], [ %.sroa.03.0.copyload, %.loopexit ]
  %.sroa.4.0.copyload.sink.a = phi i32 [ %.sroa.5.0.copyload, %bb.d ], [ %.sroa.4.0.copyload, %.loopexit ]
  %.2.sink = phi i32 [ %8, %bb.d ], [ %.2, %.loopexit ]
  %.146.sink = phi i32 [ %9, %bb.d ], [ %.146, %.loopexit ]
  %i.x = getelementptr inbounds nuw i8, ptr %2, i64 24
  store i32 %.sroa.03.0.copyload.sink, ptr %i.x, align 8, !tbaa !304
  %i.y = getelementptr inbounds nuw i8, ptr %2, i64 28
  store i32 %.sroa.4.0.copyload.sink.a, ptr %i.y, align 4, !tbaa !305
  %i.z = getelementptr inbounds nuw i8, ptr %2, i64 36 ; 2 uses
  store i32 %.2.sink, ptr %i.z, align 4, !tbaa !306
  %10 = getelementptr inbounds nuw i8, ptr %2, i64 40 ; 2 uses
  store i32 %.146.sink, ptr %10, align 8, !tbaa !307
...
bb.f:                                             ; preds = %bb.e
  store i32 %.2, ptr %i.z, align 4, !tbaa !306
  store i32 %.2, ptr %10, align 8, !tbaa !307
  br label %bb.g
...
begin_hunk_2_@_ZNK11OpenImageIO4v3_110ImageInput8errorfmtIJiiEEEvPKcDpRKT_:bb.a
  ...
  %i.a = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %1) #33, !noalias !308
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #33, !noalias !308
  tail call void @llvm.experimental.noalias.scope.decl(metadata !311)
  %i.b = load i32, ptr %2, align 4, !tbaa !3, !noalias !314
  store i32 %i.b, ptr %4, align 16, !tbaa !68, !alias.scope !311, !noalias !308
  %i.c = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.d = load i32, ptr %3, align 4, !tbaa !3, !noalias !314
  store i32 %i.d, ptr %i.c, align 16, !tbaa !68, !alias.scope !311, !noalias !308
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #33, !noalias !308
...
begin_hunk_3_@_ZN11OpenImageIO4v3_116OpenEXRCoreInput15spec_dimensionsEii:bb.a
  ...
  %i.ao = load i8, ptr %i.an, align 8, !tbaa !315, !range !101, !noundef !102
  %i.ap = getelementptr inbounds nuw i8, ptr %0, i64 128
  store i8 %i.ao, ptr %i.ap, align 8, !tbaa !315
...
begin_hunk_5_@_ZN11OpenImageIO4v3_116OpenEXRCoreInput21read_native_scanlinesEiiiiiiiPv:bb.a
  ...
  %i.s = load i32, ptr %i.r, align 4, !tbaa !300
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.y = load i32, ptr %i.x, align 4, !tbaa !303  ; 3 uses
  %i.z = getelementptr inbounds nuw i8, ptr %i.m, i64 16
  %i.aa = load i32, ptr %i.z, align 8, !tbaa !301
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.e = load i32, ptr %i.d, align 4, !tbaa !316
...
begin_hunk_8_@_ZN11OpenImageIO4v3_116OpenEXRCoreInput16read_native_tileEiiiiiPv:bb.a
  ...
  %i.k = load i32, ptr %i.j, align 4, !tbaa !316
  ...
  %i.o = load i32, ptr %i.e, align 8, !tbaa !302
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.v = load i32, ptr %i.j, align 4, !tbaa !316
...
.preheader:                                       ; preds = %bb.h
  %i.aj = load i32, ptr %i.j, align 4, !tbaa !316
...
begin_hunk_11_@_ZN11OpenImageIO4v3_116OpenEXRCoreInput16read_native_tileEiiiiiPv:bb.a
  ...
  %i.az = load i32, ptr %i.j, align 4, !tbaa !316
...
.loopexit:                                        ; preds = %_ZN11OpenImageIO4v3_117basic_string_viewIcSt11char_traitsIcEEC2EPKc.exit.thread, %bb.k, %_ZNK11OpenImageIO4v3_19ImageSpec12channel_nameEi.exit.thread, %_ZNK11OpenImageIO4v3_19ImageSpec12channel_nameEi.exit, %.thread
  ...
  %i.db = load i32, ptr %i.j, align 4, !tbaa !316
...
begin_hunk_13_@_ZN11OpenImageIO4v3_116OpenEXRCoreInput16read_native_tileEiiiiiPv:bb.a
  ...
  %i.dn = load i32, ptr %i.j, align 4, !tbaa !316
...
begin_hunk_15_@_ZN11OpenImageIO4v3_116OpenEXRCoreInput17read_native_tilesEiiiiiiiiiiPv:bb.a
  ...
  %i.ab = load i32, ptr %i.t, align 8, !tbaa !302
  ...
  %i.af = load i32, ptr %i.ae, align 4, !tbaa !303
...
begin_hunk_17_@_ZN11OpenImageIO4v3_116OpenEXRCoreInput26read_native_deep_scanlinesEiiiiiiiRNS0_8DeepDataE:bb.a
  ...
  %i.m = load i32, ptr %i.l, align 4, !tbaa !300
...
begin_hunk_18_@_ZN11OpenImageIO4v3_116OpenEXRCoreInput26read_native_deep_scanlinesEiiiiiiiRNS0_8DeepDataE:bb.a
  ...
  %i.aa = load i32, ptr %i.h, align 4, !tbaa !316 ; 2 uses
...
begin_hunk_19_@_ZN11OpenImageIO4v3_116OpenEXRCoreInput26read_native_deep_scanlinesEiiiiiiiRNS0_8DeepDataE:bb.a
  ...
  %i.ba = load i32, ptr %i.l, align 4, !tbaa !300
...
begin_hunk_20_@_ZN11OpenImageIO4v3_116OpenEXRCoreInput22read_native_deep_tilesEiiiiiiiiiiRNS0_8DeepDataE:bb.a
  ...
  %i.v = load i32, ptr %i.m, align 8, !tbaa !302
  ...
  %i.z = load i32, ptr %i.y, align 4, !tbaa !303
...
begin_hunk_22_@_ZN11OpenImageIO4v3_116OpenEXRCoreInput22read_native_deep_tilesEiiiiiiiiiiRNS0_8DeepDataE:bb.a
  ...
  %i.bh = load i32, ptr %i.s, align 4, !tbaa !316 ; 2 uses
...
.critedge68.i.i.i:                                ; preds = %.critedge67.i.i.i, %.critedge.i.i.i, %bb.k, %bb.i
  ...
  %i.eu = load i32, ptr %i.et, align 8, !tbaa !302 ; 2 uses
  %i.ev = getelementptr inbounds nuw i8, ptr %i.et, i64 12
  %i.ew = load i32, ptr %i.ev, align 4, !tbaa !300
...
!307 = !{!16, !4, i64 40}
!308 = !{!309}
!309 = distinct !{!309, !310, !"_ZN11OpenImageIO4v3_17Strutil3fmt6formatIPKcJRKiS7_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKT_DpOT0_: argument 0"}
!310 = distinct !{!310, !"_ZN11OpenImageIO4v3_17Strutil3fmt6formatIPKcJRKiS7_EEENSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEERKT_DpOT0_"}
!311 = !{!312}
!312 = distinct !{!312, !313, !"_ZN3fmt3v1216make_format_argsINS0_7contextEJKiS3_ELi2ELi0ELy17EEENS0_6detail16format_arg_storeIT_XT1_EXT2_EXT3_EEEDpRT0_: argument 0"}
!313 = distinct !{!313, !"_ZN3fmt3v1216make_format_argsINS0_7contextEJKiS3_ELi2ELi0ELy17EEENS0_6detail16format_arg_storeIT_XT1_EXT2_EXT3_EEEDpRT0_"}
!314 = !{!312, !309}
!315 = !{!16, !28, i64 128}
!316 = !{!16, !4, i64 60}
!317 = !{!172, !172, i64 0}
