...
; Function Attrs: mustprogress nofree norecurse nounwind memory(read, inaccessiblemem: write, target_mem: none) uwtable
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.thread8
  ...
  %i.l = getelementptr inbounds nuw [168 x i8], ptr %i.g, i64 %.0611 ; 3 uses
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  %.sroa.04.08 = phi ptr [ %i.e, %.lr.ph ], [ %i.b, %bb.a ] ; 3 uses
...
bb.h:                                             ; preds = %_ZNK22photos_editing_formats8image_io11DataContext17GetBytesAvailableEv.exit
  %i.ax = getelementptr inbounds nuw [168 x i8], ptr %i.ar, i64 %i.an ; 5 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.cj = getelementptr inbounds nuw [168 x i8], ptr %i.cc, i64 %.021101 ; 7 uses
...
attributes #4 = { mustprogress nofree norecurse nounwind memory(read, inaccessiblemem: write, target_mem: none) uwtable "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cmov,+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
