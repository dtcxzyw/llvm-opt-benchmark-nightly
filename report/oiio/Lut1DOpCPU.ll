...
bb.b:                                             ; preds = %.lr.ph, %_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE1EE9CastValueEf.exit36
  ...
  %5 = load float, ptr %4, align 4, !tbaa !230    ; 4 uses
  store float %5, ptr %i.j, align 8, !tbaa !230
  %6 = extractelement <2 x float> %i.n, i64 0     ; 3 uses
  %7 = extractelement <2 x float> %i.n, i64 1     ; 3 uses
  %i.o = fcmp ogt float %6, %7
  %i.p = select i1 %i.o, i64 5, i64 0
  %i.q = fcmp ogt float %7, %5
  %i.r = select i1 %i.q, i64 4, i64 0
  %i.s = fcmp ogt float %6, %5
  ...
  %i.ac = tail call fastcc i64 @_ZN16OpenColorIO_v2_512_GLOBAL__N_19IndexPair18GetEdgeFloatValuesEf(float noundef %6) ; 3 uses
  ...
  %i.ae = tail call fastcc i64 @_ZN16OpenColorIO_v2_512_GLOBAL__N_19IndexPair18GetEdgeFloatValuesEf(float noundef %7) ; 3 uses
  ...
  %i.ag = tail call fastcc i64 @_ZN16OpenColorIO_v2_512_GLOBAL__N_19IndexPair18GetEdgeFloatValuesEf(float noundef %5) ; 3 uses
...
bb.b:                                             ; preds = %.lr.ph, %_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE2EE9CastValueEf.exit36
  ...
  %5 = load float, ptr %4, align 4, !tbaa !230    ; 4 uses
  store float %5, ptr %i.j, align 8, !tbaa !230
  %6 = extractelement <2 x float> %i.o, i64 0     ; 3 uses
  %7 = extractelement <2 x float> %i.o, i64 1     ; 3 uses
  %i.p = fcmp ogt float %6, %7
  %i.q = select i1 %i.p, i64 5, i64 0
  %i.r = fcmp ogt float %7, %5
  %i.s = select i1 %i.r, i64 4, i64 0
  %i.t = fcmp ogt float %6, %5
  ...
  %i.ad = tail call fastcc i64 @_ZN16OpenColorIO_v2_512_GLOBAL__N_19IndexPair18GetEdgeFloatValuesEf(float noundef %6) ; 3 uses
  ...
  %i.af = tail call fastcc i64 @_ZN16OpenColorIO_v2_512_GLOBAL__N_19IndexPair18GetEdgeFloatValuesEf(float noundef %7) ; 3 uses
  ...
  %i.ah = tail call fastcc i64 @_ZN16OpenColorIO_v2_512_GLOBAL__N_19IndexPair18GetEdgeFloatValuesEf(float noundef %5) ; 3 uses
...
bb.b:                                             ; preds = %.lr.ph, %_ZN16OpenColorIO_v2_59ConverterILNS_8BitDepthE7EE9CastValueEf.exit49
  ...
  store <2 x float> %i.o, ptr %i.a, align 8, !tbaa !230
  %4 = getelementptr inbounds nuw i8, ptr %.057, i64 8
  %5 = load float, ptr %4, align 4, !tbaa !230    ; 4 uses
  store float %5, ptr %i.j, align 8, !tbaa !230
  %6 = extractelement <2 x float> %i.o, i64 0     ; 3 uses
  %7 = extractelement <2 x float> %i.o, i64 1     ; 3 uses
...
bb.b:                                             ; preds = %.lr.ph, %._crit_edge42
  ...
  store <2 x float> %i.n, ptr %i.a, align 8, !tbaa !230
  %4 = getelementptr inbounds nuw i8, ptr %.041, i64 8
  %5 = load float, ptr %4, align 4, !tbaa !230    ; 4 uses
  store float %5, ptr %i.j, align 8, !tbaa !230
  %6 = extractelement <2 x float> %i.n, i64 0     ; 3 uses
  %7 = extractelement <2 x float> %i.n, i64 1     ; 3 uses
