...
bb.b:                                             ; preds = %.lr.ph, %bb.b
  ...
  %i.u = fpext float %i.n to double               ; 2 uses
  %i.v = fpext float %i.i to double               ; 3 uses
  %i.w = tail call double @llvm.fmuladd.f64(double %i.u, double -3.440000e-01, double %i.v)
  ...
  %2 = tail call double @llvm.fmuladd.f64(double %i.u, double 1.772000e+00, double %i.v)
...
.ph.lver.orig:                                    ; preds = %.lver.check, %.ph.lver.orig
  ...
  %i.v = fpext float %i.o to double               ; 2 uses
  %i.w = fpext float %i.j to double               ; 3 uses
  %i.x = tail call double @llvm.fmuladd.f64(double %i.v, double -3.440000e-01, double %i.w)
  ...
  %2 = tail call double @llvm.fmuladd.f64(double %i.v, double 1.772000e+00, double %i.w)
  %3 = fptrunc double %2 to float
...
bb.b:                                             ; preds = %.ph, %bb.b
  ...
  %i.bh = fpext float %i.ba to double             ; 2 uses
  %i.bi = fpext float %i.ax to double             ; 3 uses
  %i.bj = tail call double @llvm.fmuladd.f64(double %i.bh, double -3.440000e-01, double %i.bi)
  ...
  %4 = tail call double @llvm.fmuladd.f64(double %i.bh, double 1.772000e+00, double %i.bi)
