begin_hunk_0_@jpeg_consume_input:bb.a
  ...
  tail call void %i.ah(ptr noundef nonnull %0, i32 noundef -1) #3, !inline_history !60
...
bb.m:                                             ; preds = %bb.h
  ...
  %i.al = load i32, ptr %i.ak, align 8, !tbaa !62 ; 3 uses
  %i.am = getelementptr inbounds nuw i8, ptr %i.ak, i64 96
  %i.an = load i32, ptr %i.am, align 8, !tbaa !62 ; 3 uses
  %i.ao = getelementptr inbounds nuw i8, ptr %i.ak, i64 192
  %i.ap = load i32, ptr %i.ao, align 8, !tbaa !62 ; 3 uses
...
begin_hunk_10_@jpeg_finish_decompress:bb.a
  ...
  br i1 %i.ab, label %.loopexit, label %bb.j, !llvm.loop !77
