...
begin_hunk_0_@alloc_sarray:bb.a
  ...
  %4 = shl nuw nsw i64 %i.q, %i.r                 ; 2 uses
  %5 = udiv i64 999999976, %4
  %i.s = icmp samesign ugt i64 %4, 999999976
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %i.w = zext i32 %3 to i64                       ; 3 uses
  %.0104120 = tail call i64 @llvm.umin.i64(i64 %5, i64 %i.w)
  %.0104 = trunc nuw nsw i64 %.0104120 to i32     ; 4 uses
...
.lr.ph48:                                         ; preds = %bb.c, %.loopexit
  %.03647 = phi i32 [ %.1.lcssa, %.loopexit ], [ 0, %bb.c ] ; 4 uses
  %.13846 = phi i32 [ %i.n, %.loopexit ], [ %.037, %bb.c ]
...
bb.x:                                             ; preds = %bb.w, %bb.v
  ...
  %1 = shl nuw nsw i64 %i.dw, 7                   ; 2 uses
  %2 = udiv i64 999999976, %1
...
bb.z:                                             ; preds = %bb.y, %bb.x
  %i.eb = zext i32 %i.ds to i64                   ; 2 uses
  %.03741.i = tail call i64 @llvm.umin.i64(i64 %2, i64 %i.eb)
...
bb.ab:                                            ; preds = %bb.aa, %.lr.ph48.i
  ...
  %i.es = icmp ugt i64 %i.er, 1000000000
