...
.lr.ph137:                                        ; preds = %bb.d
  ...
  %wide.trip.count157 = zext nneg i32 %i.d to i64 ; 7 uses
  %invariant.gep168.a = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.ce ; 5 uses
  %i.cf = add nsw i64 %wide.trip.count157, -1     ; 2 uses
  %min.iters.check236 = icmp ult i32 %i.d, 14
  br i1 %min.iters.check236, label %scalar.ph235.preheader, label %vector.scevcheck

vector.scevcheck:                                 ; preds = %.lr.ph137
  %4 = add nsw i64 %wide.trip.count157, -2        ; 2 uses
  %5 = trunc i64 %4 to i32
  %6 = add i32 %i.c, %5
  %7 = icmp slt i32 %6, %i.c
  %8 = icmp ugt i64 %4, 4294967295
  %9 = or i1 %7, %8
  br i1 %9, label %scalar.ph235.preheader, label %vector.memcheck228

vector.memcheck228:                               ; preds = %vector.scevcheck
...
vector.body239:                                   ; preds = %vector.body239, %vector.ph237
  ...
  %10 = trunc i64 %i.cn to i32
  %11 = add i32 %i.f, %10
  %12 = sext i32 %11 to i64
  %i.ct = getelementptr inbounds [4 x i8], ptr %1, i64 %12 ; 2 uses
...
scalar.ph235.preheader:                           ; preds = %vector.body239, %vector.memcheck228, %vector.scevcheck, %.lr.ph137
  %indvars.iv154.ph = phi i64 [ 1, %vector.memcheck228 ], [ 1, %vector.scevcheck ], [ 1, %.lr.ph137 ], [ %i.cm, %vector.body239 ] ; 8 uses
...
scalar.ph235.prol:                                ; preds = %scalar.ph235.preheader
  ...
  %13 = trunc i64 %indvars.iv154.ph to i32
  %14 = add i32 %i.f, %13
  %15 = sext i32 %14 to i64
  %i.dl = getelementptr inbounds [4 x i8], ptr %1, i64 %15
...
scalar.ph235:                                     ; preds = %scalar.ph235.prol.loopexit, %scalar.ph235
  ...
  %i.dx = getelementptr inbounds [4 x i8], ptr %1, i64 %18
  ...
  %19 = trunc i64 %indvars.iv.next155 to i32
  %20 = add i32 %i.f, %19
  %21 = sext i32 %20 to i64
  %i.eh = getelementptr inbounds [4 x i8], ptr %1, i64 %21
...
opj_dwt_get_band_coordinates.exit206.i:           ; preds = %bb.z, %bb.y, %bb.x
  ...
  %i.kh = load i32, ptr %i.kg, align 8, !tbaa !145 ; 5 uses
...
.lr.ph.i14:                                       ; preds = %bb.ab
  ...
  %i.on = shl nsw i64 %11, 2                      ; 2 uses
  %scevgep101 = getelementptr i8, ptr %scevgep100.a, i64 %i.on
  %i.oo = getelementptr i8, ptr %scevgep102.a, i64 %i.ol
  %scevgep103 = getelementptr i8, ptr %i.oo, i64 %i.on
  ...
  %min.iters.check112 = icmp ult i32 %i.ou, 12
  %mul.overflow = icmp slt i32 %8, 0
  %12 = add i32 %i.kv, %8
  %13 = shl i32 %12, 1
...
.lr.ph219.i.i.preheader:                          ; preds = %bb.am
  %brmerge = select i1 %min.iters.check112, i1 true, i1 %15
...
.lr.ph219.i.i.preheader128:                       ; preds = %.lr.ph219.i.i.preheader, %vector.body115
  %indvars.iv233.i.i.ph.a = phi i64 [ %i.nv, %.lr.ph219.i.i.preheader ], [ %i.pa, %vector.body115 ] ; 5 uses
  %.0150.in217.i.i.ph = phi i32 [ %i.kv, %.lr.ph219.i.i.preheader ], [ %17, %vector.body115 ] ; 2 uses
  %i.st = trunc i64 %indvars.iv233.i.i.ph.a to i32 ; 2 uses
...
.lr.ph219.i.i.prol:                               ; preds = %.lr.ph219.i.i.preheader128
  %18 = shl nsw i32 %.0150.in217.i.i.ph, 1
  %19 = sext i32 %18 to i64
  %20 = getelementptr [4 x i8], ptr %i.hg, i64 %19
  %i.sv = getelementptr i8, ptr %20, i64 4
  %i.sw = load i32, ptr %i.sv, align 4, !tbaa !3
  %.idx256.i.i.prol = shl nsw i64 %indvars.iv233.i.i.ph.a, 3
  ...
  %indvars.iv.next234.i.i.prol = add nsw i64 %indvars.iv233.i.i.ph.a, 1
  %21 = trunc nsw i64 %indvars.iv233.i.i.ph.a to i32
  br label %.lr.ph219.i.i.prol.loopexit

.lr.ph219.i.i.prol.loopexit:                      ; preds = %.lr.ph219.i.i.prol, %.lr.ph219.i.i.preheader128
  %indvars.iv233.i.i.unr.a = phi i64 [ %indvars.iv233.i.i.ph.a, %.lr.ph219.i.i.preheader128 ], [ %indvars.iv.next234.i.i.prol, %.lr.ph219.i.i.prol ]
  %.0150.in217.i.i.unr = phi i32 [ %.0150.in217.i.i.ph, %.lr.ph219.i.i.preheader128 ], [ %21, %.lr.ph219.i.i.prol ]
...
vector.body115:                                   ; preds = %.lr.ph219.i.i.preheader, %vector.body115
  ...
  %i.tg = add i64 %index116, %i.nv                ; 4 uses
  %22 = trunc i64 %index116 to i32
  %23 = add i32 %i.kv, %22
  %24 = shl nsw i32 %23, 1
  %25 = sext i32 %24 to i64
  %26 = getelementptr [4 x i8], ptr %i.hg, i64 %25
  %i.th = getelementptr i8, ptr %26, i64 4
...
.lr.ph219.i.i:                                    ; preds = %.lr.ph219.i.i.prol.loopexit, %.lr.ph219.i.i
  %indvars.iv233.i.i.a = phi i64 [ %indvars.iv.next234.i.i.1, %.lr.ph219.i.i ], [ %indvars.iv233.i.i.unr.a, %.lr.ph219.i.i.prol.loopexit ] ; 4 uses
  %.0150.in217.i.i = phi i32 [ %35, %.lr.ph219.i.i ], [ %.0150.in217.i.i.unr, %.lr.ph219.i.i.prol.loopexit ]
  %27 = shl nsw i32 %.0150.in217.i.i, 1
  %28 = sext i32 %27 to i64
  %29 = getelementptr [4 x i8], ptr %i.hg, i64 %28
  %i.ue = getelementptr i8, ptr %29, i64 4
  %i.uf = load i32, ptr %i.ue, align 4, !tbaa !3
  %.idx256.i.i = shl i64 %indvars.iv233.i.i.a, 3
  ...
  %indvars.iv.next234.i.i = add nsw i64 %indvars.iv233.i.i.a, 1 ; 2 uses
  %30 = trunc nsw i64 %indvars.iv233.i.i.a to i32
  %31 = shl nsw i32 %30, 1
  %32 = sext i32 %31 to i64
  %33 = getelementptr [4 x i8], ptr %i.hg, i64 %32
  %i.uo = getelementptr i8, ptr %33, i64 4
  %34 = load i32, ptr %i.uo, align 4, !tbaa !3
  %.idx256.i.i.1 = shl i64 %indvars.iv.next234.i.i, 3
  %i.up = getelementptr i8, ptr %i.hg, i64 %.idx256.i.i.1 ; 3 uses
  ...
  %indvars.iv.next234.i.i.1 = add nsw i64 %indvars.iv233.i.i.a, 2 ; 2 uses
  %35 = trunc nsw i64 %indvars.iv.next234.i.i to i32
