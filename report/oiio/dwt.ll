...
begin_hunk_0_@opj_dwt_encode_and_deinterleave_h_one_row_real:bb.a
  ...
  %i.adx = load float, ptr %i.adt, align 4, !tbaa !188
  %i.ady = load float, ptr %i.adu, align 4, !tbaa !188
  %i.adz = load float, ptr %i.adv, align 4, !tbaa !188
  %i.aea = load float, ptr %i.adw, align 4, !tbaa !188
  ...
  store float %i.aeg, ptr %i.adt, align 4, !tbaa !188
  %i.aeh = extractelement <4 x float> %i.aef, i64 1
  store float %i.aeh, ptr %i.adu, align 4, !tbaa !188
  %i.aei = extractelement <4 x float> %i.aef, i64 2
  store float %i.aei, ptr %i.adv, align 4, !tbaa !188
  %i.aej = extractelement <4 x float> %i.aef, i64 3
  store float %i.aej, ptr %i.adw, align 4, !tbaa !188
  ...
  %i.aeo = load float, ptr %i.aek, align 4, !tbaa !188
  %i.aep = load float, ptr %i.ael, align 4, !tbaa !188
  %i.aeq = load float, ptr %i.aem, align 4, !tbaa !188
  %i.aer = load float, ptr %i.aen, align 4, !tbaa !188
  ...
  %i.afb = load float, ptr %i.aex, align 4, !tbaa !188
  %i.afc = load float, ptr %i.aey, align 4, !tbaa !188
  %i.afd = load float, ptr %i.aez, align 4, !tbaa !188
  %i.afe = load float, ptr %i.afa, align 4, !tbaa !188
  ...
  store float %i.afk, ptr %i.aex, align 4, !tbaa !188
  %i.afl = extractelement <4 x float> %i.afj, i64 1
  store float %i.afl, ptr %i.aey, align 4, !tbaa !188
  %i.afm = extractelement <4 x float> %i.afj, i64 2
  store float %i.afm, ptr %i.aez, align 4, !tbaa !188
  %i.afn = extractelement <4 x float> %i.afj, i64 3
  store float %i.afn, ptr %i.afa, align 4, !tbaa !188
  %index.next172 = add nuw i64 %index167, 4       ; 2 uses
  %i.afo = icmp eq i64 %index.next172, %n.vec165
  br i1 %i.afo, label %.lr.ph.i82.i.preheader276, label %vector.body166, !llvm.loop !201
...
vector.body181:                                   ; preds = %vector.body181, %vector.ph178
  ...
  %wide.vec187 = load <8 x float>, ptr %i.agh, align 4, !tbaa !188
  ...
  %wide.vec189 = load <8 x float>, ptr %i.agi, align 4, !tbaa !188 ; 2 uses
  ...
  store float %i.agp, ptr %i.agk, align 4, !tbaa !188
  %i.agq = extractelement <4 x float> %i.ago, i64 1
  store float %i.agq, ptr %i.agl, align 4, !tbaa !188
  %i.agr = extractelement <4 x float> %i.ago, i64 2
  store float %i.agr, ptr %i.agm, align 4, !tbaa !188
  %i.ags = extractelement <4 x float> %i.ago, i64 3
  store float %i.ags, ptr %i.agn, align 4, !tbaa !188
  %index.next192 = add nuw i64 %index182, 4       ; 2 uses
  %i.agt = icmp eq i64 %index.next192, %n.vec180
  br i1 %i.agt, label %.lr.ph48.i78.i.preheader274, label %vector.body181, !llvm.loop !202
...
.lr.ph.i82.i:                                     ; preds = %.lr.ph.i82.i.preheader276, %.lr.ph.i82.i
  ...
  br i1 %i.ahw, label %.lr.ph.i82.i, label %.preheader.loopexit.i85.i, !llvm.loop !203
...
.lr.ph48.i78.i:                                   ; preds = %.lr.ph48.i78.i.preheader274, %.lr.ph48.i78.i
  ...
  %i.ahy = load float, ptr %i.ahx, align 4, !tbaa !188
  %i.ahz = load float, ptr %.147.i79.i, align 4, !tbaa !188
  %i.aia = fadd float %i.ahy, %i.ahz
  %i.aib = getelementptr inbounds i8, ptr %.147.i79.i, i64 -4 ; 2 uses
  %i.aic = load float, ptr %i.aib, align 4, !tbaa !188
  %i.aid = tail call float @llvm.fmuladd.f32(float %i.aia, float f0x3EE31355, float %i.aic)
  store float %i.aid, ptr %i.aib, align 4, !tbaa !188
...
vector.body216:                                   ; preds = %vector.body216, %vector.ph213
  ...
  br i1 %i.ajk, label %middle.block224, label %vector.body216, !llvm.loop !205
...
.lr.ph38.i.i:                                     ; preds = %.lr.ph38.i.i.preheader269, %.lr.ph38.i.i
  ...
  %i.ajx = load <2 x float>, ptr %.137.i.i, align 4, !tbaa !188
  %i.ajy = fmul <2 x float> %i.ajx, <float f0x3F5019C3, float f0x3F9D7658>
  store <2 x float> %i.ajy, ptr %.137.i.i, align 4, !tbaa !188
...
bb.l:                                             ; preds = %._crit_edge.i.i
  %i.akc = load float, ptr %.1.lcssa.i.i, align 4, !tbaa !188
  %i.akd = fmul float %i.akc, f0x3F5019C3
  store float %i.akd, ptr %.1.lcssa.i.i, align 4, !tbaa !188
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.akg = load float, ptr %i.akf, align 4, !tbaa !188
  %i.akh = fmul float %i.akg, f0x3F9D7658
  store float %i.akh, ptr %i.akf, align 4, !tbaa !188
