...
vector.body:                                      ; preds = %vector.scevcheck, %vector.body
  ...
  %wide.load373 = load <4 x i32>, ptr %i.ao, align 4, !tbaa !3
...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  ...
  %.lcssa378.unr = phi i32 [ poison, %scalar.ph.preheader ], [ %i.au, %scalar.ph.prol ]
...
.lr.ph37.us.i:                                    ; preds = %..preheader31_crit_edge.us.i
  ...
  %i.co = add nuw i32 %i.cn, %.lcssa371
...
.lr.ph.i.epil.preheader:                          ; preds = %opj_dwt_fetch_cols_vertical_pass.exit.loopexit.unr-lcssa, %.lr.ph.preheader.i
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(32) %i.dr, ptr noundef nonnull readonly align 4 dereferenceable(32) %i.du, i64 32, i1 false)
...
.preheader32.i.epil:                              ; preds = %.preheader32.i.epil, %.preheader32.i.epil.preheader
  ...
  %i.dv = shl nuw nsw i64 %indvars.iv59.i.epil, 5
  %i.dw = and i64 %i.dv, 17179869152
  %scevgep55.i.epil = getelementptr nuw i8, ptr %1, i64 %i.dw
...
opj_dwt_fetch_cols_vertical_pass.exit:            ; preds = %._crit_edge.us.i, %opj_dwt_fetch_cols_vertical_pass.exit.loopexit375.unr-lcssa, %.preheader32.i.epil, %.lr.ph.i.epil.preheader, %opj_dwt_fetch_cols_vertical_pass.exit.loopexit.unr-lcssa
  %i.dx = icmp eq i32 %2, 1
  br i1 %i.dx, label %bb.b, label %opj_dwt_fetch_cols_vertical_pass.exit.thread
...
.preheader273.preheader:                          ; preds = %bb.b
  %i.dy = load <4 x i32>, ptr %1, align 4, !tbaa !3
  %i.dz = shl nsw <4 x i32> %i.dy, splat (i32 1)
  store <4 x i32> %i.dz, ptr %1, align 4, !tbaa !3
  %i.ea = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  %i.eb = load <4 x i32>, ptr %i.ea, align 4, !tbaa !3
  %i.ec = shl nsw <4 x i32> %i.eb, splat (i32 1)
  store <4 x i32> %i.ec, ptr %i.ea, align 4, !tbaa !3
  br label %.loopexit
...
.preheader272.preheader:                          ; preds = %opj_dwt_fetch_cols_vertical_pass.exit.thread
  ...
  %i.ef = load <4 x i32>, ptr %1, align 4, !tbaa !3
  %i.eg = sub nsw <4 x i32> %i.ef, %i.ee
  store <4 x i32> %i.eg, ptr %1, align 4, !tbaa !3
  %i.eh = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 3 uses
  %i.ei = getelementptr inbounds nuw i8, ptr %1, i64 48
  %i.ej = load <4 x i32>, ptr %i.ei, align 4, !tbaa !3
  %i.ek = load <4 x i32>, ptr %i.eh, align 4, !tbaa !3
  %i.el = sub nsw <4 x i32> %i.ek, %i.ej
  store <4 x i32> %i.el, ptr %i.eh, align 4, !tbaa !3
  %i.em = icmp ugt i32 %i.d, 3
  br i1 %i.em, label %.lr.ph.preheader, label %bb.i

bb.c:                                             ; preds = %opj_dwt_fetch_cols_vertical_pass.exit.thread
  %i.en = icmp ugt i32 %i.d, 3
  br i1 %i.en, label %.lr.ph291.preheader, label %bb.d

.lr.ph291.preheader:                              ; preds = %bb.c
  %i.eo = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.ep = load <2 x i64>, ptr %i.eo, align 16, !tbaa !62
  %i.eq = load <2 x i64>, ptr %1, align 16, !tbaa !62
  %umax336 = tail call i32 @llvm.umax.i32(i32 %i.e, i32 2)
  %i.er = add nsw i32 %umax336, -1
  %wide.trip.count337 = zext nneg i32 %i.er to i64
  br label %.lr.ph291
...
.lr.ph291:                                        ; preds = %.lr.ph291.preheader, %.lr.ph291
  ...
  %.0215288 = phi <2 x i64> [ %i.eq, %.lr.ph291.preheader ], [ %i.ev, %.lr.ph291 ]
  %.0216287 = phi <2 x i64> [ %i.ep, %.lr.ph291.preheader ], [ %i.ex, %.lr.ph291 ]
  %i.es = shl i64 %indvars.iv329, 4
  %i.et = and i64 %i.es, 4294967280
  %i.eu = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.et ; 2 uses
  %i.ev = load <2 x i64>, ptr %i.eu, align 16, !tbaa !62 ; 2 uses
  %i.ew = getelementptr inbounds nuw i8, ptr %i.eu, i64 16
  %i.ex = load <2 x i64>, ptr %i.ew, align 16, !tbaa !62 ; 2 uses
  %i.ey = shl i64 %indvars.iv331, 4
  %i.ez = and i64 %i.ey, 4294967280
  %i.fa = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.ez ; 2 uses
  %i.fb = getelementptr inbounds nuw i8, ptr %i.fa, i64 32 ; 2 uses
  %i.fc = load <4 x i32>, ptr %i.fb, align 16, !tbaa !62
  %i.fd = getelementptr inbounds nuw i8, ptr %i.fa, i64 48 ; 2 uses
  %i.fe = load <4 x i32>, ptr %i.fd, align 16, !tbaa !62
  %i.ff = bitcast <2 x i64> %.0215288 to <4 x i32>
  %i.fg = bitcast <2 x i64> %i.ev to <4 x i32>
  %i.fh = add <4 x i32> %i.fg, %i.ff
  %i.fi = ashr <4 x i32> %i.fh, splat (i32 1)
  %i.fj = sub <4 x i32> %i.fc, %i.fi
  %i.fk = bitcast <2 x i64> %.0216287 to <4 x i32>
  %i.fl = bitcast <2 x i64> %i.ex to <4 x i32>
  %i.fm = add <4 x i32> %i.fl, %i.fk
  %i.fn = ashr <4 x i32> %i.fm, splat (i32 1)
  %i.fo = sub <4 x i32> %i.fe, %i.fn
  store <4 x i32> %i.fj, ptr %i.fb, align 16, !tbaa !62
  store <4 x i32> %i.fo, ptr %i.fd, align 16, !tbaa !62
...
scalar.ph.prol.loopexit:                          ; preds = %scalar.ph.prol, %scalar.ph.preheader
  ...
  %.lcssa176.unr = phi i32 [ poison, %scalar.ph.preheader ], [ %i.av, %scalar.ph.prol ]
  %indvars.iv.i.unr = phi i64 [ %indvars.iv.i.ph, %scalar.ph.preheader ], [ %indvars.iv.next.i.prol, %scalar.ph.prol ]
...
opj_dwt_fetch_cols_vertical_pass.exit:            ; preds = %._crit_edge.us.i, %opj_dwt_fetch_cols_vertical_pass.exit.loopexit173.unr-lcssa, %.preheader32.i.epil, %.lr.ph.i.epil.preheader, %opj_dwt_fetch_cols_vertical_pass.exit.loopexit.unr-lcssa, %.preheader33.i, %.preheader.i
  ...
  %i.dx = select i1 %.not, i64 0, i64 8
  %i.dy = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.dx ; 17 uses
  %i.dz = select i1 %.not, i64 8, i64 0
  %i.ea = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.dz ; 17 uses
  %i.eb = getelementptr inbounds nuw i8, ptr %i.ea, i64 32 ; 6 uses
  %i.ec = add nsw i32 %i.e, %.68.neg
  %i.ed = tail call noundef i32 @llvm.smin.i32(i32 %i.f, i32 %i.ec) ; 2 uses
  %i.ee = tail call noundef i32 @llvm.umin.i32(i32 %i.f, i32 %i.ed) ; 5 uses
  %.not.i = icmp eq i32 %i.ee, 0                  ; 2 uses
  br i1 %.not.i, label %.loopexit.i, label %bb.c

bb.c:                                             ; preds = %opj_dwt_fetch_cols_vertical_pass.exit
  %i.ef = load <4 x float>, ptr %i.ea, align 16, !tbaa !62
  %i.eg = load <4 x float>, ptr %i.dy, align 16, !tbaa !62
  %i.eh = load <4 x float>, ptr %i.eb, align 16, !tbaa !62
  %i.ei = fadd <4 x float> %i.eg, %i.eh
  %i.ej = fmul <4 x float> %i.ei, splat (float f0x3FCB0673)
  %i.ek = fsub <4 x float> %i.ef, %i.ej
  store <4 x float> %i.ek, ptr %i.ea, align 16, !tbaa !62
  %i.el = getelementptr inbounds nuw i8, ptr %i.ea, i64 16 ; 2 uses
  %i.em = load <4 x float>, ptr %i.el, align 16, !tbaa !62
  %i.en = getelementptr inbounds nuw i8, ptr %i.dy, i64 16
  %i.eo = load <4 x float>, ptr %i.en, align 16, !tbaa !62
  %i.ep = getelementptr inbounds nuw i8, ptr %i.ea, i64 48
  %i.eq = load <4 x float>, ptr %i.ep, align 16, !tbaa !62
  %i.er = fadd <4 x float> %i.eo, %i.eq
  %i.es = fmul <4 x float> %i.er, splat (float f0x3FCB0673)
  %i.et = fsub <4 x float> %i.em, %i.es
  store <4 x float> %i.et, ptr %i.el, align 16, !tbaa !62
  %.04244.i = getelementptr inbounds nuw i8, ptr %i.ea, i64 96 ; 2 uses
  %.not48.i = icmp eq i32 %i.ee, 1
...
.lr.ph.i69:                                       ; preds = %bb.c, %.lr.ph.i69
  ...
  %.046.i = phi i32 [ %i.fk, %.lr.ph.i69 ], [ 1, %bb.c ]
  %.pn45.i = phi ptr [ %.04247.i, %.lr.ph.i69 ], [ %i.eb, %bb.c ] ; 5 uses
  %i.eu = getelementptr inbounds nuw i8, ptr %.pn45.i, i64 32 ; 2 uses
  %i.ev = load <4 x float>, ptr %i.eu, align 16, !tbaa !62
  %i.ew = load <4 x float>, ptr %.pn45.i, align 16, !tbaa !62
  %i.ex = load <4 x float>, ptr %.04247.i, align 16, !tbaa !62
  %i.ey = fadd <4 x float> %i.ew, %i.ex
  %i.ez = fmul <4 x float> %i.ey, splat (float f0x3FCB0673)
  %i.fa = fsub <4 x float> %i.ev, %i.ez
  store <4 x float> %i.fa, ptr %i.eu, align 16, !tbaa !62
  %i.fb = getelementptr inbounds nuw i8, ptr %.pn45.i, i64 48 ; 2 uses
  %i.fc = load <4 x float>, ptr %i.fb, align 16, !tbaa !62
  %i.fd = getelementptr inbounds nuw i8, ptr %.pn45.i, i64 16
  %i.fe = load <4 x float>, ptr %i.fd, align 16, !tbaa !62
  %i.ff = getelementptr inbounds nuw i8, ptr %.pn45.i, i64 80
  %i.fg = load <4 x float>, ptr %i.ff, align 16, !tbaa !62
  %i.fh = fadd <4 x float> %i.fe, %i.fg
  %i.fi = fmul <4 x float> %i.fh, splat (float f0x3FCB0673)
  %i.fj = fsub <4 x float> %i.fc, %i.fi
  store <4 x float> %i.fj, ptr %i.fb, align 16, !tbaa !62
  %i.fk = add nuw i32 %.046.i, 1                  ; 2 uses
  %.042.i = getelementptr inbounds nuw i8, ptr %.04247.i, i64 64 ; 2 uses
  %exitcond.not.i70 = icmp eq i32 %i.fk, %i.ee
...
.loopexit.i:                                      ; preds = %.lr.ph.i69, %bb.c, %opj_dwt_fetch_cols_vertical_pass.exit
  %.1.i = phi ptr [ %i.eb, %opj_dwt_fetch_cols_vertical_pass.exit ], [ %.04244.i, %bb.c ], [ %.042.i, %.lr.ph.i69 ] ; 4 uses
  %i.fl = icmp ult i32 %i.ed, %i.f                ; 2 uses
  br i1 %i.fl, label %bb.d, label %opj_v8dwt_encode_step2.exit

bb.d:                                             ; preds = %.loopexit.i
  %i.fm = getelementptr inbounds i8, ptr %.1.i, i64 -32 ; 2 uses
  %i.fn = load <4 x float>, ptr %i.fm, align 16, !tbaa !62
  %i.fo = getelementptr inbounds i8, ptr %.1.i, i64 -64
  %i.fp = load <4 x float>, ptr %i.fo, align 16, !tbaa !62
  %i.fq = fmul <4 x float> %i.fp, splat (float f0x404B0673)
  %i.fr = fsub <4 x float> %i.fn, %i.fq
  store <4 x float> %i.fr, ptr %i.fm, align 16, !tbaa !62
  %i.fs = getelementptr inbounds i8, ptr %.1.i, i64 -16 ; 2 uses
  %i.ft = load <4 x float>, ptr %i.fs, align 16, !tbaa !62
  %i.fu = getelementptr inbounds i8, ptr %.1.i, i64 -48
  %i.fv = load <4 x float>, ptr %i.fu, align 16, !tbaa !62
  %i.fw = fmul <4 x float> %i.fv, splat (float f0x404B0673)
  %i.fx = fsub <4 x float> %i.ft, %i.fw
  store <4 x float> %i.fx, ptr %i.fs, align 16, !tbaa !62
  br label %opj_v8dwt_encode_step2.exit

opj_v8dwt_encode_step2.exit:                      ; preds = %.loopexit.i, %bb.d
  %i.fy = getelementptr inbounds nuw i8, ptr %i.dy, i64 32 ; 6 uses
end_hunk_1
