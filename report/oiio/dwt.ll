...
.lr.ph.i14:                                       ; preds = %bb.ab
  ...
  %5 = tail call i32 @llvm.umin.i32(i32 %i.ka, i32 %i.kh)
  %umin111 = tail call i32 @llvm.umin.i32(i32 %i.kn, i32 2)
  %i.ow = add i32 %spec.select.i209.i, %5
  %6 = add i32 %i.ow, %umin111
  %7 = sub i32 %6, %i.ka
  %8 = add i32 %7, -2                             ; 2 uses
  %i.ox = zext i32 %8 to i64
  %i.oy = add nuw nsw i64 %i.ox, 1                ; 2 uses
  %min.iters.check114 = icmp ult i32 %8, 12
  ...
  %10 = tail call i64 @llvm.smax.i64(i64 %i.nz, i64 %9)
  %11 = sub i64 %10, %i.nf                        ; 3 uses
  %min.iters.check = icmp ult i64 %11, 5
  %n.mod.vf = and i64 %11, 3                      ; 2 uses
  %i.pi = icmp eq i64 %n.mod.vf, 0
  %i.pj = select i1 %i.pi, i64 4, i64 %n.mod.vf
  %n.vec = sub i64 %11, %i.pj                     ; 2 uses
