...
bb.o:                                             ; preds = %.loopexit
  ...
  %.pn70.pn.1.i257 = select i1 %.not, i64 8, i64 0
...
.lr.ph.preheader.i246:                            ; preds = %bb.o
  %.pn70.pn.i247 = select i1 %.not, i64 0, i64 8
...
begin_hunk_6_@opj_dwt_encode_and_deinterleave_v_real:bb.a
  ...
  %i.eb = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.ea ; 20 uses
  %i.ec = select i1 %.not, i64 8, i64 0
  %i.ed = getelementptr inbounds nuw [4 x i8], ptr %1, i64 %i.ec ; 20 uses
...
.lr.ph.i118.prol:                                 ; preds = %.lr.ph.i118.preheader, %.lr.ph.i118.prol
  ...
  %.15469.i.prol = phi ptr [ %i.mv, %.lr.ph.i118.prol ], [ %i.eb, %.lr.ph.i118.preheader ] ; 2 uses
...
.lr.ph.i118.prol.loopexit:                        ; preds = %.lr.ph.i118.prol, %.lr.ph.i118.preheader
  ...
  %.15469.i.unr = phi ptr [ %i.eb, %.lr.ph.i118.preheader ], [ %i.mv, %.lr.ph.i118.prol ]
...
.lr.ph.1.i.prol:                                  ; preds = %.lr.ph.preheader.1.i, %.lr.ph.1.i.prol
  ...
  %.15469.1.i.prol = phi ptr [ %i.nn, %.lr.ph.1.i.prol ], [ %i.ed, %.lr.ph.preheader.1.i ] ; 2 uses
...
.lr.ph.1.i.prol.loopexit:                         ; preds = %.lr.ph.1.i.prol, %.lr.ph.preheader.1.i
  ...
  %.15469.1.i.unr = phi ptr [ %i.ed, %.lr.ph.preheader.1.i ], [ %i.nn, %.lr.ph.1.i.prol ]
...
.lr.ph.i125:                                      ; preds = %opj_v8dwt_encode_step1.exit115.thread, %bb.s
  ...
  %.15469.i127 = phi ptr [ %i.pg, %bb.s ], [ %i.eb, %opj_v8dwt_encode_step1.exit115.thread ] ; 8 uses
...
.lr.ph.1.i135:                                    ; preds = %bb.ab, %.lr.ph.preheader.1.i132
  ...
  %.15469.1.i137 = phi ptr [ %i.qr, %bb.ab ], [ %i.ed, %.lr.ph.preheader.1.i132 ] ; 9 uses
