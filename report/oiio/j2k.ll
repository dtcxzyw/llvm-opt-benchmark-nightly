...
opj_get_tile_dimensions.exit.i:                   ; preds = %.loopexit.i, %opj_get_tile_dimensions.exit.lr.ph.i
  ...
  %i.eo = load i32, ptr %i.en, align 8, !tbaa !359 ; 17 uses
  %i.ep = load i32, ptr %i.ec, align 8, !tbaa !360 ; 18 uses
