...
bb.u:                                             ; preds = %.lr.ph, %.backedge
  %i.an = phi i32 [ %.pr, %.lr.ph ], [ %i.ar, %.backedge ] ; 5 uses
...
..loopexit5.loopexit_crit_edge:                   ; preds = %bb.v
  %.lcssa = phi i32 [ %i.an, %bb.v ]
  %.lcssa15 = phi i32 [ %i.an, %bb.v ]            ; 0 uses
  br label %.loopexit5.loopexit

.loopexit5.loopexit:                              ; preds = %.loopexit5.loopexitsplit, %..loopexit5.loopexit_crit_edge
  %.ph = phi i32 [ %.lcssa, %..loopexit5.loopexit_crit_edge ], [ %.lcssa14, %.loopexit5.loopexitsplit ]
  br label %.loopexit5
...
begin_hunk_3_@j2k_get_cstr_index:bb.a
  ...
  %exitcond150.not = icmp eq i64 %lsr.iv.lcssa, %lsr.iv.next240
...
.preheader121:                                    ; preds = %bb.n
  %lsr.iv.lcssa238 = phi i64 [ %lsr.iv, %bb.n ]
...
begin_hunk_5_@j2k_get_cstr_index:bb.a
  ...
  %exitcond.not = icmp eq i64 %lsr.iv.lcssa238, %lsr.iv.next234
