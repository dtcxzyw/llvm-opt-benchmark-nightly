...
bb.ax:                                            ; preds = %bb.aw, %bb.av
  ...
  br i1 %niter.ncmp.1, label %._crit_edge293.loopexit.unr-lcssa, label %bb.at, !llvm.loop !434
...
bb.ba:                                            ; preds = %.lr.ph297
  ...
  br i1 %i.jh, label %.lr.ph297, label %._crit_edge298, !llvm.loop !435
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.j = load i32, ptr %i.i, align 8, !tbaa !413
...
bb.e:                                             ; preds = %bb.d
  store i32 1, ptr %i.i, align 8, !tbaa !413
...
bb.i:                                             ; preds = %bb.h
  %i.z = load i32, ptr %i.e, align 8, !tbaa !410  ; 2 uses
  %i.aa = xor i32 %i.w, -1
...
.lr.ph:                                           ; preds = %bb.l
  store ptr %i.aj, ptr %i.af, align 8, !tbaa !414
  ...
  %umax83 = call i32 @llvm.umax.i32(i32 %i.w, i32 1) ; 2 uses
...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %bb.n
  ...
  %.05976.us = phi i32 [ %i.bc, %bb.n ], [ 0, %.lr.ph.split.us.preheader ]
  %.06175.us = phi ptr [ %i.au, %bb.n ], [ %i.l, %.lr.ph.split.us.preheader ] ; 2 uses
...
bb.n:                                             ; preds = %.lr.ph.split.us
  ...
  %i.au = getelementptr inbounds nuw i8, ptr %.06175.us, i64 %i.ap
  %i.av = trunc i32 %i.aq to i16
  %i.aw = load i32, ptr %i.e, align 8, !tbaa !410 ; 2 uses
  %i.ax = zext i32 %i.aw to i64
  %i.ay = getelementptr inbounds nuw [8 x i8], ptr %i.aj, i64 %i.ax ; 2 uses
  store i16 %i.av, ptr %i.ay, align 4, !tbaa !415
  %i.az = load i32, ptr %i.d, align 4, !tbaa !3
  %i.ba = getelementptr inbounds nuw i8, ptr %i.ay, i64 4
  store i32 %i.az, ptr %i.ba, align 4, !tbaa !421
  %i.bb = add i32 %i.aw, 1                        ; 2 uses
  store i32 %i.bb, ptr %i.e, align 8, !tbaa !410
...
bb.o:                                             ; preds = %.lr.ph.split
  %i.bi = getelementptr inbounds nuw i8, ptr %.06175, i64 %i.am ; 2 uses
  ...
  %i.bm = load i32, ptr %i.e, align 8, !tbaa !410 ; 2 uses
  %i.bn = zext i32 %i.bm to i64
  %i.bo = getelementptr inbounds nuw [8 x i8], ptr %i.aj, i64 %i.bn ; 2 uses
  store i16 %i.bl, ptr %i.bo, align 4, !tbaa !415
  %i.bp = load i32, ptr %i.d, align 4, !tbaa !3
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bo, i64 4
  store i32 %i.bp, ptr %i.bq, align 4, !tbaa !421
  %i.br = add i32 %i.bm, 1
  store i32 %i.br, ptr %i.e, align 8, !tbaa !410
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #21
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #21
  %i.bs = add nuw nsw i32 %.05976, 1              ; 2 uses
  %exitcond.not = icmp eq i32 %i.bs, %umax83
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %.not47, label %.thread50, label %bb.h
...
bb.h:                                             ; preds = %bb.g
  ...
  call void @llvm.memset.p0.i64(ptr nonnull align 8 %i.ab, i8 0, i64 %i.ae, i1 false)
  store i32 %i.u, ptr %i.r, align 8, !tbaa !38
  %.pre = load ptr, ptr %i.i, align 8, !tbaa !37
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.e, %bb.f
  %i.af = phi ptr [ %.pre, %bb.h ], [ %i.o, %bb.e ], [ %i.j, %bb.f ]
  %i.ag = load i32, ptr %i.a, align 4, !tbaa !3   ; 2 uses
  %i.ah = zext i32 %i.ag to i64
  %i.ai = getelementptr inbounds nuw [16 x i8], ptr %i.af, i64 %i.ah
  %i.aj = load ptr, ptr %i.ai, align 8, !tbaa !39
  %.not49 = icmp eq ptr %i.aj, null
  br i1 %.not49, label %bb.k, label %bb.j

bb.j:                                             ; preds = %bb.i
  %i.ak = call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 1, ptr noundef nonnull @.str.231, i32 noundef %i.ag) #21 ; 0 uses
  br label %bb.n

bb.k:                                             ; preds = %bb.i
  %i.al = zext i32 %i.h to i64                    ; 2 uses
  %i.am = call ptr @opj_malloc(i64 noundef %i.al) #21 ; 2 uses
  %i.an = load ptr, ptr %i.i, align 8, !tbaa !37  ; 2 uses
  %i.ao = load i32, ptr %i.a, align 4, !tbaa !3
  %i.ap = zext i32 %i.ao to i64
  %i.aq = getelementptr inbounds nuw [16 x i8], ptr %i.an, i64 %i.ap ; 2 uses
  store ptr %i.am, ptr %i.aq, align 8, !tbaa !39
  %i.ar = icmp eq ptr %i.am, null
  br i1 %i.ar, label %bb.l, label %bb.m

bb.l:                                             ; preds = %bb.k
  %i.as = call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 1, ptr noundef nonnull @.str.174) #21 ; 0 uses
  br label %bb.n

bb.m:                                             ; preds = %bb.k
  %i.at = getelementptr inbounds nuw i8, ptr %i.aq, i64 8
  store i32 %i.h, ptr %i.at, align 8, !tbaa !250
  %i.au = load i32, ptr %i.a, align 4, !tbaa !3
  %i.av = zext i32 %i.au to i64
  %i.aw = getelementptr inbounds nuw [16 x i8], ptr %i.an, i64 %i.av
  %i.ax = load ptr, ptr %i.aw, align 8, !tbaa !39
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.ax, ptr nonnull align 1 %i.g, i64 %i.al, i1 false)
  br label %bb.n

bb.n:                                             ; preds = %.thread50, %.thread, %bb.m, %bb.l, %bb.j, %bb.b
  %.2 = phi i32 [ 0, %bb.b ], [ 0, %bb.j ], [ 0, %bb.l ], [ 1, %bb.m ], [ 0, %.thread ], [ 0, %.thread50 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #21
  ret i32 %.2
}

; Function Attrs: nounwind uwtable
define internal range(i32 0, 2) i32 @opj_j2k_read_ppt(ptr nofree noundef readonly captures(none) %0, ptr noundef %1, i32 noundef %2, ptr noundef %3) #3 {
bb.a:
  %i.a = alloca i32, align 4                      ; 8 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #21
end_hunk_0
