...
bb.h:                                             ; preds = %bb.f
  %i.r = getelementptr inbounds nuw i8, ptr %1, i64 %.sink25
...
begin_hunk_2_@opj_j2k_update_image_data:bb.a
  ...
  %i.t = getelementptr inbounds nuw [192 x i8], ptr %i.r, i64 %i.s ; 8 uses
  br i1 %.not, label %bb.d, label %bb.c

bb.c:                                             ; preds = %bb.b
  %i.u = load i32, ptr %i.t, align 8, !tbaa !481
  %1 = getelementptr inbounds nuw i8, ptr %i.t, i64 4
  %i.v = getelementptr inbounds nuw i8, ptr %i.t, i64 8
  %i.w = load i32, ptr %i.v, align 8, !tbaa !483
  %2 = getelementptr inbounds nuw i8, ptr %i.t, i64 12
...
bb.d:                                             ; preds = %bb.b
  ...
  %3 = getelementptr inbounds nuw i8, ptr %i.t, i64 180
  %i.ai = getelementptr inbounds nuw i8, ptr %i.t, i64 184
  %i.aj = load i32, ptr %i.ai, align 8, !tbaa !486 ; 2 uses
  %4 = getelementptr inbounds nuw i8, ptr %i.t, i64 188
  %i.ak = sub i32 %i.aj, %i.ah
  br label %bb.e

bb.e:                                             ; preds = %bb.d, %bb.c
  %.sink = phi i64 [ 80, %bb.d ], [ 48, %bb.c ]
  %.0172 = phi i32 [ %i.ah, %bb.d ], [ %i.u, %bb.c ] ; 5 uses
  %.0171.a = phi i32 [ %i.aj, %bb.d ], [ %i.w, %bb.c ] ; 3 uses
  %.0170.in = phi ptr [ %3, %bb.d ], [ %1, %bb.c ]
  %.0169.in = phi ptr [ %4, %bb.d ], [ %2, %bb.c ]
  %.0168 = phi i32 [ %i.ak, %bb.d ], [ %i.af, %bb.c ] ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %.01747, i64 %.sink
...
bb.f:                                             ; preds = %bb.e
  %i.an = sub nsw i32 %.0171.a, %.0172            ; 3 uses
...
begin_hunk_5_@opj_j2k_update_image_data:bb.a
  ...
  %.not197 = icmp ult i32 %i.bh, %.0171.a         ; 2 uses
...
bb.k:                                             ; preds = %bb.i
  %i.br = sub nuw nsw i32 %.0171.a, %i.bh
  br label %bb.l
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.ch = zext i32 %.0168 to i64                  ; 6 uses
