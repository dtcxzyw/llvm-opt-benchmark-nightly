...
bb.a:
  ...
  %i.b = fcmp olt <2 x double> %i.a, <double f0x3FF000010C6F7A0B, double f0x3EB0C6F7A0B5ED8D>
  %i.c = select <2 x i1> %i.b, <2 x double> <double f0x3FF000010C6F7A0B, double f0x3EB0C6F7A0B5ED8D>, <2 x double> %i.a ; 5 uses
  %2 = extractelement <2 x double> %i.c, i64 0    ; 4 uses
  %i.d = extractelement <2 x double> %i.c, i64 1  ; 2 uses
  %3 = fadd double %i.d, 1.000000e+00             ; 3 uses
  %4 = fadd double %2, -1.000000e+00              ; 3 uses
  %5 = fmul double %2, %i.d
  %6 = fmul double %4, %3
  %7 = insertelement <2 x double> poison, double %5, i64 0
  %8 = insertelement <2 x double> %7, double %4, i64 1
  %9 = insertelement <2 x double> %i.c, double %6, i64 0
  %10 = fdiv <2 x double> %8, %9                  ; 2 uses
  %11 = extractelement <2 x double> %10, i64 0
  %i.e = tail call noundef double @pow(double noundef %11, double noundef %2) #2, !tbaa !3
  %12 = insertelement <2 x double> <double 1.000000e+00, double poison>, double %3, i64 1
  %13 = shufflevector <2 x double> %i.c, <2 x double> poison, <2 x i32> zeroinitializer
  %i.f = fdiv <2 x double> %12, %13               ; 2 uses
  %i.g = extractelement <2 x double> %10, i64 1
  %i.h = tail call double @pow(double noundef %i.g, double noundef %4) #2, !tbaa !3
  %i.i = extractelement <2 x double> %i.f, i64 1
  %i.j = tail call double @pow(double noundef %i.i, double noundef %2) #2, !tbaa !3
  %i.k = fmul double %i.h, %i.j
  %14 = shufflevector <2 x double> %i.f, <2 x double> %i.c, <4 x i32> <i32 0, i32 3, i32 poison, i32 poison>
  %i.l = insertelement <4 x double> %14, double %i.e, i64 2
