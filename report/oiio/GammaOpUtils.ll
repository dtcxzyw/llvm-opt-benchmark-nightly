...
begin_hunk_0_@_ZN16OpenColorIO_v2_516ComputeParamsRevERKSt6vectorIdSaIdEERNS_14RendererParamsE:bb.a
  ...
  %2 = fadd double %i.d, -1.000000e+00            ; 3 uses
  %3 = fadd double %i.f, 1.000000e+00             ; 3 uses
  %i.h = fmul double %2, %3
  %i.i = fdiv double %i.g, %i.h
  %i.j = tail call noundef double @pow(double noundef %i.i, double noundef %i.d) #2, !tbaa !3
  %i.k = fdiv double %2, %i.f
  %i.l = fdiv double %3, %i.d
  %i.m = tail call double @pow(double noundef %i.k, double noundef %2) #2, !tbaa !3
