...
vector.ph1234:                                    ; preds = %vector.scevcheck
  %n.vec1236 = and i64 %i.ni, 8589934588          ; 4 uses
  %.cast = trunc i64 %n.vec1236 to i32            ; 2 uses
  %i.ov = mul i32 %.cast, 3
...
.preheader.preheader:                             ; preds = %vector.scevcheck, %.preheader.lr.ph, %middle.block1244
  ...
  %.0100721.ph = phi i32 [ 0, %vector.scevcheck ], [ 0, %.preheader.lr.ph ], [ %.cast, %middle.block1244 ]
  br label %.preheader
