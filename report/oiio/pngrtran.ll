...
bb.io:                                            ; preds = %bb.in, %bb.im, %bb.il, %bb.ik
  %spec.select.i.lcssa = phi i32 [ %spec.select.i, %bb.ik ], [ %spec.select.i.1, %bb.il ], [ %spec.select.i.2, %bb.im ], [ %spec.select.i.3, %bb.in ]
  ...
  %or.cond125.i = select i1 %.not94.not.i, i1 %i.cpf, i1 false
