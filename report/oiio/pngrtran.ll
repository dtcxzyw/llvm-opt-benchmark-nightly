...
bb.de:                                            ; preds = %bb.dd
  ...
  %i.vl = zext nneg i8 %i.vk to i16
  %i.vm = sub nuw nsw i16 8, %i.vl                ; 5 uses
...
.loopexit444:                                     ; preds = %.loopexit444.loopexit.unr-lcssa, %bb.dg, %bb.de
  ...
  %i.wx = zext nneg i8 %i.ww to i16
  %i.wy = sub nuw nsw i16 8, %i.wx                ; 5 uses
  %i.wz = add i8 %i.ww, -1
...
.loopexit442:                                     ; preds = %.loopexit442.loopexit.unr-lcssa, %bb.di, %.loopexit444
  ...
  %i.yj = zext nneg i8 %i.yi to i16
  %i.yk = sub nuw nsw i16 8, %i.yj                ; 5 uses
  %i.yl = add i8 %i.yi, -1
