...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %.02128 = phi ptr [ %i.kk, %.lr.ph ], [ %.02128.ph, %.lr.ph.preheader ] ; 4 uses
  %.02227 = phi ptr [ %i.kj, %.lr.ph ], [ %.02227.ph, %.lr.ph.preheader ] ; 2 uses
  %i.je = load i8, ptr %.02029, align 1, !tbaa !12
  %i.jf = load i8, ptr %.02227, align 1, !tbaa !12
  %5 = getelementptr inbounds nuw i8, ptr %.030, i64 1
  %i.jg = load i8, ptr %5, align 1, !tbaa !12
  %6 = load i8, ptr %.030, align 1, !tbaa !12
  %7 = zext i8 %i.jg to i32
  %8 = zext i8 %i.je to i32                       ; 2 uses
  %9 = zext i8 %6 to i32
  %10 = zext i8 %i.jf to i32                      ; 2 uses
  %i.jh = mul nuw nsw i32 %8, 6419
  %i.ji = lshr i32 %i.jh, 8
  %i.jj = mul nuw nsw i32 %10, 13320
  %i.jk = lshr i32 %i.jj, 8
  %i.jl = add nuw nsw i32 %i.jk, %i.ji            ; 2 uses
  %11 = mul nuw nsw i32 %7, 19077
  %12 = mul nuw nsw i32 %8, 33050
  %13 = mul nuw nsw i32 %9, 19077
  %i.jm = mul nuw nsw i32 %10, 26149
  %i.jn = lshr i32 %11, 8                         ; 3 uses
  %i.jo = lshr i32 %12, 8                         ; 2 uses
  %14 = lshr i32 %13, 8                           ; 3 uses
  %15 = lshr i32 %i.jm, 8                         ; 2 uses
  %16 = add nuw nsw i32 %i.jn, %15
  %17 = add nuw nsw i32 %i.jo, %14
  %18 = sub nsw i32 %14, %i.jl
  ...
  %23 = insertelement <4 x i32> %22, i32 %16, i64 3 ; 3 uses
  %24 = add nsw <4 x i32> %23, <i32 -14234, i32 8708, i32 -17685, i32 -14234> ; 2 uses
  %25 = icmp ult <4 x i32> %24, splat (i32 16384)
  %26 = lshr <4 x i32> %24, splat (i32 6)
  %27 = icmp ult <4 x i32> %23, <i32 14234, i32 -8708, i32 17685, i32 14234>
  %28 = icmp slt <4 x i32> %23, <i32 14234, i32 -8708, i32 17685, i32 14234>
  %29 = shufflevector <4 x i1> %27, <4 x i1> %28, <4 x i32> <i32 0, i32 5, i32 2, i32 3>
  %30 = select <4 x i1> %29, <4 x i32> zeroinitializer, <4 x i32> splat (i32 255)
  %31 = select <4 x i1> %25, <4 x i32> %26, <4 x i32> %30
  %32 = trunc <4 x i32> %31 to <4 x i8>
  store <4 x i8> %32, ptr %.02128, align 1, !tbaa !12
  %i.jp = sub nsw i32 %i.jn, %i.jl                ; 2 uses
  ...
  %i.jy = add nuw nsw i32 %i.jn, %i.jo            ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %6 = load i8, ptr %.030, align 1, !tbaa !12
  %7 = zext i8 %i.jg to i32
  %8 = zext i8 %i.jf to i32                       ; 2 uses
  %9 = zext i8 %6 to i32
  %10 = zext i8 %i.je to i32                      ; 2 uses
  %i.jh = mul nuw nsw i32 %10, 6419
  %i.ji = lshr i32 %i.jh, 8
  %i.jj = mul nuw nsw i32 %8, 13320
  %i.jk = lshr i32 %i.jj, 8
  %i.jl = add nuw nsw i32 %i.jk, %i.ji            ; 2 uses
  %11 = mul nuw nsw i32 %7, 19077
  %12 = mul nuw nsw i32 %8, 26149
  %13 = mul nuw nsw i32 %9, 19077
  %i.jm = mul nuw nsw i32 %10, 33050
  %i.jn = lshr i32 %11, 8                         ; 3 uses
  %i.jo = lshr i32 %12, 8                         ; 2 uses
  %14 = lshr i32 %13, 8                           ; 3 uses
  %15 = lshr i32 %i.jm, 8                         ; 2 uses
  ...
  %22 = insertelement <4 x i32> %21, i32 %17, i64 2
  %23 = insertelement <4 x i32> %22, i32 %16, i64 3 ; 3 uses
  %24 = add nsw <4 x i32> %23, <i32 -17685, i32 8708, i32 -14234, i32 -17685> ; 2 uses
  %25 = icmp ult <4 x i32> %24, splat (i32 16384)
  %26 = lshr <4 x i32> %24, splat (i32 6)
  %27 = icmp ult <4 x i32> %23, <i32 17685, i32 -8708, i32 14234, i32 17685>
  %28 = icmp slt <4 x i32> %23, <i32 17685, i32 -8708, i32 14234, i32 17685>
  %29 = shufflevector <4 x i1> %27, <4 x i1> %28, <4 x i32> <i32 0, i32 5, i32 2, i32 3>
  %30 = select <4 x i1> %29, <4 x i32> zeroinitializer, <4 x i32> splat (i32 255)
  %31 = select <4 x i1> %25, <4 x i32> %26, <4 x i32> %30
  %32 = trunc <4 x i32> %31 to <4 x i8>
