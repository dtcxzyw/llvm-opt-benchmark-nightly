...
FT_MulDiv.exit59:                                 ; preds = %FT_MulDiv.exit51, %bb.f
  ...
  %i.bf = sub nsw i64 0, %i.bb
  %i.bg = select i1 %i.be, i64 %i.bf, i64 %i.bb
  %i.bh = add nsw i64 %i.bg, %i.au
