...
.split.preheader:                                 ; preds = %bb.a
  %6 = load ptr, ptr %i.a, align 8, !tbaa !335    ; 2 uses
  %.not.i = icmp eq ptr %6, null
  br i1 %.not.i, label %raccess_guess_apple_double.exit, label %bb.b
...
.split25.us.loopexit:                             ; preds = %bb.a
  ...
  %12 = tail call i32 @raccess_guess_darwin_ufs_export(ptr noundef %0, ptr poison, ptr noundef %2, ptr noundef nonnull %9, ptr noundef nonnull %11) #32
  ...
  %16 = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %2) #33 ; 5 uses
...
21:                                               ; preds = %18
  ...
  %25 = tail call ptr %24(ptr noundef %22, i64 noundef %19) #32, !inline_history !591 ; 2 uses
...
raccess_guess_darwin_newvfs.exit:                 ; preds = %.split25.us.loopexit, %21, %26, %select.unfold16.i
  ...
  %31 = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %2) #33 ; 5 uses
  %32 = icmp sgt i64 %31, 2147483641
  br i1 %32, label %raccess_guess_darwin_hfsplus.exit, label %33
...
36:                                               ; preds = %33
  ...
  %40 = tail call ptr %39(ptr noundef %37, i64 noundef %34) #32, !inline_history !592 ; 2 uses
  %.not.i.i60 = icmp eq ptr %40, null
  br i1 %.not.i.i60, label %raccess_guess_darwin_hfsplus.exit, label %select.unfold16.i58

41:                                               ; preds = %33
  %.not14.i.i56 = icmp eq i64 %34, 0
  br i1 %.not14.i.i56, label %select.unfold16.i58, label %raccess_guess_darwin_hfsplus.exit
...
raccess_guess_darwin_hfsplus.exit:                ; preds = %raccess_guess_darwin_newvfs.exit, %36, %41, %select.unfold16.i58
  ...
  br i1 %.not.i61, label %raccess_guess_vfat.exit, label %47

47:                                               ; preds = %raccess_guess_darwin_hfsplus.exit
  %48 = getelementptr inbounds nuw i8, ptr %4, i64 40
  store ptr %46, ptr %43, align 8, !tbaa !199
  store i64 0, ptr %48, align 8, !tbaa !39
  br label %raccess_guess_vfat.exit

raccess_guess_vfat.exit:                          ; preds = %raccess_guess_darwin_hfsplus.exit, %47
  %.0.i62 = phi i32 [ 0, %47 ], [ 64, %raccess_guess_darwin_hfsplus.exit ]
  ...
  br i1 %.not.i63, label %raccess_guess_linux_cap.exit, label %52

52:                                               ; preds = %raccess_guess_vfat.exit
...
raccess_guess_linux_cap.exit:                     ; preds = %raccess_guess_vfat.exit, %52
  %.0.i64 = phi i32 [ 0, %52 ], [ 64, %raccess_guess_vfat.exit ]
  ...
  %57 = tail call i32 @raccess_guess_linux_double(ptr noundef nonnull %0, ptr poison, ptr noundef nonnull %2, ptr noundef nonnull %54, ptr noundef nonnull %56) #32
  ...
  %61 = tail call i32 @raccess_guess_linux_netatalk(ptr noundef nonnull %0, ptr poison, ptr noundef nonnull %2, ptr noundef nonnull %58, ptr noundef nonnull %60) #32
  store i32 %61, ptr %59, align 4, !tbaa !3
  br label %.split25.us

bb.b:                                             ; preds = %.split.preheader
  %i.d = tail call i64 %6(ptr noundef nonnull %1, i64 noundef 0, ptr noundef null, i64 noundef 0) #32, !inline_history !336
  %.not10.i = icmp eq i64 %i.d, 0
  br i1 %.not10.i, label %raccess_guess_apple_double.exit, label %.split.1

raccess_guess_apple_double.exit:                  ; preds = %bb.b, %.split.preheader
...
.split.1:                                         ; preds = %bb.b, %raccess_guess_apple_double.exit
  %.sink = phi i32 [ %62, %raccess_guess_apple_double.exit ], [ 85, %bb.b ]
  ...
  %64 = load ptr, ptr %i.a, align 8, !tbaa !335   ; 2 uses
  %.not.i.1 = icmp eq ptr %64, null
  br i1 %.not.i.1, label %raccess_guess_apple_single.exit, label %65

65:                                               ; preds = %.split.1
  %66 = tail call i64 %64(ptr noundef nonnull %1, i64 noundef 0, ptr noundef null, i64 noundef 0) #32, !inline_history !336
  %.not10.i.1 = icmp eq i64 %66, 0
  br i1 %.not10.i.1, label %raccess_guess_apple_single.exit, label %FT_Stream_Seek.exit.1

FT_Stream_Seek.exit.1:                            ; preds = %65
  %67 = getelementptr inbounds nuw i8, ptr %5, i64 4
  store i32 85, ptr %67, align 4, !tbaa !3
  br label %.split.2

raccess_guess_apple_single.exit:                  ; preds = %.split.1, %65
  store i64 0, ptr %i.b, align 8, !tbaa !280
...
.split.2:                                         ; preds = %FT_Stream_Seek.exit.1, %raccess_guess_apple_single.exit
  %71 = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 2 uses
  store ptr null, ptr %71, align 8, !tbaa !199
  %72 = load ptr, ptr %i.a, align 8, !tbaa !335   ; 2 uses
  %.not.i.2 = icmp eq ptr %72, null
  br i1 %.not.i.2, label %bb.c, label %73

73:                                               ; preds = %.split.2
  %74 = tail call i64 %72(ptr noundef nonnull %1, i64 noundef 0, ptr noundef null, i64 noundef 0) #32, !inline_history !336
  %.not10.i.2 = icmp eq i64 %74, 0
  br i1 %.not10.i.2, label %bb.c, label %FT_Stream_Seek.exit.2

FT_Stream_Seek.exit.2:                            ; preds = %73
  %75 = getelementptr inbounds nuw i8, ptr %5, i64 8
  store i32 85, ptr %75, align 4, !tbaa !3
  br label %.split.3

bb.c:                                             ; preds = %.split.2, %73
  store i64 0, ptr %i.b, align 8, !tbaa !280
  %76 = getelementptr inbounds nuw i8, ptr %5, i64 8 ; 2 uses
  store i32 0, ptr %76, align 4, !tbaa !3
  %77 = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.e = tail call i32 @raccess_guess_darwin_ufs_export(ptr noundef %0, ptr nonnull poison, ptr noundef %2, ptr noundef nonnull %71, ptr noundef nonnull %77) #32
  store i32 %i.e, ptr %76, align 4, !tbaa !3
  br label %.split.3

.split.3:                                         ; preds = %FT_Stream_Seek.exit.2, %bb.c
  %78 = getelementptr inbounds nuw i8, ptr %3, i64 24 ; 2 uses
  store ptr null, ptr %78, align 8, !tbaa !199
  %79 = load ptr, ptr %i.a, align 8, !tbaa !335   ; 2 uses
  %.not.i.3 = icmp eq ptr %79, null
  br i1 %.not.i.3, label %83, label %80

80:                                               ; preds = %.split.3
  %81 = tail call i64 %79(ptr noundef nonnull %1, i64 noundef 0, ptr noundef null, i64 noundef 0) #32, !inline_history !336
...
83:                                               ; preds = %.split.3, %80
  ...
  %86 = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %2) #33 ; 5 uses
...
91:                                               ; preds = %88
  ...
  %95 = tail call ptr %94(ptr noundef %92, i64 noundef %89) #32, !inline_history !591 ; 2 uses
...
.split.4:                                         ; preds = %FT_Stream_Seek.exit.3, %raccess_guess_darwin_newvfs.exit72
  ...
  %99 = load ptr, ptr %i.a, align 8, !tbaa !335   ; 2 uses
  %.not.i.4 = icmp eq ptr %99, null
  br i1 %.not.i.4, label %103, label %100

100:                                              ; preds = %.split.4
  %101 = tail call i64 %99(ptr noundef nonnull %1, i64 noundef 0, ptr noundef null, i64 noundef 0) #32, !inline_history !336
...
103:                                              ; preds = %.split.4, %100
  ...
  %106 = tail call i64 @strlen(ptr noundef nonnull readonly dereferenceable(1) %2) #33 ; 5 uses
...
111:                                              ; preds = %108
  ...
  %115 = tail call ptr %114(ptr noundef %112, i64 noundef %109) #32, !inline_history !592 ; 2 uses
...
.split.5:                                         ; preds = %FT_Stream_Seek.exit.4, %raccess_guess_darwin_hfsplus.exit78
  ...
  %119 = load ptr, ptr %i.a, align 8, !tbaa !335  ; 2 uses
  %.not.i.5 = icmp eq ptr %119, null
  br i1 %.not.i.5, label %123, label %120

120:                                              ; preds = %.split.5
  %121 = tail call i64 %119(ptr noundef nonnull %1, i64 noundef 0, ptr noundef null, i64 noundef 0) #32, !inline_history !336
  %.not10.i.5 = icmp eq i64 %121, 0
  br i1 %.not10.i.5, label %123, label %FT_Stream_Seek.exit.5

FT_Stream_Seek.exit.5:                            ; preds = %120
...
123:                                              ; preds = %.split.5, %120
  ...
  br i1 %.not.i79, label %raccess_guess_vfat.exit81, label %bb.d

bb.d:                                             ; preds = %123
  %127 = getelementptr inbounds nuw i8, ptr %4, i64 40
  store ptr %126, ptr %118, align 8, !tbaa !199
  store i64 0, ptr %127, align 8, !tbaa !39
  br label %raccess_guess_vfat.exit81

raccess_guess_vfat.exit81:                        ; preds = %123, %bb.d
  %.0.i80 = phi i32 [ 0, %bb.d ], [ 64, %123 ]
  store i32 %.0.i80, ptr %124, align 4, !tbaa !3
  br label %.split.6

.split.6:                                         ; preds = %FT_Stream_Seek.exit.5, %raccess_guess_vfat.exit81
  %128 = getelementptr inbounds nuw i8, ptr %3, i64 48 ; 2 uses
  store ptr null, ptr %128, align 8, !tbaa !199
  %129 = load ptr, ptr %i.a, align 8, !tbaa !335  ; 2 uses
  %.not.i.6 = icmp eq ptr %129, null
  br i1 %.not.i.6, label %133, label %130

130:                                              ; preds = %.split.6
  %131 = tail call i64 %129(ptr noundef nonnull %1, i64 noundef 0, ptr noundef null, i64 noundef 0) #32, !inline_history !336
  %.not10.i.6 = icmp eq i64 %131, 0
  br i1 %.not10.i.6, label %133, label %FT_Stream_Seek.exit.6

FT_Stream_Seek.exit.6:                            ; preds = %130
...
133:                                              ; preds = %.split.6, %130
  ...
  br i1 %.not.i82, label %raccess_guess_linux_cap.exit84, label %bb.e

bb.e:                                             ; preds = %133
  %137 = getelementptr inbounds nuw i8, ptr %4, i64 48
  store ptr %136, ptr %128, align 8, !tbaa !199
  store i64 0, ptr %137, align 8, !tbaa !39
  br label %raccess_guess_linux_cap.exit84

raccess_guess_linux_cap.exit84:                   ; preds = %133, %bb.e
  %.0.i83 = phi i32 [ 0, %bb.e ], [ 64, %133 ]
  store i32 %.0.i83, ptr %134, align 4, !tbaa !3
  br label %.split.7

.split.7:                                         ; preds = %FT_Stream_Seek.exit.6, %raccess_guess_linux_cap.exit84
  %138 = getelementptr inbounds nuw i8, ptr %3, i64 56 ; 2 uses
  store ptr null, ptr %138, align 8, !tbaa !199
  %139 = load ptr, ptr %i.a, align 8, !tbaa !335  ; 2 uses
  %.not.i.7 = icmp eq ptr %139, null
  br i1 %.not.i.7, label %bb.f, label %140

140:                                              ; preds = %.split.7
  %141 = tail call i64 %139(ptr noundef nonnull %1, i64 noundef 0, ptr noundef null, i64 noundef 0) #32, !inline_history !336
  %.not10.i.7 = icmp eq i64 %141, 0
  br i1 %.not10.i.7, label %bb.f, label %FT_Stream_Seek.exit.7

FT_Stream_Seek.exit.7:                            ; preds = %140
  %142 = getelementptr inbounds nuw i8, ptr %5, i64 28
  store i32 85, ptr %142, align 4, !tbaa !3
  br label %.split.8

bb.f:                                             ; preds = %.split.7, %140
  store i64 0, ptr %i.b, align 8, !tbaa !280
  ...
  %i.f = tail call i32 @raccess_guess_linux_double(ptr noundef %0, ptr nonnull poison, ptr noundef %2, ptr noundef nonnull %138, ptr noundef nonnull %144) #32
  store i32 %i.f, ptr %143, align 4, !tbaa !3
  br label %.split.8

.split.8:                                         ; preds = %FT_Stream_Seek.exit.7, %bb.f
  %145 = getelementptr inbounds nuw i8, ptr %3, i64 64 ; 2 uses
  store ptr null, ptr %145, align 8, !tbaa !199
  %146 = load ptr, ptr %i.a, align 8, !tbaa !335  ; 2 uses
  %.not.i.8 = icmp eq ptr %146, null
  br i1 %.not.i.8, label %149, label %bb.g

bb.g:                                             ; preds = %.split.8
  %147 = tail call i64 %146(ptr noundef nonnull %1, i64 noundef 0, ptr noundef null, i64 noundef 0) #32, !inline_history !336
  %.not10.i.8 = icmp eq i64 %147, 0
  br i1 %.not10.i.8, label %149, label %FT_Stream_Seek.exit.8

FT_Stream_Seek.exit.8:                            ; preds = %bb.g
  %148 = getelementptr inbounds nuw i8, ptr %5, i64 32
  store i32 85, ptr %148, align 4, !tbaa !3
  br label %.split25.us

149:                                              ; preds = %.split.8, %bb.g
  store i64 0, ptr %i.b, align 8, !tbaa !280
  ...
  %152 = tail call i32 @raccess_guess_linux_netatalk(ptr noundef %0, ptr nonnull poison, ptr noundef %2, ptr noundef nonnull %145, ptr noundef nonnull %151) #32
  store i32 %152, ptr %150, align 4, !tbaa !3
  br label %.split25.us

.split25.us:                                      ; preds = %149, %FT_Stream_Seek.exit.8, %raccess_guess_linux_cap.exit
  ret void
}
...
!589 = distinct !{!589, !41}
!590 = !{!105, !105, i64 0}
!591 = !{ptr @raccess_guess_darwin_newvfs, ptr @ft_mem_qalloc}
!592 = !{ptr @raccess_guess_darwin_hfsplus, ptr @ft_mem_qalloc}
!593 = !{!103, !17, i64 560}
!594 = !{!103, !112, i64 584}
!595 = !{!596, !17, i64 8}
end_hunk_1
