...
raccess_guess_vfat.exit:                          ; preds = %raccess_guess_darwin_hfsplus.exit
  %i.c = load ptr, ptr %i.a, align 8, !tbaa !335  ; 2 uses
...
bb.b:                                             ; preds = %raccess_guess_vfat.exit
  %i.d = tail call i64 %i.c(ptr noundef nonnull %1, i64 noundef 0, ptr noundef null, i64 noundef 0) #32, !inline_history !336
...
bb.c:                                             ; preds = %raccess_guess_apple_single.exit
  %i.e = tail call i32 @raccess_guess_apple_double(ptr poison, ptr noundef %1, ptr poison, ptr noundef nonnull %6, ptr noundef %10) #32
  br label %.split.8

FT_Stream_Seek.exit.5:                            ; preds = %raccess_guess_apple_single.exit
  %12 = tail call i32 @raccess_guess_apple_single(ptr poison, ptr noundef %1, ptr poison, ptr noundef nonnull %6, ptr noundef %10) #32
  br label %.split.8

bb.d:                                             ; preds = %raccess_guess_apple_single.exit
  %13 = tail call i32 @raccess_guess_darwin_ufs_export(ptr noundef %0, ptr poison, ptr noundef %2, ptr noundef nonnull %6, ptr noundef %10) #32
  br label %.split.8

raccess_guess_vfat.exit81:                        ; preds = %raccess_guess_apple_single.exit
  %14 = tail call i32 @raccess_guess_darwin_newvfs(ptr noundef %0, ptr poison, ptr noundef %2, ptr noundef nonnull %6, ptr noundef %10) #32
  br label %.split.8

FT_Stream_Seek.exit.6:                            ; preds = %raccess_guess_apple_single.exit
  %15 = tail call i32 @raccess_guess_darwin_hfsplus(ptr noundef %0, ptr poison, ptr noundef %2, ptr noundef nonnull %6, ptr noundef %10) #32
  br label %.split.8

bb.e:                                             ; preds = %raccess_guess_apple_single.exit
  %16 = tail call i32 @raccess_guess_vfat(ptr noundef %0, ptr poison, ptr noundef %2, ptr noundef nonnull %6, ptr noundef %10) #32
  br label %.split.8

raccess_guess_linux_cap.exit84:                   ; preds = %raccess_guess_apple_single.exit
  %17 = tail call i32 @raccess_guess_linux_cap(ptr noundef %0, ptr poison, ptr noundef %2, ptr noundef nonnull %6, ptr noundef %10) #32
  br label %.split.8

FT_Stream_Seek.exit.7:                            ; preds = %raccess_guess_apple_single.exit
  %18 = tail call i32 @raccess_guess_linux_double(ptr noundef %0, ptr poison, ptr noundef %2, ptr noundef nonnull %6, ptr noundef %10) #32
  br label %.split.8

bb.f:                                             ; preds = %raccess_guess_apple_single.exit
  %i.f = tail call i32 @raccess_guess_linux_netatalk(ptr noundef %0, ptr poison, ptr noundef %2, ptr noundef nonnull %6, ptr noundef %10) #32
  br label %.split.8
...
bb.g:                                             ; preds = %FT_Stream_Seek.exit.1, %.split.8
  ...
  br i1 %.not10.i.8, label %.split25.us, label %raccess_guess_darwin_hfsplus.exit, !llvm.loop !592
...
!589 = distinct !{!589, !41}
!590 = !{!105, !105, i64 0}
!591 = !{!"unknown", !"jump-table-to-switch"}
!592 = distinct !{!592, !41}
!593 = !{!103, !17, i64 560}
!594 = !{!103, !112, i64 584}
!595 = !{!596, !17, i64 8}
