...
bb.l:                                             ; preds = %bb.k
  ...
  tail call void %i.am(ptr noundef nonnull %i.aj, ptr noundef nonnull %i.ak) #32, !inline_history !558
...
bb.m:                                             ; preds = %ft_mem_free.exit.i
  ...
  tail call void %i.aq(ptr noundef nonnull %i.aj, ptr noundef nonnull %i.ao) #32, !inline_history !558
...
bb.n:                                             ; preds = %ft_mem_free.exit22.i
  ...
  tail call void %i.au(ptr noundef nonnull %i.aj, ptr noundef nonnull %i.as) #32, !inline_history !558
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.h(ptr noundef nonnull %i.a, ptr noundef nonnull %i.f) #32, !inline_history !202
...
bb.g:                                             ; preds = %ft_mem_free.exit
  ...
  tail call void %i.l(ptr noundef nonnull %i.a, ptr noundef nonnull %i.j) #32, !inline_history !202
...
bb.h:                                             ; preds = %ft_mem_free.exit22
  ...
  tail call void %i.p(ptr noundef nonnull %i.a, ptr noundef nonnull %i.n) #32, !inline_history !202
...
.lr.ph.preheader:                                 ; preds = %bb.b
  %1 = load ptr, ptr %i.d, align 8, !tbaa !162    ; 2 uses
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %.sroa.0.0.copyload = load <16 x i8>, ptr %.03538, align 8
  ...
  store <16 x i8> %.sroa.0.0.copyload, ptr %.03439, align 8
...
.lr.ph.preheader:                                 ; preds = %bb.h
  ...
  %i.ap = tail call i32 %i.am(ptr noundef %i.ao, ptr noundef nonnull %2) #32 ; 2 uses
...
.lr.ph.loopexit:                                  ; preds = %.lr.ph.i45
  ...
  %i.au = tail call i32 %i.ar(ptr noundef %i.at, ptr noundef nonnull %2) #32 ; 2 uses
