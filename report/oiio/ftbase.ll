...
bb.c:                                             ; preds = %bb.b
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !535
...
.preheader:                                       ; preds = %bb.c
  ...
  %i.e = load i32, ptr %i.d, align 4, !tbaa !251  ; 3 uses
...
bb.d:                                             ; preds = %bb.e
  ...
  br i1 %exitcond.not, label %.loopexit, label %bb.e, !llvm.loop !534
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.q = load i64, ptr %i.p, align 8, !tbaa !536
  %i.r = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.s = load i64, ptr %i.r, align 8, !tbaa !536
...
bb.g:                                             ; preds = %bb.f
  ...
  %.pr = load i32, ptr %i.d, align 4, !tbaa !251
  br label %.loopexit
...
.loopexit.thread:                                 ; preds = %.preheader, %.loopexit
  %i.w = load ptr, ptr %0, align 8, !tbaa !235    ; 5 uses
  %i.x = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.y = load i64, ptr %i.x, align 8, !tbaa !537  ; 4 uses
...
ft_mem_qalloc.exit.i:                             ; preds = %.loopexit.thread
  ...
  %i.ac = tail call ptr %i.ab(ptr noundef %i.w, i64 noundef %i.y) #30, !inline_history !181 ; 15 uses
...
select.unfold:                                    ; preds = %ft_mem_qalloc.exit.i
  ...
  store ptr %0, ptr %i.ad, align 8, !tbaa !344
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ac, i64 16
  store ptr %i.w, ptr %i.ae, align 8, !tbaa !345
  store ptr %1, ptr %i.ac, align 8, !tbaa !115
  %i.af = load i64, ptr %1, align 8, !tbaa !116   ; 2 uses
  %i.ag = and i64 %i.af, 2
...
._crit_edge:                                      ; preds = %bb.h
  %.pre = load ptr, ptr %i.ac, align 8, !tbaa !115 ; 2 uses
  %.pre84 = load i64, ptr %.pre, align 8, !tbaa !116
  br label %bb.i
...
bb.j:                                             ; preds = %bb.i
  ...
  store ptr %i.ac, ptr %i.al, align 8, !tbaa !105
  br label %bb.k
...
bb.l:                                             ; preds = %bb.k
  ...
  store ptr %i.aj, ptr %i.an, align 8, !tbaa !64
  br label %bb.m
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  %i.as = load i32, ptr %i.d, align 4, !tbaa !251 ; 2 uses
  %i.at = add i32 %i.as, 1
  store i32 %i.at, ptr %i.d, align 4, !tbaa !251
  %i.au = zext i32 %i.as to i64
  %i.av = getelementptr inbounds nuw [8 x i8], ptr %i.ar, i64 %i.au
  store ptr %i.ac, ptr %i.av, align 8, !tbaa !252
  br label %ft_mem_alloc.exit

bb.p:                                             ; preds = %bb.n, %bb.h
  %.3 = phi i32 [ %i.aq, %bb.n ], [ %i.ah, %bb.h ]
  %i.aw = load ptr, ptr %i.ac, align 8, !tbaa !115
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !165 ; 3 uses
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.bc = load i32, ptr %i.bb, align 8, !tbaa !346
...
bb.s:                                             ; preds = %bb.r
  ...
  %i.bf = load ptr, ptr %i.be, align 8, !tbaa !347 ; 2 uses
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !350
...
ft_mem_free.exit:                                 ; preds = %bb.q, %bb.r, %bb.s, %bb.t, %bb.p
  ...
  tail call void %i.bl(ptr noundef nonnull %i.w, ptr noundef nonnull %i.ac) #30, !inline_history !196
  br label %ft_mem_alloc.exit
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.c = load i32, ptr %i.b, align 4, !tbaa !251  ; 3 uses
...
.lr.ph:                                           ; preds = %bb.c, %bb.v
  ...
  %i.f = load ptr, ptr %.02030, align 8, !tbaa !252
  %i.g = icmp eq ptr %i.f, %1
  br i1 %i.g, label %bb.d, label %bb.v

bb.d:                                             ; preds = %.lr.ph
  %i.h = add i32 %i.c, -1
  store i32 %i.h, ptr %i.b, align 4, !tbaa !251
...
.lr.ph32.preheader:                               ; preds = %bb.d
  ...
  tail call void @llvm.memmove.p0.p0.i64(ptr nonnull align 8 %.02030, ptr align 8 %scevgep, i64 %i.n, i1 false), !tbaa !252
  br label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph32.preheader, %bb.d
  store ptr null, ptr %i.i, align 8, !tbaa !252
  %i.o = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 2 uses
  %i.p = load ptr, ptr %i.o, align 8, !tbaa !345  ; 2 uses
  %i.q = load ptr, ptr %1, align 8, !tbaa !115    ; 6 uses
  %i.r = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !344  ; 6 uses
...
bb.f:                                             ; preds = %bb.e
  store ptr null, ptr %i.t, align 8, !tbaa !105
  br label %bb.g

bb.g:                                             ; preds = %bb.f, %bb.e
  %i.w = load i64, ptr %i.q, align 8, !tbaa !116
  %i.x = and i64 %i.w, 2
  %.not17.i = icmp eq i64 %i.x, 0
  br i1 %.not17.i, label %ft_remove_renderer.exit.i, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.y = load ptr, ptr %i.s, align 8, !tbaa !235  ; 2 uses
  %i.z = getelementptr inbounds nuw i8, ptr %i.s, i64 280 ; 3 uses
  %.011.i.i.i = load ptr, ptr %i.z, align 8, !tbaa !295 ; 2 uses
...
bb.i:                                             ; preds = %.lr.ph.i.i.i
  ...
  %.0.i.i.i = load ptr, ptr %i.ad, align 8, !tbaa !295 ; 2 uses
  %.not10.i.i.i = icmp eq ptr %.0.i.i.i, null
  br i1 %.not10.i.i.i, label %ft_remove_renderer.exit.i, label %.lr.ph.i.i.i, !llvm.loop !9

FT_List_Find.exit.i.i:                            ; preds = %.lr.ph.i.i.i
  %i.ae = getelementptr inbounds nuw i8, ptr %1, i64 104
  %i.af = load ptr, ptr %i.ae, align 8, !tbaa !347 ; 2 uses
...
bb.j:                                             ; preds = %FT_List_Find.exit.i.i
  ...
  %i.ah = load ptr, ptr %i.ag, align 8, !tbaa !165
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ah, i64 112
  %i.aj = load ptr, ptr %i.ai, align 8, !tbaa !348
  %i.ak = getelementptr inbounds nuw i8, ptr %i.aj, i64 40
  %i.al = load ptr, ptr %i.ak, align 8, !tbaa !350
  tail call void %i.al(ptr noundef nonnull %i.af) #30, !inline_history !539
  br label %bb.k

bb.k:                                             ; preds = %bb.j, %FT_List_Find.exit.i.i
  %i.am = load ptr, ptr %.013.i.i.i, align 8, !tbaa !283 ; 4 uses
  %i.an = getelementptr inbounds nuw i8, ptr %.013.i.i.i, i64 8
  %i.ao = load ptr, ptr %i.an, align 8, !tbaa !164 ; 4 uses
  %.not.i.i.i = icmp eq ptr %i.am, null
  br i1 %.not.i.i.i, label %bb.m, label %bb.l

bb.l:                                             ; preds = %bb.k
  %i.ap = getelementptr inbounds nuw i8, ptr %i.am, i64 8
  store ptr %i.ao, ptr %i.ap, align 8, !tbaa !164
  br label %bb.n

bb.m:                                             ; preds = %bb.k
  store ptr %i.ao, ptr %i.z, align 8, !tbaa !284
  br label %bb.n
...
bb.o:                                             ; preds = %bb.n
  store ptr %i.am, ptr %i.ao, align 8, !tbaa !283
  br label %bb.q

bb.p:                                             ; preds = %bb.n
  %i.aq = getelementptr inbounds nuw i8, ptr %i.s, i64 288
  store ptr %i.am, ptr %i.aq, align 8, !tbaa !282
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  %i.ar = getelementptr inbounds nuw i8, ptr %i.y, i64 16
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !94
  tail call void %i.as(ptr noundef %i.y, ptr noundef nonnull %.013.i.i.i) #30, !inline_history !540
  %i.at = load ptr, ptr %i.z, align 8, !tbaa !161 ; 2 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.q, %bb.r
  ...
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !163 ; 2 uses
...
bb.r:                                             ; preds = %.lr.ph.i.i.i.i
  ...
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !164 ; 2 uses
...
ft_set_current_renderer.exit.i.i:                 ; preds = %bb.r, %.lr.ph.i.i.i.i, %bb.q
  ...
  store ptr %.2.i.i.i.i, ptr %i.bb, align 8, !tbaa !155
  %.pre.i = load ptr, ptr %1, align 8, !tbaa !115
...
ft_remove_renderer.exit.i:                        ; preds = %bb.i, %ft_set_current_renderer.exit.i.i, %bb.h, %bb.g, %._crit_edge
  ...
  %i.bd = load i64, ptr %i.bc, align 8, !tbaa !116
  %i.be = and i64 %i.bd, 1
...
bb.s:                                             ; preds = %ft_remove_renderer.exit.i
  ...
  %i.bg = load ptr, ptr %i.o, align 8, !tbaa !256 ; 4 uses
  %.not.i20.i = icmp eq ptr %i.bg, null
  br i1 %.not.i20.i, label %Destroy_Driver.exit.i, label %bb.t

bb.t:                                             ; preds = %bb.s
  %i.bh = load ptr, ptr %i.bf, align 8, !tbaa !284 ; 2 uses
...
ft_mem_free.exit.i.i.i:                           ; preds = %ft_mem_free.exit.i.i.i, %.lr.ph.i.i21.i
  ...
  %i.bk = load ptr, ptr %i.bj, align 8, !tbaa !164 ; 2 uses
  %i.bl = getelementptr inbounds nuw i8, ptr %.022.i.i.i, i64 16
  %i.bm = load ptr, ptr %i.bl, align 8, !tbaa !163
  tail call fastcc void @destroy_face(ptr noundef nonnull %i.bg, ptr noundef %i.bm, ptr noundef nonnull %1) #30, !inline_history !545
  %i.bn = load ptr, ptr %i.bi, align 8, !tbaa !94
  tail call void %i.bn(ptr noundef nonnull %i.bg, ptr noundef nonnull %.022.i.i.i) #30, !inline_history !541
  %.not.i.i22.i = icmp eq ptr %i.bk, null
  br i1 %.not.i.i22.i, label %._crit_edge.i.i.i, label %ft_mem_free.exit.i.i.i, !llvm.loop !10
...
Destroy_Driver.exit.i:                            ; preds = %._crit_edge.i.i.i, %bb.s, %ft_remove_renderer.exit.i
  ...
  %i.bp = load ptr, ptr %i.bo, align 8, !tbaa !546 ; 2 uses
  %.not19.i = icmp eq ptr %i.bp, null
  br i1 %.not19.i, label %bb.w, label %bb.u

bb.u:                                             ; preds = %Destroy_Driver.exit.i
  tail call void %i.bp(ptr noundef nonnull %1) #30, !inline_history !542
  br label %bb.w
...
bb.v:                                             ; preds = %.lr.ph
  ...
  br i1 %i.br, label %.lr.ph, label %.thread, !llvm.loop !543
...
bb.w:                                             ; preds = %bb.u, %Destroy_Driver.exit.i
  ...
  tail call void %i.bt(ptr noundef %i.p, ptr noundef nonnull %1) #30, !inline_history !544
  br label %.thread
...
bb.a:
  ...
  %i.c = load ptr, ptr %i.b, align 8, !tbaa !235  ; 5 uses
  %i.d = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !180
  %i.f = tail call ptr %i.e(ptr noundef %i.c, i64 noundef 24) #30, !inline_history !186 ; 10 uses
