...
bb.l:                                             ; preds = %bb.d, %ft_mem_realloc.exit, %FT_GlyphLoader_Adjust_Points.exit, %bb.a, %bb.b
...
begin_hunk_4
  ...
  br i1 %.not24.i, label %ft_mem_realloc.exit.i, label %bb.f
...
bb.ah:                                            ; preds = %bb.ag
  ...
  br i1 %i.ed, label %FT_GlyphLoader_Adjust_Points.exit.thread, label %bb.ai
...
begin_hunk_8
  ...
  br i1 %.not24.i102, label %ft_mem_realloc.exit.i110, label %bb.aj
...
ft_mem_realloc.exit.i110:                         ; preds = %bb.ai
...
FT_GlyphLoader_Adjust_Points.exit.thread:         ; preds = %bb.aq, %ft_mem_realloc.exit.i110, %bb.ah, %bb.m, %ft_mem_realloc.exit.i, %bb.d, %ft_mem_realloc.exit99, %ft_mem_realloc.exit, %bb.ab, %bb.ar, %ft_mem_realloc.exit.thread121
  %3 = phi i32 [ 10, %bb.m ], [ 64, %ft_mem_realloc.exit.i ], [ 64, %ft_mem_realloc.exit.i110 ], [ %.134.i.i93, %ft_mem_realloc.exit99 ], [ %.134.i.i, %ft_mem_realloc.exit ], [ %i.dp, %bb.ab ], [ %i.gj, %bb.ar ], [ 10, %ft_mem_realloc.exit.thread121 ], [ 10, %bb.d ], [ 10, %bb.ah ], [ 10, %bb.aq ]
...
begin_hunk_12
  ...
  %i.f = load ptr, ptr %0, align 8, !tbaa !246    ; 6 uses
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 40 ; 8 uses
end_hunk_12
begin_hunk_13

bb.ak:                                            ; preds = %bb.aj, %bb.ai
  store i64 %i.dd, ptr %i.m, align 8, !tbaa !260
  %i.dh = icmp slt i32 %i.da, 0
  br i1 %i.dh, label %.thread.sink.split, label %bb.al
