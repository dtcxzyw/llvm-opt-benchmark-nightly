...
begin_hunk_0_@opj_stream_read_skip:bb.a
  ...
  %i.ar = tail call i32 %i.ap(i64 noundef %i.aj, ptr noundef %i.aq) #9
...
begin_hunk_1_@opj_stream_read_skip:bb.a
  ...
  br i1 %i.bg, label %bb.h, label %._crit_edge, !llvm.loop !49
...
begin_hunk_2_@opj_stream_write_skip:bb.a
  ...
  %i.n = tail call i64 %i.l(ptr noundef %i.j, i64 noundef %i.k, ptr noundef %i.m) #9 ; 3 uses
...
begin_hunk_3_@opj_stream_write_skip:bb.a
  ...
  br i1 %.not.i, label %._crit_edge.loopexit.i, label %bb.c, !llvm.loop !50
...
begin_hunk_4_@opj_stream_write_skip:bb.a
  ...
  br i1 %i.ao, label %bb.f, label %._crit_edge, !llvm.loop !51
...
begin_hunk_5_@opj_stream_write_seek:bb.a
  ...
  %i.k = tail call i64 %i.i(ptr noundef %i.g, i64 noundef %i.h, ptr noundef %i.j) #9 ; 3 uses
...
begin_hunk_6_@opj_stream_write_seek:bb.a
  ...
  br i1 %.not.i, label %._crit_edge.loopexit.i, label %bb.b, !llvm.loop !50
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8
  store ptr %2, ptr %i.a, align 8, !tbaa !52
  br label %bb.c
...
begin_hunk_9_@opj_stream_write_data:bb.a
  ...
  %i.r = load <2 x i64>, ptr %i.e, align 8, !tbaa !53
  ...
  store <2 x i64> %i.u, ptr %i.e, align 8, !tbaa !53
  br label %bb.f
...
begin_hunk_10_@opj_stream_write_data:bb.a
  ...
  %i.an = tail call i64 %i.al(ptr noundef %i.aj, i64 noundef %i.ak, ptr noundef %i.am) #9 ; 3 uses
...
begin_hunk_12_@opj_stream_flush:bb.a
  ...
  br i1 %.not, label %._crit_edge.loopexit, label %bb.b, !llvm.loop !50
