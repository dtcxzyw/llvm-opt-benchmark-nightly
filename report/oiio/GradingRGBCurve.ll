Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/oiio/original/GradingRGBCurve?download=true
...
bb.w:                                             ; preds = %bb.u
  %i.bm = load i8, ptr @__libc_single_threaded, align 1, !tbaa !26
  %.not.i.i.i17 = icmp eq i8 %i.bm, 0
  br i1 %.not.i.i.i17, label %bb.y, label %bb.x

bb.x:                                             ; preds = %bb.w
  %i.bn = add nsw i32 %i.be, -1
  store i32 %i.bn, ptr %i.bb, align 8, !tbaa !11
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i18: ; preds = %bb.y, %bb.x
  ...
  br i1 %i.bp, label %bb.z, label %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_519GradingBSplineCurveELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit20, !prof !27
...
_ZNSt12__shared_ptrIKN16OpenColorIO_v2_519GradingBSplineCurveELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit20: ; preds = %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_519GradingBSplineCurveELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, %bb.v, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i18, %bb.z
  ...
  %i.bq = load ptr, ptr %i.j, align 8, !tbaa !22  ; 8 uses
...
bb.ac:                                            ; preds = %bb.aa
  %i.cc = load i8, ptr @__libc_single_threaded, align 1, !tbaa !26
  %.not.i.i.i22 = icmp eq i8 %i.cc, 0
  br i1 %.not.i.i.i22, label %bb.ae, label %bb.ad

bb.ad:                                            ; preds = %bb.ac
  %i.cd = add nsw i32 %i.bu, -1
  store i32 %i.cd, ptr %i.br, align 8, !tbaa !11
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i23: ; preds = %bb.ae, %bb.ad
  ...
  br i1 %i.cf, label %bb.af, label %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_519GradingBSplineCurveELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit25, !prof !27
...
_ZNSt12__shared_ptrIKN16OpenColorIO_v2_519GradingBSplineCurveELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit25: ; preds = %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_519GradingBSplineCurveELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit20, %bb.ab, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i23, %bb.af
  ...
  %i.cg = load ptr, ptr %i.a, align 8, !tbaa !22  ; 8 uses
...
bb.ai:                                            ; preds = %bb.ag
  %i.cs = load i8, ptr @__libc_single_threaded, align 1, !tbaa !26
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i28: ; preds = %bb.ak, %bb.aj
  ...
  br i1 %i.cv, label %bb.al, label %_ZNSt12__shared_ptrIKN16OpenColorIO_v2_519GradingBSplineCurveELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit30, !prof !27
...
bb.am:                                            ; preds = %_ZNSt10shared_ptrIKN16OpenColorIO_v2_519GradingBSplineCurveEEC2IS1_vEERKS_IT_E.exit14
  %i.cw = landingpad { ptr, i32 }
          cleanup
  call void @_ZNSt12__shared_ptrIKN16OpenColorIO_v2_519GradingBSplineCurveELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %8) #20
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #20
  call void @_ZNSt12__shared_ptrIKN16OpenColorIO_v2_519GradingBSplineCurveELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %7) #20
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #20
  call void @_ZNSt12__shared_ptrIKN16OpenColorIO_v2_519GradingBSplineCurveELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %6) #20
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #20
...
bb.b:                                             ; preds = %bb.a
  %i.b = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.c = load ptr, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_111DefaultCtrlE, align 8, !tbaa !15 ; 2 uses
...
common.resume.sink.split:                         ; preds = %bb.c, %bb.b
  ...
  %.sink13 = load ptr, ptr %.sink13.in, align 8, !tbaa !16
...
__cxx_global_var_init.exit:                       ; preds = %bb.a
  store ptr %i.a, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_111DefaultCtrlE, align 8, !tbaa !15
  %i.g = getelementptr inbounds nuw i8, ptr %i.a, i64 24 ; 2 uses
  store ptr %i.g, ptr getelementptr inbounds nuw (i8, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_111DefaultCtrlE, i64 16), align 8, !tbaa !16
  store <4 x float> <float 0.000000e+00, float 0.000000e+00, float 5.000000e-01, float 5.000000e-01>, ptr %i.a, align 4, !tbaa !66
  %.sroa.8.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store <2 x float> splat (float 1.000000e+00), ptr %.sroa.8.0..sroa_idx.i, align 4, !tbaa !66
...
bb.c:                                             ; preds = %__cxx_global_var_init.exit
  %i.j = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.k = load ptr, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_114DefaultCtrlLinE, align 8, !tbaa !15 ; 2 uses
...
__cxx_global_var_init.1.exit:                     ; preds = %__cxx_global_var_init.exit
  store ptr %i.i, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_114DefaultCtrlLinE, align 8, !tbaa !15
  %i.l = getelementptr inbounds nuw i8, ptr %i.i, i64 24 ; 2 uses
  store ptr %i.l, ptr getelementptr inbounds nuw (i8, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_114DefaultCtrlLinE, i64 16), align 8, !tbaa !16
  store <4 x float> <float -7.000000e+00, float -7.000000e+00, float 0.000000e+00, float 0.000000e+00>, ptr %i.i, align 4, !tbaa !66
  %.sroa.8.0..sroa_idx.i6 = getelementptr inbounds nuw i8, ptr %i.i, i64 16
  store <2 x float> splat (float 7.000000e+00), ptr %.sroa.8.0..sroa_idx.i6, align 4, !tbaa !66
...
!13 = !{!"p1 _ZTSN16OpenColorIO_v2_519GradingControlPointE", !12, i64 0}
!14 = !{!"_ZTSNSt12_Vector_baseIN16OpenColorIO_v2_519GradingControlPointESaIS1_EE17_Vector_impl_dataE", !13, i64 0, !13, i64 8, !13, i64 16}
!15 = !{!14, !13, i64 0}
!16 = !{!14, !13, i64 16}
...
!21 = !{!"_ZTSSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EE", !20, i64 0}
!22 = !{!21, !20, i64 0}
...
!28 = !{!"p1 _ZTSN16OpenColorIO_v2_519GradingBSplineCurveE", !12, i64 0}
!29 = !{!"_ZTSSt12__shared_ptrIN16OpenColorIO_v2_519GradingBSplineCurveELN9__gnu_cxx12_Lock_policyE2EE", !28, i64 0, !21, i64 8}
!30 = !{!29, !28, i64 0}
!31 = !{!"_ZTSSt12__shared_ptrIKN16OpenColorIO_v2_519GradingBSplineCurveELN9__gnu_cxx12_Lock_policyE2EE", !28, i64 0, !21, i64 8}
!32 = !{!31, !28, i64 0}
!33 = !{!"p1 _ZTSN16OpenColorIO_v2_515GradingRGBCurveE", !12, i64 0}
!34 = !{!"_ZTSSt12__shared_ptrIN16OpenColorIO_v2_515GradingRGBCurveELN9__gnu_cxx12_Lock_policyE2EE", !33, i64 0, !21, i64 8}
!35 = !{!34, !33, i64 0}
!36 = !{!"p1 omnipotent char", !12, i64 0}
!37 = !{!"p1 float", !12, i64 0}
!38 = !{!"_ZTSNSt12_Vector_baseIfSaIfEE17_Vector_impl_dataE", !37, i64 0, !37, i64 8, !37, i64 16}
!39 = !{!38, !37, i64 0}
!40 = !{!38, !37, i64 16}
!41 = !{!"_ZTSSt12__shared_ptrIKN16OpenColorIO_v2_515GradingRGBCurveELN9__gnu_cxx12_Lock_policyE2EE", !33, i64 0, !21, i64 8}
!42 = !{!41, !33, i64 0}
!43 = distinct !{!43, !"_ZSt11make_sharedIN16OpenColorIO_v2_519GradingRGBCurveImplEJRKSt10shared_ptrINS0_19GradingBSplineCurveEES6_S6_S6_EES2_INSt9enable_ifIXntsr8is_arrayIT_EE5valueES8_E4typeEEDpOT0_"}
!44 = distinct !{!44, !43, !"_ZSt11make_sharedIN16OpenColorIO_v2_519GradingRGBCurveImplEJRKSt10shared_ptrINS0_19GradingBSplineCurveEES6_S6_S6_EES2_INSt9enable_ifIXntsr8is_arrayIT_EE5valueES8_E4typeEEDpOT0_: argument 0"}
...
!49 = !{!"long", !9, i64 0}
!50 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !48, i64 0, !49, i64 8, !9, i64 16}
!51 = !{!50, !36, i64 0}
!52 = distinct !{!52, !"_ZSt11make_sharedIN16OpenColorIO_v2_519GradingRGBCurveImplEJRNS0_12GradingStyleEEESt10shared_ptrINSt9enable_ifIXntsr8is_arrayIT_EE5valueES6_E4typeEEDpOT0_"}
!53 = distinct !{!53, !52, !"_ZSt11make_sharedIN16OpenColorIO_v2_519GradingRGBCurveImplEJRNS0_12GradingStyleEEESt10shared_ptrINSt9enable_ifIXntsr8is_arrayIT_EE5valueES6_E4typeEEDpOT0_: argument 0"}
!54 = !{!53}
!55 = distinct !{!55, !"_ZSt11make_sharedIN16OpenColorIO_v2_519GradingRGBCurveImplEJRKSt10shared_ptrIKNS0_15GradingRGBCurveEEEES2_INSt9enable_ifIXntsr8is_arrayIT_EE5valueES9_E4typeEEDpOT0_"}
!56 = distinct !{!56, !55, !"_ZSt11make_sharedIN16OpenColorIO_v2_519GradingRGBCurveImplEJRKSt10shared_ptrIKNS0_15GradingRGBCurveEEEES2_INSt9enable_ifIXntsr8is_arrayIT_EE5valueES9_E4typeEEDpOT0_: argument 0"}
!57 = !{!56}
!58 = distinct !{!58, !"_ZSt11make_sharedIN16OpenColorIO_v2_519GradingRGBCurveImplEJRKSt10shared_ptrIKNS0_19GradingBSplineCurveEES7_S7_S7_EES2_INSt9enable_ifIXntsr8is_arrayIT_EE5valueES9_E4typeEEDpOT0_"}
!59 = distinct !{!59, !58, !"_ZSt11make_sharedIN16OpenColorIO_v2_519GradingRGBCurveImplEJRKSt10shared_ptrIKNS0_19GradingBSplineCurveEES7_S7_S7_EES2_INSt9enable_ifIXntsr8is_arrayIT_EE5valueES9_E4typeEEDpOT0_: argument 0"}
!60 = !{!59}
!61 = distinct !{null}
!62 = distinct !{null}
!63 = !{!"_ZTSSt9type_info", !36, i64 8}
!64 = !{!63, !36, i64 8}
!65 = !{!"float", !9, i64 0}
!66 = !{!65, !65, i64 0}
!67 = !{!14, !13, i64 8}
