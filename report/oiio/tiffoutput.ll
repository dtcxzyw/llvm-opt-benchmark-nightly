...
.preheader26.preheader:                           ; preds = %bb.a
  ...
  %n.vec57 = and i64 %i.l, 2147483644             ; 3 uses
  %cmp.n61 = icmp eq i64 %n.vec57, %i.l
...
.preheader26:                                     ; preds = %.preheader26.preheader, %._crit_edge29.split.us.us.us
  ...
  %i.v = mul i64 %i.u, %i.l
  %scevgep51 = getelementptr i8, ptr %4, i64 %i.v
  %i.w = mul i64 %i.r, %indvars.iv42              ; 2 uses
  %scevgep52 = getelementptr i8, ptr %3, i64 %i.w
  %scevgep53 = getelementptr i8, ptr %i.s, i64 %i.w
  %i.x = mul nuw nsw i64 %indvars.iv42, %i.n
...
iter.check:                                       ; preds = %._crit_edge.us.us.us, %.preheader26
  ...
  %i.ab = add nuw nsw i64 %i.aa, %indvars.iv42
  %i.ac = mul nuw nsw i64 %i.ab, %i.l
  %invariant.gep = getelementptr inbounds nuw i8, ptr %3, i64 %i.z ; 7 uses
  %invariant.gep49 = getelementptr inbounds nuw i8, ptr %4, i64 %i.ac ; 7 uses
  %brmerge62 = select i1 %min.iters.check, i1 true, i1 %found.conflict
  br i1 %brmerge62, label %vec.epilog.scalar.ph.preheader, label %vector.main.loop.iter.check
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  %wide.load55 = load <16 x i8>, ptr %i.ae, align 1, !tbaa !15, !alias.scope !250
  %i.af = getelementptr inbounds nuw i8, ptr %invariant.gep49, i64 %index ; 2 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 16
  store <16 x i8> %wide.load, ptr %i.af, align 1, !tbaa !15, !alias.scope !253, !noalias !250
  store <16 x i8> %wide.load55, ptr %i.ag, align 1, !tbaa !15, !alias.scope !253, !noalias !250
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.ai = getelementptr inbounds nuw i8, ptr %invariant.gep, i64 %index58
  %wide.load59 = load <4 x i8>, ptr %i.ai, align 1, !tbaa !15, !alias.scope !250
  %i.aj = getelementptr inbounds nuw i8, ptr %invariant.gep49, i64 %index58
  store <4 x i8> %wide.load59, ptr %i.aj, align 1, !tbaa !15, !alias.scope !253, !noalias !250
  %index.next60 = add nuw i64 %index58, 4         ; 2 uses
  %i.ak = icmp eq i64 %index.next60, %n.vec57
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  store i8 %i.al, ptr %gep50.prol, align 1, !tbaa !15
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  store i8 %i.ao, ptr %gep50, align 1, !tbaa !15
  ...
  store i8 %i.ap, ptr %gep50.1, align 1, !tbaa !15
  ...
  store i8 %i.aq, ptr %gep50.2, align 1, !tbaa !15
...
bb.b:                                             ; preds = %bb.a
  ...
  %.pre110 = load i32, ptr %i.b, align 4, !tbaa !3
...
_ZN11OpenImageIO4v3_19ImageSpec11auto_strideERlNS0_8TypeDescEi.exit: ; preds = %bb.a, %bb.b
  %i.q = phi i32 [ %.pre110, %bb.b ], [ %2, %bb.a ]
...
bb.d:                                             ; preds = %bb.c
  %i.af = landingpad { ptr, i32 }
          cleanup
  br label %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EED2Ev.exit77
...
bb.h:                                             ; preds = %bb.y, %bb.g, %bb.ah, %_ZN11OpenImageIO4v3_110TIFFOutput15move_to_scratchEPKvm.exit84, %_ZN11OpenImageIO4v3_110TIFFOutput15move_to_scratchEPKvm.exit
...
.preheader26.preheader.i:                         ; preds = %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EE5resetIPcvEEvT_.exit
  ...
  %min.iters.check132 = icmp ult i32 %i.cv, 32
  %n.mod.vf = and i64 %i.cx, 28
  %n.vec = and i64 %i.cx, 2147483616              ; 4 uses
  %cmp.n = icmp eq i64 %n.vec, %i.cx
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf, 0
  %n.vec135 = and i64 %i.cx, 2147483644           ; 3 uses
  %cmp.n139 = icmp eq i64 %n.vec135, %i.cx
...
.preheader26.i:                                   ; preds = %._crit_edge29.split.us.us.us.i, %.preheader26.preheader.i
  ...
  %scevgep129 = getelementptr i8, ptr %.032, i64 %i.dh
  %i.di = mul i64 %i.dd, %indvars.iv42.i          ; 2 uses
  %scevgep130 = getelementptr i8, ptr %.134, i64 %i.di
  %scevgep131 = getelementptr i8, ptr %i.de, i64 %i.di
  %i.dj = mul nuw nsw i64 %indvars.iv42.i, %i.cz
...
iter.check:                                       ; preds = %._crit_edge.us.us.us.i, %.preheader26.i
  ...
  %i.dn = add nuw nsw i64 %i.dm, %indvars.iv42.i
  %i.do = mul nuw nsw i64 %i.dn, %i.cx
  %invariant.gep.i = getelementptr inbounds nuw i8, ptr %.134, i64 %i.dl ; 7 uses
  %invariant.gep49.i = getelementptr inbounds nuw i8, ptr %.032, i64 %i.do ; 7 uses
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  %wide.load133 = load <16 x i8>, ptr %i.dq, align 1, !tbaa !15, !alias.scope !268
  %i.dr = getelementptr inbounds nuw i8, ptr %invariant.gep49.i, i64 %index ; 2 uses
  %i.ds = getelementptr inbounds nuw i8, ptr %i.dr, i64 16
  store <16 x i8> %wide.load, ptr %i.dr, align 1, !tbaa !15, !alias.scope !271, !noalias !268
  store <16 x i8> %wide.load133, ptr %i.ds, align 1, !tbaa !15, !alias.scope !271, !noalias !268
  %index.next = add nuw i64 %index, 32            ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.du = getelementptr inbounds nuw i8, ptr %invariant.gep.i, i64 %index136
  %wide.load137 = load <4 x i8>, ptr %i.du, align 1, !tbaa !15, !alias.scope !268
  %i.dv = getelementptr inbounds nuw i8, ptr %invariant.gep49.i, i64 %index136
  store <4 x i8> %wide.load137, ptr %i.dv, align 1, !tbaa !15, !alias.scope !271, !noalias !268
  %index.next138 = add nuw i64 %index136, 4       ; 2 uses
  %i.dw = icmp eq i64 %index.next138, %n.vec135
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  store i8 %i.dx, ptr %gep50.i.prol, align 1, !tbaa !15
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  store i8 %i.ea, ptr %gep50.i, align 1, !tbaa !15
  ...
  store i8 %i.eb, ptr %gep50.i.1, align 1, !tbaa !15
  ...
  store i8 %i.ec, ptr %gep50.i.2, align 1, !tbaa !15
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.s, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  ...
  %.not.i71 = icmp eq ptr %.sroa.0.0, null
  br i1 %.not.i71, label %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EED2Ev.exit, label %_ZNKSt14default_deleteIA_cEclIcEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i
...
bb.v:                                             ; preds = %bb.r
  ...
  br i1 %i.fd, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit74, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i72

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i72: ; preds = %bb.v
  %i.fe = load i64, ptr %i.fc, align 8, !tbaa !15
  %i.ff = add i64 %i.fe, 1
  call void @_ZdlPvm(ptr noundef %i.fb, i64 noundef %i.ff) #36
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit74

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit74: ; preds = %bb.v, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i72, %bb.u
  %.pn49 = phi { ptr, i32 } [ %i.ez, %bb.u ], [ %i.fa, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i72 ], [ %i.fa, %bb.v ]
  call void @llvm.lifetime.end.p0(ptr nonnull %10) #34
  br label %bb.w

bb.w:                                             ; preds = %bb.t, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit74
  %.pn49.pn.pn = phi { ptr, i32 } [ %i.ey, %bb.t ], [ %.pn49, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit74 ] ; 2 uses
  %.not.i75 = icmp eq ptr %.sroa.0.0, null
  br i1 %.not.i75, label %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EED2Ev.exit77, label %_ZNKSt14default_deleteIA_cEclIcEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i76

_ZNKSt14default_deleteIA_cEclIcEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i76: ; preds = %bb.w
  call void @_ZdaPv(ptr noundef nonnull %.sroa.0.0) #36
  br label %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EED2Ev.exit77
...
bb.x:                                             ; preds = %bb.i
  ...
  %.not.i80 = icmp eq ptr %.134, %i.fj
  %or.cond.i81 = and i1 %.not.i80, %i.fm
  br i1 %or.cond.i81, label %_ZN11OpenImageIO4v3_110TIFFOutput15move_to_scratchEPKvm.exit84, label %bb.y

bb.y:                                             ; preds = %bb.x
  %i.fn = zext i8 %i.fh to i64
  %narrow.i78 = call i32 @llvm.smax.i32(i32 %i.fg, i32 1)
  %spec.select.i79 = zext nneg i32 %narrow.i78 to i64
  %i.fo = mul i64 %i.am, %i.fn
  %i.fp = mul i64 %i.fo, %i.fi
  %i.fq = mul i64 %i.fp, %spec.select.i79
...
.noexc83:                                         ; preds = %bb.y
  %.pre.i82 = load ptr, ptr %i.s, align 8, !tbaa !76
  br label %_ZN11OpenImageIO4v3_110TIFFOutput15move_to_scratchEPKvm.exit84

_ZN11OpenImageIO4v3_110TIFFOutput15move_to_scratchEPKvm.exit84: ; preds = %.noexc83, %bb.x
  %i.fs = phi ptr [ %i.fj, %bb.x ], [ %.pre.i82, %.noexc83 ]
...
bb.z:                                             ; preds = %_ZN11OpenImageIO4v3_110TIFFOutput15move_to_scratchEPKvm.exit84
  %i.fx = icmp slt i32 %i.fw, 0
  br i1 %i.fx, label %bb.aa, label %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EED2Ev.exit93
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %spec.select105 = select i1 %.not45, ptr @.str.86, ptr %i.ga
  store ptr %spec.select105, ptr %i.d, align 8, !tbaa !100
...
bb.ac:                                            ; preds = %bb.ab
  ...
  br i1 %i.gd, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit87, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i85
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit87: ; preds = %bb.ac, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i85
...
bb.ae:                                            ; preds = %bb.ab
  ...
  br i1 %i.gk, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit90, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i88

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i88: ; preds = %bb.ae
  %i.gl = load i64, ptr %i.gj, align 8, !tbaa !15
  %i.gm = add i64 %i.gl, 1
  call void @_ZdlPvm(ptr noundef %i.gi, i64 noundef %i.gm) #36
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit90

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit90: ; preds = %bb.ae, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i88, %bb.ad
end_hunk_1
...
_ZN11OpenImageIO4v3_19ImageSpec11auto_strideERlS2_S2_NS0_8TypeDescEiii.exit: ; preds = %bb.f, %bb.e
  %.0133.a = phi i64 [ %i.ao, %bb.f ], [ %6, %bb.e ] ; 2 uses
  %i.ap = icmp eq i64 %7, -9223372036854775808
  %i.aq = sext i32 %i.k to i64
  %i.ar = mul nsw i64 %.0133.a, %i.aq
  %.0132 = select i1 %i.ap, i64 %i.ar, i64 %7     ; 2 uses
  %i.as = icmp eq i64 %8, -9223372036854775808
  %i.at = sext i32 %i.t to i64
  %i.au = mul nsw i64 %.0132, %i.at
  ...
  %i.be = call noundef ptr @_ZN11OpenImageIO4v3_111ImageOutput14to_native_tileENS0_8TypeDescEPKvlllRSt6vectorIhSaIhEEjiii(ptr noundef nonnull align 8 dereferenceable(184) %0, i64 %4, ptr noundef %5, i64 noundef %.0133.a, i64 noundef %.0132, i64 noundef %.0, ptr noundef nonnull align 8 dereferenceable(24) %i.bb, i32 noundef %i.bd, i32 noundef %i.aw, i32 noundef %i.ay, i32 noundef %i.ba) ; 2 uses
...
bb.h:                                             ; preds = %bb.ab, %bb.k, %bb.ak, %_ZN11OpenImageIO4v3_110TIFFOutput15move_to_scratchEPKvm.exit111, %_ZN11OpenImageIO4v3_110TIFFOutput15move_to_scratchEPKvm.exit, %bb.g
  %i.bt = landingpad { ptr, i32 }
          cleanup
  br label %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EED2Ev.exit104
...
.preheader26.preheader.i:                         ; preds = %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EE5resetIPcvEEvT_.exit
  ...
  %min.iters.check164 = icmp ult i32 %i.dw, 32
  %n.mod.vf = and i64 %i.dy, 28
  %n.vec = and i64 %i.dy, 2147483616              ; 4 uses
  %cmp.n = icmp eq i64 %n.vec, %i.dy
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf, 0
  %n.vec167 = and i64 %i.dy, 2147483644           ; 3 uses
  %cmp.n171 = icmp eq i64 %n.vec167, %i.dy
...
.preheader26.i:                                   ; preds = %._crit_edge29.split.us.us.us.i, %.preheader26.preheader.i
  ...
  %scevgep161 = getelementptr i8, ptr %.058, i64 %i.ei
  %i.ej = mul i64 %i.ee, %indvars.iv42.i          ; 2 uses
  %scevgep162 = getelementptr i8, ptr %.168, i64 %i.ej
  %scevgep163 = getelementptr i8, ptr %i.ef, i64 %i.ej
  %i.ek = mul nuw nsw i64 %indvars.iv42.i, %i.ea
  %bound0 = icmp ult ptr %scevgep, %scevgep163
  %bound1 = icmp ult ptr %scevgep162, %scevgep161
  %found.conflict = and i1 %bound0, %bound1
  br label %iter.check
...
iter.check:                                       ; preds = %._crit_edge.us.us.us.i, %.preheader26.i
  ...
  %i.eo = add nuw nsw i64 %i.en, %indvars.iv42.i
  %i.ep = mul nuw nsw i64 %i.eo, %i.dy
  %invariant.gep.i = getelementptr inbounds nuw i8, ptr %.168, i64 %i.em ; 7 uses
  %invariant.gep49.i = getelementptr inbounds nuw i8, ptr %.058, i64 %i.ep ; 7 uses
  %brmerge = select i1 %min.iters.check, i1 true, i1 %found.conflict
  br i1 %brmerge, label %vec.epilog.scalar.ph.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %iter.check
  br i1 %min.iters.check164, label %vec.epilog.ph, label %vector.body
...
vector.body:                                      ; preds = %vector.main.loop.iter.check, %vector.body
  ...
  %wide.load165 = load <16 x i8>, ptr %i.er, align 1, !tbaa !15, !alias.scope !389
  %i.es = getelementptr inbounds nuw i8, ptr %invariant.gep49.i, i64 %index ; 2 uses
  %i.et = getelementptr inbounds nuw i8, ptr %i.es, i64 16
  store <16 x i8> %wide.load, ptr %i.es, align 1, !tbaa !15, !alias.scope !392, !noalias !389
  store <16 x i8> %wide.load165, ptr %i.et, align 1, !tbaa !15, !alias.scope !392, !noalias !389
  %index.next = add nuw i64 %index, 32            ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.ev = getelementptr inbounds nuw i8, ptr %invariant.gep.i, i64 %index168
  %wide.load169 = load <4 x i8>, ptr %i.ev, align 1, !tbaa !15, !alias.scope !389
  %i.ew = getelementptr inbounds nuw i8, ptr %invariant.gep49.i, i64 %index168
  store <4 x i8> %wide.load169, ptr %i.ew, align 1, !tbaa !15, !alias.scope !392, !noalias !389
  %index.next170 = add nuw i64 %index168, 4       ; 2 uses
  %i.ex = icmp eq i64 %index.next170, %n.vec167
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  %gep50.i.prol = getelementptr inbounds nuw i8, ptr %invariant.gep49.i, i64 %indvars.iv.i.prol
  store i8 %i.ey, ptr %gep50.i.prol, align 1, !tbaa !15
  %indvars.iv.next.i.prol = add nuw nsw i64 %indvars.iv.i.prol, 1 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  %gep50.i = getelementptr inbounds nuw i8, ptr %invariant.gep49.i, i64 %indvars.iv.i
  store i8 %i.fb, ptr %gep50.i, align 1, !tbaa !15
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %gep.i.1 = getelementptr inbounds nuw i8, ptr %invariant.gep.i, i64 %indvars.iv.next.i
  %i.fc = load i8, ptr %gep.i.1, align 1, !tbaa !15
  %gep50.i.1 = getelementptr inbounds nuw i8, ptr %invariant.gep49.i, i64 %indvars.iv.next.i
  store i8 %i.fc, ptr %gep50.i.1, align 1, !tbaa !15
  %indvars.iv.next.i.1 = add nuw nsw i64 %indvars.iv.i, 2 ; 2 uses
  %gep.i.2 = getelementptr inbounds nuw i8, ptr %invariant.gep.i, i64 %indvars.iv.next.i.1
  %i.fd = load i8, ptr %gep.i.2, align 1, !tbaa !15
  %gep50.i.2 = getelementptr inbounds nuw i8, ptr %invariant.gep49.i, i64 %indvars.iv.next.i.1
  store i8 %i.fd, ptr %gep50.i.2, align 1, !tbaa !15
  %indvars.iv.next.i.2 = add nuw nsw i64 %indvars.iv.i, 3 ; 2 uses
  %gep.i.3 = getelementptr inbounds nuw i8, ptr %invariant.gep.i, i64 %indvars.iv.next.i.2
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.v, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  ...
  %.not.i98 = icmp eq ptr %.sroa.0.0, null
  br i1 %.not.i98, label %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EED2Ev.exit, label %_ZNKSt14default_deleteIA_cEclIcEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i
...
bb.y:                                             ; preds = %bb.u
  ...
  br i1 %i.gi, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit101, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i99

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i99: ; preds = %bb.y
  %i.gj = load i64, ptr %i.gh, align 8, !tbaa !15
  %i.gk = add i64 %i.gj, 1
  call void @_ZdlPvm(ptr noundef %i.gg, i64 noundef %i.gk) #36
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit101

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit101: ; preds = %bb.y, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i99, %bb.x
  %.pn75 = phi { ptr, i32 } [ %i.ge, %bb.x ], [ %i.gf, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i99 ], [ %i.gf, %bb.y ]
  call void @llvm.lifetime.end.p0(ptr nonnull %13) #34
  br label %bb.z

bb.z:                                             ; preds = %bb.w, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit101
  %.pn75.pn.pn = phi { ptr, i32 } [ %i.gd, %bb.w ], [ %.pn75, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit101 ] ; 2 uses
  %.not.i102 = icmp eq ptr %.sroa.0.0, null
  br i1 %.not.i102, label %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EED2Ev.exit104, label %_ZNKSt14default_deleteIA_cEclIcEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i103

_ZNKSt14default_deleteIA_cEclIcEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i103: ; preds = %bb.z
  call void @_ZdaPv(ptr noundef nonnull %.sroa.0.0) #36
  br label %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EED2Ev.exit104
...
bb.aa:                                            ; preds = %bb.l
  ...
  %.not.i107 = icmp eq ptr %.168, %i.go
  %or.cond.i108 = and i1 %.not.i107, %i.gr
  br i1 %or.cond.i108, label %_ZN11OpenImageIO4v3_110TIFFOutput15move_to_scratchEPKvm.exit111, label %bb.ab

bb.ab:                                            ; preds = %bb.aa
  %i.gs = zext i8 %i.gm to i64
  %narrow.i105 = call i32 @llvm.smax.i32(i32 %i.gl, i32 1)
  %spec.select.i106 = zext nneg i32 %narrow.i105 to i64
  %i.gt = mul i64 %i.bj, %i.gs
  %i.gu = mul i64 %i.gt, %i.gn
  %i.gv = mul i64 %i.gu, %spec.select.i106
  ...
  invoke void @_ZNSt6vectorIhSaIhEE13_M_assign_auxIPKhEEvT_S5_St20forward_iterator_tag(ptr noundef nonnull align 8 dereferenceable(24) %i.bb, ptr noundef %.168, ptr noundef %i.gw)
          to label %.noexc110 unwind label %bb.h

.noexc110:                                        ; preds = %bb.ab
  %.pre.i109 = load ptr, ptr %i.bb, align 8, !tbaa !76
  br label %_ZN11OpenImageIO4v3_110TIFFOutput15move_to_scratchEPKvm.exit111

_ZN11OpenImageIO4v3_110TIFFOutput15move_to_scratchEPKvm.exit111: ; preds = %.noexc110, %bb.aa
  %i.gx = phi ptr [ %i.go, %bb.aa ], [ %.pre.i109, %.noexc110 ]
...
bb.ac:                                            ; preds = %_ZN11OpenImageIO4v3_110TIFFOutput15move_to_scratchEPKvm.exit111
  %i.hb = icmp slt i64 %i.ha, 0
  br i1 %i.hb, label %bb.ad, label %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EED2Ev.exit120
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %spec.select138 = select i1 %.not71, ptr @.str.86, ptr %i.hk
  store ptr %spec.select138, ptr %i.h, align 8, !tbaa !100
...
bb.af:                                            ; preds = %bb.ae
  ...
  br i1 %i.hn, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit114, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i112
...
.lr.ph.i.preheader:                               ; preds = %bb.a, %_ZN11OpenImageIO4v3_120bitstring_add_n_bitsIhEEvRPT_Riji.exit.loopexit
  ...
  %.0713 = phi i32 [ %.2, %_ZN11OpenImageIO4v3_120bitstring_add_n_bitsIhEEvRPT_Riji.exit.loopexit ], [ 0, %bb.a ]
  %.0812 = phi ptr [ %.210, %_ZN11OpenImageIO4v3_120bitstring_add_n_bitsIhEEvRPT_Riji.exit.loopexit ], [ %2, %bb.a ]
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %bb.b
  %.19 = phi ptr [ %.210, %bb.b ], [ %.0812, %.lr.ph.i.preheader ] ; 3 uses
  %.1 = phi i32 [ %.2, %bb.b ], [ %.0713, %.lr.ph.i.preheader ] ; 3 uses
  %.02529.i = phi i32 [ %i.h, %bb.b ], [ %i.e, %.lr.ph.i.preheader ]
  %.02628.i = phi i32 [ %i.s, %bb.b ], [ %3, %.lr.ph.i.preheader ] ; 6 uses
  %i.f = shl nsw i32 -1, %.02628.i
  %i.g = xor i32 %i.f, -1
  %i.h = and i32 %.02529.i, %i.g                  ; 3 uses
  %i.i = icmp eq i32 %.1, 0
  br i1 %i.i, label %bb.b, label %.lr.ph.i._crit_edge

.lr.ph.i._crit_edge:                              ; preds = %.lr.ph.i
  %.pre = load i8, ptr %.19, align 1, !tbaa !15
  br label %bb.b

bb.b:                                             ; preds = %.lr.ph.i, %.lr.ph.i._crit_edge
  %i.j = phi i8 [ %.pre, %.lr.ph.i._crit_edge ], [ 0, %.lr.ph.i ]
  %i.k = sub nsw i32 8, %.1                       ; 4 uses
  %.not.i = icmp sgt i32 %.02628.i, %i.k
  %i.l = sub nsw i32 %i.k, %.02628.i
  %i.m = shl i32 %i.h, %i.l
  %i.n = sub nsw i32 %.02628.i, %i.k
  %i.o = lshr i32 %i.h, %i.n
  %.024.i = select i1 %.not.i, i32 %i.o, i32 %i.m
  %.0.i = tail call i32 @llvm.smin.i32(i32 %.02628.i, i32 %i.k) ; 2 uses
  %i.p = trunc i32 %.024.i to i8
  %i.q = or i8 %i.j, %i.p
  store i8 %i.q, ptr %.19, align 1, !tbaa !15
  %i.r = add nsw i32 %.0.i, %.1                   ; 2 uses
  %i.s = sub nsw i32 %.02628.i, %.0.i             ; 2 uses
  %i.t = icmp eq i32 %i.r, 8                      ; 2 uses
  %.210.idx = zext i1 %i.t to i64
  %.210 = getelementptr inbounds nuw i8, ptr %.19, i64 %.210.idx ; 2 uses
  %.2 = select i1 %i.t, i32 0, i32 %i.r           ; 2 uses
  %i.u = icmp sgt i32 %i.s, 0
  br i1 %i.u, label %.lr.ph.i, label %_ZN11OpenImageIO4v3_120bitstring_add_n_bitsIhEEvRPT_Riji.exit.loopexit, !llvm.loop !281
...
.lr.ph.i.preheader:                               ; preds = %bb.a, %_ZN11OpenImageIO4v3_120bitstring_add_n_bitsIhEEvRPT_Riji.exit.loopexit
  ...
  %.0713 = phi i32 [ %.2, %_ZN11OpenImageIO4v3_120bitstring_add_n_bitsIhEEvRPT_Riji.exit.loopexit ], [ 0, %bb.a ]
  %.0812 = phi ptr [ %.210, %_ZN11OpenImageIO4v3_120bitstring_add_n_bitsIhEEvRPT_Riji.exit.loopexit ], [ %2, %bb.a ]
  %i.c = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %.014
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %bb.b
  %.19 = phi ptr [ %.210, %bb.b ], [ %.0812, %.lr.ph.i.preheader ] ; 3 uses
  %.1 = phi i32 [ %.2, %bb.b ], [ %.0713, %.lr.ph.i.preheader ] ; 3 uses
  %.02529.i = phi i32 [ %i.g, %bb.b ], [ %i.d, %.lr.ph.i.preheader ]
  %.02628.i = phi i32 [ %i.r, %bb.b ], [ %3, %.lr.ph.i.preheader ] ; 6 uses
  %i.e = shl nsw i32 -1, %.02628.i
  %i.f = xor i32 %i.e, -1
  %i.g = and i32 %.02529.i, %i.f                  ; 3 uses
  %i.h = icmp eq i32 %.1, 0
  br i1 %i.h, label %bb.b, label %.lr.ph.i._crit_edge
...
bb.b:                                             ; preds = %.lr.ph.i, %.lr.ph.i._crit_edge
  %i.i = phi i8 [ %.pre, %.lr.ph.i._crit_edge ], [ 0, %.lr.ph.i ]
  %i.j = sub nsw i32 8, %.1                       ; 4 uses
  %.not.i = icmp sgt i32 %.02628.i, %i.j
  %i.k = sub nsw i32 %i.j, %.02628.i
  %i.l = shl i32 %i.g, %i.k
  %i.m = sub nsw i32 %.02628.i, %i.j
  %i.n = lshr i32 %i.g, %i.m
  %.024.i = select i1 %.not.i, i32 %i.n, i32 %i.l
  %.0.i = tail call i32 @llvm.smin.i32(i32 %.02628.i, i32 %i.j) ; 2 uses
  %i.o = trunc i32 %.024.i to i8
  %i.p = or i8 %i.i, %i.o
  store i8 %i.p, ptr %.19, align 1, !tbaa !15
  %i.q = add nsw i32 %.0.i, %.1                   ; 2 uses
  %i.r = sub nsw i32 %.02628.i, %.0.i             ; 2 uses
  %i.s = icmp eq i32 %i.q, 8                      ; 2 uses
  %.210.idx = zext i1 %i.s to i64
  %.210 = getelementptr inbounds nuw i8, ptr %.19, i64 %.210.idx ; 2 uses
  %.2 = select i1 %i.s, i32 0, i32 %i.q           ; 2 uses
  %i.t = icmp sgt i32 %i.r, 0
  br i1 %i.t, label %.lr.ph.i, label %_ZN11OpenImageIO4v3_120bitstring_add_n_bitsIhEEvRPT_Riji.exit.loopexit, !llvm.loop !281
