...
vector.body:                                      ; preds = %pred.store.continue64, %vector.ph
  ...
  %offset.idx = add i64 %index, %i.f              ; 8 uses
  %i.i = getelementptr inbounds nuw [4 x i8], ptr %0, i64 %offset.idx ; 3 uses
...
pred.store.continue52:                            ; preds = %pred.store.continue, %pred.store.if51
