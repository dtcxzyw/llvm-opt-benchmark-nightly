...
bb.b:                                             ; preds = %.lr.ph126, %.loopexit99
  %indvars.iv158 = phi i64 [ 0, %.lr.ph126 ], [ %indvars.iv.next159, %.loopexit99 ] ; 3 uses
  ...
  %i.r = getelementptr inbounds nuw [8 x i8], ptr %i.l, i64 %indvars.iv158
...
.lr.ph:                                           ; preds = %bb.e
  %i.ao = getelementptr inbounds nuw [8 x i8], ptr %1, i64 %indvars.iv158 ; 2 uses
  %i.ap = icmp sgt i32 %spec.select98, 0
  %i.aq = zext i32 %.fr129 to i64
  %i.ar = zext i32 %spec.select98 to i64          ; 3 uses
  %i.as = shl nuw nsw i64 %i.ar, 7
  %wide.trip.count142 = zext nneg i32 %.088 to i64 ; 2 uses
...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %.loopexit.us
  %indvars.iv139.a = phi i64 [ %indvars.iv.next140.a, %.loopexit.us ], [ 0, %.lr.ph.split.us.preheader ] ; 3 uses
  %i.au = getelementptr inbounds nuw [8 x i8], ptr %i.x, i64 %indvars.iv139.a
  ...
  %indvars.iv139.tr = trunc i64 %indvars.iv139.a to i32
  %i.ba = shl i32 %indvars.iv139.tr, 3
  tail call void %i.ay(ptr noundef nonnull %0, ptr noundef %.086123, ptr noundef %i.az, ptr noundef %i.av, i32 noundef %i.ba, i32 noundef 0, i32 noundef %.fr129) #5
...
.lr.ph.split.us.new:                              ; preds = %.lr.ph.split.us, %.lr.ph.split.us.new
  %indvars.iv134 = phi i64 [ %indvars.iv.next135.3, %.lr.ph.split.us.new ], [ 0, %.lr.ph.split.us ] ; 5 uses
  %niter = phi i64 [ %niter.next.3, %.lr.ph.split.us.new ], [ 0, %.lr.ph.split.us ]
  %i.be = getelementptr inbounds nuw [128 x i8], ptr %i.bb, i64 %indvars.iv134
  store i16 %i.bd, ptr %i.be, align 2, !tbaa !75
  %i.bf = getelementptr inbounds nuw [128 x i8], ptr %i.bb, i64 %indvars.iv134
  %i.bg = getelementptr inbounds nuw i8, ptr %i.bf, i64 128
  store i16 %i.bd, ptr %i.bg, align 2, !tbaa !75
  %i.bh = getelementptr inbounds nuw [128 x i8], ptr %i.bb, i64 %indvars.iv134
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bh, i64 256
  store i16 %i.bd, ptr %i.bi, align 2, !tbaa !75
  %i.bj = getelementptr inbounds nuw [128 x i8], ptr %i.bb, i64 %indvars.iv134
...
.epil.preheader:                                  ; preds = %.loopexit.us.unr-lcssa, %.lr.ph.split.us
  %indvars.iv134.epil.init = phi i64 [ 0, %.lr.ph.split.us ], [ %indvars.iv.next135.3, %.loopexit.us.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod171.a)
  br label %bb.f

bb.f:                                             ; preds = %bb.f, %.epil.preheader
  %indvars.iv134.epil = phi i64 [ %indvars.iv.next135.epil, %bb.f ], [ %indvars.iv134.epil.init, %.epil.preheader ] ; 2 uses
  %epil.iter = phi i64 [ %epil.iter.next, %bb.f ], [ 0, %.epil.preheader ]
  %i.bl = getelementptr inbounds nuw [128 x i8], ptr %i.bb, i64 %indvars.iv134.epil
...
.loopexit.us:                                     ; preds = %bb.f, %.loopexit.us.unr-lcssa
  %indvars.iv.next140.a = add nuw nsw i64 %indvars.iv139.a, 1 ; 2 uses
  %exitcond143.not = icmp eq i64 %indvars.iv.next140.a, %wide.trip.count142
  br i1 %exitcond143.not, label %._crit_edge, label %.lr.ph.split.us, !llvm.loop !91
...
.lr.ph.split:                                     ; preds = %.lr.ph, %.lr.ph.split
  ...
  tail call void %i.bq(ptr noundef nonnull %0, ptr noundef nonnull %.086123, ptr noundef %i.br, ptr noundef %i.bn, i32 noundef %i.bs, i32 noundef 0, i32 noundef %.fr129) #5
...
bb.g:                                             ; preds = %._crit_edge
  %i.bv = add i32 %spec.select98, %.fr129         ; 3 uses
...
.lr.ph110.us.us.preheader:                        ; preds = %.lr.ph114.split.us
  %wide.trip.count150 = zext nneg i32 %.fr to i64 ; 2 uses
  %xtraiter173 = and i64 %wide.trip.count150, 3   ; 3 uses
  %i.cf = icmp ult i32 %.fr, 4
  %unroll_iter177 = and i64 %wide.trip.count150, 2147483644
...
.lr.ph110.us.us:                                  ; preds = %.lr.ph110.us.us.preheader, %._crit_edge111.split.us.us.us
  %indvars.iv152 = phi i64 [ %i.ce, %.lr.ph110.us.us.preheader ], [ %indvars.iv.next153, %._crit_edge111.split.us.us.us ] ; 2 uses
  %i.cg = getelementptr inbounds [8 x i8], ptr %i.x, i64 %indvars.iv152 ; 2 uses
...
.lr.ph104.us.us.us.new:                           ; preds = %.lr.ph104.us.us.us, %.lr.ph104.us.us.us.new
  %indvars.iv147 = phi i64 [ %indvars.iv.next148.3, %.lr.ph104.us.us.us.new ], [ 0, %.lr.ph104.us.us.us ] ; 5 uses
  %niter178 = phi i64 [ %niter178.next.3, %.lr.ph104.us.us.us.new ], [ 0, %.lr.ph104.us.us.us ]
  %i.cn = getelementptr inbounds nuw [128 x i8], ptr %.085107.us.us.us, i64 %indvars.iv147
  store i16 %i.cm, ptr %i.cn, align 2, !tbaa !75
  %i.co = getelementptr inbounds nuw [128 x i8], ptr %.085107.us.us.us, i64 %indvars.iv147
  %i.cp = getelementptr inbounds nuw i8, ptr %i.co, i64 128
  store i16 %i.cm, ptr %i.cp, align 2, !tbaa !75
  %i.cq = getelementptr inbounds nuw [128 x i8], ptr %.085107.us.us.us, i64 %indvars.iv147
  %i.cr = getelementptr inbounds nuw i8, ptr %i.cq, i64 256
  store i16 %i.cm, ptr %i.cr, align 2, !tbaa !75
  %i.cs = getelementptr inbounds nuw [128 x i8], ptr %.085107.us.us.us, i64 %indvars.iv147
...
.epil.preheader172:                               ; preds = %._crit_edge105.us.us.us.unr-lcssa, %.lr.ph104.us.us.us
  %indvars.iv147.epil.init = phi i64 [ 0, %.lr.ph104.us.us.us ], [ %indvars.iv.next148.3, %._crit_edge105.us.us.us.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod176)
  br label %bb.h

bb.h:                                             ; preds = %bb.h, %.epil.preheader172
  %indvars.iv147.epil = phi i64 [ %indvars.iv.next148.epil, %bb.h ], [ %indvars.iv147.epil.init, %.epil.preheader172 ] ; 2 uses
  %epil.iter174 = phi i64 [ %epil.iter174.next, %bb.h ], [ 0, %.epil.preheader172 ]
  %i.cu = getelementptr inbounds nuw [128 x i8], ptr %.085107.us.us.us, i64 %indvars.iv147.epil
...
._crit_edge111.split.us.us.us:                    ; preds = %._crit_edge105.us.us.us
  ...
  %i.da = icmp slt i64 %indvars.iv.next153, %i.cz
  br i1 %i.da, label %.lr.ph110.us.us, label %.loopexit99, !llvm.loop !95

.lr.ph110.us:                                     ; preds = %.lr.ph114.split.us, %.lr.ph110.us
  %indvars.iv144 = phi i64 [ %indvars.iv.next145, %.lr.ph110.us ], [ %i.ce, %.lr.ph114.split.us ] ; 2 uses
  %i.db = getelementptr inbounds [8 x i8], ptr %i.x, i64 %indvars.iv144
  ...
  %i.df = icmp slt i64 %indvars.iv.next145, %i.de
  br i1 %i.df, label %.lr.ph110.us, label %.loopexit99, !llvm.loop !95

.lr.ph114.split:                                  ; preds = %.lr.ph114.split.preheader, %.lr.ph114.split
  %indvars.iv155 = phi i64 [ %i.cc, %.lr.ph114.split.preheader ], [ %indvars.iv.next156, %.lr.ph114.split ] ; 2 uses
  %i.dg = getelementptr inbounds [8 x i8], ptr %i.x, i64 %indvars.iv155
  ...
  %i.dk = icmp slt i64 %indvars.iv.next156, %i.dj
...
.loopexit99:                                      ; preds = %.lr.ph110.us, %._crit_edge111.split.us.us.us, %.lr.ph114.split, %bb.g, %._crit_edge
  ...
  %i.do = icmp slt i64 %indvars.iv.next159, %i.dn
