...
.lr.ph.split.us:                                  ; preds = %.lr.ph.split.us.preheader, %.loopexit.us
  %indvars.iv134.a = phi i64 [ %indvars.iv.next135, %.loopexit.us ], [ 0, %.lr.ph.split.us.preheader ] ; 3 uses
  %i.au = getelementptr inbounds nuw [8 x i8], ptr %i.x, i64 %indvars.iv134.a
  ...
  %indvars.iv134.tr = trunc i64 %indvars.iv134.a to i32
...
.lr.ph110.us.us:                                  ; preds = %.lr.ph110.us.us.preheader, %._crit_edge111.us.us
  %indvars.iv147.a = phi i64 [ %i.ce, %.lr.ph110.us.us.preheader ], [ %indvars.iv.next148, %._crit_edge111.us.us ] ; 2 uses
  %i.cg = getelementptr inbounds [8 x i8], ptr %i.x, i64 %indvars.iv147.a ; 2 uses
...
._crit_edge111.us.us:                             ; preds = %._crit_edge105.us.us
  %indvars.iv.next148 = add nsw i64 %indvars.iv147.a, 1 ; 2 uses
