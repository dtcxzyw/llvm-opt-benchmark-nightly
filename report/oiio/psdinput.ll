...
bb.d:                                             ; preds = %bb.d, %.epil.preheader149
  %store_forwarded.epil = phi i8 [ %store_forwarded.epil.init, %.epil.preheader149 ], [ %i.y, %bb.d ]
  %.05795.epil = phi i64 [ %.05795.epil.init, %.epil.preheader149 ], [ %i.z, %bb.d ] ; 2 uses
...
vector.ph125:                                     ; preds = %vector.main.loop.iter.check
  %n.vec126 = and i64 %i.an, 9223372036854775792  ; 4 uses
  br label %vector.body127

vector.body127:                                   ; preds = %vector.body127, %vector.ph125
  %index128 = phi i64 [ 0, %vector.ph125 ], [ %index.next131, %vector.body127 ] ; 2 uses
  %i.ao = getelementptr inbounds nuw [2 x i8], ptr %3, i64 %index128 ; 3 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ao, i64 16 ; 2 uses
  %wide.load129.a = load <8 x i16>, ptr %i.ao, align 2, !tbaa !26
  %wide.load130 = load <8 x i16>, ptr %i.ap, align 2, !tbaa !26
  %i.aq = tail call <8 x i16> @llvm.bswap.v8i16(<8 x i16> %wide.load129.a)
  %i.ar = tail call <8 x i16> @llvm.bswap.v8i16(<8 x i16> %wide.load130)
  ...
  br i1 %i.as, label %middle.block132, label %vector.body127, !llvm.loop !435

middle.block132:                                  ; preds = %vector.body127
  %cmp.n133 = icmp eq i64 %i.an, %n.vec126
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec134 = and i64 %i.an, 9223372036854775804  ; 3 uses
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index135 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next137, %vec.epilog.vector.body ] ; 2 uses
  %i.au = getelementptr inbounds nuw [2 x i8], ptr %3, i64 %index135 ; 2 uses
  %wide.load136 = load <4 x i16>, ptr %i.au, align 2, !tbaa !26
  %i.av = tail call <4 x i16> @llvm.bswap.v4i16(<4 x i16> %wide.load136)
  store <4 x i16> %i.av, ptr %i.au, align 2, !tbaa !26
  %index.next137 = add nuw i64 %index135, 4       ; 2 uses
  %i.aw = icmp eq i64 %index.next137, %n.vec134
  br i1 %i.aw, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !436

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n138 = icmp eq i64 %i.an, %n.vec134
...
.preheader79.preheader:                           ; preds = %.preheader79.lr.ph
  ...
  %xtraiter146 = and i64 %i.bf, 3                 ; 3 uses
  %i.bg = add i32 %5, -2
...
.preheader79:                                     ; preds = %.preheader79.preheader, %._crit_edge93
  ...
  %scevgep140 = getelementptr i8, ptr %3, i64 %i.bi
...
.epil.preheader:                                  ; preds = %._crit_edge93.unr-lcssa, %.preheader79
  %store_forwarded142.epil.init = phi i16 [ %load_initial141, %.preheader79 ], [ %i.by, %._crit_edge93.unr-lcssa ]
  %.05592.epil.init = phi i64 [ 1, %.preheader79 ], [ %i.bz, %._crit_edge93.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod148)
  br label %bb.f

bb.f:                                             ; preds = %bb.f, %.epil.preheader
  %store_forwarded142.epil = phi i16 [ %store_forwarded142.epil.init, %.epil.preheader ], [ %i.bl, %bb.f ]
  ...
  %i.bl = add i16 %i.bk, %store_forwarded142.epil ; 2 uses
...
.preheader79.new:                                 ; preds = %.preheader79, %.preheader79.new
  %store_forwarded142 = phi i16 [ %i.by, %.preheader79.new ], [ %load_initial141, %.preheader79 ]
  ...
  %i.bp = add i16 %i.bo, %store_forwarded142      ; 2 uses
...
.lr.ph.i62:                                       ; preds = %.lr.ph.i62.preheader144, %.lr.ph.i62
  %.06.i63 = phi i64 [ %i.cn, %.lr.ph.i62 ], [ %.06.i63.ph, %.lr.ph.i62.preheader144 ] ; 2 uses
