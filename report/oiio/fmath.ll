...
.lr.ph27:                                         ; preds = %.preheader, %_ZN9Imath_3_14halfaSEf.exit16.1
  %.126 = phi i64 [ %5, %_ZN9Imath_3_14halfaSEf.exit16.1 ], [ %.0.lcssa, %.preheader ]
  %.11025 = phi ptr [ %i.fx, %_ZN9Imath_3_14halfaSEf.exit16.1 ], [ %.09.lcssa, %.preheader ] ; 2 uses
  %.11224 = phi ptr [ %i.fv, %_ZN9Imath_3_14halfaSEf.exit16.1 ], [ %.011.lcssa, %.preheader ] ; 2 uses
...
bb.aq:                                            ; preds = %bb.ap
  ...
  br i1 %i.gh, label %_ZN9Imath_3_14halfaSEf.exit16.1, label %bb.ar
...
bb.ar:                                            ; preds = %bb.aq
  ...
  br label %_ZN9Imath_3_14halfaSEf.exit16.1
...
bb.av:                                            ; preds = %.lr.ph27
  ...
  br i1 %i.gz, label %_ZN9Imath_3_14halfaSEf.exit16.1, label %bb.aw
...
bb.ax:                                            ; preds = %bb.aw
  ...
  %i.hm = and i32 %i.hg, 1
  %.not.i.i.i13.1 = icmp eq i32 %i.hm, 0
  %or.cond.i.i.i14.1 = select i1 %i.hl, i1 true, i1 %.not.i.i.i13.1
  br i1 %or.cond.i.i.i14.1, label %_ZN9Imath_3_14halfaSEf.exit16.1, label %bb.ay

bb.ay:                                            ; preds = %bb.ax, %bb.aw
  %i.hn = add nuw i16 %i.hj, 1
  br label %_ZN9Imath_3_14halfaSEf.exit16.1

_ZN9Imath_3_14halfaSEf.exit16.1:                  ; preds = %bb.aq, %bb.ar, %bb.at, %bb.au, %bb.av, %bb.ax, %bb.ay
  %.0.i.i.i15.1 = phi i16 [ %i.gd, %bb.av ], [ %i.go, %bb.ar ], [ %i.gq, %bb.at ], [ %i.gy, %bb.au ], [ %i.gg, %bb.aq ], [ %i.hn, %bb.ay ], [ %i.hj, %bb.ax ]
  store i16 %.0.i.i.i15.1, ptr %.11025, align 2, !tbaa !7
  %.not.1 = icmp eq i64 %5, 0
  br i1 %.not.1, label %._crit_edge, label %.lr.ph27, !llvm.loop !19

._crit_edge:                                      ; preds = %_ZN9Imath_3_14halfaSEf.exit16.1, %.preheader
  ret void
}
