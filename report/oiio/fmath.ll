...
49:                                               ; preds = %34
  ...
  br i1 %51, label %_ZN9Imath_3_14halfaSEf.exit16.1, label %52
...
_ZN9Imath_3_14halfaSEf.exit16.1:                  ; preds = %52, %49, %47, %38, %bb.ay, %bb.ax, %bb.av
  %.0.i.i.i15.1 = phi i16 [ %32, %bb.av ], [ %59, %52 ], [ %48, %47 ], [ %46, %38 ], [ %50, %49 ], [ %i.hn, %bb.ay ], [ %i.hj, %bb.ax ]
  store i16 %.0.i.i.i15.1, ptr %i.fx, align 2, !tbaa !7
  %.not.1 = icmp eq i64 %.0.lcssa, 2
  br i1 %.not.1, label %._crit_edge, label %.lr.ph27.2

.lr.ph27.2:                                       ; preds = %_ZN9Imath_3_14halfaSEf.exit16.1
...
._crit_edge:                                      ; preds = %_ZN9Imath_3_14halfaSEf.exit16, %_ZN9Imath_3_14halfaSEf.exit16.1, %_ZN9Imath_3_14halfaSEf.exit16.2, %.preheader
  ret void
}
