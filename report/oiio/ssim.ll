...
scalar.ph.preheader:                              ; preds = %vector.scevcheck, %.preheader, %middle.block
  ...
  %.sroa.18.174.ph = phi i32 [ %.sroa.18.087, %vector.scevcheck ], [ %.sroa.18.087, %.preheader ], [ %i.bg, %middle.block ]
  %.sroa.15.173.ph = phi i32 [ %.sroa.15.086, %vector.scevcheck ], [ %.sroa.15.086, %.preheader ], [ %i.bh, %middle.block ]
  %.sroa.12.172.ph = phi i32 [ %.sroa.12.085, %vector.scevcheck ], [ %.sroa.12.085, %.preheader ], [ %i.bi, %middle.block ]
  %.sroa.9.171.ph = phi i32 [ %.sroa.9.084, %vector.scevcheck ], [ %.sroa.9.084, %.preheader ], [ %i.bj, %middle.block ]
  %.sroa.6.170.ph = phi i32 [ %.sroa.6.083, %vector.scevcheck ], [ %.sroa.6.083, %.preheader ], [ %i.bk, %middle.block ]
  %.sroa.0.169.ph = phi i32 [ %.sroa.0.082, %vector.scevcheck ], [ %.sroa.0.082, %.preheader ], [ %i.bl, %middle.block ]
  br label %scalar.ph
