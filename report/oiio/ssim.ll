...
scalar.ph.preheader:                              ; preds = %.preheader, %middle.block
  ...
  %.sroa.18.174.ph = phi i32 [ %.sroa.18.087, %.preheader ], [ %i.bf, %middle.block ]
  %.sroa.15.173.ph = phi i32 [ %.sroa.15.086, %.preheader ], [ %i.bg, %middle.block ]
  %.sroa.12.172.ph = phi i32 [ %.sroa.12.085, %.preheader ], [ %i.bh, %middle.block ]
  %.sroa.9.171.ph = phi i32 [ %.sroa.9.084, %.preheader ], [ %i.bi, %middle.block ]
  %.sroa.6.170.ph = phi i32 [ %.sroa.6.083, %.preheader ], [ %i.bj, %middle.block ]
  %.sroa.0.169.ph = phi i32 [ %.sroa.0.082, %.preheader ], [ %i.bk, %middle.block ]
  br label %scalar.ph
