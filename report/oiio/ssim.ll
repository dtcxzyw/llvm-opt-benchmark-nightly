...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx135 = add i64 %i.t, %index           ; 3 uses
  ...
  %i.au = getelementptr inbounds i8, ptr %.090, i64 %offset.idx135
  %wide.load136.a = load <4 x i8>, ptr %i.au, align 1, !tbaa !17
  %i.av = zext <4 x i8> %wide.load136.a to <4 x i32> ; 2 uses
  %i.aw = getelementptr inbounds i8, ptr %.05189, i64 %offset.idx135
