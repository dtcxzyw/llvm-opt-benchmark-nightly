...
bb.a:
  ...
  %12 = fmul <2 x float> %11, <float 1.000000e+00, float 0.000000e+00> ; 2 uses
  %13 = extractelement <2 x float> %12, i64 1
  %14 = fadd float %3, %13
  %15 = insertelement <2 x float> poison, float %3, i64 0
  %16 = shufflevector <2 x float> %15, <2 x float> poison, <2 x i32> zeroinitializer
  %17 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %16, <2 x float> zeroinitializer, <2 x float> %12)
  %18 = insertelement <4 x float> poison, float %14, i64 0
  %19 = shufflevector <2 x float> %17, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %20 = shufflevector <4 x float> %18, <4 x float> %19, <4 x i32> <i32 0, i32 4, i32 5, i32 0>
  %21 = fadd <4 x float> %20, <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00> ; 3 uses
  %22 = extractelement <4 x float> %21, i64 2
  %23 = tail call float @llvm.fmuladd.f32(float %i.c, float 0.000000e+00, float %i.d)
  %sin.i.i = extractvalue { float, float } %sincos.i.i, 0 ; 5 uses
  %i.e = fmul float %sin.i.i, 0.000000e+00
  %24 = fneg float %sin.i.i                       ; 2 uses
  %25 = insertelement <4 x float> poison, float %24, i64 0
  %i.f = fmul float %4, -0.000000e+00             ; 2 uses
  %.scalar30 = fsub float %i.f, %3
  %.scalar31 = fadd float %.scalar30, 0.000000e+00 ; 3 uses
  %i.g = insertelement <4 x float> <float poison, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, float %.scalar31, i64 0
  %26 = fadd float %23, 0.000000e+00              ; 2 uses
  %27 = tail call float @llvm.fmuladd.f32(float %i.c, float 0.000000e+00, float %i.f)
  %28 = fadd float %27, 1.000000e+00              ; 3 uses
  %cos.i.i = extractvalue { float, float } %sincos.i.i, 1 ; 6 uses
  %29 = fsub float %cos.i.i, %i.e
  %30 = fmul float %cos.i.i, 0.000000e+00
  %i.h = fadd float %sin.i.i, %30
  %31 = fmul float %cos.i.i, %26
  %32 = tail call float @llvm.fmuladd.f32(float %.scalar31, float %sin.i.i, float %31)
  %i.i = insertelement <2 x float> poison, float %cos.i.i, i64 0
  %33 = insertelement <2 x float> %i.i, float %28, i64 1
  %34 = insertelement <4 x float> poison, float %26, i64 0
  %35 = insertelement <4 x float> %34, float %cos.i.i, i64 1
  ...
  %38 = insertelement <4 x float> <float poison, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, float %24, i64 0
  %39 = fmul <4 x float> %37, %38
  %i.j = insertelement <4 x float> poison, float %cos.i.i, i64 0
  %40 = insertelement <4 x float> %i.j, float %sin.i.i, i64 1
  %41 = insertelement <4 x float> %40, float %28, i64 2
  %42 = insertelement <4 x float> %41, float %.scalar31, i64 3
  %43 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.g, <4 x float> %42, <4 x float> %39) ; 5 uses
  %44 = shufflevector <4 x float> %25, <4 x float> %43, <2 x i32> <i32 0, i32 4>
  %45 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %33, <2 x float> zeroinitializer, <2 x float> %44) ; 2 uses
  %46 = shufflevector <2 x float> %45, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 1>
  %47 = shufflevector <4 x float> %46, <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, <4 x i32> <i32 0, i32 0, i32 6, i32 3>
  %48 = fadd <4 x float> %47, <float 0.000000e+00, float 0.000000e+00, float -0.000000e+00, float -0.000000e+00> ; 2 uses
  %49 = extractelement <4 x float> %43, i64 3
  %50 = fadd float %28, %49                       ; 2 uses
  %51 = extractelement <4 x float> %43, i64 2
  %52 = fmul float %51, 0.000000e+00              ; 2 uses
  %53 = extractelement <2 x float> %45, i64 1     ; 2 uses
  %54 = fadd float %53, %52
  %i.k = extractelement <4 x float> %43, i64 1
  %i.l = fadd float %i.k, 0.000000e+00            ; 2 uses
  %55 = fmul float %i.l, 0.000000e+00             ; 2 uses
  %i.m = insertelement <4 x float> poison, float %i.l, i64 0
  %56 = insertelement <4 x float> %i.m, float %55, i64 1
  %i.n = insertelement <4 x float> %56, float %54, i64 2
  %57 = shufflevector <4 x float> %i.n, <4 x float> %43, <4 x i32> <i32 0, i32 1, i32 2, i32 6>
  %i.o = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %48, <4 x float> zeroinitializer, <4 x float> %57)
  %58 = tail call float @llvm.fmuladd.f32(float %53, float 0.000000e+00, float %52)
  %59 = fadd float %29, 0.000000e+00              ; 2 uses
  %60 = extractelement <4 x float> %48, i64 0
  %61 = fadd float %60, %55
  %62 = fadd float %i.h, 0.000000e+00             ; 2 uses
  %63 = fmul float %62, 0.000000e+00              ; 2 uses
  %i.p = fadd float %59, %63
  ...
  %68 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %65, <2 x float> zeroinitializer, <2 x float> %67)
  %69 = insertelement <4 x float> poison, float %i.p, i64 0
  %70 = shufflevector <2 x float> %68, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %71 = shufflevector <4 x float> %69, <4 x float> %70, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %i.q = insertelement <4 x float> %71, float %61, i64 3
  %i.r = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %21, <4 x float> zeroinitializer, <4 x float> %i.q)
  %i.s = insertelement <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float poison>, float %50, i64 2
  %i.t = shufflevector <4 x float> %i.s, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.u = shufflevector <4 x float> %21, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %i.v = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.t, <4 x float> %i.u, <4 x float> %i.o)
  %i.w = tail call float @llvm.fmuladd.f32(float %50, float %22, float %58)
...
bb.a:
  ...
  %22 = fmul <2 x float> %21, <float 1.000000e+00, float 0.000000e+00> ; 2 uses
  %23 = extractelement <2 x float> %22, i64 1
  %24 = fadd float %3, %23
  %25 = insertelement <2 x float> poison, float %3, i64 0
  %26 = shufflevector <2 x float> %25, <2 x float> poison, <2 x i32> zeroinitializer
  %27 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %26, <2 x float> zeroinitializer, <2 x float> %22)
  ...
  %30 = shufflevector <4 x float> %28, <4 x float> %29, <4 x i32> <i32 0, i32 4, i32 5, i32 0>
  %31 = fadd <4 x float> %30, <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00> ; 3 uses
  %32 = extractelement <4 x float> %31, i64 2
  %33 = tail call float @llvm.fmuladd.f32(float %i.e, float 0.000000e+00, float %i.f)
  %sin.i.i = extractvalue { float, float } %sincos.i.i, 0 ; 5 uses
  %i.g = fmul float %sin.i.i, 0.000000e+00
  %34 = fneg float %sin.i.i                       ; 2 uses
  %35 = insertelement <4 x float> poison, float %34, i64 0
  %i.h = fmul float %4, -0.000000e+00             ; 2 uses
  %.scalar39 = fsub float %i.h, %3
  %.scalar40 = fadd float %.scalar39, 0.000000e+00 ; 3 uses
  %i.i = insertelement <4 x float> <float poison, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, float %.scalar40, i64 0
  %36 = fadd float %33, 0.000000e+00              ; 2 uses
  %37 = tail call float @llvm.fmuladd.f32(float %i.e, float 0.000000e+00, float %i.h)
  %38 = fadd float %37, 1.000000e+00              ; 3 uses
  %cos.i.i = extractvalue { float, float } %sincos.i.i, 1 ; 6 uses
  %39 = fsub float %cos.i.i, %i.g
  %40 = fmul float %cos.i.i, 0.000000e+00
  %i.j = fadd float %sin.i.i, %40
  %41 = fmul float %cos.i.i, %36
  %42 = tail call float @llvm.fmuladd.f32(float %.scalar40, float %sin.i.i, float %41)
  %i.k = insertelement <2 x float> poison, float %cos.i.i, i64 0
  %43 = insertelement <2 x float> %i.k, float %38, i64 1
  %44 = insertelement <4 x float> poison, float %36, i64 0
  %45 = insertelement <4 x float> %44, float %cos.i.i, i64 1
  ...
  %48 = insertelement <4 x float> <float poison, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, float %34, i64 0
  %49 = fmul <4 x float> %47, %48
  %i.l = insertelement <4 x float> poison, float %cos.i.i, i64 0
  %50 = insertelement <4 x float> %i.l, float %sin.i.i, i64 1
  %51 = insertelement <4 x float> %50, float %38, i64 2
  %52 = insertelement <4 x float> %51, float %.scalar40, i64 3
  %53 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.i, <4 x float> %52, <4 x float> %49) ; 5 uses
  %54 = shufflevector <4 x float> %35, <4 x float> %53, <2 x i32> <i32 0, i32 4>
  %55 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %43, <2 x float> zeroinitializer, <2 x float> %54) ; 2 uses
  %56 = shufflevector <2 x float> %55, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 1>
  %57 = shufflevector <4 x float> %56, <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, <4 x i32> <i32 0, i32 0, i32 6, i32 3>
  %58 = fadd <4 x float> %57, <float 0.000000e+00, float 0.000000e+00, float -0.000000e+00, float -0.000000e+00> ; 2 uses
  %59 = extractelement <4 x float> %53, i64 3
  %60 = fadd float %38, %59                       ; 2 uses
  %61 = extractelement <4 x float> %53, i64 2
  %62 = fmul float %61, 0.000000e+00              ; 2 uses
  %63 = extractelement <2 x float> %55, i64 1     ; 2 uses
  %64 = fadd float %63, %62
  %i.m = extractelement <4 x float> %53, i64 1
  %i.n = fadd float %i.m, 0.000000e+00            ; 2 uses
  %65 = fmul float %i.n, 0.000000e+00             ; 2 uses
  %i.o = insertelement <4 x float> poison, float %i.n, i64 0
  %66 = insertelement <4 x float> %i.o, float %65, i64 1
  %i.p = insertelement <4 x float> %66, float %64, i64 2
  %67 = shufflevector <4 x float> %i.p, <4 x float> %53, <4 x i32> <i32 0, i32 1, i32 2, i32 6>
  %i.q = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %58, <4 x float> zeroinitializer, <4 x float> %67)
  %68 = tail call float @llvm.fmuladd.f32(float %63, float 0.000000e+00, float %62)
  %69 = fadd float %39, 0.000000e+00              ; 2 uses
  %70 = extractelement <4 x float> %58, i64 0
  %71 = fadd float %70, %65
  %72 = fadd float %i.j, 0.000000e+00             ; 2 uses
  %73 = fmul float %72, 0.000000e+00              ; 2 uses
  %i.r = fadd float %69, %73
  ...
  %78 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %75, <2 x float> zeroinitializer, <2 x float> %77)
  %79 = insertelement <4 x float> poison, float %i.r, i64 0
  %80 = shufflevector <2 x float> %78, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %81 = shufflevector <4 x float> %79, <4 x float> %80, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %i.s = insertelement <4 x float> %81, float %71, i64 3
  %i.t = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %31, <4 x float> zeroinitializer, <4 x float> %i.s)
  %i.u = insertelement <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float poison>, float %60, i64 2
  %i.v = shufflevector <4 x float> %i.u, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.w = shufflevector <4 x float> %31, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %i.x = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.v, <4 x float> %i.w, <4 x float> %i.q)
  %i.y = tail call float @llvm.fmuladd.f32(float %60, float %32, float %68)
...
bb.a:
  ...
  %i.o = fneg float %i.l                          ; 2 uses
  %9 = call float @llvm.copysign.f32(float 0.000000e+00, float %i.o) ; 2 uses
  %sincos.i.i.i = call { float, float } @llvm.sincos.f32(float %2) ; 2 uses
  %10 = call float @llvm.copysign.f32(float 0.000000e+00, float %i.l) ; 2 uses
  %sin.i.i.i = extractvalue { float, float } %sincos.i.i.i, 0 ; 5 uses
  %11 = fmul float %sin.i.i.i, 0.000000e+00
  %12 = fneg float %sin.i.i.i                     ; 2 uses
  %13 = insertelement <4 x float> poison, float %12, i64 0
  %.scalar = fmul nnan float %i.e, 5.000000e-01   ; 4 uses
  %14 = insertelement <4 x float> poison, float %.scalar, i64 0
  %15 = fneg float %.scalar                       ; 2 uses
  %.scalar8 = fsub float %9, %.scalar
  %.scalar9 = fadd float %.scalar8, 0.000000e+00  ; 3 uses
  %16 = insertelement <4 x float> <float poison, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, float %.scalar9, i64 0
  %17 = call float @llvm.fmuladd.f32(float %15, float 0.000000e+00, float %i.o)
  %18 = fadd float %17, 0.000000e+00              ; 2 uses
  %19 = call float @llvm.fmuladd.f32(float %15, float 0.000000e+00, float %9)
  %20 = fadd float %19, 1.000000e+00              ; 3 uses
  %cos.i.i.i = extractvalue { float, float } %sincos.i.i.i, 1 ; 6 uses
  %21 = fsub float %cos.i.i.i, %11
  %i.p = fmul float %cos.i.i.i, 0.000000e+00
  %22 = fadd float %sin.i.i.i, %i.p
  %i.q = fmul float %cos.i.i.i, %18
  %23 = call float @llvm.fmuladd.f32(float %.scalar9, float %sin.i.i.i, float %i.q)
  %24 = insertelement <2 x float> poison, float %cos.i.i.i, i64 0
  %25 = insertelement <2 x float> %24, float %20, i64 1
  %i.r = insertelement <4 x float> poison, float %18, i64 0
  %i.s = insertelement <4 x float> %i.r, float %cos.i.i.i, i64 1
  %i.t = insertelement <4 x float> %i.s, float %23, i64 2
  %26 = shufflevector <4 x float> %i.t, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0>
  %27 = insertelement <4 x float> <float poison, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, float %12, i64 0
  %28 = fmul <4 x float> %26, %27
  %29 = insertelement <4 x float> poison, float %cos.i.i.i, i64 0
  %30 = insertelement <4 x float> %29, float %sin.i.i.i, i64 1
  %31 = insertelement <4 x float> %30, float %20, i64 2
  %32 = insertelement <4 x float> %31, float %.scalar9, i64 3
  %33 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %16, <4 x float> %32, <4 x float> %28) ; 5 uses
  %34 = shufflevector <4 x float> %13, <4 x float> %33, <2 x i32> <i32 0, i32 4>
  %i.u = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %25, <2 x float> zeroinitializer, <2 x float> %34) ; 2 uses
  %35 = shufflevector <2 x float> %i.u, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 1>
  %36 = shufflevector <4 x float> %35, <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, <4 x i32> <i32 0, i32 0, i32 6, i32 3>
  %i.v = fadd <4 x float> %36, <float 0.000000e+00, float 0.000000e+00, float -0.000000e+00, float -0.000000e+00> ; 2 uses
  %37 = extractelement <4 x float> %33, i64 3
  %i.w = fadd float %20, %37                      ; 2 uses
  %38 = fadd float %.scalar, %10
  %i.x = shufflevector <4 x float> %14, <4 x float> poison, <2 x i32> zeroinitializer
  %i.y = insertelement <2 x float> poison, float %i.l, i64 0
  %i.z = insertelement <2 x float> %i.y, float %10, i64 1
  ...
  %40 = fmul float %39, 0.000000e+00              ; 2 uses
  %41 = extractelement <2 x float> %i.u, i64 1    ; 2 uses
  %42 = fadd float %41, %40
  %i.ab = extractelement <4 x float> %33, i64 1
  %i.ac = fadd float %i.ab, 0.000000e+00          ; 2 uses
  %43 = fmul float %i.ac, 0.000000e+00            ; 2 uses
  %44 = insertelement <4 x float> poison, float %i.ac, i64 0
  %i.ad = insertelement <4 x float> %44, float %43, i64 1
  %i.ae = insertelement <4 x float> %i.ad, float %42, i64 2
  %45 = shufflevector <4 x float> %i.ae, <4 x float> %33, <4 x i32> <i32 0, i32 1, i32 2, i32 6>
  %46 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.v, <4 x float> zeroinitializer, <4 x float> %45)
  %47 = call float @llvm.fmuladd.f32(float %41, float 0.000000e+00, float %40)
  %48 = fadd float %21, 0.000000e+00              ; 2 uses
  %i.af = insertelement <4 x float> poison, float %38, i64 0
  %49 = shufflevector <2 x float> %i.aa, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %50 = shufflevector <4 x float> %i.af, <4 x float> %49, <4 x i32> <i32 0, i32 4, i32 5, i32 0>
  %i.ag = fadd <4 x float> %50, <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00> ; 3 uses
  %i.ah = extractelement <4 x float> %i.v, i64 0
  %51 = fadd float %i.ah, %43
  %52 = fadd float %22, 0.000000e+00              ; 2 uses
  %i.ai = fmul float %52, 0.000000e+00            ; 2 uses
  %i.aj = fadd float %48, %i.ai
  %53 = insertelement <2 x float> poison, float %48, i64 0
  %54 = shufflevector <2 x float> %53, <2 x float> poison, <2 x i32> zeroinitializer
  %55 = insertelement <2 x float> poison, float %52, i64 0
  %56 = insertelement <2 x float> %55, float %i.ai, i64 1
  %57 = call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %54, <2 x float> zeroinitializer, <2 x float> %56)
  %58 = insertelement <4 x float> poison, float %i.aj, i64 0
  %59 = shufflevector <2 x float> %57, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %60 = shufflevector <4 x float> %58, <4 x float> %59, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %i.ak = insertelement <4 x float> %60, float %51, i64 3
  %i.al = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ag, <4 x float> zeroinitializer, <4 x float> %i.ak)
  %61 = extractelement <4 x float> %i.ag, i64 2
  %i.am = insertelement <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float poison>, float %i.w, i64 2
  %i.an = shufflevector <4 x float> %i.am, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %i.ao = shufflevector <4 x float> %i.ag, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %i.ap = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.an, <4 x float> %i.ao, <4 x float> %46)
  %i.aq = call float @llvm.fmuladd.f32(float %i.w, float %61, float %47)
...
bb.a:
  ...
  %23 = tail call float @llvm.fmuladd.f32(float %i.c, float 0.000000e+00, float %i.d)
  %sin.i.i.i = extractvalue { float, float } %sincos.i.i.i, 0 ; 5 uses
  %i.e = fmul float %sin.i.i.i, 0.000000e+00
  %24 = fneg float %sin.i.i.i                     ; 2 uses
  %25 = insertelement <4 x float> poison, float %24, i64 0
  %i.f = fmul float %4, -0.000000e+00             ; 2 uses
  %.scalar10 = fsub float %i.f, %3
  %.scalar11 = fadd float %.scalar10, 0.000000e+00 ; 3 uses
  %i.g = insertelement <4 x float> <float poison, float 0.000000e+00, float 0.000000e+00, float 0.000000e+00>, float %.scalar11, i64 0
  %26 = fadd float %23, 0.000000e+00              ; 2 uses
  %27 = tail call float @llvm.fmuladd.f32(float %i.c, float 0.000000e+00, float %i.f)
  %28 = fadd float %27, 1.000000e+00              ; 3 uses
  %cos.i.i.i = extractvalue { float, float } %sincos.i.i.i, 1 ; 6 uses
  %29 = fsub float %cos.i.i.i, %i.e
  %30 = fmul float %cos.i.i.i, 0.000000e+00
  %i.h = fadd float %sin.i.i.i, %30
  %31 = fmul float %cos.i.i.i, %26
  %32 = tail call float @llvm.fmuladd.f32(float %.scalar11, float %sin.i.i.i, float %31)
  %i.i = insertelement <2 x float> poison, float %cos.i.i.i, i64 0
  %33 = insertelement <2 x float> %i.i, float %28, i64 1
  %34 = insertelement <4 x float> poison, float %26, i64 0
  %35 = insertelement <4 x float> %34, float %cos.i.i.i, i64 1
  %36 = insertelement <4 x float> %35, float %32, i64 2
  %37 = shufflevector <4 x float> %36, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 0>
  %38 = insertelement <4 x float> <float poison, float 1.000000e+00, float 1.000000e+00, float 0.000000e+00>, float %24, i64 0
  %39 = fmul <4 x float> %37, %38
  %i.j = insertelement <4 x float> poison, float %cos.i.i.i, i64 0
  %40 = insertelement <4 x float> %i.j, float %sin.i.i.i, i64 1
  %41 = insertelement <4 x float> %40, float %28, i64 2
  %42 = insertelement <4 x float> %41, float %.scalar11, i64 3
  %43 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.g, <4 x float> %42, <4 x float> %39) ; 5 uses
  %44 = shufflevector <4 x float> %25, <4 x float> %43, <2 x i32> <i32 0, i32 4>
  %45 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %33, <2 x float> zeroinitializer, <2 x float> %44) ; 2 uses
  %46 = shufflevector <2 x float> %45, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 1>
