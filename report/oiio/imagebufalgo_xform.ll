...
bb.q:                                             ; preds = %bb.p
  ...
  %40 = load <4 x float>, ptr %i.an, align 4
  %i.ao = getelementptr inbounds nuw i8, ptr %2, i64 20
  %41 = load <4 x float>, ptr %i.ao, align 4
  ...
  %i.bb = insertelement <2 x float> %i.av, float %i.ak, i64 0 ; 2 uses
  %i.bc = shufflevector <4 x float> %41, <4 x float> poison, <2 x i32> zeroinitializer
  %i.bd = fmul <2 x float> %i.bb, %i.bc           ; 2 uses
  %i.be = shufflevector <2 x float> %i.bb, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.bo = shufflevector <4 x float> %40, <4 x float> poison, <2 x i32> zeroinitializer ; 2 uses
