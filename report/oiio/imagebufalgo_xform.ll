...
bb.a:
  ...
  %11 = fadd float %10, 1.000000e+00              ; 3 uses
  ...
  %12 = tail call float @llvm.fmuladd.f32(float %sin.i.i, float 0.000000e+00, float %cos.i.i)
  %13 = fadd float %12, 0.000000e+00              ; 2 uses
  %i.o = fmul float %i.i, %i.j
  %14 = tail call float @llvm.fmuladd.f32(float %i.g, float %cos.i.i, float %i.o)
  %15 = fmul float %cos.i.i, %i.i
  %16 = tail call float @llvm.fmuladd.f32(float %i.g, float %sin.i.i, float %15)
  %17 = tail call float @llvm.fmuladd.f32(float %11, float 0.000000e+00, float %16) ; 2 uses
  %18 = fmul float %i.i, 0.000000e+00
  %19 = tail call float @llvm.fmuladd.f32(float %i.g, float 0.000000e+00, float %18)
  %20 = fadd float %11, %19                       ; 2 uses
  %21 = fmul float %13, 0.000000e+00              ; 2 uses
  %22 = fmul float %17, 0.000000e+00              ; 2 uses
  ...
  %i.an = extractelement <4 x float> %i.ab, i64 2
  %i.ao = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %cos.i.i, i64 0
  %i.ap = insertelement <4 x float> %i.ao, float %11, i64 3
  %i.aq = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %i.j, i64 0
  %23 = insertelement <4 x float> %i.aq, float %14, i64 3
  %i.ar = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ap, <4 x float> <float 0.000000e+00, float poison, float 0.000000e+00, float 0.000000e+00>, <4 x float> %23) ; 2 uses
  %i.as = fadd <4 x float> %i.ar, <float 0.000000e+00, float poison, float -0.000000e+00, float -0.000000e+00> ; 2 uses
  %24 = shufflevector <4 x float> %i.as, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %i.at = extractelement <4 x float> %i.ar, i64 3 ; 2 uses
  %i.au = fadd float %i.at, %22
  %i.av = insertelement <4 x float> poison, float %13, i64 0
  %i.aw = insertelement <4 x float> %i.av, float %21, i64 1
  %i.ax = insertelement <4 x float> %i.aw, float %i.au, i64 2
  %i.ay = insertelement <4 x float> %i.ax, float %17, i64 3
  %i.az = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %24, <4 x float> zeroinitializer, <4 x float> %i.ay)
  %i.ba = tail call float @llvm.fmuladd.f32(float %i.at, float 0.000000e+00, float %22)
  %i.bb = extractelement <4 x float> %i.as, i64 0
  %i.bc = fadd float %i.bb, %21
  ...
  %i.bf = insertelement <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float poison>, float %20, i64 2
  ...
  %i.bj = tail call float @llvm.fmuladd.f32(float %20, float %i.an, float %i.ba)
...
bb.a:
  ...
  %21 = fadd float %20, 1.000000e+00              ; 3 uses
  %sincos.i.i = tail call { float, float } @llvm.sincos.f32(float %2) ; 2 uses
  %sin.i.i = extractvalue { float, float } %sincos.i.i, 0 ; 5 uses
  %cos.i.i = extractvalue { float, float } %sincos.i.i, 1 ; 6 uses
  ...
  %22 = tail call float @llvm.fmuladd.f32(float %sin.i.i, float 0.000000e+00, float %cos.i.i)
  %23 = fadd float %22, 0.000000e+00              ; 2 uses
  %i.q = fmul float %i.k, %i.l
  %24 = tail call float @llvm.fmuladd.f32(float %i.i, float %cos.i.i, float %i.q)
  %25 = fmul float %cos.i.i, %i.k
  %26 = tail call float @llvm.fmuladd.f32(float %i.i, float %sin.i.i, float %25)
  %27 = tail call float @llvm.fmuladd.f32(float %21, float 0.000000e+00, float %26) ; 2 uses
  %28 = fmul float %i.k, 0.000000e+00
  %29 = tail call float @llvm.fmuladd.f32(float %i.i, float 0.000000e+00, float %28)
  %30 = fadd float %21, %29                       ; 2 uses
  %31 = fmul float %23, 0.000000e+00              ; 2 uses
  ...
  %i.ap = extractelement <4 x float> %i.ad, i64 2
  %i.aq = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %cos.i.i, i64 0
  %i.ar = insertelement <4 x float> %i.aq, float %21, i64 3
  %i.as = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %i.l, i64 0
  %33 = insertelement <4 x float> %i.as, float %24, i64 3
  %i.at = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.ar, <4 x float> <float 0.000000e+00, float poison, float 0.000000e+00, float 0.000000e+00>, <4 x float> %33) ; 2 uses
  %i.au = fadd <4 x float> %i.at, <float 0.000000e+00, float poison, float -0.000000e+00, float -0.000000e+00> ; 2 uses
  %34 = shufflevector <4 x float> %i.au, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %i.av = extractelement <4 x float> %i.at, i64 3 ; 2 uses
  %i.aw = fadd float %i.av, %32
  %i.ax = insertelement <4 x float> poison, float %23, i64 0
  %i.ay = insertelement <4 x float> %i.ax, float %31, i64 1
  %i.az = insertelement <4 x float> %i.ay, float %i.aw, i64 2
  %i.ba = insertelement <4 x float> %i.az, float %27, i64 3
  %i.bb = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %34, <4 x float> zeroinitializer, <4 x float> %i.ba)
  %i.bc = tail call float @llvm.fmuladd.f32(float %i.av, float 0.000000e+00, float %32)
  %i.bd = extractelement <4 x float> %i.au, i64 0
  %i.be = fadd float %i.bd, %31
  ...
  %i.bh = insertelement <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float poison>, float %30, i64 2
  ...
  %i.bl = tail call float @llvm.fmuladd.f32(float %30, float %i.ap, float %i.bc)
...
bb.a:
  ...
  %10 = fadd float %9, 1.000000e+00               ; 3 uses
  ...
  %11 = call float @llvm.fmuladd.f32(float %sin.i.i.i, float 0.000000e+00, float %cos.i.i.i)
  %12 = fadd float %11, 0.000000e+00              ; 2 uses
  %i.ab = fmul float %i.v, %i.w
  %13 = call float @llvm.fmuladd.f32(float %i.t, float %cos.i.i.i, float %i.ab)
  %14 = fmul float %cos.i.i.i, %i.v
  %15 = call float @llvm.fmuladd.f32(float %i.t, float %sin.i.i.i, float %14)
  %16 = call float @llvm.fmuladd.f32(float %10, float 0.000000e+00, float %15) ; 2 uses
  %17 = fmul float %i.v, 0.000000e+00
  %18 = call float @llvm.fmuladd.f32(float %i.t, float 0.000000e+00, float %17)
  %i.ac = fadd float %10, %18                     ; 2 uses
  ...
  %i.ba = extractelement <4 x float> %i.ao, i64 2
  %i.bb = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %cos.i.i.i, i64 0
  %i.bc = insertelement <4 x float> %i.bb, float %10, i64 3
  %i.bd = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %i.w, i64 0
  %21 = insertelement <4 x float> %i.bd, float %13, i64 3
  %i.be = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.bc, <4 x float> <float 0.000000e+00, float poison, float 0.000000e+00, float 0.000000e+00>, <4 x float> %21) ; 2 uses
  %i.bf = fadd <4 x float> %i.be, <float 0.000000e+00, float poison, float -0.000000e+00, float -0.000000e+00> ; 2 uses
  %22 = shufflevector <4 x float> %i.bf, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %i.bg = extractelement <4 x float> %i.be, i64 3 ; 2 uses
  %i.bh = fadd float %i.bg, %20
  %i.bi = insertelement <4 x float> poison, float %12, i64 0
  %i.bj = insertelement <4 x float> %i.bi, float %19, i64 1
  %i.bk = insertelement <4 x float> %i.bj, float %i.bh, i64 2
  %i.bl = insertelement <4 x float> %i.bk, float %16, i64 3
  %i.bm = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %22, <4 x float> zeroinitializer, <4 x float> %i.bl)
  %i.bn = call float @llvm.fmuladd.f32(float %i.bg, float 0.000000e+00, float %20)
  %i.bo = extractelement <4 x float> %i.bf, i64 0
  %i.bp = fadd float %i.bo, %19
  ...
  %i.bw = call float @llvm.fmuladd.f32(float %i.ac, float %i.ba, float %i.bn)
...
bb.a:
  ...
  %12 = tail call float @llvm.fmuladd.f32(float %sin.i.i.i, float 0.000000e+00, float %cos.i.i.i)
  %13 = fadd float %12, 0.000000e+00              ; 2 uses
  %i.o = fmul float %i.i, %i.j
  %14 = tail call float @llvm.fmuladd.f32(float %i.g, float %cos.i.i.i, float %i.o)
  %15 = fmul float %cos.i.i.i, %i.i
  %16 = tail call float @llvm.fmuladd.f32(float %i.g, float %sin.i.i.i, float %15)
  %17 = tail call float @llvm.fmuladd.f32(float %11, float 0.000000e+00, float %16) ; 2 uses
  %18 = fmul float %i.i, 0.000000e+00
  %19 = tail call float @llvm.fmuladd.f32(float %i.g, float 0.000000e+00, float %18)
  %20 = fadd float %11, %19                       ; 2 uses
