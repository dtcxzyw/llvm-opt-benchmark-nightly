...
begin_hunk_0_@_ZZN11OpenImageIO4v3_1L7resize_IffEEbRNS0_8ImageBufERKS2_PKNS0_8Filter2DENS0_3ROIEiENKUlS9_E_clES9_:bb.a
  ...
  %i.ae = sitofp <2 x i32> %i.ad to <2 x float>   ; 2 uses
  %i.af = fdiv <2 x float> %i.ae, %i.ac           ; 5 uses
  %i.ag = fdiv <2 x float> splat (float 1.000000e+00), %i.ae ; 5 uses
  %i.ah = insertelement <2 x float> poison, float %i.aa, i64 0
  %i.ai = shufflevector <2 x float> %i.ah, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aj = fdiv <2 x float> %i.ai, %i.af
  %i.ak = tail call <2 x float> @llvm.ceil.v2f32(<2 x float> %i.aj)
  %i.al = fptosi <2 x float> %i.ak to <2 x i32>   ; 3 uses
  %i.am = extractelement <2 x i32> %i.al, i64 0   ; 11 uses
  %i.an = shl i32 %i.am, 1                        ; 5 uses
  %i.ao = or disjoint i32 %i.an, 1                ; 3 uses
  %i.ap = extractelement <2 x i32> %i.al, i64 1   ; 9 uses
  %i.aq = shl i32 %i.ap, 1                        ; 3 uses
  %i.ar = load ptr, ptr %i.x, align 8, !tbaa !21
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 16
  %i.at = load ptr, ptr %i.as, align 8
  %i.au = tail call noundef zeroext i1 %i.at(ptr noundef nonnull align 8 dereferenceable(16) %i.x) ; 2 uses
  %i.av = or disjoint i32 %i.aq, 1
  %i.aw = sext i32 %i.av to i64
  %i.ax = shl nsw i64 %i.aw, 2
  %i.ay = alloca i8, i64 %i.ax, align 16          ; 4 uses
  br i1 %i.au, label %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit, label %.loopexit423

_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit: ; preds = %bb.a
  %i.az = getelementptr inbounds nuw i8, ptr %1, i64 4 ; 2 uses
  %i.ba = load i32, ptr %i.az, align 4, !tbaa !164 ; 2 uses
  %i.bb = load i32, ptr %1, align 8, !tbaa !71    ; 3 uses
  %i.bc = sub nsw i32 %i.ba, %i.bb
  %i.bd = mul nsw i32 %i.bc, %i.ao                ; 2 uses
  %i.be = sext i32 %i.bd to i64
  %i.bf = icmp slt i32 %i.bd, 0
  %i.bg = shl nsw i64 %i.be, 2
  %i.bh = select i1 %i.bf, i64 -1, i64 %i.bg
  %i.bi = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %i.bh) #34 ; 4 uses
  %i.bj = icmp sge i32 %i.bb, %i.ba
  %.not309430 = icmp slt i32 %i.am, 0
  %or.cond = select i1 %i.bj, i1 true, i1 %.not309430
...
.lr.ph.preheader:                                 ; preds = %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit
  %smax = tail call i32 @llvm.smax.i32(i32 %i.an, i32 0) ; 2 uses
  %i.bk = or disjoint i32 %smax, 1
  %wide.trip.count = zext nneg i32 %i.bk to i64   ; 2 uses
  %i.bl = extractelement <2 x float> %i.ac, i64 0
  %i.bm = extractelement <2 x float> %i.ag, i64 0
  %i.bn = extractelement <2 x float> %i.af, i64 0
  %min.iters.check = icmp slt i32 %i.an, 4
  %i.bo = and i32 %smax, 2147483644
  %n.vec = zext nneg i32 %i.bo to i64             ; 2 uses
  br label %.lr.ph

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.loopexit422
  %.0245436 = phi i32 [ %i.cx, %.loopexit422 ], [ %i.bb, %.lr.ph.preheader ] ; 3 uses
  %i.bp = load i32, ptr %1, align 8, !tbaa !71
  %i.bq = sub nsw i32 %.0245436, %i.bp
  %i.br = mul nsw i32 %i.bq, %i.ao
  %i.bs = sext i32 %i.br to i64
  %i.bt = getelementptr inbounds [4 x i8], ptr %i.bi, i64 %i.bs ; 3 uses
  %i.bu = sitofp i32 %.0245436 to float
  %i.bv = fsub nnan float %i.bu, %i.r
  %i.bw = fadd nnan float %i.bv, 5.000000e-01
  %i.bx = fmul float %i.bm, %i.bw
  %i.by = tail call float @llvm.fmuladd.f32(float %i.bx, float %i.bl, float %i.j) ; 2 uses
  %i.bz = tail call noundef float @llvm.floor.f32(float %i.by)
  %i.ca = fsub float %i.by, %i.bz
  %i.cb = fadd float %i.ca, -5.000000e-01
  br label %bb.b

._crit_edge:                                      ; preds = %bb.c
  %i.cc = fcmp oeq float %i.cs, 0.000000e+00
  br i1 %i.cc, label %.loopexit422, label %.lr.ph435.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x float>, ptr %i.cd, align 4, !tbaa !77
  %i.ce = fdiv <4 x float> %wide.load, %broadcast.splat
  store <4 x float> %i.ce, ptr %i.cd, align 4, !tbaa !77
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cf = icmp eq i64 %index.next, %n.vec
  br i1 %i.cf, label %.lr.ph435.preheader688, label %vector.body, !llvm.loop !1023

bb.b:                                             ; preds = %.lr.ph, %bb.c
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %bb.c ] ; 3 uses
  %.0248432 = phi float [ 0.000000e+00, %.lr.ph ], [ %i.cs, %bb.c ]
  %i.cg = load ptr, ptr %i.v, align 8, !tbaa !1022, !nonnull !48, !align !386
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !49 ; 2 uses
  %i.ci = trunc i64 %indvars.iv to i32
  %i.cj = sub i32 %i.ci, %i.am
  %i.ck = sitofp i32 %i.cj to float
  %i.cl = fsub float %i.ck, %i.cb
  %i.cm = fmul float %i.bn, %i.cl
  %i.cn = load ptr, ptr %i.ch, align 8, !tbaa !21
  %i.co = getelementptr inbounds nuw i8, ptr %i.cn, i64 32
  %i.cp = load ptr, ptr %i.co, align 8
  %i.cq = invoke noundef float %i.cp(ptr noundef nonnull align 8 dereferenceable(16) %i.ch, float noundef %i.cm)
          to label %bb.c unwind label %bb.d       ; 2 uses

bb.c:                                             ; preds = %bb.b
  %i.cr = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %indvars.iv
  store float %i.cq, ptr %i.cr, align 4, !tbaa !77
  %i.cs = fadd float %.0248432, %i.cq             ; 4 uses
...
.lr.ph435:                                        ; preds = %.lr.ph435.preheader688, %.lr.ph435
  ...
  %i.cu = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %indvars.iv521 ; 2 uses
  %i.cv = load float, ptr %i.cu, align 4, !tbaa !77
  %i.cw = fdiv float %i.cv, %i.cs
  store float %i.cw, ptr %i.cu, align 4, !tbaa !77
...
.loopexit422:                                     ; preds = %.lr.ph435, %._crit_edge
  %i.cx = add nsw i32 %.0245436, 1                ; 2 uses
  %i.cy = load i32, ptr %i.az, align 4, !tbaa !164
  %i.cz = icmp slt i32 %i.cx, %i.cy
  br i1 %i.cz, label %.lr.ph, label %.loopexit423, !llvm.loop !1026

.loopexit423:                                     ; preds = %.loopexit422, %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit, %bb.a
  %.sroa.0392.0 = phi ptr [ null, %bb.a ], [ %i.bi, %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit ], [ %i.bi, %.loopexit422 ] ; 5 uses
  %.not = icmp eq i32 %i.g, 0
  br i1 %.not, label %bb.f, label %bb.e

bb.e:                                             ; preds = %.loopexit423
  %i.da = sext i32 %i.g to i64
  %i.db = shl nsw i64 %i.da, 2
  %i.dc = alloca i8, i64 %i.db, align 16
  br label %bb.f

bb.f:                                             ; preds = %.loopexit423, %bb.e
  %i.dd = phi ptr [ %i.dc, %bb.e ], [ null, %.loopexit423 ] ; 8 uses
  br i1 %i.au, label %bb.g, label %bb.bg

bb.g:                                             ; preds = %bb.f
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #33
  %i.de = load ptr, ptr %i.c, align 8, !tbaa !1021, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_RKNS0_3ROIENS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.de, ptr noundef nonnull align 4 dereferenceable(32) %1, i32 noundef 0, i1 noundef zeroext true)
...
_ZN11OpenImageIO4v3_18ImageBuf8IteratorIffEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit: ; preds = %bb.g
  ...
  %i.df = load ptr, ptr %0, align 8, !tbaa !1019, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_NS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %3, ptr noundef nonnull align 8 dereferenceable(16) %i.df, i32 noundef 2, i1 noundef zeroext false)
...
_ZN11OpenImageIO4v3_18ImageBuf13ConstIteratorIffEC2ERKS1_NS1_8WrapModeE.exit: ; preds = %_ZN11OpenImageIO4v3_18ImageBuf8IteratorIffEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit
  ...
  %i.di = getelementptr inbounds nuw i8, ptr %1, i64 12 ; 2 uses
  %i.dj = load i32, ptr %i.di, align 4, !tbaa !162
  %i.dk = icmp slt i32 %i.dh, %i.dj
  br i1 %i.dk, label %.lr.ph505, label %._crit_edge506
...
.lr.ph505:                                        ; preds = %_ZN11OpenImageIO4v3_18ImageBuf13ConstIteratorIffEC2ERKS1_NS1_8WrapModeE.exit
  ...
  %i.ds = getelementptr inbounds nuw i8, ptr %3, i64 112 ; 6 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %3, i64 60 ; 4 uses
  %i.du = getelementptr inbounds nuw i8, ptr %3, i64 40
  %i.dv = getelementptr inbounds nuw i8, ptr %3, i64 36
  %i.dw = getelementptr inbounds nuw i8, ptr %3, i64 64 ; 6 uses
  %i.dx = getelementptr inbounds nuw i8, ptr %3, i64 48
  %i.dy = getelementptr inbounds nuw i8, ptr %3, i64 44
  %i.dz = getelementptr inbounds nuw i8, ptr %3, i64 68 ; 5 uses
  %i.ea = getelementptr inbounds nuw i8, ptr %3, i64 56
  %i.eb = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.ec = getelementptr inbounds nuw i8, ptr %3, i64 9 ; 2 uses
  %i.ed = getelementptr inbounds nuw i8, ptr %3, i64 11
  %i.ee = getelementptr inbounds nuw i8, ptr %3, i64 10
  %i.ef = getelementptr inbounds nuw i8, ptr %3, i64 104 ; 2 uses
  %i.eg = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 2 uses
  %i.eh = getelementptr inbounds nuw i8, ptr %3, i64 92 ; 2 uses
  %i.ei = getelementptr inbounds nuw i8, ptr %3, i64 72 ; 3 uses
  %i.ej = getelementptr inbounds nuw i8, ptr %3, i64 80
  %i.ek = getelementptr inbounds nuw i8, ptr %3, i64 84
  %i.el = getelementptr inbounds nuw i8, ptr %3, i64 88
  %i.em = getelementptr inbounds nuw i8, ptr %3, i64 124
  %i.en = getelementptr inbounds nuw i8, ptr %3, i64 120
  %i.eo = getelementptr inbounds nuw i8, ptr %2, i64 112 ; 7 uses
  %i.ep = getelementptr inbounds nuw i8, ptr %2, i64 60 ; 3 uses
  %i.eq = getelementptr inbounds nuw i8, ptr %2, i64 40
  %i.er = getelementptr inbounds nuw i8, ptr %2, i64 36
  %i.es = getelementptr inbounds nuw i8, ptr %2, i64 64 ; 5 uses
  %i.et = getelementptr inbounds nuw i8, ptr %2, i64 48
  %i.eu = getelementptr inbounds nuw i8, ptr %2, i64 44
  %i.ev = getelementptr inbounds nuw i8, ptr %2, i64 68 ; 4 uses
  %i.ew = getelementptr inbounds nuw i8, ptr %2, i64 56
  %i.ex = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.ey = getelementptr inbounds nuw i8, ptr %2, i64 9 ; 2 uses
  %i.ez = getelementptr inbounds nuw i8, ptr %2, i64 11
  %i.fa = getelementptr inbounds nuw i8, ptr %2, i64 10
  %i.fb = getelementptr inbounds nuw i8, ptr %2, i64 104 ; 2 uses
  %i.fc = getelementptr inbounds nuw i8, ptr %2, i64 16 ; 2 uses
  %i.fd = getelementptr inbounds nuw i8, ptr %2, i64 92 ; 2 uses
  %i.fe = getelementptr inbounds nuw i8, ptr %2, i64 72 ; 2 uses
  %i.ff = getelementptr inbounds nuw i8, ptr %2, i64 80
  %i.fg = getelementptr inbounds nuw i8, ptr %2, i64 84
  %i.fh = getelementptr inbounds nuw i8, ptr %2, i64 88
  %i.fi = getelementptr inbounds nuw i8, ptr %2, i64 124
  %i.fj = getelementptr inbounds nuw i8, ptr %2, i64 120
  %i.fk = sext i32 %i.ap to i64
  %smax549 = call i32 @llvm.smax.i32(i32 %i.aq, i32 0) ; 2 uses
  %i.fl = or disjoint i32 %smax549, 1             ; 2 uses
  %i.fm = zext i32 %i.g to i64                    ; 6 uses
  %i.fn = shl nuw nsw i64 %i.fm, 2
  %smax564 = call i32 @llvm.smax.i32(i32 %i.an, i32 0) ; 2 uses
  %i.fo = or disjoint i32 %smax564, 1
  %i.fp = sext i32 %i.dq to i64
  %wide.trip.count550 = zext nneg i32 %i.fl to i64
  %wide.trip.count556 = zext nneg i32 %i.fl to i64
  %invariant.gep = getelementptr [4 x i8], ptr %i.ay, i64 %i.fk
  %wide.trip.count576 = zext nneg i32 %i.fo to i64
  %i.fq = extractelement <2 x i1> %i.dn, i64 1    ; 2 uses
  %i.fr = extractelement <2 x float> %i.ac, i64 1
  %i.fs = extractelement <2 x float> %i.ag, i64 1
  %i.ft = or disjoint i32 %smax564, 1
  %i.fu = zext nneg i32 %i.ft to i64              ; 2 uses
  %i.fv = extractelement <2 x float> %i.af, i64 1
  %min.iters.check670 = icmp slt i32 %i.aq, 4
  %i.fw = and i32 %smax549, 2147483644
  %n.vec673 = zext nneg i32 %i.fw to i64          ; 2 uses
  %i.fx = extractelement <2 x i1> %i.dn, i64 0
  %i.fy = extractelement <2 x float> %i.ac, i64 0
  %i.fz = extractelement <2 x float> %i.ag, i64 0
  %xtraiter = and i64 %i.fu, 7
  %i.ga = icmp slt i32 %i.an, 7
  %unroll_iter = and i64 %i.fu, 2147483640
  %min.iters.check653 = icmp ult i32 %i.g, 8
  %n.vec656 = and i64 %i.fm, 2147483640           ; 3 uses
  %cmp.n667 = icmp eq i64 %n.vec656, %i.fm
  br label %bb.n
...
bb.n:                                             ; preds = %.lr.ph505, %._crit_edge503
  %.0257504 = phi i32 [ %i.dh, %.lr.ph505 ], [ %i.hv, %._crit_edge503 ] ; 2 uses
  %i.gl = sitofp i32 %.0257504 to float
  %i.gm = fsub nnan float %i.gl, %i.u
  %i.gn = fadd nnan float %i.gm, 5.000000e-01
  %i.go = fmul float %i.fs, %i.gn
  %i.gp = call float @llvm.fmuladd.f32(float %i.go, float %i.fr, float %i.m) ; 2 uses
  %i.gq = call noundef float @llvm.floor.f32(float %i.gp) ; 2 uses
  %i.gr = fptosi float %i.gq to i32               ; 2 uses
  br i1 %i.fq, label %.loopexit415, label %.lr.ph470
...
vector.body676:                                   ; preds = %vector.body676, %vector.ph671
  ...
  %i.gv = getelementptr inbounds nuw [4 x i8], ptr %i.ay, i64 %index677 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  %i.hj = getelementptr inbounds nuw [4 x i8], ptr %i.ay, i64 %indvars.iv546
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cf = icmp eq i64 %index.next, %n.vec
  br i1 %i.cf, label %.lr.ph435.preheader688, label %vector.body, !llvm.loop !1049

bb.b:                                             ; preds = %.lr.ph, %bb.c
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %bb.c ] ; 3 uses
  %.0248432 = phi float [ 0.000000e+00, %.lr.ph ], [ %i.cs, %bb.c ]
  %i.cg = load ptr, ptr %i.v, align 8, !tbaa !1048, !nonnull !48, !align !386
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !49 ; 2 uses
  %i.ci = trunc i64 %indvars.iv to i32
  %i.cj = sub i32 %i.ci, %i.am
  %i.ck = sitofp i32 %i.cj to float
...
.loopexit422:                                     ; preds = %.lr.ph435, %._crit_edge
  ...
  %i.cy = load i32, ptr %i.az, align 4, !tbaa !164
  %i.cz = icmp slt i32 %i.cx, %i.cy
  br i1 %i.cz, label %.lr.ph, label %.loopexit423, !llvm.loop !1052
...
bb.g:                                             ; preds = %bb.f
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #33
  %i.de = load ptr, ptr %i.c, align 8, !tbaa !1047, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_RKNS0_3ROIENS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.de, ptr noundef nonnull align 4 dereferenceable(32) %1, i32 noundef 0, i1 noundef zeroext true)
          to label %_ZN11OpenImageIO4v3_18ImageBuf8IteratorIffEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit unwind label %bb.l

_ZN11OpenImageIO4v3_18ImageBuf8IteratorIffEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit: ; preds = %bb.g
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #33
  %i.df = load ptr, ptr %0, align 8, !tbaa !1045, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_NS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %3, ptr noundef nonnull align 8 dereferenceable(16) %i.df, i32 noundef 2, i1 noundef zeroext false)
...
begin_hunk_2_@_ZZN11OpenImageIO4v3_1L7resize_IfN9Imath_3_14halfEEEbRNS0_8ImageBufERKS4_PKNS0_8Filter2DENS0_3ROIEiENKUlSB_E_clESB_:bb.a
  ...
  %i.ax = shl nsw i64 %i.aw, 2
  %i.ay = alloca i8, i64 %i.ax, align 16          ; 4 uses
  br i1 %i.au, label %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit, label %.loopexit427
...
_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit: ; preds = %bb.a
  ...
  %i.bi = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %i.bh) #34 ; 4 uses
  %i.bj = icmp sge i32 %i.bb, %i.ba
  %.not309434 = icmp slt i32 %i.am, 0
  %or.cond = select i1 %i.bj, i1 true, i1 %.not309434
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.loopexit426
  %.0245440 = phi i32 [ %i.cx, %.loopexit426 ], [ %i.bb, %.lr.ph.preheader ] ; 3 uses
  %i.bp = load i32, ptr %1, align 8, !tbaa !71
  %i.bq = sub nsw i32 %.0245440, %i.bp
  %i.br = mul nsw i32 %i.bq, %i.ao
  %i.bs = sext i32 %i.br to i64
  %i.bt = getelementptr inbounds [4 x i8], ptr %i.bi, i64 %i.bs ; 3 uses
  %i.bu = sitofp i32 %.0245440 to float
  %i.bv = fsub nnan float %i.bu, %i.r
  %i.bw = fadd nnan float %i.bv, 5.000000e-01
  %i.bx = fmul float %i.bm, %i.bw
  %i.by = tail call float @llvm.fmuladd.f32(float %i.bx, float %i.bl, float %i.j) ; 2 uses
...
._crit_edge:                                      ; preds = %bb.c
  %i.cc = fcmp oeq float %i.cs, 0.000000e+00
  br i1 %i.cc, label %.loopexit426, label %.lr.ph439.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cf = icmp eq i64 %index.next, %n.vec
  br i1 %i.cf, label %.lr.ph439.preheader696, label %vector.body, !llvm.loop !1075

bb.b:                                             ; preds = %.lr.ph, %bb.c
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %bb.c ] ; 3 uses
  %.0248436 = phi float [ 0.000000e+00, %.lr.ph ], [ %i.cs, %bb.c ]
  %i.cg = load ptr, ptr %i.v, align 8, !tbaa !1074, !nonnull !48, !align !386
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !49 ; 2 uses
  %i.ci = trunc i64 %indvars.iv to i32
  %i.cj = sub i32 %i.ci, %i.am
  %i.ck = sitofp i32 %i.cj to float
...
bb.c:                                             ; preds = %bb.b
  %i.cr = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %indvars.iv
  store float %i.cq, ptr %i.cr, align 4, !tbaa !77
  %i.cs = fadd float %.0248436, %i.cq             ; 4 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
.lr.ph439:                                        ; preds = %.lr.ph439.preheader696, %.lr.ph439
  ...
  %i.cu = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %indvars.iv525 ; 2 uses
  %i.cv = load float, ptr %i.cu, align 4, !tbaa !77
  %i.cw = fdiv float %i.cv, %i.cs
  store float %i.cw, ptr %i.cu, align 4, !tbaa !77
...
.loopexit426:                                     ; preds = %.lr.ph439, %._crit_edge
  %i.cx = add nsw i32 %.0245440, 1                ; 2 uses
  %i.cy = load i32, ptr %i.az, align 4, !tbaa !164
  %i.cz = icmp slt i32 %i.cx, %i.cy
  br i1 %i.cz, label %.lr.ph, label %.loopexit427, !llvm.loop !1078

.loopexit427:                                     ; preds = %.loopexit426, %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit, %bb.a
  %.sroa.0396.0 = phi ptr [ null, %bb.a ], [ %i.bi, %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit ], [ %i.bi, %.loopexit426 ] ; 5 uses
  %.not = icmp eq i32 %i.g, 0
  br i1 %.not, label %bb.f, label %bb.e
...
bb.f:                                             ; preds = %.loopexit427, %bb.e
  %i.dd = phi ptr [ %i.dc, %bb.e ], [ null, %.loopexit427 ] ; 8 uses
  br i1 %i.au, label %bb.g, label %bb.bm

bb.g:                                             ; preds = %bb.f
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #33
  %i.de = load ptr, ptr %i.c, align 8, !tbaa !1073, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_RKNS0_3ROIENS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.de, ptr noundef nonnull align 4 dereferenceable(32) %1, i32 noundef 0, i1 noundef zeroext true)
          to label %_ZN11OpenImageIO4v3_18ImageBuf8IteratorIffEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit unwind label %bb.l

_ZN11OpenImageIO4v3_18ImageBuf8IteratorIffEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit: ; preds = %bb.g
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #33
  %i.df = load ptr, ptr %0, align 8, !tbaa !1071, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_NS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %3, ptr noundef nonnull align 8 dereferenceable(16) %i.df, i32 noundef 2, i1 noundef zeroext false)
...
_ZN11OpenImageIO4v3_18ImageBuf13ConstIteratorIN9Imath_3_14halfEfEC2ERKS1_NS1_8WrapModeE.exit: ; preds = %_ZN11OpenImageIO4v3_18ImageBuf8IteratorIffEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit
  ...
  %i.dj = load i32, ptr %i.di, align 4, !tbaa !162
  %i.dk = icmp slt i32 %i.dh, %i.dj
  br i1 %i.dk, label %.lr.ph509, label %._crit_edge510
...
.lr.ph509:                                        ; preds = %_ZN11OpenImageIO4v3_18ImageBuf13ConstIteratorIN9Imath_3_14halfEfEC2ERKS1_NS1_8WrapModeE.exit
  ...
  %i.fj = getelementptr inbounds nuw i8, ptr %2, i64 120
  %i.fk = sext i32 %i.ap to i64
  %smax553 = call i32 @llvm.smax.i32(i32 %i.aq, i32 0) ; 2 uses
  %i.fl = or disjoint i32 %smax553, 1             ; 2 uses
  %i.fm = zext i32 %i.g to i64                    ; 6 uses
  %i.fn = shl nuw nsw i64 %i.fm, 2
  %smax568 = call i32 @llvm.smax.i32(i32 %i.an, i32 0) ; 2 uses
  %i.fo = or disjoint i32 %smax568, 1
  %i.fp = sext i32 %i.dq to i64
  %wide.trip.count554 = zext nneg i32 %i.fl to i64
  %wide.trip.count560 = zext nneg i32 %i.fl to i64
  %invariant.gep = getelementptr [4 x i8], ptr %i.ay, i64 %i.fk
  %wide.trip.count580 = zext nneg i32 %i.fo to i64
  %i.fq = extractelement <2 x i1> %i.dn, i64 1    ; 2 uses
  %i.fr = extractelement <2 x float> %i.ac, i64 1
  %i.fs = extractelement <2 x float> %i.ag, i64 1
  %i.ft = or disjoint i32 %smax568, 1
  %i.fu = zext nneg i32 %i.ft to i64              ; 2 uses
  %i.fv = extractelement <2 x float> %i.af, i64 1
  %min.iters.check678 = icmp slt i32 %i.aq, 4
  %i.fw = and i32 %smax553, 2147483644
  %n.vec681 = zext nneg i32 %i.fw to i64          ; 2 uses
  %i.fx = extractelement <2 x i1> %i.dn, i64 0
  %i.fy = extractelement <2 x float> %i.ac, i64 0
  %i.fz = extractelement <2 x float> %i.ag, i64 0
  %xtraiter = and i64 %i.fu, 7
  ...
  %n.vec663 = and i64 %i.fm, 2147483644           ; 3 uses
  %cmp.n675 = icmp eq i64 %n.vec663, %i.fm
  br label %bb.n
...
bb.n:                                             ; preds = %.lr.ph509, %._crit_edge507
  %.0257508 = phi i32 [ %i.dh, %.lr.ph509 ], [ %i.hv, %._crit_edge507 ] ; 2 uses
  ...
  %i.gq = call noundef float @llvm.floor.f32(float %i.gp) ; 2 uses
  %i.gr = fptosi float %i.gq to i32               ; 2 uses
  br i1 %i.fq, label %.loopexit419, label %.lr.ph474
...
vector.body684:                                   ; preds = %vector.body684, %vector.ph679
  ...
  %i.gv = getelementptr inbounds nuw [4 x i8], ptr %i.ay, i64 %index685 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  %i.hj = getelementptr inbounds nuw [4 x i8], ptr %i.ay, i64 %indvars.iv550
  store float %i.hi, ptr %i.hj, align 4, !tbaa !77
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cf = icmp eq i64 %index.next, %n.vec
  br i1 %i.cf, label %.lr.ph435.preheader688, label %vector.body, !llvm.loop !1101

bb.b:                                             ; preds = %.lr.ph, %bb.c
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %bb.c ] ; 3 uses
  %.0248432 = phi float [ 0.000000e+00, %.lr.ph ], [ %i.cs, %bb.c ]
  %i.cg = load ptr, ptr %i.v, align 8, !tbaa !1100, !nonnull !48, !align !386
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !49 ; 2 uses
  %i.ci = trunc i64 %indvars.iv to i32
  %i.cj = sub i32 %i.ci, %i.am
  %i.ck = sitofp i32 %i.cj to float
...
.loopexit422:                                     ; preds = %.lr.ph435, %._crit_edge
  ...
  %i.cy = load i32, ptr %i.az, align 4, !tbaa !164
  %i.cz = icmp slt i32 %i.cx, %i.cy
  br i1 %i.cz, label %.lr.ph, label %.loopexit423, !llvm.loop !1104
...
bb.g:                                             ; preds = %bb.f
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #33
  %i.de = load ptr, ptr %i.c, align 8, !tbaa !1099, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_RKNS0_3ROIENS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.de, ptr noundef nonnull align 4 dereferenceable(32) %1, i32 noundef 0, i1 noundef zeroext true)
          to label %_ZN11OpenImageIO4v3_18ImageBuf8IteratorIffEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit unwind label %bb.l

_ZN11OpenImageIO4v3_18ImageBuf8IteratorIffEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit: ; preds = %bb.g
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #33
  %i.df = load ptr, ptr %0, align 8, !tbaa !1097, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_NS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %3, ptr noundef nonnull align 8 dereferenceable(16) %i.df, i32 noundef 2, i1 noundef zeroext false)
...
begin_hunk_4_@_ZZN11OpenImageIO4v3_1L7resize_IhhEEbRNS0_8ImageBufERKS2_PKNS0_8Filter2DENS0_3ROIEiENKUlS9_E_clES9_:bb.a
  ...
  %i.ax = shl nsw i64 %i.aw, 2
  %i.ay = alloca i8, i64 %i.ax, align 16          ; 4 uses
  br i1 %i.au, label %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit, label %.loopexit426
...
_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit: ; preds = %bb.a
  ...
  %i.bi = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %i.bh) #34 ; 4 uses
  %i.bj = icmp sge i32 %i.bb, %i.ba
  %.not309433 = icmp slt i32 %i.am, 0
  %or.cond = select i1 %i.bj, i1 true, i1 %.not309433
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.loopexit425
  %.0245439 = phi i32 [ %i.cx, %.loopexit425 ], [ %i.bb, %.lr.ph.preheader ] ; 3 uses
  %i.bp = load i32, ptr %1, align 8, !tbaa !71
  %i.bq = sub nsw i32 %.0245439, %i.bp
  %i.br = mul nsw i32 %i.bq, %i.ao
  %i.bs = sext i32 %i.br to i64
  %i.bt = getelementptr inbounds [4 x i8], ptr %i.bi, i64 %i.bs ; 3 uses
  %i.bu = sitofp i32 %.0245439 to float
  %i.bv = fsub nnan float %i.bu, %i.r
  %i.bw = fadd nnan float %i.bv, 5.000000e-01
  %i.bx = fmul float %i.bm, %i.bw
  %i.by = tail call float @llvm.fmuladd.f32(float %i.bx, float %i.bl, float %i.j) ; 2 uses
...
._crit_edge:                                      ; preds = %bb.c
  %i.cc = fcmp oeq float %i.cs, 0.000000e+00
  br i1 %i.cc, label %.loopexit425, label %.lr.ph438.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cf = icmp eq i64 %index.next, %n.vec
  br i1 %i.cf, label %.lr.ph438.preheader691, label %vector.body, !llvm.loop !1127

bb.b:                                             ; preds = %.lr.ph, %bb.c
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %bb.c ] ; 3 uses
  %.0248435 = phi float [ 0.000000e+00, %.lr.ph ], [ %i.cs, %bb.c ]
  %i.cg = load ptr, ptr %i.v, align 8, !tbaa !1126, !nonnull !48, !align !386
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !49 ; 2 uses
  %i.ci = trunc i64 %indvars.iv to i32
  %i.cj = sub i32 %i.ci, %i.am
  %i.ck = sitofp i32 %i.cj to float
...
bb.c:                                             ; preds = %bb.b
  %i.cr = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %indvars.iv
  store float %i.cq, ptr %i.cr, align 4, !tbaa !77
  %i.cs = fadd float %.0248435, %i.cq             ; 4 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
.lr.ph438:                                        ; preds = %.lr.ph438.preheader691, %.lr.ph438
  ...
  %i.cu = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %indvars.iv524 ; 2 uses
  %i.cv = load float, ptr %i.cu, align 4, !tbaa !77
  %i.cw = fdiv float %i.cv, %i.cs
  store float %i.cw, ptr %i.cu, align 4, !tbaa !77
...
.loopexit425:                                     ; preds = %.lr.ph438, %._crit_edge
  %i.cx = add nsw i32 %.0245439, 1                ; 2 uses
  %i.cy = load i32, ptr %i.az, align 4, !tbaa !164
  %i.cz = icmp slt i32 %i.cx, %i.cy
  br i1 %i.cz, label %.lr.ph, label %.loopexit426, !llvm.loop !1130

.loopexit426:                                     ; preds = %.loopexit425, %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit, %bb.a
  %.sroa.0395.0 = phi ptr [ null, %bb.a ], [ %i.bi, %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit ], [ %i.bi, %.loopexit425 ] ; 5 uses
  %.not = icmp eq i32 %i.g, 0
  br i1 %.not, label %bb.f, label %bb.e
...
bb.f:                                             ; preds = %.loopexit426, %bb.e
  %i.dd = phi ptr [ %i.dc, %bb.e ], [ null, %.loopexit426 ] ; 8 uses
  br i1 %i.au, label %bb.g, label %bb.bg

bb.g:                                             ; preds = %bb.f
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #33
  %i.de = load ptr, ptr %i.c, align 8, !tbaa !1125, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_RKNS0_3ROIENS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.de, ptr noundef nonnull align 4 dereferenceable(32) %1, i32 noundef 0, i1 noundef zeroext true)
...
_ZN11OpenImageIO4v3_18ImageBuf8IteratorIhfEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit: ; preds = %bb.g
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #33
  %i.df = load ptr, ptr %0, align 8, !tbaa !1123, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_NS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %3, ptr noundef nonnull align 8 dereferenceable(16) %i.df, i32 noundef 2, i1 noundef zeroext false)
          to label %_ZN11OpenImageIO4v3_18ImageBuf13ConstIteratorIhfEC2ERKS1_NS1_8WrapModeE.exit unwind label %bb.m
...
_ZN11OpenImageIO4v3_18ImageBuf13ConstIteratorIhfEC2ERKS1_NS1_8WrapModeE.exit: ; preds = %_ZN11OpenImageIO4v3_18ImageBuf8IteratorIhfEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit
  ...
  %i.dj = load i32, ptr %i.di, align 4, !tbaa !162
  %i.dk = icmp slt i32 %i.dh, %i.dj
  br i1 %i.dk, label %.lr.ph508, label %._crit_edge509
...
.lr.ph508:                                        ; preds = %_ZN11OpenImageIO4v3_18ImageBuf13ConstIteratorIhfEC2ERKS1_NS1_8WrapModeE.exit
  ...
  %i.fj = getelementptr inbounds nuw i8, ptr %2, i64 120
  %i.fk = sext i32 %i.ap to i64
  %smax552 = call i32 @llvm.smax.i32(i32 %i.aq, i32 0) ; 2 uses
  %i.fl = or disjoint i32 %smax552, 1             ; 2 uses
  %i.fm = zext i32 %i.g to i64                    ; 6 uses
  %i.fn = shl nuw nsw i64 %i.fm, 2
  %smax567 = call i32 @llvm.smax.i32(i32 %i.an, i32 0) ; 2 uses
  %i.fo = or disjoint i32 %smax567, 1
  %i.fp = sext i32 %i.dq to i64
  %wide.trip.count553 = zext nneg i32 %i.fl to i64
  %wide.trip.count559 = zext nneg i32 %i.fl to i64
  %invariant.gep = getelementptr [4 x i8], ptr %i.ay, i64 %i.fk
  %wide.trip.count579 = zext nneg i32 %i.fo to i64
  %i.fq = extractelement <2 x i1> %i.dn, i64 1    ; 2 uses
  %i.fr = extractelement <2 x float> %i.ac, i64 1
  %i.fs = extractelement <2 x float> %i.ag, i64 1
  %i.ft = or disjoint i32 %smax567, 1
  %i.fu = zext nneg i32 %i.ft to i64              ; 2 uses
  %i.fv = extractelement <2 x float> %i.af, i64 1
  %min.iters.check673 = icmp slt i32 %i.aq, 4
  %i.fw = and i32 %smax552, 2147483644
  %n.vec676 = zext nneg i32 %i.fw to i64          ; 2 uses
  %i.fx = extractelement <2 x i1> %i.dn, i64 0
  %i.fy = extractelement <2 x float> %i.ac, i64 0
  %i.fz = extractelement <2 x float> %i.ag, i64 0
  %xtraiter = and i64 %i.fu, 7
  ...
  %n.vec659 = and i64 %i.fm, 2147483640           ; 3 uses
  %cmp.n670 = icmp eq i64 %n.vec659, %i.fm
  br label %bb.n
...
bb.n:                                             ; preds = %.lr.ph508, %._crit_edge506
  %.0257507 = phi i32 [ %i.dh, %.lr.ph508 ], [ %i.hv, %._crit_edge506 ] ; 2 uses
  ...
  %i.gq = call noundef float @llvm.floor.f32(float %i.gp) ; 2 uses
  %i.gr = fptosi float %i.gq to i32               ; 2 uses
  br i1 %i.fq, label %.loopexit418, label %.lr.ph473
...
vector.body679:                                   ; preds = %vector.body679, %vector.ph674
  ...
  %i.gv = getelementptr inbounds nuw [4 x i8], ptr %i.ay, i64 %index680 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  %i.hj = getelementptr inbounds nuw [4 x i8], ptr %i.ay, i64 %indvars.iv549
  store float %i.hi, ptr %i.hj, align 4, !tbaa !77
...
begin_hunk_5_@_ZZN11OpenImageIO4v3_1L7resize_IN9Imath_3_14halfES3_EEbRNS0_8ImageBufERKS4_PKNS0_8Filter2DENS0_3ROIEiENKUlSB_E_clESB_:bb.a
  ...
  %i.ax = shl nsw i64 %i.aw, 2
  %i.ay = alloca i8, i64 %i.ax, align 16          ; 4 uses
  br i1 %i.au, label %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit, label %.loopexit441
...
_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit: ; preds = %bb.a
  ...
  %i.bi = tail call noalias noundef nonnull ptr @_Znam(i64 noundef %i.bh) #34 ; 4 uses
  %i.bj = icmp sge i32 %i.bb, %i.ba
  %.not309448 = icmp slt i32 %i.am, 0
  %or.cond = select i1 %i.bj, i1 true, i1 %.not309448
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.loopexit440
  %.0245454 = phi i32 [ %i.cx, %.loopexit440 ], [ %i.bb, %.lr.ph.preheader ] ; 3 uses
  %i.bp = load i32, ptr %1, align 8, !tbaa !71
  %i.bq = sub nsw i32 %.0245454, %i.bp
  %i.br = mul nsw i32 %i.bq, %i.ao
  %i.bs = sext i32 %i.br to i64
  %i.bt = getelementptr inbounds [4 x i8], ptr %i.bi, i64 %i.bs ; 3 uses
  %i.bu = sitofp i32 %.0245454 to float
  %i.bv = fsub nnan float %i.bu, %i.r
  %i.bw = fadd nnan float %i.bv, 5.000000e-01
  %i.bx = fmul float %i.bm, %i.bw
  %i.by = tail call float @llvm.fmuladd.f32(float %i.bx, float %i.bl, float %i.j) ; 2 uses
...
._crit_edge:                                      ; preds = %bb.c
  %i.cc = fcmp oeq float %i.cs, 0.000000e+00
  br i1 %i.cc, label %.loopexit440, label %.lr.ph453.preheader
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cf = icmp eq i64 %index.next, %n.vec
  br i1 %i.cf, label %.lr.ph453.preheader715, label %vector.body, !llvm.loop !1153

bb.b:                                             ; preds = %.lr.ph, %bb.c
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %bb.c ] ; 3 uses
  %.0248450 = phi float [ 0.000000e+00, %.lr.ph ], [ %i.cs, %bb.c ]
  %i.cg = load ptr, ptr %i.v, align 8, !tbaa !1152, !nonnull !48, !align !386
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !49 ; 2 uses
  %i.ci = trunc i64 %indvars.iv to i32
  %i.cj = sub i32 %i.ci, %i.am
  %i.ck = sitofp i32 %i.cj to float
...
bb.c:                                             ; preds = %bb.b
  %i.cr = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %indvars.iv
  store float %i.cq, ptr %i.cr, align 4, !tbaa !77
  %i.cs = fadd float %.0248450, %i.cq             ; 4 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
...
.lr.ph453:                                        ; preds = %.lr.ph453.preheader715, %.lr.ph453
  ...
  %i.cu = getelementptr inbounds nuw [4 x i8], ptr %i.bt, i64 %indvars.iv539 ; 2 uses
  %i.cv = load float, ptr %i.cu, align 4, !tbaa !77
  %i.cw = fdiv float %i.cv, %i.cs
  store float %i.cw, ptr %i.cu, align 4, !tbaa !77
...
.loopexit440:                                     ; preds = %.lr.ph453, %._crit_edge
  %i.cx = add nsw i32 %.0245454, 1                ; 2 uses
  %i.cy = load i32, ptr %i.az, align 4, !tbaa !164
  %i.cz = icmp slt i32 %i.cx, %i.cy
  br i1 %i.cz, label %.lr.ph, label %.loopexit441, !llvm.loop !1156

.loopexit441:                                     ; preds = %.loopexit440, %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit, %bb.a
  %.sroa.0410.0 = phi ptr [ null, %bb.a ], [ %i.bi, %_ZNSt10unique_ptrIA_fSt14default_deleteIS0_EE5resetIPfvEEvT_.exit ], [ %i.bi, %.loopexit440 ] ; 5 uses
  %.not = icmp eq i32 %i.g, 0
  br i1 %.not, label %bb.f, label %bb.e
...
bb.f:                                             ; preds = %.loopexit441, %bb.e
  %i.dd = phi ptr [ %i.dc, %bb.e ], [ null, %.loopexit441 ] ; 8 uses
  br i1 %i.au, label %bb.g, label %bb.bw

bb.g:                                             ; preds = %bb.f
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #33
  %i.de = load ptr, ptr %i.c, align 8, !tbaa !1151, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_RKNS0_3ROIENS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.de, ptr noundef nonnull align 4 dereferenceable(32) %1, i32 noundef 0, i1 noundef zeroext true)
...
_ZN11OpenImageIO4v3_18ImageBuf8IteratorIN9Imath_3_14halfEfEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit: ; preds = %bb.g
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #33
  %i.df = load ptr, ptr %0, align 8, !tbaa !1149, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_NS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %3, ptr noundef nonnull align 8 dereferenceable(16) %i.df, i32 noundef 2, i1 noundef zeroext false)
          to label %_ZN11OpenImageIO4v3_18ImageBuf13ConstIteratorIN9Imath_3_14halfEfEC2ERKS1_NS1_8WrapModeE.exit unwind label %bb.m
...
_ZN11OpenImageIO4v3_18ImageBuf13ConstIteratorIN9Imath_3_14halfEfEC2ERKS1_NS1_8WrapModeE.exit: ; preds = %_ZN11OpenImageIO4v3_18ImageBuf8IteratorIN9Imath_3_14halfEfEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit
  ...
  %i.dj = load i32, ptr %i.di, align 4, !tbaa !162
  %i.dk = icmp slt i32 %i.dh, %i.dj
  br i1 %i.dk, label %.lr.ph523, label %._crit_edge524
...
.lr.ph523:                                        ; preds = %_ZN11OpenImageIO4v3_18ImageBuf13ConstIteratorIN9Imath_3_14halfEfEC2ERKS1_NS1_8WrapModeE.exit
  ...
  %i.fl = or disjoint i32 %smax567, 1             ; 2 uses
  %i.fm = zext i32 %i.g to i64                    ; 6 uses
  %i.fn = shl nuw nsw i64 %i.fm, 2
  %smax582 = call i32 @llvm.smax.i32(i32 %i.an, i32 0) ; 2 uses
  %i.fo = or disjoint i32 %smax582, 1
  %i.fp = sext i32 %i.dq to i64
  %wide.trip.count568 = zext nneg i32 %i.fl to i64
  %wide.trip.count574 = zext nneg i32 %i.fl to i64
  %invariant.gep = getelementptr [4 x i8], ptr %i.ay, i64 %i.fk
  %wide.trip.count594 = zext nneg i32 %i.fo to i64
  %i.fq = extractelement <2 x i1> %i.dn, i64 1    ; 2 uses
  %i.fr = extractelement <2 x float> %i.ac, i64 1
  %i.fs = extractelement <2 x float> %i.ag, i64 1
  %i.ft = or disjoint i32 %smax582, 1
  %i.fu = zext nneg i32 %i.ft to i64              ; 2 uses
  %i.fv = extractelement <2 x float> %i.af, i64 1
  %min.iters.check697 = icmp slt i32 %i.aq, 4
  %i.fw = and i32 %smax567, 2147483644
  %n.vec700 = zext nneg i32 %i.fw to i64          ; 2 uses
  %i.fx = extractelement <2 x i1> %i.dn, i64 0
  %i.fy = extractelement <2 x float> %i.ac, i64 0
  %i.fz = extractelement <2 x float> %i.ag, i64 0
  %xtraiter = and i64 %i.fu, 7
  ...
  %n.vec682 = and i64 %i.fm, 2147483644           ; 3 uses
  %cmp.n694 = icmp eq i64 %n.vec682, %i.fm
  br label %bb.n
...
bb.n:                                             ; preds = %.lr.ph523, %._crit_edge521
  %.0257522 = phi i32 [ %i.dh, %.lr.ph523 ], [ %i.hv, %._crit_edge521 ] ; 2 uses
  ...
  %i.gq = call noundef float @llvm.floor.f32(float %i.gp) ; 2 uses
  %i.gr = fptosi float %i.gq to i32               ; 2 uses
  br i1 %i.fq, label %.loopexit433, label %.lr.ph488
...
vector.body703:                                   ; preds = %vector.body703, %vector.ph698
  ...
  %i.gv = getelementptr inbounds nuw [4 x i8], ptr %i.ay, i64 %index704 ; 2 uses
...
bb.p:                                             ; preds = %bb.o
  %i.hj = getelementptr inbounds nuw [4 x i8], ptr %i.ay, i64 %indvars.iv564
  store float %i.hi, ptr %i.hj, align 4, !tbaa !77
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.cf = icmp eq i64 %index.next, %n.vec
  br i1 %i.cf, label %.lr.ph438.preheader691, label %vector.body, !llvm.loop !1179

bb.b:                                             ; preds = %.lr.ph, %bb.c
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %bb.c ] ; 3 uses
  %.0248435 = phi float [ 0.000000e+00, %.lr.ph ], [ %i.cs, %bb.c ]
  %i.cg = load ptr, ptr %i.v, align 8, !tbaa !1178, !nonnull !48, !align !386
  %i.ch = load ptr, ptr %i.cg, align 8, !tbaa !49 ; 2 uses
  %i.ci = trunc i64 %indvars.iv to i32
  %i.cj = sub i32 %i.ci, %i.am
  %i.ck = sitofp i32 %i.cj to float
...
.loopexit425:                                     ; preds = %.lr.ph438, %._crit_edge
  ...
  %i.cy = load i32, ptr %i.az, align 4, !tbaa !164
  %i.cz = icmp slt i32 %i.cx, %i.cy
  br i1 %i.cz, label %.lr.ph, label %.loopexit426, !llvm.loop !1182
...
bb.g:                                             ; preds = %bb.f
  call void @llvm.lifetime.start.p0(ptr nonnull %2) #33
  %i.de = load ptr, ptr %i.c, align 8, !tbaa !1177, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_RKNS0_3ROIENS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %2, ptr noundef nonnull align 8 dereferenceable(16) %i.de, ptr noundef nonnull align 4 dereferenceable(32) %1, i32 noundef 0, i1 noundef zeroext true)
...
_ZN11OpenImageIO4v3_18ImageBuf8IteratorItfEC2ERS1_RKNS0_3ROIENS1_8WrapModeE.exit: ; preds = %bb.g
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #33
  %i.df = load ptr, ptr %0, align 8, !tbaa !1175, !nonnull !48, !align !386
  invoke void @_ZN11OpenImageIO4v3_18ImageBuf12IteratorBaseC2ERKS1_NS1_8WrapModeEb(ptr noundef nonnull align 8 dereferenceable(126) %3, ptr noundef nonnull align 8 dereferenceable(16) %i.df, i32 noundef 2, i1 noundef zeroext false)
          to label %_ZN11OpenImageIO4v3_18ImageBuf13ConstIteratorItfEC2ERKS1_NS1_8WrapModeE.exit unwind label %bb.m
