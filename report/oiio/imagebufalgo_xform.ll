...
bb.a:
  ...
  %i.o = fadd float %sin.i.i, %10
  %11 = tail call float @llvm.fmuladd.f32(float %sin.i.i, float 0.000000e+00, float %cos.i.i)
  %i.p = fadd float %11, 0.000000e+00             ; 2 uses
  ...
  %12 = fadd float %i.k, %i.w                     ; 2 uses
  %13 = fmul float %i.p, 0.000000e+00             ; 2 uses
  %14 = fmul float %i.u, 0.000000e+00             ; 2 uses
  %i.x = fadd float %i.n, 0.000000e+00            ; 2 uses
  ...
  %15 = insertelement <4 x float> poison, float %i.ac, i64 0
  %16 = shufflevector <2 x float> %i.af, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %17 = shufflevector <4 x float> %15, <4 x float> %16, <4 x i32> <i32 0, i32 4, i32 5, i32 0>
  %18 = fadd <4 x float> %17, <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00> ; 3 uses
  %19 = fadd float %i.o, 0.000000e+00             ; 2 uses
  %20 = fmul float %19, 0.000000e+00              ; 2 uses
  %21 = fadd float %i.x, %20
  %i.ag = insertelement <2 x float> poison, float %i.x, i64 0
  %22 = shufflevector <2 x float> %i.ag, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ah = insertelement <2 x float> poison, float %19, i64 0
  %i.ai = insertelement <2 x float> %i.ah, float %20, i64 1
  %i.aj = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %22, <2 x float> zeroinitializer, <2 x float> %i.ai)
  %23 = insertelement <4 x float> poison, float %21, i64 0
  %24 = shufflevector <2 x float> %i.aj, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %25 = shufflevector <4 x float> %23, <4 x float> %24, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %26 = extractelement <4 x float> %18, i64 2
  %i.ak = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %cos.i.i, i64 0
  %27 = insertelement <4 x float> %i.ak, float %i.k, i64 3
  %i.al = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %i.l, i64 0
  %28 = insertelement <4 x float> %i.al, float %i.r, i64 3
  %29 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %27, <4 x float> <float 0.000000e+00, float poison, float 0.000000e+00, float 0.000000e+00>, <4 x float> %28) ; 2 uses
  %30 = fadd <4 x float> %29, <float 0.000000e+00, float poison, float -0.000000e+00, float -0.000000e+00> ; 2 uses
  %31 = shufflevector <4 x float> %30, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %i.am = extractelement <4 x float> %29, i64 3   ; 2 uses
  %32 = fadd float %i.am, %14
  %33 = insertelement <4 x float> poison, float %i.p, i64 0
  %34 = insertelement <4 x float> %33, float %13, i64 1
  %35 = insertelement <4 x float> %34, float %32, i64 2
  %36 = insertelement <4 x float> %35, float %i.u, i64 3
  %37 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %31, <4 x float> zeroinitializer, <4 x float> %36)
  %i.an = tail call float @llvm.fmuladd.f32(float %i.am, float 0.000000e+00, float %14)
  %38 = extractelement <4 x float> %30, i64 0
  %39 = fadd float %38, %13
  %i.ao = insertelement <4 x float> %25, float %39, i64 3
  %40 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %18, <4 x float> zeroinitializer, <4 x float> %i.ao)
  %41 = insertelement <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float poison>, float %12, i64 2
  %42 = shufflevector <4 x float> %41, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %43 = shufflevector <4 x float> %18, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %44 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %42, <4 x float> %43, <4 x float> %37)
  %45 = tail call float @llvm.fmuladd.f32(float %12, float %26, float %i.an)
  store <4 x float> %40, ptr %9, align 16, !tbaa !77
  store <4 x float> %44, ptr %i.a, align 16, !tbaa !77
  store float %45, ptr %i.b, align 16, !tbaa !77
...
bb.a:
  ...
  %i.q = fadd float %sin.i.i, %20
  %21 = tail call float @llvm.fmuladd.f32(float %sin.i.i, float 0.000000e+00, float %cos.i.i)
  %i.r = fadd float %21, 0.000000e+00             ; 2 uses
  ...
  %22 = fadd float %i.m, %i.y                     ; 2 uses
  %23 = fmul float %i.r, 0.000000e+00             ; 2 uses
  %24 = fmul float %i.w, 0.000000e+00             ; 2 uses
  %i.z = fadd float %i.p, 0.000000e+00            ; 2 uses
  ...
  %25 = insertelement <4 x float> poison, float %i.ae, i64 0
  %26 = shufflevector <2 x float> %i.ah, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %27 = shufflevector <4 x float> %25, <4 x float> %26, <4 x i32> <i32 0, i32 4, i32 5, i32 0>
  %28 = fadd <4 x float> %27, <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00> ; 3 uses
  %29 = fadd float %i.q, 0.000000e+00             ; 2 uses
  %30 = fmul float %29, 0.000000e+00              ; 2 uses
  %31 = fadd float %i.z, %30
  %i.ai = insertelement <2 x float> poison, float %i.z, i64 0
  %32 = shufflevector <2 x float> %i.ai, <2 x float> poison, <2 x i32> zeroinitializer
  %i.aj = insertelement <2 x float> poison, float %29, i64 0
  %i.ak = insertelement <2 x float> %i.aj, float %30, i64 1
  %i.al = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %32, <2 x float> zeroinitializer, <2 x float> %i.ak)
  %33 = insertelement <4 x float> poison, float %31, i64 0
  %34 = shufflevector <2 x float> %i.al, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %35 = shufflevector <4 x float> %33, <4 x float> %34, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %36 = extractelement <4 x float> %28, i64 2
  %i.am = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %cos.i.i, i64 0
  %37 = insertelement <4 x float> %i.am, float %i.m, i64 3
  %i.an = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %i.n, i64 0
  %38 = insertelement <4 x float> %i.an, float %i.t, i64 3
  %39 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %37, <4 x float> <float 0.000000e+00, float poison, float 0.000000e+00, float 0.000000e+00>, <4 x float> %38) ; 2 uses
  %40 = fadd <4 x float> %39, <float 0.000000e+00, float poison, float -0.000000e+00, float -0.000000e+00> ; 2 uses
  %41 = shufflevector <4 x float> %40, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %i.ao = extractelement <4 x float> %39, i64 3   ; 2 uses
  %42 = fadd float %i.ao, %24
  %43 = insertelement <4 x float> poison, float %i.r, i64 0
  %44 = insertelement <4 x float> %43, float %23, i64 1
  %45 = insertelement <4 x float> %44, float %42, i64 2
  %46 = insertelement <4 x float> %45, float %i.w, i64 3
  %47 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %41, <4 x float> zeroinitializer, <4 x float> %46)
  %i.ap = tail call float @llvm.fmuladd.f32(float %i.ao, float 0.000000e+00, float %24)
  %48 = extractelement <4 x float> %40, i64 0
  %49 = fadd float %48, %23
  %i.aq = insertelement <4 x float> %35, float %49, i64 3
  %50 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %28, <4 x float> zeroinitializer, <4 x float> %i.aq)
  %51 = insertelement <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float poison>, float %22, i64 2
  %52 = shufflevector <4 x float> %51, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %53 = shufflevector <4 x float> %28, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %54 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %52, <4 x float> %53, <4 x float> %47)
  %55 = tail call float @llvm.fmuladd.f32(float %22, float %36, float %i.ap)
  store <4 x float> %50, ptr %14, align 16, !tbaa !77
  store <4 x float> %54, ptr %i.c, align 16, !tbaa !77
  store float %55, ptr %i.d, align 16, !tbaa !77
...
bb.a:
  ...
  %i.ab = fadd float %sin.i.i.i, %9
  %10 = call float @llvm.fmuladd.f32(float %sin.i.i.i, float 0.000000e+00, float %cos.i.i.i)
  %i.ac = fadd float %10, 0.000000e+00            ; 2 uses
  ...
  %11 = fmul float %i.ac, 0.000000e+00            ; 2 uses
  %i.as = fmul float %i.ah, 0.000000e+00          ; 2 uses
  %i.at = fadd float %i.aa, 0.000000e+00          ; 2 uses
  %12 = insertelement <4 x float> poison, float %i.am, i64 0
  %13 = shufflevector <2 x float> %i.ar, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %14 = shufflevector <4 x float> %12, <4 x float> %13, <4 x i32> <i32 0, i32 4, i32 5, i32 0>
  %15 = fadd <4 x float> %14, <float 0.000000e+00, float 0.000000e+00, float 1.000000e+00, float 0.000000e+00> ; 3 uses
  %16 = fadd float %i.ab, 0.000000e+00            ; 2 uses
  %17 = fmul float %16, 0.000000e+00              ; 2 uses
  %18 = fadd float %i.at, %17
  %i.au = insertelement <2 x float> poison, float %i.at, i64 0
  %19 = shufflevector <2 x float> %i.au, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %27 = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %cos.i.i.i, i64 0
  %28 = insertelement <4 x float> %27, float %i.x, i64 3
  %i.av = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %i.y, i64 0
  %29 = insertelement <4 x float> %i.av, float %i.ae, i64 3
  %30 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %28, <4 x float> <float 0.000000e+00, float poison, float 0.000000e+00, float 0.000000e+00>, <4 x float> %29) ; 2 uses
  %31 = fadd <4 x float> %30, <float 0.000000e+00, float poison, float -0.000000e+00, float -0.000000e+00> ; 2 uses
  %32 = shufflevector <4 x float> %31, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  %i.aw = extractelement <4 x float> %30, i64 3   ; 2 uses
  %33 = fadd float %i.aw, %i.as
  %34 = insertelement <4 x float> poison, float %i.ac, i64 0
  %35 = insertelement <4 x float> %34, float %11, i64 1
  %36 = insertelement <4 x float> %35, float %33, i64 2
  %37 = insertelement <4 x float> %36, float %i.ah, i64 3
  %38 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %32, <4 x float> zeroinitializer, <4 x float> %37)
  %i.ax = call float @llvm.fmuladd.f32(float %i.aw, float 0.000000e+00, float %i.as)
  %39 = extractelement <4 x float> %31, i64 0
  %40 = fadd float %39, %11
  %i.ay = insertelement <4 x float> %25, float %40, i64 3
  %41 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %15, <4 x float> zeroinitializer, <4 x float> %i.ay)
  %42 = insertelement <4 x float> <float 0.000000e+00, float 0.000000e+00, float poison, float poison>, float %i.ak, i64 2
  %43 = shufflevector <4 x float> %42, <4 x float> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 2>
  %44 = shufflevector <4 x float> %15, <4 x float> poison, <4 x i32> <i32 1, i32 2, i32 0, i32 1>
  %45 = call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %43, <4 x float> %44, <4 x float> %38)
  %46 = call float @llvm.fmuladd.f32(float %i.ak, float %26, float %i.ax)
  store <4 x float> %41, ptr %7, align 16, !tbaa !77
  store <4 x float> %45, ptr %i.n, align 16, !tbaa !77
  store float %46, ptr %i.o, align 16, !tbaa !77
...
bb.a:
  ...
  %i.o = fadd float %sin.i.i.i, %10
  %11 = tail call float @llvm.fmuladd.f32(float %sin.i.i.i, float 0.000000e+00, float %cos.i.i.i)
  %i.p = fadd float %11, 0.000000e+00             ; 2 uses
  %i.q = fmul float %i.i, %i.l
  ...
  %25 = shufflevector <4 x float> %23, <4 x float> %24, <4 x i32> <i32 0, i32 4, i32 5, i32 poison>
  %26 = extractelement <4 x float> %18, i64 2
  %i.ak = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %cos.i.i.i, i64 0
  %27 = insertelement <4 x float> %i.ak, float %i.k, i64 3
  %i.al = insertelement <4 x float> <float poison, float poison, float -0.000000e+00, float poison>, float %i.l, i64 0
  %28 = insertelement <4 x float> %i.al, float %i.r, i64 3
  %29 = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %27, <4 x float> <float 0.000000e+00, float poison, float 0.000000e+00, float 0.000000e+00>, <4 x float> %28) ; 2 uses
...
bb.e:                                             ; preds = %bb.c
  ...
  %i.ce = load <2 x float>, ptr %1, align 4, !tbaa !77 ; 3 uses
  %i.cf = load float, ptr %i.cd, align 4, !tbaa !77
  %i.cg = fneg float %i.cf                        ; 2 uses
  %i.ch = load <2 x float>, ptr %i.d, align 4, !tbaa !77 ; 4 uses
  %i.ci = extractelement <2 x float> %i.ch, i64 0 ; 2 uses
  %i.cj = fneg float %i.ci
  %i.ck = fmul float %i.ci, %i.cg
  %2 = insertelement <2 x float> %i.ce, float 0.000000e+00, i64 1
  %3 = shufflevector <2 x float> <float poison, float -0.000000e+00>, <2 x float> %i.ch, <2 x i32> <i32 3, i32 1>
  %4 = insertelement <2 x float> <float poison, float 1.000000e+00>, float %i.ck, i64 0
  %5 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %2, <2 x float> %3, <2 x float> %4) ; 2 uses
  %6 = shufflevector <2 x float> %5, <2 x float> poison, <4 x i32> <i32 0, i32 0, i32 1, i32 0>
  %7 = extractelement <2 x float> %5, i64 0       ; 4 uses
  %i.cl = fcmp ogt float %7, 0.000000e+00
  %i.cm = fneg float %7
  %i.cn = select i1 %i.cl, float %7, float %i.cm  ; 2 uses
...
.critedge63:                                      ; preds = %.preheader67, %bb.e
  %8 = shufflevector <2 x float> %i.ch, <2 x float> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 poison>
  %i.cy = insertelement <4 x float> %8, float 0.000000e+00, i64 2
  %i.cz = insertelement <4 x float> %i.cy, float %i.cg, i64 1
  %i.da = insertelement <4 x float> %i.cz, float %i.cj, i64 3
  %i.db = fdiv <4 x float> %i.da, %6              ; 3 uses
  ...
  %9 = extractelement <2 x float> %i.ce, i64 0
  %.sroa.22.0 = fdiv float %9, %7                 ; 2 uses
