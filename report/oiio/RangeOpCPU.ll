...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %broadcast.splat = shufflevector <4 x float> %7, <4 x float> poison, <4 x i32> zeroinitializer ; 3 uses
  %8 = load <4 x float>, ptr %0, align 8
  %broadcast.splat34 = shufflevector <4 x float> %8, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3> ; 3 uses
  %9 = load float, ptr %i.d, align 8, !tbaa !19, !alias.scope !22 ; 2 uses
  %broadcast.splatinsert39.a = insertelement <4 x float> poison, float %9, i64 0
  %broadcast.splat40.a = shufflevector <4 x float> %broadcast.splatinsert39.a, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.g = load float, ptr %i.e, align 4, !tbaa !25, !alias.scope !22 ; 2 uses
  ...
  %broadcast.splatinsert39 = insertelement <4 x float> poison, float %9, i64 0
  %broadcast.splat40 = shufflevector <4 x float> %broadcast.splatinsert39, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %broadcast.splatinsert41 = insertelement <4 x float> poison, float %i.g, i64 0
  %broadcast.splat42 = shufflevector <4 x float> %broadcast.splatinsert41, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %10 = load float, ptr %i.d, align 8, !tbaa !19, !alias.scope !22
  %broadcast.splatinsert43 = insertelement <4 x float> poison, float %10, i64 0
  %broadcast.splat.a = shufflevector <4 x float> %broadcast.splatinsert43, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %11 = load float, ptr %i.e, align 4, !tbaa !25, !alias.scope !22
  %broadcast.splatinsert45 = insertelement <4 x float> poison, float %11, i64 0
...
begin_hunk_1_@_ZNK16OpenColorIO_v2_524RangeScaleMinMaxRenderer5applyEPKvPvl:bb.a
  ...
  %i.t = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.s, <4 x float> %broadcast.splat, <4 x float> %broadcast.splat34) ; 2 uses
...
begin_hunk_2_@_ZNK16OpenColorIO_v2_524RangeScaleMinMaxRenderer5applyEPKvPvl:bb.a
  ...
  %i.ag = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.af, <4 x float> %broadcast.splat, <4 x float> %broadcast.splat34) ; 2 uses
...
begin_hunk_3_@_ZNK16OpenColorIO_v2_524RangeScaleMinMaxRenderer5applyEPKvPvl:bb.a
  ...
  %i.at = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.as, <4 x float> %broadcast.splat, <4 x float> %broadcast.splat34) ; 2 uses
  %i.au = fcmp olt <4 x float> %broadcast.splat40.a, %i.t
  %i.av = select <4 x i1> %i.au, <4 x float> %i.t, <4 x float> %broadcast.splat40.a ; 2 uses
  %i.aw = fcmp olt <4 x float> %broadcast.splat38, %i.av
  %i.ax = select <4 x i1> %i.aw, <4 x float> %broadcast.splat38, <4 x float> %i.av
  %i.ay = fcmp olt <4 x float> %broadcast.splat40, %i.ag
  %i.az = select <4 x i1> %i.ay, <4 x float> %i.ag, <4 x float> %broadcast.splat40 ; 2 uses
  %i.ba = fcmp olt <4 x float> %broadcast.splat42, %i.az
  %i.bb = select <4 x i1> %i.ba, <4 x float> %broadcast.splat42, <4 x float> %i.az
  %i.bc = fcmp olt <4 x float> %broadcast.splat.a, %i.at
  %i.bd = select <4 x i1> %i.bc, <4 x float> %i.at, <4 x float> %broadcast.splat.a ; 2 uses
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph, %middle.block
  %.023.ph = phi ptr [ %1, %vector.memcheck ], [ %1, %.lr.ph ], [ %5, %middle.block ]
...
begin_hunk_5_@_ZNK16OpenColorIO_v2_524RangeScaleMinMaxRenderer5applyEPKvPvl:bb.a
  ...
  %i.cf = load float, ptr %i.d, align 8, !tbaa !19 ; 2 uses
  %i.cg = load float, ptr %i.e, align 4, !tbaa !25 ; 2 uses
  ...
  %i.cj = load float, ptr %i.d, align 8, !tbaa !19 ; 2 uses
  %i.ck = load float, ptr %i.e, align 4, !tbaa !25 ; 2 uses
  ...
  %i.co = load float, ptr %i.d, align 8, !tbaa !19 ; 2 uses
  %i.cp = load float, ptr %i.e, align 4, !tbaa !25 ; 2 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.e = load float, ptr %i.b, align 8, !tbaa !19, !alias.scope !38 ; 2 uses
  %broadcast.splatinsert39.a = insertelement <4 x float> poison, float %i.e, i64 0
  %broadcast.splat40.a = shufflevector <4 x float> %broadcast.splatinsert39.a, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %7 = load float, ptr %i.c, align 4, !tbaa !25, !alias.scope !38 ; 2 uses
  %broadcast.splatinsert37.a = insertelement <4 x float> poison, float %7, i64 0
  ...
  %broadcast.splatinsert33 = insertelement <4 x float> poison, float %7, i64 0
  %broadcast.splat34 = shufflevector <4 x float> %broadcast.splatinsert33, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %i.f = load float, ptr %i.b, align 8, !tbaa !19, !alias.scope !38
  %broadcast.splatinsert = insertelement <4 x float> poison, float %i.f, i64 0
  %broadcast.splat = shufflevector <4 x float> %broadcast.splatinsert, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %8 = load float, ptr %i.c, align 4, !tbaa !25, !alias.scope !38
  %broadcast.splatinsert41 = insertelement <4 x float> poison, float %8, i64 0
  %broadcast.splat42 = shufflevector <4 x float> %broadcast.splatinsert41, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  br label %vector.body
...
begin_hunk_7_@_ZNK16OpenColorIO_v2_519RangeMinMaxRenderer5applyEPKvPvl:bb.a
  ...
  %i.s = fcmp olt <4 x float> %broadcast.splat40.a, %i.r
  %i.t = select <4 x i1> %i.s, <4 x float> %i.r, <4 x float> %broadcast.splat40.a ; 2 uses
  %i.u = fcmp olt <4 x float> %broadcast.splat38.a, %i.t
  %i.v = select <4 x i1> %i.u, <4 x float> %broadcast.splat38.a, <4 x float> %i.t
...
begin_hunk_8_@_ZNK16OpenColorIO_v2_519RangeMinMaxRenderer5applyEPKvPvl:bb.a
  ...
  %i.ak = fcmp olt <4 x float> %broadcast.splat34, %i.aj
  %i.al = select <4 x i1> %i.ak, <4 x float> %broadcast.splat34, <4 x float> %i.aj
...
begin_hunk_9_@_ZNK16OpenColorIO_v2_519RangeMinMaxRenderer5applyEPKvPvl:bb.a
  ...
  %i.ay = fcmp olt <4 x float> %broadcast.splat, %i.ax
  %i.az = select <4 x i1> %i.ay, <4 x float> %i.ax, <4 x float> %broadcast.splat ; 2 uses
  %i.ba = fcmp olt <4 x float> %broadcast.splat42, %i.az
  %i.bb = select <4 x i1> %i.ba, <4 x float> %broadcast.splat42, <4 x float> %i.az
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph, %middle.block
  ...
  %.01522.ph = phi ptr [ %2, %vector.memcheck ], [ %2, %.lr.ph ], [ %5, %middle.block ]
  %.01621.ph = phi ptr [ %1, %vector.memcheck ], [ %1, %.lr.ph ], [ %6, %middle.block ]
  br label %scalar.ph
...
begin_hunk_11_@_ZNK16OpenColorIO_v2_519RangeMinMaxRenderer5applyEPKvPvl:bb.a
  ...
  %i.bs = load float, ptr %i.b, align 8, !tbaa !19 ; 2 uses
  %i.bt = load float, ptr %i.c, align 4, !tbaa !25 ; 2 uses
...
begin_hunk_12_@_ZNK16OpenColorIO_v2_519RangeMinMaxRenderer5applyEPKvPvl:bb.a
  ...
  %i.by = load float, ptr %i.b, align 8, !tbaa !19 ; 2 uses
  %i.bz = load float, ptr %i.c, align 4, !tbaa !25 ; 2 uses
...
begin_hunk_13_@_ZNK16OpenColorIO_v2_519RangeMinMaxRenderer5applyEPKvPvl:bb.a
  ...
  %i.cf = load float, ptr %i.b, align 8, !tbaa !19 ; 2 uses
  %i.cg = load float, ptr %i.c, align 4, !tbaa !25 ; 2 uses
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %5 = getelementptr i8, ptr %2, i64 %4
  %6 = getelementptr i8, ptr %1, i64 %4
  %7 = load float, ptr %i.b, align 8, !tbaa !17, !alias.scope !48 ; 3 uses
  %broadcast.splatinsert33.a = insertelement <4 x float> poison, float %7, i64 0
  ...
  %broadcast.splat = shufflevector <4 x float> %broadcast.splatinsert, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %broadcast.splatinsert35 = insertelement <4 x float> poison, float %7, i64 0
  %broadcast.splat36 = shufflevector <4 x float> %broadcast.splatinsert35, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  br label %vector.body
...
begin_hunk_15_@_ZNK16OpenColorIO_v2_516RangeMinRenderer5applyEPKvPvl:bb.a
  ...
  %i.p = fcmp olt <4 x float> %broadcast.splat34.a, %i.o
  %i.q = select <4 x i1> %i.p, <4 x float> %i.o, <4 x float> %broadcast.splat34.a
...
begin_hunk_16_@_ZNK16OpenColorIO_v2_516RangeMinRenderer5applyEPKvPvl:bb.a
  ...
  %i.ad = fcmp olt <4 x float> %broadcast.splat, %i.ac
  %i.ae = select <4 x i1> %i.ad, <4 x float> %i.ac, <4 x float> %broadcast.splat
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %5 = getelementptr i8, ptr %2, i64 %4
  %6 = getelementptr i8, ptr %1, i64 %4
  %7 = load float, ptr %i.b, align 4, !tbaa !17, !alias.scope !58 ; 3 uses
  %broadcast.splatinsert33.a = insertelement <4 x float> poison, float %7, i64 0
  %broadcast.splat34.a = shufflevector <4 x float> %broadcast.splatinsert33.a, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
  %broadcast.splatinsert = insertelement <4 x float> poison, float %7, i64 0
  %broadcast.splat = shufflevector <4 x float> %broadcast.splatinsert, <4 x float> poison, <4 x i32> zeroinitializer ; 2 uses
...
begin_hunk_19_@_ZNK16OpenColorIO_v2_516RangeMaxRenderer5applyEPKvPvl:bb.a
  ...
  %i.n = insertelement <4 x float> %i.m, float %i.j, i64 2
  %i.o = insertelement <4 x float> %i.n, float %i.k, i64 3 ; 2 uses
  %i.p = fcmp olt <4 x float> %i.o, %broadcast.splat34.a
  %i.q = select <4 x i1> %i.p, <4 x float> %i.o, <4 x float> %broadcast.splat34.a
  %i.r = getelementptr inbounds nuw i8, ptr %next.gep29, i64 4
  %i.s = getelementptr i8, ptr %i.e, i64 20
  %i.t = getelementptr i8, ptr %i.f, i64 36
...
begin_hunk_20_@_ZNK16OpenColorIO_v2_516RangeMaxRenderer5applyEPKvPvl:bb.a
  ...
  %i.ab = insertelement <4 x float> %i.aa, float %i.x, i64 2
  %i.ac = insertelement <4 x float> %i.ab, float %i.y, i64 3 ; 2 uses
  %i.ad = fcmp olt <4 x float> %i.ac, %broadcast.splat
  %i.ae = select <4 x i1> %i.ad, <4 x float> %i.ac, <4 x float> %broadcast.splat
  %i.af = getelementptr inbounds nuw i8, ptr %next.gep29, i64 8
  %i.ag = getelementptr i8, ptr %i.e, i64 24
  %i.ah = getelementptr i8, ptr %i.f, i64 40
