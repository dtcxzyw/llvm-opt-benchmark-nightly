...
begin_hunk_0_@_ZNK16OpenColorIO_v2_516GpuShaderCreator18getDynamicPropertyENS_19DynamicPropertyTypeE:bb.a
  ...
  %.promoted = load ptr, ptr %i.e, align 8, !tbaa !59 ; 2 uses
  %.not1416 = icmp eq ptr %i.d, %.promoted
...
bb.b:                                             ; preds = %.lr.ph, %_ZNSt12__shared_ptrIN16OpenColorIO_v2_515DynamicPropertyELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit
  ...
  %i.g = load ptr, ptr %.sroa.010.017, align 8, !tbaa !60 ; 3 uses
  store ptr %i.g, ptr %0, align 8, !tbaa !60
...
_ZNSt10shared_ptrIN16OpenColorIO_v2_515DynamicPropertyEEC2ERKS2_.exit: ; preds = %bb.b, %bb.d, %bb.e
  %3 = phi ptr [ %i.g, %bb.b ], [ %i.g, %bb.d ], [ %.pre, %bb.e ] ; 2 uses
  %i.o = load ptr, ptr %3, align 8, !tbaa !7
  %i.p = load ptr, ptr %i.o, align 8
  %i.q = tail call noundef i32 %i.p(ptr noundef nonnull align 8 dereferenceable(8) %3) #25
...
bb.f:                                             ; preds = %_ZNSt10shared_ptrIN16OpenColorIO_v2_515DynamicPropertyEEC2ERKS2_.exit
  %4 = load ptr, ptr %i.f, align 8, !tbaa !45     ; 8 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.w = load ptr, ptr %4, align 8, !tbaa !7
  %i.x = getelementptr inbounds nuw i8, ptr %i.w, i64 16
  %i.y = load ptr, ptr %i.x, align 8
  tail call void %i.y(ptr noundef nonnull align 8 dereferenceable(16) %4) #25, !inline_history !65
  %i.z = load ptr, ptr %4, align 8, !tbaa !7
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 24
  %i.ab = load ptr, ptr %i.aa, align 8
  tail call void %i.ab(ptr noundef nonnull align 8 dereferenceable(16) %4) #25, !inline_history !65
...
_ZNSt12__shared_ptrIN16OpenColorIO_v2_515DynamicPropertyELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit: ; preds = %bb.f, %bb.h, %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i, %bb.l
  ...
  %.not14 = icmp eq ptr %i.ag, %.promoted
  br i1 %.not14, label %bb.m, label %bb.b

bb.m:                                             ; preds = %_ZNSt12__shared_ptrIN16OpenColorIO_v2_515DynamicPropertyELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, %bb.a
