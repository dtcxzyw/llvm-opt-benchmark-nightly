begin_hunk_0
  ...
  %i.bj = select <4 x i1> %i.bg, <4 x i1> %i.bi, <4 x i1> zeroinitializer
  %3 = freeze <4 x i1> %i.bj                      ; 2 uses
  %i.bk = select <4 x i1> %3, <4 x i32> zeroinitializer, <4 x i32> %i.bf ; 5 uses
