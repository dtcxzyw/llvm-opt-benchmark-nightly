...
.thread123:                                       ; preds = %.thread, %.preheader, %bb.o, %bb.n, %.critedge, %bb.m, %.thread126
  %.4126 = phi ptr [ %.389.ph, %.thread126 ], [ @.str.36, %.preheader ], [ @.str.39, %bb.o ], [ @.str.39, %bb.n ], [ @.str.36, %.critedge ], [ @.str.38, %bb.m ], [ @.str.22, %.thread ]
  call void @png_chunk_benign_error(ptr noundef nonnull %0, ptr noundef nonnull %.4126) #13
  br label %bb.x

bb.x:                                             ; preds = %.thread, %.thread123, %png_crc_read.exit, %bb.k, %bb.d, %bb.b
  %.3 = phi i32 [ 0, %bb.b ], [ 0, %bb.d ], [ 0, %bb.k ], [ 0, %.thread123 ], [ 0, %png_crc_read.exit ], [ 3, %.thread ]
  ret i32 %.3
}
...
bb.q:                                             ; preds = %bb.p
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #13
  br i1 %.not, label %.critedge63, label %.critedge.thread.sink.split
...
.critedge.thread.sink.split:                      ; preds = %.thread67, %bb.q, %4
  %.3 = phi ptr [ %6, %4 ], [ @.str.22, %bb.q ], [ @.str.56, %.thread67 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #13
  br label %.critedge.thread

.critedge.thread:                                 ; preds = %.preheader, %.critedge.thread.sink.split, %bb.n, %bb.m, %.critedge
  %.4 = phi ptr [ %.3, %.critedge.thread.sink.split ], [ @.str.36, %.critedge ], [ @.str.38, %bb.m ], [ @.str.55, %bb.n ], [ @.str.36, %.preheader ]
...
bb.r:                                             ; preds = %.critedge63, %png_crc_read.exit, %.critedge.thread, %bb.k, %bb.d, %bb.b
