...
begin_hunk_0_@BBox_Cubic_Check:bb.a
  ...
  %6 = xor i32 %i.p, 31                           ; 2 uses
  %7 = sub nsw i32 27, %6                         ; 2 uses
  %i.q = icmp samesign ult i32 %6, 27
  br i1 %i.q, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %spec.store.select.i = tail call i32 @llvm.smin.i32(i32 %7, i32 2) ; 2 uses
...
begin_hunk_1_@BBox_Cubic_Check:bb.a
  ...
  %.0.i = phi i32 [ %spec.store.select.i, %bb.c ], [ %7, %bb.d ] ; 3 uses
  br label %bb.f
...
begin_hunk_2_@BBox_Cubic_Check:bb.a
  ...
  %8 = xor i32 %i.bs, 31                          ; 2 uses
  %9 = sub nsw i32 27, %8                         ; 2 uses
  %i.bt = icmp samesign ult i32 %8, 27
  br i1 %i.bt, label %bb.n, label %bb.o

bb.n:                                             ; preds = %bb.m
  %spec.store.select.i47 = tail call i32 @llvm.smin.i32(i32 %9, i32 2) ; 2 uses
...
begin_hunk_3_@BBox_Cubic_Check:bb.a
  ...
  %.0.i32 = phi i32 [ %spec.store.select.i47, %bb.n ], [ %9, %bb.o ] ; 3 uses
  br label %bb.q
