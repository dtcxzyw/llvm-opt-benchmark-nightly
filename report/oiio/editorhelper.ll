...
bb.a:
  ...
  %5 = shufflevector <4 x double> %i.e, <4 x double> %i.f, <4 x i32> <i32 0, i32 0, i32 5, i32 6>
  %i.g = fmul contract <4 x double> %i.f, %5
  %i.h = fmul contract <4 x double> %i.d, %i.g
  %i.i = insertelement <4 x double> poison, double %0, i64 0
  %i.j = insertelement <4 x double> %i.i, double %1, i64 1
  %i.k = insertelement <4 x double> %i.j, double %2, i64 2
  ...
  %i.o = extractelement <4 x double> %i.m, i64 1
  %i.p = fadd contract double %i.n, %i.o
  %i.q = extractelement <4 x double> %i.m, i64 2
