...
.preheader63:                                     ; preds = %.lr.ph68, %.preheader63.loopexit, %bb.a
  ...
  %spec.select.2.1 = phi i32 [ 0, %bb.a ], [ %i.bn, %.preheader63.loopexit ], [ 0, %.lr.ph68 ]
  %i.cf = phi i32 [ 0, %bb.a ], [ %i.bl, %.preheader63.loopexit ], [ 0, %.lr.ph68 ]
  ...
  %op.rdx137 = add nsw i32 %i.cg, %spec.select.2.1
  %op.rdx138 = add nsw i32 %op.rdx137, %i.cf      ; 2 uses
  ...
  %op.rdx135 = add i32 %i.ci, %i.ce
  %op.rdx136 = add i32 %op.rdx135, %i.cd          ; 2 uses
