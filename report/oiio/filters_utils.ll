...
.preheader63:                                     ; preds = %.lr.ph68, %.preheader63.loopexit, %bb.a
  ...
  %spec.select.2.1 = phi i32 [ 0, %bb.a ], [ %i.bv, %.preheader63.loopexit ], [ 0, %.lr.ph68 ]
  ...
  %op.rdx137 = add nsw i32 %i.cg, %i.cf
  %op.rdx138 = add nsw i32 %op.rdx137, %spec.select.2 ; 2 uses
  ...
  %op.rdx133 = add nsw i32 %spec.select.2.1, %i.ce
  %op.rdx134 = add nuw nsw i32 %op.rdx131, %op.rdx132
  %op.rdx135 = add nsw i32 %op.rdx133, %i.cd
  %op.rdx136 = add nsw i32 %op.rdx134, %op.rdx135 ; 2 uses
  %i.cj = icmp samesign ult i32 %op.rdx136, %op.rdx138
  %spec.select61.1 = zext i1 %i.cj to i32
  %i.ck = tail call i32 @llvm.umin.i32(i32 %op.rdx136, i32 %op.rdx138) ; 2 uses
end_hunk_1
