...
.preheader63:                                     ; preds = %.lr.ph68, %.preheader63.loopexit, %bb.a
  ...
  %op.rdx129.a = add nsw i32 %i.cj, %i.ch
  %op.rdx130.a = add nsw i32 %op.rdx129.a, %spec.select.2 ; 2 uses
  ...
  %op.rdx.a = add i32 %i.cq, %i.cg
  %op.rdx128.a = add i32 %op.rdx.a, %i.cf         ; 2 uses
  %i.cr = icmp samesign ult i32 %op.rdx128.a, %op.rdx130.a
  %spec.select61.1 = zext i1 %i.cr to i32
  %i.cs = tail call i32 @llvm.umin.i32(i32 %op.rdx128.a, i32 %op.rdx130.a) ; 2 uses
