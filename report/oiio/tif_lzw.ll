...
begin_hunk_0_@LZWDecodeCompat:bb.a
  ...
  %.2258458 = phi ptr [ %.1257, %.lr.ph ], [ %.2258.be, %.backedge ] ; 9 uses
...
bb.y:                                             ; preds = %bb.x
  %.2258458.lcssa1592 = phi ptr [ %.2258458, %bb.x ] ; 2 uses
...
begin_hunk_2_@LZWDecodeCompat:bb.a
  ...
  %scevgep1585 = getelementptr i8, ptr %.2258458.lcssa1592, i64 %.4253.prol
  ...
  %scevgep1584 = getelementptr i8, ptr %.2258458.lcssa1592, i64 %i.hh
