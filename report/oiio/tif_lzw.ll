...
begin_hunk_1_@LZWDecodeCompat:bb.a
  ...
  %4 = getelementptr inbounds nuw i8, ptr %i.b, i64 144
  %5 = load i64, ptr %4, align 8, !tbaa !73       ; 2 uses
  %6 = load i64, ptr %i.cp, align 8, !tbaa !72    ; 2 uses
...
begin_hunk_3_@LZWDecodeCompat:bb.a
  ...
  %.0214464 = phi i64 [ %6, %.lr.ph ], [ %.0214.be, %.backedge ] ; 2 uses
  %.0220463 = phi i64 [ %i.cr, %.lr.ph ], [ %.0220.be, %.backedge ] ; 4 uses
  %.0223462 = phi i64 [ %5, %.lr.ph ], [ %.0223.be, %.backedge ] ; 4 uses
...
begin_hunk_5_@LZWDecodeCompat:bb.a
  ...
  %i.jb = phi <2 x i64> [ %i.df, %.thread285 ], [ %i.hc, %.prol.loopexit1148 ], [ %i.ei, %.thread291 ], [ %i.iw, %.loopexit298 ], [ %8, %bb.e ], [ %i.hc, %.new1149 ], [ %i.iy, %.loopexit.loopexit970.split.loop.exit ], [ %i.ja, %.loopexit.loopexit970.split.loop.exit1335 ]
...
begin_hunk_6_@LZWDecodeCompat:bb.a
  ...
  store <2 x i64> %i.jb, ptr %i.cp, align 8, !tbaa !95
