...
begin_hunk_0_@VP8DecompressAlphaRows:bb.a
  ...
  tail call void %i.dd(ptr noundef %.03439.i, ptr noundef %.03340.i, ptr noundef %.041.i, i32 noundef %i.cg) #3
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %bb.t, !llvm.loop !59
...
begin_hunk_1_@VP8DecompressAlphaRows:bb.a
  ...
  %i.ds = load i32, ptr %i.dr, align 8, !tbaa !61 ; 2 uses
