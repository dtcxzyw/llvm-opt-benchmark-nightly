...
.lr.ph.preheader:                                 ; preds = %bb.g
  ...
  %min.iters.check = icmp eq i32 %i.ca, 1
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %i.cb, 4294967294              ; 5 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.co = shl i64 %index, 2                       ; 2 uses
  %next.gep.a = getelementptr i8, ptr %i.q, i64 %i.co ; 4 uses
  %i.cp = getelementptr i8, ptr %i.q, i64 %i.co   ; 4 uses
  %next.gep128.a = getelementptr i8, ptr %i.cp, i64 4
  %i.cq = mul i64 %index, 3
  %next.gep129.a = getelementptr i8, ptr %.078, i64 %i.cq
  %i.cr = getelementptr inbounds nuw i8, ptr %next.gep.a, i64 1
  %i.cs = getelementptr i8, ptr %i.cp, i64 5
  %i.ct = load i8, ptr %next.gep.a, align 1, !tbaa !37, !alias.scope !83
  %i.cu = load i8, ptr %next.gep128.a, align 1, !tbaa !37, !alias.scope !83
  %3 = insertelement <2 x i8> poison, i8 %i.ct, i64 0
  %4 = insertelement <2 x i8> %3, i8 %i.cu, i64 1
  %i.cv = getelementptr inbounds nuw i8, ptr %next.gep.a, i64 2
  %i.cw = getelementptr i8, ptr %i.cp, i64 6
  %i.cx = load i8, ptr %i.cr, align 1, !tbaa !37, !alias.scope !83
  %i.cy = load i8, ptr %i.cs, align 1, !tbaa !37, !alias.scope !83
  %5 = insertelement <2 x i8> poison, i8 %i.cx, i64 0
  %6 = insertelement <2 x i8> %5, i8 %i.cy, i64 1
  %i.cz = getelementptr inbounds nuw i8, ptr %next.gep.a, i64 3
  %i.da = getelementptr i8, ptr %i.cp, i64 7
  %i.db = load i8, ptr %i.cv, align 1, !tbaa !37, !alias.scope !83
  %i.dc = load i8, ptr %i.cw, align 1, !tbaa !37, !alias.scope !83
  %7 = insertelement <2 x i8> poison, i8 %i.db, i64 0
  %8 = insertelement <2 x i8> %7, i8 %i.dc, i64 1
  %i.dd = load i8, ptr %i.cz, align 1, !tbaa !37, !alias.scope !83
  %i.de = load i8, ptr %i.da, align 1, !tbaa !37, !alias.scope !83
  %9 = insertelement <2 x i8> poison, i8 %i.dd, i64 0
  %10 = insertelement <2 x i8> %9, i8 %i.de, i64 1
  %11 = uitofp <2 x i8> %4 to <2 x double>
  %12 = uitofp <2 x i8> %10 to <2 x double>       ; 3 uses
  %13 = fmul nnan <2 x double> %11, %12
  %14 = fdiv <2 x double> %13, splat (double 2.550000e+02)
  %15 = fadd <2 x double> %14, splat (double 5.000000e-01)
  %16 = fptoui <2 x double> %15 to <2 x i8>
  %17 = uitofp <2 x i8> %6 to <2 x double>
  %18 = fmul nnan <2 x double> %17, %12
  %19 = uitofp <2 x i8> %8 to <2 x double>
  %20 = fmul nnan <2 x double> %19, %12
  %21 = shufflevector <2 x double> %20, <2 x double> %18, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %22 = fdiv <4 x double> %21, splat (double 2.550000e+02)
  %23 = fadd <4 x double> %22, splat (double 5.000000e-01)
  %24 = fptoui <4 x double> %23 to <4 x i8>
  %25 = shufflevector <2 x i8> %16, <2 x i8> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %interleaved.vec = shufflevector <4 x i8> %24, <4 x i8> %25, <6 x i32> <i32 0, i32 2, i32 4, i32 1, i32 3, i32 5>
  store <6 x i8> %interleaved.vec, ptr %next.gep129.a, align 1, !tbaa !37, !alias.scope !86, !noalias !83
