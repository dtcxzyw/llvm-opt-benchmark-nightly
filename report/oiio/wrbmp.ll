...
.lr.ph:                                           ; preds = %.lr.ph.preheader140, %.lr.ph
  ...
  %i.hn = add i32 %.18194, -1                     ; 2 uses
  %.not88 = icmp eq i32 %i.hn, 0
  br i1 %.not88, label %.loopexit, label %.lr.ph, !llvm.loop !91

bb.h:                                             ; preds = %bb.d
  %i.ho = getelementptr inbounds nuw i8, ptr %0, i64 136
  %i.hp = load i32, ptr %i.ho, align 8, !tbaa !54 ; 5 uses
  %.not87103 = icmp eq i32 %i.hp, 0
  br i1 %.not87103, label %.loopexit, label %.lr.ph107

.lr.ph107:                                        ; preds = %bb.h
  %i.hq = zext i32 %i.s to i64                    ; 4 uses
  %i.hr = getelementptr inbounds nuw [4 x i8], ptr @rgb_pixelsize, i64 %i.hq
  %i.hs = load i32, ptr %i.hr, align 4, !tbaa !4
  %i.ht = getelementptr inbounds nuw [4 x i8], ptr @rgb_blue, i64 %i.hq
  %i.hu = load i32, ptr %i.ht, align 4, !tbaa !4
  %i.hv = getelementptr inbounds nuw [4 x i8], ptr @rgb_green, i64 %i.hq
  %i.hw = load i32, ptr %i.hv, align 4, !tbaa !4
  %i.hx = getelementptr inbounds nuw [4 x i8], ptr @rgb_red, i64 %i.hq
  %i.hy = load i32, ptr %i.hx, align 4, !tbaa !4
  %i.hz = sext i32 %i.hu to i64                   ; 3 uses
  %i.ia = sext i32 %i.hw to i64                   ; 3 uses
  %i.ib = sext i32 %i.hy to i64                   ; 3 uses
  %i.ic = sext i32 %i.hs to i64                   ; 3 uses
  %xtraiter143 = and i32 %i.hp, 1
...
.prol.loopexit.unr-lcssa:                         ; preds = %.lr.ph107
  %i.id = getelementptr inbounds i8, ptr %i.q, i64 %i.hz
  %i.ie = load i8, ptr %i.id, align 1, !tbaa !37
  store i8 %i.ie, ptr %.078, align 1, !tbaa !37
  %i.if = getelementptr inbounds i8, ptr %i.q, i64 %i.ia
  %i.ig = load i8, ptr %i.if, align 1, !tbaa !37
  %i.ih = getelementptr inbounds nuw i8, ptr %.078, i64 1
  store i8 %i.ig, ptr %i.ih, align 1, !tbaa !37
  %i.ii = getelementptr inbounds i8, ptr %i.q, i64 %i.ib
  %i.ij = load i8, ptr %i.ii, align 1, !tbaa !37
  %i.ik = getelementptr inbounds nuw i8, ptr %.078, i64 2
  store i8 %i.ij, ptr %i.ik, align 1, !tbaa !37
  %i.il = getelementptr inbounds nuw i8, ptr %.078, i64 3 ; 2 uses
  %i.im = getelementptr inbounds i8, ptr %i.q, i64 %i.ic
  %i.in = add nsw i32 %i.hp, -1
  br label %.prol.loopexit

.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.lr.ph107
  %.lcssa.unr = phi ptr [ poison, %.lr.ph107 ], [ %i.il, %.prol.loopexit.unr-lcssa ]
  %.1106.unr = phi ptr [ %i.q, %.lr.ph107 ], [ %i.im, %.prol.loopexit.unr-lcssa ]
  %.3105.unr = phi ptr [ %.078, %.lr.ph107 ], [ %i.il, %.prol.loopexit.unr-lcssa ]
  %.282104.unr = phi i32 [ %i.hp, %.lr.ph107 ], [ %i.in, %.prol.loopexit.unr-lcssa ]
  %i.io = icmp eq i32 %i.hp, 1
  br i1 %i.io, label %.loopexit, label %.lr.ph107.new

.lr.ph107.new:                                    ; preds = %.prol.loopexit, %.lr.ph107.new
  %.1106 = phi ptr [ %i.ji, %.lr.ph107.new ], [ %.1106.unr, %.prol.loopexit ] ; 4 uses
  %.3105 = phi ptr [ %i.jh, %.lr.ph107.new ], [ %.3105.unr, %.prol.loopexit ] ; 7 uses
  %.282104 = phi i32 [ %i.jj, %.lr.ph107.new ], [ %.282104.unr, %.prol.loopexit ]
  %i.ip = getelementptr inbounds i8, ptr %.1106, i64 %i.hz
  %i.iq = load i8, ptr %i.ip, align 1, !tbaa !37
  store i8 %i.iq, ptr %.3105, align 1, !tbaa !37
  %i.ir = getelementptr inbounds i8, ptr %.1106, i64 %i.ia
  %i.is = load i8, ptr %i.ir, align 1, !tbaa !37
  %i.it = getelementptr inbounds nuw i8, ptr %.3105, i64 1
  store i8 %i.is, ptr %i.it, align 1, !tbaa !37
  %i.iu = getelementptr inbounds i8, ptr %.1106, i64 %i.ib
  %i.iv = load i8, ptr %i.iu, align 1, !tbaa !37
  %i.iw = getelementptr inbounds nuw i8, ptr %.3105, i64 2
  store i8 %i.iv, ptr %i.iw, align 1, !tbaa !37
  %i.ix = getelementptr inbounds nuw i8, ptr %.3105, i64 3
  %i.iy = getelementptr inbounds i8, ptr %.1106, i64 %i.ic ; 4 uses
  %i.iz = getelementptr inbounds i8, ptr %i.iy, i64 %i.hz
  %i.ja = load i8, ptr %i.iz, align 1, !tbaa !37
  store i8 %i.ja, ptr %i.ix, align 1, !tbaa !37
  %i.jb = getelementptr inbounds i8, ptr %i.iy, i64 %i.ia
  %i.jc = load i8, ptr %i.jb, align 1, !tbaa !37
  %i.jd = getelementptr inbounds nuw i8, ptr %.3105, i64 4
  store i8 %i.jc, ptr %i.jd, align 1, !tbaa !37
  %i.je = getelementptr inbounds i8, ptr %i.iy, i64 %i.ib
  %i.jf = load i8, ptr %i.je, align 1, !tbaa !37
  %i.jg = getelementptr inbounds nuw i8, ptr %.3105, i64 5
  store i8 %i.jf, ptr %i.jg, align 1, !tbaa !37
  %i.jh = getelementptr inbounds nuw i8, ptr %.3105, i64 6 ; 2 uses
  %i.ji = getelementptr inbounds i8, ptr %i.iy, i64 %i.ic
  %i.jj = add i32 %.282104, -2                    ; 2 uses
  %.not87.1 = icmp eq i32 %i.jj, 0
...
.loopexit:                                        ; preds = %.lr.ph, %.lr.ph101.prol.loopexit, %.lr.ph101, %.prol.loopexit, %.lr.ph107.new, %middle.block, %bb.g, %bb.f, %bb.h, %bb.e
  %.4 = phi ptr [ %i.aa, %bb.e ], [ %i.bw, %.lr.ph101 ], [ %i.jh, %.lr.ph107.new ], [ %.078, %bb.h ], [ %.078, %bb.f ], [ %.078, %bb.g ], [ %i.cl, %middle.block ], [ %.lcssa.unr, %.prol.loopexit ], [ %.lcssa139.unr, %.lr.ph101.prol.loopexit ], [ %i.hm, %.lr.ph ]
  %i.jk = getelementptr inbounds nuw i8, ptr %1, i64 96
  %i.jl = load i32, ptr %i.jk, align 8, !tbaa !58 ; 2 uses
  %i.jm = icmp sgt i32 %i.jl, 0
  br i1 %i.jm, label %.lr.ph111.preheader, label %._crit_edge

.lr.ph111.preheader:                              ; preds = %.loopexit
  %i.jn = zext nneg i32 %i.jl to i64
  tail call void @llvm.memset.p0.i64(ptr align 1 %.4, i8 0, i64 %i.jn, i1 false), !tbaa !37
  br label %._crit_edge

._crit_edge:                                      ; preds = %.lr.ph111.preheader, %.loopexit
  %i.jo = load i32, ptr %i.a, align 8, !tbaa !68
  %.not90 = icmp eq i32 %i.jo, 0
  br i1 %.not90, label %bb.i, label %bb.j

bb.i:                                             ; preds = %._crit_edge
  %i.jp = getelementptr inbounds nuw i8, ptr %1, i64 112
  %i.jq = load ptr, ptr %i.jp, align 8, !tbaa !67
  %i.jr = getelementptr inbounds nuw i8, ptr %1, i64 92
  %i.js = load i32, ptr %i.jr, align 4, !tbaa !56
  %i.jt = zext i32 %i.js to i64
  %i.ju = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.jv = load ptr, ptr %i.ju, align 8, !tbaa !72
  %i.jw = tail call i64 @fwrite(ptr noundef %i.jq, i64 noundef 1, i64 noundef %i.jt, ptr noundef %i.jv) ; 0 uses
  br label %bb.j
