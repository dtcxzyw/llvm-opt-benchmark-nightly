...
begin_hunk_0_@VP8LGetHistoImageSymbols:bb.a
  ...
  %i.yv = icmp sgt i32 %.sroa.13.2178.i, 0
  br i1 %i.yv, label %.lr.ph148.i, label %.loopexit.i

.lr.ph148.i:                                      ; preds = %HistoQueuePush.exit._crit_edge.thread.i, %bb.bq
  %.188146.i = phi i32 [ %.289.i, %bb.bq ], [ 0, %HistoQueuePush.exit._crit_edge.thread.i ] ; 4 uses
  %.sroa.13.3145.i = phi i32 [ %.sroa.13.4.i, %bb.bq ], [ %.sroa.13.2178.i, %HistoQueuePush.exit._crit_edge.thread.i ] ; 5 uses
  %i.yw = sext i32 %.188146.i to i64
...
bb.ba:                                            ; preds = %.lr.ph148.i
  %i.zg = sext i32 %.sroa.13.3145.i to i64
  ...
  %i.zj = add nsw i32 %.sroa.13.3145.i, -1
  br label %bb.bq, !llvm.loop !68

bb.bb:                                            ; preds = %.lr.ph148.i
...
HistoQueueFixPair.exit.i:                         ; preds = %bb.bh, %bb.bg
  ...
  %.not.i.i90 = icmp eq i32 %i.aac, 0
  br i1 %.not.i.i90, label %bb.bi, label %HistoQueueUpdatePair.exit.i
...
HistoQueueUpdatePair.exit.i:                      ; preds = %HistoQueueFixPair.exit.i
  ...
  %.pre.i91 = load i32, ptr %i.yx, align 8, !tbaa !63
  br label %bb.bj

bb.bi:                                            ; preds = %HistoQueueFixPair.exit.i
  %i.aag = sext i32 %.sroa.13.3145.i to i64
  ...
  %i.aaj = add nsw i32 %.sroa.13.3145.i, -1
  br label %bb.bq, !llvm.loop !68

bb.bj:                                            ; preds = %HistoQueueUpdatePair.exit.i, %bb.bb
  %i.aak = phi i32 [ %.pre.i91, %HistoQueueUpdatePair.exit.i ], [ %i.yy, %bb.bb ] ; 2 uses
...
HistoQueueUpdateHead.exit.i:                      ; preds = %bb.bp, %HistoQueueFixPair.exit105.i
  %i.aaw = add nsw i32 %.188146.i, 1
  br label %bb.bq

bb.bq:                                            ; preds = %HistoQueueUpdateHead.exit.i, %bb.bi, %bb.ba
  %.sroa.13.4.i = phi i32 [ %i.zj, %bb.ba ], [ %i.aaj, %bb.bi ], [ %.sroa.13.3145.i, %HistoQueueUpdateHead.exit.i ] ; 3 uses
  %.289.i = phi i32 [ %.188146.i, %bb.ba ], [ %.188146.i, %bb.bi ], [ %i.aaw, %HistoQueueUpdateHead.exit.i ] ; 2 uses
  %i.aax = icmp slt i32 %.289.i, %.sroa.13.4.i
  br i1 %i.aax, label %.lr.ph148.i, label %.loopexit.i

.loopexit.i:                                      ; preds = %bb.bq, %HistoQueuePush.exit._crit_edge.thread.i, %HistoQueuePush.exit._crit_edge.i
  %.2125177.i = phi i32 [ %.2125.i, %HistoQueuePush.exit._crit_edge.i ], [ %.2125176.i, %HistoQueuePush.exit._crit_edge.thread.i ], [ %.2125176.i, %bb.bq ]
  %.sroa.13.5.i = phi i32 [ 0, %HistoQueuePush.exit._crit_edge.i ], [ %.sroa.13.2178.i, %HistoQueuePush.exit._crit_edge.thread.i ], [ %.sroa.13.4.i, %bb.bq ]
  %.185.i = phi i32 [ %i.vn, %HistoQueuePush.exit._crit_edge.i ], [ 0, %HistoQueuePush.exit._crit_edge.thread.i ], [ 0, %bb.bq ]
  %i.aay = add nuw nsw i32 %.086152.i, 1          ; 2 uses
...
.loopexit:                                        ; preds = %.loopexit.i, %bb.as, %bb.ar, %.preheader.i
  ...
  %.not158 = icmp sgt i32 %i.aba, %i.uv
  call void @WebPSafeFree(ptr noundef nonnull %i.uy) #10
  %.pre198.a = load i32, ptr %7, align 8, !tbaa !26 ; 2 uses
  br i1 %.not158, label %.thread152, label %.thread147thread-pre-split

.thread147thread-pre-split:                       ; preds = %.loopexit
  %.pre196 = load ptr, ptr %i.gk, align 8, !tbaa !22
  br label %.thread147

.thread147:                                       ; preds = %.thread147thread-pre-split, %DivRound.exit
  %i.abb = phi ptr [ %.pre196, %.thread147thread-pre-split ], [ %i.ux, %DivRound.exit ] ; 4 uses
  %i.abc = phi i32 [ %.pre198.a, %.thread147thread-pre-split ], [ %i.un, %DivRound.exit ] ; 4 uses
  ...
  %.not114.i = icmp eq ptr %i.abg, null
  br i1 %.not114.i, label %bb.dv, label %.preheader118.i

.preheader118.i:                                  ; preds = %.thread147
  %i.abh = icmp sgt i32 %i.abc, 0
  br i1 %i.abh, label %.lr.ph129.i, label %HistogramCombineGreedy.exit.thread

.lr.ph129.i:                                      ; preds = %.preheader118.i
...
.loopexit117.i:                                   ; preds = %HistoQueuePush.exit.i108, %bb.bs
  %.sroa.13.1.lcssa.i = phi i32 [ %.sroa.13.0127.i, %bb.bs ], [ %.sroa.13.7.i, %HistoQueuePush.exit.i108 ] ; 3 uses
  %indvars.iv.next.i98 = add nuw nsw i64 %indvars.iv.i97, 1
  %exitcond148.not.i = icmp eq i64 %indvars.iv.next152.i, %29
  br i1 %exitcond148.not.i, label %.preheader115.i, label %bb.bs, !llvm.loop !70

.preheader115.i:                                  ; preds = %.loopexit117.i
  %i.abv = icmp sgt i32 %.sroa.13.1.lcssa.i, 0
  br i1 %i.abv, label %.lr.ph144.i, label %HistogramCombineGreedy.exit.thread

.lr.ph144.i:                                      ; preds = %.preheader115.i
...
bb.bs:                                            ; preds = %.loopexit117.i, %.lr.ph129.i
  %indvars.iv151.i = phi i64 [ 0, %.lr.ph129.i ], [ %indvars.iv.next152.i, %.loopexit117.i ] ; 3 uses
  %indvars.iv.i97 = phi i64 [ 1, %.lr.ph129.i ], [ %indvars.iv.next.i98, %.loopexit117.i ] ; 2 uses
  %.sroa.13.0127.i = phi i32 [ 0, %.lr.ph129.i ], [ %.sroa.13.1.lcssa.i, %.loopexit117.i ] ; 2 uses
  %indvars.iv.next152.i = add nuw nsw i64 %indvars.iv151.i, 1 ; 3 uses
  %30 = icmp samesign ult i64 %indvars.iv.next152.i, %29
  br i1 %30, label %.lr.ph.i107, label %.loopexit117.i

.lr.ph.i107:                                      ; preds = %bb.bs
  %31 = getelementptr inbounds nuw [8 x i8], ptr %i.abb, i64 %indvars.iv151.i
  %32 = trunc nuw nsw i64 %indvars.iv151.i to i32
  br label %.lr.ph.i105

.lr.ph.i105:                                      ; preds = %HistoQueuePush.exit.i108, %.lr.ph.i107
  %indvars.iv148.i = phi i64 [ %indvars.iv.i97, %.lr.ph.i107 ], [ %indvars.iv.next149.i, %HistoQueuePush.exit.i108 ] ; 3 uses
  %.sroa.13.1125.i = phi i32 [ %.sroa.13.0127.i, %.lr.ph.i107 ], [ %.sroa.13.7.i, %HistoQueuePush.exit.i108 ] ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %23) #10
  %i.acp = icmp eq i32 %.sroa.13.1125.i, %i.abd
  br i1 %i.acp, label %HistoQueuePush.exit.i108, label %bb.bt

bb.bt:                                            ; preds = %.lr.ph.i105
  store i32 %32, ptr %23, align 8, !tbaa !63
  %33 = trunc nuw nsw i64 %indvars.iv148.i to i32
  store i32 %33, ptr %i.abi, align 4, !tbaa !64
  %i.acq = load ptr, ptr %31, align 8, !tbaa !27  ; 9 uses
  %i.acr = getelementptr inbounds nuw [8 x i8], ptr %i.abb, i64 %indvars.iv148.i
  ...
  br i1 %i.acy, label %HistoQueuePush.exit.i108, label %bb.bu
...
bb.bv:                                            ; preds = %GetCombinedEntropy.exit.i.i
  %indvars.iv.next.i.i110 = add nuw nsw i64 %indvars.iv.i.i106, 1 ; 2 uses
  %exitcond.not.i.i111 = icmp eq i64 %indvars.iv.next.i.i110, 5
  br i1 %exitcond.not.i.i111, label %GetCombinedHistogramEntropy.exit.i, label %bb.bw, !llvm.loop !71

bb.bw:                                            ; preds = %bb.bv, %bb.bu
  %i.ado = phi i64 [ 0, %bb.bu ], [ %i.agm, %bb.bv ]
  %indvars.iv.i.i106 = phi i64 [ 0, %bb.bu ], [ %indvars.iv.next.i.i110, %bb.bv ] ; 9 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %17) #10
  call void @llvm.lifetime.start.p0(ptr nonnull %18) #10
  %i.adp = getelementptr inbounds nuw i8, ptr %i.acz, i64 %indvars.iv.i.i106
  %i.adq = load i8, ptr %i.adp, align 1, !tbaa !15
  %i.adr = getelementptr inbounds nuw i8, ptr %i.ada, i64 %indvars.iv.i.i106
  %i.ads = load i8, ptr %i.adr, align 1, !tbaa !15
  %i.adt = getelementptr inbounds nuw [2 x i8], ptr %i.adb, i64 %indvars.iv.i.i106
  %i.adu = load i16, ptr %i.adt, align 2, !tbaa !14 ; 2 uses
  %.not.i.i62.i = icmp eq i16 %i.adu, -1
  br i1 %.not.i.i62.i, label %bb.by, label %bb.bx

bb.bx:                                            ; preds = %bb.bw
  %i.adv = getelementptr inbounds nuw [2 x i8], ptr %i.adc, i64 %indvars.iv.i.i106
...
bb.ca:                                            ; preds = %bb.bz
  %i.aeb = getelementptr inbounds nuw [8 x i8], ptr %i.ade, i64 %indvars.iv.i.i106
  %i.aec = load i64, ptr %i.aeb, align 8, !tbaa !45
  br label %GetCombinedEntropy.exit.i.i

bb.cb:                                            ; preds = %bb.bz
  %i.aed = getelementptr inbounds nuw [8 x i8], ptr %i.add, i64 %indvars.iv.i.i106
  %i.aee = load i64, ptr %i.aed, align 8, !tbaa !45
  br label %GetCombinedEntropy.exit.i.i

bb.cc:                                            ; preds = %bb.by
  %i.aef = trunc nuw nsw i64 %indvars.iv.i.i106 to i32
...
GetCombinedEntropy.exit.i.i:                      ; preds = %BitsEntropyRefine.exit.i.i.i, %bb.cb, %bb.ca
  ...
  %i.agl = getelementptr inbounds nuw [8 x i8], ptr %i.abk, i64 %indvars.iv.i.i106
  store i64 %.0.i.i.i, ptr %i.agl, align 8, !tbaa !45
  %i.agm = add i64 %.0.i.i.i, %i.ado              ; 4 uses
  %.not.i.i107 = icmp ult i64 %i.agm, %i.acx
  br i1 %.not.i.i107, label %bb.bv, label %HistoQueuePush.exit.i108
...
GetCombinedHistogramEntropy.exit.i:               ; preds = %bb.bv
  ...
  %i.ago = add nsw i32 %.sroa.13.1125.i, 1        ; 3 uses
  %i.agp = sext i32 %.sroa.13.1125.i to i64
  ...
  br i1 %i.agw, label %bb.cm, label %HistoQueuePush.exit.i108
...
bb.cm:                                            ; preds = %GetCombinedHistogramEntropy.exit.i
  ...
  br label %HistoQueuePush.exit.i108

HistoQueuePush.exit.i108:                         ; preds = %GetCombinedEntropy.exit.i.i, %bb.cm, %GetCombinedHistogramEntropy.exit.i, %bb.bt, %.lr.ph.i105
  %.sroa.13.7.i = phi i32 [ %i.abd, %.lr.ph.i105 ], [ %i.ago, %GetCombinedHistogramEntropy.exit.i ], [ %i.ago, %bb.cm ], [ %.sroa.13.1125.i, %bb.bt ], [ %.sroa.13.1125.i, %GetCombinedEntropy.exit.i.i ] ; 2 uses
  call void @llvm.lifetime.end.p0(ptr nonnull %23) #10
  %indvars.iv.next149.i = add nuw nsw i64 %indvars.iv148.i, 1 ; 2 uses
  %exitcond.not.i109 = icmp eq i64 %indvars.iv.next149.i, %29
  br i1 %exitcond.not.i109, label %.loopexit117.i, label %.lr.ph.i105, !llvm.loop !73

.loopexit.i103:                                   ; preds = %bb.du, %.preheader.i102
  %.sroa.13.5.lcssa.i = phi i32 [ %.sroa.13.4.i100, %.preheader.i102 ], [ %.sroa.13.6.i, %bb.du ] ; 2 uses
  %i.agy = icmp sgt i32 %.sroa.13.5.lcssa.i, 0
  br i1 %i.agy, label %bb.cn, label %HistogramCombineGreedy.exit.thread, !llvm.loop !74

bb.cn:                                            ; preds = %.loopexit.i103, %.lr.ph144.i
  %.sroa.13.2143.i = phi i32 [ %.sroa.13.1.lcssa.i, %.lr.ph144.i ], [ %.sroa.13.5.lcssa.i, %.loopexit.i103 ]
...
.preheader.i102:                                  ; preds = %bb.cy
  %i.aic = load i32, ptr %7, align 8, !tbaa !26   ; 2 uses
  %i.aid = icmp sgt i32 %i.aic, 0
  br i1 %i.aid, label %.lr.ph141.i, label %.loopexit.i103

bb.co:                                            ; preds = %bb.cy, %bb.cn
  %.1132.i = phi i32 [ 0, %bb.cn ], [ %.2.i101, %bb.cy ] ; 3 uses
  %.sroa.13.3131.i = phi i32 [ %.sroa.13.2143.i, %bb.cn ], [ %.sroa.13.4.i100, %bb.cy ] ; 3 uses
  %i.aie = sext i32 %.1132.i to i64
...
bb.cp:                                            ; preds = %bb.co
  ...
  %or.cond.i97 = or i1 %i.ail, %i.aik
  %i.aim = icmp eq i32 %i.aij, %i.aha
  %or.cond56.i = or i1 %i.aim, %or.cond.i97
  br i1 %or.cond56.i, label %bb.cq, label %bb.cr

bb.cq:                                            ; preds = %bb.cp, %bb.co
  %i.ain = sext i32 %.sroa.13.3131.i to i64
  ...
  %i.aiq = add nsw i32 %.sroa.13.3131.i, -1
  br label %bb.cy
...
bb.cv:                                            ; preds = %bb.cu, %bb.ct
  ...
  br i1 %i.aiw, label %bb.cw, label %HistoQueueFixPair.exit.i98

bb.cw:                                            ; preds = %bb.cv
  store i32 %i.aiv, ptr %i.aif, align 8, !tbaa !63
  store i32 %i.ait, ptr %i.aii, align 4, !tbaa !64
  br label %HistoQueueFixPair.exit.i98

HistoQueueFixPair.exit.i98:                       ; preds = %bb.cw, %bb.cv
  ...
  br i1 %i.aja, label %bb.cx, label %HistoQueueUpdateHead.exit.i99

bb.cx:                                            ; preds = %HistoQueueFixPair.exit.i98
  ...
  br label %HistoQueueUpdateHead.exit.i99

HistoQueueUpdateHead.exit.i99:                    ; preds = %bb.cx, %HistoQueueFixPair.exit.i98
  %i.ajb = add nsw i32 %.1132.i, 1
  br label %bb.cy

bb.cy:                                            ; preds = %HistoQueueUpdateHead.exit.i99, %bb.cq
  %.sroa.13.4.i100 = phi i32 [ %i.aiq, %bb.cq ], [ %.sroa.13.3131.i, %HistoQueueUpdateHead.exit.i99 ] ; 4 uses
  %.2.i101 = phi i32 [ %.1132.i, %bb.cq ], [ %i.ajb, %HistoQueueUpdateHead.exit.i99 ] ; 2 uses
  %i.ajc = icmp slt i32 %.2.i101, %.sroa.13.4.i100
  br i1 %i.ajc, label %bb.co, label %.preheader.i102, !llvm.loop !75

.lr.ph141.i:                                      ; preds = %.preheader.i102, %bb.du
  %i.ajd = phi i32 [ %i.ans, %bb.du ], [ %i.aic, %.preheader.i102 ]
  %.3139.i = phi i32 [ %i.ant, %bb.du ], [ 0, %.preheader.i102 ] ; 4 uses
  %.sroa.13.5138.i = phi i32 [ %.sroa.13.6.i, %bb.du ], [ %.sroa.13.4.i100, %.preheader.i102 ] ; 6 uses
  %i.aje = icmp eq i32 %.3139.i, %i.agz
  br i1 %i.aje, label %bb.du, label %bb.cz

bb.cz:                                            ; preds = %.lr.ph141.i
  %i.ajf = load ptr, ptr %i.gk, align 8, !tbaa !22 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %20) #10
  %i.ajg = icmp eq i32 %.sroa.13.5138.i, %i.abd
  br i1 %i.ajg, label %HistoQueuePush.exit61.i, label %bb.da

bb.da:                                            ; preds = %bb.cz
  %spec.select.i57.i = call i32 @llvm.smax.i32(i32 %i.agz, i32 %.3139.i) ; 2 uses
  %spec.select26.i58.i = call i32 @llvm.smin.i32(i32 %i.agz, i32 %.3139.i) ; 2 uses
...
bb.dc:                                            ; preds = %GetCombinedEntropy.exit.i67.i
  %indvars.iv.next.i71.i = add nuw nsw i64 %indvars.iv.i63.i, 1 ; 2 uses
  %exitcond.not.i72.i = icmp eq i64 %indvars.iv.next.i71.i, 5
  br i1 %exitcond.not.i72.i, label %GetCombinedHistogramEntropy.exit91.i, label %bb.dd, !llvm.loop !71

bb.dd:                                            ; preds = %bb.dc, %bb.db
  %i.aki = phi i64 [ 0, %bb.db ], [ %i.ang, %bb.dc ]
  %indvars.iv.i63.i = phi i64 [ 0, %bb.db ], [ %indvars.iv.next.i71.i, %bb.dc ] ; 9 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %15) #10
  call void @llvm.lifetime.start.p0(ptr nonnull %16) #10
  %i.akj = getelementptr inbounds nuw i8, ptr %i.ajt, i64 %indvars.iv.i63.i
  %i.akk = load i8, ptr %i.akj, align 1, !tbaa !15
  %i.akl = getelementptr inbounds nuw i8, ptr %i.aju, i64 %indvars.iv.i63.i
  %i.akm = load i8, ptr %i.akl, align 1, !tbaa !15
  %i.akn = getelementptr inbounds nuw [2 x i8], ptr %i.ajv, i64 %indvars.iv.i63.i
