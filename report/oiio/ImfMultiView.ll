begin_hunk_0
  %65 = getelementptr i8, ptr %64, i64 -64        ; 2 uses
  %.val = load ptr, ptr %65, align 8
  %66 = getelementptr i8, ptr %64, i64 -56
  %.val13 = load i64, ptr %66, align 8
  %.val13.fr = freeze i64 %.val13                 ; 7 uses
  %.val14 = load ptr, ptr %2, align 8             ; 4 uses
  %67 = getelementptr inbounds nuw i8, ptr %2, i64 8
  %.val15 = load ptr, ptr %67, align 8            ; 2 uses
end_hunk_0
begin_hunk_1
  %69 = ptrtoint ptr %.val14 to i64
  %70 = sub i64 %68, %69
  %71 = ashr exact i64 %70, 5                     ; 2 uses
...
end_hunk_1
begin_hunk_2
  %78 = getelementptr inbounds nuw [32 x i8], ptr %.val14, i64 %.089.i ; 2 uses
...
begin_hunk_3
  ...
  %92 = load ptr, ptr %65, align 8, !tbaa !15     ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #19
  store i64 %.val13.fr, ptr %4, align 8, !tbaa !19
...
._crit_edge.i.i25:                                ; preds = %.noexc27, %90
  %96 = phi ptr [ %94, %.noexc27 ], [ %91, %90 ]  ; 2 uses
...
begin_hunk_6
  ...
  %.val45.fr = freeze i64 %.val45                 ; 3 uses
  %.val46 = load ptr, ptr %2, align 8             ; 4 uses
  %90 = getelementptr inbounds nuw i8, ptr %2, i64 8
  %.val47 = load ptr, ptr %90, align 8            ; 2 uses
end_hunk_6
begin_hunk_7
  %92 = ptrtoint ptr %.val46 to i64
  %93 = sub i64 %91, %92
  %94 = ashr exact i64 %93, 5                     ; 2 uses
...
end_hunk_7
begin_hunk_8
  %101 = getelementptr inbounds nuw [32 x i8], ptr %.val46, i64 %.089.i ; 2 uses
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.i: ; preds = %.lr.ph.i
  %105 = load ptr, ptr %101, align 8, !tbaa !15
...
begin_hunk_9
  ...
  %.val49.fr = freeze i64 %.val49                 ; 3 uses
  %.val50 = load ptr, ptr %2, align 8             ; 4 uses
  %116 = getelementptr inbounds nuw i8, ptr %2, i64 8
  %.val51 = load ptr, ptr %116, align 8           ; 2 uses
end_hunk_9
begin_hunk_10
  %118 = ptrtoint ptr %.val50 to i64
  %119 = sub i64 %117, %118
  %120 = ashr exact i64 %119, 5                   ; 2 uses
...
end_hunk_10
begin_hunk_11
  %127 = getelementptr inbounds nuw [32 x i8], ptr %.val50, i64 %.089.i67 ; 2 uses
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EESA_.exit.i70: ; preds = %.lr.ph.i66
  %131 = load ptr, ptr %127, align 8, !tbaa !15
