...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.e
  ...
  %i.fx = icmp samesign ult <4 x i32> %i.ft, <i32 14234, i32 -8708, i32 17685, i32 14234>
...
bb.d:                                             ; preds = %.lr.ph
  ...
  %i.is = icmp samesign ult <4 x i32> %i.io, <i32 14234, i32 -8708, i32 17685, i32 14234>
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.e
  ...
  %i.fv = icmp ult <4 x i32> %i.fu, splat (i32 16384)
  %i.fw = lshr <4 x i32> %i.fu, splat (i32 6)
  %i.fx = icmp samesign ult <4 x i32> %i.ft, <i32 17685, i32 -8708, i32 14234, i32 17685>
...
bb.d:                                             ; preds = %.lr.ph
  ...
  %i.iq = icmp ult <4 x i32> %i.ip, splat (i32 16384)
  %i.ir = lshr <4 x i32> %i.ip, splat (i32 6)
  %i.is = icmp samesign ult <4 x i32> %i.io, <i32 17685, i32 -8708, i32 14234, i32 17685>
