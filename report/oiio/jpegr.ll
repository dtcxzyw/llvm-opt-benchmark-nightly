...
; Function Attrs: mustprogress uwtable
define void @_ZN8ultrahdr5JpegR11encodeJPEGREP14uhdr_raw_imageP21uhdr_compressed_imageiP14uhdr_mem_block(ptr dead_on_unwind noalias writable sret(%struct.uhdr_error_info) align 4 %0, ptr noundef nonnull align 8 dereferenceable(40) %1, ptr noundef %2, ptr noundef %3, i32 noundef %4, ptr nofree noundef readonly captures(address) %5) local_unnamed_addr #3 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  store i32 1, ptr %i.c, align 4, !tbaa !82
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.e = tail call i32 (ptr, i64, ptr, ...) @snprintf(ptr noundef nonnull dereferenceable(1) %i.d, i64 noundef 256, ptr noundef nonnull @.str.3, i32 noundef %i.a) #28 ; 0 uses
  br label %bb.bb
...
common.resume:                                    ; preds = %bb.ba, %bb.c
  %common.resume.op = phi { ptr, i32 } [ %i.l, %bb.c ], [ %.pn31.pn.pn.pn.pn.pn.pn.pn, %bb.ba ]
  resume { ptr, i32 } %common.resume.op

bb.c:                                             ; preds = %switch.lookup
  %i.l = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvm(ptr noundef nonnull %i.i, i64 noundef 72) #30, !noalias !83
  br label %common.resume

_ZSt11make_uniqueIN8ultrahdr18uhdr_raw_image_extEJR12uhdr_img_fmt16uhdr_color_gamut19uhdr_color_transfer16uhdr_color_rangeRjS7_iEENSt8__detail9_MakeUniqIT_E15__single_objectEDpOT0_.exit: ; preds = %switch.lookup
  store ptr %i.i, ptr %6, align 8, !tbaa !86, !alias.scope !83
  invoke void @_ZN8ultrahdr5JpegR7toneMapEP14uhdr_raw_imageS2_(ptr dead_on_unwind writable sret(%struct.uhdr_error_info) align 4 %0, ptr nonnull align 8 poison, ptr noundef nonnull %2, ptr noundef nonnull %i.i)
          to label %bb.d unwind label %bb.e

bb.d:                                             ; preds = %_ZSt11make_uniqueIN8ultrahdr18uhdr_raw_image_extEJR12uhdr_img_fmt16uhdr_color_gamut19uhdr_color_transfer16uhdr_color_rangeRjS7_iEENSt8__detail9_MakeUniqIT_E15__single_objectEDpOT0_.exit
  %i.m = load i32, ptr %0, align 4, !tbaa !79
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.d
  ...
  store ptr %i.p, ptr %8, align 8, !tbaa !88
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(3) %i.p, ptr noundef nonnull align 1 dereferenceable(3) @.str.4, i64 3, i1 false)
  %i.q = getelementptr inbounds nuw i8, ptr %8, i64 8
  store i64 3, ptr %i.q, align 8, !tbaa !91
  %i.r = getelementptr inbounds nuw i8, ptr %8, i64 19
  store i8 0, ptr %i.r, align 1, !tbaa !93
  %i.s = getelementptr inbounds nuw i8, ptr %7, i64 72 ; 3 uses
  %i.t = getelementptr inbounds nuw i8, ptr %7, i64 88 ; 6 uses
  store ptr %i.t, ptr %i.s, align 8, !tbaa !88
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(3) %i.t, ptr noundef nonnull align 1 dereferenceable(3) @.str.4, i64 3, i1 false)
  %i.u = getelementptr inbounds nuw i8, ptr %7, i64 80
  store i64 3, ptr %i.u, align 8, !tbaa !91
  %i.v = getelementptr inbounds nuw i8, ptr %7, i64 91
  store i8 0, ptr %i.v, align 1, !tbaa !93
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #28
  store ptr null, ptr %9, align 8, !tbaa !94
  invoke void @_ZN8ultrahdr5JpegR15generateGainMapEP14uhdr_raw_imageS2_PNS_25uhdr_gainmap_metadata_extERSt10unique_ptrINS_18uhdr_raw_image_extESt14default_deleteIS6_EEbb(ptr dead_on_unwind nonnull writable sret(%struct.uhdr_error_info) align 4 %0, ptr noundef nonnull align 8 dereferenceable(40) %1, ptr noundef nonnull %i.i, ptr noundef nonnull %2, ptr noundef nonnull %7, ptr noundef nonnull align 8 dereferenceable(8) %9, i1 noundef zeroext false, i1 noundef zeroext false)
          to label %bb.f unwind label %bb.g

bb.f:                                             ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %i.w = load i32, ptr %0, align 4, !tbaa !79
  %.not28 = icmp eq i32 %i.w, 0
  br i1 %.not28, label %bb.h, label %bb.av
...
bb.h:                                             ; preds = %bb.f
  ...
  %i.y = getelementptr inbounds nuw i8, ptr %10, i64 40 ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %i.y, i8 0, i64 48, i1 false)
  %i.z = load ptr, ptr %9, align 8, !tbaa !86
  invoke void @_ZN8ultrahdr5JpegR15compressGainMapEP14uhdr_raw_imagePNS_17JpegEncoderHelperE(ptr dead_on_unwind nonnull writable sret(%struct.uhdr_error_info) align 4 %0, ptr noundef nonnull align 8 dereferenceable(40) %1, ptr noundef %i.z, ptr noundef nonnull %10)
          to label %bb.i unwind label %bb.j

bb.i:                                             ; preds = %bb.h
  %i.aa = load i32, ptr %0, align 4, !tbaa !79
  %.not29 = icmp eq i32 %i.aa, 0
  br i1 %.not29, label %bb.k, label %bb.as
...
bb.l:                                             ; preds = %bb.k
  ...
  %i.ac = getelementptr inbounds nuw i8, ptr %i.i, i64 4
  %i.ad = load i32, ptr %i.ac, align 4, !tbaa !96
  invoke void @_ZN8ultrahdr9IccHelper15writeIccProfileE19uhdr_color_transfer16uhdr_color_gamut(ptr dead_on_unwind nonnull writable sret(%"class.std::shared_ptr") align 8 %12, i32 noundef 3, i32 noundef %i.ad)
          to label %bb.m unwind label %bb.q

bb.m:                                             ; preds = %bb.l
  call void @llvm.lifetime.start.p0(ptr nonnull %13) #28
  store ptr null, ptr %13, align 8, !tbaa !94
  %i.ae = load i32, ptr %i.i, align 8, !tbaa !73
  %i.af = invoke noundef zeroext i1 @_ZN8ultrahdr16isPixelFormatRgbE12uhdr_img_fmt(i32 noundef %i.ae)
...
bb.o:                                             ; preds = %bb.n
  ...
  invoke void @_ZN8ultrahdr26convert_raw_input_to_ycbcrEP14uhdr_raw_imageb(ptr dead_on_unwind nonnull writable sret(%"class.std::unique_ptr") align 8 %14, ptr noundef nonnull %i.i, i1 noundef zeroext false)
          to label %_ZNSt10unique_ptrIN8ultrahdr18uhdr_raw_image_extESt14default_deleteIS1_EED2Ev.exit unwind label %bb.s

_ZNSt10unique_ptrIN8ultrahdr18uhdr_raw_image_extESt14default_deleteIS1_EED2Ev.exit: ; preds = %bb.o
  %i.ag = load ptr, ptr %14, align 8, !tbaa !86   ; 3 uses
  store ptr %i.ag, ptr %13, align 8, !tbaa !86
...
bb.t:                                             ; preds = %_ZNSt10unique_ptrIN8ultrahdr18uhdr_raw_image_extESt14default_deleteIS1_EED2Ev.exit, %bb.n
  %i.al = phi ptr [ %i.ag, %_ZNSt10unique_ptrIN8ultrahdr18uhdr_raw_image_extESt14default_deleteIS1_EED2Ev.exit ], [ null, %bb.n ] ; 3 uses
  %.0 = phi ptr [ %i.ag, %_ZNSt10unique_ptrIN8ultrahdr18uhdr_raw_image_extESt14default_deleteIS1_EED2Ev.exit ], [ %i.i, %bb.n ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %15) #28
  %i.am = getelementptr inbounds nuw i8, ptr %15, i64 40 ; 2 uses
  ...
  %i.ao = invoke noundef ptr @_ZN8ultrahdr10DataStruct7getDataEv(ptr noundef nonnull align 8 dereferenceable(24) %i.an)
          to label %bb.u unwind label %bb.x

bb.u:                                             ; preds = %bb.t
  %i.ap = load ptr, ptr %12, align 8, !tbaa !97
  %i.aq = invoke noundef i64 @_ZN8ultrahdr10DataStruct9getLengthEv(ptr noundef nonnull align 8 dereferenceable(24) %i.ap)
          to label %bb.v unwind label %bb.x

bb.v:                                             ; preds = %bb.u
  invoke void @_ZN8ultrahdr17JpegEncoderHelper13compressImageEPK14uhdr_raw_imageiPKvm(ptr dead_on_unwind nonnull writable sret(%struct.uhdr_error_info) align 4 %0, ptr noundef nonnull align 8 dereferenceable(112) %15, ptr noundef %.0, i32 noundef %4, ptr noundef %i.ao, i64 noundef %i.aq)
          to label %bb.w unwind label %bb.x

bb.w:                                             ; preds = %bb.v
  %i.ar = load i32, ptr %0, align 4, !tbaa !79
  %.not30 = icmp eq i32 %i.ar, 0
  br i1 %.not30, label %bb.y, label %bb.ae
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.av = getelementptr inbounds nuw i8, ptr %16, i64 24
  store i32 %i.au, ptr %i.av, align 8, !tbaa !102
...
bb.aa:                                            ; preds = %bb.z
  %i.aw = load i32, ptr %0, align 4, !tbaa !79
  %.not40 = icmp eq i32 %i.aw, 0
  br i1 %.not40, label %bb.ac, label %bb.ad
...
bb.ae:                                            ; preds = %bb.w, %bb.ad
  ...
  %i.ay = load ptr, ptr %.ptr1.i, align 8, !tbaa !104 ; 2 uses
...
end_hunk_0
begin_hunk_1_@_ZN8ultrahdr5JpegR12getJPEGRInfoEPNS_23jpegr_compressed_structEPNS_17jpegr_info_structE:bb.a
  %3 = alloca %struct.uhdr_compressed_image, align 8 ; 4 uses
  %4 = alloca %struct.uhdr_compressed_image, align 8 ; 4 uses
  %5 = alloca %struct.uhdr_compressed_image, align 8 ; 8 uses
  %6 = alloca %struct.uhdr_error_info, align 4    ; 8 uses
  %i.a = icmp eq ptr %1, null
  br i1 %i.a, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.b = load ptr, ptr %1, align 8, !tbaa !448    ; 2 uses
  %i.c = icmp eq ptr %i.b, null
  br i1 %i.c, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.a, %bb.b
  %i.d = load ptr, ptr @stderr, align 8, !tbaa !172
  %i.e = tail call i64 @fwrite(ptr nonnull @.str.66, i64 43, i64 1, ptr %i.d) #34 ; 0 uses
  %i.f = load ptr, ptr @stderr, align 8, !tbaa !172
  %fputc11 = tail call i32 @fputc(i32 10, ptr %i.f) ; 0 uses
  br label %bb.k
...
bb.e:                                             ; preds = %bb.d
  %i.h = load ptr, ptr @stderr, align 8, !tbaa !172
  %i.i = tail call i64 @fwrite(ptr nonnull @.str.67, i64 49, i64 1, ptr %i.h) #34 ; 0 uses
  %i.j = load ptr, ptr @stderr, align 8, !tbaa !172
  %fputc = tail call i32 @fputc(i32 10, ptr %i.j) ; 0 uses
  br label %bb.k

bb.f:                                             ; preds = %bb.d
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #28
  store ptr %i.b, ptr %5, align 8, !tbaa !218
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 8
  %i.l = getelementptr inbounds nuw i8, ptr %5, i64 8
  %i.m = load <2 x i64>, ptr %i.k, align 8, !tbaa !142
  store <2 x i64> %i.m, ptr %i.l, align 8, !tbaa !142
  %i.n = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.o = load i32, ptr %i.n, align 8, !tbaa !456  ; 2 uses
  %i.p = icmp ult i32 %i.o, 3
  %..i = select i1 %i.p, i32 %i.o, i32 -1
  %i.q = getelementptr inbounds nuw i8, ptr %5, i64 24
  store i32 %..i, ptr %i.q, align 8, !tbaa !102
  %i.r = getelementptr inbounds nuw i8, ptr %5, i64 28
  store i32 -1, ptr %i.r, align 4, !tbaa !219
  %i.s = getelementptr inbounds nuw i8, ptr %5, i64 32
  store i32 -1, ptr %i.s, align 8, !tbaa !220
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #28
  tail call void @llvm.experimental.noalias.scope.decl(metadata !460)
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #28, !noalias !460
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #28, !noalias !460
  call void @_ZN8ultrahdr5JpegR29extractPrimaryImageAndGainMapEP21uhdr_compressed_imageS2_S2_(ptr dead_on_unwind nonnull writable sret(%struct.uhdr_error_info) align 4 %6, ptr nonnull readnone align 8 poison, ptr noundef nonnull readonly %5, ptr noundef nonnull %3, ptr noundef nonnull %4)
  %i.t = load i32, ptr %6, align 4, !tbaa !79, !alias.scope !460
  %.not.i = icmp eq i32 %i.t, 0
  br i1 %.not.i, label %bb.g, label %_ZN8ultrahdr5JpegR12getJPEGRInfoEP21uhdr_compressed_imagePNS_17jpegr_info_structE.exit

bb.g:                                             ; preds = %bb.f
  %i.u = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.v = load ptr, ptr %i.u, align 8, !tbaa !306, !noalias !460
  %i.w = getelementptr inbounds nuw i8, ptr %2, i64 4
  call void @_ZN8ultrahdr5JpegR13parseJpegInfoEP21uhdr_compressed_imagePNS_16jpeg_info_structEPjS5_(ptr dead_on_unwind nonnull writable sret(%struct.uhdr_error_info) align 4 %6, ptr nonnull readnone align 8 poison, ptr noundef nonnull %3, ptr noundef %i.v, ptr noundef nonnull %2, ptr noundef nonnull %i.w)
  %i.x = load i32, ptr %6, align 4, !tbaa !79, !alias.scope !460
  %.not7.i = icmp eq i32 %i.x, 0
  br i1 %.not7.i, label %bb.h, label %_ZN8ultrahdr5JpegR12getJPEGRInfoEP21uhdr_compressed_imagePNS_17jpegr_info_structE.exit

bb.h:                                             ; preds = %bb.g
  %i.y = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.z = load ptr, ptr %i.y, align 8, !tbaa !309, !noalias !460 ; 2 uses
  %.not8.i = icmp eq ptr %i.z, null
  br i1 %.not8.i, label %bb.j, label %bb.i

bb.i:                                             ; preds = %bb.h
  call void @_ZN8ultrahdr5JpegR13parseJpegInfoEP21uhdr_compressed_imagePNS_16jpeg_info_structEPjS5_(ptr dead_on_unwind nonnull writable sret(%struct.uhdr_error_info) align 4 %6, ptr nonnull readnone align 8 poison, ptr noundef nonnull %4, ptr noundef nonnull %i.z, ptr noundef null, ptr noundef null)
  %i.aa = load i32, ptr %6, align 4, !tbaa !79, !alias.scope !460
  %.not9.i = icmp eq i32 %i.aa, 0
  br i1 %.not9.i, label %bb.j, label %_ZN8ultrahdr5JpegR12getJPEGRInfoEP21uhdr_compressed_imagePNS_17jpegr_info_structE.exit

bb.j:                                             ; preds = %bb.i, %bb.h
  br label %_ZN8ultrahdr5JpegR12getJPEGRInfoEP21uhdr_compressed_imagePNS_17jpegr_info_structE.exit

_ZN8ultrahdr5JpegR12getJPEGRInfoEP21uhdr_compressed_imagePNS_17jpegr_info_structE.exit: ; preds = %bb.f, %bb.g, %bb.i, %bb.j
  %i.ab = phi i32 [ -1, %bb.f ], [ -1, %bb.g ], [ -1, %bb.i ], [ 0, %bb.j ]
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #28, !noalias !460
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #28, !noalias !460
  call void @llvm.lifetime.end.p0(ptr nonnull %6) #28
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #28
  br label %bb.k

bb.k:                                             ; preds = %_ZN8ultrahdr5JpegR12getJPEGRInfoEP21uhdr_compressed_imagePNS_17jpegr_info_structE.exit, %bb.e, %bb.c
  %.0 = phi i32 [ -10001, %bb.c ], [ -10001, %bb.e ], [ %i.ab, %_ZN8ultrahdr5JpegR12getJPEGRInfoEP21uhdr_compressed_imagePNS_17jpegr_info_structE.exit ]
  ret i32 %.0
}

; Function Attrs: mustprogress uwtable
define noundef range(i32 -20005, 1) i32 @_ZN8ultrahdr5JpegR11decodeJPEGREPNS_23jpegr_compressed_structEPNS_25jpegr_uncompressed_structEfPNS_17jpegr_exif_structENS_22ultrahdr_output_formatES4_PNS_24ultrahdr_metadata_structE(ptr nofree noundef nonnull readnone align 8 captures(none) dereferenceable(40) %0, ptr nofree noundef readonly captures(address_is_null) %1, ptr nofree noundef captures(address_is_null) %2, float noundef %3, ptr nofree noundef captures(address_is_null) %4, i32 noundef %5, ptr nofree noundef captures(address_is_null) %6, ptr noundef %7) local_unnamed_addr #3 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %8 = alloca %struct.uhdr_compressed_image, align 8 ; 5 uses
  %9 = alloca %struct.uhdr_compressed_image, align 8 ; 5 uses
  %10 = alloca %struct.uhdr_compressed_image, align 8 ; 10 uses
  %11 = alloca %"struct.ultrahdr::jpeg_info_struct", align 8 ; 19 uses
  %12 = alloca %"struct.ultrahdr::jpeg_info_struct", align 8 ; 18 uses
  %13 = alloca %"struct.ultrahdr::jpegr_info_struct", align 8 ; 9 uses
  %14 = alloca %struct.uhdr_error_info, align 4   ; 10 uses
  %15 = alloca %struct.uhdr_raw_image, align 16   ; 16 uses
  %16 = alloca %struct.uhdr_raw_image, align 16   ; 7 uses
  %17 = alloca %"struct.ultrahdr::uhdr_gainmap_metadata_ext", align 8 ; 24 uses
  %18 = alloca %struct.uhdr_error_info, align 4   ; 6 uses
  %i.a = icmp eq ptr %1, null
  br i1 %i.a, label %bb.c, label %bb.b
...
bb.c:                                             ; preds = %bb.a, %bb.b
  ...
  %i.e = tail call i64 @fwrite(ptr nonnull @.str.66, i64 43, i64 1, ptr %i.d) #34 ; 0 uses
  %i.f = load ptr, ptr @stderr, align 8, !tbaa !172
  %fputc86 = tail call i32 @fputc(i32 10, ptr %i.f) ; 0 uses
  br label %bb.az
...
bb.f:                                             ; preds = %bb.d, %bb.e
  %i.j = load ptr, ptr @stderr, align 8, !tbaa !172
  %i.k = tail call i64 @fwrite(ptr nonnull @.str.68, i64 31, i64 1, ptr %i.j) #34 ; 0 uses
  %i.l = load ptr, ptr @stderr, align 8, !tbaa !172
  %fputc85 = tail call i32 @fputc(i32 10, ptr %i.l) ; 0 uses
  br label %bb.az

bb.g:                                             ; preds = %bb.e
  %i.m = fcmp contract olt float %3, 1.000000e+00
  br i1 %i.m, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %i.n = load ptr, ptr @stderr, align 8, !tbaa !172
  %i.o = fpext contract float %3 to double
  %i.p = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.n, ptr noundef nonnull @.str.69, double noundef %i.o) #33 ; 0 uses
  %i.q = load ptr, ptr @stderr, align 8, !tbaa !172
  %fputc84 = tail call i32 @fputc(i32 10, ptr %i.q) ; 0 uses
  br label %bb.az
...
bb.j:                                             ; preds = %bb.i
  %i.r = load ptr, ptr %4, align 8, !tbaa !450
  %i.s = icmp eq ptr %i.r, null
  br i1 %i.s, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  %i.t = load ptr, ptr @stderr, align 8, !tbaa !172
  %i.u = tail call i64 @fwrite(ptr nonnull @.str.70, i64 38, i64 1, ptr %i.t) #34 ; 0 uses
  %i.v = load ptr, ptr @stderr, align 8, !tbaa !172
  %fputc83 = tail call i32 @fputc(i32 10, ptr %i.v) ; 0 uses
  br label %bb.az

bb.l:                                             ; preds = %bb.j, %bb.i
  %.not77 = icmp eq ptr %6, null                  ; 3 uses
  br i1 %.not77, label %bb.o, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.w = load ptr, ptr %6, align 8, !tbaa !439
  %i.x = icmp eq ptr %i.w, null
  br i1 %i.x, label %bb.n, label %bb.o

bb.n:                                             ; preds = %bb.m
  %i.y = load ptr, ptr @stderr, align 8, !tbaa !172
  %i.z = tail call i64 @fwrite(ptr nonnull @.str.71, i64 41, i64 1, ptr %i.y) #34 ; 0 uses
  %i.aa = load ptr, ptr @stderr, align 8, !tbaa !172
  %fputc82 = tail call i32 @fputc(i32 10, ptr %i.aa) ; 0 uses
  br label %bb.az

bb.o:                                             ; preds = %bb.m, %bb.l
  %or.cond = icmp ugt i32 %5, 3
  br i1 %or.cond, label %bb.p, label %bb.q

bb.p:                                             ; preds = %bb.o
  %i.ab = load ptr, ptr @stderr, align 8, !tbaa !172
  %i.ac = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.ab, ptr noundef nonnull @.str.72, i32 noundef %5) #33 ; 0 uses
  %i.ad = load ptr, ptr @stderr, align 8, !tbaa !172
  %fputc = tail call i32 @fputc(i32 10, ptr %i.ad) ; 0 uses
  br label %bb.az

bb.q:                                             ; preds = %bb.o
  %switch.tableidx = add nsw i32 %5, -1           ; 3 uses
  %i.ae = icmp ult i32 %switch.tableidx, 3
  br i1 %i.ae, label %switch.lookup, label %bb.r
...
bb.r:                                             ; preds = %bb.q, %switch.lookup
  ...
  %i.aj = load <2 x i64>, ptr %i.ah, align 8, !tbaa !142
  store <2 x i64> %i.aj, ptr %i.ai, align 8, !tbaa !142
  %i.ak = getelementptr inbounds nuw i8, ptr %1, i64 24
  %i.al = load i32, ptr %i.ak, align 8, !tbaa !456 ; 2 uses
  %i.am = icmp ult i32 %i.al, 3
  %..i = select i1 %i.am, i32 %i.al, i32 -1
  %i.an = getelementptr inbounds nuw i8, ptr %10, i64 24
  store i32 %..i, ptr %i.an, align 8, !tbaa !102
  %i.ao = getelementptr inbounds nuw i8, ptr %10, i64 28
  store i32 -1, ptr %i.ao, align 4, !tbaa !219
  %i.ap = getelementptr inbounds nuw i8, ptr %10, i64 32
  store i32 -1, ptr %i.ap, align 8, !tbaa !220
  call void @llvm.lifetime.start.p0(ptr nonnull %11) #28
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(132) %11, i8 0, i64 120, i1 false)
  call void @llvm.lifetime.start.p0(ptr nonnull %12) #28
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(132) %12, i8 0, i64 120, i1 false)
  call void @llvm.lifetime.start.p0(ptr nonnull %13) #28
  %i.aq = getelementptr inbounds nuw i8, ptr %13, i64 8
  store ptr %11, ptr %i.aq, align 8, !tbaa !306
  %i.ar = getelementptr inbounds nuw i8, ptr %13, i64 16 ; 2 uses
  store ptr %12, ptr %i.ar, align 8, !tbaa !309
  call void @llvm.lifetime.start.p0(ptr nonnull %14) #28
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #28, !noalias !463
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #28, !noalias !463
  invoke void @_ZN8ultrahdr5JpegR29extractPrimaryImageAndGainMapEP21uhdr_compressed_imageS2_S2_(ptr dead_on_unwind nonnull writable sret(%struct.uhdr_error_info) align 4 %14, ptr nonnull readnone align 8 poison, ptr noundef nonnull readonly %10, ptr noundef nonnull %8, ptr noundef nonnull %9)
          to label %.noexc unwind label %bb.v

.noexc:                                           ; preds = %bb.r
  %i.as = load i32, ptr %14, align 4, !tbaa !79
  %.not.i = icmp eq i32 %i.as, 0
  br i1 %.not.i, label %bb.s, label %.thread

bb.s:                                             ; preds = %.noexc
  %i.at = getelementptr inbounds nuw i8, ptr %13, i64 4
  invoke void @_ZN8ultrahdr5JpegR13parseJpegInfoEP21uhdr_compressed_imagePNS_16jpeg_info_structEPjS5_(ptr dead_on_unwind nonnull writable sret(%struct.uhdr_error_info) align 4 %14, ptr nonnull readnone align 8 poison, ptr noundef nonnull %8, ptr noundef nonnull %11, ptr noundef nonnull %13, ptr noundef nonnull %i.at)
          to label %.noexc87 unwind label %bb.v

.noexc87:                                         ; preds = %bb.s
  %i.au = load i32, ptr %14, align 4, !tbaa !79
  %.not7.i = icmp eq i32 %i.au, 0
  br i1 %.not7.i, label %bb.t, label %.thread

bb.t:                                             ; preds = %.noexc87
  %i.av = load ptr, ptr %i.ar, align 8, !tbaa !309, !noalias !463 ; 2 uses
  %.not8.i = icmp eq ptr %i.av, null
  br i1 %.not8.i, label %bb.w, label %bb.u

bb.u:                                             ; preds = %bb.t
  invoke void @_ZN8ultrahdr5JpegR13parseJpegInfoEP21uhdr_compressed_imagePNS_16jpeg_info_structEPjS5_(ptr dead_on_unwind nonnull writable sret(%struct.uhdr_error_info) align 4 %14, ptr nonnull readnone align 8 poison, ptr noundef nonnull %9, ptr noundef nonnull %i.av, ptr noundef null, ptr noundef null)
          to label %.noexc88 unwind label %bb.v

.noexc88:                                         ; preds = %bb.u
  %i.aw = load i32, ptr %14, align 4, !tbaa !79
  %.not9.i = icmp eq i32 %i.aw, 0
  br i1 %.not9.i, label %bb.w, label %.thread

.thread:                                          ; preds = %.noexc88, %.noexc87, %.noexc
  call void @llvm.lifetime.end.p0(ptr nonnull %9) #28, !noalias !463
  call void @llvm.lifetime.end.p0(ptr nonnull %8) #28, !noalias !463
  call void @llvm.lifetime.end.p0(ptr nonnull %14) #28
  br label %bb.an
...
bb.x:                                             ; preds = %bb.w
  ...
  %i.az = load i64, ptr %i.ay, align 8, !tbaa !454
  %i.ba = getelementptr inbounds nuw i8, ptr %11, i64 48 ; 2 uses
  %i.bb = getelementptr inbounds nuw i8, ptr %11, i64 56 ; 2 uses
  %i.bc = load ptr, ptr %i.bb, align 8, !tbaa !216
  %i.bd = load ptr, ptr %i.ba, align 8, !tbaa !105 ; 2 uses
  %i.be = ptrtoint ptr %i.bc to i64
  %i.bf = ptrtoint ptr %i.bd to i64
  %i.bg = sub i64 %i.be, %i.bf                    ; 2 uses
  %i.bh = icmp ult i64 %i.az, %i.bg
  br i1 %i.bh, label %bb.an, label %bb.y

bb.y:                                             ; preds = %bb.x
  %i.bi = load ptr, ptr %4, align 8, !tbaa !450
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.bi, ptr align 1 %i.bd, i64 %i.bg, i1 false)
  %i.bj = load ptr, ptr %i.bb, align 8, !tbaa !216
  %i.bk = load ptr, ptr %i.ba, align 8, !tbaa !105
  %i.bl = ptrtoint ptr %i.bj to i64
  %i.bm = ptrtoint ptr %i.bk to i64
  %i.bn = sub i64 %i.bl, %i.bm
  store i64 %i.bn, ptr %i.ay, align 8, !tbaa !454
  br label %bb.z

bb.z:                                             ; preds = %bb.y, %bb.w
  call void @llvm.lifetime.start.p0(ptr nonnull %15) #28
  store i32 %.062, ptr %15, align 16, !tbaa !73
  %i.bo = getelementptr inbounds nuw i8, ptr %15, i64 4 ; 3 uses
  store i32 -1, ptr %i.bo, align 4, !tbaa !96
  %i.bp = getelementptr inbounds nuw i8, ptr %15, i64 8 ; 2 uses
  store i32 -1, ptr %i.bp, align 8, !tbaa !119
  %i.bq = getelementptr inbounds nuw i8, ptr %15, i64 12 ; 2 uses
  store i32 -1, ptr %i.bq, align 4, !tbaa !120
  %i.br = getelementptr inbounds nuw i8, ptr %15, i64 16 ; 3 uses
  %i.bs = load <2 x i32>, ptr %13, align 8, !tbaa !3
  %i.bt = load i32, ptr %13, align 8, !tbaa !466
  store <2 x i32> %i.bs, ptr %i.br, align 16, !tbaa !3
  %i.bu = load ptr, ptr %2, align 8, !tbaa !439
  %i.bv = getelementptr inbounds nuw i8, ptr %15, i64 24 ; 2 uses
  store ptr %i.bu, ptr %i.bv, align 8, !tbaa !58
  %i.bw = getelementptr inbounds nuw i8, ptr %15, i64 48 ; 2 uses
  store i32 %i.bt, ptr %i.bw, align 16, !tbaa !3
  %i.bx = getelementptr inbounds nuw i8, ptr %15, i64 32 ; 2 uses
  %i.by = getelementptr inbounds nuw i8, ptr %15, i64 52 ; 2 uses
  store i32 0, ptr %i.by, align 4, !tbaa !3
  %i.bz = getelementptr inbounds nuw i8, ptr %15, i64 56 ; 2 uses
  store i32 0, ptr %i.bz, align 8, !tbaa !3
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %i.bx, i8 0, i64 16, i1 false)
  call void @llvm.lifetime.start.p0(ptr nonnull %16) #28
  br i1 %.not77, label %bb.ab, label %bb.aa

bb.aa:                                            ; preds = %bb.z
  %i.ca = getelementptr inbounds nuw i8, ptr %12, i64 128
  %i.cb = load i32, ptr %i.ca, align 8, !tbaa !391
  %i.cc = icmp eq i32 %i.cb, 1
  %i.cd = select i1 %i.cc, i32 2, i32 11
  store i32 %i.cd, ptr %15, align 16, !tbaa !73
  store i32 -1, ptr %i.bo, align 4, !tbaa !96
  store i32 -1, ptr %i.bp, align 8, !tbaa !119
  store i32 -1, ptr %i.bq, align 4, !tbaa !120
  %i.ce = getelementptr inbounds nuw i8, ptr %12, i64 120 ; 2 uses
  %i.cf = load <2 x i32>, ptr %i.ce, align 8, !tbaa !3
  %i.cg = load i32, ptr %i.ce, align 8, !tbaa !388
  store <2 x i32> %i.cf, ptr %i.br, align 16, !tbaa !3
  %i.ch = load ptr, ptr %6, align 8, !tbaa !439
  store ptr %i.ch, ptr %i.bv, align 8, !tbaa !58
  store i32 %i.cg, ptr %i.bw, align 16, !tbaa !3
  store i32 0, ptr %i.by, align 4, !tbaa !3
  store i32 0, ptr %i.bz, align 8, !tbaa !3
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %i.bx, i8 0, i64 16, i1 false)
  br label %bb.ab
...
bb.ab:                                            ; preds = %bb.aa, %bb.z
  %i.ci = phi ptr [ %16, %bb.aa ], [ null, %bb.z ]
  call void @llvm.lifetime.start.p0(ptr nonnull %17) #28
  %i.cj = getelementptr inbounds nuw i8, ptr %17, i64 72 ; 4 uses
  %i.ck = getelementptr inbounds nuw i8, ptr %17, i64 88 ; 6 uses
  store ptr %i.ck, ptr %i.cj, align 8, !tbaa !88
  %i.cl = getelementptr inbounds nuw i8, ptr %17, i64 80
  store i64 0, ptr %i.cl, align 8, !tbaa !91
  store i8 0, ptr %i.ck, align 8, !tbaa !93
  call void @llvm.lifetime.start.p0(ptr nonnull %18) #28
  %.not79 = icmp eq ptr %7, null                  ; 2 uses
  %i.cm = select i1 %.not79, ptr null, ptr %17
  invoke void @_ZN8ultrahdr5JpegR11decodeJPEGREP21uhdr_compressed_imageP14uhdr_raw_imagef19uhdr_color_transfer12uhdr_img_fmtS4_P21uhdr_gainmap_metadata(ptr dead_on_unwind nonnull writable sret(%struct.uhdr_error_info) align 4 %18, ptr noundef nonnull align 8 dereferenceable(40) %0, ptr noundef nonnull %10, ptr noundef nonnull %15, float noundef %3, i32 noundef %.063, i32 noundef %.062, ptr noundef %i.ci, ptr noundef %i.cm)
          to label %bb.ac unwind label %bb.af

bb.ac:                                            ; preds = %bb.ab
  %i.cn = load i32, ptr %18, align 4, !tbaa !79
  %i.co = icmp eq i32 %i.cn, 0
  br i1 %i.co, label %bb.ad, label %_ZNK8ultrahdr25uhdr_gainmap_metadata_ext26are_all_channels_identicalEv.exit.thread

bb.ad:                                            ; preds = %bb.ac
  %i.cp = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.cq = load <2 x i32>, ptr %i.br, align 16, !tbaa !3
  store <2 x i32> %i.cq, ptr %i.cp, align 8, !tbaa !3
  %i.cr = load i32, ptr %i.bo, align 4, !tbaa !96 ; 2 uses
  %i.cs = icmp ult i32 %i.cr, 3
  %..i89 = select i1 %i.cs, i32 %i.cr, i32 -1
  %i.ct = getelementptr inbounds nuw i8, ptr %2, i64 16
  store i32 %..i89, ptr %i.ct, align 8, !tbaa !444
  %i.cu = getelementptr inbounds nuw i8, ptr %2, i64 40
  %i.cv = load <4 x i32>, ptr %15, align 16, !tbaa !93
  %i.cw = shufflevector <4 x i32> %i.cv, <4 x i32> poison, <2 x i32> <i32 0, i32 3>
  store <2 x i32> %i.cw, ptr %i.cu, align 8, !tbaa !93
  %i.cx = getelementptr inbounds nuw i8, ptr %2, i64 24
  store ptr null, ptr %i.cx, align 8, !tbaa !446
  br i1 %.not77, label %bb.ag, label %bb.ae

bb.ae:                                            ; preds = %bb.ad
  %i.cy = getelementptr inbounds nuw i8, ptr %16, i64 16
  %i.cz = getelementptr inbounds nuw i8, ptr %6, i64 8
  %i.da = load <2 x i32>, ptr %i.cy, align 16, !tbaa !3
  store <2 x i32> %i.da, ptr %i.cz, align 8, !tbaa !3
  %i.db = getelementptr inbounds nuw i8, ptr %16, i64 4
  %i.dc = load i32, ptr %i.db, align 4, !tbaa !96 ; 2 uses
  %i.dd = icmp ult i32 %i.dc, 3
  %..i90 = select i1 %i.dd, i32 %i.dc, i32 -1
  %i.de = getelementptr inbounds nuw i8, ptr %6, i64 16
  store i32 %..i90, ptr %i.de, align 8, !tbaa !444
  %i.df = getelementptr inbounds nuw i8, ptr %6, i64 40
  %i.dg = load <4 x i32>, ptr %16, align 16, !tbaa !93
end_hunk_1
