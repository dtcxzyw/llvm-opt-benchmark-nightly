...
begin_hunk_1_@"_ZNSt17_Function_handlerIFvvEZN8ultrahdr5JpegR7toneMapEP14uhdr_raw_imageS4_E3$_0E9_M_invokeERKSt9_Any_data":bb.a
  ...
  %.sroa.25.0..sroa_idx.i.i.i = getelementptr inbounds nuw i8, ptr %2, i64 4
...
bb.h:                                             ; preds = %_ZN8ultrahdr13globalTonemapERKSt5arrayIfLm3EEfb.exit.i.i.i
  ...
  %.fca.0.extract2.i.i.i = extractvalue { <2 x float>, float } %i.dq, 0 ; 2 uses
  ...
  store <2 x float> %9, ptr %.sroa.25.0..sroa_idx.i.i.i, align 4, !tbaa !93
...
bb.j:                                             ; preds = %bb.h
  %i.du = fmul contract float %6, 2.550000e+02
...
bb.m:                                             ; preds = %bb.c
  ...
  %i.ea = fdiv contract float %13, %i.aq
  %14 = extractelement <2 x float> %12, i64 1
  %i.eb = fdiv contract float %14, %i.aq
