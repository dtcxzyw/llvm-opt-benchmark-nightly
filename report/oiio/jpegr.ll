...
bb.h:                                             ; preds = %_ZN8ultrahdr13globalTonemapERKSt5arrayIfLm3EEfb.exit.i.i.i
  ...
  %.fca.0.extract2.i.i.i = extractvalue { <2 x float>, float } %i.dr, 0
  ...
  store float %4, ptr %i.ao, align 8, !tbaa !93
...
bb.j:                                             ; preds = %bb.h
  ...
  %i.dv = fmul contract float %5, 2.550000e+02
...
bb.m:                                             ; preds = %bb.c
  %i.eb = fdiv contract float %.3.i.i.i, %i.ar
  %i.ec = fdiv contract float %.3147.i.i.i, %i.ar
