...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %23 = getelementptr i8, ptr %20, i64 %n.vec
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load42 = load <16 x i8>, ptr %24, align 1, !tbaa !35, !noalias !284 ; 3 uses
  %25 = add <16 x i8> %wide.load, splat (i8 -65)
  %26 = add <16 x i8> %wide.load42, splat (i8 -65)
  %27 = icmp ult <16 x i8> %25, splat (i8 26)
  %28 = icmp ult <16 x i8> %26, splat (i8 26)
  %29 = or disjoint <16 x i8> %wide.load, splat (i8 32)
  %30 = or disjoint <16 x i8> %wide.load42, splat (i8 32)
  %31 = select <16 x i1> %27, <16 x i8> %29, <16 x i8> %wide.load
  %32 = select <16 x i1> %28, <16 x i8> %30, <16 x i8> %wide.load42
  store <16 x i8> %31, ptr %next.gep, align 1, !tbaa !35, !noalias !284
  store <16 x i8> %32, ptr %24, align 1, !tbaa !35, !noalias !284
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %33 = icmp eq i64 %index.next, %n.vec
  br i1 %33, label %middle.block, label %vector.body, !llvm.loop !287
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %34 = getelementptr i8, ptr %20, i64 %n.vec44
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %35 = add <8 x i8> %wide.load47, splat (i8 -65)
  %36 = icmp ult <8 x i8> %35, splat (i8 26)
  %37 = or disjoint <8 x i8> %wide.load47, splat (i8 32)
  %38 = select <8 x i1> %36, <8 x i8> %37, <8 x i8> %wide.load47
  store <8 x i8> %38, ptr %next.gep46, align 1, !tbaa !35, !noalias !284
  %index.next48 = add nuw i64 %index45, 8         ; 2 uses
  %39 = icmp eq i64 %index.next48, %n.vec44
  br i1 %39, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !291
...
.lr.ph.i.i.preheader:                             ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.sroa.0.08.i.i.ph = phi ptr [ %20, %iter.check ], [ %23, %vec.epilog.iter.check ], [ %34, %vec.epilog.middle.block ]
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  %.sroa.0.08.i.i = phi ptr [ %43, %.lr.ph.i.i ], [ %.sroa.0.08.i.i.ph, %.lr.ph.i.i.preheader ] ; 3 uses
  %40 = load i8, ptr %.sroa.0.08.i.i, align 1, !tbaa !35, !noalias !284 ; 3 uses
  %41 = add i8 %40, -65
...
_ZSt9transformIN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEES9_ZN11StringUtils5LowerES8_EUlhE_ET0_T_SD_SC_T1_.exit.i: ; preds = %_ZSt9transformIN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEES9_ZN11StringUtils5LowerES8_EUlhE_ET0_T_SD_SC_T1_.exit.loopexit.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit
  %44 = phi ptr [ %.pre.i, %_ZSt9transformIN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEES9_ZN11StringUtils5LowerES8_EUlhE_ET0_T_SD_SC_T1_.exit.loopexit.i ], [ %20, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2ERKS4_.exit ] ; 3 uses
  %45 = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 6 uses
  store ptr %45, ptr %3, align 8, !tbaa !43, !alias.scope !284
  %46 = icmp eq ptr %44, %5
  br i1 %46, label %47, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i

47:                                               ; preds = %_ZSt9transformIN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEES9_ZN11StringUtils5LowerES8_EUlhE_ET0_T_SD_SC_T1_.exit.i
  %48 = load i64, ptr %17, align 8, !tbaa !46, !noalias !284 ; 3 uses
  %49 = icmp ult i64 %48, 16
  call void @llvm.assume(i1 %49)
  %50 = add nuw nsw i64 %48, 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %45, ptr noundef nonnull align 8 dereferenceable(1) %5, i64 %50, i1 false)
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %_ZSt9transformIN9__gnu_cxx17__normal_iteratorIPcNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEES9_ZN11StringUtils5LowerES8_EUlhE_ET0_T_SD_SC_T1_.exit.i
  store ptr %44, ptr %3, align 8, !tbaa !45, !alias.scope !284
  %51 = load i64, ptr %5, align 8, !tbaa !35, !noalias !284
  store i64 %51, ptr %45, align 8, !tbaa !35, !alias.scope !284
  %.pre4.i = load i64, ptr %17, align 8, !tbaa !46, !noalias !284
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %47
  %52 = phi ptr [ %45, %47 ], [ %44, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ] ; 8 uses
  %53 = phi i64 [ %48, %47 ], [ %.pre4.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ] ; 3 uses
  %54 = getelementptr inbounds nuw i8, ptr %3, i64 8
  store i64 %53, ptr %54, align 8, !tbaa !46, !alias.scope !284
  ...
  switch i64 %53, label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread [
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %bcmp.i = call i32 @bcmp(ptr noundef nonnull dereferenceable(2) %52, ptr noundef nonnull dereferenceable(2) @.str.61, i64 2)
  %55 = icmp eq i32 %bcmp.i, 0
  %spec.select37 = zext i1 %55 to i32
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit14: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %bcmp.i13 = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) %52, ptr noundef nonnull dereferenceable(3) @.str.62, i64 3)
  %56 = icmp eq i32 %bcmp.i13, 0
  br i1 %56, label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread, label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit16
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit16: ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit14
  %bcmp.i15 = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) %52, ptr noundef nonnull dereferenceable(3) @.str.63, i64 3)
  %57 = icmp eq i32 %bcmp.i15, 0
  br i1 %57, label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread, label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit18
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit18: ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit16
  %bcmp.i17 = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) %52, ptr noundef nonnull dereferenceable(3) @.str.64, i64 3)
  %58 = icmp eq i32 %bcmp.i17, 0
  br i1 %58, label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread, label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit20
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit20: ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit18
  %bcmp.i19 = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) %52, ptr noundef nonnull dereferenceable(3) @.str.65, i64 3)
  %59 = icmp eq i32 %bcmp.i19, 0
  br i1 %59, label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread, label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit22
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit22: ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit20
  %bcmp.i21 = call i32 @bcmp(ptr noundef nonnull dereferenceable(3) %52, ptr noundef nonnull dereferenceable(3) @.str.66, i64 3)
  %bcmp.i21.fr = freeze i32 %bcmp.i21
  %60 = icmp eq i32 %bcmp.i21.fr, 0
  %spec.select = select i1 %60, i32 8, i32 0
  br label %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i23: ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit.thread
  ...
  %64 = add i64 %63, 1
  call void @_ZdlPvm(ptr noundef %52, i64 noundef %64) #35
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit25
