...
vector.body.interim345:                           ; preds = %vector.body340
  ...
  br i1 %i.bw, label %middle.block346, label %vector.body340, !llvm.loop !176
...
vec.epilog.scalar.ph:                             ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph
  ...
  br i1 %exitcond228.not.3, label %._crit_edge.us, label %vec.epilog.scalar.ph, !llvm.loop !180
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.gf, label %middle.block, label %vector.body, !llvm.loop !181
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.gi, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !182
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  br i1 %prol.iter.cmp.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol, !llvm.loop !183
