...
vector.body.interim345:                           ; preds = %vector.body340
  ...
  br i1 %i.bh, label %middle.block346, label %vector.body340, !llvm.loop !177
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.fq, label %middle.block, label %vector.body, !llvm.loop !182
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.ft, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !183
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  br i1 %prol.iter.cmp.not, label %vec.epilog.scalar.ph.prol.loopexit, label %vec.epilog.scalar.ph.prol, !llvm.loop !184
