...
.lr.ph.us176.us:                                  ; preds = %.lr.ph.us176.us.preheader, %._crit_edge156.us.us.us.us
  ...
  %i.aq = load i32, ptr %i.ap, align 4, !tbaa !112 ; 5 uses
...
vector.body.interim345:                           ; preds = %vector.body340
  ...
  br i1 %i.bh, label %middle.block346, label %vector.body340, !llvm.loop !176
...
.preheader139.us.us.us.us.us:                     ; preds = %.lr.ph155.split.us173.us.us.us
  ...
  br i1 %exitcond254.not, label %._crit_edge156.us.us.us.us.loopexit202, label %.lr.ph155.split.us173.us.us.us, !llvm.loop !177
...
._crit_edge.split.us.split.us.us.us:              ; preds = %._crit_edge156.us.us.us.us, %bb.e
  ...
  store i32 %i.br, ptr %i.u, align 8, !tbaa !116
  %i.bs = load i16, ptr %i.ac, align 4, !tbaa !99 ; 2 uses
  %i.bt = zext i16 %i.bs to i32
  %i.bu = load i32, ptr %i.g, align 4, !tbaa !105
  %i.bv = add i32 %i.bu, %i.bt
  store i32 %i.bv, ptr %i.g, align 4, !tbaa !105
  %i.bw = load i64, ptr %i.t, align 8, !tbaa !107 ; 2 uses
...
.lr.ph.us.prol:                                   ; preds = %.lr.ph.us.preheader, %.lr.ph.us.prol
  ...
  br i1 %prol.iter399.cmp.not, label %.lr.ph.us.prol.loopexit, label %.lr.ph.us.prol, !llvm.loop !178
...
vector.body.interim:                              ; preds = %vector.body319
  ...
  br i1 %i.ev, label %middle.block322, label %vector.body319, !llvm.loop !179
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load299 = load <16 x i8>, ptr %i.fn, align 1, !tbaa !36
  %i.fo = getelementptr inbounds nuw i8, ptr %.1147.us, i64 %index ; 2 uses
  %i.fp = getelementptr inbounds nuw i8, ptr %i.fo, i64 16
  store <16 x i8> %wide.load, ptr %i.fo, align 1, !tbaa !36
  store <16 x i8> %wide.load299, ptr %i.fp, align 1, !tbaa !36
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.fq = icmp eq i64 %index.next, %n.vec
  br i1 %i.fq, label %middle.block, label %vector.body, !llvm.loop !180
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  store <4 x i8> %wide.load303, ptr %i.fs, align 1, !tbaa !36
  %index.next304 = add nuw i64 %index301, 4       ; 2 uses
  %i.ft = icmp eq i64 %index.next304, %n.vec300
  br i1 %i.ft, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !181
...
vec.epilog.scalar.ph.prol:                        ; preds = %vec.epilog.scalar.ph.preheader, %vec.epilog.scalar.ph.prol
  ...
  %i.fv = load i8, ptr %.2143.us.prol, align 1, !tbaa !36
  %i.fw = getelementptr inbounds nuw i8, ptr %.1147.us, i64 %indvars.iv225.prol
  store i8 %i.fv, ptr %i.fw, align 1, !tbaa !36
...
.preheader139:                                    ; preds = %.lr.ph155.split.split.split
  ...
  br i1 %exitcond.not, label %._crit_edge156.loopexit213, label %.lr.ph155.split.split.split, !llvm.loop !184
...
bb.a:
  ...
  store ptr @TIFFjpeg_progress_monitor, ptr %i.a, align 8, !tbaa !186
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i32, ptr %i.c, align 4, !tbaa !188  ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  %i.k = load ptr, ptr %0, align 8, !tbaa !201    ; 2 uses
...
.lr.ph121.us.us.us.preheader:                     ; preds = %.loopexit.us.us.us
  %i.by = load ptr, ptr %i.be, align 8, !tbaa !126
  %i.bz = load i32, ptr %i.ao, align 8, !tbaa !116
...
._crit_edge126.us.us:                             ; preds = %._crit_edge.us136.us.us.us, %._crit_edge.us129.us.us, %.lr.ph125.split.us145.us, %.lr.ph.us158
  ...
  %i.cq = load i32, ptr %i.am, align 4, !tbaa !36
...
._crit_edge144.split.us.us:                       ; preds = %._crit_edge126.us.us, %.lr.ph157.split.us
  %i.ct = load i32, ptr %i.ao, align 8, !tbaa !116 ; 2 uses
  %i.cu = add nsw i32 %i.ct, 1
  store i32 %i.cu, ptr %i.ao, align 8, !tbaa !116
  %i.cv = icmp sgt i32 %i.ct, 6
  br i1 %i.cv, label %bb.g, label %bb.h

bb.g:                                             ; preds = %._crit_edge144.split.us.us
  %i.cw = load i32, ptr %i.aq, align 8, !tbaa !36
...
bb.h:                                             ; preds = %.thread.us, %._crit_edge144.split.us.us
  %i.cz = load i16, ptr %i.r, align 4, !tbaa !99  ; 2 uses
  %i.da = zext i16 %i.cz to i32
  %i.db = load i32, ptr %i.ar, align 4, !tbaa !105
  %i.dc = add i32 %i.db, %i.da
  store i32 %i.dc, ptr %i.ar, align 4, !tbaa !105
...
.lr.ph121.us:                                     ; preds = %.lr.ph121.us.preheader, %.lr.ph121.us
  ...
  store i8 %load_initial238, ptr %i.fz, align 1, !tbaa !36
...
!184 = distinct !{!184, !131, !130}
!185 = distinct !{null}
!186 = !{!34, !7, i64 1032}
!187 = !{!64, !5, i64 32}
!188 = !{!86, !5, i64 172}
!189 = !{!114, !7, i64 16}
!190 = !{!"p1 _ZTS20jpeg_destination_mgr", !7, i64 0}
!191 = !{!"p1 _ZTS16jpeg_comp_master", !7, i64 0}
!192 = !{!"p1 _ZTS22jpeg_c_main_controller", !7, i64 0}
!193 = !{!"p1 _ZTS22jpeg_c_prep_controller", !7, i64 0}
!194 = !{!"p1 _ZTS22jpeg_c_coef_controller", !7, i64 0}
!195 = !{!"p1 _ZTS18jpeg_marker_writer", !7, i64 0}
!196 = !{!"p1 _ZTS20jpeg_color_converter", !7, i64 0}
!197 = !{!"p1 _ZTS16jpeg_downsampler", !7, i64 0}
!198 = !{!"p1 _ZTS16jpeg_forward_dct", !7, i64 0}
!199 = !{!"p1 _ZTS20jpeg_entropy_encoder", !7, i64 0}
!200 = !{!"jpeg_compress_struct", !61, i64 0, !62, i64 8, !63, i64 16, !7, i64 24, !5, i64 32, !5, i64 36, !190, i64 40, !5, i64 48, !5, i64 52, !5, i64 56, !5, i64 60, !72, i64 64, !5, i64 72, !5, i64 76, !5, i64 80, !5, i64 84, !5, i64 88, !5, i64 92, !5, i64 96, !7, i64 104, !4, i64 112, !4, i64 144, !4, i64 160, !4, i64 192, !4, i64 224, !4, i64 240, !4, i64 256, !5, i64 272, !7, i64 280, !5, i64 288, !5, i64 292, !5, i64 296, !5, i64 300, !5, i64 304, !5, i64 308, !5, i64 312, !5, i64 316, !5, i64 320, !5, i64 324, !4, i64 328, !4, i64 329, !4, i64 330, !11, i64 332, !11, i64 334, !5, i64 336, !5, i64 340, !5, i64 344, !5, i64 348, !5, i64 352, !5, i64 356, !5, i64 360, !5, i64 364, !5, i64 368, !4, i64 376, !5, i64 408, !5, i64 412, !5, i64 416, !4, i64 420, !5, i64 460, !5, i64 464, !5, i64 468, !5, i64 472, !5, i64 476, !73, i64 480, !5, i64 488, !191, i64 496, !192, i64 504, !193, i64 512, !194, i64 520, !195, i64 528, !196, i64 536, !197, i64 544, !198, i64 552, !199, i64 560, !7, i64 568, !5, i64 576}
!201 = !{!200, !61, i64 0}
!202 = !{!28, !7, i64 0}
