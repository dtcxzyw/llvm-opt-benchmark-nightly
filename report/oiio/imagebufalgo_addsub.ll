...
.lr.ph.i.preheader.i:                             ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i, %.noexc170
  ...
  %i.dl = load ptr, ptr %7, align 8, !tbaa !409   ; 4 uses
  %i.dm = add i64 %9, -4
  %i.dn = sub i64 %i.dm, %10                      ; 2 uses
  %i.do = lshr i64 %i.dn, 2
  %i.dp = add nuw nsw i64 %i.do, 1                ; 2 uses
  %min.iters.check1664 = icmp ult i64 %i.dn, 44
  %11 = ptrtoaddr ptr %i.dl to i64
  %i.dq = ptrtoaddr ptr %i.dk to i64
  %i.dr = sub i64 %i.dq, %11
...
vector.ph1665:                                    ; preds = %.lr.ph.i.preheader.i
  ...
  %i.ds = shl i64 %n.vec1667, 2                   ; 2 uses
  %i.dt = getelementptr i8, ptr %i.dl, i64 %i.ds
...
vector.body1668:                                  ; preds = %vector.body1668, %vector.ph1665
  ...
  %i.dv = shl i64 %index1669, 2                   ; 2 uses
  %next.gep = getelementptr i8, ptr %i.dl, i64 %i.dv ; 2 uses
  %next.gep1670 = getelementptr i8, ptr %i.dk, i64 %i.dv ; 2 uses
  %i.dw = getelementptr i8, ptr %next.gep1670, i64 16
  %wide.load1671 = load <4 x i32>, ptr %next.gep1670, align 4, !tbaa !3
  %wide.load1672 = load <4 x i32>, ptr %i.dw, align 4, !tbaa !3
  %i.dx = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %wide.load1671, ptr %next.gep, align 4, !tbaa !3
  store <4 x i32> %wide.load1672, ptr %i.dx, align 4, !tbaa !3
  %index.next1673 = add nuw i64 %index1669, 8     ; 2 uses
  %i.dy = icmp eq i64 %index.next1673, %n.vec1667
  br i1 %i.dy, label %middle.block1674, label %vector.body1668, !llvm.loop !426
...
.lr.ph.i.i.preheader:                             ; preds = %.lr.ph.i.preheader.i, %middle.block1674
  %.08.i.i.ph = phi ptr [ %i.dl, %.lr.ph.i.preheader.i ], [ %i.dt, %middle.block1674 ]
  %.057.i.i.ph = phi ptr [ %i.dk, %.lr.ph.i.preheader.i ], [ %i.du, %middle.block1674 ]
  br label %.lr.ph.i.i
...
.loopexit570:                                     ; preds = %.lr.ph.i.i, %middle.block1674, %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i
  %i.ec = phi ptr [ %i.dh, %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i ], [ %i.dk, %middle.block1674 ], [ %i.dk, %.lr.ph.i.i ] ; 2 uses
  %i.ed = load i32, ptr %i.e, align 8, !tbaa !411 ; 2 uses
  store i32 %i.ed, ptr %i.o, align 8, !tbaa !411
  br i1 %.not, label %_ZN3fmt3v126detail6bigintlSEi.exit196, label %bb.q

bb.q:                                             ; preds = %.loopexit570
  %i.ee = load i64, ptr %i.c, align 8, !tbaa !419 ; 8 uses
  %i.ef = load i64, ptr %i.p, align 8, !tbaa !410 ; 2 uses
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.thread.i179: ; preds = %bb.q
  %i.eh = load ptr, ptr %i.q, align 8, !tbaa !407
...
.noexc182:                                        ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.thread.i179
  ...
  store i64 %i.ei, ptr %i.r, align 8, !tbaa !419
  %i.ej = load ptr, ptr %5, align 8, !tbaa !409   ; 2 uses
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171: ; preds = %bb.q
  store i64 %i.ee, ptr %i.r, align 8, !tbaa !419
...
.thread:                                          ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171
  store i32 %i.ed, ptr %i.t, align 8, !tbaa !411
...
.lr.ph.i.preheader.i174:                          ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171, %.noexc182
  ...
  %i.eo = phi ptr [ %i.ej, %.noexc182 ], [ %i.ec, %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171 ] ; 5 uses
  %12 = ptrtoint ptr %i.en to i64
  %13 = ptrtoint ptr %i.eo to i64
  %i.ep = load ptr, ptr %8, align 8, !tbaa !409   ; 7 uses
  %i.eq = add i64 %12, -4
  %i.er = sub i64 %i.eq, %13                      ; 2 uses
  %i.es = lshr i64 %i.er, 2
  %i.et = add nuw nsw i64 %i.es, 1                ; 2 uses
  %min.iters.check1681 = icmp ult i64 %i.er, 44
  %14 = ptrtoaddr ptr %i.ep to i64
  %i.eu = ptrtoaddr ptr %i.eo to i64
  %i.ev = sub i64 %i.eu, %14
  %diff.check1679 = icmp ugt i64 %i.ev, -32
...
vector.ph1682:                                    ; preds = %.lr.ph.i.preheader.i174
  %n.vec1684 = and i64 %i.et, 9223372036854775800 ; 3 uses
  %i.ew = shl i64 %n.vec1684, 2                   ; 2 uses
...
vector.body1685:                                  ; preds = %vector.body1685, %vector.ph1682
  ...
  %i.ez = shl i64 %index1686, 2                   ; 2 uses
  %next.gep1687 = getelementptr i8, ptr %i.ep, i64 %i.ez ; 2 uses
  %next.gep1688 = getelementptr i8, ptr %i.eo, i64 %i.ez ; 2 uses
  %i.fa = getelementptr i8, ptr %next.gep1688, i64 16
  %wide.load1689 = load <4 x i32>, ptr %next.gep1688, align 4, !tbaa !3
  %wide.load1690 = load <4 x i32>, ptr %i.fa, align 4, !tbaa !3
  %i.fb = getelementptr i8, ptr %next.gep1687, i64 16
  store <4 x i32> %wide.load1689, ptr %next.gep1687, align 4, !tbaa !3
  store <4 x i32> %wide.load1690, ptr %i.fb, align 4, !tbaa !3
  %index.next1691 = add nuw i64 %index1686, 8     ; 2 uses
  %i.fc = icmp eq i64 %index.next1691, %n.vec1684
  br i1 %i.fc, label %middle.block1692, label %vector.body1685, !llvm.loop !428

middle.block1692:                                 ; preds = %vector.body1685
  %cmp.n1693 = icmp eq i64 %i.et, %n.vec1684
...
.lr.ph.i.i175.preheader:                          ; preds = %.lr.ph.i.preheader.i174, %middle.block1692
  %.08.i.i176.ph = phi ptr [ %i.ep, %.lr.ph.i.preheader.i174 ], [ %i.ex, %middle.block1692 ]
  %.057.i.i177.ph = phi ptr [ %i.eo, %.lr.ph.i.preheader.i174 ], [ %i.ey, %middle.block1692 ]
...
.loopexit1772:                                    ; preds = %.lr.ph.i.i175, %middle.block1692
  %i.fg = load i32, ptr %i.e, align 8, !tbaa !411
  store i32 %i.fg, ptr %i.t, align 8, !tbaa !411
...
vector.body1701:                                  ; preds = %vector.body1701, %vector.ph1698
  ...
  %vector.recur1703 = phi <4 x i32> [ <i32 poison, i32 poison, i32 poison, i32 0>, %vector.ph1698 ], [ %i.fk, %vector.body1701 ]
  %i.fh = getelementptr inbounds nuw [4 x i8], ptr %i.ep, i64 %index1702 ; 3 uses
  %i.fi = getelementptr inbounds nuw i8, ptr %i.fh, i64 16 ; 2 uses
  %wide.load1704 = load <4 x i32>, ptr %i.fh, align 4, !tbaa !3 ; 2 uses
  %wide.load1705 = load <4 x i32>, ptr %i.fi, align 4, !tbaa !3 ; 3 uses
  %i.fj = lshr <4 x i32> %wide.load1704, splat (i32 31) ; 2 uses
  %i.fk = lshr <4 x i32> %wide.load1705, splat (i32 31) ; 3 uses
  %i.fl = shufflevector <4 x i32> %vector.recur1703, <4 x i32> %i.fj, <4 x i32> <i32 3, i32 4, i32 5, i32 6>
  %i.fm = shufflevector <4 x i32> %i.fj, <4 x i32> %i.fk, <4 x i32> <i32 3, i32 4, i32 5, i32 6>
  %i.fn = shl <4 x i32> %wide.load1704, splat (i32 1)
  %i.fo = shl <4 x i32> %wide.load1705, splat (i32 1)
  ...
  %i.fr = icmp eq i64 %index.next1706, %n.vec1700
  br i1 %i.fr, label %middle.block1707, label %vector.body1701, !llvm.loop !430

middle.block1707:                                 ; preds = %vector.body1701
  %vector.recur.extract1708 = extractelement <4 x i32> %i.fk, i64 3 ; 2 uses
  %i.fs = extractelement <4 x i32> %wide.load1705, i64 3
...
._crit_edge.i189:                                 ; preds = %.lr.ph.i185, %middle.block1707
  %.lcssa1630 = phi i32 [ %i.fs, %middle.block1707 ], [ %i.fu, %.lr.ph.i185 ]
  %.lcssa1629 = phi i32 [ %vector.recur.extract1708, %middle.block1707 ], [ %i.fv, %.lr.ph.i185 ]
...
.lr.ph.i185:                                      ; preds = %.lr.ph.i185.preheader1843, %.lr.ph.i185
  %.01418.i186 = phi i64 [ %i.fy, %.lr.ph.i185 ], [ %.01418.i186.ph, %.lr.ph.i185.preheader1843 ] ; 2 uses
  %.017.i187 = phi i32 [ %i.fv, %.lr.ph.i185 ], [ %.017.i187.ph, %.lr.ph.i185.preheader1843 ]
  %i.ft = getelementptr inbounds nuw [4 x i8], ptr %i.ep, i64 %.01418.i186 ; 2 uses
...
bb.s:                                             ; preds = %bb.r
  %i.gb = load ptr, ptr %i.q, align 8, !tbaa !407
...
_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i191: ; preds = %.noexc195, %bb.r
  %i.gc = phi ptr [ %i.ep, %bb.r ], [ %.pre678, %.noexc195 ]
...
_ZN3fmt3v126detail6bigintlSEi.exit196:            ; preds = %_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i191, %._crit_edge.i189, %.loopexit1772, %.thread, %.loopexit570
  ...
  %i.gf = load i128, ptr %0, align 16, !tbaa !417 ; 3 uses
  %i.gg = and i128 %i.gf, 18446744073709551615
  %i.gh = load i64, ptr %i.c, align 8, !tbaa !419 ; 4 uses
...
.lr.ph.i.i197:                                    ; preds = %_ZN3fmt3v126detail6bigintlSEi.exit196
  %i.gi = load ptr, ptr %5, align 8, !tbaa !409   ; 3 uses
...
.lr.ph22.i.i:                                     ; preds = %.preheader.i.i, %_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i.i
  ...
  %i.hc = load i64, ptr %i.a, align 8, !tbaa !410
...
bb.u:                                             ; preds = %.lr.ph22.i.i
  %i.he = load ptr, ptr %i.b, align 8, !tbaa !407
...
_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i.i: ; preds = %.noexc200, %.lr.ph22.i.i
  %i.hf = phi ptr [ %i.gy, %.lr.ph22.i.i ], [ %.pre.i, %.noexc200 ] ; 3 uses
  %.pre-phi.i.i.i = phi i64 [ %i.hb, %.lr.ph22.i.i ], [ %.pre2.i.i.i, %.noexc200 ] ; 4 uses
  %i.hg = phi i64 [ %i.gz, %.lr.ph22.i.i ], [ %.pre.i.i.i199, %.noexc200 ]
...
bb.a:
  ...
  %i.b = load i8, ptr %0, align 1, !tbaa !47      ; 5 uses
  %i.c = add i8 %i.b, -48
...
bb.i:                                             ; preds = %_ZN3fmt3v126detail21parse_nonnegative_intIcEEiRPKT_S5_i.exit
  %i.ae = load i8, ptr %.037, align 1, !tbaa !47
...
bb.k:                                             ; preds = %bb.i, %bb.i
  %i.af = load ptr, ptr %2, align 8, !tbaa !537, !nonnull !83, !align !255
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 16 ; 2 uses
  %i.ah = load i32, ptr %i.ag, align 8, !tbaa !123
...
_ZZN3fmt3v126detail23parse_replacement_fieldIcRNS1_14format_handlerIcEEEEPKT_S8_S8_OT0_EN10id_adapter8on_indexEi.exit: ; preds = %bb.k
  store i32 -1, ptr %i.ag, align 8, !tbaa !123
...
.critedge:                                        ; preds = %.critedge4, %..critedge_crit_edge, %.critedge4.preheader
  ...
  %i.az = load ptr, ptr %2, align 8, !tbaa !537, !nonnull !83, !align !255 ; 3 uses
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 16
  store i32 -1, ptr %i.ba, align 8, !tbaa !123
  %i.bb = getelementptr inbounds nuw i8, ptr %i.az, i64 32
  %i.bc = load i64, ptr %i.bb, align 8, !tbaa !148 ; 2 uses
...
bb.o:                                             ; preds = %.critedge
  ...
  %i.bj = load i64, ptr %i.bi, align 8, !tbaa !539 ; 2 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.o
  %i.bk = load ptr, ptr %i.bh, align 8, !tbaa !542
  br label %bb.q
...
bb.q:                                             ; preds = %bb.p, %.lr.ph.i.i.i.i
  ...
  %i.bn = load ptr, ptr %i.bm, align 8, !tbaa !544 ; 2 uses
...
_ZNK3fmt3v127context6arg_idENS0_17basic_string_viewIcEE.exit.i.i: ; preds = %bb.q
  ...
  %i.bt = load i32, ptr %i.bs, align 8, !tbaa !546 ; 2 uses
...
.lr.ph:                                           ; preds = %bb.b, %bb.c
  ...
  %i.p = load i8, ptr %i.n, align 1, !tbaa !47    ; 2 uses
  %i.q = add i8 %i.p, -48
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.x = load i8, ptr %.028.lcssa.i, align 1, !tbaa !47
...
bb.j:                                             ; preds = %bb.i, %bb.i
  ...
  %i.ai = load i32, ptr %i.ah, align 8, !tbaa !123 ; 3 uses
...
_ZN3fmt3v1213parse_contextIcE11next_arg_idEv.exit: ; preds = %bb.j
  ...
  store i32 %i.ak, ptr %i.ah, align 8, !tbaa !123
...
bb.l:                                             ; preds = %bb.i
  ...
  store ptr %3, ptr %i.al, align 8, !tbaa !577
  %i.am = getelementptr inbounds nuw i8, ptr %5, i64 16
  store ptr %i.a, ptr %i.am, align 8, !tbaa !39
...
bb.n:                                             ; preds = %bb.m
  %i.ao = load i8, ptr %.0, align 1, !tbaa !47
...
bb.k:                                             ; preds = %bb.i, %bb.i
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !579, !nonnull !83, !align !255
  store i32 %.021, ptr %i.ag, align 8
  %i.ah = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.ai = load ptr, ptr %i.ah, align 8, !tbaa !581, !nonnull !83, !align !234
  store i32 1, ptr %i.ai, align 4, !tbaa !573
  %i.aj = load ptr, ptr %2, align 8, !tbaa !582, !nonnull !83, !align !255
...
_ZN3fmt3v126detail20dynamic_spec_handlerIcE8on_indexEi.exit: ; preds = %bb.k
  store i32 -1, ptr %i.ak, align 8, !tbaa !123
  br label %bb.o
...
.lr.ph:                                           ; preds = %.critedge4.preheader, %.critedge4
  ...
  %i.av = load i8, ptr %i.au, align 1, !tbaa !47  ; 3 uses
  %i.aw = and i8 %i.av, -33
  %i.ax = add i8 %i.aw, -65
...
.critedge:                                        ; preds = %.critedge4, %..critedge_crit_edge, %.critedge4.preheader
  ...
  %i.be = load ptr, ptr %i.bd, align 8, !tbaa !579, !nonnull !83, !align !255 ; 2 uses
  store ptr %0, ptr %i.be, align 8
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.be, i64 8
  store i64 %i.bc, ptr %.sroa.4.0..sroa_idx.i, align 8, !tbaa !47
  %i.bf = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !581, !nonnull !83, !align !234
  store i32 2, ptr %i.bg, align 4, !tbaa !573
  %i.bh = load ptr, ptr %2, align 8, !tbaa !582, !nonnull !83, !align !255
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bh, i64 16
  store i32 -1, ptr %i.bi, align 8, !tbaa !123
  br label %bb.o
