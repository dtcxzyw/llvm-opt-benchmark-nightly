...
begin_hunk_0_@_ZN11OpenImageIO4v3_112ImageBufAlgo3subERNS0_8ImageBufENS0_14Image_or_ConstES4_NS0_3ROIEi:bb.a
bb.ci:                                            ; preds = %bb.ch
  %.not = icmp eq i32 %i.ey, 0
  br i1 %.not, label %.loopexit, label %bb.cj

bb.cj:                                            ; preds = %bb.ci
  %i.ez = sext i32 %i.ey to i64
  %i.fa = shl nsw i64 %i.ez, 2
  %i.fb = alloca i8, i64 %i.fa, align 16          ; 29 uses
  %i.fc = icmp sgt i32 %i.ey, 0
  br i1 %i.fc, label %.lr.ph, label %.loopexit

.lr.ph:                                           ; preds = %bb.cj
  %.not242 = icmp eq i64 %.sroa.2.0.copyload.i.fr, 0
  %wide.trip.count716 = zext nneg i32 %i.ey to i64 ; 2 uses
  br i1 %.not242, label %bb.ck, label %.lr.ph.split.preheader

.lr.ph.split.preheader:                           ; preds = %.lr.ph
  %i.fd = getelementptr [4 x i8], ptr %.sroa.0.0.copyload.i, i64 %.sroa.2.0.copyload.i.fr
  %i.fe = getelementptr i8, ptr %i.fd, i64 -4
  %i.ff = icmp sgt i64 %.sroa.2.0.copyload.i.fr, 0
  %spec.select = select i1 %i.ff, ptr %.sroa.0.0.copyload.i, ptr %i.fe
  %i.fg = load float, ptr %spec.select, align 4, !tbaa !54
  store float %i.fg, ptr %i.fb, align 16, !tbaa !54
  %exitcond.peel.not = icmp eq i32 %i.ey, 1
  br i1 %exitcond.peel.not, label %.loopexit, label %.lr.ph.split.preheader774

.lr.ph.split.preheader774:                        ; preds = %.lr.ph.split.preheader
  %i.fh = add nsw i64 %wide.trip.count716, -1     ; 2 uses
  %xtraiter = and i64 %i.fh, 3                    ; 3 uses
  %i.fi = add nsw i32 %i.ey, -2
  %i.fj = icmp ult i32 %i.fi, 3
  br i1 %i.fj, label %.lr.ph.split.epil.preheader, label %.lr.ph.split.preheader774.new

.lr.ph.split.preheader774.new:                    ; preds = %.lr.ph.split.preheader774
  %unroll_iter = and i64 %i.fh, -4
  br label %.lr.ph.split

bb.ck:                                            ; preds = %.lr.ph
  store float 0.000000e+00, ptr %i.fb, align 16, !tbaa !54
  %exitcond717.peel.not = icmp eq i32 %i.ey, 1
  br i1 %exitcond717.peel.not, label %.loopexit, label %.lr.ph.split.us.peel.next.preheader

.lr.ph.split.us.peel.next.preheader:              ; preds = %bb.ck
  %load_initial = load float, ptr %i.fb, align 16 ; 9 uses
  %i.fk = add nsw i64 %wide.trip.count716, -1     ; 2 uses
  %xtraiter777 = and i64 %i.fk, 7                 ; 3 uses
  %i.fl = add nsw i32 %i.ey, -2
  %i.fm = icmp ult i32 %i.fl, 7
  br i1 %i.fm, label %.lr.ph.split.us.peel.next.epil.preheader, label %.lr.ph.split.us.peel.next.preheader.new

.lr.ph.split.us.peel.next.preheader.new:          ; preds = %.lr.ph.split.us.peel.next.preheader
  %unroll_iter781 = and i64 %i.fk, -8
...
.lr.ph.split.us.peel.next:                        ; preds = %.lr.ph.split.us.peel.next, %.lr.ph.split.us.peel.next.preheader.new
  %indvars.iv713 = phi i64 [ 1, %.lr.ph.split.us.peel.next.preheader.new ], [ %indvars.iv.next714.7, %.lr.ph.split.us.peel.next ] ; 9 uses
  %niter782 = phi i64 [ 0, %.lr.ph.split.us.peel.next.preheader.new ], [ %niter782.next.7, %.lr.ph.split.us.peel.next ]
  %i.fn = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv713
  store float %load_initial, ptr %i.fn, align 4, !tbaa !54
  %i.fo = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv713
  %i.fp = getelementptr inbounds nuw i8, ptr %i.fo, i64 4
  store float %load_initial, ptr %i.fp, align 4, !tbaa !54
  %i.fq = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv713
  %i.fr = getelementptr inbounds nuw i8, ptr %i.fq, i64 8
  store float %load_initial, ptr %i.fr, align 4, !tbaa !54
  %i.fs = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv713
  %i.ft = getelementptr inbounds nuw i8, ptr %i.fs, i64 12
  store float %load_initial, ptr %i.ft, align 4, !tbaa !54
  %i.fu = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv713
  %i.fv = getelementptr inbounds nuw i8, ptr %i.fu, i64 16
  store float %load_initial, ptr %i.fv, align 4, !tbaa !54
  %i.fw = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv713
  %i.fx = getelementptr inbounds nuw i8, ptr %i.fw, i64 20
  store float %load_initial, ptr %i.fx, align 4, !tbaa !54
  %i.fy = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv713
  %i.fz = getelementptr inbounds nuw i8, ptr %i.fy, i64 24
  store float %load_initial, ptr %i.fz, align 4, !tbaa !54
  %i.ga = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv713
  %i.gb = getelementptr inbounds nuw i8, ptr %i.ga, i64 28
  store float %load_initial, ptr %i.gb, align 4, !tbaa !54
  %indvars.iv.next714.7 = add nuw nsw i64 %indvars.iv713, 8 ; 2 uses
  %niter782.next.7 = add i64 %niter782, 8         ; 2 uses
  %niter782.ncmp.7 = icmp eq i64 %niter782.next.7, %unroll_iter781
  br i1 %niter782.ncmp.7, label %.loopexit.loopexit.unr-lcssa, label %.lr.ph.split.us.peel.next, !llvm.loop !91
...
.lr.ph.split:                                     ; preds = %.lr.ph.split, %.lr.ph.split.preheader774.new
  %indvars.iv = phi i64 [ 1, %.lr.ph.split.preheader774.new ], [ %indvars.iv.next.3, %.lr.ph.split ] ; 8 uses
  %niter = phi i64 [ 0, %.lr.ph.split.preheader774.new ], [ %niter.next.3, %.lr.ph.split ]
  %i.gd = icmp sgt i64 %.sroa.2.0.copyload.i.fr, %indvars.iv
  %i.ge = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.copyload.i, i64 %indvars.iv
  %i.gf = getelementptr [4 x i8], ptr %i.fb, i64 %indvars.iv
  %i.gg = getelementptr i8, ptr %i.gf, i64 -4
  %.in = select i1 %i.gd, ptr %i.ge, ptr %i.gg
  %i.gh = load float, ptr %.in, align 4, !tbaa !54
  %i.gi = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv
  store float %i.gh, ptr %i.gi, align 4, !tbaa !54
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 4 uses
  %i.gj = icmp sgt i64 %.sroa.2.0.copyload.i.fr, %indvars.iv.next
  %i.gk = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.copyload.i, i64 %indvars.iv.next
  %i.gl = getelementptr [4 x i8], ptr %i.fb, i64 %indvars.iv.next
  %i.gm = getelementptr i8, ptr %i.gl, i64 -4
  %.in.1 = select i1 %i.gj, ptr %i.gk, ptr %i.gm
  %i.gn = load float, ptr %.in.1, align 4, !tbaa !54
  %i.go = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv.next
  store float %i.gn, ptr %i.go, align 4, !tbaa !54
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 4 uses
  %i.gp = icmp sgt i64 %.sroa.2.0.copyload.i.fr, %indvars.iv.next.1
  %i.gq = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.copyload.i, i64 %indvars.iv.next.1
  %i.gr = getelementptr [4 x i8], ptr %i.fb, i64 %indvars.iv.next.1
  %i.gs = getelementptr i8, ptr %i.gr, i64 -4
  %.in.2 = select i1 %i.gp, ptr %i.gq, ptr %i.gs
  %i.gt = load float, ptr %.in.2, align 4, !tbaa !54
  %i.gu = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv.next.1
  store float %i.gt, ptr %i.gu, align 4, !tbaa !54
  %indvars.iv.next.2 = add nuw nsw i64 %indvars.iv, 3 ; 4 uses
  %i.gv = icmp sgt i64 %.sroa.2.0.copyload.i.fr, %indvars.iv.next.2
  %i.gw = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.copyload.i, i64 %indvars.iv.next.2
  %i.gx = getelementptr [4 x i8], ptr %i.fb, i64 %indvars.iv.next.2
  %i.gy = getelementptr i8, ptr %i.gx, i64 -4
  %.in.3 = select i1 %i.gv, ptr %i.gw, ptr %i.gy
  %i.gz = load float, ptr %.in.3, align 4, !tbaa !54
  %i.ha = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv.next.2
  store float %i.gz, ptr %i.ha, align 4, !tbaa !54
  %indvars.iv.next.3 = add nuw nsw i64 %indvars.iv, 4 ; 2 uses
  %niter.next.3 = add i64 %niter, 4               ; 2 uses
  %niter.ncmp.3 = icmp eq i64 %niter.next.3, %unroll_iter
  br i1 %niter.ncmp.3, label %.loopexit.loopexit775.unr-lcssa, label %.lr.ph.split, !llvm.loop !92

.loopexit.loopexit.unr-lcssa:                     ; preds = %.lr.ph.split.us.peel.next
  %lcmp.mod779.not = icmp eq i64 %xtraiter777, 0
  br i1 %lcmp.mod779.not, label %.loopexit, label %.lr.ph.split.us.peel.next.epil.preheader

.lr.ph.split.us.peel.next.epil.preheader:         ; preds = %.loopexit.loopexit.unr-lcssa, %.lr.ph.split.us.peel.next.preheader
  %indvars.iv713.epil.init = phi i64 [ 1, %.lr.ph.split.us.peel.next.preheader ], [ %indvars.iv.next714.7, %.loopexit.loopexit.unr-lcssa ]
  %lcmp.mod780 = icmp ne i64 %xtraiter777, 0
...
.lr.ph.split.us.peel.next.epil:                   ; preds = %.lr.ph.split.us.peel.next.epil, %.lr.ph.split.us.peel.next.epil.preheader
  %indvars.iv713.epil = phi i64 [ %indvars.iv.next714.epil, %.lr.ph.split.us.peel.next.epil ], [ %indvars.iv713.epil.init, %.lr.ph.split.us.peel.next.epil.preheader ] ; 2 uses
  %epil.iter778 = phi i64 [ %epil.iter778.next, %.lr.ph.split.us.peel.next.epil ], [ 0, %.lr.ph.split.us.peel.next.epil.preheader ]
  %i.hb = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv713.epil
  store float %load_initial, ptr %i.hb, align 4, !tbaa !54
  %indvars.iv.next714.epil = add nuw nsw i64 %indvars.iv713.epil, 1
  %epil.iter778.next = add i64 %epil.iter778, 1   ; 2 uses
  %epil.iter778.cmp.not = icmp eq i64 %epil.iter778.next, %xtraiter777
  br i1 %epil.iter778.cmp.not, label %.loopexit, label %.lr.ph.split.us.peel.next.epil, !llvm.loop !93

.loopexit.loopexit775.unr-lcssa:                  ; preds = %.lr.ph.split
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.loopexit, label %.lr.ph.split.epil.preheader

.lr.ph.split.epil.preheader:                      ; preds = %.loopexit.loopexit775.unr-lcssa, %.lr.ph.split.preheader774
  %indvars.iv.epil.init = phi i64 [ 1, %.lr.ph.split.preheader774 ], [ %indvars.iv.next.3, %.loopexit.loopexit775.unr-lcssa ]
  %lcmp.mod776 = icmp ne i64 %xtraiter, 0
...
.lr.ph.split.epil:                                ; preds = %.lr.ph.split.epil, %.lr.ph.split.epil.preheader
  ...
  %i.hc = icmp sgt i64 %.sroa.2.0.copyload.i.fr, %indvars.iv.epil
  %i.hd = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0.0.copyload.i, i64 %indvars.iv.epil
  %i.he = getelementptr [4 x i8], ptr %i.fb, i64 %indvars.iv.epil
  %i.hf = getelementptr i8, ptr %i.he, i64 -4
  %.in.epil = select i1 %i.hc, ptr %i.hd, ptr %i.hf
  %i.hg = load float, ptr %.in.epil, align 4, !tbaa !54
  %i.hh = getelementptr inbounds nuw [4 x i8], ptr %i.fb, i64 %indvars.iv.epil
  store float %i.hg, ptr %i.hh, align 4, !tbaa !54
  %indvars.iv.next.epil = add nuw nsw i64 %indvars.iv.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %.loopexit, label %.lr.ph.split.epil, !llvm.loop !94

.loopexit:                                        ; preds = %.loopexit.loopexit775.unr-lcssa, %.lr.ph.split.epil, %.loopexit.loopexit.unr-lcssa, %.lr.ph.split.us.peel.next.epil, %bb.ci, %.lr.ph.split.preheader, %bb.ck, %bb.cj, %bb.cg
  %.sroa.0365.0 = phi ptr [ %.sroa.0.0.copyload.i, %bb.cg ], [ %i.fb, %bb.cj ], [ %i.fb, %.lr.ph.split.preheader ], [ %i.fb, %bb.ck ], [ null, %bb.ci ], [ %i.fb, %.loopexit.loopexit.unr-lcssa ], [ %i.fb, %.lr.ph.split.us.peel.next.epil ], [ %i.fb, %.lr.ph.split.epil ], [ %i.fb, %.loopexit.loopexit775.unr-lcssa ] ; 7 uses
  %.sroa.0365.0770 = ptrtoaddr ptr %.sroa.0365.0 to i64
  %i.hi = invoke noundef i32 @_ZNK11OpenImageIO4v3_18ImageBuf9nchannelsEv(ptr noundef nonnull align 8 dereferenceable(16) %i.er)
          to label %bb.cm unwind label %bb.co     ; 6 uses

bb.cm:                                            ; preds = %.loopexit
  %.not228 = icmp eq i32 %i.hi, 0
  br i1 %.not228, label %._crit_edge, label %bb.cn

bb.cn:                                            ; preds = %bb.cm
  %i.hj = sext i32 %i.hi to i64
  %i.hk = shl nsw i64 %i.hj, 2
  %i.hl = alloca i8, i64 %i.hk, align 16          ; 11 uses
  %i.hm = icmp sgt i32 %i.hi, 0
  br i1 %i.hm, label %.lr.ph709.preheader, label %._crit_edge

.lr.ph709.preheader:                              ; preds = %bb.cn
  %i.hn = ptrtoaddr ptr %i.hl to i64
  %wide.trip.count722 = zext nneg i32 %i.hi to i64 ; 5 uses
  %min.iters.check = icmp ult i32 %i.hi, 8
  %i.ho = sub i64 %.sroa.0365.0770, %i.hn
  %diff.check = icmp ugt i64 %i.ho, -32
  %or.cond = select i1 %min.iters.check, i1 true, i1 %diff.check
  br i1 %or.cond, label %.lr.ph709.preheader773, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph709.preheader
  %n.vec = and i64 %wide.trip.count722, 2147483640 ; 3 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 3 uses
  %i.hp = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0365.0, i64 %index ; 2 uses
  %i.hq = getelementptr inbounds nuw i8, ptr %i.hp, i64 16
  %wide.load = load <4 x float>, ptr %i.hp, align 4, !tbaa !54
  %wide.load771 = load <4 x float>, ptr %i.hq, align 4, !tbaa !54
  %i.hr = fneg <4 x float> %wide.load
  %i.hs = fneg <4 x float> %wide.load771
  %i.ht = getelementptr inbounds nuw [4 x i8], ptr %i.hl, i64 %index ; 2 uses
  %i.hu = getelementptr inbounds nuw i8, ptr %i.ht, i64 16
  store <4 x float> %i.hr, ptr %i.ht, align 16, !tbaa !54
  store <4 x float> %i.hs, ptr %i.hu, align 16, !tbaa !54
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.hv = icmp eq i64 %index.next, %n.vec
  br i1 %i.hv, label %middle.block, label %vector.body, !llvm.loop !95

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %n.vec, %wide.trip.count722
  br i1 %cmp.n, label %._crit_edge, label %.lr.ph709.preheader773

.lr.ph709.preheader773:                           ; preds = %.lr.ph709.preheader, %middle.block
  %indvars.iv719.ph = phi i64 [ 0, %.lr.ph709.preheader ], [ %n.vec, %middle.block ] ; 3 uses
  %xtraiter783 = and i64 %wide.trip.count722, 3   ; 2 uses
  %lcmp.mod784.not = icmp eq i64 %xtraiter783, 0
  br i1 %lcmp.mod784.not, label %.lr.ph709.prol.loopexit, label %.lr.ph709.prol

.lr.ph709.prol:                                   ; preds = %.lr.ph709.preheader773, %.lr.ph709.prol
  %indvars.iv719.prol = phi i64 [ %indvars.iv.next720.prol, %.lr.ph709.prol ], [ %indvars.iv719.ph, %.lr.ph709.preheader773 ] ; 3 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph709.prol ], [ 0, %.lr.ph709.preheader773 ]
  %i.hw = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0365.0, i64 %indvars.iv719.prol
  %i.hx = load float, ptr %i.hw, align 4, !tbaa !54
  %i.hy = fneg float %i.hx
  %i.hz = getelementptr inbounds nuw [4 x i8], ptr %i.hl, i64 %indvars.iv719.prol
  store float %i.hy, ptr %i.hz, align 4, !tbaa !54
  %indvars.iv.next720.prol = add nuw nsw i64 %indvars.iv719.prol, 1 ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter783
  br i1 %prol.iter.cmp.not, label %.lr.ph709.prol.loopexit, label %.lr.ph709.prol, !llvm.loop !98

.lr.ph709.prol.loopexit:                          ; preds = %.lr.ph709.prol, %.lr.ph709.preheader773
  %indvars.iv719.unr = phi i64 [ %indvars.iv719.ph, %.lr.ph709.preheader773 ], [ %indvars.iv.next720.prol, %.lr.ph709.prol ]
  %i.ia = sub nsw i64 %indvars.iv719.ph, %wide.trip.count722
  %i.ib = icmp ugt i64 %i.ia, -4
  br i1 %i.ib, label %._crit_edge, label %.lr.ph709

._crit_edge:                                      ; preds = %.lr.ph709.prol.loopexit, %.lr.ph709, %middle.block, %bb.cm, %bb.cn
  %i.ic = phi ptr [ null, %bb.cm ], [ %i.hl, %bb.cn ], [ %i.hl, %middle.block ], [ %i.hl, %.lr.ph709 ], [ %i.hl, %.lr.ph709.prol.loopexit ] ; 8 uses
  %i.id = sext i32 %i.hi to i64                   ; 8 uses
  %i.ie = invoke noundef zeroext i1 @_ZNK11OpenImageIO4v3_18ImageBuf4deepEv(ptr noundef nonnull align 8 dereferenceable(16) %0)
...
.lr.ph709:                                        ; preds = %.lr.ph709.prol.loopexit, %.lr.ph709
  %indvars.iv719 = phi i64 [ %indvars.iv.next720.3, %.lr.ph709 ], [ %indvars.iv719.unr, %.lr.ph709.prol.loopexit ] ; 6 uses
  %i.ig = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0365.0, i64 %indvars.iv719
  %i.ih = load float, ptr %i.ig, align 4, !tbaa !54
  %i.ii = fneg float %i.ih
  %i.ij = getelementptr inbounds nuw [4 x i8], ptr %i.hl, i64 %indvars.iv719
  store float %i.ii, ptr %i.ij, align 4, !tbaa !54
  %indvars.iv.next720 = add nuw nsw i64 %indvars.iv719, 1 ; 2 uses
  %i.ik = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0365.0, i64 %indvars.iv.next720
  %i.il = load float, ptr %i.ik, align 4, !tbaa !54
  %i.im = fneg float %i.il
  %i.in = getelementptr inbounds nuw [4 x i8], ptr %i.hl, i64 %indvars.iv.next720
  store float %i.im, ptr %i.in, align 4, !tbaa !54
  %indvars.iv.next720.1 = add nuw nsw i64 %indvars.iv719, 2 ; 2 uses
  %i.io = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0365.0, i64 %indvars.iv.next720.1
  %i.ip = load float, ptr %i.io, align 4, !tbaa !54
  %i.iq = fneg float %i.ip
  %i.ir = getelementptr inbounds nuw [4 x i8], ptr %i.hl, i64 %indvars.iv.next720.1
  store float %i.iq, ptr %i.ir, align 4, !tbaa !54
  %indvars.iv.next720.2 = add nuw nsw i64 %indvars.iv719, 3 ; 2 uses
  %i.is = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0365.0, i64 %indvars.iv.next720.2
  %i.it = load float, ptr %i.is, align 4, !tbaa !54
  %i.iu = fneg float %i.it
  %i.iv = getelementptr inbounds nuw [4 x i8], ptr %i.hl, i64 %indvars.iv.next720.2
  store float %i.iu, ptr %i.iv, align 4, !tbaa !54
  ...
  br i1 %exitcond723.not.3, label %._crit_edge, label %.lr.ph709, !llvm.loop !99

bb.cp:                                            ; preds = %._crit_edge
  br i1 %i.ie, label %bb.cq, label %bb.cw

bb.cq:                                            ; preds = %bb.cp
  %i.iw = invoke noundef ptr @_ZN11OpenImageIO4v3_18ImageBuf8deepdataEv(ptr noundef nonnull align 8 dereferenceable(16) %0)
          to label %bb.cr unwind label %bb.cv

bb.cr:                                            ; preds = %bb.cq
  %i.ix = invoke noundef ptr @_ZNK11OpenImageIO4v3_18ImageBuf8deepdataEv(ptr noundef nonnull align 8 dereferenceable(16) %i.er)
          to label %bb.cs unwind label %bb.cv

bb.cs:                                            ; preds = %bb.cr
  %i.iy = invoke { ptr, i64 } @_ZNK11OpenImageIO4v3_18DeepData11all_samplesEv(ptr noundef nonnull align 8 dereferenceable(20) %i.ix)
          to label %bb.ct unwind label %bb.cv     ; 2 uses

bb.ct:                                            ; preds = %bb.cs
  %i.iz = extractvalue { ptr, i64 } %i.iy, 0
  %i.ja = extractvalue { ptr, i64 } %i.iy, 1
  invoke void @_ZN11OpenImageIO4v3_18DeepData15set_all_samplesENS0_4spanIKjLm18446744073709551615EEE(ptr noundef nonnull align 8 dereferenceable(20) %i.iw, ptr %i.iz, i64 %i.ja)
          to label %bb.cu unwind label %bb.cv

bb.cu:                                            ; preds = %bb.ct
  invoke fastcc void @_ZN11OpenImageIO4v3_1L13add_impl_deepERNS0_8ImageBufERKS1_NS0_4spanIKfLm18446744073709551615EEENS0_3ROIEi(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef nonnull align 8 dereferenceable(16) %i.er, ptr %i.ic, i64 %i.id, ptr noundef nonnull byval(%"struct.OpenImageIO::v3_1::ROI") align 8 %3, i32 noundef %4)
          to label %bb.eg unwind label %bb.cv

bb.cv:                                            ; preds = %bb.cu, %bb.ct, %bb.cs, %bb.cr, %bb.cq, %._crit_edge
  %i.jb = landingpad { ptr, i32 }
          cleanup
  br label %bb.eh

bb.cw:                                            ; preds = %bb.cp
  %i.jc = invoke noundef zeroext i1 @_ZNK11OpenImageIO4v3_18ImageBuf11initializedEv(ptr noundef nonnull align 8 dereferenceable(16) %0)
          to label %bb.cx unwind label %bb.de

bb.cx:                                            ; preds = %bb.cw
  br i1 %i.jc, label %bb.cz, label %bb.cy, !prof !22

bb.cy:                                            ; preds = %bb.cx
  %i.jd = load ptr, ptr @stderr, align 8, !tbaa !23
  %i.je = call i32 (ptr, ptr, ...) @fprintf(ptr noundef %i.jd, ptr noundef nonnull @.str.1, ptr noundef nonnull @.str.2, i32 noundef 227, ptr noundef nonnull @__FUNCTION__._ZN11OpenImageIO4v3_112ImageBufAlgo3subERNS0_8ImageBufENS0_14Image_or_ConstES4_NS0_3ROIEi, ptr noundef nonnull @.str.3) #29 ; 0 uses
  br label %bb.cz

bb.cz:                                            ; preds = %bb.cx, %bb.cy
  call void @llvm.lifetime.start.p0(ptr nonnull %14) #28
  invoke void @_ZN11OpenImageIO4v3_18ImageBufC1Ev(ptr noundef nonnull align 8 dereferenceable(16) %14)
...
bb.db:                                            ; preds = %bb.da
  %i.jf = invoke noundef nonnull align 8 dereferenceable(160) ptr @_ZNK11OpenImageIO4v3_18ImageBuf4specEv(ptr noundef nonnull align 8 dereferenceable(16) %0)
          to label %bb.dc unwind label %bb.dh

bb.dc:                                            ; preds = %bb.db
  %i.jg = getelementptr inbounds nuw i8, ptr %i.jf, i64 64
  %i.jh = load i64, ptr %i.jg, align 8            ; 4 uses
  %.sroa.0322.0.extract.trunc = trunc i64 %i.jh to i8 ; 4 uses
  %.sroa.14.0.extract.shift = lshr i64 %i.jh, 8
  %.sroa.14.0.extract.trunc = trunc i64 %.sroa.14.0.extract.shift to i8 ; 7 uses
  %.sroa.22.0.extract.shift = lshr i64 %i.jh, 16
  %.sroa.22.0.extract.trunc = trunc i64 %.sroa.22.0.extract.shift to i8 ; 7 uses
  %.sroa.30351.0.extract.shift = lshr i64 %i.jh, 32 ; 7 uses
  %.sroa.30351.0.extract.trunc = trunc nuw i64 %.sroa.30351.0.extract.shift to i32
  %i.ji = invoke noundef nonnull align 8 dereferenceable(160) ptr @_ZNK11OpenImageIO4v3_18ImageBuf4specEv(ptr noundef nonnull align 8 dereferenceable(16) %i.er)
          to label %bb.dd unwind label %bb.di

bb.dd:                                            ; preds = %bb.dc
  %i.jj = getelementptr inbounds nuw i8, ptr %i.ji, i64 64
  %i.jk = load i64, ptr %i.jj, align 8            ; 4 uses
  %.sroa.0303.0.extract.trunc = trunc i64 %i.jk to i8 ; 5 uses
  %.sroa.11.0.extract.shift = lshr i64 %i.jk, 8
  %.sroa.11.0.extract.trunc = trunc i64 %.sroa.11.0.extract.shift to i8 ; 4 uses
  %.sroa.13.0.extract.shift = lshr i64 %i.jk, 16
  %.sroa.13.0.extract.trunc = trunc i64 %.sroa.13.0.extract.shift to i8 ; 4 uses
  %.sroa.15318.0.extract.shift = lshr i64 %i.jk, 32
  %.sroa.15318.0.extract.trunc = trunc nuw i64 %.sroa.15318.0.extract.shift to i32 ; 4 uses
  switch i8 %.sroa.0303.0.extract.trunc, label %_ZN11OpenImageIO4v3_112ImageBufAlgo20is_common_pixel_typeENS0_8TypeDescE.exit281 [
    i8 11, label %_ZN11OpenImageIO4v3_112ImageBufAlgo20is_common_pixel_typeENS0_8TypeDescE.exit281.thread
    i8 4, label %_ZN11OpenImageIO4v3_112ImageBufAlgo20is_common_pixel_typeENS0_8TypeDescE.exit281.thread
    i8 2, label %_ZN11OpenImageIO4v3_112ImageBufAlgo20is_common_pixel_typeENS0_8TypeDescE.exit281.thread
    i8 10, label %_ZN11OpenImageIO4v3_112ImageBufAlgo20is_common_pixel_typeENS0_8TypeDescE.exit281.thread
  ]

_ZN11OpenImageIO4v3_112ImageBufAlgo20is_common_pixel_typeENS0_8TypeDescE.exit281: ; preds = %bb.dd
  %i.jl = invoke noundef zeroext i1 @_ZN11OpenImageIO4v3_18ImageBuf4copyERKS1_NS0_8TypeDescE(ptr noundef nonnull align 8 dereferenceable(16) %15, ptr noundef nonnull align 8 dereferenceable(16) %i.er, i64 267)
          to label %_ZN11OpenImageIO4v3_112ImageBufAlgo20is_common_pixel_typeENS0_8TypeDescE.exit281.thread unwind label %bb.di ; 0 uses
...
_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i: ; preds = %bb.a
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.e), !inline_history !182
  %.pre.i = load i64, ptr %i.c, align 8, !tbaa !116 ; 2 uses
  %.pre14.i = load i64, ptr %i.f, align 8, !tbaa !115
...
_ZN3fmt3v126detail10to_pointerIcEEPT_NS0_14basic_appenderIS3_EEm.exit: ; preds = %bb.a, %_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i
  ...
  store i64 %.pre-phi19.i, ptr %i.c, align 8, !tbaa !116
  %i.m = load ptr, ptr %0, align 8, !tbaa !114    ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.b, %.lr.ph.i
  ...
  br i1 %i.y, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !156
...
bb.d:                                             ; preds = %._crit_edge.i
  ...
  store i8 %i.ai, ptr %i.al, align 1, !tbaa !47
  br label %_ZN3fmt3v126detail17do_format_decimalIcjEEPT_S4_T0_i.exit
...
.lr.ph.i16:                                       ; preds = %_ZN3fmt3v126detail10to_pointerIcEEPT_NS0_14basic_appenderIS3_EEm.exit.thread, %.lr.ph.i16
  ...
  br i1 %i.aw, label %.lr.ph.i16, label %._crit_edge.i12, !llvm.loop !156
...
bb.f:                                             ; preds = %._crit_edge.i12
  ...
  store i8 %i.bg, ptr %i.bj, align 1, !tbaa !47
  br label %_ZN3fmt3v126detail17do_format_decimalIcjEEPT_S4_T0_i.exit19
...
define linkonce_odr hidden ptr @_ZN3fmt3v126detail13copy_noinlineIcPcNS0_14basic_appenderIcEEEET1_T0_S7_S6_(ptr noundef %0, ptr noundef %1, ptr %2) local_unnamed_addr #19 {
bb.a:
...
.lr.ph34.i.i:                                     ; preds = %bb.a
  ...
  %.pre.i.i = load i64, ptr %i.a, align 8, !tbaa !116
  br label %bb.b
...
bb.b:                                             ; preds = %._crit_edge.i.i, %.lr.ph34.i.i
  ...
  %i.f = load i64, ptr %i.b, align 8, !tbaa !115
  %i.g = sub i64 %i.f, %i.e
...
bb.c:                                             ; preds = %bb.b
  %i.k = load ptr, ptr %i.d, align 8, !tbaa !106
  %i.l = add i64 %i.i, %i.e
  tail call void %i.k(ptr noundef nonnull align 8 dereferenceable(32) %2, i64 noundef %i.l), !inline_history !184
  %i.m = load i64, ptr %i.a, align 8, !tbaa !116  ; 2 uses
  %i.n = load i64, ptr %i.b, align 8, !tbaa !115
  %i.o = sub i64 %i.n, %i.m
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.q = load ptr, ptr %2, align 8, !tbaa !114    ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.v, align 1, !tbaa !47
  %wide.load8 = load <16 x i8>, ptr %i.w, align 1, !tbaa !47
  %i.x = getelementptr inbounds nuw i8, ptr %i.s, i64 %index ; 2 uses
  %i.y = getelementptr inbounds nuw i8, ptr %i.x, i64 16
  store <16 x i8> %wide.load, ptr %i.x, align 1, !tbaa !47
  store <16 x i8> %wide.load8, ptr %i.y, align 1, !tbaa !47
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load12 = load <4 x i8>, ptr %i.aa, align 1, !tbaa !47
  %i.ab = getelementptr inbounds nuw i8, ptr %i.s, i64 %index11
  store <4 x i8> %wide.load12, ptr %i.ab, align 1, !tbaa !47
  %index.next13 = add nuw i64 %index11, 4         ; 2 uses
  %i.ac = icmp eq i64 %index.next13, %n.vec10
  br i1 %i.ac, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !187
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  store i8 %i.ae, ptr %i.af, align 1, !tbaa !47
...
._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i = load i64, ptr %i.a, align 8, !tbaa !116
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.d
  ...
  store i64 %i.ak, ptr %i.a, align 8, !tbaa !116
  %i.al = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i = icmp eq ptr %i.al, %1
  br i1 %.not.i.i, label %_ZN3fmt3v126detail4copyIcPcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS7_T0_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit, label %bb.b, !llvm.loop !189
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  %i.an = load i8, ptr %i.am, align 1, !tbaa !47
  %i.ao = getelementptr inbounds nuw i8, ptr %i.s, i64 %.030.i.i
  store i8 %i.an, ptr %i.ao, align 1, !tbaa !47
  ...
  store i8 %i.ar, ptr %i.as, align 1, !tbaa !47
  ...
  store i8 %i.av, ptr %i.aw, align 1, !tbaa !47
  ...
  br i1 %exitcond.not.i.i.3, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !190
...
bb.a:
  ...
  %i.f = load i8, ptr %i.e, align 1, !tbaa !47    ; 2 uses
  ...
  %i.j = load i64, ptr %i.i, align 8, !tbaa !53
  ...
  %i.p = load i64, ptr %i.o, align 8, !tbaa !116  ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i: ; preds = %bb.a
  ...
  tail call void %i.v(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.q), !inline_history !182
  %.pre.i = load i64, ptr %i.o, align 8, !tbaa !116 ; 3 uses
  %.pre14.i = load i64, ptr %i.r, align 8, !tbaa !115 ; 3 uses
...
_ZN3fmt3v126detail10to_pointerIcEEPT_NS0_14basic_appenderIS3_EEm.exit: ; preds = %bb.a, %_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i
  ...
  store i64 %.pre-phi19.i, ptr %i.o, align 8, !tbaa !116
  %i.z = load ptr, ptr %0, align 8, !tbaa !114    ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  store i8 45, ptr %i.aa, align 1, !tbaa !47
  br label %bb.d
...
.lr.ph.i:                                         ; preds = %bb.d, %.lr.ph.i
  ...
  br i1 %i.al, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !158
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ac = load i8, ptr %4, align 1, !tbaa !206, !range !82, !noundef !83
  %i.ad = trunc nuw i8 %i.ac to i1
  %i.ae = getelementptr inbounds nuw i8, ptr %4, i64 1
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !208 ; 2 uses
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.ai = load i64, ptr %i.ah, align 8, !tbaa !116 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  tail call void %i.ao(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.aj), !inline_history !257
  %.pre.i.i.i = load i64, ptr %i.ah, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.g, %bb.f
  ...
  %i.aq = load ptr, ptr %.sroa.09.0, align 8, !tbaa !114
  store i64 %.pre-phi.i.i.i, ptr %i.ah, align 8, !tbaa !116
  %i.ar = getelementptr inbounds nuw i8, ptr %i.aq, i64 %i.ap
  store i8 %i.af, ptr %i.ar, align 1, !tbaa !47
  br label %_ZZN3fmt3v126detail10write_charIcNS0_14basic_appenderIcEEEET0_S5_T_RKNS0_12format_specsEENKUlS4_E_clES4_.exit
...
; Function Attrs: mustprogress noinline uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail4fillIcNS0_14basic_appenderIcEEEET0_S5_mRKNS0_11basic_specsE(ptr %0, i64 noundef %1, ptr noundef nonnull align 4 dereferenceable(8) %2) local_unnamed_addr #19 {
bb.a:
  %i.a = load i32, ptr %2, align 4, !tbaa !159
  %i.b = lshr i32 %i.a, 15
...
bb.b:                                             ; preds = %bb.a
  %i.g = load i8, ptr %i.f, align 4, !tbaa !47
...
bb.c:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %.lr.ph.i
  ...
  %i.k = load i64, ptr %i.h, align 8, !tbaa !116  ; 2 uses
  %i.l = add i64 %i.k, 1                          ; 3 uses
  %i.m = load i64, ptr %i.i, align 8, !tbaa !115
  %i.n = icmp ugt i64 %i.l, %i.m
  br i1 %i.n, label %bb.d, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i

bb.d:                                             ; preds = %bb.c
  %i.o = load ptr, ptr %i.j, align 8, !tbaa !106
  tail call void %i.o(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.l), !inline_history !258
  %.pre.i.i.i = load i64, ptr %i.h, align 8, !tbaa !116 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.d, %bb.c
  ...
  %i.q = load ptr, ptr %0, align 8, !tbaa !114
  store i64 %.pre-phi.i.i.i, ptr %i.h, align 8, !tbaa !116
  %i.r = getelementptr inbounds nuw i8, ptr %i.q, i64 %i.p
  store i8 %i.g, ptr %i.r, align 1, !tbaa !47
  %i.s = add nuw i64 %.04.i, 1                    ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.s, %1
  br i1 %exitcond.not.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEmcEET_S5_T0_RKT1_.exit, label %bb.c, !llvm.loop !259
...
.lr.ph34.i.i.preheader:                           ; preds = %.lr.ph
  %.pre.i.i.pre = load i64, ptr %i.u, align 8, !tbaa !116
...
bb.f:                                             ; preds = %._crit_edge.i.i, %.lr.ph34.i.i
  ...
  %i.z = load i64, ptr %i.v, align 8, !tbaa !115
...
bb.g:                                             ; preds = %bb.f
  %i.ae = load ptr, ptr %i.x, align 8, !tbaa !106
  %i.af = add i64 %i.ac, %i.y
  tail call void %i.ae(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.af), !inline_history !211
  %i.ag = load i64, ptr %i.u, align 8, !tbaa !116 ; 2 uses
  %i.ah = load i64, ptr %i.v, align 8, !tbaa !115
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %i.ak = load ptr, ptr %0, align 8, !tbaa !114   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.ap, align 1, !tbaa !47
  %wide.load32 = load <16 x i8>, ptr %i.aq, align 1, !tbaa !47
  %i.ar = getelementptr inbounds nuw i8, ptr %i.am, i64 %index ; 2 uses
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 16
  store <16 x i8> %wide.load, ptr %i.ar, align 1, !tbaa !47
  store <16 x i8> %wide.load32, ptr %i.as, align 1, !tbaa !47
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.at = icmp eq i64 %index.next, %n.vec
  br i1 %i.at, label %middle.block, label %vector.body, !llvm.loop !260
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load36 = load <4 x i8>, ptr %i.au, align 1, !tbaa !47
  %i.av = getelementptr inbounds nuw i8, ptr %i.am, i64 %index35
  store <4 x i8> %wide.load36, ptr %i.av, align 1, !tbaa !47
  %index.next37 = add nuw i64 %index35, 4         ; 2 uses
  %i.aw = icmp eq i64 %index.next37, %n.vec34
  br i1 %i.aw, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !261
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  store i8 %i.ay, ptr %i.az, align 1, !tbaa !47
  %i.ba = add nuw i64 %.030.i.i.prol, 1           ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !262
...
._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i = load i64, ptr %i.u, align 8, !tbaa !116
  br label %._crit_edge.i.i
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.h
  ...
  store i64 %i.be, ptr %i.u, align 8, !tbaa !116
  %i.bf = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i = icmp eq ptr %i.bf, %i.t
  br i1 %.not.i.i, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit.loopexit, label %bb.f, !llvm.loop !189
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  store i8 %i.bt, ptr %i.bu, align 1, !tbaa !47
  %i.bv = add nuw i64 %.030.i.i, 4                ; 2 uses
  %exitcond.not.i.i.3 = icmp eq i64 %i.bv, %.026.i.i
  br i1 %exitcond.not.i.i.3, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !263
...
_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit.loopexit: ; preds = %._crit_edge.i.i
  ...
  br i1 %exitcond.not, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEmcEET_S5_T0_RKT1_.exit, label %.lr.ph34.i.i, !llvm.loop !264
...
bb.a:
  ...
  %i.c = load i64, ptr %i.b, align 8, !tbaa !116  ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void %i.i(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.d), !inline_history !183
  %.pre.i.i = load i64, ptr %i.b, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit:          ; preds = %bb.a, %bb.b
  ...
  %i.k = load ptr, ptr %0, align 8, !tbaa !114
  store i64 %.pre-phi.i.i, ptr %i.b, align 8, !tbaa !116
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.j
  store i8 39, ptr %i.l, align 1, !tbaa !47
...
bb.d:                                             ; preds = %_ZN3fmt3v126detail12needs_escapeEj.exit
  ...
  store ptr %i.t, ptr %i.s, align 8, !tbaa !267
  %i.u = getelementptr inbounds nuw i8, ptr %2, i64 16
  store i32 %i.m, ptr %i.u, align 8, !tbaa !268
...
bb.e:                                             ; preds = %_ZN3fmt3v126detail12needs_escapeEj.exit
  %i.w = load i64, ptr %i.b, align 8, !tbaa !116  ; 2 uses
  %i.x = add i64 %i.w, 1                          ; 3 uses
  %i.y = load i64, ptr %i.e, align 8, !tbaa !115
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.ab(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.x), !inline_history !183
  %.pre.i.i15 = load i64, ptr %i.b, align 8, !tbaa !116 ; 2 uses
end_hunk_2
...
bb.a:
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIiLm500ENS0_6detail9allocatorIiEEE4growERNS2_6bufferIiEEm, ptr %i.c, align 8, !tbaa !272
  %i.e = getelementptr inbounds nuw i8, ptr %4, i64 32 ; 6 uses
  store ptr %i.e, ptr %4, align 8, !tbaa !274
  store i64 500, ptr %i.b, align 8, !tbaa !275
  store i64 1, ptr %i.d, align 8, !tbaa !276
...
bb.b:                                             ; preds = %.lr.ph, %bb.i
  ...
  %i.o = load i64, ptr %i.j, align 8, !tbaa !67
...
bb.c:                                             ; preds = %bb.b
  ...
  %.sink.i.pre = load i8, ptr %i.r, align 1, !tbaa !47
  br label %_ZNK3fmt3v126detail14digit_groupingIcE4nextERNS3_10next_stateE.exit

bb.d:                                             ; preds = %bb.b
  %i.s = load i8, ptr %.sroa.039.055, align 1, !tbaa !47 ; 2 uses
  %i.t = add i8 %i.s, -127
...
bb.g:                                             ; preds = %_ZNK3fmt3v126detail14digit_groupingIcE4nextERNS3_10next_stateE.exit
  ...
  %i.z = load i64, ptr %i.b, align 8, !tbaa !275
  %i.aa = icmp ugt i64 %i.y, %i.z
  br i1 %i.aa, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %i.ab = load ptr, ptr %i.c, align 8, !tbaa !272
  invoke void %i.ab(ptr noundef nonnull align 8 dereferenceable(32) %4, i64 noundef %i.y)
          to label %.noexc31 unwind label %bb.f, !inline_history !277

.noexc31:                                         ; preds = %bb.h
  %.pre.i29 = load i64, ptr %i.d, align 8, !tbaa !276 ; 2 uses
  %.pre2.i30 = add i64 %.pre.i29, 1
  %.pre = load ptr, ptr %4, align 8, !tbaa !274
  %.pre63 = load i64, ptr %i.f, align 8, !tbaa !67
  br label %bb.i
...
bb.i:                                             ; preds = %.noexc31, %bb.g
  ...
  store i64 %.pre-phi.i28, ptr %i.d, align 8, !tbaa !276
...
._crit_edge.loopexit:                             ; preds = %bb.s
  %.pre64 = load ptr, ptr %4, align 8, !tbaa !274
  br label %._crit_edge
...
bb.k:                                             ; preds = %.lr.ph60, %bb.s
  ...
  %i.au = load ptr, ptr %4, align 8, !tbaa !274
...
bb.l:                                             ; preds = %bb.k
  %i.ba = load ptr, ptr %i.ao, align 8, !tbaa !44 ; 2 uses
  %i.bb = load i64, ptr %i.f, align 8, !tbaa !67  ; 2 uses
...
.lr.ph34.i.i:                                     ; preds = %bb.l
  ...
  %.pre.i.i = load i64, ptr %i.ap, align 8, !tbaa !116
  br label %bb.m
...
bb.m:                                             ; preds = %._crit_edge.i.i, %.lr.ph34.i.i
  ...
  %i.bf = load i64, ptr %i.aq, align 8, !tbaa !115
...
bb.n:                                             ; preds = %bb.m
  %i.bk = load ptr, ptr %i.ar, align 8, !tbaa !106
  %i.bl = add i64 %i.bi, %i.be
  invoke void %i.bk(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.bl)
          to label %.noexc34 unwind label %bb.p, !inline_history !278

.noexc34:                                         ; preds = %bb.n
  %i.bm = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
  %i.bn = load i64, ptr %i.aq, align 8, !tbaa !115
...
bb.o:                                             ; preds = %.noexc34, %bb.m
  ...
  %i.bq = load ptr, ptr %1, align 8, !tbaa !114   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.bv, align 1, !tbaa !47
  %wide.load78 = load <16 x i8>, ptr %i.bw, align 1, !tbaa !47
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bs, i64 %index ; 2 uses
  %i.by = getelementptr inbounds nuw i8, ptr %i.bx, i64 16
  store <16 x i8> %wide.load, ptr %i.bx, align 1, !tbaa !47
  store <16 x i8> %wide.load78, ptr %i.by, align 1, !tbaa !47
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bz = icmp eq i64 %index.next, %n.vec
  br i1 %i.bz, label %middle.block, label %vector.body, !llvm.loop !279
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load82 = load <4 x i8>, ptr %i.ca, align 1, !tbaa !47
  %i.cb = getelementptr inbounds nuw i8, ptr %i.bs, i64 %index81
  store <4 x i8> %wide.load82, ptr %i.cb, align 1, !tbaa !47
  %index.next83 = add nuw i64 %index81, 4         ; 2 uses
  %i.cc = icmp eq i64 %index.next83, %n.vec80
  br i1 %i.cc, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !280
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !281
...
._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i = load i64, ptr %i.ap, align 8, !tbaa !116
  br label %._crit_edge.i.i
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.o
  ...
  store i64 %i.ck, ptr %i.ap, align 8, !tbaa !116
  %i.cl = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i33 = icmp eq ptr %i.cl, %i.bc
  br i1 %.not.i.i33, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit, label %bb.m, !llvm.loop !189
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  %i.cr = load i8, ptr %i.cq, align 1, !tbaa !47
  %i.cs = getelementptr inbounds nuw i8, ptr %i.bs, i64 %i.cp
  store i8 %i.cr, ptr %i.cs, align 1, !tbaa !47
...
bb.q:                                             ; preds = %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit, %bb.k
  ...
  %i.df = load i8, ptr %i.de, align 1, !tbaa !47
  %i.dg = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
  %i.dh = add i64 %i.dg, 1                        ; 3 uses
  %i.di = load i64, ptr %i.aq, align 8, !tbaa !115
  %i.dj = icmp ugt i64 %i.dh, %i.di
  br i1 %i.dj, label %bb.r, label %bb.s

bb.r:                                             ; preds = %bb.q
  %i.dk = load ptr, ptr %i.ar, align 8, !tbaa !106
  invoke void %i.dk(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.dh)
          to label %.noexc36 unwind label %bb.t, !inline_history !283

.noexc36:                                         ; preds = %bb.r
  %.pre.i.i35 = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
...
bb.s:                                             ; preds = %.noexc36, %bb.q
  ...
  %i.dm = load ptr, ptr %1, align 8, !tbaa !114
  store i64 %.pre-phi.i.i, ptr %i.ap, align 8, !tbaa !116
  %i.dn = getelementptr inbounds nuw i8, ptr %i.dm, i64 %i.dl
  store i8 %i.df, ptr %i.dn, align 1, !tbaa !47
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge.loopexit, label %bb.k, !llvm.loop !284
...
bb.u:                                             ; preds = %bb.f, %bb.t, %bb.p
  ...
  %i.dp = load ptr, ptr %4, align 8, !tbaa !274   ; 2 uses
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !275  ; 2 uses
  %i.c = lshr i64 %i.b, 1
...
bb.d:                                             ; preds = %bb.a, %bb.b, %bb.c
  ...
  %i.h = load ptr, ptr %0, align 8, !tbaa !274    ; 3 uses
  %i.i = shl i64 %.0, 2
  %i.j = tail call noalias ptr @malloc(i64 noundef %i.i) #36 ; 3 uses
...
bb.a:
  ...
  %i.g = and i32 %i.f, 7
  %i.h = zext nneg i32 %i.g to i64
  %i.i = getelementptr inbounds nuw i8, ptr @.str.29, i64 %i.h
  %i.j = load i8, ptr %i.i, align 1, !tbaa !47
  %i.k = sext i8 %i.j to i64
  %i.l = and i64 %i.k, 4294967295
  %i.m = lshr i64 %i.d, %i.l                      ; 4 uses
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ac = load ptr, ptr %4, align 8, !tbaa !289, !nonnull !83, !align !234
...
bb.e:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %.lr.ph.i
  ...
  %i.aj = load i64, ptr %i.af, align 8, !tbaa !116 ; 2 uses
  %i.ak = add i64 %i.aj, 1                        ; 3 uses
  %i.al = load i64, ptr %i.ag, align 8, !tbaa !115
  %i.am = icmp ugt i64 %i.ak, %i.al
  br i1 %i.am, label %bb.f, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i

bb.f:                                             ; preds = %bb.e
  %i.an = load ptr, ptr %i.ah, align 8, !tbaa !106
  tail call void %i.an(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ak), !inline_history !291
  %.pre.i.i.i = load i64, ptr %i.af, align 8, !tbaa !116 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.f, %bb.e
  ...
  %i.ap = load ptr, ptr %.sroa.09.0, align 8, !tbaa !114
  store i64 %.pre-phi.i.i.i, ptr %i.af, align 8, !tbaa !116
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 %i.ao
  store i8 %i.ai, ptr %i.aq, align 1, !tbaa !47
  %i.ar = lshr i32 %.07.i, 8                      ; 2 uses
  %.not.i = icmp eq i32 %i.ar, 0
  br i1 %.not.i, label %_ZZN3fmt3v126detail9write_intINS0_14basic_appenderIcEEocEET_S5_T0_jRKNS0_12format_specsERKNS1_14digit_groupingIT1_EEENKUlS4_E_clES4_.exit, label %bb.e, !llvm.loop !292
...
_ZZN3fmt3v126detail9write_intINS0_14basic_appenderIcEEocEET_S5_T0_jRKNS0_12format_specsERKNS1_14digit_groupingIT1_EEENKUlS4_E_clES4_.exit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %bb.d
  ...
  %i.at = load ptr, ptr %i.as, align 8, !tbaa !293, !nonnull !83, !align !255
  %i.au = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !294, !nonnull !83, !align !255 ; 2 uses
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  %.sroa.09.0 = phi ptr [ %i.ab, %bb.c ], [ %0, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit ] ; 7 uses
  %i.ac = load ptr, ptr %4, align 8, !tbaa !295   ; 2 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.ae = load i64, ptr %i.ad, align 8, !tbaa !296 ; 2 uses
...
.lr.ph34.i.i.i:                                   ; preds = %bb.d
  ...
  %.pre.i.i.i = load i64, ptr %i.ag, align 8, !tbaa !116
  br label %bb.e
...
bb.e:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.al = load i64, ptr %i.ah, align 8, !tbaa !115
...
bb.f:                                             ; preds = %bb.e
  %i.aq = load ptr, ptr %i.aj, align 8, !tbaa !106
  %i.ar = add i64 %i.ao, %i.ak
  tail call void %i.aq(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ar), !inline_history !297
  %i.as = load i64, ptr %i.ag, align 8, !tbaa !116 ; 2 uses
  %i.at = load i64, ptr %i.ah, align 8, !tbaa !115
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.aw = load ptr, ptr %.sroa.09.0, align 8, !tbaa !114 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.bb, align 1, !tbaa !47
  %wide.load36 = load <16 x i8>, ptr %i.bc, align 1, !tbaa !47
  %i.bd = getelementptr inbounds nuw i8, ptr %i.ay, i64 %index ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 16
  store <16 x i8> %wide.load, ptr %i.bd, align 1, !tbaa !47
  store <16 x i8> %wide.load36, ptr %i.be, align 1, !tbaa !47
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bf = icmp eq i64 %index.next, %n.vec
  br i1 %i.bf, label %middle.block, label %vector.body, !llvm.loop !298
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load40 = load <4 x i8>, ptr %i.bg, align 1, !tbaa !47
  %i.bh = getelementptr inbounds nuw i8, ptr %i.ay, i64 %index39
  store <4 x i8> %wide.load40, ptr %i.bh, align 1, !tbaa !47
  %index.next41 = add nuw i64 %index39, 4         ; 2 uses
  %i.bi = icmp eq i64 %index.next41, %n.vec38
  br i1 %i.bi, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !299
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  store i8 %i.bk, ptr %i.bl, align 1, !tbaa !47
  %i.bm = add nuw i64 %.030.i.i.i.prol, 1         ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !300
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.ag, align 8, !tbaa !116
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.g
  ...
  store i64 %i.bq, ptr %i.ag, align 8, !tbaa !116
  %i.br = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.br, %i.af
  br i1 %.not.i.i.i, label %_ZZN3fmt3v126detail11write_bytesIcLNS0_5alignE1ENS0_14basic_appenderIcEEEET1_S6_NS0_17basic_string_viewIcEERKNS0_12format_specsEENKUlS5_E_clES5_.exit, label %bb.e, !llvm.loop !189
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !301
...
_ZN3fmt3v126detail15write_nonfiniteIcNS0_14basic_appenderIcEEEET0_S5_bNS0_12format_specsENS0_4signE.exit: ; preds = %bb.a
  ...
  %i.h = select i1 %i.f, ptr @.str.33, ptr @.str.35
  %.not.not.i = icmp sgt i32 %i.b, -1
  %i.i = select i1 %.not.not.i, i64 3, i64 4      ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #28
  store i32 %.lobit, ptr %3, align 8, !tbaa !302
  %i.j = getelementptr inbounds nuw i8, ptr %3, i64 8
  store ptr %i.h, ptr %i.j, align 8, !tbaa !305
...
bb.c:                                             ; preds = %bb.b
  ...
  store i32 32768, ptr %5, align 4, !tbaa !159
  %i.ad = getelementptr inbounds nuw i8, ptr %5, i64 4
  store i8 32, ptr %i.ad, align 4, !tbaa !47
...
bb.k:                                             ; preds = %bb.j
  ...
  tail call void %i.au(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.ap), !inline_history !183
  %.pre.i.i27 = load i64, ptr %i.an, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit29:        ; preds = %bb.j, %bb.k
  ...
  %i.aw = load ptr, ptr %1, align 8, !tbaa !114
  store i64 %.pre-phi.i.i26, ptr %i.an, align 8, !tbaa !116
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 %i.av
  store i8 %i.am, ptr %i.ax, align 1, !tbaa !47
  br label %bb.l
...
bb.m:                                             ; preds = %bb.l
  ...
  tail call void %i.bj(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.be), !inline_history !183
  %.pre.i.i32 = load i64, ptr %i.bc, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit34:        ; preds = %bb.l, %bb.m
  ...
  %i.bl = load ptr, ptr %1, align 8, !tbaa !114
  store i64 %.pre-phi.i.i31, ptr %i.bc, align 8, !tbaa !116
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 %i.bk
  store i8 %i.bb, ptr %i.bm, align 1, !tbaa !47
  %i.bn = getelementptr inbounds nuw i8, ptr %i.ba, i64 1
  %i.bo = load i8, ptr %i.bn, align 1, !tbaa !47
  %i.bp = load i64, ptr %i.bc, align 8, !tbaa !116 ; 2 uses
  %i.bq = add i64 %i.bp, 1                        ; 3 uses
  %i.br = load i64, ptr %i.bf, align 8, !tbaa !115
...
bb.n:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit34
  ...
  tail call void %i.bu(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.bq), !inline_history !183
  %.pre.i.i37 = load i64, ptr %i.bc, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit39:        ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit34, %bb.n
  ...
  %i.bw = load ptr, ptr %1, align 8, !tbaa !114
  store i64 %.pre-phi.i.i36, ptr %i.bc, align 8, !tbaa !116
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 %i.bv
  store i8 %i.bo, ptr %i.bx, align 1, !tbaa !47
  ret ptr %1
}
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ac = load i32, ptr %4, align 8, !tbaa !302   ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !116 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.an(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ai), !inline_history !319
  %.pre.i.i.i = load i64, ptr %i.ag, align 8, !tbaa !116 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.f, %bb.e
  ...
  %i.ap = load ptr, ptr %.sroa.09.0, align 8, !tbaa !114
  store i64 %.pre-phi.i.i.i, ptr %i.ag, align 8, !tbaa !116
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 %i.ao
  store i8 %i.af, ptr %i.aq, align 1, !tbaa !47
  br label %bb.g

bb.g:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %bb.d
  %i.ar = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !305 ; 2 uses
  ...
  %.pre.i.i2.i = load i64, ptr %i.au, align 8, !tbaa !116
  br label %bb.h
...
bb.h:                                             ; preds = %._crit_edge.i.i.i, %bb.g
  ...
  %i.ay = load i64, ptr %i.av, align 8, !tbaa !115
...
bb.i:                                             ; preds = %bb.h
  %i.bb = load ptr, ptr %i.aw, align 8, !tbaa !106
  %i.bc = add i64 %gepdiff.i, %i.ax
  tail call void %i.bb(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.bc), !inline_history !320
  %i.bd = load i64, ptr %i.au, align 8, !tbaa !116 ; 2 uses
  %i.be = load i64, ptr %i.av, align 8, !tbaa !115
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %i.bh = load ptr, ptr %.sroa.09.0, align 8, !tbaa !114 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.bn, align 1, !tbaa !47
  %wide.load36 = load <16 x i8>, ptr %i.bo, align 1, !tbaa !47
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bj, i64 %index ; 2 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 16
  store <16 x i8> %wide.load, ptr %i.bp, align 1, !tbaa !47
  store <16 x i8> %wide.load36, ptr %i.bq, align 1, !tbaa !47
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.br = icmp eq i64 %index.next, %n.vec
  br i1 %i.br, label %middle.block, label %vector.body, !llvm.loop !321
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load40 = load <4 x i8>, ptr %i.bs, align 1, !tbaa !47
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bj, i64 %index39
  store <4 x i8> %wide.load40, ptr %i.bt, align 1, !tbaa !47
  %index.next41 = add nuw i64 %index39, 4         ; 2 uses
  %i.bu = icmp eq i64 %index.next41, %n.vec38
  br i1 %i.bu, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !322
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !323
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.au, align 8, !tbaa !116
  br label %._crit_edge.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.j
  ...
  store i64 %i.cc, ptr %i.au, align 8, !tbaa !116
  %.02532.i.i.add.i = add nuw nsw i64 %.026.i.i.i, %.02532.i.i.idx.i ; 2 uses
  %.not.i.i.i = icmp eq i64 %.02532.i.i.add.i, 3
  br i1 %.not.i.i.i, label %_ZZN3fmt3v126detail15write_nonfiniteIcNS0_14basic_appenderIcEEEET0_S5_bNS0_12format_specsENS0_4signEENKUlS4_E_clES4_.exit, label %bb.h, !llvm.loop !189
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !324
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load i64, ptr %i.f, align 8, !tbaa !116  ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.h), !inline_history !183
  %.pre.i.i = load i64, ptr %i.f, align 8, !tbaa !116 ; 2 uses
  %.pre2.i.i = add i64 %.pre.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit:          ; preds = %bb.b, %bb.c
  ...
  %i.o = load ptr, ptr %1, align 8, !tbaa !114
  store i64 %.pre-phi.i.i, ptr %i.f, align 8, !tbaa !116
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 %i.n
  store i8 %i.e, ptr %i.p, align 1, !tbaa !47
  br label %bb.d

bb.d:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit, %bb.a
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !327, !nonnull !83, !align !234 ; 2 uses
  %i.s = load i32, ptr %i.r, align 4, !tbaa !328
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !329, !nonnull !83, !align !234
  %i.v = load i32, ptr %i.u, align 4, !tbaa !3
  %i.w = getelementptr inbounds nuw i8, ptr %i.r, i64 4
  %i.x = load i32, ptr %i.w, align 4, !tbaa !308  ; 2 uses
...
bb.e:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i.i, %.lr.ph.i.i
  ...
  %i.ad = load i64, ptr %i.aa, align 8, !tbaa !116 ; 2 uses
  %i.ae = add i64 %i.ad, 1                        ; 3 uses
  %i.af = load i64, ptr %i.ab, align 8, !tbaa !115
  %i.ag = icmp ugt i64 %i.ae, %i.af
  br i1 %i.ag, label %bb.f, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i.i

bb.f:                                             ; preds = %bb.e
  %i.ah = load ptr, ptr %i.ac, align 8, !tbaa !106
  tail call void %i.ah(ptr noundef nonnull align 8 dereferenceable(32) %i.y, i64 noundef %i.ae), !inline_history !330
  %.pre.i.i.i.i = load i64, ptr %i.aa, align 8, !tbaa !116 ; 2 uses
...
.split.i.i:                                       ; preds = %.split.i.i, %bb.f
  ...
  store i8 %i.ah, ptr %i.ai, align 1, !tbaa !47
  %i.aj = lshr i128 %.012.i.i, 4                  ; 2 uses
  %.not.i.i = icmp eq i128 %i.aj, 0
  br i1 %.not.i.i, label %_ZN3fmt3v126detail13format_base2eIcoEEPT_iS4_T0_ib.exit.preheader, label %.split.i.i, !llvm.loop !286
...
_ZN3fmt3v126detail13format_base2eIcoEEPT_iS4_T0_ib.exit: ; preds = %.lr.ph
  ...
  br i1 %.not91, label %.critedge, label %.lr.ph, !llvm.loop !390
...
.critedge:                                        ; preds = %.lr.ph, %_ZN3fmt3v126detail13format_base2eIcoEEPT_iS4_T0_ib.exit, %_ZN3fmt3v126detail13format_base2eIcoEEPT_iS4_T0_ib.exit.preheader
  ...
  %i.aq = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
  %i.ar = add i64 %i.aq, 1                        ; 3 uses
  %i.as = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 9 uses
  %i.at = load i64, ptr %i.as, align 8, !tbaa !115
...
bb.g:                                             ; preds = %.critedge
  ...
  tail call void %i.aw(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ar), !inline_history !391
  %.pre.i = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit:  ; preds = %.critedge, %bb.g
  ...
  %i.ay = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i, ptr %i.ap, align 8, !tbaa !116
  %i.az = getelementptr inbounds nuw i8, ptr %i.ay, i64 %i.ax
  store i8 48, ptr %i.az, align 1, !tbaa !47
  %i.ba = select i1 %.not90, i8 120, i8 88
  %i.bb = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
  %i.bc = add i64 %i.bb, 1                        ; 3 uses
  %i.bd = load i64, ptr %i.as, align 8, !tbaa !115
...
bb.h:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit
  ...
  tail call void %i.bg(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bc), !inline_history !391
  %.pre.i40 = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit, %bb.h
  ...
  %i.bi = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i39, ptr %i.ap, align 8, !tbaa !116
  %i.bj = getelementptr inbounds nuw i8, ptr %i.bi, i64 %i.bh
  store i8 %i.ba, ptr %i.bj, align 1, !tbaa !47
  %i.bk = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
  %i.bl = add i64 %i.bk, 1                        ; 3 uses
  %i.bm = load i64, ptr %i.as, align 8, !tbaa !115
...
bb.i:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42
  ...
  %i.bp = load ptr, ptr %i.bo, align 8, !tbaa !106
  tail call void %i.bp(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bl), !inline_history !391
  %.pre.i44 = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42, %bb.i
  ...
  %i.br = load i8, ptr %i.a, align 16, !tbaa !47
  %i.bs = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i43, ptr %i.ap, align 8, !tbaa !116
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bs, i64 %i.bq
  store i8 %i.br, ptr %i.bt, align 1, !tbaa !47
...
bb.j:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46
  %i.bx = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
  %i.by = add i64 %i.bx, 1                        ; 3 uses
  %i.bz = load i64, ptr %i.as, align 8, !tbaa !115
...
bb.k:                                             ; preds = %bb.j
  ...
  tail call void %i.cc(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.by), !inline_history !391
  %.pre.i48 = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit50: ; preds = %bb.j, %bb.k
  ...
  %i.ce = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i47, ptr %i.ap, align 8, !tbaa !116
  %i.cf = getelementptr inbounds nuw i8, ptr %i.ce, i64 %i.cd
  store i8 46, ptr %i.cf, align 1, !tbaa !47
  br label %bb.l
...
.lr.ph34.i:                                       ; preds = %bb.l
  ...
  %.pre.i51 = load i64, ptr %i.ap, align 8, !tbaa !116
  br label %bb.m
...
bb.m:                                             ; preds = %._crit_edge.i, %.lr.ph34.i
  ...
  %i.cm = load i64, ptr %i.as, align 8, !tbaa !115
...
bb.n:                                             ; preds = %bb.m
  %i.cr = load ptr, ptr %i.ck, align 8, !tbaa !106
  %i.cs = add i64 %i.cp, %i.cl
  call void %i.cr(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.cs), !inline_history !392
  %i.ct = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
  %i.cu = load i64, ptr %i.as, align 8, !tbaa !115
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  %i.cx = load ptr, ptr %3, align 8, !tbaa !114   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.dc, align 1, !tbaa !47
  %wide.load118 = load <16 x i8>, ptr %i.dd, align 1, !tbaa !47
  %i.de = getelementptr inbounds nuw i8, ptr %i.cz, i64 %index ; 2 uses
  %i.df = getelementptr inbounds nuw i8, ptr %i.de, i64 16
  store <16 x i8> %wide.load, ptr %i.de, align 1, !tbaa !47
  store <16 x i8> %wide.load118, ptr %i.df, align 1, !tbaa !47
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.dg = icmp eq i64 %index.next, %n.vec
  br i1 %i.dg, label %middle.block, label %vector.body, !llvm.loop !393
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load122 = load <4 x i8>, ptr %i.dh, align 1, !tbaa !47
  %i.di = getelementptr inbounds nuw i8, ptr %i.cz, i64 %index121
  store <4 x i8> %wide.load122, ptr %i.di, align 1, !tbaa !47
  %index.next123 = add nuw i64 %index121, 4       ; 2 uses
  %i.dj = icmp eq i64 %index.next123, %n.vec120
  br i1 %i.dj, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !394
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  store i8 %i.dl, ptr %i.dm, align 1, !tbaa !47
...
._crit_edge.loopexit.i:                           ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i = load i64, ptr %i.ap, align 8, !tbaa !116
...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.o
  ...
  store i64 %i.dr, ptr %i.ap, align 8, !tbaa !116
  %i.ds = getelementptr inbounds nuw i8, ptr %.02532.i, i64 %.026.i ; 2 uses
  %.not.i = icmp eq ptr %i.ds, %i.ci
  br i1 %.not.i, label %_ZN3fmt3v126detail6bufferIcE6appendIcEEvPKT_S7_.exit, label %bb.m, !llvm.loop !189
...
bb.p:                                             ; preds = %.lr.ph96, %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55
  ...
  %i.ek = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
  %i.el = add i64 %i.ek, 1                        ; 3 uses
  %i.em = load i64, ptr %i.as, align 8, !tbaa !115
  %i.en = icmp ugt i64 %i.el, %i.em
  br i1 %i.en, label %bb.q, label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55

bb.q:                                             ; preds = %bb.p
  %i.eo = load ptr, ptr %i.ej, align 8, !tbaa !106
  call void %i.eo(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.el), !inline_history !391
  %.pre.i53 = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55: ; preds = %bb.p, %bb.q
  ...
  %i.eq = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i52, ptr %i.ap, align 8, !tbaa !116
  %i.er = getelementptr inbounds nuw i8, ptr %i.eq, i64 %i.ep
  store i8 48, ptr %i.er, align 1, !tbaa !47
  %i.es = add i32 %.295, 1                        ; 2 uses
  %exitcond.not = icmp eq i32 %i.es, %.sroa.6.8.extract.trunc
  br i1 %exitcond.not, label %._crit_edge, label %bb.p, !llvm.loop !397
...
._crit_edge:                                      ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55, %_ZN3fmt3v126detail6bufferIcE6appendIcEEvPKT_S7_.exit
  ...
  %i.eu = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
  %i.ev = add i64 %i.eu, 1                        ; 3 uses
  %i.ew = load i64, ptr %i.as, align 8, !tbaa !115
...
bb.r:                                             ; preds = %._crit_edge
  ...
  %i.ez = load ptr, ptr %i.ey, align 8, !tbaa !106
  call void %i.ez(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ev), !inline_history !391
  %.pre.i57 = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit59: ; preds = %._crit_edge, %bb.r
  ...
  %i.fb = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i56, ptr %i.ap, align 8, !tbaa !116
  %i.fc = getelementptr inbounds nuw i8, ptr %i.fb, i64 %i.fa
  store i8 %i.et, ptr %i.fc, align 1, !tbaa !47
  %i.fd = icmp slt i32 %.sroa.9.2, 0
  %i.fe = load i64, ptr %i.ap, align 8, !tbaa !116 ; 3 uses
  %i.ff = add i64 %i.fe, 1                        ; 5 uses
  %i.fg = load i64, ptr %i.as, align 8, !tbaa !115
...
bb.t:                                             ; preds = %bb.s
  ...
  call void %i.fj(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ff), !inline_history !391
  %.pre.i61 = load i64, ptr %i.ap, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit63: ; preds = %bb.s, %bb.t
  ...
  %i.fl = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i60, ptr %i.ap, align 8, !tbaa !116
  %i.fm = getelementptr inbounds nuw i8, ptr %i.fl, i64 %i.fk
  store i8 45, ptr %i.fm, align 1, !tbaa !47
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  store i128 %.sroa.0.0, ptr %5, align 16, !tbaa !399
...
bb.j:                                             ; preds = %bb.i
  %i.bk = load i32, ptr %2, align 4, !tbaa !159
...
bb.n:                                             ; preds = %.critedge
  ...
  call void %i.cb(ptr noundef nonnull align 8 dereferenceable(32) %4, i64 noundef %.047), !inline_history !398
  %.pre.i41 = load i64, ptr %i.bx, align 8, !tbaa !115
  br label %_ZN3fmt3v126detail6bufferIcE10try_resizeEm.exit42
...
_ZN3fmt3v126detail6bufferIcE10try_resizeEm.exit42: ; preds = %.critedge.thread, %.critedge, %bb.n
  ...
  store i64 %i.cd, ptr %i.bm, align 8, !tbaa !116
  br label %bb.o
...
bb.f:                                             ; preds = %bb.e
  %i.aq = load ptr, ptr %i.aj, align 8, !tbaa !106
  %i.ar = add i64 %i.ao, %i.ak
  tail call void %i.aq(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ar), !inline_history !402
  %i.as = load i64, ptr %i.ag, align 8, !tbaa !116 ; 2 uses
  %i.at = load i64, ptr %i.ah, align 8, !tbaa !115
  %i.au = sub i64 %i.at, %i.as
  %i.av = tail call i64 @llvm.umin.i64(i64 %i.ao, i64 %i.au)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bf = icmp eq i64 %index.next, %n.vec
  br i1 %i.bf, label %middle.block, label %vector.body, !llvm.loop !403
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %index.next41 = add nuw i64 %index39, 4         ; 2 uses
  %i.bi = icmp eq i64 %index.next41, %n.vec38
  br i1 %i.bi, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !404
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !405
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.g
  ...
  %i.br = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.br, %i.af
  br i1 %.not.i.i.i, label %_ZZN3fmt3v126detail11write_bytesIcLNS0_5alignE2ENS0_14basic_appenderIcEEEET1_S6_NS0_17basic_string_viewIcEERKNS0_12format_specsEENKUlS5_E_clES5_.exit, label %bb.e, !llvm.loop !189
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  %i.ch = add nuw i64 %.030.i.i.i, 4              ; 2 uses
  %exitcond.not.i.i.i.3 = icmp eq i64 %i.ch, %.026.i.i.i
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !406
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden void @_ZN3fmt3v1212format_errorCI2St13runtime_errorEPKc(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef %1) unnamed_addr #10 align 2 {
bb.a:
  tail call void @_ZNSt13runtime_errorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef %1)
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN3fmt3v1212format_errorE, i64 16), ptr %0, align 8, !tbaa !128
  ret void
}
...
define linkonce_odr hidden void @_ZN3fmt3v1212format_errorD0Ev(ptr noundef nonnull align 8 dereferenceable(16) %0) unnamed_addr #20 align 2 {
bb.a:
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden void @_ZN3fmt3v126detail13format_dragonENS1_8basic_fpIoEEjiRNS1_6bufferIcEERi(ptr noundef byval(%"struct.fmt::v12::detail::basic_fp") align 16 %0, i32 noundef %1, i32 noundef %2, ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 4 dereferenceable(4) %4) local_unnamed_addr #10 personality ptr @__gxx_personality_v0 {
bb.a:
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE4growERNS2_6bufferIjEEm, ptr %i.b, align 8, !tbaa !407
  %i.d = getelementptr inbounds nuw i8, ptr %5, i64 32 ; 9 uses
  store ptr %i.d, ptr %5, align 8, !tbaa !409
  store i64 32, ptr %i.a, align 8, !tbaa !410
  %i.e = getelementptr inbounds nuw i8, ptr %5, i64 168 ; 10 uses
  store i32 0, ptr %i.e, align 8, !tbaa !411
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE4growERNS2_6bufferIjEEm, ptr %i.g, align 8, !tbaa !407
  %i.i = getelementptr inbounds nuw i8, ptr %6, i64 32 ; 3 uses
  store ptr %i.i, ptr %6, align 8, !tbaa !409
  store i64 32, ptr %i.f, align 8, !tbaa !410
  %i.j = getelementptr inbounds nuw i8, ptr %6, i64 168 ; 9 uses
  store i32 0, ptr %i.j, align 8, !tbaa !411
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE4growERNS2_6bufferIjEEm, ptr %i.l, align 8, !tbaa !407
  %i.n = getelementptr inbounds nuw i8, ptr %7, i64 32 ; 5 uses
  store ptr %i.n, ptr %7, align 8, !tbaa !409
  store i64 32, ptr %i.k, align 8, !tbaa !410
  %i.o = getelementptr inbounds nuw i8, ptr %7, i64 168 ; 7 uses
  store i32 0, ptr %i.o, align 8, !tbaa !411
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE4growERNS2_6bufferIjEEm, ptr %i.q, align 8, !tbaa !407
  %i.s = getelementptr inbounds nuw i8, ptr %8, i64 32 ; 5 uses
  store ptr %i.s, ptr %8, align 8, !tbaa !409
  store i64 32, ptr %i.p, align 8, !tbaa !410
...
.lr.ph.i.preheader.i:                             ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i, %.noexc170
  ...
  %i.dn = load ptr, ptr %7, align 8, !tbaa !409   ; 4 uses
  %i.do = add i64 %i.dl, -4
  %i.dp = sub i64 %i.do, %i.dm                    ; 2 uses
  %i.dq = lshr i64 %i.dp, 2
  %i.dr = add nuw nsw i64 %i.dq, 1                ; 2 uses
  %min.iters.check1664 = icmp ult i64 %i.dp, 44
...
vector.ph1665:                                    ; preds = %.lr.ph.i.preheader.i
  %n.vec1667 = and i64 %i.dr, 9223372036854775800 ; 3 uses
  %i.dv = shl i64 %n.vec1667, 2                   ; 2 uses
...
vector.body1668:                                  ; preds = %vector.body1668, %vector.ph1665
  ...
  %i.dy = shl i64 %index1669, 2                   ; 2 uses
  %next.gep = getelementptr i8, ptr %i.dn, i64 %i.dy ; 2 uses
  %next.gep1670 = getelementptr i8, ptr %i.dk, i64 %i.dy ; 2 uses
  %i.dz = getelementptr i8, ptr %next.gep1670, i64 16
  %wide.load1671 = load <4 x i32>, ptr %next.gep1670, align 4, !tbaa !3
  %wide.load1672 = load <4 x i32>, ptr %i.dz, align 4, !tbaa !3
  %i.ea = getelementptr i8, ptr %next.gep, i64 16
  store <4 x i32> %wide.load1671, ptr %next.gep, align 4, !tbaa !3
  store <4 x i32> %wide.load1672, ptr %i.ea, align 4, !tbaa !3
  %index.next1673 = add nuw i64 %index1669, 8     ; 2 uses
  %i.eb = icmp eq i64 %index.next1673, %n.vec1667
  br i1 %i.eb, label %middle.block1674, label %vector.body1668, !llvm.loop !426

middle.block1674:                                 ; preds = %vector.body1668
  %cmp.n1675 = icmp eq i64 %i.dr, %n.vec1667
...
.lr.ph.i.i.preheader:                             ; preds = %.lr.ph.i.preheader.i, %middle.block1674
  %.08.i.i.ph = phi ptr [ %i.dn, %.lr.ph.i.preheader.i ], [ %i.dw, %middle.block1674 ]
  %.057.i.i.ph = phi ptr [ %i.dk, %.lr.ph.i.preheader.i ], [ %i.dx, %middle.block1674 ]
  br label %.lr.ph.i.i
...
.loopexit570:                                     ; preds = %.lr.ph.i.i, %middle.block1674, %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i
  %i.ef = phi ptr [ %i.dh, %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i ], [ %i.dk, %middle.block1674 ], [ %i.dk, %.lr.ph.i.i ] ; 2 uses
  %i.eg = load i32, ptr %i.e, align 8, !tbaa !411 ; 2 uses
  store i32 %i.eg, ptr %i.o, align 8, !tbaa !411
  br i1 %.not, label %_ZN3fmt3v126detail6bigintlSEi.exit196, label %bb.q

bb.q:                                             ; preds = %.loopexit570
  %i.eh = load i64, ptr %i.c, align 8, !tbaa !419 ; 8 uses
  %i.ei = load i64, ptr %i.p, align 8, !tbaa !410 ; 2 uses
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.thread.i179: ; preds = %bb.q
  %i.ek = load ptr, ptr %i.q, align 8, !tbaa !407
...
.noexc182:                                        ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.thread.i179
  ...
  store i64 %i.el, ptr %i.r, align 8, !tbaa !419
  %i.em = load ptr, ptr %5, align 8, !tbaa !409   ; 2 uses
...
.thread:                                          ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171
  store i32 %i.eg, ptr %i.t, align 8, !tbaa !411
...
vector.ph1682:                                    ; preds = %.lr.ph.i.preheader.i174
  %n.vec1684 = and i64 %i.ey, 9223372036854775800 ; 3 uses
  %i.fc = shl i64 %n.vec1684, 2                   ; 2 uses
...
vector.body1685:                                  ; preds = %vector.body1685, %vector.ph1682
  ...
  %i.ff = shl i64 %index1686, 2                   ; 2 uses
  %next.gep1687 = getelementptr i8, ptr %i.eu, i64 %i.ff ; 2 uses
  %next.gep1688 = getelementptr i8, ptr %i.er, i64 %i.ff ; 2 uses
  %i.fg = getelementptr i8, ptr %next.gep1688, i64 16
  %wide.load1689 = load <4 x i32>, ptr %next.gep1688, align 4, !tbaa !3
  %wide.load1690 = load <4 x i32>, ptr %i.fg, align 4, !tbaa !3
  %i.fh = getelementptr i8, ptr %next.gep1687, i64 16
  store <4 x i32> %wide.load1689, ptr %next.gep1687, align 4, !tbaa !3
  store <4 x i32> %wide.load1690, ptr %i.fh, align 4, !tbaa !3
  %index.next1691 = add nuw i64 %index1686, 8     ; 2 uses
  %i.fi = icmp eq i64 %index.next1691, %n.vec1684
  br i1 %i.fi, label %middle.block1692, label %vector.body1685, !llvm.loop !428

middle.block1692:                                 ; preds = %vector.body1685
  %cmp.n1693 = icmp eq i64 %i.ey, %n.vec1684
...
.lr.ph.i.i175.preheader:                          ; preds = %.lr.ph.i.preheader.i174, %middle.block1692
  %.08.i.i176.ph = phi ptr [ %i.eu, %.lr.ph.i.preheader.i174 ], [ %i.fd, %middle.block1692 ]
  %.057.i.i177.ph = phi ptr [ %i.er, %.lr.ph.i.preheader.i174 ], [ %i.fe, %middle.block1692 ]
...
.loopexit1772:                                    ; preds = %.lr.ph.i.i175, %middle.block1692
  %i.fm = load i32, ptr %i.e, align 8, !tbaa !411
  store i32 %i.fm, ptr %i.t, align 8, !tbaa !411
...
vector.body1701:                                  ; preds = %vector.body1701, %vector.ph1698
  ...
  %vector.recur1703 = phi <4 x i32> [ <i32 poison, i32 poison, i32 poison, i32 0>, %vector.ph1698 ], [ %i.fq, %vector.body1701 ]
  %i.fn = getelementptr inbounds nuw [4 x i8], ptr %i.eu, i64 %index1702 ; 3 uses
  %i.fo = getelementptr inbounds nuw i8, ptr %i.fn, i64 16 ; 2 uses
  %wide.load1704 = load <4 x i32>, ptr %i.fn, align 4, !tbaa !3 ; 2 uses
  %wide.load1705 = load <4 x i32>, ptr %i.fo, align 4, !tbaa !3 ; 3 uses
  %i.fp = lshr <4 x i32> %wide.load1704, splat (i32 31) ; 2 uses
  %i.fq = lshr <4 x i32> %wide.load1705, splat (i32 31) ; 3 uses
  %i.fr = shufflevector <4 x i32> %vector.recur1703, <4 x i32> %i.fp, <4 x i32> <i32 3, i32 4, i32 5, i32 6>
  %i.fs = shufflevector <4 x i32> %i.fp, <4 x i32> %i.fq, <4 x i32> <i32 3, i32 4, i32 5, i32 6>
  %i.ft = shl <4 x i32> %wide.load1704, splat (i32 1)
  %i.fu = shl <4 x i32> %wide.load1705, splat (i32 1)
  ...
  %i.fx = icmp eq i64 %index.next1706, %n.vec1700
  br i1 %i.fx, label %middle.block1707, label %vector.body1701, !llvm.loop !430

middle.block1707:                                 ; preds = %vector.body1701
  %vector.recur.extract1708 = extractelement <4 x i32> %i.fq, i64 3 ; 2 uses
  %i.fy = extractelement <4 x i32> %wide.load1705, i64 3
...
._crit_edge.i189:                                 ; preds = %.lr.ph.i185, %middle.block1707
  %.lcssa1630 = phi i32 [ %i.fy, %middle.block1707 ], [ %i.ga, %.lr.ph.i185 ]
  %.lcssa1629 = phi i32 [ %vector.recur.extract1708, %middle.block1707 ], [ %i.gb, %.lr.ph.i185 ]
...
.lr.ph.i185:                                      ; preds = %.lr.ph.i185.preheader1843, %.lr.ph.i185
  %.01418.i186 = phi i64 [ %i.ge, %.lr.ph.i185 ], [ %.01418.i186.ph, %.lr.ph.i185.preheader1843 ] ; 2 uses
  %.017.i187 = phi i32 [ %i.gb, %.lr.ph.i185 ], [ %.017.i187.ph, %.lr.ph.i185.preheader1843 ]
...
bb.s:                                             ; preds = %bb.r
  %i.gh = load ptr, ptr %i.q, align 8, !tbaa !407
...
_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i191: ; preds = %.noexc195, %bb.r
  ...
  store i32 %.lcssa1629, ptr %i.gk, align 4, !tbaa !3
  br label %_ZN3fmt3v126detail6bigintlSEi.exit196
...
_ZN3fmt3v126detail6bigintlSEi.exit196:            ; preds = %_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i191, %._crit_edge.i189, %.loopexit1772, %.thread, %.loopexit570
  ...
  %i.gl = load i128, ptr %0, align 16, !tbaa !417 ; 3 uses
  %i.gm = and i128 %i.gl, 18446744073709551615
  %i.gn = load i64, ptr %i.c, align 8, !tbaa !419 ; 4 uses
...
.lr.ph.i.i197:                                    ; preds = %_ZN3fmt3v126detail6bigintlSEi.exit196
  %i.go = load ptr, ptr %5, align 8, !tbaa !409   ; 3 uses
...
.lr.ph22.i.i:                                     ; preds = %.preheader.i.i, %_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i.i
  ...
  %i.hi = load i64, ptr %i.a, align 8, !tbaa !410
...
bb.u:                                             ; preds = %.lr.ph22.i.i
  %i.hk = load ptr, ptr %i.b, align 8, !tbaa !407
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.bz = icmp eq i64 %index.next, %n.vec
  br i1 %i.bz, label %middle.block, label %vector.body, !llvm.loop !455
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %scalar.ph, !llvm.loop !456

bb.l:                                             ; preds = %._crit_edge.i
  %i.cg = add i64 %i.bm, 1                        ; 3 uses
  %i.ch = load i64, ptr %i.o, align 8, !tbaa !410
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ck = load ptr, ptr %i.cj, align 8, !tbaa !407
  tail call void %i.ck(ptr noundef nonnull align 8 dereferenceable(172) %0, i64 noundef %i.cg), !inline_history !457
  %.pre.i.i = load i64, ptr %i.v, align 8, !tbaa !419 ; 2 uses
  %.pre2.i.i = add i64 %.pre.i.i, 1
  %.pre23 = load ptr, ptr %0, align 8, !tbaa !409
...
_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i: ; preds = %bb.m, %bb.l
  ...
  store i64 %.pre-phi.i.i, ptr %i.v, align 8, !tbaa !419
...
bb.d:                                             ; preds = %.lr.ph
  ...
  br i1 %.not35.not.i, label %.lr.ph, label %._crit_edge, !llvm.loop !446
...
.lr.ph:                                           ; preds = %bb.c, %bb.d
  ...
  br i1 %.not37.i, label %bb.d, label %.loopexit.i, !llvm.loop !446
...
bb.e:                                             ; preds = %select.unfold
  ...
  %i.ad = load i64, ptr %i.ac, align 8, !tbaa !410 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.ag(ptr noundef nonnull align 8 dereferenceable(172) %0, i64 noundef %i.ab), !inline_history !458
  %.pre.i.i.i = load i64, ptr %i.ac, align 8, !tbaa !410
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i: ; preds = %bb.f, %bb.e
  ...
  store i64 %i.ai, ptr %i.a, align 8, !tbaa !419
  %i.aj = icmp sgt i32 %i.c, 0
  %.pre.i = load ptr, ptr %0, align 8, !tbaa !409 ; 13 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.ba, label %middle.block, label %vector.body, !llvm.loop !459
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !460
...
.lr.ph.preheader.i.i:                             ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i
  ...
  %i.bl = load i32, ptr %i.d, align 8, !tbaa !411
  %i.bm = sub nsw i32 %i.bl, %i.y                 ; 2 uses
  store i32 %i.bm, ptr %i.d, align 8, !tbaa !411
  %.pre.pre = load i64, ptr %i.g, align 8, !tbaa !419
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %.not.i13.3, label %.lr.ph.preheader.i.i, label %scalar.ph, !llvm.loop !461
...
.lr.ph.i14:                                       ; preds = %_ZN3fmt3v126detail7compareERKNS1_6bigintES4_.exit32
  %i.cm = load i32, ptr %i.j, align 8, !tbaa !411
  %i.cn = sub i32 %i.cm, %i.ci
  %i.co = load ptr, ptr %1, align 8, !tbaa !409   ; 3 uses
  %i.cp = load ptr, ptr %0, align 8, !tbaa !409   ; 4 uses
...
bb.g:                                             ; preds = %bb.g, %.lr.ph.i14.new
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.i.unr-lcssa, label %bb.g, !llvm.loop !462
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i12: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %i.ba = load i64, ptr %i.b, align 8, !tbaa !47
  %i.bb = add i64 %i.ba, 1
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden void @_ZN3fmt3v126detail18thousands_sep_implIcEENS1_20thousands_sep_resultIT_EENS0_10locale_refE(ptr dead_on_unwind noalias writable sret(%"struct.fmt::v12::detail::thousands_sep_result") align 8 %0, ptr %1) local_unnamed_addr #10 personality ptr @__gxx_personality_v0 {
bb.a:
...
_ZSt9use_facetINSt7__cxx118numpunctIcEEERKT_RKSt6locale.exit: ; preds = %_ZNK3fmt3v1210locale_ref3getISt6localeEET_v.exit
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #28
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #28
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !128, !noalias !494
  %i.h = getelementptr inbounds nuw i8, ptr %i.g, i64 32
  %i.i = load ptr, ptr %i.h, align 8, !noalias !494
  call void %i.i(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %3, ptr noundef nonnull align 8 dereferenceable(24) %i.f), !inline_history !224
...
bb.e:                                             ; preds = %_ZSt9use_facetINSt7__cxx118numpunctIcEEERKT_RKSt6locale.exit
  %i.m = load ptr, ptr %i.f, align 8, !tbaa !128
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 24
  %i.o = load ptr, ptr %i.n, align 8
  %i.p = invoke noundef signext i8 %i.o(ptr noundef nonnull align 8 dereferenceable(24) %i.f)
          to label %_ZNKSt7__cxx118numpunctIcE13thousands_sepEv.exit unwind label %bb.h, !inline_history !225
...
_ZNKSt7__cxx118numpunctIcE13thousands_sepEv.exit: ; preds = %bb.e, %_ZSt9use_facetINSt7__cxx118numpunctIcEEERKT_RKSt6locale.exit
  ...
  store ptr %i.r, ptr %0, align 8, !tbaa !66
  %i.s = load ptr, ptr %3, align 8, !tbaa !44     ; 2 uses
...
bb.f:                                             ; preds = %_ZNKSt7__cxx118numpunctIcE13thousands_sepEv.exit
  %i.v = load i64, ptr %i.j, align 8, !tbaa !67   ; 3 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i: ; preds = %_ZNKSt7__cxx118numpunctIcE13thousands_sepEv.exit
  ...
  %i.y = load i64, ptr %i.t, align 8, !tbaa !47
  store i64 %i.y, ptr %i.r, align 8, !tbaa !47
  %.pre = load i64, ptr %i.j, align 8, !tbaa !67
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.f, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i
  ...
  store i8 %i.q, ptr %i.ab, align 8, !tbaa !492
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #28
  ret void
...
bb.h:                                             ; preds = %bb.e
  %i.ad = landingpad { ptr, i32 }
          cleanup
  %i.ae = load ptr, ptr %3, align 8, !tbaa !44    ; 2 uses
...
.lr.ph34.i.i.i:                                   ; preds = %bb.b
  ...
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.pre.i.i.i = load i64, ptr %i.e, align 8, !tbaa !116
  br label %bb.c
...
bb.c:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.j = load i64, ptr %i.f, align 8, !tbaa !115
  %i.k = sub i64 %i.j, %i.i
...
bb.d:                                             ; preds = %bb.c
  %i.o = load ptr, ptr %i.h, align 8, !tbaa !106
  %i.p = add i64 %i.m, %i.i
  tail call void %i.o(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.p), !inline_history !497
  %i.q = load i64, ptr %i.e, align 8, !tbaa !116  ; 2 uses
  %i.r = load i64, ptr %i.f, align 8, !tbaa !115
  %i.s = sub i64 %i.r, %i.q
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.u = load ptr, ptr %0, align 8, !tbaa !114    ; 2 uses
...
vector.body79:                                    ; preds = %vector.body79, %vector.ph76
  ...
  %wide.load81 = load <16 x i8>, ptr %i.z, align 1, !tbaa !47
  %wide.load82 = load <16 x i8>, ptr %i.aa, align 1, !tbaa !47
  %i.ab = getelementptr inbounds nuw i8, ptr %i.w, i64 %index80 ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 16
  store <16 x i8> %wide.load81, ptr %i.ab, align 1, !tbaa !47
  store <16 x i8> %wide.load82, ptr %i.ac, align 1, !tbaa !47
  %index.next83 = add nuw i64 %index80, 32        ; 2 uses
  %i.ad = icmp eq i64 %index.next83, %n.vec78
  br i1 %i.ad, label %middle.block84, label %vector.body79, !llvm.loop !498
...
vec.epilog.iter.check89:                          ; preds = %middle.block84
  ...
  br i1 %min.epilog.iters.check90, label %.lr.ph.i.i.i.preheader, label %vec.epilog.ph91, !prof !186
...
vec.epilog.vector.body94:                         ; preds = %vec.epilog.vector.body94, %vec.epilog.ph91
  ...
  %wide.load96 = load <4 x i8>, ptr %i.ae, align 1, !tbaa !47
  %i.af = getelementptr inbounds nuw i8, ptr %i.w, i64 %index95
  store <4 x i8> %wide.load96, ptr %i.af, align 1, !tbaa !47
  %index.next97 = add nuw i64 %index95, 4         ; 2 uses
  %i.ag = icmp eq i64 %index.next97, %n.vec93
  br i1 %i.ag, label %vec.epilog.middle.block98, label %vec.epilog.vector.body94, !llvm.loop !499
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %i.ai = load i8, ptr %i.ah, align 1, !tbaa !47
  ...
  br i1 %prol.iter103.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !500
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block98, %middle.block84
  %.pre37.i.i.i = load i64, ptr %i.e, align 8, !tbaa !116
  br label %._crit_edge.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.e
  ...
  store i64 %i.ao, ptr %i.e, align 8, !tbaa !116
  %i.ap = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.ap, %i.d
  br i1 %.not.i.i.i, label %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit, label %bb.c, !llvm.loop !189
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !501
...
bb.f:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %.lr.ph.i
  ...
  %i.bk = load i64, ptr %i.bh, align 8, !tbaa !116 ; 2 uses
  %i.bl = add i64 %i.bk, 1                        ; 3 uses
  %i.bm = load i64, ptr %i.bi, align 8, !tbaa !115
  %i.bn = icmp ugt i64 %i.bl, %i.bm
  br i1 %i.bn, label %bb.g, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i

bb.g:                                             ; preds = %bb.f
  %i.bo = load ptr, ptr %i.bj, align 8, !tbaa !106
  tail call void %i.bo(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.bl), !inline_history !335
  %.pre.i.i.i18 = load i64, ptr %i.bh, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.g, %bb.f
  ...
  store i64 %.pre-phi.i.i.i, ptr %i.bh, align 8, !tbaa !116
  %i.br = getelementptr inbounds nuw i8, ptr %i.bq, i64 %i.bp
  store i8 48, ptr %i.br, align 1, !tbaa !47
  %i.bs = add nuw nsw i32 %.04.i, 1               ; 2 uses
  %exitcond.not.i = icmp eq i32 %i.bs, %3
  br i1 %exitcond.not.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit, label %bb.f, !llvm.loop !331
...
bb.h:                                             ; preds = %bb.a
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIcLm500ENS0_6detail9allocatorIcEEE4growERNS2_6bufferIcEEm, ptr %i.bu, align 8, !tbaa !106
  %i.bw = getelementptr inbounds nuw i8, ptr %5, i64 32 ; 3 uses
  store ptr %i.bw, ptr %5, align 8, !tbaa !114
  store i64 500, ptr %i.bt, align 8, !tbaa !115
...
bb.i:                                             ; preds = %._crit_edge.i.i.i31, %.lr.ph34.i.i.i20
  ...
  %i.cb = load i64, ptr %i.bt, align 8, !tbaa !115
...
bb.j:                                             ; preds = %bb.i
  %i.cg = load ptr, ptr %i.bu, align 8, !tbaa !106
  %i.ch = add i64 %i.ce, %i.ca
  invoke void %i.cg(ptr noundef nonnull align 8 dereferenceable(32) %5, i64 noundef %i.ch)
          to label %.noexc unwind label %.loopexit, !inline_history !502

.noexc:                                           ; preds = %bb.j
  %i.ci = load i64, ptr %i.bv, align 8, !tbaa !116 ; 2 uses
  %i.cj = load i64, ptr %i.bt, align 8, !tbaa !115
...
bb.k:                                             ; preds = %.noexc, %bb.i
  ...
  %i.cm = load ptr, ptr %5, align 8, !tbaa !114   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.cr, align 1, !tbaa !47
  %wide.load64 = load <16 x i8>, ptr %i.cs, align 1, !tbaa !47
  %i.ct = getelementptr inbounds nuw i8, ptr %i.co, i64 %index ; 2 uses
  %i.cu = getelementptr inbounds nuw i8, ptr %i.ct, i64 16
  store <16 x i8> %wide.load, ptr %i.ct, align 1, !tbaa !47
  store <16 x i8> %wide.load64, ptr %i.cu, align 1, !tbaa !47
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.cv = icmp eq i64 %index.next, %n.vec
  br i1 %i.cv, label %middle.block, label %vector.body, !llvm.loop !503
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf, 0
  br i1 %min.epilog.iters.check, label %.lr.ph.i.i.i26.preheader, label %vec.epilog.ph, !prof !186
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load68 = load <4 x i8>, ptr %i.cw, align 1, !tbaa !47
  %i.cx = getelementptr inbounds nuw i8, ptr %i.co, i64 %index67
  store <4 x i8> %wide.load68, ptr %i.cx, align 1, !tbaa !47
  %index.next69 = add nuw i64 %index67, 4         ; 2 uses
  %i.cy = icmp eq i64 %index.next69, %n.vec66
  br i1 %i.cy, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !504
...
.lr.ph.i.i.i26.prol:                              ; preds = %.lr.ph.i.i.i26.preheader, %.lr.ph.i.i.i26.prol
  ...
  store i8 %i.da, ptr %i.db, align 1, !tbaa !47
  %i.dc = add nuw i64 %.030.i.i.i27.prol, 1       ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i26.prol.loopexit, label %.lr.ph.i.i.i26.prol, !llvm.loop !505
...
._crit_edge.loopexit.i.i.i29:                     ; preds = %.lr.ph.i.i.i26.prol.loopexit, %.lr.ph.i.i.i26, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i30 = load i64, ptr %i.bv, align 8, !tbaa !116
...
._crit_edge.i.i.i31:                              ; preds = %._crit_edge.loopexit.i.i.i29, %bb.k
  ...
  store i64 %i.dg, ptr %i.bv, align 8, !tbaa !116
  %i.dh = getelementptr inbounds nuw i8, ptr %.02532.i.i.i22, i64 %.026.i.i.i24 ; 2 uses
  %.not.i.i.i32 = icmp eq ptr %i.dh, %i.by
  br i1 %.not.i.i.i32, label %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit33, label %bb.i, !llvm.loop !189
...
.lr.ph.i.i.i26:                                   ; preds = %.lr.ph.i.i.i26.prol.loopexit, %.lr.ph.i.i.i26
  ...
  %i.dj = load i8, ptr %i.di, align 1, !tbaa !47
  %i.dk = getelementptr inbounds nuw i8, ptr %i.co, i64 %.030.i.i.i27
  store i8 %i.dj, ptr %i.dk, align 1, !tbaa !47
  ...
  store i8 %i.dn, ptr %i.do, align 1, !tbaa !47
  ...
  store i8 %i.dr, ptr %i.ds, align 1, !tbaa !47
  ...
  br i1 %exitcond.not.i.i.i28.3, label %._crit_edge.loopexit.i.i.i29, label %.lr.ph.i.i.i26, !llvm.loop !506
...
.lr.ph.i34:                                       ; preds = %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit33, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i36
  ...
  %i.ea = load i64, ptr %i.bv, align 8, !tbaa !116 ; 2 uses
  %i.eb = add i64 %i.ea, 1                        ; 3 uses
  %i.ec = load i64, ptr %i.bt, align 8, !tbaa !115
  %i.ed = icmp ugt i64 %i.eb, %i.ec
  br i1 %i.ed, label %bb.l, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i36

bb.l:                                             ; preds = %.lr.ph.i34
  %i.ee = load ptr, ptr %i.bu, align 8, !tbaa !106
  invoke void %i.ee(ptr noundef nonnull align 8 dereferenceable(32) %5, i64 noundef %i.eb)
          to label %.noexc41 unwind label %bb.o, !inline_history !507

.noexc41:                                         ; preds = %bb.l
  %.pre.i.i.i39 = load i64, ptr %i.bv, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i36:      ; preds = %.noexc41, %.lr.ph.i34
  ...
  %i.eg = load ptr, ptr %5, align 8, !tbaa !114
  store i64 %.pre-phi.i.i.i37, ptr %i.bv, align 8, !tbaa !116
  %i.eh = getelementptr inbounds nuw i8, ptr %i.eg, i64 %i.ef
  store i8 48, ptr %i.eh, align 1, !tbaa !47
  %i.ei = add nuw nsw i32 %.04.i35, 1             ; 2 uses
  %exitcond.not.i38 = icmp eq i32 %i.ei, %3
  br i1 %exitcond.not.i38, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42.loopexit, label %.lr.ph.i34, !llvm.loop !331
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42.loopexit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i36
  %.pre = load i64, ptr %i.bv, align 8, !tbaa !116
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42: ; preds = %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42.loopexit, %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit33
  ...
  %i.ek = load ptr, ptr %5, align 8, !tbaa !114
...
bb.m:                                             ; preds = %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42
  %i.em = load ptr, ptr %5, align 8, !tbaa !114   ; 2 uses
...
bb.p:                                             ; preds = %.loopexit, %.loopexit.split-lp, %bb.o
  ...
  %i.eo = load ptr, ptr %5, align 8, !tbaa !114   ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !106
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(32) %i.e, i64 noundef %i.h), !inline_history !488
  %.pre.i.i.i = load i64, ptr %i.f, align 8, !tbaa !116 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.d, %bb.c
  ...
  %i.o = load ptr, ptr %i.e, align 8, !tbaa !114
  store i64 %.pre-phi.i.i.i, ptr %i.f, align 8, !tbaa !116
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 %i.n
  store i8 %4, ptr %i.p, align 1, !tbaa !47
...
bb.e:                                             ; preds = %bb.a
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIcLm500ENS0_6detail9allocatorIcEEE4growERNS2_6bufferIcEEm, ptr %i.u, align 8, !tbaa !106
  %i.w = getelementptr inbounds nuw i8, ptr %6, i64 32 ; 3 uses
  store ptr %i.w, ptr %6, align 8, !tbaa !114
  store i64 500, ptr %i.t, align 8, !tbaa !115
...
bb.f:                                             ; preds = %.noexc
  ...
  %i.ae = load i64, ptr %i.ad, align 8, !tbaa !115
...
bb.g:                                             ; preds = %bb.f
  ...
  invoke void %i.ah(ptr noundef nonnull align 8 dereferenceable(32) %i.z, i64 noundef %i.ac)
          to label %.noexc25 unwind label %bb.k, !inline_history !518

.noexc25:                                         ; preds = %bb.g
  %.pre.i.i.i23 = load i64, ptr %i.aa, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i20:      ; preds = %.noexc25, %bb.f
  ...
  %i.aj = load ptr, ptr %i.z, align 8, !tbaa !114
  store i64 %.pre-phi.i.i.i21, ptr %i.aa, align 8, !tbaa !116
  %i.ak = getelementptr inbounds nuw i8, ptr %i.aj, i64 %i.ai
  store i8 %4, ptr %i.ak, align 1, !tbaa !47
...
_ZN3fmt3v126detail17write_significandINS0_14basic_appenderIcEEcEET_S5_PKciiT0_.exit27: ; preds = %.noexc, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i20
  %i.ao = load ptr, ptr %6, align 8, !tbaa !114
...
bb.h:                                             ; preds = %_ZN3fmt3v126detail17write_significandINS0_14basic_appenderIcEEcEET_S5_PKciiT0_.exit27
  %i.ar = load ptr, ptr %6, align 8, !tbaa !114   ; 2 uses
  %i.as = getelementptr inbounds i8, ptr %i.ar, i64 %i.x
  %i.at = load i64, ptr %i.v, align 8, !tbaa !116
...
bb.i:                                             ; preds = %bb.h
  %i.aw = load ptr, ptr %6, align 8, !tbaa !114   ; 2 uses
...
bb.k:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i20, %bb.g, %bb.e, %bb.h, %_ZN3fmt3v126detail17write_significandINS0_14basic_appenderIcEEcEET_S5_PKciiT0_.exit27
  %i.ax = landingpad { ptr, i32 }
          cleanup
  %i.ay = load ptr, ptr %6, align 8, !tbaa !114   ; 2 uses
...
; Function Attrs: mustprogress noinline uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail13copy_noinlineIcPKcNS0_14basic_appenderIcEEEET1_T0_S8_S7_(ptr noundef %0, ptr noundef %1, ptr %2) local_unnamed_addr #19 {
bb.a:
  %.not31.i.i = icmp eq ptr %0, %1
  br i1 %.not31.i.i, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit, label %.lr.ph34.i.i
...
bb.c:                                             ; preds = %bb.b
  %i.k = load ptr, ptr %i.d, align 8, !tbaa !106
  %i.l = add i64 %i.i, %i.e
  tail call void %i.k(ptr noundef nonnull align 8 dereferenceable(32) %2, i64 noundef %i.l), !inline_history !211
  %i.m = load i64, ptr %i.a, align 8, !tbaa !116  ; 2 uses
  %i.n = load i64, ptr %i.b, align 8, !tbaa !115
  %i.o = sub i64 %i.n, %i.m
  %i.p = tail call i64 @llvm.umin.i64(i64 %i.i, i64 %i.o)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.z = icmp eq i64 %index.next, %n.vec
  br i1 %i.z, label %middle.block, label %vector.body, !llvm.loop !519
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %index.next13 = add nuw i64 %index11, 4         ; 2 uses
  %i.ac = icmp eq i64 %index.next13, %n.vec10
  br i1 %i.ac, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !520
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !521
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.d
  ...
  %i.al = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i = icmp eq ptr %i.al, %1
  br i1 %.not.i.i, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit, label %bb.b, !llvm.loop !189
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  %i.bb = add nuw i64 %.030.i.i, 4                ; 2 uses
  %exitcond.not.i.i.3 = icmp eq i64 %i.bb, %.026.i.i
  br i1 %exitcond.not.i.i.3, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !522
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden ptr @_ZZN3fmt3v126detail11write_fixedIcNS1_14digit_groupingIcEENS0_14basic_appenderIcEENS1_14big_decimal_fpEEET1_S8_RKT2_iT_RKNS0_12format_specsENS0_4signENS0_10locale_refEENKUlS6_E1_clES6_(ptr noundef nonnull align 8 dereferenceable(48) %0, ptr %1) local_unnamed_addr #10 align 2 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !523, !nonnull !83, !align !234
  %i.b = load i32, ptr %i.a, align 4, !tbaa !307  ; 2 uses
  %.not = icmp eq i32 %i.b, 0
  br i1 %.not, label %bb.d, label %bb.b
...
bb.d:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit, %bb.a
  ...
  %i.r = load i64, ptr %i.q, align 8, !tbaa !116  ; 2 uses
  %i.s = add i64 %i.r, 1                          ; 3 uses
  %i.t = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 5 uses
  %i.u = load i64, ptr %i.t, align 8, !tbaa !115
...
bb.e:                                             ; preds = %bb.d
  ...
  tail call void %i.x(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.s), !inline_history !183
  %.pre.i.i6 = load i64, ptr %i.q, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit8:         ; preds = %bb.d, %bb.e
  ...
  %i.z = load ptr, ptr %1, align 8, !tbaa !114
  store i64 %.pre-phi.i.i5, ptr %i.q, align 8, !tbaa !116
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 %i.y
  store i8 48, ptr %i.aa, align 1, !tbaa !47
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !525, !nonnull !83
  %i.ad = load i8, ptr %i.ac, align 1, !tbaa !315, !range !82, !noundef !83
...
bb.f:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit8
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !526, !nonnull !83
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !47
  %i.ai = load i64, ptr %i.q, align 8, !tbaa !116 ; 2 uses
  %i.aj = add i64 %i.ai, 1                        ; 3 uses
  %i.ak = load i64, ptr %i.t, align 8, !tbaa !115
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.an = load ptr, ptr %i.am, align 8, !tbaa !106
  tail call void %i.an(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.aj), !inline_history !183
  %.pre.i.i11 = load i64, ptr %i.q, align 8, !tbaa !116 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit13:        ; preds = %bb.f, %bb.g
  ...
  %i.ap = load ptr, ptr %1, align 8, !tbaa !114
  store i64 %.pre-phi.i.i10, ptr %i.q, align 8, !tbaa !116
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 %i.ao
  store i8 %i.ah, ptr %i.aq, align 1, !tbaa !47
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !527, !nonnull !83, !align !234
...
bb.h:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %.lr.ph.i
  ...
  %i.aw = load i64, ptr %i.q, align 8, !tbaa !116 ; 2 uses
  %i.ax = add i64 %i.aw, 1                        ; 3 uses
  %i.ay = load i64, ptr %i.t, align 8, !tbaa !115
  %i.az = icmp ugt i64 %i.ax, %i.ay
  br i1 %i.az, label %bb.i, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i

bb.i:                                             ; preds = %bb.h
  %i.ba = load ptr, ptr %i.av, align 8, !tbaa !106
  tail call void %i.ba(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.ax), !inline_history !335
  %.pre.i.i.i = load i64, ptr %i.q, align 8, !tbaa !116 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.i, %bb.h
  ...
  %i.bc = load ptr, ptr %1, align 8, !tbaa !114
  store i64 %.pre-phi.i.i.i, ptr %i.q, align 8, !tbaa !116
  %i.bd = getelementptr inbounds nuw i8, ptr %i.bc, i64 %i.bb
  store i8 48, ptr %i.bd, align 1, !tbaa !47
  %i.be = add nuw nsw i32 %.04.i, 1               ; 2 uses
  %exitcond.not.i = icmp eq i32 %i.be, %i.at
  br i1 %exitcond.not.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit, label %bb.h, !llvm.loop !331
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit13
  ...
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !528, !nonnull !83, !align !255
  %i.bh = load ptr, ptr %i.bg, align 8, !tbaa !386 ; 2 uses
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !529, !nonnull !83, !align !234
...
.lr.ph34.i.i.i:                                   ; preds = %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit
  ...
  %.pre.i.i.i14 = load i64, ptr %i.q, align 8, !tbaa !116
  br label %bb.j
...
bb.j:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.bq = load i64, ptr %i.t, align 8, !tbaa !115
...
bb.k:                                             ; preds = %bb.j
  %i.bv = load ptr, ptr %i.bo, align 8, !tbaa !106
  %i.bw = add i64 %i.bt, %i.bp
  tail call void %i.bv(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.bw), !inline_history !497
  %i.bx = load i64, ptr %i.q, align 8, !tbaa !116 ; 2 uses
  %i.by = load i64, ptr %i.t, align 8, !tbaa !115
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.cb = load ptr, ptr %1, align 8, !tbaa !114   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.cg, align 1, !tbaa !47
  %wide.load31 = load <16 x i8>, ptr %i.ch, align 1, !tbaa !47
  %i.ci = getelementptr inbounds nuw i8, ptr %i.cd, i64 %index ; 2 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 16
  store <16 x i8> %wide.load, ptr %i.ci, align 1, !tbaa !47
  store <16 x i8> %wide.load31, ptr %i.cj, align 1, !tbaa !47
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ck = icmp eq i64 %index.next, %n.vec
  br i1 %i.ck, label %middle.block, label %vector.body, !llvm.loop !530
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load35 = load <4 x i8>, ptr %i.cl, align 1, !tbaa !47
  %i.cm = getelementptr inbounds nuw i8, ptr %i.cd, i64 %index34
  store <4 x i8> %wide.load35, ptr %i.cm, align 1, !tbaa !47
  %index.next36 = add nuw i64 %index34, 4         ; 2 uses
  %i.cn = icmp eq i64 %index.next36, %n.vec33
  br i1 %i.cn, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !531
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  store i8 %i.cp, ptr %i.cq, align 1, !tbaa !47
  %i.cr = add nuw i64 %.030.i.i.i.prol, 1         ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !532
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.q, align 8, !tbaa !116
  br label %._crit_edge.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.l
  ...
  store i64 %i.cv, ptr %i.q, align 8, !tbaa !116
  %i.cw = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.cw, %i.bm
  br i1 %.not.i.i.i, label %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit, label %bb.j, !llvm.loop !189
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  store i8 %i.cy, ptr %i.cz, align 1, !tbaa !47
...
.split.i.i:                                       ; preds = %.split.i.i, %bb.d
  ...
  store i8 %i.ab, ptr %i.ac, align 1, !tbaa !47
  %i.ad = lshr i64 %.012.i.i, 4                   ; 2 uses
  %.not.i.i = icmp eq i64 %i.ad, 0
  br i1 %.not.i.i, label %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit.preheader, label %.split.i.i, !llvm.loop !241
...
_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit: ; preds = %.lr.ph
  ...
  br i1 %.not89, label %.critedge, label %.lr.ph, !llvm.loop !596
...
.critedge:                                        ; preds = %.lr.ph, %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit, %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit.preheader
  ...
  %i.ak = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
...
bb.e:                                             ; preds = %.critedge
  ...
  tail call void %i.aq(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.al), !inline_history !391
  %.pre.i = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %.pre2.i = add i64 %.pre.i, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit:  ; preds = %.critedge, %bb.e
  ...
  %i.as = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i, ptr %i.aj, align 8, !tbaa !116
  %i.at = getelementptr inbounds nuw i8, ptr %i.as, i64 %i.ar
  store i8 48, ptr %i.at, align 1, !tbaa !47
  %i.au = select i1 %.not88, i8 120, i8 88
  %i.av = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %i.aw = add i64 %i.av, 1                        ; 3 uses
  %i.ax = load i64, ptr %i.am, align 8, !tbaa !115
...
bb.f:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit
  ...
  tail call void %i.ba(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.aw), !inline_history !391
  %.pre.i40 = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %.pre2.i41 = add i64 %.pre.i40, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit, %bb.f
  ...
  %i.bc = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i39, ptr %i.aj, align 8, !tbaa !116
  %i.bd = getelementptr inbounds nuw i8, ptr %i.bc, i64 %i.bb
  store i8 %i.au, ptr %i.bd, align 1, !tbaa !47
  %i.be = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %i.bf = add i64 %i.be, 1                        ; 3 uses
  %i.bg = load i64, ptr %i.am, align 8, !tbaa !115
...
bb.g:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42
  ...
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !106
  tail call void %i.bj(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bf), !inline_history !391
  %.pre.i44 = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %.pre2.i45 = add i64 %.pre.i44, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42, %bb.g
  ...
  %i.bl = load i8, ptr %i.a, align 16, !tbaa !47
  %i.bm = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i43, ptr %i.aj, align 8, !tbaa !116
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 %i.bk
  store i8 %i.bl, ptr %i.bn, align 1, !tbaa !47
...
bb.h:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46
  %i.br = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %i.bs = add i64 %i.br, 1                        ; 3 uses
  %i.bt = load i64, ptr %i.am, align 8, !tbaa !115
...
bb.i:                                             ; preds = %bb.h
  ...
  tail call void %i.bw(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bs), !inline_history !391
  %.pre.i48 = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %.pre2.i49 = add i64 %.pre.i48, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit50
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit50: ; preds = %bb.h, %bb.i
  ...
  %i.by = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i47, ptr %i.aj, align 8, !tbaa !116
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 %i.bx
  store i8 46, ptr %i.bz, align 1, !tbaa !47
  br label %bb.j
...
.lr.ph34.i:                                       ; preds = %bb.j
  ...
  %.pre.i51 = load i64, ptr %i.aj, align 8, !tbaa !116
  br label %bb.k
...
bb.k:                                             ; preds = %._crit_edge.i, %.lr.ph34.i
  ...
  %i.cg = load i64, ptr %i.am, align 8, !tbaa !115
...
bb.l:                                             ; preds = %bb.k
  %i.cl = load ptr, ptr %i.ce, align 8, !tbaa !106
  %i.cm = add i64 %i.cj, %i.cf
  call void %i.cl(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.cm), !inline_history !392
  %i.cn = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %i.co = load i64, ptr %i.am, align 8, !tbaa !115
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.cr = load ptr, ptr %3, align 8, !tbaa !114   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.cw, align 1, !tbaa !47
  %wide.load118 = load <16 x i8>, ptr %i.cx, align 1, !tbaa !47
  %i.cy = getelementptr inbounds nuw i8, ptr %i.ct, i64 %index ; 2 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %i.cy, i64 16
  store <16 x i8> %wide.load, ptr %i.cy, align 1, !tbaa !47
  store <16 x i8> %wide.load118, ptr %i.cz, align 1, !tbaa !47
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.da = icmp eq i64 %index.next, %n.vec
  br i1 %i.da, label %middle.block, label %vector.body, !llvm.loop !597
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load122 = load <4 x i8>, ptr %i.db, align 1, !tbaa !47
  %i.dc = getelementptr inbounds nuw i8, ptr %i.ct, i64 %index121
  store <4 x i8> %wide.load122, ptr %i.dc, align 1, !tbaa !47
  %index.next123 = add nuw i64 %index121, 4       ; 2 uses
  %i.dd = icmp eq i64 %index.next123, %n.vec120
  br i1 %i.dd, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !598
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  store i8 %i.df, ptr %i.dg, align 1, !tbaa !47
...
._crit_edge.loopexit.i:                           ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i = load i64, ptr %i.aj, align 8, !tbaa !116
  br label %._crit_edge.i
...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.m
  ...
  store i64 %i.dl, ptr %i.aj, align 8, !tbaa !116
  %i.dm = getelementptr inbounds nuw i8, ptr %.02532.i, i64 %.026.i ; 2 uses
  %.not.i = icmp eq ptr %i.dm, %i.cc
  br i1 %.not.i, label %_ZN3fmt3v126detail6bufferIcE6appendIcEEvPKT_S7_.exit, label %bb.k, !llvm.loop !189
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  store i8 %i.dw, ptr %i.dx, align 1, !tbaa !47
  ...
  br i1 %exitcond.not.i.3, label %._crit_edge.loopexit.i, label %.lr.ph.i, !llvm.loop !600
...
bb.n:                                             ; preds = %.lr.ph94, %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55
  ...
  %i.ee = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %i.ef = add i64 %i.ee, 1                        ; 3 uses
  %i.eg = load i64, ptr %i.am, align 8, !tbaa !115
...
bb.o:                                             ; preds = %bb.n
  ...
  call void %i.ei(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ef), !inline_history !391
  %.pre.i53 = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %.pre2.i54 = add i64 %.pre.i53, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55: ; preds = %bb.n, %bb.o
  ...
  %i.ek = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i52, ptr %i.aj, align 8, !tbaa !116
  %i.el = getelementptr inbounds nuw i8, ptr %i.ek, i64 %i.ej
  store i8 48, ptr %i.el, align 1, !tbaa !47
  %i.em = add i32 %.293, 1                        ; 2 uses
  %exitcond.not = icmp eq i32 %i.em, %.sroa.6.8.extract.trunc
  br i1 %exitcond.not, label %._crit_edge, label %bb.n, !llvm.loop !601

._crit_edge:                                      ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55, %_ZN3fmt3v126detail6bufferIcE6appendIcEEvPKT_S7_.exit
  %i.en = select i1 %.not88, i8 112, i8 80
  %i.eo = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %i.ep = add i64 %i.eo, 1                        ; 3 uses
  %i.eq = load i64, ptr %i.am, align 8, !tbaa !115
...
bb.p:                                             ; preds = %._crit_edge
  ...
  call void %i.et(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ep), !inline_history !391
  %.pre.i57 = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %.pre2.i58 = add i64 %.pre.i57, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit59
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit59: ; preds = %._crit_edge, %bb.p
  ...
  %i.ev = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i56, ptr %i.aj, align 8, !tbaa !116
  %i.ew = getelementptr inbounds nuw i8, ptr %i.ev, i64 %i.eu
  store i8 %i.en, ptr %i.ew, align 1, !tbaa !47
  %i.ex = icmp slt i32 %i.j, 0
  %i.ey = load i64, ptr %i.aj, align 8, !tbaa !116 ; 3 uses
  %i.ez = add i64 %i.ey, 1                        ; 5 uses
  %i.fa = load i64, ptr %i.am, align 8, !tbaa !115
...
bb.r:                                             ; preds = %bb.q
  ...
  %i.fd = load ptr, ptr %i.fc, align 8, !tbaa !106
  call void %i.fd(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ez), !inline_history !391
  %.pre.i61 = load i64, ptr %i.aj, align 8, !tbaa !116 ; 2 uses
  %.pre2.i62 = add i64 %.pre.i61, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit63
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit63: ; preds = %bb.q, %bb.r
  ...
  %i.ff = load ptr, ptr %3, align 8, !tbaa !114
  store i64 %.pre-phi.i60, ptr %i.aj, align 8, !tbaa !116
  %i.fg = getelementptr inbounds nuw i8, ptr %i.ff, i64 %i.fe
  store i8 45, ptr %i.fg, align 1, !tbaa !47
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit8:         ; preds = %bb.d, %bb.e
  ...
  store i8 48, ptr %i.aa, align 1, !tbaa !47
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !661, !nonnull !83
  %i.ad = load i8, ptr %i.ac, align 1, !tbaa !315, !range !82, !noundef !83
  %i.ae = trunc nuw i8 %i.ad to i1
...
bb.f:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit8
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !662, !nonnull !83
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !47
  %i.ai = load i64, ptr %i.q, align 8, !tbaa !116 ; 2 uses
  %i.aj = add i64 %i.ai, 1                        ; 3 uses
  %i.ak = load i64, ptr %i.t, align 8, !tbaa !115
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit13:        ; preds = %bb.f, %bb.g
  ...
  store i8 %i.ah, ptr %i.aq, align 1, !tbaa !47
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !663, !nonnull !83, !align !234
  %i.at = load i32, ptr %i.as, align 4, !tbaa !3  ; 2 uses
  %i.au = icmp sgt i32 %i.at, 0
  br i1 %i.au, label %.lr.ph.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit13
  %i.bf = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !664, !nonnull !83, !align !255
  %i.bh = load i64, ptr %i.bg, align 8, !tbaa !363
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !665, !nonnull !83, !align !234
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #28
  %i.f = load i32, ptr %3, align 4, !tbaa !159
  %i.g = and i32 %i.f, 7
  %i.h = icmp eq i32 %i.g, 1                      ; 3 uses
  %i.i = zext i1 %i.h to i8
  store i8 %i.i, ptr %i.a, align 1, !tbaa !315
  %i.j = getelementptr inbounds nuw i8, ptr %3, i64 12
  %i.k = load i32, ptr %i.j, align 4, !tbaa !161  ; 3 uses
  %i.l = icmp slt i32 %i.k, 0
  br i1 %i.l, label %bb.b, label %bb.j

bb.b:                                             ; preds = %bb.a
  %i.m = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.n = load i32, ptr %i.m, align 4, !tbaa !209
...
bb.d:                                             ; preds = %bb.c
  ...
  tail call void %i.w(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.r), !inline_history !210
  br label %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
...
.lr.ph34.i.i.i:                                   ; preds = %bb.f
  ...
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.pre.i.i.i = load i64, ptr %i.p, align 8, !tbaa !116
  br label %bb.g
...
bb.g:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.ac = load i64, ptr %i.s, align 8, !tbaa !115
...
bb.h:                                             ; preds = %bb.g
  %i.ah = load ptr, ptr %i.aa, align 8, !tbaa !106
  %i.ai = add i64 %i.af, %i.ab
  tail call void %i.ah(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.ai), !inline_history !666
  %i.aj = load i64, ptr %i.p, align 8, !tbaa !116 ; 2 uses
  %i.ak = load i64, ptr %i.s, align 8, !tbaa !115
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  %i.an = load ptr, ptr %0, align 8, !tbaa !114   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.as, align 1, !tbaa !47
  %wide.load27 = load <16 x i8>, ptr %i.at, align 1, !tbaa !47
  %i.au = getelementptr inbounds nuw i8, ptr %i.ap, i64 %index ; 2 uses
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 16
  store <16 x i8> %wide.load, ptr %i.au, align 1, !tbaa !47
  store <16 x i8> %wide.load27, ptr %i.av, align 1, !tbaa !47
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.aw = icmp eq i64 %index.next, %n.vec
  br i1 %i.aw, label %middle.block, label %vector.body, !llvm.loop !667
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load31 = load <4 x i8>, ptr %i.ax, align 1, !tbaa !47
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ap, i64 %index30
  store <4 x i8> %wide.load31, ptr %i.ay, align 1, !tbaa !47
  %index.next32 = add nuw i64 %index30, 4         ; 2 uses
  %i.az = icmp eq i64 %index.next32, %n.vec29
  br i1 %i.az, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !668
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  store i8 %i.bb, ptr %i.bc, align 1, !tbaa !47
  %i.bd = add nuw i64 %.030.i.i.i.prol, 1         ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !669
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.p, align 8, !tbaa !116
  br label %._crit_edge.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.i
  ...
  store i64 %i.bh, ptr %i.p, align 8, !tbaa !116
  %i.bi = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.bi, %i.y
  br i1 %.not.i.i.i, label %_ZN3fmt3v126detail4copyIccNS0_14basic_appenderIcEEEET1_NS0_17basic_string_viewIT0_EES5_.exit, label %bb.g, !llvm.loop !189
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !670
...
bb.k:                                             ; preds = %.thread, %bb.j
  ...
  store i64 %i.ca, ptr %i.b, align 8, !tbaa !53
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #28
  %i.cb = icmp ne i32 %i.k, 0
  %narrow = and i1 %i.h, %i.cb
  %.sink = zext i1 %narrow to i64                 ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d) #28
  store i64 %.sink, ptr %i.c, align 8, !tbaa !53
  store i64 %.sink, ptr %i.d, align 8, !tbaa !53
  store ptr %i.a, ptr %5, align 8, !tbaa !316
  %i.cc = getelementptr inbounds nuw i8, ptr %5, i64 8
  store ptr %i.c, ptr %i.cc, align 8, !tbaa !671
  %i.cd = getelementptr inbounds nuw i8, ptr %5, i64 16
  store ptr %i.b, ptr %i.cd, align 8, !tbaa !671
  %i.ce = getelementptr inbounds nuw i8, ptr %5, i64 24
  store ptr %i.d, ptr %i.ce, align 8, !tbaa !671
  %i.cf = getelementptr inbounds nuw i8, ptr %5, i64 32
  store ptr %4, ptr %i.cf, align 8, !tbaa !673
  ...
  %i.cg = load i64, ptr %i.d, align 8, !tbaa !53  ; 2 uses
  %i.ch = load i64, ptr %i.c, align 8, !tbaa !53
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #28
  %i.ci = load i8, ptr %i.a, align 1, !tbaa !315, !range !82, !noundef !83
  store i8 %i.ci, ptr %6, align 8, !tbaa !675
  %i.cj = getelementptr inbounds nuw i8, ptr %6, i64 8
  store i64 %i.cg, ptr %i.cj, align 8, !tbaa !677
  %i.ck = getelementptr inbounds nuw i8, ptr %6, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ck, ptr noundef nonnull align 8 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !678
...
bb.a:
  ...
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  %i.b = load i64, ptr %i.a, align 8, !tbaa !116  ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void %i.h(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.c), !inline_history !183
  %.pre.i.i = load i64, ptr %i.a, align 8, !tbaa !116 ; 2 uses
  %.pre2.i.i = add i64 %.pre.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit:          ; preds = %bb.a, %bb.b
  ...
  store i64 %.pre-phi.i.i, ptr %i.a, align 8, !tbaa !116
...
bb.c:                                             ; preds = %bb.g, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #28
  store ptr %i.l, ptr %3, align 8, !tbaa !265, !alias.scope !679
  store ptr null, ptr %i.m, align 8, !tbaa !267, !alias.scope !679
  store i32 0, ptr %i.n, align 8, !tbaa !268, !alias.scope !679
  ...
  %i.r = load ptr, ptr %3, align 8, !tbaa !265    ; 3 uses
...
bb.a:
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #28
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %3, ptr noundef nonnull align 8 dereferenceable(40) %2, i64 40, i1 false), !tbaa.struct !687
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.k = getelementptr inbounds nuw i8, ptr @.str.61, i64 %i.j
  ...
  br i1 %i.bp, label %bb.c, label %.thread, !llvm.loop !688
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load50 = load <16 x i8>, ptr %i.bz, align 1, !tbaa !47
  %i.ca = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !47
  store <16 x i8> %wide.load50, ptr %i.ca, align 1, !tbaa !47
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.cb = icmp eq i64 %index.next, %n.vec
  br i1 %i.cb, label %middle.block, label %vector.body, !llvm.loop !689
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.ce, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !690
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  %i.ci = load i8, ptr %.057.i.prol, align 1, !tbaa !47
  %i.cj = getelementptr inbounds nuw i8, ptr %.08.i.prol, i64 1 ; 2 uses
  store i8 %i.ci, ptr %.08.i.prol, align 1, !tbaa !47
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.cn = load i8, ptr %.057.i, align 1, !tbaa !47
  %i.co = getelementptr inbounds nuw i8, ptr %.08.i, i64 1
  store i8 %i.cn, ptr %.08.i, align 1, !tbaa !47
  %i.cp = getelementptr inbounds nuw i8, ptr %.057.i, i64 2
  %i.cq = load i8, ptr %i.cm, align 1, !tbaa !47
  ...
  %i.ct = load i8, ptr %i.cp, align 1, !tbaa !47
  %i.cu = getelementptr inbounds nuw i8, ptr %.08.i, i64 3
  store i8 %i.ct, ptr %i.cr, align 1, !tbaa !47
...
_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit: ; preds = %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit.preheader, %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit
  ...
  %i.dl = load i8, ptr %.022, align 1, !tbaa !47
  %i.dm = zext i8 %i.dl to i32                    ; 2 uses
  %i.dn = lshr i32 %i.dm, 3                       ; 2 uses
  %i.do = zext nneg i32 %i.dn to i64
  %i.dp = getelementptr inbounds nuw i8, ptr @.str.61, i64 %i.do
  ...
  %i.eb = load i8, ptr %i.ea, align 1, !tbaa !47  ; 2 uses
  %i.ec = and i8 %i.eb, 63
  ...
  %i.eh = load i8, ptr %i.eg, align 1, !tbaa !47  ; 2 uses
  %i.ei = and i8 %i.eh, 63
  ...
  %i.en = load i8, ptr %i.em, align 1, !tbaa !47  ; 2 uses
  %i.eo = and i8 %i.en, 63
...
.lr.ph:                                           ; preds = %bb.b, %_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit
  ...
  %i.g = load i8, ptr %.055, align 1, !tbaa !47
  %i.h = zext i8 %i.g to i32                      ; 2 uses
  %i.i = lshr i32 %i.h, 3                         ; 2 uses
  %i.j = zext nneg i32 %i.i to i64
  %i.k = getelementptr inbounds nuw i8, ptr @.str.61, i64 %i.j
...
_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit.thread: ; preds = %.lr.ph, %switch.early.test.i.i.i, %switch.early.test.i.i.i, %switch.early.test.i.i.i, %_ZN3fmt3v126detail12needs_escapeEj.exit.i.i
  ...
  store ptr %i.br, ptr %.sroa.4.0..sroa_idx.i.i, align 8, !tbaa !122
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load107 = load <16 x i8>, ptr %i.cb, align 1, !tbaa !47
  %i.cc = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !47
  store <16 x i8> %wide.load107, ptr %i.cc, align 1, !tbaa !47
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.cd = icmp eq i64 %index.next, %n.vec
  br i1 %i.cd, label %middle.block, label %vector.body, !llvm.loop !700
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.cg, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !701
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  %i.ck = load i8, ptr %.057.i.prol, align 1, !tbaa !47
  %i.cl = getelementptr inbounds nuw i8, ptr %.08.i.prol, i64 1 ; 2 uses
  store i8 %i.ck, ptr %.08.i.prol, align 1, !tbaa !47
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.cp = load i8, ptr %.057.i, align 1, !tbaa !47
  %i.cq = getelementptr inbounds nuw i8, ptr %.08.i, i64 1
  store i8 %i.cp, ptr %.08.i, align 1, !tbaa !47
  ...
  %i.dk = load i8, ptr %i.dg, align 1, !tbaa !47
  %i.dl = getelementptr inbounds nuw i8, ptr %.08.i, i64 8
  store i8 %i.dk, ptr %i.di, align 1, !tbaa !47
...
_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit: ; preds = %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit.preheader, %_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit42
  ...
  %i.dn = load i8, ptr %.022, align 1, !tbaa !47
  %i.do = zext i8 %i.dn to i32                    ; 2 uses
  %i.dp = lshr i32 %i.do, 3                       ; 2 uses
  %i.dq = zext nneg i32 %i.dp to i64
  %i.dr = getelementptr inbounds nuw i8, ptr @.str.61, i64 %i.dq
  %i.ds = load i8, ptr %i.dr, align 1, !tbaa !47
  ...
  %i.ed = load i8, ptr %i.ec, align 1, !tbaa !47  ; 2 uses
  %i.ee = and i8 %i.ed, 63
  ...
  %i.ej = load i8, ptr %i.ei, align 1, !tbaa !47  ; 2 uses
  %i.ek = and i8 %i.ej, 63
  ...
  %i.ep = load i8, ptr %i.eo, align 1, !tbaa !47  ; 2 uses
  %i.eq = and i8 %i.ep, 63
