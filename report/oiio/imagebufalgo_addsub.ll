...
bb.c:                                             ; preds = %bb.b
  ...
  %scevgep.i = getelementptr i8, ptr %6, i64 %4   ; 2 uses
  %i.c = sub i64 %4, %3
...
.critedge:                                        ; preds = %.critedge4, %..critedge_crit_edge, %.critedge4.preheader
  ...
  %8 = ptrtoint ptr %.lcssa44 to i64
  %i.aw = ptrtoint ptr %0 to i64
  %i.ax = sub i64 %8, %i.aw                       ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %scevgep.i = getelementptr i8, ptr %9, i64 %6   ; 2 uses
  %i.d = sub i64 %6, %7
...
.critedge.i:                                      ; preds = %bb.c, %..critedge.i_crit_edge, %bb.b
  ...
  %10 = ptrtoint ptr %.lcssa.i to i64
  %i.q = ptrtoint ptr %0 to i64
  %i.r = sub i64 %10, %i.q                        ; 2 uses
