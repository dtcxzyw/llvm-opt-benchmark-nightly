...
begin_hunk_0_@_Z23mergeOverlappingSamplesffffRfS_:bb.a
  ...
  %6 = fcmp oeq float %.sroa.speculated34, 1.000000e+00 ; 3 uses
  %7 = fcmp oeq float %.sroa.speculated, 1.000000e+00 ; 2 uses
  %or.cond = and i1 %6, %7
...
begin_hunk_1_@_Z17splitVolumeSamplefffffRfS_S_S_:bb.a
  ...
  %.sroa.speculated = select i1 %i.b, float %.sroa.speculated40, float 0.000000e+00 ; 7 uses
  %9 = fcmp oeq float %.sroa.speculated, 1.000000e+00
