...
begin_hunk_0_@_ZN11OpenImageIO4v3_18term_pvt10TermOutput6outputEv:bb.a
  ...
  %4 = alloca %"struct.OpenImageIO::v3_1::ROI", align 8 ; 11 uses
  %5 = alloca %"struct.OpenImageIO::v3_1::ROI", align 8 ; 11 uses
  %6 = alloca %"class.fmt::v12::detail::file_print_buffer", align 8 ; 10 uses
  %7 = alloca %"struct.OpenImageIO::v3_1::ROI", align 8 ; 11 uses
  %8 = alloca %"class.fmt::v12::detail::file_print_buffer", align 8 ; 10 uses
  %9 = alloca %"struct.OpenImageIO::v3_1::ROI", align 8 ; 11 uses
...
.lr.ph765:                                        ; preds = %.preheader730
  ...
  %.sroa.2566.0..sroa_idx = getelementptr inbounds nuw i8, ptr %9, i64 4
  %.sroa.3567.0..sroa_idx = getelementptr inbounds nuw i8, ptr %9, i64 8
  %.sroa.4568.0..sroa_idx = getelementptr inbounds nuw i8, ptr %9, i64 12
  %.sroa.5569.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %9, i64 16
  %.sroa.6570.0..sroa_idx = getelementptr inbounds nuw i8, ptr %9, i64 20
  %.sroa.7571.0..sroa_idx = getelementptr inbounds nuw i8, ptr %9, i64 24
  %.sroa.8572.0..sroa_idx = getelementptr inbounds nuw i8, ptr %9, i64 28
...
begin_hunk_3_@_ZN11OpenImageIO4v3_18term_pvt10TermOutput6outputEv:bb.a
  ...
  store i32 %i.lu, ptr %.sroa.2566.0..sroa_idx, align 4
  store i32 %.0153764, ptr %.sroa.3567.0..sroa_idx, align 8
  store i32 %i.lr, ptr %.sroa.4568.0..sroa_idx, align 4
  store i32 %i.kf, ptr %.sroa.5569.0..sroa_idx.a, align 8
  store i32 %i.kj, ptr %.sroa.6570.0..sroa_idx, align 4
  store i32 0, ptr %.sroa.7571.0..sroa_idx, align 8
  store i32 3, ptr %.sroa.8572.0..sroa_idx, align 4
...
.lr.ph760:                                        ; preds = %.preheader733
  ...
  %.sroa.2550.0..sroa_idx = getelementptr inbounds nuw i8, ptr %7, i64 4
  %.sroa.3551.0..sroa_idx = getelementptr inbounds nuw i8, ptr %7, i64 8
  %.sroa.4552.0..sroa_idx = getelementptr inbounds nuw i8, ptr %7, i64 12
  %.sroa.5553.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %7, i64 16
  %.sroa.6554.0..sroa_idx = getelementptr inbounds nuw i8, ptr %7, i64 20
  %.sroa.7555.0..sroa_idx = getelementptr inbounds nuw i8, ptr %7, i64 24
  %.sroa.8556.0..sroa_idx = getelementptr inbounds nuw i8, ptr %7, i64 28
...
begin_hunk_6_@_ZN11OpenImageIO4v3_18term_pvt10TermOutput6outputEv:bb.a
  ...
  store i32 %i.qq, ptr %.sroa.2550.0..sroa_idx, align 4
  store i32 %.0155759, ptr %.sroa.3551.0..sroa_idx, align 8
  store i32 %i.qn, ptr %.sroa.4552.0..sroa_idx, align 4
  store i32 %i.pm, ptr %.sroa.5553.0..sroa_idx.a, align 8
  store i32 %i.pq, ptr %.sroa.6554.0..sroa_idx, align 4
  store i32 0, ptr %.sroa.7555.0..sroa_idx, align 8
  store i32 3, ptr %.sroa.8556.0..sroa_idx, align 4
...
.lr.ph755:                                        ; preds = %.preheader736
  ...
  %.sroa.2531.0..sroa_idx = getelementptr inbounds nuw i8, ptr %5, i64 4
  %.sroa.3532.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %5, i64 8
  %.sroa.4533.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %5, i64 12
  %.sroa.5534.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %5, i64 16
  %.sroa.6535.0..sroa_idx = getelementptr inbounds nuw i8, ptr %5, i64 20
  %.sroa.7536.0..sroa_idx = getelementptr inbounds nuw i8, ptr %5, i64 24
  %.sroa.8537.0..sroa_idx = getelementptr inbounds nuw i8, ptr %5, i64 28
  %i.tl = getelementptr inbounds nuw i8, ptr %60, i64 8
  %i.tm = getelementptr inbounds nuw i8, ptr %59, i64 8
  %64 = getelementptr inbounds nuw i8, ptr %25, i64 8
  %65 = getelementptr inbounds nuw i8, ptr %59, i64 16 ; 4 uses
  br label %bb.eg
...
._crit_edge:                                      ; preds = %bb.el, %.preheader735
  ...
  store i64 7, ptr %i.tl, align 8, !tbaa !12
...
begin_hunk_9_@_ZN11OpenImageIO4v3_18term_pvt10TermOutput6outputEv:bb.a
  ...
  store i32 %i.tx, ptr %.sroa.2531.0..sroa_idx, align 4
  store i32 %.0157754, ptr %.sroa.3532.0..sroa_idx.a, align 8
  store i32 %i.tt, ptr %.sroa.4533.0..sroa_idx.a, align 4
  store i32 %i.tg, ptr %.sroa.5534.0..sroa_idx.a, align 8
  store i32 %i.tk, ptr %.sroa.6535.0..sroa_idx, align 4
  store i32 0, ptr %.sroa.7536.0..sroa_idx, align 8
  store i32 3, ptr %.sroa.8537.0..sroa_idx, align 4
...
.noexc237:                                        ; preds = %._crit_edge
  ...
  %i.vm = load i64, ptr %i.tm, align 8, !tbaa !34
  store ptr %i.vl, ptr %25, align 16, !tbaa !33
  store i64 %i.vm, ptr %64, align 8, !tbaa !33
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i454: ; preds = %bb.ep
  %i.vp = load i64, ptr %65, align 8, !tbaa !33
  %i.vq = add i64 %i.vp, 1
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i457: ; preds = %bb.er
  %i.vw = load i64, ptr %65, align 8, !tbaa !33
  %i.vx = add i64 %i.vw, 1
...
.lr.ph772:                                        ; preds = %.preheader727
  ...
  %.sroa.2514.0..sroa_idx = getelementptr inbounds nuw i8, ptr %4, i64 4
  %.sroa.3.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %4, i64 8
  %.sroa.4.0..sroa_idx.a = getelementptr inbounds nuw i8, ptr %4, i64 12
  %.sroa.5.0..sroa_idx515.a = getelementptr inbounds nuw i8, ptr %4, i64 16
  ...
  %i.wf = getelementptr inbounds nuw i8, ptr %63, i64 8
  %i.wg = getelementptr inbounds nuw i8, ptr %62, i64 8
  %66 = getelementptr inbounds nuw i8, ptr %26, i64 8
  %67 = getelementptr inbounds nuw i8, ptr %62, i64 16 ; 4 uses
  br label %bb.ey
...
._crit_edge770:                                   ; preds = %bb.fd, %.preheader726
  ...
  store i64 7, ptr %i.wf, align 8, !tbaa !12
...
begin_hunk_14_@_ZN11OpenImageIO4v3_18term_pvt10TermOutput6outputEv:bb.a
  ...
  store i32 %i.wq, ptr %.sroa.2514.0..sroa_idx, align 4
  store i32 %.0151771, ptr %.sroa.3.0..sroa_idx.a, align 8
  store i32 %i.wn, ptr %.sroa.4.0..sroa_idx.a, align 4
  store i32 %i.wa, ptr %.sroa.5.0..sroa_idx515.a, align 8
  store i32 %i.we, ptr %.sroa.6.0..sroa_idx, align 4
...
.noexc:                                           ; preds = %._crit_edge770
  ...
  %i.yb = load i64, ptr %i.wg, align 8, !tbaa !34
  store ptr %i.ya, ptr %26, align 16, !tbaa !33
  store i64 %i.yb, ptr %66, align 8, !tbaa !33
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i477: ; preds = %bb.fh
  %i.ye = load i64, ptr %67, align 8, !tbaa !33
  %i.yf = add i64 %i.ye, 1
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i480: ; preds = %bb.fj
  %i.yl = load i64, ptr %67, align 8, !tbaa !33
  %i.ym = add i64 %i.yl, 1
