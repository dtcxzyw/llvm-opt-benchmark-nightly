...
.noexc262:                                        ; preds = %bb.eg
  ...
  %64 = extractelement <2 x float> %bc719, i64 1
  %bc721 = bitcast double %i.uc to <2 x float>    ; 2 uses
  %65 = extractelement <2 x float> %bc721, i64 0
  %66 = extractelement <2 x float> %bc721, i64 1
  %67 = call float @llvm.floor.f32(float %65)
  %i.ue = call float @llvm.floor.f32(float %i.ud)
  %68 = call float @llvm.floor.f32(float %66)
  %i.uf = call float @llvm.floor.f32(float %64)
  %i.ug = insertelement <2 x float> poison, float %i.ue, i64 0
  %i.uh = insertelement <2 x float> %i.ug, float %67, i64 1
  %i.ui = bitcast <2 x float> %i.uh to <2 x i32>
  %i.uj = insertelement <2 x float> poison, float %i.uf, i64 0
  %i.uk = insertelement <2 x float> %i.uj, float %68, i64 1
...
.noexc260:                                        ; preds = %bb.ey
  ...
  %69 = extractelement <2 x float> %bc713, i64 1
  %bc715 = bitcast double %i.wt to <2 x float>    ; 2 uses
  %70 = extractelement <2 x float> %bc715, i64 0
  %71 = extractelement <2 x float> %bc715, i64 1
  %72 = call float @llvm.floor.f32(float %70)
  %i.wv = call float @llvm.floor.f32(float %i.wu)
  %73 = call float @llvm.floor.f32(float %71)
  %i.ww = call float @llvm.floor.f32(float %69)
  %i.wx = insertelement <2 x float> poison, float %i.wv, i64 0
  %i.wy = insertelement <2 x float> %i.wx, float %72, i64 1
  %i.wz = bitcast <2 x float> %i.wy to <2 x i32>
  %i.xa = insertelement <2 x float> poison, float %i.ww, i64 0
  %i.xb = insertelement <2 x float> %i.xa, float %73, i64 1
