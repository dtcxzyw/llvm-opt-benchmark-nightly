...
begin_hunk_2_@png_build_gamma_table:bb.a
  br i1 %exitcond.not.i104, label %.preheader38.i, label %bb.x, !llvm.loop !205

.preheader.i105:                                  ; preds = %._crit_edge.i
  %4 = shl nuw nsw i32 256, %2                    ; 3 uses
  %i.ff = icmp ult i32 %.135.lcssa.i, %4
  br i1 %i.ff, label %.lr.ph45.i.preheader, label %png_build_16to8_table.exit

.lr.ph45.i.preheader:                             ; preds = %.preheader.i105
  %i.fg = sub i32 0, %.135.lcssa.i
...
begin_hunk_3_@png_build_gamma_table:bb.a
  ...
  %i.fk = load ptr, ptr %i.fj, align 8, !tbaa !176
  %i.fl = lshr i32 %.244.i.prol, %2
...
begin_hunk_5_@png_build_gamma_table:bb.a
  ...
  %.fr37.i = freeze i16 %i.ga
  %i.gb = zext i16 %.fr37.i to i32                ; 2 uses
  %mulshl.i = shl nuw i32 %i.gb, %i.ey
  %reass.sub = sub i32 %mulshl.i, %i.gb
  %i.gc = add i32 %reass.sub, 32768
...
begin_hunk_6_@png_build_gamma_table:bb.a
  ...
  %i.gk = load ptr, ptr %i.gj, align 8, !tbaa !176
  %i.gl = lshr i32 %.13541.i.prol, %2
...
begin_hunk_7_@png_build_gamma_table:bb.a
  ...
  %i.gt = load ptr, ptr %i.gs, align 8, !tbaa !176
  %i.gu = lshr i32 %.13541.i, %2
...
begin_hunk_8_@png_build_gamma_table:bb.a
  ...
  %i.hb = load ptr, ptr %i.ha, align 8, !tbaa !176
  %i.hc = lshr i32 %i.gx, %2
...
begin_hunk_11_@png_build_gamma_table:bb.a
  ...
  %i.ib = load ptr, ptr %i.ia, align 8, !tbaa !176
  %i.ic = lshr i32 %.244.i, %2
...
begin_hunk_12_@png_build_gamma_table:bb.a
  ...
  %i.ij = load ptr, ptr %i.ii, align 8, !tbaa !176
  %i.ik = lshr i32 %i.if, %2
...
begin_hunk_13_@png_build_gamma_table:bb.a
  ...
  %i.ir = load ptr, ptr %i.iq, align 8, !tbaa !176
  %i.is = lshr i32 %i.in, %2
...
begin_hunk_14_@png_build_gamma_table:bb.a
  ...
  %i.iz = load ptr, ptr %i.iy, align 8, !tbaa !176
  %i.ja = lshr i32 %i.iv, %2
  ...
  %exitcond50.not.i.3 = icmp eq i32 %i.jd, %4
  br i1 %exitcond50.not.i.3, label %png_build_16to8_table.exit, label %.lr.ph45.i, !llvm.loop !210
