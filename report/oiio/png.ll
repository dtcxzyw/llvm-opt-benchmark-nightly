...
bb.l:                                             ; preds = %.preheader343, %bb.aj
  ...
  %.1120 = phi i32 [ %.5124, %bb.aj ], [ %.0115.ph, %.preheader343 ] ; 5 uses
...
begin_hunk_2_@png_ascii_from_fp:bb.a
  ...
  %6 = sub i32 %.3111204307, %.2117203308
  %7 = add i32 %6, %.3122202309
  %i.do = add i32 %7, 1
  br label %bb.aj
...
bb.aj:                                            ; preds = %bb.y, %bb.ai
  ...
  %.5124 = phi i32 [ 0, %bb.ai ], [ %5, %bb.y ]   ; 2 uses
