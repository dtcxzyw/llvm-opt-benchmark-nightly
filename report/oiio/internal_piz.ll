...
begin_hunk_0_@internal_exr_apply_piz:bb.a
  ...
  br i1 %niter271.ncmp.3, label %applyLut.exit.loopexit.unr-lcssa, label %.lr.ph25.i, !llvm.loop !33

applyLut.exit.loopexit.unr-lcssa:                 ; preds = %.lr.ph25.i
  %lcmp.mod268.not = icmp eq i64 %xtraiter267, 0
  br i1 %lcmp.mod268.not, label %applyLut.exit, label %.lr.ph25.i.epil.preheader
...
.lr.ph25.i.epil.preheader:                        ; preds = %applyLut.exit.loopexit.unr-lcssa, %.lr.ph25.preheader.i
  ...
  %lcmp.mod269 = icmp ne i64 %xtraiter267, 0
...
._crit_edge.loopexit:                             ; preds = %bb.l
  %.pre222.a = load i32, ptr %i.u, align 4, !tbaa !18
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %bb.g
  %i.fi = phi i32 [ %i.fb, %bb.g ], [ %.pre222.a, %._crit_edge.loopexit ] ; 2 uses
...
bb.k:                                             ; preds = %bb.h, %bb.j
  ...
  %.pre221 = load i16, ptr %i.z, align 8, !tbaa !20
  br label %bb.l

bb.l:                                             ; preds = %bb.i, %.lr.ph, %bb.k
  %i.gj = phi i16 [ %.pre221, %bb.k ], [ %i.fn, %.lr.ph ], [ %i.fn, %bb.i ] ; 4 uses
...
._crit_edge206:                                   ; preds = %._crit_edge201, %bb.p
...
bb.q:                                             ; preds = %.lr.ph205, %._crit_edge201
  %i.hg = phi i16 [ %i.gz, %.lr.ph205 ], [ %i.ht, %._crit_edge201 ] ; 2 uses
  %indvars.iv218 = phi i64 [ 0, %.lr.ph205 ], [ %indvars.iv.next219, %._crit_edge201 ] ; 2 uses
  %.0140202 = phi ptr [ %i.gx, %.lr.ph205 ], [ %i.hw, %._crit_edge201 ] ; 2 uses
  %i.hh = getelementptr inbounds nuw [48 x i8], ptr %i.hc, i64 %indvars.iv218 ; 3 uses
...
._crit_edge201:                                   ; preds = %bb.q, %._crit_edge201.loopexit208, %.lr.ph200
  ...
  %i.hy = icmp slt i64 %indvars.iv.next219, %i.hx
...
.lr.ph132.i.preheader:                            ; preds = %.lr.ph132.i.preheader.preheader, %wav_2D_encode.exit.loopexit
  %indvars.iv215 = phi i64 [ 0, %.lr.ph132.i.preheader.preheader ], [ %indvars.iv.next216, %wav_2D_encode.exit.loopexit ] ; 2 uses
  %i.hz = getelementptr inbounds nuw [2 x i8], ptr %.0140202, i64 %indvars.iv215 ; 3 uses
  br label %.lr.ph132.i
