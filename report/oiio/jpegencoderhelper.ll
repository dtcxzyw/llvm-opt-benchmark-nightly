...
begin_hunk_0_@_ZN8ultrahdr17JpegEncoderHelper6encodeEPPKhPKjii12uhdr_img_fmtiPKvm:bb.a
  store i32 1, ptr %i.ek, align 4, !tbaa !26
...
bb.p:                                             ; preds = %bb.n
  ...
  %i.en = load i32, ptr %0, align 4, !tbaa !25
...
bb.r:                                             ; preds = %_ZNSt3mapI12uhdr_img_fmtSt6vectorIiSaIiEESt4lessIS0_ESaISt4pairIKS0_S3_EEE4findERS7_.exit64
  ...
  store i32 1, ptr %i.eo, align 4, !tbaa !26
...
_ZSt8_DestroyIPhhEvT_S1_RSaIT0_E.exit.i.i:        ; preds = %bb.d
  store ptr %i.o, ptr %i.d, align 8, !tbaa !52
  br label %_ZNSt6vectorIhSaIhEE6resizeEm.exit
...
bb.b:                                             ; preds = %.lr.ph108, %.loopexit
  ...
  store i64 %i.w, ptr %i.x, align 8, !tbaa !132
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.ac = load ptr, ptr %i.k, align 8, !tbaa !59
  %i.ad = getelementptr inbounds nuw [96 x i8], ptr %i.ac, i64 %indvars.iv120
  %i.ae = getelementptr inbounds nuw i8, ptr %i.ad, i64 12
  %i.af = load i32, ptr %i.ae, align 4, !tbaa !61
  %i.ag = sext i32 %i.af to i64
  %i.ah = mul i64 %i.ab, %i.ag                    ; 2 uses
  %i.ai = call noalias noundef nonnull ptr @_Znam(i64 noundef %i.ah) #24, !noalias !133 ; 3 uses
  call void @llvm.memset.p0.i64(ptr nonnull align 1 %i.ai, i8 0, i64 %i.ah, i1 false), !noalias !133
...
_ZNKSt14default_deleteIA_hEclIhEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i.i.i.i: ; preds = %bb.c
  ...
  %.pre = load ptr, ptr %i.aj, align 8, !tbaa !19
...
_ZNSt10unique_ptrIA_hSt14default_deleteIS0_EED2Ev.exit: ; preds = %_ZNKSt14default_deleteIA_hEclIhEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i.i.i.i, %bb.c
  ...
  %i.am = load ptr, ptr %i.k, align 8, !tbaa !59  ; 2 uses
...
.lr.ph.split.us:                                  ; preds = %.lr.ph
  ...
  %i.at = load i32, ptr %i.as, align 4, !tbaa !61 ; 2 uses
...
bb.d:                                             ; preds = %bb.d, %.lr.ph.split.us.new
  ...
  store ptr %.085104.us, ptr %i.aw, align 16, !tbaa !19
  ...
  store ptr %i.ba, ptr %i.bc, align 16, !tbaa !19
  ...
  store ptr %i.bd, ptr %i.bf, align 8, !tbaa !19
  ...
  store ptr %i.bg, ptr %i.bi, align 16, !tbaa !19
  ...
  store ptr %i.bj, ptr %i.bl, align 8, !tbaa !19
  ...
  store ptr %i.bm, ptr %i.bo, align 16, !tbaa !19
  ...
  store ptr %i.bp, ptr %i.br, align 8, !tbaa !19
  ...
  br i1 %niter.ncmp.7, label %.loopexit.loopexit.unr-lcssa, label %bb.d, !llvm.loop !124
...
.lr.ph.split:                                     ; preds = %.lr.ph, %.lr.ph.split
  ...
  store ptr %.085104, ptr %i.bt, align 8, !tbaa !19
  %i.bu = load i32, ptr %i.s, align 4, !tbaa !6
  ...
  %i.bz = load ptr, ptr %i.k, align 8, !tbaa !59
  %i.ca = getelementptr inbounds nuw [96 x i8], ptr %i.bz, i64 %indvars.iv120
  %i.cb = getelementptr inbounds nuw i8, ptr %i.ca, i64 12
  %i.cc = load i32, ptr %i.cb, align 4, !tbaa !61
  %i.cd = shl nsw i32 %i.cc, 3
  %i.ce = sext i32 %i.cd to i64
  %i.cf = icmp slt i64 %indvars.iv.next, %i.ce
  br i1 %i.cf, label %.lr.ph.split, label %.loopexit, !llvm.loop !124

bb.e:                                             ; preds = %bb.b
  %i.cg = getelementptr inbounds nuw [4 x i8], ptr %i.i, i64 %indvars.iv120
  %i.ch = load i32, ptr %i.cg, align 4, !tbaa !6
  %i.ci = and i32 %i.ch, 7
  %.not90 = icmp eq i32 %i.ci, 0
  br i1 %.not90, label %.loopexit, label %bb.f

bb.f:                                             ; preds = %bb.e
  %i.cj = call noalias noundef nonnull ptr @_Znam(i64 noundef %i.w) #24, !noalias !134 ; 2 uses
  call void @llvm.memset.p0.i64(ptr nonnull align 1 %i.cj, i8 0, i64 %i.w, i1 false), !noalias !134
  %i.ck = getelementptr inbounds nuw [8 x i8], ptr %i.j, i64 %indvars.iv120 ; 3 uses
  %i.cl = load ptr, ptr %i.ck, align 8, !tbaa !19 ; 2 uses
  store ptr %i.cj, ptr %i.ck, align 8, !tbaa !19
end_hunk_0
