...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %i.bi = load i32, ptr %i.bb, align 4, !tbaa !3, !alias.scope !79
  %broadcast.splatinsert110.a = insertelement <2 x i32> poison, i32 %i.bi, i64 0
  %12 = load i32, ptr %i.ax, align 4, !tbaa !3, !alias.scope !79
  %broadcast.splatinsert = insertelement <2 x i32> poison, i32 %12, i64 0
  %13 = sitofp <2 x i32> %broadcast.splatinsert to <2 x float>
  %14 = shufflevector <2 x float> %13, <2 x float> poison, <2 x i32> zeroinitializer
  %i.bj = sitofp <2 x i32> %broadcast.splatinsert110.a to <2 x float>
...
begin_hunk_1_@_ZN8ultrahdr17JpegEncoderHelper6encodeEPPKhPKjii12uhdr_img_fmtiPKvm:bb.a
  ...
  %i.bx = fdiv contract <2 x float> %i.bw, %14
