...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %bb.k
  ...
  %i.d = getelementptr inbounds i8, ptr %.01831, i64 -1 ; 3 uses
...
bb.c:                                             ; preds = %bb.b
  %i.k = getelementptr inbounds nuw i8, ptr %.01831, i64 3
...
bb.f:                                             ; preds = %bb.e
  %i.p = getelementptr inbounds nuw i8, ptr %.01831, i64 2
  br label %select.unfold
...
bb.i:                                             ; preds = %bb.h
  %i.u = getelementptr inbounds nuw i8, ptr %.01831, i64 1
  br label %select.unfold
...
bb.k:                                             ; preds = %bb.j, %bb.h, %bb.e, %bb.b
  ...
  br i1 %i.x, label %.lr.ph, label %select.unfold
...
define hidden range(i32 0, 5) i32 @XmlUtf8Encode(i32 noundef %0, ptr nofree noundef writeonly captures(none) %1) local_unnamed_addr #2 {
bb.a:
...
bb.i:                                             ; preds = %bb.h
  ...
  store <4 x i8> %i.al, ptr %1, align 1
  br label %bb.j
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: write) uwtable
define hidden range(i32 0, 3) i32 @XmlUtf16Encode(i32 noundef %0, ptr nofree noundef writeonly captures(none) %1) local_unnamed_addr #2 {
bb.a:
  %i.a = icmp slt i32 %0, 0
...
define hidden noundef i32 @XmlSizeOfUnknownEncoding() local_unnamed_addr #3 {
bb.a:
  ret i32 2016
}

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define hidden noundef ptr @XmlInitUnknownEncoding(ptr nofree noundef writeonly captures(ret: address, provenance) initializes((0, 464)) %0, ptr nofree noundef readonly captures(none) %1, ptr noundef %2, ptr noundef %3) local_unnamed_addr #4 {
bb.a:
...
begin_hunk_1_@findEncoding:bb.a
  %i.m = load i8, ptr %.019.i, align 1            ; 3 uses
  %i.n = add i8 %i.k, -97
...
bb.d:                                             ; preds = %streqci.exit.thread
  ...
  %i.v = getelementptr inbounds nuw [8 x i8], ptr @encodings, i64 %i.u
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define hidden noundef nonnull ptr @XmlGetUtf8InternalEncodingNS() local_unnamed_addr #3 {
bb.a:
  ret ptr @internal_utf8_encoding_ns
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(none) uwtable
define hidden noundef nonnull ptr @XmlGetUtf16InternalEncodingNS() local_unnamed_addr #3 {
bb.a:
  ret ptr @internal_little2_encoding_ns
}

; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define hidden range(i32 0, 2) i32 @XmlInitEncodingNS(ptr noundef %0, ptr noundef %1, ptr nofree noundef readonly captures(address_is_null) %2) local_unnamed_addr #4 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  store ptr @initScanPrologNS, ptr %0, align 8
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 8
  store ptr @initScanContentNS, ptr %i.e, align 8
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 96
  store ptr @initUpdatePosition, ptr %i.f, align 8
...
; Function Attrs: nounwind uwtable
define hidden range(i32 0, 2) i32 @XmlParseXmlDeclNS(i32 noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3, ptr nofree noundef writeonly captures(none) %4, ptr nofree noundef writeonly captures(address_is_null) %5, ptr nofree noundef writeonly captures(address_is_null) %6, ptr nofree noundef writeonly captures(address_is_null) %7, ptr nofree noundef writeonly captures(address_is_null) %8, ptr nofree noundef writeonly captures(address_is_null) %9) local_unnamed_addr #5 {
bb.a:
...
bb.c:                                             ; preds = %bb.c, %bb.b
  ...
  %i.j = getelementptr inbounds nuw i8, ptr %.020.i, i64 1
  %i.k = load i8, ptr %.020.i, align 1            ; 3 uses
  %i.l = getelementptr inbounds nuw i8, ptr %.019.i, i64 1
  %i.m = load i8, ptr %.019.i, align 1            ; 3 uses
  %i.n = add i8 %i.k, -97
  %or.cond.i = icmp ult i8 %i.n, 26
  %narrow.i = add nsw i8 %i.k, -32
...
bb.d:                                             ; preds = %streqci.exit.thread
  %i.u = zext nneg i32 %i.s to i64
  %i.v = getelementptr inbounds nuw [8 x i8], ptr @encodingsNS, i64 %i.u
  %i.w = load ptr, ptr %i.v, align 8
  br label %bb.e
...
define hidden noundef ptr @XmlInitUnknownEncodingNS(ptr nofree noundef writeonly captures(address, ret: address, provenance) initializes((0, 464)) %0, ptr nofree noundef readonly captures(none) %1, ptr noundef %2, ptr noundef %3) local_unnamed_addr #7 {
bb.a:
  %i.a = tail call ptr @XmlInitUnknownEncoding(ptr noundef %0, ptr noundef %1, ptr noundef %2, ptr noundef %3) ; 3 uses
  %.not = icmp eq ptr %i.a, null
  br i1 %.not, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.b = getelementptr inbounds nuw i8, ptr %i.a, i64 194
  store i8 23, ptr %i.b, align 2
  br label %bb.c
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.g = tail call fastcc i32 @normal_scanLit(i32 noundef 12, ptr noundef nonnull %0, ptr noundef nonnull %i.f, ptr noundef nonnull %2, ptr noundef %3)
  br label %.loopexit

bb.d:                                             ; preds = %bb.b
  %i.h = getelementptr inbounds nuw i8, ptr %1, i64 1
  %i.i = tail call fastcc i32 @normal_scanLit(i32 noundef 13, ptr noundef nonnull %0, ptr noundef nonnull %i.h, ptr noundef nonnull %2, ptr noundef %3)
  br label %.loopexit
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.t = tail call fastcc i32 @normal_scanDecl(ptr noundef nonnull %0, ptr noundef nonnull %i.s, ptr noundef nonnull %2, ptr noundef %3)
  br label %.loopexit

bb.h:                                             ; preds = %bb.f
  %i.u = getelementptr inbounds nuw i8, ptr %1, i64 2
  %i.v = tail call fastcc i32 @normal_scanPi(ptr noundef nonnull %0, ptr noundef nonnull %i.u, ptr noundef nonnull %2, ptr noundef %3)
  br label %.loopexit
...
bb.m:                                             ; preds = %bb.k, %bb.b, %bb.b
  ...
  %i.z = getelementptr inbounds nuw i8, ptr %1, i64 1 ; 3 uses
...
bb.n:                                             ; preds = %.lr.ph315
  %i.aj = getelementptr inbounds nuw i8, ptr %.0247313, i64 2
...
bb.p:                                             ; preds = %bb.n, %.lr.ph315, %.lr.ph315
  %i.ak = getelementptr inbounds nuw i8, ptr %i.ae, i64 1 ; 2 uses
...
bb.q:                                             ; preds = %bb.b
  ...
  %i.ap = tail call fastcc i32 @normal_scanPercent(ptr noundef nonnull %0, ptr noundef nonnull %i.ao, ptr noundef nonnull %2, ptr noundef %3)
  br label %.loopexit
...
bb.t:                                             ; preds = %bb.b
  %i.as = getelementptr inbounds nuw i8, ptr %1, i64 1 ; 3 uses
...
bb.aa:                                            ; preds = %bb.b
  %i.be = getelementptr inbounds nuw i8, ptr %1, i64 1 ; 4 uses
...
bb.ac:                                            ; preds = %bb.ab
  ...
  store ptr %i.bn, ptr %3, align 8
  br label %.loopexit

bb.ad:                                            ; preds = %bb.ab
  %i.bo = getelementptr inbounds nuw i8, ptr %1, i64 2
...
bb.ai:                                            ; preds = %bb.b
  ...
  store ptr %i.br, ptr %3, align 8
  br label %.loopexit

bb.aj:                                            ; preds = %bb.b
  %i.bs = getelementptr inbounds nuw i8, ptr %1, i64 1
  %i.bt = tail call fastcc i32 @normal_scanPoundName(ptr noundef nonnull %0, ptr noundef nonnull %i.bs, ptr noundef nonnull %2, ptr noundef %3)
  br label %.loopexit
...
bb.al:                                            ; preds = %bb.ak
  %i.bx = getelementptr inbounds nuw i8, ptr %0, i64 440
...
bb.ar:                                            ; preds = %bb.aq
  %i.cj = getelementptr inbounds nuw i8, ptr %0, i64 448
...
bb.au:                                            ; preds = %bb.at
  %i.cp = getelementptr inbounds nuw i8, ptr %0, i64 400
...
bb.az:                                            ; preds = %bb.ax
  %i.cy = getelementptr inbounds nuw i8, ptr %0, i64 432
...
bb.be:                                            ; preds = %bb.b, %bb.b, %bb.ba, %bb.az, %bb.au, %bb.at, %bb.ao, %bb.an, %bb.bc
  ...
  %i.de = getelementptr inbounds nuw i8, ptr %1, i64 %.sink ; 2 uses
...
.lr.ph:                                           ; preds = %bb.be
  ...
  %i.dk = getelementptr inbounds nuw i8, ptr %0, i64 408 ; 2 uses
  %i.dl = getelementptr inbounds nuw i8, ptr %0, i64 448 ; 2 uses
  %i.dm = getelementptr inbounds nuw i8, ptr %0, i64 400 ; 2 uses
  %i.dn = getelementptr inbounds nuw i8, ptr %0, i64 440 ; 2 uses
...
bb.bf:                                            ; preds = %.lr.ph, %bb.cw
  ...
  %i.dq = load i8, ptr %.2249311, align 1
...
bb.bh:                                            ; preds = %bb.cy
  %i.dy = load i8, ptr %.3.jt19, align 1
...
bb.bi:                                            ; preds = %bb.bg, %bb.bh, %bb.bf
  ...
  store ptr %.2249311369, ptr %3, align 8
  br label %.loopexit
...
bb.bj:                                            ; preds = %bb.bg, %bb.bg, %bb.bg, %bb.bg, %bb.bg, %bb.bh, %bb.bh, %bb.bh, %bb.bh, %bb.bh, %bb.bf, %bb.bf, %bb.bf, %bb.bf, %bb.bf
  ...
  %i.ec = getelementptr inbounds nuw i8, ptr %.2249311370, i64 1
  br label %bb.cw
...
bb.bl:                                            ; preds = %bb.bk
  %i.ef = load ptr, ptr %i.dn, align 8
...
bb.bm:                                            ; preds = %bb.bl
  %i.eh = load ptr, ptr %i.do, align 8
...
bb.bn:                                            ; preds = %bb.bm, %bb.bl
  store ptr %.2249311371, ptr %3, align 8
  br label %.loopexit

bb.bo:                                            ; preds = %bb.bm
  %i.ej = getelementptr inbounds nuw i8, ptr %.2249311371, i64 2
  br label %bb.cw
...
bb.bq:                                            ; preds = %bb.bp
  %i.em = load ptr, ptr %i.dl, align 8
...
bb.av:                                            ; preds = %bb.ai
  %i.dx = getelementptr inbounds nuw i8, ptr %i.da, i64 1 ; 2 uses
...
.thread161:                                       ; preds = %.lr.ph323
  %i.ec = getelementptr inbounds nuw i8, ptr %i.da, i64 1 ; 7 uses
  store ptr %i.ec, ptr %i.a, align 8
...
bb.aw:                                            ; preds = %.thread161
  %i.eg = load i8, ptr %i.ec, align 1
  %i.eh = zext i8 %i.eg to i64
  %i.ei = getelementptr inbounds nuw i8, ptr %i.f, i64 %i.eh
...
bb.ax:                                            ; preds = %bb.aw, %bb.aw, %bb.aw
  %i.ek = getelementptr inbounds nuw i8, ptr %i.da, i64 2 ; 2 uses
...
.lr.ph343:                                        ; preds = %bb.ax, %bb.bl
  ...
  %i.et = getelementptr inbounds nuw i8, ptr %i.f, i64 %i.es
...
bb.ay:                                            ; preds = %.lr.ph343, %.lr.ph343
  %i.ev = getelementptr inbounds nuw i8, ptr %i.eq, i64 2
  br label %bb.bn
...
bb.bc:                                            ; preds = %bb.bb
  %i.fb = getelementptr inbounds nuw i8, ptr %i.eq, i64 3
  br label %bb.bn
...
bb.bg:                                            ; preds = %bb.bf
  %i.fh = getelementptr inbounds nuw i8, ptr %i.eq, i64 4
  br label %bb.bn
...
bb.bk:                                            ; preds = %bb.bj
  %i.fn = getelementptr inbounds nuw i8, ptr %i.eq, i64 5
  br label %bb.bn

bb.bl:                                            ; preds = %.lr.ph343, %.lr.ph343, %.lr.ph343
  %i.fo = getelementptr inbounds nuw i8, ptr %i.ep, i64 1 ; 2 uses
...
.loopexit181:                                     ; preds = %bb.aw, %.lr.ph343
  ...
  %i.fv = getelementptr inbounds nuw i8, ptr %i.fu, i64 1 ; 4 uses
  store ptr %i.fv, ptr %i.a, align 8
...
bb.bm:                                            ; preds = %.loopexit181
  %i.fz = load i8, ptr %i.fv, align 1
  %i.ga = icmp eq i8 %i.fz, 62                    ; 2 uses
  %i.gb = getelementptr inbounds nuw i8, ptr %i.fu, i64 2
...
bb.bn:                                            ; preds = %bb.ay, %bb.bc, %bb.bg, %bb.bk, %bb.s, %bb.w, %bb.aa, %bb.ae, %bb.o, %bb.k, %bb.g, %bb.c
  ...
  br i1 %i.ge, label %bb.b, label %.thread
...
.thread.sink.split:                               ; preds = %bb.b, %bb.bi, %bb.bj, %bb.be, %bb.bf, %bb.ba, %bb.bb, %bb.aw, %bb.r, %bb.ac, %bb.ad, %bb.y, %bb.z, %bb.u, %bb.v, %bb.p, %bb.m, %bb.n, %bb.i, %bb.j, %bb.e, %bb.f, %.lr.ph, %.lr.ph699, %bb.ai, %bb.ai, %bb.ai, %bb.ai, %bb.aq, %bb.an, %bb.ak, %.lr.ph343, %bb.bm, %.loopexit182, %bb.au
  ...
  store ptr %.sink638, ptr %3, align 8
  br label %.thread
...
bb.a:
  ...
  %i.j = getelementptr inbounds i8, ptr %i.a, i64 %i.h
...
.lr.ph.i:                                         ; preds = %bb.k, %.lr.ph.preheader.i
  ...
  %i.m = getelementptr inbounds i8, ptr %.01831.i, i64 -1 ; 3 uses
...
bb.c:                                             ; preds = %bb.b
  %i.t = getelementptr inbounds nuw i8, ptr %.01831.i, i64 3
...
bb.f:                                             ; preds = %bb.e
  %i.y = getelementptr inbounds nuw i8, ptr %.01831.i, i64 2
  br label %_INTERNAL_trim_to_complete_utf8_characters.exit
...
bb.i:                                             ; preds = %bb.h
  %i.ad = getelementptr inbounds nuw i8, ptr %.01831.i, i64 1
  br label %_INTERNAL_trim_to_complete_utf8_characters.exit
...
bb.k:                                             ; preds = %bb.j, %bb.h, %bb.e, %bb.b
  ...
  br i1 %i.ag, label %.lr.ph.i, label %_INTERNAL_trim_to_complete_utf8_characters.exit
...
bb.b:                                             ; preds = %.lr.ph, %bb.k
  ...
  %i.i = load i8, ptr %.04769, align 1            ; 5 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.s = getelementptr inbounds nuw i8, ptr %.04769, i64 1
  %i.t = load i8, ptr %i.s, align 1
  %i.u = and i8 %i.t, 63
  %i.v = zext nneg i8 %i.u to i16
  %i.w = or disjoint i16 %i.r, %i.v
  %i.x = getelementptr inbounds nuw i8, ptr %.04868, i64 2
  store i16 %i.w, ptr %.04868, align 2
  %i.y = getelementptr inbounds nuw i8, ptr %.04769, i64 2
  br label %bb.k
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ae = getelementptr inbounds nuw i8, ptr %.04769, i64 1
  %i.af = load i8, ptr %i.ae, align 1
  %i.ag = and i8 %i.af, 63
  %i.ah = zext nneg i8 %i.ag to i16
  %i.ai = shl nuw nsw i16 %i.ah, 6
  %i.aj = or disjoint i16 %i.ai, %i.ad
  %i.ak = getelementptr inbounds nuw i8, ptr %.04769, i64 2
  %i.al = load i8, ptr %i.ak, align 1
  %i.am = and i8 %i.al, 63
  %i.an = zext nneg i8 %i.am to i16
  %i.ao = or disjoint i16 %i.aj, %i.an
  %i.ap = getelementptr inbounds nuw i8, ptr %.04868, i64 2
  store i16 %i.ao, ptr %.04868, align 2
  %i.aq = getelementptr inbounds nuw i8, ptr %.04769, i64 3
  br label %bb.k
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.ba = getelementptr inbounds nuw i8, ptr %.04769, i64 1
  %i.bb = load i8, ptr %i.ba, align 1
  %i.bc = and i8 %i.bb, 63
  %i.bd = zext nneg i8 %i.bc to i64
  %i.be = shl nuw nsw i64 %i.bd, 12
  %i.bf = getelementptr inbounds nuw i8, ptr %.04769, i64 2
  %i.bg = load i8, ptr %i.bf, align 1
  %i.bh = and i8 %i.bg, 63
  %i.bi = zext nneg i8 %i.bh to i64
  %i.bj = shl nuw nsw i64 %i.bi, 6                ; 2 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %.04769, i64 3
  ...
  store i16 %i.bt, ptr %.04868, align 2
  %i.bu = or disjoint i64 %i.bj, %i.bn
  %i.bv = trunc nuw nsw i64 %i.bu to i16
  %i.bw = or i16 %i.bv, -9216
  %i.bx = getelementptr inbounds nuw i8, ptr %.04868, i64 2
  store i16 %i.bw, ptr %i.bx, align 2
  %i.by = getelementptr inbounds nuw i8, ptr %.04868, i64 4
  %i.bz = getelementptr inbounds nuw i8, ptr %.04769, i64 4
  br label %bb.k

bb.j:                                             ; preds = %bb.b
  %i.ca = getelementptr inbounds nuw i8, ptr %.04769, i64 1
end_hunk_2
