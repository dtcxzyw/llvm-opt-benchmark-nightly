...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx25 = shl i64 %index, 4               ; 4 uses
  %next.gep26.a = getelementptr i8, ptr %1, i64 %offset.idx25 ; 4 uses
  %i.z = getelementptr i8, ptr %1, i64 %offset.idx25 ; 4 uses
  %next.gep27.a = getelementptr i8, ptr %i.z, i64 16
  %i.aa = getelementptr i8, ptr %1, i64 %offset.idx25 ; 4 uses
  %next.gep28.a = getelementptr i8, ptr %i.aa, i64 32
  %i.ab = getelementptr i8, ptr %1, i64 %offset.idx25 ; 4 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %offset.idx25 = shl i64 %index, 4               ; 4 uses
  %next.gep26.a = getelementptr i8, ptr %1, i64 %offset.idx25 ; 4 uses
  %i.p = getelementptr i8, ptr %1, i64 %offset.idx25 ; 4 uses
  %next.gep27.a = getelementptr i8, ptr %i.p, i64 16
  %i.q = getelementptr i8, ptr %1, i64 %offset.idx25 ; 4 uses
  %next.gep28.a = getelementptr i8, ptr %i.q, i64 32
  %i.r = getelementptr i8, ptr %1, i64 %offset.idx25 ; 4 uses
