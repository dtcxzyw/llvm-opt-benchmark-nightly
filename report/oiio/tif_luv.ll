...
.preheader56:                                     ; preds = %.loopexit, %.preheader56._crit_edge
  ...
  %.163 = phi i32 [ %i.cl, %.preheader56._crit_edge ], [ 100, %.loopexit ] ; 2 uses
...
begin_hunk_2_@oog_encode:bb.a
  ...
  %2 = add nsw i32 %.049.lcssa, %i.cl
  %i.dm = add i32 %.163, %.0.neg.lcssa
  %i.dn = add i32 %i.dm, 99
  %.sink = select i1 %i.dl, i32 %2, i32 %i.dn
  ...
  %3 = getelementptr inbounds [4 x i8], ptr @oog_encode.oog_table, i64 %indvars.iv70
  store i32 %i.dr, ptr %3, align 4, !tbaa !3
