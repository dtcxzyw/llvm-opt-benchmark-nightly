...
LogLuv24toXYZ.exit:                               ; preds = %.lr.ph, %LogL10toY.exit.i, %bb.e
  ...
  %4 = extractelement <2 x double> %i.bl, i64 1
  %5 = tail call double @llvm.fmuladd.f64(double %4, double 2.690000e+00, double %i.bm)
  %6 = fmul double %.sroa.5.0, 1.978000e+00
  %i.bn = insertelement <2 x double> poison, double %5, i64 0
  %i.bo = insertelement <2 x double> %i.bn, double %6, i64 1
...
LogLuv32toXYZ.exit:                               ; preds = %.lr.ph, %LogL16toY.exit.i, %bb.b
  ...
  %4 = extractelement <2 x double> %i.au, i64 1
  %5 = tail call double @llvm.fmuladd.f64(double %4, double 2.690000e+00, double %i.av)
  %6 = fmul double %.sroa.5.0, 1.978000e+00
  %i.aw = insertelement <2 x double> poison, double %5, i64 0
  %i.ax = insertelement <2 x double> %i.aw, double %6, i64 1
