...
.lr.ph.epil.preheader:                            ; preds = %._crit_edge.loopexit.unr-lcssa, %.lr.ph.preheader
  %spec.store.select127134.epil.init = phi i32 [ %i.ah, %.lr.ph.preheader ], [ %spec.store.select.1.a, %._crit_edge.loopexit.unr-lcssa ]
  %spec.store.select5129133.epil.init = phi i32 [ %i.aj, %.lr.ph.preheader ], [ %spec.store.select5.1, %._crit_edge.loopexit.unr-lcssa ]
...
._crit_edge:                                      ; preds = %.lr.ph.epil.preheader, %._crit_edge.loopexit.unr-lcssa, %bb.i
  ...
  %spec.store.select5129.lcssa = phi i32 [ %i.aj, %bb.i ], [ %spec.store.select5.1, %._crit_edge.loopexit.unr-lcssa ], [ %spec.store.select5.epil, %.lr.ph.epil.preheader ] ; 4 uses
  %spec.store.select127.lcssa = phi i32 [ %i.ah, %bb.i ], [ %spec.store.select.1.a, %._crit_edge.loopexit.unr-lcssa ], [ %spec.store.select.epil, %.lr.ph.epil.preheader ] ; 4 uses
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  %spec.store.select127134 = phi i32 [ %i.ah, %.lr.ph.preheader.new ], [ %spec.store.select.1.a, %.lr.ph ]
  ...
  %19 = lshr i32 %spec.store.select5129133, 2
  %i.cp = lshr i32 %spec.store.select2131132, 2
  %spec.store.select.1.a = tail call i32 @llvm.umax.i32(i32 %i.co, i32 1) ; 3 uses
  %spec.store.select5.1 = tail call i32 @llvm.umax.i32(i32 %19, i32 1) ; 3 uses
  %spec.store.select2.1 = tail call i32 @llvm.umax.i32(i32 %i.cp, i32 1) ; 3 uses
