...
begin_hunk_0_@_ZN11OpenImageIO4v3_18DDSInput13seek_subimageEii:bb.a
  ...
  %i.ac = and i32 %i.ab, -2
  %or.cond.i = icmp eq i32 %i.ac, 8               ; 3 uses
...
begin_hunk_1_@_ZN11OpenImageIO4v3_18DDSInput13seek_subimageEii:bb.a
  ...
  %.sroa.0101.0.insert.insert = select i1 %or.cond.i, i64 266, i64 258
...
begin_hunk_2_@_ZN11OpenImageIO4v3_18DDSInput13seek_subimageEii:bb.a
  ...
  %.sroa.099.0.insert.insert = select i1 %or.cond.i, i64 266, i64 258
...
bb.e:                                             ; preds = %bb.a
  ...
  %.not36 = icmp eq i32 %i.ac, 0                  ; 3 uses
...
bb.f:                                             ; preds = %_ZN3fmt3v126detail16do_format_base2eIcjEEPT_iS4_T0_ib.exit
  %i.aj = select i1 %.not36, i32 30768, i32 22576
  %.not.i7 = icmp eq i64 %.sroa.2.0.extract.shift.i, 0
  %4 = select i1 %.not36, i32 7876608, i32 5779456
...
bb.i:                                             ; preds = %_ZN3fmt3v126detail16do_format_base2eIcjEEPT_iS4_T0_ib.exit14
  ...
  %.not39 = icmp eq i32 %i.bf, 0                  ; 2 uses
  %i.bg = select i1 %.not39, i32 25136, i32 16944
  %.not.i15 = icmp eq i64 %.sroa.2.0.extract.shift.i, 0
  %5 = select i1 %.not39, i32 6434816, i32 4337664
...
bb.e:                                             ; preds = %bb.d
  ...
  %.not97 = icmp eq i32 %i.w, 0                   ; 2 uses
  %i.x = select i1 %.not97, i32 30768, i32 22576
  %.not.i = icmp eq i32 %2, 0
  %8 = select i1 %.not97, i32 7876608, i32 5779456
...
bb.k:                                             ; preds = %bb.j
  ...
  %.not100 = icmp eq i32 %i.bj, 0                 ; 2 uses
  %i.bk = select i1 %.not100, i32 25136, i32 16944
  %.not.i63 = icmp eq i32 %2, 0
  %9 = select i1 %.not100, i32 6434816, i32 4337664
...
bb.k:                                             ; preds = %bb.j
  ...
  %.not97 = icmp eq i32 %i.v, 0                   ; 2 uses
  %i.w = select i1 %.not97, i32 30768, i32 22576
  %.not.i = icmp eq i32 %2, 0
  %8 = select i1 %.not97, i32 7876608, i32 5779456
...
bb.e:                                             ; preds = %bb.a
  ...
  %.not37 = icmp eq i32 %i.aa, 0                  ; 3 uses
...
bb.f:                                             ; preds = %_ZN3fmt3v126detail16do_format_base2eIcmEEPT_iS4_T0_ib.exit
  %i.ag = select i1 %.not37, i32 30768, i32 22576
  %.not.i8 = icmp eq i32 %2, 0
  %5 = select i1 %.not37, i32 7876608, i32 5779456
...
bb.i:                                             ; preds = %_ZN3fmt3v126detail16do_format_base2eIcmEEPT_iS4_T0_ib.exit15
  ...
  %.not40 = icmp eq i32 %i.bc, 0                  ; 2 uses
  %i.bd = select i1 %.not40, i32 25136, i32 16944
  %.not.i16 = icmp eq i32 %2, 0
  %6 = select i1 %.not40, i32 6434816, i32 4337664
...
bb.e:                                             ; preds = %bb.a
  %i.ac = and i32 %i.b, 4096
  %.not37 = icmp eq i32 %i.ac, 0                  ; 3 uses
  %.str.47..str.48.i = select i1 %.not37, ptr @.str.48, ptr @.str.47
  br label %.split.i
...
bb.f:                                             ; preds = %_ZN3fmt3v126detail16do_format_base2eIcoEEPT_iS4_T0_ib.exit
  %i.aj = select i1 %.not37, i32 30768, i32 22576
  %.not.i5 = icmp eq i32 %.sroa.2.0.copyload, 0
  %4 = select i1 %.not37, i32 7876608, i32 5779456
...
bb.i:                                             ; preds = %_ZN3fmt3v126detail16do_format_base2eIcoEEPT_iS4_T0_ib.exit12
  %i.bf = and i32 %i.b, 4096
  %.not40 = icmp eq i32 %i.bf, 0                  ; 2 uses
  %i.bg = select i1 %.not40, i32 25136, i32 16944
  %.not.i13 = icmp eq i32 %.sroa.2.0.copyload, 0
  %5 = select i1 %.not40, i32 6434816, i32 4337664
...
.thread217:                                       ; preds = %bb.p
  %6 = select i1 %i.dd, i32 18, i32 17
  %i.kl = add nsw i32 %6, %.neg125
