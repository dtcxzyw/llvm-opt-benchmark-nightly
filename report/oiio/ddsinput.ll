...
begin_hunk_0_@_ZN11OpenImageIO4v3_110ImageInput13read_scanlineEiiNS0_8TypeDescEPvl
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.bc, label %middle.block, label %vector.body, !llvm.loop !185
...
_ZSt4copyIN9__gnu_cxx17__normal_iteratorIPKN11OpenImageIO4v3_18TypeDescESt6vectorIS4_SaIS4_EEEENS1_IPS4_S9_EEET0_T_SE_SD_.exit: ; preds = %.lr.ph.i.i.i.i, %middle.block, %_ZSt4copyIPN11OpenImageIO4v3_18TypeDescES3_ET0_T_S5_S4_.exit, %bb.j, %bb.i, %bb.h, %_ZNSt12_Vector_baseIN11OpenImageIO4v3_18TypeDescESaIS2_EE13_M_deallocateEPS2_m.exit
  %i.bg = load ptr, ptr %0, align 8, !tbaa !130
  %i.bh = getelementptr inbounds nuw i8, ptr %i.bg, i64 %i.f
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 8
  store ptr %i.bh, ptr %i.bi, align 8, !tbaa !183
  br label %bb.o
...
.lr.ph.i.i.i.i.i32:                               ; preds = %bb.g, %.lr.ph.i.i.i.i.i32
  ...
  br i1 %i.bb, label %.lr.ph.i.i.i.i.i32, label %_ZSt4copyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES6_ET0_T_S8_S7_.exit.loopexit, !llvm.loop !191
end_hunk_0
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail14format_decimalIcjNS0_14basic_appenderIcEETnNSt9enable_ifIXntsr3std10is_pointerINSt9remove_cvINSt16remove_referenceIT1_E4typeEE4typeEEE5valueEiE4typeELi0EEES8_S8_T0_i(ptr %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #6 {
bb.a:
  %i.a = alloca [10 x i8], align 1                ; 7 uses
  %i.b = zext i32 %2 to i64                       ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  %i.d = load i64, ptr %i.c, align 8, !tbaa !235  ; 2 uses
  %i.e = add i64 %i.d, %i.b                       ; 3 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.g = load i64, ptr %i.f, align 8, !tbaa !231
...
_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i: ; preds = %bb.a
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.e), !inline_history !278
  %.pre.i = load i64, ptr %i.c, align 8, !tbaa !235 ; 2 uses
  %.pre14.i = load i64, ptr %i.f, align 8, !tbaa !231
...
_ZN3fmt3v126detail10to_pointerIcEEPT_NS0_14basic_appenderIS3_EEm.exit: ; preds = %bb.a, %_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i
  ...
  store i64 %.pre-phi19.i, ptr %i.c, align 8, !tbaa !235
  %i.m = load ptr, ptr %0, align 8, !tbaa !230    ; 2 uses
...
.lr.ph.i:                                         ; preds = %bb.b, %.lr.ph.i
  ...
  br i1 %i.y, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !252
...
bb.d:                                             ; preds = %._crit_edge.i
  ...
  store i8 %i.ai, ptr %i.al, align 1, !tbaa !9
  br label %_ZN3fmt3v126detail17do_format_decimalIcjEEPT_S4_T0_i.exit
...
.lr.ph.i16:                                       ; preds = %_ZN3fmt3v126detail10to_pointerIcEEPT_NS0_14basic_appenderIS3_EEm.exit.thread, %.lr.ph.i16
  ...
  br i1 %i.aw, label %.lr.ph.i16, label %._crit_edge.i12, !llvm.loop !252
...
define linkonce_odr hidden ptr @_ZN3fmt3v126detail13copy_noinlineIcPcNS0_14basic_appenderIcEEEET1_T0_S7_S6_(ptr noundef %0, ptr noundef %1, ptr %2) local_unnamed_addr #29 {
bb.a:
...
.lr.ph34.i.i:                                     ; preds = %bb.a
  ...
  %.pre.i.i = load i64, ptr %i.a, align 8, !tbaa !235
  br label %bb.b
...
bb.b:                                             ; preds = %._crit_edge.i.i, %.lr.ph34.i.i
  ...
  %i.f = load i64, ptr %i.b, align 8, !tbaa !231
  %i.g = sub i64 %i.f, %i.e
...
bb.c:                                             ; preds = %bb.b
  %i.k = load ptr, ptr %i.d, align 8, !tbaa !228
  %i.l = add i64 %i.i, %i.e
  tail call void %i.k(ptr noundef nonnull align 8 dereferenceable(32) %2, i64 noundef %i.l), !inline_history !280
  %i.m = load i64, ptr %i.a, align 8, !tbaa !235  ; 2 uses
  %i.n = load i64, ptr %i.b, align 8, !tbaa !231
  %i.o = sub i64 %i.n, %i.m
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.q = load ptr, ptr %2, align 8, !tbaa !230    ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.v, align 1, !tbaa !9
  %wide.load8 = load <16 x i8>, ptr %i.w, align 1, !tbaa !9
  %i.x = getelementptr inbounds nuw i8, ptr %i.s, i64 %index ; 2 uses
  %i.y = getelementptr inbounds nuw i8, ptr %i.x, i64 16
  store <16 x i8> %wide.load, ptr %i.x, align 1, !tbaa !9
  store <16 x i8> %wide.load8, ptr %i.y, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.z = icmp eq i64 %index.next, %n.vec
  br i1 %i.z, label %middle.block, label %vector.body, !llvm.loop !281
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load12 = load <4 x i8>, ptr %i.aa, align 1, !tbaa !9
  %i.ab = getelementptr inbounds nuw i8, ptr %i.s, i64 %index11
  store <4 x i8> %wide.load12, ptr %i.ab, align 1, !tbaa !9
  %index.next13 = add nuw i64 %index11, 4         ; 2 uses
  %i.ac = icmp eq i64 %index.next13, %n.vec10
  br i1 %i.ac, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !283
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !284
...
._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i = load i64, ptr %i.a, align 8, !tbaa !235
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.d
  ...
  store i64 %i.ak, ptr %i.a, align 8, !tbaa !235
  %i.al = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i = icmp eq ptr %i.al, %1
  br i1 %.not.i.i, label %_ZN3fmt3v126detail4copyIcPcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS7_T0_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit, label %bb.b, !llvm.loop !285
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i.3, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !286
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail5writeIcNS0_14basic_appenderIcEExTnNSt9enable_ifIXaaaasr11is_integralIT1_EE5valuentsr3std7is_sameIS6_bEE5valuentsr3std7is_sameIS6_T_EE5valueEiE4typeELi0EEET0_SA_S6_(ptr %0, i64 noundef %1) local_unnamed_addr #6 {
bb.a:
  ...
  %i.j = load i64, ptr %i.i, align 8, !tbaa !145
  ...
  %i.p = load i64, ptr %i.o, align 8, !tbaa !235  ; 2 uses
  %i.q = add i64 %i.n, %i.p                       ; 3 uses
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.s = load i64, ptr %i.r, align 8, !tbaa !231  ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i: ; preds = %bb.a
  ...
  tail call void %i.v(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.q), !inline_history !278
  %.pre.i = load i64, ptr %i.o, align 8, !tbaa !235 ; 3 uses
  %.pre14.i = load i64, ptr %i.r, align 8, !tbaa !231 ; 3 uses
...
_ZN3fmt3v126detail10to_pointerIcEEPT_NS0_14basic_appenderIS3_EEm.exit: ; preds = %bb.a, %_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i
  ...
  store i64 %.pre-phi19.i, ptr %i.o, align 8, !tbaa !235
  %i.z = load ptr, ptr %0, align 8, !tbaa !230    ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  store i8 45, ptr %i.aa, align 1, !tbaa !9
  br label %bb.d
...
.lr.ph.i:                                         ; preds = %bb.d, %.lr.ph.i
  ...
  br i1 %i.al, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !254
...
end_hunk_1
begin_hunk_2_@_ZN3fmt3v126detail12write_paddedIcLNS0_5alignE1ENS0_14basic_appenderIcEERZNS1_10write_charIcS5_EET0_S7_T_RKNS0_12format_specsEEUlS5_E_EET1_SE_SB_mmOT2_
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ac = load i8, ptr %4, align 1, !tbaa !300, !range !204, !noundef !205
  %i.ad = trunc nuw i8 %i.ac to i1
  %i.ae = getelementptr inbounds nuw i8, ptr %4, i64 1
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !302 ; 2 uses
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.ai = load i64, ptr %i.ah, align 8, !tbaa !235 ; 2 uses
  %i.aj = add i64 %i.ai, 1                        ; 3 uses
  %i.ak = getelementptr inbounds nuw i8, ptr %.sroa.09.0, i64 16
  %i.al = load i64, ptr %i.ak, align 8, !tbaa !231
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ao = load ptr, ptr %i.an, align 8, !tbaa !228
  tail call void %i.ao(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.aj), !inline_history !347
  %.pre.i.i.i = load i64, ptr %i.ah, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.g, %bb.f
  ...
  %i.aq = load ptr, ptr %.sroa.09.0, align 8, !tbaa !230
  store i64 %.pre-phi.i.i.i, ptr %i.ah, align 8, !tbaa !235
  %i.ar = getelementptr inbounds nuw i8, ptr %i.aq, i64 %i.ap
  store i8 %i.af, ptr %i.ar, align 1, !tbaa !9
  br label %_ZZN3fmt3v126detail10write_charIcNS0_14basic_appenderIcEEEET0_S5_T_RKNS0_12format_specsEENKUlS4_E_clES4_.exit
...
; Function Attrs: mustprogress noinline uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail4fillIcNS0_14basic_appenderIcEEEET0_S5_mRKNS0_11basic_specsE(ptr %0, i64 noundef %1, ptr noundef nonnull align 4 dereferenceable(8) %2) local_unnamed_addr #29 {
bb.a:
  %i.a = load i32, ptr %2, align 4, !tbaa !255
  %i.b = lshr i32 %i.a, 15
...
bb.b:                                             ; preds = %bb.a
  %i.g = load i8, ptr %i.f, align 4, !tbaa !9
...
bb.c:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %.lr.ph.i
  ...
  %i.k = load i64, ptr %i.h, align 8, !tbaa !235  ; 2 uses
  %i.l = add i64 %i.k, 1                          ; 3 uses
  %i.m = load i64, ptr %i.i, align 8, !tbaa !231
  %i.n = icmp ugt i64 %i.l, %i.m
  br i1 %i.n, label %bb.d, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i

bb.d:                                             ; preds = %bb.c
  %i.o = load ptr, ptr %i.j, align 8, !tbaa !228
  tail call void %i.o(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.l), !inline_history !348
  %.pre.i.i.i = load i64, ptr %i.h, align 8, !tbaa !235 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.d, %bb.c
  ...
  %i.q = load ptr, ptr %0, align 8, !tbaa !230
  store i64 %.pre-phi.i.i.i, ptr %i.h, align 8, !tbaa !235
  %i.r = getelementptr inbounds nuw i8, ptr %i.q, i64 %i.p
  store i8 %i.g, ptr %i.r, align 1, !tbaa !9
  %i.s = add nuw i64 %.04.i, 1                    ; 2 uses
  %exitcond.not.i = icmp eq i64 %i.s, %1
  br i1 %exitcond.not.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEmcEET_S5_T0_RKT1_.exit, label %bb.c, !llvm.loop !349
...
.lr.ph34.i.i.preheader:                           ; preds = %.lr.ph
  %.pre.i.i.pre = load i64, ptr %i.u, align 8, !tbaa !235
...
bb.f:                                             ; preds = %._crit_edge.i.i, %.lr.ph34.i.i
  ...
  %i.z = load i64, ptr %i.v, align 8, !tbaa !231
...
bb.g:                                             ; preds = %bb.f
  %i.ae = load ptr, ptr %i.x, align 8, !tbaa !228
  %i.af = add i64 %i.ac, %i.y
  tail call void %i.ae(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.af), !inline_history !305
  %i.ag = load i64, ptr %i.u, align 8, !tbaa !235 ; 2 uses
  %i.ah = load i64, ptr %i.v, align 8, !tbaa !231
...
bb.h:                                             ; preds = %bb.g, %bb.f
  ...
  %i.ak = load ptr, ptr %0, align 8, !tbaa !230   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load32 = load <16 x i8>, ptr %i.aq, align 1, !tbaa !9
  %i.ar = getelementptr inbounds nuw i8, ptr %i.am, i64 %index ; 2 uses
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 16
  store <16 x i8> %wide.load, ptr %i.ar, align 1, !tbaa !9
  store <16 x i8> %wide.load32, ptr %i.as, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.at = icmp eq i64 %index.next, %n.vec
  br i1 %i.at, label %middle.block, label %vector.body, !llvm.loop !350
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load36 = load <4 x i8>, ptr %i.au, align 1, !tbaa !9
  %i.av = getelementptr inbounds nuw i8, ptr %i.am, i64 %index35
  store <4 x i8> %wide.load36, ptr %i.av, align 1, !tbaa !9
  %index.next37 = add nuw i64 %index35, 4         ; 2 uses
  %i.aw = icmp eq i64 %index.next37, %n.vec34
  br i1 %i.aw, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !351
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !352
...
._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i = load i64, ptr %i.u, align 8, !tbaa !235
  br label %._crit_edge.i.i
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.h
  ...
  store i64 %i.be, ptr %i.u, align 8, !tbaa !235
  %i.bf = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i = icmp eq ptr %i.bf, %i.t
  br i1 %.not.i.i, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit.loopexit, label %bb.f, !llvm.loop !285
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i.3, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !353
...
_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit.loopexit: ; preds = %._crit_edge.i.i
  ...
  br i1 %exitcond.not, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEmcEET_S5_T0_RKT1_.exit, label %.lr.ph34.i.i, !llvm.loop !354
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail18write_escaped_charIcNS0_14basic_appenderIcEEEET0_S5_T_(ptr %0, i8 noundef signext %1) local_unnamed_addr #6 {
bb.a:
  ...
  %i.c = load i64, ptr %i.b, align 8, !tbaa !235  ; 2 uses
  %i.d = add i64 %i.c, 1                          ; 3 uses
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.f = load i64, ptr %i.e, align 8, !tbaa !231
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void %i.i(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.d), !inline_history !279
  %.pre.i.i = load i64, ptr %i.b, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit:          ; preds = %bb.a, %bb.b
  ...
  store i64 %.pre-phi.i.i, ptr %i.b, align 8, !tbaa !235
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 %i.j
  store i8 39, ptr %i.l, align 1, !tbaa !9
...
bb.d:                                             ; preds = %_ZN3fmt3v126detail12needs_escapeEj.exit
  ...
  store ptr %i.a, ptr %2, align 8, !tbaa !355
  %i.s = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.t = getelementptr inbounds nuw i8, ptr %i.a, i64 1
  store ptr %i.t, ptr %i.s, align 8, !tbaa !357
  %i.u = getelementptr inbounds nuw i8, ptr %2, i64 16
  store i32 %i.m, ptr %i.u, align 8, !tbaa !358
...
bb.e:                                             ; preds = %_ZN3fmt3v126detail12needs_escapeEj.exit
  %i.w = load i64, ptr %i.b, align 8, !tbaa !235  ; 2 uses
  %i.x = add i64 %i.w, 1                          ; 3 uses
  %i.y = load i64, ptr %i.e, align 8, !tbaa !231
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.ab(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.x), !inline_history !279
  %.pre.i.i15 = load i64, ptr %i.b, align 8, !tbaa !235 ; 2 uses
end_hunk_2
begin_hunk_3_@_ZN3fmt3v126detail15write_codepointILm8EcNS0_14basic_appenderIcEEEET1_S5_cj:bb.a
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #34
  ret ptr %0
}

; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZNK3fmt3v126detail14digit_groupingIcE5applyINS0_14basic_appenderIcEEcEET_S7_NS0_17basic_string_viewIT0_EE(ptr noundef nonnull align 8 dereferenceable(64) %0, ptr %1, ptr %2, i64 %3) local_unnamed_addr #6 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %4 = alloca %"class.fmt::v12::basic_memory_buffer.48", align 8 ; 13 uses
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIiLm500ENS0_6detail9allocatorIiEEE4growERNS2_6bufferIiEEm, ptr %i.c, align 8, !tbaa !362
  %i.e = getelementptr inbounds nuw i8, ptr %4, i64 32 ; 6 uses
  store ptr %i.e, ptr %4, align 8, !tbaa !364
  store i64 500, ptr %i.b, align 8, !tbaa !365
  store i64 1, ptr %i.d, align 8, !tbaa !366
...
.lr.ph:                                           ; preds = %bb.a
  %i.i = load ptr, ptr %0, align 8, !tbaa !87
...
bb.b:                                             ; preds = %.lr.ph, %bb.i
  ...
  %i.n = load ptr, ptr %0, align 8, !tbaa !87
  %i.o = load i64, ptr %i.j, align 8, !tbaa !40
...
bb.c:                                             ; preds = %bb.b
  ...
  %.sink.i.pre = load i8, ptr %i.r, align 1, !tbaa !9
  br label %_ZNK3fmt3v126detail14digit_groupingIcE4nextERNS3_10next_stateE.exit

bb.d:                                             ; preds = %bb.b
  %i.s = load i8, ptr %.sroa.039.055, align 1, !tbaa !9 ; 2 uses
  %i.t = add i8 %i.s, -127
...
bb.g:                                             ; preds = %_ZNK3fmt3v126detail14digit_groupingIcE4nextERNS3_10next_stateE.exit
  ...
  %i.z = load i64, ptr %i.b, align 8, !tbaa !365
  %i.aa = icmp ugt i64 %i.y, %i.z
  br i1 %i.aa, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %i.ab = load ptr, ptr %i.c, align 8, !tbaa !362
  invoke void %i.ab(ptr noundef nonnull align 8 dereferenceable(32) %4, i64 noundef %i.y)
          to label %.noexc31 unwind label %bb.f, !inline_history !367

.noexc31:                                         ; preds = %bb.h
  %.pre.i29 = load i64, ptr %i.d, align 8, !tbaa !366 ; 2 uses
  %.pre2.i30 = add i64 %.pre.i29, 1
  %.pre = load ptr, ptr %4, align 8, !tbaa !364
  %.pre63 = load i64, ptr %i.f, align 8, !tbaa !40
  br label %bb.i
...
bb.i:                                             ; preds = %.noexc31, %bb.g
  ...
  store i64 %.pre-phi.i28, ptr %i.d, align 8, !tbaa !366
...
._crit_edge.loopexit:                             ; preds = %bb.s
  %.pre64 = load ptr, ptr %4, align 8, !tbaa !364
  br label %._crit_edge
...
bb.j:                                             ; preds = %._crit_edge
  call void @free(ptr noundef %i.as) #34
...
bb.k:                                             ; preds = %.lr.ph60, %bb.s
  ...
  %i.au = load ptr, ptr %4, align 8, !tbaa !364
...
bb.l:                                             ; preds = %bb.k
  %i.ba = load ptr, ptr %i.ao, align 8, !tbaa !87 ; 2 uses
  %i.bb = load i64, ptr %i.f, align 8, !tbaa !40  ; 2 uses
...
.lr.ph34.i.i:                                     ; preds = %bb.l
  ...
  %.pre.i.i = load i64, ptr %i.ap, align 8, !tbaa !235
  br label %bb.m
...
bb.m:                                             ; preds = %._crit_edge.i.i, %.lr.ph34.i.i
  ...
  %i.bf = load i64, ptr %i.aq, align 8, !tbaa !231
...
bb.n:                                             ; preds = %bb.m
  %i.bk = load ptr, ptr %i.ar, align 8, !tbaa !228
  %i.bl = add i64 %i.bi, %i.be
  invoke void %i.bk(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.bl)
          to label %.noexc34 unwind label %bb.p, !inline_history !368

.noexc34:                                         ; preds = %bb.n
  %i.bm = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
  %i.bn = load i64, ptr %i.aq, align 8, !tbaa !231
...
bb.o:                                             ; preds = %.noexc34, %bb.m
  ...
  %i.bq = load ptr, ptr %1, align 8, !tbaa !230   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.bv, align 1, !tbaa !9
  %wide.load78 = load <16 x i8>, ptr %i.bw, align 1, !tbaa !9
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bs, i64 %index ; 2 uses
  %i.by = getelementptr inbounds nuw i8, ptr %i.bx, i64 16
  store <16 x i8> %wide.load, ptr %i.bx, align 1, !tbaa !9
  store <16 x i8> %wide.load78, ptr %i.by, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bz = icmp eq i64 %index.next, %n.vec
  br i1 %i.bz, label %middle.block, label %vector.body, !llvm.loop !369
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.cc, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !370
...
._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i = load i64, ptr %i.ap, align 8, !tbaa !235
  br label %._crit_edge.i.i
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.o
  ...
  store i64 %i.ck, ptr %i.ap, align 8, !tbaa !235
  %i.cl = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i33 = icmp eq ptr %i.cl, %i.bc
  br i1 %.not.i.i33, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit, label %bb.m, !llvm.loop !285
...
bb.q:                                             ; preds = %bb.k, %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit
  ...
  %i.dg = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
  %i.dh = add i64 %i.dg, 1                        ; 3 uses
  %i.di = load i64, ptr %i.aq, align 8, !tbaa !231
  %i.dj = icmp ugt i64 %i.dh, %i.di
  br i1 %i.dj, label %bb.r, label %bb.s

bb.r:                                             ; preds = %bb.q
  %i.dk = load ptr, ptr %i.ar, align 8, !tbaa !228
  invoke void %i.dk(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.dh)
          to label %.noexc36 unwind label %bb.t, !inline_history !373

.noexc36:                                         ; preds = %bb.r
  %.pre.i.i35 = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
...
bb.s:                                             ; preds = %.noexc36, %bb.q
  ...
  %i.dm = load ptr, ptr %1, align 8, !tbaa !230
  store i64 %.pre-phi.i.i, ptr %i.ap, align 8, !tbaa !235
  %i.dn = getelementptr inbounds nuw i8, ptr %i.dm, i64 %i.dl
  store i8 %i.df, ptr %i.dn, align 1, !tbaa !9
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge.loopexit, label %bb.k, !llvm.loop !374
...
bb.u:                                             ; preds = %bb.f, %bb.t, %bb.p
  ...
  %i.dp = load ptr, ptr %4, align 8, !tbaa !364   ; 2 uses
...
bb.a:
  ...
  %i.b = load i64, ptr %i.a, align 8, !tbaa !365  ; 2 uses
  %i.c = lshr i64 %i.b, 1
...
bb.d:                                             ; preds = %bb.a, %bb.b, %bb.c
  ...
  %i.h = load ptr, ptr %0, align 8, !tbaa !364    ; 3 uses
  %i.i = shl i64 %.0, 2
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ac = load ptr, ptr %4, align 8, !tbaa !379, !nonnull !205, !align !210
...
bb.e:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %.lr.ph.i
  ...
  %i.aj = load i64, ptr %i.af, align 8, !tbaa !235 ; 2 uses
  %i.ak = add i64 %i.aj, 1                        ; 3 uses
  %i.al = load i64, ptr %i.ag, align 8, !tbaa !231
  %i.am = icmp ugt i64 %i.ak, %i.al
  br i1 %i.am, label %bb.f, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i

bb.f:                                             ; preds = %bb.e
  %i.an = load ptr, ptr %i.ah, align 8, !tbaa !228
  tail call void %i.an(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ak), !inline_history !381
  %.pre.i.i.i = load i64, ptr %i.af, align 8, !tbaa !235 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.f, %bb.e
  ...
  %i.ap = load ptr, ptr %.sroa.09.0, align 8, !tbaa !230
  store i64 %.pre-phi.i.i.i, ptr %i.af, align 8, !tbaa !235
  ...
  br i1 %.not.i, label %_ZZN3fmt3v126detail9write_intINS0_14basic_appenderIcEEocEET_S5_T0_jRKNS0_12format_specsERKNS1_14digit_groupingIT1_EEENKUlS4_E_clES4_.exit, label %bb.e, !llvm.loop !382
...
_ZZN3fmt3v126detail9write_intINS0_14basic_appenderIcEEocEET_S5_T0_jRKNS0_12format_specsERKNS1_14digit_groupingIT1_EEENKUlS4_E_clES4_.exit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %bb.d
  ...
  %i.at = load ptr, ptr %i.as, align 8, !tbaa !383, !nonnull !205, !align !213
  %i.au = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !384, !nonnull !205, !align !213 ; 2 uses
  %i.aw = load ptr, ptr %i.av, align 8, !tbaa !230
  %i.ax = getelementptr inbounds nuw i8, ptr %i.av, i64 8
  %i.ay = load i64, ptr %i.ax, align 8, !tbaa !235
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  %.sroa.09.0 = phi ptr [ %i.ab, %bb.c ], [ %0, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit ] ; 7 uses
  %i.ac = load ptr, ptr %4, align 8, !tbaa !385   ; 2 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.ae = load i64, ptr %i.ad, align 8, !tbaa !386 ; 2 uses
...
.lr.ph34.i.i.i:                                   ; preds = %bb.d
  ...
  %.pre.i.i.i = load i64, ptr %i.ag, align 8, !tbaa !235
  br label %bb.e
...
bb.e:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.al = load i64, ptr %i.ah, align 8, !tbaa !231
...
bb.f:                                             ; preds = %bb.e
  %i.aq = load ptr, ptr %i.aj, align 8, !tbaa !228
  %i.ar = add i64 %i.ao, %i.ak
  tail call void %i.aq(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ar), !inline_history !387
  %i.as = load i64, ptr %i.ag, align 8, !tbaa !235 ; 2 uses
  %i.at = load i64, ptr %i.ah, align 8, !tbaa !231
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.aw = load ptr, ptr %.sroa.09.0, align 8, !tbaa !230 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.bb, align 1, !tbaa !9
  %wide.load36 = load <16 x i8>, ptr %i.bc, align 1, !tbaa !9
  %i.bd = getelementptr inbounds nuw i8, ptr %i.ay, i64 %index ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 16
  store <16 x i8> %wide.load, ptr %i.bd, align 1, !tbaa !9
  store <16 x i8> %wide.load36, ptr %i.be, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bf = icmp eq i64 %index.next, %n.vec
  br i1 %i.bf, label %middle.block, label %vector.body, !llvm.loop !388
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load40 = load <4 x i8>, ptr %i.bg, align 1, !tbaa !9
  %i.bh = getelementptr inbounds nuw i8, ptr %i.ay, i64 %index39
  store <4 x i8> %wide.load40, ptr %i.bh, align 1, !tbaa !9
  %index.next41 = add nuw i64 %index39, 4         ; 2 uses
  %i.bi = icmp eq i64 %index.next41, %n.vec38
  br i1 %i.bi, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !389
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !390
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.ag, align 8, !tbaa !235
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.g
  ...
  store i64 %i.bq, ptr %i.ag, align 8, !tbaa !235
  %i.br = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.br, %i.af
  br i1 %.not.i.i.i, label %_ZZN3fmt3v126detail11write_bytesIcLNS0_5alignE1ENS0_14basic_appenderIcEEEET1_S6_NS0_17basic_string_viewIcEERKNS0_12format_specsEENKUlS5_E_clES5_.exit, label %bb.e, !llvm.loop !285
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !391
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail5writeIcNS0_14basic_appenderIcEEfTnNSt9enable_ifIXsr13is_fast_floatIT1_EE5valueEiE4typeELi0EEET0_S9_S6_(ptr %0, float noundef %1) local_unnamed_addr #6 {
bb.a:
  %i.a = alloca [11 x i8], align 1                ; 8 uses
  %2 = alloca %"struct.fmt::v12::format_specs", align 8 ; 5 uses
  %3 = alloca %class.anon.63, align 8             ; 5 uses
...
_ZN3fmt3v126detail15write_nonfiniteIcNS0_14basic_appenderIcEEEET0_S5_bNS0_12format_specsENS0_4signE.exit: ; preds = %bb.a
  ...
  %i.h = select i1 %i.f, ptr @.str.54, ptr @.str.56
  %.not.not.i = icmp sgt i32 %i.b, -1
  %i.i = select i1 %.not.not.i, i64 3, i64 4      ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #34
  store i32 %.lobit, ptr %3, align 8, !tbaa !392
  %i.j = getelementptr inbounds nuw i8, ptr %3, i64 8
  store ptr %i.h, ptr %i.j, align 8, !tbaa !395
...
bb.b:                                             ; preds = %bb.a
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #34
  %i.l = tail call i64 @_ZN3fmt3v126detail9dragonbox10to_decimalIfEENS2_10decimal_fpIT_EES5_(float noundef %1) #34 ; 5 uses
  ...
  %i.s = load i64, ptr %i.r, align 8, !tbaa !145
...
bb.c:                                             ; preds = %bb.b
  ...
  store i32 32768, ptr %5, align 4, !tbaa !255
  %i.ad = getelementptr inbounds nuw i8, ptr %5, i64 4
  store i8 32, ptr %i.ad, align 4, !tbaa !9
  ...
  store i32 -1, ptr %i.ae, align 4, !tbaa !257
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.au = load ptr, ptr %i.at, align 8, !tbaa !228
  tail call void %i.au(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.ap), !inline_history !279
  %.pre.i.i27 = load i64, ptr %i.an, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit29:        ; preds = %bb.j, %bb.k
  ...
  %i.aw = load ptr, ptr %1, align 8, !tbaa !230
  store i64 %.pre-phi.i.i26, ptr %i.an, align 8, !tbaa !235
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 %i.av
  store i8 %i.am, ptr %i.ax, align 1, !tbaa !9
  br label %bb.l
...
bb.l:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit29, %bb.f
  ...
  %i.bb = load i8, ptr %i.ba, align 2, !tbaa !9
  %i.bc = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 6 uses
  %i.bd = load i64, ptr %i.bc, align 8, !tbaa !235 ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  ...
  tail call void %i.bj(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.be), !inline_history !279
  %.pre.i.i32 = load i64, ptr %i.bc, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit34:        ; preds = %bb.l, %bb.m
  ...
  %i.bl = load ptr, ptr %1, align 8, !tbaa !230
  store i64 %.pre-phi.i.i31, ptr %i.bc, align 8, !tbaa !235
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 %i.bk
  store i8 %i.bb, ptr %i.bm, align 1, !tbaa !9
  %i.bn = getelementptr inbounds nuw i8, ptr %i.ba, i64 1
  %i.bo = load i8, ptr %i.bn, align 1, !tbaa !9
  %i.bp = load i64, ptr %i.bc, align 8, !tbaa !235 ; 2 uses
  %i.bq = add i64 %i.bp, 1                        ; 3 uses
  %i.br = load i64, ptr %i.bf, align 8, !tbaa !231
...
bb.n:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit34
  ...
  %i.bu = load ptr, ptr %i.bt, align 8, !tbaa !228
  tail call void %i.bu(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.bq), !inline_history !279
  %.pre.i.i37 = load i64, ptr %i.bc, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit39:        ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit34, %bb.n
  ...
  %i.bw = load ptr, ptr %1, align 8, !tbaa !230
  store i64 %.pre-phi.i.i36, ptr %i.bc, align 8, !tbaa !235
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 %i.bv
  store i8 %i.bo, ptr %i.bx, align 1, !tbaa !9
  ret ptr %1
}
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ac = load i32, ptr %4, align 8, !tbaa !392   ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !235 ; 2 uses
  %i.ai = add i64 %i.ah, 1                        ; 3 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %.sroa.09.0, i64 16
  %i.ak = load i64, ptr %i.aj, align 8, !tbaa !231
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.an = load ptr, ptr %i.am, align 8, !tbaa !228
  tail call void %i.an(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ai), !inline_history !408
  %.pre.i.i.i = load i64, ptr %i.ag, align 8, !tbaa !235 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.f, %bb.e
  ...
  %i.ap = load ptr, ptr %.sroa.09.0, align 8, !tbaa !230
  store i64 %.pre-phi.i.i.i, ptr %i.ag, align 8, !tbaa !235
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 %i.ao
  store i8 %i.af, ptr %i.aq, align 1, !tbaa !9
  br label %bb.g

bb.g:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %bb.d
  %i.ar = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !395 ; 2 uses
  ...
  %.pre.i.i2.i = load i64, ptr %i.au, align 8, !tbaa !235
  br label %bb.h
...
bb.h:                                             ; preds = %._crit_edge.i.i.i, %bb.g
  ...
  %i.ay = load i64, ptr %i.av, align 8, !tbaa !231
...
bb.i:                                             ; preds = %bb.h
  %i.bb = load ptr, ptr %i.aw, align 8, !tbaa !228
  %i.bc = add i64 %gepdiff.i, %i.ax
  tail call void %i.bb(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.bc), !inline_history !409
  %i.bd = load i64, ptr %i.au, align 8, !tbaa !235 ; 2 uses
  %i.be = load i64, ptr %i.av, align 8, !tbaa !231
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %i.bh = load ptr, ptr %.sroa.09.0, align 8, !tbaa !230 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.bn, align 1, !tbaa !9
  %wide.load36 = load <16 x i8>, ptr %i.bo, align 1, !tbaa !9
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bj, i64 %index ; 2 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 16
  store <16 x i8> %wide.load, ptr %i.bp, align 1, !tbaa !9
  store <16 x i8> %wide.load36, ptr %i.bq, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.br = icmp eq i64 %index.next, %n.vec
  br i1 %i.br, label %middle.block, label %vector.body, !llvm.loop !410
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load40 = load <4 x i8>, ptr %i.bs, align 1, !tbaa !9
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bj, i64 %index39
  store <4 x i8> %wide.load40, ptr %i.bt, align 1, !tbaa !9
  %index.next41 = add nuw i64 %index39, 4         ; 2 uses
  %i.bu = icmp eq i64 %index.next41, %n.vec38
  br i1 %i.bu, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !411
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !412
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.au, align 8, !tbaa !235
  br label %._crit_edge.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.j
  ...
  store i64 %i.cc, ptr %i.au, align 8, !tbaa !235
  %.02532.i.i.add.i = add nuw nsw i64 %.026.i.i.i, %.02532.i.i.idx.i ; 2 uses
  %.not.i.i.i = icmp eq i64 %.02532.i.i.add.i, 3
  br i1 %.not.i.i.i, label %_ZZN3fmt3v126detail15write_nonfiniteIcNS0_14basic_appenderIcEEEET0_S5_bNS0_12format_specsENS0_4signEENKUlS4_E_clES4_.exit, label %bb.h, !llvm.loop !285
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !413
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load i64, ptr %i.f, align 8, !tbaa !235  ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !228
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.h), !inline_history !279
  %.pre.i.i = load i64, ptr %i.f, align 8, !tbaa !235 ; 2 uses
  %.pre2.i.i = add i64 %.pre.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit:          ; preds = %bb.b, %bb.c
  ...
  %i.o = load ptr, ptr %1, align 8, !tbaa !230
  store i64 %.pre-phi.i.i, ptr %i.f, align 8, !tbaa !235
...
bb.d:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit, %bb.a
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !416, !nonnull !205, !align !210 ; 2 uses
  %i.s = load i32, ptr %i.r, align 4, !tbaa !417
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !418, !nonnull !205, !align !210
  %i.v = load i32, ptr %i.u, align 4, !tbaa !3
  %i.w = getelementptr inbounds nuw i8, ptr %i.r, i64 4
  %i.x = load i32, ptr %i.w, align 4, !tbaa !398  ; 2 uses
...
bb.e:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i.i, %.lr.ph.i.i
  ...
  %i.ad = load i64, ptr %i.aa, align 8, !tbaa !235 ; 2 uses
  %i.ae = add i64 %i.ad, 1                        ; 3 uses
  %i.af = load i64, ptr %i.ab, align 8, !tbaa !231
  %i.ag = icmp ugt i64 %i.ae, %i.af
  br i1 %i.ag, label %bb.f, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i.i

bb.f:                                             ; preds = %bb.e
  %i.ah = load ptr, ptr %i.ac, align 8, !tbaa !228
  tail call void %i.ah(ptr noundef nonnull align 8 dereferenceable(32) %i.y, i64 noundef %i.ae), !inline_history !419
  %.pre.i.i.i.i = load i64, ptr %i.aa, align 8, !tbaa !235 ; 2 uses
...
bb.f:                                             ; preds = %bb.d, %bb.e, %bb.a
  ...
  %.str.47..str.48.i.i = select i1 %.not90, ptr @.str.48, ptr @.str.47
  br label %.split.i.i
...
.split.i.i:                                       ; preds = %.split.i.i, %bb.f
  ...
  %i.ag = getelementptr inbounds nuw i8, ptr %.str.47..str.48.i.i, i64 %i.af
  ...
  br i1 %.not.i.i, label %_ZN3fmt3v126detail13format_base2eIcoEEPT_iS4_T0_ib.exit.preheader, label %.split.i.i, !llvm.loop !376
...
_ZN3fmt3v126detail13format_base2eIcoEEPT_iS4_T0_ib.exit: ; preds = %.lr.ph
  ...
  br i1 %.not91, label %.critedge, label %.lr.ph, !llvm.loop !479
...
.critedge:                                        ; preds = %.lr.ph, %_ZN3fmt3v126detail13format_base2eIcoEEPT_iS4_T0_ib.exit, %_ZN3fmt3v126detail13format_base2eIcoEEPT_iS4_T0_ib.exit.preheader
  ...
  %i.aq = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
  %i.ar = add i64 %i.aq, 1                        ; 3 uses
  %i.as = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 9 uses
  %i.at = load i64, ptr %i.as, align 8, !tbaa !231
...
bb.g:                                             ; preds = %.critedge
  ...
  tail call void %i.aw(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ar), !inline_history !480
  %.pre.i = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit:  ; preds = %.critedge, %bb.g
  ...
  %i.ay = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i, ptr %i.ap, align 8, !tbaa !235
  %i.az = getelementptr inbounds nuw i8, ptr %i.ay, i64 %i.ax
  store i8 48, ptr %i.az, align 1, !tbaa !9
  %i.ba = select i1 %.not90, i8 120, i8 88
  %i.bb = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
  %i.bc = add i64 %i.bb, 1                        ; 3 uses
  %i.bd = load i64, ptr %i.as, align 8, !tbaa !231
...
bb.h:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit
  ...
  tail call void %i.bg(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bc), !inline_history !480
  %.pre.i40 = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit, %bb.h
  ...
  %i.bi = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i39, ptr %i.ap, align 8, !tbaa !235
  %i.bj = getelementptr inbounds nuw i8, ptr %i.bi, i64 %i.bh
  store i8 %i.ba, ptr %i.bj, align 1, !tbaa !9
  %i.bk = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
  %i.bl = add i64 %i.bk, 1                        ; 3 uses
  %i.bm = load i64, ptr %i.as, align 8, !tbaa !231
...
bb.i:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42
  ...
  %i.bp = load ptr, ptr %i.bo, align 8, !tbaa !228
  tail call void %i.bp(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bl), !inline_history !480
  %.pre.i44 = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42, %bb.i
  ...
  %i.br = load i8, ptr %i.a, align 16, !tbaa !9
  %i.bs = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i43, ptr %i.ap, align 8, !tbaa !235
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bs, i64 %i.bq
  store i8 %i.br, ptr %i.bt, align 1, !tbaa !9
...
bb.j:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46
  %i.bx = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
  %i.by = add i64 %i.bx, 1                        ; 3 uses
  %i.bz = load i64, ptr %i.as, align 8, !tbaa !231
...
bb.k:                                             ; preds = %bb.j
  ...
  %i.cc = load ptr, ptr %i.cb, align 8, !tbaa !228
  tail call void %i.cc(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.by), !inline_history !480
  %.pre.i48 = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit50: ; preds = %bb.j, %bb.k
  ...
  %i.ce = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i47, ptr %i.ap, align 8, !tbaa !235
  %i.cf = getelementptr inbounds nuw i8, ptr %i.ce, i64 %i.cd
  store i8 46, ptr %i.cf, align 1, !tbaa !9
  br label %bb.l
...
.lr.ph34.i:                                       ; preds = %bb.l
  ...
  %.pre.i51 = load i64, ptr %i.ap, align 8, !tbaa !235
  br label %bb.m
...
bb.m:                                             ; preds = %._crit_edge.i, %.lr.ph34.i
  ...
  %i.cm = load i64, ptr %i.as, align 8, !tbaa !231
...
bb.n:                                             ; preds = %bb.m
  %i.cr = load ptr, ptr %i.ck, align 8, !tbaa !228
  %i.cs = add i64 %i.cp, %i.cl
  call void %i.cr(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.cs), !inline_history !481
  %i.ct = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
  %i.cu = load i64, ptr %i.as, align 8, !tbaa !231
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  %i.cx = load ptr, ptr %3, align 8, !tbaa !230   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.dc, align 1, !tbaa !9
  %wide.load118 = load <16 x i8>, ptr %i.dd, align 1, !tbaa !9
  %i.de = getelementptr inbounds nuw i8, ptr %i.cz, i64 %index ; 2 uses
  %i.df = getelementptr inbounds nuw i8, ptr %i.de, i64 16
  store <16 x i8> %wide.load, ptr %i.de, align 1, !tbaa !9
  store <16 x i8> %wide.load118, ptr %i.df, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.dg = icmp eq i64 %index.next, %n.vec
  br i1 %i.dg, label %middle.block, label %vector.body, !llvm.loop !482
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load122 = load <4 x i8>, ptr %i.dh, align 1, !tbaa !9
  %i.di = getelementptr inbounds nuw i8, ptr %i.cz, i64 %index121
  store <4 x i8> %wide.load122, ptr %i.di, align 1, !tbaa !9
  %index.next123 = add nuw i64 %index121, 4       ; 2 uses
  %i.dj = icmp eq i64 %index.next123, %n.vec120
  br i1 %i.dj, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !483
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !484
...
._crit_edge.loopexit.i:                           ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i = load i64, ptr %i.ap, align 8, !tbaa !235
...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.o
  ...
  store i64 %i.dr, ptr %i.ap, align 8, !tbaa !235
  %i.ds = getelementptr inbounds nuw i8, ptr %.02532.i, i64 %.026.i ; 2 uses
  %.not.i = icmp eq ptr %i.ds, %i.ci
  br i1 %.not.i, label %_ZN3fmt3v126detail6bufferIcE6appendIcEEvPKT_S7_.exit, label %bb.m, !llvm.loop !285
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  store i8 %i.du, ptr %i.dv, align 1, !tbaa !9
  ...
  store i8 %i.dy, ptr %i.dz, align 1, !tbaa !9
  ...
  store i8 %i.ec, ptr %i.ed, align 1, !tbaa !9
  ...
  br i1 %exitcond.not.i.3, label %._crit_edge.loopexit.i, label %.lr.ph.i, !llvm.loop !485
...
bb.p:                                             ; preds = %.lr.ph96, %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55
  ...
  %i.ek = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
  %i.el = add i64 %i.ek, 1                        ; 3 uses
  %i.em = load i64, ptr %i.as, align 8, !tbaa !231
  %i.en = icmp ugt i64 %i.el, %i.em
  br i1 %i.en, label %bb.q, label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55

bb.q:                                             ; preds = %bb.p
  %i.eo = load ptr, ptr %i.ej, align 8, !tbaa !228
  call void %i.eo(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.el), !inline_history !480
  %.pre.i53 = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55: ; preds = %bb.p, %bb.q
  ...
  %i.eq = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i52, ptr %i.ap, align 8, !tbaa !235
  %i.er = getelementptr inbounds nuw i8, ptr %i.eq, i64 %i.ep
  store i8 48, ptr %i.er, align 1, !tbaa !9
  %i.es = add i32 %.295, 1                        ; 2 uses
  %exitcond.not = icmp eq i32 %i.es, %.sroa.6.8.extract.trunc
  br i1 %exitcond.not, label %._crit_edge, label %bb.p, !llvm.loop !486
...
._crit_edge:                                      ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55, %_ZN3fmt3v126detail6bufferIcE6appendIcEEvPKT_S7_.exit
  ...
  %i.eu = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
  %i.ev = add i64 %i.eu, 1                        ; 3 uses
  %i.ew = load i64, ptr %i.as, align 8, !tbaa !231
...
bb.r:                                             ; preds = %._crit_edge
  ...
  %i.ez = load ptr, ptr %i.ey, align 8, !tbaa !228
  call void %i.ez(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ev), !inline_history !480
  %.pre.i57 = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit59: ; preds = %._crit_edge, %bb.r
  ...
  %i.fb = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i56, ptr %i.ap, align 8, !tbaa !235
  %i.fc = getelementptr inbounds nuw i8, ptr %i.fb, i64 %i.fa
  store i8 %i.et, ptr %i.fc, align 1, !tbaa !9
  %i.fd = icmp slt i32 %.sroa.9.2, 0
  %i.fe = load i64, ptr %i.ap, align 8, !tbaa !235 ; 3 uses
  %i.ff = add i64 %i.fe, 1                        ; 5 uses
  %i.fg = load i64, ptr %i.as, align 8, !tbaa !231
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.fj = load ptr, ptr %i.fi, align 8, !tbaa !228
  call void %i.fj(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ff), !inline_history !480
  %.pre.i61 = load i64, ptr %i.ap, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit63: ; preds = %bb.s, %bb.t
  ...
  %i.fl = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i60, ptr %i.ap, align 8, !tbaa !235
  %i.fm = getelementptr inbounds nuw i8, ptr %i.fl, i64 %i.fk
  store i8 45, ptr %i.fm, align 1, !tbaa !9
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  store i128 %.sroa.0.0, ptr %5, align 16, !tbaa !488
...
bb.j:                                             ; preds = %bb.i
  %i.bk = load i32, ptr %2, align 4, !tbaa !255
...
bb.n:                                             ; preds = %.critedge
  ...
  %i.cb = load ptr, ptr %i.ca, align 8, !tbaa !228
  call void %i.cb(ptr noundef nonnull align 8 dereferenceable(32) %4, i64 noundef %.047), !inline_history !487
  %.pre.i41 = load i64, ptr %i.bx, align 8, !tbaa !231
  br label %_ZN3fmt3v126detail6bufferIcE10try_resizeEm.exit42
...
_ZN3fmt3v126detail6bufferIcE10try_resizeEm.exit42: ; preds = %.critedge.thread, %.critedge, %bb.n
  ...
  store i64 %i.cd, ptr %i.bm, align 8, !tbaa !235
  br label %bb.o
...
bb.f:                                             ; preds = %bb.e
  %i.aq = load ptr, ptr %i.aj, align 8, !tbaa !228
  %i.ar = add i64 %i.ao, %i.ak
  tail call void %i.aq(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ar), !inline_history !491
  %i.as = load i64, ptr %i.ag, align 8, !tbaa !235 ; 2 uses
  %i.at = load i64, ptr %i.ah, align 8, !tbaa !231
  %i.au = sub i64 %i.at, %i.as
  %i.av = tail call i64 @llvm.umin.i64(i64 %i.ao, i64 %i.au)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bf = icmp eq i64 %index.next, %n.vec
  br i1 %i.bf, label %middle.block, label %vector.body, !llvm.loop !492
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %index.next41 = add nuw i64 %index39, 4         ; 2 uses
  %i.bi = icmp eq i64 %index.next41, %n.vec38
  br i1 %i.bi, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !493
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !494
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.g
  ...
  %i.br = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.br, %i.af
  br i1 %.not.i.i.i, label %_ZZN3fmt3v126detail11write_bytesIcLNS0_5alignE2ENS0_14basic_appenderIcEEEET1_S6_NS0_17basic_string_viewIcEERKNS0_12format_specsEENKUlS5_E_clES5_.exit, label %bb.e, !llvm.loop !285
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  %i.ch = add nuw i64 %.030.i.i.i, 4              ; 2 uses
  %exitcond.not.i.i.i.3 = icmp eq i64 %i.ch, %.026.i.i.i
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !495
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden void @_ZN3fmt3v1212format_errorCI2St13runtime_errorEPKc(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef %1) unnamed_addr #12 align 2 {
bb.a:
  tail call void @_ZNSt13runtime_errorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef %1)
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN3fmt3v1212format_errorE, i64 16), ptr %0, align 8, !tbaa !34
  ret void
}
...
define linkonce_odr hidden void @_ZN3fmt3v1212format_errorD0Ev(ptr noundef nonnull align 8 dereferenceable(16) %0) unnamed_addr #10 align 2 {
bb.a:
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden void @_ZN3fmt3v126detail13format_dragonENS1_8basic_fpIoEEjiRNS1_6bufferIcEERi(ptr noundef byval(%"struct.fmt::v12::detail::basic_fp") align 16 %0, i32 noundef %1, i32 noundef %2, ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 4 dereferenceable(4) %4) local_unnamed_addr #12 personality ptr @__gxx_personality_v0 {
bb.a:
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE4growERNS2_6bufferIjEEm, ptr %i.b, align 8, !tbaa !496
  %i.d = getelementptr inbounds nuw i8, ptr %5, i64 32 ; 9 uses
  store ptr %i.d, ptr %5, align 8, !tbaa !498
  store i64 32, ptr %i.a, align 8, !tbaa !499
  %i.e = getelementptr inbounds nuw i8, ptr %5, i64 168 ; 10 uses
  store i32 0, ptr %i.e, align 8, !tbaa !500
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE4growERNS2_6bufferIjEEm, ptr %i.g, align 8, !tbaa !496
  %i.i = getelementptr inbounds nuw i8, ptr %6, i64 32 ; 3 uses
  store ptr %i.i, ptr %6, align 8, !tbaa !498
  store i64 32, ptr %i.f, align 8, !tbaa !499
  %i.j = getelementptr inbounds nuw i8, ptr %6, i64 168 ; 9 uses
  store i32 0, ptr %i.j, align 8, !tbaa !500
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE4growERNS2_6bufferIjEEm, ptr %i.l, align 8, !tbaa !496
  %i.n = getelementptr inbounds nuw i8, ptr %7, i64 32 ; 5 uses
  store ptr %i.n, ptr %7, align 8, !tbaa !498
  store i64 32, ptr %i.k, align 8, !tbaa !499
...
end_hunk_7
begin_hunk_8_@_ZN3fmt3v126detail13format_dragonENS1_8basic_fpIoEEjiRNS1_6bufferIcEERi:bb.a
...
.lr.ph.i.preheader.i:                             ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i, %.noexc170
  ...
  %i.dn = load ptr, ptr %7, align 8, !tbaa !498   ; 4 uses
  %i.do = add i64 %i.dl, -4
  %i.dp = sub i64 %i.do, %i.dm                    ; 2 uses
  %i.dq = lshr i64 %i.dp, 2
  %i.dr = add nuw nsw i64 %i.dq, 1                ; 2 uses
  %min.iters.check1515 = icmp ult i64 %i.dp, 28
...
vector.body1519:                                  ; preds = %vector.body1519, %vector.ph1516
  ...
  br i1 %i.eb, label %middle.block1525, label %vector.body1519, !llvm.loop !515
...
.loopexit570:                                     ; preds = %.lr.ph.i.i, %middle.block1525, %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i
  ...
  %i.eg = load i32, ptr %i.e, align 8, !tbaa !500 ; 2 uses
  store i32 %i.eg, ptr %i.o, align 8, !tbaa !500
  br i1 %.not, label %_ZN3fmt3v126detail6bigintlSEi.exit196, label %bb.q

bb.q:                                             ; preds = %.loopexit570
  %i.eh = load i64, ptr %i.c, align 8, !tbaa !508 ; 8 uses
  %i.ei = load i64, ptr %i.p, align 8, !tbaa !499 ; 2 uses
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.thread.i179: ; preds = %bb.q
  %i.ek = load ptr, ptr %i.q, align 8, !tbaa !496
...
.noexc182:                                        ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.thread.i179
  ...
  store i64 %i.el, ptr %i.r, align 8, !tbaa !508
  %i.em = load ptr, ptr %5, align 8, !tbaa !498   ; 2 uses
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171: ; preds = %bb.q
  store i64 %i.eh, ptr %i.r, align 8, !tbaa !508
...
.thread:                                          ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171
  store i32 %i.eg, ptr %i.t, align 8, !tbaa !500
...
vector.body1536:                                  ; preds = %vector.body1536, %vector.ph1533
  ...
  br i1 %i.fi, label %middle.block1543, label %vector.body1536, !llvm.loop !517
...
.loopexit1623:                                    ; preds = %.lr.ph.i.i175, %middle.block1543
  %i.fm = load i32, ptr %i.e, align 8, !tbaa !500
  store i32 %i.fm, ptr %i.t, align 8, !tbaa !500
...
vector.body1552:                                  ; preds = %vector.body1552, %vector.ph1549
  ...
  br i1 %i.fx, label %middle.block1558, label %vector.body1552, !llvm.loop !519
...
bb.s:                                             ; preds = %bb.r
  %i.gh = load ptr, ptr %i.q, align 8, !tbaa !496
...
_ZN3fmt3v126detail6bigintlSEi.exit196:            ; preds = %_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i191, %._crit_edge.i189, %.loopexit1623, %.thread, %.loopexit570
  ...
  %i.gl = load i128, ptr %0, align 16, !tbaa !506 ; 3 uses
  %i.gm = and i128 %i.gl, 18446744073709551615
  %i.gn = load i64, ptr %i.c, align 8, !tbaa !508 ; 4 uses
...
.lr.ph.i.i197:                                    ; preds = %_ZN3fmt3v126detail6bigintlSEi.exit196
  %i.go = load ptr, ptr %5, align 8, !tbaa !498   ; 3 uses
...
.lr.ph22.i.i:                                     ; preds = %.preheader.i.i, %_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i.i
  ...
  %i.hi = load i64, ptr %i.a, align 8, !tbaa !499
...
bb.u:                                             ; preds = %.lr.ph22.i.i
  %i.hk = load ptr, ptr %i.b, align 8, !tbaa !496
...
_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i.i: ; preds = %.noexc200, %.lr.ph22.i.i
  ...
  store i64 %.pre-phi.i.i.i, ptr %i.c, align 8, !tbaa !508
  %i.hn = getelementptr inbounds nuw [4 x i8], ptr %i.hl, i64 %i.hm
  store i32 %i.hg, ptr %i.hn, align 4, !tbaa !3
end_hunk_8
begin_hunk_9_@_ZN3fmt3v126detail6bigint12assign_pow10Ei:bb.a
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bz = icmp eq i64 %index.next, %n.vec
  br i1 %i.bz, label %middle.block, label %vector.body, !llvm.loop !544
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %scalar.ph, !llvm.loop !545

bb.l:                                             ; preds = %._crit_edge.i
  %i.cg = add i64 %i.bm, 1                        ; 3 uses
  %i.ch = load i64, ptr %i.o, align 8, !tbaa !499
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ck = load ptr, ptr %i.cj, align 8, !tbaa !496
  tail call void %i.ck(ptr noundef nonnull align 8 dereferenceable(172) %0, i64 noundef %i.cg), !inline_history !546
  %.pre.i.i = load i64, ptr %i.v, align 8, !tbaa !508 ; 2 uses
  %.pre2.i.i = add i64 %.pre.i.i, 1
  %.pre23 = load ptr, ptr %0, align 8, !tbaa !498
...
_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i: ; preds = %bb.m, %bb.l
  ...
  store i64 %.pre-phi.i.i, ptr %i.v, align 8, !tbaa !508
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden noundef i32 @_ZN3fmt3v126detail6bigint13divmod_assignERKS2_(ptr noundef nonnull align 8 dereferenceable(172) %0, ptr noundef nonnull align 8 dereferenceable(172) %1) local_unnamed_addr #6 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  %i.b = load i64, ptr %i.a, align 8, !tbaa !508  ; 5 uses
  %i.c = trunc i64 %i.b to i32                    ; 5 uses
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 168 ; 4 uses
  %i.e = load i32, ptr %i.d, align 8, !tbaa !500  ; 4 uses
  %i.f = add nsw i32 %i.e, %i.c                   ; 2 uses
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 3 uses
  %i.h = load i64, ptr %i.g, align 8, !tbaa !508  ; 3 uses
  %i.i = trunc i64 %i.h to i32                    ; 2 uses
  %i.j = getelementptr inbounds nuw i8, ptr %1, i64 168 ; 3 uses
  %i.k = load i32, ptr %i.j, align 8, !tbaa !500  ; 3 uses
...
bb.d:                                             ; preds = %.lr.ph
  ...
  br i1 %.not35.not.i, label %.lr.ph, label %._crit_edge, !llvm.loop !535
...
.lr.ph:                                           ; preds = %bb.c, %bb.d
  ...
  br i1 %.not37.i, label %bb.d, label %.loopexit.i, !llvm.loop !535
...
bb.e:                                             ; preds = %select.unfold
  ...
  %i.ad = load i64, ptr %i.ac, align 8, !tbaa !499 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !496
  tail call void %i.ag(ptr noundef nonnull align 8 dereferenceable(172) %0, i64 noundef %i.ab), !inline_history !547
  %.pre.i.i.i = load i64, ptr %i.ac, align 8, !tbaa !499
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i: ; preds = %bb.f, %bb.e
  ...
  store i64 %i.ai, ptr %i.a, align 8, !tbaa !508
  %i.aj = icmp sgt i32 %i.c, 0
  %.pre.i = load ptr, ptr %0, align 8, !tbaa !498 ; 13 uses
...
vector.memcheck:                                  ; preds = %.lr.ph.i
  ...
  %2 = and i64 %i.ap, 4611686018427387896
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.ba, label %middle.block, label %vector.body, !llvm.loop !548
...
.lr.ph.preheader.i.i:                             ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i
  ...
  %i.bl = load i32, ptr %i.d, align 8, !tbaa !500
  %i.bm = sub nsw i32 %i.bl, %i.y                 ; 2 uses
  store i32 %i.bm, ptr %i.d, align 8, !tbaa !500
...
.lr.ph.i14:                                       ; preds = %_ZN3fmt3v126detail7compareERKNS1_6bigintES4_.exit32
  %i.cm = load i32, ptr %i.j, align 8, !tbaa !500
  %i.cn = sub i32 %i.cm, %i.ci
  %i.co = load ptr, ptr %1, align 8, !tbaa !498   ; 3 uses
  %i.cp = load ptr, ptr %0, align 8, !tbaa !498   ; 4 uses
...
end_hunk_9
begin_hunk_10_@_ZN3fmt3v126detail14digit_groupingIcEC2ENS0_10locale_refEb:bb.a
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %.body
  %i.aw = load i64, ptr %i.e, align 8, !tbaa !9
  %i.ax = add i64 %i.aw, 1
  call void @_ZdlPvm(ptr noundef %i.au, i64 noundef %i.ax) #35
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %.body, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i
  %i.ay = load ptr, ptr %0, align 8, !tbaa !87    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i12: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  %i.ba = load i64, ptr %i.b, align 8, !tbaa !9
  %i.bb = add i64 %i.ba, 1
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden void @_ZN3fmt3v126detail18thousands_sep_implIcEENS1_20thousands_sep_resultIT_EENS0_10locale_refE(ptr dead_on_unwind noalias writable sret(%"struct.fmt::v12::detail::thousands_sep_result") align 8 %0, ptr %1) local_unnamed_addr #12 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  call void @_ZNSt6localeC1ERKS_(ptr noundef nonnull align 8 dereferenceable(8) %2, ptr noundef nonnull align 8 dereferenceable(8) %1) #34
  br label %_ZNK3fmt3v1210locale_ref3getISt6localeEET_v.exit

bb.c:                                             ; preds = %bb.a
  call void @_ZNSt6localeC1Ev(ptr noundef nonnull align 8 dereferenceable(8) %2) #34
  br label %_ZNK3fmt3v1210locale_ref3getISt6localeEET_v.exit

_ZNK3fmt3v1210locale_ref3getISt6localeEET_v.exit: ; preds = %bb.b, %bb.c
  %i.a = call noundef i64 @_ZNKSt6locale2id5_M_idEv(ptr noundef nonnull align 8 dereferenceable(8) @_ZNSt7__cxx118numpunctIcE2idE) #34
  %i.b = load ptr, ptr %2, align 8, !tbaa !289
  %i.c = getelementptr inbounds nuw i8, ptr %i.b, i64 8
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !295
  %i.e = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %i.a
  %i.f = load ptr, ptr %i.e, align 8, !tbaa !296  ; 5 uses
...
_ZSt9use_facetINSt7__cxx118numpunctIcEEERKT_RKSt6locale.exit: ; preds = %_ZNK3fmt3v1210locale_ref3getISt6localeEET_v.exit
  call void @_ZNSt6localeD1Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) %2) #34
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #34
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #34
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !34, !noalias !583
  %i.h = getelementptr inbounds nuw i8, ptr %i.g, i64 32
  %i.i = load ptr, ptr %i.h, align 8, !noalias !583
  call void %i.i(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %3, ptr noundef nonnull align 8 dereferenceable(24) %i.f), !inline_history !318
...
bb.e:                                             ; preds = %_ZSt9use_facetINSt7__cxx118numpunctIcEEERKT_RKSt6locale.exit
  %i.m = load ptr, ptr %i.f, align 8, !tbaa !34
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 24
  %i.o = load ptr, ptr %i.n, align 8
  %i.p = invoke noundef signext i8 %i.o(ptr noundef nonnull align 8 dereferenceable(24) %i.f)
          to label %_ZNKSt7__cxx118numpunctIcE13thousands_sepEv.exit unwind label %bb.h, !inline_history !319
...
bb.f:                                             ; preds = %_ZNKSt7__cxx118numpunctIcE13thousands_sepEv.exit
  %i.v = load i64, ptr %i.j, align 8, !tbaa !40   ; 3 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i: ; preds = %_ZNKSt7__cxx118numpunctIcE13thousands_sepEv.exit
  store ptr %i.s, ptr %0, align 8, !tbaa !87
  %i.y = load i64, ptr %i.t, align 8, !tbaa !9
  store i64 %i.y, ptr %i.r, align 8, !tbaa !9
  %.pre = load i64, ptr %i.j, align 8, !tbaa !40
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.f, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i
  ...
  store i64 %i.z, ptr %i.aa, align 8, !tbaa !40
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 32
  store i8 %i.q, ptr %i.ab, align 8, !tbaa !581
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #34
  ret void
...
bb.h:                                             ; preds = %bb.e
  %i.ad = landingpad { ptr, i32 }
          cleanup
  %i.ae = load ptr, ptr %3, align 8, !tbaa !87    ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i7: ; preds = %bb.h
  %i.ah = load i64, ptr %i.af, align 8, !tbaa !9
  %i.ai = add i64 %i.ah, 1
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEPKcNS1_14digit_groupingIcEEEET0_S9_T1_iiRKT2_(ptr %0, ptr noundef %1, i32 noundef %2, i32 noundef %3, ptr noundef nonnull align 8 dereferenceable(64) %4) local_unnamed_addr #6 personality ptr @__gxx_personality_v0 {
bb.a:
...
.lr.ph34.i.i.i:                                   ; preds = %bb.b
  ...
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.pre.i.i.i = load i64, ptr %i.e, align 8, !tbaa !235
  br label %bb.c
...
bb.c:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.j = load i64, ptr %i.f, align 8, !tbaa !231
  %i.k = sub i64 %i.j, %i.i
...
bb.d:                                             ; preds = %bb.c
  %i.o = load ptr, ptr %i.h, align 8, !tbaa !228
  %i.p = add i64 %i.m, %i.i
  tail call void %i.o(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.p), !inline_history !586
  %i.q = load i64, ptr %i.e, align 8, !tbaa !235  ; 2 uses
  %i.r = load i64, ptr %i.f, align 8, !tbaa !231
  %i.s = sub i64 %i.r, %i.q
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %i.u = load ptr, ptr %0, align 8, !tbaa !230    ; 2 uses
...
vector.memcheck71:                                ; preds = %iter.check87
  ...
  %i.y = sub i64 %i.x, %i.l
  %diff.check72 = icmp ult i64 %i.y, 32
...
vector.body79:                                    ; preds = %vector.body79, %vector.ph76
  ...
  %wide.load81 = load <16 x i8>, ptr %i.z, align 1, !tbaa !9
  %wide.load82 = load <16 x i8>, ptr %i.aa, align 1, !tbaa !9
  %i.ab = getelementptr inbounds nuw i8, ptr %i.w, i64 %index80 ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 16
  store <16 x i8> %wide.load81, ptr %i.ab, align 1, !tbaa !9
  store <16 x i8> %wide.load82, ptr %i.ac, align 1, !tbaa !9
  %index.next83 = add nuw i64 %index80, 32        ; 2 uses
  %i.ad = icmp eq i64 %index.next83, %n.vec78
  br i1 %i.ad, label %middle.block84, label %vector.body79, !llvm.loop !587
...
vec.epilog.iter.check89:                          ; preds = %middle.block84
  ...
  br i1 %min.epilog.iters.check90, label %.lr.ph.i.i.i.preheader, label %vec.epilog.ph91, !prof !282
...
vec.epilog.vector.body94:                         ; preds = %vec.epilog.vector.body94, %vec.epilog.ph91
  ...
  store <4 x i8> %wide.load96, ptr %i.af, align 1, !tbaa !9
  %index.next97 = add nuw i64 %index95, 4         ; 2 uses
  %i.ag = icmp eq i64 %index.next97, %n.vec93
  br i1 %i.ag, label %vec.epilog.middle.block98, label %vec.epilog.vector.body94, !llvm.loop !588
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  br i1 %prol.iter103.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !589
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block98, %middle.block84
  %.pre37.i.i.i = load i64, ptr %i.e, align 8, !tbaa !235
  br label %._crit_edge.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.e
  ...
  store i64 %i.ao, ptr %i.e, align 8, !tbaa !235
  %i.ap = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.ap, %i.d
  br i1 %.not.i.i.i, label %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit, label %bb.c, !llvm.loop !285
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !590
...
bb.f:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %.lr.ph.i
  ...
  %i.bk = load i64, ptr %i.bh, align 8, !tbaa !235 ; 2 uses
  %i.bl = add i64 %i.bk, 1                        ; 3 uses
  %i.bm = load i64, ptr %i.bi, align 8, !tbaa !231
  %i.bn = icmp ugt i64 %i.bl, %i.bm
  br i1 %i.bn, label %bb.g, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i

bb.g:                                             ; preds = %bb.f
  %i.bo = load ptr, ptr %i.bj, align 8, !tbaa !228
  tail call void %i.bo(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.bl), !inline_history !424
  %.pre.i.i.i18 = load i64, ptr %i.bh, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.g, %bb.f
  ...
  store i64 %.pre-phi.i.i.i, ptr %i.bh, align 8, !tbaa !235
  %i.br = getelementptr inbounds nuw i8, ptr %i.bq, i64 %i.bp
  store i8 48, ptr %i.br, align 1, !tbaa !9
  %i.bs = add nuw nsw i32 %.04.i, 1               ; 2 uses
  %exitcond.not.i = icmp eq i32 %i.bs, %3
  br i1 %exitcond.not.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit, label %bb.f, !llvm.loop !420
...
bb.h:                                             ; preds = %bb.a
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIcLm500ENS0_6detail9allocatorIcEEE4growERNS2_6bufferIcEEm, ptr %i.bu, align 8, !tbaa !228
  %i.bw = getelementptr inbounds nuw i8, ptr %5, i64 32 ; 3 uses
  store ptr %i.bw, ptr %5, align 8, !tbaa !230
  store i64 500, ptr %i.bt, align 8, !tbaa !231
...
bb.i:                                             ; preds = %._crit_edge.i.i.i31, %.lr.ph34.i.i.i20
  ...
  %i.cb = load i64, ptr %i.bt, align 8, !tbaa !231
...
bb.j:                                             ; preds = %bb.i
  %i.cg = load ptr, ptr %i.bu, align 8, !tbaa !228
  %i.ch = add i64 %i.ce, %i.ca
  invoke void %i.cg(ptr noundef nonnull align 8 dereferenceable(32) %5, i64 noundef %i.ch)
          to label %.noexc unwind label %.loopexit, !inline_history !591

.noexc:                                           ; preds = %bb.j
  %i.ci = load i64, ptr %i.bv, align 8, !tbaa !235 ; 2 uses
  %i.cj = load i64, ptr %i.bt, align 8, !tbaa !231
...
bb.k:                                             ; preds = %.noexc, %bb.i
  ...
  %i.cm = load ptr, ptr %5, align 8, !tbaa !230   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.cr, align 1, !tbaa !9
  %wide.load64 = load <16 x i8>, ptr %i.cs, align 1, !tbaa !9
  %i.ct = getelementptr inbounds nuw i8, ptr %i.co, i64 %index ; 2 uses
  %i.cu = getelementptr inbounds nuw i8, ptr %i.ct, i64 16
  store <16 x i8> %wide.load, ptr %i.ct, align 1, !tbaa !9
  store <16 x i8> %wide.load64, ptr %i.cu, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.cv = icmp eq i64 %index.next, %n.vec
  br i1 %i.cv, label %middle.block, label %vector.body, !llvm.loop !592
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf, 0
  br i1 %min.epilog.iters.check, label %.lr.ph.i.i.i26.preheader, label %vec.epilog.ph, !prof !282
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load68 = load <4 x i8>, ptr %i.cw, align 1, !tbaa !9
  %i.cx = getelementptr inbounds nuw i8, ptr %i.co, i64 %index67
  store <4 x i8> %wide.load68, ptr %i.cx, align 1, !tbaa !9
  %index.next69 = add nuw i64 %index67, 4         ; 2 uses
  %i.cy = icmp eq i64 %index.next69, %n.vec66
  br i1 %i.cy, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !593
...
.lr.ph.i.i.i26.prol:                              ; preds = %.lr.ph.i.i.i26.preheader, %.lr.ph.i.i.i26.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i26.prol.loopexit, label %.lr.ph.i.i.i26.prol, !llvm.loop !594
...
._crit_edge.loopexit.i.i.i29:                     ; preds = %.lr.ph.i.i.i26.prol.loopexit, %.lr.ph.i.i.i26, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i30 = load i64, ptr %i.bv, align 8, !tbaa !235
...
._crit_edge.i.i.i31:                              ; preds = %._crit_edge.loopexit.i.i.i29, %bb.k
  ...
  store i64 %i.dg, ptr %i.bv, align 8, !tbaa !235
  %i.dh = getelementptr inbounds nuw i8, ptr %.02532.i.i.i22, i64 %.026.i.i.i24 ; 2 uses
  %.not.i.i.i32 = icmp eq ptr %i.dh, %i.by
  br i1 %.not.i.i.i32, label %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit33, label %bb.i, !llvm.loop !285
...
.lr.ph.i.i.i26:                                   ; preds = %.lr.ph.i.i.i26.prol.loopexit, %.lr.ph.i.i.i26
  ...
  store i8 %i.dj, ptr %i.dk, align 1, !tbaa !9
  ...
  store i8 %i.dn, ptr %i.do, align 1, !tbaa !9
  ...
  store i8 %i.dv, ptr %i.dw, align 1, !tbaa !9
  %i.dx = add nuw i64 %.030.i.i.i27, 4            ; 2 uses
  %exitcond.not.i.i.i28.3 = icmp eq i64 %i.dx, %.026.i.i.i24
  br i1 %exitcond.not.i.i.i28.3, label %._crit_edge.loopexit.i.i.i29, label %.lr.ph.i.i.i26, !llvm.loop !595
...
.lr.ph.i34:                                       ; preds = %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit33, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i36
  ...
  %i.ea = load i64, ptr %i.bv, align 8, !tbaa !235 ; 2 uses
  %i.eb = add i64 %i.ea, 1                        ; 3 uses
  %i.ec = load i64, ptr %i.bt, align 8, !tbaa !231
  %i.ed = icmp ugt i64 %i.eb, %i.ec
  br i1 %i.ed, label %bb.l, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i36

bb.l:                                             ; preds = %.lr.ph.i34
  %i.ee = load ptr, ptr %i.bu, align 8, !tbaa !228
  invoke void %i.ee(ptr noundef nonnull align 8 dereferenceable(32) %5, i64 noundef %i.eb)
          to label %.noexc41 unwind label %bb.o, !inline_history !596

.noexc41:                                         ; preds = %bb.l
  %.pre.i.i.i39 = load i64, ptr %i.bv, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i36:      ; preds = %.noexc41, %.lr.ph.i34
  ...
  %i.eg = load ptr, ptr %5, align 8, !tbaa !230
  store i64 %.pre-phi.i.i.i37, ptr %i.bv, align 8, !tbaa !235
  %i.eh = getelementptr inbounds nuw i8, ptr %i.eg, i64 %i.ef
  store i8 48, ptr %i.eh, align 1, !tbaa !9
  %i.ei = add nuw nsw i32 %.04.i35, 1             ; 2 uses
  %exitcond.not.i38 = icmp eq i32 %i.ei, %3
  br i1 %exitcond.not.i38, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42.loopexit, label %.lr.ph.i34, !llvm.loop !420
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42.loopexit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i36
  %.pre = load i64, ptr %i.bv, align 8, !tbaa !235
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42: ; preds = %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42.loopexit, %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit33
  ...
  %i.ek = load ptr, ptr %5, align 8, !tbaa !230
...
bb.m:                                             ; preds = %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42
  %i.em = load ptr, ptr %5, align 8, !tbaa !230   ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  call void @free(ptr noundef %i.em) #34
...
bb.p:                                             ; preds = %.loopexit, %.loopexit.split-lp, %bb.o
  ...
  %i.eo = load ptr, ptr %5, align 8, !tbaa !230   ; 2 uses
...
bb.q:                                             ; preds = %bb.p
  call void @free(ptr noundef %i.eo) #34
...
end_hunk_10
begin_hunk_11_@_ZN3fmt3v126detail12write_paddedIcLNS0_5alignE2ENS0_14basic_appenderIcEERZNS1_11write_fixedIcNS1_14digit_groupingIcEES5_NS1_14big_decimal_fpEEET1_SA_RKT2_iT_RKNS0_12format_specsENS0_4signENS0_10locale_refEEUlS5_E0_EESA_SA_SH_mmOSB_:bb.a
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail17write_significandINS0_14basic_appenderIcEEcPKcNS1_14digit_groupingIcEEEET_S9_T1_iiT0_RKT2_(ptr %0, ptr noundef %1, i32 noundef %2, i32 noundef %3, i8 noundef signext %4, ptr noundef nonnull align 8 dereferenceable(64) %5) local_unnamed_addr #6 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !228
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(32) %i.e, i64 noundef %i.h), !inline_history !577
  %.pre.i.i.i = load i64, ptr %i.f, align 8, !tbaa !235 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.d, %bb.c
  ...
  %i.o = load ptr, ptr %i.e, align 8, !tbaa !230
  store i64 %.pre-phi.i.i.i, ptr %i.f, align 8, !tbaa !235
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 %i.n
  store i8 %4, ptr %i.p, align 1, !tbaa !9
...
bb.e:                                             ; preds = %bb.a
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIcLm500ENS0_6detail9allocatorIcEEE4growERNS2_6bufferIcEEm, ptr %i.u, align 8, !tbaa !228
  %i.w = getelementptr inbounds nuw i8, ptr %6, i64 32 ; 3 uses
  store ptr %i.w, ptr %6, align 8, !tbaa !230
  store i64 500, ptr %i.t, align 8, !tbaa !231
...
bb.f:                                             ; preds = %.noexc
  ...
  %i.ab = load i64, ptr %i.aa, align 8, !tbaa !235 ; 2 uses
  %i.ac = add i64 %i.ab, 1                        ; 3 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %i.z, i64 16
  %i.ae = load i64, ptr %i.ad, align 8, !tbaa !231
...
bb.g:                                             ; preds = %bb.f
  ...
  invoke void %i.ah(ptr noundef nonnull align 8 dereferenceable(32) %i.z, i64 noundef %i.ac)
          to label %.noexc25 unwind label %bb.l, !inline_history !607

.noexc25:                                         ; preds = %bb.g
  %.pre.i.i.i23 = load i64, ptr %i.aa, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i20:      ; preds = %.noexc25, %bb.f
  ...
  %i.aj = load ptr, ptr %i.z, align 8, !tbaa !230
  store i64 %.pre-phi.i.i.i21, ptr %i.aa, align 8, !tbaa !235
  %i.ak = getelementptr inbounds nuw i8, ptr %i.aj, i64 %i.ai
  store i8 %4, ptr %i.ak, align 1, !tbaa !9
...
bb.h:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i20, %.noexc
  %i.ao = load ptr, ptr %6, align 8, !tbaa !230
...
bb.i:                                             ; preds = %bb.h
  %i.ar = load ptr, ptr %6, align 8, !tbaa !230   ; 2 uses
  %i.as = getelementptr inbounds i8, ptr %i.ar, i64 %i.x
  %i.at = load i64, ptr %i.v, align 8, !tbaa !235
...
bb.j:                                             ; preds = %bb.i
  %i.aw = load ptr, ptr %6, align 8, !tbaa !230   ; 2 uses
...
bb.k:                                             ; preds = %bb.j
  call void @free(ptr noundef %i.aw) #34
  br label %_ZN3fmt3v1219basic_memory_bufferIcLm500ENS0_6detail9allocatorIcEEED2Ev.exit
...
bb.l:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i20, %bb.g, %bb.e, %bb.i, %bb.h
  %i.ax = landingpad { ptr, i32 }
          cleanup
  %i.ay = load ptr, ptr %6, align 8, !tbaa !230   ; 2 uses
...
bb.m:                                             ; preds = %bb.l
  call void @free(ptr noundef %i.ay) #34
...
; Function Attrs: mustprogress noinline uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail13copy_noinlineIcPKcNS0_14basic_appenderIcEEEET1_T0_S8_S7_(ptr noundef %0, ptr noundef %1, ptr %2) local_unnamed_addr #29 {
bb.a:
  %.not31.i.i = icmp eq ptr %0, %1
  br i1 %.not31.i.i, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit, label %.lr.ph34.i.i
...
bb.c:                                             ; preds = %bb.b
  %i.k = load ptr, ptr %i.d, align 8, !tbaa !228
  %i.l = add i64 %i.i, %i.e
  tail call void %i.k(ptr noundef nonnull align 8 dereferenceable(32) %2, i64 noundef %i.l), !inline_history !305
  %i.m = load i64, ptr %i.a, align 8, !tbaa !235  ; 2 uses
  %i.n = load i64, ptr %i.b, align 8, !tbaa !231
  %i.o = sub i64 %i.n, %i.m
  %i.p = tail call i64 @llvm.umin.i64(i64 %i.i, i64 %i.o)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.z = icmp eq i64 %index.next, %n.vec
  br i1 %i.z, label %middle.block, label %vector.body, !llvm.loop !608
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %index.next13 = add nuw i64 %index11, 4         ; 2 uses
  %i.ac = icmp eq i64 %index.next13, %n.vec10
  br i1 %i.ac, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !609
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !610
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.d
  ...
  %i.al = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i = icmp eq ptr %i.al, %1
  br i1 %.not.i.i, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit, label %bb.b, !llvm.loop !285
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  %i.bb = add nuw i64 %.030.i.i, 4                ; 2 uses
  %exitcond.not.i.i.3 = icmp eq i64 %i.bb, %.026.i.i
  br i1 %exitcond.not.i.i.3, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !611
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden ptr @_ZZN3fmt3v126detail11write_fixedIcNS1_14digit_groupingIcEENS0_14basic_appenderIcEENS1_14big_decimal_fpEEET1_S8_RKT2_iT_RKNS0_12format_specsENS0_4signENS0_10locale_refEENKUlS6_E1_clES6_(ptr noundef nonnull align 8 dereferenceable(48) %0, ptr %1) local_unnamed_addr #12 align 2 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !612, !nonnull !205, !align !210
  %i.b = load i32, ptr %i.a, align 4, !tbaa !397  ; 2 uses
  %.not = icmp eq i32 %i.b, 0
  br i1 %.not, label %bb.d, label %bb.b
...
bb.d:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit, %bb.a
  ...
  %i.r = load i64, ptr %i.q, align 8, !tbaa !235  ; 2 uses
  %i.s = add i64 %i.r, 1                          ; 3 uses
  %i.t = getelementptr inbounds nuw i8, ptr %1, i64 16 ; 5 uses
  %i.u = load i64, ptr %i.t, align 8, !tbaa !231
...
bb.e:                                             ; preds = %bb.d
  ...
  tail call void %i.x(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.s), !inline_history !279
  %.pre.i.i6 = load i64, ptr %i.q, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit8:         ; preds = %bb.d, %bb.e
  ...
  %i.z = load ptr, ptr %1, align 8, !tbaa !230
  store i64 %.pre-phi.i.i5, ptr %i.q, align 8, !tbaa !235
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 %i.y
  store i8 48, ptr %i.aa, align 1, !tbaa !9
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !614, !nonnull !205
  %i.ad = load i8, ptr %i.ac, align 1, !tbaa !167, !range !204, !noundef !205
...
bb.f:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit8
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !615, !nonnull !205
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !9
  %i.ai = load i64, ptr %i.q, align 8, !tbaa !235 ; 2 uses
  %i.aj = add i64 %i.ai, 1                        ; 3 uses
  %i.ak = load i64, ptr %i.t, align 8, !tbaa !231
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.an = load ptr, ptr %i.am, align 8, !tbaa !228
  tail call void %i.an(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.aj), !inline_history !279
  %.pre.i.i11 = load i64, ptr %i.q, align 8, !tbaa !235 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit13:        ; preds = %bb.f, %bb.g
  ...
  %i.ap = load ptr, ptr %1, align 8, !tbaa !230
  store i64 %.pre-phi.i.i10, ptr %i.q, align 8, !tbaa !235
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 %i.ao
  store i8 %i.ah, ptr %i.aq, align 1, !tbaa !9
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !616, !nonnull !205, !align !210
...
bb.h:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %.lr.ph.i
  ...
  %i.aw = load i64, ptr %i.q, align 8, !tbaa !235 ; 2 uses
  %i.ax = add i64 %i.aw, 1                        ; 3 uses
  %i.ay = load i64, ptr %i.t, align 8, !tbaa !231
  %i.az = icmp ugt i64 %i.ax, %i.ay
  br i1 %i.az, label %bb.i, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i

bb.i:                                             ; preds = %bb.h
  %i.ba = load ptr, ptr %i.av, align 8, !tbaa !228
  tail call void %i.ba(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.ax), !inline_history !424
  %.pre.i.i.i = load i64, ptr %i.q, align 8, !tbaa !235 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.i, %bb.h
  ...
  %i.bc = load ptr, ptr %1, align 8, !tbaa !230
  store i64 %.pre-phi.i.i.i, ptr %i.q, align 8, !tbaa !235
  ...
  br i1 %exitcond.not.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit, label %bb.h, !llvm.loop !420
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit13
  ...
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !617, !nonnull !205, !align !213
  %i.bh = load ptr, ptr %i.bg, align 8, !tbaa !475 ; 2 uses
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !618, !nonnull !205, !align !210
...
.lr.ph34.i.i.i:                                   ; preds = %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit
  ...
  %.pre.i.i.i14 = load i64, ptr %i.q, align 8, !tbaa !235
  br label %bb.j
...
bb.j:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.bq = load i64, ptr %i.t, align 8, !tbaa !231
...
bb.k:                                             ; preds = %bb.j
  %i.bv = load ptr, ptr %i.bo, align 8, !tbaa !228
  %i.bw = add i64 %i.bt, %i.bp
  tail call void %i.bv(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.bw), !inline_history !586
  %i.bx = load i64, ptr %i.q, align 8, !tbaa !235 ; 2 uses
  %i.by = load i64, ptr %i.t, align 8, !tbaa !231
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.cb = load ptr, ptr %1, align 8, !tbaa !230   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load31 = load <16 x i8>, ptr %i.ch, align 1, !tbaa !9
  %i.ci = getelementptr inbounds nuw i8, ptr %i.cd, i64 %index ; 2 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 16
  store <16 x i8> %wide.load, ptr %i.ci, align 1, !tbaa !9
  store <16 x i8> %wide.load31, ptr %i.cj, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ck = icmp eq i64 %index.next, %n.vec
  br i1 %i.ck, label %middle.block, label %vector.body, !llvm.loop !619
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load35 = load <4 x i8>, ptr %i.cl, align 1, !tbaa !9
  %i.cm = getelementptr inbounds nuw i8, ptr %i.cd, i64 %index34
  store <4 x i8> %wide.load35, ptr %i.cm, align 1, !tbaa !9
  %index.next36 = add nuw i64 %index34, 4         ; 2 uses
  %i.cn = icmp eq i64 %index.next36, %n.vec33
  br i1 %i.cn, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !620
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !621
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.q, align 8, !tbaa !235
  br label %._crit_edge.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.l
  ...
  store i64 %i.cv, ptr %i.q, align 8, !tbaa !235
  %i.cw = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.cw, %i.bm
  br i1 %.not.i.i.i, label %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit, label %bb.j, !llvm.loop !285
...
end_hunk_11
begin_hunk_12_@_ZN3fmt3v126detail15format_hexfloatIdTnNSt9enable_ifIXntsr16is_double_doubleIT_EE5valueEiE4typeELi0EEEvS4_NS0_12format_specsERNS1_6bufferIcEE:bb.a
...
bb.d:                                             ; preds = %bb.b, %bb.c, %bb.a
  ...
  %.str.47..str.48.i.i = select i1 %.not88, ptr @.str.48, ptr @.str.47
  br label %.split.i.i
...
.split.i.i:                                       ; preds = %.split.i.i, %bb.d
  ...
  %i.aa = getelementptr inbounds nuw i8, ptr %.str.47..str.48.i.i, i64 %i.z
  ...
  br i1 %.not.i.i, label %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit.preheader, label %.split.i.i, !llvm.loop !334
...
_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit: ; preds = %.lr.ph
  ...
  br i1 %.not89, label %.critedge, label %.lr.ph, !llvm.loop !685
...
.critedge:                                        ; preds = %.lr.ph, %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit, %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit.preheader
  ...
  %i.ak = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
...
bb.e:                                             ; preds = %.critedge
  ...
  %i.aq = load ptr, ptr %i.ap, align 8, !tbaa !228
  tail call void %i.aq(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.al), !inline_history !480
  %.pre.i = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %.pre2.i = add i64 %.pre.i, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit:  ; preds = %.critedge, %bb.e
  ...
  %i.as = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i, ptr %i.aj, align 8, !tbaa !235
  %i.at = getelementptr inbounds nuw i8, ptr %i.as, i64 %i.ar
  store i8 48, ptr %i.at, align 1, !tbaa !9
  %i.au = select i1 %.not88, i8 120, i8 88
  %i.av = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %i.aw = add i64 %i.av, 1                        ; 3 uses
  %i.ax = load i64, ptr %i.am, align 8, !tbaa !231
...
bb.f:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit
  ...
  %i.ba = load ptr, ptr %i.az, align 8, !tbaa !228
  tail call void %i.ba(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.aw), !inline_history !480
  %.pre.i40 = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %.pre2.i41 = add i64 %.pre.i40, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit, %bb.f
  ...
  %i.bc = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i39, ptr %i.aj, align 8, !tbaa !235
  %i.bd = getelementptr inbounds nuw i8, ptr %i.bc, i64 %i.bb
  store i8 %i.au, ptr %i.bd, align 1, !tbaa !9
  %i.be = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %i.bf = add i64 %i.be, 1                        ; 3 uses
  %i.bg = load i64, ptr %i.am, align 8, !tbaa !231
...
bb.g:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42
  ...
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !228
  tail call void %i.bj(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bf), !inline_history !480
  %.pre.i44 = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %.pre2.i45 = add i64 %.pre.i44, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42, %bb.g
  ...
  %i.bl = load i8, ptr %i.a, align 16, !tbaa !9
  %i.bm = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i43, ptr %i.aj, align 8, !tbaa !235
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 %i.bk
  store i8 %i.bl, ptr %i.bn, align 1, !tbaa !9
...
bb.h:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46
  %i.br = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %i.bs = add i64 %i.br, 1                        ; 3 uses
  %i.bt = load i64, ptr %i.am, align 8, !tbaa !231
...
bb.i:                                             ; preds = %bb.h
  ...
  %i.bw = load ptr, ptr %i.bv, align 8, !tbaa !228
  tail call void %i.bw(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bs), !inline_history !480
  %.pre.i48 = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %.pre2.i49 = add i64 %.pre.i48, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit50
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit50: ; preds = %bb.h, %bb.i
  ...
  %i.by = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i47, ptr %i.aj, align 8, !tbaa !235
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 %i.bx
  store i8 46, ptr %i.bz, align 1, !tbaa !9
  br label %bb.j
...
.lr.ph34.i:                                       ; preds = %bb.j
  ...
  %.pre.i51 = load i64, ptr %i.aj, align 8, !tbaa !235
  br label %bb.k
...
bb.k:                                             ; preds = %._crit_edge.i, %.lr.ph34.i
  ...
  %i.cg = load i64, ptr %i.am, align 8, !tbaa !231
...
bb.l:                                             ; preds = %bb.k
  %i.cl = load ptr, ptr %i.ce, align 8, !tbaa !228
  %i.cm = add i64 %i.cj, %i.cf
  call void %i.cl(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.cm), !inline_history !481
  %i.cn = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %i.co = load i64, ptr %i.am, align 8, !tbaa !231
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.cr = load ptr, ptr %3, align 8, !tbaa !230   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.cw, align 1, !tbaa !9
  %wide.load118 = load <16 x i8>, ptr %i.cx, align 1, !tbaa !9
  %i.cy = getelementptr inbounds nuw i8, ptr %i.ct, i64 %index ; 2 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %i.cy, i64 16
  store <16 x i8> %wide.load, ptr %i.cy, align 1, !tbaa !9
  store <16 x i8> %wide.load118, ptr %i.cz, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.da = icmp eq i64 %index.next, %n.vec
  br i1 %i.da, label %middle.block, label %vector.body, !llvm.loop !686
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load122 = load <4 x i8>, ptr %i.db, align 1, !tbaa !9
  %i.dc = getelementptr inbounds nuw i8, ptr %i.ct, i64 %index121
  store <4 x i8> %wide.load122, ptr %i.dc, align 1, !tbaa !9
  %index.next123 = add nuw i64 %index121, 4       ; 2 uses
  %i.dd = icmp eq i64 %index.next123, %n.vec120
  br i1 %i.dd, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !687
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !688
...
._crit_edge.loopexit.i:                           ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i = load i64, ptr %i.aj, align 8, !tbaa !235
  br label %._crit_edge.i
...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.m
  ...
  store i64 %i.dl, ptr %i.aj, align 8, !tbaa !235
  %i.dm = getelementptr inbounds nuw i8, ptr %.02532.i, i64 %.026.i ; 2 uses
  %.not.i = icmp eq ptr %i.dm, %i.cc
  br i1 %.not.i, label %_ZN3fmt3v126detail6bufferIcE6appendIcEEvPKT_S7_.exit, label %bb.k, !llvm.loop !285
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  store i8 %i.ds, ptr %i.dt, align 1, !tbaa !9
  ...
  store i8 %i.dw, ptr %i.dx, align 1, !tbaa !9
  ...
  br i1 %exitcond.not.i.3, label %._crit_edge.loopexit.i, label %.lr.ph.i, !llvm.loop !689
...
bb.n:                                             ; preds = %.lr.ph94, %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55
  ...
  %i.ee = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %i.ef = add i64 %i.ee, 1                        ; 3 uses
  %i.eg = load i64, ptr %i.am, align 8, !tbaa !231
  %i.eh = icmp ugt i64 %i.ef, %i.eg
  br i1 %i.eh, label %bb.o, label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55

bb.o:                                             ; preds = %bb.n
  %i.ei = load ptr, ptr %i.ed, align 8, !tbaa !228
  call void %i.ei(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ef), !inline_history !480
  %.pre.i53 = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %.pre2.i54 = add i64 %.pre.i53, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55: ; preds = %bb.n, %bb.o
  ...
  %i.ek = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i52, ptr %i.aj, align 8, !tbaa !235
  %i.el = getelementptr inbounds nuw i8, ptr %i.ek, i64 %i.ej
  store i8 48, ptr %i.el, align 1, !tbaa !9
  %i.em = add i32 %.293, 1                        ; 2 uses
  %exitcond.not = icmp eq i32 %i.em, %.sroa.6.8.extract.trunc
  br i1 %exitcond.not, label %._crit_edge, label %bb.n, !llvm.loop !690

._crit_edge:                                      ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55, %_ZN3fmt3v126detail6bufferIcE6appendIcEEvPKT_S7_.exit
  %i.en = select i1 %.not88, i8 112, i8 80
  %i.eo = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %i.ep = add i64 %i.eo, 1                        ; 3 uses
  %i.eq = load i64, ptr %i.am, align 8, !tbaa !231
...
bb.p:                                             ; preds = %._crit_edge
  ...
  %i.et = load ptr, ptr %i.es, align 8, !tbaa !228
  call void %i.et(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ep), !inline_history !480
  %.pre.i57 = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %.pre2.i58 = add i64 %.pre.i57, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit59
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit59: ; preds = %._crit_edge, %bb.p
  ...
  %i.ev = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i56, ptr %i.aj, align 8, !tbaa !235
  %i.ew = getelementptr inbounds nuw i8, ptr %i.ev, i64 %i.eu
  store i8 %i.en, ptr %i.ew, align 1, !tbaa !9
  %i.ex = icmp slt i32 %i.j, 0
  %i.ey = load i64, ptr %i.aj, align 8, !tbaa !235 ; 3 uses
  %i.ez = add i64 %i.ey, 1                        ; 5 uses
  %i.fa = load i64, ptr %i.am, align 8, !tbaa !231
...
bb.r:                                             ; preds = %bb.q
  ...
  call void %i.fd(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ez), !inline_history !480
  %.pre.i61 = load i64, ptr %i.aj, align 8, !tbaa !235 ; 2 uses
  %.pre2.i62 = add i64 %.pre.i61, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit63
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit63: ; preds = %bb.q, %bb.r
  ...
  %i.ff = load ptr, ptr %3, align 8, !tbaa !230
  store i64 %.pre-phi.i60, ptr %i.aj, align 8, !tbaa !235
  %i.fg = getelementptr inbounds nuw i8, ptr %i.ff, i64 %i.fe
  store i8 45, ptr %i.fg, align 1, !tbaa !9
...
end_hunk_12
begin_hunk_13_@_ZZN3fmt3v126detail11write_fixedIcNS1_14digit_groupingIcEENS0_14basic_appenderIcEENS1_9dragonbox10decimal_fpIdEEEET1_SA_RKT2_iT_RKNS0_12format_specsENS0_4signENS0_10locale_refEENKUlS6_E1_clES6_:bb.a
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit8:         ; preds = %bb.d, %bb.e
  ...
  store i8 48, ptr %i.aa, align 1, !tbaa !9
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !750, !nonnull !205
  %i.ad = load i8, ptr %i.ac, align 1, !tbaa !167, !range !204, !noundef !205
  %i.ae = trunc nuw i8 %i.ad to i1
...
bb.f:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit8
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !751, !nonnull !205
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !9
  %i.ai = load i64, ptr %i.q, align 8, !tbaa !235 ; 2 uses
  %i.aj = add i64 %i.ai, 1                        ; 3 uses
  %i.ak = load i64, ptr %i.t, align 8, !tbaa !231
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit13:        ; preds = %bb.f, %bb.g
  ...
  store i8 %i.ah, ptr %i.aq, align 1, !tbaa !9
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !752, !nonnull !205, !align !210
  %i.at = load i32, ptr %i.as, align 4, !tbaa !3  ; 2 uses
  %i.au = icmp sgt i32 %i.at, 0
  br i1 %i.au, label %.lr.ph.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit13
  %i.bf = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !753, !nonnull !205, !align !213
  %i.bh = load i64, ptr %i.bg, align 8, !tbaa !452
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !754, !nonnull !205, !align !210
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail5writeIcNS0_14basic_appenderIcEETnNSt9enable_ifIXsr3std7is_sameIT_cEE5valueEiE4typeELi0EEET0_S9_NS0_17basic_string_viewIS6_EERKNS0_12format_specsE(ptr %0, ptr %1, i64 %2, ptr noundef nonnull align 4 dereferenceable(16) %3) local_unnamed_addr #6 {
bb.a:
  ...
  %6 = alloca %class.anon.102, align 8            ; 6 uses
  store ptr %1, ptr %4, align 8
  %i.e = getelementptr inbounds nuw i8, ptr %4, i64 8
  store i64 %2, ptr %i.e, align 8
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #34
  %i.f = load i32, ptr %3, align 4, !tbaa !255
  %i.g = and i32 %i.f, 7
  %i.h = icmp eq i32 %i.g, 1                      ; 3 uses
  %i.i = zext i1 %i.h to i8
  store i8 %i.i, ptr %i.a, align 1, !tbaa !167
  %i.j = getelementptr inbounds nuw i8, ptr %3, i64 12
  %i.k = load i32, ptr %i.j, align 4, !tbaa !257  ; 3 uses
  %i.l = icmp slt i32 %i.k, 0
  br i1 %i.l, label %bb.b, label %bb.j

bb.b:                                             ; preds = %bb.a
  %i.m = getelementptr inbounds nuw i8, ptr %3, i64 8
  %i.n = load i32, ptr %i.m, align 4, !tbaa !303
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.q = load i64, ptr %i.p, align 8, !tbaa !235
...
bb.d:                                             ; preds = %bb.c
  ...
  tail call void %i.w(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.r), !inline_history !304
  br label %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
...
.lr.ph34.i.i.i:                                   ; preds = %bb.f
  ...
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.pre.i.i.i = load i64, ptr %i.p, align 8, !tbaa !235
  br label %bb.g
...
bb.g:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.ac = load i64, ptr %i.s, align 8, !tbaa !231
...
bb.h:                                             ; preds = %bb.g
  %i.ah = load ptr, ptr %i.aa, align 8, !tbaa !228
  %i.ai = add i64 %i.af, %i.ab
  tail call void %i.ah(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.ai), !inline_history !755
  %i.aj = load i64, ptr %i.p, align 8, !tbaa !235 ; 2 uses
  %i.ak = load i64, ptr %i.s, align 8, !tbaa !231
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  %i.an = load ptr, ptr %0, align 8, !tbaa !230   ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.as, align 1, !tbaa !9
  %wide.load27 = load <16 x i8>, ptr %i.at, align 1, !tbaa !9
  %i.au = getelementptr inbounds nuw i8, ptr %i.ap, i64 %index ; 2 uses
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 16
  store <16 x i8> %wide.load, ptr %i.au, align 1, !tbaa !9
  store <16 x i8> %wide.load27, ptr %i.av, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.aw = icmp eq i64 %index.next, %n.vec
  br i1 %i.aw, label %middle.block, label %vector.body, !llvm.loop !756
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load31 = load <4 x i8>, ptr %i.ax, align 1, !tbaa !9
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ap, i64 %index30
  store <4 x i8> %wide.load31, ptr %i.ay, align 1, !tbaa !9
  %index.next32 = add nuw i64 %index30, 4         ; 2 uses
  %i.az = icmp eq i64 %index.next32, %n.vec29
  br i1 %i.az, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !757
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !758
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.p, align 8, !tbaa !235
  br label %._crit_edge.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.i
  ...
  store i64 %i.bh, ptr %i.p, align 8, !tbaa !235
  %i.bi = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.bi, %i.y
  br i1 %.not.i.i.i, label %_ZN3fmt3v126detail4copyIccNS0_14basic_appenderIcEEEET1_NS0_17basic_string_viewIT0_EES5_.exit, label %bb.g, !llvm.loop !285
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !759
...
bb.k:                                             ; preds = %.thread, %bb.j
  ...
  store i64 %i.ca, ptr %i.b, align 8, !tbaa !145
  ...
  store i64 %.sink, ptr %i.c, align 8, !tbaa !145
  store i64 %.sink, ptr %i.d, align 8, !tbaa !145
  store ptr %i.a, ptr %5, align 8, !tbaa !405
  %i.cc = getelementptr inbounds nuw i8, ptr %5, i64 8
  store ptr %i.c, ptr %i.cc, align 8, !tbaa !154
  %i.cd = getelementptr inbounds nuw i8, ptr %5, i64 16
  store ptr %i.b, ptr %i.cd, align 8, !tbaa !154
  %i.ce = getelementptr inbounds nuw i8, ptr %5, i64 24
  store ptr %i.d, ptr %i.ce, align 8, !tbaa !154
  %i.cf = getelementptr inbounds nuw i8, ptr %5, i64 32
  store ptr %4, ptr %i.cf, align 8, !tbaa !760
  call void @_ZN3fmt3v126detail18for_each_codepointIZNS1_5writeIcNS0_14basic_appenderIcEETnNSt9enable_ifIXsr3std7is_sameIT_cEE5valueEiE4typeELi0EEET0_SA_NS0_17basic_string_viewIS7_EERKNS0_12format_specsEEUljNSB_IcEEE_EEvSG_S7_(ptr %1, i64 %2, ptr noundef nonnull byval(%class.anon.101) align 8 %5)
  %i.cg = load i64, ptr %i.d, align 8, !tbaa !145 ; 2 uses
  %i.ch = load i64, ptr %i.c, align 8, !tbaa !145
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #34
  %i.ci = load i8, ptr %i.a, align 1, !tbaa !167, !range !204, !noundef !205
  store i8 %i.ci, ptr %6, align 8, !tbaa !762
  %i.cj = getelementptr inbounds nuw i8, ptr %6, i64 8
  store i64 %i.cg, ptr %i.cj, align 8, !tbaa !764
  %i.ck = getelementptr inbounds nuw i8, ptr %6, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ck, ptr noundef nonnull align 8 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !765
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail20write_escaped_stringIcNS0_14basic_appenderIcEEEET0_S5_NS0_17basic_string_viewIT_EE(ptr %0, ptr %1, i64 %2) local_unnamed_addr #6 {
bb.a:
  %3 = alloca %"struct.fmt::v12::detail::find_escape_result", align 8 ; 9 uses
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  %i.b = load i64, ptr %i.a, align 8, !tbaa !235  ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void %i.h(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.c), !inline_history !279
  %.pre.i.i = load i64, ptr %i.a, align 8, !tbaa !235 ; 2 uses
  %.pre2.i.i = add i64 %.pre.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit:          ; preds = %bb.a, %bb.b
  ...
  %i.j = load ptr, ptr %0, align 8, !tbaa !230
  store i64 %.pre-phi.i.i, ptr %i.a, align 8, !tbaa !235
...
bb.c:                                             ; preds = %bb.g, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #34
  store ptr %i.l, ptr %3, align 8, !tbaa !355, !alias.scope !766
  store ptr null, ptr %i.m, align 8, !tbaa !357, !alias.scope !766
  store i32 0, ptr %i.n, align 8, !tbaa !358, !alias.scope !766
  ...
  %i.r = load ptr, ptr %3, align 8, !tbaa !355    ; 3 uses
...
bb.a:
  ...
  %3 = alloca %class.anon.105, align 8            ; 5 uses
  %i.b = alloca [7 x i8], align 1                 ; 11 uses
  %i.c = ptrtoaddr ptr %i.b to i64
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #34
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %3, ptr noundef nonnull align 8 dereferenceable(40) %2, i64 40, i1 false), !tbaa.struct !774
...
bb.d:                                             ; preds = %bb.c
  %i.g = load i8, ptr %.0, align 1, !tbaa !9
  %i.h = zext i8 %i.g to i32                      ; 2 uses
  %i.i = lshr i32 %i.h, 3                         ; 2 uses
  %i.j = zext nneg i32 %i.i to i64
  %i.k = getelementptr inbounds nuw i8, ptr @.str.82, i64 %i.j
  ...
  %i.ai = load i8, ptr %i.ah, align 1, !tbaa !9   ; 2 uses
  %i.aj = and i8 %i.ai, 63
  ...
  br i1 %i.bp, label %bb.c, label %.thread, !llvm.loop !775
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load50 = load <16 x i8>, ptr %i.bz, align 1, !tbaa !9
  %i.ca = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !9
  store <16 x i8> %wide.load50, ptr %i.ca, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.cb = icmp eq i64 %index.next, %n.vec
  br i1 %i.cb, label %middle.block, label %vector.body, !llvm.loop !776
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.ce, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !777
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  %i.ci = load i8, ptr %.057.i.prol, align 1, !tbaa !9
  %i.cj = getelementptr inbounds nuw i8, ptr %.08.i.prol, i64 1 ; 2 uses
  store i8 %i.ci, ptr %.08.i.prol, align 1, !tbaa !9
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.cw = load i8, ptr %i.cs, align 1, !tbaa !9
  ...
  store i8 %i.cz, ptr %i.cx, align 1, !tbaa !9
...
_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit: ; preds = %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit.preheader, %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit
  ...
  %i.dl = load i8, ptr %.022, align 1, !tbaa !9
  %i.dm = zext i8 %i.dl to i32                    ; 2 uses
  %i.dn = lshr i32 %i.dm, 3                       ; 2 uses
  %i.do = zext nneg i32 %i.dn to i64
  %i.dp = getelementptr inbounds nuw i8, ptr @.str.82, i64 %i.do
  ...
  %i.eh = load i8, ptr %i.eg, align 1, !tbaa !9   ; 2 uses
  %i.ei = and i8 %i.eh, 63
...
.lr.ph:                                           ; preds = %bb.b, %_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit
  ...
  %i.g = load i8, ptr %.055, align 1, !tbaa !9
  %i.h = zext i8 %i.g to i32                      ; 2 uses
  %i.i = lshr i32 %i.h, 3                         ; 2 uses
  %i.j = zext nneg i32 %i.i to i64
  %i.k = getelementptr inbounds nuw i8, ptr @.str.82, i64 %i.j
...
_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit.thread: ; preds = %.lr.ph, %switch.early.test.i.i.i, %switch.early.test.i.i.i, %switch.early.test.i.i.i, %_ZN3fmt3v126detail12needs_escapeEj.exit.i.i
  ...
  store ptr %i.br, ptr %.sroa.4.0..sroa_idx.i.i, align 8, !tbaa !146
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load107 = load <16 x i8>, ptr %i.cb, align 1, !tbaa !9
  %i.cc = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !9
  store <16 x i8> %wide.load107, ptr %i.cc, align 1, !tbaa !9
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.cd = icmp eq i64 %index.next, %n.vec
  br i1 %i.cd, label %middle.block, label %vector.body, !llvm.loop !787
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.cg, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !788
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  %i.ck = load i8, ptr %.057.i.prol, align 1, !tbaa !9
  %i.cl = getelementptr inbounds nuw i8, ptr %.08.i.prol, i64 1 ; 2 uses
  store i8 %i.ck, ptr %.08.i.prol, align 1, !tbaa !9
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.cp = load i8, ptr %.057.i, align 1, !tbaa !9
  %i.cq = getelementptr inbounds nuw i8, ptr %.08.i, i64 1
  store i8 %i.cp, ptr %.08.i, align 1, !tbaa !9
  ...
  %i.dk = load i8, ptr %i.dg, align 1, !tbaa !9
...
_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit: ; preds = %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit.preheader, %_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit42
  ...
  %i.dn = load i8, ptr %.022, align 1, !tbaa !9
  %i.do = zext i8 %i.dn to i32                    ; 2 uses
  %i.dp = lshr i32 %i.do, 3                       ; 2 uses
  %i.dq = zext nneg i32 %i.dp to i64
  %i.dr = getelementptr inbounds nuw i8, ptr @.str.82, i64 %i.dq
  %i.ds = load i8, ptr %i.dr, align 1, !tbaa !9
