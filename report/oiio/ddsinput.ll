...
._crit_edge:                                      ; preds = %.lr.ph.prol.loopexit, %.lr.ph, %bb.q
  ...
  %i.dc = getelementptr inbounds [4 x i8], ptr %.pre93, i64 %indvars.iv88.a
