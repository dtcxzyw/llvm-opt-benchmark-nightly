begin_hunk_0
  ...
  %47 = call ptr %46(ptr noundef nonnull %0, i32 noundef 1, i32 noundef %.fr65, i32 noundef 1) #11 ; 5 uses
...
.lr.ph63.us.preheader:                            ; preds = %.lr.ph64
  %wide.trip.count = zext nneg i32 %.fr65 to i64  ; 6 uses
  %min.iters.check = icmp ult i32 %.fr65, 4
  %min.iters.check3 = icmp ult i32 %.fr65, 16
