begin_hunk_0_@IDecode:bb.a
  ...
  %i.hd = call i32 %i.hb(ptr noundef nonnull %i.hc) #7
...
begin_hunk_1_@IDecode:bb.a
  ...
  br i1 %i.hx, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !86
...
begin_hunk_2_@IDecode:bb.a
  ...
  br i1 %i.ig, label %bb.ai, label %._crit_edge70.i, !llvm.loop !88
...
.thread.i.i:                                      ; preds = %bb.bh
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(120) %i.il, ptr noundef nonnull align 8 dereferenceable(120) %i.it, i64 120, i1 false), !tbaa.struct !91
...
bb.bl:                                            ; preds = %bb.bk
  %i.jj = load i32, ptr %i.iy, align 8, !tbaa !92 ; 3 uses
...
begin_hunk_6_@IDecode:bb.a
  ...
  store i32 %i.jx, ptr %i.iy, align 8, !tbaa !92
...
DecodeVP8LHeader.exit.sink.split:                 ; preds = %bb.bm, %bb.bj
  store i32 5, ptr %i.iy, align 8, !tbaa !92
...
begin_hunk_8_@IDecode:bb.a
  ...
  store i32 %i.kl, ptr %i.km, align 8, !tbaa !103
  %i.kn = call i32 @VP8LDecodeImage(ptr noundef %i.ke) #7
  %.not.i32 = icmp eq i32 %i.kn, 0
  %i.ko = load i32, ptr %i.ke, align 8, !tbaa !92 ; 3 uses
...
bb.by:                                            ; preds = %bb.bx
  ...
  %i.lb = load i32, ptr %i.la, align 4, !tbaa !89
...
.thread.i.i39:                                    ; preds = %bb.cb
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(120) %i.kz, ptr noundef nonnull align 8 dereferenceable(120) %i.lh, i64 120, i1 false), !tbaa.struct !91
...
bb.c:                                             ; preds = %bb.b
  ...
  store ptr %1, ptr %i.c, align 8, !tbaa !107
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 208
  store ptr %2, ptr %i.d, align 8, !tbaa !108
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 216
  store ptr %3, ptr %i.e, align 8, !tbaa !109
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 192
  store ptr %4, ptr %i.f, align 8, !tbaa !110
  br label %bb.d
...
begin_hunk_20_@DoRemap:bb.a
  ...
  br i1 %.not51, label %bb.e, label %bb.d, !llvm.loop !111
...
bb.l:                                             ; preds = %NeedCompressedAlpha.exit
  ...
  %i.ar = load ptr, ptr %i.aq, align 8, !tbaa !112 ; 3 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.ay = load i32, ptr %i.ax, align 8, !tbaa !116
...
!88 = distinct !{!88, !87}
!89 = !{!90, !4, i64 48}
!90 = !{!"WebPDecoderOptions", !4, i64 0, !4, i64 4, !4, i64 8, !4, i64 12, !4, i64 16, !4, i64 20, !4, i64 24, !4, i64 28, !4, i64 32, !4, i64 36, !4, i64 40, !4, i64 44, !4, i64 48, !4, i64 52, !5, i64 56}
!91 = !{i64 0, i64 4, !3, i64 4, i64 4, !3, i64 8, i64 4, !3, i64 12, i64 4, !3, i64 16, i64 80, !32, i64 96, i64 16, !32, i64 112, i64 8, !83}
!92 = !{!93, !4, i64 0}
!93 = !{!"VP8LDecoder", !4, i64 0, !4, i64 4, !94, i64 8, !10, i64 16, !95, i64 24, !95, i64 32, !96, i64 40, !4, i64 80, !96, i64 88, !4, i64 128, !4, i64 132, !4, i64 136, !4, i64 140, !4, i64 144, !4, i64 148, !97, i64 152, !4, i64 272, !5, i64 280, !4, i64 376, !12, i64 384, !14, i64 392}
!94 = !{!"p1 _ZTS5VP8Io", !11, i64 0}
!95 = !{!"p1 int", !11, i64 0}
!96 = !{!"", !16, i64 0, !12, i64 8, !16, i64 16, !16, i64 24, !4, i64 32, !4, i64 36}
!97 = !{!"", !4, i64 0, !98, i64 8, !98, i64 24, !4, i64 40, !4, i64 44, !4, i64 48, !95, i64 56, !4, i64 64, !99, i64 72, !100, i64 80}
!98 = !{!"", !95, i64 0, !4, i64 8, !4, i64 12}
!99 = !{!"p1 _ZTS10HTreeGroup", !11, i64 0}
!100 = !{!"HuffmanTables", !101, i64 0, !102, i64 32}
!101 = !{!"HuffmanTablesSegment", !11, i64 0, !11, i64 8, !102, i64 16, !4, i64 24}
!102 = !{!"p1 _ZTS20HuffmanTablesSegment", !11, i64 0}
!103 = !{!93, !4, i64 80}
!104 = !{!18, !4, i64 4}
!105 = !{!8, !4, i64 40}
!106 = !{!18, !4, i64 8}
...
!112 = !{!34, !45, i64 2960}
!113 = !{!114, !115, i64 24}
!114 = !{!"ALPHDecoder", !4, i64 0, !4, i64 4, !4, i64 8, !4, i64 12, !4, i64 16, !115, i64 24, !15, i64 32, !4, i64 192, !12, i64 200, !12, i64 208}
!115 = !{!"p1 _ZTS11VP8LDecoder", !11, i64 0}
!116 = !{!114, !4, i64 8}
end_hunk_23
