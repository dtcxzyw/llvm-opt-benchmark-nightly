...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %.02026 = phi ptr [ %i.cr, %scalar.ph ], [ %.02026.ph, %scalar.ph.preheader ] ; 4 uses
  %.02125 = phi i32 [ %i.dh, %scalar.ph ], [ %.02125.ph, %scalar.ph.preheader ]
  %i.co = getelementptr inbounds nuw i8, ptr %.02026, i64 1
  %i.cp = load i8, ptr %.02026, align 1, !tbaa !37
  ...
  %i.cv = uitofp i8 %i.cp to double
  %i.cw = uitofp i8 %i.cs to double               ; 2 uses
  %i.cx = fmul nnan double %i.cv, %i.cw
  %i.cy = uitofp nneg i32 %i.cu to double         ; 2 uses
  %i.cz = fdiv double %i.cx, %i.cy
  %i.da = fadd double %i.cz, 5.000000e-01
  %i.db = fptoui double %i.da to i8
  %3 = load <2 x i8>, ptr %i.co, align 1, !tbaa !37
  ...
  %8 = insertelement <2 x double> poison, double %i.cy, i64 0
  ...
  %i.dc = fadd double %14, 5.000000e-01
  ...
  store i8 %13, ptr %i.de, align 1, !tbaa !37
