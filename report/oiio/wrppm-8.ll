...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %5 = uitofp nneg <4 x i32> %4 to <4 x double>   ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep33 = getelementptr i8, ptr %i.g, i64 %i.y ; 4 uses
  %6 = getelementptr i8, ptr %i.g, i64 %i.y       ; 4 uses
  %next.gep34 = getelementptr i8, ptr %6, i64 4
  %7 = getelementptr i8, ptr %i.g, i64 %i.y       ; 4 uses
  %next.gep35 = getelementptr i8, ptr %7, i64 8
  %8 = getelementptr i8, ptr %i.g, i64 %i.y       ; 4 uses
  %next.gep33.a = getelementptr i8, ptr %8, i64 12
  %i.z = getelementptr inbounds nuw i8, ptr %next.gep33, i64 1
  %next.gep34.a = getelementptr i8, ptr %6, i64 5
  %i.aa = getelementptr i8, ptr %7, i64 9
  %i.ab = getelementptr i8, ptr %8, i64 13
  %9 = load i8, ptr %next.gep33, align 1, !tbaa !37, !alias.scope !71
  %10 = load i8, ptr %next.gep34, align 1, !tbaa !37, !alias.scope !71
  %i.ac = load i8, ptr %next.gep35, align 1, !tbaa !37, !alias.scope !71
  %i.ad = load i8, ptr %next.gep33.a, align 1, !tbaa !37, !alias.scope !71
  %11 = insertelement <4 x i8> poison, i8 %9, i64 0
  %12 = insertelement <4 x i8> %11, i8 %10, i64 1
  %13 = insertelement <4 x i8> %12, i8 %i.ac, i64 2
  %14 = insertelement <4 x i8> %13, i8 %i.ad, i64 3
  %15 = getelementptr inbounds nuw i8, ptr %next.gep33, i64 2
  %16 = getelementptr i8, ptr %6, i64 6
  %i.ae = getelementptr i8, ptr %7, i64 10
  %i.af = getelementptr i8, ptr %8, i64 14
  %17 = load i8, ptr %i.z, align 1, !tbaa !37, !alias.scope !71
  %18 = load i8, ptr %next.gep34.a, align 1, !tbaa !37, !alias.scope !71
  %i.ag = load i8, ptr %i.aa, align 1, !tbaa !37, !alias.scope !71
  %i.ah = load i8, ptr %i.ab, align 1, !tbaa !37, !alias.scope !71
  %19 = insertelement <4 x i8> poison, i8 %17, i64 0
  %20 = insertelement <4 x i8> %19, i8 %18, i64 1
  %21 = insertelement <4 x i8> %20, i8 %i.ag, i64 2
  %22 = insertelement <4 x i8> %21, i8 %i.ah, i64 3
  %23 = getelementptr inbounds nuw i8, ptr %next.gep33, i64 3
  %24 = getelementptr i8, ptr %6, i64 7
  %i.ai = getelementptr i8, ptr %7, i64 11
  %i.aj = getelementptr i8, ptr %8, i64 15
  %25 = load i8, ptr %15, align 1, !tbaa !37, !alias.scope !71
  %26 = load i8, ptr %16, align 1, !tbaa !37, !alias.scope !71
  %i.ak = load i8, ptr %i.ae, align 1, !tbaa !37, !alias.scope !71
  %i.al = load i8, ptr %i.af, align 1, !tbaa !37, !alias.scope !71
  %27 = insertelement <4 x i8> poison, i8 %25, i64 0
  %28 = insertelement <4 x i8> %27, i8 %26, i64 1
  %29 = insertelement <4 x i8> %28, i8 %i.ak, i64 2
  %30 = insertelement <4 x i8> %29, i8 %i.al, i64 3
  %31 = load i8, ptr %23, align 1, !tbaa !37, !alias.scope !71
  %i.am = load i8, ptr %24, align 1, !tbaa !37, !alias.scope !71
  %i.an = load i8, ptr %i.ai, align 1, !tbaa !37, !alias.scope !71
  %32 = load i8, ptr %i.aj, align 1, !tbaa !37, !alias.scope !71
  %33 = insertelement <4 x i8> poison, i8 %31, i64 0
  %34 = insertelement <4 x i8> %33, i8 %i.am, i64 1
  %35 = insertelement <4 x i8> %34, i8 %i.an, i64 2
  %36 = insertelement <4 x i8> %35, i8 %32, i64 3
  %37 = uitofp <4 x i8> %14 to <4 x double>
  %38 = uitofp <4 x i8> %36 to <4 x double>       ; 3 uses
  %39 = fmul nnan <4 x double> %37, %38
  %40 = fdiv <4 x double> %39, %5
  %41 = uitofp <4 x i8> %22 to <4 x double>
  %42 = fmul nnan <4 x double> %41, %38
  %43 = fdiv <4 x double> %42, %5
  %44 = uitofp <4 x i8> %30 to <4 x double>
  %45 = fmul nnan <4 x double> %44, %38
  %46 = fdiv <4 x double> %45, %5
  %i.ao = fadd <4 x double> %46, splat (double 5.000000e-01)
  %i.ap = fptoui <4 x double> %i.ao to <4 x i8>
  %47 = shufflevector <4 x double> %40, <4 x double> %43, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %48 = fadd <8 x double> %47, splat (double 5.000000e-01)
  %49 = fptoui <8 x double> %48 to <8 x i8>
  %50 = shufflevector <4 x i8> %i.ap, <4 x i8> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %interleaved.vec = shufflevector <8 x i8> %49, <8 x i8> %50, <12 x i32> <i32 0, i32 4, i32 8, i32 1, i32 5, i32 9, i32 2, i32 6, i32 10, i32 3, i32 7, i32 11>
