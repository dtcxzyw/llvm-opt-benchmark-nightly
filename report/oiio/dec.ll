...
.preheader.preheader:
  ...
  %i.n = mul nsw i32 %i.m, 20091
  %i.o = ashr i32 %i.n, 16
  %11 = load i16, ptr %i.a, align 2, !tbaa !10
  %12 = sext i16 %i.i to i32                      ; 3 uses
  %i.p = sext i16 %11 to i32                      ; 3 uses
  %i.q = mul nsw i32 %i.p, 20091
  %i.r = ashr i32 %i.q, 16
  %13 = mul nsw i32 %12, 20091
  %14 = ashr i32 %13, 16
  %15 = add nsw i32 %14, %12
  %16 = load <4 x i8>, ptr %1, align 1, !tbaa !12
  %17 = zext <4 x i8> %16 to <4 x i32>
  %18 = getelementptr inbounds nuw i8, ptr %1, i64 32 ; 2 uses
  %19 = load i16, ptr %3, align 2, !tbaa !10
  %i.s = load i16, ptr %i.j, align 2, !tbaa !10
  %20 = load i16, ptr %10, align 2, !tbaa !10
  %i.t = load i16, ptr %5, align 2, !tbaa !10
  %i.u = sext i16 %19 to i32                      ; 3 uses
  %21 = sext i16 %i.s to i32                      ; 3 uses
  %22 = sext i16 %20 to i32                       ; 3 uses
  %23 = sext i16 %i.t to i32                      ; 3 uses
  %24 = mul nsw i32 %i.u, 20091
  %25 = mul nsw i32 %23, 20091
  %i.v = mul nsw i32 %23, 35468
  %i.w = ashr i32 %i.v, 16
  %26 = mul nsw i32 %21, 20091
  %27 = mul nsw i32 %21, 35468
  %i.x = mul nsw i32 %22, 20091
  %28 = ashr i32 %24, 16
  %29 = ashr i32 %26, 16
  %30 = ashr i32 %i.x, 16
  %31 = ashr i32 %25, 16
  %32 = add nsw i32 %28, %i.u
  %33 = add nsw i32 %29, %21
  %34 = add nsw i32 %30, %22
  %35 = add nsw i32 %31, %23
  %i.y = mul nsw i32 %22, 35468
  %i.z = ashr i32 %i.y, 16
  %36 = mul nsw i32 %i.p, 35468
  %37 = mul nsw i32 %12, 35468
  %38 = mul nsw i32 %i.m, 35468
  %i.aa = mul nsw i32 %i.e, 35468
  %39 = ashr i32 %36, 16
  %40 = ashr i32 %37, 16
  %41 = ashr i32 %38, 16
  %i.ab = ashr i32 %i.aa, 16
  %42 = sub nsw i32 %39, %32                      ; 2 uses
  %43 = sub nsw i32 %40, %33                      ; 2 uses
  %i.ac = sub nsw i32 %41, %34                    ; 2 uses
  %44 = sub nsw i32 %i.ab, %35                    ; 2 uses
  %i.ad = ashr i32 %27, 16
  %i.ae = mul nsw i32 %i.u, 35468
  %i.af = ashr i32 %i.ae, 16
  %45 = add nsw i32 %15, %i.ad                    ; 2 uses
  %46 = load <4 x i8>, ptr %18, align 1, !tbaa !12
  %47 = zext <4 x i8> %46 to <4 x i32>
  %48 = getelementptr inbounds nuw i8, ptr %1, i64 64 ; 2 uses
  %49 = load <4 x i8>, ptr %48, align 1, !tbaa !12
  %50 = zext <4 x i8> %49 to <4 x i32>
  %51 = getelementptr inbounds nuw i8, ptr %1, i64 96 ; 2 uses
  %52 = load i16, ptr %2, align 2, !tbaa !10
  %53 = load i16, ptr %7, align 2, !tbaa !10
  %54 = load i16, ptr %9, align 2, !tbaa !10
  %55 = load i16, ptr %i.b, align 2, !tbaa !10
  %56 = sext i16 %52 to i32                       ; 2 uses
  %57 = sext i16 %53 to i32                       ; 2 uses
  %58 = sext i16 %54 to i32                       ; 2 uses
  %59 = sext i16 %55 to i32                       ; 2 uses
  %60 = load i16, ptr %0, align 2, !tbaa !10
  %61 = load i16, ptr %6, align 2, !tbaa !10
  %62 = load i16, ptr %8, align 2, !tbaa !10
  %63 = load i16, ptr %4, align 2, !tbaa !10
  %i.ag = add nsw i32 %i.r, %i.p
  %i.ah = add nsw i32 %i.o, %i.m
  %i.ai = add nsw i32 %i.g, %i.e
  %64 = sext i16 %60 to i32                       ; 2 uses
  %65 = sext i16 %61 to i32                       ; 2 uses
  %66 = sext i16 %62 to i32                       ; 2 uses
  %67 = sext i16 %63 to i32                       ; 2 uses
  %68 = sub nsw i32 %66, %58                      ; 2 uses
  %69 = sub nsw i32 %67, %59                      ; 2 uses
  %70 = add nsw i32 %i.ag, %i.af                  ; 2 uses
  %i.aj = add nsw i32 %i.ah, %i.z                 ; 2 uses
  %i.ak = add nsw i32 %i.ai, %i.w                 ; 2 uses
  %71 = add nsw i32 %56, %64                      ; 2 uses
  %72 = add nsw i32 %57, %65                      ; 2 uses
  %73 = add nsw i32 %58, %66                      ; 2 uses
  %i.al = add nsw i32 %59, %67                    ; 2 uses
  %74 = add nsw i32 %i.aj, %73                    ; 3 uses
  %75 = add nsw i32 %i.ak, %i.al                  ; 3 uses
  %76 = add nsw i32 %70, %71
  %i.am = mul nsw i32 %75, 35468
  %i.an = mul nsw i32 %74, 35468
  %77 = add nsw i32 %i.ac, %68                    ; 3 uses
  %78 = add nsw i32 %44, %69                      ; 3 uses
  %79 = mul nsw i32 %74, 20091
  %i.ao = ashr i32 %79, 16
  %80 = mul nsw i32 %75, 20091
  %i.ap = ashr i32 %80, 16
  %81 = add nsw i32 %74, %i.ao
  %i.aq = add nsw i32 %i.ap, %75
  %i.ar = add nsw i32 %76, 4                      ; 2 uses
  %82 = ashr i32 %i.am, 16
  %83 = ashr i32 %i.an, 16
  %i.as = sub nsw i32 %82, %81                    ; 2 uses
  %84 = add nsw i32 %i.aq, %83                    ; 2 uses
  %i.at = mul nsw i32 %78, 35468
  %i.au = mul nsw i32 %77, 20091
  %i.av = ashr i32 %i.au, 16
  %i.aw = mul nsw i32 %78, 20091
  %i.ax = ashr i32 %i.aw, 16
  %i.ay = add nsw i32 %77, %i.av
  %i.az = add nsw i32 %i.ax, %78
  %85 = mul nsw i32 %77, 35468
  %i.ba = ashr i32 %i.at, 16
  %i.bb = ashr i32 %85, 16
  %i.bc = sub nsw i32 %i.ba, %i.ay                ; 2 uses
  %i.bd = add nsw i32 %i.az, %i.bb                ; 2 uses
  %i.be = sub nsw i32 %71, %70
  %i.bf = sub nsw i32 %73, %i.aj                  ; 3 uses
  %i.bg = sub nsw i32 %i.al, %i.ak                ; 3 uses
  %i.bh = sub nsw i32 %64, %56                    ; 2 uses
  %i.bi = sub nsw i32 %69, %44                    ; 3 uses
  %86 = sub nsw i32 %68, %i.ac                    ; 3 uses
  %i.bj = add nsw i32 %42, %i.bh
  %i.bk = add nsw i32 %45, %72                    ; 2 uses
  %i.bl = add nsw i32 %i.ar, %i.bk                ; 2 uses
  %i.bm = sub nsw i32 %i.ar, %i.bk                ; 2 uses
  %i.bn = sub nsw i32 %i.bl, %84
  %i.bo = sub nsw i32 %i.bm, %i.as
  %i.bp = add nsw i32 %i.as, %i.bm
  %i.bq = add nsw i32 %84, %i.bl
  ...
  store <4 x i8> %i.bz, ptr %1, align 1, !tbaa !12
  %i.ca = sub nsw i32 %65, %57                    ; 2 uses
  %87 = sub nsw i32 %i.bh, %42
  %88 = mul nsw i32 %i.bi, 35468
  %89 = mul nsw i32 %86, 35468
  %i.cb = add nsw i32 %43, %i.ca                  ; 2 uses
  %i.cc = add nsw i32 %i.bj, 4                    ; 2 uses
  %i.cd = add nsw i32 %i.cc, %i.cb                ; 2 uses
  %i.ce = sub nsw i32 %i.cc, %i.cb                ; 2 uses
  %i.cf = sub nsw i32 %i.cd, %i.bd
  %i.cg = sub nsw i32 %i.ce, %i.bc
  %i.ch = add nsw i32 %i.bc, %i.ce
  %i.ci = add nsw i32 %i.bd, %i.cd
  ...
  store <4 x i8> %i.cr, ptr %18, align 1, !tbaa !12
  %90 = mul nsw i32 %86, 20091
  %91 = ashr i32 %90, 16
  %92 = mul nsw i32 %i.bi, 20091
  %93 = ashr i32 %92, 16
  %i.cs = sub nsw i32 %i.ca, %43                  ; 2 uses
  %94 = ashr i32 %88, 16
  %95 = ashr i32 %89, 16
  %96 = add nsw i32 %87, 4                        ; 2 uses
  %97 = add nsw i32 %86, %91
  %i.ct = add nsw i32 %93, %i.bi
  %i.cu = add nsw i32 %96, %i.cs                  ; 2 uses
  %98 = sub nsw i32 %96, %i.cs                    ; 2 uses
  %99 = sub nsw i32 %94, %97                      ; 2 uses
  %100 = add nsw i32 %i.ct, %95                   ; 2 uses
  %i.cv = sub nsw i32 %i.cu, %100
  %i.cw = sub nsw i32 %98, %99
  %i.cx = add nsw i32 %99, %98
  %i.cy = add nsw i32 %100, %i.cu
  ...
  store <4 x i8> %i.dh, ptr %48, align 1, !tbaa !12
  %101 = mul nsw i32 %i.bg, 35468
  %i.di = mul nsw i32 %i.bf, 20091
  %i.dj = ashr i32 %i.di, 16
  %i.dk = mul nsw i32 %i.bg, 20091
  %i.dl = ashr i32 %i.dk, 16
  %102 = add nsw i32 %i.bf, %i.dj
  %i.dm = add nsw i32 %i.dl, %i.bg
  %103 = mul nsw i32 %i.bf, 35468
  %i.dn = sub nsw i32 %72, %45                    ; 2 uses
  %i.do = add nsw i32 %i.be, 4                    ; 2 uses
  %i.dp = ashr i32 %101, 16
  %i.dq = ashr i32 %103, 16
  %i.dr = add nsw i32 %i.do, %i.dn                ; 2 uses
  %i.ds = sub nsw i32 %i.do, %i.dn                ; 2 uses
  %i.dt = sub nsw i32 %i.dp, %102                 ; 2 uses
  %i.du = add nsw i32 %i.dm, %i.dq                ; 2 uses
  %i.dv = load <4 x i8>, ptr %51, align 1, !tbaa !12
  ...
  store <4 x i8> %i.ej, ptr %51, align 1, !tbaa !12
  ret void
}
