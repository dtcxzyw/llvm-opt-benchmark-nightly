...
.preheader:                                       ; preds = %.preheader.ph, %.preheader
  ...
  %5 = load <4 x i8>, ptr %i.cr, align 1, !tbaa !12
  %i.cy = load <2 x i8>, ptr %.01419, align 1, !tbaa !12
  %6 = zext <2 x i8> %i.cy to <2 x i32>
  %7 = shufflevector <2 x i32> %6, <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  ...
  %10 = shufflevector <8 x i32> %7, <8 x i32> %9, <8 x i32> <i32 0, i32 1, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 poison>
  %11 = zext <2 x i8> %4 to <2 x i32>
  %12 = shufflevector <2 x i32> %11, <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %13 = shufflevector <8 x i32> %10, <8 x i32> %12, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 8, i32 9>
  %i.cz = add nsw <8 x i32> %i.cx, %13
