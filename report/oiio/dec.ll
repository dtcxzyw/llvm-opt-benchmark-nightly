...
.preheader.preheader:
  ...
  %8 = mul nsw i32 %i.aj, 20091
  %9 = ashr i32 %8, 16
  %i.aq = mul nsw i32 %i.an, 35468
  %10 = sext i16 %i.y to i32                      ; 3 uses
  %i.ar = mul nsw i32 %10, 20091
  %i.as = ashr i32 %i.ar, 16
  %11 = add nsw i32 %i.as, %10
  %12 = ashr i32 %i.ae, 16
  %13 = ashr i32 %6, 16
  %14 = ashr i32 %i.u, 16
  %15 = ashr i32 %i.aq, 16
  %i.at = mul nsw i32 %10, 35468
  %16 = add nsw i32 %11, %12                      ; 2 uses
  %17 = load <4 x i8>, ptr %1, align 1, !tbaa !12
  %18 = zext <4 x i8> %17 to <4 x i32>
  %19 = getelementptr inbounds nuw i8, ptr %1, i64 32 ; 2 uses
  %i.au = add nsw i32 %i.ad, %i.ab
  %20 = ashr i32 %i.at, 16
  %i.av = ashr i32 %3, 16
  %i.aw = ashr i32 %i.m, 16
  %21 = ashr i32 %i.ak, 16
  %22 = sub nsw i32 %20, %i.au                    ; 2 uses
  %23 = load <4 x i8>, ptr %19, align 1, !tbaa !12
  %24 = zext <4 x i8> %23 to <4 x i32>
  %25 = getelementptr inbounds nuw i8, ptr %1, i64 64 ; 2 uses
  %i.ax = add nsw i32 %i.h, %i.f
  %i.ay = add nsw i32 %i.r, %i.p
  %i.az = add nsw i32 %i.ap, %i.an
  %26 = sub nsw i32 %i.av, %i.ax                  ; 2 uses
  %27 = sub nsw i32 %i.aw, %i.ay                  ; 2 uses
  %28 = sub nsw i32 %21, %i.az                    ; 2 uses
  %29 = load <4 x i8>, ptr %25, align 1, !tbaa !12
  %30 = zext <4 x i8> %29 to <4 x i32>
  %31 = getelementptr inbounds nuw i8, ptr %1, i64 96 ; 2 uses
  %32 = load i16, ptr %i.w, align 2, !tbaa !10
  %33 = load i16, ptr %2, align 2, !tbaa !10
  %34 = load i16, ptr %7, align 2, !tbaa !10
  %35 = load i16, ptr %i.ag, align 2, !tbaa !10
  %36 = add nsw i32 %5, %i.c
  %i.ba = add nsw i32 %i.t, %i.l
  %37 = add nsw i32 %9, %i.aj
  %38 = add nsw i32 %36, %13                      ; 2 uses
  %39 = add nsw i32 %i.ba, %14                    ; 2 uses
  %40 = add nsw i32 %37, %15                      ; 2 uses
  %41 = sext i16 %32 to i32                       ; 2 uses
  %42 = sext i16 %33 to i32                       ; 2 uses
  %43 = sext i16 %34 to i32                       ; 2 uses
  %44 = sext i16 %35 to i32                       ; 2 uses
  %45 = load i16, ptr %i.v, align 2, !tbaa !10
  %46 = load i16, ptr %0, align 2, !tbaa !10
  %47 = load i16, ptr %i.i, align 2, !tbaa !10
  %48 = load i16, ptr %i.af, align 2, !tbaa !10
  %49 = sext i16 %45 to i32                       ; 2 uses
  %50 = sext i16 %46 to i32                       ; 2 uses
  %51 = sext i16 %47 to i32                       ; 2 uses
  %52 = sext i16 %48 to i32                       ; 2 uses
  %53 = add nsw i32 %41, %49                      ; 2 uses
  %54 = add nsw i32 %42, %50                      ; 2 uses
  %55 = add nsw i32 %43, %51                      ; 2 uses
  %i.bb = add nsw i32 %44, %52                    ; 2 uses
  %i.bc = add nsw i32 %38, %54
  %56 = add nsw i32 %39, %55                      ; 3 uses
  %57 = add nsw i32 %40, %i.bb                    ; 3 uses
  %i.bd = sub nsw i32 %54, %38
  %58 = sub nsw i32 %55, %39                      ; 3 uses
  %59 = sub nsw i32 %i.bb, %40                    ; 3 uses
  %60 = mul nsw i32 %57, 20091
  %61 = ashr i32 %60, 16
  %62 = mul nsw i32 %56, 20091
  %63 = ashr i32 %62, 16
  %64 = mul nsw i32 %56, 35468
  %65 = mul nsw i32 %57, 35468
  %i.be = add nsw i32 %57, %61
  %66 = add nsw i32 %63, %56
  %67 = add nsw i32 %16, %53                      ; 2 uses
  %68 = add nsw i32 %i.bc, 4                      ; 2 uses
  %69 = ashr i32 %64, 16
  %70 = ashr i32 %65, 16
  %i.bf = add nsw i32 %68, %67                    ; 2 uses
  %71 = sub nsw i32 %68, %67                      ; 2 uses
  %i.bg = sub nsw i32 %69, %i.be                  ; 2 uses
  %72 = add nsw i32 %66, %70                      ; 2 uses
  %i.bh = sub nsw i32 %i.bf, %72
  %i.bi = sub nsw i32 %71, %i.bg
  %i.bj = add nsw i32 %i.bg, %71
  %i.bk = add nsw i32 %72, %i.bf
  ...
  store <4 x i8> %i.bt, ptr %1, align 1, !tbaa !12
  %73 = sub nsw i32 %50, %42                      ; 2 uses
  %74 = sub nsw i32 %51, %43                      ; 2 uses
  %75 = sub nsw i32 %52, %44                      ; 2 uses
  %76 = add nsw i32 %26, %73
  %77 = add nsw i32 %27, %74                      ; 3 uses
  %78 = add nsw i32 %28, %75                      ; 3 uses
  %79 = sub nsw i32 %49, %41                      ; 2 uses
  %80 = sub nsw i32 %73, %26
  %81 = sub nsw i32 %74, %27                      ; 3 uses
  %82 = sub nsw i32 %75, %28                      ; 3 uses
  %i.bu = mul nsw i32 %78, 20091
  %i.bv = ashr i32 %i.bu, 16
  %83 = mul nsw i32 %77, 20091
  %i.bw = ashr i32 %83, 16
  %84 = mul nsw i32 %77, 35468
  %85 = mul nsw i32 %78, 35468
  %i.bx = add nsw i32 %78, %i.bv
  %i.by = add nsw i32 %i.bw, %77
  %i.bz = add nsw i32 %22, %79                    ; 2 uses
  %i.ca = add nsw i32 %76, 4                      ; 2 uses
  %86 = ashr i32 %84, 16
  %87 = ashr i32 %85, 16
  %i.cb = add nsw i32 %i.ca, %i.bz                ; 2 uses
  %88 = sub nsw i32 %i.ca, %i.bz                  ; 2 uses
  %89 = sub nsw i32 %86, %i.bx                    ; 2 uses
  %90 = add nsw i32 %i.by, %87                    ; 2 uses
  %i.cc = sub nsw i32 %i.cb, %90
  %i.cd = sub nsw i32 %88, %89
  %i.ce = add nsw i32 %89, %88
  %i.cf = add nsw i32 %90, %i.cb
  ...
  store <4 x i8> %i.co, ptr %19, align 1, !tbaa !12
  %91 = mul nsw i32 %82, 20091
  %92 = ashr i32 %91, 16
  %93 = mul nsw i32 %81, 20091
  %94 = ashr i32 %93, 16
  %95 = mul nsw i32 %81, 35468
  %96 = mul nsw i32 %82, 35468
  %97 = sub nsw i32 %79, %22                      ; 2 uses
  %98 = ashr i32 %95, 16
  %99 = ashr i32 %96, 16
  %i.cp = add nsw i32 %80, 4                      ; 2 uses
  %i.cq = add nsw i32 %82, %92
  %i.cr = add nsw i32 %94, %81
  %i.cs = add nsw i32 %i.cp, %97                  ; 2 uses
  %100 = sub nsw i32 %i.cp, %97                   ; 2 uses
  %i.ct = sub nsw i32 %98, %i.cq                  ; 2 uses
  %101 = add nsw i32 %i.cr, %99                   ; 2 uses
  %i.cu = sub nsw i32 %i.cs, %101
  %i.cv = sub nsw i32 %100, %i.ct
  %i.cw = add nsw i32 %i.ct, %100
  %i.cx = add nsw i32 %101, %i.cs
  ...
  store <4 x i8> %i.dg, ptr %25, align 1, !tbaa !12
  %i.dh = mul nsw i32 %59, 20091
  %i.di = ashr i32 %i.dh, 16
  %i.dj = mul nsw i32 %58, 20091
  %i.dk = ashr i32 %i.dj, 16
  %102 = mul nsw i32 %58, 35468
  %103 = mul nsw i32 %59, 35468
  %i.dl = add nsw i32 %59, %i.di
  %i.dm = add nsw i32 %i.dk, %58
  %i.dn = sub nsw i32 %53, %16                    ; 2 uses
  %i.do = add nsw i32 %i.bd, 4                    ; 2 uses
  %i.dp = ashr i32 %102, 16
  ...
  %i.dv = load <4 x i8>, ptr %31, align 1, !tbaa !12
  ...
  store <4 x i8> %i.ej, ptr %31, align 1, !tbaa !12
  ret void
}
