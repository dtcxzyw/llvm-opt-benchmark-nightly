...
.preheader.preheader:
  ...
  %2 = mul nsw i32 %i.d, 35468
  %i.e = getelementptr inbounds nuw i8, ptr %0, i64 24
  %3 = load i16, ptr %i.e, align 2, !tbaa !10
  %4 = sext i16 %3 to i32                         ; 3 uses
  %5 = mul nsw i32 %4, 20091
  %6 = ashr i32 %5, 16
  %i.f = mul nsw i32 %i.d, 20091
  %i.g = ashr i32 %i.f, 16
  %7 = mul nsw i32 %4, 35468
  ...
  %8 = mul nsw i32 %i.l, 35468
  %i.m = getelementptr inbounds nuw i8, ptr %0, i64 26
  %9 = load i16, ptr %i.m, align 2, !tbaa !10
  %10 = sext i16 %9 to i32                        ; 3 uses
  %11 = mul nsw i32 %10, 20091
  %12 = ashr i32 %11, 16
  %13 = mul nsw i32 %i.l, 20091
  %14 = ashr i32 %13, 16
  %15 = mul nsw i32 %10, 35468
  ...
  %16 = load i16, ptr %i.r, align 2, !tbaa !10
  %i.s = sext i16 %16 to i32                      ; 3 uses
  %i.t = mul nsw i32 %i.s, 20091
  %i.u = ashr i32 %i.t, 16
  %17 = mul nsw i32 %i.s, 35468
  ...
  %19 = sext i16 %i.x to i32                      ; 3 uses
  %20 = mul nsw i32 %19, 35468
  %21 = getelementptr inbounds nuw i8, ptr %0, i64 30
  %22 = load i16, ptr %21, align 2, !tbaa !10
  %i.y = sext i16 %22 to i32                      ; 3 uses
  %23 = mul nsw i32 %i.y, 20091
  %24 = ashr i32 %23, 16
  %i.z = mul nsw i32 %19, 20091
  %25 = ashr i32 %i.z, 16
  %i.aa = mul nsw i32 %i.y, 35468
  %26 = sext i16 %i.q to i32                      ; 3 uses
  %i.ab = mul nsw i32 %26, 20091
  %27 = ashr i32 %i.ab, 16
  ...
  %i.ag = mul nsw i32 %26, 35468
  %29 = add nsw i32 %28, %i.ac                    ; 2 uses
  %30 = load <4 x i8>, ptr %1, align 1, !tbaa !12
  %31 = zext <4 x i8> %30 to <4 x i32>
  %32 = getelementptr inbounds nuw i8, ptr %1, i64 32 ; 2 uses
  %33 = add nsw i32 %i.u, %i.s
  %34 = ashr i32 %i.ag, 16
  %35 = ashr i32 %2, 16
  %36 = ashr i32 %8, 16
  %37 = ashr i32 %20, 16
  %38 = sub nsw i32 %34, %33                      ; 2 uses
  %39 = load <4 x i8>, ptr %32, align 1, !tbaa !12
  %40 = zext <4 x i8> %39 to <4 x i32>
  %41 = getelementptr inbounds nuw i8, ptr %1, i64 64 ; 2 uses
  %42 = add nsw i32 %6, %4
  %43 = add nsw i32 %12, %10
  %44 = add nsw i32 %24, %i.y
  %i.ah = sub nsw i32 %35, %42                    ; 2 uses
  %i.ai = sub nsw i32 %36, %43                    ; 2 uses
  %i.aj = sub nsw i32 %37, %44                    ; 2 uses
  %i.ak = load <4 x i8>, ptr %41, align 1, !tbaa !12
  %i.al = zext <4 x i8> %i.ak to <4 x i32>
  %i.am = getelementptr inbounds nuw i8, ptr %1, i64 96 ; 2 uses
  %45 = load i16, ptr %i.o, align 2, !tbaa !10
  %46 = load i16, ptr %i.a, align 2, !tbaa !10
  %47 = load i16, ptr %i.i, align 2, !tbaa !10
  %48 = load i16, ptr %18, align 2, !tbaa !10
  %i.an = add nsw i32 %i.g, %i.d
  %i.ao = add nsw i32 %14, %i.l
  %49 = add nsw i32 %25, %19
  %50 = add nsw i32 %i.an, %i.ad                  ; 2 uses
  %51 = add nsw i32 %i.ao, %i.ae                  ; 2 uses
  %52 = add nsw i32 %49, %i.af                    ; 2 uses
  %i.ap = sext i16 %45 to i32                     ; 2 uses
  %i.aq = sext i16 %46 to i32                     ; 2 uses
  %i.ar = sext i16 %47 to i32                     ; 2 uses
  %i.as = sext i16 %48 to i32                     ; 2 uses
  %i.at = load i16, ptr %i.n, align 2, !tbaa !10
  %i.au = load i16, ptr %0, align 2, !tbaa !10
  %i.av = load i16, ptr %i.h, align 2, !tbaa !10
  %i.aw = load i16, ptr %i.v, align 2, !tbaa !10
  ...
  %i.bb = add nsw i32 %i.ap, %i.ax                ; 2 uses
  %i.bc = add nsw i32 %i.aq, %i.ay                ; 2 uses
  %i.bd = add nsw i32 %i.ar, %i.az                ; 2 uses
  %i.be = add nsw i32 %i.as, %i.ba                ; 2 uses
  %i.bf = add nsw i32 %50, %i.bc
  %i.bg = add nsw i32 %51, %i.bd                  ; 3 uses
  %i.bh = add nsw i32 %52, %i.be                  ; 3 uses
  %i.bi = sub nsw i32 %i.bc, %50
  %i.bj = sub nsw i32 %i.bd, %51                  ; 3 uses
  %i.bk = sub nsw i32 %i.be, %52                  ; 3 uses
  %i.bl = mul nsw i32 %i.bh, 20091
  %53 = ashr i32 %i.bl, 16
  %54 = mul nsw i32 %i.bg, 20091
  %i.bm = ashr i32 %54, 16
  %i.bn = mul nsw i32 %i.bg, 35468
  %i.bo = mul nsw i32 %i.bh, 35468
  %i.bp = add nsw i32 %i.bh, %53
  %i.bq = add nsw i32 %i.bm, %i.bg
  %i.br = add nsw i32 %29, %i.bb                  ; 2 uses
  ...
  %i.cm = sub nsw i32 %i.ay, %i.aq                ; 2 uses
  %i.cn = sub nsw i32 %i.az, %i.ar                ; 2 uses
  %i.co = sub nsw i32 %i.ba, %i.as                ; 2 uses
  %i.cp = add nsw i32 %i.ah, %i.cm
  %i.cq = add nsw i32 %i.ai, %i.cn                ; 3 uses
  %i.cr = add nsw i32 %i.aj, %i.co                ; 3 uses
  %i.cs = sub nsw i32 %i.ax, %i.ap                ; 2 uses
  %i.ct = sub nsw i32 %i.cm, %i.ah
  %i.cu = sub nsw i32 %i.cn, %i.ai                ; 3 uses
  %i.cv = sub nsw i32 %i.co, %i.aj                ; 3 uses
  %i.cw = mul nsw i32 %i.cr, 20091
  %55 = ashr i32 %i.cw, 16
  %56 = mul nsw i32 %i.cq, 20091
  %i.cx = ashr i32 %56, 16
  %i.cy = mul nsw i32 %i.cq, 35468
  %i.cz = mul nsw i32 %i.cr, 35468
  %i.da = add nsw i32 %i.cr, %55
  %i.db = add nsw i32 %i.cx, %i.cq
  %i.dc = add nsw i32 %38, %i.cs                  ; 2 uses
  ...
  store <4 x i8> %i.dw, ptr %32, align 1, !tbaa !12
  %i.dx = mul nsw i32 %i.cv, 20091
  %57 = ashr i32 %i.dx, 16
  %58 = mul nsw i32 %i.cu, 20091
  %i.dy = ashr i32 %58, 16
  %59 = mul nsw i32 %i.cu, 35468
  %i.dz = mul nsw i32 %i.cv, 35468
  %60 = sub nsw i32 %i.cs, %38                    ; 2 uses
  %61 = ashr i32 %59, 16
  %62 = ashr i32 %i.dz, 16
  %i.ea = add nsw i32 %i.ct, 4                    ; 2 uses
  %63 = add nsw i32 %i.cv, %57
  %64 = add nsw i32 %i.dy, %i.cu
  %i.eb = add nsw i32 %i.ea, %60                  ; 2 uses
  %i.ec = sub nsw i32 %i.ea, %60                  ; 2 uses
  %i.ed = sub nsw i32 %61, %63                    ; 2 uses
  %i.ee = add nsw i32 %64, %62                    ; 2 uses
  ...
  store <4 x i8> %i.er, ptr %41, align 1, !tbaa !12
  %i.es = mul nsw i32 %i.bk, 20091
  %65 = ashr i32 %i.es, 16
  %66 = mul nsw i32 %i.bj, 20091
  %i.et = ashr i32 %66, 16
  %67 = mul nsw i32 %i.bj, 35468
  %68 = mul nsw i32 %i.bk, 35468
  %69 = add nsw i32 %i.bk, %65
  %i.eu = add nsw i32 %i.et, %i.bj
  %70 = sub nsw i32 %i.bb, %29                    ; 2 uses
  %71 = add nsw i32 %i.bi, 4                      ; 2 uses
  %i.ev = ashr i32 %67, 16
  %i.ew = ashr i32 %68, 16
  %i.ex = add nsw i32 %71, %70                    ; 2 uses
  %i.ey = sub nsw i32 %71, %70                    ; 2 uses
  %i.ez = sub nsw i32 %i.ev, %69                  ; 2 uses
  %i.fa = add nsw i32 %i.eu, %i.ew                ; 2 uses
