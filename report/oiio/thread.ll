...
bb.c:                                             ; preds = %bb.b, %bb.a
  ...
  %i.n = load i32, ptr %7, align 8, !tbaa !201    ; 3 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.s = load ptr, ptr %i.r, align 8, !tbaa !197  ; 2 uses
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  br i1 %i.bv, label %bb.n, label %_ZN11OpenImageIO4v3_18task_setC2EPNS0_11thread_poolE.exit

bb.n:                                             ; preds = %bb.m
  %i.bw = sdiv i64 %i.q, %.025
  %.sroa.speculated59 = tail call i64 @llvm.smax.i64(i64 %i.bw, i64 1)
  %i.bx = sext i32 %i.n to i64
...
_ZN11OpenImageIO4v3_18task_setC2EPNS0_11thread_poolE.exit: ; preds = %bb.m, %bb.n
  %.024 = phi i64 [ %.sroa.speculated47, %bb.n ], [ %2, %bb.m ] ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %8) #30
  store ptr %i.s, ptr %8, align 8, !tbaa !173
