...
.outer:                                           ; preds = %.outer.backedge, %bb.r
  %.sroa.0356.0.ph = phi ptr [ null, %bb.r ], [ %.sroa.0356.0.ph.be, %.outer.backedge ] ; 44 uses
  %.sroa.17.0.ph = phi ptr [ null, %bb.r ], [ %.sroa.17.0.ph.be, %.outer.backedge ] ; 15 uses
  %.sroa.30.0.ph = phi ptr [ null, %bb.r ], [ %.sroa.30.0.ph.be, %.outer.backedge ] ; 33 uses
...
begin_hunk_1_@_ZNK16OpenColorIO_v2_512_GLOBAL__N_115LocalFileFormat4readERSiRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEENS_13InterpolationE:bb.a
  ...
  br i1 %i.li, label %bb.br, label %_ZNSt6vectorIfSaIfEE7reserveEm.exit
...
_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit214: ; preds = %bb.ai
  ...
  br i1 %i.lj, label %bb.br, label %_ZNSt6vectorIfSaIfEE7reserveEm.exit
...
bb.br:                                            ; preds = %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit214, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit212, %_ZNSt6vectorIfSaIfEE7reserveEm.exit
  %22 = phi i1 [ %i.lm, %_ZNSt6vectorIfSaIfEE7reserveEm.exit ], [ true, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit214 ], [ false, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit212 ]
  %23 = phi i1 [ %i.ll, %_ZNSt6vectorIfSaIfEE7reserveEm.exit ], [ false, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit214 ], [ true, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit212 ]
  %.171396 = phi i8 [ %.070.ph, %_ZNSt6vectorIfSaIfEE7reserveEm.exit ], [ 1, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit214 ], [ 0, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit212 ] ; 7 uses
  %.173394 = phi i8 [ %.072.ph, %_ZNSt6vectorIfSaIfEE7reserveEm.exit ], [ 0, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit214 ], [ 1, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit212 ] ; 7 uses
  %.sroa.30.2392 = phi ptr [ %.sroa.30.2, %_ZNSt6vectorIfSaIfEE7reserveEm.exit ], [ %.sroa.30.0.ph, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit214 ], [ %.sroa.30.0.ph, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit212 ] ; 14 uses
  %.sroa.17.1391 = phi ptr [ %.sroa.17.1, %_ZNSt6vectorIfSaIfEE7reserveEm.exit ], [ %.sroa.17.0.ph, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit214 ], [ %.sroa.17.0.ph, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit212 ] ; 8 uses
  %.sroa.0356.2390 = phi ptr [ %.sroa.0356.2, %_ZNSt6vectorIfSaIfEE7reserveEm.exit ], [ %.sroa.0356.0.ph, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit214 ], [ %.sroa.0356.0.ph, %_ZSteqIcSt11char_traitsIcESaIcEEbRKNSt7__cxx1112basic_stringIT_T0_T1_EEPKS5_.exit212 ] ; 16 uses
...
bb.bu:                                            ; preds = %bb.bt
  br i1 %23, label %bb.bv, label %bb.ck
...
bb.ck:                                            ; preds = %bb.bu
  br i1 %22, label %bb.cl, label %.outer.backedge
