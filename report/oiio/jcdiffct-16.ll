...
begin_hunk_0_@compress_first_pass:bb.a
  ...
  %i.cc = tail call ptr %i.bu(ptr noundef nonnull %0, ptr noundef %i.bx, i32 noundef %i.cb, i32 noundef %i.ca, i32 noundef 0) #6
  ...
  br i1 %i.cg, label %bb.g, label %compress_output.exit, !llvm.loop !90
...
begin_hunk_1_@compress_output:bb.a
  ...
  br i1 %i.ac, label %bb.b, label %._crit_edge, !llvm.loop !90
