...
define noundef i32 @TIFFPredictorCleanup(ptr noundef captures(none) initializes((936, 944), (952, 960), (1256, 1280)) %0) local_unnamed_addr #2 {
bb.a:
...
; Function Attrs: nounwind uwtable
define internal range(i32 0, 2) i32 @horAcc8(ptr noundef %0, ptr noundef captures(none) %1, i64 noundef %2) #0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 1072
