...
.lr.ph196:                                        ; preds = %.preheader190
  ...
  %min.iters.check241 = icmp ult i64 %i.p, 32
  %n.mod.vf = and i64 %i.p, 28
  %n.vec = and i64 %i.p, -32                      ; 4 uses
  %i.r = and i64 %i.p, 31
  %cmp.n = icmp eq i64 %i.p, %n.vec
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf, 0
  %n.vec247 = and i64 %i.p, -4                    ; 3 uses
  %i.s = and i64 %i.d, 3
  %cmp.n253 = icmp eq i64 %i.p, %n.vec247
  br label %bb.e
...
.lr.ph204.preheader:                              ; preds = %.preheader186
  %.pre220 = load i8, ptr %.0159.lcssa, align 1, !tbaa !64 ; 2 uses
...
.lr.ph204.prol:                                   ; preds = %.lr.ph204.preheader, %.lr.ph204.prol
  %i.x = phi i8 [ %.narrow176.prol, %.lr.ph204.prol ], [ %.pre220, %.lr.ph204.preheader ]
...
.lr.ph204.prol.loopexit:                          ; preds = %.lr.ph204.prol, %.lr.ph204.preheader
  %.unr = phi i8 [ %.pre220, %.lr.ph204.preheader ], [ %.narrow176.prol, %.lr.ph204.prol ]
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load242 = load <16 x i8>, ptr %i.bi, align 1, !tbaa !64
  %i.bj = getelementptr i8, ptr %next.gep, i64 16
  %wide.load243.a = load <16 x i8>, ptr %next.gep, align 1, !tbaa !64
  %wide.load244.a = load <16 x i8>, ptr %i.bj, align 1, !tbaa !64
  %i.bk = add <16 x i8> %wide.load243.a, %wide.load
  %i.bl = add <16 x i8> %wide.load244.a, %wide.load242
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %i.bn = getelementptr i8, ptr %.2161194, i64 %n.vec247 ; 2 uses
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index248 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next252, %vec.epilog.vector.body ] ; 2 uses
  %next.gep249 = getelementptr i8, ptr %.2161194, i64 %index248 ; 2 uses
  %i.bo = getelementptr inbounds nuw i8, ptr %next.gep249, i64 %i.d ; 2 uses
  %wide.load250 = load <4 x i8>, ptr %i.bo, align 1, !tbaa !64
  %wide.load251 = load <4 x i8>, ptr %next.gep249, align 1, !tbaa !64
  %i.bp = add <4 x i8> %wide.load251, %wide.load250
  store <4 x i8> %i.bp, ptr %i.bo, align 1, !tbaa !64
  %index.next252 = add nuw i64 %index248, 4       ; 2 uses
  %i.bq = icmp eq i64 %index.next252, %n.vec247
  br i1 %i.bq, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !84

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  br i1 %cmp.n253, label %.loopexit189, label %.lr.ph.preheader
...
.loopexit:                                        ; preds = %bb.j, %.loopexit187
  ...
  br i1 %or.cond212, label %.preheader.us.preheader, label %._crit_edge211
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  %.5210.us = phi i64 [ %i.es, %._crit_edge.us ], [ %.4, %.preheader.us.preheader ] ; 3 uses
  %invariant.gep.us = getelementptr i8, ptr %i.m, i64 %.5210.us ; 3 uses
  %i.dx = mul nuw nsw i64 %.5210.us, %i.i
  %i.dy = getelementptr inbounds nuw i8, ptr %1, i64 %i.dx ; 3 uses
  br i1 %i.dw, label %.epil.preheader, label %.preheader.us.new
...
.preheader.us.new:                                ; preds = %.preheader.us, %.preheader.us.new
  ...
  %gep.us = getelementptr i8, ptr %invariant.gep.us, i64 %i.ec
  %i.ed = load i8, ptr %gep.us, align 1, !tbaa !64
  ...
  %gep.us.1 = getelementptr i8, ptr %invariant.gep.us, i64 %i.ei
  %i.ej = load i8, ptr %gep.us.1, align 1, !tbaa !64
...
.epil.preheader:                                  ; preds = %._crit_edge.us.unr-lcssa, %.preheader.us
  ...
  %gep.us.epil = getelementptr i8, ptr %invariant.gep.us, i64 %i.ep
  %i.eq = load i8, ptr %gep.us.epil, align 1, !tbaa !64
...
._crit_edge.us:                                   ; preds = %._crit_edge.us.unr-lcssa, %.epil.preheader
  %i.es = add nuw nsw i64 %.5210.us, 1            ; 2 uses
  %exitcond219.not = icmp eq i64 %i.es, %i.j
  br i1 %exitcond219.not, label %._crit_edge211, label %.preheader.us

._crit_edge211:                                   ; preds = %._crit_edge.us, %.loopexit
...
bb.d:                                             ; preds = %bb.c
  ...
  %4 = icmp ne i16 %i.g, 0
  %or.cond = and i1 %3, %4
  br i1 %or.cond, label %.preheader.us.preheader, label %._crit_edge92
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us
  %.07891.us = phi i64 [ %i.aj, %._crit_edge.us ], [ 0, %.preheader.us.preheader ] ; 3 uses
  %invariant.gep.us = getelementptr i8, ptr %1, i64 %.07891.us ; 3 uses
  %i.o = mul nuw nsw i64 %.07891.us, %i.i
...
.preheader.us.new:                                ; preds = %.preheader.us, %.preheader.us.new
  ...
  %gep.us = getelementptr i8, ptr %invariant.gep.us, i64 %i.v
  store i8 %i.r, ptr %gep.us, align 1, !tbaa !64
  ...
  %gep.us.1 = getelementptr i8, ptr %invariant.gep.us, i64 %i.ac
  store i8 %i.y, ptr %gep.us.1, align 1, !tbaa !64
  %indvars.iv.next.1 = add nuw nsw i64 %indvars.iv, 2 ; 2 uses
  %niter.next.1 = add i64 %niter, 2               ; 2 uses
  %niter.ncmp.1 = icmp eq i64 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1, label %._crit_edge.us.unr-lcssa, label %.preheader.us.new
...
.epil.preheader:                                  ; preds = %._crit_edge.us.unr-lcssa, %.preheader.us
  ...
  %gep.us.epil = getelementptr i8, ptr %invariant.gep.us, i64 %i.ai
  store i8 %i.ae, ptr %gep.us.epil, align 1, !tbaa !64
  br label %._crit_edge.us

._crit_edge.us:                                   ; preds = %._crit_edge.us.unr-lcssa, %.epil.preheader
  %i.aj = add nuw nsw i64 %.07891.us, 1           ; 2 uses
...
._crit_edge92:                                    ; preds = %._crit_edge.us, %bb.d
  tail call void @_TIFFfreeExt(ptr noundef nonnull %0, ptr noundef nonnull %i.m) #10
  %i.ak = icmp sgt i64 %2, %.fr99
  br i1 %i.ak, label %.lr.ph97, label %.loopexit89

.lr.ph97:                                         ; preds = %._crit_edge92
  %i.al = getelementptr i8, ptr %1, i64 %2
  %i.am = xor i64 %.fr99, -1
  %i.an = getelementptr i8, ptr %i.al, i64 %i.am  ; 2 uses
  %i.ao = add i64 %.fr99, -4                      ; 10 uses
  %i.ap = icmp sgt i64 %.fr99, 4
  br i1 %i.ap, label %iter.check.preheader, label %.lr.ph97.split
...
iter.check:                                       ; preds = %iter.check.preheader, %.loopexit130
  %.07796.us = phi ptr [ %i.bx, %.loopexit130 ], [ %i.an, %iter.check.preheader ] ; 5 uses
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %i.au = getelementptr i8, ptr %.07796.us, i64 %i.aq ; 3 uses
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.av = sub i64 0, %index
  %next.gep = getelementptr i8, ptr %.07796.us, i64 %i.av ; 2 uses
  %i.aw = getelementptr inbounds nuw i8, ptr %next.gep, i64 %.fr99
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %i.bb = getelementptr i8, ptr %.07796.us, i64 %i.as ; 3 uses
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index118 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next125, %vec.epilog.vector.body ] ; 2 uses
  %i.bc = sub i64 0, %index118
  %next.gep119 = getelementptr i8, ptr %.07796.us, i64 %i.bc ; 2 uses
  %i.bd = getelementptr inbounds nuw i8, ptr %next.gep119, i64 %.fr99
...
.lr.ph.us.preheader:                              ; preds = %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  ...
  %.193.us.ph = phi ptr [ %.07796.us, %iter.check ], [ %i.au, %vec.epilog.iter.check ], [ %i.bb, %vec.epilog.middle.block ]
  br label %.lr.ph.us
...
.lr.ph97.split:                                   ; preds = %.lr.ph97, %bb.h
  %.07796 = phi ptr [ %.6, %bb.h ], [ %i.an, %.lr.ph97 ] ; 7 uses
end_hunk_1
