...
bb.a:
  ...
  %2 = shufflevector <2 x double> %i.ai, <2 x double> %i.am, <2 x i32> <i32 0, i32 2>
  %3 = shufflevector <2 x double> %i.ab, <2 x double> poison, <2 x i32> zeroinitializer
  %4 = shufflevector <2 x double> %i.ab, <2 x double> poison, <2 x i32> <i32 1, i32 1> ; 2 uses
  %5 = insertelement <2 x double> %4, double %i.p, i64 1
  %6 = load <2 x float>, ptr %i.k, align 4, !tbaa !9
  %7 = fpext <2 x float> %6 to <2 x double>       ; 6 uses
  %8 = fneg <2 x double> %7                       ; 4 uses
  %i.an = shufflevector <2 x double> %i.ag, <2 x double> %i.ai, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.ao = fmul <2 x double> %i.an, %8
  %i.ap = shufflevector <2 x double> %8, <2 x double> poison, <2 x i32> zeroinitializer
  %9 = fmul <2 x double> %2, %i.ap
  %i.aq = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %3, <2 x double> %5, <2 x double> %9) ; 4 uses
  %i.ar = extractelement <2 x double> %i.aq, i64 0 ; 2 uses
  %i.as = fneg double %i.ar                       ; 2 uses
  %i.at = fmul double %i.aj, %i.as
  %10 = shufflevector <2 x double> %7, <2 x double> %i.ag, <2 x i32> <i32 1, i32 2>
  %11 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ab, <2 x double> %10, <2 x double> %i.ao) ; 5 uses
  %i.au = shufflevector <2 x double> %i.am, <2 x double> poison, <2 x i32> zeroinitializer
  %i.av = shufflevector <2 x double> %7, <2 x double> %i.ab, <2 x i32> <i32 1, i32 3>
  ...
  %i.ba = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.an, <2 x double> %i.az, <2 x double> %i.ax) ; 5 uses
  %i.bb = extractelement <2 x double> %i.ba, i64 0 ; 2 uses
  %i.bc = fneg double %i.bb
  %12 = extractelement <2 x double> %i.y, i64 0   ; 3 uses
  %i.bd = fmul double %12, %i.bc
  %i.be = extractelement <2 x double> %i.ba, i64 1 ; 2 uses
  %13 = tail call double @llvm.fmuladd.f64(double %i.v, double %i.be, double %i.bd)
  %14 = extractelement <2 x double> %i.aq, i64 1
  %i.bf = shufflevector <2 x double> %i.aq, <2 x double> %11, <2 x i32> <i32 1, i32 3>
  %i.bg = insertelement <2 x double> poison, double %i.at, i64 0
  %i.bh = insertelement <2 x double> %i.bg, double %13, i64 1
  %i.bi = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.y, <2 x double> %i.bf, <2 x double> %i.bh) ; 3 uses
  %i.bj = fneg double %14                         ; 2 uses
  ...
  %i.bq = extractelement <2 x double> %11, i64 0  ; 2 uses
  ...
  %i.bu = fmul double %12, %i.bt
  %15 = tail call double @llvm.fmuladd.f64(double %i.v, double %i.ar, double %i.bu)
  %16 = extractelement <2 x double> %i.ag, i64 1
  %foldExtExtBinop = fmul <2 x double> %i.bp, %i.ag
  %17 = insertelement <2 x double> poison, double %i.ac, i64 0 ; 3 uses
  %i.bv = insertelement <2 x double> %17, double %i.b, i64 1
  %18 = shufflevector <2 x double> %11, <2 x double> %i.bi, <2 x i32> <i32 1, i32 3>
  %19 = insertelement <2 x double> %foldExtExtBinop, double %15, i64 0
  %i.bw = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bv, <2 x double> %18, <2 x double> %19) ; 3 uses
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.thread: ; preds = %bb.a, %_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit
  ...
  %20 = tail call double @llvm.fmuladd.f64(double %i.b, double %i.be, double %i.db)
  ...
  %i.df = insertelement <2 x double> poison, double %20, i64 0
  ...
  %i.do = shufflevector <2 x double> %17, <2 x double> %i.dn, <2 x i32> <i32 0, i32 2> ; 2 uses
  ...
  %i.ea = shufflevector <2 x double> %i.am, <2 x double> %8, <2 x i32> <i32 0, i32 2>
  %i.eb = shufflevector <2 x double> %i.ag, <2 x double> %i.am, <2 x i32> <i32 1, i32 3>
  %i.ec = insertelement <2 x double> %17, double %i.cu, i64 1
  ...
  %i.ek = shufflevector <2 x double> %7, <2 x double> %i.am, <2 x i32> <i32 1, i32 2>
  %i.el = fmul <2 x double> %i.ek, %i.ej
  %i.em = insertelement <2 x double> %i.ej, double %i.dy, i64 1
  %i.en = fmul <2 x double> %i.dz, %i.em
  %i.eo = shufflevector <2 x double> %7, <2 x double> %i.ag, <2 x i32> <i32 0, i32 2>
  ...
  %i.et = fmul <2 x double> %4, %i.es
  %i.eu = shufflevector <2 x double> %7, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %i.fa = tail call double @llvm.fmuladd.f64(double %16, double %12, double %i.cv) ; 2 uses
  %i.fb = insertelement <2 x double> %11, double %i.fa, i64 0 ; 2 uses
  ...
  %i.fk = shufflevector <2 x double> %i.eg, <2 x double> %11, <2 x i32> <i32 0, i32 2>
  ...
  %i.fo = insertelement <2 x double> %8, double %i.p, i64 1
