...
bb.a:
  ...
  %2 = load <2 x float>, ptr %i.c, align 4, !tbaa !9 ; 2 uses
  %3 = load <2 x float>, ptr %i.h, align 4, !tbaa !9 ; 2 uses
  %4 = shufflevector <2 x float> %3, <2 x float> %2, <2 x i32> <i32 0, i32 2>
  %5 = fpext <2 x float> %4 to <2 x double>       ; 10 uses
  %6 = shufflevector <2 x float> %3, <2 x float> %2, <2 x i32> <i32 1, i32 3>
  %7 = fpext <2 x float> %6 to <2 x double>       ; 8 uses
  %8 = insertelement <2 x float> poison, float %i.j, i64 0
  %9 = insertelement <2 x float> %8, float %i.e, i64 1
  %10 = fpext <2 x float> %9 to <2 x double>      ; 10 uses
  ...
  %i.aa = load <2 x float>, ptr %i.w, align 4, !tbaa !9
  %i.ab = fpext <2 x float> %i.aa to <2 x double> ; 7 uses
  %i.ac = shufflevector <2 x double> %7, <2 x double> %10, <2 x i32> <i32 0, i32 2>
  ...
  %11 = shufflevector <2 x double> %5, <2 x double> %7, <2 x i32> <i32 0, i32 2> ; 2 uses
  %12 = fmul <2 x double> %11, %i.ai
  %i.am = shufflevector <2 x double> %i.ah, <2 x double> %5, <2 x i32> <i32 1, i32 2>
  %i.an = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.z, <2 x double> %i.am, <2 x double> %12) ; 5 uses
  %i.ao = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> zeroinitializer
  ...
  %i.au = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %11, <2 x double> %i.at, <2 x double> %i.ar) ; 5 uses
  %i.av = extractelement <2 x double> %i.au, i64 0 ; 2 uses
  %i.aw = fneg double %i.av
  %i.ax = extractelement <2 x double> %i.ab, i64 0 ; 3 uses
  ...
  %13 = extractelement <2 x double> %i.ab, i64 1  ; 2 uses
  %14 = extractelement <2 x double> %i.al, i64 0  ; 2 uses
  %15 = fneg double %14                           ; 2 uses
  %16 = fmul double %13, %15
  %i.bb = extractelement <2 x double> %i.al, i64 1
  %i.bc = shufflevector <2 x double> %i.al, <2 x double> %i.an, <2 x i32> <i32 1, i32 3>
  %i.bd = insertelement <2 x double> poison, double %16, i64 0
  %i.be = insertelement <2 x double> %i.bd, double %i.ba, i64 1
  %i.bf = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.ab, <2 x double> %i.bc, <2 x double> %i.be) ; 3 uses
  %17 = fneg double %i.s                          ; 2 uses
  %i.bg = fneg double %i.bb                       ; 2 uses
  %i.bh = fmul double %i.v, %i.bg
  %i.bi = insertelement <2 x double> poison, double %i.s, i64 0
  %i.bj = insertelement <2 x double> %i.bi, double %17, i64 1
  ...
  %i.bp = tail call double @llvm.fmuladd.f64(double %13, double %i.bn, double %i.bo) ; 2 uses
  %i.bq = fneg double %i.bn                       ; 2 uses
  %i.br = fmul double %i.ax, %i.bq
  %i.bs = tail call double @llvm.fmuladd.f64(double %i.v, double %14, double %i.br)
  %i.bt = extractelement <2 x double> %5, i64 1
  %foldExtExtBinop = fmul <2 x double> %i.bm, %5
  %i.bu = insertelement <2 x double> poison, double %17, i64 0 ; 3 uses
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.thread: ; preds = %bb.a, %_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit
  ...
  %i.dh = shufflevector <2 x double> %10, <2 x double> %5, <2 x i32> <i32 1, i32 3>
  ...
  %i.dp = shufflevector <2 x double> %7, <2 x double> %10, <2 x i32> <i32 1, i32 3>
  %i.dq = fneg <2 x double> %i.ab
  %i.dr = shufflevector <2 x double> %i.bu, <2 x double> %i.dq, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.ds = fmul <2 x double> %i.dp, %i.dr
  %i.dt = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.du = fmul <2 x double> %i.dt, %i.dr
  %i.dv = insertelement <2 x double> %7, double %i.b, i64 0 ; 2 uses
  %i.dw = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.dv, <2 x double> %i.ab, <2 x double> %i.ds) ; 4 uses
  %i.dx = shufflevector <2 x double> %i.ab, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  ...
  %i.ec = insertelement <2 x double> %7, double %i.p, i64 1
  %i.ed = shufflevector <2 x double> %10, <2 x double> %i.ai, <2 x i32> <i32 0, i32 2>
  %i.ee = shufflevector <2 x double> %5, <2 x double> %10, <2 x i32> <i32 1, i32 3>
  %i.ef = insertelement <2 x double> %i.bu, double %i.cw, i64 1
  %i.eg = fmul <2 x double> %i.ee, %i.ef
  %i.eh = insertelement <2 x double> %5, double %i.b, i64 0
  %i.ei = insertelement <2 x double> %i.ab, double %i.v, i64 0
  ...
  %i.en = shufflevector <2 x double> %i.ah, <2 x double> %10, <2 x i32> <i32 1, i32 2>
  %i.eo = fmul <2 x double> %i.en, %i.em
  %i.ep = insertelement <2 x double> %i.em, double %i.eb, i64 1
  %i.eq = fmul <2 x double> %i.ec, %i.ep
  %i.er = shufflevector <2 x double> %i.ah, <2 x double> %5, <2 x i32> <i32 0, i32 2>
  ...
  %i.fg = fmul <2 x double> %10, %i.ff
  %i.fh = insertelement <2 x double> poison, double %i.eb, i64 0
  %i.fi = insertelement <2 x double> %i.fh, double %15, i64 1
  %i.fj = fmul <2 x double> %i.fi, %5
  ...
  %i.fm = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %7, <2 x double> %i.ek, <2 x double> %i.fg)
  %i.fn = shufflevector <2 x double> %i.ej, <2 x double> %i.an, <2 x i32> <i32 0, i32 2>
  %i.fo = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %7, <2 x double> %i.fn, <2 x double> %i.fl)
