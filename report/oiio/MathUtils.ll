...
bb.b:                                             ; preds = %bb.a
  ...
  %1 = icmp slt i32 %i.a, 0
  %i.i = select i1 %1, i32 %i.h, i32 %i.f         ; 3 uses
  %i.j = sub nuw i32 -2147483648, %i.i
  %i.k = xor i32 %i.i, -2147483648
  %2 = icmp slt i32 %i.i, 0
  %i.l = select i1 %2, i32 %i.k, i32 %i.j
...
bb.a:
  ...
  %4 = bitcast float %1 to i32                    ; 7 uses
  %5 = and i32 %i.a, 8388607
  %i.b = and i32 %4, 8388607
  %i.c = and i32 %i.a, 2139095040
  %i.d = icmp eq i32 %i.c, 2139095040
  %i.e = and i32 %4, 2139095040
...
bb.e:                                             ; preds = %bb.d
  %i.l = tail call float @llvm.fabs.f32(float %0) ; 3 uses
  %6 = icmp slt i32 %i.a, 0                       ; 2 uses
  br i1 %3, label %bb.f, label %bb.g

bb.f:                                             ; preds = %bb.e
  %7 = bitcast float %i.l to i32                  ; 2 uses
  %8 = icmp samesign ult i32 %7, 8388608
  %9 = add nuw i32 %i.a, 2139095041
  %10 = sub nuw i32 -2139095041, %7
  %11 = select i1 %6, i32 %10, i32 %9
  %.0.i = select i1 %8, i32 -2147483648, i32 %11
  %i.m = tail call float @llvm.fabs.f32(float %1)
  %12 = bitcast float %i.m to i32                 ; 2 uses
  %13 = icmp samesign ult i32 %12, 8388608
  %14 = add nuw i32 %4, 2139095041
  %15 = sub nuw i32 -2139095041, %12
  %16 = icmp slt i32 %4, 0
  %17 = select i1 %16, i32 %15, i32 %14
  %.0.i26 = select i1 %13, i32 -2147483648, i32 %17
  br label %bb.h

bb.g:                                             ; preds = %bb.e
  %18 = fneg float %i.l
  %19 = bitcast float %18 to i32
  %20 = bitcast float %i.l to i32
  %21 = sub nuw i32 -2147483648, %20
  %22 = select i1 %6, i32 %21, i32 %19
  %23 = tail call float @llvm.fabs.f32(float %1)  ; 2 uses
  %24 = fneg float %23
...
bb.h:                                             ; preds = %bb.g, %bb.f
  %.024 = phi i32 [ %.0.i, %bb.f ], [ %22, %bb.g ] ; 3 uses
  %.023 = phi i32 [ %.0.i26, %bb.f ], [ %29, %bb.g ] ; 3 uses
  %i.n = icmp ugt i32 %.024, %.023
  %i.o = sub nuw i32 %.024, %.023
  %i.p = sub nuw i32 %.023, %.024
...
bb.b:                                             ; preds = %bb.a
  ...
  %1 = icmp slt i32 %i.b, 0
  %i.j = select i1 %1, i32 %i.i, i32 %i.g         ; 3 uses
  %i.k = sub nuw i32 -2147483648, %i.j
  %i.l = xor i32 %i.j, -2147483648
  %2 = icmp slt i32 %i.j, 0
  %i.m = select i1 %2, i32 %i.l, i32 %i.k
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit: ; preds = %.lr.ph
  ...
  %2 = icmp slt i32 %i.e, 0
  %i.m = select i1 %2, i32 %i.l, i32 %i.j         ; 3 uses
  %i.n = sub nuw i32 -2147483648, %i.m
  %i.o = xor i32 %i.m, -2147483648
  %3 = icmp slt i32 %i.m, 0
  %i.p = select i1 %3, i32 %i.o, i32 %i.n
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.1: ; preds = %bb.b
  ...
  %2 = icmp slt i32 %i.r, 0
  %i.z = select i1 %2, i32 %i.y, i32 %i.w         ; 3 uses
  %i.aa = sub nuw i32 -2147483648, %i.z
  %i.ab = xor i32 %i.z, -2147483648
  %3 = icmp slt i32 %i.z, 0
  %i.ac = select i1 %3, i32 %i.ab, i32 %i.aa
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.2: ; preds = %bb.c
  ...
  %4 = icmp slt i32 %i.ag, 0
  %i.ao = select i1 %4, i32 %i.an, i32 %i.al      ; 3 uses
  %i.ap = sub nuw i32 -2147483648, %i.ao
  %i.aq = xor i32 %i.ao, -2147483648
  %5 = icmp slt i32 %i.ao, 0
  %i.ar = select i1 %5, i32 %i.aq, i32 %i.ap
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.3: ; preds = %bb.d
  ...
  %i.bd = select i1 %6, i32 %i.bc, i32 %i.ba      ; 3 uses
  %i.be = sub nuw i32 -2147483648, %i.bd
  %i.bf = xor i32 %i.bd, -2147483648
  %7 = icmp slt i32 %i.bd, 0
  %i.bg = select i1 %7, i32 %i.bf, i32 %i.be
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.131: ; preds = %.critedge
  ...
  %8 = icmp slt i32 %i.bk, 0
  %i.bs = select i1 %8, i32 %i.br, i32 %i.bp      ; 3 uses
  %i.bt = sub nuw i32 -2147483648, %i.bs
  %i.bu = xor i32 %i.bs, -2147483648
  %9 = icmp slt i32 %i.bs, 0
  %i.bv = select i1 %9, i32 %i.bu, i32 %i.bt
...
_ZN16OpenColorIO_v2_518IsScalarEqualToOneIfEEbT_.exit.1.1: ; preds = %bb.e
  ...
  %10 = icmp slt i32 %i.bz, 0
  %i.ch = select i1 %10, i32 %i.cg, i32 %i.ce     ; 3 uses
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.2.1: ; preds = %bb.f
  ...
  %11 = icmp slt i32 %i.cp, 0
  %i.cx = select i1 %11, i32 %i.cw, i32 %i.cu     ; 3 uses
  %i.cy = sub nuw i32 -2147483648, %i.cx
  %i.cz = xor i32 %i.cx, -2147483648
  %12 = icmp slt i32 %i.cx, 0
  %i.da = select i1 %12, i32 %i.cz, i32 %i.cy
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.3.1: ; preds = %bb.g
  ...
  %13 = icmp slt i32 %i.de, 0
  %i.dm = select i1 %13, i32 %i.dl, i32 %i.dj     ; 3 uses
  %i.dn = sub nuw i32 -2147483648, %i.dm
  %i.do = xor i32 %i.dm, -2147483648
  %14 = icmp slt i32 %i.dm, 0
  %i.dp = select i1 %14, i32 %i.do, i32 %i.dn
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.233: ; preds = %.critedge.1
  ...
  %15 = icmp slt i32 %i.dt, 0
  %i.eb = select i1 %15, i32 %i.ea, i32 %i.dy     ; 3 uses
  %i.ec = sub nuw i32 -2147483648, %i.eb
  %i.ed = xor i32 %i.eb, -2147483648
  %16 = icmp slt i32 %i.eb, 0
  %i.ee = select i1 %16, i32 %i.ed, i32 %i.ec
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.1.2: ; preds = %bb.h
  ...
  %17 = icmp slt i32 %i.ei, 0
  %i.eq = select i1 %17, i32 %i.ep, i32 %i.en     ; 3 uses
  %i.er = sub nuw i32 -2147483648, %i.eq
  %i.es = xor i32 %i.eq, -2147483648
  %18 = icmp slt i32 %i.eq, 0
  %i.et = select i1 %18, i32 %i.es, i32 %i.er
...
_ZN16OpenColorIO_v2_518IsScalarEqualToOneIfEEbT_.exit.2.2: ; preds = %bb.i
  ...
  %19 = icmp slt i32 %i.ex, 0
  %i.ff = select i1 %19, i32 %i.fe, i32 %i.fc     ; 3 uses
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.3.2: ; preds = %bb.j
  ...
  %20 = icmp slt i32 %i.fn, 0
  %i.fv = select i1 %20, i32 %i.fu, i32 %i.fs     ; 3 uses
  %i.fw = sub nuw i32 -2147483648, %i.fv
  %i.fx = xor i32 %i.fv, -2147483648
  %21 = icmp slt i32 %i.fv, 0
  %i.fy = select i1 %21, i32 %i.fx, i32 %i.fw
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.335: ; preds = %.critedge.2
  ...
  %22 = icmp slt i32 %i.gc, 0
  %i.gk = select i1 %22, i32 %i.gj, i32 %i.gh     ; 3 uses
  %i.gl = sub nuw i32 -2147483648, %i.gk
  %i.gm = xor i32 %i.gk, -2147483648
  %23 = icmp slt i32 %i.gk, 0
  %i.gn = select i1 %23, i32 %i.gm, i32 %i.gl
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.1.3: ; preds = %bb.k
  ...
  %24 = icmp slt i32 %i.gr, 0
  %i.gz = select i1 %24, i32 %i.gy, i32 %i.gw     ; 3 uses
  %i.ha = sub nuw i32 -2147483648, %i.gz
  %i.hb = xor i32 %i.gz, -2147483648
  %25 = icmp slt i32 %i.gz, 0
  %i.hc = select i1 %25, i32 %i.hb, i32 %i.ha
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit.2.3: ; preds = %bb.l
  ...
  %26 = icmp slt i32 %i.hg, 0
  %i.ho = select i1 %26, i32 %i.hn, i32 %i.hl     ; 3 uses
  %i.hp = sub nuw i32 -2147483648, %i.ho
  %i.hq = xor i32 %i.ho, -2147483648
  %27 = icmp slt i32 %i.ho, 0
  %i.hr = select i1 %27, i32 %i.hq, i32 %i.hp
...
_ZN16OpenColorIO_v2_518IsScalarEqualToOneIfEEbT_.exit.3.3: ; preds = %bb.m
  ...
  %28 = icmp slt i32 %i.hv, 0
  %i.id = select i1 %28, i32 %i.ic, i32 %i.ia     ; 3 uses
...
_ZN16OpenColorIO_v2_518IsScalarEqualToOneIdEEbT_.exit: ; preds = %bb.a
  ...
  %i.j = sub nuw i32 -2147483648, %i.i
  %1 = icmp slt i32 %i.c, 0
  %i.k = select i1 %1, i32 %i.j, i32 %i.h         ; 3 uses
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit.1: ; preds = %bb.b
  ...
  %i.aa = sub nuw i32 -2147483648, %i.z
  %2 = icmp slt i32 %i.t, 0
  %i.ab = select i1 %2, i32 %i.aa, i32 %i.y       ; 3 uses
  %i.ac = sub nuw i32 -2147483648, %i.ab
  %i.ad = xor i32 %i.ab, -2147483648
  %3 = icmp slt i32 %i.ab, 0
  %i.ae = select i1 %3, i32 %i.ad, i32 %i.ac
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit.2: ; preds = %bb.c
  ...
  %4 = icmp slt i32 %i.aj, 0
  %i.ar = select i1 %4, i32 %i.aq, i32 %i.ao      ; 3 uses
  %i.as = sub nuw i32 -2147483648, %i.ar
  %i.at = xor i32 %i.ar, -2147483648
  %5 = icmp slt i32 %i.ar, 0
  %i.au = select i1 %5, i32 %i.at, i32 %i.as
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit.3: ; preds = %bb.d
  ...
  %6 = icmp slt i32 %i.az, 0
  %i.bh = select i1 %6, i32 %i.bg, i32 %i.be      ; 3 uses
  %i.bi = sub nuw i32 -2147483648, %i.bh
  %i.bj = xor i32 %i.bh, -2147483648
  %7 = icmp slt i32 %i.bh, 0
  %i.bk = select i1 %7, i32 %i.bj, i32 %i.bi
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit.131: ; preds = %.critedge
  ...
  %8 = icmp slt i32 %i.bp, 0
  %i.bx = select i1 %8, i32 %i.bw, i32 %i.bu      ; 3 uses
  %i.by = sub nuw i32 -2147483648, %i.bx
  %i.bz = xor i32 %i.bx, -2147483648
  %9 = icmp slt i32 %i.bx, 0
  %i.ca = select i1 %9, i32 %i.bz, i32 %i.by
...
_ZN16OpenColorIO_v2_518IsScalarEqualToOneIdEEbT_.exit.1.1: ; preds = %bb.e
  ...
  %10 = icmp slt i32 %i.cf, 0
  %i.cn = select i1 %10, i32 %i.cm, i32 %i.ck     ; 3 uses
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit.2.1: ; preds = %bb.f
  ...
  %11 = icmp slt i32 %i.cw, 0
  %i.de = select i1 %11, i32 %i.dd, i32 %i.db     ; 3 uses
  %i.df = sub nuw i32 -2147483648, %i.de
  %i.dg = xor i32 %i.de, -2147483648
  %12 = icmp slt i32 %i.de, 0
  %i.dh = select i1 %12, i32 %i.dg, i32 %i.df
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit.3.1: ; preds = %bb.g
  ...
  %13 = icmp slt i32 %i.dm, 0
  %i.du = select i1 %13, i32 %i.dt, i32 %i.dr     ; 3 uses
  %i.dv = sub nuw i32 -2147483648, %i.du
  %i.dw = xor i32 %i.du, -2147483648
  %14 = icmp slt i32 %i.du, 0
  %i.dx = select i1 %14, i32 %i.dw, i32 %i.dv
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit.233: ; preds = %.critedge.1
  ...
  %15 = icmp slt i32 %i.ec, 0
  %i.ek = select i1 %15, i32 %i.ej, i32 %i.eh     ; 3 uses
  %i.el = sub nuw i32 -2147483648, %i.ek
  %i.em = xor i32 %i.ek, -2147483648
  %16 = icmp slt i32 %i.ek, 0
  %i.en = select i1 %16, i32 %i.em, i32 %i.el
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit.1.2: ; preds = %bb.h
  ...
  %17 = icmp slt i32 %i.es, 0
  %i.fa = select i1 %17, i32 %i.ez, i32 %i.ex     ; 3 uses
  %i.fb = sub nuw i32 -2147483648, %i.fa
  %i.fc = xor i32 %i.fa, -2147483648
  %18 = icmp slt i32 %i.fa, 0
  %i.fd = select i1 %18, i32 %i.fc, i32 %i.fb
...
_ZN16OpenColorIO_v2_518IsScalarEqualToOneIdEEbT_.exit.2.2: ; preds = %bb.i
  ...
  %19 = icmp slt i32 %i.fi, 0
  %i.fq = select i1 %19, i32 %i.fp, i32 %i.fn     ; 3 uses
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit.3.2: ; preds = %bb.j
  ...
  %20 = icmp slt i32 %i.fz, 0
  %i.gh = select i1 %20, i32 %i.gg, i32 %i.ge     ; 3 uses
  %i.gi = sub nuw i32 -2147483648, %i.gh
  %i.gj = xor i32 %i.gh, -2147483648
  %21 = icmp slt i32 %i.gh, 0
  %i.gk = select i1 %21, i32 %i.gj, i32 %i.gi
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit.335: ; preds = %.critedge.2
  ...
  %22 = icmp slt i32 %i.gp, 0
  %i.gx = select i1 %22, i32 %i.gw, i32 %i.gu     ; 3 uses
  %i.gy = sub nuw i32 -2147483648, %i.gx
  %i.gz = xor i32 %i.gx, -2147483648
  %23 = icmp slt i32 %i.gx, 0
  %i.ha = select i1 %23, i32 %i.gz, i32 %i.gy
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit.1.3: ; preds = %bb.k
  ...
  %24 = icmp slt i32 %i.hf, 0
  %i.hn = select i1 %24, i32 %i.hm, i32 %i.hk     ; 3 uses
  %i.ho = sub nuw i32 -2147483648, %i.hn
  %i.hp = xor i32 %i.hn, -2147483648
  %25 = icmp slt i32 %i.hn, 0
  %i.hq = select i1 %25, i32 %i.hp, i32 %i.ho
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIdEEbT_.exit.2.3: ; preds = %bb.l
  ...
  %i.ib = bitcast float %i.hy to i32
  %i.ic = sub nuw i32 -2147483648, %i.ib
  %26 = icmp slt i32 %i.hv, 0
  %i.id = select i1 %26, i32 %i.ic, i32 %i.ia     ; 3 uses
  %i.ie = sub nuw i32 -2147483648, %i.id
  %i.if = xor i32 %i.id, -2147483648
  %27 = icmp slt i32 %i.id, 0
  %i.ig = select i1 %27, i32 %i.if, i32 %i.ie
...
_ZN16OpenColorIO_v2_518IsScalarEqualToOneIdEEbT_.exit.3.3: ; preds = %bb.m
  ...
  %28 = icmp slt i32 %i.il, 0
  %i.it = select i1 %28, i32 %i.is, i32 %i.iq     ; 3 uses
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit: ; preds = %bb.a
  ...
  %i.h = bitcast float %i.e to i32
  %i.i = sub nuw i32 -2147483648, %i.h
  %2 = icmp slt i32 %i.a, 0
  %i.j = select i1 %2, i32 %i.i, i32 %i.g         ; 3 uses
  %i.k = sub nuw i32 -2147483648, %i.j
  %i.l = xor i32 %i.j, -2147483648
  %3 = icmp slt i32 %i.j, 0
  %i.m = select i1 %3, i32 %i.l, i32 %i.k
  %.fr = freeze i32 %i.m
...
_ZN16OpenColorIO_v2_519IsScalarEqualToZeroIfEEbT_.exit: ; preds = %bb.a
  ...
  %2 = icmp slt i32 %i.cm, 0
  %i.cu = select i1 %2, i32 %i.ct, i32 %i.cr      ; 3 uses
  %i.cv = sub nuw i32 -2147483648, %i.cu
  %i.cw = xor i32 %i.cu, -2147483648
  %3 = icmp slt i32 %i.cu, 0
  %i.cx = select i1 %3, i32 %i.cw, i32 %i.cv
