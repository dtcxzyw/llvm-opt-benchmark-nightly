...
.preheader76.preheader.i.us:                      ; preds = %bb.bz, %bb.by, %bb.bw
  ...
  %2 = zext i16 %.sroa.10.0.i.us to i32
  %i.he = zext i16 %.sroa.15.0.i.us to i32
  %i.hf = sub nsw i32 %i.hc, %i.hd
  %i.hg = shl nsw i32 %i.hf, 1                    ; 2 uses
  %3 = sub nsw i32 %i.hc, %i.he
  %i.hh = sub nsw i32 %i.hc, %2
  %4 = shl nsw i32 %i.hh, 1                       ; 2 uses
  %i.hi = shl nsw i32 %3, 1                       ; 2 uses
...
bb.ca:                                            ; preds = %bb.ca, %.preheader76.preheader.i.us
  ...
  %i.im = add nsw i32 %.066.i.us, 2               ; 11 uses
  %i.in = lshr i32 %i.hl, %i.im
  %i.io = and i32 %i.in, 1
  %i.ip = add nsw i32 %i.hl, %i.il
  %i.iq = add nsw i32 %i.ip, %i.io
  %i.ir = ashr i32 %i.iq, %i.im
  %i.is = lshr i32 %i.ii, %i.im
  %i.it = and i32 %i.is, 1
  %i.iu = add nsw i32 %i.ii, %i.il
  %i.iv = add nsw i32 %i.iu, %i.it
  %i.iw = ashr i32 %i.iv, %i.im
  %i.ix = insertelement <8 x i32> poison, i32 %i.im, i64 0
  ...
  %i.jj = ashr <8 x i32> %i.jh, %i.iy             ; 3 uses
  %i.jk = ashr <8 x i32> %i.ji, %i.iy             ; 2 uses
  %5 = lshr i32 %i.hg, %i.im
  %6 = lshr i32 %i.hi, %i.im
  %7 = lshr i32 %4, %i.im
  %8 = and i32 %5, 1
  %9 = and i32 %6, 1
  %10 = and i32 %7, 1
  %i.jl = add nsw i32 %i.hg, %i.il
  %11 = add nsw i32 %i.hi, %i.il
  %12 = add nsw i32 %4, %i.il
  %13 = add nsw i32 %i.jl, %8
  %14 = add nsw i32 %11, %9
  %i.jm = add nsw i32 %12, %10
  %15 = ashr i32 %13, %i.im                       ; 2 uses
  %16 = ashr i32 %14, %i.im                       ; 2 uses
  %17 = ashr i32 %i.jm, %i.im                     ; 2 uses
  %18 = sub nsw i32 %16, %i.ir
  %19 = add nsw i32 %18, 32                       ; 3 uses
  %20 = sub nsw i32 %17, %16
  %21 = add nsw i32 %20, 32                       ; 2 uses
  %22 = shufflevector <8 x i32> %i.jj, <8 x i32> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 poison>
  %23 = insertelement <4 x i32> poison, i32 %15, i64 0
  %24 = shufflevector <4 x i32> %23, <4 x i32> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 0>
  %25 = shufflevector <4 x i32> %24, <4 x i32> %22, <4 x i32> <i32 0, i32 5, i32 6, i32 3>
  %26 = insertelement <8 x i32> poison, i32 %17, i64 3
  %27 = shufflevector <8 x i32> %i.jj, <8 x i32> %26, <4 x i32> <i32 0, i32 1, i32 2, i32 11>
  %28 = sub nsw <4 x i32> %25, %27                ; 3 uses
  %29 = add nsw <4 x i32> %28, splat (i32 32)     ; 5 uses
  %30 = sub nsw <8 x i32> %i.jj, %i.jk            ; 3 uses
  %31 = add nsw <8 x i32> %30, splat (i32 32)     ; 3 uses
  %i.jn = extractelement <8 x i32> %i.jk, i64 5
  %32 = sub nsw i32 %i.jn, %i.iw
  %33 = add nsw i32 %32, 32                       ; 3 uses
  %i.jo = extractelement <8 x i32> %31, i64 0     ; 2 uses
  %34 = shufflevector <4 x i32> %29, <4 x i32> poison, <5 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison>
  %35 = insertelement <5 x i32> %34, i32 %21, i64 4
  %36 = shufflevector <8 x i32> %31, <8 x i32> poison, <12 x i32> <i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %37 = shufflevector <5 x i32> %35, <5 x i32> poison, <12 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %38 = shufflevector <12 x i32> %36, <12 x i32> %37, <12 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 12, i32 13, i32 14, i32 15, i32 16> ; 2 uses
  %39 = tail call i32 @llvm.vector.reduce.smin.v12i32(<12 x i32> %38)
  %.169.10.i.us = tail call i32 @llvm.smin.i32(i32 %39, i32 %i.jo)
  %spec.select75.11.i.us = tail call i32 @llvm.smin.i32(i32 %19, i32 %33)
  %.169.11.i.us = tail call i32 @llvm.smin.i32(i32 %.169.10.i.us, i32 %spec.select75.11.i.us) ; 2 uses
  %40 = tail call i32 @llvm.vector.reduce.smax.v12i32(<12 x i32> %38)
  %.169.12.i.us = tail call i32 @llvm.smax.i32(i32 %40, i32 %i.jo)
  %spec.select75.13.i.us = tail call i32 @llvm.smax.i32(i32 %19, i32 %33)
  %.169.13.i.us = tail call i32 @llvm.smax.i32(i32 %.169.12.i.us, i32 %spec.select75.13.i.us) ; 2 uses
  %i.jp = icmp slt i32 %.169.11.i.us, 0
  %i.jq = icmp sgt i32 %.169.13.i.us, 63
  %i.jr = select i1 %i.jp, i1 true, i1 %i.jq
  br i1 %i.jr, label %bb.ca, label %bb.cb, !llvm.loop !36

bb.cb:                                            ; preds = %bb.ca
  %i.js = icmp eq i32 %.169.11.i.us, 32
...
bb.cc:                                            ; preds = %bb.cb
  ...
  %i.jx = shl i32 %i.ik, 2
  %41 = extractelement <4 x i32> %29, i64 0
  %i.jy = lshr i32 %41, 4
  ...
  %42 = extractelement <4 x i32> %28, i64 0
  %i.kc = shl i32 %42, 4
  %43 = extractelement <4 x i32> %29, i64 1
  %i.kd = lshr i32 %43, 2
  ...
  %44 = extractelement <4 x i32> %28, i64 1
  %i.kh = shl i32 %44, 6
  %45 = extractelement <4 x i32> %29, i64 2
  %i.ki = or i32 %45, %i.kh
  %i.kj = trunc i32 %i.ki to i8
  %i.kk = getelementptr inbounds nuw i8, ptr %.2176304.us, i64 4
  store i8 %i.kj, ptr %i.kk, align 1, !tbaa !37
  %i.kl = shufflevector <8 x i32> %30, <8 x i32> poison, <8 x i32> <i32 poison, i32 0, i32 1, i32 poison, i32 3, i32 4, i32 poison, i32 6>
  %46 = shufflevector <4 x i32> %29, <4 x i32> poison, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %47 = shufflevector <8 x i32> %i.kl, <8 x i32> %46, <8 x i32> <i32 11, i32 1, i32 2, i32 poison, i32 4, i32 5, i32 poison, i32 7>
  %i.km = insertelement <8 x i32> %47, i32 %21, i64 3
  %i.kn = insertelement <8 x i32> %i.km, i32 %19, i64 6
  ...
  %i.kq = lshr <8 x i32> %31, <i32 4, i32 2, i32 0, i32 4, i32 2, i32 0, i32 4, i32 2>
  %i.kr = or <8 x i32> %i.kq, %i.ko
  %i.ks = trunc <8 x i32> %i.kr to <8 x i8>
  store <8 x i8> %i.ks, ptr %i.kp, align 1, !tbaa !37
  %i.kt = extractelement <8 x i32> %30, i64 7
  %i.ku = shl i32 %i.kt, 6
  %i.kv = or i32 %33, %i.ku
