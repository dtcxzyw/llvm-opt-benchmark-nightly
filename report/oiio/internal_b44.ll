...
.preheader76.preheader.i.us:                      ; preds = %bb.bz, %bb.by, %bb.bw
  ...
  %i.hc = zext i16 %spec.select.15.i.us to i32    ; 4 uses
  %2 = zext i16 %.sroa.0.0.i.us to i32
  %3 = insertelement <4 x i16> poison, i16 %.sroa.45.0.i.us, i64 0
  %4 = insertelement <4 x i16> %3, i16 %.sroa.65.0.i.us, i64 1
  %5 = insertelement <4 x i16> %4, i16 %.sroa.10.0.i.us, i64 2
  %6 = insertelement <4 x i16> %5, i16 %.sroa.15.0.i.us, i64 3
  %7 = zext <4 x i16> %6 to <4 x i32>
  %i.hd = zext i16 %.sroa.20.0.i.us to i32
  %i.he = sub nsw i32 %i.hc, %i.hd
  %i.hf = shl nsw i32 %i.he, 1                    ; 2 uses
  %i.hg = zext i16 %.sroa.25.0.i.us to i32
  %8 = sub nsw i32 %i.hc, %i.hg
  %i.hh = sub nsw i32 %i.hc, %2
  %9 = shl nsw i32 %i.hh, 1                       ; 2 uses
  %i.hi = shl nsw i32 %8, 1                       ; 2 uses
  ...
  %10 = insertelement <2 x i16> poison, i16 %.sroa.60.0.i.us, i64 0
  %11 = insertelement <2 x i16> %10, i16 %.sroa.80.0.i.us, i64 1
  %12 = zext <2 x i16> %11 to <2 x i32>
  %i.ht = insertelement <4 x i32> poison, i32 %i.hc, i64 0 ; 2 uses
  %i.hu = shufflevector <4 x i32> %i.ht, <4 x i32> poison, <4 x i32> zeroinitializer ; 3 uses
  ...
  %13 = sub nsw <4 x i32> %i.hu, %7
  %14 = shufflevector <4 x i32> %i.ht, <4 x i32> poison, <2 x i32> zeroinitializer
  %15 = sub nsw <2 x i32> %14, %12
  %16 = shl nsw <4 x i32> %13, splat (i32 1)      ; 2 uses
  %17 = shl nsw <2 x i32> %15, splat (i32 1)      ; 2 uses
  br label %bb.ca
...
bb.ca:                                            ; preds = %bb.ca, %.preheader76.preheader.i.us
  ...
  %i.ia = xor i32 %notmask.i.i.us, -1             ; 4 uses
  %i.ib = add nsw i32 %.066.i.us, 2               ; 7 uses
  %i.ic = lshr i32 %i.hf, %i.ib
  %i.id = and i32 %i.ic, 1
  %i.ie = add nsw i32 %i.hf, %i.ia
  %i.if = add nsw i32 %i.ie, %i.id
  %i.ig = ashr i32 %i.if, %i.ib
  %18 = insertelement <4 x i32> poison, i32 %i.ib, i64 0 ; 2 uses
  %19 = shufflevector <4 x i32> %18, <4 x i32> poison, <4 x i32> zeroinitializer ; 6 uses
  %20 = lshr <4 x i32> %i.hx, %19
  %21 = lshr <4 x i32> %i.hy, %19
  %22 = and <4 x i32> %20, splat (i32 1)
  %23 = insertelement <4 x i32> poison, i32 %i.ia, i64 0 ; 2 uses
  %24 = shufflevector <4 x i32> %23, <4 x i32> poison, <4 x i32> zeroinitializer ; 3 uses
  %25 = add nsw <4 x i32> %i.hx, %24
  %26 = and <4 x i32> %21, splat (i32 1)
  %27 = add nsw <4 x i32> %i.hy, %24
  %28 = add nsw <4 x i32> %25, %22
  %29 = add nsw <4 x i32> %27, %26
  %30 = ashr <4 x i32> %28, %19                   ; 3 uses
  %31 = ashr <4 x i32> %29, %19                   ; 2 uses
  %32 = extractelement <4 x i32> %30, i64 0
  %33 = sub nsw <4 x i32> %30, %31                ; 3 uses
  %34 = add nsw <4 x i32> %33, splat (i32 32)     ; 6 uses
  %35 = lshr <4 x i32> %16, %19
  %36 = and <4 x i32> %35, splat (i32 1)
  %37 = add nsw <4 x i32> %16, %24
  %38 = add nsw <4 x i32> %37, %36
  %39 = ashr <4 x i32> %38, %19                   ; 5 uses
  %40 = shufflevector <4 x i32> %18, <4 x i32> poison, <2 x i32> zeroinitializer ; 2 uses
  %41 = lshr <2 x i32> %17, %40
  %42 = and <2 x i32> %41, splat (i32 1)
  %43 = shufflevector <4 x i32> %23, <4 x i32> poison, <2 x i32> zeroinitializer
  %44 = add nsw <2 x i32> %17, %43
  %45 = add nsw <2 x i32> %44, %42
  %46 = ashr <2 x i32> %45, %40
  %47 = extractelement <4 x i32> %39, i64 0
  %48 = lshr i32 %i.hi, %i.ib
  %49 = lshr i32 %9, %i.ib
  %50 = and i32 %48, 1
  %51 = and i32 %49, 1
  %52 = add nsw i32 %i.hi, %i.ia
  %53 = add nsw i32 %9, %i.ia
  %54 = add nsw i32 %52, %50
  %55 = add nsw i32 %53, %51
  %56 = ashr i32 %54, %i.ib                       ; 3 uses
  %57 = ashr i32 %55, %i.ib                       ; 3 uses
  %58 = sub nsw i32 %56, %32                      ; 2 uses
  %59 = add nsw i32 %58, 32                       ; 3 uses
  %60 = sub nsw i32 %56, %47                      ; 2 uses
  %61 = sub nsw i32 %57, %56                      ; 2 uses
  %62 = add nsw i32 %60, 32                       ; 3 uses
  %i.ih = add nsw i32 %61, 32                     ; 3 uses
  %shift = shufflevector <4 x i32> %39, <4 x i32> poison, <4 x i32> <i32 1, i32 poison, i32 poison, i32 poison>
  %i.ii = sub nsw <4 x i32> %39, %shift
  %63 = extractelement <4 x i32> %i.ii, i64 0
  %64 = add nsw i32 %63, 32                       ; 3 uses
  %i.ij = extractelement <4 x i32> %39, i64 2
  %i.ik = sub nsw i32 %57, %i.ij
  %i.il = add nsw i32 %i.ik, 32                   ; 3 uses
  %65 = shufflevector <4 x i32> %39, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison> ; 2 uses
  %66 = shufflevector <4 x i32> %31, <4 x i32> %34, <8 x i32> <i32 1, i32 2, i32 4, i32 5, i32 poison, i32 poison, i32 poison, i32 poison>
  %67 = shufflevector <8 x i32> %65, <8 x i32> %66, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  %68 = shufflevector <4 x i32> %30, <4 x i32> poison, <8 x i32> <i32 1, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %69 = shufflevector <8 x i32> %68, <8 x i32> <i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 0, i32 0>, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 14, i32 15>
  %70 = shufflevector <8 x i32> %69, <8 x i32> %65, <8 x i32> <i32 0, i32 1, i32 11, i32 poison, i32 poison, i32 poison, i32 6, i32 7>
  %71 = insertelement <8 x i32> %70, i32 %i.ig, i64 3
  %72 = shufflevector <2 x i32> %46, <2 x i32> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %73 = shufflevector <8 x i32> %71, <8 x i32> %72, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 6, i32 7>
  %74 = sub nsw <8 x i32> %67, %73                ; 3 uses
  %75 = add nsw <8 x i32> %74, <i32 32, i32 32, i32 32, i32 32, i32 32, i32 32, i32 0, i32 0> ; 7 uses
  %76 = extractelement <4 x i32> %34, i64 2
  %i.im = extractelement <4 x i32> %34, i64 3
  %77 = shufflevector <4 x i32> %34, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %78 = shufflevector <8 x i32> %75, <8 x i32> %77, <10 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 8, i32 9, i32 poison, i32 poison>
  %79 = shufflevector <4 x i32> %34, <4 x i32> poison, <10 x i32> <i32 poison, i32 poison, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %80 = insertelement <12 x i32> poison, i32 %i.ih, i64 0
  %81 = insertelement <12 x i32> %80, i32 %62, i64 1
  %82 = shufflevector <10 x i32> %78, <10 x i32> %79, <12 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 poison, i32 poison>
  %83 = shufflevector <12 x i32> %82, <12 x i32> %81, <12 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 12, i32 13>
  %i.in = tail call i32 @llvm.vector.reduce.smin.v12i32(<12 x i32> %83)
  %i.io = tail call i32 @llvm.smin.i32(i32 %i.in, i32 %64)
  %i.ip = tail call i32 @llvm.smin.i32(i32 %i.il, i32 %59)
  %i.iq = tail call i32 @llvm.smin.i32(i32 %i.io, i32 %i.ip) ; 2 uses
  %84 = tail call i32 @llvm.vector.reduce.smax.v8i32(<8 x i32> %75)
  %85 = tail call i32 @llvm.smax.i32(i32 %84, i32 %i.ih)
  %86 = tail call i32 @llvm.smax.i32(i32 %62, i32 %64)
  %87 = tail call i32 @llvm.smax.i32(i32 %i.il, i32 %59)
  %88 = tail call i32 @llvm.smax.i32(i32 %76, i32 %i.im)
  %i.ir = tail call i32 @llvm.smax.i32(i32 %85, i32 %86)
  %i.is = tail call i32 @llvm.smax.i32(i32 %87, i32 %88)
...
bb.cc:                                            ; preds = %bb.cb
  ...
  %i.jv = shl i32 %58, 4
  %i.jw = extractelement <8 x i32> %75, i64 0
  ...
  %i.kb = extractelement <8 x i32> %74, i64 0
  %i.kc = shl i32 %i.kb, 6
  %i.kd = extractelement <8 x i32> %75, i64 1
  ...
  %89 = shufflevector <4 x i32> %33, <4 x i32> poison, <8 x i32> <i32 poison, i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %90 = shufflevector <8 x i32> %89, <8 x i32> %75, <4 x i32> <i32 10, i32 1, i32 2, i32 11>
  %i.kh = shl <4 x i32> %90, <i32 2, i32 4, i32 6, i32 2>
  %i.ki = getelementptr inbounds nuw i8, ptr %.2176304.us, i64 8
  %i.kj = lshr <4 x i32> %34, <i32 4, i32 2, i32 0, i32 4>
  %i.kk = or <4 x i32> %i.kj, %i.kh
  %i.kl = trunc <4 x i32> %i.kk to <4 x i8>
  store <4 x i8> %i.kl, ptr %i.ki, align 1, !tbaa !37
  %i.km = extractelement <4 x i32> %33, i64 3
  %i.kn = shl i32 %i.km, 4
  %91 = extractelement <8 x i32> %75, i64 4
  %i.ko = lshr i32 %91, 2
  ...
  %92 = extractelement <8 x i32> %74, i64 4
  %i.ks = shl i32 %92, 6
  %93 = extractelement <8 x i32> %75, i64 5
  %i.kt = or i32 %93, %i.ks
