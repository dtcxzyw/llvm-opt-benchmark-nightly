...
begin_hunk_0_@compress_b44_impl:bb.a
  ...
  %i.hc = zext i16 %spec.select.15.i.us to i32    ; 3 uses
...
begin_hunk_1_@compress_b44_impl:bb.a
  ...
  %2 = zext i16 %.sroa.80.0.i.us to i32
  %3 = sub nsw i32 %i.hc, %2
  %i.ih = shl nsw i32 %3, 1                       ; 2 uses
  br label %bb.ca
...
begin_hunk_2_@compress_b44_impl:bb.a
  ...
  %i.im = and i32 %i.il, 1
  %i.in = add nsw i32 %i.ih, %i.ij
  %i.io = add nsw i32 %i.in, %i.im
  %4 = ashr i32 %i.io, %i.ik
