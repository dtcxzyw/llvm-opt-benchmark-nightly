...
bb.l:                                             ; preds = %.lr.ph317.split.us, %bb.cd
  ...
  %.2176304.us = phi ptr [ %.1175315.us, %.lr.ph317.split.us ], [ %i.jy, %bb.cd ] ; 12 uses
...
.preheader76.preheader.i.us:                      ; preds = %bb.bz, %bb.by, %bb.bw
  ...
  %9 = zext i16 %.sroa.15.0.i.us to i32
  %10 = sub nsw i32 %i.hc, %9
  %i.hd = shl nsw i32 %10, 1                      ; 2 uses
  %i.he = zext i16 %.sroa.20.0.i.us to i32
  %i.hf = sub nsw i32 %i.hc, %i.he
  %i.hg = shl nsw i32 %i.hf, 1                    ; 2 uses
  %11 = insertelement <4 x i16> poison, i16 %.sroa.30.0.i.us, i64 0
  %12 = insertelement <4 x i16> %11, i16 %.sroa.50.0.i.us, i64 1
  %13 = insertelement <4 x i16> %12, i16 %.sroa.70.0.i.us, i64 2
  %14 = insertelement <4 x i16> %13, i16 %.sroa.35.0.i.us, i64 3
  %15 = zext <4 x i16> %14 to <4 x i32>
  %16 = insertelement <4 x i16> poison, i16 %.sroa.35.0.i.us, i64 0
  %17 = insertelement <4 x i16> %16, i16 %.sroa.55.0.i.us, i64 1
  %18 = insertelement <4 x i16> %17, i16 %.sroa.75.0.i.us, i64 2
  %19 = insertelement <4 x i16> %18, i16 %.sroa.40.0.i.us, i64 3
  %20 = zext <4 x i16> %19 to <4 x i32>
  %21 = zext i16 %.sroa.60.0.i.us to i32
  %22 = sub nsw i32 %i.hc, %21
  %23 = shl nsw i32 %22, 1                        ; 2 uses
  %i.hh = insertelement <8 x i32> poison, i32 %i.hc, i64 0
  %i.hi = shufflevector <8 x i32> %i.hh, <8 x i32> poison, <8 x i32> zeroinitializer
  %i.hj = sub nsw <8 x i32> %i.hi, %8
  %24 = shl nsw <8 x i32> %i.hj, splat (i32 1)    ; 2 uses
  %25 = insertelement <4 x i32> poison, i32 %i.hc, i64 0
  %26 = shufflevector <4 x i32> %25, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  %27 = sub nsw <4 x i32> %26, %15
  %28 = sub nsw <4 x i32> %26, %20
  %29 = shl nsw <4 x i32> %27, splat (i32 1)      ; 2 uses
  %30 = shl nsw <4 x i32> %28, splat (i32 1)      ; 2 uses
...
bb.ca:                                            ; preds = %bb.ca, %.preheader76.preheader.i.us
  ...
  %i.hp = add nsw i32 %.066.i.us, 2               ; 10 uses
  %i.hq = lshr i32 %i.hd, %i.hp
  %i.hr = and i32 %i.hq, 1
  %i.hs = add nsw i32 %i.hd, %i.ho
  %i.ht = add nsw i32 %i.hs, %i.hr
  %i.hu = ashr i32 %i.ht, %i.hp                   ; 2 uses
  %i.hv = lshr i32 %i.hg, %i.hp
  %i.hw = and i32 %i.hv, 1
  %i.hx = add nsw i32 %i.hg, %i.ho
  %i.hy = add nsw i32 %i.hx, %i.hw
  %i.hz = ashr i32 %i.hy, %i.hp
  %31 = lshr i32 %23, %i.hp
  %32 = and i32 %31, 1
  %33 = add nsw i32 %23, %i.ho
  %34 = add nsw i32 %33, %32
  %35 = ashr i32 %34, %i.hp
  %36 = lshr i32 %i.hm, %i.hp
  %37 = and i32 %36, 1
  %38 = add nsw i32 %i.hm, %i.ho
  %39 = add nsw i32 %38, %37
  %40 = ashr i32 %39, %i.hp
  %41 = sub nsw i32 %i.hu, %i.hz
  %42 = insertelement <4 x i32> poison, i32 %i.hp, i64 0
  %43 = shufflevector <4 x i32> %42, <4 x i32> poison, <4 x i32> zeroinitializer ; 4 uses
  %44 = lshr <4 x i32> %29, %43
  %45 = lshr <4 x i32> %30, %43
  %46 = and <4 x i32> %44, splat (i32 1)
  %47 = insertelement <4 x i32> poison, i32 %i.ho, i64 0
  %48 = shufflevector <4 x i32> %47, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  %49 = add nsw <4 x i32> %29, %48
  %50 = and <4 x i32> %45, splat (i32 1)
  %51 = add nsw <4 x i32> %30, %48
  %52 = add nsw <4 x i32> %49, %46
  %53 = add nsw <4 x i32> %51, %50
  %54 = ashr <4 x i32> %52, %43                   ; 2 uses
  %55 = ashr <4 x i32> %53, %43                   ; 3 uses
  %56 = insertelement <8 x i32> poison, i32 %i.hp, i64 0
  %57 = shufflevector <8 x i32> %56, <8 x i32> poison, <8 x i32> zeroinitializer ; 2 uses
  %58 = lshr <8 x i32> %24, %57
  %59 = and <8 x i32> %58, splat (i32 1)
  %60 = insertelement <8 x i32> poison, i32 %i.ho, i64 0
  %61 = shufflevector <8 x i32> %60, <8 x i32> poison, <8 x i32> zeroinitializer
  %62 = add nsw <8 x i32> %24, %61
  %63 = add nsw <8 x i32> %62, %59
  %64 = ashr <8 x i32> %63, %57                   ; 3 uses
  %65 = shufflevector <4 x i32> %54, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %66 = shufflevector <8 x i32> %65, <8 x i32> %64, <8 x i32> <i32 9, i32 10, i32 14, i32 15, i32 0, i32 1, i32 2, i32 poison>
  %i.ia = insertelement <8 x i32> %66, i32 %i.hu, i64 7
  %67 = sub nsw <8 x i32> %64, %i.ia              ; 5 uses
  %68 = add nsw <8 x i32> %67, splat (i32 32)     ; 11 uses
  %69 = add nsw i32 %41, 32                       ; 3 uses
  %70 = sub nsw <4 x i32> %54, %55                ; 3 uses
  %71 = add nsw <4 x i32> %70, splat (i32 32)     ; 3 uses
  %i.ib = extractelement <4 x i32> %55, i64 1
  %i.ic = sub nsw i32 %i.ib, %35                  ; 2 uses
  %i.id = add nsw i32 %i.ic, 32                   ; 3 uses
  %i.ie = extractelement <4 x i32> %55, i64 2
  %72 = sub nsw i32 %i.ie, %40
  %73 = add nsw i32 %72, 32                       ; 3 uses
  %74 = shufflevector <8 x i32> %68, <8 x i32> poison, <12 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison>
  %75 = shufflevector <4 x i32> %71, <4 x i32> poison, <12 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
  %76 = shufflevector <12 x i32> %74, <12 x i32> %75, <12 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 12, i32 13, i32 14, i32 15>
  %i.if = tail call i32 @llvm.vector.reduce.smin.v12i32(<12 x i32> %76)
  %i.ig = tail call i32 @llvm.smin.i32(i32 %i.if, i32 %69)
  %i.ih = tail call i32 @llvm.smin.i32(i32 %i.id, i32 %73)
  %i.ii = tail call i32 @llvm.smin.i32(i32 %i.ig, i32 %i.ih) ; 2 uses
  %77 = shufflevector <8 x i32> %68, <8 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %78 = tail call <4 x i32> @llvm.smax.v4i32(<4 x i32> %77, <4 x i32> %71)
  %79 = shufflevector <4 x i32> %78, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %80 = shufflevector <8 x i32> %79, <8 x i32> %68, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15>
  %i.ij = tail call i32 @llvm.vector.reduce.smax.v8i32(<8 x i32> %80)
  %i.ik = tail call i32 @llvm.smax.i32(i32 %i.ij, i32 %69)
  %i.il = tail call i32 @llvm.smax.i32(i32 %i.id, i32 %73)
...
bb.cc:                                            ; preds = %bb.cb
  %81 = extractelement <8 x i32> %64, i64 0
  %i.is = shl i32 %81, %i.hn
  ...
  %i.iv = shl i32 %i.hn, 2
  %i.iw = extractelement <8 x i32> %68, i64 0
  ...
  %i.jb = extractelement <8 x i32> %67, i64 0
  %i.jc = shl i32 %i.jb, 4
  %i.jd = extractelement <8 x i32> %68, i64 1
  ...
  %i.ji = extractelement <8 x i32> %67, i64 1
  %i.jj = shl i32 %i.ji, 6
  %i.jk = extractelement <8 x i32> %68, i64 2
  ...
  %82 = extractelement <8 x i32> %68, i64 3
  %83 = shl i32 %82, 2
  %84 = extractelement <8 x i32> %68, i64 4
  %85 = lshr i32 %84, 4
  %86 = or i32 %85, %83
  %87 = trunc i32 %86 to i8
  %i.jo = getelementptr inbounds nuw i8, ptr %.2176304.us, i64 5
  store i8 %87, ptr %i.jo, align 1, !tbaa !37
  %88 = extractelement <8 x i32> %67, i64 4
  %89 = shl i32 %88, 4
  %90 = extractelement <8 x i32> %68, i64 5
  %91 = lshr i32 %90, 2
  %92 = or i32 %91, %89
  %93 = trunc i32 %92 to i8
  %94 = getelementptr inbounds nuw i8, ptr %.2176304.us, i64 6
  store i8 %93, ptr %94, align 1, !tbaa !37
  %95 = extractelement <8 x i32> %67, i64 5
  %96 = shl i32 %95, 6
  %97 = extractelement <8 x i32> %68, i64 6
  %98 = or i32 %97, %96
  %99 = trunc i32 %98 to i8
  %100 = getelementptr inbounds nuw i8, ptr %.2176304.us, i64 7
  store i8 %99, ptr %100, align 1, !tbaa !37
  %101 = shufflevector <4 x i32> %70, <4 x i32> poison, <4 x i32> <i32 poison, i32 0, i32 1, i32 poison>
  %102 = shufflevector <8 x i32> %68, <8 x i32> poison, <4 x i32> <i32 7, i32 poison, i32 poison, i32 poison>
  %103 = shufflevector <4 x i32> %102, <4 x i32> %101, <4 x i32> <i32 0, i32 5, i32 6, i32 poison>
  %104 = insertelement <4 x i32> %103, i32 %69, i64 3
  %105 = shl <4 x i32> %104, <i32 2, i32 4, i32 6, i32 2>
  %106 = getelementptr inbounds nuw i8, ptr %.2176304.us, i64 8
  %107 = lshr <4 x i32> %71, <i32 4, i32 2, i32 0, i32 4>
  %108 = or <4 x i32> %107, %105
  %109 = trunc <4 x i32> %108 to <4 x i8>
  store <4 x i8> %109, ptr %106, align 1, !tbaa !37
  %i.jp = extractelement <4 x i32> %70, i64 3
  %110 = shl i32 %i.jp, 4
  %111 = lshr i32 %i.id, 2
  %112 = or i32 %111, %110
  %113 = trunc i32 %112 to i8
  %114 = getelementptr inbounds nuw i8, ptr %.2176304.us, i64 12
