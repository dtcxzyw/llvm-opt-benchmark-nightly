...
begin_hunk_0_@uncompress_b44_impl:bb.a
  ...
  %i.bu = or disjoint i32 %.masked97.i.us, %i.bt  ; 2 uses
  %i.bv = shl nuw nsw i32 %i.bu, %i.bb
  %5 = add nsw i32 %i.bl, %.neg106.i.us           ; 3 uses
  %i.bw = add nsw i32 %i.bv, %5                   ; 2 uses
  %i.bx = add nsw i32 %i.bu, -32
  ...
  %i.cb = add nsw i32 %i.bw, %.neg106.i.us
  ...
  %i.ci = trunc i32 %i.bw to i16                  ; 2 uses
  ...
  %i.cm = add nsw i32 %i.bx, %i.cl
  %i.cn = shl nsw i32 %i.cm, %i.bb
  %i.co = add nsw i32 %i.cn, %5                   ; 2 uses
...
begin_hunk_1_@uncompress_b44_impl:bb.a
  ...
  %i.dd = add nsw i32 %i.dc, %5                   ; 2 uses
