...
begin_hunk_2
  ...
  %invariant.op398 = add <4 x i32> splat (i32 4), %broadcast.splat306
...
begin_hunk_3
  ...
  %.reass399 = add <4 x i32> %vec.ind309, %invariant.op398
  ...
  %vec.ind.next313 = add <4 x i32> %vec.ind309, splat (i32 8)
...
begin_hunk_4
  ...
  %invariant.op402 = add <4 x i32> splat (i32 4), %broadcast.splat325
...
begin_hunk_5
  ...
  %.reass403 = add <4 x i32> %vec.ind328, %invariant.op402
  ...
  %vec.ind.next332 = add <4 x i32> %vec.ind328, splat (i32 8)
