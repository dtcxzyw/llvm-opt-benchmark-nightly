...
begin_hunk_0_@tt_cmap6_char_next:bb.a
  ...
  %i.v = sub nuw nsw i32 %spec.select, %i.u       ; 3 uses
  %i.w = icmp samesign ult i32 %i.v, %i.l
...
begin_hunk_1_@tt_cmap10_char_next:bb.a
  ...
  %i.aa = sub nuw i32 %spec.select, %i.y          ; 3 uses
...
begin_hunk_2_@tt_sbit_decoder_load_byte_aligned:bb.a
  ...
  %n.vec = and i64 %i.hl, 536870880               ; 5 uses
  %.cast = trunc nuw nsw i64 %n.vec to i32
  %i.hm = shl nuw i32 %.cast, 3
...
begin_hunk_3_@tt_sbit_decoder_load_bit_aligned:bb.a
  ...
  %i.aw = sub nuw nsw i32 %i.q, %i.aq             ; 3 uses
...
.split:                                           ; preds = %bb.e
  %6 = icmp samesign ugt i32 %i.aw, 7
...
begin_hunk_6_@tt_sbit_decoder_load_bit_aligned:bb.a
  ...
  %i.ff = sub i32 %reass.sub123, %.1.lcssa
  %i.fg = shl i16 %.5, 8
  br label %bb.af
...
.split136.us.split.us:                            ; preds = %bb.c
  %i.bp = sub nuw nsw i32 %.094104.us.us.mux, %i.ag
  %i.bq = shl nuw nsw i32 %i.bp, 1
  %i.br = add nuw nsw i32 %.0103.us.us.us.us, %i.bq
