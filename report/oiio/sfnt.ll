...
define internal void @tt_face_get_metrics(ptr noundef %0, i8 noundef zeroext %1, i32 noundef %2, ptr noundef captures(none) initializes((0, 2)) %3, ptr noundef captures(none) initializes((0, 2)) %4) #0 {
bb.a:
...
begin_hunk_4_@tt_face_get_metrics:bb.a
  ...
  %5 = load i16, ptr %3, align 2, !tbaa !298
...
.critedge188.i:                                   ; preds = %sfnt_get_name_id.exit235.i, %sfnt_get_name_id.exit222.i, %sfnt_get_name_id.exit.i
  %.0..0.324.i = phi i32 [ %.0..0..0..0..0..pre.pre333.i, %sfnt_get_name_id.exit.i ], [ %.0..0..0..0..0..pre.pre.i, %sfnt_get_name_id.exit235.i ], [ %.0..0..0..0..0..pre.pre332.i, %sfnt_get_name_id.exit222.i ] ; 2 uses
  %.0..0.250.pr.i = phi i32 [ %.0..0..0..0..0.251.pr.i, %sfnt_get_name_id.exit.i ], [ %.0..0..0..0..0.255.pr.i, %sfnt_get_name_id.exit235.i ], [ %.0..0..0..0..0.253.pr.i, %sfnt_get_name_id.exit222.i ] ; 2 uses
