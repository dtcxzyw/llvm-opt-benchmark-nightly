...
.preheader.i.i:                                   ; preds = %bb.aw, %.preheader.i.i
  ...
  br i1 %.not.i239.i, label %iter.check, label %.preheader.i.i, !llvm.loop !697
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load104 = load <16 x i8>, ptr %i.hy, align 1, !tbaa !16, !alias.scope !698
  ...
  store <16 x i8> %reverse, ptr %next.gep103, align 1, !tbaa !16, !alias.scope !701, !noalias !698
  store <16 x i8> %reverse105, ptr %i.hz, align 1, !tbaa !16, !alias.scope !701, !noalias !698
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load111 = load <8 x i8>, ptr %i.if, align 1, !tbaa !16, !alias.scope !698
  %reverse112 = shufflevector <8 x i8> %wide.load111, <8 x i8> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  store <8 x i8> %reverse112, ptr %next.gep110, align 1, !tbaa !16, !alias.scope !701, !noalias !698
