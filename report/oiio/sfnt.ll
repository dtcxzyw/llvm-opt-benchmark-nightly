Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/oiio/original/sfnt?download=true
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.ic, align 1, !tbaa !16, !alias.scope !698
  %wide.load106 = load <16 x i8>, ptr %i.id, align 1, !tbaa !16, !alias.scope !698
  ...
  store <16 x i8> %reverse107, ptr %i.ie, align 1, !tbaa !16, !alias.scope !701, !noalias !698
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.if = icmp eq i64 %index.next, %n.vec
  br i1 %i.if, label %middle.block, label %vector.body, !llvm.loop !703
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load113 = load <8 x i8>, ptr %i.ik, align 1, !tbaa !16, !alias.scope !698
  ...
  br i1 %i.il, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !705
...
.lr.ph80.i.i:                                     ; preds = %.lr.ph80.i.i.preheader, %.lr.ph80.i.i
  ...
  %i.in = load i8, ptr %i.im, align 1, !tbaa !16
  %i.io = getelementptr inbounds nuw i8, ptr %.14878.i.i, i64 1 ; 2 uses
  store i8 %i.in, ptr %.14878.i.i, align 1, !tbaa !16
  %i.ip = icmp ugt ptr %i.im, %i.a
  br i1 %i.ip, label %.lr.ph80.i.i, label %._crit_edge.i240.i, !llvm.loop !706
...
bb.ax:                                            ; preds = %._crit_edge.i240.i
  ...
  store i8 %i.iu, ptr %.285.i.i, align 1, !tbaa !16
  ...
  store i8 %i.iz, ptr %.285.1.i.i, align 1, !tbaa !16
  ...
  store i8 %i.je, ptr %.285.2.i.i, align 1, !tbaa !16
...
bb.ay:                                            ; preds = %bb.ax
  ...
  store i8 %i.jj, ptr %.285.3.i.i, align 1, !tbaa !16
...
bb.az:                                            ; preds = %bb.ay
  ...
  store i8 %i.jo, ptr %.285.4.i.i, align 1, !tbaa !16
...
bb.bg:                                            ; preds = %.thread118.i.i
  ...
  store i8 %i.kb, ptr %.28594110117121.i.i, align 1, !tbaa !16
  br label %.thread70.i.i
