...
bb.c:                                             ; preds = %bb.a
  ...
  br i1 %.not24, label %4, label %bb.f
...
bb.b:                                             ; preds = %bb.a
  ...
  %.013.v = select i1 %.not, i64 1432, i64 1440
  %.013 = getelementptr inbounds nuw i8, ptr %0, i64 %.013.v
...
begin_hunk_2_@tt_face_get_colorline_stops:bb.a
  ...
  %3 = getelementptr inbounds nuw i8, ptr %i.m, i64 6 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  %i.bd = getelementptr inbounds nuw i8, ptr %i.m, i64 10
  %i.be = load i32, ptr %3, align 1               ; 2 uses
...
bb.l:                                             ; preds = %get_deltas_for_var_index_base.exit, %bb.f
  ...
  %.049 = phi ptr [ %i.bd, %get_deltas_for_var_index_base.exit ], [ %3, %bb.f ]
...
.thread274.i:                                     ; preds = %bb.ak
  ...
  %1 = getelementptr inbounds nuw i8, ptr %.pr.i, i64 %i.eo
...
.thread282.i:                                     ; preds = %bb.ao, %bb.am
  ...
  %2 = getelementptr inbounds nuw i8, ptr %.0151.lcssa.i, i64 1
