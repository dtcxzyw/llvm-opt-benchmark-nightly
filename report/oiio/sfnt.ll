...
.lr.ph.i.i:                                       ; preds = %bb.b, %bb.d
  %.01.i.i = phi ptr [ %i.i, %bb.d ], [ %.val29.i, %bb.b ] ; 4 uses
  %i.e = load i64, ptr %.01.i.i, align 8, !tbaa !156
  %i.f = icmp eq i64 %i.e, %1
  br i1 %i.f, label %bb.c, label %bb.d

bb.c:                                             ; preds = %.lr.ph.i.i
  %i.g = getelementptr inbounds nuw i8, ptr %.01.i.i, i64 24
...
bb.d:                                             ; preds = %bb.c, %.lr.ph.i.i
  %i.i = getelementptr inbounds nuw i8, ptr %.01.i.i, i64 32 ; 2 uses
...
tt_face_lookup_table.exit.i:                      ; preds = %bb.c
  %i.k = getelementptr inbounds nuw i8, ptr %.01.i.i, i64 16
...
bb.f:                                             ; preds = %bb.e, %tt_face_lookup_table.exit.i
  ...
  %.022.i = phi i64 [ %i.m, %tt_face_lookup_table.exit.i ], [ %2, %bb.e ]
...
.critedge.i:                                      ; preds = %bb.g, %bb.f
  ...
  %i.u = tail call i32 @FT_Stream_ReadAt(ptr noundef %i.t, i64 noundef %.022.i, ptr noundef %3, i64 noundef %.1.i) #26
  br label %tt_face_load_any.exit

tt_face_load_any.exit:                            ; preds = %bb.d, %bb.b, %bb.h, %.critedge.i
  %.021.i = phi i32 [ 0, %bb.h ], [ %i.u, %.critedge.i ], [ 142, %bb.b ], [ 142, %bb.d ]
  ret i32 %.021.i
}
...
bb.ae:                                            ; preds = %bb.ad
  %i.dl = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %.1142.i) #29
...
bb.ag:                                            ; preds = %bb.af, %bb.ae
  ...
  store ptr %.1142.i, ptr %i.aa, align 8, !tbaa !335
  %i.dp = getelementptr inbounds nuw i8, ptr %0, i64 1240
  store i32 %.0137.i, ptr %i.dp, align 8, !tbaa !679
  br label %bb.ah
...
bb.an:                                            ; preds = %.lr.ph.i
  ...
  store i8 %i.ft, ptr %.0138298.i, align 1, !tbaa !16
  br label %bb.ao
...
.thread281.i:                                     ; preds = %bb.ao, %bb.am
  ...
  store i8 0, ptr %.0138.lcssa.i, align 1, !tbaa !16
...
bb.as:                                            ; preds = %.lr.ph303.i
  ...
  store i8 95, ptr %.4301.i, align 1, !tbaa !16
...
bb.aw:                                            ; preds = %bb.av, %bb.au
  ...
  %.047.i.i = phi ptr [ %i.hk, %bb.av ], [ %i.hd, %bb.au ] ; 10 uses
...
.preheader.i.i:                                   ; preds = %.lr.ph.i238.i
  %1 = icmp ugt ptr %5, %i.a
  br i1 %1, label %iter.check, label %._crit_edge.i240.i

iter.check:                                       ; preds = %.preheader.i.i
  %i.ho = ptrtoaddr ptr %5 to i64
  %i.hp = sub i64 %i.ho, %i.b                     ; 7 uses
...
vector.memcheck:                                  ; preds = %iter.check
  ...
  %i.hr = sub i64 %i.hq, %i.b
  %scevgep.a = getelementptr i8, ptr %.047.i.i, i64 %i.hr
  %bound0 = icmp ult ptr %.047.i.i, %5
  %bound1 = icmp ult ptr %i.a, %scevgep.a
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.hx, align 1, !tbaa !16, !alias.scope !697
  %wide.load104 = load <16 x i8>, ptr %i.hy, align 1, !tbaa !16, !alias.scope !697
  ...
  store <16 x i8> %reverse, ptr %next.gep103, align 1, !tbaa !16, !alias.scope !700, !noalias !697
  store <16 x i8> %reverse105, ptr %i.hz, align 1, !tbaa !16, !alias.scope !700, !noalias !697
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ia = icmp eq i64 %index.next, %n.vec
  br i1 %i.ia, label %middle.block, label %vector.body, !llvm.loop !702
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph80.i.i.preheader, label %vec.epilog.ph, !prof !703
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load111 = load <8 x i8>, ptr %i.if, align 1, !tbaa !16, !alias.scope !697
  %reverse112 = shufflevector <8 x i8> %wide.load111, <8 x i8> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  store <8 x i8> %reverse112, ptr %next.gep110, align 1, !tbaa !16, !alias.scope !700, !noalias !697
  %index.next113 = add nuw i64 %index108, 8       ; 2 uses
  %i.ig = icmp eq i64 %index.next113, %n.vec107
  br i1 %i.ig, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !704
...
.lr.ph.i238.i:                                    ; preds = %bb.aw, %.lr.ph.i238.i
  %.04477.i.i = phi i32 [ %6, %.lr.ph.i238.i ], [ %i.hm, %bb.aw ] ; 3 uses
  %.04576.i.i = phi ptr [ %5, %.lr.ph.i238.i ], [ %i.a, %bb.aw ] ; 2 uses
  %2 = urem i32 %.04477.i.i, 10
  %3 = trunc nuw nsw i32 %2 to i8
  %4 = or disjoint i8 %3, 48
  %5 = getelementptr inbounds nuw i8, ptr %.04576.i.i, i64 1 ; 11 uses
  store i8 %4, ptr %.04576.i.i, align 1, !tbaa !16
  %6 = udiv i32 %.04477.i.i, 10
  %.not.i239.i = icmp samesign ult i32 %.04477.i.i, 10
  br i1 %.not.i239.i, label %.preheader.i.i, label %.lr.ph.i238.i, !llvm.loop !705
...
._crit_edge.i240.i:                               ; preds = %.lr.ph80.i.i, %middle.block, %vec.epilog.middle.block, %.preheader.i.i, %bb.aw
  %.148.lcssa.i.i = phi ptr [ %.047.i.i, %.preheader.i.i ], [ %.047.i.i, %bb.aw ], [ %i.id, %vec.epilog.middle.block ], [ %i.hv, %middle.block ], [ %i.ij, %.lr.ph80.i.i ] ; 8 uses
...
bb.bl:                                            ; preds = %bb.bk
  ...
  store i8 %i.kr, ptr %.5.i, align 1, !tbaa !16
...
!699 = distinct !{!699, !"LVerDomain"}
!700 = !{!701}
!701 = distinct !{!701, !699}
!702 = distinct !{!702, !18, !104, !105}
!703 = !{!"branch_weights", i32 8, i32 24}
!704 = distinct !{!704, !18, !104, !105}
!705 = distinct !{!705, !18}
