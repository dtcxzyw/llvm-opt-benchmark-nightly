...
.critedge.preheader.i:                            ; preds = %.critedge.preheader.loopexit.i, %bb.i
  ...
  %i.ap = add i32 %29, %i.ao                      ; 4 uses
  store i32 %i.ap, ptr %i.w, align 4, !tbaa !76
  %i.aq = icmp ugt i32 %i.ap, 65537
  br i1 %i.aq, label %bb.z, label %bb.aa

.lr.ph.i:                                         ; preds = %bb.i, %bb.y
  %i.ar = phi i8 [ %i.cs, %bb.y ], [ 0, %bb.i ]   ; 5 uses
  %i.as = phi i8 [ %i.ct, %bb.y ], [ -1, %bb.i ]  ; 5 uses
  %.0133237.i = phi i64 [ %i.cu, %bb.y ], [ %i.aa, %bb.i ] ; 4 uses
...
bb.k:                                             ; preds = %.lr.ph.i
  %i.at = icmp slt i32 %.0193236.i, 6
  br i1 %i.at, label %.lr.ph.i.i, label %fasthuf_read_bits.exit.i

.lr.ph.i.i:                                       ; preds = %bb.k, %.lr.ph.i.i
  %i.au = phi ptr [ %i.ay, %.lr.ph.i.i ], [ %.0201234.i, %bb.k ] ; 2 uses
  %i.av = phi i64 [ %i.bb, %.lr.ph.i.i ], [ %.0196235.i, %bb.k ]
  %i.aw = phi i32 [ %i.bc, %.lr.ph.i.i ], [ %.0193236.i, %bb.k ] ; 2 uses
  %i.ax = shl i64 %i.av, 8
  %i.ay = getelementptr inbounds nuw i8, ptr %i.au, i64 1 ; 2 uses
  %i.az = load i8, ptr %i.au, align 1, !tbaa !25
  %i.ba = zext i8 %i.az to i64
  %i.bb = or disjoint i64 %i.ax, %i.ba            ; 2 uses
  %i.bc = add nsw i32 %i.aw, 8                    ; 2 uses
  %i.bd = icmp slt i32 %i.aw, -2
  br i1 %i.bd, label %.lr.ph.i.i, label %fasthuf_read_bits.exit.i, !llvm.loop !79

fasthuf_read_bits.exit.i:                         ; preds = %.lr.ph.i.i, %bb.k
  %.6207.i = phi ptr [ %.0201234.i, %bb.k ], [ %i.ay, %.lr.ph.i.i ] ; 6 uses
  %.5.i = phi i64 [ %.0196235.i, %bb.k ], [ %i.bb, %.lr.ph.i.i ] ; 6 uses
  %.lcssa.i.i = phi i32 [ %.0193236.i, %bb.k ], [ %i.bc, %.lr.ph.i.i ] ; 2 uses
  %i.be = add nsw i32 %.lcssa.i.i, -6             ; 6 uses
  %i.bf = zext nneg i32 %i.be to i64
  %i.bg = lshr i64 %.5.i, %i.bf
  %i.bh = and i64 %i.bg, 63                       ; 9 uses
  %i.bi = icmp samesign ult i64 %i.bh, 59
  br i1 %i.bi, label %bb.l, label %bb.r

bb.l:                                             ; preds = %fasthuf_read_bits.exit.i
  %i.bj = icmp eq i64 %i.bh, 0
  br i1 %i.bj, label %bb.y, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.bk = zext i8 %i.as to i64
  %i.bl = icmp samesign ult i64 %i.bh, %i.bk
  br i1 %i.bl, label %bb.n, label %bb.o

bb.n:                                             ; preds = %bb.m
  %i.bm = trunc nuw nsw i64 %i.bh to i8           ; 2 uses
  store i8 %i.bm, ptr %i.x, align 8, !tbaa !77
  br label %bb.o

bb.o:                                             ; preds = %bb.n, %bb.m
  %i.bn = phi i8 [ %i.bm, %bb.n ], [ %i.as, %bb.m ]
  %i.bo = zext nneg i8 %i.ar to i64
  %i.bp = icmp samesign ugt i64 %i.bh, %i.bo
  br i1 %i.bp, label %bb.p, label %bb.q

bb.p:                                             ; preds = %bb.o
  %i.bq = trunc nuw nsw i64 %i.bh to i8           ; 2 uses
  store i8 %i.bq, ptr %i.y, align 1, !tbaa !78
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  %i.br = phi i8 [ %i.bq, %bb.p ], [ %i.ar, %bb.o ]
  %i.bs = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %i.bh ; 2 uses
...
bb.u:                                             ; preds = %bb.s
  %i.bw = icmp samesign ult i32 %.lcssa.i.i, 14
  br i1 %i.bw, label %.lr.ph.i168.i, label %fasthuf_read_bits.exit170.i

.lr.ph.i168.i:                                    ; preds = %bb.u, %.lr.ph.i168.i
  %i.bx = phi ptr [ %i.cb, %.lr.ph.i168.i ], [ %.6207.i, %bb.u ] ; 2 uses
  %i.by = phi i64 [ %i.ce, %.lr.ph.i168.i ], [ %.5.i, %bb.u ]
  %i.bz = phi i32 [ %i.cf, %.lr.ph.i168.i ], [ %i.be, %bb.u ] ; 2 uses
  %i.ca = shl i64 %i.by, 8
  ...
  %i.cf = add nsw i32 %i.bz, 8                    ; 2 uses
  %i.cg = icmp slt i32 %i.bz, 0
  br i1 %i.cg, label %.lr.ph.i168.i, label %fasthuf_read_bits.exit170.i, !llvm.loop !79

fasthuf_read_bits.exit170.i:                      ; preds = %.lr.ph.i168.i, %bb.u
  %.7208.i = phi ptr [ %.6207.i, %bb.u ], [ %i.cb, %.lr.ph.i168.i ]
  %.6.i = phi i64 [ %.5.i, %bb.u ], [ %i.ce, %.lr.ph.i168.i ] ; 2 uses
  %.lcssa.i167.i = phi i32 [ %i.be, %bb.u ], [ %i.cf, %.lr.ph.i168.i ]
  %i.ch = add nsw i32 %.lcssa.i167.i, -8          ; 2 uses
  %i.ci = zext nneg i32 %i.ch to i64
  %i.cj = lshr i64 %.6.i, %i.ci
  %i.ck = and i64 %i.cj, 255
  %i.cl = add nuw nsw i64 %.0133237.i, 5
  %i.cm = add nuw nsw i64 %i.cl, %i.ck
  br label %bb.w

bb.v:                                             ; preds = %bb.r
  %i.cn = add i64 %.0133237.i, -58
  %i.co = add i64 %i.cn, %i.bh
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %fasthuf_read_bits.exit170.i, %bb.q
  %i.cp = phi i8 [ %i.br, %bb.q ], [ %i.ar, %fasthuf_read_bits.exit170.i ], [ %i.ar, %bb.v ]
  %i.cq = phi i8 [ %i.bn, %bb.q ], [ %i.as, %fasthuf_read_bits.exit170.i ], [ %i.as, %bb.v ]
  ...
  %.1194.i = phi i32 [ %i.be, %bb.q ], [ %i.ch, %fasthuf_read_bits.exit170.i ], [ %i.be, %bb.v ]
  %.1134.i = phi i64 [ %.0133237.i, %bb.q ], [ %i.cm, %fasthuf_read_bits.exit170.i ], [ %i.co, %bb.v ] ; 2 uses
  %i.cr = icmp samesign ugt i64 %.1134.i, %i.ab
...
bb.aa:                                            ; preds = %.critedge.preheader.i
  %i.cv = load i8, ptr %i.x, align 8, !tbaa !77   ; 7 uses
  %i.cw = load i8, ptr %i.y, align 1, !tbaa !78   ; 4 uses
  %.not154240.i = icmp ugt i8 %i.cv, %i.cw        ; 3 uses
  %.pre180 = zext i8 %i.cw to i64                 ; 16 uses
  br i1 %.not154240.i, label %._crit_edge253.i, label %.lr.ph242.preheader.i

.lr.ph242.preheader.i:                            ; preds = %bb.aa
  %i.cx = zext i8 %i.cv to i64                    ; 8 uses
  %i.cy = add nuw nsw i64 %.pre180, 1
  %i.cz = sub nsw i64 %i.cy, %i.cx                ; 3 uses
  %min.iters.check257 = icmp ult i64 %i.cz, 2
  br i1 %min.iters.check257, label %.lr.ph242.i.preheader, label %vector.ph258

vector.ph258:                                     ; preds = %.lr.ph242.preheader.i
  %n.vec260 = and i64 %i.cz, -2                   ; 3 uses
  %i.da = add nsw i64 %n.vec260, %i.cx
  %broadcast.splatinsert = insertelement <2 x i64> poison, i64 %.pre180, i64 0
  %broadcast.splat = shufflevector <2 x i64> %broadcast.splatinsert, <2 x i64> poison, <2 x i32> zeroinitializer
  %broadcast.splatinsert261 = insertelement <2 x i64> poison, i64 %i.cx, i64 0
...
vector.body263:                                   ; preds = %vector.body263, %vector.ph258
  ...
  %i.db = add i64 %index264, %i.cx                ; 2 uses
  %i.dc = getelementptr inbounds nuw [8 x i8], ptr %i.d, i64 %i.db
  %wide.load = load <2 x i64>, ptr %i.dc, align 8, !tbaa !9
  %i.dd = uitofp <2 x i64> %wide.load to <2 x double>
  %i.de = sub nuw nsw <2 x i64> %broadcast.splat, %vec.ind
  %i.df = shl <2 x i64> splat (i64 2), %i.de
  %i.dg = sitofp <2 x i64> %i.df to <2 x double>
  %i.dh = fmul nnan <2 x double> %i.dd, %i.dg
  %i.di = getelementptr inbounds nuw [8 x i8], ptr %i.c, i64 %i.db
  store <2 x double> %i.dh, ptr %i.di, align 8, !tbaa !81
  %index.next265 = add nuw i64 %index264, 2       ; 2 uses
  %vec.ind.next = add nuw nsw <2 x i64> %vec.ind, splat (i64 2)
  %i.dj = icmp eq i64 %index.next265, %n.vec260
  br i1 %i.dj, label %middle.block266, label %vector.body263, !llvm.loop !83

middle.block266:                                  ; preds = %vector.body263
  %cmp.n267 = icmp eq i64 %i.cz, %n.vec260
