begin_hunk_0
  ...
  %i.mq = add nsw <16 x i64> %vec.ind264, splat (i64 -8)
  %i.mr = lshr <16 x i64> %broadcast.splat258, %i.mq
...
bb.ak:                                            ; preds = %.lr.ph187.i
  ...
  %7 = trunc nuw i64 %indvars.iv227.i to i32
  %i.my = icmp slt i32 %7, 16
...
bb.am:                                            ; preds = %.lr.ph176.i
  ...
  %8 = trunc nuw i64 %indvars.iv219.i to i32
  %i.nx = icmp slt i32 %8, 16
...
.thread132.i:                                     ; preds = %.thread132.loopexit210.i, %.thread132.loopexit207.i, %.thread132.loopexit.i, %.critedge120.thread.i, %bb.al, %.critedge.i
  ...
  %.889140.i = phi ptr [ %.182.lcssa.i, %.critedge.i ], [ %.081198.i, %.critedge120.thread.i ], [ %.081198.i, %bb.al ], [ %i.ov, %.thread132.loopexit.i ], [ %i.mx, %.thread132.loopexit207.i ], [ %i.nw, %.thread132.loopexit210.i ] ; 5 uses
  %.4101139.i = phi i64 [ %i.mb, %.critedge.i ], [ %i.nz, %.critedge120.thread.i ], [ %i.na, %bb.al ], [ %i.nz, %.thread132.loopexit.i ], [ %i.mb, %.thread132.loopexit207.i ], [ %i.na, %.thread132.loopexit210.i ] ; 2 uses
  %.8111138.i = phi i32 [ %i.mc, %.critedge.i ], [ %i.oa, %.critedge120.thread.i ], [ %i.nb, %bb.al ], [ %i.oy, %.thread132.loopexit.i ], [ %i.oz, %.thread132.loopexit207.i ], [ %i.pa, %.thread132.loopexit210.i ] ; 3 uses
...
.critedge:                                        ; preds = %bb.bl, %hufUnpackEncTable.exit, %fasthuf_initialize.exit.thread, %bb.ar, %bb.as, %bb.g, %bb.f, %bb.e, %bb.d
  %.2 = phi i32 [ %., %bb.d ], [ %i.nx, %bb.as ], [ 1, %bb.ar ], [ 3, %bb.e ], [ 23, %bb.f ], [ 23, %hufUnpackEncTable.exit ], [ 1, %bb.g ], [ 23, %fasthuf_initialize.exit.thread ], [ %.262, %bb.bl ]
  ret i32 %.2
}
...
FastHufDecoder_refill.exit157:                    ; preds = %.sink.split.i147, %bb.ao, %bb.am
  %.5249 = phi i64 [ %.4248, %bb.am ], [ %.14258, %bb.ao ], [ %.16260, %.sink.split.i147 ] ; 2 uses
  %.5234 = phi i64 [ %.4233, %bb.am ], [ %i.gz, %bb.ao ], [ %.13242, %.sink.split.i147 ]
  %.5213 = phi i64 [ %.4212, %bb.am ], [ %i.hb, %bb.ao ], [ %.19227, %.sink.split.i147 ]
  %.5195 = phi i32 [ %.4194, %bb.am ], [ %i.hc, %bb.ao ], [ 64, %.sink.split.i147 ]
  %.5 = phi ptr [ %.4, %bb.am ], [ %.16, %bb.ao ], [ %.19, %.sink.split.i147 ]
  %.7 = phi i32 [ %.592, %bb.am ], [ 64, %bb.ao ], [ 64, %.sink.split.i147 ]
...
.critedge:                                        ; preds = %bb.ad, %bb.ag, %bb.ae, %bb.ah, %bb.ak, %bb.aj, %bb.o, %bb.p, %bb.s, %bb.r, %._crit_edge, %bb.av, %bb.aw
