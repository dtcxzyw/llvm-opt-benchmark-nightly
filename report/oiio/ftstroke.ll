...
begin_hunk_0_@FT_Stroker_BeginSubPath:bb.a
...
.lr.ph.i60:                                       ; preds = %.lr.ph.i60, %.lr.ph.preheader.i59
  ...
  %.048.i.a = getelementptr inbounds i8, ptr %.04857.i, i64 -16 ; 2 uses
  %.049.i = getelementptr inbounds nuw i8, ptr %.04958.i, i64 16 ; 2 uses
  %i.fi = icmp ult ptr %.049.i, %.048.i.a
end_hunk_1
