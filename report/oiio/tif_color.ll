...
vector.ph101:                                     ; preds = %bb.g, %bb.f
  ...
  %3 = extractelement <2 x float> %i.cc, i64 0
  %shift = shufflevector <2 x float> %i.cc, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop = fsub <2 x float> %shift, %i.cc
  %i.cd = extractelement <2 x float> %foldExtExtBinop, i64 0 ; 2 uses
  %4 = fcmp une float %i.cd, 0.000000e+00
  %5 = select i1 %4, float %i.cd, float 1.000000e+00
  %i.ce = fptosi float %3 to i32
  ...
  %shift127 = shufflevector <2 x float> %i.ch, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop128 = fsub <2 x float> %shift127, %i.ch
  %6 = extractelement <2 x float> %foldExtExtBinop128, i64 0 ; 2 uses
  %7 = fcmp une float %6, 0.000000e+00
  %8 = select i1 %7, float %6, float 1.000000e+00
  ...
  %broadcast.splatinsert104 = insertelement <4 x float> poison, float %8, i64 0
  ...
  %broadcast.splatinsert108 = insertelement <4 x float> poison, float %5, i64 0
