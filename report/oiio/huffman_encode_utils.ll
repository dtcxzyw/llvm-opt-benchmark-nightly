...
CodeRepeatedZeros.exit:                           ; preds = %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %bb.k, %bb.j, %bb.g, %bb.e, %.lr.ph35.preheader.i, %bb.d
  ...
  %.1 = phi ptr [ %4, %bb.g ], [ %.059, %bb.d ], [ %i.y, %.lr.ph35.preheader.i ], [ %3, %bb.e ], [ %.026.i, %bb.j ], [ %i.ca, %bb.k ], [ %i.bl, %middle.block ], [ %i.bq, %vec.epilog.middle.block ], [ %i.bu, %vec.epilog.scalar.ph ] ; 2 uses
