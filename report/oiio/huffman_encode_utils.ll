...
begin_hunk_0_@VP8LCreateCompressedHuffmanTree:bb.a
  ...
  %i.h = load i8, ptr %i.g, align 1, !tbaa !13    ; 6 uses
...
.lr.ph38.i:                                       ; preds = %.lr.ph.i36, %.lr.ph.preheader.i34
  ...
  %.12734.i.lcssa = phi ptr [ %.026.i, %.lr.ph.preheader.i34 ], [ %i.bx, %.lr.ph.i36 ] ; 4 uses
  %i.bg = add i32 %.135.i.lcssa, -1               ; 2 uses
  %i.bh = zext i32 %i.bg to i64
  %i.bi = add nuw nsw i64 %i.bh, 1                ; 2 uses
  %min.iters.check = icmp ult i32 %i.bg, 15
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph38.i
  %n.vec = and i64 %i.bi, 8589934576              ; 4 uses
...
begin_hunk_2_@VP8LCreateCompressedHuffmanTree:bb.a
  ...
  br i1 %i.bn, label %middle.block.a, label %vector.body, !llvm.loop !22

middle.block.a:                                   ; preds = %vector.body
  %cmp.n.a = icmp eq i64 %i.bi, %n.vec
  br i1 %cmp.n.a, label %CodeRepeatedZeros.exit, label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %.lr.ph38.i, %middle.block.a
  %.037.i.ph = phi i32 [ 0, %.lr.ph38.i ], [ %i.bj, %middle.block.a ]
  %.236.i.ph = phi ptr [ %.12734.i.lcssa, %.lr.ph38.i ], [ %i.bl, %middle.block.a ]
  br label %scalar.ph
...
begin_hunk_3_@VP8LCreateCompressedHuffmanTree:bb.a
  ...
  br i1 %exitcond.not.i, label %CodeRepeatedZeros.exit, label %scalar.ph, !llvm.loop !23
...
begin_hunk_4_@VP8LCreateCompressedHuffmanTree:bb.a
  ...
  br i1 %i.bz, label %.lr.ph38.i, label %.lr.ph, !llvm.loop !24

CodeRepeatedZeros.exit:                           ; preds = %scalar.ph, %middle.block.a, %bb.k, %bb.j, %bb.g, %bb.e, %.lr.ph35.preheader.i, %bb.d
  %.130 = phi i32 [ %.02958, %bb.g ], [ %.02958, %bb.d ], [ %.02958, %.lr.ph35.preheader.i ], [ %.02958, %bb.e ], [ %i.i, %bb.j ], [ %i.i, %bb.k ], [ %i.i, %middle.block.a ], [ %i.i, %scalar.ph ]
  %.1 = phi ptr [ %indvars.iv.i52, %bb.g ], [ %.059, %bb.d ], [ %i.y, %.lr.ph35.preheader.i ], [ %indvars.iv.i52, %bb.e ], [ %.026.i, %bb.j ], [ %i.bv, %bb.k ], [ %i.bl, %middle.block.a ], [ %i.bp, %scalar.ph ] ; 2 uses
  %i.ca = icmp slt i32 %.028.lcssa, %i.a
  br i1 %i.ca, label %bb.b, label %._crit_edge, !llvm.loop !25
...
begin_hunk_5_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %exitcond.not.i, label %._crit_edge139.i, label %.lr.ph138.i, !llvm.loop !26
...
begin_hunk_6_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %i.bm, label %middle.block, label %vector.body, !llvm.loop !27
...
begin_hunk_8_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %exitcond155.not.i.3, label %.loopexit.i, label %scalar.ph, !llvm.loop !30
...
begin_hunk_9_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %exitcond160.not.i, label %OptimizeHuffmanForRle.exit, label %bb.h, !llvm.loop !31
...
begin_hunk_10_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %i.dj, label %middle.block67, label %vector.body62, !llvm.loop !32
...
begin_hunk_11_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %exitcond.not.i16, label %._crit_edge.i17, label %.lr.ph.i13, !llvm.loop !33
...
begin_hunk_12_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %exitcond212.not.i, label %._crit_edge134.us.us.i, label %.lr.ph133.us.us.i, !llvm.loop !34
...
._crit_edge118.us.us.i:                           ; preds = %bb.z
  ...
  %i.eh = load i32, ptr %i.dr, align 4, !tbaa !37
...
begin_hunk_15_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %i.et, label %middle.block123, label %vector.body115, !llvm.loop !41
...
begin_hunk_16_@VP8LCreateHuffmanTree:bb.a
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.fd, ptr noundef nonnull align 4 dereferenceable(16) %i.ff, i64 16, i1 false), !tbaa.struct !42
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 4 dereferenceable(16) %i.fg, ptr noundef nonnull align 4 dereferenceable(16) %i.fi, i64 16, i1 false), !tbaa.struct !42
  %i.fj = load i32, ptr %i.fg, align 4, !tbaa !35
  %i.fk = load i32, ptr %i.fd, align 4, !tbaa !35
...
.lr.ph121.us.i:                                   ; preds = %bb.aa, %bb.ab
  ...
  %i.fo = load i32, ptr %i.fn, align 4, !tbaa !35
...
begin_hunk_18_@VP8LCreateHuffmanTree:bb.a
  ...
  store i32 %i.fl, ptr %i.fq, align 4, !tbaa !35
  %i.fv = getelementptr inbounds nuw i8, ptr %i.fq, i64 4
  store i32 -1, ptr %i.fv, align 4, !tbaa !37
...
begin_hunk_19_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %exitcond202.not.i, label %._crit_edge134.us150.i, label %.lr.ph133.us149.i, !llvm.loop !45
...
begin_hunk_21_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %exitcond179.not.i, label %.preheader.us.i, label %.lr.ph117.us147.i, !llvm.loop !40
...
begin_hunk_22_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %i.gw, label %middle.block103, label %vector.body95, !llvm.loop !46
...
begin_hunk_25_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %i.hq, label %middle.block84, label %vector.body77, !llvm.loop !47
...
.lr.ph27.i:                                       ; preds = %._crit_edge.i19
  ...
  %i.lo = load ptr, ptr %i.ln, align 8, !tbaa !51
...
begin_hunk_30_@VP8LCreateHuffmanTree:bb.a
  ...
  br i1 %niter155.ncmp.1.not, label %ReverseBits.exit.i.loopexit.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !52
...
begin_hunk_31_@VP8LCreateHuffmanTree:bb.a
  ...
  store i16 %i.ne, ptr %i.nf, align 2, !tbaa !53
...
begin_hunk_35_@SetBitDepths:bb.a
  ...
  %i.m = load i32, ptr %i.l, align 4, !tbaa !38   ; 2 uses
...
!31 = distinct !{!31, !15}
!32 = distinct !{!32, !15, !20, !21}
!33 = distinct !{!33, !15, !21, !20}
!34 = distinct !{!34, !15, !21, !20}
!35 = !{!36, !4, i64 0}
!36 = !{!"", !4, i64 0, !4, i64 4, !4, i64 8, !4, i64 12}
!37 = !{!36, !4, i64 4}
!38 = !{!36, !4, i64 8}
!39 = !{!36, !4, i64 12}
!40 = distinct !{!40, !15}
!41 = distinct !{!41, !15, !20, !21}
!42 = !{i64 0, i64 4, !3, i64 4, i64 4, !3, i64 8, i64 4, !3, i64 12, i64 4, !3}
!43 = distinct !{!43, !15}
!44 = distinct !{!44, !15}
!45 = distinct !{!45, !15, !21, !20}
!46 = distinct !{!46, !15, !20, !21}
!47 = distinct !{!47, !15, !20, !21}
!48 = distinct !{!48, !15, !21, !20}
!49 = distinct !{!49, !15}
!50 = distinct !{!50, !29}
!51 = !{!8, !11, i64 16}
!52 = distinct !{!52, !15}
