...
.lr.ph138.preheader.i:                            ; preds = %.lr.ph
  ...
  %lsr.iv198.lcssa = phi i32 [ %lsr.iv198, %.lr.ph ]
  ...
  %i.q = zext i32 %lsr.iv198.lcssa to i64
...
begin_hunk_1_@VP8LCreateHuffmanTree:bb.a
  ...
  %i.r = icmp eq i64 %lsr.iv.lcssa, %indvar.i     ; 2 uses
...
.lr.ph121.us.i:                                   ; preds = %.lr.ph121.us.i.preheader, %bb.ab
  ...
  %indvars.iv180.i = phi i64 [ %indvars.iv.next181.i, %bb.ab ], [ 0, %.lr.ph121.us.i.preheader ] ; 3 uses
...
._crit_edge122.us.loopexit.isplit:                ; preds = %bb.ab
  %.092.lcssa.us.ph.in.i.ph = phi i64 [ %indvars.iv187.i, %bb.ab ]
  br label %._crit_edge122.us.loopexit.i

.lr.ph121.us.i.._crit_edge122.us.loopexit.i_crit_edge: ; preds = %.lr.ph121.us.i
  %indvars.iv180.i.lcssa = phi i64 [ %indvars.iv180.i, %.lr.ph121.us.i ]
  %indvars.iv180.i.lcssa.a = phi i64 [ %indvars.iv180.i, %.lr.ph121.us.i ] ; 0 uses
  br label %._crit_edge122.us.loopexit.i

._crit_edge122.us.loopexit.i:                     ; preds = %._crit_edge122.us.loopexit.isplit, %.lr.ph121.us.i.._crit_edge122.us.loopexit.i_crit_edge
  %.092.lcssa.us.ph.in.i = phi i64 [ %indvars.iv180.i.lcssa, %.lr.ph121.us.i.._crit_edge122.us.loopexit.i_crit_edge ], [ %.092.lcssa.us.ph.in.i.ph, %._crit_edge122.us.loopexit.isplit ]
