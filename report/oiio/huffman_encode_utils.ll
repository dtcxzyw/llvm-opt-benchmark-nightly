...
CodeRepeatedZeros.exit:                           ; preds = %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %bb.k, %bb.j, %bb.g, %bb.e, %.lr.ph35.preheader.i, %bb.d
  ...
  %.1 = phi ptr [ %indvars.iv.i52, %bb.g ], [ %.059, %bb.d ], [ %i.y, %.lr.ph35.preheader.i ], [ %indvars.iv.i52, %bb.e ], [ %.026.i, %bb.j ], [ %i.cd, %bb.k ], [ %i.bn, %middle.block ], [ %i.bt, %vec.epilog.middle.block ], [ %i.bx, %vec.epilog.scalar.ph ] ; 2 uses
