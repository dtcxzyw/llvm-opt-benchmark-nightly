...
bb.b:                                             ; preds = %.lr.ph55, %CodeRepeatedZeros.exit
  %.054 = phi ptr [ %1, %.lr.ph55 ], [ %.1, %CodeRepeatedZeros.exit ] ; 6 uses
  %.02953 = phi i32 [ 8, %.lr.ph55 ], [ %.130, %CodeRepeatedZeros.exit ] ; 4 uses
...
.critedge:                                        ; preds = %bb.c, %bb.b, %.critedge.split.loop.exit78
  ...
  %i.q = sub nsw i32 %.028.lcssa, %.03152         ; 6 uses
...
CodeRepeatedZeros.exit:                           ; preds = %vec.epilog.scalar.ph, %middle.block, %vec.epilog.middle.block, %bb.j, %bb.i, %bb.f, %bb.d, %.lr.ph35.preheader.i
  %.130 = phi i32 [ %.02953, %bb.f ], [ %i.i, %bb.j ], [ %.02953, %.lr.ph35.preheader.i ], [ %.02953, %bb.d ], [ %i.i, %bb.i ], [ %i.i, %middle.block ], [ %i.i, %vec.epilog.middle.block ], [ %i.i, %vec.epilog.scalar.ph ]
  %.1 = phi ptr [ %i.ag, %bb.f ], [ %i.cf, %bb.j ], [ %scevgep.i, %.lr.ph35.preheader.i ], [ %i.ab, %bb.d ], [ %.026.i, %bb.i ], [ %i.bp, %middle.block ], [ %i.bv, %vec.epilog.middle.block ], [ %i.bz, %vec.epilog.scalar.ph ] ; 2 uses
