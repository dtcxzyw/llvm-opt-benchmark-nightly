...
.lr.ph:                                           ; preds = %.lr.ph42.split, %._crit_edge
  %indvars.iv46 = phi i64 [ %i.bh, %.lr.ph42.split ], [ %indvars.iv.next47, %._crit_edge ] ; 2 uses
  %i.br = mul i64 %i.bc, %indvars.iv46
...
._crit_edge:                                      ; preds = %.lr.ph.new, %.prol.loopexit
  ...
  %exitcond50.not = icmp eq i32 %i.bi, %lftr.wideiv49
