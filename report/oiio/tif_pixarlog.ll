...
begin_hunk_0_@PixarLogDecode:bb.a
  ...
  br i1 %.not138, label %.thread220, label %bb.m
...
bb.n:                                             ; preds = %.thread220
  tail call void @TIFFSwabArrayOfShort(ptr noundef %i.as, i64 noundef %.0122) #7
  br label %bb.o

bb.o:                                             ; preds = %bb.n, %.thread220
  %i.ax = sext i32 %i.o to i64                    ; 20 uses
  %i.ay = srem i64 %.0122, %i.ax                  ; 2 uses
  %.not140 = icmp eq i64 %i.ay, 0
  br i1 %.not140, label %bb.q, label %bb.p

bb.p:                                             ; preds = %bb.o
  tail call void (ptr, ptr, ptr, ...) @TIFFWarningExtR(ptr noundef nonnull %0, ptr noundef nonnull @PixarLogDecode.module, ptr noundef nonnull @.str.13, i32 noundef %i.o, i64 noundef %.0122) #7
  %i.az = sub nsw i64 %.0122, %i.ay
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %bb.o
  %.1 = phi i64 [ %i.az, %bb.p ], [ %.0122, %bb.o ] ; 2 uses
  %i.ba = icmp sgt i64 %.1, 0
...
bb.r:                                             ; preds = %.lr.ph, %horizontalAccumulateF.exit
  ...
  %.0121260 = phi ptr [ %i.as, %.lr.ph ], [ %i.ahr, %horizontalAccumulateF.exit ] ; 59 uses
  %.0123259 = phi i64 [ 0, %.lr.ph ], [ %i.ahq, %horizontalAccumulateF.exit ]
  %.0126258 = phi ptr [ %1, %.lr.ph ], [ %i.ahp, %horizontalAccumulateF.exit ] ; 65 uses
  %.0126258403 = ptrtoaddr ptr %.0126258 to i64
...
bb.u:                                             ; preds = %bb.t
  %i.bp = load i16, ptr %.0121260, align 2, !tbaa !59
  ...
  %i.bu = getelementptr inbounds nuw i8, ptr %.0121260, i64 2
  ...
  %i.ca = getelementptr inbounds nuw i8, ptr %.0121260, i64 4
  ...
  store float %i.bt, ptr %.0126258, align 4, !tbaa !52
  %i.cg = getelementptr inbounds nuw i8, ptr %.0126258, i64 4
  store float %i.bz, ptr %i.cg, align 4, !tbaa !52
  %i.ch = getelementptr inbounds nuw i8, ptr %.0126258, i64 8
...
.lr.ph156.i:                                      ; preds = %.lr.ph156.i, %.lr.ph156.preheader.i
  %.0118155.i = phi i32 [ %i.df, %.lr.ph156.i ], [ %i.ci, %.lr.ph156.preheader.i ]
  %.0119154.i = phi i32 [ %i.cx, %.lr.ph156.i ], [ %i.cj, %.lr.ph156.preheader.i ]
  %.0121153.i = phi i32 [ %i.cp, %.lr.ph156.i ], [ %i.ck, %.lr.ph156.preheader.i ]
  %.0123152.i = phi ptr [ %i.cl, %.lr.ph156.i ], [ %.0121260, %.lr.ph156.preheader.i ] ; 3 uses
  %.0125151.i = phi ptr [ %i.cm, %.lr.ph156.i ], [ %.0126258, %.lr.ph156.preheader.i ] ; 3 uses
  %.0130.in150.i = phi i32 [ %.0130.i, %.lr.ph156.i ], [ %i.o, %.lr.ph156.preheader.i ] ; 2 uses
  %.0130.i = add nsw i32 %.0130.in150.i, -3
  %i.cl = getelementptr inbounds nuw i8, ptr %.0123152.i, i64 6 ; 2 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %.0125151.i, i64 12 ; 2 uses
  %i.cn = load i16, ptr %i.cl, align 2, !tbaa !59
  %i.co = zext i16 %i.cn to i32
  %i.cp = add i32 %.0121153.i, %i.co              ; 2 uses
  ...
  %i.cu = getelementptr inbounds nuw i8, ptr %.0123152.i, i64 8
  %i.cv = load i16, ptr %i.cu, align 2, !tbaa !59
  %i.cw = zext i16 %i.cv to i32
  %i.cx = add i32 %.0119154.i, %i.cw              ; 2 uses
  ...
  %i.dc = getelementptr inbounds nuw i8, ptr %.0123152.i, i64 10
  %i.dd = load i16, ptr %i.dc, align 2, !tbaa !59
  %i.de = zext i16 %i.dd to i32
  %i.df = add i32 %.0118155.i, %i.de              ; 2 uses
  ...
  %i.dk = getelementptr inbounds nuw i8, ptr %.0125151.i, i64 16
  store float %i.db, ptr %i.dk, align 4, !tbaa !52
  %i.dl = getelementptr inbounds nuw i8, ptr %.0125151.i, i64 20
  store float %i.dj, ptr %i.dl, align 4, !tbaa !52
  %i.dm = icmp samesign ugt i32 %.0130.in150.i, 6
  br i1 %i.dm, label %.lr.ph156.i, label %horizontalAccumulateF.exit

bb.v:                                             ; preds = %bb.t
  %i.dn = load <4 x i16>, ptr %.0121260, align 2, !tbaa !59
  ...
  store float %i.ds, ptr %.0126258, align 4, !tbaa !52
  %i.ef = getelementptr inbounds nuw i8, ptr %.0126258, i64 4
  store float %i.dw, ptr %i.ef, align 4, !tbaa !52
  %i.eg = getelementptr inbounds nuw i8, ptr %.0126258, i64 8
  store float %i.ea, ptr %i.eg, align 4, !tbaa !52
  %i.eh = getelementptr inbounds nuw i8, ptr %.0126258, i64 12
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.preheader.i
  %.1124145.i = phi ptr [ %i.ek, %.lr.ph.i ], [ %.0121260, %.lr.ph.preheader.i ]
  %.1126144.i = phi ptr [ %i.el, %.lr.ph.i ], [ %.0126258, %.lr.ph.preheader.i ] ; 4 uses
  %.1131.in143.i = phi i32 [ %.1131.i, %.lr.ph.i ], [ %i.o, %.lr.ph.preheader.i ] ; 2 uses
  %i.ej = phi <4 x i32> [ %i.eo, %.lr.ph.i ], [ %i.ei, %.lr.ph.preheader.i ]
  %.1131.i = add nsw i32 %.1131.in143.i, -4
  %i.ek = getelementptr inbounds nuw i8, ptr %.1124145.i, i64 8 ; 2 uses
  %i.el = getelementptr inbounds nuw i8, ptr %.1126144.i, i64 16 ; 2 uses
  %i.em = load <4 x i16>, ptr %i.ek, align 2, !tbaa !59
  %i.en = zext <4 x i16> %i.em to <4 x i32>
  %i.eo = add <4 x i32> %i.ej, %i.en              ; 4 uses
  %4 = shufflevector <4 x i32> %i.eo, <4 x i32> poison, <2 x i32> <i32 0, i32 1>
  %5 = and <2 x i32> %4, splat (i32 2047)         ; 2 uses
  %6 = extractelement <2 x i32> %5, i64 0
  %i.ep = zext nneg i32 %6 to i64
  %i.eq = getelementptr inbounds nuw [4 x i8], ptr %i.bo, i64 %i.ep
  %i.er = load float, ptr %i.eq, align 4, !tbaa !52
  %i.es = extractelement <2 x i32> %5, i64 1
  ...
  %i.fg = getelementptr inbounds nuw i8, ptr %.1126144.i, i64 20
  store float %i.ev, ptr %i.fg, align 4, !tbaa !52
  %i.fh = getelementptr inbounds nuw i8, ptr %.1126144.i, i64 24
  store float %i.fa, ptr %i.fh, align 4, !tbaa !52
  %i.fi = getelementptr inbounds nuw i8, ptr %.1126144.i, i64 28
  store float %i.ff, ptr %i.fi, align 4, !tbaa !52
  %i.fj = icmp samesign ugt i32 %.1131.in143.i, 8
  br i1 %i.fj, label %.lr.ph.i, label %horizontalAccumulateF.exit

.preheader137.i:                                  ; preds = %bb.t, %.preheader137.i
  %.2127.i = phi ptr [ %i.fr, %.preheader137.i ], [ %.0126258, %bb.t ] ; 2 uses
  %.2.i = phi ptr [ %i.fq, %.preheader137.i ], [ %.0121260, %bb.t ] ; 2 uses
  ...
  store float %i.fp, ptr %.2127.i, align 4, !tbaa !52
  %i.fq = getelementptr inbounds nuw i8, ptr %.2.i, i64 2 ; 2 uses
  %i.fr = getelementptr inbounds nuw i8, ptr %.2127.i, i64 4 ; 2 uses
...
.preheader135.i:                                  ; preds = %.preheader137.i
  %.2132157.i = sub nsw i32 %i.o, %i.bn           ; 2 uses
  %i.ft = icmp sgt i32 %.2132157.i, 0
...
.loopexit.i:                                      ; preds = %bb.w
  %.2132.i = sub nsw i32 %.2132160.i, %i.bn       ; 2 uses
  %i.fv = icmp sgt i32 %.2132.i, 0
  br i1 %i.fv, label %.preheader.i, label %horizontalAccumulateF.exit

.preheader.i:                                     ; preds = %.loopexit.i, %.preheader.lr.ph.i
  %.2132160.i = phi i32 [ %.2132157.i, %.preheader.lr.ph.i ], [ %.2132.i, %.loopexit.i ]
  %.3159.i = phi ptr [ %i.fq, %.preheader.lr.ph.i ], [ %i.gg, %.loopexit.i ]
  %.3128158.i = phi ptr [ %i.fr, %.preheader.lr.ph.i ], [ %i.gh, %.loopexit.i ]
  br label %bb.w

bb.w:                                             ; preds = %bb.w, %.preheader.i
  %.4129.i = phi ptr [ %i.gh, %bb.w ], [ %.3128158.i, %.preheader.i ] ; 2 uses
  ...
  store float %i.gf, ptr %.4129.i, align 4, !tbaa !52
  %i.gg = getelementptr inbounds nuw i8, ptr %.4.i, i64 2 ; 2 uses
  %i.gh = getelementptr inbounds nuw i8, ptr %.4129.i, i64 4 ; 2 uses
...
bb.z:                                             ; preds = %bb.y
  %i.gm = load i16, ptr %.0121260, align 2, !tbaa !59
  ...
  store i16 %i.gq, ptr %.0126258, align 2, !tbaa !59
  %i.gr = getelementptr inbounds nuw i8, ptr %.0121260, i64 2
  ...
  %i.gx = getelementptr inbounds nuw i8, ptr %.0126258, i64 2
  store i16 %i.gw, ptr %i.gx, align 2, !tbaa !59
  %i.gy = getelementptr inbounds nuw i8, ptr %.0121260, i64 4
  ...
  %i.he = getelementptr inbounds nuw i8, ptr %.0126258, i64 4
...
.lr.ph142.i:                                      ; preds = %.lr.ph142.i, %.lr.ph142.preheader.i
  %.0104141.i = phi i32 [ %i.id, %.lr.ph142.i ], [ %i.hf, %.lr.ph142.preheader.i ]
  %.0105140.i = phi i32 [ %i.hu, %.lr.ph142.i ], [ %i.hg, %.lr.ph142.preheader.i ]
  %.0107139.i = phi i32 [ %i.hm, %.lr.ph142.i ], [ %i.hh, %.lr.ph142.preheader.i ]
  %.0109138.i = phi ptr [ %i.hi, %.lr.ph142.i ], [ %.0121260, %.lr.ph142.preheader.i ] ; 3 uses
  %.0111137.i = phi ptr [ %i.hj, %.lr.ph142.i ], [ %.0126258, %.lr.ph142.preheader.i ] ; 3 uses
  %.0116.in136.i = phi i32 [ %.0116.i145, %.lr.ph142.i ], [ %i.o, %.lr.ph142.preheader.i ] ; 2 uses
  %.0116.i145 = add nsw i32 %.0116.in136.i, -3
  %i.hi = getelementptr inbounds nuw i8, ptr %.0109138.i, i64 6 ; 2 uses
  %i.hj = getelementptr inbounds nuw i8, ptr %.0111137.i, i64 6 ; 2 uses
  %i.hk = load i16, ptr %i.hi, align 2, !tbaa !59
  %i.hl = zext i16 %i.hk to i32
  %i.hm = add i32 %.0107139.i, %i.hl              ; 2 uses
  ...
  %i.hr = getelementptr inbounds nuw i8, ptr %.0109138.i, i64 8
  %i.hs = load i16, ptr %i.hr, align 2, !tbaa !59
  %i.ht = zext i16 %i.hs to i32
  %i.hu = add i32 %.0105140.i, %i.ht              ; 2 uses
  ...
  %i.hz = getelementptr inbounds nuw i8, ptr %.0111137.i, i64 8
  store i16 %i.hy, ptr %i.hz, align 2, !tbaa !59
  %i.ia = getelementptr inbounds nuw i8, ptr %.0109138.i, i64 10
  %i.ib = load i16, ptr %i.ia, align 2, !tbaa !59
  %i.ic = zext i16 %i.ib to i32
  %i.id = add i32 %.0104141.i, %i.ic              ; 2 uses
  ...
  %i.ii = getelementptr inbounds nuw i8, ptr %.0111137.i, i64 10
  store i16 %i.ih, ptr %i.ii, align 2, !tbaa !59
  %i.ij = icmp samesign ugt i32 %.0116.in136.i, 6
  br i1 %i.ij, label %.lr.ph142.i, label %horizontalAccumulateF.exit

bb.aa:                                            ; preds = %bb.y
  %i.ik = load i16, ptr %.0121260, align 2, !tbaa !59
  ...
  store i16 %i.io, ptr %.0126258, align 2, !tbaa !59
  %i.ip = getelementptr inbounds nuw i8, ptr %.0121260, i64 2
  ...
  %i.iv = getelementptr inbounds nuw i8, ptr %.0126258, i64 2
  store i16 %i.iu, ptr %i.iv, align 2, !tbaa !59
  %i.iw = getelementptr inbounds nuw i8, ptr %.0121260, i64 4
  ...
  %i.jc = getelementptr inbounds nuw i8, ptr %.0126258, i64 4
  store i16 %i.jb, ptr %i.jc, align 2, !tbaa !59
  %i.jd = getelementptr inbounds nuw i8, ptr %.0121260, i64 6
  ...
  %i.jj = getelementptr inbounds nuw i8, ptr %.0126258, i64 6
...
begin_hunk_1_@PixarLogDecode:bb.a
  %.2.i146 = phi ptr [ %i.lf, %.preheader123.i ], [ %.0121260, %bb.y ] ; 2 uses
  %.0102.i = phi i32 [ %i.kz, %.preheader123.i ], [ %i.gk, %bb.y ] ; 2 uses
  %i.kz = add nsw i32 %.0102.i, -1
  %i.la = load i16, ptr %.2.i146, align 2, !tbaa !59
  ...
  store i16 %i.le, ptr %.2113.i, align 2, !tbaa !59
  %i.lf = getelementptr inbounds nuw i8, ptr %.2.i146, i64 2 ; 2 uses
  %i.lg = getelementptr inbounds nuw i8, ptr %.2113.i, i64 2 ; 2 uses
...
.preheader121.i:                                  ; preds = %.preheader123.i
  %.2118143.i = sub nsw i32 %i.o, %i.gk           ; 2 uses
  %i.li = icmp sgt i32 %.2118143.i, 0
  br i1 %i.li, label %.preheader.lr.ph.i147, label %horizontalAccumulateF.exit

.preheader.lr.ph.i147:                            ; preds = %.preheader121.i
  %i.lj = zext i16 %i.gj to i64
  br label %.preheader.i148

.loopexit.i151:                                   ; preds = %bb.ab
  %.2118.i = sub nsw i32 %.2118146.i, %i.gk       ; 2 uses
  %i.lk = icmp sgt i32 %.2118.i, 0
  br i1 %i.lk, label %.preheader.i148, label %horizontalAccumulateF.exit

.preheader.i148:                                  ; preds = %.loopexit.i151, %.preheader.lr.ph.i147
  %.2118146.i = phi i32 [ %.2118143.i, %.preheader.lr.ph.i147 ], [ %.2118.i, %.loopexit.i151 ]
  %.3145.i = phi ptr [ %i.lf, %.preheader.lr.ph.i147 ], [ %i.lv, %.loopexit.i151 ]
  %.3114144.i = phi ptr [ %i.lg, %.preheader.lr.ph.i147 ], [ %i.lw, %.loopexit.i151 ]
  br label %bb.ab

bb.ab:                                            ; preds = %bb.ab, %.preheader.i148
  %.4115.i = phi ptr [ %i.lw, %bb.ab ], [ %.3114144.i, %.preheader.i148 ] ; 2 uses
  %.4.i149 = phi ptr [ %i.lv, %bb.ab ], [ %.3145.i, %.preheader.i148 ] ; 4 uses
  %.0.i150 = phi i32 [ %i.ll, %bb.ab ], [ %i.gk, %.preheader.i148 ] ; 2 uses
  %i.ll = add nsw i32 %.0.i150, -1
  %i.lm = load i16, ptr %.4.i149, align 2, !tbaa !59
  %i.ln = getelementptr inbounds nuw [2 x i8], ptr %.4.i149, i64 %i.lj ; 2 uses
  %i.lo = load i16, ptr %i.ln, align 2, !tbaa !59
  %i.lp = add i16 %i.lo, %i.lm
  store i16 %i.lp, ptr %i.ln, align 2, !tbaa !59
  %i.lq = load i16, ptr %.4.i149, align 2, !tbaa !59
  ...
  store i16 %i.lu, ptr %.4115.i, align 2, !tbaa !59
  %i.lv = getelementptr inbounds nuw i8, ptr %.4.i149, i64 2 ; 2 uses
  %i.lw = getelementptr inbounds nuw i8, ptr %.4115.i, i64 2 ; 2 uses
  %i.lx = icmp sgt i32 %.0.i150, 1
  br i1 %i.lx, label %bb.ab, label %.loopexit.i151
...
bb.ac:                                            ; preds = %bb.r
  ...
  %.not.i152 = icmp slt i32 %i.o, %i.lz
  br i1 %.not.i152, label %horizontalAccumulateF.exit, label %bb.ad
...
bb.ae:                                            ; preds = %bb.ad
  %i.mb = load i16, ptr %.0121260, align 2, !tbaa !59
  ...
  %i.mg = getelementptr inbounds nuw i8, ptr %.0121260, i64 2
  ...
  %i.mm = getelementptr inbounds nuw i8, ptr %.0121260, i64 4
...
.lr.ph175.i:                                      ; preds = %.lr.ph175.i, %.lr.ph175.preheader.i
  %.0137174.i = phi i32 [ %i.oa, %.lr.ph175.i ], [ %i.nd, %.lr.ph175.preheader.i ]
  %.0138173.i = phi i32 [ %i.ns, %.lr.ph175.i ], [ %i.ne, %.lr.ph175.preheader.i ]
  %.0140172.i = phi i32 [ %i.nk, %.lr.ph175.i ], [ %i.nf, %.lr.ph175.preheader.i ]
  %.0142171.i = phi ptr [ %i.ng, %.lr.ph175.i ], [ %.0121260, %.lr.ph175.preheader.i ] ; 3 uses
  %.0144170.i = phi ptr [ %i.nh, %.lr.ph175.i ], [ %.0126258, %.lr.ph175.preheader.i ] ; 2 uses
  %.0149.in169.i = phi i32 [ %.0149.i, %.lr.ph175.i ], [ %i.o, %.lr.ph175.preheader.i ] ; 2 uses
  %.0149.i = add nsw i32 %.0149.in169.i, -3
  %i.ng = getelementptr inbounds nuw i8, ptr %.0142171.i, i64 6 ; 2 uses
  %i.nh = getelementptr inbounds nuw i8, ptr %.0144170.i, i64 6 ; 2 uses
  ...
  %i.np = getelementptr inbounds nuw i8, ptr %.0142171.i, i64 8
  ...
  %i.nx = getelementptr inbounds nuw i8, ptr %.0142171.i, i64 10
  %i.ny = load i16, ptr %i.nx, align 2, !tbaa !59
  %i.nz = zext i16 %i.ny to i32
  %i.oa = add i32 %.0137174.i, %i.nz              ; 2 uses
  ...
  %i.op = getelementptr inbounds nuw i8, ptr %.0144170.i, i64 10
  store i16 %i.oo, ptr %i.op, align 2, !tbaa !59
  %i.oq = icmp samesign ugt i32 %.0149.in169.i, 6
  br i1 %i.oq, label %.lr.ph175.i, label %horizontalAccumulateF.exit

bb.af:                                            ; preds = %bb.ad
  %i.or = load <4 x i16>, ptr %.0121260, align 2, !tbaa !59
  ...
  store <4 x i16> %i.pq, ptr %.0126258, align 2, !tbaa !59
  br i1 %i.bc, label %.lr.ph.preheader.i153, label %horizontalAccumulateF.exit

.lr.ph.preheader.i153:                            ; preds = %bb.af
  %i.pr = zext nneg <4 x i16> %i.os to <4 x i32>
  br label %.lr.ph.i154

.lr.ph.i154:                                      ; preds = %.lr.ph.i154, %.lr.ph.preheader.i153
  %.1143164.i = phi ptr [ %i.pt, %.lr.ph.i154 ], [ %.0121260, %.lr.ph.preheader.i153 ]
  %.1145163.i = phi ptr [ %i.pu, %.lr.ph.i154 ], [ %.0126258, %.lr.ph.preheader.i153 ]
  %.1150.in162.i = phi i32 [ %.1150.i, %.lr.ph.i154 ], [ %i.o, %.lr.ph.preheader.i153 ] ; 2 uses
  %i.ps = phi <4 x i32> [ %i.px, %.lr.ph.i154 ], [ %i.pr, %.lr.ph.preheader.i153 ]
  %.1150.i = add nsw i32 %.1150.in162.i, -4
  %i.pt = getelementptr inbounds nuw i8, ptr %.1143164.i, i64 8 ; 2 uses
  %i.pu = getelementptr inbounds nuw i8, ptr %.1145163.i, i64 8 ; 2 uses
  %i.pv = load <4 x i16>, ptr %i.pt, align 2, !tbaa !59
  %i.pw = zext <4 x i16> %i.pv to <4 x i32>
  %i.px = add <4 x i32> %i.ps, %i.pw              ; 4 uses
  %7 = shufflevector <4 x i32> %i.px, <4 x i32> poison, <2 x i32> <i32 0, i32 1>
  %8 = and <2 x i32> %7, splat (i32 2047)         ; 2 uses
  %9 = extractelement <2 x i32> %8, i64 0
  %i.py = zext nneg i32 %9 to i64
  %i.pz = getelementptr inbounds nuw [4 x i8], ptr %i.ma, i64 %i.py
  %i.qa = load float, ptr %i.pz, align 4, !tbaa !52
  %i.qb = extractelement <2 x i32> %8, i64 1
  ...
  %i.qx = icmp samesign ugt i32 %.1150.in162.i, 8
  br i1 %i.qx, label %.lr.ph.i154, label %horizontalAccumulateF.exit

.preheader156.i:                                  ; preds = %bb.ad, %.preheader156.i
  %.2146.i = phi ptr [ %i.rj, %.preheader156.i ], [ %.0126258, %bb.ad ] ; 2 uses
  %.2.i155 = phi ptr [ %i.ri, %.preheader156.i ], [ %.0121260, %bb.ad ] ; 2 uses
  %.0135.i = phi i32 [ %i.qy, %.preheader156.i ], [ %i.lz, %bb.ad ] ; 2 uses
  %i.qy = add nsw i32 %.0135.i, -1
  %i.qz = load i16, ptr %.2.i155, align 2, !tbaa !59
  ...
  store i16 %i.rh, ptr %.2146.i, align 2, !tbaa !59
  %i.ri = getelementptr inbounds nuw i8, ptr %.2.i155, i64 2 ; 2 uses
  %i.rj = getelementptr inbounds nuw i8, ptr %.2146.i, i64 2 ; 2 uses
...
.preheader154.i:                                  ; preds = %.preheader156.i
  %.2151176.i = sub nsw i32 %i.o, %i.lz           ; 2 uses
  %i.rl = icmp sgt i32 %.2151176.i, 0
  br i1 %i.rl, label %.preheader.lr.ph.i156, label %horizontalAccumulateF.exit

.preheader.lr.ph.i156:                            ; preds = %.preheader154.i
  %i.rm = zext i16 %i.ly to i64
  br label %.preheader.i157

.loopexit.i160:                                   ; preds = %bb.ag
  %.2151.i = sub nsw i32 %.2151179.i, %i.lz       ; 2 uses
  %i.rn = icmp sgt i32 %.2151.i, 0
  br i1 %i.rn, label %.preheader.i157, label %horizontalAccumulateF.exit

.preheader.i157:                                  ; preds = %.loopexit.i160, %.preheader.lr.ph.i156
  %.2151179.i = phi i32 [ %.2151176.i, %.preheader.lr.ph.i156 ], [ %.2151.i, %.loopexit.i160 ]
  %.3178.i = phi ptr [ %i.ri, %.preheader.lr.ph.i156 ], [ %i.sb, %.loopexit.i160 ]
  %.3147177.i = phi ptr [ %i.rj, %.preheader.lr.ph.i156 ], [ %i.sc, %.loopexit.i160 ]
  br label %bb.ag

bb.ag:                                            ; preds = %bb.ag, %.preheader.i157
  %.4148.i = phi ptr [ %i.sc, %bb.ag ], [ %.3147177.i, %.preheader.i157 ] ; 2 uses
  %.4.i158 = phi ptr [ %i.sb, %bb.ag ], [ %.3178.i, %.preheader.i157 ] ; 3 uses
  %.0.i159 = phi i32 [ %i.ro, %bb.ag ], [ %i.lz, %.preheader.i157 ] ; 2 uses
  %i.ro = add nsw i32 %.0.i159, -1
  %i.rp = load i16, ptr %.4.i158, align 2, !tbaa !59
  %i.rq = getelementptr inbounds nuw [2 x i8], ptr %.4.i158, i64 %i.rm ; 2 uses
  ...
  store i16 %i.sa, ptr %.4148.i, align 2, !tbaa !59
  %i.sb = getelementptr inbounds nuw i8, ptr %.4.i158, i64 2 ; 2 uses
  %i.sc = getelementptr inbounds nuw i8, ptr %.4148.i, i64 2 ; 2 uses
  %i.sd = icmp sgt i32 %.0.i159, 1
  br i1 %i.sd, label %bb.ag, label %.loopexit.i160

bb.ah:                                            ; preds = %bb.r
  %i.se = load i16, ptr %i.j, align 8, !tbaa !79  ; 4 uses
  %i.sf = zext i16 %i.se to i32                   ; 15 uses
  %.not.i161 = icmp slt i32 %i.o, %i.sf
  br i1 %.not.i161, label %horizontalAccumulateF.exit, label %bb.ai
...
iter.check:                                       ; preds = %bb.ai
  ...
  %min.iters.check405 = icmp ult i32 %i.sh, 3
  br i1 %min.iters.check405, label %.preheader107.i.preheader, label %vector.memcheck402

vector.memcheck402:                               ; preds = %iter.check
  %i.sk = add i64 %i.bk, %.0126258403
  %i.sl = add i64 %i.sk, -1
  %diff.check = icmp ult i64 %i.sl, 31
  br i1 %diff.check, label %.preheader107.i.preheader, label %vector.main.loop.iter.check

vector.main.loop.iter.check:                      ; preds = %vector.memcheck402
  %min.iters.check406 = icmp ult i32 %i.sh, 15
  br i1 %min.iters.check406, label %vec.epilog.ph, label %vector.ph407

vector.ph407:                                     ; preds = %vector.main.loop.iter.check
  %i.sm = and i64 %i.sj, 12
  %n.vec408 = and i64 %i.sj, 8589934576           ; 5 uses
  %i.sn = shl nuw nsw i64 %n.vec408, 1            ; 2 uses
  %i.so = getelementptr i8, ptr %.0121260, i64 %i.sn ; 2 uses
  %i.sp = getelementptr i8, ptr %.0126258, i64 %i.sn ; 2 uses
  %i.sq = trunc i64 %n.vec408 to i32
...
vector.body409:                                   ; preds = %vector.body409, %vector.ph407
  ...
  %i.ss = shl i64 %index410, 1                    ; 2 uses
  %next.gep411 = getelementptr i8, ptr %.0121260, i64 %i.ss ; 2 uses
  %next.gep412 = getelementptr i8, ptr %.0126258, i64 %i.ss ; 2 uses
  %i.st = getelementptr i8, ptr %next.gep411, i64 16
  %wide.load413 = load <8 x i16>, ptr %next.gep411, align 2, !tbaa !59
  %wide.load414 = load <8 x i16>, ptr %i.st, align 2, !tbaa !59
  %i.su = and <8 x i16> %wide.load413, splat (i16 2047)
  %i.sv = and <8 x i16> %wide.load414, splat (i16 2047)
  %i.sw = getelementptr i8, ptr %next.gep412, i64 16
  store <8 x i16> %i.su, ptr %next.gep412, align 2, !tbaa !59
  store <8 x i16> %i.sv, ptr %i.sw, align 2, !tbaa !59
  %index.next415 = add nuw i64 %index410, 16      ; 2 uses
  %i.sx = icmp eq i64 %index.next415, %n.vec408
  br i1 %i.sx, label %middle.block416, label %vector.body409, !llvm.loop !95

middle.block416:                                  ; preds = %vector.body409
  %cmp.n417 = icmp eq i64 %i.sj, %n.vec408
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %n.vec421 = and i64 %i.sj, 8589934588           ; 4 uses
  %i.sy = shl nuw nsw i64 %n.vec421, 1            ; 2 uses
  %i.sz = getelementptr i8, ptr %.0121260, i64 %i.sy ; 2 uses
  %i.ta = getelementptr i8, ptr %.0126258, i64 %i.sy ; 2 uses
  %i.tb = trunc i64 %n.vec421 to i32
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %i.td = shl i64 %index422, 1                    ; 2 uses
  %next.gep423 = getelementptr i8, ptr %.0121260, i64 %i.td
  %next.gep424 = getelementptr i8, ptr %.0126258, i64 %i.td
  %wide.load425 = load <4 x i16>, ptr %next.gep423, align 2, !tbaa !59
  %i.te = and <4 x i16> %wide.load425, splat (i16 2047)
  store <4 x i16> %i.te, ptr %next.gep424, align 2, !tbaa !59
  %index.next426 = add nuw i64 %index422, 4       ; 2 uses
  %i.tf = icmp eq i64 %index.next426, %n.vec421
  br i1 %i.tf, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !97

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n427 = icmp eq i64 %i.sj, %n.vec421
  br i1 %cmp.n427, label %.preheader105.i, label %.preheader107.i.preheader

.preheader107.i.preheader:                        ; preds = %vector.memcheck402, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.297.i.ph = phi ptr [ %.0121260, %iter.check ], [ %.0121260, %vector.memcheck402 ], [ %i.so, %vec.epilog.iter.check ], [ %i.sz, %vec.epilog.middle.block ]
  %.2.i164.ph = phi ptr [ %.0126258, %iter.check ], [ %.0126258, %vector.memcheck402 ], [ %i.sp, %vec.epilog.iter.check ], [ %i.ta, %vec.epilog.middle.block ]
  %.086.i.ph = phi i32 [ %i.sf, %iter.check ], [ %i.sf, %vector.memcheck402 ], [ %i.sr, %vec.epilog.iter.check ], [ %i.tc, %vec.epilog.middle.block ]
  br label %.preheader107.i

bb.aj:                                            ; preds = %bb.ai
  %i.tg = load i16, ptr %.0121260, align 2, !tbaa !59
  store i16 %i.tg, ptr %.0126258, align 2, !tbaa !59
  %i.th = getelementptr inbounds nuw i8, ptr %.0121260, i64 2 ; 2 uses
  %i.ti = load i16, ptr %i.th, align 2, !tbaa !59
  %i.tj = getelementptr inbounds nuw i8, ptr %.0126258, i64 2
  store i16 %i.ti, ptr %i.tj, align 2, !tbaa !59
  %i.tk = getelementptr inbounds nuw i8, ptr %.0121260, i64 4
  %i.tl = load i16, ptr %i.tk, align 2, !tbaa !59 ; 2 uses
  %i.tm = getelementptr inbounds nuw i8, ptr %.0126258, i64 4
...
begin_hunk_2_@PixarLogDecode:bb.a
  ...
  %i.abh = add i32 %.0103135.i173, %i.abg         ; 2 uses
  ...
  %i.abm = getelementptr inbounds nuw i8, ptr %.1112130.i178, i64 7
  store i8 %i.abl, ptr %i.abm, align 1, !tbaa !64
  %i.abn = icmp samesign ugt i32 %.1117.in129.i179, 8
  br i1 %i.abn, label %.lr.ph.i172, label %horizontalAccumulateF.exit

.preheader123.i190:                               ; preds = %bb.am, %.preheader123.i190
  %.2113.i191 = phi ptr [ %i.abv, %.preheader123.i190 ], [ %.0126258, %bb.am ] ; 2 uses
  %.2.i192 = phi ptr [ %i.abu, %.preheader123.i190 ], [ %.0121260, %bb.am ] ; 2 uses
  %.0102.i193 = phi i32 [ %i.abo, %.preheader123.i190 ], [ %i.wz, %bb.am ] ; 2 uses
  %i.abo = add nsw i32 %.0102.i193, -1
  %i.abp = load i16, ptr %.2.i192, align 2, !tbaa !59
  ...
  store i8 %i.abt, ptr %.2113.i191, align 1, !tbaa !64
  %i.abu = getelementptr inbounds nuw i8, ptr %.2.i192, i64 2 ; 2 uses
  %i.abv = getelementptr inbounds nuw i8, ptr %.2113.i191, i64 1 ; 2 uses
  %i.abw = icmp samesign ugt i32 %.0102.i193, 1
  br i1 %i.abw, label %.preheader123.i190, label %.preheader121.i194

.preheader121.i194:                               ; preds = %.preheader123.i190
  %.2118143.i195 = sub nsw i32 %i.o, %i.wz        ; 2 uses
  %i.abx = icmp sgt i32 %.2118143.i195, 0
  br i1 %i.abx, label %.preheader.lr.ph.i196, label %horizontalAccumulateF.exit

.preheader.lr.ph.i196:                            ; preds = %.preheader121.i194
  %i.aby = zext i16 %i.wy to i64
  br label %.preheader.i197

.loopexit.i204:                                   ; preds = %bb.ap
  %.2118.i205 = sub nsw i32 %.2118146.i198, %i.wz ; 2 uses
  %i.abz = icmp sgt i32 %.2118.i205, 0
  br i1 %i.abz, label %.preheader.i197, label %horizontalAccumulateF.exit

.preheader.i197:                                  ; preds = %.loopexit.i204, %.preheader.lr.ph.i196
  %.2118146.i198 = phi i32 [ %.2118143.i195, %.preheader.lr.ph.i196 ], [ %.2118.i205, %.loopexit.i204 ]
  %.3145.i199 = phi ptr [ %i.abu, %.preheader.lr.ph.i196 ], [ %i.ack, %.loopexit.i204 ]
  %.3114144.i200 = phi ptr [ %i.abv, %.preheader.lr.ph.i196 ], [ %i.acl, %.loopexit.i204 ]
  br label %bb.ap

bb.ap:                                            ; preds = %bb.ap, %.preheader.i197
  %.4115.i201 = phi ptr [ %i.acl, %bb.ap ], [ %.3114144.i200, %.preheader.i197 ] ; 2 uses
  %.4.i202 = phi ptr [ %i.ack, %bb.ap ], [ %.3145.i199, %.preheader.i197 ] ; 4 uses
  %.0.i203 = phi i32 [ %i.aca, %bb.ap ], [ %i.wz, %.preheader.i197 ] ; 2 uses
  %i.aca = add nsw i32 %.0.i203, -1
  %i.acb = load i16, ptr %.4.i202, align 2, !tbaa !59
  %i.acc = getelementptr inbounds nuw [2 x i8], ptr %.4.i202, i64 %i.aby ; 2 uses
  %i.acd = load i16, ptr %i.acc, align 2, !tbaa !59
  %i.ace = add i16 %i.acd, %i.acb
  store i16 %i.ace, ptr %i.acc, align 2, !tbaa !59
  %i.acf = load i16, ptr %.4.i202, align 2, !tbaa !59
  ...
  store i8 %i.acj, ptr %.4115.i201, align 1, !tbaa !64
  %i.ack = getelementptr inbounds nuw i8, ptr %.4.i202, i64 2 ; 2 uses
  %i.acl = getelementptr inbounds nuw i8, ptr %.4115.i201, i64 1 ; 2 uses
  %i.acm = icmp sgt i32 %.0.i203, 1
  br i1 %i.acm, label %bb.ap, label %.loopexit.i204
...
bb.aq:                                            ; preds = %bb.r
  ...
  %.not.i206 = icmp slt i32 %i.o, %i.aco
  br i1 %.not.i206, label %horizontalAccumulateF.exit, label %bb.ar
...
bb.as:                                            ; preds = %bb.ar
  store i8 0, ptr %.0126258, align 1, !tbaa !64
  %i.acq = getelementptr inbounds nuw i8, ptr %.0121260, i64 4
  ...
  %i.acw = getelementptr inbounds nuw i8, ptr %.0121260, i64 2
  ...
  %i.adc = load i16, ptr %.0121260, align 2, !tbaa !59
  ...
  %i.adh = getelementptr inbounds nuw i8, ptr %.0126258, i64 1
  store i8 %i.acv, ptr %i.adh, align 1, !tbaa !64
  %i.adi = getelementptr inbounds nuw i8, ptr %.0126258, i64 2
  store i8 %i.adb, ptr %i.adi, align 1, !tbaa !64
  %i.adj = getelementptr inbounds nuw i8, ptr %.0126258, i64 3
...
.lr.ph158.i:                                      ; preds = %.lr.ph158.i, %.lr.ph158.preheader.i
  %.0120157.i = phi i32 [ %i.ads, %.lr.ph158.i ], [ %i.adm, %.lr.ph158.preheader.i ]
  %.0121156.i = phi i32 [ %i.aea, %.lr.ph158.i ], [ %i.adl, %.lr.ph158.preheader.i ]
  %.0123155.i = phi i32 [ %i.aeh, %.lr.ph158.i ], [ %i.adk, %.lr.ph158.preheader.i ]
  %.0125154.i = phi ptr [ %i.adn, %.lr.ph158.i ], [ %.0121260, %.lr.ph158.preheader.i ] ; 3 uses
  %.0127153.i = phi ptr [ %i.ado, %.lr.ph158.i ], [ %.0126258, %.lr.ph158.preheader.i ] ; 4 uses
  %.0132.in152.i = phi i32 [ %.0132.i, %.lr.ph158.i ], [ %i.o, %.lr.ph158.preheader.i ] ; 2 uses
  %.0132.i = add nsw i32 %.0132.in152.i, -3
  %i.adn = getelementptr inbounds nuw i8, ptr %.0125154.i, i64 6 ; 2 uses
  %i.ado = getelementptr inbounds nuw i8, ptr %.0127153.i, i64 4 ; 2 uses
  store i8 0, ptr %i.ado, align 1, !tbaa !64
  %i.adp = getelementptr inbounds nuw i8, ptr %.0125154.i, i64 10
  %i.adq = load i16, ptr %i.adp, align 2, !tbaa !59
  %i.adr = zext i16 %i.adq to i32
  %i.ads = add i32 %.0120157.i, %i.adr            ; 2 uses
  ...
  %i.adx = getelementptr inbounds nuw i8, ptr %.0125154.i, i64 8
  %i.ady = load i16, ptr %i.adx, align 2, !tbaa !59
  %i.adz = zext i16 %i.ady to i32
  %i.aea = add i32 %.0121156.i, %i.adz            ; 2 uses
  ...
  %i.aeh = add i32 %.0123155.i, %i.aeg            ; 2 uses
  ...
  %i.aem = getelementptr inbounds nuw i8, ptr %.0127153.i, i64 5
  store i8 %i.adw, ptr %i.aem, align 1, !tbaa !64
  %i.aen = getelementptr inbounds nuw i8, ptr %.0127153.i, i64 6
  store i8 %i.aee, ptr %i.aen, align 1, !tbaa !64
  %i.aeo = getelementptr inbounds nuw i8, ptr %.0127153.i, i64 7
  store i8 %i.ael, ptr %i.aeo, align 1, !tbaa !64
  %i.aep = icmp samesign ugt i32 %.0132.in152.i, 6
  br i1 %i.aep, label %.lr.ph158.i, label %horizontalAccumulateF.exit

bb.at:                                            ; preds = %bb.ar
  %i.aeq = load <4 x i16>, ptr %.0121260, align 2, !tbaa !59
  ...
  store i8 %i.aev, ptr %.0126258, align 1, !tbaa !64
  %i.afi = getelementptr inbounds nuw i8, ptr %.0126258, i64 1
  store i8 %i.aez, ptr %i.afi, align 1, !tbaa !64
  %i.afj = getelementptr inbounds nuw i8, ptr %.0126258, i64 2
  store i8 %i.afd, ptr %i.afj, align 1, !tbaa !64
  %i.afk = getelementptr inbounds nuw i8, ptr %.0126258, i64 3
  store i8 %i.afh, ptr %i.afk, align 1, !tbaa !64
  br i1 %i.bc, label %.lr.ph.preheader.i207, label %horizontalAccumulateF.exit

.lr.ph.preheader.i207:                            ; preds = %bb.at
  %i.afl = zext nneg <4 x i16> %i.aer to <4 x i32>
  br label %.lr.ph.i208

.lr.ph.i208:                                      ; preds = %.lr.ph.i208, %.lr.ph.preheader.i207
  %.1126147.i = phi ptr [ %i.afn, %.lr.ph.i208 ], [ %.0121260, %.lr.ph.preheader.i207 ]
  %.1128146.i = phi ptr [ %i.afo, %.lr.ph.i208 ], [ %.0126258, %.lr.ph.preheader.i207 ] ; 4 uses
  %.1133.in145.i = phi i32 [ %.1133.i, %.lr.ph.i208 ], [ %i.o, %.lr.ph.preheader.i207 ] ; 2 uses
  %i.afm = phi <4 x i32> [ %i.afr, %.lr.ph.i208 ], [ %i.afl, %.lr.ph.preheader.i207 ]
  %.1133.i = add nsw i32 %.1133.in145.i, -4
  %i.afn = getelementptr inbounds nuw i8, ptr %.1126147.i, i64 8 ; 2 uses
  %i.afo = getelementptr inbounds nuw i8, ptr %.1128146.i, i64 4 ; 2 uses
  %i.afp = load <4 x i16>, ptr %i.afn, align 2, !tbaa !59
  %i.afq = zext <4 x i16> %i.afp to <4 x i32>
  %i.afr = add <4 x i32> %i.afm, %i.afq           ; 4 uses
  %10 = shufflevector <4 x i32> %i.afr, <4 x i32> poison, <2 x i32> <i32 2, i32 3>
  %11 = and <2 x i32> %10, splat (i32 2047)       ; 2 uses
  %12 = extractelement <2 x i32> %11, i64 1
  %i.afs = zext nneg i32 %12 to i64
  %i.aft = getelementptr inbounds nuw i8, ptr %i.acp, i64 %i.afs
  %i.afu = load i8, ptr %i.aft, align 1, !tbaa !64
  %i.afv = extractelement <2 x i32> %11, i64 0
  ...
  %i.agj = getelementptr inbounds nuw i8, ptr %.1128146.i, i64 5
  store i8 %i.afy, ptr %i.agj, align 1, !tbaa !64
  %i.agk = getelementptr inbounds nuw i8, ptr %.1128146.i, i64 6
  store i8 %i.agd, ptr %i.agk, align 1, !tbaa !64
  %i.agl = getelementptr inbounds nuw i8, ptr %.1128146.i, i64 7
  store i8 %i.agi, ptr %i.agl, align 1, !tbaa !64
  %i.agm = icmp samesign ugt i32 %.1133.in145.i, 8
  br i1 %i.agm, label %.lr.ph.i208, label %horizontalAccumulateF.exit

.preheader139.i:                                  ; preds = %bb.ar, %.preheader139.i
  %.2129.i = phi ptr [ %i.agu, %.preheader139.i ], [ %.0126258, %bb.ar ] ; 2 uses
  %.2.i210 = phi ptr [ %i.agt, %.preheader139.i ], [ %.0121260, %bb.ar ] ; 2 uses
  %.0118.i = phi i32 [ %i.agn, %.preheader139.i ], [ %i.aco, %bb.ar ] ; 2 uses
  %i.agn = add nsw i32 %.0118.i, -1
  %i.ago = load i16, ptr %.2.i210, align 2, !tbaa !59
  ...
  store i8 %i.ags, ptr %.2129.i, align 1, !tbaa !64
  %i.agt = getelementptr inbounds nuw i8, ptr %.2.i210, i64 2 ; 2 uses
  %i.agu = getelementptr inbounds nuw i8, ptr %.2129.i, i64 1 ; 2 uses
  %i.agv = icmp samesign ugt i32 %.0118.i, 1
  br i1 %i.agv, label %.preheader139.i, label %.preheader137.i211

.preheader137.i211:                               ; preds = %.preheader139.i
  %.2134159.i = sub nsw i32 %i.o, %i.aco          ; 2 uses
  %i.agw = icmp sgt i32 %.2134159.i, 0
  br i1 %i.agw, label %.preheader.lr.ph.i212, label %horizontalAccumulateF.exit

.preheader.lr.ph.i212:                            ; preds = %.preheader137.i211
  %i.agx = zext i16 %i.acn to i64
  br label %.preheader.i213

.loopexit.i216:                                   ; preds = %bb.au
  %.2134.i = sub nsw i32 %.2134162.i, %i.aco      ; 2 uses
  %i.agy = icmp sgt i32 %.2134.i, 0
  br i1 %i.agy, label %.preheader.i213, label %horizontalAccumulateF.exit

.preheader.i213:                                  ; preds = %.loopexit.i216, %.preheader.lr.ph.i212
  %.2134162.i = phi i32 [ %.2134159.i, %.preheader.lr.ph.i212 ], [ %.2134.i, %.loopexit.i216 ]
  %.3161.i = phi ptr [ %i.agt, %.preheader.lr.ph.i212 ], [ %i.ahj, %.loopexit.i216 ]
  %.3130160.i = phi ptr [ %i.agu, %.preheader.lr.ph.i212 ], [ %i.ahk, %.loopexit.i216 ]
  br label %bb.au

bb.au:                                            ; preds = %bb.au, %.preheader.i213
  %.4131.i = phi ptr [ %i.ahk, %bb.au ], [ %.3130160.i, %.preheader.i213 ] ; 2 uses
  %.4.i214 = phi ptr [ %i.ahj, %bb.au ], [ %.3161.i, %.preheader.i213 ] ; 4 uses
  %.0.i215 = phi i32 [ %i.agz, %bb.au ], [ %i.aco, %.preheader.i213 ] ; 2 uses
  %i.agz = add nsw i32 %.0.i215, -1
  %i.aha = load i16, ptr %.4.i214, align 2, !tbaa !59
  %i.ahb = getelementptr inbounds nuw [2 x i8], ptr %.4.i214, i64 %i.agx ; 2 uses
  %i.ahc = load i16, ptr %i.ahb, align 2, !tbaa !59
  %i.ahd = add i16 %i.ahc, %i.aha
  store i16 %i.ahd, ptr %i.ahb, align 2, !tbaa !59
  %i.ahe = load i16, ptr %.4.i214, align 2, !tbaa !59
  ...
  store i8 %i.ahi, ptr %.4131.i, align 1, !tbaa !64
  %i.ahj = getelementptr inbounds nuw i8, ptr %.4.i214, i64 2 ; 2 uses
  %i.ahk = getelementptr inbounds nuw i8, ptr %.4131.i, i64 1 ; 2 uses
  %i.ahl = icmp sgt i32 %.0.i215, 1
  br i1 %i.ahl, label %bb.au, label %.loopexit.i216
...
horizontalAccumulateF.exit:                       ; preds = %.lr.ph.i208, %.lr.ph158.i, %.loopexit.i216, %.lr.ph.i172, %.lr.ph142.i182, %.loopexit.i204, %.lr.ph.i163, %.lr.ph126.i, %.loopexit.i169, %.lr.ph.i154, %.lr.ph175.i, %.loopexit.i160, %.lr.ph.i144, %.lr.ph142.i, %.loopexit.i151, %.lr.ph.i, %.lr.ph156.i, %.loopexit.i, %.preheader137.i211, %bb.at, %bb.as, %bb.aq, %.preheader121.i194, %bb.ao, %bb.an, %bb.al, %.preheader105.i, %bb.ak, %bb.aj, %bb.ah, %.preheader154.i, %bb.af, %bb.ae, %bb.ac, %.preheader121.i, %bb.aa, %bb.z, %bb.x, %.preheader135.i, %bb.v, %bb.u, %bb.s
  %.sink = phi i64 [ %i.ax, %.preheader121.i194 ], [ %i.bh, %.preheader135.i ], [ %i.be, %.preheader121.i ], [ %i.be, %.preheader154.i ], [ %i.be, %.preheader105.i ], [ %i.ax, %.loopexit.i216 ], [ %i.ax, %.lr.ph.i172 ], [ %i.ax, %.preheader137.i211 ], [ %i.bh, %bb.s ], [ %i.bh, %bb.u ], [ %i.bh, %bb.v ], [ %i.bh, %.lr.ph156.i ], [ %i.bh, %.loopexit.i ], [ %i.ax, %.lr.ph158.i ], [ %i.be, %bb.x ], [ %i.be, %bb.z ], [ %i.be, %bb.aa ], [ %i.be, %.lr.ph142.i ], [ %i.be, %.loopexit.i151 ], [ %i.bh, %.lr.ph.i ], [ %i.be, %bb.ac ], [ %i.be, %bb.ae ], [ %i.be, %bb.af ], [ %i.be, %.lr.ph175.i ], [ %i.be, %.loopexit.i160 ], [ %i.be, %.lr.ph.i144 ], [ %i.be, %bb.ah ], [ %i.be, %bb.aj ], [ %i.be, %bb.ak ], [ %i.be, %.lr.ph126.i ], [ %i.be, %.loopexit.i169 ], [ %i.be, %.lr.ph.i154 ], [ %i.ax, %bb.al ], [ %i.ax, %bb.an ], [ %i.ax, %bb.ao ], [ %i.ax, %.lr.ph142.i182 ], [ %i.ax, %.loopexit.i204 ], [ %i.be, %.lr.ph.i163 ], [ %i.ax, %bb.aq ], [ %i.ax, %bb.as ], [ %i.ax, %bb.at ], [ %i.ax, %.lr.ph.i208 ]
  %i.ahp = getelementptr inbounds nuw i8, ptr %.0126258, i64 %.sink
  %i.ahq = add nsw i64 %.0123259, %i.ax           ; 2 uses
  %i.ahr = getelementptr inbounds [2 x i8], ptr %.0121260, i64 %i.ax
  %i.ahs = icmp slt i64 %i.ahq, %.1
  %indvar.next = add i64 %indvar, 1
  br i1 %i.ahs, label %bb.r, label %.thread

.thread.sink.split:                               ; preds = %bb.d, %bb.f, %bb.h, %bb.m, %bb.av, %bb.i, %bb.j
  %.sink343 = phi ptr [ %1, %bb.j ], [ %1, %bb.i ], [ %.0126258, %bb.av ], [ %1, %bb.m ], [ %1, %bb.h ], [ %1, %bb.f ], [ %1, %bb.d ]
  tail call void @llvm.memset.p0.i64(ptr align 1 %.sink343, i8 0, i64 %2, i1 false)
  br label %.thread
