...
bb.h:                                             ; preds = %bb.g
  ...
  br i1 %i.as, label %.thread58, label %bb.m

bb.i:                                             ; preds = %bb.g
  switch i16 %.val50, label %bb.m [
...
begin_hunk_3
  ...
  br i1 %switch.selectcmp18.i, label %.thread58, label %bb.m
...
bb.m:                                             ; preds = %bb.j, %bb.h, %bb.g, %bb.i, %bb.k, %bb.l
...
bb.g:                                             ; preds = %bb.f
  ...
  br i1 %i.ac, label %.thread35, label %bb.l

bb.h:                                             ; preds = %bb.f
  switch i16 %.val28, label %bb.l [
...
begin_hunk_8
  ...
  %switch.selectcmp18.i = icmp eq i16 %switch.and.i, 0
  br i1 %switch.selectcmp18.i, label %.thread35, label %bb.l
...
bb.l:                                             ; preds = %bb.i, %bb.g, %bb.f, %bb.h, %bb.j, %bb.k
