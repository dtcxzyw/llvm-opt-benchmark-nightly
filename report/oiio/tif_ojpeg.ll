...
bb.x:                                             ; preds = %bb.w
  ...
  %i.ci = sub i64 %i.cf, %spec.select2122.i
...
begin_hunk_5_@OJPEGReadHeaderInfoSec:bb.a
  ...
  %i.hw = sub i16 %i.hm, %spec.select.i.i97
...
bb.bp:                                            ; preds = %bb.bo
  %i.hx = sub i16 %i.ht, %spec.select.i.i97
...
begin_hunk_6_@OJPEGReadHeaderInfoSec:bb.a
  ...
  %i.ie = sub i64 %i.ia, %spec.select2122.i.i100
