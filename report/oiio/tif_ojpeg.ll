...
.preheader.preheader.i:                           ; preds = %._crit_edge.i130
  %1 = load <8 x i8>, ptr %i.a, align 16, !tbaa !101
  %2 = load <4 x i8>, ptr %i.uk, align 8, !tbaa !101
  ...
  %3 = zext <8 x i8> %1 to <8 x i32>              ; 2 uses
  %4 = zext <4 x i8> %2 to <4 x i32>
  %5 = shufflevector <8 x i32> %3, <8 x i32> poison, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %rdx.op = add nuw nsw <4 x i32> %5, %4
  %6 = shufflevector <4 x i32> %rdx.op, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %7 = shufflevector <8 x i32> %6, <8 x i32> %3, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15>
  %i.vn = call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> %7)
  %op.rdx = add nuw nsw i32 %i.vn, %i.vi
  %op.rdx575 = add nuw nsw i32 %i.vk, %i.vm
  %op.rdx576 = add i32 %op.rdx, %op.rdx575
...
.preheader.preheader:                             ; preds = %._crit_edge
  %1 = load <8 x i8>, ptr %i.a, align 16, !tbaa !101
  %2 = load <4 x i8>, ptr %i.o, align 8, !tbaa !101
  ...
  %6 = shufflevector <4 x i32> %rdx.op, <4 x i32> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %7 = shufflevector <8 x i32> %6, <8 x i32> %3, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 12, i32 13, i32 14, i32 15>
  %i.aw = call i32 @llvm.vector.reduce.add.v8i32(<8 x i32> %7)
