...
vector.ph517:                                     ; preds = %vector.main.loop.iter.check515
  ...
  store <16 x i8> splat (i8 17), ptr %i.ss, align 1, !tbaa !101
  store <16 x i8> splat (i8 17), ptr %i.st, align 1, !tbaa !101
...
vector.body520.1:                                 ; preds = %vector.ph517
  ...
  store <16 x i8> splat (i8 17), ptr %i.sv, align 1, !tbaa !101
  store <16 x i8> splat (i8 17), ptr %i.sw, align 1, !tbaa !101
...
vector.body520.2:                                 ; preds = %vector.body520.1
  ...
  store <16 x i8> splat (i8 17), ptr %i.sy, align 1, !tbaa !101
  store <16 x i8> splat (i8 17), ptr %i.sz, align 1, !tbaa !101
...
vector.body520.3:                                 ; preds = %vector.body520.2
  ...
  store <16 x i8> splat (i8 17), ptr %i.tb, align 1, !tbaa !101
  store <16 x i8> splat (i8 17), ptr %i.tc, align 1, !tbaa !101
...
vector.body520.4:                                 ; preds = %vector.body520.3
  ...
  store <16 x i8> splat (i8 17), ptr %i.te, align 1, !tbaa !101
  store <16 x i8> splat (i8 17), ptr %i.tf, align 1, !tbaa !101
...
vector.body520.5:                                 ; preds = %vector.body520.4
  ...
  store <16 x i8> splat (i8 17), ptr %i.th, align 1, !tbaa !101
  store <16 x i8> splat (i8 17), ptr %i.ti, align 1, !tbaa !101
...
vector.body520.6:                                 ; preds = %vector.body520.5
  ...
  store <16 x i8> splat (i8 17), ptr %i.tk, align 1, !tbaa !101
  store <16 x i8> splat (i8 17), ptr %i.tl, align 1, !tbaa !101
...
bb.fg:                                            ; preds = %bb.ft, %.lr.ph95.i
  ...
  %i.um = phi i8 [ %i.wn, %bb.ft ], [ %i.ue, %.lr.ph95.i ]
  %indvars.iv.i127 = phi i64 [ %indvars.iv.next.i136, %bb.ft ], [ 0, %.lr.ph95.i ] ; 7 uses
  %i.un = phi i32 [ %i.wo, %bb.ft ], [ 0, %.lr.ph95.i ]
  %i.uo = getelementptr inbounds nuw [8 x i8], ptr %i.tz, i64 %indvars.iv.i127 ; 2 uses
  %i.up = load i64, ptr %i.uo, align 8, !tbaa !160 ; 4 uses
  %.not.i128 = icmp eq i64 %i.up, 0
  br i1 %.not.i128, label %bb.fs, label %bb.fh

bb.fh:                                            ; preds = %bb.fg
  %i.uq = icmp eq i64 %indvars.iv.i127, 0
  br i1 %i.uq, label %bb.fj, label %bb.fi

bb.fi:                                            ; preds = %bb.fh
  %i.ur = getelementptr i8, ptr %i.uo, i64 -8
  %i.us = load i64, ptr %i.ur, align 8, !tbaa !160
  %.not83.i129 = icmp eq i64 %i.up, %i.us
  br i1 %.not83.i129, label %bb.fs, label %bb.fj

bb.fj:                                            ; preds = %bb.fi, %bb.fh
  %i.ut = icmp samesign ugt i32 %i.un, 1
  br i1 %i.ut, label %.lr.ph.i137.preheader, label %._crit_edge.i130
...
.lr.ph.i137:                                      ; preds = %.lr.ph.i137.preheader, %bb.fk
  ...
  %i.uu = getelementptr inbounds nuw [8 x i8], ptr %i.tz, i64 %indvars.iv307
  %i.uv = load i64, ptr %i.uu, align 8, !tbaa !160
  %i.uw = icmp eq i64 %i.up, %i.uv
  br i1 %i.uw, label %bb.fl, label %bb.fk
...
._crit_edge.i130:                                 ; preds = %bb.fk, %bb.fj
  %i.ux = load ptr, ptr %i.uf, align 8, !tbaa !192
  %i.uy = load ptr, ptr %i.ug, align 8, !tbaa !181
  %i.uz = call i64 %i.ux(ptr noundef %i.uy, i64 noundef %i.up, i32 noundef 0) #13, !inline_history !203 ; 0 uses
  %i.va = load ptr, ptr %i.uh, align 8, !tbaa !194
  %i.vb = load ptr, ptr %i.ug, align 8, !tbaa !181
  %i.vc = call i64 %i.va(ptr noundef %i.vb, ptr noundef nonnull %i.a, i64 noundef 16) #13, !inline_history !203
  %i.vd = and i64 %i.vc, 4294967295
  %.not84.i131 = icmp eq i64 %i.vd, 16
...
.preheader.preheader.i:                           ; preds = %._crit_edge.i130
  ...
  br i1 %i.vl, label %bb.fm, label %bb.fn
...
bb.fn:                                            ; preds = %.preheader.preheader.i
  ...
  store i32 %i.vi, ptr %i.vk, align 4, !tbaa !3
  %i.vn = getelementptr inbounds nuw i8, ptr %i.vk, i64 4
  store i8 -1, ptr %i.vn, align 4, !tbaa !101
  %i.vo = getelementptr inbounds nuw i8, ptr %i.vk, i64 5
  store i8 -60, ptr %i.vo, align 1, !tbaa !101
  %i.vp = add nuw nsw i32 %i.vh, 19               ; 2 uses
  %i.vq = lshr i32 %i.vp, 8
  %i.vr = trunc nuw nsw i32 %i.vq to i8
  %i.vs = getelementptr inbounds nuw i8, ptr %i.vk, i64 6
  store i8 %i.vr, ptr %i.vs, align 2, !tbaa !101
  %i.vt = trunc i32 %i.vp to i8
  %i.vu = getelementptr inbounds nuw i8, ptr %i.vk, i64 7
  store i8 %i.vt, ptr %i.vu, align 1, !tbaa !101
  %i.vv = getelementptr inbounds nuw i8, ptr %i.vk, i64 8
  %i.vw = trunc nuw i64 %indvars.iv.i127 to i8    ; 2 uses
  store i8 %i.vw, ptr %i.vv, align 4, !tbaa !101
  %i.vx = getelementptr inbounds nuw i8, ptr %i.vk, i64 9
  %i.vy = load <8 x i8>, ptr %i.a, align 16, !tbaa !101
  store <8 x i8> %i.vy, ptr %i.vx, align 1, !tbaa !101
  %i.vz = getelementptr inbounds nuw i8, ptr %i.vk, i64 17
  %i.wa = load <8 x i8>, ptr %i.uk, align 8, !tbaa !101
  store <8 x i8> %i.wa, ptr %i.vz, align 1, !tbaa !101
  %i.wb = load ptr, ptr %i.uh, align 8, !tbaa !194
  %i.wc = load ptr, ptr %i.ug, align 8, !tbaa !181
  %i.wd = getelementptr inbounds nuw i8, ptr %i.vk, i64 25
  %i.we = call i64 %i.wb(ptr noundef %i.wc, ptr noundef nonnull %i.wd, i64 noundef %i.vm) #13, !inline_history !203
  %i.wf = trunc i64 %i.we to i32
  %.not85.i134 = icmp eq i32 %i.vh, %i.wf
  br i1 %.not85.i134, label %bb.fp, label %bb.fo

bb.fo:                                            ; preds = %bb.fn
  call void @_TIFFfreeExt(ptr noundef nonnull %0, ptr noundef nonnull %i.vk) #13
  br label %OJPEGReadHeaderInfoSecTablesDcTable.exit.thread

bb.fp:                                            ; preds = %bb.fn
  %i.wg = getelementptr inbounds nuw [8 x i8], ptr %i.ui, i64 %indvars.iv.i127 ; 2 uses
  %i.wh = load ptr, ptr %i.wg, align 8, !tbaa !138 ; 2 uses
  %.not86.i = icmp eq ptr %i.wh, null
  br i1 %.not86.i, label %bb.fr, label %bb.fq

bb.fq:                                            ; preds = %bb.fp
  call void @_TIFFfreeExt(ptr noundef nonnull %0, ptr noundef nonnull %i.wh) #13
  br label %bb.fr

bb.fr:                                            ; preds = %bb.fq, %bb.fp
  store ptr %i.vk, ptr %i.wg, align 8, !tbaa !138
  %i.wi = shl i8 %i.vw, 4
  %i.wj = getelementptr inbounds nuw i8, ptr %i.uj, i64 %indvars.iv.i127
  store i8 %i.wi, ptr %i.wj, align 1, !tbaa !101
  %.pre.i135 = load i8, ptr %i.ud, align 4, !tbaa !87
  br label %bb.ft

bb.fs:                                            ; preds = %bb.fi, %bb.fg
  %i.wk = getelementptr i8, ptr %i.uj, i64 %indvars.iv.i127 ; 2 uses
  %i.wl = getelementptr i8, ptr %i.wk, i64 -1
  %i.wm = load i8, ptr %i.wl, align 1, !tbaa !101
  store i8 %i.wm, ptr %i.wk, align 1, !tbaa !101
  br label %bb.ft

bb.ft:                                            ; preds = %bb.fs, %bb.fr
  %i.wn = phi i8 [ %.pre.i135, %bb.fr ], [ %i.um, %bb.fs ] ; 2 uses
  %indvars.iv.next.i136 = add nuw nsw i64 %indvars.iv.i127, 1 ; 3 uses
  %i.wo = trunc nuw i64 %indvars.iv.next.i136 to i32
  %i.wp = zext i8 %i.wn to i64
  %i.wq = icmp samesign ult i64 %indvars.iv.next.i136, %i.wp
  %indvars.iv.next311 = add nsw i32 %indvars.iv310, 1
  br i1 %i.wq, label %bb.fg, label %.loopexit
...
.loopexit:                                        ; preds = %bb.ft, %bb.ff
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #13
  %i.wr = call fastcc i32 @OJPEGReadHeaderInfoSecTablesAcTable(ptr noundef %0)
  %i.ws = icmp eq i32 %i.wr, 0
  br i1 %i.ws, label %OJPEGReadBytePeek.exit.thread, label %.preheader

.preheader:                                       ; preds = %.loopexit
  %i.wt = load i8, ptr %i.qy, align 4, !tbaa !87  ; 4 uses
  %i.wu = icmp ugt i8 %i.wt, 1
  br i1 %i.wu, label %iter.check556, label %OJPEGReadBytePeek.exit.thread

iter.check556:                                    ; preds = %.preheader
  %i.wv = getelementptr inbounds nuw i8, ptr %i.e, i64 497 ; 2 uses
  %i.ww = zext i8 %i.wt to i64                    ; 2 uses
  %i.wx = add nsw i64 %i.ww, -1                   ; 5 uses
  %min.iters.check540 = icmp ult i8 %i.wt, 5
...
vector.main.loop.iter.check541:                   ; preds = %iter.check556
  %min.iters.check542 = icmp ult i8 %i.wt, 33
  br i1 %min.iters.check542, label %vec.epilog.ph560, label %vector.ph543

vector.ph543:                                     ; preds = %vector.main.loop.iter.check541
  %n.mod.vf544 = and i64 %i.wx, 28
  %n.vec545 = and i64 %i.wx, -32                  ; 9 uses
  %i.wy = or disjoint i64 %n.vec545, 1            ; 2 uses
  %i.wz = getelementptr inbounds nuw i8, ptr %i.e, i64 498
  %i.xa = getelementptr inbounds nuw i8, ptr %i.e, i64 514
  store <16 x i8> <i8 1, i8 2, i8 3, i8 4, i8 5, i8 6, i8 7, i8 8, i8 9, i8 10, i8 11, i8 12, i8 13, i8 14, i8 15, i8 16>, ptr %i.wz, align 1, !tbaa !101
  store <16 x i8> <i8 17, i8 18, i8 19, i8 20, i8 21, i8 22, i8 23, i8 24, i8 25, i8 26, i8 27, i8 28, i8 29, i8 30, i8 31, i8 32>, ptr %i.xa, align 1, !tbaa !101
  %i.xb = icmp eq i64 %n.vec545, 32
  br i1 %i.xb, label %middle.block552, label %vector.body546.1

vector.body546.1:                                 ; preds = %vector.ph543
  %i.xc = getelementptr inbounds nuw i8, ptr %i.e, i64 530
  %i.xd = getelementptr inbounds nuw i8, ptr %i.e, i64 546
  store <16 x i8> <i8 33, i8 34, i8 35, i8 36, i8 37, i8 38, i8 39, i8 40, i8 41, i8 42, i8 43, i8 44, i8 45, i8 46, i8 47, i8 48>, ptr %i.xc, align 1, !tbaa !101
  store <16 x i8> <i8 49, i8 50, i8 51, i8 52, i8 53, i8 54, i8 55, i8 56, i8 57, i8 58, i8 59, i8 60, i8 61, i8 62, i8 63, i8 64>, ptr %i.xd, align 1, !tbaa !101
  %i.xe = icmp eq i64 %n.vec545, 64
  br i1 %i.xe, label %middle.block552, label %vector.body546.2

vector.body546.2:                                 ; preds = %vector.body546.1
  %i.xf = getelementptr inbounds nuw i8, ptr %i.e, i64 562
  %i.xg = getelementptr inbounds nuw i8, ptr %i.e, i64 578
  store <16 x i8> <i8 65, i8 66, i8 67, i8 68, i8 69, i8 70, i8 71, i8 72, i8 73, i8 74, i8 75, i8 76, i8 77, i8 78, i8 79, i8 80>, ptr %i.xf, align 1, !tbaa !101
  store <16 x i8> <i8 81, i8 82, i8 83, i8 84, i8 85, i8 86, i8 87, i8 88, i8 89, i8 90, i8 91, i8 92, i8 93, i8 94, i8 95, i8 96>, ptr %i.xg, align 1, !tbaa !101
  %i.xh = icmp eq i64 %n.vec545, 96
  br i1 %i.xh, label %middle.block552, label %vector.body546.3

vector.body546.3:                                 ; preds = %vector.body546.2
  %i.xi = getelementptr inbounds nuw i8, ptr %i.e, i64 594
  %i.xj = getelementptr inbounds nuw i8, ptr %i.e, i64 610
  store <16 x i8> <i8 97, i8 98, i8 99, i8 100, i8 101, i8 102, i8 103, i8 104, i8 105, i8 106, i8 107, i8 108, i8 109, i8 110, i8 111, i8 112>, ptr %i.xi, align 1, !tbaa !101
  store <16 x i8> <i8 113, i8 114, i8 115, i8 116, i8 117, i8 118, i8 119, i8 120, i8 121, i8 122, i8 123, i8 124, i8 125, i8 126, i8 127, i8 -128>, ptr %i.xj, align 1, !tbaa !101
  %i.xk = icmp eq i64 %n.vec545, 128
  br i1 %i.xk, label %middle.block552, label %vector.body546.4

vector.body546.4:                                 ; preds = %vector.body546.3
  %i.xl = getelementptr inbounds nuw i8, ptr %i.e, i64 626
  %i.xm = getelementptr inbounds nuw i8, ptr %i.e, i64 642
  store <16 x i8> <i8 -127, i8 -126, i8 -125, i8 -124, i8 -123, i8 -122, i8 -121, i8 -120, i8 -119, i8 -118, i8 -117, i8 -116, i8 -115, i8 -114, i8 -113, i8 -112>, ptr %i.xl, align 1, !tbaa !101
  store <16 x i8> <i8 -111, i8 -110, i8 -109, i8 -108, i8 -107, i8 -106, i8 -105, i8 -104, i8 -103, i8 -102, i8 -101, i8 -100, i8 -99, i8 -98, i8 -97, i8 -96>, ptr %i.xm, align 1, !tbaa !101
  %i.xn = icmp eq i64 %n.vec545, 160
  br i1 %i.xn, label %middle.block552, label %vector.body546.5

vector.body546.5:                                 ; preds = %vector.body546.4
  %i.xo = getelementptr inbounds nuw i8, ptr %i.e, i64 658
  %i.xp = getelementptr inbounds nuw i8, ptr %i.e, i64 674
  store <16 x i8> <i8 -95, i8 -94, i8 -93, i8 -92, i8 -91, i8 -90, i8 -89, i8 -88, i8 -87, i8 -86, i8 -85, i8 -84, i8 -83, i8 -82, i8 -81, i8 -80>, ptr %i.xo, align 1, !tbaa !101
  store <16 x i8> <i8 -79, i8 -78, i8 -77, i8 -76, i8 -75, i8 -74, i8 -73, i8 -72, i8 -71, i8 -70, i8 -69, i8 -68, i8 -67, i8 -66, i8 -65, i8 -64>, ptr %i.xp, align 1, !tbaa !101
  %i.xq = icmp eq i64 %n.vec545, 192
  br i1 %i.xq, label %middle.block552, label %vector.body546.6

vector.body546.6:                                 ; preds = %vector.body546.5
  %i.xr = getelementptr inbounds nuw i8, ptr %i.e, i64 690
  %i.xs = getelementptr inbounds nuw i8, ptr %i.e, i64 706
  store <16 x i8> <i8 -63, i8 -62, i8 -61, i8 -60, i8 -59, i8 -58, i8 -57, i8 -56, i8 -55, i8 -54, i8 -53, i8 -52, i8 -51, i8 -50, i8 -49, i8 -48>, ptr %i.xr, align 1, !tbaa !101
  store <16 x i8> <i8 -47, i8 -46, i8 -45, i8 -44, i8 -43, i8 -42, i8 -41, i8 -40, i8 -39, i8 -38, i8 -37, i8 -36, i8 -35, i8 -34, i8 -33, i8 -32>, ptr %i.xs, align 1, !tbaa !101
...
middle.block552:                                  ; preds = %vector.body546.6, %vector.body546.5, %vector.body546.4, %vector.body546.3, %vector.body546.2, %vector.body546.1, %vector.ph543
  %cmp.n553 = icmp eq i64 %i.wx, %n.vec545
...
vec.epilog.ph560:                                 ; preds = %vector.main.loop.iter.check541, %vec.epilog.iter.check558
  ...
  %bc.resume.val555 = phi i64 [ %i.wy, %vec.epilog.iter.check558 ], [ 1, %vector.main.loop.iter.check541 ]
  %n.vec562 = and i64 %i.wx, -4                   ; 3 uses
  %i.xt = or disjoint i64 %n.vec562, 1
  %i.xu = trunc i64 %bc.resume.val555 to i8
  %broadcast.splatinsert563 = insertelement <4 x i8> poison, i8 %i.xu, i64 0
...
vec.epilog.vector.body566:                        ; preds = %vec.epilog.vector.body566, %vec.epilog.ph560
  ...
  %i.xv = getelementptr inbounds nuw i8, ptr %i.wv, i64 %index567
  %i.xw = getelementptr inbounds nuw i8, ptr %i.xv, i64 1
  store <4 x i8> %vec.ind568, ptr %i.xw, align 1, !tbaa !101
  %index.next569 = add nuw i64 %index567, 4       ; 2 uses
  %vec.ind.next570 = add <4 x i8> %vec.ind568, splat (i8 4)
  %i.xx = icmp eq i64 %index.next569, %n.vec562
  br i1 %i.xx, label %vec.epilog.middle.block571, label %vec.epilog.vector.body566, !llvm.loop !204

vec.epilog.middle.block571:                       ; preds = %vec.epilog.vector.body566
  %cmp.n572 = icmp eq i64 %i.wx, %n.vec562
...
vec.epilog.scalar.ph557.preheader:                ; preds = %iter.check556, %vec.epilog.iter.check558, %vec.epilog.middle.block571
  %indvars.iv314.ph = phi i64 [ 1, %iter.check556 ], [ %i.wy, %vec.epilog.iter.check558 ], [ %i.xt, %vec.epilog.middle.block571 ]
end_hunk_1
...
._crit_edge:                                      ; preds = %bb.h, %bb.g
  %i.ag = load ptr, ptr %i.j, align 8, !tbaa !192
  %i.ah = load ptr, ptr %i.k, align 8, !tbaa !181
  %i.ai = call i64 %i.ag(ptr noundef %i.ah, i64 noundef %i.t, i32 noundef 0) #13 ; 0 uses
  %i.aj = load ptr, ptr %i.l, align 8, !tbaa !194
  %i.ak = load ptr, ptr %i.k, align 8, !tbaa !181
  %i.al = call i64 %i.aj(ptr noundef %i.ak, ptr noundef nonnull %i.a, i64 noundef 16) #13
  %i.am = and i64 %i.al, 4294967295
  %.not88 = icmp eq i64 %i.am, 16
...
bb.k:                                             ; preds = %.preheader.preheader
  ...
  store i32 %i.ar, ptr %i.at, align 4, !tbaa !3
  %i.aw = getelementptr inbounds nuw i8, ptr %i.at, i64 4
  store i8 -1, ptr %i.aw, align 4, !tbaa !101
  %i.ax = getelementptr inbounds nuw i8, ptr %i.at, i64 5
  store i8 -60, ptr %i.ax, align 1, !tbaa !101
  %i.ay = add nuw nsw i32 %i.aq, 19               ; 2 uses
  %i.az = lshr i32 %i.ay, 8
  %i.ba = trunc nuw nsw i32 %i.az to i8
  %i.bb = getelementptr inbounds nuw i8, ptr %i.at, i64 6
  store i8 %i.ba, ptr %i.bb, align 2, !tbaa !101
  %i.bc = trunc i32 %i.ay to i8
  %i.bd = getelementptr inbounds nuw i8, ptr %i.at, i64 7
  store i8 %i.bc, ptr %i.bd, align 1, !tbaa !101
  %i.be = trunc nuw i64 %indvars.iv to i8         ; 2 uses
  %i.bf = or i8 %i.be, 16
  %i.bg = getelementptr inbounds nuw i8, ptr %i.at, i64 8
  store i8 %i.bf, ptr %i.bg, align 4, !tbaa !101
  %i.bh = getelementptr inbounds nuw i8, ptr %i.at, i64 9
  %i.bi = load <8 x i8>, ptr %i.a, align 16, !tbaa !101
  store <8 x i8> %i.bi, ptr %i.bh, align 1, !tbaa !101
  %i.bj = getelementptr inbounds nuw i8, ptr %i.at, i64 17
  %i.bk = load <8 x i8>, ptr %i.o, align 8, !tbaa !101
  store <8 x i8> %i.bk, ptr %i.bj, align 1, !tbaa !101
  %i.bl = load ptr, ptr %i.l, align 8, !tbaa !194
  %i.bm = load ptr, ptr %i.k, align 8, !tbaa !181
  %i.bn = getelementptr inbounds nuw i8, ptr %i.at, i64 25
  %i.bo = call i64 %i.bl(ptr noundef %i.bm, ptr noundef nonnull %i.bn, i64 noundef %i.av) #13
  %i.bp = trunc i64 %i.bo to i32
  %.not89 = icmp eq i32 %i.aq, %i.bp
  br i1 %.not89, label %bb.m, label %bb.l

bb.l:                                             ; preds = %bb.k
  call void @_TIFFfreeExt(ptr noundef nonnull %0, ptr noundef nonnull %i.at) #13
  br label %.loopexit

bb.m:                                             ; preds = %bb.k
  %i.bq = getelementptr inbounds nuw [8 x i8], ptr %i.m, i64 %indvars.iv ; 2 uses
  %i.br = load ptr, ptr %i.bq, align 8, !tbaa !138 ; 2 uses
  %.not90 = icmp eq ptr %i.br, null
  br i1 %.not90, label %bb.o, label %bb.n

bb.n:                                             ; preds = %bb.m
  call void @_TIFFfreeExt(ptr noundef nonnull %0, ptr noundef nonnull %i.br) #13
  br label %bb.o

bb.o:                                             ; preds = %bb.n, %bb.m
  store ptr %i.at, ptr %i.bq, align 8, !tbaa !138
  %i.bs = getelementptr inbounds nuw i8, ptr %i.n, i64 %indvars.iv ; 2 uses
  %i.bt = load i8, ptr %i.bs, align 1, !tbaa !101
  %i.bu = or i8 %i.bt, %i.be
  store i8 %i.bu, ptr %i.bs, align 1, !tbaa !101
  %.pre = load i8, ptr %i.h, align 4, !tbaa !87
  br label %bb.q

bb.p:                                             ; preds = %bb.f, %bb.d
  %i.bv = getelementptr inbounds nuw i8, ptr %i.n, i64 %indvars.iv ; 3 uses
  %i.bw = load i8, ptr %i.bv, align 1, !tbaa !101
  %i.bx = getelementptr i8, ptr %i.bv, i64 -1
  %i.by = load i8, ptr %i.bx, align 1, !tbaa !101
  %i.bz = and i8 %i.by, 15
  %i.ca = or i8 %i.bz, %i.bw
  store i8 %i.ca, ptr %i.bv, align 1, !tbaa !101
  br label %bb.q

bb.q:                                             ; preds = %bb.o, %bb.p
  %i.cb = phi i8 [ %.pre, %bb.o ], [ %i.q, %bb.p ] ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 3 uses
  %i.cc = trunc nuw i64 %indvars.iv.next to i32
  %i.cd = zext i8 %i.cb to i64
  %i.ce = icmp samesign ult i64 %indvars.iv.next, %i.cd
  br i1 %i.ce, label %bb.d, label %.loopexit
...
define internal void @OJPEGLibjpegJpegSourceMgrSkipInputData(ptr noundef readonly captures(none) %0, i64 %1) #6 {
bb.a:
...
; Function Attrs: noreturn nounwind uwtable
define internal noundef i32 @OJPEGLibjpegJpegSourceMgrResyncToRestart(ptr noundef readonly captures(none) %0, i32 %1) #6 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.b = load ptr, ptr %i.a, align 8, !tbaa !210  ; 2 uses
  tail call void (ptr, ptr, ptr, ...) @TIFFErrorExtR(ptr noundef %i.b, ptr noundef nonnull @.str.51, ptr noundef nonnull @.str.54) #13
...
define internal void @OJPEGLibjpegJpegSourceMgrTermSource(ptr readnone captures(none) %0) #3 {
bb.a:
  ret void
}
