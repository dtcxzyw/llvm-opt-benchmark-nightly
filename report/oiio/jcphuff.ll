begin_hunk_0_@encode_mcu_AC_first:bb.a
  ...
  call void %i.cn(ptr noundef nonnull %i.ck) #7, !inline_history !83
...
begin_hunk_1_@encode_mcu_AC_first:bb.a
  ...
  %i.dl = call i32 %i.dk(ptr noundef %i.dg) #7, !inline_history !85
...
begin_hunk_2_@encode_mcu_AC_first:bb.a
  ...
  call void %i.dp(ptr noundef nonnull %i.dm) #7, !inline_history !85
...
begin_hunk_3_@encode_mcu_AC_first:bb.a
  ...
  %i.ee = load ptr, ptr %i.ed, align 8, !tbaa !84
  %i.ef = call i32 %i.ee(ptr noundef %i.ea) #7, !inline_history !85
...
begin_hunk_4_@encode_mcu_AC_first:bb.a
  ...
  call void %i.ej(ptr noundef nonnull %i.eg) #7, !inline_history !85
...
begin_hunk_5_@encode_mcu_AC_first:bb.a
  ...
  br i1 %i.ep, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !86
...
emit_symbol.exit:                                 ; preds = %._crit_edge.i, %bb.j, %bb.h
  ...
  br i1 %i.er, label %.lr.ph.splitthread-pre-split, label %._crit_edge, !llvm.loop !87
...
begin_hunk_7_@encode_mcu_AC_first:bb.a
  ...
  br i1 %.not63, label %._crit_edge79, label %bb.g, !llvm.loop !89
...
begin_hunk_10_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.bt(ptr noundef nonnull %i.bq) #7, !inline_history !92
  br label %bb.h
...
begin_hunk_11_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.cs(ptr noundef nonnull %i.cp) #7, !inline_history !83
...
begin_hunk_12_@encode_mcu_AC_refine:bb.a
  ...
  %i.dp = call i32 %i.do(ptr noundef %i.dk) #7, !inline_history !85
...
begin_hunk_13_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.dt(ptr noundef nonnull %i.dq) #7, !inline_history !85
...
begin_hunk_14_@encode_mcu_AC_refine:bb.a
  ...
  %i.ej = call i32 %i.ei(ptr noundef %i.ee) #7, !inline_history !85
...
begin_hunk_15_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.en(ptr noundef nonnull %i.ek) #7, !inline_history !85
...
begin_hunk_16_@encode_mcu_AC_refine:bb.a
  ...
  br i1 %i.et, label %.lr.ph.i118, label %._crit_edge.i115.loopexit, !llvm.loop !86
...
begin_hunk_17_@encode_mcu_AC_refine:bb.a
  ...
  %i.fs = load ptr, ptr %i.fr, align 8, !tbaa !84
  %i.ft = call i32 %i.fs(ptr noundef %i.fo) #7, !inline_history !85
...
begin_hunk_18_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.fx(ptr noundef nonnull %i.fu) #7, !inline_history !85
...
begin_hunk_19_@encode_mcu_AC_refine:bb.a
  ...
  %i.gm = load ptr, ptr %i.gl, align 8, !tbaa !84
  %i.gn = call i32 %i.gm(ptr noundef %i.gi) #7, !inline_history !85
...
begin_hunk_20_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.gr(ptr noundef nonnull %i.go) #7, !inline_history !85
...
begin_hunk_21_@encode_mcu_AC_refine:bb.a
  ...
  br i1 %i.gx, label %.lr.ph.i105, label %._crit_edge.i102.loopexit, !llvm.loop !86
...
begin_hunk_22_@encode_mcu_AC_refine:bb.a
  ...
  %i.ia = load ptr, ptr %i.hz, align 8, !tbaa !84
  %i.ib = call i32 %i.ia(ptr noundef %i.hw) #7, !inline_history !85
...
begin_hunk_23_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.if(ptr noundef nonnull %i.ic) #7, !inline_history !85
  br label %dump_buffer.exit.i
...
begin_hunk_24_@encode_mcu_AC_refine:bb.a
  ...
  %i.iu = load ptr, ptr %i.it, align 8, !tbaa !84
  %i.iv = call i32 %i.iu(ptr noundef %i.iq) #7, !inline_history !85
...
begin_hunk_25_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.iz(ptr noundef nonnull %i.iw) #7, !inline_history !85
  br label %dump_buffer.exit32.i
...
begin_hunk_26_@encode_mcu_AC_refine:bb.a
  ...
  br i1 %i.jf, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !86
...
begin_hunk_28_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.kd(ptr noundef nonnull %i.ka) #7, !inline_history !83
...
begin_hunk_29_@encode_mcu_AC_refine:bb.a
  ...
  %i.la = load ptr, ptr %i.kz, align 8, !tbaa !84
  %i.lb = call i32 %i.la(ptr noundef %i.kw) #7, !inline_history !85
...
begin_hunk_30_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.lf(ptr noundef nonnull %i.lc) #7, !inline_history !85
...
begin_hunk_31_@encode_mcu_AC_refine:bb.a
  ...
  %i.lv = call i32 %i.lu(ptr noundef %i.lq) #7, !inline_history !85
...
begin_hunk_32_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.lz(ptr noundef nonnull %i.lw) #7, !inline_history !85
...
begin_hunk_33_@encode_mcu_AC_refine:bb.a
  ...
  br i1 %i.mf, label %.lr.ph.i131, label %._crit_edge.i128.loopexit, !llvm.loop !86
...
begin_hunk_34_@encode_mcu_AC_refine:bb.a
  ...
  %i.nf = load ptr, ptr %i.ne, align 8, !tbaa !84
  %i.ng = call i32 %i.nf(ptr noundef %i.nb) #7, !inline_history !85
...
begin_hunk_35_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.nk(ptr noundef nonnull %i.nh) #7, !inline_history !85
...
begin_hunk_36_@encode_mcu_AC_refine:bb.a
  ...
  %i.nz = load ptr, ptr %i.ny, align 8, !tbaa !84
  %i.oa = call i32 %i.nz(ptr noundef %i.nv) #7, !inline_history !85
...
begin_hunk_37_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.oe(ptr noundef nonnull %i.ob) #7, !inline_history !85
...
begin_hunk_38_@encode_mcu_AC_refine:bb.a
  ...
  br i1 %i.ok, label %.lr.ph.i143, label %._crit_edge.i140, !llvm.loop !86
...
begin_hunk_41_@encode_mcu_AC_refine:bb.a
  ...
  %i.qu = load ptr, ptr %i.qt, align 8, !tbaa !84
  %i.qv = call i32 %i.qu(ptr noundef %i.qq) #7, !inline_history !85
...
begin_hunk_42_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.qz(ptr noundef nonnull %i.qw) #7, !inline_history !85
...
begin_hunk_43_@encode_mcu_AC_refine:bb.a
  ...
  %i.ro = load ptr, ptr %i.rn, align 8, !tbaa !84
  %i.rp = call i32 %i.ro(ptr noundef %i.rk) #7, !inline_history !85
...
begin_hunk_44_@encode_mcu_AC_refine:bb.a
  ...
  call void %i.rt(ptr noundef nonnull %i.rq) #7, !inline_history !85
...
begin_hunk_45_@encode_mcu_AC_refine:bb.a
  ...
  br i1 %i.rz, label %.lr.ph.i155, label %._crit_edge.i152, !llvm.loop !86
...
begin_hunk_48_@finish_pass_gather_phuff:bb.a
  ...
  br i1 %i.af, label %.lr.ph.split.us.splitthread-pre-split, label %._crit_edge, !llvm.loop !99
...
begin_hunk_49_@finish_pass_gather_phuff:bb.a
  ...
  br i1 %i.av, label %.lr.ph.split, label %._crit_edge, !llvm.loop !100
...
begin_hunk_50_@emit_restart:bb.a
  ...
  %i.r = tail call i32 %i.q(ptr noundef %i.m) #7, !inline_history !101
...
begin_hunk_51_@emit_restart:bb.a
  ...
  tail call void %i.v(ptr noundef nonnull %i.s) #7, !inline_history !101
...
begin_hunk_52_@emit_restart:bb.a
  ...
  %i.am = tail call i32 %i.al(ptr noundef %i.ah) #7, !inline_history !101
...
begin_hunk_53_@emit_restart:bb.a
  ...
  tail call void %i.aq(ptr noundef nonnull %i.an) #7, !inline_history !101
...
begin_hunk_55_@emit_bits:bb.a
  ...
  %i.al = tail call i32 %i.ak(ptr noundef %i.ag) #7, !inline_history !101
...
begin_hunk_56_@emit_bits:bb.a
  ...
  tail call void %i.ap(ptr noundef nonnull %i.am) #7, !inline_history !101
  br label %dump_buffer.exit
...
begin_hunk_57_@emit_bits:bb.a
  ...
  %i.bf = tail call i32 %i.be(ptr noundef %i.ba) #7, !inline_history !101
...
begin_hunk_58_@emit_bits:bb.a
  ...
  tail call void %i.bj(ptr noundef nonnull %i.bg) #7, !inline_history !101
...
begin_hunk_59_@emit_bits:bb.a
  ...
  br i1 %i.bp, label %bb.e, label %._crit_edge, !llvm.loop !86
...
!83 = !{ptr @emit_bits}
!84 = !{!72, !10, i64 24}
!85 = distinct !{ptr @emit_bits, null}
!86 = distinct !{!86, !49}
