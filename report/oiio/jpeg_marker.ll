...
begin_hunk_0_@_ZNK22photos_editing_formats8image_io10JpegMarker12GetHexStringERKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE:bb.a
  ...
  %i.ae = invoke noundef signext i8 %i.ad(ptr noundef nonnull align 8 dereferenceable(570) %i.y, i8 noundef signext 32)
          to label %.noexc5._ZNKSt9basic_iosIcSt11char_traitsIcEE5widenEc.exit.i.i.i_crit_edge unwind label %bb.k ; 0 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  store ptr %i.ao, ptr %0, align 8, !tbaa !9, !alias.scope !68
  %i.ap = getelementptr inbounds nuw i8, ptr %0, i64 8
  store i64 0, ptr %i.ap, align 8, !tbaa !13, !alias.scope !68
  store i8 0, ptr %i.ao, align 8, !tbaa !16, !alias.scope !68
  %i.aq = getelementptr inbounds nuw i8, ptr %3, i64 64
  %i.ar = load ptr, ptr %i.aq, align 8, !tbaa !24, !noalias !68 ; 3 uses
  %.not.i.not.i.i = icmp eq ptr %i.ar, null
  %i.as = getelementptr inbounds nuw i8, ptr %3, i64 48
  %i.at = load ptr, ptr %i.as, align 8, !noalias !68 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.aw = load ptr, ptr %i.av, align 8, !tbaa !28, !noalias !68 ; 2 uses
...
bb.i:                                             ; preds = %bb.j, %bb.h
  %i.bb = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.bc = load ptr, ptr %0, align 8, !tbaa !29, !alias.scope !68 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i: ; preds = %bb.i
  %i.be = load i64, ptr %i.ao, align 8, !tbaa !16, !alias.scope !68
  %i.bf = add i64 %i.be, 1
