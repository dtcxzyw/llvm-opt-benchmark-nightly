...
.lr.ph110.prol:                                   ; preds = %.lr.ph110.preheader200, %.lr.ph110.prol
  ...
  br i1 %prol.iter210.cmp.not, label %.lr.ph110.prol.loopexit, label %.lr.ph110.prol, !llvm.loop !271
...
.lr.ph.preheader:                                 ; preds = %bb.n
  ...
  br i1 %min.iters.check150, label %.lr.ph.preheader201, label %vector.memcheck144
...
vector.memcheck144:                               ; preds = %.lr.ph.preheader
  ...
  br i1 %found.conflict148, label %.lr.ph.preheader201, label %vector.ph151
...
vector.body154:                                   ; preds = %vector.body154, %vector.ph151
  %index155 = phi i64 [ 0, %vector.ph151 ], [ %index.next169, %vector.body154 ] ; 2 uses
  %i.cu = mul i64 %index155, -4                   ; 2 uses
  %next.gep156 = getelementptr i8, ptr %i.cc, i64 %i.cu ; 2 uses
  %next.gep157.a = getelementptr i8, ptr %i.cn, i64 %i.cu ; 2 uses
  %i.cv = getelementptr inbounds i8, ptr %next.gep157.a, i64 -16 ; 2 uses
  %i.cw = getelementptr inbounds i8, ptr %next.gep157.a, i64 -32 ; 2 uses
  %wide.load158 = load <4 x i32>, ptr %i.cv, align 4, !tbaa !3, !alias.scope !273, !noalias !276
  %wide.load159.a = load <4 x i32>, ptr %i.cw, align 4, !tbaa !3, !alias.scope !273, !noalias !276
  %3 = getelementptr inbounds i8, ptr %next.gep156, i64 -16 ; 2 uses
  %i.cx = getelementptr inbounds i8, ptr %next.gep156, i64 -32 ; 2 uses
  %wide.load161 = load <4 x i32>, ptr %3, align 4, !tbaa !3, !alias.scope !276
  %wide.load162 = load <4 x i32>, ptr %i.cx, align 4, !tbaa !3, !alias.scope !276
  store <4 x i32> %wide.load161, ptr %i.cv, align 4, !tbaa !3, !alias.scope !273, !noalias !276
  store <4 x i32> %wide.load162, ptr %i.cw, align 4, !tbaa !3, !alias.scope !273, !noalias !276
  store <4 x i32> %wide.load158, ptr %3, align 4, !tbaa !3, !alias.scope !276
  store <4 x i32> %wide.load159.a, ptr %i.cx, align 4, !tbaa !3, !alias.scope !276
  %index.next169 = add nuw i64 %index155, 8       ; 2 uses
  %i.cy = icmp eq i64 %index.next169, %n.vec153
  br i1 %i.cy, label %middle.block170, label %vector.body154, !llvm.loop !278

middle.block170:                                  ; preds = %vector.body154
  %cmp.n171 = icmp eq i64 %.082, %n.vec153
  br i1 %cmp.n171, label %._crit_edge, label %.lr.ph.preheader201

.lr.ph.preheader201:                              ; preds = %vector.memcheck144, %.lr.ph.preheader, %middle.block170
  %.0105.ph = phi i64 [ 0, %vector.memcheck144 ], [ 0, %.lr.ph.preheader ], [ %n.vec153, %middle.block170 ] ; 3 uses
  %.052104.ph = phi ptr [ %i.cc, %vector.memcheck144 ], [ %i.cc, %.lr.ph.preheader ], [ %i.cs, %middle.block170 ] ; 2 uses
  %.260103.ph = phi ptr [ %i.cn, %vector.memcheck144 ], [ %i.cn, %.lr.ph.preheader ], [ %i.ct, %middle.block170 ] ; 2 uses
  %xtraiter = and i64 %.082, 3                    ; 2 uses
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol

.lr.ph.prol:                                      ; preds = %.lr.ph.preheader201, %.lr.ph.prol
  %.0105.prol = phi i64 [ %i.dd, %.lr.ph.prol ], [ %.0105.ph, %.lr.ph.preheader201 ]
  %.052104.prol = phi ptr [ %i.da, %.lr.ph.prol ], [ %.052104.ph, %.lr.ph.preheader201 ]
  %.260103.prol = phi ptr [ %i.cz, %.lr.ph.prol ], [ %.260103.ph, %.lr.ph.preheader201 ]
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph.prol ], [ 0, %.lr.ph.preheader201 ]
  %i.cz = getelementptr inbounds i8, ptr %.260103.prol, i64 -4 ; 4 uses
  %i.da = getelementptr inbounds i8, ptr %.052104.prol, i64 -4 ; 4 uses
  ...
  %i.dd = add nuw nsw i64 %.0105.prol, 1          ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.prol.loopexit, label %.lr.ph.prol, !llvm.loop !279

.lr.ph.prol.loopexit:                             ; preds = %.lr.ph.prol, %.lr.ph.preheader201
  %.0105.unr = phi i64 [ %.0105.ph, %.lr.ph.preheader201 ], [ %i.dd, %.lr.ph.prol ]
  %.052104.unr = phi ptr [ %.052104.ph, %.lr.ph.preheader201 ], [ %i.da, %.lr.ph.prol ]
  %.260103.unr = phi ptr [ %.260103.ph, %.lr.ph.preheader201 ], [ %i.cz, %.lr.ph.prol ]
  %i.de = sub nsw i64 %.0105.ph, %.082
...
.backedge:                                        ; preds = %._crit_edge, %bb.h
  ...
  %.082.be = phi i64 [ %i.ca, %bb.h ], [ %i.dg, %._crit_edge ]
  %.058.be = phi ptr [ %.159.lcssa, %bb.h ], [ %.260.lcssa, %._crit_edge ]
  br label %bb.e, !llvm.loop !280

.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  %.0105 = phi i64 [ %i.dx, %.lr.ph ], [ %.0105.unr, %.lr.ph.prol.loopexit ]
  %.052104 = phi ptr [ %i.du, %.lr.ph ], [ %.052104.unr, %.lr.ph.prol.loopexit ] ; 4 uses
  %.260103 = phi ptr [ %i.dt, %.lr.ph ], [ %.260103.unr, %.lr.ph.prol.loopexit ] ; 4 uses
  %i.dh = getelementptr inbounds i8, ptr %.260103, i64 -4 ; 2 uses
  %i.di = getelementptr inbounds i8, ptr %.052104, i64 -4 ; 2 uses
  ...
  %i.dl = getelementptr inbounds i8, ptr %.260103, i64 -8 ; 2 uses
  %i.dm = getelementptr inbounds i8, ptr %.052104, i64 -8 ; 2 uses
  %i.dn = load i32, ptr %i.dl, align 4, !tbaa !3
  %i.do = load i32, ptr %i.dm, align 4, !tbaa !3
  store i32 %i.do, ptr %i.dl, align 4, !tbaa !3
  store i32 %i.dn, ptr %i.dm, align 4, !tbaa !3
  %i.dp = getelementptr inbounds i8, ptr %.260103, i64 -12 ; 2 uses
  %i.dq = getelementptr inbounds i8, ptr %.052104, i64 -12 ; 2 uses
  %i.dr = load i32, ptr %i.dp, align 4, !tbaa !3
  %i.ds = load i32, ptr %i.dq, align 4, !tbaa !3
  store i32 %i.ds, ptr %i.dp, align 4, !tbaa !3
  store i32 %i.dr, ptr %i.dq, align 4, !tbaa !3
  %i.dt = getelementptr inbounds i8, ptr %.260103, i64 -16 ; 3 uses
  %i.du = getelementptr inbounds i8, ptr %.052104, i64 -16 ; 3 uses
  %i.dv = load i32, ptr %i.dt, align 4, !tbaa !3
  %i.dw = load i32, ptr %i.du, align 4, !tbaa !3
  store i32 %i.dw, ptr %i.dt, align 4, !tbaa !3
  store i32 %i.dv, ptr %i.du, align 4, !tbaa !3
  %i.dx = add nuw nsw i64 %.0105, 4               ; 2 uses
  %exitcond.not.3 = icmp eq i64 %i.dx, %.082
  br i1 %exitcond.not.3, label %._crit_edge, label %.lr.ph, !llvm.loop !281

_ZSt11swap_rangesIPiS0_ET0_T_S2_S1_.exit:         ; preds = %._crit_edge, %._crit_edge111, %.lr.ph.i, %middle.block195, %_ZSt13move_backwardIPiS0_ET0_T_S2_S1_.exit, %_ZSt4moveIPiS0_ET0_T_S2_S1_.exit, %bb.b, %bb.a
  %.6 = phi ptr [ %0, %bb.b ], [ %2, %bb.a ], [ %i.af, %_ZSt13move_backwardIPiS0_ET0_T_S2_S1_.exit ], [ %i.af, %_ZSt4moveIPiS0_ET0_T_S2_S1_.exit ], [ %1, %middle.block195 ], [ %1, %.lr.ph.i ], [ %i.af, %._crit_edge111 ], [ %i.af, %._crit_edge ]
  ret ptr %.6
}

; Function Attrs: mustprogress uwtable
define internal fastcc void @_ZSt23__merge_adaptive_resizeIPilS0_N9__gnu_cxx5__ops15_Iter_comp_iterIN11OpenImageIO4v3_112_GLOBAL__N_116SampleComparatorEEEEvT_S9_S9_T0_SA_T1_SA_T2_(ptr noundef %0, ptr noundef %1, ptr noundef %2, i64 noundef %3, i64 noundef %4, ptr noundef %5, i64 noundef range(i64 -9223372036854775808, 1152921504606846976) %6, ptr noundef readonly byval(%"struct.__gnu_cxx::__ops::_Iter_comp_iter") align 8 captures(none) %7) unnamed_addr #1 {
bb.a:
