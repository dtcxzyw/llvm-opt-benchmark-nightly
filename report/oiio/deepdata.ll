...
bb.af:                                            ; preds = %bb.ae
  ...
  %i.ge = tail call noundef float @_ZNK11OpenImageIO4v3_18DeepData10deep_valueElii(ptr noundef nonnull align 8 dereferenceable(20) %0, i64 noundef %1, i32 noundef %i.gd, i32 noundef %.0125175)
  ...
  tail call void @_ZN11OpenImageIO4v3_18DeepData14set_deep_valueEliif(ptr noundef nonnull align 8 dereferenceable(20) %0, i64 noundef %1, i32 noundef %i.gd, i32 noundef %.0125175, float noundef %i.go)
...
bb.ag:                                            ; preds = %bb.ae
  ...
  %i.gr = tail call noundef float @_ZNK11OpenImageIO4v3_18DeepData10deep_valueElii(ptr noundef nonnull align 8 dereferenceable(20) %0, i64 noundef %1, i32 noundef %i.gq, i32 noundef %.0125175)
  ...
  tail call void @_ZN11OpenImageIO4v3_18DeepData14set_deep_valueEliif(ptr noundef nonnull align 8 dereferenceable(20) %0, i64 noundef %1, i32 noundef %i.gq, i32 noundef %.0125175, float noundef %i.gv)
...
bb.ai:                                            ; preds = %.lr.ph172, %bb.be
  ...
  %i.hb = load i32, ptr %i.ha, align 4, !tbaa !3  ; 2 uses
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %or.cond21.i.i149 = select i1 %i.he, i1 %.not.i.i148, i1 false
...
bb.al:                                            ; preds = %bb.ak
  ...
  %.not19.i.i152 = icmp slt i32 %.0125175, %i.ho
...
bb.bc:                                            ; preds = %bb.bb
  ...
  tail call void @_ZN11OpenImageIO4v3_18DeepData14set_deep_valueEliif(ptr noundef nonnull align 8 dereferenceable(20) %0, i64 noundef %1, i32 noundef %i.kq, i32 noundef %.0125175, float noundef %i.km)
...
bb.bd:                                            ; preds = %bb.bb
  ...
  tail call void @_ZN11OpenImageIO4v3_18DeepData14set_deep_valueEliif(ptr noundef nonnull align 8 dereferenceable(20) %0, i64 noundef %1, i32 noundef %i.kr, i32 noundef %.0125175, float noundef %i.kv)
...
bb.ci:                                            ; preds = %bb.cg, %bb.ch, %bb.cf
  %.0108 = phi float [ %i.mu, %bb.cf ], [ %i.nw, %bb.ch ], [ %.mux, %bb.cg ]
  %i.nx = trunc nuw nsw i64 %indvars.iv to i32
  tail call void @_ZN11OpenImageIO4v3_18DeepData14set_deep_valueEliif(ptr noundef nonnull align 8 dereferenceable(20) %0, i64 noundef %1, i32 noundef %i.nx, i32 noundef %i.w, float noundef %.0108)
  br label %bb.cj
...
bb.cn:                                            ; preds = %.lr.ph262, %bb.ea
  ...
  br i1 %.not, label %bb.co, label %bb.ea

bb.co:                                            ; preds = %bb.cn
  br i1 %i.m, label %.thread, label %bb.cp
...
bb.cr:                                            ; preds = %bb.cq
  ...
  %.not19.i.i187.not = icmp sgt i32 %.0105, %i.qf
...
bb.dh:                                            ; preds = %bb.cp, %bb.cq, %bb.cr, %_ZNK11OpenImageIO4v3_18DeepData8data_ptrElii.exit.i188, %bb.cs, %_ZNK9Imath_3_14halfcvfEv.exit.i194, %bb.cz, %bb.da, %bb.db, %bb.dc, %bb.dd, %bb.de, %bb.df, %bb.dg, %_ZNK11OpenImageIO4v3_18DeepData11channeltypeEi.exit24.i196
  ...
  br i1 %or.cond21.i.i200, label %bb.di, label %.thread

bb.di:                                            ; preds = %bb.dh
  %i.sx = load ptr, ptr %0, align 8, !tbaa !36    ; 8 uses
  %.not18.i.i202 = icmp eq ptr %i.sx, null
  br i1 %.not18.i.i202, label %.thread, label %bb.dj
...
bb.dj:                                            ; preds = %bb.di
  ...
  br i1 %or.cond3.i.i203, label %.thread, label %bb.dk
...
bb.dk:                                            ; preds = %bb.dj
  ...
  %.not19.i.i204 = icmp slt i32 %.0105, %i.tg
  br i1 %.not19.i.i204, label %_ZNK11OpenImageIO4v3_18DeepData8data_ptrElii.exit.i205, label %.thread
...
_ZNK11OpenImageIO4v3_18DeepData8data_ptrElii.exit.i205: ; preds = %bb.dk
  ...
  br i1 %.not.i206, label %.thread, label %_ZNK11OpenImageIO4v3_18DeepData11channeltypeEi.exit.i207
...
.thread:                                          ; preds = %bb.co, %bb.dh, %bb.di, %bb.dj, %bb.dk, %_ZNK11OpenImageIO4v3_18DeepData8data_ptrElii.exit.i205, %bb.dl, %_ZNK9Imath_3_14halfcvfEv.exit.i211, %bb.ds, %bb.dt, %bb.du, %bb.dv, %bb.dw, %bb.dx, %bb.dy, %bb.dz, %_ZNK11OpenImageIO4v3_18DeepData11channeltypeEi.exit24.i213
  ...
  %2 = fcmp ogt float %.0.i, 1.000000e+00
  %.1.i = select i1 %2, float 1.000000e+00, float %.0.i ; 2 uses
  %i.vu = fadd float %.1.i121253, %.1.i
  %i.vv = fneg float %.1.i121253
  %i.vw = tail call float @llvm.fmuladd.f32(float %i.vv, float %.1.i, float %i.vu)
...
bb.eb:                                            ; preds = %_ZN11OpenImageIO4v3_18DeepData13erase_samplesElii.exit, %bb.f, %bb.e
  %.1 = phi i32 [ %i.w, %_ZN11OpenImageIO4v3_18DeepData13erase_samplesElii.exit ], [ %.0105, %bb.f ], [ %.0105, %bb.e ]
...
.lr.ph:                                           ; preds = %bb.c, %.lr.ph
  %.049 = phi i32 [ %i.ae, %.lr.ph ], [ 0, %bb.c ] ; 3 uses
  %i.ac = add nsw i32 %.049, %i.r
  %i.ad = tail call noundef zeroext i1 @_ZN11OpenImageIO4v3_18DeepData16copy_deep_sampleEliRKS1_li(ptr noundef nonnull align 8 dereferenceable(20) %0, i64 noundef %1, i32 noundef %i.ac, ptr noundef nonnull align 8 dereferenceable(20) %2, i64 noundef %i.a, i32 noundef %.049) ; 0 uses
  %i.ae = add nuw nsw i32 %.049, 1                ; 2 uses
...
_ZNK11OpenImageIO4v3_18DeepData7samplesEl.exit46: ; preds = %._crit_edge, %bb.d
  %.03651 = phi i32 [ %i.ap, %bb.d ], [ 0, %._crit_edge ] ; 4 uses
...
bb.d:                                             ; preds = %_ZNK11OpenImageIO4v3_18DeepData7samplesEl.exit46
  %i.al = tail call noundef float @_ZNK11OpenImageIO4v3_18DeepData10deep_valueElii(ptr noundef nonnull align 8 dereferenceable(20) %0, i64 noundef %1, i32 noundef %i.y, i32 noundef %.03651)
  %i.am = tail call noundef float @_ZNK11OpenImageIO4v3_18DeepData10deep_valueElii(ptr noundef nonnull align 8 dereferenceable(20) %0, i64 noundef %1, i32 noundef %i.aa, i32 noundef %.03651)
