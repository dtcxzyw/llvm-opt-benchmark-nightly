...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  ...
  %4 = load i8, ptr %i.gd, align 1, !tbaa !16, !alias.scope !136
  %broadcast.splatinsert190 = insertelement <8 x i8> poison, i8 %4, i64 0 ; 7 uses
  %5 = load i8, ptr %i.gc, align 1, !tbaa !16, !alias.scope !139
  %broadcast.splatinsert = insertelement <8 x i8> poison, i8 %5, i64 0 ; 7 uses
  %6 = trunc nuw nsw i64 %n.vec to i32
  %7 = sub nsw i32 %i.da, %6
  %8 = shl nuw nsw i64 %n.vec, 1
  %9 = getelementptr i8, ptr %.572127, i64 %8     ; 2 uses
...
vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  ...
  %10 = load i8, ptr %i.gd, align 1, !tbaa !16, !alias.scope !136
  %broadcast.splatinsert200 = insertelement <4 x i8> poison, i8 %10, i64 0
  %11 = load i8, ptr %i.gc, align 1, !tbaa !16, !alias.scope !139
  %broadcast.splatinsert198 = insertelement <4 x i8> poison, i8 %11, i64 0
  %12 = trunc nuw nsw i64 %n.vec195 to i32
  %13 = sub nsw i32 %i.da, %12
  %14 = shl nuw nsw i64 %n.vec195, 1
  %15 = getelementptr i8, ptr %.572127, i64 %14   ; 2 uses
...
vec.epilog.scalar.ph.preheader:                   ; preds = %vector.memcheck, %iter.check, %vec.epilog.iter.check, %vec.epilog.middle.block
  %.1126.ph = phi i32 [ %i.da, %iter.check ], [ %i.da, %vector.memcheck ], [ %7, %vec.epilog.iter.check ], [ %13, %vec.epilog.middle.block ] ; 4 uses
  %.774124.ph = phi ptr [ %.572127, %iter.check ], [ %.572127, %vector.memcheck ], [ %9, %vec.epilog.iter.check ], [ %15, %vec.epilog.middle.block ] ; 2 uses
...
.loopexit266:                                     ; preds = %vec.epilog.scalar.ph.prol.loopexit, %vec.epilog.scalar.ph, %vec.epilog.middle.block, %middle.block
  %.lcssa179 = phi ptr [ %15, %vec.epilog.middle.block ], [ %9, %middle.block ], [ %.lcssa275.unr, %vec.epilog.scalar.ph.prol.loopexit ], [ %i.ip, %vec.epilog.scalar.ph ]
