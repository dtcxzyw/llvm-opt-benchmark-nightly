...
bb.l:                                             ; preds = %.critedge.i
  ...
  br i1 %or.cond.i.i.i.i, label %.lr.ph.us.preheader.i.i.i.i, label %vector.body

.lr.ph.us.preheader.i.i.i.i:                      ; preds = %bb.l
  %i.ay = zext nneg i32 %i.r to i64               ; 3 uses
  %wide.trip.count29.i.i.i.i = zext nneg i32 %i.t to i64
...
.lr.ph.us.i.i.i.i:                                ; preds = %._crit_edge.us.i.i.i.i, %.lr.ph.us.preheader.i.i.i.i
  %indvars.iv26.i.i.i.i = phi i64 [ 0, %.lr.ph.us.preheader.i.i.i.i ], [ %indvars.iv.next27.i.i.i.i, %._crit_edge.us.i.i.i.i ] ; 2 uses
  %i.ba = mul nuw nsw i64 %indvars.iv26.i.i.i.i, %i.ay
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ac, i64 %i.ba ; 5 uses
  br i1 %i.az, label %.epil.preheader, label %.lr.ph.us.i.i.i.i.new

.lr.ph.us.i.i.i.i.new:                            ; preds = %.lr.ph.us.i.i.i.i, %.lr.ph.us.i.i.i.i.new
  %indvars.iv.i.i.i.i = phi i64 [ %indvars.iv.next.i.i.i.i.3, %.lr.ph.us.i.i.i.i.new ], [ 0, %.lr.ph.us.i.i.i.i ] ; 5 uses
  %niter = phi i64 [ %niter.next.3, %.lr.ph.us.i.i.i.i.new ], [ 0, %.lr.ph.us.i.i.i.i ]
  ...
  br i1 %niter.ncmp.3, label %._crit_edge.us.i.i.i.i.unr-lcssa, label %.lr.ph.us.i.i.i.i.new, !llvm.loop !54

._crit_edge.us.i.i.i.i.unr-lcssa:                 ; preds = %.lr.ph.us.i.i.i.i.new
  br i1 %lcmp.mod.not, label %._crit_edge.us.i.i.i.i, label %.epil.preheader

.epil.preheader:                                  ; preds = %._crit_edge.us.i.i.i.i.unr-lcssa, %.lr.ph.us.i.i.i.i
  %indvars.iv.i.i.i.i.epil.init = phi i64 [ 0, %.lr.ph.us.i.i.i.i ], [ %indvars.iv.next.i.i.i.i.3, %._crit_edge.us.i.i.i.i.unr-lcssa ]
...
bb.m:                                             ; preds = %bb.m, %.epil.preheader
  ...
  br i1 %epil.iter.cmp.not, label %._crit_edge.us.i.i.i.i, label %bb.m, !llvm.loop !56

._crit_edge.us.i.i.i.i:                           ; preds = %bb.m, %._crit_edge.us.i.i.i.i.unr-lcssa
  %indvars.iv.next27.i.i.i.i = add nuw nsw i64 %indvars.iv26.i.i.i.i, 1 ; 2 uses
