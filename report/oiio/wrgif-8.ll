begin_hunk_0_@finish_output_gif:bb.a
  ...
  tail call void %i.ag(ptr noundef nonnull %i.ad) #7, !inline_history !73
  br label %.thread.i
...
begin_hunk_1_@finish_output_gif:bb.a
  ...
  tail call void %i.ax(ptr noundef nonnull %i.au) #7, !inline_history !73
  br label %bb.j
...
begin_hunk_3_@put_LZW_pixel_rows:bb.a
  ...
  %i.ae = load i16, ptr %i.ad, align 2, !tbaa !75 ; 2 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.an = load i16, ptr %i.k, align 4, !tbaa !77  ; 2 uses
  %i.ao = add i16 %i.an, 2
  store i16 %i.ao, ptr %i.j, align 8, !tbaa !76
  tail call fastcc void @output(ptr noundef nonnull %1, i16 noundef signext %i.an)
  %i.ap = load i32, ptr %i.l, align 8, !tbaa !78  ; 2 uses
  store i32 %i.ap, ptr %i.m, align 8, !tbaa !79
  %notmask.i = shl nsw i32 -1, %i.ap
  %i.aq = trunc i32 %notmask.i to i16
  %i.ar = xor i16 %i.aq, -1
  store i16 %i.ar, ptr %i.n, align 4, !tbaa !80
  br label %bb.h
...
begin_hunk_5_@put_LZW_pixel_rows:bb.a
  ...
  %i.bc = load i16, ptr %i.bb, align 2, !tbaa !75 ; 2 uses
