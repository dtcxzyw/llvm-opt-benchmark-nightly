...
begin_hunk_0_@mel_init:.critedge
  ...
  %i.w = icmp eq i64 %spec.select, 255            ; 4 uses
...
begin_hunk_1_@mel_init:.critedge
  ...
  %4 = select i1 %i.w, i64 7, i64 8
  %i.aj = shl i64 %spec.select, %4
  %i.ak = or i64 %i.aj, %spec.select.1            ; 3 uses
  store i64 %i.ak, ptr %i.g, align 8, !tbaa !116
  %5 = select i1 %i.w, i32 15, i32 16             ; 3 uses
  store i32 %5, ptr %i.f, align 8, !tbaa !115
...
begin_hunk_2_@mel_init:.critedge
  ...
  %i.bc = add nuw nsw i32 %5, %i.ay               ; 3 uses
...
bb.m:                                             ; preds = %.critedge.3, %.critedge.2, %.critedge.1, %.critedge
  ...
  %.lcssa = phi i32 [ 8, %.critedge ], [ %5, %.critedge.1 ], [ %i.bc, %.critedge.2 ], [ %i.bu, %.critedge.3 ]
