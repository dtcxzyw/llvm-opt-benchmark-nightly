begin_hunk_0
  ...
  %i.ej = sub i32 %i.eh, %i.ei                    ; 38 uses
...
begin_hunk_1
  ...
  %i.hn = sext i32 %i.ej to i64                   ; 12 uses
...
bb.cp:                                            ; preds = %.lr.ph1946, %.thread1807
  %indvars.iv2043 = phi i64 [ 2, %.lr.ph1946 ], [ %indvars.iv.next2044.pre-phi, %.thread1807 ] ; 8 uses
...
.lr.ph1883:                                       ; preds = %bb.cp
  %13 = trunc nuw nsw i64 %indvars.iv2043 to i32  ; 3 uses
  %14 = mul nuw nsw i32 %i.ej, %13
  %15 = zext nneg i32 %14 to i64
  %16 = getelementptr inbounds nuw [4 x i8], ptr %i.dp, i64 %15
  %i.uz = and i32 %13, 4
...
begin_hunk_4
  ...
  %.214381877 = phi ptr [ %16, %.lr.ph1883 ], [ %i.akc, %bb.em ] ; 7 uses
...
._crit_edge1884:                                  ; preds = %bb.em, %.._crit_edge1884_crit_edge
  %.pre-phi2074 = phi i32 [ %.pre2073, %.._crit_edge1884_crit_edge ], [ %13, %bb.em ]
