...
.lr.ph2003:                                       ; preds = %.loopexit1837
  ...
  %13 = add i32 %i.eh, %i.bbr                     ; 3 uses
  %14 = lshr i32 %13, 3
  %narrow2361.a = add nuw nsw i32 %14, 1
  %15 = zext nneg i32 %narrow2361.a to i64        ; 2 uses
  %i.bbs = lshr i32 %13, 1
  ...
  %min.iters.check2297 = icmp ult i32 %13, 24
  %n.vec2300 = and i64 %15, 1073741820            ; 4 uses
  %i.bcc = trunc nuw nsw i64 %n.vec2300 to i32
  %i.bcd = shl i32 %i.bcc, 3
  %i.bce = shl nuw nsw i64 %n.vec2300, 2          ; 3 uses
  %cmp.n2314 = icmp eq i64 %n.vec2300, %15
  br label %bb.gv
