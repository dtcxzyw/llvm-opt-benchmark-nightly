...
bb.a:
  ...
  %i.f = getelementptr i8, ptr %i.b, i64 -3       ; 3 uses
  ...
  %i.m = select i1 %i.l, i32 3, i32 4             ; 3 uses
  ...
  %. = tail call i32 @llvm.umin.i32(i32 %i.u, i32 %i.d) ; 4 uses
  %.not = icmp eq i32 %i.d, 0
  br i1 %.not, label %.thread41, label %.lr.ph.a

.thread41:                                        ; preds = %bb.a
  %i.v = sub nuw nsw i32 %i.d, %.
  br label %.loopexit.i.sink.split

.lr.ph.a:                                         ; preds = %bb.a, %.lr.ph.a
  %4 = phi i64 [ %i.af, %.lr.ph.a ], [ %i.i, %bb.a ]
  %5 = phi i32 [ %i.ag, %.lr.ph.a ], [ %i.m, %bb.a ] ; 2 uses
  %6 = phi i1 [ %i.ah, %.lr.ph.a ], [ %i.o, %bb.a ]
  %7 = phi ptr [ %i.w, %.lr.ph.a ], [ %i.f, %bb.a ] ; 4 uses
  %.035 = phi i32 [ %8, %.lr.ph.a ], [ 0, %bb.a ]
  %i.w = getelementptr inbounds i8, ptr %7, i64 -1 ; 4 uses
  store ptr %i.w, ptr %0, align 8, !tbaa !123
  %i.x = load i8, ptr %7, align 1, !tbaa !46      ; 2 uses
  %i.y = zext i8 %i.x to i64                      ; 2 uses
  %i.z = and i64 %i.y, 127
  %i.aa = icmp eq i64 %i.z, 127
  %i.ab = select i1 %6, i1 %i.aa, i1 false
  %i.ac = select i1 %i.ab, i32 7, i32 8
  %i.ad = zext nneg i32 %5 to i64
  %i.ae = shl i64 %i.y, %i.ad
  %i.af = or i64 %i.ae, %4                        ; 6 uses
  store i64 %i.af, ptr %i.j, align 8, !tbaa !49
  %i.ag = add i32 %i.ac, %5                       ; 7 uses
  store i32 %i.ag, ptr %i.n, align 8, !tbaa !52
  %i.ah = icmp ugt i8 %i.x, -113                  ; 6 uses
  %i.ai = zext i1 %i.ah to i32
  store i32 %i.ai, ptr %i.q, align 8, !tbaa !124
  %8 = add nuw nsw i32 %.035, 1                   ; 2 uses
  %exitcond.not.a = icmp eq i32 %8, %.
  br i1 %exitcond.not.a, label %._crit_edge, label %.lr.ph.a, !llvm.loop !125

._crit_edge:                                      ; preds = %.lr.ph.a
  %i.aj = sub nsw i32 %i.d, %.                    ; 9 uses
  store i32 %i.aj, ptr %i.e, align 4, !tbaa !122
  %i.ak = icmp ugt i32 %i.ag, 32
...
bb.c:                                             ; preds = %bb.b
  %i.am = getelementptr inbounds i8, ptr %7, i64 -4
  %.val.i = load i32, ptr %i.am, align 4, !tbaa !3
  %i.an = getelementptr inbounds i8, ptr %7, i64 -5
...
.preheader.i:                                     ; preds = %.preheader.i, %.preheader.i.preheader.new
  %i.as = phi ptr [ %i.w, %.preheader.i.preheader.new ], [ %i.bb, %.preheader.i ] ; 3 uses
...
begin_hunk_3_@rev_init:bb.a
  ...
  br i1 %niter.ncmp.1.not, label %.loopexit.i.loopexit.unr-lcssa, label %.preheader.i, !llvm.loop !126

.loopexit.i.sink.split:                           ; preds = %bb.c, %.thread41
  %.sink = phi i32 [ %i.v, %.thread41 ], [ %i.ao, %bb.c ]
  %.ph = phi i64 [ %i.i, %.thread41 ], [ %i.af, %bb.c ]
  %.ph46 = phi i1 [ %i.o, %.thread41 ], [ %i.ah, %bb.c ]
  %.ph47 = phi i32 [ %i.m, %.thread41 ], [ %i.ag, %bb.c ]
...
.preheader.i.epil.preheader:                      ; preds = %.loopexit.i.loopexit.unr-lcssa, %.preheader.i.preheader
  %.epil.init = phi ptr [ %i.w, %.preheader.i.preheader ], [ %i.bb, %.loopexit.i.loopexit.unr-lcssa ] ; 2 uses
...
.loopexit.i:                                      ; preds = %.preheader.i.epil.preheader, %.loopexit.i.loopexit.unr-lcssa, %.loopexit.i.sink.split, %bb.d
  %i.bo = phi i64 [ %.ph, %.loopexit.i.sink.split ], [ %i.af, %bb.d ], [ %i.af, %.loopexit.i.loopexit.unr-lcssa ], [ %i.af, %.preheader.i.epil.preheader ]
  %i.bp = phi i1 [ %.ph46, %.loopexit.i.sink.split ], [ %i.ah, %bb.d ], [ %i.ah, %.loopexit.i.loopexit.unr-lcssa ], [ %i.ah, %.preheader.i.epil.preheader ]
  %i.bq = phi i32 [ %.ph47, %.loopexit.i.sink.split ], [ %i.ag, %bb.d ], [ %i.ag, %.loopexit.i.loopexit.unr-lcssa ], [ %i.ag, %.preheader.i.epil.preheader ] ; 2 uses
...
begin_hunk_10_@frwd_init:bb.a
  ...
  store i32 %i.bi, ptr %i.c, align 4, !tbaa !130
  br label %bb.m
...
bb.n:                                             ; preds = %bb.m
  ...
  store ptr %i.bk, ptr %0, align 8, !tbaa !127
  %i.bl = add nsw i32 %.lcssa41, -5
  store i32 %i.bl, ptr %i.d, align 8, !tbaa !129
...
begin_hunk_12_@frwd_init:bb.a
  ...
  store ptr %i.bq, ptr %0, align 8, !tbaa !127
...
begin_hunk_13_@frwd_init:bb.a
  ...
  store i32 %i.by, ptr %i.d, align 8, !tbaa !129
  %i.bz = add nuw nsw i32 %.04246.i, 8
  %i.ca = icmp samesign ugt i32 %i.bp, 1
  br i1 %i.ca, label %.lr.ph.i, label %frwd_read.exit, !llvm.loop !131
...
begin_hunk_14_@frwd_init:bb.a
  ...
  store i32 %i.cx, ptr %i.c, align 4, !tbaa !130
...
begin_hunk_15_@rev_init_mrp:bb.a
  ...
  br i1 %i.cm, label %.preheader.i, label %.loopexit.i, !llvm.loop !132
...
begin_hunk_16_@mel_get_run:bb.a
  ...
  %niter.next.1 = add i32 %niter, 2               ; 2 uses
  %niter.ncmp.1.not = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1.not, label %._crit_edge.i.loopexit.i.unr-lcssa, label %.lr.ph.i.i, !llvm.loop !133
...
begin_hunk_17_@rev_fetch:bb.a
  ...
  %niter.next.1 = add i32 %niter, 2               ; 2 uses
  %niter.ncmp.1.not = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1.not, label %rev_read.exit.loopexit.unr-lcssa, label %bb.e, !llvm.loop !126
...
begin_hunk_18_@rev_fetch:bb.a
  ...
  br i1 %niter36.ncmp.1.not, label %rev_read.exit12.loopexit.unr-lcssa, label %bb.i, !llvm.loop !126
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.e = load i32, ptr %i.d, align 8, !tbaa !129  ; 10 uses
  %i.f = icmp sgt i32 %i.e, 3
  br i1 %i.f, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %i.g = load ptr, ptr %0, align 8, !tbaa !127    ; 2 uses
...
begin_hunk_20_@frwd_fetch:bb.a
  ...
  store ptr %i.q, ptr %0, align 8, !tbaa !127
...
begin_hunk_22_@frwd_fetch:bb.a
  ...
  store i32 %i.ai, ptr %i.d, align 8, !tbaa !129
  %i.aj = add nuw nsw i32 %.04246.i, 16           ; 2 uses
  %niter.next.1 = add i32 %niter, 2               ; 2 uses
  %niter.ncmp.1.not = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1.not, label %frwd_read.exit.loopexit.unr-lcssa, label %bb.e, !llvm.loop !131
...
begin_hunk_23_@frwd_fetch:bb.a
  ...
  store ptr %i.ak, ptr %0, align 8, !tbaa !127
...
begin_hunk_24_@frwd_fetch:bb.a
  ...
  store i32 %i.as, ptr %i.d, align 8, !tbaa !129
  br label %frwd_read.exit
...
begin_hunk_25_@frwd_fetch:bb.a
  ...
  store i32 %i.bs, ptr %i.au, align 4, !tbaa !130
...
bb.g:                                             ; preds = %bb.f
  %i.cd = load ptr, ptr %0, align 8, !tbaa !127   ; 2 uses
  %.val.i12 = load i32, ptr %i.cd, align 4, !tbaa !3
  %i.ce = getelementptr inbounds nuw i8, ptr %i.cd, i64 4
  store ptr %i.ce, ptr %0, align 8, !tbaa !127
  %i.cf = add nsw i32 %i.at, -4
  store i32 %i.cf, ptr %i.d, align 8, !tbaa !129
...
.lr.ph.i8:                                        ; preds = %bb.h
  %.promoted.i9 = load ptr, ptr %0, align 8, !tbaa !127 ; 2 uses
...
begin_hunk_27_@frwd_fetch:bb.a
  ...
  store ptr %i.cn, ptr %0, align 8, !tbaa !127
...
begin_hunk_29_@frwd_fetch:bb.a
  ...
  store i32 %i.df, ptr %i.d, align 8, !tbaa !129
  ...
  br i1 %niter37.ncmp.1.not, label %frwd_read.exit13.loopexit.unr-lcssa, label %bb.i, !llvm.loop !131
...
begin_hunk_30_@frwd_fetch:bb.a
  ...
  store ptr %i.dh, ptr %0, align 8, !tbaa !127
...
begin_hunk_31_@frwd_fetch:bb.a
  ...
  store i32 %i.dp, ptr %i.d, align 8, !tbaa !129
  br label %frwd_read.exit13
...
begin_hunk_32_@frwd_fetch:bb.a
  ...
  store i32 %i.em, ptr %i.au, align 4, !tbaa !130
...
begin_hunk_33_@rev_fetch_mrp:bb.a
  ...
  %niter.next.1 = add i32 %niter, 2               ; 2 uses
  %niter.ncmp.1.not = icmp eq i32 %niter.next.1, %unroll_iter
  br i1 %niter.ncmp.1.not, label %rev_read_mrp.exit.loopexit.unr-lcssa, label %bb.e, !llvm.loop !132
...
begin_hunk_34_@rev_fetch_mrp:bb.a
  ...
  %niter36.next.1 = add i32 %niter36, 2           ; 2 uses
  %niter36.ncmp.1.not = icmp eq i32 %niter36.next.1, %unroll_iter35
  br i1 %niter36.ncmp.1.not, label %rev_read_mrp.exit12.loopexit.unr-lcssa, label %bb.i, !llvm.loop !132
