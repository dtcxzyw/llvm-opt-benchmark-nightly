...
bb.bn:                                            ; preds = %bb.bm
  ...
  %i.mw = lshr i32 %.sroa.0.0, 12
  %i.mx = and i32 %i.mw, 1
  %i.my = sub i32 %i.ly, %i.mx                    ; 4 uses
...
bb.bq:                                            ; preds = %bb.bp
  ...
  %i.ns = lshr i32 %.sroa.0.0, 13
  %i.nt = and i32 %i.ns, 1
  %i.nu = sub i32 %i.ly, %i.nt                    ; 4 uses
...
bb.bu:                                            ; preds = %bb.bt
  ...
  %i.pa = lshr i32 %.sroa.0.0, 14
  %i.pb = and i32 %i.pa, 1
  %i.pc = sub i32 %i.ly, %i.pb                    ; 4 uses
