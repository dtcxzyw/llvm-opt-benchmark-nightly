...
bb.bn:                                            ; preds = %bb.bm
  ...
  %13 = lshr i32 %.sroa.0.0, 12
  %14 = and i32 %13, 1
  %15 = sub i32 %i.lz, %14                        ; 4 uses
...
bb.bq:                                            ; preds = %bb.bp
  ...
  %16 = lshr i32 %.sroa.0.0, 13
  %17 = and i32 %16, 1
  %18 = sub i32 %i.lz, %17                        ; 4 uses
...
bb.bu:                                            ; preds = %bb.bt
  ...
  %19 = lshr i32 %.sroa.0.0, 14
  %20 = and i32 %19, 1
  %21 = sub i32 %i.lz, %20                        ; 4 uses
...
bb.cb:                                            ; preds = %bb.ca
  ...
  %22 = lshr i32 %.sroa.49.1, 12
  %23 = and i32 %22, 1
  %24 = sub i32 %i.mb, %23                        ; 4 uses
...
bb.ce:                                            ; preds = %bb.cd
  ...
  %25 = lshr i32 %.sroa.49.1, 13
  %26 = and i32 %25, 1
  %27 = sub i32 %i.mb, %26                        ; 4 uses
...
bb.ci:                                            ; preds = %bb.ch
  ...
  %28 = lshr i32 %.sroa.49.1, 14
  %29 = and i32 %28, 1
  %30 = sub i32 %i.mb, %29                        ; 4 uses
...
bb.dl:                                            ; preds = %bb.dk
  ...
  %31 = lshr i32 %.sroa.0.1, 12
  %32 = and i32 %31, 1
  %33 = sub nuw nsw i32 %.sroa.0.01783, %32       ; 4 uses
...
bb.do:                                            ; preds = %bb.dn
  ...
  %34 = lshr i32 %.sroa.0.1, 13
  %35 = and i32 %34, 1
  %36 = sub nuw nsw i32 %.sroa.0.01783, %35       ; 4 uses
...
bb.ds:                                            ; preds = %bb.dr
  ...
  %37 = lshr i32 %.sroa.0.1, 14
  %38 = and i32 %37, 1
  %39 = sub nuw nsw i32 %.sroa.0.01783, %38       ; 4 uses
...
bb.dz:                                            ; preds = %bb.dy
  ...
  %40 = lshr i32 %.sroa.49.3, 12
  %41 = and i32 %40, 1
  %42 = sub nsw i32 %.sroa.12.0, %41              ; 4 uses
...
bb.ec:                                            ; preds = %bb.eb
  ...
  %43 = lshr i32 %.sroa.49.3, 13
  %44 = and i32 %43, 1
  %45 = sub nsw i32 %.sroa.12.0, %44              ; 4 uses
...
bb.eg:                                            ; preds = %bb.ef
  ...
  %46 = lshr i32 %.sroa.49.3, 14
  %47 = and i32 %46, 1
  %48 = sub nsw i32 %.sroa.12.0, %47              ; 4 uses
