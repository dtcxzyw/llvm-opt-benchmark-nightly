...
bb.h:                                             ; preds = %bb.f, %bb.g
  ...
  %.not.i.i21 = icmp eq i32 %i.an, 0
  br i1 %.not.i.i21, label %ps_dimension_end_mask.exit.i22, label %bb.i
...
ps_dimension_end_mask.exit.i22:                   ; preds = %bb.i, %bb.h
  ...
  br i1 %i.aw, label %bb.j, label %._crit_edge.i.i23

._crit_edge.i.i23:                                ; preds = %ps_dimension_end_mask.exit.i22
  %.phi.trans.insert.i.i24 = getelementptr inbounds nuw i8, ptr %0, i64 96
  %.pre.i.i25 = load ptr, ptr %.phi.trans.insert.i.i24, align 8, !tbaa !101
  br label %bb.k

bb.j:                                             ; preds = %ps_dimension_end_mask.exit.i22
  ...
  %.not.i.i.i28 = icmp eq i32 %i.be, 0
  br i1 %.not.i.i.i28, label %ps_mask_table_ensure.exit.thread.i.i30, label %ps_dimension_reset_mask.exit31

ps_mask_table_ensure.exit.thread.i.i30:           ; preds = %bb.j
  store i32 %i.ay, ptr %i.au, align 4, !tbaa !273
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #12
  br label %bb.k

bb.k:                                             ; preds = %ps_mask_table_ensure.exit.thread.i.i30, %._crit_edge.i.i23
  %i.bf = phi ptr [ %.pre.i.i25, %._crit_edge.i.i23 ], [ %i.bd, %ps_mask_table_ensure.exit.thread.i.i30 ]
  ...
  %.not24.i.i26 = icmp eq i32 %i.bl, 0
  br i1 %.not24.i.i26, label %bb.m, label %bb.l
...
ps_dimension_reset_mask.exit31:                   ; preds = %bb.j
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #12
  br label %bb.n
...
bb.n:                                             ; preds = %ps_dimension_reset_mask.exit, %bb.b, %ps_dimension_reset_mask.exit31
  %.014.ph = phi i32 [ %i.be, %ps_dimension_reset_mask.exit31 ], [ 6, %bb.b ], [ %i.aa, %ps_dimension_reset_mask.exit ]
