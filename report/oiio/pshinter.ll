...
bb.a:
  ...
  %.089 = getelementptr inbounds nuw i8, ptr %0, i64 %.089.idx ; 11 uses
  %.089.a = getelementptr inbounds nuw i8, ptr %0, i64 %.092.v ; 9 uses
  store i32 0, ptr %.089, align 8, !tbaa !126
  store i32 0, ptr %.089.a, align 8, !tbaa !126
  %7 = load i32, ptr %.089, align 8, !tbaa !126   ; 2 uses
...
begin_hunk_1_@psh_blues_set_zones:bb.a
  ...
  %.06515.i = phi i32 [ %.166.i, %bb.k ], [ %7, %bb.a ] ; 7 uses
  ...
  %.089..092 = select i1 %or.cond.not.not.i, ptr %.089, ptr %.089.a
...
psh_blues_set_zones_0.exit:                       ; preds = %bb.k, %bb.a
  %.065.lcssa.i = phi i32 [ %7, %bb.a ], [ %.166.i, %bb.k ]
  %.063.lcssa.i = phi i32 [ 0, %bb.a ], [ %.164.i, %bb.k ] ; 3 uses
  store i32 %.065.lcssa.i, ptr %.089, align 8, !tbaa !126
  store i32 %.063.lcssa.i, ptr %.089.a, align 8, !tbaa !126
  %8 = load i32, ptr %.089, align 8, !tbaa !126
...
.lr.ph21.i111.preheader:                          ; preds = %psh_blues_set_zones_0.exit
  %.057.i126 = getelementptr inbounds nuw i8, ptr %.089.a, i64 8 ; 2 uses
...
psh_blues_set_zones_0.exit140:                    ; preds = %bb.s, %psh_blues_set_zones_0.exit
  ...
  store i32 %8, ptr %.089, align 8, !tbaa !126
  store i32 %.063.lcssa.i110, ptr %.089.a, align 8, !tbaa !126
  %9 = load i32, ptr %.089, align 8, !tbaa !126   ; 3 uses
  %.not101 = icmp eq i32 %9, 0                    ; 2 uses
  br i1 %.not101, label %.loopexit141, label %bb.t

bb.t:                                             ; preds = %psh_blues_set_zones_0.exit140
  %i.bn = getelementptr inbounds nuw i8, ptr %.089, i64 8
  br label %bb.u

bb.u:                                             ; preds = %bb.x, %bb.t
  %.094 = phi ptr [ %i.bn, %bb.t ], [ %i.cb, %bb.x ] ; 8 uses
  %.087 = phi i32 [ %9, %bb.t ], [ %i.ca, %bb.x ] ; 2 uses
...
bb.y:                                             ; preds = %.loopexit141
  %i.cc = getelementptr inbounds nuw i8, ptr %.089.a, i64 8
  br label %bb.z
...
bb.ad:                                            ; preds = %.loopexit
  %.0164 = getelementptr inbounds nuw i8, ptr %.089, i64 8 ; 2 uses
  %i.cr = getelementptr inbounds nuw i8, ptr %.089, i64 20 ; 2 uses
  %i.cs = load i32, ptr %i.cr, align 4, !tbaa !128
  %i.ct = sub nsw i32 %i.cs, %5
  store i32 %i.ct, ptr %i.cr, align 4, !tbaa !128
  %i.cu = getelementptr inbounds nuw i8, ptr %.089, i64 16
  %.3153 = add i32 %9, -1                         ; 2 uses
...
bb.af:                                            ; preds = %bb.ae
  %.0164.1 = getelementptr inbounds nuw i8, ptr %.089.a, i64 8 ; 2 uses
  %i.di = getelementptr inbounds nuw i8, ptr %.089.a, i64 20 ; 2 uses
  %i.dj = load i32, ptr %i.di, align 4, !tbaa !128
  %i.dk = sub nsw i32 %i.dj, %5
  store i32 %i.dk, ptr %i.di, align 4, !tbaa !128
  %i.dl = getelementptr inbounds nuw i8, ptr %.089.a, i64 16
