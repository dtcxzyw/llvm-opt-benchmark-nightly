...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep, align 1, !tbaa !31, !noalias !103 ; 3 uses
  %wide.load36 = load <16 x i8>, ptr %i.af, align 1, !tbaa !31, !noalias !103 ; 3 uses
  ...
  store <16 x i8> %i.al, ptr %next.gep, align 1, !tbaa !31, !noalias !103
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load41 = load <8 x i8>, ptr %next.gep40, align 1, !tbaa !31, !noalias !103 ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep, align 1, !tbaa !31, !noalias !112 ; 3 uses
  %wide.load57 = load <16 x i8>, ptr %i.t, align 1, !tbaa !31, !noalias !112 ; 3 uses
  ...
  store <16 x i8> %i.z, ptr %next.gep, align 1, !tbaa !31, !noalias !112
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load62 = load <8 x i8>, ptr %next.gep61, align 1, !tbaa !31, !noalias !112 ; 3 uses
...
vector.body72:                                    ; preds = %vector.body72, %vector.ph69
  ...
  %wide.load75 = load <16 x i8>, ptr %next.gep74, align 1, !tbaa !31, !noalias !118 ; 3 uses
  %wide.load76 = load <16 x i8>, ptr %i.bj, align 1, !tbaa !31, !noalias !118 ; 3 uses
  ...
  store <16 x i8> %i.bp, ptr %next.gep74, align 1, !tbaa !31, !noalias !118
...
vec.epilog.vector.body88:                         ; preds = %vec.epilog.vector.body88, %vec.epilog.ph85
  ...
  %wide.load91 = load <8 x i8>, ptr %next.gep90, align 1, !tbaa !31, !noalias !118 ; 3 uses
