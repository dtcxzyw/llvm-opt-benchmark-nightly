...
vector.body:                                      ; preds = %vector.memcheck, %vector.body
  ...
  %offset.idx184 = shl i64 %index, 2
  %next.gep185 = getelementptr i8, ptr %i.aw, i64 %offset.idx184 ; 2 uses
...
vector.body229:                                   ; preds = %vector.memcheck191, %vector.body229
  %index230 = phi i64 [ %index.next243, %vector.body229 ], [ 0, %vector.memcheck191 ] ; 3 uses
  %offset.idx231 = shl i64 %index230, 2
  %next.gep232 = getelementptr i8, ptr %i.ct, i64 %offset.idx231 ; 2 uses
  %offset.idx233 = shl i64 %index230, 2
  %next.gep234 = getelementptr i8, ptr %i.co, i64 %offset.idx233 ; 2 uses
