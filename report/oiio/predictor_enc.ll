...
.epil.preheader:                                  ; preds = %._crit_edge104.loopexit.unr-lcssa, %.lr.ph103
  ...
  %.080100.epil.init = phi i32 [ 0, %.lr.ph103 ], [ %i.aq, %._crit_edge104.loopexit.unr-lcssa ]
  ...
  %i.az = add i32 %i.ax, %.080100.epil.init
...
._crit_edge104:                                   ; preds = %._crit_edge104.loopexit, %bb.c
  %.080.lcssa = phi i64 [ 0, %bb.c ], [ %i.ba, %._crit_edge104.loopexit ]
  %i.bb = tail call ptr @WebPSafeMalloc(i64 noundef %.080.lcssa, i64 noundef 4) #10 ; 6 uses
  %i.bc = icmp eq ptr %i.bb, null
  br i1 %i.bc, label %bb.av, label %bb.e

bb.e:                                             ; preds = %._crit_edge104
  ...
  %.not85.not105 = icmp slt i32 %2, %3
  br i1 %.not85.not105, label %.lr.ph108.preheader, label %._crit_edge109

.lr.ph108.preheader:                              ; preds = %bb.e
  %wide.trip.count142 = sext i32 %3 to i64        ; 3 uses
  %i.bf = sub nsw i64 %wide.trip.count142, %i.bd
  %xtraiter222 = and i64 %i.bf, 3                 ; 2 uses
  %lcmp.mod223.not = icmp eq i64 %xtraiter222, 0
  br i1 %lcmp.mod223.not, label %.lr.ph108.prol.loopexit, label %.lr.ph108.prol

.lr.ph108.prol:                                   ; preds = %.lr.ph108.preheader, %.lr.ph108.prol
  %i.bg = phi ptr [ %i.bk, %.lr.ph108.prol ], [ %i.bb, %.lr.ph108.preheader ]
  %indvars.iv139.prol = phi i64 [ %indvars.iv.next140.prol, %.lr.ph108.prol ], [ %i.bd, %.lr.ph108.preheader ] ; 2 uses
  %prol.iter = phi i64 [ %prol.iter.next, %.lr.ph108.prol ], [ 0, %.lr.ph108.preheader ]
  %indvars.iv.next140.prol = add nsw i64 %indvars.iv139.prol, 1 ; 3 uses
  %i.bh = getelementptr inbounds [4 x i8], ptr %i.c, i64 %indvars.iv139.prol
  %i.bi = load i32, ptr %i.bh, align 4, !tbaa !3
  %i.bj = zext i32 %i.bi to i64
  %i.bk = getelementptr inbounds nuw [4 x i8], ptr %i.bg, i64 %i.bj ; 3 uses
  %i.bl = getelementptr inbounds [8 x i8], ptr %i.b, i64 %indvars.iv.next140.prol
  store ptr %i.bk, ptr %i.bl, align 8, !tbaa !19
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter222
  br i1 %prol.iter.cmp.not, label %.lr.ph108.prol.loopexit, label %.lr.ph108.prol, !llvm.loop !22

.lr.ph108.prol.loopexit:                          ; preds = %.lr.ph108.prol, %.lr.ph108.preheader
  %.unr = phi ptr [ %i.bb, %.lr.ph108.preheader ], [ %i.bk, %.lr.ph108.prol ]
  %indvars.iv139.unr = phi i64 [ %i.bd, %.lr.ph108.preheader ], [ %indvars.iv.next140.prol, %.lr.ph108.prol ]
  %i.bm = sub nsw i64 %i.bd, %wide.trip.count142
  %i.bn = icmp ugt i64 %i.bm, -4
  br i1 %i.bn, label %._crit_edge109, label %.lr.ph108

.lr.ph108:                                        ; preds = %.lr.ph108.prol.loopexit, %.lr.ph108
  %i.bo = phi ptr [ %i.ch, %.lr.ph108 ], [ %.unr, %.lr.ph108.prol.loopexit ]
  %indvars.iv139 = phi i64 [ %indvars.iv.next140.3, %.lr.ph108 ], [ %indvars.iv139.unr, %.lr.ph108.prol.loopexit ] ; 5 uses
  %indvars.iv.next140 = add nsw i64 %indvars.iv139, 1 ; 2 uses
  %i.bp = getelementptr inbounds [4 x i8], ptr %i.c, i64 %indvars.iv139
  %i.bq = load i32, ptr %i.bp, align 4, !tbaa !3
  %i.br = zext i32 %i.bq to i64
  %i.bs = getelementptr inbounds nuw [4 x i8], ptr %i.bo, i64 %i.br ; 2 uses
  %i.bt = getelementptr inbounds [8 x i8], ptr %i.b, i64 %indvars.iv.next140
  store ptr %i.bs, ptr %i.bt, align 8, !tbaa !19
  %indvars.iv.next140.1 = add nsw i64 %indvars.iv139, 2 ; 2 uses
  %i.bu = getelementptr inbounds [4 x i8], ptr %i.c, i64 %indvars.iv.next140
  %i.bv = load i32, ptr %i.bu, align 4, !tbaa !3
  %i.bw = zext i32 %i.bv to i64
  %i.bx = getelementptr inbounds nuw [4 x i8], ptr %i.bs, i64 %i.bw ; 2 uses
  %i.by = getelementptr inbounds [8 x i8], ptr %i.b, i64 %indvars.iv.next140.1
  store ptr %i.bx, ptr %i.by, align 8, !tbaa !19
  %indvars.iv.next140.2 = add nsw i64 %indvars.iv139, 3 ; 2 uses
  %i.bz = getelementptr inbounds [4 x i8], ptr %i.c, i64 %indvars.iv.next140.1
  %i.ca = load i32, ptr %i.bz, align 4, !tbaa !3
  %i.cb = zext i32 %i.ca to i64
  %i.cc = getelementptr inbounds nuw [4 x i8], ptr %i.bx, i64 %i.cb ; 2 uses
  %i.cd = getelementptr inbounds [8 x i8], ptr %i.b, i64 %indvars.iv.next140.2
  store ptr %i.cc, ptr %i.cd, align 8, !tbaa !19
  %indvars.iv.next140.3 = add nsw i64 %indvars.iv139, 4 ; 3 uses
  %i.ce = getelementptr inbounds [4 x i8], ptr %i.c, i64 %indvars.iv.next140.2
  %i.cf = load i32, ptr %i.ce, align 4, !tbaa !3
  %i.cg = zext i32 %i.cf to i64
  %i.ch = getelementptr inbounds nuw [4 x i8], ptr %i.cc, i64 %i.cg ; 2 uses
  %i.ci = getelementptr inbounds [8 x i8], ptr %i.b, i64 %indvars.iv.next140.3
  store ptr %i.ch, ptr %i.ci, align 8, !tbaa !19
  %exitcond143.not.3 = icmp eq i64 %indvars.iv.next140.3, %wide.trip.count142
  br i1 %exitcond143.not.3, label %._crit_edge109, label %.lr.ph108, !llvm.loop !24

._crit_edge109:                                   ; preds = %.lr.ph108.prol.loopexit, %.lr.ph108, %bb.e
  ...
  br i1 %i.df, label %GetBestPredictorsAndSubSampling.exit.thread, label %.preheader174.i

.preheader174.i:                                  ; preds = %._crit_edge109
  %.not187.i = icmp eq i32 %i.cp, 0
  br i1 %.not187.i, label %.preheader.i.preheader, label %.lr.ph.i

.lr.ph.i:                                         ; preds = %.preheader174.i
  ...
  %i.dl = icmp sgt i32 %.fr122, 1                 ; 2 uses
...
bb.f:                                             ; preds = %bb.ar, %.lr.ph.i
  %.0145182.i = phi i32 [ 0, %.lr.ph.i ], [ %.1146.i, %bb.ar ] ; 2 uses
  %.0147181.i = phi i32 [ 0, %.lr.ph.i ], [ %.1148.i, %bb.ar ] ; 2 uses
  %.0150180.i = phi i32 [ 0, %.lr.ph.i ], [ %i.ni, %bb.ar ] ; 3 uses
  %.0151179.i = phi i32 [ 0, %.lr.ph.i ], [ %i.ng, %bb.ar ] ; 3 uses
  %.0152178.i = phi i32 [ 0, %.lr.ph.i ], [ %.2154.i, %bb.ar ] ; 2 uses
  %.0155177.i = phi i32 [ 0, %.lr.ph.i ], [ %.2157.i, %bb.ar ] ; 2 uses
  %i.dt = shl i32 %.0151179.i, %2                 ; 7 uses
  %i.du = shl i32 %.0150180.i, %2                 ; 4 uses
...
.split.us.i.i.us:                                 ; preds = %.split.us.i.i.preheader, %._crit_edge127.us.i.split.i.split.us118
  %indvars.iv148.i.i.us = phi i64 [ %indvars.iv.next149.i.i.us, %._crit_edge127.us.i.split.i.split.us118 ], [ 0, %.split.us.i.i.preheader ] ; 2 uses
  %.0131.us.i.i.us = phi ptr [ %.1100123.us.i.i.us113, %._crit_edge127.us.i.split.i.split.us118 ], [ %6, %.split.us.i.i.preheader ]
  %.099130.us.i.i.us = phi ptr [ %.1124.us.i.i.us112, %._crit_edge127.us.i.split.i.split.us118 ], [ %i.di, %.split.us.i.i.preheader ] ; 2 uses
...
bb.h:                                             ; preds = %.lr.ph126.us.i.i.us, %.loopexit.split.us.i.i.us115
  %indvars.iv143.i.i.us111 = phi i64 [ 0, %.lr.ph126.us.i.i.us ], [ %indvars.iv.next144.i.i.us116, %.loopexit.split.us.i.i.us115 ] ; 2 uses
  %.1124.us.i.i.us112 = phi ptr [ %.0131.us.i.i.us, %.lr.ph126.us.i.i.us ], [ %.1100123.us.i.i.us113, %.loopexit.split.us.i.i.us115 ] ; 4 uses
  %.1100123.us.i.i.us113 = phi ptr [ %.099130.us.i.i.us, %.lr.ph126.us.i.i.us ], [ %.1124.us.i.i.us112, %.loopexit.split.us.i.i.us115 ] ; 3 uses
  %i.ex = add nsw i64 %indvars.iv143.i.i.us111, %i.eu ; 4 uses
  %i.ey = getelementptr inbounds [4 x i8], ptr %.1124.us.i.i.us112, i64 %i.ei
  %i.ez = mul nsw i64 %i.ex, %i.dg
  %gep.us.i.i.us114 = getelementptr [4 x i8], ptr %invariant.gep.i.i, i64 %i.ez ; 2 uses
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 4 %i.ey, ptr readonly align 4 %gep.us.i.i.us114, i64 %i.fe, i1 false)
  %i.ff = icmp sgt i64 %i.ex, 0
  %brmerge.not.us.i.i.us = select i1 %i.ff, i1 %i.fa, i1 false
  br i1 %brmerge.not.us.i.i.us, label %bb.i, label %.loopexit.split.us.i.i.us115

bb.i:                                             ; preds = %bb.h
  call fastcc void @MaxDiffsForRow(i32 noundef %i.ef, i32 noundef %0, ptr noundef readonly %gep.us.i.i.us114, ptr noundef nonnull %i.er, i32 noundef %10)
  br label %.loopexit.split.us.i.i.us115

.loopexit.split.us.i.i.us115:                     ; preds = %bb.i, %bb.h
  %i.fg = trunc nsw i64 %i.ex to i32
  call fastcc void @GetResidual(i32 noundef %0, i32 noundef %1, ptr noundef %.1100123.us.i.i.us113, ptr noundef %.1124.us.i.i.us112, ptr noundef nonnull %i.dk, i32 noundef %i.ew, i32 noundef %i.dt, i32 noundef %i.es, i32 noundef %i.fg, i32 noundef %.fr122, i32 noundef %9, i32 noundef %10, ptr noundef nonnull %i.a)
  %indvars.iv.next144.i.i.us116 = add nuw nsw i64 %indvars.iv143.i.i.us111, 1 ; 2 uses
  %exitcond147.not.i.i.us117 = icmp eq i64 %indvars.iv.next144.i.i.us116, %wide.trip.count146.i.i
  br i1 %exitcond147.not.i.i.us117, label %._crit_edge127.us.i.split.i.split.us118, label %bb.h, !llvm.loop !25

._crit_edge127.us.i.split.i.split.us118:          ; preds = %.loopexit.split.us.i.i.us115
...
.lr.ph.us.i.preheader.us.us.i:                    ; preds = %bb.l, %bb.k
  ...
  call fastcc void @GetResidual(i32 noundef %0, i32 noundef %1, ptr noundef %.1100123.us.i.us.us.i, ptr noundef %.1124.us.i.us.us.i, ptr noundef nonnull %i.dk, i32 noundef %i.fj, i32 noundef %i.dt, i32 noundef %i.es, i32 noundef %i.ft, i32 noundef %.fr122, i32 noundef %9, i32 noundef %10, ptr noundef nonnull %i.a)
