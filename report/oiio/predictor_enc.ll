...
PredictionCostBias.exit.i.i.i:                    ; preds = %bb.ab, %bb.aa
  ...
  %i.li = call i64 %i.lh(ptr noundef nonnull %gep.i.i, ptr noundef nonnull %i.ja) #12
...
PredictionCostBias.exit.1.i.i.i:                  ; preds = %bb.aj, %bb.ai
  ...
  %i.mn = call i64 %i.mm(ptr noundef nonnull %i.lj, ptr noundef nonnull %i.kb) #12
...
PredictionCostBias.exit.2.i.i.i:                  ; preds = %bb.ar, %bb.aq
  ...
  %i.ns = call i64 %i.nr(ptr noundef nonnull %i.mo, ptr noundef nonnull %i.kc) #12
...
PredictionCostSpatialHistogram.exit.i.i:          ; preds = %bb.az, %bb.ay
  ...
  %i.ox = call i64 %i.ow(ptr noundef nonnull %i.nt, ptr noundef nonnull %i.kd) #12
...
begin_hunk_4_@VP8LResidualImage:bb.a
  ...
  br i1 %exitcond.not.i170.i, label %GetBestPredictorForTile.exit.i, label %bb.t, !llvm.loop !32
...
GetBestPredictorForTile.exit.i:                   ; preds = %PredictionCostSpatialHistogram.exit.i.i
  ...
  call void %i.po(ptr noundef %.143.i.i, ptr noundef nonnull %i.ja, i32 noundef 1024) #12
...
begin_hunk_5_@VP8LResidualImage:bb.a
  ...
  call void %i.qe(ptr noundef %invariant.gep.i166.i, ptr noundef nonnull %i.qh, i32 noundef 14336) #12
  br label %bb.bc
...
bb.bo:                                            ; preds = %bb.bm, %bb.bl
  ...
  br i1 %i.ri, label %bb.f, label %.preheader.i.preheader, !llvm.loop !33
...
begin_hunk_7_@VP8LResidualImage:bb.a
  ...
  %i.rq = call i64 %i.rm(ptr noundef nonnull %i.rp, i32 noundef 14) #12
  %i.rr = load ptr, ptr @VP8LShannonEntropy, align 8, !tbaa !31
  %i.rs = call i64 %i.rr(ptr noundef nonnull %i.rl, i32 noundef 256) #12
  ...
  %i.rw = call i64 %i.ru(ptr noundef nonnull %i.rv, i32 noundef 256) #12
  ...
  %i.sa = call i64 %i.ry(ptr noundef nonnull %i.rz, i32 noundef 256) #12
  ...
  %i.se = call i64 %i.sc(ptr noundef nonnull %i.sd, i32 noundef 256) #12
...
begin_hunk_8_@VP8LResidualImage:bb.a
  ...
  br i1 %.not.i, label %bb.br, label %.preheader.i, !llvm.loop !34
...
begin_hunk_9_@VP8LResidualImage:bb.a
  ...
  tail call void %i.tl(ptr noundef %6, ptr noundef null, i32 noundef 1, ptr noundef %5) #12
  ...
  tail call void %i.tn(ptr noundef nonnull %i.to, ptr noundef null, i32 noundef %i.h, ptr noundef nonnull %i.tm) #12
...
begin_hunk_10_@VP8LResidualImage:bb.a
  ...
  br i1 %i.ut, label %bb.bw, label %.PredictBatch.exit.loopexit_crit_edge.us.us.i, !llvm.loop !35

.PredictBatch.exit.loopexit_crit_edge.us.us.i:    ; preds = %bb.bw
  %exitcond117.not.i = icmp eq i64 %indvars.iv.next114.i, %i.ts
  br i1 %exitcond117.not.i, label %CopyImageWithPrediction.exit, label %.lr.ph89.split.us.split.us.i, !llvm.loop !36
...
PredictBatch.exit.loopexit.us.us95.i:             ; preds = %bb.bx, %.lr.ph89.split.us.split.split.us.i
  ...
  br i1 %exitcond112.not.i, label %CopyImageWithPrediction.exit, label %.lr.ph89.split.us.split.split.us.i, !llvm.loop !36
...
begin_hunk_12_@VP8LResidualImage:bb.a
  ...
  br i1 %niter262.ncmp.1, label %CopyImageWithPrediction.exit.loopexit241.unr-lcssa, label %PredictBatch.exit.loopexit.us.i, !llvm.loop !36
...
begin_hunk_13_@VP8LResidualImage:bb.a
  ...
  tail call void %i.wb(ptr noundef nonnull %.07288.i, ptr noundef nonnull %.07387.i, i32 noundef 1, ptr noundef %i.vv) #12
  ...
  tail call void %i.wd(ptr noundef nonnull %i.we, ptr noundef nonnull %i.wf, i32 noundef %i.h, ptr noundef nonnull %i.wc) #12
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %i.tf
  br i1 %exitcond.not.i, label %CopyImageWithPrediction.exit, label %PredictBatch.exit.i, !llvm.loop !37
...
begin_hunk_14_@VP8LColorSpaceTransform:bb.a
  ...
  call void %i.bd(ptr noundef nonnull %10, ptr noundef %.01415.i.us, i32 noundef %i.ay) #12
  %i.be = getelementptr inbounds [4 x i8], ptr %.01415.i.us, i64 %i.l
  %i.bf = icmp samesign ugt i32 %.016.i.us, 1
  br i1 %i.bf, label %bb.d, label %CopyTileWithColorTransform.exit.us, !llvm.loop !39
...
._crit_edge171.us:                                ; preds = %._crit_edge.us, %CopyTileWithColorTransform.exit.us
  ...
  br i1 %exitcond205.not, label %._crit_edge180.us, label %bb.b, !llvm.loop !40
...
begin_hunk_16_@VP8LColorSpaceTransform:bb.a
  ...
  br i1 %exitcond202.not, label %._crit_edge171.us, label %bb.e, !llvm.loop !41
...
begin_hunk_17_@VP8LColorSpaceTransform:bb.a
  ...
  br i1 %exitcond201.not, label %._crit_edge.us, label %.lr.ph.us, !llvm.loop !42
...
bb.n:                                             ; preds = %._crit_edge180.us
  ...
  br i1 %exitcond209.not, label %._crit_edge193, label %.preheader.us, !llvm.loop !43
...
begin_hunk_19_@GetBestColorTransformForTile:bb.a
  ...
  call void %i.s(ptr noundef %i.r, i32 noundef %6, i32 noundef %i.l, i32 noundef %i.m, i32 noundef 0, ptr noundef nonnull %i.d) #12
  %i.t = load ptr, ptr @VP8LCombinedShannonEntropy, align 8, !tbaa !31
  %i.u = call i64 %i.t(ptr noundef nonnull %i.d, ptr noundef nonnull %8) #12
...
begin_hunk_20_@GetBestColorTransformForTile:bb.a
  ...
  call void %i.bp(ptr noundef %i.r, i32 noundef %6, i32 noundef %i.l, i32 noundef %i.m, i32 noundef %i.bo, ptr noundef nonnull %i.c) #12
  %i.bq = load ptr, ptr @VP8LCombinedShannonEntropy, align 8, !tbaa !31
  %i.br = call i64 %i.bq(ptr noundef nonnull %i.c, ptr noundef nonnull %8) #12
...
begin_hunk_21_@GetBestColorTransformForTile:bb.a
  ...
  br i1 %.not.i, label %._crit_edge.i, label %bb.j, !llvm.loop !44
...
begin_hunk_22_@GetBestColorTransformForTile:bb.a
  ...
  call void %i.dg(ptr noundef %i.r, i32 noundef %6, i32 noundef %i.l, i32 noundef %i.m, i32 noundef 0, i32 noundef 0, ptr noundef nonnull %i.a) #12
  %i.dh = load ptr, ptr @VP8LCombinedShannonEntropy, align 8, !tbaa !31
  %i.di = call i64 %i.dh(ptr noundef nonnull %i.a, ptr noundef nonnull %9) #12
...
begin_hunk_23_@GetBestColorTransformForTile:bb.a
  ...
  br i1 %i.fd, label %bb.ab, label %GetBestGreenRedToBlue.exit, !llvm.loop !46
...
begin_hunk_24_@GetBestColorTransformForTile:bb.a
  ...
  %i.ff = load i8, ptr %i.fe, align 1, !tbaa !47
...
begin_hunk_25_@GetBestColorTransformForTile:bb.a
  ...
  %i.fj = load i8, ptr %i.fi, align 2, !tbaa !47
  ...
  call void %i.fs(ptr noundef %i.r, i32 noundef %6, i32 noundef %i.l, i32 noundef %i.m, i32 noundef %i.fm, i32 noundef %i.fr, ptr noundef nonnull %i.b) #12
  %i.ft = load ptr, ptr @VP8LCombinedShannonEntropy, align 8, !tbaa !31
  %i.fu = call i64 %i.ft(ptr noundef nonnull %i.b, ptr noundef nonnull %9) #12
...
begin_hunk_26_@GetBestColorTransformForTile:bb.a
  ...
  br i1 %or.cond80.i, label %bb.ac, label %bb.al, !llvm.loop !48
...
begin_hunk_27_@MaxDiffsForRow:bb.a
  ...
  store i8 %i.dv, ptr %i.dw, align 1, !tbaa !47
...
bb.d:                                             ; preds = %bb.c
  ...
  tail call void %i.d(ptr noundef %3, ptr noundef null, i32 noundef 1, ptr noundef %12) #12
  br label %bb.f

bb.e:                                             ; preds = %bb.c
  %i.e = load ptr, ptr getelementptr inbounds nuw (i8, ptr @VP8LPredictorsSub, i64 16), align 16, !tbaa !31
  tail call void %i.e(ptr noundef %3, ptr noundef %2, i32 noundef 1, ptr noundef %12) #12
  br label %bb.f
...
begin_hunk_29_@GetResidual:bb.a
  ...
  tail call void %i.i(ptr noundef nonnull %i.k, ptr noundef null, i32 noundef %.022.i, ptr noundef %.0.i) #12
...
begin_hunk_30_@GetResidual:bb.a
  ...
  tail call void %i.n(ptr noundef nonnull %i.p, ptr noundef nonnull %i.q, i32 noundef %.022.i, ptr noundef %.0.i) #12
  br label %PredictBatch.exit
...
begin_hunk_31_@GetResidual:bb.a
  ...
  br i1 %exitcond114.not, label %PredictBatch.exit, label %.lr.ph.split.us, !llvm.loop !50
...
begin_hunk_32_@GetResidual:bb.a
  ...
  br i1 %exitcond110.not, label %PredictBatch.exit, label %.lr.ph.split.split.us, !llvm.loop !50
...
begin_hunk_33_@GetResidual:bb.a
  ...
  br i1 %exitcond105.not, label %PredictBatch.exit, label %.lr.ph.split.split.split.us, !llvm.loop !50
...
begin_hunk_34_@GetResidual:bb.a
  ...
  %i.dd = load i8, ptr %i.dc, align 1, !tbaa !47  ; 2 uses
...
begin_hunk_35_@GetResidual:bb.a
  ...
  br i1 %.not.i, label %bb.aa, label %.preheader.i, !llvm.loop !51
...
begin_hunk_36_@GetResidual:bb.a
  ...
  br i1 %exitcond.not, label %PredictBatch.exit, label %.lr.ph.split.split.split, !llvm.loop !50
