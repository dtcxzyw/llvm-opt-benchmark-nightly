...
bb.k:                                             ; preds = %.loopexit.split.us.i.us.us.i, %.lr.ph126.us.i.us.i
  %indvars.iv143.i.us.us.i.a = phi i64 [ 0, %.lr.ph126.us.i.us.i ], [ %indvars.iv.next144.i.us.us.i, %.loopexit.split.us.i.us.us.i ] ; 2 uses
  ...
  %i.fk = add nsw i64 %indvars.iv143.i.us.us.i.a, %i.eu ; 4 uses
...
.loopexit.split.us.i.us.us.i:                     ; preds = %._crit_edge120.us.i.us.us.i, %._crit_edge.us.i.us.us.i
  %indvars.iv.next144.i.us.us.i = add nuw nsw i64 %indvars.iv143.i.us.us.i.a, 1 ; 2 uses
...
.lr.ph126.us.i.i:                                 ; preds = %bb.n, %.split.us.i.i
  %i.id = trunc nuw nsw i64 %indvars.iv148.i.i to i32
...
.loopexit.split.us.i.i.us:                        ; preds = %.loopexit.split.us.i.i.us, %.lr.ph126.us.i.i
  ...
  %.1124.us.i.i.us = phi ptr [ %.0131.us.i.i, %.lr.ph126.us.i.i ], [ %.1100123.us.i.i.us, %.loopexit.split.us.i.i.us ] ; 4 uses
  %.1100123.us.i.i.us = phi ptr [ %.099130.us.i.i, %.lr.ph126.us.i.i ], [ %.1124.us.i.i.us, %.loopexit.split.us.i.i.us ] ; 3 uses
  %i.ie = add nsw i64 %indvars.iv143.i.i.us, %i.eu ; 3 uses
  ...
  %indvars.iv.next144.i.i.us = add nuw nsw i64 %indvars.iv143.i.i.us, 1 ; 2 uses
  %exitcond147.not.i.i.us = icmp eq i64 %indvars.iv.next144.i.i.us, %wide.trip.count146.i.i
  br i1 %exitcond147.not.i.i.us, label %._crit_edge127.us.i.split.i.split.us, label %.loopexit.split.us.i.i.us, !llvm.loop !25

._crit_edge127.us.i.split.i.split.us:             ; preds = %.loopexit.split.us.i.i.us
  %indvars.iv.next149.i.i = add nuw nsw i64 %indvars.iv148.i.i, 1 ; 2 uses
  %exitcond151.not.i.i = icmp eq i64 %indvars.iv.next149.i.i, 14
  br i1 %exitcond151.not.i.i, label %ComputeResidualsForTile.exit.i, label %.split.us.i.i, !llvm.loop !26

.split.i.i:                                       ; preds = %bb.f
  br i1 %i.eg, label %.split.split.preheader.i.i, label %ComputeResidualsForTile.exit.i

.split.split.preheader.i.i:                       ; preds = %.split.i.i
...
ComputeResidualsForTile.exit.i:                   ; preds = %._crit_edge127.us.i.split.i.split.us, %._crit_edge127.us.i.split.i.split.us126, %._crit_edge127.us.i.split.us.us.i, %.split.split.preheader.i.i, %.split.i.i
