...
_ZSt4copyIPN11OpenImageIO4v3_18TypeDescES3_ET0_T_S5_S4_.exit: ; preds = %bb.l, %bb.m, %bb.n
  ...
  %i.af = load ptr, ptr %i.u, align 8, !tbaa !127 ; 5 uses
  %i.ag = load ptr, ptr %0, align 8, !tbaa !78    ; 2 uses
...
bb.f:                                             ; preds = %bb.f, %.lr.ph.i.i.i.i
  ...
  store ptr null, ptr %.09.i.i.i.i, align 8, !tbaa !104
  %i.g = getelementptr inbounds nuw i8, ptr %.09.i.i.i.i, i64 8
  store <4 x i8> <i8 0, i8 1, i8 0, i8 0>, ptr %i.g, align 8, !tbaa !16
  ...
  %.sroa.0.0.copyload.i.i.i.i.i.i.i = load ptr, ptr %.sroa.04.08.i.i.i.i, align 8, !tbaa !145
  ...
  %i.q = load i8, ptr %i.p, align 2, !tbaa !149, !range !114, !noundef !150
  ...
  %i.y = and i64 %i.x, 255
  %i.z = tail call noundef i64 @_ZNK11OpenImageIO4v3_18TypeDesc8basesizeEv(ptr noundef nonnull align 4 dereferenceable(8) %i.j) #19
  ...
  br i1 %.not.i.i.i.i, label %_ZSt22__uninitialized_copy_aIN9__gnu_cxx17__normal_iteratorIPKN11OpenImageIO4v3_110ParamValueESt6vectorIS4_SaIS4_EEEEPS4_S4_ET0_T_SD_SC_RSaIT1_E.exit, label %bb.f, !llvm.loop !152
...
; Function Attrs: nounwind
declare noundef nonnull align 8 dereferenceable(39) ptr @_ZN11OpenImageIO4v3_110ParamValueaSERKS1_(ptr noundef nonnull align 8 dereferenceable(39), ptr noundef nonnull align 8 dereferenceable(39)) local_unnamed_addr #2
...
declare void @_ZN11OpenImageIO4v3_17Strutil5splitENS0_17basic_string_viewIcSt11char_traitsIcEEERSt6vectorIS5_SaIS5_EES5_i(ptr noundef dead_on_return, ptr noundef nonnull align 8 dereferenceable(24), ptr noundef dead_on_return, i32 noundef) local_unnamed_addr #1
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = load ptr, ptr %0, align 8, !tbaa !98     ; 4 uses
  %i.d = ptrtoint ptr %i.b to i64                 ; 2 uses
  %i.e = ptrtoint ptr %i.c to i64                 ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  store float 0.000000e+00, ptr %i.b, align 4, !tbaa !99
...
_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i: ; preds = %bb.c
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.p, i8 0, i64 %.idx.i.i.i.i.i, i1 false), !tbaa !99
...
_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit:    ; preds = %bb.d
  ...
  store float 0.000000e+00, ptr %i.y, align 4, !tbaa !99
...
_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i30: ; preds = %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.ab, i8 0, i64 %.idx.i.i.i.i.i31, i1 false), !tbaa !99
...
_ZNSt12_Vector_baseIfSaIfEE13_M_deallocateEPfm.exit36: ; preds = %_ZNSt6vectorIfSaIfEE11_S_relocateEPfS2_S2_RS0_.exit, %bb.g
  store ptr %i.x, ptr %0, align 8, !tbaa !98
  %i.ae = getelementptr inbounds nuw [4 x i8], ptr %i.y, i64 %1
  store ptr %i.ae, ptr %i.a, align 8, !tbaa !95
  %i.af = getelementptr inbounds nuw [4 x i8], ptr %i.x, i64 %i.v
  store ptr %i.af, ptr %i.h, align 8, !tbaa !101
  br label %bb.h
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !95   ; 16 uses
...
vector.body119:                                   ; preds = %vector.body119, %vector.ph114
  ...
  store <4 x float> %broadcast.splat118, ptr %i.bn, align 4, !tbaa !99
  %index.next122 = add nuw i64 %index120, 8       ; 2 uses
  %i.bo = icmp eq i64 %index.next122, %n.vec116
  br i1 %i.bo, label %middle.block123, label %vector.body119, !llvm.loop !157
...
bb.q:                                             ; preds = %bb.b
  %i.bq = load ptr, ptr %0, align 8, !tbaa !98    ; 5 uses
...
bb.s:                                             ; preds = %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit
  ...
  %i.cd = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.cc) #24
  br label %bb.t
...
bb.t:                                             ; preds = %bb.s, %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit
  ...
  %i.ch = load float, ptr %3, align 4, !tbaa !99  ; 2 uses
...
vector.body147:                                   ; preds = %vector.body147, %vector.ph142
  ...
  store <4 x float> %broadcast.splat146, ptr %i.co, align 4, !tbaa !99
  %index.next150 = add nuw i64 %index148, 8       ; 2 uses
  %i.cp = icmp eq i64 %index.next150, %n.vec144
  br i1 %i.cp, label %middle.block151, label %vector.body147, !llvm.loop !159
...
.lr.ph.i.i.i.i.i.i.i76:                           ; preds = %.lr.ph.i.i.i.i.i.i.i76.preheader, %.lr.ph.i.i.i.i.i.i.i76
  ...
  store float %i.ch, ptr %.07.i.i.i.i.i.i.i77, align 4, !tbaa !99
...
_ZSt24__uninitialized_fill_n_aIPfmffET_S1_T0_RKT1_RSaIT2_E.exit80: ; preds = %.lr.ph.i.i.i.i.i.i.i76, %middle.block151
  ...
  br i1 %i.cr, label %bb.u, label %bb.v, !prof !129
...
bb.w:                                             ; preds = %bb.v
  %i.ct = load float, ptr %i.bq, align 4, !tbaa !99
  store float %i.ct, ptr %i.ce, align 4, !tbaa !99
  br label %_ZSt34__uninitialized_move_if_noexcept_aIPfS0_SaIfEET0_T_S3_S2_RT1_.exit
...
_ZSt34__uninitialized_move_if_noexcept_aIPfS0_SaIfEET0_T_S3_S2_RT1_.exit: ; preds = %bb.w, %bb.v, %bb.u
  ...
  br i1 %i.cw, label %bb.x, label %bb.y, !prof !129
...
bb.z:                                             ; preds = %bb.y
  %i.cy = load float, ptr %1, align 4, !tbaa !99
  store float %i.cy, ptr %i.cu, align 4, !tbaa !99
  br label %bb.aa
...
bb.ab:                                            ; preds = %bb.aa
  ...
  tail call void @_ZdlPvm(ptr noundef nonnull %i.bq, i64 noundef %i.da) #20
  br label %_ZNSt12_Vector_baseIfSaIfEE13_M_deallocateEPfm.exit

_ZNSt12_Vector_baseIfSaIfEE13_M_deallocateEPfm.exit: ; preds = %bb.aa, %bb.ab
  store ptr %i.ce, ptr %0, align 8, !tbaa !98
  store ptr %i.cz, ptr %i.c, align 8, !tbaa !95
  %i.db = getelementptr inbounds nuw [4 x i8], ptr %i.ce, i64 %i.bz
  store ptr %i.db, ptr %i.a, align 8, !tbaa !101
