...
.noexc26:                                         ; preds = %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i
  ...
  %i.k = and i64 %i.j, -4
  %7 = add i64 %i.k, 4
  tail call void @llvm.memset.p0.i64(ptr nonnull align 4 %i.i, i8 0, i64 %7, i1 false), !tbaa !59
...
begin_hunk_1_@_ZN16OpenColorIO_v2_511ConfigUtils18initializeTestValsERNS0_22ColorSpaceFingerprintsERKSt10shared_ptrIKNS_6ConfigEE:bb.a
  ...
  %29 = add i64 %i.hl, -4
  %i.ht = sub i64 %29, %i.hm
  %i.hu = and i64 %i.ht, -4
  %30 = add i64 %i.hu, 4
  call void @llvm.memset.p0.i64(ptr nonnull align 4 %i.hq, i8 0, i64 %30, i1 false), !tbaa !59
...
begin_hunk_2_@_ZN16OpenColorIO_v2_511ConfigUtils18initializeTestValsERNS0_22ColorSpaceFingerprintsERKSt10shared_ptrIKNS_6ConfigEE:bb.a
  ...
  %31 = add i64 %i.rq, -4
  %i.ry = sub i64 %31, %i.rr
  %i.rz = and i64 %i.ry, -4
  %32 = add i64 %i.rz, 4
  call void @llvm.memset.p0.i64(ptr nonnull align 4 %i.rv, i8 0, i64 %32, i1 false), !tbaa !59
  br label %.loopexit
