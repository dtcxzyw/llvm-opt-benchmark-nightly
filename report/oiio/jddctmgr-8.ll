...
vector.body118:                                   ; preds = %bb.af, %bb.ag
  ...
  %i.gq = shufflevector <2 x double> %i.fc, <2 x double> %i.fk, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = fmul nnan <2 x double> %i.em, <double 1.000000e+00, double f0x3FF63150B14861EF>
  %2 = fmul nnan <2 x double> %i.eu, splat (double f0x3FF63150B14861EF)
  %i.gr = shufflevector <2 x double> %1, <2 x double> %2, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %3 = fmul nnan <4 x double> %i.gq, <double f0x3FF4E7AE914D6FCA, double f0x3FF4E7AE914D6FCA, double f0x3FF2D062EF6C11AA, double f0x3FF2D062EF6C11AA>
  %4 = shufflevector <4 x double> %i.gr, <4 x double> %3, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.gs = fptrunc <8 x double> %4 to <8 x float>
  %i.gt = shufflevector <2 x double> %i.gh, <2 x double> %i.gp, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %5 = fmul nnan <2 x double> %i.fr, <double 1.000000e+00, double f0x3FF63150B14861EF>
  %6 = fmul nnan <2 x double> %i.fz, splat (double f0x3FE92469C0A7BF3B)
  %i.gu = shufflevector <2 x double> %5, <2 x double> %6, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %7 = fmul nnan <4 x double> %i.gt, <double f0x3FE1517A7BC720BB, double f0x3FE1517A7BC720BB, double f0x3FD1A855DE72AB5D, double f0x3FD1A855DE72AB5D>
  %8 = shufflevector <4 x double> %i.gu, <4 x double> %7, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %i.jh = shufflevector <2 x double> %i.ht, <2 x double> %i.ib, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %9 = fmul nnan <2 x double> %i.hc, <double f0x3FF4E7AE914D6FCA, double f0x3FF2D062EF6C11AA>
  %10 = fmul nnan <2 x double> %i.hl, splat (double f0x3FF63150B14861EF)
  %i.ji = shufflevector <2 x double> %9, <2 x double> %10, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %11 = fmul nnan <4 x double> %i.jh, <double f0x3FF4E7AE914D6FCA, double f0x3FF4E7AE914D6FCA, double f0x3FF2D062EF6C11AA, double f0x3FF2D062EF6C11AA>
  %12 = shufflevector <4 x double> %i.ji, <4 x double> %11, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.jj = fptrunc <8 x double> %12 to <8 x float>
  %i.jk = shufflevector <2 x double> %i.iy, <2 x double> %i.jg, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %13 = fmul nnan <2 x double> %i.ii, <double f0x3FF4E7AE914D6FCA, double f0x3FF2D062EF6C11AA>
  %14 = fmul nnan <2 x double> %i.iq, splat (double f0x3FE92469C0A7BF3B)
  %i.jl = shufflevector <2 x double> %13, <2 x double> %14, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %15 = fmul nnan <4 x double> %i.jk, <double f0x3FE1517A7BC720BB, double f0x3FE1517A7BC720BB, double f0x3FD1A855DE72AB5D, double f0x3FD1A855DE72AB5D>
  %16 = shufflevector <4 x double> %i.jl, <4 x double> %15, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %i.ly = shufflevector <2 x double> %i.kk, <2 x double> %i.ks, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %17 = fmul nnan <2 x double> %i.jt, <double 1.000000e+00, double f0x3FE92469C0A7BF3B>
  %18 = fmul nnan <2 x double> %i.kc, splat (double f0x3FF63150B14861EF)
  %i.lz = shufflevector <2 x double> %17, <2 x double> %18, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %19 = fmul nnan <4 x double> %i.ly, <double f0x3FF4E7AE914D6FCA, double f0x3FF4E7AE914D6FCA, double f0x3FF2D062EF6C11AA, double f0x3FF2D062EF6C11AA>
  %20 = shufflevector <4 x double> %i.lz, <4 x double> %19, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ma = fptrunc <8 x double> %20 to <8 x float>
  %i.mb = shufflevector <2 x double> %i.lp, <2 x double> %i.lx, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %21 = fmul nnan <2 x double> %i.kz, <double 1.000000e+00, double f0x3FE92469C0A7BF3B>
  %22 = fmul nnan <2 x double> %i.lh, splat (double f0x3FE92469C0A7BF3B)
  %i.mc = shufflevector <2 x double> %21, <2 x double> %22, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %23 = fmul nnan <4 x double> %i.mb, <double f0x3FE1517A7BC720BB, double f0x3FE1517A7BC720BB, double f0x3FD1A855DE72AB5D, double f0x3FD1A855DE72AB5D>
  %24 = shufflevector <4 x double> %i.mc, <4 x double> %23, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  ...
  %i.op = shufflevector <2 x double> %i.nb, <2 x double> %i.nj, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %25 = fmul nnan <2 x double> %i.mk, <double f0x3FE1517A7BC720BB, double f0x3FD1A855DE72AB5D>
  %26 = fmul nnan <2 x double> %i.mt, splat (double f0x3FF63150B14861EF)
  %i.oq = shufflevector <2 x double> %25, <2 x double> %26, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %27 = fmul nnan <4 x double> %i.op, <double f0x3FF4E7AE914D6FCA, double f0x3FF4E7AE914D6FCA, double f0x3FF2D062EF6C11AA, double f0x3FF2D062EF6C11AA>
  %28 = shufflevector <4 x double> %i.oq, <4 x double> %27, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.or = fptrunc <8 x double> %28 to <8 x float>
  %i.os = shufflevector <2 x double> %i.og, <2 x double> %i.oo, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %29 = fmul nnan <2 x double> %i.nq, <double f0x3FE1517A7BC720BB, double f0x3FD1A855DE72AB5D>
  %30 = fmul nnan <2 x double> %i.ny, splat (double f0x3FE92469C0A7BF3B)
  %i.ot = shufflevector <2 x double> %29, <2 x double> %30, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %31 = fmul nnan <4 x double> %i.os, <double f0x3FE1517A7BC720BB, double f0x3FE1517A7BC720BB, double f0x3FD1A855DE72AB5D, double f0x3FD1A855DE72AB5D>
  %32 = shufflevector <4 x double> %i.ot, <4 x double> %31, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
