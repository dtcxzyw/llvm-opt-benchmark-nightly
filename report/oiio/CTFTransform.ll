...
begin_hunk_0_@_ZNK16OpenColorIO_v2_512_GLOBAL__N_121GradingRGBCurveWriter12writeContentEv:bb.a
  ...
  %7 = alloca %"class.std::__cxx11::basic_ostringstream", align 8 ; 32 uses
...
bb.ad:                                            ; preds = %.lr.ph.i
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 16) (i8, ptr @_ZTVSt9basic_iosIcSt11char_traitsIcEE, i64 16), ptr %i.bb, align 8, !tbaa !43
  store ptr null, ptr %i.bc, align 8, !tbaa !603
  store i8 0, ptr %i.bd, align 8, !tbaa !610
...
bb.ae:                                            ; preds = %bb.ad
  store ptr getelementptr inbounds nuw inrange(-24, 16) (i8, ptr @_ZTVNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE, i64 24), ptr %7, align 8, !tbaa !43
  store ptr getelementptr inbounds nuw inrange(-24, 16) (i8, ptr @_ZTVNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEE, i64 64), ptr %i.bb, align 8, !tbaa !43
  store ptr getelementptr inbounds nuw inrange(-16, 112) (i8, ptr @_ZTVSt15basic_streambufIcSt11char_traitsIcEE, i64 16), ptr %i.ax, align 8, !tbaa !43
  ...
  store ptr %i.ay, ptr %i.at, align 8, !tbaa !24
  store i64 0, ptr %i.az, align 8, !tbaa !16
  store i8 0, ptr %i.ay, align 8, !tbaa !17
  %i.gl = load ptr, ptr %7, align 8, !tbaa !43
...
_ZNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEC1Ev.exit: ; preds = %bb.ae
  %i.gr = load ptr, ptr %7, align 8, !tbaa !43
...
begin_hunk_5_@_ZNK16OpenColorIO_v2_512_GLOBAL__N_121GradingRGBCurveWriter12writeContentEv:bb.a
  ...
  %i.hi = load ptr, ptr %i.aq, align 8, !tbaa !104, !noalias !623 ; 3 uses
  %.not.i.not.i.i.i = icmp eq ptr %i.hi, null
  %i.hj = load ptr, ptr %i.ar, align 8, !noalias !623 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit103.i
  %i.ib = load i64, ptr %i.ay, align 8, !tbaa !17
  %i.ic = add i64 %i.ib, 1
...
bb.ad:                                            ; preds = %.lr.ph.i
  ...
  %i.gj = load ptr, ptr %7, align 8, !tbaa !43
...
bb.ae:                                            ; preds = %bb.ad
  ...
  store i64 0, ptr %i.az, align 8, !tbaa !16
  store i8 0, ptr %i.ay, align 8, !tbaa !17
  %i.gn = load ptr, ptr %7, align 8, !tbaa !43
...
_ZNSt7__cxx1119basic_ostringstreamIcSt11char_traitsIcESaIcEEC1Ev.exit: ; preds = %bb.ae
  %i.gt = load ptr, ptr %7, align 8, !tbaa !43
...
begin_hunk_12_@_ZNK16OpenColorIO_v2_512_GLOBAL__N_121GradingHueCurveWriter12writeContentEv:bb.a
  ...
  %i.hk = load ptr, ptr %i.aq, align 8, !tbaa !104, !noalias !661 ; 3 uses
  %.not.i.not.i.i.i = icmp eq ptr %i.hk, null
  %i.hl = load ptr, ptr %i.ar, align 8, !noalias !661 ; 2 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit103.i: ; preds = %bb.al, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i101.i
  ...
  store ptr getelementptr inbounds nuw inrange(-16, 112) (i8, ptr @_ZTVNSt7__cxx1115basic_stringbufIcSt11char_traitsIcESaIcEEE, i64 16), ptr %i.ax, align 8, !tbaa !43
  %i.ib = load ptr, ptr %i.at, align 8, !tbaa !11 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit103.i
  %i.id = load i64, ptr %i.ay, align 8, !tbaa !17
  %i.ie = add i64 %i.id, 1
