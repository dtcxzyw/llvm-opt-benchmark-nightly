...
bb.c:                                             ; preds = %bb.b
  ...
  %i.h = tail call i32 (ptr, i32, ptr, ...) %i.g(ptr noundef nonnull %0, i32 noundef 3, ptr noundef nonnull @.str, i32 noundef %2, i32 noundef %3, i64 noundef %i.d) #3, !inline_history !31
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.k = tail call i32 %i.j(ptr noundef nonnull %0, i32 noundef 3, ptr noundef nonnull @.str.1) #3, !inline_history !31
  br label %exr_attr_preview_init.exit
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.n = tail call ptr %i.m(i64 noundef %i.d) #3, !inline_history !31 ; 2 uses
...
bb.h:                                             ; preds = %bb.g
  ...
  %i.s = tail call i32 %i.r(ptr noundef nonnull %0, i32 noundef 1) #3, !inline_history !31
  br label %exr_attr_preview_init.exit
