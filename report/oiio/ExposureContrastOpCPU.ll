...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep32.a = getelementptr i8, ptr %1, i64 %offset.idx ; 4 uses
  %i.am = getelementptr i8, ptr %1, i64 %offset.idx ; 4 uses
  %next.gep33.a = getelementptr i8, ptr %i.am, i64 16
  %i.an = getelementptr i8, ptr %1, i64 %offset.idx ; 4 uses
  %next.gep34.a = getelementptr i8, ptr %i.an, i64 32
  %i.ao = getelementptr i8, ptr %1, i64 %offset.idx ; 4 uses
