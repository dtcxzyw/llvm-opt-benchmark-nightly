...
vector.body191:                                   ; preds = %vector.body191, %vector.ph184
  ...
  %wide.vec = load <8 x i16>, ptr %i.dz, align 2, !tbaa !66, !alias.scope !98
  %4 = freeze <8 x i16> %wide.vec                 ; 2 uses
  %5 = bitcast <8 x i16> %4 to <4 x i32>
  %6 = bitcast <8 x i16> %4 to <4 x i32>
  %7 = and <4 x i32> %6, splat (i32 65535)
  %8 = lshr <4 x i32> %5, splat (i32 16)
  %i.ea = getelementptr inbounds nuw i8, ptr %next.gep197, i64 2
  %wide.vec199 = load <8 x i16>, ptr %i.ea, align 2, !tbaa !66, !alias.scope !98
  %9 = freeze <8 x i16> %wide.vec199              ; 2 uses
  %10 = bitcast <8 x i16> %9 to <4 x i32>
  %11 = bitcast <8 x i16> %9 to <4 x i32>
  %12 = and <4 x i32> %11, splat (i32 65535)
  %13 = lshr <4 x i32> %10, splat (i32 16)
  %i.eb = add nuw nsw <4 x i32> %12, %8
  %i.ec = getelementptr i8, ptr %next.gep196, i64 -2
  %wide.vec202 = load <8 x i16>, ptr %i.ec, align 2, !tbaa !66, !alias.scope !101
  %14 = freeze <8 x i16> %wide.vec202             ; 2 uses
  %15 = bitcast <8 x i16> %14 to <4 x i32>
  %16 = bitcast <8 x i16> %14 to <4 x i32>
  %17 = and <4 x i32> %16, splat (i32 65535)
  %18 = lshr <4 x i32> %15, splat (i32 16)
  %i.ed = add nuw nsw <4 x i32> %i.eb, %18
  %i.ee = getelementptr inbounds nuw i8, ptr %next.gep196, i64 2
  %wide.vec205 = load <8 x i16>, ptr %i.ee, align 2, !tbaa !66, !alias.scope !101
  %19 = freeze <8 x i16> %wide.vec205             ; 2 uses
  %20 = bitcast <8 x i16> %19 to <4 x i32>
  %21 = bitcast <8 x i16> %19 to <4 x i32>
  %22 = and <4 x i32> %21, splat (i32 65535)
  %23 = lshr <4 x i32> %20, splat (i32 16)
  %i.ef = add nuw nsw <4 x i32> %i.ed, %22
  %i.eg = getelementptr i8, ptr %next.gep195, i64 -2
  %wide.vec208 = load <8 x i16>, ptr %i.eg, align 2, !tbaa !66, !alias.scope !103
  %24 = freeze <8 x i16> %wide.vec208             ; 2 uses
  %25 = bitcast <8 x i16> %24 to <4 x i32>
  %26 = bitcast <8 x i16> %24 to <4 x i32>
  %27 = and <4 x i32> %26, splat (i32 65535)
  %28 = lshr <4 x i32> %25, splat (i32 16)
  %29 = getelementptr inbounds nuw i8, ptr %next.gep195, i64 2
  %wide.vec211 = load <8 x i16>, ptr %29, align 2, !tbaa !66, !alias.scope !103
  %30 = freeze <8 x i16> %wide.vec211             ; 2 uses
  %31 = bitcast <8 x i16> %30 to <4 x i32>
  %32 = bitcast <8 x i16> %30 to <4 x i32>
  %33 = and <4 x i32> %32, splat (i32 65535)
  %34 = lshr <4 x i32> %31, splat (i32 16)
  %35 = add nuw nsw <4 x i32> %33, %28
  %36 = getelementptr i8, ptr %next.gep194, i64 -2
  %wide.vec214 = load <8 x i16>, ptr %36, align 2, !tbaa !66, !alias.scope !105
  %37 = freeze <8 x i16> %wide.vec214             ; 2 uses
  %38 = bitcast <8 x i16> %37 to <4 x i32>
  %39 = bitcast <8 x i16> %37 to <4 x i32>
  %40 = and <4 x i32> %39, splat (i32 65535)
  %41 = lshr <4 x i32> %38, splat (i32 16)
  %i.eh = add nuw nsw <4 x i32> %35, %41
  %42 = getelementptr inbounds nuw i8, ptr %next.gep194, i64 2
  %wide.vec217 = load <8 x i16>, ptr %42, align 2, !tbaa !66, !alias.scope !105
  %43 = freeze <8 x i16> %wide.vec217             ; 2 uses
  %44 = bitcast <8 x i16> %43 to <4 x i32>
  %45 = bitcast <8 x i16> %43 to <4 x i32>
  %46 = and <4 x i32> %45, splat (i32 65535)
  %47 = lshr <4 x i32> %44, splat (i32 16)
  %i.ei = add nuw nsw <4 x i32> %i.eh, %46
  %48 = add nuw nsw <4 x i32> %i.ei, %7
  %49 = add nuw nsw <4 x i32> %48, %13
  %50 = add nuw nsw <4 x i32> %49, %17
  %i.ej = add nuw nsw <4 x i32> %50, %23
  %51 = shl nuw nsw <4 x i32> %i.ej, splat (i32 1)
  %52 = add nuw nsw <4 x i32> %34, %27
  %i.ek = add nuw nsw <4 x i32> %52, %51
  %i.el = add nuw nsw <4 x i32> %i.ek, %40
  %i.em = add nuw nsw <4 x i32> %i.el, %47
