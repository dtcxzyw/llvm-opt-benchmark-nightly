...
bb.j:                                             ; preds = %bb.h
  %i.y = invoke i16 @_ZN27OpenImageIO_v3_1_Imf__3_3_510round12logEN9Imath_3_14halfE(i16 %i.c)
          to label %.noexc9 unwind label %.loopexit, !inline_history !68
...
bb.k:                                             ; preds = %.noexc9, %bb.i, %bb.f, %bb.d
  ...
  br i1 %exitcond.not.i.i, label %_ZN27OpenImageIO_v3_1_Imf__3_3_57RgbaLutC2IPFN9Imath_3_14halfES3_EEET_NS_12RgbaChannelsE.exit, label %bb.c, !llvm.loop !69
...
_ZN27OpenImageIO_v3_1_Imf__3_3_57RgbaLutC2IPFN9Imath_3_14halfES3_EEET_NS_12RgbaChannelsE.exit: ; preds = %bb.k
  ...
  store i32 %0, ptr %i.aa, align 8, !tbaa !70
  br label %bb.p
...
bb.h:                                             ; preds = %bb.g, %bb.f, %bb.e, %_ZN27OpenImageIO_v3_1_Imf__3_3_59roundNBitclEN9Imath_3_14halfE.exit.us
  ...
  br i1 %exitcond30.not, label %.split23.us, label %.split.us, !llvm.loop !73
...
bb.o:                                             ; preds = %bb.k, %_ZN27OpenImageIO_v3_1_Imf__3_3_59roundNBitclEN9Imath_3_14halfE.exit, %bb.n, %bb.i
  ...
  br i1 %exitcond.not, label %.split23.us, label %.split, !llvm.loop !73
}
...
!69 = distinct !{!69, !13}
!70 = !{!71, !72, i64 8}
!71 = !{!"_ZTSN27OpenImageIO_v3_1_Imf__3_3_57RgbaLutE", !66, i64 0, !72, i64 8}
!72 = !{!"_ZTSN27OpenImageIO_v3_1_Imf__3_3_512RgbaChannelsE", !5, i64 0}
!73 = distinct !{!73, !13}
end_hunk_5
