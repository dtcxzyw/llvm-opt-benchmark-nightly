...
.loopexit.loopexit:                               ; preds = %scalar.ph, %vec.epilog.middle.block, %middle.block
  %indvars.iv.next.lcssa = phi i64 [ %6, %vec.epilog.middle.block ], [ %i.av, %middle.block ], [ %indvars.iv.next, %scalar.ph ]
...
.lr.ph119:                                        ; preds = %bb.g, %.loopexit
  ...
  %i.z = call zeroext i16 @FT_Stream_ReadUShort(ptr noundef nonnull %2, ptr noundef nonnull %i.b) #21 ; 7 uses
...
vector.main.loop.iter.check:                      ; preds = %.lr.ph
  %min.iters.check129 = icmp samesign ult i64 %umin, 15
  br i1 %min.iters.check129, label %scalar.ph.preheader, label %vector.ph
...
begin_hunk_3_@cff_charset_load:bb.a
  ...
  br i1 %i.az, label %middle.block, label %vector.body, !llvm.loop !617

middle.block:                                     ; preds = %vector.body
  %cmp.n = icmp eq i64 %i.au, %n.vec
  br i1 %cmp.n, label %.loopexit.loopexit, label %middle.block.a

middle.block.a:                                   ; preds = %middle.block
  %cmp.n.a = icmp eq i64 %n.mod.vf, 0
  br i1 %cmp.n.a, label %vec.epilog.scalar.ph.preheader, label %scalar.ph.preheader, !prof !618

scalar.ph.preheader:                              ; preds = %vector.main.loop.iter.check, %middle.block.a
  %indvars.iv.ph.a = phi i64 [ %n.vec, %middle.block.a ], [ 0, %vector.main.loop.iter.check ]
  %bc.resume.val131 = phi i16 [ %i.ax, %middle.block.a ], [ %i.z, %vector.main.loop.iter.check ]
  %n.vec133 = and i64 %i.au, 8589934588           ; 5 uses
  %6 = add nuw nsw i64 %n.vec133, %i.aq           ; 2 uses
  %7 = trunc i64 %n.vec133 to i32
  %.cast135 = trunc i64 %n.vec133 to i16
  %8 = add i16 %i.z, %.cast135
  %broadcast.splatinsert136 = insertelement <4 x i16> poison, i16 %bc.resume.val131, i64 0
  %broadcast.splat137 = shufflevector <4 x i16> %broadcast.splatinsert136, <4 x i16> poison, <4 x i32> zeroinitializer
  %induction138 = add <4 x i16> %broadcast.splat137, <i16 0, i16 1, i16 2, i16 3>
  %invariant.gep186 = getelementptr [2 x i8], ptr %i.ap, i64 %i.aq
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %scalar.ph.preheader
  %index139 = phi i64 [ %indvars.iv.ph.a, %scalar.ph.preheader ], [ %index.next141, %vec.epilog.vector.body ] ; 2 uses
  %vec.ind140 = phi <4 x i16> [ %induction138, %scalar.ph.preheader ], [ %vec.ind.next142, %vec.epilog.vector.body ] ; 2 uses
  %gep187 = getelementptr [2 x i8], ptr %invariant.gep186, i64 %index139
  store <4 x i16> %vec.ind140, ptr %gep187, align 2, !tbaa !60
  %index.next141 = add nuw i64 %index139, 4       ; 2 uses
  %vec.ind.next142 = add <4 x i16> %vec.ind140, splat (i16 4)
  %9 = icmp eq i64 %index.next141, %n.vec133
  br i1 %9, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !619

vec.epilog.middle.block:                          ; preds = %vec.epilog.vector.body
  %cmp.n143 = icmp eq i64 %i.au, %n.vec133
  br i1 %cmp.n143, label %.loopexit.loopexit, label %vec.epilog.scalar.ph.preheader

vec.epilog.scalar.ph.preheader:                   ; preds = %.lr.ph, %middle.block.a, %vec.epilog.middle.block
  %indvars.iv.ph = phi i64 [ %i.aq, %.lr.ph ], [ %i.av, %middle.block.a ], [ %6, %vec.epilog.middle.block ]
  %.078116.ph = phi i32 [ 0, %.lr.ph ], [ %i.aw, %middle.block.a ], [ %7, %vec.epilog.middle.block ]
  %.083114.ph = phi i16 [ %i.z, %.lr.ph ], [ %i.ax, %middle.block.a ], [ %8, %vec.epilog.middle.block ]
  br label %scalar.ph
...
scalar.ph:                                        ; preds = %vec.epilog.scalar.ph.preheader, %scalar.ph
  ...
  %.078116 = phi i32 [ %i.bb, %scalar.ph ], [ %.078116.ph, %vec.epilog.scalar.ph.preheader ] ; 2 uses
  %.083114 = phi i16 [ %i.bc, %scalar.ph ], [ %.083114.ph, %vec.epilog.scalar.ph.preheader ] ; 2 uses
...
begin_hunk_4_@cff_charset_load:bb.a
  ...
  br i1 %i.bf, label %scalar.ph, label %.loopexit.loopexit, !llvm.loop !620
...
begin_hunk_5_@cff_charset_load:bb.a
  ...
  br i1 %i.ci, label %middle.block142, label %vector.body137, !llvm.loop !621
...
vec.epilog.iter.check:                            ; preds = %middle.block142
  ...
  br i1 %min.epilog.iters.check, label %vec.epilog.scalar.ph.preheader.a, label %vec.epilog.ph, !prof !618
...
begin_hunk_7_@cff_charset_load:bb.a
  ...
  br i1 %i.cm, label %vec.epilog.middle.block.a, label %vec.epilog.vector.body.a, !llvm.loop !622
...
begin_hunk_8_@cff_charset_load:bb.a
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %vec.epilog.scalar.ph, !llvm.loop !623
...
begin_hunk_9_@cff_charset_load:bb.a
  ...
  br i1 %i.dc, label %bb.y, label %._crit_edge33.i, !llvm.loop !624
...
._crit_edge33.i:                                  ; preds = %bb.y
  ...
  store i32 %1, ptr %i.de, align 4, !tbaa !625
...
bb.ac:                                            ; preds = %bb.aa
  ...
  br i1 %exitcond200.not, label %.loopexit, label %bb.aa, !llvm.loop !629
...
begin_hunk_13_@cff_encoding_load:bb.a
  ...
  br i1 %i.ef, label %middle.block, label %vector.body, !llvm.loop !631
...
begin_hunk_15_@cff_encoding_load:bb.a
  ...
  br i1 %i.ej, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !632
...
begin_hunk_16_@cff_encoding_load:bb.a
  ...
  %indvars.iv.next.i = add nuw nsw i64 %indvars.iv.i, 1 ; 2 uses
  %exitcond.not.i = icmp eq i64 %indvars.iv.next.i, %wide.trip.count.i
  br i1 %exitcond.not.i, label %._crit_edge.i, label %vec.epilog.scalar.ph, !llvm.loop !633
...
begin_hunk_17_@cff_encoding_load:bb.a
  ...
  br i1 %i.ez, label %bb.ah, label %._crit_edge33.i, !llvm.loop !624
...
._crit_edge33.i:                                  ; preds = %bb.ah, %.preheader.i
  ...
  store i32 %2, ptr %i.fb, align 4, !tbaa !625
  br label %cff_charset_compute_cids.exit
...
bb.ak:                                            ; preds = %cff_charset_cid_to_gindex.exit.thread, %bb.aj
  ...
  br i1 %exitcond.not, label %.loopexit154, label %bb.ai, !llvm.loop !634
...
begin_hunk_19_@cff_vstore_done:bb.a
  ...
  br i1 %i.l, label %.lr.ph, label %.loopexit25, !llvm.loop !635
...
begin_hunk_20_@cff_vstore_done:bb.a
  ...
  br i1 %i.z, label %.lr.ph28, label %.loopexit, !llvm.loop !636
...
!618 = !{!"branch_weights", i32 4, i32 12}
!619 = distinct !{!619, !62, !522, !523}
!620 = distinct !{!620, !62, !523, !522}
!621 = distinct !{!621, !62, !522, !523}
!622 = distinct !{!622, !62, !522, !523}
!623 = distinct !{!623, !62, !523, !522}
!624 = distinct !{!624, !62}
!625 = !{!65, !4, i64 36}
!626 = distinct !{!626, !62}
!627 = distinct !{!627, !62}
...
!632 = distinct !{!632, !62, !522, !523}
!633 = distinct !{!633, !62, !523, !522}
!634 = distinct !{!634, !62}
!635 = distinct !{!635, !62}
!636 = distinct !{!636, !62}
!637 = !{!71, !51, i64 1208}
