...
bb.f:                                             ; preds = %bb.d
  ...
  store i32 %i.q, ptr %i.r, align 4, !tbaa !573
...
._crit_edge223:                                   ; preds = %bb.f
  %.pre = load i8, ptr %i.m, align 2, !tbaa !572
  br label %bb.k
...
bb.o:                                             ; preds = %bb.n
  ...
  store i64 %i.ag, ptr %i.ah, align 8, !tbaa !574
  ...
  store i64 %i.ak, ptr %i.al, align 8, !tbaa !575
...
bb.aa:                                            ; preds = %bb.z
  %i.bi = load i32, ptr %i.ar, align 4, !tbaa !576
  %i.bj = getelementptr inbounds nuw i8, ptr %3, i64 1420
  %i.bk = load i32, ptr %i.bj, align 4, !tbaa !578
...
bb.ac:                                            ; preds = %bb.aa, %bb.p
  ...
  %i.bn = load i32, ptr %i.bm, align 4, !tbaa !527
...
bb.ad:                                            ; preds = %bb.ac
  ...
  %i.bs = load i32, ptr %i.br, align 4, !tbaa !576 ; 2 uses
...
bb.af:                                            ; preds = %bb.ac
  ...
  %i.bv = load i32, ptr %i.bu, align 4, !tbaa !576
...
bb.aj:                                            ; preds = %bb.ai
  ...
  %i.cc = load i64, ptr %i.cb, align 8, !tbaa !579
...
bb.am:                                            ; preds = %bb.al
  ...
  %i.cm = load i64, ptr %i.cl, align 8, !tbaa !580
...
bb.an:                                            ; preds = %bb.am
  ...
  %i.cp = load i64, ptr %i.co, align 8, !tbaa !581
...
bb.ap:                                            ; preds = %bb.ao
  ...
  %i.cu = load i32, ptr %i.ct, align 4, !tbaa !527 ; 3 uses
...
.preheader211:                                    ; preds = %bb.aq
  %i.da = load i32, ptr %i.ct, align 4, !tbaa !527 ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.dc = getelementptr inbounds nuw [1224 x i8], ptr %i.cy, <2 x i64> %vec.ind
  %i.dd = getelementptr inbounds nuw [1224 x i8], ptr %i.cy, <2 x i64> %step.add
  %i.de = getelementptr inbounds nuw [8 x i8], ptr %i.db, i64 %index ; 2 uses
  %i.df = getelementptr inbounds nuw i8, ptr %i.de, i64 16
  store <2 x ptr> %i.dc, ptr %i.de, align 8, !tbaa !139
  store <2 x ptr> %i.dd, ptr %i.df, align 8, !tbaa !139
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %vec.ind.next = add nuw <2 x i64> %vec.ind, splat (i64 4)
  %i.dg = icmp eq i64 %index.next, %n.vec
  br i1 %i.dg, label %middle.block, label %vector.body, !llvm.loop !582
...
.lr.ph215:                                        ; preds = %scalar.ph, %middle.block
  %i.dh = getelementptr inbounds nuw i8, ptr %3, i64 2872
  %i.di = select i1 %9, i32 16384, i32 4096
  br label %bb.as

scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %scalar.ph ], [ %indvars.iv.ph, %scalar.ph.preheader ] ; 3 uses
  %i.dj = getelementptr inbounds nuw [1224 x i8], ptr %i.cy, i64 %indvars.iv
  %i.dk = getelementptr inbounds nuw [8 x i8], ptr %i.db, i64 %indvars.iv
  store ptr %i.dj, ptr %i.dk, align 8, !tbaa !139
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %.lr.ph215, label %scalar.ph, !llvm.loop !583

bb.ar:                                            ; preds = %bb.as
  %indvars.iv.next221 = add nuw nsw i64 %indvars.iv220, 1 ; 2 uses
  %i.dl = load i32, ptr %i.ct, align 4, !tbaa !527 ; 2 uses
  %i.dm = zext i32 %i.dl to i64
  %i.dn = icmp samesign ult i64 %indvars.iv.next221, %i.dm
  br i1 %i.dn, label %bb.as, label %._crit_edge, !llvm.loop !584

bb.as:                                            ; preds = %.lr.ph215, %bb.ar
  %indvars.iv220 = phi i64 [ 0, %.lr.ph215 ], [ %indvars.iv.next221, %bb.ar ] ; 3 uses
  %i.do = getelementptr inbounds nuw [8 x i8], ptr %i.dh, i64 %indvars.iv220
  %i.dp = load ptr, ptr %i.do, align 8, !tbaa !139
  %i.dq = trunc nuw i64 %indvars.iv220 to i32
  %i.dr = call fastcc i32 @cff_subfont_load(ptr noundef %i.dp, ptr noundef nonnull %8, i32 noundef %i.dq, ptr noundef nonnull %1, i64 noundef %i.e, i32 noundef %i.di, ptr noundef nonnull %3, ptr noundef %4) ; 2 uses
  store i32 %i.dr, ptr %i.a, align 4, !tbaa !3
  %.not192 = icmp eq i32 %i.dr, 0
  br i1 %.not192, label %bb.ar, label %.loopexit

._crit_edge:                                      ; preds = %bb.ar
  %i.ds = icmp ugt i32 %i.dl, 1
  %i.dt = or i1 %.not168, %i.ds
  br i1 %i.dt, label %bb.at, label %.loopexit

bb.at:                                            ; preds = %.preheader.thread, %._crit_edge
  %i.du = getelementptr inbounds nuw i8, ptr %3, i64 4920
  %i.dv = getelementptr inbounds nuw i8, ptr %3, i64 1356
  %i.dw = load i32, ptr %i.dv, align 4, !tbaa !144
  %i.dx = getelementptr inbounds nuw i8, ptr %3, i64 1936
  %i.dy = load i64, ptr %i.dx, align 8, !tbaa !585
  %i.dz = add i64 %i.dy, %i.e
  %i.ea = call fastcc i32 @CFF_Load_FD_Select(ptr noundef nonnull %i.du, i32 noundef %i.dw, ptr noundef nonnull %1, i64 noundef %i.dz)
  store i32 %i.ea, ptr %i.a, align 4, !tbaa !3
  br label %.loopexit
...
bb.av:                                            ; preds = %bb.al
  %i.ec = getelementptr inbounds nuw i8, ptr %3, i64 2864
  store i32 0, ptr %i.ec, align 8, !tbaa !138
  br label %bb.aw

bb.aw:                                            ; preds = %bb.au, %bb.av
  %i.ed = load i64, ptr %i.cb, align 8, !tbaa !579
...
bb.ay:                                            ; preds = %bb.aw
  %i.ef = getelementptr inbounds nuw i8, ptr %3, i64 1356
  %i.eg = load i32, ptr %i.ef, align 4, !tbaa !144
  %i.eh = getelementptr inbounds nuw i8, ptr %3, i64 36 ; 3 uses
  store i32 %i.eg, ptr %i.eh, align 4, !tbaa !89
  %i.ei = getelementptr inbounds nuw i8, ptr %3, i64 184
  %i.ej = getelementptr inbounds nuw i8, ptr %3, i64 1600
  %i.ek = call fastcc i32 @cff_index_get_pointers(ptr noundef nonnull %i.ei, ptr noundef nonnull %i.ej, ptr noundef null, ptr noundef null) ; 2 uses
  store i32 %i.ek, ptr %i.a, align 4, !tbaa !3
  %.not194 = icmp eq i32 %i.ek, 0
...
bb.ba:                                            ; preds = %bb.az
  %i.el = load i32, ptr %i.eh, align 4, !tbaa !89 ; 2 uses
  %.not195 = icmp eq i32 %i.el, 0
...
bb.bb:                                            ; preds = %bb.ba
  ...
  %i.et = call fastcc i32 @cff_charset_load(ptr noundef nonnull %i.eq, i32 noundef %i.el, ptr noundef nonnull %1, i64 noundef %i.e, i64 noundef %i.es, i8 noundef zeroext %i.ep) ; 2 uses
  store i32 %i.et, ptr %i.a, align 4, !tbaa !3
  %.not196 = icmp eq i32 %i.et, 0
  br i1 %.not196, label %bb.bc, label %.thread

bb.bc:                                            ; preds = %bb.bb
  %i.eu = load i32, ptr %i.ch, align 4, !tbaa !126
  %i.ev = icmp eq i32 %i.eu, 65535
  br i1 %i.ev, label %bb.bd, label %bb.be

bb.bd:                                            ; preds = %bb.bc
  %i.ew = getelementptr inbounds nuw i8, ptr %3, i64 248
  %i.ex = load i32, ptr %i.eh, align 4, !tbaa !89
...
define internal fastcc void @remove_subset_prefix(ptr noundef nonnull captures(none) %0) unnamed_addr #13 {
bb.a:
...
; Function Attrs: nofree norecurse nosync nounwind memory(argmem: readwrite) uwtable
define internal fastcc void @remove_style(ptr noundef captures(none) %0, ptr noundef nonnull readonly captures(none) %1) unnamed_addr #13 {
bb.a:
