...
begin_hunk_0_@cff_face_init:bb.a
  ...
  %i.u = tail call i32 %i.t(ptr noundef %0, ptr noundef nonnull %1, i32 noundef %2, i32 noundef %3, ptr noundef %4) #20
...
begin_hunk_1_@cff_face_init:bb.a
  ...
  %spec.select = select i1 %.not379.not, i64 2073, i64 2065
  %i.jz = getelementptr inbounds nuw i8, ptr %i.as, i64 1664
  %i.ka = load i8, ptr %i.jz, align 8, !tbaa !169
  %.not408 = icmp eq i8 %i.ka, 0
  %6 = select i1 %.not379.not, i64 2077, i64 2069
  %.1342 = select i1 %.not408, i64 %spec.select, i64 %6
