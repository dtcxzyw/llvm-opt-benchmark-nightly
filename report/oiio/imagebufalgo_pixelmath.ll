...
scalar.ph169:                                     ; preds = %scalar.ph169.preheader, %scalar.ph169
  ...
  %6 = getelementptr inbounds [4 x i8], ptr %i.bx, i64 %indvars.iv119
  %7 = load float, ptr %i.gs, align 4, !tbaa !54  ; 2 uses
  %8 = fadd float %7, -1.000000e+00
  %9 = fmul float %i.gr, %7
  %10 = fmul float %i.gr, %8
  %11 = call float @llvm.exp.f32(float %9)
  %i.gt = call float @llvm.exp.f32(float %10)
  %i.gu = insertelement <2 x float> poison, float %i.gt, i64 0
  %i.gv = insertelement <2 x float> %i.gu, float %11, i64 1
  ...
  store float %i.gy, ptr %6, align 4, !tbaa !54
...
scalar.ph169:                                     ; preds = %scalar.ph169.preheader, %scalar.ph169
  ...
  %6 = getelementptr inbounds [4 x i8], ptr %i.bz, i64 %indvars.iv119
  %7 = load float, ptr %i.ha, align 4, !tbaa !54  ; 2 uses
  %8 = fadd float %7, -1.000000e+00
  %9 = fmul float %i.gz, %7
  %10 = fmul float %i.gz, %8
  %11 = call float @llvm.exp.f32(float %9)
  %i.hb = call float @llvm.exp.f32(float %10)
  %i.hc = insertelement <2 x float> poison, float %i.hb, i64 0
  %i.hd = insertelement <2 x float> %i.hc, float %11, i64 1
  ...
  store float %i.hg, ptr %6, align 4, !tbaa !54
...
scalar.ph177:                                     ; preds = %scalar.ph177.preheader, %scalar.ph177
  ...
  %6 = getelementptr inbounds [4 x i8], ptr %i.co, i64 %indvars.iv123
  %7 = load float, ptr %i.io, align 4, !tbaa !54  ; 2 uses
  %8 = fadd float %7, -1.000000e+00
  %9 = fmul float %i.in, %7
  %10 = fmul float %i.in, %8
  %11 = call float @llvm.exp.f32(float %9)
  %i.ip = call float @llvm.exp.f32(float %10)
  %i.iq = insertelement <2 x float> poison, float %i.ip, i64 0
  %i.ir = insertelement <2 x float> %i.iq, float %11, i64 1
  ...
  store float %i.iu, ptr %6, align 4, !tbaa !54
...
scalar.ph172:                                     ; preds = %scalar.ph172.preheader, %scalar.ph172
  ...
  %6 = getelementptr inbounds [4 x i8], ptr %i.cf, i64 %indvars.iv122
  %7 = load float, ptr %i.hg, align 4, !tbaa !54  ; 2 uses
  %8 = fadd float %7, -1.000000e+00
  %9 = fmul float %i.hf, %7
  %10 = fmul float %i.hf, %8
  %11 = call float @llvm.exp.f32(float %9)
  %i.hh = call float @llvm.exp.f32(float %10)
  %i.hi = insertelement <2 x float> poison, float %i.hh, i64 0
  %i.hj = insertelement <2 x float> %i.hi, float %11, i64 1
  ...
  store float %i.hm, ptr %6, align 4, !tbaa !54
...
scalar.ph187:                                     ; preds = %scalar.ph187.preheader, %scalar.ph187
  ...
  %6 = getelementptr inbounds [4 x i8], ptr %i.ee, i64 %indvars.iv128
  %7 = load float, ptr %i.ke, align 4, !tbaa !54  ; 2 uses
  %8 = fadd float %7, -1.000000e+00
  %9 = fmul float %i.kd, %7
  %10 = fmul float %i.kd, %8
  %11 = call float @llvm.exp.f32(float %9)
  %i.kf = call float @llvm.exp.f32(float %10)
  %i.kg = insertelement <2 x float> poison, float %i.kf, i64 0
  %i.kh = insertelement <2 x float> %i.kg, float %11, i64 1
  ...
  store float %i.kk, ptr %6, align 4, !tbaa !54
