...
bb.n:                                             ; preds = %bb.m
  ...
  %6 = fsub float -1.000000e+00, %i.bz
  %7 = fadd float %i.bz, -1.000000e+00
  %i.ca = insertelement <2 x float> poison, float %7, i64 0
  %8 = insertelement <2 x float> %i.ca, float %6, i64 1
  %i.cb = fdiv <2 x float> %8, splat (float f0x438E2DCC) ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  %9 = fsub float -1.000000e+00, %i.do
  %10 = fadd float %i.do, -1.000000e+00
  %i.dp = insertelement <2 x float> poison, float %10, i64 0
  %11 = insertelement <2 x float> %i.dp, float %9, i64 1
  %i.dq = fdiv <2 x float> %11, splat (float f0x438E2DCC) ; 2 uses
...
bb.az:                                            ; preds = %bb.ay
  ...
  %12 = fsub float -1.000000e+00, %i.iy
  %13 = fadd float %i.iy, -1.000000e+00
  %i.iz = insertelement <2 x float> poison, float %13, i64 0
  %14 = insertelement <2 x float> %i.iz, float %12, i64 1
  %i.ja = fdiv <2 x float> %14, splat (float f0x438E2DCC) ; 2 uses
...
bb.bn:                                            ; preds = %bb.bm
  ...
  %15 = fsub float -1.000000e+00, %i.ks
  %16 = fadd float %i.ks, -1.000000e+00
  %i.kt = insertelement <2 x float> poison, float %16, i64 0
  %17 = insertelement <2 x float> %i.kt, float %15, i64 1
  %i.ku = fdiv <2 x float> %17, splat (float f0x438E2DCC) ; 2 uses
...
bb.az:                                            ; preds = %bb.ay
  ...
  %12 = fsub float -1.000000e+00, %i.je
  %13 = fadd float %i.je, -1.000000e+00
  %i.jf = insertelement <2 x float> poison, float %13, i64 0
  %14 = insertelement <2 x float> %i.jf, float %12, i64 1
  %i.jg = fdiv <2 x float> %14, splat (float f0x438E2DCC) ; 2 uses
...
bb.bn:                                            ; preds = %bb.bm
  ...
  %15 = fsub float -1.000000e+00, %i.lb
  %16 = fadd float %i.lb, -1.000000e+00
  %i.lc = insertelement <2 x float> poison, float %16, i64 0
  %17 = insertelement <2 x float> %i.lc, float %15, i64 1
  %i.ld = fdiv <2 x float> %17, splat (float f0x438E2DCC) ; 2 uses
...
bb.br:                                            ; preds = %bb.bq
  ...
  %12 = fsub float -1.000000e+00, %i.kx
  %13 = fadd float %i.kx, -1.000000e+00
  %i.ky = insertelement <2 x float> poison, float %13, i64 0
  %14 = insertelement <2 x float> %i.ky, float %12, i64 1
  %i.kz = fdiv <2 x float> %14, splat (float f0x438E2DCC) ; 2 uses
...
bb.dg:                                            ; preds = %bb.df
  ...
  %15 = fsub float -1.000000e+00, %i.oz
  %16 = fadd float %i.oz, -1.000000e+00
  %i.pa = insertelement <2 x float> poison, float %16, i64 0
  %17 = insertelement <2 x float> %i.pa, float %15, i64 1
  %i.pb = fdiv <2 x float> %17, splat (float f0x438E2DCC) ; 2 uses
...
bb.n:                                             ; preds = %bb.m
  ...
  %6 = fsub float -1.000000e+00, %i.cf
  %7 = fadd float %i.cf, -1.000000e+00
  %i.cg = insertelement <2 x float> poison, float %7, i64 0
  %8 = insertelement <2 x float> %i.cg, float %6, i64 1
  %i.ch = fdiv <2 x float> %8, splat (float f0x438E2DCC) ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  %9 = fsub float -1.000000e+00, %i.ec
  %10 = fadd float %i.ec, -1.000000e+00
  %i.ed = insertelement <2 x float> poison, float %10, i64 0
  %11 = insertelement <2 x float> %i.ed, float %9, i64 1
  %i.ee = fdiv <2 x float> %11, splat (float f0x438E2DCC) ; 2 uses
...
bb.az:                                            ; preds = %bb.ay
  ...
  %12 = fsub float -1.000000e+00, %i.jw
  %13 = fadd float %i.jw, -1.000000e+00
  %i.jx = insertelement <2 x float> poison, float %13, i64 0
  %14 = insertelement <2 x float> %i.jx, float %12, i64 1
  %i.jy = fdiv <2 x float> %14, splat (float f0x438E2DCC) ; 2 uses
...
bb.bq:                                            ; preds = %bb.bp
  ...
  %15 = fsub float -1.000000e+00, %i.ml
  %16 = fadd float %i.ml, -1.000000e+00
  %i.mm = insertelement <2 x float> poison, float %16, i64 0
  %17 = insertelement <2 x float> %i.mm, float %15, i64 1
  %i.mn = fdiv <2 x float> %17, splat (float f0x438E2DCC) ; 2 uses
...
bb.af:                                            ; preds = %bb.ae
  ...
  %6 = fsub float -1.000000e+00, %i.dy
  %7 = fadd float %i.dy, -1.000000e+00
  %i.dz = insertelement <2 x float> poison, float %7, i64 0
  %8 = insertelement <2 x float> %i.dz, float %6, i64 1
  %i.ea = fdiv <2 x float> %8, splat (float f0x438E2DCC) ; 2 uses
...
bb.bk:                                            ; preds = %bb.bj
  ...
  %9 = fsub float -1.000000e+00, %i.il
  %10 = fadd float %i.il, -1.000000e+00
  %i.im = insertelement <2 x float> poison, float %10, i64 0
  %11 = insertelement <2 x float> %i.im, float %9, i64 1
  %i.in = fdiv <2 x float> %11, splat (float f0x438E2DCC) ; 2 uses
...
bb.dp:                                            ; preds = %bb.do
  ...
  %12 = fsub float -1.000000e+00, %i.rk
  %13 = fadd float %i.rk, -1.000000e+00
  %i.rl = insertelement <2 x float> poison, float %13, i64 0
  %14 = insertelement <2 x float> %i.rl, float %12, i64 1
  %i.rm = fdiv <2 x float> %14, splat (float f0x438E2DCC) ; 2 uses
...
bb.gf:                                            ; preds = %bb.ge
  ...
  %15 = fsub float -1.000000e+00, %i.aag
  %16 = fadd float %i.aag, -1.000000e+00
  %i.aah = insertelement <2 x float> poison, float %16, i64 0
  %17 = insertelement <2 x float> %i.aah, float %15, i64 1
  %i.aai = fdiv <2 x float> %17, splat (float f0x438E2DCC) ; 2 uses
...
bb.w:                                             ; preds = %bb.v
  ...
  %9 = fsub float -1.000000e+00, %i.ed
  %10 = fadd float %i.ed, -1.000000e+00
  %i.ee = insertelement <2 x float> poison, float %10, i64 0
  %11 = insertelement <2 x float> %i.ee, float %9, i64 1
  %i.ef = fdiv <2 x float> %11, splat (float f0x438E2DCC) ; 2 uses
...
bb.az:                                            ; preds = %bb.ay
  ...
  %12 = fsub float -1.000000e+00, %i.jx
  %13 = fadd float %i.jx, -1.000000e+00
  %i.jy = insertelement <2 x float> poison, float %13, i64 0
  %14 = insertelement <2 x float> %i.jy, float %12, i64 1
  %i.jz = fdiv <2 x float> %14, splat (float f0x438E2DCC) ; 2 uses
...
bb.bq:                                            ; preds = %bb.bp
  ...
  %15 = fsub float -1.000000e+00, %i.mm
  %16 = fadd float %i.mm, -1.000000e+00
  %i.mn = insertelement <2 x float> poison, float %16, i64 0
  %17 = insertelement <2 x float> %i.mn, float %15, i64 1
  %i.mo = fdiv <2 x float> %17, splat (float f0x438E2DCC) ; 2 uses
