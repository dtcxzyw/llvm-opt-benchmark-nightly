...
bb.ax:                                            ; preds = %_ZNK11OpenImageIO4v3_18ImageBuf12IteratorBase4doneEv.exit157.thread.i.i.i
  ...
  %i.ii = uitofp <2 x i8> %i.ih to <2 x float>    ; 2 uses
  %6 = extractelement <2 x float> %i.ii, i64 0
  %7 = fmul nnan float %6, f0x3B808081
  %i.ij = extractelement <2 x float> %i.ii, i64 1
  %8 = fmul nnan float %i.ij, f0x3B808081
  %9 = fmul nnan float %7, 7.151700e-01
  %10 = call float @llvm.fmuladd.f32(float %i.if, float 2.126400e-01, float %9)
  %i.ik = call float @llvm.fmuladd.f32(float %8, float 7.219000e-02, float %10) ; 5 uses
...
bb.ax:                                            ; preds = %_ZNK11OpenImageIO4v3_18ImageBuf12IteratorBase4doneEv.exit157.thread.i.i.i
  ...
  %i.ii = uitofp <2 x i16> %i.ih to <2 x float>   ; 2 uses
  %6 = extractelement <2 x float> %i.ii, i64 0
  %7 = fmul nnan float %6, f0x37800080
  %i.ij = extractelement <2 x float> %i.ii, i64 1
  %8 = fmul nnan float %i.ij, f0x37800080
  %9 = fmul nnan float %7, 7.151700e-01
  %10 = call float @llvm.fmuladd.f32(float %i.if, float 2.126400e-01, float %9)
  %i.ik = call float @llvm.fmuladd.f32(float %8, float 7.219000e-02, float %10) ; 5 uses
  %i.il = fcmp ogt float %i.ik, 0.000000e+00
...
bb.l:                                             ; preds = %_ZNK11OpenImageIO4v3_18ImageBuf12IteratorBase4doneEv.exit.thread.i.i.i
  ...
  %i.bs = uitofp <2 x i8> %i.br to <2 x float>    ; 2 uses
  %6 = extractelement <2 x float> %i.bs, i64 0
  %7 = fmul nnan float %6, f0x3B808081
  %8 = fmul nnan float %7, 7.151700e-01
  %i.bt = call float @llvm.fmuladd.f32(float %i.bp, float 2.126400e-01, float %8)
  %i.bu = extractelement <2 x float> %i.bs, i64 1
  %9 = fmul nnan float %i.bu, f0x3B808081
  %i.bv = call float @llvm.fmuladd.f32(float %9, float 7.219000e-02, float %i.bt) ; 5 uses
...
bb.ax:                                            ; preds = %_ZNK11OpenImageIO4v3_18ImageBuf12IteratorBase4doneEv.exit160.thread.i.i.i
  ...
  %i.iu = uitofp <2 x i8> %i.it to <2 x float>    ; 2 uses
  %10 = extractelement <2 x float> %i.iu, i64 0
  %11 = fmul nnan float %10, f0x3B808081
  %i.iv = extractelement <2 x float> %i.iu, i64 1
  %12 = fmul nnan float %i.iv, f0x3B808081
  %13 = fmul nnan float %11, 7.151700e-01
  %14 = call float @llvm.fmuladd.f32(float %i.ir, float 2.126400e-01, float %13)
  %i.iw = call float @llvm.fmuladd.f32(float %12, float 7.219000e-02, float %14) ; 5 uses
...
bb.l:                                             ; preds = %_ZNK11OpenImageIO4v3_18ImageBuf12IteratorBase4doneEv.exit.thread.i.i.i
  ...
  %i.bs = uitofp <2 x i16> %i.br to <2 x float>   ; 2 uses
  %6 = extractelement <2 x float> %i.bs, i64 0
  %7 = fmul nnan float %6, f0x37800080
  %8 = fmul nnan float %7, 7.151700e-01
  %i.bt = call float @llvm.fmuladd.f32(float %i.bp, float 2.126400e-01, float %8)
  %i.bu = extractelement <2 x float> %i.bs, i64 1
  %9 = fmul nnan float %i.bu, f0x37800080
  %i.bv = call float @llvm.fmuladd.f32(float %9, float 7.219000e-02, float %i.bt) ; 5 uses
  %i.bw = fcmp ogt float %i.bv, 0.000000e+00
  br i1 %i.bw, label %bb.m, label %bb.o
...
bb.ax:                                            ; preds = %_ZNK11OpenImageIO4v3_18ImageBuf12IteratorBase4doneEv.exit160.thread.i.i.i
  ...
  %i.iv = uitofp <2 x i16> %i.iu to <2 x float>   ; 2 uses
  %10 = extractelement <2 x float> %i.iv, i64 0
  %11 = fmul nnan float %10, f0x37800080
  %i.iw = extractelement <2 x float> %i.iv, i64 1
  %12 = fmul nnan float %i.iw, f0x37800080
  %13 = fmul nnan float %11, 7.151700e-01
  %14 = call float @llvm.fmuladd.f32(float %i.is, float 2.126400e-01, float %13)
  %i.ix = call float @llvm.fmuladd.f32(float %12, float 7.219000e-02, float %14) ; 5 uses
...
bb.ax:                                            ; preds = %_ZNK11OpenImageIO4v3_18ImageBuf12IteratorBase4doneEv.exit162.thread.i.i.i
  ...
  %i.iv = uitofp <2 x i8> %i.iu to <2 x float>    ; 2 uses
  %6 = extractelement <2 x float> %i.iv, i64 0
  %7 = fmul nnan float %6, f0x3B808081
  %i.iw = extractelement <2 x float> %i.iv, i64 1
  %8 = fmul nnan float %i.iw, f0x3B808081
  %9 = fmul nnan float %7, 7.151700e-01
  %10 = call float @llvm.fmuladd.f32(float %i.is, float 2.126400e-01, float %9)
  %i.ix = call float @llvm.fmuladd.f32(float %8, float 7.219000e-02, float %10) ; 5 uses
  %i.iy = fcmp ogt float %i.ix, 0.000000e+00
  br i1 %i.iy, label %bb.ay, label %bb.ba
...
bb.ax:                                            ; preds = %_ZNK11OpenImageIO4v3_18ImageBuf12IteratorBase4doneEv.exit162.thread.i.i.i
  ...
  %7 = fmul nnan float %6, f0x37800080
  %i.iw = extractelement <2 x float> %i.iv, i64 1
  %8 = fmul nnan float %i.iw, f0x37800080
  %9 = fmul nnan float %7, 7.151700e-01
  %10 = call float @llvm.fmuladd.f32(float %i.is, float 2.126400e-01, float %9)
  %i.ix = call float @llvm.fmuladd.f32(float %8, float 7.219000e-02, float %10) ; 5 uses
  %i.iy = fcmp ogt float %i.ix, 0.000000e+00
...
bb.ax:                                            ; preds = %_ZNK11OpenImageIO4v3_18ImageBuf12IteratorBase4doneEv.exit165.thread.i.i.i
  ...
  %i.ji = uitofp <2 x i8> %i.jh to <2 x float>    ; 2 uses
  %10 = extractelement <2 x float> %i.ji, i64 0
  %11 = fmul nnan float %10, f0x3B808081
  %i.jj = extractelement <2 x float> %i.ji, i64 1
  %12 = fmul nnan float %i.jj, f0x3B808081
  %13 = fmul nnan float %11, 7.151700e-01
  %14 = call float @llvm.fmuladd.f32(float %i.jf, float 2.126400e-01, float %13)
  %i.jk = call float @llvm.fmuladd.f32(float %12, float 7.219000e-02, float %14) ; 5 uses
...
bb.ax:                                            ; preds = %_ZNK11OpenImageIO4v3_18ImageBuf12IteratorBase4doneEv.exit165.thread.i.i.i
  ...
  %i.jj = uitofp <2 x i16> %i.ji to <2 x float>   ; 2 uses
  %10 = extractelement <2 x float> %i.jj, i64 0
  %11 = fmul nnan float %10, f0x37800080
  %i.jk = extractelement <2 x float> %i.jj, i64 1
  %12 = fmul nnan float %i.jk, f0x37800080
  %13 = fmul nnan float %11, 7.151700e-01
  %14 = call float @llvm.fmuladd.f32(float %i.jg, float 2.126400e-01, float %13)
  %i.jl = call float @llvm.fmuladd.f32(float %12, float 7.219000e-02, float %14) ; 5 uses
...
bb.g:                                             ; preds = %_ZNK11OpenImageIO4v3_18ImageBuf12IteratorBase4doneEv.exit.thread.i.i.i
  ...
  %i.ch = uitofp <2 x i8> %i.cg to <2 x float>    ; 2 uses
  %5 = extractelement <2 x float> %i.ch, i64 0
  %6 = fmul nnan float %5, f0x3B808081
  %i.ci = extractelement <2 x float> %i.ch, i64 1
  %7 = fmul nnan float %i.ci, f0x3B808081
  %8 = fmul nnan float %6, 7.152000e-01
  %9 = call float @llvm.fmuladd.f32(float %i.ce, float 2.126000e-01, float %8)
  %i.cj = call float @llvm.fmuladd.f32(float %7, float 7.220000e-02, float %9)
  br label %bb.i
...
bb.g:                                             ; preds = %_ZNK11OpenImageIO4v3_18ImageBuf12IteratorBase4doneEv.exit.thread.i.i.i
  ...
  %i.ch = uitofp <2 x i16> %i.cg to <2 x float>   ; 2 uses
  %5 = extractelement <2 x float> %i.ch, i64 0
  %6 = fmul nnan float %5, f0x37800080
  %i.ci = extractelement <2 x float> %i.ch, i64 1
  %7 = fmul nnan float %i.ci, f0x37800080
  %8 = fmul nnan float %6, 7.152000e-01
  %9 = call float @llvm.fmuladd.f32(float %i.ce, float 2.126000e-01, float %8)
  %i.cj = call float @llvm.fmuladd.f32(float %7, float 7.220000e-02, float %9)
  br label %bb.i
