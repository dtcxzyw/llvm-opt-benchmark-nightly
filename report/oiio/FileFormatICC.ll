...
bb.n:                                             ; preds = %bb.l
  %i.aa = call ptr @__dynamic_cast(ptr nonnull %i.x, ptr nonnull @_ZTIN9SampleICC13IccTypeReaderE, ptr nonnull @_ZTIN9SampleICC21IccXYZArrayTypeReaderE, i64 0) #31 ; 4 uses
...
begin_hunk_2_@_ZNK16OpenColorIO_v2_515LocalFileFormat4readERSiRKNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEENS_13InterpolationE:bb.a
  ...
  %16 = getelementptr inbounds nuw i8, ptr %i.aa, i64 16
  %17 = load i32, ptr %16, align 4, !tbaa !177
  %18 = sitofp i32 %17 to double
  %19 = fmul nnan double %18, 0x3EF0000000000000
  %i.ca = getelementptr inbounds nuw i8, ptr %i.ar, i64 120
  store double %19, ptr %i.ca, align 8, !tbaa !174
