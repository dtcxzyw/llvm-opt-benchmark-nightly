...
bb.fz:                                            ; preds = %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit665.thread, %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit665
  ...
  %22 = ptrtoint ptr %.sroa.0880.0102310431083.a to i64
  %i.azc = ptrtoint ptr %.sroa.0880.0102310431083 to i64
  %i.azd = sub i64 %22, %i.azc
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0880.0102310431083, i64 noundef %i.azd) #35
  br label %_ZNSt6vectorIiSaIiEED2Ev.exit667
