...
_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i: ; preds = %.preheader413, %._crit_edge
  %.lcssa447762 = phi i64 [ %i.ex, %._crit_edge ], [ %i.p, %.preheader413 ] ; 5 uses
  %.lcssa454761 = phi i64 [ %i.ew, %._crit_edge ], [ %i.o, %.preheader413 ]
  %.lcssa461760 = phi ptr [ %i.et, %._crit_edge ], [ %i.l, %.preheader413 ]
  %.lcssa468759 = phi ptr [ %i.es, %._crit_edge ], [ %i.k, %.preheader413 ]
...
bb.g:                                             ; preds = %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i
  %i.y = ashr exact i64 %.lcssa454761, 3
  %i.z = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.y) #34
          to label %.noexc126 unwind label %bb.ao ; 6 uses

.noexc126:                                        ; preds = %bb.g
  %i.aa = getelementptr inbounds nuw [4 x i8], ptr %i.z, i64 %.lcssa447762 ; 3 uses
  store i32 0, ptr %i.z, align 4, !tbaa !3
  %i.ab = add nsw i64 %.lcssa447762, -1           ; 3 uses
  %i.ac = icmp eq i64 %i.ab, 0                    ; 2 uses
  br i1 %i.ac, label %bb.ak, label %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i
...
bb.i:                                             ; preds = %.lr.ph, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit145
  %i.af = phi ptr [ %i.l, %.lr.ph ], [ %i.et, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit145 ]
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i: ; preds = %bb.s
  store ptr %i.t, ptr %8, align 8, !tbaa !23, !alias.scope !25
  %i.bl = load ptr, ptr %i.bh, align 8, !tbaa !18, !noalias !25
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 %.090 ; 2 uses
  %i.bn = sub nuw i64 %i.bj, %.090                ; 4 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c) #32, !noalias !25
  store i64 %i.bn, ptr %i.c, align 8, !tbaa !24, !noalias !25
  %i.bo = icmp ugt i64 %i.bn, 15
  br i1 %i.bo, label %.noexc10.i.i130, label %._crit_edge.i.i.i129

.noexc10.i.i130:                                  ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i
  %i.bp = invoke noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %8, ptr noundef nonnull align 8 dereferenceable(8) %i.c, i64 noundef 0)
          to label %.noexc132 unwind label %.loopexit414 ; 2 uses

.noexc132:                                        ; preds = %.noexc10.i.i130
  store ptr %i.bp, ptr %8, align 8, !tbaa !18, !alias.scope !25
  %i.bq = load i64, ptr %i.c, align 8, !tbaa !24, !noalias !25
  store i64 %i.bq, ptr %i.t, align 8, !tbaa !19, !alias.scope !25
...
._crit_edge.i.i.i129:                             ; preds = %.noexc132, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i
  %i.br = phi ptr [ %i.bp, %.noexc132 ], [ %i.t, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8_M_checkEmPKc.exit.i.i ] ; 2 uses
  switch i64 %i.bn, label %bb.v [
    i64 1, label %bb.u
    i64 0, label %bb.w
  ]
...
bb.v:                                             ; preds = %._crit_edge.i.i.i129
  call void @llvm.memcpy.p0.p0.i64(ptr align 1 %i.br, ptr nonnull align 1 %i.bm, i64 %i.bn, i1 false)
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %bb.u, %._crit_edge.i.i.i129
  %i.bt = load i64, ptr %i.c, align 8, !tbaa !24, !noalias !25 ; 2 uses
  store i64 %i.bt, ptr %i.u, align 8, !tbaa !14, !alias.scope !25
  %i.bu = load ptr, ptr %8, align 8, !tbaa !18, !alias.scope !25
  %i.bv = getelementptr inbounds nuw i8, ptr %i.bu, i64 %i.bt
  store i8 0, ptr %i.bv, align 1, !tbaa !19
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #32, !noalias !25
  call void @llvm.experimental.noalias.scope.decl(metadata !28)
  %i.bw = load i64, ptr %i.s, align 8, !tbaa !14, !noalias !28 ; 4 uses
  %i.bx = load i64, ptr %i.u, align 8, !tbaa !14, !noalias !28 ; 4 uses
  %i.by = add i64 %i.bx, %i.bw                    ; 2 uses
  %i.bz = load ptr, ptr %7, align 8, !tbaa !18, !noalias !28 ; 2 uses
  %i.ca = icmp eq ptr %i.bz, %i.r
  br i1 %i.ca, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i: ; preds = %bb.w
  %i.cb = icmp ult i64 %i.bw, 16
  call void @llvm.assume(i1 %i.cb)
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i: ; preds = %bb.w
  %i.cc = load i64, ptr %i.r, align 8, !tbaa !19, !noalias !28
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i
  %i.cd = phi i64 [ %i.cc, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i ], [ 15, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i ]
...
bb.x:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i
  %i.cf = load ptr, ptr %8, align 8, !tbaa !18, !noalias !28
  %i.cg = icmp eq ptr %i.cf, %i.t
  br i1 %i.cg, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i13.i, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i12.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i13.i: ; preds = %bb.x
  %i.ch = icmp ult i64 %i.bx, 16
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i12.i: ; preds = %bb.x
  %i.ci = load i64, ptr %i.t, align 8, !tbaa !19, !noalias !28
  br label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit14.i
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit14.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i12.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i13.i
  %i.cj = phi i64 [ %i.ci, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i12.i ], [ 15, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i13.i ]
  %.not.i = icmp ugt i64 %i.by, %i.cj
...
.critedge.i:                                      ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit14.i
  %i.ck = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE10_M_replaceEmmPKcm(ptr noundef nonnull align 8 dereferenceable(32) %8, i64 noundef 0, i64 noundef 0, ptr noundef %i.bz, i64 noundef %i.bw)
          to label %.noexc134 unwind label %.loopexit419 ; 5 uses

.noexc134:                                        ; preds = %.critedge.i
  store ptr %i.v, ptr %6, align 8, !tbaa !23, !alias.scope !28
  %i.cl = load ptr, ptr %i.ck, align 8, !tbaa !18 ; 2 uses
  %i.cm = getelementptr inbounds nuw i8, ptr %i.ck, i64 16 ; 5 uses
  %i.cn = icmp eq ptr %i.cl, %i.cm
  br i1 %i.cn, label %bb.y, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i15.i

bb.y:                                             ; preds = %.noexc134
  %i.co = getelementptr inbounds nuw i8, ptr %i.ck, i64 8
  %i.cp = load i64, ptr %i.co, align 8, !tbaa !14 ; 2 uses
  %i.cq = icmp ult i64 %i.cp, 16
  call void @llvm.assume(i1 %i.cq)
  %i.cr = add nuw nsw i64 %i.cp, 1
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.v, ptr noundef nonnull align 8 dereferenceable(1) %i.cm, i64 %i.cr, i1 false)
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i15.i: ; preds = %.noexc134
  store ptr %i.cl, ptr %6, align 8, !tbaa !18, !alias.scope !28
  %i.cs = load i64, ptr %i.cm, align 8, !tbaa !19
  store i64 %i.cs, ptr %i.v, align 8, !tbaa !19, !alias.scope !28
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.i
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i15.i, %bb.y
  %i.ct = getelementptr inbounds nuw i8, ptr %i.ck, i64 8 ; 2 uses
  %i.cu = load i64, ptr %i.ct, align 8, !tbaa !14
  store i64 %i.cu, ptr %i.w, align 8, !tbaa !14, !alias.scope !28
  store ptr %i.cm, ptr %i.ck, align 8, !tbaa !18
  store i64 0, ptr %i.ct, align 8, !tbaa !14
  store i8 0, ptr %i.cm, align 8, !tbaa !19
...
bb.z:                                             ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit14.i, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE8capacityEv.exit.i
  %i.cv = sub i64 4611686018427387903, %i.bw
  %i.cw = icmp ult i64 %i.cv, %i.bx
  br i1 %i.cw, label %bb.aa, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i

bb.aa:                                            ; preds = %bb.z
  invoke void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.35) #33
          to label %.noexc135 unwind label %.loopexit.split-lp420

.noexc135:                                        ; preds = %bb.aa
  unreachable

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i: ; preds = %bb.z
  %i.cx = load ptr, ptr %8, align 8, !tbaa !18, !noalias !28
  %i.cy = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm(ptr noundef nonnull align 8 dereferenceable(32) %7, ptr noundef %i.cx, i64 noundef %i.bx)
          to label %.noexc136 unwind label %.loopexit419 ; 5 uses

.noexc136:                                        ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i
  store ptr %i.v, ptr %6, align 8, !tbaa !23, !alias.scope !28
  %i.cz = load ptr, ptr %i.cy, align 8, !tbaa !18 ; 2 uses
  %i.da = getelementptr inbounds nuw i8, ptr %i.cy, i64 16 ; 5 uses
  %i.db = icmp eq ptr %i.cz, %i.da
  br i1 %i.db, label %bb.ab, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i16.i
...
bb.ab:                                            ; preds = %.noexc136
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(1) %i.v, ptr noundef nonnull align 8 dereferenceable(1) %i.da, i64 %i.df, i1 false)
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i16.i: ; preds = %.noexc136
  store ptr %i.cz, ptr %6, align 8, !tbaa !18, !alias.scope !28
  %i.dg = load i64, ptr %i.da, align 8, !tbaa !19
  store i64 %i.dg, ptr %i.v, align 8, !tbaa !19, !alias.scope !28
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit17.i
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit17.i: ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i16.i, %bb.ab
  ...
  store i64 %i.di, ptr %i.w, align 8, !tbaa !14, !alias.scope !28
  store ptr %i.da, ptr %i.cy, align 8, !tbaa !18
  store i64 0, ptr %i.dh, align 8, !tbaa !14
...
_ZStplIcSt11char_traitsIcESaIcEENSt7__cxx1112basic_stringIT_T0_T1_EEOS8_S9_.exit: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit17.i, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EOS4_.exit.i
  ...
  %i.dk = getelementptr inbounds nuw [32 x i8], ptr %i.dj, i64 %.080505 ; 9 uses
  %i.dl = load ptr, ptr %i.dk, align 8, !tbaa !18 ; 6 uses
  %i.dm = getelementptr inbounds nuw i8, ptr %i.dk, i64 16 ; 4 uses
  %i.dn = icmp eq ptr %i.dl, %i.dm
  %i.do = load ptr, ptr %6, align 8, !tbaa !18    ; 6 uses
  %i.dp = icmp eq ptr %i.do, %i.v                 ; 2 uses
end_hunk_0
