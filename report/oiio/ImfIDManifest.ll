...
_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i: ; preds = %_ZSt4sortIN9__gnu_cxx17__normal_iteratorIPSt4pairIiiESt6vectorIS3_SaIS3_EEEEEvT_S9_.exit350
  ...
  %i.tt = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ts) #34
          to label %.noexc353 unwind label %bb.bs ; 15 uses

.noexc353:                                        ; preds = %_ZNSt6vectorIiSaIiEE17_S_check_init_lenEmRKS0_.exit.i
  %19 = ptrtoaddr ptr %i.tt to i64
...
_ZNKSt6vectorISt4pairIiiESaIS1_EE12_M_check_lenEmPKc.exit.i.i: ; preds = %.noexc353, %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i
  %.0.i.i.i.i.i.ph = phi ptr [ %i.tv, %.noexc353 ], [ %i.ty, %_ZSt6fill_nIPimiET_S1_T0_RKT1_.exit.loopexit.i.i.i.i.i ] ; 3 uses
  %.0.i.i.i.i.i.ph1502 = ptrtoaddr ptr %.0.i.i.i.i.i.ph to i64
...
.lr.ph1351:                                       ; preds = %_ZSt4fillIN9__gnu_cxx17__normal_iteratorIPiSt6vectorIiSaIiEEEEiEvT_S7_RKT0_.exit
  %20 = ptrtoint ptr %.0.i.i.i.i.i.ph to i64
  %21 = ptrtoint ptr %i.tt to i64
  %i.ul = sub i64 %20, %21
...
bb.bt:                                            ; preds = %.lr.ph1351, %.critedge2
  ...
  %.01931349 = phi i64 [ 1, %.lr.ph1351 ], [ %i.wk, %.critedge2 ] ; 3 uses
...
.lr.ph.i.i.i.i.i365.preheader:                    ; preds = %.noexc371
  ...
  %22 = add i64 %i.ux, -8
  %23 = sub i64 %22, %i.uy                        ; 2 uses
  %i.vk = lshr i64 %23, 3
  %i.vl = add nuw nsw i64 %i.vk, 1                ; 2 uses
  %min.iters.check = icmp ult i64 %23, 24
  %i.vm = sub i64 %i.uy, %i.vj
  %diff.check = icmp ugt i64 %i.vm, -32
  %or.cond = or i1 %min.iters.check, %diff.check
  br i1 %or.cond, label %.lr.ph.i.i.i.i.i365.preheader2163, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.i365.preheader
  %n.vec = and i64 %i.vl, 4611686018427387900     ; 3 uses
  %i.vn = shl i64 %n.vec, 3                       ; 2 uses
  %i.vo = getelementptr i8, ptr %i.vh, i64 %i.vn  ; 2 uses
  %i.vp = getelementptr i8, ptr %.sroa.0859.01346, i64 %i.vn
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ] ; 2 uses
  %i.vq = shl i64 %index, 3                       ; 2 uses
  %next.gep = getelementptr i8, ptr %i.vh, i64 %i.vq ; 2 uses
  %next.gep1890 = getelementptr i8, ptr %.sroa.0859.01346, i64 %i.vq ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !146)
  call void @llvm.experimental.noalias.scope.decl(metadata !149)
  %i.vr = getelementptr i8, ptr %next.gep1890, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep1890, align 4, !alias.scope !149, !noalias !146
  %wide.load1891 = load <2 x i64>, ptr %i.vr, align 4, !alias.scope !149, !noalias !146
  %i.vs = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 4, !alias.scope !146, !noalias !149
  store <2 x i64> %wide.load1891, ptr %i.vs, align 4, !alias.scope !146, !noalias !149
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.vt = icmp eq i64 %index.next, %n.vec
  br i1 %i.vt, label %middle.block, label %vector.body, !llvm.loop !151
...
.lr.ph.i.i.i.i.i365.preheader2163:                ; preds = %.lr.ph.i.i.i.i.i365.preheader, %middle.block
  %.012.i.i.i.i.i366.ph = phi ptr [ %i.vh, %.lr.ph.i.i.i.i.i365.preheader ], [ %i.vo, %middle.block ]
  %.0911.i.i.i.i.i367.ph = phi ptr [ %.sroa.0859.01346, %.lr.ph.i.i.i.i.i365.preheader ], [ %i.vp, %middle.block ]
  br label %.lr.ph.i.i.i.i.i365

.lr.ph.i.i.i.i.i365:                              ; preds = %.lr.ph.i.i.i.i.i365.preheader2163, %.lr.ph.i.i.i.i.i365
  %.012.i.i.i.i.i366 = phi ptr [ %i.vw, %.lr.ph.i.i.i.i.i365 ], [ %.012.i.i.i.i.i366.ph, %.lr.ph.i.i.i.i.i365.preheader2163 ] ; 2 uses
  %.0911.i.i.i.i.i367 = phi ptr [ %i.vv, %.lr.ph.i.i.i.i.i365 ], [ %.0911.i.i.i.i.i367.ph, %.lr.ph.i.i.i.i.i365.preheader2163 ] ; 2 uses
  call void @llvm.experimental.noalias.scope.decl(metadata !146)
  call void @llvm.experimental.noalias.scope.decl(metadata !149)
  %i.vu = load i64, ptr %.0911.i.i.i.i.i367, align 4, !alias.scope !149, !noalias !146
  store i64 %i.vu, ptr %.012.i.i.i.i.i366, align 4, !alias.scope !146, !noalias !149
  %i.vv = getelementptr inbounds nuw i8, ptr %.0911.i.i.i.i.i367, i64 8 ; 2 uses
  %i.vw = getelementptr inbounds nuw i8, ptr %.012.i.i.i.i.i366, i64 8 ; 2 uses
  %.not.i.i.i.i.i368 = icmp eq ptr %i.vv, %.sroa.29.01348
...
_ZNSt6vectorISt4pairIiiESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i: ; preds = %.lr.ph.i.i.i.i.i365, %middle.block, %.noexc371
  %.0.lcssa.i.i.i.i.i369 = phi ptr [ %i.vh, %.noexc371 ], [ %i.vo, %middle.block ], [ %i.vw, %.lr.ph.i.i.i.i.i365 ]
  %i.vx = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i369, i64 8
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0859.01346, i64 noundef %i.uz) #35
  %i.vy = getelementptr inbounds nuw [8 x i8], ptr %i.vh, i64 %i.vf
  br label %_ZNSt6vectorISt4pairIiiESaIS1_EE9push_backERKS1_.exit
...
_ZNSt6vectorISt4pairIiiESaIS1_EE9push_backERKS1_.exit: ; preds = %bb.bw, %_ZNSt6vectorISt4pairIiiESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i, %bb.bu
  ...
  %.sroa.17.1 = phi ptr [ %.sroa.17.01347, %bb.bu ], [ %i.vx, %_ZNSt6vectorISt4pairIiiESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %i.uw, %bb.bw ] ; 2 uses
  %.sroa.29.1 = phi ptr [ %.sroa.29.01348, %bb.bu ], [ %i.vy, %_ZNSt6vectorISt4pairIiiESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit.i ], [ %.sroa.29.01348, %bb.bw ] ; 2 uses
  %i.vz = trunc i64 %.01931349 to i32
  %i.wa = load i32, ptr %i.us, align 4, !tbaa !134 ; 2 uses
  %i.wb = sext i32 %i.wa to i64                   ; 2 uses
  %i.wc = getelementptr inbounds nuw [4 x i8], ptr %i.tt, i64 %i.wb
  store i32 %i.vz, ptr %i.wc, align 4, !tbaa !3
  %i.wd = add nsw i32 %i.wa, 1
  %smax = call i32 @llvm.smax.i32(i32 %i.wd, i32 %i.un) ; 2 uses
  %indvars.iv.next15041887 = add nsw i64 %i.wb, 1 ; 2 uses
  %i.we = icmp slt i64 %indvars.iv.next15041887, %i.uo
  br i1 %i.we, label %.lr.ph1889, label %.critedge2

bb.bz:                                            ; preds = %.lr.ph1889
  %indvars.iv.next1504 = add nsw i64 %indvars.iv.next15041888, 1 ; 2 uses
  %i.wf = icmp slt i64 %indvars.iv.next1504, %i.uo
  br i1 %i.wf, label %.lr.ph1889, label %.critedge2, !llvm.loop !155
...
.lr.ph1889:                                       ; preds = %_ZNSt6vectorISt4pairIiiESaIS1_EE9push_backERKS1_.exit, %bb.bz
  ...
  %i.wg = getelementptr inbounds nuw [4 x i8], ptr %i.tt, i64 %indvars.iv.next15041888
  %i.wh = load i32, ptr %i.wg, align 4, !tbaa !3
  %i.wi = icmp sgt i32 %i.wh, -1
  br i1 %i.wi, label %bb.bz, label %.critedge2.split.loop.exit, !llvm.loop !155

.critedge2.split.loop.exit:                       ; preds = %.lr.ph1889
  %i.wj = trunc nsw i64 %indvars.iv.next15041888 to i32
  br label %.critedge2

.critedge2:                                       ; preds = %bb.bz, %_ZNSt6vectorISt4pairIiiESaIS1_EE9push_backERKS1_.exit, %.critedge2.split.loop.exit
  %.1187.lcssa = phi i32 [ %i.wj, %.critedge2.split.loop.exit ], [ %smax, %_ZNSt6vectorISt4pairIiiESaIS1_EE9push_backERKS1_.exit ], [ %smax, %bb.bz ]
  %i.wk = add nuw i64 %.01931349, 1               ; 2 uses
  %exitcond1506.not = icmp eq i64 %i.wk, %.pre1525
...
.lr.ph.i:                                         ; preds = %_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit, %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i
  %.15.i = phi i32 [ %i.wy, %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i ], [ 4, %_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit ]
  %.sroa.01.04.i = phi ptr [ %i.wz, %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i ], [ %.sroa.0947.0997, %_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit ] ; 2 uses
  %i.wl = getelementptr i8, ptr %.sroa.01.04.i, i64 8
  %.val.val.i = load i64, ptr %i.wl, align 8, !tbaa !14 ; 10 uses
  %i.wm = trunc i64 %.val.val.i to i32
  %i.wn = add i32 %.15.i, %i.wm
  %i.wo = icmp ult i64 %.val.val.i, 128
  br i1 %i.wo, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i, label %bb.ca

bb.ca:                                            ; preds = %.lr.ph.i
  %i.wp = icmp ult i64 %.val.val.i, 16384
  br i1 %i.wp, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i, label %bb.cb

bb.cb:                                            ; preds = %bb.ca
  %i.wq = icmp ult i64 %.val.val.i, 2097152
  br i1 %i.wq, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i, label %bb.cc

bb.cc:                                            ; preds = %bb.cb
  %i.wr = icmp ult i64 %.val.val.i, 268435456
  br i1 %i.wr, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i, label %bb.cd

bb.cd:                                            ; preds = %bb.cc
  %i.ws = icmp ult i64 %.val.val.i, 34359738368
  br i1 %i.ws, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i, label %bb.ce

bb.ce:                                            ; preds = %bb.cd
  %i.wt = icmp ult i64 %.val.val.i, 4398046511104
  br i1 %i.wt, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i, label %bb.cf

bb.cf:                                            ; preds = %bb.ce
  %i.wu = icmp ult i64 %.val.val.i, 562949953421312
  br i1 %i.wu, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i, label %bb.cg

bb.cg:                                            ; preds = %bb.cf
  %i.wv = icmp ult i64 %.val.val.i, 72057594037927936
  br i1 %i.wv, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i, label %bb.ch

bb.ch:                                            ; preds = %bb.cg
  %i.ww = icmp sgt i64 %.val.val.i, -1
  %i.wx = select i1 %i.ww, i32 9, i32 10
...
_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i: ; preds = %bb.ch, %bb.cg, %bb.cf, %bb.ce, %bb.cd, %bb.cc, %bb.cb, %bb.ca, %.lr.ph.i
  %.0.i.i = phi i32 [ 8, %bb.cg ], [ 1, %.lr.ph.i ], [ 2, %bb.ca ], [ 3, %bb.cb ], [ 4, %bb.cc ], [ 5, %bb.cd ], [ 6, %bb.ce ], [ 7, %bb.cf ], [ %i.wx, %bb.ch ]
  %i.wy = add i32 %i.wn, %.0.i.i                  ; 2 uses
  %i.wz = getelementptr inbounds nuw i8, ptr %.sroa.01.04.i, i64 32 ; 2 uses
  %.not.i372 = icmp eq ptr %i.wz, %.0.lcssa.i.i.i.i.i1006
...
_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_117getStringListSizeISt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS8_EEEEiRKT_m.exit: ; preds = %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i, %_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit
  %.1.lcssa.i = phi i32 [ 4, %_ZNSt6vectorIiSaIiEEC2EmRKS0_.exit ], [ %i.wy, %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_128getVariableLengthIntegerSizeEm.exit.i ]
  %i.xa = ptrtoint ptr %.sroa.17.2 to i64
  %i.xb = ptrtoint ptr %.sroa.0859.2 to i64       ; 2 uses
  %i.xc = sub i64 %i.xa, %i.xb                    ; 2 uses
  %i.xd = ashr exact i64 %i.xc, 3                 ; 7 uses
  %.tr = trunc i64 %i.xd to i32                   ; 2 uses
  %i.xe = shl i32 %.tr, 3
  %i.xf = add i32 %i.xe, 12
  %i.xg = add i32 %i.xf, %.1.lcssa.i              ; 2 uses
  %i.xh = load ptr, ptr %i.h, align 8, !tbaa !39
  %i.xi = load ptr, ptr %0, align 8, !tbaa !36    ; 2 uses
  %.not1411 = icmp eq ptr %i.xh, %i.xi
...
._crit_edge1378:                                  ; preds = %bb.et, %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_117getStringListSizeISt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS8_EEEEiRKT_m.exit
  ...
  %.0189.lcssa = phi i32 [ %i.xg, %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_117getStringListSizeISt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS8_EEEEiRKT_m.exit ], [ %.3192, %bb.et ]
  %i.xj = sext i32 %.0189.lcssa to i64
  invoke void @_ZNSt6vectorIcSaIcEE6resizeEm(ptr noundef nonnull align 8 dereferenceable(24) %1, i64 noundef %i.xj)
...
.lr.ph1377:                                       ; preds = %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_117getStringListSizeISt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS8_EEEEiRKT_m.exit, %bb.et
  %i.xk = phi ptr [ %i.afm, %bb.et ], [ %i.xi, %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_117getStringListSizeISt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS8_EEEEiRKT_m.exit ]
  %.01881376 = phi i64 [ %i.afk, %bb.et ], [ 0, %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_117getStringListSizeISt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS8_EEEEiRKT_m.exit ] ; 2 uses
  %.01891375 = phi i32 [ %.3192, %bb.et ], [ %i.xg, %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_117getStringListSizeISt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS8_EEEEiRKT_m.exit ]
  ...
  %i.xl = getelementptr inbounds nuw [208 x i8], ptr %i.xk, i64 %.01881376 ; 10 uses
  %i.xm = getelementptr inbounds nuw i8, ptr %i.xl, i64 24
  %i.xn = load ptr, ptr %i.xm, align 8, !tbaa !52 ; 2 uses
  %i.xo = getelementptr inbounds nuw i8, ptr %i.xl, i64 8 ; 2 uses
  %.not15.i = icmp eq ptr %i.xn, %i.xo
  br i1 %.not15.i, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_117getStringListSizeISt3setINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4lessIS8_ESaIS8_EEEEiRKT_m.exit, label %.lr.ph.i373
...
bb.fj:                                            ; preds = %bb.ff
  %i.awv = load ptr, ptr %i.awb, align 8, !tbaa !18 ; 2 uses
  %i.aww = getelementptr inbounds nuw i8, ptr %i.awa, i64 48 ; 2 uses
  %i.awx = icmp eq ptr %i.awv, %i.aww
  br i1 %i.awx, label %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESt10_Select1stIS8_ESt4lessIS5_ESaIS8_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS8_E.exit.i.i728, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i.i727

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i.i727: ; preds = %bb.fj
  %i.awy = load i64, ptr %i.aww, align 8, !tbaa !19
  %i.awz = add i64 %i.awy, 1
  call void @_ZdlPvm(ptr noundef %i.awv, i64 noundef %i.awz) #35
...
_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESt10_Select1stIS8_ESt4lessIS5_ESaIS8_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS8_E.exit.i.i728: ; preds = %bb.fj, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i.i727
  call void @_ZdlPvm(ptr noundef nonnull %i.awa, i64 noundef 72) #35
  br label %.noexc644
...
.noexc644:                                        ; preds = %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESt10_Select1stIS8_ESt4lessIS5_ESaIS8_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS8_E.exit.i.i728, %.thread.i721
  %.sroa.0.010.i722 = phi ptr [ %i.awa, %.thread.i721 ], [ %i.awd, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESt10_Select1stIS8_ESt4lessIS5_ESaIS8_EE12_M_drop_nodeEPSt13_Rb_tree_nodeIS8_E.exit.i.i728 ]
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #32
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #32
...
bb.fk:                                            ; preds = %.noexc644, %_ZNKSt4lessINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEclERKS5_S8_.exit.i631
  ...
  %i.axa = getelementptr inbounds nuw i8, ptr %.sroa.07.0.i633, i64 64
  %i.axb = load i32, ptr %i.axa, align 4, !tbaa !3
  %i.axc = sext i32 %i.axb to i64
  %i.axd = getelementptr inbounds nuw [4 x i8], ptr %.sroa.0880.01022, i64 %i.axc
  %i.axe = load i32, ptr %i.axd, align 4, !tbaa !3
  %i.axf = sext i32 %i.axe to i64
  br label %bb.fl

bb.fl:                                            ; preds = %bb.fl, %bb.fk
  %.29 = phi ptr [ %.41388, %bb.fk ], [ %i.axj, %bb.fl ] ; 2 uses
  %.06.i646 = phi i64 [ %i.axf, %bb.fk ], [ %i.axi, %bb.fl ] ; 2 uses
  %i.axg = trunc i64 %.06.i646 to i8
  %i.axh = and i8 %i.axg, 127
  %i.axi = lshr i64 %.06.i646, 7                  ; 2 uses
  %.not.i647 = icmp eq i64 %i.axi, 0              ; 2 uses
  %masksel.i648 = select i1 %.not.i647, i8 0, i8 -128
  %.0.i649 = or disjoint i8 %masksel.i648, %i.axh
  %i.axj = getelementptr inbounds nuw i8, ptr %.29, i64 1 ; 3 uses
...
_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_126writeVariableLengthIntegerERPcm.exit650: ; preds = %bb.fl
  %i.axk = add nuw i64 %.01441389, 1              ; 2 uses
  %i.axl = load ptr, ptr %i.anb, align 8, !tbaa !10
  %i.axm = load ptr, ptr %i.ana, align 8, !tbaa !13
  %i.axn = ptrtoint ptr %i.axl to i64
  %i.axo = ptrtoint ptr %i.axm to i64
  %i.axp = sub i64 %i.axn, %i.axo
  %i.axq = ashr exact i64 %i.axp, 5
  %i.axr = icmp ult i64 %i.axk, %i.axq
  br i1 %i.axr, label %bb.fc, label %._crit_edge1391, !llvm.loop !206
...
bb.fn:                                            ; preds = %._crit_edge1406
  %i.axt = call ptr @__cxa_allocate_exception(i64 72) #32 ; 3 uses
  invoke void @_ZN7Iex_3_36ArgExcC1EPKc(ptr noundef nonnull align 8 dereferenceable(72) %i.axt, ptr noundef nonnull @.str.21)
          to label %bb.fo unwind label %bb.fp

bb.fo:                                            ; preds = %bb.fn
  invoke void @__cxa_throw(ptr nonnull %i.axt, ptr nonnull @_ZTIN7Iex_3_36ArgExcE, ptr nonnull @_ZN7Iex_3_36ArgExcD1Ev) #33
          to label %bb.gd unwind label %bb.fq

bb.fp:                                            ; preds = %bb.fn
  %i.axu = landingpad { ptr, i32 }
          cleanup
  call void @__cxa_free_exception(ptr nonnull %i.axt) #32
  br label %.body710
...
bb.fs:                                            ; preds = %bb.fr
  %i.axw = ptrtoint ptr %.sroa.31.0.lcssa to i64
  %i.axx = ptrtoint ptr %.sroa.0829.0.lcssa to i64
  %i.axy = sub i64 %i.axw, %i.axx
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0829.0.lcssa, i64 noundef %i.axy) #35
...
bb.ft:                                            ; preds = %_ZNSt6vectorIcSaIcEED2Ev.exit
  %i.axz = ptrtoint ptr %.sroa.29.2 to i64
  %i.aya = sub i64 %i.axz, %i.xb
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0859.2, i64 noundef %i.aya) #35
...
bb.fu:                                            ; preds = %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit
  %i.ayb = ptrtoint ptr %.sroa.19.01019 to i64
  %i.ayc = ptrtoint ptr %.sroa.0880.01022 to i64
  %i.ayd = sub i64 %i.ayb, %i.ayc
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0880.01022, i64 noundef %i.ayd) #35
  br label %_ZNSt6vectorIiSaIiEED2Ev.exit

_ZNSt6vectorIiSaIiEED2Ev.exit:                    ; preds = %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit, %bb.fu
  %i.aye = load ptr, ptr %10, align 8, !tbaa !18  ; 2 uses
  %i.ayf = icmp eq ptr %i.aye, %i.dw
  br i1 %i.ayf, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit656, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i654

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i654: ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit
  %i.ayg = load i64, ptr %i.dw, align 8, !tbaa !19
  %i.ayh = add i64 %i.ayg, 1
  call void @_ZdlPvm(ptr noundef %i.aye, i64 noundef %i.ayh) #35
...
bb.fv:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit656
  %i.ayi = sub i64 %.sink.i, %.pre1521
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0907.0, i64 noundef %i.ayi) #35
...
.lr.ph.i.i.i659:                                  ; preds = %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit658, %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i
  %.05.i.i.i660 = phi ptr [ %i.ayo, %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i ], [ %.sroa.0947.0997, %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit658 ] ; 3 uses
  %i.ayj = load ptr, ptr %.05.i.i.i660, align 8, !tbaa !18 ; 2 uses
  %i.ayk = getelementptr inbounds nuw i8, ptr %.05.i.i.i660, i64 16 ; 2 uses
  %i.ayl = icmp eq ptr %i.ayj, %i.ayk
  br i1 %i.ayl, label %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i: ; preds = %.lr.ph.i.i.i659
  %i.aym = load i64, ptr %i.ayk, align 8, !tbaa !19
  %i.ayn = add i64 %i.aym, 1
  call void @_ZdlPvm(ptr noundef %i.ayj, i64 noundef %i.ayn) #35
...
_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i: ; preds = %.lr.ph.i.i.i659, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i
  %i.ayo = getelementptr inbounds nuw i8, ptr %.05.i.i.i660, i64 32 ; 2 uses
  %.not.i.i.i661 = icmp eq ptr %i.ayo, %.0.lcssa.i.i.i.i.i1006
...
bb.fw:                                            ; preds = %_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E.exit.i
  %i.ayp = ptrtoint ptr %.sroa.25.0988 to i64
  %i.ayq = sub i64 %i.ayp, %i.afv
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0947.0997, i64 noundef %i.ayq) #35
...
_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EED2Ev.exit: ; preds = %_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E.exit.i, %bb.fw
  %i.ayr = load ptr, ptr %i.d, align 8, !tbaa !78
  invoke void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESt10_Select1stIS8_ESt4lessIS5_ESaIS8_EE8_M_eraseEPSt13_Rb_tree_nodeIS8_E(ptr noundef nonnull align 8 dereferenceable(48) %9, ptr noundef %i.ayr)
...
bb.fx:                                            ; preds = %_ZNSt6vectorINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EED2Ev.exit
  ...
  %i.ayt = extractvalue { ptr, i32 } %i.ays, 0
  call void @__clang_call_terminate(ptr %i.ayt) #37
  unreachable
...
.body710:                                         ; preds = %.loopexit1103, %.loopexit.split-lp, %.loopexit1104, %.loopexit.split-lp1105, %.loopexit1109, %.loopexit.split-lp1110, %.loopexit1114, %.loopexit.split-lp1115, %bb.fq, %bb.fp, %bb.fm, %bb.fi, %bb.dt, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESt10_Select1stIS8_ESt4lessIS5_ESaIS8_EE10_Auto_nodeD2Ev.exit742, %bb.ew
  ...
  %.pn203.pn.pn = phi { ptr, i32 } [ %i.ajh, %bb.ew ], [ %i.abq, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESt10_Select1stIS8_ESt4lessIS5_ESaIS8_EE10_Auto_nodeD2Ev.exit742 ], [ %i.awu, %bb.fi ], [ %lpad.loopexit.split-lp1107, %.loopexit.split-lp1105 ], [ %i.axu, %bb.fp ], [ %lpad.loopexit.split-lp1117, %.loopexit.split-lp1115 ], [ %lpad.loopexit.split-lp1112, %.loopexit.split-lp1110 ], [ %i.acv, %bb.dt ], [ %i.axv, %bb.fq ], [ %i.axs, %bb.fm ], [ %lpad.loopexit1116, %.loopexit1114 ], [ %lpad.loopexit1111, %.loopexit1109 ], [ %lpad.loopexit1106, %.loopexit1104 ], [ %lpad.loopexit, %.loopexit1103 ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ] ; 2 uses
  %.not.i.i.i662 = icmp eq ptr %.sroa.0829.01223, null
  br i1 %.not.i.i.i662, label %_ZNSt6vectorIcSaIcEED2Ev.exit663, label %bb.fy

bb.fy:                                            ; preds = %.body710
  %i.ayu = ptrtoint ptr %.sroa.31.01208 to i64
  %i.ayv = ptrtoint ptr %.sroa.0829.01223 to i64
  %i.ayw = sub i64 %i.ayu, %i.ayv
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0829.01223, i64 noundef %i.ayw) #35
  br label %_ZNSt6vectorIcSaIcEED2Ev.exit663

_ZNSt6vectorIcSaIcEED2Ev.exit663:                 ; preds = %.loopexit1119, %.loopexit.split-lp1120, %bb.fy, %.body710
  %.sroa.0880.01023 = phi ptr [ %.sroa.0880.01022, %.body710 ], [ %.sroa.0880.01022, %bb.fy ], [ %i.tt, %.loopexit.split-lp1120 ], [ %i.tt, %.loopexit1119 ] ; 2 uses
...
_ZNSt6vectorIcSaIcEED2Ev.exit663.thread1049:      ; preds = %_ZNSt6vectorIcSaIcEED2Ev.exit663
  %i.ayx = ptrtoint ptr %.sroa.29.3 to i64
  %i.ayy = ptrtoint ptr %.sroa.0859.3 to i64
  %i.ayz = sub i64 %i.ayx, %i.ayy
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0859.3, i64 noundef %i.ayz) #35
...
_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit665:     ; preds = %_ZNSt6vectorIcSaIcEED2Ev.exit663, %_ZNSt6vectorIcSaIcEED2Ev.exit663.thread1049
  ...
  br i1 %.not.i.i.i666, label %_ZNSt6vectorIiSaIiEED2Ev.exit667, label %bb.fz

bb.fz:                                            ; preds = %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit665.thread, %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit665
  %.sroa.0880.0102310431083 = phi ptr [ %i.tt, %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit665.thread ], [ %.sroa.0880.01023, %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit665 ] ; 2 uses
  %.sroa.0880.0102310431083.a = phi ptr [ %i.tu, %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit665.thread ], [ %.sroa.19.01015, %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit665 ]
  %.pn20810481074 = phi { ptr, i32 } [ %i.uq, %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit665.thread ], [ %.pn208, %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit665 ]
  %24 = ptrtoint ptr %.sroa.0880.0102310431083.a to i64
  %i.aza = ptrtoint ptr %.sroa.0880.0102310431083 to i64
  %i.azb = sub i64 %24, %i.aza
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0880.0102310431083, i64 noundef %i.azb) #35
  br label %_ZNSt6vectorIiSaIiEED2Ev.exit667
...
_ZNSt6vectorIiSaIiEED2Ev.exit667:                 ; preds = %bb.bs, %_ZNSt6vectorISt4pairIiiESaIS1_EED2Ev.exit665, %bb.fz, %bb.p, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit344, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit295, %bb.bo
  ...
  %i.azc = load ptr, ptr %10, align 8, !tbaa !18  ; 2 uses
  %i.azd = icmp eq ptr %i.azc, %i.dw
  br i1 %i.azd, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit670, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i668

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i668: ; preds = %_ZNSt6vectorIiSaIiEED2Ev.exit667
  %i.aze = load i64, ptr %i.dw, align 8, !tbaa !19
  %i.azf = add i64 %i.aze, 1
  call void @_ZdlPvm(ptr noundef %i.azc, i64 noundef %i.azf) #35
...
bb.ga:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit670
  %i.azg = ptrtoint ptr %.sroa.0907.0 to i64
  %i.azh = sub i64 %.sink.i, %i.azg
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0907.0, i64 noundef %i.azh) #35
...
.lr.ph.i.i.i674:                                  ; preds = %.lr.ph.i.i.i674.preheader, %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i677
  %.05.i.i.i675 = phi ptr [ %i.azn, %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i677 ], [ %.sroa.0947.09901720, %.lr.ph.i.i.i674.preheader ] ; 3 uses
  %i.azi = load ptr, ptr %.05.i.i.i675, align 8, !tbaa !18 ; 2 uses
  %i.azj = getelementptr inbounds nuw i8, ptr %.05.i.i.i675, i64 16 ; 2 uses
  %i.azk = icmp eq ptr %i.azi, %i.azj
  br i1 %i.azk, label %_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i677, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i676

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i676: ; preds = %.lr.ph.i.i.i674
  %i.azl = load i64, ptr %i.azj, align 8, !tbaa !19
  %i.azm = add i64 %i.azl, 1
  call void @_ZdlPvm(ptr noundef %i.azi, i64 noundef %i.azm) #35
...
_ZSt8_DestroyINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEEvPT_.exit.i.i.i677: ; preds = %.lr.ph.i.i.i674, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i.i.i.i.i676
  %i.azn = getelementptr inbounds nuw i8, ptr %.05.i.i.i675, i64 32 ; 2 uses
  %.not.i.i.i678 = icmp eq ptr %i.azn, %.0.lcssa.i.i.i.i.i9991719
...
bb.gb:                                            ; preds = %_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E.exit.i681
  %i.azo = ptrtoint ptr %.sroa.25.09811723 to i64
  %i.azp = ptrtoint ptr %.sroa.0947.09901721 to i64
  %i.azq = sub i64 %i.azo, %i.azp
  call void @_ZdlPvm(ptr noundef nonnull %.sroa.0947.09901721, i64 noundef %i.azq) #35
  br label %.body
...
.body:                                            ; preds = %bb.m, %_ZSt8_DestroyIPNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_EvT_S7_RSaIT0_E.exit.i681, %bb.gb, %bb.k, %_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESt10_Select1stIS8_ESt4lessIS5_ESaIS8_EE10_Auto_nodeD2Ev.exit
  ...
  %i.azr = load ptr, ptr %i.d, align 8, !tbaa !78
  invoke void @_ZNSt8_Rb_treeINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESt4pairIKS5_iESt10_Select1stIS8_ESt4lessIS5_ESaIS8_EE8_M_eraseEPSt13_Rb_tree_nodeIS8_E(ptr noundef nonnull align 8 dereferenceable(48) %9, ptr noundef %i.azr)
...
bb.gc:                                            ; preds = %.body
  ...
  call void @__clang_call_terminate(ptr %i.azt) #37
  unreachable
