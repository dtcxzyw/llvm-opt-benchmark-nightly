...
bb.a:
  ...
  %i.c = fneg float %8
  %11 = fsub float %5, %6
  %12 = fmul float %5, -2.000000e+00
  %13 = fsub float %2, %1                         ; 4 uses
  %14 = fmul float %13, %7                        ; 4 uses
  %15 = insertelement <2 x float> poison, float %i.a, i64 0
  %16 = insertelement <2 x float> %15, float %6, i64 1
  %17 = insertelement <2 x float> <float poison, float 2.000000e+00>, float %13, i64 0
  %18 = insertelement <2 x float> poison, float %10, i64 0
  %19 = insertelement <2 x float> %18, float %12, i64 1
  %20 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %16, <2 x float> %17, <2 x float> %19) ; 2 uses
  %i.d = fsub float %3, %2                        ; 2 uses
  %21 = insertelement <2 x float> poison, float %i.c, i64 0
  %i.e = insertelement <2 x float> %21, float %8, i64 1
  %i.f = insertelement <2 x float> poison, float %i.d, i64 0
  %22 = shufflevector <2 x float> %i.f, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %23 = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.g = insertelement <2 x float> %23, float %11, i64 1
  %i.h = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.e, <2 x float> %22, <2 x float> %i.g) ; 4 uses
  %i.i = insertelement <2 x float> %i.h, float 4.000000e+00, i64 1
  %24 = fmul <2 x float> %i.h, %i.i               ; 6 uses
  %25 = fcmp olt float %i.b, %5
  %26 = fcmp olt float %i.b, %4
  %27 = fcmp olt float %i.b, %6
  %28 = load <2 x float>, ptr %9, align 4, !tbaa !84 ; 7 uses
  %i.j = insertelement <2 x float> poison, float %4, i64 0
  %29 = shufflevector <2 x float> %i.j, <2 x float> poison, <2 x i32> zeroinitializer ; 3 uses
  %30 = fsub <2 x float> %29, %28                 ; 2 uses
  %31 = fmul float %14, %14
  %32 = shufflevector <2 x float> %24, <2 x float> %30, <4 x i32> <i32 poison, i32 1, i32 2, i32 3>
  %33 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %34 = insertelement <2 x float> %33, float %31, i64 0
  %i.k = shufflevector <2 x float> %34, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
  %i.l = fmul <2 x float> %30, splat (float 2.000000e+00)
  %35 = insertelement <2 x float> poison, float %14, i64 0
  %36 = shufflevector <2 x float> %35, <2 x float> poison, <2 x i32> zeroinitializer
  %37 = insertelement <2 x float> poison, float %13, i64 0
  %i.m = shufflevector <2 x float> %37, <2 x float> poison, <2 x i32> zeroinitializer
  %38 = insertelement <2 x float> poison, float %1, i64 0
  %i.n = shufflevector <2 x float> %38, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.o = insertelement <2 x float> poison, float %5, i64 0
  %i.p = shufflevector <2 x float> %i.o, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.q = fsub <2 x float> %i.p, %28               ; 3 uses
  %shift4 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop5 = fmul <2 x float> %shift4, %i.q
  %foldExtExtBinop = fmul <2 x float> %24, %i.q
  %foldExtExtBinop7 = fsub <2 x float> %24, %foldExtExtBinop5
  %39 = extractelement <2 x float> %foldExtExtBinop7, i64 0
  %shift = shufflevector <2 x float> %foldExtExtBinop, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop2 = fsub <2 x float> %24, %shift
  %40 = extractelement <2 x float> %foldExtExtBinop2, i64 0
  %i.r = fmul <2 x float> %i.q, splat (float 2.000000e+00)
  %41 = shufflevector <2 x float> %i.h, <2 x float> poison, <2 x i32> zeroinitializer
  %42 = extractelement <2 x float> %i.h, i64 0
  ...
  %i.y = fsub <4 x float> %i.v, %i.x              ; 3 uses
  %43 = shufflevector <4 x float> %i.y, <4 x float> poison, <2 x i32> <i32 poison, i32 3>
  %44 = shufflevector <2 x float> %20, <2 x float> %43, <4 x i32> <i32 0, i32 3, i32 0, i32 0>
  %45 = fmul <4 x float> %44, <float 4.000000e+00, float 1.000000e+00, float 4.000000e+00, float 4.000000e+00>
  %i.z = fmul <4 x float> %i.y, <float 1.000000e+00, float 1.000000e+00, float 2.000000e+00, float 2.000000e+00>
  %46 = shufflevector <4 x float> %i.y, <4 x float> poison, <4 x i32> <i32 2, i32 poison, i32 poison, i32 poison>
  %47 = shufflevector <4 x float> %46, <4 x float> %32, <4 x i32> <i32 0, i32 5, i32 6, i32 7>
  %i.aa = fmul <4 x float> %47, %45
  ...
  %i.ai = fadd float %14, %i.ah
  %i.aj = tail call float @sqrtf(float noundef %39) #22, !tbaa !3
  %i.ak = tail call float @sqrtf(float noundef %40) #22, !tbaa !3
  %i.al = extractelement <4 x float> %i.ab, i64 1
  %i.am = tail call float @sqrtf(float noundef %i.al) #22, !tbaa !3
  %i.an = fadd float %42, %i.am
  ...
  %i.az = fadd <2 x float> %36, %i.ay
  %i.ba = fdiv <2 x float> %i.l, %i.az
  %i.bb = fmul <2 x float> %i.m, %i.ba
  %i.bc = extractelement <4 x float> %i.as, i64 2
  %i.bd = fmul float %13, %i.bc
  %i.be = fsub <2 x float> %i.n, %i.bb
  ...
  %i.bi = fadd <2 x float> %41, %i.bh
  %i.bj = fdiv <2 x float> %i.r, %i.bi
  %i.bk = fmul <2 x float> %22, %i.bj
  ...
  %i.br = fcmp olt <2 x float> %28, %i.p
  %i.bs = select <2 x i1> %i.br, <2 x float> %i.be, <2 x float> %i.bp
  %i.bt = select i1 %25, float %i.bf, float %i.bq
  %i.bu = fsub <2 x float> %28, %29
  ...
  %i.by = fadd <2 x float> %i.n, %i.bx
  %i.bz = fcmp olt <2 x float> %28, %29
  %i.ca = select <2 x i1> %i.bz, <2 x float> %i.by, <2 x float> %i.bs
  %i.cb = select i1 %26, float %i.au, float %i.bt
  %i.cc = insertelement <2 x float> poison, float %6, i64 0
  %i.cd = shufflevector <2 x float> %i.cc, <2 x float> poison, <2 x i32> zeroinitializer ; 2 uses
  %i.ce = fsub <2 x float> %28, %i.cd
  ...
  %i.cl = fcmp olt <2 x float> %28, %i.cd
  %i.cm = select <2 x i1> %i.cl, <2 x float> %i.ca, <2 x float> %i.ck
  %i.cn = select i1 %27, float %i.cb, float %i.aw
