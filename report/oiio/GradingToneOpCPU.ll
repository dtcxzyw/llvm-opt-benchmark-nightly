...
bb.g:                                             ; preds = %bb.f
  ...
  %7 = load <2 x float>, ptr %i.s, align 8, !tbaa !84 ; 4 uses
  %8 = load float, ptr %i.t, align 4, !tbaa !84   ; 2 uses
  %9 = extractelement <2 x float> %7, i64 0
  %10 = fneg float %9
  %11 = fsub <2 x float> %i.cj, %i.ci             ; 4 uses
  %12 = extractelement <2 x float> %i.ck, i64 1   ; 2 uses
  %13 = fmul float %12, -2.000000e+00
  %foldExtExtBinop = fmul <2 x float> %11, %7     ; 2 uses
  %14 = extractelement <2 x float> %foldExtExtBinop, i64 0
  %15 = tail call float @llvm.fmuladd.f32(float %i.ch, float 2.000000e+00, float %13)
  %16 = fneg float %8
  %17 = extractelement <2 x float> %11, i64 1
  %18 = tail call float @llvm.fmuladd.f32(float %16, float %17, float %15) ; 2 uses
  %19 = shufflevector <2 x float> %i.ck, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %20 = insertelement <2 x float> %i.ck, float %i.ch, i64 1
  %21 = fsub <2 x float> %19, %20
  %22 = insertelement <2 x float> %7, float %10, i64 0
  %23 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %22, <2 x float> %11, <2 x float> %21)
  %24 = insertelement <2 x float> poison, float %i.cg, i64 0
  %25 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
  %26 = fsub <2 x float> %i.ck, %25               ; 2 uses
  %foldExtExtBinop.a = fmul <2 x float> %23, splat (float 4.000000e+00)
  %27 = fneg <2 x float> %26
  %28 = fmul <2 x float> %foldExtExtBinop.a, %27
  %i.cl = insertelement <2 x float> %foldExtExtBinop, float %18, i64 1 ; 2 uses
  %i.cm = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cl, <2 x float> %i.cl, <2 x float> %28) ; 2 uses
  %29 = extractelement <2 x float> %i.cm, i64 0
  %30 = tail call noundef float @sqrtf(float noundef %29) #22, !tbaa !3
  %31 = fadd float %14, %30
  %32 = extractelement <2 x float> %i.ci, i64 0
  %i.cn = extractelement <2 x float> %i.cm, i64 1
  %i.co = tail call noundef float @sqrtf(float noundef %i.cn) #22, !tbaa !3
  %i.cp = fadd float %18, %i.co
  %33 = fcmp olt float %i.cg, %12
  %34 = extractelement <2 x float> %i.ck, i64 0
  %35 = fcmp olt float %i.cg, %34
  ...
  %i.cs = shufflevector <2 x float> %26, <2 x float> %i.ck, <4 x i32> <i32 0, i32 1, i32 2, i32 poison>
  ...
  %36 = shufflevector <2 x float> %7, <2 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 poison>
  %37 = insertelement <4 x float> %36, float %31, i64 0
  %i.cx = insertelement <4 x float> %37, float %i.cp, i64 1
  %i.cy = insertelement <4 x float> %i.cx, float %8, i64 3
  ...
  %i.dc = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.da, <2 x float> %11, <2 x float> %i.db) ; 2 uses
  %i.dd = extractelement <2 x float> %i.dc, i64 0
  %i.de = extractelement <2 x float> %i.dc, i64 1
  %i.df = select i1 %33, float %i.dd, float %i.de
  %i.dg = extractelement <4 x float> %i.cz, i64 2
  %i.dh = fadd float %32, %i.dg
  %i.di = select i1 %35, float %i.dh, float %i.df
...
bb.e:                                             ; preds = %bb.d
  ...
  %5 = fmul float %i.ba, %i.az
  %i.bb = fmul float %i.ba, %i.aw                 ; 3 uses
  %i.bc = fmul float %5, 4.000000e+00
  %i.bd = extractelement <2 x float> %i.u, i64 0  ; 3 uses
  %6 = tail call float @llvm.fmuladd.f32(float %i.av, float %i.w, float %..i) ; 6 uses
  %i.be = fsub float %6, %i.bd
  %i.bf = fsub float %i.bd, %6                    ; 2 uses
  %i.bg = fneg float %i.bf
  %i.bh = fmul float %i.bc, %i.bg
  %i.bi = tail call float @llvm.fmuladd.f32(float %i.bb, float %i.bb, float %i.bh)
  %i.bj = tail call noundef float @sqrtf(float noundef %i.bi) #22, !tbaa !3
  %i.bk = fadd float %i.bb, %i.bj
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.cl = insertelement <2 x float> %i.ck, float %6, i64 1
...
bb.a:
  %.sroa.15.0..sroa_idx = getelementptr inbounds nuw i8, ptr %9, i64 8
  %i.a = insertelement <2 x float> poison, float %5, i64 0
  %10 = shufflevector <2 x float> %i.a, <2 x float> poison, <2 x i32> zeroinitializer ; 3 uses
  %i.b = insertelement <2 x float> poison, float %4, i64 0 ; 2 uses
  %i.c = insertelement <2 x float> %i.b, float %6, i64 1
  %11 = fsub <2 x float> %10, %i.c
  %12 = fneg float %7
  %13 = load float, ptr %.sroa.15.0..sroa_idx, align 4, !tbaa !84 ; 4 uses
  %i.d = fneg float %8
  %14 = fcmp olt float %13, %5
  %15 = fcmp olt float %13, %4
  %16 = fcmp olt float %13, %6
  %17 = load <2 x float>, ptr %9, align 4, !tbaa !84 ; 7 uses
  %i.e = shufflevector <2 x float> %i.b, <2 x float> poison, <2 x i32> zeroinitializer ; 3 uses
  %18 = fsub <2 x float> %i.e, %17                ; 2 uses
  %19 = fsub float %2, %1                         ; 3 uses
  %20 = fmul float %5, -2.000000e+00
  %21 = fmul float %19, %7                        ; 2 uses
  %22 = tail call float @llvm.fmuladd.f32(float %6, float 2.000000e+00, float %20)
  %23 = fsub float %3, %2                         ; 4 uses
  %24 = tail call float @llvm.fmuladd.f32(float %i.d, float %23, float %22) ; 3 uses
  %25 = insertelement <2 x float> poison, float %12, i64 0
  %i.f = insertelement <2 x float> %25, float %8, i64 1
  %26 = insertelement <2 x float> poison, float %19, i64 0 ; 2 uses
  %27 = insertelement <2 x float> %26, float %23, i64 1
  %28 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.f, <2 x float> %27, <2 x float> %11)
  %29 = insertelement <2 x float> poison, float %21, i64 0 ; 2 uses
  %30 = insertelement <2 x float> %29, float %24, i64 1 ; 2 uses
  %31 = fmul <2 x float> %30, %30                 ; 2 uses
  %i.g = shufflevector <2 x float> %31, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
  %i.h = fmul <2 x float> %28, splat (float 4.000000e+00) ; 2 uses
  %32 = shufflevector <2 x float> %i.h, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 0, i32 0>
  %33 = shufflevector <2 x float> %18, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %34 = fmul <2 x float> %18, splat (float 2.000000e+00)
  %i.i = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> zeroinitializer
  %i.j = shufflevector <2 x float> %26, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %i.m = fsub <2 x float> %10, %17                ; 3 uses
  %35 = extractelement <2 x float> %i.m, i64 0
  %36 = extractelement <2 x float> %i.h, i64 1    ; 2 uses
  %37 = fmul float %36, %35
  %38 = extractelement <2 x float> %i.m, i64 1
  %39 = fmul float %36, %38
  %40 = extractelement <2 x float> %31, i64 1     ; 2 uses
  %41 = fsub float %40, %37
  %42 = fsub float %40, %39
  %i.n = fmul <2 x float> %i.m, splat (float 2.000000e+00)
  %43 = insertelement <2 x float> poison, float %24, i64 0
  %44 = shufflevector <2 x float> %43, <2 x float> poison, <2 x i32> zeroinitializer
  %i.o = insertelement <4 x float> poison, float %13, i64 0
  ...
  %i.u = fsub <4 x float> %i.r, %i.t              ; 2 uses
  %i.v = fmul <4 x float> %i.u, <float 1.000000e+00, float 1.000000e+00, float 2.000000e+00, float 2.000000e+00>
  %45 = shufflevector <4 x float> %33, <4 x float> %i.u, <4 x i32> <i32 6, i32 7, i32 0, i32 1>
  %i.w = fmul <4 x float> %32, %45
  ...
  %i.ae = fadd float %21, %i.ad
  %i.af = tail call float @sqrtf(float noundef %41) #22, !tbaa !3
  %i.ag = tail call float @sqrtf(float noundef %42) #22, !tbaa !3
  %i.ah = extractelement <4 x float> %i.x, i64 1
  %i.ai = tail call float @sqrtf(float noundef %i.ah) #22, !tbaa !3
  %i.aj = fadd float %24, %i.ai
  ...
  %i.av = fadd <2 x float> %i.i, %i.au
  %i.aw = fdiv <2 x float> %34, %i.av
  %i.ax = fmul <2 x float> %i.j, %i.aw
  %i.ay = extractelement <4 x float> %i.ao, i64 2
  %i.az = fmul float %19, %i.ay
  %i.ba = fsub <2 x float> %i.l, %i.ax
  ...
  %i.bn = fcmp olt <2 x float> %17, %10
  %i.bo = select <2 x i1> %i.bn, <2 x float> %i.ba, <2 x float> %i.bl
  %i.bp = select i1 %14, float %i.bb, float %i.bm
  %i.bq = fsub <2 x float> %17, %i.e
  ...
  %i.bu = fadd <2 x float> %i.l, %i.bt
  %i.bv = fcmp olt <2 x float> %17, %i.e
  %i.bw = select <2 x i1> %i.bv, <2 x float> %i.bu, <2 x float> %i.bo
  %i.bx = select i1 %15, float %i.aq, float %i.bp
  ...
  %i.ch = fcmp olt <2 x float> %17, %i.bz
  %i.ci = select <2 x i1> %i.ch, <2 x float> %i.bw, <2 x float> %i.cg
  %i.cj = select i1 %16, float %i.bx, float %i.as
...
bb.d:                                             ; preds = %bb.c
  ...
  %9 = extractelement <2 x float> %7, i64 0
  %10 = fneg float %9
  %11 = fsub <2 x float> %i.z, %i.y               ; 4 uses
  %12 = extractelement <2 x float> %i.aa, i64 1   ; 2 uses
  %13 = fmul float %12, -2.000000e+00
  %foldExtExtBinop = fmul <2 x float> %11, %7     ; 2 uses
  %14 = extractelement <2 x float> %foldExtExtBinop, i64 0
  %15 = tail call float @llvm.fmuladd.f32(float %i.x, float 2.000000e+00, float %13)
  %16 = fneg float %8
  %17 = extractelement <2 x float> %11, i64 1
  %18 = tail call float @llvm.fmuladd.f32(float %16, float %17, float %15) ; 2 uses
  %19 = shufflevector <2 x float> %i.aa, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %20 = insertelement <2 x float> %i.aa, float %i.x, i64 1
  %21 = fsub <2 x float> %19, %20
  %22 = insertelement <2 x float> %7, float %10, i64 0
  %23 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %22, <2 x float> %11, <2 x float> %21)
  %24 = insertelement <2 x float> poison, float %i.w, i64 0
  %25 = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
  %26 = fsub <2 x float> %i.aa, %25               ; 2 uses
  %foldExtExtBinop.a = fmul <2 x float> %23, splat (float 4.000000e+00)
  %27 = fneg <2 x float> %26
  %28 = fmul <2 x float> %foldExtExtBinop.a, %27
  %i.ab = insertelement <2 x float> %foldExtExtBinop, float %18, i64 1 ; 2 uses
  %i.ac = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ab, <2 x float> %i.ab, <2 x float> %28) ; 2 uses
  %29 = extractelement <2 x float> %i.ac, i64 0
  %30 = tail call noundef float @sqrtf(float noundef %29) #22, !tbaa !3
  %31 = fadd float %14, %30
  %32 = extractelement <2 x float> %i.y, i64 0
  %i.ad = extractelement <2 x float> %i.ac, i64 1
  %i.ae = tail call noundef float @sqrtf(float noundef %i.ad) #22, !tbaa !3
  %i.af = fadd float %18, %i.ae
  %33 = fcmp olt float %i.w, %12
  %34 = extractelement <2 x float> %i.aa, i64 0
  %35 = fcmp olt float %i.w, %34
  ...
  %i.ai = shufflevector <2 x float> %26, <2 x float> %i.aa, <4 x i32> <i32 0, i32 1, i32 2, i32 poison>
  ...
  %36 = shufflevector <2 x float> %7, <2 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 poison>
  %37 = insertelement <4 x float> %36, float %31, i64 0
  %i.an = insertelement <4 x float> %37, float %i.af, i64 1
  %i.ao = insertelement <4 x float> %i.an, float %8, i64 3
  ...
  %i.as = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.aq, <2 x float> %11, <2 x float> %i.ar) ; 2 uses
  %i.at = extractelement <2 x float> %i.as, i64 0
  %i.au = extractelement <2 x float> %i.as, i64 1
  %i.av = select i1 %33, float %i.at, float %i.au
  %i.aw = extractelement <4 x float> %i.ap, i64 2
  %i.ax = fadd float %32, %i.aw
  %i.ay = select i1 %35, float %i.ax, float %i.av
