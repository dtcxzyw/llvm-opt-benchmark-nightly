...
bb.g:                                             ; preds = %bb.f
  ...
  %i.cl = fmul <2 x float> %23, splat (float 4.000000e+00)
  %27 = fneg <2 x float> %26
  %28 = fmul <2 x float> %i.cl, %27
  %i.cm = insertelement <2 x float> %foldExtExtBinop, float %18, i64 1 ; 2 uses
  %i.cn = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.cm, <2 x float> %i.cm, <2 x float> %28) ; 2 uses
  %29 = extractelement <2 x float> %i.cn, i64 0
  %30 = tail call noundef float @sqrtf(float noundef %29) #22, !tbaa !3
  %31 = fadd float %14, %30
  %32 = extractelement <2 x float> %i.ci, i64 0
  %i.co = extractelement <2 x float> %i.cn, i64 1
  %i.cp = tail call noundef float @sqrtf(float noundef %i.co) #22, !tbaa !3
  %i.cq = fadd float %18, %i.cp
  ...
  %i.ct = shufflevector <2 x float> %26, <2 x float> %i.ck, <4 x i32> <i32 0, i32 1, i32 2, i32 poison>
  ...
  %i.cy = insertelement <4 x float> %37, float %i.cq, i64 1
  %i.cz = insertelement <4 x float> %i.cy, float %8, i64 3
  ...
  %i.dd = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.db, <2 x float> %11, <2 x float> %i.dc) ; 2 uses
  %i.de = extractelement <2 x float> %i.dd, i64 0
  %i.df = extractelement <2 x float> %i.dd, i64 1
  %i.dg = select i1 %33, float %i.de, float %i.df
  %i.dh = extractelement <4 x float> %i.da, i64 2
  %i.di = fadd float %32, %i.dh
  %i.dj = select i1 %35, float %i.di, float %i.dg
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.ab = fmul <2 x float> %23, splat (float 4.000000e+00)
  %27 = fneg <2 x float> %26
  %28 = fmul <2 x float> %i.ab, %27
  %i.ac = insertelement <2 x float> %foldExtExtBinop, float %18, i64 1 ; 2 uses
  %i.ad = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ac, <2 x float> %i.ac, <2 x float> %28) ; 2 uses
  %29 = extractelement <2 x float> %i.ad, i64 0
  %30 = tail call noundef float @sqrtf(float noundef %29) #22, !tbaa !3
  %31 = fadd float %14, %30
  ...
  %i.aj = shufflevector <2 x float> %26, <2 x float> %i.aa, <4 x i32> <i32 0, i32 1, i32 2, i32 poison>
  ...
  %36 = shufflevector <2 x float> %7, <2 x float> poison, <4 x i32> <i32 poison, i32 poison, i32 0, i32 poison>
  %37 = insertelement <4 x float> %36, float %31, i64 0
  %i.ao = insertelement <4 x float> %37, float %i.ag, i64 1
  %i.ap = insertelement <4 x float> %i.ao, float %8, i64 3
  ...
  %i.at = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ar, <2 x float> %11, <2 x float> %i.as) ; 2 uses
  %i.au = extractelement <2 x float> %i.at, i64 0
  %i.av = extractelement <2 x float> %i.at, i64 1
  %i.aw = select i1 %33, float %i.au, float %i.av
  %i.ax = extractelement <4 x float> %i.aq, i64 2
  %i.ay = fadd float %32, %i.ax
  %i.az = select i1 %35, float %i.ay, float %i.aw
