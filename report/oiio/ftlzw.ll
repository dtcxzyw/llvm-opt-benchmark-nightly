...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  br i1 %i.aj, label %bb.j, label %.thread178

.thread178:                                       ; preds = %bb.i
...
.preheader:                                       ; preds = %bb.b, %.thread178, %bb.ag
  %.2122.ph = phi i32 [ %.3123, %bb.ag ], [ %i.ah, %.thread178 ], [ %i.e, %bb.b ] ; 3 uses
  %.2116.ph = phi i32 [ %.3111, %bb.ag ], [ %i.ah, %.thread178 ], [ %i.g, %bb.b ] ; 3 uses
  %.2110.ph = phi i32 [ %.3111, %bb.ag ], [ 0, %.thread178 ], [ %i.i, %bb.b ] ; 3 uses
  %.2107.ph = phi i64 [ %.us-phi, %bb.ag ], [ 1, %.thread178 ], [ 0, %bb.b ]
  %i.ak = freeze i64 %.2107.ph                    ; 9 uses
  %i.al = call fastcc i32 @ft_lzwstate_get_code(ptr noundef nonnull %0) ; 3 uses
  %i.am = icmp slt i32 %i.al, 0
  br i1 %i.am, label %.loopexit190, label %.lr.ph
...
.lr.ph:                                           ; preds = %.preheader
  ...
  br i1 %i.aq, label %bb.k, label %.loopexit232

bb.k:                                             ; preds = %.lr.ph
  %i.ar = load i32, ptr %i.an, align 4, !tbaa !43
  %.not141.peel = icmp eq i32 %i.ar, 0
  br i1 %.not141.peel, label %.thread184, label %bb.l
...
bb.n:                                             ; preds = %bb.m
  ...
  br i1 %i.ay, label %.loopexit190, label %.peel.next, !llvm.loop !48

.loopexit232:                                     ; preds = %.peel.next, %.lr.ph
  %.lcssa228 = phi i32 [ %i.al, %.lr.ph ], [ %i.au, %.peel.next ] ; 4 uses
  %.2116206.lcssa = phi i32 [ %.2116.ph, %.lr.ph ], [ 0, %.peel.next ] ; 2 uses
  %.2122205.lcssa = phi i32 [ %.2122.ph, %.lr.ph ], [ 0, %.peel.next ]
  %i.az = icmp samesign ugt i32 %.lcssa228, 255
  br i1 %i.az, label %.thread184, label %.loopexit189

.thread184:                                       ; preds = %bb.m, %bb.k, %.loopexit232
  %i.ba = phi i32 [ %.lcssa228, %.loopexit232 ], [ 256, %bb.k ], [ 256, %bb.m ] ; 8 uses
  %.2116206226 = phi i32 [ %.2116206.lcssa, %.loopexit232 ], [ %.2116.ph, %bb.k ], [ 0, %bb.m ] ; 9 uses
  %.2122205223 = phi i32 [ %.2122205.lcssa, %.loopexit232 ], [ %.2122.ph, %bb.k ], [ 0, %bb.m ] ; 5 uses
  %i.bb = add nsw i32 %i.ba, -256                 ; 2 uses
  %i.bc = load i32, ptr %i.ao, align 8, !tbaa !45 ; 2 uses
  %.not142 = icmp ult i32 %i.bb, %i.bc
  br i1 %.not142, label %.lr.ph209, label %bb.o

bb.o:                                             ; preds = %.thread184
  %i.bd = icmp samesign ugt i32 %i.bb, %i.bc
  br i1 %i.bd, label %.loopexit190, label %bb.p
...
bb.p:                                             ; preds = %bb.o
  ...
  br i1 %.not143, label %bb.q, label %5
...
15:                                               ; preds = %5
  ...
  br i1 %16, label %17, label %.thread32.i.a

.thread.i:                                        ; preds = %5
  store ptr null, ptr %11, align 8, !tbaa !26
  %spec.select.i = call i64 @llvm.umin.i64(i64 %10, i64 65536)
  br label %.thread32.i.a

17:                                               ; preds = %15
  %18 = icmp eq i64 %i.bi, 65536
  br i1 %18, label %ft_lzwstate_stack_grow.exit.thread, label %.thread32.i.a

.thread32.i.a:                                    ; preds = %17, %.thread.i, %15
...
22:                                               ; preds = %.thread32.i.a
  %23 = icmp eq i64 %.02531.i, 0
  br i1 %23, label %24, label %ft_lzwstate_stack_grow.exit.a
...
24:                                               ; preds = %22
  ...
  br label %ft_lzwstate_stack_grow.exit.a

ft_lzwstate_stack_grow.exit.thread:               ; preds = %17, %.thread32.i.a
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #7
  br label %.loopexit190

ft_lzwstate_stack_grow.exit.a:                    ; preds = %22, %24
  store i64 %.024.i, ptr %i.bh, align 8, !tbaa !27
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #7
  %.pre = load i32, ptr %i.be, align 8, !tbaa !36 ; 2 uses
  %.pre243 = zext i32 %.pre to i64
  br label %bb.q

bb.q:                                             ; preds = %bb.p, %ft_lzwstate_stack_grow.exit.a
  %.pre-phi244 = phi i64 [ %.pre243, %ft_lzwstate_stack_grow.exit.a ], [ %i.bg, %bb.p ]
  %i.bj = phi i32 [ %.pre, %ft_lzwstate_stack_grow.exit.a ], [ %i.bf, %bb.p ]
  %i.bk = trunc i32 %.2122205223 to i8
  ...
  %i.bo = getelementptr inbounds nuw i8, ptr %i.bm, i64 %.pre-phi244
  store i8 %i.bk, ptr %i.bo, align 1, !tbaa !13
  %i.bp = icmp ugt i32 %.2116206226, 255
  br i1 %i.bp, label %.lr.ph209, label %.loopexit189

.lr.ph209:                                        ; preds = %.thread184, %bb.q
  %.0271 = phi i32 [ %.2116206226, %bb.q ], [ %i.ba, %.thread184 ]
  ...
  %.pre233 = load ptr, ptr %i.bq, align 8, !tbaa !38
  br label %bb.r

bb.r:                                             ; preds = %.lr.ph209, %bb.y
  %i.bx = phi ptr [ %.pre233, %.lr.ph209 ], [ %i.cv, %bb.y ]
  %.1208 = phi i32 [ %.0271, %.lr.ph209 ], [ %i.cy, %bb.y ]
  %.not148 = icmp eq ptr %i.bx, null
  br i1 %.not148, label %.loopexit190, label %bb.s
...
bb.s:                                             ; preds = %bb.r
  ...
  %.pre235 = load ptr, ptr %i.bu, align 8, !tbaa !26 ; 4 uses
  br i1 %.not149, label %bb.y, label %bb.t
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.cf = icmp eq ptr %.pre235, %i.bv
  br i1 %i.cf, label %.thread.i158, label %bb.u

bb.u:                                             ; preds = %bb.t
  %i.cg = icmp samesign ugt i64 %i.cd, 65532
  br i1 %i.cg, label %bb.v, label %.thread32.i151

.thread.i158:                                     ; preds = %bb.t
  store ptr null, ptr %i.bu, align 8, !tbaa !26
  %spec.select.i159 = call i64 @llvm.umin.i64(i64 %i.ce, i64 65536)
  br label %.thread32.i151

bb.v:                                             ; preds = %bb.u
  %i.ch = icmp eq i64 %i.ca, 65536
  br i1 %i.ch, label %ft_lzwstate_stack_grow.exit160.thread, label %.thread32.i151

.thread32.i151:                                   ; preds = %bb.v, %.thread.i158, %bb.u
  %i.ci = phi ptr [ %.pre235, %bb.v ], [ %.pre235, %bb.u ], [ null, %.thread.i158 ]
  %.02531.i152 = phi i64 [ %i.ca, %bb.v ], [ %i.ca, %bb.u ], [ 0, %.thread.i158 ] ; 2 uses
  %.024.i153 = phi i64 [ 65536, %bb.v ], [ %i.ce, %bb.u ], [ %spec.select.i159, %.thread.i158 ] ; 2 uses
  %i.cj = call ptr @ft_mem_qrealloc(ptr noundef %i.cb, i64 noundef 1, i64 noundef %.02531.i152, i64 noundef %.024.i153, ptr noundef %i.ci, ptr noundef nonnull %i.a) #7 ; 3 uses
  store ptr %i.cj, ptr %i.bu, align 8, !tbaa !26
  %i.ck = load i32, ptr %i.a, align 4, !tbaa !3
  %.not28.i154 = icmp eq i32 %i.ck, 0
  br i1 %.not28.i154, label %bb.w, label %ft_lzwstate_stack_grow.exit160.thread

bb.w:                                             ; preds = %.thread32.i151
  %i.cl = icmp eq i64 %.02531.i152, 0
  br i1 %i.cl, label %bb.x, label %ft_lzwstate_stack_grow.exit160
...
bb.x:                                             ; preds = %bb.w
  ...
  %.pre234.pre = load ptr, ptr %i.bu, align 8, !tbaa !26
  br label %ft_lzwstate_stack_grow.exit160

ft_lzwstate_stack_grow.exit160.thread:            ; preds = %bb.v, %.thread32.i151
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #7
  br label %.loopexit190

ft_lzwstate_stack_grow.exit160:                   ; preds = %bb.w, %bb.x
  %.pre234 = phi ptr [ %i.cj, %bb.w ], [ %.pre234.pre, %bb.x ]
  store i64 %.024.i153, ptr %i.bs, align 8, !tbaa !27
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #7
  %.pre236 = load i32, ptr %i.br, align 8, !tbaa !36 ; 2 uses
  %.pre240 = zext i32 %.pre236 to i64
  br label %bb.y

bb.y:                                             ; preds = %ft_lzwstate_stack_grow.exit160, %bb.s
  %.pre-phi = phi i64 [ %.pre240, %ft_lzwstate_stack_grow.exit160 ], [ %i.bz, %bb.s ]
  %i.cm = phi i32 [ %.pre236, %ft_lzwstate_stack_grow.exit160 ], [ %i.by, %bb.s ]
  %i.cn = phi ptr [ %.pre234, %ft_lzwstate_stack_grow.exit160 ], [ %.pre235, %bb.s ]
  %i.co = load ptr, ptr %i.bw, align 8, !tbaa !50
  %i.cp = add i32 %.1208, -256
  ...
  br i1 %i.cz, label %bb.r, label %.loopexit189, !llvm.loop !53

.loopexit189:                                     ; preds = %bb.y, %bb.q, %.loopexit232
  %i.da = phi i32 [ %.lcssa228, %.loopexit232 ], [ %i.ba, %bb.q ], [ %i.ba, %bb.y ] ; 2 uses
  %.2116206227 = phi i32 [ %.2116206.lcssa, %.loopexit232 ], [ %.2116206226, %bb.q ], [ %.2116206226, %bb.y ] ; 2 uses
  %.2 = phi i32 [ %.lcssa228, %.loopexit232 ], [ %.2116206226, %bb.q ], [ %i.cy, %bb.y ] ; 3 uses
  ...
  br i1 %.not144, label %bb.z, label %25

25:                                               ; preds = %.loopexit189
...
35:                                               ; preds = %25
  ...
  br i1 %36, label %37, label %.thread32.i162
...
37:                                               ; preds = %35
  ...
  br i1 %38, label %ft_lzwstate_stack_grow.exit171.thread, label %.thread32.i162

.thread32.i162:                                   ; preds = %37, %.thread.i169, %35
...
42:                                               ; preds = %.thread32.i162
  %43 = icmp eq i64 %.02531.i163, 0
  br i1 %43, label %44, label %ft_lzwstate_stack_grow.exit171
...
ft_lzwstate_stack_grow.exit171.thread:            ; preds = %37, %.thread32.i162
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #7
  br label %.loopexit190

ft_lzwstate_stack_grow.exit171:                   ; preds = %42, %44
  store i64 %.024.i164, ptr %i.de, align 8, !tbaa !27
  call void @llvm.lifetime.end.p0(ptr nonnull %4) #7
  %.pre237 = load i32, ptr %i.db, align 8, !tbaa !36 ; 2 uses
  %.pre241 = zext i32 %.pre237 to i64
  br label %bb.z

bb.z:                                             ; preds = %ft_lzwstate_stack_grow.exit171, %.loopexit189
  %.pre-phi242 = phi i64 [ %.pre241, %ft_lzwstate_stack_grow.exit171 ], [ %i.dd, %.loopexit189 ]
  %i.dg = phi i32 [ %.pre237, %ft_lzwstate_stack_grow.exit171 ], [ %i.dc, %.loopexit189 ]
  ...
  %i.dl = getelementptr inbounds nuw i8, ptr %i.dj, i64 %.pre-phi242
  store i8 %i.dh, ptr %i.dl, align 1, !tbaa !13
  store i32 2, ptr %0, align 8, !tbaa !37
  br label %bb.aa

bb.aa:                                            ; preds = %bb.z, %bb.b
  %.3123 = phi i32 [ %.2, %bb.z ], [ %i.e, %bb.b ] ; 5 uses
  %.3117 = phi i32 [ %.2116206227, %bb.z ], [ %i.g, %bb.b ] ; 4 uses
  %.3111 = phi i32 [ %i.da, %bb.z ], [ %i.i, %bb.b ] ; 5 uses
  %.3 = phi i64 [ %i.ak, %bb.z ], [ 0, %bb.b ]    ; 4 uses
...
vector.ph:                                        ; preds = %.split.us
  ...
  %n.mod.vf = and i64 %i.dr, 7                    ; 2 uses
  %i.ds = icmp eq i64 %n.mod.vf, 0
  %i.dt = select i1 %i.ds, i64 8, i64 %n.mod.vf
  %n.vec = sub nsw i64 %i.dr, %i.dt               ; 3 uses
  %i.du = trunc i64 %n.vec to i32
  %i.dv = sub i32 %.promoted, %i.du
  %i.dw = add i64 %.3, %n.vec
  %i.dx = add i32 %.promoted, -3
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %vector.body ]
  %i.dy = phi i32 [ %i.dx, %vector.ph ], [ %i.dz, %vector.body ] ; 2 uses
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.dz = add i32 %i.dy, -8
  %i.ea = icmp eq i64 %index.next, %n.vec
  br i1 %i.ea, label %middle.block, label %vector.body, !llvm.loop !55

middle.block:                                     ; preds = %vector.body
  %i.eb = add i32 %i.dy, -5
  store i32 %i.eb, ptr %i.dm, align 8, !tbaa !36
  br label %scalar.ph.preheader

scalar.ph.preheader:                              ; preds = %.split.us, %middle.block
  %.ph = phi i32 [ %.promoted, %.split.us ], [ %i.dv, %middle.block ]
  %.4.us.ph = phi i64 [ %.3, %.split.us ], [ %i.dw, %middle.block ]
  br label %scalar.ph

scalar.ph:                                        ; preds = %scalar.ph.preheader, %bb.ab
  %i.ec = phi i32 [ %i.ed, %bb.ab ], [ %.ph, %scalar.ph.preheader ] ; 2 uses
  %.4.us = phi i64 [ %i.ee, %bb.ab ], [ %.4.us.ph, %scalar.ph.preheader ] ; 2 uses
  %.not145.us = icmp eq i32 %i.ec, 0
  br i1 %.not145.us, label %.split212.us, label %bb.ab

bb.ab:                                            ; preds = %scalar.ph
  %i.ed = add i32 %i.ec, -1                       ; 2 uses
  store i32 %i.ed, ptr %i.dm, align 8, !tbaa !36
  %i.ee = add i64 %.4.us, 1                       ; 2 uses
  %i.ef = icmp eq i64 %i.ee, %2
  br i1 %i.ef, label %.loopexit, label %scalar.ph, !llvm.loop !58

.split:                                           ; preds = %bb.aa, %bb.ac
  %.4 = phi i64 [ %i.en, %bb.ac ], [ %.3, %bb.aa ] ; 3 uses
  %i.eg = load i32, ptr %i.dm, align 8, !tbaa !36 ; 2 uses
  %.not145 = icmp eq i32 %i.eg, 0
  br i1 %.not145, label %.split212.us, label %bb.ac

bb.ac:                                            ; preds = %.split
  %i.eh = add i32 %i.eg, -1                       ; 2 uses
  store i32 %i.eh, ptr %i.dm, align 8, !tbaa !36
  %i.ei = load ptr, ptr %i.dn, align 8, !tbaa !26
  ...
  br i1 %i.eo, label %.loopexit, label %.split, !llvm.loop !59

.split212.us:                                     ; preds = %.split, %scalar.ph
  %.us-phi = phi i64 [ %.4.us, %scalar.ph ], [ %.4, %.split ] ; 2 uses
  %i.ep = getelementptr inbounds nuw i8, ptr %0, i64 64 ; 4 uses
...
bb.ad:                                            ; preds = %.split212.us
  %i.eu = getelementptr inbounds nuw i8, ptr %0, i64 104 ; 2 uses
  %i.ev = load i32, ptr %i.eu, align 8, !tbaa !60 ; 5 uses
  %.not146 = icmp ult i32 %i.eq, %i.ev
  br i1 %.not146, label %bb.af, label %bb.ae
...
bb.ae:                                            ; preds = %bb.ad
  ...
  %i.ez = lshr i32 %i.ev, 2
  %i.fa = add i32 %i.ez, %i.ev
  %.020.i = select i1 %i.ey, i32 512, i32 %i.fa   ; 2 uses
  %i.fb = zext i32 %i.ev to i64                   ; 3 uses
  %i.fc = zext i32 %.020.i to i64                 ; 2 uses
  %i.fd = getelementptr inbounds nuw i8, ptr %0, i64 88 ; 2 uses
  %i.fe = load ptr, ptr %i.fd, align 8, !tbaa !38
  %i.ff = call ptr @ft_mem_realloc(ptr noundef %i.ex, i64 noundef 3, i64 noundef %i.fb, i64 noundef %i.fc, ptr noundef %i.fe, ptr noundef nonnull %3) #7 ; 3 uses
  store ptr %i.ff, ptr %i.fd, align 8, !tbaa !38
  %i.fg = load i32, ptr %3, align 4, !tbaa !3
  %.not.i172 = icmp eq i32 %i.fg, 0
  br i1 %.not.i172, label %ft_lzwstate_prefix_grow.exit, label %ft_lzwstate_prefix_grow.exit.thread

ft_lzwstate_prefix_grow.exit.thread:              ; preds = %bb.ae
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #7
  br label %.loopexit190

ft_lzwstate_prefix_grow.exit:                     ; preds = %bb.ae
  %i.fh = getelementptr inbounds nuw [2 x i8], ptr %i.ff, i64 %i.fc ; 2 uses
  %i.fi = getelementptr inbounds nuw i8, ptr %0, i64 96
  store ptr %i.fh, ptr %i.fi, align 8, !tbaa !50
  %i.fj = getelementptr inbounds nuw [2 x i8], ptr %i.ff, i64 %i.fb
  call void @llvm.memmove.p0.p0.i64(ptr align 1 %i.fh, ptr align 2 %i.fj, i64 %i.fb, i1 false)
  store i32 %.020.i, ptr %i.eu, align 8, !tbaa !60
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #7
  %.pre238 = load i32, ptr %i.ep, align 8, !tbaa !45
  br label %bb.af

bb.af:                                            ; preds = %ft_lzwstate_prefix_grow.exit, %bb.ad
  %i.fk = phi i32 [ %.pre238, %ft_lzwstate_prefix_grow.exit ], [ %i.eq, %bb.ad ]
  %i.fl = trunc i32 %.3117 to i16
  %i.fm = getelementptr inbounds nuw i8, ptr %0, i64 88
  %i.fn = load ptr, ptr %i.fm, align 8, !tbaa !38
  %i.fo = zext i32 %i.fk to i64                   ; 2 uses
  %i.fp = getelementptr inbounds nuw [2 x i8], ptr %i.fn, i64 %i.fo
  store i16 %i.fl, ptr %i.fp, align 2, !tbaa !51
  %i.fq = trunc i32 %.3123 to i8
  ...
  store i8 %i.fq, ptr %i.ft, align 1, !tbaa !13
  %i.fu = load i32, ptr %i.ep, align 8, !tbaa !45
  %i.fv = add i32 %i.fu, 1
  store i32 %i.fv, ptr %i.ep, align 8, !tbaa !45
  br label %bb.ag

bb.ag:                                            ; preds = %bb.af, %.split212.us
  store i32 1, ptr %0, align 8, !tbaa !37
  br label %.preheader

.loopexit:                                        ; preds = %bb.ac, %bb.ab, %bb.j, %bb.b, %bb.a, %.loopexit190
  %.4124 = phi i32 [ %i.e, %bb.a ], [ %i.e, %bb.b ], [ %.5125, %.loopexit190 ], [ %i.ah, %bb.j ], [ %.3123, %bb.ab ], [ %.3123, %bb.ac ]
  %.4118 = phi i32 [ %i.g, %bb.a ], [ %i.g, %bb.b ], [ %.5119, %.loopexit190 ], [ %i.ah, %bb.j ], [ %.3117, %bb.ab ], [ %.3117, %bb.ac ]
  %.4112 = phi i32 [ %i.i, %bb.a ], [ %i.i, %bb.b ], [ %.5113, %.loopexit190 ], [ 0, %bb.j ], [ %.3111, %bb.ab ], [ %.3111, %bb.ac ]
  %.5 = phi i64 [ 0, %bb.a ], [ 0, %bb.b ], [ %.6, %.loopexit190 ], [ 1, %bb.j ], [ %2, %bb.ab ], [ %2, %bb.ac ]
  store i32 %.4118, ptr %i.f, align 8, !tbaa !40
  store i32 %.4124, ptr %i.d, align 4, !tbaa !39
  store i32 %.4112, ptr %i.h, align 8, !tbaa !41
  ret i64 %.5

.loopexit190:                                     ; preds = %bb.n, %bb.r, %bb.l, %.preheader, %ft_lzwstate_prefix_grow.exit.thread, %ft_lzwstate_stack_grow.exit171.thread, %ft_lzwstate_stack_grow.exit160.thread, %ft_lzwstate_stack_grow.exit.thread, %.thread, %bb.o
  %.5125 = phi i32 [ 0, %bb.l ], [ %.2122205223, %bb.o ], [ %.2122205223, %ft_lzwstate_stack_grow.exit.thread ], [ %.2122205223, %ft_lzwstate_stack_grow.exit160.thread ], [ %i.e, %.thread ], [ %.2, %ft_lzwstate_stack_grow.exit171.thread ], [ %.3123, %ft_lzwstate_prefix_grow.exit.thread ], [ %.2122.ph, %.preheader ], [ %.2122205223, %bb.r ], [ 0, %bb.n ]
  %.5119 = phi i32 [ 0, %bb.l ], [ %.2116206226, %bb.o ], [ %.2116206226, %ft_lzwstate_stack_grow.exit.thread ], [ %.2116206226, %ft_lzwstate_stack_grow.exit160.thread ], [ %i.g, %.thread ], [ %.2116206227, %ft_lzwstate_stack_grow.exit171.thread ], [ %.3117, %ft_lzwstate_prefix_grow.exit.thread ], [ %.2116.ph, %.preheader ], [ %.2116206226, %bb.r ], [ 0, %bb.n ]
  %.5113 = phi i32 [ %.2110.ph, %bb.l ], [ %i.ba, %bb.o ], [ %i.ba, %ft_lzwstate_stack_grow.exit.thread ], [ %i.ba, %ft_lzwstate_stack_grow.exit160.thread ], [ %.0108.ph, %.thread ], [ %i.da, %ft_lzwstate_stack_grow.exit171.thread ], [ %.3111, %ft_lzwstate_prefix_grow.exit.thread ], [ %.2110.ph, %.preheader ], [ %i.ba, %bb.r ], [ %.2110.ph, %bb.n ]
  %.6 = phi i64 [ %i.ak, %bb.l ], [ %i.ak, %bb.o ], [ %i.ak, %ft_lzwstate_stack_grow.exit.thread ], [ %i.ak, %ft_lzwstate_stack_grow.exit160.thread ], [ 0, %.thread ], [ %i.ak, %ft_lzwstate_stack_grow.exit171.thread ], [ %.us-phi, %ft_lzwstate_prefix_grow.exit.thread ], [ %i.ak, %.preheader ], [ %i.ak, %bb.r ], [ %i.ak, %bb.n ]
