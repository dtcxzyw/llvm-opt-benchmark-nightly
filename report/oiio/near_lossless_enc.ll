...
begin_hunk_0_@VP8ApplyNearLossless:bb.a
  ...
  %i.i = tail call ptr @WebPSafeMalloc(i64 noundef %i.h, i64 noundef 4) #6 ; 4 uses
...
.sink.split:                                      ; preds = %.lr.ph, %.epil.preheader, %.sink.split.loopexit.unr-lcssa, %bb.d, %.preheader
  tail call void @WebPSafeFree(ptr noundef nonnull %i.i) #6
  br label %bb.e
...
.split.us.preheader:                              ; preds = %bb.a
  ...
  %7 = insertelement <4 x i32> poison, i32 %i.n, i64 0
  %8 = shufflevector <4 x i32> %7, <4 x i32> poison, <4 x i32> zeroinitializer
  %9 = insertelement <4 x i32> poison, i32 %4, i64 0
  %10 = shufflevector <4 x i32> %9, <4 x i32> poison, <4 x i32> zeroinitializer
  %11 = insertelement <4 x i32> poison, i32 %notmask.i.i, i64 0
...
bb.b:                                             ; preds = %.lr.ph.us, %bb.n
  ...
  %i.z = and i32 %i.y, 255
  %13 = load i32, ptr %i.w, align 4, !tbaa !3     ; 7 uses
  %i.aa = and i32 %13, 255                        ; 5 uses
  %i.ab = sub nsw i32 %i.aa, %i.z                 ; 2 uses
...
begin_hunk_7_@NearLossless:bb.a
  ...
  %i.as = sub nsw i32 %i.aa, %i.ar                ; 2 uses
...
begin_hunk_8_@NearLossless:bb.a
  ...
  %i.be = sub nsw i32 %i.aa, %i.bd                ; 2 uses
...
begin_hunk_9_@NearLossless:bb.a
  ...
  %i.bq = sub nsw i32 %i.aa, %i.bp                ; 2 uses
...
IsSmooth.exit.thread.us:                          ; preds = %bb.b, %IsSmooth.exit.us, %bb.m, %bb.l, %bb.k, %IsNear.exit50.i.us, %bb.j, %bb.i, %bb.h, %IsNear.exit35.i.us, %bb.g, %bb.f, %bb.e, %IsNear.exit.i.us, %bb.d, %bb.c
  %i.bz = lshr i32 %13, 16
  %i.ca = lshr i32 %13, 24
  %14 = insertelement <4 x i32> poison, i32 %i.ca, i64 0
  %15 = insertelement <4 x i32> %14, i32 %i.aa, i64 1
  %16 = insertelement <4 x i32> %15, i32 %i.bz, i64 2
  %17 = insertelement <4 x i32> %16, i32 %i.ad, i64 3
  %18 = and <4 x i32> %17, <i32 -1, i32 -1, i32 255, i32 -1> ; 2 uses
  %19 = add nuw nsw <4 x i32> %18, %8
  %20 = lshr <4 x i32> %18, %10
  %21 = and <4 x i32> %20, splat (i32 1)
  %22 = add nuw nsw <4 x i32> %19, %21            ; 2 uses
  %23 = icmp ugt <4 x i32> %22, splat (i32 255)
  %24 = and <4 x i32> %22, %12
  %25 = shl nuw <4 x i32> %24, <i32 24, i32 0, i32 16, i32 8>
  %26 = select <4 x i1> %23, <4 x i32> <i32 -16777216, i32 255, i32 16711680, i32 65280>, <4 x i32> %25
  %27 = tail call i32 @llvm.vector.reduce.or.v4i32(<4 x i32> %26)
  br label %bb.n

bb.n:                                             ; preds = %IsSmooth.exit.us, %IsSmooth.exit.thread.us
  %.sink = phi i32 [ %27, %IsSmooth.exit.thread.us ], [ %13, %IsSmooth.exit.us ]
