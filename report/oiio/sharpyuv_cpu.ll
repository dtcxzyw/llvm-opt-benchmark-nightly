...
bb.j:                                             ; preds = %bb.b
  %i.af = tail call { i32, i32, i32, i32 } asm sideeffect "cpuid\0A", "={ax},={bx},={cx},={dx},{ax},{cx},~{dirflag},~{fpsr},~{flags}"(i32 0, i32 0) #1, !srcloc !7
  %i.ag = extractvalue { i32, i32, i32, i32 } %i.af, 0
  %i.ah = icmp slt i32 %i.ag, 1
  br i1 %i.ah, label %CheckSlowModel.exit, label %bb.k

bb.k:                                             ; preds = %bb.j
  %i.ai = tail call { i32, i32, i32, i32 } asm sideeffect "cpuid\0A", "={ax},={bx},={cx},={dx},{ax},{cx},~{dirflag},~{fpsr},~{flags}"(i32 1, i32 0) #1, !srcloc !7
...
x86CPUInfo.exit:                                  ; preds = %bb.k
  %i.am = tail call { i32, i32 } asm sideeffect ".byte 0x0f, 0x01, 0xd0\0A", "={ax},={dx},{cx},~{dirflag},~{fpsr},~{flags}"(i32 0) #1, !srcloc !8
