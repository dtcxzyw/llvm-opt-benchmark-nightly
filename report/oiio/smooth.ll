...
begin_hunk_0_@gray_render_line:bb.a
  ...
  store i32 %i.hz, ptr %i.hv, align 8, !tbaa !78
...
bb.av:                                            ; preds = %.lr.ph.i220
  ...
  %i.it = load ptr, ptr %i.is, align 8, !tbaa !82 ; 2 uses
  %i.iu = load i32, ptr %i.it, align 8, !tbaa !77 ; 2 uses
...
._crit_edge.i222:                                 ; preds = %._crit_edge.i222.loopexit, %bb.au
  ...
  %i.ix = load ptr, ptr %i.fk, align 8, !tbaa !86 ; 8 uses
  %i.iy = getelementptr inbounds nuw i8, ptr %i.ix, i64 24
  store ptr %i.iy, ptr %i.fk, align 8, !tbaa !86
  %i.iz = load ptr, ptr %i.fl, align 8, !tbaa !75
...
bb.ax:                                            ; preds = %._crit_edge.i222
  store i32 %i.il, ptr %i.ix, align 8, !tbaa !77
  %i.ja = getelementptr inbounds nuw i8, ptr %i.ix, i64 8
  store i32 0, ptr %i.ja, align 8, !tbaa !78
  %i.jb = getelementptr inbounds nuw i8, ptr %i.ix, i64 4
  store i32 0, ptr %i.jb, align 4, !tbaa !79
  %i.jc = load ptr, ptr %.034.lcssa.i223, align 8, !tbaa !82
  %i.jd = getelementptr inbounds nuw i8, ptr %i.ix, i64 16
  store ptr %i.jc, ptr %i.jd, align 8, !tbaa !80
  store ptr %i.ix, ptr %.034.lcssa.i223, align 8, !tbaa !82
  br label %gray_set_cell.exit225

gray_set_cell.exit225:                            ; preds = %.lr.ph.i220, %bb.at, %bb.ax
  %.0.sink.i217 = phi ptr [ %i.if, %bb.at ], [ %i.ix, %bb.ax ], [ %i.iq, %.lr.ph.i220 ] ; 2 uses
  store ptr %.0.sink.i217, ptr %i.ff, align 8, !tbaa !87
  %i.je = icmp ne i32 %.1171, %i.r
  %i.jf = icmp ne i32 %.3, %i.f
  %i.jg = or i1 %i.je, %i.jf
  br i1 %i.jg, label %bb.aj, label %.loopexit, !llvm.loop !138
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load i16, ptr %i.c, align 2, !tbaa !22
...
bb.d:                                             ; preds = %bb.c
  ...
  store ptr %1, ptr %i.k, align 8, !tbaa !14
  %i.l = getelementptr inbounds nuw i8, ptr %3, i64 16
  store i32 3, ptr %i.l, align 8, !tbaa !16
  %i.m = getelementptr inbounds nuw i8, ptr %3, i64 24
  store ptr @ft_smooth_overlap_spans, ptr %i.m, align 8, !tbaa !24
  %i.n = getelementptr inbounds nuw i8, ptr %3, i64 56
  store ptr %4, ptr %i.n, align 8, !tbaa !31
  ...
  store ptr %storemerge, ptr %4, align 8, !tbaa !98
  %i.ad = getelementptr inbounds nuw i8, ptr %4, i64 8
  store i32 %i.x, ptr %i.ad, align 8, !tbaa !99
...
.lr.ph:                                           ; preds = %.lr.ph.preheader43, %.lr.ph
  ...
  %i.as = load <2 x i64>, ptr %.034, align 8, !tbaa !96
  %i.at = shl nsw <2 x i64> %i.as, splat (i64 2)
  store <2 x i64> %i.at, ptr %.034, align 8, !tbaa !96
...
.lr.ph37:                                         ; preds = %.lr.ph37.preheader, %.lr.ph37
  ...
  %i.bg = load <2 x i64>, ptr %.135, align 8, !tbaa !96
  %i.bh = sdiv <2 x i64> %i.bg, splat (i64 4)
  store <2 x i64> %i.bh, ptr %.135, align 8, !tbaa !96
...
bb.a:
  ...
  store i32 3, ptr %i.e, align 8, !tbaa !16
  %i.f = getelementptr inbounds nuw i8, ptr %3, i64 24
  store ptr @ft_smooth_lcd_spans, ptr %i.f, align 8, !tbaa !24
  %i.g = getelementptr inbounds nuw i8, ptr %3, i64 56
  store ptr %4, ptr %i.g, align 8, !tbaa !31
  ...
  %i.m = load i32, ptr %2, align 8, !tbaa !40     ; 2 uses
  %i.n = zext i32 %i.m to i64
  %i.o = getelementptr inbounds nuw i8, ptr %3, i64 88
  store i64 %i.n, ptr %i.o, align 8, !tbaa !37
  %i.p = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.q = load i32, ptr %i.p, align 8, !tbaa !42   ; 3 uses
  ...
  store i32 %i.q, ptr %i.w, align 8, !tbaa !99
  %i.x = load i64, ptr %i.c, align 8, !tbaa !56
...
bb.b:                                             ; preds = %bb.a
  %i.ah = load ptr, ptr %4, align 8, !tbaa !98
  %i.ai = getelementptr inbounds nuw i8, ptr %i.ah, i64 1
  store ptr %i.ai, ptr %4, align 8, !tbaa !98
  %i.aj = load i64, ptr %i.c, align 8, !tbaa !56
...
bb.c:                                             ; preds = %bb.b
  %i.au = load ptr, ptr %4, align 8, !tbaa !98
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 1
  store ptr %i.av, ptr %4, align 8, !tbaa !98
  %i.aw = load i64, ptr %i.ak, align 8, !tbaa !56
...
bb.d:                                             ; preds = %bb.b, %bb.a, %bb.c
  ...
  %.040 = load i64, ptr %.040.in, align 8, !tbaa !56
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 8, !tbaa !42   ; 3 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !54   ; 6 uses
  ...
  store i32 1, ptr %i.g, align 8, !tbaa !16
  %i.h = mul nsw i32 %i.b, 3
  store i32 %i.h, ptr %i.a, align 8, !tbaa !42
  %i.i = load i32, ptr %2, align 8, !tbaa !40
  %i.j = udiv i32 %i.i, 3
end_hunk_0
