Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/oiio/original/muxedit?download=true
...
.lr.ph.i.i:                                       ; preds = %bb.d, %bb.g
  ...
  %.0711.i.i = phi ptr [ %.18.i.i, %bb.g ], [ %i.i, %bb.d ] ; 2 uses
...
bb.e:                                             ; preds = %.lr.ph.i.i
  ...
  store ptr %i.n, ptr %.0711.i.i, align 8, !tbaa !17
  br label %bb.g
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %.18.i.i = phi ptr [ %.0711.i.i, %bb.e ], [ %i.o, %bb.f ]
...
.lr.ph.i.i:                                       ; preds = %bb.f, %bb.i
  ...
  %.0711.i.i = phi ptr [ %.18.i.i, %bb.i ], [ %i.j, %bb.f ] ; 2 uses
...
bb.g:                                             ; preds = %.lr.ph.i.i
  ...
  store ptr %i.o, ptr %.0711.i.i, align 8, !tbaa !17
  br label %bb.i
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  %.18.i.i = phi ptr [ %.0711.i.i, %bb.g ], [ %i.p, %bb.h ]
...
.lr.ph.i.i.i52:                                   ; preds = %bb.t, %bb.w
  ...
  %.0711.i.i.i53 = phi ptr [ %.18.i.i.i, %bb.w ], [ %i.bg, %bb.t ] ; 2 uses
...
bb.u:                                             ; preds = %.lr.ph.i.i.i52
  ...
  store ptr %i.bl, ptr %.0711.i.i.i53, align 8, !tbaa !17
  br label %bb.w

bb.v:                                             ; preds = %.lr.ph.i.i.i52
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bi, i64 24 ; 2 uses
  %.pre.i.i.i54 = load ptr, ptr %i.bm, align 8, !tbaa !17
  br label %bb.w

bb.w:                                             ; preds = %bb.v, %bb.u
  %i.bn = phi ptr [ %i.bl, %bb.u ], [ %.pre.i.i.i54, %bb.v ] ; 2 uses
  %.18.i.i.i = phi ptr [ %.0711.i.i.i53, %bb.u ], [ %i.bm, %bb.v ]
  %.not.i.i.i55 = icmp eq ptr %i.bn, null
  br i1 %.not.i.i.i55, label %MuxDeleteAllNamedData.exit.thread81.i, label %.lr.ph.i.i.i52, !llvm.loop !21
...
bb.aa:                                            ; preds = %bb.z, %bb.y
  %.1.i57 = phi i32 [ %.0.i, %bb.y ], [ %spec.select64.i, %bb.z ] ; 3 uses
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.cb = or i32 %.1.i57, 4
  %spec.select65.i = select i1 %.not58.i, i32 %.1.i57, i32 %i.cb
  br label %bb.ac

bb.ac:                                            ; preds = %bb.ab, %bb.aa
  %.2.i = phi i32 [ %.1.i57, %bb.aa ], [ %spec.select65.i, %bb.ab ] ; 3 uses
...
.loopexit.i:                                      ; preds = %bb.af, %bb.ag
  ...
  %.175.ph.i = phi i32 [ %i.dr, %bb.ag ], [ %.125.i.i, %bb.af ] ; 4 uses
...
bb.an:                                            ; preds = %bb.am
  ...
  br i1 %i.eh, label %CreateVP8XChunk.exit.thread66, label %CreateVP8XChunk.exit

CreateVP8XChunk.exit.thread66:                    ; preds = %bb.an
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #5
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #5
  br label %bb.ao
...
bb.ao:                                            ; preds = %CreateVP8XChunk.exit.thread66, %CreateVP8XChunk.exit
...
.lr.ph.i:                                         ; preds = %bb.ao, %.lr.ph.i
  ...
  br i1 %.not.i58, label %ImageListDiskSize.exit, label %.lr.ph.i, !llvm.loop !62
...
.lr.ph.i59:                                       ; preds = %bb.ap, %.lr.ph.i59
  %.08.i = phi ptr [ %i.gh, %.lr.ph.i59 ], [ %i.gf, %bb.ap ]
  %.057.i = phi ptr [ %i.gj, %.lr.ph.i59 ], [ %i.gg, %bb.ap ] ; 2 uses
  ...
  %.not.i60 = icmp eq ptr %i.gj, null
  br i1 %.not.i60, label %ImageListEmit.exit, label %.lr.ph.i59, !llvm.loop !63

ImageListEmit.exit:                               ; preds = %.lr.ph.i59, %bb.ap
  %.0.lcssa.i61 = phi ptr [ %i.gf, %bb.ap ], [ %i.gh, %.lr.ph.i59 ]
  %i.gk = load ptr, ptr %i.bs, align 8, !tbaa !55
  %i.gl = call ptr @ChunkListEmit(ptr noundef %i.gk, ptr noundef %.0.lcssa.i61) #5
