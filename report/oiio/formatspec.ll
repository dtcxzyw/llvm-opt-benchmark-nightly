...
bb.ap:                                            ; preds = %bb.ah, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  ...
  %.not46 = icmp eq i3 %26, 0
  %i.ee = getelementptr inbounds nuw i8, ptr %1, i64 36
  %i.ef = load i32, ptr %i.ee, align 4, !tbaa !53 ; 4 uses
  br i1 %.not46, label %bb.aq, label %thread-pre-split

bb.aq:                                            ; preds = %bb.ap
  %i.eg = getelementptr inbounds nuw i8, ptr %1, i64 12
  %i.eh = load i32, ptr %i.eg, align 4, !tbaa !51
  %.not47 = icmp eq i32 %i.ef, %i.eh
  %.not48 = icmp eq i32 %i.ef, 0
...
bb.ar:                                            ; preds = %bb.aq
  ...
  %i.ej = load i32, ptr %i.ei, align 8, !tbaa !54 ; 2 uses
  %i.ek = getelementptr inbounds nuw i8, ptr %1, i64 16
  %i.el = load i32, ptr %i.ek, align 8, !tbaa !52
  %.not49 = icmp eq i32 %i.ej, %i.el
  %.not50 = icmp eq i32 %i.ej, 0
...
bb.as:                                            ; preds = %bb.ar
  ...
  %i.en = load i32, ptr %i.em, align 4, !tbaa !222 ; 2 uses
  %i.eo = load i32, ptr %i.g, align 4, !tbaa !23  ; 2 uses
  %.not51 = icmp eq i32 %i.en, %i.eo
  %.not52 = icmp eq i32 %i.en, 0
...
bb.at:                                            ; preds = %thread-pre-split, %bb.as
  %i.ep = phi i32 [ %.pr, %thread-pre-split ], [ %i.eo, %bb.as ]
  call void @llvm.lifetime.start.p0(ptr nonnull %17) #39
  %i.eq = getelementptr inbounds nuw i8, ptr %1, i64 40
  %i.er = load i32, ptr %i.eq, align 8, !tbaa !54 ; 2 uses
  %i.es = icmp sgt i32 %i.ep, 1
  br i1 %i.es, label %bb.au, label %bb.av

bb.au:                                            ; preds = %bb.at
  %i.et = getelementptr inbounds nuw i8, ptr %1, i64 44
  %i.eu = load i32, ptr %i.et, align 4, !tbaa !222
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #39, !noalias !226
  store i32 %i.ef, ptr %9, align 16, !tbaa !62, !alias.scope !229, !noalias !226
  %i.ev = getelementptr inbounds nuw i8, ptr %9, i64 16
  store i32 %i.er, ptr %i.ev, align 16, !tbaa !62, !alias.scope !229, !noalias !226
  %i.ew = getelementptr inbounds nuw i8, ptr %9, i64 32
  store i32 %i.eu, ptr %i.ew, align 16, !tbaa !62, !alias.scope !229, !noalias !226
...
bb.av:                                            ; preds = %bb.at
  ...
  store i32 %i.ef, ptr %8, align 16, !tbaa !62, !alias.scope !235, !noalias !232
  %i.ex = getelementptr inbounds nuw i8, ptr %8, i64 16
  store i32 %i.er, ptr %i.ex, align 16, !tbaa !62, !alias.scope !235, !noalias !232
...
bb.aw:                                            ; preds = %_ZN11OpenImageIO4v3_110format_resB5cxx11ERKNS0_9ImageSpecEiii.exit
  %i.ey = load ptr, ptr %17, align 8, !tbaa !57   ; 2 uses
  %i.ez = getelementptr inbounds nuw i8, ptr %17, i64 16 ; 2 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i88: ; preds = %bb.aw
  %i.fb = load i64, ptr %i.ez, align 8, !tbaa !62
  %i.fc = add i64 %i.fb, 1
  call void @_ZdlPvm(ptr noundef %i.ey, i64 noundef %i.fc) #40
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit90: ; preds = %bb.aw, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i88
  ...
  %i.fd = load i32, ptr %i.ec, align 8, !tbaa !79 ; 2 uses
  %i.fe = load i32, ptr %i.ed, align 4, !tbaa !80 ; 2 uses
  %i.ff = load i32, ptr %i.g, align 4, !tbaa !23, !noalias !238
...
bb.ax:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit90
  %i.fh = load i32, ptr %23, align 8, !tbaa !81
  call void @llvm.lifetime.start.p0(ptr nonnull %7) #39, !noalias !241
  store i32 %i.fd, ptr %7, align 16, !tbaa !62, !alias.scope !244, !noalias !241
  %i.fi = getelementptr inbounds nuw i8, ptr %7, i64 16
  store i32 %i.fe, ptr %i.fi, align 16, !tbaa !62, !alias.scope !244, !noalias !241
  %i.fj = getelementptr inbounds nuw i8, ptr %7, i64 32
  store i32 %i.fh, ptr %i.fj, align 16, !tbaa !62, !alias.scope !244, !noalias !241
...
bb.ay:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit90
  ...
  store i32 %i.fd, ptr %6, align 16, !tbaa !62, !alias.scope !250, !noalias !247
  %i.fk = getelementptr inbounds nuw i8, ptr %6, i64 16
  store i32 %i.fe, ptr %i.fk, align 16, !tbaa !62, !alias.scope !250, !noalias !247
...
bb.az:                                            ; preds = %_ZN11OpenImageIO4v3_113format_offsetB5cxx11ERKNS0_9ImageSpecEiii.exit
  %i.fl = load ptr, ptr %18, align 8, !tbaa !57   ; 2 uses
  %i.fm = getelementptr inbounds nuw i8, ptr %18, i64 16 ; 2 uses
  %i.fn = icmp eq ptr %i.fl, %i.fm
  br i1 %i.fn, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit95, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i93

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i93: ; preds = %bb.az
  %i.fo = load i64, ptr %i.fm, align 8, !tbaa !62
  %i.fp = add i64 %i.fo, 1
...
bb.bb:                                            ; preds = %_ZN11OpenImageIO4v3_110format_resB5cxx11ERKNS0_9ImageSpecEiii.exit
  %i.fr = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.fs = load ptr, ptr %17, align 8, !tbaa !57   ; 2 uses
  %i.ft = getelementptr inbounds nuw i8, ptr %17, i64 16 ; 2 uses
  %i.fu = icmp eq ptr %i.fs, %i.ft
  br i1 %i.fu, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit98, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i96

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i96: ; preds = %bb.bb
  %i.fv = load i64, ptr %i.ft, align 8, !tbaa !62
  %i.fw = add i64 %i.fv, 1
  call void @_ZdlPvm(ptr noundef %i.fs, i64 noundef %i.fw) #40
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit98
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit98: ; preds = %bb.bb, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i96, %bb.ba
  %.pn53 = phi { ptr, i32 } [ %i.fq, %bb.ba ], [ %i.fr, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i96 ], [ %i.fr, %bb.bb ]
  call void @llvm.lifetime.end.p0(ptr nonnull %17) #39
  br label %.body120
...
bb.bd:                                            ; preds = %_ZN11OpenImageIO4v3_113format_offsetB5cxx11ERKNS0_9ImageSpecEiii.exit
  %i.fy = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.fz = load ptr, ptr %18, align 8, !tbaa !57   ; 2 uses
  %i.ga = getelementptr inbounds nuw i8, ptr %18, i64 16 ; 2 uses
  %i.gb = icmp eq ptr %i.fz, %i.ga
  br i1 %i.gb, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit101, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i99

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i99: ; preds = %bb.bd
  %i.gc = load i64, ptr %i.ga, align 8, !tbaa !62
  %i.gd = add i64 %i.gc, 1
  call void @_ZdlPvm(ptr noundef %i.fz, i64 noundef %i.gd) #40
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit101
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit101: ; preds = %bb.bd, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i99, %bb.bc
  %.pn55 = phi { ptr, i32 } [ %i.fx, %bb.bc ], [ %i.fy, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i99 ], [ %i.fy, %bb.bd ]
  call void @llvm.lifetime.end.p0(ptr nonnull %18) #39
  br label %.body120
...
bb.be:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit95, %bb.as
  ...
  %i.gf = load i32, ptr %i.ge, align 8, !tbaa !98 ; 3 uses
  %.not57 = icmp eq i32 %i.gf, 0
  br i1 %.not57, label %bb.bl, label %bb.bf

bb.bf:                                            ; preds = %bb.be
  call void @llvm.lifetime.start.p0(ptr nonnull %19) #39
  %i.gg = getelementptr inbounds nuw i8, ptr %1, i64 52
  %i.gh = load i32, ptr %i.gg, align 4, !tbaa !99 ; 2 uses
  %i.gi = load i32, ptr %i.g, align 4, !tbaa !23, !noalias !253
  %i.gj = icmp sgt i32 %i.gi, 1
  br i1 %i.gj, label %bb.bg, label %bb.bh

bb.bg:                                            ; preds = %bb.bf
  %i.gk = getelementptr inbounds nuw i8, ptr %1, i64 56
  %i.gl = load i32, ptr %i.gk, align 8, !tbaa !43
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #39, !noalias !256
  store i32 %i.gf, ptr %5, align 16, !tbaa !62, !alias.scope !259, !noalias !256
  %i.gm = getelementptr inbounds nuw i8, ptr %5, i64 16
  store i32 %i.gh, ptr %i.gm, align 16, !tbaa !62, !alias.scope !259, !noalias !256
  %i.gn = getelementptr inbounds nuw i8, ptr %5, i64 32
  store i32 %i.gl, ptr %i.gn, align 16, !tbaa !62, !alias.scope !259, !noalias !256
...
bb.bh:                                            ; preds = %bb.bf
  ...
  store i32 %i.gf, ptr %4, align 16, !tbaa !62, !alias.scope !265, !noalias !262
  %i.go = getelementptr inbounds nuw i8, ptr %4, i64 16
  store i32 %i.gh, ptr %i.go, align 16, !tbaa !62, !alias.scope !265, !noalias !262
...
bb.bi:                                            ; preds = %_ZN11OpenImageIO4v3_110format_resB5cxx11ERKNS0_9ImageSpecEiii.exit104
  %i.gp = load ptr, ptr %19, align 8, !tbaa !57   ; 2 uses
  %i.gq = getelementptr inbounds nuw i8, ptr %19, i64 16 ; 2 uses
  %i.gr = icmp eq ptr %i.gp, %i.gq
  br i1 %i.gr, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit107, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i105

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i105: ; preds = %bb.bi
  %i.gs = load i64, ptr %i.gq, align 8, !tbaa !62
  %i.gt = add i64 %i.gs, 1
  call void @_ZdlPvm(ptr noundef %i.gp, i64 noundef %i.gt) #40
...
bb.bk:                                            ; preds = %_ZN11OpenImageIO4v3_110format_resB5cxx11ERKNS0_9ImageSpecEiii.exit104
  %i.gv = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.gw = load ptr, ptr %19, align 8, !tbaa !57   ; 2 uses
  %i.gx = getelementptr inbounds nuw i8, ptr %19, i64 16 ; 2 uses
  %i.gy = icmp eq ptr %i.gw, %i.gx
  br i1 %i.gy, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit110, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i108

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i108: ; preds = %bb.bk
  %i.gz = load i64, ptr %i.gx, align 8, !tbaa !62
  %i.ha = add i64 %i.gz, 1
  call void @_ZdlPvm(ptr noundef %i.gw, i64 noundef %i.ha) #40
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit110
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit110: ; preds = %bb.bk, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i108, %bb.bj
  %.pn58 = phi { ptr, i32 } [ %i.gu, %bb.bj ], [ %i.gv, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i108 ], [ %i.gv, %bb.bk ]
  call void @llvm.lifetime.end.p0(ptr nonnull %19) #39
  br label %.body120
...
bb.bl:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit107, %bb.be
  ...
  %i.hb = getelementptr inbounds nuw i8, ptr %1, i64 136
  invoke void @_ZNSt6vectorIN11OpenImageIO4v3_110ParamValueESaIS2_EEC2ERKS4_(ptr noundef nonnull align 8 dereferenceable(24) %20, ptr noundef nonnull align 8 dereferenceable(24) %i.hb)
...
bb.bm:                                            ; preds = %_ZN11OpenImageIO4v3_114ParamValueListC2ERKS1_.exit
  %i.hc = load ptr, ptr %20, align 8, !tbaa !106  ; 3 uses
  %i.hd = getelementptr inbounds nuw i8, ptr %20, i64 8 ; 2 uses
  %i.he = load ptr, ptr %i.hd, align 8, !tbaa !106 ; 2 uses
  %.not162167 = icmp eq ptr %i.hc, %i.he
...
.lr.ph170:                                        ; preds = %bb.bm
  %i.hf = icmp eq i32 %3, 2
  %i.hg = getelementptr inbounds nuw i8, ptr %22, i64 8
  %i.hh = getelementptr inbounds nuw i8, ptr %22, i64 16 ; 4 uses
end_hunk_0
