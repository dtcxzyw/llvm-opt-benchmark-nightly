...
begin_hunk_0_@_ZNSt16_Sp_counted_baseILN9__gnu_cxx12_Lock_policyE2EE24_M_release_last_use_coldEv:bb.a
  ...
  tail call void %i.c(ptr noundef nonnull align 8 dereferenceable(16) %0) #13, !inline_history !54
...
bb.d:                                             ; preds = %_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i
  ...
  tail call void %i.l(ptr noundef nonnull align 8 dereferenceable(16) %0) #13, !inline_history !54
...
define linkonce_odr void @_ZNSt6vectorIhSaIhEE15_M_range_insertIPKhEEvN9__gnu_cxx17__normal_iteratorIPhS1_EET_S9_St20forward_iterator_tag(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr %1, ptr noundef %2, ptr noundef %3) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %.not = icmp eq ptr %2, %3
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !29   ; 8 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %i.q, label %bb.e, label %bb.f, !prof !55
...
bb.g:                                             ; preds = %bb.f
  %i.s = load i8, ptr %i.o, align 1, !tbaa !31
  store i8 %i.s, ptr %i.g, align 1, !tbaa !31
  br label %_ZSt22__uninitialized_move_aIPhS0_SaIhEET0_T_S3_S2_RT1_.exit
...
_ZSt22__uninitialized_move_aIPhS0_SaIhEET0_T_S3_S2_RT1_.exit: ; preds = %bb.e, %bb.f, %bb.g
  ...
  store ptr %i.u, ptr %i.f, align 8, !tbaa !29
  %i.v = sub i64 %i.p, %i.k                       ; 4 uses
  %i.w = icmp sgt i64 %i.v, 1
  br i1 %i.w, label %bb.h, label %bb.i, !prof !55
...
bb.m:                                             ; preds = %bb.l
  %i.ad = load i8, ptr %2, align 1, !tbaa !31
  store i8 %i.ad, ptr %1, align 1, !tbaa !31
  br label %_ZSt4copyIPKhN9__gnu_cxx17__normal_iteratorIPhSt6vectorIhSaIhEEEEET0_T_SA_S9_.exit
...
_ZSt9__advanceIPKhlEvRT_T0_St26random_access_iterator_tag.exit: ; preds = %bb.c
  ...
  br i1 %i.ai, label %bb.n, label %bb.o, !prof !55
...
bb.p:                                             ; preds = %bb.o
  %i.ak = load i8, ptr %i.af, align 1, !tbaa !31
  store i8 %i.ak, ptr %i.g, align 1, !tbaa !31
  br label %_ZSt22__uninitialized_copy_aIPKhPhhET0_T_S4_S3_RSaIT1_E.exit

_ZSt22__uninitialized_copy_aIPKhPhhET0_T_S4_S3_RSaIT1_E.exit: ; preds = %bb.n, %bb.o, %bb.p
  %i.al = sub nuw i64 %i.c, %i.l
  %i.am = load ptr, ptr %i.f, align 8, !tbaa !29
  %i.an = getelementptr inbounds nuw i8, ptr %i.am, i64 %i.al ; 3 uses
  store ptr %i.an, ptr %i.f, align 8, !tbaa !29
  %i.ao = icmp sgt i64 %i.l, 1
  br i1 %i.ao, label %bb.q, label %bb.r, !prof !55
...
bb.s:                                             ; preds = %bb.r
  %i.ap = load i8, ptr %1, align 1, !tbaa !31
  store i8 %i.ap, ptr %i.an, align 1, !tbaa !31
  br label %_ZSt22__uninitialized_move_aIPhS0_SaIhEET0_T_S3_S2_RT1_.exit55

_ZSt22__uninitialized_move_aIPhS0_SaIhEET0_T_S3_S2_RT1_.exit55: ; preds = %bb.q, %bb.r, %bb.s
  %i.aq = load ptr, ptr %i.f, align 8, !tbaa !29
  %i.ar = getelementptr inbounds nuw i8, ptr %i.aq, i64 %i.l
  store ptr %i.ar, ptr %i.f, align 8, !tbaa !29
  %i.as = icmp sgt i64 %i.l, 1
  br i1 %i.as, label %bb.t, label %bb.u, !prof !55
...
bb.v:                                             ; preds = %bb.u
  %i.au = load i8, ptr %2, align 1, !tbaa !31
  store i8 %i.au, ptr %1, align 1, !tbaa !31
  br label %_ZSt4copyIPKhN9__gnu_cxx17__normal_iteratorIPhSt6vectorIhSaIhEEEEET0_T_SA_S9_.exit

bb.w:                                             ; preds = %bb.b
  %i.av = load ptr, ptr %0, align 8, !tbaa !52    ; 5 uses
...
bb.ad:                                            ; preds = %bb.ab
  ...
  br i1 %i.bi, label %bb.ae, label %bb.af

bb.ae:                                            ; preds = %bb.ad
  %i.bj = load i8, ptr %2, align 1, !tbaa !31
  store i8 %i.bj, ptr %i.bg, align 1, !tbaa !31
  br label %bb.af
...
bb.ai:                                            ; preds = %bb.ah
  %i.bo = load i8, ptr %1, align 1, !tbaa !31
  store i8 %i.bo, ptr %i.bk, align 1, !tbaa !31
  br label %bb.aj

bb.aj:                                            ; preds = %bb.ai, %bb.ah, %bb.ag
  %i.bp = getelementptr inbounds i8, ptr %i.bk, i64 %i.bl
  %.not.i59 = icmp eq ptr %i.av, null
  br i1 %.not.i59, label %_ZNSt12_Vector_baseIhSaIhEE13_M_deallocateEPhm.exit, label %bb.ak

bb.ak:                                            ; preds = %bb.aj
  %i.bq = sub i64 %i.h, %i.aw
  tail call void @_ZdlPvm(ptr noundef nonnull %i.av, i64 noundef %i.bq) #14
...
!6 = !{!"Simple C++ TBAA"}
!7 = !{!8, !10, i64 8}
!8 = !{!"_ZTSN22photos_editing_formats8image_io28Base64DecoderDataDestinationE", !9, i64 0, !10, i64 8, !12, i64 16, !13, i64 24, !18, i64 48, !19, i64 56}
...
!12 = !{!"p1 _ZTSN22photos_editing_formats8image_io14MessageHandlerE", !11, i64 0}
...
!22 = !{!23, !18, i64 0}
!23 = !{!"_ZTSN22photos_editing_formats8image_io9DataRangeE", !18, i64 0, !18, i64 8}
!24 = !{!23, !18, i64 8}
!25 = !{!8, !19, i64 56}
!26 = !{i8 0, i8 2}
!27 = !{}
...
!35 = !{!36, !18, i64 8}
!36 = !{!"_ZTSNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEE", !34, i64 0, !18, i64 8, !5, i64 16}
!37 = !{!36, !17, i64 0}
!38 = !{!8, !18, i64 48}
!39 = !{!40, !41, i64 0}
!40 = !{!"_ZTSSt12__shared_ptrIN22photos_editing_formats8image_io11DataSegmentELN9__gnu_cxx12_Lock_policyE2EE", !41, i64 0, !42, i64 8}
!41 = !{!"p1 _ZTSN22photos_editing_formats8image_io11DataSegmentE", !11, i64 0}
...
!47 = !{!46, !4, i64 12}
!48 = distinct !{ptr @_ZNSt12__shared_ptrIN22photos_editing_formats8image_io11DataSegmentELN9__gnu_cxx12_Lock_policyE2EED2Ev, null, null}
!49 = !{!"branch_weights", !"expected", i32 1, i32 2000}
!50 = !{!18, !18, i64 0}
!51 = distinct !{null, null}
!52 = !{!16, !17, i64 0}
!53 = !{ptr @_ZN22photos_editing_formats8image_io28Base64DecoderDataDestinationD2Ev}
!54 = distinct !{null}
