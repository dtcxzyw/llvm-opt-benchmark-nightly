...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %i.t, label %._crit_edge172, label %bb.e

._crit_edge172:                                   ; preds = %bb.d
  %.pre173 = tail call noundef i64 @llvm.usub.sat.i64(i64 %i.k, i64 %i.a)
  br label %._crit_edge171

bb.e:                                             ; preds = %bb.d
  %spec.select.i171 = sub nuw i64 %i.k, %i.a
  %i.u = ptrtoint ptr %i.s to i64
  %i.v = ptrtoint ptr %i.q to i64
  %i.w = sub i64 %i.u, %i.v                       ; 2 uses
  %i.x = and i64 %i.w, 3
  %i.y = sub nuw nsw i64 4, %i.x
  %.sroa.speculated = tail call i64 @llvm.umin.i64(i64 %i.y, i64 %spec.select.i171) ; 3 uses
...
._crit_edge171:                                   ; preds = %._crit_edge172, %._crit_edge
  %spec.select.i88.pre-phi = phi i64 [ %.pre173, %._crit_edge172 ], [ %spec.select.i87, %._crit_edge ]
  %.sroa.15.0 = phi i64 [ 0, %._crit_edge172 ], [ %i.al, %._crit_edge ] ; 2 uses
  %.sroa.11.0 = phi i64 [ 0, %._crit_edge172 ], [ %i.af, %._crit_edge ]
  %.sroa.0133.0 = phi ptr [ null, %._crit_edge172 ], [ %i.ab, %._crit_edge ] ; 8 uses
  %.062 = phi i64 [ 0, %._crit_edge172 ], [ %.sroa.speculated, %._crit_edge ] ; 3 uses
