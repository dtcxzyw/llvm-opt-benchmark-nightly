...
bb.v:                                             ; preds = %bb.v, %.lr.ph145.new
  ...
  %i.bu = phi i64 [ %.promoted, %.lr.ph145.new ], [ %i.dd, %bb.v ] ; 5 uses
...
begin_hunk_2_@exr_write_header:bb.a
  ...
  %1 = add nsw i64 %i.ca, %i.cj                   ; 2 uses
  %i.ck = shl nsw i64 %1, 3
...
begin_hunk_3_@exr_write_header:bb.a
  ...
  %2 = add nsw i64 %1, %i.cs                      ; 2 uses
  %i.ct = shl nsw i64 %2, 3
  %i.cu = add i64 %i.ct, %i.bu
...
begin_hunk_4_@exr_write_header:bb.a
  ...
  %3 = add nsw i64 %2, %i.db
  %i.dc = shl nsw i64 %3, 3
  %i.dd = add i64 %i.dc, %i.bu                    ; 3 uses
