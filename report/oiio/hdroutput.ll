Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/oiio/original/hdroutput?download=true
...
bb.d:                                             ; preds = %bb.c
  ...
  br i1 %or.cond, label %bb.c, label %.critedge.loopexit, !llvm.loop !0
...
.critedge:                                        ; preds = %.critedge.loopexit, %bb.b
  ...
  %i.u = and i1 %i.t, %i.s
  br i1 %i.u, label %bb.b, label %bb.e, !llvm.loop !1
...
bb.h:                                             ; preds = %bb.i
  ...
  br i1 %i.ag, label %.lr.ph64, label %._crit_edge, !llvm.loop !2
...
.lr.ph64:                                         ; preds = %bb.g, %bb.h
  ...
  store i8 %i.ai, ptr %i.a, align 1, !tbaa !54
...
bb.l:                                             ; preds = %bb.k, %._crit_edge
  ...
  br i1 %.not, label %.preheader, label %.loopexit, !llvm.loop !3
...
_ZNSt10unique_ptrIA_hSt14default_deleteIS0_EE5resetIPhvEEvT_.exit: ; preds = %bb.e, %bb.d
  ...
  %.048 = phi ptr [ %i.k, %bb.d ], [ %i.l, %bb.e ] ; 5 uses
...
bb.f:                                             ; preds = %.lr.ph94, %.critedge61
  ...
  store i8 2, ptr %i.c, align 1, !tbaa !54
  store i8 2, ptr %i.n, align 1, !tbaa !54
  store i8 %i.p, ptr %i.q, align 1, !tbaa !54
  store i8 %i.r, ptr %i.s, align 1, !tbaa !54
...
.lr.ph:                                           ; preds = %bb.g, %bb.j
  ...
  %i.ad = load float, ptr %.15390, align 4, !tbaa !57 ; 3 uses
  %i.ae = getelementptr inbounds nuw i8, ptr %.15390, i64 4
  %i.af = load float, ptr %i.ae, align 4, !tbaa !57 ; 3 uses
  %i.ag = getelementptr inbounds nuw i8, ptr %.15390, i64 8
  %i.ah = load float, ptr %i.ag, align 4, !tbaa !57 ; 3 uses
...
bb.i:                                             ; preds = %.lr.ph
  ...
  %i.av = load i32, ptr %i.b, align 4, !tbaa !46
...
bb.j:                                             ; preds = %bb.i, %.lr.ph
  ...
  store i8 %.sink29.i.i, ptr %i.s, align 1, !tbaa !54
  store i8 %.sink28.i.i, ptr %i.q, align 1, !tbaa !54
  store i8 %.sink27.i.i, ptr %i.n, align 1, !tbaa !54
  store i8 %.sink.i.i, ptr %i.c, align 1, !tbaa !54
  %i.ay = getelementptr inbounds nuw i8, ptr %.048, i64 %indvars.iv
  store i8 %.sink.i.i, ptr %i.ay, align 1, !tbaa !54
  %gep = getelementptr inbounds nuw i8, ptr %invariant.gep, i64 %indvars.iv
  store i8 %.sink27.i.i, ptr %gep, align 1, !tbaa !54
  %gep118 = getelementptr inbounds nuw i8, ptr %invariant.gep117, i64 %indvars.iv
  store i8 %.sink28.i.i, ptr %gep118, align 1, !tbaa !54
...
.preheader.lr.ph.i:                               ; preds = %bb.j, %.loopexit79
  ...
  %i.bb = getelementptr inbounds nuw i8, ptr %.048, i64 %i.ba ; 5 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #29
...
bb.m:                                             ; preds = %bb.l
  ...
  br i1 %or.cond.i, label %bb.l, label %.critedge.loopexit.i, !llvm.loop !0
...
.critedge.i:                                      ; preds = %.critedge.loopexit.i, %bb.k
  ...
  br i1 %i.bs, label %bb.k, label %bb.n, !llvm.loop !1
...
bb.o:                                             ; preds = %bb.n
  ...
  store i8 %i.bx, ptr %i.a, align 1, !tbaa !54
  %i.by = sext i32 %.04866.i to i64
  %i.bz = getelementptr inbounds i8, ptr %i.bb, i64 %i.by
  %i.ca = load i8, ptr %i.bz, align 1, !tbaa !54
  store i8 %i.ca, ptr %i.v, align 1, !tbaa !54
...
bb.q:                                             ; preds = %.noexc63
  ...
  br i1 %i.ce, label %.lr.ph64.i, label %._crit_edge.i, !llvm.loop !2
...
.lr.ph64.i:                                       ; preds = %bb.p, %bb.q
  ...
  store i8 %i.cg, ptr %i.a, align 1, !tbaa !54
...
._crit_edge.i:                                    ; preds = %bb.q, %bb.p, %.noexc
  %.2.lcssa.i = phi i32 [ %.04866.i, %bb.p ], [ %i.bc, %.noexc ], [ %i.cd, %bb.q ] ; 2 uses
  %i.cm = icmp samesign ugt i32 %.1.lcssa.i, 3
  br i1 %i.cm, label %bb.s, label %bb.u

bb.s:                                             ; preds = %._crit_edge.i
  %i.cn = trunc i32 %.1.lcssa.i to i8
  %i.co = xor i8 %i.cn, -128
  store i8 %i.co, ptr %i.a, align 1, !tbaa !54
  %i.cp = sext i32 %i.bc to i64
  %i.cq = getelementptr inbounds i8, ptr %i.bb, i64 %i.cp
  %i.cr = load i8, ptr %i.cq, align 1, !tbaa !54
  store i8 %i.cr, ptr %i.v, align 1, !tbaa !54
  %i.cs = invoke noundef zeroext i1 @_ZN11OpenImageIO4v3_111ImageOutput7iowriteEPKvmm(ptr noundef nonnull align 8 dereferenceable(232) %0, ptr noundef nonnull %i.a, i64 noundef 2, i64 noundef 1)
          to label %.noexc64 unwind label %.loopexit.split-lp

.noexc64:                                         ; preds = %bb.s
  br i1 %i.cs, label %bb.t, label %.loopexit77

bb.t:                                             ; preds = %.noexc64
  %i.ct = add nsw i32 %.2.lcssa.i, %.1.lcssa.i
  br label %bb.u

bb.u:                                             ; preds = %bb.t, %._crit_edge.i
  %.3.i = phi i32 [ %i.ct, %bb.t ], [ %.2.lcssa.i, %._crit_edge.i ] ; 2 uses
  %.not.i = icmp slt i32 %.3.i, %2
  br i1 %.not.i, label %.preheader.i, label %.loopexit79, !llvm.loop !3

.loopexit:                                        ; preds = %.lr.ph64.i, %bb.r
  %lpad.loopexit = landingpad { ptr, i32 }
          cleanup
  br label %bb.v

.loopexit.split-lp:                               ; preds = %bb.o, %bb.s
  %lpad.loopexit.split-lp = landingpad { ptr, i32 }
          cleanup
  br label %bb.v

.loopexit79:                                      ; preds = %bb.u
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #29
  %indvars.iv.next102 = add nuw nsw i64 %indvars.iv101, 1 ; 2 uses
  %exitcond104 = icmp eq i64 %indvars.iv.next102, 4
  br i1 %exitcond104, label %.critedge61, label %.preheader.lr.ph.i, !llvm.loop !254

.loopexit77:                                      ; preds = %.noexc, %.noexc64, %.noexc63, %.noexc62
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #29
  br label %.loopexit81.sink.split, !llvm.loop !255

.loopexit81.sink.split:                           ; preds = %bb.g, %.loopexit77
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #29
  br label %.loopexit81

.loopexit81:                                      ; preds = %.critedge61, %.loopexit81.sink.split, %_ZNSt10unique_ptrIA_hSt14default_deleteIS0_EE5resetIPhvEEvT_.exit
  %i.cu = phi i1 [ true, %_ZNSt10unique_ptrIA_hSt14default_deleteIS0_EE5resetIPhvEEvT_.exit ], [ false, %.loopexit81.sink.split ], [ true, %.critedge61 ] ; 2 uses
  %.not.i65 = icmp eq ptr %.sroa.0.0, null
  br i1 %.not.i65, label %_ZNSt10unique_ptrIA_hSt14default_deleteIS0_EED2Ev.exit, label %_ZNKSt14default_deleteIA_hEclIhEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i

_ZNKSt14default_deleteIA_hEclIhEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i: ; preds = %.loopexit81
  call void @_ZdaPv(ptr noundef nonnull %.sroa.0.0) #28
  br label %_ZNSt10unique_ptrIA_hSt14default_deleteIS0_EED2Ev.exit

bb.v:                                             ; preds = %.loopexit, %.loopexit.split-lp, %bb.h
  %.pn = phi { ptr, i32 } [ %i.ac, %bb.h ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #29
  %.not.i66 = icmp eq ptr %.sroa.0.0, null
  br i1 %.not.i66, label %_ZNSt10unique_ptrIA_hSt14default_deleteIS0_EED2Ev.exit68, label %_ZNKSt14default_deleteIA_hEclIhEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i67

_ZNKSt14default_deleteIA_hEclIhEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i67: ; preds = %bb.v
  call void @_ZdaPv(ptr noundef nonnull %.sroa.0.0) #28
  br label %_ZNSt10unique_ptrIA_hSt14default_deleteIS0_EED2Ev.exit68

_ZNSt10unique_ptrIA_hSt14default_deleteIS0_EED2Ev.exit68: ; preds = %bb.v, %_ZNKSt14default_deleteIA_hEclIhEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i67
  resume { ptr, i32 } %.pn

_ZNSt10unique_ptrIA_hSt14default_deleteIS0_EED2Ev.exit: ; preds = %_ZNKSt14default_deleteIA_hEclIhEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i, %.loopexit81, %bb.b
  %.4 = phi i1 [ %i.g, %bb.b ], [ %i.cu, %.loopexit81 ], [ %i.cu, %_ZNKSt14default_deleteIA_hEclIhEENSt9enable_ifIXsr14is_convertibleIPA_T_PS0_EE5valueEvE4typeEPS4_.exit.i ]
  ret i1 %.4
}

; Function Attrs: mustprogress uwtable
define hidden noundef zeroext i1 @_ZN11OpenImageIO4v3_19HdrOutput16RGBE_WritePixelsEPfl(ptr noundef nonnull align 8 dereferenceable(232) %0, ptr nofree noundef readonly captures(none) %1, i64 noundef %2) local_unnamed_addr #0 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %i.a = alloca i32, align 4                      ; 4 uses
  %i.b = shl nsw i64 %2, 2                        ; 4 uses
