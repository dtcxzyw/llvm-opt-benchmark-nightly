begin_hunk_0_@VP8EncWrite:bb.a
  ...
  %i.gp = call i32 %i.go(ptr noundef nonnull %i.h, i64 noundef 12, ptr noundef %i.gk) #5, !inline_history !65
...
begin_hunk_1_@VP8EncWrite:bb.a
  ...
  %i.gu = load i32, ptr %i.gt, align 8, !tbaa !66
...
begin_hunk_2_@VP8EncWrite:bb.a
  ...
  %i.hc = load i32, ptr %i.hb, align 4, !tbaa !67
...
begin_hunk_3_@VP8EncWrite:bb.a
  ...
  %i.hk = call i32 %i.hj(ptr noundef nonnull %i.g, i64 noundef 18, ptr noundef %.val32.i) #5, !inline_history !68
...
begin_hunk_4_@VP8EncWrite:bb.a
  ...
  %i.hs = call i32 %i.hr(ptr noundef nonnull %i.f, i64 noundef 8, ptr noundef %i.hm) #5, !inline_history !69
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.hv = load ptr, ptr %i.hu, align 8, !tbaa !70
  %i.hw = load i32, ptr %i.ho, align 8, !tbaa !55
  %i.hx = zext i32 %i.hw to i64
  %i.hy = call i32 %i.ht(ptr noundef %i.hv, i64 noundef %i.hx, ptr noundef nonnull %i.hm) #5, !inline_history !69
...
begin_hunk_5_@VP8EncWrite:bb.a
  ...
  %i.ic = call i32 %i.ib(ptr noundef nonnull %i.e, i64 noundef 1, ptr noundef nonnull %i.hm) #5, !inline_history !71
...
begin_hunk_6_@VP8EncWrite:bb.a
  ...
  %i.ig = call i32 %i.if(ptr noundef nonnull %i.d, i64 noundef 8, ptr noundef nonnull %i.gk) #5, !inline_history !72
...
bb.x:                                             ; preds = %.critedge.i
  ...
  %i.ii = load i32, ptr %i.ih, align 4, !tbaa !73
...
begin_hunk_7_@VP8EncWrite:bb.a
  ...
  %i.jb = call i32 %i.ja(ptr noundef nonnull %i.c, i64 noundef 10, ptr noundef nonnull %i.gk) #5, !inline_history !74
...
._crit_edge.i:                                    ; preds = %bb.ab
  ...
  %i.jy = call i32 %i.jv(ptr noundef nonnull %i.b, i64 noundef %i.jx, ptr noundef %i.j) #5, !inline_history !76
...
begin_hunk_9_@VP8EncWrite:bb.a
  ...
  br i1 %i.kw, label %bb.ad, label %._crit_edge115, !llvm.loop !77
...
begin_hunk_10_@VP8EncWrite:bb.a
  ...
  %i.lb = call i32 %i.la(ptr noundef nonnull %i.a, i64 noundef 1, ptr noundef %i.j) #5, !inline_history !78
...
begin_hunk_11_@VP8EncWrite:bb.a
  ...
  store i32 %i.le, ptr %i.lf, align 8, !tbaa !79
