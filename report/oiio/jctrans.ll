...
begin_hunk_0_@jinit_huff_encoder
...
bb.c:                                             ; preds = %.lr.ph125, %._crit_edge122
  %i.ax = phi i32 [ %i.ap, %.lr.ph125 ], [ %i.eo, %._crit_edge122 ]
  %i.ay = phi i32 [ %.pre161, %.lr.ph125 ], [ %i.ep, %._crit_edge122 ] ; 2 uses
...
.preheader:                                       ; preds = %bb.c, %bb.i
  %.071121 = phi i32 [ %i.el, %bb.i ], [ %i.az, %bb.c ] ; 4 uses
...
bb.d:                                             ; preds = %.lr.ph119, %._crit_edge100
  ...
  %.077117 = phi i32 [ 0, %.lr.ph119 ], [ %.178.lcssa, %._crit_edge100 ] ; 4 uses
  ...
  %i.bh = load i32, ptr %i.bg, align 8, !tbaa !126 ; 11 uses
...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  %i.bn = load i32, ptr %i.bm, align 4, !tbaa !128 ; 3 uses
...
.lr.ph99.split.us:                                ; preds = %.lr.ph99.split.us.preheader, %scalar.ph.a
  %indvars.iv149 = phi i64 [ 0, %.lr.ph99.split.us.preheader ], [ %indvars.iv.next142.a, %scalar.ph.a ] ; 2 uses
  %.17896.us = phi i32 [ %.077117, %.lr.ph99.split.us.preheader ], [ %.07485.us.a, %scalar.ph.a ] ; 2 uses
  %.pre164 = add nsw i64 %indvars.iv149, %indvars.iv158 ; 2 uses
  br i1 %i.bq, label %.lr.ph88.us, label %bb.g

bb.g:                                             ; preds = %.lr.ph99.split.us
  %i.by = load i32, ptr %i.br, align 4, !tbaa !115
  %i.bz = sext i32 %i.by to i64
  %i.ca = icmp slt i64 %.pre164, %i.bz
...
.lr.ph88.us:                                      ; preds = %.lr.ph99.split.us, %bb.g
  ...
  %i.cc = getelementptr inbounds [8 x i8], ptr %i.cb, i64 %.pre164
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %.086.us = phi ptr [ %2, %scalar.ph ], [ %.086.us.ph, %scalar.ph.preheader ] ; 2 uses
  %.07485.us = phi i32 [ %4, %scalar.ph ], [ %.07485.us.ph, %scalar.ph.preheader ]
  %2 = getelementptr inbounds nuw i8, ptr %.086.us, i64 128
  %indvars.iv.next142 = add nsw i64 %indvars.iv141, 1 ; 2 uses
  %3 = getelementptr inbounds [8 x i8], ptr %i.b, i64 %indvars.iv141
  store ptr %.086.us, ptr %3, align 8, !tbaa !58
  %4 = add nuw nsw i32 %.07485.us, 1              ; 2 uses
  %exitcond144.not = icmp eq i32 %4, %.fr127
  br i1 %exitcond144.not, label %..loopexit_crit_edge.us.loopexit, label %scalar.ph, !llvm.loop !132
...
..loopexit_crit_edge.us:                          ; preds = %..loopexit_crit_edge.us.loopexit, %bb.g
  ...
  br i1 %i.cl, label %.lr.ph93.us.preheader, label %scalar.ph.a
...
.lr.ph93.us:                                      ; preds = %.lr.ph93.us.prol.loopexit, %.lr.ph93.us
  ...
  %.291.us = phi i32 [ %i.di, %.lr.ph93.us ], [ %.291.us.unr, %.lr.ph93.us.prol.loopexit ]
  %i.cw = getelementptr inbounds [8 x i8], ptr %i.au, i64 %indvars.iv145
  %i.cx = load ptr, ptr %i.cw, align 8, !tbaa !58 ; 2 uses
  %i.cy = getelementptr inbounds [8 x i8], ptr %i.b, i64 %indvars.iv145 ; 2 uses
  store ptr %i.cx, ptr %i.cy, align 8, !tbaa !58
  %i.cz = getelementptr i8, ptr %i.cy, i64 -8
  %i.da = load ptr, ptr %i.cz, align 8, !tbaa !58
  %i.db = load i16, ptr %i.da, align 2, !tbaa !99
  store i16 %i.db, ptr %i.cx, align 2, !tbaa !99
  %indvars.iv.next146 = add nsw i64 %indvars.iv145, 1 ; 2 uses
  %i.dc = getelementptr inbounds [8 x i8], ptr %i.au, i64 %indvars.iv.next146
  %i.dd = load ptr, ptr %i.dc, align 8, !tbaa !58 ; 2 uses
  %i.de = getelementptr inbounds [8 x i8], ptr %i.b, i64 %indvars.iv.next146 ; 2 uses
  store ptr %i.dd, ptr %i.de, align 8, !tbaa !58
  %i.df = getelementptr i8, ptr %i.de, i64 -8
  %i.dg = load ptr, ptr %i.df, align 8, !tbaa !58
  %i.dh = load i16, ptr %i.dg, align 2, !tbaa !99
  store i16 %i.dh, ptr %i.dd, align 2, !tbaa !99
  %indvars.iv.next146.1 = add nsw i64 %indvars.iv145, 2 ; 2 uses
  %i.di = add nuw nsw i32 %.291.us, 2             ; 2 uses
  %exitcond148.not.1 = icmp eq i32 %i.di, %i.bh
...
._crit_edge94.us.loopexit:                        ; preds = %.lr.ph93.us, %.lr.ph93.us.prol.loopexit
  ...
  %5 = trunc nsw i64 %indvars.iv.next146.lcssa to i32
  br label %scalar.ph.a

scalar.ph.a:                                      ; preds = %._crit_edge94.us.loopexit, %..loopexit_crit_edge.us
  %.07485.us.a = phi i32 [ %.3.us, %..loopexit_crit_edge.us ], [ %5, %._crit_edge94.us.loopexit ] ; 2 uses
  %indvars.iv.next142.a = add nuw nsw i64 %indvars.iv149, 1 ; 2 uses
  %exitcond144.not.a = icmp eq i64 %indvars.iv.next142.a, %wide.trip.count
  br i1 %exitcond144.not.a, label %._crit_edge100, label %.lr.ph99.split.us, !llvm.loop !134

.lr.ph99.split:                                   ; preds = %.lr.ph99
  %i.dj = icmp sgt i32 %i.bh, 0
  br i1 %i.dj, label %.lr.ph99.split.split.us.preheader, label %._crit_edge100

.lr.ph99.split.split.us.preheader:                ; preds = %.lr.ph99.split
  %i.dk = sext i32 %.077117 to i64
  %xtraiter = and i32 %i.bh, 1
  %i.dl = icmp eq i32 %i.bh, 1
...
.lr.ph99.split.split.us:                          ; preds = %.lr.ph99.split.split.us.preheader, %._crit_edge94.us109
  %.07397.us102 = phi i32 [ %i.ee, %._crit_edge94.us109 ], [ 0, %.lr.ph99.split.split.us.preheader ]
  %.17896.us103 = phi i64 [ %indvars.iv.next138.lcssa, %._crit_edge94.us109 ], [ %i.dk, %.lr.ph99.split.split.us.preheader ] ; 2 uses
  br i1 %i.dl, label %.epil.preheader, label %.lr.ph99.split.split.us.new

.lr.ph99.split.split.us.new:                      ; preds = %.lr.ph99.split.split.us, %.lr.ph99.split.split.us.new
  %indvars.iv137 = phi i64 [ %indvars.iv.next138.1, %.lr.ph99.split.split.us.new ], [ %.17896.us103, %.lr.ph99.split.split.us ] ; 4 uses
  %niter = phi i32 [ %niter.next.1, %.lr.ph99.split.split.us.new ], [ 0, %.lr.ph99.split.split.us ]
  %i.dm = getelementptr inbounds [8 x i8], ptr %i.au, i64 %indvars.iv137
  %i.dn = load ptr, ptr %i.dm, align 8, !tbaa !58 ; 2 uses
  %i.do = getelementptr inbounds [8 x i8], ptr %i.b, i64 %indvars.iv137 ; 2 uses
  store ptr %i.dn, ptr %i.do, align 8, !tbaa !58
  %i.dp = getelementptr i8, ptr %i.do, i64 -8
  %i.dq = load ptr, ptr %i.dp, align 8, !tbaa !58
  %i.dr = load i16, ptr %i.dq, align 2, !tbaa !99
  store i16 %i.dr, ptr %i.dn, align 2, !tbaa !99
  %indvars.iv.next138 = add nsw i64 %indvars.iv137, 1 ; 2 uses
  %i.ds = getelementptr inbounds [8 x i8], ptr %i.au, i64 %indvars.iv.next138
  %i.dt = load ptr, ptr %i.ds, align 8, !tbaa !58 ; 2 uses
  %i.du = getelementptr inbounds [8 x i8], ptr %i.b, i64 %indvars.iv.next138 ; 2 uses
  store ptr %i.dt, ptr %i.du, align 8, !tbaa !58
  %i.dv = getelementptr i8, ptr %i.du, i64 -8
  %i.dw = load ptr, ptr %i.dv, align 8, !tbaa !58
  %i.dx = load i16, ptr %i.dw, align 2, !tbaa !99
  store i16 %i.dx, ptr %i.dt, align 2, !tbaa !99
  %indvars.iv.next138.1 = add nsw i64 %indvars.iv137, 2 ; 3 uses
...
.epil.preheader:                                  ; preds = %._crit_edge94.us109.unr-lcssa, %.lr.ph99.split.split.us
  %indvars.iv137.epil.init = phi i64 [ %.17896.us103, %.lr.ph99.split.split.us ], [ %indvars.iv.next138.1, %._crit_edge94.us109.unr-lcssa ] ; 3 uses
  call void @llvm.assume(i1 %lcmp.mod190)
  %i.dy = getelementptr inbounds [8 x i8], ptr %i.au, i64 %indvars.iv137.epil.init
  %i.dz = load ptr, ptr %i.dy, align 8, !tbaa !58 ; 2 uses
  %i.ea = getelementptr inbounds [8 x i8], ptr %i.b, i64 %indvars.iv137.epil.init ; 2 uses
  store ptr %i.dz, ptr %i.ea, align 8, !tbaa !58
  %i.eb = getelementptr i8, ptr %i.ea, i64 -8
  %i.ec = load ptr, ptr %i.eb, align 8, !tbaa !58
  %i.ed = load i16, ptr %i.ec, align 2, !tbaa !99
  store i16 %i.ed, ptr %i.dz, align 2, !tbaa !99
  %indvars.iv.next138.epil = add nsw i64 %indvars.iv137.epil.init, 1
  br label %._crit_edge94.us109

._crit_edge94.us109:                              ; preds = %._crit_edge94.us109.unr-lcssa, %.epil.preheader
  %indvars.iv.next138.lcssa = phi i64 [ %indvars.iv.next138.1, %._crit_edge94.us109.unr-lcssa ], [ %indvars.iv.next138.epil, %.epil.preheader ] ; 2 uses
  %i.ee = add nuw nsw i32 %.07397.us102, 1        ; 2 uses
  %exitcond140.not = icmp eq i32 %i.ee, %i.bn
  br i1 %exitcond140.not, label %._crit_edge100.loopexit128, label %.lr.ph99.split.split.us, !llvm.loop !134

._crit_edge100.loopexit128:                       ; preds = %._crit_edge94.us109
  %i.ef = trunc nsw i64 %indvars.iv.next138.lcssa to i32
  br label %._crit_edge100

._crit_edge100:                                   ; preds = %scalar.ph.a, %.lr.ph99.split, %._crit_edge100.loopexit128, %bb.f
  %.178.lcssa = phi i32 [ %.077117, %bb.f ], [ %i.ef, %._crit_edge100.loopexit128 ], [ %.077117, %.lr.ph99.split ], [ %.07485.us.a, %scalar.ph.a ]
...
._crit_edge120:                                   ; preds = %._crit_edge100, %.preheader
  %i.eg = load ptr, ptr %i.av, align 8, !tbaa !136
  %i.eh = getelementptr inbounds nuw i8, ptr %i.eg, i64 8
  %i.ei = load ptr, ptr %i.eh, align 8, !tbaa !137
  %i.ej = call i32 %i.ei(ptr noundef nonnull %0, ptr noundef nonnull %i.b) #4
  %.not = icmp eq i32 %i.ej, 0
  br i1 %.not, label %bb.h, label %bb.i

bb.h:                                             ; preds = %._crit_edge120
  %i.ek = trunc nsw i64 %indvars.iv158 to i32
  store i32 %i.ek, ptr %i.am, align 8, !tbaa !117
  store i32 %.071121, ptr %i.ar, align 4, !tbaa !116
  br label %bb.n

bb.i:                                             ; preds = %._crit_edge120
  %i.el = add nuw i32 %.071121, 1                 ; 2 uses
  %i.em = load i32, ptr %i.e, align 8, !tbaa !118 ; 2 uses
  %i.en = icmp ult i32 %i.el, %i.em
  br i1 %i.en, label %.preheader, label %._crit_edge122.loopexit, !llvm.loop !139
...
._crit_edge122:                                   ; preds = %._crit_edge122.loopexit, %bb.c
  %i.eo = phi i32 [ %.pre162, %._crit_edge122.loopexit ], [ %i.ax, %bb.c ] ; 2 uses
  %i.ep = phi i32 [ %i.em, %._crit_edge122.loopexit ], [ %i.ay, %bb.c ]
  store i32 0, ptr %i.ar, align 4, !tbaa !116
  %indvars.iv.next159 = add nsw i64 %indvars.iv158, 1 ; 2 uses
  %i.eq = sext i32 %i.eo to i64
  %i.er = icmp slt i64 %indvars.iv.next159, %i.eq
  br i1 %i.er, label %bb.c, label %._crit_edge126.loopexit, !llvm.loop !140
...
._crit_edge126:                                   ; preds = %._crit_edge126.loopexit, %._crit_edge
  %i.es = phi i32 [ %.pre163, %._crit_edge126.loopexit ], [ %i.al, %._crit_edge ]
  %i.et = getelementptr inbounds nuw i8, ptr %i.d, i64 32 ; 2 uses
  %i.eu = load i32, ptr %i.et, align 8, !tbaa !110
  %i.ev = add i32 %i.eu, 1
  store i32 %i.ev, ptr %i.et, align 8, !tbaa !110
  %i.ew = load ptr, ptr %i.c, align 8, !tbaa !49  ; 5 uses
  %i.ex = icmp sgt i32 %i.es, 1
  br i1 %i.ex, label %bb.j, label %bb.k

bb.j:                                             ; preds = %._crit_edge126
  %i.ey = getelementptr inbounds nuw i8, ptr %i.ew, i64 44
  store i32 1, ptr %i.ey, align 4, !tbaa !112
  br label %start_iMCU_row.exit

bb.k:                                             ; preds = %._crit_edge126
  %i.ez = getelementptr inbounds nuw i8, ptr %i.ew, i64 32
  %i.fa = load i32, ptr %i.ez, align 8, !tbaa !110
  %i.fb = load i32, ptr %i.h, align 4, !tbaa !113
  %i.fc = add i32 %i.fb, -1
  %i.fd = icmp ult i32 %i.fa, %i.fc
  %i.fe = getelementptr inbounds nuw i8, ptr %0, i64 376
  %i.ff = load ptr, ptr %i.fe, align 8, !tbaa !88 ; 2 uses
  %i.fg = getelementptr inbounds nuw i8, ptr %i.ew, i64 44 ; 2 uses
  br i1 %i.fd, label %bb.l, label %bb.m

bb.l:                                             ; preds = %bb.k
  %i.fh = getelementptr inbounds nuw i8, ptr %i.ff, i64 12
  %i.fi = load i32, ptr %i.fh, align 4, !tbaa !114
  store i32 %i.fi, ptr %i.fg, align 4, !tbaa !112
  br label %start_iMCU_row.exit

bb.m:                                             ; preds = %bb.k
  %i.fj = getelementptr inbounds nuw i8, ptr %i.ff, i64 76
  %i.fk = load i32, ptr %i.fj, align 4, !tbaa !115
  store i32 %i.fk, ptr %i.fg, align 4, !tbaa !112
  br label %start_iMCU_row.exit

start_iMCU_row.exit:                              ; preds = %bb.j, %bb.l, %bb.m
  %i.fl = getelementptr inbounds nuw i8, ptr %i.ew, i64 36
  store i32 0, ptr %i.fl, align 4, !tbaa !116
  %i.fm = getelementptr inbounds nuw i8, ptr %i.ew, i64 40
  store i32 0, ptr %i.fm, align 8, !tbaa !117
  br label %bb.n
...
!88 = !{!10, !10, i64 0}
!89 = !{!90, !4, i64 128}
!90 = !{!"", !5, i64 0, !4, i64 128}
!91 = !{!67, !4, i64 56}
!92 = !{!8, !4, i64 92}
!93 = !{!8, !10, i64 104}
!94 = !{!67, !10, i64 304}
!95 = !{!96, !4, i64 0}
!96 = !{!"", !4, i64 0, !4, i64 4, !4, i64 8, !4, i64 12, !4, i64 16, !4, i64 20, !4, i64 24, !4, i64 28, !4, i64 32, !4, i64 36, !4, i64 40, !4, i64 44, !4, i64 48, !4, i64 52, !4, i64 56, !4, i64 60, !4, i64 64, !4, i64 68, !4, i64 72, !4, i64 76, !10, i64 80, !10, i64 88}
!97 = !{!96, !4, i64 16}
!98 = !{!96, !10, i64 80}
!99 = !{!15, !15, i64 0}
...
!120 = !{!96, !4, i64 4}
!121 = !{!122, !122, i64 0}
!122 = !{!"p1 _ZTS20jvirt_barray_control", !10, i64 0}
!123 = !{!124, !124, i64 0}
!124 = !{!"p2 short", !33, i64 0}
!125 = distinct !{!125, !101}
!126 = !{!96, !4, i64 56}
!127 = !{!96, !4, i64 72}
!128 = !{!96, !4, i64 60}
!129 = distinct !{!129, !101, !130, !131}
!130 = !{!"llvm.loop.isvectorized", i32 1}
!131 = !{!"llvm.loop.unroll.runtime.disable"}
!132 = distinct !{!132, !101, !131, !130}
!133 = distinct !{!133, !101}
!134 = distinct !{!134, !101}
!135 = distinct !{!135, !101}
!136 = !{!8, !25, i64 560}
!137 = !{!138, !10, i64 8}
!138 = !{!"jpeg_entropy_encoder", !10, i64 0, !10, i64 8, !10, i64 16, !10, i64 24}
