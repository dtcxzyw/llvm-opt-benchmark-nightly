begin_hunk_0
  ...
  %.not.i51 = icmp eq i32 %151, 0
  %152 = select i1 %or.cond.i50, i1 %.not.i51, i1 false
...
115:                                              ; preds = %113
  %116 = load i32, ptr %4, align 4, !tbaa !176    ; 2 uses
...
230:                                              ; preds = %228
  %231 = load i32, ptr %4, align 4, !tbaa !176    ; 2 uses
