...
.preheader.lr.ph:                                 ; preds = %bb.dz
  ...
  br i1 %i.rz, label %.preheader.us, label %.preheader.us.preheader

.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  %min.iters.check310 = icmp ult i32 %i.pz, 4
  br i1 %min.iters.check310, label %.preheader.preheader322, label %.preheader.preheader

.preheader.preheader:                             ; preds = %.preheader.us.preheader
  %20 = add nsw i64 %wide.trip.count188, -1       ; 2 uses
  ...
  %25 = or i1 %23, %24
  br i1 %25, label %.preheader.preheader322, label %vector.ph306

vector.ph306:                                     ; preds = %.preheader.preheader
  %n.vec308 = and i64 %wide.trip.count188, 2147483644 ; 4 uses
  %26 = trunc nuw nsw i64 %n.vec308 to i32
  %27 = mul i32 %26, 3
...
vector.body309:                                   ; preds = %vector.body309, %vector.ph306
  ...
  %sext = mul i64 %index310, 12884901888
  ...
  %i.sp = getelementptr inbounds nuw i8, ptr %i.sd, i64 %28
...
.preheader.preheader322:                          ; preds = %.preheader.preheader, %.preheader.us.preheader, %middle.block315
  %indvars.iv181.ph = phi i64 [ 0, %.preheader.preheader ], [ 0, %.preheader.us.preheader ], [ %n.vec308, %middle.block315 ]
  %indvars.iv.ph = phi i32 [ 0, %.preheader.preheader ], [ 0, %.preheader.us.preheader ], [ %27, %middle.block315 ]
...
.preheader.us:                                    ; preds = %.preheader.lr.ph, %.preheader.us
  %niter = phi i64 [ %indvars.iv.next186.1, %.preheader.us ], [ 0, %.preheader.lr.ph ] ; 4 uses
  %indvars.iv184 = phi i32 [ %indvars.iv.next185, %.preheader.us ], [ 0, %.preheader.lr.ph ] ; 2 uses
  %29 = sext i32 %indvars.iv184 to i64            ; 3 uses
  %i.tb = load ptr, ptr @imath_half_to_float_table, align 8 ; 3 uses
  %i.tc = getelementptr inbounds nuw [2 x i8], ptr %.pre192, i64 %niter
  ...
  %i.th = getelementptr inbounds nuw [4 x i8], ptr %i.sd, i64 %29
  store float %i.tg, ptr %i.th, align 4, !tbaa !137
  %i.ti = getelementptr inbounds nuw [2 x i8], ptr %i.si, i64 %niter
  ...
  %i.tn = getelementptr [4 x i8], ptr %i.sd, i64 %29
  %i.to = getelementptr i8, ptr %i.tn, i64 4
  store float %i.tm, ptr %i.to, align 4, !tbaa !137
  %i.tp = getelementptr inbounds nuw [2 x i8], ptr %i.sl, i64 %niter
  ...
  %i.tu = getelementptr [4 x i8], ptr %i.sd, i64 %29
  %i.tv = getelementptr i8, ptr %i.tu, i64 8
  store float %i.tt, ptr %i.tv, align 4, !tbaa !137
  %indvars.iv.next186.1 = add nuw nsw i64 %niter, 1 ; 2 uses
  %indvars.iv.next185 = add i32 %indvars.iv184, 3
  %niter.ncmp.1 = icmp eq i64 %indvars.iv.next186.1, %wide.trip.count188
  br i1 %niter.ncmp.1, label %.preheader13.i.i, label %.preheader.us, !llvm.loop !140

.preheader:                                       ; preds = %.preheader.preheader322, %.preheader
  %indvars.iv.a = phi i64 [ %indvars.iv.next.2, %.preheader ], [ %indvars.iv181.ph, %.preheader.preheader322 ] ; 4 uses
  %indvars.iv = phi i32 [ %indvars.iv.next, %.preheader ], [ %indvars.iv.ph, %.preheader.preheader322 ] ; 2 uses
  ...
  %i.ty = getelementptr inbounds nuw [4 x i8], ptr %i.sd, i64 %30
  ...
  %i.uj = getelementptr [4 x i8], ptr %i.sd, i64 %30
  ...
  %exitcond.not = icmp eq i64 %indvars.iv.next.2, %wide.trip.count188
...
.preheader13.i.i:                                 ; preds = %.preheader, %.preheader.us, %middle.block315, %._crit_edge
  %31 = phi ptr [ %.pre193, %._crit_edge ], [ %i.sc, %middle.block315 ], [ %i.sc, %.preheader.us ], [ %i.sc, %.preheader ]
...
._crit_edge19.i.i:                                ; preds = %._crit_edge19.loopexit.i.i, %.preheader13.i.i
  %i.un = phi ptr [ %.pre25.i.i, %._crit_edge19.loopexit.i.i ], [ %31, %.preheader13.i.i ]
