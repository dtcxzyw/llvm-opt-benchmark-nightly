...
bb.a:
  ...
  %2 = alloca %"struct.YAML::ScanScalarParams", align 8 ; 15 uses
...
begin_hunk_1
  ...
  store i32 0, ptr %i.e, align 4, !tbaa !139
  %i.f = getelementptr inbounds nuw i8, ptr %2, i64 24 ; 2 uses
  store i8 0, ptr %i.f, align 8, !tbaa !140
  %i.g = getelementptr inbounds nuw i8, ptr %2, i64 28 ; 2 uses
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(7) %i.d, i8 0, i64 7, i1 false)
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(13) %i.g, i8 0, i64 13, i1 false)
...
bb.g:                                             ; preds = %bb.d, %bb.f
  ...
  store i32 %i.s, ptr %i.d, align 4, !tbaa !141
  store i32 2, ptr %i.e, align 4, !tbaa !139
  %i.t = getelementptr inbounds nuw i8, ptr %2, i64 17
  store i8 1, ptr %i.t, align 1, !tbaa !142
  store i8 1, ptr %i.f, align 8, !tbaa !140
  store i32 -1, ptr %i.g, align 4, !tbaa !143
...
begin_hunk_3
  ...
  store i8 0, ptr %i.h, align 8, !tbaa !140
...
begin_hunk_4
  ...
  store i32 2, ptr %i.g, align 4, !tbaa !139
  %i.aa = getelementptr inbounds nuw i8, ptr %2, i64 17
  store i8 1, ptr %i.aa, align 1, !tbaa !142
  store i8 0, ptr %i.h, align 8, !tbaa !140
...
begin_hunk_5
  ...
  store i32 1, ptr %i.d, align 4, !tbaa !141
...
begin_hunk_6
  ...
  store i32 %i.n, ptr %i.l, align 4, !tbaa !139
...
bb.w:                                             ; preds = %bb.q
  ...
  store i32 %i.at, ptr %i.d, align 4, !tbaa !141
...
bb.bk:                                            ; preds = %bb.bj
  %i.co = load i32, ptr %i.d, align 4, !tbaa !141
  %i.cp = add nsw i32 %i.co, %i.cn
  store i32 %i.cp, ptr %i.d, align 4, !tbaa !141
  br label %bb.bl

bb.bl:                                            ; preds = %bb.bk, %bb.bi
  %i.cq = getelementptr inbounds nuw i8, ptr %8, i64 17
  store i8 0, ptr %i.cq, align 1, !tbaa !142
  store i8 0, ptr %i.e, align 8, !tbaa !140
