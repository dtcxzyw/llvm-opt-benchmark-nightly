...
bb.a:
  ...
  %7 = alloca %struct._G_fpos_t, align 8          ; 9 uses
...
bb.r:                                             ; preds = %bb.q
  br i1 %i.bl, label %bb.t, label %_ZNSt6vectorI9_G_fpos_tSaIS0_EE9push_backERKS0_.exit44
...
_ZNSt6vectorI9_G_fpos_tSaIS0_EE9push_backERKS0_.exit44: ; preds = %bb.r, %_ZNSt6vectorI9_G_fpos_tSaIS0_EE17_M_realloc_insertIJRKS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i41, %bb.aa
  %.0 = phi i1 [ %i.cp, %_ZNSt6vectorI9_G_fpos_tSaIS0_EE17_M_realloc_insertIJRKS0_EEEvN9__gnu_cxx17__normal_iteratorIPS0_S2_EEDpOT_.exit.i41 ], [ %i.cp, %bb.aa ], [ false, %bb.r ]
  call void @llvm.lifetime.end.p0(ptr nonnull %7) #31
  %spec.select = and i1 %i.bl, %.0
...
begin_hunk_5
  ...
  br i1 %.not100, label %.lr.ph.i.preheader, label %.critedge.thread
...
begin_hunk_6
  ...
  br i1 %.not104, label %.preheader126, label %.critedge.thread
...
begin_hunk_7
  ...
  br i1 %.not102, label %..critedge_crit_edge, label %.critedge.thread

..critedge_crit_edge:                             ; preds = %bb.p
  %.pre = zext i16 %i.bo to i64
  br label %.critedge

.critedge.thread:                                 ; preds = %bb.p, %bb.k, %bb.n
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b) #31
  br label %.loopexit
...
.loopexit:                                        ; preds = %bb.b, %bb.i, %.thread120, %bb.h, %bb.a, %.critedge.thread
  %i.es = phi i1 [ false, %bb.h ], [ false, %.critedge.thread ], [ true, %bb.a ], [ false, %bb.b ], [ false, %bb.i ], [ true, %.thread120 ]
