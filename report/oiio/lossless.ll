...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %6 = and i32 %i.l, 255
  %7 = and i32 %4, 255
  %8 = insertelement <4 x i32> poison, i32 %i.j, i64 0
  %i.q = insertelement <4 x i32> %8, i32 %i.n, i64 1
  %i.r = insertelement <4 x i32> %i.q, i32 %i.m, i64 2
  %i.s = insertelement <4 x i32> %i.r, i32 %5, i64 3
  %9 = and <4 x i32> %i.s, <i32 255, i32 255, i32 255, i32 -1>
