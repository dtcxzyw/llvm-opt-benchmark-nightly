...
bb.a:
  ...
  %2 = icmp ult i32 %i.i, 256
  %3 = xor i32 %i.i, -1
  %4 = lshr i32 %3, 24
  %.0.i.i.i = select i1 %2, i32 %i.i, i32 %4
  %i.j = lshr i32 %i.a, 16
  %i.k = and i32 %i.j, 255
  %i.l = lshr i32 %i.b, 16
  %i.m = and i32 %i.l, 255
  ...
  %6 = xor i32 %i.q, -1
  %7 = lshr i32 %6, 24
  %.0.i.i16.i = select i1 %5, i32 %i.q, i32 %7
  %i.r = lshr i32 %i.a, 8
  %i.s = and i32 %i.r, 255
  %i.t = lshr i32 %i.b, 8
  %i.u = and i32 %i.t, 255
  ...
  %8 = icmp ult i32 %i.y, 256
  %9 = xor i32 %i.y, -1
  %10 = lshr i32 %9, 24
  %.0.i.i17.i = select i1 %8, i32 %i.y, i32 %10
  %i.z = and i32 %i.a, 255
  %i.aa = and i32 %i.b, 255
  %i.ab = and i32 %i.d, 255
  %i.ac = add nuw nsw i32 %i.aa, %i.z
  %i.ad = sub nsw i32 %i.ac, %i.ab                ; 3 uses
  %11 = icmp ult i32 %i.ad, 256
  %12 = xor i32 %i.ad, -1
  %13 = lshr i32 %12, 24
  %.0.i.i18.i = select i1 %11, i32 %i.ad, i32 %13
...
bb.a:
  ...
  %2 = icmp ult <4 x i32> %i.aj, splat (i32 256)
  %3 = xor <4 x i32> %i.aj, splat (i32 -1)
  %4 = lshr <4 x i32> %3, splat (i32 24)
  %i.ak = select <4 x i1> %2, <4 x i32> %i.aj, <4 x i32> %4
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %4 = icmp ult i32 %i.k, 256
  %5 = xor i32 %i.k, -1
  %6 = lshr i32 %5, 24
  %.0.i.i.i.i = select i1 %4, i32 %i.k, i32 %6
  ...
  %7 = icmp ult i32 %i.s, 256
  %8 = xor i32 %i.s, -1
  %9 = lshr i32 %8, 24
  %.0.i.i16.i.i = select i1 %7, i32 %i.s, i32 %9
  ...
  %10 = icmp ult i32 %i.aa, 256
  %11 = xor i32 %i.aa, -1
  %12 = lshr i32 %11, 24
  %.0.i.i17.i.i = select i1 %10, i32 %i.aa, i32 %12
  ...
  %13 = icmp ult i32 %i.af, 256
  %14 = xor i32 %i.af, -1
  %15 = lshr i32 %14, 24
  %.0.i.i18.i.i = select i1 %13, i32 %i.af, i32 %15
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %4 = icmp ult <4 x i32> %i.ah, splat (i32 256)
  %5 = xor <4 x i32> %i.ah, splat (i32 -1)
  %6 = lshr <4 x i32> %5, splat (i32 24)
  %i.ai = select <4 x i1> %4, <4 x i32> %i.ah, <4 x i32> %6
