begin_hunk_0
  ...
  %i.dp = icmp ne <4 x i32> %wide.load114.fr, zeroinitializer ; 2 uses
...
begin_hunk_1
  ...
  %i.ds = icmp ne <4 x i32> %wide.load114.fr.1, zeroinitializer ; 2 uses
...
begin_hunk_2
  ...
  %i.dv = icmp ne <4 x i32> %wide.load114.fr.2, zeroinitializer ; 2 uses
...
begin_hunk_3
  ...
  %i.dy = icmp ne <4 x i32> %wide.load114.fr.3, zeroinitializer ; 2 uses
