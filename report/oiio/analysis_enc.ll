begin_hunk_0
  ...
  %130 = icmp ne <4 x i32> %wide.load114, zeroinitializer ; 2 uses
...
begin_hunk_1
  ...
  %133 = icmp ne <4 x i32> %wide.load114.1, zeroinitializer ; 2 uses
...
begin_hunk_2
  ...
  %136 = icmp ne <4 x i32> %wide.load114.2, zeroinitializer ; 2 uses
...
begin_hunk_3
  ...
  %139 = icmp ne <4 x i32> %wide.load114.3, zeroinitializer ; 2 uses
