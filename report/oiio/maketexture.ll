...
_ZN11OpenImageIO4v3_114latlong_to_dirEffb.exit:   ; preds = %bb.l, %bb.k
  %.sink13.i = phi float [ %7, %bb.k ], [ %12, %bb.l ] ; 2 uses
  %.sink.i.a = phi float [ %5, %bb.k ], [ %i.bo, %bb.l ] ; 2 uses
  %cos.i.sink.i = phi float [ %i.bn, %bb.k ], [ %5, %bb.l ]
...
_ZN11OpenImageIO4v3_114latlong_to_dirEffb.exit:   ; preds = %bb.k, %bb.j
  %.sink13.i = phi float [ %7, %bb.j ], [ %12, %bb.k ] ; 2 uses
  %.sink.i.a = phi float [ %5, %bb.j ], [ %i.bn, %bb.k ] ; 2 uses
  %cos.i.sink.i = phi float [ %i.bm, %bb.j ], [ %5, %bb.k ]
