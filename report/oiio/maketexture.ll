...
bb.d:                                             ; preds = %._crit_edge103
  ...
  %spec.select.i81.a = tail call i32 @llvm.smax.i32(i32 %i.bc, i32 %i.bh)
  %.1.i82.a = tail call i32 @llvm.smin.i32(i32 %spec.select.i81.a, i32 %i.bg)
  %spec.select.i = tail call i32 @llvm.smax.i32(i32 %i.bc, i32 %i.ag)
  %.1.i = tail call i32 @llvm.smin.i32(i32 %spec.select.i, i32 %i.bg)
  %7 = fsub float 1.000000e+00, %i.ah
  %8 = sitofp i32 %.1.i to float
  %9 = fadd nnan float %8, 5.000000e-01
  %10 = fmul nnan float %9, f0x40490FDB
  %11 = fdiv float %10, %i.n
  %12 = tail call float @llvm.sin.f32(float %11)
  %13 = fmul float %7, %12
  %14 = sitofp i32 %.1.i82.a to float
  %15 = fadd nnan float %14, 5.000000e-01
  %16 = fmul nnan float %15, f0x40490FDB
  %17 = fdiv float %16, %i.n
  %18 = tail call float @llvm.sin.f32(float %17)
  %19 = fmul float %i.ah, %18                     ; 2 uses
  %20 = fadd float %13, %19
  %i.bi = fdiv float %19, %20
  br label %bb.e
...
bb.d:                                             ; preds = %._crit_edge103
  ...
  %spec.select.i81.a = tail call i32 @llvm.smax.i32(i32 %i.cy, i32 %i.dd)
  %.1.i82.a = tail call i32 @llvm.smin.i32(i32 %spec.select.i81.a, i32 %i.dc)
...
bb.ab:                                            ; preds = %._crit_edge115
  ...
  %spec.select.i81.a = tail call i32 @llvm.smax.i32(i32 %i.ds, i32 %i.dx)
  %.1.i82.a = tail call i32 @llvm.smin.i32(i32 %spec.select.i81.a, i32 %i.dw)
  %spec.select.i = tail call i32 @llvm.smax.i32(i32 %i.ds, i32 %i.ag)
  %.1.i = tail call i32 @llvm.smin.i32(i32 %spec.select.i, i32 %i.dw)
  %7 = fsub float 1.000000e+00, %i.ah
  %8 = sitofp i32 %.1.i to float
  %9 = fadd nnan float %8, 5.000000e-01
  %10 = fmul nnan float %9, f0x40490FDB
...
bb.d:                                             ; preds = %._crit_edge103
  ...
  %spec.select.i81.a = tail call i32 @llvm.smax.i32(i32 %i.cm, i32 %i.cr)
  %.1.i82.a = tail call i32 @llvm.smin.i32(i32 %spec.select.i81.a, i32 %i.cq)
