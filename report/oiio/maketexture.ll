...
_ZN11OpenImageIO4v3_114latlong_to_dirEffb.exit:   ; preds = %bb.l, %bb.k
  %.sink13.i = phi float [ %4, %bb.k ], [ %7, %bb.l ] ; 2 uses
  %.sink.i.a = phi float [ %cos.i.i, %bb.k ], [ %i.bo, %bb.l ] ; 2 uses
  %cos.i.sink.i = phi float [ %i.bn, %bb.k ], [ %cos.i.i, %bb.l ]
  %i.bp = call float @llvm.acos.f32(float %cos.i.sink.i)
...
_ZN11OpenImageIO4v3_114latlong_to_dirEffb.exit:   ; preds = %bb.k, %bb.j
  %.sink13.i = phi float [ %4, %bb.j ], [ %7, %bb.k ] ; 2 uses
  %.sink.i.a = phi float [ %cos.i.i, %bb.j ], [ %i.bn, %bb.k ] ; 2 uses
  %cos.i.sink.i = phi float [ %i.bm, %bb.j ], [ %cos.i.i, %bb.k ]
  %i.bo = call float @llvm.acos.f32(float %cos.i.sink.i)
