Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/oiio/original/jcsample-12?download=true
inline.NumInlined: 6
inline.NumDeleted: 1
...
.lr.ph.new:                                       ; preds = %.lr.ph, %.lr.ph.new
  ...
  %i.cc = add nsw i32 %i.bt, 2
  %i.cd = add nsw i32 %i.cc, %i.bw
  %i.ce = add nsw i32 %i.cd, %i.by
...
.preheader.lr.ph.us.us:                           ; preds = %.preheader.lr.ph.us.us.preheader, %._crit_edge.split.us.split.us.us.us
  ...
  %i.bf = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv95
...
.preheader.us.us.us.us:                           ; preds = %._crit_edge56.split.us.us.us.us.us, %.preheader.lr.ph.us.us
  %.04260.us.us.us.us = phi ptr [ %i.bg, %.preheader.lr.ph.us.us ], [ %i.cx, %._crit_edge56.split.us.us.us.us.us ] ; 2 uses
  %.04459.us.us.us.us = phi i32 [ 0, %.preheader.lr.ph.us.us ], [ %i.cz, %._crit_edge56.split.us.us.us.us.us ] ; 2 uses
  %.04558.us.us.us.us = phi i32 [ 0, %.preheader.lr.ph.us.us ], [ %i.cy, %._crit_edge56.split.us.us.us.us.us ]
  %i.bh = zext i32 %.04459.us.us.us.us to i64
...
.lr.ph.us.us.us.us.us:                            ; preds = %._crit_edge.us.us.us.us.us, %.preheader.us.us.us.us
  ...
  %i.bi = load ptr, ptr %gep, align 8, !tbaa !64
  %i.bj = getelementptr inbounds nuw [2 x i8], ptr %i.bi, i64 %i.bh ; 2 uses
  br i1 %i.be, label %.epil.preheader, label %.lr.ph.us.us.us.us.us.new

.lr.ph.us.us.us.us.us.new:                        ; preds = %.lr.ph.us.us.us.us.us, %.lr.ph.us.us.us.us.us.new
  %.152.us.us.us.us.us = phi i64 [ %i.cp, %.lr.ph.us.us.us.us.us.new ], [ %.054.us.us.us.us.us, %.lr.ph.us.us.us.us.us ]
  %.04351.us.us.us.us.us = phi ptr [ %i.cm, %.lr.ph.us.us.us.us.us.new ], [ %i.bj, %.lr.ph.us.us.us.us.us ] ; 9 uses
  %niter = phi i32 [ %niter.next.7, %.lr.ph.us.us.us.us.us.new ], [ 0, %.lr.ph.us.us.us.us.us ]
  %i.bk = getelementptr inbounds nuw i8, ptr %.04351.us.us.us.us.us, i64 2
  %i.bl = load i16, ptr %.04351.us.us.us.us.us, align 2, !tbaa !66
  %i.bm = sext i16 %i.bl to i64
  %i.bn = add nsw i64 %.152.us.us.us.us.us, %i.bm
  %i.bo = getelementptr inbounds nuw i8, ptr %.04351.us.us.us.us.us, i64 4
  %i.bp = load i16, ptr %i.bk, align 2, !tbaa !66
  %i.bq = sext i16 %i.bp to i64
  %i.br = add nsw i64 %i.bn, %i.bq
  %i.bs = getelementptr inbounds nuw i8, ptr %.04351.us.us.us.us.us, i64 6
  %i.bt = load i16, ptr %i.bo, align 2, !tbaa !66
  %i.bu = sext i16 %i.bt to i64
  %i.bv = add nsw i64 %i.br, %i.bu
  %i.bw = getelementptr inbounds nuw i8, ptr %.04351.us.us.us.us.us, i64 8
  %i.bx = load i16, ptr %i.bs, align 2, !tbaa !66
  %i.by = sext i16 %i.bx to i64
  %i.bz = add nsw i64 %i.bv, %i.by
  %i.ca = getelementptr inbounds nuw i8, ptr %.04351.us.us.us.us.us, i64 10
  %i.cb = load i16, ptr %i.bw, align 2, !tbaa !66
  %i.cc = sext i16 %i.cb to i64
  %i.cd = add nsw i64 %i.bz, %i.cc
  %i.ce = getelementptr inbounds nuw i8, ptr %.04351.us.us.us.us.us, i64 12
  %i.cf = load i16, ptr %i.ca, align 2, !tbaa !66
  %i.cg = sext i16 %i.cf to i64
  %i.ch = add nsw i64 %i.cd, %i.cg
  %i.ci = getelementptr inbounds nuw i8, ptr %.04351.us.us.us.us.us, i64 14
  %i.cj = load i16, ptr %i.ce, align 2, !tbaa !66
  %i.ck = sext i16 %i.cj to i64
  %i.cl = add nsw i64 %i.ch, %i.ck
  %i.cm = getelementptr inbounds nuw i8, ptr %.04351.us.us.us.us.us, i64 16 ; 2 uses
...
.epil.preheader:                                  ; preds = %._crit_edge.us.us.us.us.us.unr-lcssa, %.lr.ph.us.us.us.us.us
  %.152.us.us.us.us.us.epil.init = phi i64 [ %.054.us.us.us.us.us, %.lr.ph.us.us.us.us.us ], [ %i.cp, %._crit_edge.us.us.us.us.us.unr-lcssa ]
  %.04351.us.us.us.us.us.epil.init = phi ptr [ %i.bj, %.lr.ph.us.us.us.us.us ], [ %i.cm, %._crit_edge.us.us.us.us.us.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod191)
  br label %bb.b

bb.b:                                             ; preds = %bb.b, %.epil.preheader
  %.152.us.us.us.us.us.epil = phi i64 [ %.152.us.us.us.us.us.epil.init, %.epil.preheader ], [ %i.ct, %bb.b ]
  %.04351.us.us.us.us.us.epil = phi ptr [ %.04351.us.us.us.us.us.epil.init, %.epil.preheader ], [ %i.cq, %bb.b ] ; 2 uses
  %epil.iter = phi i32 [ 0, %.epil.preheader ], [ %epil.iter.next, %bb.b ]
  %i.cq = getelementptr inbounds nuw i8, ptr %.04351.us.us.us.us.us.epil, i64 2
  %i.cr = load i16, ptr %.04351.us.us.us.us.us.epil, align 2, !tbaa !66
  %i.cs = sext i16 %i.cr to i64
  %i.ct = add nsw i64 %.152.us.us.us.us.us.epil, %i.cs ; 2 uses
  %epil.iter.next = add i32 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i32 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %._crit_edge.us.us.us.us.us, label %bb.b, !llvm.loop !122
...
._crit_edge56.split.us.us.us.us.us:               ; preds = %._crit_edge.us.us.us.us.us
  ...
  %i.cv = sdiv i64 %i.cu, %i.bb
  %i.cw = trunc i64 %i.cv to i16
  %i.cx = getelementptr inbounds nuw i8, ptr %.04260.us.us.us.us, i64 2
  store i16 %i.cw, ptr %.04260.us.us.us.us, align 2, !tbaa !66
  %i.cy = add nuw i32 %.04558.us.us.us.us, 1      ; 2 uses
  %i.cz = add i32 %.04459.us.us.us.us, %i.m
  %exitcond94.not = icmp eq i32 %i.cy, %i.h
...
.lr.ph.split.split.us.split:                      ; preds = %.lr.ph.split.split.us
  ...
  %n.vec161 = and i64 %i.dc, 4294967280           ; 5 uses
  %i.de = shl nuw nsw i64 %n.vec161, 1
  %i.df = trunc nuw i64 %n.vec161 to i32
  %broadcast.splatinsert162 = insertelement <8 x i16> poison, i16 %i.db, i64 0
  %broadcast.splat163 = shufflevector <8 x i16> %broadcast.splatinsert162, <8 x i16> poison, <8 x i32> zeroinitializer ; 2 uses
  %cmp.n169 = icmp eq i64 %n.vec161, %i.dc
  %min.epilog.iters.check175 = icmp eq i64 %i.dd, 0
  %n.vec177 = and i64 %i.dc, 4294967292           ; 4 uses
  %i.dg = shl nuw nsw i64 %n.vec177, 1
  %i.dh = trunc nuw i64 %n.vec177 to i32
  %broadcast.splatinsert178 = insertelement <4 x i16> poison, i16 %i.db, i64 0
  %broadcast.splat179 = shufflevector <4 x i16> %broadcast.splatinsert178, <4 x i16> poison, <4 x i32> zeroinitializer
  %cmp.n185 = icmp eq i64 %n.vec177, %i.dc
...
iter.check172:                                    ; preds = %._crit_edge.split.us.split.us73, %.lr.ph.split.split.us.split
  ...
  %i.di = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv83
...
vector.body164:                                   ; preds = %vector.body164, %vector.ph160
  ...
  %i.dl = shl i64 %index165, 1
  %next.gep166 = getelementptr i8, ptr %i.dj, i64 %i.dl ; 2 uses
  %i.dm = getelementptr i8, ptr %next.gep166, i64 16
  store <8 x i16> %broadcast.splat163, ptr %next.gep166, align 2, !tbaa !66
  store <8 x i16> %broadcast.splat163, ptr %i.dm, align 2, !tbaa !66
  %index.next167 = add nuw i64 %index165, 16      ; 2 uses
  %i.dn = icmp eq i64 %index.next167, %n.vec161
  br i1 %i.dn, label %middle.block168, label %vector.body164, !llvm.loop !127
...
vec.epilog.vector.body180:                        ; preds = %vec.epilog.vector.body180, %vec.epilog.ph176
  ...
  %i.dp = shl i64 %index181, 1
  %next.gep182 = getelementptr i8, ptr %i.dj, i64 %i.dp
  store <4 x i16> %broadcast.splat179, ptr %next.gep182, align 2, !tbaa !66
  %index.next183 = add nuw i64 %index181, 4       ; 2 uses
  %i.dq = icmp eq i64 %index.next183, %n.vec177
  br i1 %i.dq, label %vec.epilog.middle.block184, label %vec.epilog.vector.body180, !llvm.loop !128
...
.preheader.us.us69.preheader:                     ; preds = %iter.check172, %vec.epilog.iter.check174, %vec.epilog.middle.block184
  %.04260.us.us70.ph = phi ptr [ %i.dj, %iter.check172 ], [ %i.dk, %vec.epilog.iter.check174 ], [ %i.do, %vec.epilog.middle.block184 ]
  %.04558.us.us72.ph = phi i32 [ 0, %iter.check172 ], [ %i.df, %vec.epilog.iter.check174 ], [ %i.dh, %vec.epilog.middle.block184 ]
  br label %.preheader.us.us69

.preheader.us.us69:                               ; preds = %.preheader.us.us69.preheader, %.preheader.us.us69
  %.04260.us.us70 = phi ptr [ %i.dr, %.preheader.us.us69 ], [ %.04260.us.us70.ph, %.preheader.us.us69.preheader ] ; 2 uses
  %.04558.us.us72 = phi i32 [ %i.ds, %.preheader.us.us69 ], [ %.04558.us.us72.ph, %.preheader.us.us69.preheader ]
  %i.dr = getelementptr inbounds nuw i8, ptr %.04260.us.us70, i64 2
  store i16 %i.db, ptr %.04260.us.us70, align 2, !tbaa !66
  %i.ds = add nuw i32 %.04558.us.us72, 1          ; 2 uses
  %exitcond82.not = icmp eq i32 %i.ds, %i.h
  br i1 %exitcond82.not, label %._crit_edge.split.us.split.us73, label %.preheader.us.us69, !llvm.loop !129
...
._crit_edge.split.us.split.us73:                  ; preds = %.preheader.us.us69, %vec.epilog.middle.block184, %middle.block168
  ...
  br i1 %exitcond87.not, label %._crit_edge68.split, label %iter.check172, !llvm.loop !126

.lr.ph.split.split:                               ; preds = %.lr.ph.split
  %i.dt = sdiv i64 %i.ba, %i.bb
  %i.du = trunc i64 %i.dt to i16                  ; 3 uses
  %wide.trip.count = zext nneg i32 %i.q to i64
  %i.dv = zext i32 %i.h to i64                    ; 5 uses
  %min.iters.check126 = icmp ult i32 %i.h, 4
  %min.iters.check128 = icmp ult i32 %i.h, 16
  %i.dw = and i64 %i.dv, 12
  %n.vec130 = and i64 %i.dv, 4294967280           ; 5 uses
  %i.dx = shl nuw nsw i64 %n.vec130, 1
  %i.dy = trunc nuw i64 %n.vec130 to i32
  %broadcast.splatinsert131 = insertelement <8 x i16> poison, i16 %i.du, i64 0
  %broadcast.splat132 = shufflevector <8 x i16> %broadcast.splatinsert131, <8 x i16> poison, <8 x i32> zeroinitializer ; 2 uses
  %cmp.n138 = icmp eq i64 %n.vec130, %i.dv
  %min.epilog.iters.check144 = icmp eq i64 %i.dw, 0
  %n.vec146 = and i64 %i.dv, 4294967292           ; 4 uses
  %i.dz = shl nuw nsw i64 %n.vec146, 1
  %i.ea = trunc nuw i64 %n.vec146 to i32
  %broadcast.splatinsert147 = insertelement <4 x i16> poison, i16 %i.du, i64 0
  %broadcast.splat148 = shufflevector <4 x i16> %broadcast.splatinsert147, <4 x i16> poison, <4 x i32> zeroinitializer
  %cmp.n154 = icmp eq i64 %n.vec146, %i.dv
...
iter.check141:                                    ; preds = %.lr.ph.split.split, %._crit_edge.split
  ...
  %i.eb = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %indvars.iv
  %i.ec = load ptr, ptr %i.eb, align 8, !tbaa !64 ; 5 uses
...
vector.ph129:                                     ; preds = %vector.main.loop.iter.check127
  %i.ed = getelementptr i8, ptr %i.ec, i64 %i.dx
  br label %vector.body133

vector.body133:                                   ; preds = %vector.body133, %vector.ph129
  %index134 = phi i64 [ 0, %vector.ph129 ], [ %index.next136, %vector.body133 ] ; 2 uses
  %i.ee = shl i64 %index134, 1
  %next.gep135 = getelementptr i8, ptr %i.ec, i64 %i.ee ; 2 uses
  %i.ef = getelementptr i8, ptr %next.gep135, i64 16
  store <8 x i16> %broadcast.splat132, ptr %next.gep135, align 2, !tbaa !66
  store <8 x i16> %broadcast.splat132, ptr %i.ef, align 2, !tbaa !66
  %index.next136 = add nuw i64 %index134, 16      ; 2 uses
  %i.eg = icmp eq i64 %index.next136, %n.vec130
  br i1 %i.eg, label %middle.block137, label %vector.body133, !llvm.loop !130
...
vec.epilog.ph145:                                 ; preds = %vector.main.loop.iter.check127, %vec.epilog.iter.check143
  ...
  %i.eh = getelementptr i8, ptr %i.ec, i64 %i.dz
...
vec.epilog.vector.body149:                        ; preds = %vec.epilog.vector.body149, %vec.epilog.ph145
  ...
  %i.ei = shl i64 %index150, 1
  %next.gep151 = getelementptr i8, ptr %i.ec, i64 %i.ei
  store <4 x i16> %broadcast.splat148, ptr %next.gep151, align 2, !tbaa !66
  %index.next152 = add nuw i64 %index150, 4       ; 2 uses
  %i.ej = icmp eq i64 %index.next152, %n.vec146
  br i1 %i.ej, label %vec.epilog.middle.block153, label %vec.epilog.vector.body149, !llvm.loop !131
...
.preheader.preheader:                             ; preds = %iter.check141, %vec.epilog.iter.check143, %vec.epilog.middle.block153
  %.04260.ph = phi ptr [ %i.ec, %iter.check141 ], [ %i.ed, %vec.epilog.iter.check143 ], [ %i.eh, %vec.epilog.middle.block153 ]
  %.04558.ph = phi i32 [ 0, %iter.check141 ], [ %i.dy, %vec.epilog.iter.check143 ], [ %i.ea, %vec.epilog.middle.block153 ]
  br label %.preheader

.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  %.04260 = phi ptr [ %i.ek, %.preheader ], [ %.04260.ph, %.preheader.preheader ] ; 2 uses
  %.04558 = phi i32 [ %i.el, %.preheader ], [ %.04558.ph, %.preheader.preheader ]
  %i.ek = getelementptr inbounds nuw i8, ptr %.04260, i64 2
  store i16 %i.du, ptr %.04260, align 2, !tbaa !66
  %i.el = add nuw i32 %.04558, 1                  ; 2 uses
  %exitcond.not = icmp eq i32 %i.el, %i.h
  br i1 %exitcond.not, label %._crit_edge.split, label %.preheader, !llvm.loop !132
...
._crit_edge.split:                                ; preds = %.preheader, %vec.epilog.middle.block153, %middle.block137
  ...
  br i1 %exitcond81.not, label %._crit_edge68.split, label %iter.check141, !llvm.loop !126
