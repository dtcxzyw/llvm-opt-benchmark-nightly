...
bb.ak:                                            ; preds = %.lr.ph.i
  %lsr.iv67.lcssa = phi ptr [ %lsr.iv66, %.lr.ph.i ]
  %lsr.iv61.lcssa = phi i64 [ %lsr.iv61, %.lr.ph.i ]
...
vector.ph:                                        ; preds = %.lr.ph60.preheader.i
  ...
  %i.el = lshr i64 %lsr.iv61.lcssa, 2
  %i.em = shl nuw i64 %i.el, 2
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %lsr.iv68 = phi ptr [ %scevgep69, %vector.body ], [ %lsr.iv67.lcssa, %vector.ph ] ; 5 uses
...
bb.h:                                             ; preds = %.lr.ph
  %lsr.iv99.lcssa = phi ptr [ %lsr.iv98, %.lr.ph ]
...
vector.ph:                                        ; preds = %.lr.ph60.preheader
  ...
  %i.z = lshr i64 %lsr.iv.lcssa, 2
  %i.aa = shl nuw i64 %i.z, 2
  br label %vector.body

vector.body:                                      ; preds = %vector.body, %vector.ph
  %lsr.iv100 = phi ptr [ %scevgep101, %vector.body ], [ %lsr.iv99.lcssa, %vector.ph ] ; 5 uses
