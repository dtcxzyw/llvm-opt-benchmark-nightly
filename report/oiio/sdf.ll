...
bb.a:
  ...
  %.not = icmp ult i32 %0, 1073741824             ; 4 uses
  %.116 = select i1 %.not, i64 0, i64 2147483648
  %.neg = select i1 %.not, i64 0, i64 -1073741824
  %.1 = add nsw i64 %.neg, %i.a
  %i.b = shl nsw i64 %.1, 1                       ; 2 uses
  %1 = select i1 %.not, i64 536870912, i64 2684354560 ; 2 uses
  %.not.1 = icmp ult i64 %i.b, %1                 ; 2 uses
  %2 = select i1 %.not, i64 1073741824, i64 3221225472
...
begin_hunk_1_@square_root:bb.a
  ...
  %3 = or disjoint i64 %.116.3, 67108864          ; 2 uses
  %.not.4 = icmp ult i64 %i.l, %3                 ; 2 uses
  %4 = or disjoint i64 %.116.3, 134217728
