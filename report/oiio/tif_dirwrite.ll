...
bb.i:                                             ; preds = %bb.g
  %i.g = tail call double @llvm.floor.f64(double %0)
  %i.h = fcmp une double %0, %i.g                 ; 2 uses
...
begin_hunk_2_@DoubleToRational:bb.a
  ...
  %i.ao = fcmp une double %i.am, %i.an
...
bb.g:                                             ; preds = %bb.e
  %i.k = tail call double @llvm.floor.f64(double %.0)
  %i.l = fcmp une double %.0, %i.k                ; 2 uses
...
begin_hunk_6_@DoubleToSrational:bb.a
  ...
  %i.ar = tail call double @llvm.floor.f64(double %i.aq)
  %i.as = fcmp une double %i.aq, %i.ar
