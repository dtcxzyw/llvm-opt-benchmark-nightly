...
.lr.ph1314.preheader:                             ; preds = %bb.np
  %scevgep2129 = getelementptr i8, ptr %.0564, i64 2
...
.lr.ph1308.preheader:                             ; preds = %bb.nz
  ...
  %scevgep2120 = getelementptr i8, ptr %.0564, i64 2
  br label %.lr.ph1308
...
.._crit_edge.loopexit_crit_edge:                  ; preds = %bb.v
  %.2294381.lcssa448.a = phi i64 [ %.2294381, %bb.v ]
  br label %._crit_edge.loopexit

._crit_edge.loopexit:                             ; preds = %._crit_edge.loopexitsplit, %.._crit_edge.loopexit_crit_edge
  %.lcssa = phi i1 [ %i.bf, %.._crit_edge.loopexit_crit_edge ], [ %i.bf, %._crit_edge.loopexitsplit ]
  %.2294.lcssa.ph = phi i64 [ %.2294381.lcssa448.a, %.._crit_edge.loopexit_crit_edge ], [ %.lcssa447, %._crit_edge.loopexitsplit ]
  br label %._crit_edge
