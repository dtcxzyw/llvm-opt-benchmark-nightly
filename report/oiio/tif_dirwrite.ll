begin_hunk_0_@TIFFWriteDirectorySec:bb.a
  ...
  %i.kk = zext i32 %i.kj to i64                   ; 4 uses
...
bb.cm:                                            ; preds = %bb.cl
  ...
  %i.kn = select i1 %.not.i.i774, i64 2, i64 4
  %4 = icmp samesign ult i64 %i.kn, %i.kk
  br i1 %4, label %bb.cn, label %TIFFWriteDirectoryTagColormap.exit.thread978

bb.cn:                                            ; preds = %bb.cm
  %5 = shl nuw nsw i64 %i.kk, 1
...
bb.co:                                            ; preds = %bb.cl
  %6 = shl nuw nsw i64 %i.kk, 1
  %i.ks = call ptr @_TIFFmallocExt(ptr noundef nonnull %0, i64 noundef %6) #9 ; 7 uses
...
begin_hunk_3_@TIFFWriteDirectorySec:bb.a
  ...
  %i.pm = zext i32 %i.pl to i64                   ; 4 uses
...
bb.ee:                                            ; preds = %.critedge.i
  %11 = shl nuw nsw i64 %i.pm, 1
  %i.ps = call ptr @_TIFFmallocExt(ptr noundef nonnull %0, i64 noundef %11) #9 ; 7 uses
...
bb.ez:                                            ; preds = %._crit_edge.i
  %i.sm = zext i16 %i.sd to i64                   ; 2 uses
  %i.sn = load i32, ptr %i.bw, align 8, !tbaa !27
  %i.so = and i32 %i.sn, 524288
  %.not.i.i.i813 = icmp eq i32 %i.so, 0
  %i.sp = select i1 %.not.i.i.i813, i64 1, i64 2
  %12 = icmp samesign ult i64 %i.sp, %i.sm
  br i1 %12, label %bb.fa, label %TIFFWriteDirectoryTagCheckedIfd8Array.exit.thread62.i

bb.fa:                                            ; preds = %bb.ez
  %13 = shl nuw nsw i64 %i.sm, 2
  %i.sq = load i64, ptr %i.bm, align 8, !tbaa !33
  %i.sr = add i64 %i.sq, %13
...
bb.gn:                                            ; preds = %bb.gm
  %i.zd = zext i32 %i.wy to i64                   ; 2 uses
  %i.ze = load i32, ptr %i.bw, align 8, !tbaa !27
  %i.zf = and i32 %i.ze, 524288
  %.not.i.i.i850 = icmp eq i32 %i.zf, 0
  %i.zg = select i1 %.not.i.i.i850, i64 2, i64 4
  %14 = icmp samesign ult i64 %i.zg, %i.zd
  br i1 %14, label %bb.go, label %TIFFWriteDirectoryTagShortArray.exit852.thread

bb.go:                                            ; preds = %bb.gn
  %15 = shl nuw nsw i64 %i.zd, 1
  %i.zh = load i64, ptr %i.bm, align 8, !tbaa !33
  %i.zi = add i64 %i.zh, %15
...
bb.gs:                                            ; preds = %bb.gr
  %i.zs = zext i32 %i.wy to i64                   ; 2 uses
  %i.zt = load i32, ptr %i.bw, align 8, !tbaa !27
  %i.zu = and i32 %i.zt, 524288
  %.not.i.i.i855 = icmp eq i32 %i.zu, 0
  %i.zv = select i1 %.not.i.i.i855, i64 2, i64 4
  %16 = icmp samesign ult i64 %i.zv, %i.zs
  br i1 %16, label %bb.gt, label %TIFFWriteDirectoryTagSshortArray.exit.thread

bb.gt:                                            ; preds = %bb.gs
  %17 = shl nuw nsw i64 %i.zs, 1
  %i.zw = load i64, ptr %i.bm, align 8, !tbaa !33
  %i.zx = add i64 %i.zw, %17
...
bb.gx:                                            ; preds = %bb.gw
  %i.aah = zext i32 %i.wy to i64                  ; 2 uses
  %i.aai = load i32, ptr %i.bw, align 8, !tbaa !27
  %i.aaj = and i32 %i.aai, 524288
  %.not.i.i.i859 = icmp eq i32 %i.aaj, 0
  %i.aak = select i1 %.not.i.i.i859, i64 1, i64 2
  %18 = icmp samesign ult i64 %i.aak, %i.aah
  br i1 %18, label %bb.gy, label %TIFFWriteDirectoryTagLongArray.exit.thread

bb.gy:                                            ; preds = %bb.gx
  %19 = shl nuw nsw i64 %i.aah, 2
  %i.aal = load i64, ptr %i.bm, align 8, !tbaa !33
  %i.aam = add i64 %i.aal, %19
...
bb.hc:                                            ; preds = %bb.hb
  %i.aaw = zext i32 %i.wy to i64                  ; 2 uses
  %i.aax = load i32, ptr %i.bw, align 8, !tbaa !27
  %i.aay = and i32 %i.aax, 524288
  %.not.i.i.i863 = icmp eq i32 %i.aay, 0
  %i.aaz = select i1 %.not.i.i.i863, i64 1, i64 2
  %20 = icmp samesign ult i64 %i.aaz, %i.aaw
  br i1 %20, label %bb.hd, label %TIFFWriteDirectoryTagSlongArray.exit.thread

bb.hd:                                            ; preds = %bb.hc
  %21 = shl nuw nsw i64 %i.aaw, 2
  %i.aba = load i64, ptr %i.bm, align 8, !tbaa !33
  %i.abb = add i64 %i.aba, %21
...
bb.ih:                                            ; preds = %bb.ig
  ...
  %i.aea = zext i32 %i.adz to i64                 ; 4 uses
...
bb.ii:                                            ; preds = %bb.ih
  ...
  %i.aed = select i1 %.not.i.i.i881, i64 1, i64 2
  %22 = icmp samesign ult i64 %i.aed, %i.aea
  br i1 %22, label %bb.ij, label %TIFFWriteDirectoryTagRationalDoubleArray.exit.thread1070

bb.ij:                                            ; preds = %bb.ii
  %23 = shl nuw nsw i64 %i.aea, 2
  %i.aee = load i64, ptr %i.bm, align 8, !tbaa !33
  %i.aef = add i64 %i.aee, %23
...
bb.ik:                                            ; preds = %bb.ih
  %24 = shl nuw nsw i64 %i.aea, 2
  %i.aei = call ptr @_TIFFmallocExt(ptr noundef nonnull %0, i64 noundef %24) #9 ; 5 uses
...
begin_hunk_11_@TIFFWriteDirectorySec:bb.a
  ...
  %i.afb = zext i32 %i.afa to i64                 ; 8 uses
...
begin_hunk_12_@TIFFWriteDirectorySec:bb.a
  ...
  %i.afe = select i1 %.not.i.i.i893, i64 1, i64 2
  %25 = icmp samesign ult i64 %i.afe, %i.afb
  br i1 %25, label %bb.is, label %TIFFWriteDirectoryTagSrationalDoubleArray.exit.thread1079

bb.is:                                            ; preds = %bb.ir
  %26 = shl nuw nsw i64 %i.afb, 2
  %i.aff = load i64, ptr %i.bm, align 8, !tbaa !33
  %i.afg = add i64 %i.aff, %26
...
bb.it:                                            ; preds = %bb.iq
  %27 = shl nuw nsw i64 %i.afb, 2
  %i.afj = call ptr @_TIFFmallocExt(ptr noundef nonnull %0, i64 noundef %27) #9 ; 5 uses
...
begin_hunk_14_@TIFFWriteDirectorySec:bb.a
  ...
  %i.afw = select i1 %.not.i.i.i905, i64 1, i64 2
  %28 = icmp samesign ult i64 %i.afw, %i.afb
  br i1 %28, label %bb.ix, label %TIFFWriteDirectoryTagSrationalArray.exit.thread1084

bb.ix:                                            ; preds = %bb.iw
  %29 = shl nuw nsw i64 %i.afb, 2
  %i.afx = load i64, ptr %i.bm, align 8, !tbaa !33
  %i.afy = add i64 %i.afx, %29
...
bb.iy:                                            ; preds = %bb.iv
  %30 = shl nuw nsw i64 %i.afb, 2
  %i.agb = call ptr @_TIFFmallocExt(ptr noundef nonnull %0, i64 noundef %30) #9 ; 5 uses
...
bb.jd:                                            ; preds = %bb.jc
  %i.agp = zext i32 %i.wy to i64                  ; 2 uses
  %i.agq = load i32, ptr %i.bw, align 8, !tbaa !27
  %i.agr = and i32 %i.agq, 524288
  %.not.i.i.i909 = icmp eq i32 %i.agr, 0
  %i.ags = select i1 %.not.i.i.i909, i64 1, i64 2
  %31 = icmp samesign ult i64 %i.ags, %i.agp
  br i1 %31, label %bb.je, label %TIFFWriteDirectoryTagFloatArray.exit.thread

bb.je:                                            ; preds = %bb.jd
  %32 = shl nuw nsw i64 %i.agp, 2
  %i.agt = load i64, ptr %i.bm, align 8, !tbaa !33
  %i.agu = add i64 %i.agt, %32
...
bb.jn:                                            ; preds = %bb.jm
  %i.ahv = zext i32 %i.wy to i64                  ; 2 uses
  %i.ahw = load i32, ptr %i.bw, align 8, !tbaa !27
  %i.ahx = and i32 %i.ahw, 524288
  %.not.i.i.i917 = icmp eq i32 %i.ahx, 0
  %i.ahy = select i1 %.not.i.i.i917, i64 1, i64 2
  %33 = icmp samesign ult i64 %i.ahy, %i.ahv
  br i1 %33, label %bb.jo, label %TIFFWriteDirectoryTagIfdArray.exit.thread

bb.jo:                                            ; preds = %bb.jn
  %34 = shl nuw nsw i64 %i.ahv, 2
  %i.ahz = load i64, ptr %i.bm, align 8, !tbaa !33
  %i.aia = add i64 %i.ahz, %34
...
bb.jy:                                            ; preds = %bb.jr
  %i.aix = zext i32 %i.wy to i64                  ; 3 uses
  %i.aiy = shl nuw nsw i64 %i.aix, 2              ; 2 uses
...
bb.kc:                                            ; preds = %._crit_edge.i927
  ...
  %i.ajj = select i1 %.not.i.i41.i, i64 1, i64 2
  %35 = icmp samesign ult i64 %i.ajj, %i.aix
  br i1 %35, label %bb.kd, label %EvaluateIFDdatasizeWrite.exit.i42.i
...
begin_hunk_21_@TIFFWriteDirectoryTagShortPerSample:bb.a
  ...
  %i.h = select i1 %.not.i.i, i64 2, i64 4
  %5 = icmp samesign ult i64 %i.h, %i.d
  br i1 %5, label %bb.c, label %TIFFWriteDirectoryTagCheckedShortArray.exit

bb.c:                                             ; preds = %bb.b
  %6 = shl nuw nsw i64 %i.d, 1
...
bb.d:                                             ; preds = %bb.a
  %7 = shl nuw nsw i64 %i.d, 1
  %i.n = tail call ptr @_TIFFmallocExt(ptr noundef %0, i64 noundef %7) #9 ; 5 uses
...
bb.ab:                                            ; preds = %._crit_edge167
  ...
  %i.bh = select i1 %.not.i.i, i64 1, i64 2
  %6 = icmp samesign ult i64 %i.bh, %i.au
...
bb.ah:                                            ; preds = %bb.u, %bb.w, %bb.x, %WriteAsLong4.exit
  %i.bq = zext i32 %4 to i64                      ; 3 uses
  %i.br = shl nuw nsw i64 %i.bq, 1                ; 2 uses
...
bb.al:                                            ; preds = %._crit_edge
  ...
  %i.cd = select i1 %.not.i.i139, i64 2, i64 4
  %7 = icmp samesign ult i64 %i.cd, %i.bq
...
bb.aa:                                            ; preds = %._crit_edge182
  %i.df = zext nneg i32 %4 to i64                 ; 2 uses
...
bb.ai:                                            ; preds = %._crit_edge179
  %i.es = zext nneg i32 %4 to i64                 ; 2 uses
...
bb.ay:                                            ; preds = %._crit_edge173
  %i.hv = zext nneg i32 %4 to i64                 ; 2 uses
...
bb.bg:                                            ; preds = %._crit_edge
  %i.ji = zext nneg i32 %4 to i64                 ; 2 uses
...
begin_hunk_33_@TIFFWriteDirectoryTagRationalArray:bb.a
  ...
  %i.g = select i1 %.not.i.i, i64 1, i64 2
  %6 = icmp samesign ult i64 %i.g, %i.c
  br i1 %6, label %bb.c, label %EvaluateIFDdatasizeWrite.exit.i

bb.c:                                             ; preds = %bb.b
  %7 = shl nuw nsw i64 %i.c, 2
...
bb.d:                                             ; preds = %bb.a
  %8 = shl nuw nsw i64 %i.c, 2
  %i.m = tail call ptr @_TIFFmallocExt(ptr noundef %0, i64 noundef %8) #9 ; 5 uses
