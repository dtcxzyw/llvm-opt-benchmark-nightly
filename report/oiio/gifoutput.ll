...
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !668, !nonnull !86, !align !243
  %i.b = load i32, ptr %i.a, align 4, !tbaa !316  ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit8:         ; preds = %bb.d, %bb.e
  ...
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !670, !nonnull !86
  %i.ad = load i8, ptr %i.ac, align 1, !tbaa !324, !range !85, !noundef !86
  %i.ae = trunc nuw i8 %i.ad to i1
  br i1 %i.ae, label %bb.f, label %bb.j

bb.f:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit8
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !671, !nonnull !86
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit13:        ; preds = %bb.f, %bb.g
  ...
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !672, !nonnull !86, !align !243
...
bb.i:                                             ; preds = %bb.h
  ...
  tail call void %i.ba(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.ax), !inline_history !344
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.i, %bb.h
  ...
  br i1 %exitcond.not.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit, label %bb.h, !llvm.loop !340
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit13
  ...
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !673, !nonnull !86, !align !264
  %i.bh = load i64, ptr %i.bg, align 8, !tbaa !372
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !674, !nonnull !86, !align !243
...
bb.g:                                             ; preds = %bb.f
  ...
  tail call void %i.ae(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.af), !inline_history !675
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.at, label %middle.block, label %vector.body, !llvm.loop !676
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.aw, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !677
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !678
...
bb.i:                                             ; preds = %bb.a
  ...
  store ptr %i.c, ptr %i.bx, align 8, !tbaa !680
  %i.by = getelementptr inbounds nuw i8, ptr %5, i64 16
  store ptr %i.b, ptr %i.by, align 8, !tbaa !680
  %i.bz = getelementptr inbounds nuw i8, ptr %5, i64 24
  store ptr %i.d, ptr %i.bz, align 8, !tbaa !680
  %i.ca = getelementptr inbounds nuw i8, ptr %5, i64 32
  store ptr %4, ptr %i.ca, align 8, !tbaa !682
  ...
  %i.cd = load i8, ptr %i.a, align 1, !tbaa !324, !range !85, !noundef !86
  store i8 %i.cd, ptr %6, align 8, !tbaa !684
  %i.ce = getelementptr inbounds nuw i8, ptr %6, i64 8
  store i64 %i.cb, ptr %i.ce, align 8, !tbaa !686
  %i.cf = getelementptr inbounds nuw i8, ptr %6, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.cf, ptr noundef nonnull align 8 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !687
...
bb.c:                                             ; preds = %bb.g, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit
  ...
  store ptr %i.l, ptr %3, align 8, !tbaa !274, !alias.scope !688
  store ptr null, ptr %i.m, align 8, !tbaa !276, !alias.scope !688
  store i32 0, ptr %i.n, align 8, !tbaa !277, !alias.scope !688
  ...
  %i.r = load ptr, ptr %3, align 8, !tbaa !274    ; 3 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.ar, label %middle.block, label %vector.body, !llvm.loop !691
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  br i1 %i.au, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !692
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !693
