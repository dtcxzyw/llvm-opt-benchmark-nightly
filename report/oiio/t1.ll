...
bb.cs:                                            ; preds = %bb.cr
  %i.ue = icmp eq i32 %.pre.i.i.us.i194.i, 255
...
bb.ct:                                            ; preds = %bb.cs
  ...
  br i1 %i.uh, label %opj_mqc_raw_decode.exit.i.us.i195.i, label %bb.cu

bb.cu:                                            ; preds = %bb.ct, %bb.cs
  %.ph17.i.i.us.i196.i = phi i32 [ 7, %bb.ct ], [ 8, %bb.cs ]
  ...
  br label %opj_mqc_raw_decode.exit.i.us.i195.i

opj_mqc_raw_decode.exit.i.us.i195.i:              ; preds = %bb.cu, %bb.ct, %bb.cr
  %17 = phi i32 [ %.pre.i.i.us.i194.i, %bb.cr ], [ 255, %bb.ct ], [ %i.ui, %bb.cu ]
  %18 = phi i32 [ %i.uc, %bb.cr ], [ 8, %bb.ct ], [ %.ph17.i.i.us.i196.i, %bb.cu ]
...
bb.da:                                            ; preds = %bb.cz
  %i.vs = icmp eq i32 %.pre.i.i70.us.i192.i, 255
...
bb.db:                                            ; preds = %bb.da
  ...
  br i1 %i.vv, label %opj_mqc_raw_decode.exit.i71.us.i193.i, label %bb.dc
...
bb.dc:                                            ; preds = %bb.db, %bb.da
  ...
  br label %opj_mqc_raw_decode.exit.i71.us.i193.i

opj_mqc_raw_decode.exit.i71.us.i193.i:            ; preds = %bb.dc, %bb.db, %bb.cz
  %21 = phi i32 [ %.pre.i.i70.us.i192.i, %bb.cz ], [ 255, %bb.db ], [ %i.vw, %bb.dc ]
