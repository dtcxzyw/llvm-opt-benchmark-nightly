...
.preheader:                                       ; preds = %.preheader.loopexit, %.preheader283
  %.5.lcssa = phi i32 [ 0, %.preheader283 ], [ %i.bko, %.preheader.loopexit ] ; 5 uses
...
vector.ph852:                                     ; preds = %vector.memcheck
  ...
  %invariant.op1022 = add i32 %.5.lcssa, %i.bkr
  %invariant.gep = getelementptr [4 x i8], ptr %i.bkt, i64 %i.bku
  br label %vector.body855

vector.body855:                                   ; preds = %vector.body855, %vector.ph852
  %index856 = phi i64 [ 0, %vector.ph852 ], [ %index.next861, %vector.body855 ] ; 3 uses
  %i.bll = trunc i64 %index856 to i32
  %.reass1023 = add i32 %i.bll, %invariant.op1022
...
begin_hunk_2_@opj_t1_clbl_decode_processor:bb.a
  ...
  %gep = getelementptr [4 x i8], ptr %invariant.gep, i64 %index856 ; 2 uses
...
begin_hunk_3_@opj_t1_clbl_decode_processor:bb.a
  ...
  %n.vec831 = and i64 %i.bny, 4294967288          ; 5 uses
  %2 = shl nuw nsw i64 %n.vec831, 2
  %i.bnz = shl nuw nsw i64 %n.vec831, 2
...
vector.ph829:                                     ; preds = %.preheader284.us
  %i.bob = getelementptr i8, ptr %.2384.us, i64 %2 ; 2 uses
  %i.boc = getelementptr i8, ptr %.0243383.us, i64 %i.bnz
  br label %vector.body835

vector.body835:                                   ; preds = %vector.body835, %vector.ph829
  %index836 = phi i64 [ 0, %vector.ph829 ], [ %index.next843, %vector.body835 ] ; 3 uses
  %offset.idx837 = shl i64 %index836, 2
  %next.gep838 = getelementptr i8, ptr %.2384.us, i64 %offset.idx837 ; 2 uses
  %offset.idx839 = shl i64 %index836, 2
  %next.gep840 = getelementptr i8, ptr %.0243383.us, i64 %offset.idx839 ; 2 uses
