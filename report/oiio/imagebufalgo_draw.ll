...
.noexc25.i.i.i:                                   ; preds = %.noexc25.i.i.i, %bb.s
  ...
  %4 = add nsw i32 %.0.i.i.i.i, 140
  %i.dv = xor i32 %4, %i.dg
  %5 = sub i32 %i.dv, %i.ds                       ; 4 uses
  %i.dw = sub i32 %i.du, %i.ds                    ; 4 uses
  %i.dx = xor i32 %5, %i.bp
  %6 = xor i32 %i.dw, %i.bp
  %7 = call i32 @llvm.fshl.i32(i32 %5, i32 %5, i32 11)
  %8 = call i32 @llvm.fshl.i32(i32 %i.dw, i32 %i.dw, i32 11)
  %9 = sub i32 %i.dx, %7                          ; 4 uses
  %i.dy = sub i32 %6, %8                          ; 4 uses
  %i.dz = xor i32 %i.dy, %i.dg
  %i.ea = call i32 @llvm.fshl.i32(i32 %i.dy, i32 %i.dy, i32 25)
  %i.eb = xor i32 %9, %i.dg
  %i.ec = call i32 @llvm.fshl.i32(i32 %9, i32 %9, i32 25)
  %i.ed = sub i32 %i.eb, %i.ec                    ; 4 uses
  %10 = sub i32 %i.dz, %i.ea                      ; 4 uses
  %11 = xor i32 %i.ed, %5
  %12 = xor i32 %10, %i.dw
  %13 = call i32 @llvm.fshl.i32(i32 %i.ed, i32 %i.ed, i32 16)
  %14 = call i32 @llvm.fshl.i32(i32 %10, i32 %10, i32 16)
  %15 = sub i32 %11, %13                          ; 4 uses
  %16 = sub i32 %12, %14                          ; 4 uses
  %17 = xor i32 %15, %9
  %18 = xor i32 %16, %i.dy
  %19 = call i32 @llvm.fshl.i32(i32 %15, i32 %15, i32 4)
  %20 = call i32 @llvm.fshl.i32(i32 %16, i32 %16, i32 4)
  %i.ee = sub i32 %17, %19                        ; 3 uses
  %21 = sub i32 %18, %20                          ; 3 uses
  %22 = xor i32 %i.ee, %i.ed
  %i.ef = xor i32 %21, %10
  %i.eg = call i32 @llvm.fshl.i32(i32 %i.ee, i32 %i.ee, i32 14)
  %23 = call i32 @llvm.fshl.i32(i32 %21, i32 %21, i32 14)
  %24 = sub i32 %22, %i.eg
  %25 = sub i32 %i.ef, %23
  %26 = insertelement <2 x i32> poison, i32 %25, i64 0
  %27 = insertelement <2 x i32> %26, i32 %24, i64 1 ; 2 uses
  %28 = insertelement <2 x i32> poison, i32 %16, i64 0
  %29 = insertelement <2 x i32> %28, i32 %15, i64 1
  %30 = xor <2 x i32> %27, %29
  %31 = lshr <2 x i32> %27, splat (i32 8)
  %32 = sub <2 x i32> %30, %31
  %33 = and <2 x i32> %32, splat (i32 1048575)
  %34 = uitofp nneg <2 x i32> %33 to <2 x float>
  %35 = fmul nnan <2 x float> %34, splat (float f0x35800000)
  %36 = fpext <2 x float> %35 to <2 x double>
  %37 = call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %36, <2 x double> splat (double 2.000000e+00), <2 x double> splat (double -1.000000e+00)) ; 2 uses
  %38 = extractelement <2 x double> %37, i64 0
  %39 = fptrunc double %38 to float               ; 3 uses
  %40 = extractelement <2 x double> %37, i64 1
  %i.eh = fptrunc double %40 to float             ; 2 uses
  %i.ei = fmul float %i.eh, %i.eh
  %i.ej = call float @llvm.fmuladd.f32(float %39, float %39, float %i.ei) ; 4 uses
