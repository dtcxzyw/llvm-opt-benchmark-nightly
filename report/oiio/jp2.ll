...
end_hunk_0
begin_hunk_1_@opj_jp2_read_colr:bb.a
  ]

bb.n:                                             ; preds = %bb.m
  call void @opj_read_bytes_LE(ptr noundef nonnull %i.ab, ptr noundef nonnull %i.b, i32 noundef 4) #6
  %i.ah = getelementptr inbounds nuw i8, ptr %1, i64 11
  call void @opj_read_bytes_LE(ptr noundef nonnull %i.ah, ptr noundef nonnull %i.c, i32 noundef 4) #6
  %i.ai = getelementptr inbounds nuw i8, ptr %1, i64 15
  call void @opj_read_bytes_LE(ptr noundef nonnull %i.ai, ptr noundef nonnull %i.d, i32 noundef 4) #6
  %i.aj = getelementptr inbounds nuw i8, ptr %1, i64 19
  call void @opj_read_bytes_LE(ptr noundef nonnull %i.aj, ptr noundef nonnull %i.e, i32 noundef 4) #6
  %i.ak = getelementptr inbounds nuw i8, ptr %1, i64 23
  call void @opj_read_bytes_LE(ptr noundef nonnull %i.ak, ptr noundef nonnull %i.f, i32 noundef 4) #6
  %i.al = getelementptr inbounds nuw i8, ptr %1, i64 27
  call void @opj_read_bytes_LE(ptr noundef nonnull %i.al, ptr noundef nonnull %i.g, i32 noundef 4) #6
  %i.am = getelementptr inbounds nuw i8, ptr %1, i64 31
  call void @opj_read_bytes_LE(ptr noundef nonnull %i.am, ptr noundef nonnull %i.h, i32 noundef 4) #6
  store i32 0, ptr %i.ag, align 4, !tbaa !8
  %.pre = load i32, ptr %i.b, align 4, !tbaa !8
  %.pre99 = load i32, ptr %i.d, align 4, !tbaa !8
  %.pre100 = load i32, ptr %i.f, align 4, !tbaa !8
  %.pre101 = load i32, ptr %i.c, align 4, !tbaa !8
  %.pre102 = load i32, ptr %i.e, align 4, !tbaa !8
  %.pre103 = load i32, ptr %i.g, align 4, !tbaa !8
  %.pre104 = load i32, ptr %i.h, align 4, !tbaa !8
  br label %bb.p

bb.o:                                             ; preds = %bb.m
  %i.an = tail call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 2, ptr noundef nonnull @.str.64, i32 noundef %2) #6 ; 0 uses
  br label %bb.p

bb.p:                                             ; preds = %bb.n, %bb.o, %bb.m
  %i.ao = phi i32 [ %.pre104, %bb.n ], [ 4470064, %bb.o ], [ 4470064, %bb.m ]
  %i.ap = phi i32 [ %.pre103, %bb.n ], [ 0, %bb.o ], [ 0, %bb.m ]
  %i.aq = phi i32 [ %.pre102, %bb.n ], [ 0, %bb.o ], [ 0, %bb.m ]
  %i.ar = phi i32 [ %.pre101, %bb.n ], [ 0, %bb.o ], [ 0, %bb.m ]
  %i.as = phi i32 [ %.pre100, %bb.n ], [ 0, %bb.o ], [ 0, %bb.m ]
  %i.at = phi i32 [ %.pre99, %bb.n ], [ 0, %bb.o ], [ 0, %bb.m ]
  %i.au = phi i32 [ %.pre, %bb.n ], [ 0, %bb.o ], [ 0, %bb.m ]
  ...
  store i32 %i.at, ptr %i.aw, align 4, !tbaa !8
  %i.ax = getelementptr inbounds nuw i8, ptr %i.ae, i64 24
  store i32 %i.as, ptr %i.ax, align 4, !tbaa !8
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ae, i64 12
  store i32 %i.ar, ptr %i.ay, align 4, !tbaa !8
  %i.az = getelementptr inbounds nuw i8, ptr %i.ae, i64 20
  store i32 %i.aq, ptr %i.az, align 4, !tbaa !8
  %i.ba = getelementptr inbounds nuw i8, ptr %i.ae, i64 28
  store i32 %i.ap, ptr %i.ba, align 4, !tbaa !8
  %i.bb = getelementptr inbounds nuw i8, ptr %i.ae, i64 32
  store i32 %i.ao, ptr %i.bb, align 4, !tbaa !8
  store ptr %i.ae, ptr %i.k, align 8, !tbaa !73
  %i.bc = getelementptr inbounds nuw i8, ptr %0, i64 136
  store i32 0, ptr %i.bc, align 8, !tbaa !74
...
bb.q:                                             ; preds = %bb.p, %bb.k
  store i8 1, ptr %i.l, align 8, !tbaa !57
  br label %bb.u

bb.r:                                             ; preds = %bb.e
  %i.bd = add nsw i32 %2, -3                      ; 3 uses
  %i.be = getelementptr inbounds nuw i8, ptr %0, i64 136 ; 2 uses
  store i32 %i.bd, ptr %i.be, align 8, !tbaa !74
  %i.bf = sext i32 %i.bd to i64
  %i.bg = tail call ptr @opj_calloc(i64 noundef 1, i64 noundef %i.bf) #6 ; 2 uses
  store ptr %i.bg, ptr %i.k, align 8, !tbaa !73
  %.not90.not = icmp eq ptr %i.bg, null
  br i1 %.not90.not, label %.thread95, label %.preheader

.preheader:                                       ; preds = %bb.r
  %i.bh = icmp sgt i32 %2, 3
...
.thread95:                                        ; preds = %bb.r
  store i32 0, ptr %i.be, align 8, !tbaa !74
  br label %bb.u

.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  %indvars.iv = phi i64 [ 0, %.lr.ph.preheader ], [ %indvars.iv.next, %.lr.ph ] ; 2 uses
  %.08696 = phi ptr [ %i.t, %.lr.ph.preheader ], [ %i.bi, %.lr.ph ] ; 2 uses
  call void @opj_read_bytes_LE(ptr noundef nonnull %.08696, ptr noundef nonnull %i.a, i32 noundef 1) #6
  %i.bi = getelementptr inbounds nuw i8, ptr %.08696, i64 1
  %i.bj = load i32, ptr %i.a, align 4, !tbaa !8
  %i.bk = trunc i32 %i.bj to i8
  %i.bl = load ptr, ptr %i.k, align 8, !tbaa !73
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 %indvars.iv
  store i8 %i.bk, ptr %i.bm, align 1, !tbaa !21
...
bb.s:                                             ; preds = %bb.e
  %i.bn = icmp ugt i32 %i.u, 2
  br i1 %i.bn, label %bb.t, label %bb.u

bb.t:                                             ; preds = %bb.s
  %i.bo = tail call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 4, ptr noundef nonnull @.str.65, i32 noundef %i.u) #6 ; 0 uses
  br label %bb.u

bb.u:                                             ; preds = %bb.q, %bb.s, %bb.t, %._crit_edge, %.thread95, %.thread, %bb.g, %bb.d, %bb.b
  %.2 = phi i32 [ 0, %bb.b ], [ 1, %bb.d ], [ 0, %bb.g ], [ 0, %.thread95 ], [ 0, %.thread ], [ 1, %._crit_edge ], [ 1, %bb.t ], [ 1, %bb.s ], [ 1, %bb.q ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #6
  ret i32 %.2
}

; Function Attrs: nounwind uwtable
define internal range(i32 0, 2) i32 @opj_jp2_read_bpcc(ptr nofree noundef readonly captures(none) %0, ptr noundef %1, i32 noundef %2, ptr noundef %3) #0 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 36
  %i.b = load i32, ptr %i.a, align 4, !tbaa !64   ; 2 uses
  %.not = icmp eq i32 %i.b, 255
  br i1 %.not, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.a
  %i.c = tail call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 2, ptr noundef nonnull @.str.66, i32 noundef %i.b) #6 ; 0 uses
  br label %bb.c

bb.c:                                             ; preds = %bb.b, %bb.a
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 2 uses
  %i.e = load i32, ptr %i.d, align 8, !tbaa !62
  %.not16 = icmp eq i32 %2, %i.e
  br i1 %.not16, label %.preheader, label %bb.d
...
bb.d:                                             ; preds = %bb.c
  %i.g = tail call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 1, ptr noundef nonnull @.str.67) #6 ; 0 uses
  br label %.loopexit

bb.e:                                             ; preds = %.lr.ph, %bb.e
  %indvars.iv = phi i64 [ 0, %.lr.ph ], [ %indvars.iv.next, %bb.e ] ; 2 uses
  %.01417 = phi ptr [ %1, %.lr.ph ], [ %i.k, %bb.e ] ; 2 uses
  %i.h = load ptr, ptr %i.f, align 8, !tbaa !63
  %i.i = getelementptr inbounds nuw [12 x i8], ptr %i.h, i64 %indvars.iv
  %i.j = getelementptr inbounds nuw i8, ptr %i.i, i64 8
  tail call void @opj_read_bytes_LE(ptr noundef %.01417, ptr noundef nonnull %i.j, i32 noundef 1) #6
  %i.k = getelementptr inbounds nuw i8, ptr %.01417, i64 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.l = load i32, ptr %i.d, align 8, !tbaa !62
  %i.m = zext i32 %i.l to i64
  %i.n = icmp samesign ult i64 %indvars.iv.next, %i.m
  br i1 %i.n, label %bb.e, label %.loopexit, !llvm.loop !138

.loopexit:                                        ; preds = %bb.e, %.preheader, %bb.d
  %.013 = phi i32 [ 0, %bb.d ], [ 1, %.preheader ], [ 1, %bb.e ]
  ret i32 %.013
}

; Function Attrs: nounwind uwtable
define internal range(i32 0, 2) i32 @opj_jp2_read_pclr(ptr nofree noundef captures(none) %0, ptr noundef %1, i32 noundef %2, ptr noundef %3) #0 {
bb.a:
  ...
  %i.d = icmp ult i32 %2, 3
  %or.cond96 = or i1 %i.d, %.not
  br i1 %or.cond96, label %.critedge, label %bb.b

bb.b:                                             ; preds = %bb.a
  call void @opj_read_bytes_LE(ptr noundef %1, ptr noundef nonnull %i.a, i32 noundef 2) #6
  %i.e = load i32, ptr %i.a, align 4, !tbaa !8    ; 3 uses
  %i.f = trunc i32 %i.e to i16
  %i.g = and i32 %i.e, 65535                      ; 3 uses
  %i.h = add nsw i32 %i.g, -1025
  %or.cond = icmp ult i32 %i.h, -1024
  br i1 %or.cond, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %i.i = call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 1, ptr noundef nonnull @.str.68, i32 noundef %i.g) #6 ; 0 uses
  br label %.critedge

bb.d:                                             ; preds = %bb.b
  %i.j = getelementptr inbounds nuw i8, ptr %1, i64 2
  call void @opj_read_bytes_LE(ptr noundef nonnull %i.j, ptr noundef nonnull %i.a, i32 noundef 1) #6
  %i.k = getelementptr inbounds nuw i8, ptr %1, i64 3
  %i.l = load i32, ptr %i.a, align 4, !tbaa !8    ; 2 uses
  %i.m = and i32 %i.l, 65535                      ; 4 uses
  %i.n = icmp eq i32 %i.m, 0
  br i1 %i.n, label %bb.e, label %bb.f

bb.e:                                             ; preds = %bb.d
  %i.o = call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 1, ptr noundef nonnull @.str.69) #6 ; 0 uses
  br label %.critedge

bb.f:                                             ; preds = %bb.d
  %i.p = add nuw nsw i32 %i.m, 3
  %i.q = icmp ult i32 %2, %i.p
  br i1 %i.q, label %.critedge, label %bb.g

bb.g:                                             ; preds = %bb.f
  %i.r = zext nneg i32 %i.m to i64                ; 3 uses
  %i.s = shl nuw nsw i32 %i.g, 2
  %narrow = mul nuw nsw i32 %i.s, %i.m
  %i.t = zext nneg i32 %narrow to i64
  %i.u = call ptr @opj_malloc(i64 noundef %i.t) #6 ; 6 uses
  %.not90 = icmp eq ptr %i.u, null
  br i1 %.not90, label %.critedge, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.v = call ptr @opj_malloc(i64 noundef %i.r) #6 ; 6 uses
  %.not91 = icmp eq ptr %i.v, null
  br i1 %.not91, label %bb.i, label %bb.j

bb.i:                                             ; preds = %bb.h
  call void @opj_free(ptr noundef nonnull %i.u) #6
  br label %.critedge

bb.j:                                             ; preds = %bb.h
  %i.w = call ptr @opj_malloc(i64 noundef %i.r) #6 ; 4 uses
  %.not92 = icmp eq ptr %i.w, null
  br i1 %.not92, label %bb.k, label %bb.l

bb.k:                                             ; preds = %bb.j
  call void @opj_free(ptr noundef nonnull %i.u) #6
  call void @opj_free(ptr noundef nonnull %i.v) #6
  br label %.critedge

bb.l:                                             ; preds = %bb.j
  %i.x = call ptr @opj_malloc(i64 noundef 40) #6  ; 8 uses
  %.not93 = icmp eq ptr %i.x, null
  br i1 %.not93, label %bb.m, label %bb.n

bb.m:                                             ; preds = %bb.l
  call void @opj_free(ptr noundef nonnull %i.u) #6
  call void @opj_free(ptr noundef nonnull %i.v) #6
  call void @opj_free(ptr noundef nonnull %i.w) #6
  br label %.critedge
...
bb.n:                                             ; preds = %bb.l
  ...
  store ptr %i.v, ptr %i.z, align 8, !tbaa !45
  store ptr %i.u, ptr %i.x, align 8, !tbaa !46
  %i.aa = getelementptr inbounds nuw i8, ptr %i.x, i64 32
  store i16 %i.f, ptr %i.aa, align 8, !tbaa !51
  %i.ab = load i32, ptr %i.a, align 4, !tbaa !8
  %i.ac = trunc i32 %i.ab to i8
  %i.ad = getelementptr inbounds nuw i8, ptr %i.x, i64 34
  store i8 %i.ac, ptr %i.ad, align 2, !tbaa !34
  %i.ae = getelementptr inbounds nuw i8, ptr %i.x, i64 24
  store ptr null, ptr %i.ae, align 8, !tbaa !33
  store ptr %i.x, ptr %i.b, align 8, !tbaa !43
  br label %bb.o

.preheader.lr.ph:                                 ; preds = %bb.o
  %i.af = zext i32 %2 to i64
  %i.ag = ptrtoint ptr %1 to i64
  %i.ah = trunc i32 %i.e to i16
  %4 = trunc i32 %i.l to i16
  br label %.preheader

bb.o:                                             ; preds = %bb.n, %bb.o
  %indvars.iv = phi i64 [ 0, %bb.n ], [ %indvars.iv.next, %bb.o ] ; 3 uses
  %.079101 = phi ptr [ %i.k, %bb.n ], [ %i.ai, %bb.o ] ; 2 uses
  call void @opj_read_bytes_LE(ptr noundef nonnull %.079101, ptr noundef nonnull %i.a, i32 noundef 1) #6
  %i.ai = getelementptr inbounds nuw i8, ptr %.079101, i64 1 ; 2 uses
  %i.aj = load i32, ptr %i.a, align 4, !tbaa !8
  %i.ak = trunc i32 %i.aj to i8
  %i.al = and i8 %i.ak, 127
  %i.am = add nuw i8 %i.al, 1
  %i.an = getelementptr inbounds nuw i8, ptr %i.v, i64 %indvars.iv
  store i8 %i.am, ptr %i.an, align 1, !tbaa !21
  %i.ao = load i32, ptr %i.a, align 4, !tbaa !8
  %i.ap = and i32 %i.ao, 128
  %.not95 = icmp ne i32 %i.ap, 0
  %i.aq = zext i1 %.not95 to i8
  ...
  br i1 %exitcond.not, label %.preheader.lr.ph, label %bb.o, !llvm.loop !139

.preheader:                                       ; preds = %.preheader.lr.ph, %bb.r
  %.072108 = phi i16 [ 0, %.preheader.lr.ph ], [ %i.be, %bb.r ]
  %.074107 = phi ptr [ %i.u, %.preheader.lr.ph ], [ %i.bd, %bb.r ]
  %.180106 = phi ptr [ %i.ai, %.preheader.lr.ph ], [ %i.bb, %bb.r ]
  br label %bb.p

bb.p:                                             ; preds = %.preheader, %bb.q
  %.1105 = phi i16 [ 0, %.preheader ], [ %6, %bb.q ] ; 2 uses
  %.175104 = phi ptr [ %.074107, %.preheader ], [ %i.bd, %bb.q ] ; 2 uses
  %.281103 = phi ptr [ %.180106, %.preheader ], [ %i.bb, %bb.q ] ; 3 uses
  %5 = zext i16 %.1105 to i64
  %i.as = getelementptr inbounds nuw i8, ptr %i.v, i64 %5
  %i.at = load i8, ptr %i.as, align 1, !tbaa !21
  %i.au = zext i8 %i.at to i32
  %i.av = add nuw nsw i32 %i.au, 7
  %i.aw = lshr i32 %i.av, 3
  %spec.store.select = call i32 @llvm.umin.i32(i32 %i.aw, i32 4) ; 2 uses
  %i.ax = ptrtoint ptr %.281103 to i64
  %i.ay = sub i64 %i.ax, %i.ag
  %i.az = zext nneg i32 %spec.store.select to i64 ; 2 uses
  %i.ba = add nsw i64 %i.ay, %i.az
  %.not94 = icmp sgt i64 %i.ba, %i.af
  br i1 %.not94, label %.critedge, label %bb.q

bb.q:                                             ; preds = %bb.p
  call void @opj_read_bytes_LE(ptr noundef %.281103, ptr noundef nonnull %i.a, i32 noundef %spec.store.select) #6
  %i.bb = getelementptr inbounds nuw i8, ptr %.281103, i64 %i.az ; 2 uses
  %i.bc = load i32, ptr %i.a, align 4, !tbaa !8
  store i32 %i.bc, ptr %.175104, align 4, !tbaa !8
  %i.bd = getelementptr inbounds nuw i8, ptr %.175104, i64 4 ; 2 uses
  %6 = add nuw i16 %.1105, 1                      ; 2 uses
  %7 = icmp ult i16 %6, %4
  br i1 %7, label %bb.p, label %bb.r, !llvm.loop !140

bb.r:                                             ; preds = %bb.q
  %i.be = add nuw i16 %.072108, 1                 ; 2 uses
  %i.bf = icmp ult i16 %i.be, %i.ah
  br i1 %i.bf, label %.preheader, label %.critedge, !llvm.loop !141

.critedge:                                        ; preds = %bb.r, %bb.p, %bb.g, %bb.f, %bb.a, %bb.m, %bb.k, %bb.i, %bb.e, %bb.c
  %.3 = phi i32 [ 0, %bb.f ], [ 0, %bb.a ], [ 0, %bb.c ], [ 0, %bb.e ], [ 0, %bb.i ], [ 0, %bb.g ], [ 0, %bb.p ], [ 0, %bb.m ], [ 0, %bb.k ], [ 1, %bb.r ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #6
  ret i32 %.3
}

; Function Attrs: nounwind uwtable
define internal range(i32 0, 2) i32 @opj_jp2_read_cmap(ptr nofree noundef readonly captures(none) %0, ptr noundef %1, i32 noundef %2, ptr noundef %3) #0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  %i.e = tail call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 1, ptr noundef nonnull @.str.70) #6 ; 0 uses
  br label %bb.h
...
bb.d:                                             ; preds = %bb.c
  %i.h = tail call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 1, ptr noundef nonnull @.str.71) #6 ; 0 uses
  br label %bb.h

bb.e:                                             ; preds = %bb.c
  %i.i = getelementptr inbounds nuw i8, ptr %i.c, i64 34
  %i.j = load i8, ptr %i.i, align 2, !tbaa !34    ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  %i.n = tail call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 1, ptr noundef nonnull @.str.72) #6 ; 0 uses
  br label %bb.h

bb.g:                                             ; preds = %bb.e
  %i.o = zext i8 %i.j to i64                      ; 2 uses
  %i.p = shl nuw nsw i64 %i.o, 2
  %i.q = tail call ptr @opj_malloc(i64 noundef %i.p) #6 ; 3 uses
  %.not31 = icmp eq ptr %i.q, null
  br i1 %.not31, label %bb.h, label %.preheader
...
.lr.ph:                                           ; preds = %.preheader, %.lr.ph
  ...
  %.02832 = phi ptr [ %i.z, %.lr.ph ], [ %1, %.preheader ] ; 4 uses
  call void @opj_read_bytes_LE(ptr noundef %.02832, ptr noundef nonnull %i.a, i32 noundef 2) #6
  %i.r = getelementptr inbounds nuw i8, ptr %.02832, i64 2
  %i.s = load i32, ptr %i.a, align 4, !tbaa !8
  %i.t = trunc i32 %i.s to i16
  %i.u = getelementptr inbounds nuw [4 x i8], ptr %i.q, i64 %indvars.iv ; 3 uses
  store i16 %i.t, ptr %i.u, align 2, !tbaa !40
  call void @opj_read_bytes_LE(ptr noundef nonnull %i.r, ptr noundef nonnull %i.a, i32 noundef 1) #6
  %i.v = getelementptr inbounds nuw i8, ptr %.02832, i64 3
  %i.w = load i32, ptr %i.a, align 4, !tbaa !8
  %i.x = trunc i32 %i.w to i8
  %i.y = getelementptr inbounds nuw i8, ptr %i.u, i64 2
  store i8 %i.x, ptr %i.y, align 2, !tbaa !41
  call void @opj_read_bytes_LE(ptr noundef nonnull %i.v, ptr noundef nonnull %i.a, i32 noundef 1) #6
  %i.z = getelementptr inbounds nuw i8, ptr %.02832, i64 4
  %i.aa = load i32, ptr %i.a, align 4, !tbaa !8
  %i.ab = trunc i32 %i.aa to i8
  %i.ac = getelementptr inbounds nuw i8, ptr %i.u, i64 3
  store i8 %i.ab, ptr %i.ac, align 1, !tbaa !42
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
...
._crit_edge:                                      ; preds = %.lr.ph, %.preheader
  ...
  store ptr %i.q, ptr %i.ae, align 8, !tbaa !33
  br label %bb.h

bb.h:                                             ; preds = %bb.g, %._crit_edge, %bb.f, %bb.d, %bb.b
  %.027 = phi i32 [ 0, %bb.b ], [ 0, %bb.d ], [ 0, %bb.f ], [ 1, %._crit_edge ], [ 0, %bb.g ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #6
  ret i32 %.027
}

; Function Attrs: nounwind uwtable
define internal range(i32 0, 2) i32 @opj_jp2_read_cdef(ptr nofree noundef captures(none) %0, ptr noundef %1, i32 noundef %2, ptr noundef %3) #0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  %i.d = icmp ult i32 %2, 2
  br i1 %i.d, label %bb.c, label %bb.d

bb.c:                                             ; preds = %bb.b
  %i.e = tail call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 1, ptr noundef nonnull @.str.73) #6 ; 0 uses
  br label %.loopexit

bb.d:                                             ; preds = %bb.b
  call void @opj_read_bytes_LE(ptr noundef %1, ptr noundef nonnull %i.a, i32 noundef 2) #6
  %i.f = load i32, ptr %i.a, align 4, !tbaa !8    ; 2 uses
  %i.g = and i32 %i.f, 65535                      ; 2 uses
  %i.h = icmp eq i32 %i.g, 0
  br i1 %i.h, label %bb.e, label %bb.f

bb.e:                                             ; preds = %bb.d
  %i.i = call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 1, ptr noundef nonnull @.str.74) #6 ; 0 uses
  br label %.loopexit

bb.f:                                             ; preds = %bb.d
  %i.j = mul nuw nsw i32 %i.g, 6
  %i.k = add nuw nsw i32 %i.j, 2
  %i.l = icmp ult i32 %2, %i.k
  br i1 %i.l, label %bb.g, label %bb.h

bb.g:                                             ; preds = %bb.f
  %i.m = call i32 (ptr, i32, ptr, ...) @opj_event_msg(ptr noundef %3, i32 noundef 1, ptr noundef nonnull @.str.73) #6 ; 0 uses
  br label %.loopexit

bb.h:                                             ; preds = %bb.f
  %i.n = zext i32 %i.f to i64
  %i.o = mul nuw nsw i64 %i.n, 6
  %i.p = call ptr @opj_malloc(i64 noundef %i.o) #6 ; 4 uses
  %.not36 = icmp eq ptr %i.p, null
  br i1 %.not36, label %.loopexit, label %bb.i

bb.i:                                             ; preds = %bb.h
  %i.q = call ptr @opj_malloc(i64 noundef 16) #6  ; 4 uses
  store ptr %i.q, ptr %i.b, align 8, !tbaa !54
  %.not37 = icmp eq ptr %i.q, null
  br i1 %.not37, label %bb.j, label %bb.k

bb.j:                                             ; preds = %bb.i
  call void @opj_free(ptr noundef nonnull %i.p) #6
  br label %.loopexit

bb.k:                                             ; preds = %bb.i
  store ptr %i.p, ptr %i.q, align 8, !tbaa !26
  %i.r = load i32, ptr %i.a, align 4, !tbaa !8
  %i.s = trunc i32 %i.r to i16                    ; 2 uses
  %i.t = getelementptr inbounds nuw i8, ptr %i.q, i64 8
  store i16 %i.s, ptr %i.t, align 8, !tbaa !27
  %.not40 = icmp eq i16 %i.s, 0
  br i1 %.not40, label %.loopexit, label %.lr.ph

.lr.ph:                                           ; preds = %bb.k, %.lr.ph
  %indvars.iv = phi i64 [ %indvars.iv.next, %.lr.ph ], [ 0, %bb.k ] ; 2 uses
  %.pn38 = phi ptr [ %i.y, %.lr.ph ], [ %1, %bb.k ] ; 3 uses
  %.031 = getelementptr inbounds nuw i8, ptr %.pn38, i64 2
  call void @opj_read_bytes_LE(ptr noundef nonnull %.031, ptr noundef nonnull %i.a, i32 noundef 2) #6
  %i.u = getelementptr inbounds nuw i8, ptr %.pn38, i64 4
  %i.v = load i32, ptr %i.a, align 4, !tbaa !8
  %i.w = trunc i32 %i.v to i16
  %i.x = getelementptr inbounds nuw [6 x i8], ptr %i.p, i64 %indvars.iv ; 3 uses
  store i16 %i.w, ptr %i.x, align 2, !tbaa !36
  call void @opj_read_bytes_LE(ptr noundef nonnull %i.u, ptr noundef nonnull %i.a, i32 noundef 2) #6
  %i.y = getelementptr inbounds nuw i8, ptr %.pn38, i64 6 ; 2 uses
  %i.z = load i32, ptr %i.a, align 4, !tbaa !8
  %i.aa = trunc i32 %i.z to i16
  %i.ab = getelementptr inbounds nuw i8, ptr %i.x, i64 2
  store i16 %i.aa, ptr %i.ab, align 2, !tbaa !55
  call void @opj_read_bytes_LE(ptr noundef nonnull %i.y, ptr noundef nonnull %i.a, i32 noundef 2) #6
  %i.ac = load i32, ptr %i.a, align 4, !tbaa !8
  %i.ad = trunc i32 %i.ac to i16
  %i.ae = getelementptr inbounds nuw i8, ptr %i.x, i64 4
  store i16 %i.ad, ptr %i.ae, align 2, !tbaa !38
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %i.af = load ptr, ptr %i.b, align 8, !tbaa !54
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 8
  %i.ah = load i16, ptr %i.ag, align 8, !tbaa !27
  %i.ai = zext i16 %i.ah to i64
  %i.aj = icmp samesign ult i64 %indvars.iv.next, %i.ai
  br i1 %i.aj, label %.lr.ph, label %.loopexit, !llvm.loop !143

.loopexit:                                        ; preds = %.lr.ph, %bb.k, %bb.h, %bb.a, %bb.j, %bb.g, %bb.e, %bb.c
  %.030 = phi i32 [ 0, %bb.a ], [ 0, %bb.c ], [ 0, %bb.e ], [ 0, %bb.g ], [ 0, %bb.h ], [ 0, %bb.j ], [ 1, %bb.k ], [ 1, %.lr.ph ]
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #6
  ret i32 %.030
}
