...
bb.ao:                                            ; preds = %.lr.ph150, %.lr.ph
  ...
  %i.ew = load i16, ptr %i.ev, align 2, !tbaa !40
  ...
  %i.fa = load ptr, ptr %i.ez, align 8, !tbaa !116
  %i.fb = icmp eq ptr %i.fa, null
  br i1 %i.fb, label %._crit_edge.loopexit, label %.lr.ph, !llvm.loop !101
...
.lr.ph136.i:                                      ; preds = %._crit_edge.i27, %bb.as
  ...
  %i.fk = load i16, ptr %i.fj, align 2, !tbaa !40
  %i.fl = getelementptr inbounds nuw i8, ptr %i.fj, i64 2
  %i.fm = load i8, ptr %i.fl, align 2, !tbaa !41
...
bb.ar:                                            ; preds = %bb.aq, %.lr.ph136.i
  ...
  store ptr %i.gc, ptr %i.ge, align 8, !tbaa !116
...
.lr.ph155.i:                                      ; preds = %.preheader.i36, %.lr.ph155.i
  ...
  %i.gi = load ptr, ptr %i.gh, align 8, !tbaa !116
...
bb.as:                                            ; preds = %bb.ar
  ...
  store i32 %i.gm, ptr %i.gn, align 8, !tbaa !49
  ...
  store i32 %i.gq, ptr %i.gr, align 8, !tbaa !50
...
._crit_edge137.i:                                 ; preds = %bb.as
  %i.gs = load ptr, ptr %i.dq, align 8, !tbaa !114
  %i.gt = getelementptr inbounds nuw i8, ptr %i.gs, i64 32
  %i.gu = load i16, ptr %i.gt, align 8, !tbaa !51
...
.lr.ph147.i:                                      ; preds = %.loopexit.i33, %._crit_edge137.i
  ...
  %i.gy = load i16, ptr %i.gx, align 2, !tbaa !40
  %i.gz = getelementptr inbounds nuw i8, ptr %i.gx, i64 3
  %i.ha = load i8, ptr %i.gz, align 1, !tbaa !42  ; 2 uses
  ...
  %i.he = load ptr, ptr %i.hd, align 8, !tbaa !116 ; 10 uses
  ...
  %i.hn = load i8, ptr %i.hm, align 2, !tbaa !41
...
bb.at:                                            ; preds = %.lr.ph147.i
  ...
  %i.hq = load ptr, ptr %i.hp, align 8, !tbaa !116 ; 7 uses
  %.not161.i35 = icmp eq i32 %i.hl, 0
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <4 x i32>, ptr %i.ht, align 4, !tbaa !8
  %wide.load151 = load <4 x i32>, ptr %i.hu, align 4, !tbaa !8
  %i.hv = getelementptr inbounds nuw [4 x i8], ptr %i.hq, i64 %index ; 2 uses
  %i.hw = getelementptr inbounds nuw i8, ptr %i.hv, i64 16
  store <4 x i32> %wide.load, ptr %i.hv, align 4, !tbaa !8
  store <4 x i32> %wide.load151, ptr %i.hw, align 4, !tbaa !8
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.hx = icmp eq i64 %index.next, %n.vec
  br i1 %i.hx, label %middle.block, label %vector.body, !llvm.loop !104
...
.lr.ph144.i.prol:                                 ; preds = %.lr.ph144.i.preheader, %.lr.ph144.i.prol
  ...
  store i32 %i.hz, ptr %i.ia, align 4, !tbaa !8
