...
vector.memcheck:                                  ; preds = %.lr.ph.i.i.i.i.preheader
  ...
  %scevgep130 = getelementptr i8, ptr %scevgep, i64 %i.dk
  %scevgep131 = getelementptr i8, ptr %i.ct, i64 8
  %scevgep132 = getelementptr i8, ptr %scevgep131, i64 %i.dk
  %bound0 = icmp ult ptr %i.de, %scevgep132
  %bound1 = icmp ult ptr %i.ct, %scevgep130
...
begin_hunk_1_@_ZN27OpenImageIO_v3_1_Imf__3_3_59InputFile4Data10fillBufferENS_11FrameBuffer13ConstIteratorEiiiii:bb.a
  ...
  %7 = add nuw nsw i32 %i.m, 134221823
  %8 = lshr i32 %i.m, 13                          ; 2 uses
  %9 = and i32 %8, 1
  %i.ag = add nuw nsw i32 %7, %9
