...
.lr.ph211.us:                                     ; preds = %.lr.ph211.us.preheader, %LossyDctEncoder_rleAc.exit.us
  ...
  %.pn148210.us = phi i64 [ 720, %LossyDctEncoder_rleAc.exit.us ], [ 336, %.lr.ph211.us.preheader ]
  %.pn209.us = phi i64 [ 464, %LossyDctEncoder_rleAc.exit.us ], [ 80, %.lr.ph211.us.preheader ]
...
begin_hunk_2_@LossyDctEncoder_execute:bb.a
  ...
  %.0119.us = getelementptr inbounds nuw i8, ptr %2, i64 %.pn148210.us ; 4 uses
  %.0120.us = getelementptr inbounds nuw i8, ptr %2, i64 %.pn209.us ; 4 uses
...
float_to_half.exit64.i.us:                        ; preds = %bb.bh, %bb.bg, %bb.bf, %bb.be, %bb.bb, %bb.ba, %bb.ay
  ...
  %i.xm = getelementptr inbounds nuw [4 x i8], ptr %.0120.us, i64 %indvars.iv.i154.us
  %i.xn = load float, ptr %i.xm, align 4, !tbaa !186, !alias.scope !243, !noalias !248
  %i.xo = getelementptr inbounds nuw [4 x i8], ptr %.0120.us, i64 %i.sh
  %i.xp = load float, ptr %i.xo, align 4, !tbaa !186, !alias.scope !243, !noalias !248
  %i.xq = getelementptr inbounds nuw [4 x i8], ptr %.0120.us, i64 %i.ua
  %i.xr = load float, ptr %i.xq, align 4, !tbaa !186, !alias.scope !243, !noalias !248
  %i.xs = getelementptr inbounds nuw [4 x i8], ptr %.0120.us, i64 %i.vt
  %i.xt = load float, ptr %i.xs, align 4, !tbaa !186, !alias.scope !243, !noalias !248
  %i.xu = getelementptr inbounds nuw [2 x i8], ptr %.0119.us, i64 %indvars.iv.i154.us
  %i.xv = load i16, ptr %i.xu, align 2, !tbaa !92, !alias.scope !245, !noalias !249
  %i.xw = getelementptr inbounds nuw [2 x i8], ptr %.0119.us, i64 %i.sh
  %i.xx = load i16, ptr %i.xw, align 2, !tbaa !92, !alias.scope !245, !noalias !249
  %i.xy = getelementptr inbounds nuw [2 x i8], ptr %.0119.us, i64 %i.ua
  %i.xz = load i16, ptr %i.xy, align 2, !tbaa !92, !alias.scope !245, !noalias !249
  %i.ya = getelementptr inbounds nuw [2 x i8], ptr %.0119.us, i64 %i.vt
