...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %7 = select <4 x i1> %i.al, <4 x i1> %i.ap, <4 x i1> zeroinitializer
  %8 = icmp samesign ult <4 x i32> %i.t, splat (i32 855638017)
  ...
  %predphi3 = select <4 x i1> %8, <4 x i16> %i.w, <4 x i16> %predphi2
  %predphi4 = select <4 x i1> %7, <4 x i16> %i.ai, <4 x i16> %predphi3
  ...
  %9 = select <4 x i1> %i.cl, <4 x i1> %i.cp, <4 x i1> zeroinitializer
  %10 = icmp samesign ult <4 x i32> %i.bt, splat (i32 855638017)
  ...
  %predphi10 = select <4 x i1> %10, <4 x i16> %i.bw, <4 x i16> %predphi9
  %predphi11 = select <4 x i1> %9, <4 x i16> %i.ci, <4 x i16> %predphi10
