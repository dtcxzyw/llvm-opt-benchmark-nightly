...
.preheader162:                                    ; preds = %.preheader162.preheader, %._crit_edge216
  ...
  %3 = shl i64 %indvars.iv303, 3                  ; 2 uses
...
.preheader160.lr.ph:                              ; preds = %.preheader161
  %4 = shl nuw nsw i64 %indvars.iv298, 3          ; 6 uses
  %i.gx = load i32, ptr %i.e, align 4, !tbaa !209 ; 7 uses
  %reass.add = shl i32 %i.gx, 1                   ; 5 uses
  %i.gy = add nsw i32 %i.gx, -1                   ; 5 uses
  ...
  %6 = sext i32 %i.gx to i64
  %.not148.us.us.us = icmp slt i64 %4, %6
  %7 = xor i32 %5, -1
  %8 = add i32 %reass.add, %7
  %.0114.us.us.us = select i1 %.not148.us.us.us, i32 %5, i32 %8 ; 2 uses
  %9 = icmp slt i32 %.0114.us.us.us, 0
  %spec.select.us.us.us = select i1 %9, i32 %i.gy, i32 %.0114.us.us.us
  %10 = sext i32 %spec.select.us.us.us to i64     ; 2 uses
  %11 = trunc i64 %4 to i32                       ; 2 uses
  %12 = or disjoint i32 %11, 1                    ; 2 uses
  %.not148.us.us.us.1 = icmp slt i32 %12, %i.gx
  %13 = xor i32 %11, -2
  %14 = add i32 %reass.add, %13
  %.0114.us.us.us.1 = select i1 %.not148.us.us.us.1, i32 %12, i32 %14 ; 2 uses
  %15 = icmp slt i32 %.0114.us.us.us.1, 0
  %spec.select.us.us.us.1 = select i1 %15, i32 %i.gy, i32 %.0114.us.us.us.1
  %16 = sext i32 %spec.select.us.us.us.1 to i64   ; 2 uses
  %i.hc = trunc i64 %4 to i32                     ; 2 uses
  %17 = or disjoint i32 %i.hc, 2                  ; 2 uses
  %.not148.us.us.us.2 = icmp slt i32 %17, %i.gx
  %18 = xor i32 %i.hc, -3
  %19 = add i32 %reass.add, %18
  %.0114.us.us.us.2 = select i1 %.not148.us.us.us.2, i32 %17, i32 %19 ; 2 uses
  %20 = icmp slt i32 %.0114.us.us.us.2, 0
  %spec.select.us.us.us.2 = select i1 %20, i32 %i.gy, i32 %.0114.us.us.us.2
  %21 = sext i32 %spec.select.us.us.us.2 to i64   ; 2 uses
  %22 = trunc i64 %4 to i32                       ; 2 uses
  %23 = or disjoint i32 %22, 3                    ; 2 uses
  %.not148.us.us.us.3 = icmp slt i32 %23, %i.gx
  %24 = xor i32 %22, -4
  %25 = add i32 %reass.add, %24
  %.0114.us.us.us.3 = select i1 %.not148.us.us.us.3, i32 %23, i32 %25 ; 2 uses
  %26 = icmp slt i32 %.0114.us.us.us.3, 0
  %spec.select.us.us.us.3 = select i1 %26, i32 %i.gy, i32 %.0114.us.us.us.3
  %27 = sext i32 %spec.select.us.us.us.3 to i64   ; 2 uses
  %28 = trunc i64 %4 to i32
  %i.hd = insertelement <4 x i32> poison, i32 %28, i64 0
  %i.he = shufflevector <4 x i32> %i.hd, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  %29 = or disjoint <4 x i32> %i.he, <i32 4, i32 5, i32 6, i32 7> ; 2 uses
  %30 = insertelement <4 x i32> poison, i32 %i.gx, i64 0
  %31 = shufflevector <4 x i32> %30, <4 x i32> poison, <4 x i32> zeroinitializer
  %32 = icmp slt <4 x i32> %29, %31
  %33 = xor <4 x i32> %i.he, <i32 -5, i32 -6, i32 -7, i32 -8>
  %34 = insertelement <4 x i32> poison, i32 %reass.add, i64 0
  %35 = shufflevector <4 x i32> %34, <4 x i32> poison, <4 x i32> zeroinitializer
  %36 = add <4 x i32> %35, %33
  %37 = select <4 x i1> %32, <4 x i32> %29, <4 x i32> %36 ; 2 uses
  %38 = icmp slt <4 x i32> %37, zeroinitializer
  %39 = insertelement <4 x i32> poison, i32 %i.gy, i64 0
  %40 = shufflevector <4 x i32> %39, <4 x i32> poison, <4 x i32> zeroinitializer
  %i.hf = select <4 x i1> %38, <4 x i32> %40, <4 x i32> %37 ; 4 uses
  %i.hg = extractelement <4 x i32> %i.hf, i64 0
  %i.hh = sext i32 %i.hg to i64                   ; 2 uses
  %i.hi = extractelement <4 x i32> %i.hf, i64 1
  %i.hj = sext i32 %i.hi to i64                   ; 2 uses
  %i.hk = extractelement <4 x i32> %i.hf, i64 2
  %i.hl = sext i32 %i.hk to i64                   ; 2 uses
  %i.hm = extractelement <4 x i32> %i.hf, i64 3
...
.preheader.us.us:                                 ; preds = %half_to_float.exit.us.us.us.7, %.preheader160.us
  ...
  %i.ib = getelementptr inbounds [2 x i8], ptr %i.hz, i64 %10
...
half_to_float.exit.us.us.us:                      ; preds = %bb.v, %bb.u, %bb.s, %bb.r
  ...
  %i.iu = getelementptr inbounds [2 x i8], ptr %i.hz, i64 %16
...
half_to_float.exit.us.us.us.1:                    ; preds = %bb.aa, %bb.z, %bb.x, %bb.w
  ...
  %i.jo = getelementptr inbounds [2 x i8], ptr %i.hz, i64 %21
...
.preheader:                                       ; preds = %.preheader160, %half_to_float.exit.7
  ...
  %i.ov = add i64 %indvars.iv271, %3
  %i.ow = trunc i64 %i.ov to i32                  ; 3 uses
  ...
  %i.pe = getelementptr inbounds [2 x i8], ptr %i.pc, i64 %10
...
half_to_float.exit:                               ; preds = %bb.bg, %bb.bh, %bb.bi, %bb.bj
  ...
  %i.qa = getelementptr inbounds [2 x i8], ptr %i.pc, i64 %16
...
half_to_float.exit.1:                             ; preds = %bb.bo, %bb.bn, %bb.bl, %bb.bk
  ...
  %i.qx = getelementptr inbounds [2 x i8], ptr %i.pc, i64 %21
