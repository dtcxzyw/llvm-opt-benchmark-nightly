...
bb.b:                                             ; preds = %bb.a
  ...
  %.sroa.5.0.copyload = load i64, ptr %.sroa.5.0..sroa_idx, align 1 ; 7 uses
...
bb.ag:                                            ; preds = %DwaCompressor_readChannelRules.exit
  ...
  %7 = icmp slt i64 %.sroa.5.0.copyload, 0
  %or.cond480 = select i1 %i.em, i1 true, i1 %7
  %i.en = icmp ugt ptr %i.ej, %i.j
  %or.cond481 = select i1 %or.cond480, i1 true, i1 %i.en
