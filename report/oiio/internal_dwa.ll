...
begin_hunk_0_@dctInverse8x8_scalar:bb.a
  ...
  %i.ae = insertelement <4 x float> %i.ad, float %i.ac, i64 2
  %i.af = insertelement <4 x float> %i.ae, float %i.ab, i64 3
  %2 = shufflevector <4 x float> %i.af, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
  ...
  %i.ai = insertelement <4 x float> %i.ah, float %i.ab, i64 2
  %i.aj = insertelement <4 x float> %i.ai, float %i.ac, i64 3
  %3 = shufflevector <4 x float> %i.aj, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 2, i32 3>
