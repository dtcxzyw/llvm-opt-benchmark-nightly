...
.lr.ph.preheader:                                 ; preds = %bb.b
  ...
  %4 = ptrtoint ptr %i.i to i64                   ; 3 uses
  %i.n = add i64 %.idx, %4
  %i.o = add i64 %4, 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep29.a = getelementptr i8, ptr %i.i, i64 %i.af
  ...
  store <8 x i16> %interleaved.vec, ptr %next.gep29.a, align 2, !tbaa !80, !alias.scope !94, !noalias !91
...
.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  ...
  %n.vec62 = and i64 %i.j, 4294967288             ; 4 uses
  %i.k = trunc nuw i64 %n.vec62 to i32
  %i.l = shl nuw nsw i64 %n.vec62, 1              ; 3 uses
  %cmp.n72 = icmp eq i64 %n.vec62, %i.j
...
.preheader.us:                                    ; preds = %.preheader.us.preheader, %._crit_edge.us.us.1
  ...
  %.02237.us = phi i64 [ 0, %.preheader.us.preheader ], [ %indvars.iv.next.1, %._crit_edge.us.us.1 ] ; 3 uses
  ...
  %i.s = getelementptr inbounds nuw [8 x i8], ptr %i.a, i64 %.02237.us
...
vector.memcheck53:                                ; preds = %.preheader.us
  ...
  %i.v = sub i64 %i.r, %i.u
  %diff.check54 = icmp ugt i64 %i.v, -16
  %i.w = sub i64 %.028.us.us55, %i.u
  %diff.check56 = icmp ugt i64 %i.w, -16
...
vector.body63:                                    ; preds = %vector.body63, %vector.ph60
  ...
  %i.aa = shl i64 %index64, 1                     ; 3 uses
  %next.gep65 = getelementptr i8, ptr %i.q, i64 %i.aa
  %next.gep66 = getelementptr i8, ptr %i.t, i64 %i.aa
  %next.gep67 = getelementptr i8, ptr %.028.us.us, i64 %i.aa
  %wide.load68 = load <8 x i16>, ptr %next.gep65, align 2, !tbaa !80
  %i.ab = sext <8 x i16> %wide.load68 to <8 x i32>
  %i.ac = mul nsw <8 x i32> %i.ab, splat (i32 3)
  %wide.load69 = load <8 x i16>, ptr %next.gep67, align 2, !tbaa !80
  %i.ad = sext <8 x i16> %wide.load69 to <8 x i32>
  ...
  store <8 x i16> %i.ah, ptr %next.gep66, align 2, !tbaa !80
  %index.next70 = add nuw i64 %index64, 8         ; 2 uses
  %i.ai = icmp eq i64 %index.next70, %n.vec62
  br i1 %i.ai, label %middle.block71, label %vector.body63, !llvm.loop !99
...
scalar.ph58.preheader:                            ; preds = %vector.memcheck53, %.preheader.us, %middle.block71
  %.02433.us.us.ph = phi i32 [ 0, %vector.memcheck53 ], [ 0, %.preheader.us ], [ %i.k, %middle.block71 ] ; 4 uses
  %.02632.us.us.ph = phi ptr [ %i.q, %vector.memcheck53 ], [ %i.q, %.preheader.us ], [ %i.x, %middle.block71 ] ; 3 uses
  %.02731.us.us.ph = phi ptr [ %i.t, %vector.memcheck53 ], [ %i.t, %.preheader.us ], [ %i.y, %middle.block71 ] ; 3 uses
  %.12930.us.us.ph = phi ptr [ %.028.us.us, %vector.memcheck53 ], [ %.028.us.us, %.preheader.us ], [ %i.z, %middle.block71 ] ; 3 uses
...
.preheader:                                       ; preds = %.preheader.lr.ph, %._crit_edge.1
  ...
  %i.cg = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv ; 3 uses
...
._crit_edge.1:                                    ; preds = %bb.c
  ...
  %indvars.iv.next73 = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next73, %wide.trip.count81
...
.lr.ph.preheader:                                 ; preds = %bb.b
  ...
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !78   ; 6 uses
  %4 = ptrtoint ptr %i.g to i64                   ; 3 uses
  %i.n = add i64 %.idx, %4
  %i.o = add i64 %4, 4
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep = getelementptr i8, ptr %i.m, i64 %i.ae ; 2 uses
  %i.af = shl i64 %index, 2                       ; 2 uses
  %next.gep41.a = getelementptr i8, ptr %i.g, i64 %i.af
  ...
  %interleaved.vec = shufflevector <4 x i16> %wide.load, <4 x i16> poison, <8 x i32> <i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3>
  store <8 x i16> %interleaved.vec, ptr %next.gep41.a, align 2, !tbaa !80, !alias.scope !109, !noalias !106
