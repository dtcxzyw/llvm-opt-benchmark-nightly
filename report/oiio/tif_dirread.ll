...
end_hunk_0
begin_hunk_1_@TIFFGetStrileOffset:bb.a

; Function Attrs: nounwind uwtable
define i64 @TIFFGetStrileOffsetWithErr(ptr noundef %0, i32 noundef %1, ptr nofree noundef writeonly captures(address_is_null) %2) local_unnamed_addr #0 {
bb.a:
...
; Function Attrs: nounwind uwtable
define internal fastcc i64 @_TIFFGetStrileOffsetOrByteCountValue(ptr noundef %0, i32 noundef %1, ptr nofree noundef readonly captures(none) %2, ptr nofree noundef readonly captures(none) %3, ptr nofree noundef writeonly captures(address_is_null) %4) unnamed_addr #0 {
bb.a:
...
bb.h:                                             ; preds = %bb.e
  ...
  br i1 %.not.i, label %bb.i, label %bb.ay
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.bq = icmp ult i16 %switch.tableidx, 15
  %switch.shifted = lshr i16 24579, %switch.tableidx
  %switch.lobit = trunc i16 %switch.shifted to i1
  %or.cond52 = select i1 %i.bq, i1 %switch.lobit, i1 false
  br i1 %or.cond52, label %switch.lookup, label %bb.u
...
switch.lookup:                                    ; preds = %bb.t
  ...
  br i1 %.not116.i.i, label %bb.x, label %bb.v

bb.v:                                             ; preds = %switch.lookup
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b) #15
  %i.bw = load i64, ptr %i.bv, align 8, !tbaa !53 ; 2 uses
  store i64 %i.bw, ptr %i.b, align 8, !tbaa !85
...
bb.x:                                             ; preds = %switch.lookup
  ...
  %i.bx = load i32, ptr %i.bv, align 8, !tbaa !53 ; 2 uses
  store i32 %i.bx, ptr %i.c, align 4, !tbaa !3
  br i1 %.not.i.i, label %.thread.i.i, label %bb.y
...
.thread.i.i:                                      ; preds = %bb.y, %bb.x
  %i.by = phi i32 [ %i.bx, %bb.x ], [ %.pre.i.i, %bb.y ]
  %i.bz = zext i32 %i.by to i64
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c) #15
  br label %bb.ab

bb.z:                                             ; preds = %bb.w, %bb.v
  %i.ca = phi i64 [ %i.bw, %bb.v ], [ %.pr.i.i, %bb.w ] ; 2 uses
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.cd = getelementptr inbounds [8 x i8], ptr %i.bg, i64 %i.cc
  store i64 0, ptr %i.cd, align 8, !tbaa !85
  br label %bb.ax
...
bb.ab:                                            ; preds = %bb.z, %.thread.i.i
  ...
  br i1 %.not117.i.i, label %bb.ad, label %bb.ac

bb.ac:                                            ; preds = %bb.ab
  call void (ptr, ptr, ptr, ...) @TIFFErrorExtR(ptr noundef nonnull %0, ptr noundef nonnull @_TIFFPartialReadStripArray.module, ptr noundef nonnull @.str.97, i32 noundef %1) #15
  %i.cp = getelementptr inbounds [8 x i8], ptr %i.bg, i64 %i.ce
  store i64 0, ptr %i.cp, align 8, !tbaa !85
  br label %bb.ax

bb.ad:                                            ; preds = %bb.ab
  %i.cq = call i32 @_TIFFSeekOK(ptr noundef nonnull %0, i64 noundef %i.ch) #15
  %.not118.i.i = icmp eq i32 %i.cq, 0
  br i1 %.not118.i.i, label %bb.ae, label %bb.af

bb.ae:                                            ; preds = %bb.ad
  %i.cr = getelementptr inbounds [8 x i8], ptr %i.bg, i64 %i.ce
  store i64 0, ptr %i.cr, align 8, !tbaa !85
  br label %bb.ax

bb.af:                                            ; preds = %bb.ad
  %i.cs = sub i64 %.1.i.i, %i.ch                  ; 2 uses
  ...
  %i.cx = call i64 %i.cu(ptr noundef %i.cw, ptr noundef nonnull %i.a, i64 noundef %i.cs) #15, !inline_history !166
  %i.cy = icmp slt i64 %i.cx, %i.cs
...
bb.ah:                                            ; preds = %bb.af
  ...
  %i.dd = sub nsw i32 %1, %spec.select120.i.i     ; 2 uses
  %i.de = icmp ult i32 %i.dd, %i.bi
  br i1 %i.de, label %.lr.ph.i.i, label %_TIFFPartialReadStripArray.exit.i

.lr.ph.i.i:                                       ; preds = %bb.ah
  %.0105.i.i = sub i32 0, %spec.select120.i.i
  %i.df = getelementptr inbounds nuw i8, ptr %i.a, i64 %i.cz
  %i.dg = sext i32 %.0105.i.i to i64
  br label %bb.ai

bb.ai:                                            ; preds = %bb.aw, %.lr.ph.i.i
...
bb.ak:                                            ; preds = %bb.aj
  ...
  store i16 %i.dn, ptr %i.d, align 2
...
bb.am:                                            ; preds = %bb.al, %bb.ak
  %i.do = phi i16 [ %.pre128.i.i, %bb.al ], [ %i.dn, %bb.ak ]
  %i.dp = zext i16 %i.do to i64
  %i.dq = sext i32 %i.dh to i64
  %i.dr = getelementptr inbounds [8 x i8], ptr %i.bg, i64 %i.dq
  store i64 %i.dp, ptr %i.dr, align 8, !tbaa !85
  call void @llvm.lifetime.end.p0(ptr nonnull %i.d) #15
  br label %bb.aw

bb.an:                                            ; preds = %bb.aj
  call void @llvm.lifetime.start.p0(ptr nonnull %i.e) #15
  %i.ds = load i32, ptr %i.dm, align 1            ; 2 uses
  store i32 %i.ds, ptr %i.e, align 4
...
bb.ap:                                            ; preds = %bb.ao, %bb.an
  %i.dt = phi i32 [ %.pre127.i.i, %bb.ao ], [ %i.ds, %bb.an ]
  %i.du = zext i32 %i.dt to i64
  %i.dv = sext i32 %i.dh to i64
  %i.dw = getelementptr inbounds [8 x i8], ptr %i.bg, i64 %i.dv
  store i64 %i.du, ptr %i.dw, align 8, !tbaa !85
  call void @llvm.lifetime.end.p0(ptr nonnull %i.e) #15
  br label %bb.aw

bb.aq:                                            ; preds = %bb.aj
  call void @llvm.lifetime.start.p0(ptr nonnull %i.f) #15
  %i.dx = load i64, ptr %i.dm, align 1            ; 2 uses
  store i64 %i.dx, ptr %i.f, align 8
...
bb.as:                                            ; preds = %bb.ar, %bb.aq
  %i.dy = phi i64 [ %.pre126.i.i, %bb.ar ], [ %i.dx, %bb.aq ]
  %i.dz = sext i32 %i.dh to i64
  %i.ea = getelementptr inbounds [8 x i8], ptr %i.bg, i64 %i.dz
  store i64 %i.dy, ptr %i.ea, align 8, !tbaa !85
  call void @llvm.lifetime.end.p0(ptr nonnull %i.f) #15
  br label %bb.aw

bb.at:                                            ; preds = %bb.aj
  call void @llvm.lifetime.start.p0(ptr nonnull %i.g) #15
  %i.eb = load i64, ptr %i.dm, align 1            ; 2 uses
  store i64 %i.eb, ptr %i.g, align 8
...
bb.av:                                            ; preds = %bb.au, %bb.at
  %i.ec = phi i64 [ %.pre129.i.i, %bb.au ], [ %i.eb, %bb.at ]
  %i.ed = sext i32 %i.dh to i64
  %i.ee = getelementptr inbounds [8 x i8], ptr %i.bg, i64 %i.ed
  store i64 %i.ec, ptr %i.ee, align 8, !tbaa !85
  call void @llvm.lifetime.end.p0(ptr nonnull %i.g) #15
  br label %bb.aw

bb.aw:                                            ; preds = %bb.av, %bb.as, %bb.ap, %bb.am
  %i.ef = trunc i64 %indvars.iv.next.i.i to i32
  %i.eg = add i32 %1, %i.ef                       ; 2 uses
  %i.eh = icmp ult i32 %i.eg, %i.bi
  br i1 %i.eh, label %bb.ai, label %_TIFFPartialReadStripArray.exit.i

_TIFFPartialReadStripArray.exit.i:                ; preds = %bb.aw, %bb.ai, %bb.ah
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #15
  br label %_TIFFFetchStrileValue.exit

bb.ax:                                            ; preds = %bb.ag, %bb.ae, %bb.ac, %bb.aa, %bb.u
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a) #15
  %i.ei = load ptr, ptr %3, align 8, !tbaa !100
  %i.ej = getelementptr inbounds nuw [8 x i8], ptr %i.ei, i64 %i.r
  store i64 0, ptr %i.ej, align 8, !tbaa !85
  br label %bb.ay

bb.ay:                                            ; preds = %bb.h, %bb.q, %bb.ax, %bb.r, %bb.l
  br i1 %i.h, label %bb.az, label %bb.be
...
_TIFFFetchStrileValue.exit:                       ; preds = %_TIFFPartialReadStripArray.exit.i, %bb.s, %bb.g, %bb.f, %bb.c
  %i.ek = load ptr, ptr %3, align 8, !tbaa !100   ; 2 uses
  %i.el = icmp eq ptr %i.ek, null
  br i1 %i.el, label %bb.bb, label %bb.ba

bb.ba:                                            ; preds = %_TIFFFetchStrileValue.exit
  %i.em = getelementptr inbounds nuw i8, ptr %0, i64 228
  %i.en = load i32, ptr %i.em, align 4, !tbaa !139
  %.not30 = icmp ult i32 %1, %i.en
  br i1 %.not30, label %bb.bd, label %bb.bb

bb.bb:                                            ; preds = %bb.ba, %_TIFFFetchStrileValue.exit
  br i1 %i.h, label %bb.bc, label %bb.be
...
bb.be:                                            ; preds = %bb.bb, %bb.bc, %bb.ay, %bb.az, %bb.bd
  %.0 = phi i64 [ 0, %bb.ay ], [ %i.eq, %bb.bd ], [ 0, %bb.az ], [ 0, %bb.bc ], [ 0, %bb.bb ]
  ret i64 %.0
}

; Function Attrs: nounwind uwtable
define i64 @TIFFGetStrileByteCountWithErr(ptr noundef %0, i32 noundef %1, ptr nofree noundef writeonly captures(address_is_null) %2) local_unnamed_addr #0 {
bb.a:
