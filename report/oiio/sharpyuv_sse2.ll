...
vector.body74:                                    ; preds = %vector.body74, %vector.ph69
  ...
  %6 = freeze <8 x i16> %wide.vec80               ; 2 uses
  ...
  %i.aq = add nsw <4 x i32> %i.ai, %9             ; 2 uses
  ...
  %i.at = add nsw <4 x i32> %i.an, %10            ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <8 x i16>, ptr %i.fp, align 2, !tbaa !12, !alias.scope !57
  %11 = freeze <8 x i16> %wide.vec                ; 2 uses
  %12 = bitcast <8 x i16> %11 to <4 x i32>
  %13 = bitcast <8 x i16> %11 to <4 x i32>
  %14 = and <4 x i32> %13, splat (i32 65535)
  %15 = lshr <4 x i32> %12, splat (i32 16)
  %i.fq = add nsw <4 x i32> %i.fi, %14            ; 2 uses
  ...
  %i.ft = add nsw <4 x i32> %i.fn, %15            ; 2 uses
