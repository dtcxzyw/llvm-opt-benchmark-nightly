...
bb.a:
  ...
  %18 = load <4 x float>, ptr %i.ae, align 8
  ...
  %i.aj = insertelement <2 x float> %i.ai, float %9, i64 1
  %i.ak = shufflevector <4 x float> %18, <4 x float> poison, <2 x i32> zeroinitializer
  %i.al = fmul <2 x float> %i.aj, %i.ak           ; 5 uses
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %18 = load <4 x float>, ptr %i.k, align 4
  %i.l = getelementptr inbounds nuw i8, ptr %3, i64 40
  %19 = load <4 x float>, ptr %i.l, align 8
  %i.m = insertelement <2 x float> poison, float %10, i64 0
  %i.n = insertelement <2 x float> %i.m, float %8, i64 1
  %i.o = shufflevector <4 x float> %18, <4 x float> poison, <2 x i32> zeroinitializer
  %i.p = fmul <2 x float> %i.n, %i.o              ; 5 uses
  %i.q = insertelement <2 x float> poison, float %11, i64 0
  %i.r = insertelement <2 x float> %i.q, float %9, i64 1
  %i.s = shufflevector <4 x float> %19, <4 x float> poison, <2 x i32> zeroinitializer
  %i.t = fmul <2 x float> %i.r, %i.s              ; 5 uses
