...
bb.aa:                                            ; preds = %bb.x, %bb.w
  ...
  %i.ep = fneg float %7
  %i.eq = fneg float %9
  %.0209 = select i1 %i.en, float %i.eq, float %9 ; 2 uses
  %.0206 = select i1 %i.en, float %i.ep, float %7 ; 2 uses
...
bb.ab:                                            ; preds = %bb.aa
  ...
  %i.fg = fmul float %.0206, %i.ex
  %i.fh = fmul float %.0209, %i.ex
  %i.fi = extractelement <2 x float> %i.ff, i64 0
  %i.fj = extractelement <2 x float> %i.ff, i64 1
  br label %bb.ac

bb.ac:                                            ; preds = %bb.ab, %bb.aa
  %.1210 = phi float [ %.0209, %bb.aa ], [ %i.fh, %bb.ab ] ; 2 uses
  %.0208 = phi float [ %8, %bb.aa ], [ %i.fa, %bb.ab ] ; 2 uses
  %.1207 = phi float [ %.0206, %bb.aa ], [ %i.fg, %bb.ab ] ; 2 uses
...
bb.ao:                                            ; preds = %bb.ac
  ...
  %i.gt = tail call noundef zeroext i1 %i.gs(ptr noundef nonnull align 8 dereferenceable(188) %0, ptr noundef nonnull align 8 dereferenceable(400) %i.ac, ptr noundef nonnull %i.r, ptr noundef nonnull align 8 dereferenceable(76) %3, i32 noundef 4, i32 noundef %.1.i, float noundef %.1201, float noundef %.2204, float noundef %.0205, float noundef %.1207, float noundef %.0208, float noundef %.1210, ptr noundef %11, ptr noundef %12, ptr noundef %13) ; 2 uses
