...
vector.body353:                                   ; preds = %vector.body353, %vector.ph352
  ...
  %i.eu = getelementptr [8 x i8], ptr %9, i64 %index354 ; 2 uses
  %i.ev = getelementptr i8, ptr %i.eu, i64 1816
  %i.ew = getelementptr [8 x i8], ptr %9, i64 %index354
  %i.ex = getelementptr i8, ptr %i.ew, i64 1824
...
vector.body332:                                   ; preds = %vector.body332, %vector.ph331
  ...
  %i.ht = getelementptr [8 x i8], ptr %9, i64 %index333 ; 2 uses
  %i.hu = getelementptr i8, ptr %i.ht, i64 1816
  %i.hv = getelementptr [8 x i8], ptr %9, i64 %index333
  %i.hw = getelementptr i8, ptr %i.hv, i64 1824
...
vector.body311:                                   ; preds = %vector.body311, %vector.ph310
  ...
  %i.ks = getelementptr [8 x i8], ptr %9, i64 %index312 ; 2 uses
  %i.kt = getelementptr i8, ptr %i.ks, i64 1816
  %i.ku = getelementptr [8 x i8], ptr %9, i64 %index312
  %i.kv = getelementptr i8, ptr %i.ku, i64 1824
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.nr = getelementptr [8 x i8], ptr %9, i64 %index ; 2 uses
  %i.ns = getelementptr i8, ptr %i.nr, i64 1816
  %i.nt = getelementptr [8 x i8], ptr %9, i64 %index
  %i.nu = getelementptr i8, ptr %i.nt, i64 1824
