...
_ZN11OpenImageIO4v3_116st_to_texel_simdERKNS0_4simd7vfloat4ES4_RNS0_14ImageCacheFileERKNS5_9ImageDimsERNS1_5vint4ESB_RS2_SC_.exit: ; preds = %bb.h, %bb.i
  ...
  %32 = extractelement <4 x float> %bc136.i, i64 1
  %i.gf = extractelement <4 x float> %bc136.i, i64 2
  %33 = extractelement <4 x float> %bc136.i, i64 3
  %34 = call float @llvm.floor.f32(float %i.gf)
  %i.gg = call float @llvm.floor.f32(float %i.ge)
  %35 = call float @llvm.floor.f32(float %33)
  %i.gh = call float @llvm.floor.f32(float %32)
  %i.gi = insertelement <2 x float> poison, float %i.gg, i64 0
  %i.gj = insertelement <2 x float> %i.gi, float %34, i64 1
  %i.gk = bitcast <2 x float> %i.gj to <2 x i32>
  %i.gl = insertelement <2 x float> poison, float %i.gh, i64 0
  %i.gm = insertelement <2 x float> %i.gl, float %35, i64 1
  ...
  %36 = extractelement <4 x float> %bc140.i, i64 1
  %i.gw = extractelement <4 x float> %bc140.i, i64 2
  %37 = extractelement <4 x float> %bc140.i, i64 3
  %38 = call float @llvm.floor.f32(float %i.gw)
  %i.gx = call float @llvm.floor.f32(float %i.gv)
  %39 = call float @llvm.floor.f32(float %37)
  %i.gy = call float @llvm.floor.f32(float %36)
  %i.gz = insertelement <2 x float> poison, float %i.gx, i64 0
  %i.ha = insertelement <2 x float> %i.gz, float %38, i64 1
  %i.hb = bitcast <2 x float> %i.ha to <2 x i32>
  %i.hc = insertelement <2 x float> poison, float %i.gy, i64 0
  %i.hd = insertelement <2 x float> %i.hc, float %39, i64 1
...
_ZN11OpenImageIO4v3_116st_to_texel_simdERKNS0_4simd7vfloat4ES4_RNS0_14ImageCacheFileERKNS5_9ImageDimsERNS1_5vint4ESB_RS2_SC_.exit: ; preds = %bb.e, %bb.f
  ...
  %39 = extractelement <4 x float> %bc136.i, i64 1
  %i.iw = extractelement <4 x float> %bc136.i, i64 2
  %40 = extractelement <4 x float> %bc136.i, i64 3
  %41 = call float @llvm.floor.f32(float %i.iw)
  %i.ix = call float @llvm.floor.f32(float %i.iv)
  %42 = call float @llvm.floor.f32(float %40)
  %i.iy = call float @llvm.floor.f32(float %39)
  %i.iz = insertelement <2 x float> poison, float %i.ix, i64 0
  %i.ja = insertelement <2 x float> %i.iz, float %41, i64 1
  %i.jb = bitcast <2 x float> %i.ja to <2 x i32>
  %i.jc = insertelement <2 x float> poison, float %i.iy, i64 0
  %i.jd = insertelement <2 x float> %i.jc, float %42, i64 1
  ...
  %43 = extractelement <4 x float> %bc140.i, i64 1
  %i.jn = extractelement <4 x float> %bc140.i, i64 2
  %44 = extractelement <4 x float> %bc140.i, i64 3
  %45 = call float @llvm.floor.f32(float %i.jn)
  %i.jo = call float @llvm.floor.f32(float %i.jm)
  %46 = call float @llvm.floor.f32(float %44)
  %i.jp = call float @llvm.floor.f32(float %43)
  %i.jq = insertelement <2 x float> poison, float %i.jo, i64 0
  %i.jr = insertelement <2 x float> %i.jq, float %45, i64 1
  %i.js = bitcast <2 x float> %i.jr to <2 x i32>
  %i.jt = insertelement <2 x float> poison, float %i.jp, i64 0
  %i.ju = insertelement <2 x float> %i.jt, float %46, i64 1
