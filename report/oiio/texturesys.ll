...
bb.a:
  ...
  %18 = load <4 x float>, ptr %i.ac, align 4
  %19 = getelementptr inbounds nuw i8, ptr %3, i64 40
  %20 = load float, ptr %19, align 8, !tbaa !283
  %i.ad = insertelement <2 x float> %i.g, float %8, i64 1
  %i.ae = shufflevector <4 x float> %18, <4 x float> poison, <2 x i32> zeroinitializer
  %i.af = fmul <2 x float> %i.ad, %i.ae           ; 5 uses
  %i.ag = insertelement <2 x float> poison, float %11, i64 0
  %21 = insertelement <2 x float> %i.ag, float %9, i64 1
  %i.ah = insertelement <2 x float> poison, float %20, i64 0
  %22 = shufflevector <2 x float> %i.ah, <2 x float> poison, <2 x i32> zeroinitializer
  %i.ai = fmul <2 x float> %21, %22               ; 5 uses
...
_ZN11OpenImageIO4v3_112ellipse_axesEffffRfS1_S1_Pf.exit: ; preds = %_ZN11OpenImageIO4v3_112adjust_widthERfS1_S1_S1_ff.exit, %bb.f, %bb.h, %bb.i
  ...
  %23 = load float, ptr %i.dh, align 8, !tbaa !280 ; 2 uses
  %24 = getelementptr inbounds nuw i8, ptr %3, i64 28
  %25 = load float, ptr %24, align 4, !tbaa !281  ; 2 uses
  %26 = fadd float %23, %25
  %i.di = fcmp une float %26, 0.000000e+00
...
bb.j:                                             ; preds = %_ZN11OpenImageIO4v3_112ellipse_axesEffffRfS1_S1_Pf.exit
  ...
  %i.fd = fmul <2 x float> %28, %i.fc
  %29 = insertelement <2 x float> poison, float %23, i64 0
  %i.fe = shufflevector <2 x float> %29, <2 x float> poison, <2 x i32> zeroinitializer
...
bb.e:                                             ; preds = %bb.d, %bb.c
  ...
  %21 = insertelement <2 x float> %i.l, float %8, i64 1
  %i.m = insertelement <2 x float> poison, float %18, i64 0
  %i.n = shufflevector <2 x float> %i.m, <2 x float> poison, <2 x i32> zeroinitializer
  %i.o = fmul <2 x float> %21, %i.n               ; 5 uses
  %i.p = insertelement <2 x float> poison, float %11, i64 0
  %22 = insertelement <2 x float> %i.p, float %9, i64 1
  %i.q = insertelement <2 x float> poison, float %20, i64 0
  %23 = shufflevector <2 x float> %i.q, <2 x float> poison, <2 x i32> zeroinitializer
  %i.r = fmul <2 x float> %22, %23                ; 5 uses
