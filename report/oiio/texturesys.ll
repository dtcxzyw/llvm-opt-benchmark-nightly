...
bb.bu:                                            ; preds = %bb.bt, %bb.bs
  ...
  %i.apv = fdiv <4 x float> %i.apu, %i.apt        ; 8 uses
  %i.apw = shufflevector <4 x float> %i.apv, <4 x float> poison, <4 x i32> zeroinitializer ; 5 uses
  %i.apx = fsub <4 x float> splat (float 1.000000e+00), %i.apw ; 4 uses
  %i.apy = shufflevector <4 x float> %i.apv, <4 x float> poison, <4 x i32> <i32 1, i32 1, i32 1, i32 1> ; 5 uses
  ...
  %i.aqf = fmul <4 x float> %i.apw, %i.aqe
  ...
  %i.aqk = fmul <4 x float> %i.apy, %i.aqj
  ...
  %i.aqp = load <4 x float>, ptr %i.ee, align 16, !tbaa !34 ; 3 uses
  %i.aqq = fmul <4 x float> %i.apx, %i.aqp
  %i.aqr = load <4 x float>, ptr %i.ew, align 16, !tbaa !34 ; 3 uses
  %i.aqs = fmul <4 x float> %i.apw, %i.aqr
  ...
  %i.aqx = fmul <4 x float> %i.apy, %i.aqw
  ...
  %i.arf = fmul <4 x float> %i.apw, %i.are
  ...
  %i.ark = fmul <4 x float> %i.apy, %i.arj
  ...
  %i.ars = fmul <4 x float> %i.apw, %i.arr
  ...
  %i.arx = fmul <4 x float> %i.apy, %i.arw
  ...
  %39 = shufflevector <4 x float> %i.apv, <4 x float> poison, <4 x i32> <i32 2, i32 2, i32 2, i32 2> ; 2 uses
  %i.asc = fsub <4 x float> splat (float 1.000000e+00), %39
  %i.asd = fmul <4 x float> %i.asc, %i.aqo
  %i.ase = fmul <4 x float> %39, %i.arb
  %i.asf = fadd <4 x float> %i.asd, %i.ase
  %40 = shufflevector <4 x float> %i.apv, <4 x float> poison, <4 x i32> <i32 3, i32 3, i32 3, i32 3> ; 2 uses
  %i.asg = fsub <4 x float> splat (float 1.000000e+00), %40
  %i.ash = fmul <4 x float> %i.asg, %i.aro
  %i.asi = fmul <4 x float> %40, %i.asb
...
bb.bv:                                            ; preds = %bb.bu
  ...
  %i.atg = fmul <4 x float> %i.atf, %i.aqp
  ...
  %i.avr = fmul <4 x float> %i.avd, %i.aqp
...
bb.bx:                                            ; preds = %bb.bw
  ...
  %i.axe = extractelement <4 x float> %i.apv, i64 0 ; 5 uses
  ...
  %i.axk = extractelement <4 x float> %i.apv, i64 1 ; 5 uses
  ...
  %i.azk = extractelement <4 x float> %i.apv, i64 2 ; 2 uses
  ...
  %i.azo = extractelement <4 x float> %i.apv, i64 3 ; 2 uses
