...
bb.d:                                             ; preds = %.lr.ph, %_ZNSt6vectorIN11OpenImageIO4v3_17ustringESaIS2_EE12emplace_backIJS2_EEERS2_DpOT_.exit
  %i.d = phi ptr [ %.pre16, %.lr.ph ], [ %i.am, %_ZNSt6vectorIN11OpenImageIO4v3_17ustringESaIS2_EE12emplace_backIJS2_EEERS2_DpOT_.exit ] ; 5 uses
  %i.e = phi ptr [ %.pre, %.lr.ph ], [ %i.an, %_ZNSt6vectorIN11OpenImageIO4v3_17ustringESaIS2_EE12emplace_backIJS2_EEERS2_DpOT_.exit ] ; 3 uses
  %.sroa.07.015 = phi ptr [ %.pre20, %.lr.ph ], [ %i.ao, %_ZNSt6vectorIN11OpenImageIO4v3_17ustringESaIS2_EE12emplace_backIJS2_EEERS2_DpOT_.exit ] ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep27 = getelementptr i8, ptr %i.i, i64 %i.ad ; 2 uses
  ...
  %wide.load28 = load <2 x i64>, ptr %i.ae, align 8, !tbaa !27, !alias.scope !106, !noalias !103
  %i.af = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 8, !tbaa !27, !alias.scope !103, !noalias !106
  store <2 x i64> %wide.load28, ptr %i.af, align 8, !tbaa !27, !alias.scope !103, !noalias !106
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ag = icmp eq i64 %index.next, %n.vec
  br i1 %i.ag, label %middle.block, label %vector.body, !llvm.loop !108
...
.lr.ph.i.i.i.i.i.preheader30:                     ; preds = %.lr.ph.i.i.i.i.i.preheader, %middle.block
  %.012.i.i.i.i.i.ph = phi ptr [ %i.t, %.lr.ph.i.i.i.i.i.preheader ], [ %i.ab, %middle.block ]
  %.0911.i.i.i.i.i.ph = phi ptr [ %i.i, %.lr.ph.i.i.i.i.i.preheader ], [ %i.ac, %middle.block ]
  br label %.lr.ph.i.i.i.i.i

.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader30, %.lr.ph.i.i.i.i.i
  %.012.i.i.i.i.i = phi ptr [ %i.aj, %.lr.ph.i.i.i.i.i ], [ %.012.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader30 ] ; 2 uses
  %.0911.i.i.i.i.i = phi ptr [ %i.ai, %.lr.ph.i.i.i.i.i ], [ %.0911.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader30 ] ; 2 uses
  tail call void @llvm.experimental.noalias.scope.decl(metadata !103)
  tail call void @llvm.experimental.noalias.scope.decl(metadata !106)
  %i.ah = load i64, ptr %.0911.i.i.i.i.i, align 8, !tbaa !27, !alias.scope !106, !noalias !103
  store i64 %i.ah, ptr %.012.i.i.i.i.i, align 8, !tbaa !27, !alias.scope !103, !noalias !106
  ...
  %.not.i.i.i.i.i = icmp eq ptr %i.ai, %i.d
...
_ZNSt6vectorIN11OpenImageIO4v3_17ustringESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit22.i.i: ; preds = %.lr.ph.i.i.i.i.i, %middle.block, %.noexc4
  %.0.lcssa.i.i.i.i.i = phi ptr [ %i.t, %.noexc4 ], [ %i.ab, %middle.block ], [ %i.aj, %.lr.ph.i.i.i.i.i ]
  %i.ak = getelementptr inbounds nuw i8, ptr %.0.lcssa.i.i.i.i.i, i64 8 ; 2 uses
...
_ZNSt6vectorIN11OpenImageIO4v3_17ustringESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i: ; preds = %bb.h, %_ZNSt6vectorIN11OpenImageIO4v3_17ustringESaIS2_EE11_S_relocateEPS2_S5_S5_RS3_.exit22.i.i
  ...
  %i.al = getelementptr inbounds nuw [8 x i8], ptr %i.t, i64 %i.r ; 2 uses
  store ptr %i.al, ptr %i.c, align 8, !tbaa !101
  br label %_ZNSt6vectorIN11OpenImageIO4v3_17ustringESaIS2_EE12emplace_backIJS2_EEERS2_DpOT_.exit
...
_ZNSt6vectorIN11OpenImageIO4v3_17ustringESaIS2_EE12emplace_backIJS2_EEERS2_DpOT_.exit: ; preds = %_ZNSt6vectorIN11OpenImageIO4v3_17ustringESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i, %bb.e
  %i.am = phi ptr [ %i.al, %_ZNSt6vectorIN11OpenImageIO4v3_17ustringESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i ], [ %i.d, %bb.e ]
  %i.an = phi ptr [ %i.ak, %_ZNSt6vectorIN11OpenImageIO4v3_17ustringESaIS2_EE17_M_realloc_insertIJS2_EEEvN9__gnu_cxx17__normal_iteratorIPS2_S4_EEDpOT_.exit.i ], [ %i.h, %bb.e ]
  %i.ao = getelementptr inbounds nuw i8, ptr %.sroa.07.015, i64 16 ; 2 uses
  %.not12 = icmp eq ptr %i.ao, %.pre18
...
bb.i:                                             ; preds = %.loopexit.split-lp, %.loopexit13
  ...
  %i.ap = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) @_ZN11OpenImageIO4v3_112_GLOBAL__N_115collision_mutexE) #24 ; 0 uses
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %bb.c, %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit
  %i.aq = phi ptr [ %.pre19, %.loopexit.loopexit ], [ %.pre18, %bb.c ], [ %.pre20, %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit ]
  %i.ar = phi ptr [ %.pre17, %.loopexit.loopexit ], [ %.pre18, %bb.c ], [ %.pre18, %_ZNSt10lock_guardISt5mutexEC2ERS0_.exit ]
  %i.as = ptrtoint ptr %i.ar to i64
  %i.at = ptrtoint ptr %i.aq to i64
  %i.au = sub i64 %i.as, %i.at
  %i.av = ashr exact i64 %i.au, 4
  %i.aw = tail call noundef i32 @pthread_mutex_unlock(ptr noundef nonnull align 8 dereferenceable(40) @_ZN11OpenImageIO4v3_112_GLOBAL__N_115collision_mutexE) #24 ; 0 uses
  ret i64 %i.av
}
