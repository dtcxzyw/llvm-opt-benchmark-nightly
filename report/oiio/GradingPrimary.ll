...
bb.r:                                             ; preds = %bb.p
  ...
  %4 = load <2 x double>, ptr %i.nc, align 8
  %i.nd = getelementptr inbounds nuw i8, ptr %3, i64 184
  %i.ne = load double, ptr %i.nd, align 8, !tbaa !12 ; 4 uses
  %i.nf = getelementptr inbounds nuw i8, ptr %0, i64 48
  %5 = getelementptr inbounds nuw i8, ptr %3, i64 168
  %6 = load <3 x double>, ptr %i.js, align 8, !tbaa !33
  %7 = shufflevector <2 x double> %4, <2 x double> poison, <3 x i32> zeroinitializer
  %8 = fadd <3 x double> %7, %6
  %9 = insertelement <3 x double> poison, double %i.ne, i64 0
  %10 = shufflevector <3 x double> %9, <3 x double> poison, <3 x i32> zeroinitializer
  %11 = fadd <3 x double> %8, %10
  %12 = load <3 x double>, ptr %i.jt, align 8, !tbaa !33 ; 3 uses
  %i.ng = load double, ptr %5, align 8, !tbaa !10
  %13 = fadd <3 x double> %11, %12
  %14 = fptrunc <3 x double> %13 to <3 x float>
  %15 = fneg <3 x float> %14
  store <3 x float> %15, ptr %i.nf, align 8, !tbaa !31
  ...
  %16 = insertelement <2 x double> poison, double %i.ne, i64 0
  %17 = insertelement <2 x double> %16, double %i.ng, i64 1
  %18 = shufflevector <3 x double> %12, <3 x double> poison, <2 x i32> <i32 0, i32 poison>
  %19 = insertelement <2 x double> %18, double %i.ne, i64 1
  %i.ns = fadd <2 x double> %17, %19
  ...
  %20 = extractelement <3 x double> %12, i64 2
  %i.od = fadd double %i.ne, %20
