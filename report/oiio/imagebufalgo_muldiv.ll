...
bb.ci:                                            ; preds = %_ZN11OpenImageIO4v3_1L10scale_implItttEEbRNS0_8ImageBufERKS2_S5_NS0_3ROIEi.exit, %_ZN11OpenImageIO4v3_1L10scale_implIfttEEbRNS0_8ImageBufERKS2_S5_NS0_3ROIEi.exit, %_ZN11OpenImageIO4v3_1L10scale_implIN9Imath_3_14halfES3_S3_EEbRNS0_8ImageBufERKS4_S7_NS0_3ROIEi.exit, %_ZN11OpenImageIO4v3_1L10scale_implIfN9Imath_3_14halfES3_EEbRNS0_8ImageBufERKS4_S7_NS0_3ROIEi.exit, %_ZN11OpenImageIO4v3_1L10scale_implIhhhEEbRNS0_8ImageBufERKS2_S5_NS0_3ROIEi.exit, %_ZN11OpenImageIO4v3_1L10scale_implIfhhEEbRNS0_8ImageBufERKS2_S5_NS0_3ROIEi.exit, %_ZN11OpenImageIO4v3_1L10scale_implIfffEEbRNS0_8ImageBufERKS2_S5_NS0_3ROIEi.exit, %bb.cg, %bb.bq, %bb.ba, %bb.ak, %bb.ch
  %.0 = phi i1 [ false, %bb.ch ], [ true, %_ZN11OpenImageIO4v3_1L10scale_implIfttEEbRNS0_8ImageBufERKS2_S5_NS0_3ROIEi.exit ], [ false, %bb.ak ], [ false, %bb.ba ], [ true, %_ZN11OpenImageIO4v3_1L10scale_implIfffEEbRNS0_8ImageBufERKS2_S5_NS0_3ROIEi.exit ], [ true, %_ZN11OpenImageIO4v3_1L10scale_implIfhhEEbRNS0_8ImageBufERKS2_S5_NS0_3ROIEi.exit ], [ false, %bb.bq ], [ true, %_ZN11OpenImageIO4v3_1L10scale_implIhhhEEbRNS0_8ImageBufERKS2_S5_NS0_3ROIEi.exit ], [ true, %_ZN11OpenImageIO4v3_1L10scale_implIfN9Imath_3_14halfES3_EEbRNS0_8ImageBufERKS4_S7_NS0_3ROIEi.exit ], [ false, %bb.cg ], [ true, %_ZN11OpenImageIO4v3_1L10scale_implIN9Imath_3_14halfES3_S3_EEbRNS0_8ImageBufERKS4_S7_NS0_3ROIEi.exit ], [ true, %_ZN11OpenImageIO4v3_1L10scale_implItttEEbRNS0_8ImageBufERKS2_S5_NS0_3ROIEi.exit ] ; 2 uses
  %.not152 = icmp eq ptr %.0136, %0
  br i1 %.not152, label %bb.cr, label %bb.cj

bb.cj:                                            ; preds = %bb.ci
  br i1 %.0, label %bb.ck, label %bb.cm
...
bb.es:                                            ; preds = %bb.ep, %bb.eo, %bb.el, %bb.ek, %bb.eh, %bb.eg, %_ZN11OpenImageIO4v3_1L10scale_implIfffEEbRNS0_8ImageBufERKS2_S5_NS0_3ROIEi.exit250, %bb.eq, %bb.em, %bb.ei, %bb.ee, %bb.er
  %.1 = phi i1 [ false, %bb.er ], [ true, %bb.eo ], [ false, %bb.ee ], [ false, %bb.ei ], [ true, %_ZN11OpenImageIO4v3_1L10scale_implIfffEEbRNS0_8ImageBufERKS2_S5_NS0_3ROIEi.exit250 ], [ true, %bb.eg ], [ false, %bb.em ], [ true, %bb.eh ], [ true, %bb.ek ], [ false, %bb.eq ], [ true, %bb.el ], [ true, %bb.ep ] ; 2 uses
  %.not = icmp eq ptr %.0139, %0
  br i1 %.not, label %bb.fb, label %bb.et

bb.et:                                            ; preds = %bb.es
  br i1 %.1, label %bb.eu, label %bb.ew
...
bb.fg:                                            ; preds = %bb.fb, %bb.cy, %bb.ff, %bb.d, %bb.cr
  %.2 = phi i1 [ %.0, %bb.cr ], [ false, %bb.d ], [ %.1, %bb.fb ], [ false, %bb.cy ], [ false, %bb.ff ]
...
bb.aa:                                            ; preds = %bb.z, %bb.y
  ...
  %.0.i = phi i64 [ 2, %bb.z ], [ 1, %bb.y ]      ; 4 uses
  %.0.i.a = phi i32 [ 2, %bb.z ], [ 1, %bb.y ]
...
.lr.ph.i:                                         ; preds = %bb.aa
  ...
  %i.fd = getelementptr inbounds nuw i8, ptr %i.ej, i64 %.0.i
  ...
  %indvars.iv.next.i = add nuw nsw i64 %.0.i, 2   ; 2 uses
...
begin_hunk_4_@_ZN3fmt3v126detail12format_floatIdEEiT_iRKNS0_12format_specsEbRNS1_6bufferIcEE:bb.a
  ...
  %indvars.iv.next.i.1 = or disjoint i64 %.0.i, 4 ; 2 uses
...
begin_hunk_5_@_ZN3fmt3v126detail12format_floatIdEEiT_iRKNS0_12format_specsEbRNS1_6bufferIcEE:bb.a
  ...
  %indvars.iv.next.i.2 = add nuw nsw i64 %.0.i, 6 ; 2 uses
...
bb.ak:                                            ; preds = %bb.aj, %bb.ai
  ...
  %.0.i143 = phi i64 [ 2, %bb.aj ], [ 1, %bb.ai ]
  %.0.i143.a = phi i32 [ 2, %bb.aj ], [ 1, %bb.ai ]
...
bb.al:                                            ; preds = %.lr.ph.i144.a, %bb.al
  %.4 = phi i64 [ %i.hr, %bb.al ], [ %.3211, %.lr.ph.i144.a ]
  %indvars.iv.i145 = phi i64 [ %indvars.iv.next.i146, %bb.al ], [ %.0.i143, %.lr.ph.i144.a ] ; 2 uses
