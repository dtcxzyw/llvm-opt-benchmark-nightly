...
begin_hunk_3_@_ZNK16OpenColorIO_v2_512BitDepthCastILNS_8BitDepthE1ELS1_1EE5applyEPKvPvl:bb.a
  ...
  %i.ah = fmul <4 x float> %broadcast.splat38, %i.ag
...
begin_hunk_4_@_ZNK16OpenColorIO_v2_512BitDepthCastILNS_8BitDepthE1ELS1_1EE5applyEPKvPvl:bb.a
  ...
  %i.aw = fmul <4 x float> %broadcast.splat41.a, %i.av
...
begin_hunk_5_@_ZNK16OpenColorIO_v2_512BitDepthCastILNS_8BitDepthE1ELS1_1EE5applyEPKvPvl:bb.a
  ...
  %i.bl = fmul <4 x float> %broadcast.splat44.a, %i.bk
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %4 = load float, ptr %i.b, align 8, !tbaa !42, !alias.scope !366 ; 4 uses
  %broadcast.splatinsert33 = insertelement <4 x float> poison, float %4, i64 0
  %broadcast.splatinsert31 = insertelement <4 x float> poison, float %4, i64 0
  %broadcast.splatinsert29 = insertelement <4 x float> poison, float %4, i64 0
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph, %middle.block
  ...
  %.01518.ph = phi ptr [ %2, %vector.memcheck ], [ %2, %.lr.ph ], [ %6, %middle.block ]
  %.01617.ph = phi ptr [ %1, %vector.memcheck ], [ %1, %.lr.ph ], [ %8, %middle.block ]
  br label %scalar.ph
...
begin_hunk_10_@_ZNK16OpenColorIO_v2_512BitDepthCastILNS_8BitDepthE2ELS1_1EE5applyEPKvPvl:bb.a
  ...
  %i.u = fmul <4 x float> %broadcast.splat, %i.t
...
begin_hunk_11_@_ZNK16OpenColorIO_v2_512BitDepthCastILNS_8BitDepthE2ELS1_1EE5applyEPKvPvl:bb.a
  ...
  %i.aj = fmul <4 x float> %broadcast.splat38, %i.ai
...
begin_hunk_12_@_ZNK16OpenColorIO_v2_512BitDepthCastILNS_8BitDepthE2ELS1_1EE5applyEPKvPvl:bb.a
  ...
  %i.ay = fmul <4 x float> %broadcast.splat41.a, %i.ax
...
begin_hunk_13_@_ZNK16OpenColorIO_v2_512BitDepthCastILNS_8BitDepthE2ELS1_1EE5applyEPKvPvl:bb.a
  ...
  %i.bn = fmul <4 x float> %broadcast.splat44.a, %i.bm
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %3, 9223372036854775804        ; 5 uses
  %4 = load float, ptr %i.b, align 8, !tbaa !72, !alias.scope !414 ; 4 uses
  %broadcast.splatinsert29 = insertelement <4 x float> poison, float %4, i64 0
  %broadcast.splatinsert27 = insertelement <4 x float> poison, float %4, i64 0
  %broadcast.splatinsert25 = insertelement <4 x float> poison, float %4, i64 0
  %broadcast.splatinsert = insertelement <4 x float> poison, float %4, i64 0
  %5 = shl i64 %n.vec, 4
  %6 = getelementptr i8, ptr %2, i64 %5
  %7 = shl i64 %n.vec, 3
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %3, 9223372036854775804        ; 5 uses
  %4 = load float, ptr %i.b, align 8, !tbaa !102, !alias.scope !459 ; 4 uses
  %broadcast.splatinsert29 = insertelement <4 x float> poison, float %4, i64 0
  %broadcast.splatinsert27 = insertelement <4 x float> poison, float %4, i64 0
  %broadcast.splatinsert25 = insertelement <4 x float> poison, float %4, i64 0
  %broadcast.splatinsert = insertelement <4 x float> poison, float %4, i64 0
...
vector.ph:                                        ; preds = %vector.memcheck
  %n.vec = and i64 %3, 9223372036854775804        ; 5 uses
  %4 = load float, ptr %i.b, align 8, !tbaa !132, !alias.scope !504 ; 4 uses
  %broadcast.splatinsert29 = insertelement <4 x float> poison, float %4, i64 0
  %broadcast.splatinsert27 = insertelement <4 x float> poison, float %4, i64 0
  %broadcast.splatinsert25 = insertelement <4 x float> poison, float %4, i64 0
  %broadcast.splatinsert = insertelement <4 x float> poison, float %4, i64 0
...
begin_hunk_34_@_ZNK16OpenColorIO_v2_512BitDepthCastILNS_8BitDepthE8ELS1_1EE5applyEPKvPvl:bb.a
  ...
  %i.t = fmul <4 x float> %i.s, %broadcast.splat
...
begin_hunk_35_@_ZNK16OpenColorIO_v2_512BitDepthCastILNS_8BitDepthE8ELS1_1EE5applyEPKvPvl:bb.a
  ...
  %i.ah = fmul <4 x float> %i.ag, %broadcast.splat38
  %i.ai = fadd <4 x float> %i.ah, splat (float 5.000000e-01) ; 3 uses
...
begin_hunk_36_@_ZNK16OpenColorIO_v2_512BitDepthCastILNS_8BitDepthE8ELS1_1EE5applyEPKvPvl:bb.a
  ...
  %i.av = fmul <4 x float> %i.au, %broadcast.splat41.a
...
begin_hunk_37_@_ZNK16OpenColorIO_v2_512BitDepthCastILNS_8BitDepthE8ELS1_1EE5applyEPKvPvl:bb.a
  ...
  %i.bj = fmul <4 x float> %i.bi, %broadcast.splat44.a
