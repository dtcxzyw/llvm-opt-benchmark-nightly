...
.lr.ph.preheader:                                 ; preds = %bb.q
  ...
  %i.fi = insertelement <4 x i32> %32, i32 %29, i64 1
  %i.fj = insertelement <4 x i32> %i.fi, i32 %26, i64 2
  %33 = insertelement <4 x i32> %i.fj, i32 %27, i64 3
  %i.fk = and <4 x i32> %33, <i32 -1, i32 255, i32 255, i32 255> ; 2 uses
  %34 = shufflevector <4 x i32> %i.fk, <4 x i32> poison, <4 x i32> <i32 2, i32 0, i32 3, i32 1>
  %35 = mul nuw nsw <4 x i32> %i.fk, %34          ; 2 uses
  %i.fl = insertelement <4 x i32> poison, i32 %30, i64 0
  %i.fm = shufflevector <4 x i32> %i.fl, <4 x i32> poison, <4 x i32> zeroinitializer
  %36 = mul nuw nsw <4 x i32> %35, %i.fm
  %i.fn = uitofp <4 x i32> %36 to <4 x float>
  %i.fo = insertelement <4 x i32> poison, i32 %31, i64 0
  %i.fp = shufflevector <4 x i32> %i.fo, <4 x i32> poison, <4 x i32> zeroinitializer
  %37 = mul nuw nsw <4 x i32> %35, %i.fp
  %i.fq = uitofp <4 x i32> %37 to <4 x float>
  ...
  %i.fx = extractelement <4 x float> %i.fw, i64 0
  %i.fy = fmul float %i.ax, %i.fx
  %i.fz = extractelement <4 x float> %i.fw, i64 2
  %i.ga = call float @llvm.fmuladd.f32(float %i.fg, float %i.fz, float %i.fy)
  %i.gb = extractelement <4 x float> %i.fw, i64 1
  %i.gc = fmul float %i.ax, %i.gb
  %i.gd = extractelement <4 x float> %i.fw, i64 3
