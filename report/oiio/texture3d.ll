...
begin_hunk_0_@_ZN11OpenImageIO4v3_117TextureSystemImpl23accum3d_sample_bilinearERKN9Imath_3_14Vec3IfEEiRNS0_14ImageCacheFileEPNS0_23ImageCachePerThreadInfoERNS0_13TextureOpt_v2EiifPfSD_SD_SD_:bb.a
  ...
  store i8 %i.bz, ptr %16, align 8, !tbaa !243
  ...
  store i8 %i.ce, ptr %i.cd, align 1, !tbaa !243
  ...
  store i8 %i.ck, ptr %i.bt, align 2, !tbaa !243
  ...
  store i8 %i.cp, ptr %i.co, align 1, !tbaa !243
  ...
  store i8 %i.cv, ptr %i.bu, align 4, !tbaa !243
  ...
  store i8 %i.da, ptr %i.cz, align 1, !tbaa !243
...
.lr.ph.preheader:                                 ; preds = %bb.q
  ...
  %i.fy = shufflevector <4 x i32> %23, <4 x i32> poison, <4 x i32> zeroinitializer
  %i.fz = mul nuw nsw <4 x i32> %i.fx, %i.fy
  %i.ga = uitofp <4 x i32> %i.fz to <4 x float>
  %24 = insertelement <4 x i32> poison, i32 %22, i64 0
  %25 = shufflevector <4 x i32> %24, <4 x i32> poison, <4 x i32> zeroinitializer
  %i.gb = mul nuw nsw <4 x i32> %i.fx, %25
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load709 = load <4 x float>, ptr %i.gy, align 4, !tbaa !184
  %i.gz = fadd <4 x float> %broadcast.splat, %wide.load
  %i.ha = fadd <4 x float> %broadcast.splat, %wide.load709
  store <4 x float> %i.gz, ptr %gep, align 4, !tbaa !184
  store <4 x float> %i.ha, ptr %i.gy, align 4, !tbaa !184
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.hb = icmp eq i64 %index.next, %n.vec
  br i1 %i.hb, label %middle.block, label %vector.body, !llvm.loop !453
...
.lr.ph:                                           ; preds = %.lr.ph.preheader1044, %.lr.ph
  ...
  %i.hd = load float, ptr %i.hc, align 4, !tbaa !184
  %i.he = fadd float %i.gu, %i.hd
  store float %i.he, ptr %i.hc, align 4, !tbaa !184
...
bb.r:                                             ; preds = %.loopexit556
  ...
  %i.hh = load i32, ptr %i.hg, align 4, !tbaa !222
  %i.hi = getelementptr inbounds nuw i8, ptr %i.r, i64 52 ; 4 uses
  %i.hj = load i32, ptr %i.hi, align 4, !tbaa !223
  %i.hk = getelementptr inbounds nuw i8, ptr %i.r, i64 56 ; 3 uses
  %i.hl = load i32, ptr %i.hk, align 4, !tbaa !224
...
bb.u:                                             ; preds = %bb.t
  ...
  %i.kb = load ptr, ptr %i.ka, align 8, !tbaa !161
  %i.kc = getelementptr inbounds nuw i8, ptr %i.kb, i64 60
  %i.kd = load i32, ptr %i.kc, align 4, !tbaa !182
  %i.ke = trunc i32 %i.kd to i16
  store i16 %i.ke, ptr %i.ju, align 2, !tbaa !232
...
_ZN11OpenImageIO4v3_16TileIDC2ERNS0_14ImageCacheFileEiiiiiiii.exit: ; preds = %bb.u, %bb.t
  %i.kf = load i32, ptr %5, align 8, !tbaa !183
