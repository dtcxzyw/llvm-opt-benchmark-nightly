...
.preheader.i.i:                                   ; preds = %._crit_edge.i.i, %.preheader.lr.ph.split.i.i
  ...
  %.03646.i.i = phi i32 [ 0, %.preheader.lr.ph.split.i.i ], [ %i.ar, %._crit_edge.i.i ]
  %.03745.i.i = phi ptr [ %0, %.preheader.lr.ph.split.i.i ], [ %i.aq, %._crit_edge.i.i ] ; 2 uses
  br label %bb.e
...
bb.e:                                             ; preds = %bb.e, %.preheader.i.i
  ...
  %i.ah = getelementptr inbounds nuw i8, ptr %.03745.i.i, i64 %indvars.iv.i.i
...
._crit_edge.i.i:                                  ; preds = %bb.e
  %i.aq = getelementptr inbounds i8, ptr %.03745.i.i, i64 %i.ae
  %i.ar = add nuw nsw i32 %.03646.i.i, 1          ; 2 uses
...
bb.f:                                             ; preds = %bb.l, %._crit_edge47.split.i.i
  ...
  %.03855.i.i = phi i32 [ -1, %._crit_edge47.split.i.i ], [ %.139.i.i.1, %bb.l ] ; 3 uses
...
bb.i:                                             ; preds = %bb.h, %bb.g, %bb.f
  ...
  %.139.i.i = phi i32 [ %.03855.i.i, %bb.f ], [ %i.ay, %bb.g ], [ %i.ay, %bb.h ] ; 3 uses
...
bb.l:                                             ; preds = %bb.k, %bb.j, %bb.i
  ...
  %.139.i.i.1 = phi i32 [ %.139.i.i, %bb.i ], [ %i.bf, %bb.j ], [ %i.bf, %bb.k ]
...
.lr.ph.preheader.i.lr.ph:                         ; preds = %bb.q
  ...
  %wide.trip.count.i34 = zext i32 %i.ci to i64    ; 13 uses
  ...
  %scevgep111 = getelementptr i8, ptr %i.w, i64 %i.cs
  %i.ct = add i32 %i.p, -2
  %i.cu = shl nuw nsw i64 %i.aa, 1                ; 2 uses
  %i.cv = getelementptr i8, ptr %i.w, i64 %i.cu
  %scevgep113 = getelementptr i8, ptr %i.cv, i64 2
  %scevgep115 = getelementptr i8, ptr %i.w, i64 %i.cu
  %i.cw = xor i32 %.1, -1
  ...
  %i.db = shl nuw nsw i64 %wide.trip.count.i34, 1
  %i.dc = add nuw nsw i64 %i.db, %i.r
  %i.dd = shl nuw nsw i64 %i.aa, 1
  %5 = add nuw nsw i64 %wide.trip.count.i34, 1
  %umax132 = tail call i64 @llvm.umax.i64(i64 %5, i64 %i.cm)
  %6 = sub nsw i64 %umax132, %wide.trip.count.i34 ; 3 uses
  %7 = shl nuw nsw i64 %wide.trip.count.i34, 1    ; 3 uses
  %8 = getelementptr i8, ptr %i.w, i64 %7
  %scevgep149.a = getelementptr i8, ptr %8, i64 %i.r ; 2 uses
  %9 = shl nuw nsw i64 %i.ch, 1                   ; 2 uses
  %i.de = shl nuw nsw i64 %i.aa, 1                ; 2 uses
  %i.df = add nuw nsw i64 %9, %i.de               ; 3 uses
  %i.dg = getelementptr i8, ptr %i.w, i64 %i.df
  %scevgep150.a = getelementptr i8, ptr %i.dg, i64 -2
  %i.dh = getelementptr i8, ptr %i.w, i64 %i.df
  %i.di = getelementptr i8, ptr %i.dh, i64 %7
  %scevgep151.a = getelementptr i8, ptr %i.di, i64 -2
  %i.dj = add nuw nsw i64 %i.df, 2
  %i.dk = sub nsw i64 %i.dj, %7
  %scevgep152.a = getelementptr i8, ptr %i.w, i64 %i.dk
  %i.dl = getelementptr i8, ptr %i.w, i64 %9
  %i.dm = getelementptr i8, ptr %i.dl, i64 %i.de
  %scevgep153 = getelementptr i8, ptr %i.dm, i64 2
  %i.dn = zext nneg i32 %.1 to i64
  %xtraiter = and i64 %i.s, 1
  %i.do = icmp eq i32 %1, 1
  %unroll_iter = and i64 %i.s, 2147483646
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod182 = trunc i32 %1 to i1
  %min.iters.check162 = icmp ult i32 %.1, 7
  %bound0154 = icmp ult ptr %i.bi, %scevgep151.a
  %bound1155 = icmp ult ptr %scevgep150.a, %scevgep149.a
  %found.conflict156 = and i1 %bound0154, %bound1155
  %bound0157 = icmp ult ptr %i.bi, %scevgep153
  %bound1158 = icmp ult ptr %scevgep152.a, %scevgep149.a
  %found.conflict159 = and i1 %bound0157, %bound1158
  %conflict.rdx160 = or i1 %found.conflict156, %found.conflict159
  %n.vec165 = and i64 %wide.trip.count.i34, 4294967288 ; 3 uses
  %broadcast.splatinsert166 = insertelement <8 x i32> poison, i32 %i.ce, i64 0
  %broadcast.splat167 = shufflevector <8 x i32> %broadcast.splatinsert166, <8 x i32> poison, <8 x i32> zeroinitializer
  %cmp.n175 = icmp eq i64 %n.vec165, %wide.trip.count.i34
  %xtraiter183 = and i64 %wide.trip.count.i34, 1
  %lcmp.mod184.not = icmp eq i64 %xtraiter183, 0
  %min.iters.check134 = icmp ugt i64 %6, 7
  %i.dp = sub nsw i64 %wide.trip.count.i34, %umax
  %.not177 = icmp ugt i64 %i.dp, -2147483649
  %or.cond178 = select i1 %min.iters.check134, i1 %.not177, i1 false
  %i.dq = sub nsw i64 %i.da, %i.r
  %diff.check = icmp ugt i64 %i.dq, -16
  %i.dr = sub nsw i64 %i.dd, %i.dc
  %diff.check130 = icmp ugt i64 %i.dr, -16
  %conflict.rdx131 = or i1 %diff.check, %diff.check130
  %n.vec137 = and i64 %6, -8                      ; 3 uses
  %i.ds = add nsw i64 %n.vec137, %wide.trip.count.i34 ; 2 uses
  %broadcast.splatinsert138 = insertelement <8 x i32> poison, i32 %i.ce, i64 0
  %broadcast.splat139 = shufflevector <8 x i32> %broadcast.splatinsert138, <8 x i32> poison, <8 x i32> zeroinitializer
  %cmp.n146 = icmp eq i64 %6, %n.vec137
...
.lr.ph.preheader.i:                               ; preds = %.lr.ph.preheader.i.lr.ph, %bb.t
  ...
  %.sroa.14.094 = phi i32 [ %i.l, %.lr.ph.preheader.i.lr.ph ], [ %i.ll, %bb.t ] ; 4 uses
...
.lr.ph.i:                                         ; preds = %.lr.ph.preheader.i, %.lr.ph.i
  ...
  %.038.i = phi i16 [ %i.eh, %.lr.ph.i ], [ 0, %.lr.ph.preheader.i ]
  ...
  %i.ej = load i16, ptr %i.ei, align 2, !tbaa !12
  ...
  store i16 %i.ek, ptr %i.el, align 2, !tbaa !12
...
.lr.ph.i.epil.preheader:                          ; preds = %._crit_edge.i.loopexit.unr-lcssa, %.lr.ph.preheader.i
  ...
  %.038.i.epil.init = phi i16 [ 0, %.lr.ph.preheader.i ], [ %i.eh, %._crit_edge.i.loopexit.unr-lcssa ]
  ...
  %i.es = add i16 %.038.i.epil.init, %i.er
  ...
  store i16 %i.ev, ptr %i.ew, align 2, !tbaa !12
...
.lr.ph.i35.preheader:                             ; preds = %._crit_edge.i.loopexit
  %brmerge = select i1 %min.iters.check162, i1 true, i1 %conflict.rdx160
  br i1 %brmerge, label %.lr.ph.i35.preheader180, label %vector.body168

vector.body168:                                   ; preds = %.lr.ph.i35.preheader, %vector.body168
  %index169 = phi i64 [ %index.next173, %vector.body168 ], [ 0, %.lr.ph.i35.preheader ] ; 4 uses
  %i.fe = getelementptr [2 x i8], ptr %invariant.gep.i, i64 %index169
  %i.ff = getelementptr i8, ptr %i.fe, i64 -2
  %wide.load170.a = load <8 x i16>, ptr %i.ff, align 2, !tbaa !12, !alias.scope !16
  %i.fg = sub nsw i64 %i.ch, %index169
  %i.fh = getelementptr inbounds nuw [2 x i8], ptr %i.ab, i64 %i.fg
  %i.fi = getelementptr inbounds i8, ptr %i.fh, i64 -14
  %wide.load171 = load <8 x i16>, ptr %i.fi, align 2, !tbaa !12, !alias.scope !19
  %reverse172 = shufflevector <8 x i16> %wide.load171, <8 x i16> poison, <8 x i32> <i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>
  %i.fj = add <8 x i16> %reverse172, %wide.load170.a
  %i.fk = zext <8 x i16> %i.fj to <8 x i32>
  %i.fl = mul nuw <8 x i32> %broadcast.splat167, %i.fk
  %i.fm = lshr <8 x i32> %i.fl, splat (i32 16)
  %i.fn = trunc nuw <8 x i32> %i.fm to <8 x i16>
  %i.fo = getelementptr inbounds nuw [2 x i8], ptr %i.bi, i64 %index169
  store <8 x i16> %i.fn, ptr %i.fo, align 2, !tbaa !12, !alias.scope !21, !noalias !23
  %index.next173 = add nuw i64 %index169, 8       ; 2 uses
  %i.fp = icmp eq i64 %index.next173, %n.vec165
  br i1 %i.fp, label %middle.block174, label %vector.body168, !llvm.loop !24

middle.block174:                                  ; preds = %vector.body168
  br i1 %cmp.n175, label %.preheader53.i, label %.lr.ph.i35.preheader180

.lr.ph.i35.preheader180:                          ; preds = %.lr.ph.i35.preheader, %middle.block174
  %indvars.iv.i36.ph = phi i64 [ %n.vec165, %middle.block174 ], [ 0, %.lr.ph.i35.preheader ] ; 6 uses
  br i1 %lcmp.mod184.not, label %.lr.ph.i35.prol.loopexit, label %.lr.ph.i35.prol

.lr.ph.i35.prol:                                  ; preds = %.lr.ph.i35.preheader180
  %gep.i.prol = getelementptr [2 x i8], ptr %invariant.gep.i, i64 %indvars.iv.i36.ph
  %i.fq = getelementptr i8, ptr %gep.i.prol, i64 -2
  %i.fr = load i16, ptr %i.fq, align 2, !tbaa !12
  %i.fs = sub nsw i64 %i.ch, %indvars.iv.i36.ph
  ...
  store i16 %i.fz, ptr %i.ga, align 2, !tbaa !12
  %indvars.iv.next.i37.prol = or disjoint i64 %indvars.iv.i36.ph, 1
  br label %.lr.ph.i35.prol.loopexit

.lr.ph.i35.prol.loopexit:                         ; preds = %.lr.ph.i35.prol, %.lr.ph.i35.preheader180
  %indvars.iv.i36.unr = phi i64 [ %indvars.iv.i36.ph, %.lr.ph.i35.preheader180 ], [ %indvars.iv.next.i37.prol, %.lr.ph.i35.prol ]
  %i.gb = icmp eq i64 %indvars.iv.i36.ph, %i.dn
  br i1 %i.gb, label %.preheader53.i, label %.lr.ph.i35

.preheader53.i:                                   ; preds = %.lr.ph.i35.prol.loopexit, %.lr.ph.i35, %middle.block174
...
.lr.ph57.i.preheader:                             ; preds = %.preheader53.i
  ...
  %brmerge187 = select i1 %or.cond178.not, i1 true, i1 %conflict.rdx131
  br i1 %brmerge187, label %.lr.ph57.i.preheader179, label %vector.body140
...
vector.body140:                                   ; preds = %.lr.ph57.i.preheader, %vector.body140
  ...
  %i.gc = add i64 %index141, %wide.trip.count.i34 ; 3 uses
  %i.gd = getelementptr [2 x i8], ptr %invariant.gep.i, i64 %i.gc
  %wide.load142.a = load <8 x i16>, ptr %i.gd, align 2, !tbaa !12
  %i.ge = trunc nuw nsw i64 %i.gc to i32
  %i.gf = add i32 %i.ge, %i.cl
  %i.gg = sext i32 %i.gf to i64
  %i.gh = getelementptr inbounds [2 x i8], ptr %i.ab, i64 %i.gg
  %wide.load143 = load <8 x i16>, ptr %i.gh, align 2, !tbaa !12
  %i.gi = sub <8 x i16> %wide.load142.a, %wide.load143
  %i.gj = zext <8 x i16> %i.gi to <8 x i32>
  %i.gk = mul nuw <8 x i32> %broadcast.splat139, %i.gj
  ...
  store <8 x i16> %i.gm, ptr %i.gn, align 2, !tbaa !12
  %index.next144 = add nuw i64 %index141, 8       ; 2 uses
  %i.go = icmp eq i64 %index.next144, %n.vec137
  br i1 %i.go, label %middle.block145, label %vector.body140, !llvm.loop !27

middle.block145:                                  ; preds = %vector.body140
  br i1 %cmp.n146, label %.preheader.loopexit.i, label %.lr.ph57.i.preheader179

.lr.ph57.i.preheader179:                          ; preds = %.lr.ph57.i.preheader, %middle.block145
  %indvars.iv63.i.ph = phi i64 [ %i.ds, %middle.block145 ], [ %wide.trip.count.i34, %.lr.ph57.i.preheader ]
  br label %.lr.ph57.i
...
.lr.ph.i35:                                       ; preds = %.lr.ph.i35.prol.loopexit, %.lr.ph.i35
  ...
  %i.gq = load i16, ptr %i.gp, align 2, !tbaa !12
  %i.gr = sub nsw i64 %i.ch, %indvars.iv.i36
  ...
  store i16 %i.gy, ptr %i.gz, align 2, !tbaa !12
  ...
  %i.hb = load i16, ptr %i.ha, align 2, !tbaa !12
  %i.hc = sub nsw i64 %i.ch, %indvars.iv.next.i37
