...
vector.body140:                                   ; preds = %.lr.ph57.i.preheader, %vector.body140
  ...
  %5 = trunc i64 %i.gh to i32
  %6 = getelementptr [2 x i8], ptr %invariant.gep.i, i64 %i.gh
  %wide.load142 = load <8 x i16>, ptr %6, align 2, !tbaa !12
  %i.gi = add i32 %5, %i.cl
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.iy = trunc i64 %i.ix to i32                  ; 2 uses
  %i.iz = add i32 %.1, %i.iy
