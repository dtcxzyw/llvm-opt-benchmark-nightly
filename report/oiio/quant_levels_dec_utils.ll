...
.lr.ph.preheader.i.lr.ph:                         ; preds = %bb.q
  ...
  %i.cr = add i32 %i.p, -2
  %i.cs = shl nuw nsw i64 %i.aa, 1                ; 2 uses
  %i.ct = getelementptr i8, ptr %i.w, i64 %i.cs
  %scevgep112 = getelementptr i8, ptr %i.ct, i64 2
  %scevgep114 = getelementptr i8, ptr %i.w, i64 %i.cs
  %7 = xor i32 %.1, -1
  %i.cu = add nuw nsw i64 %i.s, %i.aa
...
vector.scevcheck:                                 ; preds = %.lr.ph60.i
  ...
  %i.hs = sub i32 %i.cp, %i.hr                    ; 2 uses
  %i.ht = trunc i64 %i.hq to i32                  ; 2 uses
  %i.hu = sub i32 %i.hs, %i.ht
  %i.hv = icmp sgt i32 %i.hu, %i.hs
  %8 = add i32 %.1.lcssa.i, %6                    ; 2 uses
  %9 = add i32 %8, %i.ht
  %10 = icmp slt i32 %9, %8
...
vector.memcheck:                                  ; preds = %vector.scevcheck
  ...
  %12 = shl nsw i64 %i.id, 1
  %scevgep111 = getelementptr i8, ptr %scevgep110, i64 %12
  %i.ie = shl nsw i64 %i.ib, 1
  %scevgep113.a = getelementptr i8, ptr %scevgep112, i64 %i.ie
  %13 = add i32 %.1.lcssa.i, %7
  %14 = sext i32 %13 to i64                       ; 2 uses
  %i.if = shl nsw i64 %14, 1
  %scevgep115.a = getelementptr i8, ptr %scevgep114, i64 %i.if
  %15 = add nsw i64 %i.cu, %14
  %16 = sub nsw i64 %15, %i.hn
  %17 = shl nsw i64 %16, 1
  %scevgep116.a = getelementptr i8, ptr %i.w, i64 %17
  %bound0 = icmp ult ptr %scevgep109, %i.cn
  %found.conflict = and i1 %bound0, %bound1
  %bound0117 = icmp ult ptr %scevgep109, %scevgep113.a
  ...
  %bound0120 = icmp ult ptr %scevgep109, %scevgep116.a
  %bound1121 = icmp ult ptr %scevgep115.a, %i.bj
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ij = add nuw i64 %index, %i.hn               ; 2 uses
  %i.ik = trunc nsw i64 %i.ij to i32              ; 2 uses
  %i.il = add i32 %.1, %i.ik
  %i.im = sub i32 %5, %i.il
  ...
  %18 = add i32 %i.ik, %i.cl
  %19 = sext i32 %18 to i64
  %i.iq = getelementptr inbounds [2 x i8], ptr %i.ab, i64 %19
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %i.jn = shl i16 %i.jm, 1
  %i.jo = trunc nsw i64 %indvars.iv66.i to i32    ; 2 uses
  %i.jp = add i32 %.1, %i.jo
  %i.jq = sub i32 %5, %i.jp
  %i.jr = sext i32 %i.jq to i64
  %i.js = getelementptr inbounds [2 x i8], ptr %i.ab, i64 %i.jr
  %i.jt = load i16, ptr %i.js, align 2, !tbaa !32
  %20 = add i32 %i.jo, %i.cl
  %21 = sext i32 %20 to i64
  %i.ju = getelementptr inbounds [2 x i8], ptr %i.ab, i64 %21
