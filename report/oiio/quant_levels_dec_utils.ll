...
.lr.ph.preheader.i.lr.ph:                         ; preds = %bb.q
  ...
  %scevgep149.a = getelementptr i8, ptr %i.w, i64 %i.dc ; 2 uses
  ...
  %6 = tail call i64 @llvm.umax.i64(i64 %5, i64 %i.cm)
  %7 = sub nsw i64 %6, %wide.trip.count.i34       ; 3 uses
  %min.iters.check134 = icmp ugt i64 %7, 7
  ...
  %cmp.n146 = icmp eq i64 %7, %n.vec137
