...
.lr.ph108:                                        ; preds = %.lr.ph108.preheader, %bb.j
  ...
  %indvars.iv128 = phi i64 [ %indvars.iv.next129, %bb.j ], [ %.pre-phi, %.lr.ph108.preheader ] ; 4 uses
...
bb.j:                                             ; preds = %bb.i
  %indvars.iv.next129 = add i64 %indvars.iv128, -1 ; 3 uses
...
..critedge.loopexitsplit_crit_edge:               ; preds = %bb.j
  %indvars.iv.next129.lcssa = phi i64 [ %indvars.iv.next129, %bb.j ]
  %indvars.iv.next129.lcssa.a = phi i64 [ %indvars.iv.next129, %bb.j ] ; 0 uses
...
.critedge.loopexitsplit:                          ; preds = %.critedge.loopexitsplitsplit, %..critedge.loopexitsplit_crit_edge
  %.082.lcssa.ph.in.ph = phi i64 [ %indvars.iv.next129.lcssa, %..critedge.loopexitsplit_crit_edge ], [ %indvars.iv128.lcssa, %.critedge.loopexitsplitsplit ]
  br label %.critedge.loopexit

..critedge.loopexit_crit_edge:                    ; preds = %bb.i
  %indvars.iv128.lcssa175 = phi i64 [ %indvars.iv128, %bb.i ]
  %indvars.iv128.lcssa180 = phi i64 [ %indvars.iv128, %bb.i ] ; 0 uses
  br label %.critedge.loopexit

.critedge.loopexit:                               ; preds = %.critedge.loopexitsplit, %..critedge.loopexit_crit_edge
  %.082.lcssa.ph.in = phi i64 [ %indvars.iv128.lcssa175, %..critedge.loopexit_crit_edge ], [ %.082.lcssa.ph.in.ph, %.critedge.loopexitsplit ]
