...
%"class.OpenImageIO_v3_1_Imf__3_3_5::FastHufDecoder" = type { i32, i32, i8, i8, ptr, [59 x i64], [59 x i64], [4096 x i32], [4096 x i8], i64 }
...
define noundef i32 @_ZN27OpenImageIO_v3_1_Imf__3_3_511hufCompressEPKtiPc(ptr nofree noundef readonly captures(none) %0, i32 noundef %1, ptr noundef %2) local_unnamed_addr #0 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  br i1 %i.d, label %.lr.ph.preheader.i, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_116countFrequenciesEPmPKti.exit
...
.lr.ph.i:                                         ; preds = %.lr.ph.i, %.lr.ph.preheader.i.new
  ...
  %i.y = add i64 %i.x, 1
  store i64 %i.y, ptr %i.w, align 8, !tbaa !9
  ...
  br i1 %niter.ncmp.3, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_116countFrequenciesEPmPKti.exit.loopexit.unr-lcssa, label %.lr.ph.i, !llvm.loop !11

_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_116countFrequenciesEPmPKti.exit.loopexit.unr-lcssa: ; preds = %.lr.ph.i
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  br i1 %lcmp.mod.not, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_116countFrequenciesEPmPKti.exit, label %.lr.ph.i.epil.preheader

.lr.ph.i.epil.preheader:                          ; preds = %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_116countFrequenciesEPmPKti.exit.loopexit.unr-lcssa, %.lr.ph.preheader.i
  %indvars.iv.i.epil.init = phi i64 [ 0, %.lr.ph.preheader.i ], [ %indvars.iv.next.i.3, %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_116countFrequenciesEPmPKti.exit.loopexit.unr-lcssa ]
...
.lr.ph.i.epil:                                    ; preds = %.lr.ph.i.epil, %.lr.ph.i.epil.preheader
  ...
  %i.ah = load i16, ptr %i.ag, align 2, !tbaa !7
  ...
  %i.al = add i64 %i.ak, 1
  store i64 %i.al, ptr %i.aj, align 8, !tbaa !9
  %indvars.iv.next.i.epil = add nuw nsw i64 %indvars.iv.i.epil, 1
  %epil.iter.next = add i64 %epil.iter, 1         ; 2 uses
  %epil.iter.cmp.not = icmp eq i64 %epil.iter.next, %xtraiter
  br i1 %epil.iter.cmp.not, label %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_116countFrequenciesEPmPKti.exit, label %.lr.ph.i.epil, !llvm.loop !13

_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_116countFrequenciesEPmPKti.exit: ; preds = %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_116countFrequenciesEPmPKti.exit.loopexit.unr-lcssa, %.lr.ph.i.epil, %bb.b
...
.noexc:                                           ; preds = %_ZN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_116countFrequenciesEPmPKti.exit
  ...
  %i.an = invoke noalias noundef nonnull dereferenceable(524296) ptr @_Znam(i64 noundef 524296) #11
          to label %_ZN27OpenImageIO_v3_1_Imf__3_3_59AutoArrayIPmLi65537EEC2Ev.exit.i unwind label %bb.d ; 42 uses

_ZN27OpenImageIO_v3_1_Imf__3_3_59AutoArrayIPmLi65537EEC2Ev.exit.i: ; preds = %.noexc
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(524296) %i.an, i8 0, i64 524296, i1 false)
  br label %bb.c

bb.c:                                             ; preds = %bb.c, %_ZN27OpenImageIO_v3_1_Imf__3_3_59AutoArrayIPmLi65537EEC2Ev.exit.i
  %indvars.iv.i28 = phi i64 [ %indvars.iv.next.i29, %bb.c ], [ 0, %_ZN27OpenImageIO_v3_1_Imf__3_3_59AutoArrayIPmLi65537EEC2Ev.exit.i ] ; 7 uses
...
bb.d:                                             ; preds = %.noexc
  %i.as = landingpad { ptr, i32 }
          cleanup
  br label %_ZN27OpenImageIO_v3_1_Imf__3_3_59AutoArrayIiLi65537EED2Ev.exit101.i
...
bb.e:                                             ; preds = %.lr.ph.i30.epil.preheader
  ...
  store ptr %i.av, ptr %i.ay, align 8, !tbaa !16
...
._crit_edge.i:                                    ; preds = %.lr.ph.i30.epil.preheader, %bb.e, %._crit_edge.i.unr-lcssa
  ...
  store i64 1, ptr %i.bd, align 8, !tbaa !9
  %i.be = sext i32 %.158.i.lcssa to i64
  %i.bf = getelementptr inbounds [8 x i8], ptr %i.an, i64 %i.be
  store ptr %i.bd, ptr %i.bf, align 8, !tbaa !16
  %i.bg = add i32 %.158.i.lcssa, 1                ; 2 uses
  %i.bh = icmp slt i32 %.158.i.lcssa, 1
  br i1 %i.bh, label %_ZSt9make_heapIPPmN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_112FHeapCompareEEvT_S5_T0_.exit.i, label %bb.f
...
bb.g:                                             ; preds = %_ZSt13__adjust_heapIPPmlS0_N9__gnu_cxx5__ops15_Iter_comp_iterIN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_112FHeapCompareEEEEvT_T0_SA_T1_T2_.exit.i.i.i, %bb.f
  %.014.i.i.i = phi i64 [ %i.bk, %bb.f ], [ %i.cy, %_ZSt13__adjust_heapIPPmlS0_N9__gnu_cxx5__ops15_Iter_comp_iterIN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_112FHeapCompareEEEEvT_T0_SA_T1_T2_.exit.i.i.i ] ; 8 uses
  %i.bq = getelementptr inbounds nuw [8 x i8], ptr %i.an, i64 %.014.i.i.i
  %i.br = load ptr, ptr %i.bq, align 8, !tbaa !16 ; 3 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.g, %.lr.ph.i.i.i.i
  ...
  %.val.i.i.i.i = load ptr, ptr %i.bv, align 8, !tbaa !16 ; 2 uses
  %.val29.i.i.i.i = load ptr, ptr %i.bx, align 8, !tbaa !16 ; 2 uses
  %i.by = load i64, ptr %.val.i.i.i.i, align 8, !tbaa !9 ; 2 uses
  %i.bz = load i64, ptr %.val29.i.i.i.i, align 8, !tbaa !9 ; 2 uses
  ...
  br i1 %i.cj, label %.lr.ph.i.i.i.i, label %._crit_edge.i.i.i.i, !llvm.loop !19
...
bb.h:                                             ; preds = %._crit_edge.i.i.i.i
  %i.cl = load ptr, ptr %i.bo, align 8, !tbaa !16
  store ptr %i.cl, ptr %i.bp, align 8, !tbaa !16
  br label %bb.i
...
bb.i:                                             ; preds = %bb.h, %._crit_edge.i.i.i.i
  ...
  br i1 %i.cm, label %.lr.ph.i.i.i.i.i, label %_ZSt13__adjust_heapIPPmlS0_N9__gnu_cxx5__ops15_Iter_comp_iterIN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_112FHeapCompareEEEEvT_T0_SA_T1_T2_.exit.i.i.i

.lr.ph.i.i.i.i.i:                                 ; preds = %bb.i
  %i.cn = load i64, ptr %i.br, align 8, !tbaa !9  ; 2 uses
  br label %bb.j
...
bb.j:                                             ; preds = %bb.k, %.lr.ph.i.i.i.i.i
  ...
  %.val.i.i.i.i.i = load ptr, ptr %i.co, align 8, !tbaa !16 ; 3 uses
  %i.cp = load i64, ptr %.val.i.i.i.i.i, align 8, !tbaa !9 ; 2 uses
  ...
  br i1 %i.cu, label %bb.k, label %_ZSt13__adjust_heapIPPmlS0_N9__gnu_cxx5__ops15_Iter_comp_iterIN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_112FHeapCompareEEEEvT_T0_SA_T1_T2_.exit.i.i.i

bb.k:                                             ; preds = %bb.j
  %i.cv = getelementptr inbounds nuw [8 x i8], ptr %i.an, i64 %.0133.i.i.i.i.i
  store ptr %.val.i.i.i.i.i, ptr %i.cv, align 8, !tbaa !16
  %i.cw = icmp samesign ugt i64 %.048.i.i.i.i.i, %.014.i.i.i
  br i1 %i.cw, label %bb.j, label %_ZSt13__adjust_heapIPPmlS0_N9__gnu_cxx5__ops15_Iter_comp_iterIN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_112FHeapCompareEEEEvT_T0_SA_T1_T2_.exit.i.i.i, !llvm.loop !20

_ZSt13__adjust_heapIPPmlS0_N9__gnu_cxx5__ops15_Iter_comp_iterIN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_112FHeapCompareEEEEvT_T0_SA_T1_T2_.exit.i.i.i: ; preds = %bb.k, %bb.j, %bb.i
  ...
  store ptr %i.br, ptr %i.cx, align 8, !tbaa !16
  %.not.i.i.i = icmp eq i64 %.014.i.i.i, 0
  %i.cy = add nsw i64 %.014.i.i.i, -1
  br i1 %.not.i.i.i, label %_ZSt9make_heapIPPmN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_112FHeapCompareEEvT_S5_T0_.exit.i, label %bb.g, !llvm.loop !21
...
bb.l:                                             ; preds = %.lr.ph.i30
  ...
  store ptr %i.db, ptr %i.de, align 8, !tbaa !16
...
bb.m:                                             ; preds = %.lr.ph.i30.1
  ...
  store ptr %i.di, ptr %i.dl, align 8, !tbaa !16
...
bb.n:                                             ; preds = %bb.m, %.lr.ph.i30.1
  ...
  br i1 %niter194.ncmp.1, label %._crit_edge.i.unr-lcssa, label %.lr.ph.i30, !llvm.loop !22

_ZSt9make_heapIPPmN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_112FHeapCompareEEvT_S5_T0_.exit.i: ; preds = %_ZSt13__adjust_heapIPPmlS0_N9__gnu_cxx5__ops15_Iter_comp_iterIN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_112FHeapCompareEEEEvT_T0_SA_T1_T2_.exit.i.i.i, %._crit_edge.i
  %i.dn = invoke noalias noundef nonnull dereferenceable(524296) ptr @_Znam(i64 noundef 524296) #11
          to label %bb.o unwind label %_ZN27OpenImageIO_v3_1_Imf__3_3_59AutoArrayIPmLi65537EED2Ev.exit100.i ; 10 uses

bb.o:                                             ; preds = %_ZSt9make_heapIPPmN27OpenImageIO_v3_1_Imf__3_3_512_GLOBAL__N_112FHeapCompareEEvT_S5_T0_.exit.i
...
.loopexit.i:                                      ; preds = %bb.ad
  ...
  br i1 %i.ds, label %bb.p, label %._crit_edge139.i, !llvm.loop !23

bb.p:                                             ; preds = %.loopexit.i, %.lr.ph138.i
  %indvars.iv144.i = phi i64 [ %i.dq, %.lr.ph138.i ], [ %i.fr, %.loopexit.i ] ; 5 uses
  %i.dt = load ptr, ptr %i.an, align 8, !tbaa !16 ; 2 uses
  ...
  %i.ea = load ptr, ptr %i.dz, align 8, !tbaa !16 ; 3 uses
  store ptr %i.dt, ptr %i.dz, align 8, !tbaa !16
...
.lr.ph.i.i.i75.i:                                 ; preds = %bb.p, %.lr.ph.i.i.i75.i
  ...
  %.val.i.i.i77.i = load ptr, ptr %i.ei, align 8, !tbaa !16 ; 2 uses
  %.val29.i.i.i78.i = load ptr, ptr %i.ek, align 8, !tbaa !16 ; 2 uses
  %i.el = load i64, ptr %.val.i.i.i77.i, align 8, !tbaa !9 ; 2 uses
  %i.em = load i64, ptr %.val29.i.i.i78.i, align 8, !tbaa !9 ; 2 uses
  ...
  store ptr %i.eu, ptr %i.ev, align 8, !tbaa !16
  %i.ew = icmp slt i64 %spec.select.i.i.i79.i, %i.ee
  br i1 %i.ew, label %.lr.ph.i.i.i75.i, label %._crit_edge.i.i.i66.i, !llvm.loop !19
