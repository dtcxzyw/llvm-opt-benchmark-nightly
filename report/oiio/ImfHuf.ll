...
.lr.ph.i30:                                       ; preds = %bb.n, %.lr.ph.i30.preheader.new
  ...
  %lsr.iv264 = phi ptr [ %scevgep265, %bb.n ], [ %lsr.iv262, %.lr.ph.i30.preheader.new ] ; 3 uses
...
.lr.ph.i32:                                       ; preds = %.lr.ph.i32.preheader, %bb.ah
  %indvars.iv.i33 = phi i64 [ %indvars.iv.next.i34, %bb.ah ], [ %i.kn, %.lr.ph.i32.preheader ] ; 4 uses
...
.lr.ph.i32.._crit_edge.i35_crit_edge:             ; preds = %.lr.ph.i32
  %indvars.iv.i33.lcssa.a = phi i64 [ %indvars.iv.i33, %.lr.ph.i32 ]
  %.02081.i.lcssa = phi i32 [ %.02081.i, %.lr.ph.i32 ]
  br label %._crit_edge.i35

._crit_edge.i35:                                  ; preds = %._crit_edge.i35split, %.lr.ph.i32.._crit_edge.i35_crit_edge
  %.1.lcssa.ph.in.i = phi i64 [ %indvars.iv.i33.lcssa.a, %.lr.ph.i32.._crit_edge.i35_crit_edge ], [ %indvars.iv.next.i34.lcssa298, %._crit_edge.i35split ]
