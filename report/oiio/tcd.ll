...
begin_hunk_1_@opj_tcd_init_tile:bb.a
  ...
  %5 = shl nuw i32 1, %.0493
  %6 = shl nuw i32 1, %.0492
...
begin_hunk_2_@opj_tcd_init_tile:bb.a
  ...
  %i.lk = urem i32 %.0459621, %i.lj
  %i.ll = shl i32 %i.lk, %.0493
  %i.lm = add nsw i32 %i.ll, %.0491               ; 2 uses
  %i.ln = udiv i32 %.0459621, %i.lj
  %i.lo = shl i32 %i.ln, %.0492
  %i.lp = add nsw i32 %i.lo, %.0494               ; 2 uses
  %i.lq = add nsw i32 %i.lm, %5
  %i.lr = add nsw i32 %i.lp, %6
  ...
  %i.lv = tail call noundef i32 @llvm.smax.i32(i32 %i.lp, i32 %i.lu) ; 2 uses
  ...
  %i.ly = tail call noundef i32 @llvm.smin.i32(i32 %i.lq, i32 %i.lx) ; 2 uses
