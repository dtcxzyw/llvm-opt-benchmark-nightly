...
.preheader141.lr.ph.split.i.us.i.i:               ; preds = %.preheader141.lr.ph.i.us.i.i
  ...
  %i.tq = add nsw i64 %wide.trip.count.i.us.i.i, -1 ; 4 uses
  ...
  %8 = trunc i64 %i.tq to i32
  %mul216 = tail call { i32, i1 } @llvm.umul.with.overflow.i32(i32 %8, i32 3) ; 2 uses
  %mul.result217 = extractvalue { i32, i1 } %mul216, 0
  %mul.overflow218 = extractvalue { i32, i1 } %mul216, 1
  %i.tu = icmp ugt i64 %i.tq, 4294967295
  %invariant.op286 = or i1 %mul.overflow218, %i.tu
  %9 = trunc i64 %i.tq to i32
  %mul219 = tail call { i32, i1 } @llvm.umul.with.overflow.i32(i32 %9, i32 3) ; 2 uses
...
vector.scevcheck:                                 ; preds = %.preheader141.i.us.i.i
  ...
  %10 = or i1 %i.ui, %mul.overflow
  %i.uj = sub i32 -2, %i.uf
  %i.uk = icmp ult i32 %i.uj, %mul.result217
  %.reass287 = or i1 %i.uk, %invariant.op286
  %i.ul = sub i32 -3, %i.ue
  %i.um = icmp ult i32 %i.ul, %mul.result220
  %i.un = or i1 %i.um, %mul.overflow221
  %i.uo = or i1 %10, %.reass287
  %i.up = or i1 %i.un, %i.uo
...
.preheader141.lr.ph.split.i.i.i:                  ; preds = %.preheader141.lr.ph.i.i.i
  ...
  %i.aax = add nsw i64 %wide.trip.count.i.i.i, -1 ; 4 uses
  %i.aay = mul i32 %.pre.i.i.i, 3
  %i.aaz = zext i32 %i.aay to i64
  %min.iters.check245 = icmp ult i32 %.pre.i.i.i, 13
  ...
  %11 = trunc i64 %i.aax to i32
  %mul238 = tail call { i32, i1 } @llvm.umul.with.overflow.i32(i32 %11, i32 3) ; 2 uses
  %mul.result239 = extractvalue { i32, i1 } %mul238, 0
  %mul.overflow240 = extractvalue { i32, i1 } %mul238, 1
  %i.abb = icmp ugt i64 %i.aax, 4294967295
  %invariant.op = or i1 %mul.overflow240, %i.abb
  %12 = trunc i64 %i.aax to i32
  %mul241 = tail call { i32, i1 } @llvm.umul.with.overflow.i32(i32 %12, i32 3) ; 2 uses
  %mul.result242 = extractvalue { i32, i1 } %mul241, 0
  %mul.overflow243 = extractvalue { i32, i1 } %mul241, 1
...
vector.scevcheck234:                              ; preds = %.preheader141.i.i.i
  ...
  %13 = or i1 %i.abr, %mul.overflow237
  %i.abs = sub i32 -2, %i.abo
  %i.abt = icmp ult i32 %i.abs, %mul.result239
  %.reass.a = or i1 %i.abt, %invariant.op
  %i.abu = sub i32 -3, %i.abn
  %i.abv = icmp ult i32 %i.abu, %mul.result242
  %i.abw = or i1 %i.abv, %mul.overflow243
  %i.abx = or i1 %13, %.reass.a
  %i.aby = or i1 %i.abw, %i.abx
