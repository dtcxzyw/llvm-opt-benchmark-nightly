...
begin_hunk_0_@opj_tcd_decode_tile:bb.a
  ...
  %i.xf = getelementptr inbounds nuw [192 x i8], ptr %i.xb, i64 %i.xe ; 4 uses
...
bb.bz:                                            ; preds = %bb.by
  ...
  %12 = load <2 x i32>, ptr %i.xh, align 8, !tbaa !3
  %13 = load <2 x i32>, ptr %i.xi, align 8, !tbaa !3
  %14 = sub <2 x i32> %12, %13
  %i.xj = getelementptr inbounds nuw i8, ptr %.074112.i, i64 80
  br label %bb.cb

bb.ca:                                            ; preds = %bb.by
  %i.xk = getelementptr inbounds nuw i8, ptr %i.xf, i64 8
  %15 = load <2 x i32>, ptr %i.xk, align 8, !tbaa !3
  %16 = load <2 x i32>, ptr %i.xf, align 8, !tbaa !3
...
bb.cb:                                            ; preds = %bb.ca, %bb.bz
  ...
  %19 = phi <2 x i32> [ %17, %bb.ca ], [ %14, %bb.bz ] ; 5 uses
...
bb.ce:                                            ; preds = %bb.cd, %bb.cc
  ...
  %20 = icmp eq <2 x i32> %19, zeroinitializer    ; 2 uses
  %21 = extractelement <2 x i1> %20, i64 0
  %22 = extractelement <2 x i1> %20, i64 1
  %or.cond.i225 = select i1 %21, i1 true, i1 %22
...
.preheader.us.i.preheader:                        ; preds = %bb.cf
  %23 = extractelement <2 x i32> %19, i64 0       ; 6 uses
  %i.yk = add i32 %23, -1
  %i.yl = zext i32 %i.yk to i64
  %i.ym = shl nuw nsw i64 %i.yl, 2
  %i.yn = zext i32 %23 to i64                     ; 2 uses
  %24 = extractelement <2 x i32> %19, i64 1
  %min.iters.check402 = icmp ult i32 %23, 8
...
.preheader96.us.preheader.i:                      ; preds = %bb.cf
  ...
  %26 = extractelement <2 x i32> %19, i64 0
...
begin_hunk_5_@opj_tcd_decode_tile:bb.a
  ...
  %exitcond.not.i226 = icmp eq i32 %i.zd, %26
...
._crit_edge.us.i:                                 ; preds = %bb.cj
  ...
  %exitcond123.not.i = icmp eq i32 %i.zf, %25
...
scalar.ph401.preheader:                           ; preds = %vector.memcheck, %.preheader.us.i, %middle.block415
  ...
  %i.zt = sub i32 %23, %.081104.us.i.ph
...
begin_hunk_8_@opj_tcd_decode_tile:bb.a
  ...
  %exitcond124.not.i.1 = icmp eq i32 %i.aal, %23
...
._crit_edge.us108.i:                              ; preds = %scalar.ph401.prol.loopexit, %scalar.ph401, %middle.block415
  ...
  %exitcond125.not.i = icmp eq i32 %i.aan, %24
...
bb.m:                                             ; preds = %bb.l
  ...
  %3 = load <2 x i32>, ptr %i.cq, align 8, !tbaa !3
  %4 = load <2 x i32>, ptr %i.co, align 8, !tbaa !3
  %5 = sub nsw <2 x i32> %3, %4                   ; 2 uses
...
bb.n:                                             ; preds = %bb.l
  ...
  %7 = load <2 x i32>, ptr %i.db, align 8, !tbaa !3
  %8 = load <2 x i32>, ptr %i.dc, align 8, !tbaa !3
  %9 = sub <2 x i32> %7, %8
  br label %bb.o
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  %10 = phi <2 x i32> [ %9, %bb.n ], [ %5, %bb.m ] ; 4 uses
  %11 = extractelement <2 x i32> %10, i64 0       ; 30 uses
...
bb.p:                                             ; preds = %bb.o
  ...
  %13 = extractelement <2 x i32> %10, i64 1       ; 3 uses
  %.not219 = icmp eq i32 %13, 0                   ; 2 uses
...
.preheader143.us.preheader:                       ; preds = %.preheader143.lr.ph
  ...
  %i.dr = zext i32 %11 to i64                     ; 2 uses
  %min.iters.check314 = icmp ult i32 %11, 8
...
begin_hunk_14_@opj_tcd_update_tile_data:bb.a
  ...
  %exitcond246.not.7 = icmp eq i32 %i.fq, %11
...
begin_hunk_15_@opj_tcd_update_tile_data:bb.a
  ...
  %exitcond247.not = icmp eq i32 %i.fs, %13
...
.preheader.us.preheader:                          ; preds = %.preheader.lr.ph
  ...
  %i.fx = zext i32 %11 to i64                     ; 2 uses
...
begin_hunk_18_@opj_tcd_update_tile_data:bb.a
  ...
  %exitcond248.not.7 = icmp eq i32 %i.hw, %11
...
begin_hunk_19_@opj_tcd_update_tile_data:bb.a
  ...
  %exitcond249.not = icmp eq i32 %i.hy, %13
...
bb.q:                                             ; preds = %bb.o
  ...
  %14 = extractelement <2 x i32> %10, i64 1       ; 3 uses
  %.not215 = icmp eq i32 %14, 0                   ; 2 uses
...
.preheader145.us.preheader:                       ; preds = %.preheader145.lr.ph
  ...
  %i.ig = zext i32 %11 to i64                     ; 2 uses
  %min.iters.check364 = icmp ult i32 %11, 8
...
begin_hunk_22_@opj_tcd_update_tile_data:bb.a
  ...
  %exitcond242.not.7 = icmp eq i32 %i.kh, %11
...
begin_hunk_23_@opj_tcd_update_tile_data:bb.a
  ...
  %exitcond243.not = icmp eq i32 %i.kj, %14
...
.preheader144.us.preheader:                       ; preds = %.preheader144.lr.ph
  ...
  %i.kp = zext i32 %11 to i64                     ; 2 uses
  %min.iters.check339 = icmp ult i32 %11, 8
...
begin_hunk_26_@opj_tcd_update_tile_data:bb.a
  ...
  %exitcond244.not.7 = icmp eq i32 %i.mq, %11
...
begin_hunk_27_@opj_tcd_update_tile_data:bb.a
  ...
  %exitcond245.not = icmp eq i32 %i.ms, %14
