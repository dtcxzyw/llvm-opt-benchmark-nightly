...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %8 = load i32, ptr %i.da, align 4, !tbaa !173, !alias.scope !178
  %broadcast.splatinsert = insertelement <4 x i32> poison, i32 %8, i64 0
  %broadcast.splat = shufflevector <4 x i32> %broadcast.splatinsert, <4 x i32> poison, <4 x i32> zeroinitializer ; 2 uses
  %9 = shl i64 %n.vec, 2
  %10 = getelementptr i8, ptr %i.by, i64 %9
...
scalar.ph.preheader:                              ; preds = %vector.memcheck, %.lr.ph7.i, %middle.block
  %.06.i.ph = phi ptr [ %i.by, %vector.memcheck ], [ %i.by, %.lr.ph7.i ], [ %10, %middle.block ] ; 2 uses
