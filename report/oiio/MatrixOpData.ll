...
vector.ph:                                        ; preds = %.preheader
  %invariant.gep = getelementptr [8 x i8], ptr %i.n, i64 %i.ah
  %invariant.gep89 = getelementptr [8 x i8], ptr %i.ai, i64 %i.ah
  br label %vector.body

vector.body:                                      ; preds = %pred.store.continue81, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %pred.store.continue81 ] ; 4 uses
...
pred.store.if:                                    ; preds = %vector.body
  %gep90 = getelementptr [8 x i8], ptr %invariant.gep89, i64 %index
