...
bb.c:                                             ; preds = %bb.b
  %i.bg = zext i32 %i.n to i64                    ; 23 uses
...
bb.p:                                             ; preds = %bb.n, %bb.o
  ...
  %i.dx = call ptr @ft_mem_realloc(ptr noundef %i.h, i64 noundef 8, i64 noundef 0, i64 noundef %i.bg, ptr noundef null, ptr noundef nonnull %i.a) #23 ; 18 uses
  %i.dy = load i32, ptr %i.a, align 4, !tbaa !3
  %.not375 = icmp eq i32 %i.dy, 0
  br i1 %.not375, label %bb.q, label %bb.ao

bb.q:                                             ; preds = %bb.p
  %i.dz = call ptr @ft_mem_realloc(ptr noundef %i.h, i64 noundef 8, i64 noundef 0, i64 noundef %i.bg, ptr noundef null, ptr noundef nonnull %i.a) #23 ; 21 uses
...
begin_hunk_2
  ...
  %3 = shl nuw nsw i64 %i.bg, 3                   ; 4 uses
  %scevgep561 = getelementptr i8, ptr %i.dx, i64 %3 ; 3 uses
  %scevgep562 = getelementptr i8, ptr %i.dz, i64 %3 ; 3 uses
  %i.ex = shl nuw nsw i64 %i.bg, 3                ; 2 uses
  %scevgep600.a = getelementptr i8, ptr %i.dx, i64 %i.ex ; 3 uses
  %scevgep601.a = getelementptr i8, ptr %i.dz, i64 %i.ex ; 3 uses
...
begin_hunk_3
  ...
  %bound0565 = icmp ult ptr %i.dx, %scevgep562
  %bound1566 = icmp ult ptr %i.dz, %scevgep561
...
vector.memcheck560:                               ; preds = %.lr.ph446
  %scevgep563 = getelementptr i8, ptr %i.ho, i64 %3 ; 2 uses
  %scevgep564 = getelementptr i8, ptr %i.hq, i64 %3 ; 2 uses
  %bound0568 = icmp ult ptr %i.dx, %scevgep563
  %bound1569 = icmp ult ptr %i.ho, %scevgep561
  ...
  %bound1573 = icmp ult ptr %i.hq, %scevgep561
  ...
  %bound1577 = icmp ult ptr %i.ho, %scevgep562
  ...
  %bound1581 = icmp ult ptr %i.hq, %scevgep562
