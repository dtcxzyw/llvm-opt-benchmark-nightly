...
begin_hunk_1
  ...
  %i.aa = call i32 %i.z(ptr noundef nonnull %0, i64 noundef 1735811442, ptr noundef %i.v, ptr noundef nonnull %i.b) #24 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.ac = call i32 @FT_Stream_ReadFields(ptr noundef nonnull %i.v, ptr noundef nonnull @ft_var_load_gvar.gvar_fields, ptr noundef nonnull %4) #24 ; 2 uses
