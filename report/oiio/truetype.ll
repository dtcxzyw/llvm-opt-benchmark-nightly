...
tt_face_get_location.exit:                        ; preds = %bb.o, %bb.q, %.thread71.i
  ...
  store i32 %storemerge.sink.i, ptr %i.cn, align 8, !tbaa !743
  br label %bb.s
...
bb.t:                                             ; preds = %bb.s
  ...
  %i.cr = load i64, ptr %i.cq, align 8, !tbaa !745 ; 2 uses
  %.not290 = icmp eq i64 %i.cr, 0
  br i1 %.not290, label %bb.u, label %bb.w

bb.u:                                             ; preds = %bb.t
  %i.cs = load ptr, ptr %i.ab, align 8, !tbaa !733
...
bb.aa:                                            ; preds = %.thread, %bb.z
  ...
  call void %i.dr(ptr noundef %i.dk, i8 noundef zeroext 0, i32 noundef %1, ptr noundef nonnull %i.a, ptr noundef nonnull %i.c) #22, !inline_history !747
...
bb.ab:                                            ; preds = %bb.aa
  ...
  call void %i.dw(ptr noundef nonnull %i.dk, i8 noundef zeroext 1, i32 noundef %1, ptr noundef nonnull %i.b, ptr noundef nonnull %i.d) #22, !inline_history !748
  br label %TT_Get_VMetrics.exit.i

bb.ac:                                            ; preds = %bb.aa
  %i.dx = getelementptr inbounds nuw i8, ptr %0, i64 88
  %i.dy = load i64, ptr %i.dx, align 8, !tbaa !749
...
bb.af:                                            ; preds = %TT_Get_VMetrics.exit.i
  ...
  store i32 %i.ey, ptr %i.ez, align 8, !tbaa !750
  ...
  store i32 %i.fb, ptr %i.fc, align 4, !tbaa !751
  ...
  store i32 %i.fe, ptr %i.ff, align 8, !tbaa !752
  ...
  %i.fk = load ptr, ptr %i.fj, align 8, !tbaa !733
...
bb.ak:                                            ; preds = %bb.aj, %bb.ai
  ...
  %i.fy = load ptr, ptr %i.fx, align 8, !tbaa !733
...
bb.al:                                            ; preds = %bb.ak
  %i.gb = load ptr, ptr %i.ga, align 8, !tbaa !734
  %i.gc = getelementptr inbounds nuw i8, ptr %i.gb, i64 16
  %i.gd = load ptr, ptr %i.gc, align 8, !tbaa !754 ; 2 uses
...
bb.am:                                            ; preds = %bb.al
  ...
  store i64 %i.ge, ptr %5, align 8, !tbaa !755
  %i.gf = getelementptr inbounds nuw i8, ptr %5, i64 8
  store i64 0, ptr %i.gf, align 8, !tbaa !757
  %i.gg = zext i16 %i.fa to i64
  %i.gh = getelementptr inbounds nuw i8, ptr %5, i64 16 ; 2 uses
  store i64 %i.gg, ptr %i.gh, align 8, !tbaa !758
  %i.gi = getelementptr inbounds nuw i8, ptr %5, i64 24
  store i64 0, ptr %i.gi, align 8, !tbaa !759
  %i.gj = getelementptr inbounds nuw i8, ptr %i.ga, i64 8
  %i.gk = load ptr, ptr %i.gj, align 8, !tbaa !740
  %i.gl = call i32 %i.gd(ptr noundef %i.gk, i32 noundef %1, i8 noundef zeroext 0, ptr noundef nonnull %5) #22, !inline_history !760
  %.not23.i = icmp eq i32 %i.gl, 0
  br i1 %.not23.i, label %bb.an, label %._crit_edge437

._crit_edge437:                                   ; preds = %bb.am
  %.pre427.pre.a = load i32, ptr %i.ez, align 8, !tbaa !750
  %.pre428.pre.a = load i32, ptr %i.fc, align 4, !tbaa !751
  %.pre429.pre.a = load i32, ptr %i.ff, align 8, !tbaa !752
  %.pre430.pre = load i32, ptr %i.fi, align 4, !tbaa !173
  br label %bb.ap

bb.an:                                            ; preds = %bb.am
  %i.gm = load i64, ptr %5, align 8, !tbaa !755
  %i.gn = trunc i64 %i.gm to i16
  %i.go = load i64, ptr %i.gh, align 8, !tbaa !758
  %i.gp = trunc i64 %i.go to i32
  %i.gq = sext i16 %i.gn to i32                   ; 3 uses
  store i32 %i.gq, ptr %i.ez, align 8, !tbaa !750
  %i.gr = and i32 %i.gp, 65535                    ; 4 uses
  store i32 %i.gr, ptr %i.fc, align 4, !tbaa !751
  store i32 0, ptr %i.ff, align 8, !tbaa !752
  store i32 0, ptr %i.fi, align 4, !tbaa !173
  %i.gs = getelementptr inbounds nuw i8, ptr %0, i64 108 ; 2 uses
  %i.gt = load i8, ptr %i.gs, align 4, !tbaa !753
  %.not24.i = icmp eq i8 %i.gt, 0
  br i1 %.not24.i, label %bb.ao, label %bb.ap

bb.ao:                                            ; preds = %bb.an
  store i8 1, ptr %i.gs, align 4, !tbaa !753
...
tt_get_metrics_incremental.exit:                  ; preds = %bb.ak, %bb.al, %bb.ap
  ...
  %i.hb = load i64, ptr %i.ha, align 8, !tbaa !761
...
bb.at:                                            ; preds = %bb.as
  ...
  store i64 %i.ig, ptr %i.hk, align 8, !tbaa !765
  store i64 %i.ig, ptr %i.hq, align 8, !tbaa !767
...
bb.av:                                            ; preds = %bb.au, %tt_loader_set_pp.exit
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %8, ptr noundef nonnull align 8 dereferenceable(16) %i.he, i64 16, i1 false), !tbaa.struct !438
  %i.in = getelementptr inbounds nuw i8, ptr %8, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %i.in, ptr noundef nonnull align 8 dereferenceable(16) %i.hi, i64 16, i1 false), !tbaa.struct !438
  %i.io = getelementptr inbounds nuw i8, ptr %8, i64 32
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %i.io, ptr noundef nonnull align 8 dereferenceable(16) %i.hk, i64 16, i1 false), !tbaa.struct !438
  %i.ip = getelementptr inbounds nuw i8, ptr %8, i64 48
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(16) %i.ip, ptr noundef nonnull align 8 dereferenceable(16) %i.hq, i64 16, i1 false), !tbaa.struct !438
  %i.iq = getelementptr inbounds nuw i8, ptr %9, i64 2
  store i16 0, ptr %i.iq, align 2, !tbaa !769
  store i16 0, ptr %9, align 8, !tbaa !770
  %i.ir = getelementptr inbounds nuw i8, ptr %9, i64 8
  store ptr %8, ptr %i.ir, align 8, !tbaa !771
