...
bb.vb:                                            ; preds = %switch.lookup1302
  %i.cpt = lshr exact i64 %switch.load1304, 10
  br label %bb.ve

bb.vc:                                            ; preds = %switch.lookup1302
  %i.cpu = lshr exact i64 %switch.load1304, 9
  br label %bb.ve

bb.vd:                                            ; preds = %switch.lookup1302
  %i.cpv = mul nuw nsw i64 %switch.load1304, 3
  %i.cpw = lshr exact i64 %i.cpv, 10
  br label %bb.ve
...
begin_hunk_1_@TT_RunIns:bb.a
  ...
  store i64 %i.cpx, ptr %i.ff, align 8, !tbaa !465
...
begin_hunk_3_@TT_RunIns:bb.a
  ...
  store i64 %i.cqp, ptr %i.ff, align 8, !tbaa !465
