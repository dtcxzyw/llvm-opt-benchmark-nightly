...
begin_hunk_0_@compute_glyph_metrics:bb.a
  ...
  %. = select i1 %.not82, i64 410, i64 708
  %.117 = select i1 %.not82, i64 408, i64 706
  %i.bo = getelementptr inbounds nuw i8, ptr %i.a, i64 %.117
  %.sink112.in = load i16, ptr %i.bo, align 2, !tbaa !135
  %.sink112 = sext i16 %.sink112.in to i64
  %.sink114.in = getelementptr inbounds nuw i8, ptr %i.a, i64 %.
  %.sink114 = load i16, ptr %.sink114.in, align 2, !tbaa !135
...
bb.b:                                             ; preds = %bb.x, %bb.a
  %.0118 = phi ptr [ %i.b, %bb.a ], [ %.2, %bb.x ] ; 14 uses
...
bb.r:                                             ; preds = %bb.p, %bb.q, %bb.m, %bb.n
  ...
  %.pn = phi i64 [ 8, %bb.p ], [ 6, %bb.q ], [ 8, %bb.m ], [ 6, %bb.n ]
  store i32 %.sink, ptr %i.r, align 4, !tbaa !789
  %.1119 = getelementptr inbounds nuw i8, ptr %.0118, i64 %.pn ; 18 uses
