...
tt_skip_pdffont_random_tag.exit.i:                ; preds = %.preheader.5.i.i, %.preheader.4.i.i, %.preheader.3.i.i, %.preheader.2.i.i, %.preheader.1.i.i, %.preheader.preheader.i.i, %bb.d, %bb.c
  %.09.i.i = phi ptr [ %i.c, %.preheader.preheader.i.i ], [ %i.c, %bb.c ], [ %i.c, %bb.d ], [ %spec.select.i.i, %.preheader.5.i.i ], [ %i.c, %.preheader.4.i.i ], [ %i.c, %.preheader.3.i.i ], [ %i.c, %.preheader.2.i.i ], [ %i.c, %.preheader.1.i.i ] ; 21 uses
  call void @llvm.assume(i1 true) [ "nonnull"(ptr %.09.i.i) ]
