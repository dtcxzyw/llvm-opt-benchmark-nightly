...
bb.e:                                             ; preds = %bb.d
  %i.z = load float, ptr %i.l, align 4, !tbaa !38
  store float %i.z, ptr %i.t, align 4, !tbaa !38
  br label %bb.f

bb.f:                                             ; preds = %bb.e, %bb.d, %bb.c, %.thread.i.i.i
  %i.aa = phi ptr [ %i.w, %bb.e ], [ %i.w, %bb.d ], [ %i.w, %bb.c ], [ %i.r, %.thread.i.i.i ]
  %i.ab = phi ptr [ %i.v, %bb.e ], [ %i.v, %bb.d ], [ %i.v, %bb.c ], [ %i.q, %.thread.i.i.i ]
  %i.ac = phi ptr [ %i.u, %bb.e ], [ %i.u, %bb.d ], [ %i.u, %bb.c ], [ %i.p, %.thread.i.i.i ]
  store ptr %i.ab, ptr %i.ac, align 8, !tbaa !33
  %i.ad = invoke noalias noundef nonnull dereferenceable(168) ptr @_Znwm(i64 noundef 168) #24
          to label %bb.g unwind label %bb.j, !inline_history !36 ; 4 uses

bb.g:                                             ; preds = %bb.f
  invoke void @_ZN16OpenColorIO_v2_56OpDataC2Ev(ptr noundef nonnull align 8 dereferenceable(168) %i.ad)
          to label %bb.h unwind label %bb.k, !inline_history !36

bb.h:                                             ; preds = %bb.g
  store ptr getelementptr inbounds nuw inrange(-16, 88) (i8, ptr @_ZTVN16OpenColorIO_v2_58NoOpDataE, i64 16), ptr %i.ad, align 8, !tbaa !15
  invoke void @_ZNSt12__shared_ptrIN16OpenColorIO_v2_56OpDataELN9__gnu_cxx12_Lock_policyE2EE5resetINS0_8NoOpDataEEENSt9enable_ifIXsr21__sp_is_constructibleIS1_T_EE5valueEvE4typeEPS8_(ptr noundef nonnull align 8 dereferenceable(16) %i.e, ptr noundef nonnull %i.ad)
          to label %_ZNSt10shared_ptrIN16OpenColorIO_v2_512_GLOBAL__N_114AllocationNoOpEEC2ISaIvEJRKNS0_14AllocationDataEEEESt20_Sp_alloc_shared_tagIT_EDpOT0_.exit unwind label %bb.j, !inline_history !36
...
bb.k:                                             ; preds = %bb.g
  %i.ag = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ad, i64 noundef 168) #26, !inline_history !36
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %bb.j
  %.pn.i.i.i.i.i.i = phi { ptr, i32 } [ %i.af, %bb.j ], [ %i.ag, %bb.k ] ; 2 uses
  %i.ah = load ptr, ptr %i.h, align 8, !tbaa !34  ; 3 uses
...
bb.m:                                             ; preds = %bb.l
  %i.ai = load ptr, ptr %i.aa, align 8, !tbaa !35
  %i.aj = ptrtoint ptr %i.ai to i64
  %i.ak = ptrtoint ptr %i.ah to i64
  %i.al = sub i64 %i.aj, %i.ak
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ah, i64 noundef %i.al) #26, !inline_history !36
  br label %_ZN16OpenColorIO_v2_514AllocationDataD2Ev.exit.i.i.i.i.i.i

_ZN16OpenColorIO_v2_514AllocationDataD2Ev.exit.i.i.i.i.i.i: ; preds = %bb.m, %bb.l, %bb.i
  %.pn.pn.i.i.i.i.i.i = phi { ptr, i32 } [ %i.ae, %bb.i ], [ %.pn.i.i.i.i.i.i, %bb.l ], [ %.pn.i.i.i.i.i.i, %bb.m ]
  tail call void @_ZN16OpenColorIO_v2_52OpD2Ev(ptr noundef nonnull align 8 dead_on_return(24) dereferenceable(56) %i.d) #23, !inline_history !36
  tail call void @_ZdlPvm(ptr noundef nonnull %i.a, i64 noundef 72) #26, !inline_history !24
...
_ZNSt10shared_ptrIN16OpenColorIO_v2_512_GLOBAL__N_114AllocationNoOpEEC2ISaIvEJRKNS0_14AllocationDataEEEESt20_Sp_alloc_shared_tagIT_EDpOT0_.exit: ; preds = %bb.h
  ...
  store ptr %i.a, ptr %i.am, align 8, !tbaa !9
...
define linkonce_odr hidden void @_ZNSt12__shared_ptrIN16OpenColorIO_v2_52OpELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %0) unnamed_addr #4 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #23, !inline_history !41
  %i.k = load ptr, ptr %i.b, align 8, !tbaa !15
  %i.l = getelementptr inbounds nuw i8, ptr %i.k, i64 24
  %i.m = load ptr, ptr %i.l, align 8
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(16) %i.b) #23, !inline_history !41
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i: ; preds = %bb.f, %bb.e
  ...
  br i1 %i.o, label %bb.g, label %_ZNSt14__shared_countILN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !19
...
bb.c:                                             ; preds = %bb.a
  ...
  %i.g = tail call noalias noundef nonnull dereferenceable(248) ptr @_Znwm(i64 noundef 248) #24, !noalias !46 ; 6 uses
  %i.h = getelementptr inbounds nuw i8, ptr %i.g, i64 8
  store i32 1, ptr %i.h, align 8, !tbaa !12, !noalias !46
  %i.i = getelementptr inbounds nuw i8, ptr %i.g, i64 12
  store i32 1, ptr %i.i, align 4, !tbaa !14, !noalias !46
  store ptr getelementptr inbounds nuw inrange(-16, 40) (i8, ptr @_ZTVSt23_Sp_counted_ptr_inplaceIN16OpenColorIO_v2_511Lut3DOpDataESaIvELN9__gnu_cxx12_Lock_policyE2EE, i64 16), ptr %i.g, align 8, !tbaa !15, !noalias !46
...
_ZNSt15__allocated_ptrISaISt23_Sp_counted_ptr_inplaceIN16OpenColorIO_v2_511Lut3DOpDataESaIvELN9__gnu_cxx12_Lock_policyE2EEEED2Ev.exit10.i.i.i.i: ; preds = %bb.c
  %i.l = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvm(ptr noundef nonnull %i.g, i64 noundef 248) #26, !noalias !46
...
_ZSt11make_sharedIN16OpenColorIO_v2_511Lut3DOpDataEJRKjEESt10shared_ptrINSt9enable_ifIXntsr8is_arrayIT_EE5valueES6_E4typeEEDpOT0_.exit: ; preds = %bb.c
  ...
  store ptr %i.g, ptr %i.m, align 8, !tbaa !9, !alias.scope !46
  store ptr %i.j, ptr %3, align 8, !tbaa !49, !alias.scope !46
...
.noexc:                                           ; preds = %_ZSt11make_sharedIN16OpenColorIO_v2_511Lut3DOpDataEJRKjEESt10shared_ptrINSt9enable_ifIXntsr8is_arrayIT_EE5valueES6_E4typeEEDpOT0_.exit
  store float 0.000000e+00, ptr %i.q, align 4, !tbaa !38
  %i.r = getelementptr i8, ptr %i.q, i64 4
  %.idx.i.i.i.i.i.i.i = add nsw i64 %i.p, -4
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(1) %i.r, i8 0, i64 %.idx.i.i.i.i.i.i.i, i1 false), !tbaa !38
...
bb.d:                                             ; preds = %.noexc
  %i.s = load ptr, ptr %1, align 8, !tbaa !51     ; 2 uses
  %i.t = load ptr, ptr %i.a, align 8, !tbaa !51   ; 2 uses
...
.lr.ph52:                                         ; preds = %._crit_edge
  %i.v = load ptr, ptr %3, align 8, !tbaa !52
  %i.w = getelementptr inbounds nuw i8, ptr %i.v, i64 200
  %i.x = load ptr, ptr %i.w, align 8, !tbaa !34   ; 6 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ao = load float, ptr %i.am, align 4, !tbaa !38, !alias.scope !54
  %i.ap = load float, ptr %i.an, align 4, !tbaa !38, !alias.scope !54
  ...
  %i.bb = load float, ptr %i.az, align 4, !tbaa !38, !alias.scope !54
  %i.bc = load float, ptr %i.ba, align 4, !tbaa !38, !alias.scope !54
  ...
  %i.bl = load float, ptr %i.bj, align 4, !tbaa !38, !alias.scope !54
  %i.bm = load float, ptr %i.bk, align 4, !tbaa !38, !alias.scope !54
  ...
  store <6 x float> %interleaved.vec, ptr %i.au, align 4, !tbaa !38, !alias.scope !57, !noalias !54
  %index.next = add nuw i64 %index, 2             ; 2 uses
  %i.bq = icmp eq i64 %index.next, %n.vec
  br i1 %i.bq, label %scalar.ph.preheader, label %vector.body, !llvm.loop !59
...
bb.g:                                             ; preds = %.lr.ph, %bb.h
  ...
  %i.bt = load ptr, ptr %.sroa.033.049, align 8, !tbaa !63 ; 2 uses
...
_ZNSt6vectorIfSaIfEED2Ev.exit:                    ; preds = %bb.k
  ...
  %i.cx = load ptr, ptr %i.m, align 8, !tbaa !9   ; 8 uses
...
bb.n:                                             ; preds = %bb.m
  store i32 0, ptr %i.cy, align 8, !tbaa !12
  %i.dc = getelementptr inbounds nuw i8, ptr %i.cx, i64 12
  store i32 0, ptr %i.dc, align 4, !tbaa !14
  %i.dd = load ptr, ptr %i.cx, align 8, !tbaa !15
  %i.de = getelementptr inbounds nuw i8, ptr %i.dd, i64 16
  %i.df = load ptr, ptr %i.de, align 8
  call void %i.df(ptr noundef nonnull align 8 dereferenceable(16) %i.cx) #23, !inline_history !67
  %i.dg = load ptr, ptr %i.cx, align 8, !tbaa !15
  %i.dh = getelementptr inbounds nuw i8, ptr %i.dg, i64 24
  %i.di = load ptr, ptr %i.dh, align 8
  call void %i.di(ptr noundef nonnull align 8 dereferenceable(16) %i.cx) #23, !inline_history !67
  br label %_ZNSt12__shared_ptrIN16OpenColorIO_v2_511Lut3DOpDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit

bb.o:                                             ; preds = %bb.m
  %i.dj = load i8, ptr @__libc_single_threaded, align 1, !tbaa !18
...
_ZN9__gnu_cxx27__exchange_and_add_dispatchEPii.exit.i.i.i: ; preds = %bb.q, %bb.p
  ...
  br i1 %i.dm, label %bb.r, label %_ZNSt12__shared_ptrIN16OpenColorIO_v2_511Lut3DOpDataELN9__gnu_cxx12_Lock_policyE2EED2Ev.exit, !prof !19
...
bb.s:                                             ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit32, %bb.e
  ...
  call void @_ZNSt12__shared_ptrIN16OpenColorIO_v2_511Lut3DOpDataELN9__gnu_cxx12_Lock_policyE2EED2Ev(ptr noundef nonnull align 8 dereferenceable(16) %3) #23
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #23
  br label %common.resume
