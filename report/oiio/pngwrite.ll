...
bb.g:                                             ; preds = %bb.f, %bb.e, %.split.us87
  %.0.us83 = phi i16 [ 0, %bb.e ], [ %i.al, %bb.f ], [ -1, %.split.us87 ]
  %i.am = getelementptr inbounds nuw i8, ptr %.05674.us, i64 2
  store i16 %.0.us83, ptr %.05674.us, align 2, !tbaa !226
  br i1 %.not105, label %.split71.us84, label %.split.us87.1

.split.us87.1:                                    ; preds = %bb.g
  %i.an = getelementptr inbounds nuw i8, ptr %.05773.us, i64 4 ; 2 uses
...
.split.us87.2:                                    ; preds = %bb.i, %bb.h, %.split.us87.1
  %.0.us83.1 = phi i16 [ 0, %bb.h ], [ %i.at, %bb.i ], [ -1, %.split.us87.1 ]
  %i.au = getelementptr inbounds nuw i8, ptr %.05674.us, i64 4 ; 2 uses
  store i16 %.0.us83.1, ptr %i.am, align 2, !tbaa !226
...
bb.l:                                             ; preds = %bb.k, %bb.j, %.split.us87.2
  %.0.us83.2 = phi i16 [ 0, %bb.j ], [ %i.ba, %bb.k ], [ -1, %.split.us87.2 ]
  store i16 %.0.us83.2, ptr %i.au, align 2, !tbaa !226
  br label %.split71.us84

.split71.us84:                                    ; preds = %.split.us.us, %.split.us.us.1, %bb.g, %bb.l
  %.us-phi.us = phi ptr [ %i.an, %bb.l ], [ %.05773.us, %bb.g ], [ %.05773.us, %.split.us.us ], [ %i.bj, %.split.us.us.1 ]
  %.us-phi72.us = phi ptr [ %i.au, %bb.l ], [ %.05674.us, %bb.g ], [ %.05674.us, %.split.us.us ], [ %i.bi, %.split.us.us.1 ]
...
.split.us.us:                                     ; preds = %bb.d
  %i.be = load i16, ptr %.05773.us, align 2, !tbaa !226
  store i16 %i.be, ptr %.05674.us, align 2, !tbaa !226
  br i1 %.not104, label %.split71.us84, label %.split.us.us.1

.split.us.us.1:                                   ; preds = %.split.us.us
  %i.bf = getelementptr inbounds nuw i8, ptr %.05674.us, i64 2
  %i.bg = getelementptr inbounds nuw i8, ptr %.05773.us, i64 2
  %i.bh = load i16, ptr %i.bg, align 2, !tbaa !226
  store i16 %i.bh, ptr %i.bf, align 2, !tbaa !226
  %i.bi = getelementptr inbounds nuw i8, ptr %.05674.us, i64 4 ; 2 uses
  %i.bj = getelementptr inbounds nuw i8, ptr %.05773.us, i64 4 ; 2 uses
...
._crit_edge.us:                                   ; preds = %.split71.us84
  ...
  %i.bp = getelementptr inbounds nuw [2 x i8], ptr %.16376.us, i64 %i.bo
  %i.bq = add i32 %.05977.us, -1                  ; 2 uses
...
bb.b:                                             ; preds = %bb.a
  ...
  %.072.idx = zext nneg i32 %.lobit to i64
  %.072 = getelementptr inbounds nuw i8, ptr %i.g, i64 %.072.idx ; 2 uses
  ...
  %i.v = getelementptr inbounds nuw i8, ptr %.072, i64 %i.u
...
.preheader78.us.preheader:                        ; preds = %.preheader78.lr.ph
  %.073.idx = select i1 %.not76.not, i64 0, i64 2
  %.073 = getelementptr inbounds nuw i8, ptr %i.e, i64 %.073.idx
  %i.x = lshr i32 %i.k, 1
  %.lobit114 = and i32 %i.x, 1
  %i.y = zext nneg i32 %.lobit114 to i64          ; 2 uses
  %i.z = shl nuw nsw i64 %i.y, 1                  ; 2 uses
  %i.aa = or disjoint i64 %i.z, 1
  %i.ab = shl nuw nsw i64 %i.y, 2
  %.not124 = icmp eq i32 %i.l, 0
  br label %.preheader78.us

.preheader78.us:                                  ; preds = %.preheader78.us.preheader, %._crit_edge.us
  %.07087.us = phi i32 [ %i.dk, %._crit_edge.us ], [ %i.i, %.preheader78.us.preheader ]
  %.17486.us = phi ptr [ %i.dj, %._crit_edge.us ], [ %.073, %.preheader78.us.preheader ] ; 2 uses
  br label %bb.c

bb.c:                                             ; preds = %.preheader78.us, %.split81.us92
  %.06684.us = phi ptr [ %.072, %.preheader78.us ], [ %i.dd, %.split81.us92 ] ; 7 uses
  %.06783.us = phi ptr [ %.17486.us, %.preheader78.us ], [ %i.dc, %.split81.us92 ] ; 6 uses
  %i.ac = getelementptr inbounds [2 x i8], ptr %.06783.us, i64 %.069
  ...
  %i.aj = getelementptr inbounds i8, ptr %.06684.us, i64 %.069
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %.065.us = phi i32 [ %i.ao, %bb.d ], [ 0, %bb.c ] ; 3 uses
...
png_unpremultiply.exit.us.us.preheader:           ; preds = %bb.e
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 1 dereferenceable(1) %.06684.us, i8 -1, i64 %i.aa, i1 false), !tbaa !47
  %scevgep = getelementptr nuw i8, ptr %.06783.us, i64 %i.ab
  %scevgep109 = getelementptr nuw i8, ptr %.06684.us, i64 %i.z
  br label %.split81.us92

.split.us95:                                      ; preds = %bb.e
  %i.aq = getelementptr inbounds nuw i8, ptr %.06783.us, i64 2
  %i.ar = load i16, ptr %.06783.us, align 2, !tbaa !226 ; 3 uses
...
png_unpremultiply.exit.us91:                      ; preds = %bb.g, %bb.f, %.split.us95
  ...
  store i8 %.0.i.us, ptr %.06684.us, align 1, !tbaa !47
  br i1 %.not124, label %.split81.us92, label %.split.us95.1
...
.split81.us92:                                    ; preds = %png_unpremultiply.exit.us91, %png_unpremultiply.exit.us91.2, %png_unpremultiply.exit.us.us.preheader
  %.us-phi.us = phi ptr [ %scevgep, %png_unpremultiply.exit.us.us.preheader ], [ %.06783.us, %png_unpremultiply.exit.us91 ], [ %i.bm, %png_unpremultiply.exit.us91.2 ]
  %.us-phi82.us = phi ptr [ %scevgep109, %png_unpremultiply.exit.us.us.preheader ], [ %.06684.us, %png_unpremultiply.exit.us91 ], [ %i.ch, %png_unpremultiply.exit.us91.2 ]
...
._crit_edge.us:                                   ; preds = %.split81.us92
  ...
  %i.dj = getelementptr inbounds nuw [2 x i8], ptr %.17486.us, i64 %i.di
  %i.dk = add i32 %.07087.us, -1                  ; 2 uses
...
.preheader.us:                                    ; preds = %.preheader.lr.ph, %._crit_edge.us101
  %.171100.us = phi i32 [ %i.er, %._crit_edge.us101 ], [ %i.i, %.preheader.lr.ph ]
  %.299.us = phi ptr [ %i.eq, %._crit_edge.us101 ], [ %i.e, %.preheader.lr.ph ] ; 2 uses
  br label %bb.m

bb.m:                                             ; preds = %.preheader.us, %bb.m
  %.097.us = phi ptr [ %i.g, %.preheader.us ], [ %i.el, %bb.m ] ; 2 uses
  %.06396.us = phi ptr [ %.299.us, %.preheader.us ], [ %i.dt, %bb.m ] ; 2 uses
  %i.dt = getelementptr inbounds nuw i8, ptr %.06396.us, i64 2
  %i.du = load i16, ptr %.06396.us, align 2, !tbaa !226
  ...
  %i.el = getelementptr inbounds nuw i8, ptr %.097.us, i64 1 ; 2 uses
  store i8 %i.ek, ptr %.097.us, align 1, !tbaa !47
...
._crit_edge.us101:                                ; preds = %bb.m
  ...
  %i.eq = getelementptr inbounds nuw [2 x i8], ptr %.299.us, i64 %i.ep
  %i.er = add i32 %.171100.us, -1                 ; 2 uses
  %.not75.us = icmp eq i32 %i.er, 0
  br i1 %.not75.us, label %.loopexit, label %.preheader.us, !llvm.loop !243

.preheader:                                       ; preds = %.preheader.lr.ph, %.preheader
  %.171100 = phi i32 [ %i.es, %.preheader ], [ %i.i, %.preheader.lr.ph ]
  tail call void @png_write_row(ptr noundef %i.c, ptr noundef %i.g)
  %i.es = add i32 %.171100, -1                    ; 2 uses
end_hunk_0
