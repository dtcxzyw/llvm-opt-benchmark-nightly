...
bb.b:                                             ; preds = %.lr.ph, %bb.d
  ...
  %3 = getelementptr inbounds nuw [32 x i8], ptr %i.f, i64 %indvars.iv
...
._crit_edge.loopexitsplit:                        ; preds = %bb.d
  %spec.select.ph.ph = phi ptr [ null, %bb.d ]
  br label %._crit_edge.loopexit

.._crit_edge.loopexit_crit_edge:                  ; preds = %bb.c
  %lsr.iv.lcssa = phi ptr [ %lsr.iv, %bb.c ]
  %split = phi ptr [ %3, %bb.c ]                  ; 0 uses
  br label %._crit_edge.loopexit

._crit_edge.loopexit:                             ; preds = %._crit_edge.loopexitsplit, %.._crit_edge.loopexit_crit_edge
  %spec.select.ph = phi ptr [ %lsr.iv.lcssa, %.._crit_edge.loopexit_crit_edge ], [ %spec.select.ph.ph, %._crit_edge.loopexitsplit ]
  br label %._crit_edge
