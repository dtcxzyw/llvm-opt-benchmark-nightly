begin_hunk_0
          to label %bb.gu unwind label %_ZNSt6vectorIhSaIhEED2Ev.exit

bb.gu:                                            ; preds = %bb.gt
  %i.zn = sub nuw i64 %.0494554, %.sroa.speculated ; 2 uses
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1
  %.not82 = icmp eq i64 %i.zn, 0
  br i1 %.not82, label %_ZNSt6vectorIhSaIhEED2Ev.exit385, label %bb.gt, !llvm.loop !165
end_hunk_0
begin_hunk_1
...
begin_hunk_6
  ...
  %i.q = load i64, ptr %i.p, align 8, !tbaa !109  ; 5 uses
  %i.r = lshr i64 %i.q, 25
