...
bb.ev:                                            ; preds = %bb.et
  ...
  %or.cond17 = or i1 %.0175.shrunk, %28
  %or.cond19 = or i1 %or.cond17, %.0172
  br i1 %or.cond19, label %bb.ey, label %bb.ew

bb.ew:                                            ; preds = %bb.ev
  %i.in = load i32, ptr %i.p, align 8, !tbaa !29
  %i.io = load i32, ptr %i.z, align 4, !tbaa !53
  %.not226 = icmp slt i32 %i.in, %i.io
  br i1 %.not226, label %.thread, label %bb.ex

bb.ex:                                            ; preds = %bb.ew
  %i.ip = load i64, ptr %i.e, align 8, !tbaa !18
  %i.iq = icmp eq i64 %i.ip, 4611686018427387903
  br i1 %i.iq, label %.invoke, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i319.invoke

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i319.invoke: ; preds = %.thread, %bb.ex
  %i.ir = phi ptr [ @.str.4, %bb.ex ], [ @.str.3, %.thread ]
  %i.is = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef nonnull %i.ir, i64 noundef 1)
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit.thread375.outer.backedge: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit322.thread, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit.thread
  %.0183.ph.be = phi i32 [ %.2185372, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit.thread ], [ %i.it, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit322.thread ]
  %.0172.ph.be = phi i1 [ %i.jw, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit.thread ], [ true, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit322.thread ]
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit.thread375.outer

.thread:                                          ; preds = %bb.ew, %bb.ey
  %i.iu = load i64, ptr %i.e, align 8, !tbaa !18
  %i.iv = icmp eq i64 %i.iu, 4611686018427387903
  br i1 %i.iv, label %.invoke, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i319.invoke
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit322: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i319.invoke
  %i.iw = icmp slt i32 %.0183.ph, 1
  br i1 %i.iw, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit.thread, label %bb.ez
...
bb.ez:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit322
  ...
  %i.ix = add nsw i32 %.0183.ph, -1
  %i.iy = zext nneg i32 %i.ix to i64
  store ptr %i.ai, ptr %26, align 8, !tbaa !15
  invoke void @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE12_M_constructEmc(ptr noundef nonnull align 8 dereferenceable(32) %26, i64 noundef %i.iy, i8 noundef signext 10)
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EmcRKS3_.exit: ; preds = %bb.ez
  %i.iz = load i64, ptr %i.aj, align 8, !tbaa !18 ; 2 uses
  %i.ja = load i64, ptr %i.e, align 8, !tbaa !18
  %i.jb = sub i64 4611686018427387903, %i.ja
  %i.jc = icmp ult i64 %i.jb, %i.iz
  br i1 %i.jc, label %bb.fa, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i328
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i328: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEC2EmcRKS3_.exit
  %i.jd = load ptr, ptr %26, align 8, !tbaa !43
  %i.je = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef %i.jd, i64 noundef %i.iz)
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLERKS4_.exit331: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendERKS4_.exit.i328
  %i.jf = load ptr, ptr %26, align 8, !tbaa !43   ; 2 uses
  %i.jg = icmp eq ptr %i.jf, %i.ai
  br i1 %i.jg, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit334, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i332
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i332: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLERKS4_.exit331
  call void @_ZdlPv(ptr noundef %i.jf) #17
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit334: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLERKS4_.exit331, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i332
  ...
  %i.jh = trunc nuw i8 %spec.select to i1
  %i.ji = xor i1 %i.ge, true
  %i.jj = or i1 %i.ig, %i.ji
  %or.cond247 = select i1 %i.jh, i1 true, i1 %i.jj
...
bb.fb:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit334
  %i.jk = load i64, ptr %i.e, align 8, !tbaa !18
  %i.jl = icmp eq i64 %i.jk, 4611686018427387903
  br i1 %i.jl, label %.invoke, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i335

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i335: ; preds = %bb.fb
  %i.jm = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef nonnull @.str.3, i64 noundef 1)
...
bb.fd:                                            ; preds = %.loopexit.split-lp408, %.loopexit407
  ...
  %i.jo = load ptr, ptr %26, align 8, !tbaa !43   ; 2 uses
  %i.jp = icmp eq ptr %i.jo, %i.ai
  br i1 %i.jp, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit341, label %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i339

_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i339: ; preds = %bb.fd
  call void @_ZdlPv(ptr noundef %i.jo) #17
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit341
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit341: ; preds = %bb.fd, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i339, %bb.fc
  %.pn228 = phi { ptr, i32 } [ %i.jn, %bb.fc ], [ %lpad.phi411, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i339 ], [ %lpad.phi411, %bb.fd ]
  call void @llvm.lifetime.end.p0(ptr nonnull %26) #15
  br label %.body
...
bb.ff:                                            ; preds = %bb.fe
  %i.jq = load i64, ptr %i.e, align 8, !tbaa !18
  %i.jr = icmp eq i64 %i.jq, 4611686018427387903
  br i1 %i.jr, label %.invoke, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i342

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i342: ; preds = %bb.ff
  %i.js = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef nonnull @.str.3, i64 noundef 1)
...
bb.fh:                                            ; preds = %bb.fg
  %i.jt = load i64, ptr %i.e, align 8, !tbaa !18
  %i.ju = icmp eq i64 %i.jt, 4611686018427387903
  br i1 %i.ju, label %.invoke, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i346

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i346: ; preds = %bb.fh
  %i.jv = invoke noundef nonnull align 8 dereferenceable(32) ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_appendEPKcm(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef nonnull @.str.4, i64 noundef 1)
          to label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit.thread unwind label %.loopexit402.loopexit.split-lp ; 0 uses
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit.thread: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit, %bb.fg, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit322, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit334, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i335, %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE6appendEPKc.exit.i346
  ...
  %i.jx = load i32, ptr %i.p, align 8, !tbaa !29
  %i.jy = load i32, ptr %i.z, align 4, !tbaa !53
  %i.jz = icmp slt i32 %i.jx, %i.jy
  br i1 %i.jz, label %bb.fi, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEpLEPKc.exit.thread375.outer.backedge
...
.thread377:                                       ; preds = %bb.cv, %bb.i, %bb.fi, %bb.cz, %bb.cy, %bb.ch
  ...
  %i.kb = load i8, ptr %i.ka, align 8, !tbaa !58, !range !51, !noundef !52
  %i.kc = trunc nuw i8 %i.kb to i1
  br i1 %i.kc, label %bb.fj, label %bb.fk

bb.fj:                                            ; preds = %.thread377
  %i.kd = call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE16find_last_not_ofEPKcmm(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef nonnull @.str.5, i64 noundef -1, i64 noundef 2) #15 ; 3 uses
  %.not237 = icmp eq i64 %.3195, -1
  %i.ke = icmp eq i64 %i.kd, -1
  %i.kf = call i64 @llvm.umax.i64(i64 %i.kd, i64 %.3195)
  %spec.select248 = select i1 %i.ke, i64 %.3195, i64 %i.kf
  %.0165 = select i1 %.not237, i64 %i.kd, i64 %spec.select248 ; 2 uses
  %i.kg = load i64, ptr %i.e, align 8, !tbaa !18
  %i.kh = icmp ult i64 %.0165, %i.kg
  br i1 %i.kh, label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit351, label %bb.fk

_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit351: ; preds = %bb.fj
  %i.ki = add nuw i64 %.0165, 1                   ; 2 uses
  store i64 %i.ki, ptr %i.e, align 8, !tbaa !18
  %i.kj = load ptr, ptr %0, align 8, !tbaa !43
  %i.kk = getelementptr inbounds nuw i8, ptr %i.kj, i64 %i.ki
  store i8 0, ptr %i.kk, align 1, !tbaa !21
  br label %bb.fk

bb.fk:                                            ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE5eraseEmm.exit351, %bb.fj, %.thread377
  %i.kl = getelementptr inbounds nuw i8, ptr %2, i64 28
  %i.km = load i32, ptr %i.kl, align 4, !tbaa !59
  switch i32 %i.km, label %bb.fr [
    i32 0, label %bb.fl
    i32 -1, label %bb.fo
  ]

bb.fl:                                            ; preds = %bb.fk
  %i.kn = call noundef i64 @_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE16find_last_not_ofEcm(ptr noundef nonnull align 8 dereferenceable(32) %0, i8 noundef signext 10, i64 noundef -1) #15 ; 3 uses
end_hunk_0
