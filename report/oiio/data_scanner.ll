...
20:                                               ; preds = %5
  ...
  %.fr27 = freeze i8 %21                          ; 2 uses
  %22 = and i8 %.fr27, -33
  %23 = add i8 %22, -65
  %or.cond29 = icmp ult i8 %23, 26
  br i1 %or.cond29, label %_ZN22photos_editing_formats8image_io12_GLOBAL__N_115IsFirstNameCharEc.exit.thread, label %switch.early.test

switch.early.test:                                ; preds = %20
  switch i8 %.fr27, label %.noexc.i [
...
begin_hunk_3
  ...
  %.old.us = icmp eq i8 %.fr, %47
  %or.cond = or i1 %48, %.old.us
  br i1 %or.cond, label %.thread, label %49

49:                                               ; preds = %.lr.ph.split.us
  %50 = add nuw i64 %.01542.us, 1                 ; 2 uses
  %exitcond66.not = icmp eq i64 %50, %42
  br i1 %exitcond66.not, label %.noexc.i31, label %.lr.ph.split.us, !llvm.loop !44
...
switch.early.test:                                ; preds = %.lr.ph.split
  switch i8 %.fr, label %.lr.ph.split.split.preheader [
...
begin_hunk_5
  ...
  %.old.us47 = icmp eq i8 %.fr, %55
  %or.cond53 = or i1 %56, %.old.us47
  br i1 %or.cond53, label %.thread, label %57

57:                                               ; preds = %.lr.ph.split.split.us
  %58 = add nuw i64 %.01542.us46, 1               ; 2 uses
  %exitcond65.not = icmp eq i64 %58, %42
  br i1 %exitcond65.not, label %.noexc.i31, label %.lr.ph.split.split.us, !llvm.loop !44
...
.thread:                                          ; preds = %62, %_ZN22photos_editing_formats8image_io12_GLOBAL__N_115IsFirstNameCharEc.exit, %.lr.ph.split.split.us, %.lr.ph.split.us
  %.us-phi = phi i8 [ %47, %.lr.ph.split.us ], [ %55, %.lr.ph.split.split.us ], [ 126, %_ZN22photos_editing_formats8image_io12_GLOBAL__N_115IsFirstNameCharEc.exit ], [ %.fr, %62 ]
