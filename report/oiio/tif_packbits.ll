...
.outer:                                           ; preds = %.outer.backedge, %.critedge
  %.199.ph = phi ptr [ %.098158, %.critedge ], [ %.199.ph.be, %.outer.backedge ] ; 2 uses
...
begin_hunk_2_@PackBitsEncode:bb.a
  ...
  %.199.ph.be = getelementptr inbounds nuw i8, ptr %.us-phi.sink239, i64 2
  br label %.outer
...
bb.z:                                             ; preds = %bb.x, %bb.y, %bb.u, %bb.v, %bb.r, %bb.s
  %.4102.a = phi ptr [ %.us-phi155, %bb.y ], [ %.us-phi, %bb.r ], [ %.us-phi, %bb.s ], [ %.us-phi151, %bb.u ], [ %.us-phi151, %bb.v ], [ %.us-phi155, %bb.x ]
  %.pn = phi i64 [ 2, %bb.y ], [ 2, %bb.r ], [ 2, %bb.s ], [ 2, %bb.u ], [ 1, %bb.v ], [ 2, %bb.x ]
  ...
  %.4102 = getelementptr inbounds nuw i8, ptr %.4102.a, i64 %.pn ; 2 uses
...
._crit_edge164:                                   ; preds = %._crit_edge164.loopexit, %bb.a
  ...
  %.098.lcssa = phi ptr [ %i.b, %bb.a ], [ %.4102, %._crit_edge164.loopexit ] ; 2 uses
