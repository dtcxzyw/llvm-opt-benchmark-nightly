...
bb.a:
  ...
  br i1 %i.e, label %.outer.split, label %bb.k
...
.outer.split:                                     ; preds = %bb.a, %.outer
  ...
  br i1 %i.f, label %.lr.ph, label %.thread.a

bb.b:                                             ; preds = %bb.c
  %i.g = icmp sgt i64 %.054197, 1
  br i1 %i.g, label %.lr.ph, label %.thread.a
...
.lr.ph:                                           ; preds = %.outer.split, %bb.b
  ...
  %i.h = getelementptr inbounds nuw i8, ptr %.057196, i64 1 ; 7 uses
...
.outer:                                           ; preds = %.lr.ph.preheader, %bb.j
  ...
  br i1 %i.aa, label %.outer.split, label %bb.k

.thread.a:                                        ; preds = %.outer.split, %bb.b
  %.057.lcssa = phi ptr [ %i.h, %bb.b ], [ %.057.ph120, %.outer.split ]
  %smin.le = tail call i64 @llvm.smin.i64(i64 %.054.ph121, i64 0)
  br label %.split.us.thread

.split.us.thread:                                 ; preds = %.thread.a, %4, %5
  %storemerge126 = phi ptr [ %i.h, %4 ], [ %i.h, %5 ], [ %.057.lcssa, %.thread.a ]
  %storemerge = phi i64 [ 0, %4 ], [ %i.j, %5 ], [ %smin.le, %.thread.a ]
...
bb.k:                                             ; preds = %.outer, %bb.a
  %.057.lcssa.sink = phi ptr [ %i.b, %bb.a ], [ %.158, %.outer ]
  %smin.le.sink = phi i64 [ %i.d, %bb.a ], [ %.155, %.outer ]
  store ptr %.057.lcssa.sink, ptr %i.a, align 8, !tbaa !34
  store i64 %smin.le.sink, ptr %i.c, align 8, !tbaa !35
  br label %bb.l

bb.l:                                             ; preds = %bb.k, %.split.us.thread
  %.0 = phi i32 [ 0, %.split.us.thread ], [ 1, %bb.k ]
  ret i32 %.0
}
