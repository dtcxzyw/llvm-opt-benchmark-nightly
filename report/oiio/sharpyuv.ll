begin_hunk_0
  ...
  %.not.i.us.us.i.i = icmp ult i16 %i.wh, 256
  %i.wi = trunc i32 %i.wg to i8
  %i.wj = icmp sgt i16 %i.wh, -1
  %i.wk = sext i1 %i.wj to i8
  %i.wl = select i1 %.not.i.us.us.i.i, i8 %i.wi, i8 %i.wk
...
begin_hunk_2
  ...
  %.not.i104.us.us.i.i = icmp ult i16 %i.adl, 256
  %i.adm = trunc i32 %i.adc to i8
  %i.adn = icmp sgt i16 %i.adl, -1
  %i.ado = sext i1 %i.adn to i8
  %i.adp = select i1 %.not.i104.us.us.i.i, i8 %i.adm, i8 %i.ado
  ...
  %.not.i105.us.us.i.i = icmp ult i16 %i.adr, 256
  %i.ads = trunc i32 %i.adk to i8
  %i.adt = icmp sgt i16 %i.adr, -1
  %i.adu = sext i1 %i.adt to i8
  %i.adv = select i1 %.not.i105.us.us.i.i, i8 %i.ads, i8 %i.adu
