...
bb.a:
  ...
  %18 = alloca %struct.CF2_HintMapRec_, align 8   ; 9 uses
...
bb.f:                                             ; preds = %bb.d
  ...
  %.pr = load i32, ptr %i.m, align 4, !tbaa !3
...
bb.h:                                             ; preds = %cf2_arrstack_setCount.exit
  ...
  %i.dg = getelementptr inbounds nuw i8, ptr %18, i64 16
  %i.dh = getelementptr inbounds nuw i8, ptr %19, i64 8 ; 2 uses
  ...
  %i.dl = getelementptr inbounds nuw i8, ptr %19, i64 24
  %i.dm = getelementptr inbounds nuw i8, ptr %19, i64 9
  ...
  %i.fb = getelementptr inbounds nuw i8, ptr %18, i64 24
  br label %.backedge
...
bb.n:                                             ; preds = %bb.m, %cf2_buf_readByte.exit.thread
  ...
  %i.gd = load i32, ptr %i.m, align 4, !tbaa !3
...
bb.gx:                                            ; preds = %bb.gu
  ...
  %i.zr = call fastcc i32 @cf2_getT1SeacComponent(ptr %.val1326, i32 noundef %.01083, ptr noundef %16) ; 2 uses
  %.not1214 = icmp eq i32 %i.zr, 0
  br i1 %.not1214, label %bb.gy, label %bb.he

bb.gy:                                            ; preds = %bb.gx
  %i.zs = load ptr, ptr %i.dt, align 8, !tbaa !608
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %14, ptr noundef nonnull align 8 dereferenceable(16) %i.zs, i64 16, i1 false), !tbaa.struct !580
  %i.zt = load ptr, ptr %i.ds, align 8, !tbaa !640
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %15, ptr noundef nonnull align 8 dereferenceable(16) %i.zt, i64 16, i1 false), !tbaa.struct !580
  ...
  %i.zu = getelementptr inbounds nuw i8, ptr %16, i64 8 ; 2 uses
  %.val1331 = load ptr, ptr %i.zu, align 8, !tbaa !253 ; 2 uses
  %i.zv = getelementptr inbounds nuw i8, ptr %16, i64 16 ; 2 uses
...
bb.ha:                                            ; preds = %cf2_freeT1SeacComponent.exit
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %14, ptr noundef nonnull align 8 dereferenceable(16) %.pre2225, i64 16, i1 false), !tbaa.struct !580
  %i.aaj = load ptr, ptr %i.ds, align 8, !tbaa !640
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %15, ptr noundef nonnull align 8 dereferenceable(16) %i.aaj, i64 16, i1 false), !tbaa.struct !580
  br label %bb.hb
...
bb.hb:                                            ; preds = %bb.ha, %cf2_freeT1SeacComponent.exit
  ...
  %i.aak = call fastcc i32 @cf2_getT1SeacComponent(ptr %.val1325, i32 noundef %.01086, ptr noundef %16) ; 2 uses
...
bb.hc:                                            ; preds = %bb.hb
  ...
  call fastcc void @cf2_interpT2CharString(ptr noundef nonnull %0, ptr noundef %16, ptr noundef %2, ptr noundef %3, i8 noundef zeroext 1, i32 noundef %i.aam, i32 noundef %i.xp, ptr noundef %i.i)
...
cf2_freeT1SeacComponent.exit1490:                 ; preds = %bb.hc, %bb.hd
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.aaz, ptr noundef nonnull align 8 dereferenceable(16) %14, i64 16, i1 false), !tbaa.struct !580
  %i.aba = load ptr, ptr %i.ds, align 8, !tbaa !640
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.aba, ptr noundef nonnull align 8 dereferenceable(16) %15, i64 16, i1 false), !tbaa.struct !580
  br label %bb.he
...
bb.qh:                                            ; preds = %.lr.ph2123
  %i.baa = load i32, ptr %i.m, align 4, !tbaa !3
...
bb.qj:                                            ; preds = %cf2_arrstack_getPointer.exit1599
  %i.bab = load i32, ptr %i.m, align 4, !tbaa !3
...
bb.qv:                                            ; preds = %bb.qu
  ...
  %i.bbe = call fastcc i32 @cf2_getSeacComponent(ptr noundef nonnull %i.l, i32 noundef %i.bba, ptr noundef %17) ; 2 uses
  %.not1168 = icmp eq i32 %i.bbe, 0
  br i1 %.not1168, label %bb.qw, label %bb.qy

bb.qw:                                            ; preds = %bb.qv
  call fastcc void @cf2_interpT2CharString(ptr noundef nonnull %0, ptr noundef %17, ptr noundef %2, ptr noundef %3, i8 noundef zeroext 1, i32 noundef %i.bbd, i32 noundef %i.bbc, ptr noundef %i.j)
  ...
  %i.bbh = getelementptr inbounds nuw i8, ptr %17, i64 8 ; 4 uses
  %i.bbi = getelementptr inbounds nuw i8, ptr %17, i64 16 ; 2 uses
  ...
  %i.bbo = call fastcc i32 @cf2_getSeacComponent(ptr noundef nonnull %i.l, i32 noundef %i.bbb, ptr noundef %17) ; 2 uses
...
bb.rk:                                            ; preds = %bb.rb
  ...
  store ptr %i.m, ptr %19, align 8, !tbaa !561
