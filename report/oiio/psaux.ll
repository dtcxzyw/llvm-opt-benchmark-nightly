...
bb.gy:                                            ; preds = %bb.gx
  ...
  %.sroa.02566.0.copyload = load <16 x i8>, ptr %i.zs, align 8
  %i.zt = load ptr, ptr %i.ds, align 8, !tbaa !640
  %.sroa.0.0.copyload = load <16 x i8>, ptr %i.zt, align 8
...
bb.ha:                                            ; preds = %cf2_freeT1SeacComponent.exit
  %.sroa.02566.0.copyload2567 = load <16 x i8>, ptr %.pre2225, align 8
  %i.aaj = load ptr, ptr %i.ds, align 8, !tbaa !640
  %.sroa.0.0.copyload2564 = load <16 x i8>, ptr %i.aaj, align 8
  br label %bb.hb

bb.hb:                                            ; preds = %bb.ha, %cf2_freeT1SeacComponent.exit
  %.sroa.02566.0 = phi <16 x i8> [ %.sroa.02566.0.copyload2567, %bb.ha ], [ %.sroa.02566.0.copyload, %cf2_freeT1SeacComponent.exit ]
  %.sroa.0.0 = phi <16 x i8> [ %.sroa.0.0.copyload2564, %bb.ha ], [ %.sroa.0.0.copyload, %cf2_freeT1SeacComponent.exit ]
...
cf2_freeT1SeacComponent.exit1490:                 ; preds = %bb.hc, %bb.hd
  ...
  store <16 x i8> %.sroa.02566.0, ptr %i.aaz, align 8
  %i.aba = load ptr, ptr %i.ds, align 8, !tbaa !640
  store <16 x i8> %.sroa.0.0, ptr %i.aba, align 8
  br label %bb.he
