...
begin_hunk_1
  ...
  %i.dg = getelementptr inbounds nuw i8, ptr %17, i64 8 ; 2 uses
  %i.dh = getelementptr inbounds nuw i8, ptr %10, i64 32 ; 4 uses
  %i.di = getelementptr inbounds nuw i8, ptr %11, i64 32 ; 4 uses
  %i.dj = getelementptr inbounds nuw i8, ptr %17, i64 16
  %i.dk = getelementptr inbounds nuw i8, ptr %17, i64 24
  %i.dl = getelementptr inbounds nuw i8, ptr %17, i64 9
  %i.dm = getelementptr inbounds nuw i8, ptr %17, i64 32
...
begin_hunk_2
  ...
  %i.fa = getelementptr inbounds nuw i8, ptr %16, i64 24
...
begin_hunk_4
  ...
  %i.zs = call fastcc i32 @cf2_getT1SeacComponent(ptr %.val1326.a, i32 noundef %.01083, ptr noundef %14) ; 2 uses
  %.not1214 = icmp eq i32 %i.zs, 0
  br i1 %.not1214, label %bb.gy, label %bb.he

bb.gy:                                            ; preds = %bb.gx
  %i.zt = load ptr, ptr %i.ds, align 8, !tbaa !603
  %.sroa.0443.0.copyload = load <2 x i64>, ptr %i.zt, align 8
  %i.zu = load ptr, ptr %i.dr, align 8, !tbaa !634
  %.sroa.0.0.copyload = load <2 x i64>, ptr %i.zu, align 8
  ...
  %i.zv = getelementptr inbounds nuw i8, ptr %14, i64 8 ; 2 uses
  %.val1331 = load ptr, ptr %i.zv, align 8, !tbaa !252 ; 2 uses
  %i.zw = getelementptr inbounds nuw i8, ptr %14, i64 16 ; 2 uses
...
bb.ha:                                            ; preds = %cf2_freeT1SeacComponent.exit
  ...
  %.sroa.0.0.copyload441 = load <2 x i64>, ptr %i.aak, align 8
  br label %bb.hb
...
bb.hb:                                            ; preds = %bb.ha, %cf2_freeT1SeacComponent.exit
  ...
  %i.aal = call fastcc i32 @cf2_getT1SeacComponent(ptr %.val1325, i32 noundef %.01086, ptr noundef %14) ; 2 uses
...
bb.hc:                                            ; preds = %bb.hb
  ...
  call fastcc void @cf2_interpT2CharString(ptr noundef nonnull %0, ptr noundef %14, ptr noundef %2, ptr noundef %3, i8 noundef zeroext 1, i32 noundef %i.aan, i32 noundef %i.xq, ptr noundef %i.i)
...
cf2_freeT1SeacComponent.exit1490:                 ; preds = %bb.hc, %bb.hd
  ...
  store <2 x i64> %.sroa.0443.0, ptr %i.aba, align 8
  %i.abb = load ptr, ptr %i.dr, align 8, !tbaa !634
  store <2 x i64> %.sroa.0.0, ptr %i.abb, align 8
  br label %bb.he
...
begin_hunk_8
  ...
  %i.bbf = call fastcc i32 @cf2_getSeacComponent(ptr noundef nonnull %i.l, i32 noundef %i.bbb, ptr noundef %15) ; 2 uses
  %.not1168.a = icmp eq i32 %i.bbf, 0
  br i1 %.not1168.a, label %bb.qw, label %bb.qy

bb.qw:                                            ; preds = %bb.qv
  call fastcc void @cf2_interpT2CharString(ptr noundef nonnull %0, ptr noundef %15, ptr noundef %2, ptr noundef %3, i8 noundef zeroext 1, i32 noundef %i.bbe, i32 noundef %i.bbd, ptr noundef %i.j)
  ...
  %i.bbi = getelementptr inbounds nuw i8, ptr %15, i64 8 ; 4 uses
  %i.bbj = getelementptr inbounds nuw i8, ptr %15, i64 16 ; 2 uses
  ...
  %i.bbp = call fastcc i32 @cf2_getSeacComponent(ptr noundef nonnull %i.l, i32 noundef %i.bbc, ptr noundef %15) ; 2 uses
...
bb.rk:                                            ; preds = %bb.rb
  ...
  store ptr %0, ptr %16, align 8, !tbaa !569
  ...
  store ptr %i.m, ptr %17, align 8, !tbaa !556
