...
begin_hunk_3_@SharpYuvComputeConversionMatrix:bb.a
  ...
  %11 = fmul float %6, %.055
  %i.au = tail call float @llvm.fmuladd.f32(float %11, float 6.553600e+04, float 5.000000e-01)
...
begin_hunk_4_@SharpYuvComputeConversionMatrix:bb.a
  ...
  %12 = fmul float %5, %.0.a
  %i.bd = tail call float @llvm.fmuladd.f32(float %12, float 6.553600e+04, float 5.000000e-01)
  %i.be = tail call float @llvm.floor.f32(float %i.bd)
  %i.bf = getelementptr inbounds nuw i8, ptr %1, i64 32
  %i.bg = fmul float %.0.a, %i.aq
