...
.preheader222:
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(1) %i.a, i8 0, i64 %9, i1 false), !tbaa !3
...
bb.a:                                             ; preds = %.preheader221
  ...
  br i1 %12, label %.preheader221, label %.critedge, !llvm.loop !54
