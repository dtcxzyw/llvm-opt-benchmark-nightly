...
bb.o:                                             ; preds = %.thread, %bb.n
  ...
  %i.ar = call i32 (ptr, i32, ptr, ...) %i.aq(ptr noundef nonnull %0, i32 noundef 3, ptr noundef nonnull @.str.30, ptr noundef %2, ptr noundef nonnull @.str.40) #5
  br label %bb.r
...
.thread61:                                        ; preds = %..thread61_crit_edge, %.thread
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(32) %i.av, ptr noundef nonnull align 1 dereferenceable(32) %3, i64 32, i1 false), !tbaa.struct !56
  br label %bb.q
...
bb.m:                                             ; preds = %bb.k, %bb.l
  ...
  %i.ac = tail call i32 %i.ab(ptr noundef nonnull %0, i32 noundef 3, ptr noundef nonnull @.str.41) #5
  br label %bb.aa
...
bb.t:                                             ; preds = %bb.r, %bb.s
  ...
  %i.av = call i32 (ptr, i32, ptr, ...) %i.as(ptr noundef nonnull %0, i32 noundef 16, ptr noundef nonnull @.str.42, ptr noundef nonnull %2, ptr noundef %i.au) #5
  br label %bb.aa
...
bb.v:                                             ; preds = %bb.u
  %i.aw = load i8, ptr %0, align 8, !tbaa !7
...
bb.y:                                             ; preds = %bb.u
  ...
  %i.be = load i8, ptr %i.bd, align 8, !tbaa !35
  %i.bf = zext i8 %i.be to i32
  store i32 %i.bf, ptr %3, align 4, !tbaa !3
  %i.bg = load i8, ptr %0, align 8, !tbaa !7
...
bb.a:
  ...
  %i.c = icmp ugt i32 %3, 9
  br i1 %i.c, label %bb.b, label %bb.c

bb.b:                                             ; preds = %bb.a
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 72
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !24
  %i.f = tail call i32 (ptr, i32, ptr, ...) %i.e(ptr noundef %0, i32 noundef 4, ptr noundef nonnull @.str.43, ptr noundef %2, i32 noundef %3, i32 noundef 0, i32 noundef 10) #5
  br label %bb.v
...
bb.j:                                             ; preds = %bb.h
  %i.s = load i8, ptr %0, align 8, !tbaa !7
...
bb.n:                                             ; preds = %bb.m
  %i.ai = load i8, ptr %0, align 8, !tbaa !7
...
bb.q:                                             ; preds = %bb.p
  ...
  %i.at = call i32 (ptr, i32, ptr, ...) %i.ap(ptr noundef nonnull %0, i32 noundef 16, ptr noundef nonnull @.str.42, ptr noundef %2, ptr noundef %i.as) #5
  br label %bb.u
...
bb.s:                                             ; preds = %bb.n, %bb.n
  %i.av = call i32 @exr_attr_list_add(ptr noundef nonnull %0, ptr noundef nonnull %i.ag, ptr noundef %2, i32 noundef 5, i32 noundef 0, ptr noundef null, ptr noundef nonnull %i.a) #5 ; 2 uses
...
.thread:                                          ; preds = %..thread_crit_edge, %bb.p
  ...
  store i8 %i.b, ptr %i.ay, align 8, !tbaa !35
  br label %bb.t
...
begin_hunk_1_@exr_attr_set_double:bb.a
  ...
  %i.ai = load ptr, ptr %i.a, align 8, !tbaa !30
  %i.aj = getelementptr inbounds nuw i8, ptr %i.ai, i64 8
  %i.ak = load ptr, ptr %i.aj, align 8, !tbaa !34
  %i.al = call i32 (ptr, i32, ptr, ...) %i.ah(ptr noundef nonnull %0, i32 noundef 16, ptr noundef nonnull @.str.45, ptr noundef %2, ptr noundef %i.ak) #5
  br label %bb.p
...
bb.n:                                             ; preds = %bb.i, %bb.i
  %i.an = call i32 @exr_attr_list_add(ptr noundef nonnull %0, ptr noundef nonnull %i.y, ptr noundef %2, i32 noundef 6, i32 noundef 0, ptr noundef null, ptr noundef nonnull %i.a) #5 ; 2 uses
...
.thread:                                          ; preds = %..thread_crit_edge, %bb.k
  ...
  store double %3, ptr %i.aq, align 8, !tbaa !35
  br label %bb.o
...
bb.b:                                             ; preds = %bb.a
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 72
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !24
  %i.f = tail call i32 (ptr, i32, ptr, ...) %i.e(ptr noundef %0, i32 noundef 4, ptr noundef nonnull @.str.46, ptr noundef %2, i32 noundef %3, i32 noundef 0, i32 noundef 2) #5
  br label %bb.s
...
bb.g:                                             ; preds = %bb.e
  %i.p = load i8, ptr %0, align 8, !tbaa !7
...
bb.n:                                             ; preds = %bb.m
  ...
  %i.aq = call i32 (ptr, i32, ptr, ...) %i.am(ptr noundef nonnull %0, i32 noundef 16, ptr noundef nonnull @.str.42, ptr noundef %2, ptr noundef %i.ap) #5
  br label %bb.r
...
bb.p:                                             ; preds = %bb.k, %bb.k
  %i.as = call i32 @exr_attr_list_add(ptr noundef nonnull %0, ptr noundef nonnull %i.ad, ptr noundef %2, i32 noundef 7, i32 noundef 0, ptr noundef null, ptr noundef nonnull %i.a) #5 ; 2 uses
...
.thread:                                          ; preds = %..thread_crit_edge, %bb.m
  ...
  store i8 %i.b, ptr %i.av, align 8, !tbaa !35
  br label %bb.q
...
bb.o:                                             ; preds = %.thread, %bb.n
  ...
  %i.ap = getelementptr inbounds nuw i8, ptr %0, i64 72
  %i.aq = load ptr, ptr %i.ap, align 8, !tbaa !24
  %i.ar = call i32 (ptr, i32, ptr, ...) %i.aq(ptr noundef nonnull %0, i32 noundef 3, ptr noundef nonnull @.str.30, ptr noundef %2, ptr noundef nonnull @.str.59) #5
  br label %bb.r
...
.thread61:                                        ; preds = %..thread61_crit_edge, %.thread
  ...
  %i.au = getelementptr inbounds nuw i8, ptr %i.at, i64 24
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !35
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 1 dereferenceable(28) %i.av, ptr noundef nonnull align 1 dereferenceable(28) %3, i64 28, i1 false), !tbaa.struct !61
  br label %bb.q
...
bb.b:                                             ; preds = %bb.a
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 72
  %i.e = load ptr, ptr %i.d, align 8, !tbaa !24
  %i.f = tail call i32 (ptr, i32, ptr, ...) %i.e(ptr noundef %0, i32 noundef 4, ptr noundef nonnull @.str.60, ptr noundef %2, i32 noundef %3, i32 noundef 0, i32 noundef 3) #5
  br label %bb.v
...
bb.s:                                             ; preds = %bb.n, %bb.n
  %i.av = call i32 @exr_attr_list_add(ptr noundef nonnull %0, ptr noundef nonnull %i.ag, ptr noundef %2, i32 noundef 12, i32 noundef 0, ptr noundef null, ptr noundef nonnull %i.a) #5 ; 2 uses
  %i.aw = icmp eq i32 %i.av, 0
  br i1 %i.aw, label %..thread_crit_edge, label %bb.t
