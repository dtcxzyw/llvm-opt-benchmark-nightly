...
.preheader:                                       ; preds = %.preheader.lr.ph, %._crit_edge
  ...
  %i.h = fdiv contract float %i.f, %i.c           ; 2 uses
  ...
  %6 = insertelement <2 x i32> %5, i32 %i.j, i64 1
  %7 = sitofp <2 x i32> %6 to <2 x float>
  %8 = insertelement <2 x float> poison, float %i.h, i64 0
  %9 = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> zeroinitializer
  %10 = fsub contract <2 x float> %7, %9          ; 2 uses
  %11 = fmul contract <2 x float> %10, %10        ; 2 uses
  ...
  %14 = shufflevector <4 x float> <float -0.000000e+00, float poison, float poison, float poison>, <4 x float> %12, <4 x i32> <i32 0, i32 4, i32 5, i32 4>
  br label %bb.b
...
bb.b:                                             ; preds = %.preheader, %bb.e
  ...
  %i.s = fadd contract float %13, %i.r            ; 2 uses
...
bb.d:                                             ; preds = %bb.b
  ...
  %i.ai = fadd contract <4 x float> %14, %i.ah
...
bb.f:                                             ; preds = %bb.d, %bb.e
  ...
  store i8 %i.dr, ptr %3, align 1, !tbaa !28
...
bb.h:                                             ; preds = %bb.f, %bb.g
  ...
  store i8 %i.dy, ptr %7, align 1, !tbaa !28
...
bb.j:                                             ; preds = %bb.h, %bb.i
  ...
  store i8 %i.ef, ptr %i.az, align 1, !tbaa !28
...
.lr.ph:                                           ; preds = %.preheader, %bb.g
  ...
  %2 = load float, ptr %1, align 4, !tbaa !13
  %3 = fmul contract float %i.at, %2
  %4 = zext i8 %i.ar to i16
  %5 = zext i8 %i.ao to i16
  %6 = add nsw i16 %4, -128
  %7 = add nsw i16 %5, -128
  %8 = insertelement <2 x i16> poison, i16 %7, i64 0
  %9 = insertelement <2 x i16> %8, i16 %6, i64 1
  %10 = sitofp <2 x i16> %9 to <2 x float>
  %11 = fmul nnan contract <2 x float> %10, splat (float f0x3B808081) ; 3 uses
  %12 = load <2 x float>, ptr %i.j, align 4, !tbaa !13
  %13 = fmul contract <2 x float> %12, %11        ; 2 uses
  %14 = extractelement <2 x float> %13, i64 0
  %15 = fadd contract float %3, %14
  %16 = extractelement <2 x float> %13, i64 1
  %i.au = fadd contract float %15, %16
  %i.av = load float, ptr %i.k, align 4, !tbaa !13
  %i.aw = fmul contract float %i.at, %i.av
  %i.ax = load float, ptr %i.l, align 4, !tbaa !13
  %17 = extractelement <2 x float> %11, i64 0     ; 2 uses
  %i.ay = fmul contract float %17, %i.ax
  %i.az = fadd contract float %i.aw, %i.ay
  %i.ba = load float, ptr %i.m, align 4, !tbaa !13
  %18 = extractelement <2 x float> %11, i64 1     ; 2 uses
  %i.bb = fmul contract float %18, %i.ba
