...
bb.a:
  ...
  %3 = shufflevector <2 x i32> %bc, <2 x i32> poison, <2 x i32> <i32 1, i32 poison>
  %4 = insertelement <2 x i32> %3, i32 %2, i64 1
  %5 = add <2 x i32> %4, splat (i32 4096)         ; 3 uses
  %6 = lshr <2 x i32> %5, splat (i32 23)          ; 2 uses
  %7 = and <2 x i32> %6, splat (i32 255)          ; 4 uses
  %8 = and <2 x i32> %5, splat (i32 8388607)      ; 2 uses
  %9 = lshr <2 x i32> %5, splat (i32 16)
  %10 = and <2 x i32> %9, splat (i32 32768)
  %11 = icmp samesign ugt <2 x i32> %7, splat (i32 112)
  %12 = shl nuw nsw <2 x i32> %6, splat (i32 10)
  %13 = and <2 x i32> %12, splat (i32 31744)
  %14 = lshr <2 x i32> %8, splat (i32 13)
  %15 = or disjoint <2 x i32> %13, %14
  %16 = xor <2 x i32> %15, splat (i32 16384)
  %17 = select <2 x i1> %11, <2 x i32> %16, <2 x i32> zeroinitializer
  %18 = add nsw <2 x i32> %7, splat (i32 -102)
  %19 = icmp ult <2 x i32> %18, splat (i32 11)
  %20 = add nuw nsw <2 x i32> %8, splat (i32 8384512)
  %21 = sub nsw <2 x i32> splat (i32 125), %7
  %22 = lshr <2 x i32> %20, %21
  %23 = add nuw nsw <2 x i32> %22, splat (i32 1)
  %24 = lshr <2 x i32> %23, splat (i32 1)
  %25 = icmp samesign ugt <2 x i32> %7, splat (i32 143)
  %26 = select <2 x i1> %25, <2 x i32> splat (i32 32767), <2 x i32> zeroinitializer
  %27 = or disjoint <2 x i32> %26, %10
  %28 = or <2 x i32> %27, %17
  %29 = and <2 x i32> %24, splat (i32 65535)
  %30 = select <2 x i1> %19, <2 x i32> %29, <2 x i32> zeroinitializer
  %31 = or <2 x i32> %28, %30
  %32 = zext nneg <2 x i32> %31 to <2 x i64>
  %33 = shl nuw nsw <2 x i64> %32, <i64 16, i64 32> ; 2 uses
  %34 = extractelement <2 x i64> %33, i64 0
  %35 = add nuw nsw i64 %34, %i.ab
  %36 = extractelement <2 x i64> %33, i64 1
  %i.ac = add nuw nsw i64 %35, %36
...
bb.x:                                             ; preds = %bb.w, %bb.v, %bb.u
  ...
  %5 = fadd contract float %.fca.1.extract176, %.fca.1.extract176.1
  %foldExtExtBinop = fadd contract <2 x float> %.fca.0.extract175, %.fca.0.extract175.1
  %i.ek = shufflevector <2 x float> %foldExtExtBinop, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %i.el = insertelement <2 x float> %i.ek, float %5, i64 1
  ...
  %i.eo = fadd contract <2 x float> %i.el, %i.en
