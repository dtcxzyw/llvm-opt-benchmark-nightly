...
bb.a:
  ...
  %i.b = extractelement <2 x float> %foldExtExtBinop, i64 0
  %i.c = fmul contract float %1, 7.219200e-02
  %i.d = fadd contract float %i.c, %i.b           ; 2 uses
  %.sroa.011.0.vec.insert = insertelement <2 x float> poison, float %i.d, i64 0
  %i.e = shufflevector <2 x float> %0, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %2 = insertelement <2 x float> %i.e, float %1, i64 0
  ...
  %i.h = fsub contract <2 x float> %2, %i.g
...
bb.a:
  ...
  %i.d = fadd contract float %i.c, %i.b           ; 2 uses
  %.sroa.09.0.vec.insert = insertelement <2 x float> poison, float %i.d, i64 0
  %i.e = shufflevector <2 x float> %0, <2 x float> poison, <2 x i32> <i32 poison, i32 0>
  %2 = insertelement <2 x float> %i.e, float %1, i64 0
  %i.f = insertelement <2 x float> poison, float %i.d, i64 0
  %i.g = shufflevector <2 x float> %i.f, <2 x float> poison, <2 x i32> zeroinitializer
