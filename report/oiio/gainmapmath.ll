...
bb.b:                                             ; preds = %bb.a, %bb.a
  ...
  %i.c = load i32, ptr %i.b, align 4, !tbaa !51   ; 6 uses
...
bb.d:                                             ; preds = %bb.b
  ...
  %switch.load = load ptr, ptr %switch.gep, align 8 ; 10 uses
...
begin_hunk_1
  ...
  %i.j = load i32, ptr %i.i, align 4, !tbaa !53, !noalias !54
  %i.k = load i32, ptr %i.h, align 4, !tbaa !3, !noalias !54
  %i.l = load i32, ptr %i.g, align 4, !tbaa !3, !noalias !54
  invoke void @_ZN8ultrahdr18uhdr_raw_image_extC1E12uhdr_img_fmt16uhdr_color_gamut19uhdr_color_transfer16uhdr_color_rangejjj(ptr noundef nonnull align 8 dereferenceable(72) %i.f, i32 noundef 0, i32 noundef %i.c, i32 noundef %i.j, i32 noundef 1, i32 noundef %i.k, i32 noundef %i.l, i32 noundef 64)
...
begin_hunk_2
  ...
  br i1 %i.ah, label %.preheader, label %.loopexit, !llvm.loop !57
...
begin_hunk_3
  ...
  %i.ca = invoke { <2 x float>, float } %switch.load(<2 x float> %.sroa.0630.4.vec.insert653, float %i.bz)
          to label %bb.i unwind label %bb.y, !callees !58 ; 2 uses
...
begin_hunk_4
  ...
  %i.cm = invoke { <2 x float>, float } %switch.load(<2 x float> %.sroa.27656.16.vec.insert673, float %i.cl)
          to label %bb.m unwind label %bb.y, !callees !58 ; 2 uses
...
begin_hunk_5
  ...
  %i.cy = invoke { <2 x float>, float } %switch.load(<2 x float> %.sroa.45676.28.vec.insert693, float %i.cx)
          to label %bb.q unwind label %bb.y, !callees !58 ; 2 uses
...
begin_hunk_6
  ...
  %i.dk = invoke { <2 x float>, float } %switch.load(<2 x float> %.sroa.63696.40.vec.insert713, float %i.dj)
          to label %bb.u unwind label %bb.y, !callees !58 ; 2 uses
...
begin_hunk_7
  ...
  br i1 %i.fd, label %bb.h, label %._crit_edge537.loopexit, !llvm.loop !59
...
begin_hunk_8
  ...
  %i.fj = load i32, ptr %i.fi, align 4, !tbaa !53, !noalias !60
  %i.fk = load i32, ptr %i.fh, align 4, !tbaa !3, !noalias !60
  %i.fl = load i32, ptr %i.fg, align 4, !tbaa !3, !noalias !60
  invoke void @_ZN8ultrahdr18uhdr_raw_image_extC1E12uhdr_img_fmt16uhdr_color_gamut19uhdr_color_transfer16uhdr_color_rangejjj(ptr noundef nonnull align 8 dereferenceable(72) %i.ff, i32 noundef 12, i32 noundef %i.c, i32 noundef %i.fj, i32 noundef 1, i32 noundef %i.fk, i32 noundef %i.fl, i32 noundef 64)
          to label %_ZNSt10unique_ptrIN8ultrahdr18uhdr_raw_image_extESt14default_deleteIS1_EED2Ev.exit372 unwind label %bb.ab, !noalias !60

bb.ab:                                            ; preds = %.noexc355
  %i.fm = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ff, i64 noundef 72) #40, !noalias !60
  br label %.body
...
begin_hunk_9
  ...
  br i1 %i.ge, label %.preheader517, label %.loopexit, !llvm.loop !63
...
begin_hunk_10
  ...
  %i.gt = invoke { <2 x float>, float } %switch.load(<2 x float> %.sroa.0479.4.vec.insert501, float %i.gs)
          to label %bb.ae unwind label %bb.af, !callees !58 ; 2 uses
...
begin_hunk_11
  ...
  br i1 %i.ij, label %bb.ad, label %._crit_edge532.loopexit, !llvm.loop !64
...
begin_hunk_12
  ...
  %i.iq = load i32, ptr %i.ip, align 4, !tbaa !53, !noalias !65
  %i.ir = load i32, ptr %i.io, align 4, !tbaa !3, !noalias !65
  %i.is = load i32, ptr %i.in, align 4, !tbaa !3, !noalias !65
  invoke void @_ZN8ultrahdr18uhdr_raw_image_extC1E12uhdr_img_fmt16uhdr_color_gamut19uhdr_color_transfer16uhdr_color_rangejjj(ptr noundef nonnull align 8 dereferenceable(72) %i.im, i32 noundef 1, i32 noundef %i.c, i32 noundef %i.iq, i32 noundef 1, i32 noundef %i.ir, i32 noundef %i.is, i32 noundef 64)
          to label %_ZNSt10unique_ptrIN8ultrahdr18uhdr_raw_image_extESt14default_deleteIS1_EED2Ev.exit393 unwind label %bb.ai, !noalias !65

bb.ai:                                            ; preds = %.noexc376
  %i.it = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvm(ptr noundef nonnull %i.im, i64 noundef 72) #40, !noalias !65
  br label %.body
...
begin_hunk_13
  ...
  br i1 %i.jp, label %.preheader519, label %.loopexit, !llvm.loop !68
...
begin_hunk_14
  ...
  %i.lj = invoke { <2 x float>, float } %switch.load(<2 x float> %.sroa.0.4.vec.insert574, float %i.li)
          to label %bb.al unwind label %bb.bb, !callees !58 ; 2 uses
...
begin_hunk_15
  ...
  %i.lu = invoke { <2 x float>, float } %switch.load(<2 x float> %.sroa.27.16.vec.insert592, float %i.lt)
          to label %bb.ap unwind label %bb.bb, !callees !58 ; 2 uses
...
begin_hunk_16
  ...
  %i.mf = invoke { <2 x float>, float } %switch.load(<2 x float> %.sroa.45.28.vec.insert610, float %i.me)
          to label %bb.at unwind label %bb.bb, !callees !58 ; 2 uses
...
begin_hunk_17
  ...
  %i.mq = invoke { <2 x float>, float } %switch.load(<2 x float> %.sroa.63.40.vec.insert628, float %i.mp)
          to label %bb.ax unwind label %bb.bb, !callees !58 ; 2 uses
...
begin_hunk_18
  ...
  br i1 %i.pf, label %bb.ak, label %._crit_edge528.loopexit, !llvm.loop !69
...
bb.bc:                                            ; preds = %bb.ag
  br i1 %i.il, label %bb.bd, label %.loopexit
...
begin_hunk_20
  ...
  %i.pl = load i32, ptr %i.pk, align 4, !tbaa !53, !noalias !70
  %i.pm = load i32, ptr %i.pj, align 4, !tbaa !3, !noalias !70
  %i.pn = load i32, ptr %i.pi, align 4, !tbaa !3, !noalias !70
  invoke void @_ZN8ultrahdr18uhdr_raw_image_extC1E12uhdr_img_fmt16uhdr_color_gamut19uhdr_color_transfer16uhdr_color_rangejjj(ptr noundef nonnull align 8 dereferenceable(72) %i.ph, i32 noundef 6, i32 noundef %i.c, i32 noundef %i.pl, i32 noundef 1, i32 noundef %i.pm, i32 noundef %i.pn, i32 noundef 64)
          to label %_ZNSt10unique_ptrIN8ultrahdr18uhdr_raw_image_extESt14default_deleteIS1_EED2Ev.exit414 unwind label %bb.be, !noalias !70

bb.be:                                            ; preds = %.noexc397
  %i.po = landingpad { ptr, i32 }
          cleanup
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ph, i64 noundef 72) #40, !noalias !70
  br label %.body
...
begin_hunk_21
  ...
  br i1 %i.qg, label %.preheader521, label %.loopexit, !llvm.loop !73
...
begin_hunk_22
  ...
  %i.qv = invoke { <2 x float>, float } %switch.load(<2 x float> %.sroa.0443.4.vec.insert465, float %i.qu)
          to label %bb.bh unwind label %bb.bi, !callees !58 ; 2 uses
...
begin_hunk_23
  ...
  br i1 %i.sl, label %bb.bg, label %._crit_edge.loopexit, !llvm.loop !74
...
begin_hunk_24
  ...
  %i.st = load i32, ptr %i.ss, align 4, !tbaa !75, !noalias !76
  %i.su = load i32, ptr %i.sr, align 4, !tbaa !53, !noalias !76
...
begin_hunk_26
  ...
  %i.h = load i32, ptr %i.a, align 4, !tbaa !75, !noalias !95
  %i.i = load i32, ptr %i.b, align 4, !tbaa !53, !noalias !95
...
!57 = distinct !{!57, !14}
!58 = !{ptr @_ZN8ultrahdr10p3RgbToYuvENS_5ColorE, ptr @_ZN8ultrahdr12srgbRgbToYuvENS_5ColorE, ptr @_ZN8ultrahdr14bt2100RgbToYuvENS_5ColorE}
!59 = distinct !{!59, !14}
!60 = !{!61}
!61 = distinct !{!61, !62, !"_ZSt11make_uniqueIN8ultrahdr18uhdr_raw_image_extEJ12uhdr_img_fmtR16uhdr_color_gamutR19uhdr_color_transfer16uhdr_color_rangeRjS8_iEENSt8__detail9_MakeUniqIT_E15__single_objectEDpOT0_: argument 0"}
!62 = distinct !{!62, !"_ZSt11make_uniqueIN8ultrahdr18uhdr_raw_image_extEJ12uhdr_img_fmtR16uhdr_color_gamutR19uhdr_color_transfer16uhdr_color_rangeRjS8_iEENSt8__detail9_MakeUniqIT_E15__single_objectEDpOT0_"}
!63 = distinct !{!63, !14}
!64 = distinct !{!64, !14}
!65 = !{!66}
!66 = distinct !{!66, !67, !"_ZSt11make_uniqueIN8ultrahdr18uhdr_raw_image_extEJ12uhdr_img_fmtR16uhdr_color_gamutR19uhdr_color_transfer16uhdr_color_rangeRjS8_iEENSt8__detail9_MakeUniqIT_E15__single_objectEDpOT0_: argument 0"}
!67 = distinct !{!67, !"_ZSt11make_uniqueIN8ultrahdr18uhdr_raw_image_extEJ12uhdr_img_fmtR16uhdr_color_gamutR19uhdr_color_transfer16uhdr_color_rangeRjS8_iEENSt8__detail9_MakeUniqIT_E15__single_objectEDpOT0_"}
!68 = distinct !{!68, !14}
!69 = distinct !{!69, !14}
!70 = !{!71}
!71 = distinct !{!71, !72, !"_ZSt11make_uniqueIN8ultrahdr18uhdr_raw_image_extEJ12uhdr_img_fmtR16uhdr_color_gamutR19uhdr_color_transfer16uhdr_color_rangeRjS8_iEENSt8__detail9_MakeUniqIT_E15__single_objectEDpOT0_: argument 0"}
!72 = distinct !{!72, !"_ZSt11make_uniqueIN8ultrahdr18uhdr_raw_image_extEJ12uhdr_img_fmtR16uhdr_color_gamutR19uhdr_color_transfer16uhdr_color_rangeRjS8_iEENSt8__detail9_MakeUniqIT_E15__single_objectEDpOT0_"}
!73 = distinct !{!73, !14}
!74 = distinct !{!74, !14}
!75 = !{!33, !33, i64 0}
!76 = !{!77}
