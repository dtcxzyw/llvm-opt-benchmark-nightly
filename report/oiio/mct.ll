...
bb.b:                                             ; preds = %bb.a
  ...
  %.not72 = icmp eq i32 %i.a, 0
  br i1 %.not72, label %.preheader54, label %.lr.ph.preheader

.lr.ph.preheader:                                 ; preds = %bb.b
  %min.iters.check = icmp ult i32 %i.a, 8
  br i1 %min.iters.check, label %.lr.ph.preheader120, label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load93 = load <4 x float>, ptr %i.l, align 4, !tbaa !20
  %i.m = fmul <4 x float> %wide.load, splat (float 8.192000e+03)
  %i.n = fmul <4 x float> %wide.load93, splat (float 8.192000e+03)
...
middle.block:                                     ; preds = %vector.body
  ...
  br i1 %cmp.n, label %.preheader54, label %.lr.ph.preheader120

.lr.ph.preheader120:                              ; preds = %.lr.ph.preheader, %middle.block
...
.lr.ph58.us.preheader.preheader:                  ; preds = %.preheader54
  ...
  %min.iters.check100 = icmp ult i32 %3, 8
  %n.vec103 = and i64 %i.f, 4294967288            ; 4 uses
  %i.v = shl nuw nsw i64 %n.vec103, 2
  %cmp.n114 = icmp eq i64 %n.vec103, %i.f
  %xtraiter122 = and i64 %i.f, 1
  %lcmp.mod123.not = icmp eq i64 %xtraiter122, 0
  %i.w = add nsw i64 %i.f, -1
  br label %.lr.ph58.us.preheader

.lr.ph58.us.preheader:                            ; preds = %.lr.ph58.us.preheader.preheader, %._crit_edge.us
  %.14764.us = phi i64 [ %i.cz, %._crit_edge.us ], [ 0, %.lr.ph58.us.preheader.preheader ]
  br i1 %i.u, label %.lr.ph58.us.epil.preheader, label %.lr.ph58.us

.preheader.us:                                    ; preds = %.preheader.us.preheader, %.loopexit
  %indvars.iv84 = phi i64 [ %indvars.iv.next85, %.loopexit ], [ 0, %.preheader.us.preheader ] ; 2 uses
  %.062.us = phi ptr [ %.lcssa, %.loopexit ], [ %i.g, %.preheader.us.preheader ] ; 6 uses
  %i.x = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv84 ; 2 uses
  %i.y = load ptr, ptr %i.x, align 8, !tbaa !24   ; 9 uses
  store i32 0, ptr %i.y, align 4, !tbaa !3
  br i1 %min.iters.check100, label %scalar.ph99.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.preheader.us
  %scevgep = getelementptr i8, ptr %i.y, i64 4    ; 2 uses
  %scevgep95 = getelementptr i8, ptr %.062.us, i64 %i.t
  %bound0 = icmp ult ptr %i.y, %i.g
  %bound1 = icmp ult ptr %i.e, %scevgep
  %found.conflict = and i1 %bound0, %bound1
  %bound096 = icmp ult ptr %i.y, %scevgep95
  %bound197 = icmp ult ptr %.062.us, %scevgep
  %found.conflict98 = and i1 %bound096, %bound197
  %conflict.rdx = or i1 %found.conflict, %found.conflict98
  br i1 %conflict.rdx, label %scalar.ph99.preheader, label %vector.ph101

vector.ph101:                                     ; preds = %vector.memcheck
  %i.z = getelementptr i8, ptr %.062.us, i64 %i.v ; 2 uses
  br label %vector.body104

vector.body104:                                   ; preds = %vector.body104, %vector.ph101
  %index105 = phi i64 [ 0, %vector.ph101 ], [ %index.next112, %vector.body104 ] ; 3 uses
  %vec.phi = phi <4 x i32> [ zeroinitializer, %vector.ph101 ], [ %i.aq, %vector.body104 ]
  %vec.phi106 = phi <4 x i32> [ zeroinitializer, %vector.ph101 ], [ %i.ar, %vector.body104 ]
  %i.aa = shl i64 %index105, 2
  %next.gep107 = getelementptr i8, ptr %.062.us, i64 %i.aa ; 2 uses
  %i.ab = getelementptr i8, ptr %next.gep107, i64 16
  %wide.load108 = load <4 x i32>, ptr %next.gep107, align 4, !tbaa !3, !alias.scope !27
  %wide.load109 = load <4 x i32>, ptr %i.ab, align 4, !tbaa !3, !alias.scope !27
  %i.ac = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %index105 ; 2 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %i.ac, i64 16
  %wide.load110 = load <4 x i32>, ptr %i.ac, align 4, !tbaa !3, !alias.scope !30
  %wide.load111 = load <4 x i32>, ptr %i.ad, align 4, !tbaa !3, !alias.scope !30
  %i.ae = sext <4 x i32> %wide.load108 to <4 x i64>
  %i.af = sext <4 x i32> %wide.load109 to <4 x i64>
  %i.ag = sext <4 x i32> %wide.load110 to <4 x i64>
  %i.ah = sext <4 x i32> %wide.load111 to <4 x i64>
  ...
  %i.ar = add <4 x i32> %vec.phi106, %i.ap        ; 2 uses
  %index.next112 = add nuw i64 %index105, 8       ; 2 uses
  %i.as = icmp eq i64 %index.next112, %n.vec103
  br i1 %i.as, label %middle.block113, label %vector.body104, !llvm.loop !32
...
middle.block113:                                  ; preds = %vector.body104
  ...
  br i1 %cmp.n114, label %.loopexit, label %scalar.ph99.preheader

scalar.ph99.preheader:                            ; preds = %vector.memcheck, %.preheader.us, %middle.block113
  %indvars.iv79.ph = phi i64 [ 0, %vector.memcheck ], [ 0, %.preheader.us ], [ %n.vec103, %middle.block113 ] ; 4 uses
  %.160.us.ph = phi ptr [ %.062.us, %vector.memcheck ], [ %.062.us, %.preheader.us ], [ %i.z, %middle.block113 ] ; 3 uses
  %.ph = phi i32 [ 0, %vector.memcheck ], [ 0, %.preheader.us ], [ %i.at, %middle.block113 ] ; 2 uses
  br i1 %lcmp.mod123.not, label %scalar.ph99.prol.loopexit, label %scalar.ph99.prol

scalar.ph99.prol:                                 ; preds = %scalar.ph99.preheader
  %i.au = load i32, ptr %.160.us.ph, align 4, !tbaa !3
  %i.av = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %indvars.iv79.ph
  ...
  %i.be = getelementptr inbounds nuw i8, ptr %.160.us.ph, i64 4 ; 2 uses
  %indvars.iv.next80.prol = or disjoint i64 %indvars.iv79.ph, 1
  br label %scalar.ph99.prol.loopexit

scalar.ph99.prol.loopexit:                        ; preds = %scalar.ph99.prol, %scalar.ph99.preheader
  %.lcssa119.unr = phi ptr [ poison, %scalar.ph99.preheader ], [ %i.be, %scalar.ph99.prol ]
  %indvars.iv79.unr = phi i64 [ %indvars.iv79.ph, %scalar.ph99.preheader ], [ %indvars.iv.next80.prol, %scalar.ph99.prol ]
  %.160.us.unr = phi ptr [ %.160.us.ph, %scalar.ph99.preheader ], [ %i.be, %scalar.ph99.prol ]
  %.unr = phi i32 [ %.ph, %scalar.ph99.preheader ], [ %i.bd, %scalar.ph99.prol ]
  %i.bf = icmp eq i64 %indvars.iv79.ph, %i.w
  br i1 %i.bf, label %.loopexit, label %scalar.ph99

.loopexit:                                        ; preds = %scalar.ph99.prol.loopexit, %scalar.ph99, %middle.block113
  %.lcssa = phi ptr [ %i.z, %middle.block113 ], [ %.lcssa119.unr, %scalar.ph99.prol.loopexit ], [ %i.ce, %scalar.ph99 ]
  ...
  %exitcond88.not = icmp eq i64 %indvars.iv.next85, %i.f
  br i1 %exitcond88.not, label %._crit_edge.us, label %.preheader.us, !llvm.loop !36

scalar.ph99:                                      ; preds = %scalar.ph99.prol.loopexit, %scalar.ph99
  %indvars.iv79 = phi i64 [ %indvars.iv.next80.1, %scalar.ph99 ], [ %indvars.iv79.unr, %scalar.ph99.prol.loopexit ] ; 3 uses
  %.160.us = phi ptr [ %i.ce, %scalar.ph99 ], [ %.160.us.unr, %scalar.ph99.prol.loopexit ] ; 3 uses
  %i.bh = phi i32 [ %i.cd, %scalar.ph99 ], [ %.unr, %scalar.ph99.prol.loopexit ]
  %i.bi = load i32, ptr %.160.us, align 4, !tbaa !3
  %i.bj = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %indvars.iv79
  ...
  %i.bs = getelementptr inbounds nuw i8, ptr %.160.us, i64 4
  %i.bt = load i32, ptr %i.bs, align 4, !tbaa !3
  %i.bu = getelementptr inbounds nuw [4 x i8], ptr %i.e, i64 %indvars.iv79
  ...
  %i.ce = getelementptr inbounds nuw i8, ptr %.160.us, i64 8 ; 2 uses
  %indvars.iv.next80.1 = add nuw nsw i64 %indvars.iv79, 2 ; 2 uses
  %exitcond83.not.1 = icmp eq i64 %indvars.iv.next80.1, %i.f
  br i1 %exitcond83.not.1, label %.loopexit, label %scalar.ph99, !llvm.loop !37

.lr.ph58.us:                                      ; preds = %.lr.ph58.us.preheader, %.lr.ph58.us
  %indvars.iv = phi i64 [ %indvars.iv.next.3, %.lr.ph58.us ], [ 0, %.lr.ph58.us.preheader ] ; 6 uses
  %niter = phi i64 [ %niter.next.3, %.lr.ph58.us ], [ 0, %.lr.ph58.us.preheader ]
  ...
  br i1 %niter.ncmp.3, label %.preheader.us.preheader.unr-lcssa, label %.lr.ph58.us, !llvm.loop !38

.preheader.us.preheader.unr-lcssa:                ; preds = %.lr.ph58.us
  br i1 %lcmp.mod.not, label %.preheader.us.preheader, label %.lr.ph58.us.epil.preheader

.lr.ph58.us.epil.preheader:                       ; preds = %.preheader.us.preheader.unr-lcssa, %.lr.ph58.us.preheader
  %indvars.iv.epil.init = phi i64 [ 0, %.lr.ph58.us.preheader ], [ %indvars.iv.next.3, %.preheader.us.preheader.unr-lcssa ]
  tail call void @llvm.assume(i1 %lcmp.mod121)
  br label %.lr.ph58.us.epil

.lr.ph58.us.epil:                                 ; preds = %.lr.ph58.us.epil, %.lr.ph58.us.epil.preheader
  %indvars.iv.epil = phi i64 [ %indvars.iv.epil.init, %.lr.ph58.us.epil.preheader ], [ %indvars.iv.next.epil, %.lr.ph58.us.epil ] ; 3 uses
  %epil.iter = phi i64 [ 0, %.lr.ph58.us.epil.preheader ], [ %epil.iter.next, %.lr.ph58.us.epil ]
  ...
  br i1 %epil.iter.cmp.not, label %.preheader.us.preheader, label %.lr.ph58.us.epil, !llvm.loop !39

.preheader.us.preheader:                          ; preds = %.lr.ph58.us.epil, %.preheader.us.preheader.unr-lcssa
  br label %.preheader.us

._crit_edge.us:                                   ; preds = %.loopexit
  %i.cz = add nuw i64 %.14764.us, 1               ; 2 uses
  %exitcond89.not = icmp eq i64 %i.cz, %1
  br i1 %exitcond89.not, label %._crit_edge65, label %.lr.ph58.us.preheader, !llvm.loop !41

.lr.ph:                                           ; preds = %.lr.ph.preheader120, %.lr.ph
  %.04556 = phi ptr [ %i.da, %.lr.ph ], [ %.04556.ph, %.lr.ph.preheader120 ] ; 2 uses
  %.04655 = phi i64 [ %i.df, %.lr.ph ], [ %.04655.ph, %.lr.ph.preheader120 ] ; 2 uses
...
..preheader_crit_edge.us.us:                      ; preds = %..preheader_crit_edge.us.us.preheader, %bb.c
  %indvars.iv65 = phi i64 [ %indvars.iv.next66, %bb.c ], [ 0, %..preheader_crit_edge.us.us.preheader ] ; 3 uses
  %.03745.us.us = phi ptr [ %.lcssa77, %bb.c ], [ %0, %..preheader_crit_edge.us.us.preheader ] ; 2 uses
  %i.i = getelementptr inbounds nuw [4 x i8], ptr %i.f, i64 %indvars.iv65 ; 4 uses
  store float 0.000000e+00, ptr %i.i, align 4, !tbaa !20
  br i1 %i.h, label %.epil.preheader79, label %..preheader_crit_edge.us.us.new

.unr-lcssa:                                       ; preds = %..preheader_crit_edge.us.us.new
  br i1 %lcmp.mod82.not, label %bb.c, label %.epil.preheader79

.epil.preheader79:                                ; preds = %.unr-lcssa, %..preheader_crit_edge.us.us
  %indvars.iv60.epil.init = phi i64 [ 0, %..preheader_crit_edge.us.us ], [ %indvars.iv.next61.1, %.unr-lcssa ]
  ...
  %i.l = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %indvars.iv60.epil.init
...
bb.c:                                             ; preds = %.unr-lcssa, %.epil.preheader79
  %.lcssa77 = phi ptr [ %i.x, %.unr-lcssa ], [ %i.j, %.epil.preheader79 ]
  %.lcssa = phi float [ %i.ac, %.unr-lcssa ], [ %i.n, %.epil.preheader79 ]
  %i.o = getelementptr inbounds nuw [8 x i8], ptr %2, i64 %indvars.iv65 ; 2 uses
  ...
  %exitcond69.not = icmp eq i64 %indvars.iv.next66, %i.e
  br i1 %exitcond69.not, label %._crit_edge.us.us, label %..preheader_crit_edge.us.us, !llvm.loop !45

..preheader_crit_edge.us.us.new:                  ; preds = %..preheader_crit_edge.us.us, %..preheader_crit_edge.us.us.new
  %indvars.iv60 = phi i64 [ %indvars.iv.next61.1, %..preheader_crit_edge.us.us.new ], [ 0, %..preheader_crit_edge.us.us ] ; 3 uses
  ...
  %niter87 = phi i64 [ %niter87.next.1, %..preheader_crit_edge.us.us.new ], [ 0, %..preheader_crit_edge.us.us ]
  %i.s = getelementptr inbounds nuw i8, ptr %.13843.us.us, i64 4
  %i.t = load float, ptr %.13843.us.us, align 4, !tbaa !20
  %i.u = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %indvars.iv60
  ...
  %i.z = getelementptr inbounds nuw [4 x i8], ptr %i.d, i64 %indvars.iv60
  ...
  br i1 %niter87.ncmp.1, label %.unr-lcssa, label %..preheader_crit_edge.us.us.new, !llvm.loop !46
...
._crit_edge.us.us:                                ; preds = %bb.c
  ...
  %exitcond70.not = icmp eq i64 %i.ax, %1
  br i1 %exitcond70.not, label %._crit_edge49, label %.preheader41.us.us, !llvm.loop !49
