...
bb.i:                                             ; preds = %bb.h
  ...
  %5 = getelementptr inbounds i8, ptr %i.ar, i64 %i.ab ; 3 uses
  %i.as = getelementptr inbounds i8, ptr %5, i64 %i.ab ; 3 uses
...
begin_hunk_2_@internal_exr_undo_pxr24:bb.a
  ...
  %.sroa.829.0234.i = phi ptr [ %5, %.lr.ph240.i.preheader.new ], [ %i.ca, %.lr.ph240.i ] ; 3 uses
  %.sroa.11.0233.i = phi ptr [ %i.as, %.lr.ph240.i.preheader.new ], [ %i.cf, %.lr.ph240.i ] ; 3 uses
...
bb.j:                                             ; preds = %bb.h
  %i.cl = getelementptr inbounds i8, ptr %.1151242.i, i64 %i.ab ; 3 uses
  %6 = getelementptr inbounds i8, ptr %i.cl, i64 %i.ab ; 3 uses
...
bb.k:                                             ; preds = %bb.h
  ...
  %7 = getelementptr inbounds i8, ptr %i.dj, i64 %i.ab ; 3 uses
  %i.dk = getelementptr inbounds i8, ptr %7, i64 %i.ab ; 3 uses
...
begin_hunk_5_@internal_exr_undo_pxr24:bb.a
  ...
  %.sroa.8.0221.i = phi ptr [ %7, %.lr.ph.i.preheader.new ], [ %i.ep, %.lr.ph.i ] ; 3 uses
...
begin_hunk_6_@internal_exr_undo_pxr24:bb.a
  ...
  %.sroa.829.0234.i.epil.init = phi ptr [ %5, %.lr.ph240.i.preheader ], [ %i.ca, %.loopexit.i.loopexit.unr-lcssa ]
  %.sroa.11.0233.i.epil.init = phi ptr [ %i.as, %.lr.ph240.i.preheader ], [ %i.cf, %.loopexit.i.loopexit.unr-lcssa ]
...
begin_hunk_7_@internal_exr_undo_pxr24:bb.a
  ...
  %.sroa.8.0221.i.epil.init = phi ptr [ %7, %.lr.ph.i.preheader ], [ %i.ep, %.loopexit.i.loopexit37.unr-lcssa ]
...
.loopexit.i:                                      ; preds = %.lr.ph.i.epil.preheader, %.loopexit.i.loopexit37.unr-lcssa, %.lr.ph232.i.epil.preheader, %.loopexit.i.loopexit36.unr-lcssa, %.lr.ph240.i.epil.preheader, %.loopexit.i.loopexit.unr-lcssa, %.preheader213.i, %.preheader211.i, %.preheader.i
  %.2152.i.a = phi ptr [ %6, %.preheader211.i ], [ %i.at, %.preheader.i ], [ %i.dk, %.preheader213.i ], [ %6, %.lr.ph232.i.epil.preheader ], [ %i.at, %.lr.ph240.i.epil.preheader ], [ %i.at, %.loopexit.i.loopexit.unr-lcssa ], [ %6, %.loopexit.i.loopexit36.unr-lcssa ], [ %i.dk, %.loopexit.i.loopexit37.unr-lcssa ], [ %i.dk, %.lr.ph.i.epil.preheader ]
...
bb.l:                                             ; preds = %.loopexit.i, %bb.f, %.lr.ph247.i
  ...
  %.3153.i = phi ptr [ %.2152.i.a, %.loopexit.i ], [ %.1151242.i, %.lr.ph247.i ], [ %.1151242.i, %bb.f ] ; 2 uses
