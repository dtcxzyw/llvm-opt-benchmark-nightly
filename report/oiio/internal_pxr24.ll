...
bb.j:                                             ; preds = %bb.i
  ...
  %i.dl = getelementptr i8, ptr %.1138255.i, i64 %i.x ; 7 uses
...
vector.memcheck82:                                ; preds = %.lr.ph243.i.preheader
  ...
  %scevgep84 = getelementptr i8, ptr %scevgep83, i64 %i.dq ; 2 uses
  %i.dr = getelementptr i8, ptr %scevgep83, i64 %i.x
  %scevgep85.a = getelementptr i8, ptr %i.dr, i64 %i.dq ; 2 uses
  ...
  %bound189 = icmp ult ptr %i.dl, %scevgep84
  ...
  %bound095 = icmp ult ptr %i.dl, %scevgep87.a
...
begin_hunk_1_@internal_exr_apply_pxr24:bb.a
  ...
  store <8 x i8> %i.ec, ptr %next.gep109, align 1, !tbaa !31, !alias.scope !51, !noalias !53
  %i.ed = trunc <8 x i32> %i.ea to <8 x i8>
  store <8 x i8> %i.ed, ptr %next.gep110, align 1, !tbaa !31, !alias.scope !55, !noalias !48
  %index.next112 = add nuw i64 %index105, 8       ; 2 uses
  %i.ee = icmp eq i64 %index.next112, %n.vec103
  br i1 %i.ee, label %middle.block113, label %vector.body104, !llvm.loop !56
...
begin_hunk_4_@internal_exr_apply_pxr24:bb.a
  ...
  %wide.load164 = load <4 x i32>, ptr %next.gep160.a, align 1, !alias.scope !60 ; 6 uses
...
begin_hunk_5_@internal_exr_apply_pxr24:bb.a
  ...
  store <4 x i8> %i.hu, ptr %next.gep161, align 1, !tbaa !31, !alias.scope !63, !noalias !65
  %i.hv = lshr <4 x i32> %i.hs, splat (i32 8)
  %i.hw = trunc <4 x i32> %i.hv to <4 x i8>
  store <4 x i8> %i.hw, ptr %next.gep162, align 1, !tbaa !31, !alias.scope !68, !noalias !69
  %i.hx = trunc <4 x i32> %i.hs to <4 x i8>
  store <4 x i8> %i.hx, ptr %next.gep163, align 1, !tbaa !31, !alias.scope !70, !noalias !60
  %index.next166 = add nuw i64 %index157, 4       ; 2 uses
  %i.hy = icmp eq i64 %index.next166, %n.vec155
  br i1 %i.hy, label %middle.block167, label %vector.body156, !llvm.loop !71
...
begin_hunk_7_@internal_exr_apply_pxr24:bb.a
  ...
  br i1 %i.jd, label %.lr.ph256.i, label %._crit_edge.loopexit.i, !llvm.loop !73
...
begin_hunk_9_@internal_exr_apply_pxr24:bb.a
  ...
  %i.jj = load ptr, ptr %i.ji, align 8, !tbaa !75
  ...
  %i.jn = load i64, ptr %i.jm, align 8, !tbaa !77
...
bb.r:                                             ; preds = %bb.q, %bb.p
  ...
  store i64 %i.jw, ptr %i.jx, align 8, !tbaa !79
