...
bb.ao:                                            ; preds = %bb.am, %bb.br
  ...
  %.0243421 = phi i1 [ true, %bb.am ], [ %.2245.1, %bb.br ] ; 2 uses
...
bb.bf:                                            ; preds = %bb.be, %bb.bd
  ...
  %i.kr = select i1 %i.kq, i1 %.0243421, i1 false
...
bb.bg:                                            ; preds = %bb.av, %.loopexit
  ...
  %.2245 = phi i1 [ %i.kr, %.loopexit ], [ %.0243421, %bb.av ] ; 2 uses
...
.critedge:                                        ; preds = %bb.c, %bb.k, %bb.h, %bb.m, %bb.bt, %bb.e
  %.5 = phi i1 [ true, %bb.e ], [ %.2245.1, %bb.bt ], [ %i.ai, %bb.k ], [ %i.x, %bb.h ], [ %i.aw, %bb.m ], [ false, %bb.c ]
  ret i1 %.5
}

; Function Attrs: mustprogress uwtable
define noundef zeroext i1 @_ZN11OpenImageIO4v3_113TextureSystem11environmentENS0_7ustringERNS0_18TextureOptBatch_v1EmPKfS6_S6_iPfS7_S7_(ptr nofree noundef nonnull readonly align 8 captures(none) dereferenceable(16) %0, ptr %1, ptr nofree noundef nonnull readonly align 64 captures(none) dereferenceable(512) %2, i64 noundef %3, ptr nofree noundef readonly captures(none) %4, ptr nofree noundef readonly captures(none) %5, ptr nofree noundef readonly captures(none) %6, i32 noundef %7, ptr nofree noundef writeonly captures(none) %8, ptr nofree noundef writeonly captures(address_is_null) %9, ptr nofree noundef writeonly captures(none) %10) local_unnamed_addr #2 align 2 {
bb.a:
...
; Function Attrs: mustprogress uwtable
define hidden noundef zeroext i1 @_ZN11OpenImageIO4v3_117TextureSystemImpl11environmentENS0_7ustringERNS0_18TextureOptBatch_v1EmPKfS6_S6_iPfS7_S7_(ptr noundef nonnull align 8 dereferenceable(188) %0, ptr %1, ptr nofree noundef nonnull readonly align 64 captures(none) dereferenceable(512) %2, i64 noundef %3, ptr nofree noundef readonly captures(none) %4, ptr nofree noundef readonly captures(none) %5, ptr nofree noundef readonly captures(none) %6, i32 noundef %7, ptr nofree noundef writeonly captures(none) %8, ptr nofree noundef writeonly captures(address_is_null) %9, ptr nofree noundef writeonly captures(none) %10) local_unnamed_addr #2 align 2 {
bb.a:
