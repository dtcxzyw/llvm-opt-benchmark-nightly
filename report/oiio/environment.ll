...
bb.ao:                                            ; preds = %bb.am, %bb.br
  ...
  %.0243427 = phi i8 [ 1, %bb.am ], [ %.2245.1, %bb.br ] ; 2 uses
...
bb.bg:                                            ; preds = %bb.av, %.loopexit
  ...
  %.2245 = phi i8 [ %23, %.loopexit ], [ %.0243427, %bb.av ] ; 2 uses
...
.thread:                                          ; preds = %bb.c, %bb.k, %bb.h, %bb.m, %bb.bt, %bb.e
  %.5 = phi i1 [ true, %bb.e ], [ %i.ai, %bb.k ], [ %i.x, %bb.h ], [ %i.aw, %bb.m ], [ %26, %bb.bt ], [ false, %bb.c ]
  ret i1 %.5
}
