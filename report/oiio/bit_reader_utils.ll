...
.critedge.loopexit.i:                             ; preds = %.critedge.loopexit.isplit, %..critedge.loopexit.i_crit_edge
  %i.ai = phi i64 [ %.lcssa, %..critedge.loopexit.i_crit_edge ], [ %.ph, %.critedge.loopexit.isplit ]
