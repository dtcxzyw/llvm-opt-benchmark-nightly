...
bb.a:
  ...
  %spec.store.select = select i1 %.not, i32 2, i32 4098 ; 5 uses
...
.thread51:                                        ; preds = %._crit_edge, %.loopexit.thread, %bb.d, %bb.c
  %2 = or disjoint i32 %spec.store.select, 1024   ; 2 uses
...
.thread51.i:                                      ; preds = %._crit_edge.i, %.loopexit.thread.i, %bb.d, %bb.c
  %1 = or disjoint i32 %spec.store.select.i, 1024
  br label %.critedge.i
...
begin_hunk_6_@internal_exr_write_header:bb.a
  ...
  %2 = and i32 %.262.fr, 6144
  %3 = icmp eq i32 %2, 0
  br i1 %3, label %.preheader75.split.us, label %.preheader75.split
