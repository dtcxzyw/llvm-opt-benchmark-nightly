begin_hunk_0
  ...
  br i1 %or.cond674.i, label %bb.be, label %.preheader778.i.preheader

.preheader778.i.preheader:                        ; preds = %._crit_edge945.i
  %invariant.op = sub i64 -6, %i.mg
  br label %.preheader778.i

.preheader778.i:                                  ; preds = %.preheader778.i.preheader, %bb.bd
  %.2494.i = phi i32 [ %.3495.i, %bb.bd ], [ %.1493.i, %.preheader778.i.preheader ] ; 2 uses
  %.4485.i = phi i32 [ %.5486.i, %bb.bd ], [ %.3484.i, %.preheader778.i.preheader ] ; 3 uses
  %.4477.i = phi i32 [ %.3495.i, %bb.bd ], [ %.3476.i, %.preheader778.i.preheader ]
...
begin_hunk_1
  ...
  %i.nh = add i64 %i.ng, %invariant.op
