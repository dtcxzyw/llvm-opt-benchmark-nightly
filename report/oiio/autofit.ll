...
bb.ag:                                            ; preds = %bb.ae, %bb.af, %bb.ac
  %.sink565 = phi ptr [ %i.ce, %bb.ae ], [ %i.ce, %bb.af ], [ %.1499, %bb.ac ]
  %.sink = phi i64 [ %i.fm, %bb.ae ], [ %i.ga, %bb.af ], [ %i.ez, %bb.ac ]
  %i.gb = getelementptr inbounds nuw i8, ptr %.sink565, i64 16
...
bb.ap:                                            ; preds = %bb.an, %bb.ao
  %.sink567.a = phi i64 [ 440, %bb.ao ], [ 176, %bb.an ]
  %.sink566 = phi i64 [ 792, %bb.ao ], [ 352, %bb.an ]
  %.0339 = phi ptr [ %i.gz, %bb.ao ], [ %i.e, %bb.an ] ; 2 uses
  %i.ha = getelementptr inbounds nuw i8, ptr %i.e, i64 %.sink567.a ; 2 uses
  %i.hb = getelementptr inbounds nuw i8, ptr %i.e, i64 %.sink566 ; 4 uses
...
.lr.ph506:                                        ; preds = %bb.aw, %bb.bx
  %.2504 = phi ptr [ %i.md, %bb.bx ], [ %i.e, %bb.aw ] ; 27 uses
...
.preheader:                                       ; preds = %.thread480, %bb.bb
  ...
  br i1 %.not405, label %.preheader569, label %bb.bb
...
bb.bb:                                            ; preds = %.preheader
  ...
  br i1 %.not406, label %.preheader, label %.preheader569, !llvm.loop !444

.preheader569:                                    ; preds = %bb.bb, %.preheader
  br label %bb.bc

bb.bc:                                            ; preds = %.preheader569, %bb.bd
  %.2.pn408 = phi ptr [ %.0, %bb.bd ], [ %.2504, %.preheader569 ] ; 4 uses
