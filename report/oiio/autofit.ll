begin_hunk_0
  ...
  %i.td = load ptr, ptr %i.tc, align 8, !tbaa !183 ; 23 uses
...
vector.body264:                                   ; preds = %pred.store.continue296, %vector.ph261
  %index265 = phi i64 [ 0, %vector.ph261 ], [ %index.next297, %pred.store.continue296 ] ; 18 uses
  %i.th = getelementptr inbounds nuw [2 x i8], ptr %i.td, i64 %index265 ; 2 uses
...
pred.store.if:                                    ; preds = %vector.body264
  %4 = getelementptr inbounds nuw [2 x i8], ptr %i.td, i64 %index265
  store i16 66, ptr %4, align 2, !tbaa !56
  br label %pred.store.continue

pred.store.continue:                              ; preds = %pred.store.if, %vector.body264
...
pred.store.continue268:                           ; preds = %pred.store.if267, %pred.store.continue
...
vec.epilog.vector.body:                           ; preds = %pred.store.continue313, %vec.epilog.ph
  %index304 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next314, %pred.store.continue313 ] ; 6 uses
  %i.vk = getelementptr inbounds nuw [2 x i8], ptr %i.td, i64 %index304
...
pred.store.if306:                                 ; preds = %vec.epilog.vector.body
  %5 = getelementptr inbounds nuw [2 x i8], ptr %i.td, i64 %index304
  store i16 66, ptr %5, align 2, !tbaa !56
  br label %pred.store.continue307

pred.store.continue307:                           ; preds = %pred.store.if306, %vec.epilog.vector.body
...
begin_hunk_23
  ...
  %i.p = getelementptr inbounds nuw i8, ptr %i.j, i64 784 ; 28 uses
...
vector.body60:                                    ; preds = %pred.store.continue75, %vector.ph57
  %index61 = phi i64 [ 0, %vector.ph57 ], [ %index.next76, %pred.store.continue75 ] ; 10 uses
  %i.gg = getelementptr inbounds nuw [2 x i8], ptr %i.p, i64 %index61
...
pred.store.if:                                    ; preds = %vector.body60
  ...
  %3 = getelementptr inbounds nuw [2 x i8], ptr %i.p, i64 %index61
  %i.gm = or i16 %i.gl, %i.gf
  store i16 %i.gm, ptr %3, align 2, !tbaa !56
  br label %pred.store.continue

pred.store.continue:                              ; preds = %pred.store.if, %vector.body60
