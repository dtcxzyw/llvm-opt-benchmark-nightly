...
bb.ae:                                            ; preds = %bb.ad
  ...
  %.0337 = tail call i64 @llvm.abs.i64(i64 %i.ff, i1 true)
  %i.fg = or disjoint i64 %.437, %i.fc            ; 2 uses
  %i.fh = sub nsw i64 %i.er, %i.fg
  %.0336 = tail call i64 @llvm.abs.i64(i64 %i.fh, i1 true)
  %i.fi = icmp samesign ult i64 %.0337, %.0336
  %.0339 = select i1 %i.fi, i64 %i.fe, i64 %i.fg  ; 2 uses
  %i.fj = sdiv i64 %i.ev, 2                       ; 2 uses
  %i.fk = sub nsw i64 %.0339, %i.fj
  %i.fl = getelementptr inbounds nuw i8, ptr %.1354497, i64 16
  store i64 %i.fk, ptr %i.fl, align 8, !tbaa !96
  %i.fm = add nsw i64 %.0339, %i.fj
  br label %bb.ag
...
bb.af:                                            ; preds = %bb.ad
  ...
  %.1 = tail call i64 @llvm.abs.i64(i64 %i.fw, i1 true)
  %i.fx = icmp samesign ult i64 %spec.select438, %.1
  %i.fy = select i1 %i.fx, i64 %i.fo, i64 %i.fu   ; 2 uses
  %i.fz = getelementptr inbounds nuw i8, ptr %.1354497, i64 16
  store i64 %i.fy, ptr %i.fz, align 8, !tbaa !96
  %i.ga = add nsw i64 %i.fy, %i.ev
  br label %bb.ag

bb.ag:                                            ; preds = %bb.ae, %bb.af, %bb.ac
  %.sink568.a = phi ptr [ %i.ce, %bb.ae ], [ %i.ce, %bb.af ], [ %.1354497, %bb.ac ]
  %.sink = phi i64 [ %i.fm, %bb.ae ], [ %i.ga, %bb.af ], [ %i.ez, %bb.ac ]
  %i.gb = getelementptr inbounds nuw i8, ptr %.sink568.a, i64 16
  ...
  %i.gf = icmp ugt ptr %.1354497, %i.e
  br i1 %i.gf, label %bb.ah, label %bb.am

bb.ah:                                            ; preds = %bb.ag
  %i.gg = getelementptr inbounds nuw i8, ptr %.1354497, i64 16
  %i.gh = load i64, ptr %i.gg, align 8, !tbaa !96 ; 2 uses
  %i.gi = getelementptr inbounds i8, ptr %.1354497, i64 -72
  %i.gj = load i64, ptr %i.gi, align 8, !tbaa !96 ; 4 uses
  br i1 %.0348459, label %bb.aj, label %bb.ai
...
bb.al:                                            ; preds = %bb.ak
  %i.gr = getelementptr inbounds nuw i8, ptr %.1354497, i64 16
  store i64 %i.gj, ptr %i.gr, align 8, !tbaa !96
  br label %bb.am

bb.am:                                            ; preds = %bb.aa, %bb.ak, %bb.al, %bb.aj, %bb.ai, %bb.ag, %bb.r, %bb.v, %bb.t
  %.6 = phi ptr [ %.4498, %bb.t ], [ %.4498, %bb.v ], [ %.4498, %bb.r ], [ %.1354497, %bb.aa ], [ %.4498, %bb.ag ], [ %.4498, %bb.ak ], [ %.4498, %bb.al ], [ %.4498, %bb.aj ], [ %.4498, %bb.ai ] ; 2 uses
  %.1350 = phi i32 [ %i.cf, %bb.t ], [ %.0349499, %bb.v ], [ %.0349499, %bb.r ], [ %.0349499, %bb.aa ], [ %.0349499, %bb.ag ], [ %.0349499, %bb.ak ], [ %.0349499, %bb.al ], [ %.0349499, %bb.aj ], [ %.0349499, %bb.ai ] ; 2 uses
  %i.gs = getelementptr inbounds nuw i8, ptr %.1354497, i64 88 ; 2 uses
  %i.gt = icmp ult ptr %i.gs, %i.j
  br i1 %i.gt, label %bb.r, label %._crit_edge.loopexit, !llvm.loop !443

._crit_edge.loopexit:                             ; preds = %bb.am
  %i.gu = icmp ne i32 %.1350, 0
  br label %._crit_edge

._crit_edge:                                      ; preds = %._crit_edge.loopexit, %.thread
  %.4.lcssa = phi ptr [ %.3, %.thread ], [ %.6, %._crit_edge.loopexit ] ; 2 uses
  %.0349.lcssa = phi i1 [ false, %.thread ], [ %i.gu, %._crit_edge.loopexit ]
...
bb.ap:                                            ; preds = %bb.an, %bb.ao
  %.sink570 = phi i64 [ 440, %bb.ao ], [ 176, %bb.an ]
  %.sink569 = phi i64 [ 792, %bb.ao ], [ 352, %bb.an ]
  %.0333 = phi ptr [ %i.gz, %bb.ao ], [ %i.e, %bb.an ] ; 2 uses
  %i.ha = getelementptr inbounds nuw i8, ptr %i.e, i64 %.sink570 ; 2 uses
  %i.hb = getelementptr inbounds nuw i8, ptr %i.e, i64 %.sink569 ; 4 uses
  %i.hc = getelementptr inbounds nuw i8, ptr %i.ha, i64 8
  %i.hd = load i64, ptr %i.hc, align 8, !tbaa !97
  %i.he = getelementptr inbounds nuw i8, ptr %.0333, i64 8
...
bb.aq:                                            ; preds = %bb.ap
  ...
  %i.hr = getelementptr inbounds nuw i8, ptr %.0333, i64 16
...
bb.aw:                                            ; preds = %bb.ap, %bb.av, %bb.au, %bb.an, %._crit_edge
  ...
  %or.cond5.not510 = select i1 %.0349.lcssa, i1 true, i1 %i.im
...
bb.ax:                                            ; preds = %.lr.ph506
  %i.iq = getelementptr inbounds nuw i8, ptr %.2355503, i64 56
...
bb.ay:                                            ; preds = %bb.ax
  ...
  %i.iu = getelementptr inbounds nuw i8, ptr %.2355503, i64 8
...
bb.az:                                            ; preds = %bb.ay
  ...
  %i.jc = getelementptr inbounds nuw i8, ptr %.2355503, i64 16
  store i64 %i.jb, ptr %i.jc, align 8, !tbaa !96
  br label %bb.bi

.thread480:                                       ; preds = %bb.ax, %bb.ay
  %.not404 = icmp eq ptr %.7505, null
  br i1 %.not404, label %bb.ba, label %.preheader

bb.ba:                                            ; preds = %.thread480
  %i.jd = getelementptr inbounds nuw i8, ptr %.2355503, i64 8
  %i.je = load i64, ptr %i.jd, align 8, !tbaa !97
  %i.jf = add nsw i64 %i.je, 32
  %i.jg = and i64 %i.jf, -64                      ; 2 uses
  %i.jh = getelementptr inbounds nuw i8, ptr %.2355503, i64 16
  store i64 %i.jg, ptr %i.jh, align 8, !tbaa !96
  br label %bb.bi

.preheader:                                       ; preds = %.thread480, %bb.bb
  %.2355.pn = phi ptr [ %.0328, %bb.bb ], [ %.2355503, %.thread480 ] ; 4 uses
  %.0328 = getelementptr inbounds i8, ptr %.2355.pn, i64 -88 ; 3 uses
  %.not405 = icmp ult ptr %.0328, %i.e            ; 2 uses
  br i1 %.not405, label %.preheader573, label %bb.bb

bb.bb:                                            ; preds = %.preheader
  %i.ji = getelementptr inbounds i8, ptr %.2355.pn, i64 -64
  %i.jj = load i8, ptr %i.ji, align 8, !tbaa !202
  %i.jk = and i8 %i.jj, 4
  %.not406 = icmp eq i8 %i.jk, 0
  br i1 %.not406, label %.preheader, label %.preheader573, !llvm.loop !444

.preheader573:                                    ; preds = %bb.bb, %.preheader
  br label %bb.bc
...
bb.bd:                                            ; preds = %bb.bc
  %i.jl = getelementptr inbounds nuw i8, ptr %.2355.pn408, i64 112
...
bb.bf:                                            ; preds = %bb.be
  %i.jq = getelementptr inbounds nuw i8, ptr %.2355.pn408, i64 96
  %i.jr = load i64, ptr %i.jq, align 8, !tbaa !97 ; 2 uses
  %i.js = getelementptr inbounds i8, ptr %.2355.pn, i64 -80
  %i.jt = load i64, ptr %i.js, align 8, !tbaa !97 ; 3 uses
  %i.ju = icmp eq i64 %i.jr, %i.jt
  %i.jv = getelementptr inbounds i8, ptr %.2355.pn, i64 -72
  %i.jw = load i64, ptr %i.jv, align 8, !tbaa !96 ; 4 uses
  br i1 %i.ju, label %bb.bg, label %bb.bh

bb.bg:                                            ; preds = %bb.bf
  %i.jx = getelementptr inbounds nuw i8, ptr %.2355503, i64 16
  store i64 %i.jw, ptr %i.jx, align 8, !tbaa !96
  br label %bb.bi

bb.bh:                                            ; preds = %bb.bf
  %i.jy = getelementptr inbounds nuw i8, ptr %.2355503, i64 8
  %i.jz = load i64, ptr %i.jy, align 8, !tbaa !97
  %i.ka = sub nsw i64 %i.jz, %i.jt
  %i.kb = getelementptr inbounds nuw i8, ptr %.2355.pn408, i64 104
  ...
  %i.kh = getelementptr inbounds nuw i8, ptr %.2355503, i64 16
  store i64 %i.kg, ptr %i.kh, align 8, !tbaa !96
  %.pre516 = load i8, ptr %i.in, align 8, !tbaa !202
  br label %bb.bi

.thread562:                                       ; preds = %bb.bc, %bb.be
  %i.ki = getelementptr inbounds nuw i8, ptr %.7505, i64 16
  %i.kj = load i64, ptr %i.ki, align 8, !tbaa !96
  %i.kk = getelementptr inbounds nuw i8, ptr %.2355503, i64 8
  %i.kl = load i64, ptr %i.kk, align 8, !tbaa !97
  %i.km = getelementptr inbounds nuw i8, ptr %.7505, i64 8
  ...
  %i.ks = getelementptr inbounds nuw i8, ptr %.2355503, i64 16
  store i64 %i.kr, ptr %i.ks, align 8, !tbaa !96
  br label %bb.bi

bb.bi:                                            ; preds = %.thread562, %bb.bg, %bb.bh, %bb.ba, %bb.az
  %i.kt = phi i64 [ %i.jb, %bb.az ], [ %i.jg, %bb.ba ], [ %i.kg, %bb.bh ], [ %i.jw, %bb.bg ], [ %i.kr, %.thread562 ] ; 7 uses
  %i.ku = phi i8 [ %i.io, %bb.az ], [ %i.io, %bb.ba ], [ %.pre516, %bb.bh ], [ %i.io, %bb.bg ], [ %i.io, %.thread562 ]
  %.8 = phi ptr [ %.7505, %bb.az ], [ %.2355503, %bb.ba ], [ %.7505, %bb.bh ], [ %.7505, %bb.bg ], [ %.7505, %.thread562 ] ; 7 uses
  %i.kv = or i8 %i.ku, 4
  store i8 %i.kv, ptr %i.in, align 8, !tbaa !202
  %i.kw = icmp ugt ptr %.2355503, %i.e
  br i1 %i.kw, label %bb.bj, label %bb.bp

bb.bj:                                            ; preds = %bb.bi
  %i.kx = getelementptr inbounds i8, ptr %.2355503, i64 -72
  %i.ky = load i64, ptr %i.kx, align 8, !tbaa !96 ; 5 uses
  br i1 %.0348459, label %bb.bl, label %bb.bk
...
bb.bm:                                            ; preds = %bb.bl, %bb.bk
  %i.lb = getelementptr inbounds nuw i8, ptr %.2355503, i64 48
...
bb.bo:                                            ; preds = %bb.bn
  %i.li = getelementptr inbounds nuw i8, ptr %.2355503, i64 16
...
bb.bp:                                            ; preds = %bb.bm, %bb.bn, %bb.bo, %bb.bl, %bb.bk, %bb.bi
  ...
  %i.lk = getelementptr inbounds nuw i8, ptr %.2355503, i64 88
  %i.ll = icmp ult ptr %i.lk, %i.j
  br i1 %i.ll, label %bb.bq, label %bb.bx

bb.bq:                                            ; preds = %bb.bp
  %i.lm = getelementptr inbounds nuw i8, ptr %.2355503, i64 112
...
bb.br:                                            ; preds = %bb.bq
  %i.lp = getelementptr inbounds nuw i8, ptr %.2355503, i64 104
  %i.lq = load i64, ptr %i.lp, align 8, !tbaa !96 ; 3 uses
  br i1 %.0348459, label %bb.bt, label %bb.bs
...
bb.bu:                                            ; preds = %bb.bt, %bb.bs
  %i.lt = getelementptr inbounds nuw i8, ptr %.2355503, i64 48
...
bb.bv:                                            ; preds = %bb.bu
  ...
  %i.lx = getelementptr inbounds i8, ptr %.2355503, i64 -72
...
bb.bw:                                            ; preds = %bb.bv
  %i.mc = getelementptr inbounds nuw i8, ptr %.2355503, i64 16
  store i64 %i.lq, ptr %i.mc, align 8, !tbaa !96
  br label %bb.bx

bb.bx:                                            ; preds = %bb.bp, %bb.bq, %bb.bs, %bb.bt, %bb.bw, %bb.bv, %bb.bu, %.lr.ph506
  %.9 = phi ptr [ %.7505, %.lr.ph506 ], [ %.8, %bb.bu ], [ %.8, %bb.bv ], [ %.8, %bb.bw ], [ %.8, %bb.bt ], [ %.8, %bb.bs ], [ %.8, %bb.bq ], [ %.8, %bb.bp ]
  %i.md = getelementptr inbounds nuw i8, ptr %.2355503, i64 88 ; 2 uses
