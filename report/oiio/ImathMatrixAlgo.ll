...
bb.c:                                             ; preds = %.thread.i.i, %bb.b
  ...
  %6 = load float, ptr %1, align 4, !tbaa !26
  ...
  %i.ew = shufflevector <2 x float> %7, <2 x float> poison, <2 x i32> zeroinitializer
  ...
  %8 = load float, ptr %i.u, align 4, !tbaa !26
  ...
  %i.fe = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
