...
bb.d:                                             ; preds = %.unr-lcssa, %.preheader227.epil.preheader
  %.lcssa430 = phi <2 x double> [ %i.ad, %.unr-lcssa ], [ %i.p, %.preheader227.epil.preheader ]
...
.loopexit229:                                     ; preds = %.loopexit229.loopexit, %bb.d
  ...
  %.sroa.22.2.a = phi double [ %20, %bb.d ], [ %41, %.loopexit229.loopexit ]
  %.sroa.26.2.a = phi double [ %19, %bb.d ], [ %i.bb, %.loopexit229.loopexit ]
  %.1.a = phi double [ %18, %bb.d ], [ %i.bc, %.loopexit229.loopexit ]
  %.1 = phi double [ %17, %bb.d ], [ %42, %.loopexit229.loopexit ] ; 6 uses
  %i.bf = phi <2 x double> [ %.lcssa430, %bb.d ], [ %i.be, %.loopexit229.loopexit ]
...
bb.f:                                             ; preds = %.loopexit229
  %43 = fdiv double %.sroa.22.2.a, %.1            ; 5 uses
  %44 = fdiv double %.sroa.26.2.a, %.1            ; 5 uses
  %45 = fdiv double %.1.a, %.1                    ; 5 uses
