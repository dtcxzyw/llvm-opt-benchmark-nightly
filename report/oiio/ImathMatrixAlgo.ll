...
bb.d:                                             ; preds = %.unr-lcssa, %.preheader227.epil.preheader
  %.lcssa430 = phi <2 x double> [ %26, %.unr-lcssa ], [ %12, %.preheader227.epil.preheader ]
...
.loopexit229:                                     ; preds = %.loopexit229.loopexit, %bb.d
  %.sroa.22.2.a = phi double [ %.lcssa427, %bb.d ], [ %i.ba, %.loopexit229.loopexit ]
  %.sroa.26.2.a = phi double [ %.lcssa429, %bb.d ], [ %i.bb, %.loopexit229.loopexit ]
  %.1.a = phi double [ %15, %bb.d ], [ %i.bc, %.loopexit229.loopexit ] ; 4 uses
  %32 = phi <2 x double> [ %.lcssa428, %bb.d ], [ %i.be, %.loopexit229.loopexit ]
  %i.bf = phi <2 x double> [ %.lcssa430, %bb.d ], [ %31, %.loopexit229.loopexit ]
  %i.bg = fcmp oeq double %.1.a, 0.000000e+00
