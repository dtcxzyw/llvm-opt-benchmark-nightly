...
call.1.us.us.preheader.1.i.i:                     ; preds = %bb.ab
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 16 dereferenceable(4096) %i.c, i8 -1, i64 4096, i1 false)
  br label %bb.y

bb.y:                                             ; preds = %10, %call.1.us.us.preheader.1.i.i
  %indvars.iv.i.i.a = phi i64 [ 0, %call.1.us.us.preheader.1.i.i ], [ %indvars.iv.next335.1.i.i, %10 ] ; 3 uses
  %i.if = getelementptr inbounds nuw [4 x i8], ptr %i.bo, i64 %indvars.iv.i.i.a
  %i.ig = load i32, ptr %i.if, align 4, !tbaa !3
  %7 = and i32 %i.ig, 16777215
  %8 = mul i32 %7, -72723225
  %9 = lshr i32 %8, 21
  %i.ih = zext nneg i32 %9 to i64
  ...
  br i1 %.not.us.i.i, label %10, label %.lr.ph.us.1.i.i

10:                                               ; preds = %bb.y
  %11 = trunc i64 %indvars.iv.i.i.a to i16
  store i16 %11, ptr %i.ii, align 2, !tbaa !102
  %indvars.iv.next335.1.i.i = add nuw nsw i64 %indvars.iv.i.i.a, 1 ; 2 uses
  %exitcond338.1.not.i.i = icmp eq i64 %indvars.iv.next335.1.i.i, %wide.trip.count.i.i.a
  br i1 %exitcond338.1.not.i.i, label %bb.aj, label %bb.y, !llvm.loop !104
...
begin_hunk_1_@EncodeStreamHook:bb.a
  ...
  br i1 %.not.us.1.i.i, label %bb.aa, label %bb.au
...
bb.aa:                                            ; preds = %bb.z
  ...
  br i1 %exitcond.1.not.i.i, label %.loopexit232.i.i, label %bb.z, !llvm.loop !104

bb.ab:                                            ; preds = %bb.ac, %.split.us.i.i
  %indvars.iv.2.i.i = phi i64 [ 0, %.split.us.i.i ], [ %indvars.iv.next.i.i.a, %bb.ac ] ; 3 uses
  %i.it = getelementptr inbounds nuw [4 x i8], ptr %i.bo, i64 %indvars.iv.2.i.i
  %i.iu = load i32, ptr %i.it, align 4, !tbaa !3
  %12 = lshr i32 %i.iu, 8
  %13 = and i32 %12, 255
  %i.iv = zext nneg i32 %13 to i64
  ...
  br i1 %.not.us.2.i.i, label %bb.ac, label %call.1.us.us.preheader.1.i.i

bb.ac:                                            ; preds = %bb.ab
  %i.iy = trunc i64 %indvars.iv.2.i.i to i16
  store i16 %i.iy, ptr %i.iw, align 2, !tbaa !102
  %indvars.iv.next.i.i.a = add nuw nsw i64 %indvars.iv.2.i.i, 1 ; 2 uses
  %exitcond.not.i.i.a = icmp eq i64 %indvars.iv.next.i.i.a, %wide.trip.count.i.i.a
  br i1 %exitcond.not.i.i.a, label %bb.ad, label %bb.ab, !llvm.loop !104
