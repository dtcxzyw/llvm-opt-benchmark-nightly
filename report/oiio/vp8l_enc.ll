...
call.1.us.us.1.i.i:                               ; preds = %10, %call.1.us.us.preheader.1.i.i
  %indvars.iv334.1.i.i = phi i64 [ 0, %call.1.us.us.preheader.1.i.i ], [ %indvars.iv.next335.1.i.i, %10 ] ; 3 uses
  ...
  br i1 %.not.us243.us.1.i.i, label %10, label %call.2.us.us.preheader.2.i.i

10:                                               ; preds = %call.1.us.us.1.i.i
  %11 = trunc i64 %indvars.iv334.1.i.i to i16
  ...
  br i1 %exitcond338.1.not.i.i, label %bb.ag, label %call.1.us.us.1.i.i, !llvm.loop !104
...
begin_hunk_1_@EncodeStreamHook:bb.a
  ...
  br i1 %.not.us249.us.2.i.i, label %bb.y, label %bb.ar
...
bb.y:                                             ; preds = %call.2.us.us.2.i.i
  ...
  br i1 %exitcond.2.not.i.i.a, label %.loopexit232.i.i, label %call.2.us.us.2.i.i, !llvm.loop !104

call.0.us.us.i.i:                                 ; preds = %bb.z, %call.0.us.us.preheader.i.i
  %indvars.iv339.i.i = phi i64 [ 0, %call.0.us.us.preheader.i.i ], [ %indvars.iv.next340.i.i, %bb.z ] ; 3 uses
  ...
  br i1 %.not.us.us.i.i, label %bb.z, label %call.1.us.us.preheader.1.i.i

bb.z:                                             ; preds = %call.0.us.us.i.i
  %i.ix = trunc i64 %indvars.iv339.i.i to i16
  ...
  br i1 %exitcond343.not.i.i, label %bb.aa, label %call.0.us.us.i.i, !llvm.loop !104
...
bb.ar:                                            ; preds = %call.2.us.us.2.i.i
