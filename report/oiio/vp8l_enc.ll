...
bb.y:                                             ; preds = %10, %call.1.us.us.preheader.1.i.i
  ...
  %7 = and i32 %i.if, 16777215
  %8 = mul i32 %7, -72723225
  %9 = lshr i32 %8, 21
  %i.ig = zext nneg i32 %9 to i64
...
10:                                               ; preds = %bb.y
  ...
  store i16 %11, ptr %i.ih, align 2, !tbaa !102
...
bb.ac:                                            ; preds = %bb.ab
  %i.ix = trunc i64 %indvars.iv.2.i.i to i16
  store i16 %i.ix, ptr %i.iv, align 2, !tbaa !102
