...
bb.b:                                             ; preds = %bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %9) #7
  call void @llvm.lifetime.start.p0(ptr nonnull %10) #7
  %i.h = tail call ptr @WebPGetWorkerInterface() #7 ; 10 uses
...
bb.ag:                                            ; preds = %bb.ae, %bb.af
  ...
  call void %12(ptr noundef nonnull %5) #7
  ...
  call void %13(ptr noundef nonnull %4) #7
  %14 = load ptr, ptr %i.tg, align 8, !tbaa !71
  %15 = call i32 %14(ptr noundef nonnull %5) #7
  %i.tk = load ptr, ptr %i.tj, align 8, !tbaa !72
  call void %i.tk(ptr noundef nonnull %5) #7
...
.critedge:                                        ; preds = %bb.ab
  ...
  call void %19(ptr noundef nonnull %4) #7
  %20 = getelementptr inbounds nuw i8, ptr %i.h, i64 16
  %21 = load ptr, ptr %20, align 8, !tbaa !71
  %22 = call i32 %21(ptr noundef nonnull %4) #7   ; 0 uses
  %23 = getelementptr inbounds nuw i8, ptr %i.h, i64 40
  %24 = load ptr, ptr %23, align 8, !tbaa !72
  call void %24(ptr noundef nonnull %4) #7
  br label %VP8LEncoderDelete.exit135
