...
begin_hunk_1
  ...
  %25 = alloca %struct.VP8LHashChain, align 8     ; 14 uses
  %.not = icmp eq i32 %4, 0
...
.critedge:                                        ; preds = %186, %852, %343, %CalculateBestCacheSize.exit.i, %1301, %1181, %BackwardRefsWithLocalCache.exit.thread.i, %BackwardRefsClone.exit.i, %BackwardRefsClone.exit196.i, %88
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %24) #12
  call void @llvm.lifetime.end.p0(ptr nonnull %23) #12
  %1375 = call i32 @WebPEncodingSetError(ptr noundef %11, i32 noundef 1) #12
  br label %1380

1376:                                             ; preds = %87, %GetBackwardReferencesLowEffort.exit.thread, %GetBackwardReferences.exit
  %1377 = load i32, ptr %13, align 4, !tbaa !3
  %1378 = add nsw i32 %1377, %12
  %1379 = call i32 @WebPReportProgress(ptr noundef %11, i32 noundef %1378, ptr noundef nonnull %13) #12
  br label %1380

1380:                                             ; preds = %.thread, %1376, %.critedge
  %.1 = phi i32 [ %1379, %1376 ], [ %83, %.thread ], [ %1375, %.critedge ]
  ret i32 %.1
}
