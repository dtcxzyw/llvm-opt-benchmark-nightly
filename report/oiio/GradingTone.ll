...
bb.d:                                             ; preds = %bb.b
  ...
  %4 = extractelement <2 x double> %i.ah, i64 1
  %i.aj = fmul double %i.ad, %4                   ; 2 uses
  %i.ak = fmul double %i.p, %i.aj
  %5 = fmul double %i.p, %i.ak
  %i.al = tail call double @llvm.fmuladd.f64(double %1, double %i.t, double %5)
  %6 = tail call double @llvm.fmuladd.f64(double %i.r, double %i.o, double %i.al)
  %i.am = fadd double %i.ai, -1.000000e+00
  %i.an = fmul double %i.f, %i.am
  %i.ao = fmul double %i.ai, %i.an
  %i.ap = extractelement <2 x double> %i.ah, i64 0
  %i.aq = fsub double 1.000000e+00, %i.ap         ; 2 uses
  %i.ar = fmul double %i.aq, %i.aj
  %i.as = fsub double 2.000000e+00, %i.ai
  %i.at = fmul double %2, %i.as
  %i.au = fmul double %i.ai, %i.at
  ...
  %i.ax = select i1 %i.j, double %6, double %i.aw
  br label %_ZN16OpenColorIO_v2_512_GLOBAL__N_116FauxCubicFwdEvalEdddddddd.exit
...
bb.e:                                             ; preds = %bb.a
  ...
  %i.bh = insertelement <2 x double> %i.bg, double %i.b, i64 1 ; 2 uses
  %9 = fsub <2 x double> %8, %i.bh                ; 8 uses
  %10 = extractelement <2 x double> %9, i64 0     ; 2 uses
  %11 = extractelement <2 x double> %9, i64 1     ; 3 uses
  %i.bi = fadd double %11, %10
  %i.bj = fdiv double 5.000000e-01, %i.bi
  %12 = fneg double %11
  %13 = fmul double %i.bf, %12
  %i.bk = insertelement <2 x double> poison, double %1, i64 0 ; 2 uses
  %i.bl = insertelement <2 x double> %i.bk, double %2, i64 1
  %i.bm = insertelement <2 x double> %9, double %13, i64 1
  %i.bn = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bl, <2 x double> splat (double 2.000000e+00), <2 x double> %i.bm) ; 2 uses
  ...
  %i.bp = tail call double @llvm.fmuladd.f64(double %i.bo, double %11, double %14)
  %i.bq = fmul double %i.bj, %i.bp                ; 5 uses
  %15 = fsub double %i.bq, %1
  %i.br = fsub double %15, %10
  %16 = insertelement <2 x double> %i.bk, double %i.bq, i64 1
  %i.bs = insertelement <2 x double> poison, double %0, i64 0
  %17 = shufflevector <2 x double> %i.bs, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bt = fsub <2 x double> %16, %17              ; 2 uses
  %i.bu = fmul double %i.bq, -2.000000e+00
  %i.bv = tail call double @llvm.fmuladd.f64(double %2, double 2.000000e+00, double %i.bu)
  %18 = fneg double %i.bf
  %i.bw = fsub double %i.bq, %2
  %i.bx = insertelement <2 x double> poison, double %18, i64 0
  %i.by = insertelement <2 x double> %i.bx, double %i.bf, i64 1
  %19 = shufflevector <2 x double> %9, <2 x double> poison, <2 x i32> <i32 1, i32 1>
  %i.bz = insertelement <2 x double> poison, double %i.bv, i64 0
  %i.ca = insertelement <2 x double> %i.bz, double %i.bw, i64 1
  %i.cb = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.by, <2 x double> %19, <2 x double> %i.ca) ; 3 uses
  %i.cc = insertelement <2 x double> %i.cb, double %i.br, i64 0
  %i.cd = fmul <2 x double> %i.cc, splat (double 4.000000e+00)
  %i.ce = fneg <2 x double> %i.bt
  %i.cf = fmul <2 x double> %i.cd, %i.ce
  %i.cg = shufflevector <2 x double> %9, <2 x double> %i.cb, <2 x i32> <i32 0, i32 2> ; 2 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  %20 = shufflevector <2 x double> %9, <2 x double> %i.cb, <2 x i32> <i32 0, i32 2>
  %21 = fsub <2 x double> %i.ct, %20
  %22 = fdiv <2 x double> %i.cq, %21
  %i.cu = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %22, <2 x double> %9, <2 x double> %i.bh) ; 2 uses
...
bb.d:                                             ; preds = %bb.b
  ...
  %5 = fmul double %i.k, %i.ak
  %i.al = tail call double @llvm.fmuladd.f64(double %1, double %i.p, double %5)
  %6 = tail call double @llvm.fmuladd.f64(double %i.n, double %i.j, double %i.al)
  %i.am = fadd double %i.ai, -1.000000e+00
  %i.an = fmul double %i.ai, %i.am
  %i.ao = extractelement <2 x double> %i.ah, i64 0
  %i.ap = fsub double 1.000000e+00, %i.ao         ; 2 uses
  %i.aq = fmul double %i.ap, %i.aj
  %i.ar = fsub double 2.000000e+00, %i.ai
  %i.as = fmul double %2, %i.ar
  %i.at = fmul double %i.ai, %i.as
  ...
  %i.aw = select i1 %i.i, double %6, double %i.av
  br label %_ZN16OpenColorIO_v2_512_GLOBAL__N_116FauxCubicFwdEvalEdddddddd.exit
...
bb.e:                                             ; preds = %bb.a
  ...
  %7 = insertelement <2 x double> poison, double %2, i64 1 ; 2 uses
  %8 = insertelement <2 x double> %7, double %i.b, i64 0
  %9 = insertelement <2 x double> poison, double %1, i64 0
  %10 = insertelement <2 x double> %9, double %i.b, i64 1 ; 2 uses
  %11 = fsub <2 x double> %8, %10                 ; 6 uses
  %12 = extractelement <2 x double> %11, i64 0    ; 2 uses
  %13 = extractelement <2 x double> %11, i64 1    ; 4 uses
  %i.ba = fadd double %13, %12
  %i.bb = fdiv double 5.000000e-01, %i.ba
  %i.bc = fneg double %13
  %i.bd = fneg double %i.az
  %i.be = insertelement <2 x double> poison, double %1, i64 0
  ...
  %i.bh = fmul double %12, %i.az                  ; 2 uses
  ...
  %foldExtExtBinop = fmul <2 x double> %11, %i.bm
  %14 = extractelement <2 x double> %foldExtExtBinop, i64 0
  %i.bn = extractelement <2 x double> %i.bm, i64 1
  %i.bo = tail call double @llvm.fmuladd.f64(double %i.bn, double %13, double %14)
  ...
  %i.bu = insertelement <2 x double> %7, double %i.bd, i64 0
  %i.bv = insertelement <2 x double> %11, double 2.000000e+00, i64 1
  ...
  %foldExtExtBinop38 = fsub <2 x double> %i.by, %11
  %i.bz = fsub double %i.bp, %2
  %i.ca = fadd double %13, %i.bz
  ...
  %i.cf = insertelement <2 x double> %foldExtExtBinop38, double %i.bh, i64 0 ; 3 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.cw = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cv, <2 x double> %11, <2 x double> %10) ; 2 uses
...
bb.c:                                             ; preds = %bb.a, %bb.l
  ...
  %i.bd = getelementptr inbounds nuw [24 x i8], ptr %i.d, i64 %i.ar ; 5 uses
...
bb.h:                                             ; preds = %_ZN16OpenColorIO_v2_515GetChannelValueERKNS_13GradingRGBMSWENS_11RGBMChannelE.exit
  ...
  %4 = insertelement <2 x float> <float poison, float 1.000000e+00>, float %i.bm, i64 0
  %5 = insertelement <2 x float> <float -1.000000e+00, float poison>, float %i.bm, i64 1
  %6 = fsub <2 x float> %4, %5                    ; 9 uses
  store <2 x float> %6, ptr %i.bf, align 8, !tbaa !24
  %i.bn = insertelement <2 x float> %i.an, float %i.bm, i64 0
  %i.bo = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bn, <2 x float> <float 4.000000e-01, float 5.000000e-01>, <2 x float> %i.ao) ; 5 uses
  ...
  %i.bv = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.bt, <2 x float> <float 2.500000e-01, float 7.500000e-01>, <2 x float> %i.bu) ; 7 uses
  %i.bw = extractelement <2 x float> %i.bv, i64 1 ; 4 uses
  %i.bx = extractelement <2 x float> %i.bv, i64 0 ; 4 uses
  store <2 x float> %i.bv, ptr %i.au, align 8, !tbaa !24
  %i.by = extractelement <2 x float> %i.bo, i64 0 ; 2 uses
  store float %i.by, ptr %i.be, align 4, !tbaa !24
...
bb.i:                                             ; preds = %bb.h
  ...
  %foldExtExtBinop = fsub <2 x float> %6, %i.bo
  %7 = extractelement <2 x float> %foldExtExtBinop, i64 0
  %8 = tail call float @llvm.fmuladd.f32(float %7, float 5.000000e-01, float %i.cc)
  %9 = fmul float %8, %i.cf
  %10 = insertelement <2 x float> %i.bv, float %.sroa.speculated.i166, i64 0
  %11 = insertelement <2 x float> %i.bv, float %.sroa.speculated.i166, i64 1
  %12 = fsub <2 x float> %10, %11
  %13 = fadd <2 x float> %6, splat (float -1.000000e+00)
  %i.cg = fsub float %2, %i.bq                    ; 2 uses
  %i.ch = fmul float %i.cg, 5.000000e-01
  %i.ci = fsub float %i.bq, %i.bw                 ; 2 uses
  %14 = insertelement <2 x float> %6, float %i.ce, i64 0
  %15 = insertelement <2 x float> <float poison, float -1.000000e+00>, float %9, i64 0
  %16 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %14, <2 x float> splat (float 5.000000e-01), <2 x float> %15) ; 2 uses
  %17 = extractelement <2 x float> %16, i64 1
  %i.cj = fmul float %17, %i.ci
  %i.ck = fsub float %i.cj, %i.ch
  %18 = fmul <2 x float> %13, %12
  %19 = insertelement <2 x float> %16, float %i.ck, i64 1
  %20 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %18, <2 x float> splat (float 5.000000e-01), <2 x float> %19) ; 2 uses
  %shift = shufflevector <2 x float> %20, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop173 = fadd <2 x float> %shift, %20
  %21 = extractelement <2 x float> %foldExtExtBinop173, i64 0
  %i.cl = fsub float %2, %i.bw
  %i.cm = fmul float %i.cl, -5.000000e-01
  %i.cn = fdiv float %21, %i.cm                   ; 2 uses
...
bb.j:                                             ; preds = %bb.h
  ...
  %23 = insertelement <2 x float> %i.bv, float %.sroa.speculated.i166, i64 0
  %24 = insertelement <2 x float> %i.bv, float %.sroa.speculated.i166, i64 1
  %25 = fsub <2 x float> %23, %24
  %26 = fadd <2 x float> %6, splat (float -1.000000e+00)
  ...
  %i.cz = tail call float @llvm.fmuladd.f32(float %27, float 5.000000e-01, float -1.000000e+00)
  %i.da = fmul float %i.cz, %i.cy
  %i.db = fsub float %i.da, %i.cx
  %28 = fmul <2 x float> %26, %25
  %29 = insertelement <2 x float> poison, float %i.db, i64 0
  %30 = insertelement <2 x float> %29, float %i.cv, i64 1
  %31 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %28, <2 x float> splat (float 5.000000e-01), <2 x float> %30) ; 2 uses
  %shift175 = shufflevector <2 x float> %31, <2 x float> poison, <2 x i32> <i32 1, i32 poison>
  %foldExtExtBinop176 = fadd <2 x float> %31, %shift175
  %32 = extractelement <2 x float> %foldExtExtBinop176, i64 0
  %i.dc = fsub float %i.bx, %3
  %i.dd = fmul float %i.dc, -5.000000e-01
  %i.de = fdiv float %32, %i.dd                   ; 2 uses
  store float %i.de, ptr %i.be, align 4, !tbaa !24
  br label %bb.k
...
bb.k:                                             ; preds = %bb.j, %bb.i
  ...
  %33 = extractelement <2 x float> %6, i64 0      ; 2 uses
  %i.dk = fadd float %i.dg, %33
  ...
  %34 = extractelement <2 x float> %6, i64 1      ; 2 uses
  %i.dn = fadd float %33, %34
