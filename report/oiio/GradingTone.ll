...
bb.a:
  %4 = fsub double %2, %1
  %5 = tail call double @llvm.fmuladd.f64(double %4, double 5.000000e-01, double %1) ; 7 uses
...
bb.d:                                             ; preds = %bb.b
  %i.h = fcmp olt double %0, %5
  %i.i = fsub double %0, %5
  %i.j = fsub double %2, %5                       ; 5 uses
  %i.k = fneg double %i.j
  %i.l = fmul double %i.d, %i.k
  %i.m = fsub double %5, %1                       ; 5 uses
...
bb.e:                                             ; preds = %bb.a
  ...
  %6 = fsub double %2, %5                         ; 5 uses
  %7 = fneg double %6
  %8 = fneg double %i.bg
  %9 = insertelement <2 x double> poison, double %1, i64 0 ; 2 uses
  %10 = insertelement <2 x double> poison, double %0, i64 0
  %11 = shufflevector <2 x double> %10, <2 x double> poison, <2 x i32> zeroinitializer
  %12 = fsub double %5, %1                        ; 5 uses
  %i.bh = fmul double %i.bg, %7
  %13 = fadd double %6, %12
  ...
  %15 = insertelement <2 x double> poison, double %i.bh, i64 0
  %16 = insertelement <2 x double> %15, double %12, i64 1
  %17 = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bj, <2 x double> splat (double 2.000000e+00), <2 x double> %16) ; 2 uses
  %18 = extractelement <2 x double> %17, i64 0
  %19 = fmul double %12, %18
  %20 = extractelement <2 x double> %17, i64 1
  %i.bk = tail call double @llvm.fmuladd.f64(double %20, double %6, double %19)
  %i.bl = fmul double %14, %i.bk                  ; 5 uses
  %i.bm = fsub double %i.bl, %1
  %i.bn = insertelement <2 x double> %9, double %i.bl, i64 1
  %i.bo = fsub <2 x double> %i.bn, %11            ; 2 uses
  ...
  %i.bs = fsub double %i.bm, %12
  %21 = insertelement <2 x double> poison, double %8, i64 0
  %i.bt = insertelement <2 x double> %21, double %i.bg, i64 1
  %i.bu = insertelement <2 x double> poison, double %6, i64 0
  %22 = shufflevector <2 x double> %i.bu, <2 x double> poison, <2 x i32> zeroinitializer
  %i.bv = insertelement <2 x double> poison, double %i.bq, i64 0
  %i.bw = insertelement <2 x double> %i.bv, double %i.br, i64 1
  %i.bx = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.bt, <2 x double> %22, <2 x double> %i.bw) ; 2 uses
  ...
  %23 = insertelement <2 x double> poison, double %12, i64 0 ; 2 uses
  %i.cc = shufflevector <2 x double> %23, <2 x double> %i.bx, <2 x i32> <i32 0, i32 2> ; 3 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  %i.cs = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cr, <2 x double> %24, <2 x double> %25) ; 2 uses
...
bb.d:                                             ; preds = %bb.b
  %i.g = fcmp olt double %0, %5
  %i.h = fsub double %5, %1                       ; 5 uses
...
bb.e:                                             ; preds = %bb.a
  ...
  %6 = fsub double %2, %5                         ; 6 uses
  %7 = fsub double %5, %1                         ; 5 uses
  %i.bb = fadd double %6, %7
  %i.bc = fdiv double 5.000000e-01, %i.bb
  %i.bd = fneg double %6
  %i.be = fneg double %i.ba
  %i.bf = insertelement <2 x double> poison, double %1, i64 0 ; 2 uses
  ...
  %i.bi = fmul double %7, %i.ba                   ; 2 uses
  ...
  %8 = extractelement <2 x double> %i.bn, i64 0
  %9 = fmul double %7, %8
  %i.bo = extractelement <2 x double> %i.bn, i64 1
  %i.bp = tail call double @llvm.fmuladd.f64(double %i.bo, double %6, double %9)
  ...
  %i.bx = insertelement <2 x double> <double poison, double 2.000000e+00>, double %7, i64 0
  ...
  %10 = extractelement <2 x double> %i.ca, i64 1
  %11 = fsub double %10, %6
  %i.cb = fsub double %i.bq, %2
  %i.cc = fadd double %6, %i.cb
  ...
  %i.ch = insertelement <2 x double> %12, double %11, i64 1 ; 3 uses
...
bb.g:                                             ; preds = %bb.e
  ...
  %15 = insertelement <2 x double> %i.bf, double %5, i64 1
  %i.cy = tail call <2 x double> @llvm.fmuladd.v2f64(<2 x double> %i.cx, <2 x double> %14, <2 x double> %15) ; 2 uses
