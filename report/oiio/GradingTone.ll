...
bb.a:
  ...
  %i.b = fcmp une <4 x double> %i.a, splat (double 1.000000e+00)
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.g = fcmp une <4 x double> %i.f, splat (double 1.000000e+00)
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.l = fcmp une <4 x double> %i.k, splat (double 1.000000e+00)
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.q = fcmp une <4 x double> %i.p, splat (double 1.000000e+00)
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.v = fcmp une <4 x double> %i.u, splat (double 1.000000e+00)
