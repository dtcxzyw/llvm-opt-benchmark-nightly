...
define linkonce_odr hidden ptr @_ZN3fmt3v126detail14format_decimalIcjNS0_14basic_appenderIcEETnNSt9enable_ifIXntsr3std10is_pointerINSt9remove_cvINSt16remove_referenceIT1_E4typeEE4typeEEE5valueEiE4typeELi0EEES8_S8_T0_i(ptr %0, i32 noundef %1, i32 noundef %2) local_unnamed_addr #4 {
bb.a:
...
_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i: ; preds = %bb.a
  ...
  tail call void %i.j(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.e), !inline_history !106
  %.pre.i = load i64, ptr %i.c, align 8, !tbaa !53 ; 2 uses
  %.pre14.i = load i64, ptr %i.f, align 8, !tbaa !54
...
_ZN3fmt3v126detail10to_pointerIcEEPT_NS0_14basic_appenderIS3_EEm.exit: ; preds = %bb.a, %_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i
  ...
  store i64 %.pre-phi19.i, ptr %i.c, align 8, !tbaa !53
...
.lr.ph.i:                                         ; preds = %bb.b, %.lr.ph.i
  ...
  br i1 %i.y, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !82
...
bb.d:                                             ; preds = %._crit_edge.i
  ...
  store i8 %i.ai, ptr %i.al, align 1, !tbaa !15
  br label %_ZN3fmt3v126detail17do_format_decimalIcjEEPT_S4_T0_i.exit
...
.lr.ph.i16:                                       ; preds = %_ZN3fmt3v126detail10to_pointerIcEEPT_NS0_14basic_appenderIS3_EEm.exit.thread, %.lr.ph.i16
  ...
  br i1 %i.aw, label %.lr.ph.i16, label %._crit_edge.i12, !llvm.loop !82
...
bb.f:                                             ; preds = %._crit_edge.i12
  ...
  store i8 %i.bg, ptr %i.bj, align 1, !tbaa !15
  br label %_ZN3fmt3v126detail17do_format_decimalIcjEEPT_S4_T0_i.exit19
...
define linkonce_odr hidden ptr @_ZN3fmt3v126detail13copy_noinlineIcPcNS0_14basic_appenderIcEEEET1_T0_S7_S6_(ptr noundef %0, ptr noundef %1, ptr %2) local_unnamed_addr #15 {
bb.a:
...
.lr.ph34.i.i:                                     ; preds = %bb.a
  ...
  %.pre.i.i = load i64, ptr %i.a, align 8, !tbaa !53
  br label %bb.b
...
bb.b:                                             ; preds = %._crit_edge.i.i, %.lr.ph34.i.i
  ...
  %i.f = load i64, ptr %i.b, align 8, !tbaa !54
  %i.g = sub i64 %i.f, %i.e
...
bb.c:                                             ; preds = %bb.b
  ...
  %i.l = add i64 %i.i, %i.e
  tail call void %i.k(ptr noundef nonnull align 8 dereferenceable(32) %2, i64 noundef %i.l), !inline_history !108
  %i.m = load i64, ptr %i.a, align 8, !tbaa !53   ; 2 uses
  %i.n = load i64, ptr %i.b, align 8, !tbaa !54
  %i.o = sub i64 %i.n, %i.m
...
bb.d:                                             ; preds = %bb.c, %bb.b
  ...
  %i.q = load ptr, ptr %2, align 8, !tbaa !51     ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.v, align 1, !tbaa !15
  %wide.load8 = load <16 x i8>, ptr %i.w, align 1, !tbaa !15
  %i.x = getelementptr inbounds nuw i8, ptr %i.s, i64 %index ; 2 uses
  %i.y = getelementptr inbounds nuw i8, ptr %i.x, i64 16
  store <16 x i8> %wide.load, ptr %i.x, align 1, !tbaa !15
  store <16 x i8> %wide.load8, ptr %i.y, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.z = icmp eq i64 %index.next, %n.vec
  br i1 %i.z, label %middle.block, label %vector.body, !llvm.loop !109
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load12 = load <4 x i8>, ptr %i.aa, align 1, !tbaa !15
  %i.ab = getelementptr inbounds nuw i8, ptr %i.s, i64 %index11
  store <4 x i8> %wide.load12, ptr %i.ab, align 1, !tbaa !15
  %index.next13 = add nuw i64 %index11, 4         ; 2 uses
  %i.ac = icmp eq i64 %index.next13, %n.vec10
  br i1 %i.ac, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !113
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !114
...
._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i = load i64, ptr %i.a, align 8, !tbaa !53
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.d
  ...
  store i64 %i.ak, ptr %i.a, align 8, !tbaa !53
  %i.al = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i = icmp eq ptr %i.al, %1
  br i1 %.not.i.i, label %_ZN3fmt3v126detail4copyIcPcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS7_T0_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit, label %bb.b, !llvm.loop !116
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i.3, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !117
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail5writeIcNS0_14basic_appenderIcEExTnNSt9enable_ifIXaaaasr11is_integralIT1_EE5valuentsr3std7is_sameIS6_bEE5valuentsr3std7is_sameIS6_T_EE5valueEiE4typeELi0EEET0_SA_S6_(ptr %0, i64 noundef %1) local_unnamed_addr #4 {
bb.a:
  ...
  %i.p = load i64, ptr %i.o, align 8, !tbaa !53   ; 2 uses
  %i.q = add i64 %i.n, %i.p                       ; 3 uses
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 16 ; 2 uses
  %i.s = load i64, ptr %i.r, align 8, !tbaa !54   ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i: ; preds = %bb.a
  ...
  tail call void %i.v(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.q), !inline_history !106
  %.pre.i = load i64, ptr %i.o, align 8, !tbaa !53 ; 3 uses
  %.pre14.i = load i64, ptr %i.r, align 8, !tbaa !54 ; 3 uses
...
_ZN3fmt3v126detail10to_pointerIcEEPT_NS0_14basic_appenderIS3_EEm.exit: ; preds = %bb.a, %_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i
  ...
  store i64 %.pre-phi19.i, ptr %i.o, align 8, !tbaa !53
  %i.z = load ptr, ptr %0, align 8, !tbaa !51     ; 2 uses
...
bb.c:                                             ; preds = %bb.b
  ...
  store i8 45, ptr %i.aa, align 1, !tbaa !15
  br label %bb.d
...
.lr.ph.i:                                         ; preds = %bb.d, %.lr.ph.i
  ...
  br i1 %i.al, label %.lr.ph.i, label %._crit_edge.i, !llvm.loop !85
...
bb.a:
  ...
  %i.b = load i32, ptr %i.a, align 4, !tbaa !139
  %i.c = zext i32 %i.b to i64
  %i.d = tail call i64 @llvm.usub.sat.i64(i64 %i.c, i64 %3) ; 4 uses
  %i.e = load i32, ptr %1, align 4, !tbaa !86     ; 2 uses
  %i.f = lshr i32 %i.e, 3
  %i.g = and i32 %i.f, 7
  %i.h = zext nneg i32 %i.g to i64
  %i.i = getelementptr inbounds nuw i8, ptr @.str.11, i64 %i.h
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void %i.aa(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.v), !inline_history !140
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ac = load i8, ptr %4, align 1, !tbaa !136, !range !69, !noundef !70
  %i.ad = trunc nuw i8 %i.ac to i1
  %i.ae = getelementptr inbounds nuw i8, ptr %4, i64 1
  %i.af = load i8, ptr %i.ae, align 1, !tbaa !138 ; 2 uses
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.ai = load i64, ptr %i.ah, align 8, !tbaa !53 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  tail call void %i.ao(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.aj), !inline_history !189
  %.pre.i.i.i = load i64, ptr %i.ah, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.g, %bb.f
  ...
  %i.aq = load ptr, ptr %.sroa.09.0, align 8, !tbaa !51
  store i64 %.pre-phi.i.i.i, ptr %i.ah, align 8, !tbaa !53
  %i.ar = getelementptr inbounds nuw i8, ptr %i.aq, i64 %i.ap
  store i8 %i.af, ptr %i.ar, align 1, !tbaa !15
  br label %_ZZN3fmt3v126detail10write_charIcNS0_14basic_appenderIcEEEET0_S5_T_RKNS0_12format_specsEENKUlS4_E_clES4_.exit
...
; Function Attrs: mustprogress noinline uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail4fillIcNS0_14basic_appenderIcEEEET0_S5_mRKNS0_11basic_specsE(ptr %0, i64 noundef %1, ptr noundef nonnull align 4 dereferenceable(8) %2) local_unnamed_addr #15 {
bb.a:
  %i.a = load i32, ptr %2, align 4, !tbaa !86
  %i.b = lshr i32 %i.a, 15
...
bb.b:                                             ; preds = %bb.a
  %i.g = load i8, ptr %i.f, align 4, !tbaa !15
...
bb.c:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %.lr.ph.i
  ...
  %i.k = load i64, ptr %i.h, align 8, !tbaa !53   ; 2 uses
  %i.l = add i64 %i.k, 1                          ; 3 uses
  %i.m = load i64, ptr %i.i, align 8, !tbaa !54
  %i.n = icmp ugt i64 %i.l, %i.m
  br i1 %i.n, label %bb.d, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i

bb.d:                                             ; preds = %bb.c
  %i.o = load ptr, ptr %i.j, align 8, !tbaa !55
  tail call void %i.o(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.l), !inline_history !190
  %.pre.i.i.i = load i64, ptr %i.h, align 8, !tbaa !53 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.d, %bb.c
  ...
  %i.q = load ptr, ptr %0, align 8, !tbaa !51
  store i64 %.pre-phi.i.i.i, ptr %i.h, align 8, !tbaa !53
  ...
  br i1 %exitcond.not.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEmcEET_S5_T0_RKT1_.exit, label %bb.c, !llvm.loop !191
...
.lr.ph34.i.i.preheader:                           ; preds = %.lr.ph
  %.pre.i.i.pre = load i64, ptr %i.u, align 8, !tbaa !53
...
bb.f:                                             ; preds = %._crit_edge.i.i, %.lr.ph34.i.i
  ...
  %i.z = load i64, ptr %i.v, align 8, !tbaa !54
...
bb.g:                                             ; preds = %bb.f
  %i.ae = load ptr, ptr %i.x, align 8, !tbaa !55
  %i.af = add i64 %i.ac, %i.y
  tail call void %i.ae(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.af), !inline_history !141
  %i.ag = load i64, ptr %i.u, align 8, !tbaa !53  ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load32 = load <16 x i8>, ptr %i.aq, align 1, !tbaa !15
  %i.ar = getelementptr inbounds nuw i8, ptr %i.am, i64 %index ; 2 uses
  %i.as = getelementptr inbounds nuw i8, ptr %i.ar, i64 16
  store <16 x i8> %wide.load, ptr %i.ar, align 1, !tbaa !15
  store <16 x i8> %wide.load32, ptr %i.as, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.at = icmp eq i64 %index.next, %n.vec
  br i1 %i.at, label %middle.block, label %vector.body, !llvm.loop !192
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load36 = load <4 x i8>, ptr %i.au, align 1, !tbaa !15
  %i.av = getelementptr inbounds nuw i8, ptr %i.am, i64 %index35
  store <4 x i8> %wide.load36, ptr %i.av, align 1, !tbaa !15
  %index.next37 = add nuw i64 %index35, 4         ; 2 uses
  %i.aw = icmp eq i64 %index.next37, %n.vec34
  br i1 %i.aw, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !193
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !194
...
._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i = load i64, ptr %i.u, align 8, !tbaa !53
  br label %._crit_edge.i.i
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.h
  ...
  store i64 %i.be, ptr %i.u, align 8, !tbaa !53
  %i.bf = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i = icmp eq ptr %i.bf, %i.t
  br i1 %.not.i.i, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit.loopexit, label %bb.f, !llvm.loop !116
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i.3, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !195
...
_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit.loopexit: ; preds = %._crit_edge.i.i
  ...
  br i1 %exitcond.not, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEmcEET_S5_T0_RKT1_.exit, label %.lr.ph34.i.i, !llvm.loop !196
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail18write_escaped_charIcNS0_14basic_appenderIcEEEET0_S5_T_(ptr %0, i8 noundef signext %1) local_unnamed_addr #4 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void %i.i(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.d), !inline_history !107
  %.pre.i.i = load i64, ptr %i.b, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit:          ; preds = %bb.a, %bb.b
  ...
  store i64 %.pre-phi.i.i, ptr %i.b, align 8, !tbaa !53
...
bb.d:                                             ; preds = %_ZN3fmt3v126detail12needs_escapeEj.exit
  ...
  store ptr %i.a, ptr %2, align 8, !tbaa !197
  %i.s = getelementptr inbounds nuw i8, ptr %2, i64 8
  %i.t = getelementptr inbounds nuw i8, ptr %i.a, i64 1
  store ptr %i.t, ptr %i.s, align 8, !tbaa !199
  %i.u = getelementptr inbounds nuw i8, ptr %2, i64 16
  store i32 %i.m, ptr %i.u, align 8, !tbaa !200
...
bb.e:                                             ; preds = %_ZN3fmt3v126detail12needs_escapeEj.exit
  %i.w = load i64, ptr %i.b, align 8, !tbaa !53   ; 2 uses
  %i.x = add i64 %i.w, 1                          ; 3 uses
  %i.y = load i64, ptr %i.e, align 8, !tbaa !54
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.ab(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.x), !inline_history !107
  %.pre.i.i15 = load i64, ptr %i.b, align 8, !tbaa !53 ; 2 uses
end_hunk_1
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZNK3fmt3v126detail14digit_groupingIcE5applyINS0_14basic_appenderIcEEcEET_S7_NS0_17basic_string_viewIT0_EE(ptr noundef nonnull align 8 dereferenceable(64) %0, ptr %1, ptr %2, i64 %3) local_unnamed_addr #4 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %4 = alloca %"class.fmt::v12::basic_memory_buffer.8", align 8 ; 13 uses
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIiLm500ENS0_6detail9allocatorIiEEE4growERNS2_6bufferIiEEm, ptr %i.c, align 8, !tbaa !204
  %i.e = getelementptr inbounds nuw i8, ptr %4, i64 32 ; 6 uses
  store ptr %i.e, ptr %4, align 8, !tbaa !206
  store i64 500, ptr %i.b, align 8, !tbaa !207
  store i64 1, ptr %i.d, align 8, !tbaa !208
  store i32 0, ptr %i.e, align 8, !tbaa !3
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 40 ; 3 uses
  %i.g = load i64, ptr %i.f, align 8, !tbaa !152  ; 2 uses
  %i.h = icmp eq i64 %i.g, 0
  br i1 %i.h, label %_ZNK3fmt3v126detail14digit_groupingIcE4nextERNS3_10next_stateE.exit.thread, label %.lr.ph

.lr.ph:                                           ; preds = %bb.a
  %i.i = load ptr, ptr %0, align 8, !tbaa !131
...
bb.b:                                             ; preds = %.lr.ph, %bb.i
  ...
  %i.o = load i64, ptr %i.j, align 8, !tbaa !152
...
bb.c:                                             ; preds = %bb.b
  ...
  %.sink.i.pre = load i8, ptr %i.r, align 1, !tbaa !15
  br label %_ZNK3fmt3v126detail14digit_groupingIcE4nextERNS3_10next_stateE.exit

bb.d:                                             ; preds = %bb.b
  %i.s = load i8, ptr %.sroa.039.055, align 1, !tbaa !15 ; 2 uses
  %i.t = add i8 %i.s, -127
...
bb.g:                                             ; preds = %_ZNK3fmt3v126detail14digit_groupingIcE4nextERNS3_10next_stateE.exit
  ...
  %i.z = load i64, ptr %i.b, align 8, !tbaa !207
  %i.aa = icmp ugt i64 %i.y, %i.z
  br i1 %i.aa, label %bb.h, label %bb.i

bb.h:                                             ; preds = %bb.g
  %i.ab = load ptr, ptr %i.c, align 8, !tbaa !204
  invoke void %i.ab(ptr noundef nonnull align 8 dereferenceable(32) %4, i64 noundef %i.y)
          to label %.noexc31 unwind label %bb.f, !inline_history !209

.noexc31:                                         ; preds = %bb.h
  %.pre.i29 = load i64, ptr %i.d, align 8, !tbaa !208 ; 2 uses
  %.pre2.i30 = add i64 %.pre.i29, 1
  %.pre = load ptr, ptr %4, align 8, !tbaa !206
  %.pre63 = load i64, ptr %i.f, align 8, !tbaa !152
  br label %bb.i
...
bb.i:                                             ; preds = %.noexc31, %bb.g
  ...
  store i64 %.pre-phi.i28, ptr %i.d, align 8, !tbaa !208
...
._crit_edge.loopexit:                             ; preds = %bb.s
  %.pre64 = load ptr, ptr %4, align 8, !tbaa !206
  br label %._crit_edge
...
bb.k:                                             ; preds = %.lr.ph60, %bb.s
  ...
  %i.au = load ptr, ptr %4, align 8, !tbaa !206
...
bb.l:                                             ; preds = %bb.k
  %i.ba = load ptr, ptr %i.ao, align 8, !tbaa !131 ; 2 uses
  %i.bb = load i64, ptr %i.f, align 8, !tbaa !152 ; 2 uses
...
.lr.ph34.i.i:                                     ; preds = %bb.l
  ...
  %.pre.i.i = load i64, ptr %i.ap, align 8, !tbaa !53
  br label %bb.m
...
bb.m:                                             ; preds = %._crit_edge.i.i, %.lr.ph34.i.i
  ...
  %i.bf = load i64, ptr %i.aq, align 8, !tbaa !54
...
bb.n:                                             ; preds = %bb.m
  %i.bk = load ptr, ptr %i.ar, align 8, !tbaa !55
  %i.bl = add i64 %i.bi, %i.be
  invoke void %i.bk(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.bl)
          to label %.noexc34 unwind label %bb.p, !inline_history !210

.noexc34:                                         ; preds = %bb.n
  %i.bm = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
  %i.bn = load i64, ptr %i.aq, align 8, !tbaa !54
...
bb.o:                                             ; preds = %.noexc34, %bb.m
  ...
  %i.bq = load ptr, ptr %1, align 8, !tbaa !51    ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.bv, align 1, !tbaa !15
  %wide.load78 = load <16 x i8>, ptr %i.bw, align 1, !tbaa !15
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bs, i64 %index ; 2 uses
  %i.by = getelementptr inbounds nuw i8, ptr %i.bx, i64 16
  store <16 x i8> %wide.load, ptr %i.bx, align 1, !tbaa !15
  store <16 x i8> %wide.load78, ptr %i.by, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load82 = load <4 x i8>, ptr %i.ca, align 1, !tbaa !15
  %i.cb = getelementptr inbounds nuw i8, ptr %i.bs, i64 %index81
  store <4 x i8> %wide.load82, ptr %i.cb, align 1, !tbaa !15
  %index.next83 = add nuw i64 %index81, 4         ; 2 uses
  %i.cc = icmp eq i64 %index.next83, %n.vec80
  br i1 %i.cc, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !212
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !213
...
._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i = load i64, ptr %i.ap, align 8, !tbaa !53
  br label %._crit_edge.i.i
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.o
  ...
  store i64 %i.ck, ptr %i.ap, align 8, !tbaa !53
  %i.cl = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i33 = icmp eq ptr %i.cl, %i.bc
  br i1 %.not.i.i33, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit, label %bb.m, !llvm.loop !116
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  store i8 %i.cn, ptr %i.co, align 1, !tbaa !15
  ...
  br i1 %exitcond.not.i.i.3, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !214
...
bb.q:                                             ; preds = %bb.k, %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit
  ...
  %i.dg = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
  %i.dh = add i64 %i.dg, 1                        ; 3 uses
  %i.di = load i64, ptr %i.aq, align 8, !tbaa !54
  %i.dj = icmp ugt i64 %i.dh, %i.di
  br i1 %i.dj, label %bb.r, label %bb.s

bb.r:                                             ; preds = %bb.q
  %i.dk = load ptr, ptr %i.ar, align 8, !tbaa !55
  invoke void %i.dk(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.dh)
          to label %.noexc36 unwind label %bb.t, !inline_history !215

.noexc36:                                         ; preds = %bb.r
  %.pre.i.i35 = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
...
bb.s:                                             ; preds = %.noexc36, %bb.q
  ...
  %i.dm = load ptr, ptr %1, align 8, !tbaa !51
  store i64 %.pre-phi.i.i, ptr %i.ap, align 8, !tbaa !53
  %i.dn = getelementptr inbounds nuw i8, ptr %i.dm, i64 %i.dl
  store i8 %i.df, ptr %i.dn, align 1, !tbaa !15
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 1 ; 2 uses
  %exitcond.not = icmp eq i64 %indvars.iv.next, %wide.trip.count
  br i1 %exitcond.not, label %._crit_edge.loopexit, label %bb.k, !llvm.loop !216
...
bb.u:                                             ; preds = %bb.f, %bb.t, %bb.p
  ...
  %i.dp = load ptr, ptr %4, align 8, !tbaa !206   ; 2 uses
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden void @_ZN3fmt3v1219basic_memory_bufferIiLm500ENS0_6detail9allocatorIiEEE4growERNS2_6bufferIiEEm(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %1) #4 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
...
bb.d:                                             ; preds = %bb.a, %bb.b, %bb.c
  ...
  %i.h = load ptr, ptr %0, align 8, !tbaa !206    ; 3 uses
  %i.i = shl i64 %.0, 2
  %i.j = tail call noalias ptr @malloc(i64 noundef %i.i) #33 ; 3 uses
...
begin_hunk_3_@_ZN3fmt3v126detail12write_paddedIcLNS0_5alignE2ENS0_14basic_appenderIcEEZNS1_9write_intIS5_ocEET_S7_T0_jRKNS0_12format_specsERKNS1_14digit_groupingIT1_EEEUlS5_E_EESD_SD_SB_mmOT2_:bb.a
  ...
  %i.g = and i32 %i.f, 7
  %i.h = zext nneg i32 %i.g to i64
  %i.i = getelementptr inbounds nuw i8, ptr @.str.12, i64 %i.h
  %i.j = load i8, ptr %i.i, align 1, !tbaa !15
  %i.k = sext i8 %i.j to i64
  %i.l = and i64 %i.k, 4294967295
  %i.m = lshr i64 %i.d, %i.l                      ; 4 uses
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ac = load ptr, ptr %4, align 8, !tbaa !221, !nonnull !70, !align !166
...
bb.e:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %.lr.ph.i
  ...
  %i.aj = load i64, ptr %i.af, align 8, !tbaa !53 ; 2 uses
  %i.ak = add i64 %i.aj, 1                        ; 3 uses
  %i.al = load i64, ptr %i.ag, align 8, !tbaa !54
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.an(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ak), !inline_history !223
  %.pre.i.i.i = load i64, ptr %i.af, align 8, !tbaa !53 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.f, %bb.e
  ...
  %i.ap = load ptr, ptr %.sroa.09.0, align 8, !tbaa !51
  store i64 %.pre-phi.i.i.i, ptr %i.af, align 8, !tbaa !53
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 %i.ao
  store i8 %i.ai, ptr %i.aq, align 1, !tbaa !15
  %i.ar = lshr i32 %.07.i, 8                      ; 2 uses
  %.not.i = icmp eq i32 %i.ar, 0
  br i1 %.not.i, label %_ZZN3fmt3v126detail9write_intINS0_14basic_appenderIcEEocEET_S5_T0_jRKNS0_12format_specsERKNS1_14digit_groupingIT1_EEENKUlS4_E_clES4_.exit, label %bb.e, !llvm.loop !224
...
_ZZN3fmt3v126detail9write_intINS0_14basic_appenderIcEEocEET_S5_T0_jRKNS0_12format_specsERKNS1_14digit_groupingIT1_EEENKUlS4_E_clES4_.exit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %bb.d
  ...
  %i.at = load ptr, ptr %i.as, align 8, !tbaa !225, !nonnull !70, !align !187
  %i.au = getelementptr inbounds nuw i8, ptr %4, i64 16
  %i.av = load ptr, ptr %i.au, align 8, !tbaa !226, !nonnull !70, !align !187 ; 2 uses
  %i.aw = load ptr, ptr %i.av, align 8, !tbaa !51
  %i.ax = getelementptr inbounds nuw i8, ptr %i.av, i64 8
  %i.ay = load i64, ptr %i.ax, align 8, !tbaa !53
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  %.sroa.09.0 = phi ptr [ %i.ab, %bb.c ], [ %0, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit ] ; 7 uses
  %i.ac = load ptr, ptr %4, align 8, !tbaa !227   ; 2 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.ae = load i64, ptr %i.ad, align 8, !tbaa !228 ; 2 uses
...
.lr.ph34.i.i.i:                                   ; preds = %bb.d
  ...
  %.pre.i.i.i = load i64, ptr %i.ag, align 8, !tbaa !53
  br label %bb.e
...
bb.e:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.al = load i64, ptr %i.ah, align 8, !tbaa !54
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.aq(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ar), !inline_history !229
  %i.as = load i64, ptr %i.ag, align 8, !tbaa !53 ; 2 uses
  %i.at = load i64, ptr %i.ah, align 8, !tbaa !54
...
bb.g:                                             ; preds = %bb.f, %bb.e
  ...
  %i.aw = load ptr, ptr %.sroa.09.0, align 8, !tbaa !51 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.bb, align 1, !tbaa !15
  %wide.load36 = load <16 x i8>, ptr %i.bc, align 1, !tbaa !15
  %i.bd = getelementptr inbounds nuw i8, ptr %i.ay, i64 %index ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %i.bd, i64 16
  store <16 x i8> %wide.load, ptr %i.bd, align 1, !tbaa !15
  store <16 x i8> %wide.load36, ptr %i.be, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bf = icmp eq i64 %index.next, %n.vec
  br i1 %i.bf, label %middle.block, label %vector.body, !llvm.loop !230
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf, 0
  br i1 %min.epilog.iters.check, label %.lr.ph.i.i.i.preheader, label %vec.epilog.ph, !prof !112
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load40 = load <4 x i8>, ptr %i.bg, align 1, !tbaa !15
  %i.bh = getelementptr inbounds nuw i8, ptr %i.ay, i64 %index39
  store <4 x i8> %wide.load40, ptr %i.bh, align 1, !tbaa !15
  %index.next41 = add nuw i64 %index39, 4         ; 2 uses
  %i.bi = icmp eq i64 %index.next41, %n.vec38
  br i1 %i.bi, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !231
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !232
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.ag, align 8, !tbaa !53
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.g
  ...
  store i64 %i.bq, ptr %i.ag, align 8, !tbaa !53
  %i.br = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.br, %i.af
  br i1 %.not.i.i.i, label %_ZZN3fmt3v126detail11write_bytesIcLNS0_5alignE1ENS0_14basic_appenderIcEEEET1_S6_NS0_17basic_string_viewIcEERKNS0_12format_specsEENKUlS5_E_clES5_.exit, label %bb.e, !llvm.loop !116
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  store i8 %i.cf, ptr %i.cg, align 1, !tbaa !15
  %i.ch = add nuw i64 %.030.i.i.i, 4              ; 2 uses
  %exitcond.not.i.i.i.3 = icmp eq i64 %i.ch, %.026.i.i.i
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !233
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail5writeIcNS0_14basic_appenderIcEEfTnNSt9enable_ifIXsr13is_fast_floatIT1_EE5valueEiE4typeELi0EEET0_S9_S6_(ptr %0, float noundef %1) local_unnamed_addr #4 {
bb.a:
  %i.a = alloca [11 x i8], align 1                ; 8 uses
  %2 = alloca %"struct.fmt::v12::format_specs", align 8 ; 5 uses
  %3 = alloca %class.anon.23, align 8             ; 5 uses
...
_ZN3fmt3v126detail15write_nonfiniteIcNS0_14basic_appenderIcEEEET0_S5_bNS0_12format_specsENS0_4signE.exit: ; preds = %bb.a
  ...
  %i.h = select i1 %i.f, ptr @.str.16, ptr @.str.18
  %.not.not.i = icmp sgt i32 %i.b, -1
  %i.i = select i1 %.not.not.i, i64 3, i64 4      ; 2 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #29
  store i32 %.lobit, ptr %3, align 8, !tbaa !234
  %i.j = getelementptr inbounds nuw i8, ptr %3, i64 8
  store ptr %i.h, ptr %i.j, align 8, !tbaa !237
...
bb.c:                                             ; preds = %bb.b
  ...
  store i32 32768, ptr %5, align 4, !tbaa !86
  %i.ad = getelementptr inbounds nuw i8, ptr %5, i64 4
  store i8 32, ptr %i.ad, align 4, !tbaa !15
...
bb.k:                                             ; preds = %bb.j
  ...
  tail call void %i.au(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.ap), !inline_history !107
  %.pre.i.i27 = load i64, ptr %i.an, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit29:        ; preds = %bb.j, %bb.k
  ...
  %i.aw = load ptr, ptr %1, align 8, !tbaa !51
  store i64 %.pre-phi.i.i26, ptr %i.an, align 8, !tbaa !53
  %i.ax = getelementptr inbounds nuw i8, ptr %i.aw, i64 %i.av
  store i8 %i.am, ptr %i.ax, align 1, !tbaa !15
  br label %bb.l
...
bb.m:                                             ; preds = %bb.l
  ...
  tail call void %i.bj(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.be), !inline_history !107
  %.pre.i.i32 = load i64, ptr %i.bc, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit34:        ; preds = %bb.l, %bb.m
  ...
  %i.bl = load ptr, ptr %1, align 8, !tbaa !51
  store i64 %.pre-phi.i.i31, ptr %i.bc, align 8, !tbaa !53
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 %i.bk
  store i8 %i.bb, ptr %i.bm, align 1, !tbaa !15
  %i.bn = getelementptr inbounds nuw i8, ptr %i.ba, i64 1
  %i.bo = load i8, ptr %i.bn, align 1, !tbaa !15
  %i.bp = load i64, ptr %i.bc, align 8, !tbaa !53 ; 2 uses
  %i.bq = add i64 %i.bp, 1                        ; 3 uses
  %i.br = load i64, ptr %i.bf, align 8, !tbaa !54
...
bb.n:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit34
  ...
  tail call void %i.bu(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.bq), !inline_history !107
  %.pre.i.i37 = load i64, ptr %i.bc, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit39:        ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit34, %bb.n
  ...
  %i.bw = load ptr, ptr %1, align 8, !tbaa !51
  store i64 %.pre-phi.i.i36, ptr %i.bc, align 8, !tbaa !53
  %i.bx = getelementptr inbounds nuw i8, ptr %i.bw, i64 %i.bv
  store i8 %i.bo, ptr %i.bx, align 1, !tbaa !15
  ret ptr %1
}
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ac = load i32, ptr %4, align 8, !tbaa !234   ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !53 ; 2 uses
  %i.ai = add i64 %i.ah, 1                        ; 3 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %.sroa.09.0, i64 16
  %i.ak = load i64, ptr %i.aj, align 8, !tbaa !54
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.an(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ai), !inline_history !251
  %.pre.i.i.i = load i64, ptr %i.ag, align 8, !tbaa !53 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.f, %bb.e
  ...
  %i.ap = load ptr, ptr %.sroa.09.0, align 8, !tbaa !51
  store i64 %.pre-phi.i.i.i, ptr %i.ag, align 8, !tbaa !53
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 %i.ao
  store i8 %i.af, ptr %i.aq, align 1, !tbaa !15
  br label %bb.g

bb.g:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %bb.d
  %i.ar = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !237 ; 2 uses
  ...
  %.pre.i.i2.i = load i64, ptr %i.au, align 8, !tbaa !53
  br label %bb.h
...
bb.h:                                             ; preds = %._crit_edge.i.i.i, %bb.g
  ...
  %i.ay = load i64, ptr %i.av, align 8, !tbaa !54
...
bb.i:                                             ; preds = %bb.h
  %i.bb = load ptr, ptr %i.aw, align 8, !tbaa !55
  %i.bc = add i64 %gepdiff.i, %i.ax
  tail call void %i.bb(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.bc), !inline_history !252
  %i.bd = load i64, ptr %i.au, align 8, !tbaa !53 ; 2 uses
  %i.be = load i64, ptr %i.av, align 8, !tbaa !54
...
bb.j:                                             ; preds = %bb.i, %bb.h
  ...
  %i.bh = load ptr, ptr %.sroa.09.0, align 8, !tbaa !51 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load36 = load <16 x i8>, ptr %i.bo, align 1, !tbaa !15
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bj, i64 %index ; 2 uses
  %i.bq = getelementptr inbounds nuw i8, ptr %i.bp, i64 16
  store <16 x i8> %wide.load, ptr %i.bp, align 1, !tbaa !15
  store <16 x i8> %wide.load36, ptr %i.bq, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.br = icmp eq i64 %index.next, %n.vec
  br i1 %i.br, label %middle.block, label %vector.body, !llvm.loop !253
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load40 = load <4 x i8>, ptr %i.bs, align 1, !tbaa !15
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bj, i64 %index39
  store <4 x i8> %wide.load40, ptr %i.bt, align 1, !tbaa !15
  %index.next41 = add nuw i64 %index39, 4         ; 2 uses
  %i.bu = icmp eq i64 %index.next41, %n.vec38
  br i1 %i.bu, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !254
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.au, align 8, !tbaa !53
  br label %._crit_edge.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.j
  ...
  store i64 %i.cc, ptr %i.au, align 8, !tbaa !53
  %.02532.i.i.add.i = add nuw nsw i64 %.026.i.i.i, %.02532.i.i.idx.i ; 2 uses
  %.not.i.i.i = icmp eq i64 %.02532.i.i.add.i, 3
  br i1 %.not.i.i.i, label %_ZZN3fmt3v126detail15write_nonfiniteIcNS0_14basic_appenderIcEEEET0_S5_bNS0_12format_specsENS0_4signEENKUlS4_E_clES4_.exit, label %bb.h, !llvm.loop !116
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !256
...
bb.c:                                             ; preds = %bb.b
  ...
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.h), !inline_history !107
  %.pre.i.i = load i64, ptr %i.f, align 8, !tbaa !53 ; 2 uses
  %.pre2.i.i = add i64 %.pre.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit:          ; preds = %bb.b, %bb.c
  ...
  store i64 %.pre-phi.i.i, ptr %i.f, align 8, !tbaa !53
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 %i.n
  store i8 %i.e, ptr %i.p, align 1, !tbaa !15
  br label %bb.d

bb.d:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit, %bb.a
  %i.q = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.r = load ptr, ptr %i.q, align 8, !tbaa !259, !nonnull !70, !align !166 ; 2 uses
  %i.s = load i32, ptr %i.r, align 4, !tbaa !260
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.u = load ptr, ptr %i.t, align 8, !tbaa !261, !nonnull !70, !align !166
  %i.v = load i32, ptr %i.u, align 4, !tbaa !3
  %i.w = getelementptr inbounds nuw i8, ptr %i.r, i64 4
  %i.x = load i32, ptr %i.w, align 4, !tbaa !240  ; 2 uses
...
bb.e:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i.i, %.lr.ph.i.i
  ...
  %i.ad = load i64, ptr %i.aa, align 8, !tbaa !53 ; 2 uses
  %i.ae = add i64 %i.ad, 1                        ; 3 uses
  %i.af = load i64, ptr %i.ab, align 8, !tbaa !54
  %i.ag = icmp ugt i64 %i.ae, %i.af
  br i1 %i.ag, label %bb.f, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i.i

bb.f:                                             ; preds = %bb.e
  %i.ah = load ptr, ptr %i.ac, align 8, !tbaa !55
  tail call void %i.ah(ptr noundef nonnull align 8 dereferenceable(32) %i.y, i64 noundef %i.ae), !inline_history !262
  %.pre.i.i.i.i = load i64, ptr %i.aa, align 8, !tbaa !53 ; 2 uses
...
bb.f:                                             ; preds = %bb.d, %bb.e, %bb.a
  ...
  %.str.9..str.10.i.i = select i1 %.not90, ptr @.str.10, ptr @.str.9
  br label %.split.i.i
...
.split.i.i:                                       ; preds = %.split.i.i, %bb.f
  ...
  %i.ag = getelementptr inbounds nuw i8, ptr %.str.9..str.10.i.i, i64 %i.af
  ...
  br i1 %.not.i.i, label %_ZN3fmt3v126detail13format_base2eIcoEEPT_iS4_T0_ib.exit.preheader, label %.split.i.i, !llvm.loop !218
...
_ZN3fmt3v126detail13format_base2eIcoEEPT_iS4_T0_ib.exit: ; preds = %.lr.ph
  ...
  br i1 %.not91, label %.critedge, label %.lr.ph, !llvm.loop !322
...
.critedge:                                        ; preds = %.lr.ph, %_ZN3fmt3v126detail13format_base2eIcoEEPT_iS4_T0_ib.exit, %_ZN3fmt3v126detail13format_base2eIcoEEPT_iS4_T0_ib.exit.preheader
  ...
  %i.aq = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
  %i.ar = add i64 %i.aq, 1                        ; 3 uses
  %i.as = getelementptr inbounds nuw i8, ptr %3, i64 16 ; 9 uses
  %i.at = load i64, ptr %i.as, align 8, !tbaa !54
...
bb.g:                                             ; preds = %.critedge
  ...
  tail call void %i.aw(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ar), !inline_history !323
  %.pre.i = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit:  ; preds = %.critedge, %bb.g
  ...
  %i.ay = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i, ptr %i.ap, align 8, !tbaa !53
  %i.az = getelementptr inbounds nuw i8, ptr %i.ay, i64 %i.ax
  store i8 48, ptr %i.az, align 1, !tbaa !15
  %i.ba = select i1 %.not90, i8 120, i8 88
  %i.bb = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
  %i.bc = add i64 %i.bb, 1                        ; 3 uses
  %i.bd = load i64, ptr %i.as, align 8, !tbaa !54
...
bb.h:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit
  ...
  tail call void %i.bg(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bc), !inline_history !323
  %.pre.i40 = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit, %bb.h
  ...
  %i.bi = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i39, ptr %i.ap, align 8, !tbaa !53
  %i.bj = getelementptr inbounds nuw i8, ptr %i.bi, i64 %i.bh
  store i8 %i.ba, ptr %i.bj, align 1, !tbaa !15
  %i.bk = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
  %i.bl = add i64 %i.bk, 1                        ; 3 uses
  %i.bm = load i64, ptr %i.as, align 8, !tbaa !54
...
bb.i:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42
  ...
  %i.bp = load ptr, ptr %i.bo, align 8, !tbaa !55
  tail call void %i.bp(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bl), !inline_history !323
  %.pre.i44 = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42, %bb.i
  ...
  %i.br = load i8, ptr %i.a, align 16, !tbaa !15
  %i.bs = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i43, ptr %i.ap, align 8, !tbaa !53
...
bb.j:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46
  %i.bx = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
  %i.by = add i64 %i.bx, 1                        ; 3 uses
  %i.bz = load i64, ptr %i.as, align 8, !tbaa !54
...
bb.k:                                             ; preds = %bb.j
  ...
  tail call void %i.cc(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.by), !inline_history !323
  %.pre.i48 = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit50: ; preds = %bb.j, %bb.k
  ...
  %i.ce = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i47, ptr %i.ap, align 8, !tbaa !53
  %i.cf = getelementptr inbounds nuw i8, ptr %i.ce, i64 %i.cd
  store i8 46, ptr %i.cf, align 1, !tbaa !15
  br label %bb.l
...
.lr.ph34.i:                                       ; preds = %bb.l
  ...
  %.pre.i51 = load i64, ptr %i.ap, align 8, !tbaa !53
  br label %bb.m
...
bb.m:                                             ; preds = %._crit_edge.i, %.lr.ph34.i
  ...
  %i.cm = load i64, ptr %i.as, align 8, !tbaa !54
...
bb.n:                                             ; preds = %bb.m
  %i.cr = load ptr, ptr %i.ck, align 8, !tbaa !55
  %i.cs = add i64 %i.cp, %i.cl
  call void %i.cr(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.cs), !inline_history !324
  %i.ct = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
  %i.cu = load i64, ptr %i.as, align 8, !tbaa !54
...
bb.o:                                             ; preds = %bb.n, %bb.m
  ...
  %i.cx = load ptr, ptr %3, align 8, !tbaa !51    ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.dc, align 1, !tbaa !15
  %wide.load118 = load <16 x i8>, ptr %i.dd, align 1, !tbaa !15
  %i.de = getelementptr inbounds nuw i8, ptr %i.cz, i64 %index ; 2 uses
  %i.df = getelementptr inbounds nuw i8, ptr %i.de, i64 16
  store <16 x i8> %wide.load, ptr %i.de, align 1, !tbaa !15
  store <16 x i8> %wide.load118, ptr %i.df, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.dg = icmp eq i64 %index.next, %n.vec
  br i1 %i.dg, label %middle.block, label %vector.body, !llvm.loop !325
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load122 = load <4 x i8>, ptr %i.dh, align 1, !tbaa !15
  %i.di = getelementptr inbounds nuw i8, ptr %i.cz, i64 %index121
  store <4 x i8> %wide.load122, ptr %i.di, align 1, !tbaa !15
  %index.next123 = add nuw i64 %index121, 4       ; 2 uses
  %i.dj = icmp eq i64 %index.next123, %n.vec120
  br i1 %i.dj, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !326
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  %i.dl = load i8, ptr %i.dk, align 1, !tbaa !15
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !327
...
._crit_edge.loopexit.i:                           ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i = load i64, ptr %i.ap, align 8, !tbaa !53
...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.o
  ...
  store i64 %i.dr, ptr %i.ap, align 8, !tbaa !53
  %i.ds = getelementptr inbounds nuw i8, ptr %.02532.i, i64 %.026.i ; 2 uses
  %.not.i = icmp eq ptr %i.ds, %i.ci
  br i1 %.not.i, label %_ZN3fmt3v126detail6bufferIcE6appendIcEEvPKT_S7_.exit, label %bb.m, !llvm.loop !116
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  store i8 %i.ec, ptr %i.ed, align 1, !tbaa !15
  ...
  store i8 %i.eg, ptr %i.eh, align 1, !tbaa !15
  %i.ei = add nuw i64 %.030.i, 4                  ; 2 uses
  %exitcond.not.i.3 = icmp eq i64 %i.ei, %.026.i
  br i1 %exitcond.not.i.3, label %._crit_edge.loopexit.i, label %.lr.ph.i, !llvm.loop !328
...
bb.p:                                             ; preds = %.lr.ph96, %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55
  ...
  %i.ek = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
  %i.el = add i64 %i.ek, 1                        ; 3 uses
  %i.em = load i64, ptr %i.as, align 8, !tbaa !54
  %i.en = icmp ugt i64 %i.el, %i.em
  br i1 %i.en, label %bb.q, label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55

bb.q:                                             ; preds = %bb.p
  %i.eo = load ptr, ptr %i.ej, align 8, !tbaa !55
  call void %i.eo(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.el), !inline_history !323
  %.pre.i53 = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55: ; preds = %bb.p, %bb.q
  ...
  %i.eq = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i52, ptr %i.ap, align 8, !tbaa !53
  %i.er = getelementptr inbounds nuw i8, ptr %i.eq, i64 %i.ep
  store i8 48, ptr %i.er, align 1, !tbaa !15
  %i.es = add i32 %.295, 1                        ; 2 uses
  %exitcond.not = icmp eq i32 %i.es, %.sroa.6.8.extract.trunc
  br i1 %exitcond.not, label %._crit_edge, label %bb.p, !llvm.loop !329
...
._crit_edge:                                      ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55, %_ZN3fmt3v126detail6bufferIcE6appendIcEEvPKT_S7_.exit
  ...
  %i.eu = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
  %i.ev = add i64 %i.eu, 1                        ; 3 uses
  %i.ew = load i64, ptr %i.as, align 8, !tbaa !54
...
bb.r:                                             ; preds = %._crit_edge
  ...
  call void %i.ez(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ev), !inline_history !323
  %.pre.i57 = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit59: ; preds = %._crit_edge, %bb.r
  ...
  %i.fb = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i56, ptr %i.ap, align 8, !tbaa !53
  %i.fc = getelementptr inbounds nuw i8, ptr %i.fb, i64 %i.fa
  store i8 %i.et, ptr %i.fc, align 1, !tbaa !15
  %i.fd = icmp slt i32 %.sroa.9.2, 0
  %i.fe = load i64, ptr %i.ap, align 8, !tbaa !53 ; 3 uses
  %i.ff = add i64 %i.fe, 1                        ; 5 uses
  %i.fg = load i64, ptr %i.as, align 8, !tbaa !54
...
bb.t:                                             ; preds = %bb.s
  ...
  call void %i.fj(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ff), !inline_history !323
  %.pre.i61 = load i64, ptr %i.ap, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit63: ; preds = %bb.s, %bb.t
  ...
  %i.fl = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i60, ptr %i.ap, align 8, !tbaa !53
  %i.fm = getelementptr inbounds nuw i8, ptr %i.fl, i64 %i.fk
  store i8 45, ptr %i.fm, align 1, !tbaa !15
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  store i128 %.sroa.0.0, ptr %5, align 16, !tbaa !331
...
bb.j:                                             ; preds = %bb.i
  %i.bk = load i32, ptr %2, align 4, !tbaa !86
...
bb.n:                                             ; preds = %.critedge
  ...
  call void %i.cb(ptr noundef nonnull align 8 dereferenceable(32) %4, i64 noundef %.047), !inline_history !330
  %.pre.i41 = load i64, ptr %i.bx, align 8, !tbaa !54
  br label %_ZN3fmt3v126detail6bufferIcE10try_resizeEm.exit42
...
_ZN3fmt3v126detail6bufferIcE10try_resizeEm.exit42: ; preds = %.critedge.thread, %.critedge, %bb.n
  ...
  store i64 %i.cd, ptr %i.bm, align 8, !tbaa !53
  br label %bb.o
...
bb.f:                                             ; preds = %bb.e
  %i.aq = load ptr, ptr %i.aj, align 8, !tbaa !55
  %i.ar = add i64 %i.ao, %i.ak
  tail call void %i.aq(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ar), !inline_history !334
  %i.as = load i64, ptr %i.ag, align 8, !tbaa !53 ; 2 uses
  %i.at = load i64, ptr %i.ah, align 8, !tbaa !54
  %i.au = sub i64 %i.at, %i.as
  %i.av = tail call i64 @llvm.umin.i64(i64 %i.ao, i64 %i.au)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bf = icmp eq i64 %index.next, %n.vec
  br i1 %i.bf, label %middle.block, label %vector.body, !llvm.loop !335
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %index.next41 = add nuw i64 %index39, 4         ; 2 uses
  %i.bi = icmp eq i64 %index.next41, %n.vec38
  br i1 %i.bi, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !336
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !337
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.g
  ...
  %i.br = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.br, %i.af
  br i1 %.not.i.i.i, label %_ZZN3fmt3v126detail11write_bytesIcLNS0_5alignE2ENS0_14basic_appenderIcEEEET1_S6_NS0_17basic_string_viewIcEERKNS0_12format_specsEENKUlS5_E_clES5_.exit, label %bb.e, !llvm.loop !116
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  %i.ch = add nuw i64 %.030.i.i.i, 4              ; 2 uses
  %exitcond.not.i.i.i.3 = icmp eq i64 %i.ch, %.026.i.i.i
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !338
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden void @_ZN3fmt3v1212format_errorCI2St13runtime_errorEPKc(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef %1) unnamed_addr #16 align 2 {
bb.a:
  tail call void @_ZNSt13runtime_errorC2EPKc(ptr noundef nonnull align 8 dereferenceable(16) %0, ptr noundef %1)
  store ptr getelementptr inbounds nuw inrange(-16, 24) (i8, ptr @_ZTVN3fmt3v1212format_errorE, i64 16), ptr %0, align 8, !tbaa !40
  ret void
}
...
define linkonce_odr hidden void @_ZN3fmt3v1212format_errorD0Ev(ptr noundef nonnull align 8 dereferenceable(16) %0) unnamed_addr #17 align 2 {
bb.a:
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden void @_ZN3fmt3v126detail13format_dragonENS1_8basic_fpIoEEjiRNS1_6bufferIcEERi(ptr noundef byval(%"struct.fmt::v12::detail::basic_fp") align 16 %0, i32 noundef %1, i32 noundef %2, ptr noundef nonnull align 8 dereferenceable(32) %3, ptr noundef nonnull align 4 dereferenceable(4) %4) local_unnamed_addr #16 personality ptr @__gxx_personality_v0 {
bb.a:
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE4growERNS2_6bufferIjEEm, ptr %i.b, align 8, !tbaa !339
  %i.d = getelementptr inbounds nuw i8, ptr %5, i64 32 ; 9 uses
  store ptr %i.d, ptr %5, align 8, !tbaa !341
  store i64 32, ptr %i.a, align 8, !tbaa !342
  %i.e = getelementptr inbounds nuw i8, ptr %5, i64 168 ; 10 uses
  store i32 0, ptr %i.e, align 8, !tbaa !343
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE4growERNS2_6bufferIjEEm, ptr %i.g, align 8, !tbaa !339
  %i.i = getelementptr inbounds nuw i8, ptr %6, i64 32 ; 3 uses
  store ptr %i.i, ptr %6, align 8, !tbaa !341
  store i64 32, ptr %i.f, align 8, !tbaa !342
  %i.j = getelementptr inbounds nuw i8, ptr %6, i64 168 ; 9 uses
  store i32 0, ptr %i.j, align 8, !tbaa !343
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE4growERNS2_6bufferIjEEm, ptr %i.l, align 8, !tbaa !339
  %i.n = getelementptr inbounds nuw i8, ptr %7, i64 32 ; 5 uses
  store ptr %i.n, ptr %7, align 8, !tbaa !341
  store i64 32, ptr %i.k, align 8, !tbaa !342
...
_ZN3fmt3v126detail6bigintlSEi.exit:               ; preds = %bb.i, %_ZN3fmt3v126detail9allocatorIjE8allocateEm.exit.i
  ...
  store i64 %.pre2.i.i.pre-phi, ptr %i.c, align 8, !tbaa !351
...
_ZN3fmt3v126detail6bigintlSEi.exit.thread:        ; preds = %bb.f, %._crit_edge.i, %_ZN3fmt3v126detail6bigintlSEi.exit, %_ZN3fmt3v126detail6bigintlSEi.exit.thread1117
  ...
  store i64 1, ptr %i.m, align 8, !tbaa !351
  %i.bm = lshr i32 %i.x, 5
  store i32 %i.bm, ptr %i.o, align 8, !tbaa !343
...
bb.j:                                             ; preds = %_ZN3fmt3v126detail6bigintlSEi.exit135
  ...
  store i64 1, ptr %i.r, align 8, !tbaa !351
  %i.bq = add nuw nsw i32 %i.x, 1                 ; 2 uses
  %i.br = lshr i32 %i.bq, 5
  store i32 %i.br, ptr %i.t, align 8, !tbaa !343
...
bb.k:                                             ; preds = %_ZN3fmt3v126detail6bigintlSEi.exit155
  %i.bw = load i64, ptr %i.h, align 8, !tbaa !351 ; 7 uses
...
.lr.ph.i157:                                      ; preds = %bb.k
  %i.bx = load ptr, ptr %6, align 8, !tbaa !341   ; 3 uses
...
vector.body1612:                                  ; preds = %vector.body1612, %vector.ph1605
  ...
  br i1 %i.cj, label %middle.block1618, label %vector.body1612, !llvm.loop !354
...
scalar.ph1603:                                    ; preds = %scalar.ph1603.preheader, %scalar.ph1603
  ...
  br i1 %exitcond.not.i160, label %._crit_edge.i161, label %scalar.ph1603, !llvm.loop !355

bb.l:                                             ; preds = %._crit_edge.i161
  %i.cq = add i64 %i.bw, 1                        ; 3 uses
  %i.cr = load i64, ptr %i.f, align 8, !tbaa !342
  %i.cs = icmp ugt i64 %i.cq, %i.cr
  br i1 %i.cs, label %bb.m, label %_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i163

bb.m:                                             ; preds = %bb.l
  %i.ct = load ptr, ptr %i.g, align 8, !tbaa !339
  invoke void %i.ct(ptr noundef nonnull align 8 dereferenceable(172) %6, i64 noundef %i.cq)
          to label %.noexc167 unwind label %.loopexit.split-lp, !inline_history !356

.noexc167:                                        ; preds = %bb.m
  %.pre.i.i165 = load i64, ptr %i.h, align 8, !tbaa !351 ; 2 uses
  %.pre2.i.i166 = add i64 %.pre.i.i165, 1
  %.pre684 = load ptr, ptr %6, align 8, !tbaa !341
...
_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i163: ; preds = %.noexc167, %bb.l
  ...
  store i64 %.pre-phi.i.i164, ptr %i.h, align 8, !tbaa !351
...
bb.p:                                             ; preds = %bb.o
  %i.da = load i64, ptr %i.c, align 8, !tbaa !351 ; 7 uses
  %i.db = load i64, ptr %i.k, align 8, !tbaa !342
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i: ; preds = %bb.p
  store i64 %i.da, ptr %i.m, align 8, !tbaa !351
  %i.dh = load ptr, ptr %5, align 8, !tbaa !341   ; 3 uses
...
.lr.ph.i.preheader.i:                             ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i, %.noexc170
  ...
  %i.dn = load ptr, ptr %7, align 8, !tbaa !341   ; 4 uses
  %i.do = add i64 %i.dl, -4
...
vector.body1519:                                  ; preds = %vector.body1519, %vector.ph1516
  ...
  br i1 %i.eb, label %middle.block1525, label %vector.body1519, !llvm.loop !358
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  br i1 %.not.i.i169, label %.loopexit570, label %.lr.ph.i.i, !llvm.loop !359
...
.loopexit570:                                     ; preds = %.lr.ph.i.i, %middle.block1525, %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i
  ...
  %i.eg = load i32, ptr %i.e, align 8, !tbaa !343 ; 2 uses
  store i32 %i.eg, ptr %i.o, align 8, !tbaa !343
  br i1 %.not, label %_ZN3fmt3v126detail6bigintlSEi.exit196, label %bb.q

bb.q:                                             ; preds = %.loopexit570
  %i.eh = load i64, ptr %i.c, align 8, !tbaa !351 ; 8 uses
  %i.ei = load i64, ptr %i.p, align 8, !tbaa !342 ; 2 uses
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171: ; preds = %bb.q
  store i64 %i.eh, ptr %i.r, align 8, !tbaa !351
...
.thread:                                          ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171
  store i32 %i.eg, ptr %i.t, align 8, !tbaa !343
...
.lr.ph.i.preheader.i174:                          ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171, %.noexc182
  ...
  %i.eu = load ptr, ptr %8, align 8, !tbaa !341   ; 7 uses
  %i.ev = add i64 %i.es, -4
...
vector.body1536:                                  ; preds = %vector.body1536, %vector.ph1533
  ...
  br i1 %i.fi, label %middle.block1543, label %vector.body1536, !llvm.loop !360
...
.lr.ph.i.i175:                                    ; preds = %.lr.ph.i.i175.preheader, %.lr.ph.i.i175
  ...
  br i1 %.not.i.i178, label %.loopexit1623, label %.lr.ph.i.i175, !llvm.loop !361

.loopexit1623:                                    ; preds = %.lr.ph.i.i175, %middle.block1543
  %i.fm = load i32, ptr %i.e, align 8, !tbaa !343
  store i32 %i.fm, ptr %i.t, align 8, !tbaa !343
...
vector.body1552:                                  ; preds = %vector.body1552, %vector.ph1549
  ...
  br i1 %i.fx, label %middle.block1558, label %vector.body1552, !llvm.loop !362
...
.lr.ph.i185:                                      ; preds = %.lr.ph.i185.preheader1673, %.lr.ph.i185
  ...
  br i1 %exitcond.not.i188, label %._crit_edge.i189, label %.lr.ph.i185, !llvm.loop !363
...
bb.s:                                             ; preds = %bb.r
  %i.gh = load ptr, ptr %i.q, align 8, !tbaa !339
  invoke void %i.gh(ptr noundef nonnull align 8 dereferenceable(172) %8, i64 noundef %i.gf)
          to label %.noexc195 unwind label %.loopexit.split-lp, !inline_history !356

.noexc195:                                        ; preds = %bb.s
  %.pre.i.i193 = load i64, ptr %i.r, align 8, !tbaa !351 ; 2 uses
  %.pre2.i.i194 = add i64 %.pre.i.i193, 1
  %.pre678 = load ptr, ptr %8, align 8, !tbaa !341
...
_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i191: ; preds = %.noexc195, %bb.r
  ...
  store i64 %.pre-phi.i.i192, ptr %i.r, align 8, !tbaa !351
...
_ZN3fmt3v126detail6bigintlSEi.exit196:            ; preds = %_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i191, %._crit_edge.i189, %.loopexit1623, %.thread, %.loopexit570
  ...
  %i.gl = load i128, ptr %0, align 16, !tbaa !349 ; 3 uses
  %i.gm = and i128 %i.gl, 18446744073709551615
  %i.gn = load i64, ptr %i.c, align 8, !tbaa !351 ; 4 uses
...
.lr.ph.i.i197:                                    ; preds = %_ZN3fmt3v126detail6bigintlSEi.exit196
  %i.go = load ptr, ptr %5, align 8, !tbaa !341   ; 3 uses
...
bb.t:                                             ; preds = %bb.t, %.lr.ph.i.i197
  ...
  br i1 %exitcond.not.i.i, label %.preheader.i.i, label %bb.t, !llvm.loop !364
...
.lr.ph22.i.i:                                     ; preds = %.preheader.i.i, %_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i.i
  ...
  %i.hi = load i64, ptr %i.a, align 8, !tbaa !342
...
bb.u:                                             ; preds = %.lr.ph22.i.i
  %i.hk = load ptr, ptr %i.b, align 8, !tbaa !339
  invoke void %i.hk(ptr noundef nonnull align 8 dereferenceable(172) %5, i64 noundef %i.hh)
          to label %.noexc200 unwind label %.loopexit569, !inline_history !365

.noexc200:                                        ; preds = %bb.u
  %.pre.i.i.i199 = load i64, ptr %i.c, align 8, !tbaa !351 ; 2 uses
...
_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i.i: ; preds = %.noexc200, %.lr.ph22.i.i
  ...
  store i64 %.pre-phi.i.i.i, ptr %i.c, align 8, !tbaa !351
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bz = icmp eq i64 %index.next, %n.vec
  br i1 %i.bz, label %middle.block, label %vector.body, !llvm.loop !387
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  br i1 %exitcond.not.i, label %._crit_edge.i, label %scalar.ph, !llvm.loop !388

bb.l:                                             ; preds = %._crit_edge.i
  %i.cg = add i64 %i.bm, 1                        ; 3 uses
  %i.ch = load i64, ptr %i.o, align 8, !tbaa !342
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ck = load ptr, ptr %i.cj, align 8, !tbaa !339
  tail call void %i.ck(ptr noundef nonnull align 8 dereferenceable(172) %0, i64 noundef %i.cg), !inline_history !389
  %.pre.i.i = load i64, ptr %i.v, align 8, !tbaa !351 ; 2 uses
  %.pre2.i.i = add i64 %.pre.i.i, 1
  %.pre23 = load ptr, ptr %0, align 8, !tbaa !341
...
_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i: ; preds = %bb.m, %bb.l
  ...
  store i64 %.pre-phi.i.i, ptr %i.v, align 8, !tbaa !351
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden noundef i32 @_ZN3fmt3v126detail6bigint13divmod_assignERKS2_(ptr noundef nonnull align 8 dereferenceable(172) %0, ptr noundef nonnull align 8 dereferenceable(172) %1) local_unnamed_addr #4 align 2 {
bb.a:
  %i.a = getelementptr inbounds nuw i8, ptr %0, i64 8 ; 3 uses
  %i.b = load i64, ptr %i.a, align 8, !tbaa !351  ; 5 uses
  %i.c = trunc i64 %i.b to i32                    ; 5 uses
  %i.d = getelementptr inbounds nuw i8, ptr %0, i64 168 ; 4 uses
  %i.e = load i32, ptr %i.d, align 8, !tbaa !343  ; 4 uses
  %i.f = add nsw i32 %i.e, %i.c                   ; 2 uses
  %i.g = getelementptr inbounds nuw i8, ptr %1, i64 8 ; 3 uses
  %i.h = load i64, ptr %i.g, align 8, !tbaa !351  ; 3 uses
  %i.i = trunc i64 %i.h to i32                    ; 2 uses
  %i.j = getelementptr inbounds nuw i8, ptr %1, i64 168 ; 3 uses
  %i.k = load i32, ptr %i.j, align 8, !tbaa !343  ; 3 uses
...
bb.d:                                             ; preds = %.lr.ph
  ...
  br i1 %.not35.not.i, label %.lr.ph, label %._crit_edge, !llvm.loop !378
...
.lr.ph:                                           ; preds = %bb.c, %bb.d
  ...
  br i1 %.not37.i, label %bb.d, label %.loopexit.i, !llvm.loop !378
...
bb.e:                                             ; preds = %select.unfold
  ...
  %i.ad = load i64, ptr %i.ac, align 8, !tbaa !342 ; 2 uses
...
bb.f:                                             ; preds = %bb.e
  ...
  tail call void %i.ag(ptr noundef nonnull align 8 dereferenceable(172) %0, i64 noundef %i.ab), !inline_history !390
  %.pre.i.i.i = load i64, ptr %i.ac, align 8, !tbaa !342
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i: ; preds = %bb.f, %bb.e
  ...
  store i64 %i.ai, ptr %i.a, align 8, !tbaa !351
  %i.aj = icmp sgt i32 %i.c, 0
  %.pre.i = load ptr, ptr %0, align 8, !tbaa !341 ; 13 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.ba, label %middle.block, label %vector.body, !llvm.loop !391
...
scalar.ph.prol:                                   ; preds = %scalar.ph.preheader, %scalar.ph.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %scalar.ph.prol.loopexit, label %scalar.ph.prol, !llvm.loop !392
...
.lr.ph.preheader.i.i:                             ; preds = %scalar.ph.prol.loopexit, %scalar.ph, %middle.block, %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i
  ...
  %i.bl = load i32, ptr %i.d, align 8, !tbaa !343
  %i.bm = sub nsw i32 %i.bl, %i.y                 ; 2 uses
  store i32 %i.bm, ptr %i.d, align 8, !tbaa !343
  %.pre.pre = load i64, ptr %i.g, align 8, !tbaa !351
...
scalar.ph:                                        ; preds = %scalar.ph.prol.loopexit, %scalar.ph
  ...
  br i1 %.not.i13.3, label %.lr.ph.preheader.i.i, label %scalar.ph, !llvm.loop !393
...
.lr.ph.i14:                                       ; preds = %_ZN3fmt3v126detail7compareERKNS1_6bigintES4_.exit32
  %i.cm = load i32, ptr %i.j, align 8, !tbaa !343
  %i.cn = sub i32 %i.cm, %i.ci
  %i.co = load ptr, ptr %1, align 8, !tbaa !341   ; 3 uses
  %i.cp = load ptr, ptr %0, align 8, !tbaa !341   ; 4 uses
...
bb.g:                                             ; preds = %bb.g, %.lr.ph.i14.new
  ...
  br i1 %niter.ncmp.1, label %._crit_edge.i.unr-lcssa, label %bb.g, !llvm.loop !394
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i12: ; preds = %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
  ...
  %i.bb = add i64 %i.ba, 1
  call void @_ZdlPvm(ptr noundef %i.ay, i64 noundef %i.bb) #32
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden void @_ZN3fmt3v126detail18thousands_sep_implIcEENS1_20thousands_sep_resultIT_EENS0_10locale_refE(ptr dead_on_unwind noalias writable sret(%"struct.fmt::v12::detail::thousands_sep_result") align 8 %0, ptr %1) local_unnamed_addr #16 personality ptr @__gxx_personality_v0 {
bb.a:
...
_ZSt9use_facetINSt7__cxx118numpunctIcEEERKT_RKSt6locale.exit: ; preds = %_ZNK3fmt3v1210locale_ref3getISt6localeEET_v.exit
  ...
  call void @llvm.lifetime.end.p0(ptr nonnull %2) #29
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #29
  %i.g = load ptr, ptr %i.f, align 8, !tbaa !40, !noalias !426
  %i.h = getelementptr inbounds nuw i8, ptr %i.g, i64 32
  %i.i = load ptr, ptr %i.h, align 8, !noalias !426
  call void %i.i(ptr dead_on_unwind nonnull writable sret(%"class.std::__cxx11::basic_string") align 8 %3, ptr noundef nonnull align 8 dereferenceable(24) %i.f), !inline_history !156
...
bb.e:                                             ; preds = %_ZSt9use_facetINSt7__cxx118numpunctIcEEERKT_RKSt6locale.exit
  %i.m = load ptr, ptr %i.f, align 8, !tbaa !40
  %i.n = getelementptr inbounds nuw i8, ptr %i.m, i64 24
  %i.o = load ptr, ptr %i.n, align 8
  %i.p = invoke noundef signext i8 %i.o(ptr noundef nonnull align 8 dereferenceable(24) %i.f)
          to label %_ZNKSt7__cxx118numpunctIcE13thousands_sepEv.exit unwind label %bb.h, !inline_history !157
...
_ZNKSt7__cxx118numpunctIcE13thousands_sepEv.exit: ; preds = %bb.e, %_ZSt9use_facetINSt7__cxx118numpunctIcEEERKT_RKSt6locale.exit
  ...
  store ptr %i.r, ptr %0, align 8, !tbaa !151
  %i.s = load ptr, ptr %3, align 8, !tbaa !131    ; 2 uses
...
bb.f:                                             ; preds = %_ZNKSt7__cxx118numpunctIcE13thousands_sepEv.exit
  %i.v = load i64, ptr %i.j, align 8, !tbaa !152  ; 3 uses
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i: ; preds = %_ZNKSt7__cxx118numpunctIcE13thousands_sepEv.exit
  ...
  %i.y = load i64, ptr %i.t, align 8, !tbaa !15
  store i64 %i.y, ptr %i.r, align 8, !tbaa !15
  %.pre = load i64, ptr %i.j, align 8, !tbaa !152
  br label %_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit
...
_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEED2Ev.exit: ; preds = %bb.f, %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i
  ...
  store i8 %i.q, ptr %i.ab, align 8, !tbaa !424
  call void @llvm.lifetime.end.p0(ptr nonnull %3) #29
  ret void
...
_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.i.i7: ; preds = %bb.h
  ...
  %i.ai = add i64 %i.ah, 1
  call void @_ZdlPvm(ptr noundef %i.ae, i64 noundef %i.ai) #32
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEPKcNS1_14digit_groupingIcEEEET0_S9_T1_iiRKT2_(ptr %0, ptr noundef %1, i32 noundef %2, i32 noundef %3, ptr noundef nonnull align 8 dereferenceable(64) %4) local_unnamed_addr #4 personality ptr @__gxx_personality_v0 {
bb.a:
...
.lr.ph34.i.i.i:                                   ; preds = %bb.b
  ...
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.pre.i.i.i = load i64, ptr %i.e, align 8, !tbaa !53
  br label %bb.c
...
bb.c:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.j = load i64, ptr %i.f, align 8, !tbaa !54
  %i.k = sub i64 %i.j, %i.i
...
bb.d:                                             ; preds = %bb.c
  %i.o = load ptr, ptr %i.h, align 8, !tbaa !55
  %i.p = add i64 %i.m, %i.i
  tail call void %i.o(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.p), !inline_history !429
  %i.q = load i64, ptr %i.e, align 8, !tbaa !53   ; 2 uses
...
vector.body79:                                    ; preds = %vector.body79, %vector.ph76
  ...
  %wide.load81 = load <16 x i8>, ptr %i.z, align 1, !tbaa !15
  %wide.load82 = load <16 x i8>, ptr %i.aa, align 1, !tbaa !15
  %i.ab = getelementptr inbounds nuw i8, ptr %i.w, i64 %index80 ; 2 uses
  %i.ac = getelementptr inbounds nuw i8, ptr %i.ab, i64 16
  store <16 x i8> %wide.load81, ptr %i.ab, align 1, !tbaa !15
  store <16 x i8> %wide.load82, ptr %i.ac, align 1, !tbaa !15
  %index.next83 = add nuw i64 %index80, 32        ; 2 uses
  %i.ad = icmp eq i64 %index.next83, %n.vec78
  br i1 %i.ad, label %middle.block84, label %vector.body79, !llvm.loop !430
...
vec.epilog.iter.check89:                          ; preds = %middle.block84
  ...
  br i1 %min.epilog.iters.check90, label %.lr.ph.i.i.i.preheader, label %vec.epilog.ph91, !prof !112
...
vec.epilog.vector.body94:                         ; preds = %vec.epilog.vector.body94, %vec.epilog.ph91
  ...
  %wide.load96 = load <4 x i8>, ptr %i.ae, align 1, !tbaa !15
  %i.af = getelementptr inbounds nuw i8, ptr %i.w, i64 %index95
  store <4 x i8> %wide.load96, ptr %i.af, align 1, !tbaa !15
  %index.next97 = add nuw i64 %index95, 4         ; 2 uses
  %i.ag = icmp eq i64 %index.next97, %n.vec93
  br i1 %i.ag, label %vec.epilog.middle.block98, label %vec.epilog.vector.body94, !llvm.loop !431
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  br i1 %prol.iter103.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !432
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block98, %middle.block84
  %.pre37.i.i.i = load i64, ptr %i.e, align 8, !tbaa !53
  br label %._crit_edge.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.e
  ...
  br i1 %.not.i.i.i, label %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit, label %bb.c, !llvm.loop !116
...
bb.f:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %.lr.ph.i
  ...
  %i.bk = load i64, ptr %i.bh, align 8, !tbaa !53 ; 2 uses
  %i.bl = add i64 %i.bk, 1                        ; 3 uses
  %i.bm = load i64, ptr %i.bi, align 8, !tbaa !54
  %i.bn = icmp ugt i64 %i.bl, %i.bm
  br i1 %i.bn, label %bb.g, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i

bb.g:                                             ; preds = %bb.f
  %i.bo = load ptr, ptr %i.bj, align 8, !tbaa !55
  tail call void %i.bo(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.bl), !inline_history !267
  %.pre.i.i.i18 = load i64, ptr %i.bh, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.g, %bb.f
  ...
  %i.bq = load ptr, ptr %0, align 8, !tbaa !51
  store i64 %.pre-phi.i.i.i, ptr %i.bh, align 8, !tbaa !53
  %i.br = getelementptr inbounds nuw i8, ptr %i.bq, i64 %i.bp
  store i8 48, ptr %i.br, align 1, !tbaa !15
  %i.bs = add nuw nsw i32 %.04.i, 1               ; 2 uses
  %exitcond.not.i = icmp eq i32 %i.bs, %3
  br i1 %exitcond.not.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit, label %bb.f, !llvm.loop !263
...
bb.h:                                             ; preds = %bb.a
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIcLm500ENS0_6detail9allocatorIcEEE4growERNS2_6bufferIcEEm, ptr %i.bu, align 8, !tbaa !55
  %i.bw = getelementptr inbounds nuw i8, ptr %5, i64 32 ; 3 uses
  store ptr %i.bw, ptr %5, align 8, !tbaa !51
  store i64 500, ptr %i.bt, align 8, !tbaa !54
...
bb.i:                                             ; preds = %._crit_edge.i.i.i31, %.lr.ph34.i.i.i20
  ...
  %i.cb = load i64, ptr %i.bt, align 8, !tbaa !54
...
bb.j:                                             ; preds = %bb.i
  %i.cg = load ptr, ptr %i.bu, align 8, !tbaa !55
  %i.ch = add i64 %i.ce, %i.ca
  invoke void %i.cg(ptr noundef nonnull align 8 dereferenceable(32) %5, i64 noundef %i.ch)
          to label %.noexc unwind label %.loopexit, !inline_history !434

.noexc:                                           ; preds = %bb.j
  %i.ci = load i64, ptr %i.bv, align 8, !tbaa !53 ; 2 uses
  %i.cj = load i64, ptr %i.bt, align 8, !tbaa !54
...
bb.k:                                             ; preds = %.noexc, %bb.i
  ...
  %i.cm = load ptr, ptr %5, align 8, !tbaa !51    ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.cr, align 1, !tbaa !15
  %wide.load64 = load <16 x i8>, ptr %i.cs, align 1, !tbaa !15
  %i.ct = getelementptr inbounds nuw i8, ptr %i.co, i64 %index ; 2 uses
  %i.cu = getelementptr inbounds nuw i8, ptr %i.ct, i64 16
  store <16 x i8> %wide.load, ptr %i.ct, align 1, !tbaa !15
  store <16 x i8> %wide.load64, ptr %i.cu, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.cv = icmp eq i64 %index.next, %n.vec
  br i1 %i.cv, label %middle.block, label %vector.body, !llvm.loop !435
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf, 0
  br i1 %min.epilog.iters.check, label %.lr.ph.i.i.i26.preheader, label %vec.epilog.ph, !prof !112
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load68 = load <4 x i8>, ptr %i.cw, align 1, !tbaa !15
  %i.cx = getelementptr inbounds nuw i8, ptr %i.co, i64 %index67
  store <4 x i8> %wide.load68, ptr %i.cx, align 1, !tbaa !15
  %index.next69 = add nuw i64 %index67, 4         ; 2 uses
  %i.cy = icmp eq i64 %index.next69, %n.vec66
  br i1 %i.cy, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !436
...
.lr.ph.i.i.i26.prol:                              ; preds = %.lr.ph.i.i.i26.preheader, %.lr.ph.i.i.i26.prol
  ...
  store i8 %i.da, ptr %i.db, align 1, !tbaa !15
  %i.dc = add nuw i64 %.030.i.i.i27.prol, 1       ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i26.prol.loopexit, label %.lr.ph.i.i.i26.prol, !llvm.loop !437
...
._crit_edge.loopexit.i.i.i29:                     ; preds = %.lr.ph.i.i.i26.prol.loopexit, %.lr.ph.i.i.i26, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i30 = load i64, ptr %i.bv, align 8, !tbaa !53
...
._crit_edge.i.i.i31:                              ; preds = %._crit_edge.loopexit.i.i.i29, %bb.k
  ...
  store i64 %i.dg, ptr %i.bv, align 8, !tbaa !53
  %i.dh = getelementptr inbounds nuw i8, ptr %.02532.i.i.i22, i64 %.026.i.i.i24 ; 2 uses
  %.not.i.i.i32 = icmp eq ptr %i.dh, %i.by
  br i1 %.not.i.i.i32, label %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit33, label %bb.i, !llvm.loop !116
...
.lr.ph.i.i.i26:                                   ; preds = %.lr.ph.i.i.i26.prol.loopexit, %.lr.ph.i.i.i26
  ...
  store i8 %i.dv, ptr %i.dw, align 1, !tbaa !15
  %i.dx = add nuw i64 %.030.i.i.i27, 4            ; 2 uses
  %exitcond.not.i.i.i28.3 = icmp eq i64 %i.dx, %.026.i.i.i24
  br i1 %exitcond.not.i.i.i28.3, label %._crit_edge.loopexit.i.i.i29, label %.lr.ph.i.i.i26, !llvm.loop !438
...
.lr.ph.i34:                                       ; preds = %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit33, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i36
  ...
  %i.ea = load i64, ptr %i.bv, align 8, !tbaa !53 ; 2 uses
  %i.eb = add i64 %i.ea, 1                        ; 3 uses
  %i.ec = load i64, ptr %i.bt, align 8, !tbaa !54
  %i.ed = icmp ugt i64 %i.eb, %i.ec
  br i1 %i.ed, label %bb.l, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i36

bb.l:                                             ; preds = %.lr.ph.i34
  %i.ee = load ptr, ptr %i.bu, align 8, !tbaa !55
  invoke void %i.ee(ptr noundef nonnull align 8 dereferenceable(32) %5, i64 noundef %i.eb)
          to label %.noexc41 unwind label %bb.o, !inline_history !439

.noexc41:                                         ; preds = %bb.l
  %.pre.i.i.i39 = load i64, ptr %i.bv, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i36:      ; preds = %.noexc41, %.lr.ph.i34
  ...
  %i.eg = load ptr, ptr %5, align 8, !tbaa !51
  store i64 %.pre-phi.i.i.i37, ptr %i.bv, align 8, !tbaa !53
  %i.eh = getelementptr inbounds nuw i8, ptr %i.eg, i64 %i.ef
  store i8 48, ptr %i.eh, align 1, !tbaa !15
  %i.ei = add nuw nsw i32 %.04.i35, 1             ; 2 uses
  %exitcond.not.i38 = icmp eq i32 %i.ei, %3
  br i1 %exitcond.not.i38, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42.loopexit, label %.lr.ph.i34, !llvm.loop !263
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42.loopexit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i36
  %.pre = load i64, ptr %i.bv, align 8, !tbaa !53
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42: ; preds = %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42.loopexit, %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit33
  ...
  %i.ek = load ptr, ptr %5, align 8, !tbaa !51
...
bb.m:                                             ; preds = %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit42
  %i.em = load ptr, ptr %5, align 8, !tbaa !51    ; 2 uses
...
bb.p:                                             ; preds = %.loopexit, %.loopexit.split-lp, %bb.o
  ...
  %i.eo = load ptr, ptr %5, align 8, !tbaa !51    ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.m = load ptr, ptr %i.l, align 8, !tbaa !55
  tail call void %i.m(ptr noundef nonnull align 8 dereferenceable(32) %i.e, i64 noundef %i.h), !inline_history !420
  %.pre.i.i.i = load i64, ptr %i.f, align 8, !tbaa !53 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.d, %bb.c
  ...
  %i.o = load ptr, ptr %i.e, align 8, !tbaa !51
  store i64 %.pre-phi.i.i.i, ptr %i.f, align 8, !tbaa !53
  %i.p = getelementptr inbounds nuw i8, ptr %i.o, i64 %i.n
  store i8 %4, ptr %i.p, align 1, !tbaa !15
...
bb.e:                                             ; preds = %bb.a
  ...
  store ptr @_ZN3fmt3v1219basic_memory_bufferIcLm500ENS0_6detail9allocatorIcEEE4growERNS2_6bufferIcEEm, ptr %i.u, align 8, !tbaa !55
  %i.w = getelementptr inbounds nuw i8, ptr %6, i64 32 ; 3 uses
  store ptr %i.w, ptr %6, align 8, !tbaa !51
  store i64 500, ptr %i.t, align 8, !tbaa !54
...
bb.f:                                             ; preds = %.noexc
  ...
  %i.ab = load i64, ptr %i.aa, align 8, !tbaa !53 ; 2 uses
...
bb.g:                                             ; preds = %bb.f
  ...
  invoke void %i.ah(ptr noundef nonnull align 8 dereferenceable(32) %i.z, i64 noundef %i.ac)
          to label %.noexc25 unwind label %bb.l, !inline_history !450

.noexc25:                                         ; preds = %bb.g
  %.pre.i.i.i23 = load i64, ptr %i.aa, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i20:      ; preds = %.noexc25, %bb.f
  ...
  %i.aj = load ptr, ptr %i.z, align 8, !tbaa !51
  store i64 %.pre-phi.i.i.i21, ptr %i.aa, align 8, !tbaa !53
  %i.ak = getelementptr inbounds nuw i8, ptr %i.aj, i64 %i.ai
  store i8 %4, ptr %i.ak, align 1, !tbaa !15
...
bb.h:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i20, %.noexc
  %i.ao = load ptr, ptr %6, align 8, !tbaa !51
...
bb.i:                                             ; preds = %bb.h
  %i.ar = load ptr, ptr %6, align 8, !tbaa !51    ; 2 uses
  %i.as = getelementptr inbounds i8, ptr %i.ar, i64 %i.x
  %i.at = load i64, ptr %i.v, align 8, !tbaa !53
...
bb.j:                                             ; preds = %bb.i
  %i.aw = load ptr, ptr %6, align 8, !tbaa !51    ; 2 uses
...
; Function Attrs: mustprogress noinline uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail13copy_noinlineIcPKcNS0_14basic_appenderIcEEEET1_T0_S8_S7_(ptr noundef %0, ptr noundef %1, ptr %2) local_unnamed_addr #15 {
bb.a:
  %.not31.i.i = icmp eq ptr %0, %1
  br i1 %.not31.i.i, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit, label %.lr.ph34.i.i
...
bb.c:                                             ; preds = %bb.b
  %i.k = load ptr, ptr %i.d, align 8, !tbaa !55
  %i.l = add i64 %i.i, %i.e
  tail call void %i.k(ptr noundef nonnull align 8 dereferenceable(32) %2, i64 noundef %i.l), !inline_history !141
  %i.m = load i64, ptr %i.a, align 8, !tbaa !53   ; 2 uses
  %i.n = load i64, ptr %i.b, align 8, !tbaa !54
  %i.o = sub i64 %i.n, %i.m
  %i.p = tail call i64 @llvm.umin.i64(i64 %i.i, i64 %i.o)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.z = icmp eq i64 %index.next, %n.vec
  br i1 %i.z, label %middle.block, label %vector.body, !llvm.loop !451
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %index.next13 = add nuw i64 %index11, 4         ; 2 uses
  %i.ac = icmp eq i64 %index.next13, %n.vec10
  br i1 %i.ac, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !452
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !453
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.d
  ...
  %i.al = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i = icmp eq ptr %i.al, %1
  br i1 %.not.i.i, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit, label %bb.b, !llvm.loop !116
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  %i.bb = add nuw i64 %.030.i.i, 4                ; 2 uses
  %exitcond.not.i.i.3 = icmp eq i64 %i.bb, %.026.i.i
  br i1 %exitcond.not.i.i.3, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !454
...
; Function Attrs: inlinehint mustprogress uwtable
define linkonce_odr hidden ptr @_ZZN3fmt3v126detail11write_fixedIcNS1_14digit_groupingIcEENS0_14basic_appenderIcEENS1_14big_decimal_fpEEET1_S8_RKT2_iT_RKNS0_12format_specsENS0_4signENS0_10locale_refEENKUlS6_E1_clES6_(ptr noundef nonnull align 8 dereferenceable(48) %0, ptr %1) local_unnamed_addr #16 align 2 {
bb.a:
  %i.a = load ptr, ptr %0, align 8, !tbaa !455, !nonnull !70, !align !166
  %i.b = load i32, ptr %i.a, align 4, !tbaa !239  ; 2 uses
  %.not = icmp eq i32 %i.b, 0
  br i1 %.not, label %bb.d, label %bb.b
...
bb.e:                                             ; preds = %bb.d
  ...
  tail call void %i.x(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.s), !inline_history !107
  %.pre.i.i6 = load i64, ptr %i.q, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit8:         ; preds = %bb.d, %bb.e
  ...
  %i.z = load ptr, ptr %1, align 8, !tbaa !51
  store i64 %.pre-phi.i.i5, ptr %i.q, align 8, !tbaa !53
  %i.aa = getelementptr inbounds nuw i8, ptr %i.z, i64 %i.y
  store i8 48, ptr %i.aa, align 1, !tbaa !15
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !457, !nonnull !70
  %i.ad = load i8, ptr %i.ac, align 1, !tbaa !247, !range !69, !noundef !70
...
bb.f:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit8
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !458, !nonnull !70
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !15
  %i.ai = load i64, ptr %i.q, align 8, !tbaa !53  ; 2 uses
  %i.aj = add i64 %i.ai, 1                        ; 3 uses
  %i.ak = load i64, ptr %i.t, align 8, !tbaa !54
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.an = load ptr, ptr %i.am, align 8, !tbaa !55
  tail call void %i.an(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.aj), !inline_history !107
  %.pre.i.i11 = load i64, ptr %i.q, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit13:        ; preds = %bb.f, %bb.g
  ...
  %i.ap = load ptr, ptr %1, align 8, !tbaa !51
  store i64 %.pre-phi.i.i10, ptr %i.q, align 8, !tbaa !53
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 %i.ao
  store i8 %i.ah, ptr %i.aq, align 1, !tbaa !15
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !459, !nonnull !70, !align !166
...
bb.h:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %.lr.ph.i
  ...
  %i.aw = load i64, ptr %i.q, align 8, !tbaa !53  ; 2 uses
  %i.ax = add i64 %i.aw, 1                        ; 3 uses
  %i.ay = load i64, ptr %i.t, align 8, !tbaa !54
  %i.az = icmp ugt i64 %i.ax, %i.ay
  br i1 %i.az, label %bb.i, label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i

bb.i:                                             ; preds = %bb.h
  %i.ba = load ptr, ptr %i.av, align 8, !tbaa !55
  tail call void %i.ba(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.ax), !inline_history !267
  %.pre.i.i.i = load i64, ptr %i.q, align 8, !tbaa !53 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.i, %bb.h
  ...
  %i.bc = load ptr, ptr %1, align 8, !tbaa !51
  store i64 %.pre-phi.i.i.i, ptr %i.q, align 8, !tbaa !53
  %i.bd = getelementptr inbounds nuw i8, ptr %i.bc, i64 %i.bb
  store i8 48, ptr %i.bd, align 1, !tbaa !15
  %i.be = add nuw nsw i32 %.04.i, 1               ; 2 uses
  %exitcond.not.i = icmp eq i32 %i.be, %i.at
  br i1 %exitcond.not.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit, label %bb.h, !llvm.loop !263
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit13
  ...
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !460, !nonnull !70, !align !187
  %i.bh = load ptr, ptr %i.bg, align 8, !tbaa !318 ; 2 uses
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !461, !nonnull !70, !align !166
...
.lr.ph34.i.i.i:                                   ; preds = %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit
  ...
  %.pre.i.i.i14 = load i64, ptr %i.q, align 8, !tbaa !53
  br label %bb.j
...
bb.j:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.bq = load i64, ptr %i.t, align 8, !tbaa !54
...
bb.k:                                             ; preds = %bb.j
  ...
  tail call void %i.bv(ptr noundef nonnull align 8 dereferenceable(32) %1, i64 noundef %i.bw), !inline_history !429
  %i.bx = load i64, ptr %i.q, align 8, !tbaa !53  ; 2 uses
  %i.by = load i64, ptr %i.t, align 8, !tbaa !54
...
bb.l:                                             ; preds = %bb.k, %bb.j
  ...
  %i.cb = load ptr, ptr %1, align 8, !tbaa !51    ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.cg, align 1, !tbaa !15
  %wide.load31 = load <16 x i8>, ptr %i.ch, align 1, !tbaa !15
  %i.ci = getelementptr inbounds nuw i8, ptr %i.cd, i64 %index ; 2 uses
  %i.cj = getelementptr inbounds nuw i8, ptr %i.ci, i64 16
  store <16 x i8> %wide.load, ptr %i.ci, align 1, !tbaa !15
  store <16 x i8> %wide.load31, ptr %i.cj, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ck = icmp eq i64 %index.next, %n.vec
  br i1 %i.ck, label %middle.block, label %vector.body, !llvm.loop !462
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load35 = load <4 x i8>, ptr %i.cl, align 1, !tbaa !15
  %i.cm = getelementptr inbounds nuw i8, ptr %i.cd, i64 %index34
  store <4 x i8> %wide.load35, ptr %i.cm, align 1, !tbaa !15
  %index.next36 = add nuw i64 %index34, 4         ; 2 uses
  %i.cn = icmp eq i64 %index.next36, %n.vec33
  br i1 %i.cn, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !463
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !464
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.q, align 8, !tbaa !53
  br label %._crit_edge.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.l
  ...
  store i64 %i.cv, ptr %i.q, align 8, !tbaa !53
  %i.cw = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.cw, %i.bm
  br i1 %.not.i.i.i, label %_ZN3fmt3v126detail17write_significandIcNS0_14basic_appenderIcEEEET0_S5_PKci.exit, label %bb.j, !llvm.loop !116
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  store i8 %i.dg, ptr %i.dh, align 1, !tbaa !15
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !465
...
bb.b:                                             ; preds = %bb.a
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.ab = load ptr, ptr %i.aa, align 8, !tbaa !55
  tail call void %i.ab(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.w), !inline_history !140
  br label %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ae = load i64, ptr %i.ad, align 8, !tbaa !53 ; 2 uses
...
bb.e:                                             ; preds = %bb.d
  ...
  tail call void %i.ak(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.af), !inline_history !466
  %.pre.i.i.i = load i64, ptr %i.ad, align 8, !tbaa !53 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.e, %bb.d
  ...
  %i.am = load ptr, ptr %.sroa.09.0, align 8, !tbaa !51
  store i64 %.pre-phi.i.i.i, ptr %i.ad, align 8, !tbaa !53
  %i.an = getelementptr inbounds nuw i8, ptr %i.am, i64 %i.al
  store i8 48, ptr %i.an, align 1, !tbaa !15
  %i.ao = load i64, ptr %i.ad, align 8, !tbaa !53 ; 2 uses
  %i.ap = add i64 %i.ao, 1                        ; 3 uses
  %i.aq = load i64, ptr %i.ag, align 8, !tbaa !54
...
bb.f:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
  ...
  tail call void %i.at(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ap), !inline_history !466
  %.pre.i.i4.i = load i64, ptr %i.ad, align 8, !tbaa !53 ; 2 uses
...
bb.d:                                             ; preds = %bb.b, %bb.c, %bb.a
  ...
  %.str.9..str.10.i.i = select i1 %.not88, ptr @.str.10, ptr @.str.9
  br label %.split.i.i
...
.split.i.i:                                       ; preds = %.split.i.i, %bb.d
  ...
  %i.aa = getelementptr inbounds nuw i8, ptr %.str.9..str.10.i.i, i64 %i.z
  ...
  br i1 %.not.i.i, label %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit.preheader, label %.split.i.i, !llvm.loop !173
...
_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit: ; preds = %.lr.ph
  ...
  br i1 %.not89, label %.critedge, label %.lr.ph, !llvm.loop !528
...
.critedge:                                        ; preds = %.lr.ph, %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit, %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit.preheader
  ...
  %i.ak = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
...
bb.e:                                             ; preds = %.critedge
  ...
  tail call void %i.aq(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.al), !inline_history !323
  %.pre.i = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %.pre2.i = add i64 %.pre.i, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit:  ; preds = %.critedge, %bb.e
  ...
  %i.as = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i, ptr %i.aj, align 8, !tbaa !53
  %i.at = getelementptr inbounds nuw i8, ptr %i.as, i64 %i.ar
  store i8 48, ptr %i.at, align 1, !tbaa !15
  %i.au = select i1 %.not88, i8 120, i8 88
  %i.av = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %i.aw = add i64 %i.av, 1                        ; 3 uses
  %i.ax = load i64, ptr %i.am, align 8, !tbaa !54
...
bb.f:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit
  ...
  tail call void %i.ba(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.aw), !inline_history !323
  %.pre.i40 = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %.pre2.i41 = add i64 %.pre.i40, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit, %bb.f
  ...
  %i.bc = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i39, ptr %i.aj, align 8, !tbaa !53
  %i.bd = getelementptr inbounds nuw i8, ptr %i.bc, i64 %i.bb
  store i8 %i.au, ptr %i.bd, align 1, !tbaa !15
  %i.be = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %i.bf = add i64 %i.be, 1                        ; 3 uses
  %i.bg = load i64, ptr %i.am, align 8, !tbaa !54
...
bb.g:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42
  ...
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !55
  tail call void %i.bj(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bf), !inline_history !323
  %.pre.i44 = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %.pre2.i45 = add i64 %.pre.i44, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46: ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit42, %bb.g
  ...
  %i.bl = load i8, ptr %i.a, align 16, !tbaa !15
  %i.bm = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i43, ptr %i.aj, align 8, !tbaa !53
  %i.bn = getelementptr inbounds nuw i8, ptr %i.bm, i64 %i.bk
  store i8 %i.bl, ptr %i.bn, align 1, !tbaa !15
...
bb.h:                                             ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit46
  %i.br = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %i.bs = add i64 %i.br, 1                        ; 3 uses
  %i.bt = load i64, ptr %i.am, align 8, !tbaa !54
...
bb.i:                                             ; preds = %bb.h
  ...
  tail call void %i.bw(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.bs), !inline_history !323
  %.pre.i48 = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %.pre2.i49 = add i64 %.pre.i48, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit50
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit50: ; preds = %bb.h, %bb.i
  ...
  %i.by = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i47, ptr %i.aj, align 8, !tbaa !53
  %i.bz = getelementptr inbounds nuw i8, ptr %i.by, i64 %i.bx
  store i8 46, ptr %i.bz, align 1, !tbaa !15
  br label %bb.j
...
.lr.ph34.i:                                       ; preds = %bb.j
  ...
  %.pre.i51 = load i64, ptr %i.aj, align 8, !tbaa !53
  br label %bb.k
...
bb.k:                                             ; preds = %._crit_edge.i, %.lr.ph34.i
  ...
  %i.cg = load i64, ptr %i.am, align 8, !tbaa !54
...
bb.l:                                             ; preds = %bb.k
  %i.cl = load ptr, ptr %i.ce, align 8, !tbaa !55
  %i.cm = add i64 %i.cj, %i.cf
  call void %i.cl(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.cm), !inline_history !324
  %i.cn = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %i.co = load i64, ptr %i.am, align 8, !tbaa !54
...
bb.m:                                             ; preds = %bb.l, %bb.k
  ...
  %i.cr = load ptr, ptr %3, align 8, !tbaa !51    ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.cw, align 1, !tbaa !15
  %wide.load118 = load <16 x i8>, ptr %i.cx, align 1, !tbaa !15
  %i.cy = getelementptr inbounds nuw i8, ptr %i.ct, i64 %index ; 2 uses
  %i.cz = getelementptr inbounds nuw i8, ptr %i.cy, i64 16
  store <16 x i8> %wide.load, ptr %i.cy, align 1, !tbaa !15
  store <16 x i8> %wide.load118, ptr %i.cz, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.da = icmp eq i64 %index.next, %n.vec
  br i1 %i.da, label %middle.block, label %vector.body, !llvm.loop !529
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load122 = load <4 x i8>, ptr %i.db, align 1, !tbaa !15
  %i.dc = getelementptr inbounds nuw i8, ptr %i.ct, i64 %index121
  store <4 x i8> %wide.load122, ptr %i.dc, align 1, !tbaa !15
  %index.next123 = add nuw i64 %index121, 4       ; 2 uses
  %i.dd = icmp eq i64 %index.next123, %n.vec120
  br i1 %i.dd, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !530
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  store i8 %i.df, ptr %i.dg, align 1, !tbaa !15
  %i.dh = add nuw i64 %.030.i.prol, 1             ; 2 uses
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !531
...
._crit_edge.loopexit.i:                           ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i = load i64, ptr %i.aj, align 8, !tbaa !53
  br label %._crit_edge.i
...
._crit_edge.i:                                    ; preds = %._crit_edge.loopexit.i, %bb.m
  ...
  store i64 %i.dl, ptr %i.aj, align 8, !tbaa !53
  %i.dm = getelementptr inbounds nuw i8, ptr %.02532.i, i64 %.026.i ; 2 uses
  %.not.i = icmp eq ptr %i.dm, %i.cc
  br i1 %.not.i, label %_ZN3fmt3v126detail6bufferIcE6appendIcEEvPKT_S7_.exit, label %bb.k, !llvm.loop !116
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  store i8 %i.ds, ptr %i.dt, align 1, !tbaa !15
  ...
  br i1 %exitcond.not.i.3, label %._crit_edge.loopexit.i, label %.lr.ph.i, !llvm.loop !532
...
bb.n:                                             ; preds = %.lr.ph94, %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55
  ...
  %i.ee = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %i.ef = add i64 %i.ee, 1                        ; 3 uses
  %i.eg = load i64, ptr %i.am, align 8, !tbaa !54
  %i.eh = icmp ugt i64 %i.ef, %i.eg
  br i1 %i.eh, label %bb.o, label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55

bb.o:                                             ; preds = %bb.n
  %i.ei = load ptr, ptr %i.ed, align 8, !tbaa !55
  call void %i.ei(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ef), !inline_history !323
  %.pre.i53 = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %.pre2.i54 = add i64 %.pre.i53, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55: ; preds = %bb.n, %bb.o
  ...
  %i.ek = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i52, ptr %i.aj, align 8, !tbaa !53
  ...
  br i1 %exitcond.not, label %._crit_edge, label %bb.n, !llvm.loop !533

._crit_edge:                                      ; preds = %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit55, %_ZN3fmt3v126detail6bufferIcE6appendIcEEvPKT_S7_.exit
  %i.en = select i1 %.not88, i8 112, i8 80
  %i.eo = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %i.ep = add i64 %i.eo, 1                        ; 3 uses
  %i.eq = load i64, ptr %i.am, align 8, !tbaa !54
...
bb.p:                                             ; preds = %._crit_edge
  ...
  %i.et = load ptr, ptr %i.es, align 8, !tbaa !55
  call void %i.et(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ep), !inline_history !323
  %.pre.i57 = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %.pre2.i58 = add i64 %.pre.i57, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit59
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit59: ; preds = %._crit_edge, %bb.p
  ...
  %i.ev = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i56, ptr %i.aj, align 8, !tbaa !53
  %i.ew = getelementptr inbounds nuw i8, ptr %i.ev, i64 %i.eu
  store i8 %i.en, ptr %i.ew, align 1, !tbaa !15
  %i.ex = icmp slt i32 %i.j, 0
  %i.ey = load i64, ptr %i.aj, align 8, !tbaa !53 ; 3 uses
  %i.ez = add i64 %i.ey, 1                        ; 5 uses
  %i.fa = load i64, ptr %i.am, align 8, !tbaa !54
...
bb.r:                                             ; preds = %bb.q
  ...
  call void %i.fd(ptr noundef nonnull align 8 dereferenceable(32) %3, i64 noundef %i.ez), !inline_history !323
  %.pre.i61 = load i64, ptr %i.aj, align 8, !tbaa !53 ; 2 uses
  %.pre2.i62 = add i64 %.pre.i61, 1
  br label %_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit63
...
_ZN3fmt3v126detail6bufferIcE9push_backERKc.exit63: ; preds = %bb.q, %bb.r
  ...
  %i.ff = load ptr, ptr %3, align 8, !tbaa !51
  store i64 %.pre-phi.i60, ptr %i.aj, align 8, !tbaa !53
  %i.fg = getelementptr inbounds nuw i8, ptr %i.ff, i64 %i.fe
  store i8 45, ptr %i.fg, align 1, !tbaa !15
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit8:         ; preds = %bb.d, %bb.e
  ...
  store i8 48, ptr %i.aa, align 1, !tbaa !15
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.ac = load ptr, ptr %i.ab, align 8, !tbaa !593, !nonnull !70
  %i.ad = load i8, ptr %i.ac, align 1, !tbaa !247, !range !69, !noundef !70
  %i.ae = trunc nuw i8 %i.ad to i1
...
bb.f:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit8
  %i.af = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !594, !nonnull !70
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !15
  %i.ai = load i64, ptr %i.q, align 8, !tbaa !53  ; 2 uses
  %i.aj = add i64 %i.ai, 1                        ; 3 uses
  %i.ak = load i64, ptr %i.t, align 8, !tbaa !54
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit13:        ; preds = %bb.f, %bb.g
  ...
  store i8 %i.ah, ptr %i.aq, align 1, !tbaa !15
  %i.ar = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.as = load ptr, ptr %i.ar, align 8, !tbaa !595, !nonnull !70, !align !166
  %i.at = load i32, ptr %i.as, align 4, !tbaa !3  ; 2 uses
  %i.au = icmp sgt i32 %i.at, 0
  br i1 %i.au, label %.lr.ph.i, label %_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit
...
_ZN3fmt3v126detail6fill_nINS0_14basic_appenderIcEEicEET_S5_T0_RKT1_.exit: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit13
  %i.bf = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !596, !nonnull !70, !align !187
  %i.bh = load i64, ptr %i.bg, align 8, !tbaa !295
  %i.bi = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.bj = load ptr, ptr %i.bi, align 8, !tbaa !597, !nonnull !70, !align !166
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail5writeIcNS0_14basic_appenderIcEETnNSt9enable_ifIXsr3std7is_sameIT_cEE5valueEiE4typeELi0EEET0_S9_NS0_17basic_string_viewIS6_EERKNS0_12format_specsE(ptr %0, ptr %1, i64 %2, ptr noundef nonnull align 4 dereferenceable(16) %3) local_unnamed_addr #4 {
bb.a:
  ...
  %5 = alloca %class.anon.62, align 8             ; 6 uses
  %6 = alloca %class.anon.63, align 8             ; 6 uses
  ...
  store i8 %i.i, ptr %i.a, align 1, !tbaa !247
  %i.j = getelementptr inbounds nuw i8, ptr %3, i64 12
  %i.k = load i32, ptr %i.j, align 4, !tbaa !88   ; 3 uses
...
bb.d:                                             ; preds = %bb.c
  ...
  tail call void %i.w(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.r), !inline_history !140
  br label %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
...
.lr.ph34.i.i.i:                                   ; preds = %bb.f
  ...
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 24
  %.pre.i.i.i = load i64, ptr %i.p, align 8, !tbaa !53
  br label %bb.g
...
bb.g:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.ac = load i64, ptr %i.s, align 8, !tbaa !54
...
bb.h:                                             ; preds = %bb.g
  ...
  tail call void %i.ah(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.ai), !inline_history !598
  %i.aj = load i64, ptr %i.p, align 8, !tbaa !53  ; 2 uses
  %i.ak = load i64, ptr %i.s, align 8, !tbaa !54
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.as, align 1, !tbaa !15
  %wide.load27 = load <16 x i8>, ptr %i.at, align 1, !tbaa !15
  %i.au = getelementptr inbounds nuw i8, ptr %i.ap, i64 %index ; 2 uses
  %i.av = getelementptr inbounds nuw i8, ptr %i.au, i64 16
  store <16 x i8> %wide.load, ptr %i.au, align 1, !tbaa !15
  store <16 x i8> %wide.load27, ptr %i.av, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.aw = icmp eq i64 %index.next, %n.vec
  br i1 %i.aw, label %middle.block, label %vector.body, !llvm.loop !599
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load31 = load <4 x i8>, ptr %i.ax, align 1, !tbaa !15
  %i.ay = getelementptr inbounds nuw i8, ptr %i.ap, i64 %index30
  store <4 x i8> %wide.load31, ptr %i.ay, align 1, !tbaa !15
  %index.next32 = add nuw i64 %index30, 4         ; 2 uses
  %i.az = icmp eq i64 %index.next32, %n.vec29
  br i1 %i.az, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !600
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !601
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.p, align 8, !tbaa !53
  br label %._crit_edge.i.i.i
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.i
  ...
  store i64 %i.bh, ptr %i.p, align 8, !tbaa !53
  %i.bi = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.bi, %i.y
  br i1 %.not.i.i.i, label %_ZN3fmt3v126detail4copyIccNS0_14basic_appenderIcEEEET1_NS0_17basic_string_viewIT0_EES5_.exit, label %bb.g, !llvm.loop !116
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !602
...
bb.k:                                             ; preds = %.thread, %bb.j
  ...
  store i64 %i.ca, ptr %i.b, align 8, !tbaa !59
  ...
  store i64 %.sink, ptr %i.c, align 8, !tbaa !59
  store i64 %.sink, ptr %i.d, align 8, !tbaa !59
  store ptr %i.a, ptr %5, align 8, !tbaa !248
  %i.cc = getelementptr inbounds nuw i8, ptr %5, i64 8
  store ptr %i.c, ptr %i.cc, align 8, !tbaa !603
  %i.cd = getelementptr inbounds nuw i8, ptr %5, i64 16
  store ptr %i.b, ptr %i.cd, align 8, !tbaa !603
  %i.ce = getelementptr inbounds nuw i8, ptr %5, i64 24
  store ptr %i.d, ptr %i.ce, align 8, !tbaa !603
  %i.cf = getelementptr inbounds nuw i8, ptr %5, i64 32
  store ptr %4, ptr %i.cf, align 8, !tbaa !605
  call void @_ZN3fmt3v126detail18for_each_codepointIZNS1_5writeIcNS0_14basic_appenderIcEETnNSt9enable_ifIXsr3std7is_sameIT_cEE5valueEiE4typeELi0EEET0_SA_NS0_17basic_string_viewIS7_EERKNS0_12format_specsEEUljNSB_IcEEE_EEvSG_S7_(ptr %1, i64 %2, ptr noundef nonnull byval(%class.anon.62) align 8 %5)
  %i.cg = load i64, ptr %i.d, align 8, !tbaa !59  ; 2 uses
  %i.ch = load i64, ptr %i.c, align 8, !tbaa !59
  call void @llvm.lifetime.start.p0(ptr nonnull %6) #29
  %i.ci = load i8, ptr %i.a, align 1, !tbaa !247, !range !69, !noundef !70
  store i8 %i.ci, ptr %6, align 8, !tbaa !607
  %i.cj = getelementptr inbounds nuw i8, ptr %6, i64 8
  store i64 %i.cg, ptr %i.cj, align 8, !tbaa !609
  %i.ck = getelementptr inbounds nuw i8, ptr %6, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ck, ptr noundef nonnull align 8 dereferenceable(16) %4, i64 16, i1 false), !tbaa.struct !610
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden ptr @_ZN3fmt3v126detail20write_escaped_stringIcNS0_14basic_appenderIcEEEET0_S5_NS0_17basic_string_viewIT_EE(ptr %0, ptr %1, i64 %2) local_unnamed_addr #4 {
bb.a:
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void %i.h(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.c), !inline_history !107
  %.pre.i.i = load i64, ptr %i.a, align 8, !tbaa !53 ; 2 uses
  %.pre2.i.i = add i64 %.pre.i.i, 1
  br label %_ZN3fmt3v1214basic_appenderIcEaSEc.exit
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit:          ; preds = %bb.a, %bb.b
  ...
  store i64 %.pre-phi.i.i, ptr %i.a, align 8, !tbaa !53
  %i.k = getelementptr inbounds nuw i8, ptr %i.j, i64 %i.i
  store i8 34, ptr %i.k, align 1, !tbaa !15
...
bb.c:                                             ; preds = %bb.g, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #29
  store ptr %i.l, ptr %3, align 8, !tbaa !197, !alias.scope !611
  store ptr null, ptr %i.m, align 8, !tbaa !199, !alias.scope !611
  store i32 0, ptr %i.n, align 8, !tbaa !200, !alias.scope !611
  ...
  %i.r = load ptr, ptr %3, align 8, !tbaa !197    ; 3 uses
...
.lr.ph34.i.i:                                     ; preds = %bb.c
  ...
  %.pre.i.i13 = load i64, ptr %i.s, align 8, !tbaa !53
  br label %bb.d
...
bb.d:                                             ; preds = %._crit_edge.i.i, %.lr.ph34.i.i
  ...
  %i.x = load i64, ptr %i.t, align 8, !tbaa !54
  %i.y = sub i64 %i.x, %i.w
...
bb.e:                                             ; preds = %bb.d
  %i.ac = load ptr, ptr %i.v, align 8, !tbaa !55
  %i.ad = add i64 %i.aa, %i.w
  call void %i.ac(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.022.0, i64 noundef %i.ad), !inline_history !141
  %i.ae = load i64, ptr %i.s, align 8, !tbaa !53  ; 2 uses
  %i.af = load i64, ptr %i.t, align 8, !tbaa !54
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.ai = load ptr, ptr %.sroa.022.0, align 8, !tbaa !51 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.an, align 1, !tbaa !15
  %wide.load41 = load <16 x i8>, ptr %i.ao, align 1, !tbaa !15
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ak, i64 %index ; 2 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 16
  store <16 x i8> %wide.load, ptr %i.ap, align 1, !tbaa !15
  store <16 x i8> %wide.load41, ptr %i.aq, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ar = icmp eq i64 %index.next, %n.vec
  br i1 %i.ar, label %middle.block, label %vector.body, !llvm.loop !614
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load45 = load <4 x i8>, ptr %i.as, align 1, !tbaa !15
  %i.at = getelementptr inbounds nuw i8, ptr %i.ak, i64 %index44
  store <4 x i8> %wide.load45, ptr %i.at, align 1, !tbaa !15
  %index.next46 = add nuw i64 %index44, 4         ; 2 uses
  %i.au = icmp eq i64 %index.next46, %n.vec43
  br i1 %i.au, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !615
...
.lr.ph.i.i.prol:                                  ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.prol.loopexit, label %.lr.ph.i.i.prol, !llvm.loop !616
...
._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i = load i64, ptr %i.s, align 8, !tbaa !53
  br label %._crit_edge.i.i
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.f
  ...
  store i64 %i.bc, ptr %i.s, align 8, !tbaa !53
  %i.bd = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i = icmp eq ptr %i.bd, %i.r
  br i1 %.not.i.i, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit, label %bb.d, !llvm.loop !116
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  br i1 %exitcond.not.i.i.3, label %._crit_edge.loopexit.i.i, label %.lr.ph.i.i, !llvm.loop !617
...
_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit: ; preds = %._crit_edge.i.i, %bb.c
  %i.bu = load ptr, ptr %i.m, align 8, !tbaa !199 ; 3 uses
...
bb.g:                                             ; preds = %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit
  ...
  br i1 %.not12, label %.loopexit, label %bb.c, !llvm.loop !618
...
.loopexit:                                        ; preds = %bb.g, %.thread
  ...
  %i.bx = load i64, ptr %i.bw, align 8, !tbaa !53 ; 2 uses
  %i.by = add i64 %i.bx, 1                        ; 3 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %.sroa.022.127, i64 16
  %i.ca = load i64, ptr %i.bz, align 8, !tbaa !54
...
bb.h:                                             ; preds = %.loopexit
  ...
  %i.cd = load ptr, ptr %i.cc, align 8, !tbaa !55
  call void %i.cd(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.022.127, i64 noundef %i.by), !inline_history !107
  %.pre.i.i16 = load i64, ptr %i.bw, align 8, !tbaa !53 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit18:        ; preds = %.loopexit, %bb.h
  ...
  %i.cf = load ptr, ptr %.sroa.022.127, align 8, !tbaa !51
  store i64 %.pre-phi.i.i15, ptr %i.bw, align 8, !tbaa !53
  %i.cg = getelementptr inbounds nuw i8, ptr %i.cf, i64 %i.ce
  store i8 34, ptr %i.cg, align 1, !tbaa !15
...
bb.a:
  ...
  %3 = alloca %class.anon.66, align 8             ; 5 uses
  %i.b = alloca [7 x i8], align 1                 ; 11 uses
  %i.c = ptrtoaddr ptr %i.b to i64
  call void @llvm.lifetime.start.p0(ptr nonnull %3) #29
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %3, ptr noundef nonnull align 8 dereferenceable(40) %2, i64 40, i1 false), !tbaa.struct !619
...
bb.d:                                             ; preds = %bb.c
  ...
  %i.k = getelementptr inbounds nuw i8, ptr @.str.44, i64 %i.j
  ...
  %i.ac = load i8, ptr %i.ab, align 1, !tbaa !15  ; 2 uses
  %i.ad = and i8 %i.ac, 63
  ...
  br i1 %i.bp, label %bb.c, label %.thread, !llvm.loop !620
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep49, align 1, !tbaa !15
  %wide.load50 = load <16 x i8>, ptr %i.bz, align 1, !tbaa !15
  %i.ca = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !15
  store <16 x i8> %wide.load50, ptr %i.ca, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.cb = icmp eq i64 %index.next, %n.vec
  br i1 %i.cb, label %middle.block, label %vector.body, !llvm.loop !621
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load57 = load <4 x i8>, ptr %next.gep56, align 1, !tbaa !15
  store <4 x i8> %wide.load57, ptr %next.gep55, align 1, !tbaa !15
  %index.next58 = add nuw i64 %index54, 4         ; 2 uses
  %i.ce = icmp eq i64 %index.next58, %n.vec53
  br i1 %i.ce, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !622
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  %i.ci = load i8, ptr %.057.i.prol, align 1, !tbaa !15
  %i.cj = getelementptr inbounds nuw i8, ptr %.08.i.prol, i64 1 ; 2 uses
  store i8 %i.ci, ptr %.08.i.prol, align 1, !tbaa !15
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !623
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.cn = load i8, ptr %.057.i, align 1, !tbaa !15
  %i.co = getelementptr inbounds nuw i8, ptr %.08.i, i64 1
  store i8 %i.cn, ptr %.08.i, align 1, !tbaa !15
  %i.cp = getelementptr inbounds nuw i8, ptr %.057.i, i64 2
  %i.cq = load i8, ptr %i.cm, align 1, !tbaa !15
  ...
  %i.ct = load i8, ptr %i.cp, align 1, !tbaa !15
  ...
  %i.cw = load i8, ptr %i.cs, align 1, !tbaa !15
  ...
  %i.cz = load i8, ptr %i.cv, align 1, !tbaa !15
  ...
  %i.dc = load i8, ptr %i.cy, align 1, !tbaa !15
  ...
  %i.df = load i8, ptr %i.db, align 1, !tbaa !15
...
_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit: ; preds = %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit.preheader, %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit
  ...
  %i.dl = load i8, ptr %.022, align 1, !tbaa !15
  %i.dm = zext i8 %i.dl to i32                    ; 2 uses
  %i.dn = lshr i32 %i.dm, 3                       ; 2 uses
  %i.do = zext nneg i32 %i.dn to i64
  %i.dp = getelementptr inbounds nuw i8, ptr @.str.44, i64 %i.do
  ...
  br i1 %or.cond, label %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit, label %bb.e, !llvm.loop !625
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ac = load i8, ptr %4, align 8, !tbaa !607, !range !69, !noundef !70
  %i.ad = trunc nuw i8 %i.ac to i1
  br i1 %i.ad, label %bb.e, label %bb.f

bb.e:                                             ; preds = %bb.d
  %i.ae = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.af = load i64, ptr %i.ae, align 8, !tbaa !609
  %i.ag = getelementptr inbounds nuw i8, ptr %4, i64 16
  %.sroa.01.0.copyload.i = load ptr, ptr %i.ag, align 8, !tbaa !58
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.ak = load ptr, ptr %i.aj, align 8, !tbaa !227 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.am = load i64, ptr %i.al, align 8, !tbaa !609 ; 2 uses
...
bb.g:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.at = load i64, ptr %i.ap, align 8, !tbaa !54
  %i.au = sub i64 %i.at, %i.as
...
bb.h:                                             ; preds = %bb.g
  %i.ay = load ptr, ptr %i.ar, align 8, !tbaa !55
  %i.az = add i64 %i.aw, %i.as
  tail call void %i.ay(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.az), !inline_history !626
  %i.ba = load i64, ptr %i.ao, align 8, !tbaa !53 ; 2 uses
  %i.bb = load i64, ptr %i.ap, align 8, !tbaa !54
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  %i.be = load ptr, ptr %.sroa.09.0, align 8, !tbaa !51 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.bj, align 1, !tbaa !15
  %wide.load36 = load <16 x i8>, ptr %i.bk, align 1, !tbaa !15
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bg, i64 %index ; 2 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 16
  store <16 x i8> %wide.load, ptr %i.bl, align 1, !tbaa !15
  store <16 x i8> %wide.load36, ptr %i.bm, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bn = icmp eq i64 %index.next, %n.vec
  br i1 %i.bn, label %middle.block, label %vector.body, !llvm.loop !627
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load40 = load <4 x i8>, ptr %i.bo, align 1, !tbaa !15
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bg, i64 %index39
  store <4 x i8> %wide.load40, ptr %i.bp, align 1, !tbaa !15
  %index.next41 = add nuw i64 %index39, 4         ; 2 uses
  %i.bq = icmp eq i64 %index.next41, %n.vec38
  br i1 %i.bq, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !628
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !629
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.ao, align 8, !tbaa !53
  br label %._crit_edge.i.i.i

._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.i
  %i.bx = phi i64 [ %.pre37.i.i.i, %._crit_edge.loopexit.i.i.i ], [ %.027.i.i.i, %bb.i ]
  %i.by = add i64 %i.bx, %.026.i.i.i              ; 2 uses
  store i64 %i.by, ptr %i.ao, align 8, !tbaa !53
  %i.bz = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.bz, %i.an
  br i1 %.not.i.i.i, label %_ZZN3fmt3v126detail5writeIcNS0_14basic_appenderIcEETnNSt9enable_ifIXsr3std7is_sameIT_cEE5valueEiE4typeELi0EEET0_S9_NS0_17basic_string_viewIS6_EERKNS0_12format_specsEENKUlS4_E_clES4_.exit, label %bb.g, !llvm.loop !116
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  store i8 %i.cj, ptr %i.ck, align 1, !tbaa !15
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !630
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden void @_ZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_(ptr %0, i64 %1, ptr %2) local_unnamed_addr #4 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64
  %i.b = alloca [7 x i8], align 1                 ; 11 uses
  %i.c = ptrtoaddr ptr %i.b to i64
...
.lr.ph:                                           ; preds = %bb.b, %_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit
  ...
  %i.g = load i8, ptr %.055, align 1, !tbaa !15
  %i.h = zext i8 %i.g to i32                      ; 2 uses
  %i.i = lshr i32 %i.h, 3                         ; 2 uses
  %i.j = zext nneg i32 %i.i to i64
  %i.k = getelementptr inbounds nuw i8, ptr @.str.44, i64 %i.j
...
_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit.thread: ; preds = %.lr.ph, %switch.early.test.i.i.i, %switch.early.test.i.i.i, %switch.early.test.i.i.i, %_ZN3fmt3v126detail12needs_escapeEj.exit.i.i
  ...
  store ptr %.055, ptr %2, align 8, !tbaa !58
  %.sroa.4.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %2, i64 8
  store ptr %i.br, ptr %.sroa.4.0..sroa_idx.i.i, align 8, !tbaa !58
...
_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit: ; preds = %_ZN3fmt3v126detail12needs_escapeEj.exit.i.i
  ...
  br i1 %.not30, label %.lr.ph, label %.loopexit, !llvm.loop !631
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep106, align 1, !tbaa !15
  %wide.load107 = load <16 x i8>, ptr %i.cb, align 1, !tbaa !15
  %i.cc = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !15
  store <16 x i8> %wide.load107, ptr %i.cc, align 1, !tbaa !15
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.cd = icmp eq i64 %index.next, %n.vec
  br i1 %i.cd, label %middle.block, label %vector.body, !llvm.loop !632
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load114 = load <4 x i8>, ptr %next.gep113, align 1, !tbaa !15
  store <4 x i8> %wide.load114, ptr %next.gep112, align 1, !tbaa !15
  %index.next115 = add nuw i64 %index111, 4       ; 2 uses
  %i.cg = icmp eq i64 %index.next115, %n.vec110
  br i1 %i.cg, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !633
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  %i.ck = load i8, ptr %.057.i.prol, align 1, !tbaa !15
  %i.cl = getelementptr inbounds nuw i8, ptr %.08.i.prol, i64 1 ; 2 uses
  store i8 %i.ck, ptr %.08.i.prol, align 1, !tbaa !15
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !634
...
_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit: ; preds = %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit.preheader, %_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit42
  ...
  %i.dn = load i8, ptr %.022, align 1, !tbaa !15
  %i.do = zext i8 %i.dn to i32                    ; 2 uses
  %i.dp = lshr i32 %i.do, 3                       ; 2 uses
  %i.dq = zext nneg i32 %i.dp to i64
  %i.dr = getelementptr inbounds nuw i8, ptr @.str.44, i64 %i.dq
  %i.ds = load i8, ptr %i.dr, align 1, !tbaa !15
  ...
  %i.ed = load i8, ptr %i.ec, align 1, !tbaa !15  ; 2 uses
  %i.ee = and i8 %i.ed, 63
  ...
  %i.ep = load i8, ptr %i.eo, align 1, !tbaa !15  ; 2 uses
  %i.eq = and i8 %i.ep, 63
