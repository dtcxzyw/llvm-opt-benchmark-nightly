...
bb.e:                                             ; preds = %bb.d
  ...
  br i1 %.not26.i, label %.critedge.i, label %.loopexit
...
._crit_edge.i:                                    ; preds = %.critedge.i
  ...
  br i1 %i.aw, label %.lr.ph.i, label %.loopexit, !llvm.loop !137

.loopexit:                                        ; preds = %._crit_edge.i, %bb.e
  %10 = phi i1 [ false, %bb.e ], [ true, %._crit_edge.i ] ; 2 uses
  %11 = xor i1 %10, true
...
.thread:                                          ; preds = %._crit_edge.i80, %PixelsAreSimilar.exit.i, %bb.i, %bb.h, %bb.g, %.lr.ph35.i, %.thread99, %CopyCurrentCanvas.exit
  %not..i = phi i32 [ 1, %CopyCurrentCanvas.exit ], [ %13, %PixelsAreSimilar.exit.i ], [ %13, %.thread99 ], [ %13, %.lr.ph35.i ], [ %13, %bb.g ], [ %13, %bb.h ], [ %13, %bb.i ], [ %13, %._crit_edge.i80 ]
  %i.dn = phi i1 [ false, %CopyCurrentCanvas.exit ], [ %14, %PixelsAreSimilar.exit.i ], [ %14, %.thread99 ], [ %14, %.lr.ph35.i ], [ %14, %bb.g ], [ %14, %bb.h ], [ %14, %bb.i ], [ %14, %._crit_edge.i80 ] ; 2 uses
  %i.do = phi i1 [ false, %CopyCurrentCanvas.exit ], [ false, %PixelsAreSimilar.exit.i ], [ true, %.thread99 ], [ true, %.lr.ph35.i ], [ false, %bb.g ], [ false, %bb.h ], [ false, %bb.i ], [ true, %._crit_edge.i80 ] ; 3 uses
