...
.lr.ph35.i:                                       ; preds = %.thread99
  ...
  br i1 %i.bp, label %.lr.ph35.split.us.i, label %.thread
...
.lr.ph35.split.us.i:                              ; preds = %.lr.ph35.i
  ...
  %i.cc = sext i32 %i.bh to i64
  %i.cd = sext i32 %i.by to i64
  br label %.lr.ph.us.i74

.lr.ph.us.i74:                                    ; preds = %._crit_edge.us.i79, %.lr.ph35.split.us.i
  %indvars.iv39.i = phi i64 [ %indvars.iv.next40.i, %._crit_edge.us.i79 ], [ %i.cb, %.lr.ph35.split.us.i ] ; 3 uses
  %i.ce = mul nsw i64 %indvars.iv39.i, %i.cd
  %i.cf = getelementptr [4 x i8], ptr %i.bx, i64 %i.ce
  br label %bb.f

bb.f:                                             ; preds = %.critedge.us.i77, %.lr.ph.us.i74
  %indvars.iv.i75 = phi i64 [ %i.bz, %.lr.ph.us.i74 ], [ %indvars.iv.next.i78, %.critedge.us.i77 ] ; 3 uses
  %i.cg = getelementptr [4 x i8], ptr %i.cf, i64 %indvars.iv.i75
  %i.ch = load i32, ptr %i.cg, align 4, !tbaa !3  ; 5 uses
  %.not.us.i76 = icmp ugt i32 %i.ch, -16777217
...
bb.g:                                             ; preds = %bb.f
  ...
  %i.cl = mul nsw i64 %indvars.iv39.i, %i.ck
  %i.cm = getelementptr [4 x i8], ptr %i.ci, i64 %i.cl
  %i.cn = getelementptr [4 x i8], ptr %i.cm, i64 %indvars.iv.i75
...
bb.h:                                             ; preds = %bb.g
  ...
  %.not.i.us.i = icmp sgt i32 %i.de, %i.bs
...
bb.i:                                             ; preds = %bb.h
  ...
  %.not23.i.us.i = icmp samesign ugt i32 %i.dh, %i.bs
...
PixelsAreSimilar.exit.us.i:                       ; preds = %bb.i
  ...
  %.not30.us.i = icmp samesign ugt i32 %i.dk, %i.bs
...
.critedge.us.i77:                                 ; preds = %PixelsAreSimilar.exit.us.i, %bb.f
  ...
  %i.dl = icmp slt i64 %indvars.iv.next.i78, %i.ca
  br i1 %i.dl, label %bb.f, label %._crit_edge.us.i79, !llvm.loop !138

._crit_edge.us.i79:                               ; preds = %.critedge.us.i77
  %indvars.iv.next40.i = add nsw i64 %indvars.iv39.i, 1 ; 2 uses
  %i.dm = icmp slt i64 %indvars.iv.next40.i, %i.cc
...
bb.o:                                             ; preds = %._crit_edge.i, %.lr.ph32.i
  %i.er = phi i32 [ %i.eh, %.lr.ph32.i ], [ %i.ft, %._crit_edge.i ]
  %i.es = phi i32 [ %i.ej, %.lr.ph32.i ], [ %i.fu, %._crit_edge.i ]
  %i.et = phi i32 [ %.pre36.i, %.lr.ph32.i ], [ %i.fv, %._crit_edge.i ] ; 2 uses
  %i.eu = phi i32 [ %.pre.i, %.lr.ph32.i ], [ %i.fw, %._crit_edge.i ] ; 2 uses
  %i.ev = phi i32 [ %.pre36.i, %.lr.ph32.i ], [ %i.fx, %._crit_edge.i ] ; 2 uses
  %i.ew = phi i32 [ %.pre.i, %.lr.ph32.i ], [ %i.fy, %._crit_edge.i ] ; 2 uses
  %.02430.i = phi i32 [ %i.ej, %.lr.ph32.i ], [ %i.fz, %._crit_edge.i ] ; 3 uses
  ...
  br i1 %i.ff, label %.lr.ph.preheader.i, label %._crit_edge.i
...
.lr.ph.i:                                         ; preds = %bb.q, %.lr.ph.preheader.i
  ...
  %indvars.iv.i82 = phi i64 [ %i.fg, %.lr.ph.preheader.i ], [ %indvars.iv.next.i84, %bb.q ] ; 3 uses
  %.127.i = phi i32 [ %.02529.i, %.lr.ph.preheader.i ], [ %.2.i, %bb.q ]
  %i.fj = getelementptr inbounds [4 x i8], ptr %i.fa, i64 %indvars.iv.i82
  %i.fk = load i32, ptr %i.fj, align 4, !tbaa !3
  %i.fl = getelementptr inbounds [4 x i8], ptr %i.fe, i64 %indvars.iv.i82 ; 2 uses
  %i.fm = load i32, ptr %i.fl, align 4, !tbaa !3  ; 2 uses
  %i.fn = icmp ne i32 %i.fk, %i.fm
  %.not.i83 = icmp eq i32 %i.fm, 0
  %or.cond.i = or i1 %i.fn, %.not.i83
...
bb.q:                                             ; preds = %bb.p, %.lr.ph.i
  %i.fo = phi i32 [ %.pre38.i, %bb.p ], [ %i.fh, %.lr.ph.i ] ; 4 uses
  %i.fp = phi i32 [ %.pre37.i, %bb.p ], [ %i.fi, %.lr.ph.i ] ; 4 uses
  ...
  %i.fs = icmp slt i64 %indvars.iv.next.i84, %i.fr
  br i1 %i.fs, label %.lr.ph.i, label %._crit_edge.loopexit.i, !llvm.loop !140
...
bb.r:                                             ; preds = %IncreaseTransparency.exit, %CopyCurrentCanvas.exit81
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %i.ge, ptr noundef nonnull readonly align 4 dereferenceable(16) %i.gd, i64 16, i1 false), !tbaa.struct !84
