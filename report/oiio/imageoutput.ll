...
bb.ar:                                            ; preds = %bb.aq
  ...
  store i64 6, ptr %i.gd, align 8, !tbaa !77
  %i.ge = load ptr, ptr %0, align 8, !tbaa !40
  %i.gf = getelementptr inbounds nuw i8, ptr %i.ge, i64 24
  %i.gg = load ptr, ptr %i.gf, align 8
  %i.gh = call noundef i32 %i.gg(ptr noundef nonnull align 8 dereferenceable(184) %0, ptr noundef nonnull dead_on_return %12)
  %.not33 = icmp eq i32 %i.gh, 0
  br i1 %.not33, label %bb.as, label %bb.au

bb.as:                                            ; preds = %bb.ar
  %i.gi = and i64 %4, 4294967296
  %.not34 = icmp eq i64 %i.gi, 0
  br i1 %.not34, label %.sink.split, label %bb.at

bb.at:                                            ; preds = %bb.as
  call void @llvm.lifetime.start.p0(ptr nonnull %i.p) #2
  %i.gj = load ptr, ptr %0, align 8, !tbaa !40
  %i.gk = getelementptr inbounds nuw i8, ptr %i.gj, i64 16
  %i.gl = load ptr, ptr %i.gk, align 8
  %i.gm = call noundef ptr %i.gl(ptr noundef nonnull align 8 dereferenceable(184) %0)
  store ptr %i.gm, ptr %i.p, align 8, !tbaa !227
...
bb.av:                                            ; preds = %bb.au
  ...
  store i64 14, ptr %i.gn, align 8, !tbaa !77
  %i.go = load ptr, ptr %0, align 8, !tbaa !40
  %i.gp = getelementptr inbounds nuw i8, ptr %i.go, i64 24
  %i.gq = load ptr, ptr %i.gp, align 8
  %i.gr = call noundef i32 %i.gq(ptr noundef nonnull align 8 dereferenceable(184) %0, ptr noundef nonnull dead_on_return %13)
  %.not35 = icmp eq i32 %i.gr, 0
  br i1 %.not35, label %bb.aw, label %bb.ay

bb.aw:                                            ; preds = %bb.av
  %i.gs = and i64 %4, 4294967296
  %.not36 = icmp eq i64 %i.gs, 0
  br i1 %.not36, label %.sink.split, label %bb.ax

bb.ax:                                            ; preds = %bb.aw
  call void @llvm.lifetime.start.p0(ptr nonnull %i.q) #2
  %i.gt = load ptr, ptr %0, align 8, !tbaa !40
  %i.gu = getelementptr inbounds nuw i8, ptr %i.gt, i64 16
  %i.gv = load ptr, ptr %i.gu, align 8
  %i.gw = call noundef ptr %i.gv(ptr noundef nonnull align 8 dereferenceable(184) %0)
  store ptr %i.gw, ptr %i.q, align 8, !tbaa !227
...
bb.ay:                                            ; preds = %.sink.split, %bb.au, %bb.aq, %bb.av
  ...
  store i64 7, ptr %i.gx, align 8, !tbaa !77
  %i.gy = call noundef zeroext i1 @_ZNK11OpenImageIO4v3_114ParamValueList8containsENS0_17basic_string_viewIcSt11char_traitsIcEEENS0_8TypeDescEb(ptr noundef nonnull align 8 dereferenceable(24) %i.at, ptr noundef nonnull dead_on_return %14, i64 256, i1 noundef zeroext true)
  br i1 %i.gy, label %bb.az, label %bb.bb

bb.az:                                            ; preds = %bb.ay
  store ptr @.str.22, ptr %15, align 8, !tbaa !75
  %i.gz = getelementptr inbounds nuw i8, ptr %15, i64 8
  store i64 7, ptr %i.gz, align 8, !tbaa !77
  %i.ha = load ptr, ptr %0, align 8, !tbaa !40
  %i.hb = getelementptr inbounds nuw i8, ptr %i.ha, i64 24
  %i.hc = load ptr, ptr %i.hb, align 8
  %i.hd = call noundef i32 %i.hc(ptr noundef nonnull align 8 dereferenceable(184) %0, ptr noundef nonnull dead_on_return %15)
  %.not37 = icmp eq i32 %i.hd, 0
  br i1 %.not37, label %bb.ba, label %bb.bb

bb.ba:                                            ; preds = %bb.az
  call void @llvm.lifetime.start.p0(ptr nonnull %i.r) #2
  %i.he = load ptr, ptr %0, align 8, !tbaa !40
  %i.hf = getelementptr inbounds nuw i8, ptr %i.he, i64 16
  %i.hg = load ptr, ptr %i.hf, align 8
  %i.hh = call noundef ptr %i.hg(ptr noundef nonnull align 8 dereferenceable(184) %0)
  store ptr %i.hh, ptr %i.r, align 8, !tbaa !227
