...
.lr.ph.i:                                         ; preds = %.preheader111.i, %bb.i
  ...
  %i.aa = call i32 @FT_Stream_ReadFields(ptr noundef %0, ptr noundef nonnull @pcf_table_header, ptr noundef %.084116.i) #13 ; 2 uses
...
pcf_read_TOC.exit:                                ; preds = %.lr.ph.i, %bb.r
  ...
  call void @ft_mem_free(ptr noundef %i.g, ptr noundef %i.bx) #13
