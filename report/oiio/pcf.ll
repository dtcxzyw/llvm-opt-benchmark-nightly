...
bb.a:
  %i.a = tail call ptr @ft_service_list_lookup(ptr noundef nonnull @pcf_services, ptr noundef %1) #13
  ret ptr %i.a
}
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = tail call i32 @FT_Stream_OpenGzip(ptr noundef nonnull %i.c, ptr noundef %0) #13 ; 2 uses
  %i.e = and i32 %i.d, 255
...
bb.d:                                             ; preds = %bb.c
  %i.g = tail call i32 @FT_Stream_OpenLZW(ptr noundef nonnull %i.c, ptr noundef %0) #13
...
bb.h:                                             ; preds = %bb.f
  ...
  br i1 %or.cond, label %bb.i, label %.thread84

bb.i:                                             ; preds = %bb.h
  %i.s = load i8, ptr %i.n, align 1, !tbaa !40
  switch i8 %i.s, label %.thread84 [
    i8 105, label %bb.j
    i8 73, label %bb.j
  ]
...
bb.l:                                             ; preds = %bb.k, %bb.k
  ...
  %i.y = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.x, ptr noundef nonnull dereferenceable(6) @.str.5) #14
  %.not73 = icmp eq i32 %i.y, 0
  br i1 %.not73, label %.thread87, label %bb.m

bb.m:                                             ; preds = %bb.l
  %i.z = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.x, ptr noundef nonnull dereferenceable(5) @.str.6) #14
  %.not74 = icmp eq i32 %i.z, 0
  br i1 %.not74, label %sub_0, label %.tail.thread

sub_0:                                            ; preds = %bb.m
  %i.aa = load i8, ptr %i.p, align 1
  %.not90 = icmp eq i8 %i.aa, 49
  br i1 %.not90, label %.tail, label %.tail.thread

.tail:                                            ; preds = %sub_0
  %i.ab = getelementptr inbounds nuw i8, ptr %i.p, i64 1
  %i.ac = load i8, ptr %i.ab, align 1
  %i.ad = icmp eq i8 %i.ac, 0
  br i1 %i.ad, label %.thread87, label %.tail.thread

.tail.thread:                                     ; preds = %sub_0, %.tail, %bb.m
  %i.ae = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.x, ptr noundef nonnull dereferenceable(9) @.str.8) #14
  %.not76 = icmp eq i32 %i.ae, 0
  br i1 %.not76, label %bb.n, label %.thread84

.thread84:                                        ; preds = %bb.h, %.tail.thread, %bb.i, %bb.k, %bb.j
...
.thread87:                                        ; preds = %bb.l, %.tail
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #13
  store ptr %1, ptr %5, align 8, !tbaa !41
  %i.ag = getelementptr inbounds nuw i8, ptr %5, i64 8 ; 2 uses
  %i.ah = getelementptr inbounds nuw i8, ptr %5, i64 12
  %i.ai = getelementptr inbounds nuw i8, ptr %5, i64 14
  store i64 0, ptr %i.ag, align 8
  br label %bb.o

bb.n:                                             ; preds = %.tail.thread
  %i.aj = tail call i32 @strcmp(ptr noundef nonnull dereferenceable(1) %i.p, ptr noundef nonnull dereferenceable(4) @.str.9) #14
  %.not77.not = icmp eq i32 %i.aj, 0
  call void @llvm.lifetime.start.p0(ptr nonnull %5) #13
  store ptr %1, ptr %5, align 8, !tbaa !41
  %i.ak = getelementptr inbounds nuw i8, ptr %5, i64 8 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %5, i64 12
  %i.am = getelementptr inbounds nuw i8, ptr %5, i64 14
  store i64 0, ptr %i.ak, align 8
  br i1 %.not77.not, label %bb.o, label %bb.p

bb.o:                                             ; preds = %.thread87, %bb.n
  %i.an = phi ptr [ %i.ai, %.thread87 ], [ %i.am, %bb.n ]
  %i.ao = phi ptr [ %i.ah, %.thread87 ], [ %i.al, %bb.n ]
end_hunk_0
...
bb.k:                                             ; preds = %.lr.ph118.i
  %.sroa.0.0.copyload = load <32 x i8>, ptr %i.as, align 8
  ...
  store <32 x i8> %.sroa.0.0.copyload, ptr %i.aw, align 8
...
pcf_read_TOC.exit:                                ; preds = %.lr.ph.i, %bb.o, %bb.q, %bb.s
  ...
  call void @ft_mem_free(ptr noundef %i.g, ptr noundef %i.ci) #13
...
bb.z:                                             ; preds = %bb.y
  ...
  %i.cz = call i32 @FT_Stream_Skip(ptr noundef nonnull %0, i64 noundef %i.cy) #13
...
bb.aa:                                            ; preds = %bb.z
  ...
  %i.dc = call i32 @FT_Stream_ReadULongLE(ptr noundef nonnull %0, ptr noundef nonnull %i.c) #13 ; 2 uses
...
bb.ac:                                            ; preds = %bb.ab
  %i.dg = call i32 @FT_Stream_ReadULong(ptr noundef nonnull %0, ptr noundef nonnull %i.c) #13
  br label %bb.ae

bb.ad:                                            ; preds = %bb.ab
  %i.dh = call i32 @FT_Stream_ReadULongLE(ptr noundef nonnull %0, ptr noundef nonnull %i.c) #13
  br label %bb.ae
...
bb.ag:                                            ; preds = %bb.af
  ...
  %i.dm = call ptr @ft_mem_qrealloc(ptr noundef %i.cn, i64 noundef 24, i64 noundef 0, i64 noundef %..091.i, ptr noundef null, ptr noundef nonnull %i.c) #13 ; 19 uses
...
.lr.ph.split.us.i:                                ; preds = %.lr.ph.i197, %bb.ah
  ...
  %i.dp = call i32 @FT_Stream_ReadFields(ptr noundef nonnull %0, ptr noundef nonnull @pcf_property_header, ptr noundef %i.do) #13 ; 2 uses
...
.lr.ph.split.i:                                   ; preds = %.lr.ph.i197, %bb.ai
  ...
  %i.ds = call i32 @FT_Stream_ReadFields(ptr noundef nonnull %0, ptr noundef nonnull @pcf_property_msb_header, ptr noundef %i.dr) #13 ; 2 uses
