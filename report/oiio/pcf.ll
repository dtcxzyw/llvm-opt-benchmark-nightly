...
begin_hunk_3
  ...
  %i.bq = call ptr @ft_mem_qalloc(ptr noundef %i.c, i64 noundef %.277, ptr noundef nonnull %i.a) #14 ; 47 uses
...
vector.body:                                      ; preds = %pred.store.continue317, %vector.ph
  %index = phi i64 [ 0, %vector.ph ], [ %index.next, %pred.store.continue317 ] ; 34 uses
  %i.bt = getelementptr inbounds nuw i8, ptr %i.bq, i64 %index ; 2 uses
...
pred.store.if:                                    ; preds = %vector.body
  %1 = getelementptr inbounds nuw i8, ptr %i.bq, i64 %index
  store i8 45, ptr %1, align 1, !tbaa !40
...
vec.epilog.vector.body:                           ; preds = %pred.store.continue337, %vec.epilog.ph
  %index320 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next338, %pred.store.continue337 ] ; 10 uses
  %i.fo = getelementptr inbounds nuw i8, ptr %i.bq, i64 %index320
...
pred.store.if322:                                 ; preds = %vec.epilog.vector.body
  %2 = getelementptr inbounds nuw i8, ptr %i.bq, i64 %index320
  store i8 45, ptr %2, align 1, !tbaa !40
  br label %pred.store.continue323

pred.store.continue323:                           ; preds = %pred.store.if322, %vec.epilog.vector.body
...
bb.y:                                             ; preds = %bb.w, %bb.x
  %.174.3 = phi ptr [ %i.gz, %bb.x ], [ %.2.2, %bb.w ] ; 45 uses
...
vector.body348:                                   ; preds = %pred.store.continue415, %vector.ph345
  %index349 = phi i64 [ 0, %vector.ph345 ], [ %index.next416, %pred.store.continue415 ] ; 34 uses
  %i.ha = getelementptr inbounds nuw i8, ptr %.174.3, i64 %index349 ; 2 uses
...
pred.store.if352:                                 ; preds = %vector.body348
  %3 = getelementptr inbounds nuw i8, ptr %.174.3, i64 %index349
  store i8 45, ptr %3, align 1, !tbaa !40
  br label %pred.store.continue353

pred.store.continue353:                           ; preds = %pred.store.if352, %vector.body348
...
pred.store.continue415:                           ; preds = %pred.store.if414, %pred.store.continue413
...
vec.epilog.vector.body426:                        ; preds = %pred.store.continue444, %vec.epilog.ph423
  %index427 = phi i64 [ %vec.epilog.resume.val419, %vec.epilog.ph423 ], [ %index.next445, %pred.store.continue444 ] ; 10 uses
  %i.kv = getelementptr inbounds nuw i8, ptr %.174.3, i64 %index427
...
pred.store.if429:                                 ; preds = %vec.epilog.vector.body426
  %4 = getelementptr inbounds nuw i8, ptr %.174.3, i64 %index427
  store i8 45, ptr %4, align 1, !tbaa !40
  br label %pred.store.continue430

pred.store.continue430:                           ; preds = %pred.store.if429, %vec.epilog.vector.body426
