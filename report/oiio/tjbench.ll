...
bb.g:                                             ; preds = %bb.f, %bb.c
  ...
  %7 = insertelement <2 x double> poison, double %i.ar, i64 0
...
bb.ef:                                            ; preds = %bb.ee
  ...
  %8 = insertelement <2 x double> %7, double %i.se, i64 1
  %9 = insertelement <2 x double> <double poison, double 8.000000e+00>, double %i.sa, i64 0
  %10 = fmul <2 x double> %8, %9                  ; 2 uses
  %11 = insertelement <2 x double> <double poison, double 1.000000e+06>, double %.1581.lcssa, i64 0
  %12 = fdiv <2 x double> %10, %11                ; 2 uses
  %13 = extractelement <2 x double> %12, i64 0
  %14 = call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.275, double noundef %13) ; 0 uses
  %15 = extractelement <2 x double> %12, i64 1
  %i.sh = fmul double %15, %i.sa
...
bb.eg:                                            ; preds = %._crit_edge1483, %bb.ef
  %.pre-phi1485 = phi double [ %.pre1484, %._crit_edge1483 ], [ %16, %bb.ef ]
...
bb.dd:                                            ; preds = %.split858.us
  ...
  %12 = insertelement <2 x double> poison, double %i.oq, i64 0
  %13 = insertelement <2 x double> %12, double %11, i64 1
  %14 = insertelement <2 x double> <double poison, double 1.000000e+06>, double %.3506, i64 0
  %15 = fdiv <2 x double> %13, %14                ; 2 uses
  %16 = extractelement <2 x double> %15, i64 0
  %17 = tail call i32 (ptr, ...) @printf(ptr noundef nonnull dereferenceable(1) @.str.310, ptr noundef nonnull %i.op, double noundef %16) ; 0 uses
  %18 = extractelement <2 x double> %15, i64 1
  %i.or = fmul double %18, %i.oq                  ; 2 uses
