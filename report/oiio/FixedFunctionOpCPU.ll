...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = shufflevector <4 x float> %i.aq, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %5 = fcmp oeq <8 x float> %4, zeroinitializer
  %i.be = shufflevector <4 x float> %i.aq, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %6 = fdiv <8 x float> splat (float 1.000000e+00), %i.be
  %7 = select <8 x i1> %5, <8 x float> zeroinitializer, <8 x float> %6
  %i.bf = fmul <8 x float> %i.bd, %7
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %4 = shufflevector <4 x float> %i.aq, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %5 = fcmp oeq <8 x float> %4, zeroinitializer
  %i.bf = shufflevector <4 x float> %i.aq, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 0, i32 1, i32 2, i32 3>
  %6 = fdiv <8 x float> splat (float 1.000000e+00), %i.bf
  %7 = select <8 x i1> %5, <8 x float> zeroinitializer, <8 x float> %6
  %i.bg = fmul <8 x float> %i.be, %7
