...
_ZNSt8functionIFvPKcEEC2ERKS3_.exit.i:            ; preds = %bb.c, %bb.a
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %1, ptr noundef nonnull align 8 dereferenceable(32) @_ZN16OpenColorIO_v2_512_GLOBAL__N_117g_loggingFunctionE, i64 16, i1 false), !tbaa.struct !46
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) @_ZN16OpenColorIO_v2_512_GLOBAL__N_117g_loggingFunctionE, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i, i64 16, i1 false), !tbaa.struct !46
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0.i.i.i)
  %i.k = load <2 x ptr>, ptr getelementptr inbounds nuw (i8, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_117g_loggingFunctionE, i64 16), align 8, !tbaa !45
  %i.l = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_117g_loggingFunctionE, i64 16), align 8, !tbaa !45 ; 2 uses
  store <2 x ptr> %i.k, ptr %i.a, align 8, !tbaa !45
  store <2 x ptr> %2, ptr getelementptr inbounds nuw (i8, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_117g_loggingFunctionE, i64 16), align 8, !tbaa !45
...
bb.a:
  ...
  store ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_122DefaultLoggingFunctionEPKc, ptr %0, align 8, !tbaa !45
  call void @llvm.lifetime.start.p0(ptr nonnull %.sroa.0.i.i.i)
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i, ptr noundef nonnull align 8 dereferenceable(32) %0, i64 16, i1 false), !tbaa.struct !46
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef nonnull align 8 dereferenceable(32) @_ZN16OpenColorIO_v2_512_GLOBAL__N_117g_loggingFunctionE, i64 16, i1 false), !tbaa.struct !46
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(32) @_ZN16OpenColorIO_v2_512_GLOBAL__N_117g_loggingFunctionE, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.0.i.i.i, i64 16, i1 false), !tbaa.struct !46
  call void @llvm.lifetime.end.p0(ptr nonnull %.sroa.0.i.i.i)
  %i.c = load <2 x ptr>, ptr getelementptr inbounds nuw (i8, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_117g_loggingFunctionE, i64 16), align 8, !tbaa !45
  %i.d = load ptr, ptr getelementptr inbounds nuw (i8, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_117g_loggingFunctionE, i64 16), align 8, !tbaa !45 ; 2 uses
  store ptr @_ZNSt17_Function_handlerIFvPKcEPS2_E10_M_managerERSt9_Any_dataRKS5_St18_Manager_operation, ptr getelementptr inbounds nuw (i8, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_117g_loggingFunctionE, i64 16), align 8, !tbaa !45
  store <2 x ptr> %i.c, ptr %i.a, align 8, !tbaa !45
...
bb.a:
  ...
  store ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_122DefaultLoggingFunctionEPKc, ptr @_ZN16OpenColorIO_v2_512_GLOBAL__N_117g_loggingFunctionE, align 8, !tbaa !45
