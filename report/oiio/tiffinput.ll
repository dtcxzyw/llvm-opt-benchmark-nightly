...
.preheader209.lr.ph:                              ; preds = %.critedge
  ...
  br i1 %or.cond348, label %.preheader209.lr.ph.split.us.split.us, label %_ZNSt10unique_ptrIA_St4byteSt14default_deleteIS1_EED2Ev.exit158

.preheader209.lr.ph.split.us.split.us:            ; preds = %.preheader209.lr.ph
  %19 = getelementptr inbounds nuw i8, ptr %14, i64 8
  store ptr %i.cc, ptr %14, align 8
  store i64 %i.x, ptr %19, align 8
  br label %.preheader209.us.us

.preheader209.us.us:                              ; preds = %..critedge152_crit_edge.split.us.us.us, %.preheader209.lr.ph.split.us.split.us
  %.095262.us.us = phi i32 [ %7, %.preheader209.lr.ph.split.us.split.us ], [ %i.dd, %..critedge152_crit_edge.split.us.us.us ] ; 3 uses
