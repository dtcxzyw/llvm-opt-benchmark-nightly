...
bb.an:                                            ; preds = %.lr.ph324, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit"
  %.sroa.16.32.copyload = phi i64 [ %i.y, %.lr.ph324 ], [ %i.ko, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit" ] ; 6 uses
  %.sroa.13.32.copyload = phi ptr [ %i.w, %.lr.ph324 ], [ %i.kp, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit" ] ; 10 uses
  ...
  %.0125323 = phi i64 [ 0, %.lr.ph324 ], [ %i.kt, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit" ] ; 2 uses
  %i.ge = mul i64 %.0125323, %i.ex
...
begin_hunk_10_@_ZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEE:bb.a
  ...
  invoke void @_ZN11OpenImageIO4v3_19TIFFInput20uncompress_one_stripEPKvmPvmiiiPb(ptr noundef nonnull align 8 dereferenceable(432) %0, ptr noundef nonnull %i.gf, i64 noundef %i.gk, ptr noundef %.sroa.13.32.copyload, i64 noundef %i.ew, i32 noundef %i.jw, i32 noundef %i.jx, i32 noundef %i.jy, ptr noundef nonnull %i.c)
...
vector.body572:                                   ; preds = %vector.main.loop.iter.check567, %vector.body572
  ...
  %i.kc = getelementptr inbounds nuw i8, ptr %.sroa.13.32.copyload, i64 %index573 ; 3 uses
...
vec.epilog.vector.body587:                        ; preds = %vec.epilog.vector.body587, %vec.epilog.ph584
  ...
  %i.kh = getelementptr inbounds nuw i8, ptr %.sroa.13.32.copyload, i64 %index588 ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  %i.kk = getelementptr inbounds nuw i8, ptr %.sroa.13.32.copyload, i64 %indvars.iv.i.i ; 2 uses
...
"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit": ; preds = %.lr.ph.i.i, %middle.block577, %vec.epilog.middle.block591, %bb.ce, %.noexc176, %_ZNSt14__basic_futureIvED2Ev.exit
  %15 = phi ptr [ %.pre398, %_ZNSt14__basic_futureIvED2Ev.exit ], [ %.sroa.13.32.copyload, %bb.ce ], [ %.sroa.13.32.copyload, %.noexc176 ], [ %.sroa.13.32.copyload, %middle.block577 ], [ %.sroa.13.32.copyload, %vec.epilog.middle.block591 ], [ %.sroa.13.32.copyload, %.lr.ph.i.i ]
  %16 = phi i64 [ %.pre, %_ZNSt14__basic_futureIvED2Ev.exit ], [ %.sroa.16.32.copyload, %bb.ce ], [ %.sroa.16.32.copyload, %.noexc176 ], [ %.sroa.16.32.copyload, %middle.block577 ], [ %.sroa.16.32.copyload, %vec.epilog.middle.block591 ], [ %.sroa.16.32.copyload, %.lr.ph.i.i ] ; 2 uses
  %.sroa.speculated6.i177 = call i64 @llvm.umin.i64(i64 %16, i64 %i.fx) ; 2 uses
  %i.ko = sub i64 %16, %.sroa.speculated6.i177    ; 3 uses
  %i.kp = getelementptr inbounds nuw i8, ptr %15, i64 %.sroa.speculated6.i177 ; 3 uses
  store ptr %i.kp, ptr %5, align 8, !tbaa !181
  store i64 %i.ko, ptr %i.x, align 8, !tbaa !116
...
bb.cg:                                            ; preds = %bb.ag
  ...
  br i1 %i.kw, label %.lr.ph320, label %.loopexit273
...
begin_hunk_16_@_ZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEE:bb.a
  ...
  br i1 %i.rb, label %bb.ch, label %.loopexit273, !llvm.loop !359
...
.loopexit273:                                     ; preds = %_ZN11OpenImageIO4v3_19TIFFInput18separate_to_contigEmmNS0_4spanIKSt4byteLm18446744073709551615EEENS2_IS3_Lm18446744073709551615EEE.exit, %bb.cg
  %17 = phi i32 [ %i.kv, %bb.cg ], [ %i.qz, %_ZN11OpenImageIO4v3_19TIFFInput18separate_to_contigEmmNS0_4spanIKSt4byteLm18446744073709551615EEENS2_IS3_Lm18446744073709551615EEE.exit ]
  %.lcssa314 = phi i64 [ %i.y, %bb.cg ], [ %i.qv, %_ZN11OpenImageIO4v3_19TIFFInput18separate_to_contigEmmNS0_4spanIKSt4byteLm18446744073709551615EEENS2_IS3_Lm18446744073709551615EEE.exit ] ; 2 uses
  %.lcssa309 = phi ptr [ %i.w, %bb.cg ], [ %i.qw, %_ZN11OpenImageIO4v3_19TIFFInput18separate_to_contigEmmNS0_4spanIKSt4byteLm18446744073709551615EEENS2_IS3_Lm18446744073709551615EEE.exit ] ; 2 uses
...
.loopexit271:                                     ; preds = %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit", %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EE5resetIPcvEEvT_.exit.preheader, %.loopexit273
  %.promoted329 = phi i64 [ %.lcssa314, %.loopexit273 ], [ %i.y, %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EE5resetIPcvEEvT_.exit.preheader ], [ %i.ko, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit" ] ; 2 uses
  %.promoted325 = phi ptr [ %.lcssa309, %.loopexit273 ], [ %i.w, %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EE5resetIPcvEEvT_.exit.preheader ], [ %i.kp, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit" ] ; 2 uses
  %18 = phi i32 [ %17, %.loopexit273 ], [ %i.fl, %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EE5resetIPcvEEvT_.exit.preheader ], [ %i.ks, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit" ] ; 3 uses
...
.lr.ph336:                                        ; preds = %.loopexit271, %bb.cu
  %i.rf = phi i32 [ %i.rl, %bb.cu ], [ %18, %.loopexit271 ]
  %.sroa.01.0.copyload326334 = phi ptr [ %i.rj, %bb.cu ], [ %.promoted325, %.loopexit271 ] ; 3 uses
  %.sroa.2.0.copyload330333 = phi i64 [ %i.ri, %bb.cu ], [ %.promoted329, %.loopexit271 ] ; 3 uses
...
._crit_edge337:                                   ; preds = %bb.cu, %.loopexit271
  %.sroa.2.0.copyload330.lcssa = phi i64 [ %.promoted329, %.loopexit271 ], [ %i.ri, %bb.cu ]
  %.sroa.01.0.copyload326.lcssa = phi ptr [ %.promoted325, %.loopexit271 ], [ %i.rj, %bb.cu ]
