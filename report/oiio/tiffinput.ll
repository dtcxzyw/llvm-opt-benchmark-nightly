...
bb.an:                                            ; preds = %.lr.ph356, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit"
  ...
  %.0125355 = phi i64 [ 0, %.lr.ph356 ], [ %i.ku, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit" ] ; 2 uses
  %.sroa.13.32.copyload323353 = phi ptr [ %i.w, %.lr.ph356 ], [ %i.kq, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit" ] ; 19 uses
  %i.ge = phi i64 [ %i.y, %.lr.ph356 ], [ %i.kp, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit" ] ; 16 uses
  %i.gf = mul i64 %.0125355, %i.ex
...
bb.as:                                            ; preds = %bb.an
  ...
  store i64 %i.ge, ptr %i.x, align 8
  br label %bb.cv
...
begin_hunk_5_@_ZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEE:bb.a
  ...
  store i64 %i.ge, ptr %.sroa.16.0..sroa_idx, align 8, !tbaa !116, !noalias !304
...
begin_hunk_10_@_ZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEE:bb.a
  ...
  invoke void @_ZN11OpenImageIO4v3_19TIFFInput20uncompress_one_stripEPKvmPvmiiiPb(ptr noundef nonnull align 8 dereferenceable(432) %0, ptr noundef nonnull %i.gg, i64 noundef %i.gl, ptr noundef %.sroa.13.32.copyload323353, i64 noundef %i.ew, i32 noundef %i.jx, i32 noundef %i.jy, i32 noundef %i.jz, ptr noundef nonnull %i.c)
...
vector.body686:                                   ; preds = %vector.main.loop.iter.check681, %vector.body686
  ...
  %i.kd = getelementptr inbounds nuw i8, ptr %.sroa.13.32.copyload323353, i64 %index687 ; 3 uses
...
vec.epilog.vector.body701:                        ; preds = %vec.epilog.vector.body701, %vec.epilog.ph698
  ...
  %i.ki = getelementptr inbounds nuw i8, ptr %.sroa.13.32.copyload323353, i64 %index702 ; 2 uses
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  %i.kl = getelementptr inbounds nuw i8, ptr %.sroa.13.32.copyload323353, i64 %indvars.iv.i.i ; 2 uses
...
"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit": ; preds = %.lr.ph.i.i, %middle.block691, %vec.epilog.middle.block705, %bb.ce, %.noexc176, %_ZNSt14__basic_futureIvED2Ev.exit
  %.sroa.speculated6.i177 = call i64 @llvm.umin.i64(i64 %i.ge, i64 %i.fx) ; 2 uses
  %i.kp = sub i64 %i.ge, %.sroa.speculated6.i177  ; 2 uses
  %i.kq = getelementptr inbounds nuw i8, ptr %.sroa.13.32.copyload323353, i64 %.sroa.speculated6.i177 ; 2 uses
...
bb.cg:                                            ; preds = %bb.ag
  ...
  br i1 %i.kx, label %.lr.ph320, label %.loopexit271
...
begin_hunk_16_@_ZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEE:bb.a
  ...
  br i1 %i.rc, label %bb.ch, label %.loopexit271, !llvm.loop !359
...
.loopexit271:                                     ; preds = %_ZN11OpenImageIO4v3_19TIFFInput18separate_to_contigEmmNS0_4spanIKSt4byteLm18446744073709551615EEENS2_IS3_Lm18446744073709551615EEE.exit, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit", %bb.cg, %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EE5resetIPcvEEvT_.exit.preheader
  %15 = phi i32 [ %i.kt, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit" ], [ %i.fl, %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EE5resetIPcvEEvT_.exit.preheader ], [ %i.kw, %bb.cg ], [ %i.ra, %_ZN11OpenImageIO4v3_19TIFFInput18separate_to_contigEmmNS0_4spanIKSt4byteLm18446744073709551615EEENS2_IS3_Lm18446744073709551615EEE.exit ] ; 3 uses
  %storemerge379 = phi ptr [ %i.kq, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit" ], [ %i.w, %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EE5resetIPcvEEvT_.exit.preheader ], [ %i.w, %bb.cg ], [ %i.qx, %_ZN11OpenImageIO4v3_19TIFFInput18separate_to_contigEmmNS0_4spanIKSt4byteLm18446744073709551615EEENS2_IS3_Lm18446744073709551615EEE.exit ] ; 3 uses
  %storemerge = phi i64 [ %i.kp, %"_ZZN11OpenImageIO4v3_19TIFFInput21read_native_scanlinesEiiiiNS0_4spanISt4byteLm18446744073709551615EEEENK3$_0clEi.exit" ], [ %i.y, %_ZNSt10unique_ptrIA_cSt14default_deleteIS0_EE5resetIPcvEEvT_.exit.preheader ], [ %i.y, %bb.cg ], [ %i.qw, %_ZN11OpenImageIO4v3_19TIFFInput18separate_to_contigEmmNS0_4spanIKSt4byteLm18446744073709551615EEENS2_IS3_Lm18446744073709551615EEE.exit ] ; 2 uses
...
.lr.ph370:                                        ; preds = %.loopexit271, %bb.cu
  %i.rg = phi i32 [ %i.rm, %bb.cu ], [ %15, %.loopexit271 ]
  %.sroa.01.0.copyload360368 = phi ptr [ %i.rk, %bb.cu ], [ %storemerge379, %.loopexit271 ] ; 3 uses
  %.sroa.2.0.copyload364367 = phi i64 [ %i.rj, %bb.cu ], [ %storemerge, %.loopexit271 ] ; 3 uses
...
._crit_edge371:                                   ; preds = %bb.cu, %.loopexit271
  %.sroa.2.0.copyload364.lcssa = phi i64 [ %storemerge, %.loopexit271 ], [ %i.rj, %bb.cu ]
  %.sroa.01.0.copyload360.lcssa = phi ptr [ %storemerge379, %.loopexit271 ], [ %i.rk, %bb.cu ]
