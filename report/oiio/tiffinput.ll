...
@switch.table._ZN11OpenImageIO4v3_19TIFFInput8readspecEb.99 = private unnamed_addr constant [5 x i64] [i64 1, i64 1, i64 3, i64 1, i64 1], align 8
@switch.table._ZN11OpenImageIO4v3_19TIFFInput8readspecEb.100 = private unnamed_addr constant [5 x i32] [i32 1, i32 1, i32 3, i32 1, i32 1], align 4
...
bb.aq:                                            ; preds = %bb.ap
  %i.jz = load i16, ptr %i.ib, align 4, !tbaa !155 ; 4 uses
  %i.ka = icmp ult i16 %i.jz, 5
  br i1 %i.ka, label %switch.lookup573, label %bb.ar

switch.lookup573:                                 ; preds = %bb.aq
  %93 = zext nneg i16 %i.jz to i64
  %switch.gep574 = getelementptr inbounds nuw [8 x i8], ptr @switch.table._ZN11OpenImageIO4v3_19TIFFInput8readspecEb.99, i64 %93
  %switch.load575 = load i64, ptr %switch.gep574, align 8
  %i.kb = zext nneg i16 %i.jz to i64
  %switch.gep574.a = getelementptr inbounds nuw [4 x i8], ptr @switch.table._ZN11OpenImageIO4v3_19TIFFInput8readspecEb.100, i64 %i.kb
  %switch.load575.a = load i32, ptr %switch.gep574.a, align 4
  br label %bb.ar

bb.ar:                                            ; preds = %switch.lookup573, %bb.aq
  %.085 = phi i64 [ %switch.load575, %switch.lookup573 ], [ 3, %bb.aq ]
  %.085.a = phi i32 [ %switch.load575.a, %switch.lookup573 ], [ 3, %bb.aq ]
...
bb.as:                                            ; preds = %.lr.ph428, %bb.be
  %indvars.iv445 = phi i64 [ %.085, %.lr.ph428 ], [ %indvars.iv.next446, %bb.be ] ; 6 uses
