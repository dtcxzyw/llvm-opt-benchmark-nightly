...
bb.am:                                            ; preds = %.thread.i
  %i.ms = load i64, ptr %i.ax, align 8, !tbaa !126
  %i.mt = load i64, ptr %i.ay, align 8, !tbaa !127
...
bb.ar:                                            ; preds = %.thread203.i
  ...
  %i.oo = load i64, ptr %i.on, align 8, !tbaa !126
  %i.op = getelementptr inbounds nuw i8, ptr %i.b, i64 56
  %i.oq = load i64, ptr %i.op, align 8, !tbaa !127
...
define internal fastcc range(i32 0, 2) i32 @DecodeImageData(ptr noundef %0, ptr noundef %1, i32 noundef %2, i32 noundef %3, i32 noundef %4, ptr nofree noundef readonly captures(address_is_null) %5) unnamed_addr #1 {
bb.a:
...
bb.e:                                             ; preds = %bb.d
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(40) %i.ar, ptr noundef nonnull align 8 dereferenceable(40) %i.e, i64 40, i1 false), !tbaa.struct !129
  store i32 %i.bh, ptr %i.as, align 8, !tbaa !132
  %i.bi = load i32, ptr %i.f, align 8, !tbaa !133
