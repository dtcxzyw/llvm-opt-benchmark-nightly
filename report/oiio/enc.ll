...
begin_hunk_2
  ...
  %i.rz = mul nuw nsw <4 x i32> %i.ry, %broadcast.splat69.a
...
begin_hunk_3
  ...
  %i.st = mul nuw nsw <4 x i32> %i.ss, %broadcast.splat71.a
  ...
  %i.sz = mul nuw nsw <4 x i32> %i.sy, %broadcast.splat73
  ...
  %i.td = mul nuw nsw <4 x i32> %i.tc, %broadcast.splat75
...
begin_hunk_5
  ...
  %i.wu = mul nuw nsw <4 x i32> %i.wt, %broadcast.splat69.a
