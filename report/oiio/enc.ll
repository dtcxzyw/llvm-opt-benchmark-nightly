...
.preheader.preheader:
  ...
  %i.o = ashr i32 %i.n, 16
  %12 = load i16, ptr %i.a, align 2, !tbaa !18
  %13 = sext i16 %i.i to i32                      ; 3 uses
  %i.p = sext i16 %12 to i32                      ; 3 uses
  %i.q = mul nsw i32 %i.p, 20091
  %i.r = ashr i32 %i.q, 16
  %14 = mul nsw i32 %13, 20091
  %15 = ashr i32 %14, 16
  %16 = add nsw i32 %15, %13
  %17 = load <4 x i8>, ptr %0, align 1, !tbaa !12
  %18 = zext <4 x i8> %17 to <4 x i32>
  %19 = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.s = getelementptr inbounds nuw i8, ptr %2, i64 32
  %20 = load i16, ptr %4, align 2, !tbaa !18
  %i.t = load i16, ptr %i.j, align 2, !tbaa !18
  %21 = load i16, ptr %11, align 2, !tbaa !18
  %i.u = load i16, ptr %6, align 2, !tbaa !18
  %i.v = sext i16 %20 to i32                      ; 3 uses
  %22 = sext i16 %i.t to i32                      ; 3 uses
  %23 = sext i16 %21 to i32                       ; 3 uses
  %24 = sext i16 %i.u to i32                      ; 3 uses
  %25 = mul nsw i32 %i.v, 20091
  %26 = mul nsw i32 %24, 20091
  %i.w = mul nsw i32 %24, 35468
  %i.x = ashr i32 %i.w, 16
  %27 = mul nsw i32 %22, 20091
  %28 = mul nsw i32 %22, 35468
  %i.y = mul nsw i32 %23, 20091
  %29 = ashr i32 %25, 16
  %30 = ashr i32 %27, 16
  %31 = ashr i32 %i.y, 16
  %32 = ashr i32 %26, 16
  %33 = add nsw i32 %29, %i.v
  %34 = add nsw i32 %30, %22
  %35 = add nsw i32 %31, %23
  %36 = add nsw i32 %32, %24
  %i.z = mul nsw i32 %23, 35468
  %i.aa = ashr i32 %i.z, 16
  %37 = mul nsw i32 %i.p, 35468
  %38 = mul nsw i32 %13, 35468
  %39 = mul nsw i32 %i.m, 35468
  %i.ab = mul nsw i32 %i.e, 35468
  %40 = ashr i32 %37, 16
  %41 = ashr i32 %38, 16
  %42 = ashr i32 %39, 16
  %i.ac = ashr i32 %i.ab, 16
  %43 = sub nsw i32 %40, %33                      ; 2 uses
  %44 = sub nsw i32 %41, %34                      ; 2 uses
  %i.ad = sub nsw i32 %42, %35                    ; 2 uses
  %45 = sub nsw i32 %i.ac, %36                    ; 2 uses
  %i.ae = ashr i32 %28, 16
  %i.af = mul nsw i32 %i.v, 35468
  %i.ag = ashr i32 %i.af, 16
  %46 = add nsw i32 %16, %i.ae                    ; 2 uses
  %47 = load <4 x i8>, ptr %19, align 1, !tbaa !12
  %48 = zext <4 x i8> %47 to <4 x i32>
  %49 = getelementptr inbounds nuw i8, ptr %0, i64 64
  %50 = getelementptr inbounds nuw i8, ptr %2, i64 64
  %51 = load <4 x i8>, ptr %49, align 1, !tbaa !12
  %52 = zext <4 x i8> %51 to <4 x i32>
  %53 = getelementptr inbounds nuw i8, ptr %0, i64 96
  %54 = getelementptr inbounds nuw i8, ptr %2, i64 96
  %55 = load i16, ptr %3, align 2, !tbaa !18
  %56 = load i16, ptr %8, align 2, !tbaa !18
  %57 = load i16, ptr %10, align 2, !tbaa !18
  %58 = load i16, ptr %i.b, align 2, !tbaa !18
  %59 = sext i16 %55 to i32                       ; 2 uses
  %60 = sext i16 %56 to i32                       ; 2 uses
  %61 = sext i16 %57 to i32                       ; 2 uses
  %62 = sext i16 %58 to i32                       ; 2 uses
  %63 = load i16, ptr %1, align 2, !tbaa !18
  %64 = load i16, ptr %7, align 2, !tbaa !18
  %65 = load i16, ptr %9, align 2, !tbaa !18
  %66 = load i16, ptr %5, align 2, !tbaa !18
  %i.ah = add nsw i32 %i.r, %i.p
  %i.ai = add nsw i32 %i.o, %i.m
  %i.aj = add nsw i32 %i.g, %i.e
  %67 = sext i16 %63 to i32                       ; 2 uses
  %68 = sext i16 %64 to i32                       ; 2 uses
  %69 = sext i16 %65 to i32                       ; 2 uses
  %70 = sext i16 %66 to i32                       ; 2 uses
  %71 = sub nsw i32 %69, %61                      ; 2 uses
  %72 = sub nsw i32 %70, %62                      ; 2 uses
  %i.ak = add nsw i32 %i.ah, %i.ag                ; 2 uses
  %i.al = add nsw i32 %i.ai, %i.aa                ; 2 uses
  %73 = add nsw i32 %i.aj, %i.x                   ; 2 uses
  %74 = add nsw i32 %59, %67                      ; 2 uses
  %75 = add nsw i32 %60, %68                      ; 2 uses
  %i.am = add nsw i32 %61, %69                    ; 2 uses
  %76 = add nsw i32 %62, %70                      ; 2 uses
  %77 = add nsw i32 %i.al, %i.am                  ; 3 uses
  %78 = add nsw i32 %73, %76                      ; 3 uses
  %79 = add nsw i32 %i.ak, %74
  %i.an = mul nsw i32 %78, 35468
  %i.ao = mul nsw i32 %77, 35468
  %80 = add nsw i32 %i.ad, %71                    ; 3 uses
  %81 = add nsw i32 %45, %72                      ; 3 uses
  %82 = mul nsw i32 %77, 20091
  %i.ap = ashr i32 %82, 16
  %83 = mul nsw i32 %78, 20091
  %i.aq = ashr i32 %83, 16
  %84 = add nsw i32 %77, %i.ap
  %i.ar = add nsw i32 %i.aq, %78
  %i.as = add nsw i32 %79, 4                      ; 2 uses
  %85 = ashr i32 %i.an, 16
  %86 = ashr i32 %i.ao, 16
  %i.at = sub nsw i32 %85, %84                    ; 2 uses
  %87 = add nsw i32 %i.ar, %86                    ; 2 uses
  %i.au = mul nsw i32 %81, 35468
  %i.av = mul nsw i32 %80, 20091
  %i.aw = ashr i32 %i.av, 16
  %i.ax = mul nsw i32 %81, 20091
  %i.ay = ashr i32 %i.ax, 16
  %i.az = add nsw i32 %80, %i.aw
  %i.ba = add nsw i32 %i.ay, %81
  %88 = mul nsw i32 %80, 35468
  %i.bb = ashr i32 %i.au, 16
  %i.bc = ashr i32 %88, 16
  %i.bd = sub nsw i32 %i.bb, %i.az                ; 2 uses
  %i.be = add nsw i32 %i.ba, %i.bc                ; 2 uses
  %i.bf = sub nsw i32 %74, %i.ak
  %i.bg = sub nsw i32 %i.am, %i.al                ; 3 uses
  %i.bh = sub nsw i32 %76, %73                    ; 3 uses
  %i.bi = sub nsw i32 %67, %59                    ; 2 uses
  %i.bj = sub nsw i32 %72, %45                    ; 3 uses
  %89 = sub nsw i32 %71, %i.ad                    ; 3 uses
  %i.bk = add nsw i32 %43, %i.bi
  %i.bl = add nsw i32 %46, %75                    ; 2 uses
  %i.bm = add nsw i32 %i.as, %i.bl                ; 2 uses
  %i.bn = sub nsw i32 %i.as, %i.bl                ; 2 uses
  %i.bo = sub nsw i32 %i.bm, %87
  %i.bp = sub nsw i32 %i.bn, %i.at
  %i.bq = add nsw i32 %i.at, %i.bn
  %i.br = add nsw i32 %87, %i.bm
  ...
  store <4 x i8> %i.ca, ptr %2, align 1, !tbaa !12
  %i.cb = sub nsw i32 %68, %60                    ; 2 uses
  %90 = sub nsw i32 %i.bi, %43
  %91 = mul nsw i32 %i.bj, 35468
  %92 = mul nsw i32 %89, 35468
  %i.cc = add nsw i32 %44, %i.cb                  ; 2 uses
  %i.cd = add nsw i32 %i.bk, 4                    ; 2 uses
  %i.ce = add nsw i32 %i.cd, %i.cc                ; 2 uses
  %i.cf = sub nsw i32 %i.cd, %i.cc                ; 2 uses
  %i.cg = sub nsw i32 %i.ce, %i.be
  %i.ch = sub nsw i32 %i.cf, %i.bd
  %i.ci = add nsw i32 %i.bd, %i.cf
  %i.cj = add nsw i32 %i.be, %i.ce
  ...
  store <4 x i8> %i.cs, ptr %i.s, align 1, !tbaa !12
  %93 = mul nsw i32 %89, 20091
  %94 = ashr i32 %93, 16
  %95 = mul nsw i32 %i.bj, 20091
  %96 = ashr i32 %95, 16
  %i.ct = sub nsw i32 %i.cb, %44                  ; 2 uses
  %97 = ashr i32 %91, 16
  %98 = ashr i32 %92, 16
  %i.cu = add nsw i32 %90, 4                      ; 2 uses
  %99 = add nsw i32 %89, %94
  %i.cv = add nsw i32 %96, %i.bj
  %i.cw = add nsw i32 %i.cu, %i.ct                ; 2 uses
  %100 = sub nsw i32 %i.cu, %i.ct                 ; 2 uses
  %101 = sub nsw i32 %97, %99                     ; 2 uses
  %102 = add nsw i32 %i.cv, %98                   ; 2 uses
  %i.cx = sub nsw i32 %i.cw, %102
  %i.cy = sub nsw i32 %100, %101
  %i.cz = add nsw i32 %101, %100
  %i.da = add nsw i32 %102, %i.cw
  ...
  store <4 x i8> %i.dj, ptr %50, align 1, !tbaa !12
  %103 = mul nsw i32 %i.bh, 35468
  %i.dk = mul nsw i32 %i.bg, 20091
  %i.dl = ashr i32 %i.dk, 16
  %i.dm = mul nsw i32 %i.bh, 20091
  %i.dn = ashr i32 %i.dm, 16
  %104 = add nsw i32 %i.bg, %i.dl
  %i.do = add nsw i32 %i.dn, %i.bh
  %105 = mul nsw i32 %i.bg, 35468
  %i.dp = sub nsw i32 %75, %46                    ; 2 uses
  %i.dq = add nsw i32 %i.bf, 4                    ; 2 uses
  %i.dr = ashr i32 %103, 16
  %i.ds = ashr i32 %105, 16
  %i.dt = add nsw i32 %i.dq, %i.dp                ; 2 uses
  %i.du = sub nsw i32 %i.dq, %i.dp                ; 2 uses
  %i.dv = sub nsw i32 %i.dr, %104                 ; 2 uses
  %i.dw = add nsw i32 %i.do, %i.ds                ; 2 uses
  %i.dx = load <4 x i8>, ptr %53, align 1, !tbaa !12
  ...
  store <4 x i8> %i.el, ptr %54, align 1, !tbaa !12
  ret void
}
