...
bb.a:
  ...
  %spec.select = tail call i32 @llvm.smax.i32(i32 %i.a, i32 0) ; 2 uses
  %i.c = getelementptr inbounds nuw i8, ptr %0, i64 4
  %i.d = load i32, ptr %i.c, align 4, !tbaa !3    ; 2 uses
  %i.e = icmp sgt i32 %i.d, 0                     ; 2 uses
  %spec.select.1.a = tail call i32 @llvm.smax.i32(i32 %i.d, i32 %spec.select)
  %narrow = select i1 %i.e, i1 true, i1 %i.b
  %.114.1 = zext i1 %narrow to i32
  %.2.1 = select i1 %i.e, i32 %spec.select.1.a, i32 %spec.select ; 2 uses
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.g = load i32, ptr %i.f, align 4, !tbaa !3    ; 2 uses
  %i.h = icmp sgt i32 %i.g, 0                     ; 2 uses
  %spec.select.2.a = tail call i32 @llvm.smax.i32(i32 %i.g, i32 %.2.1)
  %.114.2 = select i1 %i.h, i32 2, i32 %.114.1
  %.2.2 = select i1 %i.h, i32 %spec.select.2.a, i32 %.2.1 ; 2 uses
  %i.i = getelementptr inbounds nuw i8, ptr %0, i64 12
  %i.j = load i32, ptr %i.i, align 4, !tbaa !3    ; 2 uses
  %i.k = icmp sgt i32 %i.j, 0                     ; 2 uses
  %spec.select.3.a = tail call i32 @llvm.smax.i32(i32 %i.j, i32 %.2.2)
  %.114.3 = select i1 %i.k, i32 3, i32 %.114.2
  %.2.3 = select i1 %i.k, i32 %spec.select.3.a, i32 %.2.2 ; 2 uses
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.m = load i32, ptr %i.l, align 4, !tbaa !3    ; 2 uses
  %i.n = icmp sgt i32 %i.m, 0                     ; 2 uses
  %spec.select.4.a = tail call i32 @llvm.smax.i32(i32 %i.m, i32 %.2.3)
  %.114.4 = select i1 %i.n, i32 4, i32 %.114.3
  %.2.4 = select i1 %i.n, i32 %spec.select.4.a, i32 %.2.3 ; 2 uses
  %i.o = getelementptr inbounds nuw i8, ptr %0, i64 20
  %i.p = load i32, ptr %i.o, align 4, !tbaa !3    ; 2 uses
  %i.q = icmp sgt i32 %i.p, 0                     ; 2 uses
  %spec.select.5.a = tail call i32 @llvm.smax.i32(i32 %i.p, i32 %.2.4)
  %.114.5 = select i1 %i.q, i32 5, i32 %.114.4
  %.2.5 = select i1 %i.q, i32 %spec.select.5.a, i32 %.2.4 ; 2 uses
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.s = load i32, ptr %i.r, align 4, !tbaa !3    ; 2 uses
  %i.t = icmp sgt i32 %i.s, 0                     ; 2 uses
  %spec.select.6.a = tail call i32 @llvm.smax.i32(i32 %i.s, i32 %.2.5)
  %.114.6 = select i1 %i.t, i32 6, i32 %.114.5
  %.2.6 = select i1 %i.t, i32 %spec.select.6.a, i32 %.2.5 ; 2 uses
  %i.u = getelementptr inbounds nuw i8, ptr %0, i64 28
  %i.v = load i32, ptr %i.u, align 4, !tbaa !3    ; 2 uses
  %i.w = icmp sgt i32 %i.v, 0                     ; 2 uses
  %spec.select.7.a = tail call i32 @llvm.smax.i32(i32 %i.v, i32 %.2.6)
  %.114.7 = select i1 %i.w, i32 7, i32 %.114.6
  %.2.7 = select i1 %i.w, i32 %spec.select.7.a, i32 %.2.6 ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 32
  %i.y = load i32, ptr %i.x, align 4, !tbaa !3    ; 2 uses
  %i.z = icmp sgt i32 %i.y, 0                     ; 2 uses
  %spec.select.8.a = tail call i32 @llvm.smax.i32(i32 %i.y, i32 %.2.7)
  %.114.8 = select i1 %i.z, i32 8, i32 %.114.7
  %.2.8 = select i1 %i.z, i32 %spec.select.8.a, i32 %.2.7 ; 2 uses
  %i.aa = getelementptr inbounds nuw i8, ptr %0, i64 36
  %i.ab = load i32, ptr %i.aa, align 4, !tbaa !3  ; 2 uses
  %i.ac = icmp sgt i32 %i.ab, 0                   ; 2 uses
  %spec.select.9.a = tail call i32 @llvm.smax.i32(i32 %i.ab, i32 %.2.8)
  %.114.9 = select i1 %i.ac, i32 9, i32 %.114.8
  %.2.9 = select i1 %i.ac, i32 %spec.select.9.a, i32 %.2.8 ; 2 uses
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 40
  %i.ae = load i32, ptr %i.ad, align 4, !tbaa !3  ; 2 uses
  %i.af = icmp sgt i32 %i.ae, 0                   ; 2 uses
  %spec.select.10.a = tail call i32 @llvm.smax.i32(i32 %i.ae, i32 %.2.9)
  %.114.10 = select i1 %i.af, i32 10, i32 %.114.9
  %.2.10 = select i1 %i.af, i32 %spec.select.10.a, i32 %.2.9 ; 2 uses
  ...
  %spec.select.11.a = tail call i32 @llvm.smax.i32(i32 %i.ah, i32 %.2.10)
  %.114.11 = select i1 %i.ai, i32 11, i32 %.114.10
  %.2.11 = select i1 %i.ai, i32 %spec.select.11.a, i32 %.2.10 ; 2 uses
  %i.aj = getelementptr inbounds nuw i8, ptr %0, i64 48
  %i.ak = load i32, ptr %i.aj, align 4, !tbaa !3  ; 2 uses
  %i.al = icmp sgt i32 %i.ak, 0                   ; 2 uses
  %spec.select.12.a = tail call i32 @llvm.smax.i32(i32 %i.ak, i32 %.2.11)
  %.114.12 = select i1 %i.al, i32 12, i32 %.114.11
  %.2.12 = select i1 %i.al, i32 %spec.select.12.a, i32 %.2.11 ; 2 uses
  ...
  %spec.select.13.a = tail call i32 @llvm.smax.i32(i32 %i.an, i32 %.2.12)
  %.114.13 = select i1 %i.ao, i32 13, i32 %.114.12
  %.2.13 = select i1 %i.ao, i32 %spec.select.13.a, i32 %.2.12 ; 2 uses
  %i.ap = getelementptr inbounds nuw i8, ptr %0, i64 56
  %i.aq = load i32, ptr %i.ap, align 4, !tbaa !3  ; 2 uses
  %i.ar = icmp sgt i32 %i.aq, 0                   ; 2 uses
  %spec.select.14.a = tail call i32 @llvm.smax.i32(i32 %i.aq, i32 %.2.13)
  %.114.14 = select i1 %i.ar, i32 14, i32 %.114.13
  %.2.14 = select i1 %i.ar, i32 %spec.select.14.a, i32 %.2.13 ; 2 uses
  ...
  %spec.select.15.a = tail call i32 @llvm.smax.i32(i32 %i.at, i32 %.2.14)
  %.114.15 = select i1 %i.au, i32 15, i32 %.114.14
  %.2.15 = select i1 %i.au, i32 %spec.select.15.a, i32 %.2.14 ; 2 uses
  %i.av = getelementptr inbounds nuw i8, ptr %0, i64 64
  %i.aw = load i32, ptr %i.av, align 4, !tbaa !3  ; 2 uses
  %i.ax = icmp sgt i32 %i.aw, 0                   ; 2 uses
  %spec.select.16.a = tail call i32 @llvm.smax.i32(i32 %i.aw, i32 %.2.15)
  %.114.16 = select i1 %i.ax, i32 16, i32 %.114.15
  %.2.16 = select i1 %i.ax, i32 %spec.select.16.a, i32 %.2.15 ; 2 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %0, i64 68
  %i.az = load i32, ptr %i.ay, align 4, !tbaa !3  ; 2 uses
  %i.ba = icmp sgt i32 %i.az, 0                   ; 2 uses
  %spec.select.17.a = tail call i32 @llvm.smax.i32(i32 %i.az, i32 %.2.16)
  %.114.17 = select i1 %i.ba, i32 17, i32 %.114.16
  %.2.17 = select i1 %i.ba, i32 %spec.select.17.a, i32 %.2.16 ; 2 uses
  ...
  %spec.select.18.a = tail call i32 @llvm.smax.i32(i32 %i.bc, i32 %.2.17)
  %.114.18 = select i1 %i.bd, i32 18, i32 %.114.17
  %.2.18 = select i1 %i.bd, i32 %spec.select.18.a, i32 %.2.17 ; 2 uses
  %i.be = getelementptr inbounds nuw i8, ptr %0, i64 76
  %i.bf = load i32, ptr %i.be, align 4, !tbaa !3  ; 2 uses
  %i.bg = icmp sgt i32 %i.bf, 0                   ; 2 uses
  %spec.select.19.a = tail call i32 @llvm.smax.i32(i32 %i.bf, i32 %.2.18)
  %.114.19 = select i1 %i.bg, i32 19, i32 %.114.18
  %.2.19 = select i1 %i.bg, i32 %spec.select.19.a, i32 %.2.18 ; 2 uses
  ...
  %spec.select.20.a = tail call i32 @llvm.smax.i32(i32 %i.bi, i32 %.2.19)
  %.114.20 = select i1 %i.bj, i32 20, i32 %.114.19
  %.2.20 = select i1 %i.bj, i32 %spec.select.20.a, i32 %.2.19 ; 2 uses
  %i.bk = getelementptr inbounds nuw i8, ptr %0, i64 84
  %i.bl = load i32, ptr %i.bk, align 4, !tbaa !3  ; 2 uses
  %i.bm = icmp sgt i32 %i.bl, 0                   ; 2 uses
  %spec.select.21.a = tail call i32 @llvm.smax.i32(i32 %i.bl, i32 %.2.20)
  %.114.21 = select i1 %i.bm, i32 21, i32 %.114.20
  %.2.21 = select i1 %i.bm, i32 %spec.select.21.a, i32 %.2.20 ; 2 uses
  %i.bn = getelementptr inbounds nuw i8, ptr %0, i64 88
  %i.bo = load i32, ptr %i.bn, align 4, !tbaa !3  ; 2 uses
  %i.bp = icmp sgt i32 %i.bo, 0                   ; 2 uses
  %spec.select.22.a = tail call i32 @llvm.smax.i32(i32 %i.bo, i32 %.2.21)
  %.114.22 = select i1 %i.bp, i32 22, i32 %.114.21
  %.2.22 = select i1 %i.bp, i32 %spec.select.22.a, i32 %.2.21 ; 2 uses
  ...
  %spec.select.23.a = tail call i32 @llvm.smax.i32(i32 %i.br, i32 %.2.22)
  %.114.23 = select i1 %i.bs, i32 23, i32 %.114.22
  %.2.23 = select i1 %i.bs, i32 %spec.select.23.a, i32 %.2.22 ; 2 uses
  ...
  %spec.select.24.a = tail call i32 @llvm.smax.i32(i32 %i.bu, i32 %.2.23)
  %.114.24 = select i1 %i.bv, i32 24, i32 %.114.23
  %.2.24 = select i1 %i.bv, i32 %spec.select.24.a, i32 %.2.23 ; 2 uses
  %i.bw = getelementptr inbounds nuw i8, ptr %0, i64 100
  %i.bx = load i32, ptr %i.bw, align 4, !tbaa !3  ; 2 uses
  %i.by = icmp sgt i32 %i.bx, 0                   ; 2 uses
  %spec.select.25.a = tail call i32 @llvm.smax.i32(i32 %i.bx, i32 %.2.24)
  %.114.25 = select i1 %i.by, i32 25, i32 %.114.24
  %.2.25 = select i1 %i.by, i32 %spec.select.25.a, i32 %.2.24 ; 2 uses
  ...
  %spec.select.26.a = tail call i32 @llvm.smax.i32(i32 %i.ca, i32 %.2.25)
  %.114.26 = select i1 %i.cb, i32 26, i32 %.114.25
  %.2.26 = select i1 %i.cb, i32 %spec.select.26.a, i32 %.2.25 ; 2 uses
  ...
  %spec.select.27.a = tail call i32 @llvm.smax.i32(i32 %i.cd, i32 %.2.26)
  %.114.27 = select i1 %i.ce, i32 27, i32 %.114.26
  %.2.27 = select i1 %i.ce, i32 %spec.select.27.a, i32 %.2.26 ; 2 uses
  ...
  %spec.select.28.a = tail call i32 @llvm.smax.i32(i32 %i.cg, i32 %.2.27)
  %.114.28 = select i1 %i.ch, i32 28, i32 %.114.27
  %.2.28 = select i1 %i.ch, i32 %spec.select.28.a, i32 %.2.27 ; 2 uses
  %i.ci = getelementptr inbounds nuw i8, ptr %0, i64 116
  %i.cj = load i32, ptr %i.ci, align 4, !tbaa !3  ; 2 uses
  %i.ck = icmp sgt i32 %i.cj, 0                   ; 2 uses
  %spec.select.29.a = tail call i32 @llvm.smax.i32(i32 %i.cj, i32 %.2.28)
  %.114.29 = select i1 %i.ck, i32 29, i32 %.114.28
  %.2.29 = select i1 %i.ck, i32 %spec.select.29.a, i32 %.2.28 ; 2 uses
  ...
  %spec.select.30.a = tail call i32 @llvm.smax.i32(i32 %i.cm, i32 %.2.29)
  %.114.30 = select i1 %i.cn, i32 30, i32 %.114.29
  %.2.30 = select i1 %i.cn, i32 %spec.select.30.a, i32 %.2.29 ; 2 uses
  ...
  %spec.select.31.a = tail call i32 @llvm.smax.i32(i32 %i.cp, i32 %.2.30)
  %.114.31 = select i1 %i.cq, i32 31, i32 %.114.30
  %.2.31 = select i1 %i.cq, i32 %spec.select.31.a, i32 %.2.30
  store i32 %.2.31, ptr %1, align 4, !tbaa !7
  %i.cr = getelementptr inbounds nuw i8, ptr %1, i64 4
  store i32 %.114.31, ptr %i.cr, align 4, !tbaa !9
  ret void
}
