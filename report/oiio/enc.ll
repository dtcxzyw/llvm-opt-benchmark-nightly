...
begin_hunk_3_@FTransform_C:.preheader.preheader
  ...
  %.neg60.3.a = mul nsw i32 %i.dz, -5352
  ...
  %i.ec = add nsw i32 %i.z, %i.e                  ; 2 uses
  %i.ed = add nsw i32 %i.ad, 1812
  %i.ee = sub nsw i32 %i.ec, %i.aa
  %15 = add nsw i32 %.neg60, 937
  %16 = add nsw i32 %15, %i.af
  %i.ef = add nsw i32 %i.ed, %i.ae
  %17 = add nsw i32 %i.ec, %i.aa
  %18 = ashr i32 %16, 9                           ; 3 uses
  %19 = shl nsw i32 %i.ee, 3                      ; 3 uses
  %20 = ashr i32 %i.ef, 9                         ; 3 uses
  %21 = shl nsw i32 %17, 3                        ; 3 uses
  %i.eg = add nsw i32 %i.bh, %i.am                ; 2 uses
  %i.eh = add nsw i32 %i.bl, 1812
  %22 = sub nsw i32 %i.eg, %i.bi
  %23 = add nsw i32 %.neg60.1, 937
  %24 = add nsw i32 %23, %i.bn
  %i.ei = add nsw i32 %i.eh, %i.bm
  %25 = add nsw i32 %i.eg, %i.bi
  %26 = ashr i32 %24, 9                           ; 2 uses
  %27 = shl nsw i32 %22, 3                        ; 2 uses
  %28 = ashr i32 %i.ei, 9                         ; 2 uses
  ...
  %i.ej = add nsw i32 %31, %i.cu
  %i.ek = add nsw i32 %30, %i.cq
  %35 = ashr i32 %34, 9                           ; 2 uses
  %36 = shl nsw i32 %32, 3                        ; 2 uses
  %37 = ashr i32 %i.ej, 9                         ; 2 uses
  %38 = shl nsw i32 %i.ek, 3                      ; 2 uses
  %i.el = add nsw i32 %i.dx, %i.dc                ; 2 uses
  %i.em = add nsw i32 %3, 1812
  %i.en = sub nsw i32 %i.el, %i.dy
  %39 = add nsw i32 %.neg60.3.a, 937
  %i.eo = add nsw i32 %39, %i.eb
  %i.ep = add nsw i32 %i.em, %4
  %40 = add nsw i32 %i.el, %i.dy
  %41 = ashr i32 %i.eo, 9                         ; 3 uses
  %42 = shl nsw i32 %i.en, 3                      ; 3 uses
  %43 = ashr i32 %i.ep, 9                         ; 3 uses
  %44 = shl nsw i32 %40, 3                        ; 3 uses
  %45 = add nsw i32 %44, %21                      ; 2 uses
  %i.eq = add nsw i32 %38, %29                    ; 2 uses
  %i.er = add nsw i32 %45, %i.eq
  %i.es = lshr i32 %i.er, 4
  %46 = trunc i32 %i.es to i16
  store i16 %46, ptr %2, align 2, !tbaa !18
  %47 = sub nsw i32 %45, %i.eq
  %48 = lshr i32 %47, 4
  %i.et = trunc i32 %48 to i16
  store i16 %i.et, ptr %6, align 2, !tbaa !18
  %49 = sub nsw i32 %18, %41                      ; 2 uses
  %50 = sub nsw i32 %19, %42                      ; 2 uses
  %51 = sub nsw i32 %20, %43                      ; 2 uses
  %i.eu = sub nsw i32 %21, %44                    ; 2 uses
  %52 = mul nsw i32 %i.eu, 2217
  %53 = sub nsw i32 %26, %35                      ; 2 uses
  %54 = sub nsw i32 %27, %36                      ; 2 uses
  %55 = sub nsw i32 %28, %37                      ; 2 uses
  %56 = sub nsw i32 %29, %38                      ; 2 uses
  %.neg.a = mul nsw i32 %56, -5352
  %i.ev = add nsw i32 %52, 51000
  %i.ew = add nsw i32 %i.ev, %.neg.a
  %i.ex = lshr i32 %i.ew, 16
  %i.ey = trunc nuw i32 %i.ex to i16
  store i16 %i.ey, ptr %7, align 2, !tbaa !18
  %57 = add nsw i32 %43, %20
  %58 = add nsw i32 %37, %28                      ; 2 uses
  %i.ez = add nsw i32 %57, 7                      ; 2 uses
  %i.fa = add nsw i32 %i.ez, %58
  %59 = lshr i32 %i.fa, 4
  %60 = trunc i32 %59 to i16
  store i16 %60, ptr %8, align 2, !tbaa !18
  %61 = sub nsw i32 %i.ez, %58
  %62 = lshr i32 %61, 4
  %63 = trunc i32 %62 to i16
  store i16 %63, ptr %9, align 2, !tbaa !18
  %i.fb = mul nsw i32 %51, 2217
  %.neg.1 = mul nsw i32 %55, -5352
  %i.fc = add nsw i32 %i.fb, 51000
  %i.fd = add nsw i32 %i.fc, %.neg.1
  %i.fe = lshr i32 %i.fd, 16
  %64 = trunc nuw i32 %i.fe to i16
  store i16 %64, ptr %10, align 2, !tbaa !18
  %65 = add nsw i32 %42, %19                      ; 2 uses
  %66 = add nsw i32 %36, %27                      ; 2 uses
  %i.ff = add nsw i32 %65, %66
  %67 = lshr i32 %i.ff, 4
  %68 = trunc i32 %67 to i16
  store i16 %68, ptr %11, align 2, !tbaa !18
  %i.fg = sub nsw i32 %65, %66
  %i.fh = lshr i32 %i.fg, 4
  %i.fi = trunc i32 %i.fh to i16
  store i16 %i.fi, ptr %12, align 2, !tbaa !18
  %i.fj = mul nsw i32 %50, 2217
  ...
  store i16 %i.fn, ptr %13, align 2, !tbaa !18
  %69 = add nsw i32 %41, %18
  %70 = add nsw i32 %35, %26                      ; 2 uses
  %i.fo = add nsw i32 %69, 7                      ; 2 uses
  %i.fp = add nsw i32 %i.fo, %70
  %71 = lshr i32 %i.fp, 4
  ...
  %i.fq = mul nsw i32 %51, 5352
  %i.fr = mul nsw i32 %i.eu, 5352
  %79 = add nsw i32 %77, 12000
  %80 = add nsw i32 %78, 12000
  %i.fs = add nsw i32 %i.fq, 12000
  %i.ft = add nsw i32 %i.fr, 12000
  %81 = add nsw i32 %79, %73
  %82 = add nsw i32 %80, %74
  %83 = add nsw i32 %i.fs, %75
  %i.fu = add nsw i32 %i.ft, %76
  %84 = insertelement <4 x i32> poison, i32 %i.fu, i64 0
