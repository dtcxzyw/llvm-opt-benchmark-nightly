...
.preheader.preheader:
  ...
  %22 = add nsw i32 %i.ap, %i.an
  %23 = sub nsw i32 %21, %22                      ; 2 uses
  %i.aq = mul nsw i32 %i.aj, 20091
  %24 = ashr i32 %i.aq, 16
  %i.ar = mul nsw i32 %i.an, 35468
  %i.as = ashr i32 %i.ar, 16
  %25 = load i16, ptr %5, align 2, !tbaa !18
  %26 = load i16, ptr %i.af, align 2, !tbaa !18
  %27 = sext i16 %i.y to i32                      ; 3 uses
  %28 = sext i16 %25 to i32                       ; 3 uses
  %29 = sext i16 %8 to i32                        ; 2 uses
  %30 = sext i16 %26 to i32                       ; 2 uses
  %31 = mul nsw i32 %28, 20091
  %32 = ashr i32 %31, 16
  %33 = ashr i32 %i.ae, 16
  %34 = mul nsw i32 %27, 20091
  %35 = mul nsw i32 %i.f, 35468
  %i.at = add nsw i32 %i.t, %i.l
  %36 = add nsw i32 %24, %i.aj
  %i.au = ashr i32 %34, 16
  %i.av = ashr i32 %35, 16
  %37 = add nsw i32 %20, %30                      ; 2 uses
  %38 = add nsw i32 %10, %29                      ; 2 uses
  %39 = add nsw i32 %36, %i.as                    ; 2 uses
  %40 = add nsw i32 %i.at, %14                    ; 2 uses
  %41 = add nsw i32 %i.au, %27
  %i.aw = add nsw i32 %39, %37                    ; 3 uses
  %i.ax = add nsw i32 %40, %38                    ; 3 uses
  %i.ay = add nsw i32 %41, %33                    ; 2 uses
  %42 = mul nsw i32 %i.ax, 35468
  %43 = mul nsw i32 %i.aw, 35468
  %44 = mul nsw i32 %i.aw, 20091
  %45 = ashr i32 %44, 16
  %46 = mul nsw i32 %i.ax, 20091
  %47 = ashr i32 %46, 16
  %48 = add nsw i32 %i.aw, %45
  %49 = add nsw i32 %47, %i.ax
  %50 = ashr i32 %42, 16
  %51 = ashr i32 %43, 16
  %52 = sub nsw i32 %50, %48                      ; 2 uses
  %i.az = add nsw i32 %49, %51                    ; 2 uses
  %53 = load <4 x i8>, ptr %0, align 1, !tbaa !12
  %54 = zext <4 x i8> %53 to <4 x i32>
  %55 = getelementptr inbounds nuw i8, ptr %0, i64 32
  %56 = getelementptr inbounds nuw i8, ptr %2, i64 32
  %57 = mul nsw i32 %27, 35468
  %58 = mul nsw i32 %28, 35468
  %59 = sub nsw i32 %29, %10                      ; 2 uses
  %60 = sub nsw i32 %30, %20                      ; 2 uses
  %61 = ashr i32 %57, 16
  %62 = ashr i32 %58, 16
  %63 = add nsw i32 %13, %59                      ; 3 uses
  %64 = add nsw i32 %23, %60                      ; 3 uses
  %65 = sub nsw i32 %61, %18                      ; 2 uses
  %66 = sub nsw i32 %62, %6                       ; 2 uses
  %67 = mul nsw i32 %63, 35468
  %68 = mul nsw i32 %64, 35468
  %69 = mul nsw i32 %64, 20091
  %70 = ashr i32 %69, 16
  %71 = mul nsw i32 %63, 20091
  %72 = ashr i32 %71, 16
  %i.ba = add nsw i32 %64, %70
  %i.bb = add nsw i32 %72, %63
  %73 = ashr i32 %67, 16
  %74 = ashr i32 %68, 16
  %i.bc = sub nsw i32 %73, %i.ba                  ; 2 uses
  %75 = add nsw i32 %i.bb, %74                    ; 2 uses
  %76 = load <4 x i8>, ptr %55, align 1, !tbaa !12
  %77 = zext <4 x i8> %76 to <4 x i32>
  %78 = getelementptr inbounds nuw i8, ptr %0, i64 64
  %79 = getelementptr inbounds nuw i8, ptr %2, i64 64
  %80 = sext i16 %15 to i32                       ; 2 uses
  %81 = sub nsw i32 %4, %i.c                      ; 2 uses
  %82 = sub nsw i32 %59, %13                      ; 3 uses
  %83 = sub nsw i32 %60, %23                      ; 3 uses
  %i.bd = add nsw i32 %66, %81
  %84 = sub nsw i32 %80, %17                      ; 2 uses
  %85 = sub nsw i32 %81, %66
  %86 = mul nsw i32 %82, 35468
  %87 = mul nsw i32 %83, 35468
  %i.be = add nsw i32 %65, %84                    ; 2 uses
  %88 = add nsw i32 %i.bd, 4                      ; 2 uses
  %89 = add nsw i32 %88, %i.be                    ; 2 uses
  %90 = sub nsw i32 %88, %i.be                    ; 2 uses
  %i.bf = sub nsw i32 %89, %75
  %i.bg = sub nsw i32 %90, %i.bc
  %i.bh = add nsw i32 %i.bc, %90
  %i.bi = add nsw i32 %75, %89
  ...
  store <4 x i8> %i.br, ptr %56, align 1, !tbaa !12
  %91 = mul nsw i32 %83, 20091
  %92 = ashr i32 %91, 16
  %i.bs = mul nsw i32 %82, 20091
  %i.bt = ashr i32 %i.bs, 16
  %93 = sub nsw i32 %84, %65                      ; 2 uses
  %i.bu = ashr i32 %86, 16
  %94 = ashr i32 %87, 16
  %i.bv = add nsw i32 %85, 4                      ; 2 uses
  %i.bw = add nsw i32 %83, %92
  %i.bx = add nsw i32 %i.bt, %82
  %i.by = add nsw i32 %i.bv, %93                  ; 2 uses
  %95 = sub nsw i32 %i.bv, %93                    ; 2 uses
  %96 = sub nsw i32 %i.bu, %i.bw                  ; 2 uses
  %i.bz = add nsw i32 %i.bx, %94                  ; 2 uses
  %97 = load <4 x i8>, ptr %78, align 1, !tbaa !12
  %98 = zext <4 x i8> %97 to <4 x i32>
  %i.ca = sub nsw i32 %i.by, %i.bz
  %i.cb = sub nsw i32 %95, %96
  %i.cc = add nsw i32 %96, %95
  %i.cd = add nsw i32 %i.bz, %i.by
  ...
  store <4 x i8> %i.cm, ptr %79, align 1, !tbaa !12
  %99 = getelementptr inbounds nuw i8, ptr %0, i64 96
  %100 = getelementptr inbounds nuw i8, ptr %2, i64 96
  %101 = add nsw i32 %32, %28
  %102 = add nsw i32 %101, %i.av                  ; 2 uses
  %103 = sub nsw i32 %38, %40                     ; 3 uses
  %104 = sub nsw i32 %37, %39                     ; 3 uses
  %105 = add nsw i32 %17, %80                     ; 2 uses
  %106 = add nsw i32 %i.c, %4                     ; 2 uses
  %107 = mul nsw i32 %103, 35468
  %108 = mul nsw i32 %104, 35468
  %i.cn = add nsw i32 %102, %106
  %i.co = add nsw i32 %i.cn, 4                    ; 2 uses
  %i.cp = add nsw i32 %i.ay, %105                 ; 2 uses
  %109 = add nsw i32 %i.co, %i.cp                 ; 2 uses
  %i.cq = sub nsw i32 %i.co, %i.cp                ; 2 uses
  %i.cr = sub nsw i32 %109, %i.az
  %i.cs = sub nsw i32 %i.cq, %52
  %i.ct = add nsw i32 %52, %i.cq
  %i.cu = add nsw i32 %i.az, %109
  ...
  store <4 x i8> %i.dd, ptr %2, align 1, !tbaa !12
  %i.de = mul nsw i32 %104, 20091
  %i.df = ashr i32 %i.de, 16
  %i.dg = mul nsw i32 %103, 20091
  %i.dh = ashr i32 %i.dg, 16
  %110 = sub nsw i32 %106, %102
  %i.di = add nsw i32 %104, %i.df
  %i.dj = add nsw i32 %i.dh, %103
  %i.dk = sub nsw i32 %105, %i.ay                 ; 2 uses
  %i.dl = add nsw i32 %110, 4                     ; 2 uses
  %i.dm = ashr i32 %107, 16
  %i.dn = ashr i32 %108, 16
  ...
  %i.ds = load <4 x i8>, ptr %99, align 1, !tbaa !12
  ...
  store <4 x i8> %i.eg, ptr %100, align 1, !tbaa !12
  ret void
}
