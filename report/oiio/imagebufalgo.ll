...
.lr.ph:                                           ; preds = %bb.k
  ...
  %i.ad = getelementptr inbounds nuw i8, ptr %10, i64 120
  %i.ae = getelementptr inbounds nuw i8, ptr %12, i64 8
  %i.af = getelementptr inbounds nuw i8, ptr %13, i64 8
  %i.ag = getelementptr inbounds nuw i8, ptr %14, i64 4
  %i.ah = getelementptr inbounds nuw i8, ptr %4, i64 4
  %i.ai = getelementptr inbounds nuw i8, ptr %4, i64 6
...
bb.m:                                             ; preds = %bb.l
  ...
  %i.ba = load i32, ptr %23, align 8, !tbaa !48
  store i32 %i.ba, ptr %i.ad, align 8, !tbaa !48
...
begin_hunk_3_@_ZN11OpenImageIO4v3_112ImageBufAlgo18fillholes_pushpullERNS0_8ImageBufERKS2_NS0_3ROIEi:bb.a
  ...
  store i64 10, ptr %i.ae, align 8, !tbaa !90
  store ptr @.str.69, ptr %13, align 8, !tbaa !88
  store i64 8, ptr %i.af, align 8, !tbaa !90
  ...
  call void @llvm.memset.p0.i64(ptr noundef nonnull align 4 dereferenceable(28) %i.ag, i8 0, i64 28, i1 false)
...
bb.q:                                             ; preds = %_ZN11OpenImageIO4v3_1eqERKNS0_8TypeDescENS1_8BASETYPEE.exit.thread.i, %_ZN11OpenImageIO4v3_1eqERKNS0_8TypeDescENS1_8BASETYPEE.exit.i
  ...
  store i16 0, ptr %i.ah, align 4, !tbaa !202
  store i16 1, ptr %i.ai, align 2, !tbaa !203
  store i64 1024, ptr %i.aj, align 8, !tbaa !204
  store ptr null, ptr %i.ak, align 8, !tbaa !205
  store i8 0, ptr %i.al, align 8, !tbaa !206
  %i.bs = ptrtoint ptr %i.bg to i64
  store i64 0, ptr %i.ao, align 8
  store i64 %i.bs, ptr %5, align 8, !tbaa !137
  store ptr @"_ZNSt17_Function_handlerIFvN11OpenImageIO4v3_13ROIEEZNS1_L15divide_by_alphaERNS1_8ImageBufES2_iE3$_0E9_M_invokeERKSt9_Any_dataOS2_", ptr %i.an, align 8, !tbaa !212
  store ptr @"_ZNSt17_Function_handlerIFvN11OpenImageIO4v3_13ROIEEZNS1_L15divide_by_alphaERNS1_8ImageBufES2_iE3$_0E10_M_managerERSt9_Any_dataRKS8_St18_Manager_operation", ptr %i.am, align 8, !tbaa !215
...
bb.r:                                             ; preds = %bb.q
  %i.bt = load ptr, ptr %i.am, align 8, !tbaa !215 ; 2 uses
...
bb.u:                                             ; preds = %bb.q
  %i.bx = landingpad { ptr, i32 }
          cleanup                                 ; 2 uses
  %i.by = load ptr, ptr %i.am, align 8, !tbaa !215 ; 2 uses
