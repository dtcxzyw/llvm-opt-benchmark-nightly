...
pred.store.continue:                              ; preds = %.preheader.us, %pred.store.if
...
pred.store.continue30:                            ; preds = %pred.store.continue, %pred.store.if29
...
pred.store.continue:                              ; preds = %.lr.ph.us, %pred.store.if
...
pred.store.continue36:                            ; preds = %pred.store.continue, %pred.store.if35
...
pred.store.continue38:                            ; preds = %pred.store.continue36, %pred.store.if37
