...
bb.r:                                             ; preds = %bb.r, %.lr.ph.i180.i
  ...
  %.sroa.speculated.i.i187.i = select i1 %i.oh, float 1.000000e+00, float %i.og ; 2 uses
  %i.oi = fpext float %.sroa.speculated.i.i187.i to double
  %i.oj = fcmp ogt float %.sroa.speculated.i.i187.i, 0.000000e+00
  ...
  %i.oz = select <2 x i1> %i.oy, <2 x float> splat (float 1.000000e+00), <2 x float> %i.ox ; 2 uses
  %i.pa = fpext <2 x float> %i.oz to <2 x double>
  %i.pb = fcmp ogt <2 x float> %i.oz, zeroinitializer
...
vector.body305:                                   ; preds = %vector.body305, %vector.ph284
  ...
  %i.alx = select <2 x i1> %i.alw, <2 x float> splat (float 1.000000e+00), <2 x float> %i.alv ; 2 uses
  %i.aly = fpext <2 x float> %i.alx to <2 x double>
  %i.alz = fcmp ogt <2 x float> %i.alx, zeroinitializer
  ...
  %i.amj = select <2 x i1> %i.ami, <2 x float> splat (float 1.000000e+00), <2 x float> %i.amh ; 2 uses
  %i.amk = fpext <2 x float> %i.amj to <2 x double>
  %5 = fcmp ogt <2 x float> %i.amj, zeroinitializer
  %6 = select <2 x i1> %5, <2 x double> %i.amk, <2 x double> zeroinitializer
  ...
  %i.amt = select <2 x i1> %i.ams, <2 x float> splat (float 1.000000e+00), <2 x float> %i.amr ; 2 uses
  %i.amu = fpext <2 x float> %i.amt to <2 x double>
  %7 = fcmp ogt <2 x float> %i.amt, zeroinitializer
  %8 = select <2 x i1> %7, <2 x double> %i.amu, <2 x double> zeroinitializer
  %9 = getelementptr inbounds nuw [8 x i8], ptr %3, i64 %i.akr
  %i.amv = shufflevector <2 x double> %8, <2 x double> %6, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.amw = shufflevector <2 x double> %i.ama, <2 x double> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %interleaved.vec307 = shufflevector <4 x double> %i.amv, <4 x double> %i.amw, <6 x i32> <i32 0, i32 2, i32 4, i32 1, i32 3, i32 5>
  store <6 x double> %interleaved.vec307, ptr %9, align 8, !alias.scope !66, !noalias !63
...
scalar.ph282:                                     ; preds = %scalar.ph282.preheader, %scalar.ph282
  ...
  %.sroa.speculated.i.i245.i = select i1 %i.anu, float 1.000000e+00, float %i.ant ; 2 uses
  %i.anv = fpext float %.sroa.speculated.i.i245.i to double
  %i.anw = fcmp ogt float %.sroa.speculated.i.i245.i, 0.000000e+00
  ...
  %i.aom = select <2 x i1> %i.aol, <2 x float> splat (float 1.000000e+00), <2 x float> %i.aok ; 2 uses
  %i.aon = fpext <2 x float> %i.aom to <2 x double>
  %i.aoo = fcmp ogt <2 x float> %i.aom, zeroinitializer
...
bb.ai:                                            ; preds = %bb.ai, %.lr.ph.i300.i
  ...
  %.sroa.speculated.i.i305.i = select i1 %i.azj, float 1.000000e+00, float %i.azi ; 2 uses
  %i.azk = fpext float %.sroa.speculated.i.i305.i to double
  %i.azl = fcmp ogt float %.sroa.speculated.i.i305.i, 0.000000e+00
  ...
  %i.bab = select <2 x i1> %i.baa, <2 x float> splat (float 1.000000e+00), <2 x float> %i.azz ; 2 uses
  %i.bac = fpext <2 x float> %i.bab to <2 x double>
  %i.bad = fcmp ogt <2 x float> %i.bab, zeroinitializer
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.bvw = select <2 x i1> %i.bvv, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bvu ; 2 uses
  %i.bvx = fpext <2 x float> %i.bvw to <2 x double>
  %i.bvy = fcmp ogt <2 x float> %i.bvw, zeroinitializer
  ...
  %i.bwi = select <2 x i1> %i.bwh, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bwg ; 2 uses
  %i.bwj = fpext <2 x float> %i.bwi to <2 x double>
  %10 = fcmp ogt <2 x float> %i.bwi, zeroinitializer
  %11 = select <2 x i1> %10, <2 x double> %i.bwj, <2 x double> zeroinitializer
  ...
  %i.bws = select <2 x i1> %i.bwr, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bwq ; 2 uses
  %i.bwt = fpext <2 x float> %i.bws to <2 x double>
  %12 = fcmp ogt <2 x float> %i.bws, zeroinitializer
  %13 = select <2 x i1> %12, <2 x double> %i.bwt, <2 x double> zeroinitializer
  ...
  %i.bxb = shufflevector <2 x double> %13, <2 x double> %11, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %i.bxc = shufflevector <2 x double> %i.bvz, <2 x double> %i.bwz, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %interleaved.vec = shufflevector <4 x double> %i.bxb, <4 x double> %i.bxc, <8 x i32> <i32 0, i32 2, i32 4, i32 6, i32 1, i32 3, i32 5, i32 7>
...
scalar.ph:                                        ; preds = %scalar.ph.preheader, %scalar.ph
  ...
  %.sroa.speculated.i.i371.i = select i1 %i.bya, float 1.000000e+00, float %i.bxz ; 2 uses
  %i.byb = fpext float %.sroa.speculated.i.i371.i to double
  %i.byc = fcmp ogt float %.sroa.speculated.i.i371.i, 0.000000e+00
  ...
  %i.byu = select <2 x i1> %i.byt, <2 x float> splat (float 1.000000e+00), <2 x float> %i.bys ; 2 uses
  %i.byv = fpext <2 x float> %i.byu to <2 x double>
  %i.byw = fcmp ogt <2 x float> %i.byu, zeroinitializer
