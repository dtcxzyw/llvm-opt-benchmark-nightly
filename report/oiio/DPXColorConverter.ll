...
bb.n:                                             ; preds = %bb.n, %.lr.ph.i154.i
  ...
  %5 = fadd nnan float %i.jw, f0xCF000000         ; 2 uses
  %6 = fadd float %i.jx, f0xCF000000              ; 2 uses
  %i.jy = fmul float %i.ix, %5
  %i.jz = tail call float @llvm.fmuladd.f32(float %i.iv, float %i.ju, float %i.jy)
  %i.ka = tail call float @llvm.fmuladd.f32(float %i.iz, float %6, float %i.jz) ; 2 uses
  ...
  %i.kh = shufflevector <2 x float> %9, <2 x float> poison, <2 x i32> zeroinitializer
...
scalar.ph348:                                     ; preds = %scalar.ph348.preheader, %scalar.ph348
  ...
  %10 = fadd nnan float %i.aem, f0xCF000000       ; 2 uses
  %11 = fadd float %i.aen, f0xCF000000            ; 2 uses
  %i.aeo = fmul float %i.abd, %10
  %i.aep = tail call float @llvm.fmuladd.f32(float %i.abb, float %i.aei, float %i.aeo)
  %i.aeq = tail call float @llvm.fmuladd.f32(float %i.abf, float %11, float %i.aep) ; 2 uses
  ...
  %i.aex = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
...
bb.ae:                                            ; preds = %bb.ae, %.lr.ph.i275.i
  ...
  %15 = fadd nnan float %i.aub, f0xCF000000       ; 2 uses
  %16 = fadd float %i.auc, f0xCF000000            ; 2 uses
  %i.aud = fmul float %i.asz, %15
  %i.aue = tail call float @llvm.fmuladd.f32(float %i.asx, float %i.atz, float %i.aud)
  %i.auf = tail call float @llvm.fmuladd.f32(float %i.atb, float %16, float %i.aue) ; 2 uses
...
scalar.ph175:                                     ; preds = %scalar.ph175.preheader, %scalar.ph175
  ...
  %20 = fadd nnan float %i.bnm, f0xCF000000       ; 2 uses
  %21 = fadd float %i.bnn, f0xCF000000            ; 2 uses
  %i.bno = fmul float %i.bjp, %20
  %i.bnp = tail call float @llvm.fmuladd.f32(float %i.bjn, float %i.bng, float %i.bno)
  %i.bnq = tail call float @llvm.fmuladd.f32(float %i.bjr, float %21, float %i.bnp) ; 2 uses
  ...
  %i.bnx = shufflevector <2 x float> %24, <2 x float> poison, <2 x i32> zeroinitializer
