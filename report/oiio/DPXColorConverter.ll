...
bb.j:                                             ; preds = %bb.j, %.lr.ph.i137.i
  ...
  %5 = insertelement <2 x i8> poison, i8 %i.fm, i64 0
  %6 = insertelement <2 x i8> %5, i8 %i.fg, i64 1
  %7 = uitofp <2 x i8> %6 to <2 x float>
  %8 = fadd <2 x float> %7, splat (float -1.275000e+02) ; 4 uses
  %9 = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.fr = fmul <2 x float> %i.fb, %9
  ...
  %i.fv = shufflevector <2 x float> %8, <2 x float> poison, <2 x i32> zeroinitializer
...
bb.p:                                             ; preds = %bb.p, %.lr.ph.i167.i
  ...
  %12 = insertelement <2 x float> poison, float %i.lk, i64 0
  %13 = insertelement <2 x float> %12, float %i.le, i64 1
  %14 = fadd <2 x float> %13, splat (float -5.000000e-01) ; 4 uses
  %15 = extractelement <2 x float> %14, i64 1
  %i.ln = fmul float %i.kp, %15
  %i.lo = tail call float @llvm.fmuladd.f32(float %i.kn, float %i.lh, float %i.ln)
  %16 = extractelement <2 x float> %14, i64 0
  %i.lp = tail call float @llvm.fmuladd.f32(float %i.kr, float %16, float %i.lo) ; 2 uses
  ...
  %i.lw = shufflevector <2 x float> %14, <2 x float> poison, <2 x i32> zeroinitializer
...
scalar.ph418:                                     ; preds = %scalar.ph418.preheader, %scalar.ph418
  ...
  %18 = insertelement <2 x i8> poison, i8 %i.tq, i64 0
  %19 = insertelement <2 x i8> %18, i8 %i.tp, i64 1
  %20 = uitofp <2 x i8> %19 to <2 x float>
  %21 = fadd <2 x float> %20, splat (float -1.275000e+02) ; 4 uses
  ...
  %i.tv = shufflevector <2 x float> %21, <2 x float> poison, <2 x i32> zeroinitializer
...
scalar.ph313:                                     ; preds = %scalar.ph313.preheader, %scalar.ph313
  ...
  %25 = insertelement <2 x float> poison, float %i.aie, i64 0
  %26 = insertelement <2 x float> %25, float %i.aid, i64 1
  %27 = fadd <2 x float> %26, splat (float -5.000000e-01) ; 4 uses
  %28 = extractelement <2 x float> %27, i64 1
  %i.aig = fmul float %i.aex, %28
  %i.aih = tail call float @llvm.fmuladd.f32(float %i.aev, float %i.aic, float %i.aig)
  %29 = extractelement <2 x float> %27, i64 0
  %i.aii = tail call float @llvm.fmuladd.f32(float %i.aez, float %29, float %i.aih) ; 2 uses
  ...
  %30 = shufflevector <2 x float> %27, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.ail = fmul <2 x float> %i.ahu, %30
  ...
  %i.aip = shufflevector <2 x float> %27, <2 x float> poison, <2 x i32> zeroinitializer
...
bb.aa:                                            ; preds = %bb.aa, %.lr.ph.i256.i
  ...
  %31 = insertelement <2 x i8> poison, i8 %i.aop, i64 0
  %32 = insertelement <2 x i8> %31, i8 %i.aog, i64 1
  %33 = uitofp <2 x i8> %32 to <2 x float>
  %34 = fadd <2 x float> %33, splat (float -1.275000e+02) ; 4 uses
  %35 = shufflevector <2 x float> %34, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.aou = fmul <2 x float> %i.aob, %35
  ...
  %i.aoy = shufflevector <2 x float> %34, <2 x float> poison, <2 x i32> zeroinitializer
...
bb.ag:                                            ; preds = %bb.ag, %.lr.ph.i286.i
  ...
  %38 = insertelement <2 x float> poison, float %i.avf, i64 0
  %39 = insertelement <2 x float> %38, float %i.aux, i64 1
  %40 = fadd <2 x float> %39, splat (float -5.000000e-01) ; 4 uses
  %41 = extractelement <2 x float> %40, i64 1
  %i.avi = fmul float %i.auh, %41
  %i.avj = tail call float @llvm.fmuladd.f32(float %i.auf, float %i.ava, float %i.avi)
  %42 = extractelement <2 x float> %40, i64 0
  %i.avk = tail call float @llvm.fmuladd.f32(float %i.auj, float %42, float %i.avj) ; 2 uses
  ...
  %43 = shufflevector <2 x float> %40, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.avn = fmul <2 x float> %i.aus, %43
...
scalar.ph244:                                     ; preds = %scalar.ph244.preheader, %scalar.ph244
  ...
  %44 = insertelement <2 x i8> poison, i8 %i.bcy, i64 0
  %45 = insertelement <2 x i8> %44, i8 %i.bcx, i64 1
  %46 = uitofp <2 x i8> %45 to <2 x float>
  %47 = fadd <2 x float> %46, splat (float -1.275000e+02) ; 4 uses
  %48 = shufflevector <2 x float> %47, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.bdc = fmul <2 x float> %i.bco, %48
...
scalar.ph140:                                     ; preds = %scalar.ph140.preheader, %scalar.ph140
  ...
  %51 = insertelement <2 x float> poison, float %i.bra, i64 0
  %52 = insertelement <2 x float> %51, float %i.bqz, i64 1
  %53 = fadd <2 x float> %52, splat (float -5.000000e-01) ; 4 uses
  %54 = extractelement <2 x float> %53, i64 1
  %i.bre = fmul float %i.bnh, %54
  %i.brf = tail call float @llvm.fmuladd.f32(float %i.bnf, float %i.bqy, float %i.bre)
  %55 = extractelement <2 x float> %53, i64 0
  %i.brg = tail call float @llvm.fmuladd.f32(float %i.bnj, float %55, float %i.brf) ; 2 uses
  ...
  %56 = shufflevector <2 x float> %53, <2 x float> poison, <2 x i32> <i32 1, i32 1>
  %i.brj = fmul <2 x float> %i.bqq, %56
  ...
  %i.brn = shufflevector <2 x float> %53, <2 x float> poison, <2 x i32> zeroinitializer
