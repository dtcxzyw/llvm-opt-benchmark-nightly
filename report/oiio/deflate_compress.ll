...
bb.i:                                             ; preds = %deflate_choose_default_litlen_costs.exit.i
  ...
  %9 = getelementptr inbounds nuw i8, ptr %0, i64 9009572
  %10 = getelementptr inbounds nuw i8, ptr %0, i64 1356
  %11 = getelementptr inbounds nuw i8, ptr %0, i64 9009576
  %12 = getelementptr inbounds nuw i8, ptr %0, i64 1360
  %13 = getelementptr inbounds nuw i8, ptr %0, i64 9009580
  %14 = getelementptr inbounds nuw i8, ptr %0, i64 1364
  %15 = getelementptr inbounds nuw i8, ptr %0, i64 9009584
  %16 = getelementptr inbounds nuw i8, ptr %0, i64 1368
  %17 = getelementptr inbounds nuw i8, ptr %0, i64 9009588
  %i.jy = getelementptr inbounds nuw i8, ptr %0, i64 1372
  %18 = getelementptr inbounds nuw i8, ptr %0, i64 9009592
  %19 = getelementptr inbounds nuw i8, ptr %0, i64 1376
  %20 = getelementptr inbounds nuw i8, ptr %0, i64 9009596
  %i.jz = getelementptr inbounds nuw i8, ptr %0, i64 1380
  %i.ka = load i32, ptr %20, align 4, !tbaa !20
  %21 = load i32, ptr %18, align 8, !tbaa !20
  %22 = load i32, ptr %17, align 4, !tbaa !20
  %23 = load i32, ptr %15, align 16, !tbaa !20
  %24 = load i32, ptr %13, align 4, !tbaa !20
  %25 = load i32, ptr %11, align 8, !tbaa !20
  %26 = load i32, ptr %i.jq, align 32, !tbaa !20
  %i.kb = load i32, ptr %9, align 4, !tbaa !20
  %i.kc = zext i32 %i.ka to i64
  %27 = zext i32 %21 to i64
  %28 = zext i32 %22 to i64
  %29 = zext i32 %23 to i64
  %i.kd = zext i32 %24 to i64
  %30 = zext i32 %25 to i64
  %31 = zext i32 %26 to i64
  %32 = zext i32 %i.kb to i64
  %33 = mul nuw i64 %i.kc, %i.jt                  ; 2 uses
  %34 = mul nuw i64 %27, %i.jt                    ; 2 uses
  %35 = mul nuw i64 %28, %i.jt                    ; 2 uses
  %36 = mul nuw i64 %29, %i.jt                    ; 2 uses
  %37 = mul nuw i64 %i.kd, %i.jt                  ; 2 uses
  %38 = mul nuw i64 %30, %i.jt                    ; 2 uses
  %i.ke = mul nuw i64 %31, %i.jt                  ; 2 uses
  %39 = mul nuw i64 %32, %i.jt                    ; 2 uses
  %i.kf = load i32, ptr %i.jz, align 4, !tbaa !3
  %40 = load i32, ptr %19, align 32, !tbaa !3
  %41 = load i32, ptr %i.jy, align 4, !tbaa !3
  %42 = load i32, ptr %16, align 8, !tbaa !3
  %43 = load i32, ptr %14, align 4, !tbaa !3
  %44 = load i32, ptr %12, align 16, !tbaa !3
  %45 = load i32, ptr %i.ju, align 8, !tbaa !3
  %46 = load i32, ptr %10, align 4, !tbaa !3
  %47 = zext i32 %i.kf to i64
  %i.kg = zext i32 %40 to i64
  %48 = zext i32 %41 to i64
  %49 = zext i32 %42 to i64
  %50 = zext i32 %43 to i64
  %i.kh = zext i32 %44 to i64
  %51 = zext i32 %45 to i64
  %52 = zext i32 %46 to i64
  %53 = mul nuw i64 %47, %i.jx                    ; 2 uses
  %54 = mul nuw i64 %i.kg, %i.jx                  ; 2 uses
  %55 = mul nuw i64 %48, %i.jx                    ; 2 uses
  %56 = mul nuw i64 %49, %i.jx                    ; 2 uses
  %57 = mul nuw i64 %50, %i.jx                    ; 2 uses
  %58 = mul nuw i64 %i.kh, %i.jx                  ; 2 uses
  %59 = mul nuw i64 %51, %i.jx                    ; 2 uses
  %i.ki = mul nuw i64 %52, %i.jx                  ; 2 uses
  %60 = icmp ugt i64 %33, %53
  %61 = icmp ugt i64 %34, %54
  %62 = icmp ugt i64 %35, %55
  %63 = icmp ugt i64 %36, %56
  %i.kj = icmp ugt i64 %37, %57
  %64 = icmp ugt i64 %38, %58
  %65 = icmp ugt i64 %i.ke, %59
  %66 = icmp ugt i64 %39, %i.ki
  %67 = insertelement <8 x i64> poison, i64 %i.ke, i64 0
  %68 = insertelement <8 x i64> %67, i64 %39, i64 1
  %69 = insertelement <8 x i64> %68, i64 %38, i64 2
  %70 = insertelement <8 x i64> %69, i64 %37, i64 3
  %71 = insertelement <8 x i64> %70, i64 %36, i64 4
  %72 = insertelement <8 x i64> %71, i64 %35, i64 5
  %73 = insertelement <8 x i64> %72, i64 %34, i64 6
  %74 = insertelement <8 x i64> %73, i64 %33, i64 7 ; 2 uses
  %75 = insertelement <8 x i64> poison, i64 %59, i64 0
  %76 = insertelement <8 x i64> %75, i64 %i.ki, i64 1
  %77 = insertelement <8 x i64> %76, i64 %58, i64 2
  %78 = insertelement <8 x i64> %77, i64 %57, i64 3
  %79 = insertelement <8 x i64> %78, i64 %56, i64 4
  %80 = insertelement <8 x i64> %79, i64 %55, i64 5
  %81 = insertelement <8 x i64> %80, i64 %54, i64 6
  %82 = insertelement <8 x i64> %81, i64 %53, i64 7 ; 2 uses
  %83 = sub nuw <8 x i64> %74, %82
  %84 = sub nuw <8 x i64> %82, %74
  %85 = insertelement <8 x i1> poison, i1 %65, i64 0
  %86 = insertelement <8 x i1> %85, i1 %66, i64 1
  %87 = insertelement <8 x i1> %86, i1 %64, i64 2
  %88 = insertelement <8 x i1> %87, i1 %i.kj, i64 3
  %89 = insertelement <8 x i1> %88, i1 %63, i64 4
  %90 = insertelement <8 x i1> %89, i1 %62, i64 5
  %91 = insertelement <8 x i1> %90, i1 %61, i64 6
  %92 = insertelement <8 x i1> %91, i1 %60, i64 7
  %93 = select <8 x i1> %92, <8 x i64> %83, <8 x i64> %84
  ...
  %94 = tail call i64 @llvm.vector.reduce.add.v8i64(<8 x i64> %93)
  %op.rdx = add i64 %94, %i.kv
  %op.rdx334 = add i64 %op.rdx, %i.lh             ; 3 uses
