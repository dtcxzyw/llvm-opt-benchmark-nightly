...
bb.d:                                             ; preds = %bb.aa, %bb.ab, %bb.p
  ...
  %spec.select = phi i8 [ 64, %bb.p ], [ -64, %bb.ab ], [ -64, %bb.aa ]
  %.2.lcssa = phi i8 [ %.2, %bb.p ], [ 0, %bb.ab ], [ %.2.1, %bb.aa ] ; 2 uses
  %3 = trunc nuw i8 %i.f to i1
  %.1106 = select i1 %3, i8 %spec.select, i8 %spec.select.a
...
bb.f:                                             ; preds = %_ZN8ultrahdr13streamReadU16ERKSt6vectorIhSaIhEERtRm.exit164._crit_edge, %_ZN8ultrahdr13streamReadU16ERKSt6vectorIhSaIhEERtRm.exit164.thread
  ...
  %3 = phi i32 [ 2, %_ZN8ultrahdr13streamReadU16ERKSt6vectorIhSaIhEERtRm.exit164._crit_edge ], [ 4, %_ZN8ultrahdr13streamReadU16ERKSt6vectorIhSaIhEERtRm.exit164.thread ]
  %i.ag = phi i64 [ 2, %_ZN8ultrahdr13streamReadU16ERKSt6vectorIhSaIhEERtRm.exit164._crit_edge ], [ 4, %_ZN8ultrahdr13streamReadU16ERKSt6vectorIhSaIhEERtRm.exit164.thread ] ; 3 uses
