...
bb.j:                                             ; preds = %.critedge.i, %bb.i
  ...
  %.145.i.a = phi i32 [ 1, %bb.i ], [ 2, %.critedge.i ] ; 6 uses
...
begin_hunk_1_@VP8SetSegmentParams:bb.a
  ...
  %wide.trip.count.i.1 = zext nneg i32 %.145.i.a to i64
  br label %bb.k
...
bb.l:                                             ; preds = %.critedge.i.1
  %2 = zext nneg i32 %.145.i.a to i64
  %i.gr = getelementptr inbounds nuw [744 x i8], ptr %i.fq, i64 %2
