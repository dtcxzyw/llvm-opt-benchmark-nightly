...
vector.memcheck241:                               ; preds = %.lr.ph.us.i108.i
  ...
  %diff.check243 = icmp ult i64 %i.ahq, 32
  %conflict.rdx = or i1 %diff.check242, %diff.check243
  %i.ahr = add i64 %i.ahm, %i.ahn
  %diff.check244 = icmp ult i64 %i.ahr, 32
  ...
  %diff.check246 = icmp ult i64 %i.ahu, 32
  ...
  %diff.check248 = icmp ult i64 %i.ahx, 32
...
vector.memcheck265:                               ; preds = %.lr.ph.us93.i.i
  ...
  %diff.check267 = icmp ult i64 %i.alg, 32
  %conflict.rdx268 = or i1 %diff.check266, %diff.check267
  %i.alh = add i64 %i.alc, %i.ald
  %diff.check269 = icmp ult i64 %i.alh, 32
  ...
  %diff.check271 = icmp ult i64 %i.alk, 32
  ...
  %diff.check273 = icmp ult i64 %i.aln, 32
