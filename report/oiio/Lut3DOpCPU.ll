...
begin_hunk_0_@_ZNK16OpenColorIO_v2_512_GLOBAL__N_113Lut3DRenderer5applyEPKvPvl:bb.a
  ...
  %i.w = tail call <4 x i32> @llvm.x86.sse2.cvttps2dq(<4 x float> %i.v) ; 4 uses
  %i.x = sitofp <4 x i32> %i.w to <4 x float>     ; 2 uses
  %i.y = fcmp ogt <4 x float> %i.i, %i.x
  %.neg = zext <4 x i1> %i.y to <4 x i32>
  %i.z = add <4 x i32> %i.w, %.neg                ; 2 uses
  %i.aa = fsub <4 x float> %i.v, %i.x             ; 3 uses
  %4 = shufflevector <4 x i32> %i.w, <4 x i32> %i.z, <4 x i32> <i32 2, i32 6, i32 1, i32 5> ; 3 uses
  ...
  %5 = shufflevector <4 x i32> %4, <4 x i32> poison, <4 x i32> <i32 2, i32 2, i32 3, i32 3> ; 2 uses
...
begin_hunk_1_@_ZNK16OpenColorIO_v2_512_GLOBAL__N_113Lut3DRenderer5applyEPKvPvl:bb.a
  ...
  %6 = shufflevector <4 x i32> %4, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>, <4 x i32> <i32 2, i32 3, i32 3, i32 4> ; 2 uses
