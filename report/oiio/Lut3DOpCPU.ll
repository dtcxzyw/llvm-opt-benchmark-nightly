...
.preheader149:                                    ; preds = %bb.a, %.loopexit
  ...
  %.0110171.a = phi i64 [ 0, %bb.a ], [ %i.rp, %.loopexit ] ; 4 uses
  %6 = phi <2 x float> [ zeroinitializer, %bb.a ], [ %18, %.loopexit ] ; 3 uses
  %7 = phi <2 x i64> [ zeroinitializer, %bb.a ], [ %19, %.loopexit ] ; 2 uses
  %i.dh = getelementptr inbounds nuw [8 x i8], ptr %i.n, i64 %.0110171.a ; 2 uses
  %i.di = load i64, ptr %i.dh, align 8, !tbaa !117 ; 2 uses
  %i.dj = getelementptr inbounds nuw [8 x i8], ptr %i.o, i64 %.0110171.a
...
bb.b:                                             ; preds = %.lr.ph170, %bb.ab
  ...
  %.1169.a = phi i64 [ %.0110171.a, %.lr.ph170 ], [ %.4.a, %bb.ab ] ; 6 uses
  %9 = phi <2 x i64> [ %7, %.lr.ph170 ], [ %17, %bb.ab ] ; 4 uses
  %i.dr = getelementptr inbounds [8 x i8], ptr %i.p, i64 %.1169.a ; 3 uses
  %i.ds = load i64, ptr %i.dr, align 8, !tbaa !117 ; 6 uses
  %i.dt = getelementptr inbounds nuw [112 x i8], ptr %.val129.pre, i64 %.1169.a ; 4 uses
...
._crit_edge168:                                   ; preds = %.lr.ph167, %.preheader
  ...
  %i.ex = mul i64 %i.dm, %11
  %12 = extractelement <2 x i64> %10, i64 1
  %i.ey = mul i64 %i.dn, %12
...
bb.ab:                                            ; preds = %select.unfold, %bb.g, %bb.aa, %.critedge
  ...
  %.4.a = phi i64 [ %i.bo, %select.unfold ], [ %i.qz, %bb.aa ], [ %.1169.a, %bb.g ], [ %.1169.a, %.critedge ] ; 4 uses
  %17 = phi <2 x i64> [ %10, %select.unfold ], [ %9, %bb.aa ], [ %9, %bb.g ], [ %9, %.critedge ] ; 2 uses
  %i.rj = getelementptr inbounds [8 x i8], ptr %i.n, i64 %.4.a ; 2 uses
  %i.rk = load i64, ptr %i.rj, align 8, !tbaa !117 ; 2 uses
  %i.rl = getelementptr inbounds [8 x i8], ptr %i.o, i64 %.4.a
