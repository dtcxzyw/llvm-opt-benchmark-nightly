...
bb.af:                                            ; preds = %bb.ae, %bb.ad
  %.1611 = phi i64 [ %i.fh, %bb.ae ], [ %.0610991, %bb.ad ] ; 5 uses
  %.1606 = phi i64 [ %i.fk, %bb.ae ], [ %.0605993, %bb.ad ] ; 5 uses
  %.1602 = phi i64 [ %i.fn, %bb.ae ], [ %.0601994, %bb.ad ] ; 5 uses
  %.1599 = phi i64 [ %i.fq, %bb.ae ], [ %.0598995, %bb.ad ] ; 5 uses
...
bb.aw:                                            ; preds = %bb.av
  ...
  %2 = lshr i64 %i.kt, 8
  %i.ku = udiv i64 %2, %i.es
  %i.kv = trunc nuw nsw i64 %i.ku to i32          ; 2 uses
...
bb.ay:                                            ; preds = %bb.av
  ...
  %3 = lshr i64 %i.kx, 8
  %i.ky = udiv i64 %3, %i.es
  %i.kz = trunc nuw nsw i64 %i.ky to i32          ; 2 uses
...
bb.bg:                                            ; preds = %bb.bf
  ...
  %4 = lshr i64 %i.mb, 8
  %i.mc = udiv i64 %4, %i.ev
  %i.md = trunc nuw nsw i64 %i.mc to i32          ; 2 uses
...
bb.bi:                                            ; preds = %bb.bf
  ...
  %5 = lshr i64 %i.mf, 8
  %i.mg = udiv i64 %5, %i.ev
  %i.mh = trunc nuw nsw i64 %i.mg to i32          ; 2 uses
...
bb.cz:                                            ; preds = %bb.cy
  ...
  %14 = lshr i64 %i.qw, 8
  %i.qx = udiv i64 %14, %.1606
  %i.qy = trunc nuw nsw i64 %i.qx to i32          ; 2 uses
...
bb.db:                                            ; preds = %bb.cy
  ...
  %15 = lshr i64 %i.ra, 8
  %i.rb = udiv i64 %15, %.1606
  %i.rc = trunc nuw nsw i64 %i.rb to i32          ; 2 uses
...
bb.dg:                                            ; preds = %bb.df
  ...
  %16 = lshr i64 %i.rr, 8
  %i.rs = udiv i64 %16, %.1602
  %i.rt = trunc nuw nsw i64 %i.rs to i32          ; 2 uses
...
bb.di:                                            ; preds = %bb.df
  ...
  %17 = lshr i64 %i.rv, 8
  %i.rw = udiv i64 %17, %.1602
  %i.rx = trunc nuw nsw i64 %i.rw to i32          ; 2 uses
