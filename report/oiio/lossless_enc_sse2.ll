...
bb.e:                                             ; preds = %bb.c
  ...
  %i.ao = tail call i64 %i.an(i32 noundef %i.ah) #8, !inline_history !25
...
bb.g:                                             ; preds = %.lr.ph._crit_edge
  ...
  %i.bc = tail call i64 %i.bb(i32 noundef %i.av) #8, !inline_history !25
...
begin_hunk_3_@CombinedShannonEntropy_SSE2:bb.a
  ...
  br i1 %i.bh, label %bb.b, label %bb.h, !llvm.loop !27
...
bb.j:                                             ; preds = %bb.h
  ...
  %i.bn = tail call i64 %i.bm(i32 noundef %.159.lcssa) #8, !inline_history !25
...
bb.l:                                             ; preds = %VP8LFastSLog2.exit66
  ...
  %i.bu = tail call i64 %i.bt(i32 noundef %.162.lcssa) #8, !inline_history !25
