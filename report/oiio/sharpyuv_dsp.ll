...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <8 x i16>, ptr %i.ae, align 2, !tbaa !9, !alias.scope !41
  %6 = freeze <8 x i16> %wide.vec                 ; 2 uses
  %7 = bitcast <8 x i16> %6 to <4 x i32>
  %8 = bitcast <8 x i16> %6 to <4 x i32>
  %9 = and <4 x i32> %8, splat (i32 65535)
  %10 = lshr <4 x i32> %7, splat (i32 16)
  %i.af = add nsw <4 x i32> %i.v, %9              ; 2 uses
  ...
  %i.ai = add nsw <4 x i32> %i.ac, %10            ; 2 uses
