...
.lr.ph.epil:                                      ; preds = %.lr.ph.epil, %.lr.ph.epil.preheader
  ...
  %i.h = shl nsw i32 %indvars.iv.tr.epil, 3
  %i.i = shl i32 %i.g, %i.h
...
.lr.ph:                                           ; preds = %.lr.ph, %.lr.ph.preheader.new
  ...
  %i.z = shl nsw i32 %indvars.iv.tr.1, 3
  ...
  %i.af = shl nsw i32 %indvars.iv.tr.2, 3
  ...
  %i.al = shl nsw i32 %indvars.iv.tr.3, 3
...
.lr.ph.i.epil:                                    ; preds = %.lr.ph.i.epil, %.lr.ph.i.epil.preheader
  ...
  %i.bk = shl nsw i32 %indvars.iv.tr.i.epil, 3
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.preheader, %.lr.ph.i
  ...
  %i.ca = shl nsw i32 %indvars.iv.tr.i.1, 3
  ...
  %i.cg = shl nsw i32 %indvars.iv.tr.i.2, 3
  ...
  %i.cm = shl nsw i32 %indvars.iv.tr.i.3, 3
...
.lr.ph.i168.epil:                                 ; preds = %.lr.ph.i168.epil, %.lr.ph.i168.epil.preheader
  ...
  %i.gz = shl nsw i32 %indvars.iv.tr.i171.epil, 3
...
.lr.ph.i168:                                      ; preds = %.lr.ph.i168.preheader, %.lr.ph.i168
  ...
  %i.hp = shl nsw i32 %indvars.iv.tr.i171.1, 3
  ...
  %i.hv = shl nsw i32 %indvars.iv.tr.i171.2, 3
  ...
  %i.ib = shl nsw i32 %indvars.iv.tr.i171.3, 3
...
.lr.ph.i182.epil:                                 ; preds = %.lr.ph.i182.epil, %.lr.ph.i182.epil.preheader
  ...
  %i.mm = shl nsw i32 %indvars.iv.tr.i185.epil, 3
...
.lr.ph.i182:                                      ; preds = %.lr.ph.i182.preheader, %.lr.ph.i182
  ...
  %i.nc = shl nsw i32 %indvars.iv.tr.i185.1, 3
  ...
  %i.ni = shl nsw i32 %indvars.iv.tr.i185.2, 3
  ...
  %i.no = shl nsw i32 %indvars.iv.tr.i185.3, 3
