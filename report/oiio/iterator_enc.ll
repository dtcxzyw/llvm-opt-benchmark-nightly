...
iter.check310:                                    ; preds = %.preheader.i175, %.lr.ph18.i163..lr.ph.i183_crit_edge
  ...
  %2 = add nsw i64 %wide.trip.count.i184.pre-phi, -1
  %xtraiter388 = and i64 %wide.trip.count.i184.pre-phi, 3 ; 3 uses
  %min.iters.check308 = icmp ult i64 %2, 3
...
vector.memcheck306:                               ; preds = %iter.check310
  %unroll_iter392 = and i64 %wide.trip.count.i184.pre-phi, 2147483644
  br label %vec.epilog.scalar.ph321

vec.epilog.ph324:                                 ; preds = %vec.epilog.scalar.ph321
  %cmp.n331 = icmp eq i64 %xtraiter388, 0
  br i1 %cmp.n331, label %.preheader.i189, label %vec.epilog.scalar.ph321.preheader

vec.epilog.scalar.ph321.preheader:                ; preds = %vec.epilog.ph324, %iter.check310
  %indvars.iv.i185.epil.init = phi i64 [ 0, %iter.check310 ], [ %indvars.iv.next.i187.3, %vec.epilog.ph324 ]
  %.01415.i186.epil.init = phi ptr [ %i.pz, %iter.check310 ], [ %i.qy, %vec.epilog.ph324 ]
  %lcmp.mod391 = icmp ne i64 %xtraiter388, 0
  tail call void @llvm.assume(i1 %lcmp.mod391)
  br label %vec.epilog.scalar.ph321.prol

vec.epilog.scalar.ph321.prol:                     ; preds = %vec.epilog.scalar.ph321.prol, %vec.epilog.scalar.ph321.preheader
  %indvars.iv.i185.prol = phi i64 [ %indvars.iv.i185.epil.init, %vec.epilog.scalar.ph321.preheader ], [ %indvars.iv.next.i187.prol, %vec.epilog.scalar.ph321.prol ] ; 2 uses
  %.01415.i186.prol = phi ptr [ %.01415.i186.epil.init, %vec.epilog.scalar.ph321.preheader ], [ %i.qd, %vec.epilog.scalar.ph321.prol ] ; 2 uses
  %prol.iter415 = phi i64 [ 0, %vec.epilog.scalar.ph321.preheader ], [ %prol.iter415.next, %vec.epilog.scalar.ph321.prol ]
  ...
  %indvars.iv.next.i187.prol = add nuw nsw i64 %indvars.iv.i185.prol, 1
  %i.qd = getelementptr inbounds nuw i8, ptr %.01415.i186.prol, i64 1
  %prol.iter415.next = add i64 %prol.iter415, 1   ; 2 uses
  %prol.iter415.cmp.not = icmp eq i64 %prol.iter415.next, %xtraiter388
  br i1 %prol.iter415.cmp.not, label %.preheader.i189, label %vec.epilog.scalar.ph321.prol, !llvm.loop !99

.preheader.i189:                                  ; preds = %vec.epilog.scalar.ph321.prol, %vec.epilog.ph324
...
vec.epilog.scalar.ph321:                          ; preds = %vec.epilog.scalar.ph321, %vector.memcheck306
  %indvars.iv.i185 = phi i64 [ 0, %vector.memcheck306 ], [ %indvars.iv.next.i187.3, %vec.epilog.scalar.ph321 ] ; 5 uses
  %.01415.i186 = phi ptr [ %i.pz, %vector.memcheck306 ], [ %i.qy, %vec.epilog.scalar.ph321 ] ; 5 uses
  %niter393 = phi i64 [ 0, %vector.memcheck306 ], [ %niter393.next.3, %vec.epilog.scalar.ph321 ]
...
begin_hunk_4
  ...
  %i.qy = getelementptr inbounds nuw i8, ptr %.01415.i186, i64 4 ; 2 uses
  %niter393.next.3 = add i64 %niter393, 4         ; 2 uses
  %exitcond.not.i188.3 = icmp eq i64 %niter393.next.3, %unroll_iter392
  br i1 %exitcond.not.i188.3, label %vec.epilog.ph324, label %vec.epilog.scalar.ph321, !llvm.loop !84
