...
.lr.ph303.preheader:                              ; preds = %bb.z
  %.promoted = load i32, ptr %i.gn, align 4, !tbaa !3
  br label %.lr.ph303

.lr.ph303.preheader.a:                            ; preds = %bb.ab
  %.promoted.a = load i32, ptr %i.gn, align 4, !tbaa !3
  %11 = zext i32 %.promoted.a to i64
  br label %._crit_edge304

._crit_edge304:                                   ; preds = %.lr.ph303.preheader.a, %bb.z
  %12 = phi i64 [ %11, %.lr.ph303.preheader.a ], [ 0, %bb.z ]
...
.lr.ph303:                                        ; preds = %.lr.ph303.preheader, %bb.ab
  %i.gr = phi i32 [ %i.gw, %bb.ab ], [ %.promoted, %.lr.ph303.preheader ]
  %.0115301 = phi i64 [ %i.ha, %bb.ab ], [ 0, %.lr.ph303.preheader ] ; 2 uses
...
bb.ab:                                            ; preds = %.lr.ph303, %bb.aa
  ...
  br i1 %exitcond364.not, label %.lr.ph303.preheader.a, label %.lr.ph303, !llvm.loop !151
