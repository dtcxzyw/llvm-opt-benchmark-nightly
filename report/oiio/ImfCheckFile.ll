...
.preheader334.us.preheader:                       ; preds = %.preheader334.lr.ph
  ...
  %wide.trip.count609 = zext i32 %i.g to i64      ; 4 uses
  %wide.trip.count624 = zext nneg i32 %i.i to i64
  ...
  %xtraiter = and i64 %wide.trip.count609, 3      ; 3 uses
  %i.cf = icmp ult i32 %i.g, 4
  %unroll_iter = and i64 %wide.trip.count609, 2147483644
  %lcmp.mod.not = icmp eq i64 %xtraiter, 0
  %lcmp.mod813 = icmp ne i64 %xtraiter, 0
  %xtraiter815 = and i64 %wide.trip.count609, 1
  %i.cg = icmp eq i32 %i.g, 1
  %unroll_iter821 = and i64 %wide.trip.count609, 2147483646
