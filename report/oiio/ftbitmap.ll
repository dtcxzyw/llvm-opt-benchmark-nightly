...
bb.ag:                                            ; preds = %.lr.ph267, %bb.ai
  ...
  %.4264 = phi ptr [ %.0183, %.lr.ph267 ], [ %i.in, %bb.ai ] ; 10 uses
  %.4196263 = phi ptr [ %.0192, %.lr.ph267 ], [ %i.iq, %bb.ai ] ; 11 uses
  %i.gh = load i32, ptr %i.gg, align 4, !tbaa !31 ; 5 uses
...
.lr.ph259.preheader.a:                            ; preds = %bb.ag
  ...
  %i.gk = zext nneg i32 %i.gj to i64              ; 5 uses
...
begin_hunk_1_@FT_Bitmap_Convert:bb.a
  ...
  br i1 %found.conflict, label %.lr.ph259.preheader381, label %vector.main.loop.iter.check
...
vector.ph:                                        ; preds = %vector.main.loop.iter.check
  %n.mod.vf = and i64 %i.gk, 12
  %n.vec = and i64 %i.gk, 2147483632              ; 6 uses
...
begin_hunk_2_@FT_Bitmap_Convert:bb.a
  ...
  br i1 %i.gy, label %middle.block, label %vector.body, !llvm.loop !63
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph259.preheader381, label %vec.epilog.ph, !prof !64

vec.epilog.ph:                                    ; preds = %vector.main.loop.iter.check, %vec.epilog.iter.check
  %vec.epilog.resume.val = phi i64 [ %n.vec, %vec.epilog.iter.check ], [ 0, %vector.main.loop.iter.check ]
  %n.vec378 = and i64 %i.gk, 2147483644           ; 5 uses
  %.cast379 = trunc nuw nsw i64 %n.vec378 to i32
  %4 = sub nsw i32 %i.gi, %.cast379
  %5 = shl nuw nsw i64 %n.vec378, 1
  %6 = getelementptr i8, ptr %.4196263, i64 %5    ; 2 uses
  %7 = getelementptr i8, ptr %.4264, i64 %n.vec378 ; 2 uses
  br label %vec.epilog.vector.body

vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  %index380 = phi i64 [ %vec.epilog.resume.val, %vec.epilog.ph ], [ %index.next385, %vec.epilog.vector.body ] ; 3 uses
  %8 = shl i64 %index380, 1
  %next.gep381 = getelementptr i8, ptr %.4196263, i64 %8
  %next.gep382 = getelementptr i8, ptr %.4264, i64 %index380
  %wide.load383 = load <4 x i8>, ptr %next.gep382, align 1, !tbaa !23, !alias.scope !58 ; 2 uses
  %9 = lshr <4 x i8> %wide.load383, splat (i8 4)
  %10 = and <4 x i8> %wide.load383, splat (i8 15)
  %interleaved.vec384 = shufflevector <4 x i8> %9, <4 x i8> %10, <8 x i32> <i32 0, i32 4, i32 1, i32 5, i32 2, i32 6, i32 3, i32 7>
  store <8 x i8> %interleaved.vec384, ptr %next.gep381, align 1, !tbaa !23, !alias.scope !61, !noalias !58
  %index.next385 = add nuw i64 %index380, 4       ; 2 uses
  %11 = icmp eq i64 %index.next385, %n.vec378
  br i1 %11, label %middle.block.a, label %vec.epilog.vector.body, !llvm.loop !65

middle.block.a:                                   ; preds = %vec.epilog.vector.body
  %cmp.n.a = icmp eq i64 %n.vec378, %i.gk
  br i1 %cmp.n.a, label %._crit_edge260.loopexit, label %.lr.ph259.preheader381

.lr.ph259.preheader381:                           ; preds = %vector.memcheck, %.lr.ph259.preheader.a, %vec.epilog.iter.check, %middle.block.a
  %.0178257.ph = phi i32 [ %i.gi, %.lr.ph259.preheader.a ], [ %i.gi, %vector.memcheck ], [ %i.go, %vec.epilog.iter.check ], [ %4, %middle.block.a ] ; 4 uses
  %.0179256.ph = phi ptr [ %.4196263, %.lr.ph259.preheader.a ], [ %.4196263, %vector.memcheck ], [ %i.gq, %vec.epilog.iter.check ], [ %6, %middle.block.a ] ; 2 uses
  %.0180255.ph = phi ptr [ %.4264, %.lr.ph259.preheader.a ], [ %.4264, %vector.memcheck ], [ %i.gr, %vec.epilog.iter.check ], [ %7, %middle.block.a ] ; 2 uses
...
begin_hunk_3_@FT_Bitmap_Convert:bb.a
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph259.prol.loopexit, label %.lr.ph259.prol, !llvm.loop !66
...
begin_hunk_4_@FT_Bitmap_Convert:bb.a
  ...
  br i1 %.not223.3, label %._crit_edge260.loopexit, label %.lr.ph259, !llvm.loop !67

._crit_edge260.loopexit:                          ; preds = %.lr.ph259.prol.loopexit, %.lr.ph259, %middle.block.a, %middle.block
  %.lcssa366 = phi ptr [ %7, %middle.block.a ], [ %i.gr, %middle.block ], [ %.lcssa384.unr, %.lr.ph259.prol.loopexit ], [ %i.ie, %.lr.ph259 ]
  %.lcssa365 = phi ptr [ %6, %middle.block.a ], [ %i.gq, %middle.block ], [ %.lcssa383.unr, %.lr.ph259.prol.loopexit ], [ %i.if, %.lr.ph259 ]
...
begin_hunk_5_@FT_Bitmap_Convert:bb.a
  ...
  br i1 %.not222, label %.loopexit238, label %bb.ag, !llvm.loop !68
...
begin_hunk_6_@FT_Bitmap_Convert:bb.a
  ...
  br i1 %.not221, label %._crit_edge.loopexit, label %.lr.ph, !llvm.loop !69
...
begin_hunk_7_@FT_Bitmap_Convert:bb.a
  ...
  br i1 %.not220, label %.loopexit238, label %.lr.ph253.splitthread-pre-split, !llvm.loop !70
...
begin_hunk_9_@FT_Bitmap_Blend:bb.a
  ...
  br i1 %i.dr, label %bb.aa, label %.thread286, !llvm.loop !76
...
begin_hunk_10_@FT_Bitmap_Blend:bb.a
  ...
  br i1 %i.gt, label %.lr.ph305, label %._crit_edge.loopexit, !llvm.loop !77
...
begin_hunk_11_@FT_Bitmap_Blend:bb.a
  ...
  br i1 %i.ha, label %bb.af, label %.loopexit, !llvm.loop !78
...
.loopexit:                                        ; preds = %._crit_edge, %bb.ae, %bb.ad
  ...
  store i64 %i.hc, ptr %i.af, align 8, !tbaa !75
...
.thread:                                          ; preds = %bb.d
  ...
  %i.l = load ptr, ptr %i.d, align 8, !tbaa !91
  %i.m = getelementptr inbounds nuw i8, ptr %i.l, i64 8 ; 2 uses
  %i.n = load i32, ptr %i.m, align 8, !tbaa !92
  %i.o = or i32 %i.n, 1
  store i32 %i.o, ptr %i.m, align 8, !tbaa !92
  br label %.sink.split
...
!65 = distinct !{!65, !29, !42, !43}
!66 = distinct !{!66, !27}
!67 = distinct !{!67, !29, !42}
!68 = distinct !{!68, !29}
!69 = distinct !{!69, !29}
!70 = distinct !{!70, !29, !71}
!71 = !{!"llvm.loop.unswitch.partial.disable"}
!72 = !{!73, !74, i64 0}
!73 = !{!"FT_Vector_", !74, i64 0, !74, i64 8}
!74 = !{!"long", !5, i64 0}
!75 = !{!73, !74, i64 8}
!76 = distinct !{!76, !29}
!77 = distinct !{!77, !29}
!78 = distinct !{!78, !29}
!79 = !{!80, !4, i64 144}
!80 = !{!"FT_GlyphSlotRec_", !81, i64 0, !82, i64 8, !83, i64 16, !4, i64 24, !84, i64 32, !85, i64 48, !74, i64 112, !74, i64 120, !73, i64 128, !4, i64 144, !8, i64 152, !4, i64 192, !4, i64 196, !86, i64 200, !4, i64 240, !89, i64 248, !10, i64 256, !74, i64 264, !74, i64 272, !74, i64 280, !10, i64 288, !90, i64 296}
!81 = !{!"p1 _ZTS14FT_LibraryRec_", !10, i64 0}
!82 = !{!"p1 _ZTS11FT_FaceRec_", !10, i64 0}
!83 = !{!"p1 _ZTS16FT_GlyphSlotRec_", !10, i64 0}
!84 = !{!"FT_Generic_", !10, i64 0, !10, i64 8}
!85 = !{!"FT_Glyph_Metrics_", !74, i64 0, !74, i64 8, !74, i64 16, !74, i64 24, !74, i64 32, !74, i64 40, !74, i64 48, !74, i64 56}
!86 = !{!"FT_Outline_", !11, i64 0, !11, i64 2, !87, i64 8, !9, i64 16, !88, i64 24, !4, i64 32}
!87 = !{!"p1 _ZTS10FT_Vector_", !10, i64 0}
!88 = !{!"p1 short", !10, i64 0}
!89 = !{!"p1 _ZTS15FT_SubGlyphRec_", !10, i64 0}
!90 = !{!"p1 _ZTS20FT_Slot_InternalRec_", !10, i64 0}
!91 = !{!80, !90, i64 296}
!92 = !{!93, !4, i64 8}
!93 = !{!"FT_Slot_InternalRec_", !94, i64 0, !4, i64 8, !5, i64 12, !95, i64 16, !73, i64 48, !10, i64 64, !4, i64 72}
!94 = !{!"p1 _ZTS18FT_GlyphLoaderRec_", !10, i64 0}
!95 = !{!"FT_Matrix_", !74, i64 0, !74, i64 8, !74, i64 16, !74, i64 24}
!96 = !{!80, !81, i64 0}
end_hunk_15
