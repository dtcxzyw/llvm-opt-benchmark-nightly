...
pred.store.continue37:                            ; preds = %pred.store.continue, %pred.store.if36
...
pred.store.continue39:                            ; preds = %pred.store.continue37, %pred.store.if38
...
pred.store.continue21:                            ; preds = %pred.store.continue, %pred.store.if20
