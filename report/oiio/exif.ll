...
.lr.ph.i.i.i.i.preheader:                         ; preds = %bb.a
  ...
  %min.iters.check = icmp ult i64 %i.g, 168
  br i1 %min.iters.check, label %.lr.ph.i.i.i.i.preheader24, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.preheader
  %n.vec = and i64 %i.i, 2305843009213693944      ; 3 uses
  %i.j = mul i64 %n.vec, 24
...
vector.body:                                      ; preds = %pred.store.continue23, %vector.ph
  ...
  %i.l = mul i64 %index, 24                       ; 8 uses
  %next.gep = getelementptr i8, ptr %i.b, i64 %i.l ; 2 uses
  %i.m = getelementptr i8, ptr %i.b, i64 %i.l
  %next.gep3 = getelementptr i8, ptr %i.m, i64 24 ; 2 uses
  %i.n = getelementptr i8, ptr %i.b, i64 %i.l
  %next.gep4 = getelementptr i8, ptr %i.n, i64 48 ; 2 uses
  %i.o = getelementptr i8, ptr %i.b, i64 %i.l
  %next.gep5 = getelementptr i8, ptr %i.o, i64 72 ; 2 uses
  %i.p = getelementptr i8, ptr %i.b, i64 %i.l
  %next.gep6 = getelementptr i8, ptr %i.p, i64 96 ; 2 uses
  %i.q = getelementptr i8, ptr %i.b, i64 %i.l
  %next.gep7 = getelementptr i8, ptr %i.q, i64 120 ; 2 uses
  %i.r = getelementptr i8, ptr %i.b, i64 %i.l
  %next.gep8 = getelementptr i8, ptr %i.r, i64 144 ; 2 uses
  %i.s = getelementptr i8, ptr %i.b, i64 %i.l
  %next.gep9 = getelementptr i8, ptr %i.s, i64 168 ; 2 uses
  %i.t = load i16, ptr %next.gep, align 8, !tbaa !16
  %i.u = load i16, ptr %next.gep3, align 8, !tbaa !16
  %i.v = load i16, ptr %next.gep4, align 8, !tbaa !16
  %i.w = load i16, ptr %next.gep5, align 8, !tbaa !16
  %i.x = load i16, ptr %next.gep6, align 8, !tbaa !16
  %i.y = load i16, ptr %next.gep7, align 8, !tbaa !16
  %i.z = load i16, ptr %next.gep8, align 8, !tbaa !16
  %i.aa = load i16, ptr %next.gep9, align 8, !tbaa !16
  %i.ab = insertelement <8 x i16> poison, i16 %i.t, i64 0
  %i.ac = insertelement <8 x i16> %i.ab, i16 %i.u, i64 1
  %i.ad = insertelement <8 x i16> %i.ac, i16 %i.v, i64 2
  %i.ae = insertelement <8 x i16> %i.ad, i16 %i.w, i64 3
  %i.af = insertelement <8 x i16> %i.ae, i16 %i.x, i64 4
  %i.ag = insertelement <8 x i16> %i.af, i16 %i.y, i64 5
  %i.ah = insertelement <8 x i16> %i.ag, i16 %i.z, i64 6
  %i.ai = insertelement <8 x i16> %i.ah, i16 %i.aa, i64 7
  %i.aj = icmp ne <8 x i16> %i.ai, splat (i16 -1) ; 8 uses
  %i.ak = extractelement <8 x i1> %i.aj, i64 0
  br i1 %i.ak, label %pred.store.if, label %pred.store.continue
...
.lr.ph.i.i.i.i.preheader24:                       ; preds = %.lr.ph.i.i.i.i.preheader, %middle.block
  %.05.i.i.i.i.ph = phi ptr [ %i.b, %.lr.ph.i.i.i.i.preheader ], [ %i.k, %middle.block ]
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.preheader24, %_ZSt8_DestroyIN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEEEvPT_.exit.i.i.i.i
  %.05.i.i.i.i = phi ptr [ %i.av, %_ZSt8_DestroyIN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEEEvPT_.exit.i.i.i.i ], [ %.05.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader24 ] ; 3 uses
  %i.at = load i16, ptr %.05.i.i.i.i, align 8, !tbaa !16
  %i.au = icmp eq i16 %i.at, -1
  br i1 %i.au, label %_ZSt8_DestroyIN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEEEvPT_.exit.i.i.i.i, label %bb.b
...
_ZSt8_DestroyIN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEEEvPT_.exit.i.i.i.i: ; preds = %bb.b, %.lr.ph.i.i.i.i
  %i.av = getelementptr inbounds nuw i8, ptr %.05.i.i.i.i, i64 24 ; 2 uses
  %.not.i.i.i.i = icmp eq ptr %i.av, %i.d
...
bb.c:                                             ; preds = %_ZSt8_DestroyIPN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEESA_EvT_SC_RSaIT0_E.exit.i.i
  ...
  %i.ax = load ptr, ptr %i.aw, align 8, !tbaa !179
  %i.ay = ptrtoint ptr %i.ax to i64
  %i.az = ptrtoint ptr %i.b to i64
  %i.ba = sub i64 %i.ay, %i.az
  tail call void @_ZdlPvm(ptr noundef nonnull %i.b, i64 noundef %i.ba) #31
...
.lr.ph.i.i.i.i.preheader:                         ; preds = %._crit_edge
  ...
  %min.iters.check = icmp ult i64 %i.ap, 168
  br i1 %min.iters.check, label %.lr.ph.i.i.i.i.preheader50, label %vector.ph

vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.preheader
  %n.vec = and i64 %i.ar, 2305843009213693944     ; 3 uses
  %i.as = mul i64 %n.vec, 24
...
vector.body:                                      ; preds = %pred.store.continue49, %vector.ph
  ...
  %i.au = mul i64 %index, 24                      ; 8 uses
  %next.gep = getelementptr i8, ptr %i.l, i64 %i.au ; 2 uses
  %i.av = getelementptr i8, ptr %i.l, i64 %i.au
  %next.gep29 = getelementptr i8, ptr %i.av, i64 24 ; 2 uses
  %i.aw = getelementptr i8, ptr %i.l, i64 %i.au
  %next.gep30 = getelementptr i8, ptr %i.aw, i64 48 ; 2 uses
  %i.ax = getelementptr i8, ptr %i.l, i64 %i.au
  %next.gep31 = getelementptr i8, ptr %i.ax, i64 72 ; 2 uses
  %i.ay = getelementptr i8, ptr %i.l, i64 %i.au
  %next.gep32 = getelementptr i8, ptr %i.ay, i64 96 ; 2 uses
  %i.az = getelementptr i8, ptr %i.l, i64 %i.au
  %next.gep33 = getelementptr i8, ptr %i.az, i64 120 ; 2 uses
  %i.ba = getelementptr i8, ptr %i.l, i64 %i.au
  %next.gep34 = getelementptr i8, ptr %i.ba, i64 144 ; 2 uses
  %i.bb = getelementptr i8, ptr %i.l, i64 %i.au
  %next.gep35 = getelementptr i8, ptr %i.bb, i64 168 ; 2 uses
  %i.bc = load i16, ptr %next.gep, align 8, !tbaa !16
  %i.bd = load i16, ptr %next.gep29, align 8, !tbaa !16
  %i.be = load i16, ptr %next.gep30, align 8, !tbaa !16
  %i.bf = load i16, ptr %next.gep31, align 8, !tbaa !16
  %i.bg = load i16, ptr %next.gep32, align 8, !tbaa !16
  %i.bh = load i16, ptr %next.gep33, align 8, !tbaa !16
  %i.bi = load i16, ptr %next.gep34, align 8, !tbaa !16
  %i.bj = load i16, ptr %next.gep35, align 8, !tbaa !16
  %i.bk = insertelement <8 x i16> poison, i16 %i.bc, i64 0
  %i.bl = insertelement <8 x i16> %i.bk, i16 %i.bd, i64 1
  %i.bm = insertelement <8 x i16> %i.bl, i16 %i.be, i64 2
  %i.bn = insertelement <8 x i16> %i.bm, i16 %i.bf, i64 3
  %i.bo = insertelement <8 x i16> %i.bn, i16 %i.bg, i64 4
  %i.bp = insertelement <8 x i16> %i.bo, i16 %i.bh, i64 5
  %i.bq = insertelement <8 x i16> %i.bp, i16 %i.bi, i64 6
  %i.br = insertelement <8 x i16> %i.bq, i16 %i.bj, i64 7
  %i.bs = icmp ne <8 x i16> %i.br, splat (i16 -1) ; 8 uses
  %i.bt = extractelement <8 x i1> %i.bs, i64 0
  br i1 %i.bt, label %pred.store.if, label %pred.store.continue
...
pred.store.continue49:                            ; preds = %pred.store.if48, %pred.store.continue47
  ...
  br i1 %i.cb, label %middle.block, label %vector.body, !llvm.loop !199
...
.lr.ph.i.i.i.i.preheader50:                       ; preds = %.lr.ph.i.i.i.i.preheader, %middle.block
  %.05.i.i.i.i.ph = phi ptr [ %i.l, %.lr.ph.i.i.i.i.preheader ], [ %i.at, %middle.block ]
  br label %.lr.ph.i.i.i.i
...
.lr.ph.i.i.i.i:                                   ; preds = %.lr.ph.i.i.i.i.preheader50, %_ZSt8_DestroyIN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEEEvPT_.exit.i.i.i.i
  %.05.i.i.i.i = phi ptr [ %i.ce, %_ZSt8_DestroyIN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEEEvPT_.exit.i.i.i.i ], [ %.05.i.i.i.i.ph, %.lr.ph.i.i.i.i.preheader50 ] ; 3 uses
  %i.cc = load i16, ptr %.05.i.i.i.i, align 8, !tbaa !16
  %i.cd = icmp eq i16 %i.cc, -1
  br i1 %i.cd, label %_ZSt8_DestroyIN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEEEvPT_.exit.i.i.i.i, label %bb.b
...
_ZSt8_DestroyIN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEEEvPT_.exit.i.i.i.i: ; preds = %bb.b, %.lr.ph.i.i.i.i
  %i.ce = getelementptr inbounds nuw i8, ptr %.05.i.i.i.i, i64 24 ; 2 uses
  %.not.i.i.i.i = icmp eq ptr %i.ce, %i.k
...
bb.c:                                             ; preds = %_ZSt8_DestroyIPN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEESA_EvT_SC_RSaIT0_E.exit.i.i
  %i.cf = ptrtoint ptr %i.t to i64
  %i.cg = ptrtoint ptr %i.l to i64
  %i.ch = sub i64 %i.cf, %i.cg
  call void @_ZdlPvm(ptr noundef nonnull %i.l, i64 noundef %i.ch) #31
  br label %_ZN3tsl17detail_robin_hash10robin_hashISt4pairIiPKN11OpenImageIO4v3_17TagInfoEENS_9robin_mapIiS7_St4hashIiESt8equal_toIiESaIS8_ELb0ENS_2rh26power_of_two_growth_policyILm2EEEE9KeySelectENSI_11ValueSelectESB_SD_SE_Lb0ESH_ED2Ev.exit
...
bb.d:                                             ; preds = %.lr.ph, %bb.j
  %.sroa.015.019 = phi ptr [ %i.g, %.lr.ph ], [ %i.dc, %bb.j ] ; 4 uses
  %i.ci = load i16, ptr %.sroa.015.019, align 8, !tbaa !16
  %i.cj = icmp eq i16 %i.ci, -1
  br i1 %i.cj, label %bb.j, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.ck = getelementptr inbounds nuw i8, ptr %.sroa.015.019, i64 8 ; 4 uses
  %i.cl = load i32, ptr %i.ck, align 8, !tbaa !3
  %i.cm = sext i32 %i.cl to i64
  %i.cn = load i64, ptr %2, align 8, !tbaa !70
  %i.co = load ptr, ptr %i.j, align 8, !tbaa !21
  %i.cp = getelementptr inbounds nuw i8, ptr %.sroa.015.019, i64 16 ; 2 uses
  br label %bb.f

bb.f:                                             ; preds = %bb.i, %bb.e
  %.011.i = phi i16 [ 0, %bb.e ], [ %i.da, %bb.i ] ; 4 uses
  %.pn = phi i64 [ %i.cm, %bb.e ], [ %i.db, %bb.i ]
  %.0.i = and i64 %.pn, %i.cn                     ; 2 uses
  %i.cq = getelementptr inbounds nuw [24 x i8], ptr %i.co, i64 %.0.i ; 5 uses
  %i.cr = load i16, ptr %i.cq, align 8, !tbaa !16 ; 3 uses
  %i.cs = icmp sgt i16 %.011.i, %i.cr
  br i1 %i.cs, label %bb.g, label %bb.i

bb.g:                                             ; preds = %bb.f
  %i.ct = icmp eq i16 %i.cr, -1
  %i.cu = getelementptr inbounds nuw i8, ptr %i.cq, i64 8 ; 3 uses
  br i1 %i.ct, label %_ZN3tsl17detail_robin_hash10robin_hashISt4pairIiPKN11OpenImageIO4v3_17TagInfoEENS_9robin_mapIiS7_St4hashIiESt8equal_toIiESaIS8_ELb0ENS_2rh26power_of_two_growth_policyILm2EEEE9KeySelectENSI_11ValueSelectESB_SD_SE_Lb0ESH_E22insert_value_on_rehashEmsjOS8_.exit, label %bb.h

bb.h:                                             ; preds = %bb.g
  %i.cv = load i32, ptr %i.ck, align 8, !tbaa !3
  %i.cw = load i32, ptr %i.cu, align 8, !tbaa !3
  store i32 %i.cw, ptr %i.ck, align 8, !tbaa !3
  store i32 %i.cv, ptr %i.cu, align 8, !tbaa !3
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cq, i64 16 ; 2 uses
  %i.cy = load ptr, ptr %i.cp, align 8, !tbaa !60
  %i.cz = load ptr, ptr %i.cx, align 8, !tbaa !60
  store ptr %i.cz, ptr %i.cp, align 8, !tbaa !60
  store ptr %i.cy, ptr %i.cx, align 8, !tbaa !60
  store i16 %.011.i, ptr %i.cq, align 8, !tbaa !99
  br label %bb.i

bb.i:                                             ; preds = %bb.h, %bb.f
  %.1.i = phi i16 [ %i.cr, %bb.h ], [ %.011.i, %bb.f ]
  %i.da = add i16 %.1.i, 1
  %i.db = add i64 %.0.i, 1
end_hunk_1
...
vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.i2.i.preheader
  %n.vec = and i64 %i.aj, 2305843009213693944     ; 3 uses
  %i.ak = mul i64 %n.vec, 24
...
vector.body:                                      ; preds = %pred.store.continue33, %vector.ph
  ...
  %i.am = mul i64 %index, 24                      ; 8 uses
  %next.gep = getelementptr i8, ptr %i.ac, i64 %i.am ; 2 uses
  %i.an = getelementptr i8, ptr %i.ac, i64 %i.am
  %next.gep13 = getelementptr i8, ptr %i.an, i64 24 ; 2 uses
  %i.ao = getelementptr i8, ptr %i.ac, i64 %i.am
  %next.gep14 = getelementptr i8, ptr %i.ao, i64 48 ; 2 uses
  %i.ap = getelementptr i8, ptr %i.ac, i64 %i.am
  %next.gep15 = getelementptr i8, ptr %i.ap, i64 72 ; 2 uses
  %i.aq = getelementptr i8, ptr %i.ac, i64 %i.am
  %next.gep16 = getelementptr i8, ptr %i.aq, i64 96 ; 2 uses
  %i.ar = getelementptr i8, ptr %i.ac, i64 %i.am
  %next.gep17 = getelementptr i8, ptr %i.ar, i64 120 ; 2 uses
  %i.as = getelementptr i8, ptr %i.ac, i64 %i.am
  %next.gep18 = getelementptr i8, ptr %i.as, i64 144 ; 2 uses
  %i.at = getelementptr i8, ptr %i.ac, i64 %i.am
  %next.gep19 = getelementptr i8, ptr %i.at, i64 168 ; 2 uses
  %i.au = load i16, ptr %next.gep, align 8, !tbaa !16
  %i.av = load i16, ptr %next.gep13, align 8, !tbaa !16
  %i.aw = load i16, ptr %next.gep14, align 8, !tbaa !16
  %i.ax = load i16, ptr %next.gep15, align 8, !tbaa !16
  %i.ay = load i16, ptr %next.gep16, align 8, !tbaa !16
  %i.az = load i16, ptr %next.gep17, align 8, !tbaa !16
  %i.ba = load i16, ptr %next.gep18, align 8, !tbaa !16
  %i.bb = load i16, ptr %next.gep19, align 8, !tbaa !16
  %i.bc = insertelement <8 x i16> poison, i16 %i.au, i64 0
  %i.bd = insertelement <8 x i16> %i.bc, i16 %i.av, i64 1
  %i.be = insertelement <8 x i16> %i.bd, i16 %i.aw, i64 2
  %i.bf = insertelement <8 x i16> %i.be, i16 %i.ax, i64 3
  %i.bg = insertelement <8 x i16> %i.bf, i16 %i.ay, i64 4
  %i.bh = insertelement <8 x i16> %i.bg, i16 %i.az, i64 5
  %i.bi = insertelement <8 x i16> %i.bh, i16 %i.ba, i64 6
  %i.bj = insertelement <8 x i16> %i.bi, i16 %i.bb, i64 7
  %i.bk = icmp ne <8 x i16> %i.bj, splat (i16 -1) ; 8 uses
  %i.bl = extractelement <8 x i1> %i.bk, i64 0
  br i1 %i.bl, label %pred.store.if, label %pred.store.continue
...
pred.store.continue33:                            ; preds = %pred.store.if32, %pred.store.continue31
  ...
  br i1 %i.bt, label %middle.block, label %vector.body, !llvm.loop !231
...
.lr.ph.i.i.i.i.i2.i.preheader34:                  ; preds = %.lr.ph.i.i.i.i.i2.i.preheader, %middle.block
  %.05.i.i.i.i.i3.i.ph = phi ptr [ %i.ac, %.lr.ph.i.i.i.i.i2.i.preheader ], [ %i.al, %middle.block ]
...
.lr.ph.i.i.i.i.i2.i:                              ; preds = %.lr.ph.i.i.i.i.i2.i.preheader34, %_ZSt8_DestroyIN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEEEvPT_.exit.i.i.i.i.i.i
  %.05.i.i.i.i.i3.i = phi ptr [ %i.bw, %_ZSt8_DestroyIN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEEEvPT_.exit.i.i.i.i.i.i ], [ %.05.i.i.i.i.i3.i.ph, %.lr.ph.i.i.i.i.i2.i.preheader34 ] ; 3 uses
  %i.bu = load i16, ptr %.05.i.i.i.i.i3.i, align 8, !tbaa !16
  %i.bv = icmp eq i16 %i.bu, -1
  br i1 %i.bv, label %_ZSt8_DestroyIN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEEEvPT_.exit.i.i.i.i.i.i, label %bb.e
...
_ZSt8_DestroyIN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEEEvPT_.exit.i.i.i.i.i.i: ; preds = %bb.e, %.lr.ph.i.i.i.i.i2.i
  %i.bw = getelementptr inbounds nuw i8, ptr %.05.i.i.i.i.i3.i, i64 24 ; 2 uses
  %.not.i.i.i.i.i4.i = icmp eq ptr %i.bw, %i.ae
...
bb.f:                                             ; preds = %_ZSt8_DestroyIPN3tsl17detail_robin_hash12bucket_entryISt4pairIiPKN11OpenImageIO4v3_17TagInfoEELb0EEESA_EvT_SC_RSaIT0_E.exit.i.i.i.i
  ...
  %i.by = load ptr, ptr %i.bx, align 8, !tbaa !179
  %i.bz = ptrtoint ptr %i.by to i64
  %i.ca = ptrtoint ptr %i.ac to i64
  %i.cb = sub i64 %i.bz, %i.ca
  tail call void @_ZdlPvm(ptr noundef nonnull %i.ac, i64 noundef %i.cb) #31
