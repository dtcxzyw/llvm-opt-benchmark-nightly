...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <8 x i16>, ptr %next.gep25, align 2, !tbaa !70
  %5 = freeze <8 x i16> %wide.vec                 ; 2 uses
  %6 = bitcast <8 x i16> %5 to <4 x i32>          ; 2 uses
  %7 = bitcast <8 x i16> %5 to <4 x i32>
  %8 = and <4 x i32> %7, splat (i32 65535)        ; 3 uses
  %9 = lshr <4 x i32> %6, splat (i32 16)          ; 2 uses
  %i.al = shl nuw nsw <4 x i32> %8, splat (i32 8)
  %i.am = and <4 x i32> %i.al, splat (i32 63488)
  %i.an = shl nuw nsw <4 x i32> %8, splat (i32 3)
  %i.ao = and <4 x i32> %i.an, splat (i32 2016)
  %i.ap = lshr <4 x i32> %8, splat (i32 3)
  %i.aq = or <4 x i32> %i.ao, %i.ap
  %i.ar = or <4 x i32> %i.aq, %i.am
  %i.as = shl nuw nsw <4 x i32> %9, splat (i32 8)
  %i.at = and <4 x i32> %i.as, splat (i32 63488)
  %i.au = shl nuw nsw <4 x i32> %9, splat (i32 3)
  %i.av = and <4 x i32> %i.au, splat (i32 2016)
  %i.aw = lshr <4 x i32> %6, splat (i32 19)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.vec = load <8 x i16>, ptr %next.gep33, align 2, !tbaa !70
  %5 = freeze <8 x i16> %wide.vec
  %6 = bitcast <8 x i16> %5 to <4 x i32>          ; 2 uses
  %wide.vec39 = load <8 x i16>, ptr %next.gep32, align 2, !tbaa !70
  %7 = freeze <8 x i16> %wide.vec39
  %8 = bitcast <8 x i16> %7 to <4 x i32>          ; 2 uses
  ...
  %i.az = shl <4 x i32> %6, splat (i32 8)
  %i.ba = and <4 x i32> %i.az, splat (i32 63488)
  %i.bb = shl <4 x i32> %8, splat (i32 3)
  ...
  %9 = lshr <4 x i32> %6, splat (i32 8)
  %i.bh = and <4 x i32> %9, splat (i32 63488)
  %10 = lshr <4 x i32> %8, splat (i32 13)
