...
.lr.ph:                                           ; preds = %.lr.ph.preheader49, %.lr.ph
  ...
  %i.cd = load <2 x i16>, ptr %.154.i10, align 2, !tbaa !68
  %i.ce = load <2 x i16>, ptr %.152.i11, align 2, !tbaa !68
  %i.cf = load <2 x i16>, ptr %.150.i12, align 2, !tbaa !68
  %i.cg = shl <2 x i16> %i.cd, splat (i16 8)
  %i.ch = and <2 x i16> %i.cg, splat (i16 -2048)
  %i.ci = shl <2 x i16> %i.ce, splat (i16 3)
  %i.cj = and <2 x i16> %i.ci, splat (i16 2016)
  %i.ck = or disjoint <2 x i16> %i.cj, %i.ch
