...
bb.c:                                             ; preds = %_ZN11OpenImageIO4v3_19ImageSpec11auto_strideERlNS0_8TypeDescEi.exit
  ...
  %i.v = load ptr, ptr %i.o, align 8, !tbaa !98
  br label %bb.d
...
bb.d:                                             ; preds = %bb.c, %_ZN11OpenImageIO4v3_19ImageSpec11auto_strideERlNS0_8TypeDescEi.exit
  ...
  %i.x = load i8, ptr %i.w, align 4, !tbaa !117, !range !114, !noundef !115
...
bb.g:                                             ; preds = %bb.d
  ...
  %i.as = load i32, ptr %i.ar, align 4, !tbaa !116
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.bb = load i8, ptr %i.ba, align 1, !tbaa !52  ; 3 uses
  store i8 %i.bb, ptr %i.av, align 2, !tbaa !52
  store i8 %i.bb, ptr %i.au, align 1, !tbaa !52
  store i8 %i.bb, ptr %i.a, align 4, !tbaa !52
  br label %bb.n

bb.k:                                             ; preds = %bb.i
  %i.bc = shl nuw nsw i64 %indvars.iv, 1
  %i.bd = getelementptr inbounds nuw i8, ptr %.066, i64 %i.bc ; 2 uses
  %i.be = load i8, ptr %i.bd, align 1, !tbaa !52  ; 3 uses
  store i8 %i.be, ptr %i.av, align 2, !tbaa !52
  store i8 %i.be, ptr %i.au, align 1, !tbaa !52
  store i8 %i.be, ptr %i.a, align 4, !tbaa !52
  %i.bf = getelementptr inbounds nuw i8, ptr %i.bd, i64 1
  %i.bg = load i8, ptr %i.bf, align 1, !tbaa !52
  store i8 %i.bg, ptr %i.aw, align 1, !tbaa !52
  br label %bb.n
...
.critedge76:                                      ; preds = %bb.h, %bb.g
  %i.bu = load ptr, ptr %i.ab, align 8, !tbaa !95
  %i.bv = load i32, ptr %i.ad, align 8, !tbaa !121
  %i.bw = sext i32 %i.bv to i64
  %i.bx = add nsw i64 %i.bw, 40
  %i.by = load i32, ptr %i.ah, align 8, !tbaa !104 ; 2 uses
  %i.bz = load i32, ptr %i.al, align 4, !tbaa !123
  ...
  %i.cf = load i32, ptr %i.ce, align 8, !tbaa !124
  ...
  %i.cl = load i32, ptr %i.ck, align 8, !tbaa !118
...
.preheader:                                       ; preds = %.critedge76
  %i.cm = load i32, ptr %i.ar, align 4, !tbaa !116 ; 2 uses
...
bb.o:                                             ; preds = %.critedge
  ...
  %i.cn = load i32, ptr %i.ar, align 4, !tbaa !116 ; 2 uses
  %i.co = trunc nuw i64 %indvars.iv.next98 to i32
  %.not73 = icmp sgt i32 %i.cn, %i.co
  br i1 %.not73, label %.lr.ph93, label %.critedge80, !llvm.loop !341
...
.critedge.sink.split:                             ; preds = %bb.ak, %bb.al
  ...
  %i.cs = shl nuw nsw i64 %i.fk, %.sink
...
.critedge:                                        ; preds = %.critedge.sink.split, %bb.ak, %bb.aj, %bb.ag, %bb.ad, %bb.aa, %bb.x, %bb.u, %bb.r, %.lr.ph93
  ...
  %i.cy = load ptr, ptr %i.ab, align 8, !tbaa !95
...
bb.p:                                             ; preds = %.lr.ph93
  %i.da = load i32, ptr %i.ck, align 8, !tbaa !118 ; 8 uses
...
.sink.split:                                      ; preds = %bb.p, %bb.q
  ...
  %i.db = shl nuw nsw i64 %indvars.iv97, %.sink121
...
.sink.split122:                                   ; preds = %bb.s, %bb.t
  ...
  %i.dk = shl nuw nsw i64 %i.di, %.sink129
...
.sink.split130:                                   ; preds = %bb.v, %bb.w
  ...
  %i.dt = shl nuw nsw i64 %i.dr, %.sink137
...
.sink.split146:                                   ; preds = %bb.ab, %bb.ac
  ...
  %i.el = shl nuw nsw i64 %i.ej, %.sink153
...
.sink.split154:                                   ; preds = %bb.ae, %bb.af
  ...
  %i.eu = shl nuw nsw i64 %i.es, %.sink161
...
.sink.split162:                                   ; preds = %bb.ah, %bb.ai
  ...
  %i.fd = shl nuw nsw i64 %i.fb, %.sink169
...
bb.b:                                             ; preds = %bb.a
  %i.d = load ptr, ptr %0, align 8, !tbaa !129
...
bb.c:                                             ; preds = %bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #30
  store i64 %i.d, ptr %i.a, align 8, !tbaa !126
  %i.e = icmp ugt i64 %i.d, 15
  br i1 %i.e, label %.noexc, label %._crit_edge.i

.noexc:                                           ; preds = %bb.c
  %i.f = call noundef ptr @_ZNSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE9_M_createERmm(ptr noundef nonnull align 8 dereferenceable(32) %0, ptr noundef nonnull align 8 dereferenceable(8) %i.a, i64 noundef 0) ; 2 uses
  store ptr %i.f, ptr %0, align 8, !tbaa !100
  %i.g = load i64, ptr %i.a, align 8, !tbaa !126
...
bb.f:                                             ; preds = %bb.e, %bb.d, %._crit_edge.i
  %i.j = load i64, ptr %i.a, align 8, !tbaa !126  ; 2 uses
