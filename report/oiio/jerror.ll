...
bb.h:                                             ; preds = %bb.g, %bb.c
  ...
  %.036.in = phi ptr [ %i.j, %bb.g ], [ %i.h, %bb.c ]
  %2 = zext nneg i32 %.sink55 to i64
  %3 = getelementptr inbounds nuw [8 x i8], ptr %.036.in, i64 %2
  %.036 = load ptr, ptr %3, align 8, !tbaa !32    ; 2 uses
  %i.p = icmp eq ptr %.036, null
...
bb.i:                                             ; preds = %.thread, %bb.h
  %.1 = phi ptr [ %i.t, %.thread ], [ %.036, %bb.h ] ; 3 uses
  br label %bb.j

bb.j:                                             ; preds = %bb.j, %bb.i
  %.037 = phi ptr [ %.1, %bb.i ], [ %i.u, %bb.j ] ; 2 uses
  %i.u = getelementptr inbounds nuw i8, ptr %.037, i64 1 ; 2 uses
  %i.v = load i8, ptr %.037, align 1, !tbaa !34
