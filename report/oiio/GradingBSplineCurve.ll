...
_ZNSt6vectorIfSaIfEE9push_backERKf.exit209.i:     ; preds = %_ZNSt6vectorIfSaIfEE17_M_realloc_insertIJRKfEEEvN9__gnu_cxx17__normal_iteratorIPfS1_EEDpOT_.exit.i206.i, %bb.ce
  ...
  %.sroa.speculated.i = select i1 %i.zd, float %i.zc, float f0x3C23D70A ; 2 uses
...
.lr.ph387.i:                                      ; preds = %bb.cn, %.thread.i
  ...
  %i.zg = phi i64 [ %20, %.thread.i ], [ 0, %bb.cn ] ; 2 uses
  %.0120385.i = phi i32 [ %19, %.thread.i ], [ 0, %bb.cn ]
  %18 = getelementptr inbounds nuw [4 x i8], ptr %i.zf, i64 %i.zg
  %i.zh = call float @llvm.fabs.f32(float %17)
  %19 = add i32 %.0120385.i, 1                    ; 2 uses
  %20 = zext i32 %19 to i64                       ; 3 uses
  %i.zi = getelementptr inbounds nuw [4 x i8], ptr %i.zf, i64 %20 ; 2 uses
  %i.zj = load float, ptr %i.zi, align 4, !tbaa !58 ; 5 uses
  ...
  %i.zm = fsub float %i.zj, %17
  %i.zn = call float @llvm.fmuladd.f32(float %.0119.i, float %i.zm, float %17) ; 2 uses
...
bb.cp:                                            ; preds = %bb.co
  %i.zu = fmul float %17, %i.zs
  store float %i.zu, ptr %18, align 4, !tbaa !58
  %i.zv = fmul float %i.zj, %i.zs                 ; 2 uses
  store float %i.zv, ptr %i.zi, align 4, !tbaa !58
  br label %.thread.i

.thread.i:                                        ; preds = %bb.cp, %bb.co, %.lr.ph387.i
  %21 = phi float [ %i.zj, %.lr.ph387.i ], [ %i.zv, %bb.cp ], [ %i.zj, %bb.co ]
  %i.zw = icmp ugt i64 %i.nh, %20
