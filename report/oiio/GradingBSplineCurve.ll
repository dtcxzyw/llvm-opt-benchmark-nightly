...
.lr.ph.i.i.i.i.i.preheader:                       ; preds = %.noexc6
  ...
  %2 = ptrtoaddr ptr %i.o to i64
  %i.r = add i64 %2, -8
  %i.s = sub i64 %i.r, %i.p                       ; 2 uses
  %i.t = lshr i64 %i.s, 3
...
vector.ph:                                        ; preds = %.lr.ph.i.i.i.i.i.preheader
  ...
  %i.x = getelementptr i8, ptr %i.j, i64 %i.w     ; 2 uses
  %i.y = getelementptr i8, ptr %i.n, i64 %i.w
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %next.gep15 = getelementptr i8, ptr %i.n, i64 %i.z ; 2 uses
  %i.aa = getelementptr i8, ptr %next.gep15, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep15, align 4
  %wide.load16 = load <2 x i64>, ptr %i.aa, align 4
  %i.ab = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 4
  store <2 x i64> %wide.load16, ptr %i.ab, align 4
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ac = icmp eq i64 %index.next, %n.vec
  br i1 %i.ac, label %middle.block, label %vector.body, !llvm.loop !71
...
.lr.ph.i.i.i.i.i.preheader18:                     ; preds = %.lr.ph.i.i.i.i.i.preheader, %middle.block
  %.09.i.i.i.i.i.ph = phi ptr [ %i.j, %.lr.ph.i.i.i.i.i.preheader ], [ %i.x, %middle.block ]
  %.sroa.04.08.i.i.i.i.i.ph = phi ptr [ %i.n, %.lr.ph.i.i.i.i.i.preheader ], [ %i.y, %middle.block ]
  br label %.lr.ph.i.i.i.i.i

.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader18, %.lr.ph.i.i.i.i.i
  %.09.i.i.i.i.i = phi ptr [ %i.af, %.lr.ph.i.i.i.i.i ], [ %.09.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader18 ] ; 2 uses
  %.sroa.04.08.i.i.i.i.i = phi ptr [ %i.ae, %.lr.ph.i.i.i.i.i ], [ %.sroa.04.08.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader18 ] ; 2 uses
  %i.ad = load i64, ptr %.sroa.04.08.i.i.i.i.i, align 4
  store i64 %i.ad, ptr %.09.i.i.i.i.i, align 4
  %i.ae = getelementptr inbounds nuw i8, ptr %.sroa.04.08.i.i.i.i.i, i64 8 ; 2 uses
  %i.af = getelementptr inbounds nuw i8, ptr %.09.i.i.i.i.i, i64 8 ; 2 uses
  %.not.i.i.i.i.i = icmp eq ptr %i.ae, %i.o
...
.loopexit10:                                      ; preds = %.lr.ph.i.i.i.i.i, %middle.block, %.noexc6
  %.0.lcssa.i.i.i.i.i = phi ptr [ %i.j, %.noexc6 ], [ %i.x, %middle.block ], [ %i.af, %.lr.ph.i.i.i.i.i ]
  store ptr %.0.lcssa.i.i.i.i.i, ptr %i.k, align 8, !tbaa !53
  %i.ag = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 2 uses
  %i.ah = load ptr, ptr %i.b, align 8, !tbaa !53  ; 2 uses
  %i.ai = ptrtoint ptr %i.ah to i64
  %i.aj = ptrtoint ptr %i.n to i64
  %i.ak = sub i64 %i.ai, %i.aj                    ; 2 uses
  %i.al = ashr exact i64 %i.ak, 3                 ; 2 uses
  %i.am = icmp ugt i64 %i.al, 2305843009213693951
  br i1 %i.am, label %bb.c, label %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i
...
_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i: ; preds = %.loopexit10
  ...
  %.not.i.i.i.i7 = icmp eq ptr %i.ah, %i.n
  br i1 %.not.i.i.i.i7, label %.loopexit, label %bb.d

bb.d:                                             ; preds = %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i
  %i.an = ashr exact i64 %i.ak, 1                 ; 3 uses
  %i.ao = invoke noalias noundef nonnull ptr @_Znwm(i64 noundef %i.an) #23
          to label %.noexc9 unwind label %bb.e    ; 4 uses

.noexc9:                                          ; preds = %bb.d
  store ptr %i.ao, ptr %i.ag, align 8, !tbaa !54
  %i.ap = getelementptr inbounds nuw [4 x i8], ptr %i.ao, i64 %i.al
  %i.aq = getelementptr inbounds nuw i8, ptr %0, i64 48
  store ptr %i.ap, ptr %i.aq, align 8, !tbaa !57
  %i.ar = and i64 %i.an, -4
  tail call void @llvm.memset.p0.i64(ptr nonnull align 4 %i.ao, i8 0, i64 %i.ar, i1 false), !tbaa !58
...
.loopexit:                                        ; preds = %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i, %.noexc9
  %.0.i.i.i.i.i.i.i = phi ptr [ %i.as, %.noexc9 ], [ null, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i ]
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 40
  store ptr %.0.i.i.i.i.i.i.i, ptr %i.at, align 8, !tbaa !60
...
bb.e:                                             ; preds = %bb.d, %bb.c
  %i.av = landingpad { ptr, i32 }
          cleanup
  %i.aw = load ptr, ptr %i.a, align 8, !tbaa !49  ; 3 uses
...
bb.f:                                             ; preds = %bb.e
  %i.ax = load ptr, ptr %i.m, align 8, !tbaa !52
  %i.ay = ptrtoint ptr %i.ax to i64
  %i.az = ptrtoint ptr %i.aw to i64
  %i.ba = sub i64 %i.ay, %i.az
  tail call void @_ZdlPvm(ptr noundef nonnull %i.aw, i64 noundef %i.ba) #24
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.z = shl i64 %index, 3                        ; 2 uses
  %next.gep = getelementptr i8, ptr %i.j, i64 %i.z ; 2 uses
  %next.gep16 = getelementptr i8, ptr %i.n, i64 %i.z ; 2 uses
  %i.aa = getelementptr i8, ptr %next.gep16, i64 16
  %wide.load = load <2 x i64>, ptr %next.gep16, align 4
  %wide.load17 = load <2 x i64>, ptr %i.aa, align 4
  %i.ab = getelementptr i8, ptr %next.gep, i64 16
  store <2 x i64> %wide.load, ptr %next.gep, align 4
  store <2 x i64> %wide.load17, ptr %i.ab, align 4
  %index.next = add nuw i64 %index, 4             ; 2 uses
  %i.ac = icmp eq i64 %index.next, %n.vec
...
.lr.ph.i.i.i.i.i:                                 ; preds = %.lr.ph.i.i.i.i.i.preheader19, %.lr.ph.i.i.i.i.i
  %.09.i.i.i.i.i = phi ptr [ %i.af, %.lr.ph.i.i.i.i.i ], [ %.09.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader19 ] ; 2 uses
  %.sroa.04.08.i.i.i.i.i = phi ptr [ %i.ae, %.lr.ph.i.i.i.i.i ], [ %.sroa.04.08.i.i.i.i.i.ph, %.lr.ph.i.i.i.i.i.preheader19 ] ; 2 uses
  %i.ad = load i64, ptr %.sroa.04.08.i.i.i.i.i, align 4
  store i64 %i.ad, ptr %.09.i.i.i.i.i, align 4
  %i.ae = getelementptr inbounds nuw i8, ptr %.sroa.04.08.i.i.i.i.i, i64 8 ; 2 uses
  %i.af = getelementptr inbounds nuw i8, ptr %.09.i.i.i.i.i, i64 8 ; 2 uses
...
.loopexit11:                                      ; preds = %.lr.ph.i.i.i.i.i, %middle.block, %.noexc7
  %.0.lcssa.i.i.i.i.i = phi ptr [ %i.j, %.noexc7 ], [ %i.x, %middle.block ], [ %i.af, %.lr.ph.i.i.i.i.i ]
  store ptr %.0.lcssa.i.i.i.i.i, ptr %i.k, align 8, !tbaa !53
  %i.ag = getelementptr inbounds nuw i8, ptr %0, i64 32 ; 2 uses
  %i.ah = load ptr, ptr %i.b, align 8, !tbaa !53  ; 2 uses
  %i.ai = ptrtoint ptr %i.ah to i64
...
_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i: ; preds = %.loopexit11
  tail call void @llvm.memset.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %i.ag, i8 0, i64 24, i1 false)
  %.not.i.i.i.i8 = icmp eq ptr %i.ah, %i.n
...
.loopexit:                                        ; preds = %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i, %.noexc10
  %.0.i.i.i.i.i.i.i = phi ptr [ %i.as, %.noexc10 ], [ null, %_ZNSt6vectorIfSaIfEE17_S_check_init_lenEmRKS0_.exit.i ]
  %i.at = getelementptr inbounds nuw i8, ptr %0, i64 40
  store ptr %.0.i.i.i.i.i.i.i, ptr %i.at, align 8, !tbaa !60
  %i.au = getelementptr inbounds nuw i8, ptr %0, i64 56
  store i32 %2, ptr %i.au, align 8, !tbaa !61
  ret void
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.c = load ptr, ptr %1, align 8, !tbaa !49     ; 8 uses
...
.lr.ph.i.i.i.i.i.i109.i.preheader:                ; preds = %.noexc118
  ...
  %diff.check1181 = icmp ugt i64 %i.eh, -32
...
.lr.ph.i.i.i.i.i.i123.i.preheader:                ; preds = %.noexc120
  ...
  %diff.check1199 = icmp ugt i64 %i.fn, -32
...
.lr.ph.i.i.i.i.i.i.preheader:                     ; preds = %.noexc123
  ...
  %min.iters.check1219 = icmp ult i64 %14, 72
  %i.kl = sub i64 %i.jx, %i.ki
  %diff.check1217 = icmp ugt i64 %i.kl, -32
...
_ZNSt6vectorIN16OpenColorIO_v2_519GradingControlPointESaIS1_EE17_M_realloc_insertIJRKS1_EEEvN9__gnu_cxx17__normal_iteratorIPS1_S3_EEDpOT_.exit: ; preds = %_ZNSt6vectorIN16OpenColorIO_v2_519GradingControlPointESaIS1_EE11_S_relocateEPS1_S4_S4_RS2_.exit22.i, %bb.k
  ...
  store ptr %i.br, ptr %i.g, align 8, !tbaa !52
  br label %bb.l
...
vector.body119:                                   ; preds = %vector.body119, %vector.ph114
  ...
  store <4 x float> %broadcast.splat118, ptr %i.bl, align 4, !tbaa !58
  %index.next122 = add nuw i64 %index120, 8       ; 2 uses
  %i.bm = icmp eq i64 %index.next122, %n.vec116
  br i1 %i.bm, label %middle.block123, label %vector.body119, !llvm.loop !199
...
bb.s:                                             ; preds = %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit
  ...
  %i.cb = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.ca) #23
  br label %bb.t
...
bb.t:                                             ; preds = %bb.s, %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit
  ...
  %i.cf = load float, ptr %3, align 4, !tbaa !58  ; 2 uses
...
vector.body147:                                   ; preds = %vector.body147, %vector.ph142
  ...
  store <4 x float> %broadcast.splat146, ptr %i.cm, align 4, !tbaa !58
  %index.next150 = add nuw i64 %index148, 8       ; 2 uses
  %i.cn = icmp eq i64 %index.next150, %n.vec144
  br i1 %i.cn, label %middle.block151, label %vector.body147, !llvm.loop !201
...
.lr.ph.i.i.i.i.i.i.i76:                           ; preds = %.lr.ph.i.i.i.i.i.i.i76.preheader, %.lr.ph.i.i.i.i.i.i.i76
  ...
  store float %i.cf, ptr %.07.i.i.i.i.i.i.i77, align 4, !tbaa !58
...
_ZSt24__uninitialized_fill_n_aIPfmffET_S1_T0_RKT1_RSaIT2_E.exit80: ; preds = %.lr.ph.i.i.i.i.i.i.i76, %middle.block151
  ...
  br i1 %i.cp, label %bb.u, label %bb.v, !prof !82
...
bb.w:                                             ; preds = %bb.v
  %i.cr = load float, ptr %i.bo, align 4, !tbaa !58
  store float %i.cr, ptr %i.cc, align 4, !tbaa !58
  br label %_ZSt34__uninitialized_move_if_noexcept_aIPfS0_SaIfEET0_T_S3_S2_RT1_.exit
...
_ZSt34__uninitialized_move_if_noexcept_aIPfS0_SaIfEET0_T_S3_S2_RT1_.exit: ; preds = %bb.w, %bb.v, %bb.u
  ...
  br i1 %i.cu, label %bb.x, label %bb.y, !prof !82
...
bb.z:                                             ; preds = %bb.y
  %i.cw = load float, ptr %1, align 4, !tbaa !58
  store float %i.cw, ptr %i.cs, align 4, !tbaa !58
  br label %bb.aa
