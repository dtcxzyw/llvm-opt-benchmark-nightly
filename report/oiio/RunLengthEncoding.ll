...
bb.b:                                             ; preds = %bb.a
  tail call void @_ZdaPv(ptr noundef nonnull %i.b) #7, !inline_history !15
  br label %_ZN3dpx17RunLengthEncodingD2Ev.exit

_ZN3dpx17RunLengthEncodingD2Ev.exit:              ; preds = %bb.a, %bb.b
  tail call void @_ZN3dpx5CodecD2Ev(ptr noundef nonnull align 8 dead_on_return(16) dereferenceable(24) %0) #8, !inline_history !15
...
_ZNK3dpx13GenericHeader8BitDepthEi.exit:          ; preds = %_ZNK3dpx13GenericHeader16EndOfLinePaddingEi.exit
  ...
  %i.q = load i8, ptr %i.p, align 1, !tbaa !21    ; 2 uses
  %.not = icmp eq i32 %..i, 0
...
!15 = !{ptr @_ZN3dpx17RunLengthEncodingD2Ev}
!16 = !{!17, !19, i64 26}
!17 = !{!"_ZTSN3dpx12ImageElementE", !4, i64 0, !4, i64 4, !18, i64 8, !4, i64 12, !18, i64 16, !5, i64 20, !5, i64 21, !5, i64 22, !5, i64 23, !19, i64 24, !19, i64 26, !4, i64 28, !4, i64 32, !4, i64 36, !5, i64 40}
!18 = !{!"float", !5, i64 0}
!19 = !{!"short", !5, i64 0}
!20 = !{!17, !4, i64 32}
!21 = !{!17, !5, i64 23}
