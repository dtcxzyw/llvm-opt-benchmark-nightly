...
bb.lo:                                            ; preds = %bb.lm
  ...
  %i.atd = add nuw i64 %indvars.iv.i, 2
  %59 = and i64 %i.atd, 4294967295                ; 2 uses
  %i.ate = getelementptr inbounds nuw [4 x i8], ptr %i.apd, i64 %59
  %i.atf = load float, ptr %i.ate, align 4, !tbaa !59
  %i.atg = getelementptr inbounds nuw [4 x i8], ptr %i.aor, i64 %59
