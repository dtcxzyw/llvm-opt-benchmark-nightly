...
.peel.next.i:                                     ; preds = %.preheader.i
  ...
  %i.aqj = add nuw nsw i64 %i.apb, 4294967295     ; 2 uses
...
bb.lo:                                            ; preds = %bb.lm
  ...
  %i.ask = add nuw nsw i64 %indvars.iv.i, 4294967295 ; 2 uses
  ...
  %i.asr = add nuw nsw i64 %indvars.iv.i, 2       ; 2 uses
  %i.ass = getelementptr inbounds nuw [4 x i8], ptr %i.aor, i64 %i.asr
  %i.ast = load float, ptr %i.ass, align 4, !tbaa !59
  %i.asu = getelementptr inbounds nuw [4 x i8], ptr %i.aof, i64 %i.asr
