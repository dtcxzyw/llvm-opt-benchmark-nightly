...
bb.f:                                             ; preds = %bb.d
  ...
  %i.t = load <2 x float>, ptr %i.q, align 4, !tbaa !7 ; 4 uses
  %3 = shufflevector <2 x float> %i.t, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.u = load <2 x float>, ptr %i.p, align 4, !tbaa !7 ; 5 uses
  %4 = load float, ptr %i.r, align 4, !tbaa !7    ; 2 uses
  %i.v = load <2 x float>, ptr %2, align 4, !tbaa !7 ; 4 uses
  %i.w = load float, ptr %i.s, align 4, !tbaa !7  ; 3 uses
  %i.x = shufflevector <2 x float> %i.u, <2 x float> %i.t, <2 x i32> <i32 1, i32 3>
  %i.y = fneg <2 x float> %i.x                    ; 2 uses
  %i.z = shufflevector <2 x float> %i.t, <2 x float> %i.v, <2 x i32> <i32 0, i32 2> ; 2 uses
  %i.aa = fmul <2 x float> %i.z, %i.y
  %5 = shufflevector <2 x float> %i.u, <2 x float> %i.v, <2 x i32> <i32 0, i32 3>
  %6 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %3, <2 x float> %5, <2 x float> %i.aa) ; 3 uses
  %7 = fneg float %i.w                            ; 2 uses
  %i.ab = extractelement <2 x float> %i.u, i64 0
  %8 = fmul float %i.ab, %7
  %9 = extractelement <2 x float> %i.v, i64 0     ; 2 uses
  %10 = tail call float @llvm.fmuladd.f32(float %9, float %4, float %8) ; 2 uses
  %11 = load float, ptr %i.h, align 4, !tbaa !7   ; 2 uses
  %12 = load float, ptr %i.d, align 4, !tbaa !7   ; 2 uses
  %13 = load float, ptr %1, align 4, !tbaa !7     ; 4 uses
  %i.ac = insertelement <2 x float> poison, float %12, i64 0 ; 2 uses
  %i.ad = insertelement <2 x float> %i.ac, float %11, i64 1 ; 2 uses
  %14 = shufflevector <2 x float> %i.y, <2 x float> poison, <2 x i32> <i32 1, i32 0> ; 2 uses
  %i.ae = insertelement <2 x float> %14, float %7, i64 1
  %15 = fmul <2 x float> %i.ad, %i.ae
  %16 = insertelement <2 x float> poison, float %11, i64 0
  %i.af = insertelement <2 x float> %16, float %13, i64 1 ; 2 uses
  %i.ag = insertelement <2 x float> %i.t, float %4, i64 0
  %17 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.af, <2 x float> %i.ag, <2 x float> %15) ; 4 uses
  %18 = shufflevector <2 x float> %i.u, <2 x float> %3, <2 x i32> <i32 0, i32 3>
  %19 = fneg <2 x float> %18
  %20 = fmul <2 x float> %i.af, %19
  %i.ah = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %i.ad, <2 x float> %i.z, <2 x float> %20) ; 3 uses
  %i.ai = fneg float %9
  %21 = insertelement <2 x float> %i.ac, float %13, i64 1
  %22 = insertelement <2 x float> %14, float %i.ai, i64 0
  %i.aj = fmul <2 x float> %21, %22
  %23 = insertelement <2 x float> poison, float %13, i64 0
  %24 = insertelement <2 x float> %23, float %12, i64 1
  %25 = insertelement <2 x float> %i.u, float %i.w, i64 1
  %26 = tail call <2 x float> @llvm.fmuladd.v2f32(<2 x float> %24, <2 x float> %25, <2 x float> %i.aj) ; 3 uses
  %foldExtExtBinop = fmul <2 x float> %i.v, %17
  %i.ak = extractelement <2 x float> %foldExtExtBinop, i64 0
  %i.al = extractelement <2 x float> %6, i64 0
  %i.am = tail call float @llvm.fmuladd.f32(float %13, float %i.al, float %i.ak)
  %27 = extractelement <2 x float> %i.ah, i64 0
  %i.an = tail call float @llvm.fmuladd.f32(float %i.w, float %27, float %i.am) ; 5 uses
...
.preheader:                                       ; preds = %bb.f
  ...
  %28 = shufflevector <2 x float> %17, <2 x float> %i.ah, <4 x i32> <i32 1, i32 poison, i32 2, i32 3>
  %29 = shufflevector <2 x float> %26, <2 x float> poison, <4 x i32> <i32 poison, i32 1, i32 poison, i32 poison>
  %30 = shufflevector <2 x float> %6, <2 x float> %17, <4 x i32> <i32 0, i32 1, i32 poison, i32 2>
  %31 = shufflevector <4 x float> %30, <4 x float> poison, <8 x i32> <i32 0, i32 1, i32 poison, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %32 = insertelement <8 x float> %31, float %10, i64 2
  %33 = shufflevector <4 x float> %28, <4 x float> %29, <8 x i32> <i32 0, i32 5, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
  %34 = shufflevector <8 x float> %32, <8 x float> %33, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 8, i32 9, i32 10, i32 11>
  ...
  %i.ax = extractelement <2 x float> %26, i64 0
...
.critedge29:                                      ; preds = %.preheader, %bb.f
  %35 = insertelement <2 x float> poison, float %i.an, i64 0
  %36 = shufflevector <2 x float> %35, <2 x float> poison, <2 x i32> zeroinitializer ; 4 uses
  %37 = fdiv <2 x float> %6, %36                  ; 2 uses
  %.sroa.14.0 = fdiv float %10, %i.an             ; 2 uses
  %38 = fdiv <2 x float> %17, %36                 ; 2 uses
  %39 = fdiv <2 x float> %26, %36                 ; 3 uses
  %40 = fdiv <2 x float> %i.ah, %36               ; 2 uses
  ...
  %41 = extractelement <2 x float> %39, i64 1     ; 2 uses
  %42 = fneg float %41
  store <2 x float> %37, ptr %0, align 4, !tbaa !7
  %43 = getelementptr inbounds nuw i8, ptr %0, i64 8
  store float %.sroa.14.0, ptr %43, align 4, !tbaa !7
  %44 = getelementptr inbounds nuw i8, ptr %0, i64 12
  store float 0.000000e+00, ptr %44, align 4, !tbaa !7
  %i.bq = getelementptr inbounds nuw i8, ptr %0, i64 16
  store <2 x float> %38, ptr %i.bq, align 4, !tbaa !7
  %45 = getelementptr inbounds nuw i8, ptr %0, i64 24
  store float %41, ptr %45, align 4, !tbaa !7
  %46 = getelementptr inbounds nuw i8, ptr %0, i64 28
  store float 0.000000e+00, ptr %46, align 4, !tbaa !7
  %i.br = getelementptr inbounds nuw i8, ptr %0, i64 32
  store <2 x float> %40, ptr %i.br, align 4, !tbaa !7
  %47 = getelementptr inbounds nuw i8, ptr %0, i64 40
  %48 = extractelement <2 x float> %39, i64 0
  store float %48, ptr %47, align 4, !tbaa !7
  ...
  %51 = insertelement <4 x float> <float poison, float 1.000000e+00, float poison, float poison>, float %i.bm, i64 0
  %52 = shufflevector <4 x float> %51, <4 x float> poison, <4 x i32> <i32 0, i32 0, i32 0, i32 1>
  %i.bt = insertelement <4 x float> <float poison, float poison, float poison, float 1.000000e+00>, float %42, i64 2
  %53 = shufflevector <2 x float> %50, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.bu = shufflevector <4 x float> %53, <4 x float> %i.bt, <4 x i32> <i32 0, i32 1, i32 6, i32 7>
  %i.bv = fmul <4 x float> %52, %i.bu
  ...
  %54 = shufflevector <2 x float> %37, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %55 = insertelement <4 x float> %54, float -0.000000e+00, i64 3
  %i.by = insertelement <4 x float> %55, float %.sroa.14.0, i64 2
  ...
  %56 = shufflevector <2 x float> %40, <2 x float> poison, <4 x i32> <i32 0, i32 1, i32 poison, i32 poison>
  %i.cc = insertelement <4 x float> %56, float -0.000000e+00, i64 3
  %57 = shufflevector <2 x float> %39, <2 x float> poison, <4 x i32> <i32 0, i32 poison, i32 poison, i32 poison>
  %58 = shufflevector <4 x float> %i.cc, <4 x float> %57, <4 x i32> <i32 0, i32 1, i32 4, i32 3>
  %i.cd = tail call <4 x float> @llvm.fmuladd.v4f32(<4 x float> %i.cb, <4 x float> %58, <4 x float> %i.bz)
