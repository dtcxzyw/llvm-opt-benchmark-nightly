...
._crit_edge:                                      ; preds = %bb.a, %bb.b
  ...
  %i.v = load float, ptr %1, align 4, !tbaa !15   ; 4 uses
  %i.w = load <2 x float>, ptr %i.s, align 4, !tbaa !8 ; 4 uses
  %i.x = load float, ptr %i.u, align 4, !tbaa !16 ; 6 uses
  ...
  %6 = load float, ptr %i.p, align 4, !tbaa !17   ; 5 uses
  %7 = fneg float %6
  %8 = load float, ptr %i.t, align 4, !tbaa !18   ; 4 uses
...
bb.f:                                             ; preds = %bb.d
  ...
  %6 = load float, ptr %i.d, align 4, !tbaa !8    ; 3 uses
