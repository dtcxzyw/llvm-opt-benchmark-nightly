...
.lr.ph.i194:                                      ; preds = %bb.ah
  ...
  %min.iters.check = icmp ult i32 %i.dr, 26
  br i1 %min.iters.check, label %scalar.ph.preheader, label %vector.memcheck

vector.memcheck:                                  ; preds = %.lr.ph.i194
  %i.ee = sub i64 %i.dx, %i.du
  %diff.check = icmp ult i64 %i.ee, 16
  %i.ef = add nsw i64 %i.ed, %i.ec
  %2 = and i64 %i.ef, 2305843009213693950
  %diff.check265 = icmp eq i64 %2, 0
  ...
  %i.ek = sub i64 %i.ej, %i.du
  %diff.check266 = icmp ult i64 %i.ek, 16
  %conflict.rdx267 = or i1 %conflict.rdx, %diff.check266
  %i.el = add nsw i64 %i.eb, %i.ec
  %3 = mul nsw i64 %i.el, -8
  %diff.check268 = icmp ult i64 %3, 16
