...
vector.ph47:                                      ; preds = %vector.memcheck39
  ...
  %5 = load i64, ptr %2, align 4, !alias.scope !859
  %broadcast.splatinsert53 = insertelement <2 x i64> poison, i64 %5, i64 0
...
.lr.ph.i.i.i.i.preheader98:                       ; preds = %vector.memcheck39, %.lr.ph.i.i.i.i.preheader, %middle.block56
  %.06.i.i.i.i.ph = phi ptr [ %i.c, %vector.memcheck39 ], [ %i.c, %.lr.ph.i.i.i.i.preheader ], [ %4, %middle.block56 ]
...
vector.ph67:                                      ; preds = %vector.memcheck59
  ...
  %6 = shl i64 %n.vec69, 3
  %7 = getelementptr i8, ptr %i.ap, i64 %6        ; 2 uses
  %8 = and i64 %i.aq, 3
  %9 = load i64, ptr %2, align 4, !alias.scope !866
  %broadcast.splatinsert73 = insertelement <2 x i64> poison, i64 %9, i64 0
...
.lr.ph.i.i.i.i12.preheader96:                     ; preds = %vector.memcheck59, %.lr.ph.i.i.i.i12.preheader, %middle.block76
  %.09.i.i.i.i.ph = phi ptr [ %i.ap, %vector.memcheck59 ], [ %i.ap, %.lr.ph.i.i.i.i12.preheader ], [ %7, %middle.block76 ] ; 2 uses
  %.068.i.i.i.i.ph = phi i64 [ %i.aq, %vector.memcheck59 ], [ %i.aq, %.lr.ph.i.i.i.i12.preheader ], [ %8, %middle.block76 ] ; 4 uses
...
_ZSt24__uninitialized_fill_n_aIPN11OpenImageIO4v3_18TypeDescEmS2_S2_ET_S4_T0_RKT1_RSaIT2_E.exit: ; preds = %.lr.ph.i.i.i.i12.prol.loopexit, %.lr.ph.i.i.i.i12, %middle.block76, %_ZSt4fillIN9__gnu_cxx17__normal_iteratorIPN11OpenImageIO4v3_18TypeDescESt6vectorIS4_SaIS4_EEEES4_EvT_SA_RKT0_.exit
  %.0.lcssa.i.i.i.i = phi ptr [ %i.ap, %_ZSt4fillIN9__gnu_cxx17__normal_iteratorIPN11OpenImageIO4v3_18TypeDescESt6vectorIS4_SaIS4_EEEES4_EvT_SA_RKT0_.exit ], [ %7, %middle.block76 ], [ %.lcssa97.unr, %.lr.ph.i.i.i.i12.prol.loopexit ], [ %i.br, %.lr.ph.i.i.i.i12 ]
...
vector.ph:                                        ; preds = %vector.memcheck
  ...
  %12 = load i64, ptr %2, align 4, !alias.scope !874
...
.lr.ph.i.i.i.i14.preheader:                       ; preds = %vector.memcheck, %bb.h, %middle.block
  %.06.i.i.i.i15.ph = phi ptr [ %i.c, %vector.memcheck ], [ %i.c, %bb.h ], [ %11, %middle.block ]
