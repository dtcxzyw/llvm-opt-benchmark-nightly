begin_hunk_0
  ...
  %.sroa.speculated = call i32 @llvm.umin.i32(i32 %i.fb, i32 %i.eq) ; 2 uses
  %i.fc = add i32 %.sroa.speculated, -1           ; 14 uses
  %i.fd = sub i32 %i.fa, %i.ey
  %i.fe = add i32 %i.fd, 1                        ; 2 uses
  %i.ff = sub i32 %.sroa.speculated, %i.ep        ; 2 uses
...
bb.fe:                                            ; preds = %_ZNKSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEE11_M_is_localEv.exit.thread.i.i.i795
  %i.anq = mul i32 %i.ff, %i.fe                   ; 5 uses
