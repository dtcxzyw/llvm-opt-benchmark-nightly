begin_hunk_0
  %i.tk = sub i64 %i.tj, %.pre-phi                ; 2 uses
  %i.tl = zext nneg i32 %i.si to i64
  %.sroa.speculated6.i601 = call i64 @llvm.umin.i64(i64 %i.tk, i64 %i.rl) ; 2 uses
  %i.tm = sub nuw i64 %i.tk, %.sroa.speculated6.i601
  %.sroa.speculated.i602 = call i64 @llvm.umin.i64(i64 %i.tm, i64 %i.tl) ; 2 uses
  %.not5.i.i.i = icmp samesign eq i64 %.sroa.speculated.i602, 0
  br i1 %.not5.i.i.i, label %_ZSt4fillIPhiEvT_S1_RKT0_.exit, label %.lr.ph.i.i.i
end_hunk_0
begin_hunk_1
  %i.ajj = sub i64 %i.aji, %.pre-phi2427          ; 2 uses
  %i.ajk = zext nneg i32 %i.aih to i64
  %.sroa.speculated6.i740 = call i64 @llvm.umin.i64(i64 %i.ajj, i64 %i.ahk) ; 2 uses
  %i.ajl = sub nuw i64 %i.ajj, %.sroa.speculated6.i740
  %.sroa.speculated.i741 = call i64 @llvm.umin.i64(i64 %i.ajl, i64 %i.ajk) ; 2 uses
  %.not5.i.i.i744 = icmp samesign eq i64 %.sroa.speculated.i741, 0
  br i1 %.not5.i.i.i744, label %_ZSt4fillIPhiEvT_S1_RKT0_.exit746, label %.lr.ph.i.i.i745
end_hunk_1
begin_hunk_2
...
begin_hunk_7
  ...
  %i.q = load i64, ptr %i.p, align 8, !tbaa !135  ; 5 uses
  %i.r = lshr i64 %i.q, 25
