...
.preheader:                                       ; preds = %.preheader.lr.ph, %._crit_edge2179
  %i.el = phi i32 [ %i.ay, %.preheader.lr.ph ], [ %i.ayd, %._crit_edge2179 ]
  %i.em = phi i32 [ %.pre, %.preheader.lr.ph ], [ %i.aye, %._crit_edge2179 ] ; 3 uses
  %.03602181 = phi i32 [ 0, %.preheader.lr.ph ], [ %i.ayf, %._crit_edge2179 ] ; 2 uses
...
bb.e:                                             ; preds = %.lr.ph2178, %bb.hg
  ...
  %i.es = phi i32 [ %i.em, %.lr.ph2178 ], [ %i.axz, %bb.hg ]
  %.03472177 = phi i32 [ 0, %.lr.ph2178 ], [ %i.axy, %bb.hg ] ; 2 uses
  ...
  %indvar.tr3105 = trunc i64 %indvar to i32
  %i.ew = shl i32 %indvar.tr3105, 6
...
_ZNSt6vectorIhSaIhEEC2EmRKS0_.exit563:            ; preds = %.noexc562, %bb.n
  ...
  %i.hh = zext i8 %i.hc to i64                    ; 2 uses
  %i.hi = icmp eq i8 %i.hc, 0
  br i1 %i.hi, label %._crit_edge3044, label %.lr.ph3043
