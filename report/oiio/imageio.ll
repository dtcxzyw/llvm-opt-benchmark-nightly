...
_ZN11OpenImageIO4v3_14simd5roundERKNS1_7vfloat4E.exit.i.i: ; preds = %bb.e, %_ZN11OpenImageIO4v3_14simd5roundERKNS1_7vfloat4E.exit.i.i
  ...
  %5 = extractelement <4 x float> %i.l, i64 1
  %i.n = extractelement <4 x float> %i.l, i64 2
  %6 = extractelement <4 x float> %i.l, i64 3
  %7 = tail call float @llvm.round.f32(float %i.n)
  %i.o = tail call float @llvm.round.f32(float %i.m)
  %8 = tail call float @llvm.round.f32(float %6)
  %i.p = tail call float @llvm.round.f32(float %5)
  %i.q = insertelement <2 x float> poison, float %i.o, i64 0
  %i.r = insertelement <2 x float> %i.q, float %7, i64 1
  %i.s = bitcast <2 x float> %i.r to <2 x i32>
  %i.t = insertelement <2 x float> poison, float %i.p, i64 0
  %i.u = insertelement <2 x float> %i.t, float %8, i64 1
...
_ZN11OpenImageIO4v3_14simd5roundERKNS1_7vfloat4E.exit.i.i46: ; preds = %bb.f, %_ZN11OpenImageIO4v3_14simd5roundERKNS1_7vfloat4E.exit.i.i46
  ...
  %9 = extractelement <4 x float> %i.bo, i64 1
  %i.bq = extractelement <4 x float> %i.bo, i64 2
  %10 = extractelement <4 x float> %i.bo, i64 3
  %11 = tail call float @llvm.round.f32(float %i.bq)
  %i.br = tail call float @llvm.round.f32(float %i.bp)
  %12 = tail call float @llvm.round.f32(float %10)
  %i.bs = tail call float @llvm.round.f32(float %9)
  %i.bt = insertelement <2 x float> poison, float %i.br, i64 0
  %i.bu = insertelement <2 x float> %i.bt, float %11, i64 1
  %i.bv = bitcast <2 x float> %i.bu to <2 x i32>
  %i.bw = insertelement <2 x float> poison, float %i.bs, i64 0
  %i.bx = insertelement <2 x float> %i.bw, float %12, i64 1
...
_ZN11OpenImageIO4v3_14simd5roundERKNS1_7vfloat4E.exit.i.i: ; preds = %bb.i, %_ZN11OpenImageIO4v3_14simd5roundERKNS1_7vfloat4E.exit.i.i
  ...
  %6 = extractelement <4 x float> %i.bd, i64 1
  %i.bf = extractelement <4 x float> %i.bd, i64 2
  %7 = extractelement <4 x float> %i.bd, i64 3
  %8 = call float @llvm.round.f32(float %i.bf)
  %i.bg = call float @llvm.round.f32(float %i.be)
  %9 = call float @llvm.round.f32(float %7)
  %i.bh = call float @llvm.round.f32(float %6)
  %i.bi = insertelement <2 x float> poison, float %i.bg, i64 0
  %i.bj = insertelement <2 x float> %i.bi, float %8, i64 1
  %i.bk = bitcast <2 x float> %i.bj to <2 x i32>
  %i.bl = insertelement <2 x float> poison, float %i.bh, i64 0
  %i.bm = insertelement <2 x float> %i.bl, float %9, i64 1
...
_ZN11OpenImageIO4v3_14simd5roundERKNS1_7vfloat4E.exit.i.i63: ; preds = %bb.j, %_ZN11OpenImageIO4v3_14simd5roundERKNS1_7vfloat4E.exit.i.i63
  ...
  %10 = extractelement <4 x float> %i.dj, i64 1
  %i.dl = extractelement <4 x float> %i.dj, i64 2
  %11 = extractelement <4 x float> %i.dj, i64 3
  %12 = call float @llvm.round.f32(float %i.dl)
  %i.dm = call float @llvm.round.f32(float %i.dk)
  %13 = call float @llvm.round.f32(float %11)
  %i.dn = call float @llvm.round.f32(float %10)
  %i.do = insertelement <2 x float> poison, float %i.dm, i64 0
  %i.dp = insertelement <2 x float> %i.do, float %12, i64 1
  %i.dq = bitcast <2 x float> %i.dp to <2 x i32>
  %i.dr = insertelement <2 x float> poison, float %i.dn, i64 0
  %i.ds = insertelement <2 x float> %i.dr, float %13, i64 1
