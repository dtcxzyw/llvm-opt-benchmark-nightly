...
vector.body81:                                    ; preds = %vector.body81, %vector.ph79
  ...
  %wide.load86 = load <4 x i8>, ptr %i.i, align 1, !tbaa !68, !alias.scope !502
  ...
  store <4 x float> %i.l, ptr %next.gep84, align 4, !tbaa !94, !alias.scope !503, !noalias !502
  store <4 x float> %i.m, ptr %i.n, align 4, !tbaa !94, !alias.scope !503, !noalias !502
  %index.next87 = add nuw i64 %index82, 8         ; 2 uses
  %i.o = icmp eq i64 %index.next87, %n.vec80
  br i1 %i.o, label %middle.block88, label %vector.body81, !llvm.loop !494
...
.lr.ph.i.i:                                       ; preds = %bb.b, %.lr.ph.i.i
  ...
  br i1 %i.aj, label %.lr.ph.i.i, label %.preheader.i.i, !llvm.loop !496
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.cf, label %middle.block, label %vector.body, !llvm.loop !499
...
.lr.ph.i.i42:                                     ; preds = %.lr.ph.i.i42.prol.loopexit, %.lr.ph.i.i42
  ...
  br i1 %i.db, label %.lr.ph.i.i42, label %.preheader.i.i32, !llvm.loop !500
...
vector.body140:                                   ; preds = %vector.body140, %vector.ph138
  ...
  store <4 x i8> %i.ba, ptr %next.gep143, align 1, !tbaa !68, !alias.scope !512, !noalias !511
  %index.next145 = add nuw i64 %index141, 4       ; 2 uses
  %i.bb = icmp eq i64 %index.next145, %n.vec139
  br i1 %i.bb, label %middle.block146, label %vector.body140, !llvm.loop !507
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  br i1 %i.dl, label %middle.block, label %vector.body, !llvm.loop !509
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  br i1 %i.cl, label %.lr.ph, label %.preheader, !llvm.loop !1012
...
.lr.ph66:                                         ; preds = %.lr.ph66.prol.loopexit, %.lr.ph66
  ...
  br i1 %.not.3, label %._crit_edge, label %.lr.ph66, !llvm.loop !1013
...
begin_hunk_3_@_ZN11OpenImageIO4v3_112convert_typeIsfEEvPKT_PT0_mS5_S5_:bb.a
  ...
  br i1 %i.lc, label %middle.block, label %vector.body, !llvm.loop !1014
...
vector.body87:                                    ; preds = %vector.body87, %vector.ph85
  ...
  br i1 %i.lq, label %middle.block93, label %vector.body87, !llvm.loop !1015
...
.lr.ph:                                           ; preds = %.lr.ph.preheader99, %.lr.ph
  ...
  br i1 %i.mm, label %.lr.ph, label %.preheader, !llvm.loop !1016
...
.lr.ph66:                                         ; preds = %.lr.ph66.preheader98, %.lr.ph66
  ...
  br i1 %.not, label %._crit_edge, label %.lr.ph66, !llvm.loop !1017
...
.lr.ph66.prol:                                    ; preds = %.lr.ph66.preheader, %.lr.ph66.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph66.prol.loopexit, label %.lr.ph66.prol, !llvm.loop !1018
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  br i1 %i.ad, label %.lr.ph, label %.preheader, !llvm.loop !1019
...
.lr.ph66:                                         ; preds = %.lr.ph66.prol.loopexit, %.lr.ph66
  ...
  br i1 %.not.3, label %._crit_edge, label %.lr.ph66, !llvm.loop !1020
...
.lr.ph66.prol:                                    ; preds = %.lr.ph66.preheader, %.lr.ph66.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph66.prol.loopexit, label %.lr.ph66.prol, !llvm.loop !1021
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.ac = add i64 %.05557, -16                    ; 3 uses
  %i.ad = icmp ugt i64 %i.ac, 15
  br i1 %i.ad, label %.lr.ph, label %.preheader, !llvm.loop !1022
...
.lr.ph66:                                         ; preds = %.lr.ph66.prol.loopexit, %.lr.ph66
  ...
  store float %i.ax, ptr %i.as, align 4, !tbaa !94
  %.not.3 = icmp eq i64 %i.at, 0
  br i1 %.not.3, label %._crit_edge, label %.lr.ph66, !llvm.loop !1023
...
.lr.ph66.prol:                                    ; preds = %.lr.ph66.preheader, %.lr.ph66.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph66.prol.loopexit, label %.lr.ph66.prol, !llvm.loop !1024
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.ac = add i64 %.05557, -16                    ; 3 uses
  %i.ad = icmp ugt i64 %i.ac, 15
  br i1 %i.ad, label %.lr.ph, label %.preheader, !llvm.loop !1025
...
.lr.ph66:                                         ; preds = %.lr.ph66.prol.loopexit, %.lr.ph66
  ...
  store float %i.ax, ptr %i.as, align 4, !tbaa !94
  %.not.3 = icmp eq i64 %i.at, 0
  br i1 %.not.3, label %._crit_edge, label %.lr.ph66, !llvm.loop !1026
...
.lr.ph66.prol:                                    ; preds = %.lr.ph66.preheader, %.lr.ph66.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph66.prol.loopexit, label %.lr.ph66.prol, !llvm.loop !1027
...
.lr.ph:                                           ; preds = %bb.a, %.lr.ph
  ...
  %i.ac = add i64 %.05557, -16                    ; 3 uses
  %i.ad = icmp ugt i64 %i.ac, 15
  br i1 %i.ad, label %.lr.ph, label %.preheader, !llvm.loop !1028
...
.lr.ph66:                                         ; preds = %.lr.ph66.prol.loopexit, %.lr.ph66
  ...
  store float %i.ax, ptr %i.as, align 4, !tbaa !94
  %.not.3 = icmp eq i64 %i.at, 0
  br i1 %.not.3, label %._crit_edge, label %.lr.ph66, !llvm.loop !1029
...
.lr.ph66.prol:                                    ; preds = %.lr.ph66.preheader, %.lr.ph66.prol
  ...
  br i1 %prol.iter.cmp.not, label %.lr.ph66.prol.loopexit, label %.lr.ph66.prol, !llvm.loop !1030
...
.lr.ph:                                           ; preds = %.lr.ph.prol.loopexit, %.lr.ph
  ...
  br i1 %i.bi, label %.lr.ph, label %.preheader, !llvm.loop !1031
...
.lr.ph66:                                         ; preds = %.lr.ph66.prol.loopexit, %.lr.ph66
  ...
  br i1 %.not.3, label %._crit_edge, label %.lr.ph66, !llvm.loop !1032
...
begin_hunk_4_@_ZN11OpenImageIO4v3_112convert_typeIfjEEvPKT_PT0_mS5_S5_:bb.a
  ...
  br i1 %i.kl, label %middle.block, label %vector.body, !llvm.loop !1033
...
vector.body175:                                   ; preds = %vector.body175, %vector.ph169
  ...
  br i1 %i.lf, label %middle.block180, label %vector.body175, !llvm.loop !1034
...
.lr.ph:                                           ; preds = %.lr.ph.preheader186, %.lr.ph
  ...
  br i1 %i.nh, label %.lr.ph, label %.preheader, !llvm.loop !1035
...
.lr.ph152:                                        ; preds = %.lr.ph152.preheader185, %.lr.ph152
  ...
  br i1 %.not, label %._crit_edge, label %.lr.ph152, !llvm.loop !1036
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %i.ae = load float, ptr %next.gep, align 4, !tbaa !94, !alias.scope !1047
  %i.af = load float, ptr %next.gep163, align 4, !tbaa !94, !alias.scope !1047
  %i.ag = load float, ptr %next.gep164, align 4, !tbaa !94, !alias.scope !1047
  %i.ah = load float, ptr %next.gep165, align 4, !tbaa !94, !alias.scope !1047
  ...
  store i8 %i.az, ptr %next.gep166, align 1, !tbaa !68, !alias.scope !1048, !noalias !1047
  %i.ba = extractelement <4 x i8> %i.au, i64 1
  store i8 %i.ba, ptr %next.gep167, align 1, !tbaa !68, !alias.scope !1048, !noalias !1047
  %i.bb = extractelement <4 x i8> %i.au, i64 2
  store i8 %i.bb, ptr %next.gep168, align 1, !tbaa !68, !alias.scope !1048, !noalias !1047
  %i.bc = extractelement <4 x i8> %i.au, i64 3
  store i8 %i.bc, ptr %next.gep169, align 1, !tbaa !68, !alias.scope !1048, !noalias !1047
  ...
  %i.bh = load float, ptr %i.aa, align 4, !tbaa !94, !alias.scope !1047
  %i.bi = load float, ptr %i.ab, align 4, !tbaa !94, !alias.scope !1047
  %i.bj = load float, ptr %i.ac, align 4, !tbaa !94, !alias.scope !1047
  %i.bk = load float, ptr %i.ad, align 4, !tbaa !94, !alias.scope !1047
  ...
  store i8 %i.cc, ptr %i.av, align 1, !tbaa !68, !alias.scope !1048, !noalias !1047
  %i.cd = extractelement <4 x i8> %i.bx, i64 1
  store i8 %i.cd, ptr %i.aw, align 1, !tbaa !68, !alias.scope !1048, !noalias !1047
  %i.ce = extractelement <4 x i8> %i.bx, i64 2
  store i8 %i.ce, ptr %i.ax, align 1, !tbaa !68, !alias.scope !1048, !noalias !1047
  %i.cf = extractelement <4 x i8> %i.bx, i64 3
  store i8 %i.cf, ptr %i.ay, align 1, !tbaa !68, !alias.scope !1048, !noalias !1047
  ...
  %i.ck = load float, ptr %i.bd, align 4, !tbaa !94, !alias.scope !1047
  %i.cl = load float, ptr %i.be, align 4, !tbaa !94, !alias.scope !1047
  %i.cm = load float, ptr %i.bf, align 4, !tbaa !94, !alias.scope !1047
  %i.cn = load float, ptr %i.bg, align 4, !tbaa !94, !alias.scope !1047
  ...
  store i8 %i.df, ptr %i.by, align 1, !tbaa !68, !alias.scope !1048, !noalias !1047
  %i.dg = extractelement <4 x i8> %i.da, i64 1
  store i8 %i.dg, ptr %i.bz, align 1, !tbaa !68, !alias.scope !1048, !noalias !1047
  %i.dh = extractelement <4 x i8> %i.da, i64 2
  store i8 %i.dh, ptr %i.ca, align 1, !tbaa !68, !alias.scope !1048, !noalias !1047
  %i.di = extractelement <4 x i8> %i.da, i64 3
  store i8 %i.di, ptr %i.cb, align 1, !tbaa !68, !alias.scope !1048, !noalias !1047
  ...
  %i.dn = load float, ptr %i.cg, align 4, !tbaa !94, !alias.scope !1047
  %i.do = load float, ptr %i.ch, align 4, !tbaa !94, !alias.scope !1047
  %i.dp = load float, ptr %i.ci, align 4, !tbaa !94, !alias.scope !1047
  %i.dq = load float, ptr %i.cj, align 4, !tbaa !94, !alias.scope !1047
...
begin_hunk_5_@_ZN11OpenImageIO4v3_112convert_typeIfaEEvPKT_PT0_mS5_S5_:bb.a
  ...
  br i1 %i.xu, label %.lr.ph, label %.preheader, !llvm.loop !1045
...
.lr.ph152:                                        ; preds = %.lr.ph152.preheader196, %.lr.ph152
  ...
  br i1 %.not, label %._crit_edge, label %.lr.ph152, !llvm.loop !1046
...
begin_hunk_7_@_ZN11OpenImageIO4v3_112convert_typeIfiEEvPKT_PT0_mS5_S5_:bb.a
  ...
  br i1 %i.kn, label %middle.block, label %vector.body, !llvm.loop !1055
...
vector.body175:                                   ; preds = %vector.body175, %vector.ph169
  ...
  %index.next179 = add nuw i64 %index176, 4       ; 2 uses
  %i.lf = icmp eq i64 %index.next179, %n.vec170
  br i1 %i.lf, label %middle.block180, label %vector.body175, !llvm.loop !1056
...
.lr.ph:                                           ; preds = %.lr.ph.preheader186, %.lr.ph
  ...
  br i1 %i.ni, label %.lr.ph, label %.preheader, !llvm.loop !1057
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.dj, label %.lr.ph, label %.preheader, !llvm.loop !1064
...
begin_hunk_8_@_ZN11OpenImageIO4v3_112convert_typeIfcEEvPKT_PT0_mS5_S5_:bb.a
  ...
  %i.xt = add i64 %.093143, -16                   ; 3 uses
  %i.xu = icmp ugt i64 %i.xt, 15
  br i1 %i.xu, label %.lr.ph, label %.preheader, !llvm.loop !1078
...
.lr.ph152:                                        ; preds = %.lr.ph152.preheader196, %.lr.ph152
  ...
  store i8 %i.yd, ptr %.192150, align 1, !tbaa !68
  %.not = icmp eq i64 %i.xv, 0
  br i1 %.not, label %._crit_edge, label %.lr.ph152, !llvm.loop !1079
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  br i1 %i.da, label %.lr.ph, label %.preheader, !llvm.loop !1084
...
.lr.ph152:                                        ; preds = %.preheader, %.lr.ph152
  ...
  br i1 %.not, label %._crit_edge, label %.lr.ph152, !llvm.loop !1085
...
.lr.ph:                                           ; preds = %.lr.ph.preheader, %.lr.ph
  ...
  %i.cz = add i64 %.093143, -16                   ; 3 uses
  %i.da = icmp ugt i64 %i.cz, 15
  br i1 %i.da, label %.lr.ph, label %.preheader, !llvm.loop !1086
...
.lr.ph152:                                        ; preds = %.preheader, %.lr.ph152
  ...
  store i64 %i.dj, ptr %.192150, align 8, !tbaa !106
  %.not = icmp eq i64 %i.db, 0
  br i1 %.not, label %._crit_edge, label %.lr.ph152, !llvm.loop !1087
...
bb.a:
  ...
  %i.p = load i64, ptr %i.o, align 8, !tbaa !1094
  %i.q = getelementptr inbounds nuw i8, ptr %.val, i64 48
  %i.r = load i64, ptr %i.q, align 8, !tbaa !1095
  %i.s = getelementptr inbounds nuw i8, ptr %.val, i64 56
  %i.t = load ptr, ptr %i.s, align 8, !tbaa !1096
  %i.u = getelementptr inbounds nuw i8, ptr %.val, i64 64
  %i.v = load i64, ptr %i.u, align 8, !tbaa !1097 ; 2 uses
  ...
  %i.aa = load i64, ptr %i.z, align 8, !tbaa !1098
  %i.ab = getelementptr inbounds nuw i8, ptr %.val, i64 88
  %i.ac = load i64, ptr %i.ab, align 8, !tbaa !1099
...
bb.d:                                             ; preds = %bb.a
  ...
  tail call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 16 dereferenceable(96) %i.a, ptr noundef nonnull readonly align 8 dereferenceable(96) %.val6, i64 96, i1 false), !tbaa.struct !1100
  store ptr %i.a, ptr %0, align 8, !tbaa !141
  br label %"_ZNSt14_Function_base13_Base_managerIZN11OpenImageIO4v3_122parallel_convert_imageEiiiiPKvNS2_8TypeDescElllPvS5_llliE3$_0E10_M_managerERSt9_Any_dataRKS9_St18_Manager_operation.exit"
...
__cxx_global_var_init.exit:                       ; preds = %bb.a, %bb.b
  ...
  store i32 %.0.i.i, ptr @_ZN11OpenImageIO4v3_13pvt12oiio_threadsE, align 4, !tbaa !1102
