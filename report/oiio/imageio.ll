...
begin_hunk_0_@_ZN3fmt3v126detail13format_dragonENS1_8basic_fpIoEEjiRNS1_6bufferIcEERi:bb.a
  ...
  %.pre.i.i.pre = load i64, ptr %i.c, align 8, !tbaa !677 ; 2 uses
  %.pre681.pre = load ptr, ptr %5, align 8, !tbaa !667
...
_ZN3fmt3v126detail6bigintlSEi.exit:               ; preds = %bb.i, %_ZN3fmt3v126detail9allocatorIjE8allocateEm.exit.i
  ...
  store i64 %.pre2.i.i.pre-phi, ptr %i.c, align 8, !tbaa !677
...
_ZN3fmt3v126detail6bigintlSEi.exit.thread:        ; preds = %bb.f, %._crit_edge.i, %_ZN3fmt3v126detail6bigintlSEi.exit, %_ZN3fmt3v126detail6bigintlSEi.exit.thread1117
  ...
  store i64 1, ptr %i.m, align 8, !tbaa !677
  %i.bm = lshr i32 %i.x, 5
  store i32 %i.bm, ptr %i.o, align 8, !tbaa !669
...
bb.j:                                             ; preds = %_ZN3fmt3v126detail6bigintlSEi.exit135
  ...
  store i64 1, ptr %i.r, align 8, !tbaa !677
  %i.bq = add nuw nsw i32 %i.x, 1                 ; 2 uses
  %i.br = lshr i32 %i.bq, 5
  store i32 %i.br, ptr %i.t, align 8, !tbaa !669
...
bb.k:                                             ; preds = %_ZN3fmt3v126detail6bigintlSEi.exit155
  %i.bw = load i64, ptr %i.h, align 8, !tbaa !677 ; 7 uses
...
.lr.ph.i157:                                      ; preds = %bb.k
  %i.bx = load ptr, ptr %6, align 8, !tbaa !667   ; 3 uses
...
vector.body1612:                                  ; preds = %vector.body1612, %vector.ph1605
  ...
  br i1 %i.cj, label %middle.block1618, label %vector.body1612, !llvm.loop !680
...
scalar.ph1603:                                    ; preds = %scalar.ph1603.preheader, %scalar.ph1603
  ...
  br i1 %exitcond.not.i160, label %._crit_edge.i161, label %scalar.ph1603, !llvm.loop !681

bb.l:                                             ; preds = %._crit_edge.i161
  %i.cq = add i64 %i.bw, 1                        ; 3 uses
  %i.cr = load i64, ptr %i.f, align 8, !tbaa !668
  %i.cs = icmp ugt i64 %i.cq, %i.cr
  br i1 %i.cs, label %bb.m, label %_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i163

bb.m:                                             ; preds = %bb.l
  %i.ct = load ptr, ptr %i.g, align 8, !tbaa !665
  invoke void %i.ct(ptr noundef nonnull align 8 dereferenceable(172) %6, i64 noundef %i.cq)
          to label %.noexc167 unwind label %.loopexit.split-lp, !inline_history !682

.noexc167:                                        ; preds = %bb.m
  %.pre.i.i165 = load i64, ptr %i.h, align 8, !tbaa !677 ; 2 uses
  %.pre2.i.i166 = add i64 %.pre.i.i165, 1
  %.pre684 = load ptr, ptr %6, align 8, !tbaa !667
...
_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i163: ; preds = %.noexc167, %bb.l
  ...
  store i64 %.pre-phi.i.i164, ptr %i.h, align 8, !tbaa !677
...
bb.p:                                             ; preds = %bb.o
  %i.da = load i64, ptr %i.c, align 8, !tbaa !677 ; 7 uses
  %i.db = load i64, ptr %i.k, align 8, !tbaa !668
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i: ; preds = %bb.p
  store i64 %i.da, ptr %i.m, align 8, !tbaa !677
  %i.dh = load ptr, ptr %5, align 8, !tbaa !667   ; 3 uses
...
.lr.ph.i.preheader.i:                             ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i, %.noexc170
  ...
  %i.dl = load ptr, ptr %7, align 8, !tbaa !667   ; 4 uses
...
vector.body1519:                                  ; preds = %vector.body1519, %vector.ph1516
  ...
  br i1 %i.dz, label %middle.block1525, label %vector.body1519, !llvm.loop !684
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.preheader, %.lr.ph.i.i
  ...
  br i1 %.not.i.i169, label %.loopexit570, label %.lr.ph.i.i, !llvm.loop !685
...
.loopexit570:                                     ; preds = %.lr.ph.i.i, %middle.block1525, %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i
  ...
  %i.ee = load i32, ptr %i.e, align 8, !tbaa !669 ; 2 uses
  store i32 %i.ee, ptr %i.o, align 8, !tbaa !669
  br i1 %.not, label %_ZN3fmt3v126detail6bigintlSEi.exit196, label %bb.q

bb.q:                                             ; preds = %.loopexit570
  %i.ef = load i64, ptr %i.c, align 8, !tbaa !677 ; 8 uses
  %i.eg = load i64, ptr %i.p, align 8, !tbaa !668 ; 2 uses
...
_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171: ; preds = %bb.q
  store i64 %i.ef, ptr %i.r, align 8, !tbaa !677
...
.thread:                                          ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171
  store i32 %i.ee, ptr %i.t, align 8, !tbaa !669
...
.lr.ph.i.preheader.i174:                          ; preds = %_ZN3fmt3v1219basic_memory_bufferIjLm32ENS0_6detail9allocatorIjEEE6resizeEm.exit.i171, %.noexc182
  ...
  %i.eq = load ptr, ptr %8, align 8, !tbaa !667   ; 7 uses
...
vector.body1536:                                  ; preds = %vector.body1536, %vector.ph1533
  ...
  br i1 %i.fe, label %middle.block1543, label %vector.body1536, !llvm.loop !686
...
.lr.ph.i.i175:                                    ; preds = %.lr.ph.i.i175.preheader, %.lr.ph.i.i175
  ...
  br i1 %.not.i.i178, label %.loopexit1623, label %.lr.ph.i.i175, !llvm.loop !687

.loopexit1623:                                    ; preds = %.lr.ph.i.i175, %middle.block1543
  %i.fi = load i32, ptr %i.e, align 8, !tbaa !669
  store i32 %i.fi, ptr %i.t, align 8, !tbaa !669
...
vector.body1552:                                  ; preds = %vector.body1552, %vector.ph1549
  ...
  br i1 %i.ft, label %middle.block1558, label %vector.body1552, !llvm.loop !688
...
.lr.ph.i185:                                      ; preds = %.lr.ph.i185.preheader1673, %.lr.ph.i185
  ...
  br i1 %exitcond.not.i188, label %._crit_edge.i189, label %.lr.ph.i185, !llvm.loop !689
...
bb.s:                                             ; preds = %bb.r
  %i.gd = load ptr, ptr %i.q, align 8, !tbaa !665
  invoke void %i.gd(ptr noundef nonnull align 8 dereferenceable(172) %8, i64 noundef %i.gb)
          to label %.noexc195 unwind label %.loopexit.split-lp, !inline_history !682

.noexc195:                                        ; preds = %bb.s
  %.pre.i.i193 = load i64, ptr %i.r, align 8, !tbaa !677 ; 2 uses
  %.pre2.i.i194 = add i64 %.pre.i.i193, 1
  %.pre678 = load ptr, ptr %8, align 8, !tbaa !667
...
_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i191: ; preds = %.noexc195, %bb.r
  ...
  store i64 %.pre-phi.i.i192, ptr %i.r, align 8, !tbaa !677
...
_ZN3fmt3v126detail6bigintlSEi.exit196:            ; preds = %_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i191, %._crit_edge.i189, %.loopexit1623, %.thread, %.loopexit570
  ...
  %i.gh = load i128, ptr %0, align 16, !tbaa !675 ; 3 uses
  %i.gi = and i128 %i.gh, 18446744073709551615
  %i.gj = load i64, ptr %i.c, align 8, !tbaa !677 ; 4 uses
...
.lr.ph.i.i197:                                    ; preds = %_ZN3fmt3v126detail6bigintlSEi.exit196
  %i.gk = load ptr, ptr %5, align 8, !tbaa !667   ; 3 uses
...
bb.t:                                             ; preds = %bb.t, %.lr.ph.i.i197
  ...
  br i1 %exitcond.not.i.i, label %.preheader.i.i, label %bb.t, !llvm.loop !690
...
.lr.ph22.i.i:                                     ; preds = %.preheader.i.i, %_ZN3fmt3v126detail6bufferIjE9push_backERKj.exit.i.i
  ...
  %i.he = load i64, ptr %i.a, align 8, !tbaa !668
...
bb.u:                                             ; preds = %.lr.ph22.i.i
  %i.hg = load ptr, ptr %i.b, align 8, !tbaa !665
  invoke void %i.hg(ptr noundef nonnull align 8 dereferenceable(172) %5, i64 noundef %i.hd)
          to label %.noexc200 unwind label %.loopexit569, !inline_history !691

.noexc200:                                        ; preds = %bb.u
  %.pre.i.i.i199 = load i64, ptr %i.c, align 8, !tbaa !677 ; 2 uses
  %.pre2.i.i.i = add i64 %.pre.i.i.i199, 1
  %.pre.i = load ptr, ptr %5, align 8, !tbaa !667
end_hunk_0
begin_hunk_1_@_ZZN3fmt3v126detail11write_fixedIcNS1_14digit_groupingIcEENS0_14basic_appenderIcEENS1_14big_decimal_fpEEET1_S8_RKT2_iT_RKNS0_12format_specsENS0_4signENS0_10locale_refEENKUlS6_E1_clES6_:bb.a
  ...
  store i8 %i.dc, ptr %i.dd, align 1, !tbaa !23
  ...
  store i8 %i.dg, ptr %i.dh, align 1, !tbaa !23
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !791
...
bb.a:
  ...
  %i.u = load i64, ptr %i.t, align 8, !tbaa !405
  %i.v = add i64 %i.u, %2
  %i.w = add i64 %i.v, %i.s                       ; 2 uses
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.y = load i64, ptr %i.x, align 8, !tbaa !399
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void %i.ab(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.w), !inline_history !469
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ah = load i64, ptr %i.ag, align 8, !tbaa !399
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.ak = load ptr, ptr %i.aj, align 8, !tbaa !396
  tail call void %i.ak(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.af), !inline_history !792
  %.pre.i.i.i = load i64, ptr %i.ad, align 8, !tbaa !405 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i:        ; preds = %bb.e, %bb.d
  ...
  %i.am = load ptr, ptr %.sroa.09.0, align 8, !tbaa !398
  store i64 %.pre-phi.i.i.i, ptr %i.ad, align 8, !tbaa !405
  %i.an = getelementptr inbounds nuw i8, ptr %i.am, i64 %i.al
  store i8 48, ptr %i.an, align 1, !tbaa !23
  %i.ao = load i64, ptr %i.ad, align 8, !tbaa !405 ; 2 uses
  %i.ap = add i64 %i.ao, 1                        ; 3 uses
  %i.aq = load i64, ptr %i.ag, align 8, !tbaa !399
...
bb.f:                                             ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
  ...
  %i.at = load ptr, ptr %i.as, align 8, !tbaa !396
  tail call void %i.at(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.ap), !inline_history !792
  %.pre.i.i4.i = load i64, ptr %i.ad, align 8, !tbaa !405 ; 2 uses
...
_ZN3fmt3v1214basic_appenderIcEaSEc.exit6.i:       ; preds = %bb.f, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit.i
  ...
  %i.av = load ptr, ptr %.sroa.09.0, align 8, !tbaa !398
  store i64 %.pre-phi.i.i3.i, ptr %i.ad, align 8, !tbaa !405
  %i.aw = getelementptr inbounds nuw i8, ptr %i.av, i64 %i.au
  store i8 120, ptr %i.aw, align 1, !tbaa !23
  %i.ax = load i64, ptr %4, align 8, !tbaa !428   ; 2 uses
  %i.ay = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.az = load i32, ptr %i.ay, align 8, !tbaa !430 ; 3 uses
  %i.ba = zext i32 %i.az to i64                   ; 2 uses
  %i.bb = load i64, ptr %i.ad, align 8, !tbaa !405 ; 2 uses
  %i.bc = add i64 %i.bb, %i.ba                    ; 3 uses
  %i.bd = load i64, ptr %i.ag, align 8, !tbaa !399
...
_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i.i.i: ; preds = %_ZN3fmt3v1214basic_appenderIcEaSEc.exit6.i
  ...
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !396
  tail call void %i.bg(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.bc), !inline_history !793
  %.pre.i.i7.i = load i64, ptr %i.ad, align 8, !tbaa !405 ; 2 uses
  %.pre14.i.i.i = load i64, ptr %i.ag, align 8, !tbaa !399
...
_ZN3fmt3v126detail10to_pointerIcEEPT_NS0_14basic_appenderIS3_EEm.exit.i.i: ; preds = %_ZN3fmt3v126detail6bufferIcE11try_reserveEm.exit.i.i.i, %_ZN3fmt3v1214basic_appenderIcEaSEc.exit6.i
  ...
  store i64 %.pre-phi19.i.i.i, ptr %i.ad, align 8, !tbaa !405
  %i.bj = load ptr, ptr %.sroa.09.0, align 8, !tbaa !398 ; 2 uses
...
.split.i.i.i.i:                                   ; preds = %.split.i.i.i.i, %bb.g
  ...
  %i.bo = getelementptr inbounds nuw i8, ptr @.str.96, i64 %i.bn
  %i.bp = load i8, ptr %i.bo, align 1, !tbaa !23
  %i.bq = getelementptr inbounds i8, ptr %.0.i.i.i.i, i64 -1 ; 2 uses
  store i8 %i.bp, ptr %i.bq, align 1, !tbaa !23
  %i.br = lshr i64 %.012.i.i.i.i, 4               ; 2 uses
  %.not.i.i.i.i = icmp eq i64 %i.br, 0
  br i1 %.not.i.i.i.i, label %_ZZN3fmt3v126detail9write_ptrIcNS0_14basic_appenderIcEEmEET0_S5_T1_PKNS0_12format_specsEENKUlS4_E_clES4_.exit, label %.split.i.i.i.i, !llvm.loop !500
...
.split.i.i18.i.i:                                 ; preds = %.split.i.i18.i.i, %_ZN3fmt3v126detail10to_pointerIcEEPT_NS0_14basic_appenderIS3_EEm.exit.thread.i.i
  ...
  %i.bv = getelementptr inbounds nuw i8, ptr @.str.96, i64 %i.bu
  ...
  br i1 %.not.i.i21.i.i, label %_ZN3fmt3v126detail13format_base2eIcmEEPT_iS4_T0_ib.exit26.i.i, label %.split.i.i18.i.i, !llvm.loop !500
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden noundef ptr @_ZN3fmt3v126detail12parse_arg_idIcRZNS1_23parse_replacement_fieldIcRNS1_14format_handlerIcEEEEPKT_S9_S9_OT0_E10id_adapterEES9_S9_S9_SB_(ptr noundef %0, ptr noundef %1, ptr noundef nonnull align 8 dereferenceable(12) %2) local_unnamed_addr #2 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64                   ; 4 uses
  %3 = ptrtoint ptr %1 to i64                     ; 3 uses
  %i.b = load i8, ptr %0, align 1, !tbaa !23      ; 5 uses
  %i.c = add i8 %i.b, -48
...
bb.d:                                             ; preds = %.lr.ph62
  ...
  br i1 %.not34.i, label %.critedge.i, label %.lr.ph62, !llvm.loop !794
...
.lr.ph62:                                         ; preds = %bb.c, %bb.d
  ...
  %i.o = load i8, ptr %i.m, align 1, !tbaa !23    ; 2 uses
  %i.p = add i8 %i.o, -48
  %or.cond.i = icmp ult i8 %i.p, 10
  br i1 %or.cond.i, label %bb.d, label %..critedge.i_crit_edge, !llvm.loop !794

..critedge.i_crit_edge:                           ; preds = %.lr.ph62
  br label %.critedge.i, !llvm.loop !794
...
bb.f:                                             ; preds = %bb.e
  ...
  %i.w = load i8, ptr %.028.lcssa.i, align 1, !tbaa !23
...
bb.i:                                             ; preds = %_ZN3fmt3v126detail21parse_nonnegative_intIcEEiRPKT_S5_i.exit
  %i.ae = load i8, ptr %.037, align 1, !tbaa !23
...
bb.j:                                             ; preds = %bb.i, %_ZN3fmt3v126detail21parse_nonnegative_intIcEEiRPKT_S5_i.exit
  tail call void @_ZN3fmt3v1212report_errorEPKc(ptr noundef nonnull @.str.115) #42
  unreachable

bb.k:                                             ; preds = %bb.i, %bb.i
  %i.af = load ptr, ptr %2, align 8, !tbaa !795, !nonnull !33, !align !514
  %i.ag = getelementptr inbounds nuw i8, ptr %i.af, i64 16 ; 2 uses
  %i.ah = load i32, ptr %i.ag, align 8, !tbaa !400
...
bb.l:                                             ; preds = %bb.k
  tail call void @_ZN3fmt3v1212report_errorEPKc(ptr noundef nonnull @.str.119) #42
  unreachable
...
_ZZN3fmt3v126detail23parse_replacement_fieldIcRNS1_14format_handlerIcEEEEPKT_S8_S8_OT0_EN10id_adapter8on_indexEi.exit: ; preds = %bb.k
  store i32 -1, ptr %i.ag, align 8, !tbaa !400
...
.lr.ph:                                           ; preds = %.critedge4.preheader, %.critedge4
  ...
  br i1 %or.cond38, label %.critedge4, label %..critedge_crit_edge, !llvm.loop !796

..critedge_crit_edge:                             ; preds = %.lr.ph
  br label %.critedge, !llvm.loop !796
...
.critedge:                                        ; preds = %.critedge4, %..critedge_crit_edge, %.critedge4.preheader
  ...
  %i.az = load ptr, ptr %2, align 8, !tbaa !795, !nonnull !33, !align !514 ; 3 uses
  %i.ba = getelementptr inbounds nuw i8, ptr %i.az, i64 16
  store i32 -1, ptr %i.ba, align 8, !tbaa !400
  %i.bb = getelementptr inbounds nuw i8, ptr %i.az, i64 32
  %i.bc = load i64, ptr %i.bb, align 8, !tbaa !410 ; 2 uses
...
bb.o:                                             ; preds = %.critedge
  ...
  %i.bj = load i64, ptr %i.bi, align 8, !tbaa !797 ; 2 uses
...
.lr.ph.i.i.i.i:                                   ; preds = %bb.o
  %i.bk = load ptr, ptr %i.bh, align 8, !tbaa !800
  br label %bb.q

bb.p:                                             ; preds = %bb.q
  %i.bl = add nuw i64 %.01115.i.i.i.i, 1          ; 2 uses
  %exitcond.not.i.i.i.i = icmp eq i64 %i.bl, %i.bj
  br i1 %exitcond.not.i.i.i.i, label %_ZNK3fmt3v127context6arg_idENS0_17basic_string_viewIcEE.exit.thread.i.i, label %bb.q, !llvm.loop !801
...
bb.q:                                             ; preds = %bb.p, %.lr.ph.i.i.i.i
  ...
  %i.bn = load ptr, ptr %i.bm, align 8, !tbaa !802 ; 2 uses
  %i.bo = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %i.bn) #39 ; 2 uses
...
_ZNK3fmt3v127context6arg_idENS0_17basic_string_viewIcEE.exit.i.i: ; preds = %bb.q
  ...
  %i.bt = load i32, ptr %i.bs, align 8, !tbaa !804 ; 2 uses
...
_ZNK3fmt3v127context6arg_idENS0_17basic_string_viewIcEE.exit.thread.i.i: ; preds = %bb.p, %_ZNK3fmt3v127context6arg_idENS0_17basic_string_viewIcEE.exit.i.i, %bb.o, %.critedge
  tail call void @_ZN3fmt3v1212report_errorEPKc(ptr noundef nonnull @.str.113) #42
  unreachable
...
_ZNK3fmt3v1217basic_format_argsINS0_7contextEE6get_idIcEEiNS0_17basic_string_viewIT_EE.exit.i.i: ; preds = %bb.k
  ...
  %i.ak = load i32, ptr %i.aj, align 8, !tbaa !804, !noalias !826 ; 6 uses
...
_ZNK3fmt3v127context3argEi.exit:                  ; preds = %bb.n, %bb.d
  ...
  %storemerge = load i128, ptr %storemerge.in, align 16, !tbaa !23 ; 3 uses
  ...
  %.sroa.23.0 = load i32, ptr %.sroa.23.0.in, align 16, !tbaa !407 ; 2 uses
...
_ZNK3fmt3v127context3argEi.exit.thread37.sink.split: ; preds = %bb.p, %bb.g
  ...
  %.sroa.010.0.copyload25 = load i128, ptr %i.ay, align 16, !tbaa !23 ; 3 uses
...
bb.w:                                             ; preds = %_ZNK3fmt3v127context3argEi.exit.thread37
  tail call void @_ZN3fmt3v1212report_errorEPKc(ptr noundef nonnull @.str.126) #42
  unreachable
...
_ZNK3fmt3v1216basic_format_argINS0_7contextEE5visitINS0_6detail19dynamic_spec_getterEEEDTclfp_Li0EEEOT_.exit.thread: ; preds = %bb.u, %bb.q, %_ZNK3fmt3v1216basic_format_argINS0_7contextEE5visitINS0_6detail19dynamic_spec_getterEEEDTclfp_Li0EEEOT_.exit
  tail call void @_ZN3fmt3v1212report_errorEPKc(ptr noundef nonnull @.str.125) #42
  unreachable
...
bb.c:                                             ; preds = %.lr.ph
  ...
  br i1 %.not34.i, label %.critedge.i, label %.lr.ph, !llvm.loop !794
...
.lr.ph:                                           ; preds = %bb.b, %bb.c
  ...
  %i.p = load i8, ptr %i.n, align 1, !tbaa !23    ; 2 uses
  %i.q = add i8 %i.p, -48
  %or.cond.i = icmp ult i8 %i.q, 10
  br i1 %or.cond.i, label %bb.c, label %..critedge.i_crit_edge, !llvm.loop !794
...
bb.e:                                             ; preds = %bb.d
  ...
  %i.x = load i8, ptr %.028.lcssa.i, align 1, !tbaa !23
...
_ZN3fmt3v126detail21parse_nonnegative_intIcEEiRPKT_S5_i.exit.thread: ; preds = %bb.e, %bb.d, %_ZN3fmt3v126detail21parse_nonnegative_intIcEEiRPKT_S5_i.exit
  tail call void @_ZN3fmt3v1212report_errorEPKc(ptr noundef nonnull @.str.110) #42
  unreachable
...
bb.n:                                             ; preds = %bb.m
  %i.ao = load i8, ptr %.0, align 1, !tbaa !23
  %i.ap = icmp eq i8 %i.ao, 125
  br i1 %i.ap, label %bb.o, label %bb.p

bb.o:                                             ; preds = %bb.n
  %i.aq = getelementptr inbounds nuw i8, ptr %.0, i64 1
  %.sroa.3.0.pre = load i32, ptr %i.a, align 4, !tbaa !831
  br label %bb.q

bb.p:                                             ; preds = %bb.m, %bb.n, %bb.g
  call void @_ZN3fmt3v1212report_errorEPKc(ptr noundef nonnull @.str.115) #42
  unreachable
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden noundef ptr @_ZN3fmt3v126detail12parse_arg_idIcNS1_20dynamic_spec_handlerIcEEEEPKT_S7_S7_OT0_(ptr noundef %0, ptr noundef %1, ptr noundef nonnull align 8 dereferenceable(24) %2) local_unnamed_addr #2 {
bb.a:
  %i.a = ptrtoint ptr %0 to i64                   ; 4 uses
  %3 = ptrtoint ptr %1 to i64                     ; 3 uses
  %i.b = load i8, ptr %0, align 1, !tbaa !23      ; 5 uses
...
bb.d:                                             ; preds = %.lr.ph50
  ...
  %i.l = getelementptr inbounds nuw i8, ptr %i.m, i64 1 ; 2 uses
  %.not34.i = icmp eq ptr %i.l, %1
  br i1 %.not34.i, label %.critedge.i, label %.lr.ph50, !llvm.loop !794
...
bb.k:                                             ; preds = %bb.i, %bb.i
  ...
  %i.ag = load ptr, ptr %i.af, align 8, !tbaa !837, !nonnull !33, !align !514
  store i32 %.021, ptr %i.ag, align 8
  %i.ah = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.ai = load ptr, ptr %i.ah, align 8, !tbaa !839, !nonnull !33, !align !493
  store i32 1, ptr %i.ai, align 4, !tbaa !831
  %i.aj = load ptr, ptr %2, align 8, !tbaa !840, !nonnull !33, !align !514
  %i.ak = getelementptr inbounds nuw i8, ptr %i.aj, i64 16 ; 2 uses
  %i.al = load i32, ptr %i.ak, align 8, !tbaa !400
...
_ZN3fmt3v126detail20dynamic_spec_handlerIcE8on_indexEi.exit: ; preds = %bb.k
  store i32 -1, ptr %i.ak, align 8, !tbaa !400
  br label %bb.o
...
.critedge4:                                       ; preds = %.lr.ph
  ...
  br i1 %.not, label %.critedge, label %.lr.ph, !llvm.loop !841

.lr.ph:                                           ; preds = %.critedge4.preheader, %.critedge4
  %i.au = phi ptr [ %i.at, %.critedge4 ], [ %i.as, %.critedge4.preheader ] ; 3 uses
  %i.av = load i8, ptr %i.au, align 1, !tbaa !23  ; 3 uses
  %i.aw = and i8 %i.av, -33
  %i.ax = add i8 %i.aw, -65
  ...
  br i1 %or.cond38, label %.critedge4, label %..critedge_crit_edge, !llvm.loop !841

..critedge_crit_edge:                             ; preds = %.lr.ph
  br label %.critedge, !llvm.loop !841
...
.critedge:                                        ; preds = %.critedge4, %..critedge_crit_edge, %.critedge4.preheader
  ...
  %i.be = load ptr, ptr %i.bd, align 8, !tbaa !837, !nonnull !33, !align !514 ; 2 uses
  store ptr %0, ptr %i.be, align 8
  %.sroa.4.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.be, i64 8
  store i64 %i.bc, ptr %.sroa.4.0..sroa_idx.i, align 8, !tbaa !23
  %i.bf = getelementptr inbounds nuw i8, ptr %2, i64 16
  %i.bg = load ptr, ptr %i.bf, align 8, !tbaa !839, !nonnull !33, !align !493
  store i32 2, ptr %i.bg, align 4, !tbaa !831
  %i.bh = load ptr, ptr %2, align 8, !tbaa !840, !nonnull !33, !align !514
  %i.bi = getelementptr inbounds nuw i8, ptr %i.bh, i64 16
  store i32 -1, ptr %i.bi, align 8, !tbaa !400
  br label %bb.o
...
define linkonce_odr hidden ptr @_ZN3fmt3v126detail18write_int_noinlineIcNS0_14basic_appenderIcEEmEET0_S5_NS1_13write_int_argIT1_EERKNS0_12format_specsE(ptr %0, i64 %1, i32 %2, ptr noundef nonnull align 4 dereferenceable(16) %3) local_unnamed_addr #31 {
bb.a:
  %4 = alloca %class.anon.54, align 1             ; 5 uses
  %i.a = alloca [64 x i8], align 16               ; 10 uses
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a) #39
  %i.b = load i32, ptr %3, align 4, !tbaa !421    ; 10 uses
...
begin_hunk_3_@_ZN3fmt3v126detail20write_escaped_stringIcNS0_14basic_appenderIcEEEET0_S5_NS0_17basic_string_viewIT_EE:bb.a
  ...
  %.pre.i.i13 = load i64, ptr %i.s, align 8, !tbaa !405
  br label %bb.d
...
bb.d:                                             ; preds = %._crit_edge.i.i, %.lr.ph34.i.i
  ...
  %i.x = load i64, ptr %i.t, align 8, !tbaa !399
  %i.y = sub i64 %i.x, %i.w
...
bb.e:                                             ; preds = %bb.d
  %i.ac = load ptr, ptr %i.v, align 8, !tbaa !396
  %i.ad = add i64 %i.aa, %i.w
  call void %i.ac(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.022.0, i64 noundef %i.ad), !inline_history !470
  %i.ae = load i64, ptr %i.s, align 8, !tbaa !405 ; 2 uses
  %i.af = load i64, ptr %i.t, align 8, !tbaa !399
...
bb.f:                                             ; preds = %bb.e, %bb.d
  ...
  %i.ai = load ptr, ptr %.sroa.022.0, align 8, !tbaa !398 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.an, align 1, !tbaa !23
  %wide.load41 = load <16 x i8>, ptr %i.ao, align 1, !tbaa !23
  %i.ap = getelementptr inbounds nuw i8, ptr %i.ak, i64 %index ; 2 uses
  %i.aq = getelementptr inbounds nuw i8, ptr %i.ap, i64 16
  store <16 x i8> %wide.load, ptr %i.ap, align 1, !tbaa !23
  store <16 x i8> %wide.load41, ptr %i.aq, align 1, !tbaa !23
...
vec.epilog.iter.check:                            ; preds = %middle.block
  ...
  br i1 %min.epilog.iters.check, label %.lr.ph.i.i.preheader, label %vec.epilog.ph, !prof !232
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load45 = load <4 x i8>, ptr %i.as, align 1, !tbaa !23
  %i.at = getelementptr inbounds nuw i8, ptr %i.ak, i64 %index44
  store <4 x i8> %wide.load45, ptr %i.at, align 1, !tbaa !23
  %index.next46 = add nuw i64 %index44, 4         ; 2 uses
  %i.au = icmp eq i64 %index.next46, %n.vec43
  br i1 %i.au, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !941
...
._crit_edge.loopexit.i.i:                         ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i = load i64, ptr %i.s, align 8, !tbaa !405
...
._crit_edge.i.i:                                  ; preds = %._crit_edge.loopexit.i.i, %bb.f
  ...
  store i64 %i.bc, ptr %i.s, align 8, !tbaa !405
  %i.bd = getelementptr inbounds nuw i8, ptr %.02532.i.i, i64 %.026.i.i ; 2 uses
  %.not.i.i = icmp eq ptr %i.bd, %i.r
  br i1 %.not.i.i, label %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit, label %bb.d, !llvm.loop !450
...
.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i.prol.loopexit, %.lr.ph.i.i
  ...
  store i8 %i.bj, ptr %i.bk, align 1, !tbaa !23
...
_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit: ; preds = %._crit_edge.i.i, %bb.c
  %i.bu = load ptr, ptr %i.m, align 8, !tbaa !526 ; 3 uses
...
bb.g:                                             ; preds = %_ZN3fmt3v126detail4copyIcPKcNS0_14basic_appenderIcEETnNSt9enable_ifIXaasr23is_back_insert_iteratorIT1_EE5valuesr41has_back_insert_iterator_container_appendIS8_T0_EE5valueEiE4typeELi0EEES8_S9_S9_S8_.exit
  ...
  br i1 %.not12, label %.loopexit, label %bb.c, !llvm.loop !944
...
.loopexit:                                        ; preds = %bb.g, %.thread
  ...
  %i.bx = load i64, ptr %i.bw, align 8, !tbaa !405 ; 2 uses
  %i.by = add i64 %i.bx, 1                        ; 3 uses
  %i.bz = getelementptr inbounds nuw i8, ptr %.sroa.022.127, i64 16
  %i.ca = load i64, ptr %i.bz, align 8, !tbaa !399
...
bb.h:                                             ; preds = %.loopexit
  ...
  %i.cd = load ptr, ptr %i.cc, align 8, !tbaa !396
  call void %i.cd(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.022.127, i64 noundef %i.by), !inline_history !445
  %.pre.i.i16 = load i64, ptr %i.bw, align 8, !tbaa !405 ; 2 uses
...
bb.d:                                             ; preds = %bb.c
  %i.f = load i8, ptr %.0, align 1, !tbaa !23
  %i.g = zext i8 %i.f to i32                      ; 2 uses
  %i.h = lshr i32 %i.g, 3                         ; 2 uses
  %i.i = zext nneg i32 %i.h to i64
  %i.j = getelementptr inbounds nuw i8, ptr @.str.130, i64 %i.i
  %i.k = load i8, ptr %i.j, align 1, !tbaa !23
  ...
  %i.ab = load i8, ptr %i.aa, align 1, !tbaa !23  ; 2 uses
  %i.ac = and i8 %i.ab, 63
  ...
  %i.ah = load i8, ptr %i.ag, align 1, !tbaa !23  ; 2 uses
  %i.ai = and i8 %i.ah, 63
  ...
  br i1 %i.bo, label %bb.c, label %.thread, !llvm.loop !946
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep49, align 1, !tbaa !23
  %wide.load50 = load <16 x i8>, ptr %i.by, align 1, !tbaa !23
  %i.bz = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !23
  store <16 x i8> %wide.load50, ptr %i.bz, align 1, !tbaa !23
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.ca = icmp eq i64 %index.next, %n.vec
  br i1 %i.ca, label %middle.block, label %vector.body, !llvm.loop !947
...
vec.epilog.iter.check:                            ; preds = %middle.block
  %min.epilog.iters.check = icmp eq i64 %n.mod.vf, 0
  br i1 %min.epilog.iters.check, label %.lr.ph.i.preheader, label %vec.epilog.ph, !prof !232
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load57 = load <4 x i8>, ptr %next.gep56, align 1, !tbaa !23
  store <4 x i8> %wide.load57, ptr %next.gep55, align 1, !tbaa !23
  %index.next58 = add nuw i64 %index54, 4         ; 2 uses
  %i.cd = icmp eq i64 %index.next58, %n.vec53
  br i1 %i.cd, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !948
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  %i.ch = load i8, ptr %.057.i.prol, align 1, !tbaa !23
  %i.ci = getelementptr inbounds nuw i8, ptr %.08.i.prol, i64 1 ; 2 uses
  store i8 %i.ch, ptr %.08.i.prol, align 1, !tbaa !23
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !949
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.cm = load i8, ptr %.057.i, align 1, !tbaa !23
  %i.cn = getelementptr inbounds nuw i8, ptr %.08.i, i64 1
  store i8 %i.cm, ptr %.08.i, align 1, !tbaa !23
...
_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit: ; preds = %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit.preheader, %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit
  ...
  %i.dk = load i8, ptr %.022, align 1, !tbaa !23
  %i.dl = zext i8 %i.dk to i32                    ; 2 uses
  %i.dm = lshr i32 %i.dl, 3                       ; 2 uses
  %i.dn = zext nneg i32 %i.dm to i64
  %i.do = getelementptr inbounds nuw i8, ptr @.str.130, i64 %i.dn
  ...
  %i.ea = load i8, ptr %i.dz, align 1, !tbaa !23  ; 2 uses
  %i.eb = and i8 %i.ea, 63
  ...
  br i1 %or.cond, label %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit, label %bb.e, !llvm.loop !951
...
bb.a:
  ...
  %i.t = load i64, ptr %i.s, align 8, !tbaa !405
  %i.u = add i64 %i.t, %2
  %i.v = add i64 %i.u, %i.r                       ; 2 uses
  %i.w = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.x = load i64, ptr %i.w, align 8, !tbaa !399
...
bb.b:                                             ; preds = %bb.a
  ...
  tail call void %i.aa(ptr noundef nonnull align 8 dereferenceable(32) %0, i64 noundef %i.v), !inline_history !469
  br label %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
...
bb.d:                                             ; preds = %bb.c, %_ZN3fmt3v126detail7reserveIcEENS0_14basic_appenderIT_EES5_m.exit
  ...
  %i.ac = load i8, ptr %4, align 8, !tbaa !933, !range !32, !noundef !33
  %i.ad = trunc nuw i8 %i.ac to i1
  br i1 %i.ad, label %bb.e, label %bb.f

bb.e:                                             ; preds = %bb.d
  %i.ae = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.af = load i64, ptr %i.ae, align 8, !tbaa !935
  %i.ag = getelementptr inbounds nuw i8, ptr %4, i64 16
  %.sroa.01.0.copyload.i = load ptr, ptr %i.ag, align 8, !tbaa !71
...
bb.f:                                             ; preds = %bb.d
  ...
  %i.ak = load ptr, ptr %i.aj, align 8, !tbaa !554 ; 2 uses
  %i.al = getelementptr inbounds nuw i8, ptr %4, i64 8
  %i.am = load i64, ptr %i.al, align 8, !tbaa !935 ; 2 uses
...
.lr.ph34.i.i.i:                                   ; preds = %bb.f
  ...
  %.pre.i.i.i = load i64, ptr %i.ao, align 8, !tbaa !405
  br label %bb.g
...
bb.g:                                             ; preds = %._crit_edge.i.i.i, %.lr.ph34.i.i.i
  ...
  %i.at = load i64, ptr %i.ap, align 8, !tbaa !399
...
bb.h:                                             ; preds = %bb.g
  %i.ay = load ptr, ptr %i.ar, align 8, !tbaa !396
  %i.az = add i64 %i.aw, %i.as
  tail call void %i.ay(ptr noundef nonnull align 8 dereferenceable(32) %.sroa.09.0, i64 noundef %i.az), !inline_history !952
  %i.ba = load i64, ptr %i.ao, align 8, !tbaa !405 ; 2 uses
  %i.bb = load i64, ptr %i.ap, align 8, !tbaa !399
...
bb.i:                                             ; preds = %bb.h, %bb.g
  ...
  %i.be = load ptr, ptr %.sroa.09.0, align 8, !tbaa !398 ; 2 uses
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %i.bj, align 1, !tbaa !23
  %wide.load36 = load <16 x i8>, ptr %i.bk, align 1, !tbaa !23
  %i.bl = getelementptr inbounds nuw i8, ptr %i.bg, i64 %index ; 2 uses
  %i.bm = getelementptr inbounds nuw i8, ptr %i.bl, i64 16
  store <16 x i8> %wide.load, ptr %i.bl, align 1, !tbaa !23
  store <16 x i8> %wide.load36, ptr %i.bm, align 1, !tbaa !23
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.bn = icmp eq i64 %index.next, %n.vec
  br i1 %i.bn, label %middle.block, label %vector.body, !llvm.loop !953
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load40 = load <4 x i8>, ptr %i.bo, align 1, !tbaa !23
  %i.bp = getelementptr inbounds nuw i8, ptr %i.bg, i64 %index39
  store <4 x i8> %wide.load40, ptr %i.bp, align 1, !tbaa !23
  %index.next41 = add nuw i64 %index39, 4         ; 2 uses
  %i.bq = icmp eq i64 %index.next41, %n.vec38
  br i1 %i.bq, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !954
...
.lr.ph.i.i.i.prol:                                ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i.prol
  ...
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.i.i.prol.loopexit, label %.lr.ph.i.i.i.prol, !llvm.loop !955
...
._crit_edge.loopexit.i.i.i:                       ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i, %vec.epilog.middle.block, %middle.block
  %.pre37.i.i.i = load i64, ptr %i.ao, align 8, !tbaa !405
...
._crit_edge.i.i.i:                                ; preds = %._crit_edge.loopexit.i.i.i, %bb.i
  ...
  store i64 %i.by, ptr %i.ao, align 8, !tbaa !405
  %i.bz = getelementptr inbounds nuw i8, ptr %.02532.i.i.i, i64 %.026.i.i.i ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.bz, %i.an
  br i1 %.not.i.i.i, label %_ZZN3fmt3v126detail5writeIcNS0_14basic_appenderIcEETnNSt9enable_ifIXsr3std7is_sameIT_cEE5valueEiE4typeELi0EEET0_S9_NS0_17basic_string_viewIS6_EERKNS0_12format_specsEENKUlS4_E_clES4_.exit, label %bb.g, !llvm.loop !450
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.prol.loopexit, %.lr.ph.i.i.i
  ...
  store i8 %i.cb, ptr %i.cc, align 1, !tbaa !23
  ...
  br i1 %exitcond.not.i.i.i.3, label %._crit_edge.loopexit.i.i.i, label %.lr.ph.i.i.i, !llvm.loop !956
...
; Function Attrs: mustprogress uwtable
define linkonce_odr hidden void @_ZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_(ptr %0, i64 %1, ptr %2) local_unnamed_addr #2 {
bb.a:
  %3 = ptrtoint ptr %0 to i64
  %i.a = alloca [7 x i8], align 1                 ; 11 uses
  %i.b = ptrtoaddr ptr %i.a to i64
...
.lr.ph:                                           ; preds = %bb.b, %_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit
  ...
  %i.f = load i8, ptr %.055, align 1, !tbaa !23
  %i.g = zext i8 %i.f to i32                      ; 2 uses
  %i.h = lshr i32 %i.g, 3                         ; 2 uses
  %i.i = zext nneg i32 %i.h to i64
  %i.j = getelementptr inbounds nuw i8, ptr @.str.130, i64 %i.i
...
_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit.thread: ; preds = %.lr.ph, %switch.early.test.i.i.i, %switch.early.test.i.i.i, %switch.early.test.i.i.i, %_ZN3fmt3v126detail12needs_escapeEj.exit.i.i
  ...
  store ptr %.055, ptr %2, align 8, !tbaa !71
  %.sroa.4.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %2, i64 8
  store ptr %i.bq, ptr %.sroa.4.0..sroa_idx.i.i, align 8, !tbaa !71
...
_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit: ; preds = %_ZN3fmt3v126detail12needs_escapeEj.exit.i.i
  ...
  br i1 %.not30, label %.lr.ph, label %.loopexit, !llvm.loop !957
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  %wide.load = load <16 x i8>, ptr %next.gep106, align 1, !tbaa !23
  %wide.load107 = load <16 x i8>, ptr %i.ca, align 1, !tbaa !23
  %i.cb = getelementptr i8, ptr %next.gep, i64 16
  store <16 x i8> %wide.load, ptr %next.gep, align 1, !tbaa !23
  store <16 x i8> %wide.load107, ptr %i.cb, align 1, !tbaa !23
  %index.next = add nuw i64 %index, 32            ; 2 uses
  %i.cc = icmp eq i64 %index.next, %n.vec
  br i1 %i.cc, label %middle.block, label %vector.body, !llvm.loop !958
...
vec.epilog.vector.body:                           ; preds = %vec.epilog.vector.body, %vec.epilog.ph
  ...
  %wide.load114 = load <4 x i8>, ptr %next.gep113, align 1, !tbaa !23
  store <4 x i8> %wide.load114, ptr %next.gep112, align 1, !tbaa !23
  %index.next115 = add nuw i64 %index111, 4       ; 2 uses
  %i.cf = icmp eq i64 %index.next115, %n.vec110
  br i1 %i.cf, label %vec.epilog.middle.block, label %vec.epilog.vector.body, !llvm.loop !959
...
.lr.ph.i.prol:                                    ; preds = %.lr.ph.i.preheader, %.lr.ph.i.prol
  ...
  %i.cj = load i8, ptr %.057.i.prol, align 1, !tbaa !23
  %i.ck = getelementptr inbounds nuw i8, ptr %.08.i.prol, i64 1 ; 2 uses
  store i8 %i.cj, ptr %.08.i.prol, align 1, !tbaa !23
  %prol.iter.next = add i64 %prol.iter, 1         ; 2 uses
  %prol.iter.cmp.not = icmp eq i64 %prol.iter.next, %xtraiter
  br i1 %prol.iter.cmp.not, label %.lr.ph.i.prol.loopexit, label %.lr.ph.i.prol, !llvm.loop !960
...
.lr.ph.i:                                         ; preds = %.lr.ph.i.prol.loopexit, %.lr.ph.i
  ...
  %i.co = load i8, ptr %.057.i, align 1, !tbaa !23
  %i.cp = getelementptr inbounds nuw i8, ptr %.08.i, i64 1
  store i8 %i.co, ptr %.08.i, align 1, !tbaa !23
  %i.cq = getelementptr inbounds nuw i8, ptr %.057.i, i64 2
  %i.cr = load i8, ptr %i.cn, align 1, !tbaa !23
  ...
  br i1 %.not.i33.7, label %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit.preheader, label %.lr.ph.i, !llvm.loop !961
...
_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit: ; preds = %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit.preheader, %_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit42
  ...
  %i.dm = load i8, ptr %.022, align 1, !tbaa !23
  %i.dn = zext i8 %i.dm to i32                    ; 2 uses
  %i.do = lshr i32 %i.dn, 3                       ; 2 uses
  %i.dp = zext nneg i32 %i.do to i64
  %i.dq = getelementptr inbounds nuw i8, ptr @.str.130, i64 %i.dp
  ...
  %i.ec = load i8, ptr %i.eb, align 1, !tbaa !23  ; 2 uses
  %i.ed = and i8 %i.ec, 63
  ...
  %i.ei = load i8, ptr %i.eh, align 1, !tbaa !23  ; 2 uses
  %i.ej = and i8 %i.ei, 63
...
_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit42.thread: ; preds = %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit, %switch.early.test.i.i.i37, %switch.early.test.i.i.i37, %switch.early.test.i.i.i37, %_ZN3fmt3v126detail12needs_escapeEj.exit.i.i41
  ...
  store ptr %i.fx, ptr %.sroa.4.0..sroa_idx.i.i39, align 8, !tbaa !71
...
_ZZN3fmt3v126detail18for_each_codepointIZNS1_11find_escapeEPKcS4_EUljNS0_17basic_string_viewIcEEE_EEvS6_T_ENKUlS4_S4_E_clES4_S4_.exit42: ; preds = %_ZN3fmt3v126detail12needs_escapeEj.exit.i.i41
  ...
  br i1 %i.gc, label %_ZN3fmt3v126detail4copyIcPKcPcTnNSt9enable_ifIXntaasr23is_back_insert_iteratorIT1_EE5valueoosr41has_back_insert_iterator_container_appendIS7_T0_EE5valuesr48has_back_insert_iterator_container_insert_at_endIS7_S8_EE5valueEiE4typeELi0EEES7_S8_S8_S7_.exit, label %.loopexit73, !llvm.loop !962
...
bb.a:
  ...
  %i.a = load ptr, ptr %0, align 8, !tbaa !963, !nonnull !33
  %i.b = load i8, ptr %i.a, align 1, !tbaa !44, !range !32, !noundef !33
...
_ZN3fmt3v126detail12needs_escapeEj.exit.thread:   ; preds = %bb.b, %switch.early.test.i, %switch.early.test.i, %switch.early.test.i, %_ZN3fmt3v126detail12needs_escapeEj.exit
  call void @llvm.lifetime.start.p0(ptr nonnull %4) #39
end_hunk_3
begin_hunk_4_@_ZN11OpenImageIO4v3_17Strutil24extract_from_list_stringIfSaIfEEEiRSt6vectorIT_T0_ENS0_17basic_string_viewIcSt11char_traitsIcEEESC_:bb.a
bb.o:                                             ; preds = %bb.m
  %i.cn = icmp ugt i64 %i.ck, 1
  br i1 %i.cn, label %bb.p, label %_ZNSt6vectorIfSaIfEE6resizeEm.exit

bb.p:                                             ; preds = %bb.o
  %i.co = getelementptr inbounds nuw i8, ptr %i.cg, i64 4 ; 3 uses
...
_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i:        ; preds = %bb.p
  store ptr %i.co, ptr %i.a, align 8, !tbaa !83
...
_ZNSt6vectorIfSaIfEE6resizeEm.exit:               ; preds = %._ZNSt6vectorIfSaIfEE6resizeEm.exit_crit_edge, %_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i, %bb.p, %bb.o
  %.pre-phi = phi i64 [ %.pre47, %._ZNSt6vectorIfSaIfEE6resizeEm.exit_crit_edge ], [ %i.ci, %_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i ], [ %i.ci, %bb.p ], [ %i.ci, %bb.o ]
  %i.cp = phi ptr [ %.pre43, %._ZNSt6vectorIfSaIfEE6resizeEm.exit_crit_edge ], [ %i.co, %_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i ], [ %i.cf, %bb.p ], [ %i.cf, %bb.o ] ; 3 uses
  %i.cq = phi ptr [ %.pre, %._ZNSt6vectorIfSaIfEE6resizeEm.exit_crit_edge ], [ %i.cg, %_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i ], [ %i.cg, %bb.p ], [ %i.cg, %bb.o ] ; 2 uses
  %i.cr = ptrtoint ptr %i.cp to i64
  %i.cs = sub i64 %i.cr, %.pre-phi
  %i.ct = ashr exact i64 %i.cs, 2                 ; 3 uses
  %i.cu = icmp ugt i64 %i.g, %i.ct
  br i1 %i.cu, label %bb.q, label %bb.r

bb.q:                                             ; preds = %_ZNSt6vectorIfSaIfEE6resizeEm.exit
  %i.cv = sub nuw nsw i64 %i.g, %i.ct
  invoke void @_ZNSt6vectorIfSaIfEE14_M_fill_insertEN9__gnu_cxx17__normal_iteratorIPfS1_EEmRKf(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr %i.cp, i64 noundef %i.cv, ptr noundef nonnull align 4 dereferenceable(4) %i.cq)
          to label %_ZNSt6vectorIfSaIfEE6resizeEmRKf.exit unwind label %bb.h

bb.r:                                             ; preds = %_ZNSt6vectorIfSaIfEE6resizeEm.exit
  %i.cw = icmp ult i64 %i.g, %i.ct
  br i1 %i.cw, label %bb.s, label %_ZNSt6vectorIfSaIfEE6resizeEmRKf.exit

bb.s:                                             ; preds = %bb.r
  %i.cx = getelementptr inbounds nuw i8, ptr %i.cq, i64 %i.f ; 2 uses
  %.not.i.i29 = icmp eq ptr %i.cp, %i.cx
...
_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i30:      ; preds = %bb.s
  store ptr %i.cx, ptr %i.a, align 8, !tbaa !83
...
_ZNSt6vectorIfSaIfEE6resizeEmRKf.exit:            ; preds = %_ZSt8_DestroyIPffEvT_S1_RSaIT0_E.exit.i.i30, %bb.s, %bb.r, %bb.q, %._crit_edge
  %i.cy = load i64, ptr %i.j, align 8, !tbaa !12
  %i.cz = load ptr, ptr %i.p, align 8
  %i.da = load ptr, ptr %5, align 8               ; 3 uses
  %.not.i.i.i32 = icmp eq ptr %i.da, null
...
bb.t:                                             ; preds = %_ZNSt6vectorIfSaIfEE6resizeEmRKf.exit
  ...
  %i.de = ptrtoint ptr %i.da to i64               ; 2 uses
  %i.df = sub i64 %i.dd, %i.de
  call void @_ZdlPvm(ptr noundef nonnull %i.da, i64 noundef %i.df) #40
...
_ZNSt6vectorIN11OpenImageIO4v3_117basic_string_viewIcSt11char_traitsIcEEESaIS5_EED2Ev.exit: ; preds = %_ZNSt6vectorIfSaIfEE6resizeEmRKf.exit, %bb.t
  %.pre-phi49 = phi i64 [ %i.de, %bb.t ], [ 0, %_ZNSt6vectorIfSaIfEE6resizeEmRKf.exit ]
  %.not = icmp eq i64 %i.cy, 0
  %i.dg = ptrtoint ptr %i.cz to i64
  %i.dh = sub i64 %i.dg, %.pre-phi49
  %i.di = lshr exact i64 %i.dh, 4
  %i.dj = trunc i64 %i.di to i32
  %i.dk = select i1 %.not, i32 0, i32 %i.dj
  call void @llvm.lifetime.end.p0(ptr nonnull %5) #39
  ret i32 %i.dk

.loopexit:                                        ; preds = %.loopexit.split-lp, %.loopexit.split.us, %.loopexit.split, %bb.h
  %.pn = phi { ptr, i32 } [ %i.bh, %bb.h ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp ], [ %lpad.loopexit, %.loopexit.split ], [ %lpad.loopexit.us, %.loopexit.split.us ]
  %i.dl = load ptr, ptr %5, align 8, !tbaa !97    ; 3 uses
  %.not.i.i.i33 = icmp eq ptr %i.dl, null
...
bb.u:                                             ; preds = %.loopexit
  ...
  call void @_ZdlPvm(ptr noundef nonnull %i.dl, i64 noundef %i.dq) #40
...
; Function Attrs: mustprogress uwtable
define linkonce_odr void @_ZNSt6vectorIfSaIfEE17_M_default_appendEm(ptr noundef nonnull align 8 dereferenceable(24) %0, i64 noundef %1) local_unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %.not = icmp eq i64 %1, 0
...
bb.c:                                             ; preds = %bb.b
  store float 0.000000e+00, ptr %i.b, align 4, !tbaa !73
...
_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i: ; preds = %bb.c
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.p, i8 0, i64 %.idx.i.i.i.i.i, i1 false), !tbaa !73
...
_ZSt27__uninitialized_default_n_aIPfmfET_S1_T0_RSaIT1_E.exit: ; preds = %bb.c, %_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i
  ...
  store ptr %.0.i.i.i, ptr %i.a, align 8, !tbaa !83
  br label %bb.h
...
bb.e:                                             ; preds = %bb.d
  tail call void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.161) #42
  unreachable
...
_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit:    ; preds = %bb.d
  ...
  %i.x = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.w) #44 ; 4 uses
  %i.y = getelementptr inbounds nuw i8, ptr %i.x, i64 %i.f ; 3 uses
  store float 0.000000e+00, ptr %i.y, align 4, !tbaa !73
...
_ZSt6fill_nIPfmfET_S1_T0_RKT1_.exit.loopexit.i.i.i30: ; preds = %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit
  ...
  tail call void @llvm.memset.p0.i64(ptr align 4 %i.ab, i8 0, i64 %.idx.i.i.i.i.i31, i1 false), !tbaa !73
...
_ZNSt12_Vector_baseIfSaIfEE13_M_deallocateEPfm.exit36: ; preds = %_ZNSt6vectorIfSaIfEE11_S_relocateEPfS2_S2_RS0_.exit, %bb.g
  store ptr %i.x, ptr %0, align 8, !tbaa !15
  %i.ae = getelementptr inbounds nuw [4 x i8], ptr %i.y, i64 %1
  store ptr %i.ae, ptr %i.a, align 8, !tbaa !83
  %i.af = getelementptr inbounds nuw [4 x i8], ptr %i.x, i64 %i.v
  store ptr %i.af, ptr %i.h, align 8, !tbaa !18
  br label %bb.h
...
; Function Attrs: mustprogress uwtable
define linkonce_odr void @_ZNSt6vectorIfSaIfEE14_M_fill_insertEN9__gnu_cxx17__normal_iteratorIPfS1_EEmRKf(ptr noundef nonnull align 8 dereferenceable(24) %0, ptr %1, i64 noundef %2, ptr noundef nonnull align 4 dereferenceable(4) %3) local_unnamed_addr #2 align 2 personality ptr @__gxx_personality_v0 {
bb.a:
  %.not = icmp eq i64 %2, 0
...
bb.b:                                             ; preds = %bb.a
  ...
  %i.d = load ptr, ptr %i.c, align 8, !tbaa !83   ; 15 uses
...
bb.c:                                             ; preds = %bb.b
  %i.i = load float, ptr %3, align 4, !tbaa !73   ; 6 uses
...
bb.g:                                             ; preds = %bb.f
  %i.s = load float, ptr %i.o, align 4, !tbaa !73
  store float %i.s, ptr %i.d, align 4, !tbaa !73
  br label %_ZSt22__uninitialized_move_aIPfS0_SaIfEET0_T_S3_S2_RT1_.exit
...
_ZSt22__uninitialized_move_aIPfS0_SaIfEET0_T_S3_S2_RT1_.exit: ; preds = %bb.g, %bb.f, %bb.e
  ...
  store ptr %i.u, ptr %i.c, align 8, !tbaa !83
  %i.v = sub i64 %i.p, %i.j                       ; 3 uses
  %i.w = ashr exact i64 %i.v, 2                   ; 2 uses
  %i.x = icmp sgt i64 %i.w, 1
  br i1 %i.x, label %bb.h, label %bb.i, !prof !347
...
bb.j:                                             ; preds = %bb.i
  ...
  %i.ac = load float, ptr %1, align 4, !tbaa !73
  store float %i.ac, ptr %i.ab, align 4, !tbaa !73
  br label %bb.k
...
vector.body133:                                   ; preds = %vector.body133, %vector.ph128
  ...
  store <4 x float> %broadcast.splat132, ptr %next.gep135, align 4, !tbaa !73
  store <4 x float> %broadcast.splat132, ptr %i.ak, align 4, !tbaa !73
  %index.next136 = add nuw i64 %index134, 8       ; 2 uses
  %i.al = icmp eq i64 %index.next136, %n.vec130
  br i1 %i.al, label %middle.block137, label %vector.body133, !llvm.loop !1000
...
.lr.ph.i.i.i:                                     ; preds = %.lr.ph.i.i.i.preheader, %.lr.ph.i.i.i
  ...
  store float %i.i, ptr %.07.i.i.i, align 4, !tbaa !73
  %i.am = getelementptr inbounds nuw i8, ptr %.07.i.i.i, i64 4 ; 2 uses
  %.not.i.i.i = icmp eq ptr %i.am, %i.ad
  br i1 %.not.i.i.i, label %_ZSt4fillIPffEvT_S1_RKT0_.exit, label %.lr.ph.i.i.i, !llvm.loop !1001
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  store <4 x float> %broadcast.splat, ptr %next.gep, align 4, !tbaa !73
  store <4 x float> %broadcast.splat, ptr %i.ay, align 4, !tbaa !73
  %index.next = add nuw i64 %index, 8             ; 2 uses
  %i.az = icmp eq i64 %index.next, %n.vec
  br i1 %i.az, label %middle.block, label %vector.body, !llvm.loop !1002
...
.lr.ph.i.i.i.i.i.i.i:                             ; preds = %.lr.ph.i.i.i.i.i.i.i.preheader, %.lr.ph.i.i.i.i.i.i.i
  ...
  store float %i.i, ptr %.07.i.i.i.i.i.i.i, align 4, !tbaa !73
  %i.ba = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i.i.i.i, i64 4 ; 2 uses
  %.not.i.i.i.i.i.i.i = icmp eq ptr %i.ba, %i.ap
  br i1 %.not.i.i.i.i.i.i.i, label %_ZSt24__uninitialized_fill_n_aIPfmffET_S1_T0_RKT1_RSaIT2_E.exit, label %.lr.ph.i.i.i.i.i.i.i, !llvm.loop !1003
...
_ZSt24__uninitialized_fill_n_aIPfmffET_S1_T0_RKT1_RSaIT2_E.exit: ; preds = %.lr.ph.i.i.i.i.i.i.i, %middle.block, %bb.l
  ...
  br i1 %i.bb, label %bb.n, label %bb.o, !prof !347
...
bb.p:                                             ; preds = %bb.o
  %i.bd = load float, ptr %1, align 4, !tbaa !73
  store float %i.bd, ptr %.0.i.i.i.i.i, align 4, !tbaa !73
  br label %_ZSt22__uninitialized_move_aIPfS0_SaIfEET0_T_S3_S2_RT1_.exit69
...
vector.body119:                                   ; preds = %vector.body119, %vector.ph114
  ...
  store <4 x float> %broadcast.splat118, ptr %next.gep121, align 4, !tbaa !73
  store <4 x float> %broadcast.splat118, ptr %i.bn, align 4, !tbaa !73
  %index.next122 = add nuw i64 %index120, 8       ; 2 uses
  %i.bo = icmp eq i64 %index.next122, %n.vec116
  br i1 %i.bo, label %middle.block123, label %vector.body119, !llvm.loop !1004
...
.lr.ph.i.i.i71:                                   ; preds = %.lr.ph.i.i.i71.preheader154, %.lr.ph.i.i.i71
  ...
  store float %i.i, ptr %.07.i.i.i72, align 4, !tbaa !73
  %i.bp = getelementptr inbounds nuw i8, ptr %.07.i.i.i72, i64 4 ; 2 uses
  %.not.i.i.i73 = icmp eq ptr %i.bp, %i.d
  br i1 %.not.i.i.i73, label %_ZSt4fillIPffEvT_S1_RKT0_.exit, label %.lr.ph.i.i.i71, !llvm.loop !1005

bb.q:                                             ; preds = %bb.b
  %i.bq = load ptr, ptr %0, align 8, !tbaa !15    ; 5 uses
...
bb.r:                                             ; preds = %bb.q
  tail call void @_ZSt20__throw_length_errorPKc(ptr noundef nonnull @.str.162) #42
  unreachable
...
bb.s:                                             ; preds = %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit
  ...
  %i.cd = tail call noalias noundef nonnull ptr @_Znwm(i64 noundef %i.cc) #44
  br label %bb.t
...
bb.t:                                             ; preds = %bb.s, %_ZNKSt6vectorIfSaIfEE12_M_check_lenEmPKc.exit
  ...
  %i.ch = load float, ptr %3, align 4, !tbaa !73  ; 2 uses
...
vector.body147:                                   ; preds = %vector.body147, %vector.ph142
  ...
  store <4 x float> %broadcast.splat146, ptr %next.gep149, align 4, !tbaa !73
  store <4 x float> %broadcast.splat146, ptr %i.co, align 4, !tbaa !73
  %index.next150 = add nuw i64 %index148, 8       ; 2 uses
  %i.cp = icmp eq i64 %index.next150, %n.vec144
  br i1 %i.cp, label %middle.block151, label %vector.body147, !llvm.loop !1006
...
.lr.ph.i.i.i.i.i.i.i76:                           ; preds = %.lr.ph.i.i.i.i.i.i.i76.preheader, %.lr.ph.i.i.i.i.i.i.i76
  ...
  store float %i.ch, ptr %.07.i.i.i.i.i.i.i77, align 4, !tbaa !73
  %i.cq = getelementptr inbounds nuw i8, ptr %.07.i.i.i.i.i.i.i77, i64 4 ; 2 uses
  %.not.i.i.i.i.i.i.i78 = icmp eq ptr %i.cq, %i.cg
  br i1 %.not.i.i.i.i.i.i.i78, label %_ZSt24__uninitialized_fill_n_aIPfmffET_S1_T0_RKT1_RSaIT2_E.exit80, label %.lr.ph.i.i.i.i.i.i.i76, !llvm.loop !1007
...
_ZSt24__uninitialized_fill_n_aIPfmffET_S1_T0_RKT1_RSaIT2_E.exit80: ; preds = %.lr.ph.i.i.i.i.i.i.i76, %middle.block151
  ...
  br i1 %i.cr, label %bb.u, label %bb.v, !prof !347
...
bb.w:                                             ; preds = %bb.v
  %i.ct = load float, ptr %i.bq, align 4, !tbaa !73
  store float %i.ct, ptr %i.ce, align 4, !tbaa !73
  br label %_ZSt34__uninitialized_move_if_noexcept_aIPfS0_SaIfEET0_T_S3_S2_RT1_.exit
...
_ZSt34__uninitialized_move_if_noexcept_aIPfS0_SaIfEET0_T_S3_S2_RT1_.exit: ; preds = %bb.w, %bb.v, %bb.u
  ...
  br i1 %i.cw, label %bb.x, label %bb.y, !prof !347
...
bb.z:                                             ; preds = %bb.y
  %i.cy = load float, ptr %1, align 4, !tbaa !73
  store float %i.cy, ptr %i.cu, align 4, !tbaa !73
  br label %bb.aa
