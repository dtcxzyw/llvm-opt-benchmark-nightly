...
vector.body119:                                   ; preds = %bb.m, %bb.l
  ...
  %i.it = shufflevector <2 x double> <double 1.000000e+00, double f0x3FF63150B14861EF>, <2 x double> %i.gx, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %1 = shufflevector <2 x double> %i.hf, <2 x double> %i.hn, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %2 = shufflevector <4 x double> %i.it, <4 x double> %1, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.iu = shufflevector <2 x double> %i.gp, <2 x double> splat (double f0x3FF63150B14861EF), <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %3 = shufflevector <4 x double> %i.iu, <4 x double> <double f0x3FF4E7AE914D6FCA, double f0x3FF4E7AE914D6FCA, double f0x3FF2D062EF6C11AA, double f0x3FF2D062EF6C11AA>, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %4 = fmul <8 x double> %2, %3
  %i.iv = fmul <8 x double> %4, splat (double 8.000000e+00)
  %i.iw = fdiv <8 x double> splat (double 1.000000e+00), %i.iv
  %i.ix = fptrunc <8 x double> %i.iw to <8 x float>
  %i.iy = shufflevector <2 x double> <double 1.000000e+00, double f0x3FF63150B14861EF>, <2 x double> %i.ic, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %5 = shufflevector <2 x double> %i.ik, <2 x double> %i.is, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %6 = shufflevector <4 x double> %i.iy, <4 x double> %5, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.iz = shufflevector <2 x double> %i.hu, <2 x double> splat (double f0x3FE92469C0A7BF3B), <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %7 = shufflevector <4 x double> %i.iz, <4 x double> <double f0x3FE1517A7BC720BB, double f0x3FE1517A7BC720BB, double f0x3FD1A855DE72AB5D, double f0x3FD1A855DE72AB5D>, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %8 = fmul <8 x double> %6, %7
  %i.ja = fmul <8 x double> %8, splat (double 8.000000e+00)
  ...
  %i.lo = shufflevector <2 x double> <double f0x3FF4E7AE914D6FCA, double f0x3FF2D062EF6C11AA>, <2 x double> %i.js, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %9 = shufflevector <2 x double> %i.ka, <2 x double> %i.ki, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %10 = shufflevector <4 x double> %i.lo, <4 x double> %9, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.lp = shufflevector <2 x double> %i.jj, <2 x double> splat (double f0x3FF63150B14861EF), <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %11 = shufflevector <4 x double> %i.lp, <4 x double> <double f0x3FF4E7AE914D6FCA, double f0x3FF4E7AE914D6FCA, double f0x3FF2D062EF6C11AA, double f0x3FF2D062EF6C11AA>, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %12 = fmul <8 x double> %10, %11
  %i.lq = fmul <8 x double> %12, splat (double 8.000000e+00)
  %i.lr = fdiv <8 x double> splat (double 1.000000e+00), %i.lq
  %i.ls = fptrunc <8 x double> %i.lr to <8 x float>
  %i.lt = shufflevector <2 x double> <double f0x3FF4E7AE914D6FCA, double f0x3FF2D062EF6C11AA>, <2 x double> %i.kx, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %13 = shufflevector <2 x double> %i.lf, <2 x double> %i.ln, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %14 = shufflevector <4 x double> %i.lt, <4 x double> %13, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.lu = shufflevector <2 x double> %i.kp, <2 x double> splat (double f0x3FE92469C0A7BF3B), <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %15 = shufflevector <4 x double> %i.lu, <4 x double> <double f0x3FE1517A7BC720BB, double f0x3FE1517A7BC720BB, double f0x3FD1A855DE72AB5D, double f0x3FD1A855DE72AB5D>, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %16 = fmul <8 x double> %14, %15
  %i.lv = fmul <8 x double> %16, splat (double 8.000000e+00)
  ...
  %i.oj = shufflevector <2 x double> <double 1.000000e+00, double f0x3FE92469C0A7BF3B>, <2 x double> %i.mn, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %17 = shufflevector <2 x double> %i.mv, <2 x double> %i.nd, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %18 = shufflevector <4 x double> %i.oj, <4 x double> %17, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.ok = shufflevector <2 x double> %i.me, <2 x double> splat (double f0x3FF63150B14861EF), <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %19 = shufflevector <4 x double> %i.ok, <4 x double> <double f0x3FF4E7AE914D6FCA, double f0x3FF4E7AE914D6FCA, double f0x3FF2D062EF6C11AA, double f0x3FF2D062EF6C11AA>, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %20 = fmul <8 x double> %18, %19
  %i.ol = fmul <8 x double> %20, splat (double 8.000000e+00)
  %i.om = fdiv <8 x double> splat (double 1.000000e+00), %i.ol
  %i.on = fptrunc <8 x double> %i.om to <8 x float>
  %i.oo = shufflevector <2 x double> <double 1.000000e+00, double f0x3FE92469C0A7BF3B>, <2 x double> %i.ns, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %21 = shufflevector <2 x double> %i.oa, <2 x double> %i.oi, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %22 = shufflevector <4 x double> %i.oo, <4 x double> %21, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.op = shufflevector <2 x double> %i.nk, <2 x double> splat (double f0x3FE92469C0A7BF3B), <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %23 = shufflevector <4 x double> %i.op, <4 x double> <double f0x3FE1517A7BC720BB, double f0x3FE1517A7BC720BB, double f0x3FD1A855DE72AB5D, double f0x3FD1A855DE72AB5D>, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %24 = fmul <8 x double> %22, %23
  %i.oq = fmul <8 x double> %24, splat (double 8.000000e+00)
  ...
  %i.re = shufflevector <2 x double> <double f0x3FE1517A7BC720BB, double f0x3FD1A855DE72AB5D>, <2 x double> %i.pi, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %25 = shufflevector <2 x double> %i.pq, <2 x double> %i.py, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %26 = shufflevector <4 x double> %i.re, <4 x double> %25, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.rf = shufflevector <2 x double> %i.oz, <2 x double> splat (double f0x3FF63150B14861EF), <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %27 = shufflevector <4 x double> %i.rf, <4 x double> <double f0x3FF4E7AE914D6FCA, double f0x3FF4E7AE914D6FCA, double f0x3FF2D062EF6C11AA, double f0x3FF2D062EF6C11AA>, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %28 = fmul <8 x double> %26, %27
  %i.rg = fmul <8 x double> %28, splat (double 8.000000e+00)
  %i.rh = fdiv <8 x double> splat (double 1.000000e+00), %i.rg
  %i.ri = fptrunc <8 x double> %i.rh to <8 x float>
  %i.rj = shufflevector <2 x double> <double f0x3FE1517A7BC720BB, double f0x3FD1A855DE72AB5D>, <2 x double> %i.qn, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %29 = shufflevector <2 x double> %i.qv, <2 x double> %i.rd, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %30 = shufflevector <4 x double> %i.rj, <4 x double> %29, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %i.rk = shufflevector <2 x double> %i.qf, <2 x double> splat (double f0x3FE92469C0A7BF3B), <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %31 = shufflevector <4 x double> %i.rk, <4 x double> <double f0x3FE1517A7BC720BB, double f0x3FE1517A7BC720BB, double f0x3FD1A855DE72AB5D, double f0x3FD1A855DE72AB5D>, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %32 = fmul <8 x double> %30, %31
  %i.rl = fmul <8 x double> %32, splat (double 8.000000e+00)
