Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/oiio/original/invert?download=true
inline.NumInlined: 3
inline.NumDeleted: 3
...
bb.c:                                             ; preds = %._crit_edge126.split.us.i, %.lr.ph133.i
  ...
  %i.w = trunc i64 %indvars.iv.i to i32
  %i.x = sub i32 %i.q, %i.w
  %i.y = zext i32 %i.x to i64
  %i.z = shl nuw nsw i64 %i.y, 2                  ; 2 uses
  %i.aa = getelementptr inbounds nuw [4 x i8], ptr %.086130.i, i64 %indvars.iv.i ; 6 uses
...
.lr.ph110.preheader.i:                            ; preds = %bb.c
  %i.ab = trunc i64 %indvars.iv.i to i32
  %i.ac = sub i32 %2, %i.ab
  %i.ad = trunc nuw i64 %indvars.iv.i to i32      ; 4 uses
...
.lr.ph110.i.prol:                                 ; preds = %.lr.ph110.preheader.i
  %i.ae = load float, ptr %i.aa, align 4, !tbaa !12 ; 3 uses
  %i.af = fcmp ogt float %i.ae, 0.000000e+00
  %i.ag = fneg float %i.ae
  %i.ah = select i1 %i.af, float %i.ae, float %i.ag ; 2 uses
  %i.ai = fcmp ogt float %i.ah, 0.000000e+00      ; 2 uses
  %.296.i.prol = select i1 %i.ai, i32 %i.ad, i32 %.094128.i ; 2 uses
  %.188.i.prol = select i1 %i.ai, float %i.ah, float 0.000000e+00 ; 2 uses
  %i.aj = getelementptr inbounds nuw [4 x i8], ptr %i.aa, i64 %i.p
  %i.ak = add nuw i32 %i.ad, 1
...
.lr.ph110.i.prol.loopexit:                        ; preds = %.lr.ph110.i.prol, %.lr.ph110.preheader.i
  ...
  %.084109.i.unr = phi ptr [ %i.aa, %.lr.ph110.preheader.i ], [ %i.aj, %.lr.ph110.i.prol ]
  %.087108.i.unr = phi float [ 0.000000e+00, %.lr.ph110.preheader.i ], [ %.188.i.prol, %.lr.ph110.i.prol ]
  %.192107.i.unr = phi i32 [ %i.ad, %.lr.ph110.preheader.i ], [ %i.ak, %.lr.ph110.i.prol ]
  %.195106.i.unr = phi i32 [ %.094128.i, %.lr.ph110.preheader.i ], [ %.296.i.prol, %.lr.ph110.i.prol ]
  %i.al = icmp eq i32 %i.h, %i.t
  br i1 %i.al, label %._crit_edge.i, label %.lr.ph110.i

.lr.ph110.i:                                      ; preds = %.lr.ph110.i.prol.loopexit, %.lr.ph110.i
  %.084109.i = phi ptr [ %i.ay, %.lr.ph110.i ], [ %.084109.i.unr, %.lr.ph110.i.prol.loopexit ] ; 2 uses
  %.087108.i = phi float [ %.188.i.1, %.lr.ph110.i ], [ %.087108.i.unr, %.lr.ph110.i.prol.loopexit ] ; 2 uses
  %.192107.i = phi i32 [ %i.az, %.lr.ph110.i ], [ %.192107.i.unr, %.lr.ph110.i.prol.loopexit ] ; 3 uses
  %.195106.i = phi i32 [ %.296.i.1, %.lr.ph110.i ], [ %.195106.i.unr, %.lr.ph110.i.prol.loopexit ]
  %i.am = load float, ptr %.084109.i, align 4, !tbaa !12 ; 3 uses
  %i.an = fcmp ogt float %i.am, 0.000000e+00
  %i.ao = fneg float %i.am
  %i.ap = select i1 %i.an, float %i.am, float %i.ao ; 2 uses
  %i.aq = fcmp ogt float %i.ap, %.087108.i        ; 2 uses
  %.296.i = select i1 %i.aq, i32 %.192107.i, i32 %.195106.i
  %.188.i = select i1 %i.aq, float %i.ap, float %.087108.i ; 2 uses
  %i.ar = getelementptr inbounds nuw [4 x i8], ptr %.084109.i, i64 %i.p ; 2 uses
  %i.as = add nuw i32 %.192107.i, 1
  %i.at = load float, ptr %i.ar, align 4, !tbaa !12 ; 3 uses
  %i.au = fcmp ogt float %i.at, 0.000000e+00
  %i.av = fneg float %i.at
  %i.aw = select i1 %i.au, float %i.at, float %i.av ; 2 uses
  %i.ax = fcmp ogt float %i.aw, %.188.i           ; 2 uses
  %.296.i.1 = select i1 %i.ax, i32 %i.as, i32 %.296.i ; 2 uses
  %.188.i.1 = select i1 %i.ax, float %i.aw, float %.188.i ; 2 uses
  %i.ay = getelementptr inbounds nuw [4 x i8], ptr %i.ar, i64 %i.p
  %i.az = add nuw i32 %.192107.i, 2               ; 2 uses
  %exitcond140.not.i.1 = icmp eq i32 %i.az, %2
...
._crit_edge.i:                                    ; preds = %.lr.ph110.i, %.lr.ph110.i.prol.loopexit
  ...
  %i.ba = fcmp oeq float %.188.i.lcssa, 0.000000e+00
  br i1 %i.ba, label %.sink.split, label %bb.d

bb.d:                                             ; preds = %._crit_edge.i
  %i.bb = zext i32 %.296.i.lcssa to i64           ; 2 uses
  %.not.i = icmp eq i64 %indvars.iv.i, %i.bb
  br i1 %.not.i, label %bb.f, label %bb.e

bb.e:                                             ; preds = %bb.d
  %i.bc = getelementptr inbounds nuw [4 x i8], ptr %.198127.i, i64 %i.bb
  %i.bd = sub nsw i64 0, %indvars.iv.i
  %i.be = getelementptr inbounds [4 x i8], ptr %i.bc, i64 %i.bd ; 2 uses
...
bb.f:                                             ; preds = %bb.e, %bb.d
  %i.bl = load float, ptr %i.aa, align 4, !tbaa !12
  %i.bm = icmp ult i32 %.082131.i, %2
  br i1 %i.bm, label %.lr.ph125.i, label %._crit_edge126.split.us.i

.lr.ph125.i:                                      ; preds = %bb.f
  %i.bn = getelementptr inbounds nuw i8, ptr %i.aa, i64 4
  %i.bo = getelementptr inbounds nuw [4 x i8], ptr %i.aa, i64 %i.p
...
.lr.ph.i.i.preheader:                             ; preds = %.preheader.i.i
  %xtraiter78 = and i32 %.06171.i.i, 3            ; 3 uses
  %i.eb = icmp ult i32 %.06171.i.i, 4
  br i1 %i.eb, label %.lr.ph.i.i.epil.preheader, label %.lr.ph.i.i.preheader.new

.lr.ph.i.i.preheader.new:                         ; preds = %.lr.ph.i.i.preheader
  %unroll_iter = and i32 %.06171.i.i, -4
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %.lr.ph.i.i, %.lr.ph.i.i.preheader.new
  %.05170.i.i = phi ptr [ %.05073.i.i, %.lr.ph.i.i.preheader.new ], [ %i.er, %.lr.ph.i.i ] ; 5 uses
  %.05569.i.i = phi ptr [ %i.do, %.lr.ph.i.i.preheader.new ], [ %i.et, %.lr.ph.i.i ] ; 5 uses
  %.05768.i.i = phi float [ 0.000000e+00, %.lr.ph.i.i.preheader.new ], [ %i.ev, %.lr.ph.i.i ]
  %niter = phi i32 [ 0, %.lr.ph.i.i.preheader.new ], [ %niter.next.3, %.lr.ph.i.i ]
  %i.ec = getelementptr inbounds nuw i8, ptr %.05170.i.i, i64 4
  %i.ed = load float, ptr %.05170.i.i, align 4, !tbaa !12
  %i.ee = getelementptr inbounds nuw i8, ptr %.05569.i.i, i64 4
  %i.ef = load float, ptr %.05569.i.i, align 4, !tbaa !12
end_hunk_0
