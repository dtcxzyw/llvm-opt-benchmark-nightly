...
begin_hunk_0_@_ZNK27OpenImageIO_v3_1_Imf__3_3_57RgbaLut5applyEPNS_4RgbaEiiRKN9Imath_3_13BoxINS3_4Vec2IiEEEE:bb.a
  ...
  %exitcond175.not.1 = icmp eq i32 %i.mo, %i.l
  br i1 %exitcond175.not.1, label %._crit_edge.split.split.us.us.split.split, label %.lr.ph.us72.new, !llvm.loop !42

._crit_edge.split.split.us.us.split.split:        ; preds = %.lr.ph.us72.new, %.prol.loopexit259
  %i.mz = getelementptr inbounds [8 x i8], ptr %.065.us73, i64 %i.s
  %i.na = add i32 %.03364.us74, 1
  %exitcond176.not = icmp eq i32 %.03364.us74, %i.g
  br i1 %exitcond176.not, label %._crit_edge68, label %.lr.ph.us72, !llvm.loop !43
...
.lr.ph67.split.split.split.split.us:              ; preds = %.lr.ph67.split.split.split
  br i1 %.not40, label %.lr.ph.us76.us.preheader, label %.lr.ph.us76.preheader

.lr.ph.us76.preheader:                            ; preds = %.lr.ph67.split.split.split.split.us
...
.lr.ph.us76.us.preheader:                         ; preds = %.lr.ph67.split.split.split.split.us
  %i.nf = add i32 %i.l, %i.i
  %i.ng = and i32 %i.nf, 1
  %lcmp.mod257.not.not = icmp eq i32 %i.ng, 0
  %i.nh = add i32 %i.i, 1
  %i.ni = icmp eq i32 %i.l, %i.i
  br label %.lr.ph.us76.us

.lr.ph.us76.us:                                   ; preds = %.lr.ph.us76.us.preheader, %._crit_edge.split.split.split.us.split.us.us.us
  %.065.us77.us = phi ptr [ %i.of, %._crit_edge.split.split.split.us.split.us.us.us ], [ %i.e, %.lr.ph.us76.us.preheader ] ; 2 uses
  %.03364.us78.us = phi i32 [ %i.og, %._crit_edge.split.split.split.us.split.us.us.us ], [ %i.b, %.lr.ph.us76.us.preheader ] ; 2 uses
  %i.nj = getelementptr inbounds [8 x i8], ptr %.065.us77.us, i64 %i.k ; 5 uses
  %i.nk = load ptr, ptr %0, align 8               ; 6 uses
  br i1 %lcmp.mod257.not.not, label %.prol.loopexit255.unr-lcssa, label %.prol.loopexit255

.prol.loopexit255.unr-lcssa:                      ; preds = %.lr.ph.us76.us
  ...
  br label %.prol.loopexit255

.prol.loopexit255:                                ; preds = %.prol.loopexit255.unr-lcssa, %.lr.ph.us76.us
  %.03446.us54.us.us.us.unr = phi ptr [ %i.nj, %.lr.ph.us76.us ], [ %i.nq, %.prol.loopexit255.unr-lcssa ]
  %.03545.us55.us.us.us.unr = phi i32 [ %i.i, %.lr.ph.us76.us ], [ %i.nh, %.prol.loopexit255.unr-lcssa ]
  br i1 %i.ni, label %._crit_edge.split.split.split.us.split.us.us.us, label %.lr.ph.us76.us.new

.lr.ph.us76.us.new:                               ; preds = %.prol.loopexit255, %.lr.ph.us76.us.new
  %.03446.us54.us.us.us = phi ptr [ %i.od, %.lr.ph.us76.us.new ], [ %.03446.us54.us.us.us.unr, %.prol.loopexit255 ] ; 4 uses
  %.03545.us55.us.us.us = phi i32 [ %i.oe, %.lr.ph.us76.us.new ], [ %.03545.us55.us.us.us.unr, %.prol.loopexit255 ] ; 2 uses
  ...
  %exitcond173.not.1 = icmp eq i32 %i.nx, %i.l
  br i1 %exitcond173.not.1, label %._crit_edge.split.split.split.us.split.us.us.us, label %.lr.ph.us76.us.new, !llvm.loop !42

._crit_edge.split.split.split.us.split.us.us.us:  ; preds = %.lr.ph.us76.us.new, %.prol.loopexit255
  %i.of = getelementptr inbounds [8 x i8], ptr %.065.us77.us, i64 %i.s
  %i.og = add i32 %.03364.us78.us, 1
  %exitcond174.not = icmp eq i32 %.03364.us78.us, %i.g
  br i1 %exitcond174.not, label %._crit_edge68, label %.lr.ph.us76.us, !llvm.loop !43

.lr.ph.us76:                                      ; preds = %.lr.ph.us76.preheader, %._crit_edge.split.split.split.us.split.us87
  %.065.us77 = phi ptr [ %i.pm, %._crit_edge.split.split.split.us.split.us87 ], [ %i.e, %.lr.ph.us76.preheader ] ; 2 uses
  %.03364.us78 = phi i32 [ %i.pn, %._crit_edge.split.split.split.us.split.us87 ], [ %i.b, %.lr.ph.us76.preheader ] ; 2 uses
  %i.oh = getelementptr inbounds [8 x i8], ptr %.065.us77, i64 %i.k ; 6 uses
  %i.oi = load ptr, ptr %0, align 8               ; 9 uses
  br i1 %lcmp.mod.not.not, label %.prol.loopexit.unr-lcssa, label %.prol.loopexit

.prol.loopexit.unr-lcssa:                         ; preds = %.lr.ph.us76
  %.sroa.06.0.copyload.us56.us82.prol = load i16, ptr %i.oh, align 2, !tbaa !11
  %i.oj = zext i16 %.sroa.06.0.copyload.us56.us82.prol to i64
  %i.ok = getelementptr inbounds nuw [2 x i8], ptr %i.oi, i64 %i.oj
  %.sroa.0.0.copyload.i.us57.us83.prol = load i16, ptr %i.ok, align 2, !tbaa !11
  store i16 %.sroa.0.0.copyload.i.us57.us83.prol, ptr %i.oh, align 2, !tbaa !11
  %i.ol = getelementptr inbounds nuw i8, ptr %i.oh, i64 2 ; 2 uses
  %.sroa.04.0.copyload.us58.us84.prol = load i16, ptr %i.ol, align 2, !tbaa !11
  %i.om = zext i16 %.sroa.04.0.copyload.us58.us84.prol to i64
  %i.on = getelementptr inbounds nuw [2 x i8], ptr %i.oi, i64 %i.om
  %.sroa.0.0.copyload.i41.us59.us85.prol = load i16, ptr %i.on, align 2, !tbaa !11
  store i16 %.sroa.0.0.copyload.i41.us59.us85.prol, ptr %i.ol, align 2, !tbaa !11
...
.prol.loopexit:                                   ; preds = %.prol.loopexit.unr-lcssa, %.lr.ph.us76
  %.03446.us54.us80.unr = phi ptr [ %i.oh, %.lr.ph.us76 ], [ %i.or, %.prol.loopexit.unr-lcssa ]
  %.03545.us55.us81.unr = phi i32 [ %i.i, %.lr.ph.us76 ], [ %i.nd, %.prol.loopexit.unr-lcssa ]
  br i1 %i.ne, label %._crit_edge.split.split.split.us.split.us87, label %.lr.ph.us76.new

.lr.ph.us76.new:                                  ; preds = %.prol.loopexit, %.lr.ph.us76.new
  %.03446.us54.us80 = phi ptr [ %i.pk, %.lr.ph.us76.new ], [ %.03446.us54.us80.unr, %.prol.loopexit ] ; 5 uses
  %.03545.us55.us81 = phi i32 [ %i.pl, %.lr.ph.us76.new ], [ %.03545.us55.us81.unr, %.prol.loopexit ] ; 2 uses
  %.sroa.06.0.copyload.us56.us82 = load i16, ptr %.03446.us54.us80, align 2, !tbaa !11
  %i.os = zext i16 %.sroa.06.0.copyload.us56.us82 to i64
  %i.ot = getelementptr inbounds nuw [2 x i8], ptr %i.oi, i64 %i.os
  %.sroa.0.0.copyload.i.us57.us83 = load i16, ptr %i.ot, align 2, !tbaa !11
  store i16 %.sroa.0.0.copyload.i.us57.us83, ptr %.03446.us54.us80, align 2, !tbaa !11
  %i.ou = getelementptr inbounds nuw i8, ptr %.03446.us54.us80, i64 2 ; 2 uses
  %.sroa.04.0.copyload.us58.us84 = load i16, ptr %i.ou, align 2, !tbaa !11
  %i.ov = zext i16 %.sroa.04.0.copyload.us58.us84 to i64
  %i.ow = getelementptr inbounds nuw [2 x i8], ptr %i.oi, i64 %i.ov
  %.sroa.0.0.copyload.i41.us59.us85 = load i16, ptr %i.ow, align 2, !tbaa !11
  store i16 %.sroa.0.0.copyload.i41.us59.us85, ptr %i.ou, align 2, !tbaa !11
  %i.ox = getelementptr inbounds nuw i8, ptr %.03446.us54.us80, i64 6 ; 2 uses
  ...
  %i.pa = getelementptr inbounds [8 x i8], ptr %.03446.us54.us80, i64 %i.r ; 5 uses
  %i.pb = add i32 %.03545.us55.us81, 1
  %.sroa.06.0.copyload.us56.us82.1 = load i16, ptr %i.pa, align 2, !tbaa !11
  %i.pc = zext i16 %.sroa.06.0.copyload.us56.us82.1 to i64
  %i.pd = getelementptr inbounds nuw [2 x i8], ptr %i.oi, i64 %i.pc
  %.sroa.0.0.copyload.i.us57.us83.1 = load i16, ptr %i.pd, align 2, !tbaa !11
  store i16 %.sroa.0.0.copyload.i.us57.us83.1, ptr %i.pa, align 2, !tbaa !11
  %i.pe = getelementptr inbounds nuw i8, ptr %i.pa, i64 2 ; 2 uses
  %.sroa.04.0.copyload.us58.us84.1 = load i16, ptr %i.pe, align 2, !tbaa !11
  %i.pf = zext i16 %.sroa.04.0.copyload.us58.us84.1 to i64
  %i.pg = getelementptr inbounds nuw [2 x i8], ptr %i.oi, i64 %i.pf
  %.sroa.0.0.copyload.i41.us59.us85.1 = load i16, ptr %i.pg, align 2, !tbaa !11
  store i16 %.sroa.0.0.copyload.i41.us59.us85.1, ptr %i.pe, align 2, !tbaa !11
  ...
  %i.pl = add i32 %.03545.us55.us81, 2
  %exitcond171.not.1 = icmp eq i32 %i.pb, %i.l
  br i1 %exitcond171.not.1, label %._crit_edge.split.split.split.us.split.us87, label %.lr.ph.us76.new, !llvm.loop !42

._crit_edge.split.split.split.us.split.us87:      ; preds = %.lr.ph.us76.new, %.prol.loopexit
  %i.pm = getelementptr inbounds [8 x i8], ptr %.065.us77, i64 %i.s
  %i.pn = add i32 %.03364.us78, 1
  %exitcond172.not = icmp eq i32 %.03364.us78, %i.g
  br i1 %exitcond172.not, label %._crit_edge68, label %.lr.ph.us76, !llvm.loop !43
...
._crit_edge.split.split.split:                    ; preds = %bb.d
  ...
  %exitcond170.not = icmp eq i32 %.03364, %i.g
  br i1 %exitcond170.not, label %._crit_edge68, label %.lr.ph, !llvm.loop !43
