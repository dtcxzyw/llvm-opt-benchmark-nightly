begin_hunk_0
  ...
  %11 = alloca %"struct.OpenImageIO::v3_1::ROI", align 8 ; 6 uses
...
begin_hunk_1
  ...
  %.sroa.gep447 = getelementptr inbounds nuw i8, ptr %2, i64 16 ; 6 uses
...
begin_hunk_2
  ...
  %.sroa.5207.0.copyload = phi i32 [ %.sroa.9.0.copyload192, %bb.e ], [ %i.p, %bb.d ] ; 10 uses
  %.sroa.6208.0.copyload = phi i32 [ %.sroa.10.0.copyload194, %bb.e ], [ %i.s, %bb.d ] ; 9 uses
...
.lr.ph:                                           ; preds = %_ZNSt6vectorIfSaIfEEC2EmRKfRKS0_.exit91
  %13 = load i64, ptr %2, align 8                 ; 4 uses
...
begin_hunk_4
  ...
  %.fr = freeze i1 %i.cu
  %14 = lshr i64 %13, 32
  %15 = trunc nuw i64 %14 to i32                  ; 4 uses
  %16 = trunc i64 %13 to i32                      ; 4 uses
...
.loopexit267:                                     ; preds = %.loopexit266.a, %bb.u, %.lr.ph.i.i.i.i.i.i, %.lr.ph.split.us, %_ZNSt6vectorIfSaIfEEC2EmRKfRKS0_.exit91
  %.promoted = phi i32 [ %16, %.lr.ph.split.us ], [ %.sroa.0204.0.copyload, %_ZNSt6vectorIfSaIfEEC2EmRKfRKS0_.exit91 ], [ %16, %.lr.ph.i.i.i.i.i.i ], [ %16, %bb.u ], [ %16, %.loopexit266.a ] ; 6 uses
  %.sroa.6.0..sroa_idx184.promoted = phi i32 [ %15, %.lr.ph.split.us ], [ %.sroa.2205.0.copyload, %_ZNSt6vectorIfSaIfEEC2EmRKfRKS0_.exit91 ], [ %15, %.lr.ph.i.i.i.i.i.i ], [ %15, %bb.u ], [ %15, %.loopexit266.a ] ; 5 uses
...
.lr.ph282.split.us:                               ; preds = %.lr.ph282
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.625.0..sroa_idx26, ptr noundef nonnull align 8 dereferenceable(16) %.sroa.gep447, i64 16, i1 false)
...
.preheader:                                       ; preds = %_ZStneIfSaIfEEbRKSt6vectorIT_T0_ES6_.exit109.thread220
  %i.fz = icmp slt i32 %.sroa.5207.0.copyload, %.sroa.6208.0.copyload
...
.lr.ph305.split.us:                               ; preds = %.lr.ph305
  %i.gh = add nsw i32 %.sroa.6208.0.copyload, -1
  ...
  store i32 %i.gh, ptr %.sroa.55.0..sroa_idx6, align 8, !tbaa !3
...
.lr.ph305.split:                                  ; preds = %.lr.ph305, %.loopexit254
  %i.gk = phi i32 [ %i.gl, %.loopexit254 ], [ %.sroa.6208.0.copyload, %.lr.ph305 ] ; 3 uses
...
.loopexit255:                                     ; preds = %.loopexit254, %bb.ak, %.lr.ph.i.i.i.i.i.i111, %.lr.ph305.split.us, %.preheader
  %i.gu = phi i32 [ %.sroa.6208.0.copyload, %.lr.ph305.split.us ], [ %.sroa.6208.0.copyload, %.preheader ], [ %i.gk, %.lr.ph.i.i.i.i.i.i111 ], [ %.sroa.5207.0.copyload, %.loopexit254 ], [ %i.gk, %bb.ak ] ; 2 uses
  %i.gv = icmp slt i32 %.sroa.5207.0.copyload, %i.gu
  br i1 %i.gv, label %.lr.ph312, label %.loopexit252

.lr.ph312:                                        ; preds = %.loopexit255
  %17 = load i64, ptr %.sroa.gep453, align 8      ; 2 uses
...
.lr.ph312.split.us:                               ; preds = %.lr.ph312
  %i.hd = add nsw i32 %.sroa.5207.0.copyload, 1
  ...
  store i64 %17, ptr %.sroa.6.0..sroa_idx3, align 8
...
.lr.ph312.split:                                  ; preds = %.lr.ph312, %.loopexit251
  %i.hg = phi i32 [ %i.hh, %.loopexit251 ], [ %.sroa.5207.0.copyload, %.lr.ph312 ]
...
_ZNSt6vectorIfSaIfEED2Ev.exit123:                 ; preds = %_ZNSt6vectorIfSaIfEED2Ev.exit123.loopexit, %.lr.ph.i, %bb.g, %bb.ar, %_ZNSt6vectorIfSaIfEED2Ev.exit
...
begin_hunk_17
  ...
  %6 = load i64, ptr %i.k, align 4
  %.sroa.6.0..sroa_idx.i.i.i = getelementptr inbounds nuw i8, ptr %i.k, i64 16
  %.sroa.6.0..sroa_idx5.i.i.i = getelementptr inbounds nuw i8, ptr %5, i64 16
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(16) %.sroa.6.0..sroa_idx5.i.i.i, ptr noundef nonnull align 4 dereferenceable(16) %.sroa.6.0..sroa_idx.i.i.i, i64 16, i1 false)
...
begin_hunk_18
  ...
  store i32 %i.l, ptr %.sroa.4.0..sroa_idx1.i.i.i, align 8, !tbaa !3
  %.sroa.5.0..sroa_idx3.i.i.i = getelementptr inbounds nuw i8, ptr %5, i64 12
  store i32 %i.m, ptr %.sroa.5.0..sroa_idx3.i.i.i, align 4, !tbaa !3
