...
.lr.ph:                                           ; preds = %_ZNSt6vectorIfSaIfEEC2EmRKfRKS0_.exit91
  %13 = load i64, ptr %2, align 8                 ; 3 uses
...
.loopexit267.a:                                   ; preds = %.loopexit266, %bb.u, %.lr.ph.i.i.i.i.i.i, %.lr.ph.split.us, %_ZNSt6vectorIfSaIfEEC2EmRKfRKS0_.exit91
  %.promoted = phi i32 [ %16, %.lr.ph.split.us ], [ %.sroa.0204.0.copyload, %_ZNSt6vectorIfSaIfEEC2EmRKfRKS0_.exit91 ], [ %16, %.lr.ph.i.i.i.i.i.i ], [ %16, %bb.u ], [ %16, %.loopexit266 ] ; 6 uses
  %.sroa.6.0..sroa_idx184.promoted = phi i32 [ %15, %.lr.ph.split.us ], [ %.sroa.2205.0.copyload, %_ZNSt6vectorIfSaIfEEC2EmRKfRKS0_.exit91 ], [ %15, %.lr.ph.i.i.i.i.i.i ], [ %15, %bb.u ], [ %15, %.loopexit266 ] ; 5 uses
...
.lr.ph312:                                        ; preds = %.loopexit255.a
  %17 = load i64, ptr %.sroa.gep453, align 8
