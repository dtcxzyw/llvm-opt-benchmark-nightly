...
.lr.ph312:                                        ; preds = %.loopexit255
  %i.ha = load i64, ptr %.sroa.gep453, align 8
...
.lr.ph73.split.us:                                ; preds = %.lr.ph73
  br i1 %.not, label %.lr.ph73.split.us.split.us, label %.lr.ph.us

.lr.ph73.split.us.split.us:                       ; preds = %.lr.ph73.split.us
...
.lr.ph.us.us:                                     ; preds = %._crit_edge.split.us.us.us, %.lr.ph73.split.us.split.us
  %.03770.us.us = phi i32 [ %i.aa, %.lr.ph73.split.us.split.us ], [ %i.as, %._crit_edge.split.us.us.us ] ; 2 uses
