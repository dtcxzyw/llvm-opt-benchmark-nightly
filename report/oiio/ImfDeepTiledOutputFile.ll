...
begin_hunk_0_@_ZN27OpenImageIO_v3_1_Imf__3_3_519DeepTiledOutputFile10writeTilesEiiiiii:bb.a
  ...
  %reass.sub = sub nuw nsw i32 %spec.select214, %spec.select215
  %i.bi = add nuw nsw i32 %reass.sub, 1
  %reass.sub278 = sub nuw nsw i32 %.0211, %.0210
  %i.bj = add nuw nsw i32 %reass.sub278, 1
