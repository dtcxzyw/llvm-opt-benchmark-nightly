...
bb.a:
  %i.a = tail call i32 @pthread_mutex_lock(ptr noundef nonnull @VP8EncDspCostInit.VP8EncDspCostInit_body_lock) #7
  %.not = icmp eq i32 %i.a, 0
  br i1 %.not, label %bb.b, label %bb.f

bb.b:                                             ; preds = %bb.a
  %i.b = load volatile ptr, ptr @VP8EncDspCostInit.VP8EncDspCostInit_body_last_cpuinfo_used, align 8, !tbaa !7
  %i.c = load ptr, ptr @VP8GetCPUInfo, align 8, !tbaa !7 ; 3 uses
  %.not1 = icmp eq ptr %i.b, %i.c
  br i1 %.not1, label %VP8EncDspCostInit_body.exit, label %bb.c

bb.c:                                             ; preds = %bb.b
  store ptr @GetResidualCost_C, ptr @VP8GetResidualCost, align 8, !tbaa !7
  store ptr @SetResidualCoeffs_C, ptr @VP8SetResidualCoeffs, align 8, !tbaa !7
  %.not.i = icmp eq ptr %i.c, null
  br i1 %.not.i, label %VP8EncDspCostInit_body.exit, label %bb.d

bb.d:                                             ; preds = %bb.c
  %i.d = tail call i32 %i.c(i32 noundef 0) #7, !inline_history !9
  %.not1.i = icmp eq i32 %i.d, 0
  br i1 %.not1.i, label %VP8EncDspCostInit_body.exit, label %bb.e

bb.e:                                             ; preds = %bb.d
  tail call void @VP8EncDspCostInitSSE2() #7
  br label %VP8EncDspCostInit_body.exit

VP8EncDspCostInit_body.exit:                      ; preds = %bb.e, %bb.d, %bb.c, %bb.b
  %i.e = load ptr, ptr @VP8GetCPUInfo, align 8, !tbaa !7
  store volatile ptr %i.e, ptr @VP8EncDspCostInit.VP8EncDspCostInit_body_last_cpuinfo_used, align 8, !tbaa !7
  %i.f = tail call i32 @pthread_mutex_unlock(ptr noundef nonnull @VP8EncDspCostInit.VP8EncDspCostInit_body_lock) #7 ; 0 uses
  br label %bb.f

bb.f:                                             ; preds = %bb.a, %VP8EncDspCostInit_body.exit
  ret void
}
...
bb.d:                                             ; preds = %bb.c
  %.pn.i43 = zext i8 %i.h to i64
  %.in.in.i44 = getelementptr inbounds nuw [2 x i8], ptr @VP8EntropyCost, i64 %.pn.i43
  %.in.i45 = load i16, ptr %.in.in.i44, align 2, !tbaa !21
  %i.w = zext i16 %.in.i45 to i32
  br label %bb.g
...
bb.e:                                             ; preds = %.lr.ph, %bb.e
  ...
  %2 = tail call i16 @llvm.abs.i16(i16 %i.y, i1 false) ; 3 uses
  %i.z = tail call i16 @llvm.umin.i16(i16 %2, i16 2)
  %i.aa = zext i16 %2 to i64
  %i.ab = getelementptr inbounds nuw [2 x i8], ptr @VP8LevelFixedCosts, i64 %i.aa
  %i.ac = load i16, ptr %i.ab, align 2, !tbaa !21
  %i.ad = zext i16 %i.ac to i32
  %i.ae = tail call i16 @llvm.umin.i16(i16 %2, i16 67)
  %i.af = zext nneg i16 %i.ae to i64
  %i.ag = getelementptr inbounds nuw [2 x i8], ptr %.04051, i64 %i.af
  %i.ah = load i16, ptr %i.ag, align 2, !tbaa !21
...
._crit_edge:                                      ; preds = %bb.e, %.preheader
  %.pre-phi = phi i64 [ %i.d, %.preheader ], [ %wide.trip.count, %bb.e ] ; 2 uses
  %.041.lcssa = phi i32 [ %i.p, %.preheader ], [ %i.ak, %bb.e ]
  %.040.lcssa = phi ptr [ %i.m, %.preheader ], [ %i.ao, %bb.e ]
  %.039.lcssa = phi i32 [ %i.a, %.preheader ], [ %i.r, %bb.e ]
  %i.ap = getelementptr inbounds [2 x i8], ptr %i.v, i64 %.pre-phi
  %i.aq = load i16, ptr %i.ap, align 2, !tbaa !21
  %i.ar = tail call i16 @llvm.abs.i16(i16 %i.aq, i1 false) ; 3 uses
  %i.as = zext i16 %i.ar to i64
  %i.at = getelementptr inbounds nuw [2 x i8], ptr @VP8LevelFixedCosts, i64 %i.as
  %i.au = load i16, ptr %i.at, align 2, !tbaa !21
  %i.av = zext i16 %i.au to i32
  %i.aw = tail call i16 @llvm.umin.i16(i16 %i.ar, i16 67)
  %i.ax = zext nneg i16 %i.aw to i64
  %i.ay = getelementptr inbounds nuw [2 x i8], ptr %.040.lcssa, i64 %i.ax
  %i.az = load i16, ptr %i.ay, align 2, !tbaa !21
  %i.ba = zext i16 %i.az to i32
  %i.bb = add nuw nsw i32 %.041.lcssa, %i.av
  %i.bc = add nuw nsw i32 %i.bb, %i.ba            ; 2 uses
  %i.bd = icmp samesign ult i32 %.039.lcssa, 15
  br i1 %i.bd, label %bb.f, label %bb.g

bb.f:                                             ; preds = %._crit_edge
  %i.be = getelementptr i8, ptr @VP8EncBands, i64 %.pre-phi
  %i.bf = getelementptr i8, ptr %i.be, i64 1
  %i.bg = load i8, ptr %i.bf, align 1, !tbaa !18
  %i.bh = icmp eq i16 %i.ar, 1
  %i.bi = zext i8 %i.bg to i64
  %i.bj = getelementptr inbounds nuw [33 x i8], ptr %i.c, i64 %i.bi
  %i.bk = select i1 %i.bh, i64 1, i64 2
  %i.bl = getelementptr inbounds nuw [11 x i8], ptr %i.bj, i64 %i.bk
  %i.bm = load i8, ptr %i.bl, align 1, !tbaa !18
  %.pn.i47 = zext i8 %i.bm to i64
  %.in.in.i48 = getelementptr inbounds nuw [2 x i8], ptr @VP8EntropyCost, i64 %.pn.i47
  %.in.i49 = load i16, ptr %.in.in.i48, align 2, !tbaa !21
  %i.bn = zext i16 %.in.i49 to i32
  %i.bo = add nuw nsw i32 %i.bc, %i.bn
  br label %bb.g

bb.g:                                             ; preds = %._crit_edge, %bb.f, %bb.d
  %.0 = phi i32 [ %i.w, %bb.d ], [ %i.bo, %bb.f ], [ %i.bc, %._crit_edge ]
  ret i32 %.0
}

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: readwrite) uwtable
define internal void @SetResidualCoeffs_C(ptr noalias noundef %0, ptr noalias noundef writeonly captures(none) initializes((4, 16)) %1) #3 {
bb.a:
  ...
  %i.c = load i16, ptr %i.b, align 2, !tbaa !21
  %.not = icmp eq i16 %i.c, 0
  br i1 %.not, label %bb.c, label %bb.b

bb.b:                                             ; preds = %bb.q, %bb.p, %bb.o, %bb.n, %bb.m, %bb.l, %bb.k, %bb.j, %bb.i, %bb.h, %bb.g, %bb.f, %bb.e, %bb.d, %bb.c, %bb.a
  %.09.lcssa = phi i32 [ 15, %bb.a ], [ 14, %bb.c ], [ 13, %bb.d ], [ 12, %bb.e ], [ 11, %bb.f ], [ 10, %bb.g ], [ 9, %bb.h ], [ 8, %bb.i ], [ 7, %bb.j ], [ 6, %bb.k ], [ 5, %bb.l ], [ 4, %bb.m ], [ 3, %bb.n ], [ 2, %bb.o ], [ 1, %bb.p ], [ 0, %bb.q ]
  store i32 %.09.lcssa, ptr %i.a, align 4, !tbaa !23
  br label %.loopexit
...
bb.c:                                             ; preds = %bb.a
  ...
  br i1 %.not.1, label %bb.d, label %bb.b

bb.d:                                             ; preds = %bb.c
  %i.f = getelementptr inbounds nuw i8, ptr %0, i64 26
  %i.g = load i16, ptr %i.f, align 2, !tbaa !21
  %.not.2 = icmp eq i16 %i.g, 0
  br i1 %.not.2, label %bb.e, label %bb.b

bb.e:                                             ; preds = %bb.d
  %i.h = getelementptr inbounds nuw i8, ptr %0, i64 24
  %i.i = load i16, ptr %i.h, align 2, !tbaa !21
  %.not.3 = icmp eq i16 %i.i, 0
  br i1 %.not.3, label %bb.f, label %bb.b

bb.f:                                             ; preds = %bb.e
  %i.j = getelementptr inbounds nuw i8, ptr %0, i64 22
  %i.k = load i16, ptr %i.j, align 2, !tbaa !21
  %.not.4 = icmp eq i16 %i.k, 0
  br i1 %.not.4, label %bb.g, label %bb.b

bb.g:                                             ; preds = %bb.f
  %i.l = getelementptr inbounds nuw i8, ptr %0, i64 20
  %i.m = load i16, ptr %i.l, align 2, !tbaa !21
  %.not.5 = icmp eq i16 %i.m, 0
  br i1 %.not.5, label %bb.h, label %bb.b

bb.h:                                             ; preds = %bb.g
  %i.n = getelementptr inbounds nuw i8, ptr %0, i64 18
  %i.o = load i16, ptr %i.n, align 2, !tbaa !21
  %.not.6 = icmp eq i16 %i.o, 0
  br i1 %.not.6, label %bb.i, label %bb.b

bb.i:                                             ; preds = %bb.h
  %i.p = getelementptr inbounds nuw i8, ptr %0, i64 16
  %i.q = load i16, ptr %i.p, align 2, !tbaa !21
  %.not.7 = icmp eq i16 %i.q, 0
  br i1 %.not.7, label %bb.j, label %bb.b

bb.j:                                             ; preds = %bb.i
  %i.r = getelementptr inbounds nuw i8, ptr %0, i64 14
  %i.s = load i16, ptr %i.r, align 2, !tbaa !21
  %.not.8 = icmp eq i16 %i.s, 0
  br i1 %.not.8, label %bb.k, label %bb.b

bb.k:                                             ; preds = %bb.j
  %i.t = getelementptr inbounds nuw i8, ptr %0, i64 12
  %i.u = load i16, ptr %i.t, align 2, !tbaa !21
  %.not.9 = icmp eq i16 %i.u, 0
  br i1 %.not.9, label %bb.l, label %bb.b

bb.l:                                             ; preds = %bb.k
  %i.v = getelementptr inbounds nuw i8, ptr %0, i64 10
  %i.w = load i16, ptr %i.v, align 2, !tbaa !21
  %.not.10 = icmp eq i16 %i.w, 0
  br i1 %.not.10, label %bb.m, label %bb.b

bb.m:                                             ; preds = %bb.l
  %i.x = getelementptr inbounds nuw i8, ptr %0, i64 8
  %i.y = load i16, ptr %i.x, align 2, !tbaa !21
  %.not.11 = icmp eq i16 %i.y, 0
  br i1 %.not.11, label %bb.n, label %bb.b

bb.n:                                             ; preds = %bb.m
  %i.z = getelementptr inbounds nuw i8, ptr %0, i64 6
  %i.aa = load i16, ptr %i.z, align 2, !tbaa !21
  %.not.12 = icmp eq i16 %i.aa, 0
  br i1 %.not.12, label %bb.o, label %bb.b

bb.o:                                             ; preds = %bb.n
  %i.ab = getelementptr inbounds nuw i8, ptr %0, i64 4
  %i.ac = load i16, ptr %i.ab, align 2, !tbaa !21
  %.not.13 = icmp eq i16 %i.ac, 0
  br i1 %.not.13, label %bb.p, label %bb.b

bb.p:                                             ; preds = %bb.o
  %i.ad = getelementptr inbounds nuw i8, ptr %0, i64 2
  %i.ae = load i16, ptr %i.ad, align 2, !tbaa !21
  %.not.14 = icmp eq i16 %i.ae, 0
  br i1 %.not.14, label %bb.q, label %bb.b

bb.q:                                             ; preds = %bb.p
  %i.af = load i16, ptr %0, align 2, !tbaa !21
  %.not.15 = icmp eq i16 %i.af, 0
  br i1 %.not.15, label %.loopexit, label %bb.b

.loopexit:                                        ; preds = %bb.q, %bb.b
  %i.ag = getelementptr inbounds nuw i8, ptr %1, i64 8
  store ptr %0, ptr %i.ag, align 8, !tbaa !24
  ret void
}
...
!9 = distinct !{null}
!10 = !{!11, !4, i64 0}
!11 = !{!"VP8Residual", !4, i64 0, !4, i64 4, !12, i64 8, !4, i64 16, !13, i64 24, !14, i64 32, !15, i64 40}
!12 = !{!"p1 short", !8, i64 0}
