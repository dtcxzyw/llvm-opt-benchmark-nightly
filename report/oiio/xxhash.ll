...
.preheader:                                       ; preds = %.lr.ph, %bb.f
  ...
  %.2.i.lcssa = phi ptr [ %.1.i, %bb.f ], [ %i.bk, %.lr.ph ] ; 4 uses
...
begin_hunk_3_@_ZN11OpenImageIO4v3_16xxhash5XXH32EPKvmj:bb.a
  ...
  %3 = icmp ult ptr %i.cs, %i.b
  br i1 %3, label %.lr.ph21, label %_ZN11OpenImageIO4v3_16xxhashL18XXH32_endian_alignEPKvmjNS1_13XXH_endianessENS1_13XXH_alignmentE.exit, !llvm.loop !15
...
bb.h:                                             ; preds = %bb.g, %._crit_edge
  ...
  %.3.i = phi ptr [ %i.cp, %bb.g ], [ %.2.i.lcssa, %._crit_edge ] ; 4 uses
...
begin_hunk_7_@_ZN11OpenImageIO4v3_16xxhash5XXH64EPKvmy:bb.a
  ...
  %3 = icmp ult ptr %i.ek, %i.b
  br i1 %3, label %.lr.ph22, label %_ZN11OpenImageIO4v3_16xxhashL18XXH64_endian_alignEPKvmyNS1_13XXH_endianessENS1_13XXH_alignmentE.exit, !llvm.loop !22
