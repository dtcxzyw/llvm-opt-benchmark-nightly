...
begin_hunk_0_@JPEGFixupTags:bb.a
  ...
  %i.fe = phi ptr [ %i.p, %bb.az ], [ %i.en, %JPEGFixupTagsSubsamplingSkip.exit79.i.i ] ; 2 uses
...
begin_hunk_1_@JPEGFixupTags:bb.a
  ...
  %.pn.i = phi i64 [ 1, %bb.bb ], [ 1, %bb.bc ], [ 2, %bb.ba ]
  %i.fl = phi i32 [ 0, %bb.bb ], [ 0, %bb.bc ], [ %i.fi, %bb.ba ]
  %i.fm = load i16, ptr %i.i, align 2, !tbaa !133
  %i.fn = icmp ugt i16 %i.fm, 1
  br i1 %i.fn, label %.lr.ph.i.preheader.i, label %._crit_edge.i.i

.lr.ph.i.preheader.i:                             ; preds = %JPEGFixupTagsSubsamplingSkip.exit92.i.i
  %1 = getelementptr inbounds nuw i8, ptr %i.fe, i64 %.pn.i
  br label %.lr.ph.i.i

.lr.ph.i.i:                                       ; preds = %JPEGFixupTagsSubsamplingSkip.exit108.i.i, %.lr.ph.i.preheader.i
  %.sroa.10877.7.i = phi i64 [ %.sroa.10877.9.i, %JPEGFixupTagsSubsamplingSkip.exit108.i.i ], [ %.sroa.10877.6.i, %.lr.ph.i.preheader.i ] ; 4 uses
  %.sroa.143.7.i = phi i64 [ %.sroa.143.9.i, %JPEGFixupTagsSubsamplingSkip.exit108.i.i ], [ %.sroa.143.6.i, %.lr.ph.i.preheader.i ] ; 6 uses
  %.sroa.188.7.i = phi i8 [ %.sroa.188.9.i, %JPEGFixupTagsSubsamplingSkip.exit108.i.i ], [ %.sroa.188.6.i, %.lr.ph.i.preheader.i ] ; 2 uses
  %i.fo = phi ptr [ %2, %JPEGFixupTagsSubsamplingSkip.exit108.i.i ], [ %1, %.lr.ph.i.preheader.i ]
  %i.fp = phi i32 [ %i.gm, %JPEGFixupTagsSubsamplingSkip.exit108.i.i ], [ %i.fl, %.lr.ph.i.preheader.i ] ; 2 uses
  %.052143.i.i = phi i16 [ %i.gn, %JPEGFixupTagsSubsamplingSkip.exit108.i.i ], [ 1, %.lr.ph.i.preheader.i ]
...
begin_hunk_2_@JPEGFixupTags:bb.a
  ...
  %i.gh = phi ptr [ %i.p, %bb.bg ], [ %i.fq, %JPEGFixupTagsSubsamplingSkip.exit95.i.i ] ; 2 uses
...
begin_hunk_4_@JPEGFixupTags:bb.a
  ...
  %.pn188.i = phi i64 [ 1, %bb.bk ], [ 1, %bb.bl ], [ 2, %bb.bj ]
  %i.gm = phi i32 [ 0, %bb.bk ], [ 0, %bb.bl ], [ %i.gj, %bb.bj ]
  %2 = getelementptr inbounds nuw i8, ptr %i.gh, i64 %.pn188.i
