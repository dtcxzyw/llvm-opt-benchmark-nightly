...
begin_hunk_0_@_RNvCsjAVdN2kNoZZ_17show_posts_step_14main:bb.a
  ...
  store ptr %i.ee, ptr %.sroa.4.0..sroa_idx, align 8, !alias.scope !325, !noalias !326
  %.sroa.0.0.copyload27 = load i64, ptr %i.ed, align 8, !noalias !325 ; 2 uses
  %.sroa.7.0..sroa_idx28 = getelementptr inbounds nuw i8, ptr %i.ed, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(48) %.sroa.7, ptr noundef nonnull align 8 dereferenceable(48) %.sroa.7.0..sroa_idx28, i64 48, i1 false), !noalias !325
...
bb.bh:                                            ; preds = %bb.bg
  ...
  %.val4.i = load i64, ptr %i.z, align 8, !alias.scope !327 ; 2 uses
...
bb.bi:                                            ; preds = %bb.bh
  %.val5.i = load ptr, ptr %.sroa.7.0..sroa_idx, align 8, !alias.scope !327, !nonnull !5, !noundef !5
  call void @_RNvCs9hJ03s5DiqP_7___rustc14___rust_dealloc(ptr noundef nonnull %.val5.i, i64 noundef %.val4.i, i64 noundef range(i64 1, -9223372036854775807) 1) #26, !noalias !328
...
_RINvNtCscI6d9CVNmLh_4core3ptr9drop_glueNtNtCs40k4W9msRzi_5alloc6string6StringECsjAVdN2kNoZZ_17show_posts_step_1.exit.i: ; preds = %bb.bi, %bb.bh
  %.val.i = load i64, ptr %i.eb, align 8, !alias.scope !327 ; 2 uses
...
bb.bj:                                            ; preds = %_RINvNtCscI6d9CVNmLh_4core3ptr9drop_glueNtNtCs40k4W9msRzi_5alloc6string6StringECsjAVdN2kNoZZ_17show_posts_step_1.exit.i
  %.val1.i = load ptr, ptr %i.ec, align 8, !alias.scope !327, !nonnull !5, !noundef !5
  call void @_RNvCs9hJ03s5DiqP_7___rustc14___rust_dealloc(ptr noundef nonnull %.val1.i, i64 noundef %.val.i, i64 noundef range(i64 1, -9223372036854775807) 1) #26, !noalias !329
...
_RINvNtCscI6d9CVNmLh_4core3ptr9drop_glueNtNtCskz3n0RVv2OU_29getting_started_step_1_sqlite6models4PostECsjAVdN2kNoZZ_17show_posts_step_1.exit: ; preds = %bb.bj, %_RINvNtCscI6d9CVNmLh_4core3ptr9drop_glueNtNtCs40k4W9msRzi_5alloc6string6StringECsjAVdN2kNoZZ_17show_posts_step_1.exit.i
  ...
  %i.ei = load ptr, ptr %.sroa.6.0..sroa_idx, align 8, !alias.scope !330, !noalias !326, !nonnull !5, !noundef !5
  %i.ej = load ptr, ptr %.sroa.4.0..sroa_idx, align 8, !alias.scope !330, !noalias !326, !nonnull !5, !noundef !5 ; 2 uses
...
bb.a:
  ...
  %i.e = load i64, ptr %1, align 8, !range !10, !noundef !5
...
bb.c:                                             ; preds = %bb.a
  ...
  call void @llvm.lifetime.start.p0(ptr nonnull %i.d), !noalias !346
  store i64 0, ptr %i.d, align 8, !alias.scope !347, !noalias !346
  %.sroa.42.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.d, i64 8 ; 3 uses
  store ptr inttoptr (i64 1 to ptr), ptr %.sroa.42.0..sroa_idx.i.i, align 8, !alias.scope !347, !noalias !346
  %.sroa.53.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.d, i64 16
  store i64 0, ptr %.sroa.53.0..sroa_idx.i.i, align 8, !alias.scope !347, !noalias !346
  call void @llvm.lifetime.start.p0(ptr nonnull %i.c), !noalias !346
  call void @llvm.lifetime.start.p0(ptr nonnull %i.b), !noalias !348
  store i8 0, ptr %i.b, align 1, !noalias !348
  call void @llvm.lifetime.start.p0(ptr nonnull %i.a), !noalias !348
  store i64 0, ptr %i.a, align 8, !noalias !348
  %.sroa.4.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 8
  store ptr %i.d, ptr %.sroa.4.0..sroa_idx.i.i, align 8, !noalias !348
  %.sroa.5.0..sroa_idx.i.i = getelementptr inbounds nuw i8, ptr %i.a, i64 16
  store ptr %i.b, ptr %.sroa.5.0..sroa_idx.i.i, align 8, !noalias !348
  %i.k = getelementptr inbounds nuw i8, ptr %i.a, i64 24
  store ptr inttoptr (i64 1 to ptr), ptr %i.k, align 8, !noalias !348
  invoke void @_RNvXs3_NtNtCsjRvGck33osM_6diesel13query_builder16select_statementINtB5_15SelectStatementINtNtB7_11from_clause10FromClauseNtNtNtCskz3n0RVv2OU_29getting_started_step_1_sqlite6schema5posts5tableEINtNtB7_13select_clause12SelectClauseINtNtNtB9_10expression9select_by8SelectByNtNtB21_6models4PostNtNtNtB9_6sqlite7backend6SqliteEENtNtB7_15distinct_clause16NoDistinctClauseINtNtB7_12where_clause11WhereClauseINtNtB3K_7grouped7GroupedINtNtB3K_9operators2EqNtNtB1X_7columns9publishedINtNtB3K_5bound5BoundNtNtB9_9sql_types4BoolbEEEENtNtB7_12order_clause13NoOrderClauseINtNtB7_19limit_offset_clause17LimitOffsetClauseINtNtB7_12limit_clause11LimitClauseIB7C_NtB7Y_6BigIntxEENtNtB7_13offset_clause14NoOffsetClauseEEINtB7_13QueryFragmentB4E_E8walk_astCsjAVdN2kNoZZ_17show_posts_step_1(ptr noalias noundef nonnull sret([32 x i8]) align 8 captures(address) dereferenceable(32) %i.c, ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %2, ptr noalias noundef nonnull align 8 captures(address) dereferenceable(32) %i.a)
          to label %bb.d unwind label %bb.h, !noalias !349

bb.d:                                             ; preds = %bb.c
  call void @llvm.lifetime.end.p0(ptr nonnull %i.a), !noalias !348
  call void @llvm.lifetime.end.p0(ptr nonnull %i.b), !noalias !348
  %i.l = load i64, ptr %i.c, align 8, !range !12, !noalias !346, !noundef !5 ; 3 uses
  %.not.i = icmp eq i64 %i.l, -1
  br i1 %.not.i, label %bb.j, label %bb.e

bb.e:                                             ; preds = %bb.d
  %.sroa.6.0..sroa_idx2 = getelementptr inbounds nuw i8, ptr %i.c, i64 8
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.6, ptr noundef nonnull align 8 dereferenceable(24) %.sroa.6.0..sroa_idx2, i64 24, i1 false), !noalias !350
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !346
  %.val3.i = load i64, ptr %i.d, align 8, !noalias !346 ; 2 uses
  %i.m = icmp eq i64 %.val3.i, 0
  br i1 %i.m, label %bb.k, label %bb.f

bb.f:                                             ; preds = %bb.e
  %.val4.i = load ptr, ptr %.sroa.42.0..sroa_idx.i.i, align 8, !noalias !346, !nonnull !5, !noundef !5
  call void @_RNvCs9hJ03s5DiqP_7___rustc14___rust_dealloc(ptr noundef nonnull %.val4.i, i64 noundef %.val3.i, i64 noundef range(i64 1, -9223372036854775807) 1) #26, !noalias !351
  br label %bb.k
...
bb.h:                                             ; preds = %bb.c
  %i.n = landingpad { ptr, i32 }
          cleanup
  %.val.i = load i64, ptr %i.d, align 8, !noalias !346 ; 2 uses
  %i.o = icmp eq i64 %.val.i, 0
  br i1 %i.o, label %bb.g, label %bb.i

bb.i:                                             ; preds = %bb.h
  %.val2.i = load ptr, ptr %.sroa.42.0..sroa_idx.i.i, align 8, !noalias !346, !nonnull !5, !noundef !5
  call void @_RNvCs9hJ03s5DiqP_7___rustc14___rust_dealloc(ptr noundef nonnull %.val2.i, i64 noundef %.val.i, i64 noundef range(i64 1, -9223372036854775807) 1) #26, !noalias !352
  br label %bb.g

bb.j:                                             ; preds = %bb.d
  call void @llvm.lifetime.end.p0(ptr nonnull %i.c), !noalias !346
  call void @llvm.memcpy.p0.p0.i64(ptr noundef nonnull align 8 dereferenceable(24) %.sroa.6, ptr noundef nonnull align 8 dereferenceable(24) %i.d, i64 24, i1 false), !noalias !350
  br label %bb.k
...
bb.a:
  ...
  %.sroa.0.0.copyload.i68.i = load <16 x i8>, ptr %i.b, align 1, !noalias !355
  ...
  br i1 %.not.i9.i, label %.lr.ph.i, label %._crit_edge.i, !prof !356
...
._crit_edge.i:                                    ; preds = %.lr.ph.i, %bb.a
  ...
  br i1 %i.k, label %bb.b, label %_RNvMsa_NtCsfKiFC1ztrmh_9hashbrown3rawNtB5_13RawTableInner17find_insert_index.exit, !prof !357
...
.lr.ph.i:                                         ; preds = %bb.a, %.lr.ph.i
  ...
  %.sroa.0.0.copyload.i6.i = load <16 x i8>, ptr %i.s, align 1, !noalias !355
  ...
  br i1 %.not.i.i, label %.lr.ph.i, label %._crit_edge.i, !prof !358
