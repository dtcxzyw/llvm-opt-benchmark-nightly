...
_RNvXsz_NtCs50gxqRnCXtk_10proc_macro6bridgeINtB5_5GroupNtNtB5_6client11TokenStreamNtBS_4SpanENtNtCscI6d9CVNmLh_4core5clone5Clone5cloneCs8SLDEF1Cvau_13dsl_auto_type.exit.i.i.i: ; preds = %bb.h, %bb.g
  ...
  %2 = zext i32 %.val3.i.i.i.i.i to i64
  %3 = shl nuw i64 %2, 32
  %4 = and i32 %storemerge.i.i.i.i, -256
...
_RNvXsF_NtCsiD8eKn5yFCp_11proc_macro23impNtB5_5GroupNtNtCscI6d9CVNmLh_4core5clone5Clone5clone.exit.i.i: ; preds = %_RNvXsz_NtCs50gxqRnCXtk_10proc_macro6bridgeINtB5_5GroupNtNtB5_6client11TokenStreamNtBS_4SpanENtNtCscI6d9CVNmLh_4core5clone5Clone5cloneCs8SLDEF1Cvau_13dsl_auto_type.exit.i.i.i, %bb.f
  ...
  %.sroa.841.sroa.5.sroa.0.0.i.i = phi i32 [ %4, %_RNvXsz_NtCs50gxqRnCXtk_10proc_macro6bridgeINtB5_5GroupNtNtB5_6client11TokenStreamNtBS_4SpanENtNtCscI6d9CVNmLh_4core5clone5Clone5cloneCs8SLDEF1Cvau_13dsl_auto_type.exit.i.i.i ], [ 0, %bb.f ]
  ...
  %storemerge.i.i.i = phi i64 [ %3, %_RNvXsz_NtCs50gxqRnCXtk_10proc_macro6bridgeINtB5_5GroupNtNtB5_6client11TokenStreamNtBS_4SpanENtNtCscI6d9CVNmLh_4core5clone5Clone5cloneCs8SLDEF1Cvau_13dsl_auto_type.exit.i.i.i ], [ 1, %bb.f ]
  %i.ar = ptrtoint ptr %.sroa.540.0.i.i to i64
...
bb.k:                                             ; preds = %bb.d
  ...
  %.sroa.721.0.copyload23.i = load i64, ptr %.sroa.721.0..sroa_idx22.i, align 8, !alias.scope !4142, !noalias !4136
  %.sroa.11.0..sroa_idx24.i = getelementptr inbounds nuw i8, ptr %.sroa.015.089.i, i64 16
  %.sroa.11.0.copyload25.i = load i64, ptr %.sroa.11.0..sroa_idx24.i, align 8, !alias.scope !4142, !noalias !4136
...
bb.q:                                             ; preds = %bb.p, %.noexc14.i
  ...
  %.sroa.0.0.i12.i = phi i64 [ -1, %bb.p ], [ %.sroa.04.0.copyload.i.i, %.noexc14.i ]
  %.sroa.11.sroa.0.0.insert.ext.i = zext i32 %.sroa.5.sroa.0.0.i.i to i64
  %.sroa.11.sroa.0.4.insert.ext.i = zext i32 %.sroa.5.sroa.5.0.i.i to i64
  ...
  %.sroa.15.sroa.0.0.extract.trunc32.i = trunc i32 %.sroa.5.sroa.6.0.i.i to i8
  %.sroa.15.sroa.7.0.extract.shift34.i = and i32 %.sroa.5.sroa.6.0.i.i, -256
  br label %_RNvXsO_CsiD8eKn5yFCp_11proc_macro2NtB5_9TokenTreeNtNtCscI6d9CVNmLh_4core5clone5Clone5clone.exit.i

_RNvXsO_CsiD8eKn5yFCp_11proc_macro2NtB5_9TokenTreeNtNtCscI6d9CVNmLh_4core5clone5Clone5clone.exit.i: ; preds = %bb.q, %bb.n, %.noexc13.i, %bb.k, %_RNvXsF_NtCsiD8eKn5yFCp_11proc_macro23impNtB5_5GroupNtNtCscI6d9CVNmLh_4core5clone5Clone5clone.exit.i.i
  %.sroa.721.sroa.0.0.i = phi i64 [ %storemerge.i.i.i, %_RNvXsF_NtCsiD8eKn5yFCp_11proc_macro23impNtB5_5GroupNtNtCscI6d9CVNmLh_4core5clone5Clone5clone.exit.i.i ], [ %.sroa.0.0.i12.i, %bb.q ], [ %.sroa.721.0.copyload23.i, %bb.k ], [ %i.ba, %.noexc13.i ], [ %.val1.i.i.i, %bb.n ]
  %.sroa.11.sroa.0.0.i = phi i64 [ %i.ar, %_RNvXsF_NtCsiD8eKn5yFCp_11proc_macro23impNtB5_5GroupNtNtCscI6d9CVNmLh_4core5clone5Clone5clone.exit.i.i ], [ %.sroa.11.sroa.0.4.insert.insert.i, %bb.q ], [ %.sroa.11.0.copyload25.i, %bb.k ], [ %i.az, %.noexc13.i ], [ %.sroa.06.sroa.5.0.insert.ext.i.i, %bb.n ]
  %.sroa.15.sroa.7.sroa.0.0.i = phi i32 [ %.sroa.841.sroa.5.sroa.0.0.i.i, %_RNvXsF_NtCsiD8eKn5yFCp_11proc_macro23impNtB5_5GroupNtNtCscI6d9CVNmLh_4core5clone5Clone5clone.exit.i.i ], [ %.sroa.15.sroa.7.0.extract.shift34.i, %bb.q ], [ %.sroa.15.sroa.7.0.extract.shift.i, %bb.k ], [ 0, %.noexc13.i ], [ 0, %bb.n ]
  %.sroa.15.sroa.0.0.i = phi i8 [ %.sroa.841.sroa.0.0.i.i, %_RNvXsF_NtCsiD8eKn5yFCp_11proc_macro23impNtB5_5GroupNtNtCscI6d9CVNmLh_4core5clone5Clone5clone.exit.i.i ], [ %.sroa.15.sroa.0.0.extract.trunc32.i, %bb.q ], [ %.sroa.15.sroa.0.0.extract.trunc.i, %bb.k ], [ %i.au, %.noexc13.i ], [ 2, %bb.n ]
  %.sroa.21.0.i = phi i16 [ undef, %_RNvXsF_NtCsiD8eKn5yFCp_11proc_macro23impNtB5_5GroupNtNtCscI6d9CVNmLh_4core5clone5Clone5clone.exit.i.i ], [ %.sroa.5.sroa.9.0.i.i, %bb.q ], [ %.sroa.21.0.copyload33.i, %bb.k ], [ undef, %.noexc13.i ], [ undef, %bb.n ]
  %.sroa.20.0.i = phi i8 [ undef, %_RNvXsF_NtCsiD8eKn5yFCp_11proc_macro23impNtB5_5GroupNtNtCscI6d9CVNmLh_4core5clone5Clone5clone.exit.i.i ], [ %.sroa.5.sroa.8.0.i.i, %bb.q ], [ %.sroa.20.0.copyload31.i, %bb.k ], [ undef, %.noexc13.i ], [ undef, %bb.n ]
  %.sroa.18.0.i = phi i8 [ %.sroa.10.0.i.i, %_RNvXsF_NtCsiD8eKn5yFCp_11proc_macro23impNtB5_5GroupNtNtCscI6d9CVNmLh_4core5clone5Clone5clone.exit.i.i ], [ %.sroa.5.sroa.7.0.i.i, %bb.q ], [ %.sroa.18.0.copyload29.i, %bb.k ], [ undef, %.noexc13.i ], [ undef, %bb.n ]
  %.sroa.718.0.i = phi i32 [ undef, %_RNvXsF_NtCsiD8eKn5yFCp_11proc_macro23impNtB5_5GroupNtNtCscI6d9CVNmLh_4core5clone5Clone5clone.exit.i.i ], [ undef, %bb.q ], [ %.sroa.718.0.copyload20.i, %bb.k ], [ undef, %.noexc13.i ], [ undef, %bb.n ]
  ...
  store i64 %.sroa.721.sroa.0.0.i, ptr %.sroa.567.0..sroa_idx.i, align 8, !noalias !4136
  %.sroa.668.0..sroa_idx.i = getelementptr inbounds nuw i8, ptr %i.bl, i64 16
  store i64 %.sroa.11.sroa.0.0.i, ptr %.sroa.668.0..sroa_idx.i, align 8, !noalias !4136
