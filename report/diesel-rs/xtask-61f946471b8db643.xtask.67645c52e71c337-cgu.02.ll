Download link: https://huggingface.co/buckets/llvm-opt-benchmark/llvm-opt-benchmark/resolve/diesel-rs/original/xtask-61f946471b8db643.xtask.67645c52e71c337-cgu.02?download=true
...
.body300:                                         ; preds = %.split.thread.loopexit, %.split.thread.loopexit.split-lp, %.loopexit, %.loopexit.split-lp.loopexit.split-lp.loopexit, %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp, %.loopexit.split-lp.loopexit, %bb.hz, %bb.hj, %bb.hg, %bb.jq, %bb.io, %bb.il, %.body318, %bb.hc
  %.pn.pn = phi { ptr, i32 } [ %.pn411, %bb.jq ], [ %eh.lpad-body, %bb.io ], [ %i.or, %bb.hc ], [ %lpad.phi427, %.body318 ], [ %i.qq, %bb.il ], [ %i.ov, %bb.hj ], [ %i.ot, %bb.hg ], [ %lpad.loopexit.split-lp, %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp ], [ %i.pn, %bb.hz ], [ %lpad.loopexit, %.loopexit ], [ %lpad.loopexit418, %.loopexit.split-lp.loopexit ], [ %lpad.loopexit421, %.loopexit.split-lp.loopexit.split-lp.loopexit ], [ %lpad.loopexit433, %.split.thread.loopexit ], [ %lpad.loopexit.split-lp434, %.split.thread.loopexit.split-lp ]
...
.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp: ; preds = %.invoke519
...
bb.ha:                                            ; preds = %bb.go
  ...
  br i1 %.not161, label %.invoke519, label %bb.hb, !prof !282
...
.invoke519:                                       ; preds = %bb.hm, %bb.ha, %.noexc312, %bb.hp
  ...
  invoke void @_RNvNtCscI6d9CVNmLh_4core6option13unwrap_failed(ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) %i.oo) #16
          to label %.cont520 unwind label %.loopexit.split-lp.loopexit.split-lp.loopexit.split-lp

.cont520:                                         ; preds = %.invoke519
  unreachable
...
bb.hm:                                            ; preds = %_RINvNtCscI6d9CVNmLh_4core3ptr9drop_glueNtCsknFUbXuePIn_6camino11Utf8PathBufECsyoCoCcM3Qh_5xtask.exit309
  ...
  br i1 %.not166, label %.invoke519, label %bb.hs, !prof !282
...
.noexc312:                                        ; preds = %bb.ho
  ...
  br i1 %i.pd, label %bb.hq, label %.invoke519

bb.hp:                                            ; preds = %bb.hr, %bb.hq
  %.not.i.i = icmp ugt i64 %i.pe, %i.oz
  br i1 %.not.i.i, label %.invoke519, label %bb.ho
...
bb.ht:                                            ; preds = %bb.hs
  ...
  %i.pl = invoke noundef zeroext i1 @_RNvXs1b_NtCsgczF5crJ4sT_3std4pathNtB6_7DisplayNtNtCscI6d9CVNmLh_4core3fmt7Display3fmt(ptr noalias noundef nonnull readonly align 8 captures(address, read_provenance) dereferenceable(16) %i.al, ptr noalias noundef nonnull align 8 dereferenceable(24) %i.d)
          to label %bb.hv unwind label %.loopexit423, !noalias !382

.loopexit423:                                     ; preds = %bb.ht
  %lpad.loopexit425 = landingpad { ptr, i32 }
          cleanup
  br label %bb.hu

.loopexit.split-lp424:                            ; preds = %bb.hw
  %lpad.loopexit.split-lp426 = landingpad { ptr, i32 }
          cleanup
  br label %bb.hu

bb.hu:                                            ; preds = %.loopexit.split-lp424, %.loopexit423
...
bb.hw:                                            ; preds = %bb.hv
  invoke void @_RNvNtCscI6d9CVNmLh_4core6result13unwrap_failed(ptr noalias noundef nonnull readonly captures(address, read_provenance) @128, i64 noundef 55, ptr noundef nonnull %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @6, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @130) #16
          to label %.noexc.i317 unwind label %.loopexit.split-lp424, !noalias !382
...
_RNvNtNtCscI6d9CVNmLh_4core5slice6memchr6memchr.exit.i.i: ; preds = %bb.ie, %._crit_edge.i.i.i
  ...
  br i1 %i.qe, label %bb.ig, label %.loopexit494
...
bb.ih:                                            ; preds = %bb.ii, %bb.ig
  br i1 %.not13.i.i, label %.loopexit494, label %bb.id
...
.loopexit494:                                     ; preds = %bb.ih, %_RNvNtNtCscI6d9CVNmLh_4core5slice6memchr6memchr.exit.i.i, %_RINvMNtCscI6d9CVNmLh_4core3stre10split_oncecECsyoCoCcM3Qh_5xtask.exit
...
_RINvMNtCscI6d9CVNmLh_4core6optionINtB3_6OptionReE11map_or_elseNtNtCs40k4W9msRzi_5alloc6string6StringNCNvNtB12_3fmt6format0NvYeNtNtB12_6borrow7ToOwned8to_ownedECsyoCoCcM3Qh_5xtask.exit330: ; preds = %.loopexit494
  ...
  %.not165417 = icmp eq ptr %.sroa.6.3494, null
  %.not165 = select i1 %.sroa.0402.0492, i1 true, i1 %.not165417
...
.body:                                            ; preds = %bb.je, %bb.it, %bb.iq
  ...
  %eh.lpad-body = phi { ptr, i32 } [ %lpad.phi432, %bb.it ], [ %i.rd, %bb.iq ], [ %i.rp, %bb.je ] ; 2 uses
...
bb.is:                                            ; preds = %bb.ir
  ...
  %i.rg = invoke noundef zeroext i1 @_RNvXs0_CsyoCoCcM3Qh_5xtaskNtB5_7BackendNtNtCscI6d9CVNmLh_4core3fmt7Display3fmt(ptr noalias noundef nonnull readonly captures(address, read_provenance) dereferenceable(1) %i.rf, ptr noalias noundef nonnull align 8 dereferenceable(24) %i.b)
          to label %bb.iu unwind label %.loopexit428, !noalias !406

.loopexit428:                                     ; preds = %bb.is
  %lpad.loopexit430 = landingpad { ptr, i32 }
          cleanup
  br label %bb.it

.loopexit.split-lp429:                            ; preds = %bb.iv
  %lpad.loopexit.split-lp431 = landingpad { ptr, i32 }
          cleanup
  br label %bb.it

bb.it:                                            ; preds = %.loopexit.split-lp429, %.loopexit428
...
bb.iv:                                            ; preds = %bb.iu
  invoke void @_RNvNtCscI6d9CVNmLh_4core6result13unwrap_failed(ptr noalias noundef nonnull readonly captures(address, read_provenance) @128, i64 noundef 55, ptr noundef nonnull %i.a, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(32) @6, ptr noalias noundef readonly align 8 captures(address, read_provenance) dereferenceable(24) @130) #16
          to label %.noexc.i338 unwind label %.loopexit.split-lp429, !noalias !406
